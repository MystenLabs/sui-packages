module 0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::access {
    ...
    struct Rule has store {
        ...
        condition_configs: 0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::DynamicMap<0x1::type_name::TypeName>,
    }
    ...
    struct ActionRequest {
        ...
        context: 0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::DynamicMap<0x1::ascii::String>,
    ...
    public fun add_condition_to_rule_with_config<T0: drop, T1: copy + drop + store>(arg0: &mut Policy, arg1: &PackageAdmin, arg2: address, arg3: T1) {
        ...
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::insert<0x1::type_name::TypeName, T1>(&mut v0.condition_configs, v1, arg3);
    }
    ...
    public fun add_config_for_condition<T0, T1: copy + drop + store>(arg0: &mut Policy, arg1: &PackageAdmin, arg2: address, arg3: T1) {
        ...
        let v0 = 0x2::vec_map::get_mut<address, Rule>(&mut arg0.rules, &arg2);
        let v1 = 0x1::type_name::get<T0>();
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::remove<0x1::type_name::TypeName, ConfigNone>(&mut v0.condition_configs, v1);
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::insert<0x1::type_name::TypeName, T1>(&mut v0.condition_configs, v1, arg3);
    }
    ...
    public fun add_empty_rule(arg0: &mut Policy, arg1: &PackageAdmin, arg2: &mut 0x2::tx_context::TxContext) : address {
        ...
        let v1 = Rule{
            ...
            condition_configs : 0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::new<0x1::type_name::TypeName>(arg2),
        };
    ...
    public fun admin_approve_request(arg0: ActionRequest, arg1: &PackageAdmin) {
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::force_drop<0x1::ascii::String>(admin_approve_request_and_return_context(arg0, arg1));
    }

    public fun admin_approve_request_and_return_context(arg0: ActionRequest, arg1: &PackageAdmin) : 0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::DynamicMap<0x1::ascii::String> {
    ...
    public fun approve_and_return_context(arg0: ActionRequest, arg1: &Entity, arg2: &Policy, arg3: address) : 0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::DynamicMap<0x1::ascii::String> {
    ...
    public fun approve_request(arg0: ActionRequest, arg1: &Entity, arg2: &Policy, arg3: address) {
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::force_drop<0x1::ascii::String>(approve_and_return_context(arg0, arg1, arg2, arg3));
    }

    public fun borrow_condition_config<T0, T1: copy + drop + store>(arg0: &Policy, arg1: &address) : &T1 {
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::borrow<0x1::type_name::TypeName, T1>(&0x2::vec_map::get<address, Rule>(&arg0.rules, arg1).condition_configs, 0x1::type_name::get<T0>())
    }

    public fun borrow_context(arg0: &ActionRequest) : &0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::DynamicMap<0x1::ascii::String> {
        &arg0.context
    }

    public fun borrow_mut_condition_config<T0, T1: copy + drop + store>(arg0: &mut Policy, arg1: &PackageAdmin, arg2: address) : &mut T1 {
        assert!(arg0.package == arg1.package, 2);
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::borrow_mut<0x1::type_name::TypeName, T1>(&mut 0x2::vec_map::get_mut<address, Rule>(&mut arg0.rules, &arg2).condition_configs, 0x1::type_name::get<T0>())
    }
    ...
    public fun context_value<T0: copy + drop + store>(arg0: &ActionRequest, arg1: 0x1::ascii::String) : &T0 {
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::borrow<0x1::ascii::String, T0>(&arg0.context, arg1)
    }
    ...
    public fun drop_rule(arg0: &mut Policy, arg1: &PackageAdmin, arg2: address) {
        ...
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::force_drop<0x1::type_name::TypeName>(v4);
    }
    ...
    public fun get_condition_witness<T0, T1: drop, T2: copy + drop + store>(arg0: &Policy, arg1: &Entity, arg2: address) : ConditionWitness<T0, T2> {
        ...
        ConditionWitness<T0, T2>{
            rule_id : arg2,
            config  : *0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::borrow<0x1::type_name::TypeName, T2>(&v1.condition_configs, 0x1::type_name::get<T0>()),
    ...
    public fun new_request<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : ActionRequest {
        ActionRequest{
            ...
            context             : 0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::new<0x1::ascii::String>(arg1),
    ...
    public fun new_request_for_resource<T0: key>(arg0: 0x1::ascii::String, arg1: &T0, arg2: &mut 0x2::tx_context::TxContext) : ActionRequest {
        ...
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::insert<0x1::ascii::String, 0x2::object::ID>(&mut v0.context, 0x1::ascii::string(b"resource_id"), 0x2::object::id<T0>(arg1));
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::insert<0x1::ascii::String, 0x1::type_name::TypeName>(&mut v0.context, 0x1::ascii::string(b"resource_type_name"), 0x1::type_name::get<T0>());
        v0
    }

    public fun new_request_with_context<T0: drop>(arg0: T0, arg1: 0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::DynamicMap<0x1::ascii::String>) : ActionRequest {
        ActionRequest{
            action_name         : 0x1::type_name::get<T0>(),
            context             : arg1,
            approved_conditions : 0x2::vec_map::empty<0x1::type_name::TypeName, address>(),
    ...
    public fun remove_config_for_condition<T0, T1: copy + drop + store>(arg0: &mut Policy, arg1: &PackageAdmin, arg2: address) {
        ...
        let v0 = 0x2::vec_map::get_mut<address, Rule>(&mut arg0.rules, &arg2);
        let v1 = 0x1::type_name::get<T0>();
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::remove<0x1::type_name::TypeName, T1>(&mut v0.condition_configs, v1);
        let v2 = ConfigNone{dummy_field: false};
        0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::dynamic_map::insert<0x1::type_name::TypeName, ConfigNone>(&mut v0.condition_configs, v1, v2);
    }
