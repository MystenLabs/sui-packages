module 0x6ee54cd57f6f30a70cffeccb16251fc59be211a9706d7c8f0ea8e08c22aaf667::storage {
    ...
    public(friend) fun rebase_treasury_usage_on_tier_change(arg0: &StorageTreasury, arg1: &mut StorageSpace, arg2: u8, arg3: u8, arg4: u64) {
        if (!0x2::vec_map::contains<u8, TreasuryUsageBudget>(&arg0.wal_treasury_usage_budget, &arg2) || !0x2::vec_map::contains<u8, TreasuryUsageBudget>(&arg0.wal_treasury_usage_budget, &arg3)) {
            return
        };
        let v0 = 0x2::vec_map::get<u8, TreasuryUsageBudget>(&arg0.wal_treasury_usage_budget, &arg3);
        if (v0.duration < 0x2::vec_map::get<u8, TreasuryUsageBudget>(&arg0.wal_treasury_usage_budget, &arg2).duration && arg1.treasury_usage.start_at > 0) {
            let v1 = arg4 - v0.duration;
            if (v1 > arg1.treasury_usage.start_at) {
                arg1.treasury_usage.start_at = v1;
            };
        };
    }
    ...
    public fun update_tier_plan(arg0: &mut StorageTreasury, arg1: &0x6ee54cd57f6f30a70cffeccb16251fc59be211a9706d7c8f0ea8e08c22aaf667::config::Config, arg2: &0x2dce2e2a3bc345b2c048477bd5f1fc0dfddce631b14ceeced3075cebe28955dd::admin::AdminCap, arg3: u8, arg4: u64, arg5: u16, arg6: u64) {
        ...
        if (0x2::vec_map::contains<u8, StorageTier>(&arg0.tier_plan, &arg3)) {
            ...
            let v2 = TreasuryUsageBudget{
                duration   : 0,
                max_budget : 0,
            };
            0x2::vec_map::insert<u8, TreasuryUsageBudget>(&mut arg0.wal_treasury_usage_budget, arg3, v2);
        };
    }
