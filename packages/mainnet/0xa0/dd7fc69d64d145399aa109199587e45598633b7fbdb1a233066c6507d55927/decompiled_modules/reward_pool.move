module 0xa0dd7fc69d64d145399aa109199587e45598633b7fbdb1a233066c6507d55927::reward_pool {
    ...
    public fun deposit_yield(arg0: &mut RewardPool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v0 - v2 - v3 - v4;
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.treasury, 0x2::balance::split<0x2::sui::SUI>(&mut v1, v2));
    ...
    entry fun withdraw_treasury(arg0: &mut RewardPool, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
