module 0xa0dd7fc69d64d145399aa109199587e45598633b7fbdb1a233066c6507d55927::stake_vault {
    ...
    entry fun withdraw(arg0: &mut Vault, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: StakeReceipt, arg3: &mut 0xa0dd7fc69d64d145399aa109199587e45598633b7fbdb1a233066c6507d55927::loyalty_tracker::LoyaltyRecord, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v7 > v2) {
            ...
            0xa0dd7fc69d64d145399aa109199587e45598633b7fbdb1a233066c6507d55927::loyalty_tracker::reset(arg3, arg4, arg5);
            let v9 = Withdrawn{
