module 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::fees {
    ...
    struct TokenFeeKey<phantom T0> has copy, drop, store {
    ...
    public(friend) fun accrue(arg0: &mut FeeVault, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x1::option::Option<address>) {
        accrue_split(arg0, arg1, arg2, arg3, 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::creator_bps(), 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::referrer_bps());
    }

    fun accrue_split(arg0: &mut FeeVault, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x1::option::Option<address>, arg4: u64, arg5: u64) {
        ...
        let v1 = 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::math::mul_bps(v0, arg4);
        let v2 = if (0x1::option::is_some<address>(&arg3)) {
            0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::math::mul_bps(v0, arg5)
        } else {
            0
        };
        let v3 = v0 - v1 - v2;
    ...
    public(friend) fun accrue_tokens<T0>(arg0: &mut FeeVault, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<T0>) {
        if (0x2::balance::value<T0>(&arg2) == 0) {
            0x2::balance::destroy_zero<T0>(arg2);
            return
        };
        let v0 = TokenFeeKey<T0>{curve_id: arg1};
        if (0x2::dynamic_field::exists_<TokenFeeKey<T0>>(&arg0.id, v0)) {
            0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<TokenFeeKey<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, v0), arg2);
        } else {
            0x2::dynamic_field::add<TokenFeeKey<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, v0, arg2);
        };
    }

    public(friend) fun accrue_with_config(arg0: &mut FeeVault, arg1: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::Config, arg2: 0x2::object::ID, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: 0x1::option::Option<address>) {
        let (v0, v1, _) = 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::fee_split(arg1);
        accrue_split(arg0, arg2, arg3, arg4, v0, v1);
    }
    ...
    public fun claim_creator(arg0: &mut FeeVault, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        assert!(v2 > 0, 1);
        *v1 = 0;
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events::fees_claimed(v0, 0x1::ascii::string(b"creator"), 0x1::option::some<0x2::object::ID>(arg1), v2, 0x2::clock::timestamp_ms(arg2));
            ...
            if (0x2::table::contains<0x2::object::ID, address>(&arg0.creator_of, v3) && *0x2::table::borrow<0x2::object::ID, address>(&arg0.creator_of, v3) == v0) {
                ...
                if (v5 > 0) {
                    *v4 = 0;
                    ...
                    0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events::fees_claimed(v0, 0x1::ascii::string(b"creator"), 0x1::option::some<0x2::object::ID>(v3), v5, 0x2::clock::timestamp_ms(arg2));
                };
            };
            v2 = v2 + 1;
        };
    ...
    public fun claim_creator_tokens<T0>(arg0: &mut FeeVault, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::table::contains<0x2::object::ID, address>(&arg0.creator_of, arg1), 2);
        assert!(*0x2::table::borrow<0x2::object::ID, address>(&arg0.creator_of, arg1) == v0, 0);
        let v1 = TokenFeeKey<T0>{curve_id: arg1};
        assert!(0x2::dynamic_field::exists_<TokenFeeKey<T0>>(&arg0.id, v1), 1);
        let v2 = 0x2::dynamic_field::borrow_mut<TokenFeeKey<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, v1);
        let v3 = 0x2::balance::value<T0>(v2);
        assert!(v3 > 0, 1);
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events::fees_claimed(v0, 0x1::ascii::string(b"creator-tokens"), 0x1::option::some<0x2::object::ID>(arg1), v3, 0x2::clock::timestamp_ms(arg2));
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v2, v3), arg3)
    }

    public fun claim_creator_tokens_to_sender<T0>(arg0: &mut FeeVault, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = claim_creator_tokens<T0>(arg0, arg1, arg2, arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v0, 0x2::tx_context::sender(arg3));
    }

    public fun claim_protocol(arg0: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::AdminCap, arg1: &mut FeeVault, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        pay_protocol(arg1, arg2, arg3, arg4);
    }

    public fun claim_protocol_by_fee_claimer(arg0: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::FeeClaimerCap, arg1: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::Config, arg2: &mut FeeVault, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::assert_fee_claimer(arg1, arg0);
        pay_protocol(arg2, arg3, arg4, arg5);
    }
    ...
    public fun claim_referrer(arg0: &mut FeeVault, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        assert!(v2 > 0, 1);
        *v1 = 0;
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events::fees_claimed(v0, 0x1::ascii::string(b"referrer"), 0x1::option::none<0x2::object::ID>(), v2, 0x2::clock::timestamp_ms(arg1));
    ...
    public fun creator_tokens_unclaimed<T0>(arg0: &FeeVault, arg1: 0x2::object::ID) : u64 {
        let v0 = TokenFeeKey<T0>{curve_id: arg1};
        if (!0x2::dynamic_field::exists_<TokenFeeKey<T0>>(&arg0.id, v0)) {
            return 0
        };
        0x2::balance::value<T0>(0x2::dynamic_field::borrow<TokenFeeKey<T0>, 0x2::balance::Balance<T0>>(&arg0.id, v0))
    }
    ...
    public(friend) fun credit_local(arg0: &mut FeeVault, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: u64, arg4: vector<address>, arg5: vector<u64>, arg6: u64) {
        let v0 = 0x2::balance::value<0x2::sui::SUI>(&arg2);
        let v1 = 0x1::vector::length<address>(&arg4);
        assert!(0x1::vector::length<u64>(&arg5) == v1, 3);
        let v2 = 0;
        let v3 = 0;
        while (v3 < v1) {
            v2 = v2 + *0x1::vector::borrow<u64>(&arg5, v3);
            v3 = v3 + 1;
        };
        assert!(v0 == arg3 + v2 + arg6, 3);
        if (v0 == 0) {
            0x2::balance::destroy_zero<0x2::sui::SUI>(arg2);
            return
        };
        ...
        let v4 = arg6;
        if (0x2::table::contains<0x2::object::ID, u64>(&arg0.creator_unclaimed, arg1)) {
            let v5 = 0x2::table::borrow_mut<0x2::object::ID, u64>(&mut arg0.creator_unclaimed, arg1);
            *v5 = *v5 + arg3;
            let v6 = 0x2::table::borrow_mut<0x2::object::ID, u64>(&mut arg0.creator_lifetime, arg1);
            *v6 = *v6 + arg3;
        } else {
            v4 = arg6 + arg3;
        };
        ...
        while (v7 < v1) {
            ...
            let v9 = *0x1::vector::borrow<u64>(&arg5, v7);
            if (v9 > 0) {
                if (0x2::table::contains<address, u64>(&arg0.referrer_unclaimed, v8)) {
                    let v10 = 0x2::table::borrow_mut<address, u64>(&mut arg0.referrer_unclaimed, v8);
                    *v10 = *v10 + v9;
                    let v11 = 0x2::table::borrow_mut<address, u64>(&mut arg0.referrer_lifetime, v8);
                    *v11 = *v11 + v9;
                } else {
                    0x2::table::add<address, u64>(&mut arg0.referrer_unclaimed, v8, v9);
                    0x2::table::add<address, u64>(&mut arg0.referrer_lifetime, v8, v9);
                };
            };
            v7 = v7 + 1;
        };
        arg0.protocol_unclaimed = arg0.protocol_unclaimed + v4;
        arg0.protocol_lifetime = arg0.protocol_lifetime + v4;
    }

    public(friend) fun credit_protocol(arg0: &mut FeeVault, arg1: 0x2::balance::Balance<0x2::sui::SUI>) {
        ...
        arg0.total_fees = arg0.total_fees + v0;
        arg0.protocol_unclaimed = arg0.protocol_unclaimed + v0;
        arg0.protocol_lifetime = arg0.protocol_lifetime + v0;
    }
    ...
    fun pay_protocol(arg0: &mut FeeVault, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = arg0.protocol_unclaimed;
        assert!(v0 > 0, 1);
        arg0.protocol_unclaimed = 0;
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events::fees_claimed(arg1, 0x1::ascii::string(b"protocol"), 0x1::option::none<0x2::object::ID>(), v0, 0x2::clock::timestamp_ms(arg2));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.funds, v0, arg3), arg1);
    }

    public fun preview_split(arg0: u64, arg1: bool) : (u64, u64, u64) {
        let v0 = 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::math::mul_bps(arg0, 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::creator_bps());
        let v1 = if (arg1) {
            0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::math::mul_bps(arg0, 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::referrer_bps())
        } else {
            0
        };
        (v0, v1, arg0 - v0 - v1)
