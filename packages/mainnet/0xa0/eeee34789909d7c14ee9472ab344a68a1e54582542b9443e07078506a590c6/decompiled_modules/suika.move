module 0xa0eeee34789909d7c14ee9472ab344a68a1e54582542b9443e07078506a590c6::suika {
    ...
    fun init(arg0: SUIKA, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUIKA>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUIKA"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"SUIKA "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreifdccteswmxnzdi5abc3n4ibxabwrq3v7jqljz7a6xjirtc2cysti"));
