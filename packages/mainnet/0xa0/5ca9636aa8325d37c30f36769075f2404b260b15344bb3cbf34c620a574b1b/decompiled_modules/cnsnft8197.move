module 0xa05ca9636aa8325d37c30f36769075f2404b260b15344bb3cbf34c620a574b1b::cnsnft8197 {
    struct CNSNFT8197 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8197, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8197>(arg0, arg1);
