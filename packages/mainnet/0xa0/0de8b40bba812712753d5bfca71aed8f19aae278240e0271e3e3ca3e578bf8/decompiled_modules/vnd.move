module 0xa00de8b40bba812712753d5bfca71aed8f19aae278240e0271e3e3ca3e578bf8::vnd {
    struct VND has drop {
        dummy_field: bool,
    }

    fun init(arg0: VND, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<VND>(arg0, 6, b"VND", b"VUNDIO", b"Start to manage your collectibles on SUI Network. Vundio's sleek design and user-friendly features make the experience enjoyable and efficient. $VND.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/photo_2024_05_26_23_16_48_5aa0975d12.jpg")), arg1);
