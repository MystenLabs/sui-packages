module 0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::flow_x_router {
    ...
    public entry fun buy_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3 >= arg3, 1);
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<T0>(v2, 0x2::tx_context::sender(arg6));
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<0x2::sui::SUI>(arg4, 0x2::tx_context::sender(arg6));
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg4, v0, arg6), arg0.admin);
        let v4 = BuyEvent<T0>{
    ...
    public entry fun buy_exact_in_usdc<T0>(arg0: &FeeObject, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg4: u64, arg5: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg6: u64, arg7: 0x1::string::String, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2;
        let v4 = v1;
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(v0, 0x2::tx_context::sender(arg9), arg9);
        ...
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg5, 0x2::tx_context::sender(arg9));
        let v6 = 0x2::coin::from_balance<0x2::sui::SUI>(v4, arg9);
        let v7 = v5 * arg0.buy_fee / 10000;
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v6, v7, arg9), arg0.admin);
        let v8 = 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::router::swap_exact_input_direct<0x2::sui::SUI, T0>(arg2, 0x2::coin::split<0x2::sui::SUI>(&mut v6, v5 - v7, arg9), arg9);
        let v9 = 0x2::coin::value<T0>(&v8);
        assert!(v9 >= arg6, 1);
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<T0>(v8, 0x2::tx_context::sender(arg9));
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<0x2::sui::SUI>(v6, 0x2::tx_context::sender(arg9));
    ...
    public entry fun sell_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 - v2 >= arg3, 1);
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<T0>(arg4, 0x2::tx_context::sender(arg6));
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg6));
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v2, arg6), arg0.admin);
        let v3 = SellEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg6),
            amount_in  : arg2,
            amount_out : v1 - v2,
    ...
    public entry fun sell_exact_in_usdc<T0>(arg0: &FeeObject, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: u64, arg7: 0x1::string::String, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::coin::value<0x2::sui::SUI>(&v0);
        let v2 = v1 * arg0.sell_fee / 10000;
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<T0>(arg5, 0x2::tx_context::sender(arg9));
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v2, arg9), arg0.admin);
        ...
        assert!(v8 >= arg6, 1);
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(v7, 0x2::tx_context::sender(arg9), arg9);
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_balance<0x2::sui::SUI>(v4, 0x2::tx_context::sender(arg9), arg9);
        0xa0c3a79a9a871b310971d43cc38cf3cf8157c3b85639a00c384716ee868e2d71::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg9));
