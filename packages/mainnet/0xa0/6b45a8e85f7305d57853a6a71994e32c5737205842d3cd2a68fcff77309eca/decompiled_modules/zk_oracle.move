module 0x8f6221a353c4ea356ea386893d1b9816a9392bf84c0b750ceb6c976eeaa598c8::zk_oracle {
    ...
    public fun create_oracle_v2(arg0: &0x8f6221a353c4ea356ea386893d1b9816a9392bf84c0b750ceb6c976eeaa598c8::agent_policy::AdminCap, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = ZkRiskOracleV2{
        ...
        0x2::transfer::share_object<ZkRiskOracleV2>(v0);
    }
    ...
    public fun get_latest_score_v2(arg0: &ZkRiskOracleV2) : u64 {
        arg0.latest_score
    }
    ...
    public fun get_verification_count_v2(arg0: &ZkRiskOracleV2) : u64 {
        arg0.verification_count
    }
    ...
    public fun submit_proof_v2(arg0: &mut ZkRiskOracleV2, arg1: u64, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock) {
        assert!(arg1 <= 500, 1);
        let v0 = 0x2::groth16::bn254();
