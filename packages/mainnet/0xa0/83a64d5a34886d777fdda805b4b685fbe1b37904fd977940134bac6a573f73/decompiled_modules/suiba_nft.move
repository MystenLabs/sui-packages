module 0xa083a64d5a34886d777fdda805b4b685fbe1b37904fd977940134bac6a573f73::suiba_nft {
    ...
    fun create_nft(arg0: &SuibaCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : SuibaNFT {
        ...
        let v5 = 0x1::string::utf8(b"The coolest blue dog on Sui. Suiba #");
        0x1::string::append(&mut v5, v2);
        0x1::string::append(&mut v5, 0x1::string::utf8(b" is part of the exclusive Suiba collection."));
        SuibaNFT{
