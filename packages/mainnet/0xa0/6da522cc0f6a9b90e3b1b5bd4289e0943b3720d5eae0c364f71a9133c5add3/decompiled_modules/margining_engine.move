module 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::margining_engine {
    ...
    public(friend) fun apply_maths_internal(arg0: &0x2::table::Table<0x1::string::String, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::perpetual::Perpetual>, arg1: &0x2::table::Table<0x1::string::String, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::bank::Asset>, arg2: &0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::perpetual::Perpetual, arg3: &0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::Account, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: bool, arg9: bool, arg10: u8, arg11: 0x1::option::Option<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::signed_number::Number>, arg12: 0x1::option::Option<bool>, arg13: u64) : (u64, u64, 0x1::string::String, vector<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::Position>, u64, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::Position, vector<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::DepositedAsset>, u64, u64) {
        ...
        let (v23, v24) = settle_pnl(arg1, v7, v15, v22, arg9, arg8, arg10);
        let (v25, v26) = settle_pending_funding_payment(arg1, v7, v17, arg5, v11, v23, v24, arg8, arg10);
        let (v27, v28, v29) = settle_fee(arg1, arg2, arg3, v7, arg5, arg4, arg9, arg10);
        let (v30, v31) = settle_margin(v7, v25, v20, v21, v26, calculate_effective_leverage(arg8, v11, v12, v15, arg6), arg9, arg8, arg10);
        premium_or_debt_settlement(v7, arg11, arg9, arg10);
        0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::set_isolated_position_assets(&mut v3, v30);
        if (!arg8) {
            arg6 = 0;
        };
        0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::update_position_values(v8, v20, v21, v30, arg6, v19, 0);
        ...
        v3 = v33;
        (v27, v28, v29, v2, v9, *v8, v3, v31, settle_gas_charges(arg13, v7, arg3, arg12, arg9, arg10))
    }

    public fun calculate_effective_leverage(arg0: bool, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        if (arg0) {
            if (arg1 > 0 && arg3 > 0) {
                (((arg2 as u128) * (arg1 as u128) / (arg3 as u128)) as u64)
            } else {
                arg4
            }
        } else {
    ...
    public fun get_withdrawable_assets(arg0: &0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::data_store::InternalDataStore, arg1: address, arg2: vector<u8>) : u64 {
        ...
        let v5 = if (0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::signed_number::gt_uint(v4, 0)) {
            0x1::u64::min((0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::signed_number::value(v4) as u64), (0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::get_asset_quantity(&v3, arg2) as u64))
        } else {
            0
        };
        (v5 as u64)
    ...
    fun settle_margin(arg0: &mut vector<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::DepositedAsset>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: bool, arg7: bool, arg8: u8) : (u64, u64) {
        let v0 = arg1;
        if (arg7) {
            let v1 = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::utils::base_div(0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::utils::base_mul(arg2, arg3), arg5);
            v0 = v1;
    ...
    fun settle_pending_funding_payment(arg0: &0x2::table::Table<0x1::string::String, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::bank::Asset>, arg1: &mut vector<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::DepositedAsset>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: u8) : (u64, u64) {
        if (arg2 == 0 || arg8 != 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::action_liquidate()) {
            return (arg5, arg6)
        };
        ...
        if (arg7) {
            ...
            let v2 = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::get_total_effective_balance(arg1, arg0);
            if (v2 < v0) {
                let v3 = arg6 + v0;
                arg6 = v3 - v2;
                0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::sub_margin_from_asset_vector(arg1, v2, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::empty_string());
            } else {
                0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::sub_margin_from_asset_vector(arg1, v0, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::empty_string());
            };
        };
        (arg5, arg6)
    }
    ...
    fun settle_pnl(arg0: &0x2::table::Table<0x1::string::String, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::bank::Asset>, arg1: &mut vector<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::DepositedAsset>, arg2: u64, arg3: 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::signed_number::Number, arg4: bool, arg5: bool, arg6: u8) : (u64, u64) {
        ...
        let v1 = 0;
        let v2 = arg2;
        if (0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::signed_number::gte_uint(arg3, 0) && (arg6 != 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::action_deleverage() || !arg4)) {
            if (arg5) {
                v2 = arg2 + v0;
            } else {
                0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::add_margin_to_asset_vector(arg1, v0, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::empty_string());
            };
        } else if (arg5) {
            ...
            let v5 = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::get_total_effective_balance(arg1, arg0);
            if (v5 < v0) {
                v1 = v0 - v5;
            };
            let v6 = if (v1 == 0) {
            ...
            0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::sub_margin_from_asset_vector(arg1, v6, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::empty_string());
        };
        (v2, v1)
    }
    ...
    public(friend) fun verify_health(arg0: &0x2::table::Table<0x1::string::String, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::perpetual::Perpetual>, arg1: &0x2::table::Table<0x1::string::String, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::bank::Asset>, arg2: &vector<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::DepositedAsset>, arg3: &vector<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::Position>, arg4: &vector<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::DepositedAsset>, arg5: &vector<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::Position>, arg6: u64, arg7: u8, arg8: bool) {
        ...
        let v23 = if (arg8 && (arg7 == 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::action_liquidate() || arg7 == 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::action_deleverage())) {
            true
        } else if (0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::signed_number::gte_uint(v21, 0)) {
            true
        } else {
            0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::signed_number::gte(v21, v22)
        };
        ...
        let v25 = if (0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::signed_number::gt_uint(v20, 0)) {
            true
        } else if (arg7 == 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::action_add_margin()) {
            true
        } else {
