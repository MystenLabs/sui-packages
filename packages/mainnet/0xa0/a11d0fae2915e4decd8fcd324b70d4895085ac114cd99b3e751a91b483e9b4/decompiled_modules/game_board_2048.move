module 0xa0a11d0fae2915e4decd8fcd324b70d4895085ac114cd99b3e751a91b483e9b4::game_board_2048 {
    struct GameBoard2048 has copy, drop, store {
        packed_spaces: u64,
        score: u64,
    ...
    fun add_new_tile(arg0: &mut GameBoard2048, arg1: u64, arg2: vector<u8>) : u64 {
    ...
    public(friend) fun board_space_at(arg0: &GameBoard2048, arg1: u8, arg2: u8) : u64 {
    ...
    public(friend) fun default(arg0: vector<u8>) : GameBoard2048 {
    ...
    public(friend) fun empty_space_count(arg0: &GameBoard2048) : u64 {
        let v0 = empty_space_positions(arg0, 4);
        0x1::vector::length<SpacePosition>(&v0)
    }

    public(friend) fun empty_space_positions(arg0: &GameBoard2048, arg1: u64) : vector<SpacePosition> {
    ...
    public(friend) fun game_over(arg0: &GameBoard2048) : &bool {
        &arg0.game_over
    }

    public(friend) fun last_tile(arg0: &GameBoard2048) : &vector<u64> {
        &arg0.last_tile
    }
    ...
    public(friend) fun move_direction(arg0: &mut GameBoard2048, arg1: u64, arg2: vector<u8>) {
    ...
    fun move_possible(arg0: &GameBoard2048) : bool {
        let v0 = 4;
        let v1 = 4;
        let v2 = 0;
        while (v2 < v0) {
    ...
    public(friend) fun packed_spaces(arg0: &GameBoard2048) : &u64 {
        &arg0.packed_spaces
    }
    ...
    public(friend) fun score(arg0: &GameBoard2048) : &u64 {
        &arg0.score
    }
    ...
    public(friend) fun top_tile(arg0: &GameBoard2048) : &u64 {
        &arg0.top_tile
    }
