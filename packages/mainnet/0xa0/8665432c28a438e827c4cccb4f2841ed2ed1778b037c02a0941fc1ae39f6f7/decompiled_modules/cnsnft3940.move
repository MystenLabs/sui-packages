module 0xa08665432c28a438e827c4cccb4f2841ed2ed1778b037c02a0941fc1ae39f6f7::cnsnft3940 {
    struct CNSNFT3940 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3940, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3940>(arg0, arg1);
