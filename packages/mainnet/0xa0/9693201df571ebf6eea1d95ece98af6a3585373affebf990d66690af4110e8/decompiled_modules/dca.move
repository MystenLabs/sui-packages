module 0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::dca {
    ...
    public(friend) fun apply_fee<T0>(arg0: &mut DCAReg, arg1: &mut 0x2::coin::Coin<T0>) {
        ...
        0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::event::charge_fee<T0>(v0);
    }

    public fun assert_not_expired<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0x2::clock::Clock) {
        assert!(0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::utils::get_sec(arg1) <= arg0.end_time + 10 * 0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::utils::minute(), 111);
    }

    public fun assert_time_window<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0x2::clock::Clock) {
        assert!(0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::utils::get_sec(arg1) <= get_current_epoch<T0, T1>(arg0, arg1) * arg0.frequency + arg0.deposit_time + 10 * 0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::utils::minute(), 114);
    }
    ...
    public entry fun claim_fee<T0>(arg0: &mut DCAReg, arg1: &DCACap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::event::claim_fee<T0>(0x2::tx_context::sender(arg3), arg2);
    }

    public fun clear_escrow_with_cap<T0, T1>(arg0: &mut DCAReg, arg1: &DCACap, arg2: Escrow<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(balance_x_value<T0, T1>(&arg2) == 0, 115);
        let (v0, v1) = close_escrow_<T0, T1>(arg0, arg2, arg3);
        0x2::coin::destroy_zero<T0>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v1, arg2.owner);
    }
    ...
    fun close_escrow_<T0, T1>(arg0: &mut DCAReg, arg1: Escrow<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::event::order_closed<T0, T1>(0x2::object::uid_to_inner(&v21), v1, 0x2::coin::value<T0>(&v22), 0x2::coin::value<T1>(&v23));
        (v22, v23)
    }
    ...
    public fun execute_order<T0, T1>(arg0: &mut Escrow<T0, T1>, arg1: &DCACap, arg2: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, SwapReceipt<T0, T1>) {
        ...
        let v2 = SwapReceipt<T0, T1>{
            ...
            ts        : 0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::utils::get_sec(arg3),
            spent     : v0,
            amount    : v1,
        };
    ...
    public fun get_current_epoch<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        get_epoch<T0, T1>(arg0, 0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::utils::get_sec(arg1))
    }
    ...
    public fun get_escrow_required_amount<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock) : (u64, u64) {
        let v0 = if (arg0.price_enabled) {
            ...
            0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::utils::mul_div(get_output_y<T0, T1>(arg0, arg1, arg0.divided_amount, arg2), 10000 - 50, 10000)
        };
    ...
    public fun place_order<T0, T1>(arg0: &mut DCAReg, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::coin::CoinMetadata<T1>, arg5: u64, arg6: u64, arg7: bool, arg8: u128, arg9: u128, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v6 = Escrow<T0, T1>{
            ...
            frequency              : arg5,
            divided_amount         : v1,
            last_claimed           : 0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::utils::get_sec(arg10),
            filled_orders          : 0,
            balance_x              : v2,
            ...
            min_price              : v4,
            max_price              : v5,
            deposit_time           : 0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::utils::get_sec(arg10),
            end_time               : 0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::utils::get_sec(arg10) + arg6 * arg5,
            total_spent            : 0,
            total_withdrawn_amount : 0,
        };
        0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::event::order_created<T0, T1>(0x2::object::id<Escrow<T0, T1>>(&v6), arg1, 0x2::coin::value<T0>(&arg2), arg6, arg5, v4, v5);
    ...
    public fun repay_order<T0, T1>(arg0: &mut DCAReg, arg1: &DCACap, arg2: &mut Escrow<T0, T1>, arg3: SwapReceipt<T0, T1>, arg4: 0x2::coin::Coin<T1>) {
        ...
        0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::event::order_executed<T0, T1>(0x2::object::id<Escrow<T0, T1>>(arg2), arg2.owner, v1, v2, v3, balance_x_value<T0, T1>(arg2), balance_y_value<T0, T1>(arg2), arg2.filled_orders);
    }
    ...
    public entry fun update_price<T0, T1>(arg0: &mut Escrow<T0, T1>, arg1: bool, arg2: u128, arg3: u128, arg4: &0x2::tx_context::TxContext) {
        ...
        arg0.min_price = arg2;
        arg0.max_price = arg3;
        0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::event::price_updated<T0, T1>(0x2::object::id<Escrow<T0, T1>>(arg0), arg0.owner, arg0.price_enabled, arg0.min_price, arg0.max_price);
    }
    ...
    public fun withdraw<T0, T1>(arg0: &mut Escrow<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0xa09693201df571ebf6eea1d95ece98af6a3585373affebf990d66690af4110e8::event::order_withdrew<T0, T1>(0x2::object::id<Escrow<T0, T1>>(arg0), arg0.owner, 0x2::coin::value<T1>(&v0));
        v0
    }
