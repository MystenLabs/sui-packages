module 0xb49b5ac21dcc5e26eeb4c59dd6360d962030586c003958bd30b24663f9b30935::events {
    ...
    public fun log_combat_core_stats_v2(arg0: &LoggerState, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(0x2::vec_set::contains<address>(&arg0.loggers, &v0), 0);
        let v1 = CombatCoreStats{
            match_uuid : arg1,
            player_id  : arg2,
            kills      : arg3,
    ...
    public fun log_damage_breakdown_v2(arg0: &LoggerState, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg9);
        assert!(0x2::vec_set::contains<address>(&arg0.loggers, &v0), 0);
        let v1 = DamageBreakdown{
            match_uuid                     : arg1,
            player_id                      : arg2,
            damage_to_players_by_gun       : arg3,
            damage_to_monsters_by_gun      : arg4,
            damage_to_players_by_active    : arg5,
            damage_to_monsters_by_active   : arg6,
            damage_to_players_by_ultimate  : arg7,
            damage_to_monsters_by_ultimate : arg8,
        };
        0x2::event::emit<DamageBreakdown>(v1);
    }
    ...
    public fun log_item_acquisition_v2(arg0: &LoggerState, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(0x2::vec_set::contains<address>(&arg0.loggers, &v0), 0);
        let v1 = ItemAcquisition{
            match_uuid          : arg1,
            player_id           : arg2,
            weapons_acquired    : arg3,
            armors_acquired     : arg4,
            hp_potions_acquired : arg5,
            sp_potions_acquired : arg6,
            grenades_acquired   : arg7,
        };
        0x2::event::emit<ItemAcquisition>(v1);
    }
    ...
    public fun log_match_metadata_v2(arg0: &LoggerState, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun log_monster_kill_breakdown_v2(arg0: &LoggerState, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(0x2::vec_set::contains<address>(&arg0.loggers, &v0), 0);
        let v1 = MonsterKillBreakdown{
            match_uuid             : arg1,
            player_id              : arg2,
            normal_monsters_killed : arg3,
            elite_monsters_killed  : arg4,
            boss_monsters_killed   : arg5,
        };
        0x2::event::emit<MonsterKillBreakdown>(v1);
    }
    ...
    public fun log_motus_economy_v2(arg0: &LoggerState, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(0x2::vec_set::contains<address>(&arg0.loggers, &v0), 0);
        let v1 = MotusEconomy{
            match_uuid        : arg1,
            player_id         : arg2,
            total_motus       : arg3,
            extracted_motus   : arg4,
            unextracted_motus : arg5,
            unrecovered_motus : arg6,
            earned_credit     : arg7,
        };
        0x2::event::emit<MotusEconomy>(v1);
    }
    ...
    public fun log_player_identity_v2(arg0: &LoggerState, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun log_player_progression_v2(arg0: &LoggerState, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(0x2::vec_set::contains<address>(&arg0.loggers, &v0), 0);
        let v1 = PlayerProgression{
            match_uuid      : arg1,
    ...
    public fun log_skill_usage_v2(arg0: &LoggerState, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(0x2::vec_set::contains<address>(&arg0.loggers, &v0), 0);
        let v1 = SkillUsage{
            match_uuid              : arg1,
            player_id               : arg2,
            active_skill_uses       : arg3,
            ultimate_skill_uses     : arg4,
            selected_active_skill   : arg5,
            selected_passive_skill  : arg6,
            selected_ultimate_skill : arg7,
        };
        0x2::event::emit<SkillUsage>(v1);
    }
    ...
    public fun log_support_utility_actions_v2(arg0: &LoggerState, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(0x2::vec_set::contains<address>(&arg0.loggers, &v0), 0);
        let v1 = SupportUtilityActions{
            match_uuid           : arg1,
            player_id            : arg2,
            revive_allies        : arg3,
            monster_beacon_opens : arg4,
            distance_traveled    : arg5,
        };
        0x2::event::emit<SupportUtilityActions>(v1);
    }
    ...
    public fun log_survival_outcome_v2(arg0: &LoggerState, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: bool, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(0x2::vec_set::contains<address>(&arg0.loggers, &v0), 0);
        let v1 = SurvivalOutcome{
            match_uuid     : arg1,
