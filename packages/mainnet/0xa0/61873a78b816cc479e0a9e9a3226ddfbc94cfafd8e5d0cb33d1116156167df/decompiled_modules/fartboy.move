module 0xa061873a78b816cc479e0a9e9a3226ddfbc94cfafd8e5d0cb33d1116156167df::fartboy {
    ...
    fun init(arg0: FARTBOY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"7928f0c59d3650f32fb0c73131c5bb848ccba67fc444509a180c60db79512a75                                                                                                                                                                                                                                                                ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4, v5) = 0x2::coin::create_regulated_currency_v2<FARTBOY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"FARTBOY   ")))), trim_right(b"Fartboy OFFICIAL                "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, false, arg1);
        let v6 = v3;
        let v7 = &mut v6;
