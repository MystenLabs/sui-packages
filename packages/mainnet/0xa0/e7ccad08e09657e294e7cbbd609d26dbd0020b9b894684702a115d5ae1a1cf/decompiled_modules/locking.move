module 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::locking {
    ...
    public fun can_emergency_pause(arg0: &LockUpManager, arg1: address) : bool {
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::is_authorized(&arg0.id, emergency_pause_acl_key(), arg1)
    }

    public fun can_pause_convert(arg0: &LockUpManager, arg1: address) : bool {
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::is_authorized(&arg0.id, convert_pause_acl_key(), arg1)
    }
    ...
    public fun cancel_redeem_lock_v2(arg0: &mut LockUpManager, arg1: &mut 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::XcetusManager, arg2: &mut 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT, arg3: 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::lock_coin_v2::LockedCoinV2<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>, arg4: &0x2::clock::Clock) {
        checked_package_version(arg0);
        assert!(0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::lock_coin_v2::lock_time<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(&arg3) > 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::utils::now_timestamp(arg4), 5);
        let v0 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow<0x2::object::ID, LockInfo>(&arg0.lock_infos, 0x2::object::id<0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::lock_coin_v2::LockedCoinV2<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>>(&arg3));
        assert!(v0.venft_id == 0x2::object::id<0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT>(arg2), 4);
        assert!(0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::lock_coin_v2::value<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(&arg3) == v0.cetus_amount, 4);
        let (v1, v2) = 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::lock_coin_v2::destroy_for_cancel<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(arg3);
        assert!(v2 == v0.lock_id, 4);
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::update_unlocked(arg1, arg2, v0.xcetus_amount);
        0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::remove<0x2::object::ID, LockInfo>(&mut arg0.lock_infos, v0.lock_id);
        receive(arg0, v1);
    ...
    public fun emergency_pause(arg0: &mut LockUpManager, arg1: &mut 0x2::tx_context::TxContext) {
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::assert_authorized(&arg0.id, emergency_pause_acl_key(), 0x2::tx_context::sender(arg1));
    ...
    public fun grant_convert_pause_operator(arg0: &AdminCap, arg1: &mut LockUpManager, arg2: address) {
        checked_package_version(arg1);
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::grant(&mut arg1.id, convert_pause_acl_key(), arg2);
    }

    public fun grant_emergency_pause_operator(arg0: &AdminCap, arg1: &mut LockUpManager, arg2: address) {
        checked_package_version(arg1);
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::grant(&mut arg1.id, emergency_pause_acl_key(), arg2);
    }
    ...
    public fun redeem_v2(arg0: &mut LockUpManager, arg1: &mut 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::XcetusManager, arg2: &mut 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT, arg3: 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::lock_coin_v2::LockedCoinV2<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0.venft_id == 0x2::object::id<0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT>(arg2), 4);
        assert!(0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::lock_coin_v2::value<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(&arg3) == v0.cetus_amount, 4);
        let v1 = 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::lock_coin_v2::unlock_coin<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(arg3, arg4, arg5);
        assert!(v1 == v0.lock_id, 4);
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::update_unlocked(arg1, arg2, v0.xcetus_amount);
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::burn(arg1, arg2, v0.xcetus_amount, arg5);
        let v2 = v0.cetus_amount;
    ...
    public fun revoke_convert_pause_operator(arg0: &AdminCap, arg1: &mut LockUpManager, arg2: address) {
        checked_package_version(arg1);
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::revoke(&mut arg1.id, convert_pause_acl_key(), arg2);
    }

    public fun revoke_emergency_pause_operator(arg0: &AdminCap, arg1: &mut LockUpManager, arg2: address) {
        checked_package_version(arg1);
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::revoke(&mut arg1.id, emergency_pause_acl_key(), arg2);
    }

    public fun set_convert_paused(arg0: &mut LockUpManager, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::assert_authorized(&arg0.id, convert_pause_acl_key(), 0x2::tx_context::sender(arg2));
