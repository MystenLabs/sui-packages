module 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus {
    ...
    struct DividendCorrectionKey has copy, drop, store {
        venft_id: 0x2::object::ID,
    }
    ...
    struct DividendCorrectionUpdateEvent has copy, drop, store {
        venft_id: 0x2::object::ID,
        old_correction: u64,
        new_correction: u64,
        total_correction: u64,
    }
    ...
    public fun can_set_dividend_correction(arg0: &XcetusManager, arg1: address) : bool {
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::is_authorized(&arg0.id, dividend_correction_acl_key(), arg1)
    }
    ...
    public fun dividend_correction(arg0: &XcetusManager, arg1: 0x2::object::ID) : u64 {
        let v0 = dividend_correction_key(arg1);
        if (0x2::dynamic_field::exists_with_type<DividendCorrectionKey, u64>(&arg0.id, v0)) {
            *0x2::dynamic_field::borrow<DividendCorrectionKey, u64>(&arg0.id, v0)
        } else {
            0
        }
    }

    fun dividend_correction_acl_key() : vector<u8> {
        b"dividend_correction"
    }

    fun dividend_correction_key(arg0: 0x2::object::ID) : DividendCorrectionKey {
        DividendCorrectionKey{venft_id: arg0}
    }

    public fun effective_totol_amount(arg0: &XcetusManager) : u64 {
        let v0 = totol_amount(arg0);
        let v1 = total_dividend_correction(arg0);
        if (v0 > v1) {
            v0 - v1
        } else {
            0
    ...
    public fun effective_xcetus_amount(arg0: &XcetusManager, arg1: &VeNftInfo) : u64 {
        let v0 = dividend_correction(arg0, arg1.id);
        if (arg1.xcetus_amount > v0) {
            arg1.xcetus_amount - v0
        } else {
            0
        }
    }

    public fun grant_dividend_correction_operator(arg0: &AdminCap, arg1: &mut XcetusManager, arg2: address) {
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::grant(&mut arg1.id, dividend_correction_acl_key(), arg2);
    }
    ...
    public fun revoke_dividend_correction_operator(arg0: &AdminCap, arg1: &mut XcetusManager, arg2: address) {
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::revoke(&mut arg1.id, dividend_correction_acl_key(), arg2);
    }

    public fun set_dividend_correction(arg0: &mut XcetusManager, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::assert_authorized(&arg0.id, dividend_correction_acl_key(), 0x2::tx_context::sender(arg3));
        set_dividend_correction_internal(arg0, arg1, arg2);
    }

    fun set_dividend_correction_internal(arg0: &mut XcetusManager, arg1: 0x2::object::ID, arg2: u64) {
        assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<0x2::object::ID, VeNftInfo>(&arg0.nfts, arg1), 7);
        let v0 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow<0x2::object::ID, VeNftInfo>(&arg0.nfts, arg1);
        assert!(arg2 <= v0.xcetus_amount, 12);
        assert!(arg2 <= v0.lock_amount, 14);
        let v1 = dividend_correction_key(arg1);
        let v2 = dividend_correction(arg0, arg1);
        if (0x2::dynamic_field::exists_with_type<DividendCorrectionKey, u64>(&arg0.id, v1)) {
            *0x2::dynamic_field::borrow_mut<DividendCorrectionKey, u64>(&mut arg0.id, v1) = arg2;
        } else {
            0x2::dynamic_field::add<DividendCorrectionKey, u64>(&mut arg0.id, v1, arg2);
        };
        let v3 = if (arg2 >= v2) {
            total_dividend_correction(arg0) + arg2 - v2
        } else {
            total_dividend_correction(arg0) - v2 - arg2
        };
        set_total_dividend_correction(arg0, v3);
        let v4 = DividendCorrectionUpdateEvent{
            venft_id         : arg1,
            old_correction   : v2,
            new_correction   : arg2,
            total_correction : v3,
        };
        0x2::event::emit<DividendCorrectionUpdateEvent>(v4);
    }

    public fun set_dividend_corrections(arg0: &mut XcetusManager, arg1: vector<0x2::object::ID>, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) {
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::acl::assert_authorized(&arg0.id, dividend_correction_acl_key(), 0x2::tx_context::sender(arg3));
        assert!(0x1::vector::length<0x2::object::ID>(&arg1) == 0x1::vector::length<u64>(&arg2), 13);
        while (!0x1::vector::is_empty<0x2::object::ID>(&arg1)) {
            set_dividend_correction_internal(arg0, 0x1::vector::pop_back<0x2::object::ID>(&mut arg1), 0x1::vector::pop_back<u64>(&mut arg2));
        };
        0x1::vector::destroy_empty<0x2::object::ID>(arg1);
        0x1::vector::destroy_empty<u64>(arg2);
    }

    fun set_total_dividend_correction(arg0: &mut XcetusManager, arg1: u64) {
        if (0x2::dynamic_field::exists_with_type<vector<u8>, u64>(&arg0.id, total_dividend_correction_key())) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, u64>(&mut arg0.id, total_dividend_correction_key()) = arg1;
        } else {
            0x2::dynamic_field::add<vector<u8>, u64>(&mut arg0.id, total_dividend_correction_key(), arg1);
        };
    }

    public fun total_dividend_correction(arg0: &XcetusManager) : u64 {
        if (0x2::dynamic_field::exists_with_type<vector<u8>, u64>(&arg0.id, total_dividend_correction_key())) {
            *0x2::dynamic_field::borrow<vector<u8>, u64>(&arg0.id, total_dividend_correction_key())
        } else {
            0
        }
    }

    fun total_dividend_correction_key() : vector<u8> {
        b"total_dividend_correction"
    }
