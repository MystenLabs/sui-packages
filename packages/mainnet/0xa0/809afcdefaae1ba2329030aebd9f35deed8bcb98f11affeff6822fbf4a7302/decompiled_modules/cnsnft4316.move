module 0xa0809afcdefaae1ba2329030aebd9f35deed8bcb98f11affeff6822fbf4a7302::cnsnft4316 {
    struct CNSNFT4316 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4316, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4316>(arg0, arg1);
