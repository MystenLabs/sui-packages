module 0xa0c0be5c898e4380bb465ee8fe8ffb62f5860ae70f65ffc0a1f346386b1ac6e9::reward3050 {
    struct REWARD3050 has drop {
        dummy_field: bool,
    }

    struct TICKET_3050 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3050(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3050>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3050>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3050, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3050>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3050>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3050>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3050>>(v5, 0x2::tx_context::sender(arg1));
    }
