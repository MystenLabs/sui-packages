module 0x9ed231de8d1b21aa940d450f363d4b2fc4366aeba85300d21abc887b3961e21::cnsnft2348 {
    struct CNSNFT2348 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2348, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2348>(arg0, arg1);
