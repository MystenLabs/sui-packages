module 0x90d2ff30db14bf51f1a5dd429d7b4ef328ede34769d550c715a12ffad3ca7fd::cnsnft9580 {
    struct CNSNFT9580 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9580, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9580>(arg0, arg1);
