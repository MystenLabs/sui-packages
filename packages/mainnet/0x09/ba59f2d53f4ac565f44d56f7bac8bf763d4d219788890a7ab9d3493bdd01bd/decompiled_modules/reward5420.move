module 0x9ba59f2d53f4ac565f44d56f7bac8bf763d4d219788890a7ab9d3493bdd01bd::reward5420 {
    struct REWARD5420 has drop {
        dummy_field: bool,
    }

    struct TICKET_5420 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5420(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5420>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5420>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5420, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5420>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5420>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5420>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5420>>(v5, 0x2::tx_context::sender(arg1));
    }
