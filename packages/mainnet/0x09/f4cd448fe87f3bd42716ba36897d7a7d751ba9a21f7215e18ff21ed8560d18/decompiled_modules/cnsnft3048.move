module 0x9f4cd448fe87f3bd42716ba36897d7a7d751ba9a21f7215e18ff21ed8560d18::cnsnft3048 {
    struct CNSNFT3048 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3048, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9715"));
        let v4 = 0x2::package::claim<CNSNFT3048>(arg0, arg1);
