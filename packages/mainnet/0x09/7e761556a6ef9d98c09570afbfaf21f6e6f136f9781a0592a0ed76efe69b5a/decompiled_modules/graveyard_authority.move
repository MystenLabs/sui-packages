module 0x97e761556a6ef9d98c09570afbfaf21f6e6f136f9781a0592a0ed76efe69b5a::graveyard_authority {
    ...
    struct GraveyardCap has store, key {
        id: 0x2::object::UID,
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = GraveyardCap{id: 0x2::object::new(arg0)};
        0x2::transfer::public_transfer<GraveyardCap>(v2, 0x2::tx_context::sender(arg0));
