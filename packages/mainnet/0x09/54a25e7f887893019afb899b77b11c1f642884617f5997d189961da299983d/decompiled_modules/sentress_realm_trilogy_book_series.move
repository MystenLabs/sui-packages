module 0x954a25e7f887893019afb899b77b11c1f642884617f5997d189961da299983d::sentress_realm_trilogy_book_series {
    struct SENTRESS_REALM_TRILOGY_BOOK_SERIES has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SENTRESS_REALM_TRILOGY_BOOK_SERIES, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SENTRESS_REALM_TRILOGY_BOOK_SERIES>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sentress Realm Trilogy Book Series"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Collectable NFTS featuring characters from the Sentress Realm Trilogy Book Series. Not just an NFT...not just a coin..not just a book...not just a game."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://s7BYapW1Ur0arkhd9-aMcoJXmY0T5M3KYGQZd3gQHPw"));
