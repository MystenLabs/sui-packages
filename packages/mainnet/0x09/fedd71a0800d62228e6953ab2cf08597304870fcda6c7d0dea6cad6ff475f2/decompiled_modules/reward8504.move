module 0x9fedd71a0800d62228e6953ab2cf08597304870fcda6c7d0dea6cad6ff475f2::reward8504 {
    struct REWARD8504 has drop {
        dummy_field: bool,
    }

    struct TICKET_8504 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8504(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8504>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8504>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8504, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8504>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8504>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8504>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8504>>(v5, 0x2::tx_context::sender(arg1));
    }
