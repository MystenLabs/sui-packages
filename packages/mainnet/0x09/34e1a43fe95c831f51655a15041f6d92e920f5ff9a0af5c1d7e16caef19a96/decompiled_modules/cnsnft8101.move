module 0x934e1a43fe95c831f51655a15041f6d92e920f5ff9a0af5c1d7e16caef19a96::cnsnft8101 {
    struct CNSNFT8101 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8101, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8101>(arg0, arg1);
