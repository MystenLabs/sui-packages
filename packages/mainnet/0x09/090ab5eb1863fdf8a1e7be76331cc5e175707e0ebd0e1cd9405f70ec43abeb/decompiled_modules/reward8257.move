module 0x9090ab5eb1863fdf8a1e7be76331cc5e175707e0ebd0e1cd9405f70ec43abeb::reward8257 {
    struct REWARD8257 has drop {
        dummy_field: bool,
    }

    struct TICKET_8257 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8257(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8257>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8257>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8257, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8257>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8257>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8257>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8257>>(v5, 0x2::tx_context::sender(arg1));
    }
