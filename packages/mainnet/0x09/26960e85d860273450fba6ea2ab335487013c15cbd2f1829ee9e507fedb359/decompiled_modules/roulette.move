module 0xaaf31cee7b44907a0484b044a87a77a168da5701b1c6611ba85fca5633ff5010::roulette {
    ...
    public fun place_bet_with_voucher<T0>(arg0: &mut 0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::unihouse::UniHouse, arg1: &mut RouletteConfig<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0xaaf31cee7b44907a0484b044a87a77a168da5701b1c6611ba85fca5633ff5010::voucher::Voucher<T0>, arg4: u64, arg5: u8, arg6: 0x1::option::Option<u64>, arg7: 0x1::option::Option<0x1::string::String>, arg8: 0x1::option::Option<0x2::object::ID>, arg9: 0x1::option::Option<0x1::string::String>, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0xaaf31cee7b44907a0484b044a87a77a168da5701b1c6611ba85fca5633ff5010::voucher::balance<T0>(arg3);
        assert!(v0 >= arg4, 10);
        0xaaf31cee7b44907a0484b044a87a77a168da5701b1c6611ba85fca5633ff5010::voucher::set_new_balance<T0>(arg3, v0 - arg4);
        0xaaf31cee7b44907a0484b044a87a77a168da5701b1c6611ba85fca5633ff5010::voucher::set_is_used<T0>(arg3);
        let v1 = borrow_current_game_mut<T0>(arg1);
        assert!(0x2::clock::timestamp_ms(arg2) < v1.close_time, 1);
        let (_, _) = 0xaaf31cee7b44907a0484b044a87a77a168da5701b1c6611ba85fca5633ff5010::risk_manager::add_risk(&mut v1.risk_manager, arg5, arg6, 0xaaf31cee7b44907a0484b044a87a77a168da5701b1c6611ba85fca5633ff5010::bet_manager::get_bet_payout(arg4, arg5));
        let v4 = borrow_current_game_mut<T0>(arg1);
        assert!(0xaaf31cee7b44907a0484b044a87a77a168da5701b1c6611ba85fca5633ff5010::risk_manager::total_risk(&v4.risk_manager) <= v4.max_risk, 0);
        assert!(v4.status == 0, 1);
        v4.total_volume = v4.total_volume + arg4;
        assert!(arg4 >= v4.min_bet_size, 2);
        let v5 = 0x2::tx_context::sender(arg10);
        let v6 = Bet<T0>{
            id         : 0x2::object::new(arg10),
            bet_type   : arg5,
            bet_number : arg6,
            bet        : 0x2::coin::into_balance<T0>(0x2::coin::zero<T0>(arg10)),
            player     : v5,
            is_settled : false,
            name       : arg7,
            avatar     : arg8,
        ...
        let v7 = 0x2::balance::value<T0>(&v6.bet);
        let v8 = *0x2::object::uid_as_inner(&v6.id);
        0xaaf31cee7b44907a0484b044a87a77a168da5701b1c6611ba85fca5633ff5010::events::emit_place_bet_with_voucher<T0>(0x2::object::id<0xaaf31cee7b44907a0484b044a87a77a168da5701b1c6611ba85fca5633ff5010::voucher::Voucher<T0>>(arg3), v4.round, 0x2::object::id<Game<T0>>(v4), v8, v6.bet_type, v6.bet_number, v7, v6.player);
        0x2::table_vec::push_back<Bet<T0>>(&mut v4.bets, v6);
        let v9 = BetDisplay<T0>{
            id         : v8,
            bet_type   : arg5,
        ...
        let v11 = Roulette{dummy_field: false};
        0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::unihouse::add_volume<T0, Roulette>(v11, arg0, arg4, arg10);
    }
