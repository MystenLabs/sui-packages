module 0x96f89e444093728b147b93019722b9a1d59d9dead5b4b5564cbf833e2eaa9ec::reward8109 {
    struct REWARD8109 has drop {
        dummy_field: bool,
    }

    struct TICKET_8109 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8109(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_8109>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8109, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8109>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8109>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8109>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8109>>(v5, 0x2::tx_context::sender(arg1));
    }
