module 0x9aad6e943ded5bed1fe1d53ed932d7a8b1cfbbbafda0f8375567699e4c80de4::cnsnft4879 {
    struct CNSNFT4879 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4879, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4879>(arg0, arg1);
