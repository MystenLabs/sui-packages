module 0x95f8d7551275cbb2bd75ce4bf5a86370222351c72c64fde57279f0ed9a511ca::wukong {
    ...
    fun init(arg0: WUKONG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/FR4M1ZtkfQxL8an8EWopj6RoArPLsMd5njbzfuG2hjoi.png?size=lg&key=e9ddf8                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<WUKONG>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"WUKONG  ")))), trim_right(b"SUN WUKONG                      "), trim_right(b"Forge Your Myth, For Glory Fades but Legends Rise.                                                                                                                                                                                                                                                                              "), v2, arg1);
        let v5 = v3;
