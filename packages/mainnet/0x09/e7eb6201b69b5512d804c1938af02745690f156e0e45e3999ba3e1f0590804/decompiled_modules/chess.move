module 0xcd53b9b1f6bec17a3a2643eaf9bd60577e13341f4cfc50f029f3fe51bf493ade::chess {
    ...
    fun fight(arg0: &mut Chess, arg1: &0xa54718d01b0389f1d2cc05241efd0df098b4bf4ae4d26d3f306e0447da4ba87f::lineup::LineUp, arg2: bool, arg3: &0x2::tx_context::TxContext) : bool {
        ...
        loop {
            let v10 = 0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::get_speed(v5);
            let v11 = 0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::get_speed(v7);
            let v12 = v10 > v11;
            if (v10 == v11) {
                let v13 = 0xa54718d01b0389f1d2cc05241efd0df098b4bf4ae4d26d3f306e0447da4ba87f::lineup::get_hash(arg1);
                let v14 = 0xa54718d01b0389f1d2cc05241efd0df098b4bf4ae4d26d3f306e0447da4ba87f::lineup::get_hash(&v0);
            ...
            if (v12) {
                ...
                if (0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::get_hp(v7) == 0 && 0x1::vector::length<0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::Role>(&v3) > 0) {
                    let v15 = 0x1::vector::pop_back<0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::Role>(&mut v3);
                    v7 = &mut v15;
                    continue
                };
                ...
                if (0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::get_hp(v5) == 0 && 0x1::vector::length<0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::Role>(&v2) > 0) {
                    let v16 = 0x1::vector::pop_back<0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::Role>(&mut v2);
                    v5 = &mut v16;
                };
            ...
            0x12c1af04ffbe5d3ad037fbbe5ac7439660fe6d4e2dda99a7ccc505a05f4df438::fight::action(v7, v5, &mut v3, &mut v2, &mut v9);
            if (0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::get_hp(v5) == 0 && 0x1::vector::length<0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::Role>(&v2) > 0) {
                let v17 = 0x1::vector::pop_back<0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::Role>(&mut v2);
                v5 = &mut v17;
                continue
            };
            if (0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::get_hp(v5) == 0) {
            ...
            0x12c1af04ffbe5d3ad037fbbe5ac7439660fe6d4e2dda99a7ccc505a05f4df438::fight::action(v5, v7, &mut v2, &mut v3, &mut v8);
            if (0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::get_hp(v7) == 0 && 0x1::vector::length<0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::Role>(&v3) > 0) {
                let v18 = 0x1::vector::pop_back<0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::Role>(&mut v3);
                v7 = &mut v18;
            };
            if (0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::get_hp(v7) == 0) {
                break
        ...
        let v24 = 0xa54718d01b0389f1d2cc05241efd0df098b4bf4ae4d26d3f306e0447da4ba87f::lineup::get_mut_roles(&mut arg0.lineup);
        if (0x2::vec_map::size<0x1::string::String, 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::Int_wrapper>(&v8) > 0) {
            ...
            0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::permenant_increase_role_hp(v24, &v8);
        };
        let v26 = 0x1::string::utf8(b"--------Permenant roles After the battle---------");
        0x1::debug::print<0x1::string::String>(&v26);
        0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::print_roles_short(v24);
        let v27 = if (0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::get_hp(v5) > 0) {
            if (arg2) {
    ...
    public entry fun operate_and_battle(arg0: &mut Global, arg1: &0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role::Global, arg2: &mut 0xa54718d01b0389f1d2cc05241efd0df098b4bf4ae4d26d3f306e0447da4ba87f::lineup::Global, arg3: &mut 0x255cafab94384ff817450535c39d55c65007fcce9cbef1b1f53fec14f67f3dd4::challenge::Global, arg4: &mut Chess, arg5: vector<0x1::string::String>, arg6: u8, arg7: vector<0x1::string::String>, arg8: &mut 0xcd53b9b1f6bec17a3a2643eaf9bd60577e13341f4cfc50f029f3fe51bf493ade::metaIdentity::MetaIdentity, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = if (0x1::string::length(&arg4.name) + 0x1::vector::length<0x1::string::String>(&arg5) != 12) {
            0xa54718d01b0389f1d2cc05241efd0df098b4bf4ae4d26d3f306e0447da4ba87f::lineup::parse_lineup_str_vec(arg4.name, arg1, arg7, 10 - (arg6 as u64), arg9)
        } else {
            verify_operation(arg1, v1, v2, arg5, arg6, arg7, arg4.name, (arg4.gold as u8), arg4.gold_cost, arg9)
        };
