module 0x1a184ecf7d0652f8f1285a3b0b2e644bf86ae1742317fcdaa9b11a7f3a30bd70::memez_vesting {
    ...
    public fun new<T0>(arg0: &0x2::clock::Clock, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : MemezVesting<T0> {
        assert!(arg2 >= 0x2::clock::timestamp_ms(arg0) - 60000, 13906834333257433093);
        assert!(arg3 != 0, 13906834341847236611);
        assert!(0x2::coin::value<T0>(&arg1) != 0, 13906834346142072833);
        MemezVesting<T0>{
    ...
    public fun vesting_status<T0>(arg0: &MemezVesting<T0>, arg1: &0x2::clock::Clock) : u64 {
        let v0 = if (0x2::clock::timestamp_ms(arg1) < arg0.start) {
            ...
            0x1a184ecf7d0652f8f1285a3b0b2e644bf86ae1742317fcdaa9b11a7f3a30bd70::memez_vesting_core::mul_div(0x2::balance::value<T0>(&arg0.balance) + arg0.released, 0x2::clock::timestamp_ms(arg1) - arg0.start, arg0.duration)
        };
        v0 - arg0.released
    }
