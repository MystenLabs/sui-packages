module 0x28c462b64af6ecee09df4f86866c296813fe20d557238aae68fdca4d7cf61b38::config {
    ...
    public fun get_max_id() : u32 {
        8832244
    }

    public fun get_min_id() : u32 {
        7944972
    }
    ...
    public fun validate_bin_range(arg0: &GlobalConfig, arg1: u16, arg2: u32) {
        let v0 = b"bin_range";
        assert!(0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, v0), 5005);
        let v1 = 0x2::dynamic_field::borrow<vector<u8>, 0x2::vec_map::VecMap<u16, BinRange>>(&arg0.id, v0);
        assert!(0x2::vec_map::contains<u16, BinRange>(v1, &arg1), 5000);
        let v2 = 0x2::vec_map::get<u16, BinRange>(v1, &arg1);
        assert!(arg2 >= v2.min_bin && arg2 <= v2.max_bin, 5006);
    }
