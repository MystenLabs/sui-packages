module 0x9c9b419370adf24559f414f2005203ac7e739032604bef7f3c5e9d68b88db32::cnsnft6466 {
    struct CNSNFT6466 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6466, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6466>(arg0, arg1);
