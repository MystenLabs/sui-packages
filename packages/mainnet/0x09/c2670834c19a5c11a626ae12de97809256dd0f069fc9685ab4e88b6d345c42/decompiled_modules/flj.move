module 0x9c2670834c19a5c11a626ae12de97809256dd0f069fc9685ab4e88b6d345c42::flj {
    struct FLJ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: FLJ, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FLJ>(arg0, 9, b"FLJ", b"FuLiJi", b"only Test", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://waterpump.fun/api/file/9709db68ea434e62ad949e189ff1d39c.jpeg")), arg1);
        let v2 = v1;
