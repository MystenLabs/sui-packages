module 0x93940867a1d519af8fbb8dd1547c323c0f17e5d5416e6e9cf483a578c01fc8a::gift5081 {
    struct GIFT5081 has drop {
        dummy_field: bool,
    }

    struct TICKET_5081 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5081(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5081>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5081>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5081, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5081>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5081>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5081>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5081>>(v5, 0x2::tx_context::sender(arg1));
    }
