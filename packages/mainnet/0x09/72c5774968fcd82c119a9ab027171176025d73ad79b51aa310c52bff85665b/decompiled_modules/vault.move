module 0x972c5774968fcd82c119a9ab027171176025d73ad79b51aa310c52bff85665b::vault {
    ...
    public fun commit_strategy<T0, T1>(arg0: &mut Vault<T0>, arg1: BorrowReceipt<T0>, arg2: 0x2::balance::Balance<T1>, arg3: u8, arg4: u64) {
        ...
        if (v0 > 0) {
            assert!(arg4 >= v0 - v0 * 0x972c5774968fcd82c119a9ab027171176025d73ad79b51aa310c52bff85665b::floors::max_slippage_ceil() / 10000, 207);
        };
    ...
    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::token::Token<0x46ed88368c5c1fbac0f9da490d6fd76fe65f9dea33f64ccc75c74a161ffb11c2::receipt::RECEIPT> {
        assert!(!arg0.auto_paused, 204);
        ...
        let v2 = if (arg0.total_receipts == 0) {
            ...
            0x972c5774968fcd82c119a9ab027171176025d73ad79b51aa310c52bff85665b::floors::assert_heartbeat_age(0x2::clock::timestamp_ms(arg2) - arg0.last_heartbeat_ms);
        ...
        0x2::token::mint<0x46ed88368c5c1fbac0f9da490d6fd76fe65f9dea33f64ccc75c74a161ffb11c2::receipt::RECEIPT>(&mut arg0.treasury_cap, v2, arg3)
    }
    ...
    public fun set_vote_lock<T0>(arg0: &mut Vault<T0>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock) {
        ...
        0x972c5774968fcd82c119a9ab027171176025d73ad79b51aa310c52bff85665b::floors::assert_vote_lock_duration(v1);
        if (0x2::table::contains<address, u64>(&arg0.vote_locks, arg1)) {
    ...
    public fun update_heartbeat_tvl<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock) {
        ...
        if (v1 > 0) {
            ...
            0x972c5774968fcd82c119a9ab027171176025d73ad79b51aa310c52bff85665b::floors::assert_tvl_delta((((v2 as u128) * 10000 / (v1 as u128)) as u64));
        };
    ...
    public fun update_performance_fee<T0>(arg0: &mut Vault<T0>, arg1: &AdminCap, arg2: u64) {
        0x972c5774968fcd82c119a9ab027171176025d73ad79b51aa310c52bff85665b::floors::assert_rewards_fee(arg2);
