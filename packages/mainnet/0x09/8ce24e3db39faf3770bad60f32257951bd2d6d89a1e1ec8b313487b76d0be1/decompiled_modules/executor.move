module 0x98ce24e3db39faf3770bad60f32257951bd2d6d89a1e1ec8b313487b76d0be1::executor {
    ...
    public(friend) fun deposit_and_record<T0>(arg0: &mut Vault<T0>, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64) {
        0x2::balance::join<T0>(&mut arg0.balance, arg1);
        arg0.total_arbs = arg0.total_arbs + 1;
        arg0.total_gross_profit = arg0.total_gross_profit + arg2;
        arg0.total_keeper_paid = arg0.total_keeper_paid + arg3;
    }
