module 0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::oracle {
    public(friend) fun calculate_pyth_primitive_prices(arg0: vector<u8>, arg1: &0x2::clock::Clock, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: u8, arg4: u64, arg5: u64, arg6: u8) : (u64, u64, u64, u64, u64, u64) {
        let v0 = 0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::safe_math::get_one_decimals();
        let (v1, v2, v3) = get_pyth_price(arg0, arg1, arg2, v0, arg4);
        (0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::safe_math::safe_mul_div_u64(v1, 0x1::u64::pow(10, v0 + arg6 - arg3), arg5), 0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::safe_math::safe_mul_div_u64(v2, 0x1::u64::pow(10, v0 + arg6 - arg3), arg5), 0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::safe_math::safe_mul_div_u64(arg5, 0x1::u64::pow(10, v0 + arg3 - arg6), v1), v1, v2, v3)
    }
