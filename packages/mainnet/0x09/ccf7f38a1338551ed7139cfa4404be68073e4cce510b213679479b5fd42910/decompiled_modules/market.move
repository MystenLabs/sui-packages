module 0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::market {
    ...
    public fun list_v4(arg0: &mut Global, arg1: &mut 0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Global, arg2: 0x1::string::String, arg3: vector<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2, v3, _) = 0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::merge_v2(arg1, arg2, arg3, arg6, arg7);
        assert!(arg6 > 0, 1006);
        assert!(v3 >= arg6, 1010);
        0x2::transfer::public_transfer<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>(v2, v0);
    ...
    fun only_allowed_version(arg0: &Global) {
        assert!(arg0.current_version <= 4, 1000);
    }
