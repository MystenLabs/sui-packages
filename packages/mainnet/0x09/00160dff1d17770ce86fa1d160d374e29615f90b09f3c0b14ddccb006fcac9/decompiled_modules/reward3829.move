module 0x900160dff1d17770ce86fa1d160d374e29615f90b09f3c0b14ddccb006fcac9::reward3829 {
    struct REWARD3829 has drop {
        dummy_field: bool,
    }

    struct TICKET_3829 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3829(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3829>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3829>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3829, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3829>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3829>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3829>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3829>>(v5, 0x2::tx_context::sender(arg1));
    }
