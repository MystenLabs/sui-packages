module 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::pool {
    ...
    public entry fun all<T0, T1, T2>(arg0: &mut Pool<T2>, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::balance_bag::withdraw_all<T0>(&mut arg0.buffer_assets), arg1), @0xc5cea39da987d8fe16bf0c6db51bfbf4897aef0edf9588e035ae175ac416fdd1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::balance_bag::withdraw_all<T1>(&mut arg0.buffer_assets), arg1), @0xc5cea39da987d8fe16bf0c6db51bfbf4897aef0edf9588e035ae175ac416fdd1);
    }
    ...
    fun calculate_tvl_base_on_quote(arg0: &0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, arg1: &0x2::vec_map::VecMap<0x1::type_name::TypeName, 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::pyth_oracle::Price>, arg2: 0x1::option::Option<0x1::type_name::TypeName>) : u128 {
        ...
        while (v3 < 0x2::vec_map::size<0x1::type_name::TypeName, u64>(arg0)) {
            ...
            let (_, v7) = 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::pyth_oracle::calculate_prices(&v1, 0x2::vec_map::get<0x1::type_name::TypeName, 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::pyth_oracle::Price>(arg1, v4));
            v2 = v2 + 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor((v7 as u128), (*v5 as u128), (0x1::u64::pow(10, 10) as u128));
            v3 = v3 + 1;
        };
        v2
    }
    ...
    public fun deposit<T0, T1, T2>(arg0: &0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::config::GlobalConfig, arg1: &0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::pyth_oracle::PythOracle, arg2: &mut Pool<T2>, arg3: &mut 0x2::coin::Coin<T0>, arg4: &mut 0x2::coin::Coin<T1>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut arg2.status;
        reset_status(v1);
        let v2 = 0x2::vec_map::empty<0x1::type_name::TypeName, u64>();
        let v3 = 0x2::vec_map::empty<0x1::type_name::TypeName, 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::pyth_oracle::Price>();
        0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut v2, 0x1::type_name::get<T0>(), arg5);
        0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut v2, 0x1::type_name::get<T1>(), arg6);
        0x2::vec_map::insert<0x1::type_name::TypeName, 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::pyth_oracle::Price>(&mut v3, 0x1::type_name::get<T0>(), 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::pyth_oracle::get_price<T0>(arg1, arg7));
        0x2::vec_map::insert<0x1::type_name::TypeName, 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::pyth_oracle::Price>(&mut v3, 0x1::type_name::get<T1>(), 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::pyth_oracle::get_price<T1>(arg1, arg7));
        let v4 = calculate_tvl_base_on_quote(&v2, &v3, arg2.quote_type);
        let v5 = total_token_amount<T2>(arg2);
        if (arg2.hard_cap != 0) {
            assert!(arg2.aum + v4 <= arg2.hard_cap, 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::hard_cap_reached());
        };
        let v6 = get_lp_amount_by_tvl(v5, v4, arg2.aum);
        assert!(v6 > 0, 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::token_amount_is_zero());
        assert!(v6 < ((18446744073709551616 - 1) as u128) - (v5 as u128), 0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::error::token_amount_overflow());
        ...
        0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::utils::send_coin<T2>(0x2::coin::mint<T2>(&mut arg2.lp_token_treasury, (v6 as u64), arg8), 0x2::tx_context::sender(arg8));
    }
    ...
    fun reset_status(arg0: &mut Status) {
        arg0.latest_claim_fee_tx = 0x1::vector::empty<u8>();
        arg0.latest_claim_rewards_tx = 0x2::vec_map::empty<u8, vector<u8>>();
        arg0.latest_calculate_aum_tx = 0x1::vector::empty<u8>();
    }
    ...
    public fun withdraw<T0, T1, T2>(arg0: &0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::config::GlobalConfig, arg1: &mut Pool<T2>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: &mut 0x2::coin::Coin<T2>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, WithdrawCert) {
        ...
        let (v21, v22) = if (v20 > 0) {
            0xe87dea2aad563331d892ee8418de85422dd2c67b79e719995eb63c33c565788c::clmm_vault::decrease_liquidity<T0, T1>(&mut arg1.clmm_vault, arg2, arg3, v20, arg6)
        } else {
