module 0x901cfb121c63c3ad423c1419456a6030823ba285f7e06c5239cffa80e84b236::protocol {
    ...
    public fun admin_emergency_recover<T0: store + key>(arg0: &0x901cfb121c63c3ad423c1419456a6030823ba285f7e06c5239cffa80e84b236::fee_manager::AdminCap, arg1: &0x901cfb121c63c3ad423c1419456a6030823ba285f7e06c5239cffa80e84b236::fee_manager::PlatformConfig, arg2: &mut GlobalRegistry, arg3: SwapOffer, arg4: address) {
        assert!(0x2::object::id<0x901cfb121c63c3ad423c1419456a6030823ba285f7e06c5239cffa80e84b236::fee_manager::AdminCap>(arg0) == 0x901cfb121c63c3ad423c1419456a6030823ba285f7e06c5239cffa80e84b236::fee_manager::admin_cap_id(arg1), 1);
        let SwapOffer {
            id                 : v0,
            maker              : _,
            taker              : _,
    ...
    public fun execute_kiosk_swap<T0: store + key, T1: store + key>(arg0: &mut GlobalRegistry, arg1: SwapOffer, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &0x2::transfer_policy::TransferPolicy<T1>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x901cfb121c63c3ad423c1419456a6030823ba285f7e06c5239cffa80e84b236::fee_manager::PlatformConfig, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v16 = 0x901cfb121c63c3ad423c1419456a6030823ba285f7e06c5239cffa80e84b236::fee_manager::get_flat_fee(arg7, 0x1::type_name::with_defining_ids<T1>());
        if (v16 > 0) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg6) >= v7 + v16, 4);
            0x901cfb121c63c3ad423c1419456a6030823ba285f7e06c5239cffa80e84b236::fee_manager::collect_fee(arg7, 0x2::coin::split<0x2::sui::SUI>(&mut arg6, v16, arg9));
        };
        0x2::table::remove<0x2::object::ID, bool>(&mut arg0.active_offers, v4);
        let v17 = v1;
    ...
    public fun execute_swap<T0: store + key, T1: store + key>(arg0: &mut GlobalRegistry, arg1: SwapOffer, arg2: T1, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x901cfb121c63c3ad423c1419456a6030823ba285f7e06c5239cffa80e84b236::fee_manager::PlatformConfig, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = 0x901cfb121c63c3ad423c1419456a6030823ba285f7e06c5239cffa80e84b236::fee_manager::get_flat_fee(arg4, 0x1::type_name::with_defining_ids<T1>());
        if (v11 > 0) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) >= v7 + v11, 4);
            0x901cfb121c63c3ad423c1419456a6030823ba285f7e06c5239cffa80e84b236::fee_manager::collect_fee(arg4, 0x2::coin::split<0x2::sui::SUI>(&mut arg3, v11, arg6));
        };
        0x2::table::remove<0x2::object::ID, bool>(&mut arg0.active_offers, v4);
        let v12 = v1;
