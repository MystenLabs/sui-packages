module 0x9065c4c6eaaeb802f35d4d57237c0c19852faaf00ef0daa51799c12189bee4c::cnsnft2442 {
    struct CNSNFT2442 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2442, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2442>(arg0, arg1);
