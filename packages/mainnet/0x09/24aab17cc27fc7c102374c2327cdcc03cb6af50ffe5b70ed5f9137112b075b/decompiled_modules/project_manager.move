module 0x924aab17cc27fc7c102374c2327cdcc03cb6af50ffe5b70ed5f9137112b075b::project_manager {
    ...
    public fun batch_add_whitelist<T0>(arg0: &0x924aab17cc27fc7c102374c2327cdcc03cb6af50ffe5b70ed5f9137112b075b::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut ProjectManager<T0>, arg2: vector<address>, arg3: vector<u64>) {
    ...
    public fun batch_remove_whitelist<T0>(arg0: &mut ProjectManager<T0>, arg1: &0x924aab17cc27fc7c102374c2327cdcc03cb6af50ffe5b70ed5f9137112b075b::launchpad_manager_config::LaunchManagerAdmin, arg2: vector<address>) {
        let v0 = 0x1::vector::length<address>(&arg2);
        assert!(v0 <= 200, 13);
        let v1 = 0;
        while (v1 < v0) {
    ...
    public fun change_pay_nft_status(arg0: &mut PayNft, arg1: &0x924aab17cc27fc7c102374c2327cdcc03cb6af50ffe5b70ed5f9137112b075b::launchpad_manager_config::LaunchAdmin) {
        arg0.status = 1;
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = ProjectConfig{
            level              : 0,
            max_funding_amount : 10000000000,
            token_price        : 60,
    ...
    public entry fun initialize_project_manager<T0>(arg0: &0x924aab17cc27fc7c102374c2327cdcc03cb6af50ffe5b70ed5f9137112b075b::launchpad_manager_config::LaunchAdmin, arg1: &mut PayNft, arg2: u64, arg3: u64, arg4: u64, arg5: u8, arg6: &mut ProjectManagerConfig, arg7: &mut 0x2::tx_context::TxContext) {
        assert_version(arg6);
        let v0 = if (arg5 == 0) {
            true
        } else if (arg5 == 1) {
    ...
    public fun project_falied<T0>(arg0: &mut ProjectManager<T0>, arg1: &0x924aab17cc27fc7c102374c2327cdcc03cb6af50ffe5b70ed5f9137112b075b::launchpad_manager_config::LaunchAdmin, arg2: &0x2::clock::Clock) {
    ...
    public fun set_project_config(arg0: &0x924aab17cc27fc7c102374c2327cdcc03cb6af50ffe5b70ed5f9137112b075b::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut ProjectManagerConfig, arg2: u8, arg3: u64, arg4: u64, arg5: u64) {
