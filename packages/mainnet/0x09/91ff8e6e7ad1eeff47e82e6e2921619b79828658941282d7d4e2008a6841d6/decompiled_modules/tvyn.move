module 0x991ff8e6e7ad1eeff47e82e6e2921619b79828658941282d7d4e2008a6841d6::tvyn {
    ...
    public entry fun create_and_share_mint_vault(arg0: 0x2::coin::TreasuryCap<TVYN>, arg1: &mut 0x991ff8e6e7ad1eeff47e82e6e2921619b79828658941282d7d4e2008a6841d6::config_registry::Config, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = MintVault{
            id  : 0x2::object::new(arg2),
            cap : arg0,
        };
        0x991ff8e6e7ad1eeff47e82e6e2921619b79828658941282d7d4e2008a6841d6::config_registry::set_mint_vault_id(arg1, 0x2::object::id<MintVault>(&v0));
    ...
    fun init(arg0: TVYN, arg1: &mut 0x2::tx_context::TxContext) {
        create_currency_and_supply_internal(arg0, b"BBBBBB", b"BBBB", b"BBBB TOKEN. Visit https://AAAAAA.com", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://amethyst-high-woodpecker-414.mypinata.cloud/ipfs/bafkreigzhutlov22epryhddcdqlxitarif7nsodzrcxuxqz7fn67z4wb24")), 9, arg1);
    }
