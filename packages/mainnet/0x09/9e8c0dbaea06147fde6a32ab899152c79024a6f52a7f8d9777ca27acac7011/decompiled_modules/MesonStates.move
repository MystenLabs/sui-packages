module 0x99e8c0dbaea06147fde6a32ab899152c79024a6f52a7f8d9777ca27acac7011::MesonStates {
    ...
    public(friend) fun remove_posted_swap(arg0: vector<u8>, arg1: &0x2::clock::Clock, arg2: &mut GeneralStore) : (u64, vector<u8>, address) {
        ...
        if (0x99e8c0dbaea06147fde6a32ab899152c79024a6f52a7f8d9777ca27acac7011::MesonHelpers::expire_ts_from(arg0) < 0x2::clock::timestamp_ms(arg1) / 1000 + 0x99e8c0dbaea06147fde6a32ab899152c79024a6f52a7f8d9777ca27acac7011::MesonHelpers::get_MIN_BOND_TIME_PERIOD()) {
            let PostedSwap {
                pool_index   : v4,
                initiator    : v5,
                from_address : v6,
