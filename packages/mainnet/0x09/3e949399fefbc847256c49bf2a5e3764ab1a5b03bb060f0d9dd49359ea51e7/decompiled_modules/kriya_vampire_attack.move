module 0x93e949399fefbc847256c49bf2a5e3764ab1a5b03bb060f0d9dd49359ea51e7::kriya_vampire_attack {
    ...
    struct KriyaLockdropForPool<phantom T0, phantom T1> has key {
        ...
        precision: u8,
        user_profile_access_cap: 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::ProfileDofOwnershipCapability,
        total_hive_incentives: u64,
        available_hive_tokens: 0x2::balance::Balance<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>,
    ...
    public entry fun add_incentives_for_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut KriyaLockdropForPool<T0, T1>, arg2: &KriyaAttackConfig, arg3: 0x2::coin::Coin<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (u64, 0x1::string::String) {
        assert!(arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window > 0x2::clock::timestamp_ms(arg0), 9803);
        let v0 = 0x2::coin::into_balance<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(arg3);
        0x2::balance::join<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(&mut arg1.available_hive_tokens, 0x2::balance::split<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(&mut v0, arg4));
        ...
        0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::coin_helper::destroy_or_transfer_balance<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(v0, 0x2::tx_context::sender(arg5), arg5);
    ...
    fun allowed_withdrawal_amount(arg0: &KriyaAttackConfig, arg1: u64, arg2: u64) : u64 {
        ...
        if (arg1 < v2) {
            (0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::math::mul_div_u256(((arg2 / 2) as u256), ((v2 - arg1) as u256), ((v2 - v1) as u256)) as u64)
        } else {
            0
        }
    }
    ...
    fun calculate_hive_rewards(arg0: u128, arg1: u128, arg2: u64) : u64 {
        if (arg1 == 0) {
            ...
            (0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::math::mul_div_u256((arg2 as u256), (arg0 as u256), (arg1 as u256)) as u64)
        }
    }

    fun calculate_weighted_units(arg0: u128, arg1: u64, arg2: &KriyaAttackConfig) : u128 {
        (((arg0 as u256) * ((1000000000 as u256) + 0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::math::mul_div_u256(((arg1 - 1) as u256) * (arg2.weekly_multiplier as u256), (1000000000 as u256), (arg2.weekly_divider as u256)))) as u128)
    }

    public fun destroy_user_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &KriyaLockdropForPool<T0, T1>, arg4: &mut 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::HiveProfile, arg5: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, u128, u128) {
        ...
        if (!0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::exists_for_profile(arg4, 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::get_profile_dof_capability_identifier(&arg3.user_profile_access_cap))) {
        ...
        } = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::entry_remove_from_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, arg5);
        0x2::object::delete(v0);
        0x2::table::drop<u64, bool>(v5);
        (v1, v2, v3, v4, v6, v7)
    }

    public fun does_user_have_position<T0, T1>(arg0: &0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::HiveProfile, arg1: &KriyaLockdropForPool<T0, T1>) : bool {
        0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::exists_for_profile(arg0, 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::get_profile_dof_capability_identifier(&arg1.user_profile_access_cap))
    }

    public fun extract_liquidity_from_kriya<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &mut KriyaLockdropForPool<T0, T1>, arg4: &mut 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::Pool<T0, T1>, arg5: &mut 0x2::tx_context::TxContext) : (u128, u8, u128, u64, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>) {
        assert!(0x2::clock::timestamp_ms(arg0) > arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window, 9813);
        ...
        (arg3.total_lp_locked, arg3.precision, arg3.total_weighted_units, arg3.total_hive_incentives, v3, v4, 0x2::balance::withdraw_all<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(&mut arg3.available_hive_tokens))
    }

    public fun get_user_position<T0, T1>(arg0: &0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::HiveProfile, arg1: &KriyaLockdropForPool<T0, T1>) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u128, u64) {
        let v0 = 0x1::vector::empty<u64>();
        let v1 = 0x1::vector::empty<u64>();
        let v2 = 0x1::vector::empty<u128>();
        let v3 = 0x1::vector::empty<bool>();
        let v4 = 0x1::vector::empty<u64>();
        let v5 = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::get_profile_dof_capability_identifier(&arg1.user_profile_access_cap);
        if (!0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::exists_for_profile(arg0, v5)) {
            return (0x1::vector::empty<u64>(), v0, v1, v2, v3, v4, 0, 0)
        };
        let v6 = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::borrow_from_profile<UserKriyaHivePosition>(arg0, v5);
        let v7 = 0;
    ...
    public entry fun initialize_attack_on_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::config::HiveEntryCap, arg2: 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::ProfileDofOwnershipCapability, arg3: 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::KriyaLPToken<T0, T1>, arg4: &mut KriyaAttackConfig, arg5: 0x1::string::String, arg6: u8, arg7: 0x2::coin::Coin<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : address {
        assert!(arg4.init_timestamp > 0x2::clock::timestamp_ms(arg0), 9800);
        let v0 = 0x2::coin::into_balance<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(arg7);
        ...
        let v4 = KriyaLockdropForPool<T0, T1>{
            ...
            available_hive_tokens   : 0x2::balance::split<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(&mut v0, arg8),
        ...
        0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::coin_helper::destroy_or_transfer_balance<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(v0, 0x2::tx_context::sender(arg9), arg9);
    ...
    public entry fun initialize_kriya_attack_config(arg0: &0x2::clock::Clock, arg1: &0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::config::HiveEntryCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) : address {
    ...
    public entry fun lock_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &mut KriyaLockdropForPool<T0, T1>, arg4: &mut 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::HiveProfile, arg5: 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::KriyaLPToken<T0, T1>, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : (0x1::string::String, u8) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (v1, v2, _, v4) = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::get_profile_meta_info(arg4);
        ...
        let v5 = if (0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::exists_for_profile(arg4, 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::get_profile_dof_capability_identifier(&arg3.user_profile_access_cap))) {
            0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::entry_remove_from_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, arg8)
        } else {
        ...
        let v7 = arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window + arg7 * 1800000;
        ...
        0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::entry_add_to_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, v5, arg8);
    ...
    public fun simulate_withdraw_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &KriyaAttackConfig, arg2: &KriyaLockdropForPool<T0, T1>, arg3: &0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::HiveProfile, arg4: u128, arg5: u64) : (u64, u64, bool) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        if (v0 < arg1.init_timestamp || v0 > arg1.init_timestamp + arg1.deposit_window + arg1.withdrawal_window) {
            return (0, 0, false)
        };
        let v1 = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap);
        if (!0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::exists_for_profile(arg3, v1)) {
            return (0, 0, false)
        };
        let v2 = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::borrow_from_profile<UserKriyaHivePosition>(arg3, v1);
    ...
    public entry fun withdraw_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &mut KriyaLockdropForPool<T0, T1>, arg4: &mut 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::HiveProfile, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (0x1::string::String, u8) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (v1, v2, _, v4) = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::get_profile_meta_info(arg4);
        assert!(v0 >= arg2.init_timestamp, 9804);
        assert!(v0 < arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window, 9811);
        assert!(0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::exists_for_profile(arg4, 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::get_profile_dof_capability_identifier(&arg3.user_profile_access_cap)), 9808);
        let v5 = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::entry_remove_from_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, arg7);
        ...
        0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::entry_add_to_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, v5, arg7);
