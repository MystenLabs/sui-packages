module 0x9e6f42c82d00452a4ed1a7ffb51c17a9e5ca4df4397d25aae5782032e4998f3::cnsnft3508 {
    struct CNSNFT3508 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3508, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3508>(arg0, arg1);
