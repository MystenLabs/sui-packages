module 0x90f4acad1fdc6449bce33af42ebda7065abb810ce3fd68185927db729fd268d::coinflip {
    ...
    public fun join(arg0: &mut HouseData, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x1::string::String, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = v0 / 1000 * 15;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v11, arg0.top_order, arg5);
        let v12 = v0 / 100 * 1;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v12, arg0.week_performance, arg5);
        let v13 = v0 / 1000 * 15;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v13, arg0.daily_award, arg5);
        let v14 = v0 / 100;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v14, arg0.insurance, arg5);
        let v15 = v0 / 100 * 5;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v15, arg0.operation, arg5);
        let v16 = v0 / 100 * 2;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v16, arg0.ecosys, arg5);
        if (arg0.bank == @0x0) {
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::into_balance<0x2::sui::SUI>(v1));
        } else {
            0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v0 - v2 - v4 - v5 - v6 - v7 - v8 - v9 - v10 - v11 - v12 - v13 - v14 - v15 - v16, arg0.bank, arg5);
            0x2::coin::destroy_zero<0x2::sui::SUI>(v1);
        };
        arg0.round_balance = arg0.round_balance + v0;
        let v17 = get_mut_account(arg0, 0x2::tx_context::sender(arg5));
        v17.contributed = v17.contributed + v0;
        let v18 = JoinGame{
            round         : arg0.round,
