module 0x9ded32286c24b8eded83452b6fda4402dd03939cf49b2ab6d0db3a9cc86228a::cnsnft4157 {
    struct CNSNFT4157 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4157, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4157>(arg0, arg1);
