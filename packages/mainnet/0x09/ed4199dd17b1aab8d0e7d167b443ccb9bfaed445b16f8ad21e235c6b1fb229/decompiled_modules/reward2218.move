module 0x9ed4199dd17b1aab8d0e7d167b443ccb9bfaed445b16f8ad21e235c6b1fb229::reward2218 {
    struct REWARD2218 has drop {
        dummy_field: bool,
    }

    struct TICKET_2218 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2218(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2218>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2218>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2218, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2218>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2218>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2218>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2218>>(v5, 0x2::tx_context::sender(arg1));
    }
