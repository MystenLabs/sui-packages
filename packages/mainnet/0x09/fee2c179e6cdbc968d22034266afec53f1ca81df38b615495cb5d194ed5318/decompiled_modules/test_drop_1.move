module 0x9fee2c179e6cdbc968d22034266afec53f1ca81df38b615495cb5d194ed5318::test_drop_1 {
    struct TEST_DROP_1 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TEST_DROP_1, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TEST_DROP_1>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Test Drop 1"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"asdfasf"));
