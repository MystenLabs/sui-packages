module 0x9790c044c823e15d86227ddf6b55d7f49f936c7ba3cf2601d3776435ec26dc3::alphafi_lyf_investor {
    ...
    public(friend) fun autocompound_internal<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg5: &mut 0x3::sui_system::SuiSystemState, arg6: bool, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, bool, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let v8 = collect_alphalend_reward<T0, T1, T1>(arg0, arg1, arg5, arg7, arg8);
        0x2::balance::join<T1>(&mut v4, v8);
        let v9 = collect_alphalend_reward<T0, T1, T0>(arg0, arg1, arg5, arg7, arg8);
        ...
        assert!(0x1::vector::length<0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::rewards::ClaimableReward>(&v11) == 0, 13906837344029245439);
    ...
    fun collect_alphalend_reward<T0, T1, T2>(arg0: &mut Investor<T0, T1>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T2> {
        let v0 = if (0x1::type_name::with_defining_ids<T2>() == 0x1::type_name::with_defining_ids<0x2::sui::SUI>()) {
            let (v1, v2) = 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::collect_reward<0x2::sui::SUI>(arg1, arg0.market_id_a, &arg0.position_cap, arg3, arg4);
            let v3 = v1;
            0x2::coin::join<0x2::sui::SUI>(&mut v3, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise_SUI(arg1, v2, arg2, arg3, arg4));
            let (v4, v5) = 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::collect_reward<0x2::sui::SUI>(arg1, arg0.market_id_b, &arg0.position_cap, arg3, arg4);
            0x2::coin::join<0x2::sui::SUI>(&mut v3, v4);
            0x2::coin::join<0x2::sui::SUI>(&mut v3, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise_SUI(arg1, v5, arg2, arg3, arg4));
            let v6 = recast_balance_type<T0, T1, 0x2::sui::SUI, T2>(arg0, 0x2::coin::into_balance<0x2::sui::SUI>(v3));
            0x2::coin::from_balance<T2>(v6, arg4)
        } else {
            let (v7, v8) = 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::collect_reward<T2>(arg1, arg0.market_id_a, &arg0.position_cap, arg3, arg4);
            let v9 = v7;
            0x2::coin::join<T2>(&mut v9, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise<T2>(arg1, v8, arg3, arg4));
            let (v10, v11) = 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::collect_reward<T2>(arg1, arg0.market_id_b, &arg0.position_cap, arg3, arg4);
            0x2::coin::join<T2>(&mut v9, v10);
            0x2::coin::join<T2>(&mut v9, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise<T2>(arg1, v11, arg3, arg4));
            v9
        };
        let v12 = v0;
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T2>())) {
            0x2::coin::join<T2>(&mut v12, 0x2::coin::from_balance<T2>(0x2::balance::withdraw_all<T2>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T2>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T2>())), arg4));
        };
    ...
    public(friend) fun collect_reward_and_swap_bluefin<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: bool, arg6: bool, arg7: bool, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg5) {
            if (arg7) {
                ...
                let v8 = collect_alphalend_reward<T0, T1, T2>(arg0, arg1, arg8, arg9, arg10);
            ...
            if (arg7) {
                let (v15, v16) = 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::borrow_bluefin_lp_collateral(arg1, &arg0.position_cap, arg10);
                let v17 = v15;
                let v18 = &mut v17;
                let v19 = collect_bluefin_reward<T0, T1, T3>(arg0, arg4, arg2, v18, arg9);
                0x2::balance::join<T3>(&mut v2, v19);
                0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::return_bluefin_lp_collateral<T0, T1>(arg1, &arg0.position_cap, arg2, v17, v16, arg9, arg10);
            } else {
                let v20 = collect_alphalend_reward<T0, T1, T3>(arg0, arg1, arg8, arg9, arg10);
                0x2::balance::join<T3>(&mut v2, v20);
            };
            let v21 = 0x2::balance::value<T3>(&v2);
            if (v21 >= arg0.minimum_swap_amount && arg6) {
                let (_, v23) = get_bluefin_sqrt_price_limits<T2, T3>(arg3);
                let (v24, v25) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T2, T3>(arg9, arg4, arg3, 0x2::balance::zero<T2>(), v2, false, true, v21, 0, v23);
                let v26 = v25;
                assert!(0x2::balance::value<T3>(&v26) == 0, 2);
                0x2::balance::destroy_zero<T3>(v26);
                0x2::balance::join<T2>(&mut v1, v24);
                update_free_rewards<T0, T1, T2>(arg0, v1);
            } else {
                update_free_rewards<T0, T1, T3>(arg0, v2);
                update_free_rewards<T0, T1, T2>(arg0, v1);
    ...
    fun destroy_potatoes<T0, T1>(arg0: &Investor<T0, T1>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::FlashTransactionHotPotato, arg3: 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::FlashTransactionHotPotato, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<T0>(&v0) == 0, 13906837739166236671);
        assert!(0x2::coin::value<T1>(&v1) == 0, 13906837743461203967);
    ...
    public(friend) fun rebalance_debts<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: u64, arg2: bool, arg3: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg6: &mut 0x3::sui_system::SuiSystemState, arg7: bool, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert!(arg1 >= arg0.minimum_swap_amount, 13906838800023158783);
    ...
    fun recast_balance_type<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: 0x2::balance::Balance<T2>) : 0x2::balance::Balance<T3> {
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T3>()) == true, 13906838215907606527);
