module 0x94ee4655b9256b30264c145b1e75141530b6e42ca402ae3f12fce48546c5b6a::reward2238 {
    struct REWARD2238 has drop {
        dummy_field: bool,
    }

    struct TICKET_2238 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2238(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2238>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2238>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2238, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2238>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2238>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2238>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2238>>(v5, 0x2::tx_context::sender(arg1));
    }
