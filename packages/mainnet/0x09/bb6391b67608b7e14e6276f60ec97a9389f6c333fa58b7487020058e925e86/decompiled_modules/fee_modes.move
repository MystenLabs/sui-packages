module 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::fee_modes {
    ...
    public fun add_stake_v2<T0>(arg0: &mut 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>, arg1: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::Config, arg2: &mut Stake<T0>, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
    ...
    fun claim_internal<T0>(arg0: &mut 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>, arg1: &mut Stake<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
    ...
    public fun claim_rewards_v2<T0>(arg0: &mut 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>, arg1: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::Config, arg2: &mut Stake<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::assert_version(arg1);
        assert!(arg2.curve_id == 0x2::object::id<0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>>(arg0), 605);
        distribute_internal<T0>(arg0);
    ...
    fun release<T0>(arg0: &mut 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>, arg1: u64) {
        let v0 = 0x2::object::id<0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>>(arg0);
        ...
        let v3 = if (v2 == 0 || arg1 <= v1.last_ms) {
            ...
            0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::math::mul_div(v2, arg1 - v1.last_ms, v1.end_ms - v1.last_ms)
        };
        v1.streaming = v2 - v3;
        if (arg1 > v1.last_ms) {
            v1.last_ms = arg1;
    ...
    public fun release_rewards<T0>(arg0: &mut 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>, arg1: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::Config, arg2: &0x2::clock::Clock) {
        0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::assert_version(arg1);
        distribute_internal<T0>(arg0);
    ...
    public fun stake_v2<T0>(arg0: &mut 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>, arg1: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::Config, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Stake<T0> {
        0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::assert_version(arg1);
    ...
    fun stream_mut<T0>(arg0: &mut 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>) : &mut Stream {
        let v0 = StreamKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_with_type<StreamKey, Stream>(0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::uid<T0>(arg0), v0)) {
            ...
            0x2::dynamic_field::add<StreamKey, Stream>(0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::uid_mut<T0>(arg0), v1, v2);
        };
        let v3 = StreamKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<StreamKey, Stream>(0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::uid_mut<T0>(arg0), v3)
    }

    public fun stream_stats<T0>(arg0: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>) : (u64, u64, u64, u64) {
        let v0 = StreamKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_with_type<StreamKey, Stream>(0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::uid<T0>(arg0), v0)) {
            return (0, 0, 0, 0)
        };
        let v1 = StreamKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow<StreamKey, Stream>(0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::uid<T0>(arg0), v1);
    ...
    public fun unreleased<T0>(arg0: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>) : u64 {
    ...
    fun unstake_internal<T0>(arg0: &mut 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>, arg1: Stake<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        let v0 = 0x2::object::id<0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>>(arg0);
        let Stake {
            id          : v1,
            curve_id    : _,
    ...
    public fun unstake_v2<T0>(arg0: &mut 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve::Curve<T0>, arg1: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::Config, arg2: Stake<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        let v0 = &mut arg2;
