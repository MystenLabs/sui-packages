module 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::curve {
    ...
    public fun buy<T0>(arg0: &mut Curve<T0>, arg1: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::Config, arg2: &mut 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::Treasury, arg3: &mut 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::referral::Registry, arg4: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: u64, arg7: 0x1::option::Option<address>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        if (v0 - arg0.created_ms < arg0.snipe_window_ms) {
            let v3 = 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::math::mul_div(1000000000000000, 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::snipe_tx_cap_bps(&arg0.params), 10000);
        ...
        let v6 = 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::referral::resolve(arg3, v5, arg7);
    ...
    public fun reopen_trading<T0>(arg0: &mut Curve<T0>, arg1: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::Config, arg2: &0x2::clock::Clock) {
        0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::assert_version(arg1);
    ...
    public fun report_stuck<T0>(arg0: &mut Curve<T0>, arg1: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::Config, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::assert_version(arg1);
        assert!(arg0.status == 1, 428);
        let v0 = StuckKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists_<StuckKey>(&arg0.id, v0), 429);
        let v1 = 0x2::clock::timestamp_ms(arg2) + 600000;
