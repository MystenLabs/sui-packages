module 0x98dd5ca4b0dc68c704159efcfdc01d93009a4eab6cd6d25291ca3f3c49b322a::cnsnft2667 {
    struct CNSNFT2667 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2667, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9487"));
        let v4 = 0x2::package::claim<CNSNFT2667>(arg0, arg1);
