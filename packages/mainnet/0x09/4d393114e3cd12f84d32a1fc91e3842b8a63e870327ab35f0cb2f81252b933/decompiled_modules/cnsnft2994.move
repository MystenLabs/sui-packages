module 0x94d393114e3cd12f84d32a1fc91e3842b8a63e870327ab35f0cb2f81252b933::cnsnft2994 {
    struct CNSNFT2994 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2994, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2994>(arg0, arg1);
