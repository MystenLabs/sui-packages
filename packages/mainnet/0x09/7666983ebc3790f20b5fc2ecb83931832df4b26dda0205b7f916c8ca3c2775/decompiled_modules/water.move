module 0x97666983ebc3790f20b5fc2ecb83931832df4b26dda0205b7f916c8ca3c2775::water {
    ...
    fun init(arg0: WATER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/9mAnyxAq8JQieHT7Lc47PVQbTK7ZVaaog8LwAbFzBAGS.png?size=lg&key=065050                                                                                                                                                                                                            ");
