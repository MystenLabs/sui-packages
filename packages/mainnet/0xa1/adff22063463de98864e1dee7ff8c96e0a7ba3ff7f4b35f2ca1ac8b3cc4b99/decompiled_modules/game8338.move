module 0xa1adff22063463de98864e1dee7ff8c96e0a7ba3ff7f4b35f2ca1ac8b3cc4b99::game8338 {
    struct GAME8338 has drop {
        dummy_field: bool,
    }

    struct TICKET_8338 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8338(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8338>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8338>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME8338, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME8338>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8338>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8338>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8338>>(v5, 0x2::tx_context::sender(arg1));
    }
