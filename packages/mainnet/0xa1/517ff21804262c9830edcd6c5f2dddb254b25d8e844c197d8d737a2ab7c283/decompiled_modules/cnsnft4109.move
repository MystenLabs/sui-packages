module 0xa1517ff21804262c9830edcd6c5f2dddb254b25d8e844c197d8d737a2ab7c283::cnsnft4109 {
    struct CNSNFT4109 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4109, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4109>(arg0, arg1);
