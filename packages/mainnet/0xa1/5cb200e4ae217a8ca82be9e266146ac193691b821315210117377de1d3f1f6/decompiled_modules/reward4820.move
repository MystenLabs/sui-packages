module 0xa15cb200e4ae217a8ca82be9e266146ac193691b821315210117377de1d3f1f6::reward4820 {
    struct REWARD4820 has drop {
        dummy_field: bool,
    }

    struct TICKET_4820 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4820(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4820>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4820>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4820, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4820>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4820>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4820>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4820>>(v5, 0x2::tx_context::sender(arg1));
    }
