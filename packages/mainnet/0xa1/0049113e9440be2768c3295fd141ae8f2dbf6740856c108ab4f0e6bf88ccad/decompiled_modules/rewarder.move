module 0xa46f7dc3f1f0f4978d81c9c52757554f6f4dc62f65f2ce586be34409aa3b8168::rewarder {
    ...
    public(friend) fun new() : RewarderManager {
        let v0 = 0x1::vector::empty<Rewarder>();
        let v1 = 0;
        while (v1 < 8) {
            let v2 = Rewarder{
                reward_coin          : 0x1::type_name::get<bool>(),
                emissions_per_second : 0,
                growth_global        : 0,
            };
            0x1::vector::push_back<Rewarder>(&mut v0, v2);
            v1 = v1 + 1;
        };
        RewarderManager{
            rewarders            : v0,
    ...
    public(friend) fun add_rewarder<T0>(arg0: &mut RewarderManager) {
        ...
        let v1 = initialized_rewarders_count(arg0);
        assert!(0x1::option::is_none<u64>(&v0), 934862304673206987);
        assert!(v1 < 8, 934062834076983206);
        0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v1).reward_coin = 0x1::type_name::get<T0>();
    }
    ...
    public(friend) fun borrow_mut_rewarder<T0>(arg0: &mut RewarderManager) : &mut Rewarder {
        let v0 = 0;
        while (v0 < 0x1::vector::length<Rewarder>(&arg0.rewarders) && v0 < 8) {
            let v1 = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v0).reward_coin;
            if (v1 == 0x1::type_name::get<T0>()) {
                return 0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v0)
            };
            if (v1 == 0x1::type_name::get<bool>()) {
                break
            };
            v0 = v0 + 1;
        };
    ...
    public fun delete_rewarder_v2(arg0: &mut RewarderManager) {
        let v0 = 0;
        while (v0 < 1) {
            let Rewarder {
                reward_coin          : _,
                emissions_per_second : _,
                growth_global        : _,
            } = 0x1::vector::pop_back<Rewarder>(&mut arg0.rewarders);
            v0 = v0 + 1;
        };
    }

    public fun deposit_reward<T0>(arg0: &0xa46f7dc3f1f0f4978d81c9c52757554f6f4dc62f65f2ce586be34409aa3b8168::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) : u64 {
    ...
    public fun emergent_withdraw<T0>(arg0: &0xa46f7dc3f1f0f4978d81c9c52757554f6f4dc62f65f2ce586be34409aa3b8168::config::AdminCap, arg1: &0xa46f7dc3f1f0f4978d81c9c52757554f6f4dc62f65f2ce586be34409aa3b8168::config::GlobalConfig, arg2: &mut RewarderGlobalVault, arg3: u64) : 0x2::balance::Balance<T0> {
        0xa46f7dc3f1f0f4978d81c9c52757554f6f4dc62f65f2ce586be34409aa3b8168::config::checked_package_version(arg1);
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun initialized_rewarders_count(arg0: &RewarderManager) : u64 {
        let v0 = 0;
        while (v0 < 0x1::vector::length<Rewarder>(&arg0.rewarders) && v0 < 8) {
            if (0x1::vector::borrow<Rewarder>(&arg0.rewarders, v0).reward_coin == 0x1::type_name::get<bool>()) {
                break
            };
            v0 = v0 + 1;
        };
    ...
    public(friend) fun settle(arg0: &mut RewarderGlobalVault, arg1: &mut RewarderManager, arg2: u128, arg3: u64) {
        ...
        let v1 = arg3 - v0;
        let v2 = 0;
        while (v2 < 0x1::vector::length<Rewarder>(&arg1.rewarders) && v2 < 8) {
            let v3 = 0x1::vector::borrow_mut<Rewarder>(&mut arg1.rewarders, v2);
            if (v3.reward_coin == 0x1::type_name::get<bool>()) {
                break
            };
    ...
    public fun setup_200_rewarder_v2(arg0: &mut RewarderManager) {
        let v0 = 8;
        while (v0 < 200) {
            let v1 = Rewarder{
                reward_coin          : 0x1::type_name::get<bool>(),
    ...
    public fun upgrade_rewarder_v2(arg0: &mut RewarderManager) {
        let v0 = 0x1::vector::length<Rewarder>(&arg0.rewarders);
        while (v0 < 8) {
            let v1 = Rewarder{
                reward_coin          : 0x1::type_name::get<bool>(),
                emissions_per_second : 0,
