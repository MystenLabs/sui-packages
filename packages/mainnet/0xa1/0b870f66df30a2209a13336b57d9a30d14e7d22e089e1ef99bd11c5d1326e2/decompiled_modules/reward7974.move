module 0xa10b870f66df30a2209a13336b57d9a30d14e7d22e089e1ef99bd11c5d1326e2::reward7974 {
    struct REWARD7974 has drop {
        dummy_field: bool,
    }

    struct TICKET_7974 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7974(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7974>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7974>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7974, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7974>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7974>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7974>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7974>>(v5, 0x2::tx_context::sender(arg1));
    }
