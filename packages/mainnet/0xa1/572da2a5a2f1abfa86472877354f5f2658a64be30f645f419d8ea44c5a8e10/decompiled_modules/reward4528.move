module 0xa1572da2a5a2f1abfa86472877354f5f2658a64be30f645f419d8ea44c5a8e10::reward4528 {
    struct REWARD4528 has drop {
        dummy_field: bool,
    }

    struct TICKET_4528 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4528(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4528>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4528>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4528, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4528>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4528>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4528>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4528>>(v5, 0x2::tx_context::sender(arg1));
    }
