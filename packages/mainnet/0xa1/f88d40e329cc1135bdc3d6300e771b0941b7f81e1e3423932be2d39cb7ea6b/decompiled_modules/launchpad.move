module 0xa1f88d40e329cc1135bdc3d6300e771b0941b7f81e1e3423932be2d39cb7ea6b::launchpad {
    ...
    public entry fun claim<T0, T1>(arg0: &mut LaunchInfo<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0xa1f88d40e329cc1135bdc3d6300e771b0941b7f81e1e3423932be2d39cb7ea6b::math_extend::mul_div(arg0.claim_amount_per_coin_uint, v1.paid_amount, arg0.pay_coin_unit);
        assert!(v2 > 0, 1005);
