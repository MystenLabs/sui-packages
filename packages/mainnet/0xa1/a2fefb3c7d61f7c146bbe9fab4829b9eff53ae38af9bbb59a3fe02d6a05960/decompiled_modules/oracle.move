module 0xa1a2fefb3c7d61f7c146bbe9fab4829b9eff53ae38af9bbb59a3fe02d6a05960::oracle {
    struct HiveOracle has store, key {
        id: 0x2::object::UID,
        update_cap: 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::TwapUpdateCap,
    ...
    public fun setup_hive_oracle(arg0: 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::TwapUpdateCap, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = HiveOracle{
    ...
    public entry fun update_hive_oracle_price<T0, T1, T2, T3, T4, T5>(arg0: &0x2::clock::Clock, arg1: &mut HiveOracle, arg2: &mut 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::HiveGraph, arg3: &0xa1a2fefb3c7d61f7c146bbe9fab4829b9eff53ae38af9bbb59a3fe02d6a05960::two_pool::LiquidityPool<T0, T1, T4>, arg4: &0xa1a2fefb3c7d61f7c146bbe9fab4829b9eff53ae38af9bbb59a3fe02d6a05960::two_pool::LiquidityPool<T2, T3, T5>, arg5: &0x2::tx_context::TxContext) {
        ...
        let v2 = 0xa1a2fefb3c7d61f7c146bbe9fab4829b9eff53ae38af9bbb59a3fe02d6a05960::two_pool::get_liquidity_pool_id<T2, T3, T5>(arg4);
        assert!(0x2::object::id_to_address(&v2) == *0x1::option::borrow<address>(&arg1.sui_hive_pool_addr), 1974);
        let v3 = 0xa1a2fefb3c7d61f7c146bbe9fab4829b9eff53ae38af9bbb59a3fe02d6a05960::two_pool::get_liquidity_pool_id<T0, T1, T4>(arg3);
        assert!(0x2::object::id_to_address(&v3) == *0x1::option::borrow<address>(&arg1.usdc_sui_pool_addr), 1974);
        let (_, v5, v6) = 0xa1a2fefb3c7d61f7c146bbe9fab4829b9eff53ae38af9bbb59a3fe02d6a05960::two_pool::get_pool_cumulative_prices<T2, T3, T5>(arg4);
        let (_, v8, v9) = 0xa1a2fefb3c7d61f7c146bbe9fab4829b9eff53ae38af9bbb59a3fe02d6a05960::two_pool::get_pool_cumulative_prices<T0, T1, T4>(arg3);
        ...
        if (0x1::option::is_some<HiveTwapSnapshot>(&v20)) {
            ...
            if (v28 > 0) {
                0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::update_hive_twap_info(&arg1.update_cap, arg0, arg2, v26, v27, v28);
            };
        };
