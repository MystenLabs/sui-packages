module 0xa1ace4e393347ca75a798d33a9de471120fa128e7ca88f6df77fa5d24420e9c0::test_lp_holding_migration {
    ...
    public entry fun rescue_with_accounts(arg0: &Owner, arg1: &mut HydroLocker, arg2: &mut StartVesting, arg3: &0x2::clock::Clock, arg4: &mut VestedTokens, arg5: vector<0x1::string::String>, arg6: vector<0x1::string::String>, arg7: &UpgradeVersion, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        while (v5 < v1) {
            ...
            assert!(0 != v8, 12);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x4bb07b086c13bda7af26b9872fa8c4b460a9c0479cde6a63de4b9d29ea0ec99a::test_token::TEST_TOKEN>>(0x2::coin::split<0x4bb07b086c13bda7af26b9872fa8c4b460a9c0479cde6a63de4b9d29ea0ec99a::test_token::TEST_TOKEN>(&mut arg4.coin, v8, arg8), v0);
    ...
    public entry fun withdraw(arg0: &mut HydroLocker, arg1: &mut StartVesting, arg2: &0x2::clock::Clock, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut VestedTokens, arg6: &UpgradeVersion, arg7: &PauseUnpauseContract, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == v4, 5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x4bb07b086c13bda7af26b9872fa8c4b460a9c0479cde6a63de4b9d29ea0ec99a::test_token::TEST_TOKEN>>(0x2::coin::split<0x4bb07b086c13bda7af26b9872fa8c4b460a9c0479cde6a63de4b9d29ea0ec99a::test_token::TEST_TOKEN>(&mut arg5.coin, v1, arg8), v0);
