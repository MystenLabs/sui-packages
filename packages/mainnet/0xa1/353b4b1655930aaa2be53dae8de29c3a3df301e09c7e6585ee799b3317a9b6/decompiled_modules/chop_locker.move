module 0xa1353b4b1655930aaa2be53dae8de29c3a3df301e09c7e6585ee799b3317a9b6::chop_locker {
    ...
    public entry fun lock_tokens<T0>(arg0: &mut PoolConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v13 = Lock<T0>{
            ...
            start_time            : v2,
            end_time              : v2 + arg3,
            locked_in_apy         : ((((365 / v1) as u128) * (0x2::balance::value<T0>(&v4) as u128) * 100000 / (v0 as u128)) as u64),
            token_type            : arg4,
            rewards_locked        : v4,
