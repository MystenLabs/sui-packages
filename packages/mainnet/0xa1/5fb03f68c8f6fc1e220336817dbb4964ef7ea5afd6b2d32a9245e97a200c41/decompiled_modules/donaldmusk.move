module 0xa15fb03f68c8f6fc1e220336817dbb4964ef7ea5afd6b2d32a9245e97a200c41::donaldmusk {
    ...
    fun init(arg0: DONALDMUSK, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<DONALDMUSK>(arg0, 9, b"DonaldMusk", b"DonaldMusk", b"DonaldMusk Meme Coin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), false, arg1);
        let v3 = v0;
