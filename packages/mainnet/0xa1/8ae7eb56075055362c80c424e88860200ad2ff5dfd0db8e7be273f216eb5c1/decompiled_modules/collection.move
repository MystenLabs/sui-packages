module 0xa18ae7eb56075055362c80c424e88860200ad2ff5dfd0db8e7be273f216eb5c1::collection {
    ...
    public entry fun changeCollectionDescription(arg0: 0x1::string::String, arg1: &mut Collection, arg2: &mut 0x2::tx_context::TxContext) {
        0xa18ae7eb56075055362c80c424e88860200ad2ff5dfd0db8e7be273f216eb5c1::admin::is_admin(arg1.admin, 0x2::tx_context::sender(arg2));
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Collection{
            ...
            name                   : 0x1::string::utf8(b"Badjenos"),
            description            : 0x1::string::utf8(b"Badjenos is a Casino NFT project and the first ever on the newly created Sui Blockchain. This isn't only a casino; it will engulf a whole lot more: crash, coin flip, roulette and much more soon! The casino will be enhanced with NFTs to give the possibility for our community members to participate and interact and get rewards for taking part in our project. Our theme will be Sea-horse."),
            supply                 : 3333,
            url                    : 0x2::url::new_unsafe_from_bytes(b"https://bettasui.xyz/collection/29/profile.png"),
            metadata_uri           : 0x1::string::utf8(b"https://ipfs.io/ipfs/QmWb7gmaaHnwkGFsYo1cLVQAavAxpk5ph624xQ2Zzow7m2/badjenos"),
            minted                 : 0,
            max_mint_per_og        : 1,
            og_price               : 0,
            max_mint_per_whitelist : 5,
            whitelist_price        : 7000000000,
            max_public_per_wallet  : 3333,
            public_price           : 8000000000,
            launchpad_fee          : 3,
            creator                : @0xa0d23178f75e7bda9a69a929a036e69a9598417255223a9c45b813a4751e4ef9,
