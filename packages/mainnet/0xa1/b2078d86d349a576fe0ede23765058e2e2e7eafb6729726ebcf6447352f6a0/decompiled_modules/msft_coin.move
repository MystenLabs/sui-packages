module 0xa1b2078d86d349a576fe0ede23765058e2e2e7eafb6729726ebcf6447352f6a0::msft_coin {
    ...
    public entry fun burn(arg0: &mut MSFTTreasury, arg1: &mut 0xa1b2078d86d349a576fe0ede23765058e2e2e7eafb6729726ebcf6447352f6a0::registry::StockRegistry, arg2: 0x2::coin::Coin<MSFT_COIN>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xa1b2078d86d349a576fe0ede23765058e2e2e7eafb6729726ebcf6447352f6a0::registry::emit_burn_event(0x1::string::utf8(b"MSFT"), v0, 0x2::tx_context::sender(arg3));
    }

    public entry fun mint(arg0: &0xa1b2078d86d349a576fe0ede23765058e2e2e7eafb6729726ebcf6447352f6a0::registry::MinterCap, arg1: &mut MSFTTreasury, arg2: &mut 0xa1b2078d86d349a576fe0ede23765058e2e2e7eafb6729726ebcf6447352f6a0::registry::StockRegistry, arg3: u64, arg4: vector<u8>, arg5: vector<u8>, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0xa1b2078d86d349a576fe0ede23765058e2e2e7eafb6729726ebcf6447352f6a0::registry::emit_mint_event(0x1::string::utf8(b"MSFT"), arg3, arg6, v1);
    ...
    fun init(arg0: MSFT_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MSFT_COIN>(arg0, 8, b"MSFTx", b"Microsoft Synthetic Stock", b"Synthetic Microsoft stock backed 1:1 by Backed Finance MSFT tokens on Solana", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"ipfs://bafkreiaf3f22gkbiwq7tasqh3ypvgn2dzwrjwyqmhtfjcu3bwphkpw4oxa")), arg1);
