module 0xa1c567082c5af345fe70effe34fc12c1b10b6ba79e99d2c670c1b4d42ef27e7f::make_meme_on_sui_pump {
    struct MAKE_MEME_ON_SUI_PUMP has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MAKE_MEME_ON_SUI_PUMP, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MAKE_MEME_ON_SUI_PUMP>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Make meme on Sui Pump"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"make make meme sui great again"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://yA9tylJHv2Ve7kAUuCqBXtd5fE6dyVzZubvHOsyI_3U"));
