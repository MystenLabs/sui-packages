module 0x2c45b38a7eda6a058a4461ac4af4d547edae24abbc833da8116bc11a408a4aed::vault {
    ...
    public fun migration_begin<T0: store, T1, T2>(arg0: &VaultCap, arg1: &mut Vault<T0, T1, T2>) {
        ...
        let v0 = MigrationWindDownStartedEvent{vault_id: 0x2::object::id<Vault<T0, T1, T2>>(arg1)};
        0x2::event::emit<MigrationWindDownStartedEvent>(v0);
    }
    ...
    public fun migration_collect_reward<T0, T1, T2, T3>(arg0: &VaultCap, arg1: &mut Vault<T0, T1, T2>, arg2: &0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_config::IncentiveConfig, arg3: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_pool::IncentivePools, arg4: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_account::IncentiveAccounts, arg5: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert_vault_obligation<T0, T1, T2>(arg1, arg5);
        let v0 = 0x2::coin::into_balance<T3>(0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::user::redeem_rewards<T3>(arg2, arg3, arg4, &mut arg1.obligation_key, arg5, arg6, arg7));
        store_wind_down_reward<T0, T1, T2, T3>(arg1, v0);
        let v1 = MigrationRewardStoredEvent{
            vault_id     : 0x2::object::id<Vault<T0, T1, T2>>(arg1),
            reward_type  : 0x1::type_name::get<T3>(),
            amount       : 0x2::balance::value<T3>(&v0),
            total_stored : stored_wind_down_reward<T0, T1, T2, T3>(arg1),
            sender       : 0x2::tx_context::sender(arg7),
        };
        0x2::event::emit<MigrationRewardStoredEvent>(v1);
    }
    ...
    public fun migration_final_withdraw<T0: store, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: 0x2::coin::Coin<T2>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v3 = take_final_assets<T0, T1, T2>(arg0, v2);
        let v4 = MigrationFinalWithdrawalEvent{
            vault_id            : 0x2::object::id<Vault<T0, T1, T2>>(arg0),
            user                : 0x2::tx_context::sender(arg3),
            vt_burned           : v0,
            amount_out          : v2,
            remaining_assets    : final_assets<T0, T1, T2>(arg0),
            remaining_vt_supply : total_vt_supply<T0, T1, T2>(arg0),
        };
        0x2::event::emit<MigrationFinalWithdrawalEvent>(v4);
    ...
    public fun migration_finalize<T0: store, T1, T2>(arg0: &VaultCap, arg1: &mut Vault<T0, T1, T2>, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation) {
        ...
        let v2 = MigrationWindDownFinalizedEvent{
            vault_id        : 0x2::object::id<Vault<T0, T1, T2>>(arg1),
            final_assets    : final_assets<T0, T1, T2>(arg1),
            total_vt_supply : total_vt_supply<T0, T1, T2>(arg1),
        };
        0x2::event::emit<MigrationWindDownFinalizedEvent>(v2);
    }
