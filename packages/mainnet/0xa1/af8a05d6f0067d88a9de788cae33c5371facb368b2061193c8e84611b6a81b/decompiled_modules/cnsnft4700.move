module 0xa1af8a05d6f0067d88a9de788cae33c5371facb368b2061193c8e84611b6a81b::cnsnft4700 {
    struct CNSNFT4700 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4700, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4700>(arg0, arg1);
