module 0xa1bf78212119c592be771abb078ba9231e5e586fac7de29acc308b0215180182::tikcoin {
    ...
    public entry fun claim(arg0: &mut Treasury<TIKCOIN>, arg1: &mut 0xa1bf78212119c592be771abb078ba9231e5e586fac7de29acc308b0215180182::mine::Miner, arg2: &0xa1bf78212119c592be771abb078ba9231e5e586fac7de29acc308b0215180182::mine::Epochs, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xa1bf78212119c592be771abb078ba9231e5e586fac7de29acc308b0215180182::mine::claim(arg1, arg2, arg3, arg4);
        if (v0 > 0) {
            let v1 = v0 * 1 / 100;
    ...
    fun init(arg0: TIKCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TIKCOIN>(arg0, 12, b"TIME", b"TIMECOIN", b"Time Flies, $TIME Stays! Everyone Gets a Fair Chance to Mine and Earn Rewards!", 0x1::option::some<0x2::url::Url>(0xa1bf78212119c592be771abb078ba9231e5e586fac7de29acc308b0215180182::icon::get_icon_url()), arg1);
