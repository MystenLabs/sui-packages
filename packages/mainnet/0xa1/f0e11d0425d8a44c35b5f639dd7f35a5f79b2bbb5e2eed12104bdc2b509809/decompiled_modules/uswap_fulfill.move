module 0xa1f0e11d0425d8a44c35b5f639dd7f35a5f79b2bbb5e2eed12104bdc2b509809::uswap_fulfill {
    ...
    fun assert_is_corridor_stable<T0>(arg0: &vector<u8>) {
        assert!(payload_hash_of_type(0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()))) == 0xa1f0e11d0425d8a44c35b5f639dd7f35a5f79b2bbb5e2eed12104bdc2b509809::blob::dst_stable_hash_of(arg0), 7);
    }
    ...
    fun begin_fulfill_inner<T0>(arg0: &mut FulfillRegistry, arg1: vector<u8>, arg2: vector<0x2::transfer::Receiving<0x2::coin::Coin<T0>>>) : (0x2::coin::Coin<T0>, FulfillReceipt) {
        let v0 = 0xa1f0e11d0425d8a44c35b5f639dd7f35a5f79b2bbb5e2eed12104bdc2b509809::blob::parse(arg1);
        assert!(0xa1f0e11d0425d8a44c35b5f639dd7f35a5f79b2bbb5e2eed12104bdc2b509809::blob::dst_chain_id(&v0) == 101, 1);
        let v1 = 0xa1f0e11d0425d8a44c35b5f639dd7f35a5f79b2bbb5e2eed12104bdc2b509809::blob::intent_id(&v0);
        let v2 = receive_all<T0>(arg0, v1, arg2);
        let v3 = 0x2::coin::value<T0>(&v2);
        assert!(v3 > 0, 3);
        let v4 = FulfillReceipt{
            intent_id      : v1,
            dst_token_hash : 0xa1f0e11d0425d8a44c35b5f639dd7f35a5f79b2bbb5e2eed12104bdc2b509809::blob::dst_token_hash(&v0),
            dst_recipient  : 0xa1f0e11d0425d8a44c35b5f639dd7f35a5f79b2bbb5e2eed12104bdc2b509809::blob::dst_recipient(&v0),
            min_final_out  : 0xa1f0e11d0425d8a44c35b5f639dd7f35a5f79b2bbb5e2eed12104bdc2b509809::blob::min_final_out(&v0),
            usdc_in        : v3,
        };
        (v2, v4)
    }
    ...
    public fun encode_refund_attestation(arg0: vector<u8>, arg1: address, arg2: u64) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0x8f5d8eecedc3ec113c7d23b4d9816c33f495d8e1829b3e250275e4d3a31fdce7::utils::u64_to_be_bytes(arg2));
        v0
    }
    ...
    public fun refund_redeposit<T0>(arg0: &mut FulfillRegistry, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<0x2::transfer::Receiving<0x2::coin::Coin<T0>>>, arg4: &mut 0x58978a0c0678f010ff0ced45da75bf76f2cc33b96508c9a616dc547651f78341::liquidity_pool::Bank, arg5: &mut 0x8f5d8eecedc3ec113c7d23b4d9816c33f495d8e1829b3e250275e4d3a31fdce7::inbox_bridge::InboxBridge, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        assert_is_corridor_stable<T0>(&arg1);
    ...
    fun refund_redeposit_inner<T0>(arg0: &mut FulfillRegistry, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<0x2::transfer::Receiving<0x2::coin::Coin<T0>>>, arg4: &mut 0x58978a0c0678f010ff0ced45da75bf76f2cc33b96508c9a616dc547651f78341::liquidity_pool::Bank, arg5: &mut 0x8f5d8eecedc3ec113c7d23b4d9816c33f495d8e1829b3e250275e4d3a31fdce7::inbox_bridge::InboxBridge, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        ...
        let v0 = 0xa1f0e11d0425d8a44c35b5f639dd7f35a5f79b2bbb5e2eed12104bdc2b509809::blob::parse(arg1);
        assert!(0xa1f0e11d0425d8a44c35b5f639dd7f35a5f79b2bbb5e2eed12104bdc2b509809::blob::dst_chain_id(&v0) == 101, 1);
        assert!(0x2::clock::timestamp_ms(arg6) > 0xa1f0e11d0425d8a44c35b5f639dd7f35a5f79b2bbb5e2eed12104bdc2b509809::blob::deadline(&v0) * 1000 + 60000, 12);
        assert!(0x1::vector::length<u8>(&arg2) == 32, 11);
        let v1 = 0x2::address::from_bytes(arg2);
        let v2 = 0xa1f0e11d0425d8a44c35b5f639dd7f35a5f79b2bbb5e2eed12104bdc2b509809::blob::intent_id(&v0);
        let v3 = receive_all<T0>(arg0, v2, arg3);
        let v4 = 0x2::coin::value<T0>(&v3);
        assert!(v4 > 0, 3);
        0x58978a0c0678f010ff0ced45da75bf76f2cc33b96508c9a616dc547651f78341::liquidity_pool::deposit<T0>(arg4, v1, v3, arg5, arg6);
        let v5 = JupnetInboxWitness{dummy_field: false};
        let (_, v7, _) = 0x8f5d8eecedc3ec113c7d23b4d9816c33f495d8e1829b3e250275e4d3a31fdce7::inbox_bridge::submit_inbox_message<JupnetInboxWitness>(arg5, v5, encode_refund_attestation(v2, v1, v4), arg6);
    ...
    public fun register_with_inbox(arg0: &mut 0x8f5d8eecedc3ec113c7d23b4d9816c33f495d8e1829b3e250275e4d3a31fdce7::inbox_bridge::InboxBridge, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        0x8f5d8eecedc3ec113c7d23b4d9816c33f495d8e1829b3e250275e4d3a31fdce7::inbox_bridge::register<JupnetInboxWitness>(arg0, arg1, arg2);
    }
