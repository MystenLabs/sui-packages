module 0xa1cce7e1ce3334165679934b1d3ea48dccd68096d852c739427a162be4d4afa4::reward7742 {
    struct REWARD7742 has drop {
        dummy_field: bool,
    }

    struct TICKET_7742 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7742(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7742>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7742>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7742, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7742>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7742>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7742>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7742>>(v5, 0x2::tx_context::sender(arg1));
    }
