module 0xa12ca3425f9c163f6ef8931dec6a373cd246da613d702cb9c342a647689328f4::reward3326 {
    struct REWARD3326 has drop {
        dummy_field: bool,
    }

    struct TICKET_3326 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3326(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3326>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3326>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3326, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3326>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3326>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3326>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3326>>(v5, 0x2::tx_context::sender(arg1));
    }
