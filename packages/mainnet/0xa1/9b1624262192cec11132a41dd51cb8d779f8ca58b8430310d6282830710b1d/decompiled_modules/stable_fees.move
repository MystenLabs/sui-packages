module 0xa19b1624262192cec11132a41dd51cb8d779f8ca58b8430310d6282830710b1d::stable_fees {
    ...
    public fun update_admin_fee_percent(arg0: &mut StableFees, arg1: 0x1::option::Option<u256>) {
        ...
        assert!(200000000000000000 >= v0, 0xa19b1624262192cec11132a41dd51cb8d779f8ca58b8430310d6282830710b1d::errors::invalid_fee());
    ...
    public fun update_fee_in_percent(arg0: &mut StableFees, arg1: 0x1::option::Option<u256>) {
        ...
        let v0 = 0x1::option::extract<u256>(&mut arg1);
        assert!(20000000000000000 >= v0, 0xa19b1624262192cec11132a41dd51cb8d779f8ca58b8430310d6282830710b1d::errors::invalid_fee());
