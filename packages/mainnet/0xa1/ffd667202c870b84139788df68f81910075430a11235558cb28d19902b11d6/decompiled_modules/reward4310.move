module 0xa1ffd667202c870b84139788df68f81910075430a11235558cb28d19902b11d6::reward4310 {
    struct REWARD4310 has drop {
        dummy_field: bool,
    }

    struct TICKET_4310 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4310(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4310>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4310>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4310, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4310>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4310>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4310>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4310>>(v5, 0x2::tx_context::sender(arg1));
    }
