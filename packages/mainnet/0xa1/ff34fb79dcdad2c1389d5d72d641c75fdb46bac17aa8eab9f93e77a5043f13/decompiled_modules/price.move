module 0xa1ff34fb79dcdad2c1389d5d72d641c75fdb46bac17aa8eab9f93e77a5043f13::price {
    ...
    public(friend) fun read_price(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &vector<u8>, arg2: u64, arg3: u8) : u64 {
        ...
        let v4 = 0xa1ff34fb79dcdad2c1389d5d72d641c75fdb46bac17aa8eab9f93e77a5043f13::config::oracle_tolerance_ms(arg3);
        let v5 = if (arg2 > v4) {
            arg2 - v4
        } else {
            0
