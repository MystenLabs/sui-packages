module 0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::bounty {
    ...
    public fun cancel_bounty(arg0: &mut Bounty, arg1: &mut 0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::Room, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 0, 1);
        assert!(arg0.room == 0x2::object::id<0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::Room>(arg1), 10);
        assert!(0x2::tx_context::sender(arg3) == arg0.poster, 0);
        refund_to_poster(arg0, arg2, arg3);
        0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::dec_active_bounties(arg1);
    }

    public fun claim_after_review_timeout(arg0: &mut Bounty, arg1: &mut 0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::Room, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 2, 1);
        assert!(arg0.room == 0x2::object::id<0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::Room>(arg1), 10);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x1::option::contains<address>(&arg0.claimer, &v0), 0);
        assert!(0x2::clock::timestamp_ms(arg2) >= arg0.review_deadline_ms, 8);
        payout_to_claimer(arg0, true, arg2, arg3);
        0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::dec_active_bounties(arg1);
    }
    ...
    fun payout_to_claimer(arg0: &mut Bounty, arg1: bool, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = *0x1::option::borrow<address>(&arg0.claimer);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.locked), arg3), v0);
        arg0.status = 3;
        let v1 = BountyReleased{
            bounty        : 0x2::object::uid_to_inner(&arg0.id),
            claimer       : v0,
            amount        : arg0.amount,
            auto_released : arg1,
        ...
        0x2::event::emit<BountyReleased>(v1);
    }

    public fun post_bounty(arg0: &mut 0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::Room, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::is_open(arg0), 11);
        assert!(arg2 > 0, 2);
        ...
        let v5 = 0x2::object::id<0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::Room>(arg0);
        let v6 = Bounty{
        ...
        0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::inc_active_bounties(arg0);
    ...
    public fun release_bounty(arg0: &mut Bounty, arg1: &mut 0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::Room, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 2, 1);
        assert!(arg0.room == 0x2::object::id<0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::Room>(arg1), 10);
        assert!(0x2::tx_context::sender(arg3) == arg0.poster, 0);
        payout_to_claimer(arg0, false, arg2, arg3);
        0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::dec_active_bounties(arg1);
    }
    ...
    public fun resolve_dispute(arg0: &0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::AdminCap, arg1: &mut Bounty, arg2: &mut 0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::Room, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == 5, 1);
        assert!(arg1.room == 0x2::object::id<0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::Room>(arg2), 10);
        assert!(arg3 + arg4 == arg1.amount, 12);
        assert!(0x1::vector::length<u8>(&arg5) <= 96, 6);
        if (arg3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.locked, arg3), arg7), *0x1::option::borrow<address>(&arg1.claimer));
        };
        if (arg4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.locked, arg4), arg7), arg1.poster);
        };
        arg1.status = 3;
        let v0 = DisputeResolved{
            ...
            to_claimer   : arg3,
            to_poster    : arg4,
            verdict_cid  : 0x1::string::utf8(arg5),
            timestamp_ms : 0x2::clock::timestamp_ms(arg6),
        };
        0x2::event::emit<DisputeResolved>(v0);
        0xa1b9253c2780091febc3c48e8c054f2b0b21a056ad05ffbfc5d896caf008a662::ephemeral_chat::dec_active_bounties(arg2);
    }
