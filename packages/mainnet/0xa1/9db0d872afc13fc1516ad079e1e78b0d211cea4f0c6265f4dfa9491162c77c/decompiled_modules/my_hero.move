module 0xa19db0d872afc13fc1516ad079e1e78b0d211cea4f0c6265f4dfa9491162c77c::my_hero {
    ...
    public entry fun send(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Hero{
            ...
            name        : 0x1::string::utf8(b"Nem"),
            img_url     : 0x1::string::utf8(b"https://ipfs.io/ipfs/QmdyZkfnpxnQgmPn1LmPccaDzQ1GVHU11rHrUvEybysMuD"),
