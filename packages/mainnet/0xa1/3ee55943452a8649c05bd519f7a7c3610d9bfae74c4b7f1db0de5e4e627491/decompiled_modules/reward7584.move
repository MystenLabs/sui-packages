module 0xa13ee55943452a8649c05bd519f7a7c3610d9bfae74c4b7f1db0de5e4e627491::reward7584 {
    struct REWARD7584 has drop {
        dummy_field: bool,
    }

    struct TICKET_7584 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7584(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7584>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7584>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7584, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7584>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7584>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7584>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7584>>(v5, 0x2::tx_context::sender(arg1));
    }
