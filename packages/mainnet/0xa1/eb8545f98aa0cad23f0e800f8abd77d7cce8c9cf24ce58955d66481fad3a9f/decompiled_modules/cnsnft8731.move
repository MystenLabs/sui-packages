module 0xa1eb8545f98aa0cad23f0e800f8abd77d7cce8c9cf24ce58955d66481fad3a9f::cnsnft8731 {
    struct CNSNFT8731 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8731, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8731>(arg0, arg1);
