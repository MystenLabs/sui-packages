module 0xa1fd294800a67f4db92048db6a51352f3f08560ae0b65d66255c92bf5b88723a::btc {
    struct BTC has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BTC, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<BTC>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BTC     ")))), trim_right(b"BTC100K                         "), trim_right(b"$100K                                                                                                                                                                                                                                                                                                                           "), v2, arg1);
