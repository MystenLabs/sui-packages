module 0xa1d8b2bcb4cd57a8ccc98e18a505cb79dd06731f5a92f2b9711a4ae22bb1aabe::auto_position {
    ...
    public fun new<T0: store + key>(arg0: T0, arg1: 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, arg2: address, arg3: u64, arg4: &0xa1d8b2bcb4cd57a8ccc98e18a505cb79dd06731f5a92f2b9711a4ae22bb1aabe::registry::ProxyCap) : AutoPosition<T0> {
        assert!(arg3 < 0xa1d8b2bcb4cd57a8ccc98e18a505cb79dd06731f5a92f2b9711a4ae22bb1aabe::constants::scaling_pips(), 2);
        AutoPosition<T0>{
            owner         : arg2,
            inner         : arg0,
            vault         : arg1,
    ...
    public fun unwrap<T0: store + key>(arg0: AutoPosition<T0>, arg1: &0xa1d8b2bcb4cd57a8ccc98e18a505cb79dd06731f5a92f2b9711a4ae22bb1aabe::registry::ProxyCap) : (address, T0, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, u64) {
        let AutoPosition {
            owner         : v0,
            inner         : v1,
            vault         : v2,
