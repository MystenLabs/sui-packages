module 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::market {
    ...
    struct SetMarketLongPauseEvent has copy, drop {
        market_id: 0x2::object::ID,
        is_long_pause: bool,
        sender: address,
        timestamp: u64,
    ...
    struct SetMarketShortPauseEvent has copy, drop {
        market_id: 0x2::object::ID,
        is_short_pause: bool,
        sender: address,
        timestamp: u64,
    ...
    public(friend) fun assert_leverage_valid<T0, T1>(arg0: &Market<T0, T1>, arg1: u64, arg2: bool) {
        if (arg2) {
            assert!(arg1 > 0 && arg1 <= arg0.max_long_leverage, 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors::err_leverage_too_high());
        } else {
            assert!(arg1 > 0 && arg1 <= arg0.max_short_leverage, 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors::err_leverage_too_high());
        };
    }

    public(friend) fun assert_long_not_paused<T0, T1>(arg0: &Market<T0, T1>) {
        assert!(!arg0.is_long_pause, 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors::err_market_long_paused());
    }

    public(friend) fun assert_short_not_paused<T0, T1>(arg0: &Market<T0, T1>) {
        assert!(!arg0.is_short_pause, 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors::err_market_short_paused());
    }
    ...
    public fun claim_fees<T0, T1>(arg0: &0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::config::AdminCap, arg1: &mut Market<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let v0 = 0x2::balance::value<T1>(&arg1.fee);
        let v1 = ClaimFeeEvent{
            market_id : 0x2::object::uid_to_inner(&arg1.id),
            recipient : 0x2::tx_context::sender(arg3),
            amount    : v0,
            timestamp : 0x2::clock::timestamp_ms(arg2),
        };
        0x2::event::emit<ClaimFeeEvent>(v1);
        0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.fee, v0), arg3)
    }

    public fun create_market<T0, T1>(arg0: &0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::config::AdminCap, arg1: &mut Markets, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg4 <= 100000, 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors::err_invalid_fee_rate());
        assert!(arg5 <= 100000, 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors::err_invalid_fee_rate());
        assert!(arg2 > 0, 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors::err_invalid_leverage());
        assert!(arg3 > 0, 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors::err_invalid_leverage());
    ...
    public fun is_market_long_paused<T0, T1>(arg0: &Market<T0, T1>) : bool {
        arg0.is_long_pause
    }

    public fun is_market_short_paused<T0, T1>(arg0: &Market<T0, T1>) : bool {
        arg0.is_short_pause
    }

    public(friend) fun join_close_fee<T0, T1>(arg0: &mut Market<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &0x2::clock::Clock) {
        0x2::balance::join<T1>(&mut arg0.fee, 0x2::coin::into_balance<T1>(arg1));
    ...
    public(friend) fun join_open_fee<T0, T1>(arg0: &mut Market<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &0x2::clock::Clock) {
        0x2::balance::join<T1>(&mut arg0.fee, 0x2::coin::into_balance<T1>(arg1));
        let v0 = FeeCollectedEvent{
            market_id : 0x2::object::uid_to_inner(&arg0.id),
            fee_type  : 0,
    ...
    public fun set_fee_rate<T0, T1>(arg0: &0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::config::AdminCap, arg1: &mut Market<T0, T1>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(arg2 <= 100000, 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors::err_invalid_fee_rate());
        assert!(arg3 <= 100000, 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors::err_invalid_fee_rate());
    ...
    public fun set_market_long_pause<T0, T1>(arg0: &0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::config::AdminCap, arg1: &mut Market<T0, T1>, arg2: bool, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        arg1.is_long_pause = arg2;
        let v0 = SetMarketLongPauseEvent{
            market_id     : 0x2::object::uid_to_inner(&arg1.id),
            is_long_pause : arg2,
            sender        : 0x2::tx_context::sender(arg4),
            timestamp     : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<SetMarketLongPauseEvent>(v0);
    }

    public fun set_market_short_pause<T0, T1>(arg0: &0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::config::AdminCap, arg1: &mut Market<T0, T1>, arg2: bool, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        arg1.is_short_pause = arg2;
        let v0 = SetMarketShortPauseEvent{
            market_id      : 0x2::object::uid_to_inner(&arg1.id),
            is_short_pause : arg2,
            sender         : 0x2::tx_context::sender(arg4),
            timestamp      : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<SetMarketShortPauseEvent>(v0);
    }

    public fun set_max_leverage<T0, T1>(arg0: &0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::config::AdminCap, arg1: &mut Market<T0, T1>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(arg2 > 0, 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors::err_invalid_leverage());
        assert!(arg3 > 0, 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors::err_invalid_leverage());
