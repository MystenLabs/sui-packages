module 0xa1265373a081c3529c303a727118205b6a766843fcefa9ffc6d3463b2a7a3117::errors {
    ...
    public fun err_global_long_paused() : u64 {
        abort 204
    }

    public fun err_global_short_paused() : u64 {
        abort 205
    }
    ...
    public fun err_market_long_paused() : u64 {
        abort 202
    }
    ...
    public fun err_market_short_paused() : u64 {
        abort 203
    }
