module 0xa1740591b271628aa1d3e512108e13e7f998fdcb665cea8456b265f8d0950198::dex_dao {
    struct PoolsGovernor has store, key {
        ...
        pool_hive_cap: 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::config::PoolHiveCapability,
    ...
    struct PoolHive<phantom T0> has store, key {
        ...
        gems_available: 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::HiveGems,
    ...
    fun accrue_hive_for_bee_box<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut LpBeeBox<T0>, arg3: u64) : 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::HiveGems {
        ...
        if (v1 == 0) {
            ...
            return 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::zero()
        };
        ...
        if (v2 > 0 && arg1.total_staked > 0 && arg3 >= arg0.hive_emissions_schedule.start_epoch && arg3 <= arg0.hive_emissions_schedule.end_epoch) {
            let v4 = (0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256((arg0.hive_emissions_schedule.hive_per_epoch as u256), (v1 as u256), (arg0.total_emission_points as u256)) as u64);
            let v5 = 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256(((v2 * v4) as u256), (1000000 as u256), (arg1.total_staked as u256));
            arg1.global_claim_index = arg1.global_claim_index + v5;
            arg1.last_claim_epoch = arg3;
            let v6 = (0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256((arg1.total_staked as u256), (v5 as u256), (1000000 as u256)) as u64);
            let v7 = 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::zero();
            if (v6 <= 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::get_available_gems_in_profile(&arg0.governor_profile)) {
                0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::join(&mut v7, 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::withdraw_gems_from_comp_profile(&mut arg0.governor_profile, v6));
            };
            0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::join(&mut arg1.gems_available, v7);
        ...
        if (v9 > 0 && arg1.global_claim_index > arg2.claim_index) {
            let v10 = (0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256(((arg1.global_claim_index - arg2.claim_index) as u256), (v9 as u256), (1000000 as u256)) as u64);
            v3 = v10;
            arg2.claim_index = arg1.global_claim_index;
            arg2.total_gems_earned = arg2.total_gems_earned + v10;
        };
        if (v3 > 0) {
            0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::split(&mut arg1.gems_available, v3)
        } else {
            0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::zero()
        }
    }
    ...
    public fun add_more_fruits<T0, T1>(arg0: &mut PoolHive<T0>, arg1: 0x2::balance::Balance<T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        if (v0 >= v4.start_epoch) {
            ...
            if (v7 > 0) {
                v4.claim_index = v4.claim_index + (0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256(((v4.fruits_per_epoch * v7) as u256), (1000000 as u256), (arg0.total_staked as u256)) as u256);
                v4.last_claim_epoch = v0;
            };
        };
        0x2::balance::join<T1>(&mut v4.available_fruits, 0x2::balance::split<T1>(&mut arg1, arg2));
        let v8 = 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div(1000000, arg2, v4.end_epoch - v6);
    ...
    public fun add_more_fruits_coins<T0, T1>(arg0: &mut PoolHive<T0>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::destroy_or_transfer_balance<T1>(v0, 0x2::tx_context::sender(arg3), arg3);
    }
    ...
    public fun burn_lp_tokens_for_hive_three_pool<T0, T1, T2, T3>(arg0: &mut PoolHive<0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::LP<T0, T1, T2, T3>>, arg1: &mut 0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::LiquidityPool<T0, T1, T2, T3>, arg2: &0x2::tx_context::TxContext) {
        0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::dangerous_burn_lp_coins<T0, T1, T2, T3>(arg1, 0x2::balance::withdraw_all<0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::LP<T0, T1, T2, T3>>(&mut arg0.locked_via_tax));
    }

    public fun burn_lp_tokens_for_hive_two_pool<T0, T1, T2>(arg0: &mut PoolHive<0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LP<T0, T1, T2>>, arg1: &mut 0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LiquidityPool<T0, T1, T2>, arg2: &0x2::tx_context::TxContext) {
        0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::dangerous_burn_lp_coins<T0, T1, T2>(arg1, 0x2::balance::withdraw_all<0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LP<T0, T1, T2>>(&mut arg0.locked_via_tax));
    }
    ...
    fun calculate_fruit_rewards<T0, T1>(arg0: &BeeFruit<T1>, arg1: &LpBeeBox<T0>, arg2: u64, arg3: u64) : u64 {
        ...
        let v4 = v3;
        if (v2 > 0 && arg2 > 0) {
            v4 = v3 + 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256(((arg0.fruits_per_epoch * v2) as u256), (1000000 as u256), (arg2 as u256));
        };
        ...
        (0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256(((v4 - v6) as u256), (0x2::balance::value<T0>(&arg1.staked_balance) as u256), (1000000 as u256)) as u64)
    }

    public entry fun castVote<T0>(arg0: &mut PoolHive<T0>, arg1: &0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 7038);
        ...
        assert!(v5 > 0, 7026);
        if (0x2::linked_table::contains<address, Vote>(&v4.voters, v0)) {
            let v6 = 0x2::linked_table::remove<address, Vote>(&mut v4.voters, v0);
            if (v6.vote) {
                v4.yes_votes = v4.yes_votes - v6.staked_amt;
            } else {
                v4.no_votes = v4.no_votes - v6.staked_amt;
            };
        };
        if (arg3 == true) {
        ...
        0x2::linked_table::push_back<address, Vote>(&mut v4.voters, v0, v7);
        let v8 = VoteCasted{
            pool_hive_addr : 0x2::object::uid_to_address(&arg0.id),
    ...
    fun claim_fruit_for_bee_box<T0, T1>(arg0: &mut BeeFruit<T1>, arg1: &mut LpBeeBox<T0>, arg2: address, arg3: u64, arg4: u64, arg5: address, arg6: 0x1::string::String, arg7: bool) : 0x2::balance::Balance<T1> {
        ...
        if (v3 > 0 && arg3 > 0) {
            arg0.claim_index = arg0.claim_index + 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256(((arg0.fruits_per_epoch * v3) as u256), (1000000 as u256), (arg3 as u256));
        ...
        let v7 = (0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256(((arg0.claim_index - *v6) as u256), (0x2::balance::value<T0>(&arg1.staked_balance) as u256), (1000000 as u256)) as u64);
        *v6 = arg0.claim_index;
        if (v7 > 0) {
    ...
    public entry fun cleanup_gov_buzzes(arg0: &mut PoolsGovernor, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg0.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")));
        let v1 = 0x2::linked_table::length<u64, GovernorBuzz>(&v0.governor_buzzes);
        if (v1 > arg0.buzzes_to_store) {
            let v2 = 0;
            while (v2 <= 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::min_u64(v1 - arg0.buzzes_to_store, arg1)) {
    ...
    public entry fun del_comment_from_governance_buzz(arg0: &mut PoolsGovernor, arg1: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3) = 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::get_profile_meta_info(arg1);
        authority_check(v2, v3, 0x2::tx_context::sender(arg4));
        let v4 = 0x2::linked_table::borrow_mut<u64, GovernorBuzz>(&mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg0.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes"))).governor_buzzes, arg2);
    ...
    fun deposit_hive_and_unbond_shares<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg3: address, arg4: LpBeeBox<T0>, arg5: u64, arg6: u64) {
        assert!(0x2::balance::value<T0>(&arg4.staked_balance) >= arg5, 7008);
        let v0 = &mut arg4;
        let v1 = accrue_hive_for_bee_box<T0>(arg0, arg1, v0, arg6);
        let v2 = 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::value(&v1);
        if (v2 > 0) {
            0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::deposit_gems_in_profile(arg2, v1);
        } else {
    ...
    public fun deposit_hive_as_incentives(arg0: &mut PoolsGovernor, arg1: &mut 0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HiveVault, arg2: 0x2::coin::Coin<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::burn_hive_for_gems(arg1, &mut arg0.governor_profile, arg2, arg3, arg4);
    }

    fun deposit_into_bee_box<T0>(arg0: address, arg1: 0x1::string::String, arg2: &mut PoolsGovernor, arg3: &mut PoolHive<T0>, arg4: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg5: LpBeeBox<T0>, arg6: 0x2::balance::Balance<T0>, arg7: u64) {
        let v0 = &mut arg5;
        let v1 = accrue_hive_for_bee_box<T0>(arg2, arg3, v0, arg7);
        let v2 = 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::value(&v1);
        if (v2 > 0) {
            0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::deposit_gems_in_profile(arg4, v1);
        } else {
            0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::destroy_zero(v1);
        };
    ...
    public fun deposit_into_bee_box_0_fruits<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x2::tx_context::epoch(arg4);
        0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::make_forever_subscriber_of_comp_profile(0, arg2, &mut arg0.governor_profile, arg4);
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 0, 7006);
        let (v1, v2, v3, v4) = 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::get_profile_meta_info(arg2);
    ...
    public fun deposit_into_bee_box_1_fruits<T0, T1>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::make_forever_subscriber_of_comp_profile(0, arg2, &mut arg0.governor_profile, arg4);
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 1, 7006);
        let (v2, v3, v4, v5) = 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::get_profile_meta_info(arg2);
        ...
        let v8 = &mut v6;
        let v9 = claim_fruit_for_bee_box<T0, T1>(v7, v8, v1, arg1.total_staked, v0, v2, v3, false);
        deposit_into_bee_box<T0>(v2, v3, arg0, arg1, arg2, v6, arg3, v0);
        v9
    }

    public fun deposit_into_bee_box_2_fruits<T0, T1, T2>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::make_forever_subscriber_of_comp_profile(0, arg2, &mut arg0.governor_profile, arg4);
        ...
        let v11 = &mut v6;
        let v12 = claim_fruit_for_bee_box<T0, T2>(v10, v11, v1, arg1.total_staked, v0, v2, v3, false);
        deposit_into_bee_box<T0>(v2, v3, arg0, arg1, arg2, v6, arg3, v0);
        (v9, v12)
    }

    public fun deposit_into_bee_box_3_fruits<T0, T1, T2, T3>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T3>) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::make_forever_subscriber_of_comp_profile(0, arg2, &mut arg0.governor_profile, arg4);
        ...
        let v14 = &mut v6;
        let v15 = claim_fruit_for_bee_box<T0, T3>(v13, v14, v1, arg1.total_staked, v0, v2, v3, false);
        deposit_into_bee_box<T0>(v2, v3, arg0, arg1, arg2, v6, arg3, v0);
        (v9, v12, v15)
    }
    ...
    fun destroy_proposal(arg0: Proposal) : (u64, address, 0x2::balance::Balance<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>, 0x1::string::String, 0x1::string::String, 0x1::string::String, u64, u64, u64, u64, u64, u64, u64, u64, 0x1::option::Option<FruitLife>, 0x1::option::Option<vector<u64>>, 0x1::option::Option<vector<u64>>, 0x1::option::Option<vector<u64>>) {
        let Proposal {
            proposal_id           : v0,
            proposer              : v1,
            deposit               : v2,
    ...
    public entry fun evaluateProposal<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HiveVault, arg3: u64, arg4: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveDisperser, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = if (v3 == 0) {
            ...
            0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u128((1000000 as u128), (v2 as u128), (v3 as u128))
        };
        let v5 = 0;
        let v6 = if (arg0.vote_config.proposal_required_quorum > v4) {
            v1.proposal_status = 5;
            0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::deposit_gems_for_hive(arg4, 0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::burn_hive_and_return_gems(arg2, 0x2::balance::withdraw_all<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>(&mut v1.deposit), v1.proposer, arg5));
            0x1::string::to_ascii(0x1::string::utf8(b"PROPOSAL_STATUS_CANCELLED"))
        } else {
            let v7 = 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u128((1000000 as u128), (v1.yes_votes as u128), (v2 as u128));
            v5 = v7;
        ...
        0x1::string::append(&mut v8, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v1.proposal_id)));
        ...
        0x1::string::append(&mut v8, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v3)));
        0x1::string::append(&mut v8, 0x1::string::utf8(x"0a546f74616c20766f746573206361737465643a20"));
        0x1::string::append(&mut v8, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v2)));
        0x1::string::append(&mut v8, 0x1::string::utf8(x"0a252070617274696369706174696f6e3a20"));
        0x1::string::append(&mut v8, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v4 * 100 / 1000000)));
        0x1::string::append(&mut v8, 0x1::string::utf8(x"0a59657320766f7465733a20"));
        0x1::string::append(&mut v8, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v1.yes_votes)));
        0x1::string::append(&mut v8, 0x1::string::utf8(x"0a4e6f20766f7465733a20"));
        0x1::string::append(&mut v8, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v1.no_votes)));
        0x1::string::append(&mut v8, 0x1::string::utf8(x"0a59657320766f746573207468726573686f6c643a20"));
        0x1::string::append(&mut v8, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v5)));
        let v9 = 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg0.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")));
    ...
    public entry fun executeProposalToAddFruit<T0, T1>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::string::append(&mut v6, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v2.proposal_id)));
        ...
        0x1::string::append(&mut v6, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v3.start_epoch)));
        0x1::string::append(&mut v6, 0x1::string::utf8(x"0a446973747269627574696f6e20656e64732061742065706f63683a20"));
        0x1::string::append(&mut v6, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v3.end_epoch)));
        let v7 = 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg0.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")));
    ...
    public entry fun executeThreePoolProposal<T0, T1, T2, T3>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::LP<T0, T1, T2, T3>>, arg2: &mut 0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::LiquidityPool<T0, T1, T2, T3>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::tx_context::epoch(arg4);
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x2::object::uid_to_address(&arg1.id);
        let v1 = 0x1::string::to_ascii(0x1::string::utf8(b"PROPOSAL_EXECUTED"));
        ...
        if (v2.proposal_type == 0) {
            ...
            0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::update_fee_for_pool<T0, T1, T2, T3>(arg2, &arg0.pool_hive_cap, *0x1::vector::borrow<u64>(&v3, 0), *0x1::vector::borrow<u64>(&v3, 1));
        };
        if (v2.proposal_type == 1) {
            ...
            0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::update_stable_config<T0, T1, T2, T3>(arg2, &arg0.pool_hive_cap, *0x1::vector::borrow<u64>(&v4, 0), *0x1::vector::borrow<u64>(&v4, 1), *0x1::vector::borrow<u64>(&v4, 2));
        };
        if (v2.proposal_type == 2) {
            ...
            0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::update_weighted_config<T0, T1, T2, T3>(arg2, &arg0.pool_hive_cap, 0x1::option::extract<vector<u64>>(&mut v2.new_weights), *0x1::vector::borrow<u64>(&v5, 0));
        };
        if (v2.proposal_type == 3) {
            ...
            0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::update_curved_A_and_gamma<T0, T1, T2, T3>(arg2, &arg0.pool_hive_cap, *0x1::vector::borrow<u64>(&v6, 0), *0x1::vector::borrow<u64>(&v6, 1), (*0x1::vector::borrow<u64>(&v6, 2) as u256), *0x1::vector::borrow<u64>(&v6, 3));
        };
        ...
        0x1::string::append(&mut v8, 0x1::string::utf8(x"0a0a50726f706f73616c2049443a20"));
        0x1::string::append(&mut v8, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v2.proposal_id)));
        0x1::string::append(&mut v8, 0x1::string::utf8(x"0a5469746c653a20"));
    ...
    public entry fun executeTwoPoolProposal<T0, T1, T2>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LP<T0, T1, T2>>, arg2: &mut 0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LiquidityPool<T0, T1, T2>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::tx_context::epoch(arg4);
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x2::object::uid_to_address(&arg1.id);
        let v1 = 0x1::string::to_ascii(0x1::string::utf8(b"PROPOSAL_EXECUTED"));
        ...
        if (v2.proposal_type == 0) {
            v1 = 0x1::string::to_ascii(0x1::string::utf8(b"UPDATE_FEE_BREAKDOWN_EXECUTED"));
            let v3 = 0x1::option::extract<vector<u64>>(&mut v2.new_fee_info);
            0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::update_fee_for_pool<T0, T1, T2>(arg2, &arg0.pool_hive_cap, *0x1::vector::borrow<u64>(&v3, 0), *0x1::vector::borrow<u64>(&v3, 1));
        };
        if (v2.proposal_type == 1) {
            v1 = 0x1::string::to_ascii(0x1::string::utf8(b"UPDATE_STABLE_CONFIG_EXECUTED"));
            let v4 = 0x1::option::extract<vector<u64>>(&mut v2.new_params);
            0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::update_stable_config<T0, T1, T2>(arg2, &arg0.pool_hive_cap, *0x1::vector::borrow<u64>(&v4, 0), *0x1::vector::borrow<u64>(&v4, 1), *0x1::vector::borrow<u64>(&v4, 2));
        };
        if (v2.proposal_type == 2) {
            v1 = 0x1::string::to_ascii(0x1::string::utf8(b"UPDATE_WEIGHTED_CONFIG_EXECUTED"));
            let v5 = 0x1::option::extract<vector<u64>>(&mut v2.new_params);
            0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::update_weighted_config<T0, T1, T2>(arg2, &arg0.pool_hive_cap, 0x1::option::extract<vector<u64>>(&mut v2.new_weights), *0x1::vector::borrow<u64>(&v5, 0));
        };
        if (v2.proposal_type == 3) {
            v1 = 0x1::string::to_ascii(0x1::string::utf8(b"UPDATE_CURVED_A_AND_GAMMA_EXECUTED"));
            let v6 = 0x1::option::extract<vector<u64>>(&mut v2.new_params);
            0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::update_curved_A_and_gamma<T0, T1, T2>(arg2, &arg0.pool_hive_cap, *0x1::vector::borrow<u64>(&v6, 0), *0x1::vector::borrow<u64>(&v6, 1), (*0x1::vector::borrow<u64>(&v6, 2) as u256), *0x1::vector::borrow<u64>(&v6, 3));
        };
        if (v2.proposal_type == 4) {
            v1 = 0x1::string::to_ascii(0x1::string::utf8(b"UPDATE_CURVED_FEE_PARAMS_EXECUTED"));
            let v7 = 0x1::option::extract<vector<u64>>(&mut v2.new_params);
    ...
    public fun get_pool_hive<T0>(arg0: &PoolHive<T0>) : (u64, u64, u64, u256, u64, u64, vector<0x1::ascii::String>) {
        (arg0.total_staked, arg0.total_unbonding, 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::value(&arg0.gems_available), arg0.global_claim_index, arg0.last_claim_epoch, arg0.next_proposal_id, arg0.bee_fruit_list)
    }
    ...
    fun get_unbonding_psns_and_expected_hive<T0>(arg0: &PoolsGovernor, arg1: &PoolHive<T0>, arg2: &LpBeeBox<T0>, arg3: u64) : (vector<u64>, vector<u64>, u64, u64) {
        ...
        if (v4 > 0 && v5 > 0 && arg1.total_staked > 0) {
            let v9 = 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256((((0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256((arg0.hive_emissions_schedule.hive_per_epoch as u256), (v4 as u256), (arg0.total_emission_points as u256)) as u64) * v5) as u256), (1000000 as u256), (arg1.total_staked as u256));
            v7 = v6 + v9;
            v8 = (0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256((arg1.total_staked as u256), (v9 as u256), (1000000 as u256)) as u64);
        };
        let v10 = 0x2::balance::value<T0>(&arg2.staked_balance);
        let v11 = 0;
        if (v10 > 0 && v7 > arg2.claim_index) {
            v11 = (0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256((v10 as u256), ((v7 - arg2.claim_index) as u256), (1000000 as u256)) as u64);
        };
        (v0, v1, v8, v11)
    }
    ...
    public fun has_user_liked(arg0: &PoolsGovernor, arg1: address, arg2: u64) : bool {
        0x2::linked_table::contains<address, bool>(&0x2::linked_table::borrow<u64, GovernorBuzz>(&0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::borrow_from_profile<PoolGovernorBuzzes>(&arg0.governor_profile, 0x1::ascii::string(b"pool_governor_buzzes")).governor_buzzes, arg2).likes, arg1)
    }
    ...
    public fun initialize_pools_manager(arg0: &0x2::clock::Clock, arg1: 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::config::PoolHiveCapability, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x1c096bec7f46dd3dfd04bc2ab7c0050a0a1a504f9f2a2131893350589a50bc6e::dsui_vault::DSuiVault, arg4: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfileMappingStore, arg5: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveManager, arg6: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::DSuiDisperser<0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::dsui::DSUI>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: &mut 0x2::tx_context::TxContext) {
        ...
        0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::add_to_composable_profile<PoolGovernorBuzzes>(&mut v2, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")), v3);
        ...
        let v5 = VoteConfig{
            ...
            proposal_required_quorum    : 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div(1000000, arg16, 100),
            proposal_approval_threshold : 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div(1000000, arg17, 100),
        };
    ...
    public entry fun initiate_discussion_for_proposal<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveDisperser, arg3: &mut 0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HiveVault, arg4: 0x2::coin::Coin<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: &mut 0x2::tx_context::TxContext) {
        0x2::tx_context::epoch(arg9);
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x1::string::to_ascii(0x1::string::utf8(b"INITIATE_DISCUSSION"));
        let v1 = 0x2::coin::into_balance<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>(arg4);
        assert!(arg0.vote_config.proposal_required_deposit / 10 <= 0x2::balance::value<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>(&v1), 7018);
        0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::deposit_gems_for_hive(arg2, 0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::burn_hive_and_return_gems(arg3, 0x2::balance::split<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>(&mut v1, arg0.vote_config.proposal_required_deposit / 10), 0x2::tx_context::sender(arg9), arg9));
        ...
        let v3 = 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg0.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")));
        make_new_governor_buzz(v3, 0x2::object::uid_to_address(&arg1.id), v2, 0, arg9);
        0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::destroy_or_transfer_balance<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>(v1, 0x2::tx_context::sender(arg9), arg9);
    }

    public entry fun interact_with_governance_buzz(arg0: &0x2::clock::Clock, arg1: &0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveAppAccessCapability, arg2: &0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveManager, arg3: &mut PoolsGovernor, arg4: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg5: u64, arg6: u64, arg7: 0x1::string::String, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::linked_table::borrow_mut<u64, GovernorBuzz>(&mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg3.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes"))).governor_buzzes, arg5);
    ...
    public entry fun kraft_new_pool_hive_three_token_amm<T0, T1, T2, T3>(arg0: &mut PoolsGovernor, arg1: &mut 0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::LiquidityPool<T0, T1, T2, T3>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 7038);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::LP<T0, T1, T2, T3>>());
        let v1 = 0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::get_liquidity_pool_id<T0, T1, T2, T3>(arg1);
        ...
        let v6 = PoolHive<0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::LP<T0, T1, T2, T3>>{
            id                 : v3,
            total_staked       : 0,
            total_unbonding    : 0,
            locked_via_tax     : 0x2::balance::zero<0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::LP<T0, T1, T2, T3>>(),
            lp_bee_boxes       : 0x2::linked_table::new<address, LpBeeBox<0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::LP<T0, T1, T2, T3>>>(arg2),
            gems_available     : 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::zero(),
        ...
        0x2::transfer::share_object<PoolHive<0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::LP<T0, T1, T2, T3>>>(v6);
        ...
        0x98575e674db74873f6ddfdb27f3581f34bb4a41d079297483ffaa5a9d6cfc0fe::three_pool::set_pool_hive_addr<T0, T1, T2, T3>(arg1, &arg0.pool_hive_cap, v5);
    }

    public entry fun kraft_new_pool_hive_two_token_amm<T0, T1, T2>(arg0: &mut PoolsGovernor, arg1: &mut 0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LiquidityPool<T0, T1, T2>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 7038);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LP<T0, T1, T2>>());
        let v1 = 0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::get_liquidity_pool_id<T0, T1, T2>(arg1);
        let v2 = 0x2::tx_context::epoch(arg2);
        assert!(!0x2::linked_table::contains<0x1::ascii::String, address>(&arg0.pool_hives, v0), 7005);
        let v3 = 0x2::object::new(arg2);
        let v4 = 0x2::object::uid_to_inner(&v3);
        let v5 = 0x2::object::id_to_address(&v4);
        let v6 = PoolHive<0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LP<T0, T1, T2>>{
            id                 : v3,
            total_staked       : 0,
            total_unbonding    : 0,
            locked_via_tax     : 0x2::balance::zero<0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LP<T0, T1, T2>>(),
            lp_bee_boxes       : 0x2::linked_table::new<address, LpBeeBox<0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LP<T0, T1, T2>>>(arg2),
            gems_available     : 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::hive_gems::zero(),
            global_claim_index : 0,
            last_claim_epoch   : v2,
            bee_fruit_list     : 0x1::vector::empty<0x1::ascii::String>(),
        ...
        0x2::transfer::share_object<PoolHive<0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LP<T0, T1, T2>>>(v6);
        0x2::linked_table::push_back<0x1::ascii::String, address>(&mut arg0.pool_hives, v0, v5);
        0x2::linked_table::push_back<address, u64>(&mut arg0.emission_points_map, v5, 0);
        arg0.active_pool_hives = arg0.active_pool_hives + 1;
        let v7 = PoolHiveKrafted{
        ...
        0x2::event::emit<PoolHiveKrafted>(v7);
        0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::set_pool_hive_addr<T0, T1, T2>(arg1, &arg0.pool_hive_cap, v5);
    }
    ...
    public fun query_across_likes(arg0: &PoolsGovernor, arg1: u64, arg2: 0x1::option::Option<address>, arg3: u64) : (vector<address>, u64) {
        ...
        let v1 = 0x2::linked_table::borrow<u64, GovernorBuzz>(&0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::borrow_from_profile<PoolGovernorBuzzes>(&arg0.governor_profile, 0x1::ascii::string(b"pool_governor_buzzes")).governor_buzzes, arg1);
    ...
    public entry fun removeExpiredProposal<T0>(arg0: &mut PoolHive<T0>, arg1: &mut 0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HiveVault, arg2: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveDisperser, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::tx_context::epoch(arg4);
        assert!(arg0.module_version == 0, 7038);
        ...
        let v18 = v2;
        if (0x2::balance::value<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>(&v18) > 0) {
            0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::deposit_gems_for_hive(arg2, 0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::burn_hive_and_return_gems(arg1, v18, v1, arg4));
        } else {
            0x2::balance::destroy_zero<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>(v18);
        };
    ...
    public fun remove_expired_fruit<T0, T1>(arg0: &mut PoolHive<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::balance::value<T1>(&v11) > 0) {
            assert!(v0 > v7, 7017);
            0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::destroy_or_transfer_balance<T1>(v11, 0x2::tx_context::sender(arg1), arg1);
        } else {
            assert!(v0 > v6 + 2, 7017);
    ...
    public entry fun submit_proposal<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: 0x2::coin::Coin<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>, arg3: u64, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::option::Option<vector<u64>>, arg8: 0x1::option::Option<vector<u64>>, arg9: 0x1::option::Option<vector<u64>>, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch(arg10);
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        let v2 = 0x1::string::to_ascii(0x1::string::utf8(b"INVALID_PROPOSAL_TYPE"));
        let v3 = 0x2::coin::into_balance<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>(arg2);
        assert!(arg0.vote_config.proposal_required_deposit <= 0x2::balance::value<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>(&v3), 7018);
        ...
        if (arg3 == 4) {
            ...
            0x826db736a92b67900782ddd3d7b7765dc2dee80b17b255e12c0ff977cdc77ea1::curved_math::assert_new_config_params(*0x1::vector::borrow<u64>(&v16, 0), *0x1::vector::borrow<u64>(&v16, 1), *0x1::vector::borrow<u64>(&v16, 2), *0x1::vector::borrow<u64>(&v16, 3), *0x1::vector::borrow<u64>(&v16, 4), *0x1::vector::borrow<u64>(&v16, 5));
            assert!(0x1::vector::length<u64>(&v16) >= 6, 7019);
        };
        let v17 = Proposal{
            proposal_id           : arg1.next_proposal_id,
            proposer              : 0x2::tx_context::sender(arg10),
            deposit               : 0x2::balance::split<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>(&mut v3, arg0.vote_config.proposal_required_deposit),
            title                 : arg4,
            description           : arg5,
            link                  : arg6,
            proposal_type         : arg3,
        ...
        0x1::string::append(&mut v19, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v20)));
        ...
        let v21 = 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg0.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")));
        make_new_governor_buzz(v21, v1, v19, v20, arg10);
        0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::destroy_or_transfer_balance<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>(v3, 0x2::tx_context::sender(arg10), arg10);
    }

    public entry fun submit_proposal_to_add_fruit<T0, T1>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: 0x2::coin::Coin<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>, arg3: u64, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::string::append(&mut v7, 0x1::string::utf8(0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::u64_to_ascii(v8)));
        ...
        0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::coin_helper::destroy_or_transfer_balance<0xe1897fb329950bff07aaed50d45ae8e32cff04e22fe8f0b220cb1154a7ddf072::hive::HIVE>(v3, 0x2::tx_context::sender(arg9), arg9);
    }

    public fun unbond_from_bee_box_0_fruits<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 0, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
    ...
    public fun unbond_from_bee_box_1_fruits<T0, T1>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 1, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        ...
        let v7 = &mut v5;
        let v8 = claim_fruit_for_bee_box<T0, T1>(v6, v7, v1, arg1.total_staked, v0, v3, v4, true);
        deposit_hive_and_unbond_shares<T0>(arg0, arg1, arg2, v3, v5, arg3, v0);
        v8
    }

    public fun unbond_from_bee_box_2_fruits<T0, T1, T2>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 2, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        ...
        let v10 = &mut v5;
        let v11 = claim_fruit_for_bee_box<T0, T2>(v9, v10, v1, arg1.total_staked, v0, v3, v4, true);
        deposit_hive_and_unbond_shares<T0>(arg0, arg1, arg2, v3, v5, arg3, v0);
        (v8, v11)
    }

    public fun unbond_from_bee_box_3_fruits<T0, T1, T2, T3>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T3>) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 3, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        ...
        let v13 = &mut v5;
        let v14 = claim_fruit_for_bee_box<T0, T3>(v12, v13, v1, arg1.total_staked, v0, v3, v4, true);
        deposit_hive_and_unbond_shares<T0>(arg0, arg1, arg2, v3, v5, arg3, v0);
        (v8, v11, v14)
    }

    public fun unlock_from_bee_box<T0>(arg0: &mut PoolHive<T0>, arg1: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert!(arg0.module_version == 0, 7038);
        let (v0, v1, v2, v3) = 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::get_profile_meta_info(arg1);
        ...
        if (arg2 > 0) {
            ...
            let v7 = 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u128((arg2 as u128), (0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::constants::emergency_unlock_tax() as u128), (100 as u128));
    ...
    public fun update_hive_per_epoch(arg0: &mut PoolsGovernor, arg1: &0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::config::HiveDaoCapability, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 7038);
        let v0 = 0x2::tx_context::epoch(arg3);
        assert!(arg2 * 352 < 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::get_available_gems_in_profile(&arg0.governor_profile) / 3, 7040);
    ...
    public fun update_pool_hive_points(arg0: &mut PoolsGovernor, arg1: &0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::config::HiveDaoCapability, arg2: vector<address>, arg3: vector<u64>) {
        assert!(arg0.module_version == 0, 7038);
    ...
    public fun update_pools_governance_params(arg0: &mut PoolsGovernor, arg1: &0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::config::HiveDaoCapability, arg2: vector<u64>) {
        assert!(arg0.module_version == 0, 7038);
        ...
        if (50 >= v5 && v5 >= 10) {
            arg0.vote_config.proposal_required_quorum = 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div(1000000, v5, 100);
        };
        let v6 = *0x1::vector::borrow<u64>(&arg2, 6);
        if (70 > v6 && v6 >= 40) {
            arg0.vote_config.proposal_approval_threshold = 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div(1000000, v6, 100);
        };
    ...
    public fun update_system_buzz(arg0: &mut PoolsGovernor, arg1: &0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::config::DegenHiveDeployerCap, arg2: 0x1::ascii::String, arg3: 0x1::string::String, arg4: &0x2::tx_context::TxContext) {
    ...
    fun verify_and_extract_bee_box<T0>(arg0: &PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveProfile, arg3: &mut 0x2::tx_context::TxContext) : (LpBeeBox<T0>, address, 0x1::string::String) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
