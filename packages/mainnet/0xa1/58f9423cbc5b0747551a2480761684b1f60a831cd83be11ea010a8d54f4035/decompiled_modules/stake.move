module 0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake {
    ...
    public fun stake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::GlobalConfig, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun deposit_reward_coins<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::GlobalConfig, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!is_emergency_inner<T0, T1>(arg0, arg2), 109);
        assert!(!is_finished_inner<T0, T1>(arg0, arg3), 113);
    ...
    public fun emergency_unstake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::GlobalConfig, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
    ...
    public fun enable_emergency<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::GlobalConfig, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == 0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::get_emergency_admin_address(arg1), 111);
    ...
    public fun harvest<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::GlobalConfig, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert!(!is_emergency_inner<T0, T1>(arg0, arg1), 109);
    ...
    public fun is_emergency<T0, T1>(arg0: &StakePool<T0, T1>, arg1: &0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::GlobalConfig) : bool {
        is_emergency_inner<T0, T1>(arg0, arg1)
    }

    fun is_emergency_inner<T0, T1>(arg0: &StakePool<T0, T1>, arg1: &0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::GlobalConfig) : bool {
        arg0.emergency_locked || 0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::is_global_emergency(arg1)
    }
    ...
    public fun register_pool<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: u64, arg2: &0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::GlobalConfig, arg3: u8, arg4: u8, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::is_global_emergency(arg2), 109);
        assert!(arg1 > 0, 112);
        ...
        let v4 = StakePool<T0, T1>{
            ...
            reward_coins              : arg0,
            scale                     : 0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::math128::pow(10, (arg3 as u128)) * 1000000000000 / 0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::math128::pow(10, v3),
    ...
    public fun unstake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: u64, arg2: &0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::GlobalConfig, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg1 > 0, 105);
        assert!(!is_emergency_inner<T0, T1>(arg0, arg2), 109);
    ...
    public fun withdraw_to_treasury<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: u64, arg2: &0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::GlobalConfig, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert!(0x2::tx_context::sender(arg4) == 0xa158f9423cbc5b0747551a2480761684b1f60a831cd83be11ea010a8d54f4035::stake_config::get_treasury_admin_address(arg2), 115);
