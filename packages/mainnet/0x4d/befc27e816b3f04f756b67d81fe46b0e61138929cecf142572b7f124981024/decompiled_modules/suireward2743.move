module 0x4dbefc27e816b3f04f756b67d81fe46b0e61138929cecf142572b7f124981024::suireward2743 {
    ...
    public entry fun DistributeReward2743(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            ...
            0x2::transfer::public_transfer<SUI_REWARD_2743>(v0, 0x1::vector::pop_back<address>(&mut arg0));
        };
    }

    public entry fun burn_nft(arg0: SUI_REWARD_2743, arg1: &mut 0x2::tx_context::TxContext) {
        let SUI_REWARD_2743 {
            id          : v0,
            name        : v1,
            image_url   : v2,
