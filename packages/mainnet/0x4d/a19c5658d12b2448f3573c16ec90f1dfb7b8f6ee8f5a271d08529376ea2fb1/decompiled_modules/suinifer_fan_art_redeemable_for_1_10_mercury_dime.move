module 0x4da19c5658d12b2448f3573c16ec90f1dfb7b8f6ee8f5a271d08529376ea2fb1::suinifer_fan_art_redeemable_for_1_10_mercury_dime {
    struct SUINIFER_FAN_ART_REDEEMABLE_FOR_1_10_MERCURY_DIME has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUINIFER_FAN_ART_REDEEMABLE_FOR_1_10_MERCURY_DIME, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUINIFER_FAN_ART_REDEEMABLE_FOR_1_10_MERCURY_DIME>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Suinifer Fan art redeemable for 1/10 mercury dime"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Suinfer Fan art reddemable for 1/10 of a mercury dime. You may redeem at any one of the three events that we have plans, including the party and cruise or the social event."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibrjdsz4fw7bnjo46x2c52ibkfcemk3u5pmqxe3ashrokac24ue5m"));
