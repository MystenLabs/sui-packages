module 0x4d402fff4ed2ff872ff651a687e0a226f4488b1e61312b8392847201e863ae70::cnsnft8402 {
    struct CNSNFT8402 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8402, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9227"));
        let v4 = 0x2::package::claim<CNSNFT8402>(arg0, arg1);
