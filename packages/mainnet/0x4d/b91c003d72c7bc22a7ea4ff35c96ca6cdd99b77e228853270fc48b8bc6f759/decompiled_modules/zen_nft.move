module 0x4db91c003d72c7bc22a7ea4ff35c96ca6cdd99b77e228853270fc48b8bc6f759::zen_nft {
    ...
    struct OptionsStorage has store, key {
        ...
        test_one: 0x1::ascii::String,
        test_two: 0x1::ascii::String,
    }
    ...
    fun assert_is_zen_coin<T0>() {
        assert!(0x1::string::utf8(0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>()))) == 0x1::string::utf8(b"2665dc784c7ff17fddba2442b36cb8b2bbc8adfa9fe08794fd941d80ef2758ec::zen::ZEN"), 4);
    }
    ...
    fun create_config(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = OptionsStorage{
            ...
            test_one                  : 0x1::ascii::string(b""),
            test_two                  : 0x1::ascii::string(b""),
        };
    ...
    public fun get_options(arg0: &OptionsStorage) : (address, u64, u64, u64, 0x1::string::String, u64, bool, bool, bool, 0x1::ascii::String, 0x1::ascii::String) {
        (arg0.escrow_address, arg0.escrow_fee, arg0.max_amount, arg0.stage_price, arg0.stage_name, arg0.stage_quantity_per_wallet, arg0.mint_enabled, arg0.voting_enabled, arg0.only_airdrop_mint, arg0.test_one, arg0.test_two)
    }
    ...
    public fun mint_nft<T0: drop>(arg0: &mut NFTStorage, arg1: &OptionsStorage, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1::ascii::string(b"2665dc784c7ff17fddba2442b36cb8b2bbc8adfa9fe08794fd941d80ef2758ec::zen::ZEN");
        assert!(0x1::ascii::as_bytes(&v1) == 0x1::ascii::as_bytes(&v2), 4);
        ...
        if (0x2::table::contains<address, u64>(&arg0.owners, v0)) {
            let v3 = 0x2::table::borrow_mut<address, u64>(&mut arg0.owners, v0);
            assert!(*v3 + 1 <= arg1.stage_quantity_per_wallet, 3);
            *v3 = *v3 + 1;
        } else {
            0x2::table::add<address, u64>(&mut arg0.owners, v0, 1);
        };
        let v4 = 0x2::linked_table::length<0x2::object::ID, 0x2::object::ID>(&arg0.nfts) + 1;
        assert!(v4 <= arg1.max_amount, 3);
        let v5 = NFTTreasury<T0>{
        ...
        v5.nft_object_id = v8;
        0x2::linked_table::push_back<0x2::object::ID, 0x2::object::ID>(&mut arg0.nfts, v8, v6);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, arg1.escrow_address);
        0x2::transfer::public_transfer<NFT>(v7, v0);
        0x2::transfer::public_share_object<NFTTreasury<T0>>(v5);
        let v9 = NFTMinted{
            nft_object_id : v8,
            nft_id        : v4,
            creator       : v0,
    ...
    public fun mint_test<T0: drop>(arg0: &mut OptionsStorage, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        arg0.test_one = v0;
        arg0.test_two = 0x1::ascii::string(b"2665dc784c7ff17fddba2442b36cb8b2bbc8adfa9fe08794fd941d80ef2758ec::zen::ZEN");
        arg0.stage_name = 0x1::string::utf8(0x1::ascii::into_bytes(v0));
