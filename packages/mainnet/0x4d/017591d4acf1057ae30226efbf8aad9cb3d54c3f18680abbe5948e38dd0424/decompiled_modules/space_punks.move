module 0x4d017591d4acf1057ae30226efbf8aad9cb3d54c3f18680abbe5948e38dd0424::space_punks {
    struct SPACE_PUNKS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SPACE_PUNKS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SPACE_PUNKS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Space Punks"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Collection of 3D animated Space Punks on Sui that are out of this world."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidneabz4a5i3vtcxorlurxgzu753cfxaqumxlhjsnrs4oguwjqhsi"));
