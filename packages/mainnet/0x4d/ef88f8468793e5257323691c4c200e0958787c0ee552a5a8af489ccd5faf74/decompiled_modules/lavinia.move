module 0x4def88f8468793e5257323691c4c200e0958787c0ee552a5a8af489ccd5faf74::lavinia {
    ...
    fun init(arg0: LAVINIA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<LAVINIA>(arg0, 9, b"LAV", b"Lavinia", b"Official Lavinia Token", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe")), arg1);
