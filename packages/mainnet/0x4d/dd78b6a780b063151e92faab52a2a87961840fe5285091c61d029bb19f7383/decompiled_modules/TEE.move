module 0x4ddd78b6a780b063151e92faab52a2a87961840fe5285091c61d029bb19f7383::TEE {
    struct TEE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TEE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<TEE>(arg0, 2, b"TEE", b"TEE", b"TEE", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/rB9ps8PXNditR-48L10h8dMlmXoJPw3iJtNT25BGMWo?ext=png")), arg1);
