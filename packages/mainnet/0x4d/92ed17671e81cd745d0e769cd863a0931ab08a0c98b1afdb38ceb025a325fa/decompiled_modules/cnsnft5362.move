module 0x4d92ed17671e81cd745d0e769cd863a0931ab08a0c98b1afdb38ceb025a325fa::cnsnft5362 {
    struct CNSNFT5362 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5362, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5362>(arg0, arg1);
