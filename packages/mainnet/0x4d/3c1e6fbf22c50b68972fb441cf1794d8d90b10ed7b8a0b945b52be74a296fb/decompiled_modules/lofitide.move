module 0x4d3c1e6fbf22c50b68972fb441cf1794d8d90b10ed7b8a0b945b52be74a296fb::lofitide {
    struct LOFITIDE has drop {
        dummy_field: bool,
    }

    fun init(arg0: LOFITIDE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gyezvyk0nlwtunwb.public.blob.vercel-storage.com/tokens/1000058848-LNJFbiAis4d91tqILObTOQUykQBiXi.png";
        let v1 = if (0x1::vector::length<u8>(&v0) < 2) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gyezvyk0nlwtunwb.public.blob.vercel-storage.com/tokens/1000058848-LNJFbiAis4d91tqILObTOQUykQBiXi.png"))
        };
