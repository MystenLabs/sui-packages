module 0x4dd3cce35dfde91edf822763dff5dd4b6123963c7cd52fda6ef1c889157d47e0::america {
    ...
    fun init(arg0: AMERICA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<AMERICA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"America ")))), trim_right(b"America                         "), trim_right(b"America PAC Founded by @ElonMusk to support candidates who champion Secure Borders, Sensible Spending, Safe Cities, Fair Justice System, Free Speech and Self-Protection                                                                                                                                                        "), v2, arg1);
