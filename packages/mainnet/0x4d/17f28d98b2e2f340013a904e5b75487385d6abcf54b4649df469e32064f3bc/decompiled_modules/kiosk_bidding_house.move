module 0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::kiosk_bidding_house {
    ...
    public fun accept_bid<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v18 = v16;
        0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::add_fee(arg1, 0x2::balance::split<0x2::sui::SUI>(&mut v18, 0x2::balance::value<0x2::sui::SUI>(&v18) * (v9 as u64) / 10000));
    ...
    public entry fun accept_bid_entry<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun buy_nft<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun buy_nft_to_new_kiosk<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public fun buy_nft_with_request<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, NftListing<T0>>(&arg0.id, arg2), 25);
        let NftListing {
            id             : v0,
            seller         : v1,
        ...
        assert!(v13 >= v5, 31);
        0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg5, v13 * (v9 as u64) / 10000, arg6)));
    ...
    public entry fun create_and_share_kiosk_bidding_house_store(arg0: &0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Kiosk_Bidding_Store>(create_kiosk_bidding_house(arg0, arg1));
    }

    public fun create_kiosk_bidding_house(arg0: &0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Kiosk_Bidding_Store {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::is_admin(arg0, v0), 33);
        let v1 = 0x2::object::new(arg1);
        let v2 = Kiosk_Bidding_Store{
            id            : v1,
            auction_house : 0x2::object::id<0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::AuctionHouse>(arg0),
    ...
    public entry fun emergency_reset_accepted_bid<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 33);
    ...
    public entry fun emergency_reset_listing<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x4d17f28d98b2e2f340013a904e5b75487385d6abcf54b4649df469e32064f3bc::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 33);
    ...
    public fun place_bid<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, NftListing<T0>>(&mut arg0.id, arg1);
        if (0x1::option::is_some<address>(&v6.highest_bidder)) {
            v5 = 0x1::option::some<address>(*0x1::option::borrow<address>(&v6.highest_bidder));
            0x1::option::extract<address>(&mut v6.highest_bidder);
        };
        v6.highest_bid = v0;
        v6.highest_bidder = 0x1::option::some<address>(v1);
        if (0x1::option::is_some<address>(&v5)) {
            let v7 = 0x1::option::extract<address>(&mut v5);
            if (0x2::dynamic_object_field::exists_with_type<address, Bid>(&arg0.id, v7)) {
                let Bid {
                    id        : v8,
                    bidder    : _,
                    amount    : v10,
                    timestamp : _,
                } = 0x2::dynamic_object_field::remove<address, Bid>(&mut arg0.id, v7);
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v10, arg3), v7);
        ...
        0x2::dynamic_object_field::add<address, Bid>(&mut arg0.id, v1, v12);
        let v13 = BidPlaced{
            listing_id : arg1,
            bidder     : v1,
            amount     : v0,
