module 0x4d6385ad94a382a04b1d9cb3ff83c9728c2c43546853bc2b914be90bafb7bb91::suiheroes {
    ...
    fun init(arg0: SUIHEROES, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<SUIHEROES>>(0x2::coin::mint<SUIHEROES>(&mut v2, 100000000000000000, arg1), 0x2::tx_context::sender(arg1));
