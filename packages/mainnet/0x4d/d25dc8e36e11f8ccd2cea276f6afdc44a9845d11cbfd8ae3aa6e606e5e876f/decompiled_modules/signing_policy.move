module 0x4dd25dc8e36e11f8ccd2cea276f6afdc44a9845d11cbfd8ae3aa6e606e5e876f::signing_policy {
    ...
    public fun add_main_rule<T0: drop, T1: drop + store>(arg0: T0, arg1: &mut SigningPolicy, arg2: &SigningPolicyCap, arg3: T1) {
        ...
        0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg1.main_rules, 0x1::type_name::get<T0>());
    }
    ...
    public fun add_stackable_rule<T0: drop, T1: drop + store>(arg0: T0, arg1: &mut SigningPolicy, arg2: &SigningPolicyCap, arg3: T1) {
        ...
        let v0 = RuleKey<T0>{dummy_field: false};
        0x2::dynamic_field::add<RuleKey<T0>, T1>(&mut arg1.id, v0, arg3);
        0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg1.stackable_rules, 0x1::type_name::get<T0>());
    }
    ...
    public fun confirm_request(arg0: &SigningPolicy, arg1: SigningRequest) : (vector<u8>, vector<u8>, u64, 0x2::object::ID) {
        ...
        assert!(v7 == 0x2::vec_set::size<0x1::type_name::TypeName>(&arg0.stackable_rules), 0);
        (v0, v1, v2, v3)
    }
    ...
    public fun has_pending_removal<T0: drop>(arg0: &SigningPolicy, arg1: T0) : bool {
        0x2::table::contains<0x1::type_name::TypeName, u64>(&arg0.pending_removals, 0x1::type_name::get<T0>())
    }
    ...
    public fun pending_removal_unlock_time<T0: drop>(arg0: &SigningPolicy, arg1: T0) : u64 {
        assert!(0x2::table::contains<0x1::type_name::TypeName, u64>(&arg0.pending_removals, 0x1::type_name::get<T0>()), 5);
        *0x2::table::borrow<0x1::type_name::TypeName, u64>(&arg0.pending_removals, 0x1::type_name::get<T0>())
    }
    ...
    public(friend) fun verify_request<T0>(arg0: &SigningRequest, arg1: &SigningPolicy, arg2: &T0, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::vec_set::size<0x1::type_name::TypeName>(&arg0.receipts);
        let v1 = 0x2::vec_set::size<0x1::type_name::TypeName>(&arg1.main_rules);
        let v2 = 0x2::vec_set::size<0x1::type_name::TypeName>(&arg1.stackable_rules);
        let v3 = if (v1 > 0) {
            1 + v2
        } else {
            v2
