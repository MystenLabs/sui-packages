module 0x4d1d690409ba95700e8397acb10a2485a56ab2168bd7f49e631ac5a5a194fcb3::staked_lp {
    ...
    public fun into_token<T0>(arg0: StakedLP<T0>, arg1: &0x2::clock::Clock, arg2: &0x2::token::TokenPolicy<T0>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::token::Token<T0> {
        ...
        0x2::object::delete(v0);
        0x4d1d690409ba95700e8397acb10a2485a56ab2168bd7f49e631ac5a5a194fcb3::token_ir::from_balance<T0>(arg2, v1, arg3)
    }
