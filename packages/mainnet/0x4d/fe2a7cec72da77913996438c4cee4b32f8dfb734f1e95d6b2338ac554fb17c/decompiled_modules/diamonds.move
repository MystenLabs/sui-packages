module 0x4dfe2a7cec72da77913996438c4cee4b32f8dfb734f1e95d6b2338ac554fb17c::diamonds {
    ...
    fun init(arg0: DIAMONDS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DIAMONDS>(arg0, 0, b"DIAMONDS", b"Diamonds Beta", b"Diamonds Beta", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://assets.unkjd.games/metadata/diamond_season_1.png")), arg1);
        let v2 = Store{
