module 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share {
    ...
    public(friend) fun create_burn_request<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: 0x2::object::ID) : BurnRequest<T0> {
    ...
    public(friend) fun create_mint_request<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: 0x2::object::ID, arg2: bool, arg3: address, arg4: 0x1::string::String, arg5: u64, arg6: address, arg7: address) : MintRequest<T0> {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        MintRequest<T0>{
            fund_id         : arg1,
            is_init         : arg2,
    ...
    public fun mint<T0>(arg0: &mut 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: MintRequest<T0>, arg2: &mut 0x2::tx_context::TxContext) : FundShare {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        let MintRequest {
            fund_id         : v0,
            is_init         : v1,
