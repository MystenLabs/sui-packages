module 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund {
    ...
    public fun add_allow_list<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: &FundCap, arg3: address) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
    ...
    fun assert_id_pool_is_empty<T0>(arg0: &0x1::option::Option<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::SponsorPool<T0>>) {
        assert!(0x1::option::is_some<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::SponsorPool<T0>>(arg0), 32);
    }
    ...
    fun assert_if_contain_voucher_share(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare) {
        assert!(0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::base_receiver(arg0) == 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::reward_receiver(arg0), 30);
    }

    fun assert_if_deinvest_init_share(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare) {
        assert!(!0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::is_init(arg0), 21);
    }

    fun assert_if_empty_voucher<T0>(arg0: &vector<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::VoucherConsumeRequest<T0>>) {
        assert!(0x1::vector::length<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::VoucherConsumeRequest<T0>>(arg0) != 0, 27);
    }
    ...
    fun assert_if_fund_owner_and_voucher_sponsor_not_matched<T0>(arg0: &Fund<T0>, arg1: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::VoucherConsumeRequest<T0>) {
        let v0 = 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::request_sponsor_addr<T0>(arg1);
        assert!(arg0.trader == *0x1::option::borrow<address>(&v0), 31);
    }

    fun assert_if_fund_type_not_matched<T0>(arg0: &Fund<T0>, arg1: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare) {
        assert!(*0x2::object::uid_as_inner(&arg0.id) == 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::fund_id(arg1), 22);
    }
    ...
    fun assert_if_init_value_not_enough<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: u64, arg2: &0x2::coin::Coin<T0>) {
        assert!(0x2::coin::value<T0>(arg2) >= arg1 * 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::trader_init_percentage(arg0) / 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::base_percentage(arg0), 14);
    }
    ...
    fun assert_if_over_max_trader_fee(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: u64) {
        assert!(0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::max_trader_fee(arg0) >= arg1, 0);
    }

    fun assert_if_provider_not_matched<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::VoucherConsumeRequest<T0>, arg1: 0x2::object::ID) {
        let v0 = 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::base_provider<T0>(arg0);
    ...
    fun assert_if_shares_empty(arg0: &vector<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare>) {
        assert!(0x1::vector::length<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare>(arg0) != 0, 20);
    }
    ...
    public fun claim<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: 0x1::option::Option<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::SponsorPool<T0>>, arg2: &mut Fund<T0>, arg3: vector<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        assert_if_not_settle<T0>(arg2);
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        let v1 = 0;
        let v2 = 0;
        while (0x1::vector::length<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare>(&arg3) != 0) {
            let v3 = 0x1::vector::pop_back<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare>(&mut arg3);
            0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::id(&v3));
            assert_if_fund_type_not_matched<T0>(arg2, &v3);
            if (0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::base_receiver(&v3) != 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::reward_receiver(&v3)) {
                assert_id_pool_is_empty<T0>(&arg1);
                v1 = v1 + 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::invest_amount(&v3);
            } else {
                v2 = v2 + 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::invest_amount(&v3);
            };
            0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::burn<T0>(0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::create_burn_request<T0>(arg0, *0x2::object::uid_as_inner(&arg2.id)), v3);
        };
        0x1::vector::destroy_empty<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare>(arg3);
        if (arg2.after_amount < arg2.base) {
            ...
            if (v1 != 0) {
                0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::put_back<T0>(0x1::option::borrow_mut<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::SponsorPool<T0>>(&mut arg1), 0x2::balance::split<T0>(v5, arg2.after_amount * v1 / arg2.share_amount));
            };
            ...
            if (v1 == 0) {
                let v10 = (arg2.after_amount - 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::math::ceil(v9, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::platform_fee_percentage(arg0), 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::base_percentage(arg0)) - 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::math::ceil(v9, arg2.trader_fee, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::base_percentage(arg0)) - 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::math::ceil(v9, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::settle_percentage(arg0), 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::base_percentage(arg0))) * v2 / arg2.share_amount;
                let v11 = Claimed<T0>{
                    receiver : 0x2::tx_context::sender(arg4),
                    fund     : *0x2::object::uid_as_inner(&arg2.id),
                    shares   : v0,
                ...
                let v12 = arg2.after_amount - 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::math::ceil(v9, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::platform_fee_percentage(arg0), 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::base_percentage(arg0)) - 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::math::ceil(v9, arg2.trader_fee, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::base_percentage(arg0)) - 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::math::ceil(v9, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::settle_percentage(arg0), 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::base_percentage(arg0));
                let v13 = 0;
                let v14 = v13;
                if (v12 <= arg2.base) {
                    0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::put_back<T0>(0x1::option::borrow_mut<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::SponsorPool<T0>>(&mut arg1), 0x2::balance::split<T0>(v8, v12 * v1 / arg2.share_amount));
                } else {
                    0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::put_back<T0>(0x1::option::borrow_mut<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::SponsorPool<T0>>(&mut arg1), 0x2::balance::split<T0>(v8, v1));
    ...
    public fun create<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: 0x2::coin::Coin<T0>, arg12: &mut 0x2::tx_context::TxContext) : (Fund<T0>, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::MintRequest<T0>) {
        ...
        (v6, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::create_mint_request<T0>(arg0, *0x2::object::uid_as_inner(&v6.id), true, v6.trader, v8, v0, 0x2::tx_context::sender(arg12), 0x2::tx_context::sender(arg12)))
    }

    public fun create_settle_request<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: bool, arg3: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare, arg4: &0x2::tx_context::TxContext) : SettleRequest {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        SettleRequest{
    ...
    public fun deinvest<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: vector<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        ...
        let v0 = 0x1::vector::pop_back<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare>(&mut arg2);
        assert_if_contain_voucher_share(&v0);
        arg1.share_amount = arg1.share_amount - arg3;
        while (0x1::vector::length<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare>(&arg2) != 0) {
            let v1 = 0x1::vector::pop_back<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare>(&mut arg2);
            assert_if_deinvest_init_share(&v1);
            assert_if_contain_voucher_share(&v1);
            0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::join(&mut v0, v1);
        };
        let v2 = 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::split(&mut v0, arg3, arg5);
        if (0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::invest_amount(&v0) == 0) {
            0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::burn<T0>(0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::create_burn_request<T0>(arg0, *0x2::object::uid_as_inner(&arg1.id)), v0);
            let v3 = Deinvested{
            ...
            let v4 = Deinvested{
                remain_share           : 0x1::option::some<0x2::object::ID>(0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::id(&v0)),
                fund_id                : *0x2::object::uid_as_inner(&arg1.id),
                investor               : 0x2::tx_context::sender(arg5),
                withdraw_invest_amount : arg3,
            };
            0x2::event::emit<Deinvested>(v4);
            0x2::transfer::public_transfer<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare>(v0, 0x2::tx_context::sender(arg5));
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.asset.assets, 0x1::type_name::get<0x2::balance::Balance<T0>>()), 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::invest_amount(&v2)), arg5), 0x2::tx_context::sender(arg5));
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::burn<T0>(0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::create_burn_request<T0>(arg0, *0x2::object::uid_as_inner(&arg1.id)), v2);
        0x1::vector::destroy_empty<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::FundShare>(arg2);
    }
    ...
    public fun finish_settle_request(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut SettleRequest) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun invest_with_asset<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::MintRequest<T0> {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        ...
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::create_mint_request<T0>(arg0, *0x2::object::uid_as_inner(&arg1.id), false, arg1.trader, v0, 0x2::coin::value<T0>(&arg2), 0x2::tx_context::sender(arg4), 0x2::tx_context::sender(arg4))
    }

    public fun invest_with_voucher<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: vector<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::VoucherConsumeRequest<T0>>, arg2: &mut Fund<T0>, arg3: 0x2::balance::Balance<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::MintRequest<T0> {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        assert_if_empty_voucher<T0>(&arg1);
        let v0 = 0;
        let v1 = 0;
        let v2 = 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::base_provider<T0>(0x1::vector::borrow<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::VoucherConsumeRequest<T0>>(&arg1, 0));
        let v3 = 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::request_sponsor_addr<T0>(0x1::vector::borrow<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::VoucherConsumeRequest<T0>>(&arg1, 0));
        while (0x1::vector::length<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::VoucherConsumeRequest<T0>>(&arg1) != 0) {
            let v4 = 0x1::vector::pop_back<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::VoucherConsumeRequest<T0>>(&mut arg1);
            ...
            v0 = v0 + 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::request_amount<T0>(&v4);
            0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::burn_request<T0>(v4);
            v1 = v1 + 1;
        };
        0x1::vector::destroy_empty<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::VoucherConsumeRequest<T0>>(arg1);
        ...
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::fund_share::create_mint_request<T0>(arg0, *0x2::object::uid_as_inner(&arg2.id), false, arg2.trader, v5, 0x2::balance::value<T0>(&arg3), 0x2::object::id_to_address(&v2), 0x2::tx_context::sender(arg5))
    }
    ...
    public fun put_1_liquidity_for_1_liquidity_by_all<T0, T1, T2>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: Take_1_Liquidity_For_1_Liquidity_Request<T0, T1>, arg3: 0x2::balance::Balance<T1>) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun put_1_liquidity_for_1_nonliquidity_by_all<T0, T1: store, T2>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: Take_1_Liquidity_For_1_NonLiquidity_Request<T0, T1>, arg3: T1) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun put_1_liquidity_for_2_liquidity_by_all<T0, T1, T2, T3>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: Take_1_Liquidity_For_2_Liquidity_Request<T0, T1, T2>, arg3: 0x2::balance::Balance<T1>, arg4: 0x2::balance::Balance<T2>) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun put_1_nonliquidity_for_2_liquidity_by_all<T0: store, T1, T2, T3>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: Take_1_NonLiquidity_For_2_Liquidity_Request<T0, T1, T2>, arg3: 0x2::balance::Balance<T1>, arg4: 0x2::balance::Balance<T2>) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun settle<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: SettleRequest, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        ...
        if (v5 > v6) {
            let v8 = v5 - v6;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v4, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::math::ceil(v8, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::platform_fee_percentage(arg0), 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::base_percentage(arg0))), arg3), 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::platform(arg0));
            if (v5 >= v6 * (0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::base_percentage(arg0) + arg1.expected_roi) / 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::base_percentage(arg0)) {
                let v9 = SettleResult{
                    fund           : *0x2::object::uid_as_inner(&arg1.id),
            ...
            0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v4, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::math::ceil(v8, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::settle_percentage(arg0), 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::base_percentage(arg0))), arg3)
        } else {
    ...
    public fun take_1_liquidity_for_1_liquidity_by_trader<T0, T1, T2>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &FundCap, arg2: &mut Fund<T2>, arg3: u64, arg4: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_Liquidity_Request<T0, T1>) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        assert_if_fund_cap_and_fund_not_matched<T2>(arg2, arg1);
        take_1_liquidity_for_1_liquidity<T0, T1, T2>(arg2, arg3, arg4)
    }

    public fun take_1_liquidity_for_1_liquidity_over_end_time<T0, T1, T2>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: u64, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_Liquidity_Request<T0, T1>) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun take_1_liquidity_for_1_nonliquidity_by_trader<T0, T1: store, T2>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &FundCap, arg2: &mut Fund<T2>, arg3: u64, arg4: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_NonLiquidity_Request<T0, T1>) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        assert_if_fund_cap_and_fund_not_matched<T2>(arg2, arg1);
        take_1_liquidity_for_1_nonliquidity<T0, T1, T2>(arg2, arg3, arg4)
    }

    public fun take_1_liquidity_for_1_nonliquidity_over_end_time<T0, T1: store, T2>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: u64, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_NonLiquidity_Request<T0, T1>) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        assert_if_in_end_time<T2>(arg1, arg3);
    ...
    public fun take_1_liquidity_for_2_liquidity_by_trader<T0, T1, T2, T3>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &FundCap, arg2: &mut Fund<T3>, arg3: u64, arg4: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        assert_if_fund_cap_and_fund_not_matched<T3>(arg2, arg1);
        take_1_liquidity_for_2_liquidity<T0, T1, T2, T3>(arg2, arg3, arg4)
    }

    public fun take_1_liquidity_for_2_liquidity_over_end_time<T0, T1, T2, T3>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: u64, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun take_1_nonliquidity_for_2_liquidity_by_trader<T0: store, T1, T2, T3>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &FundCap, arg2: &mut Fund<T3>, arg3: &0x2::clock::Clock) : (T0, Take_1_NonLiquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        assert_if_fund_cap_and_fund_not_matched<T3>(arg2, arg1);
        take_1_nonliquidity_for_2_liquidity<T0, T1, T2, T3>(arg2, arg3)
    }

    public fun take_1_nonliquidity_for_2_liquidity_over_end_time<T0: store, T1, T2, T3>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: &0x2::clock::Clock) : (T0, Take_1_NonLiquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun trader_claim<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::GlobalConfig, arg1: &FundCap, arg2: &mut Fund<T0>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::assert_if_version_not_matched(arg0, 1);
        assert_if_not_settle<T0>(arg2);
        assert_if_fund_cap_and_fund_not_matched<T0>(arg2, arg1);
        assert_if_trader_fee_already_claimed<T0>(arg2);
        if (arg2.after_amount > arg2.base) {
            let v1 = 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::math::ceil(arg2.after_amount - arg2.base, arg2.trader_fee, 0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::base_percentage(arg0));
            ...
            0x2::dynamic_field::add<0x1::type_name::TypeName, TraderClaimedProof>(&mut arg2.id, 0x1::type_name::get<TraderClaimedProof>(), v5);
            0x2::coin::from_balance<T0>(0x2::balance::zero<T0>(), arg3)
        }
    }
    ...
    fun transfer_pool_if_is_some<T0>(arg0: 0x1::option::Option<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::SponsorPool<T0>>) {
        if (0x1::option::is_some<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::SponsorPool<T0>>(&arg0)) {
            0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::to_share_object<T0>(0x1::option::destroy_some<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::SponsorPool<T0>>(arg0));
        } else {
            0x1::option::destroy_none<0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::voucher::SponsorPool<T0>>(arg0);
        };
    }
    ...
    public entry fun withdraw<T0>(arg0: &0x4d62a9eb0e4d55aa663c254206554bd89c2ef29d130a9fa7b1e8d02b821763a2::config::AdminCap, arg1: &mut Fund<T0>, arg2: &mut 0x2::tx_context::TxContext) {
