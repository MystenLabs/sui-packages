module 0x4d699d779fced6bbbe794480274ec275d8ad8f670d92fbd196487ae243bf21a7::cnsnft9656 {
    struct CNSNFT9656 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9656, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9656>(arg0, arg1);
