module 0x4dfd0b7bf375eebb3d794efa0fd17456b5216f01a0dc6d18cd7b63e5915248c1::reward5399 {
    struct REWARD5399 has drop {
        dummy_field: bool,
    }

    struct TICKET_5399 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5399(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5399>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5399>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5399, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5399>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5399>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5399>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5399>>(v5, 0x2::tx_context::sender(arg1));
    }
