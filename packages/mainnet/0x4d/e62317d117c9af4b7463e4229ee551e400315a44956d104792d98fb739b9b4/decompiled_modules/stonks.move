module 0x4de62317d117c9af4b7463e4229ee551e400315a44956d104792d98fb739b9b4::stonks {
    ...
    fun init(arg0: STONKS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<STONKS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"STONKS    ")))), trim_right(b"STONKS9800                      "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
