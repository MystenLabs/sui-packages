module 0x4d1aa3a8ca93270758025de2642cfc436383b7644daf81ce90926a117a56076a::cnsnft1848 {
    struct CNSNFT1848 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1848, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1848>(arg0, arg1);
