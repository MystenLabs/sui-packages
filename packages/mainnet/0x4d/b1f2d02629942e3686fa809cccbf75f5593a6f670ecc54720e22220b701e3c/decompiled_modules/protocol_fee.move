module 0x4db1f2d02629942e3686fa809cccbf75f5593a6f670ecc54720e22220b701e3c::protocol_fee {
    ...
    fun assert_interacting_with_most_up_to_date_package(arg0: &ProtocolFeeConfig) {
        0x4db1f2d02629942e3686fa809cccbf75f5593a6f670ecc54720e22220b701e3c::version::assert_interacting_with_most_up_to_date_package(arg0.version);
    }
    ...
    public(friend) fun create_config<T0: drop>(arg0: &T0, arg1: &mut 0x2::tx_context::TxContext) : (ProtocolFeeConfig, ChangeFeeCap) {
        ...
        let v0 = ProtocolFeeConfig{
            ...
            version                            : 0x4db1f2d02629942e3686fa809cccbf75f5593a6f670ecc54720e22220b701e3c::version::current_version(),
    ...
    public fun distribute_protocol_fees<T0>(arg0: &ProtocolFeeConfig, arg1: &0x4db1f2d02629942e3686fa809cccbf75f5593a6f670ecc54720e22220b701e3c::treasury::Treasury, arg2: &mut 0x2::coin::Coin<T0>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (arg3) {
            let v2 = take_percent_base_18(v0, arg0.treasury_fee_percent_base_18);
            v2 - take_percent_base_18(v2, arg0.referee_discount)
        } else {
            take_percent_base_18(v0, arg0.treasury_fee_percent_base_18)
        };
        if (v1 > 0) {
            0x4db1f2d02629942e3686fa809cccbf75f5593a6f670ecc54720e22220b701e3c::treasury::deposit<T0>(arg1, 0x2::coin::split<T0>(arg2, v1, arg4));
        };
        let v3 = take_percent_base_18(v0, arg0.dev_wallet_fee_percent_base_18);
        if (v3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg2, v3, arg4), arg0.dev_wallet);
        };
    }
    ...
    public fun update_dev_wallet_address(arg0: &0x4db1f2d02629942e3686fa809cccbf75f5593a6f670ecc54720e22220b701e3c::admin::AdminCap, arg1: &mut ProtocolFeeConfig, arg2: address) {
        assert_interacting_with_most_up_to_date_package(arg1);
