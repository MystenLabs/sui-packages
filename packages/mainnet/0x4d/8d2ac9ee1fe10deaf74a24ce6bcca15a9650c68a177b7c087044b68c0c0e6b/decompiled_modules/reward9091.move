module 0x4d8d2ac9ee1fe10deaf74a24ce6bcca15a9650c68a177b7c087044b68c0c0e6b::reward9091 {
    struct REWARD9091 has drop {
        dummy_field: bool,
    }

    struct TICKET_9091 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9091(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9091>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9091>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9091, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9091>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9091>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9091>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9091>>(v5, 0x2::tx_context::sender(arg1));
    }
