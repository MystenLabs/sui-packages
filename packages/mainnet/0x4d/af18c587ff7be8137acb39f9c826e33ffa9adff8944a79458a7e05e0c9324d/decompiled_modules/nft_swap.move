module 0x4daf18c587ff7be8137acb39f9c826e33ffa9adff8944a79458a7e05e0c9324d::nft_swap {
    ...
    public fun accept_trade_improved<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::transfer_policy::TransferPolicy<T0>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = 0x1::string::utf8(0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>())));
        ...
        let v16 = 0x2::vec_set::into_keys<TradeItem>(v0.creator_items);
        let v17 = 0;
        while (v17 < 0x1::vector::length<TradeItem>(&v16)) {
            ...
            0x1::vector::push_back<0x1::string::String>(&mut v13, v18.type_name);
            v17 = v17 + 1;
        };
        let v19 = 0x2::vec_set::into_keys<TradeItem>(v0.counterparty_items);
        let v20 = 0;
        while (v20 < 0x1::vector::length<TradeItem>(&v19)) {
            let v21 = *0x1::vector::borrow<TradeItem>(&v19, v20);
            0x1::vector::push_back<0x2::object::ID>(&mut v14, v21.item_id);
            0x1::vector::push_back<0x1::string::String>(&mut v15, v21.type_name);
            v20 = v20 + 1;
        };
        v0.active = false;
        ...
        let v22 = 0x2::tx_context::sender(arg7);
        let v23 = if (v9 > 0) {
            let v24 = v9 * arg0.fee_percentage / 10000;
            if (v24 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg5, v24, arg7), arg0.fee_address);
                v24
            } else {
                0
            }
        ...
        if (v9 > 0) {
            let v25 = v9 - v23;
            if (v25 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg5, v25, arg7), v8);
            };
        };
        let v26 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Trade>(&mut arg0.id, arg4);
        let v27 = if (v10 > 0) {
            0x2::dynamic_object_field::remove<vector<u8>, 0x2::coin::Coin<0x2::sui::SUI>>(&mut v26.id, b"sui_payment")
        } else {
            0x2::coin::zero<0x2::sui::SUI>(arg7)
        };
        let v28 = 0;
        while (v28 < 0x1::vector::length<0x2::object::ID>(&v14)) {
            let v29 = *0x1::vector::borrow<0x2::object::ID>(&v14, v28);
            if (*0x1::vector::borrow<0x1::string::String>(&v15, v28) == v11 && 0x2::kiosk::has_item(arg2, v29)) {
                if (0x2::kiosk::is_listed(arg2, v29)) {
                    0x2::kiosk::delist<T0>(arg2, arg3, v29);
                };
                let (v30, v31) = 0x2::kiosk::purchase_with_cap<T0>(arg2, 0x2::kiosk::list_with_purchase_cap<T0>(arg2, arg3, v29, 0, arg7), 0x2::coin::zero<0x2::sui::SUI>(arg7));
                0x2::kiosk::lock<T0>(&mut v7, &v6, arg6, v30);
        ...
        let v36 = 0;
        while (v36 < 0x1::vector::length<0x2::object::ID>(&v12)) {
            let v37 = *0x1::vector::borrow<0x2::object::ID>(&v12, v36);
            if (*0x1::vector::borrow<0x1::string::String>(&v13, v36) == v11 && 0x2::kiosk::has_item(arg1, v37)) {
                ...
                if (0x2::dynamic_object_field::exists_<vector<u8>>(&v35.id, v38)) {
                    ...
                    let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg6, v40);
                };
            };
            v36 = v36 + 1;
        };
        if (v10 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v27, v22);
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(v27);
        };
        arg0.active_trades = arg0.active_trades - 1;
        arg0.total_volume = arg0.total_volume + v9 + v10;
        let v44 = TradeAcceptedEvent{
            trade_id           : arg4,
            creator            : v8,
            counterparty       : v22,
            creator_items      : v12,
            creator_types      : v13,
            counterparty_items : v14,
            counterparty_types : v15,
            sui_requested      : v9,
            sui_offered        : v10,
            platform_fee       : v23,
        };
        0x2::event::emit<TradeAcceptedEvent>(v44);
        let Trade {
            id                 : v45,
            creator            : _,
            creator_items      : _,
