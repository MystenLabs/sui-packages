module 0x4d3a677761f4de052d573938ac160ef30eb8c82a526097bfd4fce30bf99c3aec::cnsnft4312 {
    struct CNSNFT4312 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4312, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4312>(arg0, arg1);
