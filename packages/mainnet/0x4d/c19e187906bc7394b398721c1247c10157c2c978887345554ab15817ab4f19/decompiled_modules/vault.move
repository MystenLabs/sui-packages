module 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::vault {
    ...
    struct Vault<phantom T0, phantom T1, phantom T2, T3: copy + drop + store> has key {
        ...
        decimals_a: u8,
        decimals_b: u8,
        config: 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Config<T3>,
    }
    ...
    struct VaultCreatedEvent<T0: copy + drop + store> has copy, drop {
        ...
        free_threshold_b: u64,
        fee_val: u64,
        config: 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Config<T0>,
    }
    ...
    public fun borrow_config<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>) : &0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Config<T3> {
        &arg0.config
    }

    public(friend) fun borrow_mut_config<T0, T1, T2, T3: copy + drop + store>(arg0: &mut Vault<T0, T1, T2, T3>) : &mut 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Config<T3> {
        &mut arg0.config
    }
    ...
    fun emit_event<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>, arg1: 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Config<T3>) {
    ...
    public fun is_deposit_enabled<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>) : bool {
        *0x2::dynamic_field::borrow<vector<u8>, bool>(&arg0.id, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::constants::deposit_enabled_df_key())
    }

    public fun issue_rebalance_cap(arg0: &VaultCap, arg1: address, arg2: &0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::version::assert_supported_version(arg2);
        let v0 = RebalanceCap{
    ...
    public fun new_drift_vault_vault<T0, T1, T2>(arg0: &0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::pool::Pool<T0, T1>, arg1: 0x2::coin::TreasuryCap<T2>, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u128, arg7: u64, arg8: u64, arg9: u64, arg10: u8, arg11: u64, arg12: u8, arg13: u8, arg14: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::total_supply<T2>(&arg1) == 0, 0);
        assert!(arg2 > arg3, 10);
        let v0 = 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::new_drift_config(arg10, arg11, arg4);
        let v1 = Vault<T0, T1, T2, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Drift>{
        ...
        0x2::dynamic_field::add<vector<u8>, bool>(&mut v1.id, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::constants::deposit_enabled_df_key(), true);
        let v2 = VaultCap{
            id             : 0x2::object::new(arg14),
            vault_id       : 0x2::object::id<Vault<T0, T1, T2, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Drift>>(&v1),
            is_initialised : false,
        };
        emit_event<T0, T1, T2, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Drift>(&v1, v0);
        0x2::transfer::share_object<Vault<T0, T1, T2, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Drift>>(v1);
    ...
    public fun new_stable_vault<T0, T1, T2>(arg0: &0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::pool::Pool<T0, T1>, arg1: 0x2::coin::TreasuryCap<T2>, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: u8, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::total_supply<T2>(&arg1) == 0, 0);
        assert!(arg2 > arg3, 10);
        let v0 = 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::new_stable_config();
        let v1 = Vault<T0, T1, T2, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Stable>{
        ...
        let v2 = VaultCap{
            id             : 0x2::object::new(arg11),
            vault_id       : 0x2::object::id<Vault<T0, T1, T2, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Stable>>(&v1),
            is_initialised : false,
        };
        emit_event<T0, T1, T2, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Stable>(&v1, v0);
        0x2::transfer::share_object<Vault<T0, T1, T2, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Stable>>(v1);
    ...
    public fun new_uncorrelated_vault<T0, T1, T2>(arg0: &0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::pool::Pool<T0, T1>, arg1: 0x2::coin::TreasuryCap<T2>, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u128, arg7: u128, arg8: u64, arg9: u64, arg10: u64, arg11: u8, arg12: u8, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg4 > arg5, 0);
        assert!(arg2 > arg3, 10);
        let v0 = 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::new_uncorrelated_config(0, 0, arg4, arg5);
        let v1 = Vault<T0, T1, T2, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Uncorrelated>{
        ...
        let v2 = VaultCap{
            id             : 0x2::object::new(arg13),
            vault_id       : 0x2::object::id<Vault<T0, T1, T2, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Uncorrelated>>(&v1),
            is_initialised : false,
        };
        emit_event<T0, T1, T2, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Uncorrelated>(&v1, v0);
        0x2::transfer::share_object<Vault<T0, T1, T2, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::config::Uncorrelated>>(v1);
    ...
    public fun set_deposit_enable<T0, T1, T2, T3: copy + drop + store>(arg0: &mut Vault<T0, T1, T2, T3>, arg1: &VaultCap, arg2: bool) {
        ...
        *0x2::dynamic_field::borrow_mut<vector<u8>, bool>(&mut arg0.id, 0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::constants::deposit_enabled_df_key()) = arg2;
    }
    ...
    public fun update_rebalance_cap_ownership(arg0: &VaultCap, arg1: &mut RebalanceCap, arg2: address, arg3: &0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::version::Version) {
        0x4dc19e187906bc7394b398721c1247c10157c2c978887345554ab15817ab4f19::version::assert_supported_version(arg3);
