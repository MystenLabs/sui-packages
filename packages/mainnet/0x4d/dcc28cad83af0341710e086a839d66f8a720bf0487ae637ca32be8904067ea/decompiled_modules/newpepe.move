module 0x4ddcc28cad83af0341710e086a839d66f8a720bf0487ae637ca32be8904067ea::newpepe {
    ...
    fun init(arg0: NEWPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<NEWPEPE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"newPepe   ")))), trim_right(b"newPepe                         "), trim_right(b"Type Ai is a personalized AI Crypto Companion.                                                                                                                                                                                                                                                                                  "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
