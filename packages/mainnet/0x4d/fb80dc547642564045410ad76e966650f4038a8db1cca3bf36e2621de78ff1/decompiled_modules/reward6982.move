module 0x4dfb80dc547642564045410ad76e966650f4038a8db1cca3bf36e2621de78ff1::reward6982 {
    struct REWARD6982 has drop {
        dummy_field: bool,
    }

    struct TICKET_6982 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6982(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6982>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6982>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6982, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6982>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6982>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6982>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6982>>(v5, 0x2::tx_context::sender(arg1));
    }
