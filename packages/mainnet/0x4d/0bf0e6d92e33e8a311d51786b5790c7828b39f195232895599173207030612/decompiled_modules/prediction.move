module 0x4d0bf0e6d92e33e8a311d51786b5790c7828b39f195232895599173207030612::prediction {
    ...
    public fun betDown(arg0: &mut Rounds, arg1: &mut Epoch, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun betUp(arg0: &mut Rounds, arg1: &mut Epoch, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::borrow_mut<Round>(&mut arg0.rounds, arg3);
        0x2::balance::join<0x2::sui::SUI>(&mut v0.totalAmount, 0x2::coin::into_balance<0x2::sui::SUI>(arg2));
