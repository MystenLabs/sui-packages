module 0x4d2cc9ca9969d5111e172dc001f0d3a69b67686841ed43de7c7556e421505d36::cnsnft5198 {
    struct CNSNFT5198 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5198, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://nsclaim1122img-0220.vercel.app/api/{id}"));
        let v4 = 0x2::package::claim<CNSNFT5198>(arg0, arg1);
