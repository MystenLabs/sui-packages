module 0x4d4eb807ac07cc12fb905d373fa8be0b3f8b20c54a56c94fb4762b3b859e2235::cnsnft9405 {
    struct CNSNFT9405 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9405, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9405>(arg0, arg1);
