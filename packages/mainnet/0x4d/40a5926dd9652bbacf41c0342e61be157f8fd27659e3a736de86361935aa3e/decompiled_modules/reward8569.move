module 0x4d40a5926dd9652bbacf41c0342e61be157f8fd27659e3a736de86361935aa3e::reward8569 {
    struct REWARD8569 has drop {
        dummy_field: bool,
    }

    struct TICKET_8569 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8569(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8569>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8569>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8569, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8569>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8569>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8569>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8569>>(v5, 0x2::tx_context::sender(arg1));
    }
