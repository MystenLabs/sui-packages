module 0x4dea343c9fe65d83b514a8520fdc619464be1debf598ad1e60f19b513cddb204::router {
    struct SwapContext {
    ...
    public fun confirm_swap<T0>(arg0: SwapContext, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(v12 >= v5, 0x4dea343c9fe65d83b514a8520fdc619464be1debf598ad1e60f19b513cddb204::errors::amount_out_slippage_check_failed());
        assert!(0x2::bag::is_empty(&v10), 0x4dea343c9fe65d83b514a8520fdc619464be1debf598ad1e60f19b513cddb204::errors::remains_balance());
    ...
    public fun new_swap_context<T0, T1>(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &0x4dea343c9fe65d83b514a8520fdc619464be1debf598ad1e60f19b513cddb204::fee::FeeConfig, arg5: &mut 0x2::tx_context::TxContext) : SwapContext {
        let v0 = 0x4dea343c9fe65d83b514a8520fdc619464be1debf598ad1e60f19b513cddb204::fee::fee_rate(arg4);
        let v1 = 0x4dea343c9fe65d83b514a8520fdc619464be1debf598ad1e60f19b513cddb204::fee::fee_recipient(arg4);
        let v2 = 0x2::coin::value<T0>(&arg3);
        assert!(v2 > 0, 0x4dea343c9fe65d83b514a8520fdc619464be1debf598ad1e60f19b513cddb204::errors::amount_in_is_zero());
        if (v0 > 0) {
            assert!(v1 != @0x0, 0x4dea343c9fe65d83b514a8520fdc619464be1debf598ad1e60f19b513cddb204::errors::invalid_fee_recipient());
        };
