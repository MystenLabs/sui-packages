module 0x4d6335913e204b02710e9f385d55ce18101620580b2aa499b0c13841fdd607c0::stablecoin_vault {
    ...
    public fun convert_ausd_to_stablecoin<T0>(arg0: &Vault<T0>, arg1: u64) : u64 {
        ...
        if (v0 == v1) {
            ...
            0x447ba101db6d145e40695c3c185ee44fd22ab44cbf98f32204032c24df95ea35::math_utils::safe_mul_u64(arg1, (0x447ba101db6d145e40695c3c185ee44fd22ab44cbf98f32204032c24df95ea35::math_utils::safe_pow(10, ((v0 - v1) as u128)) as u64))
        } else {
            arg1 / (0x447ba101db6d145e40695c3c185ee44fd22ab44cbf98f32204032c24df95ea35::math_utils::safe_pow(10, ((v1 - v0) as u128)) as u64)
        }
    }
    ...
    public fun convert_stablecoin_to_ausd<T0>(arg0: &Vault<T0>, arg1: u64) : u64 {
        ...
        if (v0 == v1) {
            ...
            arg1 / (0x447ba101db6d145e40695c3c185ee44fd22ab44cbf98f32204032c24df95ea35::math_utils::safe_pow(10, ((v0 - v1) as u128)) as u64)
        } else {
            0x447ba101db6d145e40695c3c185ee44fd22ab44cbf98f32204032c24df95ea35::math_utils::safe_mul_u64(arg1, (0x447ba101db6d145e40695c3c185ee44fd22ab44cbf98f32204032c24df95ea35::math_utils::safe_pow(10, ((v1 - v0) as u128)) as u64))
        }
    }

    public fun create_vault<T0>(arg0: &VaultRegistry, arg1: &0x4d6335913e204b02710e9f385d55ce18101620580b2aa499b0c13841fdd607c0::vault_governance::GovernanceRegistry, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun redeem<T0>(arg0: &mut Vault<T0>, arg1: &mut VaultRegistry, arg2: &0x4d6335913e204b02710e9f385d55ce18101620580b2aa499b0c13841fdd607c0::vault_governance::GovernanceRegistry, arg3: 0x2::coin::Coin<0xd5dcd0e791949074b70af25dd6b0c2e121adcfa8a062a779846bf1dd5e0f4b9a::ausd::AUSD>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        verify_vault_registry_association<T0>(arg0, arg1);
        verify_registry_governance_association(arg1, arg2);
    ...
    entry fun stake<T0>(arg0: &mut Vault<T0>, arg1: &mut VaultRegistry, arg2: &0x4d6335913e204b02710e9f385d55ce18101620580b2aa499b0c13841fdd607c0::vault_governance::GovernanceRegistry, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        verify_vault_registry_association<T0>(arg0, arg1);
        verify_registry_governance_association(arg1, arg2);
        assert!(!0x4d6335913e204b02710e9f385d55ce18101620580b2aa499b0c13841fdd607c0::vault_governance::is_governance_paused(arg2) && !arg0.is_paused, 2);
    ...
    fun verify_registry_governance_association(arg0: &VaultRegistry, arg1: &0x4d6335913e204b02710e9f385d55ce18101620580b2aa499b0c13841fdd607c0::vault_governance::GovernanceRegistry) {
        assert!(arg0.governance_registry_id == 0x2::object::id<0x4d6335913e204b02710e9f385d55ce18101620580b2aa499b0c13841fdd607c0::vault_governance::GovernanceRegistry>(arg1), 7);
    }
