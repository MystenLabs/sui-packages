module 0x4dbe3b682c83ef304b90f0f021066be4443150430d9368fd8debc7febe87a53d::collectible {
    ...
    fun init(arg0: COLLECTIBLE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Token>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"FlowX Testnet Pass II"));
        0x2::display::add<Token>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"ipfs://bafybeig67vkmnnmgg563nocr32wctf3i64s7ycchsiw6sxktpcfc5mjgjq"));
    ...
    public entry fun mint(arg0: &mut State, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.total_supply < 3000, 0);
