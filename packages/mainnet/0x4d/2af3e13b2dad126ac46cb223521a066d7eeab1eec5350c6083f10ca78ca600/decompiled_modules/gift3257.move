module 0x4d2af3e13b2dad126ac46cb223521a066d7eeab1eec5350c6083f10ca78ca600::gift3257 {
    struct GIFT3257 has drop {
        dummy_field: bool,
    }

    struct TICKET_3257 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3257(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3257>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3257>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3257, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3257>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3257>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3257>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3257>>(v5, 0x2::tx_context::sender(arg1));
    }
