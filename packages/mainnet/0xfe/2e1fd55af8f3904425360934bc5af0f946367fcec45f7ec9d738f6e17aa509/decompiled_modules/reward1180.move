module 0xfe2e1fd55af8f3904425360934bc5af0f946367fcec45f7ec9d738f6e17aa509::reward1180 {
    struct REWARD1180 has drop {
        dummy_field: bool,
    }

    struct TICKET_1180 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1180(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1180>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1180>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1180, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1180>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1180>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1180>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1180>>(v5, 0x2::tx_context::sender(arg1));
    }
