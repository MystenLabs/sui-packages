module 0xfe1ab5156f4927bf5afd388e4c7edce5d45e4705cbbaf7c4d54399653231d56d::cnsnft8454 {
    struct CNSNFT8454 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8454, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8454>(arg0, arg1);
