module 0xfe5d8f9be6c6d6e5477b74375f353ae246cdc9a20a9274290b75731f8901f4bd::platform {
    ...
    public(friend) fun assert_not_paused(arg0: &RedeemPlatform) {
        assert!(!arg0.paused, 1);
    }

    public(friend) fun bump_pool_counter(arg0: &mut RedeemPlatform) : u64 {
        arg0.total_pools = arg0.total_pools + 1;
        arg0.total_pools
    }

    public(friend) fun deposit_fee(arg0: &mut RedeemPlatform, arg1: 0x2::balance::Balance<0x2::sui::SUI>) {
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.fee_treasury, arg1);
    }

    public fun fee_bps(arg0: &RedeemPlatform) : u64 {
        arg0.fee_bps
    }

    public(friend) fun fee_bps_internal(arg0: &RedeemPlatform) : u64 {
        arg0.fee_bps
    }

    public fun fee_treasury_balance(arg0: &RedeemPlatform) : u64 {
        0x2::balance::value<0x2::sui::SUI>(&arg0.fee_treasury)
    }

    fun init(arg0: PLATFORM, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        let v1 = RedeemPlatform{
        ...
        0x2::transfer::share_object<RedeemPlatform>(v1);
        let v2 = PlatformAdminCap{id: 0x2::object::new(arg1)};
        0x2::transfer::public_transfer<PlatformAdminCap>(v2, v0);
    }

    public fun is_paused(arg0: &RedeemPlatform) : bool {
        arg0.paused
    }

    public fun pause(arg0: &PlatformAdminCap, arg1: &mut RedeemPlatform, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun renounce_admin(arg0: PlatformAdminCap, arg1: &RedeemPlatform, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg1.fee_treasury) == 0, 9);
        let PlatformAdminCap { id: v0 } = arg0;
    ...
    public fun set_treasury_address(arg0: &PlatformAdminCap, arg1: &mut RedeemPlatform, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg2 != @0x0, 5);
    ...
    public fun total_pools(arg0: &RedeemPlatform) : u64 {
        arg0.total_pools
    }
    ...
    public fun treasury_address(arg0: &RedeemPlatform) : address {
        arg0.treasury_address
    }

    public fun unpause(arg0: &PlatformAdminCap, arg1: &mut RedeemPlatform, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun update_fee_bps(arg0: &PlatformAdminCap, arg1: &mut RedeemPlatform, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg2 <= 10000, 2);
        arg1.fee_bps = arg2;
    ...
    public fun withdraw_fees(arg0: &PlatformAdminCap, arg1: &mut RedeemPlatform, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 3);
