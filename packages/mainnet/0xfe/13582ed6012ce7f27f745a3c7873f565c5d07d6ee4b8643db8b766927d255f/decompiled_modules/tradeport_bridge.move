module 0x2235d7a739aae888ad6abb290924584a68dd7178a0ae0062237fba9be5666495::tradeport_bridge {
    ...
    public fun delete_bridge<T0: store + key, T1>(arg0: &mut Manager, arg1: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        ...
        let Bridge {
            ...
            registry     : v10,
            reservations : v11,
        } = 0x2::table::remove<0x1::ascii::String, Bridge>(&mut arg0.bridges, v1);
        let v12 = v9;
        0x2::object::delete(v4);
        assert!(v6 == v3, 3);
        assert!(v7 == 0, 6);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::bag::remove<0x1::ascii::String, 0x2::balance::Balance<T1>>(&mut v12, v3), arg1), 0x2::tx_context::sender(arg1));
        0x2::bag::destroy_empty(v12);
        0x2::table::drop<0x2::object::ID, u64>(v10);
        0x2::table::destroy_empty<0x2::object::ID, Reservation>(v11);
    }
