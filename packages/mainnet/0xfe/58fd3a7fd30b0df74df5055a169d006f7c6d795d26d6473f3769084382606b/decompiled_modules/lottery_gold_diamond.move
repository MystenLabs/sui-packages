module 0xfe58fd3a7fd30b0df74df5055a169d006f7c6d795d26d6473f3769084382606b::lottery_gold_diamond {
    ...
    public entry fun draw(arg0: &mut GoldToDiamondLottery, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun enter(arg0: &mut GoldToDiamondLottery, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<LotteryEntry>(&arg0.entries);
        assert!(v0 < 100, 0);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= 10000000000, 1);
        let v1 = 0x2::tx_context::sender(arg4);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.prize_pool, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, 10000000000, arg4)));
