module 0xfe1c02153bc62d510da305dbb11c424345765cae5dc966ef11eb3e153a35ff81::cnsnft8694 {
    struct CNSNFT8694 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8694, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8694>(arg0, arg1);
