module 0xfe045283d1fd07519b36713956105d8b30337db5d52f741b4f5181a86305b7b6::aqua {
    ...
    fun init(arg0: AQUA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AQUA>(arg0, 6, b"aqUSDC", b"AquaYield USDC", b"Yield-bearing USDC receipt token. Deposit USDC, receive aqUSDC.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/vxfbHwt.png")), arg1);
