module 0xfeb9eb2c6d31568c622c608cdc48285a6fa82fa224b16e72ab9e76dd9737a794::canvas {
    ...
    public entry fun paint(arg0: &mut CanvasNFT, arg1: vector<u64>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<u64>(&arg1)) {
            let v1 = *0x1::vector::borrow<u64>(&arg1, v0);
            if (v1 < 100) {
                *0x1::vector::borrow_mut<u8>(&mut arg0.pixels, v1) = 1;
            };
            v0 = v0 + 1;
        };
