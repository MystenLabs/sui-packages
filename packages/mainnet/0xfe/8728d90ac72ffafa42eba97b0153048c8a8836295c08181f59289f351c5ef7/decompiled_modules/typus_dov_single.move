module 0xa76499eda1d37751473de5f30e106f35943ada2f6ea764861243e7f5aa5bcc97::typus_dov_single {
    ...
    entry fun drop_ownership_loop<T0, T1, T2>(arg0: &ManagerCap, arg1: &mut Registry, arg2: &mut AdditionalConfigRegistry, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg1.id;
        let v1 = get_mut_portfolio_vault<T0, T1, T2>(v0, arg3);
        let v2 = AdditionalConfigKey{
            index : v1.info.index,
        ...
        let v3 = get_additional_config<0x2::vec_map::VecMap<address, u64>>(arg2, v2);
        0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::dutch::drop_ownership_loop<ManagerCap, T1>(arg0, 0x1::option::borrow_mut<0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::dutch::Auction<ManagerCap, T1>>(&mut v1.auction), 0x2::vec_map::keys<address, u64>(0x1::option::borrow<0x2::vec_map::VecMap<address, u64>>(&v3)), arg4);
    }
