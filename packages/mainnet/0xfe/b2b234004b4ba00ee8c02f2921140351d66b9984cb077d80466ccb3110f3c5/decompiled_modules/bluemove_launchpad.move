module 0x1c48e7be87bad6db011ea3023264ec26c52448e8260daced24b19ac2cb94d3a8::bluemove_launchpad {
    ...
    struct HOMINIDS has store, key {
        id: 0x2::object::UID,
        name: 0x1::string::String,
        description: 0x1::string::String,
        url: 0x1::string::String,
        image_url: 0x1::string::String,
        atributes: 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::attributes::Attributes,
    }
    ...
    public entry fun burn_nft(arg0: HOMINIDS, arg1: &mut 0x2::tx_context::TxContext) {
        let HOMINIDS {
            id          : v0,
            name        : v1,
            description : _,
        ...
        let v6 = BurnEvent{
            object_id : 0x2::object::id<HOMINIDS>(&arg0),
    ...
    public entry fun claim_nfts(arg0: &mut LaunchpadData, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v11 > 0) {
            ...
            assert!(v12 < arg0.total_nft + arg0.pre_mint, 1);
            let v13 = v12 + 1;
            ...
            0x1::string::append(&mut v15, 0x1::string::utf8(b".png"));
            ...
            let v17 = HOMINIDS{
                ...
                url         : v16,
                image_url   : v15,
                atributes   : 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::attributes::add_from_vec(0x2::table::remove<u64, vector<0x1::ascii::String>>(&mut arg0.keys, v13), 0x2::table::remove<u64, vector<0x1::ascii::String>>(&mut arg0.values, v13)),
            };
            let v18 = MintNFTEvent{
                object_id : 0x2::object::id<HOMINIDS>(&v17),
                creator   : v0,
                name      : v14,
            };
            0x2::event::emit<MintNFTEvent>(v18);
            0x2::transfer::public_transfer<HOMINIDS>(v17, v0);
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LaunchpadData{
            ...
            minted         : 0,
            current_nft    : 0,
            base_name      : 0x1::string::utf8(b"HOMINIDS #"),
            base_url       : 0x1::string::utf8(b"https://ipfs.io/ipfs/bafybeihmeriufyjm65eacjqjoiupc5tuq42io3v3vughz7gmjp7oy33zza/"),
            base_image_url : 0x1::string::utf8(b"https://ipfs.io/ipfs/bafybeieugwidekwly7rvscmhsifmnbdcmze3uyzco76kjhasdsrukauj3e/"),
            description    : 0x1::string::utf8(b"A culture shift and an extraordinary brand built by ordinary people. A community based metaverse platform, 3D graphic-based new future of social media.HOMINIDS Project consists of the creation of a collection of 9,999 unique NFTs and a 3D metaverse community platform to provide an immersive experience to users around the world. We anticipate several revenue streams, such as NFT sales, targeted advertising and brand partnerships. We are convinced of its potential for success and are ready to take on the challenges to make this project a reality."),
            ...
            fund_address   : @0xa3d1d4c9c328c0f37e94b61183b4b49f3b37f765822e567706211ffac391faff,
            balance        : 0x2::balance::zero<0x2::sui::SUI>(),
            total_nft      : v0,
            pre_mint       : 0,
        };
        let v2 = 0x2::tx_context::sender(arg1);
        let (v3, v4) = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::create_with_mint_cap<BLUEMOVE_LAUNCHPAD, HOMINIDS>(&arg0, 0x1::option::some<u64>(v0), arg1);
        let v5 = v3;
        let v6 = Witness{dummy_field: false};
        let v7 = 0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::from_witness<HOMINIDS, Witness>(v6);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::add_domain<HOMINIDS, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::creators::Creators>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::creators::new(0x2::vec_set::singleton<address>(v2)));
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::add_domain<HOMINIDS, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::display_info::DisplayInfo>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::display_info::new(0x1::string::utf8(b"HOMINIDS"), 0x1::string::utf8(b"A culture shift and an extraordinary brand built by ordinary people. A community based metaverse platform, 3D graphic-based new future of social media.HOMINIDS Project consists of the creation of a collection of 9,999 unique NFTs and a 3D metaverse community platform to provide an immersive experience to users around the world. We anticipate several revenue streams, such as NFT sales, targeted advertising and brand partnerships. We are convinced of its potential for success and are ready to take on the challenges to make this project a reality.")));
        ...
        let v11 = 0x2::display::new<HOMINIDS>(&v8, arg1);
        0x2::display::add<HOMINIDS>(&mut v11, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<HOMINIDS>(&mut v11, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<HOMINIDS>(&mut v11, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{image_url}"));
        0x2::display::add<HOMINIDS>(&mut v11, 0x1::string::utf8(b"tags"), 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::display::from_vec(v9));
        0x2::display::update_version<HOMINIDS>(&mut v11);
        0x2::transfer::public_transfer<0x2::display::Display<HOMINIDS>>(v11, 0x2::tx_context::sender(arg1));
        let (v12, v13) = 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::init_policy<HOMINIDS>(&v8, arg1);
        let v14 = v13;
        let v15 = v12;
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::enforce<HOMINIDS>(&mut v15, &v14);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::transfer_allowlist::enforce<HOMINIDS>(&mut v15, &v14);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::create_domain_and_add_strategy<HOMINIDS>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty::from_address(@0xa3d1d4c9c328c0f37e94b61183b4b49f3b37f765822e567706211ffac391faff, arg1), 500, arg1);
        0x2::transfer::public_transfer<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<HOMINIDS>>(v4, v2);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v8, v2);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<HOMINIDS>>(v14, v2);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<HOMINIDS>>(v15);
        0x2::transfer::public_share_object<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<HOMINIDS>>(v5);
    ...
    public entry fun pre_nfts(arg0: &mut LaunchpadData, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg1 > 0) {
            ...
            let v5 = HOMINIDS{
                ...
                url         : v4,
                image_url   : v3,
                atributes   : 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::attributes::add_from_vec(0x2::table::remove<u64, vector<0x1::ascii::String>>(&mut arg0.keys, v1), 0x2::table::remove<u64, vector<0x1::ascii::String>>(&mut arg0.values, v1)),
            };
            0x2::transfer::public_transfer<HOMINIDS>(v5, arg2);
            arg0.current_nft = v1;
            arg1 = arg1 - 1;
        };
    }

    public entry fun remove_all_keys(arg0: &mut LaunchpadData, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == @0x49cc391ab4d3503e03dbb24c4f9e28f3cdd2ddf8a459e0d43012c3868ffefa1, 5);
        while (0x2::table::length<u64, vector<0x1::ascii::String>>(&arg0.keys) != 0) {
            0x2::table::remove<u64, vector<0x1::ascii::String>>(&mut arg0.keys, 0x2::table::length<u64, vector<0x1::ascii::String>>(&arg0.keys) - 1);
        };
    }

    public entry fun remove_all_values(arg0: &mut LaunchpadData, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == @0x49cc391ab4d3503e03dbb24c4f9e28f3cdd2ddf8a459e0d43012c3868ffefa1, 5);
        while (0x2::table::length<u64, vector<0x1::ascii::String>>(&arg0.values) != 0) {
            0x2::table::remove<u64, vector<0x1::ascii::String>>(&mut arg0.values, 0x2::table::length<u64, vector<0x1::ascii::String>>(&arg0.values) - 1);
        };
    }
    ...
    public entry fun update_admin_2(arg0: &mut LaunchpadData, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x49cc391ab4d3503e03dbb24c4f9e28f3cdd2ddf8a459e0d43012c3868ffefa1, 5);
        arg0.admin_2 = arg1;
    }
