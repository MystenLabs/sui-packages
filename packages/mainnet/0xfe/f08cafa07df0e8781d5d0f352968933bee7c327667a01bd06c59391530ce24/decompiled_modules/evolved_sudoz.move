module 0xfef08cafa07df0e8781d5d0f352968933bee7c327667a01bd06c59391530ce24::evolved_sudoz {
    struct EvolvedSudoz has store, key {
        ...
        original_path: u8,
        trait_type: vector<0x1::string::String>,
    ...
    public fun get_trait_types(arg0: &EvolvedSudoz) : &vector<0x1::string::String> {
        &arg0.trait_type
    }

    public fun get_trait_values(arg0: &EvolvedSudoz) : &vector<0x1::string::String> {
        &arg0.value
    }
    ...
    fun init(arg0: EVOLVED_SUDOZ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<EvolvedSudoz>(&mut v1, 0x1::string::utf8(b"trait_type"), 0x1::string::utf8(b"{trait_type}"));
        0x2::display::add<EvolvedSudoz>(&mut v1, 0x1::string::utf8(b"value"), 0x1::string::utf8(b"{value}"));
    ...
    public entry fun mint_developer_reserve_batch(arg0: &EvolvedAdminCap, arg1: address, arg2: u64, arg3: &mut EvolvedStats, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < arg2) {
            ...
            let v6 = &mut v5;
            0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Background"));
            0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Skin"));
            0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Clothes"));
            0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Hats"));
            0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Eyewear"));
            0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Mouth"));
            0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Earrings"));
            let v7 = 0x1::vector::empty<0x1::string::String>();
            let v8 = &mut v7;
            0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"Developer Reserve"));
            0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"Gold"));
            0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"Developer Hoodie"));
            0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"Code Crown"));
            0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"Smart Glasses"));
            0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"Confident"));
            0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"SUI"));
            let v9 = EvolvedSudoz{
            ...
            let v10 = 0x2::object::id<EvolvedSudoz>(&v9);
            ...
            0x2::transfer::public_transfer<EvolvedSudoz>(v9, arg1);
            v2 = v2 + 1;
        };
    }
    ...
    public entry fun mint_developer_reserve_one_of_ones(arg0: &EvolvedAdminCap, arg1: address, arg2: &mut EvolvedStats, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < 0x1::vector::length<u64>(&v0)) {
            ...
            0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"Skin"));
            0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"Clothes"));
            0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"Hats"));
            0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"Eyewear"));
            0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"Mouth"));
            0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"Earrings"));
            let v8 = 0x1::vector::empty<0x1::string::String>();
            let v9 = &mut v8;
            0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"Developer Reserve"));
            0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"Gold"));
            0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"Developer Hoodie"));
            0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"Code Crown"));
            0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"Smart Glasses"));
            0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"Confident"));
            0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"SUI"));
            ...
            let v11 = 0x2::object::id<EvolvedSudoz>(&v10);
            arg2.evolved_minted = arg2.evolved_minted + 1;
            0x1::vector::push_back<0x2::object::ID>(&mut v1, v11);
    ...
    public entry fun mint_developer_reserve_specific(arg0: &EvolvedAdminCap, arg1: address, arg2: u64, arg3: &mut EvolvedStats, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Skin"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Clothes"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Hats"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Eyewear"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Mouth"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Earrings"));
        let v4 = 0x1::vector::empty<0x1::string::String>();
        let v5 = &mut v4;
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Developer Reserve"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Gold"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Developer Hoodie"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Code Crown"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Smart Glasses"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Confident"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"SUI"));
        let v6 = EvolvedSudoz{
        ...
        let v7 = EvolvedMinted{
            evolved_id               : 0x2::object::id<EvolvedSudoz>(&v6),
            recipient                : arg1,
            number                   : v1,
            metadata_id              : arg2,
            original_artifact_number : 0,
    ...
    public fun mint_evolved(arg0: &EvolvedAdminCap, arg1: address, arg2: u64, arg3: u8, arg4: &mut EvolvedStats, arg5: &0x2::random::Random, arg6: &mut 0x2::tx_context::TxContext) : EvolvedSudoz {
        ...
        let v4 = &mut v3;
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Background"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Skin"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Clothes"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Hats"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Eyewear"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Mouth"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Earrings"));
        let v5 = 0x1::vector::empty<0x1::string::String>();
        let v6 = &mut v5;
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Developer Reserve"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Gold"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Developer Hoodie"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Code Crown"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Smart Glasses"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Confident"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"SUI"));
        let v7 = EvolvedSudoz{
