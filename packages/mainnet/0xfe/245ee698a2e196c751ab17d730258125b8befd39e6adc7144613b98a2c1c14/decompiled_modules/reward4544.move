module 0xfe245ee698a2e196c751ab17d730258125b8befd39e6adc7144613b98a2c1c14::reward4544 {
    struct REWARD4544 has drop {
        dummy_field: bool,
    }

    struct TICKET_4544 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4544(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4544>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4544>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4544, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4544>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4544>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4544>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4544>>(v5, 0x2::tx_context::sender(arg1));
    }
