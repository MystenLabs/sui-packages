module 0xfe932d7189c0097242da9e0e7b2d0e4fb97a6c454e24ca865ac15814350eea89::secure_file_storage_v3 {
    ...
    public entry fun upload_file(arg0: &mut PrivexaStorage, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: 0x1::string::String, arg5: u8, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: vector<u8>, arg9: vector<u8>, arg10: vector<u8>, arg11: u8, arg12: 0x1::option::Option<vector<u8>>, arg13: vector<0x1::string::String>, arg14: 0x1::string::String, arg15: 0x1::string::String, arg16: address, arg17: bool, arg18: &0x2::clock::Clock, arg19: &mut 0x2::tx_context::TxContext) {
        ...
        ensure_user_profile(arg0, arg16, v1, arg19);
        let v2 = 0x2::table::borrow<address, UserProfile>(&arg0.user_profiles, arg16);
        ...
        let v4 = if (arg17) {
            ...
            assert!(0x2::table::borrow<address, UserProfile>(&arg0.user_profiles, arg16).gas_consumed + arg0.gas_sponsor.per_upload_cost <= arg0.gas_sponsor.per_user_limit, 1007);
            ...
            let v5 = 0x2::table::borrow_mut<address, UserProfile>(&mut arg0.user_profiles, arg16);
            v5.gas_consumed = safe_add(v5.gas_consumed, arg0.gas_sponsor.per_upload_cost);
            if (arg0.gas_sponsor.balance < arg0.gas_sponsor.low_balance_threshold) {
                let v6 = GasSponsorAlert{
                    current_balance : arg0.gas_sponsor.balance,
                    threshold       : arg0.gas_sponsor.low_balance_threshold,
                    timestamp       : v1,
                };
                0x2::event::emit<GasSponsorAlert>(v6);
            };
        ...
        let v8 = InternalFileData{
            ...
            content_hash    : arg10,
            encryption_iv   : arg12,
            shares          : 0x2::table::new<address, ShareInfo>(arg19),
            public_access   : 0x1::option::none<PublicAccessInfo>(),
        };
        0x2::table::add<0x1::string::String, FileMetadata>(&mut arg0.files_metadata, arg1, v7);
        0x2::table::add<0x1::string::String, InternalFileData>(&mut arg0.files_internal, arg1, v8);
        if (!0x2::table::contains<address, 0x2::vec_set::VecSet<0x1::string::String>>(&arg0.user_files, arg16)) {
            0x2::table::add<address, 0x2::vec_set::VecSet<0x1::string::String>>(&mut arg0.user_files, arg16, 0x2::vec_set::empty<0x1::string::String>());
        };
        0x2::vec_set::insert<0x1::string::String>(0x2::table::borrow_mut<address, 0x2::vec_set::VecSet<0x1::string::String>>(&mut arg0.user_files, arg16), arg1);
        let v9 = 0x2::table::borrow_mut<address, UserProfile>(&mut arg0.user_profiles, arg16);
        ...
        let v10 = FileUploadedEvent{
            ...
            timestamp         : v1,
            version           : 1,
            weekly_count      : update_user_upload_stats(v9, arg3, v1),
            gas_consumed      : v4,
        };
