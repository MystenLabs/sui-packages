module 0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::bounty {
    ...
    public fun cancel_bounty(arg0: &mut Bounty, arg1: &mut 0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::Room, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 0, 1);
        assert!(arg0.room == 0x2::object::id<0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::Room>(arg1), 10);
        assert!(0x2::tx_context::sender(arg3) == arg0.poster, 0);
        refund_to_poster(arg0, arg2, arg3);
        0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::dec_active_bounties(arg1);
    }

    public fun claim_after_review_timeout(arg0: &mut Bounty, arg1: &mut 0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::Room, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun post_bounty(arg0: &mut 0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::Room, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::is_open(arg0), 11);
        assert!(arg2 > 0, 2);
        ...
        let v5 = 0x2::object::id<0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::Room>(arg0);
        let v6 = Bounty{
        ...
        0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::inc_active_bounties(arg0);
    ...
    public fun release_bounty(arg0: &mut Bounty, arg1: &mut 0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::Room, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 2, 1);
        assert!(arg0.room == 0x2::object::id<0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::Room>(arg1), 10);
        assert!(0x2::tx_context::sender(arg3) == arg0.poster, 0);
    ...
    public fun resolve_dispute(arg0: &0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::AdminCap, arg1: &mut Bounty, arg2: &mut 0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::Room, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == 5, 1);
        assert!(arg1.room == 0x2::object::id<0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::Room>(arg2), 10);
        ...
        0xfecc2a9a2f88c5f18b79f8e841b45a7be20054069efb1a92728eb37d25e617bd::ephemeral_chat::dec_active_bounties(arg2);
    }
