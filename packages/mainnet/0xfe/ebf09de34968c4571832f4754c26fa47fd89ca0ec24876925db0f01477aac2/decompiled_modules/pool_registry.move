module 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::pool_registry {
    ...
    public(friend) fun add_coin<T0>(arg0: &mut PoolRegistry) {
        ...
        let v1 = 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::type_to_string<T0>();
    ...
    public fun contains_coin<T0>(arg0: &PoolRegistry) : bool {
        0x2::table::contains<0x1::ascii::String, bool>(&borrow_state(arg0).coins, 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::type_to_string<T0>())
    }

    public fun contains_lp_coin<T0>(arg0: &PoolRegistry) : bool {
        0x2::table::contains<0x1::ascii::String, 0x2::object::ID>(&borrow_state(arg0).lp_coin_map, 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::type_to_string<T0>())
    }

    public fun current_protocol_version() : u64 {
        2
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<u64, PoolRegistryStateV1>(&mut v0.id, 2, v1);
    ...
    public fun lp_type_to_pool_id<T0>(arg0: &PoolRegistry) : 0x2::object::ID {
        *0x2::table::borrow<0x1::ascii::String, 0x2::object::ID>(&borrow_state(arg0).lp_coin_map, 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::type_to_string<T0>())
    }
    ...
    public(friend) fun register_pool<T0>(arg0: &mut PoolRegistry, arg1: &0x2::object::UID, arg2: vector<0x1::ascii::String>, arg3: vector<u64>, arg4: u64, arg5: vector<u64>, arg6: vector<u64>, arg7: vector<u64>, arg8: vector<u64>) {
        ...
        0x2::table::add<0x1::ascii::String, 0x2::object::ID>(&mut v0.lp_coin_map, 0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::keys::type_to_string<T0>(), 0x2::object::uid_to_inner(arg1));
    }
    ...
    public fun upgrade(arg0: &mut PoolRegistry, arg1: &0xc05d18dd6b61f510786e0c6df15f769fbc1b7d317341251eca2af4370c7426c3::admin::AdminCap) {
        assert!(arg0.protocol_version == 2 - 1, 62);
        0x2::dynamic_object_field::add<u64, PoolRegistryStateV1>(&mut arg0.id, 2, 0x2::dynamic_object_field::remove<u64, PoolRegistryStateV1>(&mut arg0.id, 2 - 1));
        arg0.protocol_version = 2;
    }
