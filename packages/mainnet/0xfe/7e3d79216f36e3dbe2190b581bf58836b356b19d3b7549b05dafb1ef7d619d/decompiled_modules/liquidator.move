module 0x359afe764dadd59153018c8bc36dfede2e16d8f8ff68f3257d29a5562d749157::liquidator {
    ...
    struct Liquidator has store, key {
        id: 0x2::object::UID,
        package_caller_cap: 0x1::option::Option<0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::app::PackageCallerCap>,
    ...
    public(friend) fun borrow_package_caller_cap(arg0: &Liquidator) : &0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::app::PackageCallerCap {
        0x1::option::borrow<0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::app::PackageCallerCap>(&arg0.package_caller_cap)
    }

    public(friend) fun ensure_caller_whitelisted(arg0: &Liquidator, arg1: address) {
        assert!(0x2::vec_set::contains<address>(&arg0.whitelist, &arg1), 0x359afe764dadd59153018c8bc36dfede2e16d8f8ff68f3257d29a5562d749157::error::not_whitelisted());
    }
    ...
    fun init(arg0: LIQUIDATOR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Liquidator{
            ...
            package_caller_cap : 0x1::option::none<0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::app::PackageCallerCap>(),
    ...
    public fun populate_package_caller_cap(arg0: &LiquidatorAdminCap, arg1: &mut 0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::app::ProtocolApp, arg2: &mut Liquidator, arg3: 0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::app::PackageCallerCap) {
        if (0x1::option::is_some<0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::app::PackageCallerCap>(&arg2.package_caller_cap)) {
            0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::whitelist_admin::burn_whitelist(arg1, 0x1::option::extract<0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::app::PackageCallerCap>(&mut arg2.package_caller_cap));
        };
        0x1::option::fill<0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::app::PackageCallerCap>(&mut arg2.package_caller_cap, arg3);
    }
