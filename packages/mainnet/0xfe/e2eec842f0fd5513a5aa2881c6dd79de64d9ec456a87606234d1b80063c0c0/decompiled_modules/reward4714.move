module 0xfee2eec842f0fd5513a5aa2881c6dd79de64d9ec456a87606234d1b80063c0c0::reward4714 {
    struct REWARD4714 has drop {
        dummy_field: bool,
    }

    struct TICKET_4714 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4714(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4714>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4714>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4714, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4714>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4714>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4714>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4714>>(v5, 0x2::tx_context::sender(arg1));
    }
