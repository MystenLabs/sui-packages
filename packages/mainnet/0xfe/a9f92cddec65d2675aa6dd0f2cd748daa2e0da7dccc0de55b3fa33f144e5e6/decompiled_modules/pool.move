module 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::pool {
    ...
    fun reward_settle<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock) {
        let v0 = 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::reward::settle_rewards(&mut arg0.reward_manager, arg1);
        if (0x1::vector::is_empty<u128>(&v0)) {
            return
        };
        if (0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::is_active_bin_empty(&arg0.bin_manager, arg0.active_id)) {
            0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::reward::rollover_refunds_into_remaining_time(&mut arg0.reward_manager, v0, arg1);
            return
        };
        if (0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::reward::emergency_reward_pause(&arg0.reward_manager)) {
            0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::reward::refund_rewards(&mut arg0.reward_manager, v0);
            return
        };
        0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::accumulate_rewards(0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::borrow_bin_mut(&mut arg0.bin_manager, arg0.active_id), v0);
    }
