module 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::position {
    ...
    public fun push_back(arg0: &mut OpenPositionArg, arg1: BinStat) {
        ...
        assert!(0x1::vector::length<BinStat>(&arg0.bin_stats) < (0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::constants::max_bin_per_position() as u64), 13906834977502789641);
    ...
    public(friend) fun decrease_liquidity(arg0: &mut PositionManager, arg1: &mut Position, arg2: &0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::Bin, arg3: u128) {
        if (arg3 == 0) {
            return
        };
        let v0 = arg1.lower_bin_id;
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::gte(0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::id(arg2), v0) && 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lte(0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::id(arg2), arg1.upper_bin_id), 13906836055539843085);
        let v1 = (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::sub(0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::id(arg2), v0)) as u64);
        ...
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v3.bin_id, 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::id(arg2)), 13906836077014286343);
        let v4 = &mut v2.fee_owned_a;
        let v5 = &mut v2.fee_owned_b;
        update_fee_per_bin(v3, 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::fee_a_growth_global(arg2), 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::fee_b_growth_global(arg2), v4, v5);
        let v6 = &mut v2.rewards_owned;
        update_reward_per_bin(v3, 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::rewards_growth_global(arg2), v6);
    ...
    public fun borrow_position_info(arg0: &PositionManager, arg1: 0x2::object::ID) : &PositionInfo {
        assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 13906837365505523735);
    ...
    public(friend) fun close_position_bin(arg0: &mut ClosePositionCert, arg1: &mut 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::Bin, arg2: BinStat) : (u64, u64) {
        let v0 = &mut arg2;
        let v1 = &mut arg0.position_info.fee_owned_a;
        let v2 = &mut arg0.position_info.fee_owned_b;
        update_fee_per_bin(v0, 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::fee_a_growth_global(arg1), 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::fee_b_growth_global(arg1), v1, v2);
        let v3 = &mut arg2;
        let v4 = &mut arg0.position_info.rewards_owned;
        update_reward_per_bin(v3, 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::rewards_growth_global(arg1), v4);
        let BinStat {
            bin_id          : _,
            liquidity_share : v6,
            fee_a_growth    : _,
        ...
        let (v10, v11) = 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::decrease_liquidity(arg1, v6);
    ...
    fun decrease_liquidity_per_bin(arg0: &mut BinStat, arg1: u128) : u128 {
        assert!(arg0.liquidity_share >= arg1, 13906838666879303683);
    ...
    public(friend) fun destroy_cert(arg0: ClosePositionCert) {
        ...
        let v8 = v7;
        assert!(0x1::vector::length<BinStat>(&v8) == 0, 13906837043382845461);
        0x1::vector::destroy_empty<BinStat>(v8);
        assert!(v1 + v4 == 0, 13906837051972386831);
        assert!(v2 + v5 == 0, 13906837056267485201);
        let v9 = v6;
        let v10 = 0;
        while (v10 < 0x1::vector::length<u64>(&v9)) {
            assert!(0x1::vector::pop_back<u64>(&mut v9) == 0, 13906837064857550867);
            v10 = v10 + 1;
        };
    ...
    public(friend) fun increase_liquidity(arg0: &mut PositionManager, arg1: &mut Position, arg2: &0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::Bin, arg3: u128) {
        if (arg3 == 0) {
            return
        };
        let v0 = arg1.lower_bin_id;
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::gte(0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::id(arg2), v0) && 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lte(0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::id(arg2), arg1.upper_bin_id), 13906835857971347469);
        let v1 = (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::sub(0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::id(arg2), v0)) as u64);
        let v2 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_mut<0x2::object::ID, PositionInfo>(&mut arg0.positions, 0x2::object::id<Position>(arg1));
        let v3 = 0x1::vector::borrow_mut<BinStat>(&mut v2.stats, v1);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v3.bin_id, 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::id(arg2)), 13906835879445790727);
        let v4 = &mut v2.fee_owned_a;
        let v5 = &mut v2.fee_owned_b;
        update_fee_per_bin(v3, 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::fee_a_growth_global(arg2), 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::fee_b_growth_global(arg2), v4, v5);
        let v6 = &mut v2.rewards_owned;
    ...
    fun increase_liquidity_per_bin(arg0: &mut BinStat, arg1: u128) : u128 {
        assert!(340282366920938463463374607431768211455 - arg0.liquidity_share >= arg1, 13906838602454663169);
        arg0.liquidity_share = arg0.liquidity_share + arg1;
        arg0.liquidity_share
    }
    ...
    public(friend) fun new_bin_stat(arg0: &0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::Bin, arg1: u128) : BinStat {
        BinStat{
            bin_id          : 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::id(arg0),
            liquidity_share : arg1,
            fee_a_growth    : 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::fee_a_growth_global(arg0),
            fee_b_growth    : 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::fee_b_growth_global(arg0),
            rewards_growth  : 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::rewards_growth_global(arg0),
        }
    }
    ...
    public(friend) fun update_fee(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: &0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::Bin) {
        ...
        let v1 = 0x1::vector::borrow_mut<BinStat>(&mut v0.stats, (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::sub(0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::id(arg2), lower_bin_id_on_position_info(v0))) as u64));
        if (liquidity_share(v1) == 0) {
            return
        };
        let v2 = &mut v0.fee_owned_a;
        let v3 = &mut v0.fee_owned_b;
        update_fee_per_bin(v1, 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::fee_a_growth_global(arg2), 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::fee_b_growth_global(arg2), v2, v3);
    }
    ...
    fun update_fee_per_bin(arg0: &mut BinStat, arg1: u128, arg2: u128, arg3: &mut u64, arg4: &mut u64) {
        ...
        *arg3 = *arg3 + (0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::dlmm_math::calculate_amount_by_growth(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(arg1, arg0.fee_a_growth), arg0.liquidity_share) as u64);
        *arg4 = *arg4 + (0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::dlmm_math::calculate_amount_by_growth(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(arg2, arg0.fee_b_growth), arg0.liquidity_share) as u64);
    }
    ...
    fun update_reward_per_bin(arg0: &mut BinStat, arg1: vector<u128>, arg2: &mut vector<u64>) {
        ...
        assert!(v1 <= v0, 13906838757073747973);
        let v2 = 0;
        while (v2 < v0) {
            ...
            let v4 = if (v1 > v2) {
                ...
                *v5 = v3;
                0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::dlmm_math::calculate_amount_by_growth(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(v3, *v5), arg0.liquidity_share)
            } else {
                0x1::vector::push_back<u128>(&mut arg0.rewards_growth, v3);
                0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::dlmm_math::calculate_amount_by_growth(v3, arg0.liquidity_share)
            };
    ...
    public(friend) fun update_rewards(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: &0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::Bin) {
        let v0 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_mut<0x2::object::ID, PositionInfo>(&mut arg0.positions, arg1);
        let v1 = 0x1::vector::borrow_mut<BinStat>(&mut v0.stats, (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::sub(0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::id(arg2), lower_bin_id_on_position_info(v0))) as u64));
        if (liquidity_share(v1) == 0) {
            return
        ...
        update_reward_per_bin(v1, 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::bin::rewards_growth_global(arg2), v2);
    }
