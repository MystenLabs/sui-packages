module 0xfe17373d094541c90d9da7dfc781c67ecaa0c7f29ac4eaf25ce0e698e2608abe::acl {
    struct Aeqrsdscmpxmnwi has key {
        id: 0x2::object::UID,
        pools: 0x2::table::Table<0x1::ascii::String, Kgzycxrplrmxsop>,
    }

    struct Kgzycxrplrmxsop has store {
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    public entry fun cfafwewyhrxtmkv(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Aeqrsdscmpxmnwi, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Kgzycxrplrmxsop>(&arg2.pools, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Kgzycxrplrmxsop>(&mut arg2.pools, arg3);
        if (v0.initialized) {
    ...
    public entry fun dosohraotseqfpu(arg0: &mut Aeqrsdscmpxmnwi, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<0x1::ascii::String, Kgzycxrplrmxsop>(&mut arg0.pools, arg1, v4);
    }

    public entry fun fqyzaxlwoyzwtgn(arg0: &mut Aeqrsdscmpxmnwi, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Kgzycxrplrmxsop>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Kgzycxrplrmxsop>(&mut arg0.pools, arg1);
        assert!(0x2::tx_context::sender(arg3) == v0.owner, 0);
        v0.initialized = arg2;
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Aeqrsdscmpxmnwi{
            id    : 0x2::object::new(arg0),
            pools : 0x2::table::new<0x1::ascii::String, Kgzycxrplrmxsop>(arg0),
        };
        0x2::transfer::share_object<Aeqrsdscmpxmnwi>(v0);
    }

    public entry fun jqaxtkxshtlooxc(arg0: &mut Aeqrsdscmpxmnwi, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Kgzycxrplrmxsop{
        ...
        0x2::table::add<0x1::ascii::String, Kgzycxrplrmxsop>(&mut arg0.pools, arg1, v0);
    }

    public entry fun szcobztluapsisk(arg0: &mut Aeqrsdscmpxmnwi, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Kgzycxrplrmxsop>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Kgzycxrplrmxsop>(&mut arg0.pools, arg1);
    ...
    public entry fun yrkfapaoqdnwqxd<T0>(arg0: &mut Aeqrsdscmpxmnwi, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Kgzycxrplrmxsop>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Kgzycxrplrmxsop>(&mut arg0.pools, arg1);
    ...
    public entry fun zavvphnymstrhgf<T0: store + key>(arg0: &mut Aeqrsdscmpxmnwi, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Kgzycxrplrmxsop>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Kgzycxrplrmxsop>(&mut arg0.pools, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.delegate, 0);
