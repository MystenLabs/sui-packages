module 0xfe927d5ae27baa747a841293602351778968649b0fa389c4fea4170dc48b907d::vram {
    ...
    fun init(arg0: VRAM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3;
        let v5 = v2;
        0xfe927d5ae27baa747a841293602351778968649b0fa389c4fea4170dc48b907d::kiosk_lock_rule::add<VramNFT>(&mut v5, &v4);
        0xfe927d5ae27baa747a841293602351778968649b0fa389c4fea4170dc48b907d::royalty_rule::add<VramNFT>(&mut v5, &v4, 500, 0);
