module 0xfe204bc480bde80faf2b45a79a766a2c717d273d79cac4c11508694afa155194::presale {
    ...
    struct Treasury has key {
        id: 0x2::object::UID,
        rewardsTreasury: 0x2::balance::Balance<0xfe204bc480bde80faf2b45a79a766a2c717d273d79cac4c11508694afa155194::token::TOKEN>,
    ...
    public entry fun claim(arg0: &mut UserState, arg1: &mut Treasury, arg2: &mut PresalePool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        *0x2::vec_map::get_mut<address, bool>(&mut arg0.isClaimed, &v0) = true;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xfe204bc480bde80faf2b45a79a766a2c717d273d79cac4c11508694afa155194::token::TOKEN>>(0x2::coin::take<0xfe204bc480bde80faf2b45a79a766a2c717d273d79cac4c11508694afa155194::token::TOKEN>(&mut arg1.rewardsTreasury, v2, arg4), v0);
    }
    ...
    public fun getTreasury(arg0: &Treasury) : (u64, u64) {
        (0x2::balance::value<0x2::sui::SUI>(&arg0.stakedCoinsTreasury), 0x2::balance::value<0xfe204bc480bde80faf2b45a79a766a2c717d273d79cac4c11508694afa155194::token::TOKEN>(&arg0.rewardsTreasury))
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Treasury{
            id                  : 0x2::object::new(arg0),
            rewardsTreasury     : 0x2::balance::zero<0xfe204bc480bde80faf2b45a79a766a2c717d273d79cac4c11508694afa155194::token::TOKEN>(),
    ...
    public entry fun setRewardAmount(arg0: &AdminCap, arg1: &mut Treasury, arg2: 0x2::coin::Coin<0xfe204bc480bde80faf2b45a79a766a2c717d273d79cac4c11508694afa155194::token::TOKEN>) {
        0x2::balance::join<0xfe204bc480bde80faf2b45a79a766a2c717d273d79cac4c11508694afa155194::token::TOKEN>(&mut arg1.rewardsTreasury, 0x2::coin::into_balance<0xfe204bc480bde80faf2b45a79a766a2c717d273d79cac4c11508694afa155194::token::TOKEN>(arg2));
    }
