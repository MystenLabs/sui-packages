module 0xfea68b0763877321a63536cf19f49d2cb92146186736934b735e29a32743e041::bookmaker {
    struct Markets has store, key {
        ...
        balance: 0x2::balance::Balance<0xfea68b0763877321a63536cf19f49d2cb92146186736934b735e29a32743e041::wsd::WSD>,
    }
    ...
    public fun add_liquidity(arg0: &mut Markets, arg1: 0x2::coin::Coin<0xfea68b0763877321a63536cf19f49d2cb92146186736934b735e29a32743e041::wsd::WSD>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::balance::join<0xfea68b0763877321a63536cf19f49d2cb92146186736934b735e29a32743e041::wsd::WSD>(&mut arg0.balance, 0x2::coin::into_balance<0xfea68b0763877321a63536cf19f49d2cb92146186736934b735e29a32743e041::wsd::WSD>(arg1));
    }
    ...
    public entry fun claim_win(arg0: Bet, arg1: 0x1::string::String, arg2: &mut Markets, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xfea68b0763877321a63536cf19f49d2cb92146186736934b735e29a32743e041::wsd::WSD>>(0x2::coin::take<0xfea68b0763877321a63536cf19f49d2cb92146186736934b735e29a32743e041::wsd::WSD>(&mut arg2.balance, ((arg0.amount + arg0.payout) as u64), arg3), 0x2::tx_context::sender(arg3));
        let Bet {
            id     : v1,
            result : _,
            amount : _,
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Markets{
            ...
            balance        : 0x2::balance::zero<0xfea68b0763877321a63536cf19f49d2cb92146186736934b735e29a32743e041::wsd::WSD>(),
        };
        0x2::transfer::share_object<Markets>(v0);
    }

    public entry fun make_bet(arg0: u8, arg1: 0x2::coin::Coin<0xfea68b0763877321a63536cf19f49d2cb92146186736934b735e29a32743e041::wsd::WSD>, arg2: 0x1::string::String, arg3: &mut Markets, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::into_balance<0xfea68b0763877321a63536cf19f49d2cb92146186736934b735e29a32743e041::wsd::WSD>(arg1);
        let v1 = (0x2::balance::value<0xfea68b0763877321a63536cf19f49d2cb92146186736934b735e29a32743e041::wsd::WSD>(&v0) as u128);
        ...
        0x2::balance::join<0xfea68b0763877321a63536cf19f49d2cb92146186736934b735e29a32743e041::wsd::WSD>(&mut arg3.balance, v0);
    }
