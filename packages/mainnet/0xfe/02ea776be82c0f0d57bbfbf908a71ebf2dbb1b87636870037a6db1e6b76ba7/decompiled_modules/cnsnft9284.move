module 0xfe02ea776be82c0f0d57bbfbf908a71ebf2dbb1b87636870037a6db1e6b76ba7::cnsnft9284 {
    struct CNSNFT9284 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9284, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9284>(arg0, arg1);
