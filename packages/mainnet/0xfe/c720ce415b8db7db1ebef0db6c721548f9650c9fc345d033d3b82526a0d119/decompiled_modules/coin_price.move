module 0xfec720ce415b8db7db1ebef0db6c721548f9650c9fc345d033d3b82526a0d119::coin_price {
    ...
    public fun calculate_usdc_needed_for_yy<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0xeed6021c73d1065611e33d053c55f5c41aae9f8c03ff011e620cbb13fbc0db65::implements::Global, arg2: u64) : (u64, u64) {
        assert!(arg2 > 0, 1002);
        let (v0, v1, _) = 0xeed6021c73d1065611e33d053c55f5c41aae9f8c03ff011e620cbb13fbc0db65::interface::getLpliquidity<T1, T2>(arg1);
    ...
    public fun calculate_usdc_to_yy_route<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0xeed6021c73d1065611e33d053c55f5c41aae9f8c03ff011e620cbb13fbc0db65::implements::Global, arg2: u64) : (u64, u64) {
        assert!(arg2 > 0, 1002);
        let (_, v1) = calculate_swap_result<T0, T1>(arg0, arg2, true);
        (v1, calculate_yswap_amount_out<T1, T2>(arg1, v1))
    }

    public fun calculate_yswap_amount_out<T0, T1>(arg0: &mut 0xeed6021c73d1065611e33d053c55f5c41aae9f8c03ff011e620cbb13fbc0db65::implements::Global, arg1: u64) : u64 {
        if (arg1 == 0) {
            return 0
        };
        let (v0, v1, _) = 0xeed6021c73d1065611e33d053c55f5c41aae9f8c03ff011e620cbb13fbc0db65::interface::getLpliquidity<T0, T1>(arg0);
        if (v0 == 0 || v1 == 0) {
            return 0
        };
    ...
    public fun calculate_yswap_amount_outV1<T0, T1>(arg0: &mut 0xeed6021c73d1065611e33d053c55f5c41aae9f8c03ff011e620cbb13fbc0db65::implements::Global, arg1: u64) : u128 {
        if (arg1 == 0) {
            return 0
        };
        let (v0, v1, _) = 0xeed6021c73d1065611e33d053c55f5c41aae9f8c03ff011e620cbb13fbc0db65::interface::getLpliquidity<T0, T1>(arg0);
    ...
    public fun get_detailed_route_info<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0xeed6021c73d1065611e33d053c55f5c41aae9f8c03ff011e620cbb13fbc0db65::implements::Global, arg2: u64) : RouteInfo {
    ...
    public fun get_yswap_reserves<T0, T1>(arg0: &mut 0xeed6021c73d1065611e33d053c55f5c41aae9f8c03ff011e620cbb13fbc0db65::implements::Global) : (u64, u64) {
        let (v0, v1, _) = 0xeed6021c73d1065611e33d053c55f5c41aae9f8c03ff011e620cbb13fbc0db65::interface::getLpliquidity<T0, T1>(arg0);
        (v0, v1)
    }
    ...
    public fun quick_quote_100_usdc_to_yy<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0xeed6021c73d1065611e33d053c55f5c41aae9f8c03ff011e620cbb13fbc0db65::implements::Global) : u64 {
        let (_, v1) = calculate_usdc_to_yy_route<T0, T1, T2>(arg0, arg1, 100000000);
        v1
    }

    public fun quote_usdc_to_yy<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0xeed6021c73d1065611e33d053c55f5c41aae9f8c03ff011e620cbb13fbc0db65::implements::Global, arg2: u64) : u64 {
