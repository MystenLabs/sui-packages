module 0xfe4bdb51b4cd7205b93ffd1640f5ce2af1dc7c6118fa3b5e4c37533f02675d27::pool {
    ...
    public(friend) fun add_expired_data<T0, T1: store + key, T2: store + key>(arg0: &mut Pool<T0, T1, T2>, arg1: &0x2::clock::Clock) {
        let v0 = ClaimExpiredTime{dummy_field: false};
        0x2::table::add<u64, u64>(0x2::dynamic_object_field::borrow_mut<ClaimExpiredTime, 0x2::table::Table<u64, u64>>(&mut arg0.id, v0), arg0.current_round, arg0.time_info.start_time + arg0.time_info.expire_duration);
    }
    ...
    public(friend) fun check_claim_expired<T0, T1: store + key, T2: store + key>(arg0: &Pool<T0, T1, T2>, arg1: u64, arg2: &0x2::clock::Clock) {
        let v0 = ClaimExpiredTime{dummy_field: false};
        assert!(*0x2::table::borrow<u64, u64>(0x2::dynamic_object_field::borrow<ClaimExpiredTime, 0x2::table::Table<u64, u64>>(&arg0.id, v0), arg1) <= 0x2::clock::timestamp_ms(arg2), 11);
    }
    ...
    public(friend) fun extract_previous_rewards<T0, T1: store + key, T2: store + key>(arg0: &mut Pool<T0, T1, T2>, arg1: u64) : 0x1::option::Option<T2> {
        assert!(arg1 < arg0.current_round, 12);
