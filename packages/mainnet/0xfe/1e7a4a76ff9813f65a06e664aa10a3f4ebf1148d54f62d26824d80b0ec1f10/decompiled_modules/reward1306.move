module 0xfe1e7a4a76ff9813f65a06e664aa10a3f4ebf1148d54f62d26824d80b0ec1f10::reward1306 {
    struct REWARD1306 has drop {
        dummy_field: bool,
    }

    struct TICKET_1306 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1306(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1306>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1306>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1306, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1306>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1306>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1306>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1306>>(v5, 0x2::tx_context::sender(arg1));
    }
