module 0xfe03d06ba23e22bfa40e7989aa5b0f7b137e61a799bc971add72f4b7ca5a4b7d::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"TeoTeo", b"TeoTeo", b"", 0x1::option::none<0x2::url::Url>(), arg1);
