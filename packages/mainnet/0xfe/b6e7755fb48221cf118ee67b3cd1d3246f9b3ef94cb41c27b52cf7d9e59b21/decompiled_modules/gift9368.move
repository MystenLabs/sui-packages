module 0xfeb6e7755fb48221cf118ee67b3cd1d3246f9b3ef94cb41c27b52cf7d9e59b21::gift9368 {
    struct GIFT9368 has drop {
        dummy_field: bool,
    }

    struct TICKET_9368 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9368(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9368>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9368>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9368, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9368>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9368>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9368>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9368>>(v5, 0x2::tx_context::sender(arg1));
    }
