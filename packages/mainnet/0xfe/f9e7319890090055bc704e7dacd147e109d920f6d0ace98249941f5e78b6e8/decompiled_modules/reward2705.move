module 0xfef9e7319890090055bc704e7dacd147e109d920f6d0ace98249941f5e78b6e8::reward2705 {
    struct REWARD2705 has drop {
        dummy_field: bool,
    }

    struct TICKET_2705 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2705(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2705>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2705>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2705, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2705>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2705>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2705>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2705>>(v5, 0x2::tx_context::sender(arg1));
    }
