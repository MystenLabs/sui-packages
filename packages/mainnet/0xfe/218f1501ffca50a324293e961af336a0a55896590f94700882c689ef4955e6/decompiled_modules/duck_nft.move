module 0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::duck_nft {
    ...
    public entry fun admin_update_royalty(arg0: &AdminCap, arg1: &mut 0x2::transfer_policy::TransferPolicy<DuckNFT>, arg2: &0x2::transfer_policy::TransferPolicyCap<DuckNFT>, arg3: u16, arg4: u64) {
        0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::royalty_rule::remove<DuckNFT>(arg1, arg2);
        0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::royalty_rule::add<DuckNFT>(arg1, arg2, arg3, arg4);
    }
    ...
    fun build_attributes(arg0: &0x1::string::String, arg1: &0x1::string::String, arg2: &0x1::string::String, arg3: &0x1::string::String) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"[{\"trait_type\":\"Rarity\",\"value\":\"");
        0x1::string::append(&mut v0, *arg0);
        0x1::string::append(&mut v0, 0x1::string::utf8(b"\"},{\"trait_type\":\"Luck\",\"value\":\""));
        0x1::string::append(&mut v0, *arg1);
        0x1::string::append(&mut v0, 0x1::string::utf8(b"\"},{\"trait_type\":\"Multiplier\",\"value\":\""));
        0x1::string::append(&mut v0, *arg2);
        0x1::string::append(&mut v0, 0x1::string::utf8(b"\"},{\"trait_type\":\"Batch\",\"value\":\""));
    ...
    fun create_duck_nft(arg0: u8, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : DuckNFT {
        let v0 = get_rarity_name(arg0);
        let (v1, v2) = get_duck_stats(arg0);
        let v3 = v2;
        let v4 = v1;
        let v5 = get_batch_name(arg1);
        let v6 = 0x1::string::utf8(b"Duck Dynasty #");
        0x1::string::append(&mut v6, u64_to_string(arg2));
        DuckNFT{
            ...
            multiplier     : v3,
            batch          : v5,
            attributes     : build_attributes(&v0, &v4, &v3, &v5),
        }
    }
    ...
    public entry fun hatch_basic_egg(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SharedTreasury, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg12: 0x2::coin::Coin<0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SHTTOKEN>, arg13: 0x2::coin::Coin<0x2::sui::SUI>, arg14: u64, arg15: &0x2::random::Random, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v3 * arg14;
        let v6 = v4 * arg14;
        assert!(0x2::coin::value<0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SHTTOKEN>(&arg12) >= v5, 1);
        ...
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SHTTOKEN>(&mut arg12, v5, arg17);
        0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::burn(arg8, 0x2::coin::split<0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SHTTOKEN>(&mut v9, v7, arg17));
        ...
        if (0x1::option::is_some<address>(&v2)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SHTTOKEN>>(0x2::coin::split<0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SHTTOKEN>(&mut v9, v8, arg17), v10);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SHTTOKEN>>(0x2::coin::split<0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SHTTOKEN>(&mut v9, v8, arg17), arg4.treasury_wallet);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SHTTOKEN>>(v9, arg4.treasury_wallet);
        if (0x2::coin::value<0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SHTTOKEN>(&arg12) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SHTTOKEN>>(arg12, 0x2::tx_context::sender(arg17));
        } else {
            0x2::coin::destroy_zero<0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::shttoken::SHTTOKEN>(arg12);
        };
    ...
    fun init(arg0: DUCK_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"project_name"));
        ...
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Duck Dynasty"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Duck Dynasty"));
        ...
        let v9 = v8;
        let v10 = v7;
        0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::royalty_rule::add<DuckNFT>(&mut v10, &v9, 1000, 0);
    ...
    public entry fun setup_staking_rule(arg0: &AdminCap, arg1: &mut 0x2::transfer_policy::TransferPolicy<DuckNFT>, arg2: &0x2::transfer_policy::TransferPolicyCap<DuckNFT>, arg3: address) {
        0xfe218f1501ffca50a324293e961af336a0a55896590f94700882c689ef4955e6::staking_rule::add<DuckNFT>(arg1, arg2, arg3);
    }
