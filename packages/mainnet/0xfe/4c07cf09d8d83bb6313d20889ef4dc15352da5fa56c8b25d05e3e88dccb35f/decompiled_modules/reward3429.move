module 0xfe4c07cf09d8d83bb6313d20889ef4dc15352da5fa56c8b25d05e3e88dccb35f::reward3429 {
    struct REWARD3429 has drop {
        dummy_field: bool,
    }

    struct TICKET_3429 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3429(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3429>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3429>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3429, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3429>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3429>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3429>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3429>>(v5, 0x2::tx_context::sender(arg1));
    }
