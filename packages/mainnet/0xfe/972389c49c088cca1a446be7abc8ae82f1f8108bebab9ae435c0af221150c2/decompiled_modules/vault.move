module 0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::vault {
    ...
    struct Treasury has key {
        id: 0x2::object::UID,
        rewardsTreasury: 0x2::balance::Balance<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>,
    ...
    public entry fun getReward(arg0: &mut UserState, arg1: &mut RewardState, arg2: &mut Treasury, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        *v1 = 0;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>>(0x2::coin::take<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>(&mut arg2.rewardsTreasury, *v1, arg4), 0x2::tx_context::sender(arg4));
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Treasury{
            id                  : 0x2::object::new(arg0),
            rewardsTreasury     : 0x2::balance::zero<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>(),
    ...
    public entry fun setRewardAmount(arg0: &AdminCap, arg1: 0x2::coin::Coin<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>, arg2: &mut UserState, arg3: &mut RewardState, arg4: &mut Treasury, arg5: &0x2::clock::Clock) {
        let v0 = 0x2::coin::value<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>(&arg1);
        ...
        0x2::balance::join<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>(&mut arg4.rewardsTreasury, 0x2::coin::into_balance<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>(arg1));
        ...
        assert!(arg3.rewardRate * arg3.duration <= 0x2::balance::value<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>(&arg4.rewardsTreasury), 103);
    ...
    public entry fun stake(arg0: 0x2::coin::Coin<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>, arg1: u64, arg2: &mut UserState, arg3: &mut RewardState, arg4: &mut Treasury, arg5: &mut 0x2::coin::TreasuryCap<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>>(0x2::coin::mint<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>(arg5, v3, arg7), v0);
    ...
    public entry fun withdraw(arg0: &mut UserState, arg1: &mut RewardState, arg2: &mut Treasury, arg3: &mut 0x2::coin::TreasuryCap<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::burn<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>(arg3, 0x2::coin::take<0xfe972389c49c088cca1a446be7abc8ae82f1f8108bebab9ae435c0af221150c2::stpop::STPOP>(&mut arg2.rewardsTreasury, v11, arg6));
