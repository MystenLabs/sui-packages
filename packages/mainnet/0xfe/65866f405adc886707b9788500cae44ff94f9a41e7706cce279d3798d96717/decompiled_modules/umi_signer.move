module 0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::umi_signer {
    ...
    public fun borrow_for_signing<T0: store + key>(arg0: &mut UmiSigner, arg1: ChainId, arg2: &0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::signing_policy::SigningPolicy, arg3: 0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::signing_policy::SigningRequest, arg4: &mut 0x2::tx_context::TxContext) : (T0, BorrowReceipt<T0>) {
        assert!(has_wallet(arg0, arg1), 3);
        assert!(0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::signing_policy::signer_id(&arg3) == 0x2::object::id<UmiSigner>(arg0), 8);
        0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::signing_policy::verify_request<UmiSigner>(&arg3, arg2, arg0, arg4);
        0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::signing_policy::destroy_request(arg3);
        ...
        let v7 = SigningOccurred{
            ...
            chain_id    : arg1.name,
            wallet_id   : v2,
            intent_hash : 0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::signing_policy::intent_hash(&arg3),
        };
    ...
    entry fun default(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::signing_policy::share(v2);
        0x2::transfer::transfer<UmiSignerOwnerCap>(v1, 0x2::tx_context::sender(arg0));
        0x2::transfer::public_transfer<0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::signing_policy::SigningPolicyCap>(v3, 0x2::tx_context::sender(arg0));
    }
    ...
    public fun lock<T0: store + key>(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: &0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::signing_policy::SigningPolicy, arg4: T0, arg5: &0x2::tx_context::TxContext) {
    ...
    public fun new_with_policy(arg0: &mut 0x2::tx_context::TxContext) : (UmiSigner, UmiSignerOwnerCap, 0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::signing_policy::SigningPolicy, 0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::signing_policy::SigningPolicyCap) {
        let (v0, v1) = new(arg0);
        let (v2, v3) = 0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::signing_policy::new(arg0);
        let v4 = v3;
        let v5 = v2;
        let v6 = 0x1::vector::empty<address>();
        0x1::vector::push_back<address>(&mut v6, 0x2::tx_context::sender(arg0));
        0xfe65866f405adc886707b9788500cae44ff94f9a41e7706cce279d3798d96717::authorization_rule::add(&mut v5, &v4, v6);
        (v0, v1, v5, v4)
    }
