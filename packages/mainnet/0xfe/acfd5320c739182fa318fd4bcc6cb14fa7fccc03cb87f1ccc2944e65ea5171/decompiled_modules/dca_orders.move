module 0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::dca_orders {
    ...
    public fun cancel_dca_order<T0, T1, T2>(arg0: DcaOrder<T0, T1, T2>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 && !v2) {
            ...
            0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::send_coins_and_destroy_balance<T1>(v8, v10, arg2);
            0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::send_coins_and_destroy_balance<T2>(v9, v10, arg2);
            0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::send_coins_and_destroy_balance<T0>(v7, v10, arg2);
    ...
    public fun claim_tokens_for_dca_interval<T0, T1, T2>(arg0: &0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::Guard<T0, T2>, arg1: DcaOrder<T0, T1, T2>, arg2: &0x2::clock::Clock, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::address::to_bytes(0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::get_actioneer<T0, T2>(arg0));
    ...
    public fun create_dca_order<T0, T1, T2>(arg0: &0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::Guard<T0, T2>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: u64, arg4: u32, arg5: u64, arg6: u64, arg7: vector<u8>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = DcaOrderCreated<T0, T1, T2>{
            ...
            guard_id                            : 0x2::object::id<0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::Guard<T0, T2>>(arg0),
            user                                : v1.user,
    ...
    fun decode_start_permission_and_check_signature<T0, T1>(arg0: &0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::Guard<T0, T1>, arg1: vector<u8>, arg2: vector<u8>) : SignedDcaPermissionData {
        let v0 = 0x2::address::to_bytes(0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::get_actioneer<T0, T1>(arg0));
    ...
    fun handle_previous_intervals<T0, T1, T2>(arg0: &mut DcaOrder<T0, T1, T2>, arg1: &SignedDcaPermissionData, arg2: u32, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.last_executed_interval_index == arg1.previous_executed_interval_index) {
            0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::send_coins_and_destroy_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg0.locked_collateral), arg0.user, arg3);
    ...
    public fun pre_start_dca_order_execution<T0, T1, T2>(arg0: &0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::Guard<T0, T2>, arg1: &mut DcaOrder<T0, T1, T2>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, SwapReceipt) {
    ...
    fun register_order_interval_fulfillment<T0, T1, T2>(arg0: &mut DcaOrder<T0, T1, T2>, arg1: u32, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : bool {
        ...
        0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::send_coins_and_destroy_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg0.locked_collateral), arg2, arg3);
        if (arg0.coins_in_were_swapped_during_interval) {
            arg0.coins_in_were_swapped_during_interval = false;
    ...
    public fun start_dca_order_execution<T0, T1, T2>(arg0: &mut 0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::Guard<T0, T2>, arg1: &mut DcaOrder<T0, T1, T2>, arg2: vector<u8>, arg3: vector<u8>, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = decode_start_permission_and_check_signature<T0, T2>(arg0, arg2, arg3);
    ...
    fun start_dca_order_execution_internal<T0, T1, T2>(arg0: &mut 0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::Guard<T0, T2>, arg1: &mut DcaOrder<T0, T1, T2>, arg2: SignedDcaPermissionData, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0xfeacfd5320c739182fa318fd4bcc6cb14fa7fccc03cb87f1ccc2944e65ea5171::source_chain_guard::increase_collected_fees<T0, T2>(arg0, 0x2::coin::into_balance<T0>(arg4));
