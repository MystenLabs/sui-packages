module 0xd666b466f618e1905b72f0a7559d2317bf96a33b0efc4f2e67e8fc98d280a7a8::cnsnft2874 {
    struct CNSNFT2874 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2874, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2874>(arg0, arg1);
