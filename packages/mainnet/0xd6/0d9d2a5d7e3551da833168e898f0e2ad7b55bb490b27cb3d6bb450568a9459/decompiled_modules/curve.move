module 0xd60d9d2a5d7e3551da833168e898f0e2ad7b55bb490b27cb3d6bb450568a9459::curve {
    ...
    struct BondingCurve<phantom T0> has key {
        ...
        discord: 0x1::option::Option<0x1::ascii::String>,
    ...
    entry fun add_version(arg0: &mut Configurator, arg1: &AdminCap, arg2: u64) {
        0x2::vec_set::insert<u64>(&mut arg0.versions, arg2);
    }

    fun assert_version(arg0: &Configurator) {
        let v0 = 1;
    ...
    public fun buy<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut Configurator, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        if (v8 <= arg0.target_supply_threshold) {
            ...
            emit_migration_pending_event(0x2::object::id<BondingCurve<T0>>(arg0), v9, v7, v8);
        };
        emit_swap_event(0x2::object::id<BondingCurve<T0>>(arg0), v9, true, v5, v6, v7, v8, v0);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Configurator{
            ...
            target_supply_threshold : 3022014870000000000,
            migration_fee           : 0,
    ...
    public fun list<T0>(arg0: &mut Configurator, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: 0x1::option::Option<0x1::ascii::String>, arg5: 0x1::option::Option<0x1::ascii::String>, arg6: 0x1::option::Option<0x1::ascii::String>, arg7: 0x1::option::Option<0x1::ascii::String>, arg8: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        assert_version(arg0);
        ...
        0xd60d9d2a5d7e3551da833168e898f0e2ad7b55bb490b27cb3d6bb450568a9459::freezer::freeze_object<0x2::coin::TreasuryCap<T0>>(arg1, arg8);
        ...
        let v1 = BondingCurve<T0>{
            ...
            sui_balance             : v0,
            token_balance           : 0x2::coin::mint_balance<T0>(&mut arg1, 8036400972000000000),
            virtual_sui_amt         : arg0.virtual_sui_amt,
            target_supply_threshold : arg0.target_supply_threshold,
    ...
    public fun migrate<T0>(arg0: &AdminCap, arg1: &mut BondingCurve<T0>, arg2: &mut Configurator, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        (0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg1.sui_balance), arg3), 0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg1.token_balance), arg3))
    }

    entry fun remove_version(arg0: &mut Configurator, arg1: &AdminCap, arg2: u64) {
    ...
    public fun withdraw_fee(arg0: &AdminCap, arg1: &mut Configurator, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        assert_version(arg1);
        0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg1.fee), arg2)
    }
