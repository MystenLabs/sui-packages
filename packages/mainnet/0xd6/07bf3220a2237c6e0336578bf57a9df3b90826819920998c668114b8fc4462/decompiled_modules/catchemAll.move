module 0xd607bf3220a2237c6e0336578bf57a9df3b90826819920998c668114b8fc4462::catchemAll {
    ...
    public entry fun play_game(arg0: &mut CatchemAll, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = get_hash(0x2::clock::timestamp_ms(arg2));
        let v4 = b"lose";
        let v5 = 0;
        if ((safe_selection(999, &v3) + (*0x1::vector::borrow<u8>(&v2, 0) as u64)) % 2 == 0) {
            v4 = b"win";
            let v6 = v0 * 2;
            ...
            let v8 = v6 - v7;
            v5 = v8;
            0x2::coin::join<0x2::sui::SUI>(&mut arg1, 0x2::coin::take<0x2::sui::SUI>(&mut arg0.bank, v8 - v0, arg3));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, 0x2::tx_context::sender(arg3));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.bank, v7, arg3), arg0.treasury);
        } else {
            if (arg0.fee > 0) {
        ...
        if (0x2::table::contains<address, 0x2::table::Table<u64, History>>(&arg0.history, 0x2::tx_context::sender(arg3))) {
            0x2::table::add<u64, History>(0x2::table::borrow_mut<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg3)), 0x2::table::length<u64, History>(0x2::table::borrow<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg3))) + 1, v9);
        } else {
            let v10 = 0x2::table::new<u64, History>(arg3);
            0x2::table::add<u64, History>(&mut v10, 1, v9);
            0x2::table::add<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg3), v10);
        };
