module 0xd68186e5060dec5aa3ca5bdc1419a427dbf43f17a4d609ded7b1054fa64df94d::drand_based_scratch_card {
    struct Game has key {
        id: 0x2::object::UID,
    ...
    public entry fun create(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Game{
            ...
            game_name        : 0x1::string::utf8(b"twiagle"),
    ...
    public entry fun evaluate(arg0: Ticket, arg1: &Game, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xd68186e5060dec5aa3ca5bdc1419a427dbf43f17a4d609ded7b1054fa64df94d::drand_lib::verify_drand_signature(arg2, end_of_game_round(arg1.base_drand_round));
        let v0 = 0xd68186e5060dec5aa3ca5bdc1419a427dbf43f17a4d609ded7b1054fa64df94d::drand_lib::derive_randomness(arg2);
        let v1 = 0x2::object::id<Ticket>(&arg0);
        let v2 = 0x2::object::id_to_bytes(&v1);
        let v3 = 0x2::hmac::hmac_sha3_256(&v0, &v2);
        if (0xd68186e5060dec5aa3ca5bdc1419a427dbf43f17a4d609ded7b1054fa64df94d::drand_lib::safe_selection(arg1.reward_factor, &v3) == 0) {
            let v4 = Winner{
                id      : 0x2::object::new(arg3),
                game_id : 0x2::object::id<Game>(arg1),
            };
