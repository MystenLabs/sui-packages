module 0xd6a19395d4b0df2e34d89568a7b32d5c4be3b0a24d7240d5a368dd1020ea2281::gift6121 {
    struct GIFT6121 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift6121(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT6121, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6121>(arg0, arg1);
