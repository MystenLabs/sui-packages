module 0xd65dc29f2b162d6244930d10764de9fb9e9b43229d2f36f4bfe028f814317a0d::flp {
    struct FLP has drop {
        dummy_field: bool,
    }
    ...
    public fun deposit<T0>(arg0: &mut FLPApp, arg1: &0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::app::ProtocolApp, arg2: &mut 0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::market::Market<0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::market_type::MainMarket>, arg3: &0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::obligation::ObligationOwnerCap, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ensure_not_stop(arg0);
        let v0 = 0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::obligation::id(arg3);
        ...
        0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::deposit::deposit<0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::market_type::MainMarket, T0>(arg1, arg2, arg3, arg4, arg5, arg6);
        let v6 = &mut arg0.total_amount;
        refresh_obligation_flp_quota<0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::market_type::MainMarket>(v6, arg2, v0, v2);
    ...
    fun calculate_obligation_asset_flp_quota<T0>(arg0: &0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::market::Market<T0>, arg1: &0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::obligation::Obligation<T0>, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: u64) : u64 {
        calculate_new_quota(0x19a53942ca9b7cef4fbc820e0b06ebbf213e4853457ce8b7a5149ebcb4131766::float::floor(0x19a53942ca9b7cef4fbc820e0b06ebbf213e4853457ce8b7a5149ebcb4131766::float::mul_u64(0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::market::exchange_rate<T0>(arg0, arg2), 0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::obligation::ctoken_amount_by_coin<T0>(arg1, arg2))), arg3, arg4)
    }
    ...
    public fun lock_flp(arg0: &AdminCap, arg1: &mut FLPApp, arg2: &0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::market::Market<0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::market_type::MainMarket>, arg3: vector<0x2::object::ID>) {
        ...
        while (v0 < 0x1::vector::length<0x2::object::ID>(&arg3)) {
            ...
            refresh_obligation_flp_quota<0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::market_type::MainMarket>(v3, arg2, v1, v2);
            v0 = v0 + 1;
        };
    }
    ...
    public fun quotas_by_cap(arg0: &FLPApp, arg1: &0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::obligation::ObligationOwnerCap) : (u64, u64) {
        quotas_by_id(arg0, 0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::obligation::id(arg1))
    }
    ...
    fun refresh_obligation_flp_quota<T0>(arg0: &mut FLPAmount, arg1: &0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::market::Market<T0>, arg2: 0x2::object::ID, arg3: &mut ObligationFLP) {
        let v0 = 0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::market::borrow_obligation<T0>(arg1, arg2);
        let v1 = 0x16a08a310237e82b2e8c29ab2a5ff1fbc3cf659bf8dc7b79211bbbac2a4c28e5::obligation::deposit_types<T0>(v0);
        let v2 = 0;
