module 0xd6f2fe3a8b7840d149576e240a1cc9ef09b16e9f0f05afa68d3a1cb92717e76b::pippin {
    struct PIPPIN has drop {
        dummy_field: bool,
    }

    public entry fun burn(arg0: &mut 0x2::coin::TreasuryCap<PIPPIN>, arg1: 0x2::coin::Coin<PIPPIN>) {
        0x2::coin::burn<PIPPIN>(arg0, arg1);
    }

    fun mint_and_transfer(arg0: &mut 0x2::coin::TreasuryCap<PIPPIN>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::mint_and_transfer<PIPPIN>(arg0, arg1, arg2, arg3);
    }
