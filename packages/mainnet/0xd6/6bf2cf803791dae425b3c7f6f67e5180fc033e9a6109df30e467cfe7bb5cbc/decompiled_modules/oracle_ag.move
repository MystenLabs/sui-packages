module 0xd66bf2cf803791dae425b3c7f6f67e5180fc033e9a6109df30e467cfe7bb5cbc::oracle_ag {
    ...
    fun new(arg0: &mut 0x2::tx_context::TxContext) : (OracleAggregator, OracleAggregatorCap) {
        let v0 = OracleAggregator{
            ...
            max_age               : 0xd66bf2cf803791dae425b3c7f6f67e5180fc033e9a6109df30e467cfe7bb5cbc::consts::GET_PYTH_MAX_AGE(),
        };
    ...
    public fun get_price<T0>(arg0: &OracleAggregator, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : (u64, u64, u64) {
        ...
        let (v6, v7) = if (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_is_negative(&v5) == true) {
            (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v4), 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_negative(&v5))
        } else {
            (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v4) * 0x1::u64::pow(10, (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v5) as u8)), 0)
        };
    ...
    public fun assert_oracle_aggregator_cap(arg0: &OracleAggregator, arg1: &OracleAggregatorCap) {
        assert!(0x2::object::id<OracleAggregator>(arg0) == arg1.oracle_aggregator, 9223372200063533055);
    }
    ...
    public fun calc_usd_value<T0>(arg0: &OracleAggregator, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        ...
        0xd66bf2cf803791dae425b3c7f6f67e5180fc033e9a6109df30e467cfe7bb5cbc::math::scale_from_float(0xd66bf2cf803791dae425b3c7f6f67e5180fc033e9a6109df30e467cfe7bb5cbc::math::mul(0xd66bf2cf803791dae425b3c7f6f67e5180fc033e9a6109df30e467cfe7bb5cbc::math::scale_to_float(arg2, (get_coin_decimal<T0>(arg0) as u64)), 0xd66bf2cf803791dae425b3c7f6f67e5180fc033e9a6109df30e467cfe7bb5cbc::math::scale_to_float(v0, v1)), 0xd66bf2cf803791dae425b3c7f6f67e5180fc033e9a6109df30e467cfe7bb5cbc::consts::GET_USDC_DECIMALS())
    }
