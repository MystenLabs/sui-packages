module 0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::policy {
    ...
    struct FeedIdRegistered has copy, drop {
    ...
    public fun migrate_registry(arg0: &mut PolicyRegistry, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 == 0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::version::current(), 5);
    ...
    public fun register_feed_id<T0>(arg0: &mut PolicyRegistry, arg1: &AdminCap, arg2: vector<u8>) {
        ...
        let v1 = 0x2::table::contains<0x1::type_name::TypeName, vector<u8>>(&arg0.feed_ids, v0);
        if (v1) {
        ...
        let v2 = FeedIdRegistered{
            token             : v0,
            feed_id           : arg2,
            replaced_existing : v1,
        };
        0x2::event::emit<FeedIdRegistered>(v2);
    }
