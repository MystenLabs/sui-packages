module 0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::session {
    ...
    public fun authorize(arg0: &mut SessionKey, arg1: &0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::policy::PolicyRegistry, arg2: &0x2::clock::Clock, arg3: vector<PriceFeedInput>, arg4: u64, arg5: u64, arg6: &0x2::tx_context::TxContext) : RebalanceProof {
        0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::version::assert_is_current(0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::policy::version_of(arg1));
        0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::policy::assert_not_revoked(arg1, 0x2::object::id<SessionKey>(arg0));
    ...
    public fun consume_proof(arg0: RebalanceProof) {
        ...
        assert!(v2 >= 0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::math::bps_of_ceil(v1, 10000 - v3), 8);
    ...
    public fun read_price<T0>(arg0: &0x2::coin_registry::Currency<T0>, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock, arg3: &0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::policy::PolicyRegistry) : PriceFeedInput {
        ...
        assert!(0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::policy::expected_feed_id(arg3, v0) == 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v2), 1);
        ...
        let v9 = 0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::math::price_from_pyth(v5, v7, v8);
        let v10 = 0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::math::price_from_pyth(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_conf(&v3), v7, v8);
        let v11 = if (v9 > v10) {
            v9 - v10
        } else {
            0
    ...
    public fun revoke_session_key(arg0: &mut 0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::policy::PolicyRegistry, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == 0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::policy::owner_of(arg0, arg1) || 0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::policy::is_admin(arg0, v0), 10);
        0xd63bf80ce324f15d71dae391f21d79598a7207694707009793cf8ccfa3878757::policy::mark_revoked(arg0, arg1);
