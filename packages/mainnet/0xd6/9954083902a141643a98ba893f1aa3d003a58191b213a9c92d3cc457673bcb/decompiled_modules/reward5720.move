module 0xd69954083902a141643a98ba893f1aa3d003a58191b213a9c92d3cc457673bcb::reward5720 {
    struct REWARD5720 has drop {
        dummy_field: bool,
    }

    struct TICKET_5720 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5720(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5720>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5720>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5720, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5720>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5720>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5720>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5720>>(v5, 0x2::tx_context::sender(arg1));
    }
