module 0xd6e2caf600f138f9e38f897cedba8266ecb82b1d0fe493b3efc00831873cba38::reward3450 {
    struct REWARD3450 has drop {
        dummy_field: bool,
    }

    struct TICKET_3450 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3450(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3450>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3450>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3450, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3450>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3450>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3450>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3450>>(v5, 0x2::tx_context::sender(arg1));
    }
