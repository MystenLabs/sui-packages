module 0xd654f7c1270f673c0ecdaa81c26f2fc8c4b61a5ed1e670647282347ee6f8e5d0::pengis_ {
    struct PENGIS_ has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"dfd8dd37-3628-452d-b423-adae9b6bbbc1"),
        };
    ...
    fun init(arg0: PENGIS_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PENGIS_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(x"50656e676973c2ae"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Every Pengis (unique) boasts a distinct combination of color "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmTAzagDvuXzGf8b4nbBsR64wZr6iKdybfomRj1KWK43F9"));
