module 0x916f631158cdbfdc24e19cefb496c729ba8522fa8aab35c4b4875bef9544d2e5::pawtato_divine_calling {
    ...
    public entry fun create_divine_calling_resource(arg0: &0x916f631158cdbfdc24e19cefb496c729ba8522fa8aab35c4b4875bef9544d2e5::pawtato_quests::QuestAdminCap, arg1: &mut DivineCallingRegistry, arg2: &0x916f631158cdbfdc24e19cefb496c729ba8522fa8aab35c4b4875bef9544d2e5::pawtato_quests::QuestSystem, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: u64, arg10: u64, arg11: 0x1::string::String, arg12: u64, arg13: vector<0x1::string::String>, arg14: vector<u64>, arg15: vector<u64>, arg16: vector<vector<0x1::string::String>>, arg17: vector<u64>, arg18: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0;
        while (v6 < v0) {
            let v7 = ContributionTier{
                tier_index       : (v6 as u8),
                tier_name        : *0x1::vector::borrow<0x1::string::String>(&arg13, v6),
                required_amount  : *0x1::vector::borrow<u64>(&arg14, v6),
                influence_reward : *0x1::vector::borrow<u64>(&arg15, v6),
            };
            0x1::vector::push_back<ContributionTier>(&mut v5, v7);
            v6 = v6 + 1;
        };
        let v8 = 0x1::vector::empty<DivineReward>();
        let v9 = 0;
        while (v9 < v1) {
            let v10 = 0x1::vector::borrow<vector<0x1::string::String>>(&arg16, v9);
            let v11 = DivineReward{
                reward_type     : (0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::string_to_u64(0x1::vector::borrow<0x1::string::String>(v10, 0)) as u8),
                type_identifier : *0x1::vector::borrow<0x1::string::String>(v10, 1),
                amount          : 0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::string_to_u64(0x1::vector::borrow<0x1::string::String>(v10, 2)),
                description     : *0x1::vector::borrow<0x1::string::String>(v10, 3),
            };
            0x1::vector::push_back<DivineReward>(&mut v8, v11);
            v9 = v9 + 1;
        };
        let v12 = DivineCalling{
            id                          : v4,
            name                        : arg3,
            description                 : arg4,
            objective                   : arg5,
        ...
        0x2::table::add<0x2::object::ID, DivineCalling>(&mut arg1.divine_callings, v4, v12);
        0x1::vector::push_back<0x2::object::ID>(&mut arg1.calling_ids, v4);
        0x2::object::delete(v3);
        let v13 = DivineCallingCreated{
            calling_id  : v4,
            name        : arg3,
            goal_type   : 0,
            goal_amount : arg12,
        ...
        0x2::event::emit<DivineCallingCreated>(v13);
    }
