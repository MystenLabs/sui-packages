module 0x916f631158cdbfdc24e19cefb496c729ba8522fa8aab35c4b4875bef9544d2e5::pawtato_quests {
    ...
    public entry fun create_world_quest_with_tiers(arg0: &QuestAdminCap, arg1: &mut QuestSystem, arg2: &mut WorldQuestRegistry, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: u64, arg9: vector<0x1::string::String>, arg10: vector<u64>, arg11: vector<u8>, arg12: vector<u64>, arg13: u64, arg14: vector<0x1::string::String>, arg15: vector<u64>, arg16: vector<vector<0x1::string::String>>, arg17: vector<vector<u64>>, arg18: vector<vector<u8>>, arg19: vector<vector<u64>>, arg20: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::vector::length<0x1::string::String>(&arg14) > 0) {
            ...
            let v7 = 0x1::vector::empty<QuestTier>();
            let v8 = 0;
            while (v8 < 0x1::vector::length<0x1::string::String>(&arg14)) {
                let v9 = 0x1::vector::borrow<vector<0x1::string::String>>(&arg16, v8);
                let v10 = 0x1::vector::borrow<vector<u64>>(&arg17, v8);
                let v11 = 0x1::vector::borrow<vector<u8>>(&arg18, v8);
                let v12 = 0x1::vector::borrow<vector<u64>>(&arg19, v8);
                assert!(0x1::vector::length<0x1::string::String>(v9) == 0x1::vector::length<u64>(v10), 712);
                assert!(0x1::vector::length<u8>(v11) == 0x1::vector::length<u64>(v12), 713);
                let v13 = 0x2::vec_map::empty<0x1::string::String, u64>();
                let v14 = 0;
                while (v14 < 0x1::vector::length<0x1::string::String>(v9)) {
                    0x2::vec_map::insert<0x1::string::String, u64>(&mut v13, *0x1::vector::borrow<0x1::string::String>(v9, v14), *0x1::vector::borrow<u64>(v10, v14));
                    v14 = v14 + 1;
                };
                let v15 = 0x2::vec_map::empty<u8, u64>();
                let v16 = 0;
                while (v16 < 0x1::vector::length<u8>(v11)) {
                    0x2::vec_map::insert<u8, u64>(&mut v15, *0x1::vector::borrow<u8>(v11, v16), *0x1::vector::borrow<u64>(v12, v16));
                    v16 = v16 + 1;
                };
                let v17 = QuestTier{
                    tier_index            : (v8 as u8),
                    tier_name             : *0x1::vector::borrow<0x1::string::String>(&arg14, v8),
                    resource_requirements : v13,
                    tool_requirements     : v15,
                    influence_reward      : *0x1::vector::borrow<u64>(&arg15, v8),
                };
                0x1::vector::push_back<QuestTier>(&mut v7, v17);
                v8 = v8 + 1;
            };
            let v18 = QuestTiersKey{quest_id: v1};
            let v19 = QuestTiers{tiers: v7};
            0x2::dynamic_field::add<QuestTiersKey, QuestTiers>(&mut arg2.id, v18, v19);
        };
        0x2::object::delete(v0);
        let v20 = WorldQuestCreated{
            quest_id         : v1,
            name             : arg3,
            start_time       : arg8,
            end_time         : arg8 + 172800000,
        ...
        0x2::event::emit<WorldQuestCreated>(v20);
    }
    ...
    public entry fun upgrade_version(arg0: &QuestAdminCap, arg1: &mut QuestSystem) {
        assert!(arg1.version < 2, 13906835248085204991);
        arg1.version = 2;
    }
