module 0xd639fc239f1d44f23b1441f4cb2fbc261dc51251a0784973a57859c8a5fffacb::cnsnft9490 {
    struct CNSNFT9490 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9490, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9490>(arg0, arg1);
