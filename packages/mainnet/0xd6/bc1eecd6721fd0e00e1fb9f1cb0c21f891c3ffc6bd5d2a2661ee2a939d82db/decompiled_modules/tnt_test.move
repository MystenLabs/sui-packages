module 0xd6bc1eecd6721fd0e00e1fb9f1cb0c21f891c3ffc6bd5d2a2661ee2a939d82db::tnt_test {
    struct TNT_TEST has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TNT_TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TNT_TEST>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"TNT TEST"));
