module 0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::safu {
    ...
    public fun pre_bid<T0, T1>(arg0: &mut 0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::Version, arg1: &mut Registry, arg2: u64, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg5: 0x2::balance::Balance<T0>, arg6: 0x2::balance::Balance<T1>, arg7: bool, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u128, arg14: u128, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let v5 = calculate_bid_value(arg8, arg9, arg10, arg12, calculate_bid_size(arg8, arg10, arg12, ((((v4 + 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::calculated_swap_result_amount_out(&v3)) as u128) * (*0x1::vector::borrow<u64>(&v0.info, 4) as u128) / (10000 as u128)) as u64), arg11));
        let (v6, v7) = if (arg7) {
    ...
    public fun withdraw_suilend<T0>(arg0: &0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        *0x1::vector::borrow_mut<u64>(&mut v0.info, 4) = 0;
        ...
        if (v4 < v5) {
            0x2::balance::join<T0>(&mut v3, 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::ascii::string(b"mist_balance")), 1));
        };
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::ascii::string(b"deposit_balance")), 0x2::balance::split<T0>(&mut v3, v5));
        if (0x2::balance::value<T0>(&v3) > 0 && 0x2::balance::value<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::ascii::string(b"mist_balance"))) == 0) {
            0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::ascii::string(b"mist_balance")), 0x2::balance::split<T0>(&mut v3, 1));
        };
        let v6 = 0x1::vector::empty<u64>();
        let v7 = &mut v6;
        0x1::vector::push_back<u64>(v7, arg2);
