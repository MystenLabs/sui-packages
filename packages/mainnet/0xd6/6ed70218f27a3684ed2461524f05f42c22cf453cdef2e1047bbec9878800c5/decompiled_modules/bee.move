module 0xd66ed70218f27a3684ed2461524f05f42c22cf453cdef2e1047bbec9878800c5::bee {
    struct BEE has drop {
        dummy_field: bool,
    }
    ...
    public fun get_total_bee_Supply() : u64 {
        0xd66ed70218f27a3684ed2461524f05f42c22cf453cdef2e1047bbec9878800c5::constants::total_bee_supply()
    }
    ...
    public fun set_rules<T0>(arg0: &mut 0x2::token::TokenPolicy<T0>, arg1: &0x2::token::TokenPolicyCap<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xd66ed70218f27a3684ed2461524f05f42c22cf453cdef2e1047bbec9878800c5::constants::bee_burn_pct();
