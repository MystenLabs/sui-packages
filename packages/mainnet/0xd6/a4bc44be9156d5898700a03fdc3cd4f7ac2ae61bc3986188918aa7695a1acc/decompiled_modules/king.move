module 0xd6a4bc44be9156d5898700a03fdc3cd4f7ac2ae61bc3986188918aa7695a1acc::king {
    ...
    fun init(arg0: KING, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<KING>(arg0, 9, 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"KING    ")))), trim_right(b"KING                            "), trim_right(b"An amalgamation of the wisdom charisma and strength of legendary kings like Cyrus the Great Xerxes and fused with the grandeur of Shahnameh of Ferdowsi                                                                                                                                                                         "), v1, arg1);
        let v4 = v2;
