module 0x83d2c0f45cfd338fbb6c867ce317d52b274c5526c3168f48acf4ce603b74bfad::alphafi_lyf_investor {
    ...
    public(friend) fun autocompound<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::return_bluefin_lp_collateral<T0, T1>(arg2, &arg0.position_cap, arg4, v2, v1, arg5, arg6);
    ...
    public fun rebalance_debts<T0, T1>(arg0: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::AdminCap, arg1: &0x83d2c0f45cfd338fbb6c867ce317d52b274c5526c3168f48acf4ce603b74bfad::version::Version, arg2: &mut Investor<T0, T1>, arg3: u64, arg4: bool, arg5: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg6: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg7: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg8: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        0x83d2c0f45cfd338fbb6c867ce317d52b274c5526c3168f48acf4ce603b74bfad::version::assert_current_version(arg1);
        assert!(arg3 >= arg2.minimum_swap_amount, 13906839165095378943);
        ...
        if (arg4) {
            ...
            let v7 = v5;
            assert!(0x2::balance::value<T0>(&v7) == 0, 13906839199455117311);
            ...
            let v14 = v13;
            assert!(0x2::balance::value<T1>(&v14) == 0, 13906839242404790271);
    ...
    public(friend) fun withdraw_and_repay<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: u64, arg2: u64, arg3: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (v11 > 0) {
            ...
            if (v11 > arg0.minimum_swap_amount) {
                ...
                let v15 = v13;
                assert!(0x2::balance::value<T0>(&v15) == 0, 13906838838677864447);
                ...
                assert!(0x2::coin::value<T1>(&v16) == 0, 13906838851562766335);
            ...
            if (v12 > arg0.minimum_swap_amount) {
                ...
                let v19 = v18;
                assert!(0x2::balance::value<T1>(&v19) == 0, 13906838898807406591);
                ...
                assert!(0x2::coin::value<T0>(&v20) == 0, 13906838911692308479);
