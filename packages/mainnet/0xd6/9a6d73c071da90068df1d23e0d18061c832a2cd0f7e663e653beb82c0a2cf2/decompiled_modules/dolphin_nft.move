module 0xd69a6d73c071da90068df1d23e0d18061c832a2cd0f7e663e653beb82c0a2cf2::dolphin_nft {
    ...
    entry fun adjust_price<T0>(arg0: &mut GlobalConfig<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.manager == 0x2::tx_context::sender(arg2), 2);
        arg0.price = arg1;
    }
    ...
    entry fun change_manager<T0>(arg0: &mut GlobalConfig<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.manager == 0x2::tx_context::sender(arg2), 2);
        arg0.manager = arg1;
    }
    ...
    entry fun create_nft_config<T0>(arg0: &AdminCapability, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1, 0x1::string::utf8(b"rarity"), 0x1::string::utf8(b"Genesis"));
    ...
    fun mint<T0>(arg0: &0x2::random::Random, arg1: &mut GlobalConfig<T0>, arg2: &mut 0x2::tx_context::TxContext) : NFT {
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v5, 0x1::string::utf8(b"rarity"), 0x1::string::utf8(v4));
        let v6 = NFT{
            id         : 0x2::object::new(arg2),
            url        : v0,
            attributes : v5,
