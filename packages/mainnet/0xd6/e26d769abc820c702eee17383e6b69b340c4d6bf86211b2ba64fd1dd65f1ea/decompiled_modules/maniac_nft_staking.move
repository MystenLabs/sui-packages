module 0xd6e26d769abc820c702eee17383e6b69b340c4d6bf86211b2ba64fd1dd65f1ea::maniac_nft_staking {
    ...
    public fun stake(arg0: &StakingControl, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let (v0, v1) = 0x2::kiosk::purchase<0x28bb239a115e60925353a635c5c7e1d85a4e7435d5da3e7afafec5b417059c8d::maniac_nfts::ManiacNft>(arg1, arg3, 0x2::coin::zero<0x2::sui::SUI>(arg6));
        let v2 = v0;
    ...
    public fun unstake(arg0: &StakingControl, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<0x28bb239a115e60925353a635c5c7e1d85a4e7435d5da3e7afafec5b417059c8d::maniac_nfts::ManiacNft>, arg4: &0x2::clock::Clock, arg5: ManiacNftStaked) {
