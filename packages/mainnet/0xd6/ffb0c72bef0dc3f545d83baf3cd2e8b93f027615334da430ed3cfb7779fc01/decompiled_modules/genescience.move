module 0xd6ffb0c72bef0dc3f545d83baf3cd2e8b93f027615334da430ed3cfb7779fc01::genescience {
    public fun breed_genes(arg0: u256, arg1: u256, arg2: u256, arg3: u256) : u256 {
        0 | slice_number(arg0, 1, 0) | mix_appearance_traits(arg0, arg1, arg2) | mix_power_traits(arg0, arg1, arg3)
    }
    ...
    public fun compute_gene_price(arg0: u64, arg1: u64, arg2: u64) : u64 {
    ...
    public fun decode_appearance_traits(arg0: u256) : vector<u8> {
        ...
        let v1 = 0;
        while (v1 < 28) {
            0x1::vector::push_back<u8>(&mut v0, (slice_number(arg0, 5, 4 + v1 * 5) as u8));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun decode_dominant_appearance_traits(arg0: u256) : vector<u8> {
        ...
        let v1 = 0;
        while (v1 < 7) {
            0x1::vector::push_back<u8>(&mut v0, (slice_number(arg0, 5, 4 + v1 * 20) as u8));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun decode_dominant_power_traits(arg0: u256) : vector<u8> {
        ...
        let v1 = 0;
        while (v1 < 4) {
            0x1::vector::push_back<u8>(&mut v0, (slice_number(arg0, 4, 144 + v1 * 16) as u8));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun decode_power_traits(arg0: u256) : vector<u8> {
        ...
        let v1 = 0;
        while (v1 < 16) {
            0x1::vector::push_back<u8>(&mut v0, (slice_number(arg0, 4, 144 + v1 * 4) as u8));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun encode_appearance_traits(arg0: vector<u8>) : u256 {
        ...
        let v1 = 0;
        while (v1 < 28) {
            v0 = v0 | (*0x1::vector::borrow<u8>(&arg0, (v1 as u64)) as u256) << 4 + v1 * 5;
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun encode_power_traits(arg0: vector<u8>) : u256 {
        ...
        let v1 = 0;
        while (v1 < 16) {
            v0 = v0 | (*0x1::vector::borrow<u8>(&arg0, (v1 as u64)) as u256) << 144 + v1 * 4;
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun evolve_genes(arg0: u256, arg1: vector<u256>) : u256 {
        let v0 = (0xd6ffb0c72bef0dc3f545d83baf3cd2e8b93f027615334da430ed3cfb7779fc01::math::min_u64(((get_evolution_stage(arg0) + 1) as u64), ((5 - 1) as u64)) as u8);
        evolve_power_traits(evolve_appearance_traits(arg0 & 115792089237316195423570985008687907853269984665640564039457584007913129639935 - ((1 << 3) - 1 << 1) | (v0 as u256) << 1, v0, &arg1), v0, &arg1)
    }
    ...
    public fun generate_genesis_genes(arg0: vector<u8>, arg1: u64, arg2: u8) : u256 {
        let v0 = 0x2::hash::blake2b256(&arg0);
        let v1 = 0 | (arg2 as u256) & 1;
        let v2 = if (arg1 >= 2) {
            arg1 - 2
        } else {
            0
        ...
        let v3 = 0;
        while (v3 < 28) {
            v1 = v1 | (0xd6ffb0c72bef0dc3f545d83baf3cd2e8b93f027615334da430ed3cfb7779fc01::math::min_u64(v2 + (*0x1::vector::borrow<u8>(&v0, v3 * 3 % 32) as u64) % (3 + arg1 - v2 + 1), 31) as u256) << 4 + (v3 as u8) * 5;
            v3 = v3 + 1;
        };
        v1
    }
    ...
    public fun get_evolution_stage(arg0: u256) : u8 {
        (slice_number(arg0, 3, 1) as u8)
    }

    public fun get_faction(arg0: u256) : u8 {
        (slice_number(arg0, 1, 0) as u8)
    }

    public fun is_bear(arg0: u256) : bool {
        get_faction(arg0) == 1
    }

    public fun is_bull(arg0: u256) : bool {
        get_faction(arg0) == 0
    }
    ...
    public fun mix_appearance_traits(arg0: u256, arg1: u256, arg2: u256) : u256 {
        ...
        while (v2 < 28) {
            let v3 = 4 + v2 * 5;
            let v4 = (slice_number(arg2, 2, v1) as u8);
            let v5 = v1 + 2;
            let v6 = if (v4 == 0) {
                if (slice_number(arg2, 1, v5) == 0) {
                    (slice_number(arg0, 5, v3) as u8)
                } else {
                    (slice_number(arg1, 5, v3) as u8)
                }
            } else if (v4 == 1) {
                (((((slice_number(arg0, 5, v3) as u8) as u64) + ((slice_number(arg1, 5, v3) as u8) as u64)) / 2) as u8)
            } else if (v4 == 2) {
                enhance_trait((slice_number(arg0, 5, v3) as u8), (slice_number(arg1, 5, v3) as u8), (slice_number(arg2, 4, v5) as u8))
            } else {
                mutate_trait(0x1::u8::max((slice_number(arg0, 5, v3) as u8), (slice_number(arg1, 5, v3) as u8)), (slice_number(arg2, 4, v5) as u8))
            };
            v1 = v5 + 2;
            v0 = v0 | (v6 as u256) << v3;
            v2 = v2 + 1;
    ...
    public fun mix_power_traits(arg0: u256, arg1: u256, arg2: u256) : u256 {
        let v0 = 0;
        let v1 = 0;
        let v2 = 0;
        while (v2 < 16) {
            ...
            let v5 = v1 + 2;
            let v6 = if (v4 == 0) {
                0x1::u8::max((slice_number(arg0, 4, v3) as u8), (slice_number(arg1, 4, v3) as u8))
            } else if (v4 == 1) {
                enhance_trait((slice_number(arg0, 4, v3) as u8), (slice_number(arg1, 4, v3) as u8), (slice_number(arg2, 4, v5) as u8))
            } else {
                synergy_boost((slice_number(arg0, 4, v3) as u8), (slice_number(arg1, 4, v3) as u8), (slice_number(arg2, 4, v5) as u8))
            };
            v1 = v5 + 2;
            v0 = v0 | (v6 as u256) << v3;
            v2 = v2 + 1;
