module 0xd6641c200edb589651b12223dbc79dcbb15af0322fbd1b9a44e8b29ff3883afb::project_config {
    ...
    struct ProjectConfig has store, key {
        id: 0x2::object::UID,
        admin: 0xd6641c200edb589651b12223dbc79dcbb15af0322fbd1b9a44e8b29ff3883afb::admin::AdminConfig,
    ...
    public entry fun add_collection(arg0: &mut ProjectConfig, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        let (v0, v1) = deep(arg0);
        assert!(0x2::tx_context::sender(arg2) == 0xd6641c200edb589651b12223dbc79dcbb15af0322fbd1b9a44e8b29ff3883afb::admin::get_owner(v0), 1);
    ...
    public entry fun add_item_to_collection(arg0: &mut ProjectConfig, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = deep(arg0);
        assert!(0x2::tx_context::sender(arg3) == 0xd6641c200edb589651b12223dbc79dcbb15af0322fbd1b9a44e8b29ff3883afb::admin::get_owner(v0), 1);
    ...
    public fun deep(arg0: &mut ProjectConfig) : (&mut 0xd6641c200edb589651b12223dbc79dcbb15af0322fbd1b9a44e8b29ff3883afb::admin::AdminConfig, &mut WhitelistedCollections) {
        (&mut arg0.admin, &mut arg0.collections)
    }

    public fun deep_immutable(arg0: &ProjectConfig) : (&0xd6641c200edb589651b12223dbc79dcbb15af0322fbd1b9a44e8b29ff3883afb::admin::AdminConfig, &WhitelistedCollections) {
    ...
    public entry fun initialize(arg0: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0xd6641c200edb589651b12223dbc79dcbb15af0322fbd1b9a44e8b29ff3883afb::admin::init_(arg0);
        let v1 = WhitelistedCollections{
            id          : 0x2::object::new(arg0),
            admin_id    : 0x2::object::id<0xd6641c200edb589651b12223dbc79dcbb15af0322fbd1b9a44e8b29ff3883afb::admin::AdminConfig>(&v0),
