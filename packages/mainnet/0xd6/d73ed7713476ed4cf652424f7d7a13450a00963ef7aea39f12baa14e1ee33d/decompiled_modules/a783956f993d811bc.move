module 0xd6d73ed7713476ed4cf652424f7d7a13450a00963ef7aea39f12baa14e1ee33d::a783956f993d811bc {
    ...
    public fun a1d4036cdf86e784c(arg0: &A0ea878587b719a64, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.a1cf5727aac3dee05 == 0x2::tx_context::sender(arg1), 13906834741279064063);
    }
    ...
    public fun abc3ae4f61d07f772(arg0: &mut 0x2::tx_context::TxContext) : A0ea878587b719a64 {
        ...
        v0.a92e57031b4ab16ae.a2d5cf79ee424b824 = true;
        v0
    }
