module 0xd64b6376bea6401bfb1669a12f7bf34a6d69392a9b48aa819ac8b5ada246619e::presale {
    ...
    public entry fun buy_tokens<T0>(arg0: &mut Presale<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun claim_tokens<T0>(arg0: &mut Presale<T0>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun create_presale<T0>(arg0: 0x2::coin::Coin<T0>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun set_claims_enabled<T0>(arg0: &mut Presale<T0>, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun set_presale_active<T0>(arg0: &mut Presale<T0>, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 4);
        arg0.is_active = arg1;
    ...
    public entry fun withdraw_remaining_tokens<T0>(arg0: &mut Presale<T0>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun withdraw_sui<T0>(arg0: &mut Presale<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 4);
        assert!(!arg0.is_active, 5);
