module 0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::vault {
    ...
    struct Treasury has key {
        id: 0x2::object::UID,
        rewardsTreasury: 0x2::balance::Balance<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>,
    ...
    public entry fun deposit(arg0: 0x2::coin::Coin<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>, arg1: &mut Treasury, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::balance::join<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>(&mut arg1.stakedCoinsTreasury, 0x2::coin::into_balance<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>(arg0));
    }
    ...
    public entry fun getReward(arg0: &mut UserState, arg1: &mut RewardState, arg2: &mut Treasury, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        *v1 = 0;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>>(0x2::coin::take<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>(&mut arg2.rewardsTreasury, *v1, arg4), 0x2::tx_context::sender(arg4));
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Treasury{
            id                  : 0x2::object::new(arg0),
            rewardsTreasury     : 0x2::balance::zero<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>(),
    ...
    public entry fun setRewardAmount(arg0: &AdminCap, arg1: 0x2::coin::Coin<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>, arg2: &mut UserState, arg3: &mut RewardState, arg4: &mut Treasury, arg5: &0x2::clock::Clock) {
        let v0 = 0x2::coin::value<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>(&arg1);
        ...
        0x2::balance::join<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>(&mut arg4.rewardsTreasury, 0x2::coin::into_balance<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>(arg1));
        ...
        assert!(arg3.rewardRate * arg3.duration <= 0x2::balance::value<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>(&arg4.rewardsTreasury), 103);
    ...
    public entry fun stake(arg0: 0x2::coin::Coin<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>, arg1: u64, arg2: &mut UserState, arg3: &mut RewardState, arg4: &mut Treasury, arg5: &mut 0x2::coin::TreasuryCap<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        let v1 = 0x2::balance::value<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>(&arg4.stakedCoinsTreasury);
        if (!0x2::vec_map::contains<address, u64>(&arg2.stakeTimestamp, &v0)) {
            0x2::vec_map::insert<address, u64>(&mut arg2.stakeTimestamp, v0, 0x2::clock::timestamp_ms(arg6));
        };
        assert!(arg1 >= 1000000000, 9999);
        assert!(0x2::coin::value<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>(&arg0) >= arg1, 10001);
        0x2::balance::join<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>(&mut arg4.stakedCoinsTreasury, 0x2::coin::into_balance<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>(0x2::coin::split<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>(&mut arg0, arg1, arg7)));
        assert!(v1 + arg1 > 0, 999);
        let v2 = 2;
        let v3 = 1000 * 0x2::math::pow(arg3.totalSTPOP + arg1, v2) / 0x2::math::pow(v1 + arg1, v2);
        arg3.totalSTPOP = arg3.totalSTPOP + v3;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>>(0x2::coin::mint<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>(arg5, v3, arg7), v0);
        if (!0x2::vec_map::contains<address, u64>(&arg2.balanceOf, &v0)) {
            0x2::vec_map::insert<address, u64>(&mut arg2.balanceOf, v0, 0);
        };
        let v4 = 0x2::vec_map::get_mut<address, u64>(&mut arg2.balanceOf, &v0);
        *v4 = *v4 + arg1;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>>(arg0, v0);
        let v5 = Staked{
            user   : v0,
            amount : arg1,
        };
    ...
    public entry fun withdraw(arg0: &mut UserState, arg1: &mut RewardState, arg2: &mut Treasury, arg3: &mut 0x2::coin::TreasuryCap<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::burn<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>(arg3, 0x2::coin::take<0xd6e8c02a25c57beade1262e7253a866dc723df68a8c3d17447517bc3a29fe833::stpop::STPOP>(&mut arg2.rewardsTreasury, v11, arg6));
