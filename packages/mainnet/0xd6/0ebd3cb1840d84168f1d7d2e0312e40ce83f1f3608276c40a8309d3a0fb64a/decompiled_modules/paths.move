module 0xd60ebd3cb1840d84168f1d7d2e0312e40ce83f1f3608276c40a8309d3a0fb64a::paths {
        ...
        while (v1 < 0x1::vector::length<PriceNode>(arg1)) {
            ...
            if (v4 > 0) {
                ...
                while (v5 < v4) {
                    ...
                    let v8 = 0xd60ebd3cb1840d84168f1d7d2e0312e40ce83f1f3608276c40a8309d3a0fb64a::arithmetic::mul_128(0x1::vector::borrow<Route>(&v3, v5).sqrtPrice, v2.sqrtPrice);
                    if (v8 > v7 || v6 < arg2) {
