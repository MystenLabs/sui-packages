module 0xd65d90c665469869e61794acce8f4956f0b15b48e0d1c0e4207f693689b2b4e4::reward3529 {
    struct REWARD3529 has drop {
        dummy_field: bool,
    }

    struct TICKET_3529 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3529(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3529>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3529>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3529, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3529>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3529>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3529>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3529>>(v5, 0x2::tx_context::sender(arg1));
    }
