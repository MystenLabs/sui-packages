module 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault {
    ...
    public fun claim<T0, T1>(arg0: &mut UserShareRegistry, arg1: &mut DepositVault<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v5, arg2), @0xba70693c0c721629cdd2ca7dfa5615d96b76d6c8f9727890291c46dbec0e18c);
        let v8 = Claim<T0, T1>{
            signer           : v0,
            user_amount      : v6,
            claim_fee_amount : v7,
    ...
    fun deposit_<T0>(arg0: &mut UserShareRegistry, arg1: &mut SubVault<T0>, arg2: 0x2::balance::Balance<T0>, arg3: address) : u64 {
        let v0 = if (arg1.share_supply > 0) {
            (((0x2::balance::value<T0>(&arg2) as u128) * (0x2::balance::value<T0>(&arg1.balance) as u128) / (arg1.share_supply as u128)) as u64)
        } else {
    ...
    fun deposit_front_<T0>(arg0: &mut UserShareRegistry, arg1: &mut SubVault<T0>, arg2: 0x2::balance::Balance<T0>, arg3: address) {
        ...
        0x2::balance::join<T0>(&mut arg1.balance, arg2);
        add_share_front<T0>(arg0, arg1, arg3, v0);
    }
    ...
    public fun refund<T0, T1>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut DepositVault<T0, T1>, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        let v0 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::last<UserShareKey, u64>(&arg2.deactivating_sub_vault.user_shares);
        while (arg3 > 0 && 0x1::option::is_some<UserShareKey>(&v0)) {
            let v1 = *0x1::option::borrow<UserShareKey>(&v0);
            v0 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::prev<UserShareKey, u64>(&arg1.id, &arg2.deactivating_sub_vault.user_shares, v1);
            let v2 = *0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::borrow<UserShareKey, u64>(&arg1.id, &arg2.deactivating_sub_vault.user_shares, v1);
            if (v2 <= arg3) {
                let v3 = &mut arg2.deactivating_sub_vault;
                let (_, v5) = withdraw_<T1>(arg1, v3, 0x1::option::none<u64>(), v1.user);
                let v6 = &mut arg2.inactive_sub_vault;
                deposit_<T1>(arg1, v6, v5, v1.user);
                arg3 = arg3 - v2;
                continue
            };
            let v7 = &mut arg2.deactivating_sub_vault;
            let (_, v9) = withdraw_<T1>(arg1, v7, 0x1::option::some<u64>(arg3), v1.user);
            let v10 = &mut arg2.inactive_sub_vault;
            deposit_<T1>(arg1, v10, v9, v1.user);
            arg3 = 0;
        };
        let v11 = arg3 - arg3;
        let v12 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::last<UserShareKey, u64>(&arg2.active_sub_vault.user_shares);
        while (arg3 > 0 && 0x1::option::is_some<UserShareKey>(&v12)) {
            let v13 = *0x1::option::borrow<UserShareKey>(&v12);
            v12 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::prev<UserShareKey, u64>(&arg1.id, &arg2.active_sub_vault.user_shares, v13);
            let v14 = *0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::borrow<UserShareKey, u64>(&arg1.id, &arg2.active_sub_vault.user_shares, v13);
            let v15 = if (v14 <= arg3) {
                let v16 = &mut arg2.active_sub_vault;
                let (_, v18) = withdraw_<T1>(arg1, v16, 0x1::option::none<u64>(), v13.user);
                arg3 = arg3 - v14;
                v18
            } else {
                let v19 = &mut arg2.active_sub_vault;
                let (_, v21) = withdraw_<T1>(arg1, v19, 0x1::option::some<u64>(arg3), v13.user);
                arg3 = 0;
                v21
            };
            if (arg2.has_next) {
                let v22 = &mut arg2.warmup_sub_vault;
                deposit_front_<T1>(arg1, v22, v15, v13.user);
                continue
            };
            let v23 = &mut arg2.inactive_sub_vault;
            deposit_<T1>(arg1, v23, v15, v13.user);
        };
        let v24 = Refund<T0, T1>{
            signer       : 0x2::tx_context::sender(arg4),
            amount       : arg3,
            deactivating : v11,
            active       : arg3 - v11,
        };
        0x2::event::emit<Refund<T0, T1>>(v24);
    }
    ...
    public fun settle_fund<T0, T1, T2, T3>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut UserShareRegistry, arg3: &mut DepositVault<T0, T1>, arg4: &mut BidVault<T0, T2>, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (v1 != 0) {
            let v2 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg8);
            if (arg7 > v2) {
                let v3 = if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T1, T2>()) {
                    (((v1 as u128) * ((arg7 - v2) as u128) / (v2 as u128)) as u64)
                } else if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T1, T3>()) {
                    (((arg9 as u128) * ((((v1 as u128) * ((arg7 - v2) as u128) / (v2 as u128)) as u64) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg10) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg6) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg5) as u128)) as u64)
                } else {
                    (((0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg10) as u128) * ((((v1 as u128) * ((arg7 - v2) as u128) / (v2 as u128)) as u64) as u128) / (arg9 as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg6) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg5) as u128)) as u64)
                };
                let v4 = v3 * 1000 / 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4);
                v0 = v4;
                if (v4 != 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut arg4.performance_fee_sub_vault.balance, v4), arg11), @0xba70693c0c721629cdd2ca7dfa5615d96b76d6c8f9727890291c46dbec0e18c);
                };
            } else if (arg7 < v2) {
                let v5 = active_share_supply<T0, T1>(arg3) + deactivating_share_supply<T0, T1>(arg3);
                let v6 = (v1 as u256) * ((v2 - arg7) as u256) / (v2 as u256);
                let v7 = 0x2::balance::split<T1>(&mut arg3.active_sub_vault.balance, ((v6 * (arg3.active_sub_vault.share_supply as u256) / (v5 as u256)) as u64));
                let v8 = &mut arg3.active_sub_vault;
                adjust_user_share_ratio<T1>(arg1, v8);
                let v9 = &mut arg3.deactivating_sub_vault;
                adjust_user_share_ratio<T1>(arg1, v9);
                0x2::balance::join<T1>(&mut v7, 0x2::balance::split<T1>(&mut arg3.deactivating_sub_vault.balance, ((v6 * (arg3.deactivating_sub_vault.share_supply as u256) / (v5 as u256)) as u64)));
                while (!0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::is_empty<UserShareKey, u64>(&arg4.bidder_sub_vault.user_shares)) {
                    let (v10, v11) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::pop_front<UserShareKey, u64>(&mut arg2.id, &mut arg4.bidder_sub_vault.user_shares);
                    let v12 = v10;
                    0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v7, (((0x2::balance::value<T1>(&v7) as u128) * (v11 as u128) / (arg4.bidder_sub_vault.share_supply as u128)) as u64)), arg11), v12.user);
                    arg4.bidder_sub_vault.share_supply = arg4.bidder_sub_vault.share_supply - v11;
                };
                0x2::balance::destroy_zero<T1>(v7);
            };
            if (0x2::balance::value<T2>(&arg4.performance_fee_sub_vault.balance) > 0) {
                let v13 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::first<UserShareKey, u64>(&arg4.performance_fee_sub_vault.user_shares);
                while (0x1::option::is_some<UserShareKey>(&v13)) {
                    let v14 = *0x1::option::borrow<UserShareKey>(&v13);
                    v13 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::next<UserShareKey, u64>(&arg2.id, &arg4.performance_fee_sub_vault.user_shares, v14);
                    let v15 = &mut arg4.performance_fee_sub_vault;
                    let (_, v17) = withdraw_<T2>(arg2, v15, 0x1::option::none<u64>(), v14.user);
                    let v18 = &mut arg4.premium_sub_vault;
                    deposit_<T2>(arg2, v18, v17, v14.user);
                };
            };
            let v19 = &mut arg3.deactivating_sub_vault;
            let v20 = &mut arg3.inactive_sub_vault;
            rock_n_roll<T1>(arg1, v19, v20);
        ...
        0x2::event::emit<Settle<T0, T2>>(v23);
        v0
    }
    ...
    public fun settle_fund_multiple<T0, T1, T2, T3>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut UserShareRegistry, arg3: &mut UserShareRegistry, arg4: &mut DepositVault<T0, T1>, arg5: &mut DepositVault<T0, T2>, arg6: &mut BidVault<T0, T3>, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: &mut 0x2::tx_context::TxContext) : (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::i64::I64, u64) {
        ...
        if (v12 != 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T3>>(0x2::coin::from_balance<T3>(0x2::balance::split<T3>(&mut arg6.performance_fee_sub_vault.balance, v12), arg16), @0xba70693c0c721629cdd2ca7dfa5615d96b76d6c8f9727890291c46dbec0e18c);
        };
        if (v0 != 0 && v1 != 0) {
            if (arg10 < v2) {
