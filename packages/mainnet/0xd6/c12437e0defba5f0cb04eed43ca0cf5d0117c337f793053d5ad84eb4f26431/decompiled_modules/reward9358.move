module 0xd6c12437e0defba5f0cb04eed43ca0cf5d0117c337f793053d5ad84eb4f26431::reward9358 {
    struct REWARD9358 has drop {
        dummy_field: bool,
    }

    struct TICKET_9358 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9358(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9358>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9358>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9358, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9358>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9358>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9358>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9358>>(v5, 0x2::tx_context::sender(arg1));
    }
