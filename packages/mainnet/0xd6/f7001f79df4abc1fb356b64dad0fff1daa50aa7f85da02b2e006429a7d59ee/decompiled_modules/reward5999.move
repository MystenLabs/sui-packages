module 0xd6f7001f79df4abc1fb356b64dad0fff1daa50aa7f85da02b2e006429a7d59ee::reward5999 {
    struct REWARD5999 has drop {
        dummy_field: bool,
    }

    struct TICKET_5999 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5999(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5999>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5999>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5999, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5999>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5999>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5999>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5999>>(v5, 0x2::tx_context::sender(arg1));
    }
