module 0xd6b780b1bcfa2c68f9772c95bb422afbe14a79987cf7b7b5804580c57890c59d::ecdsa {
    ...
    public fun secp256k1_verify(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>) {
        let v0 = VerifiedEvent{is_verified: 0x2::ecdsa_k1::secp256k1_verify(&arg0, &arg1, &arg2, 0)};
        0x2::event::emit<VerifiedEvent>(v0);
    }

    public fun keccak256(arg0: vector<u8>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Output{
    ...
    public fun ecrecover(arg0: vector<u8>, arg1: vector<u8>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Output{
