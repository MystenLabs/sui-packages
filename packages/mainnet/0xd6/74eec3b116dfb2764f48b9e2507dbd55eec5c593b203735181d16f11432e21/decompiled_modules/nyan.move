module 0xd674eec3b116dfb2764f48b9e2507dbd55eec5c593b203735181d16f11432e21::nyan {
    struct NYAN has drop {
        dummy_field: bool,
    }

    fun init(arg0: NYAN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<NYAN>(arg0, 6, b"NYAN", b"NYAN CAT", b"NYAN CAT OFFICIAL TWITTER! `.,,.*`.(=^^) #NyanCat | http://nyan.cat | NOT doing crypto coins | prguitarman1@gmail.com", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/6e2jwf7ztbr5t1yjq4c5_400x400_339ebda3e1.jpeg")), arg1);
