module 0xd6b807be3d5cd835c93462ba32b0f1c8161f9538d611d8f2923b7902e00f409c::cnsnft4516 {
    struct CNSNFT4516 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4516, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4516>(arg0, arg1);
