module 0xd68908cc1816c6dd9c82066c16cc2784848ab2ab3a9c3ef598f11c1507f47c82::wormhole_transceiver_info {
    struct WormholeTransceiverInfo has drop {
        ...
        manager_mode: 0xf714b0d291f3460f2de5ae8139827b9356932858ffd400538d045023471e2139::mode::Mode,
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : WormholeTransceiverInfo {
        assert!(0x5400c4e9bdbb6810d72dd9e7a080f09cd03dbc3f557906e039dd24bd5a69dcb3::bytes4::to_bytes(0x5400c4e9bdbb6810d72dd9e7a080f09cd03dbc3f557906e039dd24bd5a69dcb3::bytes4::take(arg0)) == x"9c23bd3b", 13906834367616974850);
        WormholeTransceiverInfo{
            ...
            manager_mode    : 0xf714b0d291f3460f2de5ae8139827b9356932858ffd400538d045023471e2139::mode::parse(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_bytes(arg0, 1)),
    ...
    public fun to_bytes(arg0: &WormholeTransceiverInfo) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0xf714b0d291f3460f2de5ae8139827b9356932858ffd400538d045023471e2139::mode::serialize(arg0.manager_mode));
