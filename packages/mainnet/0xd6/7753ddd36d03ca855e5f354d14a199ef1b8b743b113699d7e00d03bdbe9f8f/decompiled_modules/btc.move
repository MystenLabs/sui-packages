module 0xd67753ddd36d03ca855e5f354d14a199ef1b8b743b113699d7e00d03bdbe9f8f::btc {
    struct BTC has drop {
        dummy_field: bool,
    }
    ...
    public entry fun transfer(arg0: 0x2::coin::Coin<BTC>, arg1: address) {
        0x2::transfer::public_transfer<0x2::coin::Coin<BTC>>(arg0, arg1);
    }

    fun init(arg0: BTC, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BTC>(arg0, 9, b"BTC", b"Bitcoin", b"This is a test bitcoin on Sui Network mainnet", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"you can write anything here for your logo url")), arg1);
        let v2 = v0;
        let v3 = 0x2::tx_context::sender(arg1);
        0x2::coin::mint_and_transfer<BTC>(&mut v2, 10000000000000, v3, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<BTC>>(v2, v3);
