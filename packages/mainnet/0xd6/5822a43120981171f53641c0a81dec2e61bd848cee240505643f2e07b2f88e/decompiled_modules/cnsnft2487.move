module 0xd65822a43120981171f53641c0a81dec2e61bd848cee240505643f2e07b2f88e::cnsnft2487 {
    struct CNSNFT2487 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2487, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2487>(arg0, arg1);
