module 0xd6d0ca93db9a4fdf968d028db6a261eee511c79ef6850567f16c00718acace9b::cnsnft1602 {
    struct CNSNFT1602 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1602, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1602>(arg0, arg1);
