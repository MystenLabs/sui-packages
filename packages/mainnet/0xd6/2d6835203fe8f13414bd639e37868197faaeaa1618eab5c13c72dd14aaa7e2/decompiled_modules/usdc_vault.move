module 0xd62d6835203fe8f13414bd639e37868197faaeaa1618eab5c13c72dd14aaa7e2::usdc_vault {
    ...
    fun validate_vault_invariants<T0, T1>(arg0: &Vault<T0, T1>) {
        ...
        let v0 = 0x2::coin::total_supply<T1>(&arg0.share_token_supply);
        if (v0 > 0) {
            let v1 = muldiv(v0, calculate_current_share_price<T0, T1>(arg0), 10000);
            let v2 = if (v1 > arg0.total_assets) {
                v1 - arg0.total_assets
            } else {
                arg0.total_assets - v1
            };
            assert!(v2 <= 10, 12);
        };
        let v3 = VaultInvariantValidated{
            vault_id          : 0x2::object::id<Vault<T0, T1>>(arg0),
            total_assets      : arg0.total_assets,
            calculated_assets : muldiv(v0, calculate_current_share_price<T0, T1>(arg0), 10000),
        };
        0x2::event::emit<VaultInvariantValidated>(v3);
    }
