module 0xd6c2a0aea499d954d66df07e71ce562df57a05f1b9e3b8364407937f867bac78::reward8970 {
    struct REWARD8970 has drop {
        dummy_field: bool,
    }

    struct TICKET_8970 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8970(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8970>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8970>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8970, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8970>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8970>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8970>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8970>>(v5, 0x2::tx_context::sender(arg1));
    }
