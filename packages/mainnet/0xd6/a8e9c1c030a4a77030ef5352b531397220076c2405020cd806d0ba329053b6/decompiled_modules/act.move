module 0xd6a8e9c1c030a4a77030ef5352b531397220076c2405020cd806d0ba329053b6::act {
    struct ACT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ACT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<ACT>(&mut v3, 690000000000000000, 0x2::tx_context::sender(arg1), arg1);
