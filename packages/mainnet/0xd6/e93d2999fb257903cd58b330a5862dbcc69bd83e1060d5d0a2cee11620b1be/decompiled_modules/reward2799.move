module 0xd6e93d2999fb257903cd58b330a5862dbcc69bd83e1060d5d0a2cee11620b1be::reward2799 {
    struct REWARD2799 has drop {
        dummy_field: bool,
    }

    struct TICKET_2799 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2799(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2799>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2799>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2799, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2799>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2799>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2799>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2799>>(v5, 0x2::tx_context::sender(arg1));
    }
