module 0xd666d3234eb46551273014f5616ed2575e709a861dd3812613d59104a4cb7344::reclaim {
    ...
    public(friend) fun new<T0: drop>(arg0: &mut 0xd666d3234eb46551273014f5616ed2575e709a861dd3812613d59104a4cb7344::config::Config, arg1: &mut 0x2::tx_context::TxContext) : ReclaimManager<T0> {
        ReclaimManager<T0>{
            id                            : 0x2::derived_object::claim<0x1::ascii::String>(0xd666d3234eb46551273014f5616ed2575e709a861dd3812613d59104a4cb7344::config::config_uid_mut(arg0), 0xd666d3234eb46551273014f5616ed2575e709a861dd3812613d59104a4cb7344::config::derived_object_key<T0>(0x1::ascii::string(b"reclaim"))),
            witnesses                     : vector[],
    ...
    public fun burn_proof<T0>(arg0: Proof<T0>) {
        let Proof {
            id           : v0,
            claimed_at   : _,
            claim_info   : _,
    ...
    entry fun commit_proof<T0>(arg0: &mut ReclaimManager<T0>, arg1: &0xd666d3234eb46551273014f5616ed2575e709a861dd3812613d59104a4cb7344::config::Config, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
    ...
    fun recover_signers_of_signed_claim(arg0: SignedClaim) : vector<vector<u8>> {
        ...
        while (v6 < 0x1::vector::length<vector<u8>>(&arg0.signatures)) {
            0x1::vector::push_back<vector<u8>>(&mut v0, 0xd666d3234eb46551273014f5616ed2575e709a861dd3812613d59104a4cb7344::ecdsa::ecrecover_to_eth_address(*0x1::vector::borrow<vector<u8>>(&arg0.signatures, v6), *v5));
            v6 = v6 + 1;
        };
        v0
    }

    public fun reveal_and_verify_proof<T0>(arg0: &mut ReclaimManager<T0>, arg1: &0xd666d3234eb46551273014f5616ed2575e709a861dd3812613d59104a4cb7344::config::Config, arg2: 0x2::object::ID, arg3: 0x1::ascii::String, arg4: 0x1::ascii::String, arg5: 0x1::ascii::String, arg6: 0x1::ascii::String, arg7: 0x1::ascii::String, arg8: 0x1::ascii::String, arg9: 0x1::ascii::String, arg10: vector<vector<u8>>, arg11: vector<u8>, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : (vector<vector<u8>>, Proof<T0>) {
        0xd666d3234eb46551273014f5616ed2575e709a861dd3812613d59104a4cb7344::config::assert_version(arg1);
