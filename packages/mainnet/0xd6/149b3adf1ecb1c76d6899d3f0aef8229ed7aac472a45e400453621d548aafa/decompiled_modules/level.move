module 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::level {
    ...
    public(friend) fun add_level_points_to_player(arg0: &mut 0xdf7d39243184df01f2fcaac0b127c4f7434b0d1b6759d0c39f80218666053524::airdrop::VendettaAirdropNFT, arg1: &0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::authority::CapWrapper, arg2: &mut 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iplayer::Player, arg3: &0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ilevel::LevelPointRegistry, arg4: u128) {
        ...
        let (v1, v2) = is_able_to_upgrade_level(arg3, 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ilevel::borrow_level(v0), 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ilevel::borrow_level_point(v0));
        if (v1 > 0) {
            0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ilevel::increase_level_point(v0, v1);
    ...
    fun is_able_to_upgrade_level(arg0: &0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ilevel::LevelPointRegistry, arg1: u64, arg2: u128) : (u64, u128) {
        let v0 = 0;
        let v1 = 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ilevel::level_point_required(arg0, arg1);
        while (arg2 >= v1) {
            v0 = v0 + 1;
            let v2 = arg1 + 1;
            arg1 = v2;
            v1 = 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ilevel::level_point_required(arg0, v2);
        };
        (v0, v1)
    }
