module 0xd6a7b8add415b65ac8220b990dfc6c129342beb4a2f39abdce5cb4c90c24cc50::cnsnft4353 {
    struct CNSNFT4353 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4353, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4353>(arg0, arg1);
