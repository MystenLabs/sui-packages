module 0x1b27d5e7bd8e7f92caf4ca8c39ed9186638cba62ae5da94b756f7b6720a44b6b::freehand_sketch {
    struct FREEHAND_SKETCH has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: FREEHAND_SKETCH, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<FREEHAND_SKETCH>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Freehand Sketch"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"When the world becomes increasingly digitized and automated, we yearn for the handmade and the authentic"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://wjAScnDmEX9hckjRTkRLXKIcOzZyqB4CNmO5NFOF5SY"));
