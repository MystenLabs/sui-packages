module 0x1b3af45c7c1c68be58223e384abca7fbc53a394842283a51cb41685426c28818::wha {
    struct WHA has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WHA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        let v3 = &mut v2;
        mint(v3, 10000000000000000000, @0xc5d4bad4a3f9e50583a062101119de63d9e4d497ca72398e90c7c626ecaa52b5, arg1);
