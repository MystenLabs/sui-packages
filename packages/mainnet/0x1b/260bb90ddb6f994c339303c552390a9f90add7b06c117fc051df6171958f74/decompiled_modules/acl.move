module 0xf98f613416225e42930e0f25daacd83443abca19e9ce869ae05c657dba59f503::acl {
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : ACL {
        ACL{
            ...
            permissions : 0x2::linked_table::new<address, u128>(arg0),
        }
    }

    public(friend) fun add_role(arg0: &mut ACL, arg1: address, arg2: u8) {
        assert!(arg2 < 128, 0);
    ...
    public fun get_member_address(arg0: &Member) : address {
        arg0.address
    }
    ...
    public(friend) fun remove_member(arg0: &mut ACL, arg1: address) {
        assert!(0x2::linked_table::contains<address, u128>(&arg0.permissions, arg1), 1);
        if (0x2::linked_table::contains<address, u128>(&arg0.permissions, arg1)) {
            0x2::linked_table::remove<address, u128>(&mut arg0.permissions, arg1);
        };
    }

    public(friend) fun remove_role(arg0: &mut ACL, arg1: address, arg2: u8) {
        assert!(arg2 < 128, 0);
        if (0x2::linked_table::contains<address, u128>(&arg0.permissions, arg1)) {
            let v0 = 0x2::linked_table::borrow_mut<address, u128>(&mut arg0.permissions, arg1);
    ...
    public(friend) fun set_roles(arg0: &mut ACL, arg1: address, arg2: u128) {
        if (0x2::linked_table::contains<address, u128>(&arg0.permissions, arg1)) {
