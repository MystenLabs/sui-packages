module 0x1b2c86418de6e6626eacf219f95a0da0b07ee857134a746d05ec6728a030db24::pool {
    ...
    public(friend) fun deposit_treasury<T0>(arg0: &mut Pool<T0>, arg1: u64) {
        assert!(0x2::balance::value<T0>(&arg0.balance) >= arg1, 0x1b2c86418de6e6626eacf219f95a0da0b07ee857134a746d05ec6728a030db24::error::insufficient_balance());
    ...
    public(friend) fun withdraw_reserve_balance<T0>(arg0: &PoolAdminCap, arg1: &mut Pool<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 >= arg2, 0x1b2c86418de6e6626eacf219f95a0da0b07ee857134a746d05ec6728a030db24::error::insufficient_balance());
    ...
    public fun withdraw_treasury<T0>(arg0: &mut PoolAdminCap, arg1: &mut Pool<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T0>(&arg1.treasury_balance) >= arg2, 0x1b2c86418de6e6626eacf219f95a0da0b07ee857134a746d05ec6728a030db24::error::insufficient_balance());
