module 0x83ba940faec75a014752518940e225d0f150b439068af0ef9e36fba1a20a372d::queen_maker {
    struct QueenMaker has store, key {
        id: 0x2::object::UID,
        hive_kraft_cap: 0x2::coin::TreasuryCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>,
        hive_to_burn: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>,
    ...
    public fun add_to_bid(arg0: &0x2::clock::Clock, arg1: &mut QueenMaker, arg2: &mut 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::DragonTrainer, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 1, 9893);
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let v1 = arg1.current_auction.auction_start_epoch;
        let (v2, v3, _) = 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::get_trainer_meta_info(arg2);
        ...
        let v9 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div(arg4, arg1.config.energy_tax, 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::percent_precision());
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v5, 0x2::tx_context::sender(arg5), arg5);
        limit_deposits_for_existing_bidders(arg1, 0x2::tx_context::epoch(arg5), v0);
    }

    public fun compete_to_be_a_queen(arg0: &0x2::clock::Clock, arg1: &mut QueenMaker, arg2: &mut 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::BeesManager, arg3: &mut 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::DragonTrainer, arg4: u64, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 1, 9893);
        let v0 = arg1.current_auction.auction_start_epoch;
        let (v1, v2, _) = 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::get_trainer_meta_info(arg3);
        ...
        let v5 = 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::get_bee_for_queen_competition(&arg1.hive_kraft_cap, arg2, 0x2::object::uid_to_address(&arg1.id), arg3, arg4);
        let v6 = 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::get_bee_family(&v5);
        let v7 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div(arg6, arg1.config.energy_tax, 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::percent_precision());
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v4, 0x2::tx_context::sender(arg7), arg7);
        limit_deposits_for_existing_bidders(arg1, 0x2::tx_context::epoch(arg7), 0x2::clock::timestamp_ms(arg0));
    }

    fun create_user_position(arg0: u64, arg1: address, arg2: 0x1::string::String, arg3: 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::MysticalBee, arg4: u64, arg5: u64, arg6: u64, arg7: u64) : ParticipationPosition {
    ...
    fun destroy_user_position(arg0: ParticipationPosition) : (0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::MysticalBee, u64, u64, 0x1::string::String, address, u64, u64) {
    ...
    public fun increment_energy_and_health(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::TwoAmmFlowAccess, arg1: &mut QueenMaker, arg2: u64, arg3: u64, arg4: u64) {
    ...
    public fun increment_queen_maker(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::TwoAmmFlowAccess, arg1: &mut 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::BeesManager, arg2: &mut QueenMaker, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, 0x2::balance::Balance<0x2::sui::SUI>) {
        assert!(arg2.module_version == 1, 9893);
        ...
        while (0x1::option::is_some<u64>(&v3)) {
            ...
            let v18 = v11;
            0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::make_bee_queen(&arg2.hive_kraft_cap, arg1, &mut v18, arg2.config.max_eggs_per_queen, v12, arg3);
            let v19 = v2 + v16;
            v2 = v19 - v17;
        ...
        let v21 = 0x2::balance::withdraw_all<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg2.hive_to_burn);
        0x2::coin::burn<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg2.hive_kraft_cap, 0x2::coin::from_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(v21, arg3));
        ...
        let v26 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((arg2.current_auction.price_to_be_a_queen as u256), (arg2.config.bid_increase_pct as u256), (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::percent_precision() as u256)) as u64);
        ...
        let v27 = QueenCompetitionOver{
            ...
            hive_burnt_amt              : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&v21),
    ...
    public entry fun increment_queen_maker_obj(arg0: &mut QueenMaker, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.module_version < 1, 9892);
    ...
    public fun init_queen_maker(arg0: &0x2::clock::Clock, arg1: 0x2::coin::TreasuryCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = QueenMaker{
            ...
            hive_kraft_cap          : arg1,
            hive_to_burn            : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(),
            config                  : v0,
            are_live                : false,
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(0x2::coin::into_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(0x2::coin::mint<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg1, 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::total_hive_supply(), arg6)), 0x2::tx_context::sender(arg6), arg6);
    }
    ...
    fun limit_deposits_for_existing_bidders(arg0: &mut QueenMaker, arg1: u64, arg2: u64) {
        ...
        if (arg1 > arg0.current_auction.auction_start_epoch + arg0.config.unlimited_deposit_window && arg0.current_auction.auction_status == 1) {
            if (v0 < arg0.current_auction.price_to_be_a_queen && arg0.current_auction.price_to_be_a_queen_update_epoch < arg1) {
                let v1 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((arg0.current_auction.price_to_be_a_queen as u256), (arg0.config.bid_decrease_pct as u256), (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::percent_precision() as u256)) as u64);
            ...
            if (v0 >= arg0.current_auction.price_to_be_a_queen) {
                ...
                let v3 = BidsOpenForExisting{
                    ...
                    price_to_be_a_queen : arg0.current_auction.price_to_be_a_queen,
                    cur_epoch           : arg1,
                    deposits_open_till  : arg2 + arg0.config.limited_deposit_window * 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::epoch_duration_ms(),
                };
    ...
    public fun max_addable_to_bid(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : (bool, u64) {
        ...
        let v0 = arg0 * 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::epoch_duration_ms();
        let v1 = arg1 + v0;
        if (v1 > arg2) {
            return (true, (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((arg3 as u256), ((v1 - arg2) as u256), (v0 as u256)) as u64))
        };
        (true, 0)
    }

    public fun mint_hive_for_dragon_bees(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonDaoCapability, arg1: &mut QueenMaker, arg2: &mut 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::BeesManager, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE> {
        let v0 = 0x2::coin::into_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(0x2::coin::mint<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg1.hive_kraft_cap, arg3, arg5));
        0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::deposit_hive_with_treasury(arg2, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v0, arg3 * arg4 / 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::percent_precision()));
        v0
    }
    ...
    public fun update_queen_maker(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonDaoCapability, arg1: &mut QueenMaker, arg2: bool, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 1, 9893);
        arg1.are_live = arg2;
        ...
        if (arg6 > 0) {
            assert!(arg6 < 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::max_queen_eggs_limit(), 9887);
            arg1.config.max_eggs_per_queen = arg6;
        };
    }

    public fun withdraw_bee_after_competition(arg0: &mut QueenMaker, arg1: &mut 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::BeesManager, arg2: &mut 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::DragonTrainer, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 1, 9893);
        ...
        if (0x2::linked_table::contains<address, QueenCustody>(&arg0.queen_custody, v0)) {
            ...
            let v8 = QueenClaimedByItsOwner{
                trainer_addr  : v0,
                version       : 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::get_bee_version(&v7),
                sui_bidded    : v5,
                auction_epoch : v6,
            };
            ...
            if (v9.total_sui_bidded > 0) {
                v10 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((v9.total_hive_energy as u256), (v5 as u256), (v9.total_sui_bidded as u256)) as u64);
                v11 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((v9.total_health as u256), (v5 as u256), (v9.total_sui_bidded as u256)) as u64);
            };
            0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::return_bee_from_competition(&arg0.hive_kraft_cap, arg1, arg2, v7, v10, v11);
            return
        };
        ...
        if (v19.total_sui_bidded > 0) {
            v20 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((v19.total_hive_energy as u256), (v17 as u256), (v19.total_sui_bidded as u256)) as u64);
            v21 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((v19.total_health as u256), (v17 as u256), (v19.total_sui_bidded as u256)) as u64);
        };
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v19.sui_available, v17 - v18), 0x2::tx_context::sender(arg3), arg3);
        0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::return_bee_from_competition(&arg0.hive_kraft_cap, arg1, arg2, v12, v20, v21);
