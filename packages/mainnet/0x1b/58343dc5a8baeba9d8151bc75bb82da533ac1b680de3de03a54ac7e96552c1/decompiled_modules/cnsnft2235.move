module 0x1b58343dc5a8baeba9d8151bc75bb82da533ac1b680de3de03a54ac7e96552c1::cnsnft2235 {
    struct CNSNFT2235 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2235, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2235>(arg0, arg1);
