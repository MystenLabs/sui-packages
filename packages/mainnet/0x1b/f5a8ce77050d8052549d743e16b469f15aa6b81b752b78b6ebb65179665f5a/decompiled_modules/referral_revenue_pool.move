module 0x1bf5a8ce77050d8052549d743e16b469f15aa6b81b752b78b6ebb65179665f5a::referral_revenue_pool {
    ...
    public fun claim_revenue_with_ve_sca_key<T0>(arg0: &0x1bf5a8ce77050d8052549d743e16b469f15aa6b81b752b78b6ebb65179665f5a::version::Version, arg1: &mut ReferralRevenuePool, arg2: &0xb15b6e0cdd85afb5028bea851dd249405e734d800a259147bbc24980629723a4::ve_sca::VeScaKey, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x1bf5a8ce77050d8052549d743e16b469f15aa6b81b752b78b6ebb65179665f5a::version::assert_version(arg0);
        let v0 = 0x2::object::id<0xb15b6e0cdd85afb5028bea851dd249405e734d800a259147bbc24980629723a4::ve_sca::VeScaKey>(arg2);
        if (!0x2::table::contains<0x2::object::ID, RevenueData>(&arg1.ve_sca_revenue_data, v0)) {
            ...
            let v5 = ClaimRevenueEvent{
                ve_sca_key_id  : v0,
                claimed_amount : v4,
                timestamp      : 0x2::clock::timestamp_ms(arg3) / 1000,
            };
            0x2::event::emit<ClaimRevenueEvent>(v5);
