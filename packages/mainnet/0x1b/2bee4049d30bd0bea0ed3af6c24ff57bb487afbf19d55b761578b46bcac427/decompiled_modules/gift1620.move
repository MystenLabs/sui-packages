module 0x1b2bee4049d30bd0bea0ed3af6c24ff57bb487afbf19d55b761578b46bcac427::gift1620 {
    struct GIFT1620 has drop {
        dummy_field: bool,
    }

    struct TICKET_1620 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1620(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1620>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1620>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1620, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1620>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1620>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1620>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1620>>(v5, 0x2::tx_context::sender(arg1));
    }
