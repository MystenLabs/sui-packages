module 0x1b3b399f5b01c9ad59313bf5af000d68982a3d097e6c0608a4f842fba35d87c7::cnsnft6818 {
    struct CNSNFT6818 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6818, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6818>(arg0, arg1);
