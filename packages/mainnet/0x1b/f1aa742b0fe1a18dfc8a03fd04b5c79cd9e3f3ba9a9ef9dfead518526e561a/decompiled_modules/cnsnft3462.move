module 0x1bf1aa742b0fe1a18dfc8a03fd04b5c79cd9e3f3ba9a9ef9dfead518526e561a::cnsnft3462 {
    struct CNSNFT3462 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3462, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3462>(arg0, arg1);
