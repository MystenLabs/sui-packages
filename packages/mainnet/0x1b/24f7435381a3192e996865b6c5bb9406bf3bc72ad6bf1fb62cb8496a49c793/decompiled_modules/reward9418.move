module 0x1b24f7435381a3192e996865b6c5bb9406bf3bc72ad6bf1fb62cb8496a49c793::reward9418 {
    struct REWARD9418 has drop {
        dummy_field: bool,
    }

    struct TICKET_9418 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9418(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9418>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9418>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9418, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9418>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9418>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9418>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9418>>(v5, 0x2::tx_context::sender(arg1));
    }
