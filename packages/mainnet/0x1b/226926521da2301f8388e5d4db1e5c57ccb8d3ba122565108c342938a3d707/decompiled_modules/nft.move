module 0x1b226926521da2301f8388e5d4db1e5c57ccb8d3ba122565108c342938a3d707::nft {
    ...
    entry fun mint(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Nft{
            ...
            name        : 0x1::string::utf8(b"tanjiahui.flytam"),
            description : 0x1::string::utf8(b"tanjiahui.flytam NFT"),
            creator     : 0x2::tx_context::sender(arg1),
            url         : 0x2::url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/20512530?v=4"),
        };
