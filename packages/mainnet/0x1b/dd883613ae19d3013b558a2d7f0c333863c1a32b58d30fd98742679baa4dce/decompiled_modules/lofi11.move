module 0x1bdd883613ae19d3013b558a2d7f0c333863c1a32b58d30fd98742679baa4dce::lofi11 {
    struct LOFI11 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LOFI11, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<LOFI11>(arg0, 9, b"LOFI11", b"LOFI11", b"LOFI11", v2, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LOFI11>>(v4);
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<LOFI11>>(v3);
    ...
    public entry fun transfer_with_tax(arg0: &TaxStorage, arg1: &AdminCap, arg2: &mut 0x2::coin::Coin<LOFI11>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        ...
        let v3 = 0x2::balance::split<LOFI11>(0x2::coin::balance_mut<LOFI11>(arg2), arg3);
        if (v0 > 0) {
            let v4 = arg3 * v0 / 10000;
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI11>>(0x2::coin::from_balance<LOFI11>(0x2::balance::split<LOFI11>(&mut v3, v4), arg5), arg1.admin_address);
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI11>>(0x2::coin::from_balance<LOFI11>(0x2::balance::split<LOFI11>(&mut v3, arg3 - v4), arg5), arg4);
            0x2::balance::destroy_zero<LOFI11>(v3);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI11>>(0x2::coin::from_balance<LOFI11>(v3, arg5), arg4);
        };
    }
