module 0x1b43fb6523a94a85b4445b634ac11e0755e917c8a1340cb74b04700100226f80::reward1226 {
    struct REWARD1226 has drop {
        dummy_field: bool,
    }

    struct TICKET_1226 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1226(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1226>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1226>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1226, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1226>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1226>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1226>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1226>>(v5, 0x2::tx_context::sender(arg1));
    }
