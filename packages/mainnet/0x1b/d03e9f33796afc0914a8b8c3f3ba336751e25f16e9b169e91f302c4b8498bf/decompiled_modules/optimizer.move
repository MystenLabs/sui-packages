module 0x1bd03e9f33796afc0914a8b8c3f3ba336751e25f16e9b169e91f302c4b8498bf::optimizer {
    ...
    public fun optimize_cached(arg0: vector<Hop>, arg1: u128, arg2: u64, arg3: u64, arg4: u64) : OptimizeResult {
        ...
        while (v1.evaluations < arg3 && v6 > 0) {
            ...
            if (v8 - v7 <= v18) {
                ...
                let v19 = &mut v6;
                let v20 = &mut v1;
                trim_cached_v2_plateau(&arg0, &v5, v19, arg3, v20);
                return v1
            };
            arg1 = v7 + (v8 - v7) / 2;
        };
    ...
    fun trim_cached_v2_plateau(arg0: &vector<Hop>, arg1: &vector<V3PrefixCache>, arg2: &mut u64, arg3: u64, arg4: &mut OptimizeResult) {
        if (!arg4.found || arg4.evaluations >= arg3) {
            return
        };
        let v0 = 0x1::vector::length<Hop>(arg0);
        if (*arg2 < v0 * 2) {
        ...
        let v2 = arg4.amount_out;
        while (v1 > 0) {
            let v3 = v1 - 1;
            v1 = v3;
            *arg2 = *arg2 - 1;
            let (v4, v5) = inverse_hop(0x1::vector::borrow<Hop>(arg0, v3), v2);
            if (!v5) {
                return
            };
            v2 = v4;
        };
        if (v2 == 0 || v2 >= arg4.amount_in) {
            return
        };
        let (v6, v7, _, _) = quote_bounded_route(arg0, arg1, v2, arg2);
        arg4.evaluations = arg4.evaluations + 1;
        if (v7 == 0) {
            record_candidate(v2, v6, arg4);
        };
    }
