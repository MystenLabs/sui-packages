module 0x1bbb07018b0a023447c10ea28a3773bedecaa4dd8a2260c19b569f498cff7938::crazy_beanz {
    ...
    fun init(arg0: CRAZY_BEANZ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreid72pwxasy2if6cnegzwirghk2izp2jhskrsic6iaziunr2fxh5ni"));
