module 0x22577d44e000457694dd82033c0a2404bf6c97834e05431605fd51970f74a86b::d0 {
    ...
    struct D<phantom T0, phantom T1> has key {
        id: 0x2::object::UID,
        v: 0x2::object::ID,
        k: 0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::VaultTradeCap<T1>,
        a: 0x2::object::ID,
        m: 0x2::object::ID,
        po: 0x2::object::ID,
        pc: 0x2::object::ID,
    ...
    public fun c0<T0, T1>(arg0: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::Vault<T1>, arg1: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::VaultAdminCap<T1>, arg2: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::config::LotusConfig, arg3: 0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::VaultTradeCap<T1>, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: 0x2::object::ID, arg7: 0x2::object::ID, arg8: 0x2::object::ID, arg9: 0x2::object::ID, arg10: vector<u64>, arg11: vector<u64>, arg12: &mut 0x2::tx_context::TxContext) : D<T0, T1> {
        0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::config::assert_governance(arg2);
        0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::assert_admin<T1>(arg0, arg1);
        check(&arg10);
        check_ceil(&arg10, &arg11);
        D<T0, T1>{
            id : 0x2::object::new(arg12),
            v  : 0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::id<T1>(arg0),
            k  : arg3,
            a  : arg4,
            m  : arg5,
            po : arg6,
    ...
    fun check(arg0: &vector<u64>) {
        assert!(0x1::vector::length<u64>(arg0) == 27, 1);
        ...
        assert!(*0x1::vector::borrow<u64>(arg0, 19) > 0, 1);
        assert!(*0x1::vector::borrow<u64>(arg0, 20) > 0, 1);
        assert!(*0x1::vector::borrow<u64>(arg0, 21) > 0, 1);
        assert!(*0x1::vector::borrow<u64>(arg0, 22) > 0, 1);
        assert!(*0x1::vector::borrow<u64>(arg0, 23) >= *0x1::vector::borrow<u64>(arg0, 22), 1);
        assert!(*0x1::vector::borrow<u64>(arg0, 25) > 0, 1);
    }
    ...
    public(friend) fun hk(arg0: &vector<u64>, arg1: &vector<u64>) : bool {
        if (0x1::vector::length<u64>(arg1) != 27) {
            return false
        };
        let v0 = vector[6, 8, 9, 11, 13, 17, 20, 21, 23, 25];
    ...
    public(friend) fun kb<T0, T1>(arg0: &D<T0, T1>) : &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::VaultTradeCap<T1> {
        &arg0.k
    }
    ...
    public fun n1<T0, T1>(arg0: &mut D<T0, T1>, arg1: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::Vault<T1>, arg2: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::VaultAdminCap<T1>, arg3: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::config::LotusConfig, arg4: &mut 0x2::tx_context::TxContext) : U1 {
        0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::config::assert_governance(arg3);
        0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::assert_admin<T1>(arg1, arg2);
        assert!(arg0.v == 0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::id<T1>(arg1), 0);
        let v0 = U1{
    ...
    public fun t0<T0, T1>(arg0: &mut D<T0, T1>, arg1: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::Vault<T1>, arg2: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::VaultAdminCap<T1>, arg3: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::config::LotusConfig, arg4: vector<u64>, arg5: vector<u64>) {
        0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::config::assert_governance(arg3);
        0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::assert_admin<T1>(arg1, arg2);
        assert!(arg0.v == 0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::id<T1>(arg1), 0);
        check(&arg4);
        check_ceil(&arg4, &arg5);
        arg0.p = arg4;
        arg0.h = arg5;
    }
    ...
    public fun u0<T0, T1>(arg0: &mut D<T0, T1>, arg1: &U1, arg2: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::config::LotusConfig, arg3: vector<u64>) {
        0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::config::assert_governance(arg2);
        assert!(0x2::object::id<U1>(arg1) == arg0.uk && arg1.d == 0x2::object::uid_to_inner(&arg0.id), 3);
        check(&arg3);
        check_ceil(&arg3, &arg0.h);
        arg0.p = arg3;
    }
    ...
    public fun xb<T0, T1>(arg0: &mut D<T0, T1>, arg1: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::Vault<T1>, arg2: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::VaultAdminCap<T1>, arg3: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::config::LotusConfig, arg4: u8, arg5: 0x2::object::ID) {
        0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::config::assert_governance(arg3);
        0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::assert_admin<T1>(arg1, arg2);
        assert!(arg0.v == 0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::id<T1>(arg1), 0);
        let v0 = XKey{k: arg4};
        if (0x2::dynamic_field::exists_<XKey>(&arg0.id, v0)) {
            *0x2::dynamic_field::borrow_mut<XKey, 0x2::object::ID>(&mut arg0.id, v0) = arg5;
        } else {
            0x2::dynamic_field::add<XKey, 0x2::object::ID>(&mut arg0.id, v0, arg5);
        };
    }
    ...
    public fun z0<T0, T1>(arg0: &mut D<T0, T1>, arg1: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::Vault<T1>, arg2: &0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::VaultAdminCap<T1>, arg3: bool) {
        0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::assert_admin<T1>(arg1, arg2);
        assert!(arg0.v == 0x145a2a1774cf0815d5b8c98bff403ea447ab13dae095b8f62545363e1fc12a5b::vault::id<T1>(arg1), 0);
        arg0.z = arg3;
    }
