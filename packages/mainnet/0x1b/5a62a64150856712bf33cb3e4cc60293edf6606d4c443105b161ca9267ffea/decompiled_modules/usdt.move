module 0x1b5a62a64150856712bf33cb3e4cc60293edf6606d4c443105b161ca9267ffea::usdt {
    ...
    fun init(arg0: USDT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<USDT>(arg0, 9, b"USDD", b"Tether USDD", b"yulezhuanyong", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/QmbK4wEQFHr8m54comGn2EN63Dvne1q7PdoeZkZaoh57t6")), arg1);
        let v2 = v0;
