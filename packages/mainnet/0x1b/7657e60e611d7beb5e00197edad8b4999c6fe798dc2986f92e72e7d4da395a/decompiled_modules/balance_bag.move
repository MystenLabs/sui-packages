module 0x1b7657e60e611d7beb5e00197edad8b4999c6fe798dc2986f92e72e7d4da395a::balance_bag {
    ...
    public(friend) fun join<T0>(arg0: &mut BalanceBag, arg1: 0x2::balance::Balance<T0>) {
        ...
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.balances, &v0)) {
            *0x2::vec_map::get_mut<0x1::type_name::TypeName, u64>(&mut arg0.balances, &v0) = 0x1b7657e60e611d7beb5e00197edad8b4999c6fe798dc2986f92e72e7d4da395a::utils::add_balance_to_bag<T0>(&mut arg0.bag, arg1);
        } else {
            0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut arg0.balances, v0, 0x1b7657e60e611d7beb5e00197edad8b4999c6fe798dc2986f92e72e7d4da395a::utils::add_balance_to_bag<T0>(&mut arg0.bag, arg1));
        };
    }
    ...
    public(friend) fun split<T0>(arg0: &mut BalanceBag, arg1: u64) : 0x2::balance::Balance<T0> {
        let (v0, v1) = 0x1b7657e60e611d7beb5e00197edad8b4999c6fe798dc2986f92e72e7d4da395a::utils::remove_balance_from_bag<T0>(&mut arg0.bag, arg1, false);
    ...
    public(friend) fun withdraw_all<T0>(arg0: &mut BalanceBag) : 0x2::balance::Balance<T0> {
        let (v0, _) = 0x1b7657e60e611d7beb5e00197edad8b4999c6fe798dc2986f92e72e7d4da395a::utils::remove_balance_from_bag<T0>(&mut arg0.bag, 0, true);
        let v2 = 0x1::type_name::with_defining_ids<T0>();
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.balances, &v2)) {
