module 0x1bb67befcc5e3181c9f267f5abaad24e6d43fca74666ed0df57a7913c5e66b14::sale {
    ...
    public entry fun buyLand<T0>(arg0: &SaleConfig<T0>, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v2, v1), arg3), arg0.owner);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v2, arg3), v0);
        let v3 = BuyEvent{
            buyer     : v0,
            amount    : arg1,
    ...
    public entry fun buyMiner<T0>(arg0: &SaleConfig<T0>, arg1: &mut GlobalConfig<T0>, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.is_enabled, 3);
    ...
    public entry fun initialize_reward_pool<T0>(arg0: &AdminCapability, arg1: vector<u8>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = RewardPool<T0>{
            id                   : 0x2::object::new(arg3),
            owner                : 0x2::tx_context::sender(arg3),
            admin_public_key     : arg1,
            reward_pool          : 0x2::coin::into_balance<T0>(arg2),
            total_reward_claimed : 0,
            reward_per_address   : 0x2::table::new<address, u64>(arg3),
        };
        0x2::transfer::share_object<RewardPool<T0>>(v0);
    }

    public entry fun initialize_sale_config<T0>(arg0: &AdminCapability, arg1: u8, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 2);
