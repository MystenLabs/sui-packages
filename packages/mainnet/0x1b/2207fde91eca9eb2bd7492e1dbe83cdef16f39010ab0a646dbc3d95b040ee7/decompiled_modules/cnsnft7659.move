module 0x1b2207fde91eca9eb2bd7492e1dbe83cdef16f39010ab0a646dbc3d95b040ee7::cnsnft7659 {
    struct CNSNFT7659 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7659, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7999"));
        let v4 = 0x2::package::claim<CNSNFT7659>(arg0, arg1);
