module 0x1b3ae29a4a62c7423c91f902592df8a942737779540a8f87c5c21221f3ebc75c::movexnft2574 {
    struct MOVEXNFT2574 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT2574, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT2574>(arg0, arg1);
