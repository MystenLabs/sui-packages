module 0x1b50405c09a33b2117b5d92269f3cef5ddbf39ead1913e39ce8ec937cfc060ac::reward5700 {
    struct REWARD5700 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward5700(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD5700, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5700>(arg0, arg1);
