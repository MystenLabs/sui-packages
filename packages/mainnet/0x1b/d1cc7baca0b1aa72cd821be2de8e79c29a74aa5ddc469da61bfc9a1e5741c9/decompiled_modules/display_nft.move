module 0x1bd1cc7baca0b1aa72cd821be2de8e79c29a74aa5ddc469da61bfc9a1e5741c9::display_nft {
    ...
    fun init(arg0: DISPLAY_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = MyNFT{
            ...
            image_url : 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/195670331?v=4"),
        };
