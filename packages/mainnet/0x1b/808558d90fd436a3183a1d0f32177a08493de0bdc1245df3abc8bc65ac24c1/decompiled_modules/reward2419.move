module 0x1b808558d90fd436a3183a1d0f32177a08493de0bdc1245df3abc8bc65ac24c1::reward2419 {
    struct REWARD2419 has drop {
        dummy_field: bool,
    }

    struct TICKET_2419 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2419(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2419>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2419>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2419, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2419>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2419>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2419>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2419>>(v5, 0x2::tx_context::sender(arg1));
    }
