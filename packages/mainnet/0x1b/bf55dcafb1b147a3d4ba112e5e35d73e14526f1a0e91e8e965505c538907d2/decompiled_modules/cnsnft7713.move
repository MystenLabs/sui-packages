module 0x1bbf55dcafb1b147a3d4ba112e5e35d73e14526f1a0e91e8e965505c538907d2::cnsnft7713 {
    struct CNSNFT7713 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7713, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7713>(arg0, arg1);
