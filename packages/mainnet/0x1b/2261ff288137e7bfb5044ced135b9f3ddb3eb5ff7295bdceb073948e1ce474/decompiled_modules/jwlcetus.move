module 0x1b2261ff288137e7bfb5044ced135b9f3ddb3eb5ff7295bdceb073948e1ce474::jwlcetus {
    ...
    fun init(arg0: JWLCETUS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<JWLCETUS>(arg0, 9, b"JWLCETUS", b"JWLCETUS", b"JWLCETUS is a stablecoin pegged to CETUS and minted with CETUS 1:1. Brought to you by JewelSwap.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raw.githubusercontent.com/JewelSwapXFinance/jewelswap-token-logos/main/sui/jwlcetus.png")), arg1);
