module 0x1bd06e91e4cf007f65927917fac678b5c62b64ff4dc5fd3bbbcc1ad53da8e00f::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"HOPY", b"HAAPPY", b"undefined", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/media/G4hGhTZWsAAuJPL.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"HAAPPY"),
            symbol     : 0x1::string::utf8(b"HOPY"),
            decimals   : 9,
