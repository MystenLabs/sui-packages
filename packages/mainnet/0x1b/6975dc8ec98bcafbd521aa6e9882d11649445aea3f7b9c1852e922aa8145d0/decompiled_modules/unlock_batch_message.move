module 0x1b6975dc8ec98bcafbd521aa6e9882d11649445aea3f7b9c1852e922aa8145d0::unlock_batch_message {
    ...
    public(friend) fun deserialize(arg0: vector<u8>) : UnlockBatchMessage {
        ...
        assert!(0x1::vector::length<u8>(&arg0) == (v1 as u64) * 98 + 3, 1);
    ...
    public(friend) fun serialize(arg0: UnlockBatchMessage) : vector<u8> {
        ...
        0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::push_u8(&mut v1, 4);
        0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::push_u16_be(&mut v1, (0x1::vector::length<UnlockBatchMessageItem>(&v0) as u16));
        ...
        assert!(0x1::vector::length<u8>(&v1) == (0x1::vector::length<UnlockBatchMessageItem>(&v0) as u64) * 98 + 3, 1);
        v1
    }
