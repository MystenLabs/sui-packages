module 0x1b25dd6ed6781cc8d93a316f781df1326a5e711aeca73eeb06704387157a23b5::nftLib {
        ...
        while (v0 <= 0x2::vec_map::size<u64, Achievement>(&arg0.achievements)) {
            ...
            while (v2 < 0x1::vector::length<u8>(&arg4)) {
                ...
                if (v3 == v1.achievementType) {
                    if (v1.communityId != arg2 && v1.communityId != 0x1b25dd6ed6781cc8d93a316f781df1326a5e711aeca73eeb06704387157a23b5::commonLib::getZeroId()) {
                        continue
                    };
