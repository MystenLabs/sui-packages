module 0x1b1f41ead1e53f750e3bbf7d5833b76d9694bdc1e84a93b3dce9b22ad9c81fa3::reward9113 {
    struct REWARD9113 has drop {
        dummy_field: bool,
    }

    struct TICKET_9113 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9113(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9113>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9113>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9113, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9113>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9113>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9113>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9113>>(v5, 0x2::tx_context::sender(arg1));
    }
