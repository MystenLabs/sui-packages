module 0x1b3455aa9d24ce67c5370558721f8335926609bcb43804b8cdcdd11142eec6cb::pepai {
    ...
    fun init(arg0: PEPAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PEPAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PEPAI   ")))), trim_right(b"PEPE AGENT AI                   "), trim_right(b"PEPAI is more than just a cryptocurrency; it's the embodiment of the synergy between memes and cutting-edge artificial intelligence technology. PEPAI is the AI-driven evolution of the legendary Pepe meme, reimagined for the digital age.                                                                                    "), v2, arg1);
        let v5 = v3;
