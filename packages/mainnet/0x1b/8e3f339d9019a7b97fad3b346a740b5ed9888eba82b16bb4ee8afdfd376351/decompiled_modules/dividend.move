module 0x1b8e3f339d9019a7b97fad3b346a740b5ed9888eba82b16bb4ee8afdfd376351::dividend {
    ...
    public fun redeem<T0>(arg0: &mut DividendManager, arg1: &mut 0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::xcetus::VeNFT, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        let v0 = 0x2::object::id<0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::xcetus::VeNFT>(arg1);
        ...
        let v14 = RedeemEvent{
            venft_id      : 0x2::object::id<0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::xcetus::VeNFT>(arg1),
            phases        : v3,
            redeemed_nums : v5,
            amount        : v4,
        };
    ...
    public fun register_bonus<T0>(arg0: &AdminCap, arg1: &mut DividendManager, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        if (!0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<u64, DividendInfo>(&arg1.dividends, arg2)) {
            let v1 = DividendInfo{
                register_time : 0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::utils::now_timestamp(arg4),
                settled_num   : 0,
                is_settled    : false,
                bonus_types   : 0x1::vector::empty<0x1::type_name::TypeName>(),
    ...
    public fun settle(arg0: &SettleCap, arg1: &mut DividendManager, arg2: &0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::xcetus::XcetusManager, arg3: u64, arg4: vector<0x2::object::ID>, arg5: u64) : 0x1::option::Option<0x2::object::ID> {
        checked_package_version(arg1);
        assert!(arg1.is_open, 4);
        ...
        let v0 = 0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::xcetus::nfts(arg2);
        let v1 = if (0x1::vector::is_empty<0x2::object::ID>(&arg4)) {
            0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::head<0x2::object::ID, 0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::xcetus::VeNftInfo>(v0)
        } else {
        ...
        while (0x1::option::is_some<0x2::object::ID>(&v2) && v3 < arg5) {
            ...
            while (v8 < 0x1::vector::length<0x1::type_name::TypeName>(&v5)) {
                ...
                v9 = add_dividend(arg1, v7, arg3, v10, (((0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::xcetus::xcetus_amount(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow<0x2::object::ID, 0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::xcetus::VeNftInfo>(v0, v7)) as u128) * (*0x2::vec_map::get<0x1::type_name::TypeName, u64>(&v6, &v10) as u128) / (0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::xcetus::totol_amount(arg2) as u128)) as u64));
                v8 = v8 + 1;
            };
            if (v9) {
                v4 = v4 + 1;
            };
            v2 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::next<0x2::object::ID, 0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::xcetus::VeNftInfo>(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_node<0x2::object::ID, 0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::xcetus::VeNftInfo>(v0, v7));
            v3 = v3 + 1;
        };
        ...
        if (v11.settled_num >= 0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::xcetus::total_holder(arg2)) {
            v11.is_settled = true;
        };
        let v12 = SettleEvent{
            phase   : arg3,
    ...
    public entry fun update_start_time(arg0: &AdminCap, arg1: &mut DividendManager, arg2: u64, arg3: &0x2::clock::Clock) {
        checked_package_version(arg1);
        assert!(arg1.is_open, 4);
        assert!(arg2 > 0x4aa653953d362d75ae1fe9d47b61ce2997ceb6896da9ff0c9f3eb6ca5bc95d0e::utils::now_timestamp(arg3), 6);
