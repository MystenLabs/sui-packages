module 0x1bdaf7c8f87ebd1fb346d4a144344f898a67fbae5b28582745b0395784e5fbe9::cnsnft4535 {
    struct CNSNFT4535 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4535, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4535>(arg0, arg1);
