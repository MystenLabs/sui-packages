module 0x1b81940830d9da4a078f5ada7e84fb6a5359760f88a3dbe6da792f4a6fdccdfd::versioned {
    ...
    public entry fun pause(arg0: &0x1b81940830d9da4a078f5ada7e84fb6a5359760f88a3dbe6da792f4a6fdccdfd::admin_cap::AdminCap, arg1: &mut Versioned, arg2: &0x2::tx_context::TxContext) {
        check_version(arg1);
        let v0 = GlobalPauseDfKey{dummy_field: false};
    ...
    public entry fun unpause(arg0: &0x1b81940830d9da4a078f5ada7e84fb6a5359760f88a3dbe6da792f4a6fdccdfd::admin_cap::AdminCap, arg1: &mut Versioned, arg2: &0x2::tx_context::TxContext) {
        check_version(arg1);
        let v0 = GlobalPauseDfKey{dummy_field: false};
    ...
    public fun upgrade(arg0: &0x1b81940830d9da4a078f5ada7e84fb6a5359760f88a3dbe6da792f4a6fdccdfd::admin_cap::AdminCap, arg1: &mut Versioned) {
        assert!(arg1.version < 6, 1000);
