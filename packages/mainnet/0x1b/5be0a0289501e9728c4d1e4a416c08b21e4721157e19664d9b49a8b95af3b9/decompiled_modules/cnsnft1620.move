module 0x1b5be0a0289501e9728c4d1e4a416c08b21e4721157e19664d9b49a8b95af3b9::cnsnft1620 {
    struct CNSNFT1620 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1620, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8697"));
        let v4 = 0x2::package::claim<CNSNFT1620>(arg0, arg1);
