module 0x1bc8e06f5cf1bfdaa300d01e782be78652751ff7cc70ebbf8cc7b4148d9e1454::reward4591 {
    struct REWARD4591 has drop {
        dummy_field: bool,
    }

    struct TICKET_4591 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4591(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4591>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4591>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4591, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4591>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4591>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4591>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4591>>(v5, 0x2::tx_context::sender(arg1));
    }
