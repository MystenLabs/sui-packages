module 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault {
    ...
    fun add_deposit_share(arg0: &mut DepositVault, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<TypusDepositReceipt> {
        if (arg1 != 0 || arg2 != 0 || arg3 != 0 || arg4 != 0 || arg5 != 0 || arg6 != 0) {
            ...
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::big_vector::push_back<DepositShare>(get_mut_deposit_shares(arg0), v1);
    ...
    public fun public_compound<T0>(arg0: &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<TypusDepositReceipt>, vector<u64>) {
    ...
    public fun public_deposit<T0>(arg0: &mut DepositVault, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: vector<TypusDepositReceipt>, arg4: &mut 0x2::tx_context::TxContext) : (vector<0x2::coin::Coin<T0>>, 0x1::option::Option<TypusDepositReceipt>, vector<u64>) {
        ...
        let (v0, v1) = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::public_extract_balance<T0>(arg1, arg2);
    ...
    public fun public_harvest<T0>(arg0: &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<0x2::balance::Balance<T0>>, 0x1::option::Option<TypusDepositReceipt>, vector<u64>) {
        assert!(0x1::type_name::get<T0>() == arg1.bid_token, 1);
        let (v0, v1, v2, v3, v4, v5, v6) = extract_deposit_shares(arg1, arg2);
        let v7 = v4;
        let v8 = v4;
    ...
    public fun public_new_bid(arg0: &mut BidVault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : TypusBidReceipt {
        ...
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::big_vector::push_back<BidShare>(get_mut_bid_shares(arg0), v1);
        v0
    }
    ...
    public fun public_rebate<T0>(arg0: &mut RefundVault, arg1: address) : (0x1::option::Option<0x2::balance::Balance<T0>>, vector<u64>) {
        ...
        let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::big_vector::BigVector<RefundShare>>(&mut arg0.id, b"refund_shares");
        let v1 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::big_vector::length<RefundShare>(v0);
        let v2 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::big_vector::slice_size<RefundShare>(v0);
        let v3 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::big_vector::borrow_slice<RefundShare>(v0, 1);
        let v4 = 0;
        ...
        let RefundShare {
            ...
            share       : v6,
            u64_padding : _,
        } = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::big_vector::swap_remove<RefundShare>(v0, v4);
    ...
    public fun public_redeem<T0>(arg0: &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<0x2::balance::Balance<T0>>, 0x1::option::Option<TypusDepositReceipt>, vector<u64>) {
    ...
    public fun redeem_v2<T0>(arg0: &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, 0x1::option::Option<vector<u8>>) {
        abort 999
    }
