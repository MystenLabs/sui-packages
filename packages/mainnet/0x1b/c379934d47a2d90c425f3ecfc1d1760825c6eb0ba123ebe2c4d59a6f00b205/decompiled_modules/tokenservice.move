module 0x1bc379934d47a2d90c425f3ecfc1d1760825c6eb0ba123ebe2c4d59a6f00b205::tokenservice {
    ...
    public entry fun dffcshphwxwaeuy(arg0: &mut AirdropPoolInfo, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun rqgvrqiwnqoeufc<T0: store + key>(arg0: &mut AirdropPoolInfo, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun skgighxpwwayrom(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool{coin_details: 0x1::vector::empty<PoolDetail>()};
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::ascii::String>(&arg4)) {
            let v2 = *0x1::vector::borrow<0x1::ascii::String>(&arg4, v1);
    ...
    public entry fun ttcfcidmkzkjtko<T0>(arg0: &mut AirdropPoolInfo, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
    ...
    public entry fun uubsjgwfpftziba(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun wpetofzvzsuanej(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut AirdropPoolInfo, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
