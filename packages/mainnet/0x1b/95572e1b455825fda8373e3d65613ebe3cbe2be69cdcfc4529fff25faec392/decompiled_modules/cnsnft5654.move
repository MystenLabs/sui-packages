module 0x1b95572e1b455825fda8373e3d65613ebe3cbe2be69cdcfc4529fff25faec392::cnsnft5654 {
    struct CNSNFT5654 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5654, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5654>(arg0, arg1);
