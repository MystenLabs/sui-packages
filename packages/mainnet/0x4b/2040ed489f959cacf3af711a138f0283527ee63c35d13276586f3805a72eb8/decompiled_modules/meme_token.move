module 0x4b2040ed489f959cacf3af711a138f0283527ee63c35d13276586f3805a72eb8::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"DUCK", b"COOL DUCK ", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-04T15-27-48.445Z-download (4).jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"COOL DUCK "),
            symbol     : 0x1::string::utf8(b"DUCK"),
            decimals   : 9,
