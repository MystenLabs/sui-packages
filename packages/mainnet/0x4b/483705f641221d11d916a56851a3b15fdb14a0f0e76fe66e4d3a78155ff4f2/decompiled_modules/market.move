module 0x4b483705f641221d11d916a56851a3b15fdb14a0f0e76fe66e4d3a78155ff4f2::market {
    struct AdminCap has store, key {
        id: 0x2::object::UID,
    }

    struct Store has store {
        obj: 0x4b483705f641221d11d916a56851a3b15fdb14a0f0e76fe66e4d3a78155ff4f2::sui20::Sui20,
        price: u64,
        owner: address,
    }
    ...
    public fun buy(arg0: &mut Global, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: 0x2::object::ID, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let (_, v7) = 0x4b483705f641221d11d916a56851a3b15fdb14a0f0e76fe66e4d3a78155ff4f2::sui20::get_sui20_data(&v5);
        ...
        0x2::transfer::public_transfer<0x4b483705f641221d11d916a56851a3b15fdb14a0f0e76fe66e4d3a78155ff4f2::sui20::Sui20>(v5, v0);
    ...
    public fun delist(arg0: &mut Global, arg1: 0x1::string::String, arg2: 0x2::object::ID, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(v4 == v0, 1003);
        0x2::transfer::public_transfer<0x4b483705f641221d11d916a56851a3b15fdb14a0f0e76fe66e4d3a78155ff4f2::sui20::Sui20>(v2, v0);
        ...
        if (0x2::table::contains<address, UserInfo>(&v1.user_infos, v0)) {
            ...
            while (v10 < 0x1::vector::length<0x2::object::ID>(&v9)) {
                ...
                if (0x2::bag::contains<0x2::object::ID>(&v1.stores, v11)) {
                    ...
                    let (_, v14) = 0x4b483705f641221d11d916a56851a3b15fdb14a0f0e76fe66e4d3a78155ff4f2::sui20::get_sui20_data(&v12.obj);
                    let v15 = ListedItem{
                        id     : v11,
                        amount : v14,
                        price  : v12.price,
    ...
    public fun list(arg0: &mut Global, arg1: 0x4b483705f641221d11d916a56851a3b15fdb14a0f0e76fe66e4d3a78155ff4f2::sui20::Sui20, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        only_allowed_version(arg0);
        only_not_paused(arg0);
        let v0 = 0x2::tx_context::sender(arg3);
        let (v1, v2) = 0x4b483705f641221d11d916a56851a3b15fdb14a0f0e76fe66e4d3a78155ff4f2::sui20::get_sui20_data(&arg1);
        assert!(v2 > 0, 1006);
        assert!(arg2 > 0, 1005);
        let v3 = 0x2::object::id<0x4b483705f641221d11d916a56851a3b15fdb14a0f0e76fe66e4d3a78155ff4f2::sui20::Sui20>(&arg1);
        let v4 = Store{
            obj   : arg1,
            price : arg2,
