module 0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::dao_vault {
    ...
    public fun add_swap_coin<T0>(arg0: &mut Vault, arg1: &0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::coin_registry::CoinRegistry, arg2: &ManagerCap) {
        assert!(arg2.vault_id == 0x2::object::id<Vault>(arg0), 5);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::coin_registry::allowed_coin(arg1, &v0), 22);
    ...
    public fun calculate_total_value_locked_in_usd<T0>(arg0: &Vault, arg1: &0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::coin_registry::CoinRegistry, arg2: &mut TotalValueLockedCalculation, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::clock::Clock, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject) {
        let v0 = 0x1::vector::pop_back<0x1::ascii::String>(&mut arg2.remaining_coins);
        arg2.value = arg2.value + 0x2::balance::value<T0>(0x2::bag::borrow<0x1::ascii::String, 0x2::balance::Balance<T0>>(&arg0.balance_storage, v0)) * 0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::price::usd_price(0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::coin_registry::get_price_feed_id(arg1, &v0), arg4, arg5) / 0x2::math::pow(10, 0x2::coin::get_decimals<T0>(arg3));
    }

    public fun deposit_coin<T0>(arg0: &mut Vault, arg1: &0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::coin_registry::CoinRegistry, arg2: TotalValueLocked, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::clock::Clock, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: 0x2::coin::Coin<T0>, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 1);
        let v0 = 0x2::coin::value<T0>(&arg6);
        assert!(v0 > 0, 2);
        let v1 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        let v2 = usd_to_shares(arg0, arg2, 0x2::coin::value<T0>(&arg6) * 0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::price::usd_price(0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::coin_registry::get_price_feed_id(arg1, &v1), arg4, arg5) / 0x2::math::pow(10, 0x2::coin::get_decimals<T0>(arg3)));
        assert!(v2 > 0, 2);
    ...
    public fun execute_withdrawal<T0>(arg0: &mut Vault, arg1: &mut Withdrawal, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(0x1::vector::pop_back<0x1::ascii::String>(&mut arg1.coins) == 0x1::type_name::into_string(0x1::type_name::get<T0>()), 13906835372639256575);
    ...
    public fun flashloan_for_swap<T0>(arg0: &mut Vault, arg1: &0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::coin_registry::CoinRegistry, arg2: &ManagerCap, arg3: &0x2::clock::Clock, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanForSwap) {
        assert!(arg6 > 0, 2);
        assert!(arg2.vault_id == 0x2::object::id<Vault>(arg0), 5);
        assert!(!arg0.paused, 1);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        let v1 = arg6 * 0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::price::usd_price(0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::coin_registry::get_price_feed_id(arg1, &v0), arg3, arg5) / 0x2::math::pow(10, 0x2::coin::get_decimals<T0>(arg4));
        let v2 = take_balance<T0>(arg0, arg6);
        let v3 = BorrowEvent{
            vault          : 0x2::object::id<Vault>(arg0),
    ...
    public fun return_flashloan_from_swap<T0>(arg0: &mut Vault, arg1: &0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::coin_registry::CoinRegistry, arg2: &0x2::clock::Clock, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: FlashLoanForSwap, arg6: 0x2::coin::Coin<T0>, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::uid_to_inner(&arg0.id) == arg5.vault_id, 17);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        let v1 = 0x2::coin::value<T0>(&arg6) * 0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::price::usd_price(0x4ba76df0c92afc3f4bad0ecf0ca0b3926e116f196fa6632d067aa489db00f22a::coin_registry::get_price_feed_id(arg1, &v0), arg2, arg4) / 0x2::math::pow(10, 0x2::coin::get_decimals<T0>(arg3));
        assert!(v1 >= arg5.borrow_usd_value * 99 / 100, 2);
        append_balance<T0>(arg0, 0x2::coin::into_balance<T0>(arg6));
