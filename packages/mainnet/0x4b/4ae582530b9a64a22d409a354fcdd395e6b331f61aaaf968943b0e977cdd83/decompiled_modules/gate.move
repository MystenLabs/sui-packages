module 0xd7a2b43235459be0a72b2a7ae83a22d8b1437bd254a443a579d1237839af6e7f::gate {
    ...
    public fun can_liquidate_batch(arg0: &0x2::clock::Clock, arg1: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: address, arg4: vector<address>, arg5: u256) : (vector<u256>, vector<bool>, vector<bool>, vector<vector<u8>>, vector<vector<u8>>, vector<u256>, vector<u256>) {
        ...
        while (v8 < 0x1::vector::length<address>(&arg4)) {
            let v9 = *0x1::vector::borrow<address>(&arg4, v8);
            let v10 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::is_liquidatable(arg2, arg3, v9);
            let (v11, v12) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_assets(arg2, v9);
            let v13 = if (v10) {
            ...
            0x1::vector::push_back<bool>(&mut v2, *0x1::vector::borrow<u256>(&v1, v8) <= arg5);
            0x1::vector::push_back<bool>(&mut v3, v10);
            0x1::vector::push_back<vector<u8>>(&mut v4, v11);
            0x1::vector::push_back<vector<u8>>(&mut v5, v12);
            0x1::vector::push_back<u256>(&mut v6, v13);
            0x1::vector::push_back<u256>(&mut v7, v14);
            v8 = v8 + 1;
        };
    ...
    public fun exact_pair_repay_raw(arg0: &0x2::clock::Clock, arg1: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: address, arg4: address, arg5: u8, arg6: u8, arg7: u8, arg8: u64, arg9: bool) : u64 {
        ...
        if (!0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::is_liquidatable(arg2, arg3, arg4)) {
            return 0
        };
        let v0 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_loan_balance(arg2, arg5, arg4);
        let v1 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_collateral_balance(arg2, arg6, arg4);
        if (v0 == 0 || v1 == 0) {
            return 0
        };
        let (v2, v3, _) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_liquidation_factors(arg2, arg6);
        let v5 = v3;
        if (arg9 && 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::is_in_emode(arg2, arg4)) {
            let (_, _, v8) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_emode_asset_info(arg2, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_emode_id(arg2, arg4), arg6);
            v5 = v8;
        };
        let v9 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_treasury_factor(arg2, arg6);
        let (v10, _, _, _, _, _) = preview_pair(arg0, arg1, arg2, arg5, arg6, v0, v0, v1, v2, v5, v9);
        normalized_repay_to_capped_raw(v10, arg7, arg8)
    }
    ...
    public fun liquidation_plan_batch(arg0: &0x2::clock::Clock, arg1: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: address, arg4: vector<address>, arg5: u256, arg6: bool) : (vector<u256>, vector<bool>, vector<bool>, vector<bool>, vector<bool>, vector<u8>, vector<u8>, vector<u256>, vector<u256>, vector<u256>, vector<u256>, vector<u256>, vector<u256>, vector<u256>, vector<u256>, vector<u256>, vector<u256>, vector<bool>) {
        ...
        while (v24 < v1) {
            ...
            let v26 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::is_liquidatable(arg2, arg3, v25);
            let (v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37, v38, v39, v40) = if (v26) {
                let (v41, v42, v43, v44, v45, v46, v47, v48, v49, v50, v51, v52, v53, v54) = best_liquidation_plan(arg0, arg1, arg2, v25, arg6);
                (v49, v50, v51, v52, v53, v54, v41, v42, v43, v44, v45, v46, v47, v48)
            } else {
                (0, 0, 0, 0, 0, false, false, 0, 0, 0, 0, 0, 0, 0)
            };
            0x1::vector::push_back<bool>(&mut v7, *0x1::vector::borrow<u256>(&v6, v24) <= arg5);
            0x1::vector::push_back<bool>(&mut v8, v26);
            0x1::vector::push_back<bool>(&mut v9, v26);
            0x1::vector::push_back<bool>(&mut v10, v33);
            0x1::vector::push_back<u8>(&mut v11, v34);
            0x1::vector::push_back<u8>(&mut v12, v35);
            0x1::vector::push_back<u256>(&mut v13, v36);
            0x1::vector::push_back<u256>(&mut v14, v37);
            0x1::vector::push_back<u256>(&mut v15, v38);
            0x1::vector::push_back<u256>(&mut v16, v39);
            0x1::vector::push_back<u256>(&mut v17, v40);
            0x1::vector::push_back<u256>(&mut v18, v27);
            0x1::vector::push_back<u256>(&mut v19, v28);
            0x1::vector::push_back<u256>(&mut v20, v29);
            0x1::vector::push_back<u256>(&mut v21, v30);
            0x1::vector::push_back<u256>(&mut v22, v31);
            0x1::vector::push_back<bool>(&mut v23, v32);
            v24 = v24 + 1;
        };
