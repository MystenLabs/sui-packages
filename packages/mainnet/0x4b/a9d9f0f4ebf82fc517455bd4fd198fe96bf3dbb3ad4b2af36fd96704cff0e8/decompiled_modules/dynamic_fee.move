module 0xd41e5cb31a5310f14d66f35cda3d2b3d0ab078959cbc015e63fff9829b83bf12::dynamic_fee {
    ...
    public fun update_fee_rates(arg0: &DynamicFeeCap, arg1: &mut DynamicFee, arg2: vector<u64>, arg3: vector<u64>, arg4: vector<u64>) {
        validate_fee_rates(&arg2, &arg3, &arg4);
        arg1.fee_mcaps = arg2;
    ...
    fun validate_fee_rates(arg0: &vector<u64>, arg1: &vector<u64>, arg2: &vector<u64>) {
        let v0 = 0x1::vector::length<u64>(arg0);
        assert!(v0 > 0, 0);
        assert!(v0 == 0x1::vector::length<u64>(arg1) && v0 == 0x1::vector::length<u64>(arg2), 0);
        let v1 = 0;
        while (v1 < v0) {
            let v2 = *0x1::vector::borrow<u64>(arg1, v1);
            let v3 = *0x1::vector::borrow<u64>(arg2, v1);
            assert!(*0x1::vector::borrow<u64>(arg0, v1) > 0, 0);
            assert!(v2 <= 100000 && v3 <= 100000, 0);
            assert!(v2 + v3 <= 100000, 0);
            v1 = v1 + 1;
        };
    }
