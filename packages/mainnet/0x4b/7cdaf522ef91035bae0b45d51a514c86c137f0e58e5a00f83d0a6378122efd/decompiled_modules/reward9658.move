module 0x4b7cdaf522ef91035bae0b45d51a514c86c137f0e58e5a00f83d0a6378122efd::reward9658 {
    struct REWARD9658 has drop {
        dummy_field: bool,
    }

    struct TICKET_9658 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9658(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9658>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9658>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9658, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9658>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9658>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9658>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9658>>(v5, 0x2::tx_context::sender(arg1));
    }
