module 0x4b940b46a30c84129bbbfe6922f2868dc5ef424c3272673873bf63e0ea2e0331::cnsnft8144 {
    struct CNSNFT8144 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8144, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8144>(arg0, arg1);
