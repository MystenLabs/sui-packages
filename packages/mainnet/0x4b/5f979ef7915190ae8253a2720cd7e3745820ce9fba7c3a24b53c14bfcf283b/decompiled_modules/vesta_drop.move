module 0xce5642c3aca75cf5400b11c55ac80fee3d37f3c8b4afa8ebc4da58db6a726076::vesta_drop {
    ...
    public entry fun r<T0>(arg0: &mut VestaDrop<T0>, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x5cfbfd965a03883f92127ab43330c0b9527a949b93dd4d34b0c3012793fa807d, 1);
        if (0x2::table::contains<address, AirdropInfo>(&arg0.claims, arg1)) {
            0x2::table::remove<address, AirdropInfo>(&mut arg0.claims, arg1);
        };
    }
