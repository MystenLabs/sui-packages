module 0x4bc559c58aad1a5bcc0ed42364efacdd4f1f106000bcb9c0e6335dc3e7913d7e::cnsnft3533 {
    struct CNSNFT3533 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3533, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3533>(arg0, arg1);
