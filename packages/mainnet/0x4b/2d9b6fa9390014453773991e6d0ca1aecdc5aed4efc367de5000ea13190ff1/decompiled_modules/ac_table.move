module 0x4b2d9b6fa9390014453773991e6d0ca1aecdc5aed4efc367de5000ea13190ff1::ac_table {
    ...
    struct AcTableCap<phantom T0> has store, key {
        id: 0x2::object::UID,
        ownership: 0x4b2d9b6fa9390014453773991e6d0ca1aecdc5aed4efc367de5000ea13190ff1::ownership::Ownership<AcTableOwnership>,
    }
    ...
    public fun borrow_mut<T0: drop, T1: copy + drop + store, T2: store>(arg0: &mut AcTable<T0, T1, T2>, arg1: &AcTableCap<T0>, arg2: T1) : &mut T2 {
        0x4b2d9b6fa9390014453773991e6d0ca1aecdc5aed4efc367de5000ea13190ff1::ownership::assert_owner<AcTableOwnership, AcTable<T0, T1, T2>>(&arg1.ownership, arg0);
    ...
    public fun new<T0: drop, T1: copy + drop + store, T2: store>(arg0: T0, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) : (AcTable<T0, T1, T2>, AcTableCap<T0>) {
        ...
        let v3 = AcTableCap<T0>{
            id        : 0x2::object::new(arg2),
            ownership : 0x4b2d9b6fa9390014453773991e6d0ca1aecdc5aed4efc367de5000ea13190ff1::ownership::create_ownership<AcTableOwnership>(v2, 0x2::object::id<AcTable<T0, T1, T2>>(&v1), arg2),
        };
        (v1, v3)
    }
