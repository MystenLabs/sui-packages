module 0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::umi_signer {
    ...
    public fun approve_with_tx(arg0: &mut UmiSigner, arg1: ChainId, arg2: &0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::SigningPolicy, arg3: 0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::SigningRequest, arg4: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg5: u32, arg6: u32, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) : (0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap, 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::MessageApproval, BorrowReceipt) {
        assert_version(arg0);
        assert!(has_wallet(arg0, arg1), 3);
        assert!(!is_borrowed(arg0, arg1), 21);
        assert!(0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::signer_id(&arg3) == 0x2::object::id<UmiSigner>(arg0), 7);
        assert!(0x2::object::id<0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::SigningPolicy>(arg2) == arg0.policy_id, 8);
        assert!(arg1.name == 0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::chain_id(&arg3), 18);
        assert!(0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::requires_message_binding(arg2), 10);
        let v0 = 0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::intent_hash(&arg3);
        assert!(0x2::hash::blake2b256(&arg7) == v0, 19);
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::enforce_request(arg2, &arg3);
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::destroy_request(arg3);
        let v1 = WalletKey{pos0: arg1};
        let v2 = 0x2::dynamic_field::remove<WalletKey, 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&mut arg0.id, v1);
        let v3 = 0x2::object::id<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v2);
        let v4 = LockKey{pos0: arg1};
        let v5 = WalletKey{pos0: arg1};
        let v6 = BorrowedWallet{
            wallet_id : v3,
            locked    : 0x2::dynamic_field::exists_<LockKey>(&arg0.id, v4),
        };
        0x2::dynamic_field::add<WalletKey, BorrowedWallet>(&mut arg0.id, v5, v6);
        arg0.last_signing_activity_ts = 0x2::tx_context::epoch_timestamp_ms(arg8);
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::events::signing_occurred(0x2::object::id<UmiSigner>(arg0), arg1.name, v3, v0);
        let v7 = BorrowReceipt{
            signer_id : 0x2::object::id<UmiSigner>(arg0),
            chain_id  : arg1,
            wallet_id : v3,
        };
        (v2, 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::approve_message(arg4, &v2, arg5, arg6, arg7), v7)
    }

    fun assert_version(arg0: &UmiSigner) {
        assert!(arg0.version == 1, 20);
    }

    public fun borrow_for_signing(arg0: &mut UmiSigner, arg1: ChainId, arg2: &0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::SigningPolicy, arg3: 0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::SigningRequest, arg4: &mut 0x2::tx_context::TxContext) : (0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap, BorrowReceipt) {
        assert_version(arg0);
        assert!(has_wallet(arg0, arg1), 3);
        assert!(!is_borrowed(arg0, arg1), 21);
        assert!(0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::signer_id(&arg3) == 0x2::object::id<UmiSigner>(arg0), 7);
        assert!(0x2::object::id<0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::SigningPolicy>(arg2) == arg0.policy_id, 8);
        assert!(arg1.name == 0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::chain_id(&arg3), 18);
        assert!(!0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::requires_message_binding(arg2), 9);
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::enforce_request(arg2, &arg3);
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::destroy_request(arg3);
        ...
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::events::signing_occurred(0x2::object::id<UmiSigner>(arg0), arg1.name, v2, 0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::intent_hash(&arg3));
    ...
    public fun close(arg0: UmiSigner, arg1: UmiSignerOwnerCap) {
        ...
        assert!(v6 == 1, 20);
        assert!(0x2::object::uid_to_inner(&v7) == v9, 0);
        assert!(v3 == 0, 2);
    ...
    entry fun default(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::share(v3);
        0x2::transfer::transfer<UmiSignerOwnerCap>(v2, v0);
        0x2::transfer::public_transfer<0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::SigningPolicyCap>(v4, v0);
    }
    ...
    public fun lock(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: 0x2::object::ID, arg4: &0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::SigningPolicy, arg5: 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap, arg6: 0x1::option::Option<0x2::object::ID>, arg7: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        ...
        if (v0) {
            ...
            0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::events::user_share_registered(0x2::object::id<UmiSigner>(arg0), arg2.name, v1, v2);
        } else {
            0x1::option::destroy_none<0x2::object::ID>(arg6);
        };
        arg0.last_owner_activity_ts = 0x2::tx_context::epoch_timestamp_ms(arg7);
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::events::wallet_placed(0x2::object::id<UmiSigner>(arg0), arg2.name, 0x2::object::id<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&arg5), true);
    }

    public fun migrate(arg0: &mut UmiSigner) {
        if (arg0.version < 1) {
            arg0.version = 1;
        };
    }
    ...
    public fun new_with_policy(arg0: address, arg1: &mut 0x2::tx_context::TxContext) : (UmiSigner, UmiSignerOwnerCap, 0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::SigningPolicy, 0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::SigningPolicyCap) {
        let (v0, v1) = 0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::new(arg1);
        let v2 = v1;
        let v3 = v0;
        let v4 = UmiSigner{
            id                       : 0x2::object::new(arg1),
            owner                    : arg0,
            policy_id                : 0x2::object::id<0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy::SigningPolicy>(&v3),
            wallet_count             : 0,
        ...
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::authorization_rule::add(&mut v3, &v2, v6);
        (v4, v5, v3, v2)
    }
    ...
    public fun place(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: 0x2::object::ID, arg4: 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap, arg5: 0x1::option::Option<0x2::object::ID>, arg6: &0x2::tx_context::TxContext) {
        ...
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::events::wallet_placed(0x2::object::id<UmiSigner>(arg0), arg2.name, 0x2::object::id<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&arg4), false);
    }
    ...
    public fun register_user_share(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: address, arg4: 0x2::object::ID, arg5: &0x2::tx_context::TxContext) {
        ...
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::events::user_share_registered(0x2::object::id<UmiSigner>(arg0), arg2.name, arg3, arg4);
    }
    ...
    public fun unregister_user_share(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: address, arg4: &0x2::tx_context::TxContext) {
        ...
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::events::user_share_unregistered(0x2::object::id<UmiSigner>(arg0), arg2.name, arg3, 0x2::dynamic_field::remove<UserShareKey, 0x2::object::ID>(&mut arg0.id, v0));
    }
    ...
    public fun withdraw(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: &0x2::tx_context::TxContext) : 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap {
        ...
        let v3 = 0x2::dynamic_field::remove<WalletMetaKey, WalletMeta>(&mut arg0.id, v2);
        if (v3.is_zero_trust) {
            let v4 = UserShareKey{
                pos0 : arg2,
                pos1 : arg0.owner,
            };
            0x2::dynamic_field::remove<UserShareKey, 0x2::object::ID>(&mut arg0.id, v4);
        };
        arg0.wallet_count = arg0.wallet_count - 1;
        arg0.last_owner_activity_ts = 0x2::tx_context::epoch_timestamp_ms(arg3);
        0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::events::wallet_withdrawn(0x2::object::id<UmiSigner>(arg0), arg2.name, 0x2::object::id<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v1));
        v1
    }
