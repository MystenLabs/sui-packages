module 0x4b577ff4a11f249add748645338745f4f044b7a51444c8d86e7b3f3f55bea02b::signing_policy {
    ...
    fun assert_version(arg0: &SigningPolicy) {
    ...
    public fun destroy(arg0: SigningPolicy, arg1: SigningPolicyCap) {
        ...
        let v9 = SigningPolicyDestroyed{id: v1};
        0x2::event::emit<SigningPolicyDestroyed>(v9);
    }
    ...
    public(friend) fun enforce_request(arg0: &SigningPolicy, arg1: &SigningRequest) {
        ...
        while (v3 < v1) {
            ...
            if (0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.main_rules, &v4)) {
                v2 = true;
            } else {
                assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.stackable_rules, &v4), 1);
            };
            v3 = v3 + 1;
        };
        if (0x2::vec_set::length<0x1::type_name::TypeName>(&arg0.main_rules) > 0) {
        ...
        let v5 = 0x2::vec_set::into_keys<0x1::type_name::TypeName>(arg0.stackable_rules);
        let v6 = 0;
        while (v6 < 0x1::vector::length<0x1::type_name::TypeName>(&v5)) {
            let v7 = *0x1::vector::borrow<0x1::type_name::TypeName>(&v5, v6);
            assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg1.receipts, &v7), 0);
            v6 = v6 + 1;
        };
        let v8 = 0x2::vec_set::length<0x1::type_name::TypeName>(&arg0.main_rules);
        let v9 = 0x2::vec_set::length<0x1::type_name::TypeName>(&arg0.stackable_rules);
        let v10 = if (v8 > 0) {
            1 + v9
        } else {
            v9
    ...
    public(friend) fun get_rule_mut_for_migration<T0: drop, T1: drop + store>(arg0: T0, arg1: &mut SigningPolicy) : &mut T1 {
        let v0 = RuleKey<T0>{dummy_field: false};
        0x2::dynamic_field::borrow_mut<RuleKey<T0>, T1>(&mut arg1.id, v0)
    }
    ...
    public fun migrate(arg0: &mut SigningPolicy) {
        if (arg0.version < 1) {
            arg0.version = 1;
        };
    }
    ...
    public fun version(arg0: &SigningPolicy) : u64 {
        assert_version(arg0);
        arg0.version
    }
