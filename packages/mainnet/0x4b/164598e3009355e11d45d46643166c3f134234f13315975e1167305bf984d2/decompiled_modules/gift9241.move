module 0x4b164598e3009355e11d45d46643166c3f134234f13315975e1167305bf984d2::gift9241 {
    struct GIFT9241 has drop {
        dummy_field: bool,
    }

    struct TICKET_9241 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9241(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9241>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9241>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9241, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9241>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9241>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9241>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9241>>(v5, 0x2::tx_context::sender(arg1));
    }
