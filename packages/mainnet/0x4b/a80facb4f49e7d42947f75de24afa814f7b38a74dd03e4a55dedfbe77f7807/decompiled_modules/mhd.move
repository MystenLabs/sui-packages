module 0x4ba80facb4f49e7d42947f75de24afa814f7b38a74dd03e4a55dedfbe77f7807::mhd {
    struct MHD has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MHD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<MHD>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MHD     ")))), trim_right(b"MHD                             "), trim_right(b"After an attempt on President Trump's life during his last speech, he told everyone to FIGHT, encouraging us to continue fighting to Make America Great Again                                                                                                                                                                   "), v2, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<MHD>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<MHD>>(v4);
    }
