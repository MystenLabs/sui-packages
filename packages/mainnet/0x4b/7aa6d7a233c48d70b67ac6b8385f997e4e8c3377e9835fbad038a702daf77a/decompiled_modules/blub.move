module 0x4b7aa6d7a233c48d70b67ac6b8385f997e4e8c3377e9835fbad038a702daf77a::blub {
    ...
    fun init(arg0: BLUB, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<BLUB>(&mut v2, 1000000000000 * 0x1::u64::pow(10, 2), 0x2::tx_context::sender(arg1), arg1);
