module 0x4ba838c7ded1b57aededff4e825aa251858b05b720083856351dd8325094a13e::stream {
    ...
    struct TranchePaid has copy, drop {
        stream_id: 0x2::object::ID,
        recipient: address,
        amount: u64,
        tranche_index: u64,
    ...
    public fun add_worker(arg0: &StreamAdminCap, arg1: &mut StreamRegistry, arg2: address) {
        assert!(!0x1::vector::contains<address>(&arg1.worker_addresses, &arg2), 209);
        0x1::vector::push_back<address>(&mut arg1.worker_addresses, arg2);
    ...
    public fun remove_worker(arg0: &StreamAdminCap, arg1: &mut StreamRegistry, arg2: address) {
        let (v0, v1) = 0x1::vector::index_of<address>(&arg1.worker_addresses, &arg2);
        assert!(v0, 210);
        0x1::vector::remove<address>(&mut arg1.worker_addresses, v1);
    ...
    public fun set_paused(arg0: &StreamAdminCap, arg1: &mut StreamRegistry, arg2: bool) {
        arg1.paused = arg2;
    }
