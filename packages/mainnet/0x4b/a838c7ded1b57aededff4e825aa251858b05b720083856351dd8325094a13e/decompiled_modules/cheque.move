module 0x4ba838c7ded1b57aededff4e825aa251858b05b720083856351dd8325094a13e::cheque {
    ...
    public fun add_worker(arg0: &ChequeAdminCap, arg1: &mut ChequeRegistry, arg2: address) {
        assert!(!0x1::vector::contains<address>(&arg1.worker_addresses, &arg2), 307);
    ...
    public fun claim<T0>(arg0: &mut ChequeRegistry, arg1: &mut Cheque<T0>, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 303);
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x1::vector::contains<address>(&arg0.worker_addresses, &v0), 302);
        assert!(!arg1.claimed, 304);
        assert!(0x2::clock::timestamp_ms(arg3) < arg1.expiry_ms, 305);
        arg1.claimed = true;
    ...
    public fun create<T0>(arg0: &mut ChequeRegistry, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x2::balance::value<T0>(&arg1);
        assert!(v0 > 0, 300);
        assert!(arg2 > 0x2::clock::timestamp_ms(arg3), 301);
        let v1 = Cheque<T0>{
    ...
    public fun remove_worker(arg0: &ChequeAdminCap, arg1: &mut ChequeRegistry, arg2: address) {
    ...
    public fun set_paused(arg0: &ChequeAdminCap, arg1: &mut ChequeRegistry, arg2: bool) {
        arg1.paused = arg2;
    }
