module 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pool {
    ...
    public(friend) fun burn_from_pit_internal<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<T1>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun buy<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config::Config, arg2: &mut 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::Pit<T1>, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config::assert_official_pit_if_registered<T1>(arg1, arg2);
        ...
        let v7 = distribute_reflection<T0, T1>(arg0, v4);
        let v8 = &mut arg3;
        pipe_fees<T0, T1>(arg0, arg1, arg2, v8, v1, v2, v3, v4, v7, arg6);
        0x2::balance::join<T1>(&mut arg0.quote_reserve, 0x2::coin::into_balance<T1>(arg3));
        let v9 = 0x2::balance::split<T0>(&mut arg0.token_reserve, v6);
        arg0.raised = arg0.raised + v5;
        credit_holder<T0, T1>(arg0, 0x2::tx_context::sender(arg6), v6);
        0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::nudge_internal<T1>(arg2, 0x2::object::id<Pool<T0, T1>>(arg0), market_cap_metric<T0, T1>(arg0), arg0.graduated, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config::round_ms(arg1), arg5);
        maybe_graduate<T0, T1>(arg0);
    ...
    fun debit_holder<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: address, arg2: u64) {
        assert!(0x2::table::contains<address, Holder>(&arg0.holders, arg1), 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::unregistered_seller());
        let v0 = arg0.refl_mps;
        let v1 = arg0.pit_mps;
        let v2 = 0x2::table::borrow_mut<address, Holder>(&mut arg0.holders, arg1);
        accure(v2, v0, v1);
        assert!(v2.amount >= arg2, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::unregistered_seller());
        v2.amount = v2.amount - arg2;
        v2.refl_debt = (v2.amount as u256) * v0;
        v2.pit_debt = (v2.amount as u256) * v1;
        arg0.total_registered = arg0.total_registered - arg2;
    ...
    fun distribute_reflection<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64) : bool {
        if (arg1 == 0 || arg0.total_registered == 0) {
            return false
        };
    ...
    public fun forfeit_unburnable<T0, T1>(arg0: &Pool<T0, T1>, arg1: &mut 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::Pit<T1>) {
        assert!(arg0.pit_mode == 1, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::invalid_pit_mode());
        assert!(arg0.lp_locked || 0x2::balance::value<T0>(&arg0.token_reserve) == 0, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::still_burnable());
        0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::forfeit<T1>(arg1, 0x2::object::id<Pool<T0, T1>>(arg0));
    }

    public fun graduate<T0, T1>(arg0: &mut Pool<T0, T1>) {
        assert!(!arg0.graduated, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::graduated());
        assert!(0x2::balance::value<T1>(&arg0.quote_reserve) >= arg0.graduation_threshold, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::not_graduated());
    ...
    fun maybe_graduate<T0, T1>(arg0: &mut Pool<T0, T1>) {
        if (!arg0.graduated && 0x2::balance::value<T1>(&arg0.quote_reserve) >= arg0.graduation_threshold) {
            do_graduate<T0, T1>(arg0);
        };
    }
    ...
    fun pipe_fees<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config::Config, arg2: &mut 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::Pit<T1>, arg3: &mut 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) {
        if (arg6 > 0) {
            0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::take_fee_internal<T1>(arg2, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(arg3, arg6, arg9)));
        };
        if (arg4 > 0) {
            0x2::balance::join<T1>(&mut arg0.creator_pot, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(arg3, arg4, arg9)));
        };
        if (arg5 > 0) {
            0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config::take_platform<T1>(arg1, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(arg3, arg5, arg9)));
        };
        if (arg7 > 0) {
            if (arg8) {
                0x2::balance::join<T1>(&mut arg0.reflection_pot, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(arg3, arg7, arg9)));
            } else {
                0x2::balance::join<T1>(&mut arg0.creator_pot, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(arg3, arg7, arg9)));
            };
        };
    }
    ...
    public fun sell<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config::Config, arg2: &mut 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::Pit<T1>, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (v6 > 0) {
            0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::take_fee_internal<T1>(arg2, 0x2::balance::split<T1>(&mut v9, v6));
        };
        if (v4 > 0) {
        ...
        if (v7 > 0) {
            if (distribute_reflection<T0, T1>(arg0, v7)) {
                0x2::balance::join<T1>(&mut arg0.reflection_pot, 0x2::balance::split<T1>(&mut v9, v7));
            } else {
                0x2::balance::join<T1>(&mut arg0.creator_pot, 0x2::balance::split<T1>(&mut v9, v7));
            };
        };
        0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::nudge_internal<T1>(arg2, 0x2::object::id<Pool<T0, T1>>(arg0), market_cap_metric<T0, T1>(arg0), arg0.graduated, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config::round_ms(arg1), arg5);
    ...
    public fun settle_pit<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::Pit<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        if (arg0.pit_mode == 0) {
            ...
            let v0 = 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::settle_to_holders_internal<T1>(arg1, 0x2::object::id<Pool<T0, T1>>(arg0));
            0x2::balance::join<T1>(&mut arg0.pit_claim_pot, v0);
            distribute_pit<T0, T1>(arg0, 0x2::balance::value<T1>(&v0));
        } else {
            assert!(arg0.pit_mode == 1, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::invalid_pit_mode());
            if (arg0.lp_locked || 0x2::balance::value<T0>(&arg0.token_reserve) == 0) {
                0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::forfeit<T1>(arg1, 0x2::object::id<Pool<T0, T1>>(arg0));
                return
            };
            let v1 = 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::settle_burn_quote_internal<T1>(arg1, 0x2::object::id<Pool<T0, T1>>(arg0));
            burn_from_pit_internal<T0, T1>(arg0, v1, arg2);
        };
    }
