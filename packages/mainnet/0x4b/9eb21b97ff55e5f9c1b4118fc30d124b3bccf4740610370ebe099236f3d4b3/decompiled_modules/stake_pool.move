module 0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::stake_pool {
    ...
    public(friend) fun get_user_shares(arg0: &StakePoolRegistry, arg1: u64, arg2: address) : vector<vector<u8>> {
        ...
        let v1 = 0x2::dynamic_field::borrow<0x1::string::String, 0x2::table::Table<address, vector<LpUserShare>>>(&v0.id, 0x1::string::utf8(b"lp_user_shares"));
        let v2 = 0x1::vector::empty<vector<u8>>();
        if (!0x2::table::contains<address, vector<LpUserShare>>(v1, arg2)) {
            return v2
        };
        let v3 = 0x2::table::borrow<address, vector<LpUserShare>>(v1, arg2);
        let v4 = get_incentive_tokens(v0);
        let v5 = 0;
        while (v5 < 0x1::vector::length<LpUserShare>(v3)) {
            let v6 = 0x1::vector::borrow<LpUserShare>(v3, v5);
            let v7 = 0x1::vector::empty<u64>();
            let v8 = &v4;
            let v9 = 0;
            while (v9 < 0x1::vector::length<0x1::type_name::TypeName>(v8)) {
                let (v10, _) = calculate_incentive(v0, 0x1::vector::borrow<0x1::type_name::TypeName>(v8, v9), v6);
                0x1::vector::push_back<u64>(&mut v7, v10);
                v9 = v9 + 1;
            };
            let v12 = 0x2::bcs::to_bytes<LpUserShare>(v6);
            0x1::vector::append<u8>(&mut v12, 0x2::bcs::to_bytes<vector<u64>>(&v7));
            0x1::vector::push_back<vector<u8>>(&mut v2, v12);
            v5 = v5 + 1;
        };
        v2
    }
