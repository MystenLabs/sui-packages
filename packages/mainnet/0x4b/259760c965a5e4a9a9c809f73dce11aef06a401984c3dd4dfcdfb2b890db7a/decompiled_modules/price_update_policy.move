module 0x4b259760c965a5e4a9a9c809f73dce11aef06a401984c3dd4dfcdfb2b890db7a::price_update_policy {
    struct PriceUpdateRequest<phantom T0> {
        for_policy: 0x2::object::ID,
        receipts: 0x2::vec_set::VecSet<0x1::type_name::TypeName>,
        price_feeds: vector<0x4b259760c965a5e4a9a9c809f73dce11aef06a401984c3dd4dfcdfb2b890db7a::price_feed::PriceFeed>,
    }
    ...
    public fun add_price_feed<T0, T1: drop>(arg0: T1, arg1: &mut PriceUpdateRequest<T0>, arg2: 0x4b259760c965a5e4a9a9c809f73dce11aef06a401984c3dd4dfcdfb2b890db7a::price_feed::PriceFeed) {
        0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg1.receipts, 0x1::type_name::with_defining_ids<T1>());
        0x1::vector::push_back<0x4b259760c965a5e4a9a9c809f73dce11aef06a401984c3dd4dfcdfb2b890db7a::price_feed::PriceFeed>(&mut arg1.price_feeds, arg2);
    }
    ...
    public fun confirm_request<T0>(arg0: PriceUpdateRequest<T0>, arg1: &PriceUpdatePolicy) : vector<0x4b259760c965a5e4a9a9c809f73dce11aef06a401984c3dd4dfcdfb2b890db7a::price_feed::PriceFeed> {
    ...
    public fun new_request<T0>(arg0: &PriceUpdatePolicy) : PriceUpdateRequest<T0> {
        PriceUpdateRequest<T0>{
            ...
            price_feeds : 0x1::vector::empty<0x4b259760c965a5e4a9a9c809f73dce11aef06a401984c3dd4dfcdfb2b890db7a::price_feed::PriceFeed>(),
        }
    }
