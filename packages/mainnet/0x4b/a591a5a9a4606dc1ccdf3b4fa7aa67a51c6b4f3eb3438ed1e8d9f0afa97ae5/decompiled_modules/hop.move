module 0x4ba591a5a9a4606dc1ccdf3b4fa7aa67a51c6b4f3eb3438ed1e8d9f0afa97ae5::hop {
    struct HOP has drop {
        dummy_field: bool,
    }
    ...
    public entry fun remove_publisher_node_ids(arg0: &Owner, arg1: &mut PublisherDetails, arg2: &mut PublisherNodesDetails, arg3: address, arg4: vector<u64>, arg5: 0x1::string::String, arg6: &UpgradeVersion, arg7: &0x2::tx_context::TxContext) {
        ...
        if (0x2::vec_map::contains<address, 0x2::vec_map::VecMap<0x1::string::String, NodeDetails>>(&arg1.user_details, &arg3)) {
            ...
            if (0x2::vec_map::contains<0x1::string::String, NodeDetails>(v0, &arg5)) {
