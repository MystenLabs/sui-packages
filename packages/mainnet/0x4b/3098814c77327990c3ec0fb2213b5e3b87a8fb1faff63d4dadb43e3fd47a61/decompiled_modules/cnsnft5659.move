module 0x4b3098814c77327990c3ec0fb2213b5e3b87a8fb1faff63d4dadb43e3fd47a61::cnsnft5659 {
    struct CNSNFT5659 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5659, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7567"));
        let v4 = 0x2::package::claim<CNSNFT5659>(arg0, arg1);
