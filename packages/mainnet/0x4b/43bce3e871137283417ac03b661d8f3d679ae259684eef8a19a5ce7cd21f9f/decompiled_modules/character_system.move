module 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::character_system {
    ...
    public fun admin_mint_character(arg0: &0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::CharacterAdminCap, arg1: &mut 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::GlobalGameState, arg2: u64, arg3: u8, arg4: vector<u8>, arg5: vector<u8>, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 >= 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_r() && arg3 <= 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_ssr(), 7);
        0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::validate_url_bytes(&arg5);
        let v0 = 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::get_next_character_id(arg1);
        0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::update_character_stats(arg1, arg3);
        let v1 = if (arg3 == 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_r()) {
            0x1::string::utf8(b"R")
        } else if (arg3 == 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_sr()) {
        ...
        0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::emit_item_minted(0x1::string::utf8(b"Character"), v0, arg3, v2.name, arg6, v2.timeline);
        0x2::transfer::public_transfer<Character>(v2, arg6);
    }

    public fun admin_mint_crown(arg0: &0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::CharacterAdminCap, arg1: &mut 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::GlobalGameState, arg2: u8, arg3: vector<u8>, arg4: address, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 == 1 || arg2 == 2, 2);
        0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::validate_url_bytes(&arg3);
        ...
        let v2 = 0;
        while (v2 < arg5) {
            let v3 = 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::get_next_crown_id(arg1);
            let v4 = Crown{
    ...
    public fun assert_upgrade_version(arg0: &GlobalCharacterUpgradeState) {
    ...
    public(friend) fun check_and_increment_5star_cap(arg0: &mut GlobalCharacterUpgradeState, arg1: u64, arg2: u8) {
        assert_upgrade_state_version(arg0);
        let (v0, v1) = if (arg2 == 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_ssr()) {
    ...
    public(friend) fun create_awakened_character(arg0: &mut 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::GlobalGameState, arg1: u64, arg2: 0x1::string::String, arg3: vector<u8>, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) : Character {
        0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::validate_url_bytes(&arg3);
        let v0 = 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::get_next_character_id(arg0);
        0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::update_character_stats(arg0, arg4);
        let v1 = if (arg4 == 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_ssr()) {
            0x1::string::utf8(b"SSR")
        } else {
            0x1::string::utf8(b"SR")
        };
        ...
        0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::emit_item_minted(0x1::string::utf8(b"Character"), v0, arg4, v3.name, 0x2::tx_context::sender(arg5), v3.timeline);
        v3
    }

    public(friend) fun create_character_from_template(arg0: &mut 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::GlobalGameState, arg1: 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::CharacterTemplate, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) : Character {
        let v0 = 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::get_next_character_id(arg0);
        0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::update_character_stats(arg0, arg2);
        let (v1, v2, v3) = 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::get_template_data(&arg1);
        let v4 = v3;
        let v5 = if (arg2 == 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_r()) {
            0x1::string::utf8(b"R")
        } else if (arg2 == 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_sr()) {
            0x1::string::utf8(b"SR")
        } else {
            0x1::string::utf8(b"SSR")
        };
        ...
        0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::emit_item_minted(0x1::string::utf8(b"Character"), v0, arg2, v6.name, 0x2::tx_context::sender(arg3), v6.timeline);
        v6
    }
    ...
    public fun get_star_up_fragment_requirement(arg0: u8) : u64 {
        if (arg0 == 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_ssr()) {
            100
        } else {
            60
        }
    ...
    fun get_starting_star_for_rarity(arg0: u8) : u8 {
        if (arg0 == 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_ssr()) {
            3
        } else if (arg0 == 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_sr()) {
            2
        } else {
            1
        }
    ...
    fun handle_alb_tax(arg0: &mut 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::alb_token::TokenTreasury, arg1: 0x2::coin::Coin<0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::alb_token::ALB_TOKEN>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2 == 0) {
            ...
            assert!(0x2::coin::value<0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::alb_token::ALB_TOKEN>(&arg1) >= arg2, 12);
    ...
    fun init(arg0: CHARACTER_SYSTEM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Character>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{rarity_text} Rarity | A powerful character in the Albuspaths universe"));
        ...
        0x2::display::add<Character>(&mut v1, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"Albuspaths"));
        ...
        0x2::display::add<Crown>(&mut v2, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"Albuspaths"));
    ...
    public fun migrate_global_character_upgrade_state(arg0: &0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::CharacterAdminCap, arg1: &mut GlobalCharacterUpgradeState) {
    ...
    public fun set_star_up_alb_costs(arg0: &0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::CharacterAdminCap, arg1: &mut GlobalCharacterUpgradeState, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
    ...
    public fun star_up_with_crown(arg0: &mut GlobalCharacterUpgradeState, arg1: &mut 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::alb_token::TokenTreasury, arg2: &mut Character, arg3: Crown, arg4: 0x2::coin::Coin<0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::alb_token::ALB_TOKEN>, arg5: &mut 0x2::tx_context::TxContext) {
        assert_upgrade_state_version(arg0);
        assert!(!arg2.is_awakened, 13);
        ...
        let v4 = arg2.game_id;
        let (v5, v6) = if (arg2.rarity == 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_ssr()) {
    ...
    public fun star_up_with_duplicate(arg0: &GlobalCharacterUpgradeState, arg1: &mut 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::alb_token::TokenTreasury, arg2: &mut Character, arg3: Character, arg4: 0x2::coin::Coin<0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::alb_token::ALB_TOKEN>, arg5: &mut 0x2::tx_context::TxContext) {
        assert_upgrade_state_version(arg0);
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::tx_context::epoch_timestamp_ms(arg5);
        assert!(arg2.star_rating < 5, 0);
        if (arg2.rarity != 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_r()) {
    ...
    public(friend) fun upgrade_star_rating_from_wildcard(arg0: &mut Character, arg1: u8, arg2: address, arg3: u64) : (u8, u8) {
        assert!(arg0.star_rating < 5, 0);
        if (arg0.rarity != 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::rarity_r()) {
            assert!(arg0.star_rating < 5 - 1, 5);
        };
    ...
    public fun withdraw_character_royalties(arg0: &0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core::CharacterAdminCap, arg1: &mut 0x2::transfer_policy::TransferPolicy<Character>, arg2: &0x2::transfer_policy::TransferPolicyCap<Character>, arg3: 0x1::option::Option<u64>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
