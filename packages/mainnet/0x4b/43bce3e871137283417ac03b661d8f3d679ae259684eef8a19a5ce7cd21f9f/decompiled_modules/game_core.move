module 0x4b43bce3e871137283417ac03b661d8f3d679ae259684eef8a19a5ce7cd21f9f::game_core {
    ...
    struct BannerRotated has copy, drop {
        deactivated_game_ids: vector<u64>,
        activated_game_ids: vector<u64>,
        operator: address,
        timestamp: u64,
    }
    ...
    fun assert_game_state_version(arg0: &GlobalGameState) {
        assert!(arg0.version == 1, 5);
    }

    fun assert_pools_non_empty(arg0: &TemplateRegistry) {
        assert!(!0x1::vector::is_empty<u64>(&arg0.active_ssr_pool), 1);
        assert!(!0x1::vector::is_empty<u64>(&arg0.active_sr_pool), 1);
        assert!(!0x1::vector::is_empty<u64>(&arg0.active_r_pool), 1);
    }

    fun assert_registry_version(arg0: &TemplateRegistry) {
        assert!(arg0.version == 1, 5);
    }
    ...
    public fun batch_rotate_banner(arg0: &CharacterAdminCap, arg1: &mut TemplateRegistry, arg2: vector<u64>, arg3: vector<u8>, arg4: vector<u64>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<u64>(&arg2);
        let v1 = 0x1::vector::length<u64>(&arg4);
        assert!(v0 == 0x1::vector::length<u8>(&arg3), 3);
        assert!(v1 == 0x1::vector::length<u8>(&arg5), 3);
        let v2 = 0;
        while (v2 < v0) {
            deactivate_template_inner(arg1, *0x1::vector::borrow<u64>(&arg2, v2), *0x1::vector::borrow<u8>(&arg3, v2));
            v2 = v2 + 1;
        };
        let v3 = 0;
        while (v3 < v1) {
            reactivate_template(arg0, arg1, *0x1::vector::borrow<u64>(&arg4, v3), *0x1::vector::borrow<u8>(&arg5, v3), arg6);
            v3 = v3 + 1;
        };
        assert_pools_non_empty(arg1);
        let v4 = BannerRotated{
            deactivated_game_ids : arg2,
            activated_game_ids   : arg4,
            operator             : 0x2::tx_context::sender(arg6),
            timestamp            : 0x2::tx_context::epoch_timestamp_ms(arg6),
        };
        0x2::event::emit<BannerRotated>(v4);
    }
    ...
    public fun deactivate_template(arg0: &CharacterAdminCap, arg1: &mut TemplateRegistry, arg2: u64, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        deactivate_template_inner(arg1, arg2, arg3);
        assert_pools_non_empty(arg1);
    }

    fun deactivate_template_inner(arg0: &mut TemplateRegistry, arg1: u64, arg2: u8) {
        assert_registry_version(arg0);
        assert!(template_exists(arg0, arg1, arg2), 0);
        let v0 = if (arg2 == 3) {
            &mut arg0.active_ssr_pool
        } else if (arg2 == 2) {
            &mut arg0.active_sr_pool
        } else {
            &mut arg0.active_r_pool
        };
        let (v1, v2) = 0x1::vector::index_of<u64>(v0, &arg1);
        if (v1) {
    ...
    public fun get_default_r_templates() : vector<CharacterTemplate> {
        ...
        let v1 = CharacterTemplate{
            game_id   : 10100,
            name      : 0x1::string::utf8(b"Hutao"),
            image_url : 0x1::string::utf8(b"https://img.albuspaths.com/10100.png"),
        };
        let v2 = CharacterTemplate{
            game_id   : 10101,
            name      : 0x1::string::utf8(b"Mikan"),
            image_url : 0x1::string::utf8(b"https://img.albuspaths.com/10101.png"),
        };
        let v3 = CharacterTemplate{
            game_id   : 10102,
            name      : 0x1::string::utf8(b"Banri"),
            image_url : 0x1::string::utf8(b"https://img.albuspaths.com/10102.png"),
        };
        let v4 = CharacterTemplate{
            game_id   : 10104,
            name      : 0x1::string::utf8(b"Tenmonji Aoi"),
            image_url : 0x1::string::utf8(b"https://img.albuspaths.com/10104.png"),
        };
        let v5 = CharacterTemplate{
            game_id   : 10105,
            name      : 0x1::string::utf8(b"Spirit Tuner"),
            image_url : 0x1::string::utf8(b"https://img.albuspaths.com/10105.png"),
        };
        let v6 = CharacterTemplate{
            game_id   : 10400,
            name      : 0x1::string::utf8(b"Alice"),
            image_url : 0x1::string::utf8(b"https://img.albuspaths.com/10400.png"),
        };
        let v7 = CharacterTemplate{
            game_id   : 10002,
            name      : 0x1::string::utf8(b"Kuwamari Saki"),
            image_url : 0x1::string::utf8(b"https://img.albuspaths.com/10002.png"),
        };
        let v8 = 0x1::vector::empty<CharacterTemplate>();
        let v9 = &mut v8;
        0x1::vector::push_back<CharacterTemplate>(v9, v0);
        0x1::vector::push_back<CharacterTemplate>(v9, v1);
        0x1::vector::push_back<CharacterTemplate>(v9, v2);
        0x1::vector::push_back<CharacterTemplate>(v9, v3);
        0x1::vector::push_back<CharacterTemplate>(v9, v4);
        0x1::vector::push_back<CharacterTemplate>(v9, v5);
        0x1::vector::push_back<CharacterTemplate>(v9, v6);
        0x1::vector::push_back<CharacterTemplate>(v9, v7);
        v8
    }
    ...
    public(friend) fun get_next_character_id(arg0: &mut GlobalGameState) : u64 {
        assert_game_state_version(arg0);
    ...
    public(friend) fun u64_to_ascii_bytes(arg0: u64) : vector<u8> {
        if (arg0 == 0) {
            return b"0"
        };
