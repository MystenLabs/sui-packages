module 0x4b006fbc89cb0737076ea01f7c64f5ab984b903321421fb1a50f489feec8ed7c::collection_escrow {
    struct Ext has drop {
        dummy_field: bool,
    }
    ...
    public fun offer<T0: store + key>(arg0: &0x4b006fbc89cb0737076ea01f7c64f5ab984b903321421fb1a50f489feec8ed7c::marketplace::MarketPlace, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::into_balance<0x2::sui::SUI>(arg3);
        let v1 = 0x2::balance::value<0x2::sui::SUI>(&v0);
        let v2 = (((0x4b006fbc89cb0737076ea01f7c64f5ab984b903321421fb1a50f489feec8ed7c::marketplace::get_fee(arg0, 0x2::tx_context::sender(arg5)) as u128) * (v1 as u128) / 10000) as u64);
