module 0x4be61104567ad34bd23ff06b58aee7c2643026a359b7aae7f4d3740d1bdb5fee::reward5195 {
    struct REWARD5195 has drop {
        dummy_field: bool,
    }

    struct TICKET_5195 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5195(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5195>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5195>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5195, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5195>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5195>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5195>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5195>>(v5, 0x2::tx_context::sender(arg1));
    }
