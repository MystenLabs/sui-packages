module 0x4b7c7b802ca2bd9af65f520bab1c725c5ec79319cf2bec4f77eaaa07225245b9::roko {
    ...
    fun init(arg0: ROKO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<ROKO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"ROKO    ")))), trim_right(b"ROKO'S BASILISK                 "), trim_right(b"Roko's basilisk is a thought experiment which states that an otherwise benevolent artificial superintelligence (AI) in the future                                                                                                                                                                                               "), v2, arg1);
