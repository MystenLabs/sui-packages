module 0x4b7da0c452601862d964fcbeda48cec6de5fb8697879686d0cb97f61ca77e1b2::staked_share {
    ...
    public entry fun new_and_share_number_pool_and_share_supply<T0: store, T1: store + key>(arg0: &0x4b7da0c452601862d964fcbeda48cec6de5fb8697879686d0cb97f61ca77e1b2::pool::AdminCap, arg1: &mut 0x4b7da0c452601862d964fcbeda48cec6de5fb8697879686d0cb97f61ca77e1b2::pool::Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = NumberPool<T0, T1>{
            id               : 0x2::object::new(arg2),
            available_shares : 0x1::vector::empty<StakedPoolShare<T0, T1>>(),
        };
        0x4b7da0c452601862d964fcbeda48cec6de5fb8697879686d0cb97f61ca77e1b2::pool::fill_number_pool<T0, T1>(arg1, 0x2::object::uid_to_inner(&v0.id));
