module 0x4bbfc3ad28ebf54cf0810eb2377a2d08d6f9a00cff539e9b01f75652c7bd62d0::reward8981 {
    struct REWARD8981 has drop {
        dummy_field: bool,
    }

    struct TICKET_8981 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8981(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8981>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8981>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8981, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8981>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8981>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8981>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8981>>(v5, 0x2::tx_context::sender(arg1));
    }
