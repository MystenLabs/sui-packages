module 0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_pool {
    ...
    public(friend) fun accrue_fees<T0>(arg0: &mut LLVPool<T0>, arg1: u128, arg2: u64) : u128 {
        ...
        if (arg0.management_fee_bps > 0) {
            ...
            if (v3) {
                v0 = 0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_math::mul_div(v2, arg0.total_shares, arg1);
            };
        };
        if (arg0.performance_fee_bps > 0 && arg1 > arg0.last_total_assets) {
            let v4 = 0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_math::mul_div(arg1 - arg0.last_total_assets, (arg0.performance_fee_bps as u128), (10000 as u128));
            let v5 = if (v4 > 0) {
                if (arg0.total_shares > 0) {
                    arg1 > 0
                } else {
            ...
            if (v5) {
                v1 = 0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_math::mul_div(v4, arg0.total_shares, arg1);
            };
        };
        let v6 = v0 + v1;
        arg0.last_fee_collection_ms = arg2;
        ...
        if (v6 > 0) {
            0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_events::emit_fees_accrued(0x2::object::id<LLVPool<T0>>(arg0), v0, v1, v6, arg0.fee_recipient, arg2);
        };
        v6
    }

    public(friend) fun add_keeper<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: address, arg3: &0x2::clock::Clock) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        ...
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_events::emit_keeper_updated(0x2::object::id<LLVPool<T0>>(arg0), arg2, true, 0x2::clock::timestamp_ms(arg3));
    }

    public(friend) fun add_protocol<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: u8, arg3: u64, arg4: bool, arg5: &0x2::clock::Clock) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        ...
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_events::emit_update_protocol(0x2::object::id<LLVPool<T0>>(arg0), arg2, 0, arg4, arg3, 0, 0, 0, 0, 0x2::clock::timestamp_ms(arg5));
    }
    ...
    public(friend) fun claim_fee_shares<T0>(arg0: &mut LLVPool<T0>, arg1: address) : (u128, u128) {
        ...
        (v0, 0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_math::calculate_assets_for_shares(arg0.total_shares, get_total_assets<T0>(arg0), v0))
    }
    ...
    public(friend) fun create_pool<T0>(arg0: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVGlobalAdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : (LLVPool<T0>, 0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap) {
        let v0 = LLVPool<T0>{
            id                          : 0x2::object::new(arg2),
            allocations                 : 0x2::vec_map::empty<u8, ProtocolAllocation>(),
            protocol_configs            : 0x2::vec_map::empty<u8, ProtocolConfig>(),
            total_shares                : 0,
            global_yield_index          : 0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_math::scale(),
            paused                      : false,
            min_deposit                 : 1000,
            deposit_cap                 : 0,
        ...
        let v2 = 0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::create_pool_admin_cap(v1, arg2);
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_events::emit_pool_created(v1, 0x2::object::id<0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap>(&v2), 0x1::type_name::with_defining_ids<T0>(), 0x2::tx_context::sender(arg2), v0.paused, v0.min_deposit, v0.deposit_cap, v0.performance_fee_bps, v0.management_fee_bps, v0.fee_recipient, v0.min_rebalance_interval_ms, v0.min_rebalance_deviation_bps, 0x2::clock::timestamp_ms(arg1));
        (v0, v2)
    }
    ...
    public(friend) fun emergency_withdraw_protocol<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: u8) : u128 {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
    ...
    public(friend) fun pause<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        arg0.paused = true;
    }
    ...
    public(friend) fun remove_keeper<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: address, arg3: &0x2::clock::Clock) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        let (v0, v1) = 0x1::vector::index_of<address>(&arg0.keepers, &arg2);
        assert!(v0, 107);
        0x1::vector::remove<address>(&mut arg0.keepers, v1);
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_events::emit_keeper_updated(0x2::object::id<LLVPool<T0>>(arg0), arg2, false, 0x2::clock::timestamp_ms(arg3));
    }

    public(friend) fun remove_protocol<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: u8, arg3: &0x2::clock::Clock) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        assert!(0x2::vec_map::contains<u8, ProtocolAllocation>(&arg0.allocations, &arg2), 3);
        ...
        validate_total_ratio<T0>(arg0);
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_events::emit_update_protocol(0x2::object::id<LLVPool<T0>>(arg0), arg2, 2, v0.enabled, v0.target_ratio_bps, v0.deposited_amount, v0.current_balance, v0.last_sync_ms, v1, 0x2::clock::timestamp_ms(arg3));
    }

    public(friend) fun set_deposit_cap<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: u128) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        arg0.deposit_cap = arg2;
    }

    public(friend) fun set_fee_recipient<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: address) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        assert!(arg0.fee_recipient_shares == 0, 111);
        arg0.fee_recipient = arg2;
    }

    public(friend) fun set_management_fee<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: u64) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        assert!(arg2 <= 500, 104);
        arg0.management_fee_bps = arg2;
    }

    public(friend) fun set_min_deposit<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: u64) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        arg0.min_deposit = arg2;
    }

    public(friend) fun set_min_rebalance_deviation<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: u64) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        assert!(arg2 >= 10, 121);
        arg0.min_rebalance_deviation_bps = arg2;
    }

    public(friend) fun set_min_rebalance_interval<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: u64) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        assert!(arg2 >= 60000, 120);
        arg0.min_rebalance_interval_ms = arg2;
    }

    public(friend) fun set_performance_fee<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: u64) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        assert!(arg2 <= 5000, 104);
        arg0.performance_fee_bps = arg2;
    }

    public(friend) fun set_protocol_config<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: u8, arg3: ProtocolConfig, arg4: &0x2::clock::Clock) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        ...
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_events::emit_update_protocol_config(0x2::object::id<LLVPool<T0>>(arg0), arg2, v0, arg3.ids, arg3.values, v1, 0x2::clock::timestamp_ms(arg4));
    }

    public(friend) fun set_supply_queue<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: vector<u8>) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
    ...
    public(friend) fun set_withdraw_queue<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: vector<u8>) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        validate_queue<T0>(arg0, &arg2);
    ...
    public(friend) fun unpause<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        arg0.paused = false;
    }

    public(friend) fun update_apr<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: u8, arg3: u64, arg4: &0x2::clock::Clock) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        assert!(0x2::vec_map::contains<u8, ProtocolAllocation>(&arg0.allocations, &arg2), 3);
        let v0 = 0x2::vec_map::get_mut<u8, ProtocolAllocation>(&mut arg0.allocations, &arg2);
        v0.apr_bps = arg3;
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_events::emit_apr_updated(0x2::object::id<LLVPool<T0>>(arg0), arg2, v0.apr_bps, arg3, 0x2::clock::timestamp_ms(arg4));
    }
    ...
    public(friend) fun update_protocol<T0>(arg0: &mut LLVPool<T0>, arg1: &0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::LLVPoolAdminCap, arg2: u8, arg3: u64, arg4: bool, arg5: &0x2::clock::Clock) {
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0>>(arg0));
        assert!(0x2::vec_map::contains<u8, ProtocolAllocation>(&arg0.allocations, &arg2), 3);
        if (arg4) {
            assert!(arg3 > 0, 7);
        ...
        v0.enabled = arg4;
        validate_total_ratio<T0>(arg0);
        0x4b93e2827ba0ef63e0e4d376db457f6fc4e199939c495f48a6f816baf02f9dcc::llv_events::emit_update_protocol(0x2::object::id<LLVPool<T0>>(arg0), arg2, 1, arg4, arg3, v0.deposited_amount, v0.current_balance, v0.last_sync_ms, v0.apr_bps, 0x2::clock::timestamp_ms(arg5));
    }
