module 0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::dao {
    ...
    public entry fun create_proposal<T0, T1>(arg0: &mut DAO, arg1: &mut 0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::fee::FeeManager, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T1>, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: 0x1::option::Option<vector<u64>>, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.proposal_creation_enabled, 11);
        0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::fee::deposit_proposal_creation_payment(arg1, arg2, arg11, arg12);
        ...
        assert!(0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::vectors::check_valid_outcomes(arg9, 1024), 12);
        ...
        assert!(arg3 > 1, 19);
        let (v4, v5, v6) = 0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::proposal::create<T0, T1>(0x2::object::uid_to_inner(&arg0.id), arg3, 0x2::coin::into_balance<T0>(arg4), 0x2::coin::into_balance<T1>(arg5), arg0.review_period_ms, arg0.trading_period_ms, arg0.min_asset_amount, arg0.min_stable_amount, arg6, arg7, arg8, arg9, arg0.amm_twap_start_delay, arg0.amm_twap_initial_observation, arg0.amm_twap_step_max, arg10, arg0.twap_threshold, arg11, arg12);
        let v7 = ProposalInfo{
    ...
    public(friend) fun sign_result(arg0: &mut DAO, arg1: 0x2::object::ID, arg2: &0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::market_state::MarketState, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x2::object::ID, ProposalInfo>(&arg0.proposals, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, ProposalInfo>(&mut arg0.proposals, arg1);
        assert!(!v0.executed, 6);
        assert!(0x2::object::id<0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::market_state::MarketState>(arg2) == v0.market_state_id, 2);
        assert!(0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::market_state::market_id(arg2) == arg1, 2);
        assert!(0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::market_state::dao_id(arg2) == 0x2::object::uid_to_inner(&arg0.id), 2);
        0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::market_state::assert_market_finalized(arg2);
        let v1 = 0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::market_state::get_winning_outcome(arg2);
        let v2 = 0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::market_state::get_outcome_message(arg2, v1);
    ...
    public entry fun sign_result_entry<T0, T1>(arg0: &mut DAO, arg1: 0x2::object::ID, arg2: &mut 0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::coin_escrow::TokenEscrow<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::coin_escrow::get_market_state_id<T0, T1>(arg2) == get_proposal_info(arg0, arg1).market_state_id, 2);
        sign_result(arg0, arg1, 0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::coin_escrow::get_market_state_mut<T0, T1>(arg2), arg3, arg4);
    }
