module 0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::oracle {
    ...
    fun multi_full_window_accumulation(arg0: &mut Oracle, arg1: u128, arg2: u64, arg3: u64) {
        ...
        let v19 = if (arg1 >= arg0.last_window_twap) {
            0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::math::saturating_add(arg0.last_window_twap, 0x1::u128::min(v18, v0))
        } else {
            0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::math::saturating_sub(arg0.last_window_twap, 0x1::u128::min(v18, v0))
        };
        arg0.last_timestamp = arg3;
        arg0.last_window_end = arg3;
    ...
    fun one_step_cap_price_change(arg0: u128, arg1: u128, arg2: u64) : u128 {
        if (arg1 > arg0) {
            0x1::u128::min(arg1, 0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::math::saturating_add(arg0, (arg2 as u128)))
        } else {
            0x1::u128::max(arg1, 0x4bdcf9574f174552f80898d584dbb12b4575409b996f73318fca5c391dfceef0::math::saturating_sub(arg0, (arg2 as u128)))
        }
    }
