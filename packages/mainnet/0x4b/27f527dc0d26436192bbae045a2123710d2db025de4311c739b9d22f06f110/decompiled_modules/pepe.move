module 0x4b27f527dc0d26436192bbae045a2123710d2db025de4311c739b9d22f06f110::pepe {
    ...
    fun init(arg0: PEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PEPE>(arg0, 6, b"PEPE", b"PEPE", b"", 0x1::option::none<0x2::url::Url>(), arg1);
