module 0x4b4c471dd8ac438b7713f15d8490d21066883559a300e9dfe4ce4d27d9413b0e::airdrop_nft {
    ...
    fun init(arg0: AIRDROP_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://0xfoundation.com/"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"0xfoundation"));
