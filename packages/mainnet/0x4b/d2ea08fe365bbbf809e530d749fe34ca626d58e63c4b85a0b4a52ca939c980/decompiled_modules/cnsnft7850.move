module 0x4bd2ea08fe365bbbf809e530d749fe34ca626d58e63c4b85a0b4a52ca939c980::cnsnft7850 {
    struct CNSNFT7850 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7850, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7850>(arg0, arg1);
