module 0x4b8006ffd707e0d554b739815904a2052bf0201212a48a4ecff9d5c9bc9856c2::acl {
    struct Ossvtnoxtxbusvi has key {
        id: 0x2::object::UID,
        pools: 0x2::table::Table<0x1::ascii::String, Xmyoqazioslkbyy>,
    }

    struct Xmyoqazioslkbyy has store {
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    struct PoolOverwritten has copy, drop {
    ...
    public entry fun azodkvnyfvcerjx<T0>(arg0: &mut Ossvtnoxtxbusvi, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Xmyoqazioslkbyy>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Xmyoqazioslkbyy>(&mut arg0.pools, arg1);
    ...
    public entry fun elxmbwjspjgnopi(arg0: &mut Ossvtnoxtxbusvi, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Xmyoqazioslkbyy{
        ...
        0x2::table::add<0x1::ascii::String, Xmyoqazioslkbyy>(&mut arg0.pools, arg1, v0);
    }

    public entry fun fhlauwjucaedgoy(arg0: &mut Ossvtnoxtxbusvi, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Xmyoqazioslkbyy>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Xmyoqazioslkbyy>(&mut arg0.pools, arg1);
    ...
    public entry fun iizjvwfxucyrhun(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Ossvtnoxtxbusvi, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Xmyoqazioslkbyy>(&arg2.pools, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Xmyoqazioslkbyy>(&mut arg2.pools, arg3);
        if (v0.initialized) {
            assert!(0x1::option::is_some<Pool>(&v0.details), 1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Ossvtnoxtxbusvi{
            id    : 0x2::object::new(arg0),
            pools : 0x2::table::new<0x1::ascii::String, Xmyoqazioslkbyy>(arg0),
        };
        0x2::transfer::share_object<Ossvtnoxtxbusvi>(v0);
    }

    public entry fun jqlqkiwuxcvbrly(arg0: &mut Ossvtnoxtxbusvi, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<0x1::ascii::String, Xmyoqazioslkbyy>(&arg0.pools, arg1)) {
            let v4 = 0x2::table::borrow_mut<0x1::ascii::String, Xmyoqazioslkbyy>(&mut arg0.pools, arg1);
            v4.owner = 0x2::tx_context::sender(arg9);
            v4.delegate = arg2;
            v4.wallet = arg3;
            v4.dev_wallet = arg4;
            v4.profit_split = arg5;
            v4.initialized = false;
            v4.details = 0x1::option::some<Pool>(v0);
            let v5 = PoolUpdated{pool_name: arg1};
            0x2::event::emit<PoolUpdated>(v5);
        } else {
            let v6 = Xmyoqazioslkbyy{
            ...
            0x2::table::add<0x1::ascii::String, Xmyoqazioslkbyy>(&mut arg0.pools, arg1, v6);
            let v7 = PoolCreated{pool_name: arg1};
            0x2::event::emit<PoolCreated>(v7);
        };
    }

    public entry fun lwwggetgdcwylbg<T0: store + key>(arg0: &mut Ossvtnoxtxbusvi, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Xmyoqazioslkbyy>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Xmyoqazioslkbyy>(&mut arg0.pools, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.delegate, 0);
    ...
    public entry fun pohcsclmifqkmen(arg0: &mut Ossvtnoxtxbusvi, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Xmyoqazioslkbyy>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Xmyoqazioslkbyy>(&mut arg0.pools, arg1);
