module 0x4b14da6e824c6300a8aa633e9ec41a4466920a2350d686304a802156b52cd28c::cnsnft9475 {
    struct CNSNFT9475 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9475, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9475>(arg0, arg1);
