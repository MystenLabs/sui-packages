module 0x4b190f868afe7775ccfbfa065f35341d5a85244260d197da3fb7932f04b9b6fc::purple_rug {
    struct PURPLE_RUG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PURPLE_RUG, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PURPLE_RUG>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Purple Rug"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"a purple rug"));
