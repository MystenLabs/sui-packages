module 0xaa620f7efac4076050ec21f52c39c1038164053c367a146a76c85345b5b716c::reward7768 {
    struct REWARD7768 has drop {
        dummy_field: bool,
    }

    struct TICKET_7768 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7768(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7768>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7768>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7768, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7768>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7768>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7768>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7768>>(v5, 0x2::tx_context::sender(arg1));
    }
