module 0xa9b94307de472ebe7c1a24ea862eb013d954c9c003a0484e045861d05b31435::rewarder {
    ...
    public fun deposit_reward<T0>(arg0: &0xa9b94307de472ebe7c1a24ea862eb013d954c9c003a0484e045861d05b31435::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) : u64 {
    ...
    public fun emergent_withdraw<T0>(arg0: &0xa9b94307de472ebe7c1a24ea862eb013d954c9c003a0484e045861d05b31435::config::AdminCap, arg1: &0xa9b94307de472ebe7c1a24ea862eb013d954c9c003a0484e045861d05b31435::config::GlobalConfig, arg2: &mut RewarderGlobalVault, arg3: u64) : 0x2::balance::Balance<T0> {
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: u128, arg2: u64) {
        ...
        while (v2 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v2).growth_global = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).growth_global + 0xfa0e2d4afab23c5947ed9057cfc87c886324ce1fc0738af4820a88b1a48f503e::full_math_u128::mul_div_floor((v1 as u128), 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).emissions_per_second, arg1);
            v2 = v2 + 1;
        };
        arg0.points_released = arg0.points_released + (v1 as u128) * 18446744073709551616000000;
        arg0.points_growth_global = arg0.points_growth_global + 0xfa0e2d4afab23c5947ed9057cfc87c886324ce1fc0738af4820a88b1a48f503e::full_math_u128::mul_div_floor((v1 as u128), 18446744073709551616000000, arg1);
    }
