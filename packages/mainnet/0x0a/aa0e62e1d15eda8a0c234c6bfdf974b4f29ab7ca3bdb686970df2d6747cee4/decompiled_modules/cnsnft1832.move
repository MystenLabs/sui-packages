module 0xaaa0e62e1d15eda8a0c234c6bfdf974b4f29ab7ca3bdb686970df2d6747cee4::cnsnft1832 {
    struct CNSNFT1832 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1832, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3517"));
        let v4 = 0x2::package::claim<CNSNFT1832>(arg0, arg1);
