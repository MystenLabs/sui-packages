module 0xa9e48f5656b924a12ca4ec2672f1914729d9981bdace7f422c9299283add970::cnsnft3153 {
    struct CNSNFT3153 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3153, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3153>(arg0, arg1);
