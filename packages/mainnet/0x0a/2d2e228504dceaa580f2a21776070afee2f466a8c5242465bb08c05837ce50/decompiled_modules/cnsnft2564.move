module 0xa2d2e228504dceaa580f2a21776070afee2f466a8c5242465bb08c05837ce50::cnsnft2564 {
    struct CNSNFT2564 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2564, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2564>(arg0, arg1);
