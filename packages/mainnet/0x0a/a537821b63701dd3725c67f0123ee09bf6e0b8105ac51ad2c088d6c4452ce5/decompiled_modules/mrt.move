module 0xaa537821b63701dd3725c67f0123ee09bf6e0b8105ac51ad2c088d6c4452ce5::mrt {
    struct MRT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MRT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MRT>(arg0, 6, b"MRT04", b"MRT token", b"this is my token", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/profile_images/1745384206006669312/fi1rMGEb_400x400.jpg")), arg1);
        let v2 = v0;
