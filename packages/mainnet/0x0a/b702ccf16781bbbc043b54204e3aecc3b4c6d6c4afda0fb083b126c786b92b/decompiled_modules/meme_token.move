module 0xab702ccf16781bbbc043b54204e3aecc3b4c6d6c4afda0fb083b126c786b92b::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"SUM", b"Summon_wiz", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-01T11-51-04.689Z-logo2 1.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Summon_wiz"),
            symbol     : 0x1::string::utf8(b"SUM"),
            decimals   : 9,
