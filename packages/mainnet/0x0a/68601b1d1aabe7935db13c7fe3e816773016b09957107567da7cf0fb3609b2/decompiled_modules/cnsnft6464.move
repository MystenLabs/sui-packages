module 0xa68601b1d1aabe7935db13c7fe3e816773016b09957107567da7cf0fb3609b2::cnsnft6464 {
    struct CNSNFT6464 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6464, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6464>(arg0, arg1);
