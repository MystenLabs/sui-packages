module 0xad5bcd703aa25b953ca8b0eea7d4932b9c999e7b6d758d05f1155fa982d58b9::reward6995 {
    struct REWARD6995 has drop {
        dummy_field: bool,
    }

    struct TICKET_6995 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6995(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6995>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6995>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6995, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6995>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6995>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6995>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6995>>(v5, 0x2::tx_context::sender(arg1));
    }
