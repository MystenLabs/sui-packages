module 0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::implements {
    ...
    public(friend) fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LP<T0, T1>>, vector<u64>) {
        ...
        let v9 = if (0 == v6) {
            let v10 = 0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::math::sqrt(0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::math::mul_to_u128(v7, v8));
            assert!(v10 > 1000, 8);
    ...
    fun calc_optimal_coin_values(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : (u64, u64) {
        if (arg4 == 0 && arg5 == 0) {
            ...
            let v2 = 0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::math::mul_div(arg0, arg5, arg4);
            if (v2 <= arg1) {
                assert!(v2 >= arg3, 4);
                (arg0, v2)
            } else {
                let v3 = 0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::math::mul_div(arg1, arg4, arg5);
                assert!(v3 <= arg0, 6);
                assert!(v3 >= arg2, 3);
                (v3, arg1)
            }
    ...
    public fun get_amount_out(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::math::mul_div_u128(v0, (arg2 as u128), (arg1 as u128) * (10000 as u128) + v0)
    }
    ...
    public fun get_fee_to_fundation(arg0: u64, arg1: u64) : u64 {
        0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::math::mul_div(arg0, arg1, 10000)
    }
    ...
    public fun get_swap_out<T0, T1>(arg0: &mut Global, arg1: u64, arg2: bool) : u64 {
        ...
        if (arg2) {
            ...
            if (v10) {
                v0 = arg1 - 0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::math::mul_div(arg1, (v9.buy_tax as u64), 100);
            };
    ...
    public fun is_order<T0, T1>() : bool {
        ...
        let v2 = 0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::comparator::compare<0x1::type_name::TypeName>(&v0, &v1);
        assert!(!0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::comparator::is_equal(&v2), 9);
        0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::comparator::is_smaller_than(&v2)
    }
    ...
    public fun is_sui<T0>() : bool {
        ...
        let v2 = 0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::comparator::compare<0x1::ascii::String>(&v1, &v0);
        0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::comparator::is_equal(&v2)
    }
    ...
    public(friend) fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        (0x2::coin::take<T0>(&mut arg0.coin_x, 0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::math::mul_div(v1, v0, v3), arg3), 0x2::coin::take<T1>(&mut arg0.coin_y, 0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::math::mul_div(v2, v0, v3), arg3))
    }
    ...
    public(friend) fun swap_out<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        if (arg3) {
            ...
            if (v22) {
                let v32 = 0xa74af6ab271682c2397104b182642857beb61af4f1769ea4301064bdaff2e7d::math::mul_div(v29, (v21.buy_tax as u64), 100);
