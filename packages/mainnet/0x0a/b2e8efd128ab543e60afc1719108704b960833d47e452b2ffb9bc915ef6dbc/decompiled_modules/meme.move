module 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme {
    ...
    public fun accept_connector_v2<T0>(arg0: &mut MemeConfig, arg1: 0x2::transfer::Receiving<0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector_v2::ConnectorV2<T0>>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        enforce_config_version(arg0);
        let v0 = 0x2::transfer::public_receive<0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector_v2::ConnectorV2<T0>>(&mut arg0.id, arg1);
        let v1 = 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector_v2::get_temp_id<T0>(&v0);
        let v2 = 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector_v2::get_creator<T0>(&v0);
        ...
        let v5 = v3;
        let v6 = create_bonding_curve_v2<T0>(arg2, v0, arg0, arg3);
    ...
    fun create_bonding_curve_v2<T0>(arg0: &0x2::coin::CoinMetadata<T0>, arg1: 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector_v2::ConnectorV2<T0>, arg2: &MemeConfig, arg3: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        enforce_config_version(arg2);
        let (v0, v1, v2, v3, v4, v5) = 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector_v2::deconstruct<T0>(arg1);
    ...
    fun enforce_config_version(arg0: &MemeConfig) {
        assert!(1 >= arg0.minimum_version, 0);
    }
