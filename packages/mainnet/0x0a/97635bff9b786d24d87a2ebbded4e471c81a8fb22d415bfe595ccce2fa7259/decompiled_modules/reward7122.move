module 0xa97635bff9b786d24d87a2ebbded4e471c81a8fb22d415bfe595ccce2fa7259::reward7122 {
    struct REWARD7122 has drop {
        dummy_field: bool,
    }

    struct TICKET_7122 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7122(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7122>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7122>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7122, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7122>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7122>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7122>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7122>>(v5, 0x2::tx_context::sender(arg1));
    }
