module 0xacea71387672ce223bbc677c262264e7cefd42ba30403e5e96ac521d26c8812::odyssey {
    struct TokenPool<phantom T0, phantom T1> has store, key {
        ...
        fee_recipient_handle: 0x1::string::String,
        state: u8,
    ...
    public fun create_pool<T0, T1>(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: u8, arg8: 0x1::string::String, arg9: 0x2::coin::Coin<T1>, arg10: 0x2::coin::TreasuryCap<T0>, arg11: address, arg12: u64, arg13: u64, arg14: &mut TokenRegistry, arg15: &VerifiedHandles, arg16: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x2::tx_context::sender(arg16);
        assert!(0x2::coin::value<T1>(&arg9) >= 1000000000, 4);
        assert!(arg7 <= 2, 1);
        let v1 = if (0x1::string::length(&arg8) > 0) {
            0x1::option::some<0x1::string::String>(arg8)
        } else {
        ...
        if (arg7 == 0) {
            if (0x1::option::is_some<0x1::string::String>(&v2)) {
                ...
                if (0x2::table::contains<0x1::string::String, address>(&arg15.handles, *v4)) {
                    v3 = *0x2::table::borrow<0x1::string::String, address>(&arg15.handles, *v4);
                };
            };
        };
        let v5 = 0x2::coin::total_supply<T0>(&arg10);
        let v6 = 0x2::coin::mint<T0>(&mut arg10, v5, arg16);
        let v7 = TokenPool<T0, T1>{
            ...
            state                  : 0,
            meme_balance           : 0x2::coin::into_balance<T0>(v6),
            quote_balance          : 0x2::coin::into_balance<T1>(arg9),
            virtual_liquidity      : arg12,
            target_quote_liquidity : arg13,
            liquidity_provision    : 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v6, v5 / 10, arg16)),
            treasury_cap           : arg10,
            total_bought           : 0,
            total_sold             : 0,
            total_volume           : 0,
        ...
        let v8 = 0x2::object::id<TokenPool<T0, T1>>(&v7);
        0x2::table::add<0x2::object::ID, address>(&mut arg14.pools, v8, 0x2::object::id_to_address(&v8));
        arg14.total_tokens = arg14.total_tokens + 1;
        if (arg7 == 0) {
            arg14.total_joyride = arg14.total_joyride + 1;
        };
        let v9 = if (v3 != @0x0) {
            0x1::option::some<address>(v3)
        } else {
        ...
        0x2::transfer::share_object<TokenPool<T0, T1>>(v7);
        v8
    }
