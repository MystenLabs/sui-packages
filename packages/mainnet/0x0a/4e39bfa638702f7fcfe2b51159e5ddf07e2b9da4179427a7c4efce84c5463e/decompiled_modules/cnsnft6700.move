module 0xa4e39bfa638702f7fcfe2b51159e5ddf07e2b9da4179427a7c4efce84c5463e::cnsnft6700 {
    struct CNSNFT6700 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6700, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6700>(arg0, arg1);
