module 0xa60f96aeb3b1c24c2ac1213a6eaa9c52798e2246690bb2be33cf40e868b26dc::passionnn {
    ...
    public entry fun mint(arg0: &mut AppCap, arg1: 0x1::string::String, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v2, 0x1::string::utf8(b"boy"));
        0x1::vector::push_back<0x1::string::String>(v2, 0x1::string::utf8(b"road"));
        let v3 = Passionnn{
    ...
    public fun mint_for_testing<T0>(arg0: &mut 0x2::tx_context::TxContext) : Passionnn {
        ...
        let v1 = 0x1::vector::empty<0x1::string::String>();
        0x1::vector::push_back<0x1::string::String>(&mut v1, 0x1::string::utf8(b"test"));
        Passionnn{
            id          : v0,
