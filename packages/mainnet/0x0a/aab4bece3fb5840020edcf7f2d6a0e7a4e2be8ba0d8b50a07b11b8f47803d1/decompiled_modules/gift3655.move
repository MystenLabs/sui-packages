module 0xaaab4bece3fb5840020edcf7f2d6a0e7a4e2be8ba0d8b50a07b11b8f47803d1::gift3655 {
    struct GIFT3655 has drop {
        dummy_field: bool,
    }

    struct TICKET_3655 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3655(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3655>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3655>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3655, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3655>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3655>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3655>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3655>>(v5, 0x2::tx_context::sender(arg1));
    }
