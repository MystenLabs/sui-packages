module 0xadc4ef7d1b97d71fdfe01f7324f168d89acd1014dfa517db4ca68422e32884d::treasury {
    ...
    public fun claim_streak_reward(arg0: &mut Treasury, arg1: &0x2::coin::Coin<0xab0cf2644867272bc89a77d9cff0633e3d50e3f738b963d9c8e6899b529803a8::capy::CAPY>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = get_daily_cap(0x2::coin::value<0xab0cf2644867272bc89a77d9cff0633e3d50e3f738b963d9c8e6899b529803a8::capy::CAPY>(arg1));
        let v3 = *0x1::vector::borrow<RewardTier>(&arg0.tiers, (arg0.active_tier as u64));
        ensure_daily_record(arg0, v0, v1);
        let v4 = 0x2::table::borrow_mut<address, DailyRecord>(&mut arg0.daily_records, v0);
        assert!(!v4.streak_claimed, 5);
        let v5 = if (v2 > v4.total_earned) {
            v2 - v4.total_earned
        } else {
            0
        };
        ...
        let v6 = if (v3.streak_reward <= v5) {
            v3.streak_reward
        } else {
            v5
        };
        v4.streak_claimed = true;
        v4.total_earned = v4.total_earned + v6;
        pay_reward(arg0, v0, v6, b"daily_streak", arg2);
        let v7 = StreakClaimed{
            user   : v0,
            amount : v6,
            epoch  : v1,
        };
        0x2::event::emit<StreakClaimed>(v7);
    }
    ...
    public(friend) fun distribute_comment_reward(arg0: &mut Treasury, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = if (v1.comment_reward <= v3) {
            v1.comment_reward
        } else {
            v3
        };
        v2.comments_rewarded = v2.comments_rewarded + 1;
        v2.total_earned = v2.total_earned + v4;
        pay_reward(arg0, arg1, v4, b"comment_received", arg3);
    }
    ...
    public(friend) fun distribute_like_reward(arg0: &mut Treasury, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        v2.total_earned = v2.total_earned + v4;
        pay_reward(arg0, arg1, v4, b"like_received", arg3);
    }
    ...
    public(friend) fun distribute_post_reward(arg0: &mut Treasury, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        v2.total_earned = v2.total_earned + v4;
        pay_reward(arg0, arg1, v4, b"post_created", arg3);
    }
