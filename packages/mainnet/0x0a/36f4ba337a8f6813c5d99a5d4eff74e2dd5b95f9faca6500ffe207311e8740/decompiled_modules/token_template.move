module 0xa36f4ba337a8f6813c5d99a5d4eff74e2dd5b95f9faca6500ffe207311e8740::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"T038367", b"Test 038367", b"Integration test token 2025-10-28T00:40:38.367Z", 0x1::option::none<0x2::url::Url>(), arg1);
