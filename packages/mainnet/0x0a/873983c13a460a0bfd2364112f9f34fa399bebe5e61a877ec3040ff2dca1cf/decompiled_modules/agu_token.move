module 0xa873983c13a460a0bfd2364112f9f34fa399bebe5e61a877ec3040ff2dca1cf::agu_token {
    ...
    fun init(arg0: AGU_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGU_TOKEN>(arg0, 6, b"LDO", b"LDO", b"LDO Token on Sui Network", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://icon.suntool.cc/file/lido-dao.png")), arg1);
        let v2 = v0;
