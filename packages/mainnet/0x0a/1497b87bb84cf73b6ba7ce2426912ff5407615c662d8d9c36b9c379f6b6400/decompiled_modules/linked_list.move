module 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list {
    ...
    public fun drop_node<T0: copy + drop + store, T1: copy + store>(arg0: &mut 0x2::object::UID, arg1: T0) : T1 {
        let Node {
            value  : v0,
            prev   : _,
            next   : _,
    ...
    public fun force_drop_node<T0: copy + drop + store, T1: copy + store>(arg0: &mut 0x2::object::UID, arg1: T0) : T1 {
        let Node {
            value  : v0,
            prev   : _,
            next   : _,
