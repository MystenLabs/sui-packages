module 0xaef2240ec5deeb6a59812b35aaaaa5d7e7e31e3eccad82b604ed3c31a1a236b3::v1 {
    ...
    public fun cetus__a_to_b<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        if (v5 != v4) {
            transfer_or_destroy_balance<T0>(0x2::balance::split<T0>(&mut arg3, v5 - v4), arg4);
        };
    ...
    public fun cetus__b_to_a<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        if (v5 != v4) {
            transfer_or_destroy_balance<T1>(0x2::balance::split<T1>(&mut arg3, v5 - v4), arg4);
        };
    ...
    public fun ensure_min_out_balance<T0>(arg0: 0x2::balance::Balance<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(0x2::balance::value<T0>(&arg0) >= arg1, 9001);
        arg0
    }

    public fun ensure_min_out_coin<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x2::coin::into_balance<T0>(arg0);
        assert!(0x2::balance::value<T0>(&v0) >= arg1, 9001);
