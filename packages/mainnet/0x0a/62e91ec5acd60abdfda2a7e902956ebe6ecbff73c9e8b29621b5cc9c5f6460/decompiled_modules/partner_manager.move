module 0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::partner_manager {
    ...
    public(friend) fun collect_commission_if_necessary<T0>(arg0: &mut PartnerRegistry, arg1: &mut 0x2::coin::Coin<T0>, arg2: address, arg3: u8, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (arg3 == 0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::commission_type::flat()) {
            if (arg4 > 0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::math::mul_div(0x2::coin::value<T0>(arg1), arg0.max_comission_percentage, 1000000)) {
                abort 1
            };
            arg4
        } else {
            0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::math::mul_div(0x2::coin::value<T0>(arg1), arg4, 1000000)
        };
        collect<T0>(v0, 0x2::coin::split<T0>(arg1, v1, arg5), arg5);
    }

    public entry fun config_max_comission_percentage(arg0: &0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::admin_cap::AdminCap, arg1: &mut PartnerRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
