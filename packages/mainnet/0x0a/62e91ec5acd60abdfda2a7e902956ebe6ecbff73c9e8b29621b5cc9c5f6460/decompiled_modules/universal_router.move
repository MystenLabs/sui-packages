module 0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::universal_router {
    ...
    public fun build<T0, T1>(arg0: &mut 0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::partner_manager::PartnerRegistry, arg1: 0x2::coin::Coin<T0>, arg2: u256, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u64>, arg7: 0x1::option::Option<address>, arg8: u8, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : Trade<T0, T1> {
        if (arg4 > 1000000) {
            abort 2
        };
        if (arg8 != 0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::commission_type::percentage() && arg8 != 0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::commission_type::flat() || arg8 == 0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::commission_type::percentage() && arg9 > 0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::partner_manager::max_comission_percentage(arg0) || arg9 == 0) {
            abort 7
        };
        ...
        while (0x1::vector::is_empty<u64>(&arg6)) {
            ...
            let v3 = Route{
                trade_id  : arg2,
                amount_in : 0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::math::mul_div(0x2::coin::value<T0>(&arg1), v2, 100),
                current   : 0,
        ...
        if (0x1::option::is_some<address>(&arg7)) {
            0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::partner_manager::register_partner_if_necessary(arg0, *0x1::option::borrow<address>(&arg7), arg10);
            0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::partner_manager::collect_commission_if_necessary<T0>(arg0, &mut v4.coin_in, *0x1::option::borrow<address>(&arg7), arg8, arg9, arg10);
        };
        v4
    }
    ...
    public entry fun set_fee_on(arg0: &0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::admin_cap::AdminCap, arg1: &mut Treasury, arg2: bool) {
        arg1.fee_on = arg2;
    }

    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: &mut 0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::partner_manager::PartnerRegistry, arg2: Trade<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let Trade {
            trade_id            : v0,
            amount_in           : v1,
        ...
        let v12 = v9;
        let v13 = v8;
        if (!0x1::vector::is_empty<Route>(&v12)) {
            abort 5
        };
        if (0x2::clock::timestamp_ms(arg3) > v4) {
            abort 0
        };
        if (0x2::coin::value<T1>(&v13) < 0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::math::mul_div(1000000 - v3, v2, 1000000)) {
            abort 1
        };
        0x1::vector::destroy_empty<Route>(v12);
        refund_if_necessary<T0>(v7, 0x2::tx_context::sender(arg4));
        let v14 = &mut v13;
        pay_router_fee_if_necessary<T1>(arg0, v14, v2, arg4);
        if (0x1::option::is_some<address>(&v11)) {
            0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::partner_manager::collect_commission_if_necessary<T1>(arg1, &mut v13, *0x1::option::borrow<address>(&v11), v5, v6, arg4);
        };
        let v15 = Swap{
    ...
    public entry fun withdraw<T0>(arg0: &0xa62e91ec5acd60abdfda2a7e902956ebe6ecbff73c9e8b29621b5cc9c5f6460::admin_cap::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
