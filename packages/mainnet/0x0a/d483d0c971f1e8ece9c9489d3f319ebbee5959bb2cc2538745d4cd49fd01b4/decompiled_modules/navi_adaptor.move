module 0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::navi_adaptor {
    ...
    public fun calculate_navi_position_value(arg0: address, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: &0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::vault_oracle::OracleConfig, arg3: &0x2::clock::Clock) : u256 {
        ...
        while (v0 > 0) {
            ...
            let v8 = 0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::vault_oracle::get_normalized_asset_price(arg2, arg3, v7);
            v1 = v1 + 0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::vault_utils::mul_with_oracle_price((0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::ray_math::ray_mul(v3, v5) as u256), v8);
            v2 = v2 + 0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::vault_utils::mul_with_oracle_price((0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::ray_math::ray_mul(v4, v6) as u256), v8);
            v0 = v0 - 1;
        };
        v1 - v2
    }
