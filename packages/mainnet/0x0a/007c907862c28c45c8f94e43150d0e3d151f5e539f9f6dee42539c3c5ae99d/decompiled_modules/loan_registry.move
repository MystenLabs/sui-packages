module 0x92d5efc1eec7e45b9e806fbc88ba175555dc605e63fa2db9da2b90b8b68f2e5c::loan_registry {
    ...
    fun finish_liquidate_loan_offer<T0, T1>(arg0: &mut Loan<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        assert!(arg3 == 0x2::coin::value<T0>(&arg1) + arg0.amount + v1, 8);
        let v2 = ((((v1 * arg2) as u128) / (10000 as u128)) as u64);
        let v3 = 0x2::coin::into_balance<T0>(arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v3, arg6), arg0.borrower);
        arg0.status = 0x1::string::utf8(b"Liquidated");
        let v4 = LiquidatedCollateralEvent{
            lender                     : arg0.lender,
            borrower                   : arg0.borrower,
            ...
            liquidated_tx              : arg5,
            remaining_fund_to_borrower : 0x2::coin::value<T0>(&arg1) - v2,
        };
        0x2::event::emit<LiquidatedCollateralEvent>(v4);
        0x2::balance::split<T0>(&mut v3, v2)
    }
    ...
    public(friend) fun system_liquidate_loan_offer<T0, T1>(arg0: &mut Loan<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: 0x1::string::String) {
        ...
        v0.liquidated_tx = 0x1::option::some<0x1::string::String>(arg5);
        let v1 = ((((arg0.amount * arg0.interest / 10000 * arg0.duration) as u128) / (31536000 as u128)) as u64);
        assert!(arg3 == 0x2::coin::value<T0>(&arg1) + arg0.amount + v1 + ((((v1 * arg2) as u128) / (10000 as u128)) as u64), 8);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, arg0.borrower);
        arg0.status = 0x1::string::utf8(b"Liquidated");
        let v2 = LiquidatedCollateralEvent{
            lender                     : arg0.lender,
            borrower                   : arg0.borrower,
            loan_id                    : 0x2::object::id<Loan<T0, T1>>(arg0),
            collateral_swapped_amount  : arg3,
            ...
            liquidated_price           : arg4,
            liquidated_tx              : arg5,
            remaining_fund_to_borrower : 0x2::coin::value<T0>(&arg1),
        };
        0x2::event::emit<LiquidatedCollateralEvent>(v2);
    }

    public(friend) fun system_liquidate_loan_offer_to_custodian<T0, T1>(arg0: &mut Loan<T0, T1>, arg1: &mut 0x92d5efc1eec7e45b9e806fbc88ba175555dc605e63fa2db9da2b90b8b68f2e5c::custodian::Custodian<T0>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        0x92d5efc1eec7e45b9e806fbc88ba175555dc605e63fa2db9da2b90b8b68f2e5c::custodian::add_treasury_balance<T0>(arg1, finish_liquidate_loan_offer<T0, T1>(arg0, arg2, arg3, arg4, arg5, arg6, arg7));
    }
