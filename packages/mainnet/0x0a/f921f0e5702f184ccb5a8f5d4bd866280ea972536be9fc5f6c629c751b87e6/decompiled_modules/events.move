module 0xaf921f0e5702f184ccb5a8f5d4bd866280ea972536be9fc5f6c629c751b87e6::events {
    ...
    public(friend) fun emit_dual_rollover_settled(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: u32, arg7: u32, arg8: u32, arg9: u32, arg10: vector<u32>, arg11: vector<u64>, arg12: vector<u64>, arg13: vector<u32>, arg14: vector<u64>, arg15: vector<u64>, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: u64, arg27: u64, arg28: u64, arg29: u64, arg30: vector<0x1::type_name::TypeName>, arg31: vector<u64>, arg32: vector<0x1::type_name::TypeName>, arg33: vector<u64>, arg34: u64, arg35: u64, arg36: u64, arg37: u64, arg38: u64, arg39: u32, arg40: u32, arg41: u64, arg42: u128, arg43: u128, arg44: u128, arg45: u128, arg46: u128, arg47: u128, arg48: u128, arg49: u128) {
        ...
        let v4 = RolloverCumulative{
            cumulative_deployed_a    : arg42,
            cumulative_deployed_b    : arg43,
            cumulative_principal_a   : arg44,
            cumulative_principal_b   : arg45,
            cumulative_fee_a         : arg46,
            cumulative_fee_b         : arg47,
            cumulative_closing_fee_a : arg48,
            cumulative_closing_fee_b : arg49,
        };
        let v5 = DualRolloverSettled{
            vault_id             : arg0,
            pool_id              : arg1,
            below                : v0,
        ...
        0x2::event::emit<DualRolloverSettled>(v5);
    }

    public(friend) fun emit_emergency_recovered(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: address, arg3: 0x1::option::Option<0x2::object::ID>, arg4: 0x1::option::Option<0x2::object::ID>, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64) {
        let v0 = EmergencyRecovered{
            vault_id          : arg0,
            pool_id           : arg1,
            owner             : arg2,
            below_position_id : arg3,
            above_position_id : arg4,
            amount_a          : arg5,
            amount_b          : arg6,
            sequence          : arg7,
            generation        : arg8,
    ...
    public(friend) fun emit_owner_deposit(arg0: 0x2::object::ID, arg1: u8, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64) {
        let v0 = OwnerDeposit{
            vault_id       : arg0,
            side           : arg1,
            amount         : arg2,
    ...
    public(friend) fun emit_owner_withdrawal(arg0: 0x2::object::ID, arg1: u8, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64) {
    ...
    public(friend) fun emit_reward_claimed(arg0: 0x2::object::ID, arg1: 0x1::type_name::TypeName, arg2: u64, arg3: u128, arg4: u64, arg5: u64, arg6: u64) {
        let v0 = RewardClaimed{
            vault_id          : arg0,
            reward_type       : arg1,
            amount            : arg2,
            cumulative_amount : arg3,
            sequence          : arg4,
            generation        : arg5,
            policy_version    : arg6,
        };
    ...
    public(friend) fun emit_vault_created(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: address, arg5: address, arg6: 0x2::object::ID, arg7: u64, arg8: u16, arg9: u64, arg10: u64, arg11: u64) {
        let v0 = VaultCreated{
            vault_id         : arg0,
            pool_id          : arg1,
            config_id        : arg2,
            ...
            agent            : arg5,
            cap_id           : arg6,
            protocol_version : arg7,
            bin_step         : arg8,
            sequence         : arg9,
            generation       : arg10,
            policy_version   : arg11,
        };
