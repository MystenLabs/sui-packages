module 0xa1a5c63df2760550e22c6f5a2a8a1ac1736bf64dd9e313b75573eb215c910d0::reward4246 {
    struct REWARD4246 has drop {
        dummy_field: bool,
    }

    struct TICKET_4246 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4246(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4246>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4246>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4246, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4246>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4246>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4246>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4246>>(v5, 0x2::tx_context::sender(arg1));
    }
