module 0xa2bb621761e78b7b928328b76e3f3ffe481dcdf61d2f176fb33eaaa502547a5::reward2000 {
    struct REWARD2000 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward2000(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD2000, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2000>(arg0, arg1);
