module 0xa6e682d231ebe730809160d6f683a6e42969bb8d611bc04a1223dffe21b1975::reward1835 {
    struct REWARD1835 has drop {
        dummy_field: bool,
    }

    struct TICKET_1835 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1835(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1835>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1835>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1835, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1835>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1835>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1835>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1835>>(v5, 0x2::tx_context::sender(arg1));
    }
