module 0xa03c059598ce586941e13a5f31bdcdf8b32001929fe535e409c10f98cc4894f::cnsnft7071 {
    struct CNSNFT7071 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7071, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7071>(arg0, arg1);
