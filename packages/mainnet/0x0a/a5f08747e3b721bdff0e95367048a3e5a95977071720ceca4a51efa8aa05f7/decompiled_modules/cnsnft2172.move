module 0xaa5f08747e3b721bdff0e95367048a3e5a95977071720ceca4a51efa8aa05f7::cnsnft2172 {
    struct CNSNFT2172 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2172, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2172>(arg0, arg1);
