module 0xa6b8f9be9509b8cbcf02bdfa2c92d386d793a42f98a95d2a865dd06f11a994f::reward4450 {
    struct REWARD4450 has drop {
        dummy_field: bool,
    }

    struct TICKET_4450 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4450(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4450>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4450>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4450, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4450>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4450>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4450>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4450>>(v5, 0x2::tx_context::sender(arg1));
    }
