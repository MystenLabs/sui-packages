module 0xa675c3f00f3734b4167a875862b2271dafeb6b7c67fd0a058ac5296b566319a8::bridge {
    ...
    struct Config has store, key {
        ...
        version: u64,
        paused: bool,
        mint_fee: 0x2::table::Table<vector<u8>, u64>,
        burn_fee: 0x2::table::Table<vector<u8>, u64>,
        fee_addr: address,
    ...
    public fun burn_fee<T0>(arg0: &Config) : u64 {
        *0x2::table::borrow<vector<u8>, u64>(&arg0.burn_fee, 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>())))
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Config{
            ...
            version   : 3,
            paused    : false,
            mint_fee  : 0x2::table::new<vector<u8>, u64>(arg0),
            burn_fee  : 0x2::table::new<vector<u8>, u64>(arg0),
            fee_addr  : @0x0,
    ...
    public fun mint_fee<T0>(arg0: &Config) : u64 {
        *0x2::table::borrow<vector<u8>, u64>(&arg0.mint_fee, 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>())))
    }
    ...
    public entry fun set_fee_amount<T0>(arg0: &OwnerCap, arg1: &mut Config, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        if (!0x2::table::contains<vector<u8>, u64>(&arg1.mint_fee, v0)) {
            0x2::table::add<vector<u8>, u64>(&mut arg1.mint_fee, v0, arg2);
        } else {
            *0x2::table::borrow_mut<vector<u8>, u64>(&mut arg1.mint_fee, v0) = arg2;
        };
        if (!0x2::table::contains<vector<u8>, u64>(&arg1.burn_fee, v0)) {
            0x2::table::add<vector<u8>, u64>(&mut arg1.burn_fee, v0, arg3);
        } else {
            *0x2::table::borrow_mut<vector<u8>, u64>(&mut arg1.burn_fee, v0) = arg3;
        };
        let v1 = FeeSet{
