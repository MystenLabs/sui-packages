module 0xa2d6a010edb005931c7c021b4468b488c388c6e193d79af47d96bb90b375b2a::cnsnft4379 {
    struct CNSNFT4379 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4379, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4379>(arg0, arg1);
