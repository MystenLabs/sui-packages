module 0xad02a1422774a40c2df47f5c930367131774d08dc62312b1594d4a38b466098::staked_share {
    ...
    public entry fun new_and_share_number_pool<T0: store, T1: store + key>(arg0: &0xad02a1422774a40c2df47f5c930367131774d08dc62312b1594d4a38b466098::pool::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun new_share<T0, T1: store + key>(arg0: &0xad02a1422774a40c2df47f5c930367131774d08dc62312b1594d4a38b466098::pool::Pool<T0, T1>, arg1: &mut NumberPool<T0, T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : vector<StakedPoolShare<T0, T1>> {
        let v0 = arg2;
        if (0x1::vector::length<StakedPoolShare<T0, T1>>(&arg1.available_shares) == 0) {
            let v2 = StakedPoolShare<T0, T1>{
                id        : 0x2::object::new(arg3),
                start_num : 0xad02a1422774a40c2df47f5c930367131774d08dc62312b1594d4a38b466098::pool::total_amount<T0, T1>(arg0) - arg2 + 1,
                end_num   : 0xad02a1422774a40c2df47f5c930367131774d08dc62312b1594d4a38b466098::pool::total_amount<T0, T1>(arg0),
            };
            ...
            if (v0 != 0) {
                let v9 = StakedPoolShare<T0, T1>{
                    id        : 0x2::object::new(arg3),
                    start_num : 0xad02a1422774a40c2df47f5c930367131774d08dc62312b1594d4a38b466098::pool::total_amount<T0, T1>(arg0) - v0 + 1,
                    end_num   : 0xad02a1422774a40c2df47f5c930367131774d08dc62312b1594d4a38b466098::pool::total_amount<T0, T1>(arg0),
                };
