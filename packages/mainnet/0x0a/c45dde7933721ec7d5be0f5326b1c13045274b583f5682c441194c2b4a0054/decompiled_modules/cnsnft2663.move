module 0xac45dde7933721ec7d5be0f5326b1c13045274b583f5682c441194c2b4a0054::cnsnft2663 {
    struct CNSNFT2663 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2663, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2663>(arg0, arg1);
