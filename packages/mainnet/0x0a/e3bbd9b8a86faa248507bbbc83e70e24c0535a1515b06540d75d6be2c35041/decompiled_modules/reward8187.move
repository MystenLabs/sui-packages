module 0xae3bbd9b8a86faa248507bbbc83e70e24c0535a1515b06540d75d6be2c35041::reward8187 {
    struct REWARD8187 has drop {
        dummy_field: bool,
    }

    struct TICKET_8187 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8187(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8187>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8187>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8187, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8187>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8187>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8187>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8187>>(v5, 0x2::tx_context::sender(arg1));
    }
