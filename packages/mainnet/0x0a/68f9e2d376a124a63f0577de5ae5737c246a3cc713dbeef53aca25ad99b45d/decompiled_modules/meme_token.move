module 0xa68f9e2d376a124a63f0577de5ae5737c246a3cc713dbeef53aca25ad99b45d::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"BULL", b"BULL", b"BULL was launched by the X account.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/media/G2v8sftagAAida2.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"BULL"),
            symbol     : 0x1::string::utf8(b"BULL"),
            decimals   : 9,
