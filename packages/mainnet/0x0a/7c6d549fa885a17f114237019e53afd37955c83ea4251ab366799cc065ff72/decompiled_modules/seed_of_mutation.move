module 0xa7c6d549fa885a17f114237019e53afd37955c83ea4251ab366799cc065ff72::seed_of_mutation {
    ...
    fun init(arg0: SEED_OF_MUTATION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"MystenDex Items"));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"Special items used within the MystenDex ecosystem."));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"Team Mysten"));
