module 0xa9310822587cf0c98d6de6313018865b72cbad5a3af2d7ac8f3fce0c354ba91::cnsnft2529 {
    struct CNSNFT2529 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2529, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2529>(arg0, arg1);
