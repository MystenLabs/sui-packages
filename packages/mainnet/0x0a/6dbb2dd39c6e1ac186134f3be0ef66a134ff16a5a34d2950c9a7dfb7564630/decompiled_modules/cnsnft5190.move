module 0xa6dbb2dd39c6e1ac186134f3be0ef66a134ff16a5a34d2950c9a7dfb7564630::cnsnft5190 {
    struct CNSNFT5190 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5190, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5190>(arg0, arg1);
