module 0x140923c60936ad9c6acc40ebd5248a51938e3618ae24b59ff9263e2c8e57f9ea::omg_protocol {
    ...
    public fun get_user_withdrawable_amount(arg0: &WrapperState, arg1: u64, arg2: address) : u64 {
        ...
        if (v2 == 0) {
            ...
            let v4 = (v1 as u128) * (0x2::balance::value<OMG_PROTOCOL>(&v0.omg_usd_reserves) as u128) / (v2 as u128);
            assert!(v4 <= 18446744073709551615, 14);
            (v4 as u64)
        }
    }

    public fun get_user_withdrawable_amount_2(arg0: &WrapperState, arg1: u64, arg2: address) : u64 {
        assert!(arg1 < 0x1::vector::length<Campaign>(&arg0.campaigns), 2);
        let v0 = 0x1::vector::borrow<Campaign>(&arg0.campaigns, arg1);
        if (!0x2::table::contains<address, u64>(&v0.balances, arg2)) {
            return 0
    ...
    entry fun manual_reward_burn(arg0: &mut WrapperState, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 < 0x1::vector::length<Campaign>(&arg0.campaigns), 2);
        assert!(arg2 > 0, 2);
        let v0 = 0x1::vector::borrow_mut<Campaign>(&mut arg0.campaigns, arg1);
        assert!(0x2::tx_context::sender(arg4) == v0.campaign_admin, 3);
        assert!(0x2::balance::value<OMG_PROTOCOL>(&v0.omg_usd_reserves) >= arg2, 2);
        0x2::coin::burn<OMG_PROTOCOL>(&mut arg0.treasury_cap, 0x2::coin::from_balance<OMG_PROTOCOL>(0x2::balance::split<OMG_PROTOCOL>(&mut v0.omg_usd_reserves, arg2), arg4));
        arg0.total_wrapped = arg0.total_wrapped - arg2;
        v0.last_updated = arg3;
    }

    entry fun manual_reward_mint(arg0: &mut WrapperState, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 < 0x1::vector::length<Campaign>(&arg0.campaigns), 2);
        assert!(arg2 > 0, 2);
        let v0 = 0x1::vector::borrow_mut<Campaign>(&mut arg0.campaigns, arg1);
        assert!(0x2::tx_context::sender(arg4) == v0.campaign_admin, 3);
        arg0.total_wrapped = arg0.total_wrapped + arg2;
        0x2::balance::join<OMG_PROTOCOL>(&mut v0.omg_usd_reserves, 0x2::coin::into_balance<OMG_PROTOCOL>(0x2::coin::mint<OMG_PROTOCOL>(&mut arg0.treasury_cap, arg2, arg4)));
        v0.last_updated = arg3;
    }
    ...
    entry fun payback_usdc(arg0: &mut WrapperState, arg1: u64, arg2: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(v0.money_collected, 2);
        assert!(v0.last_updated >= v0.launch_time + v0.campaign_length, 2);
        assert!(v0.launch_time > 0, 2);
    ...
    fun update_campaign_rewards_(arg0: &mut WrapperState, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 > v0.launch_time + v0.campaign_length) {
            v2 = v0.launch_time + v0.campaign_length - v0.last_updated;
        };
        if (v2 == 0) {
            return
        };
        let v3 = (v2 as u128) * (v0.reward_rate as u128) * (0x2::balance::value<OMG_PROTOCOL>(&v0.omg_usd_reserves) as u128) / 1000000000000000;
        assert!(v3 <= 18446744073709551615, 14);
        let v4 = (v3 as u64);
        if (v4 != 0) {
        ...
        v0.last_updated = v0.last_updated + v2;
    }
    ...
    entry fun withdraw_omg_usd(arg0: &mut WrapperState, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = if (v2 == v3) {
            ...
            let v5 = (v2 as u128) * (0x2::balance::value<OMG_PROTOCOL>(&v1.omg_usd_reserves) as u128) / (v3 as u128);
            assert!(v5 <= 18446744073709551615, 14);
            (v5 as u64)
        };
