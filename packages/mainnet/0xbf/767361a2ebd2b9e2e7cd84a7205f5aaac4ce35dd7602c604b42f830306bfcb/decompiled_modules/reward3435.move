module 0xbf767361a2ebd2b9e2e7cd84a7205f5aaac4ce35dd7602c604b42f830306bfcb::reward3435 {
    struct REWARD3435 has drop {
        dummy_field: bool,
    }

    struct TICKET_3435 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3435(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3435>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3435>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3435, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3435>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3435>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3435>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3435>>(v5, 0x2::tx_context::sender(arg1));
    }
