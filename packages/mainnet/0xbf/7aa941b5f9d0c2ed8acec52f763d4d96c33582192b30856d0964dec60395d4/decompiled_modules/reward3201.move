module 0xbf7aa941b5f9d0c2ed8acec52f763d4d96c33582192b30856d0964dec60395d4::reward3201 {
    struct REWARD3201 has drop {
        dummy_field: bool,
    }

    struct TICKET_3201 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3201(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3201>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3201>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3201, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3201>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3201>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3201>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3201>>(v5, 0x2::tx_context::sender(arg1));
    }
