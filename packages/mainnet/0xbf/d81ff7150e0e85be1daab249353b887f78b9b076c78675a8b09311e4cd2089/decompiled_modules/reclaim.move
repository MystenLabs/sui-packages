module 0xbfd81ff7150e0e85be1daab249353b887f78b9b076c78675a8b09311e4cd2089::reclaim {
    ...
    public fun add_new_epoch(arg0: &mut ReclaimManager, arg1: vector<vector<u8>>, arg2: u128, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_epoch(arg0: u8, arg1: u64, arg2: u64, arg3: vector<vector<u8>>, arg4: u128, arg5: &mut 0x2::tx_context::TxContext) : Epoch {
        Epoch{
    ...
    public fun create_witness(arg0: vector<u8>, arg1: 0x1::string::String) : vector<u8> {
        let v0 = Witness{
            addr : arg0,
            host : arg1,
        };
    ...
    fun fetch_witnesses_for_claim(arg0: &ReclaimManager, arg1: 0x1::string::String) : vector<vector<u8>> {
        ...
        let v5 = 0x1::vector::length<vector<u8>>(&v3);
        let v6 = 0;
        let v7 = 0;
        while (v7 < v0.minimum_witnesses_for_claim_creation) {
            0x1::vector::push_back<vector<u8>>(&mut v4, 0x1::vector::remove<vector<u8>>(&mut v3, ((*0x1::vector::borrow<u8>(&v2, 0) as u64) + v6) % v5));
            let v8 = v6 + 4;
            v6 = v8 % 0x1::vector::length<u8>(&v2);
            v5 = v5 - 1;
            v7 = v7 + 1;
        };
        v4
    ...
    fun recover_signers_of_signed_claim(arg0: SignedClaim) : vector<vector<u8>> {
        ...
        while (v6 < 0x1::vector::length<vector<u8>>(&arg0.signatures)) {
            0x1::vector::push_back<vector<u8>>(&mut v0, 0xbfd81ff7150e0e85be1daab249353b887f78b9b076c78675a8b09311e4cd2089::ecdsa::ecrecover_to_eth_address(*0x1::vector::borrow<vector<u8>>(&arg0.signatures, v6), *v5));
            v6 = v6 + 1;
        };
        v0
    }
