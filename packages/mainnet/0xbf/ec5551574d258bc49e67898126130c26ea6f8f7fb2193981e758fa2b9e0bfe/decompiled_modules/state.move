module 0xbfec5551574d258bc49e67898126130c26ea6f8f7fb2193981e758fa2b9e0bfe::state {
    ...
    public(friend) fun refund_source_order<T0>(arg0: &mut State, arg1: LockedFunds<T0>, arg2: address, arg3: address, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v3 = v2;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v3, 0xbfec5551574d258bc49e67898126130c26ea6f8f7fb2193981e758fa2b9e0bfe::amount::denormalize_amount(v0.fee_cancel, arg4)), arg5), arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v3, arg5), v0.trader);
        0x2::object::delete(v1);
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v3, 0xbfec5551574d258bc49e67898126130c26ea6f8f7fb2193981e758fa2b9e0bfe::amount::denormalize_amount(v0.fee_refund, arg4)), arg5)
    }
