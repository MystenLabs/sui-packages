module 0xbfa88a06ccb6a72e57e152d7e8dc47d161423d810d729da327bc135467e8e9f6::deep {
    ...
    fun init(arg0: DEEP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<DEEP>(&mut v2, 10000000000000 * 0x1::u64::pow(10, 6), 0x2::tx_context::sender(arg1), arg1);
