module 0xbf32ceeeb956ae07e0ea8d2a3b61f3adaeb3e962c6dd85abb9746d641a3d3154::recording_master_reference {
    ...
    public fun has_master_reference<T0, T1>(arg0: &0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::Recording<T0, T1>) : bool {
    ...
    public fun master_reference<T0, T1>(arg0: &0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::Recording<T0, T1>) : &0x87c196f475ea38ad3493daa600087a0203c3406a20ffd393aae23b801decbd10::walrus_data::WalrusData {
    ...
    public fun set_master_reference<T0, T1>(arg0: &mut 0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::Recording<T0, T1>, arg1: &0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::RecordingAdminCap<T0>, arg2: 0x87c196f475ea38ad3493daa600087a0203c3406a20ffd393aae23b801decbd10::walrus_data::WalrusData) {
        ...
        let v4 = MasterReferenceSetEvent{recording_id: 0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::id<T0, T1>(arg0)};
        0x2::event::emit<MasterReferenceSetEvent>(v4);
    }

    public fun unset_master_reference<T0, T1>(arg0: &mut 0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::Recording<T0, T1>, arg1: &0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::RecordingAdminCap<T0>) {
        let v0 = 0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::uid_mut<T0, T1>(arg0, arg1);
        let v1 = ExtensionKey{dummy_field: false};
        if (0x2::dynamic_field::exists<ExtensionKey>(v0, v1)) {
            let v2 = ExtensionKey{dummy_field: false};
            ...
            let v3 = MasterReferenceUnsetEvent{recording_id: 0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::id<T0, T1>(arg0)};
