module 0x79f0b9a0862120619e0ed79690c81be28032b63b2b4fb19226dc81f40fa60d03::SSR {
    ...
    public entry fun transfer_bulk(arg0: 0x2::coin::Coin<SSR>, arg1: vector<address>, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<address>(&arg1);
        assert!(v0 == 0x1::vector::length<u64>(&arg2), 100);
        let v1 = 0;
        let v2 = 0;
        while (v2 < v0) {
        ...
        assert!(0x2::coin::value<SSR>(&arg0) >= v1, 3);
        let v3 = 0;
        while (v3 < v0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<SSR>>(0x2::coin::split<SSR>(&mut arg0, *0x1::vector::borrow<u64>(&arg2, v3), arg3), *0x1::vector::borrow<address>(&arg1, v3));
            v3 = v3 + 1;
        };
        0x2::pay::keep<SSR>(arg0, arg3);
    }

    public entry fun transfer_inno_protocol_reserve(arg0: 0x2::coin::Coin<SSR>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<SSR>(&arg0) >= arg1, 4);
        0x2::transfer::public_transfer<0x2::coin::Coin<SSR>>(0x2::coin::split<SSR>(&mut arg0, arg1, arg3), arg2);
        0x2::pay::keep<SSR>(arg0, arg3);
    }
