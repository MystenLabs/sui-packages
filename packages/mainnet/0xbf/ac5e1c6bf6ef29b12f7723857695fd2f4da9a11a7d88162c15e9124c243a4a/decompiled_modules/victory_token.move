module 0xbfac5e1c6bf6ef29b12f7723857695fd2f4da9a11a7d88162c15e9124c243a4a::victory_token {
    ...
    fun init(arg0: VICTORY_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::coin::create_currency<VICTORY_TOKEN>(arg0, 6, b"VICTORY", b"Victory Token", b"Native token for SUIDEX ecosystem", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://cryptomischief.mypinata.cloud/ipfs/bafybeid2ef3p7qxc3znj5ztbkmidfmbgb43dzclc6c2qyjfqfi5jr65nnm/Victory.png")), arg1);
    ...
    public entry fun transfer_minter_cap(arg0: MinterCap, arg1: address) {
        assert!(arg1 != @0x0, 3);
        arg0.admin = arg1;
