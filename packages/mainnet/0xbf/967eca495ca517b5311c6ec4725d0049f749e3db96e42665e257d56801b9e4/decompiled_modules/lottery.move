module 0xbf967eca495ca517b5311c6ec4725d0049f749e3db96e42665e257d56801b9e4::lottery {
    ...
    public fun purchase_tickets(arg0: &mut Lottery, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        if (0x2::vec_map::contains<address, u64>(&arg0.participants, &v2)) {
            let (_, _) = 0x2::vec_map::remove<address, u64>(&mut arg0.participants, &v2);
        };
        ...
        while (v7 < arg2) {
            let v8 = Ticket{
                ...
                lottery_id       : v3,
                round_number     : arg0.round_number,
                purchase_count   : v4 + v7 + 1,
                total_purchases  : v4 + arg2,
                lottery_version  : 4,
                contract_version : 1,
                image_url        : 0x1::string::utf8(b"https://www.vremyan.ru/_data/objects/0050/1223/icon.png?1663941676"),
            };
            0x2::transfer::public_transfer<Ticket>(v8, v2);
            v7 = v7 + 1;
        };
