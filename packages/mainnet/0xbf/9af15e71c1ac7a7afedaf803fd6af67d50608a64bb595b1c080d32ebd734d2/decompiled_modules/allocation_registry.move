module 0x7f44717f7dccf31070f2f84f290a01ab5943b175df97515244fa9da7f15f57b0::allocation_registry {
    ...
    public(friend) fun new_deallocations(arg0: &AllocationRegistry, arg1: &0x7f44717f7dccf31070f2f84f290a01ab5943b175df97515244fa9da7f15f57b0::reserve::Reserve, arg2: &0x1b56015b0e1a49d29c7dd95f9f017c198a59e60d09a97031e394fd0292811375::price_calculator::PriceCalculator, arg3: 0x1::type_name::TypeName, arg4: 0x947ba6d88db6337ef4937e15a84fe2967df3253f40b4fdf5e1263f28e9c46430::decimal::Decimal) : 0x7f44717f7dccf31070f2f84f290a01ab5943b175df97515244fa9da7f15f57b0::deallocations::Deallocations {
        let v0 = coin_types_by_lowest_apy(arg0);
        let v1 = 0x7f44717f7dccf31070f2f84f290a01ab5943b175df97515244fa9da7f15f57b0::deallocations::new();
        let v2 = arg4;
        let v3 = 0;
        while (v3 < 0x1::vector::length<0x1::type_name::TypeName>(&v0) && 0x947ba6d88db6337ef4937e15a84fe2967df3253f40b4fdf5e1263f28e9c46430::decimal::gt(v2, 0x947ba6d88db6337ef4937e15a84fe2967df3253f40b4fdf5e1263f28e9c46430::decimal::zero())) {
            ...
            let v6 = 0x7f44717f7dccf31070f2f84f290a01ab5943b175df97515244fa9da7f15f57b0::reserve::amount(arg1, *v4);
            if (v6 > 0) {
                if (v6 >= v5) {
                    v2 = 0x947ba6d88db6337ef4937e15a84fe2967df3253f40b4fdf5e1263f28e9c46430::decimal::zero();
                    0x7f44717f7dccf31070f2f84f290a01ab5943b175df97515244fa9da7f15f57b0::deallocations::deallocate(&mut v1, *v4, v5, arg3 == *v4);
                } else {
                    let v7 = v2;
                    ...
                    0x7f44717f7dccf31070f2f84f290a01ab5943b175df97515244fa9da7f15f57b0::deallocations::deallocate(&mut v1, *v4, v6, arg3 == *v4);
                };
            };
            v3 = v3 + 1;
        };
