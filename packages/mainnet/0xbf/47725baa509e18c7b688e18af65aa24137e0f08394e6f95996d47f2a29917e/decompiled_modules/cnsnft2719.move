module 0xbf47725baa509e18c7b688e18af65aa24137e0f08394e6f95996d47f2a29917e::cnsnft2719 {
    struct CNSNFT2719 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2719, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2719>(arg0, arg1);
