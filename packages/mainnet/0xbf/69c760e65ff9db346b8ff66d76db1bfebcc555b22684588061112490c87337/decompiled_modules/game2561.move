module 0xbf69c760e65ff9db346b8ff66d76db1bfebcc555b22684588061112490c87337::game2561 {
    struct GAME2561 has drop {
        dummy_field: bool,
    }

    struct TICKET_2561 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2561(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2561>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2561>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME2561, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME2561>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2561>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2561>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2561>>(v5, 0x2::tx_context::sender(arg1));
    }
