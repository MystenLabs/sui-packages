module 0xbf24ec38505647b5d27f90233617eba580bd99b5709e813d1112f4f73bd40c62::cnsnft2071 {
    struct CNSNFT2071 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2071, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2071>(arg0, arg1);
