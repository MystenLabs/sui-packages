module 0xbfe812261a4983a63837d5e3947990536985dbdb92afb06fcb61dd0d5d7c4882::nft2202 {
    struct NFT2202 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NFT2202, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<NFT2202>(arg0, arg1);
