module 0xbf773c7949e1651cde78af4542e0b3d6810f0e167a76c1e679dfb5ff182ac0e5::cnsnft7180 {
    struct CNSNFT7180 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7180, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7180>(arg0, arg1);
