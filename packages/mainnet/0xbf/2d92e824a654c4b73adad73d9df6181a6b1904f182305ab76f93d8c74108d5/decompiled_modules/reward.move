module 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::reward {
    ...
    public fun balance_of(arg0: &Reward, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock) : u64 {
        balance_of_at(arg0, arg1, 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::current_timestamp(arg2))
    }
    ...
    public(friend) fun deposit(arg0: &mut Reward, arg1: &0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::reward_authorized_cap::RewardAuthorizedCap, arg2: u64, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::reward_authorized_cap::validate(arg1, arg0.authorized);
    ...
    public(friend) fun earned<T0>(arg0: &Reward, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock) : u64 {
        ...
        let v2 = if (0x2::table::contains<0x1::type_name::TypeName, 0x2::table::Table<0x2::object::ID, u64>>(&arg0.last_earn, v0) && 0x2::table::contains<0x2::object::ID, u64>(0x2::table::borrow<0x1::type_name::TypeName, 0x2::table::Table<0x2::object::ID, u64>>(&arg0.last_earn, v0), arg1)) {
            0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch_start(*0x2::table::borrow<0x2::object::ID, u64>(0x2::table::borrow<0x1::type_name::TypeName, 0x2::table::Table<0x2::object::ID, u64>>(&arg0.last_earn, v0), arg1))
        } else {
            0
        };
        ...
        let v4 = if (v2 >= 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch_start(v3.epoch_start)) {
            v2
        } else {
            0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch_start(v3.epoch_start)
        };
        let v5 = v4;
        let v6 = (0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch_start(0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::current_timestamp(arg2)) - v4) / 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch();
        if (v6 > 0) {
            let v7 = 0;
            while (v7 < v6) {
                ...
                let v8 = 0x2::table::borrow<u64, Checkpoint>(0x2::table::borrow<0x2::object::ID, 0x2::table::Table<u64, Checkpoint>>(&arg0.checkpoints, arg1), get_prior_balance_index(arg0, arg1, v5 + 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch() - 1));
                let v9 = get_prior_supply_index(arg0, v5 + 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch() - 1);
                ...
                v5 = v5 + 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch();
                v7 = v7 + 1;
            };
        };
        v1
    ...
    public(friend) fun get_reward_internal<T0>(arg0: &mut Reward, arg1: address, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0x2::balance::Balance<T0>> {
        ...
        0x2::table::add<0x2::object::ID, u64>(v2, arg2, 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::current_timestamp(arg3));
    ...
    public(friend) fun notify_reward_amount_internal<T0>(arg0: &mut Reward, arg1: 0x2::balance::Balance<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::type_name::get<T0>();
        let v2 = 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch_start(0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::current_timestamp(arg2));
    ...
    public fun rewards_this_epoch<T0>(arg0: &Reward, arg1: &0x2::clock::Clock) : u64 {
        rewards_at_epoch<T0>(arg0, 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch_start(0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::current_timestamp(arg1)))
    }

    public fun total_supply(arg0: &Reward, arg1: &0x2::clock::Clock) : u64 {
        total_supply_at(arg0, 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::current_timestamp(arg1))
    }
    ...
    public(friend) fun update_balances(arg0: &mut Reward, arg1: &0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::reward_authorized_cap::RewardAuthorizedCap, arg2: vector<u64>, arg3: vector<0x2::object::ID>, arg4: u64, arg5: bool, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::reward_authorized_cap::validate(arg1, arg0.authorized);
        assert!(arg0.balance_update_enabled, 931921756019291001);
        assert!(arg4 % 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch() == 0, 97211664930268266);
        ...
        assert!(arg4 < 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch_start(0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::current_timestamp(arg6)), 987934305039328400);
        let v0 = 0;
    ...
    public(friend) fun withdraw(arg0: &mut Reward, arg1: &0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::reward_authorized_cap::RewardAuthorizedCap, arg2: u64, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::reward_authorized_cap::validate(arg1, arg0.authorized);
        let v0 = 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::current_timestamp(arg4);
        let v1 = total_supply_at(arg0, v0) - arg2;
        let v2 = balance_of(arg0, arg3, arg4) - arg2;
    ...
    fun write_checkpoint_internal(arg0: &mut Reward, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch_start(arg3);
        let v2 = if (v0 > 0) {
    ...
    fun write_supply_checkpoint_internal(arg0: &mut Reward, arg1: u64, arg2: u64) {
        let v0 = arg0.supply_num_checkpoints;
        let v1 = 0xbf2d92e824a654c4b73adad73d9df6181a6b1904f182305ab76f93d8c74108d5::common::epoch_start(arg1);
        let v2 = if (v0 > 0) {
