module 0xbfce7981d11c3432e2536d89177ed9d7c4960fff89f7092fd0dabbbf0130c604::agent {
    ...
    fun init(arg0: AGENT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGENT>(arg0, 9, b"QUAT", b"Quatro Agent", b"This is a test agent token", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://example.com/icon.png")), arg1);
