module 0xbf0a2143d4bdcc7562d0f2cf168b0596d73d438305161365f38f481758f59de5::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"VIbe", b"Just Vibe", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-27T08-33-03.535Z-asa.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Just Vibe"),
            symbol     : 0x1::string::utf8(b"VIbe"),
            decimals   : 9,
