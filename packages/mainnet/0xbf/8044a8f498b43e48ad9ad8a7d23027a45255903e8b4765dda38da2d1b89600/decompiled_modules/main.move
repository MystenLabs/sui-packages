module 0xbf8044a8f498b43e48ad9ad8a7d23027a45255903e8b4765dda38da2d1b89600::main {
    ...
    entry fun get_receive_msg_args(arg0: &Storage, arg1: vector<u8>) : Params {
        ...
        0x1::vector::push_back<0x1::string::String>(&mut v8, 0xbf8044a8f498b43e48ad9ad8a7d23027a45255903e8b4765dda38da2d1b89600::swap_order::get_token(&v7));
        let v9 = 0x1::vector::empty<0x1::string::String>();
        let v10 = get_id(arg0);
        0x1::vector::push_back<0x1::string::String>(&mut v9, 0xbf8044a8f498b43e48ad9ad8a7d23027a45255903e8b4765dda38da2d1b89600::utils::id_to_hex_string(&v10));
        0x1::vector::push_back<0x1::string::String>(&mut v9, 0x1::string::utf8(b"srcNid"));
        0x1::vector::push_back<0x1::string::String>(&mut v9, 0x1::string::utf8(b"conn_sn"));
        0x1::vector::push_back<0x1::string::String>(&mut v9, 0x1::string::utf8(b"msg"));
        Params{
            type_args : v8,
            args      : v9,
        }
