module 0xbf3da4e4174fda08f963abf9380e64aedec4d310dbd4a8e03ed4f653c05452ef::coin_a {
    struct COIN_A has drop {
        dummy_field: bool,
    }

    fun init(arg0: COIN_A, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<COIN_A>(arg0, 9, b"coin_a", b"CA", b"coin_a to study simple swap", 0x1::option::none<0x2::url::Url>(), arg1);
