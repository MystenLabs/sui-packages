module 0xbf36d578b2b1c9c837df5fe9f8249b1decdc5e3269835a9be10669365d041bfd::lofi7 {
    struct LOFI7 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LOFI7, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<LOFI7>(arg0, 9, b"LOFI7", b"LOFI7", b"LOFI7", v2, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LOFI7>>(v4);
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<LOFI7>>(v3);
    ...
    public entry fun transfer_with_tax(arg0: &TaxStorage, arg1: &AdminCap, arg2: &mut 0x2::coin::Coin<LOFI7>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        ...
        let v3 = 0x2::balance::split<LOFI7>(0x2::coin::balance_mut<LOFI7>(arg2), arg3);
        if (v0 > 0) {
            let v4 = arg3 * v0 / 10000;
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI7>>(0x2::coin::from_balance<LOFI7>(0x2::balance::split<LOFI7>(&mut v3, v4), arg5), arg1.admin_address);
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI7>>(0x2::coin::from_balance<LOFI7>(0x2::balance::split<LOFI7>(&mut v3, arg3 - v4), arg5), arg4);
            0x2::balance::destroy_zero<LOFI7>(v3);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI7>>(0x2::coin::from_balance<LOFI7>(v3, arg5), arg4);
        };
    }
