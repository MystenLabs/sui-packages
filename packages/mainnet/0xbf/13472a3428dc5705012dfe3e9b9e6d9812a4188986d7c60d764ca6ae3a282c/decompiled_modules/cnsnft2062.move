module 0xbf13472a3428dc5705012dfe3e9b9e6d9812a4188986d7c60d764ca6ae3a282c::cnsnft2062 {
    struct CNSNFT2062 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2062, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2062>(arg0, arg1);
