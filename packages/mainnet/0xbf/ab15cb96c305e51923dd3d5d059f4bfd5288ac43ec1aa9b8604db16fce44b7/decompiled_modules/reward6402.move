module 0xbfab15cb96c305e51923dd3d5d059f4bfd5288ac43ec1aa9b8604db16fce44b7::reward6402 {
    struct REWARD6402 has drop {
        dummy_field: bool,
    }

    struct TICKET_6402 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6402(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6402>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6402>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6402, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6402>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6402>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6402>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6402>>(v5, 0x2::tx_context::sender(arg1));
    }
