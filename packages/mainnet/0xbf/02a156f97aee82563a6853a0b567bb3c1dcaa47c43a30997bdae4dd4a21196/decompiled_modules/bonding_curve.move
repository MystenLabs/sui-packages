module 0x7b4163d17ce18b386ee50929ba48fa0a2ecb60304df4b07e26835aa18617cda2::bonding_curve {
    ...
    public fun claim_creator_fees<T0>(arg0: &CreatorCap, arg1: &mut Curve<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        pay_out_to_payouts<0x2::sui::SUI>(&arg1.payouts, v1, arg3);
        let v2 = CreatorFeesClaimed{
            curve_id : 0x2::object::id<Curve<T0>>(arg1),
            creator  : 0x2::tx_context::sender(arg3),
            amount   : v0,
        };
        0x2::event::emit<CreatorFeesClaimed>(v2);
    }
    ...
    fun do_graduate_inline<T0>(arg0: &mut Curve<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_reserve, v0), arg1);
        pay_out_to_payouts<0x2::sui::SUI>(&arg0.payouts, v2, arg1);
        ...
        let v3 = 0x2::balance::withdraw_all<T0>(&mut arg0.token_reserve);
        if (0x2::balance::value<T0>(&v3) > 0) {
            0x2::coin::burn<T0>(&mut arg0.treasury, 0x2::coin::from_balance<T0>(v3, arg1));
        } else {
    ...
    public fun execute_buyback<T0>(arg0: &mut Curve<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.buyback.burn) {
            ...
            pay_out_to_payouts<T0>(&arg0.payouts, v12, arg2);
        };
        let v13 = BuybackExecuted{
            curve_id      : 0x2::object::id<Curve<T0>>(arg0),
            sui_spent     : v9,
            tokens_bought : v11,
        ...
        0x2::event::emit<BuybackExecuted>(v13);
        if (0x2::balance::value<T0>(&arg0.token_reserve) == 0) {
            do_graduate_inline<T0>(arg0, arg2);
        };
    }
    ...
    fun pay_out_to_payouts<T0>(arg0: &vector<Payout>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<Payout>(arg0);
        let v1 = 0;
        while (v1 < v0 - 1) {
            let v2 = 0x1::vector::borrow<Payout>(arg0, v1);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg1, (((0x2::coin::value<T0>(&arg1) as u128) * (v2.bps as u128) / (10000 as u128)) as u64), arg2), v2.recipient);
            v1 = v1 + 1;
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, 0x1::vector::borrow<Payout>(arg0, v0 - 1).recipient);
    }
    ...
    public fun rebrand_metadata<T0>(arg0: &CreatorCap, arg1: &mut Curve<T0>, arg2: &mut 0x2::coin::CoinMetadata<T0>, arg3: 0x1::option::Option<0x1::string::String>, arg4: 0x1::option::Option<0x1::ascii::String>, arg5: 0x1::option::Option<0x1::string::String>, arg6: 0x1::option::Option<0x1::string::String>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v15 = v14;
        if (v5) {
            0x2::coin::update_name<T0>(&arg1.treasury, arg2, v12);
        };
        if (v6) {
            0x2::coin::update_symbol<T0>(&arg1.treasury, arg2, v13);
        };
        if (v7) {
            0x2::coin::update_description<T0>(&arg1.treasury, arg2, *0x1::option::borrow<0x1::string::String>(&arg5));
        };
        if (v8) {
            0x2::coin::update_icon_url<T0>(&arg1.treasury, arg2, 0x1::ascii::string(*0x1::string::as_bytes(&v15)));
        };
    ...
    public fun resolve_takeover<T0>(arg0: &mut TakeoverProposal<T0>, arg1: &mut Curve<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.resolved = true;
        arg0.succeeded = v2;
        assert!(0x2::dynamic_field::remove<vector<u8>, 0x2::object::ID>(&mut arg1.id, b"cto_live_proposal") == 0x2::object::id<TakeoverProposal<T0>>(arg0), 44);
        if (v2) {
            let v3 = CreatorCap{
                id       : 0x2::object::new(arg3),
                curve_id : 0x2::object::id<Curve<T0>>(arg1),
            ...
            let v4 = Payout{
                recipient : arg0.proposer,
                bps       : 10000,
            };
            let v5 = 0x1::vector::empty<Payout>();
            0x1::vector::push_back<Payout>(&mut v5, v4);
            arg1.payouts = v5;
            0x2::transfer::public_transfer<CreatorCap>(v3, arg0.proposer);
        } else {
            let v6 = if (arg0.total_weight >= v1) {
                0
            } else {
            ...
            let v7 = if (v1 == 0) {
                ...
                (((259200000 as u128) * (v6 as u128) / (v1 as u128)) as u64)
            };
            arg1.cto_cooldown_until_ms = v0 + v7;
        };
        let v8 = TakeoverResolved{
            proposal_id  : 0x2::object::id<TakeoverProposal<T0>>(arg0),
            curve_id     : 0x2::object::id<Curve<T0>>(arg1),
            succeeded    : v2,
            total_weight : arg0.total_weight,
        };
        0x2::event::emit<TakeoverResolved>(v8);
    }
    ...
    fun vested_amount(arg0: u64, arg1: u64, arg2: u64, arg3: u8, arg4: u64) : u64 {
        ...
        if (arg3 == 0) {
            ...
            let v2 = arg2 / 2592000000;
            if (v2 == 0) {
                0
            } else {
                let v3 = v0 / 2592000000;
                let v4 = if (v3 >= v2) {
                    v2 - 1
                } else {
                    v3
                };
                (((arg0 as u128) * (v4 as u128) / (v2 as u128)) as u64)
            }
        }
    }
