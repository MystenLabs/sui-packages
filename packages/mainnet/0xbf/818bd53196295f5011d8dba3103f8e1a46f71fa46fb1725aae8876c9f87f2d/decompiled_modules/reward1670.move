module 0xbf818bd53196295f5011d8dba3103f8e1a46f71fa46fb1725aae8876c9f87f2d::reward1670 {
    struct REWARD1670 has drop {
        dummy_field: bool,
    }

    struct TICKET_1670 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1670(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1670>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1670>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1670, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1670>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1670>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1670>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1670>>(v5, 0x2::tx_context::sender(arg1));
    }
