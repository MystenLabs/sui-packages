module 0xae65ae68423dbf08dc397962e61b6a4760158405477b613c85688a2b0bccebf9::tile {
    ...
    entry fun deposit_v2(arg0: &mut Game, arg1: u64, arg2: vector<u64>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x867c4a77e09e7a9a1bf73c1627bdaeea22374def79e9dda440d861e9d08ccf0b::manager::PlayManager, arg5: &0x7bf0bd74001fdfaaa2796af8dbc6f9bf129a8098fe298a1cd497ca726d7c52d0::version::VersionTable, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<u64>(&arg2) > 0 && 0x1::vector::length<u64>(&arg2) <= arg0.max_future_round, 9223372620971311120);
        assert!(arg1 == arg0.current_round_key, 9223372633856737304);
        ...
        while (v3 < 0x1::vector::length<u64>(&arg2)) {
            ...
            let v4 = 0x2::object_table::borrow_mut<u64, Round>(&mut arg0.rounds, arg1);
            if (!0x2::table::contains<address, u64>(&v4.participant_entry, 0x2::tx_context::sender(arg7))) {
                0x2::table::add<address, u64>(&mut v4.participant_entry, 0x2::tx_context::sender(arg7), 0);
            };
            let v5 = *0x1::vector::borrow<u64>(&arg2, v3);
            assert!(v5 > 0 && v5 + *0x2::table::borrow<address, u64>(&v4.participant_entry, 0x2::tx_context::sender(arg7)) <= arg0.max_user_entry, 9223372715460853780);
            assert!(v5 + v4.current_entry_index <= arg0.max_round_entry, 9223372719755690002);
            let v6 = v5 * v4.value_per_entry;
            assert!(0x2::balance::value<0x2::sui::SUI>(&v0) >= v6, 9223372728345886742);
            let v7 = v4.current_entry_index + v5;
            let v8 = Deposit{
            ...
            0x1::vector::push_back<Deposit>(&mut v4.deposits, v8);
            v4.current_entry_index = v7;
            0x2::balance::join<0x2::sui::SUI>(&mut v4.balance, 0x2::balance::split<0x2::sui::SUI>(&mut v0, v6));
            let v9 = 0x2::table::borrow_mut<address, u64>(&mut v4.participant_entry, 0x2::tx_context::sender(arg7));
            *v9 = *v9 + v5;
            0x1::vector::push_back<u64>(&mut v1, v7);
            0x1::vector::push_back<u64>(&mut v2, 0x2::balance::value<0x2::sui::SUI>(&v4.balance));
            arg1 = arg1 + 1;
            v3 = v3 + 1;
        };
        assert!(0x2::balance::value<0x2::sui::SUI>(&v0) == 0, 9223372827130134550);
        let v10 = Deposited{
        ...
        0x867c4a77e09e7a9a1bf73c1627bdaeea22374def79e9dda440d861e9d08ccf0b::manager::record_play<Witness>(arg4, 0x2::balance::value<0x2::sui::SUI>(&v0), 0x2::tx_context::sender(arg7), &v11, arg6, arg7);
    ...
    entry fun draw_v2(arg0: &mut Game, arg1: u64, arg2: &mut 0x867c4a77e09e7a9a1bf73c1627bdaeea22374def79e9dda440d861e9d08ccf0b::manager::PlayManager, arg3: &mut 0xef199024460c12d9880f7b6bb9712de2a56b3761fd5a480f297dadb60f956c03::referral::ReferralRegistry, arg4: &0x7bf0bd74001fdfaaa2796af8dbc6f9bf129a8098fe298a1cd497ca726d7c52d0::version::VersionTable, arg5: &0x2::random::Random, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 == arg0.current_round_key, 9223373011813859352);
        check_round_status(arg0, arg1, 1);
        let v0 = 0x2::object_table::borrow_mut<u64, Round>(&mut arg0.rounds, arg1);
        assert!(0x1::vector::length<Deposit>(&v0.deposits) > 0 && 0x2::table::length<address, u64>(&v0.participant_entry) > 0, 9223373024697843722);
        assert!(0x2::table::contains<address, u64>(&v0.participant_entry, 0x2::tx_context::sender(arg7)), 9223373028993073166);
        assert!(v0.drawable_time > 0 && v0.drawable_time < 0x2::clock::timestamp_ms(arg6), 9223373033287647240);
        if (0x2::table::length<address, u64>(&v0.participant_entry) < 2) {
        ...
        0x867c4a77e09e7a9a1bf73c1627bdaeea22374def79e9dda440d861e9d08ccf0b::manager::increment_point<Witness>(arg2, get_participant_amount(v0, 0x2::tx_context::sender(arg7)), 0x2::tx_context::sender(arg7), 0x1::type_name::get<0x867c4a77e09e7a9a1bf73c1627bdaeea22374def79e9dda440d861e9d08ccf0b::point::Witness>(), b"MysteryPoint", &v6, arg6, arg7);
        let v7 = v0.value_per_entry * v0.current_entry_index;
        let v8 = v7 * (arg0.fee_in_bp as u64) / 10000;
        let v9 = v7 - v8;
        assert!(v8 + v9 == 0x2::balance::value<0x2::sui::SUI>(&v0.balance), 9223373222266470412);
        ...
        0x867c4a77e09e7a9a1bf73c1627bdaeea22374def79e9dda440d861e9d08ccf0b::manager::emit_play_history<Witness>(arg2, 0x1::u64::to_string(arg1), 0x2::address::to_string(v5), get_participant_amount(v0, v5), v7, v9, &v12);
