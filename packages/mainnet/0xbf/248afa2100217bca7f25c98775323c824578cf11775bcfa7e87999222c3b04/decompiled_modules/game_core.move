module 0xbf248afa2100217bca7f25c98775323c824578cf11775bcfa7e87999222c3b04::game_core {
    ...
    public fun batch_rotate_banner(arg0: &CharacterAdminCap, arg1: &mut TemplateRegistry, arg2: vector<u64>, arg3: vector<u8>, arg4: vector<u64>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0;
        while (v2 < v0) {
            deactivate_template(arg0, arg1, *0x1::vector::borrow<u64>(&arg2, v2), *0x1::vector::borrow<u8>(&arg3, v2), arg6);
            v2 = v2 + 1;
        };
        let v3 = 0;
        while (v3 < v1) {
