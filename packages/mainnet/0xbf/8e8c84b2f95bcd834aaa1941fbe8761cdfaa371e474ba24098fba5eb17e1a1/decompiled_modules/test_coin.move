module 0xbf8e8c84b2f95bcd834aaa1941fbe8761cdfaa371e474ba24098fba5eb17e1a1::test_coin {
    ...
    public fun mint_max_supply(arg0: &mut 0x2::coin::TreasuryCap<TEST_COIN>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<TEST_COIN> {
        assert!(0x2::coin::total_supply<TEST_COIN>(arg0) + 100000000000000 <= 100000000000000, 0);
        0x2::coin::mint<TEST_COIN>(arg0, 100000000000000, arg1)
    }
