module 0xbf2fa33ff44e015f3baf5701a41114b94d89da8d146df0a3b8e0e44e9ef3af65::mining_rig_sui_network {
    struct MINING_RIG_SUI_NETWORK has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MINING_RIG_SUI_NETWORK, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MINING_RIG_SUI_NETWORK>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Mining Rig Sui Network"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Satoshi Mining Rig is a NFT-based mining ecosystem built on the Sui Network. Each NFT represents a digital mining rig that powers your access to rewards, upgrades, and exclusive utilities. Designed for scalability and user engagement, Satoshi Mining Rig combines hold-to-earn, play-to-earn, and staking mechanics to create a dynamic earning experience."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeihmhhhdqd2d66nnohkci7hdclx5xwuskkvfgcksqczqf77aded2dy"));
