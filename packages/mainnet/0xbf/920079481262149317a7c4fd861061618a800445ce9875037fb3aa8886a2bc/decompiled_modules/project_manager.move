module 0xbf920079481262149317a7c4fd861061618a800445ce9875037fb3aa8886a2bc::project_manager {
    ...
    public fun batch_add_whitelist<T0>(arg0: &0xbf920079481262149317a7c4fd861061618a800445ce9875037fb3aa8886a2bc::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut ProjectManager<T0>, arg2: vector<address>, arg3: vector<u64>) {
    ...
    public fun batch_remove_whitelist<T0>(arg0: &mut ProjectManager<T0>, arg1: &0xbf920079481262149317a7c4fd861061618a800445ce9875037fb3aa8886a2bc::launchpad_manager_config::LaunchManagerAdmin, arg2: vector<address>) {
        let v0 = 0x1::vector::length<address>(&arg2);
        assert!(v0 <= 200, 13);
        let v1 = 0;
        while (v1 < v0) {
    ...
    public fun change_pay_nft_status(arg0: &mut PayNft, arg1: &0xbf920079481262149317a7c4fd861061618a800445ce9875037fb3aa8886a2bc::launchpad_manager_config::LaunchAdmin) {
        arg0.status = 1;
    }
    ...
    public entry fun initialize_project_manager<T0>(arg0: &0xbf920079481262149317a7c4fd861061618a800445ce9875037fb3aa8886a2bc::launchpad_manager_config::LaunchAdmin, arg1: &mut PayNft, arg2: u64, arg3: u64, arg4: u64, arg5: u8, arg6: &mut ProjectManagerConfig, arg7: &mut 0x2::tx_context::TxContext) {
        assert_version(arg6);
        let v0 = if (arg5 == 0) {
            true
        } else if (arg5 == 1) {
    ...
    public fun project_falied<T0>(arg0: &mut ProjectManager<T0>, arg1: &0xbf920079481262149317a7c4fd861061618a800445ce9875037fb3aa8886a2bc::launchpad_manager_config::LaunchAdmin, arg2: &0x2::clock::Clock) {
    ...
    public fun set_project_config(arg0: &0xbf920079481262149317a7c4fd861061618a800445ce9875037fb3aa8886a2bc::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut ProjectManagerConfig, arg2: u8, arg3: u64, arg4: u64, arg5: u64) {
