module 0xbfa32851690179e9576df04d932108040ca585f5c9ee487908b5ae92466367a8::test_wallet_holding_migration {
    ...
    fun get_available_amount(arg0: &HydroLocker, arg1: 0x1::string::String, arg2: &StartVesting, arg3: &0x2::clock::Clock) : (u64, u64, u64) {
        ...
        assert!(v0 >= arg2.tge_timestamp_date, 20);
    ...
    public entry fun migrate_users_data(arg0: &MaintainerRole, arg1: &mut HydroLocker, arg2: vector<0x1::string::String>, arg3: vector<u64>, arg4: &UpgradeVersion, arg5: 0x1::option::Option<u64>, arg6: &PauseUnpauseContract, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(arg4.version == 1, 2);
        assert!(!arg6.is_paused, 22);
        assert!(0x2::vec_set::contains<address>(&arg0.has_maintainer_access, &v0), 18);
        let v1 = 0x1::vector::length<0x1::string::String>(&arg2);
        assert!(v1 != 0, 11);
        ...
        assert!(v2 != 0, 11);
        assert!(v1 == v2, 3);
        let v3 = set_total_supply_amount(arg1, arg5);
        let v4 = process_accounts_and_amounts(arg2, arg3, arg1, v3);
        arg1.total_claims_amount = v4;
        let v5 = MigratedData{
            evm_addresses : arg2,
            amounts       : arg3,
        };
        0x2::event::emit<MigratedData>(v5);
    }
    ...
    public entry fun pause_unpause_contract(arg0: &mut Owner, arg1: &mut PauseUnpauseContract, arg2: &UpgradeVersion, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg2.version == 1, 2);
        if (arg3) {
            assert!(!arg1.is_paused, 22);
            arg1.is_paused = true;
        } else {
            assert!(arg1.is_paused, 23);
    ...
    fun process_accounts_and_amounts(arg0: vector<0x1::string::String>, arg1: vector<u64>, arg2: &mut HydroLocker, arg3: u64) : u64 {
        ...
        while (v1 < 0x1::vector::length<0x1::string::String>(&arg0)) {
            ...
            0x2::table::add<0x1::string::String, Locker>(&mut arg2.lockers, *0x1::vector::borrow<0x1::string::String>(&arg0, v1), v3);
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public entry fun rescue_with_accounts(arg0: &Owner, arg1: &mut HydroLocker, arg2: &mut StartVesting, arg3: &0x2::clock::Clock, arg4: &mut VestedTokens, arg5: vector<0x1::string::String>, arg6: &UpgradeVersion, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0;
        while (v2 < v1) {
            assert!(0x2::table::contains<0x1::string::String, Locker>(&arg1.lockers, *0x1::vector::borrow<0x1::string::String>(&arg5, v2)), 5);
            v2 = v2 + 1;
        };
        let v3 = 0;
        while (v3 < v1) {
            ...
            assert!(0 != v5, 12);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x4bb07b086c13bda7af26b9872fa8c4b460a9c0479cde6a63de4b9d29ea0ec99a::test_token::TEST_TOKEN>>(0x2::coin::split<0x4bb07b086c13bda7af26b9872fa8c4b460a9c0479cde6a63de4b9d29ea0ec99a::test_token::TEST_TOKEN>(&mut arg4.coin, v5, arg7), v0);
            let v8 = 0x2::table::borrow_mut<0x1::string::String, Locker>(&mut arg1.lockers, v4);
    ...
    fun set_total_supply_amount(arg0: &mut HydroLocker, arg1: 0x1::option::Option<u64>) : u64 {
        if (!arg0.is_total_supply_set) {
            assert!(!0x1::option::is_none<u64>(&arg1), 24);
            let v0 = 0x1::option::extract<u64>(&mut arg1);
            assert!(v0 > 0, 12);
            arg0.total_vested_amount = v0;
            arg0.is_total_supply_set = true;
            let v1 = SetTotalSupply{total_supply_amount: v0};
            0x2::event::emit<SetTotalSupply>(v1);
            return v0
        };
        assert!(0x1::option::is_none<u64>(&arg1), 25);
        arg0.total_vested_amount
    }

    public entry fun start_vesting(arg0: &mut Owner, arg1: &mut HydroLocker, arg2: &mut 0x2::coin::Coin<0x4bb07b086c13bda7af26b9872fa8c4b460a9c0479cde6a63de4b9d29ea0ec99a::test_token::TEST_TOKEN>, arg3: &mut StartVesting, arg4: &mut VestedTokens, arg5: &0x2::clock::Clock, arg6: u64, arg7: &PauseUnpauseContract, arg8: &UpgradeVersion, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg8.version == 1, 2);
        assert!(0x2::tx_context::sender(arg9) == arg0.owner, 1);
        assert!(!arg7.is_paused, 22);
        assert!(arg3.vesting_started == false, 4);
        assert!(arg6 != 0, 21);
        let v0 = arg1.total_vested_amount;
        assert!(0x2::balance::value<0x4bb07b086c13bda7af26b9872fa8c4b460a9c0479cde6a63de4b9d29ea0ec99a::test_token::TEST_TOKEN>(0x2::coin::balance<0x4bb07b086c13bda7af26b9872fa8c4b460a9c0479cde6a63de4b9d29ea0ec99a::test_token::TEST_TOKEN>(arg2)) >= v0, 13);
    ...
    public entry fun update_hydro_locker_with_new_gth_holders_accounts(arg0: &MaintainerRole, arg1: &mut HydroLocker, arg2: vector<0x1::string::String>, arg3: vector<u64>, arg4: vector<address>, arg5: &PauseUnpauseContract, arg6: &UpgradeVersion, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(arg6.version == 1, 2);
        assert!(arg1.is_total_supply_set, 24);
        assert!(!arg5.is_paused, 22);
        assert!(0x2::vec_set::contains<address>(&arg0.has_maintainer_access, &v0), 18);
    ...
    public entry fun withdraw(arg0: &mut HydroLocker, arg1: &mut StartVesting, arg2: &0x2::clock::Clock, arg3: 0x1::string::String, arg4: &mut VestedTokens, arg5: &PauseUnpauseContract, arg6: &UpgradeVersion, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<0x1::string::String, Locker>(&arg0.lockers, arg3), 5);
        let (v1, _, v3) = get_available_amount(arg0, arg3, arg1, arg2);
        assert!(v1 > 0, 10);
        assert!(v0 == *0x2::table::borrow<0x1::string::String, address>(&arg0.address_locker, arg3), 5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x4bb07b086c13bda7af26b9872fa8c4b460a9c0479cde6a63de4b9d29ea0ec99a::test_token::TEST_TOKEN>>(0x2::coin::split<0x4bb07b086c13bda7af26b9872fa8c4b460a9c0479cde6a63de4b9d29ea0ec99a::test_token::TEST_TOKEN>(&mut arg4.coin, v1, arg7), v0);
        let v4 = 0x2::table::borrow_mut<0x1::string::String, Locker>(&mut arg0.lockers, arg3);
