module 0xbf9af0db7fefdd8a985a4381ae2195bbab656e9875458cd21c16018e74e36f3e::reward7144 {
    struct REWARD7144 has drop {
        dummy_field: bool,
    }

    struct TICKET_7144 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7144(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7144>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7144>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7144, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7144>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7144>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7144>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7144>>(v5, 0x2::tx_context::sender(arg1));
    }
