module 0xbf5b5c85002110177b7952858254888ec2d22ee5003771cdc92917f6768fb585::reward6899 {
    struct REWARD6899 has drop {
        dummy_field: bool,
    }

    struct TICKET_6899 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6899(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6899>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6899>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6899, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6899>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6899>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6899>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6899>>(v5, 0x2::tx_context::sender(arg1));
    }
