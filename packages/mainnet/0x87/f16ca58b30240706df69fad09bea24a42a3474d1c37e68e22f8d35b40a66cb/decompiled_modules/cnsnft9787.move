module 0x87f16ca58b30240706df69fad09bea24a42a3474d1c37e68e22f8d35b40a66cb::cnsnft9787 {
    struct CNSNFT9787 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9787, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9787>(arg0, arg1);
