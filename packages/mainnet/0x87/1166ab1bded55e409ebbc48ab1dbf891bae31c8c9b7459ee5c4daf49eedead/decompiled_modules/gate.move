module 0xc33a96dc18fc894c191ea046cc170673ece2c6b3d28685f67e1d2b3027550591::gate {
    ...
    public fun pa<T0>(arg0: 0x2::balance::Balance<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert_profit_to_recipient<T0>(0xc33a96dc18fc894c191ea046cc170673ece2c6b3d28685f67e1d2b3027550591::admin::a(), arg0, arg1, arg2);
    }

    public fun pae<T0>(arg0: 0x2::balance::Balance<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        pa<T0>(arg0, arg1, arg2);
        emit_profit_realized<T0>(0x2::balance::value<T0>(&arg0), arg1);
    }

    public fun pv<T0>(arg0: &mut 0xc33a96dc18fc894c191ea046cc170673ece2c6b3d28685f67e1d2b3027550591::wallet::Vault<T0>, arg1: 0x2::balance::Balance<T0>, arg2: u64) {
        assert_profit_to_vault<T0>(arg0, arg1, arg2);
    }

    public fun pve<T0>(arg0: &mut 0xc33a96dc18fc894c191ea046cc170673ece2c6b3d28685f67e1d2b3027550591::wallet::Vault<T0>, arg1: 0x2::balance::Balance<T0>, arg2: u64) {
        assert_profit_and_emit_to_vault<T0>(arg0, arg1, arg2);
    }
