module 0x73fada5297ef08f7e7fd2413bbcd3253ace9d730b5be04bcde192d436d8aa323::config_registry {
    ...
    fun assert_is_operator(arg0: &Config, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(v0 == arg0.dev_addr || v0 == arg0.lp_operator_addr, 102);
    }
    ...
    public entry fun set_emergency_fixed_mode_v2(arg0: &mut Config, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        assert_is_operator(arg0, arg2);
        arg0.emergency_fixed_mode = arg1;
    }
    ...
    public entry fun set_fees_and_ratios_v2(arg0: &mut Config, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        assert_is_operator(arg0, arg7);
        arg0.today_fee_usd = arg1;
        arg0.nostalgia_fee_usd = arg2;
        arg0.today_dev_ratio = arg3;
        arg0.today_pol_ratio = arg4;
        arg0.nostalgia_dev_ratio = arg5;
        arg0.nostalgia_pol_ratio = arg6;
    }
    ...
    public entry fun set_lp_target_price_bps(arg0: &mut Config, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert_is_operator(arg0, arg2);
        arg0.lp_target_ratio_bps = arg1;
    }

    public fun set_mint_vault_id(arg0: &mut Config, arg1: 0x2::object::ID) {
    ...
    public entry fun set_rewards_v2(arg0: &mut Config, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert_is_operator(arg0, arg4);
        assert!(arg1 <= 500000000, 101);
        assert!(arg2 <= 500000000, 101);
        assert!(arg3 <= 500000000, 101);
        arg0.reward_today_immediate = arg1;
        arg0.reward_today_deferred = arg2;
        arg0.reward_nostalgia_base = arg3;
    }
