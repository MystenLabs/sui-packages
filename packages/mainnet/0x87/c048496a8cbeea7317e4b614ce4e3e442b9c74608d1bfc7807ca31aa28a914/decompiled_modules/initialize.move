module 0x87c048496a8cbeea7317e4b614ce4e3e442b9c74608d1bfc7807ca31aa28a914::initialize {
    struct AddLiquidityHook has drop {
        dummy_field: bool,
    }

    public fun init_secondary_market<T0, T1, T2>(arg0: &0x87c048496a8cbeea7317e4b614ce4e3e442b9c74608d1bfc7807ca31aa28a914::admin::Admin, arg1: 0x87c048496a8cbeea7317e4b614ce4e3e442b9c74608d1bfc7807ca31aa28a914::bound_curve_amm::SeedPool, arg2: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg3: &0x2::coin::CoinMetadata<T1>, arg4: 0x2::coin::TreasuryCap<T2>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3, v4, _, _, v7, v8) = 0x87c048496a8cbeea7317e4b614ce4e3e442b9c74608d1bfc7807ca31aa28a914::bound_curve_amm::destroy_pool<T0, 0x2::sui::SUI, T1>(arg1);
        let v9 = v4;
        let v10 = v1;
        let v11 = v0;
        assert!(v7, 0);
        ...
        assert!(v12 == 0x87c048496a8cbeea7317e4b614ce4e3e442b9c74608d1bfc7807ca31aa28a914::utils::mist(30000), 0);
        ...
        let v13 = 0x2::balance::split<T1>(&mut v9, 0x87c048496a8cbeea7317e4b614ce4e3e442b9c74608d1bfc7807ca31aa28a914::math::div_mul(0x2::balance::value<T1>(&v9), 10000, 8000));
        ...
        0x2::transfer::public_share_object<0x87c048496a8cbeea7317e4b614ce4e3e442b9c74608d1bfc7807ca31aa28a914::staking_pool::StakingPool<T0, T1, T2>>(0x87c048496a8cbeea7317e4b614ce4e3e442b9c74608d1bfc7807ca31aa28a914::staking_pool::new<T0, T1, T2>(0x2::object::id<0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::interest_pool::InterestPool<0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::curves::Volatile>>(&v26), v9, 0x2::coin::into_balance<T2>(v25), 0x87c048496a8cbeea7317e4b614ce4e3e442b9c74608d1bfc7807ca31aa28a914::vesting::default_config(arg5), v24, v8, arg6));
        0x87c048496a8cbeea7317e4b614ce4e3e442b9c74608d1bfc7807ca31aa28a914::coin_decimals::destroy_coin_decimals(v14, arg6);
    }
