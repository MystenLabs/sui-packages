module 0x8715b8e89f9d884a872afeb8bc57b09bd9e1de00b1e8bb1f4a592e8bacc99267::cnsnft9603 {
    struct CNSNFT9603 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9603, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9603>(arg0, arg1);
