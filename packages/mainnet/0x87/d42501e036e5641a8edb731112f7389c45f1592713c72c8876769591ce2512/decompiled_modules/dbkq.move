module 0x87d42501e036e5641a8edb731112f7389c45f1592713c72c8876769591ce2512::dbkq {
    ...
    public fun gps<T0, T1, T2, T3>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T3>, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T1, T3>, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T2, T3>, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager) {
        let (v0, v1, v2) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::locked_balance<T0, T3>(arg0, arg3);
        let (v3, v4, v5) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::locked_balance<T1, T3>(arg1, arg3);
        let (v6, v7, v8) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::locked_balance<T2, T3>(arg2, arg3);
        let v9 = ACP{
            a : 0x1::string::utf8(b"SUI"),
            l : v0,
            f : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T0>(arg3),
        };
        0x2::event::emit<ACP>(v9);
        let v10 = ACP{
            a : 0x1::string::utf8(b"USDC"),
            l : v1 + v4,
            f : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T3>(arg3),
        };
        0x2::event::emit<ACP>(v10);
        let v11 = ACP{
            a : 0x1::string::utf8(b"DEEP"),
            l : v2 + v3 + v5 + v8,
            f : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T1>(arg3),
        };
        0x2::event::emit<ACP>(v11);
        let v12 = ACP{
            a : 0x1::string::utf8(b"WAL"),
            l : v6 + v7,
            f : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T2>(arg3),
        };
