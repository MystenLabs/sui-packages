module 0x87c878801db4cc5f46c46bcbc506d7a53866f5b629aabc116e6600b197129587::cnsnft7499 {
    struct CNSNFT7499 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7499, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3562"));
        let v4 = 0x2::package::claim<CNSNFT7499>(arg0, arg1);
