module 0x87ada1a24ede7a65781eb91761a67850750f1eb5a4f7ed21a8be869701339d46::cnsnft2434 {
    struct CNSNFT2434 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2434, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2434>(arg0, arg1);
