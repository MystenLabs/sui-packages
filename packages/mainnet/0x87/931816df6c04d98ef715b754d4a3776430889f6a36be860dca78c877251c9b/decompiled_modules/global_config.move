module 0x9670f05d34e81acae47e27db3bd088261d75660a5cd57c43baecf703a584a441::global_config {
    ...
    struct SponsorFeeRecord has store, key {
        id: 0x2::object::UID,
        sponsor_fee_records: 0x2::table::Table<0x2::object::ID, u64>,
    ...
    public(friend) fun add_sponsor_record(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<0x2::object::ID, u64>(&v1.sponsor_fee_records, v0)) {
            0x2::table::add<0x2::object::ID, u64>(&mut v1.sponsor_fee_records, v0, arg1);
        } else {
            let v2 = *0x2::table::borrow<0x2::object::ID, u64>(&v1.sponsor_fee_records, v0);
            assert!(v2 + arg1 <= v1.epoch_sponsor_fee_limit, 3);
            0x2::table::add<0x2::object::ID, u64>(&mut v1.sponsor_fee_records, v0, v2 + arg1);
        };
    }
    ...
    public entry fun init_sponsor_fee_record(arg0: &mut GlobalConfig, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = SponsorFeeRecord{
            ...
            sponsor_fee_records     : 0x2::table::new<0x2::object::ID, u64>(arg1),
    ...
    fun user_sponsor_key(arg0: &0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x2::tx_context::epoch(arg0);
        let v1 = 0x2::object::id_from_address(0x2::tx_context::sender(arg0));
        let v2 = 0x1::vector::empty<u8>();
        0x1::vector::append<u8>(&mut v2, 0x1::bcs::to_bytes<u64>(&v0));
        0x1::vector::append<u8>(&mut v2, 0x2::object::id_to_bytes(&v1));
        0x2::object::id_from_bytes(v2)
    }
