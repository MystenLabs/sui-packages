module 0x873326ede3a9596c5815cc1377f747213c206d06dec399719dcc5f41f61281bb::tpepe {
    ...
    fun init(arg0: TPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TPEPE>(arg0, 6, b"TPEPE", b"", b"", 0x1::option::none<0x2::url::Url>(), arg1);
