module 0xfadc2a695e4d92612a203f5bfc48e9f0a5be4d6bad9d08b1e8f06ce9be7a3f5a::bluefin_vault {
    ...
    entry fun admin_batch_force_withdraw<T0>(arg0: &0xfadc2a695e4d92612a203f5bfc48e9f0a5be4d6bad9d08b1e8f06ce9be7a3f5a::roles::AdminCap, arg1: &0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::perpetual::PerpetualV2, arg2: &0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::margin_bank::BankV2<T0>, arg3: &mut Vault<T0>, arg4: vector<address>, arg5: vector<u64>) {
        ...
        assert!(arg3.perpetual_id == 0x2::object::uid_to_inner(0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::perpetual::id_v2(arg1)), 0xfadc2a695e4d92612a203f5bfc48e9f0a5be4d6bad9d08b1e8f06ce9be7a3f5a::errors::perp_not_supported());
        assert!(arg3.bank == 0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::margin_bank::get_bank_id<T0>(arg2), 0xfadc2a695e4d92612a203f5bfc48e9f0a5be4d6bad9d08b1e8f06ce9be7a3f5a::errors::bluefin_bank_mismatch());
        assert!(0x1::vector::length<address>(&arg4) == 0x1::vector::length<u64>(&arg5), 0xfadc2a695e4d92612a203f5bfc48e9f0a5be4d6bad9d08b1e8f06ce9be7a3f5a::errors::invalid_size());
        while (!0x1::vector::is_empty<address>(&arg4)) {
            let v0 = 0x1::vector::pop_back<address>(&mut arg4);
            let v1 = 0x1::vector::pop_back<u64>(&mut arg5);
            if (0x2::table::contains<address, u64>(&arg3.user_shares, v0)) {
                let v2 = 0x2::table::borrow_mut<address, u64>(&mut arg3.user_shares, v0);
                let v3 = *v2;
                if (v3 > 0 && v1 > 0) {
                    *v2 = 0;
                    arg3.total_shares = arg3.total_shares - v3;
                    if (!0x2::table::contains<address, u64>(&arg3.user_pending_withdrawals, v0)) {
                        0x2::table::add<address, u64>(&mut arg3.user_pending_withdrawals, v0, 0);
                    };
                    let v4 = 0x2::table::borrow_mut<address, u64>(&mut arg3.user_pending_withdrawals, v0);
                    *v4 = *v4 + v1;
                    0xfadc2a695e4d92612a203f5bfc48e9f0a5be4d6bad9d08b1e8f06ce9be7a3f5a::events::emit_funds_withdrawn_event(0x2::object::uid_to_inner(&arg3.id), v0, 0, v3, 0, arg3.total_shares, vault_balance<T0>(arg3.bank_account, arg3.amount_to_be_withdrawn, arg2, arg1));
                    continue
                };
            };
        };
    ...
    entry fun deposit_to_vault<T0>(arg0: &0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::perpetual::PerpetualV2, arg1: &mut 0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::margin_bank::BankV2<T0>, arg2: &mut 0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::roles::Sequencer, arg3: &mut Vault<T0>, arg4: &mut 0x2::coin::Coin<T0>, arg5: u64, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 > 0 && arg3.total_shares > 0) {
            v2 = (((arg5 as u128) * (arg3.total_shares as u128) / (v1 as u128)) as u64);
        };
    ...
    public fun get_amount_to_be_withdrawn<T0>(arg0: &Vault<T0>) : u64 {
        arg0.amount_to_be_withdrawn
    }
    ...
    public fun get_user_pending_withdrawals<T0>(arg0: &Vault<T0>, arg1: address) : u64 {
        *0x2::table::borrow<address, u64>(&arg0.user_pending_withdrawals, arg1)
    }

    public fun get_user_shares<T0>(arg0: &Vault<T0>, arg1: address) : u64 {
    ...
    entry fun update_vault_funds_to_be_withdrawn<T0>(arg0: &0xfadc2a695e4d92612a203f5bfc48e9f0a5be4d6bad9d08b1e8f06ce9be7a3f5a::roles::AdminCap, arg1: &mut Vault<T0>, arg2: u64) {
        assert!(arg1.version == 0xfadc2a695e4d92612a203f5bfc48e9f0a5be4d6bad9d08b1e8f06ce9be7a3f5a::constants::get_version(), 0xfadc2a695e4d92612a203f5bfc48e9f0a5be4d6bad9d08b1e8f06ce9be7a3f5a::errors::version_mismatch());
        arg1.amount_to_be_withdrawn = arg1.amount_to_be_withdrawn + arg2;
    }
    ...
    entry fun withdraw_from_vault<T0>(arg0: &0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::perpetual::PerpetualV2, arg1: &0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::margin_bank::BankV2<T0>, arg2: &mut Vault<T0>, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        let v3 = (((arg3 as u128) * (v2 as u128) / (arg2.total_shares as u128)) as u64);
