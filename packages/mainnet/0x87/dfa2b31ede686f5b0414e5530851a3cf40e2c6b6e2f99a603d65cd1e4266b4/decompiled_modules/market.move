module 0x66bca0a8bf805cc9ad9ba6c09ac57a596412e47d1dec70b325e4be49e7e00c34::market {
    ...
    public fun get_market_data_v2(arg0: &Global, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, UserInfo>(&v1.user_infos, v0)) {
            ...
            while (v11 < 0x1::vector::length<0x2::object::ID>(&v10)) {
                ...
                if (0x2::bag::contains<0x2::object::ID>(&v1.stores, v12)) {
                    ...
                    let (_, v15) = 0x66bca0a8bf805cc9ad9ba6c09ac57a596412e47d1dec70b325e4be49e7e00c34::sui20::get_sui20_data(&v13.obj);
                    let v16 = ListedItem{
                        id     : v12,
                        amount : v15,
                        price  : v13.price,
        ...
        while (0x2::bag::contains<u64>(&v1.stores, v18) && v19 < arg4) {
            ...
            let (_, v22) = 0x66bca0a8bf805cc9ad9ba6c09ac57a596412e47d1dec70b325e4be49e7e00c34::sui20::get_sui20_data(&v20.obj);
            let v23 = ListedItemV2{
                store_index : v18,
                id          : 0x2::object::id<0x66bca0a8bf805cc9ad9ba6c09ac57a596412e47d1dec70b325e4be49e7e00c34::sui20::Sui20>(&v20.obj),
                amount      : v22,
                price       : v20.price,
            };
