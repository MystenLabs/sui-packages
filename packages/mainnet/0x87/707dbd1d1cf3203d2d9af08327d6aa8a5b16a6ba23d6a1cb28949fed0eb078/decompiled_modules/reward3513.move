module 0x87707dbd1d1cf3203d2d9af08327d6aa8a5b16a6ba23d6a1cb28949fed0eb078::reward3513 {
    struct REWARD3513 has drop {
        dummy_field: bool,
    }

    struct TICKET_3513 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3513(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3513>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3513>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3513, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3513>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3513>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3513>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3513>>(v5, 0x2::tx_context::sender(arg1));
    }
