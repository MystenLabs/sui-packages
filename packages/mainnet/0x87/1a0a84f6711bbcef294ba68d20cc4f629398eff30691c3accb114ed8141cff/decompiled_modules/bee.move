module 0x871a0a84f6711bbcef294ba68d20cc4f629398eff30691c3accb114ed8141cff::bee {
    struct BEE has drop {
        dummy_field: bool,
    }
    ...
    public fun get_total_bee_Supply() : u64 {
        0x871a0a84f6711bbcef294ba68d20cc4f629398eff30691c3accb114ed8141cff::constants::total_bee_supply()
    }
    ...
    public fun set_rules<T0>(arg0: &mut 0x2::token::TokenPolicy<T0>, arg1: &0x2::token::TokenPolicyCap<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x871a0a84f6711bbcef294ba68d20cc4f629398eff30691c3accb114ed8141cff::constants::bee_burn_pct();
    ...
    public fun transfer_bees<T0>(arg0: &mut 0x2::token::Token<T0>, arg1: &0x2::token::TokenPolicyCap<T0>, arg2: &mut 0x2::token::TokenPolicy<T0>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x871a0a84f6711bbcef294ba68d20cc4f629398eff30691c3accb114ed8141cff::math::mul_div_u128((arg3 as u128), (*0x2::vec_map::get<0x1::string::String, u64>(&0x2::token::rule_config<T0, Burn, BurnCondition>(v1, arg2).percent, &v2) as u128), (0x871a0a84f6711bbcef294ba68d20cc4f629398eff30691c3accb114ed8141cff::constants::percent_precision() as u128));
