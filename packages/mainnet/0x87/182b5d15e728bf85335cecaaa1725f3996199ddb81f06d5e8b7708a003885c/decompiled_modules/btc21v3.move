module 0x87182b5d15e728bf85335cecaaa1725f3996199ddb81f06d5e8b7708a003885c::btc21v3 {
    ...
    fun init(arg0: BTC21V3, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BTC21V3>(arg0, 9, b"BTC21", b"BTC21", b"BTC21 official coin v3", 0x1::option::none<0x2::url::Url>(), arg1);
