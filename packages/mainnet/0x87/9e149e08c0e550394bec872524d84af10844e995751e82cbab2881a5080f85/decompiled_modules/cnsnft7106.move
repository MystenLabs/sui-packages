module 0x879e149e08c0e550394bec872524d84af10844e995751e82cbab2881a5080f85::cnsnft7106 {
    struct CNSNFT7106 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7106, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7106>(arg0, arg1);
