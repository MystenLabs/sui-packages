module 0xf06a113cab684394ceeeba826292c0f5ccc0389c07a6271c85d3435cf9408b26::test {
    ...
    fun add_balance_to_dao<T0>(arg0: &mut Dao, arg1: 0x2::balance::Balance<T0>) {
    ...
    public fun deposit_to_dao<T0>(arg0: &mut Dao, arg1: 0x2::coin::Coin<T0>) {
        check_exist_coin<T0>(arg0);
        0x2::balance::join<T0>(0x2::bag::borrow_mut<u64, 0x2::balance::Balance<T0>>(&mut arg0.investment, hash_type_to_u64<T0>()), 0x2::coin::into_balance<T0>(arg1));
    }
    ...
    public fun exact_in_single<T0, T1>(arg0: &mut Dao, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: bool, arg4: u64, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        add_balance_to_dao<T0>(arg0, v3);
        add_balance_to_dao<T1>(arg0, v2);
    }
    ...
    public fun withdraw<T0>(arg0: &mut Dao, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::bag::remove<u64, 0x2::balance::Balance<T0>>(&mut arg0.investment, hash_type_to_u64<T0>()), arg1), 0x2::tx_context::sender(arg1));
    }
