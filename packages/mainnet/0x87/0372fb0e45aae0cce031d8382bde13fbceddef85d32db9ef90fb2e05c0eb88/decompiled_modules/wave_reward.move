module 0x870372fb0e45aae0cce031d8382bde13fbceddef85d32db9ef90fb2e05c0eb88::wave_reward {
    struct App has key {
        id: 0x2::object::UID,
    ...
    entry fun claim<T0>(arg0: &mut App, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1::string::utf8(b"WAVE_REWARD:");
        ...
        let v7 = 0x1::string::utf8(b"WAVE_REWARD:");
