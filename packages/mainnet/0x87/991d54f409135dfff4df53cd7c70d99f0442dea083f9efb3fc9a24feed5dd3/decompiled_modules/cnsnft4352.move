module 0x87991d54f409135dfff4df53cd7c70d99f0442dea083f9efb3fc9a24feed5dd3::cnsnft4352 {
    struct CNSNFT4352 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4352, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4352>(arg0, arg1);
