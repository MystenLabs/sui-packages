module 0x8788dc52a1d5f9bdefd18058872822e23bab931942913a61f24194a2ad79d81a::allocator {
    ...
    struct RewardsFromDistributorEvent has copy, drop {
        value: u64,
    }

    public(friend) fun add_new_pool(arg0: &mut Allocator, arg1: 0x2::object::ID) {
        assert!(!0x2::vec_map::contains<0x2::object::ID, PoolInfo>(&arg0.members, &arg1), 0x8788dc52a1d5f9bdefd18058872822e23bab931942913a61f24194a2ad79d81a::error::pool_already_present_error());
    ...
    public(friend) fun delete_pool(arg0: &mut Allocator, arg1: 0x2::object::ID) {
        assert!(0x2::vec_map::contains<0x2::object::ID, PoolInfo>(&arg0.members, &arg1), 0x8788dc52a1d5f9bdefd18058872822e23bab931942913a61f24194a2ad79d81a::error::pool_not_present_error());
        ...
        assert!(v3, 0x8788dc52a1d5f9bdefd18058872822e23bab931942913a61f24194a2ad79d81a::error::pool_has_weight_error());
        assert!(!v4, 0x8788dc52a1d5f9bdefd18058872822e23bab931942913a61f24194a2ad79d81a::error::pending_rewards_error());
    ...
    public(friend) fun get_rewards<T0>(arg0: &mut Allocator, arg1: 0x2::object::ID, arg2: u64, arg3: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::get<T0>();
        if (0x2::vec_map::contains<0x2::object::ID, PoolInfo>(&arg0.members, &arg1) && 0x2::bag::contains<0x1::type_name::TypeName>(&arg0.rewards, v0)) {
            let v1 = 0x2::vec_map::get_mut<0x2::object::ID, PoolInfo>(&mut arg0.members, &arg1);
            if (0x2::vec_map::contains<0x1::type_name::TypeName, PoolData>(&v1.pool_data, &v0)) {
                let v2 = 0x2::vec_map::get_mut<0x1::type_name::TypeName, PoolData>(&mut v1.pool_data, &v0);
                ...
                return 0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.rewards, v0), v4)
            };
        };
        0x2::balance::zero<T0>()
    }
    ...
    public(friend) fun get_rewards_from_distributor<T0>(arg0: &mut Allocator, arg1: 0x2::balance::Balance<T0>) {
        ...
        let v1 = RewardsFromDistributorEvent{value: 0x2::balance::value<T0>(&arg1)};
        0x2::event::emit<RewardsFromDistributorEvent>(v1);
    }
    ...
    public(friend) fun set_weight<T0>(arg0: &mut Allocator, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::clock::Clock) {
        ...
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.total_weights, &v1)) {
    ...
    public(friend) fun top_up_pools<T0>(arg0: &mut Allocator, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg2 <= arg3, 0x8788dc52a1d5f9bdefd18058872822e23bab931942913a61f24194a2ad79d81a::error::unlock_time_exceeded_error());
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::bag::contains<0x1::type_name::TypeName>(&arg0.rewards, v0)) {
            return
        };
    ...
    fun update_members<T0>(arg0: &mut Allocator, arg1: u64, arg2: u64) {
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.total_weights, &v0)) {
            return
        };
        ...
        let v2 = 0;
        while (v2 < 0x2::vec_map::size<0x2::object::ID, PoolInfo>(&arg0.members)) {
            let (_, v4) = 0x2::vec_map::get_entry_by_idx_mut<0x2::object::ID, PoolInfo>(&mut arg0.members, v2);
            if (0x2::vec_map::contains<0x1::type_name::TypeName, PoolData>(&v4.pool_data, &v0)) {
                let v5 = 0x2::vec_map::get_mut<0x1::type_name::TypeName, PoolData>(&mut v4.pool_data, &v0);
                v5.last_update_time = arg2;
                v5.pending_rewards = v5.pending_rewards + (((v5.weight as u128) * (((arg2 - v5.last_update_time) * arg1) as u128) / (v1 as u128)) as u64);
            };
            v2 = v2 + 1;
        };
    }
