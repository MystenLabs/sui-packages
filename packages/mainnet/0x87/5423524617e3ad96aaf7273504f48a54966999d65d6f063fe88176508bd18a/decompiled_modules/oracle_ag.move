module 0x875423524617e3ad96aaf7273504f48a54966999d65d6f063fe88176508bd18a::oracle_ag {
    ...
    fun new(arg0: &mut 0x2::tx_context::TxContext) : (OracleAggregator, OracleAggregatorCap) {
        let v0 = OracleAggregator{
            ...
            max_age               : 0x875423524617e3ad96aaf7273504f48a54966999d65d6f063fe88176508bd18a::consts::GET_PYTH_MAX_AGE(),
        };
    ...
    public fun assert_oracle_aggregator_cap(arg0: &OracleAggregator, arg1: &OracleAggregatorCap) {
        assert!(0x2::object::id<OracleAggregator>(arg0) == arg1.oracle_aggregator, 9223372195768565759);
    }
    ...
    public fun calc_usd_value<T0>(arg0: &OracleAggregator, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        ...
        0x875423524617e3ad96aaf7273504f48a54966999d65d6f063fe88176508bd18a::math::scale_from_float(0x875423524617e3ad96aaf7273504f48a54966999d65d6f063fe88176508bd18a::math::mul(0x875423524617e3ad96aaf7273504f48a54966999d65d6f063fe88176508bd18a::math::scale_to_float(arg2, (get_coin_decimal<T0>(arg0) as u64)), 0x875423524617e3ad96aaf7273504f48a54966999d65d6f063fe88176508bd18a::math::scale_to_float(v0, v1)), 0x875423524617e3ad96aaf7273504f48a54966999d65d6f063fe88176508bd18a::consts::GET_USDC_DECIMALS())
    }
