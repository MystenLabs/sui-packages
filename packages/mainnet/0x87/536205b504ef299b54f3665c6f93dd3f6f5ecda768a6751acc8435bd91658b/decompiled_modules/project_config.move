module 0x87536205b504ef299b54f3665c6f93dd3f6f5ecda768a6751acc8435bd91658b::project_config {
    ...
    struct ProjectConfig has store, key {
        id: 0x2::object::UID,
        admin: 0x87536205b504ef299b54f3665c6f93dd3f6f5ecda768a6751acc8435bd91658b::admin::AdminConfig,
    ...
    public entry fun add_collection(arg0: &mut ProjectConfig, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        let (v0, v1) = deep(arg0);
        assert!(0x2::tx_context::sender(arg2) == 0x87536205b504ef299b54f3665c6f93dd3f6f5ecda768a6751acc8435bd91658b::admin::get_owner(v0), 1);
    ...
    public entry fun add_item_to_collection(arg0: &mut ProjectConfig, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = deep(arg0);
        assert!(0x2::tx_context::sender(arg3) == 0x87536205b504ef299b54f3665c6f93dd3f6f5ecda768a6751acc8435bd91658b::admin::get_owner(v0), 1);
    ...
    public fun deep(arg0: &mut ProjectConfig) : (&mut 0x87536205b504ef299b54f3665c6f93dd3f6f5ecda768a6751acc8435bd91658b::admin::AdminConfig, &mut WhitelistedCollections) {
        (&mut arg0.admin, &mut arg0.collections)
    }

    public fun deep_immutable(arg0: &ProjectConfig) : (&0x87536205b504ef299b54f3665c6f93dd3f6f5ecda768a6751acc8435bd91658b::admin::AdminConfig, &WhitelistedCollections) {
    ...
    public entry fun initialize(arg0: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x87536205b504ef299b54f3665c6f93dd3f6f5ecda768a6751acc8435bd91658b::admin::init_(arg0);
        let v1 = WhitelistedCollections{
            id          : 0x2::object::new(arg0),
            admin_id    : 0x2::object::id<0x87536205b504ef299b54f3665c6f93dd3f6f5ecda768a6751acc8435bd91658b::admin::AdminConfig>(&v0),
