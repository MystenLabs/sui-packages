module 0x87864ada8e93c4a9cb212fdcbb7035e54e2247e017d8cadeb47698104b26ddd4::hhh {
    struct HHH has drop {
        dummy_field: bool,
    }
    ...
    public entry fun transfer(arg0: 0x2::coin::Coin<HHH>, arg1: address) {
        0x2::transfer::public_transfer<0x2::coin::Coin<HHH>>(arg0, arg1);
    }

    fun init(arg0: HHH, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HHH>(arg0, 9, b"HHH", b"hhh", b"ss", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://nextjs.org/docs/architecture/fast-refresh#how-it-works")), arg1);
        let v2 = v0;
        let v3 = 0x2::tx_context::sender(arg1);
        0x2::coin::mint_and_transfer<HHH>(&mut v2, 11919199000000000, v3, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<HHH>>(v2, v3);
