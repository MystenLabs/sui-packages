module 0x876256e5ff0760b3fceb610f9d86b7681c3c918d58f3b8e47eff27e03658fe46::cnsnft3008 {
    struct CNSNFT3008 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3008, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3008>(arg0, arg1);
