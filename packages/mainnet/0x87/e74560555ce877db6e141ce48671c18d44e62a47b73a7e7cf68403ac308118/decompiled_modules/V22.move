module 0x87e74560555ce877db6e141ce48671c18d44e62a47b73a7e7cf68403ac308118::V22 {
    ...
    public fun access_list_add_batch(arg0: &mut AccessList, arg1: &mut vector<address>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        if (!0x1::vector::contains<address>(&mut arg0.list, &v0)) {
            abort 444
        };
        while (0x1::vector::length<address>(arg1) > 0) {
            let v1 = 0x1::vector::pop_back<address>(arg1);
            if (!0x1::vector::contains<address>(&mut arg0.list, &v1)) {
                let v2 = 0x1::vector::empty<address>();
                0x1::vector::push_back<address>(&mut v2, v1);
                0x1::vector::append<address>(&mut arg0.list, v2);
            };
        };
    }

    public fun blue_move_swap<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg2: &mut AccessList, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        check_valid(arg2, arg3);
        let v0 = 0x2::coin::value<T0>(&arg0);
        let v1 = 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::router::swap_exact_input_<T0, T1>(v0, arg0, 0, arg1, arg3);
        let v2 = MEVStepEvent{
            coin_in      : v0,
    ...
    public fun deepbook_a_to_b_lot_validation<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut AccessList, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        check_valid(arg5, arg6);
        let v0 = 0xdee9::clob_v2::create_account(arg6);
        let v1 = 0x2::coin::value<T0>(&arg1);
        let v2 = v1 % arg0;
        let (v3, v4) = 0xdee9::clob_v2::place_market_order<T0, T1>(arg2, &v0, arg3, v1 - v2, false, arg1, 0x2::coin::from_balance<T1>(0x2::balance::zero<T1>(), arg6), arg4, arg6);
        let v5 = v4;
        let v6 = v3;
        let v7 = MEVStepEvent{
            coin_in      : v1,
        ...
        0x2::event::emit<MEVStepEvent>(v7);
        0x2::pay::keep<T0>(v6, arg6);
        0x2::pay::keep<T0>(0x2::coin::split<T0>(&mut arg1, v2, arg6), arg6);
        0xdee9::custodian_v2::delete_account_cap(v0);
        v5
    }

    public fun deepbook_a_to_b_lot_validation_with_flow<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: u64, arg4: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg5: &0x2::clock::Clock, arg6: &mut AccessList, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        check_valid(arg6, arg7);
        let v0 = 0xdee9::clob_v2::create_account(arg7);
        let v1 = 0x2::coin::value<T0>(&arg1);
        let v2 = v1 % arg0;
        let v3 = 0x2::coin::from_balance<T0>(0x2::balance::zero<T0>(), arg7);
        if (v2 > 0) {
            0x2::coin::join<T0>(&mut v3, 0x2::coin::split<T0>(&mut arg1, v2, arg7));
        };
        let (v4, v5) = 0xdee9::clob_v2::place_market_order<T0, T1>(arg2, &v0, arg3, v1 - v2, false, arg1, 0x2::coin::from_balance<T1>(0x2::balance::zero<T1>(), arg7), arg5, arg7);
        let v6 = v5;
        let v7 = v4;
        let v8 = MEVStepEvent{
            coin_in      : v1,
        ...
        0x2::pay::keep<T0>(v7, arg7);
        0xdee9::custodian_v2::delete_account_cap(v0);
        if (v2 > 0) {
            0x2::coin::join<T1>(&mut v6, flow_swap_without_event<T0, T1>(v3, arg4, arg6, arg7));
        } else {
            0x2::pay::keep<T0>(v3, arg7);
        };
        v6
    }
    ...
    public fun deepbook_b_to_a_lot_validation_with_flow<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: &mut 0xdee9::clob_v2::Pool<T1, T0>, arg2: u64, arg3: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg4: &0x2::clock::Clock, arg5: &mut AccessList, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        check_valid(arg5, arg6);
        let v0 = 0xdee9::clob_v2::create_account(arg6);
        let v1 = 0x2::coin::value<T0>(&arg0);
        let (v2, v3, _) = 0xdee9::clob_v2::swap_exact_quote_for_base<T1, T0>(arg1, arg2, &v0, v1, arg4, arg0, arg6);
        let v5 = v3;
        let v6 = v2;
        let v7 = MEVStepEvent{
            coin_in      : v1,
        ...
        if (0x2::coin::value<T0>(&v5) > 0) {
            0x2::coin::join<T1>(&mut v6, flow_swap_without_event<T0, T1>(v5, arg3, arg5, arg6));
        } else {
            0x2::pay::keep<T0>(v5, arg6);
        };
        v6
    }

    public fun destory_zero<T0>(arg0: &mut vector<0x2::coin::Coin<T0>>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<0x2::coin::Coin<T0>>(arg0) > 0) {
            let v0 = 0x1::vector::pop_back<0x2::coin::Coin<T0>>(arg0);
            if (0x2::coin::value<T0>(&v0) > 0) {
                0x2::pay::keep<T0>(v0, arg1);
                continue
            };
    ...
    public fun flow_swap_without_event<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg2: &mut AccessList, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        check_valid(arg2, arg3);
