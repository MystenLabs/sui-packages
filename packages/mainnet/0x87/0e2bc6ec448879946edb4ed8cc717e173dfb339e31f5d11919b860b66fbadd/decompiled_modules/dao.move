module 0x870e2bc6ec448879946edb4ed8cc717e173dfb339e31f5d11919b860b66fbadd::dao {
    ...
    struct VipAddressRemovedEvent has copy, drop {
        dao_fund_id: 0x2::object::ID,
        vip_address: address,
        remove_at: u64,
    }
    ...
    public entry fun cancel_purchase<T0>(arg0: &mut DAOFund<T0>, arg1: &mut 0x870e2bc6ec448879946edb4ed8cc717e173dfb339e31f5d11919b860b66fbadd::dao_config::GlobalDaoFee, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (_, _, v11) = 0x870e2bc6ec448879946edb4ed8cc717e173dfb339e31f5d11919b860b66fbadd::dao_config::get_dao_fee_config(arg1);
    ...
    public entry fun finalize_dao<T0>(arg0: &AdminCap, arg1: &mut DAOFund<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1.dao_end_at > 0) {
            0x870e2bc6ec448879946edb4ed8cc717e173dfb339e31f5d11919b860b66fbadd::lock::lock_nft_to<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(v14, arg1.creator, 31536000000, arg6, arg7);
        } else {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x870e2bc6ec448879946edb4ed8cc717e173dfb339e31f5d11919b860b66fbadd::dao_config::new_global_dao_fee_and_shared(arg0);
        let v1 = DAOSeller{
    ...
    public entry fun remove_vip_address<T0>(arg0: &AdminCap, arg1: address, arg2: &mut DAOFund<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0.dao_type == 0x1::string::utf8(b"vip"), 1025);
        v0.max_committable_amount = 0;
        let v1 = VipAddressRemovedEvent{
            dao_fund_id : 0x2::object::id<DAOFund<T0>>(arg2),
            vip_address : arg1,
            remove_at   : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<VipAddressRemovedEvent>(v1);
    }
    ...
    public entry fun set_platform_fee(arg0: &OperatorCap, arg1: &mut 0x870e2bc6ec448879946edb4ed8cc717e173dfb339e31f5d11919b860b66fbadd::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: address, arg5: &0x2::tx_context::TxContext) {
        0x870e2bc6ec448879946edb4ed8cc717e173dfb339e31f5d11919b860b66fbadd::dao_config::set_platform_fee(arg1, arg2, arg3, arg4, arg5);
    }
    ...
    public entry fun set_to_whitelist_phase<T0>(arg0: &AdminCap, arg1: &mut DAOFund<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        validate_fundraise_time_end<T0>(arg1, arg2);
        assert!(arg0.dao_fund_id == 0x2::object::id<DAOFund<T0>>(arg1), 1013);
        assert!(arg1.phase == 0x1::string::utf8(b"vip"), 1002);
        arg1.phase = 0x1::string::utf8(b"whitelist");
        let v0 = PhaseChangedEvent{
            dao_fund_id : 0x2::object::uid_to_inner(&arg1.id),
            sender      : 0x2::tx_context::sender(arg3),
            phase       : 0x1::string::utf8(b"whitelist"),
    ...
    public fun unlock_nft<T0: store + key>(arg0: 0x870e2bc6ec448879946edb4ed8cc717e173dfb339e31f5d11919b860b66fbadd::lock::LockedNFT<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        0x870e2bc6ec448879946edb4ed8cc717e173dfb339e31f5d11919b860b66fbadd::lock::unlock_nft<T0>(arg0, arg1, arg2);
    }

    public fun unlock_nft_by_operator<T0: store + key>(arg0: &OperatorCap, arg1: 0x870e2bc6ec448879946edb4ed8cc717e173dfb339e31f5d11919b860b66fbadd::lock::LockedNFT<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0x870e2bc6ec448879946edb4ed8cc717e173dfb339e31f5d11919b860b66fbadd::lock::unlock_nft_by_operator<T0>(arg1, arg2);
    }
    ...
    fun validate_phase<T0>(arg0: &DAOFund<T0>, arg1: address) {
        let v0 = arg0.phase;
        if (v0 == 0x1::string::utf8(b"whitelist") || v0 == 0x1::string::utf8(b"vip")) {
            assert!(is_existed_user_dao<T0>(arg0, arg1), 1001);
            assert!(0x2::table::borrow<address, UserDAO>(&arg0.tracked_addresses, arg1).dao_type == v0, 1002);
        };
    }
