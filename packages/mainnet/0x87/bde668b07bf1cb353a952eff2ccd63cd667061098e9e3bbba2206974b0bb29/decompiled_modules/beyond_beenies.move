module 0x87bde668b07bf1cb353a952eff2ccd63cd667061098e9e3bbba2206974b0bb29::beyond_beenies {
    struct BEYOND_BEENIES has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BEYOND_BEENIES, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BEYOND_BEENIES>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Beyond Beenies"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"After playing, discovering, creating, learning and expanding for eons of time, the Beenies are now at risk of meeting their paradoxical end. That is, from the timelines we perceive on Earth. They have only several billions of years left, foreseeing ever increasing friction in an ever decreasing dimensional fold of spacetime. A highly limiting prospect for beings so curious and playful!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibfo2abix3k3pil6nb44dc46borl44odmeua6gjaq3bdng5x76iqu"));
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Nft>(&mut v5, &v4, 888, 0);
