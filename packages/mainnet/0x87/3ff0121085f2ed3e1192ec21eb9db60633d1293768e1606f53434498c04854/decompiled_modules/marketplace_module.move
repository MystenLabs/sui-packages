module 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::marketplace_module {
    ...
    public entry fun add_collection_fee<T0: store + key>(arg0: &mut Admin, arg1: &mut 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::FeeContainer, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::add_collection_fee(arg1, v0, v1, v2, arg4);
    ...
    public entry fun delete_collection_fee<T0: store + key>(arg0: &mut Admin, arg1: &mut 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::FeeContainer, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(isAdmin(arg0, 0x2::tx_context::sender(arg2)) == true, 4003);
        0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::delete_collection_fee(arg1, 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())), arg2);
    ...
    public entry fun update_collection_fee<T0: store + key>(arg0: &mut Admin, arg1: &mut 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::FeeContainer, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(isAdmin(arg0, 0x2::tx_context::sender(arg3)) == true, 4003);
        0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::update_collection_fee(arg1, 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())), arg2, arg3);
    ...
    public entry fun accept_auction<T0: store + key>(arg0: &mut Marketplace, arg1: &mut Container, arg2: &mut Admin, arg3: &mut 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::FeeContainer, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) {
        let AuctionItem {
            id              : v0,
            seller          : v1,
            current_offerer : v2,
        ...
        assert!(v11, 5003);
        let (v13, v14) = 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::get_creator_fee(arg3, 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())), v6, arg5);
        ...
        let v15 = 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::get_service_fee(arg3, v6);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Marketplace{
            ...
            collection_fee_container_id : 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::create_fee_container(25, arg0),
        };
        let v3 = Container{
            id              : 0x2::object::new(arg0),
            objects_in_list : 0,
    ...
    public entry fun make_accept_offer_with_listed_nft_in_different_container<T0: store + key>(arg0: &mut Marketplace, arg1: &mut Admin, arg2: &mut 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::FeeContainer, arg3: &mut Container, arg4: &mut Container, arg5: 0x2::object::ID, arg6: 0x2::object::ID, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v13 = 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::get_service_fee(arg2, v9);
        let (v14, v15) = 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::get_creator_fee(arg2, 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())), v9, arg8);
        let v16 = if (v15 > 0) {
    ...
    public entry fun make_accept_offer_with_listed_nft_in_same_container<T0: store + key>(arg0: &mut Marketplace, arg1: &mut Admin, arg2: &mut 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::FeeContainer, arg3: &mut Container, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let List {
            id           : v0,
            container_id : _,
            seller       : v2,
        ...
        let v13 = 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::get_service_fee(arg2, v9);
        let (v14, v15) = 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::get_creator_fee(arg2, 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())), v9, arg7);
        let v16 = if (v15 > 0) {
    ...
    public entry fun make_accept_offer_with_non_listed_nft<T0: store + key>(arg0: &mut Marketplace, arg1: &mut Admin, arg2: &mut 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::FeeContainer, arg3: &mut Container, arg4: 0x2::object::ID, arg5: &0x2::clock::Clock, arg6: T0, arg7: &mut 0x2::tx_context::TxContext) {
        let Offer {
            id           : v0,
            nft_id       : v1,
            container_id : _,
        ...
        let v8 = 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::get_service_fee(arg2, v4);
        let (v9, v10) = 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::get_creator_fee(arg2, 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())), v4, arg7);
        let v11 = if (v10 > 0) {
    ...
    public entry fun make_buy_nft<T0: store + key>(arg0: &mut Marketplace, arg1: &mut Admin, arg2: &mut Container, arg3: 0x2::object::ID, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::FeeContainer, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::get_service_fee(arg5, v4);
        let (v6, v7) = 0x873ff0121085f2ed3e1192ec21eb9db60633d1293768e1606f53434498c04854::collection_fee_module::get_creator_fee(arg5, 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())), v4, arg6);
        let v8 = if (v7 > 0) {
