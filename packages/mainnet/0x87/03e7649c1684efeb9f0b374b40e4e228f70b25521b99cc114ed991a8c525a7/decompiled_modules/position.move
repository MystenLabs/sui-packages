module 0x8703e7649c1684efeb9f0b374b40e4e228f70b25521b99cc114ed991a8c525a7::position {
    ...
    fun borrow_mut_position_info(arg0: &mut PositionManager, arg1: 0x2::object::ID) : &mut PositionInfo {
        assert!(0xe1262c3d7c8cf295a5ad90814cc06578186d43911a256ab7cf8e11d18e86815f::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 923070870234869348);
    ...
    public(friend) fun increase_liquidity(arg0: &mut PositionManager, arg1: &mut Position, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: vector<u128>, arg7: u128) : u128 {
        ...
        update_rewards_internal(v0, arg6);
        update_fullsail_distribution_internal(v0, arg7);
        assert!(0x273edb422b3404487a0e700224f541852e799957e4e289363a1675a8dcee158b::math_u128::add_check(v0.liquidity, arg2), 923876923470938023);
        v0.liquidity = v0.liquidity + arg2;
        arg1.liquidity = v0.liquidity;
        v0.liquidity
    }
    ...
    fun new_position_name(arg0: u64, arg1: u64) : 0x1::string::String {
        ...
        0x1::string::append(&mut v0, 0x8703e7649c1684efeb9f0b374b40e4e228f70b25521b99cc114ed991a8c525a7::utils::str(arg0));
        0x1::string::append_utf8(&mut v0, b"-");
        0x1::string::append(&mut v0, 0x8703e7649c1684efeb9f0b374b40e4e228f70b25521b99cc114ed991a8c525a7::utils::str(arg1));
        v0
    }
    ...
    public fun set_display(arg0: &0x8703e7649c1684efeb9f0b374b40e4e228f70b25521b99cc114ed991a8c525a7::config::GlobalConfig, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    fun update_fee_internal(arg0: &mut PositionInfo, arg1: u128, arg2: u128) {
        ...
        assert!(0x273edb422b3404487a0e700224f541852e799957e4e289363a1675a8dcee158b::math_u64::add_check(arg0.fee_owned_a, v0), 923065912304623497);
        assert!(0x273edb422b3404487a0e700224f541852e799957e4e289363a1675a8dcee158b::math_u64::add_check(arg0.fee_owned_b, v1), 923065912304623497);
    ...
    fun update_fullsail_distribution_internal(arg0: &mut PositionInfo, arg1: u128) {
        ...
        assert!(0x273edb422b3404487a0e700224f541852e799957e4e289363a1675a8dcee158b::math_u64::add_check(arg0.fullsail_distribution_owned, v0), 932069234723906182);
    ...
    fun update_points_internal(arg0: &mut PositionInfo, arg1: u128) {
        ...
        assert!(0x273edb422b3404487a0e700224f541852e799957e4e289363a1675a8dcee158b::math_u128::add_check(arg0.points_owned, v0), 923065912304623497);
    ...
    fun update_rewards_internal(arg0: &mut PositionInfo, arg1: vector<u128>) {
        ...
        while (v0 < 0x1::vector::length<u128>(&arg1)) {
            ...
            if (0x1::vector::length<PositionReward>(&arg0.rewards) > v0) {
                ...
                assert!(0x273edb422b3404487a0e700224f541852e799957e4e289363a1675a8dcee158b::math_u64::add_check(v2.amount_owned, v3), 923065912304623497);
                v2.growth_inside = v1;
    ...
    public fun validate_position_exists(arg0: &PositionManager, arg1: 0x2::object::ID) {
        assert!(0xe1262c3d7c8cf295a5ad90814cc06578186d43911a256ab7cf8e11d18e86815f::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 923070870234869348);
        assert!(0xe1262c3d7c8cf295a5ad90814cc06578186d43911a256ab7cf8e11d18e86815f::linked_table::borrow<0x2::object::ID, PositionInfo>(&arg0.positions, arg1).position_id == arg1, 923070870234869348);
    }
