module 0x87a6125598dd5c5c09a39e4b0a8d5e53e43c906c7b49fb14a69cdf036d7a6743::cnsnft2146 {
    struct CNSNFT2146 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2146, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7359"));
        let v4 = 0x2::package::claim<CNSNFT2146>(arg0, arg1);
