module 0x87cf93e02c853f5834efd8645fee9d4e349ba9d2597d28bc2fac29f6109dd610::collection {
    ...
    public entry fun changeCollectionDescription(arg0: 0x1::string::String, arg1: &mut Collection, arg2: &mut 0x2::tx_context::TxContext) {
        0x87cf93e02c853f5834efd8645fee9d4e349ba9d2597d28bc2fac29f6109dd610::admin::is_admin(arg1.admin, 0x2::tx_context::sender(arg2));
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Collection{
            ...
            name                   : 0x1::string::utf8(b"Suipepes"),
