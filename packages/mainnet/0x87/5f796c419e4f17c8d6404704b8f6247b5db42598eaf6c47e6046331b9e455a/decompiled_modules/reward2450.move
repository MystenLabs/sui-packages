module 0x875f796c419e4f17c8d6404704b8f6247b5db42598eaf6c47e6046331b9e455a::reward2450 {
    struct REWARD2450 has drop {
        dummy_field: bool,
    }

    struct TICKET_2450 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2450(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2450>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2450>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2450, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2450>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2450>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2450>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2450>>(v5, 0x2::tx_context::sender(arg1));
    }
