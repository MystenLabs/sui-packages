module 0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::manager {
    ...
    public fun buy_tokens<T0, T1>(arg0: &Manager<T1>, arg1: &mut 0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::BondingCurvePool<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::object::id<0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::BondingCurvePool<T0, T1>>(arg1) == *0x2::table::borrow<0x1::string::String, 0x2::object::ID>(&arg0.pools, v0), 2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::buy_tokens<T0, T1>(arg1, arg2, arg3, arg4), 0x2::tx_context::sender(arg4));
    }

    public fun claim_pool_fees<T0, T1>(arg0: &AdminCap, arg1: &mut 0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::BondingCurvePool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::claim_pool_fees<T0, T1>(arg1, arg2), 0x2::tx_context::sender(arg2));
    }
    ...
    public fun create_bonding_curve<T0, T1>(arg0: &mut Manager<T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v1 = 0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::create_bonding_curve<T0, T1>(arg1, arg0.fee_percentage, arg3, arg4);
    ...
    public fun current_price<T0, T1>(arg0: &0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::BondingCurvePool<T0, T1>) : u128 {
        0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::current_price<T0, T1>(arg0)
    }

    public fun migrate_pool<T0, T1>(arg0: &AdminCap, arg1: &mut Manager<T1>, arg2: &mut 0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::BondingCurvePool<T0, T1>, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::coin::CoinMetadata<T1>, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::migrate_pool<T0, T1>(arg2, arg8);
        let v2 = v1;
        let v3 = v0;
    ...
    public fun sell_tokens<T0, T1>(arg0: &Manager<T1>, arg1: &mut 0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::BondingCurvePool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        assert!(0x2::table::contains<0x1::string::String, 0x2::object::ID>(&arg0.pools, v0), 2);
        assert!(0x2::object::id<0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::BondingCurvePool<T0, T1>>(arg1) == *0x2::table::borrow<0x1::string::String, 0x2::object::ID>(&arg0.pools, v0), 2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x87c75d1a2631a0c429ce7946fe379bb0d82ef0967e901325bea7f367774ee81e::bonding_curve::sell_tokens<T0, T1>(arg1, arg2, arg3, arg4), 0x2::tx_context::sender(arg4));
    }
