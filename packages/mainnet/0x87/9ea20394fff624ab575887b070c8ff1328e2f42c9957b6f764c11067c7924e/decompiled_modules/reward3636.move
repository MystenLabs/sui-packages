module 0x879ea20394fff624ab575887b070c8ff1328e2f42c9957b6f764c11067c7924e::reward3636 {
    struct REWARD3636 has drop {
        dummy_field: bool,
    }

    struct TICKET_3636 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3636(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3636>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3636>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3636, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3636>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3636>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3636>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3636>>(v5, 0x2::tx_context::sender(arg1));
    }
