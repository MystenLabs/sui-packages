module 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::game {
    ...
    struct FastReviewCap has store, key {
        id: 0x2::object::UID,
        book_id: 0x2::object::ID,
    }

    struct ClaimOperatorCap has store, key {
        id: 0x2::object::UID,
        book_id: 0x2::object::ID,
    }

    struct ClaimPolicyKey has copy, drop, store {
        dummy_field: bool,
    }

    struct WalletQuarantineKey has copy, drop, store {
        wallet: address,
    }

    struct WalletQuarantineRecord has copy, drop, store {
        quarantined: bool,
        revision: u64,
        reason_hash: address,
        changed_ms: u64,
    ...
    struct ClaimPolicyRecord has copy, drop, store {
        version: u64,
        treasury_id: 0x2::object::ID,
        legacy_treasury_id: 0x2::object::ID,
        admin_cap_id: 0x2::object::ID,
        review_cap_id: 0x2::object::ID,
        ...
        last_settled_day: u64,
        source_evidence_hash: address,
        review_digest: address,
        reviewed_authority_epoch: u64,
        reviewed_budget_version: u64,
        reviewed_exclusion_version: u64,
    }

    struct ReviewedMiningDayKey has copy, drop, store {
        day: u64,
    }

    struct ReviewedMiningDayRecord has copy, drop, store {
        root_kind: u8,
        activity_root: address,
        mining_root: address,
        total_mint_raw: u64,
        activity_cutoff_checkpoint: u64,
        mining_cutoff_checkpoint: u64,
        activity_cutoff_digest: address,
        mining_cutoff_digest: address,
        source_evidence_hash: address,
        review_digest: address,
        accepted_ms: u64,
        authority_epoch: u64,
    ...
    struct FastDailySettlementAccepted has copy, drop {
        day: u64,
        previous_settled_day: u64,
        activity_root: address,
        mining_root: address,
        total_mint_raw: u64,
        activity_cutoff_checkpoint: u64,
    ...
    struct ClaimPolicyChanged has copy, drop {
        book_id: 0x2::object::ID,
        paused: bool,
        review_status: u8,
        review_day: u64,
    ...
    struct WalletQuarantineChanged has copy, drop {
        book_id: 0x2::object::ID,
        wallet: address,
        quarantined: bool,
        revision: u64,
    ...
    fun accept_daily_settlement_internal(arg0: &FastReviewCap, arg1: &mut SettlementBook, arg2: u64, arg3: address, arg4: address, arg5: u64, arg6: u8, arg7: u32, arg8: u64, arg9: u64, arg10: u64, arg11: address, arg12: address, arg13: u64, arg14: u64, arg15: address, arg16: address, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: &0x2::clock::Clock, arg23: bool) {
        assert_review_cap(arg0, arg1);
        let v0 = 0x2::clock::timestamp_ms(arg22);
        let v1 = v0 / 86400000;
        let v2 = settlement_authority_epoch(arg1);
        let v3 = protocol_daily_mint_budget_version(arg1);
        let v4 = *policy_record(arg1);
        let v5 = if (arg2 < v1) {
            if (arg21 == v4.last_settled_day) {
                arg2 == arg21 + 1
            } else {
                false
            }
        ...
        assert!(v5, 41006);
        if (!arg23) {
            assert!(arg2 + 1 == v1 && v0 <= v1 * 86400000 + 300000, 41007);
        };
        let v6 = if (v4.generation == arg20) {
            if (v4.quarantine_revision == arg19) {
                if (v2 == arg17) {
                    v3 == arg18
                } else {
                    false
        ...
        assert!(v7, 41005);
        let v8 = ReviewedMiningDayKey{day: arg2};
        assert!(!0x2::dynamic_field::exists<ReviewedMiningDayKey>(&arg1.id, v8), 41008);
        validate_activity_snapshot_proposal(arg1, arg2, arg3, arg6, arg8, arg13, arg14, v1);
        assert!(mining_total_within_player_cap(arg5, arg1.player_count), 20);
        assert!(protocol_daily_mint_within_budget(arg5, max_protocol_daily_mint_raw(arg1)), 29);
        if (arg5 == 0) {
            assert!(arg4 == mining_v2_empty_root(), 45);
        } else {
            assert!(arg4 != @0x0 && arg4 != mining_v2_empty_root(), 45);
        };
        let v9 = MiningRootKey{day: arg2};
        assert!(!0x2::dynamic_field::exists<MiningRootKey>(&arg1.id, v9), 49);
        let v10 = ActivitySnapshotKey{use_day: arg2};
        let v11 = if (0x2::dynamic_field::exists<ActivitySnapshotKey>(&arg1.id, v10)) {
            let v12 = 0x2::dynamic_field::borrow_mut<ActivitySnapshotKey, ActivitySnapshotRecord>(&mut arg1.id, v10);
            if (v12.status == 2) {
                let v13 = if (v12.root == arg3) {
                    if (v12.policy_version == arg6) {
                        if (v12.month_id == arg7) {
                            if (v12.month_start_day == arg8) {
                                if (v12.cutoff_checkpoint == arg9) {
                                    if (v12.exclusion_version == arg13) {
                                        v12.eligible_count == arg14
                                    } else {
                                        false
                                    }
                                } else {
                ...
                let v14 = v12.revision + 1;
                let v15 = ActivitySnapshotRecord{
                    root              : arg3,
                    policy_version    : arg6,
                    month_id          : arg7,
                    month_start_day   : arg8,
                    cutoff_checkpoint : arg9,
                    exclusion_version : arg13,
                    eligible_count    : arg14,
                    status            : 2,
                    proposed_ms       : v0,
                    activates_ms      : v0,
                    revision          : v14,
            ...
            let v16 = ActivitySnapshotRecord{
                root              : arg3,
                policy_version    : arg6,
                month_id          : arg7,
                month_start_day   : arg8,
            ...
            0x2::dynamic_field::add<ActivitySnapshotKey, ActivitySnapshotRecord>(&mut arg1.id, v10, v16);
            1
        };
        let v17 = MiningV2RootKey{day: arg2};
        if (0x2::dynamic_field::exists<MiningV2RootKey>(&arg1.id, v17)) {
            let v18 = 0x2::dynamic_field::borrow_mut<MiningV2RootKey, MiningV2RootRecord>(&mut arg1.id, v17);
            if (v18.status == 2) {
                let v19 = if (v18.root == arg4) {
                    if (v18.total_mint_raw == arg5) {
                        if (v18.activity_root == arg3) {
                            if (v18.policy_version == arg6) {
                                if (v18.month_id == arg7) {
                                    if (v18.month_start_day == arg8) {
                                        v18.activity_revision == v11
                                    } else {
                                        false
                                    }
                                } else {
                ...
                assert!(v18.claimed_mint_raw == 0, 41005);
                let v20 = MiningV2RootRecord{
                    root              : arg4,
                    total_mint_raw    : arg5,
                    claimed_mint_raw  : 0,
                    activity_root     : arg3,
                    ...
                    month_id          : arg7,
                    month_start_day   : arg8,
                    activity_revision : v11,
                    status            : 2,
                    proposed_ms       : v0,
                    activates_ms      : v0,
                    revision          : v18.revision + 1,
                    authority_epoch   : v2,
                    budget_version    : v3,
                };
                *v18 = v20;
            ...
            0x2::dynamic_field::add<MiningV2RootKey, MiningV2RootRecord>(&mut arg1.id, v17, v21);
        };
        let v22 = ReviewedMiningDayKey{day: arg2};
        let v23 = ReviewedMiningDayRecord{
            root_kind                  : 2,
            activity_root              : arg3,
            mining_root                : arg4,
            total_mint_raw             : arg5,
            activity_cutoff_checkpoint : arg9,
            mining_cutoff_checkpoint   : arg10,
            activity_cutoff_digest     : arg11,
            mining_cutoff_digest       : arg12,
            source_evidence_hash       : arg15,
            review_digest              : arg16,
            accepted_ms                : v0,
            authority_epoch            : v2,
            budget_version             : v3,
            quarantine_revision        : arg19,
        };
        0x2::dynamic_field::add<ReviewedMiningDayKey, ReviewedMiningDayRecord>(&mut arg1.id, v22, v23);
        let v24 = ClaimPolicyKey{dummy_field: false};
        let v25 = 0x2::dynamic_field::borrow_mut<ClaimPolicyKey, ClaimPolicyRecord>(&mut arg1.id, v24);
        v25.last_settled_day = arg2;
        v25.review_day = v1;
        v25.review_status = 1;
        v25.reviewed_generation = v25.generation;
        v25.source_evidence_hash = arg15;
        v25.review_digest = arg16;
        v25.reviewed_authority_epoch = v2;
        v25.reviewed_budget_version = v3;
        v25.reviewed_exclusion_version = protocol_reward_exclusion_version(arg1);
        if (arg23) {
            v25.paused = true;
        };
        let v26 = FastDailySettlementAccepted{
            day                        : arg2,
            previous_settled_day       : arg21,
            activity_root              : arg3,
            mining_root                : arg4,
            total_mint_raw             : arg5,
            activity_cutoff_checkpoint : arg9,
            ...
            policy_version             : arg6,
            quarantine_revision        : arg19,
            review_generation          : arg20,
            accepted_ms                : v0,
            recovery                   : arg23,
        };
        0x2::event::emit<FastDailySettlementAccepted>(v26);
    }

    public fun accept_fast_daily_settlement(arg0: &FastReviewCap, arg1: &mut SettlementBook, arg2: u64, arg3: address, arg4: address, arg5: u64, arg6: u8, arg7: u32, arg8: u64, arg9: u64, arg10: u64, arg11: address, arg12: address, arg13: u64, arg14: u64, arg15: address, arg16: address, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: &0x2::clock::Clock) {
        accept_daily_settlement_internal(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21, arg22, false);
    }

    public fun accept_reviewed_recovery_settlement(arg0: &FastReviewCap, arg1: &mut SettlementBook, arg2: u64, arg3: address, arg4: address, arg5: u64, arg6: u8, arg7: u32, arg8: u64, arg9: u64, arg10: u64, arg11: address, arg12: address, arg13: u64, arg14: u64, arg15: address, arg16: address, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: &0x2::clock::Clock) {
        accept_daily_settlement_internal(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21, arg22, true);
    }
    ...
    public fun activate_fever_v3(arg0: &0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolAdminCap, arg1: &mut Economy, arg2: &mut 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasuryV3, arg3: &0x2::clock::Clock) {
        assert_fever_not_activated(arg1);
        assert_clean_fever_supply_values(0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::post_genesis_minted_raw_v3(arg2), 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::post_genesis_burned_raw_v3(arg2), 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::total_supply_v3(arg2));
        apply_clean_fever_activation(arg1, arg3);
        assert!(arg1.fever_state.current_day == 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::activate_supply_rollover_cursor_v3(arg2, arg3), 20505);
    }
    ...
    public fun advance_fever_one_day_v3(arg0: &mut Economy, arg1: &mut 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasuryV3, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert_fever_activated(arg0);
        let v0 = arg0.fever_state.current_day;
        assert_rollover_day_ready_values(v0, 0x2::clock::timestamp_ms(arg2) / 86400000);
        assert!(0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::supply_rollover_activated_v3(arg1), 20505);
        assert!(0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::supply_rollover_current_day_v3(arg1) == v0, 20505);
        let v1 = FeeDayKey{day: v0};
        let v2 = 0x2::dynamic_field::exists<FeeDayKey>(&arg0.id, v1);
        let (v3, v4) = if (v2) {
            let v5 = 0x2::dynamic_field::borrow_mut<FeeDayKey, FeeDayPool>(&mut arg0.id, v1);
        ...
        let (v8, v9, v10, v11) = 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::finalize_current_supply_rollover_day_v3(arg1, v3, arg2, arg3);
        assert!(v8 == v0, 20505);
        assert!(v11 == v4, 11);
        if (v2) {
            let v12 = 0x2::dynamic_field::borrow_mut<FeeDayKey, FeeDayPool>(&mut arg0.id, v1);
        ...
        arg0.fever_state.last_closed_day = v0;
        arg0.fever_state.current_day = v0 + 1;
        assert!(0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::supply_rollover_current_day_v3(arg1) == arg0.fever_state.current_day, 20505);
        let v22 = if (v21 >= v20) {
            v21 - v20
        } else {
            v20 - v21
    ...
    public fun advance_fever_one_day_v3_checked(arg0: &mut Economy, arg1: &mut 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasuryV3, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.fever_state.current_day == arg2 && 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::supply_rollover_current_day_v3(arg1) == arg2, 20505);
        advance_fever_one_day_v3(arg0, arg1, arg3, arg4);
    }

    public fun advance_treasury_claim_migration(arg0: &mut 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::TreasuryMigrationScan, arg1: &0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasury, arg2: &0x2::clock::Clock, arg3: u64) {
        0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::advance_treasury_migration_scan(arg0, arg1, arg2, arg3);
    }
    ...
    public fun approve_legacy_reviewed_mining_day(arg0: &FastReviewCap, arg1: &mut SettlementBook, arg2: u64, arg3: u8, arg4: address, arg5: u64, arg6: u64, arg7: u64, arg8: address, arg9: address, arg10: address, arg11: address, arg12: &0x2::clock::Clock) {
        assert_review_cap(arg0, arg1);
        let v0 = *policy_record(arg1);
        let v1 = if (arg2 <= v0.last_settled_day) {
            if (arg2 < 0x2::clock::timestamp_ms(arg12) / 86400000) {
                let v2 = ReviewedMiningDayKey{day: arg2};
                !0x2::dynamic_field::exists<ReviewedMiningDayKey>(&arg1.id, v2)
            } else {
                false
            }
        } else {
        ...
        assert!(v3, 41005);
        let v4 = if (arg3 == 1) {
            let v5 = MiningRootKey{day: arg2};
            let v6 = 0x2::dynamic_field::borrow<MiningRootKey, MiningRootRecord>(&arg1.id, v5);
            assert!(v6.root == arg4 && v6.total_mint_raw == arg5, 41005);
            @0x0
        } else {
            let v7 = MiningV2RootKey{day: arg2};
            let v8 = 0x2::dynamic_field::borrow<MiningV2RootKey, MiningV2RootRecord>(&arg1.id, v7);
            let v9 = if (v8.status == 2) {
                if (v8.root == arg4) {
                    v8.total_mint_raw == arg5
                } else {
                    false
                }
            } else {
            ...
            let v12 = if (v11.status == 2) {
                if (v11.root == v8.activity_root) {
                    if (v11.revision == v8.activity_revision) {
                        if (v11.policy_version == v8.policy_version) {
                            if (v11.month_id == v8.month_id) {
                                if (v11.month_start_day == v8.month_start_day) {
                                    v11.cutoff_checkpoint == arg6
                                } else {
                                    false
                                }
                            } else {
        ...
        let v13 = ReviewedMiningDayKey{day: arg2};
        let v14 = ReviewedMiningDayRecord{
            root_kind                  : arg3,
            activity_root              : v4,
            mining_root                : arg4,
            total_mint_raw             : arg5,
            activity_cutoff_checkpoint : arg6,
            mining_cutoff_checkpoint   : arg7,
            activity_cutoff_digest     : arg8,
            mining_cutoff_digest       : arg9,
            source_evidence_hash       : arg10,
            review_digest              : arg11,
            accepted_ms                : 0x2::clock::timestamp_ms(arg12),
            authority_epoch            : settlement_authority_epoch(arg1),
            budget_version             : protocol_daily_mint_budget_version(arg1),
            quarantine_revision        : v0.quarantine_revision,
        };
        0x2::dynamic_field::add<ReviewedMiningDayKey, ReviewedMiningDayRecord>(&mut arg1.id, v13, v14);
    }
    ...
    fun assert_claim_policy_v3(arg0: &SettlementBook, arg1: &0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasuryV3, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: u8) {
        assert_current_claim_review_versions(arg0);
        let v0 = policy_record(arg0);
        let v1 = 0x2::clock::timestamp_ms(arg4) / 86400000;
        assert!(0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::treasury_v3_book_id(arg1) == 0x2::object::id<SettlementBook>(arg0) && v0.treasury_id == 0x2::object::id<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasuryV3>(arg1), 41000);
        assert!(claim_window_open(arg4), 41001);
        let v2 = if (!v0.paused) {
            if (v0.review_status == 1) {
                if (v0.review_day == v1) {
                    if (v0.reviewed_generation == v0.generation) {
                        v0.last_settled_day + 1 == v1
                    } else {
                        false
                    }
                } else {
        ...
        assert!(v2, 41002);
        assert!(!wallet_quarantined(arg0, arg3), 41003);
        assert!(arg2 < v1, 18);
        let v3 = ReviewedMiningDayKey{day: arg2};
        assert!(0x2::dynamic_field::exists<ReviewedMiningDayKey>(&arg0.id, v3), 41005);
        let v4 = ReviewedMiningDayKey{day: arg2};
        let v5 = 0x2::dynamic_field::borrow<ReviewedMiningDayKey, ReviewedMiningDayRecord>(&arg0.id, v4);
        assert!(v5.root_kind == arg5, 41005);
        if (arg5 == 1) {
            let v6 = MiningRootKey{day: arg2};
            let v7 = 0x2::dynamic_field::borrow<MiningRootKey, MiningRootRecord>(&arg0.id, v6);
            assert!(v7.root == v5.mining_root && v7.total_mint_raw == v5.total_mint_raw, 41005);
        } else {
            let v8 = MiningV2RootKey{day: arg2};
            let v9 = 0x2::dynamic_field::borrow<MiningV2RootKey, MiningV2RootRecord>(&arg0.id, v8);
            let v10 = if (v9.root == v5.mining_root) {
                if (v9.total_mint_raw == v5.total_mint_raw) {
                    v9.activity_root == v5.activity_root
                } else {
                    false
                }
            } else {
    ...
    fun assert_current_claim_review_versions(arg0: &SettlementBook) {
        let v0 = policy_record(arg0);
        let v1 = if (v0.reviewed_authority_epoch == settlement_authority_epoch(arg0)) {
            if (v0.reviewed_budget_version == protocol_daily_mint_budget_version(arg0)) {
                v0.reviewed_exclusion_version == protocol_reward_exclusion_version(arg0)
            } else {
                false
            }
        } else {
    ...
    fun assert_operator_cap(arg0: &ClaimOperatorCap, arg1: &SettlementBook) {
        let v0 = policy_record(arg1);
        assert!(arg0.book_id == 0x2::object::id<SettlementBook>(arg1) && 0x2::object::id<ClaimOperatorCap>(arg0) == v0.operator_cap_id, 41004);
    }
    ...
    fun assert_review_cap(arg0: &FastReviewCap, arg1: &SettlementBook) {
        let v0 = policy_record(arg1);
        assert!(arg0.book_id == 0x2::object::id<SettlementBook>(arg1) && 0x2::object::id<FastReviewCap>(arg0) == v0.review_cap_id, 41004);
    }
    ...
    fun burn_balance_current_day_v3(arg0: &mut 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasuryV3, arg1: 0x2::balance::Balance<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x2::balance::value<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS>(&arg1);
        if (v0 == 0) {
            0x2::balance::destroy_zero<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS>(arg1);
            0
        } else {
            let v2 = 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::burn_protocol_coin_current_day_v3(arg0, 0x2::coin::from_balance<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS>(arg1, arg3), arg2);
            assert!(v2 == v0, 11);
            v2
        }
    }
    ...
    public fun claim_mining_legacy_v3(arg0: &Economy, arg1: &mut SettlementBook, arg2: &mut 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasuryV3, arg3: &PlayerState, arg4: u64, arg5: u64, arg6: vector<address>, arg7: vector<bool>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS> {
        assert_claim_policy_v3(arg1, arg2, arg4, 0x2::tx_context::sender(arg9), arg8, 1);
        assert_fever_current_day(arg0, arg8);
        assert!(arg5 > 0, 10);
        assert_owner(arg3, arg9);
        assert!(arg5 <= max_daily_mint_raw_per_player(), 20);
        ...
        0x2::event::emit<MiningClaimed>(v4);
        0x2::coin::from_balance<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS>(0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::mint_protocol_balance_current_day_v3(arg2, arg5, arg8), arg9)
    }
    ...
    public fun claim_mining_v3(arg0: &Economy, arg1: &mut SettlementBook, arg2: &mut 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasuryV3, arg3: &PlayerState, arg4: u64, arg5: u64, arg6: u64, arg7: u8, arg8: vector<address>, arg9: vector<bool>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS> {
        assert_claim_policy_v3(arg1, arg2, arg4, 0x2::tx_context::sender(arg11), arg10, 2);
        assert_fever_current_day(arg0, arg10);
        assert!(arg5 > 0, 10);
        assert_owner(arg3, arg11);
        assert!(arg5 <= max_daily_mint_raw_per_player(), 20);
        ...
        0x2::event::emit<MiningV2Claimed>(v14);
        0x2::coin::from_balance<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS>(0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::mint_protocol_balance_current_day_v3(arg2, arg5, arg10), arg11)
    }

    public fun claim_window_open(arg0: &0x2::clock::Clock) : bool {
        let v0 = 0x2::clock::timestamp_ms(arg0) % 86400000;
        v0 >= 300000 && v0 < 86100000
    }
    ...
    public fun discard_treasury_claim_migration(arg0: &0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolAdminCap, arg1: 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::TreasuryMigrationScan) {
        0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::discard_treasury_migration_scan(arg0, arg1);
    }
    ...
    public fun initialize_fast_claim_policy(arg0: &0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolAdminCap, arg1: &mut SettlementBook, arg2: &0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasuryV3, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (FastReviewCap, ClaimOperatorCap) {
        let v0 = ClaimPolicyKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists<ClaimPolicyKey>(&arg1.id, v0), 41000);
        assert!(0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::treasury_v3_book_id(arg2) == 0x2::object::id<SettlementBook>(arg1), 41000);
        let v1 = 0x2::clock::timestamp_ms(arg4) / 86400000;
        assert!(arg3 < v1, 41006);
        let v2 = FastReviewCap{
            id      : 0x2::object::new(arg5),
            book_id : 0x2::object::id<SettlementBook>(arg1),
        };
        let v3 = ClaimOperatorCap{
            id      : 0x2::object::new(arg5),
            book_id : 0x2::object::id<SettlementBook>(arg1),
        };
        let v4 = ClaimPolicyKey{dummy_field: false};
        let v5 = ClaimPolicyRecord{
            version                    : 3,
            treasury_id                : 0x2::object::id<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasuryV3>(arg2),
            legacy_treasury_id         : 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::treasury_v3_legacy_id(arg2),
            admin_cap_id               : 0x2::object::id<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolAdminCap>(arg0),
            review_cap_id              : 0x2::object::id<FastReviewCap>(&v2),
            operator_cap_id            : 0x2::object::id<ClaimOperatorCap>(&v3),
            ...
            last_settled_day           : arg3,
            source_evidence_hash       : @0x0,
            review_digest              : @0x0,
            reviewed_authority_epoch   : 0,
            reviewed_budget_version    : 0,
            reviewed_exclusion_version : 0,
        };
        0x2::dynamic_field::add<ClaimPolicyKey, ClaimPolicyRecord>(&mut arg1.id, v4, v5);
        (v2, v3)
    }

    fun invalidate_claim_review(arg0: &mut SettlementBook, arg1: address, arg2: &0x2::clock::Clock) {
        let v0 = ClaimPolicyKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<ClaimPolicyKey, ClaimPolicyRecord>(&mut arg0.id, v0);
        v1.paused = true;
        v1.review_status = 2;
        v1.generation = v1.generation + 1;
        let v2 = ClaimPolicyChanged{
            book_id             : 0x2::object::id<SettlementBook>(arg0),
            paused              : true,
            review_status       : 2,
            review_day          : v1.review_day,
            generation          : v1.generation,
            quarantine_revision : v1.quarantine_revision,
            reason_hash         : arg1,
            changed_ms          : 0x2::clock::timestamp_ms(arg2),
        };
        0x2::event::emit<ClaimPolicyChanged>(v2);
    }
    ...
    public fun mark_auto_review_failed(arg0: &FastReviewCap, arg1: &mut SettlementBook, arg2: address, arg3: &0x2::clock::Clock) {
        assert_review_cap(arg0, arg1);
        invalidate_claim_review(arg1, arg2, arg3);
    }
    ...
    public fun migrate_treasury_and_initialize_claim_policy(arg0: &0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolAdminCap, arg1: &Economy, arg2: &mut SettlementBook, arg3: 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasury, arg4: 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::TreasuryMigrationScan, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (FastReviewCap, ClaimOperatorCap) {
        let v0 = 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::migrate_protocol_treasury_v3(arg0, arg3, arg4, 0x2::object::id<SettlementBook>(arg2), arg6, arg7);
        assert!(arg1.fever_state.activated && 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::supply_rollover_current_day_v3(&v0) == arg1.fever_state.current_day, 20505);
        let (v1, v2) = initialize_fast_claim_policy(arg0, arg2, &v0, arg5, arg6, arg7);
        0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::share_protocol_treasury_v3(v0);
        (v1, v2)
    }
    ...
    public fun pause_claims(arg0: &ClaimOperatorCap, arg1: &mut SettlementBook, arg2: address, arg3: &0x2::clock::Clock) {
        assert_operator_cap(arg0, arg1);
        invalidate_claim_review(arg1, arg2, arg3);
    }
    ...
    fun policy_record(arg0: &SettlementBook) : &ClaimPolicyRecord {
        let v0 = ClaimPolicyKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists<ClaimPolicyKey>(&arg0.id, v0), 41000);
        let v1 = ClaimPolicyKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow<ClaimPolicyKey, ClaimPolicyRecord>(&arg0.id, v1);
        assert!(v2.version == 3 && v2.migration_complete, 41000);
        v2
    }

    public fun prepare_treasury_claim_migration(arg0: &0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolAdminCap, arg1: &Economy, arg2: &SettlementBook, arg3: &0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasury, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.fever_state.activated && 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::supply_rollover_current_day(arg3) == arg1.fever_state.current_day, 20505);
        let v0 = ClaimPolicyKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists<ClaimPolicyKey>(&arg2.id, v0), 41000);
        0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::share_treasury_migration_scan(0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::begin_treasury_migration_scan(arg0, arg3, 0x2::object::id<SettlementBook>(arg2), arg4, arg5));
    }
    ...
    public fun record_claim_resume_review(arg0: &FastReviewCap, arg1: &mut SettlementBook, arg2: address, arg3: address, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock) {
        assert_review_cap(arg0, arg1);
        assert!(arg2 != @0x0 && arg3 != @0x0, 41005);
        let v0 = 0x2::clock::timestamp_ms(arg6) / 86400000;
        let v1 = ReviewedMiningDayKey{day: policy_record(arg1).last_settled_day};
        assert!(0x2::dynamic_field::exists<ReviewedMiningDayKey>(&arg1.id, v1), 41005);
        let v2 = ClaimPolicyKey{dummy_field: false};
        let v3 = 0x2::dynamic_field::borrow_mut<ClaimPolicyKey, ClaimPolicyRecord>(&mut arg1.id, v2);
        let v4 = if (v3.generation == arg4) {
            if (v3.quarantine_revision == arg5) {
                v3.last_settled_day + 1 == v0
            } else {
                false
            }
        } else {
        ...
        v3.review_status = 1;
        v3.review_day = v0;
        v3.reviewed_generation = v3.generation;
        v3.source_evidence_hash = arg2;
        v3.review_digest = arg3;
        v3.reviewed_authority_epoch = settlement_authority_epoch(arg1);
        v3.reviewed_budget_version = protocol_daily_mint_budget_version(arg1);
        v3.reviewed_exclusion_version = protocol_reward_exclusion_version(arg1);
        let v5 = ClaimPolicyChanged{
            book_id             : 0x2::object::id<SettlementBook>(arg1),
            paused              : v3.paused,
            review_status       : 1,
            review_day          : v0,
            generation          : v3.generation,
            quarantine_revision : v3.quarantine_revision,
            reason_hash         : arg3,
            changed_ms          : 0x2::clock::timestamp_ms(arg6),
        };
        0x2::event::emit<ClaimPolicyChanged>(v5);
    }
    ...
    fun reserve_or_burn_rank_pool_v3(arg0: &mut 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasuryV3, arg1: 0x2::balance::Balance<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS>, u64, u64) {
        if (arg2 == 0) {
            (0x2::balance::zero<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS>(), 0, burn_balance_current_day_v3(arg0, arg1, arg3, arg4))
        } else {
            (arg1, 0x2::balance::value<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS>(&arg1), 0)
        }
    }
    ...
    public fun resume_claims_after_review(arg0: &ClaimOperatorCap, arg1: &mut SettlementBook, arg2: address, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock) {
        assert_operator_cap(arg0, arg1);
        assert_current_claim_review_versions(arg1);
        ...
        let v3 = 0x2::dynamic_field::borrow_mut<ClaimPolicyKey, ClaimPolicyRecord>(&mut arg1.id, v2);
        let v4 = if (arg2 != @0x0) {
            if (v3.review_digest == arg2) {
                if (v3.review_status == 1) {
                    if (v3.review_day == v0) {
                        if (v3.generation == arg3) {
                            if (v3.reviewed_generation == arg3) {
                                if (v3.quarantine_revision == arg4) {
                                    v3.last_settled_day + 1 == v0
                                } else {
                                    false
                                }
        ...
        let v5 = ClaimPolicyChanged{
            ...
            review_day          : v3.review_day,
            generation          : v3.generation,
            quarantine_revision : v3.quarantine_revision,
            reason_hash         : arg2,
            changed_ms          : 0x2::clock::timestamp_ms(arg5),
        };
        0x2::event::emit<ClaimPolicyChanged>(v5);
    }
    ...
    public fun set_wallet_quarantined(arg0: &ClaimOperatorCap, arg1: &mut SettlementBook, arg2: address, arg3: bool, arg4: address, arg5: &0x2::clock::Clock) {
        assert_operator_cap(arg0, arg1);
        let v0 = WalletQuarantineKey{wallet: arg2};
        let v1 = policy_record(arg1).quarantine_revision + 1;
        let v2 = WalletQuarantineRecord{
            quarantined : arg3,
            revision    : v1,
            reason_hash : arg4,
            changed_ms  : 0x2::clock::timestamp_ms(arg5),
        };
        if (0x2::dynamic_field::exists<WalletQuarantineKey>(&arg1.id, v0)) {
            *0x2::dynamic_field::borrow_mut<WalletQuarantineKey, WalletQuarantineRecord>(&mut arg1.id, v0) = v2;
        } else {
            0x2::dynamic_field::add<WalletQuarantineKey, WalletQuarantineRecord>(&mut arg1.id, v0, v2);
        };
        let v3 = ClaimPolicyKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<ClaimPolicyKey, ClaimPolicyRecord>(&mut arg1.id, v3).quarantine_revision = v1;
        invalidate_claim_review(arg1, arg4, arg5);
        let v4 = WalletQuarantineChanged{
            book_id     : 0x2::object::id<SettlementBook>(arg1),
            wallet      : arg2,
            quarantined : arg3,
            revision    : v1,
        ...
        0x2::event::emit<WalletQuarantineChanged>(v4);
    }
    ...
    public fun settle_fee_day_v3(arg0: &mut Economy, arg1: &SettlementBook, arg2: &mut 0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::ProtocolTreasuryV3, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 < 0x2::clock::timestamp_ms(arg4) / 86400000, 18);
        let v0 = RewardSnapshotKey{day: arg3};
        assert!(0x2::dynamic_field::exists<RewardSnapshotKey>(&arg1.id, v0), 22);
        let v1 = FeeDayKey{day: arg3};
        ...
        assert!(0x2::balance::value<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS>(&v18) == 0, 11);
        0x2::balance::destroy_zero<0x68f8355f65af278cd8b7bee35de76f9241126a098ffc46f16d647b09e6f71dc8::ss::SS>(v18);
        let (v19, v20, v21) = reserve_or_burn_rank_pool_v3(arg2, v11, v5, arg4, arg5);
        let (v22, v23, v24) = reserve_or_burn_rank_pool_v3(arg2, v12, v6, arg4, arg5);
        let (v25, v26, v27) = reserve_or_burn_rank_pool_v3(arg2, v13, v7, arg4, arg5);
        let (v28, v29, v30) = reserve_or_burn_rank_pool_v3(arg2, v14, v8, arg4, arg5);
        let v31 = transfer_balance(v15, v9, arg5);
        let v32 = v21 + v24 + v27 + v30;
        arg0.total_burned_raw = arg0.total_burned_raw + v32;
        arg0.total_rank_rewards_reserved_raw = arg0.total_rank_rewards_reserved_raw + v20 + v23 + v26 + v29;
    ...
    public fun wallet_quarantined(arg0: &SettlementBook, arg1: address) : bool {
        let v0 = WalletQuarantineKey{wallet: arg1};
        !0x2::dynamic_field::exists<WalletQuarantineKey>(&arg0.id, v0) && false || 0x2::dynamic_field::borrow<WalletQuarantineKey, WalletQuarantineRecord>(&arg0.id, v0).quarantined
    }
