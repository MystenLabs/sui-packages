module 0x8799eb02079a22ed40f15b343879004d98e160c7a90162756450dbb2c705b45c::committee {
    ...
    public(friend) fun size(arg0: &Committee) : u64 {
    ...
    public(friend) fun inner(arg0: &Committee) : &0x2::vec_map::VecMap<0x2::object::ID, vector<u16>> {
        &arg0.pos0
    }

    public(friend) fun shards(arg0: &Committee, arg1: &0x2::object::ID) : &vector<u16> {
        0x2::vec_map::get<0x2::object::ID, vector<u16>>(&arg0.pos0, arg1)
    }

    public(friend) fun to_inner(arg0: &Committee) : 0x2::vec_map::VecMap<0x2::object::ID, vector<u16>> {
        arg0.pos0
    }
    ...
    public(friend) fun transition(arg0: &Committee, arg1: 0x2::vec_map::VecMap<0x2::object::ID, u16>) : Committee {
        ...
        assert!(0x1::vector::length<0x2::object::ID>(&v24) == 0x1::vector::length<u16>(&v25), 9223372547955884031);
