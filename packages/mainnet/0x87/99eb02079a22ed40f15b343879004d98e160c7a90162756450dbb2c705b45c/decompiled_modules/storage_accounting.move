module 0x8799eb02079a22ed40f15b343879004d98e160c7a90162756450dbb2c705b45c::storage_accounting {
    ...
    public(friend) fun epoch(arg0: &FutureAccounting) : u32 {
        arg0.epoch
    }
    ...
    public(friend) fun max_epochs_ahead(arg0: &FutureAccountingRingBuffer) : u32 {
        arg0.length
    }
    ...
    public(friend) fun used_capacity(arg0: &FutureAccounting) : u64 {
        arg0.used_capacity
    }
