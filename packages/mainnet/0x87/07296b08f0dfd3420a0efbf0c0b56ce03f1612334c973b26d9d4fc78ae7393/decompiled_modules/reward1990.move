module 0x8707296b08f0dfd3420a0efbf0c0b56ce03f1612334c973b26d9d4fc78ae7393::reward1990 {
    struct REWARD1990 has drop {
        dummy_field: bool,
    }

    struct TICKET_1990 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1990(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1990>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1990>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1990, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1990>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1990>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1990>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1990>>(v5, 0x2::tx_context::sender(arg1));
    }
