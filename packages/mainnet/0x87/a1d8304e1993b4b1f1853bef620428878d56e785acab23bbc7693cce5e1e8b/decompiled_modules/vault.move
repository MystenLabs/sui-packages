module 0x87a1d8304e1993b4b1f1853bef620428878d56e785acab23bbc7693cce5e1e8b::vault {
    ...
    public fun check_vault_validity(arg0: &Vault, arg1: &0x2::tx_context::TxContext) {
        if (1000000000000 > 18446744073709551615 - arg0.creation_epoch) {
            return
        };
        if (0x2::tx_context::epoch(arg1) > arg0.creation_epoch + 1000000000000) {
            abort 7
        };
    }
