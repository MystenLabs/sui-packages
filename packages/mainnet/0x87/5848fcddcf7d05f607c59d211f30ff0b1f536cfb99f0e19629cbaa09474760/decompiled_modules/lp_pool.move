module 0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::lp_pool {
    ...
    public fun instant_redeem<T0, T1>(arg0: &mut WlpPool<T0>, arg1: &mut 0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::global_config::GlobalConfig, arg2: &mut 0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::AccountRegistry, arg3: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest, arg4: 0x2::coin::Coin<T0>, arg5: &0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::result::PriceResult<T1>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::DepositRequest<T1> {
        assert_version<T0>(arg0);
        ...
        assert_prices_fresh<T0>(arg0, arg1, arg7);
        let v0 = 0x1::type_name::with_defining_ids<T1>();
        let v1 = 0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::result::aggregated_price<T1>(arg5);
        if (0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::eq(v1, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::zero())) {
            0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::error::err_zero_price();
        };
        update_borrow_rates<T0>(arg0, arg7);
        refresh_token_value_with_price<T0, T1>(arg0, v1, 0x2::clock::timestamp_ms(arg7));
        assert_redeem_allowed<T0>(arg0);
        let v2 = 0x2::coin::value<T0>(&arg4);
        let v3 = borrow_token_pool<T0>(arg0, &v0);
        let v4 = if (0x2::coin::total_supply<T0>(&arg0.lp_treasury_cap) > 0) {
            0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::div_u64(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::mul_u64(arg0.tvl_usd, v2), 0x2::coin::total_supply<T0>(&arg0.lp_treasury_cap))
        } else {
            0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::zero()
        };
        let v5 = 0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::math::usd_to_amount(v4, v3.token_decimal, v1);
        ...
        let v8 = borrow_mut_token_pool<T0>(arg0, &v0);
        if (v8.liquidity_amount < v7) {
            0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::error::err_insufficient_liquidity();
        };
        v8.liquidity_amount = v8.liquidity_amount - v7;
        let v9 = 0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::math::amount_to_usd(v8.liquidity_amount, v8.token_decimal, v1);
        v8.value_usd = v9;
        arg0.tvl_usd = 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::add(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::saturating_sub(arg0.tvl_usd, v8.value_usd), v9);
        let v10 = 0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::account_ids(arg2, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::request_address(arg3));
        let v11 = if (0x1::vector::is_empty<0x2::object::ID>(&v10)) {
            0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::create_account(arg2, arg3, 0x1::string::utf8(b""), arg8)
        } else {
            *0x1::vector::borrow<0x2::object::ID>(&v10, 0)
        };
        0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::events::emit_wlp_instant_redeemed(v11, 0x1::type_name::with_defining_ids<T0>(), v0, v2, v7, v6, 0x2::clock::timestamp_ms(arg7));
        0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::request_deposit<T1>(arg2, v11, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::global_config::balance_mut<T1>(arg1), v7), arg8), b"")
    }
