module 0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::events {
    ...
    struct WlpInstantRedeemed has copy, drop {
    ...
    public(friend) fun emit_wlp_instant_redeemed(arg0: 0x2::object::ID, arg1: 0x1::type_name::TypeName, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: u64, arg5: u64, arg6: u64) {
        let v0 = WlpInstantRedeemed{
            account_id    : arg0,
            wlp_type      : arg1,
            token_type    : arg2,
            wlp_amount    : arg3,
        ...
        0x2::event::emit<WlpInstantRedeemed>(v0);
    }
