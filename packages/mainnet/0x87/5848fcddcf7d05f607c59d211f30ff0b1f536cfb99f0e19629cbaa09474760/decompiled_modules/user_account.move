module 0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::user_account {
    ...
    public fun settle_accumulator_funds<T0>(arg0: &mut AccountRegistry, arg1: &0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::global_config::GlobalConfig, arg2: &0x2::accumulator::AccumulatorRoot, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::global_config::verify_keeper(arg1, 0x2::tx_context::sender(arg5));
        ...
        let v3 = 0x1::u64::min(v2, arg4);
        let v4 = 0;
        while (v4 < v3) {
            let (_, v6) = 0x17235897a9c2e977d60f3ded7b05e85724d7ee846b1519e6d8af7fdbc840da37::keyed_big_vector::borrow_mut<0x2::object::ID, UserAccount>(v0, arg3 + v4);
            let v7 = 0x2::object::id<UserAccount>(v6);
            let v8 = 0x2::object::id_to_address(&v7);
            let v9 = 0x2::balance::settled_funds_value<T0>(arg2, v8);
            if (v9 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::redeem_funds<T0>(0x2::balance::withdraw_funds_from_object<T0>(&mut v6.id, v9)), arg5), v8);
            };
            v4 = v4 + 1;
        };
        v3
