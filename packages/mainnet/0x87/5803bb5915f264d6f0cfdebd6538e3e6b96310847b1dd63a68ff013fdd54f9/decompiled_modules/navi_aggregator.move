module 0x875803bb5915f264d6f0cfdebd6538e3e6b96310847b1dd63a68ff013fdd54f9::navi_aggregator {
    ...
    public fun update_token_price_batch(arg0: &NaviAggregatorCap, arg1: &mut NaviAggregator, arg2: &0xb38c3759fb0244e8d554b5d441890ba750557dcdde897762b213fd0b67a2523f::oracle::OracleCap, arg3: &mut 0xb38c3759fb0244e8d554b5d441890ba750557dcdde897762b213fd0b67a2523f::oracle::PriceOracle, arg4: &0x2::clock::Clock, arg5: u8, arg6: vector<u8>, arg7: vector<u256>, arg8: &mut 0x2::tx_context::TxContext) {
        only_feeder(arg0, arg8);
        let v0 = &mut arg1.oracles;
        assert!(0x2::table::contains<u8, OracleInfo>(v0, arg5), 60001);
        let v1 = 0x1::vector::length<u8>(&arg6);
        assert!(v1 == 0x1::vector::length<u256>(&arg7), 60004);
        let v2 = 0x2::clock::timestamp_ms(arg4) / 1000;
        let v3 = 0;
        let v4 = &mut 0x2::table::borrow_mut<u8, OracleInfo>(v0, arg5).prices;
        while (v3 < v1) {
            update_internal_price(v4, *0x1::vector::borrow<u8>(&arg6, v3), *0x1::vector::borrow<u256>(&arg7, v3), v2);
            v3 = v3 + 1;
        };
        if (v2 - arg1.update_timestamp < arg1.update_timeout) {
            return
        };
        0xb38c3759fb0244e8d554b5d441890ba750557dcdde897762b213fd0b67a2523f::oracle::update_token_price_batch(arg2, arg3, arg6, arg7, arg8);
    }
