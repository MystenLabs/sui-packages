module 0x87c13bb9157c3d51d61c7802704539d9d4782e838aadc41df0d6f0cc117298ba::pool {
    ...
    public fun withdraw<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: Credential<T0, T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = ((((arg0.acc_reward_per_share - arg2.acc_reward_per_share) as u256) * (v0 as u256) / (1000000000000000000 as u256)) as u128);
        assert!(v2 <= 340282366920938463463374607431768211455, 11);
        arg2.acc_reward_per_share = arg0.acc_reward_per_share;
        arg0.staked_amount = arg0.staked_amount - arg3;
        let v3 = 0x2::tx_context::sender(arg4);
        pay_from_balance<T1>(0x2::balance::split<T1>(&mut arg0.reward_vault, min_reward<T1>(&arg0.reward_vault, (v2 as u64))), v3, arg4);
        ...
        if (0x2::balance::value<T0>(&arg2.stake) == 0) {
            ...
            0x2::transfer::transfer<Credential<T0, T1>>(arg2, v3);
        };
        0x87c13bb9157c3d51d61c7802704539d9d4782e838aadc41df0d6f0cc117298ba::event::withdraw<T0, T1>(v3, arg3, (v2 as u64));
    }
