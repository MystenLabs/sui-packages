module 0x872d8c78e1df3a3b74e83d0bc83e78723442f65bfc51a3e62890c01269ea28c0::cetus_vampire_attack {
    ...
    struct LockdropForPool<phantom T0, phantom T1> has key {
        ...
        total_hive_incentives: 0x2::balance::Balance<0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive::HIVE>,
        hive_incentives: u64,
    ...
    public entry fun add_incentives_for_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut LockdropForPool<T0, T1>, arg2: &CetusAttackConfig, arg3: 0x2::coin::Coin<0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive::HIVE>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (u64, 0x1::string::String) {
        ...
        0x2::balance::join<0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive::HIVE>(&mut arg1.total_hive_incentives, 0x2::balance::split<0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive::HIVE>(&mut v0, arg4));
    ...
    public fun destroy_user_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::config::HiveEntryCap, arg2: &CetusAttackConfig, arg3: &LockdropForPool<T0, T1>, arg4: &mut 0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::HiveProfile, arg5: address, arg6: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, u128) {
        ...
        } = 0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::entry_remove_from_profile<UserCetusHivePosition>(&arg3.user_profile_access_cap, arg4, arg6);
        let v5 = v2;
        let v6 = v1;
    ...
    public fun does_user_have_position<T0, T1>(arg0: &0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::HiveProfile, arg1: &LockdropForPool<T0, T1>) : bool {
    ...
    public fun get_user_position<T0, T1>(arg0: &0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::HiveProfile, arg1: &LockdropForPool<T0, T1>) : (vector<u64>, vector<u128>, vector<u64>, vector<u128>, vector<u64>, u128, u64) {
        let v0 = 0x1::vector::empty<u64>();
        let v1 = 0x1::vector::empty<u128>();
        let v2 = 0x1::vector::empty<u64>();
        let v3 = 0x1::vector::empty<u128>();
        let v4 = 0x1::vector::empty<u64>();
        let v5 = 0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::get_profile_dof_capability_identifier(&arg1.user_profile_access_cap);
        if (!0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::exists_for_profile(arg0, v5)) {
            return (v0, v1, v2, v3, v4, 0, 0)
        };
        let v6 = 0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::borrow_from_profile<UserCetusHivePosition>(arg0, v5);
        v0 = v6.lockup_weeks;
        let v7 = 0;
    ...
    public entry fun initialize_attack_on_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::config::HiveEntryCap, arg2: 0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::ProfileDofOwnershipCapability, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: &CetusAttackConfig, arg5: 0x1::string::String, arg6: u8, arg7: 0x2::coin::Coin<0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive::HIVE>, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : address {
        0x2::clock::timestamp_ms(arg0);
        let v0 = 0x2::coin::into_balance<0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive::HIVE>(arg7);
        ...
        let v3 = LockdropForPool<T0, T1>{
            ...
            total_hive_incentives               : 0x2::balance::split<0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive::HIVE>(&mut v0, arg8),
        ...
        0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::coin_helper::destroy_or_transfer_balance<0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive::HIVE>(v0, 0x2::tx_context::sender(arg9), arg9);
    ...
    public entry fun initialize_cetus_attack(arg0: &0x2::clock::Clock, arg1: &0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::config::HiveEntryCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) : address {
        0x2::clock::timestamp_ms(arg0);
    ...
    public fun stake_cetus_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::config::HiveEntryCap, arg2: &CetusAttackConfig, arg3: &mut LockdropForPool<T0, T1>, arg4: &mut 0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::HiveProfile, arg5: 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (u128, 0x1::string::String, u8) {
        0x2::clock::timestamp_ms(arg0);
        ...
        let v4 = if (0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::exists_for_profile(arg4, 0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::get_profile_dof_capability_identifier(&arg3.user_profile_access_cap))) {
            0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::entry_remove_from_profile<UserCetusHivePosition>(&arg3.user_profile_access_cap, arg4, arg7)
        } else {
        ...
        0x2::table::add<u64, CetusPositionBreakdown>(&mut v10.position_breakdown, arg6, kraft_cetus_position_breakdown(v6, v8));
        v10.total_user_weighted_units = v10.total_user_weighted_units + v8;
        0x2::linked_table::push_back<address, UserCetusLockup>(&mut arg3.paricipants_position_mapping, v0, v10);
        arg3.total_positions_liquidity = arg3.total_positions_liquidity + v6;
        arg3.total_weighted_units = arg3.total_weighted_units + v8;
        0x2::linked_table::push_back<0x1::string::String, bool>(&mut arg3.liquidity_extracted_bool, make_position_identifier(v0, arg6), false);
        let v11 = calculate_hive_rewards(v4.total_weighted_units, arg3.total_weighted_units, arg3.hive_incentives);
        let v12 = CetusPositionLocked<T0, T1>{
            user_profile                   : v0,
            username                       : v1,
            user_addr                      : v3,
            lockup_weeks                   : arg6,
            ...
            expected_hive_rewards_increase : v11 - calculate_hive_rewards(v4.total_weighted_units, arg3.total_weighted_units, arg3.hive_incentives),
            total_user_exp_hive_rewards    : v11,
        };
        0x2::event::emit<CetusPositionLocked<T0, T1>>(v12);
        0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::entry_add_to_profile<UserCetusHivePosition>(&arg3.user_profile_access_cap, arg4, v4, arg7);
        (v6, arg3.identifier, arg3.precision)
    }

    public fun transfer_liquidity_from_cetus<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::config::HiveEntryCap, arg2: &CetusAttackConfig, arg3: &mut LockdropForPool<T0, T1>, arg4: &0x2::tx_context::TxContext) : (u128, u8, u128, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>, 0x2::balance::Balance<0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive::HIVE>) {
        0x2::clock::timestamp_ms(arg0);
        (arg3.total_positions_liquidity, arg3.precision, arg3.total_weighted_units, 0x2::balance::withdraw_all<T0>(&mut arg3.x_avail_liquidity_bal), 0x2::balance::withdraw_all<T1>(&mut arg3.y_avail_liquidity_bal), 0x2::balance::withdraw_all<T0>(&mut arg3.x_fee_avail_bal), 0x2::balance::withdraw_all<T1>(&mut arg3.y_fee_avail_bal), 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg3.sui_earned_bal), 0x2::balance::withdraw_all<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(&mut arg3.cetus_earned_bal), 0x2::balance::withdraw_all<0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive::HIVE>(&mut arg3.total_hive_incentives))
    }
