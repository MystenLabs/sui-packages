module 0x8751f0bb41b6ae3aa1712ef534fcb85a578a7e49522967c9a3371b7438bab7a3::crazy_beanz {
    ...
    fun init(arg0: CRAZY_BEANZ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"CRAZY BEANZ is a limited collection of 3,333 animated NFTs on the Sui blockchain, each with a SCRATCHIEZ ticket for rewards, hidden content, and early access to a growing MMO game world shaped by its community."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiewfi46sp2uyzupwym2ckvbgexbkntp6txfjpwtjjsozx23oebffy"));
