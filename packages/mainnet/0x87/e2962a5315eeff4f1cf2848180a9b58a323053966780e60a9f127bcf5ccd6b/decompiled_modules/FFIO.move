module 0xd9fc80a30c89489764bc07f557dc17162a477d34a9b44e65aae48af8ead006e7::FFIO {
    ...
    fun init(arg0: FFIO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<FFIO>(arg0, 9, b"FFIO", b"Find4.io Coin", b"Play to earn!", 0x1::option::some<0x2::url::Url>(create_url(b"https://www.find4.io/f4-42.png")), arg1);
        let v4 = v2;
    ...
    public entry fun stake_existing_ffio(arg0: &mut StakingPool, arg1: 0x2::coin::Coin<FFIO>, arg2: &mut Treasury, arg3: &0x2::clock::Clock, arg4: StakeObject, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<StakeObject>(arg4, 0x2::tx_context::sender(arg5));
    }
