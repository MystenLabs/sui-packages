module 0x871ed8559523f2762d279cafe38ac8cf9b1f136d925a60abf5319c667ee6507b::error {
    ...
    public(friend) fun borrow_index_time_going_backwards() : u64 {
        219
    }

    public(friend) fun borrow_index_value_going_backwards() : u64 {
        220
    }
