module 0x873ee745592fe90effe3588b122e2f3f75efcb903267ffe2a8d4490a057c7b7c::message {
    ...
    public fun amount(arg0: &BurnInputs) : u64 {
        arg0.amount
    }
    ...
    public(friend) fun encode(arg0: vector<u8>, arg1: vector<u8>, arg2: address, arg3: &BurnInputs) : vector<u8> {
        assert!(arg2 != @0x0, 0);
        let v0 = 0x1::vector::empty<vector<u8>>();
        let v1 = &mut v0;
        0x1::vector::push_back<vector<u8>>(v1, arg3.fee_payer);
        0x1::vector::push_back<vector<u8>>(v1, arg3.event_account);
        ...
        0x1::vector::append<u8>(&mut v4, arg3.recent_blockhash);
        0x1::vector::push_back<u8>(&mut v4, 3);
        0x1::vector::append<u8>(&mut v4, x"07000502");
        0x1::vector::append<u8>(&mut v4, 0x2::bcs::to_bytes<u32>(&arg3.compute_unit_limit));
        0x1::vector::append<u8>(&mut v4, x"07000903");
        0x1::vector::append<u8>(&mut v4, 0x2::bcs::to_bytes<u64>(&arg3.compute_unit_price));
        0x1::vector::append<u8>(&mut v4, x"081102000903040a0b0c0506010d080e0f100834");
        0x1::vector::append<u8>(&mut v4, x"d73c3d2e723780b0");
        0x1::vector::append<u8>(&mut v4, 0x2::bcs::to_bytes<u64>(&arg3.amount));
