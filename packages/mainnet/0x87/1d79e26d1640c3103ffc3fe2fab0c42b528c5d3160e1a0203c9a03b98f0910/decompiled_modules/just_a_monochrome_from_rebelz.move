module 0x871d79e26d1640c3103ffc3fe2fab0c42b528c5d3160e1a0203c9a03b98f0910::just_a_monochrome_from_rebelz {
    struct JUST_A_MONOCHROME_FROM_REBELZ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: JUST_A_MONOCHROME_FROM_REBELZ, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<JUST_A_MONOCHROME_FROM_REBELZ>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"JUST A MONOCHROME FROM REBELZ"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"THE ONE AND ONLY MONOCHROME ON SUI"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeif2yov5y26be4nlx5f3txespuzmehldaltrqy6aojr3zmcztdroma"));
