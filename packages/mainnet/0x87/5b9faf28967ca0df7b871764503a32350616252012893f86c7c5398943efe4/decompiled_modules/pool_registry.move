module 0x875b9faf28967ca0df7b871764503a32350616252012893f86c7c5398943efe4::pool_registry {
    ...
    public fun disable_pool<T0>(arg0: &0x875b9faf28967ca0df7b871764503a32350616252012893f86c7c5398943efe4::config::AdminCap, arg1: &mut PoolRegistry, arg2: 0x1::string::String, arg3: 0x1::option::Option<0x1::string::String>) {
        let v0 = PoolKey{
            protocol   : arg2,
            asset_type : 0x1::type_name::with_defining_ids<T0>(),
            pool_id    : arg3,
    ...
    public fun enable_pool<T0>(arg0: &0x875b9faf28967ca0df7b871764503a32350616252012893f86c7c5398943efe4::config::AdminCap, arg1: &mut PoolRegistry, arg2: 0x1::string::String, arg3: 0x1::option::Option<0x1::string::String>) {
        let v0 = PoolKey{
            protocol   : arg2,
            asset_type : 0x1::type_name::with_defining_ids<T0>(),
            pool_id    : arg3,
    ...
    public fun register_pool<T0>(arg0: &0x875b9faf28967ca0df7b871764503a32350616252012893f86c7c5398943efe4::config::AdminCap, arg1: &mut PoolRegistry, arg2: 0x1::string::String, arg3: 0x1::option::Option<0x1::string::String>) {
        let v0 = PoolKey{
            protocol   : arg2,
            asset_type : 0x1::type_name::with_defining_ids<T0>(),
            pool_id    : arg3,
