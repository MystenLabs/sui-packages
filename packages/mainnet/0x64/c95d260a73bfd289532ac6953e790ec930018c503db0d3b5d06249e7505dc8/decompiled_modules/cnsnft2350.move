module 0x64c95d260a73bfd289532ac6953e790ec930018c503db0d3b5d06249e7505dc8::cnsnft2350 {
    struct CNSNFT2350 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2350, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2350>(arg0, arg1);
