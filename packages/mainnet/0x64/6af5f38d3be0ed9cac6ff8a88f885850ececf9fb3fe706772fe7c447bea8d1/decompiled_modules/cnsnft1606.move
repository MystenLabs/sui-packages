module 0x646af5f38d3be0ed9cac6ff8a88f885850ececf9fb3fe706772fe7c447bea8d1::cnsnft1606 {
    struct CNSNFT1606 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1606, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1606>(arg0, arg1);
