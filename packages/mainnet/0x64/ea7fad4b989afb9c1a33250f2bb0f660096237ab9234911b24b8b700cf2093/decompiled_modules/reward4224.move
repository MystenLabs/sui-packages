module 0x64ea7fad4b989afb9c1a33250f2bb0f660096237ab9234911b24b8b700cf2093::reward4224 {
    struct REWARD4224 has drop {
        dummy_field: bool,
    }

    struct TICKET_4224 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4224(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4224>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4224>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4224, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4224>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4224>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4224>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4224>>(v5, 0x2::tx_context::sender(arg1));
    }
