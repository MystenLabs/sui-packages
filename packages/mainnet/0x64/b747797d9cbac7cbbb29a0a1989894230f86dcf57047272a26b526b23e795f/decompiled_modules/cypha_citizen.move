module 0x3c89d9cfbde3ef6898014a718dee6fe676b390016d796eba194b7a9d74dd83b9::cypha_citizen {
    ...
    struct AcceptedPaymentCoinKey<phantom T0> has copy, drop, store {
        dummy_field: bool,
    }

    struct AcceptedDiscountPaymentCoinKey<phantom T0> has copy, drop, store {
        dummy_field: bool,
    }

    struct AcceptedPaymentCoinValue has drop, store {
        amount: u64,
    }
    ...
    public fun accepted_coin_price<T0>(arg0: &Registry) : u64 {
        let v0 = AcceptedPaymentCoinKey<T0>{dummy_field: false};
        if (0x2::dynamic_field::exists_<AcceptedPaymentCoinKey<T0>>(&arg0.id, v0)) {
            0x2::dynamic_field::borrow<AcceptedPaymentCoinKey<T0>, AcceptedPaymentCoinValue>(&arg0.id, v0).amount
        } else {
            0
        }
    }

    public fun accepted_discount_coin_price<T0>(arg0: &Registry) : u64 {
        let v0 = AcceptedDiscountPaymentCoinKey<T0>{dummy_field: false};
        if (0x2::dynamic_field::exists_<AcceptedDiscountPaymentCoinKey<T0>>(&arg0.id, v0)) {
            0x2::dynamic_field::borrow<AcceptedDiscountPaymentCoinKey<T0>, AcceptedPaymentCoinValue>(&arg0.id, v0).amount
        } else {
            0
        }
    }
    ...
    public fun is_coin_accepted<T0>(arg0: &Registry) : bool {
        let v0 = AcceptedPaymentCoinKey<T0>{dummy_field: false};
        0x2::dynamic_field::exists_<AcceptedPaymentCoinKey<T0>>(&arg0.id, v0)
    }

    public fun is_discount_coin_accepted<T0>(arg0: &Registry) : bool {
        let v0 = AcceptedDiscountPaymentCoinKey<T0>{dummy_field: false};
        0x2::dynamic_field::exists_<AcceptedDiscountPaymentCoinKey<T0>>(&arg0.id, v0)
    }
    ...
    public fun mint_pass(arg0: &mut Registry, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x1::string::String, arg3: 0x1::option::Option<0x1::string::String>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        abort 13906834874423050239
    }

    public fun mint_pass_v2<T0>(arg0: &mut Registry, arg1: 0x2::coin::Coin<T0>, arg2: 0x1::string::String, arg3: 0x1::option::Option<0x1::string::String>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(arg0.version == 1, 7);
        let v1 = AcceptedPaymentCoinKey<T0>{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<AcceptedPaymentCoinKey<T0>>(&arg0.id, v1), 9);
        let v2 = AcceptedDiscountPaymentCoinKey<T0>{dummy_field: false};
        let v3 = if (0x1::option::is_some<0x1::string::String>(&arg3) && 0x2::dynamic_field::exists_<AcceptedDiscountPaymentCoinKey<T0>>(&arg0.id, v2)) {
            0x2::dynamic_field::borrow<AcceptedDiscountPaymentCoinKey<T0>, AcceptedPaymentCoinValue>(&arg0.id, v2).amount
        } else {
            0x2::dynamic_field::borrow<AcceptedPaymentCoinKey<T0>, AcceptedPaymentCoinValue>(&arg0.id, v1).amount
        };
        assert!(0x2::coin::value<T0>(&arg1) >= v3, 6);
        ...
        let v4 = 0x1::string::length(&arg2);
        assert!(v4 >= 3 && v4 <= 64, 1);
        let v5 = 0x1::option::none<address>();
        if (0x1::option::is_some<0x1::string::String>(&arg3)) {
            let v6 = *0x1::option::borrow<0x1::string::String>(&arg3);
            assert!(0x2::table::contains<0x1::string::String, address>(&arg0.referral_book.code_to_owner, v6), 8);
            let v7 = *0x2::table::borrow<0x1::string::String, address>(&arg0.referral_book.code_to_owner, v6);
            if (!0x2::table::contains<address, u64>(&arg0.referral_book.invite_counts, v7)) {
                0x2::table::add<address, u64>(&mut arg0.referral_book.invite_counts, v7, 0);
            };
            *0x2::table::borrow_mut<address, u64>(&mut arg0.referral_book.invite_counts, v7) = *0x2::table::borrow<address, u64>(&arg0.referral_book.invite_counts, v7) + 1;
            v5 = 0x1::option::some<address>(v7);
        };
        ...
        let v8 = 0x1::string::utf8(b"Citizen Pass #");
        0x1::string::append(&mut v8, 0x1::u128::to_string(arg0.sequence_number));
        ...
        let v10 = CitizenPass{
            ...
            created_at_ms : v9,
            name          : v8,
            image_url     : 0x1::string::utf8(b"https://welcome.cyphalab.com/citizen.jpg"),
        };
        0x2::table::add<address, u64>(&mut arg0.points_book.totals, v0, 0);
        arg0.sequence_number = arg0.sequence_number + 1;
        0x2::transfer::transfer<CitizenPass>(v10, v0);
        let v11 = CitizenPassMintedEvent{
            pass_id       : 0x2::object::id<CitizenPass>(&v10),
            owner         : v0,
            invited_by    : arg3,
            referral_code : arg2,
            minted_by     : v0,
        ...
        0x2::event::emit<CitizenPassMintedEvent>(v11);
    }
    ...
    public fun remove_accepted_coin<T0>(arg0: &AdminCap, arg1: &mut Registry) {
        assert!(arg1.version == 1, 7);
        let v0 = AcceptedPaymentCoinKey<T0>{dummy_field: false};
        0x2::dynamic_field::remove<AcceptedPaymentCoinKey<T0>, AcceptedPaymentCoinValue>(&mut arg1.id, v0);
    }

    public fun remove_accepted_discount_coin<T0>(arg0: &AdminCap, arg1: &mut Registry) {
        assert!(arg1.version == 1, 7);
        let v0 = AcceptedDiscountPaymentCoinKey<T0>{dummy_field: false};
        0x2::dynamic_field::remove<AcceptedDiscountPaymentCoinKey<T0>, AcceptedPaymentCoinValue>(&mut arg1.id, v0);
    }

    public fun set_accepted_coin<T0>(arg0: &AdminCap, arg1: &mut Registry, arg2: u64) {
        assert!(arg1.version == 1, 7);
        let v0 = AcceptedPaymentCoinKey<T0>{dummy_field: false};
        if (0x2::dynamic_field::exists_<AcceptedPaymentCoinKey<T0>>(&arg1.id, v0)) {
            0x2::dynamic_field::borrow_mut<AcceptedPaymentCoinKey<T0>, AcceptedPaymentCoinValue>(&mut arg1.id, v0).amount = arg2;
        } else {
            let v1 = AcceptedPaymentCoinValue{amount: arg2};
            0x2::dynamic_field::add<AcceptedPaymentCoinKey<T0>, AcceptedPaymentCoinValue>(&mut arg1.id, v0, v1);
        };
    }

    public fun set_accepted_discount_coin<T0>(arg0: &AdminCap, arg1: &mut Registry, arg2: u64) {
        assert!(arg1.version == 1, 7);
        let v0 = AcceptedDiscountPaymentCoinKey<T0>{dummy_field: false};
        if (0x2::dynamic_field::exists_<AcceptedDiscountPaymentCoinKey<T0>>(&arg1.id, v0)) {
            0x2::dynamic_field::borrow_mut<AcceptedDiscountPaymentCoinKey<T0>, AcceptedPaymentCoinValue>(&mut arg1.id, v0).amount = arg2;
        } else {
            let v1 = AcceptedPaymentCoinValue{amount: arg2};
            0x2::dynamic_field::add<AcceptedDiscountPaymentCoinKey<T0>, AcceptedPaymentCoinValue>(&mut arg1.id, v0, v1);
        };
    }
