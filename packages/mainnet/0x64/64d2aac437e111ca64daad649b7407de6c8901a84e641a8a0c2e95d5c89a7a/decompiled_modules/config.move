module 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::config {
    ...
    public entry fun get_fee_info<T0>(arg0: &Config) : (u64, u64) {
        if (0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::curves::is_stable<T0>()) {
            return (arg0.stable_pool_fee.total_fee_bps, arg0.stable_pool_fee.hive_fee_percent)
        };
        if (0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::curves::is_weighted<T0>()) {
            return (arg0.weighted_pool_fee.total_fee_bps, arg0.weighted_pool_fee.hive_fee_percent)
        };
        if (0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::curves::is_curved<T0>()) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v13 = FeeInfo{
            total_fee_bps    : 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::weighted_total_fee_bps(),
            hive_fee_percent : 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::weighted_hive_fee_percent(),
        };
        let v14 = FeeInfo{
            total_fee_bps    : 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::stable_total_fee_bps(),
            hive_fee_percent : 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::stable_hive_fee_percent(),
        };
        let v15 = FeeInfo{
            total_fee_bps    : 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::curved_total_fee_bps(),
            hive_fee_percent : 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::curved_hive_fee_percent(),
        };
        let v16 = Config{
            id                 : 0x2::object::new(arg0),
            ...
            stable_pool_fee    : v14,
            curved_pool_fee    : v15,
            treasury_percent   : 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::init_treasury_percent(),
        };
        0x2::transfer::share_object<Config>(v16);
        let v17 = Treasury<0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::dsui::DSUI>{
            id      : 0x2::object::new(arg0),
            balance : 0x2::balance::zero<0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::dsui::DSUI>(),
        };
        0x2::transfer::share_object<Treasury<0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::dsui::DSUI>>(v17);
    }
    ...
    public fun update_default_fee_for_curve<T0>(arg0: &mut Config, arg1: &HiveDaoCapability, arg2: u64, arg3: u64) {
        0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::curves::assert_valid_curve<T0>();
        if (0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::curves::is_stable<T0>()) {
            let v0 = &mut arg0.stable_pool_fee;
            update_fee(v0, arg2, arg3);
        } else if (0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::curves::is_weighted<T0>()) {
            let v1 = &mut arg0.weighted_pool_fee;
            update_fee(v1, arg2, arg3);
        } else if (0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::curves::is_curved<T0>()) {
    ...
    fun update_fee(arg0: &mut FeeInfo, arg1: u64, arg2: u64) {
        if (arg1 > 0) {
            assert!(arg1 >= 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::min_swap_fee() && arg1 <= 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::max_swap_fee(), 3020);
            arg0.total_fee_bps = arg1;
        };
        if (arg2 > 0) {
            assert!(arg2 >= 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::min_hive_fee() && arg2 <= 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::max_hive_fee(), 3020);
            arg0.hive_fee_percent = arg2;
        };
    }

    public fun update_treasury_percent(arg0: &mut Config, arg1: &HiveDaoCapability, arg2: u64) {
        assert!(arg2 >= 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::min_treasury_fee() && arg2 <= 0x6464d2aac437e111ca64daad649b7407de6c8901a84e641a8a0c2e95d5c89a7a::constants::max_treasury_fee(), 3020);
