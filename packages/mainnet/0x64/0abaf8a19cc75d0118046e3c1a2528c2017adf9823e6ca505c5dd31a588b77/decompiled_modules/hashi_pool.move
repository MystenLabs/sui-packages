module 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::hashi_pool {
    ...
    public fun clear_pending_sats(arg0: &0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::pool::PoolAdminCap, arg1: &mut HashiPoolConfig, arg2: u64) {
    ...
    public fun initialize(arg0: &0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::pool::PoolAdminCap, arg1: address, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun mark_hashi_approved(arg0: &0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::pool::PoolAdminCap, arg1: &mut BlockDepositRecord) {
        assert!(arg1.status == 1, 13906835759186968587);
        arg1.status = 2;
    }

    public fun mark_hashi_confirmed(arg0: &0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::pool::PoolAdminCap, arg1: &mut HashiPoolConfig, arg2: &mut BlockDepositRecord, arg3: &0x2::clock::Clock) {
    ...
    public fun mark_hashi_failed(arg0: &0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::pool::PoolAdminCap, arg1: &mut BlockDepositRecord, arg2: vector<u8>) {
    ...
    public fun record_block_found(arg0: &mut HashiPoolConfig, arg1: &0x2::clock::Clock, arg2: &0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::pool::BlockFoundClaim, arg3: vector<u8>, arg4: u32, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<u8>(&arg3) == 32, 13906835368344813577);
        let v0 = 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::pool::claim_round_id(arg2);
    ...
    public fun register_with_hashi(arg0: &0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::pool::PoolAdminCap, arg1: &HashiPoolConfig, arg2: &mut BlockDepositRecord, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun set_hashi_request_id(arg0: &0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::pool::PoolAdminCap, arg1: &mut BlockDepositRecord, arg2: address) {
    ...
    public fun update_btc_address(arg0: &0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::pool::PoolAdminCap, arg1: &mut HashiPoolConfig, arg2: vector<u8>) {
