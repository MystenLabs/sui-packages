module 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::u512 {
    ...
    fun msb(arg0: &U512) : u16 {
        if (arg0.hi != 0) {
            256 + (0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::common::msb(arg0.hi, 256) as u16)
        } else {
            (0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::common::msb(arg0.lo, 256) as u16)
        }
    }
    ...
    public fun div_rem_u256(arg0: U512, arg1: u256) : (bool, u256, u256) {
        assert!(arg1 != 0, 13835621795509829637);
        if (arg0.hi == 0) {
        ...
        assert!(v1.hi == 0, 13835903425105494023);
        if (v2) {
            (true, 0, v1.lo)
        } else {
            (false, v0, v1.lo)
    ...
    public fun mul_u256(arg0: u256, arg1: u256) : U512 {
        ...
        assert!(v19 == 0, 13835058742476931073);
        U512{
    ...
    fun sub_u256(arg0: U512, arg1: u256) : U512 {
        if (arg0.lo >= arg1) {
            ...
            assert!(arg0.hi > 0, 13835340908943507459);
