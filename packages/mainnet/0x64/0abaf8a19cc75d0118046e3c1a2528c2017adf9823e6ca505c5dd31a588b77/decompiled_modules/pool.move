module 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::pool {
    struct Pool has key {
        id: 0x2::object::UID,
        admin: address,
        total_blocks: u64,
    ...
    struct BuyerHashpowerOrder<phantom T0> has key {
        id: 0x2::object::UID,
        buyer: address,
        price_per_difficulty: u64,
        budget: 0x2::balance::Balance<T0>,
    ...
    struct BuyerHashpowerOrderPlaced has copy, drop {
        order_id: 0x2::object::ID,
        buyer: address,
        price_per_difficulty: u64,
        initial_budget: u64,
    ...
    struct BuyerHashpowerOrderPriceUpdated has copy, drop {
        order_id: 0x2::object::ID,
        old_price: u64,
        new_price: u64,
    }

    struct BuyerHashpowerOrderToppedUp has copy, drop {
        order_id: 0x2::object::ID,
        added: u64,
        new_budget: u64,
    }

    struct BuyerHashpowerOrderCanceled has copy, drop {
        order_id: 0x2::object::ID,
        refunded: u64,
    }

    struct BuyerHashpowerShareFilled has copy, drop {
        order_id: 0x2::object::ID,
        miner: address,
        template_id: 0x2::object::ID,
        derived_template_id: 0x1::option::Option<0x2::object::ID>,
    ...
    public fun accumulate_miner_stats(arg0: &mut RoundAccumulator, arg1: vector<0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerRoundStats>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        while (!0x1::vector::is_empty<0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerRoundStats>(&arg1)) {
            let v1 = 0x1::vector::pop_back<0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerRoundStats>(&mut arg1);
            assert!(0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::mrs_miner(&v1) == v0, 13906841905285627922);
            if (0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::mrs_round_id(&v1) == arg0.round_id) {
                let v2 = 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::mrs_work(&v1);
                let v3 = 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::mrs_shares(&v1);
                let v4 = 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::mrs_sold_work(&v1);
                let v5 = 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::mrs_sold_shares(&v1);
                let v6 = if (v4 >= v2) {
                    0
                } else {
                    v2 - v4
            ...
            0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::delete_round_stats(v1);
        };
        0x1::vector::destroy_empty<0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerRoundStats>(arg1);
    }
    ...
    public fun buyer_order_budget<T0>(arg0: &BuyerHashpowerOrder<T0>) : u64 {
        0x2::balance::value<T0>(&arg0.budget)
    }

    public fun buyer_order_buyer<T0>(arg0: &BuyerHashpowerOrder<T0>) : address {
        arg0.buyer
    }

    public fun buyer_order_expires_epoch<T0>(arg0: &BuyerHashpowerOrder<T0>) : 0x1::option::Option<u64> {
        arg0.expires_epoch
    }

    public fun buyer_order_is_dynamic<T0>(arg0: &BuyerHashpowerOrder<T0>) : bool {
        arg0.is_dynamic
    }

    public fun buyer_order_price<T0>(arg0: &BuyerHashpowerOrder<T0>) : u64 {
        arg0.price_per_difficulty
    }

    public fun cancel_buyer_order<T0>(arg0: BuyerHashpowerOrder<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg0.buyer == 0x2::tx_context::sender(arg1), 13906840157234987042);
        ...
        let v8 = BuyerHashpowerOrderCanceled{
            order_id : 0x2::object::id_from_address(0x2::object::uid_to_address(&v7)),
            refunded : 0x2::balance::value<T0>(&v6),
        };
        0x2::event::emit<BuyerHashpowerOrderCanceled>(v8);
        0x2::object::delete(v7);
        0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut v6), arg1)
    }

    public fun cancel_hashpower_order<T0>(arg0: HashpowerBuyOrder<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg0.buyer == 0x2::tx_context::sender(arg1), 13906837889492254754);
    ...
    fun check_buyer_order_not_expired<T0>(arg0: &BuyerHashpowerOrder<T0>, arg1: &0x2::tx_context::TxContext) {
        if (0x1::option::is_some<u64>(&arg0.expires_epoch)) {
            assert!(0x2::tx_context::epoch(arg1) <= *0x1::option::borrow<u64>(&arg0.expires_epoch), 13906840861609754660);
        };
    }

    fun check_order_not_expired<T0>(arg0: &HashpowerBuyOrder<T0>, arg1: &0x2::tx_context::TxContext) {
        if (0x1::option::is_some<u64>(&arg0.expires_epoch)) {
            assert!(0x2::tx_context::epoch(arg1) <= *0x1::option::borrow<u64>(&arg0.expires_epoch), 13906838593867022372);
        };
    }
    ...
    public fun create_mpc_config(arg0: &PoolAdminCap, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 >= 22 && v0 <= 42, 13906836424909062188);
    ...
    public fun derived_template_round_id(arg0: &DerivedTemplate) : u64 {
        arg0.round_id
    }
    ...
    fun drain_buyer_order_budget<T0>(arg0: &mut BuyerHashpowerOrder<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::balance::value<T0>(&arg0.budget) >= arg1, 13906840908854132768);
    ...
    fun drain_order_budget<T0>(arg0: &mut HashpowerBuyOrder<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::balance::value<T0>(&arg0.budget) >= arg1, 13906838684061073440);
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.budget, arg1), arg2)
    }

    public fun finalize_round(arg0: &mut Pool, arg1: RoundAccumulator, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.round_id == arg0.current_round, 13906842085674385428);
        let v0 = 0x2::clock::timestamp_ms(arg2);
        assert!(v0 >= arg1.created_at_ms + 5000, 13906842094264451094);
    ...
    public fun open_round_accumulator_from_claim(arg0: &mut Pool, arg1: &BlockFoundClaim, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.round_id == arg0.current_round, 13906841694832361492);
    ...
    public fun place_buyer_order<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: 0x1::option::Option<u64>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(arg1 > 0, 13906839890947276838);
        let v1 = BuyerHashpowerOrder<T0>{
            id                   : 0x2::object::new(arg4),
            buyer                : v0,
            price_per_difficulty : arg1,
            budget               : 0x2::coin::into_balance<T0>(arg0),
            expires_epoch        : arg2,
            is_dynamic           : arg3,
        };
        let v2 = BuyerHashpowerOrderPlaced{
            order_id             : 0x2::object::id<BuyerHashpowerOrder<T0>>(&v1),
            buyer                : v0,
            price_per_difficulty : arg1,
            initial_budget       : 0x2::coin::value<T0>(&arg0),
            expires_epoch        : arg2,
            is_dynamic           : arg3,
        };
        0x2::event::emit<BuyerHashpowerOrderPlaced>(v2);
        0x2::transfer::share_object<BuyerHashpowerOrder<T0>>(v1);
    }
    ...
    public fun place_hashpower_order<T0>(arg0: &Template, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: bool, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.owner == v0, 13906837580254609442);
        assert!(arg2 > 0, 13906837584549838886);
    ...
    public fun register_derived_template_public(arg0: &Template, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: address, arg4: vector<u8>, arg5: vector<u8>, arg6: u32, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= 10000000, 13906837249541472280);
        ...
        assert!(arg6 >= v1 && arg6 <= v0 + 7200, 13906837305376309276);
        assert!(arg4 == arg0.coinbase1, 13906837331145981978);
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::verify_derived_coinbase(&arg0.coinbase2, &arg5);
    ...
    fun register_template_inner(arg0: &mut Pool, arg1: &0x2::clock::Clock, arg2: u64, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<vector<u8>>, arg7: u32, arg8: u32, arg9: u32, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<vector<u8>>(&arg6) <= 64, 13906836038361743400);
    ...
    public fun register_template_public(arg0: &mut Pool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: u64, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<vector<u8>>, arg8: u32, arg9: u32, arg10: u32, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= 10000000, 13906835849382133784);
    ...
    public fun set_difficulty(arg0: &mut Pool, arg1: &PoolAdminCap, arg2: u64) {
        assert!(arg2 >= 1000000 && arg2 <= 1000000000000000, 13906842278947258378);
        arg0.global_min_difficulty = arg2;
    }

    public fun submit_share(arg0: &Template, arg1: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerStats, arg2: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerRoundStats, arg3: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::ShareDedup, arg4: vector<u8>, arg5: vector<u8>, arg6: u32, arg7: u32, arg8: u32, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : ShareReceipt {
        let v0 = 0x2::tx_context::sender(arg10);
        let v1 = 0x2::clock::timestamp_ms(arg9);
        assert!(0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::miner_address(arg1) == v0, 13906841123601580050);
        assert!(0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::miner(arg3) == v0, 13906841127896547346);
        assert!(0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::round_id(arg3) == arg0.round_id, 13906841132191383568);
        assert!((arg8 ^ arg0.version) & (4294967295 ^ 536862720) == 0, 13906841145076023308);
        let v2 = arg0.ntime;
        let v3 = if (v2 > 7200) {
            v2 - 7200
        } else {
        ...
        assert!(arg6 >= v3 && arg6 <= v2 + 7200, 13906841162256023566);
        let v4 = b"";
        ...
        let v5 = 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::sha256d(v4);
        let v6 = 0;
        while (v6 < 0x1::vector::length<vector<u8>>(&arg0.merkle_branches)) {
            ...
            v5 = 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::sha256d(v7);
            v6 = v6 + 1;
        };
        let v8 = b"";
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::append_u32_le(&mut v8, arg8);
        0x1::vector::append<u8>(&mut v8, arg0.prev_block_hash);
        0x1::vector::append<u8>(&mut v8, v5);
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::append_u32_le(&mut v8, arg6);
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::append_u32_le(&mut v8, arg0.nbits);
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::append_u32_le(&mut v8, arg7);
        let v9 = 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::sha256d(v8);
        let v10 = difficulty_from_hash(&v9);
        assert!(v10 >= arg0.min_difficulty, 13906841325464387592);
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::check_and_record(arg3, v9);
        let v11 = v10 >= arg0.cached_network_difficulty;
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::record_share(arg1, arg2, v10, v11, arg0.round_id, arg0.height);
    ...
    public fun submit_share_for_buyer_pay<T0>(arg0: &Template, arg1: &mut BuyerHashpowerOrder<T0>, arg2: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerStats, arg3: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerRoundStats, arg4: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::ShareDedup, arg5: vector<u8>, arg6: vector<u8>, arg7: u32, arg8: u32, arg9: u32, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg0.owner == arg1.buyer, 13906840333329432622);
        check_buyer_order_not_expired<T0>(arg1, arg11);
        ...
        let v6 = drain_buyer_order_budget<T0>(arg1, v5, arg11);
        let v7 = BuyerHashpowerShareFilled{
            order_id            : 0x2::object::id<BuyerHashpowerOrder<T0>>(arg1),
            miner               : v0,
            template_id         : 0x2::object::id<Template>(arg0),
        ...
        0x2::event::emit<BuyerHashpowerShareFilled>(v7);
        maybe_freeze_block_claim(v3, arg0.round_id, arg0.height, v0, v1, v4, arg11);
        v6
    }

    public fun submit_share_for_buyer_pay_derived<T0>(arg0: &DerivedTemplate, arg1: &Template, arg2: &mut BuyerHashpowerOrder<T0>, arg3: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerStats, arg4: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerRoundStats, arg5: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::ShareDedup, arg6: vector<u8>, arg7: vector<u8>, arg8: u32, arg9: u32, arg10: u32, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg0.parent_template_id == 0x2::object::id<Template>(arg1), 13906840616796225566);
        assert!(arg1.owner == arg2.buyer, 13906840625387208750);
        check_buyer_order_not_expired<T0>(arg2, arg12);
        let (v0, v1, v2, v3, v4) = validate_share_against_derived(arg0, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12);
        let v5 = compute_payout(v2, arg2.price_per_difficulty);
        let v6 = drain_buyer_order_budget<T0>(arg2, v5, arg12);
        let v7 = BuyerHashpowerShareFilled{
            order_id            : 0x2::object::id<BuyerHashpowerOrder<T0>>(arg2),
            miner               : v0,
        ...
        0x2::event::emit<BuyerHashpowerShareFilled>(v7);
        maybe_freeze_block_claim(v3, 0, arg0.height, v0, v1, v4, arg12);
        v6
    }

    public fun submit_share_for_pay<T0>(arg0: &Template, arg1: &mut HashpowerBuyOrder<T0>, arg2: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerStats, arg3: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerRoundStats, arg4: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::ShareDedup, arg5: vector<u8>, arg6: vector<u8>, arg7: u32, arg8: u32, arg9: u32, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::object::id<Template>(arg0) == arg1.template_id, 13906838065585651742);
    ...
    public fun submit_share_for_pay_derived<T0>(arg0: &DerivedTemplate, arg1: &mut HashpowerBuyOrder<T0>, arg2: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerStats, arg3: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerRoundStats, arg4: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::ShareDedup, arg5: vector<u8>, arg6: vector<u8>, arg7: u32, arg8: u32, arg9: u32, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg0.parent_template_id == arg1.template_id, 13906838349053493278);
        check_order_not_expired<T0>(arg1, arg11);
    ...
    public fun top_up_buyer_order<T0>(arg0: &mut BuyerHashpowerOrder<T0>, arg1: 0x2::coin::Coin<T0>) {
        0x2::balance::join<T0>(&mut arg0.budget, 0x2::coin::into_balance<T0>(arg1));
        let v0 = BuyerHashpowerOrderToppedUp{
            order_id   : 0x2::object::id<BuyerHashpowerOrder<T0>>(arg0),
            added      : 0x2::coin::value<T0>(&arg1),
            new_budget : 0x2::balance::value<T0>(&arg0.budget),
        };
        0x2::event::emit<BuyerHashpowerOrderToppedUp>(v0);
    }
    ...
    public fun update_buyer_order_price<T0>(arg0: &mut BuyerHashpowerOrder<T0>, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.buyer == 0x2::tx_context::sender(arg2), 13906840019796033570);
        assert!(arg0.is_dynamic, 13906840024091525162);
        assert!(arg1 > 0, 13906840028386230310);
        arg0.price_per_difficulty = arg1;
        let v0 = BuyerHashpowerOrderPriceUpdated{
            order_id  : 0x2::object::id<BuyerHashpowerOrder<T0>>(arg0),
            old_price : arg0.price_per_difficulty,
            new_price : arg1,
        };
        0x2::event::emit<BuyerHashpowerOrderPriceUpdated>(v0);
    }

    public fun update_hashpower_order_price<T0>(arg0: &mut HashpowerBuyOrder<T0>, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.buyer == 0x2::tx_context::sender(arg2), 13906837730578464802);
        assert!(arg0.is_dynamic, 13906837734873956394);
        assert!(arg1 > 0, 13906837739168661542);
        arg0.price_per_difficulty = arg1;
    ...
    public fun update_mpc_config(arg0: &mut ProtocolMPCConfig, arg1: &PoolAdminCap, arg2: vector<u8>) {
        ...
        assert!(v0 >= 22 && v0 <= 42, 13906836510808408108);
    ...
    fun validate_share_against_derived(arg0: &DerivedTemplate, arg1: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerStats, arg2: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerRoundStats, arg3: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::ShareDedup, arg4: vector<u8>, arg5: vector<u8>, arg6: u32, arg7: u32, arg8: u32, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (address, vector<u8>, u64, bool, u64) {
        let v0 = 0x2::tx_context::sender(arg10);
        assert!(0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::miner_address(arg1) == v0, 13906839104966950930);
        assert!(0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::miner(arg3) == v0, 13906839109261918226);
        assert!(0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::round_id(arg3) == arg0.round_id, 13906839113556754448);
        assert!((arg8 ^ arg0.version) & (4294967295 ^ 536862720) == 0, 13906839122146426892);
        let v1 = arg0.ntime;
        let v2 = if (v1 > 7200) {
            v1 - 7200
        } else {
        ...
        assert!(arg6 >= v2 && arg6 <= v1 + 7200, 13906839139326427150);
        let v3 = b"";
        ...
        let v4 = 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::sha256d(v3);
        let v5 = 0;
        while (v5 < 0x1::vector::length<vector<u8>>(&arg0.merkle_branches)) {
            ...
            v4 = 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::sha256d(v6);
            v5 = v5 + 1;
        };
        let v7 = b"";
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::append_u32_le(&mut v7, arg8);
        0x1::vector::append<u8>(&mut v7, arg0.prev_block_hash);
        0x1::vector::append<u8>(&mut v7, v4);
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::append_u32_le(&mut v7, arg6);
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::append_u32_le(&mut v7, arg0.nbits);
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::append_u32_le(&mut v7, arg7);
        let v8 = 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::sha256d(v7);
        let v9 = difficulty_from_hash(&v8);
        assert!(v9 >= arg0.min_difficulty, 13906839276764987400);
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::check_and_record(arg3, v8);
        let v10 = v9 >= arg0.cached_network_difficulty;
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::record_share(arg1, arg2, v9, v10, 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::mrs_round_id(arg2), arg0.height);
        (v0, v8, v9, v10, 0x2::clock::timestamp_ms(arg9))
    }

    fun validate_share_against_template(arg0: &Template, arg1: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerStats, arg2: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::MinerRoundStats, arg3: &mut 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::ShareDedup, arg4: vector<u8>, arg5: vector<u8>, arg6: u32, arg7: u32, arg8: u32, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (address, vector<u8>, u64, bool, u64) {
        let v0 = 0x2::tx_context::sender(arg10);
        assert!(0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::miner_address(arg1) == v0, 13906838800024272914);
        assert!(0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::miner(arg3) == v0, 13906838804319240210);
        assert!(0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::round_id(arg3) == arg0.round_id, 13906838808614076432);
        assert!((arg8 ^ arg0.version) & (4294967295 ^ 536862720) == 0, 13906838817203748876);
        let v1 = arg0.ntime;
        let v2 = if (v1 > 7200) {
            v1 - 7200
        } else {
        ...
        assert!(arg6 >= v2 && arg6 <= v1 + 7200, 13906838834383749134);
        let v3 = b"";
        0x1::vector::append<u8>(&mut v3, arg0.coinbase1);
        0x1::vector::append<u8>(&mut v3, arg4);
        0x1::vector::append<u8>(&mut v3, arg5);
        ...
        let v8 = 0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::btc_math::sha256d(v7);
        let v9 = difficulty_from_hash(&v8);
        assert!(v9 >= arg0.min_difficulty, 13906838971822309384);
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::share_dedup::check_and_record(arg3, v8);
        let v10 = v9 >= arg0.cached_network_difficulty;
        0x640abaf8a19cc75d0118046e3c1a2528c2017adf9823e6ca505c5dd31a588b77::miner::record_share(arg1, arg2, v9, v10, arg0.round_id, arg0.height);
        (v0, v8, v9, v10, 0x2::clock::timestamp_ms(arg9))
    }
