module 0x645a7ae940e8156db63ecb0059276da7fa614d12045944add4047e28ca81f367::req_helpers {
    ...
    public(friend) fun msgFromReqSigningMessage(arg0: vector<u8>) : vector<u8> {
        ...
        if (*v1 == 1) {
            ...
            0x1::vector::push_back<vector<u8>>(v5, 0x645a7ae940e8156db63ecb0059276da7fa614d12045944add4047e28ca81f367::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v3) + 29 + 66));
            ...
            0x1::vector::push_back<vector<u8>>(v8, 0x645a7ae940e8156db63ecb0059276da7fa614d12045944add4047e28ca81f367::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v6) + 31 + 66));
            ...
            0x1::vector::push_back<vector<u8>>(v11, 0x645a7ae940e8156db63ecb0059276da7fa614d12045944add4047e28ca81f367::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v9) + 29 + 66));
