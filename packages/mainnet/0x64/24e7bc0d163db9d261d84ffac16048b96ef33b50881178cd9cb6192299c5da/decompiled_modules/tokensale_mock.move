module 0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::tokensale_mock {
    ...
    public fun get_allocation<T0, T1>(arg0: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::tier_system_manual_mock::TierSystem, arg1: &IDO<T0, T1>, arg2: address) : u64 {
        0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::tier_system_manual_mock::get_allocation(arg0, 0x2::object::uid_to_address(&arg1.id), arg2)
    }
    ...
    public fun allowed(arg0: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::kyc_registry_mock::KYCRegistry, arg1: address) : bool {
        0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::kyc_registry_mock::get_status(arg0, arg1)
    }
    ...
    public entry fun create_ido<T0, T1>(arg0: &Admin, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: address, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 >= arg1, 1);
        assert!(arg3 <= 1000, 28);
        let v0 = IDO<T0, T1>{
            ...
            round_end_time           : 0,
            vesting_start            : 0,
            contributors             : 0x2::table::new<address, Contribution>(arg9),
            ...
            time_lock_seconds        : arg6,
            refundable_time          : 0,
            refundable_bool          : false,
            withdraw_address         : arg7,
            is_paused                : arg8,
        };
    ...
    public entry fun finish_ido_max_cap<T0, T1>(arg0: &Admin, arg1: &mut IDO<T0, T1>, arg2: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::tier_system_manual_mock::TierSystem, arg3: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::kyc_registry_mock::KYCRegistry, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun finish_ido_min_cap<T0, T1>(arg0: &Admin, arg1: &mut IDO<T0, T1>, arg2: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::tier_system_manual_mock::TierSystem, arg3: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::kyc_registry_mock::KYCRegistry, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun first_round_participate<T0, T1>(arg0: &mut IDO<T0, T1>, arg1: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::tier_system_manual_mock::TierSystem, arg2: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::kyc_registry_mock::KYCRegistry, arg3: u64, arg4: 0x2::coin::Coin<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_available_participate_amount<T0, T1>(arg0: &IDO<T0, T1>, arg1: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::tier_system_manual_mock::TierSystem, arg2: address) : u64 {
    ...
    fun participate_checks<T0, T1>(arg0: &mut IDO<T0, T1>, arg1: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::tier_system_manual_mock::TierSystem, arg2: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::kyc_registry_mock::KYCRegistry, arg3: address, arg4: u64, arg5: &0x2::clock::Clock) {
    ...
    fun participate_ido<T0, T1>(arg0: &mut IDO<T0, T1>, arg1: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::tier_system_manual_mock::TierSystem, arg2: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::kyc_registry_mock::KYCRegistry, arg3: u64, arg4: 0x2::coin::Coin<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun release<T0, T1>(arg0: &mut IDO<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<address, Contribution>(&arg0.contributors, v0), 30);
    ...
    public entry fun second_round_participate<T0, T1>(arg0: &mut IDO<T0, T1>, arg1: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::tier_system_manual_mock::TierSystem, arg2: &0x6424e7bc0d163db9d261d84ffac16048b96ef33b50881178cd9cb6192299c5da::kyc_registry_mock::KYCRegistry, arg3: u64, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.round == 2, 4);
        if (0x2::clock::timestamp_ms(arg6) >= arg3) {
            handle_remaining_coin<T1>(arg5, 0x2::tx_context::sender(arg7));
            return
        };
        if (recover_signer()) {
            handle_remaining_coin<T1>(arg5, 0x2::tx_context::sender(arg7));
        ...
        participate_ido<T0, T1>(arg0, arg1, arg2, arg4, arg5, arg6, arg7);
    }
    ...
    public entry fun set_round<T0, T1>(arg0: &Admin, arg1: &mut IDO<T0, T1>, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0x2::clock::timestamp_ms(arg5), 29);
        assert!(arg3 >= arg2, 0);
    ...
    public entry fun start_vesting<T0, T1>(arg0: &Admin, arg1: &mut IDO<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock) {
        ...
        assert!(arg2 >= v0, 23);
        assert!(arg2 <= v0 + 86400000, 24);
        assert!(arg1.vesting_time == 0, 25);
    ...
    fun vesting_schedule<T0, T1>(arg0: &IDO<T0, T1>, arg1: u64, arg2: u64) : u64 {
        ...
        v0 + v1 * (arg2 - arg0.vesting_start) / arg0.vesting_duration_seconds
    }
