module 0x64dbc3f02b282fbd9fc33ca1cdf19e8d204c63af00453a3dbb8e4ab7fe464051::portfolio {
    ...
    public entry fun create_portfolio(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) : Portfolio {
        Portfolio{
    ...
    fun init(arg0: PORTFOLIO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Proof of Learning Portfolio project proudly built and published with informed consent during a Move Smart Contracts Code Camp by DEVCON Philippines & Sui Foundation."));
