module 0x64794ea1249ee123dae3c273578a4766caa368f7d2275eccc8d8f262eef53b77::cnsnft2750 {
    struct CNSNFT2750 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2750, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2750>(arg0, arg1);
