module 0x648bb5d9e9c4009aa6c1ccab3bac6a320ffc5179b80295f68fa7db456155d641::smvr {
    ...
    entry fun mint_and_stake(arg0: &mut Registry, arg1: &mut 0x648bb5d9e9c4009aa6c1ccab3bac6a320ffc5179b80295f68fa7db456155d641::pool::Pool, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg2) / 100;
        assert!(v0 <= 666666666666666666 - 0x2::coin::total_supply<SMVR>(&arg0.treasury_cap), 0);
        0x648bb5d9e9c4009aa6c1ccab3bac6a320ffc5179b80295f68fa7db456155d641::pool::stake<SMVR>(arg1, 0x2::coin::mint<SMVR>(&mut arg0.treasury_cap, v0, arg4), arg3, arg4);
