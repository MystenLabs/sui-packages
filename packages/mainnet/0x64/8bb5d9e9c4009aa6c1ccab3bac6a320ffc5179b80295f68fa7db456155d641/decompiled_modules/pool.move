module 0x648bb5d9e9c4009aa6c1ccab3bac6a320ffc5179b80295f68fa7db456155d641::pool {
    ...
    public fun unstake<T0>(arg0: &mut Pool, arg1: 0x1::option::Option<u64>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        if (0x1::vector::length<DeactivatingShares>(&v3.deactivating_shares) == 0 && v3.total_shares == 0 && v3.active_shares == 0) {
            let LpUserShare {
                user                       : _,
                stake_ts_ms                : _,
                total_shares               : _,
                active_shares              : _,
                deactivating_shares        : v18,
                last_incentive_price_index : _,
            } = v3;
            0x1::vector::destroy_empty<DeactivatingShares>(v18);
        } else {
            let v20 = &mut arg0.id;
            store_user_shares(v20, v3.user, v3);
        };
