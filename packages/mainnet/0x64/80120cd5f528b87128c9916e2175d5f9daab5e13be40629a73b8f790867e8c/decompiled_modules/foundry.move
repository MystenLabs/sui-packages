module 0x6480120cd5f528b87128c9916e2175d5f9daab5e13be40629a73b8f790867e8c::foundry {
    ...
    struct TurretMinted has copy, drop {
        buyer: address,
    ...
    public fun admin_mint(arg0: &AdminCap, arg1: &mut Config, arg2: u8, arg3: u8, arg4: u8, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x6480120cd5f528b87128c9916e2175d5f9daab5e13be40629a73b8f790867e8c::turret::Turret>(build(arg1, arg2, arg3, arg4, arg1.minted, arg6), arg5);
    }

    fun build(arg0: &Config, arg1: u8, arg2: u8, arg3: u8, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x6480120cd5f528b87128c9916e2175d5f9daab5e13be40629a73b8f790867e8c::turret::Turret {
        let v0 = 0x1::string::utf8(b"Turret #");
        0x1::string::append(&mut v0, 0x1::u64::to_string(arg4));
        let v1 = arg0.media_base;
        0x1::string::append(&mut v1, 0x1::string::utf8(b"turret.png"));
        let v2 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"POWER"), 0x1::u64::to_string((arg1 as u64)));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"RANGE"), 0x1::u64::to_string((arg2 as u64)));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"ARMOUR"), 0x1::u64::to_string((arg3 as u64)));
        0x6480120cd5f528b87128c9916e2175d5f9daab5e13be40629a73b8f790867e8c::turret::mint(arg1, arg2, arg3, arg4, v0, 0x1::string::utf8(b"Fixed guns for a base in the Wastes. Sleeps without a home; wakes angry. Takes the same weapons a bot carries."), v1, v2, arg5)
    }
    ...
    entry fun mint<T0>(arg0: &mut Config, arg1: &0x2::random::Random, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = (0x2::random::generate_u64_in_range(&mut v6, 4, 9) as u8);
        let v8 = (0x2::random::generate_u64_in_range(&mut v6, 4, 9) as u8);
        let v9 = (0x2::random::generate_u64_in_range(&mut v6, 8, 12) as u8);
        ...
        0x2::transfer::public_transfer<0x6480120cd5f528b87128c9916e2175d5f9daab5e13be40629a73b8f790867e8c::turret::Turret>(v11, v0);
        let v12 = TurretMinted{
            buyer     : v0,
            turret_id : 0x2::object::id<0x6480120cd5f528b87128c9916e2175d5f9daab5e13be40629a73b8f790867e8c::turret::Turret>(&v11),
            power     : v7,
            range     : v8,
            armour    : v9,
            serial    : v10,
        ...
        0x2::event::emit<TurretMinted>(v12);
    }
