module 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::round_manager {
    ...
    struct AutoExtKey has copy, drop, store {
        dummy_field: bool,
    }

    struct AutoTier has copy, drop, store {
        odds_max: u64,
        per_round_mist: u64,
    }

    struct AutoExt has copy, drop, store {
        tiers: vector<AutoTier>,
        compound: bool,
    }
    ...
    struct AutoExtConfigured has copy, drop {
        owner: address,
        tier_odds_max: vector<u64>,
        tier_stakes: vector<u64>,
        compound: bool,
    }

    struct AutoCompounded has copy, drop {
        owner: address,
        amount: u64,
        new_balance: u64,
    }
    ...
    fun assert_version_v2(arg0: &GlobalV2) {
        assert!(arg0.version == 11, 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_INVALID_VERSION());
    }

    entry fun auto_compound_entry_v2(arg0: &mut GlobalV2, arg1: vector<address>, arg2: &mut 0x2::tx_context::TxContext) {
        assert_version_v2(arg0);
        if (arg0.paused) {
            return
        };
        let v0 = AutoExtKey{dummy_field: false};
        let v1 = if (!0x2::dynamic_field::exists_<AutoExtKey>(&arg0.id, v0)) {
            true
        } else {
            let v2 = AutoRegistryKey{dummy_field: false};
            !0x2::dynamic_field::exists_<AutoRegistryKey>(&arg0.id, v2)
        };
        if (v1) {
            return
        };
        ...
        while (v3 < 0x1::vector::length<address>(&arg1)) {
            ...
            v3 = v3 + 1;
            let v5 = AutoExtKey{dummy_field: false};
            let v6 = 0x2::dynamic_field::borrow<AutoExtKey, 0x2::table::Table<address, AutoExt>>(&arg0.id, v5);
            let v7 = if (0x2::table::contains<address, AutoExt>(v6, v4) && 0x2::table::borrow<address, AutoExt>(v6, v4).compound) {
                let v8 = AutoRegistryKey{dummy_field: false};
                0x2::table::contains<address, AutoConfig>(&0x2::dynamic_field::borrow<AutoRegistryKey, AutoRegistry>(&arg0.id, v8).configs, v4)
            } else {
                false
            };
            if (!v7) {
            ...
            let v9 = 0;
            if (0x2::table::contains<address, PlayerRecord>(&arg0.player_records, v4)) {
                let v10 = 0x2::table::borrow_mut<address, PlayerRecord>(&mut arg0.player_records, v4);
                v9 = v10.unclaimed_sui;
                v10.unclaimed_sui = 0;
            };
            if (v9 == 0) {
                continue
            };
            let v11 = AutoRegistryKey{dummy_field: false};
            let v12 = 0x2::table::borrow_mut<address, AutoConfig>(&mut 0x2::dynamic_field::borrow_mut<AutoRegistryKey, AutoRegistry>(&mut arg0.id, v11).configs, v4);
            0x2::balance::join<0x2::sui::SUI>(&mut v12.balance, 0x2::coin::into_balance<0x2::sui::SUI>(0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::treasury::withdraw_faithgg_internal(&mut arg0.vaults, v9, arg2)));
            let v13 = AutoCompounded{
                owner       : v4,
                amount      : v9,
                new_balance : 0x2::balance::value<0x2::sui::SUI>(&v12.balance),
            };
            0x2::event::emit<AutoCompounded>(v13);
        };
    }
    ...
    entry fun auto_configure_ext_entry_v2(arg0: &mut GlobalV2, arg1: vector<u64>, arg2: vector<u64>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        assert_version_v2(arg0);
        let v0 = 0x1::vector::length<u64>(&arg1);
        assert!(v0 == 0x1::vector::length<u64>(&arg2), 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_INVALID_ARGS());
        assert!(v0 <= 8, 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_INVALID_ARGS());
        let v1 = 0x2::tx_context::sender(arg4);
        let v2 = ensure_auto_registry(arg0, arg4);
        assert!(0x2::table::contains<address, AutoConfig>(&v2.configs, v1), 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_NOTHING_TO_CLAIM());
        let v3 = 0x2::table::borrow<address, AutoConfig>(&v2.configs, v1);
        let v4 = 0x1::vector::empty<AutoTier>();
        let v5 = 0;
        while (v5 < v0) {
            let v6 = *0x1::vector::borrow<u64>(&arg1, v5);
            let v7 = *0x1::vector::borrow<u64>(&arg2, v5);
            assert!(v6 > 0, 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_INVALID_ARGS());
            assert!(v7 >= 10000000 * auto_portion_count(v3.strategy, &v3.blocks), 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_INVALID_ARGS());
            let v8 = AutoTier{
                odds_max       : v6,
                per_round_mist : v7,
            };
            0x1::vector::push_back<AutoTier>(&mut v4, v8);
            v5 = v5 + 1;
        };
        let v9 = ensure_auto_ext_table(arg0, arg4);
        if (0x2::table::contains<address, AutoExt>(v9, v1)) {
            let v10 = 0x2::table::borrow_mut<address, AutoExt>(v9, v1);
            v10.tiers = v4;
            v10.compound = arg3;
        } else {
            let v11 = AutoExt{
            ...
            0x2::table::add<address, AutoExt>(v9, v1, v11);
        };
        let v12 = AutoExtConfigured{
            owner         : v1,
            tier_odds_max : arg1,
            tier_stakes   : arg2,
            compound      : arg3,
        };
        0x2::event::emit<AutoExtConfigured>(v12);
    }
    ...
    public fun auto_ext_view_v2(arg0: &GlobalV2, arg1: address) : (bool, vector<u64>, vector<u64>, bool) {
        let v0 = AutoExtKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<AutoExtKey>(&arg0.id, v0)) {
            return (false, vector[], vector[], false)
        };
        let v1 = AutoExtKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow<AutoExtKey, 0x2::table::Table<address, AutoExt>>(&arg0.id, v1);
        if (!0x2::table::contains<address, AutoExt>(v2, arg1)) {
            return (false, vector[], vector[], false)
        };
        let v3 = 0x2::table::borrow<address, AutoExt>(v2, arg1);
        let v4 = vector[];
        let v5 = vector[];
        let v6 = &v3.tiers;
        let v7 = 0;
        while (v7 < 0x1::vector::length<AutoTier>(v6)) {
            let v8 = 0x1::vector::borrow<AutoTier>(v6, v7);
            0x1::vector::push_back<u64>(&mut v4, v8.odds_max);
            0x1::vector::push_back<u64>(&mut v5, v8.per_round_mist);
            v7 = v7 + 1;
        };
        (true, v4, v5, v3.compound)
    }
    ...
    fun auto_tier_stake(arg0: &AutoExt, arg1: u64) : u64 {
        let v0 = 0;
        while (v0 < 0x1::vector::length<AutoTier>(&arg0.tiers)) {
            if (arg1 <= 0x1::vector::borrow<AutoTier>(&arg0.tiers, v0).odds_max) {
                return 0x1::vector::borrow<AutoTier>(&arg0.tiers, v0).per_round_mist
            };
            v0 = v0 + 1;
        };
        0
    ...
    entry fun crank_auto_entries_v2(arg0: &mut GlobalV2, arg1: &0x2::random::Random, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = vector[];
        let v5 = AutoRegistryKey{dummy_field: false};
        let v6 = 0x2::dynamic_field::borrow<AutoRegistryKey, AutoRegistry>(&arg0.id, v5);
        let v7 = 0x1::vector::length<address>(&v6.index);
        let v8 = if (arg2 >= v7) {
            arg2
        } else if (arg3 >= v7 - arg2) {
            v7
        } else {
            arg2 + arg3
        };
        while (arg2 < v8) {
            0x1::vector::push_back<address>(&mut v4, *0x1::vector::borrow<address>(&v6.index, arg2));
            arg2 = arg2 + 1;
        };
        let v9 = vector[];
        let v10 = AutoExtKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<AutoExtKey>(&arg0.id, v10)) {
            let v11 = AutoExtKey{dummy_field: false};
            let v12 = 0x2::dynamic_field::borrow<AutoExtKey, 0x2::table::Table<address, AutoExt>>(&arg0.id, v11);
            let v13 = &v4;
            let v14 = 0;
            while (v14 < 0x1::vector::length<address>(v13)) {
                let v15 = 0x1::vector::borrow<address>(v13, v14);
                if (0x2::table::contains<address, AutoExt>(v12, *v15)) {
                    0x1::vector::push_back<u64>(&mut v9, auto_tier_stake(0x2::table::borrow<address, AutoExt>(v12, *v15), 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::miracle::current_odds(&arg0.miracle)));
                } else {
            ...
            let v16 = &v4;
            let v17 = 0;
            while (v17 < 0x1::vector::length<address>(v16)) {
                0x1::vector::borrow<address>(v16, v17);
                0x1::vector::push_back<u64>(&mut v9, 0);
                v17 = v17 + 1;
            };
        };
        let v18 = 0x1::vector::empty<PlannedAutoEntry>();
        let v19 = 0x2::balance::zero<0x2::sui::SUI>();
        let v20 = 0x2::balance::zero<0x2::sui::SUI>();
        let v21 = 0;
        let v22 = 0;
        let v23 = AutoRegistryKey{dummy_field: false};
        let v24 = 0x2::dynamic_field::borrow_mut<AutoRegistryKey, AutoRegistry>(&mut arg0.id, v23);
        let v25 = 0;
        while (v25 < 0x1::vector::length<address>(&v4)) {
            let v26 = *0x1::vector::borrow<address>(&v4, v25);
            let v27 = *0x1::vector::borrow<u64>(&v9, v25);
            v25 = v25 + 1;
            let v28 = 0x2::table::borrow_mut<address, AutoConfig>(&mut v24.configs, v26);
            let v29 = 0x2::balance::value<0x2::sui::SUI>(&v28.balance);
            let v30 = if (v27 > 0) {
                v27
            } else {
                v28.per_round_mist
            };
            let v31 = if (v28.rounds_remaining == 0) {
                true
            } else if (v28.last_entered_round == v2) {
                true
            } else if (v30 == 0) {
                true
            } else if (v29 < v30) {
                ...
                v29 < v28.min_balance_stop
            };
            if (v31) {
                v22 = v22 + 1;
                continue
            };
            let v32 = (((v30 as u256) * (v24.auto_fee_bps as u256) / 10000) as u64);
            let v33 = v30 - v32;
            let v34 = v33 / auto_portion_count(v28.strategy, &v28.blocks);
            if (v34 < 10000000) {
                v22 = v22 + 1;
                continue
            };
            if (v28.strategy == 1) {
                let v35 = PlannedAutoEntry{
                    owner    : v26,
                    block_id : 0x2::random::generate_u64(&mut v3) % 25,
                    amount   : v33,
                };
                0x1::vector::push_back<PlannedAutoEntry>(&mut v18, v35);
            } else if (v28.strategy == 0) {
                let v36 = 0x1::vector::length<u64>(&v28.blocks);
                let v37 = 0;
                while (v37 < v36) {
                    let v38 = if (v37 == v36 - 1) {
                        v33 - v34 * (v36 - 1)
                    } else {
                        v34
                    };
                    let v39 = PlannedAutoEntry{
                        owner    : v26,
                        block_id : *0x1::vector::borrow<u64>(&v28.blocks, v37),
                        amount   : v38,
                    };
                    0x1::vector::push_back<PlannedAutoEntry>(&mut v18, v39);
                    v37 = v37 + 1;
                };
            } else {
                let v40 = 0;
                while (v40 < 25) {
                    ...
                    let v42 = PlannedAutoEntry{
                        owner    : v26,
                        block_id : v40,
                        amount   : v41,
                    };
                    0x1::vector::push_back<PlannedAutoEntry>(&mut v18, v42);
                    v40 = v40 + 1;
                };
            };
            if (v32 > 0) {
                0x2::balance::join<0x2::sui::SUI>(&mut v20, 0x2::balance::split<0x2::sui::SUI>(&mut v28.balance, v32));
            };
            0x2::balance::join<0x2::sui::SUI>(&mut v19, 0x2::balance::split<0x2::sui::SUI>(&mut v28.balance, v33));
            v28.last_entered_round = v2;
            v28.rounds_remaining = v28.rounds_remaining - 1;
            v21 = v21 + 1;
        };
        let v43 = 0x2::balance::value<0x2::sui::SUI>(&v20);
        0x1::vector::reverse<PlannedAutoEntry>(&mut v18);
        let v44 = 0;
        while (v44 < 0x1::vector::length<PlannedAutoEntry>(&v18)) {
            let v45 = 0x1::vector::pop_back<PlannedAutoEntry>(&mut v18);
            enter_for(arg0, v45.owner, v45.block_id, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v19, v45.amount), arg4));
            v44 = v44 + 1;
        };
        0x1::vector::destroy_empty<PlannedAutoEntry>(v18);
        0x2::balance::destroy_zero<0x2::sui::SUI>(v19);
        if (v43 > 0) {
            0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::treasury::deposit_to_ops_internal(&mut arg0.vaults, 0x2::coin::from_balance<0x2::sui::SUI>(v20, arg4));
        } else {
        ...
        let v46 = AutoCranked{
            ...
            entered_configs   : v21,
            skipped_configs   : v22,
            total_stake_atoms : 0x2::balance::value<0x2::sui::SUI>(&v19),
            fee_atoms         : v43,
        };
        0x2::event::emit<AutoCranked>(v46);
    }
    ...
    fun ensure_auto_ext_table(arg0: &mut GlobalV2, arg1: &mut 0x2::tx_context::TxContext) : &mut 0x2::table::Table<address, AutoExt> {
        let v0 = AutoExtKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<AutoExtKey>(&arg0.id, v0)) {
            let v1 = AutoExtKey{dummy_field: false};
            0x2::dynamic_field::add<AutoExtKey, 0x2::table::Table<address, AutoExt>>(&mut arg0.id, v1, 0x2::table::new<address, AutoExt>(arg1));
        };
        let v2 = AutoExtKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<AutoExtKey, 0x2::table::Table<address, AutoExt>>(&mut arg0.id, v2)
    }
