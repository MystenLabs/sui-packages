module 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::miracle {
    ...
    public(friend) fun accrue_internal(arg0: &mut Miracle) {
    ...
    fun bump_odds_after_miss(arg0: &mut Miracle) {
        ...
        arg0.current_odds = 0x1::u64::max(arg0.current_odds * 99 / 100, 1);
    }
    ...
    public(friend) fun current_odds(arg0: &Miracle) : u64 {
        arg0.current_odds
    }
    ...
    public(friend) fun maybe_trigger_internal(arg0: &mut Miracle, arg1: u64) : (bool, u64, u64, u64, u64) {
    ...
    public fun t_create(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Miracle {
