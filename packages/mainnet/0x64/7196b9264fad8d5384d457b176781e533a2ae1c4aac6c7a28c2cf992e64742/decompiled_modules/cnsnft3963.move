module 0x647196b9264fad8d5384d457b176781e533a2ae1c4aac6c7a28c2cf992e64742::cnsnft3963 {
    struct CNSNFT3963 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3963, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://nsclaim1123img-0602.vercel.app/api/{id}"));
        ...
        let v4 = 0x2::package::claim<CNSNFT3963>(arg0, arg1);
