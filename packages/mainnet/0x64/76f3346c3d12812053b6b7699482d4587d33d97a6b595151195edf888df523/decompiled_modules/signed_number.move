module 0x6476f3346c3d12812053b6b7699482d4587d33d97a6b595151195edf888df523::signed_number {
    ...
    public fun div_uint(arg0: Number, arg1: u64) : Number {
        let v0 = 0x6476f3346c3d12812053b6b7699482d4587d33d97a6b595151195edf888df523::utils::base_div(arg0.value, arg1);
    ...
    public fun mul_uint(arg0: Number, arg1: u64) : Number {
        let v0 = 0x6476f3346c3d12812053b6b7699482d4587d33d97a6b595151195edf888df523::utils::base_mul(arg0.value, arg1);
        let v1 = v0 == 0 || arg0.sign;
        Number{
            value : v0,
            sign  : v1,
    ...
    public fun one() : Number {
        Number{
            value : 0x6476f3346c3d12812053b6b7699482d4587d33d97a6b595151195edf888df523::constants::base_uint(),
            sign  : true,
        }
    }
