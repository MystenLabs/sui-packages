module 0x64a53b246ea8832bdf564abdc7254c40a6843ebfdb4e419cb6c929efb4e9cfa1::cnsnft7519 {
    struct CNSNFT7519 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7519, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2362"));
        let v4 = 0x2::package::claim<CNSNFT7519>(arg0, arg1);
