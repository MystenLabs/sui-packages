module 0x64b4ba4dd8a111ef1ae79aefd7675666f02a15da1c91fef4ea90327f613d8a1a::nft5712 {
    struct NFT5712 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NFT5712, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<NFT5712>(arg0, arg1);
