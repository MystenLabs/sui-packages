module 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::marketplace {
    ...
    struct MarketPlaceStore has key {
        id: 0x2::object::UID,
        points_admin_cap: 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::PointsAdminCap,
    ...
    public fun accept_bid<T0: store + key>(arg0: &0x2::clock::Clock, arg1: &mut MarketPlaceStore, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &mut 0x2::kiosk::Kiosk, arg5: 0x2::object::ID, arg6: 0x2::object::ID, arg7: address, arg8: bool, arg9: &0x2::transfer_policy::TransferPolicy<T0>, arg10: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaIONs, arg11: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaChef, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::linked_table::contains<address, UserInfo>(&arg1.user_activity, v1), 13906841458609946656);
        ...
        assert!(0x2::linked_table::contains<address, UserInfo>(&arg1.user_activity, arg7), 13906841484379881506);
        let v5 = 0x2::linked_table::borrow_mut<address, UserInfo>(&mut arg1.user_activity, arg7);
        let v6 = 0;
        if (arg8) {
            assert!(0x2::linked_table::contains<0x1::ascii::String, vector<BidInfo>>(&v5.collection_bids, v2), 13906841510149160986);
            ...
            assert!(0x2::linked_table::contains<0x2::object::ID, BidInfo>(&v5.bids, arg5), 13906841600343474202);
        ...
        assert!(0x2::linked_table::contains<0x2::object::ID, Listing<T0>>(&v11.listings, arg5), 13906841647587328014);
        let (v12, v13, _, _) = destroy_listing<T0>(0x2::linked_table::remove<0x2::object::ID, Listing<T0>>(&mut v11.listings, arg5));
        assert!(v13 == 0x2::object::id<0x2::kiosk::Kiosk>(arg2), 13906841660473278494);
        ...
        if (arg8) {
            ...
            assert!(0x2::object::uid_to_inner(&v19.id) == arg6, 13906841785028247596);
        ...
        0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::destroy_or_transfer_balance<0x2::sui::SUI>(v16, v1, arg12);
        ...
        let (v26, v27) = if (v11.ion_points_enabled) {
            ...
            let v29 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v20, v28, 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_listing_proximity_multiplier(v20, v11.avg_sale_price), 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_time_multiplier(v0 - v4.last_points_claimed_at, true));
            award_ion_points_with_referral(v1, arg1, arg10, v29, arg0, arg11);
            let v30 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v20, v28, 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_bid_proximity_multiplier(v20, v11.avg_sale_price), 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_time_multiplier(v0 - v6, true));
    ...
    public fun accept_trait_bid<T0: store + key, T1: store + key>(arg0: &mut MarketPlaceStore, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &mut 0x2::tx_context::TxContext) : (T0, T1, TraitBidsPotato) {
        ...
        assert!(0x2::dynamic_object_field::exists_<vector<u8>>(&v2.id, b"trait_bids"), 13906842940373008406);
        assert!(v2.are_trait_bids_enabled, 13906842944669941812);
        ...
        if (0x2::linked_table::contains<0x2::object::ID, Listing<T0>>(&0x2::dynamic_object_field::borrow<0x1::ascii::String, CollectionMarketPlace<T0>>(&arg0.id, v1).listings, arg1)) {
            assert!(0x2::linked_table::contains<address, UserInfo>(&arg0.user_activity, v0), 13906843017683075104);
            let v5 = 0x2::linked_table::borrow_mut<address, UserInfo>(&mut arg0.user_activity, v0);
            assert!(0x2::linked_table::contains<0x2::object::ID, ListingInfo>(&v5.listings, arg1), 13906843026271830030);
            ...
            assert!(0x2::linked_table::contains<0x2::object::ID, Listing<T0>>(&v6.listings, arg1), 13906843047747584028);
            let (v7, v8, _, _) = destroy_listing<T0>(0x2::linked_table::remove<0x2::object::ID, Listing<T0>>(&mut v6.listings, arg1));
            assert!(v8 == 0x2::object::id<0x2::kiosk::Kiosk>(arg2), 13906843069222551582);
            0x2::kiosk::return_purchase_cap<T0>(arg2, v7);
        };
        (0x2::kiosk::take<T0>(arg2, arg3, arg1), v3, v4)
    }

    public fun accept_trait_bid_settle<T0: store + key, T1: store + key>(arg0: &mut MarketPlaceStore, arg1: T1, arg2: TraitBidsPotato, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: ActiveTraitBid, arg6: T0, arg7: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaIONs, arg8: &0x2::clock::Clock, arg9: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaChef, arg10: &mut 0x2::tx_context::TxContext) {
        validation_check(arg0);
        let TraitBidsPotato { id: v0 } = arg2;
        assert!(0x2::object::id<T1>(&arg1) == v0, 13906843339806146600);
        ...
        assert!(0x2::linked_table::contains<address, UserInfo>(&arg0.user_activity, v4), 13906843391345360930);
        let v7 = 0;
        ...
        assert!(v7 != 0, 13906843468655820850);
        ...
        0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(v13, v1, arg10);
        ...
        let (v16, v17) = if (v11.ion_points_enabled) {
            ...
            let v19 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_bid_proximity_multiplier(v5, v11.avg_sale_price);
            let v20 = if (v7 == 0) {
                arg5.bid_at
            } else {
                v7
            };
            (0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v5, v18, v19, 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_time_multiplier(v3 - v20, true)), 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v5, v18, v19, 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_time_multiplier(v3 - v7, true)))
        } else {
            (0, 0)
        };
        if (v17 > 0) {
    ...
    public fun accept_unlisted_bid<T0: store + key>(arg0: &0x2::clock::Clock, arg1: &mut MarketPlaceStore, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: address, arg7: 0x2::object::ID, arg8: bool, arg9: &0x2::transfer_policy::TransferPolicy<T0>, arg10: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaIONs, arg11: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaChef, arg12: &mut 0x2::tx_context::TxContext) {
        validation_check(arg1);
        let v0 = 0x2::tx_context::sender(arg12);
        let v1 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x2::kiosk::has_item_with_type<T0>(arg2, arg5), 13906842270358634526);
        assert!(0x2::linked_table::contains<address, UserInfo>(&arg1.user_activity, arg6), 13906842283243798562);
        let v2 = 0x2::linked_table::borrow_mut<address, UserInfo>(&mut arg1.user_activity, arg6);
        let v3 = 0;
        if (arg8) {
            assert!(0x2::linked_table::contains<0x1::ascii::String, vector<BidInfo>>(&v2.collection_bids, v1), 13906842309013078042);
            ...
            assert!(0x2::linked_table::contains<0x2::object::ID, BidInfo>(&v2.bids, arg5), 13906842399207391258);
        ...
        if (arg8) {
            ...
            assert!(0x2::linked_table::contains<0x2::object::ID, ActiveBids>(&v8.bids, arg5), 13906842545236279322);
            let v12 = 0x2::linked_table::borrow_mut<0x2::object::ID, ActiveBids>(&mut v8.bids, arg5);
            assert!(0x2::linked_table::contains<address, ActiveBid>(&v12.bids, arg6), 13906842553826213914);
        ...
        0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(v9, v0, arg12);
        0x2::kiosk::lock<T0>(arg3, &arg1.escrow_kiosk_cap, arg9, 0x2::kiosk::take<T0>(arg2, arg4, arg5));
        let v15 = PendingClaim{
            buyer    : arg6,
            nft_type : v1,
            price    : v14 - v13,
        };
        if (0x2::linked_table::contains<address, PendingClaims>(&arg1.pending_claims, arg6)) {
            0x2::linked_table::push_back<0x2::object::ID, PendingClaim>(&mut 0x2::linked_table::borrow_mut<address, PendingClaims>(&mut arg1.pending_claims, arg6).pending_claims, arg5, v15);
        } else {
            let v16 = PendingClaims{pending_claims: 0x2::linked_table::new<0x2::object::ID, PendingClaim>(arg12)};
            0x2::linked_table::push_back<0x2::object::ID, PendingClaim>(&mut v16.pending_claims, arg5, v15);
            0x2::linked_table::push_back<address, PendingClaims>(&mut arg1.pending_claims, arg6, v16);
        };
        let (v17, v18) = if (v8.ion_points_enabled) {
            let v19 = if (v8.ion_collection_multiplier == 0) {
                1000
            } else {
                v8.ion_collection_multiplier
            };
            let v20 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_bid_proximity_multiplier(v14, v8.avg_sale_price);
            let v21 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_time_multiplier(0x2::clock::timestamp_ms(arg0) - v3, true);
            let v22 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v14, v19, v20, v21);
            award_ion_points_with_referral(v0, arg1, arg10, v22, arg0, arg11);
            let v23 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v14, v19, v20, v21);
            let v24 = 0x2::linked_table::borrow_mut<address, UserInfo>(&mut arg1.user_activity, arg6);
            v24.claimable_points = v24.claimable_points + v23;
            (v23, v22)
        } else {
            (0, 0)
        };
        let v25 = BidAcceptedEvent{
            ...
            buyer_ion_points  : v17,
            seller_ion_points : v18,
        };
    ...
    public fun add_trait_bidding_support<T0: store + key, T1: store + key>(arg0: &mut MarketPlaceStore, arg1: &TraitBidsAdminCap, arg2: T1, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::linked_table::contains<0x1::ascii::String, bool>(&arg0.active_collections, v0), 13906836832929513494);
        assert!(0x2::dynamic_object_field::exists_<0x1::ascii::String>(&arg0.id, v0), 13906836837224480790);
    ...
    public fun award_bid_ion_points<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: address, arg2: 0x2::object::ID, arg3: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaIONs, arg4: &0x2::clock::Clock, arg5: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaChef) {
        validation_check(arg0);
        let v0 = 0x2::clock::timestamp_ms(arg4);
        assert!(0x2::linked_table::contains<address, UserInfo>(&arg0.user_activity, arg1), 13906844374891429900);
        let v1 = 0x2::linked_table::borrow_mut<address, UserInfo>(&mut arg0.user_activity, arg1);
        assert!(0x2::linked_table::contains<0x2::object::ID, BidInfo>(&v1.bids, arg2), 13906844383482282010);
        ...
        if (v5.ion_points_enabled && v4 > 0) {
            let v6 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_time_multiplier(v4, false);
            if (v6 > 0) {
                ...
                let v8 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v2.bid_price, v7, 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_bid_proximity_multiplier(v2.bid_price, v5.avg_sale_price), v6);
                v2.last_points_claimed_at = v0;
                award_ion_points_with_referral(arg1, arg0, arg3, v8, arg4, arg5);
                if (0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::has_referrer(arg3)) {
                    let v9 = 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::get_referrer(arg3);
    ...
    fun award_ion_points_with_referral(arg0: address, arg1: &mut MarketPlaceStore, arg2: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaIONs, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaChef) {
        let v0 = 0x1::option::none<address>();
        let v1 = 0;
        let v2 = 0;
        if (0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::has_referrer(arg2)) {
            let v3 = 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::get_referrer(arg2);
            if (0x1::option::is_some<address>(&v3)) {
                0x1::option::fill<address>(&mut v0, *0x1::option::borrow<address>(&v3));
                let v4 = 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::math::mul_div_u128((arg3 as u128), (15 as u128), 100);
                v1 = v4;
                v2 = 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::math::mul_div_u128((arg3 as u128), (10 as u128), 100);
        ...
        0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::award_ion_points(&arg1.points_admin_cap, arg4, arg5, arg2, arg3 + v2);
    ...
    public fun award_listing_ion_points<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: address, arg2: 0x2::object::ID, arg3: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaIONs, arg4: &0x2::clock::Clock, arg5: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaChef) {
        validation_check(arg0);
        assert!(0x2::linked_table::contains<address, UserInfo>(&arg0.user_activity, arg1), 13906844160143065100);
        let v0 = 0x2::linked_table::borrow_mut<address, UserInfo>(&mut arg0.user_activity, arg1);
        assert!(0x2::linked_table::contains<0x2::object::ID, ListingInfo>(&v0.listings, arg2), 13906844168733130766);
        ...
        if (v4.ion_points_enabled && v3 > 0) {
            let v5 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_time_multiplier(v3, false);
            if (v5 > 0) {
                ...
                award_ion_points_with_referral(arg1, arg0, arg3, 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v1.price, v6, 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_listing_proximity_multiplier(v1.price, v4.avg_sale_price), v5), arg4, arg5);
            };
        };
    }

    public fun buy<T0: store + key>(arg0: &0x2::clock::Clock, arg1: &mut MarketPlaceStore, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaIONs, arg6: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaChef, arg7: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>, u64) {
        validation_check(arg1);
        ...
        0x1::debug::print<0x1::string::String>(&v3);
        assert!(0x2::linked_table::contains<address, UserInfo>(&arg1.user_activity, v1), 13906840857313214476);
        let v4 = 0x2::linked_table::borrow_mut<address, UserInfo>(&mut arg1.user_activity, v1);
        assert!(0x2::linked_table::contains<0x2::object::ID, ListingInfo>(&v4.listings, arg3), 13906840874493214734);
        ...
        assert!(0x2::linked_table::contains<0x2::object::ID, Listing<T0>>(&v6.listings, arg3), 13906840900263936028);
        ...
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg4) >= v8, 13906840973277724690);
        ...
        assert!(v14 == 0x2::object::id<0x2::kiosk::Kiosk>(arg2), 13906841007638249502);
        ...
        let (v20, v21) = if (v6.ion_points_enabled) {
            ...
            let v23 = v22;
            let v24 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_listing_proximity_multiplier(v8, v6.avg_sale_price);
            let v25 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_time_multiplier(0x2::clock::timestamp_ms(arg0) - v5.last_points_claimed_at, true);
            let v26 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::integer_sqrt(v15);
            ...
            let v32 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v26, v23, v24, v25);
            v4.claimable_points = v4.claimable_points + v32;
            let v33 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v26, v23, v24, 1000);
        ...
        0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(v12, v0, arg7);
        (v19, v18, v15)
    }

    public fun cancel_bid<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: 0x1::option::Option<0x2::object::ID>, arg2: 0x2::object::ID, arg3: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaIONs, arg4: &0x2::clock::Clock, arg5: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaChef, arg6: &mut 0x2::tx_context::TxContext) {
        validation_check(arg0);
        ...
        assert!(0x2::linked_table::contains<0x1::ascii::String, bool>(&arg0.active_collections, v1), 13906839062017540118);
        ...
        if (!v2) {
            ...
            assert!(0x2::linked_table::contains<0x2::object::ID, ActiveBids>(&v5.bids, v7), 13906839122147344410);
            ...
            assert!(0x2::linked_table::contains<address, vector<ActiveBid>>(&v5.collection_bids, v0), 13906839152212115482);
        ...
        0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(v6, v0, arg6);
        assert!(0x2::linked_table::contains<address, UserInfo>(&arg0.user_activity, v0), 13906839281060216844);
        let v12 = 0x2::linked_table::borrow_mut<address, UserInfo>(&mut arg0.user_activity, v0);
        let v13 = 0;
        let v14 = 0;
        if (v2) {
            assert!(0x2::linked_table::contains<0x1::ascii::String, vector<BidInfo>>(&v12.collection_bids, v1), 13906839315420872730);
            ...
            assert!(0x2::linked_table::contains<0x2::object::ID, BidInfo>(&v12.bids, v18), 13906839409910153242);
        ...
        let v21 = if (v5.ion_points_enabled) {
            let v22 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_time_multiplier(v20, false);
            let v23 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_bid_proximity_multiplier(v13, v5.avg_sale_price);
            ...
            let v25 = v24;
            let v26 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v13, v25, v23, v22);
            let v27 = 0x1::string::utf8(b"=== ION POINTS ===");
            0x1::debug::print<0x1::string::String>(&v27);
    ...
    public fun cancel_trait_bid_settle<T0: store + key, T1: store + key>(arg0: &0x2::clock::Clock, arg1: &mut MarketPlaceStore, arg2: ActiveTraitBid, arg3: T1, arg4: TraitBidsPotato, arg5: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaIONs, arg6: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaChef, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v10.sui_trait_bids_pool, v11), v3, arg7);
        ...
        let v13 = if (v12.ion_points_enabled) {
            ...
            let v15 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_time_multiplier(v2 - v14, false);
            if (v15 > 0) {
                ...
                0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v11, v16, 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_bid_proximity_multiplier(v11, v12.avg_sale_price), v15)
            } else {
                0
            }
        } else {
    ...
    public fun claim_referral_points(arg0: &0x2::clock::Clock, arg1: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaChef, arg2: &mut MarketPlaceStore, arg3: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaIONs, arg4: &mut 0x2::tx_context::TxContext) {
        validation_check(arg2);
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x1::option::none<address>();
        let v2 = 0;
        let v3 = 0;
        assert!(0x2::linked_table::contains<address, u64>(&arg2.referrals, v0), 13906844645474369548);
        ...
        *0x2::linked_table::borrow_mut<address, u64>(&mut arg2.referrals, v0) = 0;
        if (0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::has_referrer(arg3)) {
            let v5 = 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::get_referrer(arg3);
            if (0x1::option::is_some<address>(&v5)) {
                0x1::option::fill<address>(&mut v1, *0x1::option::borrow<address>(&v5));
                let v6 = 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::math::mul_div_u128((v4 as u128), (15 as u128), 100);
                v2 = v6;
                v3 = 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::math::mul_div_u128((v4 as u128), (10 as u128), 100);
        ...
        let v8 = v2 + v3;
        0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::award_ion_points(&arg2.points_admin_cap, arg0, arg1, arg3, v8);
    ...
    public fun collect_commissions(arg0: &mut MarketPlaceStore, arg1: &CollectorCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.available_sui), arg2, arg3);
    }
    ...
    public fun complete_trait_bid<T0: store + key, T1: store + key>(arg0: &mut MarketPlaceStore, arg1: T1, arg2: TraitBidsPotato, arg3: &mut 0x2::tx_context::TxContext) {
        validation_check(arg0);
        let TraitBidsPotato { id: v0 } = arg2;
        assert!(0x2::object::id<T1>(&arg1) == v0, 13906840152940412968);
    ...
    public fun init_marketplace(arg0: &AdminCap, arg1: 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::PointsAdminCap, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun launchpad_add_collection<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: &LaunchpadCap, arg2: bool, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        validation_check(arg0);
        assert!(arg3 <= 10000, 13906837198002651172);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(!0x2::linked_table::contains<0x1::ascii::String, bool>(&arg0.active_collections, v0), 13906837210886635542);
    ...
    public entry fun make_bid<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: 0x1::option::Option<0x2::object::ID>, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (!v2) {
            ...
            if (0x2::linked_table::contains<0x2::object::ID, ActiveBids>(&v5.bids, v10)) {
                ...
                assert!(!0x2::linked_table::contains<address, ActiveBid>(&v11.bids, v0), 13906838598161203224);
        ...
        if (v2) {
            ...
            let v18 = *0x1::option::borrow<0x2::object::ID>(&arg1);
            assert!(!0x2::linked_table::contains<0x2::object::ID, BidInfo>(&v16.bids, v18), 13906838834384404504);
        ...
        0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(v6, v0, arg5);
    }
    ...
    public fun make_trait_bid<T0: store + key, T1: store + key>(arg0: &0x2::clock::Clock, arg1: &mut MarketPlaceStore, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x1::option::Option<0x1::ascii::String>, arg4: 0x1::option::Option<vector<0x1::ascii::String>>, arg5: 0x1::option::Option<0x1::ascii::String>, arg6: 0x1::option::Option<vector<0x1::ascii::String>>, arg7: 0x1::option::Option<0x1::ascii::String>, arg8: 0x1::option::Option<vector<0x1::ascii::String>>, arg9: &mut 0x2::tx_context::TxContext) : (ActiveTraitBid, T1, TraitBidsPotato) {
        ...
        assert!(0x2::dynamic_object_field::exists_<vector<u8>>(&v3.id, b"trait_bids"), 13906839744918388774);
        assert!(v3.are_trait_bids_enabled, 13906839749214273588);
        ...
        0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(v5, v0, arg9);
    ...
    public fun permissionless_add_collection<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        validation_check(arg0);
        assert!(arg0.is_permissionless, 13906837425635000342);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(!0x2::linked_table::contains<0x1::ascii::String, bool>(&arg0.active_collections, v0), 13906837447109836822);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= arg0.new_collection_fee, 13906837459994476562);
        ...
        0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg2), arg2);
        0x2::linked_table::push_back<0x1::ascii::String, bool>(&mut arg0.active_collections, v0, true);
    ...
    public fun process_pending_claim<T0: store + key>(arg0: &0x2::clock::Clock, arg1: &mut MarketPlaceStore, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        0x1::debug::print<address>(&v0);
        0x1::debug::print<0x2::object::ID>(&arg5);
        assert!(0x2::linked_table::contains<address, PendingClaims>(&arg1.pending_claims, v0), 13906843936806993966);
        let v2 = 0x2::linked_table::borrow_mut<address, PendingClaims>(&mut arg1.pending_claims, v0);
        assert!(0x2::linked_table::contains<0x2::object::ID, PendingClaim>(&v2.pending_claims, arg5), 13906843945397059632);
        let v3 = 0x2::linked_table::remove<0x2::object::ID, PendingClaim>(&mut v2.pending_claims, arg5);
        assert!(v3.buyer == v0, 13906843953986601002);
        let PendingClaim {
            buyer    : _,
            nft_type : v5,
            price    : _,
        ...
        0x1::debug::print<address>(&v0);
        assert!(0x2::kiosk::kiosk_owner_cap_for(arg4) == 0x2::object::id<0x2::kiosk::Kiosk>(arg3), 13906843984050585630);
    ...
    public fun remove_trait_bidding_support<T0: store + key, T1: store + key>(arg0: &mut MarketPlaceStore, arg1: &TraitBidsAdminCap, arg2: &mut 0x2::tx_context::TxContext) : T1 {
        validation_check(arg0);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x2::linked_table::contains<0x1::ascii::String, bool>(&arg0.active_collections, v0), 13906837064857747478);
        assert!(0x2::dynamic_object_field::exists_<0x1::ascii::String>(&arg0.id, v0), 13906837069152714774);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, CollectionMarketPlace<T0>>(&mut arg0.id, v0);
    ...
    public fun switch_trait_bidding_support<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: &TraitBidsAdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        validation_check(arg0);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x2::linked_table::contains<0x1::ascii::String, bool>(&arg0.active_collections, v0), 13906836953188597782);
        assert!(0x2::dynamic_object_field::exists_<0x1::ascii::String>(&arg0.id, v0), 13906836957483565078);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, CollectionMarketPlace<T0>>(&mut arg0.id, v0);
    ...
    public fun unlist<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaIONs, arg4: &0x2::clock::Clock, arg5: &mut 0x8c022f0639b8ff6a46afb6d5adf3f145cfb8b2a6db50790925fc16a54c38c52b::ions::AnimaChef, arg6: &mut 0x2::tx_context::TxContext) {
        validation_check(arg0);
        let v0 = 0x2::tx_context::sender(arg6);
        let v1 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        ...
        0x1::debug::print<0x1::string::String>(&v3);
        assert!(0x2::linked_table::contains<address, UserInfo>(&arg0.user_activity, v0), 13906838026929766412);
        let v4 = 0x2::linked_table::borrow_mut<address, UserInfo>(&mut arg0.user_activity, v0);
        assert!(0x2::linked_table::contains<0x2::object::ID, ListingInfo>(&v4.listings, arg2), 13906838044109766670);
        let v5 = 0x2::linked_table::remove<0x2::object::ID, ListingInfo>(&mut v4.listings, arg2);
        let v6 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, CollectionMarketPlace<T0>>(&mut arg0.id, v1);
        assert!(0x2::linked_table::contains<0x2::object::ID, Listing<T0>>(&v6.listings, arg2), 13906838065584603150);
        ...
        let v10 = if (v6.ion_points_enabled) {
            let v11 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_time_multiplier(v8, false);
            let v12 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_listing_proximity_multiplier(v7.price, v6.avg_sale_price);
            ...
            let v14 = v13;
            let v15 = 0x6439d8f75e190e0aefe1d1c321e77e1b19b23b1f16a5f0ec98ed6c0827ace00e::helpers::calculate_ion_points(v7.price, v14, v12, v11);
    ...
    public fun update_commission_pct(arg0: &mut MarketPlaceStore, arg1: &AdminCap, arg2: u64) {
        validation_check(arg0);
        assert!(arg2 <= 10, 13906836381957554192);
    ...
    public fun update_ion_point_multiplier<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: &AdminCap, arg2: bool, arg3: u64) {
        validation_check(arg0);
        assert!(arg3 <= 10000, 13906836609592131620);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, CollectionMarketPlace<T0>>(&mut arg0.id, v0);
    ...
    public fun update_module_version(arg0: &mut MarketPlaceStore) {
        assert!(arg0.version < 0, 13906836068425203732);
        arg0.version = 0;
    }
    ...
    fun validate_collection_exists<T0: store + key>(arg0: &MarketPlaceStore) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x2::linked_table::contains<0x1::ascii::String, bool>(&arg0.active_collections, v0), 13906847767916249110);
        assert!(*0x2::linked_table::borrow<0x1::ascii::String, bool>(&arg0.active_collections, v0), 13906847776506183702);
        assert!(0x2::dynamic_object_field::exists_<0x1::ascii::String>(&arg0.id, v0), 13906847789391085590);
    }

    fun validation_check(arg0: &MarketPlaceStore) {
        assert!(arg0.version == 0, 13906844873107505162);
    }
