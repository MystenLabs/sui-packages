module 0x641e078c96315bfb87b01464e8e6bccf183b2362f53d384bace9d8330218a5cf::ELON {
    ...
    fun init(arg0: ELON, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<ELON>(arg0, 9, b"COIN", b"Coinbase", b"Coinbase on SUI", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
