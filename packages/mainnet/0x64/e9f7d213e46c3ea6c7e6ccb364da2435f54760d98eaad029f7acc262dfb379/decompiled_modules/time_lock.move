module 0x64e9f7d213e46c3ea6c7e6ccb364da2435f54760d98eaad029f7acc262dfb379::time_lock {
    ...
    public(friend) fun new_time_locked<T0>(arg0: T0, arg1: &0x2::clock::Clock) : TimeLock<T0> {
        let v0 = clock_now(arg1) + 86400;
        TimeLock<T0>{
            inner           : arg0,
            expiration_time : v0 + 43200,
            active_after    : v0,
        }
    }
