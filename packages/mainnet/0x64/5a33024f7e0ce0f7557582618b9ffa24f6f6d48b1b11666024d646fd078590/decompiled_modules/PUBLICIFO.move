module 0x645a33024f7e0ce0f7557582618b9ffa24f6f6d48b1b11666024d646fd078590::PUBLICIFO {
    ...
    public entry fun claim_tokens<T0>(arg0: &mut PublicIFO<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.total_committed <= arg0.hard_cap) {
            ...
            let v4 = *v1 * 200000 * (200000000000000 as u128) * 1000000000 / (arg0.total_committed as u128) * 1000 * 1000000000;
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_balance, ((*v1 - *v1 * (200000000000000 as u128) / (arg0.total_committed as u128)) as u64)), arg2), 0x2::tx_context::sender(arg2));
    ...
    public entry fun ifo_initialize<T0>(arg0: &PublicIFOAdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = PublicIFO<T0>{
            ...
            hard_cap        : 200000000000000,
            min_commit      : 10000000000,
            max_commit      : 2000000000000,
            public_rate     : 200000,
