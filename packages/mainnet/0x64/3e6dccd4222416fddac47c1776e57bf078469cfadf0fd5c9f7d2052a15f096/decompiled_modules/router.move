module 0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::router {
    struct SwapContext {
    ...
    public fun finish_swap<T0>(arg0: SwapContext, arg1: &0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::config::GlobalConfig, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::config::checked_package_version(arg1);
        let SwapContext {
            quote_id         : v0,
            from             : v1,
            target           : v2,
        ...
        assert!(v9 == v2, 0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::errors::err_target_mismatch());
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&v8, v9), 0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::errors::err_target_not_found());
        ...
        let v11 = if (v5 > 0 && v6 != @0x0) {
            ...
            transfer_balance<T0>(0x2::balance::split<T0>(&mut v10, v12), v6, arg2);
            v12
        } else {
            0
        };
        let v13 = 0x2::balance::value<T0>(&v10);
        assert!(v13 >= v4, 0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::errors::err_amount_out_slippage_check_failed());
        assert!(0x2::bag::is_empty(&v8), 0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::errors::err_remains_balance());
    ...
    public fun start_swap<T0, T1>(arg0: 0x1::string::String, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u32, arg4: address, arg5: &0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::config::GlobalConfig, arg6: &mut 0x2::tx_context::TxContext) : SwapContext {
        0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::config::checked_package_version(arg5);
        assert!(0x2::coin::value<T0>(&arg2) <= max_amount_in(), 0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::errors::err_exceed_max_amount_in());
        assert!(0x2::coin::value<T0>(&arg2) > 0, 0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::errors::err_amount_in_is_zero());
        if (arg3 > 0) {
            assert!(arg4 != @0x0, 0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::errors::err_invalid_fee_recipient());
        };
        assert!(arg3 <= 100000, 0x643e6dccd4222416fddac47c1776e57bf078469cfadf0fd5c9f7d2052a15f096::errors::err_too_large_fee_rate());
