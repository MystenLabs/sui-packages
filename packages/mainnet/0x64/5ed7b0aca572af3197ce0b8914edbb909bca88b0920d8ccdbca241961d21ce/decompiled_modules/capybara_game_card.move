module 0x645ed7b0aca572af3197ce0b8914edbb909bca88b0920d8ccdbca241961d21ce::capybara_game_card {
    ...
    public entry fun mint(arg0: &mut Registry, arg1: &0x2::clock::Clock, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = UserEvt{
            ...
            signature : serialize_checkin_args(arg2, arg3, arg4, v0),
        };
        ...
        let v4 = new_nft(v0, v2, v3, arg6);
        let v5 = 0x2::object::id<NFTData>(&v4);
        RegistryItem{id: v5};
        let v6 = MintNFT{
            from   : v0,
            to     : v0,
        ...
        0x2::transfer::transfer<NFTData>(v4, v0);
    }
