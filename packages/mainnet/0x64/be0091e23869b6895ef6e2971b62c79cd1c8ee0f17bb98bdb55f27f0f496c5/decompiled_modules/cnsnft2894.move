module 0x64be0091e23869b6895ef6e2971b62c79cd1c8ee0f17bb98bdb55f27f0f496c5::cnsnft2894 {
    struct CNSNFT2894 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2894, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2894>(arg0, arg1);
