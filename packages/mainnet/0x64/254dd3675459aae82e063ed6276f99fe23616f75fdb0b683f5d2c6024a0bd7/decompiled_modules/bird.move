module 0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::bird {
    ...
    public fun claimReward<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut RewardPool<T0>, arg3: &mut BirdStore, arg4: &mut BirdArchieve, arg5: &0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::Version, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::checkVersion(arg5, 1);
    ...
    public fun configRewardPool<T0>(arg0: &BirdAdminCap, arg1: &mut RewardPool<T0>, arg2: bool, arg3: u64, arg4: &0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::Version) {
        0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::checkVersion(arg4, 1);
        arg1.active = arg2;
        arg1.reward_limit = arg3;
    }

    public fun createRewardPool<T0>(arg0: &BirdAdminCap, arg1: &0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::checkVersion(arg1, 1);
    ...
    public fun depositReward<T0>(arg0: 0x2::coin::Coin<T0>, arg1: &mut RewardPool<T0>, arg2: &0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::Version, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::checkVersion(arg2, 1);
    ...
    public fun emergencyRewardWithdraw<T0>(arg0: &RewardTreasureCap, arg1: &mut RewardPool<T0>, arg2: &0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::Version, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::checkVersion(arg2, 1);
    ...
    fun init(arg0: BIRD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::cap_vault::createVault<BirdAdminCap>(arg1);
        0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::cap_vault::createVault<RewardTreasureCap>(arg1);
        0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::cap_vault::createVault<0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::VAdminCap>(arg1);
    }

    public fun mineBird(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::checkVersion(arg5, 1);
    ...
    public fun mineNft(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::checkVersion(arg5, 1);
        assert!(0x1::option::is_some<vector<u8>>(&arg2.validator), 8000);
    ...
    public fun register(arg0: &mut BirdReg, arg1: &0x2::clock::Clock, arg2: &0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::checkVersion(arg2, 1);
    ...
    public fun update_validator(arg0: &BirdAdminCap, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::Version) {
        0x64254dd3675459aae82e063ed6276f99fe23616f75fdb0b683f5d2c6024a0bd7::version::checkVersion(arg3, 1);
