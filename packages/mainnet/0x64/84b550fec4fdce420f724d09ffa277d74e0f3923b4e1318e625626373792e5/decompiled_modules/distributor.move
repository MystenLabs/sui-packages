module 0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::distributor {
    ...
    fun assert_all(arg0: &0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::config::DistributeConfig, arg1: &0x2::tx_context::TxContext) {
        0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::config::assert_operator(arg0, 0x2::tx_context::sender(arg1));
        0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::config::assert_version(arg0);
        0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::config::assert_paused(arg0);
    }

    public fun check_distributed_id(arg0: &mut 0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::config::DistributeConfig, arg1: 0x1::ascii::String) : bool {
        0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::config::check_distributed_id_existed(arg0, arg1)
    }

    entry fun create_zero_coin<T0>(arg0: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::zero<T0>(arg0), 0x2::tx_context::sender(arg0));
    }

    entry fun distribute<T0, T1, T2>(arg0: &mut 0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::config::DistributeConfig, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T2>, arg4: vector<0x1::ascii::String>, arg5: vector<address>, arg6: vector<u64>, arg7: vector<u64>, arg8: vector<u64>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        while (v3 < v0) {
            ...
            assert!(!0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::config::check_distributed_id_existed(arg0, v13), 201);
            if (v14 > 0) {
            ...
            0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::config::update_distributed_id(arg0, v13, arg10);
        ...
        0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::config::update_total_distributed(arg0, v8, v4, arg10);
        0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::config::update_total_distributed(arg0, v9, v5, arg10);
        0x6484b550fec4fdce420f724d09ffa277d74e0f3923b4e1318e625626373792e5::config::update_total_distributed(arg0, v10, v6, arg10);
        if (0x2::coin::value<T0>(&arg1) > 0 || v4 == 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, v2);
        } else {
            0x2::coin::destroy_zero<T0>(arg1);
        };
        if (0x2::coin::value<T1>(&arg2) > 0 || v5 == 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg2, v2);
        } else {
            0x2::coin::destroy_zero<T1>(arg2);
        };
        if (0x2::coin::value<T2>(&arg3) > 0 || v6 == 0) {
