module 0x64b80e556beb02d61751f6cf094ec46519259d704e726ba6c01e78655609a97d::cnsnft2898 {
    struct CNSNFT2898 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2898, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2898>(arg0, arg1);
