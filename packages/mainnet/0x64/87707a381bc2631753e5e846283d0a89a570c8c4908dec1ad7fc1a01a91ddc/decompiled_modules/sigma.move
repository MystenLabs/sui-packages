module 0x6487707a381bc2631753e5e846283d0a89a570c8c4908dec1ad7fc1a01a91ddc::sigma {
    ...
    fun init(arg0: SIGMA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<SIGMA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"SIGMA   ")))), trim_right(b"SIGMA                           "), trim_right(b"SIGMA SIGMA SIGMA                                                                                                                                                                                                                                                                                                               "), v2, arg1);
