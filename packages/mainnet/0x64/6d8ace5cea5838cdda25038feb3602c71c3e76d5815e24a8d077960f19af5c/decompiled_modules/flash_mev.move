module 0xf9fb721962251aa3587d9b570543efcd04b43c6e95e7afd5a1bdc202354f1eb7::flash_mev {
    ...
    struct FlashJitDualProbeResult has copy, drop {
        flash_a: u64,
        flash_b: u64,
        swap_amount_a: u64,
        tick_lower: u32,
    ...
    public entry fun flash_jit<T0, T1, T2, T3>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg3: u64, arg4: u64, arg5: u32, arg6: u32, arg7: 0x2::coin::Coin<T1>, arg8: u64, arg9: u64, arg10: address, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        assert!(arg10 == @0xa40759d45016da48ec08b52907582e69d9c0de9c1ce719331a409e6e15533292, 10);
    ...
    public entry fun flash_jit_dual_probe<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: u64, arg3: u64, arg4: u64, arg5: u32, arg6: u32, arg7: 0x2::coin::Coin<T0>, arg8: 0x2::coin::Coin<T1>, arg9: u64, arg10: u64, arg11: address, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg2 > 0) {
            if (arg3 > 0) {
                arg4 > 0
            } else {
        ...
        assert!(v0, 0);
        assert_active_one_spacing<T0, T1>(arg1, arg5, arg6);
        let (v1, v2, v3) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_loan<T0, T1>(arg0, arg1, true, arg2);
        let v4 = v1;
        0x2::balance::destroy_zero<T1>(v2);
        let (v5, v6, v7) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_loan<T0, T1>(arg0, arg1, false, arg3);
        let v8 = v6;
        0x2::balance::destroy_zero<T0>(v5);
        let v9 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::open_position<T0, T1>(arg0, arg1, arg5, arg6, arg13);
        let v10 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg0, arg1, &mut v9, arg2, true, arg12);
        let (v11, v12) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_pay_amount<T0, T1>(&v10);
        assert!(0x2::balance::value<T0>(&v4) >= v11, 6);
        assert!(0x2::balance::value<T1>(&v8) >= v12, 7);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_add_liquidity<T0, T1>(arg0, arg1, 0x2::balance::split<T0>(&mut v4, v11), 0x2::balance::split<T1>(&mut v8, v12), v10);
        let (v13, v14, v15) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg0, arg1, true, true, arg4, 4295048017, arg12);
        let v16 = v15;
        let (v17, v18) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::collect_fee<T0, T1>(arg0, arg1, &v9, false);
        let v19 = v18;
        let v20 = v17;
        let v21 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(&v9);
        let (v22, v23) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::remove_liquidity<T0, T1>(arg0, arg1, &mut v9, v21, arg12);
        let v24 = v23;
        let v25 = v22;
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::close_position<T0, T1>(arg0, arg1, v9);
        let v26 = 0x2::coin::into_balance<T0>(arg7);
        0x2::balance::join<T0>(&mut v26, v4);
        0x2::balance::join<T0>(&mut v26, v13);
        0x2::balance::join<T0>(&mut v26, v20);
        0x2::balance::join<T0>(&mut v26, v25);
        let v27 = 0x2::coin::into_balance<T1>(arg8);
        0x2::balance::join<T1>(&mut v27, v8);
        0x2::balance::join<T1>(&mut v27, v14);
        0x2::balance::join<T1>(&mut v27, v19);
        0x2::balance::join<T1>(&mut v27, v24);
        let v28 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T1>(&v16);
        assert!(0x2::balance::value<T0>(&v26) >= v28, 8);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg0, arg1, 0x2::balance::split<T0>(&mut v26, v28), 0x2::balance::zero<T1>(), v16);
        let v29 = flash_loan_repay_amount<T0, T1>(arg1, arg2);
        assert!(0x2::balance::value<T0>(&v26) >= v29, 9);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_loan<T0, T1>(arg0, arg1, 0x2::balance::split<T0>(&mut v26, v29), 0x2::balance::zero<T1>(), v3);
        let v30 = flash_loan_repay_amount<T0, T1>(arg1, arg3);
        assert!(0x2::balance::value<T1>(&v27) >= v30, 9);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_loan<T0, T1>(arg0, arg1, 0x2::balance::zero<T0>(), 0x2::balance::split<T1>(&mut v27, v30), v7);
        let v31 = 0x2::balance::value<T0>(&v26);
        let v32 = 0x2::balance::value<T1>(&v27);
        assert!(v31 >= arg9, 4);
        assert!(v32 >= arg10, 5);
        let v33 = FlashJitDualProbeResult{
            flash_a          : arg2,
            flash_b          : arg3,
            swap_amount_a    : arg4,
            tick_lower       : arg5,
            tick_upper       : arg6,
            liquidity        : v21,
            original_a       : 0x2::coin::value<T0>(&arg7),
            original_b       : 0x2::coin::value<T1>(&arg8),
            liquidity_paid_a : v11,
            liquidity_paid_b : v12,
            collected_fee_a  : 0x2::balance::value<T0>(&v20),
            collected_fee_b  : 0x2::balance::value<T1>(&v19),
            removed_a        : 0x2::balance::value<T0>(&v25),
            removed_b        : 0x2::balance::value<T1>(&v24),
        ...
        0x2::event::emit<FlashJitDualProbeResult>(v33);
        transfer_nonzero<T0>(v26, arg11, arg13);
        transfer_nonzero<T1>(v27, arg11, arg13);
    }
