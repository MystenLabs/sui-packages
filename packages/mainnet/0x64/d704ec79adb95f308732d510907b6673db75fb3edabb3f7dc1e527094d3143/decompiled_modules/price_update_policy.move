module 0x64d704ec79adb95f308732d510907b6673db75fb3edabb3f7dc1e527094d3143::price_update_policy {
    struct PriceUpdateRequest<phantom T0> {
        for_policy: 0x2::object::ID,
        receipts: 0x2::vec_set::VecSet<0x1::type_name::TypeName>,
        price_feeds: vector<0x64d704ec79adb95f308732d510907b6673db75fb3edabb3f7dc1e527094d3143::price_feed::PriceFeed>,
    }
    ...
    public fun add_price_feed<T0, T1: drop>(arg0: T1, arg1: &mut PriceUpdateRequest<T0>, arg2: 0x64d704ec79adb95f308732d510907b6673db75fb3edabb3f7dc1e527094d3143::price_feed::PriceFeed) {
        0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg1.receipts, 0x1::type_name::with_defining_ids<T1>());
        0x1::vector::push_back<0x64d704ec79adb95f308732d510907b6673db75fb3edabb3f7dc1e527094d3143::price_feed::PriceFeed>(&mut arg1.price_feeds, arg2);
    }
    ...
    public fun confirm_request<T0>(arg0: PriceUpdateRequest<T0>, arg1: &PriceUpdatePolicy) : vector<0x64d704ec79adb95f308732d510907b6673db75fb3edabb3f7dc1e527094d3143::price_feed::PriceFeed> {
    ...
    public fun new_request<T0>(arg0: &PriceUpdatePolicy) : PriceUpdateRequest<T0> {
        PriceUpdateRequest<T0>{
            ...
            price_feeds : 0x1::vector::empty<0x64d704ec79adb95f308732d510907b6673db75fb3edabb3f7dc1e527094d3143::price_feed::PriceFeed>(),
        }
    }
