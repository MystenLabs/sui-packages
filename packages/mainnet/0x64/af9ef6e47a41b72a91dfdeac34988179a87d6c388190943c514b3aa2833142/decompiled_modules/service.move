module 0x64af9ef6e47a41b72a91dfdeac34988179a87d6c388190943c514b3aa2833142::service {
    ...
    public(friend) fun get_feature<T0, T1: store + key>(arg0: &Service) : &T1 {
        0x2::dynamic_object_field::borrow<0x1::string::String, T1>(&arg0.id, 0x64af9ef6e47a41b72a91dfdeac34988179a87d6c388190943c514b3aa2833142::utils::get_key_by_struct<T0>())
    }

    public(friend) fun get_feature_mut<T0, T1: store + key>(arg0: &mut Service) : &mut T1 {
        0x2::dynamic_object_field::borrow_mut<0x1::string::String, T1>(&mut arg0.id, 0x64af9ef6e47a41b72a91dfdeac34988179a87d6c388190943c514b3aa2833142::utils::get_key_by_struct<T0>())
    }
