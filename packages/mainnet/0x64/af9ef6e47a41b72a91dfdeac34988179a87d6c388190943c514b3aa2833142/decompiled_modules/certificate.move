module 0x64af9ef6e47a41b72a91dfdeac34988179a87d6c388190943c514b3aa2833142::certificate {
    ...
    public(friend) fun issue_investment_certificate(arg0: u64, arg1: 0x64af9ef6e47a41b72a91dfdeac34988179a87d6c388190943c514b3aa2833142::project::ProjectInfo, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<InvestmentCertificate>(v0, 0x2::tx_context::sender(arg4));
    }
