module 0xfafd827f16d634ed630d9fcde2aeff37fb65ec2df6f8b60d7fdde3e315a01198::clmm {
    ...
    fun is_x2y_in_range(arg0: u64, arg1: u64, arg2: u128, arg3: u128, arg4: u128) : bool {
        ((arg0 as u256) * (arg2 as u256) >> 64) * ((arg2 - arg3) as u256) >> 64 > (arg1 as u256) * ((arg4 - arg2) as u256) / (arg4 as u256)
    }
    ...
    public(friend) fun solve_optimal_one_for_zero(arg0: &SwapState) : u128 {
        ...
        let v14 = (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::abs_u128(v12) as u256);
        let v15 = v14 * v14;
        let v16 = (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::abs_u128(v13) as u256) * ((v10 as u256) << 1);
        let v17 = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::is_neg(v13)) {
            assert!(v15 >= v16, 1);
            v15 - v16
        } else {
            v15 + v16
        };
        let v18 = 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::div(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::shl(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::add(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from((0xfafd827f16d634ed630d9fcde2aeff37fb65ec2df6f8b60d7fdde3e315a01198::math::sqrt_u256(v17) as u128)), v12), 64), v13);
        assert!(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::gt(v18, 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::zero()), 1);
        let v19 = 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::as_u128(v18);
        if (v19 > v2) {
            v19
        } else {
            v2
    ...
    public(friend) fun solve_optimal_zero_for_one(arg0: &SwapState) : u128 {
        ...
        let v14 = (v9 as u128) << 1;
        let v15 = (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::abs_u128(v13) as u256);
        let v16 = v15 * v15;
        let v17 = (v14 as u256) * (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::abs_u128(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::shl(v12, 1)) as u256);
        let v18 = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::is_neg(v12)) {
            assert!(v16 >= v17, 1);
            v16 - v17
        } else {
            v16 + v17
        };
        let v19 = 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::add(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from((0xfafd827f16d634ed630d9fcde2aeff37fb65ec2df6f8b60d7fdde3e315a01198::math::sqrt_u256(v18) as u128)), v13);
        assert!(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::gte(v19, 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::zero()), 1);
        let v20 = ((((0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::as_u128(v19) as u256) << 64) / (v14 as u256)) as u128);
        if (v20 < v2) {
            v20
        } else {
            v2
