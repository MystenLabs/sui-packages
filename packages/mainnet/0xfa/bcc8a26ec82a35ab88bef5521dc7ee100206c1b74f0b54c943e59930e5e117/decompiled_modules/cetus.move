module 0xfabcc8a26ec82a35ab88bef5521dc7ee100206c1b74f0b54c943e59930e5e117::cetus {
    ...
    public fun get_token_price<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>) : u64 {
        let v0 = ((((0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg0) * (1000 as u128)) as u256) >> 64) as u128);
        ((1000 * 1000 / ((v0 * v0) as u64)) as u64)
    }
