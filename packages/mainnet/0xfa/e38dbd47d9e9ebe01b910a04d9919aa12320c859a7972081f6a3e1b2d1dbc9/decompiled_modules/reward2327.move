module 0xfae38dbd47d9e9ebe01b910a04d9919aa12320c859a7972081f6a3e1b2d1dbc9::reward2327 {
    struct REWARD2327 has drop {
        dummy_field: bool,
    }

    struct TICKET_2327 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2327(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2327>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2327>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2327, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2327>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2327>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2327>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2327>>(v5, 0x2::tx_context::sender(arg1));
    }
