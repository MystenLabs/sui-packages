module 0xfa6003d96385f88f62cb5e6d8e7c0786464add393ec44a5023b14f7a6fd37e7a::wit_table {
    ...
    public fun borrow_mut_check<T0: drop, T1: copy + drop + store, T2: store>(arg0: &mut WitTable<T0, T1, T2>, arg1: T1) : &mut T2 {
