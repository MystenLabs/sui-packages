module 0xfa1b83a863a897c84040764305f9a87e8633d69f31ef5b034ce6f26d87cdc7b2::registry {
    ...
    public fun lookup_by_id(arg0: &Registry, arg1: 0x2::object::ID) : 0x1::option::Option<0x1::string::String> {
        if (0x2::table::contains<0x2::object::ID, 0x1::string::String>(&arg0.registry, arg1)) {
    ...
    public fun lookup_by_name(arg0: &Registry, arg1: 0x1::string::String) : 0x1::option::Option<0x2::object::ID> {
        if (0x2::table::contains<0x1::string::String, 0x2::object::ID>(&arg0.reversed_registry, arg1)) {
