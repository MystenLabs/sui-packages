module 0xfa0a6b49fe4c198b9e8ee6e6b277c5029ba7e857cd6740832d2431d7b0b0f990::cnsnft2889 {
    struct CNSNFT2889 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2889, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2889>(arg0, arg1);
