module 0xfa33c7975480ccf2f1cadc29d7c664d4b7949b39c8271513a358c506b6843340::core {
    ...
    fun init(arg0: CORE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CORE>(arg0, 9, b"ZEIRO", b"Zeiro Token", b"Zeiro Token", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
