module 0xfa410bbe25303aebed47c975ac8f25a13ed596448d4c2e1674749bfbde3eeea1::quest {
    ...
    public fun create_journey(arg0: &mut SpaceHub, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &SpaceAdminCap, arg3: &mut Space, arg4: u64, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0xfa410bbe25303aebed47c975ac8f25a13ed596448d4c2e1674749bfbde3eeea1::utils::handle_payment<0x2::sui::SUI>(&mut arg0.balance, arg1, arg0.fee_for_creating_journey, arg11);
        let v0 = Journey{
    ...
    public fun start_quest(arg0: &mut SpaceHub, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut Space, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0xfa410bbe25303aebed47c975ac8f25a13ed596448d4c2e1674749bfbde3eeea1::utils::handle_transfer<0x2::sui::SUI>(@0xfa40dda8beaf0bee40130a32df04bc74bb8a4bc85b2d27c54289fe8676d5f977, arg1, arg0.fee_for_start_quest, arg6);
    ...
    entry fun withdraw(arg0: &AdminCap, arg1: &mut SpaceHub, arg2: &mut 0x2::tx_context::TxContext) {
        check_hub_version(arg1);
        0xfa410bbe25303aebed47c975ac8f25a13ed596448d4c2e1674749bfbde3eeea1::utils::withdraw_balance<0x2::sui::SUI>(&mut arg1.balance, arg2);
    }
