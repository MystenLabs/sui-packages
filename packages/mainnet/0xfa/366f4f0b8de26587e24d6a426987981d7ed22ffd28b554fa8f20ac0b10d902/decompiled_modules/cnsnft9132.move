module 0xfa366f4f0b8de26587e24d6a426987981d7ed22ffd28b554fa8f20ac0b10d902::cnsnft9132 {
    struct CNSNFT9132 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9132, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4942"));
        let v4 = 0x2::package::claim<CNSNFT9132>(arg0, arg1);
