module 0xfab61932ecd616283d589851634e384e8f8fbf3f12b48e0a5c53fb2c561aa54b::cnsnft7357 {
    struct CNSNFT7357 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7357, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3393"));
        let v4 = 0x2::package::claim<CNSNFT7357>(arg0, arg1);
