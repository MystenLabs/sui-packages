module 0xfa302a66cf45db1dcdcdefdbccedfaa64c08463f5c96ca856e71c59d0b2e6a29::sui_booster_dao {
    struct SUI_BOOSTER_DAO has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_BOOSTER_DAO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_BOOSTER_DAO>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sui Booster DAO"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibabztekez2bkqx7m5zbvbge675ib3v2xiug3vbk733yhiuo6dwca"));
