module 0xfab09c60dadb7c65751b02299a56e0f4c67bd10d567f000b6ef9c7deb6ab58fd::reward2750 {
    struct REWARD2750 has drop {
        dummy_field: bool,
    }

    struct TICKET_2750 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2750(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_2750>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2750, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2750>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2750>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2750>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2750>>(v5, 0x2::tx_context::sender(arg1));
    }
