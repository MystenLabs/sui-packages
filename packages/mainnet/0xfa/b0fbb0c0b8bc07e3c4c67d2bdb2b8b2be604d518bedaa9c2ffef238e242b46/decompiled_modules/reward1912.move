module 0xfab0fbb0c0b8bc07e3c4c67d2bdb2b8b2be604d518bedaa9c2ffef238e242b46::reward1912 {
    struct REWARD1912 has drop {
        dummy_field: bool,
    }

    struct TICKET_1912 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1912(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1912>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1912>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1912, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1912>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1912>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1912>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1912>>(v5, 0x2::tx_context::sender(arg1));
    }
