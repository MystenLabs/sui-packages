module 0xfabfbe3cf084ba2f717bfa8a9459b27421bf512c019fa480bfe216ca8cca4e71::tale01 {
    ...
    fun init(arg0: TALE01, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = v6;
        let v8 = v5;
        0xfabfbe3cf084ba2f717bfa8a9459b27421bf512c019fa480bfe216ca8cca4e71::tale01_royalty::add<Nft>(&mut v8, &v7, 0, v3, 0);
    ...
    public entry fun update_config(arg0: &AdminCap, arg1: &mut MintConfig, arg2: &mut 0x2::transfer_policy::TransferPolicy<Nft>, arg3: &0x2::transfer_policy::TransferPolicyCap<Nft>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u16, arg9: address, arg10: u64) {
        ...
        let v0 = if (arg1.royalty_bps != arg8) {
            ...
            0xfabfbe3cf084ba2f717bfa8a9459b27421bf512c019fa480bfe216ca8cca4e71::tale01_royalty::min_amount(0xfabfbe3cf084ba2f717bfa8a9459b27421bf512c019fa480bfe216ca8cca4e71::tale01_royalty::get_config<Nft>(arg2)) != arg10
        };
        if (v0) {
            0xfabfbe3cf084ba2f717bfa8a9459b27421bf512c019fa480bfe216ca8cca4e71::tale01_royalty::update<Nft>(arg2, arg3, arg8, arg9, arg10);
