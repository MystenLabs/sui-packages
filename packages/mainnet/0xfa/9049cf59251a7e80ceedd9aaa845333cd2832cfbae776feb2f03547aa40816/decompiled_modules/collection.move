module 0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::collection {
    ...
    struct Collection<phantom T0> has store, key {
        ...
        royalty: u16,
        referral: 0x1::option::Option<0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::referrals::Referral>,
        info: CollectionInfo,
    }
    ...
    public fun create<T0: drop>(arg0: T0, arg1: 0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::factory::CollectionCap, arg2: u64, arg3: u64, arg4: bool, arg5: bool, arg6: u64, arg7: u64, arg8: &PublisherWrapper, arg9: 0x1::option::Option<vector<u8>>, arg10: &mut 0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::referrals::ReferralTable, arg11: &mut 0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::collection_storage::State, arg12: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg12);
        let (v1, v2, v3, v4, v5, v6) = 0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::factory::destroy_collection_cap(arg1);
        ...
        let v13 = 0x1::option::none<0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::referrals::Referral>();
        if (0x1::option::is_some<vector<u8>>(&arg9)) {
            0x1::option::fill<0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::referrals::Referral>(&mut v13, 0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::referrals::use_referral(arg10, 0x1::option::destroy_some<vector<u8>>(arg9)));
        };
        ...
        0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::collection_storage::add(0x2::object::id_address<Collection<T0>>(&v15), v1, v3, v0, arg11);
    ...
    public entry fun mint_nft<T0: drop, T1: drop>(arg0: 0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::factory::MintCap<T0>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &mut Collection<T0>, arg5: &0x2::transfer_policy::TransferPolicy<BelongNFT<T0>>, arg6: &0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::factory::State, arg7: &mut 0x2::tx_context::TxContext) {
        if (arg4.info.is_sui) {
        ...
        let (v0, v1, v2, v3, v4) = 0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::factory::use_mint_cap<T0>(arg0, arg7);
        let v5 = get_mint_price<T0>(arg4, v4);
        if (v5 > 0) {
            let v6 = (((v5 as u128) * (0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::factory::get_platform_commission(arg6) as u128) / 10000) as u64);
            assert!(0x2::coin::value<T1>(&arg1) == v5 + v6, 1);
            let (v7, v8) = 0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::referrals::calculate_referrals(arg4.referral, v6);
            if (v7 > 0) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg1, 0xfa9049cf59251a7e80ceedd9aaa845333cd2832cfbae776feb2f03547aa40816::factory::get_platform_address(arg6));
