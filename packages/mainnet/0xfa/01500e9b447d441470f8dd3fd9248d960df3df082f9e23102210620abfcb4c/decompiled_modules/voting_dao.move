module 0xfa01500e9b447d441470f8dd3fd9248d960df3df082f9e23102210620abfcb4c::voting_dao {
    ...
    public(friend) fun checkpoint_delegatee(arg0: &mut VotingDAO, arg1: 0x2::object::ID, arg2: u64, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (is_checkpoint_in_new_block(arg0, arg1, get_block_timestamp(arg4))) {
            let v5 = if (0x2::table::contains<0x2::object::ID, u64>(&arg0.num_checkpoints, arg1)) {
                0x2::table::remove<0x2::object::ID, u64>(&mut arg0.num_checkpoints, arg1)
            } else {
                0
            };
            let v6 = v5 + 1;
            0x2::table::add<0x2::object::ID, u64>(&mut arg0.num_checkpoints, arg1, v6);
            if (!0x2::table::contains<0x2::object::ID, 0x2::table::Table<u64, Checkpoint>>(&arg0.checkpoints, arg1)) {
                0x2::table::add<0x2::object::ID, 0x2::table::Table<u64, Checkpoint>>(&mut arg0.checkpoints, arg1, 0x2::table::new<u64, Checkpoint>(arg5));
            };
            0x2::table::add<u64, Checkpoint>(0x2::table::borrow_mut<0x2::object::ID, 0x2::table::Table<u64, Checkpoint>>(&mut arg0.checkpoints, arg1), v6, v3);
        } else {
            let v7 = 0x2::table::borrow_mut<0x2::object::ID, 0x2::table::Table<u64, Checkpoint>>(&mut arg0.checkpoints, arg1);
            0x2::table::remove<u64, Checkpoint>(v7, v0 - 1);
            0x2::table::add<u64, Checkpoint>(v7, v0 - 1, v3);
        };
    }
    ...
    public(friend) fun checkpoint_delegator(arg0: &mut VotingDAO, arg1: 0x2::object::ID, arg2: u64, arg3: 0x2::object::ID, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v1;
        assert!(0x2::table::length<u64, Checkpoint>(0x2::table::borrow<0x2::object::ID, 0x2::table::Table<u64, Checkpoint>>(&arg0.checkpoints, arg1)) == v0, 9223372642445164543);
    ...
    fun is_checkpoint_in_new_block(arg0: &VotingDAO, arg1: 0x2::object::ID, arg2: u64) : bool {
        ...
        let v1 = v0 > 0 && arg2 - 0x2::table::borrow<u64, Checkpoint>(0x2::table::borrow<0x2::object::ID, 0x2::table::Table<u64, Checkpoint>>(&arg0.checkpoints, arg1), v0 - 1).from_timestamp < 0xfa01500e9b447d441470f8dd3fd9248d960df3df082f9e23102210620abfcb4c::common::get_time_to_finality_ms();
        !v1
    }
