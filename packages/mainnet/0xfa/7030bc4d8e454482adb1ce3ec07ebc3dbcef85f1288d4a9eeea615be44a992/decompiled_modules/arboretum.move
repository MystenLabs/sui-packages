module 0xfa7030bc4d8e454482adb1ce3ec07ebc3dbcef85f1288d4a9eeea615be44a992::arboretum {
    struct Registry has key {
        ...
        planted_nfts: 0x2::table::Table<0x2::object::ID, u64>,
    }
    ...
    entry fun apply_tool(arg0: &mut Registry, arg1: &mut Seed, arg2: Tool, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        if (v5 == b"fertilizer") {
            ...
            arg1.bottomless_can_expiry_ms = assert_season_active(arg0, arg3) + 8640000000;
    ...
    fun assert_nftree_release_nft<T0: key>() {
        let v0 = 0x1::type_name::with_original_ids<T0>();
        assert!(0x1::type_name::original_id<T0>() == @0xf6c6d439ea0da2f3e9ba79e4992a7a4c113215fbf54c442ac9020c315f953705, 18);
        assert!(0x1::ascii::into_bytes(0x1::type_name::module_string(&v0)) == b"collection", 18);
        assert!(0x1::ascii::into_bytes(0x1::type_name::datatype_string(&v0)) == b"NFT", 18);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Registry{
            ...
            planted_nfts         : 0x2::table::new<0x2::object::ID, u64>(arg0),
        };
    ...
    public fun nft_is_planted(arg0: &Registry, arg1: 0x2::object::ID) : bool {
        0x2::table::contains<0x2::object::ID, u64>(&arg0.planted_nfts, arg1) && *0x2::table::borrow<0x2::object::ID, u64>(&arg0.planted_nfts, arg1) == arg0.current_season_id
    }
    ...
    entry fun plant_seed<T0: key>(arg0: &mut Registry, arg1: &T0, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x1::option::Option<address>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 12);
        assert_nftree_release_nft<T0>();
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = assert_season_active(arg0, arg4);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= 10000000, 4);
        let v2 = 0x2::object::id<T0>(arg1);
        if (0x2::table::contains<0x2::object::ID, u64>(&arg0.planted_nfts, v2)) {
            assert!(*0x2::table::borrow<0x2::object::ID, u64>(&arg0.planted_nfts, v2) != arg0.current_season_id, 14);
            *0x2::table::borrow_mut<0x2::object::ID, u64>(&mut arg0.planted_nfts, v2) = arg0.current_season_id;
        } else {
            0x2::table::add<0x2::object::ID, u64>(&mut arg0.planted_nfts, v2, arg0.current_season_id);
        };
    ...
    entry fun reset_season(arg0: &AdminCap, arg1: &mut Registry, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        if (arg1.season_start_ms > 0) {
            assert!(0x2::clock::timestamp_ms(arg2) - arg1.season_start_ms >= 8640000000, 13);
        };
