module 0xfa599bfaa54a19f81bf370bdb605dc2e80b2c4ee17c3adcba6526224bac7dd08::chaosnft {
    ...
    fun init(arg0: CHAOSNFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://img.zhulijun.club/i/2024/04/03/{name}.png"));
