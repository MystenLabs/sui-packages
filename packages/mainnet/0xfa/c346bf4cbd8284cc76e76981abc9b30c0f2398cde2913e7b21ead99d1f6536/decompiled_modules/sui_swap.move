module 0xfac346bf4cbd8284cc76e76981abc9b30c0f2398cde2913e7b21ead99d1f6536::sui_swap {
    ...
    public fun create_pool<T0: drop, T1>(arg0: T0, arg1: 0x2::coin::Coin<T1>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LSP<T0, T1>> {
        ...
        assert!(arg3 >= 0 && arg3 < (10000 as u64), 1);
    ...
    public fun get_input_price_without_fee(arg0: u64, arg1: u64, arg2: u64) : u64 {
        let v0 = (arg0 as u128);
