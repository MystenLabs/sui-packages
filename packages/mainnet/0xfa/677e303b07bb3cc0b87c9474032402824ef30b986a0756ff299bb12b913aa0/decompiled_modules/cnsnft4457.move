module 0xfa677e303b07bb3cc0b87c9474032402824ef30b986a0756ff299bb12b913aa0::cnsnft4457 {
    struct CNSNFT4457 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4457, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2023"));
        let v4 = 0x2::package::claim<CNSNFT4457>(arg0, arg1);
