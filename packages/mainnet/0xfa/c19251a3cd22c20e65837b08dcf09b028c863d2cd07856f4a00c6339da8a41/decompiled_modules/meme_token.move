module 0xfac19251a3cd22c20e65837b08dcf09b028c863d2cd07856f4a00c6339da8a41::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"REET", b"REET TEST", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-07T14-24-58.917Z-Turkish-Van-Cat-with-Funny-MOUTH.jpeg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"REET TEST"),
            symbol     : 0x1::string::utf8(b"REET"),
            decimals   : 9,
