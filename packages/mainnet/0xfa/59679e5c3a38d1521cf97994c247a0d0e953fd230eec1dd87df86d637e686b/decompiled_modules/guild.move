module 0xfa59679e5c3a38d1521cf97994c247a0d0e953fd230eec1dd87df86d637e686b::guild {
    ...
    public fun subscribe<T0>(arg0: &Config, arg1: &mut UserArchive, arg2: &mut FeePool<T0>, arg3: u16, arg4: u8, arg5: vector<u8>, arg6: vector<u8>, arg7: 0x2::coin::Coin<T0>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 6005);
        assert!(!arg0.paused, 6004);
        verify_signature(arg5, arg6, &arg0.validator);
        let v0 = 0x2::tx_context::sender(arg9);
        ...
        assert!(0x2::bcs::peel_u16(&mut v1) == arg3, 6020);
        assert!(v2 == arg4, 6020);
        assert!(v3 > 0 && 0x2::coin::value<T0>(&arg7) == v3, 6001);
        assert!(0x2::bcs::peel_address(&mut v1) == 0x2::object::id_address<FeePool<T0>>(arg2), 6002);
        assert!(0x2::clock::timestamp_ms(arg8) < 0x2::bcs::peel_u64(&mut v1), 6003);
        0x2::balance::join<T0>(&mut arg2.balance, 0x2::coin::into_balance<T0>(arg7));
        let v4 = SubscriptionEvent{
            subscriber : v0,
            duration   : arg3,
            fee        : v3,
            class      : v2,
            nonce      : update_user_nonce(arg1, 0x2::bcs::peel_u8(&mut v1), 0x2::bcs::peel_u128(&mut v1)),
        };
