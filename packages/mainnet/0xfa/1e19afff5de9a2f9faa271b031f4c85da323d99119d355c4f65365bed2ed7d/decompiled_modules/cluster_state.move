module 0xfa1e19afff5de9a2f9faa271b031f4c85da323d99119d355c4f65365bed2ed7d::cluster_state {
    ...
    public fun get_fee(arg0: &State, arg1: &0x1::string::String, arg2: bool) : u64 {
        if (arg2 == true) {
            0xfa1e19afff5de9a2f9faa271b031f4c85da323d99119d355c4f65365bed2ed7d::xcall_utils::get_or_default<0x1::string::String, u64>(&arg0.message_fee, arg1, 0) + 0xfa1e19afff5de9a2f9faa271b031f4c85da323d99119d355c4f65365bed2ed7d::xcall_utils::get_or_default<0x1::string::String, u64>(&arg0.response_fee, arg1, 0)
        } else {
            0xfa1e19afff5de9a2f9faa271b031f4c85da323d99119d355c4f65365bed2ed7d::xcall_utils::get_or_default<0x1::string::String, u64>(&arg0.message_fee, arg1, 0)
        }
    }
    ...
    public(friend) fun verify_signatures(arg0: &State, arg1: 0x1::string::String, arg2: u128, arg3: vector<u8>, arg4: 0x1::string::String, arg5: vector<vector<u8>>) {
        let v0 = 0xfa1e19afff5de9a2f9faa271b031f4c85da323d99119d355c4f65365bed2ed7d::xcall_utils::get_message_hash(arg1, arg2, arg3, arg4);
