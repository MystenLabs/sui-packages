module 0xfac0a5336309d8df5e8e5fea811c127f7e331073a38ad3431fc751b26fc1f005::cnsnft8596 {
    struct CNSNFT8596 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8596, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8502"));
        let v4 = 0x2::package::claim<CNSNFT8596>(arg0, arg1);
