module 0xfa2fe409606d8eacdfafd7baf0ad7dc43de2a09d48965bd6ac90da37992e26e4::token {
    ...
    struct Vinsuicent has store, key {
        id: 0x2::object::UID,
        number: u64,
    ...
    public(friend) fun id(arg0: &Vinsuicent) : 0x2::object::ID {
        0x2::object::id<Vinsuicent>(arg0)
    }

    public(friend) fun attributes(arg0: &Vinsuicent) : &0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        &arg0.attributes
    }

    fun burn(arg0: Vinsuicent, arg1: &mut Supply, arg2: &Data) : 0x2::object::UID {
        let Vinsuicent {
            id         : v0,
            number     : v1,
            image      : _,
    ...
    public fun buy_on_curve(arg0: 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveBuyOrder<Vinsuicent>, arg1: &Data, arg2: &mut Supply, arg3: &mut 0x2::tx_context::TxContext) : (vector<Vinsuicent>, 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveBuyOrder<Vinsuicent>) {
        assert!(0x1::option::is_some<0x2::object::ID>(&arg1.curve), 0);
        let v0 = 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::buy_order_curve<Vinsuicent>(&arg0);
        assert!(&v0 == 0x1::option::borrow<0x2::object::ID>(&arg1.curve), 0);
        (mint(arg1, arg2, 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::buy_order_size<Vinsuicent>(&arg0), arg3), arg0)
    }
    ...
    public(friend) fun image(arg0: &Vinsuicent) : &0x1::string::String {
        &arg0.image
    }

    fun init(arg0: TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TOKEN>(arg0, arg1);
        let v1 = 0x2::display::new<Vinsuicent>(&v0, arg1);
        0x2::display::add<Vinsuicent>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"VinSUIcent #{number}"));
        0x2::display::add<Vinsuicent>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(x""));
        0x2::display::add<Vinsuicent>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"ipfs://{image}"));
        0x2::display::add<Vinsuicent>(&mut v1, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
        0x2::display::update_version<Vinsuicent>(&mut v1);
        let v2 = Supply{
        ...
        0x2::transfer::public_transfer<0x2::display::Display<Vinsuicent>>(v1, 0x2::tx_context::sender(arg1));
        0x2::transfer::transfer<ManagerCap>(v4, 0x2::tx_context::sender(arg1));
    }

    fun mint(arg0: &Data, arg1: &mut Supply, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : vector<Vinsuicent> {
        assert!(arg2 > 0 && arg2 <= 1000, 0);
        assert!(arg2 <= 0x1::vector::length<vector<u64>>(&arg1.bitmaps), 9223372706869673983);
        let v0 = 0;
        let v1 = 0x1::vector::empty<Vinsuicent>();
        while (v0 < arg2) {
            ...
            0x1::vector::push_back<Vinsuicent>(&mut v1, v7);
            v0 = v0 + 1;
        };
        v1
    }

    public(friend) fun number(arg0: &Vinsuicent) : u64 {
        arg0.number
    }
    ...
    public fun sell_on_curve(arg0: vector<Vinsuicent>, arg1: 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveSellOrder<Vinsuicent>, arg2: &mut Supply, arg3: &Data) : (vector<0x2::object::UID>, 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveSellOrder<Vinsuicent>) {
        assert!(0x1::option::is_some<0x2::object::ID>(&arg3.curve), 0);
        let v0 = 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::sell_order_curve<Vinsuicent>(&arg1);
        assert!(&v0 == 0x1::option::borrow<0x2::object::ID>(&arg3.curve), 0);
        let v1 = 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::sell_asset_ids<Vinsuicent>(&arg1);
        assert!(0x1::vector::length<0x2::object::ID>(&v1) == 0x1::vector::length<Vinsuicent>(&arg0), 0);
        let v2 = 0;
        let v3 = 0x1::vector::empty<0x2::object::UID>();
        while (v2 < 0x1::vector::length<0x2::object::ID>(&v1)) {
            let v4 = 0x1::vector::pop_back<Vinsuicent>(&mut arg0);
            assert!(id(&v4) == 0x1::vector::pop_back<0x2::object::ID>(&mut v1), 0);
            0x1::vector::push_back<0x2::object::UID>(&mut v3, burn(v4, arg2, arg3));
            v2 = v2 + 1;
        };
        0x1::vector::destroy_empty<Vinsuicent>(arg0);
