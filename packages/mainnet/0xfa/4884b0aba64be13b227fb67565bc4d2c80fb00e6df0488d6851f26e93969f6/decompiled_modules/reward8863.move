module 0xfa4884b0aba64be13b227fb67565bc4d2c80fb00e6df0488d6851f26e93969f6::reward8863 {
    struct REWARD8863 has drop {
        dummy_field: bool,
    }

    struct TICKET_8863 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8863(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8863>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8863>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8863, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8863>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8863>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8863>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8863>>(v5, 0x2::tx_context::sender(arg1));
    }
