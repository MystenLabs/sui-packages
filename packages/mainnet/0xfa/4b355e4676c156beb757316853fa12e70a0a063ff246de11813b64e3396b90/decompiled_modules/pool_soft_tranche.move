module 0xfa4b355e4676c156beb757316853fa12e70a0a063ff246de11813b64e3396b90::pool_soft_tranche {
    struct SuperAdminCap has store, key {
        id: 0x2::object::UID,
    }

    struct PoolSoftTrancheManager has store, key {
        id: 0x2::object::UID,
        version: u64,
        admins: 0x2::vec_set::VecSet<address>,
        pool_tranches: 0x2::table::Table<0x2::object::ID, vector<PoolSoftTranche>>,
    ...
    struct PoolSoftTranche has store, key {
        id: 0x2::object::UID,
    ...
    public fun new<T0, T1>(arg0: &mut PoolSoftTrancheManager, arg1: &0xa46f7dc3f1f0f4978d81c9c52757554f6f4dc62f65f2ce586be34409aa3b8168::pool::Pool<T0, T1>, arg2: bool, arg3: u128, arg4: vector<u64>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_admin(arg0, 0x2::tx_context::sender(arg6));
        let v0 = 0x2::object::id<0xa46f7dc3f1f0f4978d81c9c52757554f6f4dc62f65f2ce586be34409aa3b8168::pool::Pool<T0, T1>>(arg1);
        let v1 = PoolSoftTranche{
        ...
        if (!0x2::table::contains<0x2::object::ID, vector<PoolSoftTranche>>(&arg0.pool_tranches, v0)) {
            0x2::table::add<0x2::object::ID, vector<PoolSoftTranche>>(&mut arg0.pool_tranches, v0, 0x1::vector::empty<PoolSoftTranche>());
        };
        let v2 = 0x2::table::borrow_mut<0x2::object::ID, vector<PoolSoftTranche>>(&mut arg0.pool_tranches, v0);
        0x1::vector::push_back<PoolSoftTranche>(v2, v1);
        let v3 = CreatePoolTrancheEvent{
            tranche_id                          : 0x2::object::id<PoolSoftTranche>(&v1),
            pool_id                             : v0,
            volume_in_coin_a                    : arg2,
            total_volume                        : arg3,
            duration_profitabilities            : arg4,
            minimum_remaining_volume_percentage : arg5,
            index                               : 0x1::vector::length<PoolSoftTranche>(v2) - 1,
        };
        0x2::event::emit<CreatePoolTrancheEvent>(v3);
    }

    public fun add_admin(arg0: &SuperAdminCap, arg1: &mut PoolSoftTrancheManager, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun add_reward<T0>(arg0: &mut PoolSoftTrancheManager, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: u64, arg4: 0x2::balance::Balance<T0>, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        checked_package_version(arg0);
        ...
        add_reward_internal<T0>(v0, 0xfa4b355e4676c156beb757316853fa12e70a0a063ff246de11813b64e3396b90::soft_time_manager::epoch_start(arg3), arg4, arg5)
    }

    fun add_reward_internal<T0>(arg0: &mut PoolSoftTranche, arg1: u64, arg2: 0x2::balance::Balance<T0>, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        *0x2::table::borrow_mut<0x1::type_name::TypeName, u64>(0x2::table::borrow_mut<u64, 0x2::table::Table<0x1::type_name::TypeName, u64>>(&mut arg0.total_balance_epoch, arg1), v0) = *0x2::table::borrow<0x1::type_name::TypeName, u64>(0x2::table::borrow<u64, 0x2::table::Table<0x1::type_name::TypeName, u64>>(&arg0.total_balance_epoch, arg1), v0) + v1;
        let v3 = AddRewardEvent{
            tranche_id    : 0x2::object::id<PoolSoftTranche>(arg0),
            epoch_start   : arg1,
            reward_type   : v0,
            balance_value : v1,
            after_amount  : v2,
    ...
    public fun add_token_types_to_whitelist(arg0: &mut PoolSoftTrancheManager, arg1: vector<0x1::type_name::TypeName>, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
    ...
    public fun check_admin(arg0: &PoolSoftTrancheManager, arg1: address) {
        assert!(0x2::vec_set::contains<address>(&arg0.admins, &arg1), 9389469239702349);
    }

    public fun checked_package_version(arg0: &PoolSoftTrancheManager) {
        assert!(arg0.version == 1, 945973054793406234);
    }

    public(friend) fun fill_tranches(arg0: &mut PoolSoftTranche, arg1: u128) {
    ...
    public fun get_balance_amount<T0>(arg0: &mut PoolSoftTrancheManager, arg1: 0x2::object::ID, arg2: 0x2::object::ID) : u64 {
        let v0 = get_tranche_by_id(arg0, arg1, arg2);
    ...
    public fun get_duration_profitabilities(arg0: &PoolSoftTranche) : vector<u64> {
        arg0.duration_profitabilities
    }

    public fun get_free_volume(arg0: &PoolSoftTranche) : (u128, bool) {
        (arg0.total_volume - arg0.current_volume, arg0.volume_in_coin_a)
    }

    public fun get_ignore_whitelist_flag(arg0: &PoolSoftTrancheManager) : bool {
        arg0.ignore_whitelist
    }

    public fun get_osail_epoch(arg0: &PoolSoftTrancheManager, arg1: u64) : &0x1::type_name::TypeName {
    ...
    public(friend) fun get_reward_balance<T0>(arg0: &mut PoolSoftTrancheManager, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        checked_package_version(arg0);
        let v0 = get_tranche_by_id(arg0, arg1, arg2);
        let v1 = 0xfa4b355e4676c156beb757316853fa12e70a0a063ff246de11813b64e3396b90::soft_time_manager::epoch_start(arg5);
    ...
    fun get_tranche_by_id(arg0: &mut PoolSoftTrancheManager, arg1: 0x2::object::ID, arg2: 0x2::object::ID) : &mut PoolSoftTranche {
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, vector<PoolSoftTranche>>(&mut arg0.pool_tranches, arg1);
        let v1 = 0;
        while (v1 < 0x1::vector::length<PoolSoftTranche>(v0)) {
            let v2 = 0x1::vector::borrow_mut<PoolSoftTranche>(v0, v1);
            if (arg2 == 0x2::object::id<PoolSoftTranche>(v2)) {
                return v2
            };
            v1 = v1 + 1;
        };
    ...
    public(friend) fun get_tranches(arg0: &mut PoolSoftTrancheManager, arg1: 0x2::object::ID) : &mut vector<PoolSoftTranche> {
        0x2::table::borrow_mut<0x2::object::ID, vector<PoolSoftTranche>>(&mut arg0.pool_tranches, arg1)
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = PoolSoftTrancheManager{
            id                 : 0x2::object::new(arg0),
            version            : 1,
            admins             : 0x2::vec_set::empty<address>(),
            pool_tranches      : 0x2::table::new<0x2::object::ID, vector<PoolSoftTranche>>(arg0),
        ...
        0x2::transfer::share_object<PoolSoftTrancheManager>(v0);
        let v2 = InitTrancheManagerEvent{tranche_manager_id: 0x2::object::id<PoolSoftTrancheManager>(&v0)};
        0x2::event::emit<InitTrancheManagerEvent>(v2);
    }

    public fun is_admin(arg0: &PoolSoftTrancheManager, arg1: address) : bool {
        0x2::vec_set::contains<address>(&arg0.admins, &arg1)
    }

    public fun is_filled(arg0: &PoolSoftTranche) : bool {
        arg0.filled
    }

    public fun is_token_whitelisted(arg0: &PoolSoftTrancheManager, arg1: 0x1::type_name::TypeName) : bool {
        0x2::table::contains<0x1::type_name::TypeName, bool>(&arg0.whitelisted_tokens, arg1)
    }

    public fun remove_token_types_from_whitelist(arg0: &mut PoolSoftTrancheManager, arg1: vector<0x1::type_name::TypeName>, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_admin(arg0, 0x2::tx_context::sender(arg2));
        let v0 = 0;
        while (v0 < 0x1::vector::length<0x1::type_name::TypeName>(&arg1)) {
    ...
    public fun revoke_admin(arg0: &SuperAdminCap, arg1: &mut PoolSoftTrancheManager, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg1);
        check_admin(arg1, 0x2::tx_context::sender(arg3));
        assert!(0x2::vec_set::contains<address>(&arg1.admins, &arg2), 913497842032463613);
    ...
    public fun set_ignore_whitelist(arg0: &mut PoolSoftTrancheManager, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_admin(arg0, 0x2::tx_context::sender(arg2));
    ...
    public fun set_total_incomed_and_add_reward<T0, T1>(arg0: &mut PoolSoftTrancheManager, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: u64, arg4: 0x2::balance::Balance<T1>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : u64 {
        checked_package_version(arg0);
        check_admin(arg0, 0x2::tx_context::sender(arg6));
        let v0 = 0xfa4b355e4676c156beb757316853fa12e70a0a063ff246de11813b64e3396b90::soft_time_manager::epoch_start(arg3);
        let v1 = 0x1::type_name::get<T0>();
    ...
    public fun update_osail_epoch<T0>(arg0: &mut PoolSoftTrancheManager, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_admin(arg0, 0x2::tx_context::sender(arg2));
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun update_total_income_epoch(arg0: &mut PoolSoftTrancheManager, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_admin(arg0, 0x2::tx_context::sender(arg5));
        let v0 = 0xfa4b355e4676c156beb757316853fa12e70a0a063ff246de11813b64e3396b90::soft_time_manager::epoch_start(arg3);
    ...
    public fun update_tranche(arg0: &mut PoolSoftTrancheManager, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: bool, arg4: u128, arg5: vector<u64>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
