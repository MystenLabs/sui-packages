module 0xfaac37d855a8e62f5c990e24d4987ecdfddcb0c6df8aca9ead3e0de98f099df3::cnsnft5672 {
    struct CNSNFT5672 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5672, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5672>(arg0, arg1);
