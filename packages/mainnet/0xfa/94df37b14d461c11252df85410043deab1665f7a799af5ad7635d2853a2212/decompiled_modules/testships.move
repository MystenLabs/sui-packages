module 0xfa94df37b14d461c11252df85410043deab1665f7a799af5ad7635d2853a2212::testships {
    ...
    fun init(arg0: TESTSHIPS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"ship_type"));
        ...
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"{ship_type}"));
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"[{\"trait_type\": \"Rarity\", \"value\": \"{rarity}\"}, {\"trait_type\": \"Type\", \"value\": \"{ship_type}\"}, {\"trait_type\": \"Rank\", \"value\": \"{ship_rank}\"}, {\"trait_type\": \"Upgrades\", \"value\": \"{upgrades}\"}, {\"trait_type\": \"Specialisation\", \"value\": \"{specialisation}\"}]"));
    ...
    public fun upgrade(arg0: &UpgradeManager, arg1: vector<ShipNFT>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &Payout, arg4: &0x2::transfer_policy::TransferPolicy<ShipNFT>, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut Counter, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v27 = create_ship(arg7, v11.output_rank, v11.output_name, v11.output_description, v11.output_image_url, v11.output_rarity, v11.output_type, v11.output_speed, v11.output_attack, v11.output_defence, v11.output_health, v11.output_upgrades, v11.output_specialisation, arg8);
        0x2::kiosk::lock<ShipNFT>(arg5, arg6, arg4, v27);
        let v28 = ShipUpgraded{
            upgrader        : 0x2::tx_context::sender(arg8),
            new_ship_id     : v27.ship_id,
            new_ship_rank   : v11.output_rank,
            input_count     : v0,
            rule_input_type : string_to_bytes_copy(&v11.input_type),
            rule_input_rank : v11.input_rank,
        };
        0x2::event::emit<ShipUpgraded>(v28);
    }
