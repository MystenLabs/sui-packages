module 0x5d82cd59969c5d05952e5ea0942cb62f884ba4dc776db68245755baa130bf133::pivy_gift {
    ...
    public fun add_coin<T0>(arg0: &mut GiftStore, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::length<address>(&v0.item_ids) < 50, 7);
    ...
    public fun bag_item_count(arg0: &GiftBag) : u64 {
        0x2::vec_set::length<address>(&arg0.item_ids)
    }
    ...
    public fun create_bag(arg0: &mut GiftStore, arg1: address, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_item_count(arg0: &GiftStore, arg1: address) : u64 {
        assert!(0x2::table::contains<address, GiftBag>(&arg0.bags, arg1), 2);
        0x2::vec_set::length<address>(&0x2::table::borrow<address, GiftBag>(&arg0.bags, arg1).item_ids)
    }
