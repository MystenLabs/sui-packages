module 0xfab34ed7f1519fefe099b22525a0c32ebe42df86b6e8580208275365f08eaf73::state {
    ...
    public(friend) fun fulfill_dest_order<T0>(arg0: &mut State, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: address, arg4: address, arg5: address, arg6: u64, arg7: u64, arg8: address, arg9: u16, arg10: address, arg11: address, arg12: &mut 0x2::tx_context::TxContext) : u64 {
    ...
    public(friend) fun refund_source_order<T0>(arg0: &mut State, arg1: LockedFunds<T0>, arg2: address, arg3: address, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u64) {
        ...
        let v3 = v2;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v3, 0xfab34ed7f1519fefe099b22525a0c32ebe42df86b6e8580208275365f08eaf73::amount::denormalize_amount(v0.fee_cancel, arg4)), arg5), arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v3, arg5), v0.trader);
        0x2::object::delete(v1);
        (0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v3, 0xfab34ed7f1519fefe099b22525a0c32ebe42df86b6e8580208275365f08eaf73::amount::denormalize_amount(v0.fee_refund, arg4)), arg5), 0x2::balance::value<T0>(&v3))
    }
