module 0xfa72a2792f20ee3f67fba92e5fbb82f27472006ef07765ce7accf65e83adc726::custodian {
    ...
    public fun get_round_balance<T0>(arg0: &Custodian<T0>, arg1: u64) : u64 {
        0x2::balance::value<T0>(0x2::table::borrow<u64, 0x2::balance::Balance<T0>>(&arg0.rounds_balance, arg1))
    }
