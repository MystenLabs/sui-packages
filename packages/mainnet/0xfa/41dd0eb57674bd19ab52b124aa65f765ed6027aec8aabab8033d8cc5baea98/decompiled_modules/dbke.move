module 0xfa41dd0eb57674bd19ab52b124aa65f765ed6027aec8aabab8033d8cc5baea98::dbke {
    struct EE has copy, drop {
        e: u64,
        l: u64,
    }

    struct DOP has copy, drop {
        p: u64,
        q: u64,
        e: u64,
    }
    ...
    fun emo<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<DOP>, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: &0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        while (v13 < 0x1::vector::length<u64>(&arg7)) {
            let DOP {
                ...
                q : v15,
                e : v16,
            } = *0x1::vector::borrow<DOP>(&arg9, *0x1::vector::borrow<u64>(&arg7, v13));
            v13 = v13 + 1;
            if (v16 < arg10) {
                continue
            };
            ...
            let v18 = sp(&v7, &v6, arg12, v14, true, v8, v9);
            if (v18 == 0) {
                let v19 = EE{
                    e : 101,
                    l : 507,
            ...
            let (v20, v21) = vbac<T0, T1>(arg0, v10, v11, v12, arg12, arg13, arg11, v18, v15, true, true, true);
            if (v21 != 0) {
                if (v21 == 103 || v21 == 104) {
                    break
                };
            ...
            let v23 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg1, arg2, 18446744073709551615, v0, v1, v18, v20, true, true, v16, arg3, arg14);
            v10 = v10 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v23);
            v11 = v11 - (((0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v23) as u128) * (v18 as u128) / 1000000000 + 1) as u64);
            v12 = v12 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::paid_fees(&v23);
        };
        v13 = 0;
        while (v13 < 0x1::vector::length<u64>(&arg8)) {
            let DOP {
                ...
                q : v25,
                e : v26,
            } = *0x1::vector::borrow<DOP>(&arg9, *0x1::vector::borrow<u64>(&arg8, v13));
            v13 = v13 + 1;
            if (v26 < arg10) {
                continue
            };
            ...
            let v28 = sp(&v7, &v6, arg12, v24, false, v8, v9);
            if (v28 == 0) {
                let v29 = EE{
                    e : 101,
                    l : 600,
            ...
            let (v30, v31) = vbac<T0, T1>(arg0, v10, v11, v12, arg12, arg13, arg11, v28, v25, false, true, true);
            if (v31 != 0) {
                if (v31 == 102 || v31 == 104) {
                    break
                };
            ...
            let v33 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg1, arg2, 0, v0, v1, v28, v30, false, true, v26, arg3, arg14);
            v10 = v10 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v33);
            v11 = v11 + (((0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v33) as u128) * (v28 as u128) / 1000000000) as u64);
    ...
    fun eto<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<DOP>, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: &0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        while (v13 < 0x1::vector::length<u64>(&arg7)) {
            ...
            if (!vtop(v14, true, &v7, &v6, v8, v9)) {
                break
            };
            let (v19, v20) = vbac<T0, T1>(arg0, v10, v11, v12, arg12, arg13, arg11, v14, v15, true, false, true);
            if (v20 != 0) {
                let v21 = EE{
                    e : v20,
                    l : 327,
            ...
            let v22 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg1, arg2, 18446744073709551615, v0, v1, v14, v19, true, true, v16, arg3, arg14);
            v10 = v10 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v22);
            v11 = v11 - (((0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v22) as u128) * (v14 as u128) / 1000000000 + 1) as u64);
        ...
        while (v13 < 0x1::vector::length<u64>(&arg8)) {
            ...
            if (!vtop(v23, false, &v7, &v6, v8, v9)) {
                break
            };
            let (v28, v29) = vbac<T0, T1>(arg0, v10, v11, v12, arg12, arg13, arg11, v23, v24, false, false, true);
            if (v29 != 0) {
                let v30 = EE{
                    e : v29,
                    l : 410,
            ...
            let v31 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg1, arg2, 18446744073709551615, v0, v1, v23, v28, false, true, v25, arg3, arg14);
            v10 = v10 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v31);
            v11 = v11 + (((0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v31) as u128) * (v23 as u128) / 1000000000 + 1) as u64);
