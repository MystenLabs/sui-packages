module 0xfa38ea65dfc9f28fab8a545c0e65b99632a6bec5fe324576bab9e62cbe2cbc08::chad {
    ...
    fun init(arg0: CHAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<CHAD>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"CHAD    ")))), trim_right(b"CHAD                            "), trim_right(b"CHAD CHAD CHAD CHAD                                                                                                                                                                                                                                                                                                             "), v2, arg1);
