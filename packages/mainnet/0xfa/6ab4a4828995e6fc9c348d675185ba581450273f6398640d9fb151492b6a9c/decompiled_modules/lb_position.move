module 0xfa6ab4a4828995e6fc9c348d675185ba581450273f6398640d9fb151492b6a9c::lb_position {
    ...
    public(friend) fun add_total_fees_generated(arg0: &mut LBPositionInfo, arg1: u128) {
        arg0.fee_reward_info.total_fees_generated = 0xfa6ab4a4828995e6fc9c348d675185ba581450273f6398640d9fb151492b6a9c::safe_math::add_u128(arg0.fee_reward_info.total_fees_generated, arg1);
    }
    ...
    public(friend) fun decrease_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0xfa6ab4a4828995e6fc9c348d675185ba581450273f6398640d9fb151492b6a9c::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128, arg5: &0x2::clock::Clock) : u128 {
        ...
        0xfa6ab4a4828995e6fc9c348d675185ba581450273f6398640d9fb151492b6a9c::bin_manager::decrement_total_supply(arg1, arg3, arg4)
    }
    ...
    public fun get_total_pending_fees_with_growth(arg0: &LBPositionManager, arg1: &LBPosition, arg2: &vector<u32>, arg3: &vector<u128>, arg4: &vector<u128>) : (u64, u64) {
        ...
        while (v2 < 0x1::vector::length<u32>(arg2)) {
            ...
            v0 = 0xfa6ab4a4828995e6fc9c348d675185ba581450273f6398640d9fb151492b6a9c::safe_math::add_u64(v0, v3);
            v1 = 0xfa6ab4a4828995e6fc9c348d675185ba581450273f6398640d9fb151492b6a9c::safe_math::add_u64(v1, v4);
            v2 = v2 + 1;
        };
        (v0, v1)
    }
    ...
    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0xfa6ab4a4828995e6fc9c348d675185ba581450273f6398640d9fb151492b6a9c::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128) : u128 {
        let v0 = borrow_mut_position_info(arg0, 0x2::object::id<LBPosition>(arg2));
        if (0x2::table::contains<u32, LBBinPosition>(&v0.bins, arg3)) {
            let v1 = 0x2::table::borrow_mut<u32, LBBinPosition>(&mut v0.bins, arg3);
            v1.amount = 0xfa6ab4a4828995e6fc9c348d675185ba581450273f6398640d9fb151492b6a9c::safe_math::add_u128(v1.amount, arg4);
        } else {
        ...
        0xfa6ab4a4828995e6fc9c348d675185ba581450273f6398640d9fb151492b6a9c::bin_manager::increment_total_supply(arg1, arg3, arg4)
    }
