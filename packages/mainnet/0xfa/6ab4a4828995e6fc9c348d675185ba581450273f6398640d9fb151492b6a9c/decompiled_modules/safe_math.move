module 0xfa6ab4a4828995e6fc9c348d675185ba581450273f6398640d9fb151492b6a9c::safe_math {
    ...
    public fun sqrt_u128(arg0: u128) : u128 {
        ...
        let v0 = 1 << (0xfa6ab4a4828995e6fc9c348d675185ba581450273f6398640d9fb151492b6a9c::bit_math::most_significant_bit(arg0) + 1) / 2;
        let v1 = (arg0 / v0 + v0) / 2;
        while (v1 < v0) {
            let v2 = arg0 / v1 + v1;
            v1 = v2 / 2;
