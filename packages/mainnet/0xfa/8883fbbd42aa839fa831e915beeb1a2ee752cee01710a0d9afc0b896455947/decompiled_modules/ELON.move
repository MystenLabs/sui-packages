module 0xfa8883fbbd42aa839fa831e915beeb1a2ee752cee01710a0d9afc0b896455947::ELON {
    ...
    fun init(arg0: ELON, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<ELON>(arg0, 9, b"GBTC", b"Grayscale on SUI", b"Grayscale on SUI fund", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
