module 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::liquidity_mining {
    ...
    struct PoolReward has store, key {
        ...
        end_time_ms: u64,
        total_rewards: u64,
        allocated_rewards: 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::Decimal,
        cumulative_rewards_per_share: 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::Decimal,
    ...
    struct UserReward has store {
        ...
        earned_rewards: 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::Decimal,
        cumulative_rewards_per_share: 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::Decimal,
    }
    ...
    public(friend) fun add_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = PoolReward{
            ...
            allocated_rewards            : 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::from(0),
            cumulative_rewards_per_share : 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::from(0),
    ...
    public(friend) fun cancel_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: u64, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        0x2::balance::split<T0>(0x2::bag::borrow_mut<RewardBalance<T0>, 0x2::balance::Balance<T0>>(&mut v0.additional_fields, v1), 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::floor(0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::sub(0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::from(v0.total_rewards), v0.allocated_rewards)))
    }
    ...
    public(friend) fun change_user_reward_manager_share(arg0: &mut PoolRewardManager, arg1: &mut UserRewardManager, arg2: u64, arg3: &0x2::clock::Clock) {
        update_user_reward_manager(arg0, arg1, arg3, false);
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut PoolRewardManager, arg1: &mut UserRewardManager, arg2: &0x2::clock::Clock, arg3: u64) : 0x2::balance::Balance<T0> {
        ...
        let v3 = 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::floor(v2.earned_rewards);
        v2.earned_rewards = 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::sub(v2.earned_rewards, 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::from(v3));
    ...
    public fun earned_rewards(arg0: &UserReward) : 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::Decimal {
        arg0.earned_rewards
    }
    ...
    public(friend) fun new_user_reward_manager(arg0: &mut PoolRewardManager, arg1: &0x2::clock::Clock) : UserRewardManager {
        ...
        let v1 = &mut v0;
        update_user_reward_manager(arg0, v1, arg1, true);
        v0
    }
    ...
    public fun pool_rewards(arg0: &PoolRewardManager) : &vector<0x1::option::Option<PoolReward>> {
        &arg0.pool_rewards
    }

    public fun rewards(arg0: &UserRewardManager) : &vector<0x1::option::Option<UserReward>> {
        &arg0.rewards
    }
    ...
    fun update_pool_reward_manager(arg0: &mut PoolRewardManager, arg1: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<0x1::option::Option<PoolReward>>(&arg0.pool_rewards)) {
            ...
            let v4 = 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::div(0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::mul(0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::from(v3.total_rewards), 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::from(0x1::u64::min(v0, v3.end_time_ms) - 0x1::u64::max(v3.start_time_ms, arg0.last_update_time_ms))), 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::from(v3.end_time_ms - v3.start_time_ms));
            v3.allocated_rewards = 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::add(v3.allocated_rewards, v4);
            v3.cumulative_rewards_per_share = 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::add(v3.cumulative_rewards_per_share, 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::div(v4, 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::from(arg0.total_shares)));
            v1 = v1 + 1;
        };
        arg0.last_update_time_ms = v0;
    }

    fun update_user_reward_manager(arg0: &mut PoolRewardManager, arg1: &mut UserRewardManager, arg2: &0x2::clock::Clock, arg3: bool) {
        assert!(0x2::object::id<PoolRewardManager>(arg0) == arg1.pool_reward_manager_id, 0);
        update_pool_reward_manager(arg0, arg2);
        let v0 = 0x2::clock::timestamp_ms(arg2);
        if (!arg3 && v0 == arg1.last_update_time_ms) {
            return
        };
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::option::Option<PoolReward>>(&arg0.pool_rewards)) {
            ...
            let v3 = 0x1::option::borrow_mut<PoolReward>(v2);
            while (0x1::vector::length<0x1::option::Option<UserReward>>(&arg1.rewards) <= v1) {
            ...
            if (0x1::option::is_none<UserReward>(v4)) {
                if (arg1.last_update_time_ms <= v3.end_time_ms) {
                    let v5 = if (arg1.last_update_time_ms <= v3.start_time_ms) {
                        0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::mul(v3.cumulative_rewards_per_share, 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::from(arg1.share))
                    } else {
                ...
                v7.earned_rewards = 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::add(v7.earned_rewards, 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::mul(0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::sub(v3.cumulative_rewards_per_share, v7.cumulative_rewards_per_share), 0xfa8ac1e1b35adacbc0e2e7d4f761ef7b6c1e9b14db91af0617c889040022ac1c::decimal::from(arg1.share)));
