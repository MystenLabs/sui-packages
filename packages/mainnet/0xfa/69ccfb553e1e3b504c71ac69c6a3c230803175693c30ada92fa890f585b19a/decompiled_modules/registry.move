module 0xfa69ccfb553e1e3b504c71ac69c6a3c230803175693c30ada92fa890f585b19a::registry {
    ...
    public fun assert_valid_ledger<T0, T1>(arg0: &LedgerRegistry, arg1: &0xfa69ccfb553e1e3b504c71ac69c6a3c230803175693c30ada92fa890f585b19a::ledger::Ledger<T0, T1>) {
        assert!(is_valid_ledger(arg0, 0x2::object::id<0xfa69ccfb553e1e3b504c71ac69c6a3c230803175693c30ada92fa890f585b19a::ledger::Ledger<T0, T1>>(arg1)), 202);
    }

    public fun create_market<T0, T1>(arg0: &mut LedgerRegistry, arg1: &0xfa69ccfb553e1e3b504c71ac69c6a3c230803175693c30ada92fa890f585b19a::access_control::AdminCap, arg2: &0xfa69ccfb553e1e3b504c71ac69c6a3c230803175693c30ada92fa890f585b19a::access_control::CapabilityRegistry, arg3: &mut 0xfa69ccfb553e1e3b504c71ac69c6a3c230803175693c30ada92fa890f585b19a::token_validator::TokenRegistry, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: u8, arg7: u8, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        0xfa69ccfb553e1e3b504c71ac69c6a3c230803175693c30ada92fa890f585b19a::access_control::assert_admin_active(arg1, arg2);
        ...
        if (!0xfa69ccfb553e1e3b504c71ac69c6a3c230803175693c30ada92fa890f585b19a::token_validator::is_whitelisted<T0>(arg3)) {
            0xfa69ccfb553e1e3b504c71ac69c6a3c230803175693c30ada92fa890f585b19a::token_validator::add_token<T0>(arg1, arg2, arg3, arg4, arg6, arg8);
        };
        if (!0xfa69ccfb553e1e3b504c71ac69c6a3c230803175693c30ada92fa890f585b19a::token_validator::is_whitelisted<T1>(arg3)) {
            0xfa69ccfb553e1e3b504c71ac69c6a3c230803175693c30ada92fa890f585b19a::token_validator::add_token<T1>(arg1, arg2, arg3, arg5, arg7, arg8);
        };
        let v3 = 0xfa69ccfb553e1e3b504c71ac69c6a3c230803175693c30ada92fa890f585b19a::ledger::create<T0, T1>(arg3, arg8);
