module 0xf94d9b8ba3c02d501714a3ffc9996f76b39cfff0a5edcdfbcd2890e1bc5722e9::business_passport {
    struct BUSINESS_PASSPORT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BUSINESS_PASSPORT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BUSINESS_PASSPORT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Business Passport"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b" Exclusively for Business Passport Holders."));
