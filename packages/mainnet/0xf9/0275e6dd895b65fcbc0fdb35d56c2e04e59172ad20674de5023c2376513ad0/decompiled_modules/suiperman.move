module 0xf90275e6dd895b65fcbc0fdb35d56c2e04e59172ad20674de5023c2376513ad0::suiperman {
    ...
    fun init(arg0: SUIPERMAN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::option::fill<0x2::url::Url>(&mut v1, 0x2::url::new_unsafe_from_bytes(b"https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Superman_S_symbol.svg/1200px-Superman_S_symbol.svg.png"));
        let (v2, v3) = 0x2::coin::create_currency<SUIPERMAN>(arg0, 8, b"Suip", b"Suiperman", b"Sui Gem", v1, arg1);
        let v4 = v2;
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<SUIPERMAN>>(v3);
        0x2::coin::mint_and_transfer<SUIPERMAN>(&mut v4, 30000000000000000, v0, arg1);
