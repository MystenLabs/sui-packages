module 0x402d954bdff9665b7cafefc6f6df87dcfcbaf32d68b76fdb32479c5cdaa27f6a::utils {
    ...
    public fun check_coin_threshold_v2<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<T0>(arg0) >= (((arg1 as u128) * (1000000 - (arg2 as u128)) / 1000000) as u64), 1);
    }
