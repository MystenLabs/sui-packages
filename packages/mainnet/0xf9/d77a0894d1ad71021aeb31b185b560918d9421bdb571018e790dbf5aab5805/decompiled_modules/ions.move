module 0xf9d77a0894d1ad71021aeb31b185b560918d9421bdb571018e790dbf5aab5805::ions {
    ...
    struct AnimaChef has key {
        id: 0x2::object::UID,
        version: u64,
        anima_ions: 0x2::linked_table::LinkedTable<address, address>,
        ongoing_season: u64,
    ...
    public fun claim_rewards<T0>(arg0: &0x2::clock::Clock, arg1: &mut AnimaChef, arg2: &mut AnimaIONs, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::dynamic_object_field::exists_<vector<u8>>(&arg1.id, b"ANIMA_REWARDS_HOLDER"), 13906836884468596750);
    ...
    public fun get_user_anima_ions_id(arg0: &AnimaChef, arg1: address) : 0x1::option::Option<address> {
        if (0x2::linked_table::contains<address, address>(&arg0.anima_ions, arg1)) {
            0x1::option::some<address>(*0x2::linked_table::borrow<address, address>(&arg0.anima_ions, arg1))
        } else {
    ...
    public fun has_anima_ions(arg0: &AnimaChef, arg1: address) : bool {
        0x2::linked_table::contains<address, address>(&arg0.anima_ions, arg1)
    }
    ...
    fun increment_global_claim_index(arg0: &0x2::clock::Clock, arg1: &mut SeasonRewards) {
        ...
        if (arg1.total_points > 0) {
            arg1.global_claim_index = arg1.global_claim_index + 0xf9d77a0894d1ad71021aeb31b185b560918d9421bdb571018e790dbf5aab5805::math::mul_div_u256(((v0 - arg1.last_time) as u256), (arg1.rewards_distribution_rate as u256) * (1000000000 as u256), (arg1.total_points as u256));
        };
        arg1.last_time = v0;
    }

    fun increment_user_claim_index(arg0: &SeasonRewards, arg1: &mut UserSeasonInfo) : u64 {
        let v0 = (0xf9d77a0894d1ad71021aeb31b185b560918d9421bdb571018e790dbf5aab5805::math::mul_div_u256(arg0.global_claim_index - arg1.claim_index, (arg1.points_earned as u256), (1000000000 as u256)) as u64);
    ...
    fun init(arg0: IONS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<AnimaIONs>(&mut v2, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"ION"));
        0x2::display::add<AnimaIONs>(&mut v2, 0x1::string::utf8(b"description"), 0x1::string::utf8(x"4120706f696e74732073797374656d207468617420726577617264732070617274696369706174696f6e2c20656e676167656d656e742c20616e642076616c75652d64726976656e20616374696f6e73206f6e20416e696d61e2809973204e65787573206d61726b6574706c6163652e"));
        0x2::display::add<AnimaIONs>(&mut v2, 0x1::string::utf8(b"quantity"), 0x1::string::utf8(b"0"));
        0x2::display::add<AnimaIONs>(&mut v2, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://assets.anima.nexus/static/ion.webp"));
        0x2::display::add<AnimaIONs>(&mut v2, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(b"https://anima.nexus"));
        0x2::display::add<AnimaIONs>(&mut v2, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"Anima Labs"));
        0x2::display::add<AnimaIONs>(&mut v2, 0x1::string::utf8(b"ion_points"), 0x1::string::utf8(b"{ion_points}"));
    ...
    public fun init_anima_chef(arg0: &AdminCap, arg1: &0x2::clock::Clock, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = AnimaChef{
            ...
            version        : 0,
            anima_ions     : 0x2::linked_table::new<address, address>(arg3),
            ongoing_season : 0,
    ...
    public fun init_new_season<T0>(arg0: &AdminCap, arg1: &mut AnimaChef, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64) {
        ...
        assert!(0x2::linked_table::borrow<u64, SeasonRewards>(&arg1.season_alloc, arg1.ongoing_season).end_time < v0, 13906835707647033350);
        assert!(arg3 > v0, 13906835720532197386);
        assert!(arg4 > v0 && arg4 > arg3, 13906835724827295756);
        ...
        assert!(v2.total_deposited - v2.allocated_amount >= v4, 13906835836495921156);
    ...
    public fun mint_anima_ions(arg0: &0x2::clock::Clock, arg1: &mut AnimaChef, arg2: 0x1::option::Option<address>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = arg1.ongoing_season;
        assert!(!0x2::linked_table::contains<address, address>(&arg1.anima_ions, v0), 13906836386252783636);
        let v2 = if (0x1::option::is_some<address>(&arg2)) {
            assert!(*0x1::option::borrow<address>(&arg2) != v0, 13906836424907358226);
            arg2
        } else {
            0x1::option::none<address>()
        };
        ...
        0x2::linked_table::push_back<address, address>(&mut arg1.anima_ions, v0, 0x2::object::uid_to_address(&v3.id));
        ...
        if (v0 > 0 && v0 > v1) {
            ...
            let v4 = if (!v2.is_time_based_distribution) {
                if (v2.total_points > 0) {
                    (0xf9d77a0894d1ad71021aeb31b185b560918d9421bdb571018e790dbf5aab5805::math::mul_div_u256((v3.points_earned as u256), (v2.rewards_allocated as u256), (v2.total_points as u256)) as u64)
                } else {
                    0
                }
            } else {
                v3.claim_index = v2.global_claim_index;
                (0xf9d77a0894d1ad71021aeb31b185b560918d9421bdb571018e790dbf5aab5805::math::mul_div_u256(v2.global_claim_index - v3.claim_index, (v3.points_earned as u256), (1000000000 as u256)) as u64)
            };
            ...
            if (0x2::linked_table::contains<u64, UserSeasonInfo>(&arg2.season_info, v2)) {
                ...
                if (!v5.is_time_based_distribution) {
                    if (v5.total_points > 0) {
                        v4 = v3 + (0xf9d77a0894d1ad71021aeb31b185b560918d9421bdb571018e790dbf5aab5805::math::mul_div_u256((v6.points_earned as u256), (v5.rewards_allocated as u256), (v5.total_points as u256)) as u64) - v6.claimed_amount;
                    };
                } else {
                    v4 = v3 + (0xf9d77a0894d1ad71021aeb31b185b560918d9421bdb571018e790dbf5aab5805::math::mul_div_u256(v5.global_claim_index - v6.claim_index, (v6.points_earned as u256), (1000000000 as u256)) as u64);
                };
            };
        };
        if (0x2::linked_table::contains<u64, SeasonRewards>(&arg1.season_alloc, v1) && 0x2::linked_table::contains<u64, UserSeasonInfo>(&arg2.season_info, v1)) {
            ...
            if (!v9 && !(v7.start_time > v0)) {
                if (v7.is_time_based_distribution && v7.total_points > 0) {
                    v4 = v4 + (0xf9d77a0894d1ad71021aeb31b185b560918d9421bdb571018e790dbf5aab5805::math::mul_div_u256(v7.global_claim_index + 0xf9d77a0894d1ad71021aeb31b185b560918d9421bdb571018e790dbf5aab5805::math::mul_div_u256(((v0 - v7.last_time) as u256), (((v7.rewards_distribution_rate as u256) * 1000000000) as u256), (v7.total_points as u256)) - v8.claim_index, (v8.points_earned as u256), (1000000000 as u256)) as u64);
                };
            };
        };
        v4
    ...
    public fun update_ongoing_season_rewards<T0>(arg0: &AdminCap, arg1: &mut AnimaChef, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64) {
        ...
        assert!(v1.end_time > v0, 13906836094194221064);
        assert!(0x2::dynamic_object_field::exists_<vector<u8>>(&arg1.id, b"ANIMA_REWARDS_HOLDER"), 13906836107079516174);
        let v2 = 0x2::dynamic_object_field::borrow_mut<vector<u8>, RewardsHolder<T0>>(&mut arg1.id, b"ANIMA_REWARDS_HOLDER");
        let v3 = 0;
        let v4 = false;
        ...
        if (v4) {
            assert!(v2.total_deposited - v2.allocated_amount >= v3, 13906836278877552644);
    ...
    public fun update_ongoing_season_time(arg0: &AdminCap, arg1: &mut AnimaChef, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64) {
        ...
        let v1 = 0x2::linked_table::borrow_mut<u64, SeasonRewards>(&mut arg1.season_alloc, arg1.ongoing_season);
        if (arg3 > 0) {
            assert!(v1.start_time > v0 && arg3 > v0, 13906835956755398666);
            v1.start_time = arg3;
        };
        if (arg4 > 0) {
            if (v1.end_time == 0) {
                assert!(arg4 > v0, 13906835995410235404);
            } else {
                assert!(v1.end_time > v0 && arg4 > v0, 13906836008295137292);
            };
            v1.end_time = arg4;
        };
    ...
    public fun validation_check(arg0: &mut AnimaChef) {
        assert!(arg0.version == 0, 13906837494354083856);
    }
