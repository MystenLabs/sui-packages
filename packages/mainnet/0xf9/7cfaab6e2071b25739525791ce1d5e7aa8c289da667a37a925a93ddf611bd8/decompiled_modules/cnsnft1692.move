module 0xf97cfaab6e2071b25739525791ce1d5e7aa8c289da667a37a925a93ddf611bd8::cnsnft1692 {
    struct CNSNFT1692 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1692, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1692>(arg0, arg1);
