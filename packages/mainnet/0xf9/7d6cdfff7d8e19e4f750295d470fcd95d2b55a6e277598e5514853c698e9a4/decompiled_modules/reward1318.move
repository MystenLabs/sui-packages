module 0xf97d6cdfff7d8e19e4f750295d470fcd95d2b55a6e277598e5514853c698e9a4::reward1318 {
    struct REWARD1318 has drop {
        dummy_field: bool,
    }

    struct TICKET_1318 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1318(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1318>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1318>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1318, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1318>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1318>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1318>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1318>>(v5, 0x2::tx_context::sender(arg1));
    }
