module 0xf988c657a19018596def38591020a64b4b3845acdd52283c206079d3bfeb2220::cnsnft4733 {
    struct CNSNFT4733 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4733, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4733>(arg0, arg1);
