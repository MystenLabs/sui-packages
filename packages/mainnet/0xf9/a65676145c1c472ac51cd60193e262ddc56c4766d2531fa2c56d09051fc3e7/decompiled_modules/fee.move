module 0xf9a65676145c1c472ac51cd60193e262ddc56c4766d2531fa2c56d09051fc3e7::fee {
    ...
    fun assert_reachable(arg0: bool, arg1: address) {
        if (arg0) {
            assert!(arg1 != @0x0, 0xf9a65676145c1c472ac51cd60193e262ddc56c4766d2531fa2c56d09051fc3e7::errors::invalid_fee_recipient());
        };
    }

    public fun assert_valid_version(arg0: &FeeConfig) {
        assert!(arg0.version == 1, 0xf9a65676145c1c472ac51cd60193e262ddc56c4766d2531fa2c56d09051fc3e7::errors::invalid_version());
    }
    ...
    public fun migrate(arg0: &AdminCap, arg1: &mut FeeConfig) {
        assert!(arg1.version < 1, 0xf9a65676145c1c472ac51cd60193e262ddc56c4766d2531fa2c56d09051fc3e7::errors::invalid_version());
        arg1.version = 1;
    }

    public fun set_fee_config(arg0: &AdminCap, arg1: &mut FeeConfig, arg2: bool, arg3: u32, arg4: address) {
        assert!(arg3 <= 20000, 0xf9a65676145c1c472ac51cd60193e262ddc56c4766d2531fa2c56d09051fc3e7::errors::too_large_fee_rate());
    ...
    public fun set_fee_rate(arg0: &AdminCap, arg1: &mut FeeConfig, arg2: u32) {
        assert!(arg2 <= 20000, 0xf9a65676145c1c472ac51cd60193e262ddc56c4766d2531fa2c56d09051fc3e7::errors::too_large_fee_rate());
        arg1.fee_rate = arg2;
