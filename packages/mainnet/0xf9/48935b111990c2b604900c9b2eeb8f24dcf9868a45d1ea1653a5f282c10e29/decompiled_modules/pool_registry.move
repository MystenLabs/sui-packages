module 0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool_registry {
    ...
    public(friend) fun assert_correct_package(arg0: &PoolRegistry) {
        assert!(arg0.protocol_version <= 3, 63);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<u64, PoolRegistryStateV1>(&mut v0.id, 3, v1);
    ...
    public fun upgrade(arg0: &mut PoolRegistry, arg1: &0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::admin::AdminCap) {
        assert!(arg0.protocol_version == 3 - 1, 62);
        0x2::dynamic_object_field::add<u64, PoolRegistryStateV1>(&mut arg0.id, 3, 0x2::dynamic_object_field::remove<u64, PoolRegistryStateV1>(&mut arg0.id, 3 - 1));
        arg0.protocol_version = 3;
    }
