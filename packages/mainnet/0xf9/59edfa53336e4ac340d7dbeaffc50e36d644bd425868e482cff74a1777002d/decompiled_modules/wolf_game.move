module 0xf959edfa53336e4ac340d7dbeaffc50e36d644bd425868e482cff74a1777002d::wolf_game {
    ...
    fun init(arg0: WOLF_GAME, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"PEPEWolfGame#{idx}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://wolfgame.s3.amazonaws.com/{type}/{idx}.svg"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"PEPE Wolf Game is a fun. Come on!"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://pepewolfgame.vip"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"PEPE Wolf Game"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://pepewolfgame.vip/game.png"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"PEPE Wolf Game"));
    ...
    public entry fun remove_from_stake(arg0: &mut WolfGameMaintainer, arg1: &mut 0x2::coin::TreasuryCap<0xf959edfa53336e4ac340d7dbeaffc50e36d644bd425868e482cff74a1777002d::exp::EXP>, arg2: vector<0x2::object::ID>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 > 0) {
            ...
            0xf959edfa53336e4ac340d7dbeaffc50e36d644bd425868e482cff74a1777002d::exp::mint(arg1, (v7 - v5) / 1000 * arg0.exp_eta, 0x2::tx_context::sender(arg4), arg4);
            v0 = v0 - 1;
        };
