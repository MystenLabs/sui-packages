module 0xf9af445f0e3fe9d247b6745d5912582ec2e5c918e0b5d4a953d6c2487e7bf0ed::dca {
    ...
    public fun new<T0, T1, T2: drop>(arg0: &TradePolicy, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u8, arg6: u64, arg7: u64, arg8: u64, arg9: address, arg10: &mut 0x2::tx_context::TxContext) : DCA<T0, T1> {
        ...
        let v1 = 0xd5cd31f4bf84a2c280c9ed20cbb20345cbe5c1ebe63014c406f97b20edd4ac63::math64::div_down(0x2::coin::value<T0>(&arg2), arg4);
        assert!(arg4 != 0 && v1 != 0, 14);
        let v2 = DCA<T0, T1>{
        ...
        let v3 = Start{
            ...
            every        : arg3,
            time_scale   : arg5,
            input_amount : 0x2::balance::value<T0>(&v2.input_balance),
            dca          : 0x2::object::id_address<DCA<T0, T1>>(&v2),
            delegatee    : arg9,
        };
        0x2::event::emit<Start>(v3);
        v2
    }
    ...
    fun resolve<T0, T1>(arg0: &mut DCA<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::balance::split<T1>(&mut v2, 0xd5cd31f4bf84a2c280c9ed20cbb20345cbe5c1ebe63014c406f97b20edd4ac63::math64::mul_div_up(v1, arg0.fee_percent, 1000000000));
    ...
    fun take<T0, T1>(arg0: &mut DCA<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.input_balance, 0xd5cd31f4bf84a2c280c9ed20cbb20345cbe5c1ebe63014c406f97b20edd4ac63::math64::min(arg0.amount_per_trade, 0x2::balance::value<T0>(&arg0.input_balance))), arg1)
    }
