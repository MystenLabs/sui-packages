module 0xf9f52fdb675f5817f8448b4ca18c9079312303e494d53f288c7d6522220a778f::vault {
    ...
    public fun buy_share<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0xf9f52fdb675f5817f8448b4ca18c9079312303e494d53f288c7d6522220a778f::stingray::Stingray, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0xf9f52fdb675f5817f8448b4ca18c9079312303e494d53f288c7d6522220a778f::collector::fill_balance<T0>(v5, &mut v1);
        let v6 = 0xce36dcf1d175659e78e42e3478e6fea3110fc3914bb70210df51dec9ef3d6c37::float::floor(0xce36dcf1d175659e78e42e3478e6fea3110fc3914bb70210df51dec9ef3d6c37::float::mul(0xce36dcf1d175659e78e42e3478e6fea3110fc3914bb70210df51dec9ef3d6c37::float::from_fraction(0x2::balance::supply_value<T1>(&arg0.supply), v2 - v3 + v4), 0xce36dcf1d175659e78e42e3478e6fea3110fc3914bb70210df51dec9ef3d6c37::float::from(v0)));
        let v7 = 0x2::balance::increase_supply<T1>(&mut arg0.supply, v6);
        add_to_reserve<T0, T1, T0>(arg0, v1);
        let v8 = &mut arg0.reserve_record;
        add_amount(v8, 0x1::type_name::into_string(0x1::type_name::get<T0>()), 0x2::balance::value<T0>(&v1));
        0xf9f52fdb675f5817f8448b4ca18c9079312303e494d53f288c7d6522220a778f::vault_event::buy_share_event<T0, ShareMetadata>(*0x2::object::uid_as_inner(&arg0.id), v0, v6);
        0x2::coin::from_balance<T1>(v7, arg4)
    }
