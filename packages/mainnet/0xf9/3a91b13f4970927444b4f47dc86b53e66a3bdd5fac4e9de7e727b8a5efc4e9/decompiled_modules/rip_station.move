module 0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::rip_station {
    ...
    struct CreditBalancesKey has copy, drop, store {
        dummy_field: bool,
    }

    struct PaymentBalanceKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    struct CardRedeemReturnedEvent has copy, drop {
        order_id: 0x1::string::String,
        card_id: 0x2::object::ID,
        kiosk_id: 0x2::object::ID,
    }
    ...
    struct PacksBoughtForCreditsOrderEvent has copy, drop {
        order_id: u128,
    }
    ...
    public(friend) entry fun deposit_balance(arg0: &mut Store, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>) {
        verify_version(arg0);
    ...
    entry fun buy_packs_for_credits<T0>(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut Store, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: bool, arg7: u128, arg8: u64, arg9: vector<u8>, arg10: &mut 0x2::tx_context::TxContext) {
        verify_version(arg2);
        let v0 = get_payment_for_credits(arg2, arg5 * arg4, arg10);
        buy_packs<T0>(arg0, arg1, arg2, arg3, arg4, arg5, v0, arg6, arg7, arg8, arg9, arg10);
        let v1 = PacksBoughtForCreditsOrderEvent{order_id: arg7};
        0x2::event::emit<PacksBoughtForCreditsOrderEvent>(v1);
    }

    entry fun buy_packs_for_credits_with_personal_kiosk<T0>(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut Store, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg8: bool, arg9: u128, arg10: u64, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        verify_version(arg2);
        let v0 = get_payment_for_credits(arg2, arg5 * arg4, arg12);
        buy_packs_with_personal_kiosk<T0>(arg0, arg1, arg2, arg3, arg4, arg5, v0, arg6, arg7, arg8, arg9, arg10, arg11, arg12);
        let v1 = PacksBoughtForCreditsOrderEvent{order_id: arg9};
        0x2::event::emit<PacksBoughtForCreditsOrderEvent>(v1);
    }
    ...
    public(friend) fun buy_packs_into_kiosk<T0>(arg0: &0x2::random::Random, arg1: &mut Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) : vector<0x2::object::ID> {
        verify_version(arg1);
        assert!(0x2::table::contains<0x1::string::String, 0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::vault::Vault>(&arg1.vaults, arg2), 10);
    ...
    fun credit_balances_mut(arg0: &mut Store) : &mut 0x2::table::Table<address, u64> {
        let v0 = CreditBalancesKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<CreditBalancesKey, 0x2::table::Table<address, u64>>(&mut arg0.id, v0)
    }
    ...
    entry fun deposit_credits(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: address, arg3: u64, arg4: u128, arg5: u64, arg6: vector<u8>, arg7: &0x2::tx_context::TxContext) {
        verify_version(arg1);
        verify_operator(arg1, arg7);
        assert!(0x2::clock::timestamp_ms(arg0) < arg5, 6);
        ...
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u64>(&arg5));
        assert!(0x2::ed25519::ed25519_verify(&arg6, &arg1.public_key, &v0), 4);
        let v2 = credit_balances_mut(arg1);
        0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::credit::deposit_balance(v2, arg2, arg3);
        0x2::table::add<u128, bool>(&mut arg1.orders, arg4, true);
    }

    entry fun deposit_payment_balance(arg0: &mut Store, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>) {
        verify_version(arg0);
        0x2::balance::join<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(payment_balance_mut(arg0), 0x2::coin::into_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg1));
    }
    ...
    fun get_payment_for_credits(arg0: &mut Store, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC> {
        let v0 = credit_balances_mut(arg0);
        0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::credit::withdraw_balance(v0, 0x2::tx_context::sender(arg2), arg1);
        0x2::coin::from_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(0x2::balance::split<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(payment_balance_mut(arg0), arg1), arg2)
    }

    public(friend) fun get_transfer_policy<T0>(arg0: &Store) : &0x2::transfer_policy::TransferPolicy<0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::card::Card<T0>> {
        0x2::bag::borrow<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::card::Card<T0>>>(&arg0.transfer_policies, 0x1::type_name::with_defining_ids<T0>())
    }
    ...
    entry fun init_extra_balances(arg0: &mut Store, arg1: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        verify_operator(arg0, arg1);
        let v0 = CreditBalancesKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists_<CreditBalancesKey>(&arg0.id, v0), 20);
        let v1 = CreditBalancesKey{dummy_field: false};
        0x2::dynamic_field::add<CreditBalancesKey, 0x2::table::Table<address, u64>>(&mut arg0.id, v1, 0x2::table::new<address, u64>(arg1));
        let v2 = PaymentBalanceKey{dummy_field: false};
        0x2::dynamic_field::add<PaymentBalanceKey, 0x2::balance::Balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(&mut arg0.id, v2, 0x2::balance::zero<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>());
    }
    ...
    fun payment_balance_mut(arg0: &mut Store) : &mut 0x2::balance::Balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC> {
        let v0 = PaymentBalanceKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<PaymentBalanceKey, 0x2::balance::Balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(&mut arg0.id, v0)
    }
    ...
    public(friend) fun remove_card_from_kiosk<T0>(arg0: &Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) : 0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::card::Card<T0> {
    ...
    public fun return_redeem_card<T0>(arg0: &Store, arg1: 0x1::string::String, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &0x2::tx_context::TxContext) {
        verify_version(arg0);
        verify_operator(arg0, arg6);
        assert!(0x2::kiosk_extension::is_installed<RipStationExt>(arg3), 15);
        let v0 = RipStationExt{dummy_field: false};
        let v1 = 0x2::kiosk_extension::storage_mut<RipStationExt>(v0, arg3);
        let v2 = RedeemTicket{
            card_id  : arg2,
            order_id : arg1,
        };
        assert!(0x2::bag::contains<RedeemTicket>(v1, v2), 16);
        0x2::kiosk::lock<0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::card::Card<T0>>(arg4, arg5, 0x2::bag::borrow<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::card::Card<T0>>>(&arg0.transfer_policies, 0x1::type_name::with_defining_ids<T0>()), 0x2::bag::remove<RedeemTicket, 0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::card::Card<T0>>(v1, v2));
        let v3 = CardRedeemReturnedEvent{
            order_id : arg1,
            card_id  : arg2,
            kiosk_id : 0x2::object::id<0x2::kiosk::Kiosk>(arg4),
        };
        0x2::event::emit<CardRedeemReturnedEvent>(v3);
    }
    ...
    public fun sell_card_for_credits<T0>(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: u128, arg3: 0x2::object::ID, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: vector<u8>, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &mut 0x2::tx_context::TxContext) {
        verify_version(arg1);
        assert!(0x2::clock::timestamp_ms(arg0) < arg7, 6);
        assert!(!0x2::table::contains<u128, bool>(&arg1.orders, arg2), 5);
        let v0 = 0x1::vector::empty<u8>();
        ...
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u64>(&arg6));
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u64>(&arg7));
        0x1::vector::append<u8>(&mut v0, b"credits");
        assert!(0x2::ed25519::ed25519_verify(&arg8, &arg1.public_key, &v0), 4);
        assert!(arg4 + arg5 + arg6 <= 0x2::balance::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&arg1.balance), 3);
        let v2 = 0x2::balance::split<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg1.balance, arg4);
        let v3 = payment_balance_mut(arg1);
        0x2::balance::join<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(v3, v2);
        let v4 = credit_balances_mut(arg1);
        0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::credit::deposit_balance(v4, 0x2::tx_context::sender(arg11), arg4);
        0x2::balance::send_funds<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(0x2::balance::split<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg1.balance, arg5), arg1.fee_receiver);
        0x2::balance::send_funds<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(0x2::balance::split<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg1.balance, arg6), arg1.royalty_receiver);
        0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::card::burn_card<T0>(remove_card_from_kiosk<T0>(arg1, arg9, arg10, arg3, arg11), true);
        let v5 = CardSoldEvent{
            card_id  : arg3,
            order_id : arg2,
            price    : arg4,
            fee      : arg5,
        };
        0x2::event::emit<CardSoldEvent>(v5);
        0x2::table::add<u128, bool>(&mut arg1.orders, arg2, true);
    }
    ...
    public(friend) fun verify_operator(arg0: &Store, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.operator == 0x2::tx_context::sender(arg1), 2);
    }

    public(friend) fun verify_order(arg0: &mut Store, arg1: u128) {
        assert!(!0x2::table::contains<u128, bool>(&arg0.orders, arg1), 5);
        0x2::table::add<u128, bool>(&mut arg0.orders, arg1, true);
    }

    public(friend) fun verify_signature(arg0: &Store, arg1: vector<u8>, arg2: vector<u8>) {
        assert!(0x2::ed25519::ed25519_verify(&arg2, &arg0.public_key, &arg1), 4);
    }

    public(friend) fun verify_vault(arg0: &Store, arg1: 0x1::string::String) {
        assert!(0x2::table::contains<0x1::string::String, 0xa6d2695f4c006319e80bae63dc6ddce47c1c164db13101f59fe70aa7f57651b5::vault::Vault>(&arg0.vaults, arg1), 10);
        assert!(0x2::table::contains<0x1::string::String, Config>(&arg0.vault_configs, arg1), 11);
    }

    public(friend) fun verify_version(arg0: &Store) {
