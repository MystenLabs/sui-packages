module 0xf93c96d3978770bcae45ccb8255fb8a8f72e467bed77a0dc08a1ca2a794eda77::reward2250 {
    struct REWARD2250 has drop {
        dummy_field: bool,
    }

    struct TICKET_2250 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2250(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2250>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2250>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2250, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2250>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2250>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2250>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2250>>(v5, 0x2::tx_context::sender(arg1));
    }
