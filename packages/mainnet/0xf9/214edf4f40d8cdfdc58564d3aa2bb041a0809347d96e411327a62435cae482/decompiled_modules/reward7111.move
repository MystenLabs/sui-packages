module 0xf9214edf4f40d8cdfdc58564d3aa2bb041a0809347d96e411327a62435cae482::reward7111 {
    struct REWARD7111 has drop {
        dummy_field: bool,
    }

    struct TICKET_7111 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7111(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7111>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7111>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7111, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7111>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7111>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7111>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7111>>(v5, 0x2::tx_context::sender(arg1));
    }
