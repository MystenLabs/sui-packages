module 0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::nest {
    ...
    public entry fun clear_stale_stake(arg0: &mut Nest, arg1: &0x2::kiosk::Kiosk, arg2: &mut HarvestStats, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::kiosk::has_item_with_type<0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::duck_nft::DuckNFT>(arg1, v1), 1);
    ...
    public entry fun harvest_duck(arg0: &mut Nest, arg1: &0x2::kiosk::Kiosk, arg2: &mut HarvestStats, arg3: &0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::NestMintCap, arg4: &mut 0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::SharedTreasury, arg5: &0x2::random::Random, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(arg0.owner == v0, 6);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.staked_duck_id), 13);
        let v1 = *0x1::option::borrow<0x2::object::ID>(&arg0.staked_duck_id);
        assert!(0x2::kiosk::has_item_with_type<0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::duck_nft::DuckNFT>(arg1, v1), 2);
        ...
        if (v10 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::SHTTOKEN>>(0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::mint_for_nest(arg3, arg4, v10, arg7), v0);
        };
    ...
    public fun is_staked_duck_in_kiosk(arg0: &Nest, arg1: &0x2::kiosk::Kiosk) : (bool, bool) {
        if (0x1::option::is_none<0x2::object::ID>(&arg0.staked_duck_id)) {
            ...
            (true, 0x2::kiosk::has_item_with_type<0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::duck_nft::DuckNFT>(arg1, *0x1::option::borrow<0x2::object::ID>(&arg0.staked_duck_id)))
        }
    }
    ...
    public entry fun stake_duck(arg0: &0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut Nest, arg4: &mut HarvestStats, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<0x2::object::ID>(&arg3.staked_duck_id)) {
            if (0x2::kiosk::has_item_with_type<0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::duck_nft::DuckNFT>(arg0, *0x1::option::borrow<0x2::object::ID>(&arg3.staked_duck_id))) {
                abort 12
            };
        ...
        let v1 = 0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::duck_nft::get_rarity_level(0x2::kiosk::borrow<0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::duck_nft::DuckNFT>(arg0, arg1, arg2));
    ...
    public entry fun unstake_duck(arg0: &mut Nest, arg1: &0x2::kiosk::Kiosk, arg2: &mut HarvestStats, arg3: &0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::NestMintCap, arg4: &mut 0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::SharedTreasury, arg5: &0x2::random::Random, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::kiosk::has_item_with_type<0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::duck_nft::DuckNFT>(arg1, v1)) {
            ...
            if (v3 > 0) {
                ...
                if (v9 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::SHTTOKEN>>(0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::mint_for_nest(arg3, arg4, v9, arg7), v0);
                };
    ...
    public entry fun upgrade_nest(arg0: &mut Nest, arg1: &mut 0x2::coin::Coin<0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::SHTTOKEN>, arg2: &mut 0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::SharedTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::SHTTOKEN>(arg1) >= v3, 5);
        0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::burn(arg2, 0x2::coin::split<0xf962da52f4f0b911f618834a9e23ccdc90076b68b95b3a2d7a6cc13360ba70d0::shttoken::SHTTOKEN>(arg1, v3, arg3));
        arg0.level = v2;
        let v4 = SlotUpgraded{
            nest_id    : 0x2::object::id<Nest>(arg0),
            owner      : v0,
