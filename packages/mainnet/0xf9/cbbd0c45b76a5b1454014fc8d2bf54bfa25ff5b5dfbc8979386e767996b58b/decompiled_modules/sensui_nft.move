module 0xf9cbbd0c45b76a5b1454014fc8d2bf54bfa25ff5b5dfbc8979386e767996b58b::sensui_nft {
    ...
    public entry fun mint_to_sender(arg0: &mut NFTMintData, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        let v4 = 0;
        if (arg0.nft_minted <= 10 && (v1 - arg0.time_start_event) / 3600 <= 2 && !arg0.is_resume) {
            if (arg5 >= 1 && arg5 <= 6) {
                v2 = 1200000;
            } else if (arg5 >= 7) {
                v2 = 1000000;
        ...
        if (!0x2::bag::contains<address>(&arg0.users_mint_data, v0)) {
            ...
            assert!((v1 - *0x2::bag::borrow<address, u64>(&mut arg0.users_mint_data, v0)) / 86400 >= 1, 102);
