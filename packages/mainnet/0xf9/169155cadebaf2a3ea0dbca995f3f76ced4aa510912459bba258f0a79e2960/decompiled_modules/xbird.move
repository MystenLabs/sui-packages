module 0xf9169155cadebaf2a3ea0dbca995f3f76ced4aa510912459bba258f0a79e2960::xbird {
    ...
    public fun depositToken(arg0: vector<u8>, arg1: vector<u8>, arg2: &ValidatorVault, arg3: &mut PegVault<XBIRD>, arg4: &mut 0xf9169155cadebaf2a3ea0dbca995f3f76ced4aa510912459bba258f0a79e2960::archieve::UserArchieve, arg5: &0xf9169155cadebaf2a3ea0dbca995f3f76ced4aa510912459bba258f0a79e2960::version::Version, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<XBIRD>, DepositProof) {
        ...
        assert!(v2 > 0, 1002);
        0xf9169155cadebaf2a3ea0dbca995f3f76ced4aa510912459bba258f0a79e2960::archieve::verUpdateTokenPegNonce(v3, arg4);
        let v4 = DepositProof{
            owner   : v0,
            balance : v2,
        };
        let v5 = XBirdDeposited{
            ...
            nonce         : v3,
            balance       : v2,
            total_deposit : 0xf9169155cadebaf2a3ea0dbca995f3f76ced4aa510912459bba258f0a79e2960::archieve::increaseTotalDeposit(v2, arg4),
        };
    ...
    fun init(arg0: XBIRD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xf9169155cadebaf2a3ea0dbca995f3f76ced4aa510912459bba258f0a79e2960::cap_vault::createVault<XBirdAdminCap>(arg1);
    }

    public fun setValidator(arg0: &XBirdAdminCap, arg1: vector<u8>, arg2: &mut ValidatorVault, arg3: &0xf9169155cadebaf2a3ea0dbca995f3f76ced4aa510912459bba258f0a79e2960::version::Version) {
