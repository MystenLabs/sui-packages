module 0xf9a1201029039d0ed1d160d66f4ec16f8fd99e3a0d496746febaf0aa602ee6bd::vault {
    ...
    entry fun change_limit<T0>(arg0: &mut Vault<T0>, arg1: &0xf9a1201029039d0ed1d160d66f4ec16f8fd99e3a0d496746febaf0aa602ee6bd::owner_cap::OwnerCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun create_vault<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xf9a1201029039d0ed1d160d66f4ec16f8fd99e3a0d496746febaf0aa602ee6bd::owner_cap::create_owner_cap(&v0.id, 0x2::tx_context::sender(arg2), arg2);
    ...
    entry fun liquidate_vault<T0>(arg0: &mut Vault<T0>, arg1: &0xf9a1201029039d0ed1d160d66f4ec16f8fd99e3a0d496746febaf0aa602ee6bd::owner_cap::OwnerCap, arg2: &mut 0x2::tx_context::TxContext) {
        0xf9a1201029039d0ed1d160d66f4ec16f8fd99e3a0d496746febaf0aa602ee6bd::owner_cap::is_owned(&arg0.id, arg1);
