module 0xf930ba092357cca19ad9a807db3a94e6cdd4f1a89d870ec73f3ccda30ffdb21b::reward3634 {
    struct REWARD3634 has drop {
        dummy_field: bool,
    }

    struct TICKET_3634 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3634(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_3634>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3634, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3634>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3634>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3634>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3634>>(v5, 0x2::tx_context::sender(arg1));
    }
