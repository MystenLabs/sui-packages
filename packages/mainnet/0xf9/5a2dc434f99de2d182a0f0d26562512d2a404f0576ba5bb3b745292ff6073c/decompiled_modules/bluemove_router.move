module 0xf95a2dc434f99de2d182a0f0d26562512d2a404f0576ba5bb3b745292ff6073c::bluemove_router {
    ...
    fun get_amount_in<T0>(arg0: u64, arg1: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info) : u64 {
        if (0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::utils::sort_token_type<T0, 0x2::sui::SUI>()) {
            ...
            0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::utils::get_amount_in(arg0 + arg0 * 10 / 10000, v3, v4)
        }
    }
    ...
    public entry fun buy_exact_in<T0>(arg0: &FeeObject, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xf95a2dc434f99de2d182a0f0d26562512d2a404f0576ba5bb3b745292ff6073c::utils::send_coin<T0>(v2, 0x2::tx_context::sender(arg5));
        0xf95a2dc434f99de2d182a0f0d26562512d2a404f0576ba5bb3b745292ff6073c::utils::send_coin<0x2::sui::SUI>(arg2, 0x2::tx_context::sender(arg5));
        0xf95a2dc434f99de2d182a0f0d26562512d2a404f0576ba5bb3b745292ff6073c::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, v0, arg5), arg0.admin);
        let v3 = BuyEvent<T0>{
    ...
    public entry fun sell_exact_in<T0>(arg0: &FeeObject, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xf95a2dc434f99de2d182a0f0d26562512d2a404f0576ba5bb3b745292ff6073c::utils::send_coin<T0>(arg2, 0x2::tx_context::sender(arg5));
        0xf95a2dc434f99de2d182a0f0d26562512d2a404f0576ba5bb3b745292ff6073c::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg5));
        0xf95a2dc434f99de2d182a0f0d26562512d2a404f0576ba5bb3b745292ff6073c::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v2, arg5), arg0.admin);
        let v3 = SellEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg5),
            amount_in  : arg1,
            amount_out : v1 - v2,
    ...
    public entry fun sell_exact_out<T0>(arg0: &FeeObject, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::router::swap_exact_output_<T0, 0x2::sui::SUI>(arg1, arg3, arg2, arg4, arg5);
        let v1 = 0x2::coin::value<0x2::sui::SUI>(&v0) * arg0.sell_fee / 10000;
        0xf95a2dc434f99de2d182a0f0d26562512d2a404f0576ba5bb3b745292ff6073c::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg5));
        0xf95a2dc434f99de2d182a0f0d26562512d2a404f0576ba5bb3b745292ff6073c::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v1, arg5), arg0.admin);
        let v2 = SellEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg5),
            amount_in  : get_amount_in<T0>(arg1, arg4),
