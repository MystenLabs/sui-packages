module 0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::rank_list {
    ...
    public entry fun add_performance(arg0: &mut TodayRank, arg1: address, arg2: u64, arg3: &0x2::clock::Clock) {
    ...
    public fun get_day(arg0: &TodayRank) : u64 {
        arg0.day
    }

    public fun get_rank(arg0: &TodayRank) : vector<RankItem> {
        arg0.items
    }
