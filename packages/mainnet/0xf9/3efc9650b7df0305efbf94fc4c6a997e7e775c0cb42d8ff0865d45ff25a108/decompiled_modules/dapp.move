module 0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::dapp {
    ...
    public entry fun bindInviter<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<address>(&mut arg0.user_list, v2);
        v1.total_user = v1.total_user + 1;
    }

    public fun buyToken<T0, T1>(arg0: &mut Contract<T1>, arg1: &0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::price_oracle::PriceOracle, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg2);
        assert!(v0 > 0, 13906837180820488191);
        let v1 = 0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::price_oracle::get_sui_amount(arg1, v0);
    ...
    public entry fun claimBalance<T0, T1>(arg0: &mut Contract<T1>, arg1: &0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = withdrawSui<T0>(&arg0.vault, 0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::price_oracle::get_sui_amount(arg1, arg2 - arg2 / 10), arg3, arg4, arg5, arg6, arg7, arg8, arg9);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v1, 0x2::tx_context::sender(arg9));
    }

    public entry fun claimInterest<T0>(arg0: &mut Contract<T0>, arg1: u64, arg2: &0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::price_oracle::PriceOracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        withdraw_pre<T0>(arg0, v0, 0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::price_oracle::get_usdt_amount(arg2, v5), arg4);
    }
    ...
    public entry fun investment<T0, T1, T2>(arg0: &mut Contract<T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::price_oracle::PriceOracle, arg4: u64, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (v5 > 0) {
            ...
            v6 = v7;
            assert!(v7 >= 0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::price_oracle::get_sui_amount(arg3, arg4 * (v5 as u64) / 100), 2);
        ...
        if (v8 > 0) {
            ...
            v9 = v10;
            assert!(v10 >= 0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::price_oracle::get_pre_amount(arg3, arg4 * (v8 as u64) / 100), 2);
    ...
    public entry fun stake<T0>(arg0: &mut Contract<T0>, arg1: &0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::price_oracle::PriceOracle, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg2);
        assert!(v0 > 0, 3);
        let v1 = if (arg3 == 7) {
            true
        ...
        let v4 = StakeOrder{
            ...
            cycle      : arg3,
            pre_amount : v0,
            amount     : 0xf93efc9650b7df0305efbf94fc4c6a997e7e775c0cb42d8ff0865d45ff25a108::price_oracle::get_pre_amount(arg1, v0),
            interest   : 0,
        };
