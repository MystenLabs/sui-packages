module 0xf9d3de36f2b30d64c429dc66184f5224c31577cea740176fed6ece810db85ee6::deposit_agent_config {
    ...
    public(friend) fun token_holder_receive<T0>(arg0: &mut DepositAgentConfig, arg1: &0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet_config::CloudWalletConfig, arg2: &mut 0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet_config::CloudWalletTokenHolder, arg3: u256, arg4: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg5: address, arg6: u64, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        check_signer(arg0, 0xf9d3de36f2b30d64c429dc66184f5224c31577cea740176fed6ece810db85ee6::utils::ecrecover(arg7, 0xf9d3de36f2b30d64c429dc66184f5224c31577cea740176fed6ece810db85ee6::utils::keccak_message(get_collect_to_sign_msg<T0>(0x2::object::id_address<DepositAgentTokenHolder>(v0), arg3, 0x2::coin::value<T0>(&v1), arg5, arg6))));
        0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet::mm_credit<T0>(arg1, arg2, v1, arg8);
    }
    ...
    public(friend) fun when_to_address_match(arg0: &0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet_config::CloudWalletTokenHolder, arg1: address) {
        assert!(arg1 == 0x2::object::id_address<0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet_config::CloudWalletTokenHolder>(arg0), 40012);
    }
