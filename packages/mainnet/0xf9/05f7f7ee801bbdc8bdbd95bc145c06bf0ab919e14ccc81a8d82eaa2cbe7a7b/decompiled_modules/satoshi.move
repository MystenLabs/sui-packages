module 0xf905f7f7ee801bbdc8bdbd95bc145c06bf0ab919e14ccc81a8d82eaa2cbe7a7b::satoshi {
    ...
    fun init(arg0: SATOSHI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/4fm1dSJHntkgrcnyyZHAjKw4hT9XoxfCuMnZi6uTKAM2.png                                                                                                                                                                                                                               ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<SATOSHI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"SATOSHI   ")))), trim_right(b"He Has Risen (SATOSHI)          "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
