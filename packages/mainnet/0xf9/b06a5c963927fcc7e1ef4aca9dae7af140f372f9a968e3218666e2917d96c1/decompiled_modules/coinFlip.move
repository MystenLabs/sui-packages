module 0xf9b06a5c963927fcc7e1ef4aca9dae7af140f372f9a968e3218666e2917d96c1::coinFlip {
    ...
    public entry fun play_game(arg0: &mut CoinFlip, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = get_hash(0x2::clock::timestamp_ms(arg3));
        let v4 = b"lose";
        let v5 = 0;
        let v6 = if ((safe_selection(999, &v3) + (*0x1::vector::borrow<u8>(&v2, 0) as u64)) % 2 == 0) {
            b"head"
        } else {
            b"tail"
        };
        if (arg2 == v6) {
            ...
            let v9 = v7 - v8;
            v5 = v9;
            0x2::coin::join<0x2::sui::SUI>(&mut arg1, 0x2::coin::take<0x2::sui::SUI>(&mut arg0.bank, v9 - v0, arg4));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, 0x2::tx_context::sender(arg4));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.bank, v8, arg4), arg0.treasury);
        } else {
            if (arg0.fee > 0) {
        ...
        if (0x2::table::contains<address, 0x2::table::Table<u64, History>>(&arg0.history, 0x2::tx_context::sender(arg4))) {
            0x2::table::add<u64, History>(0x2::table::borrow_mut<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg4)), 0x2::table::length<u64, History>(0x2::table::borrow<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg4))) + 1, v10);
        } else {
            let v11 = 0x2::table::new<u64, History>(arg4);
            0x2::table::add<u64, History>(&mut v11, 1, v10);
            0x2::table::add<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg4), v11);
        };
        0x2::table::add<u64, History>(&mut arg0.history_all, 0x2::table::length<u64, History>(&arg0.history_all) + 1, v10);
        0x2::event::emit<History>(v10);
    }
