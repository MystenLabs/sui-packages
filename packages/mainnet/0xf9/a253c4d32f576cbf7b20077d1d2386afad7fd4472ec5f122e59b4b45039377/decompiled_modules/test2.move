module 0xf9a253c4d32f576cbf7b20077d1d2386afad7fd4472ec5f122e59b4b45039377::test2 {
    ...
    fun init(arg0: TEST2, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST2>(arg0, 9, b"test2", b"TEST2", b"aaaa", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"http://34.27.172.105/uploads/logo_1761398597473_785774fa.png")), arg1);
