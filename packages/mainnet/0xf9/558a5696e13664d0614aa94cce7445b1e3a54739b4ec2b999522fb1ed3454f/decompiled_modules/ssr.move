module 0xf9558a5696e13664d0614aa94cce7445b1e3a54739b4ec2b999522fb1ed3454f::ssr {
    struct SSR has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SSR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/atndHXJ2PxMXYg7o4CVJ8dmkWuQKkTRF8ANvGnZpump.png?claimId=GMT_76GILgFmXeuo                                                                                                                                                                                                       ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<SSR>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"SSR       ")))), trim_right(b"Strategic Shitcoin Reserve      "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
