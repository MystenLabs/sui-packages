module 0xf9c6a431c517334ecab1a92c04d5b9b4a822518f192a9fb6784cf9b9ec5bc18e::test_coin {
    ...
    fun init(arg0: TEST_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST_COIN>(arg0, 6, b"test3333", b"forge", b"Template Coin Description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"dddd"))), arg1);
