module 0xf9645ccf891976fb0f3c53c123a9cb8af85535161b7806f76ecb76eafa2754c9::tism {
    ...
    fun init(arg0: TISM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/7QogCRyB1hJJiYCTkxkvFHPKHfmw8VMoCrNL3Cg6pump.png?size=lg&key=9acfbc                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<TISM>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TISM    ")))), trim_right(b"Degentism                       "), trim_right(b"TISM means aping into trades purely on vibes - no thesis, just conviction and hopium. We all have TISM. Only those who embrace it are going to make it.                                                                                                                                                                         "), v2, arg1);
        let v5 = v3;
