module 0xf9499ce53184dfff18d554ba378c2a30b447cd97cf4d54eba21ebb61c2822fdd::cnsnft2797 {
    struct CNSNFT2797 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2797, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2797>(arg0, arg1);
