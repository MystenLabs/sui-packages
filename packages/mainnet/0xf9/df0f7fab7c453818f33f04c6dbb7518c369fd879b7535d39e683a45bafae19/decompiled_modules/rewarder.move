module 0xf9df0f7fab7c453818f33f04c6dbb7518c369fd879b7535d39e683a45bafae19::rewarder {
    ...
    public(friend) fun add_rewarder<T0>(arg0: &mut RewarderManager) {
        ...
        assert!(0x1::option::is_none<u64>(&v0), 502);
        let v1 = &mut arg0.rewarders;
        assert!(0x1::vector::length<Rewarder>(v1) <= 4, 501);
        let v2 = Rewarder{
    ...
    public fun deposit_reward<T0>(arg0: &0xf9df0f7fab7c453818f33f04c6dbb7518c369fd879b7535d39e683a45bafae19::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) : u64 {
    ...
    public fun emergent_withdraw<T0>(arg0: &0xf9df0f7fab7c453818f33f04c6dbb7518c369fd879b7535d39e683a45bafae19::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xf9df0f7fab7c453818f33f04c6dbb7518c369fd879b7535d39e683a45bafae19::config::checked_package_version(arg0);
        0xf9df0f7fab7c453818f33f04c6dbb7518c369fd879b7535d39e683a45bafae19::config::check_pool_manager_role(arg0, 0x2::tx_context::sender(arg3));
        let v0 = withdraw_reward<T0>(arg1, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg3), 0xf9df0f7fab7c453818f33f04c6dbb7518c369fd879b7535d39e683a45bafae19::config::get_reward_receiver(arg0));
    ...
    public fun emissions_per_ms(arg0: &Rewarder) : u128 {
        arg0.emissions_per_ms
    }
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: u128, arg2: u64) {
        ...
        while (v2 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            let v3 = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).emissions_per_ms;
            if (v3 == 0) {
                v2 = v2 + 1;
                continue
            };
            0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v2).growth_global = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).growth_global + 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor((v1 as u128), v3, arg1);
            v2 = v2 + 1;
        };
        let v4 = 18446744073709551616000000;
        arg0.points_released = arg0.points_released + (v1 as u128) * v4;
        arg0.points_growth_global = arg0.points_growth_global + 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor((v1 as u128), v4, arg1);
    }
    ...
    public(friend) fun update_emission<T0>(arg0: &RewarderGlobalVault, arg1: &mut RewarderManager, arg2: u128, arg3: u128, arg4: u64) {
        ...
        if (arg3 > 0 && arg3 > v0.emissions_per_ms) {
            let v1 = 0x1::type_name::get<T0>();
            assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v1), 504);
            assert!((0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg0.balances, v1)) as u128) << 64 >= 86400000 * arg3, 504);
        };
        v0.emissions_per_ms = arg3;
    }

    public(friend) fun withdraw_reward<T0>(arg0: &mut RewarderGlobalVault, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v0), 505);
        let v1 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.balances, v0);
        assert!(0x2::balance::value<T0>(v1) >= arg1, 504);
