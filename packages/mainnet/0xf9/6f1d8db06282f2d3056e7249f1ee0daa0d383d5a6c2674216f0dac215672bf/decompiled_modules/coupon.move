module 0x1b998ebddfbad3cc5a6f9048ffec5a8956a44bba4c22c12c0d45f58e9e66bb88::coupon {
    ...
    struct CustodyGiftRegistered has copy, drop {
        coupon_id: 0x2::object::ID,
        claim_code_hash: 0x2::object::ID,
    }

    struct CouponRevoked has copy, drop {
        coupon_id: 0x2::object::ID,
        refund_to: address,
        amount: u64,
    }
    ...
    fun assert_admin(arg0: &Config, arg1: &ConfigAdminCap) {
        assert!(arg1.config_id == 0x2::object::id<Config>(arg0), 13906837039086567425);
    }
    ...
    public fun claim<T0>(arg0: &mut Coupon<T0>, arg1: &Config, arg2: address, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock) {
        assert!(0x2::clock::timestamp_ms(arg5) < arg3, 13906835857971740691);
        let v0 = 0x2::object::id<Coupon<T0>>(arg0);
        let v1 = arg0.owner;
        assert!(verify_claim_authorization(arg1, v0, v1, arg2, arg3, arg4), 13906835909511741465);
        arg0.owner = arg2;
        let v2 = Claimed{
            coupon_id      : v0,
            previous_owner : v1,
    ...
    public fun gift_with_claim<T0>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: address, arg4: address, arg5: u64, arg6: u64, arg7: 0x2::object::ID, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = new_coupon<T0>(arg0, arg3, arg4, arg1, arg2, arg5, arg6, arg8);
        let v1 = 0x2::object::id<Coupon<T0>>(&v0);
        let v2 = Gifted{
            coupon_id     : v1,
            campaign      : arg1,
            owner         : arg3,
        ...
        0x2::event::emit<Gifted>(v2);
        let v3 = CustodyGiftRegistered{
            coupon_id       : v1,
            claim_code_hash : arg7,
        };
        0x2::event::emit<CustodyGiftRegistered>(v3);
        0x2::transfer::share_object<Coupon<T0>>(v0);
    }
    ...
    fun new_coupon<T0>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: address, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : Coupon<T0> {
        assert!(arg6 != 0, 13906835724828016663);
        Coupon<T0>{
    ...
    public fun redeem<T0>(arg0: &mut Coupon<T0>, arg1: &Config, arg2: u64, arg3: address, arg4: u64, arg5: vector<u8>, arg6: u64, arg7: u64, arg8: vector<u8>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg9) < arg6, 13906836021180497939);
        assert!(verify_redeem_authorization(arg1, 0x2::object::id<Coupon<T0>>(arg0), arg0.owner, arg3, arg2, arg7, arg6, arg5, arg8), 13906836081310171157);
    ...
    fun redeem_internal<T0>(arg0: &mut Coupon<T0>, arg1: &Config, arg2: u64, arg3: address, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.paused, 13906836162913370115);
        assert!(0x2::tx_context::sender(arg8) == arg0.owner, 13906836167208468485);
        assert!(0x2::clock::timestamp_ms(arg7) < arg0.expires_at_ms, 13906836171503566855);
        assert!(arg4 >= arg0.min_subtotal, 13906836175798796299);
        assert!(arg2 > 0, 13906836180093894669);
        let v0 = 0x2::balance::value<T0>(&arg0.funds);
        assert!(v0 == arg5, 13906836188684091409);
        assert!(arg2 <= v0, 13906836192978927631);
    ...
    public fun revoke_unclaimed<T0>(arg0: Coupon<T0>, arg1: &Config, arg2: &ConfigAdminCap, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg1, arg2);
        assert!(arg0.owner == arg3, 13906836510807293979);
        let Coupon {
            id            : v0,
            funds         : v1,
            owner         : _,
        ...
        let v12 = CouponRevoked{
            coupon_id : 0x2::object::uid_to_inner(&v10),
            refund_to : v3,
            amount    : v11,
        };
        0x2::event::emit<CouponRevoked>(v12);
    }
    ...
    public fun sweep_expired<T0>(arg0: Coupon<T0>, arg1: &Config, arg2: &ConfigAdminCap, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg1, arg2);
        assert!(0x2::clock::timestamp_ms(arg3) >= arg0.expires_at_ms, 13906836330417487881);
        let Coupon {
            id            : v0,
            funds         : v1,
            owner         : _,
