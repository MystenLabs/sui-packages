module 0xf98920b1d0af67a19905085a687a972a6ed03f68fc6f1f940e19c01327e34a62::cnsnft5036 {
    struct CNSNFT5036 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5036, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6383"));
        let v4 = 0x2::package::claim<CNSNFT5036>(arg0, arg1);
