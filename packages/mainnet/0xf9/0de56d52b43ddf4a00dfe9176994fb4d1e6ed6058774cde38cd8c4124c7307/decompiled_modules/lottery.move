module 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::lottery {
    ...
    struct Lottery<phantom T0> has store, key {
        ...
        max_normal_ball: u8,
        max_special_ball: u8,
        tickets: 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<Ticket<T0>>,
        ticket_history: 0x2::linked_table::LinkedTable<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>,
    ...
    fun delete<T0>(arg0: &mut LotteryStore, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v24 = v4;
        let v25 = v1;
        assert!(v7 == 106, 9223376911642656767);
        ...
        while (0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::length<Ticket<T0>>(&v23) > 0) {
            destroy<T0>(0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::pop_front<Ticket<T0>>(&mut v23));
        };
        0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::destroy_empty<Ticket<T0>>(v23);
        while (0x2::linked_table::length<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>(&v22) > 0) {
            let (_, v27) = 0x2::linked_table::pop_front<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>(&mut v22);
            let v28 = v27;
            while (0x2::linked_table::length<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(&v28) > 0) {
                let (_, v30) = 0x2::linked_table::pop_front<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(&mut v28);
                0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::drop<TicketHistory>(v30);
            };
            0x2::linked_table::destroy_empty<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(v28);
        };
        0x2::linked_table::destroy_empty<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>(v22);
    ...
    public fun buy_ticket<T0>(arg0: &mut LotteryStore, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T0>, arg3: vector<u8>, arg4: u8, arg5: 0x1::string::String, arg6: 0x1::option::Option<address>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::push_back<Ticket<T0>>(&mut v0.tickets, v11);
        let v12 = TicketHistory{
            owner            : v10,
            picks            : v9,
            lottery_id       : arg1,
            epoch            : v0.current_epoch,
        ...
        if (0x2::linked_table::contains<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>(&v0.ticket_history, v10)) {
            let v13 = 0x2::linked_table::borrow_mut<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>(&mut v0.ticket_history, v10);
            if (0x2::linked_table::contains<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(v13, v2)) {
                0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::push_back<TicketHistory>(0x2::linked_table::borrow_mut<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(v13, v2), v12);
            } else {
                let v14 = 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::new<TicketHistory>(5000, arg8);
                0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::push_back<TicketHistory>(&mut v14, v12);
                0x2::linked_table::push_back<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(v13, v2, v14);
            };
        } else {
            let v15 = 0x2::linked_table::new<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(arg8);
            let v16 = 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::new<TicketHistory>(5000, arg8);
            0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::push_back<TicketHistory>(&mut v16, v12);
            0x2::linked_table::push_back<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(&mut v15, v2, v16);
            0x2::linked_table::push_back<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>(&mut v0.ticket_history, v10, v15);
        };
        let v17 = TicketPurchased{
            owner            : v10,
            picks            : v9,
            lottery_id       : arg1,
            epoch            : v0.current_epoch,
        ...
        0x2::event::emit<TicketPurchased>(v17);
    }
    ...
    public fun buy_ticket_on_behalf<T0>(arg0: &mut LotteryStore, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T0>, arg3: address, arg4: vector<u8>, arg5: u8, arg6: 0x1::string::String, arg7: 0x1::option::Option<address>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::push_back<Ticket<T0>>(&mut v0.tickets, v10);
        let v11 = TicketHistory{
            owner            : arg3,
            picks            : v9,
            lottery_id       : arg1,
            epoch            : v0.current_epoch,
        ...
        if (0x2::linked_table::contains<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>(&v0.ticket_history, arg3)) {
            let v12 = 0x2::linked_table::borrow_mut<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>(&mut v0.ticket_history, arg3);
            if (0x2::linked_table::contains<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(v12, v2)) {
                0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::push_back<TicketHistory>(0x2::linked_table::borrow_mut<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(v12, v2), v11);
            } else {
                let v13 = 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::new<TicketHistory>(5000, arg9);
                0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::push_back<TicketHistory>(&mut v13, v11);
                0x2::linked_table::push_back<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(v12, v2, v13);
            };
        } else {
            let v14 = 0x2::linked_table::new<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(arg9);
            let v15 = 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::new<TicketHistory>(5000, arg9);
            0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::push_back<TicketHistory>(&mut v15, v11);
            0x2::linked_table::push_back<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(&mut v14, v2, v15);
            0x2::linked_table::push_back<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>(&mut v0.ticket_history, arg3, v14);
        };
        let v16 = TicketPurchased{
            owner            : arg3,
            picks            : v9,
            lottery_id       : arg1,
            epoch            : v0.current_epoch,
        ...
        0x2::event::emit<TicketPurchased>(v16);
    }
    ...
    public fun create_lottery<T0>(arg0: &LotteryStoreAdminCap, arg1: &mut LotteryStore, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v8 = Lottery<T0>{
            ...
            max_normal_ball         : 42,
            max_special_ball        : 10,
            tickets                 : 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::new<Ticket<T0>>(5000, arg5),
            ticket_history          : 0x2::linked_table::new<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>(arg5),
    ...
    public fun get_lottery_queue_size<T0>(arg0: &LotteryStore, arg1: 0x2::object::ID) : u64 {
        assert!(lottery_exists<T0>(arg0, arg1), 9);
        0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::length<Ticket<T0>>(&0x2::dynamic_object_field::borrow<0x2::object::ID, Lottery<T0>>(&arg0.id, arg1).tickets)
    }
    ...
    public fun get_player_ticket_history_for_round<T0>(arg0: &LotteryStore, arg1: 0x2::object::ID, arg2: address, arg3: u64) : &0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory> {
        0x2::linked_table::borrow<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>(0x2::linked_table::borrow<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>(&0x2::dynamic_object_field::borrow<0x2::object::ID, Lottery<T0>>(&arg0.id, arg1).ticket_history, arg2), arg3)
    }

    public fun get_player_ticket_history_total<T0>(arg0: &LotteryStore, arg1: 0x2::object::ID, arg2: address) : &0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>> {
        0x2::linked_table::borrow<address, 0x2::linked_table::LinkedTable<u64, 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::BigQueue<TicketHistory>>>(&0x2::dynamic_object_field::borrow<0x2::object::ID, Lottery<T0>>(&arg0.id, arg1).ticket_history, arg2)
    }
    ...
    public fun settle_or_continue<T0>(arg0: &LotteryStoreAdminCap, arg1: &mut LotteryStore, arg2: 0x2::object::ID, arg3: u64, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock) {
        ...
        if (0x1::option::is_some<u64>(&arg4)) {
            v1 = 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::length<Ticket<T0>>(&v0.tickets) - *0x1::option::borrow<u64>(&arg4);
        };
        let v2 = 0x1::option::extract<Picks>(&mut v0.current_round_picks);
        while (0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::length<Ticket<T0>>(&v0.tickets) > v1) {
            let v3 = 0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::pop_front<Ticket<T0>>(&mut v0.tickets);
        ...
        if (0xf90de56d52b43ddf4a00dfe9176994fb4d1e6ed6058774cde38cd8c4124c7307::big_queue::length<Ticket<T0>>(&v0.tickets) == 0) {
