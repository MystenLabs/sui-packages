module 0xb007f13d64561c02d65d697d7b6f4edfb959652d330d3461789d810067f878fa::gauge {
    ...
    fun check_voter_cap<T0, T1, T2>(arg0: &Gauge<T0, T1, T2>, arg1: &0xb007f13d64561c02d65d697d7b6f4edfb959652d330d3461789d810067f878fa::voter_cap::VoterCap) {
        ...
        assert!(&v0 == 0x1::option::borrow<0x2::object::ID>(&arg0.voter), 9223374072670257168);
    }
    ...
    public fun deposit_position<T0, T1, T2>(arg0: &0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::config::GlobalConfig, arg1: &0xb007f13d64561c02d65d697d7b6f4edfb959652d330d3461789d810067f878fa::distribution_config::DistributionConfig, arg2: &mut Gauge<T0, T1, T2>, arg3: &mut 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg4: 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::position::Position, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::object::id<0xb007f13d64561c02d65d697d7b6f4edfb959652d330d3461789d810067f878fa::distribution_config::DistributionConfig>(arg1) == arg2.distribution_config, 9223373578748035071);
        assert!(0xb007f13d64561c02d65d697d7b6f4edfb959652d330d3461789d810067f878fa::distribution_config::is_gauge_alive(arg1, 0x2::object::id<Gauge<T0, T1, T2>>(arg2)), 9223373578749542424);
        assert!(check_gauger_pool<T0, T1, T2>(arg2, arg3), 9223373583043461128);
        assert!(0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::position::pool_id(&arg4) == v1, 9223373587338559498);
        assert!(!0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::position::is_staked(0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::position::borrow_position_info(0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::position_manager<T0, T1>(arg3), v2)), 9223373595927969794);
    ...
    fun earned_internal<T0, T1, T2>(arg0: &Gauge<T0, T1, T2>, arg1: &0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg2: 0x2::object::ID, arg3: u64) : u64 {
        let v0 = 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::get_magma_distribution_last_updated<T0, T1>(arg1);
        effective_elapsed_rewards<T0, T1, T2>(arg0, arg1, arg2, find_effective_epoch_starts<T0, T1, T2>(arg0, v0, arg3), v0, arg3)
    }

    fun effective_elapsed_rewards<T0, T1, T2>(arg0: &Gauge<T0, T1, T2>, arg1: &0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg2: 0x2::object::ID, arg3: vector<u64>, arg4: u64, arg5: u64) : u64 {
        ...
        let v2 = 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::get_magma_distribution_staked_liquidity<T0, T1>(arg1);
        let v3 = 0x2::object_table::borrow<0x2::object::ID, 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::position::Position>(&arg0.staked_positions, arg2);
        let (v4, v5) = 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::position::tick_range(v3);
        let v6 = 0;
        while (v0 < 0x1::vector::length<u64>(&arg3)) {
            let v7 = if (*0x1::vector::borrow<u64>(&arg3, v0) <= arg4 && 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::config::epoch_next(*0x1::vector::borrow<u64>(&arg3, v0) + 1) > arg4) {
                0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::config::epoch_next(*0x1::vector::borrow<u64>(&arg3, v0) + 1) - arg4
            } else if (v0 > 0 && v0 < 0x1::vector::length<u64>(&arg3) - 1) {
                0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::config::week()
            } else {
                let v8 = 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::config::epoch_start(arg5);
                if (*0x1::vector::borrow<u64>(&arg3, v0) == v8) {
                    arg5 - v8
                } else {
                    0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::config::week()
                }
            ...
            let v9 = if (v7 >= 0) {
                if ((0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::get_magma_distribution_reserve<T0, T1>(arg1) as u128) * 18446744073709551616 > 0) {
                    v2 > 0
                } else {
                    false
                }
            ...
            if (v9) {
                v1 = v1 + 0x659c0e9c4c8a416f040fa758d4fc4073a5fdd1fed97edadcd5cba5180fb36246::math_u128::checked_div_round(reward_rate_by_epoch_start<T0, T1, T2>(arg0, *0x1::vector::borrow<u64>(&arg3, v0)) * (v7 as u128), v2, false);
            };
            v6 = v6 + 0x659c0e9c4c8a416f040fa758d4fc4073a5fdd1fed97edadcd5cba5180fb36246::full_math_u128::mul_div_floor(0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::get_magma_distribution_growth_inside<T0, T1>(arg1, v4, v5, v1) - 0x2::table::borrow<0x2::object::ID, RewardProfile>(&arg0.rewards, arg2).growth_inside, 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::position::liquidity(v3), 18446744073709551616);
            v0 = v0 + 1;
        };
        (v6 as u64)
    }

    fun find_effective_epoch_starts<T0, T1, T2>(arg0: &Gauge<T0, T1, T2>, arg1: u64, arg2: u64) : vector<u64> {
        let v0 = 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::config::epoch_start(arg1);
        let v1 = 0;
        let v2 = false;
        let v3 = 0x1::vector::empty<u64>();
        while (v1 < 99) {
            if (0x2::table::contains<u64, u128>(&arg0.reward_rate_by_epoch, v0)) {
                v2 = true;
                break
            };
            let v4 = v0 - 1;
            v0 = 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::config::epoch_start(v4);
            v1 = v1 + 1;
        };
        if (!v2) {
            abort 0
        ...
        v1 = v0;
        while (v1 <= 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::config::epoch_start(arg2)) {
            if (0x2::table::contains<u64, u128>(&arg0.reward_rate_by_epoch, v1)) {
                0x1::vector::push_back<u64>(&mut v3, v1);
            };
            let v5 = v1 + 1;
            v1 = 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::config::epoch_next(v5);
        };
        v3
    }
    ...
    public fun get_position_reward<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &mut 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(check_gauger_pool<T0, T1, T2>(arg0, arg1), 9223373845036466184);
        assert!(0x2::object_table::contains<0x2::object::ID, 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::position::Position>(&arg0.staked_positions, arg2), 9223373849331171332);
    ...
    public fun get_reward<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &mut 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(check_gauger_pool<T0, T1, T2>(arg0, arg1), 9223373870806269960);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::table::contains<address, vector<0x2::object::ID>>(&arg0.stakes, v0), 9223373879396466700);
    ...
    public fun get_reward_for<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &mut 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(check_gauger_pool<T0, T1, T2>(arg0, arg1), 9223373926640844808);
        assert!(0x2::table::contains<address, vector<0x2::object::ID>>(&arg0.stakes, arg2), 9223373930936074252);
        let v0 = 0x2::table::borrow<address, vector<0x2::object::ID>>(&arg0.stakes, arg2);
    ...
    public fun notify_reward<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &0xb007f13d64561c02d65d697d7b6f4edfb959652d330d3461789d810067f878fa::voter_cap::VoterCap, arg2: &mut 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T2>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        assert!(v0 > 0, 9223374132799930386);
    ...
    fun notify_reward_amount_internal<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &mut 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.reward_rate != 0, 9223374381908164628);
        assert!(arg0.reward_rate <= 0x659c0e9c4c8a416f040fa758d4fc4073a5fdd1fed97edadcd5cba5180fb36246::full_math_u128::mul_div_floor((0x2::balance::value<T2>(&arg0.reserves_balance) as u128), 18446744073709551616, (v1 as u128)), 9223374386203262998);
    ...
    public fun notify_reward_without_claim<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &0xb007f13d64561c02d65d697d7b6f4edfb959652d330d3461789d810067f878fa::voter_cap::VoterCap, arg2: &mut 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T2>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        check_voter_cap<T0, T1, T2>(arg0, arg1);
        let v0 = 0x2::balance::value<T2>(&arg3);
        assert!(v0 > 0, 9223374235879145490);
        0x2::balance::join<T2>(&mut arg0.reserves_balance, arg3);
        notify_reward_amount_internal<T0, T1, T2>(arg0, arg2, v0, arg4, arg5);
    ...
    public(friend) fun receive_gauge_cap<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: 0x2de81c0f5cc2aa176da9f093834efbf846d581afa46516bf4952b6efd3a44992::gauge_cap::GaugeCap) {
        assert!(arg0.pool_id == 0x2de81c0f5cc2aa176da9f093834efbf846d581afa46516bf4952b6efd3a44992::gauge_cap::get_pool_id(&arg1), 9223373540093329407);
    ...
    public fun withdraw_position<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &mut 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object_table::contains<0x2::object::ID, 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::position::Position>(&arg0.staked_positions, arg2) && 0x2::table::contains<0x2::object::ID, PositionStakeInfo>(&arg0.staked_position_infos, arg2), 9223373986770124804);
        ...
        assert!(v0.received, 9223374008245616654);
        assert!(v0.from == 0x2::tx_context::sender(arg4), 9223374012540452876);
