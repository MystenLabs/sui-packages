module 0xf99bc7c0cf4b3f514f54392ca1ccc7115363913a12c168f839c4b35f790bb859::wen_lambo {
    ...
    fun init(arg0: WEN_LAMBO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WEN_LAMBO>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Wen Lambo"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeigvyv2deez6v67v6hopeimci5vk6mc7yvvn6wykwa5pceynrypcje"));
