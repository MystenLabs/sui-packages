module 0xf9bd23323871f0f3f300b8704a107b0475d3a203880d02ec7d22a7c003091919::rewarder {
    ...
    public fun deposit_reward<T0>(arg0: &0xf9bd23323871f0f3f300b8704a107b0475d3a203880d02ec7d22a7c003091919::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) : u64 {
    ...
    public fun emergent_withdraw<T0>(arg0: &0xf9bd23323871f0f3f300b8704a107b0475d3a203880d02ec7d22a7c003091919::config::AdminCap, arg1: &0xf9bd23323871f0f3f300b8704a107b0475d3a203880d02ec7d22a7c003091919::config::GlobalConfig, arg2: &mut RewarderGlobalVault, arg3: u64) : 0x2::balance::Balance<T0> {
        0xf9bd23323871f0f3f300b8704a107b0475d3a203880d02ec7d22a7c003091919::config::checked_package_version(arg1);
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: u128, arg2: u64) {
        ...
        while (v2 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            ...
            0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v2).growth_global = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).growth_global + 0x4044886fd1cfb98efe1783ec04f3d514a99a38d2dbc0cfeb3cbf9f0272a564c1::full_math_u128::mul_div_floor((v1 as u128), v3, arg1);
            v2 = v2 + 1;
        };
        let v4 = 18446744073709551616000000;
        arg0.points_released = arg0.points_released + (v1 as u128) * v4;
        arg0.points_growth_global = arg0.points_growth_global + 0x4044886fd1cfb98efe1783ec04f3d514a99a38d2dbc0cfeb3cbf9f0272a564c1::full_math_u128::mul_div_floor((v1 as u128), v4, arg1);
    }
