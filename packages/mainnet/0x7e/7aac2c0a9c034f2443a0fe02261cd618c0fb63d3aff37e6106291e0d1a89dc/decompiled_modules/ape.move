module 0x7e7aac2c0a9c034f2443a0fe02261cd618c0fb63d3aff37e6106291e0d1a89dc::ape {
    ...
    public(friend) fun create(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) : Ape {
    ...
    public(friend) fun uid_mut(arg0: &mut Ape) : &mut 0x2::object::UID {
        &mut arg0.id
    }

    public(friend) fun update(arg0: &mut Ape, arg1: vector<u8>, arg2: vector<u8>, arg3: u8, arg4: &0x2::tx_context::TxContext) {
