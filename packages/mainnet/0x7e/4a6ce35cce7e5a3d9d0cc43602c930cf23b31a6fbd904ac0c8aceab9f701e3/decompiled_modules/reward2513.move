module 0x7e4a6ce35cce7e5a3d9d0cc43602c930cf23b31a6fbd904ac0c8aceab9f701e3::reward2513 {
    struct REWARD2513 has drop {
        dummy_field: bool,
    }

    struct TICKET_2513 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2513(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2513>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2513>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2513, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2513>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2513>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2513>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2513>>(v5, 0x2::tx_context::sender(arg1));
    }
