module 0x371a30d40fcc357a37d412c4750a57303d58c9482e5f51886e46f7bf774028f3::MesonHelpers {
    public(friend) fun amount_factor(arg0: u8) : u64 {
        if (arg0 <= 32) {
            1
        } else if (arg0 == 242) {
            100
        } else if (arg0 > 112 && arg0 <= 123) {
            100
        } else if (arg0 > 123 && arg0 <= 128) {
            1000
        } else {
            1000000000000
        }
    ...
    public(friend) fun service_fee(arg0: vector<u8>) : u64 {
        let v0 = in_coin_index_from(arg0);
        let v1 = if (v0 >= 252) {
            500
        } else if (v0 >= 248) {
            5000
        ...
        let v2 = amount_from(arg0) * 5 / 10000;
        if (v2 > v1) {
            v2
        } else {
            v1
