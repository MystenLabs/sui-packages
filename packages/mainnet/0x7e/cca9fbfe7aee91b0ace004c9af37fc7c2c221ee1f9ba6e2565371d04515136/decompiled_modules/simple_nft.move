module 0x7ecca9fbfe7aee91b0ace004c9af37fc7c2c221ee1f9ba6e2565371d04515136::simple_nft {
    ...
    public entry fun create_simple_nft(arg0: 0x1::string::String, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = SimpleNFT{
            ...
            image_url   : 0x1::string::utf8(b"https://ccwpidms8429p4fi.public.blob.vercel-storage.com/icora/user/1759838582787_tvkfpr.jpg"),
        };
