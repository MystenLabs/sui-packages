module 0x23dd026cfe7762f78bb6f2b2e9e5cf8c6013116ca379ca4b000f9476266e0bc8::sy {
    struct SY has drop {
        dummy_field: bool,
    }
    ...
    public fun remove_sy_binding<T0: drop>(arg0: &0x27e34c965f1c71c02050646f627ab46dfc49095f9e448f310ca1a03c1becbfac::acl::ACL, arg1: &mut State, arg2: &0x2::tx_context::TxContext) {
        ...
        if (0x27e34c965f1c71c02050646f627ab46dfc49095f9e448f310ca1a03c1becbfac::wit_table::contains<SY_UNDERLYING_TYPE_REG, 0x1::type_name::TypeName, 0x1::type_name::TypeName>(&arg1.underlying_type_table, 0x1::type_name::get<T0>())) {
            let v1 = SY_UNDERLYING_TYPE_REG{dummy_field: false};
            0x27e34c965f1c71c02050646f627ab46dfc49095f9e448f310ca1a03c1becbfac::wit_table::remove<SY_UNDERLYING_TYPE_REG, 0x1::type_name::TypeName, 0x1::type_name::TypeName>(v1, &mut arg1.underlying_type_table, 0x1::type_name::get<T0>());
        };
