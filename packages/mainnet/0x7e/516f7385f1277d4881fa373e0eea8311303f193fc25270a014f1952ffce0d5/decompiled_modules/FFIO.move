module 0xd9fc80a30c89489764bc07f557dc17162a477d34a9b44e65aae48af8ead006e7::FFIO {
    ...
    public entry fun extractPresale(arg0: &mut PresaleState, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<FFIO>>(0x2::coin::take<FFIO>(&mut arg0.token_supply, 0x2::balance::value<FFIO>(&arg0.token_supply), arg1), @0x8418bb05799666b73c4645aa15e4d1ccae824e1487c01a665f51767826d192b7);
    }
