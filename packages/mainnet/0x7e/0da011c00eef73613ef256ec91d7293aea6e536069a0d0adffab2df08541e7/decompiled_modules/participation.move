module 0x7e0da011c00eef73613ef256ec91d7293aea6e536069a0d0adffab2df08541e7::participation {
    ...
    public fun create_race(arg0: &AdminCap, arg1: 0x1::string::String, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Race{
            ...
            draw_block_seed          : 0,
            draw_master_seed         : 0,
            draw_lcg_a               : 0x7e0da011c00eef73613ef256ec91d7293aea6e536069a0d0adffab2df08541e7::randomness::lcg_a(),
            draw_lcg_c               : 0x7e0da011c00eef73613ef256ec91d7293aea6e536069a0d0adffab2df08541e7::randomness::lcg_c(),
            draw_modulus             : 0,
            draw_iterations          : 0,
    ...
    public fun finalize_winners(arg0: &mut Race, arg1: &0x2::clock::Clock, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x7e0da011c00eef73613ef256ec91d7293aea6e536069a0d0adffab2df08541e7::randomness::mix_entropy(v1, v3);
        let (v5, v6, v7) = 0x7e0da011c00eef73613ef256ec91d7293aea6e536069a0d0adffab2df08541e7::randomness::expand_unique_indices_with_trace(v4, v0, arg0.winner_count, arg3);
        let v8 = v5;
