module 0x7e78ddb6e93ca75a5b04d2aa28c825124c2a88728f271ca0139d0fb489ae9ca8::reward2064 {
    struct REWARD2064 has drop {
        dummy_field: bool,
    }

    struct TICKET_2064 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2064(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2064>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2064>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2064, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2064>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2064>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2064>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2064>>(v5, 0x2::tx_context::sender(arg1));
    }
