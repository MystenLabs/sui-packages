module 0x7e171fb5a29041048bf3d9965946fe78e9f8cfe2f3d9b3b0452bdd8807cd02b4::reward8501 {
    struct REWARD8501 has drop {
        dummy_field: bool,
    }

    struct TICKET_8501 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8501(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8501>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8501>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8501, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8501>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8501>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8501>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8501>>(v5, 0x2::tx_context::sender(arg1));
    }
