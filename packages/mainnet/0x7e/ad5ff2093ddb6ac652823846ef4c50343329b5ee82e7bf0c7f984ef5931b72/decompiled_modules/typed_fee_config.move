module 0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::typed_fee_config {
    ...
    fun assert_supported_policy_version(arg0: u64) {
        assert!(arg0 == 0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::typed_fee_governance::minimum_start_policy_version(), 3);
    }
    ...
    public(friend) fun asset_type_matches_config<T0>(arg0: &TypedFeeConfig<T0>) : bool {
        0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::onchain_asset_lane_manager::matches_supported_order_typed_non_sui_asset_bytes<T0>(&arg0.asset_type_bytes)
    }
    ...
    public(friend) fun config_params_valid<T0>(arg0: u64, arg1: u8, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : bool {
        arg0 == 0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::typed_fee_governance::minimum_start_policy_version() && 0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::typed_fee_governance::admin_update_params_valid<T0>(arg1, arg2, arg3, arg4, arg5)
    }
    ...
    public(friend) fun config_target_supported<T0>() : bool {
        if (0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::typed_fee_policy::exact_typed_fee_policy_required<T0>()) {
            if (0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::typed_fee_policy::typed_collateral_fee_policy_closed<T0>()) {
                0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::onchain_asset_lane_manager::is_supported_order_typed_non_sui_asset<T0>()
            } else {
                false
            }
        } else {
    ...
    public(friend) fun create_minimum_start_config<T0>(arg0: &TypedFeeAdminCap<T0>, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) : TypedFeeConfig<T0> {
        create_config<T0>(arg0, 0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::typed_fee_governance::minimum_start_policy_version(), 1, 0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::typed_fee_governance::native_sui_usdc_decimals(), 0, 0, 0, 0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::typed_fee_governance::min_viable_order_amount_floor(), arg1, arg2)
    }
    ...
    public(friend) fun disabled_seed_entry_source_candidate<T0>() : bool {
        0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::onchain_asset_lane_manager::matches_sui_usdc_testnet_type<T0>() && config_target_supported<T0>()
    }
    ...
    public(friend) fun minimum_start_config<T0>(arg0: &TypedFeeConfig<T0>) : bool {
        if (config_shape_valid<T0>(arg0)) {
            if (arg0.policy_version == 0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::typed_fee_governance::minimum_start_policy_version()) {
                if (arg0.config_version >= 1) {
                    if (arg0.decimals == 0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::typed_fee_governance::native_sui_usdc_decimals()) {
                        if (arg0.bps == 0) {
                            if (arg0.min_fee_amount == 0) {
                                if (arg0.max_fee_amount == 0) {
                                    arg0.min_viable_order_amount == 0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::typed_fee_governance::min_viable_order_amount_floor()
                                } else {
                                    false
                                }
                            } else {
    ...
    public(friend) fun network_for_config_target<T0>() : u8 {
        if (0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::onchain_asset_lane_manager::matches_sui_usdc_testnet_type<T0>()) {
            return 1
        };
        if (0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::onchain_asset_lane_manager::matches_sui_usdc_mainnet_type<T0>()) {
            return 2
        };
        0
    }
    ...
    fun supported_asset_type_bytes<T0>() : vector<u8> {
        let v0 = 0x7ead5ff2093ddb6ac652823846ef4c50343329b5ee82e7bf0c7f984ef5931b72::onchain_asset_lane_manager::supported_order_typed_non_sui_asset_bytes<T0>();
