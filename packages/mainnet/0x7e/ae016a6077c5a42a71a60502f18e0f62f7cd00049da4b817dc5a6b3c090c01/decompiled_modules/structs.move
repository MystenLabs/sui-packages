module 0x80c9d4eb2f358ee3c6d249402954e0b51fbbd993053f1d2e2999370aed799fcc::structs {
    ...
    struct DWalletAddressSet has copy, drop {
        chain_id: u64,
    ...
    public(friend) fun emit_dwallet_address_set(arg0: u64, arg1: vector<u8>) {
        let v0 = DWalletAddressSet{
            chain_id        : arg0,
            dwallet_address : arg1,
        };
        0x2::event::emit<DWalletAddressSet>(v0);
    }
