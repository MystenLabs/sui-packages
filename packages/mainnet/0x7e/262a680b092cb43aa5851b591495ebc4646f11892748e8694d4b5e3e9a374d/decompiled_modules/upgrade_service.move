module 0x7e262a680b092cb43aa5851b591495ebc4646f11892748e8694d4b5e3e9a374d::upgrade_service {
    struct UpgradeService<phantom T0> has store, key {
        id: 0x2::object::UID,
        admin: 0x7e262a680b092cb43aa5851b591495ebc4646f11892748e8694d4b5e3e9a374d::two_step_role::TwoStepRole<AdminRole<T0>>,
    }
    ...
    entry fun destroy_empty<T0>(arg0: UpgradeService<T0>, arg1: &0x2::tx_context::TxContext) {
        0x7e262a680b092cb43aa5851b591495ebc4646f11892748e8694d4b5e3e9a374d::two_step_role::assert_sender_is_active_role<AdminRole<T0>>(&arg0.admin, arg1);
        ...
        0x7e262a680b092cb43aa5851b591495ebc4646f11892748e8694d4b5e3e9a374d::two_step_role::destroy<AdminRole<T0>>(v1);
    ...
    public fun new<T0: drop>(arg0: T0, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : (UpgradeService<T0>, T0) {
        ...
        let v1 = UpgradeService<T0>{
            ...
            admin : 0x7e262a680b092cb43aa5851b591495ebc4646f11892748e8694d4b5e3e9a374d::two_step_role::new<AdminRole<T0>>(v0, arg1),
        };
        (v1, arg0)
    }
    ...
    public fun authorize_upgrade<T0>(arg0: &mut UpgradeService<T0>, arg1: u8, arg2: vector<u8>, arg3: &0x2::tx_context::TxContext) : 0x2::package::UpgradeTicket {
        0x7e262a680b092cb43aa5851b591495ebc4646f11892748e8694d4b5e3e9a374d::two_step_role::assert_sender_is_active_role<AdminRole<T0>>(&arg0.admin, arg3);
    ...
    public fun commit_upgrade<T0>(arg0: &mut UpgradeService<T0>, arg1: 0x2::package::UpgradeReceipt, arg2: &0x2::tx_context::TxContext) {
        0x7e262a680b092cb43aa5851b591495ebc4646f11892748e8694d4b5e3e9a374d::two_step_role::assert_sender_is_active_role<AdminRole<T0>>(&arg0.admin, arg2);
        assert_upgrade_cap_exists<T0>(arg0);
    ...
    entry fun accept_admin<T0>(arg0: &mut UpgradeService<T0>, arg1: &0x2::tx_context::TxContext) {
        0x7e262a680b092cb43aa5851b591495ebc4646f11892748e8694d4b5e3e9a374d::two_step_role::accept_role<AdminRole<T0>>(&mut arg0.admin, arg1);
    }
    ...
    public fun admin<T0>(arg0: &UpgradeService<T0>) : address {
        0x7e262a680b092cb43aa5851b591495ebc4646f11892748e8694d4b5e3e9a374d::two_step_role::active_address<AdminRole<T0>>(&arg0.admin)
    }
    ...
    entry fun change_admin<T0>(arg0: &mut UpgradeService<T0>, arg1: address, arg2: &0x2::tx_context::TxContext) {
        0x7e262a680b092cb43aa5851b591495ebc4646f11892748e8694d4b5e3e9a374d::two_step_role::begin_role_transfer<AdminRole<T0>>(&mut arg0.admin, arg1, arg2);
    }
    ...
    public fun pending_admin<T0>(arg0: &UpgradeService<T0>) : 0x1::option::Option<address> {
        0x7e262a680b092cb43aa5851b591495ebc4646f11892748e8694d4b5e3e9a374d::two_step_role::pending_address<AdminRole<T0>>(&arg0.admin)
    }
