module 0x7e8317039e6e08a3cf0ce0bc61d2828ca6e5da62786790d0a72de61a26c2b5ea::kekius {
    ...
    fun init(arg0: KEKIUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/XC78JjRHnSqaysrHiTrhR8eRngFbvX3rrHyRjWEpump.png?size=lg&key=81f0bc                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<KEKIUS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"KEKIUS  ")))), trim_right(b"Kekius Maximus On Sui           "), trim_right(b"First EVER Grok generated Meme, Elons Gaming character - Elons Loves Kekius Maximus - and we love Elon - Supreme Meme Lord                                                                                                                                                                                                      "), v2, arg1);
        let v5 = v3;
