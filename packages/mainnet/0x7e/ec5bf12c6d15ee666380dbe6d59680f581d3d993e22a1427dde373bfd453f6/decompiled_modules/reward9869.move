module 0x7eec5bf12c6d15ee666380dbe6d59680f581d3d993e22a1427dde373bfd453f6::reward9869 {
    struct REWARD9869 has drop {
        dummy_field: bool,
    }

    struct TICKET_9869 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9869(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_9869>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9869, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9869>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9869>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9869>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9869>>(v5, 0x2::tx_context::sender(arg1));
    }
