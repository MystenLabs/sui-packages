module 0x7e51d4b7aa9226ab8b6d61739814fa796054d8195df84e4235f1304a19c1b8f4::reward9922 {
    struct REWARD9922 has drop {
        dummy_field: bool,
    }

    struct TICKET_9922 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9922(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9922>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9922>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9922, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9922>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9922>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9922>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9922>>(v5, 0x2::tx_context::sender(arg1));
    }
