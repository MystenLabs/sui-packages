module 0x7eea2247ca99d3b5a1390d60ddccaa9f842cef4aa39110049b8da58e2c1c96ec::field {
    ...
    fun check_harvestable<T0>(arg0: &mut Field, arg1: u64, arg2: &0x2::clock::Clock) {
        ...
        assert!(0x2::clock::timestamp_ms(arg2) - v1.planted >= 0x7eea2247ca99d3b5a1390d60ddccaa9f842cef4aa39110049b8da58e2c1c96ec::fruit::get_harvest_time<T0>(0x2::dynamic_field::borrow_mut<0x2::object::ID, 0x7eea2247ca99d3b5a1390d60ddccaa9f842cef4aa39110049b8da58e2c1c96ec::fruit::Fruit<T0>>(&mut arg0.id, v1.name)), 3);
    }
    ...
    public fun harvest_fruit<T0>(arg0: &mut Field, arg1: u64, arg2: &0x2::clock::Clock) : 0x7eea2247ca99d3b5a1390d60ddccaa9f842cef4aa39110049b8da58e2c1c96ec::fruit::Fruit<T0> {
        assert!(arg1 < 9, 0);
        ...
        *v0 = 0x1::option::none<Slot>();
        0x2::dynamic_field::remove<0x2::object::ID, 0x7eea2247ca99d3b5a1390d60ddccaa9f842cef4aa39110049b8da58e2c1c96ec::fruit::Fruit<T0>>(&mut arg0.id, v1.name)
    }

    public fun plant_fruit<T0>(arg0: &mut Field, arg1: u64, arg2: 0x7eea2247ca99d3b5a1390d60ddccaa9f842cef4aa39110049b8da58e2c1c96ec::fruit::Fruit<T0>, arg3: &mut 0x2::tx_context::TxContext, arg4: &0x2::clock::Clock) {
        assert!(arg1 < 9, 0);
        let v0 = 0x1::vector::borrow_mut<0x1::option::Option<Slot>>(&mut arg0.plots, arg1);
        ...
        0x2::dynamic_field::add<0x2::object::ID, 0x7eea2247ca99d3b5a1390d60ddccaa9f842cef4aa39110049b8da58e2c1c96ec::fruit::Fruit<T0>>(&mut arg0.id, v2.name, arg2);
