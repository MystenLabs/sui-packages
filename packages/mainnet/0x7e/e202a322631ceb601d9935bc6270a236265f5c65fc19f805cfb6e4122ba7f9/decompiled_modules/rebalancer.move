module 0x7ee202a322631ceb601d9935bc6270a236265f5c65fc19f805cfb6e4122ba7f9::rebalancer {
    struct Vault<T0: store> has store, key {
        id: 0x2::object::UID,
    ...
    fun assert_pool<T0: store>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, T0>) {
    ...
    public entry fun create<T0: store>(arg0: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg0) == @0x381fa7b8c35ef12b989638c01e3d46ab9839736fdc13bff0bff5b4505a907c80, 1);
        let v0 = Vault<T0>{
    ...
    public entry fun deposit_magma<T0: store>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        assert_owner(arg2);
        0x2::balance::join<T0>(&mut arg0.bal_m, 0x2::coin::into_balance<T0>(arg1));
    }

    public entry fun deposit_usdc<T0: store>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &mut 0x2::tx_context::TxContext) {
        assert_owner(arg2);
    ...
    public entry fun withdraw_magma<T0: store>(arg0: &mut Vault<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert_owner(arg2);
    ...
    public entry fun withdraw_usdc<T0: store>(arg0: &mut Vault<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert_owner(arg2);
