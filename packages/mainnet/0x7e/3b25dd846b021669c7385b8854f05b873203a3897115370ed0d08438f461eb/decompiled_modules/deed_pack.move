module 0x7e3b25dd846b021669c7385b8854f05b873203a3897115370ed0d08438f461eb::deed_pack {
    ...
    public(friend) fun burn(arg0: DeedPack, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x7e3b25dd846b021669c7385b8854f05b873203a3897115370ed0d08438f461eb::events::emit_deed_burned(0x2::object::uid_to_inner(&v3), v1, v2, arg1, arg2);
    ...
    public(friend) fun mint(arg0: address, arg1: u8, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x7e3b25dd846b021669c7385b8854f05b873203a3897115370ed0d08438f461eb::events::emit_minted(arg0, 0x2::object::uid_to_inner(&v0.id), arg1, arg2);
    }
