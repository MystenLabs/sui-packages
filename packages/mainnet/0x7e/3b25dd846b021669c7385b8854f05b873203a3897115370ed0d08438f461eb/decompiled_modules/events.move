module 0x7e3b25dd846b021669c7385b8854f05b873203a3897115370ed0d08438f461eb::events {
    ...
    public fun emit_commit_limit_updated(arg0: address, arg1: u8, arg2: u64, arg3: &0x2::clock::Clock) {
    ...
    public fun emit_commit_limits_updated(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
    ...
    public fun emit_deed_burned(arg0: 0x2::object::ID, arg1: u8, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = DeedBurned{
            deed_id   : arg0,
            tier      : arg1,
    ...
    public fun emit_minted(arg0: address, arg1: 0x2::object::ID, arg2: u8, arg3: &0x2::clock::Clock) {
        let v0 = Minted{
            user      : arg0,
            id        : arg1,
            tier      : arg2,
