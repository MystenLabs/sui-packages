module 0x7ec14b2cc1eb17b7c4303add5384933df860d2b8386dcf452e04b8ed7f390af8::cnsnft9141 {
    struct CNSNFT9141 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9141, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9141>(arg0, arg1);
