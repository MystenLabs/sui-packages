module 0x7edc23bf98cded6cb31f1b8c5ff0af2259fc5b126603fa8011e43c41eddee2e0::reward4708 {
    struct REWARD4708 has drop {
        dummy_field: bool,
    }

    struct TICKET_4708 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4708(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4708>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4708>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4708, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4708>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4708>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4708>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4708>>(v5, 0x2::tx_context::sender(arg1));
    }
