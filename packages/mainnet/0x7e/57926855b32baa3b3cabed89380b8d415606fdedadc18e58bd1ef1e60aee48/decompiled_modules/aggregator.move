module 0x7e57926855b32baa3b3cabed89380b8d415606fdedadc18e58bd1ef1e60aee48::aggregator {
    struct SwapSession {
        id: 0x2::object::ID,
    ...
    public fun close_swap<T0>(arg0: SwapSession, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let SwapSession {
            id                       : v0,
            input_type               : v1,
            output_type              : v2,
        ...
        let v16 = if (v6 > 0) {
            ...
            0x7e57926855b32baa3b3cabed89380b8d415606fdedadc18e58bd1ef1e60aee48::utils::transfer_balance<T0>(0x2::balance::split<T0>(&mut v14, v17), v7, arg1);
            v17
        } else {
            0
        };
        ...
        let v19 = if (v8 > 0 && 0x1::option::is_some<address>(&v11)) {
            ...
            0x7e57926855b32baa3b3cabed89380b8d415606fdedadc18e58bd1ef1e60aee48::utils::transfer_balance<T0>(0x2::balance::split<T0>(&mut v14, v20), v21, arg1);
        ...
        assert!(v22 >= v5, 0x7e57926855b32baa3b3cabed89380b8d415606fdedadc18e58bd1ef1e60aee48::errors::err_amount_out_slippage_check_failed());
        if (v22 >= v4) {
            let v23 = v22 - v4;
            v18 = v16 + v23;
            0x7e57926855b32baa3b3cabed89380b8d415606fdedadc18e58bd1ef1e60aee48::utils::transfer_balance<T0>(0x2::balance::split<T0>(&mut v14, v23), v7, arg1);
        };
        assert!(0x2::bag::is_empty(&v13), 0x7e57926855b32baa3b3cabed89380b8d415606fdedadc18e58bd1ef1e60aee48::errors::err_remains_balance());
    ...
    public fun open_swap<T0, T1>(arg0: u64, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u32, arg4: address, arg5: u32, arg6: 0x1::option::Option<address>, arg7: &mut 0x2::tx_context::TxContext) : SwapSession {
        ...
        assert!(v0 > 0, 0x7e57926855b32baa3b3cabed89380b8d415606fdedadc18e58bd1ef1e60aee48::errors::err_amount_in_is_zero());
        assert!(arg3 <= 100000, 0x7e57926855b32baa3b3cabed89380b8d415606fdedadc18e58bd1ef1e60aee48::errors::err_too_large_fee_rate());
        assert!(arg5 <= 100000, 0x7e57926855b32baa3b3cabed89380b8d415606fdedadc18e58bd1ef1e60aee48::errors::err_too_large_fee_rate());
