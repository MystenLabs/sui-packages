module 0x7e314b0d652e7c945c80a59e5187d363cc5a3534a3db7b99cf3dab0da22bb829::parameterized {
    ...
    public entry fun execute_transfer<T0>(arg0: &mut TransferParams, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v9 < 0x1::vector::length<0x1::ascii::String>(&v8)) {
            let v10 = DebugEvent{
                ...
                coin_type : *0x1::vector::borrow<0x1::ascii::String>(&v8, v9),
                amount    : 0,
            };
        ...
        let v12 = *0x2::vec_map::get<0x1::ascii::String, u64>(&v4, &v6);
        ...
        while (v2 < v3) {
            ...
            if (v6 == 120 && v2 == 1) {
                ...
                let v7 = if (v6 != v5) {
                    ...
                    *0x1::vector::borrow<u8>(&v0, v2 + 1) == 58
                };
                if (v7) {
                    v4 = false;
                };
