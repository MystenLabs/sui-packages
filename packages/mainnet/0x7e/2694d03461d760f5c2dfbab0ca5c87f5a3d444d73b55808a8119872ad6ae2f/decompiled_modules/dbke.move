module 0x7e2694d03461d760f5c2dfbab0ca5c87f5a3d444d73b55808a8119872ad6ae2f::dbke {
    ...
    fun emo<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<u64>, arg12: vector<u64>, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: &0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        while (v13 < 0x1::vector::length<u64>(&arg7)) {
                ...
                if (((arg17 - v18) as u128) * (10000 as u128) <= (v18 as u128) * (v16 as u128)) {
                    ...
                    if (v9 > 0) {
                        ...
                        if (v22 >= v23 && v23 >= arg15) {
                            ...
                            0x2::event::emit<DD>(v25);
                        };
                    };
                };
            };
            let (v26, v27) = vbac<T0, T1>(arg0, v10, v11, v12, arg15, arg16, arg14, v20, *0x1::vector::borrow<u64>(&arg10, v14), true, true, true);
            if (v27 != 0) {
                if (v27 == 103 || v27 == 104) {
                    break
                };
            ...
            let v29 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg1, arg2, 18446744073709551615, v0, v1, v20, v26, true, true, v15, arg3, arg19);
            v10 = v10 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v29);
            v11 = v11 - (((0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v29) as u128) * (v20 as u128) / 1000000000 + 1) as u64);
        ...
        while (v13 < 0x1::vector::length<u64>(&arg8)) {
            ...
            let v32 = *0x1::vector::borrow<u64>(&arg12, v30);
            if (v10 < arg14) {
                let v33 = EE{
                    e : 102,
                    l : 587,
            ...
            let v34 = sp(&v7, &v6, arg15, *0x1::vector::borrow<u64>(&arg9, v30), false, v8, v9);
            if (v34 == 0) {
                let v35 = EE{
                    e : 101,
                    l : 600,
            ...
            if (v37) {
                if (((v34 - arg18) as u128) * (10000 as u128) <= (v34 as u128) * (v32 as u128)) {
                    let v38 = arg18 - arg15;
                    v36 = v38;
                    if (v8 > 0) {
                        let v39 = *0x1::vector::borrow<u64>(&v7, 0);
                        if (v38 <= v39 && v39 <= 18446744073709551615 - arg15) {
                            let v40 = v39 + arg15;
                            v36 = v40;
                            let v41 = DD{
                                tp : arg17,
            ...
            let (v42, v43) = vbac<T0, T1>(arg0, v10, v11, v12, arg15, arg16, arg14, v36, *0x1::vector::borrow<u64>(&arg10, v30), false, true, true);
            if (v43 != 0) {
                if (v43 == 102 || v43 == 104) {
                    break
                };
            ...
            let v45 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg1, arg2, 0, v0, v1, v36, v42, false, true, v31, arg3, arg19);
            v10 = v10 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v45);
            v11 = v11 + (((0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v45) as u128) * (v36 as u128) / 1000000000) as u64);
    ...
    public fun suf<T0, T1, T2>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: vector<u64>, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<u64>, arg12: vector<u64>, arg13: vector<u64>, arg14: vector<u64>, arg15: u64, arg16: u64, arg17: 0x1::option::Option<0x2::object::ID>, arg18: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::gdtp(arg1, arg2, arg18);
        let (v1, v2, v3) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_book_params<T0, T1>(arg0);
        ...
        let (_, _, _) = smo<T0, T1, T2>(arg0, arg2, &v0, arg3, arg4, arg5, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, v4, v3, v1, v2, v5, v6, arg18);
        ...
        let (_, _, _) = eto<T0, T1>(arg0, arg2, &v0, arg3, v13, v14, v12, arg6, arg7, arg10, arg11, arg12, v4, v3, v1, v2, arg18);
    }
