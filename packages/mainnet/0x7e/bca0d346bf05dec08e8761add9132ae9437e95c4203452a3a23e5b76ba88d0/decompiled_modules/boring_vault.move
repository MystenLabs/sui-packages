module 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::boring_vault {
    ...
    public fun add_new_asset_type<T0, T1>(arg0: &mut Vault<T1>, arg1: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::has_cap<T1, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg2)), 4);
    ...
    public fun add_new_depositable_asset_type<T0, T1>(arg0: &mut Vault<T1>, arg1: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T1>, arg2: u16, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::has_cap<T1, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg9)), 4);
        let v0 = 0x1::type_name::get_with_original_ids<T0>();
        assert!(!0x2::bag::contains<0x1::type_name::TypeName>(&arg0.assets_balance, v0), 6);
        0x2::bag::add<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.assets_balance, v0, 0x2::balance::zero<T0>());
        assert!(arg2 <= 1000, 12);
    ...
    public fun claim_fees<T0, T1>(arg0: &mut Vault<T1>, arg1: &mut 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::Accountant<T1>, arg2: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::has_cap<T1, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::ClaimerCap>(arg2, 0x2::tx_context::sender(arg3)), 4);
        assert!(!is_vault_paused<T1>(arg0), 7);
        assert!(arg0.version == 0, 32);
        assert!(!0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::is_paused<T1>(arg1), 27);
        let v0 = 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::get_fees_owed_in_base<T1>(arg1);
        assert!(v0 != 0, 28);
        0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::reset_fees_owed_in_base<T1>(arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(get_balance_mut<T0, T1>(arg0), v0), arg3), 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::get_payout_address<T1>(arg1));
        let v1 = FeesClaimedEvent<T1>{fees_owed: v0};
        0x2::event::emit<FeesClaimedEvent<T1>>(v1);
    }

    public fun complete_withdraw<T0, T1>(arg0: &mut Vault<T1>, arg1: &mut 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::Accountant<T1>, arg2: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T1>, arg3: address, arg4: &mut 0x1::option::Option<0x2::coin::Coin<T0>>, arg5: &0x2::clock::Clock, arg6: &0x2::deny_list::DenyList, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public fun complete_withdraw_by_request_id<T0, T1>(arg0: &mut Vault<T1>, arg1: &mut 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::Accountant<T1>, arg2: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T1>, arg3: &mut QueueKey, arg4: &mut 0x1::option::Option<0x2::coin::Coin<T0>>, arg5: &0x2::clock::Clock, arg6: &0x2::deny_list::DenyList, arg7: &mut 0x2::tx_context::TxContext) {
        assert_vault<T1>(arg0, arg6);
        let v0 = 0x1::type_name::get_with_original_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, DepositableAsset<T1>>(&arg0.depositable_assets, v0), 15);
        assert!(0x2::table::borrow<0x1::type_name::TypeName, DepositableAsset<T1>>(&arg0.depositable_assets, v0).allow_withdraws, 22);
    ...
    public fun deposit<T0, T1>(arg0: &mut Vault<T1>, arg1: &mut 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::Accountant<T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::deny_list::DenyList, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v1 > 0, 3);
        let v2 = (v1 as u256) * (0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::get_one_share<T1>(arg1) as u256) / (0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::get_rate_safe<T1>(arg1) as u256);
        let v3 = v2;
        ...
        0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::update_total_shares<T1>(arg1, 0x2::coin::total_supply<T1>(v8));
    ...
    public fun deposit_and_transfer<T0, T1>(arg0: &mut Vault<T1>, arg1: &mut 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::Accountant<T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::deny_list::DenyList, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun disable_global_pause<T0>(arg0: &mut Vault<T0>, arg1: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T0>, arg2: &mut 0x2::deny_list::DenyList, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::has_cap<T0, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::PauserCap>(arg1, 0x2::tx_context::sender(arg3)), 4);
        0x2::coin::deny_list_v2_disable_global_pause<T0>(arg2, deny_cap_mut<T0>(arg0), arg3);
    }

    public fun enable_global_pause<T0>(arg0: &mut Vault<T0>, arg1: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T0>, arg2: &mut 0x2::deny_list::DenyList, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::has_cap<T0, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::PauserCap>(arg1, 0x2::tx_context::sender(arg3)), 4);
    ...
    entry fun migrate_vault<T0>(arg0: &mut Vault<T0>, arg1: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T0>, arg2: &0x2::tx_context::TxContext) {
        assert!(0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::has_cap<T0, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg2)), 4);
        arg0.version = 0;
    ...
    public(friend) fun new_vault<T0>(arg0: &mut 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T0>, arg1: 0x2::coin::TreasuryCap<T0>, arg2: 0x2::coin::DenyCapV2<T0>, arg3: bool, arg4: bool, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : Vault<T0> {
        let v0 = Vault<T0>{
        ...
        0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::add_cap<T0, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::OwnerCap>(arg0, 0x2::tx_context::sender(arg6), 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::new_owner_cap());
        let v1 = &mut v0;
    ...
    public fun pause_vault_operations<T0>(arg0: &mut Vault<T0>, arg1: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T0>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::has_cap<T0, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::PauserCap>(arg1, 0x2::tx_context::sender(arg3)), 4);
    ...
    fun process_withdrawal_fulfillment<T0, T1>(arg0: &mut Vault<T1>, arg1: &mut 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::Accountant<T1>, arg2: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T1>, arg3: WithdrawalRequest<T1>, arg4: address, arg5: &mut 0x1::option::Option<0x2::coin::Coin<T0>>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg4 == 0x2::tx_context::sender(arg7)) {
            ...
            assert!(0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::has_cap<T1, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::SolverCap>(arg2, 0x2::tx_context::sender(arg7)), 4);
        };
        ...
        let v3 = 0x1::u256::try_as_u64((v0 as u256) * (0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::get_rate_safe<T1>(arg1) as u256) / (0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::get_one_share<T1>(arg1) as u256));
        ...
        0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::update_total_shares<T1>(arg1, 0x2::coin::total_supply<T1>(v22));
    ...
    public fun request_withdraw<T0, T1>(arg0: &mut Vault<T1>, arg1: &mut 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::Accountant<T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::deny_list::DenyList, arg7: &mut 0x2::tx_context::TxContext) : QueueKey {
        assert_vault<T1>(arg0, arg6);
        let v0 = 0x1::type_name::get_with_original_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, DepositableAsset<T1>>(&arg0.depositable_assets, v0), 15);
        ...
        let v3 = 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::get_rate_safe<T1>(arg1);
        let v4 = 0x2::coin::value<T1>(&arg2);
        let v5 = 0x2::clock::timestamp_ms(arg5);
        let v6 = 0x1::u256::try_as_u64((v4 as u256) * (v3 as u256) * ((10000 - arg3) as u256) / 10000 / (0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::accountant::get_one_share<T1>(arg1) as u256));
    ...
    public fun set_allow_self_solvers<T0>(arg0: &mut Vault<T0>, arg1: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T0>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::has_cap<T0, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg3)), 4);
    ...
    public fun set_allow_third_party_solvers<T0>(arg0: &mut Vault<T0>, arg1: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T0>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::has_cap<T0, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg3)), 4);
    ...
    public fun update_depositable_asset_type<T0, T1>(arg0: &mut Vault<T1>, arg1: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T1>, arg2: bool, arg3: bool, arg4: u16, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::has_cap<T1, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg11)), 4);
        assert!(arg4 <= 1000, 12);
        assert!(arg8 <= 3000, 17);
    ...
    public fun update_withdraw_capacity<T0, T1>(arg0: &mut Vault<T1>, arg1: &0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::Auth<T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::has_cap<T1, 0x7ebca0d346bf05dec08e8761add9132ae9437e95c4203452a3a23e5b76ba88d0::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg3)), 4);
        let v0 = 0x1::type_name::get_with_original_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, DepositableAsset<T1>>(&arg0.depositable_assets, v0), 15);
        let v1 = 0x2::table::borrow_mut<0x1::type_name::TypeName, DepositableAsset<T1>>(&mut arg0.depositable_assets, v0);
