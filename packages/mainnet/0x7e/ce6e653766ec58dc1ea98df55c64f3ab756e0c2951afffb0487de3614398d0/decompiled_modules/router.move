module 0x7ece6e653766ec58dc1ea98df55c64f3ab756e0c2951afffb0487de3614398d0::router {
    public fun bluefin_spot_swap_a2b<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x4ab6048e327d87ab734978ba4f08c619aa5f8a6bf71dc496f7dc79fb352aac49::events::emit_hop_log(0x1::string::utf8(b"bluefin_spot"), 0x1::type_name::into_string(0x1::type_name::get<T0>()), 0x1::type_name::into_string(0x1::type_name::get<T1>()), v0, 0x2::coin::value<T1>(&v3));
        v3
    }
    ...
    public fun bluefin_spot_swap_b2a<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x4ab6048e327d87ab734978ba4f08c619aa5f8a6bf71dc496f7dc79fb352aac49::events::emit_hop_log(0x1::string::utf8(b"bluefin_spot"), 0x1::type_name::into_string(0x1::type_name::get<T1>()), 0x1::type_name::into_string(0x1::type_name::get<T0>()), v0, 0x2::coin::value<T0>(&v3));
        v3
    }
    ...
    public fun finalize_swap<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u16, arg6: address, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        if (arg5 > 0) {
            if (arg4) {
                ...
                if (v0 > 0) {
                    0x4ab6048e327d87ab734978ba4f08c619aa5f8a6bf71dc496f7dc79fb352aac49::events::emit_commission(arg5, arg4, v0, arg6, 0x1::type_name::into_string(0x1::type_name::get<T0>()));
                };
            } else {
                ...
                if (v1 > 0) {
                    ...
                    0x4ab6048e327d87ab734978ba4f08c619aa5f8a6bf71dc496f7dc79fb352aac49::events::emit_commission(arg5, arg4, v1, arg6, 0x1::type_name::into_string(0x1::type_name::get<T1>()));
                };
            };
        };
        let v2 = 0x2::coin::value<T1>(&arg0);
        0x4ab6048e327d87ab734978ba4f08c619aa5f8a6bf71dc496f7dc79fb352aac49::events::emit_swap_log(arg7, 0x2::tx_context::sender(arg8), arg1, arg2, arg3, v2, 0x1::type_name::into_string(0x1::type_name::get<T0>()), 0x1::type_name::into_string(0x1::type_name::get<T1>()));
        assert!(v2 >= arg3, 0);
        arg0
    }
