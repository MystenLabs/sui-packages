module 0x7ef39f6543d873b81a2fedcea8b6e5657d88518bf73aecaff83a0db8e550bea9::lamasui_origin {
    struct LAMASUI_ORIGIN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LAMASUI_ORIGIN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<LAMASUI_ORIGIN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"LamaSui Origin"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"LamaSui is a NFTs collection fan Sui Network ! Unique collection cosmonaut Lama on desert market crypto survival new generation blockchain langage $MOVE !"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreihdelqwgaqur2xux2gjr6fzyb3vl36rifwnlhc3vwubtewnwkdeku"));
