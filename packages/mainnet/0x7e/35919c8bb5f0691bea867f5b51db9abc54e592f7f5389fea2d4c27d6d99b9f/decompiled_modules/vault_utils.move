module 0x7e35919c8bb5f0691bea867f5b51db9abc54e592f7f5389fea2d4c27d6d99b9f::vault_utils {
    ...
    public fun to_oracle_decimal(arg0: u256, arg1: u64) : u256 {
        assert!(arg1 <= 36, 8001);
        if (arg1 < 18) {
            arg0 * 0x1::u256::pow(10, ((18 - arg1) as u8))
        } else {
            arg0 / 0x1::u256::pow(10, ((arg1 - 18) as u8))
        }
    }
