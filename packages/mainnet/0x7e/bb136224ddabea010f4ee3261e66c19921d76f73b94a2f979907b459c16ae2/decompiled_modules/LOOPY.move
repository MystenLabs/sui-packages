module 0x7ebb136224ddabea010f4ee3261e66c19921d76f73b94a2f979907b459c16ae2::LOOPY {
    struct LOOPY has drop {
        dummy_field: bool,
    }

    fun init(arg0: LOOPY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<LOOPY>(arg0, 2, b"LOOPY", b"LOOPY", b"LOOPY", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/-0ZL6sYpkovz9_EE3VtIIMhajSOkzAWDo3DUJdtvOXI?ext=png")), arg1);
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<LOOPY>(&mut v3, 1000000000000, 0x2::tx_context::sender(arg1), arg1);
