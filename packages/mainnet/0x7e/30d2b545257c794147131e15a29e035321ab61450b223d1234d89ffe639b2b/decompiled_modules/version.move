module 0x7e30d2b545257c794147131e15a29e035321ab61450b223d1234d89ffe639b2b::version {
    ...
    fun init(arg0: VERSION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Version{
            ...
            value : 0x7e30d2b545257c794147131e15a29e035321ab61450b223d1234d89ffe639b2b::current_version::value(),
        };
    ...
    public fun is_active_version(arg0: &Version) : bool {
        arg0.value == 0x7e30d2b545257c794147131e15a29e035321ab61450b223d1234d89ffe639b2b::current_version::value()
    }
