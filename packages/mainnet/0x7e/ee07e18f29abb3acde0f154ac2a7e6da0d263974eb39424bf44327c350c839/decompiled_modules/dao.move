module 0x7eee07e18f29abb3acde0f154ac2a7e6da0d263974eb39424bf44327c350c839::dao {
    ...
    public entry fun change_fund_status<T0>(arg0: &mut DAOFund<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 < arg0.fundraise_end_at && 0x2::balance::value<0x2::sui::SUI>(&arg0.balance) >= v1) {
            ...
            0x2::coin::mint_and_transfer<T0>(&mut v2, (((v1 - 0x2::balance::value<0x2::sui::SUI>(&arg0.balance)) * arg0.price) as u64), arg0.creator, arg2);
    ...
    public entry fun commit<T0>(arg0: &mut DAOFund<T0>, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::mint_and_transfer<T0>(0x1::option::borrow_mut<0x2::coin::TreasuryCap<T0>>(&mut arg0.treasury_cap), arg0.price * v2, 0x2::tx_context::sender(arg4), arg4);
        let v8 = TokenMintedEvent{
            token_type : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            sender     : 0x2::tx_context::sender(arg4),
            amount     : arg1,
            minted_at  : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<TokenMintedEvent>(v8);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x7eee07e18f29abb3acde0f154ac2a7e6da0d263974eb39424bf44327c350c839::dao_config::new_global_dao_fee_and_shared(arg0);
    }
    ...
    public entry fun set_platform_fee(arg0: &OperatorCap, arg1: &mut 0x7eee07e18f29abb3acde0f154ac2a7e6da0d263974eb39424bf44327c350c839::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0x7eee07e18f29abb3acde0f154ac2a7e6da0d263974eb39424bf44327c350c839::dao_config::set_platform_fee(arg1, arg2, arg3, arg4);
    }
