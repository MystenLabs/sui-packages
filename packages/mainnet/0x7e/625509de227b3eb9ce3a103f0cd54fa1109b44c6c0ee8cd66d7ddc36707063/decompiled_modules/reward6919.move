module 0x7e625509de227b3eb9ce3a103f0cd54fa1109b44c6c0ee8cd66d7ddc36707063::reward6919 {
    struct REWARD6919 has drop {
        dummy_field: bool,
    }

    struct TICKET_6919 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6919(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6919>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6919>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6919, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6919>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6919>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6919>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6919>>(v5, 0x2::tx_context::sender(arg1));
    }
