module 0x7e1daabdf0d546d549c87a8ab92bb076e741cb97de231554afd0b85c3ff0e19f::sage {
    ...
    fun init(arg0: SAGE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<SAGE>(arg0, 9, 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"SAGE    ")))), trim_right(b"TokenSage                       "), trim_right(b"TokenSage Coin powers the AI ecosystem rewarding users for engagement providing exclusive insights and enabling governance features within the AI Agents community                                                                                                                                                              "), v1, arg1);
        let v4 = v2;
