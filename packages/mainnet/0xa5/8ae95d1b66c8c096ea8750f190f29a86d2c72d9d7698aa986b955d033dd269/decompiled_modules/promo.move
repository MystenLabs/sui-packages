module 0x766ac400986c23549b2ee673a37e518dee04bb3a22f9b953496b5e31c5036772::promo {
    ...
    fun rebate<T0: store + key>(arg0: &mut Rewards, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 && 0x2::balance::value<0x2::sui::SUI>(&arg0.balance) >= 1) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.balance, 1, arg1), 0x2::tx_context::sender(arg1));
        };
    }

    entry fun setup<T0: store + key>(arg0: &mut Rewards, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0xd625c16a689668a84b031863eee14b2ac228b553f06d7da9ba50808293be361a, 2);
