module 0xa591442033cd7bba261fb4ed07fb05d798396be735a0a47d691413c5a04c501c::cetus_vampire_attack {
    ...
    struct LockdropForPool<phantom T0, phantom T1> has key {
        ...
        total_hive_incentives: 0x2::balance::Balance<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>,
        hive_incentives: u64,
    ...
    public entry fun add_incentives_for_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut LockdropForPool<T0, T1>, arg2: &CetusAttackConfig, arg3: 0x2::coin::Coin<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (u64, 0x1::string::String) {
        0x2::clock::timestamp_ms(arg0);
        let v0 = 0x2::coin::into_balance<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(arg3);
        0x2::balance::join<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(&mut arg1.total_hive_incentives, 0x2::balance::split<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(&mut v0, arg4));
        ...
        0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::coin_helper::destroy_or_transfer_balance<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(v0, 0x2::tx_context::sender(arg5), arg5);
    ...
    public fun destroy_user_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::config::HiveEntryCap, arg2: &CetusAttackConfig, arg3: &LockdropForPool<T0, T1>, arg4: &mut 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::HiveProfile, arg5: address, arg6: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, u128) {
        0x2::clock::timestamp_ms(arg0);
        if (!0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::exists_for_profile(arg4, 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::get_profile_dof_capability_identifier(&arg3.user_profile_access_cap))) {
        ...
        } = 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::entry_remove_from_profile<UserCetusHivePosition>(&arg3.user_profile_access_cap, arg4, arg6);
        let v5 = v2;
        let v6 = v1;
    ...
    public fun does_user_have_position<T0, T1>(arg0: &0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::HiveProfile, arg1: &LockdropForPool<T0, T1>) : bool {
    ...
    public fun get_user_position<T0, T1>(arg0: &0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::HiveProfile, arg1: &LockdropForPool<T0, T1>) : (vector<u64>, vector<u128>, vector<u64>, vector<u128>, vector<u64>, u128, u64) {
        let v0 = 0x1::vector::empty<u64>();
        let v1 = 0x1::vector::empty<u128>();
        let v2 = 0x1::vector::empty<u64>();
        let v3 = 0x1::vector::empty<u128>();
        let v4 = 0x1::vector::empty<u64>();
        let v5 = 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::get_profile_dof_capability_identifier(&arg1.user_profile_access_cap);
        if (!0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::exists_for_profile(arg0, v5)) {
            return (v0, v1, v2, v3, v4, 0, 0)
        };
        let v6 = 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::borrow_from_profile<UserCetusHivePosition>(arg0, v5);
        v0 = v6.lockup_weeks;
        let v7 = 0;
    ...
    public entry fun initialize_attack_on_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::config::HiveEntryCap, arg2: 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::ProfileDofOwnershipCapability, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: &CetusAttackConfig, arg5: 0x1::string::String, arg6: u8, arg7: 0x2::coin::Coin<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : address {
        0x2::clock::timestamp_ms(arg0);
        let v0 = 0x2::coin::into_balance<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(arg7);
        ...
        let v3 = LockdropForPool<T0, T1>{
            ...
            total_hive_incentives               : 0x2::balance::split<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(&mut v0, arg8),
        ...
        0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::coin_helper::destroy_or_transfer_balance<0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive::HIVE>(v0, 0x2::tx_context::sender(arg9), arg9);
    ...
    public entry fun initialize_cetus_attack(arg0: &0x2::clock::Clock, arg1: &0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::config::HiveEntryCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) : address {
        0x2::clock::timestamp_ms(arg0);
    ...
    fun make_position_identifier(arg0: address, arg1: u64) : 0x1::string::String {
        ...
        0x1::string::append(&mut v0, 0x1::string::utf8(0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::coin_helper::u64_to_ascii(arg1)));
        v0
    }
    ...
    public fun stake_cetus_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x774b18f5c66b34ec2592e7c12ad2b8911eeb86d801cc6086e6d8b20c64d202d6::config::HiveEntryCap, arg2: &CetusAttackConfig, arg3: &mut LockdropForPool<T0, T1>, arg4: &mut 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::HiveProfile, arg5: 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (u128, 0x1::string::String, u8) {
        0x2::clock::timestamp_ms(arg0);
        let (v0, v1, _, v3) = 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::get_profile_meta_info(arg4);
        let v4 = if (0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::exists_for_profile(arg4, 0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::get_profile_dof_capability_identifier(&arg3.user_profile_access_cap))) {
            0x5f9994873af69d30335b597504edec9d8177efe9873e95d833092c95b2f9bc4b::hive_profile::entry_remove_from_profile<UserCetusHivePosition>(&arg3.user_profile_access_cap, arg4, arg7)
        } else {
