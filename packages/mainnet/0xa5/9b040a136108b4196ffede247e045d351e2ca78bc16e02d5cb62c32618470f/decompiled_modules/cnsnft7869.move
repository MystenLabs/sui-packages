module 0xa59b040a136108b4196ffede247e045d351e2ca78bc16e02d5cb62c32618470f::cnsnft7869 {
    struct CNSNFT7869 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7869, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4424"));
        let v4 = 0x2::package::claim<CNSNFT7869>(arg0, arg1);
