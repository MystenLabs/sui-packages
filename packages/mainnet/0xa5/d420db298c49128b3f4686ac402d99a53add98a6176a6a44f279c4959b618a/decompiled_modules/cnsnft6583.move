module 0xa5d420db298c49128b3f4686ac402d99a53add98a6176a6a44f279c4959b618a::cnsnft6583 {
    struct CNSNFT6583 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6583, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7028"));
        let v4 = 0x2::package::claim<CNSNFT6583>(arg0, arg1);
