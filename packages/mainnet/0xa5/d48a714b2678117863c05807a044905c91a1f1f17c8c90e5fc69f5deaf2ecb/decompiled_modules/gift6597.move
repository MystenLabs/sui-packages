module 0xa5d48a714b2678117863c05807a044905c91a1f1f17c8c90e5fc69f5deaf2ecb::gift6597 {
    struct GIFT6597 has drop {
        dummy_field: bool,
    }

    struct TICKET_6597 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6597(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6597>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6597>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6597, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6597>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6597>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6597>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6597>>(v5, 0x2::tx_context::sender(arg1));
    }
