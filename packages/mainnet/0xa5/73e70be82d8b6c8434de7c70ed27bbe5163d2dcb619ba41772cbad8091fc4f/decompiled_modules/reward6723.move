module 0xa573e70be82d8b6c8434de7c70ed27bbe5163d2dcb619ba41772cbad8091fc4f::reward6723 {
    struct REWARD6723 has drop {
        dummy_field: bool,
    }

    struct TICKET_6723 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6723(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6723>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6723>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6723, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6723>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6723>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6723>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6723>>(v5, 0x2::tx_context::sender(arg1));
    }
