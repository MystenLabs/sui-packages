module 0xa59f6fa7927612f0d2b5e9d1878e69ba1400d3b015fca510336186e56f9967ad::core {
    ...
    public(friend) fun add_pool<T0>(arg0: &mut Setting, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::vec_map::contains<0x1::type_name::TypeName, address>(&arg0.pools, &v0), 2);
    ...
    fun calculate_per_share_of_reward_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64) : u64 {
        let v0 = if (arg6 < arg1) {
            arg6
        } else {
            arg1
    ...
    fun full_debts<T0>(arg0: &mut Pool<T0>, arg1: u64, arg2: &0x2::clock::Clock) : 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64> {
        ...
        while (v1 < 0x2::vec_map::size<0x1::type_name::TypeName, RewardConfig>(&arg0.reward_configs)) {
            ...
            0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut v0, *v2, v3.per_share * arg1 / 1000000);
            v1 = v1 + 1;
        };
        v0
    }
    ...
    fun get_reward<T0>(arg0: &Deposit<T0>, arg1: &0x1::type_name::TypeName, arg2: u64) : u64 {
        arg0.amount * arg2 / 1000000 - get_debt<T0>(arg0, arg1)
    }
    ...
    public(friend) fun per_share_of_period(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        if (arg1 <= arg0 || arg3 == 0) {
            0
        } else {
            (arg1 - arg0) * arg2 * 1000000 / arg3
        }
    }
    ...
    public(friend) fun remaining<T0>(arg0: &Pool<T0>, arg1: &Deposit<T0>, arg2: &0x2::clock::Clock) : 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64> {
        ...
        while (v1 < 0x2::vec_map::size<0x1::type_name::TypeName, RewardConfig>(&arg0.reward_configs)) {
            ...
            0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut v0, *v2, calculate_per_share_of_reward_config(v3.reward_rate_before, v3.rate_change_at, v3.reward_rate_after, v3.per_share, v3.last_update_time, 0x2::balance::value<T0>(&arg0.balance), now(arg2)) * arg1.amount / 1000000 - get_debt<T0>(arg1, v2));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    fun rewards_to_credits<T0>(arg0: &mut Pool<T0>, arg1: &mut Deposit<T0>, arg2: &0x2::clock::Clock) {
        ...
        while (v0 < 0x2::vec_map::size<0x1::type_name::TypeName, RewardConfig>(&arg0.reward_configs)) {
            ...
            let v3 = get_reward<T0>(arg1, v1, v2.per_share);
            add_credit<T0>(arg1, v1, v3);
            v0 = v0 + 1;
        };
        arg1.debts = full_debts<T0>(arg0, arg1.amount, arg2);
    }
