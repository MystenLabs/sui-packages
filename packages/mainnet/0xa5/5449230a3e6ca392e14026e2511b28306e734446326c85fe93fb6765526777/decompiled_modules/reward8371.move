module 0xa55449230a3e6ca392e14026e2511b28306e734446326c85fe93fb6765526777::reward8371 {
    struct REWARD8371 has drop {
        dummy_field: bool,
    }

    struct TICKET_8371 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8371(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8371>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8371>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8371, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8371>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8371>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8371>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8371>>(v5, 0x2::tx_context::sender(arg1));
    }
