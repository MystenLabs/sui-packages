module 0xa5392a0d0f138efce95ab3b0644f28533b6ee17b27eb345bd052f326d06dd58b::cnsnft9855 {
    struct CNSNFT9855 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9855, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5359"));
        let v4 = 0x2::package::claim<CNSNFT9855>(arg0, arg1);
