module 0xa5054e3ed945454ca288af7c27606564ab0e64c22ba4c1c96bf886dd0cb314bd::cnsnft7459 {
    struct CNSNFT7459 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7459, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4250"));
        let v4 = 0x2::package::claim<CNSNFT7459>(arg0, arg1);
