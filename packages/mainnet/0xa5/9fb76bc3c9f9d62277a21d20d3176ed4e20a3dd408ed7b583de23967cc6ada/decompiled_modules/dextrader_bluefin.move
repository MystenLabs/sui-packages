module 0xa59fb76bc3c9f9d62277a21d20d3176ed4e20a3dd408ed7b583de23967cc6ada::dextrader_bluefin {
    ...
    public(friend) fun check_pool_ticks<T0, T1>(arg0: &State, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg2: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg3: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x2::clock::Clock) {
        ...
        let v2 = 0x2::table::borrow<0x2::object::ID, 0xa59fb76bc3c9f9d62277a21d20d3176ed4e20a3dd408ed7b583de23967cc6ada::pyth_oracle::OracleConfig>(&arg0.oracles, v0);
        let v3 = 0xa59fb76bc3c9f9d62277a21d20d3176ed4e20a3dd408ed7b583de23967cc6ada::pyth_oracle::get_oracle_price_x128(v2, arg4, arg0.oracle_staleness_threshold, 0xa59fb76bc3c9f9d62277a21d20d3176ed4e20a3dd408ed7b583de23967cc6ada::pyth_oracle::is_a2b(v2), arg5);
        let v4 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_tick_manager<T0, T1>(arg1);
        let v5 = 0x1::u256::pow((0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::sqrt_price(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::get_tick_from_manager(v4, arg2)) as u256), 2);
        let v6 = 0x1::u256::pow((0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::sqrt_price(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::get_tick_from_manager(v4, arg3)) as u256), 2);
        ...
        assert!(0x1::u256::min(v6, v5) >= 0x1::u256::max(v7, v3) || 0x1::u256::max(v6, v5) <= 0x1::u256::min(v7, v3), 122);
    }
