module 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_maintainer {
    ...
    public entry fun admin_clear_scheduled_support(arg0: &mut CollectionMaintainer, arg1: &CollectionAdminCap) {
        ...
        while (v1 < 0x2::linked_table::length<address, vector<0x2::object::ID>>(v0)) {
            if (0x2::linked_table::length<address, vector<0x2::object::ID>>(v0) == 0) {
                break
            };
            let (_, _) = 0x2::linked_table::pop_back<address, vector<0x2::object::ID>>(v0);
            v1 = v1 + 1;
        };
    }
    ...
    public entry fun admin_remove_support(arg0: address, arg1: 0x2::object::ID, arg2: &mut CollectionMaintainer, arg3: &CollectionAdminCap, arg4: &mut 0x2::tx_context::TxContext) {
        assert_maintainer_version(arg2);
        if (0x2::table::contains<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntry>(&arg2.entries, arg1)) {
            let v0 = 0x2::table::borrow_mut<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntry>(&mut arg2.entries, arg1);
            let v1 = 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::entry_total_support(v0);
            let v2 = 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::entry_overall_support_index(v0);
            if (0x2::table::contains<address, 0x2::balance::Balance<0x2::sui::SUI>>(&arg2.accounts, arg0)) {
                0x2::balance::join<0x2::sui::SUI>(0x2::table::borrow_mut<address, 0x2::balance::Balance<0x2::sui::SUI>>(&mut arg2.accounts, arg0), 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::remove_supporter(arg0, v0));
            } else {
                0x2::table::add<address, 0x2::balance::Balance<0x2::sui::SUI>>(&mut arg2.accounts, arg0, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::remove_supporter(arg0, v0));
            };
            let v3 = &mut arg2.entries;
            let v4 = &mut arg2.ordered_support_levels;
            move_entry_by_support(arg1, v1, v2, v2, v3, v4, arg4);
        };
        if (0x2::table::contains<address, 0x2::linked_table::LinkedTable<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>>(&arg2.supports, arg0)) {
            let v5 = 0x2::table::borrow_mut<address, 0x2::linked_table::LinkedTable<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>>(&mut arg2.supports, arg0);
            if (0x2::linked_table::contains<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>(v5, arg1)) {
                0x2::linked_table::remove<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>(v5, arg1);
            };
        };
    }

    public entry fun admin_schedule_remove_support(arg0: address, arg1: 0x2::object::ID, arg2: &mut CollectionMaintainer) {
        assert_maintainer_version(arg2);
    }

    public entry fun admin_schedule_remove_support_2(arg0: address, arg1: 0x2::object::ID, arg2: &mut CollectionMaintainer, arg3: &CollectionAdminCap) {
        assert_maintainer_version(arg2);
        assert!(0x2::table::contains<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntry>(&arg2.entries, arg1), 3);
        assert!(0x2::linked_table::contains<address, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporter>(0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::supporters(0x2::table::borrow<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntry>(&mut arg2.entries, arg1)), arg0), 3);
        let v0 = &mut arg2.scheduled_remove_supporters;
        if (0x2::linked_table::contains<address, vector<0x2::object::ID>>(v0, arg0)) {
            let v1 = 0x2::linked_table::borrow_mut<address, vector<0x2::object::ID>>(v0, arg0);
            assert!(!0x1::vector::contains<0x2::object::ID>(v1, &arg1), 7);
            ...
            0x2::linked_table::push_back<address, vector<0x2::object::ID>>(v0, arg0, v2);
        };
        0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_events::emit_collection_support_scheduled_for_removal(arg1, arg0);
    }
    ...
    public entry fun complete_election(arg0: &mut CollectionMaintainer, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::clock::Clock, arg3: &CollectionAdminCap, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v25 = 0;
        let v26 = 0;
        let v27 = 0x2::coin::zero<0x2::sui::SUI>(arg4);
        while (0x2::linked_table::length<address, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporter>(&v13) > 0) {
            let (_, v29) = 0x2::linked_table::pop_front<address, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporter>(&mut v13);
            let (_, v31, v32, _, _) = 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::destructure_supporter(v29);
            let v35 = v32;
            if (v31 != v4) {
                0x2::coin::join<0x2::sui::SUI>(&mut v27, 0x2::coin::from_balance<0x2::sui::SUI>(v35, arg4));
                let v36 = arg0.election_index;
                mint_official_nft(v36, v14, v31, 0x2::balance::value<0x2::sui::SUI>(&v35), v2, v3, v4, v6, v17, v24 + 1, arg2, arg0, arg4);
            } else {
                v25 = 0x2::balance::value<0x2::sui::SUI>(&v35);
                let v37 = 0x2::coin::from_balance<0x2::sui::SUI>(v35, arg4);
                v26 = v26 + 0x2::coin::value<0x2::sui::SUI>(&v37);
                0x2::coin::put<0x2::sui::SUI>(&mut arg0.balance, v37);
            };
            v24 = v24 + 1;
        };
        ...
        let v38 = arg0.election_index;
        mint_official_nft(v38, v14, v4, v25, v2, v3, v4, v6, v17, 0, arg2, arg0, arg4);
        let v39 = 0x2::coin::value<0x2::sui::SUI>(&v27);
        let v40 = 0x1::vector::empty<0x2::coin::Coin<0x2::sui::SUI>>();
        0x1::vector::push_back<0x2::coin::Coin<0x2::sui::SUI>>(&mut v40, v27);
        let (v41, v42) = merge_and_split(v40, 1, v39 * 50 / 100, arg4);
        let (v43, v44) = 0x2::kiosk::purchase_with_cap<0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_nft_type::CollectionNft>(arg1, v11, v41);
        let (_, _, _) = 0x2::transfer_policy::confirm_request<0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_nft_type::CollectionNft>(&arg0.nft_transfer_policy, v44);
        0x2::coin::put<0x2::sui::SUI>(&mut arg0.balance, v42);
        0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_events::emit_collection_election_ended(v14, v2, v3, v4, v26 + v39, v16, arg0.election_index, v12);
        0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_nft_type::burn(v43);
    }
    ...
    fun mint_official_nft(arg0: u64, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: 0x2::url::Url, arg5: 0x1::string::String, arg6: address, arg7: u64, arg8: vector<0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_official_nft::CollectionOfficialSupporter>, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut CollectionMaintainer, arg12: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_official_nft::mint(arg1, arg0, arg4, arg5, arg6, arg2, arg3, arg7, arg8, arg9, arg10, arg12);
        ...
        0x2::linked_table::push_back<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_official_nft::CollectionOfficialNftRecord>(&mut arg11.official_nfts, v1, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_official_nft::create_nft_record(v1));
        if (0x2::table::contains<address, vector<0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_official_nft::CollectionOfficialNft>>(&arg11.pending_official_nfts, arg2)) {
            0x1::vector::push_back<0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_official_nft::CollectionOfficialNft>(0x2::table::borrow_mut<address, vector<0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_official_nft::CollectionOfficialNft>>(&mut arg11.pending_official_nfts, arg2), v0);
        } else {
            ...
            0x2::table::add<address, vector<0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_official_nft::CollectionOfficialNft>>(&mut arg11.pending_official_nfts, arg2, v2);
        };
    }
    ...
    fun move_entry_by_support(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::table::Table<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntry>, arg5: &mut 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::critbit::CritbitTree<0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::critbit::CritbitTree<0x2::object::ID>>, arg6: &mut 0x2::tx_context::TxContext) {
        if (0x2::table::contains<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntry>(arg4, arg0)) {
    ...
    public(friend) fun remove_entry(arg0: &mut CollectionMaintainer, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_nft_type::CollectionNft {
        ...
        while (0x2::linked_table::length<address, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporter>(&v4) > 0) {
            ...
            if (0x2::table::contains<address, 0x2::linked_table::LinkedTable<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>>(&arg0.supports, v11)) {
                let v19 = 0x2::table::borrow_mut<address, 0x2::linked_table::LinkedTable<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>>(&mut arg0.supports, v11);
                if (0x2::linked_table::contains<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>(v19, arg2)) {
                    0x2::linked_table::remove<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>(v19, arg2);
                };
            };
        ...
        let v20 = &mut arg0.ordered_support_levels;
        let v21 = 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::critbit::borrow_mut_leaf_by_key<0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::critbit::CritbitTree<0x2::object::ID>>(v20, v1);
        0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::critbit::remove_leaf_by_key<0x2::object::ID>(v21, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::entry_overall_support_index(&v0));
        if (0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::critbit::is_empty<0x2::object::ID>(v21)) {
            0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::critbit::destroy_empty<0x2::object::ID>(0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::critbit::remove_leaf_by_key<0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::critbit::CritbitTree<0x2::object::ID>>(v20, v1));
        };
    ...
    public fun remove_multiple_scheduled_supports(arg0: &mut CollectionMaintainer, arg1: &CollectionAdminCap, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        assert_maintainer_version(arg0);
        let v0 = &mut arg0.scheduled_remove_supporters;
        let v1 = 0x2::linked_table::length<address, vector<0x2::object::ID>>(v0);
        let v2 = v1;
        let v3 = 10;
        let v4 = v3;
        if (v3 > v1) {
        ...
        while (v5 < v4) {
            ...
            let (v6, v7) = 0x2::linked_table::pop_back<address, vector<0x2::object::ID>>(v0);
            let v8 = v7;
            while (0x1::vector::length<0x2::object::ID>(&v8) > 0) {
                let v9 = 0x1::vector::pop_back<0x2::object::ID>(&mut v8);
                if (0x2::table::contains<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntry>(&arg0.entries, v9)) {
                    let v10 = 0x2::table::borrow_mut<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntry>(&mut arg0.entries, v9);
                    let v11 = 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::entry_total_support(v10);
                    let v12 = 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::entry_overall_support_index(v10);
                    if (0x2::table::contains<address, 0x2::balance::Balance<0x2::sui::SUI>>(&arg0.accounts, v6)) {
                        0x2::balance::join<0x2::sui::SUI>(0x2::table::borrow_mut<address, 0x2::balance::Balance<0x2::sui::SUI>>(&mut arg0.accounts, v6), 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::remove_supporter(v6, v10));
                    } else {
                        0x2::table::add<address, 0x2::balance::Balance<0x2::sui::SUI>>(&mut arg0.accounts, v6, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::remove_supporter(v6, v10));
                    };
                    let v13 = &mut arg0.entries;
                    let v14 = &mut arg0.ordered_support_levels;
                    move_entry_by_support(v9, v11, v12, v12, v13, v14, arg2);
                };
                if (0x2::table::contains<address, 0x2::linked_table::LinkedTable<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>>(&arg0.supports, v6)) {
                    let v15 = 0x2::table::borrow_mut<address, 0x2::linked_table::LinkedTable<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>>(&mut arg0.supports, v6);
                    if (0x2::linked_table::contains<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>(v15, v9)) {
                        0x2::linked_table::remove<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>(v15, v9);
                    };
                };
                v2 = v2 - 1;
            };
    ...
    public entry fun remove_scheduled_support(arg0: &mut CollectionMaintainer, arg1: &CollectionAdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert_maintainer_version(arg0);
        let v0 = scheduled_remove_support_2(arg0);
        let v1 = 0;
        while (v1 < 0x1::vector::length<ScheduledRemoval>(&v0)) {
            let ScheduledRemoval {
                supporter : v2,
                nft_id    : v3,
            } = 0x1::vector::pop_back<ScheduledRemoval>(&mut v0);
            admin_remove_support(v2, v3, arg0, arg1, arg2);
            v1 = v1 + 1;
        };
        0x1::vector::destroy_empty<ScheduledRemoval>(v0);
        admin_clear_scheduled_support(arg0, arg1);
    }
    ...
    public fun scheduled_remove_support(arg0: &mut CollectionMaintainer) : vector<0x2::object::ID> {
        0x1::vector::empty<0x2::object::ID>()
    }

    public fun scheduled_remove_support_2(arg0: &mut CollectionMaintainer) : vector<ScheduledRemoval> {
        let v0 = &arg0.scheduled_remove_supporters;
        let v1 = 0x1::vector::empty<ScheduledRemoval>();
        let v2 = 0x2::linked_table::front<address, vector<0x2::object::ID>>(v0);
        while (0x1::option::is_some<address>(v2)) {
            let v3 = *0x1::option::borrow<address>(v2);
            let v4 = 0x2::linked_table::borrow<address, vector<0x2::object::ID>>(v0, v3);
            let v5 = 0;
            while (v5 < 0x1::vector::length<0x2::object::ID>(v4)) {
                let v6 = ScheduledRemoval{
                    supporter : v3,
                    nft_id    : *0x1::vector::borrow<0x2::object::ID>(v4, v5),
                };
                0x1::vector::push_back<ScheduledRemoval>(&mut v1, v6);
                v5 = v5 + 1;
            };
            v2 = 0x2::linked_table::next<address, vector<0x2::object::ID>>(v0, v3);
        };
        v1
    }
