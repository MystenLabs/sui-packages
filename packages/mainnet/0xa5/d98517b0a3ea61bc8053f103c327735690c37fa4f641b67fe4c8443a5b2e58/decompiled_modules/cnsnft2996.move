module 0xa5d98517b0a3ea61bc8053f103c327735690c37fa4f641b67fe4c8443a5b2e58::cnsnft2996 {
    struct CNSNFT2996 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2996, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2996>(arg0, arg1);
