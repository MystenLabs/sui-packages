module 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::bluefin_helper {
    ...
    public fun calc_open_parameters_inner(arg0: 0x2::object::ID, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg2: u128, arg3: u32, arg4: u128, arg5: u128, arg6: u8, arg7: u8, arg8: u128, arg9: bool) : OpenParameters {
        ...
        let v17 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::mul(&v8, &v6);
        let v18 = arg4 > 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::to_u128(&v17);
        let v19 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::zero();
        let v20 = if (v18) {
            let v21 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::mul(&v9, &v7);
            arg5 < 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::to_u128(&v21)
        } else {
            false
        };
        if (v20) {
            let v22 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::from_u128(arg5);
            let v23 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::div(&v22, &v7);
            let v24 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::diff(&v9, &v23);
            v19 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::div(&v24, &v2);
        } else {
            let v25 = if (!v18) {
                let v26 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::mul(&v8, &v6);
                arg4 < 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::to_u128(&v26)
            } else {
                false
            };
            if (v25) {
                let v27 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::from_u128(arg4);
                let v28 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::div(&v27, &v6);
                let v29 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::diff(&v8, &v28);
                v19 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::mul(&v29, &v2);
            };
        };
        let v30 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::zero();
        let v31 = if (0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::eq(&v19, &v30)) {
            0
        } else if (v18) {
            let v32 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::mul(&v19, &v6);
            0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::to_u128(&v32)
        } else {
            let v33 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::mul(&v19, &v7);
            0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::to_u128(&v33)
        };
        let v34 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::mul(&v8, &v6);
        let v35 = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::mul(&v9, &v7);
        OpenParameters{
            pool_id           : arg0,
            lower_tick        : v0,
            upper_tick        : v1,
            ...
            a2b               : v18,
            swap_amount       : v31,
            a_position_amount : 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::to_u128(&v34),
            b_position_amount : 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::to_u128(&v35),
        }
    }
    ...
    public fun close_position_and_try_reopen<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T1>, arg6: u8, arg7: u8, arg8: u128, arg9: bool, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (v15.swap_amount == 0 && (v15.a2b && v13 > v15.a_position_amount + v15.swap_amount || !v15.a2b && v14 > v15.b_position_amount + v15.swap_amount)) {
            let v16 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg1, arg2, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(v15.lower_tick), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(v15.upper_tick), arg10);
            let (v17, _, _) = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::get_liquidity_by_amount(v15.lower_tick, v15.upper_tick, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg2), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg2), (arg8 as u64), arg9);
            let (_, _, v22, v23) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity<T0, T1>(arg0, arg1, arg2, &mut v16, v11, v12, v17);
            0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::transfer_balance<T0>(v22, 0x2::tx_context::sender(arg10), arg10);
            0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::transfer_balance<T1>(v23, 0x2::tx_context::sender(arg10), arg10);
            0x2::transfer::public_transfer<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(v16, 0x2::tx_context::sender(arg10));
        } else {
