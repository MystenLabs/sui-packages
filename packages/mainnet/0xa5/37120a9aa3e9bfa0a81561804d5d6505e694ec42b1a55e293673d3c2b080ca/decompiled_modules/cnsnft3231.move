module 0xa537120a9aa3e9bfa0a81561804d5d6505e694ec42b1a55e293673d3c2b080ca::cnsnft3231 {
    struct CNSNFT3231 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3231, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3231>(arg0, arg1);
