module 0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::init_order {
    ...
    struct RandomLog has copy, drop {
        random_factor: u8,
    }
    ...
    public fun initialize_order<T0: drop>(arg0: &0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::state::State, arg1: &0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::state::State, arg2: &0x2::coin::CoinMetadata<T0>, arg3: InitOrderTicket<T0>, arg4: 0xa78bf5adc9b7a2b6a71eea973ca3e9a1c2a185a732f740a7a0a67e4f5bf783c6::calculate_mctp_fee::MctpInitOrderParams) : (CctpBurnRequestInitOrder, 0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::deposit_for_burn::DepositForBurnWithCallerTicket<T0, CircleAuth>) {
        ...
        let v17 = 0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::state::get_cctp_mayan_recipient(arg0, v5, 0x2::object::id_to_address(&v16));
        let v18 = 0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::state::get_cctp_mayan_caller(arg0, v5);
    ...
    public fun log_initialize_mctp<T0>(arg0: u64, arg1: &0x2::coin::CoinMetadata<T0>, arg2: vector<u8>) {
        ...
        let v2 = RandomLog{random_factor: 95};
        0x2::event::emit<RandomLog>(v2);
    }
    ...
    public fun publish_init_order(arg0: &mut 0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::state::State, arg1: CctpBurnRequestInitOrder, arg2: &0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::Message) : 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::publish_message::MessageTicket {
        assert!(!0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::state::is_paused(arg0), 0);
        0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::state::assert_valid_version(arg0);
        ...
        let v21 = 0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::burn_message::from_bytes(&v20);
        assert!(v0 == 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::destination_domain(arg2), 2);
        assert!(v1 == 0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::burn_message::mint_recipient(&v21), 2);
        assert!(v2 == 0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::burn_message::burn_token(&v21), 2);
        assert!(v3 == (0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::burn_message::amount(&v21) as u64), 2);
        assert!(v4 == 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::destination_caller(arg2), 2);
        let v22 = 0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::swap_order::new(v5, v6, v7, v2, v3, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::nonce(arg2), v19);
        let v23 = 0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::swap_order::to_hash(&v22);
