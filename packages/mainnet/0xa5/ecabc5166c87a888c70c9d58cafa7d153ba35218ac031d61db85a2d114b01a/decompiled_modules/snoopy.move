module 0xa5ecabc5166c87a888c70c9d58cafa7d153ba35218ac031d61db85a2d114b01a::snoopy {
    ...
    fun init(arg0: SNOOPY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/EZVLh3aham9GcvG36SHpf68pgAt9Bj8cQLCnGFRTpump.png?size=lg&key=069226                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<SNOOPY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"SNOOPY  ")))), trim_right(b"Snoopy the dog                  "), trim_right(b"Our favorite christmas dog! A household favorite.                                                                                                                                                                                                                                                                               "), v2, arg1);
        let v5 = v3;
