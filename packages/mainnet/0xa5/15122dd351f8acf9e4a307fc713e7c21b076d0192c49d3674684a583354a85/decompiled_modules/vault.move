module 0xa515122dd351f8acf9e4a307fc713e7c21b076d0192c49d3674684a583354a85::vault {
    ...
    public(friend) fun assert_deposits_enabled<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: u64) {
        assert!(arg0.deposits_enabled && 0x2::balance::value<T2>(&arg0.seed_vt) > 0 && arg1 < arg0.deposit_limit, 0xa515122dd351f8acf9e4a307fc713e7c21b076d0192c49d3674684a583354a85::error::deposits_disabled());
    }

    public(friend) fun assert_vault_cap<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &VaultCap) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1, T2>>(arg0), 0xa515122dd351f8acf9e4a307fc713e7c21b076d0192c49d3674684a583354a85::error::invalid_vault_cap());
    }
