module 0xa536ee4488c7b4ce968d94925928b88df3d3fa0e01a134a285c1e00c830fd985::bluefin_clmm_worker {
    ...
    public fun collect_reward_all_reverse_two_others_midone<T0, T1, T2, T3, T4, T5>(arg0: &0x9ec6f17e19c5e64c8872779a635235497fd6c71f7b5c23b07f652b02a240c84a::global_storage::GlobalStorage, arg1: address, arg2: &mut WorkerInfo<T0, T1, T2>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T0>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T5>, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T5, T0>, arg7: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T4, T0>, arg8: bool, arg9: bool, arg10: bool, arg11: bool, arg12: bool, arg13: bool, arg14: u8, arg15: u8, arg16: u8, arg17: u64, arg18: &0x2::clock::Clock, arg19: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        if (arg10) {
            ...
            if (v13 > 0) {
                ...
                let v16 = v14;
                0x2::coin::destroy_zero<T3>(v15);
                if (0x2::coin::value<T5>(&v16) > 0) {
                    assert!(arg12, 0);
                    let (v17, v18) = 0x87a5e0ad2f534245971542090137a368879938c10beabb175d8eb602c5582477::bluefin_clmm_utils::swap_exact_safe_reverse<T0, T5>(arg0, arg1, arg2.coin_base_decimals, arg16, arg3, arg6, 0x2::coin::zero<T0>(arg19), v16, false, true, v13, arg17, arg18, arg19);
                    0x2::coin::destroy_zero<T5>(v18);
        ...
        if (arg11) {
            let v21 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T1, T0, T4>(arg18, arg3, arg4, 0x1::option::borrow_mut<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg2.position_nft));
            let v22 = 0x2::balance::value<T4>(&v21);
            if (v22 > 0) {
                assert!(arg13, 0);
                let (v23, v24) = 0x87a5e0ad2f534245971542090137a368879938c10beabb175d8eb602c5582477::bluefin_clmm_utils::swap_exact_safe_reverse<T0, T4>(arg0, arg1, arg2.coin_base_decimals, arg15, arg3, arg7, 0x2::coin::zero<T0>(arg19), 0x2::coin::from_balance<T4>(v21, arg19), false, true, v22, arg17, arg18, arg19);
                0x2::coin::destroy_zero<T4>(v24);
                let v25 = 0x2::coin::into_balance<T0>(v23);
                let v26 = 0x9ec6f17e19c5e64c8872779a635235497fd6c71f7b5c23b07f652b02a240c84a::mole_math::mul_div(0x2::balance::value<T0>(&v25), arg2.reinvest_bounty_bps, 10000);
                if (0x2::balance::value<T0>(&v25) >= v26) {
                    0x2::balance::join<T0>(&mut arg2.tiny_coin_base_bounty, 0x2::balance::split<T0>(&mut v25, v26));
                };
                0x2::balance::join<T0>(&mut arg2.tiny_coin_base, v25);
            } else {
                0x2::coin::destroy_zero<T4>(0x2::coin::from_balance<T4>(v21, arg19));
            };
        };
        0x2::balance::join<T0>(&mut arg2.tiny_coin_base, v4);
        0x2::balance::join<T1>(&mut arg2.tiny_coin_farming, v5);
    ...
    fun strategy_execute_safe<T0, T1, T2>(arg0: &0x9ec6f17e19c5e64c8872779a635235497fd6c71f7b5c23b07f652b02a240c84a::global_storage::GlobalStorage, arg1: address, arg2: &mut WorkerInfo<T0, T1, T2>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: 0x2::coin::Coin<T0>, arg6: 0x2::coin::Coin<T1>, arg7: u128, arg8: u64, arg9: u8, arg10: vector<u8>, arg11: u64, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        if (arg9 == 1) {
            return 0xa536ee4488c7b4ce968d94925928b88df3d3fa0e01a134a285c1e00c830fd985::bluefin_clmm_strategy_add_base_coin_only::execute_safe<T0, T1>(arg0, arg1, arg2.coin_base_decimals, arg2.coin_farming_decimals, arg3, arg4, arg5, arg6, arg7, v0, arg8, arg10, &mut arg2.tiny_coin_base, &mut arg2.tiny_coin_farming, arg11, arg12, arg13)
        };
        if (arg9 == 2) {
            return 0xa536ee4488c7b4ce968d94925928b88df3d3fa0e01a134a285c1e00c830fd985::bluefin_clmm_strategy_add_two_sides_optimal::execute_safe<T0, T1>(arg0, arg1, arg2.coin_base_decimals, arg2.coin_farming_decimals, arg3, arg4, arg5, arg6, arg7, v0, arg8, arg10, &mut arg2.tiny_coin_base, &mut arg2.tiny_coin_farming, arg11, arg12, arg13)
        };
        if (arg9 == 3) {
            return 0xa536ee4488c7b4ce968d94925928b88df3d3fa0e01a134a285c1e00c830fd985::bluefin_clmm_strategy_liquidate::execute_safe<T0, T1>(arg0, arg1, arg2.coin_base_decimals, arg2.coin_farming_decimals, arg3, arg4, arg5, arg6, arg7, v0, arg8, arg10, &mut arg2.tiny_coin_base, &mut arg2.tiny_coin_farming, arg11, arg12, arg13)
        };
        if (arg9 == 4) {
        ...
        assert!(arg9 == 6, 5);
        0xa536ee4488c7b4ce968d94925928b88df3d3fa0e01a134a285c1e00c830fd985::bluefin_clmm_strategy_partial_close_minimize_trading::execute_safe<T0, T1>(arg0, arg1, arg2.coin_base_decimals, arg2.coin_farming_decimals, arg3, arg4, arg5, arg6, arg7, v0, arg8, arg10, &mut arg2.tiny_coin_base, &mut arg2.tiny_coin_farming, arg11, arg12, arg13)
    }
