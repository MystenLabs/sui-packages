module 0xa58720753002c555b873aada75365ee8042bc7ce67b13e4478636c68ceece0fc::nftLib {
        ...
        while (v0 <= 0x2::vec_map::size<u64, Achievement>(&arg0.achievements)) {
            ...
            while (v2 < 0x1::vector::length<u8>(&arg4)) {
                ...
                if (v3 == v1.achievementType) {
                    if (v1.communityId != arg2 && v1.communityId != 0xa58720753002c555b873aada75365ee8042bc7ce67b13e4478636c68ceece0fc::commonLib::getZeroId()) {
                        continue
                    };
