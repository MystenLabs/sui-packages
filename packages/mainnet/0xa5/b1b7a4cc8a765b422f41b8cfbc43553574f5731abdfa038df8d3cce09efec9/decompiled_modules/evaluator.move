module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::evaluator {
    ...
    public(friend) fun set_min_qty(arg0: 0x2::object::ID, arg1: &mut TradeChecks, arg2: u128) {
        assert!(arg2 < arg1.max_qty_limit && arg2 < arg1.max_qty_market, 17);
        assert!(arg2 > 0, 18);
        arg1.min_qty = arg2;
    ...
    public(friend) fun set_mtb_short(arg0: 0x2::object::ID, arg1: &mut TradeChecks, arg2: u128) {
        assert!(arg2 > 0, 13);
        assert!(arg2 < 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_uint(), 14);
        arg1.mtb_short = arg2;
    ...
    public(friend) fun verify_market_take_bound_checks(arg0: TradeChecks, arg1: u128, arg2: u128, arg3: bool) {
        if (arg3) {
            assert!(arg1 <= arg2 + 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul(arg2, arg0.mtb_long), 23);
        } else {
            assert!(arg1 >= arg2 - 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul(arg2, arg0.mtb_short), 24);
        };
    }

    public(friend) fun verify_min_max_price(arg0: TradeChecks, arg1: u128) {
        assert!(arg1 >= arg0.min_price, 3);
        assert!(arg1 <= arg0.max_price, 4);
    }
    ...
    public(friend) fun verify_oi_open_for_account(arg0: TradeChecks, arg1: u128, arg2: u128, arg3: u64, arg4: bool) {
        ...
        assert!((v2 as u64) < 0x1::vector::length<u128>(&arg0.max_allowed_oi_open), arg3 + 40);
        let v3 = *0x1::vector::borrow<u128>(&arg0.max_allowed_oi_open, (v2 as u64));
        let v4 = v3;
        if (arg4) {
            v4 = v3 * 5;
        };
        assert!(arg2 <= v4, arg3 + 25);
    }

    fun verify_pre_init_checks(arg0: TradeChecks) {
        assert!(arg0.min_price > 0, 1);
        assert!(arg0.min_price < arg0.max_price, 2);
        assert!(arg0.step_size > 0, 10);
        assert!(arg0.tick_size > 0, 11);
        assert!(arg0.mtb_long > 0, 12);
        assert!(arg0.mtb_short > 0, 13);
        assert!(arg0.mtb_short < 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_uint(), 14);
        assert!(arg0.min_qty > 0, 18);
        assert!(arg0.min_qty < arg0.max_qty_limit && arg0.min_qty < arg0.max_qty_market, 17);
    }
    ...
    public(friend) fun verify_qty_checks(arg0: TradeChecks, arg1: u128, arg2: bool) {
        assert!(arg1 >= arg0.min_qty, 19);
        assert!(arg1 <= arg0.max_qty_limit, 20);
        if (arg2) {
            assert!(arg1 <= arg0.max_qty_market, 21);
        };
    ...
    public(friend) fun verify_step_size(arg0: TradeChecks, arg1: u128) {
        assert!(arg1 % arg0.step_size == 0, 22);
    }
