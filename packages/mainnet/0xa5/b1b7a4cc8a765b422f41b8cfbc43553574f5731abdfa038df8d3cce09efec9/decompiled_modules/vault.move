module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::vault {
    ...
    struct VaultNameUpdateEvent has copy, drop {
        vault_id: 0x2::object::ID,
        name: 0x1::string::String,
    }
    ...
    public fun set_vault_name<T0>(arg0: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::ProtocolConfig, arg1: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::roles::ExchangeManagerCap, arg2: &mut VaultConfig, arg3: &mut Vault<T0>, arg4: 0x1::string::String) {
        0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::check_basic(arg0);
        0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::roles::check_manager_validity(arg0, arg1);
        assert!(!0x2::table::contains<0x1::string::String, 0x2::object::ID>(&arg2.registry.name_to_id, arg4), 2023);
        let v0 = 0x2::object::uid_to_inner(&arg3.id);
        0x2::table::remove<0x1::string::String, 0x2::object::ID>(&mut arg2.registry.name_to_id, 0x2::table::remove<0x2::object::ID, 0x1::string::String>(&mut arg2.registry.id_to_name, v0));
        0x2::table::add<0x1::string::String, 0x2::object::ID>(&mut arg2.registry.name_to_id, arg4, v0);
        0x2::table::add<0x2::object::ID, 0x1::string::String>(&mut arg2.registry.id_to_name, v0, arg4);
        arg3.name = arg4;
        let v1 = VaultNameUpdateEvent{
            vault_id : v0,
            name     : arg4,
        };
        0x2::event::emit<VaultNameUpdateEvent>(v1);
    }
