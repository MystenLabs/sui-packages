module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position {
    ...
    public(friend) fun compute_margin_ratio(arg0: &Position, arg1: u128) : 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::S128 {
        if (arg0.size == 0) {
            return 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::one()
        };
        let v0 = 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul(arg1, arg0.size);
        if (v0 == 0) {
            return 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::zero()
        };
        if (arg0.is_long) {
            0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::sub(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::one(), 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::div_u128(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::from_subtraction(arg0.oi_open, arg0.margin), v0))
        } else {
            0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::from_subtraction(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_div(arg0.oi_open + arg0.margin, v0), 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_uint())
        }
    }
    ...
    public(friend) fun remove_empty_positions(arg0: &mut 0x2::table::Table<address, Position>, arg1: vector<address>, arg2: u64) {
        assert!(0x1::vector::length<address>(&arg1) <= 1000, 99999);
        let v0 = 0;
    ...
    public(friend) fun verify_collat_checks(arg0: &Position, arg1: &Position, arg2: u128, arg3: u128, arg4: u128, arg5: u8, arg6: u64) {
        ...
        assert!(arg1.is_long == arg0.is_long && arg0.size > 0, 400 + arg6);
        assert!(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::gte(v0, compute_margin_ratio(arg0, arg4)), 402 + arg6);
        assert!(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::gt_u128(v0, arg3) || arg0.size >= arg1.size && arg0.is_long == arg1.is_long, 404 + arg6);
