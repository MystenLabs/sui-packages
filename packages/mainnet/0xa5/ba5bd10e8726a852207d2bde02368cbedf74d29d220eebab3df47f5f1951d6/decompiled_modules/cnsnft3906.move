module 0xa5ba5bd10e8726a852207d2bde02368cbedf74d29d220eebab3df47f5f1951d6::cnsnft3906 {
    struct CNSNFT3906 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3906, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3906>(arg0, arg1);
