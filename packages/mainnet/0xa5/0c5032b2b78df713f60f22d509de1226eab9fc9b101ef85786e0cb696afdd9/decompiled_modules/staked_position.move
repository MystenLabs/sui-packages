module 0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::staked_position {
    ...
    public fun is_unlocked<T0>(arg0: &StakedPosition<T0>, arg1: &mut 0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::afterburner_vault::AfterburnerVault<T0>, arg2: &0x2::clock::Clock) : bool {
        if (lock_end_timestamp_ms<T0>(arg0) <= 0x2::clock::timestamp_ms(arg2)) {
            true
        } else if (0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::afterburner_vault::emission_end_timestamp_ms<T0>(arg1) <= 0x2::clock::timestamp_ms(arg2)) {
            true
        } else {
            0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::afterburner_vault::is_vault_unlocked<T0>(arg1)
        }
    }
    ...
    public fun stake<T0>(arg0: &mut 0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::afterburner_vault::AfterburnerVault<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : StakedPosition<T0> {
        ...
        if (0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::afterburner_vault::total_staked_amount<T0>(arg0) == 0) {
            0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::afterburner_vault::adjust_emission_start_timestamps_ms<T0>(arg0, arg1);
        };
