module 0xa5072a9ca67487c507b036c9b67a1be45fd70d363e1ebae3a17840e2502dce34::multico {
    ...
    fun init(arg0: MULTICO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<MULTICO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MULTICO ")))), trim_right(b"MULTICO                         "), trim_right(b"Multio is a cute robotic mascot designed to tell the world about the Multi AI platform                                                                                                                                                                                                                                          "), v2, arg1);
        let v5 = v3;
