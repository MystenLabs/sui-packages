module 0xa584604180246368403690b710b92986fc1d7c108361321786b12be3ed2717c5::upgrades {
    ...
    public fun commit_upgrade<T0>(arg0: &mut UpgradeCap, arg1: &mut 0xa584604180246368403690b710b92986fc1d7c108361321786b12be3ed2717c5::state::State<T0>, arg2: 0x2::package::UpgradeReceipt) {
        0xa584604180246368403690b710b92986fc1d7c108361321786b12be3ed2717c5::state::set_version<T0>(arg1, 0);
        0x2::package::commit_upgrade(&mut arg0.cap, arg2);
    }

    public fun check_version<T0>(arg0: VersionGated, arg1: &0xa584604180246368403690b710b92986fc1d7c108361321786b12be3ed2717c5::state::State<T0>) {
        let VersionGated {  } = arg0;
        if (0xa584604180246368403690b710b92986fc1d7c108361321786b12be3ed2717c5::state::get_version<T0>(arg1) != 0) {
