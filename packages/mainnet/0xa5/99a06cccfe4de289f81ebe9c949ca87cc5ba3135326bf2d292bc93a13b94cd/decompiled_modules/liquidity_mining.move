module 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::liquidity_mining {
    ...
    struct PoolReward has store, key {
        ...
        end_time_ms: u64,
        total_rewards: u64,
        allocated_rewards: 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::Decimal,
        cumulative_rewards_per_share: 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::Decimal,
    ...
    struct UserReward has store {
        ...
        earned_rewards: 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::Decimal,
        cumulative_rewards_per_share: 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::Decimal,
    }
    ...
    public(friend) fun add_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = PoolReward{
            ...
            allocated_rewards            : 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::from(0),
            cumulative_rewards_per_share : 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::from(0),
    ...
    public(friend) fun cancel_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: u64, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        0x2::balance::split<T0>(0x2::bag::borrow_mut<RewardBalance<T0>, 0x2::balance::Balance<T0>>(&mut v0.additional_fields, v1), 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::floor(0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::sub(0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::from(v0.total_rewards), v0.allocated_rewards)))
    }
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut PoolRewardManager, arg1: &mut UserRewardManager, arg2: &0x2::clock::Clock, arg3: u64) : 0x2::balance::Balance<T0> {
        ...
        let v3 = 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::floor(v2.earned_rewards);
        v2.earned_rewards = 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::sub(v2.earned_rewards, 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::from(v3));
    ...
    fun update_pool_reward_manager(arg0: &mut PoolRewardManager, arg1: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<0x1::option::Option<PoolReward>>(&arg0.pool_rewards)) {
            ...
            let v4 = 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::div(0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::mul(0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::from(v3.total_rewards), 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::from(0x1::u64::min(v0, v3.end_time_ms) - 0x1::u64::max(v3.start_time_ms, arg0.last_update_time_ms))), 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::from(v3.end_time_ms - v3.start_time_ms));
            v3.allocated_rewards = 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::add(v3.allocated_rewards, v4);
            v3.cumulative_rewards_per_share = 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::add(v3.cumulative_rewards_per_share, 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::div(v4, 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::from(arg0.total_shares)));
            v1 = v1 + 1;
        };
        arg0.last_update_time_ms = v0;
    }
            ...
            if (0x1::option::is_none<UserReward>(v4)) {
                if (arg1.last_update_time_ms <= v3.end_time_ms) {
                    let v5 = if (arg1.last_update_time_ms <= v3.start_time_ms) {
                        0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::mul(v3.cumulative_rewards_per_share, 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::from(arg1.share))
                    } else {
                        0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::from(0)
                    };
                    let v6 = UserReward{
                ...
                v7.earned_rewards = 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::add(v7.earned_rewards, 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::mul(0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::sub(v3.cumulative_rewards_per_share, v7.cumulative_rewards_per_share), 0xa599a06cccfe4de289f81ebe9c949ca87cc5ba3135326bf2d292bc93a13b94cd::decimal::from(arg1.share)));
