module 0xa58b402fdcd725e53581817dd69aa947feddc2afa0e3bedfdc48482a64680d45::cnsnft2718 {
    struct CNSNFT2718 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2718, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2718>(arg0, arg1);
