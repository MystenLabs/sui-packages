module 0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::bot {
    ...
    struct ArbitrageBot has key {
        ...
        min_trade_size: u64,
        max_trade_size: u64,
        total_profit_usdc: 0x2::balance::Balance<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>,
        total_profit_usdt: 0x2::balance::Balance<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>,
        trading_balance_usdc: 0x2::balance::Balance<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>,
        trading_balance_usdt: 0x2::balance::Balance<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>,
        active: bool,
    ...
    public entry fun deposit_usdc(arg0: &mut ArbitrageBot, arg1: 0x2::coin::Coin<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>(&arg1);
        assert!(v0 >= 1000000, 5);
        0x2::balance::join<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>(&mut arg0.trading_balance_usdc, 0x2::coin::into_balance<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>(arg1));
    ...
    public entry fun deposit_usdt(arg0: &mut ArbitrageBot, arg1: 0x2::coin::Coin<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>(&arg1);
        assert!(v0 >= 1000000, 5);
        0x2::balance::join<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>(&mut arg0.trading_balance_usdt, 0x2::coin::into_balance<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>(arg1));
        let v1 = FundsDeposited{
            amount    : v0,
            is_usdc   : false,
            timestamp : 0x2::tx_context::epoch(arg2),
    ...
    public fun get_total_profit_usdc(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>(&arg0.total_profit_usdc)
    }

    public fun get_total_profit_usdt(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>(&arg0.total_profit_usdt)
    }

    public fun get_trading_balance_usdc(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>(&arg0.trading_balance_usdc)
    }

    public fun get_trading_balance_usdt(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>(&arg0.trading_balance_usdt)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = ArbitrageBot{
            ...
            total_profit_usdc    : 0x2::balance::zero<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>(),
            total_profit_usdt    : 0x2::balance::zero<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>(),
            trading_balance_usdc : 0x2::balance::zero<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>(),
            trading_balance_usdt : 0x2::balance::zero<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>(),
            active               : true,
    ...
    public entry fun withdraw_profits(arg0: &mut ArbitrageBot, arg1: u64, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>>(0x2::coin::from_balance<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>(0x2::balance::split<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDC>(&mut arg0.total_profit_usdc, arg1), arg3), arg0.owner);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>>(0x2::coin::from_balance<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>(0x2::balance::split<0xa5f776fc68613b662319a13461deb71a42ac3871fa63a741d793ca9d4683102f::coins::USDT>(&mut arg0.total_profit_usdt, arg1), arg3), arg0.owner);
        };
    }
