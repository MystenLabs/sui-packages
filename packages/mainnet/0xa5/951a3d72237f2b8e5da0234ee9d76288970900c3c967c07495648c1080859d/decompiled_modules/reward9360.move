module 0xa5951a3d72237f2b8e5da0234ee9d76288970900c3c967c07495648c1080859d::reward9360 {
    struct REWARD9360 has drop {
        dummy_field: bool,
    }

    struct TICKET_9360 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9360(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9360>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9360>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9360, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9360>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9360>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9360>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9360>>(v5, 0x2::tx_context::sender(arg1));
    }
