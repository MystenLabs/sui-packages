module 0xa555262dca978996a8ee5ba012100c2bac3d8c43057d2f5487029261191de2da::cnsnft1768 {
    struct CNSNFT1768 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1768, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1768>(arg0, arg1);
