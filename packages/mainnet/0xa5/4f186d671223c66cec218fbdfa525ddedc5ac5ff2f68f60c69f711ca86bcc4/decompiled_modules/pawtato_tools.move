module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools {
    ...
    public fun get_durability_value(arg0: &TOOL) : u64 {
        ...
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&arg0.attributes, &v0)) {
            ...
            if (0x1::string::as_bytes(v2) == &v3) {
                ...
                0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::string_to_u64(v2)
            }
        } else {
    ...
    public fun get_runepen_resource_multiplier(arg0: &TOOL) : u64 {
        ...
        calculate_tier_based_multiplier(0x2::vec_map::get<0x1::string::String, 0x1::string::String>(v1, &v2), 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::string_to_u64(0x2::vec_map::get<0x1::string::String, 0x1::string::String>(v1, &v3)), v4)
    }
    ...
    public fun get_runepen_time_multiplier(arg0: &TOOL) : u64 {
        ...
        0x1::vector::push_back<u64>(v5, 8000);
        0x1::vector::push_back<u64>(v5, 7000);
        0x1::vector::push_back<u64>(v5, 6500);
        0x1::vector::push_back<u64>(v5, 5500);
        0x1::vector::push_back<u64>(v5, 5000);
        0x1::vector::push_back<u64>(v5, 4000);
        0x1::vector::push_back<u64>(v5, 3000);
        0x1::vector::push_back<u64>(v5, 2000);
        calculate_tier_based_multiplier(0x2::vec_map::get<0x1::string::String, 0x1::string::String>(v1, &v2), 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::string_to_u64(0x2::vec_map::get<0x1::string::String, 0x1::string::String>(v1, &v3)), v4)
    }
    ...
    public(friend) fun update_tool_quality(arg0: &mut TOOL, arg1: u64) {
        let v0 = 0x1::string::utf8(b"Quality");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&arg0.attributes, &v0)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut arg0.attributes, &v0) = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u64_to_string(arg1);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut arg0.attributes, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u64_to_string(arg1));
        };
    }
