module 0xa56164186ff51013957c7c886d50eccfea0f75161fc729c4977f2670c360c0b4::payroll {
    ...
    struct PayoutEscrow<T0: store> has store, key {
        id: 0x2::object::UID,
        run: 0x2::object::ID,
    ...
    public fun claim_payout<T0: store>(arg0: PayoutEscrow<T0>, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let PayoutEscrow {
            id                : v0,
            run               : v1,
    ...
    public entry fun claim_to_sender<T0: store>(arg0: PayoutEscrow<T0>, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun escrow_payout<T0: store>(arg0: &mut PayrollRun, arg1: &AdminCap, arg2: vector<u8>, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun issue_payslip(arg0: &PayrollRun, arg1: &AdminCap, arg2: address, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.employer == arg0.employer, 0);
        let v0 = Payslip{
            id           : 0x2::object::new(arg4),
            run          : 0x2::object::id<PayrollRun>(arg0),
    ...
    public entry fun register(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
