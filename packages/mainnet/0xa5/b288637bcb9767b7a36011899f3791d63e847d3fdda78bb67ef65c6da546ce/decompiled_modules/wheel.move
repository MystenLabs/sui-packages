module 0x72b0192f760dd62db6df8d40dc9867e84d9e95628b100c405dcf145c60244656::wheel {
    ...
    public fun claim_win<T0>(arg0: &mut Vault<T0>, arg1: &Round, arg2: &mut Bet, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.balance, v3, arg3), arg0.burn_address);
        };
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.balance, v2, arg3), arg0.treasury);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.balance, v6, arg3), 0x2::tx_context::sender(arg3));
        let v7 = WinClaimed{
    ...
    public fun place_bet<T0>(arg0: &mut Vault<T0>, arg1: &PauseFlag, arg2: &mut Round, arg3: 0x2::coin::Coin<T0>, arg4: u8, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0 * v2 / 10000;
        let v4 = v3 * 25 / 100;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg3, v4, arg6), arg0.burn_address);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg3, v3 - v4, arg6), arg0.treasury);
        ...
        arg2.total_bets = arg2.total_bets + v5;
        let v6 = Bet{
        ...
        0x2::transfer::transfer<Bet>(v6, 0x2::tx_context::sender(arg6));
    }
