module 0xa5a663efd0998eb55f755f2182c93098a9cd5aa69288768e3a99041ba4bc2f58::conditional_coin_utils {
    ...
    public fun build_conditional_symbol(arg0: &0x1f086f81dc593df550adbaa1b076f771dfa64f6e34df523fcb32d3e503fc90df::dao_config::ConditionalCoinConfig, arg1: u64, arg2: &0x1::string::String) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"");
        let v1 = 0x1f086f81dc593df550adbaa1b076f771dfa64f6e34df523fcb32d3e503fc90df::dao_config::coin_name_prefix(arg0);
        ...
        if (0x1f086f81dc593df550adbaa1b076f771dfa64f6e34df523fcb32d3e503fc90df::dao_config::use_outcome_index(arg0)) {
            0x1::string::append_utf8(&mut v0, u64_to_string(arg1));
    ...
    public fun build_conditional_symbol_ascii(arg0: &0x1f086f81dc593df550adbaa1b076f771dfa64f6e34df523fcb32d3e503fc90df::dao_config::ConditionalCoinConfig, arg1: u64, arg2: &0x1::ascii::String) : 0x1::ascii::String {
