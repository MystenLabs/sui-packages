module 0xa5249c28756b5d3e6002887b3c0653b7a2339d59e95de280650c27b54ca28dbe::melania {
    ...
    fun init(arg0: MELANIA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/JvTRSeeaj2NrVhZAWzU8m6qKnKwimMJZGSwFKn9pump.png?size=lg&key=056dd5                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<MELANIA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MELANIA   ")))), trim_right(b"OFFICIAL MELANIA                "), trim_right(b"First Lady Of the United States of America                                                                                                                                                                                                                                                                                      "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
