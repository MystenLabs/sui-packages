module 0xa51c812f1a078f0d2f70a90399084be45f686b95af4f36d783f030b5626aa2a2::oracle_ag {
    struct OracleAggregator has key {
        id: 0x2::object::UID,
        pyth_price_address_table: 0x2::table::Table<0x1::ascii::String, vector<u8>>,
        max_age: u64,
    }
    ...
    public fun new(arg0: &mut 0x2::tx_context::TxContext) : (OracleAggregator, OracleAggregatorCap) {
        let v0 = OracleAggregator{
            ...
            pyth_price_address_table : 0x2::table::new<0x1::ascii::String, vector<u8>>(arg0),
            max_age                  : 0xa51c812f1a078f0d2f70a90399084be45f686b95af4f36d783f030b5626aa2a2::consts::GET_PYTH_MAX_AGE(),
        };
    ...
    public fun get_price<T0>(arg0: &OracleAggregator, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : (u64, u64, u64) {
        ...
        (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v3), 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_negative(&v4), 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_timestamp(&v0))
    }
    ...
    public fun calc_usd_value<T0>(arg0: &OracleAggregator, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        ...
        0xa51c812f1a078f0d2f70a90399084be45f686b95af4f36d783f030b5626aa2a2::math::scale_from_float(0xa51c812f1a078f0d2f70a90399084be45f686b95af4f36d783f030b5626aa2a2::math::mul(0xa51c812f1a078f0d2f70a90399084be45f686b95af4f36d783f030b5626aa2a2::math::scale_to_float(arg2, v1), 0xa51c812f1a078f0d2f70a90399084be45f686b95af4f36d783f030b5626aa2a2::math::scale_to_float(v0, v1)), 0xa51c812f1a078f0d2f70a90399084be45f686b95af4f36d783f030b5626aa2a2::consts::GET_USDC_DECIMALS())
    }

    public fun get_pyth_address<T0>(arg0: &OracleAggregator) : vector<u8> {
        *0x2::table::borrow<0x1::ascii::String, vector<u8>>(&arg0.pyth_price_address_table, 0x1::type_name::into_string(0x1::type_name::get<T0>()))
    }
    ...
    public fun update_pyth_price_address<T0>(arg0: &mut OracleAggregator, arg1: &OracleAggregatorCap, arg2: vector<u8>) {
        assert_oracle_aggregator_cap(arg0, arg1);
        if (!0x2::table::contains<0x1::ascii::String, vector<u8>>(&arg0.pyth_price_address_table, 0x1::type_name::into_string(0x1::type_name::get<T0>()))) {
            0x2::table::add<0x1::ascii::String, vector<u8>>(&mut arg0.pyth_price_address_table, 0x1::type_name::into_string(0x1::type_name::get<T0>()), arg2);
        };
        *0x2::table::borrow_mut<0x1::ascii::String, vector<u8>>(&mut arg0.pyth_price_address_table, 0x1::type_name::into_string(0x1::type_name::get<T0>())) = arg2;
    }
