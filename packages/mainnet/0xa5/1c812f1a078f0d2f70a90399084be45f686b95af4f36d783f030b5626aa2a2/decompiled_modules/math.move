module 0xa51c812f1a078f0d2f70a90399084be45f686b95af4f36d783f030b5626aa2a2::math {
    ...
    fun quick_sort(arg0: vector<u128>) : vector<u128> {
        ...
        while (!0x1::vector::is_empty<u128>(&arg0)) {
            let v4 = 0x1::vector::pop_back<u128>(&mut arg0);
            if (v4 < v0) {
        ...
        let v5 = vector[];
        0x1::vector::append<u128>(&mut v5, quick_sort(v1));
        0x1::vector::append<u128>(&mut v5, v2);
        0x1::vector::append<u128>(&mut v5, quick_sort(v3));
        v5
    }
