module 0x2f73c04ded344fd4e2530ec8012a7cffdc17cbb049559f3196c030f58c3a0cdd::sui_incentive {
    ...
    struct InitSecondRateInfoEvent has copy, drop {
        second_rate_info_address: address,
    }
    ...
    public entry fun new_second_rate_info(arg0: &AdminCap, arg1: &mut Storage, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg1);
        let v0 = SecondRateInfo{
            id              : 0x2::object::new(arg2),
            second_rate_bps : 0,
        };
        0x2::transfer::share_object<SecondRateInfo>(v0);
        let v1 = InitSecondRateInfoEvent{second_rate_info_address: 0x2::object::uid_to_address(&v0.id)};
        0x2::event::emit<InitSecondRateInfoEvent>(v1);
    }
    ...
    public fun pending_sui<T0>(arg0: &mut Storage, arg1: address, arg2: bool, arg3: &0x2::clock::Clock) : u64 {
        ...
        if (v9 > v3.last_reward_time && v8 != 0) {
            let v10 = 0;
            if (v2.total_alloc_point > 0) {
                v10 = ((((v9 - v3.last_reward_time) as u128) * (v2.sui_per_second as u128) * (v3.alloc_point as u128) / (v2.total_alloc_point as u128)) as u64);
            };
            v7 = v6 + mul_to_u128(v10, 1000000000000) / (v8 as u128);
        };
    ...
    public entry fun set_per_second_rate(arg0: &AdminCap, arg1: &mut Storage, arg2: u64, arg3: bool, arg4: &mut SecondRateInfo, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg1);
        if (arg3) {
        ...
        assert!(arg4.second_rate_bps > 0, 21);
        v0.sui_per_second = 0x9ec6f17e19c5e64c8872779a635235497fd6c71f7b5c23b07f652b02a240c84a::mole_math::mul_div(arg2, arg4.second_rate_bps, 1000000);
    }
    ...
    public entry fun set_second_rate_info(arg0: &AdminCap, arg1: &mut Storage, arg2: &mut SecondRateInfo, arg3: u64) {
        checked_package_version(arg1);
        assert!(arg3 <= 1000000, 20);
        arg2.second_rate_bps = arg3;
    }
    ...
    public fun update_pool(arg0: &mut Storage, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (now_seconds(arg2) > v1.last_reward_time) {
            if (v1.staked_balance > 0) {
                let v2 = 0;
                if (v0.total_alloc_point > 0) {
                    v2 = mul_div((now_seconds(arg2) - v1.last_reward_time) * v0.sui_per_second, v1.alloc_point, v0.total_alloc_point);
                };
                v1.acc_sui_per_share = v1.acc_sui_per_share + mul_to_u128(v2, 1000000000000) / (v1.staked_balance as u128);
            };
