module 0x282df60372adda5334cf55fd102c749005b95b0bcec1a2ffd9b60f2ac49fdb7a::msui {
    ...
    struct RedemptionVault has key {
        ...
        total_msui_burned_base_units: u64,
        total_sui_paid_mist: u64,
        beneficiary: address,
    }
    ...
    struct MsuiBurnEvent has copy, drop {
        burner: address,
        burned_base_units: u64,
        remaining_supply_base_units: u64,
    }

    struct WindDownFinalizedEvent has copy, drop {
        admin: address,
        redemption_vault_id: 0x2::object::ID,
        supply_base_units: u64,
        redemption_reserve_mist: u64,
        treasury_released_mist: u64,
        rate_msui_per_sui: u64,
        activated_at_ms: u64,
        closes_at_ms: u64,
        beneficiary: address,
    ...
    struct RedemptionEvent has copy, drop {
        redeemer: address,
        msui_burned_base_units: u64,
        sui_paid_mist: u64,
        remaining_reserve_mist: u64,
    }

    struct RedemptionClosedEvent has copy, drop {
        caller: address,
        beneficiary: address,
        remaining_sui_mist: u64,
        total_msui_burned_base_units: u64,
        total_sui_paid_mist: u64,
    }
    ...
    public fun burn_msui(arg0: &mut ReserveState, arg1: 0x2::coin::Coin<MSUI>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<MSUI>(&arg1);
        assert!(v0 > 0, 12);
        0x2::coin::burn<MSUI>(&mut arg0.treasury_cap, arg1);
        let v1 = MsuiBurnEvent{
            burner                      : 0x2::tx_context::sender(arg2),
            burned_base_units           : v0,
            remaining_supply_base_units : 0x2::coin::total_supply<MSUI>(&arg0.treasury_cap),
        };
        0x2::event::emit<MsuiBurnEvent>(v1);
    }
    ...
    public fun close_redemption(arg0: &mut ReserveState, arg1: RedemptionVault, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.redeem_status == 1, 15);
        assert!(0x2::clock::timestamp_ms(arg2) >= arg1.closes_at_ms, 15);
        arg0.redeem_status = 2;
        let RedemptionVault {
            id                           : v0,
            balance                      : v1,
            rate_msui_per_sui            : _,
            activated_at_ms              : _,
            closes_at_ms                 : _,
            initial_balance_mist         : _,
            total_msui_burned_base_units : v6,
            total_sui_paid_mist          : v7,
            beneficiary                  : v8,
        } = arg1;
        let v9 = v1;
        let v10 = 0x2::balance::value<0x2::sui::SUI>(&v9);
        let v11 = RedemptionClosedEvent{
            caller                       : 0x2::tx_context::sender(arg3),
            beneficiary                  : v8,
            remaining_sui_mist           : v10,
            total_msui_burned_base_units : v6,
            total_sui_paid_mist          : v7,
        };
        0x2::event::emit<RedemptionClosedEvent>(v11);
        0x2::object::delete(v0);
        if (v10 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v9, arg3), v8);
        } else {
    ...
    public fun current_supply_base_units(arg0: &ReserveState) : u64 {
        0x2::coin::total_supply<MSUI>(&arg0.treasury_cap)
    }
    ...
    public fun finalize_wind_down(arg0: AdminCap, arg1: &mut ReserveState, arg2: &mut TreasuryVault, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::total_supply<MSUI>(&arg1.treasury_cap);
        assert!(v0 <= 12500000000000, 13);
        let v1 = 0x2::balance::value<0x2::sui::SUI>(&arg2.balance);
        assert!(v1 >= 25000000000, 14);
        let v2 = 0x2::clock::timestamp_ms(arg3);
        let v3 = (v2 as u128) + (7776000000 as u128);
        assert!(v3 <= 18446744073709551615, 19);
        let v4 = (v3 as u64);
        let v5 = (arg2.total_sui_withdrawn_mist as u128) + (v1 as u128);
        assert!(v5 <= 18446744073709551615, 19);
        arg1.mint_enabled = false;
        arg1.mint_phase = 0;
        arg1.sft_reward_enabled = false;
        arg1.redeem_status = 1;
        let v6 = 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg2.balance);
        let v7 = 0x2::balance::value<0x2::sui::SUI>(&v6);
        arg2.total_sui_withdrawn_mist = (v5 as u64);
        arg2.reserved_sui_mist = 0;
        arg2.deployed_sui_mist = 0;
        let v8 = RedemptionVault{
            id                           : 0x2::object::new(arg4),
            balance                      : 0x2::balance::split<0x2::sui::SUI>(&mut arg2.balance, 25000000000),
            rate_msui_per_sui            : 500,
            activated_at_ms              : v2,
            closes_at_ms                 : v4,
            initial_balance_mist         : 25000000000,
            total_msui_burned_base_units : 0,
            total_sui_paid_mist          : 0,
            beneficiary                  : @0x2eb40a1c825b4ead061e8cc6be55a9a010a81a31cef89a23cbdfaee8ade6cf1c,
        };
        let AdminCap { id: v9 } = arg0;
        0x2::object::delete(v9);
        let v10 = WindDownFinalizedEvent{
            admin                   : 0x2::tx_context::sender(arg4),
            redemption_vault_id     : 0x2::object::id<RedemptionVault>(&v8),
            supply_base_units       : v0,
            redemption_reserve_mist : 25000000000,
            treasury_released_mist  : v7,
            rate_msui_per_sui       : 500,
            activated_at_ms         : v2,
            closes_at_ms            : v4,
            beneficiary             : @0x2eb40a1c825b4ead061e8cc6be55a9a010a81a31cef89a23cbdfaee8ade6cf1c,
        };
        0x2::event::emit<WindDownFinalizedEvent>(v10);
        0x2::transfer::share_object<RedemptionVault>(v8);
        if (v7 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v6, arg4), @0x2eb40a1c825b4ead061e8cc6be55a9a010a81a31cef89a23cbdfaee8ade6cf1c);
        } else {
    ...
    public fun redeem(arg0: &mut ReserveState, arg1: &mut RedemptionVault, arg2: 0x2::coin::Coin<MSUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.redeem_status == 1, 15);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(v0 >= arg1.activated_at_ms, 15);
        assert!(v0 < arg1.closes_at_ms, 16);
        let v1 = 0x2::coin::value<MSUI>(&arg2);
        let v2 = v1 / arg1.rate_msui_per_sui;
        assert!(v2 > 0, 17);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg1.balance) >= v2, 18);
        let v3 = (arg1.total_msui_burned_base_units as u128) + (v1 as u128);
        let v4 = (arg1.total_sui_paid_mist as u128) + (v2 as u128);
        assert!(v3 <= 18446744073709551615 && v4 <= 18446744073709551615, 19);
        0x2::coin::burn<MSUI>(&mut arg0.treasury_cap, arg2);
        arg1.total_msui_burned_base_units = (v3 as u64);
        arg1.total_sui_paid_mist = (v4 as u64);
        let v5 = RedemptionEvent{
            redeemer               : 0x2::tx_context::sender(arg4),
            msui_burned_base_units : v1,
            sui_paid_mist          : v2,
            remaining_reserve_mist : 0x2::balance::value<0x2::sui::SUI>(&arg1.balance),
        };
        0x2::event::emit<RedemptionEvent>(v5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.balance, v2), arg4), 0x2::tx_context::sender(arg4));
    }
    ...
    public fun redeem_status_active() : u8 {
        1
    }

    public fun redeem_status_closed() : u8 {
        2
    }

    public fun redemption_activated_at_ms(arg0: &RedemptionVault) : u64 {
        arg0.activated_at_ms
    }

    public fun redemption_balance_mist(arg0: &RedemptionVault) : u64 {
        0x2::balance::value<0x2::sui::SUI>(&arg0.balance)
    }

    public fun redemption_beneficiary(arg0: &RedemptionVault) : address {
        arg0.beneficiary
    }

    public fun redemption_closes_at_ms(arg0: &RedemptionVault) : u64 {
        arg0.closes_at_ms
    }

    public fun redemption_duration_constant_ms() : u64 {
        7776000000
    }

    public fun redemption_initial_balance_mist(arg0: &RedemptionVault) : u64 {
        arg0.initial_balance_mist
    }

    public fun redemption_max_supply_constant_base_units() : u64 {
        12500000000000
    }

    public fun redemption_rate_constant_msui_per_sui() : u64 {
        500
    }

    public fun redemption_rate_msui_per_sui(arg0: &RedemptionVault) : u64 {
        arg0.rate_msui_per_sui
    }

    public fun redemption_reserve_constant_mist() : u64 {
        25000000000
    }

    public fun redemption_total_msui_burned_base_units(arg0: &RedemptionVault) : u64 {
        arg0.total_msui_burned_base_units
    }

    public fun redemption_total_sui_paid_mist(arg0: &RedemptionVault) : u64 {
        arg0.total_sui_paid_mist
    }
    ...
    public fun wind_down_beneficiary() : address {
        @0x2eb40a1c825b4ead061e8cc6be55a9a010a81a31cef89a23cbdfaee8ade6cf1c
    }
