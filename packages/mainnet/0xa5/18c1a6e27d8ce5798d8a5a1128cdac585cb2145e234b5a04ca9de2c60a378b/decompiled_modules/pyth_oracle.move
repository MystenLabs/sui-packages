module 0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::pyth_oracle {
    ...
    public fun get_price<T0>(arg0: &PythOracle, arg1: &0x2::clock::Clock) : Price {
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, Price>(&arg0.prices, v0), 13837031223388405775);
        let v1 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, v0);
        assert!(0x2::clock::timestamp_ms(arg1) / 1000 == v1.last_update_time, 13837312715545116689);
        v1
    }

    public fun add_oracle_info<T0>(arg0: &mut PythOracle, arg1: &0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::config::GlobalConfig, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: &0x2::coin::CoinMetadata<T0>, arg4: vector<u8>, arg5: u64, arg6: &0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::versioned::Versioned, arg7: &0x2::tx_context::TxContext) {
        0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::versioned::check_version(arg6);
        0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg7));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
    ...
    public fun calculate_oracle_prices<T0, T1>(arg0: &PythOracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : (u64, u64, u64, u64) {
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835904254034182151);
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v1), 13835904258329149447);
        ...
        assert!(v2.price_info_object_id == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg1), 13836185754780827657);
        assert!(v3.price_info_object_id == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg2), 13836185771960696841);
    ...
    public fun get_price_by_type(arg0: &PythOracle, arg1: 0x1::type_name::TypeName, arg2: &0x2::clock::Clock) : Price {
        assert!(0x2::table::contains<0x1::type_name::TypeName, Price>(&arg0.prices, arg1), 13837031326467620879);
        let v0 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, arg1);
        assert!(0x2::clock::timestamp_ms(arg2) / 1000 == v0.last_update_time, 13837312818624331793);
        v0
    }
    ...
    public fun pyth_price_from_oracle_info(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &OracleInfo, arg2: &0x2::clock::Clock) : u64 {
        ...
        assert!(arg1.price_feed_id == 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v2), 13836468002851782667);
        ...
        assert!(!0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_is_negative(&v4), 13835060649442410497);
        let v5 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v4);
        assert!(v5 != 0, 13836749507893395469);
    ...
    public fun remove_oracle_info<T0>(arg0: &mut PythOracle, arg1: &0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::config::GlobalConfig, arg2: &0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::versioned::Versioned, arg3: &0x2::tx_context::TxContext) {
        0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::versioned::check_version(arg2);
        0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg3));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835903914731765767);
    ...
    public fun update_price_age<T0>(arg0: &mut PythOracle, arg1: &0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::config::GlobalConfig, arg2: u64, arg3: &0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::versioned::Versioned, arg4: &0x2::tx_context::TxContext) {
        0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::versioned::check_version(arg3);
        0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg4));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835904073645555719);
    ...
    fun update_price_from_type<T0>(arg0: &mut PythOracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : Price {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835904786610126855);
        let v1 = 0x2::table::borrow<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0);
        assert!(v1.price_info_object_id == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg1), 13836186278766837769);
        let v2 = Price{
