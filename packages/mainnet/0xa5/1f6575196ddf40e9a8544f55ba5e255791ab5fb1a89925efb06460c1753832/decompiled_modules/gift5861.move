module 0xa51f6575196ddf40e9a8544f55ba5e255791ab5fb1a89925efb06460c1753832::gift5861 {
    struct GIFT5861 has drop {
        dummy_field: bool,
    }

    struct TICKET_5861 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5861(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5861>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5861>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5861, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5861>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5861>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5861>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5861>>(v5, 0x2::tx_context::sender(arg1));
    }
