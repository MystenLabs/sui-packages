module 0xa51bd37ff635cb5f631e152b59a5063a5376b5c2c730308c5082bdd5b96cafb7::codelab {
    ...
    public entry fun getTypeNames<T0, T1>() {
        ...
        let (v2, v3) = 0xa51bd37ff635cb5f631e152b59a5063a5376b5c2c730308c5082bdd5b96cafb7::comparator::to_bytes<0x1::type_name::TypeName>(&v0, &v1);
        let v4 = NamesEvent{
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = ValueA{a: 1};
        0x2::bag::add<vector<u8>, ValueA>(&mut v0.upgrade_bag, b"123", v1);
    ...
    public fun is_order<T0, T1>() : bool {
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x1::type_name::get<T1>();
        let v2 = 0xa51bd37ff635cb5f631e152b59a5063a5376b5c2c730308c5082bdd5b96cafb7::comparator::compare<0x1::type_name::TypeName>(&v0, &v1);
        assert!(!0xa51bd37ff635cb5f631e152b59a5063a5376b5c2c730308c5082bdd5b96cafb7::comparator::is_equal(&v2), 1001);
        0xa51bd37ff635cb5f631e152b59a5063a5376b5c2c730308c5082bdd5b96cafb7::comparator::is_smaller_than(&v2)
    }
