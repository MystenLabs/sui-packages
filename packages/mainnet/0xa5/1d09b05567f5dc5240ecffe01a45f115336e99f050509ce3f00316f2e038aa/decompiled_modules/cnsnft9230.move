module 0xa51d09b05567f5dc5240ecffe01a45f115336e99f050509ce3f00316f2e038aa::cnsnft9230 {
    struct CNSNFT9230 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9230, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3304"));
        let v4 = 0x2::package::claim<CNSNFT9230>(arg0, arg1);
