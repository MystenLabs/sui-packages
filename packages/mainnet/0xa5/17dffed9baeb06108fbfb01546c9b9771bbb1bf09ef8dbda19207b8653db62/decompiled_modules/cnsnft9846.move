module 0xa517dffed9baeb06108fbfb01546c9b9771bbb1bf09ef8dbda19207b8653db62::cnsnft9846 {
    struct CNSNFT9846 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9846, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9846>(arg0, arg1);
