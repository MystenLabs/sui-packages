module 0xca51a97e98b7bb94094672fce4d3919684bb344997721ac5dd792dda5d35b3c8::cnsnft5872 {
    struct CNSNFT5872 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5872, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5872>(arg0, arg1);
