module 0xca056c17b9e453c65747c5c9756d742558d62bdd00e27c25814b0724c8d1a4af::dex_aftermath {
    ...
    public fun get_aftermath_module() : address {
        0xca056c17b9e453c65747c5c9756d742558d62bdd00e27c25814b0724c8d1a4af::constants::aftermath_package()
    }
    ...
    public fun validate_single_token_route<T0>() : bool {
        ...
        let v2 = 0xca056c17b9e453c65747c5c9756d742558d62bdd00e27c25814b0724c8d1a4af::constants::wusdc_type();
        if (v1 == &v2) {
            true
        } else {
            let v4 = 0xca056c17b9e453c65747c5c9756d742558d62bdd00e27c25814b0724c8d1a4af::constants::usdt_type();
            if (v1 == &v4) {
                true
            } else {
                let v5 = 0xca056c17b9e453c65747c5c9756d742558d62bdd00e27c25814b0724c8d1a4af::constants::buck_type();
                v1 == &v5
            }
        }
    }
