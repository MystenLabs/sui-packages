module 0xe5099fcd45747074d0ef5eabce07a9bd1c3b0c1862435bf2a09c3a81e0604373::router {
    ...
    public fun end_router_tx_r1_w1<T0, T1>(arg0: RouterSwapCapExtended<RouterDataV1, WrapperDataV1<T0>>, arg1: &mut 0x2::balance::Balance<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v16 = if (v1 > v10) {
            let v17 = v1 - v10;
            let v18 = 0x2::coin::take<T1>(arg1, v17, arg2);
            if (v15.recipient == @0x0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v18, v12);
                0
            } else {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v18, v17 / 2, arg2), v15.recipient);
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v18, v12);
                0x2::coin::value<T1>(&v18)
            }
        } else {
            assert!(v1 >= v10 - (((v10 as u128) * (v11 as u128) / 1000000000000000000) as u64), 5);
            0
        };
        0xe5099fcd45747074d0ef5eabce07a9bd1c3b0c1862435bf2a09c3a81e0604373::events::emit_swap_completed_event(v9.type, v9.amount, v15.fee_percent_base_18, v14, v8.type, v8.amount, v16, v15.recipient, arg2);
    }
