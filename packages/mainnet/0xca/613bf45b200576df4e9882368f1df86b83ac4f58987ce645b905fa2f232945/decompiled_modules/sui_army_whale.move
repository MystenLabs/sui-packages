module 0xca613bf45b200576df4e9882368f1df86b83ac4f58987ce645b905fa2f232945::sui_army_whale {
    struct SUI_ARMY_WHALE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_ARMY_WHALE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_ARMY_WHALE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sui Army Whale"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Sui Army Whale is a unique and totally unique collection of NFTs! Each Sui Army Whale is unique and 100% owned by you; it cannot be imitated, taken away, or destroyed. Let's be part of the Sui Army Whale!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://Kv6Cnle7aTG-Y8JitxQU5BmEbowISp4N5BdbgU0nUl0"));
