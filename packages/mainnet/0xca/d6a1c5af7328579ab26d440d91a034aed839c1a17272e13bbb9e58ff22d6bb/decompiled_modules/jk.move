module 0xcad6a1c5af7328579ab26d440d91a034aed839c1a17272e13bbb9e58ff22d6bb::jk {
    ...
    public fun deepbookswap_0<T0, T1>(arg0: &mut AccessList, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: &0xdee9::custodian_v2::AccountCap, arg3: &0x2::clock::Clock, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert!(is_valid(arg0, arg6), 10000000002);
        let (v0, v1) = 0xdee9::clob_v2::place_market_order<T0, T1>(arg1, arg2, arg4, 0x2::coin::value<T0>(&arg5), false, arg5, 0x2::coin::zero<T1>(arg6), arg3, arg6);
