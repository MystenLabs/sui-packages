module 0xcabf3662e1ccd1e508bb2ccb3db8cae7edbedbab5a9958d5dfd9df2a312cdaa7::meme_09_05_2024_02 {
    struct MEME_09_05_2024_02 has drop {
        dummy_field: bool,
    }

    fun init(arg0: MEME_09_05_2024_02, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_09_05_2024_02>(arg0, 6, b"MEME_09_05_2024_02", b"meme0905202402", b"09 May 2024 first second", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = v0;
