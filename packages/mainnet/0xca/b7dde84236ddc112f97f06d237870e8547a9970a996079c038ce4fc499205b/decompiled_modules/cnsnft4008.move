module 0xcab7dde84236ddc112f97f06d237870e8547a9970a996079c038ce4fc499205b::cnsnft4008 {
    struct CNSNFT4008 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4008, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4008>(arg0, arg1);
