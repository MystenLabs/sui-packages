module 0xca3c86d6a7b26675a22cdbf391512076328e9d900c26611d021430b50ec483db::gift2733 {
    struct GIFT2733 has drop {
        dummy_field: bool,
    }

    struct TICKET_2733 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2733(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2733>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2733>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2733, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2733>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2733>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2733>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2733>>(v5, 0x2::tx_context::sender(arg1));
    }
