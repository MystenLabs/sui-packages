module 0xcac46c81bbe1e516c65f4c3e5da81e7092cc2e70218deafb31f1c8d5fcc9dae3::mfud {
    ...
    fun init(arg0: MFUD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MFUD>(arg0, (3 as u8), b"MFUD", b"Typus MFUD", b"MFUD on Sui maintained by Typus Lab", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = Registry{
