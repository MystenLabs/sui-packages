module 0xa1476d3120e224016541f8495c239ac18131b27465a3f2a089d6f038b8cc4786::acl {
    ...
    public(friend) fun set_upgrade_cap(arg0: &mut ACL, arg1: 0x2::package::UpgradeCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(is_admin(arg0, v0), 1);
        assert!(get_upgrade_cap_id(&arg1) == @0xdba72804cc9504a82bbaa13ed4a83a0e2c6219d7e45125cf57fd10cbab957a97, 16);
