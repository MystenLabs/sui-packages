module 0xcabd752b43291e6fa5da9180afe3db2d46b32668054536d385d3582b7e0bb2fe::trade_offer {
    ...
    fun has_duplicate_ids(arg0: &vector<0x2::object::ID>) : bool {
        let v0 = 0x1::vector::length<0x2::object::ID>(arg0);
        let v1 = 0;
        while (v1 < v0) {
            let v2 = v1 + 1;
            while (v2 < v0) {
                if (*0x1::vector::borrow<0x2::object::ID>(arg0, v1) == *0x1::vector::borrow<0x2::object::ID>(arg0, v2)) {
                    return true
                };
                v2 = v2 + 1;
            };
    ...
    public fun new_offer(arg0: address, arg1: vector<0x2::object::ID>, arg2: &mut 0x2::tx_context::TxContext) : TradeOffer {
        assert!(arg0 != 0x2::tx_context::sender(arg2), 6);
        assert!(!has_duplicate_ids(&arg1), 7);
        TradeOffer{
