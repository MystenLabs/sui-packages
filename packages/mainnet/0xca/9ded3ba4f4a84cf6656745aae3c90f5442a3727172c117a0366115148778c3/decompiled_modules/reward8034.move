module 0xca9ded3ba4f4a84cf6656745aae3c90f5442a3727172c117a0366115148778c3::reward8034 {
    struct REWARD8034 has drop {
        dummy_field: bool,
    }

    struct TICKET_8034 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8034(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8034>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8034>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8034, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8034>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8034>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8034>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8034>>(v5, 0x2::tx_context::sender(arg1));
    }
