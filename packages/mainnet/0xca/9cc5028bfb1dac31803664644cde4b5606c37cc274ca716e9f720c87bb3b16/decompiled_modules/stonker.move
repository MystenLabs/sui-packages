module 0xca9cc5028bfb1dac31803664644cde4b5606c37cc274ca716e9f720c87bb3b16::stonker {
    ...
    fun adjust_maker_orders(arg0: &Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: &OrderBook, arg7: &0x2::tx_context::TxContext) {
        ...
        if (0x1::vector::length<u128>(&v11) > 4) {
            let v12 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg7);
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::cancel_all_orders<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v12, arg3, arg7);
        ...
        while (v20 < 0x1::vector::length<u128>(&v11)) {
            ...
            v20 = v20 + 1;
            assert!(v21 != 0, 13906838907397341183);
            if (order_is_bid(v21)) {
                if (v17 == 0) {
                    v18 = v21;
                    continue
        ...
        ensure_maker_order_is_correct(arg0, arg1, arg2, v14, arg4 - v5, v9, true, arg0.parameters.maker_max_shallow_quantity_base, 0, arg6, true, arg3, arg7);
        ensure_maker_order_is_correct(arg0, arg1, arg2, v16, arg4 + v5, v9, false, arg0.parameters.maker_max_shallow_quantity_base, 0, arg6, true, arg3, arg7);
        if (arg0.parameters.maker_deep_trades_enabled) {
            ensure_maker_order_is_correct(arg0, arg1, arg2, v18, arg4 - v7, v10, true, arg0.parameters.maker_max_deep_buy_quantity_base, 1, arg6, false, arg3, arg7);
            ensure_maker_order_is_correct(arg0, arg1, arg2, v19, arg4 + v7, v10, false, arg0.parameters.maker_max_deep_sell_quantity_base, 1, arg6, false, arg3, arg7);
        };
    }

    fun check_sender(arg0: &Stonker, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 13906834840063311871);
    }
    ...
    fun ensure_maker_order_is_correct(arg0: &Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: u128, arg4: u64, arg5: u64, arg6: bool, arg7: u64, arg8: u64, arg9: &OrderBook, arg10: bool, arg11: &0x2::clock::Clock, arg12: &0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_book_params<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2);
        if (arg10) {
            arg4 = get_dimed_price(arg0, arg9, arg4, arg6, v0);
        };
        let v3 = order_price(arg3);
        let v4 = if (arg3 != 0) {
            if (v3 >= arg4 - arg5) {
                v3 <= arg4 + arg5
            } else {
        ...
        if (v4) {
            let v5 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::get_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg3);
            let v6 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::expire_timestamp(&v5);
            if (v6 > 0x2::clock::timestamp_ms(arg11) && v6 - 0x2::clock::timestamp_ms(arg11) > arg0.parameters.maker_order_ttl_ms / 2) {
                return
            };
        };
        let v7 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg12);
        if (arg3 != 0) {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::cancel_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v7, arg3, arg11, arg12);
        };
        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::withdraw_settled_amounts<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v7);
        if (arg6) {
            let v8 = arg7;
            let v9 = convert_to_base_at_price(arg0, get_available_quote_balance(arg0, arg1), arg4);
            if (arg7 > v9) {
                v8 = v9;
            };
            let v10 = arg4 / v0 * v0;
            let v11 = v10;
            let v12 = v8 / v1 * v1;
            if (v10 >= arg9.best_ask) {
                v11 = arg9.best_ask - v0;
            };
            if (v12 < v2) {
                return
            };
            ...
            let v15 = (arg4 + v0 - 1) / v0 * v0;
            let v16 = v15;
            let v17 = v13 / v1 * v1;
            if (v15 <= arg9.best_bid) {
                v16 = arg9.best_bid + v0;
            };
            if (v17 < v2) {
                return
            };
            if (v16 < arg0.parameters.minimum_sell_price_quote) {
                return
            };
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v7, arg8, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::post_only(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::cancel_maker(), v16, v17, false, false, 0x2::clock::timestamp_ms(arg11) + arg0.parameters.maker_order_ttl_ms, arg11, arg12);
        };
    }
    ...
    fun get_dimed_price(arg0: &Stonker, arg1: &OrderBook, arg2: u64, arg3: bool, arg4: u64) : u64 {
        if (arg3) {
            let v0 = 0;
            while (v0 < 0x1::vector::length<u64>(&arg1.bid_prices)) {
                let v1 = *0x1::vector::borrow<u64>(&arg1.bid_prices, v0);
                if (v1 >= arg2) {
                    v0 = v0 + 1;
                    continue
                };
                if (*0x1::vector::borrow<u64>(&arg1.bid_quantities, v0) < arg0.parameters.minimum_considered_volume) {
                    v0 = v0 + 1;
                    continue
                };
                return v1 + arg4
            ...
            let v2 = 0;
            while (v2 < 0x1::vector::length<u64>(&arg1.ask_prices)) {
                let v3 = *0x1::vector::borrow<u64>(&arg1.ask_prices, v2);
                if (v3 <= arg2) {
                    v2 = v2 + 1;
                    continue
                };
                if (*0x1::vector::borrow<u64>(&arg1.ask_quantities, v2) < arg0.parameters.minimum_considered_volume) {
                    v2 = v2 + 1;
                    continue
                };
                return v3 - arg4
    ...
    fun get_order_book_without_our_orders(arg0: &Stonker, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &vector<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>, arg3: u64, arg4: &0x2::clock::Clock) : OrderBook {
        ...
        while (v8 < 0x1::vector::length<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(arg2)) {
            ...
            let (v10, v11, _) = decode_order_id(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::order_id(v9));
            let v13 = v11;
            if (v10) {
                ...
                assert!(*v16 >= v17, 13906837807885713407);
                *v16 = *v16 - v17;
                continue
            };
            ...
            assert!(*v20 >= v21, 13906837863720288255);
            *v20 = *v20 - v21;
        };
        let v22 = 0;
        while (v22 < 0x1::vector::length<u64>(&v7)) {
            if (*0x1::vector::borrow<u64>(&v6, v22) < arg0.parameters.minimum_considered_volume) {
                v22 = v22 + 1;
            } else {
                break
            };
        ...
        while (v23 < 0x1::vector::length<u64>(&v5)) {
            if (*0x1::vector::borrow<u64>(&v4, v23) < arg0.parameters.minimum_considered_volume) {
                v23 = v23 + 1;
            } else {
                break
            };
    ...
    public fun input_signal(arg0: &mut Stonker, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &0x2::clock::Clock, arg6: u64, arg7: u64, arg8: u8, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::clock::timestamp_ms(arg5) < arg0.cannot_trade_until_ms) {
            emit_could_not_trade_event(b"cannot_trade");
            return
        };
        ...
        let v0 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::get_account_order_details<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg3, arg2);
        let v1 = get_order_book_without_our_orders(arg0, arg3, &v0, 8, arg5);
        let v2 = InputSignalEvent{
            ...
            best_dex_bids                 : v1.bid_prices,
            best_dex_bid_quantities       : v1.bid_quantities,
            best_dex_asks                 : v1.ask_prices,
            best_dex_ask_quantities       : v1.ask_quantities,
            dex_spread                    : v1.best_ask - v1.best_bid,
        ...
        if (arg8 == 0 || arg8 == 1) {
            try_make_taker_trade(arg0, arg2, arg3, arg4, arg5, arg6, arg8 == 0, v1.best_bid, v1.best_ask, arg11);
        };
        adjust_maker_orders(arg0, arg2, arg3, arg5, arg6, arg7, &v1, arg11);
    }
    ...
    fun production_stonker_parameters() : StonkerParameters {
        ...
        StonkerParameters{
            ...
            maker_max_deep_sell_quantity_base          : 20 * v0,
            maker_max_deep_buy_quantity_base           : 20 * v0,
