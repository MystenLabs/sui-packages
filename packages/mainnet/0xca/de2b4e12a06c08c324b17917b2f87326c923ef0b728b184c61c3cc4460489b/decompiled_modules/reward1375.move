module 0xcade2b4e12a06c08c324b17917b2f87326c923ef0b728b184c61c3cc4460489b::reward1375 {
    struct REWARD1375 has drop {
        dummy_field: bool,
    }

    struct TICKET_1375 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1375(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1375>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1375>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1375, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1375>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1375>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1375>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1375>>(v5, 0x2::tx_context::sender(arg1));
    }
