module 0xca3b191aa3a61fe70e9ceaed09bc3434594db6249af71cf240af26e37e6bf9ca::gift8168 {
    struct GIFT8168 has drop {
        dummy_field: bool,
    }

    struct TICKET_8168 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8168(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8168>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8168>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8168, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8168>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8168>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8168>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8168>>(v5, 0x2::tx_context::sender(arg1));
    }
