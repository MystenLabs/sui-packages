module 0xca4779f84215c67963b3285788fbfd085aaf3a50f29fc08760288d28411d0285::suitama {
    struct SUITAMA has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUITAMA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUITAMA>(arg0, 6, b"SUITAMA", b"", b"", 0x1::option::none<0x2::url::Url>(), arg1);
