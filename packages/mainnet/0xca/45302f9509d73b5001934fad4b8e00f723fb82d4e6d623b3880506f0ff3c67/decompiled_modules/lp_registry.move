module 0xca45302f9509d73b5001934fad4b8e00f723fb82d4e6d623b3880506f0ff3c67::lp_registry {
    ...
    public fun unregister_position<T0: store + key>(arg0: &mut LPRegistry, arg1: PositionRegistration, arg2: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        if (0x2::table::contains<address, vector<0x2::object::ID>>(&arg0.owner_registrations, v2)) {
            let v19 = 0x2::table::borrow_mut<address, vector<0x2::object::ID>>(&mut arg0.owner_registrations, v2);
            let v20 = 0x2::object::uid_to_inner(&v18);
            let (v21, v22) = 0x1::vector::index_of<0x2::object::ID>(v19, &v20);
            if (v21) {
                0x1::vector::remove<0x2::object::ID>(v19, v22);
            };
        };
        arg0.total_registered = arg0.total_registered - 1;
        let v23 = PositionUnregistered{
            registration_id : 0x2::object::uid_to_address(&v18),
            position_id     : 0x2::object::id_to_address(&v17),
            owner           : v2,
        };
        0x2::event::emit<PositionUnregistered>(v23);
        0x2::object::delete(v18);
        0x2::dynamic_object_field::remove<0x2::object::ID, T0>(&mut arg0.id, v17)
    }
