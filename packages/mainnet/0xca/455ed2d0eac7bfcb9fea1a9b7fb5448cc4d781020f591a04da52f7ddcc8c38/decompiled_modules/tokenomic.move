module 0xca455ed2d0eac7bfcb9fea1a9b7fb5448cc4d781020f591a04da52f7ddcc8c38::tokenomic {
    ...
    public fun addFund<T0>(arg0: &TAdminCap, arg1: &mut TokenomicPie<T0>, arg2: address, arg3: vector<u8>, arg4: u8, arg5: u64, arg6: u64, arg7: 0x2::coin::Coin<T0>, arg8: u64, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0xca455ed2d0eac7bfcb9fea1a9b7fb5448cc4d781020f591a04da52f7ddcc8c38::version::Version, arg12: vector<u64>, arg13: vector<u64>, arg14: &mut 0x2::tx_context::TxContext) {
        0xca455ed2d0eac7bfcb9fea1a9b7fb5448cc4d781020f591a04da52f7ddcc8c38::version::checkVersion(arg11, 1);
        ...
        arg1.total_shares = 0xea2ef08c61bcfa88f22442782e2769acfcd73f506d1fd96664def94f390b54a2::u256::add_u64(arg1.total_shares, v0);
        arg1.total_shares_percent = arg1.total_shares * 10000 / arg1.total_supply;
        let v4 = v0 * 10000 / arg1.total_supply;
    ...
    public fun change_admin(arg0: TAdminCap, arg1: address, arg2: &mut 0xca455ed2d0eac7bfcb9fea1a9b7fb5448cc4d781020f591a04da52f7ddcc8c38::version::Version) {
        0xca455ed2d0eac7bfcb9fea1a9b7fb5448cc4d781020f591a04da52f7ddcc8c38::version::checkVersion(arg2, 1);
        0x2::transfer::transfer<TAdminCap>(arg0, arg1);
    }

    public fun change_fund_owner<T0>(arg0: &mut TokenomicPie<T0>, arg1: address, arg2: &mut 0xca455ed2d0eac7bfcb9fea1a9b7fb5448cc4d781020f591a04da52f7ddcc8c38::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0xca455ed2d0eac7bfcb9fea1a9b7fb5448cc4d781020f591a04da52f7ddcc8c38::version::checkVersion(arg2, 1);
    ...
    public fun claim<T0>(arg0: &mut TokenomicPie<T0>, arg1: &0x2::clock::Clock, arg2: &0xca455ed2d0eac7bfcb9fea1a9b7fb5448cc4d781020f591a04da52f7ddcc8c38::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0xca455ed2d0eac7bfcb9fea1a9b7fb5448cc4d781020f591a04da52f7ddcc8c38::version::checkVersion(arg2, 1);
        ...
        let v3 = cal_claim_percent<T0>(v2, v0);
        assert!(v3 > 0, 8010);
        let v4 = v2.vesting_fund_total * v3 / 10000 - v2.vesting_fund_released;
        assert!(v4 > 0, 8007);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v2.vesting_fund, v4, arg3), v1);
    ...
    public fun getFundReleased<T0>(arg0: &TokenomicPie<T0>, arg1: address) : u64 {
        0x2::table::borrow<address, TokenomicFund<T0>>(&arg0.shares, arg1).vesting_fund_released
    }

    public fun getFundTotal<T0>(arg0: &TokenomicPie<T0>, arg1: address) : u64 {
    ...
    public fun getFundVestingAvailable<T0>(arg0: &TokenomicPie<T0>, arg1: address) : u64 {
        0x2::coin::value<T0>(&0x2::table::borrow<address, TokenomicFund<T0>>(&arg0.shares, arg1).vesting_fund)
    }
    ...
    public fun getPieTotalShare<T0>(arg0: &TokenomicPie<T0>) : u64 {
        arg0.total_shares
    }

    public fun getPieTotalSharePercent<T0>(arg0: &TokenomicPie<T0>) : u64 {
        arg0.total_shares_percent
    }

    public fun getPieTotalSupply<T0>(arg0: &TokenomicPie<T0>) : u64 {
        arg0.total_supply
    }
    ...
    public fun init_tokenomic<T0>(arg0: &TAdminCap, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0xca455ed2d0eac7bfcb9fea1a9b7fb5448cc4d781020f591a04da52f7ddcc8c38::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        0xca455ed2d0eac7bfcb9fea1a9b7fb5448cc4d781020f591a04da52f7ddcc8c38::version::checkVersion(arg4, 1);
