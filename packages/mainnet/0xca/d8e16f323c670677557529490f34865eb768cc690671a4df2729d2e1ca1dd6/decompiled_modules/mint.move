module 0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mint {
    ...
    public entry fun claim_and_create_kiosk(arg0: 0xaf93691a72197580dc0172102f9e7c9ee5934c54ab777d2220edc6a3f1ac5dcc::atlansui_lab::AtlansuiLab, arg1: &0x2::transfer_policy::TransferPolicy<0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::Mermaid>, arg2: &mut MintState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = 0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::mint_nft(v6, v8, v9, arg3);
        0x1::vector::push_back<0x2::object::ID>(&mut v5, 0x2::object::id<0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::Mermaid>(&v10));
        0x2::kiosk::lock<0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::Mermaid>(&mut v2, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(&v3), arg1, v10);
    ...
    public entry fun claim_nfts_and_create_kiosk(arg0: vector<0xaf93691a72197580dc0172102f9e7c9ee5934c54ab777d2220edc6a3f1ac5dcc::atlansui_lab::AtlansuiLab>, arg1: &0x2::transfer_policy::TransferPolicy<0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::Mermaid>, arg2: &mut MintState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<0xaf93691a72197580dc0172102f9e7c9ee5934c54ab777d2220edc6a3f1ac5dcc::atlansui_lab::AtlansuiLab>(&arg0) > 0) {
            ...
            let v12 = 0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::mint_nft(v8, v10, v11, arg3);
            0x1::vector::push_back<0x2::object::ID>(&mut v6, 0x2::object::id<0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::Mermaid>(&v12));
            0x2::kiosk::lock<0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::Mermaid>(&mut v2, v4, arg1, v12);
    ...
    public entry fun claim_special_to_kiosk(arg0: &OperatorCap, arg1: address, arg2: &0x2::transfer_policy::TransferPolicy<0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::Mermaid>, arg3: u64, arg4: vector<u8>, arg5: vector<0x1::ascii::String>, arg6: vector<0x1::ascii::String>, arg7: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::kiosk::new(arg7);
        let v2 = v1;
        let v3 = v0;
        0x2::kiosk::set_owner_custom(&mut v3, &v2, arg1);
        0x2::kiosk::lock<0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::Mermaid>(&mut v3, &v2, arg2, 0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::mint_special_nft(arg3, arg4, arg5, arg6, arg7));
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v2, arg1);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v3);
    }

    public entry fun claim_to_kiosk(arg0: 0xaf93691a72197580dc0172102f9e7c9ee5934c54ab777d2220edc6a3f1ac5dcc::atlansui_lab::AtlansuiLab, arg1: &mut MintState, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg4: &0x2::transfer_policy::TransferPolicy<0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::Mermaid>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::mint_nft(v2, v4, v5, arg5);
        0x1::vector::push_back<0x2::object::ID>(&mut v1, 0x2::object::id<0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::Mermaid>(&v6));
        0x2::kiosk::lock<0xcad8e16f323c670677557529490f34865eb768cc690671a4df2729d2e1ca1dd6::mermaid::Mermaid>(arg2, v0, arg4, v6);
        0xaf93691a72197580dc0172102f9e7c9ee5934c54ab777d2220edc6a3f1ac5dcc::atlansui_lab::burn(arg0);
