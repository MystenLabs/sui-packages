module 0xca8f85b781012d051166c33b97563afe9c24b1ecb787edf1a25fdbd4eb440167::cnsnft3812 {
    struct CNSNFT3812 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3812, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3812>(arg0, arg1);
