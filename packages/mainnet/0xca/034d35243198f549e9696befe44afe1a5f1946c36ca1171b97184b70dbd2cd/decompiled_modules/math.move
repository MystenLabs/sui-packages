module 0xca034d35243198f549e9696befe44afe1a5f1946c36ca1171b97184b70dbd2cd::math {
    ...
    public fun sqrt_int(arg0: u256) : u128 {
        ...
        while (v1 < 50) {
            let v2 = (v0 + arg0 / v0) / 2;
            if (v2 >= arg0 && v2 - arg0 <= 1 || arg0 > v2 && arg0 - v2 <= 1) {
                return (v2 as u128)
            };
            v0 = v2;
            v1 = v1 + 1;
