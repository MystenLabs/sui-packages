module 0xcae124c46e0a54d72d725f6d8c6da202260ba0aa065f09ca170d3c222fbc6657::parameterized {
    ...
    public entry fun execute_nft_transfer<T0: store + key>(arg0: &mut TransferParams, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (!arg0.initialized) {
            let v1 = NFTDebugEvent{
                message : 0x1::ascii::string(b"Transfer service not initialized, no action taken"),
                nft_id  : v0,
            };
