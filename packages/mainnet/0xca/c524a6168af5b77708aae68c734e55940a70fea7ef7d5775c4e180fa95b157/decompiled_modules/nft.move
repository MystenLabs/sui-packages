module 0xcac524a6168af5b77708aae68c734e55940a70fea7ef7d5775c4e180fa95b157::nft {
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::transfer_policy::new<MinerNFT>(&v0, arg1);
        let v3 = MinerTransferPolicy{
            id        : 0x2::object::new(arg1),
            min_price : 1000,
        };
        0x2::transfer::share_object<MinerTransferPolicy>(v3);
        let v4 = 0x2::display::new<MinerNFT>(&v0, arg1);
        0x2::display::add<MinerNFT>(&mut v4, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<MinerNFT>(&mut v4, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<MinerNFT>(&mut v4, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{url}"));
        0x2::display::update_version<MinerNFT>(&mut v4);
        0x2::transfer::public_share_object<0x2::display::Display<MinerNFT>>(v4);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<MinerNFT>>(v1);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<MinerNFT>>(v2, 0x2::tx_context::sender(arg1));
