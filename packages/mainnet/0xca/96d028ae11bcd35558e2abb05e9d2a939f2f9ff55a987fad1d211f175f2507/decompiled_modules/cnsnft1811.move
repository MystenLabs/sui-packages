module 0xca96d028ae11bcd35558e2abb05e9d2a939f2f9ff55a987fad1d211f175f2507::cnsnft1811 {
    struct CNSNFT1811 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1811, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1811>(arg0, arg1);
