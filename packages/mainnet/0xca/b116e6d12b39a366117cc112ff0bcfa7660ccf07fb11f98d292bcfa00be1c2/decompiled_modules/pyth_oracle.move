module 0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::pyth_oracle {
    ...
    public fun get_price<T0>(arg0: &PythOracle, arg1: &0x2::clock::Clock) : Price {
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, Price>(&arg0.prices, v0), 13837031446726705167);
        let v1 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, v0);
        assert!(0x2::clock::timestamp_ms(arg1) / 1000 == v1.last_update_time, 13837312938883416081);
        v1
    }

    public fun add_oracle_info<T0>(arg0: &mut PythOracle, arg1: &0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::config::GlobalConfig, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: &0x2::coin::CoinMetadata<T0>, arg4: vector<u8>, arg5: u64, arg6: &0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::versioned::Versioned, arg7: &0x2::tx_context::TxContext) {
        0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::versioned::check_version(arg6);
        0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg7));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(!0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835622259366297605);
    ...
    public fun add_oracle_info_v2<T0>(arg0: &mut PythOracle, arg1: &0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::config::GlobalConfig, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: &0x2::coin_registry::Currency<T0>, arg4: vector<u8>, arg5: u64, arg6: &0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::versioned::Versioned, arg7: &0x2::tx_context::TxContext) {
        ...
        0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg7));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(!0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835622474114662405);
        let v1 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::get_price_info_object_id(arg2, arg4);
        let v2 = OracleInfo{
            price_feed_id        : arg4,
            price_info_object_id : v1,
    ...
    public fun calculate_oracle_prices<T0, T1>(arg0: &PythOracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : (u64, u64, u64, u64) {
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835904468782546951);
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v1), 13835904473077514247);
        ...
        assert!(v2.price_info_object_id == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg1), 13836185969529192457);
        assert!(v3.price_info_object_id == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg2), 13836185986709061641);
    ...
    public fun deposit_fee(arg0: &mut PythOracle, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::versioned::Versioned) {
        0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::versioned::check_version(arg2);
    ...
    public fun get_price_by_type(arg0: &PythOracle, arg1: 0x1::type_name::TypeName, arg2: &0x2::clock::Clock) : Price {
        assert!(0x2::table::contains<0x1::type_name::TypeName, Price>(&arg0.prices, arg1), 13837031549805920271);
        let v0 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, arg1);
        assert!(0x2::clock::timestamp_ms(arg2) / 1000 == v0.last_update_time, 13837313041962631185);
        v0
    }
    ...
    public fun pyth_price_from_oracle_info(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &OracleInfo, arg2: &0x2::clock::Clock) : u64 {
        ...
        assert!(arg1.price_feed_id == 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v2), 13836468217600147467);
        ...
        assert!(!0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_is_negative(&v4), 13835060864190775297);
        let v5 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v4);
        assert!(v5 != 0, 13836749722641760269);
    ...
    public fun remove_oracle_info<T0>(arg0: &mut PythOracle, arg1: &0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::config::GlobalConfig, arg2: &0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::versioned::Versioned, arg3: &0x2::tx_context::TxContext) {
        0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::versioned::check_version(arg2);
        0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg3));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835904129480130567);
    ...
    public(friend) fun split_fee(arg0: &mut PythOracle, arg1: u64) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.update_price_fee) >= arg1, 13835340561051156483);
        0x2::balance::split<0x2::sui::SUI>(&mut arg0.update_price_fee, arg1)
    }

    public fun update_price<T0>(arg0: &mut PythOracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg2: 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::hot_potato_vector::HotPotatoVector<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfo>, arg3: &mut 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x2::clock::Clock, arg5: &0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::versioned::Versioned, arg6: &mut 0x2::tx_context::TxContext) : 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::hot_potato_vector::HotPotatoVector<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfo> {
        0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::versioned::check_version(arg5);
    ...
    public fun update_price_age<T0>(arg0: &mut PythOracle, arg1: &0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::config::GlobalConfig, arg2: u64, arg3: &0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::versioned::Versioned, arg4: &0x2::tx_context::TxContext) {
        0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::versioned::check_version(arg3);
        0xcab116e6d12b39a366117cc112ff0bcfa7660ccf07fb11f98d292bcfa00be1c2::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg4));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835904288393920519);
    ...
    fun update_price_from_type<T0>(arg0: &mut PythOracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : Price {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835905001358491655);
        let v1 = 0x2::table::borrow<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0);
        assert!(v1.price_info_object_id == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg1), 13836186493515202569);
        let v2 = Price{
