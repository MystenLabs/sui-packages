module 0xca4647e4810867e7e7b9e542f738e6a47ec7aa7e640f1e395b7abd4d429c0ab0::reward8584 {
    struct REWARD8584 has drop {
        dummy_field: bool,
    }

    struct TICKET_8584 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8584(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8584>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8584>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8584, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8584>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8584>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8584>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8584>>(v5, 0x2::tx_context::sender(arg1));
    }
