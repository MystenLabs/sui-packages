module 0xca372c27915dce64e695022c3f971bffd1f17a3dce5bc430c7f29cfab6981af9::PUBLICIFO {
    ...
    public entry fun claim_tokens<T0>(arg0: &mut PublicIFO<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::table::borrow_mut<address, u128>(&mut arg0.commited_table, 0x2::tx_context::sender(arg2));
        if (arg0.total_committed <= arg0.hard_cap) {
            let v1 = *v0 * 200000 * 1000000000 / 1000 * 1000000000;
            ...
            let v2 = PublicIFOClaimedEvent{
                sender   : 0x2::tx_context::sender(arg2),
                received : v1,
            };
            0x2::event::emit<PublicIFOClaimedEvent>(v2);
        } else {
            let v3 = *v0 * 200000 * (200000000000000 as u128) * 1000000000 / (arg0.total_committed as u128) * 1000 * 1000000000;
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_balance, ((*v0 - *v0 * (200000000000000 as u128) / (arg0.total_committed as u128)) as u64)), arg2), 0x2::tx_context::sender(arg2));
            let v4 = PublicIFOClaimedEvent{
                sender   : 0x2::tx_context::sender(arg2),
                received : v3,
            };
            0x2::event::emit<PublicIFOClaimedEvent>(v4);
        };
        *v0 = 0;
    }
