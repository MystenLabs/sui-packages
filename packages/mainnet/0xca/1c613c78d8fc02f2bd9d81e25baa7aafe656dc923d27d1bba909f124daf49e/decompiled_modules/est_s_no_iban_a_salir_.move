module 0xca1c613c78d8fc02f2bd9d81e25baa7aafe656dc923d27d1bba909f124daf49e::est_s_no_iban_a_salir_ {
    struct EST_S_NO_IBAN_A_SALIR_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: EST_S_NO_IBAN_A_SALIR_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<EST_S_NO_IBAN_A_SALIR_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(x"457374c3a173206e6f206962616e20612073616c69722e"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Este es el sonido que me hace LIVRE."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://gfCIFrYjK7qnxKAgAQ4ioUjr1YIIejz3GukVZIPidI0"));
