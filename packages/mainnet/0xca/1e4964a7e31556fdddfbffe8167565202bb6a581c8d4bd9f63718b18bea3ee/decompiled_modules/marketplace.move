module 0xca1e4964a7e31556fdddfbffe8167565202bb6a581c8d4bd9f63718b18bea3ee::marketplace {
    ...
    public fun create_kiosk(arg0: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v6 = KioskCreatedEvent{
            kiosk              : v4,
            personal_kiosk_cap : 0x2::object::id<0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap>(&v5),
            owner              : 0x2::tx_context::sender(arg0),
        };
        0x2::event::emit<KioskCreatedEvent>(v6);
        v4
    }
    ...
    public(friend) fun emit_listing_event(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: address) {
    ...
    public(friend) fun emit_update_event(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: address) {
