module 0xca421c971d2d6e48b77343f875e49a6f7726f1511c2530fd6e4472f088aeed43::datn_dnft {
    struct DNFT has store, key {
        id: 0x2::object::UID,
    ...
    public entry fun mint(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<DNFT>(v0, 0x2::tx_context::sender(arg3));
    }
