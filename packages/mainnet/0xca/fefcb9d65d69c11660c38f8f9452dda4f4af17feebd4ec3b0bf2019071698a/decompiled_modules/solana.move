module 0xcafefcb9d65d69c11660c38f8f9452dda4f4af17feebd4ec3b0bf2019071698a::solana {
    public(friend) fun build_spl_transfer(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: u8, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: u64) : vector<u8> {
        ...
        assert!(0x1::vector::length<u8>(&arg5) == 32, 0);
        assert!(0x1::vector::length<u8>(&arg6) == 32, 0);
        assert!(0x1::vector::length<u8>(&arg7) == 32, 0);
        assert!(0x1::vector::length<u8>(&arg8) == 32, 0);
        ...
        0x1::vector::push_back<vector<u8>>(v4, x"050302060104");
        0x1::vector::push_back<vector<u8>>(v4, x"04000000");
        0x1::vector::push_back<vector<u8>>(v4, x"070600030809050a00");
