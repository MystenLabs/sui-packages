module 0xc83d5406fd355f34d3ce87b35ab2c0b099af9d309ba96c17e40309502a49976f::events {
    ...
    struct VaultDepositUserListUpdatedEvent has copy, drop, store {
        vault_id: 0x2::object::ID,
    ...
    struct VaultFeeExemptListUpdatedEvent has copy, drop, store {
        vault_id: 0x2::object::ID,
    ...
    struct VaultPermanentFeePercentageUpdatedEvent has copy, drop, store {
        vault_id: 0x2::object::ID,
    ...
    struct VaultTimeBasedFeePercentageUpdatedEvent has copy, drop, store {
        vault_id: 0x2::object::ID,
    ...
    struct VaultTimeBasedFeeThresholdUpdatedEvent has copy, drop, store {
        vault_id: 0x2::object::ID,
    ...
    struct WithdrawalFeeChargedEvent has copy, drop, store {
        vault_id: 0x2::object::ID,
        owner: address,
        request_sequence_number: u128,
    ...
    public(friend) fun emit_vault_deposit_user_list_updated_event(arg0: 0x2::object::ID, arg1: vector<address>, arg2: vector<address>, arg3: address, arg4: bool, arg5: u128) {
        let v0 = VaultDepositUserListUpdatedEvent{
            vault_id               : arg0,
            previous_deposit_users : arg1,
            new_deposit_users      : arg2,
            account                : arg3,
            status                 : arg4,
            sequence_number        : arg5,
        };
        0x2::event::emit<VaultDepositUserListUpdatedEvent>(v0);
    }
    ...
    public(friend) fun emit_vault_fee_exempt_list_updated_event(arg0: 0x2::object::ID, arg1: vector<address>, arg2: vector<address>, arg3: address, arg4: bool, arg5: u128) {
        let v0 = VaultFeeExemptListUpdatedEvent{
            vault_id                  : arg0,
            previous_fee_exempt_users : arg1,
            new_fee_exempt_users      : arg2,
            account                   : arg3,
            status                    : arg4,
            sequence_number           : arg5,
        };
        0x2::event::emit<VaultFeeExemptListUpdatedEvent>(v0);
    }
    ...
    public(friend) fun emit_vault_permanent_fee_percentage_updated_event(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u128) {
        let v0 = VaultPermanentFeePercentageUpdatedEvent{
            vault_id                          : arg0,
            previous_permanent_fee_percentage : arg1,
            new_permanent_fee_percentage      : arg2,
            sequence_number                   : arg3,
        };
        0x2::event::emit<VaultPermanentFeePercentageUpdatedEvent>(v0);
    }
    ...
    public(friend) fun emit_vault_time_based_fee_percentage_updated_event(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u128) {
        let v0 = VaultTimeBasedFeePercentageUpdatedEvent{
            vault_id                           : arg0,
            previous_time_based_fee_percentage : arg1,
            new_time_based_fee_percentage      : arg2,
            sequence_number                    : arg3,
        };
        0x2::event::emit<VaultTimeBasedFeePercentageUpdatedEvent>(v0);
    }

    public(friend) fun emit_vault_time_based_fee_threshold_updated_event(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u128) {
        let v0 = VaultTimeBasedFeeThresholdUpdatedEvent{
            vault_id                          : arg0,
            previous_time_based_fee_threshold : arg1,
            new_time_based_fee_threshold      : arg2,
            sequence_number                   : arg3,
        };
        0x2::event::emit<VaultTimeBasedFeeThresholdUpdatedEvent>(v0);
    }
    ...
    public(friend) fun emit_withdrawal_fee_charged_event(arg0: 0x2::object::ID, arg1: address, arg2: u128, arg3: u64, arg4: u64) {
        let v0 = WithdrawalFeeChargedEvent{
            vault_id                : arg0,
            owner                   : arg1,
            request_sequence_number : arg2,
            permanent_fee_charged   : arg3,
            time_based_fee_charged  : arg4,
        };
        0x2::event::emit<WithdrawalFeeChargedEvent>(v0);
    }
