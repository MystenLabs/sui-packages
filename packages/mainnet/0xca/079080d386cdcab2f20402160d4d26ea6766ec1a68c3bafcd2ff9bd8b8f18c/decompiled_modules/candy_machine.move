module 0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::candy_machine {
    ...
    fun create_nft(arg0: &mut CandyMachine, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : (0x2::kiosk::Kiosk, 0x2::kiosk::KioskOwnerCap) {
        let (v0, v1) = 0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::kiosk::new_kiosk(arg2);
        let v2 = v1;
        let v3 = v0;
        ...
        let v7 = 0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::nft::create_nft_with_ipfs(v4, v5, arg0.collection_description, v6, v4, 0x2::tx_context::epoch(arg2), 0x2::object::id<0x2::kiosk::Kiosk>(&v3), 0x2::object::id<0x2::kiosk::KioskOwnerCap>(&v2), arg2);
        let v8 = 0x2::object::id<0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::nft::Nft>(&v7);
        0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::kiosk::place(&mut v3, &v2, v7);
        let v9 = NFTMinted{
            nft_id     : v8,
    ...
    fun init(arg0: CANDY_MACHINE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::nft::Nft>(&v4, v0, v2, arg1);
        0x2::display::update_version<0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::nft::Nft>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::nft::Nft>>(v5, 0x2::tx_context::sender(arg1));
    }
    ...
    public fun mint(arg0: &mut CandyMachine, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < arg2) {
            ...
            0x2::transfer::public_transfer<0x2::kiosk::Kiosk>(v5, v0);
    ...
    public entry fun reveal_and_return_nft(arg0: &mut CandyMachine, arg1: 0x2::kiosk::Kiosk, arg2: 0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = *0x2::table::borrow<0x2::object::ID, address>(&arg0.original_owners, arg3);
        assert!(0x1::vector::length<0x1::string::String>(&arg4) == 0x1::vector::length<0x1::string::String>(&arg5), 8);
        let v1 = 0x2::kiosk::take<0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::nft::Nft>(&mut arg1, &arg2, arg3);
        let v2 = 0x1::string::utf8(b"");
        0x1::string::append(&mut v2, arg6);
        let v3 = 0x1::vector::empty<0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::nft::Attribute>();
        let v4 = 0;
        while (v4 < 0x1::vector::length<0x1::string::String>(&arg4)) {
            0x1::vector::push_back<0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::nft::Attribute>(&mut v3, 0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::nft::create_attribute(*0x1::vector::borrow<0x1::string::String>(&arg4, v4), *0x1::vector::borrow<0x1::string::String>(&arg5, v4)));
            v4 = v4 + 1;
        };
        0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::nft::update_metadata(&mut v1, v2, v3);
        0x2::kiosk::place<0xca079080d386cdcab2f20402160d4d26ea6766ec1a68c3bafcd2ff9bd8b8f18c::nft::Nft>(&mut arg1, &arg2, v1);
        0x2::transfer::public_transfer<0x2::kiosk::Kiosk>(arg1, v0);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(arg2, v0);
    }

    public entry fun send_nft_and_cap_for_reveal(arg0: &mut CandyMachine, arg1: 0x2::kiosk::Kiosk, arg2: 0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.phase == 4, 2);
        ...
        0x2::transfer::public_transfer<0x2::kiosk::Kiosk>(arg1, arg0.authority);
