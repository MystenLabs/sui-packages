module 0xcaa3733733c79adc0cce0cb659f0c31150dc8e0781c4e67d6c29fe283cd17ca3::my_token {
    ...
    fun init(arg0: MY_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MY_TOKEN>(arg0, 9, b"MYT", b"MyToken", b"My first Sui token", 0x1::option::none<0x2::url::Url>(), arg1);
