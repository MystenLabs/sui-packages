module 0x89aa41b05b34bbc83bf9d0763e2fe7edde09d0d0f949ef0ca56481f35ae7c224::harvest {
    ...
    public fun complete_harvest<T0>(arg0: &mut 0xb24972538853dcc7ad36068fd4e8e20277a9e79ea08cad8477a6f46f4c848478::vault::Vault<T0>, arg1: &mut HarvestConfig, arg2: &0x89aa41b05b34bbc83bf9d0763e2fe7edde09d0d0f949ef0ca56481f35ae7c224::strategy::StrategyRegistry, arg3: HarvestPromise<T0>, arg4: 0x2::coin::Coin<T0>, arg5: vector<u8>, arg6: vector<u8>, arg7: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::object::id<0xb24972538853dcc7ad36068fd4e8e20277a9e79ea08cad8477a6f46f4c848478::vault::Vault<T0>>(arg0) == v0, 702);
        ...
        0x2::bcs::peel_u64(&mut v4);
        0x2::bcs::peel_u64(&mut v4);
        let v6 = 0x2::object::id<0xb24972538853dcc7ad36068fd4e8e20277a9e79ea08cad8477a6f46f4c848478::vault::Vault<T0>>(arg0);
        ...
        assert!(v8 > 0, 703);
        let v9 = 0xb24972538853dcc7ad36068fd4e8e20277a9e79ea08cad8477a6f46f4c848478::vault::performance_fee_bps<T0>(arg0);
        let v10 = 0;
        if (v9 > 0) {
            let v11 = v8 * v9 / 10000;
            v10 = v11;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg4, v11, arg9), 0xb24972538853dcc7ad36068fd4e8e20277a9e79ea08cad8477a6f46f4c848478::vault::fee_recipient<T0>(arg0));
        };
        0xb24972538853dcc7ad36068fd4e8e20277a9e79ea08cad8477a6f46f4c848478::vault::deposit_balance_to_idle<T0>(arg0, 0x89aa41b05b34bbc83bf9d0763e2fe7edde09d0d0f949ef0ca56481f35ae7c224::strategy::borrow_protocol_access_cap(arg2), 0x2::coin::into_balance<T0>(arg4));
    ...
    public fun issue_harvest_promise<T0, T1>(arg0: &0xb24972538853dcc7ad36068fd4e8e20277a9e79ea08cad8477a6f46f4c848478::vault::Vault<T0>, arg1: &HarvestConfig, arg2: &0xb24972538853dcc7ad36068fd4e8e20277a9e79ea08cad8477a6f46f4c848478::vault::ProtocolAccessCap, arg3: u8, arg4: u64, arg5: &0x2::clock::Clock) : HarvestPromise<T0> {
        let (v0, _) = should_harvest(arg1, arg3, arg5);
        assert!(v0, 700);
        HarvestPromise<T0>{
            vault_id        : 0x2::object::id<0xb24972538853dcc7ad36068fd4e8e20277a9e79ea08cad8477a6f46f4c848478::vault::Vault<T0>>(arg0),
            strategy_id     : arg3,
    ...
    public fun issue_harvest_promise_direct<T0, T1>(arg0: &0xb24972538853dcc7ad36068fd4e8e20277a9e79ea08cad8477a6f46f4c848478::vault::Vault<T0>, arg1: &HarvestConfig, arg2: &0x89aa41b05b34bbc83bf9d0763e2fe7edde09d0d0f949ef0ca56481f35ae7c224::strategy::StrategyRegistry, arg3: u8, arg4: u64, arg5: &0x2::clock::Clock) : HarvestPromise<T0> {
        issue_harvest_promise<T0, T1>(arg0, arg1, 0x89aa41b05b34bbc83bf9d0763e2fe7edde09d0d0f949ef0ca56481f35ae7c224::strategy::borrow_protocol_access_cap(arg2), arg3, arg4, arg5)
    }
    ...
    public(friend) fun set_harvest_slippage_bps(arg0: &mut HarvestConfig, arg1: u64) {
        0xb24972538853dcc7ad36068fd4e8e20277a9e79ea08cad8477a6f46f4c848478::floors::assert_slippage(arg1, false);
