module 0x89da4d38af691c550ef55b2491453ec8241e6721108bb1b5dd1330f602d188e7::internal_rewards {
    ...
    public entry fun distribute_sui_rewards_by_admin(arg0: &0x89da4d38af691c550ef55b2491453ec8241e6721108bb1b5dd1330f602d188e7::admin::AdminCap, arg1: &mut InternalSuiVault, arg2: &RewardProportions, arg3: &RewardDestinations, arg4: &mut 0x89da4d38af691c550ef55b2491453ec8241e6721108bb1b5dd1330f602d188e7::staking_pool_rewards::RewardPool<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        distribute_sui_rewards_internal(arg1, arg2, arg3, arg4, arg5);
    }

    public entry fun distribute_sui_rewards_by_keeper(arg0: &0x89da4d38af691c550ef55b2491453ec8241e6721108bb1b5dd1330f602d188e7::admin::KeeperRegistry, arg1: &mut InternalSuiVault, arg2: &RewardProportions, arg3: &RewardDestinations, arg4: &mut 0x89da4d38af691c550ef55b2491453ec8241e6721108bb1b5dd1330f602d188e7::staking_pool_rewards::RewardPool<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        0x89da4d38af691c550ef55b2491453ec8241e6721108bb1b5dd1330f602d188e7::admin::assert_keeper(arg0, arg5);
        distribute_sui_rewards_internal(arg1, arg2, arg3, arg4, arg5);
    }

    fun distribute_sui_rewards_internal(arg0: &mut InternalSuiVault, arg1: &RewardProportions, arg2: &RewardDestinations, arg3: &mut 0x89da4d38af691c550ef55b2491453ec8241e6721108bb1b5dd1330f602d188e7::staking_pool_rewards::RewardPool<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 > 0) {
            0x89da4d38af691c550ef55b2491453ec8241e6721108bb1b5dd1330f602d188e7::staking_pool_rewards::deposit_reward_funds<0x2::sui::SUI>(arg3, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.balance, v2), arg4), arg4);
        };
        if (v3 > 0) {
    ...
    public fun emergency_withdraw_sui(arg0: &0x89da4d38af691c550ef55b2491453ec8241e6721108bb1b5dd1330f602d188e7::admin::AdminCap, arg1: &mut InternalSuiVault, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update_destinations(arg0: &0x89da4d38af691c550ef55b2491453ec8241e6721108bb1b5dd1330f602d188e7::admin::AdminCap, arg1: &mut RewardDestinations, arg2: address, arg3: address, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update_proportions(arg0: &0x89da4d38af691c550ef55b2491453ec8241e6721108bb1b5dd1330f602d188e7::admin::AdminCap, arg1: &mut RewardProportions, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
