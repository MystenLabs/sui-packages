module 0x8949896b63000021430ab5c73e10f39a3d7c9935cd826d053f4e1ecf7328996c::reward2141 {
    struct REWARD2141 has drop {
        dummy_field: bool,
    }

    struct TICKET_2141 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2141(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2141>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2141>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2141, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2141>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2141>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2141>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2141>>(v5, 0x2::tx_context::sender(arg1));
    }
