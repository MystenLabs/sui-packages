module 0x896590b02a9914cceaae7ebcfe0d80805bd88211a8c5830b4d6f5f593e7f25ef::house {
    ...
    public(friend) fun deposit<T0>(arg0: &mut House<T0>, arg1: 0x2::balance::Balance<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<StakedHouseCoin<T0>> {
        ...
        assert!(v0 + 0x2::balance::value<T0>(&arg0.pool) <= arg0.max_supply, 4);
    ...
    public(friend) fun join_with_fee<T0>(arg0: &mut House<T0>, arg1: 0x2::balance::Balance<T0>) {
        let v0 = 0x896590b02a9914cceaae7ebcfe0d80805bd88211a8c5830b4d6f5f593e7f25ef::math::mul_rate(0x2::balance::value<T0>(&arg1), 300000);
    ...
    public fun pool_changes(arg0: u64) : (u64, u64) {
        let v0 = 0x896590b02a9914cceaae7ebcfe0d80805bd88211a8c5830b4d6f5f593e7f25ef::math::mul_rate(arg0, 300000);
        (arg0 - v0, v0)
    }
    ...
    public(friend) fun split_with_reimbursement<T0>(arg0: &mut House<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(arg1 <= max_risk<T0>(arg0), 0);
        let v0 = 0x896590b02a9914cceaae7ebcfe0d80805bd88211a8c5830b4d6f5f593e7f25ef::math::mul_rate(arg1, 300000);
