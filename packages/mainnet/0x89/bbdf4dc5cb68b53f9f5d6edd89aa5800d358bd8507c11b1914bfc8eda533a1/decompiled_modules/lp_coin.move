module 0x89bbdf4dc5cb68b53f9f5d6edd89aa5800d358bd8507c11b1914bfc8eda533a1::lp_coin {
    ...
    fun init(arg0: LP_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<LP_COIN>(&mut v2, 900000000000000000, 0x2::tx_context::sender(arg1), arg1);
