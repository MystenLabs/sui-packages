module 0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::rip_station {
    ...
    entry fun burn_cards(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: 0x1::string::String, arg3: vector<0x2::object::ID>, arg4: u64, arg5: vector<u8>, arg6: &0x2::tx_context::TxContext) {
        ...
        while (v3 < 0x1::vector::length<0x2::object::ID>(&arg3)) {
            ...
            assert!(0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::vault::card_type(v2) == 0x1::type_name::with_defining_ids<0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::Card>(), 14);
            0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::burn_card(0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::vault::remove_by_id<0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::Card>(v2, v4), false);
    ...
    entry fun buy_packs_with_personal_kiosk(arg0: &0x2::random::Random, arg1: &mut Store, arg2: 0x1::string::String, arg3: u64, arg4: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg7: &mut 0x2::tx_context::TxContext) : vector<0x2::object::ID> {
        ...
        while (arg3 > 0) {
            ...
            while (v5 < v1.pack_size) {
                assert!(0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::vault::card_type(v0) == 0x1::type_name::with_defining_ids<0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::Card>(), 14);
                let v6 = 0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::vault::remove_by_index<0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::Card>(v0, 0x2::random::generate_u64_in_range(v3, 0, 0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::vault::length(v0) - 1));
                0x1::vector::push_back<0x2::object::ID>(&mut v4, 0x2::object::id<0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::Card>(&v6));
    ...
    entry fun deposit_card_for_reveal<T0: store + key>(arg0: &Store, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 == 0x1::type_name::with_defining_ids<0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::Card>(), 14);
    ...
    entry fun init_card_type<T0: store + key>(arg0: &mut Store, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == 0x1::type_name::with_defining_ids<0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::Card>(), 14);
    ...
    entry fun mint_cards(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: vector<0x1::string::String>, arg3: vector<vector<u8>>, arg4: 0x1::string::String, arg5: u64, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        while (v5 < v4) {
            assert!(0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::vault::card_type(v2) == 0x1::type_name::with_defining_ids<0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::Card>(), 14);
            let v6 = 0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::mint_card(v3.placeholder_name, v3.placeholder_description, v3.placeholder_media_url, 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>(), *0x1::vector::borrow<vector<u8>>(&arg3, v5), false, arg7);
            0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::vault::add<0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::Card>(v2, v6);
            let v7 = CardMintedEvent{
                id         : *0x1::vector::borrow<0x1::string::String>(&arg2, v5),
                card_id    : 0x2::object::id<0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::Card>(&v6),
                vault_name : arg4,
            };
    ...
    public fun redeem_card<T0: store + key>(arg0: &Store, arg1: &mut RedeemCardsRequest, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 == 0x1::type_name::with_defining_ids<0x89db294c9440a3bb12ec1ed543f158e3796d44699267a051b3c667f6c79c5ec9::tcg::Card>(), 14);
