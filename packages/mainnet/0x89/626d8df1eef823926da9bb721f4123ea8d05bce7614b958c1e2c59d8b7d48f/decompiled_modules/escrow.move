module 0x89626d8df1eef823926da9bb721f4123ea8d05bce7614b958c1e2c59d8b7d48f::escrow {
    ...
    public fun accept_offer<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg6: &mut 0x89626d8df1eef823926da9bb721f4123ea8d05bce7614b958c1e2c59d8b7d48f::marketplace::MarketPlace, arg7: &mut 0x2::tx_context::TxContext) : (OfferWrapper<T0>, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        let v4 = v2.price;
        0x89626d8df1eef823926da9bb721f4123ea8d05bce7614b958c1e2c59d8b7d48f::marketplace::add_balance(arg6, 0x2::coin::take<0x2::sui::SUI>(&mut v2.balance, v2.market_fee, arg7));
    ...
    fun new_offer<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: u64, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::transfer_policy::TransferPolicy<T0>, arg6: &0x89626d8df1eef823926da9bb721f4123ea8d05bce7614b958c1e2c59d8b7d48f::marketplace::MarketPlace, arg7: &mut 0x2::tx_context::TxContext) : (Offer<T0>, OfferCap<T0>) {
        assert!(0x2::kiosk::has_access(arg0, arg1), 100);
        let v0 = (((0x89626d8df1eef823926da9bb721f4123ea8d05bce7614b958c1e2c59d8b7d48f::marketplace::get_fee(arg6, 0x2::tx_context::sender(arg7)) as u128) * (arg3 as u128) / 10000) as u64);
        let v1 = 0;
    ...
    public fun offer<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: u64, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::transfer_policy::TransferPolicy<T0>, arg6: &mut 0x89626d8df1eef823926da9bb721f4123ea8d05bce7614b958c1e2c59d8b7d48f::marketplace::MarketPlace, arg7: &mut 0x2::tx_context::TxContext) {
