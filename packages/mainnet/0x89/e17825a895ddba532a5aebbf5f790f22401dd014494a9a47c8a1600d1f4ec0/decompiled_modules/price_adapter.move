module 0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::price_adapter {
    ...
    fun overwrite_price(arg0: AssertVersion, arg1: &mut PriceAdapter, arg2: vector<u8>, arg3: u256, arg4: u64, arg5: u64) {
        ...
        assert!(arg4 > 0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::price_data::timestamp(v0), 1);
    ...
    public fun write_price(arg0: &mut PriceAdapter, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) : u256 {
        ...
        if (0x1::option::is_some<u64>(&v2)) {
            0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_update_check::assert_update_time(&arg0.config, 0x1::option::destroy_some<u64>(v2), v0, 0x2::tx_context::sender(arg4));
        } else {
    ...
    fun write_price_checked(arg0: AssertVersion, arg1: &mut PriceAdapter, arg2: vector<u8>, arg3: vector<u8>, arg4: u64) : u256 {
        let (v0, v1) = 0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_payload::process_payload(&arg1.config, arg4, arg2, arg3);
