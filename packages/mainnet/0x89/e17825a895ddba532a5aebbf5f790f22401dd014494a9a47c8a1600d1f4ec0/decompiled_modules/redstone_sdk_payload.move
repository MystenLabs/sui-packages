module 0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_payload {
    ...
    fun parse_raw_payload(arg0: vector<u8>) : Payload {
        0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_validate::verify_redstone_marker(&arg0);
        let v0 = &mut arg0;
    ...
    public fun process_payload(arg0: &0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_config::Config, arg1: u64, arg2: vector<u8>, arg3: vector<u8>) : (u256, u64) {
        ...
        0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_validate::verify_data_packages(&v2, arg0, arg1);
        let v3 = vector[];
        ...
        while (v5 < 0x1::vector::length<vector<u8>>(&v4)) {
            ...
            0x1::vector::push_back<u256>(&mut v3, 0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_conv::from_bytes_to_u256(&v6));
            v5 = v5 + 1;
        };
        0x1::vector::destroy_empty<vector<u8>>(v4);
        (0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_median::calculate_median(&mut v3), 0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_data_package::timestamp(0x1::vector::borrow<0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_data_package::DataPackage>(&v2, 0)))
    }

    fun trim_data_package(arg0: &mut vector<u8>) : 0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_data_package::DataPackage {
        ...
        0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_data_package::new_data_package(0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_crypto::recover_address(&v6, &v0), v4, trim_data_points(arg0, v2, v3))
    }

    fun trim_data_packages(arg0: &mut vector<u8>, arg1: u64) : vector<0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_data_package::DataPackage> {
        let v0 = 0x1::vector::empty<0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_data_package::DataPackage>();
        let v1 = 0;
        while (v1 < arg1) {
            0x1::vector::push_back<0x89e17825a895ddba532a5aebbf5f790f22401dd014494a9a47c8a1600d1f4ec0::redstone_sdk_data_package::DataPackage>(&mut v0, trim_data_package(arg0));
            v1 = v1 + 1;
        };
        v0
    }
