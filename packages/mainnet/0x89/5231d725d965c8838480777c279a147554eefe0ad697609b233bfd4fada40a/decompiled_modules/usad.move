module 0x895231d725d965c8838480777c279a147554eefe0ad697609b233bfd4fada40a::usad {
    struct USAD has drop {
        dummy_field: bool,
    }

    fun init(arg0: USAD, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://arweave.net/BFNdhJaV1cbZumY3CONR1n002Q9iy4ECv_aCVnp3Ixw";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/BFNdhJaV1cbZumY3CONR1n002Q9iy4ECv_aCVnp3Ixw"))
        };
