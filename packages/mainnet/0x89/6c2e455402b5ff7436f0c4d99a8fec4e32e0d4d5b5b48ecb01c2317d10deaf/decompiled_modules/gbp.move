module 0x896c2e455402b5ff7436f0c4d99a8fec4e32e0d4d5b5b48ecb01c2317d10deaf::gbp {
    struct GBP has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: GBP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://gateway.irys.xyz/p6d_Oci0Nb6PU6Gf3g7eNxDDSjTQ70vmfaZuW69UzLA                                                                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<GBP>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"GBP     ")))), trim_right(b"gbp                             "), trim_right(b"Pound (English: Pound) is the name of the national currency and monetary unit of the United Kingdom. Pound is mainly issued by the Bank of England, but there are also other issuing institutions.                                                                                                                              "), v2, arg1);
