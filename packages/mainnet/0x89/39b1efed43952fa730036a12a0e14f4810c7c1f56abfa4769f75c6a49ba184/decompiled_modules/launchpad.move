module 0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::launchpad {
    ...
    public entry fun admin_create_collection<T0: drop + store>(arg0: &mut LaunchpadStore, arg1: &0x2::package::Publisher, arg2: address, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: u64, arg8: u64, arg9: u16, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg11) == @0x37cd8b339e4fdf180b421b579d53786f62a1a4d878067d471d4ff43fdc0b570e, 1);
        let v0 = 0x2::tx_context::sender(arg11);
        let v1 = CreateCollectionData{
            store                : 0x2::object::id_bytes<LaunchpadStore>(arg0),
            collection_publisher : 0x2::object::id_bytes<0x2::package::Publisher>(arg1),
            creator              : arg2,
            id                   : arg3,
            name                 : arg4,
            description          : arg5,
        ...
        create_collection_internal<T0>(arg0, arg1, &v1, arg11);
    }
    ...
    public entry fun admin_mint_token<T0: drop + store>(arg0: &mut LaunchpadStore, arg1: &mut 0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::NftCap<T0>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: vector<0x1::string::String>, arg9: vector<0x1::string::String>, arg10: &mut 0x2::tx_context::TxContext) {
    ...
    fun create_collection_internal<T0: drop + store>(arg0: &mut LaunchpadStore, arg1: &0x2::package::Publisher, arg2: &CreateCollectionData, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!0x2::dynamic_object_field::exists_<0x1::string::String>(&arg0.id, get_dynamic_field_key(b"Collection", arg2.id)), 3);
        let (v0, v1, v2, v3) = 0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::register_nft_type<T0>(arg1, arg2.max_supply, arg2.royalty_numerator, arg2.min_amount, arg3);
        let v4 = v2;
        let v5 = v1;
        let v6 = v0;
        let v7 = Collection{
            id                   : 0x2::object::new(arg3),
            collection_id        : arg2.id,
            name                 : arg2.name,
            creator              : arg2.creator,
            address              : 0x2::object::id_address<0x2::transfer_policy::TransferPolicy<0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::Nft<T0>>>(&v4),
            autoreserve_interval : arg2.autoreserve_interval,
            max_supply           : arg2.max_supply,
            minted               : 0,
            autoreserve_minted   : 0,
        };
        0x2::dynamic_object_field::add<0x1::string::String, Collection>(&mut arg0.id, get_dynamic_field_key(b"Collection", arg2.id), v7);
        let v8 = CreateCollectionEvent{
            id         : arg2.id,
            creator    : 0x2::tx_context::sender(arg3),
            address    : 0x2::object::id_address<Collection>(&v7),
            name       : arg2.name,
            nft_cap_id : 0x2::object::id_address<0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::NftCap<T0>>(&v6),
            display_id : 0x2::object::id_address<0x2::display::Display<0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::Nft<T0>>>(&v5),
        };
        0x2::event::emit<CreateCollectionEvent>(v8);
        0x2::transfer::public_transfer<0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::NftCap<T0>>(v6, @0x862cbc9f1a76b0df55b4dcb4fbc170fc91ecdddaa0072941d4db6be1a2e5e5a9);
        0x2::transfer::public_transfer<0x2::display::Display<0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::Nft<T0>>>(v5, arg2.creator);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::Nft<T0>>>(v4);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::Nft<T0>>>(v3, arg2.creator);
    }
    ...
    public entry fun create_mint_token_order(arg0: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut LaunchpadStore, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: u64, arg9: u64, arg10: u64, arg11: bool, arg12: vector<u8>, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::signature::verify_signature<CreateMintTokenOrderData>(&v1, arg12, arg1.public_key);
    ...
    fun mint_one_token<T0: drop + store>(arg0: &mut 0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::NftCap<T0>, arg1: address, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: vector<0x1::string::String>, arg6: vector<0x1::string::String>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : address {
        let v0 = 0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::mint<T0>(arg0, arg2, arg3, arg4, arg5, arg6, 0x1::option::none<T0>(), 0x1::option::some<address>(arg1), 0x1::vector::empty<vector<u8>>(), arg7, arg8);
        0x2::object::id_to_address(&v0)
    }

    fun mint_token_internal<T0: drop + store>(arg0: &mut LaunchpadStore, arg1: &mut 0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::NftCap<T0>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: address, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: &mut 0x2::tx_context::TxContext) {
        let v0 = @0x0;
    ...
    public entry fun update_token<T0: drop + store>(arg0: &mut LaunchpadStore, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::Nft<T0>, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: vector<0x1::string::String>, arg9: vector<0x1::string::String>, arg10: vector<u8>, arg11: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg11);
        let v1 = UpdateTokenData{
            ...
            stage_id        : arg2,
            order_id        : arg3,
            token           : 0x2::object::id_bytes<0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::Nft<T0>>(arg4),
            name            : arg5,
            description     : arg6,
            image_url       : arg7,
            property_keys   : arg8,
        ...
        0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::signature::verify_signature<UpdateTokenData>(&v1, arg10, arg0.public_key);
        update_token_internal<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg11);
    }

    fun update_token_internal<T0: drop + store>(arg0: &mut LaunchpadStore, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::Nft<T0>, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: vector<0x1::string::String>, arg9: vector<0x1::string::String>, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = get_mint_token_order(arg0, arg1, arg2, arg3);
        assert!(v0.allow_update, 1);
        0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::update<T0>(0x1::option::destroy_some<0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::UpdateNftCap<T0>>(0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::create_update_ntf_cap<T0>(0x2::object::id<0x8939b1efed43952fa730036a12a0e14f4810c7c1f56abfa4769f75c6a49ba184::nft::Nft<T0>>(arg4), arg10)), arg4, arg5, arg6, arg7, arg8, arg9);
