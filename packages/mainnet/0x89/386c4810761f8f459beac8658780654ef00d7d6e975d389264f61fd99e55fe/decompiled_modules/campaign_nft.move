module 0x89386c4810761f8f459beac8658780654ef00d7d6e975d389264f61fd99e55fe::campaign_nft {
    ...
    fun setup_nft_display(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) : 0x2::display::Display<CampaignNFT> {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://assets.thebirds.ai/nfts/birds/quest-hub/seafi/{gen_id}-thumbnail.jpg"));
