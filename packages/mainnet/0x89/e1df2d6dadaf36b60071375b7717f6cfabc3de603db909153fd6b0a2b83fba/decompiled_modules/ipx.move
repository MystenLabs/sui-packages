module 0x89e1df2d6dadaf36b60071375b7717f6cfabc3de603db909153fd6b0a2b83fba::ipx {
    struct IPX has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IPX, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<IPX>(arg0, 9, b"IPX", b"Interest Protocol Token", b"The governance token of Interest Protocol", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://interestprotocol.infura-ipfs.io/ipfs/QmXCQHziDxHP3b4tvoYLUs5h6RyaX1z5zNP9zdYNRjjxsP")), arg1);
        let v2 = 0x2::coin::treasury_into_supply<IPX>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<IPX>>(0x2::coin::from_balance<IPX>(0x2::balance::increase_supply<IPX>(&mut v2, 600000000000000000), arg1), 0x2::tx_context::sender(arg1));
