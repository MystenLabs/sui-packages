module 0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config {
    ...
    public entry fun get_fee_info<T0>(arg0: &Config) : (u64, u64) {
        if (0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::curves::is_stable<T0>()) {
            return (arg0.stable_pool_fee.total_fee_bps, arg0.stable_pool_fee.hive_fee_percent)
        };
        if (0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::curves::is_weighted<T0>()) {
            return (arg0.weighted_pool_fee.total_fee_bps, arg0.weighted_pool_fee.hive_fee_percent)
        };
        if (0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::curves::is_curved<T0>()) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = Treasury<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>{
            id      : 0x2::object::new(arg0),
            balance : 0x2::balance::zero<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>(),
        };
        0x2::transfer::share_object<Treasury<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>>(v11);
    }
    ...
    public fun update_default_fee_for_curve<T0>(arg0: &mut Config, arg1: &HiveDaoCapability, arg2: u64, arg3: u64) {
        0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::curves::assert_valid_curve<T0>();
        if (0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::curves::is_stable<T0>()) {
            let v0 = &mut arg0.stable_pool_fee;
            update_fee(v0, arg2, arg3);
        } else if (0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::curves::is_weighted<T0>()) {
            let v1 = &mut arg0.weighted_pool_fee;
            update_fee(v1, arg2, arg3);
        } else if (0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::curves::is_curved<T0>()) {
