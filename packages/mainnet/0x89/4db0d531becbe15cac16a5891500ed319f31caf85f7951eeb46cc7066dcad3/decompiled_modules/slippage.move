module 0x88dfe5e893bc9fa984d121e4d0d5b2e873dc70ae430cf5b3228ae6cb199cb32b::slippage {
    ...
    struct TraceEvent has copy, drop {
        trace_id: u64,
    }

    struct TraceUUIDEvent has copy, drop {
        trace_id: 0x1::ascii::String,
    }
    ...
    public fun calculate_max_take(arg0: &SlippageConfig, arg1: u64, arg2: u64) : u64 {
        if (0x1::vector::is_empty<u64>(&arg0.positiveThreshold)) {
            return 0
        };
        let v0 = 0;
    ...
    public fun check_slippage_v2_with_trace<T0, T1>(arg0: &0x2::coin::Coin<T1>, arg1: u64, arg2: u64, arg3: u64, arg4: u64) {
        check_slippage_v2<T0, T1>(arg0, arg1, arg2, arg3);
        let v0 = TraceEvent{trace_id: arg4};
        0x2::event::emit<TraceEvent>(v0);
    }

    public fun check_slippage_v2_with_trace_uuid<T0, T1>(arg0: &0x2::coin::Coin<T1>, arg1: u64, arg2: u64, arg3: u64, arg4: 0x1::ascii::String) {
        check_slippage_v2<T0, T1>(arg0, arg1, arg2, arg3);
        let v0 = TraceUUIDEvent{trace_id: arg4};
        0x2::event::emit<TraceUUIDEvent>(v0);
    }
    ...
    public fun check_slippage_v3_with_trace<T0, T1>(arg0: &mut SlippageConfig, arg1: bool, arg2: &mut 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        check_slippage_v2_with_trace<T0, T1>(arg2, arg3, arg5, arg7, arg8);
        let v0 = 0x2::coin::value<T1>(arg2);
        if (!arg1 || v0 <= arg4) {
            return
        };
        ...
        0x2::balance::join<T1>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.fee, v4), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(arg2, v2, arg9)));
        let v5 = PositiveSlippageEvent<T0, T1>{
            amount_in           : arg5,
            amount_in_value     : arg6,
            amount_out          : v0,
    ...
    public fun check_slippage_v3_with_trace_uuid<T0, T1>(arg0: &mut SlippageConfig, arg1: bool, arg2: &mut 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: 0x1::ascii::String, arg9: &mut 0x2::tx_context::TxContext) {
        check_slippage_v2_with_trace_uuid<T0, T1>(arg2, arg3, arg5, arg7, arg8);
        let v0 = 0x2::coin::value<T1>(arg2);
        if (!arg1 || v0 <= arg4) {
            return
        };
    ...
    public fun init_upgrade(arg0: &0x2::package::UpgradeCap, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(@0xb21adc5e55291e0743adc0f0c878f93823e63079697e321b0f9de1f40523c817 == 0x2::object::id_to_address(&v0), 1);
