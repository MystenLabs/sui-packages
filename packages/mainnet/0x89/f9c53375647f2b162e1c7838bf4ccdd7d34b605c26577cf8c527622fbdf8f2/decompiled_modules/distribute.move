module 0xc8825adac03f04a42ba4900aaff152c8e00b2628e7148a2a9bfed909115a17e5::distribute {
    ...
    public fun deposit<T0: store + key>(arg0: &mut Distributor<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut vector<address>, arg3: &mut vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<T0>(&arg1) == 0xc8825adac03f04a42ba4900aaff152c8e00b2628e7148a2a9bfed909115a17e5::utils::sum(arg3), 4002);
