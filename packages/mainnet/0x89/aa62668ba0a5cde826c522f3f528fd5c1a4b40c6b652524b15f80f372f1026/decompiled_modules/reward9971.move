module 0x89aa62668ba0a5cde826c522f3f528fd5c1a4b40c6b652524b15f80f372f1026::reward9971 {
    struct REWARD9971 has drop {
        dummy_field: bool,
    }

    struct TICKET_9971 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9971(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9971>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9971>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9971, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9971>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9971>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9971>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9971>>(v5, 0x2::tx_context::sender(arg1));
    }
