module 0x34adce5ef86f2af51ac26637f1d7f9ef3f5f7a800d49f2ec6c2452f17091eda9::keychain {
    ...
    public(friend) fun allow_action_for_address<T0: drop>(arg0: &MasterCap, arg1: &mut Keychain, arg2: address, arg3: T0) {
        ...
        0x2::vec_set::insert<0x1::type_name::TypeName>(0x2::vec_map::get_mut<address, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>(&mut arg1.action_allowlist, &arg2), 0x1::type_name::with_defining_ids<T0>());
    }

    public(friend) fun borrow_strategy_cap<T0: store + key>(arg0: &Keychain) : &T0 {
        0x2::object_bag::borrow<0x1::type_name::TypeName, T0>(&arg0.strategy_caps, 0x1::type_name::with_defining_ids<T0>())
    }
    ...
    public(friend) fun borrow_vault_cap<T0>(arg0: &Keychain) : &0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::AdminCap<T0> {
        0x2::object_bag::borrow<0x1::type_name::TypeName, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::AdminCap<T0>>(&arg0.vault_caps, 0x1::type_name::with_defining_ids<T0>())
    }
    ...
    public fun master_borrow_strategy_cap<T0: store + key>(arg0: &MasterCap, arg1: &Keychain) : &T0 {
        0x2::object_bag::borrow<0x1::type_name::TypeName, T0>(&arg1.strategy_caps, 0x1::type_name::with_defining_ids<T0>())
    }
    ...
    public fun master_borrow_vault_cap<T0>(arg0: &MasterCap, arg1: &Keychain) : &0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::AdminCap<T0> {
        0x2::object_bag::borrow<0x1::type_name::TypeName, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::AdminCap<T0>>(&arg1.vault_caps, 0x1::type_name::with_defining_ids<T0>())
    }

    public(friend) fun master_put_strategy_cap<T0: store + key>(arg0: &MasterCap, arg1: &mut Keychain, arg2: T0) {
        0x2::object_bag::add<0x1::type_name::TypeName, T0>(&mut arg1.strategy_caps, 0x1::type_name::with_defining_ids<T0>(), arg2);
    }
    ...
    public fun master_put_vault_cap<T0>(arg0: &MasterCap, arg1: &mut Keychain, arg2: 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::AdminCap<T0>) {
        0x2::object_bag::add<0x1::type_name::TypeName, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::AdminCap<T0>>(&mut arg1.vault_caps, 0x1::type_name::with_defining_ids<T0>(), arg2);
    }

    public fun master_take_strategy_cap<T0: store + key>(arg0: &MasterCap, arg1: &mut Keychain) : T0 {
        0x2::object_bag::remove<0x1::type_name::TypeName, T0>(&mut arg1.strategy_caps, 0x1::type_name::with_defining_ids<T0>())
    }
    ...
    public fun master_take_vault_cap<T0>(arg0: &MasterCap, arg1: &mut Keychain) : 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::AdminCap<T0> {
        0x2::object_bag::remove<0x1::type_name::TypeName, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::AdminCap<T0>>(&mut arg1.vault_caps, 0x1::type_name::with_defining_ids<T0>())
    }
