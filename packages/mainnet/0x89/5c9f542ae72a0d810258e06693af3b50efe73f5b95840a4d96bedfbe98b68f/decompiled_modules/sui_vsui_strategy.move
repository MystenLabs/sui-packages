module 0xc51c99c8a88c829fedc5b63064537180784ca5047303f3cb76dac922aae01b71::sui_vsui_strategy {
    ...
    fun revolving_repay_and_withdraw(arg0: &mut Strategy, arg1: &mut 0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::native_pool::NativePool, arg2: &mut 0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::cert::Metadata<0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::cert::CERT>, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &0x2::clock::Clock, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<0x2::sui::SUI>, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::cert::CERT>, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive::Incentive, arg9: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg10: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg11: 0x2::balance::Balance<0x2::sui::SUI>, arg12: u64, arg13: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        while (0x2::balance::value<0x2::sui::SUI>(&arg11) < v1) {
            let v4 = calculate_required_sui_for_repay(arg0, arg1, arg2, arg5, v1);
            if (0x2::balance::value<0x2::sui::SUI>(&arg11) >= v4) {
                let v5 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_loan_balance(arg5, 0, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::account_owner(&arg0.navi_cap));
                let v6 = 0x2::balance::zero<0x2::sui::SUI>();
                if (0x2::balance::value<0x2::sui::SUI>(&arg11) >= (v5 as u64)) {
                    0x2::balance::join<0x2::sui::SUI>(&mut v6, 0x2::balance::split<0x2::sui::SUI>(&mut arg11, (v5 as u64)));
                } else {
                    0x2::balance::join<0x2::sui::SUI>(&mut v6, 0x2::balance::split<0x2::sui::SUI>(&mut arg11, v4));
                };
                let (v7, v8) = navi_repay_and_withdraw_collateral(arg0, arg4, arg5, arg6, arg7, arg8, arg9, arg10, v6, v2, arg13);
            ...
            if (0x2::balance::value<0x2::sui::SUI>(&arg11) >= (v10 as u64)) {
                0x2::balance::join<0x2::sui::SUI>(&mut v11, 0x2::balance::split<0x2::sui::SUI>(&mut arg11, (v10 as u64)));
            } else {
                0x2::balance::join<0x2::sui::SUI>(&mut v11, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg11));
            };
            ...
            0x2::balance::join<0x2::sui::SUI>(&mut arg11, volo_unstake(arg1, arg2, arg3, v14, arg13));
            0x2::balance::join<0x2::sui::SUI>(&mut arg11, v13);
        };
        let v15 = 0x2::balance::value<0x2::sui::SUI>(&arg11);
        assert!(v15 >= v1, 104);
        add_to_collected_asset<0x2::sui::SUI>(arg0, 0x2::balance::split<0x2::sui::SUI>(&mut arg11, v15 - v1));
        arg11
    }
