module 0x897c99426bdc3a693eb921b98477156dcdaa4f44ae8d3b34a2fad7e5567d4327::anon {
    ...
    fun init(arg0: ANON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<ANON>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Anon      ")))), trim_right(b"Guy Fawkes mask                 "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
