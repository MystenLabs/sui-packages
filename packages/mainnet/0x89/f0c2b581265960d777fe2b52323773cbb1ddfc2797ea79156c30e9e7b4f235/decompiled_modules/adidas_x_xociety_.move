module 0x89f0c2b581265960d777fe2b52323773cbb1ddfc2797ea79156c30e9e7b4f235::adidas_x_xociety_ {
    struct ADIDAS_X_XOCIETY_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ADIDAS_X_XOCIETY_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ADIDAS_X_XOCIETY_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ADIDAS x XOCIETY "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"ADIDAS X XOCIETY NFT is an exclusive digital collectible that unlocks premium in-game content and special ecosystem rewards. Holders can access unique in-game skins in XOCIETY, receive $XO token airdrops, and gain additional benefits linked to the adidas collection. The higher the NFT rarity grade, the more impactful the perk. First-tier holders also receive a limited-edition physical merch drop. ADIDAS X XOCIETY NFT represents the next evolution of GameFi and brand collaboration, offering immersive digital experiences beyond traditional collectibles."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://Gyv9BmEQVkYINC7JHURMVWzjuRZWtCm4iY-B3TLqHTQ"));
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Nft>(&mut v5, &v4, 5000, 0);
