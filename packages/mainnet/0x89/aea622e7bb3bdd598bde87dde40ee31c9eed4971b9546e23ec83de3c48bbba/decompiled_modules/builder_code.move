module 0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::builder_code {
    ...
    public fun claim_all_builder_fees(arg0: &mut BuilderCode, arg1: &0x2::accumulator::AccumulatorRoot, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC> {
        ...
        0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::builder_code_events::emit_builder_fees_claimed(id(arg0), arg0.owner, v0);
    ...
    public(friend) fun create_and_share(arg0: &mut 0x2::object::UID, arg1: u64, arg2: &0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::builder_code_events::emit_builder_code_created(v3, v0, arg1);
        v3
    }
