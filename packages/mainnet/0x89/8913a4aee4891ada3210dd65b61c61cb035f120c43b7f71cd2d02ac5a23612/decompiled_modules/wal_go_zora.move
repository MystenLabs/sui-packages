module 0x898913a4aee4891ada3210dd65b61c61cb035f120c43b7f71cd2d02ac5a23612::wal_go_zora {
    struct WAL_GO_ZORA has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WAL_GO_ZORA, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WAL_GO_ZORA>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Wal.go_zora"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"It's the walrus zoro nft in this how zoro get lost and go anywhere like that power is also with this frostoo walrus"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://CYPltVTFZ9JaV3JLUP6czBz7lWdZnvW45dDxwA1bJRw"));
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Nft>(&mut v5, &v4, 375, 0);
