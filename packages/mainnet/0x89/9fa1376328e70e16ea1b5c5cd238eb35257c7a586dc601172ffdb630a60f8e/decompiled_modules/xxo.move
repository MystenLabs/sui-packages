module 0x899fa1376328e70e16ea1b5c5cd238eb35257c7a586dc601172ffdb630a60f8e::xxo {
    struct XXO has drop {
        dummy_field: bool,
    }

    fun init(arg0: XXO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/uz6bqCOaidN8Htkp5VX6MQ3jVzcnBdOzRBKi1Nmz-hY";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/uz6bqCOaidN8Htkp5VX6MQ3jVzcnBdOzRBKi1Nmz-hY"))
        };
