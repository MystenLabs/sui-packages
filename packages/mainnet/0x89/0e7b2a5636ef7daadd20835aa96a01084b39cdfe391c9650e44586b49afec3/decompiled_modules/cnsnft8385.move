module 0x890e7b2a5636ef7daadd20835aa96a01084b39cdfe391c9650e44586b49afec3::cnsnft8385 {
    struct CNSNFT8385 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8385, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8586"));
        let v4 = 0x2::package::claim<CNSNFT8385>(arg0, arg1);
