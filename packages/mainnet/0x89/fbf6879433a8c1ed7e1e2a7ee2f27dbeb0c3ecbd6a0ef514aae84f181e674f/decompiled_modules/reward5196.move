module 0x89fbf6879433a8c1ed7e1e2a7ee2f27dbeb0c3ecbd6a0ef514aae84f181e674f::reward5196 {
    struct REWARD5196 has drop {
        dummy_field: bool,
    }

    struct TICKET_5196 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5196(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5196>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5196>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5196, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5196>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5196>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5196>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5196>>(v5, 0x2::tx_context::sender(arg1));
    }
