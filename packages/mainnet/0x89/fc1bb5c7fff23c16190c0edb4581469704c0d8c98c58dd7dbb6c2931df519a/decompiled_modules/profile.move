module 0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::profile {
    ...
    public fun create_comment(arg0: &mut 0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::post::Post, arg1: &Profile, arg2: &ProfileOwnerCap, arg3: 0x1::string::String, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert_profile_owner(arg1, arg2);
        let (v0, v1) = 0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::post::create_comment(arg0, 0x2::object::id<Profile>(arg1), arg3, arg4, arg5, arg6);
        0x2::transfer::public_transfer<0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::post::PostOwnerCap>(v1, 0x2::tx_context::sender(arg6));
        0x2::transfer::public_share_object<0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::post::Post>(v0);
    }
    ...
    public fun create_post(arg0: &mut Profile, arg1: &ProfileOwnerCap, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let (v0, v1) = 0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::post::create_post(0x2::object::id<Profile>(arg0), arg2, arg3, arg4, arg5, arg6);
        let v2 = v0;
        let v3 = 0x2::object::id<0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::post::Post>(&v2);
        ...
        0x2::transfer::public_transfer<0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::post::PostOwnerCap>(v1, 0x2::tx_context::sender(arg6));
        0x2::transfer::public_share_object<0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::post::Post>(v2);
        v3
    }

    public entry fun like_post(arg0: &mut 0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::post::Post, arg1: &Profile, arg2: &ProfileOwnerCap, arg3: &mut 0x2::tx_context::TxContext) {
        assert_profile_owner(arg1, arg2);
        0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::post::like_post(arg0, 0x2::object::id<Profile>(arg1));
    }

    public entry fun unlike_post(arg0: &mut 0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::post::Post, arg1: &Profile, arg2: &ProfileOwnerCap, arg3: &mut 0x2::tx_context::TxContext) {
        assert_profile_owner(arg1, arg2);
        0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::post::unlike_post(arg0, 0x2::object::id<Profile>(arg1));
    }

    public fun assert_profile_id_owner(arg0: 0x2::object::ID, arg1: &ProfileOwnerCap) {
        assert!(arg0 == arg1.profile, 0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::error::not_owner());
    }

    public fun assert_profile_owner(arg0: &Profile, arg1: &ProfileOwnerCap) {
        assert!(0x2::object::id<Profile>(arg0) == arg1.profile, 0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::error::not_owner());
    }
    ...
    fun parse_and_verifiy_profile_name(arg0: 0x1::string::String) : 0x1::string::String {
        ...
        let v3 = &mut v2;
        assert!(0x1::ascii::all_characters_printable(&v0), 0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::error::unexpected_char_in_profile_name());
        assert!(v1 >= 5, 0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::error::profile_name_too_short());
        let v4 = 0;
        while (v4 < v1) {
            ...
            if (*v5 >= 65 && *v5 <= 90) {
                *v5 = *v5 + 32;
                ...
                let v6 = *v5;
                assert!(v6 >= 97 && v6 <= 122 || v6 >= 48 && v6 <= 57 || v6 == 32 || v6 == 45 || v6 == 95, 0x89fc1bb5c7fff23c16190c0edb4581469704c0d8c98c58dd7dbb6c2931df519a::error::unexpected_char_in_profile_name());
            };
            v4 = v4 + 1;
        };
