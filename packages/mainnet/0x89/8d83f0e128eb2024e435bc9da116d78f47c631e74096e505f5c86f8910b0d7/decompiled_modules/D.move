module 0x898d83f0e128eb2024e435bc9da116d78f47c631e74096e505f5c86f8910b0d7::D {
    struct D has drop {
        dummy_field: bool,
    }
    ...
    struct Registry has key {
        id: 0x2::object::UID,
        treasury: 0x2::coin::TreasuryCap<D>,
        fee_pool: 0x2::balance::Balance<D>,
        sp_pool: 0x2::balance::Balance<D>,
    ...
    struct SPDonated has copy, drop {
        donor: address,
        amount: u64,
    }
    ...
    public fun close_trove(arg0: &mut Registry, arg1: 0x2::coin::Coin<D>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x2::table::contains<address, Trove>(&arg0.troves, v0), 2);
        let Trove {
            collateral : v1,
        ...
        if (v2 > 0) {
            assert!(0x2::coin::value<D>(&arg1) >= v2, 6);
            0x2::coin::burn<D>(&mut arg0.treasury, 0x2::coin::split<D>(&mut arg1, v2, arg2));
        };
        if (0x2::coin::value<D>(&arg1) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<D>>(arg1, v0);
        } else {
            0x2::coin::destroy_zero<D>(arg1);
        };
    ...
    public fun close_trove_entry(arg0: &mut Registry, arg1: 0x2::coin::Coin<D>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun donate_to_reserve(arg0: &mut Registry, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg1);
        assert!(v0 > 0, 6);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.reserve_coll, 0x2::coin::into_balance<0x2::sui::SUI>(arg1));
    ...
    public fun donate_to_sp(arg0: &mut Registry, arg1: 0x2::coin::Coin<D>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<D>(&arg1);
        assert!(v0 > 0, 6);
        0x2::balance::join<D>(&mut arg0.sp_pool, 0x2::coin::into_balance<D>(arg1));
        let v1 = SPDonated{
            donor  : 0x2::tx_context::sender(arg2),
            amount : v0,
        };
        0x2::event::emit<SPDonated>(v1);
    }

    fun init(arg0: D, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin_registry::new_currency_with_otw<D>(arg0, 8, 0x1::string::utf8(b"D"), 0x1::string::utf8(b"1"), 0x1::string::utf8(b"Immutable CDP-backed stablecoin on Sui (SUI-collateralized)"), 0x1::string::utf8(b""), arg1);
        0x2::coin_registry::finalize_and_delete_metadata_cap<D>(v0, arg1);
        let v2 = Registry{
            id                : 0x2::object::new(arg1),
            treasury          : v1,
            fee_pool          : 0x2::balance::zero<D>(),
            sp_pool           : 0x2::balance::zero<D>(),
    ...
    public fun liquidate(arg0: &mut Registry, arg1: address, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v4 = 0x2::balance::value<D>(&arg0.sp_pool);
        assert!(v4 > v2, 9);
        let v5 = arg0.total_sp;
        let v6 = arg0.product_factor * ((v4 - v2) as u128) / (v4 as u128);
        assert!(v5 == 0 || v6 >= 1000000000, 14);
        let v7 = (((v5 as u128) * ((v4 - v2) as u128) / (v4 as u128)) as u64);
        assert!(v5 == 0 || v7 > 0, 14);
        let v8 = (v2 as u128) * (1000 as u128) / 10000;
        let v9 = ((v2 as u128) + v8) * 1000000000 / v0;
        let v10 = (v3 as u128);
        let v11 = if (v9 > v10) {
            v10
        } else {
        ...
        let v12 = (v11 as u64);
        let v13 = v8 * (2500 as u128) / 10000 * 1000000000 / v0;
        let v14 = (v12 as u128);
        let v15 = if (v13 > v14) {
            v14
        } else {
        ...
        let v16 = (v15 as u64);
        let v17 = v14 - (v16 as u128);
        let v18 = v8 * (2500 as u128) / 10000 * 1000000000 / v0;
        let v19 = if (v18 > v17) {
            v17
        } else {
            v18
        ...
        arg0.total_debt = arg0.total_debt - v2;
        0x2::coin::burn<D>(&mut arg0.treasury, 0x2::coin::from_balance<D>(0x2::balance::split<D>(&mut arg0.sp_pool, v2), arg4));
        if (v5 > 0) {
            arg0.reward_index_coll = arg0.reward_index_coll + (v21 as u128) * arg0.product_factor / (v5 as u128);
        };
        arg0.product_factor = v6;
        arg0.total_sp = v7;
        let v23 = 0x2::balance::split<0x2::sui::SUI>(&mut arg0.treasury_coll, v12);
        if (v20 > 0) {
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.reserve_coll, 0x2::balance::split<0x2::sui::SUI>(&mut v23, v20));
        };
        if (v21 > 0) {
            if (v5 == 0) {
                0x2::balance::join<0x2::sui::SUI>(&mut arg0.reserve_coll, 0x2::balance::split<0x2::sui::SUI>(&mut v23, v21));
            } else {
                0x2::balance::join<0x2::sui::SUI>(&mut arg0.sp_coll_pool, 0x2::balance::split<0x2::sui::SUI>(&mut v23, v21));
            };
        };
        if (v22 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.treasury_coll, v22), arg4), arg1);
        };
        let v24 = Liquidated{
            liquidator         : 0x2::tx_context::sender(arg4),
            target             : arg1,
            debt               : v2,
            coll_to_liquidator : v16,
            coll_to_sp         : v21,
            coll_to_reserve    : v20,
            coll_to_target     : v22,
        };
        0x2::event::emit<Liquidated>(v24);
        0x2::coin::from_balance<0x2::sui::SUI>(v23, arg4)
    }
    ...
    public fun open_trove(arg0: &mut Registry, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<D> {
        ...
        let v8 = 0x2::coin::mint<D>(&mut arg0.treasury, arg2 - v7, arg5);
        let v9 = 0x2::coin::into_balance<D>(0x2::coin::mint<D>(&mut arg0.treasury, v7, arg5));
    ...
    public fun open_trove_entry(arg0: &mut Registry, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<D>>(v0, 0x2::tx_context::sender(arg5));
    }
    ...
    public fun redeem(arg0: &mut Registry, arg1: 0x2::coin::Coin<D>, arg2: address, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        0x2::coin::burn<D>(&mut arg0.treasury, arg1);
        let v6 = 0x2::coin::into_balance<D>(0x2::coin::split<D>(&mut arg1, v2, arg5));
    ...
    public fun redeem_entry(arg0: &mut Registry, arg1: 0x2::coin::Coin<D>, arg2: address, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun redeem_from_reserve(arg0: &mut Registry, arg1: 0x2::coin::Coin<D>, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        0x2::coin::burn<D>(&mut arg0.treasury, arg1);
        let v4 = 0x2::coin::into_balance<D>(0x2::coin::split<D>(&mut arg1, v2, arg4));
    ...
    public fun redeem_from_reserve_entry(arg0: &mut Registry, arg1: 0x2::coin::Coin<D>, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    fun route_fee(arg0: &mut Registry, arg1: 0x2::balance::Balance<D>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<D>(&arg1);
        if (v0 == 0) {
            0x2::balance::destroy_zero<D>(arg1);
            return
        };
        let v1 = (((v0 as u128) * 1000 / 10000) as u64);
        if (v1 > 0) {
            0x2::balance::join<D>(&mut arg0.sp_pool, 0x2::balance::split<D>(&mut arg1, v1));
            let v2 = SPDonated{
                donor  : 0x2::tx_context::sender(arg2),
                amount : v1,
            };
            0x2::event::emit<SPDonated>(v2);
        };
        let v3 = 0x2::balance::value<D>(&arg1);
        if (v3 == 0) {
            0x2::balance::destroy_zero<D>(arg1);
            return
        };
        if (arg0.total_sp == 0) {
            0x2::balance::join<D>(&mut arg0.sp_pool, arg1);
            let v4 = SPDonated{
                donor  : 0x2::tx_context::sender(arg2),
                amount : v3,
            };
            0x2::event::emit<SPDonated>(v4);
        } else {
            0x2::balance::join<D>(&mut arg0.fee_pool, arg1);
            arg0.reward_index_d = arg0.reward_index_d + (v3 as u128) * arg0.product_factor / (arg0.total_sp as u128);
        };
    }
    ...
    public fun sp_deposit(arg0: &mut Registry, arg1: 0x2::coin::Coin<D>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<D>(&arg1);
        assert!(v0 > 0, 6);
        ...
        if (0x2::table::contains<address, SP>(&arg0.sp_positions, v1)) {
            ...
            let v3 = SP{
                ...
                snapshot_index_d    : arg0.reward_index_d,
    ...
    fun sp_settle(arg0: &mut Registry, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 == 0 || v3 == 0) {
            ...
            v4.snapshot_index_d = arg0.reward_index_d;
            v4.snapshot_index_coll = arg0.reward_index_coll;
            return
        };
        let v5 = 18446744073709551615;
        let v6 = ((arg0.reward_index_d - v0.snapshot_index_d) as u256) * (v3 as u256) / (v1 as u256);
        ...
        v17.snapshot_index_d = arg0.reward_index_d;
        v17.snapshot_index_coll = arg0.reward_index_coll;
        if (v12 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<D>>(0x2::coin::from_balance<D>(0x2::balance::split<D>(&mut arg0.fee_pool, v12), arg2), arg1);
        };
        if (v14 > 0) {
    ...
    public fun sp_withdraw(arg0: &mut Registry, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<D> {
        assert!(arg1 > 0, 6);
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x2::table::contains<address, SP>(&arg0.sp_positions, v0), 5);
        ...
        0x2::coin::from_balance<D>(0x2::balance::split<D>(&mut arg0.sp_pool, arg1), arg2)
    }
    ...
    public fun sp_withdraw_entry(arg0: &mut Registry, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<D>>(v0, 0x2::tx_context::sender(arg2));
    }

    public fun totals(arg0: &Registry) : (u64, u64, u128, u128, u128) {
        (arg0.total_debt, arg0.total_sp, arg0.product_factor, arg0.reward_index_d, arg0.reward_index_coll)
    }
