module 0xfd71343575541378a9a379597bd4d88b4501a36db61d39f48f45943f927199c::ethnic_dragon_by_cryptofuckers_nft_club {
    ...
    fun init(arg0: ETHNIC_DRAGON_BY_CRYPTOFUCKERS_NFT_CLUB, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ETHNIC_DRAGON_BY_CRYPTOFUCKERS_NFT_CLUB>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Ethnic Dragon by CrYpToFuCkErS-NFT-CLUB"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Compilation of ethnic dragons from different countrys and inspirations"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreih7nvkbmbtuerrlzh5ep4txr6o2uttcprlgbilsrywib37kvowlgq"));
