module 0xf9747a99e5b0a37c933fda7173d9f06068e1454107c5f53ad5f930f59edd26b::circle {
    ...
    fun init(arg0: CIRCLE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CIRCLE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Circle"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The journey round."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibr447zcohxrzznj2xcz6cmvmdkaerqtyyhoolhgumit4vbkjmmwe"));
