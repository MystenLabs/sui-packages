module 0xfe8e81c237071d0886e285f7deee6f59e596a15eb1e4bfc23dd72270d399fae::c_dino_gotchis {
    struct C_DINO_GOTCHIS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: C_DINO_GOTCHIS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<C_DINO_GOTCHIS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b" Dino Gotchis"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Dino Gotchis are 7,777 unique profile picture NFTs starring Dino, the cheerful mascot of Sleepagotchi, a wellness app ecosystem with over 1,000,000 users"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeigufws73sxzxgl5k7yu7dh4khv5ks5rc7wdzxyte3gmh76pl4l5dm"));
