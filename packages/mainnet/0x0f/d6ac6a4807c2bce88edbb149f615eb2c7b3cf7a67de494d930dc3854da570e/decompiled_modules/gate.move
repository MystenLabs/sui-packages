module 0xd7a2b43235459be0a72b2a7ae83a22d8b1437bd254a443a579d1237839af6e7f::gate {
    ...
    public fun liquidation_gate_batch(arg0: &0x2::clock::Clock, arg1: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: address, arg4: vector<address>, arg5: u256, arg6: bool) : (vector<u256>, vector<bool>, vector<bool>, vector<bool>, vector<vector<u8>>, vector<vector<u8>>) {
        let v0 = vector[];
        let v1 = vector[];
        let v2 = vector[];
        let v3 = vector[];
        ...
        while (v6 < 0x1::vector::length<address>(&arg4)) {
            let v7 = *0x1::vector::borrow<address>(&arg4, v6);
            0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::update_state_of_user(arg0, arg2, v7);
            let v8 = if (arg6) {
                0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_health_factor(arg0, arg2, arg1, v7)
            } else {
                standard_health_factor(arg0, arg1, arg2, v7)
            };
            let v9 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::is_liquidatable(arg2, arg3, v7);
            let v10 = v8 <= 1000000000000000000000000000 && v9;
            let (v11, v12) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_assets(arg2, v7);
            0x1::vector::push_back<u256>(&mut v0, v8);
            0x1::vector::push_back<bool>(&mut v1, v8 <= arg5);
            0x1::vector::push_back<bool>(&mut v2, v9);
            0x1::vector::push_back<bool>(&mut v3, v10);
            0x1::vector::push_back<vector<u8>>(&mut v4, v11);
            0x1::vector::push_back<vector<u8>>(&mut v5, v12);
            v6 = v6 + 1;
        };
