module 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::staking {
    ...
    public entry fun stake<T0>(arg0: &0x2::clock::Clock, arg1: &mut StakingStorage, arg2: 0x1::string::String, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::vec_map::contains<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&arg1.access_list, &v1)) {
            let v11 = 0x1::string::utf8(b"ACTION_UNSTAKE");
            *0x2::vec_map::get_mut<0x1::string::String, u64>(0x2::vec_map::get_mut<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&mut arg1.access_list, &v1), &v11) = v0;
            ...
            0x2::vec_map::insert<0x1::string::String, u64>(&mut v12, 0x1::string::utf8(b"ACTION_UNSTAKE"), v0);
        ...
        0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::certificate::issue_investment_certificate<ProofOfStake>(arg0, v3.name, v3.image, v3.website, v3.link, v3.description, v13, arg4);
        let v14 = Stake{
            sender       : v1,
            epoch_time   : v0,
            package_key  : arg2,
    ...
    public entry fun unstake<T0>(arg0: &0x2::clock::Clock, arg1: &mut StakingStorage, arg2: &mut 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::certificate::InvestmentCertificate, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::vec_map::contains<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&arg1.access_list, &v1)) {
            ...
            let v6 = 0x1::string::utf8(b"ACTION_UNSTAKE");
            if (0x2::vec_map::contains<0x1::string::String, u64>(v5, &v6)) {
                let v7 = 0x1::string::utf8(b"ACTION_UNSTAKE");
        ...
        *v14 = *v14 - v3.stake_amount;
        if (0x2::vec_map::contains<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&arg1.access_list, &v1)) {
            let v15 = 0x1::string::utf8(b"ACTION_UNSTAKE");
            *0x2::vec_map::get_mut<0x1::string::String, u64>(0x2::vec_map::get_mut<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&mut arg1.access_list, &v1), &v15) = v0;
            ...
            0x2::vec_map::insert<0x1::string::String, u64>(&mut v16, 0x1::string::utf8(b"ACTION_UNSTAKE"), v0);
