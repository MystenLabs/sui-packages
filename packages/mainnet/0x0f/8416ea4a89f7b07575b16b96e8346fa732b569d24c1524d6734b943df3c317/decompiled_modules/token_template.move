module 0xf8416ea4a89f7b07575b16b96e8346fa732b569d24c1524d6734b943df3c317::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT1680305", b"BatchToken1 680305", b"First parallel deployment", 0x1::option::none<0x2::url::Url>(), arg1);
