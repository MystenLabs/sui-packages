module 0xfffcf0995b5844a15c9503f11ca6331e35f1013a36d0033eac1df39d88565b7::typus_hedge {
    ...
    fun init(arg0: TYPUS_HEDGE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::vec_map::insert<0x1::string::String, u64>(&mut v2, 0x1::string::utf8(b"aaa"), 0);
        0x2::vec_map::insert<0x1::string::String, u64>(&mut v2, 0x1::string::utf8(b"bbb"), 1);
        0x2::vec_map::insert<0x1::string::String, u64>(&mut v2, 0x1::string::utf8(b"ccc"), 2);
        let v3 = Vault{
        ...
        0x2::dynamic_field::add<u64, Vault>(&mut v1, 0, v3);
        let v4 = Registry{
            id                    : v1,
            num_of_vault          : 0,
    ...
    entry fun resume_transaction(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: &0x2::tx_context::TxContext) {
        ...
        let v1 = ManagerEvent{
            action      : 0x1::string::utf8(b"resume_transaction"),
            log         : vector[],
            bcs_padding : vector[],
        };
    ...
    entry fun suspend_transaction(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: &0x2::tx_context::TxContext) {
        ...
        let v1 = ManagerEvent{
            action      : 0x1::string::utf8(b"suspend_transaction"),
            log         : vector[],
            bcs_padding : vector[],
        };
        0x2::event::emit<ManagerEvent>(v1);
