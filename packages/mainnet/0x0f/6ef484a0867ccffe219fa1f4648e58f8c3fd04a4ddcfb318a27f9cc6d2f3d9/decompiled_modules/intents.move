module 0xf6ef484a0867ccffe219fa1f4648e58f8c3fd04a4ddcfb318a27f9cc6d2f3d9::intents {
    ...
    public fun add_action_spec<T0, T1: drop, T2: drop>(arg0: &mut PendingIntent<T0>, arg1: T1, arg2: vector<u8>, arg3: T2) {
        assert_is_witness<T0, T2>(&arg0.inner, arg3);
        assert!(0x1::vector::length<u8>(&arg2) <= 0xf6ef484a0867ccffe219fa1f4648e58f8c3fd04a4ddcfb318a27f9cc6d2f3d9::constants::max_action_data_size(), 12);
        let v0 = ActionSpec{
            version     : 0xf6ef484a0867ccffe219fa1f4648e58f8c3fd04a4ddcfb318a27f9cc6d2f3d9::constants::current_action_version(),
            action_type : 0x1::type_name::with_original_ids<T1>(),
            action_data : arg2,
        };
        0x1::vector::push_back<ActionSpec>(&mut arg0.inner.action_specs, v0);
    }

    public fun add_existing_action_spec<T0, T1: drop>(arg0: &mut PendingIntent<T0>, arg1: ActionSpec, arg2: T1) {
        assert_is_witness<T0, T1>(&arg0.inner, arg2);
        assert!(arg1.version == 0xf6ef484a0867ccffe219fa1f4648e58f8c3fd04a4ddcfb318a27f9cc6d2f3d9::constants::current_action_version(), 11);
        assert!(0x1::vector::length<u8>(&arg1.action_data) <= 0xf6ef484a0867ccffe219fa1f4648e58f8c3fd04a4ddcfb318a27f9cc6d2f3d9::constants::max_action_data_size(), 12);
        0x1::vector::push_back<ActionSpec>(&mut arg0.inner.action_specs, arg1);
    }
    ...
    public fun add_typed_action<T0, T1: drop, T2: drop>(arg0: &mut PendingIntent<T0>, arg1: T1, arg2: vector<u8>, arg3: T2) {
    ...
    public(friend) fun finish_pending<T0>(arg0: PendingIntent<T0>) : Intent<T0> {
        let PendingIntent { inner: v0 } = arg0;
        v0
    }
    ...
    public fun new_action_spec<T0: drop>(arg0: T0, arg1: vector<u8>, arg2: u8) : ActionSpec {
        assert!(arg2 == 0xf6ef484a0867ccffe219fa1f4648e58f8c3fd04a4ddcfb318a27f9cc6d2f3d9::constants::current_action_version(), 11);
        assert!(0x1::vector::length<u8>(&arg1) <= 0xf6ef484a0867ccffe219fa1f4648e58f8c3fd04a4ddcfb318a27f9cc6d2f3d9::constants::max_action_data_size(), 12);
        ActionSpec{
            version     : arg2,
    ...
    public(friend) fun new_intent<T0, T1: drop>(arg0: Params, arg1: T0, arg2: address, arg3: T1, arg4: &mut 0x2::tx_context::TxContext) : PendingIntent<T0> {
    ...
    public fun pending_account<T0>(arg0: &PendingIntent<T0>) : address {
        arg0.inner.account
    }

    public fun pending_action_count<T0>(arg0: &PendingIntent<T0>) : u64 {
        0x1::vector::length<ActionSpec>(&arg0.inner.action_specs)
    }

    public fun pending_action_specs<T0>(arg0: &PendingIntent<T0>) : &vector<ActionSpec> {
        &arg0.inner.action_specs
    }

    public fun pending_assert_is_account<T0>(arg0: &PendingIntent<T0>, arg1: address) {
        assert_is_account<T0>(&arg0.inner, arg1);
    }

    public fun pending_assert_is_witness<T0, T1: drop>(arg0: &PendingIntent<T0>, arg1: T1) {
        assert_is_witness<T0, T1>(&arg0.inner, arg1);
    }

    public fun pending_creation_time<T0>(arg0: &PendingIntent<T0>) : u64 {
        arg0.inner.creation_time
    }

    public fun pending_creator<T0>(arg0: &PendingIntent<T0>) : address {
        arg0.inner.creator
    }

    public fun pending_description<T0>(arg0: &PendingIntent<T0>) : 0x1::string::String {
        arg0.inner.description
    }

    public fun pending_execution_times<T0>(arg0: &PendingIntent<T0>) : vector<u64> {
        arg0.inner.execution_times
    }

    public fun pending_expiration_time<T0>(arg0: &PendingIntent<T0>) : u64 {
        arg0.inner.expiration_time
    }

    public fun pending_inner<T0>(arg0: &PendingIntent<T0>) : &Intent<T0> {
        &arg0.inner
    }

    public fun pending_key<T0>(arg0: &PendingIntent<T0>) : 0x1::string::String {
        arg0.inner.key
    }

    public fun pending_outcome<T0>(arg0: &PendingIntent<T0>) : &T0 {
        &arg0.inner.outcome
    }

    public fun pending_outcome_mut<T0>(arg0: &mut PendingIntent<T0>) : &mut T0 {
        &mut arg0.inner.outcome
    }

    public fun pending_pop_front_execution_time<T0>(arg0: &mut PendingIntent<T0>) : u64 {
        let v0 = &mut arg0.inner;
        pop_front_execution_time<T0>(v0)
    }

    public fun pending_type<T0>(arg0: &PendingIntent<T0>) : 0x1::type_name::TypeName {
        arg0.inner.type_
    }

    public(friend) fun pop_front_execution_time<T0>(arg0: &mut Intent<T0>) : u64 {
        assert!(!0x1::vector::is_empty<u64>(&arg0.execution_times), 3);
