module 0x2921ca2fe6ee99698b095f046bc9759ce7a764d2e91ab0ad182c143649c3df79::jwlsui {
    ...
    fun init(arg0: JWLSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<JWLSUI>(arg0, 9, b"JWLSUI", b"JWLSUI", b"JWLSUI is a stablecoin pegged to SUI and minted with SUI 1:1. Brought to you by JewelSwap.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raw.githubusercontent.com/JewelSwapXFinance/jewelswap-token-logos/main/sui/jwlsui.png")), arg1);
