module 0xfe63ddfe166eed83b0a569dbf3c034f90c242166ec8eb32579d6485fe903d02::ecrecover {
    ...
    public fun test_ecrecover(arg0: address, arg1: u64, arg2: &vector<u8>, arg3: &0x2::clock::Clock) {
        ...
        let v3 = 0x2::ecdsa_k1::secp256k1_ecrecover(arg2, &v2, 0);
        let v4 = 0x2::hash::keccak256(&v3);
        let v5 = EcrecoverDebugEvent{
            msg         : v0,
            struct_hash : v1,
            final_msg   : v2,
            pubkey      : v3,
            evm_addr    : sub_range(&v4, 12, 32),
        };
        0x2::event::emit<EcrecoverDebugEvent>(v5);
    }
