module 0xfd2013af71c5ffa5b28472d920d717bcd4af6d81e3d6d614cc7cc480d9162b4::storage_accounting {
    struct FutureAccounting has store {
        epoch: u32,
        used_capacity: u64,
        rewards_to_distribute: 0x2::balance::Balance<0xfd2013af71c5ffa5b28472d920d717bcd4af6d81e3d6d614cc7cc480d9162b4::wal::WAL>,
    }
    ...
    public(friend) fun delete_empty_future_accounting(arg0: FutureAccounting) {
        0x2::balance::destroy_zero<0xfd2013af71c5ffa5b28472d920d717bcd4af6d81e3d6d614cc7cc480d9162b4::wal::WAL>(unwrap_balance(arg0));
    }
    ...
    public(friend) fun extract_burn_balance(arg0: &mut FutureAccountingRingBuffer) : 0x2::balance::Balance<0xfd2013af71c5ffa5b28472d920d717bcd4af6d81e3d6d614cc7cc480d9162b4::wal::WAL> {
        let v0 = 0x1::vector::borrow_mut<FutureAccounting>(&mut arg0.ring_buffer, (arg0.current_index as u64));
        let v1 = rewards_balance(v0);
        0x2::balance::split<0xfd2013af71c5ffa5b28472d920d717bcd4af6d81e3d6d614cc7cc480d9162b4::wal::WAL>(v1, 0x2::balance::value<0xfd2013af71c5ffa5b28472d920d717bcd4af6d81e3d6d614cc7cc480d9162b4::wal::WAL>(v1) * 3 / 100)
    }
    ...
    public(friend) fun new_future_accounting(arg0: u32, arg1: u64, arg2: 0x2::balance::Balance<0xfd2013af71c5ffa5b28472d920d717bcd4af6d81e3d6d614cc7cc480d9162b4::wal::WAL>) : FutureAccounting {
        FutureAccounting{
            epoch                 : arg0,
            used_capacity         : arg1,
    ...
    public fun rewards(arg0: &FutureAccounting) : u64 {
        0x2::balance::value<0xfd2013af71c5ffa5b28472d920d717bcd4af6d81e3d6d614cc7cc480d9162b4::wal::WAL>(&arg0.rewards_to_distribute)
    }

    public(friend) fun rewards_balance(arg0: &mut FutureAccounting) : &mut 0x2::balance::Balance<0xfd2013af71c5ffa5b28472d920d717bcd4af6d81e3d6d614cc7cc480d9162b4::wal::WAL> {
    ...
    public(friend) fun ring_new(arg0: u32) : FutureAccountingRingBuffer {
        ...
        while (v1 < (arg0 as u64)) {
            let v2 = FutureAccounting{
                epoch                 : (v1 as u32),
                used_capacity         : 0,
                rewards_to_distribute : 0x2::balance::zero<0xfd2013af71c5ffa5b28472d920d717bcd4af6d81e3d6d614cc7cc480d9162b4::wal::WAL>(),
            };
    ...
    public(friend) fun unwrap_balance(arg0: FutureAccounting) : 0x2::balance::Balance<0xfd2013af71c5ffa5b28472d920d717bcd4af6d81e3d6d614cc7cc480d9162b4::wal::WAL> {
