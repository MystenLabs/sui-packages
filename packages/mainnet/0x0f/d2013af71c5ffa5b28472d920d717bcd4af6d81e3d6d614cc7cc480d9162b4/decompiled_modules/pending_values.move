module 0xfd2013af71c5ffa5b28472d920d717bcd4af6d81e3d6d614cc7cc480d9162b4::pending_values {
    ...
    public(friend) fun latest_value_at(arg0: &PendingValues, arg1: u32) : 0x1::option::Option<u64> {
        ...
        while (v2 < 0x1::vector::length<u32>(&v1)) {
            let v3 = 0x1::vector::pop_back<u32>(&mut v1);
            if (v3 <= arg1) {
                if (0x1::option::is_none<u32>(&v0) || *0x1::option::borrow<u32>(&v0) < v3) {
                    v0 = 0x1::option::some<u32>(v3);
                };
            };
            v2 = v2 + 1;
        };
        ...
        if (0x1::option::is_some<u32>(&v0)) {
            0x1::option::some<u64>(*0x2::vec_map::get<u32, u64>(&arg0.pos0, 0x1::option::borrow<u32>(&v0)))
        } else {
            0x1::option::none<u64>()
        }
    }
