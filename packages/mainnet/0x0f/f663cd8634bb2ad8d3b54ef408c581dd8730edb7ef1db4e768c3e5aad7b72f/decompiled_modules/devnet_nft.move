module 0xff663cd8634bb2ad8d3b54ef408c581dd8730edb7ef1db4e768c3e5aad7b72f::devnet_nft {
    ...
    public entry fun mint(arg0: address, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = DevNetNFT{
        ...
        0x2::transfer::public_transfer<DevNetNFT>(v0, arg0);
    }
