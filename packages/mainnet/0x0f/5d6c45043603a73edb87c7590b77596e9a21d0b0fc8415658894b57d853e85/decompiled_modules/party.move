module 0xf5d6c45043603a73edb87c7590b77596e9a21d0b0fc8415658894b57d853e85::party {
    ...
    public entry fun add_coin<T0>(arg0: &StoreOwnerCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Reserve<T0>{
            id    : 0x2::object::new(arg1),
            coins : 0x2::balance::zero<T0>(),
        };
        0x2::transfer::share_object<Reserve<T0>>(v0);
    }
