module 0x3f3fff85a4a55f9556ce1b9a65534b0e36e1011d93efbc7e41a7513c7c1255bb::hero {
    ...
    public fun new_v2(arg0: 0x1::string::String, arg1: &mut 0x2::tx_context::TxContext) : HeroV2 {
        HeroV2{
            id   : 0x2::object::new(arg1),
            name : arg0,
        }
    ...
    public fun set_name_v2(arg0: &mut HeroV2, arg1: 0x1::string::String) {
        arg0.name = arg1;
    }
