module 0x653582ac275ffdd981bd78463fe4bd1c219f3a31d75c6b39eb324d5e00e9138a::hub_oapp {
    ...
    struct VaultRequestReceived has copy, drop {
        src_eid: u32,
        layerzero_nonce: u64,
        guid: vector<u8>,
        account: address,
    ...
    public fun assert_uln_2of2_config(arg0: &vector<u8>) {
        let v0 = 0x2::bcs::new(*arg0);
        0x2::bcs::peel_bool(&mut v0);
        0x2::bcs::peel_bool(&mut v0);
        assert!(!0x2::bcs::peel_bool(&mut v0), 40);
        0x2::bcs::peel_u64(&mut v0);
        let v1 = 0x2::bcs::peel_vec_address(&mut v0);
        0x2::bcs::peel_vec_address(&mut v0);
        0x2::bcs::peel_u8(&mut v0);
        assert!(0x1::vector::length<address>(&v1) == 2, 40);
        let v2 = *0x1::vector::borrow<address>(&v1, 0);
        let v3 = *0x1::vector::borrow<address>(&v1, 1);
        assert!(v2 == @0xc12321ebe562b8fb8a74e6d29f144ea199a8f31a4cea3a417ce72477f6dfebb && v3 == @0x52aa129049de845353484868d1be6e2df6878b0ed2213d94d3c827309aeae685 || v2 == @0x52aa129049de845353484868d1be6e2df6878b0ed2213d94d3c827309aeae685 && v3 == @0xc12321ebe562b8fb8a74e6d29f144ea199a8f31a4cea3a417ce72477f6dfebb, 40);
    }
    ...
    public fun configure_receive_library(arg0: &HubOApp, arg1: &0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp, arg2: &GovernanceCap, arg3: &mut 0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::endpoint_v2::EndpointV2, arg4: u32, arg5: address, arg6: u64, arg7: &0x2::clock::Clock) {
        assert_governance(arg0, arg2);
        assert_oapp(arg0, arg1);
        assert_endpoint(arg0, arg3);
        assert!(is_supported_remote(arg4), 11);
        assert!(arg5 != @0x0, 41);
        0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::endpoint_calls::set_receive_library(arg1, &arg0.admin_cap, arg3, arg4, arg5, arg6, arg7);
    }

    public fun configure_receive_uln(arg0: &HubOApp, arg1: &0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp, arg2: &GovernanceCap, arg3: &0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::endpoint_v2::EndpointV2, arg4: u32, arg5: address, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) : 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Call<0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::message_lib_set_config::SetConfigParam, 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Void> {
        assert_governance(arg0, arg2);
        assert_oapp(arg0, arg1);
        assert_endpoint(arg0, arg3);
        assert!(is_supported_remote(arg4), 11);
        assert!(arg5 != @0x0, 41);
        assert_uln_2of2_config(&arg6);
        0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::endpoint_calls::set_config(arg1, &arg0.admin_cap, arg3, arg5, arg4, 3, arg6, arg7)
    }
    ...
    fun decode_vault_request(arg0: vector<u8>) : (address, u64, vector<u8>) {
        assert!(0x1::vector::length<u8>(&arg0) >= 160, 13);
        let v0 = 0;
        while (v0 < 31) {
            assert!(*0x1::vector::borrow<u8>(&arg0, v0) == 0, 13);
            v0 = v0 + 1;
        };
        assert!(*0x1::vector::borrow<u8>(&arg0, 31) == 1, 13);
        let v1 = b"";
        let v2 = 76;
        while (v2 < 96) {
        ...
        let v3 = 0x245ba36f7a1cc643a2b037450dff1e4399e18069c6545fb5fcaaf37d39d7dc::bytes32::from_bytes_left_padded(v1);
        let v4 = 96;
        while (v4 < 120) {
            assert!(*0x1::vector::borrow<u8>(&arg0, v4) == 0, 13);
            v4 = v4 + 1;
        };
        let v5 = 0;
        let v6 = 120;
        while (v6 < 128) {
            let v7 = v5 << 8;
            v5 = v7 + (*0x1::vector::borrow<u8>(&arg0, v6) as u64);
            v6 = v6 + 1;
        };
        assert!(v5 > 0, 13);
        let v8 = 0;
        let v9 = 160;
        while (v9 < 184) {
            assert!(*0x1::vector::borrow<u8>(&arg0, v9) == 0, 13);
            v9 = v9 + 1;
        };
        let v10 = 184;
        while (v10 < 192) {
            let v11 = v8 << 8;
            v8 = v11 + (*0x1::vector::borrow<u8>(&arg0, v10) as u64);
            v10 = v10 + 1;
        };
        let v12 = b"";
        let v13 = 192;
        let v14 = 192 + v8;
        assert!(0x1::vector::length<u8>(&arg0) >= v14, 13);
        while (v13 < v14) {
            0x1::vector::push_back<u8>(&mut v12, *0x1::vector::borrow<u8>(&arg0, v13));
            v13 = v13 + 1;
        };
        (0x245ba36f7a1cc643a2b037450dff1e4399e18069c6545fb5fcaaf37d39d7dc::bytes32::to_address(&v3), v5, v12)
    }
    ...
    public fun dvn_layerzero_labs() : address {
        @0x52aa129049de845353484868d1be6e2df6878b0ed2213d94d3c827309aeae685
    }

    public fun dvn_nethermind() : address {
        @0xc12321ebe562b8fb8a74e6d29f144ea199a8f31a4cea3a417ce72477f6dfebb
    }
    ...
    public fun encode_receive_uln_2of2(arg0: u64) : vector<u8> {
        let v0 = vector[];
        0x1::vector::push_back<address>(&mut v0, @0xc12321ebe562b8fb8a74e6d29f144ea199a8f31a4cea3a417ce72477f6dfebb);
        0x1::vector::push_back<address>(&mut v0, @0x52aa129049de845353484868d1be6e2df6878b0ed2213d94d3c827309aeae685);
        let v1 = x"000001";
        0x1::vector::append<u8>(&mut v1, 0x2::bcs::to_bytes<u64>(&arg0));
        0x1::vector::append<u8>(&mut v1, 0x2::bcs::to_bytes<vector<address>>(&v0));
        let v2 = vector[];
        0x1::vector::append<u8>(&mut v1, 0x2::bcs::to_bytes<vector<address>>(&v2));
    ...
    public fun receive_vault_request(arg0: &mut HubOApp, arg1: &0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp, arg2: 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Call<0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::LzReceiveParam, 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Void>, arg3: &0x2::clock::Clock) {
        assert!(is_registered(arg0), 2);
        assert_oapp(arg0, arg1);
        let v0 = 0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::lz_receive(arg1, &arg0.call_cap, arg2);
        assert!(0x1::option::is_none<0x2::coin::Coin<0x2::sui::SUI>>(0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::value(&v0)), 18);
        ...
        assert!(is_supported_remote(v1), 11);
        let v2 = 0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::guid(&v0);
        let v3 = 0x245ba36f7a1cc643a2b037450dff1e4399e18069c6545fb5fcaaf37d39d7dc::bytes32::to_bytes(&v2);
        assert!(0x1::vector::length<u8>(&v3) == 32, 13);
        assert!(!0x2::table::contains<vector<u8>, bool>(&arg0.consumed_hub_guids, v3), 33);
        0x2::table::add<vector<u8>, bool>(&mut arg0.consumed_hub_guids, v3, true);
        let (v4, v5, v6) = decode_vault_request(*0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::message(&v0));
        let (_, _, _, _, _, _, _, v14) = 0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::destroy(v0);
        0x1::option::destroy_none<0x2::coin::Coin<0x2::sui::SUI>>(v14);
        let v15 = VaultRequestReceived{
            src_eid         : v1,
            layerzero_nonce : 0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::nonce(&v0),
            guid            : v3,
            account         : v4,
        ...
        0x2::event::emit<VaultRequestReceived>(v15);
    }
    ...
    public fun uln_302_package() : address {
