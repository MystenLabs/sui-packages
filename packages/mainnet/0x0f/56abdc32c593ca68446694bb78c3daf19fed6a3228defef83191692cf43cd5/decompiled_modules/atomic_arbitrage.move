module 0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::atomic_arbitrage {
    ...
    public entry fun arb_aftermath_bluefin(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg0) == 0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::constants::get_exact_sui_amount(), 1);
    ...
    public fun execute_atomic_arbitrage(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u8, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, ArbitrageResult) {
        assert!(0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::constants::is_valid_dex_id(arg1), 4);
        assert!(0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::constants::is_valid_dex_id(arg2), 4);
        assert!(arg1 != arg2, 4);
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(v0 == 0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::constants::get_exact_sui_amount(), 1);
    ...
    public fun get_sui_type() : vector<u8> {
        0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::constants::get_sui_type()
    }

    public fun get_wusdc_type() : vector<u8> {
        0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::constants::get_wusdc_type()
    }

    public fun init_arbitrage_context(arg0: &mut 0x2::tx_context::TxContext) : ArbitrageContext {
        ArbitrageContext{
            sender               : 0x2::tx_context::sender(arg0),
            exact_sui_amount     : 0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::constants::get_exact_sui_amount(),
            min_profit_threshold : 1000,
            max_gas_budget       : 0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::constants::get_default_gas_budget(),
            slippage_bps         : 0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::constants::get_default_slippage_bps(),
        }
    }
    ...
    fun swap_sui_to_wusdc_via_dex(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::wusdc::WUSDC> {
        let v0 = 0x2::coin::into_balance<0x2::sui::SUI>(arg0);
        assert!(0x2::balance::value<0x2::sui::SUI>(&v0) > 0, 2);
        if (arg1 == 1) {
            0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::dex_kriya::swap_sui_to_wusdc(0x2::coin::from_balance<0x2::sui::SUI>(v0, arg2), arg2)
        } else if (arg1 == 2) {
            0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::dex_turbos::swap_sui_to_wusdc(0x2::coin::from_balance<0x2::sui::SUI>(v0, arg2), arg2)
        } else if (arg1 == 3) {
            0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::dex_cetus::swap_sui_to_wusdc(0x2::coin::from_balance<0x2::sui::SUI>(v0, arg2), arg2)
        } else if (arg1 == 4) {
            0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::dex_aftermath::swap_sui_to_wusdc(0x2::coin::from_balance<0x2::sui::SUI>(v0, arg2), arg2)
        } else if (arg1 == 5) {
            0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::dex_bluefin::swap_sui_to_wusdc(0x2::coin::from_balance<0x2::sui::SUI>(v0, arg2), arg2)
        } else {
            assert!(arg1 == 6, 4);
            0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::dex_deepbook::swap_sui_to_wusdc(0x2::coin::from_balance<0x2::sui::SUI>(v0, arg2), arg2)
        }
    }

    fun swap_wusdc_to_sui_via_dex(arg0: 0x2::coin::Coin<0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::wusdc::WUSDC>, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        let v0 = 0x2::coin::into_balance<0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::wusdc::WUSDC>(arg0);
        assert!(0x2::balance::value<0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::wusdc::WUSDC>(&v0) > 0, 2);
        if (arg1 == 1) {
            0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::dex_kriya::swap_wusdc_to_sui(0x2::coin::from_balance<0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::wusdc::WUSDC>(v0, arg2), arg2)
        } else if (arg1 == 2) {
            0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::dex_turbos::swap_wusdc_to_sui(0x2::coin::from_balance<0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::wusdc::WUSDC>(v0, arg2), arg2)
        } else if (arg1 == 3) {
            0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::dex_cetus::swap_wusdc_to_sui(0x2::coin::from_balance<0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::wusdc::WUSDC>(v0, arg2), arg2)
        } else if (arg1 == 4) {
            0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::dex_aftermath::swap_wusdc_to_sui(0x2::coin::from_balance<0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::wusdc::WUSDC>(v0, arg2), arg2)
        } else if (arg1 == 5) {
            0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::dex_bluefin::swap_wusdc_to_sui(0x2::coin::from_balance<0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::wusdc::WUSDC>(v0, arg2), arg2)
        } else {
            assert!(arg1 == 6, 4);
            0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::dex_deepbook::swap_wusdc_to_sui(0x2::coin::from_balance<0xf56abdc32c593ca68446694bb78c3daf19fed6a3228defef83191692cf43cd5::wusdc::WUSDC>(v0, arg2), arg2)
        }
    }
