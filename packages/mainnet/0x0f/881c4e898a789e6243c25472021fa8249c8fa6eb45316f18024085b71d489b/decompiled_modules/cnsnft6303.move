module 0xf881c4e898a789e6243c25472021fa8249c8fa6eb45316f18024085b71d489b::cnsnft6303 {
    struct CNSNFT6303 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6303, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6303>(arg0, arg1);
