module 0xf49527cc40a1ec9a6257e113c01e69eb6e4a20652ddca0be2483170e339cd25::dex_aftermath {
    ...
    public fun get_aftermath_package() : address {
        0xf49527cc40a1ec9a6257e113c01e69eb6e4a20652ddca0be2483170e339cd25::constants::aftermath_package()
    }
    ...
    public fun is_aftermath_operational() : bool {
        0xf49527cc40a1ec9a6257e113c01e69eb6e4a20652ddca0be2483170e339cd25::constants::aftermath_package() != @0x0
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = AftermathSwapExecuted{
            ...
            package        : 0xf49527cc40a1ec9a6257e113c01e69eb6e4a20652ddca0be2483170e339cd25::constants::aftermath_package(),
