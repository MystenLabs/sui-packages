module 0xf23d8b3f4c94df944756d1e853e8b1e279efc8e6e3e84d38b304b2748773bd5::passionnn {
    ...
    public entry fun mint(arg0: &mut AppCap, arg1: 0x1::string::String, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Attribute{
            trait_type : 0x1::string::utf8(b"Country"),
            value      : 0x1::string::utf8(b"USA"),
        };
        let v2 = 0x1::vector::empty<Attribute>();
        0x1::vector::push_back<Attribute>(&mut v2, v1);
        let v3 = Passionnn{
    ...
    public fun mint_for_testing<T0>(arg0: &mut 0x2::tx_context::TxContext) : Passionnn {
        ...
        let v1 = Attribute{
            trait_type : 0x1::string::utf8(b"test"),
            value      : 0x1::string::utf8(b"test"),
        };
        let v2 = 0x1::vector::empty<Attribute>();
        0x1::vector::push_back<Attribute>(&mut v2, v1);
        Passionnn{
