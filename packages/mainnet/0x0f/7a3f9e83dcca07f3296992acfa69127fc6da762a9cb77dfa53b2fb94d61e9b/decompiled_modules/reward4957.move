module 0xf7a3f9e83dcca07f3296992acfa69127fc6da762a9cb77dfa53b2fb94d61e9b::reward4957 {
    struct REWARD4957 has drop {
        dummy_field: bool,
    }

    struct TICKET_4957 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4957(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4957>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4957>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4957, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4957>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4957>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4957>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4957>>(v5, 0x2::tx_context::sender(arg1));
    }
