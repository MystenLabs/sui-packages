module 0xfeca2e3524b8cc5f951e608f2488781366596ad3baaa1f2089a89f156a3dac5::kuma {
    ...
    fun init(arg0: KUMA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/4GEvgHznrwq827D5QeKJKrvDiSsqUgfzQVSu9oMdpump.png?size=lg&key=766c13                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<KUMA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"KUMA    ")))), trim_right(b"Kumamon                         "), trim_right(b"Kumamon () is a mascot created by the government of Kumamoto Prefecture, Japan. Kumamon enjoys tremendous popularity throughout the world.                                                                                                                                                                                      "), v2, arg1);
        let v5 = v3;
