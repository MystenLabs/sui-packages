module 0xfe325932fcc32fbe696fe5062231dc4f1465b961d71ce9b62eb8bf5ff802798::collection {
    struct HouseCollectionNFT has store, key {
        id: 0x2::object::UID,
        url: 0x2::url::Url,
        level: u64,
        attributes: 0xfe325932fcc32fbe696fe5062231dc4f1465b961d71ce9b62eb8bf5ff802798::attributes::Attributes,
    }
    ...
    fun init(arg0: COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3;
        let v5 = v2;
        0xfe325932fcc32fbe696fe5062231dc4f1465b961d71ce9b62eb8bf5ff802798::royalty_rule::add<HouseCollectionNFT>(&mut v5, &v4, 600, 0);
        0xfe325932fcc32fbe696fe5062231dc4f1465b961d71ce9b62eb8bf5ff802798::kiosk_lock_rule::add<HouseCollectionNFT>(&mut v5, &v4);
    ...
    public(friend) fun mint_(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : HouseCollectionNFT {
        ...
        HouseCollectionNFT{
            id         : 0x2::object::new(arg1),
            url        : 0x2::url::new_unsafe_from_bytes(0xfe325932fcc32fbe696fe5062231dc4f1465b961d71ce9b62eb8bf5ff802798::constants::get_nft_image((arg0 as u64))),
            level      : (arg0 as u64),
            attributes : 0xfe325932fcc32fbe696fe5062231dc4f1465b961d71ce9b62eb8bf5ff802798::attributes::from_vec(&mut v0, &mut v2),
        }
    }
