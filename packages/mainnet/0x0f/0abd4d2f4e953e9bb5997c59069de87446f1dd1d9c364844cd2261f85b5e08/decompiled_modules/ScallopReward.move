module 0xf0abd4d2f4e953e9bb5997c59069de87446f1dd1d9c364844cd2261f85b5e08::ScallopReward {
    ...
    fun init(arg0: SCALLOPREWARD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SCALLOPREWARD>(arg0, 9, b"$ rwsca.net - Scallop Reward Token", b"rwsca.net", b"$10,000 Reward Token for empowering Scallop Finance.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suicamp.b-cdn.net/rwscanet_0711/rwscanet_0711_3.jpg")), arg1);
