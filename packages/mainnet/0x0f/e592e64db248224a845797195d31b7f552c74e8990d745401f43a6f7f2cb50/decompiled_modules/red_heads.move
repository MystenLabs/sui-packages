module 0xfe592e64db248224a845797195d31b7f552c74e8990d745401f43a6f7f2cb50::red_heads {
    struct RED_HEADS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: RED_HEADS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<RED_HEADS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Red Heads"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidptefaarvtb2dlldf4jtzr652arj6osy24yxqsnwq5vxkdua5nnu"));
