module 0xfecc75882e2caa8b268f22fbac56e26dea470b7018e1f7bc30045b8753b8b7c::reward5309 {
    struct REWARD5309 has drop {
        dummy_field: bool,
    }

    struct TICKET_5309 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5309(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5309>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5309>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5309, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5309>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5309>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5309>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5309>>(v5, 0x2::tx_context::sender(arg1));
    }
