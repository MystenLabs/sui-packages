module 0xfebc5dc57e75ee70bb22fe05822480e510524bf65b65f050113da37e8ae47ae::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"MC1776910", b"MixedConcurrent1 776910", b"Token for mixed concurrent test 1", 0x1::option::none<0x2::url::Url>(), arg1);
