module 0xf69aec501891142ea4b970460851f1b45b2f57aee608c69ce0bff163540ec51::warehouse {
    ...
    public fun redeem<T0: store + key>(arg0: &mut Warehouse<T0>) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        redeem_inner<T0, Warehouse<T0>>(arg0, 0x2::dynamic_object_field::remove<0x2::object::ID, T0>(&mut arg0.id, 0x8a5880a32cc17d30f7090219ad64a319327ba216869d6eded06b0d0f2471b39d::dynamic_vector::pop<0x2::object::ID>(&mut arg0.inner)))
    }

    public fun redeem_at_index<T0: store + key>(arg0: &mut Warehouse<T0>, arg1: u64) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        redeem_inner<T0, Warehouse<T0>>(arg0, 0x2::dynamic_object_field::remove<0x2::object::ID, T0>(&mut arg0.id, 0x8a5880a32cc17d30f7090219ad64a319327ba216869d6eded06b0d0f2471b39d::dynamic_vector::remove<0x2::object::ID>(&mut arg0.inner, arg1)))
    }
    ...
    public fun redeem_with_id<T0: store + key>(arg0: &mut Warehouse<T0>, arg1: 0x2::object::ID) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        0x8a5880a32cc17d30f7090219ad64a319327ba216869d6eded06b0d0f2471b39d::dynamic_vector::remove_value<0x2::object::ID>(&mut arg0.inner, arg1);
