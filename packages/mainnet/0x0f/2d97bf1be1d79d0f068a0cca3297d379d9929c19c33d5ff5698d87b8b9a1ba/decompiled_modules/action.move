module 0xf2d97bf1be1d79d0f068a0cca3297d379d9929c19c33d5ff5698d87b8b9a1ba::action {
    ...
    struct AgentActed has copy, drop {
        action_id: 0x2::object::ID,
        agent_id: 0x2::object::ID,
        acted_by: address,
        expires_at: u64,
    ...
    public fun agent_act(arg0: &AgentAction, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        assert!(!is_expired(arg0, arg1), 1);
        let v0 = AgentActed{
            action_id  : 0x2::object::id<AgentAction>(arg0),
            agent_id   : arg0.agent_id,
            acted_by   : 0x2::tx_context::sender(arg2),
            expires_at : arg0.expires_at,
            label      : arg0.label,
        };
        0x2::event::emit<AgentActed>(v0);
    }
    ...
    public fun create_action(arg0: &0xf2d97bf1be1d79d0f068a0cca3297d379d9929c19c33d5ff5698d87b8b9a1ba::identity::AgentIdentity, arg1: &0x2::clock::Clock, arg2: u64, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) : AgentAction {
        let v0 = 0x2::object::id<0xf2d97bf1be1d79d0f068a0cca3297d379d9929c19c33d5ff5698d87b8b9a1ba::identity::AgentIdentity>(arg0);
        let v1 = AgentAction{
