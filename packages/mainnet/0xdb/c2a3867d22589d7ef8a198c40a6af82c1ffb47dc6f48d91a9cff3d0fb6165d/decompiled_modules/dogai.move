module 0xdbc2a3867d22589d7ef8a198c40a6af82c1ffb47dc6f48d91a9cff3d0fb6165d::dogai {
    ...
    fun init(arg0: DOGAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/DhASyXH2drjZ2w5GVXe6MWmtchAYnjECzRfcZNfopump.png                                                                                                                                                                                                                               ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DOGAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DOGAI     ")))), trim_right(b"Doggo Ai                        "), trim_right(b"Doggo Ai is the firs                                                                                                                                                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
