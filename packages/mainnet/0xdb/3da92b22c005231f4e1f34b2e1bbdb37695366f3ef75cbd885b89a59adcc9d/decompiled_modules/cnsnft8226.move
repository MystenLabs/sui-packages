module 0xdb3da92b22c005231f4e1f34b2e1bbdb37695366f3ef75cbd885b89a59adcc9d::cnsnft8226 {
    struct CNSNFT8226 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8226, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8226>(arg0, arg1);
