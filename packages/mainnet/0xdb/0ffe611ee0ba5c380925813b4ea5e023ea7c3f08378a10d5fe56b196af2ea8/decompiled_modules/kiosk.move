module 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::kiosk {
    ...
    struct MultiPriceInfo has store {
    ...
    public fun accept_item_offer_by_coin_type<T0, T1>(arg0: &mut 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::FeeManager, arg1: &0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::collection::Collection, arg2: &mut Kiosk, arg3: u64, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        let v1 = get_kiosk_item_key(arg3);
        assert!(0x2::dynamic_field::exists_<vector<u8>>(&arg2.id, v1), 4);
        let v2 = 0x2::dynamic_field::borrow<vector<u8>, KioskItem>(&arg2.id, v1);
        ...
        let v6 = 0x2::dynamic_field::remove<u64, 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(&mut arg2.id, arg3);
        let v7 = 0x2::dynamic_field::remove<u64, 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(&mut arg2.id, get_offered_item_key(arg3, arg4));
        let v8 = 0x2::dynamic_field::remove<u64, 0x2::coin::Coin<T0>>(&mut arg2.id, get_gas_payment_key(arg3, arg4));
        let v9 = 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::get_item_id(&v6);
        let v10 = 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::get_item_id(&v7);
        assert!(v9 == v5.item_id, 8);
        assert!(v10 == v4.offered_item_id, 8);
        let v11 = 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::collection::get_collection_owner(arg1);
        let (_, v13, _, v15, _) = 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::get_fee_manager(arg0);
        let v17 = 0x2::coin::value<T0>(&v8);
        let v18 = v17 * v15 / 10000;
        let v19 = 0x2::coin::value<T1>(&arg5);
        let v20 = v19 * v15 / 10000;
        if (v18 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v8, v18, arg6), v11);
        };
        if (v20 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg5, v20, arg6), v11);
        };
        if (0x2::coin::value<T0>(&v8) > 0) {
            0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::deposit_service_fee_by_coin_type<T0>(arg0, v8, arg6);
        } else {
            0x2::coin::destroy_zero<T0>(v8);
        };
        if (0x2::coin::value<T1>(&arg5) > 0) {
            0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::deposit_service_fee_by_coin_type<T1>(arg0, arg5, arg6);
        } else {
            0x2::coin::destroy_zero<T1>(arg5);
        };
        let v21 = v4.offerer;
        0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::update_item_owner(&mut v6, v21);
        0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::update_item_owner(&mut v7, v0);
        0x2::transfer::public_transfer<0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(v6, v21);
        0x2::transfer::public_transfer<0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(v7, v0);
        v4.status = 2;
        v5.is_active = false;
        0x2::dynamic_field::add<u64, KioskItemOffer>(&mut arg2.id, v3, v4);
        0x2::dynamic_field::add<vector<u8>, KioskItem>(&mut arg2.id, v1, v5);
        let v22 = KioskItemOfferAccepted{
            id                : arg4,
            kiosk_item_id     : arg3,
            kiosk_id          : 0x2::object::id<Kiosk>(arg2),
            item_id           : v9,
            ...
            buyer             : v21,
            seller            : v0,
            service_fee       : v17 * v13 / 10000 + v19 * v13 / 10000,
            developer_royalty : v18 + v20,
            total_paid        : v17 + v19,
            seller_net_amount : 0,
            trade_type        : 2,
        };
        0x2::event::emit<KioskItemOfferAccepted>(v22);
    }
    ...
    public fun buy_item_with_coin_type<T0>(arg0: &0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::collection::Collection, arg1: &mut Kiosk, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::FeeManager, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = if (v6 == v3.price) {
            ...
            0x2::coin::split<T0>(&mut arg3, v3.price, arg5)
        };
        let v8 = v7;
        let v9 = 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::collection::get_collection_owner(arg0);
        let (v10, v11) = if (0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::collection::has_collection_fee(arg0)) {
            (0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::collection::calculate_service_fee(arg4, arg0, v3.price), 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::collection::calculate_developer_fee(arg4, arg0, v3.price))
        } else {
            (0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::calculate_purchase_fee(arg4, v3.price), 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::calculate_purchase_developer_royalty(arg4, v9, v3.price))
        };
        assert!(v10 >= 0, 9);
        assert!(v11 >= 0, 9);
        let v12 = v10 + v11;
        ...
        if (v10 > 0) {
            0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::deposit_service_fee_by_coin_type<T0>(arg4, 0x2::coin::split<T0>(&mut v8, v10, arg5), arg5);
        };
        if (v11 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v8, v11, arg5), v9);
        };
        let v14 = 0x2::coin::value<T0>(&v8);
        assert!(v14 == v13, 9);
        if (v14 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v8, v3.seller);
        } else {
            0x2::coin::destroy_zero<T0>(v8);
        };
    ...
    public fun cancel_item_offer_by_coin_type<T0>(arg0: &mut Kiosk, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = get_offer_key(arg1, arg2);
        assert!(0x2::dynamic_field::exists_<u64>(&arg0.id, v1), 10);
        let v2 = 0x2::dynamic_field::borrow<u64, KioskItemOffer>(&arg0.id, v1);
        ...
        assert!(v0 == v2.offerer, 14);
        let v3 = 0x2::dynamic_field::remove<u64, KioskItemOffer>(&mut arg0.id, v1);
        let v4 = 0x2::dynamic_field::remove<u64, 0x2::coin::Coin<T0>>(&mut arg0.id, get_gas_payment_key(arg1, arg2));
        0x2::transfer::public_transfer<0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(0x2::dynamic_field::remove<u64, 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(&mut arg0.id, get_offered_item_key(arg1, arg2)), v0);
        ...
        0x2::event::emit<KioskItemOfferCanceled>(v5);
    }
    ...
    public fun create_item_offer_by_coin_type<T0>(arg0: &0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::FeeManager, arg1: &mut Kiosk, arg2: u64, arg3: 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        let v1 = get_kiosk_item_key(arg2);
        assert!(0x2::dynamic_field::exists_<vector<u8>>(&arg1.id, v1), 4);
        let v2 = 0x2::dynamic_field::borrow<vector<u8>, KioskItem>(&arg1.id, v1);
        ...
        let v4 = if (0x2::coin::value<T0>(&arg4) == arg5) {
            arg4
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg4, v0);
            0x2::coin::split<T0>(&mut arg4, arg5, arg6)
        };
        let v5 = generate_offer_id(arg1, arg2);
        let v6 = get_offer_key(arg2, v5);
        assert!(!0x2::dynamic_field::exists_<u64>(&arg1.id, v6), 12);
        let v7 = KioskItemOffer{
            id              : v5,
            kiosk_item_id   : arg2,
            offered_item_id : v3,
            offerer         : v0,
        ...
        0x2::dynamic_field::add<u64, KioskItemOffer>(&mut arg1.id, v6, v7);
        0x2::dynamic_field::add<u64, 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(&mut arg1.id, get_offered_item_key(arg2, v5), arg3);
        0x2::dynamic_field::add<u64, 0x2::coin::Coin<T0>>(&mut arg1.id, get_gas_payment_key(arg2, v5), v4);
        let v8 = KioskItemOfferCreated{
            id              : v5,
            kiosk_item_id   : arg2,
            offered_item_id : v3,
            offerer         : v0,
        ...
        0x2::event::emit<KioskItemOfferCreated>(v8);
    }
    ...
    public fun create_kiosk_item_with_coin_type<T0>(arg0: &mut Kiosk, arg1: 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::get_item_id(&arg1);
        assert!(v0 == arg0.owner, 1);
        assert!(!is_item_already_listed(arg0, v1), 5);
        ...
        0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut v4, 0x1::type_name::with_defining_ids<T0>(), arg2);
        let v5 = MultiPriceInfo{prices: v4};
        0x2::dynamic_field::add<u64, 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(&mut arg0.id, v2, arg1);
        0x2::dynamic_field::add<vector<u8>, KioskItem>(&mut arg0.id, get_kiosk_item_key(v2), v3);
        0x2::dynamic_field::add<vector<u8>, MultiPriceInfo>(&mut arg0.id, get_multi_price_key(v2), v5);
        let v6 = KioskItemListed{
            id             : v2,
            kiosk_id       : 0x2::object::id<Kiosk>(arg0),
            item_id        : v1,
            seller         : v0,
        ...
        0x2::event::emit<KioskItemListed>(v6);
    }
    ...
    public fun get_multi_price_count(arg0: &Kiosk, arg1: u64) : u64 {
        let v0 = get_multi_price_key(arg1);
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, v0)) {
            0x2::vec_map::length<0x1::type_name::TypeName, u64>(&0x2::dynamic_field::borrow<vector<u8>, MultiPriceInfo>(&arg0.id, v0).prices)
        } else {
            0
        }
    }

    fun get_multi_price_key(arg0: u64) : vector<u8> {
        let v0 = b"multi_price_";
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<u64>(&arg0));
        v0
    }
    ...
    public fun get_price_for_coin_type<T0>(arg0: &Kiosk, arg1: u64) : (bool, u64) {
        let v0 = get_multi_price_key(arg1);
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, v0)) {
            let v3 = 0x2::dynamic_field::borrow<vector<u8>, MultiPriceInfo>(&arg0.id, v0);
            let v4 = 0x1::type_name::with_defining_ids<T0>();
            if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&v3.prices, &v4)) {
                (true, *0x2::vec_map::get<0x1::type_name::TypeName, u64>(&v3.prices, &v4))
            } else {
                (false, 0)
            }
        } else {
    ...
    public fun reject_all_other_offers(arg0: &mut 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::role_manager::RoleManager, arg1: &mut Kiosk, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::role_manager::has_role(arg0, v0, 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::role_manager::factory_role()), 1);
        let v1 = 1;
        while (v1 <= 1000) {
            if (v1 != arg3) {
                let v2 = get_offer_key(arg2, v1);
                if (0x2::dynamic_field::exists_<u64>(&arg1.id, v2)) {
                    if (0x2::dynamic_field::borrow<u64, KioskItemOffer>(&arg1.id, v2).status == 1) {
                        let v3 = 0x2::dynamic_field::remove<u64, KioskItemOffer>(&mut arg1.id, v2);
                        let v4 = 0x2::dynamic_field::remove<u64, 0x2::coin::Coin<0x2::sui::SUI>>(&mut arg1.id, get_gas_payment_key(arg2, v1));
                        if (0x2::coin::value<0x2::sui::SUI>(&v4) >= 2000000) {
                            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v4, 2000000, arg4), v0);
                        };
                        0x2::transfer::public_transfer<0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(0x2::dynamic_field::remove<u64, 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(&mut arg1.id, get_offered_item_key(arg2, v1)), v3.offerer);
                        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v4, v3.offerer);
                        v3.status = 4;
                        0x2::dynamic_field::add<u64, KioskItemOffer>(&mut arg1.id, v2, v3);
                        let v5 = KioskItemOfferCanceled{
                            id              : v1,
                            kiosk_item_id   : arg2,
                            offered_item_id : v3.offered_item_id,
    ...
    public fun reject_single_offer(arg0: &mut 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::role_manager::RoleManager, arg1: &mut Kiosk, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::role_manager::has_role(arg0, v0, 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::role_manager::factory_role()), 1);
        let v1 = get_offer_key(arg2, arg3);
        assert!(0x2::dynamic_field::exists_<u64>(&arg1.id, v1), 10);
        assert!(0x2::dynamic_field::borrow<u64, KioskItemOffer>(&arg1.id, v1).status == 1, 13);
        let v2 = 0x2::dynamic_field::remove<u64, KioskItemOffer>(&mut arg1.id, v1);
        let v3 = 0x2::dynamic_field::remove<u64, 0x2::coin::Coin<0x2::sui::SUI>>(&mut arg1.id, get_gas_payment_key(arg2, arg3));
        assert!(0x2::coin::value<0x2::sui::SUI>(&v3) >= 2000000, 18);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v3, 2000000, arg4), v0);
        0x2::transfer::public_transfer<0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(0x2::dynamic_field::remove<u64, 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(&mut arg1.id, get_offered_item_key(arg2, arg3)), v2.offerer);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v3, v2.offerer);
        v2.status = 4;
    ...
    public fun reject_single_offer_by_coin_type<T0>(arg0: &mut 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::FeeManager, arg1: &mut 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::role_manager::RoleManager, arg2: &mut Kiosk, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::role_manager::has_role(arg1, 0x2::tx_context::sender(arg5), 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::role_manager::factory_role()), 1);
        let v0 = get_offer_key(arg3, arg4);
        assert!(0x2::dynamic_field::exists_<u64>(&arg2.id, v0), 10);
        assert!(0x2::dynamic_field::borrow<u64, KioskItemOffer>(&arg2.id, v0).status == 1, 13);
        let v1 = 0x2::dynamic_field::remove<u64, KioskItemOffer>(&mut arg2.id, v0);
        let v2 = 0x2::dynamic_field::remove<u64, 0x2::coin::Coin<T0>>(&mut arg2.id, get_gas_payment_key(arg3, arg4));
        let v3 = 0x2::coin::value<T0>(&v2) * 300 / 10000;
        if (v3 > 0) {
            0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::fee_manager::deposit_service_fee_by_coin_type<T0>(arg0, 0x2::coin::split<T0>(&mut v2, v3, arg5), arg5);
        };
        0x2::transfer::public_transfer<0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(0x2::dynamic_field::remove<u64, 0xc8636f05706a76ecf41db6b516b64e0c38f89295732ca9370a4de27fd41b8814::item::Item>(&mut arg2.id, get_offered_item_key(arg3, arg4)), v1.offerer);
        if (0x2::coin::value<T0>(&v2) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v2, v1.offerer);
        } else {
            0x2::coin::destroy_zero<T0>(v2);
        };
        v1.status = 4;
        0x2::dynamic_field::add<u64, KioskItemOffer>(&mut arg2.id, v0, v1);
        let v4 = KioskItemOfferCanceled{
            id              : arg4,
            kiosk_item_id   : arg3,
    ...
    public fun update_kiosk_item_with_coin_type<T0>(arg0: &mut Kiosk, arg1: u64, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(v0 == arg0.owner, 1);
        let v1 = get_kiosk_item_key(arg1);
        assert!(0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, v1), 4);
        ...
        let v3 = get_multi_price_key(arg1);
        let v4 = 0x1::type_name::with_defining_ids<T0>();
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, v3)) {
            let v5 = 0x2::dynamic_field::remove<vector<u8>, MultiPriceInfo>(&mut arg0.id, v3);
            if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&v5.prices, &v4)) {
                let (_, _) = 0x2::vec_map::remove<0x1::type_name::TypeName, u64>(&mut v5.prices, &v4);
            };
            0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut v5.prices, v4, arg2);
            0x2::dynamic_field::add<vector<u8>, MultiPriceInfo>(&mut arg0.id, v3, v5);
        } else {
            let v8 = 0x2::vec_map::empty<0x1::type_name::TypeName, u64>();
            0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut v8, v4, arg2);
            let v9 = MultiPriceInfo{prices: v8};
            0x2::dynamic_field::add<vector<u8>, MultiPriceInfo>(&mut arg0.id, v3, v9);
        };
        v2.price = arg2;
        v2.only_item_swap = arg3;
        0x2::dynamic_field::add<vector<u8>, KioskItem>(&mut arg0.id, v1, v2);
        let v10 = KioskItemUpdated{
            id                 : arg1,
            kiosk_id           : 0x2::object::id<Kiosk>(arg0),
            seller             : v0,
            old_price          : v2.price,
        ...
        0x2::event::emit<KioskItemUpdated>(v10);
    }
