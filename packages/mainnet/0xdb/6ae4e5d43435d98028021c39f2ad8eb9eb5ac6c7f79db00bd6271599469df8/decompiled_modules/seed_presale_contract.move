module 0xe64012786406e76306b3a56841772673a6ee9a9f69c70e431d1f051e39681b1e::seed_presale_contract {
    ...
    public(friend) fun add_funds_to_presale_callable(arg0: &mut Presale, arg1: u128) {
        arg0.total_raised_amount_usd = arg0.total_raised_amount_usd + arg1;
    }

    public fun burn_receipt_callable(arg0: Receipt, arg1: &mut 0x2::tx_context::TxContext) {
        let Receipt {
            id              : v0,
            amount_invested : _,
        } = arg0;
    ...
    public(friend) fun handle_referrer_callable(arg0: &mut ReferralMap, arg1: address) {
        handle_referrer(arg0, arg1);
    }

    public(friend) fun handle_sui_invest_callable(arg0: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg1: &mut Presale, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u128 {
        assert!(arg3 > 0, 0);
        assert!(arg1.open, 0);
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.raised_amount_sui, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(arg2, arg3, arg4)));
        let (v0, _, _, _) = 0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::get_price(arg0, 371);
    ...
    public(friend) fun handle_usdc_invest_callable(arg0: &mut Presale, arg1: &mut 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : u128 {
        assert!(arg2 > 0, 0);
        assert!(arg0.open, 0);
        0x2::balance::join<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg0.raised_amount_usdc, 0x2::coin::into_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(0x2::coin::split<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg1, arg2, arg3)));
        let v0 = (arg2 as u128) * 1000;
    ...
    public fun invested_amount_of(arg0: &Receipt) : u128 {
        arg0.amount_invested
    }

    public entry fun mint_by_admin(arg0: &PresaleOwnerCap, arg1: &mut Presale, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = (arg3 as u128) * 1000;
        arg1.total_raised_amount_usd = arg1.total_raised_amount_usd + v0;
        let v1 = Receipt{
            id              : 0x2::object::new(arg4),
            amount_invested : v0,
        };
        0x2::transfer::transfer<Receipt>(v1, arg2);
    }
