module 0xdb9d33079523f13af15d9eba11772023c25bfeec0d1506a29db00647e6f0a171::gift8291 {
    struct GIFT8291 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift8291(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT8291, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8291>(arg0, arg1);
