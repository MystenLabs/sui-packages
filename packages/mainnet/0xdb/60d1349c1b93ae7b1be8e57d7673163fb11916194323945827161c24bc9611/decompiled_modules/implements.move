module 0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::implements {
    ...
    public(friend) fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LP<T0, T1>>, vector<u64>) {
        ...
        let v9 = if (0 == v6) {
            let v10 = 0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::math::sqrt(0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::math::mul_to_u128(v7, v8));
            assert!(v10 > 1000, 8);
    ...
    public fun calc_optimal_coin_values(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : (u64, u64) {
        ...
        let v0 = 0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::math::mul_div(arg0, arg5, arg4);
        if (v0 <= arg1) {
            assert!(v0 >= arg3, 4);
            return (arg0, v0)
        };
        let v1 = 0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::math::mul_div(arg1, arg4, arg5);
        assert!(v1 <= arg0, 6);
        assert!(v1 >= arg2, 3);
        (v1, arg1)
    }
    ...
    public fun get_amount_out(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::math::mul_div_u128(v0, (arg2 as u128), (arg1 as u128) * (10000 as u128) + v0)
    }
    ...
    public fun get_fee_to_fundation(arg0: u64, arg1: u64) : u64 {
        0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::math::mul_div(arg0, arg1, 10000)
    }
    ...
    public fun get_swap_out<T0, T1>(arg0: &mut Global, arg1: u64, arg2: bool) : u64 {
        ...
        if (arg2) {
            ...
            if (v11) {
                let v15 = 0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::math::mul_div(arg1, (v10.free_ratio as u64), 100);
                arg1 = arg1 - v15;
            };
    ...
    public fun is_order<T0, T1>() : bool {
        ...
        let v2 = 0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::comparator::compare<0x1::type_name::TypeName>(&v0, &v1);
        assert!(!0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::comparator::is_equal(&v2), 9);
        0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::comparator::is_smaller_than(&v2)
    }
    ...
    public fun is_sui<T0>() : bool {
        ...
        let v2 = 0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::comparator::compare<0x1::ascii::String>(&v1, &v0);
        0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::comparator::is_equal(&v2)
    }
    ...
    public(friend) fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        (0x2::coin::take<T0>(&mut arg0.coin_x, 0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::math::mul_div(v1, v0, v3), arg3), 0x2::coin::take<T1>(&mut arg0.coin_y, 0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::math::mul_div(v2, v0, v3), arg3))
    }
    ...
    public(friend) fun swapCoin<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (arg3) {
            ...
            if (v19) {
                let v26 = 0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::math::mul_div(v23, (v18.free_ratio as u64), 100);
    ...
    public(friend) fun swap_out<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        if (arg3) {
            ...
            if (v21) {
                let v28 = 0xdb60d1349c1b93ae7b1be8e57d7673163fb11916194323945827161c24bc9611::math::mul_div(v25, (v20.free_ratio as u64), 100);
