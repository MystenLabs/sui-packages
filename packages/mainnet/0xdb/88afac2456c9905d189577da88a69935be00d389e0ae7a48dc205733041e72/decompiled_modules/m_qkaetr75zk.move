module 0xdb88afac2456c9905d189577da88a69935be00d389e0ae7a48dc205733041e72::m_qkaetr75zk {
    struct T_evvsobbppw has store, key {
        id: 0x2::object::UID,
        vault_id: 0x2::object::ID,
    }

    struct T_t6b7qzmbil has key {
        id: 0x2::object::UID,
    ...
    struct T_sehobv3anb has copy, drop {
        vault_id: 0x2::object::ID,
        keeper_cap_id: 0x2::object::ID,
        owner: address,
        profit_recipient: address,
    ...
    struct T_qwsfijcatl has copy, drop {
        amount: u64,
        recipient: address,
    }

    public entry fun f_3s5mrt4tnq(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::object::id<T_evvsobbppw>(&v2);
        ...
        0x2::event::emit<T_sehobv3anb>(v6);
        0x2::transfer::public_transfer<T_evvsobbppw>(v2, v4);
        0x2::transfer::share_object<T_t6b7qzmbil>(v5);
    }

    public fun f_7rr7vsaxy3<T0>(arg0: &mut T_t6b7qzmbil, arg1: 0x2::coin::Coin<T0>) {
        f_nexhoy2nlv<T0>(arg0, 0x2::coin::into_balance<T0>(arg1));
    }

    public fun f_bcpevbhef4<T0>(arg0: &mut T_t6b7qzmbil, arg1: &T_evvsobbppw, arg2: u64) : 0x2::balance::Balance<T0> {
        f_swphzwdnav(arg0, arg1);
    ...
    public fun f_fls27zowo5(arg0: &T_t6b7qzmbil) : address {
        arg0.profit_recipient
    }

    public fun f_fn5o6koohr<T0>(arg0: &mut T_t6b7qzmbil, arg1: &T_evvsobbppw, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = f_bcpevbhef4<T0>(arg0, arg1, arg2);
    ...
    public fun f_nexhoy2nlv<T0>(arg0: &mut T_t6b7qzmbil, arg1: 0x2::balance::Balance<T0>) {
        let v0 = 0x1::type_name::get<T0>();
        if (0x2::bag::contains_with_type<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg0.balances, v0)) {
    ...
    fun f_swphzwdnav(arg0: &T_t6b7qzmbil, arg1: &T_evvsobbppw) {
        assert!(0x2::object::id<T_evvsobbppw>(arg1) == arg0.keeper_cap_id, 0);
        assert!(arg1.vault_id == 0x2::object::id<T_t6b7qzmbil>(arg0), 0);
    }

    public entry fun f_uos5ay5usk(arg0: &mut T_t6b7qzmbil, arg1: &T_evvsobbppw) {
        f_swphzwdnav(arg0, arg1);
