module 0x2628bdfa2ff1a54bdb5d7fffc579236c90da4ec6daee84c223c97daa38fce74a::guild {
    ...
    public(friend) fun set_checkin(arg0: &Config, arg1: &mut UserArchive, arg2: &0x2::clock::Clock) : (u64, u64) {
        ...
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg1.id, b"CHECKIN_KEY") && v2 > 0) {
            let v3 = Checkin{
                checkin_days      : 1,
                last_checkin_time : v0,
            };
            0x2::dynamic_field::add<vector<u8>, Checkin>(&mut arg1.id, b"CHECKIN_KEY", v3);
            return (1, v0)
        };
        let v4 = 0x2::dynamic_field::borrow_mut<vector<u8>, Checkin>(&mut arg1.id, b"CHECKIN_KEY");
        assert!(v4.last_checkin_time < v1, 6024);
        let v5 = if (v2 > 0) {
            if (v1 - v4.last_checkin_time > 86400000 || v4.checkin_days + 1 > v2) {
                1
            } else {
                v4.checkin_days + 1
            }
        ...
        v4.checkin_days = v5;
        v4.last_checkin_time = v0;
        (v4.checkin_days, v4.last_checkin_time)
    }
