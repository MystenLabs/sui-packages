module 0xdbcfce77a6a5f42eb96b3d429e0bf04c7b66d17738a4217176b3046980c5ac8d::husby {
    ...
    fun init(arg0: HUSBY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<HUSBY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"HUSBY   ")))), trim_right(b"HUSBY                           "), trim_right(b"HUSBY is a registered company in Europe, transforming biogas into nearly free electricity for profitable crypto mining.                                                                                                                                                                                                         "), v2, arg1);
