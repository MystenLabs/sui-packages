module 0xdb1d2fc7f69622184a5787c388ecec7881fd78f1086a44bb048f5603fc161e5f::cnsnft4475 {
    struct CNSNFT4475 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4475, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4475>(arg0, arg1);
