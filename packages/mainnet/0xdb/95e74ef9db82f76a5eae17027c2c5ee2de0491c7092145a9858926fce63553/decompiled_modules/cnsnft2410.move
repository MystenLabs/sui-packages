module 0xdb95e74ef9db82f76a5eae17027c2c5ee2de0491c7092145a9858926fce63553::cnsnft2410 {
    struct CNSNFT2410 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2410, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2410>(arg0, arg1);
