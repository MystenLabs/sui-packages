module 0xdbfa51d345c19282bc63c2d56d613fcab49065828c9fa45d2ed8df5dbf303dc8::reward5497 {
    struct REWARD5497 has drop {
        dummy_field: bool,
    }

    struct TICKET_5497 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5497(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5497>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5497>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5497, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5497>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5497>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5497>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5497>>(v5, 0x2::tx_context::sender(arg1));
    }
