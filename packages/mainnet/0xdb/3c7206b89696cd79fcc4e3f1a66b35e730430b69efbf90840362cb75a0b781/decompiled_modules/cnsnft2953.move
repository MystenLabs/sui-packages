module 0xdb3c7206b89696cd79fcc4e3f1a66b35e730430b69efbf90840362cb75a0b781::cnsnft2953 {
    struct CNSNFT2953 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2953, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2953>(arg0, arg1);
