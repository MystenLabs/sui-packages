module 0xdba1ddbb6a5478e655dedec48993af39f63a4cce9b569fd08ea76adaf35f43b0::common_utils {
    ...
    public fun getDisplay<T0: store + key>(arg0: &0x2::display::Display<T0>) : 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
