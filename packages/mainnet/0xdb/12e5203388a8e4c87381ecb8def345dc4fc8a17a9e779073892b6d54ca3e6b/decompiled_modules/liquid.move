module 0xdb12e5203388a8e4c87381ecb8def345dc4fc8a17a9e779073892b6d54ca3e6b::liquid {
    ...
    fun init(arg0: LIQUID, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Suisses ONE-Event"));
