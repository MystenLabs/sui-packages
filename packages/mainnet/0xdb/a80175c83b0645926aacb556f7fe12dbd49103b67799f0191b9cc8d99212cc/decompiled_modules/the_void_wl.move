module 0xdba80175c83b0645926aacb556f7fe12dbd49103b67799f0191b9cc8d99212cc::the_void_wl {
    struct THE_VOID_WL has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: THE_VOID_WL, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<THE_VOID_WL>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"The Void WL"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Void NFT WL"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://kI4HKG7zDDSqj7I-dv1wt7qWE9PUCm596w9ZQj3zQNo"));
