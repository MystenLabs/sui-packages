module 0xdb93883626862c754b8030c7551cd505d94b9c75072f39f9c1f6dab755bf612f::pope {
    ...
    fun init(arg0: POPE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/ZW2yxXAb5MjVoDD1aPyPFFG2UNQVADNgH3pxJTGpump.png?size=lg&key=4f9c4d                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<POPE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"POPE    ")))), trim_right(b"RIP Pope Francis                "), trim_right(b"Pope Francis has died aged 88.                                                                                                                                                                                                                                                                                                  "), v2, arg1);
        let v5 = v3;
