module 0xdb417374f5d051ca6d41f989b2c3bd876434cf15f82071b464ba3fc07de0ccc9::cross_chain_airdrop {
    struct StaccNFT has store, key {
        id: 0x2::object::UID,
        name: 0x1::string::String,
        description: 0x1::string::String,
        url: 0x2::url::Url,
        source_contract_address: 0x1::string::String,
    }
    ...
    struct PerContractAirdropInfo has store {
        ...
        claimed_source_token_ids: vector<0xdb417374f5d051ca6d41f989b2c3bd876434cf15f82071b464ba3fc07de0ccc9::erc721_metadata::TokenID>,
    }
    ...
    public entry fun claim(arg0: &mut CrossChainAirdropOracle, arg1: address, arg2: vector<u8>, arg3: u256, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xdb417374f5d051ca6d41f989b2c3bd876434cf15f82071b464ba3fc07de0ccc9::erc721_metadata::new_token_id(arg3);
        assert!(!is_token_claimed(v0, &v1), 0);
        mint(arg4, arg7, arg6, arg1, arg2, arg8);
        0x1::vector::push_back<0xdb417374f5d051ca6d41f989b2c3bd876434cf15f82071b464ba3fc07de0ccc9::erc721_metadata::TokenID>(&mut v0.claimed_source_token_ids, v1);
    }
    ...
    fun create_contract(arg0: &mut CrossChainAirdropOracle, arg1: &vector<u8>) : &mut PerContractAirdropInfo {
        ...
        let v1 = PerContractAirdropInfo{
            ...
            claimed_source_token_ids : 0x1::vector::empty<0xdb417374f5d051ca6d41f989b2c3bd876434cf15f82071b464ba3fc07de0ccc9::erc721_metadata::TokenID>(),
        };
    ...
    fun init(arg0: CROSS_CHAIN_AIRDROP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://twitter.com/staccoverflow"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{url}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{description}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://twitter.com/staccoverflow"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{source_contract_address}"));
    ...
    fun is_token_claimed(arg0: &PerContractAirdropInfo, arg1: &0xdb417374f5d051ca6d41f989b2c3bd876434cf15f82071b464ba3fc07de0ccc9::erc721_metadata::TokenID) : bool {
        let v0 = 0;
        while (v0 < 0x1::vector::length<0xdb417374f5d051ca6d41f989b2c3bd876434cf15f82071b464ba3fc07de0ccc9::erc721_metadata::TokenID>(&arg0.claimed_source_token_ids)) {
            if (0x1::vector::borrow<0xdb417374f5d051ca6d41f989b2c3bd876434cf15f82071b464ba3fc07de0ccc9::erc721_metadata::TokenID>(&arg0.claimed_source_token_ids, v0) == arg1) {
                return true
            };
            v0 = v0 + 1;
        };
    ...
    public entry fun mint(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: address, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = StaccNFT{
            id                      : 0x2::object::new(arg5),
            name                    : 0x1::string::utf8(arg0),
            description             : 0x1::string::utf8(arg1),
            url                     : 0x2::url::new_unsafe_from_bytes(arg2),
            source_contract_address : 0x1::string::utf8(arg4),
        };
        let v1 = MintNFTEvent{
