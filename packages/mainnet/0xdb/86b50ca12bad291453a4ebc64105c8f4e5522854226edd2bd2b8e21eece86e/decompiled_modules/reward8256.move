module 0xdb86b50ca12bad291453a4ebc64105c8f4e5522854226edd2bd2b8e21eece86e::reward8256 {
    struct REWARD8256 has drop {
        dummy_field: bool,
    }

    struct TICKET_8256 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8256(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8256>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8256>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8256, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8256>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8256>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8256>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8256>>(v5, 0x2::tx_context::sender(arg1));
    }
