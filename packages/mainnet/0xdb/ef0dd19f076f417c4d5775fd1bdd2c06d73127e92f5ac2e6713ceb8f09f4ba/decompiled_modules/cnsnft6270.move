module 0xdbef0dd19f076f417c4d5775fd1bdd2c06d73127e92f5ac2e6713ceb8f09f4ba::cnsnft6270 {
    struct CNSNFT6270 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6270, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6270>(arg0, arg1);
