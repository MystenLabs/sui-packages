module 0xdbe810e248bc128d6228921778bcb9c363862628a3a67971a82b72989900431c::nihu_token {
    struct NIHU_TOKEN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NIHU_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NIHU_TOKEN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"NiHu Token"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"NiHu Token (NHT) represents the innovative spirit of its creators, blending technology with community-driven growth. It aims to empower users by providing a versatile token that fosters both utility and engagement. Designed with the principles of decentralization and collaboration, NHT is set to become the foundation of a dynamic digital ecosystem."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreicqg34e6xhoyute4qr7wnpirv6vfphm7xfej4irtluzkf7vqeop24"));
