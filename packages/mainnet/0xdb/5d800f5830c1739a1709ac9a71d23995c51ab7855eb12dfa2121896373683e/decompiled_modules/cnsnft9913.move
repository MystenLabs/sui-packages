module 0xdb5d800f5830c1739a1709ac9a71d23995c51ab7855eb12dfa2121896373683e::cnsnft9913 {
    struct CNSNFT9913 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9913, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9913>(arg0, arg1);
