module 0xe9dbdcffd693470af302da6ed3d211862768d2b649746052b406c2518cc00fc0::ido_claim_private {
    ...
    struct InfoClaimRefund has copy, drop, store {
        total_private_deposit: u64,
        total_private_claim: u64,
        total_claimed: u64,
    }
    ...
    public entry fun claim_coins_with_private(arg0: &0x2f6caff123c91121d4cc31f23a284d04a01efd19b09ece313fd172d697657228::tocen_event_ido::TocenIdoData, arg1: &mut TocenIdoDataClaim, arg2: &mut PoolClaim, arg3: u64, arg4: vector<u8>, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 == arg2.turn, 7);
        let (v0, v1) = 0x2f6caff123c91121d4cc31f23a284d04a01efd19b09ece313fd172d697657228::tocen_event_ido::get_balance_private_deposit(arg0, arg7);
        assert!(v0 == 1, 10);
        ...
        if (!0x2::dynamic_field::exists_<address>(&arg1.id, 0x2::tx_context::sender(arg7))) {
            let v2 = InfoClaimRefund{
                total_private_deposit : v1,
                total_private_claim   : v1 * arg1.percent_rate_price_sale / arg1.rate_price_sale,
                total_claimed         : 0,
            };
        ...
        let v5 = v3.total_private_claim * arg2.percent / arg2.total_percent;
        ...
        *v4 = *v4 + v5;
        ...
        arg2.total_claimed = arg2.total_claimed + v5;
    ...
    public entry fun create_pool_claim(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0xe9dbdcffd693470af302da6ed3d211862768d2b649746052b406c2518cc00fc0::witness::check_owner(arg5), 1);
        let v0 = PoolClaim{
            ...
            percent         : arg3,
            total_percent   : arg4,
            key             : 0xe9dbdcffd693470af302da6ed3d211862768d2b649746052b406c2518cc00fc0::utils::get_key_claim(),
        };
    ...
    public fun init_ido(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = TocenIdoDataClaim{
            ...
            total_token_sale         : 0xe9dbdcffd693470af302da6ed3d211862768d2b649746052b406c2518cc00fc0::utils::get_total_token_sale(),
            percent_rate_price_sale  : 0xe9dbdcffd693470af302da6ed3d211862768d2b649746052b406c2518cc00fc0::utils::get_percent_rate_price_sale(),
            rate_price_sale          : 0xe9dbdcffd693470af302da6ed3d211862768d2b649746052b406c2518cc00fc0::utils::get_rate_price_sale(),
            total_claimed            : 0,
            timestamp_start_not_sale : 0xe9dbdcffd693470af302da6ed3d211862768d2b649746052b406c2518cc00fc0::utils::get_time_not_sale(),
            not_sale                 : 0x2::balance::zero<0x2::sui::SUI>(),
            key_not_sale             : 0xe9dbdcffd693470af302da6ed3d211862768d2b649746052b406c2518cc00fc0::utils::get_key_not_sale(),
        };
    ...
    public entry fun pool_claim_not_sale(arg0: &mut TocenIdoDataClaim, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xe9dbdcffd693470af302da6ed3d211862768d2b649746052b406c2518cc00fc0::witness::check_owner(arg3), 1);
        let v0 = &mut arg0.not_sale;
        transferSui(v0, arg1, arg2, arg3);
    }

    public entry fun refund_coins_with_private(arg0: &0x2f6caff123c91121d4cc31f23a284d04a01efd19b09ece313fd172d697657228::tocen_event_ido::TocenIdoData, arg1: &mut TocenIdoDataClaim, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::ed25519::ed25519_verify(&arg2, &arg1.key_not_sale, &arg3), 12);
        let (v0, v1) = 0x2f6caff123c91121d4cc31f23a284d04a01efd19b09ece313fd172d697657228::tocen_event_ido::get_balance_private_deposit(arg0, arg5);
        assert!(v0 == 1, 1);
        let v2 = EventRefund{
    ...
    public entry fun setup_cle(arg0: &mut TocenIdoDataClaim, arg1: address) {
        0x2::dynamic_field::remove<address, InfoClaimRefund>(&mut arg0.id, arg1);
    }

    public entry fun setup_cleturn(arg0: &mut PoolClaim, arg1: address) {
    ...
    public entry fun token_pool_claim(arg0: &mut PoolClaim, arg1: u64, arg2: 0x2::coin::Coin<0xd2013e206f7983f06132d5b61f7c577638ff63171221f4f600a98863febdfb47::toce::TOCE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0xe9dbdcffd693470af302da6ed3d211862768d2b649746052b406c2518cc00fc0::witness::check_owner(arg4), 1);
    ...
    public entry fun up_pool_claim(arg0: &mut PoolClaim, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0xe9dbdcffd693470af302da6ed3d211862768d2b649746052b406c2518cc00fc0::witness::check_owner(arg6), 1);
        assert!(arg1 == arg0.turn, 7);
    ...
    public entry fun update_time_claim_not_sale(arg0: &mut TocenIdoDataClaim, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xe9dbdcffd693470af302da6ed3d211862768d2b649746052b406c2518cc00fc0::witness::check_owner(arg2), 1);
        arg0.timestamp_start_not_sale = arg1;
    }
