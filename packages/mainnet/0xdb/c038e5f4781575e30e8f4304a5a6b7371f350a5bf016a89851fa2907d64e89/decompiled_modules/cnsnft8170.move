module 0xdbc038e5f4781575e30e8f4304a5a6b7371f350a5bf016a89851fa2907d64e89::cnsnft8170 {
    struct CNSNFT8170 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8170, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8170>(arg0, arg1);
