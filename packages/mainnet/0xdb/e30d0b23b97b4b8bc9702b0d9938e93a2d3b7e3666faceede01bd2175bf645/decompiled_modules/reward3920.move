module 0xdbe30d0b23b97b4b8bc9702b0d9938e93a2d3b7e3666faceede01bd2175bf645::reward3920 {
    struct REWARD3920 has drop {
        dummy_field: bool,
    }

    struct TICKET_3920 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3920(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3920>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3920>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3920, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3920>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3920>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3920>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3920>>(v5, 0x2::tx_context::sender(arg1));
    }
