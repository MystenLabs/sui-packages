module 0xdbdd599232c3397723ce06e8858020839a08875804ca6b09bc3bab01850cfd68::maxi {
    ...
    fun init(arg0: MAXI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<MAXI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"maxi      ")))), trim_right(b"maxi                            "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
