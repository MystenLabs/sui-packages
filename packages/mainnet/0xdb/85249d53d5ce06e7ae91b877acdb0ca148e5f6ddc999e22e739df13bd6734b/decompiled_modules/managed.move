module 0xdb85249d53d5ce06e7ae91b877acdb0ca148e5f6ddc999e22e739df13bd6734b::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<MANAGED>(arg0, 6, b"Quan", b"", b"", 0x1::option::none<0x2::url::Url>(), false, arg1);
