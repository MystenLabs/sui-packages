module 0x4b1feb4e2eeec04800670eea1398ddf5eb3472a20f02acf6fb89da556499afff::loan_registry {
    ...
    entry fun close_loan<T0, T1>(arg0: &0x4b1feb4e2eeec04800670eea1398ddf5eb3472a20f02acf6fb89da556499afff::operator::OperatorCap, arg1: &mut 0x4b1feb4e2eeec04800670eea1398ddf5eb3472a20f02acf6fb89da556499afff::state::State, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let Loan {
            ...
            repay_balance     : v12,
            status            : _,
        } = 0x4b1feb4e2eeec04800670eea1398ddf5eb3472a20f02acf6fb89da556499afff::state::remove<LoanKey<T0, T1>, Loan<T0, T1>>(arg1, new_loan_key<T0, T1>(arg2));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x1::option::destroy_some<0x2::balance::Balance<T1>>(v7), arg3), v0);
