module 0xe7fd7d979501276dd82a454ab930b5c877871edb55ddbaaccbe7eeaa738b71f5::oracle {
    ...
    public fun update_price(arg0: &mut Oracle, arg1: &0x37c698a0814b09bccce2474b2c08064c53bfac7b15d054b4f4f09618d7c7980f::oracle::PriceInfo) {
        abort 4
    }

    public(friend) fun update_price_internal(arg0: &mut Oracle, arg1: &0x37c698a0814b09bccce2474b2c08064c53bfac7b15d054b4f4f09618d7c7980f::oracle::PriceInfo) {
        let v0 = OracleIdentityKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<OracleIdentityKey, OracleIdentity>(&mut arg0.id, v0);
        assert!(0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&v1.id, 0x37c698a0814b09bccce2474b2c08064c53bfac7b15d054b4f4f09618d7c7980f::oracle::coin_type(arg1)), 3);
        let v2 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, PriceInfo>(&mut v1.id, 0x37c698a0814b09bccce2474b2c08064c53bfac7b15d054b4f4f09618d7c7980f::oracle::coin_type(arg1));
        if (v2.last_updated >= 0x37c698a0814b09bccce2474b2c08064c53bfac7b15d054b4f4f09618d7c7980f::oracle::get_updated_time(arg1)) {
            return
        };
        v2.price = 0x37c698a0814b09bccce2474b2c08064c53bfac7b15d054b4f4f09618d7c7980f::oracle::get_price(arg1);
        v2.ema_price = 0x37c698a0814b09bccce2474b2c08064c53bfac7b15d054b4f4f09618d7c7980f::oracle::get_ema_price(arg1);
        v2.last_updated = 0x37c698a0814b09bccce2474b2c08064c53bfac7b15d054b4f4f09618d7c7980f::oracle::get_updated_time(arg1);
    }
