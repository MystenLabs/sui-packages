module 0xdb6caa26733e63cb4761d836a1b8ae710fa642f3a903553aaf1a2c6df35d13b0::cnsnft2812 {
    struct CNSNFT2812 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2812, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8961"));
        let v4 = 0x2::package::claim<CNSNFT2812>(arg0, arg1);
