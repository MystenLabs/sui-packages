module 0xdb96d18376a5ae96e6bb35a39e36076cb66202d12413e5ed153e5a9f2274c282::suilend_adapter {
    ...
    public fun new<T0, T1, T2>(arg0: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg1: u64, arg2: vector<0x1::type_name::TypeName>, arg3: vector<u64>, arg4: vector<0x1::type_name::TypeName>, arg5: vector<0x2::object::ID>, arg6: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::acl::AdminWitness<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam::SAM>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<0x1::type_name::TypeName>(&arg2) == 0x1::vector::length<u64>(&arg3), 13906834384796778495);
        ...
        assert!(0x1::vector::length<0x1::type_name::TypeName>(&arg4) == 0x1::vector::length<0x2::object::ID>(&arg5), 13906834401976647679);
    ...
    public fun set_reward_index_table<T0, T1, T2>(arg0: &mut SuilendAdapter<T0, T1, T2>, arg1: vector<0x1::type_name::TypeName>, arg2: vector<0x1::type_name::TypeName>, arg3: vector<u64>, arg4: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::acl::AdminWitness<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam::SAM>) {
        ...
        0x1::vector::reverse<u64>(&mut arg3);
        assert!(0x1::vector::length<0x1::type_name::TypeName>(&arg2) == 0x1::vector::length<u64>(&arg3), 13906834513645797375);
        0x1::vector::reverse<0x1::type_name::TypeName>(&mut arg2);
        let v1 = 0;
    ...
    public fun set_reward_pool_table<T0, T1, T2>(arg0: &mut SuilendAdapter<T0, T1, T2>, arg1: vector<0x1::type_name::TypeName>, arg2: vector<0x1::type_name::TypeName>, arg3: vector<0x2::object::ID>, arg4: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::acl::AdminWitness<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam::SAM>) {
        ...
        assert!(0x1::vector::length<0x1::type_name::TypeName>(&arg2) == 0x1::vector::length<0x2::object::ID>(&arg3), 13906834582365274111);
        0x1::vector::reverse<0x1::type_name::TypeName>(&mut arg2);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&arg2)) {
    ...
    fun swap_rewards<T0, T1, T2, T3>(arg0: &SuilendAdapter<T0, T1, T2>, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T3>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T3>) {
        assert!(*0x2::table::borrow<0x1::type_name::TypeName, 0x2::object::ID>(&arg0.reward_pool_table, 0x1::type_name::get<T3>()) == 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T3>>(arg3), 13906836497920688127);
    ...
    fun withdraw_staked_sui_amount<T0, T1>(arg0: &SuilendAdapter<T0, 0x2::sui::SUI, T1>, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x2::clock::Clock, arg3: 0x1::option::Option<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::RateLimiterExemption<T0, 0x2::sui::SUI>>, arg4: &mut 0x3::sui_system::SuiSystemState, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::redeem_ctokens_and_withdraw_liquidity_request<T0, 0x2::sui::SUI>(arg1, arg0.reserve_array_index, arg2, 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::withdraw_ctokens<T0, 0x2::sui::SUI>(arg1, arg0.reserve_array_index, &arg0.obligation_owner_cap, arg2, 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::floor(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::div(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::from(arg5), 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::ctoken_ratio<T0>(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::reserve<T0, 0x2::sui::SUI>(arg1)))), arg6), arg3, arg6);
        0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::unstake_sui_from_staker<T0>(arg1, arg0.reserve_array_index, &v0, arg4, arg6);
        0x2::coin::into_balance<0x2::sui::SUI>(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::fulfill_liquidity_request<T0, 0x2::sui::SUI>(arg1, arg0.reserve_array_index, v0, arg6))
    }
