module 0xdb953c85dea2f9297bf1c2a2653ac7254891d1f650276820c6dadaf12fba2f3d::reward6806 {
    struct REWARD6806 has drop {
        dummy_field: bool,
    }

    struct TICKET_6806 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6806(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6806>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6806>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6806, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6806>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6806>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6806>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6806>>(v5, 0x2::tx_context::sender(arg1));
    }
