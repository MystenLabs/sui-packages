module 0xdb0eb1a5d46638a688e2a6f1ff0d83afeb1f4e7a2861b3b58ce68362066d3abe::inspector {
    ...
    fun init(arg0: INSPECTOR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_field::add<u8, 0x2::coin::TreasuryCap<INSPECTOR>>(&mut v2.id, 0, v0);
        0x2::dynamic_field::add<u8, 0x2::coin::CoinMetadata<INSPECTOR>>(&mut v2.id, 1, v1);
    ...
    public fun unwrap<T0>(arg0: Holder<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::dynamic_field::remove<u8, 0x2::coin::TreasuryCap<T0>>(&mut v0, 0);
        let v2 = 0x2::dynamic_field::remove<u8, 0x2::coin::CoinMetadata<T0>>(&mut v0, 1);
