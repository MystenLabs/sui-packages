module 0xdbcc97ff2ba874fc23a92ca0d3873f1526104a75bd97046cbd4fa19b995614a1::cnsnft3223 {
    struct CNSNFT3223 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3223, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3223>(arg0, arg1);
