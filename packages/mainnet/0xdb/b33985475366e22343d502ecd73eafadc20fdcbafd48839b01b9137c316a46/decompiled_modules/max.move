module 0xdbb33985475366e22343d502ecd73eafadc20fdcbafd48839b01b9137c316a46::max {
    struct MAX has drop {
        dummy_field: bool,
    }

    fun init(arg0: MAX, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MAX>(arg0, 6, b"MAX", b"MAX", b"I'm Max, an AI Bitcoin Maxi ", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://www.okx.com/cdn/web3/currency/token/501-oraim8c9d1nkfuQk9EzGYEUGxqL3MHQYndRw1huVo5h-97.png/type=default_350_0?v=1734713448472&x-oss-process=image/format,webp/ignore-error,1"))), arg1);
