module 0xeedca51c1e3302970446810ac44ae813c1313a18f149f6e97f5bbeed035fed7a::navi_vault {
    ...
    public(friend) fun assert_active<T0, T1>(arg0: &Vault<T0, T1>) {
        assert!(lifecycle<T0, T1>(arg0) == 0, 100);
    }
    ...
    public(friend) fun assert_finalized<T0, T1>(arg0: &Vault<T0, T1>) {
        assert!(lifecycle<T0, T1>(arg0) == 2, 102);
    }

    public(friend) fun assert_reward_collection_state<T0, T1>(arg0: &Vault<T0, T1>) {
        let v0 = lifecycle<T0, T1>(arg0);
        assert!(v0 == 1 || v0 == 2, 104);
    }

    public(friend) fun assert_unwinding<T0, T1>(arg0: &Vault<T0, T1>) {
        assert!(lifecycle<T0, T1>(arg0) == 1, 101);
    }

    public(friend) fun begin_wind_down<T0: store, T1>(arg0: &mut Vault<T0, T1>) {
    ...
    public(friend) fun begin_wind_down_v2<T0, T1>(arg0: &mut Vault<T0, T1>) {
        assert_active<T0, T1>(arg0);
        arg0.deposits_enabled = false;
        let v0 = WindDownStateKey{dummy_field: false};
        let v1 = WindDownState{lifecycle: 1};
    ...
    public(friend) fun deposit_<T0, T1>(arg0: &Vault<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = deposited<T0, T1>(arg0, arg3, arg2);
        assert_deposits_enabled<T0, T1>(arg0, v0);
        0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::deposit_with_account_cap<T0>(arg6, arg2, arg3, arg0.depost_asset_index, 0x2::coin::from_balance<T0>(arg1, arg7), arg4, arg5, account_cap<T0, T1>(arg0));
    }
    ...
    public fun final_assets<T0: store, T1>(arg0: &Vault<T0, T1>) : u64 {
    ...
    public fun final_assets_v2<T0, T1>(arg0: &Vault<T0, T1>) : u64 {
        let v0 = FinalAssetsKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<FinalAssetsKey>(&arg0.id, v0)) {
            return 0
        };
    ...
    public(friend) fun finalize_wind_down<T0: store, T1>(arg0: &mut Vault<T0, T1>) {
        assert_unwinding<T0, T1>(arg0);
        let v0 = 0x2::balance::withdraw_all<T0>(&mut arg0.collected_withdrawal_fees);
        0x2::balance::join<T0>(&mut v0, 0x2::balance::withdraw_all<T0>(&mut arg0.collected_performance_fees));
        let v1 = FinalAssetsKey{dummy_field: false};
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<FinalAssetsKey, 0x2::balance::Balance<T0>>(&mut arg0.id, v1), v0);
        let v2 = WindDownStateKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<WindDownStateKey, WindDownState>(&mut arg0.id, v2).lifecycle = 2;
    }

    public(friend) fun finalize_wind_down_v2<T0, T1>(arg0: &mut Vault<T0, T1>) {
        assert_unwinding<T0, T1>(arg0);
        let v0 = 0x2::balance::withdraw_all<T0>(&mut arg0.collected_withdrawal_fees);
        0x2::balance::join<T0>(&mut v0, 0x2::balance::withdraw_all<T0>(&mut arg0.collected_performance_fees));
        let v1 = FinalAssetsKey{dummy_field: false};
    ...
    public(friend) fun join_final_assets<T0: store, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T0>) {
        assert_unwinding<T0, T1>(arg0);
        let v0 = FinalAssetsKey{dummy_field: false};
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<FinalAssetsKey, 0x2::balance::Balance<T0>>(&mut arg0.id, v0), arg1);
    }

    public(friend) fun join_final_assets_v2<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T0>) {
        assert_unwinding<T0, T1>(arg0);
        let v0 = FinalAssetsKey{dummy_field: false};
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<FinalAssetsKey, 0x2::balance::Balance<T0>>(&mut arg0.id, v0), arg1);
    }

    public(friend) fun join_settled_reward<T0: store, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T0>) {
        assert_finalized<T0, T1>(arg0);
        let v0 = FinalAssetsKey{dummy_field: false};
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<FinalAssetsKey, 0x2::balance::Balance<T0>>(&mut arg0.id, v0), arg1);
    }

    public(friend) fun join_settled_reward_v2<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T0>) {
        assert_finalized<T0, T1>(arg0);
        let v0 = FinalAssetsKey{dummy_field: false};
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<FinalAssetsKey, 0x2::balance::Balance<T0>>(&mut arg0.id, v0), arg1);
    }

    public fun lifecycle<T0, T1>(arg0: &Vault<T0, T1>) : u8 {
        let v0 = WindDownStateKey{dummy_field: false};
    ...
    public(friend) fun store_wind_down_reward<T0, T1, T2>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T2>) {
        assert_reward_collection_state<T0, T1>(arg0);
        assert!(0x2::balance::value<T2>(&arg1) > 0, 105);
        let v0 = WindDownRewardKey<T2>{dummy_field: false};
        if (0x2::dynamic_field::exists_with_type<WindDownRewardKey<T2>, 0x2::balance::Balance<T2>>(&arg0.id, v0)) {
            0x2::balance::join<T2>(0x2::dynamic_field::borrow_mut<WindDownRewardKey<T2>, 0x2::balance::Balance<T2>>(&mut arg0.id, v0), arg1);
        } else {
            0x2::dynamic_field::add<WindDownRewardKey<T2>, 0x2::balance::Balance<T2>>(&mut arg0.id, v0, arg1);
        };
    }

    public fun stored_wind_down_reward<T0, T1, T2>(arg0: &Vault<T0, T1>) : u64 {
        let v0 = WindDownRewardKey<T2>{dummy_field: false};
        if (0x2::dynamic_field::exists_with_type<WindDownRewardKey<T2>, 0x2::balance::Balance<T2>>(&arg0.id, v0)) {
            0x2::balance::value<T2>(0x2::dynamic_field::borrow<WindDownRewardKey<T2>, 0x2::balance::Balance<T2>>(&arg0.id, v0))
        } else {
            0
        }
    }

    public(friend) fun take_finalized_share<T0: store, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: u64) : (0x2::balance::Balance<T0>, u64) {
        assert_finalized<T0, T1>(arg0);
        let v0 = 0x2::coin::value<T1>(&arg1);
        let v1 = total_vt_supply<T0, T1>(arg0);
        assert!(v0 > 0 && v0 <= v1, 103);
        let v2 = proportional_share(final_assets<T0, T1>(arg0), v0, v1);
        assert!(v2 >= arg2, 103);
        0x2::coin::burn<T1>(&mut arg0.vt_treasury_cap, arg1);
    ...
    public(friend) fun take_finalized_share_v2<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: u64) : (0x2::balance::Balance<T0>, u64) {
        assert_finalized<T0, T1>(arg0);
        let v0 = 0x2::coin::value<T1>(&arg1);
        let v1 = total_vt_supply<T0, T1>(arg0);
        assert!(v0 > 0 && v0 <= v1, 103);
        let v2 = proportional_share(final_assets_v2<T0, T1>(arg0), v0, v1);
        assert!(v2 >= arg2, 103);
        0x2::coin::burn<T1>(&mut arg0.vt_treasury_cap, arg1);
        let v3 = FinalAssetsKey{dummy_field: false};
        (0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<FinalAssetsKey, 0x2::balance::Balance<T0>>(&mut arg0.id, v3), v2), v0)
    ...
    public(friend) fun take_wind_down_reward<T0, T1, T2>(arg0: &mut Vault<T0, T1>) : 0x2::balance::Balance<T2> {
        assert_finalized<T0, T1>(arg0);
        let v0 = WindDownRewardKey<T2>{dummy_field: false};
        assert!(0x2::dynamic_field::exists_with_type<WindDownRewardKey<T2>, 0x2::balance::Balance<T2>>(&arg0.id, v0), 106);
        0x2::dynamic_field::remove<WindDownRewardKey<T2>, 0x2::balance::Balance<T2>>(&mut arg0.id, v0)
    }
    ...
    public(friend) fun withdraw_<T0, T1>(arg0: &Vault<T0, T1>, arg1: u64, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg6: &0x2::clock::Clock, arg7: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle) : 0x2::balance::Balance<T0> {
        0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::withdraw_with_account_cap<T0>(arg6, arg7, arg2, arg3, arg0.depost_asset_index, arg1, arg4, arg5, account_cap<T0, T1>(arg0))
    }
