module 0xf84a2b7054cf840a19964abf5a5286018f2b7b648b6c8bf68474b09031d751f6::suiemoji {
    ...
    public entry fun buy<T0>(arg0: &mut SuiEmoji, arg1: &mut Pool<T0>, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 > 0) {
            ...
            if (arg1.complete == true) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.pool_coin, 0x2::balance::value<T0>(&arg1.pool_coin), arg4), @0xb1a584c0c49a5df394b80c445a3c640cb3e6d114c58f29ad87ee6651bfb0f068);
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.pool_sui, 0x2::balance::value<0x2::sui::SUI>(&arg1.pool_sui), arg4), @0xb1a584c0c49a5df394b80c445a3c640cb3e6d114c58f29ad87ee6651bfb0f068);
                let v8 = EndEvent{
                    pool_id     : 0x2::object::id<Pool<T0>>(arg1),
                    coin_type   : 0x1::type_name::get<T0>(),
                    event_index : arg0.event_index,
    ...
    public entry fun emergency_withdraw<T0>(arg0: &mut SuiEmoji, arg1: &mut Pool<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.pool_coin, 0x2::balance::value<T0>(&arg1.pool_coin), arg2), @0xb1a584c0c49a5df394b80c445a3c640cb3e6d114c58f29ad87ee6651bfb0f068);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.pool_sui, 0x2::balance::value<0x2::sui::SUI>(&arg1.pool_sui), arg2), @0xb1a584c0c49a5df394b80c445a3c640cb3e6d114c58f29ad87ee6651bfb0f068);
        arg1.complete = true;
    }
    ...
    fun init(arg0: SUIEMOJI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = SuiEmoji{
            ...
            admin           : @0xb1a584c0c49a5df394b80c445a3c640cb3e6d114c58f29ad87ee6651bfb0f068,
            max_sui_raise   : 6000000000000,
            event_index     : 0,
        };
    ...
    public entry fun start_new_coin<T0>(arg0: &mut SuiEmoji, arg1: 0x2::coin::CoinMetadata<T0>, arg2: 0x2::coin::TreasuryCap<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg6: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = (arg0.max_sui_raise as u256) * 11 / 12 / 100000;
        ...
        let v6 = Pool<T0>{
            ...
            virtual_sui_reserves  : (arg0.max_sui_raise as u128) * 3 / 8,
    ...
    public entry fun update<T0>(arg0: &mut SuiEmoji, arg1: &mut Pool<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.pool_sui, 0x2::balance::value<0x2::sui::SUI>(&arg1.pool_sui), arg2), @0xb1a584c0c49a5df394b80c445a3c640cb3e6d114c58f29ad87ee6651bfb0f068);
    }
    ...
    public entry fun withdraw_fee(arg0: &mut SuiEmoji, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.pool_sui, 0x2::balance::value<0x2::sui::SUI>(&arg0.pool_sui), arg1), @0xb1a584c0c49a5df394b80c445a3c640cb3e6d114c58f29ad87ee6651bfb0f068);
    }
