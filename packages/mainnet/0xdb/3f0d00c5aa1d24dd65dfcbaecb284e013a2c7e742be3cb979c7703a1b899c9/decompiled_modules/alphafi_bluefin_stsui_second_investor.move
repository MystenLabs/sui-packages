module 0xff869e243a172cfef9a4551f4eef88ac4861be0f81b0e7a4b7840b6276f5ceeb::alphafi_bluefin_stsui_second_investor {
    ...
    fun swap<T0, T1: drop>(arg0: bool, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<T1>, arg4: &mut 0x3::sui_system::SuiSystemState, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg6: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg8: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T0>, arg9: bool, arg10: u128, arg11: u128, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        if (arg0) {
            ...
            let v6 = 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::redeem<T1>(arg3, 0x2::coin::from_balance<T1>(arg2, arg13), arg4, arg13);
            if (arg9 == false) {
                let (v7, v8) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_b2a_with_fixed_limit<T0, 0x2::sui::SUI>(arg6, arg7, v6, true, 0x2::coin::value<0x2::sui::SUI>(&v6), arg11, arg12, arg13);
                0x2::coin::destroy_zero<0x2::sui::SUI>(v8);
                (0x2::coin::into_balance<T0>(v7), 0x2::balance::zero<T1>())
            } else {
                let (v9, v10) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<0x2::sui::SUI, T0>(arg12, arg5, arg8, 0x2::coin::into_balance<0x2::sui::SUI>(v6), 0x2::balance::zero<T0>(), true, true, 0x2::coin::value<0x2::sui::SUI>(&v6), 0, arg10);
                0x2::balance::destroy_zero<0x2::sui::SUI>(v9);
                (v10, 0x2::balance::zero<T1>())
            }
        }
    }
    ...
    fun autocompound_internal<T0, T1: drop, T2>(arg0: &mut Investor<T0, T1>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, 0x2::sui::SUI>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg7: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T0>, arg8: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<T1>, arg9: &mut 0x3::sui_system::SuiSystemState, arg10: bool, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, bool) {
        ...
        if (0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::sui_to_lst_mint_price<T1>(arg8, 0x2::coin::value<0x2::sui::SUI>(&v0)) > 0) {
            let v8 = 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::mint<T1>(arg8, arg9, v0, arg12);
            v7 = (0x2::coin::value<T1>(&v8) as u128) * (arg0.performance_fee as u128) / 10000;
            0x2::balance::join<T1>(&mut arg0.free_balance_b, 0x2::coin::into_balance<T1>(v8));
        } else {
            update_free_rewards<T0, T1, 0x2::sui::SUI>(arg0, 0x2::coin::into_balance<0x2::sui::SUI>(v0));
        };
        let (_, _, v11, v12) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg11, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"));
        let v13 = v12;
        let v14 = v11;
        let v15 = (0x2::balance::value<T0>(&v14) as u128) * (arg0.performance_fee as u128) / 10000;
        let v16 = v7 + (0x2::balance::value<T1>(&v13) as u128) * (arg0.performance_fee as u128) / 10000;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v14, (v15 as u64)), arg12), 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::get_fee_wallet_address(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v13, (v16 as u64)), arg12), 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::get_fee_wallet_address(arg1));
        let (v17, v18) = get_sqrt_price_limits<0x2::sui::SUI, T0, T0, 0x2::sui::SUI>(arg7, arg6, arg10);
        let (v19, v20) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, v14, v13, arg2, arg3, arg4, arg6, arg7, arg8, arg9, arg10, v17, v18, arg11, arg12);
