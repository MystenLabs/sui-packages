module 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool {
    ...
    struct AddLiquidityV2Event has copy, drop, store {
        pool: 0x2::object::ID,
        position: 0x2::object::ID,
        tick_lower: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32,
        tick_upper: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32,
    ...
    struct RemoveLiquidityV2Event has copy, drop, store {
        pool: 0x2::object::ID,
        position: 0x2::object::ID,
        tick_lower: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32,
        tick_upper: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32,
    ...
    fun add_liquidity_internal<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position, arg2: bool, arg3: u128, arg4: u64, arg5: bool, arg6: u64) : AddLiquidityReceipt<T0, T1> {
        ...
        0x2::event::emit<AddLiquidityV2Event>(v11);
    ...
    fun assert_no_pending_add_liquidity<T0, T1>(arg0: &Pool<T0, T1>) {
        assert!(!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"pending_add_liquidity"), 35);
    }
    ...
    public fun calculate_and_update_fee<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: 0x2::object::ID) : (u64, u64) {
        ...
        if (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::info_liquidity(v0) != 0) {
            ...
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::info_fee_owned(v0)
        }
    }
    ...
    public fun calculate_and_update_points<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) : u128 {
        ...
        if (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::info_liquidity(v0) != 0) {
            ...
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::info_points_owned(v0)
        }
    }
    ...
    public fun collect_protocol_fee<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        collect_protocol_fee_internal<T0, T1>(arg1)
    }

    fun collect_protocol_fee_internal<T0, T1>(arg0: &mut Pool<T0, T1>) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        let v0 = arg0.fee_protocol_coin_a;
        let v1 = arg0.fee_protocol_coin_b;
        assert!(v0 > 0 || v1 > 0, 33);
        assert!(0x2::balance::value<T0>(&arg0.coin_a) >= v0 && 0x2::balance::value<T1>(&arg0.coin_b) >= v1, 34);
    ...
    public fun collect_protocol_fee_with_cap<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &ProtocolFeeCollectCap) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        collect_protocol_fee_internal<T0, T1>(arg0)
    }
    ...
    public fun get_position_amounts_v2<T0, T1>(arg0: &Pool<T0, T1>, arg1: 0x2::object::ID) : (u64, u64) {
        ...
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::get_amount_by_liquidity(v1, v2, arg0.current_tick_index, arg0.current_sqrt_price, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::info_liquidity(v0), false)
    }
    ...
    public fun get_position_snapshot_by_position_id<T0, T1>(arg0: &Pool<T0, T1>, arg1: 0x2::object::ID) : 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position_snapshot::PositionSnapshot {
        assert!(0x2::dynamic_object_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"position_liquidity_snapshot")), 31);
    ...
    public fun remove_liquidity<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position, arg3: u128, arg4: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let (v6, v7) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::get_amount_by_liquidity(v0, v1, arg1.current_tick_index, arg1.current_sqrt_price, arg3, false);
        let v8 = RemoveLiquidityV2Event{
            pool               : 0x2::object::id<Pool<T0, T1>>(arg1),
        ...
        0x2::event::emit<RemoveLiquidityV2Event>(v8);
        (0x2::balance::split<T0>(&mut arg1.coin_a, v6), 0x2::balance::split<T1>(&mut arg1.coin_b, v7))
    }

    public fun remove_liquidity_with_slippage<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position, arg3: u128, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        let (v0, v1) = remove_liquidity<T0, T1>(arg0, arg1, arg2, arg3, arg6);
        let v2 = v1;
        let v3 = v0;
        assert!(0x2::balance::value<T0>(&v3) >= arg4, 36);
        assert!(0x2::balance::value<T1>(&v2) >= arg5, 36);
        (v3, v2)
    }
    ...
    public fun repay_flash_loan_with_partner<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: FlashLoanReceipt) {
        ...
        if (v1) {
            ...
            if (v5 > 0) {
                0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::receive_ref_fee_internal<T0>(arg2, 0x2::balance::split<T0>(&mut arg3, v5));
            };
            ...
            if (v5 > 0) {
                0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::receive_ref_fee_internal<T1>(arg2, 0x2::balance::split<T1>(&mut arg4, v5));
            };
    ...
    public fun repay_flash_swap_with_partner<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut Pool<T0, T1>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: FlashSwapReceipt<T0, T1>) {
        ...
        if (v1) {
            ...
            if (v4 > 0) {
                0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::receive_ref_fee_internal<T0>(arg2, 0x2::balance::split<T0>(&mut arg3, v4));
            };
            0x2::balance::join<T0>(&mut arg1.coin_a, arg3);
            0x2::balance::destroy_zero<T1>(arg4);
        } else {
            ...
            if (v4 > 0) {
                0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::receive_ref_fee_internal<T1>(arg2, 0x2::balance::split<T1>(&mut arg4, v4));
            };
            0x2::balance::join<T1>(&mut arg1.coin_b, arg4);
            0x2::balance::destroy_zero<T0>(arg3);
        };
    ...
    fun swap_in_pool<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: bool, arg2: bool, arg3: u128, arg4: u64, arg5: u64, arg6: u64) : SwapResult {
        ...
        if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lt(arg0.current_tick_index, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::min_tick()) || 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::gte(arg0.current_tick_index, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::max_tick())) {
            abort 30
        };
        ...
        if (arg1) {
            assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u64::add_check(arg0.fee_protocol_coin_a, v4 - v0.ref_fee_amount), 8);
            arg0.fee_protocol_coin_a = arg0.fee_protocol_coin_a + v4 - v0.ref_fee_amount;
        } else {
            assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u64::add_check(arg0.fee_protocol_coin_b, v4 - v0.ref_fee_amount), 8);
