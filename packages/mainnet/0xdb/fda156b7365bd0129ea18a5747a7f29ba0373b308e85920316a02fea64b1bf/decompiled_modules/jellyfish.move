module 0xdbfda156b7365bd0129ea18a5747a7f29ba0373b308e85920316a02fea64b1bf::jellyfish {
    ...
    public fun do_merge(arg0: &mut JellyFish, arg1: JellyFish) {
        ...
        arg0.alpha = 0x1::string::utf8(0xdbfda156b7365bd0129ea18a5747a7f29ba0373b308e85920316a02fea64b1bf::string_utils::num_to_alpha(arg0.amount));
        drop_jellyfish(arg1);
    }
    ...
    fun init(arg0: JELLYFISH, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(0xdbfda156b7365bd0129ea18a5747a7f29ba0373b308e85920316a02fea64b1bf::mrcs_svg::generatejfSVG(b"{color}", b"{alpha}")));
    ...
    fun new_jellyfish(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : JellyFish {
        ...
        let v1 = 0xdbfda156b7365bd0129ea18a5747a7f29ba0373b308e85920316a02fea64b1bf::string_utils::data_to_RGB(0x2::object::uid_to_bytes(&v0), arg1);
        let v2 = NewJellyFish{
        ...
        JellyFish{
            ...
            amount : arg0,
            color  : v1,
            alpha  : 0x1::string::utf8(0xdbfda156b7365bd0129ea18a5747a7f29ba0373b308e85920316a02fea64b1bf::string_utils::num_to_alpha(arg0)),
        }
    }
