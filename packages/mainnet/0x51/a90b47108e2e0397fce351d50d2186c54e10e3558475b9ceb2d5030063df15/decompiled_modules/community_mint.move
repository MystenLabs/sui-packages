module 0x51a90b47108e2e0397fce351d50d2186c54e10e3558475b9ceb2d5030063df15::community_mint {
    struct COMMUNITY_MINT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: COMMUNITY_MINT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<COMMUNITY_MINT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Community Mint"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Claim unique collections, for the community "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreia4uco7hurhaledlry5sdpoomnzkitqdshqz6ewrjz6ijrpys57uu"));
