module 0x51e60aaf2b3c5e2467bededef6aabf71e3ea1997987b096a512f20f4de21c5be::simple_swap {
    ...
    fun swap_a_to_b_inner<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v1 > 0 && v2 > 0, 2);
        0x2::balance::join<T0>(&mut arg0.token_a, v0);
        0x2::coin::take<T1>(&mut arg0.token_b, get_input_price(0x2::balance::value<T0>(&v0), v1, v2, arg0.fee_percent), arg2)
    }
    ...
    fun swap_b_to_a_inner<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let (v1, v2, _) = get_amounts<T0, T1>(arg0);
        assert!(v1 > 0 && v2 > 0, 2);
        0x2::balance::join<T1>(&mut arg0.token_b, v0);
        0x2::coin::take<T0>(&mut arg0.token_a, get_input_price(0x2::balance::value<T1>(&v0), v2, v1, arg0.fee_percent), arg2)
    }
