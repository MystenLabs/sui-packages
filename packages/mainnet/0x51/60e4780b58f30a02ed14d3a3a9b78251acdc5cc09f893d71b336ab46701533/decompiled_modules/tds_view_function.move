module 0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::tds_view_function {
    ...
    public(friend) fun get_auction_bcs(arg0: &0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::Registry, arg1: vector<u64>) : vector<vector<u8>> {
        let (_, v1, _, _, _, _, v6, _, _, _, _, _) = 0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_registry_inner(arg0);
        let v12 = 0x1::vector::empty<vector<u8>>();
        if (0x1::vector::is_empty<u64>(&arg1)) {
            let v13 = 0;
            while (v13 < *v1) {
                if (0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::auction_exists(v6, v13)) {
                    0x1::vector::push_back<vector<u8>>(&mut v12, 0x1::bcs::to_bytes<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::Auction>(0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_auction(v6, v13)));
                };
                v13 = v13 + 1;
            };
        } else {
            while (!0x1::vector::is_empty<u64>(&arg1)) {
                ...
                if (0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::auction_exists(v6, v14)) {
                    0x1::vector::push_back<vector<u8>>(&mut v12, 0x1::bcs::to_bytes<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::Auction>(0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_auction(v6, v14)));
                };
            };
        };
        v12
    ...
    public(friend) fun get_auction_bids_bcs(arg0: &0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::Registry, arg1: u64) : vector<vector<u8>> {
        let (_, _, _, _, _, _, v6, _, _, _, _, _) = 0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_registry_inner(arg0);
        let v12 = 0x1::vector::empty<vector<u8>>();
        if (0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::auction_exists(v6, arg1)) {
            let v13 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::bids(0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_auction(v6, arg1));
    ...
    public(friend) fun get_deposit_shares_bcs(arg0: &0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::Registry, arg1: vector<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusDepositReceipt>, arg2: address) : vector<vector<u8>> {
        let (_, _, _, _, _, v5, _, _, _, v9, _, _) = 0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_registry_inner(arg0);
        let v12 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v12, 0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_deposit_snapshot_bcs(v9, arg2));
        while (!0x1::vector::is_empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusDepositReceipt>(&arg1)) {
            ...
            let (v16, v17, v18, v19, v20, v21) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::summarize_deposit_shares(0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_deposit_vault(v5, v15), v13);
    ...
    public(friend) fun get_my_bids_bcs(arg0: &0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::Registry, arg1: vector<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>) : vector<vector<u8>> {
        let (_, _, _, _, _, _, _, v7, _, _, _, _) = 0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_registry_inner(arg0);
        let v12 = 0x1::vector::empty<vector<u8>>();
        while (!0x1::vector::is_empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&arg1)) {
            ...
            let v22 = 0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_bid_vault_by_id_or_index(v7, &v18, v16);
    ...
    public(friend) fun get_refund_shares_bcs<T0>(arg0: &0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::Registry, arg1: &0x2::tx_context::TxContext) : vector<u8> {
        let (_, _, _, _, _, _, _, _, v8, _, _, _) = 0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_registry_inner(arg0);
        let v12 = 0x1::type_name::get<T0>();
        let v13 = 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v12);
        let v14 = if (0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::refund_vault_exists<T0>(v8)) {
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_refund_share(0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_refund_vault<T0>(v8), 0x2::tx_context::sender(arg1))
        } else {
            0
        };
        let v15 = v14;
    ...
    public(friend) fun get_scallop_withdrawal_bcs<T0, T1>(arg0: &mut 0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg5: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : vector<vector<u8>> {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v2, @0x3e3f1ca852358b50837758b5197fedf61e2ea69186c469595baa717560963f9);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v1, @0x3e3f1ca852358b50837758b5197fedf61e2ea69186c469595baa717560963f9);
        v3
    }

    public(friend) fun get_vault_data_bcs(arg0: &0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::Registry, arg1: vector<u64>) : vector<vector<u8>> {
        let (_, v1, _, _, v4, v5, _, _, _, _, _, _) = 0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_registry_inner(arg0);
        let v12 = 0x1::vector::empty<vector<u8>>();
        if (0x1::vector::is_empty<u64>(&arg1)) {
            let v13 = 0;
            while (v13 < *v1) {
                if (0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::portfolio_vault_exists(v4, v13)) {
                    let v14 = 0x1::vector::empty<u8>();
                    0x1::vector::append<u8>(&mut v14, 0x1::bcs::to_bytes<0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::PortfolioVault>(0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_portfolio_vault(v4, v13)));
                    0x1::vector::append<u8>(&mut v14, 0x1::bcs::to_bytes<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::DepositVault>(0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_deposit_vault(v5, v13)));
            ...
            while (!0x1::vector::is_empty<u64>(&arg1)) {
                ...
                if (0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::portfolio_vault_exists(v4, v15)) {
                    let v16 = 0x1::vector::empty<u8>();
                    0x1::vector::append<u8>(&mut v16, 0x1::bcs::to_bytes<0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::PortfolioVault>(0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_portfolio_vault(v4, v15)));
                    0x1::vector::append<u8>(&mut v16, 0x1::bcs::to_bytes<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::DepositVault>(0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single::get_deposit_vault(v5, v15)));
