module 0x513d9ae38a8086abf2ab6b4ab1a2b6b840857516f077c94bb462cdcd709fda78::cnsnft7076 {
    struct CNSNFT7076 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7076, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7076>(arg0, arg1);
