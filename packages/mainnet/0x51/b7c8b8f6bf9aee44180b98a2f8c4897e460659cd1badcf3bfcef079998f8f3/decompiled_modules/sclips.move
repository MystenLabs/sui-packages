module 0x51b7c8b8f6bf9aee44180b98a2f8c4897e460659cd1badcf3bfcef079998f8f3::sclips {
    ...
    fun init(arg0: SCLIPS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SCLIPS>(arg0, 6, b"SCLIPS", b"SCLIPS", b"", 0x1::option::none<0x2::url::Url>(), arg1);
