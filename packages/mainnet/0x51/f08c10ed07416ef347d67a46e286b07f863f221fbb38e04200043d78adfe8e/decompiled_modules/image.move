module 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image {
    ...
    public fun create_image(arg0: CreateImageCap, arg1: vector<0x1::string::String>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (!0x1::vector::is_empty<0x1::string::String>(&arg1)) {
            let v2 = (0x1::vector::length<0x1::string::String>(&arg1) as u8);
            let v3 = 0x1::vector::pop_back<0x1::string::String>(&mut arg1);
            let v4 = CreateImageChunkCap{
                id       : 0x2::object::new(arg2),
                number   : arg0.number,
                level    : arg0.level,
                index    : v2,
            ...
            let v5 = CreateImageChunkCapCreatedEvent{
                id       : 0x2::object::id<CreateImageChunkCap>(&v4),
                number   : arg0.number,
                level    : arg0.level,
                index    : v2,
                hash     : v3,
            ...
            0x2::event::emit<CreateImageChunkCapCreatedEvent>(v5);
            0x2::vec_map::insert<0x1::string::String, 0x1::option::Option<0x2::object::ID>>(&mut v0.chunks, v3, 0x1::option::none<0x2::object::ID>());
            0x2::vec_set::insert<0x2::object::ID>(&mut v1, 0x2::object::id<CreateImageChunkCap>(&v4));
            0x2::transfer::transfer<CreateImageChunkCap>(v4, @0x597996d64570b1ba7ec02376995fe126d4430d385a62970f33266d7eb711172f);
        };
        ...
        let v6 = ImageCreatedEvent{
            id     : 0x2::object::id<Image>(&v0),
            number : arg0.number,
            level  : arg0.level,
        };
        0x2::event::emit<ImageCreatedEvent>(v6);
        let CreateImageCap {
            id     : v7,
            number : _,
            level  : _,
        ...
        0x2::transfer::transfer<Image>(v0, @0x597996d64570b1ba7ec02376995fe126d4430d385a62970f33266d7eb711172f);
    }
    ...
    fun init(arg0: IMAGE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<ImageChunk>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"Prime Machin #{number} Image Chunk"));
        0x2::display::add<ImageChunk>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"An image chunk for Prime Machin #{number}."));
        0x2::display::add<ImageChunk>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://prime.nozomi.world/images/image_chunk_{level}_{number}_{index}.webp"));
        ...
        0x2::transfer::public_transfer<0x2::display::Display<ImageChunk>>(v1, @0xde0053243f3226649701a7fe2c3988be11941bf3ff3535f3c8c5bf32fc600220);
    }

    public(friend) fun issue_create_image_cap(arg0: u16, arg1: u8, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : CreateImageCap {
    ...
    public(friend) fun number(arg0: &Image) : u16 {
        arg0.number
    }
