module 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::registry {
    ...
    public(friend) fun add(arg0: u16, arg1: 0x2::object::ID, arg2: &mut Registry) {
        ...
        if ((0x2::table::length<u16, 0x2::object::ID>(&arg2.pfps) as u16) == 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::collection::size()) {
            arg2.is_initialized = true;
        };
    }

    public fun admin_freeze_registry(arg0: &0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::admin::AdminCap, arg1: Registry, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun pfp_id_from_number(arg0: u16, arg1: &Registry) : 0x2::object::ID {
        assert!(arg0 >= 1 && arg0 <= 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::collection::size(), 1);
