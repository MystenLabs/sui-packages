module 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::coloring {
    ...
    public fun admin_fulfill_coloring(arg0: FulfillColoringCap, arg1: 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::Image, arg2: &mut ColoringStudio) {
        0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::verify_image_chunks_registered(&arg1);
        assert!(arg0.studio_id == 0x2::object::id<ColoringStudio>(arg2), 6);
        assert!(arg0.number == 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::number(&arg1), 4);
        assert!(arg0.level == 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::level(&arg1), 3);
        0x1::option::fill<0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::Image>(&mut arg2.image, arg1);
    ...
    public fun admin_issue_coloring_ticket(arg0: &0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::admin::AdminCap, arg1: u8, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun admin_set_coloring_prices(arg0: &0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::admin::AdminCap, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut ColoringSettings, arg6: &mut 0x2::tx_context::TxContext) {
        0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::admin::verify_admin_cap(arg0, arg6);
    ...
    public fun claim_coloring(arg0: &mut 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::PrimeMachin, arg1: 0x2::transfer::Receiving<ColoringReceipt>, arg2: ColoringStudio, arg3: &mut ColoringStudioRegistry, arg4: &mut 0x2::tx_context::TxContext) : (0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::Image, 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::DeleteImagePromise) {
        let v0 = 0x2::transfer::receive<ColoringReceipt>(0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::uid_mut(arg0), arg1);
        assert!(v0.number == 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::number(arg0), 9);
        assert!(arg2.is_fulfilled == true, 5);
        assert!(0x2::object::id<ColoringStudio>(&arg2) == v0.studio_id, 10);
        let v1 = 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::unset_image(arg0);
        0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::set_image(arg0, 0x1::option::extract<0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::Image>(&mut arg2.image));
        if (arg2.level == 1) {
            0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::set_lvl1_colored_by_address(arg0, 0x2::tx_context::sender(arg4));
        } else if (arg2.level == 2) {
            0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::set_lvl2_colored_by_address(arg0, 0x2::tx_context::sender(arg4));
        };
        ...
        0x1::option::destroy_none<0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::Image>(v10);
        0x2::object::delete(v7);
        (v1, 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::issue_delete_image_promise(&v1))
    }
    ...
    public fun request_coloring(arg0: &0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::PrimeMachin, arg1: ColoringTicket, arg2: &mut ColoringStudioRegistry, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!0x2::table::contains<u16, 0x2::object::ID>(&arg2.studios, 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::number(arg0)), 1);
        if (arg1.level == 1) {
            let v0 = 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::lvl1_colored_by(arg0);
            assert!(0x1::option::is_none<address>(&v0), 1);
        } else if (arg1.level == 2) {
            let v1 = 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::lvl1_colored_by(arg0);
            assert!(0x1::option::is_some<address>(&v1), 12);
            let v2 = 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::lvl2_colored_by(arg0);
        ...
        let v5 = 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::issue_create_image_cap(0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::number(arg0), arg1.level, 0x2::object::id<ColoringStudio>(&v3), arg3);
        let v6 = FulfillColoringCap{
            id                  : 0x2::object::new(arg3),
            number              : 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::number(arg0),
            level               : arg1.level,
            studio_id           : 0x2::object::id<ColoringStudio>(&v3),
            create_image_cap_id : 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::create_image_cap_id(&v5),
        };
        let v7 = 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::id(arg0);
        0x2::transfer::transfer<ColoringReceipt>(v4, 0x2::object::id_to_address(&v7));
        0x2::transfer::public_transfer<0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::image::CreateImageCap>(v5, @0x597996d64570b1ba7ec02376995fe126d4430d385a62970f33266d7eb711172f);
        0x2::transfer::transfer<FulfillColoringCap>(v6, @0x597996d64570b1ba7ec02376995fe126d4430d385a62970f33266d7eb711172f);
        0x2::table::add<u16, 0x2::object::ID>(&mut arg2.studios, 0x51f08c10ed07416ef347d67a46e286b07f863f221fbb38e04200043d78adfe8e::factory::number(arg0), 0x2::object::id<ColoringStudio>(&v3));
