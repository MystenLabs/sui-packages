module 0x519550517a97cee66957f01a61e9163047285b388ffacc496cd095c63c555282::game3461 {
    struct GAME3461 has drop {
        dummy_field: bool,
    }

    struct TICKET_3461 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3461(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3461>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3461>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME3461, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME3461>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3461>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3461>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3461>>(v5, 0x2::tx_context::sender(arg1));
    }
