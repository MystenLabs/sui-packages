module 0x51da6c8ae825d14fac8741bed191834691a9dabba69cbf50ee1b4e7f383edd19::reward5995 {
    struct REWARD5995 has drop {
        dummy_field: bool,
    }

    struct TICKET_5995 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5995(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5995>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5995>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5995, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5995>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5995>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5995>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5995>>(v5, 0x2::tx_context::sender(arg1));
    }
