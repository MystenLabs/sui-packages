module 0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::enchantment_logic {
    ...
    fun budget_for_rarity(arg0: u8) : u64 {
        ...
        (((50 as u128) * (v0 as u128) / 10000) as u64)
    }
    ...
    public(friend) fun enchant_inventory_slot(arg0: &mut 0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::character_data::Character, arg1: &0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::game_data::GameData, arg2: u64, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) : EnchantmentResult {
        ...
        let v1 = 0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::inventory_item::item_id(v0);
        let v2 = 0x2::random::new_generator(arg3, arg4);
        let v3 = if (0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::inventory_item::enchantment_rarity(v0) > 0) {
            true
        } else if (0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::inventory_item::agility_bonus(v0) > 0) {
            true
        } else if (0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::inventory_item::endurance_bonus(v0) > 0) {
            true
        } else if (0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::inventory_item::stealth_bonus(v0) > 0) {
            true
        } else {
            0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::inventory_item::luck_bonus(v0) > 0
        };
        let v4 = &mut v2;
        ...
        let v12 = 0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::character_data::get_item_by_instance_id_mut(arg0, arg2);
        0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::inventory_item::set_bonuses(v12, v8, v9, v10, v11, v5);
        if (0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::inventory_management::is_type_equipped(arg0, 0x518d135e593f5e68ef5a2b46378a8e838112fb542c9eb6fc01d6f9eab59a831c::inventory_item::type_id(v12))) {
