module 0x5197a0c59aa781a6dc085ea84eaf741f0134ed832fba4899f95065a51038b0d9::MONKEAI {
    ...
    struct Airdrop has key {
        ...
        total_amount: u64,
        total_claim: u64,
        balance: 0x2::balance::Balance<MONKEAI>,
    ...
    public entry fun add_wl(arg0: &mut 0x2::coin::TreasuryCap<MONKEAI>, arg1: &mut Airdrop, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun add_wl_bulk(arg0: &mut 0x2::coin::TreasuryCap<MONKEAI>, arg1: &mut Airdrop, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            add_wl(arg0, arg1, *0x1::vector::borrow<address>(&arg2, v0), *0x1::vector::borrow<u64>(&arg3, v0), arg4);
            v0 = v0 + 1;
        };
    }

    public entry fun claim_airdrop(arg0: &mut Airdrop, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun decr_airdrop(arg0: &mut 0x2::coin::TreasuryCap<MONKEAI>, arg1: &mut Airdrop, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun incr_airdrop(arg0: &mut 0x2::coin::TreasuryCap<MONKEAI>, arg1: &mut Airdrop, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
