module 0x51e8441a6dd36996075e255c152b5a1fc95cd1864e7e2f68c27fce9e4185ba98::vesting {
    ...
    public fun create_lock<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: 0x1::option::Option<0x1::string::String>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Lock<T0> {
        ...
        if (0x1::option::is_some<0x1::string::String>(&arg2)) {
            assert!(0x1::string::length(0x1::option::borrow<0x1::string::String>(&arg2)) <= 128, 5);
        };
    ...
    public fun extend<T0>(arg0: &mut Lock<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = LockExtended{
            ...
            extender   : 0x2::tx_context::sender(arg2),
