module 0x51c49d121c98ed7b6756ee8e96fc4e5221250caad0bcaa38787ec2ea4b01e60b::capability {
    ...
    public(friend) fun borrow_receipt_mut<T0, T1: store + key>(arg0: &mut Treasury<T0>, arg1: u8) : &mut T1 {
        let v0 = PositionKey{pos0: arg1};
        0x2::dynamic_object_field::borrow_mut<PositionKey, T1>(&mut arg0.id, v0)
    }
    ...
    public(friend) fun custody_receipt<T0, T1: store + key>(arg0: &mut Treasury<T0>, arg1: u8, arg2: T1) {
        let v0 = PositionKey{pos0: arg1};
        assert!(!0x2::dynamic_object_field::exists_<PositionKey>(&arg0.id, v0), 13906835054812332043);
        let v1 = PositionKey{pos0: arg1};
        0x2::dynamic_object_field::add<PositionKey, T1>(&mut arg0.id, v1, arg2);
    }
    ...
    public fun owner_take_receipt<T0, T1: store + key>(arg0: &mut Treasury<T0>, arg1: &OwnerCap<T0>, arg2: u8) : T1 {
        assert!(arg1.treasury == 0x2::object::id<Treasury<T0>>(arg0), 13906835162185859073);
        let v0 = PositionKey{pos0: arg2};
        assert!(0x2::dynamic_object_field::exists_<PositionKey>(&arg0.id, v0), 13906835166481612813);
        let v1 = PositionKey{pos0: arg2};
        0x2::dynamic_object_field::remove<PositionKey, T1>(&mut arg0.id, v1)
    }

    public(friend) fun release_for_action<T0>(arg0: &mut Treasury<T0>, arg1: &AgentCap<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg1.treasury == 0x2::object::id<Treasury<T0>>(arg0), 13906834908782788609);
        assert!(arg0.agent == 0x1::option::some<0x2::object::ID>(0x2::object::id<AgentCap<T0>>(arg1)), 13906834913077886979);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(v0 < arg0.expiry_ms, 13906834925962919941);
        assert!(arg2 <= arg0.per_tx_cap, 13906834930258018311);
        if (v0 >= arg0.period_start_ms + arg0.period_ms) {
            arg0.period_start_ms = v0;
            arg0.spent_in_period = 0;
        };
        assert!(arg0.spent_in_period + arg2 <= arg0.period_cap, 13906834960322920457);
        arg0.spent_in_period = arg0.spent_in_period + arg2;
        ...
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.funds, arg2), arg4)
    }

    public fun revoke<T0>(arg0: &mut Treasury<T0>, arg1: &OwnerCap<T0>) {
        assert!(arg1.treasury == 0x2::object::id<Treasury<T0>>(arg0), 13906835200840564737);
    ...
    public fun withdraw_principal<T0>(arg0: &mut Treasury<T0>, arg1: &OwnerCap<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg1.treasury == 0x2::object::id<Treasury<T0>>(arg0), 13906835252380172289);
