module 0x51abc7016876cd23efcd5a5240bc03ef0e3ed4538e0d87a029944d45cb3e4b81::monster {
    ...
    public entry fun mint(arg0: &mut Treasury, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x1::bcs::to_bytes<address>(&v2);
        let v5 = 0x1::bcs::to_bytes<0x2::object::ID>(0x2::object::uid_as_inner(&v3));
        let v6 = v1 ^ (*0x1::vector::borrow<u8>(&v4, 0) as u64) << 16 ^ (*0x1::vector::borrow<u8>(&v4, 1) as u64) << 8 ^ (*0x1::vector::borrow<u8>(&v4, 2) as u64) ^ (*0x1::vector::borrow<u8>(&v5, 0) as u64) << 56 ^ (*0x1::vector::borrow<u8>(&v5, 1) as u64) << 48 ^ (*0x1::vector::borrow<u8>(&v5, 2) as u64) << 40 ^ (*0x1::vector::borrow<u8>(&v5, 3) as u64) << 32;
        let v7 = Monster{
            id           : v3,
            name         : generate_name(v6),
            seed         : v6,
            stage        : 0,
            attack       : ((v6 % 50 + 10) as u16),
            defense      : (((v6 >> 8) % 50 + 10) as u16),
            speed        : (((v6 >> 16) % 50 + 10) as u16),
            created_at   : v1,
            wins         : 0,
            losses       : 0,
            xp           : 0,
        ...
        let v8 = Minted{
            monster_id : 0x2::object::id<Monster>(&v7),
            owner      : v2,
            paid_mist  : v0,
        };
        0x2::event::emit<Minted>(v8);
        0x2::transfer::public_transfer<Monster>(v7, v2);
    }
