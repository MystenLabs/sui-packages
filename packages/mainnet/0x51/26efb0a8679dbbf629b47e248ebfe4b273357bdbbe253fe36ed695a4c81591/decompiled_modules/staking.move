module 0x305d1a8a9e9dccb4c1fcb7ffb8228dd27bb1145696ec77c5dd0cbab550436ee9::staking {
    ...
    entry fun change_reward_per_nanosecs<T0, T1>(arg0: &AdminCap, arg1: &mut StakingPool<T0, T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.reward_per_nanosecs = arg2;
    }
    ...
    public entry fun claim<T0, T1>(arg0: &mut StakingPool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::clock::timestamp_ms(arg1) - v1.staking_start_timestamp >= 2592000000) {
        };
        let v3 = &mut v1;
        let v4 = inner_claim<T0, T1>(arg0, v3, arg2);
    ...
    public entry fun withdraw<T0, T1>(arg0: &mut StakingPool<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = 0x2::bag::remove<address, StakingLock>(&mut arg0.stakers, v0);
        if (0x2::clock::timestamp_ms(arg2) - v1.staking_start_timestamp > 2592000000) {
        };
        let v2 = if (arg1 == 0) {
            v1.amount
        } else {
        ...
        let v3 = &mut v1;
        update_user_earnings(arg0.accum_reward, arg0.scale, v3);
        assert!(v1.amount >= v2, 1001);
        v1.amount = v1.amount - v2;
        v1.staking_start_timestamp = 0x2::clock::timestamp_ms(arg2);
        0x2::bag::add<address, StakingLock>(&mut arg0.stakers, v0, v1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.stake_balance, v2, arg3), v0);
    }
