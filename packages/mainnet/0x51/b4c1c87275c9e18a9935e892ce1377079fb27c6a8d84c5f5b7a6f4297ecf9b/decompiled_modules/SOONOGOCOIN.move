module 0x51b4c1c87275c9e18a9935e892ce1377079fb27c6a8d84c5f5b7a6f4297ecf9b::SOONOGOCOIN {
    ...
    fun init(arg0: SOONOGOCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<SOONOGOCOIN>>(v0);
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<SOONOGOCOIN>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
