module 0x51594fd4d658b9f600b307a7f3a76681e51ea1bbab6607b1902120157da8c7bc::world {
    struct WORLD has drop {
        dummy_field: bool,
    }

    fun init(arg0: WORLD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<WORLD>(arg0, 6, b"WORLD", b"Camerons's World", b"Hi I'm Cameron and I would love to welcome you to my $WORLD", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/Qma_D_Gs4_S_Sj_Qc_Hv_QK_Nahsq_Ya2oa9z_Ggq4_M_Jq4ir4r_KUL_Uz_T_1f5840d634.png")), arg1);
