module 0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::safu {
    ...
    entry fun hotfix_vault_4(arg0: &0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::Version, arg1: &mut Registry, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::verify(arg0, arg3);
        let v0 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.id, 4);
        let v1 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::length(&v0.share);
        if (v1 > 0) {
            let v2 = (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::slice_size(&v0.share) as u64);
            let v3 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_slice_mut<Share>(&mut v0.share, 0);
            ...
            while (v4 < v1) {
                let v5 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_from_slice_mut<Share>(v3, v4 % v2);
                if (v5.user == @0xb6b29d18c728503fb59cc59ecbe52611d26b2746b2cedc8d38cabf81428cae6c) {
                    *0x1::vector::borrow_mut<u64>(&mut v5.share, 5) = 0;
                };
                if (v4 + 1 < v1 && (v4 + 1) % v2 == 0) {
                    let v6 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::get_slice_idx<Share>(v3) + 1;
                    v3 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_slice_mut<Share>(&mut v0.share, v6);
        ...
        0x2::balance::join<0x2::sui::SUI>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<0x2::sui::SUI>>(&mut v0.id, 0x1::ascii::string(b"deposit_balance")), 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(arg2, 503607, arg3)));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<0x2::sui::SUI>>(&mut v0.id, 0x1::type_name::get<0x2::sui::SUI>()), 336), arg3), 0x2::tx_context::sender(arg3));
    }
