module 0x51b5ad107926c2eb5132a36953e0ae08b0f12013ffc268a30ba5c90e0b566a08::mystic_yeti_pass_whitelist {
    struct MYSTIC_YETI_PASS_WHITELIST has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MYSTIC_YETI_PASS_WHITELIST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MYSTIC_YETI_PASS_WHITELIST>(arg0, arg1);
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreigfwbxzzg2otcs2planqodqubprrxycrj77g7x6oep742dwxj5rre"));
