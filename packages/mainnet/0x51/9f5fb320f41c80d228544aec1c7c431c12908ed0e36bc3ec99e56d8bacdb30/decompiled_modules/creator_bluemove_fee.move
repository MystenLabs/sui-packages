module 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::creator_bluemove_fee {
    ...
    public entry fun add_royalty_collection<T0>(arg0: &mut RoyaltyCollection, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::utils::get_token_name<T0>();
    ...
    public fun check_exists_royalty_collection<T0>(arg0: &mut RoyaltyCollection, arg1: &mut 0x2::tx_context::TxContext) : bool {
        0x2::dynamic_object_field::exists_with_type<0x1::string::String, RoyaltyCollectionItem>(&mut arg0.id, 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::utils::get_token_name<T0>())
    }
    ...
    public entry fun update_creator_address<T0>(arg0: &mut RoyaltyCollection, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x49cc391ab4d3503e03dbb24c4f9e28f3cdd2ddf8a459e0d43012c3868ffefa1, 1);
        0x2::dynamic_object_field::borrow_mut<0x1::string::String, RoyaltyCollectionItem>(&mut arg0.id, 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::utils::get_token_name<T0>()).creator = arg1;
    }
    ...
    public entry fun update_royalty_collection<T0>(arg0: &mut RoyaltyCollection, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == @0x49cc391ab4d3503e03dbb24c4f9e28f3cdd2ddf8a459e0d43012c3868ffefa1, 1);
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x1::string::String, RoyaltyCollectionItem>(&mut arg0.id, 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::utils::get_token_name<T0>());
