module 0x5168106eb26d2f9c44a356cb586c1565b6603e31e78e0bb8e73250e70039be35::volt {
    ...
    fun init(arg0: VOLT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<VOLT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"VOLT    ")))), trim_right(b"VOLT.WIN                        "), trim_right(b"Volt sparks rapid deflation, creating scarcity and long-term value for holders, making it a powerhouse in the DeFi space                                                                                                                                                                                                        "), v2, arg1);
