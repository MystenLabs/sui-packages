module 0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::nest {
    ...
    public entry fun clear_stale_stake(arg0: &mut Nest, arg1: &0x2::kiosk::Kiosk, arg2: &mut HarvestStats, arg3: &mut 0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::staking_lock_rule::StakingRegistry, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::kiosk::has_item_with_type<0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::duck_nft::DuckNFT>(arg1, v1), 1);
        0x1::option::extract<0x2::object::ID>(&mut arg0.staked_duck_id);
        arg0.staked_at = 0;
        arg0.last_harvest_time = 0;
        arg0.duck_rarity = 0;
        arg0.duck_multiplier = 0;
        0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::staking_lock_rule::remove_staked_duck(arg3, v1);
    ...
    public entry fun harvest_duck(arg0: &mut Nest, arg1: &0x2::kiosk::Kiosk, arg2: &mut HarvestStats, arg3: &0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::NestMintCap, arg4: &mut 0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::SharedTreasury, arg5: &0x2::random::Random, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(arg0.owner == v0, 6);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.staked_duck_id), 13);
        let v1 = *0x1::option::borrow<0x2::object::ID>(&arg0.staked_duck_id);
        assert!(0x2::kiosk::has_item_with_type<0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::duck_nft::DuckNFT>(arg1, v1), 2);
        ...
        if (v10 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::SHTTOKEN>>(0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::mint_for_nest(arg3, arg4, v10, arg7), v0);
        };
    ...
    public fun is_staked_duck_in_kiosk(arg0: &Nest, arg1: &0x2::kiosk::Kiosk) : (bool, bool) {
        if (0x1::option::is_none<0x2::object::ID>(&arg0.staked_duck_id)) {
            ...
            (true, 0x2::kiosk::has_item_with_type<0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::duck_nft::DuckNFT>(arg1, *0x1::option::borrow<0x2::object::ID>(&arg0.staked_duck_id)))
        }
    }

    public entry fun stake_duck(arg0: &0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut Nest, arg4: &mut HarvestStats, arg5: &mut 0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::staking_lock_rule::StakingRegistry, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        ...
        if (0x1::option::is_some<0x2::object::ID>(&arg3.staked_duck_id)) {
            ...
            if (0x2::kiosk::has_item_with_type<0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::duck_nft::DuckNFT>(arg0, v1)) {
                abort 12
            };
            ...
            0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::staking_lock_rule::remove_staked_duck(arg5, v1);
        ...
        let v2 = 0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::duck_nft::get_rarity_level(0x2::kiosk::borrow<0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::duck_nft::DuckNFT>(arg0, arg1, arg2));
        ...
        0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::staking_lock_rule::add_staked_duck(arg5, arg2, v0);
        arg4.active_ducks_staked = arg4.active_ducks_staked + 1;
    ...
    public entry fun unstake_duck(arg0: &mut Nest, arg1: &0x2::kiosk::Kiosk, arg2: &mut HarvestStats, arg3: &mut 0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::staking_lock_rule::StakingRegistry, arg4: &0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::NestMintCap, arg5: &mut 0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::SharedTreasury, arg6: &0x2::random::Random, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(arg0.owner == v0, 6);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.staked_duck_id), 13);
        let v1 = *0x1::option::borrow<0x2::object::ID>(&arg0.staked_duck_id);
        let v2 = 0x2::object::id<Nest>(arg0);
        if (0x2::kiosk::has_item_with_type<0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::duck_nft::DuckNFT>(arg1, v1)) {
            ...
            if (v3 > 0) {
                ...
                if (v9 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::SHTTOKEN>>(0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::mint_for_nest(arg4, arg5, v9, arg8), v0);
                };
    ...
    public entry fun upgrade_nest(arg0: &mut Nest, arg1: &mut 0x2::coin::Coin<0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::SHTTOKEN>, arg2: &mut 0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::SharedTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::SHTTOKEN>(arg1) >= v3, 5);
        0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::burn(arg2, 0x2::coin::split<0x515a552652d3d7cb4e219772ba78e17997bf7e2ffd9502a0275750574bfacdc8::shttoken::SHTTOKEN>(arg1, v3, arg3));
        arg0.level = v2;
        let v4 = SlotUpgraded{
            nest_id    : 0x2::object::id<Nest>(arg0),
            owner      : v0,
