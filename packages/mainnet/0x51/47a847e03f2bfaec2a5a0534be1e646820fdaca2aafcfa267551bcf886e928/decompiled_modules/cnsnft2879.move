module 0x5147a847e03f2bfaec2a5a0534be1e646820fdaca2aafcfa267551bcf886e928::cnsnft2879 {
    struct CNSNFT2879 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2879, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2879>(arg0, arg1);
