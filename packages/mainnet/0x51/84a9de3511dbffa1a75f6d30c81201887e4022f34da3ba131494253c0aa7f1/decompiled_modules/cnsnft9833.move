module 0x5184a9de3511dbffa1a75f6d30c81201887e4022f34da3ba131494253c0aa7f1::cnsnft9833 {
    struct CNSNFT9833 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9833, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1636"));
        let v4 = 0x2::package::claim<CNSNFT9833>(arg0, arg1);
