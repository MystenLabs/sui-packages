module 0x51b24c38e4e3b198fd465fa89280d4f04ba57af4f133e584dbd8680ba0bfdf1d::cnsnft8207 {
    struct CNSNFT8207 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8207, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8207>(arg0, arg1);
