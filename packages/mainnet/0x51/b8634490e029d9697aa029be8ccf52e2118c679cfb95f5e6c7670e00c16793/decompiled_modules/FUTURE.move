module 0x51b8634490e029d9697aa029be8ccf52e2118c679cfb95f5e6c7670e00c16793::FUTURE {
    ...
    fun init(arg0: FUTURE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FUTURE>(arg0, 9, b"FUTURE", b"future", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.ibb.co/rtXpGCB/future.png")), arg1);
