module 0x511ea23a988080a94af0c5b0813f3d95cb31bf47ca01b4f07befa9325d2ef312::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"BEAM", b"Mr Beam", b"", 0x1::option::none<0x2::url::Url>(), arg1);
