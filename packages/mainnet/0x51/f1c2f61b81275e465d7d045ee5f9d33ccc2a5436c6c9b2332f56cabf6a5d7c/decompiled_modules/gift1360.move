module 0x51f1c2f61b81275e465d7d045ee5f9d33ccc2a5436c6c9b2332f56cabf6a5d7c::gift1360 {
    struct GIFT1360 has drop {
        dummy_field: bool,
    }

    struct TICKET_1360 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1360(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1360>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1360>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1360, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1360>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1360>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1360>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1360>>(v5, 0x2::tx_context::sender(arg1));
    }
