module 0x51f2c75c8c1d3b3f0af53322269c35674cd31002f990030c8aed463b34f6aa00::interfaces {
    ...
    public entry fun get_user_total_allowed_borrow(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::PoolManagerInfo, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg2: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle, arg3: u64) {
        ...
        while (v1 < 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_reserve_length(arg1)) {
            let v2 = (v1 as u16);
            let v3 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_amount(arg2, v2, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_div(0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::user_health_collateral_value(arg1, arg2, arg3) - 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_mul(0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::user_health_loan_value(arg1, arg2, arg3), 1050000000000000000000000000), 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_borrow_coefficient(arg1, v2)));
            let v4 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::min(v3, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::get_app_liquidity(arg0, v2, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_app_id(arg1)));
            let v5 = 0x1::vector::empty<SingleBorrowInfo>();
            let v6 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::get_pools_by_id(arg0, v2);
            let v7 = 0;
            while (v7 < 0x1::vector::length<0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::dola_address::DolaAddress>(&v6)) {
                let v8 = 0x1::vector::borrow<0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::dola_address::DolaAddress>(&v6, v7);
                let v9 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::min(v3, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::pool_manager::get_pool_liquidity(arg0, *v8));
                let v10 = SingleBorrowInfo{
                    dola_chain_id           : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::dola_address::get_dola_chain_id(v8),
                    avaliable_borrow_amount : v9,
                    avaliable_borrow_value  : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg2, v2, v9),
                };
                0x1::vector::push_back<SingleBorrowInfo>(&mut v5, v10);
            };
            let v11 = UserTotalBorrowInfo{
                dola_pool_id                  : v2,
                omnichain_borrow_info         : v5,
                total_avaliable_borrow_amount : v4,
                total_avaliable_borrow_value  : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg2, v2, v4),
            };
            0x1::vector::push_back<UserTotalBorrowInfo>(&mut v0, v11);
            v1 = v1 + 1;
        };
        let v12 = UserTotalAllowedBorrow{total_allowed_borrow: v0};
        0x2::event::emit<UserTotalAllowedBorrow>(v12);
    }
