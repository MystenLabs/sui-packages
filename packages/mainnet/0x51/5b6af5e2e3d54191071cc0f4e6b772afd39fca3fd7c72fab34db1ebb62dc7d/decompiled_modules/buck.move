module 0x236149824ea2baf4e948438cab557be8ed99839bd0ebe2b07c8b43ba3310e61f::buck {
    struct LP has drop {
        dummy_field: bool,
    }
    ...
    public fun emergency_vault_withdraw(arg0: &mut Pool, arg1: &PoolConfig, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN> {
        assert_admin(arg1, arg2);
        0x2::coin::from_balance<0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN>(0x2::balance::withdraw_all<0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN>(&mut arg0.vault), arg2)
    }
