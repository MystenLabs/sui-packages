module 0x51ad1a3c1aa94b5119fd1011ad8242495db1258b4d14d142cfad0530361c7415::popkins_escape_pack {
    struct POPKINS_ESCAPE_PACK has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: POPKINS_ESCAPE_PACK, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<POPKINS_ESCAPE_PACK>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Popkins Escape Pack"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Your Popkin got away! But left behind some extras. This pack includes bonus digital rewards like Pity Points, and a collectible Escape Card."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreie2jgcg26yhg2cjifh2qnmkihu6vdgq4vvk3cfzhuowlwyejkqnoe"));
