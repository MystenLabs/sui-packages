module 0x51419fbf704ff58cc2499d0c77d11e0dd551e48939dd87756755ed41dabaf90c::aifrens_footie_legends {
    ...
    public fun birth_location(arg0: &AifrensGenesis) : 0x1::string::String {
        arg0.birth_location
    }

    public fun birthdate(arg0: &AifrensGenesis) : u64 {
        arg0.birthdate
    }

    public fun generation(arg0: &AifrensGenesis) : u64 {
        arg0.generation
    }

    public fun genes(arg0: &AifrensGenesis) : vector<u8> {
        arg0.genes
    }
    ...
    fun init(arg0: AIFRENS_FOOTIE_LEGENDS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = &mut v3;
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"AIUAT2"));
        ...
        let v7 = AifrensGenesisGlobal{
            ...
            cap             : 50000,
            count           : 0,
            beneficary      : @0x20a711c616b1a85c221c800279a14d09939e1a7ed03de5dcc139662f2d6df08f,
            start_time_ms   : 1,
            expired_time_ms : 11683982800000,
            paused          : false,
        };
