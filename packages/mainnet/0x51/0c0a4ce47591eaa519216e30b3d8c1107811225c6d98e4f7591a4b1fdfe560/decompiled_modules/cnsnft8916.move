module 0x510c0a4ce47591eaa519216e30b3d8c1107811225c6d98e4f7591a4b1fdfe560::cnsnft8916 {
    struct CNSNFT8916 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8916, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8916>(arg0, arg1);
