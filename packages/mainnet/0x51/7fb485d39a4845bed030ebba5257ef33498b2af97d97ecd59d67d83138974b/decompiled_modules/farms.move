module 0x517fb485d39a4845bed030ebba5257ef33498b2af97d97ecd59d67d83138974b::farms {
    ...
    public fun deposit<T0, T1>(arg0: &mut RewardInfo, arg1: &0xb073375aba97556eff7a6263fe686a421e3365877dedb6f68ea938e234d0bf85::pool::Position<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : FarmPosition {
        ...
        let v2 = FarmPosition{
            ...
            clmm_position_id : 0x2::object::id<0xb073375aba97556eff7a6263fe686a421e3365877dedb6f68ea938e234d0bf85::pool::Position<T0, T1>>(arg1),
            liquidity        : v1,
        ...
        let v3 = DepositEvent{
            pool_id     : arg0.pool_id,
            position_id : 0x2::object::uid_to_inner(&v2.id),
            liquidity   : v1,
        };
    ...
    public fun harvest<T0>(arg0: &mut RewardInfo, arg1: &mut RewardBalance<T0>, arg2: &mut FarmPosition, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        advance_accumulator(arg0, v0);
        let v1 = if (arg0.acc_reward_per_share > arg2.reward_debt) {
            arg0.acc_reward_per_share - arg2.reward_debt
        } else {
            0
        };
        let v2 = v1 * (arg2.liquidity as u256) / 340282366920938463463374607431768211456;
        let v3 = (0x2::balance::value<T0>(&arg1.balance) as u256);
        let v4 = if (v2 > v3) {
            v3
        } else {
            v2
        ...
        arg2.last_update_ms = v0;
        if (v4 > 0) {
            let v6 = (v4 as u64);
            if (0x2::balance::value<T0>(&arg1.balance) < v6) {
                abort 1
            };
            let v7 = HarvestEvent{
                pool_id          : arg0.pool_id,
            ...
            0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.balance, v6), arg4)
        } else {
    ...
    public fun withdraw<T0>(arg0: &mut RewardInfo, arg1: &mut RewardBalance<T0>, arg2: FarmPosition, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        advance_accumulator(arg0, 0x2::clock::timestamp_ms(arg3));
        ...
        let v7 = if (arg0.total_staked_liquidity >= arg2.liquidity) {
            arg0.total_staked_liquidity - arg2.liquidity
        } else {
            0
        };
        arg0.total_staked_liquidity = v7;
