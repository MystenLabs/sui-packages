module 0x51405dbf0298ed0531c50208a08074fdea34cfc83797321930394dda9f9909d7::router {
    ...
    public fun finalize_swap<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u16, arg6: address, arg7: u16, arg8: u16, arg9: address, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (v3) {
            ...
            if (v5 > 0) {
                ...
                0x10c52a208c8d392f2727af00d4982f7076d49b1c23ec5b9177c1d40bd6e8e7f7::liquid_mesh_pos_slip_events::emit_positive_slippage(arg10, 0x2::tx_context::sender(arg11), arg9, arg2, v0, v5, arg7, arg8, 0x1::type_name::into_string(0x1::type_name::get<T1>()));
