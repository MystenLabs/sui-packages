module 0x515f5650bd06f5aee5c436979353747485541ec77daa3d7cf5d17d68f0f2e258::x {
    ...
    public fun bg<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: u128, arg2: u64, arg3: u128, arg4: u64) {
        if (arg1 > 0) {
            ...
            assert!(v1 * 10000 <= arg1 * (arg2 as u128), 301);
        };
        if (arg4 > 0 && arg3 > 0) {
            assert!(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::liquidity<T0, T1>(arg0) * 10000 >= arg3 * (arg4 as u128), 302);
        };
    }
