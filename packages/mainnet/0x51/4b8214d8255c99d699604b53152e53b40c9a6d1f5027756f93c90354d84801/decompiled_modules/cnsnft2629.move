module 0x514b8214d8255c99d699604b53152e53b40c9a6d1f5027756f93c90354d84801::cnsnft2629 {
    struct CNSNFT2629 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2629, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9763"));
        let v4 = 0x2::package::claim<CNSNFT2629>(arg0, arg1);
