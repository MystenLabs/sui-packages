module 0x5130104c3b5a838ac31a550899a1b1a2a14496ff449a00ce9e99e8473ebda4f9::cnsnft1435 {
    struct CNSNFT1435 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1435, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1435>(arg0, arg1);
