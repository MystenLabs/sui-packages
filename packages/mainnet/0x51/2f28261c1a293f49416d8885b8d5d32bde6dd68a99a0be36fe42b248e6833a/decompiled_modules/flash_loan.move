module 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::flash_loan {
    ...
    public(friend) fun create_asset(arg0: &mut Config, arg1: u8, arg2: 0x1::ascii::String, arg3: address, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::event::emit_asset_config_created(0x2::tx_context::sender(arg8), 0x2::object::uid_to_address(&arg0.id), v1, get_market_id(arg0));
    }
    ...
    public(friend) fun create_config_with_market_id(arg0: &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_market_id(arg0);
        ...
        0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::event::emit_config_created(0x2::tx_context::sender(arg1), 0x2::object::uid_to_address(&v1), v0);
    ...
    fun get_asset_config_by_coin_type(arg0: &mut Config, arg1: 0x1::ascii::String) : &mut AssetConfig {
        assert!(0x2::table::contains<vector<u8>, address>(&arg0.support_assets, *0x1::ascii::as_bytes(&arg1)), 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::error::reserve_not_found());
    ...
    public fun init_config_for_main_market(arg0: &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::StorageAdminCap, arg1: &mut Config) {
        let v0 = MARKET_ID_KEY{dummy_field: false};
    ...
    public(friend) fun loan<T0>(arg0: &Config, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg2: address, arg3: u64) : (0x2::balance::Balance<T0>, Receipt<T0>) {
        ...
        0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::event::emit_flash_loan(arg2, *v1, arg3, get_market_id(arg0));
        (0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::withdraw_balance<T0>(arg1, arg3, arg2), v4)
    }

    public(friend) fun loan_v2<T0>(arg0: &Config, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg2: address, arg3: u64, arg4: &mut 0x3::sui_system::SuiSystemState, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, Receipt<T0>) {
        version_verification(arg0);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x2::table::contains<vector<u8>, address>(&arg0.support_assets, *0x1::ascii::as_bytes(&v0)), 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::error::reserve_not_found());
        let v1 = 0x2::table::borrow<vector<u8>, address>(&arg0.support_assets, *0x1::ascii::as_bytes(&v0));
        ...
        0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::event::emit_flash_loan(arg2, *v1, arg3, get_market_id(arg0));
        (0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::withdraw_balance_v2<T0>(arg1, arg3, arg2, arg4, arg5), v4)
    }
    ...
    public(friend) fun repay<T0>(arg0: &0x2::clock::Clock, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg3: Receipt<T0>, arg4: address, arg5: 0x2::balance::Balance<T0>) : 0x2::balance::Balance<T0> {
        ...
        0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::event::emit_flash_repay(arg4, v1, v2, v4, v5, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_market_id(arg1));
        arg5
    }
    ...
    fun verify_config(arg0: &AssetConfig) {
        assert!(arg0.rate_to_supplier + arg0.rate_to_treasury < 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::constants::FlashLoanMultiple(), 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::error::invalid_amount());
        assert!(arg0.min < arg0.max, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::error::invalid_amount());
    }
