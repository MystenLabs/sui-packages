module 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements {
    ...
    public(friend) fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LP<T0, T1>>, vector<u64>) {
        ...
        let v9 = if (0 == v6) {
            let v10 = 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::math::sqrt(0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::math::mul_to_u128(v7, v8));
            assert!(v10 > 1000, 8);
    ...
    public fun calc_optimal_coin_values(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : (u64, u64) {
        ...
        let v0 = 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::math::mul_div(arg0, arg5, arg4);
        if (v0 <= arg1) {
            assert!(v0 >= arg3, 4);
            return (arg0, v0)
        };
        let v1 = 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::math::mul_div(arg1, arg4, arg5);
        assert!(v1 <= arg0, 6);
        assert!(v1 >= arg2, 3);
        (v1, arg1)
    }
    ...
    public fun get_amount_out(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::math::mul_div_u128(v0, (arg2 as u128), (arg1 as u128) * (10000 as u128) + v0)
    }
    ...
    public fun get_fee_to_fundation(arg0: u64, arg1: u64) : u64 {
        0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::math::mul_div(arg0, arg1, 10000)
    }
    ...
    public fun get_swap_out<T0, T1>(arg0: &mut Global, arg1: u64, arg2: bool) : u64 {
        ...
        if (arg2) {
            ...
            if (v11) {
                let v15 = 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::math::mul_div(arg1, (v10.free_ratio as u64), 100);
                arg1 = arg1 - v15;
            };
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Global{
            ...
            has_paused          : false,
            controller          : @0x52a3a7620a0a7d0974ae20813357d7e7a0c6c8ec52d071b4ab2d249f690a2c35,
            beneficiary         : @0x52a3a7620a0a7d0974ae20813357d7e7a0c6c8ec52d071b4ab2d249f690a2c35,
            admin               : @0x52a3a7620a0a7d0974ae20813357d7e7a0c6c8ec52d071b4ab2d249f690a2c35,
            pool_fee            : 30,
    ...
    public fun is_order<T0, T1>() : bool {
        ...
        let v2 = 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::comparator::compare<0x1::type_name::TypeName>(&v0, &v1);
        assert!(!0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::comparator::is_equal(&v2), 9);
        0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::comparator::is_smaller_than(&v2)
    }
    ...
    public fun is_sui<T0>() : bool {
        ...
        let v2 = 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::comparator::compare<0x1::ascii::String>(&v1, &v0);
        0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::comparator::is_equal(&v2)
    }
    ...
    public(friend) fun register_pool<T0, T1>(arg0: &mut Global, arg1: bool) {
        ...
        let v3 = Pool<T0, T1>{
            ...
            market_address : @0x0,
            burn_address   : @0x0,
            rebot          : @0x52a3a7620a0a7d0974ae20813357d7e7a0c6c8ec52d071b4ab2d249f690a2c35,
    ...
    public(friend) fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        (0x2::coin::take<T0>(&mut arg0.coin_x, 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::math::mul_div(v1, v0, v3), arg3), 0x2::coin::take<T1>(&mut arg0.coin_y, 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::math::mul_div(v2, v0, v3), arg3))
    }
    ...
    public(friend) fun swapCoin<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (arg3) {
            ...
            if (!v3) {
                ...
                let v11 = v10 / 2;
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v9, v11, arg4), v2.burn_address);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v9, v11, arg4), v2.market_address);
                v8 = v7 - v10;
            };
            let v12 = get_fee_to_fundation(v8, v0);
            let v13 = get_amount_out(v8 - v12, v4, v5);
            let v14 = v13;
            if (v3) {
            ...
            assert!(v14 >= arg2, 7);
            0x2::balance::join<T0>(&mut v2.fee_coin_x, 0x2::balance::split<T0>(&mut v9, v12));
            0x2::balance::join<T0>(&mut v2.coin_x, v9);
            let (v16, v17, _) = get_reserves_size<T0, T1>(v2);
            assert_lp_value_is_increased(v4, v5, v16, v17);
            0x2::coin::take<T1>(&mut v2.coin_y, v14, arg4)
        } else {
            let v19 = get_mut_pool<T1, T0>(arg0, !arg3);
            is_tax_coin<T0>(0x1::ascii::into_bytes(v19.tax_coin));
            let (v20, v21, _) = get_reserves_size<T1, T0>(v19);
            assert!(v20 > 0 && v21 > 0, 1);
            let v23 = 0x2::coin::value<T0>(&arg1);
            let v24 = 0x2::coin::into_balance<T0>(arg1);
            let v25 = get_fee_to_fundation(v23, v0);
            let v26 = get_amount_out(v23 - v25, v21, v20);
            assert!(v26 >= arg2, 7);
            0x2::balance::join<T0>(&mut v19.fee_coin_y, 0x2::balance::split<T0>(&mut v24, v25));
            0x2::balance::join<T0>(&mut v19.coin_y, v24);
            let (v27, v28, _) = get_reserves_size<T1, T0>(v19);
            assert_lp_value_is_increased(v20, v21, v27, v28);
            0x2::coin::take<T1>(&mut v19.coin_x, v26, arg4)
        }
    }
    ...
    public(friend) fun swap_out<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        if (arg3) {
            ...
            let v12 = get_fee_to_fundation(v8, v0);
            let v13 = v8 - v12;
            let v14 = get_amount_out(v13, v4, v5);
            let v15 = v14;
            if (v3) {
                let v16 = v14 * (v2.free_ratio as u64) / 100;
            ...
            assert_lp_value_is_increased(v4, v5, v17, v18);
            let v20 = 0x1::vector::empty<u64>();
            0x1::vector::push_back<u64>(&mut v20, v13);
            ...
            if (!is_tax_coin<T0>(0x1::ascii::into_bytes(v21.tax_coin)) && v21.has_paused) {
                abort 16
            };
            let v22 = is_tax_coin<T0>(0x1::ascii::into_bytes(v21.tax_coin));
            let (v23, v24, _) = get_reserves_size<T1, T0>(v21);
            assert!(v23 > 0 && v24 > 0, 1);
            let v26 = 0x2::coin::value<T0>(&arg1);
            let v27 = v26;
            let v28 = 0x2::coin::into_balance<T0>(arg1);
            if (v22) {
                let v29 = 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::math::mul_div(v26, (v21.free_ratio as u64), 100);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v28, v29, arg4), v21.burn_address);
                v27 = v26 - v29;
            };
            let v30 = get_fee_to_fundation(v27, v0);
            let v31 = v27 - v30;
            let v32 = get_amount_out(v31, v24, v23);
            let v33 = v32;
            if (!v22) {
                let v34 = v32 * (v21.free_ratio as u64) / 100;
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut v21.coin_x, v34, arg4), v21.burn_address);
                v33 = v32 - v34;
            };
            assert!(v33 >= arg2, 7);
            0x2::balance::join<T0>(&mut v21.fee_coin_y, 0x2::balance::split<T0>(&mut v28, v30));
            0x2::balance::join<T0>(&mut v21.coin_y, v28);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut v21.coin_x, v33, arg4), 0x2::tx_context::sender(arg4));
            let (v35, v36, _) = get_reserves_size<T1, T0>(v21);
            assert_lp_value_is_increased(v23, v24, v35, v36);
            let v38 = 0x1::vector::empty<u64>();
            0x1::vector::push_back<u64>(&mut v38, 0);
            0x1::vector::push_back<u64>(&mut v38, v33);
            0x1::vector::push_back<u64>(&mut v38, v31);
            0x1::vector::push_back<u64>(&mut v38, 0);
            v38
        }
    }
