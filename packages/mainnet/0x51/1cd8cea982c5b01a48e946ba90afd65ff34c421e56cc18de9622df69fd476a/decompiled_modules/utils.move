module 0x5e93c351019084c0ece86dd35382a7c51a9a4073c70101d13b454eade8003bb0::utils {
    public fun get_description_nft() : vector<u8> {
        b"3333 CHONCHOS, SUI IS CHONCHO, EVERYTHING IS CHONCHO "
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeihelz4c5cmivpfrelyinbgs37d2fgq2tyvjpxru3q4zfz7u2jpcg4/images/"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeibjehprnos7aazanykesk67kzxn6dxp24klkkwmql5dko4oli3bym/"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/ChonchosNft"
    }
