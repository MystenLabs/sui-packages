module 0xc33f3c5121431fede46d4612ac0dde0e7f5157d1397d66cb83811772ba15e5f5::cnsnft9388 {
    struct CNSNFT9388 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9388, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9388>(arg0, arg1);
