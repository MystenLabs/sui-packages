module 0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::credenza_airdrop {
    ...
    public fun request_asset(arg0: &mut CredenzaAirdropConfig, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::bag::borrow_mut<u64, 0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::credenza_asset_collection::TokenizedAsset>(&mut arg0.items, arg1);
        assert!(arg2 <= 0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::credenza_asset_collection::value(v3), 4);
        0x2::transfer::public_transfer<0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::credenza_asset_collection::TokenizedAsset>(0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::credenza_asset_collection::split(v3, arg2, arg3), 0x2::tx_context::sender(arg3));
    }
    ...
    public fun set_asset(arg0: &mut CredenzaAirdropConfig, arg1: 0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::credenza_asset_collection::TokenizedAsset, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 0);
        let v0 = 0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::credenza_asset_collection::asset_id(&arg1);
        if (0x2::bag::contains<u64>(&arg0.items, v0)) {
            0x2::transfer::public_transfer<0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::credenza_asset_collection::TokenizedAsset>(0x2::bag::remove<u64, 0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::credenza_asset_collection::TokenizedAsset>(&mut arg0.items, v0), 0x2::tx_context::sender(arg2));
        };
        0x2::bag::add<u64, 0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::credenza_asset_collection::TokenizedAsset>(&mut arg0.items, v0, arg1);
    }
