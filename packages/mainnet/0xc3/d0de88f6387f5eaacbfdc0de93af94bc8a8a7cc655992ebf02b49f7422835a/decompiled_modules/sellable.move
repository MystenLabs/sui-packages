module 0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::sellable {
    ...
    struct CredenzaSellableConfig<phantom T0> has store, key {
        id: 0x2::object::UID,
        ownership: 0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::ownership::CredenzaOwnership,
    ...
    public fun set_owner<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: address, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::ownership::set_owner(&mut arg0.ownership, arg1, arg2);
    }
    ...
    public fun create_config<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : (T0, CredenzaSellableConfig<T0>) {
        ...
        let v1 = CredenzaSellableConfig<T0>{
            id                      : v0,
            ownership               : 0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
        ...
        0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg1));
    ...
    public fun set_asset_price_fiat_for_currency<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: u64, arg2: vector<u8>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg4));
    ...
    public fun set_beneficiary_adress<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0xc3d0de88f6387f5eaacbfdc0de93af94bc8a8a7cc655992ebf02b49f7422835a::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg2));
