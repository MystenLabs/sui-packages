module 0x536a29e1ffe898ad5cf16d58722503c356087a3185d434a841874764544f058b::n {
    ...
    public fun us(arg0: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg1: address, arg2: u64, arg3: u64) : (vector<U>, bool) {
        ...
        while (v6 < v5) {
            let v7 = (v6 as u8);
            let (v8, v9) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_balance(arg0, v7, arg1);
            let v10 = U{
                id : v7,
                s  : v8,
                b  : v9,
            };
            0x1::vector::push_back<U>(&mut v2, v10);
            v6 = v6 + 1;
        };
        if (v6 + arg3 < (v3 as u64)) {
            v1 = true;
        };
        (v2, v1)
    }
