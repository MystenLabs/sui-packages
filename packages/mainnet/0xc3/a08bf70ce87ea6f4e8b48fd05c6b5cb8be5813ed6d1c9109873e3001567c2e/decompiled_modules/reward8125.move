module 0xc3a08bf70ce87ea6f4e8b48fd05c6b5cb8be5813ed6d1c9109873e3001567c2e::reward8125 {
    struct REWARD8125 has drop {
        dummy_field: bool,
    }

    struct TICKET_8125 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8125(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8125>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8125>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8125, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8125>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8125>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8125>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8125>>(v5, 0x2::tx_context::sender(arg1));
    }
