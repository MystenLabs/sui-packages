module 0xc33f708e378c2bb53f62dcb70d40e25e95e221067d2cd0bb397e28d55e73ed41::mini_game {
    struct Game has key {
        id: 0x2::object::UID,
        balance: 0x2::balance::Balance<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>,
        ticket: u64,
        reward: u64,
    }
    ...
    public entry fun bet(arg0: vector<u64>, arg1: &mut Game, arg2: &mut 0x2::coin::Coin<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<u64>(&arg0) == 7, 0);
        assert!(0x2::balance::value<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>(&arg1.balance) >= arg1.reward, 2);
        assert!(0x2::coin::value<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>(arg2) >= arg1.ticket, 1);
        let v0 = 0;
        ...
        0x2::balance::join<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>(&mut arg1.balance, 0x2::balance::split<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>(0x2::coin::balance_mut<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>(arg2), arg1.ticket));
        ...
        if (v3) {
            ...
            if (v4 == 1) {
                ...
                v6 = 2000;
                v5 = 0x1::string::utf8(x"e681ade5969cefbc8ce682a8e88eb7e5be97e4ba94e7ad89e5a596efbc8ce88eb7e58f96e5be9732304e42efbc81");
            } else if (v4 == 6) {
                v6 = 1500;
                v5 = 0x1::string::utf8(x"e681ade5969cefbc8ce682a8e88eb7e5be97e585ade7ad89e5a596efbc8ce88eb7e58f96e5be9731354e42efbc81");
            };
            0x2::transfer::public_transfer<0x2::coin::Coin<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>>(0x2::coin::from_balance<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>(0x2::balance::split<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>(&mut arg1.balance, v6), arg4), 0x2::tx_context::sender(arg4));
        } else {
    ...
    public entry fun deposit(arg0: &mut Game, arg1: 0x2::coin::Coin<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>) {
        0x2::balance::join<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>(&mut arg0.balance, 0x2::coin::into_balance<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>(arg1));
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Game{
            ...
            balance : 0x2::balance::zero<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>(),
            ticket  : 10000,
            reward  : 1000,
        };
    ...
    public entry fun withdraw(arg0: &AdaminCap, arg1: &mut Game, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>>(0x2::coin::from_balance<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>(0x2::balance::split<0x4280d7b4218d048382b33c5e4ca907f69d140e3c4bb529d2ab6faa04f10f313f::faucet_coin::FAUCET_COIN>(&mut arg1.balance, arg2), arg3), 0x2::tx_context::sender(arg3));
    }
