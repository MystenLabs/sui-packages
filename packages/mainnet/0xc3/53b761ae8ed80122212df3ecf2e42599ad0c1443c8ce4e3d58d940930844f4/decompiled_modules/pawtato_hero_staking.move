module 0xe0fa7b75a3dc8137b38bceb0c0c21c10e0f57c408fe9068694f58fd21e071925::pawtato_hero_staking {
    ...
    public fun migrate_user_heroes_to_kiosk(arg0: &0xe0fa7b75a3dc8137b38bceb0c0c21c10e0f57c408fe9068694f58fd21e071925::pawtato_heroes::HeroAdminCap, arg1: &mut HeroStakingPool, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &mut 0x2::transfer_policy::TransferPolicy<0xe0fa7b75a3dc8137b38bceb0c0c21c10e0f57c408fe9068694f58fd21e071925::pawtato_heroes::HERO>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) : vector<0x2::object::ID> {
        assert!(is_user_registered(arg1, arg5), 3);
        let v0 = 0x2::table::borrow_mut<address, HeroUserInfo>(&mut arg1.users, arg5);
        let v1 = 0x1::vector::length<HeroInfo>(&v0.heroes);
        assert!(v1 > 0, 4);
        ...
        while (v3 < v1 && v3 < 100) {
            let v4 = v1 - 1 - v3;
            let v5 = 0x1::vector::borrow<HeroInfo>(&v0.heroes, v4).nft_id;
            0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_kiosk_helpers::direct_transfer<0xe0fa7b75a3dc8137b38bceb0c0c21c10e0f57c408fe9068694f58fd21e071925::pawtato_heroes::HERO>(&mut arg1.kiosk, &arg1.kiosk_owner_cap, arg2, arg3, v5, arg4, arg6);
            0x1::vector::remove<HeroInfo>(&mut v0.heroes, v4);
