module 0xc3d49edce01c2b8fa764df54671d06047347298e9929483f4c58aa48333987d7::cnsnft2169 {
    struct CNSNFT2169 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2169, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2169>(arg0, arg1);
