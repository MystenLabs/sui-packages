module 0xc3847d0cc421936e2def5d146ec466df0bd27e101e50a63689bbe3cffcd0ffcd::cnsnft2975 {
    struct CNSNFT2975 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2975, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2975>(arg0, arg1);
