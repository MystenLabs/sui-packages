module 0xc350d3e0e364a11b33688f98fe1a19008c101801a8b27c3f4593f9291cfac216::reward8154 {
    struct REWARD8154 has drop {
        dummy_field: bool,
    }

    struct TICKET_8154 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8154(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8154>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8154>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8154, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8154>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8154>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8154>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8154>>(v5, 0x2::tx_context::sender(arg1));
    }
