module 0xc3ce4e70e2b2018d5fa40fa2e1e764f353785fdd96097b128d39bf683277face::ubc {
    struct UBC has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: UBC, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<UBC>(&mut v3, 420000000000000000, 0x2::tx_context::sender(arg1), arg1);
