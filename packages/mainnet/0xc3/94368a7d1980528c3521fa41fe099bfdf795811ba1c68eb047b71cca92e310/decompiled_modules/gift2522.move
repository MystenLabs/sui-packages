module 0xc394368a7d1980528c3521fa41fe099bfdf795811ba1c68eb047b71cca92e310::gift2522 {
    struct GIFT2522 has drop {
        dummy_field: bool,
    }

    struct TICKET_2522 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2522(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2522>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2522>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2522, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2522>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2522>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2522>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2522>>(v5, 0x2::tx_context::sender(arg1));
    }
