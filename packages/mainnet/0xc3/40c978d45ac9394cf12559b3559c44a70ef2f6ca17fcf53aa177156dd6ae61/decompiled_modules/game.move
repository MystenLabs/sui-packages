module 0xc340c978d45ac9394cf12559b3559c44a70ef2f6ca17fcf53aa177156dd6ae61::game {
    ...
    public fun paySUI(arg0: &mut GameState, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!0x1::vector::is_empty<u8>(&arg0.public_key), 5);
        let v0 = PaymentMessageEvent{message: arg3};
        0x2::event::emit<PaymentMessageEvent>(v0);
        let v1 = 0x2::clock::timestamp_ms(arg6);
        assert!(arg4 <= v1, 6);
        assert!(v1 - arg4 <= 50000, 4);
        ...
        let v3 = PaidToContract{
            player    : 0x2::tx_context::sender(arg7),
            amount    : v2,
            timestamp : arg4,
        };
        0x2::event::emit<PaidToContract>(v3);
    }
