module 0xc32c927e9323e15e6c192027814da31d55c179dc5bb46b5bad3ba0458bff58ea::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"astro", b"astro dog", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-15T13-33-08.193Z-Cheems.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"astro dog"),
            symbol     : 0x1::string::utf8(b"astro"),
            decimals   : 9,
