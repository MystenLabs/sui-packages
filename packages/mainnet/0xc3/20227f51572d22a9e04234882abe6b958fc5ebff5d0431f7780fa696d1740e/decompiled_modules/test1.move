module 0xc320227f51572d22a9e04234882abe6b958fc5ebff5d0431f7780fa696d1740e::test1 {
    ...
    fun init(arg0: TEST1, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TEST1>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Test1"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Test1 https://t.me/spidersui test"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiawxn3j5is3czdjy66al4buqquijpiitisqzycqclx7hyfmxcprzy"));
