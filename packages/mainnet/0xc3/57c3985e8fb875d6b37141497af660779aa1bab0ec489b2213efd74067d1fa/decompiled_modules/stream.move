module 0xc357c3985e8fb875d6b37141497af660779aa1bab0ec489b2213efd74067d1fa::stream {
    ...
    public entry fun cancel_stream<T0>(arg0: &mut Stream<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = CancelEvent{
            ...
            coin            : 0xc357c3985e8fb875d6b37141497af660779aa1bab0ec489b2213efd74067d1fa::vault::coin_key<T0>(),
            withdraw_amount : v2,
    ...
    public entry fun claim_stream_by_proxy<T0>(arg0: &mut Stream<T0>, arg1: &mut 0xc357c3985e8fb875d6b37141497af660779aa1bab0ec489b2213efd74067d1fa::vault::Vault, arg2: &0xc357c3985e8fb875d6b37141497af660779aa1bab0ec489b2213efd74067d1fa::fee_module::Fee, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.auto_claim, 14);
        let v0 = claim_stream_internal<T0>(arg0, arg3, arg4);
        0xc357c3985e8fb875d6b37141497af660779aa1bab0ec489b2213efd74067d1fa::vault::collect_fee<T0>(arg1, 0x2::coin::split<T0>(&mut v0, 0xc357c3985e8fb875d6b37141497af660779aa1bab0ec489b2213efd74067d1fa::fee_module::claim_fee(arg2, 0x2::coin::value<T0>(&v0)), arg4));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v0, arg0.config.recipient);
    }
    ...
    public entry fun create_stream<T0>(arg0: &0xc357c3985e8fb875d6b37141497af660779aa1bab0ec489b2213efd74067d1fa::fee_module::Fee, arg1: &mut 0xc357c3985e8fb875d6b37141497af660779aa1bab0ec489b2213efd74067d1fa::vault::Vault, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: 0x1::ascii::String, arg5: address, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: bool, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        let v0 = arg10 * arg9 + arg7;
        0xc357c3985e8fb875d6b37141497af660779aa1bab0ec489b2213efd74067d1fa::vault::collect_fee<T0>(arg1, 0x2::coin::split<T0>(&mut arg2, 0xc357c3985e8fb875d6b37141497af660779aa1bab0ec489b2213efd74067d1fa::fee_module::streaming_fee(arg0, v0), arg13));
        assert!(0x2::coin::value<T0>(&arg2) == v0, 1);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) == 0xc357c3985e8fb875d6b37141497af660779aa1bab0ec489b2213efd74067d1fa::fee_module::streaming_flat_fee(arg0), 16);
        0xc357c3985e8fb875d6b37141497af660779aa1bab0ec489b2213efd74067d1fa::vault::collect_fee<0x2::sui::SUI>(arg1, arg3);
        let v1 = StreamConfig{
            metadata         : arg4,
