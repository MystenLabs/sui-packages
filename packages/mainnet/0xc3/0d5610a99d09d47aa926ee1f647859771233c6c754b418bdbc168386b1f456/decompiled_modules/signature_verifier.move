module 0xc30d5610a99d09d47aa926ee1f647859771233c6c754b418bdbc168386b1f456::signature_verifier {
    ...
    public fun admin_cleanup_expired_nonces(arg0: &mut SignatureConfig, arg1: vector<u64>, arg2: u64, arg3: &0xc30d5610a99d09d47aa926ee1f647859771233c6c754b418bdbc168386b1f456::admin::DropkitAdminCap) : u64 {
        let v0 = 0;
        let v1 = 0;
    ...
    public fun admin_remove_expired_nonce(arg0: &mut SignatureConfig, arg1: u64, arg2: u64, arg3: &0xc30d5610a99d09d47aa926ee1f647859771233c6c754b418bdbc168386b1f456::admin::DropkitAdminCap) : bool {
    ...
    public fun set_signature_requirement(arg0: &mut SignatureConfig, arg1: bool, arg2: vector<u8>) {
        if (arg1) {
    ...
    public fun update_backend_public_key(arg0: &mut SignatureConfig, arg1: vector<u8>, arg2: &0xc30d5610a99d09d47aa926ee1f647859771233c6c754b418bdbc168386b1f456::admin::DropkitAdminCap) {
        assert!(!0x1::vector::is_empty<u8>(&arg1), 12);
        assert!(0x1::vector::length<u8>(&arg1) == 32, 5);
