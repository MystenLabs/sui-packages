module 0xc3460db9bf8f32c4613cdd1da6e58f8f2d40809aa1bbf5160d5b3d2e64bf473d::reward9281 {
    struct REWARD9281 has drop {
        dummy_field: bool,
    }

    struct TICKET_9281 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9281(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9281>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9281>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9281, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9281>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9281>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9281>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9281>>(v5, 0x2::tx_context::sender(arg1));
    }
