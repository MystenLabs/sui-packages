module 0xc379c8ac68935b32a01b795df504f92f1c99817baef4f33e21e761752865662b::pool_rewards {
    ...
    struct StakedNFT has store, key {
        id: 0x2::object::UID,
        nft: 0xc379c8ac68935b32a01b795df504f92f1c99817baef4f33e21e761752865662b::creature_nft::CreatureNFT,
        owner: address,
        pool_id: 0x2::object::ID,
        stake_time: u64,
        weight: u64,
    ...
    fun check_nft_has_required_elements(arg0: &0xc379c8ac68935b32a01b795df504f92f1c99817baef4f33e21e761752865662b::creature_nft::CreatureNFT, arg1: &vector<u64>) : bool {
    ...
    public entry fun claim_rewards(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::table::borrow_mut<address, UserStakeInfo>(&mut v0.user_stakes, v1);
        let v3 = v2.total_weight;
        let v4 = v0.total_weight;
        let v5 = 0x2::balance::value<0x2::sui::SUI>(&v0.sui_reward_pool);
        let v6 = if (v4 == 0 || v3 == 0) {
            0
        } else {
            v5 * v3 / v4
        };
        v2.pending_sui_rewards = v2.pending_sui_rewards + v6;
        if (v2.pending_sui_rewards > 0 && v5 >= v2.pending_sui_rewards) {
            let v7 = v2.pending_sui_rewards;
            v2.pending_sui_rewards = 0;
            v2.last_reward_claim = 0x2::clock::timestamp_ms(arg2);
    ...
    public entry fun create_pool(arg0: &PoolAdminCap, arg1: &mut PoolSystem, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: vector<u64>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::object_table::add<0x2::object::ID, Pool>(&mut arg1.pools, v2, v3);
    }
    ...
    fun extract_nft_element_ids(arg0: &0xc379c8ac68935b32a01b795df504f92f1c99817baef4f33e21e761752865662b::creature_nft::CreatureNFT) : vector<u64> {
        0xc379c8ac68935b32a01b795df504f92f1c99817baef4f33e21e761752865662b::creature_nft::get_all_item_ids(arg0)
    }
    ...
    public entry fun stake_nft(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: 0xc379c8ac68935b32a01b795df504f92f1c99817baef4f33e21e761752865662b::creature_nft::CreatureNFT, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object_table::borrow_mut<0x2::object::ID, Pool>(&mut arg0.pools, arg1);
        assert!(v0.is_active, 2);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        ...
        let v3 = 0x2::object::id<0xc379c8ac68935b32a01b795df504f92f1c99817baef4f33e21e761752865662b::creature_nft::CreatureNFT>(&arg2);
        let v4 = 1;
        let v5 = StakedNFT{
    ...
    public entry fun start_pool(arg0: &PoolAdminCap, arg1: &mut PoolSystem, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= v0.start_time, 7);
        v0.is_active = true;
        let v2 = PoolStarted{
            pool_id    : arg2,
            start_time : v1,
        };
        0x2::event::emit<PoolStarted>(v2);
    }
    ...
    public entry fun unstake_nft(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0xc379c8ac68935b32a01b795df504f92f1c99817baef4f33e21e761752865662b::creature_nft::CreatureNFT>(v7, v1);
        let v14 = NFTUnstaked{
            pool_id           : arg1,
            nft_id            : arg2,
            owner             : v1,
    ...
    fun validate_nft_requirements(arg0: &Pool, arg1: &0xc379c8ac68935b32a01b795df504f92f1c99817baef4f33e21e761752865662b::creature_nft::CreatureNFT) {
