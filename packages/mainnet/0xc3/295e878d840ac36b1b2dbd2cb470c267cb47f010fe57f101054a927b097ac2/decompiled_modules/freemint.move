module 0xc3295e878d840ac36b1b2dbd2cb470c267cb47f010fe57f101054a927b097ac2::freemint {
    struct Minted {
        owner: address,
        count: u64,
    }
    ...
    public entry fun freemint(arg0: &mut FreeMint, arg1: &mut 0xc3295e878d840ac36b1b2dbd2cb470c267cb47f010fe57f101054a927b097ac2::nft::Infomation, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < 5) {
            ...
            0xc3295e878d840ac36b1b2dbd2cb470c267cb47f010fe57f101054a927b097ac2::nft::mint(v7, arg1, arg2);
