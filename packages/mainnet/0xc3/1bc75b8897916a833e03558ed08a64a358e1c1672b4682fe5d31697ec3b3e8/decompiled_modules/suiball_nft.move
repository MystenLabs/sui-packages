module 0xc31bc75b8897916a833e03558ed08a64a358e1c1672b4682fe5d31697ec3b3e8::suiball_nft {
    ...
    public entry fun mint_to_sender(arg0: &mut ItemStore, arg1: 0x2::coin::Coin<0xc31bc75b8897916a833e03558ed08a64a358e1c1672b4682fe5d31697ec3b3e8::usdc::USDC>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.counter < 5000, 1);
        assert!(arg2 > 0, 2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xc31bc75b8897916a833e03558ed08a64a358e1c1672b4682fe5d31697ec3b3e8::usdc::USDC>>(arg1, @0xb5977ee8b565fb51a9be2f032111dec12f3df06a7a49ae67f2d81378e3b0aa45);
        let v0 = 0;
