module 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::router {
    ...
    public fun unfreeze_and_add_liquidity<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg7: &mut 0x2::tx_context::TxContext) {
        0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::assert_version_contract(arg6);
        let v0 = 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::check_pool_exist<T0, T1>(arg6) || 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::check_pool_exist<T1, T0>(arg6);
        if (!v0) {
            0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::create_new_pool<T0, T1>(arg6, arg7);
        ...
        if (0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::utils::sort_token_type<T0, T1>()) {
            let (v1, v2, _) = 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::unfreeze_and_add_liquidity<T0, T1>(arg0, arg2, arg1, arg3, 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::get_pool<T0, T1>(arg6), @0x1937f2c5ce1cbab08893b63945c20cde349e4a7850eea317b965ff8da383c80e, arg7);
            assert!(v1 >= arg4, 2);
            assert!(v2 >= arg5, 3);
        } else {
            let (v4, v5, _) = 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::unfreeze_and_add_liquidity<T1, T0>(arg2, arg0, arg3, arg1, 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::get_pool<T1, T0>(arg6), @0x1937f2c5ce1cbab08893b63945c20cde349e4a7850eea317b965ff8da383c80e, arg7);
            assert!(v5 >= arg4, 2);
            assert!(v4 >= arg5, 3);
        };
    }
