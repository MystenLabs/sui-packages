module 0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::claim_campaign {
    ...
    struct ClaimCampaign has key {
        ...
        pool: 0x2::balance::Balance<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>,
    ...
    public entry fun claim(arg0: &mut ClaimCampaign, arg1: vector<vector<u8>>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::merkle::verify_proof(&arg1, &arg0.merkle_root, 0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::merkle::compute_leaf(v0, arg0.amount_per_claim)), 4);
        assert!(0x2::balance::value<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>(&arg0.pool) >= arg0.amount_per_claim, 5);
        0x2::table::add<address, bool>(&mut arg0.claimed, v0, true);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>>(0x2::coin::from_balance<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>(0x2::balance::split<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>(&mut arg0.pool, arg0.amount_per_claim), arg2), v0);
        let v1 = Claimed{
    ...
    public entry fun close_campaign(arg0: &mut ClaimCampaign, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.is_closed = true;
        let v0 = 0x2::balance::value<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>(&arg0.pool);
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>>(0x2::coin::from_balance<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>(0x2::balance::split<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>(&mut arg0.pool, v0), arg2), 0x2::tx_context::sender(arg2));
        };
    ...
    public fun create_campaign(arg0: 0x1::string::String, arg1: vector<u8>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : AdminCap {
        ...
        let v1 = ClaimCampaign{
            ...
            pool             : 0x2::balance::zero<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>(),
    ...
    public entry fun fund_campaign(arg0: &mut ClaimCampaign, arg1: 0x2::coin::Coin<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>, arg2: &AdminCap) {
        0x2::balance::join<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>(&mut arg0.pool, 0x2::coin::into_balance<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>(arg1));
        let v0 = CampaignFunded{
            campaign_id  : 0x2::object::uid_to_inner(&arg0.id),
            added_amount : 0x2::coin::value<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>(&arg1),
            pool_total   : 0x2::balance::value<0xc330a912193feaa7fe545405810732e494b57ece7bc7ecf0e4412e834c33a487::axiom_mainnet_claim::AXIOM_MAINNET_CLAIM>(&arg0.pool),
        };
