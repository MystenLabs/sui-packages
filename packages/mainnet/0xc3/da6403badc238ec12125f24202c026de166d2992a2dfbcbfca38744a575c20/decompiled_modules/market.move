    ...
    public fun highest_bid(arg0: &Marketplace, arg1: u64, arg2: u64) : vector<0x2::object::ID> {
        ...
        while (v5 < 50) {
            ...
            while (0x1::vector::length<Bid>(v8) > arg2) {
                ...
                0x1::vector::push_back<u64>(&mut v3, 0x2::balance::value<0x2::sui::SUI>(&v9.balance) / v9.amt);
            ...
            arg2 = 0;
            let (v11, v12) = 0xb88f9149c55d6314b7ae436a730cfbf3a5d53522f37e2d56288531bb8adc7071::critbit::previous_leaf<vector<Bid>>(&arg0.bid, arg1);
