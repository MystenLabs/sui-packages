module 0xc3fae86b2591255013fae250ea4d72c0036109c181a801aa26ce084420953a56::vault {
    ...
    struct Vault<phantom T0> has key {
        ...
        treasury_cap: 0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::ReceiptTreasuryCap,
    }
    ...
    public fun borrow_treasury_ref<T0>(arg0: &Vault<T0>) : &0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::ReceiptTreasuryCap {
        &arg0.treasury_cap
    }
    ...
    public fun commit_strategy<T0, T1>(arg0: &mut Vault<T0>, arg1: &ProtocolAccessCap, arg2: BorrowReceipt<T0>, arg3: 0x2::balance::Balance<T1>, arg4: u8, arg5: u64) {
        ...
        if (v0 > 0) {
            assert!(arg5 >= v0 - v0 * 0xc3fae86b2591255013fae250ea4d72c0036109c181a801aa26ce084420953a56::floors::max_slippage_ceil() / 10000, 207);
        };
    ...
    public fun commit_unwind<T0>(arg0: &mut Vault<T0>, arg1: &ProtocolAccessCap, arg2: YieldPromise<T0>, arg3: 0x2::coin::Coin<T0>, arg4: u64) {
        ...
        let v3 = if (is_depeg_active<T0>(arg0)) {
            0xc3fae86b2591255013fae250ea4d72c0036109c181a801aa26ce084420953a56::floors::max_emergency_slippage_ceil()
        } else {
            0xc3fae86b2591255013fae250ea4d72c0036109c181a801aa26ce084420953a56::floors::max_slippage_ceil()
        };
        if (arg4 > 0) {
    ...
    public fun create_vault<T0>(arg0: 0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::ReceiptTreasuryCap, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
    ...
    public fun deposit_existing<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::AqReceipt, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        if (arg0.current_strategy != 0 && arg0.last_heartbeat_ms > 0) {
            0xc3fae86b2591255013fae250ea4d72c0036109c181a801aa26ce084420953a56::floors::assert_heartbeat_age(0x2::clock::timestamp_ms(arg3) - arg0.last_heartbeat_ms);
        };
        ...
        0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::augment_receipt(&arg0.treasury_cap, arg1, v3, arg4);
    }

    public fun deposit_new<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::AqReceipt {
        if (arg0.current_strategy != 0 && arg0.last_heartbeat_ms > 0) {
            0xc3fae86b2591255013fae250ea4d72c0036109c181a801aa26ce084420953a56::floors::assert_heartbeat_age(0x2::clock::timestamp_ms(arg2) - arg0.last_heartbeat_ms);
        };
        ...
        0x2::event::emit<DepositEvent>(v4);
        0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::mint_receipt(&arg0.treasury_cap, v3, arg3)
    }
    ...
    public fun is_heartbeat_stale<T0>(arg0: &Vault<T0>, arg1: &0x2::clock::Clock) : bool {
        ...
        0x2::clock::timestamp_ms(arg1) - arg0.last_heartbeat_ms > 0xc3fae86b2591255013fae250ea4d72c0036109c181a801aa26ce084420953a56::floors::max_heartbeat_age_ms()
    }
    ...
    public fun update_heartbeat_tvl<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock, arg2: &ProtocolAccessCap) {
        ...
        if (v1 > 0) {
            ...
            0xc3fae86b2591255013fae250ea4d72c0036109c181a801aa26ce084420953a56::floors::assert_tvl_delta((((v2 as u128) * 10000 / (v1 as u128)) as u64));
        };
    ...
    public fun update_performance_fee<T0>(arg0: &mut Vault<T0>, arg1: &ProtocolAccessCap, arg2: u64) {
        0xc3fae86b2591255013fae250ea4d72c0036109c181a801aa26ce084420953a56::floors::assert_rewards_fee(arg2);
    ...
    public fun withdraw<T0>(arg0: &mut Vault<T0>, arg1: 0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::AqReceipt, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::tx_context::epoch(arg4) > 0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::deposit_epoch(&arg1), 17);
        assert!(0x2::tx_context::epoch(arg4) > 0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::locked_until_epoch(&arg1), 214);
        let v0 = 0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::receipt_amount(&arg1);
        assert!(v0 > 0, 200);
        let v1 = 1000000;
        ...
        assert!(v2 > 0, 200);
        assert!(v2 >= arg2, 203);
        0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::deplete_receipt(&arg0.treasury_cap, &mut arg1, v0);
        0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt::destroy_empty_receipt(arg1);
