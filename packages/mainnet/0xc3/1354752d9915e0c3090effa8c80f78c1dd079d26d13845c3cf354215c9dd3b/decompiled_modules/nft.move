module 0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::nft {
    ...
    public fun mint(arg0: address, arg1: &0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::articles::Article, arg2: &MintConfig, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) : ArticleAccessNft {
        assert!(0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::articles::is_gated_content(arg1), 0);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) >= arg2.base_price, 1);
        let v0 = 0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::articles::get_article_address(arg1);
        let (v1, _, _, v4, _, _, _) = 0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::articles::get_article_info(arg1);
        ...
        0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::inkray_events::emit_article_nft_minted(v0, 0x2::object::uid_to_address(&v8), arg0, v10);
        v9
    }
