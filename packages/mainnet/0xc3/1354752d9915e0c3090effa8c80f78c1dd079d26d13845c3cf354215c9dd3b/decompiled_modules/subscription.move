module 0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::subscription {
    ...
    public fun extend(arg0: &mut Subscription, arg1: &PlatformService, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::inkray_events::emit_subscription_extended(arg0.holder, 0x2::object::uid_to_address(&arg0.id), arg0.expires_ms, arg0.expires_ms);
    }
    ...
    public fun mint_platform(arg0: &PlatformService, arg1: u8, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Subscription {
        ...
        0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::inkray_events::emit_subscription_minted(v0, 0x2::object::uid_to_address(&v2), arg1, v1);
        v3
    }
