module 0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::publication {
    ...
    public fun add_contributor(arg0: &PublicationOwnerCap, arg1: &mut Publication, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::inkray_events::emit_contributor_added(0x2::object::uid_to_address(&arg1.id), arg2, 0x2::tx_context::sender(arg3));
    }
    ...
    public fun create(arg0: 0x1::string::String, arg1: &mut 0x2::tx_context::TxContext) : (PublicationOwnerCap, address) {
        ...
        let v3 = 0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::vault::create_and_share_vault(v2, arg1);
        let v4 = Publication{
            id           : v1,
            name         : arg0,
            owner        : v0,
        ...
        0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::inkray_events::emit_publication_created(v2, v0, arg0, v3);
        (v5, v2)
    }
    ...
    public fun remove_asset_from_vault(arg0: &Publication, arg1: &mut 0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::vault::PublicationVault, arg2: u256, arg3: &0x2::tx_context::TxContext) : 0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::vault::StoredAsset {
        0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::vault::remove_asset_authorized(arg1, arg2, get_publication_address(arg0), arg0.owner, &arg0.contributors, 0x2::tx_context::sender(arg3))
    }
    ...
    public fun remove_contributor(arg0: &PublicationOwnerCap, arg1: &mut Publication, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::inkray_events::emit_contributor_removed(0x2::object::uid_to_address(&arg1.id), arg2, 0x2::tx_context::sender(arg3));
    }
    ...
    public fun store_asset_in_vault(arg0: &Publication, arg1: &mut 0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::vault::PublicationVault, arg2: u256, arg3: 0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::vault::StoredAsset, arg4: &0x2::tx_context::TxContext) {
        0xc31354752d9915e0c3090effa8c80f78c1dd079d26d13845c3cf354215c9dd3b::vault::store_asset_authorized(arg1, arg2, arg3, get_publication_address(arg0), arg0.owner, &arg0.contributors, 0x2::tx_context::sender(arg4));
    }
