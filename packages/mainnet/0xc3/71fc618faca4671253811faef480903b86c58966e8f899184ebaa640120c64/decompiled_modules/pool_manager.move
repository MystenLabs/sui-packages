module 0xa49c5d1c8f0a9eaa4e1c0c461c2b5dfb6e88213876739e56db1afb3649a8af26::pool_manager {
    ...
    public(friend) fun prepare_before_withdraw<T0>(arg0: &mut SuiPoolManager, arg1: u64, arg2: u64, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        0xa49c5d1c8f0a9eaa4e1c0c461c2b5dfb6e88213876739e56db1afb3649a8af26::event::emit_fund_updated(arg0.original_sui_amount, arg2, 0x2::balance::value<0xbd61f559b21c69672d8af517e412b8154826d8de4568c82a4529dab8a0d9fd81::cert::CERT>(&arg0.vsui_balance), arg0.target_sui_amount, 0x2::object::uid_to_address(&arg0.id));
    ...
    public(friend) fun refresh_stake(arg0: &mut SuiPoolManager, arg1: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xa49c5d1c8f0a9eaa4e1c0c461c2b5dfb6e88213876739e56db1afb3649a8af26::event::emit_fund_updated(arg0.original_sui_amount, 0x2::balance::value<0x2::sui::SUI>(arg1), 0x2::balance::value<0xbd61f559b21c69672d8af517e412b8154826d8de4568c82a4529dab8a0d9fd81::cert::CERT>(v1), arg0.target_sui_amount, 0x2::object::uid_to_address(&arg0.id));
    }
    ...
    public(friend) fun take_vsui_from_treasury(arg0: &mut SuiPoolManager, arg1: u64, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0xbd61f559b21c69672d8af517e412b8154826d8de4568c82a4529dab8a0d9fd81::cert::CERT> {
        ...
        let v1 = 0xbd61f559b21c69672d8af517e412b8154826d8de4568c82a4529dab8a0d9fd81::stake_pool::sui_amount_to_lst_amount(&arg0.vsui_stake_pool, &arg0.vsui_metadata, v0);
        let v2 = v1;
        if (v1 > 0x2::balance::value<0xbd61f559b21c69672d8af517e412b8154826d8de4568c82a4529dab8a0d9fd81::cert::CERT>(&arg0.vsui_balance)) {
            v2 = 0x2::balance::value<0xbd61f559b21c69672d8af517e412b8154826d8de4568c82a4529dab8a0d9fd81::cert::CERT>(&arg0.vsui_balance);
        };
        let v3 = 0x2::balance::split<0xbd61f559b21c69672d8af517e412b8154826d8de4568c82a4529dab8a0d9fd81::cert::CERT>(&mut arg0.vsui_balance, v2);
        ...
        0xa49c5d1c8f0a9eaa4e1c0c461c2b5dfb6e88213876739e56db1afb3649a8af26::event::emit_staking_treasury_withdrawn(0x2::balance::value<0xbd61f559b21c69672d8af517e412b8154826d8de4568c82a4529dab8a0d9fd81::cert::CERT>(&v3), v0, 0x2::object::uid_to_address(&arg0.id));
        v3
    }
