module 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::project {
    ...
    public fun admin_close<T0>(arg0: &0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::PlatformAdminCap, arg1: &mut Project<T0>, arg2: &0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::Platform, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        let v0 = Closed{
            ...
            fee_bps_snapshot : 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::fee_bps_internal(arg2),
            timestamp_ms     : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<Closed>(v0);
    }

    public fun admin_compromise<T0>(arg0: &0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::PlatformAdminCap, arg1: &mut Project<T0>, arg2: &mut 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::Platform, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == 0 || arg1.status == 1, 203);
        let v0 = 0x2::balance::value<0x2::sui::SUI>(&arg1.sui_balance);
        let v1 = 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::math::calc_fee(v0, 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::fee_bps_internal(arg2));
        let v2 = v0 - v1;
        let v3 = 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::treasury_address_internal(arg2);
        ...
        arg1.status = 2;
        if (v1 > 0) {
            0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::deposit_fee(arg2, 0x2::balance::split<0x2::sui::SUI>(&mut arg1.sui_balance, v1));
        };
        if (v2 > 0) {
    ...
    public fun admin_unverify_project<T0>(arg0: &0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::PlatformAdminCap, arg1: &mut Project<T0>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        arg1.verified = false;
    ...
    public fun admin_verify_project<T0>(arg0: &0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::PlatformAdminCap, arg1: &mut Project<T0>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        arg1.verified = true;
    ...
    public fun claim<T0>(arg0: &mut Project<T0>, arg1: 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::receipt::ContributionReceipt<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg0.status == 1 || arg0.status == 2, 202);
        let (v0, v1, v2, v3) = 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::receipt::destroy<T0>(arg1);
    ...
    public fun claim_multiple<T0>(arg0: &mut Project<T0>, arg1: vector<0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::receipt::ContributionReceipt<T0>>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg0.status == 1 || arg0.status == 2, 202);
        assert!(!0x1::vector::is_empty<0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::receipt::ContributionReceipt<T0>>(&arg1), 401);
        let v0 = 0x2::object::id<Project<T0>>(arg0);
        let v1 = 0;
        while (!0x1::vector::is_empty<0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::receipt::ContributionReceipt<T0>>(&arg1)) {
            let (v2, v3, v4, v5) = 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::receipt::destroy<T0>(0x1::vector::pop_back<0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::receipt::ContributionReceipt<T0>>(&mut arg1));
            assert!(v3 == v0, 400);
            v1 = v1 + v5;
            let v6 = Claimed{
                project_id   : v0,
        ...
        0x1::vector::destroy_empty<0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::receipt::ContributionReceipt<T0>>(arg1);
    ...
    public fun contribute<T0>(arg0: &mut Project<T0>, arg1: &0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::Platform, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::receipt::ContributionReceipt<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::assert_not_paused(arg1);
        ...
        let v4 = 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::math::calc_sui_for_tokens_fixed(v3, arg0.base_rate);
        let (v5, v6, v7) = if (v0 >= v4) {
            (v3, v4, v0 - v4)
        } else {
            (0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::math::calc_tokens_fixed(v0, arg0.base_rate), v0, 0)
        };
        let v8 = if (v7 > 0) {
        ...
        if (arg0.sold == arg0.funding_allocation) {
            ...
            let v10 = Closed{
                ...
                fee_bps_snapshot : 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::fee_bps_internal(arg1),
                timestamp_ms     : v1,
            };
            0x2::event::emit<Closed>(v10);
        };
        let v11 = 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::receipt::new<T0>(v9, v6, v5, v1, arg4);
        let v12 = Contributed{
            project_id      : v9,
            contributor     : 0x2::tx_context::sender(arg4),
            receipt_id      : 0x2::object::id<0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::receipt::ContributionReceipt<T0>>(&v11),
            sui_amount      : v6,
            refunded_amount : v7,
            token_share     : v5,
            sold_before     : v2,
    ...
    public fun create_project<T0>(arg0: &mut 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::Platform, arg1: 0x2::coin::TreasuryCap<T0>, arg2: 0x2::coin::CoinMetadata<T0>, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: u64, arg7: u64, arg8: 0x1::option::Option<u64>, arg9: u8, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : ProjectAdminCap<T0> {
        0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::assert_not_paused(arg0);
        assert!(arg6 > 0, 101);
        assert!(arg7 > 0 && arg7 <= 10000000000000000000, 103);
        assert!(0x2::coin::total_supply<T0>(&arg1) == 0, 104);
        assert!(arg9 == 0 || arg9 == 1, 105);
        let v0 = 0x2::clock::timestamp_ms(arg10);
        if (0x1::option::is_some<u64>(&arg8)) {
            assert!(*0x1::option::borrow<u64>(&arg8) > v0, 108);
        };
        ...
        let v5 = ProjectCreated{
            project_id          : v3,
            project_number      : 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::bump_project_counter(arg0),
            creator             : v1,
            name                : v2.name,
    ...
    public fun permissionless_finalize<T0>(arg0: &mut Project<T0>, arg1: &0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::Platform, arg2: &0x2::clock::Clock) {
        assert!(arg0.status == 0, 200);
    ...
    public fun try_finalize<T0>(arg0: &mut Project<T0>, arg1: &0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::Platform, arg2: &0x2::clock::Clock) {
        if (arg0.status != 0) {
            return
        };
        let v0 = 0x2::clock::timestamp_ms(arg2);
    ...
    public fun update_metadata<T0>(arg0: &ProjectAdminCap<T0>, arg1: &mut Project<T0>, arg2: 0x1::option::Option<0x1::string::String>, arg3: 0x1::option::Option<0x1::string::String>, arg4: 0x1::option::Option<0x1::string::String>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        assert!(arg0.project_id == 0x2::object::id<Project<T0>>(arg1), 500);
    ...
    public fun withdraw_sui<T0>(arg0: &ProjectAdminCap<T0>, arg1: &mut Project<T0>, arg2: &mut 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::Platform, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        assert!(arg0.project_id == 0x2::object::id<Project<T0>>(arg1), 500);
        assert!(arg1.status == 1, 201);
        assert!(arg3 > 0, 602);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg1.sui_balance) >= arg3, 600);
        let v0 = 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::math::calc_fee(arg3, 0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::fee_bps_internal(arg2));
        let v1 = arg3 - v0;
        if (v0 > 0) {
            0xc3c44efaaac1dcb88e6da74cf7cae92e161c79e2a66eaa44c37fd0e5beea1687::platform::deposit_fee(arg2, 0x2::balance::split<0x2::sui::SUI>(&mut arg1.sui_balance, v0));
        };
