module 0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::testcoin {
    ...
    entry fun claim(arg0: &mut Vault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v5 > 0) {
            ...
            let v7 = 0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::treasury::current_epoch<TESTCOIN>(v6);
            let v8 = vesting_ledger(arg0);
            let (v9, v10) = 0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::vesting_ledger::claim<TESTCOIN>(v8, v1, v5, v7, arg2);
            0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::pool_dispatcher::transfer<TESTCOIN>(pool_dispatcher(arg0), 0x1::string::utf8(b"lockup"), v10);
    ...
    fun init(arg0: TESTCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::object_bag::add<0x1::string::String, 0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::vesting_ledger::VestingLedger<TESTCOIN>>(&mut v2.registry, 0x1::string::utf8(b"vesting_ledger"), 0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::vesting_ledger::create<TESTCOIN>(45, 6000000000, arg1));
        let v3 = &mut v2;
        premint(v3, arg1);
    ...
    public fun lock_batch(arg0: &mut Vault, arg1: vector<0x2::coin::Coin<TESTCOIN>>, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (!0x1::vector::is_empty<address>(&arg2)) {
            0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::vesting_ledger::lock<TESTCOIN>(vesting_ledger(arg0), 0x1::vector::pop_back<address>(&mut arg2), 0x2::coin::split<TESTCOIN>(&mut v1, 0x1::vector::pop_back<u64>(&mut arg3), arg4), 0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::treasury::current_epoch<TESTCOIN>(v0), arg4);
        };
        0x1::vector::destroy_empty<address>(arg2);
    ...
    entry fun migrate(arg0: &ScheduleAdminCap, arg1: &mut Vault, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1.version == 1) {
            0x2::object_bag::add<0x1::string::String, 0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::vesting_ledger::VestingLedger<TESTCOIN>>(&mut arg1.registry, 0x1::string::utf8(b"vesting_ledger"), 0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::vesting_ledger::create<TESTCOIN>(45, 6000000000, arg2));
            let v0 = pool_dispatcher(arg1);
            0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::pool_dispatcher::add_address_pool(v0, 0x1::string::utf8(b"lookup"), @0xefaaecff5491118ffca9090afa473c53b937a5d2beb5b566c347bd386e5a656f);
    ...
    public fun set_vesting_penalty(arg0: &VestingAdminCap, arg1: &mut Vault, arg2: u64) {
        ...
        assert!(arg1.version == 2, 2);
        0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::vesting_ledger::set_initial_penalty<TESTCOIN>(vesting_ledger(arg1), arg2);
    }

    public fun set_vesting_period(arg0: &VestingAdminCap, arg1: &mut Vault, arg2: u64) {
        assert!(arg2 <= 1800, 4);
        assert!(arg1.version == 2, 2);
        0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::vesting_ledger::set_vesting_period<TESTCOIN>(vesting_ledger(arg1), arg2);
    }
    ...
    fun vesting_ledger(arg0: &mut Vault) : &mut 0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::vesting_ledger::VestingLedger<TESTCOIN> {
        0x2::object_bag::borrow_mut<0x1::string::String, 0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::vesting_ledger::VestingLedger<TESTCOIN>>(&mut arg0.registry, 0x1::string::utf8(b"vesting_ledger"))
    }
