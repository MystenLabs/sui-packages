module 0xfee75b760674b76a3a1e5e097149ab259844a61cb1ee81d3a3dbd03b98cf5dac::treasury {
    ...
    public(friend) fun current_epoch<T0>(arg0: &Treasury<T0>) : u64 {
        let v0 = 0;
        let v1 = 0;
        while (v1 <= arg0.current_entry) {
            v0 = v0 + 0x1::vector::borrow<ScheduleEntry<T0>>(&arg0.schedule, v1).current_epoch;
            v1 = v1 + 1;
        };
        v0
    }
