module 0xc334707e31d8a1d06291a86f3204aba9bbb061756c9103955c4312dd7fd2f106::beelife {
    struct BEELIFE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BEELIFE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BEELIFE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Beelife"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is the collection of beelife NFTs, where tokenize non fungible tokens can be minted, starting with the pass NFT."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreianuyp5x3a6kmbuixootuudhzyopnak32xvrmrtof6d435sm55yha"));
