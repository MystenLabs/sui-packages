module 0xc3c61315f92fc4c0a4084a8bf12a61fdbce3577e42496f571a4cf69de2e65e7e::cnsnft3827 {
    struct CNSNFT3827 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3827, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3827>(arg0, arg1);
