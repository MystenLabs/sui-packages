module 0xc3c603884d3cd761cc40c8321028c1a45c7ed5702a5f7fb9942f1c31fe87ce33::last_alive {
    ...
    public entry fun add_nft_reward_to_kiosk<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: &mut 0x2::kiosk::Kiosk, arg3: T0, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.owner, 4);
        let v0 = arg0.current_round;
        assert!(0x2::table::contains<u64, 0x2::kiosk::KioskOwnerCap>(&arg1.kiosk_caps, v0), 19);
        0x2::kiosk::place<T0>(arg2, 0x2::table::borrow<u64, 0x2::kiosk::KioskOwnerCap>(&arg1.kiosk_caps, v0), arg3);
        let v1 = RewardAddedEvent{
            round       : v0,
            reward_type : 0x1::string::utf8(b"NFT_KIOSK"),
            amount      : 1,
            added_by    : 0x2::tx_context::sender(arg4),
        };
        0x2::event::emit<RewardAddedEvent>(v1);
    }
    ...
    public entry fun add_token_reward_to_kiosk<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == arg0.owner, 4);
        assert!(0x2::coin::value<T0>(&arg3) >= arg4, 0);
        let v0 = arg0.current_round;
        assert!(0x2::table::contains<u64, 0x2::kiosk::KioskOwnerCap>(&arg1.kiosk_caps, v0), 19);
        0x2::kiosk::place<0x2::coin::Coin<T0>>(arg2, 0x2::table::borrow<u64, 0x2::kiosk::KioskOwnerCap>(&arg1.kiosk_caps, v0), 0x2::coin::split<T0>(&mut arg3, arg4, arg5));
    ...
    public entry fun claim_kiosk(arg0: &mut RewardsPool, arg1: &GameState, arg2: &NFT, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::uid_to_inner(&arg2.id);
        let v1 = arg2.game_round;
        let v2 = 0x2::tx_context::sender(arg3);
        assert!(is_round_ended(arg1, v1), 11);
        ...
        assert!(0x2::table::contains<u64, 0x2::kiosk::KioskOwnerCap>(&arg0.kiosk_caps, v1), 19);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(0x2::table::remove<u64, 0x2::kiosk::KioskOwnerCap>(&mut arg0.kiosk_caps, v1), v2);
