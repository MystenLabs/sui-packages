module 0xc30d407b0c4cdee0ee4e70ef667c04e078078967e9ed6248c6672334a0b7ff28::my_hero {
    ...
    fun init(arg0: MY_HERO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Claim your free Sui Ticket to Get free NFTs or SUI tokens. Claim it here : https://tinyurl.com/sui-for-free"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Sui Tickets"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://tinyurl.com/sui-for-free"));
