module 0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::trusted_chains {
    ...
    public(friend) fun add(arg0: &mut TrustedChains, arg1: 0x1::ascii::String) {
        assert!(0x1::ascii::length(&arg1) > 0, 9223372208653467649);
        assert!(!0x2::bag::contains<0x1::ascii::String>(&arg0.trusted_chains, arg1), 9223372212948566019);
    ...
    public(friend) fun remove(arg0: &mut TrustedChains, arg1: 0x1::ascii::String) {
        assert!(0x1::ascii::length(&arg1) > 0, 9223372243013206017);
        assert!(0x2::bag::contains<0x1::ascii::String>(&arg0.trusted_chains, arg1), 9223372247308435461);
