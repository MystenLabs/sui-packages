module 0xc3145fd777ae87ce467ac84fde2e6906b80c1357347f724d8bf809f1bb285225::spepe {
    ...
    fun init(arg0: SPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/FXcMY8Hos1b8bR7WwzRCMifKGLP8LpkekDYYmQu7Rqn1.png?size=lg&key=e3b2dc                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<SPEPE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"SPEPE   ")))), trim_right(b"Spider Pepe                     "), trim_right(b"Fighting scams, promoting decentralization, and spreading meme power.                                                                                                                                                                                                                                                           "), v2, arg1);
        let v5 = v3;
