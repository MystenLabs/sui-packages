module 0xc347c56c34b9509aee317a5e7b6cee5d1d9659bf38dfe2f1347f103c1889f537::reward1279 {
    struct REWARD1279 has drop {
        dummy_field: bool,
    }

    struct TICKET_1279 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1279(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_1279>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1279, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1279>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1279>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1279>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1279>>(v5, 0x2::tx_context::sender(arg1));
    }
