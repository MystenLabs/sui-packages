module 0xc36ed6ff3b94364c02eee12649921eb35e0e5a687bfdf457d49db24f1b04bcba::floki {
    ...
    fun init(arg0: FLOKI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FLOKI>(arg0, 4, b"FLOKI", b"Floki Inu", b"", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = 0x2::coin::treasury_into_supply<FLOKI>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<FLOKI>>(0x2::coin::from_balance<FLOKI>(0x2::balance::increase_supply<FLOKI>(&mut v2, 1000000000000000), arg1), 0x2::tx_context::sender(arg1));
