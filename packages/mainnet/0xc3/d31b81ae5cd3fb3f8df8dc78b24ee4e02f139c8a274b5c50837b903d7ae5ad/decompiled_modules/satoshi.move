module 0xc3d31b81ae5cd3fb3f8df8dc78b24ee4e02f139c8a274b5c50837b903d7ae5ad::satoshi {
    ...
    fun init(arg0: SATOSHI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<SATOSHI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Satoshi     ")))), trim_right(b"Father of Crypto                "), trim_right(b"father of crypto                                                                                                                                                                                                                                                                                                                "), v2, arg1);
