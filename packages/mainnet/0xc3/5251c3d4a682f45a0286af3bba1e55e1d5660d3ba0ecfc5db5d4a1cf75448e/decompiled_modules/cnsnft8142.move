module 0xc35251c3d4a682f45a0286af3bba1e55e1d5660d3ba0ecfc5db5d4a1cf75448e::cnsnft8142 {
    struct CNSNFT8142 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8142, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8142>(arg0, arg1);
