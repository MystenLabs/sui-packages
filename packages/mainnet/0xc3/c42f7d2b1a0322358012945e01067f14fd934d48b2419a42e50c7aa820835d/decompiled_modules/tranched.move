module 0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::tranched {
    ...
    struct TranchedStream<phantom T0> has store, key {
        ...
        released: u64,
        tranches: vector<0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::types::Tranche>,
        cancelable: bool,
        is_canceled: bool,
    }
    ...
    public fun claim<T0>(arg0: &mut TranchedStream<T0>, arg1: &0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::global_config::GlobalConfig, arg2: &0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::version::VersionRegistry, arg3: &0x2::clock::Clock, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::events::emit_fee_collected(v0, v1, 0x1::option::some<0x2::object::ID>(0x2::object::id<TranchedStream<T0>>(arg0)));
        ...
        0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::events::emit_tokens_claimed(0x2::object::id<TranchedStream<T0>>(arg0), v5, arg0.recipient, arg0.released);
        ...
        if (arg0.released >= arg0.total_deposit) {
            0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::events::emit_stream_completed(0x2::object::id<TranchedStream<T0>>(arg0), arg0.released, v2);
        };
    }

    public fun cancel<T0>(arg0: &mut TranchedStream<T0>, arg1: 0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::cancel_cap::CancelCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::cancel_cap::get_stream_id(&arg1) == 0x2::object::id<TranchedStream<T0>>(arg0), 0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::error::einvalid_cancel_cap());
        ...
        0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::events::emit_stream_canceled(0x2::object::id<TranchedStream<T0>>(arg0), v1, arg0.recipient, v5, v6, v0);
    }
    ...
    public fun get_vested_amount<T0>(arg0: &TranchedStream<T0>, arg1: u64) : u64 {
        let v0 = 0;
        let v1 = 0;
        while (v1 < 0x1::vector::length<0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::types::Tranche>(&arg0.tranches)) {
            let v2 = 0x1::vector::borrow<0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::types::Tranche>(&arg0.tranches, v1);
            if (arg1 >= 0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::types::tranche_timestamp(v2)) {
                v0 = v0 + 0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::types::tranche_amount(v2);
                v1 = v1 + 1;
            } else {
                break
            };
    ...
    public(friend) fun new_stream<T0>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: vector<0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::types::Tranche>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : TranchedStream<T0> {
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 > 0, 0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::error::einvalid_amount());
        assert!(!0x1::vector::is_empty<0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::types::Tranche>(&arg2), 0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::error::eempty_tranches());
        let v1 = 0;
        let v2 = 0;
        while (v1 < 0x1::vector::length<0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::types::Tranche>(&arg2)) {
            let v3 = 0x1::vector::borrow<0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::types::Tranche>(&arg2, v1);
            assert!(0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::types::tranche_timestamp(v3) >= 0, 0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::error::etimestamps_not_sorted());
            v2 = v2 + (0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::types::tranche_amount(v3) as u128);
            v1 = v1 + 1;
        };
        assert!(v2 > 0, 0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::error::einvalid_amount());
        let v4 = (v2 as u64);
        assert!(v4 <= v0, 0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::error::etotal_amount_mismatch());
        let v5 = v0 - v4;
        if (v5 > 0) {
    ...
    public fun tranches<T0>(arg0: &TranchedStream<T0>) : &vector<0xc3c42f7d2b1a0322358012945e01067f14fd934d48b2419a42e50c7aa820835d::types::Tranche> {
        &arg0.tranches
    }
