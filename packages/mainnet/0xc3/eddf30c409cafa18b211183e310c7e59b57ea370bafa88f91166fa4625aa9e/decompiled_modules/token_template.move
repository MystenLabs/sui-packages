module 0xc3eddf30c409cafa18b211183e310c7e59b57ea370bafa88f91166fa4625aa9e::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"CT1763467", b"ConcurrentToken1 763467", b"First concurrent deployment", 0x1::option::none<0x2::url::Url>(), arg1);
