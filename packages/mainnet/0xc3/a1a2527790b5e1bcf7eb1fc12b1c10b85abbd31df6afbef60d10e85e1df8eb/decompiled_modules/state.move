module 0xc3a1a2527790b5e1bcf7eb1fc12b1c10b85abbd31df6afbef60d10e85e1df8eb::state {
    ...
    public(friend) fun add_refunded_order(arg0: &mut State, arg1: address) {
        ...
        if (0x2::table::contains<address, bool>(&arg0.refunded_orders, arg1)) {
            return
        };
    ...
    public(friend) fun new_state(arg0: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::emitter::EmitterCap, arg1: &mut 0x2::tx_context::TxContext) : State {
        let v0 = State{
