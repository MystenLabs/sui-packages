module 0xc34a89eaaf7c6381ff433a3011d569ed2d60184ba72a50a56bbbac07c07d6305::distributor {
    ...
    public(friend) fun new<T0>(arg0: vector<u64>, arg1: vector<u64>, arg2: vector<u64>, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : VestingSchedule {
        ...
        0x2::dynamic_field::add<0xc34a89eaaf7c6381ff433a3011d569ed2d60184ba72a50a56bbbac07c07d6305::utils::Marker<T0>, 0x2::balance::Balance<T0>>(&mut v0.id, 0xc34a89eaaf7c6381ff433a3011d569ed2d60184ba72a50a56bbbac07c07d6305::utils::marker<T0>(), 0x2::coin::into_balance<T0>(arg3));
        let v1 = 0;
        ...
        while (v1 < 0x1::vector::length<u64>(&arg0)) {
            ...
            assert!(v3 > 0, 1);
            assert!(v2 > v2 && v4 > 0, 2);
            v0.total_alloc_point = v0.total_alloc_point + v3;
            let v5 = Schedule{
                alloc_point : v3,
                clift       : v2,
                duration    : v4,
    ...
    public(friend) fun deposit<T0>(arg0: &mut VestingSchedule, arg1: 0x2::coin::Coin<T0>) {
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0xc34a89eaaf7c6381ff433a3011d569ed2d60184ba72a50a56bbbac07c07d6305::utils::Marker<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, 0xc34a89eaaf7c6381ff433a3011d569ed2d60184ba72a50a56bbbac07c07d6305::utils::marker<T0>()), 0x2::coin::into_balance<T0>(arg1));
    }

    public(friend) fun distribute(arg0: &mut VestingSchedule, arg1: address, arg2: u64) {
        assert!(!0x2::table::contains<address, u64>(&arg0.amounts, arg1), 3);
    ...
    public(friend) fun release<T0>(arg0: &mut VestingSchedule, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        released(arg0, v0, v1);
        0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0xc34a89eaaf7c6381ff433a3011d569ed2d60184ba72a50a56bbbac07c07d6305::utils::Marker<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, 0xc34a89eaaf7c6381ff433a3011d569ed2d60184ba72a50a56bbbac07c07d6305::utils::marker<T0>()), v1)
    }
    ...
    fun unsafe_vested_amount_at(arg0: &VestingSchedule, arg1: u64, arg2: address, arg3: &0x2::clock::Clock) : u64 {
        ...
        if (v1 < v0.clift) {
            ...
            0xc34a89eaaf7c6381ff433a3011d569ed2d60184ba72a50a56bbbac07c07d6305::math::mul_div(*0x2::table::borrow<address, u64>(&arg0.amounts, arg2), v0.alloc_point, arg0.total_alloc_point)
        } else {
            (((0xc34a89eaaf7c6381ff433a3011d569ed2d60184ba72a50a56bbbac07c07d6305::math::mul_div(*0x2::table::borrow<address, u64>(&arg0.amounts, arg2), v0.alloc_point, arg0.total_alloc_point) as u256) * ((v1 - v0.clift) as u256) / (v0.duration as u256)) as u64)
        }
    }
