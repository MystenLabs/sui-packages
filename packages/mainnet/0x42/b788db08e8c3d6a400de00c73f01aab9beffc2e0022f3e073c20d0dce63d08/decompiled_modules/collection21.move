module 0x42b788db08e8c3d6a400de00c73f01aab9beffc2e0022f3e073c20d0dce63d08::collection21 {
    struct COLLECTION21 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0xb936ae8317c279f0ca442ee89a9036ca90a6d45833dfe134210ab3bc1c09e613::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<Nft>(arg0), 2);
        0xb936ae8317c279f0ca442ee89a9036ca90a6d45833dfe134210ab3bc1c09e613::tradeport_launchpad::add_nft_metadata(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12);
        let v0 = AddNftMetadataEvent{
            group_id      : arg2,
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"461d6f09-8509-43c1-a1b7-b15548fdf2a0"),
        };
        0x2::event::emit<AddNftMetadataEvent>(v0);
    }

    fun init(arg0: COLLECTION21, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<COLLECTION21>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"collection21"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"http://localhost:3000"));
    ...
    public entry fun mint_nft(arg0: &0x2::clock::Clock, arg1: &mut Manager, arg2: &mut 0xb936ae8317c279f0ca442ee89a9036ca90a6d45833dfe134210ab3bc1c09e613::tradeport_launchpad::Store, arg3: 0x1::string::String, arg4: u64, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: u64, arg9: u64, arg10: u64, arg11: vector<u8>, arg12: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg13: &mut 0x2::kiosk::Kiosk, arg14: &0x2::kiosk::KioskOwnerCap, arg15: &0x2::transfer_policy::TransferPolicy<Nft>, arg16: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0xb936ae8317c279f0ca442ee89a9036ca90a6d45833dfe134210ab3bc1c09e613::tradeport_launchpad::get_nft_metadata(arg0, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg16);
        let v2 = v1;
    ...
    public entry fun update_nft(arg0: &0xb936ae8317c279f0ca442ee89a9036ca90a6d45833dfe134210ab3bc1c09e613::tradeport_launchpad::Store, arg1: vector<u8>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: vector<u8>, arg7: &mut 0x2::kiosk::Kiosk, arg8: &0x2::kiosk::KioskOwnerCap, arg9: &mut 0x2::tx_context::TxContext) {
        0xb936ae8317c279f0ca442ee89a9036ca90a6d45833dfe134210ab3bc1c09e613::tradeport_launchpad::verify_update_nft_request(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg9);
        let v0 = 0x2::kiosk::borrow_mut<Nft>(arg7, arg8, 0x2::object::id_from_bytes(arg1));
        v0.description = arg2;
        v0.media_url = arg3;
        v0.attributes = 0xb936ae8317c279f0ca442ee89a9036ca90a6d45833dfe134210ab3bc1c09e613::tradeport_launchpad::format_attributes(arg4, arg5);
