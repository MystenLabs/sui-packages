module 0x5bf5c98e636791c53d8f149de4c026467b3667de14b0e92b7362e3dbf3726be5::incentive {
    ...
    public fun get_incentive_apy_one(arg0: &0x2::clock::Clock, arg1: &Incentive, arg2: &mut 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::Storage, arg3: &0x859de5e155d57462d3fe0aeb980b9a3f9cdccf76522d9499f372789183440aca::oracle::PriceOracle, arg4: address) : IncentiveAPYInfo {
        ...
        let (v1, v2) = 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::get_total_supply(arg2, v0.asset_id);
        let v3 = v1;
        if (v0.option == 3) {
            v3 = v2;
        };
        IncentiveAPYInfo{
            ...
            apy        : 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::calculator::calculate_value(arg0, arg3, (v0.total_supply as u256), 0x2::table::borrow<address, IncentiveFundsPoolInfo>(&arg1.funds, v0.funds).oracle_id) / ((v0.end_at - v0.start_at) as u256) * (31536000000 as u256) / 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::calculator::calculate_value(arg0, arg3, v3, 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::get_oracle_id(arg2, v0.asset_id)),
