module 0x42b62e2295a53f74b8e7a9972bdd9b8048aee174bef54a21dab880b8b1350360::V31 {
    ...
    public fun withdraw_all<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        assert_wl(arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.coin_reserve, 0x2::balance::value<T0>(&mut arg0.coin_reserve)), arg1), 0x2::tx_context::sender(arg1));
    }
