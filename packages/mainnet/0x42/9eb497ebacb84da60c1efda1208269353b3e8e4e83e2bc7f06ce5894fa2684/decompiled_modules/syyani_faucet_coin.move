module 0x429eb497ebacb84da60c1efda1208269353b3e8e4e83e2bc7f06ce5894fa2684::syyani_faucet_coin {
    ...
    fun init(arg0: SYYANI_FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SYYANI_FAUCET_COIN>(arg0, 9, b"SYYANI_FAUCET", b"SYYANI_FAUCET", b"SYYANI faucet coin, everyone can access and mutate.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/100562605")), arg1);
