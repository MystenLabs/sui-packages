module 0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::sui_passport {
    ...
    public fun drop_passport(arg0: &mut SuiPassportRecord, arg1: SuiPassport, arg2: &0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::version::check_version(arg2);
    ...
    public fun edit_passport(arg0: &mut SuiPassport, arg1: 0x1::option::Option<0x1::string::String>, arg2: 0x1::option::Option<0x1::string::String>, arg3: 0x1::option::Option<0x1::string::String>, arg4: 0x1::option::Option<0x1::string::String>, arg5: 0x1::option::Option<0x1::string::String>, arg6: 0x1::option::Option<0x1::string::String>, arg7: &0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::version::Version, arg8: &0x2::clock::Clock, arg9: &0x2::tx_context::TxContext) {
        0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::version::check_version(arg7);
        ...
        arg0.last_time = 0x2::clock::timestamp_ms(arg8);
    ...
    public fun hide_stamp(arg0: &mut SuiPassport, arg1: &0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::stamp::Stamp, arg2: &0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::version::Version, arg3: &0x2::clock::Clock) {
        let v0 = 0x2::object::id<0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::stamp::Stamp>(arg1);
        0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::version::check_version(arg2);
        if (0x2::table::contains<0x2::object::ID, bool>(&arg0.collections, v0)) {
            *0x2::table::borrow_mut<0x2::object::ID, bool>(&mut arg0.collections, v0) = false;
            ...
            arg0.points = arg0.points + 0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::stamp::points(arg1);
            0x2::table::add<0x2::object::ID, bool>(&mut arg0.collections, v0, false);
        };
        arg0.last_time = 0x2::clock::timestamp_ms(arg3);
    }
    ...
    public fun mint_passport(arg0: &mut SuiPassportRecord, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: &0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::version::Version, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = SuiPassport{
            ...
            collections  : 0x2::table::new<0x2::object::ID, bool>(arg9),
            points       : 0,
            x            : arg4,
            github       : arg5,
            email        : arg6,
            last_time    : 0x2::clock::timestamp_ms(arg8),
        };
    ...
    public fun set_exhibit(arg0: &mut SuiPassport, arg1: vector<0x2::object::ID>, arg2: &0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::version::Version, arg3: &0x2::clock::Clock) {
        let v0 = 0;
    ...
    public fun show_stamp(arg0: &mut SuiPassport, arg1: &0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::stamp::Stamp, arg2: &0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::version::Version, arg3: &0x2::clock::Clock) {
        let v0 = 0x2::object::id<0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::stamp::Stamp>(arg1);
        0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::version::check_version(arg2);
        if (0x2::table::contains<0x2::object::ID, bool>(&arg0.collections, v0)) {
    ...
    public fun update_points(arg0: &mut SuiPassportRecord, arg1: &SuiPassport, arg2: &0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::version::Version, arg3: &0x2::tx_context::TxContext) {
        0x352919f09a96e8bca46cd2a9015c5651aed4aa3ca270f8c09c96ef670c8ede59::version::check_version(arg2);
        *0x2::table::borrow_mut<address, u64>(&mut arg0.record, 0x2::tx_context::sender(arg3)) = points(arg1);
    }
