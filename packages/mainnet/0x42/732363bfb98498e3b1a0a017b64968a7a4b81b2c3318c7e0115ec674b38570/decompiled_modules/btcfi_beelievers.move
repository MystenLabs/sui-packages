module 0x42732363bfb98498e3b1a0a017b64968a7a4b81b2c3318c7e0115ec674b38570::btcfi_beelievers {
    ...
    fun init(arg0: BTCFI_BEELIEVERS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"BTCFi Beelievers is a free NFT collection designed to activate and unify the BTCFi community. Each NFT represents a believer in the Bitcoin DeFi revolution, powered by Native."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreid6y3ydthusegvaulgvzbtcvxuwigqp5z5ojcpr3udl6b7emyseny"));
