module 0x422779299d2694180f6f1465a5a247f88b93ee48cd994d00df1b5998a5ac67ee::cnsnft3861 {
    struct CNSNFT3861 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3861, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3861>(arg0, arg1);
