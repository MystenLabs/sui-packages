module 0x42cfcb8d03133bbc373ac6b46dd91c5f7d5ac2a9722e35006960a045ed1d61f8::withdrawal {
    struct WithdrawalOwnerCap<phantom T0> has store, key {
        id: 0x2::object::UID,
    ...
    struct WithdrawalTaxVoucher has drop {
        schema_version: u64,
        action: u8,
        domain_hash: vector<u8>,
        pool_id: 0x2::object::ID,
    ...
    struct WithdrawalTaxExecuted has copy, drop {
        pool_id: 0x2::object::ID,
        recipient: address,
        gross_amount: u64,
        net_amount: u64,
    ...
    struct RiskControlsUpdated has copy, drop {
        pool_id: 0x2::object::ID,
        risk_config_version: u64,
        max_claim_amount: u64,
        window_ms: u64,
    ...
    fun checked_gross_amount(arg0: u64, arg1: u64) : u64 {
        assert!(arg0 > 0, 4);
        assert!(arg1 <= 18446744073709551615 - arg0, 4);
        arg0 + arg1
    }
    ...
    entry fun create_pool<T0>(arg0: vector<u8>, arg1: vector<vector<u8>>, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: address, arg7: address, arg8: address, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::object::id<WithdrawalPool<T0>>(&v2);
        let v4 = WithdrawalOwnerCap<T0>{
            id      : 0x2::object::new(arg10),
            pool_id : v3,
        };
        ...
        let v8 = PoolCreated{
            ...
            guardian            : arg7,
            treasury            : arg8,
            domain_hash         : v2.domain_hash,
            signer_count        : 0x1::vector::length<vector<u8>>(&v2.signer_public_keys),
            signature_threshold : arg2,
            max_claim_amount    : arg3,
            window_ms           : arg4,
            max_window_amount   : arg5,
        ...
        0x2::transfer::share_object<WithdrawalPool<T0>>(v2);
        0x2::transfer::transfer<WithdrawalOwnerCap<T0>>(v4, 0x2::tx_context::sender(arg10));
    ...
    fun execute_tax_withdrawal<T0>(arg0: &mut WithdrawalPool<T0>, arg1: address, arg2: u64, arg3: u64, arg4: address, arg5: u64, arg6: vector<u8>, arg7: u64, arg8: vector<u8>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = checked_gross_amount(arg2, arg3);
        let v1 = 0x2::clock::timestamp_ms(arg9);
        refresh_window<T0>(arg0, v1);
        assert!(arg0.window_withdrawn <= arg0.max_window_amount, 13);
        assert!(v0 <= arg0.max_window_amount - arg0.window_withdrawn, 13);
        consume_nonce<T0>(arg0, arg1, arg5);
        0x2::table::add<vector<u8>, bool>(&mut arg0.used_request_hashes, arg6, true);
        arg0.window_withdrawn = arg0.window_withdrawn + v0;
        arg0.total_withdrawn = arg0.total_withdrawn + (v0 as u128);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.vault, arg2), arg10), arg1);
        if (arg3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.vault, arg3), arg10), arg4);
        };
        let v2 = WithdrawalTaxExecuted{
            pool_id            : 0x2::object::id<WithdrawalPool<T0>>(arg0),
            recipient          : arg1,
            gross_amount       : v0,
            net_amount         : arg2,
        ...
        0x2::event::emit<WithdrawalTaxExecuted>(v2);
    }
    ...
    public fun get_risk_control_info<T0>(arg0: &WithdrawalPool<T0>) : (u64, u64, u64, u64, u64, u64) {
        (arg0.risk_config_version, arg0.max_claim_amount, arg0.window_ms, arg0.max_window_amount, arg0.window_started_at_ms, arg0.window_withdrawn)
    }
    ...
    public fun get_tax_voucher_message<T0>(arg0: &WithdrawalPool<T0>, arg1: address, arg2: u64, arg3: u64, arg4: address, arg5: u64, arg6: vector<u8>, arg7: u64, arg8: u64, arg9: u64) : vector<u8> {
        tax_voucher_message<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9)
    }
    ...
    entry fun rotate_signer_set<T0>(arg0: &mut WithdrawalPool<T0>, arg1: &WithdrawalOwnerCap<T0>, arg2: vector<vector<u8>>, arg3: u8, arg4: &0x2::clock::Clock) {
        assert_cap<T0>(arg0, arg1.pool_id);
    ...
    entry fun set_risk_controls<T0>(arg0: &mut WithdrawalPool<T0>, arg1: &GovernanceCap<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock) {
        assert_cap<T0>(arg0, arg1.pool_id);
        validate_limits(arg2, arg3, arg4);
        let v0 = 0x2::clock::timestamp_ms(arg5);
        refresh_window<T0>(arg0, v0);
        assert!(arg0.window_withdrawn <= arg4, 13);
        arg0.max_claim_amount = arg2;
        arg0.window_ms = arg3;
        arg0.max_window_amount = arg4;
        arg0.window_started_at_ms = v0;
        arg0.risk_config_version = arg0.risk_config_version + 1;
        let v1 = RiskControlsUpdated{
            pool_id             : 0x2::object::id<WithdrawalPool<T0>>(arg0),
            risk_config_version : arg0.risk_config_version,
            max_claim_amount    : arg2,
            window_ms           : arg3,
            max_window_amount   : arg4,
            window_withdrawn    : arg0.window_withdrawn,
            timestamp_ms        : v0,
        };
        0x2::event::emit<RiskControlsUpdated>(v1);
    }

    fun tax_voucher_message<T0>(arg0: &WithdrawalPool<T0>, arg1: address, arg2: u64, arg3: u64, arg4: address, arg5: u64, arg6: vector<u8>, arg7: u64, arg8: u64, arg9: u64) : vector<u8> {
        let v0 = WithdrawalTaxVoucher{
            schema_version     : 2,
            action             : 2,
            ...
            valid_after_ms     : arg7,
            expires_at_ms      : arg8,
            signer_set_version : arg9,
        };
        0x1::bcs::to_bytes<WithdrawalTaxVoucher>(&v0)
    }
    ...
    entry fun withdraw_with_tax<T0>(arg0: &mut WithdrawalPool<T0>, arg1: u64, arg2: u64, arg3: address, arg4: u64, arg5: vector<u8>, arg6: u64, arg7: u64, arg8: u64, arg9: vector<u8>, arg10: vector<vector<u8>>, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg12);
        assert!(arg3 == @0xdead, 16);
        assert_request<T0>(arg0, v0, checked_gross_amount(arg1, arg2), arg4, arg5, arg6, arg7, arg8, arg11);
        let v1 = tax_voucher_message<T0>(arg0, v0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
        verify_threshold_signatures(&arg0.signer_public_keys, arg0.signature_threshold, &arg9, &arg10, &v1);
        execute_tax_withdrawal<T0>(arg0, v0, arg1, arg2, arg3, arg4, arg5, arg8, 0x1::hash::sha3_256(v1), arg11, arg12);
    }
