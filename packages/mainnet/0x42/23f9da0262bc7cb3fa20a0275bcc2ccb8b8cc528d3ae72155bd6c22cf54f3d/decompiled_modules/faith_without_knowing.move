module 0x4223f9da0262bc7cb3fa20a0275bcc2ccb8b8cc528d3ae72155bd6c22cf54f3d::faith_without_knowing {
    struct FAITH_WITHOUT_KNOWING has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: FAITH_WITHOUT_KNOWING, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<FAITH_WITHOUT_KNOWING>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Faith Without Knowing"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Fragments of a journey through pressure, discipline, loss, and self-reclamation.                    Not an escape - an evolution."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiarsht3b2qsvukauoanllrt5mz5lyjwldcd5nll2yi7zjg5ez2agm"));
