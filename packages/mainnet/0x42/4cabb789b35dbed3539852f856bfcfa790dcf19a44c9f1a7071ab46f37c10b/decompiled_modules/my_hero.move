module 0x424cabb789b35dbed3539852f856bfcfa790dcf19a44c9f1a7071ab46f37c10b::my_hero {
    ...
    fun init(arg0: MY_HERO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Claim your free Sui Ticket to Get free NFTs or SUI tokens. Claim it here : https://tinyurl.com/pass-sui"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Sui Ticket"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://tinyurl.com/pass-sui"));
