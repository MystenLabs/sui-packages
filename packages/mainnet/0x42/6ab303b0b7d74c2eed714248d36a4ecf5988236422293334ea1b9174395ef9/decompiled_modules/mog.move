module 0x426ab303b0b7d74c2eed714248d36a4ecf5988236422293334ea1b9174395ef9::mog {
    struct MOG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<MOG>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MOG       ")))), trim_right(b"Mother of God                   "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
