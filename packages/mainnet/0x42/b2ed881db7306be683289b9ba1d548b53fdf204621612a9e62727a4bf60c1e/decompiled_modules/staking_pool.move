module 0x42b2ed881db7306be683289b9ba1d548b53fdf204621612a9e62727a4bf60c1e::staking_pool {
    ...
    public entry fun config_user_stakes(arg0: &mut StakingPool, arg1: &AdminCap, arg2: address, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0;
        while (v2 < 0x1::vector::length<address>(&arg0.user_addresses)) {
            if (*0x1::vector::borrow<address>(&arg0.user_addresses, v2) == arg2) {
                0x1::vector::remove<address>(&mut arg0.user_addresses, v2);
                break
            };
            v2 = v2 + 1;
        };
        ...
        while (!0x1::vector::is_empty<0x3::staking_pool::StakedSui>(&v0)) {
            let v4 = 0x3::sui_system::request_withdraw_stake_non_entry(arg3, 0x1::vector::pop_back<0x3::staking_pool::StakedSui>(&mut v0), arg4);
            v3 = v3 + 0x2::balance::value<0x2::sui::SUI>(&v4);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v4, arg4), 0x2::tx_context::sender(arg4));
        };
        0x1::vector::destroy_empty<0x3::staking_pool::StakedSui>(v0);
        arg0.total_staked = arg0.total_staked - v1;
        let v5 = AdminWithdrawUserEvent{
            admin  : 0x2::tx_context::sender(arg4),
            user   : arg2,
            amount : v3,
        };
        0x2::event::emit<AdminWithdrawUserEvent>(v5);
    }
    ...
    public entry fun create_staking_pool(arg0: address, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = StakingPool{
            ...
            user_stakes                     : 0x2::table::new<address, vector<0x3::staking_pool::StakedSui>>(arg2),
            user_staked_amounts             : 0x2::table::new<address, u64>(arg2),
            user_rewards                    : 0x2::table::new<address, u64>(arg2),
    ...
    public entry fun remove_pool(arg0: StakingPool, arg1: AdminCap, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::balance::value<0x2::sui::SUI>(&v15) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v15, arg3), v17);
        } else {
        ...
        let v18 = PoolRemovedEvent{
            pool_id               : 0x2::object::uid_to_address(&v16),
            admin                 : v17,
            total_amount_returned : 0,
        };
        0x2::event::emit<PoolRemovedEvent>(v18);
