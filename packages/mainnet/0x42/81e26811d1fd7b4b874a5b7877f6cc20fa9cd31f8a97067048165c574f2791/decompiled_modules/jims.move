module 0x4281e26811d1fd7b4b874a5b7877f6cc20fa9cd31f8a97067048165c574f2791::jims {
    struct JIMS has drop {
        dummy_field: bool,
    }

    fun init(arg0: JIMS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<JIMS>(arg0, 6, b"JIMS", b"Jims The Plankton", b"JIMS is the forgotten King of the plankton nation, for years enjoying life as an ordinary plankton, now a box is opened to the fact that he is the real king, let's help JIMS fulfill his destiny, and Atlantis is a gift for us", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/MOJO_AI_a_cartoon_pickle_with_a_blue_hat_and_a_shocked_loo_751f1431a8.png")), arg1);
