module 0x421cf256e70e9968c1a23072440160076bd9e6d822ff3b81e43afb237a9cace6::evolved_sudoz {
    ...
    public fun delist_from_kiosk(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::kiosk::delist<EvolvedSudoz>(arg0, arg1, arg2);
    }
    ...
    fun init(arg0: EVOLVED_SUDOZ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = EvolvedAdminCap{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<EvolvedAdminCap>(v5, @0x21221a34eb06d78b16ef4553572e228970f2972385b1d3feab68cfc80090f430);
        ...
        let v8 = EvolvedStats{
            ...
            evolved_minted         : 0,
            available_metadata_ids : v6,
            royalty_fees           : 0x2::balance::zero<0x2::sui::SUI>(),
            evolved_artifacts      : 0x2::table::new<u64, bool>(arg1),
        };
        0x2::transfer::share_object<EvolvedStats>(v8);
        let v9 = EvolutionAuth{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<EvolutionAuth>(v9, 0x2::tx_context::sender(arg1));
    }
    ...
    public entry fun mint_and_lock_to_kiosk(arg0: &EvolvedAdminCap, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<EvolvedSudoz>, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: &mut EvolvedStats, arg13: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg13);
        assert!(v0 == @0x21221a34eb06d78b16ef4553572e228970f2972385b1d3feab68cfc80090f430 || v0 == @0x9a5b0ad3a18964ab7c0dbf9ab4cdecfd6b3899423b47313ae6e78f4b801022a3, 1);
        assert!(arg12.evolved_minted < 5555, 0);
        assert!(arg4 >= 1 && arg4 <= 5555, 2);
        let v1 = &mut arg12.available_metadata_ids;
        assert!(remove_specific_metadata_id(v1, arg4), 3);
        let v2 = arg12.evolved_minted + 1;
        let v3 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Background"), arg5);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Skin"), arg6);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Clothes"), arg7);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Hats"), arg8);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Eyewear"), arg9);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Mouth"), arg10);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Earrings"), arg11);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Metadata ID"), u64_to_string(arg4));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Number"), u64_to_string(v2));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Developer Reserve - Locked"));
        let v4 = EvolvedSudoz{
        ...
        arg12.evolved_minted = arg12.evolved_minted + 1;
        0x2::kiosk::lock<EvolvedSudoz>(arg1, arg2, arg3, v4);
    ...
    public entry fun mint_developer_reserve_batch_to_kiosk(arg0: &EvolvedAdminCap, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<EvolvedSudoz>, arg4: u64, arg5: &mut EvolvedStats, arg6: &0x2::random::Random, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(v0 == @0x21221a34eb06d78b16ef4553572e228970f2972385b1d3feab68cfc80090f430 || v0 == @0x9a5b0ad3a18964ab7c0dbf9ab4cdecfd6b3899423b47313ae6e78f4b801022a3, 1);
        assert!(arg4 > 0 && arg4 <= 50, 4);
        assert!(arg5.evolved_minted + arg4 <= 5555, 0);
        assert!(0x1::vector::length<u64>(&arg5.available_metadata_ids) >= arg4, 0);
        ...
        while (v2 < arg4) {
            ...
            0x2::kiosk::lock<EvolvedSudoz>(arg1, arg2, arg3, v13);
            let v14 = EvolvedMinted{
                evolved_id               : 0x2::object::id<EvolvedSudoz>(&v13),
            ...
            0x2::event::emit<EvolvedMinted>(v14);
            v2 = v2 + 1;
        };
    }

    public entry fun mint_developer_reserve_specific(arg0: &EvolvedAdminCap, arg1: address, arg2: u64, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: &mut EvolvedStats, arg11: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg11);
        assert!(v0 == @0x21221a34eb06d78b16ef4553572e228970f2972385b1d3feab68cfc80090f430 || v0 == @0x9a5b0ad3a18964ab7c0dbf9ab4cdecfd6b3899423b47313ae6e78f4b801022a3, 1);
        assert!(arg10.evolved_minted < 5555, 0);
        assert!(arg2 >= 1 && arg2 <= 5555, 2);
        let v1 = &mut arg10.available_metadata_ids;
        assert!(remove_specific_metadata_id(v1, arg2), 3);
        let v2 = arg10.evolved_minted + 1;
        let v3 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Background"), arg3);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Skin"), arg4);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Clothes"), arg5);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Hats"), arg6);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Eyewear"), arg7);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Mouth"), arg8);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Earrings"), arg9);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Metadata ID"), u64_to_string(arg2));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Number"), u64_to_string(v2));
        if (is_one_of_one(arg2)) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Developer Reserve - 1/1"));
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Developer Reserve"));
        };
        let v4 = EvolvedSudoz{
        ...
        arg10.evolved_minted = arg10.evolved_minted + 1;
        let v5 = EvolvedMinted{
            evolved_id               : 0x2::object::id<EvolvedSudoz>(&v4),
            recipient                : arg1,
            number                   : v2,
        ...
        0x2::event::emit<EvolvedMinted>(v5);
        0x2::transfer::public_transfer<EvolvedSudoz>(v4, arg1);
    }

    public entry fun mint_developer_reserve_to_kiosk(arg0: &EvolvedAdminCap, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: u64, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: &mut EvolvedStats, arg12: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg12);
        assert!(v0 == @0x21221a34eb06d78b16ef4553572e228970f2972385b1d3feab68cfc80090f430 || v0 == @0x9a5b0ad3a18964ab7c0dbf9ab4cdecfd6b3899423b47313ae6e78f4b801022a3, 1);
        assert!(arg11.evolved_minted < 5555, 0);
        assert!(arg3 >= 1 && arg3 <= 5555, 2);
        let v1 = &mut arg11.available_metadata_ids;
        assert!(remove_specific_metadata_id(v1, arg3), 3);
        let v2 = arg11.evolved_minted + 1;
        let v3 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Background"), arg4);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Skin"), arg5);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Clothes"), arg6);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Hats"), arg7);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Eyewear"), arg8);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Mouth"), arg9);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Earrings"), arg10);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Metadata ID"), u64_to_string(arg3));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Number"), u64_to_string(v2));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Developer Reserve"));
        let v4 = EvolvedSudoz{
        ...
        arg11.evolved_minted = arg11.evolved_minted + 1;
        0x2::kiosk::place<EvolvedSudoz>(arg1, arg2, v4);
        let v5 = EvolvedMinted{
            evolved_id               : 0x2::object::id<EvolvedSudoz>(&v4),
    ...
    public fun mint_evolved(arg0: &EvolvedAdminCap, arg1: address, arg2: u64, arg3: u8, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: &mut EvolvedStats, arg13: &mut 0x2::tx_context::TxContext) : EvolvedSudoz {
        assert!(arg12.evolved_minted < 5555, 0);
        assert!(arg4 >= 1 && arg4 <= 5555, 2);
        let v0 = &mut arg12.available_metadata_ids;
        assert!(remove_specific_metadata_id(v0, arg4), 3);
        let v1 = arg12.evolved_minted + 1;
        let v2 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"Background"), arg5);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"Skin"), arg6);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"Clothes"), arg7);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"Hats"), arg8);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"Eyewear"), arg9);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"Mouth"), arg10);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"Earrings"), arg11);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"Metadata ID"), u64_to_string(arg4));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"Number"), u64_to_string(v1));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"Original Artifact"), u64_to_string(arg2));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, 0x1::string::utf8(b"Original Path"), get_path_name(arg3));
        let v3 = EvolvedSudoz{
            id                       : 0x2::object::new(arg13),
            name                     : build_evolved_name(arg4),
            description              : 0x1::string::utf8(b"An evolved form of the SUDOZ artifact with unique traits"),
    ...
    public entry fun mint_evolved_and_lock(arg0: &EvolvedAdminCap, arg1: address, arg2: u64, arg3: u8, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: &mut EvolvedStats, arg13: &0x2::transfer_policy::TransferPolicy<EvolvedSudoz>, arg14: &mut 0x2::tx_context::TxContext) {
        let v0 = mint_evolved(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg14);
        let (v1, v2) = 0x2::kiosk::new(arg14);
        let v3 = v2;
        let v4 = v1;
        0x2::kiosk::lock<EvolvedSudoz>(&mut v4, &v3, arg13, v0);
    ...
    public entry fun mint_one_of_ones_to_kiosk(arg0: &EvolvedAdminCap, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<EvolvedSudoz>, arg4: &mut EvolvedStats, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(v0 == @0x21221a34eb06d78b16ef4553572e228970f2972385b1d3feab68cfc80090f430 || v0 == @0x9a5b0ad3a18964ab7c0dbf9ab4cdecfd6b3899423b47313ae6e78f4b801022a3, 1);
        let v1 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v1, 504);
        0x1::vector::push_back<u64>(&mut v1, 998);
        0x1::vector::push_back<u64>(&mut v1, 1529);
        0x1::vector::push_back<u64>(&mut v1, 2016);
        0x1::vector::push_back<u64>(&mut v1, 2530);
        0x1::vector::push_back<u64>(&mut v1, 3022);
        0x1::vector::push_back<u64>(&mut v1, 3533);
        0x1::vector::push_back<u64>(&mut v1, 4059);
        0x1::vector::push_back<u64>(&mut v1, 4555);
        0x1::vector::push_back<u64>(&mut v1, 5190);
        let v2 = 0;
        while (v2 < 0x1::vector::length<u64>(&v1)) {
            ...
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v13, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Founder Reserve - 1/1"));
            ...
            0x2::kiosk::lock<EvolvedSudoz>(arg1, arg2, arg3, v14);
            let v15 = EvolvedMinted{
                evolved_id               : 0x2::object::id<EvolvedSudoz>(&v14),
    ...
    public fun take_from_kiosk(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : EvolvedSudoz {
        0x2::kiosk::take<EvolvedSudoz>(arg0, arg1, arg2)
    }
