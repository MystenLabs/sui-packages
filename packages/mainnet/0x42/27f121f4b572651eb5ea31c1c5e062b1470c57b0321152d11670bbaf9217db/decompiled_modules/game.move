module 0x4227f121f4b572651eb5ea31c1c5e062b1470c57b0321152d11670bbaf9217db::game {
    ...
    public entry fun start_upgrade<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &mut Camp, arg2: u8, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = get_build_time(v1);
        *0x1::vector::borrow_mut<u64>(&mut arg1.build_timers, (arg2 as u64)) = v6 + v7;
        let v8 = BuildStarted{
            owner        : arg1.owner,
            building_id  : arg2,
            target_level : v1,
        ...
        0x2::event::emit<BuildStarted>(v8);
    }
