module 0x42bd83c0fa7dd3fbbbc0abdc333a39a31f361e0a00ea6475387b6c2c6f497aa3::sage {
    ...
    fun init(arg0: SAGE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<SAGE>(arg0, 9, 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"SAGE    ")))), trim_right(b"TokenSage Coin                  "), trim_right(b"TokenSage Coin powers the AI ecosystem rewarding users for engagement providing exclusive insights and enabling governance features within the community of the AI agent                                                                                                                                                        "), v1, arg1);
        let v4 = v2;
