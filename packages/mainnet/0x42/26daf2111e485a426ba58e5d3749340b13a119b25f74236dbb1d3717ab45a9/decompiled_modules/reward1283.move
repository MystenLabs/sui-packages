module 0x4226daf2111e485a426ba58e5d3749340b13a119b25f74236dbb1d3717ab45a9::reward1283 {
    struct REWARD1283 has drop {
        dummy_field: bool,
    }

    struct TICKET_1283 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1283(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1283>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1283>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1283, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1283>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1283>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1283>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1283>>(v5, 0x2::tx_context::sender(arg1));
    }
