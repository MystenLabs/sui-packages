module 0x4269b420d062fad0a78fe4537c54e3da52dd8b30d353c5353625c3bb379b8ffa::mycoin {
    struct MYCOIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: MYCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MYCOIN>(arg0, 6, b"TEST", b"", b"", 0x1::option::none<0x2::url::Url>(), arg1);
