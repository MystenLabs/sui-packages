module 0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::main {
    struct ProjectConfig has store, key {
        id: 0x2::object::UID,
        admin: 0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::admin::AdminConfig,
        collections: 0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::collections::WhitelistedCollections,
    ...
    public entry fun new<T0: store + key, T1>(arg0: T0, arg1: &mut ProjectConfig, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let (v0, v1) = deep_immutable(arg1);
        assert!(0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::collections::contains_item(v1, arg2, 0x2::object::id_address<T0>(&arg0)), 1);
        assert!(0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::collections::is_enabled(v1, arg2), 2);
        assert!(arg5 > 0x2::clock::timestamp_ms(arg7), 4);
        assert!(0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::collections::is_admin(v1, v0), 7);
        let v2 = Raffle<T0, T1>{
            ...
            tickets_sold  : 0,
            end_timestamp : arg5,
            round         : (arg5 - 0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::drand_lib::get_genesis()) / 30,
            fee_collector : 0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::admin::get_owner(v0),
            ticket_price  : arg6,
            prize         : 0x1::option::some<T0>(arg0),
            participants  : 0x2::table::new<address, 0x2::object::ID>(arg8),
            winner        : 0x1::option::none<u64>(),
            collection    : arg2,
            collections   : 0x2::object::id<0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::collections::WhitelistedCollections>(v1),
            proceeds      : 0x2::balance::zero<T1>(),
        };
        let v3 = 0x2::object::id<Raffle<T0, T1>>(&v2);
        0x2::transfer::public_share_object<Raffle<T0, T1>>(v2);
        0x1::vector::push_back<0x2::object::ID>(&mut arg1.raffles, v3);
        v3
    }
    ...
    public entry fun buy<T0: store + key, T1>(arg0: &mut Raffle<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &mut Participation, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.tickets_sold == arg0.tickets) {
            ...
            arg0.round = (arg0.end_timestamp - 0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::drand_lib::get_genesis() + 30) / 30;
        };
    }
    ...
    public fun deep(arg0: &mut ProjectConfig) : (&mut 0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::admin::AdminConfig, &mut 0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::collections::WhitelistedCollections) {
        (&mut arg0.admin, &mut arg0.collections)
    }

    public fun deep_immutable(arg0: &ProjectConfig) : (&0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::admin::AdminConfig, &0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::collections::WhitelistedCollections) {
    ...
    public entry fun draw<T0: store + key, T1>(arg0: &mut Raffle<T0, T1>, arg1: &0x2::clock::Clock, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::drand_lib::verify_drand_signature(arg2, arg3, arg0.round);
        let v0 = 0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::drand_lib::derive_randomness(arg2);
        arg0.winner = 0x1::option::some<u64>(0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::drand_lib::safe_selection(arg0.tickets_sold, &v0));
    ...
    public entry fun initialize(arg0: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::admin::init_(arg0);
        let v1 = ProjectConfig{
            id          : 0x2::object::new(arg0),
            admin       : v0,
            collections : 0x424dd6bd9f16e98682980e6039ac0eb214145b378df8c1f5efefc19eb3c99eec::collections::init_(&v0, arg0),
