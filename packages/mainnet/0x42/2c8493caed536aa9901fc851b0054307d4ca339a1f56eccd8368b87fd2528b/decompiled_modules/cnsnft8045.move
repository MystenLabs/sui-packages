module 0x422c8493caed536aa9901fc851b0054307d4ca339a1f56eccd8368b87fd2528b::cnsnft8045 {
    struct CNSNFT8045 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8045, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8045>(arg0, arg1);
