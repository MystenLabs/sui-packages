module 0x42462c86d3ba08fa704c5a2efa08782ac24b06520cdfa400ef8093a7d41ad49f::authentication {
    ...
    public fun new<T0>(arg0: &mut Registry, arg1: address, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &T0, arg5: &mut 0x2::tx_context::TxContext) : Protocol<T0> {
        0x2::dynamic_field::add<0x1::string::String, bool>(&mut arg0.id, 0x42462c86d3ba08fa704c5a2efa08782ac24b06520cdfa400ef8093a7d41ad49f::utils::type_to_string<T0>(), true);
    ...
    public fun signin<T0: store + key, T1>(arg0: &Protocol<T1>, arg1: &mut HolderCap<T0>, arg2: vector<u8>, arg3: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>, arg4: &mut 0x2::tx_context::TxContext) : Authentication<T0> {
        let (v0, v1) = 0x42462c86d3ba08fa704c5a2efa08782ac24b06520cdfa400ef8093a7d41ad49f::utils::extract_signature_and_pubilc_key(arg2);
        let v2 = v1;
        let v3 = v0;
        assert!(arg0.config.address == 0x42462c86d3ba08fa704c5a2efa08782ac24b06520cdfa400ef8093a7d41ad49f::utils::derive_address_from_ed25519(v2), 103);
        ...
        while (v7 < 0x1::vector::length<0x1::string::String>(&v6)) {
            ...
            if (v9 == 0x1::string::utf8(b"sender")) {
                ...
                0x1::string::append(&mut v8, 0x42462c86d3ba08fa704c5a2efa08782ac24b06520cdfa400ef8093a7d41ad49f::utils::type_to_string<T0>());
            } else {
        ...
        let v10 = 0x42462c86d3ba08fa704c5a2efa08782ac24b06520cdfa400ef8093a7d41ad49f::utils::hash_message(0x1::string::into_bytes(v5));
