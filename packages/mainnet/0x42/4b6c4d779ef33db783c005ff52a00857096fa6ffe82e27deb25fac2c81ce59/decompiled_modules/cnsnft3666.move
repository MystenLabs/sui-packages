module 0x424b6c4d779ef33db783c005ff52a00857096fa6ffe82e27deb25fac2c81ce59::cnsnft3666 {
    struct CNSNFT3666 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3666, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5470"));
        let v4 = 0x2::package::claim<CNSNFT3666>(arg0, arg1);
