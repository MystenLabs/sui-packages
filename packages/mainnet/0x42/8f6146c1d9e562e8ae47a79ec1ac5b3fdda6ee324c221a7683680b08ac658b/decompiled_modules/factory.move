module 0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::factory {
    ...
    struct MintFactory has store {
        nfts: 0x2::table_vec::TableVec<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>,
    }
    ...
    struct UpgradeItem has drop, store {
        ...
        attributes: 0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::attributes::Attributes,
    }

    public fun upgrade<T0>(arg0: &mut Factory, arg1: &mut 0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::table::borrow_mut<u64, FactoryItem>(&mut arg0.upgrade_factory.nfts, 0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::name(arg1));
        let (v1, v2) = if (0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::level(arg1) == 0) {
        ...
        if (0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::level(arg1) == 0) {
            let v3 = 0x1::option::extract<UpgradeItem>(&mut v0.level1);
            0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::upgrade(arg1, v3.link, v3.attributes);
            ...
            0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::upgrade(arg1, v4.link, v4.attributes);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, @0xc333120e29ae0b59f924836c2eff13a06b9009324dee51fe8aa880107c7b08be);
        };
    }
    ...
    public fun batch_mint_wl(arg0: &mut Factory, arg1: &mut MintTicket, arg2: &0x2::clock::Clock, arg3: u64) : vector<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit> {
        assert!(arg0.config.mint_open, 1);
        assert!(0x2::table_vec::length<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>(&arg0.mint_factory.nfts) > 0, 2);
        assert_ticket_valid(arg1, arg2, arg0.config.normal_wl_date, arg0.config.premium_wl_date, arg3);
        let v0 = 0;
        let v1 = 0x1::vector::empty<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>();
        while (v0 < arg3) {
            arg1.how_many = arg1.how_many - 1;
            0x1::vector::push_back<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>(&mut v1, 0x2::table_vec::pop_back<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>(&mut arg0.mint_factory.nfts));
            v0 = v0 + 1;
        };
        v1
    }
    ...
    public fun create_nft(arg0: &FactoryAdmin, arg1: &mut Factory, arg2: u64, arg3: 0x1::string::String, arg4: &mut vector<0x1::string::String>, arg5: &mut vector<0x1::string::String>, arg6: &mut 0x2::tx_context::TxContext) {
        0x2::table_vec::push_back<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>(&mut arg1.mint_factory.nfts, 0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::new(arg2, arg3, 0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::attributes::from_vec(arg4, arg5), arg6));
        let v0 = FactoryItem{
    ...
    public fun how_many_nft_left(arg0: &Factory) : u64 {
        0x2::table_vec::length<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>(&arg0.mint_factory.nfts)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = MintFactory{nfts: 0x2::table_vec::empty<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>(arg0)};
    ...
    public fun is_nft_left(arg0: &Factory) : bool {
        0x2::table_vec::length<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>(&arg0.mint_factory.nfts) > 0
    }
    ...
    public fun mint(arg0: &mut Factory, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : 0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit {
        assert!(arg0.config.mint_open, 1);
        ...
        let v0 = 0x2::table_vec::pop_back<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>(&mut arg0.mint_factory.nfts);
        0x2::dynamic_field::add<address, 0x2::object::ID>(&mut arg0.id, 0x2::tx_context::sender(arg2), 0x2::object::id<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>(&v0));
        v0
    }

    public fun mint_wl(arg0: &mut Factory, arg1: &mut MintTicket, arg2: &0x2::clock::Clock) : 0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit {
        assert!(arg0.config.mint_open, 1);
        assert!(0x2::table_vec::length<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>(&arg0.mint_factory.nfts) > 0, 2);
        assert_ticket_valid(arg1, arg2, arg0.config.normal_wl_date, arg0.config.premium_wl_date, 1);
        arg1.how_many = arg1.how_many - 1;
        0x2::table_vec::pop_back<0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection::DegenRabbit>(&mut arg0.mint_factory.nfts)
    }
    ...
    public fun upgrade_nft(arg0: &FactoryAdmin, arg1: &mut Factory, arg2: u64, arg3: u8, arg4: 0x1::string::String, arg5: &mut vector<0x1::string::String>, arg6: &mut vector<0x1::string::String>) {
        ...
        if (arg3 == 1) {
            let v0 = UpgradeItem{
                link       : arg4,
                attributes : 0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::attributes::from_vec(arg5, arg6),
            };
