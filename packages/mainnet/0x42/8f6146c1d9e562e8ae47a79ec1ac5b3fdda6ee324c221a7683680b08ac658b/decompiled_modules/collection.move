module 0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::collection {
    ...
    public(friend) fun new(arg0: u64, arg1: 0x1::string::String, arg2: 0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::attributes::Attributes, arg3: &mut 0x2::tx_context::TxContext) : DegenRabbit {
        DegenRabbit{
    ...
    public fun add_kiosk_lock_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<DegenRabbit>, arg1: &CollectionInfo) {
        0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::kiosk_lock_rule::add<DegenRabbit>(arg0, &arg1.policy_cap);
    }

    public fun add_royalty_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<DegenRabbit>, arg1: &CollectionInfo) {
        0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::royalty_rule::add<DegenRabbit>(arg0, &arg1.policy_cap, 600, 0);
    }
    ...
    public fun remove_kiosk_lock_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<DegenRabbit>, arg1: &CollectionInfo) {
        0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::kiosk_lock_rule::remove<DegenRabbit>(arg0, &arg1.policy_cap);
    }

    public fun remove_royalty_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<DegenRabbit>, arg1: &CollectionInfo) {
        0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::royalty_rule::remove<DegenRabbit>(arg0, &arg1.policy_cap);
    }

    public(friend) fun upgrade(arg0: &mut DegenRabbit, arg1: 0x1::string::String, arg2: 0x428f6146c1d9e562e8ae47a79ec1ac5b3fdda6ee324c221a7683680b08ac658b::attributes::Attributes) {
