module 0x426e43dc9efb2fed23aed5cbcc8d88cb7d6923845934c5a5e0da203564a4ef44::router_script {
    ...
    public entry fun close(arg0: &mut Crypto, arg1: &mut 0x2::tx_context::TxContext) {
        arg0.is_close = true;
    }
    ...
    public entry fun open(arg0: &mut Crypto, arg1: &mut 0x2::tx_context::TxContext) {
        arg0.is_close = false;
    }
