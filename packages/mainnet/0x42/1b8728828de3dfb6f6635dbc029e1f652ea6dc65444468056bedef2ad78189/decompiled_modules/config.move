module 0x421b8728828de3dfb6f6635dbc029e1f652ea6dc65444468056bedef2ad78189::config {
    ...
    public(friend) fun assert_global_close_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_close_pause, 0x421b8728828de3dfb6f6635dbc029e1f652ea6dc65444468056bedef2ad78189::errors::err_global_close_paused());
    }

    public(friend) fun assert_global_open_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_open_pause, 0x421b8728828de3dfb6f6635dbc029e1f652ea6dc65444468056bedef2ad78189::errors::err_global_open_paused());
    }

    public(friend) fun assert_package_version(arg0: &GlobalConfig) {
        assert!(check_package_version(arg0), 0x421b8728828de3dfb6f6635dbc029e1f652ea6dc65444468056bedef2ad78189::errors::err_wrong_version());
    }
