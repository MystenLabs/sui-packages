module 0x42949e92019117178245d0514a9637ce3421bc57fee7f86248a659054f2da734::cnsnft5836 {
    struct CNSNFT5836 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5836, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5836>(arg0, arg1);
