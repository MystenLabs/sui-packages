module 0x420e3a9c426e231093189af149aefec300861aea03895acf648e8de4d9baeb88::axRouter {
    ...
    public fun register_transaction(arg0: &mut 0x2b839b25c7133e5e0f8f585cb2e89bf430a6585a88c4a0343ae3b246372d431c::discovery::RelayerDiscovery, arg1: &Singleton) {
        ...
        0x1::vector::push_back<vector<u8>>(v1, concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<Singleton>(arg1))));
