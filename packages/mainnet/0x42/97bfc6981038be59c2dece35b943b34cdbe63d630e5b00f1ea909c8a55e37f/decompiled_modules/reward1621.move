module 0x4297bfc6981038be59c2dece35b943b34cdbe63d630e5b00f1ea909c8a55e37f::reward1621 {
    struct REWARD1621 has drop {
        dummy_field: bool,
    }

    struct TICKET_1621 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1621(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1621>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1621>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1621, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1621>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1621>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1621>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1621>>(v5, 0x2::tx_context::sender(arg1));
    }
