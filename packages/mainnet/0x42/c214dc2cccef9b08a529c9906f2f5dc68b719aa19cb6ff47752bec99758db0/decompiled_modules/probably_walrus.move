module 0x42c214dc2cccef9b08a529c9906f2f5dc68b719aa19cb6ff47752bec99758db0::probably_walrus {
    ...
    fun init(arg0: PROBABLY_WALRUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Walrus"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibfjstzillglxd6f7fvx6plzaqo5wadljph3xvcaos3433a5z3f5m"));
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Nft>(&mut v5, &v4, 9900, 0);
