module 0x4216e4487728689be524aafc9467b4674f7e19f46074bb7ee33633c47ecf7417::vram_genesis_core_ {
    struct VRAM_GENESIS_CORE_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: VRAM_GENESIS_CORE_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<VRAM_GENESIS_CORE_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"VRAM Genesis Core "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"VRAM Genesis NFT - Evolving AI-powered collectible with on-chain permanence"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiem5nqu6agk2q455pzpwbyew5pt6bi37qpcul26xmcvltcla3k3lq"));
