module 0x4222d66b45bc62afbd8a2b11e7a024deaf2280b021e6405cd612b287baa56f7b::volo_mmt_airdrop {
    struct Volo_S1_Leaderboard has store, key {
        id: 0x2::object::UID,
    ...
    public fun transfer(arg0: Volo_S1_Leaderboard, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<Volo_S1_Leaderboard>(arg0, arg1);
    }
    ...
    public fun mint(arg0: &MinterCap, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<Volo_S1_Leaderboard>(v0, arg1);
    }
