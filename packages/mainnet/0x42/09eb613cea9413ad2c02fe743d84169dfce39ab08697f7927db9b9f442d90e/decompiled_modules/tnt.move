module 0x4209eb613cea9413ad2c02fe743d84169dfce39ab08697f7927db9b9f442d90e::tnt {
    struct TNT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TNT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TNT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"TNT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"TNT TEST (Don't Buy)"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreifl4ukpwvteclaog4els6jy3qmuqb26wbiovtuggxixpn2xthpinm"));
