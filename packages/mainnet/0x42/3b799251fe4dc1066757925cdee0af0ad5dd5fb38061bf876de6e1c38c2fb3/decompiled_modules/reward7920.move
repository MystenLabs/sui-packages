module 0x423b799251fe4dc1066757925cdee0af0ad5dd5fb38061bf876de6e1c38c2fb3::reward7920 {
    struct REWARD7920 has drop {
        dummy_field: bool,
    }

    struct TICKET_7920 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7920(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7920>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7920>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7920, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7920>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7920>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7920>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7920>>(v5, 0x2::tx_context::sender(arg1));
    }
