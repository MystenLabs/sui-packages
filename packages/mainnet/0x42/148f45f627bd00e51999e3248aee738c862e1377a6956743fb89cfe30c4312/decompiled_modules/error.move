module 0x42148f45f627bd00e51999e3248aee738c862e1377a6956743fb89cfe30c4312::error {
    ...
    public fun invalid_lp_tokens_to_mint() : u64 {
        33
    }
    ...
    public fun open_order_exists() : u64 {
        38
    }
    ...
    public fun too_less_deposit_to_seed() : u64 {
        34
    }
    ...
    public fun vault_already_seeded() : u64 {
        35
    }

    public fun vault_coin_supply_not_zero() : u64 {
        37
    }

    public fun vault_not_seeded() : u64 {
        36
    }
