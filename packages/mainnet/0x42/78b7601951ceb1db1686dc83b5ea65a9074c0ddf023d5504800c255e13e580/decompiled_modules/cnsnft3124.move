module 0x4278b7601951ceb1db1686dc83b5ea65a9074c0ddf023d5504800c255e13e580::cnsnft3124 {
    struct CNSNFT3124 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3124, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3124>(arg0, arg1);
