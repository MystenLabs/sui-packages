module 0x424d338b2f7a1a429a3a10dd9b5744c4cca0906d530867570869d02cd530ab86::spicy_early_ {
    struct SPICY_EARLY_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SPICY_EARLY_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SPICY_EARLY_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Spicy Early "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Early spicy Launching unique collection for early users."));
