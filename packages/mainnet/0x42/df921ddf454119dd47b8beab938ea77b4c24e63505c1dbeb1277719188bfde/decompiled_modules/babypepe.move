module 0x42df921ddf454119dd47b8beab938ea77b4c24e63505c1dbeb1277719188bfde::babypepe {
    ...
    fun init(arg0: BABYPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BABYPEPE>(arg0, 4, b"BABYPEPE", b"BabyPepe", b"Baby Pepe is the next PEPE on Sui Blockchain. Telegram : t.me/babypepesui , Twitter : https://twitter.com/babypepe_sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.pinata.cloud/ipfs/QmSeFcmoDTwbHngAYswejM46c6776qEXUNQSxHedPhM7u8?_gl=1*1ip82bf*rs_ga*ODJhNjIwYmEtMWRiOC00MTRlLWIwMDctOTI1NDY2ODFjZGQ2*rs_ga_5RMPXG14TE*MTY4MzQ0NTU0OC4xMC4xLjE2ODM0NDU1NTQuNTQuMC4w")), arg1);
        let v2 = 0x2::coin::treasury_into_supply<BABYPEPE>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<BABYPEPE>>(0x2::coin::from_balance<BABYPEPE>(0x2::balance::increase_supply<BABYPEPE>(&mut v2, 10000000000), arg1), 0x2::tx_context::sender(arg1));
