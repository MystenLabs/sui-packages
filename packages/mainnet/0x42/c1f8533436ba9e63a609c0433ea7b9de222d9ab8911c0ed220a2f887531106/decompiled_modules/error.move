module 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error {
    ...
    public(friend) fun lending_already_disabled() : u64 {
        abort 17
    }

    public(friend) fun lending_already_enabled() : u64 {
        abort 16
    }
    ...
    public(friend) fun token_not_available_for_lending() : u64 {
        abort 15
    }
    ...
    public(friend) fun unsupported_token_type_for_fountain() : u64 {
        abort 18
    }
