module 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::lp_pool {
    ...
    struct LiquidityPool has store, key {
        ...
        liquidated_unsettled_receipts: vector<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>,
    ...
    struct EnableLendingEvent has copy, drop {
        index: u64,
        liquidity_token_type: 0x1::type_name::TypeName,
        lending_protocol_index: u64,
        u64_padding: vector<u64>,
    }

    struct DisableLendingEvent has copy, drop {
        index: u64,
        liquidity_token_type: 0x1::type_name::TypeName,
        lending_protocol_index: u64,
        u64_padding: vector<u64>,
    ...
    public fun swap<T0, T1>(arg0: &mut 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: 0x2::coin::Coin<T0>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v0.pool_info.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::pool_inactive());
        ...
        let v11 = v10.config;
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3) == v9.oracle_id, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::oracle_mismatched());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg4) == v11.oracle_id, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::oracle_mismatched());
        let v12 = get_mut_token_pool(v0, &v6);
        let v13 = v12.state;
        let v14 = get_mut_token_pool(v0, &v7);
        let v15 = v14.state;
        assert!(v13.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::token_pool_inactive());
        assert!(v15.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::token_pool_inactive());
        let v16 = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::amount_to_usd(v5, v9.liquidity_token_decimal, v1, v2);
        let (v17, v18) = calculate_swap_fee(v0, v6, v5, v16, true);
        let (_, v20) = calculate_swap_fee(v0, v7, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::usd_to_amount(v16, v11.liquidity_token_decimal, v3, v4), v16, false);
        let (v21, v22) = if (v18 > v20) {
            (v17, v18)
        } else {
            (0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::usd_to_amount(v20, v9.liquidity_token_decimal, v1, v2), v20)
        };
        let v23 = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::usd_to_amount(v16 - v22, v11.liquidity_token_decimal, v3, v4);
        assert!(v23 >= arg6, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::reach_slippage_threshold());
        let v24 = get_mut_token_pool(v0, &v6);
        let v25 = 0x2::coin::into_balance<T0>(arg5);
        let v26 = 0x2::balance::value<T0>(&v25);
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::charge_fee<T0>(arg0, 0x2::balance::split<T0>(&mut v25, (((v21 as u128) * (v24.config.spot_config.swap_fee_protocol_share_bp as u128) / 10000) as u64)));
        ...
        assert!(v27.state.liquidity_amount + v26 <= v27.config.spot_config.max_capacity, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::reach_max_capacity());
        ...
        assert!(v29.state.liquidity_amount >= v29.state.reserved_amount, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::liquidity_not_enough());
    ...
    fun deposit_scallop_basic<T0>(arg0: &mut LiquidityPool, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg2: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg3: &0x2::clock::Clock, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::set_u64_vector_value(&mut v2.state.current_lending_amount, 0, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::get_u64_vector_value(&v2.state.current_lending_amount, 0) + 0x2::balance::value<T0>(&v1));
        let (v3, v4) = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::lending::deposit_scallop_basic<T0>(v1, arg1, arg2, arg3, arg5);
        let v5 = v4;
        ...
        let v9 = &mut v8;
        0x1::vector::push_back<u64>(v9, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::get_u64_vector_value(&v7.state.current_lending_amount, 0));
    ...
    fun withdraw_scallop_basic<T0>(arg0: &mut 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut LiquidityPool, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::charge_fee<T0>(arg0, 0x2::balance::split<T0>(&mut v4, v9));
        ...
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::set_u64_vector_value(&mut v12.state.current_lending_amount, 0, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::get_u64_vector_value(&v12.state.current_lending_amount, 0) - v7);
        v12.state.liquidity_amount = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::get_u64_vector_value(&v12.state.current_lending_amount, 0) + 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::get_u64_vector_value(&v12.state.current_lending_amount, 1) + v10;
        let v13 = 0x1::vector::empty<u64>();
        let v14 = &mut v13;
        0x1::vector::push_back<u64>(v14, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::get_u64_vector_value(&v12.state.current_lending_amount, 0));
    ...
    entry fun add_liquidity_token<T0>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: vector<u64>, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: &0x2::clock::Clock, arg24: &0x2::tx_context::TxContext) {
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::verify(arg0, arg24);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::pool_inactive());
        ...
        if (!0x1::vector::contains<0x1::type_name::TypeName>(&v0.liquidity_tokens, &v1)) {
            ...
            let v2 = SpotConfig{
                ...
                enable_lending             : arg14,
                lending_protocol_share_bp  : arg15,
                u64_padding                : 0x1::vector::empty<u64>(),
            };
            let v3 = MarginConfig{
                basic_borrow_rate_0        : arg16,
                basic_borrow_rate_1        : arg17,
                basic_borrow_rate_2        : arg18,
                utilization_threshold_bp_0 : arg19,
                utilization_threshold_bp_1 : arg20,
                borrow_interval_ts_ms      : arg21,
                max_order_reserve_ratio_bp : arg22,
                u64_padding                : 0x1::vector::empty<u64>(),
            };
            let v4 = Config{
            ...
            let v5 = 0x2::clock::timestamp_ms(arg23);
            let v6 = State{
                liquidity_amount                : 0,
                value_in_usd                    : 0,
                reserved_amount                 : 0,
            ...
            let v8 = AddLiquidityTokenEvent{
                sender      : 0x2::tx_context::sender(arg24),
                index       : arg2,
                token_type  : v1,
                config      : v4,
                state       : v6,
    ...
    public fun burn_lp<T0, T1>(arg0: &mut 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::treasury_caps::TreasuryCaps, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: 0x2::coin::Coin<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x1::type_name::get<T0>();
        ...
        assert!(0x1::type_name::get<T1>() == v5.lp_token_type, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::lp_token_type_mismatched());
        assert!(v5.pool_info.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::pool_inactive());
        assert!(check_tvl_updated(v5, arg6), 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::tvl_not_yet_updated());
        let v6 = get_token_pool(v5, &v0);
        assert!(v6.state.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::token_pool_inactive());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg4) == v6.config.oracle_id, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::oracle_mismatched());
        ...
        assert!(v12.state.liquidity_amount >= v12.state.reserved_amount, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::liquidity_not_enough());
        ...
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::token_interface::burn<T1>(0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::treasury_caps::get_mut_treasury_cap<T1>(arg3), 0x2::coin::from_balance<T1>(v3, arg7));
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::charge_fee<T0>(arg0, 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v13.id, v0), v10));
        let v14 = BurnLpEvent{
    ...
    public(friend) fun calculate_burn_lp(arg0: &Registry, arg1: u64, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: u64, arg5: u64) : (u64, u64, u64, u64) {
        ...
        assert!(v0.pool_info.total_share_supply > 0, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::zero_total_supply());
        let v2 = (((arg5 as u128) * (v0.pool_info.tvl_usd as u128) / (v0.pool_info.total_share_supply as u128)) as u64);
        let v3 = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::usd_to_amount(v2, v1.config.liquidity_token_decimal, arg3, arg4);
    ...
    public(friend) fun calculate_lp_fee(arg0: &LiquidityPool, arg1: 0x1::type_name::TypeName, arg2: u64, arg3: u64, arg4: bool) : (u64, u64) {
        ...
        let v5 = if (arg4) {
            ...
            assert!(v2 >= arg3, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::liquidity_not_enough());
            v2 - arg3
        };
        let v6 = if (v3 > v5) {
            v3 - v5
    ...
    public(friend) fun calculate_mint_lp(arg0: &Registry, arg1: u64, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: u64, arg5: u64) : (u64, u64, u64) {
        let v0 = get_liquidity_pool(arg0, arg1);
        let v1 = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::amount_to_usd(arg5, get_token_pool(v0, &arg2).config.liquidity_token_decimal, arg3, arg4);
        let (_, v3) = calculate_lp_fee(v0, arg2, arg5, v1, true);
        assert!(v1 >= v3, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::insufficient_amount_for_mint_fee());
    ...
    public(friend) fun check_remove_liquidity_token_process_status(arg0: &RemoveLiquidityTokenProcess, arg1: u64) {
        let v0 = if (arg0.status == 0) {
            0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::process_should_remove_position()
        } else if (arg0.status == 1) {
            0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::process_should_remove_order()
        } else if (arg0.status == 2) {
            0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::process_should_swap()
        } else {
            assert!(arg0.status == 3, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::unsupported_process_status_code());
            0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::process_should_repay_liquidity()
        };
    ...
    public(friend) fun check_token_pool_status<T0>(arg0: &Registry, arg1: u64, arg2: bool) {
        let v0 = 0x1::type_name::get<T0>();
        if (arg2) {
            assert!(get_token_pool(get_liquidity_pool(arg0, arg1), &v0).state.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::token_pool_inactive());
        } else {
            assert!(!get_token_pool(get_liquidity_pool(arg0, arg1), &v0).state.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::token_pool_already_active());
        };
    }
    ...
    public fun complete_remove_liquidity_token_process<T0>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: RemoveLiquidityTokenProcess, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(v0, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::friction_too_large());
    ...
    entry fun disable_lending<T0>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::verify(arg0, arg4);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        let v1 = 0x1::type_name::get<T0>();
        assert!(0x1::vector::contains<0x1::type_name::TypeName>(&v0.liquidity_tokens, &v1), 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::liquidity_token_not_existed());
        let v2 = get_mut_token_pool(v0, &v1);
        assert!(0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::get_u64_vector_value(&v2.config.spot_config.enable_lending, arg3) == 1, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::lending_already_disabled());
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::set_u64_vector_value(&mut v2.config.spot_config.enable_lending, arg3, 0);
        let v3 = DisableLendingEvent{
            index                  : arg2,
            liquidity_token_type   : v1,
            lending_protocol_index : arg3,
            u64_padding            : 0x1::vector::empty<u64>(),
        };
        0x2::event::emit<DisableLendingEvent>(v3);
    }

    entry fun enable_lending<T0>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::verify(arg0, arg4);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        let v1 = 0x1::type_name::get<T0>();
        assert!(0x1::vector::contains<0x1::type_name::TypeName>(&v0.liquidity_tokens, &v1), 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::liquidity_token_not_existed());
        let v2 = get_mut_token_pool(v0, &v1);
        assert!(0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::get_u64_vector_value(&v2.config.spot_config.enable_lending, arg3) == 0, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::lending_already_enabled());
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::set_u64_vector_value(&mut v2.config.spot_config.enable_lending, arg3, 1);
        let v3 = EnableLendingEvent{
            index                  : arg2,
            liquidity_token_type   : v1,
            lending_protocol_index : arg3,
            u64_padding            : 0x1::vector::empty<u64>(),
        };
        0x2::event::emit<EnableLendingEvent>(v3);
    }
    ...
    public(friend) fun get_expired_receipt_collateral_bcs(arg0: &Registry, arg1: &0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg2: u64) : vector<vector<u8>> {
        ...
        let v2 = 0;
        while (v2 < 0x1::vector::length<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>(v1)) {
            let v3 = 0x1::vector::borrow<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>(v1, v2);
            let v4 = true;
            let v5 = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::get_bid_receipts(v3);
            let v6 = 0;
            ...
            if (v4) {
                0x1::vector::push_back<vector<u8>>(&mut v0, 0x2::bcs::to_bytes<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>(v3));
            };
            v2 = v2 + 1;
        };
        v0
    ...
    public(friend) fun get_mut_token_pool(arg0: &mut LiquidityPool, arg1: &0x1::type_name::TypeName) : &mut TokenPool {
        ...
        abort 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::liquidity_token_not_existed()
    }

    public(friend) fun get_receipt_collateral(arg0: &mut LiquidityPool) : vector<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt> {
        let v0 = 0x1::vector::empty<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>();
        while (0x1::vector::length<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>(&arg0.liquidated_unsettled_receipts) > 0) {
            0x1::vector::push_back<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>(&mut v0, 0x1::vector::pop_back<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>(&mut arg0.liquidated_unsettled_receipts));
        };
        v0
    }
    ...
    public(friend) fun get_receipt_collateral_bcs(arg0: &Registry, arg1: u64) : vector<vector<u8>> {
        ...
        let v2 = 0;
        while (v2 < 0x1::vector::length<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>(v1)) {
            0x1::vector::push_back<vector<u8>>(&mut v0, 0x2::bcs::to_bytes<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>(0x1::vector::borrow<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>(v1, v2)));
            v2 = v2 + 1;
        };
        v0
    }
    ...
    entry fun manager_deposit_scallop<T0>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg5: &0x2::clock::Clock, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::verify(arg0, arg7);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::pool_inactive());
        let v1 = 0x1::type_name::get<T0>();
        let v2 = get_mut_token_pool(v0, &v1);
        assert!(v2.state.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::token_pool_already_active());
        assert!(0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::get_u64_vector_value(&v2.config.spot_config.enable_lending, 0) == 1, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::token_not_available_for_lending());
        let v3 = v2.state.liquidity_amount - v2.state.reserved_amount;
        let v4 = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::get_u64_vector_value(&v2.state.current_lending_amount, 0) + 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::get_u64_vector_value(&v2.state.current_lending_amount, 1);
        let v5 = if (v3 >= v4) {
            v3 - v4
        } else {
            0
    ...
    public fun manager_flash_remove_liquidity<T0>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: RemoveLiquidityTokenProcess, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, RemoveLiquidityTokenProcess) {
        ...
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3) == v3.config.oracle_id, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::oracle_mismatched());
        ...
        arg4.removed_usd = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::amount_to_usd(v2, v3.config.liquidity_token_decimal, v4, v5);
    ...
    public fun manager_flash_repay_liquidity<T0>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: RemoveLiquidityTokenProcess, arg5: 0x2::balance::Balance<T0>, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) : RemoveLiquidityTokenProcess {
        ...
        assert!(v3.state.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::token_pool_inactive());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3) == v3.config.oracle_id, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::oracle_mismatched());
        ...
        let v7 = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::amount_to_usd(v4, v3.config.liquidity_token_decimal, v5, v6);
    ...
    entry fun manager_withdraw_scallop<T0>(arg0: &mut 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg5: &0x2::clock::Clock, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::verify(arg0, arg7);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::pool_inactive());
        let v1 = 0x1::type_name::get<T0>();
    ...
    public fun mint_lp<T0, T1>(arg0: &mut 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: &mut 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::treasury_caps::TreasuryCaps, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let v0 = 0x1::type_name::get<T0>();
        ...
        assert!(check_tvl_updated(v5, arg6), 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::tvl_not_yet_updated());
        let v6 = get_token_pool(v5, &v0);
        assert!(v4 >= v6.config.spot_config.min_deposit, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::deposit_amount_insufficient());
        assert!(v6.state.liquidity_amount + v4 <= v6.config.spot_config.max_capacity, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::reach_max_capacity());
        assert!(v6.state.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::token_pool_inactive());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3) == v6.config.oracle_id, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::oracle_mismatched());
        ...
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::charge_fee<T0>(arg0, v11);
        ...
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::token_interface::mint<T1>(0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::treasury_caps::get_mut_treasury_cap<T1>(arg2), v9, arg7)
    }

    entry fun new_liquidity_pool<T0>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LiquidityPool{
            ...
            pool_info                     : v0,
            liquidated_unsettled_receipts : 0x1::vector::empty<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>(),
            u64_padding                   : 0x1::vector::empty<u64>(),
    ...
    public(friend) fun order_filled<T0>(arg0: &mut LiquidityPool, arg1: bool, arg2: u64, arg3: 0x2::balance::Balance<T0>) {
        assert!(arg0.pool_info.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::pool_inactive());
    ...
    public(friend) fun put_collateral<T0>(arg0: &mut LiquidityPool, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64) {
        ...
        v1.state.value_in_usd = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::amount_to_usd(v1.state.liquidity_amount, v2.liquidity_token_decimal, arg2, arg3);
        let v3 = 0;
        let v4 = 0;
    ...
    public(friend) fun put_receipt_collaterals(arg0: &mut LiquidityPool, arg1: vector<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>) {
        0x1::vector::append<0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::escrow::UnsettledBidReceipt>(&mut arg0.liquidated_unsettled_receipts, arg1);
    }
    ...
    public(friend) fun request_collateral<T0>(arg0: &mut LiquidityPool, arg1: u64, arg2: u64, arg3: u64) : 0x2::balance::Balance<T0> {
        ...
        v2.state.value_in_usd = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::amount_to_usd(v2.state.liquidity_amount, v3.liquidity_token_decimal, arg2, arg3);
        let v4 = 0;
        let v5 = 0;
    ...
    entry fun resume_pool(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::verify(arg0, arg3);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(!v0.pool_info.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::pool_already_active());
    ...
    entry fun resume_token_pool<T0>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::verify(arg0, arg3);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::pool_inactive());
        let v1 = 0x1::type_name::get<T0>();
    ...
    public fun start_remove_liquidity_token_process<T0>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x2::tx_context::TxContext) : RemoveLiquidityTokenProcess {
        ...
        assert!(v2 == v1.oracle_id, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::oracle_mismatched());
    ...
    entry fun suspend_pool(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::verify(arg0, arg3);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::pool_inactive());
    ...
    entry fun suspend_token_pool<T0>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::verify(arg0, arg3);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::pool_inactive());
        let v1 = 0x1::type_name::get<T0>();
        let v2 = get_mut_token_pool(v0, &v1);
        assert!(v2.state.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::token_pool_inactive());
    ...
    public fun update_borrow_info(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::clock::Clock) {
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::version_check(arg0);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::pool_inactive());
    ...
    public fun update_liquidity_value<T0>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::version_check(arg0);
        let v0 = get_mut_liquidity_pool(arg1, arg2);
        assert!(v0.pool_info.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::pool_inactive());
        let v1 = 0x1::type_name::get<T0>();
    ...
    fun update_tvl(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut LiquidityPool, arg2: 0x1::type_name::TypeName, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x2::clock::Clock) : vector<u64> {
        ...
        let v4 = v3.config;
        assert!(v4.oracle_id == 0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3), 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::oracle_mismatched());
        v3.state.value_in_usd = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::amount_to_usd(v3.state.liquidity_amount, v4.liquidity_token_decimal, v1, v2);
    ...
    public(friend) fun view_swap_result<T0, T1>(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: u64, arg6: &0x2::clock::Clock) : vector<u64> {
        ...
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3) == v7.oracle_id, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::oracle_mismatched());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg4) == v8.oracle_id, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::oracle_mismatched());
        let v9 = get_token_pool(v0, &v5).state;
        let v10 = get_token_pool(v0, &v6).state;
        assert!(v9.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::token_pool_inactive());
        assert!(v10.is_active, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::token_pool_inactive());
        let v11 = 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::amount_to_usd(arg5, v7.liquidity_token_decimal, v1, v2);
        let (v12, v13) = calculate_swap_fee(v0, v5, arg5, v11, true);
        let (_, v15) = calculate_swap_fee(v0, v6, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::usd_to_amount(v11, v8.liquidity_token_decimal, v3, v4), v11, false);
        let (v16, v17) = if (v13 > v15) {
            (v12, v13)
        } else {
            (0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::usd_to_amount(v15, v7.liquidity_token_decimal, v1, v2), v15)
        };
        let v18 = 0x1::vector::empty<u64>();
        let v19 = &mut v18;
        0x1::vector::push_back<u64>(v19, 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::math::usd_to_amount(v11 - v17, v8.liquidity_token_decimal, v3, v4));
