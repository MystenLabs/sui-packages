module 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::tlp {
    ...
    public(friend) fun burn<T0>(arg0: &mut 0x2::coin::TreasuryCap<T0>, arg1: 0x2::coin::Coin<T0>) : u64 {
        assert!(0x1::type_name::get<T0>() == 0x1::type_name::get<TLP>(), 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::error::lp_token_type_mismatched());
    ...
    entry fun transfer_treasury_cap(arg0: &0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::Version, arg1: &mut LpRegistry, arg2: &mut 0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::treasury_caps::TreasuryCaps, arg3: &0x2::tx_context::TxContext) {
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::admin::verify(arg0, arg3);
        0x42c1f8533436ba9e63a609c0433ea7b9de222d9ab8911c0ed220a2f887531106::treasury_caps::store_treasury_cap<TLP>(arg2, 0x2::dynamic_object_field::remove<0x1::string::String, 0x2::coin::TreasuryCap<TLP>>(&mut arg1.id, 0x1::string::utf8(b"treasury_cap")));
    }
