module 0x4200c328ce92e56540e5602c00b6f8df99c72159d3c1ff8e62ef281994811314::tunnel {
    ...
    fun claim_internal<T0>(arg0: &mut Tunnel<T0>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : ClaimReceipt {
        ...
        let v2 = 0x2::balance::split<T0>(&mut arg0.balance, v0);
        let v3 = &arg0.receiver_configs;
        let v4 = 0x1::vector::length<ReceiverConfig>(v3);
        let v5 = false;
        let v6 = 0;
        let v7 = 0;
        let v8 = 0;
        while (v8 < v4) {
            let v9 = 0x1::vector::borrow<ReceiverConfig>(v3, v8);
            if (v9._type == 4022 && v9._address == @0x0) {
                v5 = true;
                v6 = v9.fee_bps;
            };
            if (v9._type == 4020) {
        ...
        v8 = 0;
        while (v8 < v4) {
            let v10 = 0x1::vector::borrow<ReceiverConfig>(v3, v8);
            if (v10._type == 4022 && v10._address == @0x0) {
                v8 = v8 + 1;
                continue
            };
            let v11 = v0 * v10.fee_bps / 10000;
            let v12 = v11;
            let v13 = if (v5) {
                if (v10._type == 4020) {
                    v7 > 0
            ...
            if (v13) {
                v12 = v11 + v0 * v6 / 10000 / v7;
            };
            if (v12 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v2, v12), arg3), v10._address);
            };
            v8 = v8 + 1;
        };
    ...
    public fun process_payment<T0>(arg0: &CreatorConfig, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        let v4 = 0x1::vector::length<ReceiverConfig>(&v2);
        while (v3 < v4) {
            let v5 = 0x1::vector::borrow_mut<ReceiverConfig>(&mut v2, v3);
            if (v5._type == 4022) {
                v5._address = arg1;
            };
            v3 = v3 + 1;
        ...
        v3 = 0;
        while (v3 < v4) {
            let v9 = 0x1::vector::borrow<ReceiverConfig>(&v2, v3);
            if (v9._type == 4022 && v9._address == @0x0) {
                v6 = true;
                v7 = v9.fee_bps;
            };
        ...
        v3 = 0;
        while (v3 < v4) {
            let v10 = 0x1::vector::borrow<ReceiverConfig>(&v2, v3);
            if (v10._type == 4022 && v10._address == @0x0) {
                v3 = v3 + 1;
                continue
            };
            ...
            if (v13) {
                v12 = v11 + v0 * v7 / 10000 / v8;
            };
            if (v12 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v1, v12), arg4), v10._address);
            };
            v3 = v3 + 1;
        };
        if (0x2::balance::value<T0>(&v1) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v1, arg4), arg0.operator);
        } else {
            0x2::balance::destroy_zero<T0>(v1);
        };
        let v14 = PaymentProcessed{
        ...
        0x2::event::emit<PaymentProcessed>(v14);
    }
