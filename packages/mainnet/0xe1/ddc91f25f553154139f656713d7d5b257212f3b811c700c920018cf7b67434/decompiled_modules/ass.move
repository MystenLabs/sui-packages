module 0xe1ddc91f25f553154139f656713d7d5b257212f3b811c700c920018cf7b67434::ass {
    struct ASS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ASS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/CXYvh5HgSbhoVkuNNavHyUYhhvTHrZ9rDYiM1m12pump.png?claimId=lN8-GDjRsQPsP00c                                                                                                                                                                                                      ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<ASS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"ASS       ")))), trim_right(b"asscoin                         "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
