module 0xe1bba51db73b8f2e51340380261df6a22c11d09d74a506d7bf81004d0bc6e555::reward3475 {
    struct REWARD3475 has drop {
        dummy_field: bool,
    }

    struct TICKET_3475 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3475(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3475>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3475>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3475, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3475>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3475>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3475>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3475>>(v5, 0x2::tx_context::sender(arg1));
    }
