module 0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::solo {
    ...
    public entry fun batch_delist_nfts<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::PersonalKioskCap, arg3: vector<0x2::object::ID>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::is_personal(arg1), 10);
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::owner(arg1) == 0x2::tx_context::sender(arg4), 1);
        let (v0, v1) = 0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::borrow_val(arg2);
        let v2 = 0;
        ...
        0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::return_val(arg2, v0, v1);
    }

    public entry fun batch_list_nfts<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::PersonalKioskCap, arg3: vector<0x2::object::ID>, arg4: vector<u64>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::is_personal(arg1), 10);
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::owner(arg1) == 0x2::tx_context::sender(arg5), 1);
        let v0 = 0x1::vector::length<0x2::object::ID>(&arg3);
        assert!(v0 == 0x1::vector::length<u64>(&arg4), 7);
        let (v1, v2) = 0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::borrow_val(arg2);
        let v3 = v1;
        let v4 = 0;
        while (v4 < v0) {
        ...
        0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::return_val(arg2, v3, v2);
    }

    public entry fun buy_and_place_in_kiosk<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::kiosk::Kiosk, arg6: &mut 0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::PersonalKioskCap, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::is_personal(arg1), 10);
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::is_personal(arg5), 10);
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::owner(arg5) == 0x2::tx_context::sender(arg7), 1);
        ...
        let (v15, v16) = 0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::borrow_val(arg6);
        let v17 = v15;
        0x2::kiosk::place<T0>(arg5, &v17, v10);
        0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::return_val(arg6, v17, v16);
    ...
    public entry fun delist_nft<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::PersonalKioskCap, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::is_personal(arg1), 10);
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::owner(arg1) == 0x2::tx_context::sender(arg4), 1);
        ...
        let (v8, v9) = 0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::borrow_val(arg2);
        0x2::kiosk::return_purchase_cap<T0>(arg1, v4);
        0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::return_val(arg2, v8, v9);
    ...
    public entry fun list_nft<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::PersonalKioskCap, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::is_personal(arg1), 10);
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::owner(arg1) == 0x2::tx_context::sender(arg5), 1);
        assert!(0x2::kiosk::has_item(arg1, arg3), 2);
        ...
        let (v0, v1) = 0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::borrow_val(arg2);
        let v2 = v0;
        0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::return_val(arg2, v2, v1);
        let v3 = Listing<T0>{
            id          : 0x2::object::new(arg5),
            seller      : 0x2::tx_context::sender(arg5),
            kiosk_id    : 0x2::object::id<0x2::kiosk::Kiosk>(arg1),
    ...
    public entry fun update_listing_price<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::PersonalKioskCap, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::is_personal(arg1), 10);
        assert!(0xe1f47eacaa4d31e68955562ae075e493a0e37c3e9d6a505a3fe1bf613b4090d7::personal_kiosk::owner(arg1) == 0x2::tx_context::sender(arg5), 1);
        assert!(0x2::kiosk::has_item(arg1, arg3), 2);
        assert!(0x2::kiosk::is_listed(arg1, arg3), 5);
