module 0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::vault {
    ...
    public fun add_withdraw_request<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: VaultLpToken<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == *0x2::object::uid_as_inner(&arg0.id), 0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::error::invalidLPToken());
        assert!(lp_token_value<T0, T1>(&arg1) > 0, 0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::error::zeroAmount());
    ...
    fun mint_lp_token<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LSP<T0, T1>> {
        ...
        let v3 = if (v2 == 0) {
            ...
            assert!(v4 > 0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::constants::minimal_liquidity(), 0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::error::notEnoughInitialLiquidity());
            v4
        } else {
            0x2::math::min(0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::safe_math::safe_mul_div_u64(0x2::balance::value<T0>(&arg1), v2, v0), 0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::safe_math::safe_mul_div_u64(0x2::balance::value<T1>(&arg2), v2, v1))
        };
        assert!(v3 > 0, 0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::error::liquidityInsufficientMinted());
    ...
    public fun new_vault<T0, T1>(arg0: &0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::app::AdminCap, arg1: &mut 0x2::tx_context::TxContext) : (Vault<T0, T1>, VaultCap) {
    ...
    public fun process_withdrawals<T0, T1>(arg0: &0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::app::AdminCap, arg1: &mut Vault<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<WithdrawRequest<T0, T1>>(&arg1.withdraw_requests) > 0) {
            ...
            let v8 = 0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::safe_math::safe_mul_div_u64(v6, v4, v7);
            let v9 = 0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::safe_math::safe_mul_div_u64(v5, v4, v7);
            assert!(v8 > 0 && v9 > 0, 0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::error::zeroAmount());
    ...
    public fun withdraw_assets_for_trading_account<T0, T1>(arg0: &0xe18eb7e59956b5ed843d48a9a7906cb1e1c187d1afd3edecb55c7fc5bc08b47a::app::AdminCap, arg1: &mut Vault<T0, T1>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
