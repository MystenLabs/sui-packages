module 0xe13b7a8d5f0f4c7ead56155f3ddf02f982eae4cafcac2218157a8534474d3355::game1168 {
    struct GAME1168 has drop {
        dummy_field: bool,
    }

    struct TICKET_1168 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1168(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1168>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1168>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME1168, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME1168>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1168>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1168>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1168>>(v5, 0x2::tx_context::sender(arg1));
    }
