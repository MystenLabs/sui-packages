module 0xe186d94b6077c2ac68c131e57145649998daf06420de4ae19d1e0d27527f15fc::haWAL {
    struct HAWAL has drop {
        dummy_field: bool,
    }

    fun init(arg0: HAWAL, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HAWAL>(arg0, 9, b"syhaWAL", b"SY haWAL", b"SY haWAL", 0x1::option::none<0x2::url::Url>(), arg1);
