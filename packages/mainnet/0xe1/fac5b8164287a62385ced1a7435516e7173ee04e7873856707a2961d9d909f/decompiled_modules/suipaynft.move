module 0xe1fac5b8164287a62385ced1a7435516e7173ee04e7873856707a2961d9d909f::suipaynft {
    ...
    fun mintInternal(arg0: 0x2::table::Table<0x1::string::String, 0x1::string::String>, arg1: &mut ContractInfo, arg2: u64, arg3: 0x1::string::String, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = gen_next_free(0xe1fac5b8164287a62385ced1a7435516e7173ee04e7873856707a2961d9d909f::pseudorandom::rand_u32(arg6) % (50 as u32), arg1);
