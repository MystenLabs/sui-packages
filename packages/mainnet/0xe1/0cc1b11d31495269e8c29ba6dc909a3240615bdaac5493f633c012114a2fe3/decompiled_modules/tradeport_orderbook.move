module 0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::tradeport_orderbook {
    ...
    public fun add_listing<T0: store + key>(arg0: &mut Store, arg1: &0x2::object::UID, arg2: 0x2::object::ID, arg3: address, arg4: 0x2::object::ID, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::utils::encode_order_id(false, arg5, arg0.index);
        let v4 = Listing{
            listing_id : arg2,
            market     : v0,
            index      : v3,
        ...
        if (!0x2::dynamic_field::exists_<OrderbookKey>(&arg0.id, v5)) {
            0x2::dynamic_field::add<OrderbookKey, 0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::BigVector<0x2::object::ID>>(&mut arg0.id, v5, 0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::empty<0x2::object::ID>(64, 64, arg6));
        };
        0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::insert<0x2::object::ID>(0x2::dynamic_field::borrow_mut<OrderbookKey, 0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::BigVector<0x2::object::ID>>(&mut arg0.id, v5), v3, arg2);
    ...
    public fun get_floor_listing<T0: store + key>(arg0: &Store) : (bool, 0x2::object::ID, 0x1::ascii::String, address, 0x2::object::ID, u64) {
        ...
        let v2 = 0x2::dynamic_field::borrow<OrderbookKey, 0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::BigVector<0x2::object::ID>>(&arg0.id, v1);
        let (v3, v4) = 0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::min_slice<0x2::object::ID>(v2);
        let v5 = v3;
        if (0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::slice_is_null(&v5)) {
            return empty_listing()
        };
        let v6 = 0x2::dynamic_field::borrow<0x2::object::ID, Listing>(&arg0.id, *0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::slice_borrow<0x2::object::ID>(0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::borrow_slice<0x2::object::ID>(v2, v5), v4));
    ...
    public fun get_next_floor_listing<T0: store + key>(arg0: &Store, arg1: 0x2::object::ID) : (bool, 0x2::object::ID, 0x1::ascii::String, address, 0x2::object::ID, u64) {
        ...
        let v2 = 0x2::dynamic_field::borrow<OrderbookKey, 0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::BigVector<0x2::object::ID>>(&arg0.id, v1);
        let (v3, v4) = 0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::slice_around<0x2::object::ID>(v2, 0x2::dynamic_field::borrow<0x2::object::ID, Listing>(&arg0.id, arg1).index);
        let (v5, v6) = 0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::next_slice<0x2::object::ID>(v2, v3, v4);
        let v7 = v5;
        if (0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::slice_is_null(&v7)) {
            return empty_listing()
        };
        let v8 = 0x2::dynamic_field::borrow<0x2::object::ID, Listing>(&arg0.id, *0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::slice_borrow<0x2::object::ID>(0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::borrow_slice<0x2::object::ID>(v2, v7), v6));
    ...
    public fun remove_listing<T0: store + key>(arg0: &mut Store, arg1: &0x2::object::UID, arg2: 0x2::object::ID) {
        ...
        0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::remove<0x2::object::ID>(0x2::dynamic_field::borrow_mut<OrderbookKey, 0xe10cc1b11d31495269e8c29ba6dc909a3240615bdaac5493f633c012114a2fe3::big_vector::BigVector<0x2::object::ID>>(&mut arg0.id, v1), 0x2::dynamic_field::borrow<0x2::object::ID, Listing>(&arg0.id, arg2).index);
        let Listing {
            listing_id : v2,
            market     : v3,
            index      : _,
