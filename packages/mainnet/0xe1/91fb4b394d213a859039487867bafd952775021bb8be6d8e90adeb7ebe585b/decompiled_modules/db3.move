module 0xe191fb4b394d213a859039487867bafd952775021bb8be6d8e90adeb7ebe585b::db3 {
    fun swap<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        if (v10) {
            ...
            v1 = 0xe191fb4b394d213a859039487867bafd952775021bb8be6d8e90adeb7ebe585b::util::div(v1, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() + 0xe191fb4b394d213a859039487867bafd952775021bb8be6d8e90adeb7ebe585b::util::mul(v4, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::fee_penalty_multiplier()));
        };
        let v14 = v1 - v1 % v8;
        assert!(v14 >= v9, 3);
