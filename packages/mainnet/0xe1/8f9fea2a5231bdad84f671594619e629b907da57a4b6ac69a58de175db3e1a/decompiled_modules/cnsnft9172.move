module 0xe18f9fea2a5231bdad84f671594619e629b907da57a4b6ac69a58de175db3e1a::cnsnft9172 {
    struct CNSNFT9172 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9172, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4588"));
        let v4 = 0x2::package::claim<CNSNFT9172>(arg0, arg1);
