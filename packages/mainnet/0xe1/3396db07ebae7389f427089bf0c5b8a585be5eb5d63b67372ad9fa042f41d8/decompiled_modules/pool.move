module 0xe13396db07ebae7389f427089bf0c5b8a585be5eb5d63b67372ad9fa042f41d8::pool {
    ...
    public fun add_rewards<T0>(arg0: &mut Pool<T0>, arg1: &RewardCap, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 0xe13396db07ebae7389f427089bf0c5b8a585be5eb5d63b67372ad9fa042f41d8::errors::no_lots());
        assert!(arg3 < 12, 0xe13396db07ebae7389f427089bf0c5b8a585be5eb5d63b67372ad9fa042f41d8::errors::invalid_params());
        let v1 = 0x2::coin::value<T0>(&arg2);
        let v2 = v1 / v0;
        let v3 = 0x1::vector::length<Round<T0>>(&arg0.rounds);
        assert!(arg3 == v3, 0xe13396db07ebae7389f427089bf0c5b8a585be5eb5d63b67372ad9fa042f41d8::errors::invalid_params());
        assert!(v2 != 0, 0xe13396db07ebae7389f427089bf0c5b8a585be5eb5d63b67372ad9fa042f41d8::errors::invalid_params());
        let v4 = Round<T0>{
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut Pool<T0>, arg1: u64, arg2: u64) : 0x2::balance::Balance<T0> {
        assert!(arg1 < 0x1::vector::length<Round<T0>>(&arg0.rounds), 0xe13396db07ebae7389f427089bf0c5b8a585be5eb5d63b67372ad9fa042f41d8::errors::wrong_round());
        let v0 = 0x1::vector::borrow_mut<Round<T0>>(&mut arg0.rounds, arg1);
        assert!(v0.remaining_claimable_lots >= arg2, 0xe13396db07ebae7389f427089bf0c5b8a585be5eb5d63b67372ad9fa042f41d8::errors::insufficient_lots());
    ...
    public(friend) fun record_mint<T0>(arg0: &mut Pool<T0>, arg1: u64, arg2: 0x2::object::ID) : u64 {
        assert!(0x1::vector::is_empty<Round<T0>>(&arg0.rounds), 0xe13396db07ebae7389f427089bf0c5b8a585be5eb5d63b67372ad9fa042f41d8::errors::mint_locked());
