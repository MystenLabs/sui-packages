module 0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::raffle {
    ...
    public fun create_raffle<T0, T1: store + key>(arg0: &mut 0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::House, arg1: &mut 0x2::kiosk::Kiosk, arg2: T1, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (Raffle<T0, T1>, RaffleOperatorCap) {
        ...
        0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::deposit_item<T1>(arg0, arg1, arg2);
        0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::events::emit_raffle_created(0x2::object::id<Raffle<T0, T1>>(&v1));
        (v1, v0)
    }

    public fun create_raffle_with_lock<T0, T1: store + key>(arg0: &mut 0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::House, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::transfer_policy::TransferPolicy<T1>, arg3: T1, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (Raffle<T0, T1>, RaffleOperatorCap) {
        ...
        0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::deposit_item_with_lock<T1>(arg0, arg1, arg2, arg3);
        0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::events::emit_raffle_created(0x2::object::id<Raffle<T0, T1>>(&v1));
        (v1, v0)
    }

    public fun finish_raffle<T0, T1: store + key>(arg0: &mut 0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::House, arg1: &mut Raffle<T0, T1>, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::withdraw_item<T1>(arg0, arg2, 0x1::option::extract<0x2::object::ID>(&mut arg1.internal_raffle_item_id));
        0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::events::emit_raffle_finished(0x2::object::id<Raffle<T0, T1>>(arg1));
        withdraw_balance_to_operator<T0, T1>(arg1, arg4);
        0x2::transfer::public_transfer<T1>(v1, v0);
    }

    public fun finish_raffle_with_locked<T0, T1: store + key>(arg0: &mut 0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::House, arg1: &mut Raffle<T0, T1>, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: 0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (RaffleHotPotato, 0x2::transfer_policy::TransferRequest<T1>) {
        assert_is_raffle_paused<T0, T1>(arg1);
        assert_deadline_has_passed<T0, T1>(arg1, arg6);
        assert_winner_selected<T0, T1>(arg1);
        assert_is_raffle_item_locked<T0, T1>(arg1);
        let (v0, v1) = 0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::withdraw_item_with_lock<T1>(arg0, arg2, 0x1::option::extract<0x2::object::ID>(&mut arg1.internal_raffle_item_id), arg7);
    ...
    public fun join_raffle<T0, T1: store + key>(arg0: &mut Raffle<T0, T1>, arg1: &mut 0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::House, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::get_fee_from_payment<T0>(arg1, &mut arg2, arg4);
        join_payment<T0, T1>(arg0, arg2);
        0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::events::emit_raffle_participant_joined(0x2::object::id<Raffle<T0, T1>>(arg0), 0x2::tx_context::sender(arg4));
    }
    ...
    entry fun select_winner<T0, T1: store + key>(arg0: &mut Raffle<T0, T1>, arg1: &0x2::random::Random, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::events::emit_raffle_winner_selected(0x2::object::id<Raffle<T0, T1>>(arg0), *v1);
    }
    ...
    public fun withdraw_raffle_item<T0, T1: store + key>(arg0: &RaffleOperatorCap, arg1: &mut Raffle<T0, T1>, arg2: &mut 0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::House, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::tx_context::TxContext) : T1 {
        assert_operator_cap<T0, T1>(arg1, arg0);
        assert_winner_not_selected<T0, T1>(arg1);
        assert_is_raffle_item_unlocked<T0, T1>(arg1);
        let v0 = 0x1::option::extract<0x2::object::ID>(&mut arg1.internal_raffle_item_id);
        withdraw_balance_to_operator<T0, T1>(arg1, arg4);
        0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::withdraw_item<T1>(arg2, arg3, v0)
    }

    public fun withdraw_raffle_item_with_locked<T0, T1: store + key>(arg0: &RaffleOperatorCap, arg1: &mut Raffle<T0, T1>, arg2: &mut 0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::House, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::tx_context::TxContext) : (T1, 0x2::transfer_policy::TransferRequest<T1>) {
        assert_operator_cap<T0, T1>(arg1, arg0);
        assert_winner_not_selected<T0, T1>(arg1);
        assert_is_raffle_item_locked<T0, T1>(arg1);
        let v0 = 0x1::option::extract<0x2::object::ID>(&mut arg1.internal_raffle_item_id);
        withdraw_balance_to_operator<T0, T1>(arg1, arg4);
        0xe1bf44069166378119e64bcc20eb653803c1483a76f4385c3ba7c5a291bd80c9::house::withdraw_item_with_lock<T1>(arg2, arg3, v0, arg4)
    }
