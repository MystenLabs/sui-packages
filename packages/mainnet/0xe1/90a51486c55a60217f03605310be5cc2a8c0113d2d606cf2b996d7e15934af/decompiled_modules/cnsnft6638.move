module 0xe190a51486c55a60217f03605310be5cc2a8c0113d2d606cf2b996d7e15934af::cnsnft6638 {
    struct CNSNFT6638 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6638, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6638>(arg0, arg1);
