module 0xe1597369fe82eaaf11bd4ff8c5326e6d48894fead7dba53697f25a13f5baaec3::jungle {
    ...
    fun init(arg0: JUNGLE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<JUNGLE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"JUNGLE  ")))), trim_right(b"Token Jungle                    "), trim_right(b"TokenJungle is a platform that simplifies token creation, management, and growth with a full suite of tools.                                                                                                                                                                                                                    "), v2, arg1);
