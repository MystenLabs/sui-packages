module 0xe1bb546241a720463c2e7a6d5da5c3f488f04263b4e874cc71a7655ac39cc569::reward8334 {
    struct REWARD8334 has drop {
        dummy_field: bool,
    }

    struct TICKET_8334 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8334(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8334>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8334>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8334, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8334>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8334>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8334>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8334>>(v5, 0x2::tx_context::sender(arg1));
    }
