module 0xe1a12941831f00ec5e8b5669cb3e1acf0a62f5e0ced63aebab310b192c25a498::kiosk_bidding_house_dynamic_coins {
    ...
    public fun accept_bid<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0xe1a12941831f00ec5e8b5669cb3e1acf0a62f5e0ced63aebab310b192c25a498::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v20 = v18;
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v20, 0x2::balance::value<T1>(&v20) * (v9 as u64) / 10000), arg5), 0xe1a12941831f00ec5e8b5669cb3e1acf0a62f5e0ced63aebab310b192c25a498::auctionhouse::get_owner(arg1));
    ...
    public entry fun accept_bid_entry<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0xe1a12941831f00ec5e8b5669cb3e1acf0a62f5e0ced63aebab310b192c25a498::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun buy_nft_with_request<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0xe1a12941831f00ec5e8b5669cb3e1acf0a62f5e0ced63aebab310b192c25a498::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<T1>, arg6: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        assert!(v14 >= v5, 31);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg5, v14 * (v9 as u64) / 10000, arg6), 0xe1a12941831f00ec5e8b5669cb3e1acf0a62f5e0ced63aebab310b192c25a498::auctionhouse::get_owner(arg1));
    ...
    public entry fun cancel_listing_entry<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun create_nft_listing_entry<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: u64, arg5: u16, arg6: &mut 0x2::tx_context::TxContext) {
