module 0xe11211064500ddd4409da4bd7a14d04afc3af85fc11cf606aa74c84f6658f3eb::walrus_950_nft_mint {
    struct WALRUS_950_NFT_MINT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WALRUS_950_NFT_MINT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WALRUS_950_NFT_MINT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Walrus 950 NFT Mint"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Claim you tokens at claim.walrus.xyz when Walrus goes to Mainnet. Welcome to the Walrus herd, believers in the power of high performance, programmable data storage. Yes, this NFT entitles you to claim WAL tokens upon Mainnet launch. But more importantly, it gives you the iceberg cred to say you were here at the beginning of unlocking what's next in Web3."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeihumavmiad3qcgp6hn4ixh65k37o2r6qzoxyenhcc3xketu4v6a3e"));
