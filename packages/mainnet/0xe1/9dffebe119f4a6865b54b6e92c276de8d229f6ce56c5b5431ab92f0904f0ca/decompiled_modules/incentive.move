module 0x5bf5c98e636791c53d8f149de4c026467b3667de14b0e92b7362e3dbf3726be5::incentive {
    ...
    public fun get_incentive_apy(arg0: &0x2::clock::Clock, arg1: &Incentive, arg2: &mut 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::Storage, arg3: &0x859de5e155d57462d3fe0aeb980b9a3f9cdccf76522d9499f372789183440aca::oracle::PriceOracle, arg4: u8) : vector<IncentiveAPYInfo> {
        ...
        while (v1 > 0) {
            ...
            while (v7 > 0) {
                ...
                v8 = v8 + 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::ray_math::ray_div(0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::ray_math::ray_mul(0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::ray_math::ray_div(0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::calculator::calculate_value(arg0, arg3, (0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::pool::convert_amount(v10.total_supply, 6, 9) as u256), v11.oracle_id), ((v10.end_at - v10.start_at) as u256)), 31536000000), 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::calculator::calculate_value(arg0, arg3, v5, 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::get_oracle_id(arg2, v2)));
    ...
    public fun get_incentive_apy_one(arg0: &0x2::clock::Clock, arg1: &Incentive, arg2: &mut 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::Storage, arg3: &0x859de5e155d57462d3fe0aeb980b9a3f9cdccf76522d9499f372789183440aca::oracle::PriceOracle, arg4: address) : IncentiveAPYInfo {
        let v0 = 0x2::table::borrow<address, IncentivePool>(&arg1.pools, arg4);
        let v1 = 0x2::table::borrow<address, IncentiveFundsPoolInfo>(&arg1.funds, v0.funds);
        let (v2, v3) = 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::get_total_supply(arg2, v0.asset_id);
        let v4 = v2;
        if (v0.option == 3) {
            v4 = v3;
        };
        ...
        IncentiveAPYInfo{
            ...
            apy        : 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::ray_math::ray_div(0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::ray_math::ray_mul(0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::ray_math::ray_div(0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::calculator::calculate_value(arg0, arg3, (0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::pool::convert_amount(v0.total_supply, 6, 9) as u256), v1.oracle_id), ((v0.end_at - v0.start_at) as u256)), 31536000000), 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::calculator::calculate_value(arg0, arg3, v4, 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::get_oracle_id(arg2, v0.asset_id))),
            coin_types : 0x1::vector::singleton<0x1::ascii::String>(0x1::type_name::into_string(v1.coin_type)),
        }
    }
