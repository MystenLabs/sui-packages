module 0xe1a198efb924941fcf16ff486e0f6ec909f6157570956e36be4592b312db4660::cnsnft4503 {
    struct CNSNFT4503 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4503, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1977"));
        let v4 = 0x2::package::claim<CNSNFT4503>(arg0, arg1);
