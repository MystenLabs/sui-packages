module 0x501fe28d1054127f181ef94a39a27a4cbc17f5a960805b09f5da01a8550f4302::vault {
    ...
    public fun pay<T0>(arg0: &mut Matrix, arg1: FlashLoan, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(is_vip(arg0, 0x2::tx_context::sender(arg4)), 1010);
        let FlashLoan {
            coin   : v0,
            amount : v1,
        } = arg1;
    ...
    public fun pay_test<T0>(arg0: &mut Matrix, arg1: FlashLoan, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(is_vip(arg0, 0x2::tx_context::sender(arg4)), 1010);
        let FlashLoan {
            coin   : v0,
            amount : v1,
