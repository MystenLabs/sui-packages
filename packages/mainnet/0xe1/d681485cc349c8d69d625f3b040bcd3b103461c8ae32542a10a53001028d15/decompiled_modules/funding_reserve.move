module 0xe1d681485cc349c8d69d625f3b040bcd3b103461c8ae32542a10a53001028d15::funding_reserve {
    ...
    public(friend) fun update(arg0: &mut 0x2::object::UID, arg1: &0xe1d681485cc349c8d69d625f3b040bcd3b103461c8ae32542a10a53001028d15::funding_rules::Rules, arg2: u256, arg3: u64, arg4: u64, arg5: u256, arg6: u64, arg7: u64, arg8: u256, arg9: u256, arg10: u64, arg11: u64, arg12: &0x2::clock::Clock) : Status {
        let v0 = if (arg4 > 0) {
            if (arg4 <= 86400000) {
        ...
        assert!(v0, 1);
        let (_, _, v3, v4, v5) = 0xe1d681485cc349c8d69d625f3b040bcd3b103461c8ae32542a10a53001028d15::funding_rules::values(arg1);
        ...
        if (arg6 == 0 || arg5 == 0) {
            ...
            let (v23, v24, _, _, _) = 0xe1d681485cc349c8d69d625f3b040bcd3b103461c8ae32542a10a53001028d15::funding_rules::values(arg1);
