module 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::referral {
    ...
    public(friend) fun claim_rebates<T0>(arg0: &mut Referral, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(!arg0.is_claim_paused, 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::error::referral_claim_paused());
        let v0 = 0x2::tx_context::sender(arg1);
        let v1 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<address, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&arg0.user_rebates_records, v0), 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::error::referral_no_rebates());
        let v2 = 0x2::table::borrow_mut<address, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&mut arg0.user_rebates_records, v0);
        assert!(0x2::vec_map::contains<0x1::type_name::TypeName, u64>(v2, &v1), 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::error::referral_rebate_no_token());
        let v3 = *0x2::vec_map::get<0x1::type_name::TypeName, u64>(v2, &v1);
        assert!(v3 != 0, 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::error::referral_claim_zero_value_rebate());
    ...
    public(friend) fun generate_referral_code(arg0: &mut Referral, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, 0x1::string::String>(&arg0.referrer_code, v0)) {
            abort 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::error::referral_already_has_referral_code()
        };
        assert!(is_qualified_to_create_referral_code(arg0, v0), 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::error::referral_not_qualified_to_gen_code());
        let v1 = generate_random_string(arg1, 6, arg2);
        assert!(!0x2::table::contains<0x1::string::String, address>(&arg0.code_owner, v1), 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::error::referral_invalid_referral_code());
    ...
    public(friend) fun get_referral_code(arg0: &Referral, arg1: address) : 0x1::string::String {
        assert!(has_referral_code(arg0, arg1), 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::error::referral_no_referral_code());
    ...
    public(friend) fun track_flash_loan_usage<T0>(arg0: &mut Referral, arg1: 0x2::coin::Coin<T0>, arg2: 0x1::string::String, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::table::contains<0x1::string::String, address>(&arg0.code_owner, arg2), 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::error::referral_invalid_referral_code());
    ...
    public(friend) fun try_map_referral_code(arg0: &mut Referral, arg1: address, arg2: 0x1::option::Option<0x1::string::String>) : 0x1::option::Option<0x1::string::String> {
        ...
        assert!(0x2::table::contains<0x1::string::String, address>(&arg0.code_owner, v0), 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::error::referral_invalid_referral_code());
        assert!(0x2::table::borrow<0x1::string::String, address>(&arg0.code_owner, v0) != &arg1, 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::error::referral_no_self_reference());
    ...
    public(friend) fun update_claim_pause(arg0: &mut Referral, arg1: bool) {
        assert!(arg0.is_claim_paused != arg1, 0xfeed37bf494357bd6514360ddbeecc820365654ea5fd1461b336cf6595eb3dc2::error::updating_with_same_value());
