module 0xe1090d53f6ddd95619afd3eedbd58e4e6c2937aceffe3624f73873d590eb8f17::reward9785 {
    struct REWARD9785 has drop {
        dummy_field: bool,
    }

    struct TICKET_9785 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9785(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9785>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9785>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9785, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9785>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9785>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9785>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9785>>(v5, 0x2::tx_context::sender(arg1));
    }
