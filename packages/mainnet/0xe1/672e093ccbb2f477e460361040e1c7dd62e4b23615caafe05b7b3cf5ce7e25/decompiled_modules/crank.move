module 0xe1672e093ccbb2f477e460361040e1c7dd62e4b23615caafe05b7b3cf5ce7e25::crank {
    ...
    public(friend) fun update_config(arg0: &mut CrankConfig, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64) {
        0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::floors::assert_spread(arg1);
        0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::floors::assert_min_apy(arg2);
        0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::floors::assert_cooldown(arg3);
        0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::floors::assert_slippage(arg4, false);
    ...
    public fun validate_heartbeat<T0>(arg0: &mut CrankConfig, arg1: &mut 0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::vault::Vault<T0>, arg2: &0xe1672e093ccbb2f477e460361040e1c7dd62e4b23615caafe05b7b3cf5ce7e25::strategy::StrategyRegistry, arg3: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(v0 - arg0.last_heartbeat_ms >= arg0.min_heartbeat_interval_ms, 606);
        0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::vault::update_heartbeat_tvl<T0>(arg1, arg3, 0xe1672e093ccbb2f477e460361040e1c7dd62e4b23615caafe05b7b3cf5ce7e25::strategy::borrow_protocol_access_cap(arg2));
        arg0.last_heartbeat_ms = v0;
        let v1 = 0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::vault::last_heartbeat_tvl<T0>(arg1);
    ...
    public fun validate_reroute<T0>(arg0: &mut CrankConfig, arg1: &0xe1672e093ccbb2f477e460361040e1c7dd62e4b23615caafe05b7b3cf5ce7e25::apy::ApyRegistry, arg2: &0xe1672e093ccbb2f477e460361040e1c7dd62e4b23615caafe05b7b3cf5ce7e25::strategy::StrategyRegistry, arg3: &0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::vault::Vault<T0>, arg4: u8, arg5: u8, arg6: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg6);
        assert!(0xe1672e093ccbb2f477e460361040e1c7dd62e4b23615caafe05b7b3cf5ce7e25::strategy::count_available(arg2) >= 2, 600);
        assert!(0xe1672e093ccbb2f477e460361040e1c7dd62e4b23615caafe05b7b3cf5ce7e25::strategy::is_available(arg2, arg5), 601);
        assert!(arg4 != arg5, 602);
        let v1 = 0xe1672e093ccbb2f477e460361040e1c7dd62e4b23615caafe05b7b3cf5ce7e25::apy::get_total_apy(arg1, arg4);
        let v2 = 0xe1672e093ccbb2f477e460361040e1c7dd62e4b23615caafe05b7b3cf5ce7e25::apy::get_total_apy(arg1, arg5);
        assert!(v2 > v1, 607);
        let v3 = if (v1 == 0) {
            10000
        } else {
        ...
        0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::floors::assert_spread(v3);
        assert!(v2 >= arg0.min_apy_bps, 604);
        0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::floors::assert_min_apy(v2);
        let v4 = v0 - arg0.last_reroute_ms;
        assert!(v4 >= arg0.reroute_cooldown_ms, 605);
        0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::floors::assert_cooldown(v4);
        if (arg4 != 0) {
            0xe1672e093ccbb2f477e460361040e1c7dd62e4b23615caafe05b7b3cf5ce7e25::apy::assert_not_stale(arg1, arg4, arg6);
        };
        0xe1672e093ccbb2f477e460361040e1c7dd62e4b23615caafe05b7b3cf5ce7e25::apy::assert_not_stale(arg1, arg5, arg6);
        let (_, v6) = 0xe1672e093ccbb2f477e460361040e1c7dd62e4b23615caafe05b7b3cf5ce7e25::strategy::decode_strategy(arg5);
        if (v6 == 2) {
            assert!(!0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::vault::is_depeg_active<T0>(arg3), 611);
        };
