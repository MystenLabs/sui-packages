module 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::router {
    ...
    public fun calculate_router_swap_result<T0, T1, T2, T3>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T3>, arg2: bool, arg3: bool, arg4: bool, arg5: u64) {
        if (arg4) {
            let v0 = 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap<T0, T1>(arg0, arg2, arg4, arg5);
            let v1 = 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_amount_out(&v0);
            if (0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_is_exceed(&v0) || v1 > 18446744073709551615) {
                ...
                let v4 = (v1 as u64);
                let v5 = 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap<T2, T3>(arg1, arg3, arg4, v4);
                let v6 = 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_amount_out(&v5);
                if (v6 > 18446744073709551615) {
                    ...
                    let v9 = CalculatedRouterSwapResult{
                        ...
                        is_exceed             : 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_is_exceed(&v0) || 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_is_exceed(&v5),
                        ...
                        target_sqrt_price_ab  : 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_after_sqrt_price(&v0),
                        target_sqrt_price_cd  : 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_after_sqrt_price(&v5),
                    };
            ...
            let v11 = 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap<T2, T3>(arg1, arg3, arg4, arg5);
            let v12 = 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_is_exceed(&v11);
            let v13 = 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_amount_in(&v11);
            if (v12 || v13 > 18446744073709551615) {
                ...
                let v16 = (v13 as u64);
                let v17 = (0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_fee_amount(&v11) as u64);
                let v18 = 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap<T0, T1>(arg0, arg2, arg4, v16 + v17);
                let v19 = 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_amount_in(&v18);
                if (v19 > 18446744073709551615) {
                    ...
                    let v22 = CalculatedRouterSwapResult{
                        amount_in             : (v19 as u64) + (0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_fee_amount(&v18) as u64),
                        amount_medium         : v16 + v17,
                        amount_out            : arg5,
                        is_exceed             : 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_is_exceed(&v18) || v12,
                        current_sqrt_price_ab : 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg0),
                        current_sqrt_price_cd : 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T2, T3>(arg1),
                        target_sqrt_price_ab  : 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_after_sqrt_price(&v18),
                        target_sqrt_price_cd  : 0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::expect_swap::expect_swap_result_after_sqrt_price(&v11),
                    };
    ...
    public entry fun swap_ab_bc<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T2>, arg5: bool, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u128, arg11: u128, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        if (arg5) {
            ...
            0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::utils::send_coin<T1>(v5, 0x2::tx_context::sender(arg13));
            0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::utils::send_coin<T2>(v6, 0x2::tx_context::sender(arg13));
        } else {
            ...
            0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::utils::send_coin<T0>(v12, 0x2::tx_context::sender(arg13));
            0x2::coin::join<T2>(&mut arg4, 0x2::coin::from_balance<T2>(v8, arg13));
            0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::utils::send_coin<T2>(arg4, 0x2::tx_context::sender(arg13));
        };
    }
    ...
    public entry fun swap_ab_cb<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T2>, arg5: bool, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u128, arg11: u128, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        if (arg5) {
            ...
            0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::utils::send_coin<T0>(v1, 0x2::tx_context::sender(arg13));
            0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::utils::send_coin<T1>(v6, 0x2::tx_context::sender(arg13));
            0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::utils::send_coin<T2>(v5, 0x2::tx_context::sender(arg13));
        } else {
    ...
    public entry fun swap_ba_bc<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T2>, arg5: bool, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u128, arg11: u128, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        if (arg5) {
            ...
            assert!(v4 >= arg7, 0);
            let (v5, v6) = swap<T1, T2>(arg0, arg2, v3, arg4, true, true, v4, arg9, arg11, arg12, arg13);
            0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::utils::send_coin<T0>(v2, 0x2::tx_context::sender(arg13));
            0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::utils::send_coin<T1>(v5, 0x2::tx_context::sender(arg13));
            0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::utils::send_coin<T2>(v6, 0x2::tx_context::sender(arg13));
        } else {
            let (v7, v8, v9) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T1, T2>(arg0, arg2, true, false, arg7, arg11, arg12);
            ...
            0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::utils::send_coin<T0>(v13, 0x2::tx_context::sender(arg13));
            0x2::coin::join<T2>(&mut arg4, 0x2::coin::from_balance<T2>(v8, arg13));
            0xe18f7c41e055692946d2bbaf1531af76d297473d2c2c110a0840befec5960be1::utils::send_coin<T2>(arg4, 0x2::tx_context::sender(arg13));
        };
    }
