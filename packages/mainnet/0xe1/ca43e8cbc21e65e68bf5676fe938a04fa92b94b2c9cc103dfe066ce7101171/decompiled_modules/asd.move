module 0xe1ca43e8cbc21e65e68bf5676fe938a04fa92b94b2c9cc103dfe066ce7101171::asd {
    struct ASD has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ASD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ASD>(arg0, 5, b"ASD", b"ASD", b"ASD", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://www.arweave.net/vEtGqSAFnMffjG62tPeBEwkVJG5t654J-bXiSweQqNg?ext=jpg")), arg1);
