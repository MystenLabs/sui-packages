module 0xe1d5c4b443539bae19caa6d3d68be21891af2898cab7aaa6dea1220c4d04777f::deep {
    ...
    fun init(arg0: DEEP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<DEEP>(&mut v2, 100000000000 * 0x1::u64::pow(10, 6), 0x2::tx_context::sender(arg1), arg1);
