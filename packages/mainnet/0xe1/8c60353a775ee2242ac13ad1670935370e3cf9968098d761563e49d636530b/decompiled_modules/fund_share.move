module 0xe18c60353a775ee2242ac13ad1670935370e3cf9968098d761563e49d636530b::fund_share {
    ...
    public(friend) fun create_burn_request<T0>(arg0: &0xe18c60353a775ee2242ac13ad1670935370e3cf9968098d761563e49d636530b::config::GlobalConfig, arg1: 0x2::object::ID) : BurnRequest<T0> {
    ...
    public(friend) fun create_mint_request<T0>(arg0: &0xe18c60353a775ee2242ac13ad1670935370e3cf9968098d761563e49d636530b::config::GlobalConfig, arg1: 0x2::object::ID, arg2: bool, arg3: address, arg4: 0x1::string::String, arg5: u64, arg6: address, arg7: address) : MintRequest<T0> {
        0xe18c60353a775ee2242ac13ad1670935370e3cf9968098d761563e49d636530b::config::assert_if_version_not_matched(arg0, 1);
        MintRequest<T0>{
            fund_id         : arg1,
            is_init         : arg2,
    ...
    public fun mint<T0>(arg0: &mut 0xe18c60353a775ee2242ac13ad1670935370e3cf9968098d761563e49d636530b::config::GlobalConfig, arg1: MintRequest<T0>, arg2: &mut 0x2::tx_context::TxContext) : FundShare {
        0xe18c60353a775ee2242ac13ad1670935370e3cf9968098d761563e49d636530b::config::assert_if_version_not_matched(arg0, 1);
        let MintRequest {
            fund_id         : v0,
            is_init         : v1,
