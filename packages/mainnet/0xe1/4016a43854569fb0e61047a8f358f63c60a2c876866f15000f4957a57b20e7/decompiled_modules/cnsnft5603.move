module 0xe14016a43854569fb0e61047a8f358f63c60a2c876866f15000f4957a57b20e7::cnsnft5603 {
    struct CNSNFT5603 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5603, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5603>(arg0, arg1);
