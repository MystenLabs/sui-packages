module 0xe1565a262fc54885c280aa7cc58793dfb5abc4197363fcf556af8b394e46630a::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"OU", b"obito uchiha", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-08T05-18-00.090Z-G12LfxKbsAA1ggf.jpg")), arg1);
