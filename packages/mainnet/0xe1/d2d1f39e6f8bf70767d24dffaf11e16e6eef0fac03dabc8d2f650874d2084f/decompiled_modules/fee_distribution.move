module 0xe1d2d1f39e6f8bf70767d24dffaf11e16e6eef0fac03dabc8d2f650874d2084f::fee_distribution {
    ...
    public(friend) fun get_fees_to_withdraw<T0, T1>(arg0: &FeeState<T0, T1>, arg1: u64, arg2: &0x2::tx_context::TxContext) : (u64, u64) {
        ...
        (get_max_withdraw(*0x2::table::borrow<address, u64>(&arg0.user_withdrawals_x, v0), arg0.fees_meme_total, arg1, arg0.stakes_total), get_max_withdraw(*0x2::table::borrow<address, u64>(&arg0.user_withdrawals_y, v0), arg0.fees_s_total, arg1, arg0.stakes_total))
    }
