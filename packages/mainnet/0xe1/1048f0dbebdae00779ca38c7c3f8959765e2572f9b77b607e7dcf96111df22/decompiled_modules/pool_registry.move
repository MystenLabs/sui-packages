module 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::pool_registry {
    ...
    public(friend) fun add_coin<T0>(arg0: &mut PoolRegistry) {
        let v0 = 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::type_to_string<T0>();
    ...
    public fun contains_coin<T0>(arg0: &PoolRegistry) : bool {
        0x2::table::contains<0x1::ascii::String, bool>(&arg0.coins, 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::type_to_string<T0>())
    }

    public fun contains_lp_coin<T0>(arg0: &PoolRegistry) : bool {
        0x2::table::contains<0x1::ascii::String, 0x2::object::ID>(&arg0.lp_coin_map, 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::type_to_string<T0>())
    }
    ...
    public fun lp_type_to_pool_id<T0>(arg0: &PoolRegistry) : 0x2::object::ID {
        *0x2::table::borrow<0x1::ascii::String, 0x2::object::ID>(&arg0.lp_coin_map, 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::type_to_string<T0>())
    }
    ...
    public(friend) fun register_pool<T0>(arg0: &mut PoolRegistry, arg1: &0x2::object::UID, arg2: vector<0x1::ascii::String>, arg3: vector<u64>, arg4: u64, arg5: vector<u64>, arg6: vector<u64>, arg7: vector<u64>, arg8: vector<u64>) {
        ...
        0x2::table::add<0x1::ascii::String, 0x2::object::ID>(&mut arg0.lp_coin_map, 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::type_to_string<T0>(), 0x2::object::uid_to_inner(arg1));
