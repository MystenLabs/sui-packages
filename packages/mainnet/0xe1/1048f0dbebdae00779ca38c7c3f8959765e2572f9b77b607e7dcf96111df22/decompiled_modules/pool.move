module 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::pool {
    ...
    public(friend) fun new<T0>(arg0: CreatePoolCap<T0>, arg1: &mut 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::pool_registry::PoolRegistry, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<0x1::ascii::String>, arg8: vector<u64>, arg9: u64, arg10: vector<u64>, arg11: vector<u64>, arg12: vector<u64>, arg13: vector<u64>, arg14: 0x1::option::Option<vector<u8>>, arg15: bool, arg16: 0x1::option::Option<u8>, arg17: &mut 0x2::tx_context::TxContext) : Pool<T0> {
        ...
        let v9 = 0x2::object::new(arg17);
        0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::pool_registry::register_pool<T0>(arg1, &v9, arg7, arg8, arg9, arg10, arg11, arg12, arg13);
        let v10 = 9;
        let (v11, v12, v13) = if (arg15) {
            let (v14, v15) = 0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::decimals::decimal_scalars_from_decimals(0x1::option::borrow<vector<u8>>(&arg14));
            let v11 = v15;
            let v13 = v14;
            (v11, (1000000000000000000 as u128), v13)
        } else {
            let v11 = 0x1::vector::empty<u128>();
            let (v12, v13) = if (0x1::option::is_some<vector<u8>>(&arg14)) {
                let v16 = *0x1::option::borrow<vector<u8>>(&arg14);
                let v17 = 0;
                let v18 = 0;
                while (v18 < v0) {
                    v17 = v17 + (*0x1::vector::borrow<u8>(&v16, v18) as u256) * (*0x1::vector::borrow<u64>(&arg8, v18) as u256);
                    0x1::vector::push_back<u128>(&mut v11, (1000000000000000000 as u128));
                    v18 = v18 + 1;
                };
                let v13 = (((v17 as u64) / 1000000000000000000) as u8);
                ((0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::fixed::pow_down(0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::fixed::convert_int_to_fixed(10), v17) as u128) / 0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::numerical::int_exp_128(10, (v13 as u64)), v13)
            } else {
                let v19 = 0;
                while (v19 < v0) {
                    0x1::vector::push_back<u128>(&mut v11, (1000000000000000000 as u128));
                ...
                let v13 = *0x1::option::borrow_with_default<u8>(&arg16, &v10);
                ((1000000000000000000 as u128), v13)
            };
            (v11, v12, v13)
        };
        let v20 = *0x1::option::borrow_with_default<u8>(&arg16, &v13);
        let v21 = if (v20 >= v13) {
            v12 / 0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::numerical::int_exp_128(10, ((v20 - v13) as u64))
        } else {
            v12 * 0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::numerical::int_exp_128(10, ((v13 - v20) as u64))
        };
        v13 = v20;
        Pool<T0>{
            id                  : v9,
            ...
            type_names          : arg7,
            normalized_balances : 0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::vector::empty_vector_128(v0),
            weights             : arg8,
            flatness            : arg9,
            fees_swap_in        : arg10,
            fees_swap_out       : arg11,
    ...
    fun assert_pool_creation_parameters_are_valid<T0>(arg0: u64, arg1: u64, arg2: &vector<u64>, arg3: &vector<u64>, arg4: &vector<u64>, arg5: &vector<u64>, arg6: &vector<u64>, arg7: &0x1::option::Option<vector<u8>>, arg8: bool, arg9: &0x1::option::Option<u8>, arg10: &CreatePoolCap<T0>) {
        ...
        let v13 = if (arg8) {
            ...
            0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::decimals::mean(&v9)
        } else {
            9
        };
        let v14 = v13;
        assert!(0x2::coin::get_decimals<T0>(&arg10.lp_coin_metadata) == *0x1::option::borrow_with_default<u8>(arg9, &v14), 9);
        assert!(v2 == 1000000000000000000, 2);
        let v15 = 9;
        assert!(*0x1::option::borrow_with_default<u8>(arg9, &v15) <= 18, 9);
    }
    ...
    fun borrow_balance<T0, T1>(arg0: &Pool<T0>) : &0x2::balance::Balance<T1> {
        0x2::dynamic_field::borrow<0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::BalanceKey<T1>, 0x2::balance::Balance<T1>>(&arg0.id, 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::type_to_balance_key<T1>())
    }

    fun borrow_mut_balance<T0, T1>(arg0: &mut Pool<T0>) : &mut 0x2::balance::Balance<T1> {
        0x2::dynamic_field::borrow_mut<0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::BalanceKey<T1>, 0x2::balance::Balance<T1>>(&mut arg0.id, 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::type_to_balance_key<T1>())
    }
    ...
    public fun contains_type<T0, T1>(arg0: &Pool<T0>) : bool {
        let v0 = 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::type_to_string<T1>();
    ...
    public(friend) fun initialize_liquidity<T0, T1>(arg0: &mut 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::pool_registry::PoolRegistry, arg1: &mut Pool<T0>, arg2: 0x2::coin::Coin<T1>) {
        *0x1::vector::borrow_mut<u128>(&mut arg1.normalized_balances, type_to_index<T0, T1>(arg1)) = normalize_amount<T0, T1>(arg1, 0x2::coin::value<T1>(&arg2));
        0x2::dynamic_field::add<0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::BalanceKey<T1>, 0x2::balance::Balance<T1>>(&mut arg1.id, 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::type_to_balance_key<T1>(), 0x2::coin::into_balance<T1>(arg2));
        0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::pool_registry::add_coin<T1>(arg0);
    }
    ...
    public fun lp_type<T0>(arg0: &Pool<T0>) : 0x1::ascii::String {
        0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::type_to_string<T0>()
    }
    ...
    public(friend) fun type_to_index<T0, T1>(arg0: &Pool<T0>) : u64 {
        type_name_to_index<T0>(arg0, 0xe11048f0dbebdae00779ca38c7c3f8959765e2572f9b77b607e7dcf96111df22::keys::type_to_string<T1>())
    }
