module 0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::config {
    ...
    struct GlobalConfig has store, key {
        ...
        acl: 0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::ACL,
        package_version: u64,
    }
    ...
    public fun acl(arg0: &GlobalConfig) : &0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::ACL {
        &arg0.acl
    }

    public fun add_role(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u8) {
        checked_package_version(arg0);
        0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::add_role(&mut arg0.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::Member> {
        0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        checked_package_version(arg0);
        0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun remove_role(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u8) {
        checked_package_version(arg0);
        0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::remove_role(&mut arg0.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        checked_package_version(arg0);
        0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun check_bin_step_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::has_role(&arg0.acl, arg1, 1), 1);
    }

    public fun check_pair_creator_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::has_role(&arg0.acl, arg1, 5), 6);
    }

    public fun check_pair_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::has_role(&arg0.acl, arg1, 0), 5);
    }

    public fun check_protocol_fee_claim_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::has_role(&arg0.acl, arg1, 2), 2);
    }

    public fun check_quote_whitelist_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::has_role(&arg0.acl, arg1, 4), 11);
    }

    public fun check_rewarder_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::has_role(&arg0.acl, arg1, 3), 3);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                   : 0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::acl::new(arg0),
            package_version       : 1,
        };
