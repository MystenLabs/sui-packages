module 0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::safe_math {
    ...
    public fun sqrt_u128(arg0: u128) : u128 {
        ...
        let v0 = 1 << (0xe18a5b379abf25213643b8f5c3820d4a5061077fdd7ec1d58106e59aa18a2616::bit_math::most_significant_bit(arg0) + 1) / 2;
        let v1 = (arg0 / v0 + v0) / 2;
        while (v1 < v0) {
            let v2 = arg0 / v1 + v1;
            v1 = v2 / 2;
