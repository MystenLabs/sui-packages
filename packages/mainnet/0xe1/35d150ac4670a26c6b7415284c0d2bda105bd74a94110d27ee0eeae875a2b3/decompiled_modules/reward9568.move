module 0xe135d150ac4670a26c6b7415284c0d2bda105bd74a94110d27ee0eeae875a2b3::reward9568 {
    struct REWARD9568 has drop {
        dummy_field: bool,
    }

    struct TICKET_9568 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9568(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9568>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9568>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9568, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9568>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9568>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9568>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9568>>(v5, 0x2::tx_context::sender(arg1));
    }
