module 0xe14e687de02383c99502841927cfb34598647c5e75b4dc0255281e2cd7e84761::__sui_colors_ {
    struct __SUI_COLORS_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: __SUI_COLORS_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<__SUI_COLORS_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"  Sui Colors "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Your on-chain identity, pixel by pixel."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiguv7nfsucg7ce4tsrdsg36ybrhyiqqhsbx2pud4m363nmrox7emi"));
