module 0xe1ae3a57e442f4f5898a21a7d7f5be1710cb713add45404ba28ff27450ff9e09::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT2517432", b"BatchToken2 517432", b"Second atomic deployment", 0x1::option::none<0x2::url::Url>(), arg1);
