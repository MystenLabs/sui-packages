module 0xe1ea08cd0370f1f249f9223f22ba725de5f6e60d0d78e5b8341f34821c4588c6::cetus_reward_w0 {
    struct CETUS_REWARD_W0 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = CETUS_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmYet52GL8rUqiGLvXEUZrWXZX3XxgKLB9TbaCH3stdv81"),
            };
    ...
    fun init(arg0: CETUS_REWARD_W0, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmYet52GL8rUqiGLvXEUZrWXZX3XxgKLB9TbaCH3stdv81"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        let v4 = 0x2::package::claim<CETUS_REWARD_W0>(arg0, arg1);
