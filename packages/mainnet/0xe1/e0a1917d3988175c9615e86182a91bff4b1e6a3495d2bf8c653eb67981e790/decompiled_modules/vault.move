    ...
    entry fun move_token<T0, T1, T2>(arg0: &AdminCap, arg1: &VaultConfig, arg2: &mut Vault<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::type_name::into_string(0x1::type_name::with_defining_ids<T2>()) == 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())) {
            if (0x1::option::is_some<0x2::coin::Coin<T0>>(&arg2.coin_store.coin)) {
                0x2::coin::join<T0>(0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg2.coin_store.coin), v5);
            } else {
                0x1::option::fill<0x2::coin::Coin<T0>>(&mut arg2.coin_store.coin, v5);
            };
            arg2.available_liquidity = (0x2::coin::value<T0>(0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg2.coin_store.coin)) as u128);
            let v8 = arg2.available_liquidity;
            add_table_vault_asset<T0, T1>(arg2, 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), v8, arg3);
        } else {
            let v9 = if (0x2::bag::contains<0x1::ascii::String>(&arg2.harvest_assets, v0)) {
                let v10 = 0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg2.harvest_assets, v0);
                0x2::coin::join<T0>(v10, v5);
                0x2::coin::value<T0>(v10)
            } else {
                0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg2.harvest_assets, v0, v5);
                0x1::vector::push_back<0x1::ascii::String>(&mut arg2.harvest_asset_keys, v0);
                0x2::coin::value<T0>(&v5)
            };
            add_table_vault_asset_no_ctx<T0, T1>(arg2, v0, (v9 as u128));
        };
        let v11 = AddFundEvent{
            amount   : v4,
            vault_id : 0x2::object::id<Vault<T0, T1>>(arg2),
        };
        0x2::event::emit<AddFundEvent>(v11);
    }
