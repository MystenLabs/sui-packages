module 0x4358aa706a12cbefad81e7470da4c7f4210f610c0d50ff89ce3ca9a7fec777f6::thunder {
    ...
    public fun count(arg0: &Storm, arg1: vector<u8>) : u64 {
        ...
        0x1::vector::length<Signal>(&0x2::dynamic_field::borrow<vector<u8>, Inbox>(&arg0.id, arg1).signals)
    }
    ...
    entry fun quest(arg0: &mut Storm, arg1: vector<u8>, arg2: &0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg3: &0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::dynamic_field::borrow_mut<vector<u8>, Inbox>(&mut arg0.id, arg1);
        ...
        if (0x1::vector::is_empty<Signal>(&v2.signals)) {
            let Inbox {  } = 0x2::dynamic_field::remove<vector<u8>, Inbox>(&mut arg0.id, arg1);
        };
    ...
    entry fun signal(arg0: &mut Storm, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, arg1)) {
            0x1::vector::push_back<Signal>(&mut 0x2::dynamic_field::borrow_mut<vector<u8>, Inbox>(&mut arg0.id, arg1).signals, v1);
        } else {
            let v2 = 0x1::vector::empty<Signal>();
            0x1::vector::push_back<Signal>(&mut v2, v1);
            let v3 = Inbox{signals: v2};
            0x2::dynamic_field::add<vector<u8>, Inbox>(&mut arg0.id, arg1, v3);
        };
        let v4 = Signaled{
            name_hash    : arg1,
            timestamp_ms : v0,
