module 0x438669016a80cc7d4736323fc2d0dc6c4ed32b7b183a17cc467e97f1175d06e9::collection {
    ...
    public(friend) fun new(arg0: u64, arg1: 0x1::string::String, arg2: 0x438669016a80cc7d4736323fc2d0dc6c4ed32b7b183a17cc467e97f1175d06e9::attributes::Attributes, arg3: &mut 0x2::tx_context::TxContext) : DegenRabbit {
        DegenRabbit{
    ...
    public fun add_kiosk_lock_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<DegenRabbit>, arg1: &CollectionInfo) {
        0x438669016a80cc7d4736323fc2d0dc6c4ed32b7b183a17cc467e97f1175d06e9::kiosk_lock_rule::add<DegenRabbit>(arg0, &arg1.policy_cap);
    }

    public fun add_royalty_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<DegenRabbit>, arg1: &CollectionInfo) {
        0x438669016a80cc7d4736323fc2d0dc6c4ed32b7b183a17cc467e97f1175d06e9::royalty_rule::add<DegenRabbit>(arg0, &arg1.policy_cap, 600, 0);
    }
    ...
    public fun remove_kiosk_lock_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<DegenRabbit>, arg1: &CollectionInfo) {
        0x438669016a80cc7d4736323fc2d0dc6c4ed32b7b183a17cc467e97f1175d06e9::kiosk_lock_rule::remove<DegenRabbit>(arg0, &arg1.policy_cap);
    }

    public fun remove_royalty_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<DegenRabbit>, arg1: &CollectionInfo) {
        0x438669016a80cc7d4736323fc2d0dc6c4ed32b7b183a17cc467e97f1175d06e9::royalty_rule::remove<DegenRabbit>(arg0, &arg1.policy_cap);
    }

    public(friend) fun upgrade(arg0: &mut DegenRabbit, arg1: 0x1::string::String, arg2: 0x438669016a80cc7d4736323fc2d0dc6c4ed32b7b183a17cc467e97f1175d06e9::attributes::Attributes) {
