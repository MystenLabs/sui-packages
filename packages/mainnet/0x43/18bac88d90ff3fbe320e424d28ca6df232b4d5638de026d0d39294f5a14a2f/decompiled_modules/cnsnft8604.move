module 0x4318bac88d90ff3fbe320e424d28ca6df232b4d5638de026d0d39294f5a14a2f::cnsnft8604 {
    struct CNSNFT8604 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8604, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8604>(arg0, arg1);
