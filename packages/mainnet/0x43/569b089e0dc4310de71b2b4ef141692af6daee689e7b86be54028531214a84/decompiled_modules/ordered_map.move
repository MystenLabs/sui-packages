module 0x43569b089e0dc4310de71b2b4ef141692af6daee689e7b86be54028531214a84::ordered_map {
    ...
    public fun try_remove<T0: copy + drop + store>(arg0: &mut Map<T0>, arg1: u128) : 0x43569b089e0dc4310de71b2b4ef141692af6daee689e7b86be54028531214a84::enum_option::Option<T0> {
        let v0 = arg0.root;
        if (9223372036854775808 & v0 == 0) {
    ...
    fun try_remove_from_branch<T0: copy + drop + store>(arg0: &mut Map<T0>, arg1: u64, arg2: u128) : (0x43569b089e0dc4310de71b2b4ef141692af6daee689e7b86be54028531214a84::enum_option::Option<T0>, u64) {
        let v0 = 0x2::dynamic_field::borrow<u64, Branch>(&arg0.id, arg1);
        let v1 = &v0.keys;
        let v2 = 0x1::vector::length<u128>(v1);
        let v3 = binary_search(v1, v2, arg2);
        ...
        if (9223372036854775808 & v5 == 0) {
            if (v3 < v2) {
                ...
                let v9 = v7;
                if (0x43569b089e0dc4310de71b2b4ef141692af6daee689e7b86be54028531214a84::enum_option::is_none<T0>(&v9)) {
                    return (v9, v2 + 1)
                };
                if (v8 < arg0.branch_min) {
            ...
            let v15 = v13;
            if (0x43569b089e0dc4310de71b2b4ef141692af6daee689e7b86be54028531214a84::enum_option::is_none<T0>(&v15)) {
                return (v15, v2 + 1)
            };
        ...
        if (v3 < v2) {
            ...
            let v21 = v19;
            if (0x43569b089e0dc4310de71b2b4ef141692af6daee689e7b86be54028531214a84::enum_option::is_none<T0>(&v21)) {
                return (v21, v2 + 1)
            };
        ...
        let v27 = v25;
        if (0x43569b089e0dc4310de71b2b4ef141692af6daee689e7b86be54028531214a84::enum_option::is_none<T0>(&v27)) {
            return (v27, v2 + 1)
        };
    ...
    fun try_remove_from_leaf<T0: store>(arg0: &mut Map<T0>, arg1: u64, arg2: u128) : (0x43569b089e0dc4310de71b2b4ef141692af6daee689e7b86be54028531214a84::enum_option::Option<T0>, u64) {
        let v0 = 0x2::dynamic_field::borrow_mut<u64, Leaf<T0>>(&mut arg0.id, arg1);
        let v1 = &v0.keys_vals;
        let v2 = 0x1::vector::length<Pair<T0>>(v1);
        let v3 = binary_search_p<T0>(v1, v2, arg2);
        if (v3 == v2 || arg2 != 0x1::vector::borrow<Pair<T0>>(v1, v3).key) {
            return (0x43569b089e0dc4310de71b2b4ef141692af6daee689e7b86be54028531214a84::enum_option::none<T0>(), v2)
        };
        let v4 = &mut v0.keys_vals;
        let Pair {
            key : _,
        ...
        arg0.size = arg0.size - 1;
        (0x43569b089e0dc4310de71b2b4ef141692af6daee689e7b86be54028531214a84::enum_option::some<T0>(v6), v2 - 1)
    }
