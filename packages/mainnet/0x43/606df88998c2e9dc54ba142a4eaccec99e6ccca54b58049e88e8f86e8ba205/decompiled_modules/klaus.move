module 0x43606df88998c2e9dc54ba142a4eaccec99e6ccca54b58049e88e8f86e8ba205::klaus {
    ...
    fun init(arg0: KLAUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<KLAUS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"KLAUS   ")))), trim_right(b"Klaus                           "), trim_right(b"Little Fish, Big Dream. Riding the wave into the next generation of meme tokens                                                                                                                                                                                                                                                 "), v2, arg1);
