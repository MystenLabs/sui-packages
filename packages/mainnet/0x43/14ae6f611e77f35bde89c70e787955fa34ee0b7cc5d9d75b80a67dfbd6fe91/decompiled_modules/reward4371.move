module 0x4314ae6f611e77f35bde89c70e787955fa34ee0b7cc5d9d75b80a67dfbd6fe91::reward4371 {
    struct REWARD4371 has drop {
        dummy_field: bool,
    }

    struct TICKET_4371 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4371(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4371>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4371>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4371, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4371>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4371>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4371>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4371>>(v5, 0x2::tx_context::sender(arg1));
    }
