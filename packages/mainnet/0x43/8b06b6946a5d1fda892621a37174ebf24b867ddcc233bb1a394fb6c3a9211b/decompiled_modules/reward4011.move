module 0x438b06b6946a5d1fda892621a37174ebf24b867ddcc233bb1a394fb6c3a9211b::reward4011 {
    struct REWARD4011 has drop {
        dummy_field: bool,
    }

    struct TICKET_4011 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4011(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4011>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4011>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4011, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4011>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4011>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4011>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4011>>(v5, 0x2::tx_context::sender(arg1));
    }
