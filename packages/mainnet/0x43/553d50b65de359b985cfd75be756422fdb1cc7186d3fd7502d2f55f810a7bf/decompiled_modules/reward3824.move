module 0x43553d50b65de359b985cfd75be756422fdb1cc7186d3fd7502d2f55f810a7bf::reward3824 {
    struct REWARD3824 has drop {
        dummy_field: bool,
    }

    struct TICKET_3824 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3824(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3824>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3824>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3824, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3824>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3824>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3824>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3824>>(v5, 0x2::tx_context::sender(arg1));
    }
