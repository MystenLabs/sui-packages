module 0x4368d7109d0dd8b776e48561f84762962f14ee91f8d86b035e44a91988a9d0fc::global_config {
    ...
    public(friend) fun add_sponsor_record(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<address, bool>(&v1.whitelist, v2)) {
        ...
        if (!0x2::table::contains<0x1::string::String, u64>(&v1.sponsor_fee_records, v0)) {
            ...
            let v3 = 0x2::table::borrow_mut<0x1::string::String, u64>(&mut v1.sponsor_fee_records, v0);
            if (!0x2::table::contains<address, bool>(&v1.whitelist, v2)) {
                assert!(*v3 + arg1 <= v1.epoch_sponsor_fee_limit, 3);
            };
            *v3 = *v3 + arg1;
        };
    }
    ...
    fun user_sponsor_key(arg0: &0x2::tx_context::TxContext) : 0x1::string::String {
        ...
        0x1::string::append(&mut v0, u64_to_string(0x2::tx_context::epoch(arg0)));
        v0
    }
