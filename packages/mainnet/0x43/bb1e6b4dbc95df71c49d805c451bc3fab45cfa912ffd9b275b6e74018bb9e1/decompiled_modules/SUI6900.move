module 0x43bb1e6b4dbc95df71c49d805c451bc3fab45cfa912ffd9b275b6e74018bb9e1::SUI6900 {
    ...
    fun init(arg0: SUI6900, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUI6900>(arg0, 9, b"SUI6900", b"SUI 6900", b"CoinDesc", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"ICON_URL")), arg1);
