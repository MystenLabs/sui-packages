module 0x43d3a7a314d90f28ebec42d07b48aa9cf20c00e9cbbfd4988f09a62047abb0a9::reward_distribution {
    ...
    struct CoinVault<phantom T0> has store {
        ...
        vault: 0x43d3a7a314d90f28ebec42d07b48aa9cf20c00e9cbbfd4988f09a62047abb0a9::vault::Vault<T0>,
        total_rewards: u64,
    ...
    public entry fun admin_withdraw_unclaimed_rewards<T0>(arg0: &OperatorCap, arg1: &mut RewardDistributor, arg2: u32, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x43d3a7a314d90f28ebec42d07b48aa9cf20c00e9cbbfd4988f09a62047abb0a9::vault::vault_amount<T0>(&v2.vault);
        if (v3 > 0) {
            v2.distributed_rewards = v2.distributed_rewards + v3;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x43d3a7a314d90f28ebec42d07b48aa9cf20c00e9cbbfd4988f09a62047abb0a9::vault::withdraw<T0>(&mut v2.vault, v3), arg4), arg3);
        ...
        while (v2 < 0x1::vector::length<u32>(&arg1)) {
            ...
            if (!v9) {
                if (0x1::vector::contains<0x1::string::String>(v7, &v1) && 0x2::dynamic_field::exists_with_type<CoinTypeKey<T0>, CoinVault<T0>>(&arg0.id, v8)) {
                    ...
                    let v12 = (((v11.total_rewards as u128) * (v6 as u128) / (1000000 as u128)) as u64);
                    let v13 = v12;
                    if (v12 > 0) {
                        if (v12 >= 0x43d3a7a314d90f28ebec42d07b48aa9cf20c00e9cbbfd4988f09a62047abb0a9::vault::vault_amount<T0>(&v11.vault)) {
                            v13 = 0x43d3a7a314d90f28ebec42d07b48aa9cf20c00e9cbbfd4988f09a62047abb0a9::vault::vault_amount<T0>(&v11.vault);
                        };
                        v11.distributed_rewards = v11.distributed_rewards + v13;
                        0x2::balance::join<T0>(&mut v3, 0x43d3a7a314d90f28ebec42d07b48aa9cf20c00e9cbbfd4988f09a62047abb0a9::vault::withdraw<T0>(&mut v11.vault, v13));
                ...
                let v15 = 0x2::table::borrow_mut<u32, 0x2::table::Table<address, vector<0x1::string::String>>>(&mut arg0.claimed_rewards, v4);
                if (!0x2::table::contains<address, vector<0x1::string::String>>(v15, v0)) {
                    0x2::table::add<address, vector<0x1::string::String>>(v15, v0, 0x1::vector::singleton<0x1::string::String>(v1));
                } else {
                    0x1::vector::push_back<0x1::string::String>(0x2::table::borrow_mut<address, vector<0x1::string::String>>(v15, v0), v1);
                };
            };
    ...
    public entry fun deposit_reward<T0>(arg0: &OperatorCap, arg1: &mut RewardDistributor, arg2: u32, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x1::vector::contains<0x1::string::String>(v2, &v0)) {
            let v4 = 0x43d3a7a314d90f28ebec42d07b48aa9cf20c00e9cbbfd4988f09a62047abb0a9::vault::new<T0>(arg4);
            0x43d3a7a314d90f28ebec42d07b48aa9cf20c00e9cbbfd4988f09a62047abb0a9::vault::deposit<T0>(&mut v4, 0x2::coin::into_balance<T0>(arg3));
            let v5 = CoinVault<T0>{
                coin_type           : v0,
                vault               : v4,
                total_rewards       : v1,
            ...
            0x43d3a7a314d90f28ebec42d07b48aa9cf20c00e9cbbfd4988f09a62047abb0a9::vault::deposit<T0>(&mut v6.vault, 0x2::coin::into_balance<T0>(arg3));
    ...
    public fun get_period_reward_info<T0>(arg0: &RewardDistributor, arg1: u32, arg2: 0x1::string::String) : (u64, u64, u64) {
        ...
        if (arg2 == get_coin_type_name<T0>() && 0x2::dynamic_field::exists_with_type<CoinTypeKey<T0>, CoinVault<T0>>(&arg0.id, v0)) {
            ...
            return (v1.total_rewards, v1.distributed_rewards, 0x43d3a7a314d90f28ebec42d07b48aa9cf20c00e9cbbfd4988f09a62047abb0a9::vault::vault_amount<T0>(&v1.vault))
        };
        (0, 0, 0)
    }
            ...
            if (0x2::table::contains<u32, 0x2::table::Table<address, u64>>(&arg0.period_rewards, v4)) {
                ...
                if (0x2::table::contains<address, u64>(v5, arg1)) {
                    ...
                    if (0x2::table::contains<u32, vector<0x1::string::String>>(&arg0.period_vaults, v4)) {
                        let v7 = CoinTypeKey<T0>{period: v4};
                        if (0x1::vector::contains<0x1::string::String>(0x2::table::borrow<u32, vector<0x1::string::String>>(&arg0.period_vaults, v4), &v1) && 0x2::dynamic_field::exists_with_type<CoinTypeKey<T0>, CoinVault<T0>>(&arg0.id, v7)) {
                            let v8 = false;
                            if (0x2::table::contains<u32, 0x2::table::Table<address, vector<0x1::string::String>>>(&arg0.claimed_rewards, v4)) {
                                let v9 = 0x2::table::borrow<u32, 0x2::table::Table<address, vector<0x1::string::String>>>(&arg0.claimed_rewards, v4);
                                if (0x2::table::contains<address, vector<0x1::string::String>>(v9, arg1)) {
                                    v8 = 0x1::vector::contains<0x1::string::String>(0x2::table::borrow<address, vector<0x1::string::String>>(v9, arg1), &v1);
                                };
                            };
                            if (!v8) {
                                let v10 = 0x2::dynamic_field::borrow<CoinTypeKey<T0>, CoinVault<T0>>(&arg0.id, v7);
                                let v11 = (((v10.total_rewards as u128) * (v6 as u128) / (1000000 as u128)) as u64);
                                if (v11 > 0) {
                                    let v12 = 0x43d3a7a314d90f28ebec42d07b48aa9cf20c00e9cbbfd4988f09a62047abb0a9::vault::vault_amount<T0>(&v10.vault);
                                    let v13 = if (v11 > v12) {
                                        v12
                                    } else {
                                        v11
                                    ...
                                    if (v13 > 0) {
                                        let v14 = UnclaimedReward{
                                            period    : v4,
                                            coin_type : v1,
                                            amount    : v13,
                                        };
                                        0x1::vector::push_back<UnclaimedReward>(&mut v0, v14);
                                    };
                                };
                            };
                        };
