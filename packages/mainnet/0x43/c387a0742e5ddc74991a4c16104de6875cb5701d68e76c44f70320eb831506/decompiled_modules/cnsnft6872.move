module 0x43c387a0742e5ddc74991a4c16104de6875cb5701d68e76c44f70320eb831506::cnsnft6872 {
    struct CNSNFT6872 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6872, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6872>(arg0, arg1);
