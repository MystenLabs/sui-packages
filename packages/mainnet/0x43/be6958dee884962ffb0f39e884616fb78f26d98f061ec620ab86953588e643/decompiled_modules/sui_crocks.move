module 0x43be6958dee884962ffb0f39e884616fb78f26d98f061ec620ab86953588e643::sui_crocks {
    struct SUI_CROCKS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_CROCKS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_CROCKS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sui Crocks"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Riverine Crocks"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://T_rBlmEYfel24JRqSMAPnrOliZNWr7VCz98GhM-GyWU"));
