module 0x7245087ea4ca1ddf74bff2f6a137e310312e8526b872d620e1c73544ce4e8c8c::vault {
    ...
    public fun accept_coin<T0>(arg0: &mut Vault, arg1: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg2: &0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<CoinKey<T0>>(&arg0.id, v2)) {
            0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<CoinKey<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, v2), 0x2::coin::into_balance<T0>(v0));
        } else {
            0x2::dynamic_field::add<CoinKey<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, v2, 0x2::coin::into_balance<T0>(v0));
        };
        0x7245087ea4ca1ddf74bff2f6a137e310312e8526b872d620e1c73544ce4e8c8c::events::emit_coin_deposited(0x2::object::id<Vault>(arg0), 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())), v1, 0x2::tx_context::sender(arg2));
    }
