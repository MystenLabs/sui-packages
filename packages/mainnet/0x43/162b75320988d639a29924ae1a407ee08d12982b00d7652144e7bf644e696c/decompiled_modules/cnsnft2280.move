module 0x43162b75320988d639a29924ae1a407ee08d12982b00d7652144e7bf644e696c::cnsnft2280 {
    struct CNSNFT2280 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2280, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1699"));
        let v4 = 0x2::package::claim<CNSNFT2280>(arg0, arg1);
