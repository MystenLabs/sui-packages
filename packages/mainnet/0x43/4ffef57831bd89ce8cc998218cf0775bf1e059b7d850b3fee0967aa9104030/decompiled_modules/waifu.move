module 0x434ffef57831bd89ce8cc998218cf0775bf1e059b7d850b3fee0967aa9104030::waifu {
    ...
    fun init(arg0: WAIFU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/ERvWiTsWGYgqvPY6ZmFUhwCNhDoPQ6nAhc6kKJZvbonk.png?claimId=1gGP1B9WqMNP-MIO                                                                                                                                                                                                      ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<WAIFU>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"waifu     ")))), trim_right(b"waifu                           "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
