module 0x438afc7f8e5249668f2085c4e25ff7caf1cfc0be59825c7b73015dd96219befa::reward3758 {
    struct REWARD3758 has drop {
        dummy_field: bool,
    }

    struct TICKET_3758 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3758(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3758>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3758>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3758, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3758>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3758>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3758>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3758>>(v5, 0x2::tx_context::sender(arg1));
    }
