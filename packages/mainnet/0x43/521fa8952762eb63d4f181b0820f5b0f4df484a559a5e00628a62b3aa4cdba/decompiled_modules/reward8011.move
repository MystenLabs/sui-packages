module 0x43521fa8952762eb63d4f181b0820f5b0f4df484a559a5e00628a62b3aa4cdba::reward8011 {
    struct REWARD8011 has drop {
        dummy_field: bool,
    }

    struct TICKET_8011 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8011(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8011>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8011>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8011, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8011>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8011>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8011>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8011>>(v5, 0x2::tx_context::sender(arg1));
    }
