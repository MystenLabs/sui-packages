module 0x4328d4916e3c900d690234217d72e83b9a3db82815a1dba49005681f2029a546::market {
    ...
    entry fun new(arg0: &0x2::package::Publisher, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0);
        let v0 = Market{
    ...
    entry fun withdraw(arg0: &mut Market, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg1);
        0x4328d4916e3c900d690234217d72e83b9a3db82815a1dba49005681f2029a546::utils::withdraw_balance<0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN>(&mut arg0.balance, arg2);
    }
