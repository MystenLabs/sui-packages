module 0x436b217e88eb7b612ffe4c8bed17015d90874051959aebffe6a8a5a7f07ae498::cnsnft9935 {
    struct CNSNFT9935 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9935, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5820"));
        let v4 = 0x2::package::claim<CNSNFT9935>(arg0, arg1);
