module 0x43fa47eefc9a7625c4801f5145e01a437a537c1527cbf4a48a53add4fbbfe731::cnsnft9191 {
    struct CNSNFT9191 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9191, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9191>(arg0, arg1);
