module 0x43dd951c1babbf887d74898ee92f6cc48fbdfd476f20eaa06e4150f3ad5fbce0::cnsnft3788 {
    struct CNSNFT3788 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3788, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9163"));
        let v4 = 0x2::package::claim<CNSNFT3788>(arg0, arg1);
