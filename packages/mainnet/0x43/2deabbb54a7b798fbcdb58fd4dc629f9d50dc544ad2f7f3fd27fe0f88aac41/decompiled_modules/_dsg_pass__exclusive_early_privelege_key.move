module 0x432deabbb54a7b798fbcdb58fd4dc629f9d50dc544ad2f7f3fd27fe0f88aac41::_dsg_pass__exclusive_early_privelege_key {
    struct _DSG_PASS__EXCLUSIVE_EARLY_PRIVELEGE_KEY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _DSG_PASS__EXCLUSIVE_EARLY_PRIVELEGE_KEY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_DSG_PASS__EXCLUSIVE_EARLY_PRIVELEGE_KEY>(arg0, arg1);
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeia7rnp4y2cesl6gb5ejj3vfgcbots27gt652xbonprp52u4uizboy"));
