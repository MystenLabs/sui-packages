module 0x43178827980134ebd803e63bf8cf07c06017b18383e4c2f6e761d9188861e8cb::tale01 {
    ...
    fun init(arg0: TALE01, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"website"), 0x1::string::utf8(b"https://voxxinc.xyz"));
        ...
        let v7 = v6;
        let v8 = v5;
        0x43178827980134ebd803e63bf8cf07c06017b18383e4c2f6e761d9188861e8cb::tale01_royalty::add<Nft>(&mut v8, &v7, 3000, v3, 0);
    ...
    public entry fun update_config(arg0: &AdminCap, arg1: &mut MintConfig, arg2: &mut 0x2::transfer_policy::TransferPolicy<Nft>, arg3: &0x2::transfer_policy::TransferPolicyCap<Nft>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u16, arg9: address, arg10: u64) {
        ...
        let v0 = if (arg1.royalty_bps != arg8) {
            ...
            0x43178827980134ebd803e63bf8cf07c06017b18383e4c2f6e761d9188861e8cb::tale01_royalty::min_amount(0x43178827980134ebd803e63bf8cf07c06017b18383e4c2f6e761d9188861e8cb::tale01_royalty::get_config<Nft>(arg2)) != arg10
        };
        if (v0) {
            0x43178827980134ebd803e63bf8cf07c06017b18383e4c2f6e761d9188861e8cb::tale01_royalty::update<Nft>(arg2, arg3, arg8, arg9, arg10);
            arg1.royalty_bps = arg8;
            arg1.recipient = arg9;
        };
    }

    public entry fun update_display(arg0: &mut 0x2::display::Display<Nft>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>) {
        ...
        0x2::display::edit<Nft>(arg0, 0x1::string::utf8(b"discord"), 0x1::string::utf8(arg5));
        0x2::display::edit<Nft>(arg0, 0x1::string::utf8(b"twitter"), 0x1::string::utf8(arg6));
        0x2::display::edit<Nft>(arg0, 0x1::string::utf8(b"website"), 0x1::string::utf8(arg7));
