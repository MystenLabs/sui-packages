module 0x430a372d63b975a8b65a2eabf1634c45aeafecf12a486d04f22fd11a4260dc21::cnsnft3307 {
    struct CNSNFT3307 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3307, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3307>(arg0, arg1);
