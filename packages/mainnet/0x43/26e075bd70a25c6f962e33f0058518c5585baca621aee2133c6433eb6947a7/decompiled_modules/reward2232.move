module 0x4326e075bd70a25c6f962e33f0058518c5585baca621aee2133c6433eb6947a7::reward2232 {
    struct REWARD2232 has drop {
        dummy_field: bool,
    }

    struct TICKET_2232 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2232(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2232>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2232>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2232, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2232>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2232>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2232>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2232>>(v5, 0x2::tx_context::sender(arg1));
    }
