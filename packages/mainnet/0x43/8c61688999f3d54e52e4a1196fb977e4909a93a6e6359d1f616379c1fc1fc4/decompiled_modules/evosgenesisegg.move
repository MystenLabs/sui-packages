module 0x438c61688999f3d54e52e4a1196fb977e4909a93a6e6359d1f616379c1fc1fc4::evosgenesisegg {
    ...
    public entry fun presale_mint(arg0: &MintTrackerCap, arg1: &mut MintTracker, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.index + arg2 <= 6000, 0);
        let v0 = 0;
        while (arg2 > v0) {
            let v1 = create_nft(arg1, arg3);
            ...
            0x2::transfer::public_transfer<EvosGenesisEgg>(v1, 0x2::tx_context::sender(arg3));
            v0 = v0 + 1;
        };
    }

    public entry fun public_mint(arg0: &mut MintTracker, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 1;
        assert!(arg0.index + v0 <= 6000 + 1, 0);
        assert!(arg0.public_start <= 0x2::clock::timestamp_ms(arg2), 11);
        let v1 = arg0.sui_full_price * v0;
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= v1, 3);
        let v2 = 0;
        while (v0 > v2) {
            let v3 = create_nft(arg0, arg3);
            let v4 = Witness{dummy_field: false};
            0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_event::emit_mint<EvosGenesisEgg>(0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::from_witness<EvosGenesisEgg, Witness>(v4), 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::collection_id<EvosGenesisEgg>(&arg0.mint_cap), &v3);
            0x2::transfer::public_transfer<EvosGenesisEgg>(v3, 0x2::tx_context::sender(arg3));
            v2 = v2 + 1;
        };
        0x2::coin::put<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::take<0x2::sui::SUI>(0x2::coin::balance_mut<0x2::sui::SUI>(&mut arg1), arg0.sui_full_price, arg3));
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) == 0x2::balance::value<0x2::sui::SUI>(&arg0.balance) + v1, 8);
