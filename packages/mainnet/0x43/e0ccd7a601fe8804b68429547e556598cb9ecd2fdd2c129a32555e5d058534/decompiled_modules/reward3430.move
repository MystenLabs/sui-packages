module 0x43e0ccd7a601fe8804b68429547e556598cb9ecd2fdd2c129a32555e5d058534::reward3430 {
    struct REWARD3430 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward3430(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD3430, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3430>(arg0, arg1);
