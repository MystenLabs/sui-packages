module 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::core {
    ...
    public fun add_liquidity<T0, T1, T2>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T2>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LPCoin<T0, T1, T2>> {
        assert!(0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::curve::is_curve<T0>(), 14);
        ...
        let v10 = 0x2::math::min(0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::math::mul_div(v0, v7, v5), 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::math::mul_div(v1, v7, v6));
        assert!(v10 >= arg4, 5);
    ...
    fun borrow_mut_pool<T0, T1, T2>(arg0: &mut DEXStorage) : &mut Pool<T0, T1, T2> {
        0x2::object_bag::borrow_mut<0x1::ascii::String, Pool<T0, T1, T2>>(&mut arg0.pools, 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::get_coin_info_string<LPCoin<T0, T1, T2>>())
    }

    public fun borrow_pool<T0, T1, T2>(arg0: &DEXStorage) : &Pool<T0, T1, T2> {
        0x2::object_bag::borrow<0x1::ascii::String, Pool<T0, T1, T2>>(&arg0.pools, 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::get_coin_info_string<LPCoin<T0, T1, T2>>())
    }
    ...
    fun calculate_optimal_add_liquidity(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : (u64, u64) {
        ...
        let v0 = 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::quote_liquidity(arg0, arg2, arg3);
        if (arg1 >= v0) {
            return (arg0, v0)
        };
        (0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::quote_liquidity(arg1, arg3, arg2), arg1)
    }

    public fun calculate_s_value_out<T0, T1, T2>(arg0: &Pool<T0, T1, T2>, arg1: u64, arg2: u64, arg3: u64, arg4: bool) : u64 {
        assert!(!0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::curve::is_volatile<T0>(), 14);
        let v0 = (arg1 as u256);
        ...
        let v6 = if (arg4) {
            v4 - y((v0 - v0 * 500000000000000 / 1000000000000000000) * 1000000000000000000 / v5 + v3, k<0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::curve::Stable>(arg2, arg3, arg0.decimals_x, arg0.decimals_y), v4)
        } else {
            v3 - y((v0 - v0 * 500000000000000 / 1000000000000000000) * 1000000000000000000 / v5 + v4, k<0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::curve::Stable>(arg2, arg3, arg0.decimals_x, arg0.decimals_y), v3)
        };
        let v7 = if (arg4) {
            v2
        } else {
    ...
    fun create_pool<T0, T1, T2>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T2>, arg4: u64, arg5: u64, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LPCoin<T0, T1, T2>> {
        ...
        let v1 = 0x2::coin::value<T2>(&arg3);
        assert!(v0 != 0 && v1 != 0, 1);
        assert!(0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::are_coins_sorted<T1, T2>(), 4);
        let v2 = 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::get_coin_info_string<LPCoin<T0, T1, T2>>();
        assert!(!0x2::object_bag::contains<0x1::ascii::String>(&arg0.pools, v2), 2);
        let v3 = (0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::math::sqrt_u256(0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::math::sqrt_u256((v0 as u256) * (v1 as u256))) as u64);
        ...
        let v7 = PoolCreated<Pool<0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::curve::Volatile, T1, T2>>{
        ...
        0x2::event::emit<PoolCreated<Pool<0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::curve::Volatile, T1, T2>>>(v7);
        ...
        let v9 = Pool<T0, T1, T2>{
            ...
            timestamp_last            : v8,
            balance_x_cumulative_last : 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::calculate_cumulative_balance((v0 as u256), v8, 0),
            balance_y_cumulative_last : 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::calculate_cumulative_balance((v1 as u256), v8, 0),
            locked                    : false,
        };
    ...
    public fun create_s_pool<T0, T1>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LPCoin<0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::curve::Stable, T0, T1>> {
        create_pool<0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::curve::Stable, T0, T1>(arg0, arg1, arg2, arg3, 0x2::math::pow(10, 0x2::coin::get_decimals<T0>(arg4)), 0x2::math::pow(10, 0x2::coin::get_decimals<T1>(arg5)), true, arg6)
    }

    public fun create_v_pool<T0, T1>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LPCoin<0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::curve::Volatile, T0, T1>> {
        create_pool<0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::curve::Volatile, T0, T1>(arg0, arg1, arg2, arg3, 0, 0, false, arg4)
    }
    ...
    public fun get_coin_x_price<T0, T1, T2>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: u64) : u64 {
        ...
        let v6 = if (v4 > v0.balance_x_cumulative_last) {
            v0.balance_x_cumulative_last + 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::max_u_128() - v4
        } else {
            v0.balance_x_cumulative_last - v4
        };
        let v7 = if (v5 > v0.balance_y_cumulative_last) {
            v0.balance_y_cumulative_last + 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::max_u_128() - v5
        } else {
            v0.balance_y_cumulative_last - v5
        };
        if (0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::curve::is_volatile<T0>()) {
    ...
    public fun is_pool_deployed<T0, T1, T2>(arg0: &DEXStorage) : bool {
        0x2::object_bag::contains<0x1::ascii::String>(&arg0.pools, 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::get_coin_info_string<LPCoin<T0, T1, T2>>())
    }
    ...
    fun mint_fee<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : bool {
        ...
        if (v0) {
            if (arg0.k_last != 0) {
                let v1 = 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::math::sqrt_u256(k<T0>(0x2::balance::value<T1>(&arg0.balance_x), 0x2::balance::value<T2>(&arg0.balance_y), arg0.decimals_x, arg0.decimals_y));
                let v2 = 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::math::sqrt_u256(arg0.k_last);
                if (v1 > v2) {
    ...
    public fun remove_liquidity<T0, T1, T2>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<LPCoin<T0, T1, T2>>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::coin::Coin<T2>) {
        ...
        let v7 = 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::math::mul_div(v0, v4, v6);
        let v8 = 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::math::mul_div(v0, v5, v6);
        assert!(v7 >= arg3, 8);
        assert!(v8 >= arg4, 9);
    ...
    public fun swap_token_x<T0, T1, T2>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        let v7 = if (0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::curve::is_volatile<T0>()) {
    ...
    fun sync_obervations<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: &0x2::clock::Clock) {
        ...
        let v1 = 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::calculate_cumulative_balance((0x2::balance::value<T1>(&arg0.balance_x) as u256), v0, arg0.balance_x_cumulative_last);
        let v2 = 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils::calculate_cumulative_balance((0x2::balance::value<T2>(&arg0.balance_y) as u256), v0, arg0.balance_y_cumulative_last);
