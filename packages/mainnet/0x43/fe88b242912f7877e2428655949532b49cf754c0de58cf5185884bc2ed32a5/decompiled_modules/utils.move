module 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::utils {
    ...
    fun compare_struct<T0, T1>() : u8 {
        ...
        let v2 = 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::comparator::compare_u8_vector(v0, v1);
        if (0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::comparator::is_greater_than(&v2)) {
            2
        } else {
            let v4 = 0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::comparator::compare_u8_vector(v0, v1);
            if (0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::comparator::is_equal(&v4)) {
                0
            } else {
                1
            }
    ...
    public fun quote_liquidity(arg0: u64, arg1: u64, arg2: u64) : u64 {
        0x43fe88b242912f7877e2428655949532b49cf754c0de58cf5185884bc2ed32a5::math::mul_div(arg0, arg2, arg1)
    }
