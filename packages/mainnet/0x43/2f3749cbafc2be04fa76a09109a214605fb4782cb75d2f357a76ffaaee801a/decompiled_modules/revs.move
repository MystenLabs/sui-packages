module 0x432f3749cbafc2be04fa76a09109a214605fb4782cb75d2f357a76ffaaee801a::revs {
    ...
    fun init(arg0: REVS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<REVS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"REVS        ")))), trim_right(b"REVSHARE                        "), trim_right(b"Launch your token, set up automatic rewards distribution, and get a professional landing page - all in one platform. No coding required. Start building your community today.                                                                                                                                                   "), v2, arg1);
