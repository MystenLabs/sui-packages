module 0x432d7accc291f2507e9fc038275de349586898900b62dfd4acd11940c81664ca::cnsnft3973 {
    struct CNSNFT3973 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3973, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3973>(arg0, arg1);
