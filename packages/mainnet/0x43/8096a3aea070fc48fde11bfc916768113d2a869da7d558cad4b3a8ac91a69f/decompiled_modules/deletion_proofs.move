module 0x8ed5834faad055067328dd44577e5fb7a6c6c61299483616061e642c465eda47::deletion_proofs {
    ...
    public entry fun authorize_verifier(arg0: &VerifierCap, arg1: &mut ProofRegistry, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun check_expiry(arg0: &mut ProofRegistry, arg1: &DeletionReceipt, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun revoke_verifier(arg0: &VerifierCap, arg1: &mut ProofRegistry, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun submit_deletion_receipt(arg0: &VerifierCap, arg1: &mut ProofRegistry, arg2: 0x2::object::ID, arg3: address, arg4: 0x1::string::String, arg5: vector<u8>, arg6: vector<u8>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun verify_receipt(arg0: &mut ProofRegistry, arg1: &mut DeletionReceipt, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch(arg2);
