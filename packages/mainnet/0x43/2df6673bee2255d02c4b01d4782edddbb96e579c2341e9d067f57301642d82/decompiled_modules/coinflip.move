module 0x432df6673bee2255d02c4b01d4782edddbb96e579c2341e9d067f57301642d82::coinflip {
    ...
    public fun join(arg0: &mut HouseData, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x1::string::String, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v0 / 100 * 18;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v4, arg0.vx, arg5);
        let v5 = v0 / 100 * 3;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v5, arg0.node, arg5);
        let v6 = v0 / 100 * 8;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v6, arg0.fund, arg5);
        let v7 = v0 / 100;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v7, arg0.insurance, arg5);
        let v8 = v0 / 100 * 5;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v8, arg0.operation, arg5);
        let v9 = v0 / 100 * 5;
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v9, arg0.ecosys, arg5);
        if (arg0.bank == @0x0) {
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::into_balance<0x2::sui::SUI>(v1));
        } else {
            0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut v1, v0 - v2 - v4 - v5 - v6 - v7 - v8 - v9, arg0.bank, arg5);
            0x2::coin::destroy_zero<0x2::sui::SUI>(v1);
        };
        arg0.round_balance = arg0.round_balance + v0;
        let v10 = get_mut_account(arg0, 0x2::tx_context::sender(arg5));
        v10.contributed = v10.contributed + v0;
        let v11 = JoinGame{
            round         : arg0.round,
    ...
    public fun update_addresses(arg0: &mut HouseData, arg1: address, arg2: address, arg3: address, arg4: address, arg5: address, arg6: address, arg7: address, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg9) == admin(arg0), 1);
        arg0.bank = arg1;
