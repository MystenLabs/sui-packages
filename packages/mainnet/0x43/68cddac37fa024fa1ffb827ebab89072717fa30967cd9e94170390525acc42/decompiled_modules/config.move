module 0x8786f3c78ff986d2439e3bd870b2178f1796a3c232a3f30e9a169d50ff4706d8::config {
    ...
    public fun update_total_protocol_fee_bps(arg0: &0x8786f3c78ff986d2439e3bd870b2178f1796a3c232a3f30e9a169d50ff4706d8::admin::AdminCap, arg1: &mut Config, arg2: u128) {
        assert_interacting_with_most_up_to_date_package(arg1);
        assert!(arg2 <= 1000, 9223372784179478535);
        arg1.total_protocol_fee_bps = arg2;
    }

    public fun update_treasury_fee_bps(arg0: &0x8786f3c78ff986d2439e3bd870b2178f1796a3c232a3f30e9a169d50ff4706d8::admin::AdminCap, arg1: &mut Config, arg2: u128) {
        assert_interacting_with_most_up_to_date_package(arg1);
