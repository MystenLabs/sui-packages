module 0x4377dfec55e7997ab5b00cb48e3382d9381ef7828fbd1196500964ce16046a71::cnsnft7194 {
    struct CNSNFT7194 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7194, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8971"));
        let v4 = 0x2::package::claim<CNSNFT7194>(arg0, arg1);
