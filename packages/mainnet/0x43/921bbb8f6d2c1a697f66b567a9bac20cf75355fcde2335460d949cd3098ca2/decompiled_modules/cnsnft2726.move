module 0x43921bbb8f6d2c1a697f66b567a9bac20cf75355fcde2335460d949cd3098ca2::cnsnft2726 {
    struct CNSNFT2726 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2726, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9453"));
        let v4 = 0x2::package::claim<CNSNFT2726>(arg0, arg1);
