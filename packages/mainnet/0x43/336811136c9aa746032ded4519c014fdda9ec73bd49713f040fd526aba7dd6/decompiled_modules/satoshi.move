module 0x43336811136c9aa746032ded4519c014fdda9ec73bd49713f040fd526aba7dd6::satoshi {
    struct SATOSHI has drop {
        dummy_field: bool,
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<SATOSHI>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<SATOSHI>>(0x2::coin::mint<SATOSHI>(arg0, arg1, arg3), arg2);
    }
    ...
    fun init(arg0: SATOSHI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<SATOSHI>>(0x2::coin::mint<SATOSHI>(&mut v5, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
