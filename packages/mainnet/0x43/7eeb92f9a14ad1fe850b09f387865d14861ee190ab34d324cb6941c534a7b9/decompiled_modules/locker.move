module 0x437eeb92f9a14ad1fe850b09f387865d14861ee190ab34d324cb6941c534a7b9::locker {
    ...
    struct LockerContents has store, key {
        id: 0x2::object::UID,
        bag: 0x437eeb92f9a14ad1fe850b09f387865d14861ee190ab34d324cb6941c534a7b9::object_bag::ObjectBag,
        creator: address,
        unlocker: 0x1::option::Option<address>,
    }
    ...
    public fun add_coin<T0>(arg0: &mut Locker, arg1: vector<u8>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::tx_context::TxContext) {
        ...
        0x437eeb92f9a14ad1fe850b09f387865d14861ee190ab34d324cb6941c534a7b9::object_bag::add<0x2::coin::Coin<T0>>(&mut v0.bag, 0x437eeb92f9a14ad1fe850b09f387865d14861ee190ab34d324cb6941c534a7b9::object_bag::length(&v0.bag), arg2);
    }
    ...
    public fun add_object<T0: store + key>(arg0: &mut Locker, arg1: vector<u8>, arg2: T0, arg3: &0x2::tx_context::TxContext) {
        ...
        0x437eeb92f9a14ad1fe850b09f387865d14861ee190ab34d324cb6941c534a7b9::object_bag::add<T0>(&mut v0.bag, 0x437eeb92f9a14ad1fe850b09f387865d14861ee190ab34d324cb6941c534a7b9::object_bag::length(&v0.bag), arg2);
    }
    ...
    public fun create_locker_contents(arg0: &mut Locker, arg1: address, arg2: 0x1::option::Option<address>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = LockerContents{
            ...
            bag      : 0x437eeb92f9a14ad1fe850b09f387865d14861ee190ab34d324cb6941c534a7b9::object_bag::new(arg4),
            creator  : arg1,
            unlocker : arg2,
        };
    ...
    public fun delete_locker_contents(arg0: &mut Locker, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x437eeb92f9a14ad1fe850b09f387865d14861ee190ab34d324cb6941c534a7b9::object_bag::destroy_empty(v1);
    ...
    public fun remove_coin<T0>(arg0: &mut Locker, arg1: vector<u8>, arg2: u64, arg3: &0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = 0x437eeb92f9a14ad1fe850b09f387865d14861ee190ab34d324cb6941c534a7b9::object_bag::remove<0x2::coin::Coin<T0>>(&mut v0.bag, arg2);
        let v2 = RemoveCoin{
            public_key        : arg1,
            lockerContents_id : 0x2::object::id<LockerContents>(v0),
            coin_type         : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
    ...
    public fun remove_object<T0: store + key>(arg0: &mut Locker, arg1: vector<u8>, arg2: u64, arg3: &0x2::tx_context::TxContext) : T0 {
        ...
        0x437eeb92f9a14ad1fe850b09f387865d14861ee190ab34d324cb6941c534a7b9::object_bag::remove<T0>(&mut v0.bag, arg2)
    }
