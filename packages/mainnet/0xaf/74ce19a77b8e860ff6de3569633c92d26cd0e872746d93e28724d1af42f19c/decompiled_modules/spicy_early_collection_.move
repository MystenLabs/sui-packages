module 0xaf74ce19a77b8e860ff6de3569633c92d26cd0e872746d93e28724d1af42f19c::spicy_early_collection_ {
    struct SPICY_EARLY_COLLECTION_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SPICY_EARLY_COLLECTION_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SPICY_EARLY_COLLECTION_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Spicy Early collection "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The unique collection for Spicy Early Supporter."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiek2cajfwhocsnqsdcrsk7as4mfoyaapfymt6t73n6325bak6cjj4"));
