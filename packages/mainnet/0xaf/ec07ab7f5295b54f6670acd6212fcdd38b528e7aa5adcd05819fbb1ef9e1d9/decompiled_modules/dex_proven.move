module 0xafec07ab7f5295b54f6670acd6212fcdd38b528e7aa5adcd05819fbb1ef9e1d9::dex_proven {
    ...
    public fun get_proven_package() : address {
        0xafec07ab7f5295b54f6670acd6212fcdd38b528e7aa5adcd05819fbb1ef9e1d9::constants::proven_swap_package()
    }

    public fun get_proven_sui_usdc_pools() : vector<address> {
        let v0 = 0x1::vector::empty<address>();
        0x1::vector::push_back<address>(&mut v0, 0xafec07ab7f5295b54f6670acd6212fcdd38b528e7aa5adcd05819fbb1ef9e1d9::constants::proven_sui_usdc_pool());
        v0
    }
    ...
    public entry fun swap_sui_to_usdc_real(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = ProvenSwapExecuted{
            ...
            package        : 0xafec07ab7f5295b54f6670acd6212fcdd38b528e7aa5adcd05819fbb1ef9e1d9::constants::proven_swap_package(),
