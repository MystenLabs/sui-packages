module 0x41e1771682029b727adeded87f54be24e86b96fb122290be88fd41135644fac6::account {
    ...
    public fun add_accolade_v2(arg0: &mut SystemV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: address, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    fun assert_check_ac(arg0: &SystemV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl) {
        ...
        assert!(arg0.ac == 0x2::object::id_to_address(&v0), 1);
    }
    ...
    public fun assert_no_avatar_v2(arg0: &SystemV2, arg1: address) {
    ...
    public fun give_reputation_v2(arg0: &mut SystemV2, arg1: &Account, arg2: address, arg3: 0x1::string::String, arg4: u64, arg5: bool, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = Reputation{
            type        : arg3,
            value       : arg4,
            positive    : arg5,
    ...
    public fun migrate(arg0: System, arg1: &mut 0x2::tx_context::TxContext) {
        let System {
            id         : v0,
            accounts   : v1,
            accolades  : v2,
        ...
        let v4 = SystemV2{
            ...
            accolades  : v2,
            reputation : v3,
            ac         : @0xf621bd4ad2f35c9005d76c267d05d0067ab50f28c2bf0a54c58aa3c82468fed6,
        };
        0x2::transfer::share_object<SystemV2>(v4);
    }

    public fun new_v2(arg0: &mut SystemV2, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Account {
        assert_no_avatar_v2(arg0, 0x2::tx_context::sender(arg4));
        let v0 = Account{
    ...
    public fun remove_accolade_v2(arg0: &mut SystemV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: address, arg4: u64) {
        assert_check_ac(arg0, arg1);
        0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::admin::assert_accolades_role(arg1, arg2);
    ...
    public fun remove_reputation_v2(arg0: &mut SystemV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: address, arg4: u64) {
        assert_check_ac(arg0, arg1);
