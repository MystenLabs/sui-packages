module 0xaf8312099e7fb724fa2cf07bb2b67d8bc663ede644bfb4c03dfc8aca99108b41::doodle {
    ...
    fun init(arg0: DOODLE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DOODLE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"DOODLE"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is not official doodle nft. This NFT created for fun."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreif7sbfygulo444jzz7kqst5s77xgmwfruvrvyuf5wx6pquznrwuf4"));
