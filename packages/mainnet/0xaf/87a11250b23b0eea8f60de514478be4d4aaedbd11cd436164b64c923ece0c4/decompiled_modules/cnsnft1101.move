module 0xaf87a11250b23b0eea8f60de514478be4d4aaedbd11cd436164b64c923ece0c4::cnsnft1101 {
    struct CNSNFT1101 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1101, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1101>(arg0, arg1);
