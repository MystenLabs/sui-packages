module 0xaf4ea2c16d2a4792129706649b1c39e46877c15dfb785ececc898b31bf872bbb::aura {
    struct AURA has drop {
        dummy_field: bool,
    }

    fun init(arg0: AURA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AURA>(arg0, 6, b"AURA", b"Aura on Sui", x"497427732048617070656e0a0a2441555241206973206c697665206f6e205355490a0a4a75737420415552412e", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/bafybeiejiai6uxubqgiqgtcxps5edon2qbul2y3ddi42dyg3ackjcxxshq")), arg1);
