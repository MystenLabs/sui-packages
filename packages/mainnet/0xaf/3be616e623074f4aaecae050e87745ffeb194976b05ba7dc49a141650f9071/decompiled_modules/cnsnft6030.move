module 0xaf3be616e623074f4aaecae050e87745ffeb194976b05ba7dc49a141650f9071::cnsnft6030 {
    struct CNSNFT6030 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6030, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6030>(arg0, arg1);
