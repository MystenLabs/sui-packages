module 0xaf9da297f88e0ef3156c2d3cbab9f4f3a8cdb96735a734e47b3070718df7ddc5::gift3144 {
    struct GIFT3144 has drop {
        dummy_field: bool,
    }

    struct TICKET_3144 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3144(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3144>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3144>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3144, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3144>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3144>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3144>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3144>>(v5, 0x2::tx_context::sender(arg1));
    }
