module 0xafbbaa9872dda3259af04de442daac1b138769599c0b89311da4334b427999b0::burnpepe {
    ...
    fun init(arg0: BURNPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BURNPEPE>(arg0, 9, b"BURNPEPE", b"Burn Pepe", b"Burn pepe will launch today at 12PM UTC, join our channel https://t.me/burnpepeSUI", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/8gZC5e1.jpg")), arg1);
        let v2 = v0;
