module 0xaf513d6de340245b522bf362a6fc12ab06af4e86b66149210651e5f5432d896b::cnsnft6172 {
    struct CNSNFT6172 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6172, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6172>(arg0, arg1);
