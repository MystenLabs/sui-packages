module 0xaffd628c1cb43666c85c559026fd2edce5c971d3562f8ab2764e8d365eb60317::state {
    ...
    public(friend) fun has_order(arg0: &State, arg1: address) : bool {
        0x2::table::contains<address, SourceOrder>(&arg0.source_order_registry, arg1) || 0x2::table::contains<address, DestOrder>(&arg0.dest_order_registry, arg1)
    }
    ...
    public(friend) fun refund_source_order<T0>(arg0: &mut State, arg1: LockedFunds<T0>, arg2: address, arg3: address, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v3 = v2;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v3, 0xaffd628c1cb43666c85c559026fd2edce5c971d3562f8ab2764e8d365eb60317::amount::denormalize_amount(v0.fee_cancel, arg4)), arg5), arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v3, arg5), v0.trader);
        0x2::object::delete(v1);
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v3, 0xaffd628c1cb43666c85c559026fd2edce5c971d3562f8ab2764e8d365eb60317::amount::denormalize_amount(v0.fee_refund, arg4)), arg5)
    }
