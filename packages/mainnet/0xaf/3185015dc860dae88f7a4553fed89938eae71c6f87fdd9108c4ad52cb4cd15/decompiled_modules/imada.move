module 0xaf3185015dc860dae88f7a4553fed89938eae71c6f87fdd9108c4ad52cb4cd15::imada {
    ...
    fun init(arg0: IMADA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<IMADA>(arg0, 9, b"imada", b"IMADA", b"test token", 0x1::option::none<0x2::url::Url>(), arg1);
