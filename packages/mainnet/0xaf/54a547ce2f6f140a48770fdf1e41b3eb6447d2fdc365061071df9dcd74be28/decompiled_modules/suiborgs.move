module 0xaf54a547ce2f6f140a48770fdf1e41b3eb6447d2fdc365061071df9dcd74be28::suiborgs {
    ...
    fun init(arg0: SUIBORGS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Aaaa"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreif752ndqyfz7ad62plyo26g44ruc32mebv646ulpir6aszn26mvga"));
