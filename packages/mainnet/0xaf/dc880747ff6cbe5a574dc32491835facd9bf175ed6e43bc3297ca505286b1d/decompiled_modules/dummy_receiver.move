module 0xafdc880747ff6cbe5a574dc32491835facd9bf175ed6e43bc3297ca505286b1d::dummy_receiver {
    ...
    struct AlwaysAbortToggled has copy, drop {
        always_abort: bool,
    }
    ...
    public fun disable_always_abort(arg0: &mut CCIPReceiverState) {
        set_always_abort(arg0, false);
    }

    public fun enable_always_abort(arg0: &mut CCIPReceiverState) {
        set_always_abort(arg0, true);
    }

    public fun get_always_abort(arg0: &CCIPReceiverState) : bool {
        arg0.always_abort
    }
    ...
    public fun set_always_abort(arg0: &mut CCIPReceiverState, arg1: bool) {
        arg0.always_abort = arg1;
        let v0 = AlwaysAbortToggled{always_abort: arg1};
        0x2::event::emit<AlwaysAbortToggled>(v0);
    }
