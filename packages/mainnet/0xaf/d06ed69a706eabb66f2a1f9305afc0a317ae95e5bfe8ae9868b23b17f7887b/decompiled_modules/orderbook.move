module 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::orderbook {
    ...
    struct Orderbook has store, key {
        id: 0x2::object::UID,
        next_order_id: u64,
        open_orders: 0x2::table::Table<u64, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order>,
    ...
    public fun cancel_order<T0>(arg0: &mut Orderbook, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(&v1 == 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::maker_asset(&v0), 7);
        let v2 = 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::remaining_amount(&v0);
        0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::destroy(v0);
        let v3 = OrderCanceled{
            order_id         : 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::order_id(&v0),
            remaining_amount : v2,
    ...
    public fun check_order_exists(arg0: &Orderbook, arg1: u64) {
        assert!(0x2::table::contains<u64, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order>(&arg0.open_orders, arg1), 2);
    }
    ...
    public fun fill_order<T0>(arg0: &mut Orderbook, arg1: TakeOrderReceipt, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<T0>(&arg2) >= v3, 0);
        let v4 = &mut arg2;
        let v5 = pay_fee_if_necessary<T0>(arg0, v4, arg3);
        let v6 = 0x2::table::borrow_mut<u64, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order>(&mut arg0.open_orders, v0);
        let v7 = 0x1::type_name::get<T0>();
        assert!(&v7 == 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::taker_asset(v6), 8);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::recipient(v6));
        let v8 = OrderFilled{
            order_id         : 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::order_id(v6),
            taker            : v1,
            filling_amount   : v2,
            remaining_amount : 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::remaining_amount(v6),
            taking_amount    : 0x2::coin::value<T0>(&arg2),
            fee_amount       : v5,
        };
        0x2::event::emit<OrderFilled>(v8);
        if (0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::remaining_amount(v6) == 0) {
            0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::destroy(remove_order(arg0, v0, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::maker(v6)));
        };
    }

    public fun get_order(arg0: &Orderbook, arg1: u64) : &0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order {
        check_order_exists(arg0, arg1);
        0x2::table::borrow<u64, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order>(&arg0.open_orders, arg1)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Orderbook{
            ...
            next_order_id    : 1,
            open_orders      : 0x2::table::new<u64, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order>(arg0),
    ...
    fun inject_order(arg0: &mut Orderbook, arg1: 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::order_id(&arg1);
        0x2::table::add<u64, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order>(&mut arg0.open_orders, v0, arg1);
    ...
    public fun order_exists(arg0: &Orderbook, arg1: u64) : bool {
        0x2::table::contains<u64, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order>(&arg0.open_orders, arg1)
    }
    ...
    fun pay_fee_if_necessary<T0>(arg0: &mut Orderbook, arg1: &mut 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (arg0.protocol_fee.fee_rate > 0) {
            let v1 = 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::math::mul_div(arg0.protocol_fee.fee_rate, 0x2::coin::value<T0>(arg1), 1000000, false);
            v0 = v1;
    ...
    public fun place_order<T0, T1>(arg0: &mut Orderbook, arg1: u64, arg2: 0x1::option::Option<address>, arg3: 0x1::option::Option<address>, arg4: u64, arg5: u64, arg6: bool, arg7: 0x2::coin::Coin<T0>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        inject_order(arg0, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::new<T0, T1>(v3, arg1, v1, v2, arg3, v0, arg4, arg5, arg6), v1, arg9);
    ...
    fun remove_order(arg0: &mut Orderbook, arg1: u64, arg2: address) : 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order {
        ...
        let v0 = 0x2::table::remove<u64, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order>(&mut arg0.open_orders, arg1);
        assert!(0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::maker(&v0) == arg2, 3);
        v0
    }
    ...
    public fun size(arg0: &Orderbook) : u64 {
        0x2::table::length<u64, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order>(&arg0.open_orders)
    }
    ...
    public fun take_order<T0>(arg0: &mut Orderbook, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, TakeOrderReceipt) {
        ...
        let v1 = 0x2::table::borrow_mut<u64, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::Order>(&mut arg0.open_orders, arg1);
        let v2 = 0x1::type_name::get<T0>();
        assert!(&v2 == 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::maker_asset(v1), 7);
        assert!(!0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::is_expired(v1, arg3), 4);
        assert!(0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::is_allowed_taker(v1, v0), 6);
        assert!(arg2 == 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::remaining_amount(v1) || arg2 < 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::remaining_amount(v1) && 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::is_allowed_partial_fills(v1), 0);
        let v3 = 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::math::mul_div(arg2, 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::taking_amount(v1), 0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::making_amount(v1), true);
        assert!(v3 > 0, 0);
        0xafd06ed69a706eabb66f2a1f9305afc0a317ae95e5bfe8ae9868b23b17f7887b::order::remains(v1, arg2);
