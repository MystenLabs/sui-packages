module 0xaf95e111a00feae35e8e207f58a76677c27305a46620c5b22b32cb2eca9e1143::eval {
    ...
    public fun best_of_seven(arg0: &vector<u8>) : HandRank {
        assert!(0x1::vector::length<u8>(arg0) == 7, 13906834423451484159);
        let v0 = 0;
        while (v0 < 7) {
            assert!(*0x1::vector::borrow<u8>(arg0, v0) < 52, 1);
            v0 = v0 + 1;
        };
        let v1 = HandRank{
            class  : 0,
    ...
    public fun evaluate_five(arg0: &vector<u8>) : HandRank {
        assert!(0x1::vector::length<u8>(arg0) == 5, 13906834569480372223);
        ...
        while (v3 < 5) {
            ...
            assert!(v4 < 52, 1);
            let v5 = 0xaf95e111a00feae35e8e207f58a76677c27305a46620c5b22b32cb2eca9e1143::types::card_rank(v4);
            0x1::vector::push_back<u8>(&mut v1, v5);
            0x1::vector::push_back<u8>(&mut v2, 0xaf95e111a00feae35e8e207f58a76677c27305a46620c5b22b32cb2eca9e1143::types::card_suit(v4));
