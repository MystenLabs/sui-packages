module 0xaf57dc4bda93e2a606188ede73b324c24ae0953ff98e91858ba636badcd47aba::swap_math {
    fun cross_ticks<T0, T1>(arg0: &mut 0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::SwapState, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg2: bool) {
        loop {
            let (v0, _) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_bitmap::next_initialized_tick_within_one_word(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::bitmap(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_tick_manager<T0, T1>(arg1)), 0xaf57dc4bda93e2a606188ede73b324c24ae0953ff98e91858ba636badcd47aba::i32_utils::lib_to_mate(0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::tick(arg0)), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_tick_spacing<T0, T1>(arg1), arg2);
            ...
            let (v4, v5, v6, v7) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::clmm_math::compute_swap_step(0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::sqrt_price(arg0), v2, 0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::liquidity(arg0), v3, 0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::fee_pips(arg0), arg2, true);
            let (v8, v9) = if (arg2) {
                (0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::amount_x_desired(arg0) - v4 - v7, 0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::amount_y_desired(arg0) + v5)
            } else {
                (0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::amount_x_desired(arg0) + v5, 0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::amount_y_desired(arg0) - v4 - v7)
            };
            if (v6 != v2) {
                break
            };
            if (0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::math::is_zero_for_one(v8, v9, v6, 0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::sqrt_ratio_lower(arg0), 0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::sqrt_ratio_upper(arg0)) != arg2) {
                break
            };
            ...
            0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::update_swap_state(arg0, v12, v6, 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::sub(0xaf57dc4bda93e2a606188ede73b324c24ae0953ff98e91858ba636badcd47aba::i32_utils::mate_to_lib(v0), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::from(v13)), v8, v9);
        };
    }
    ...
    public(friend) fun optimal_swap<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: u32, arg2: u32, arg3: u64, arg4: u64) : (u64, u64, bool, u128) {
        ...
        let v2 = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lt(v0, v1)) {
            if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::gte(v0, 0xaf57dc4bda93e2a606188ede73b324c24ae0953ff98e91858ba636badcd47aba::i32_utils::mate_to_lib(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::min_tick()))) {
                0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lte(v1, 0xaf57dc4bda93e2a606188ede73b324c24ae0953ff98e91858ba636badcd47aba::i32_utils::mate_to_lib(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::max_tick()))
            } else {
                false
            }
        } else {
        ...
        let v4 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::get_sqrt_price_at_tick(0xaf57dc4bda93e2a606188ede73b324c24ae0953ff98e91858ba636badcd47aba::i32_utils::lib_to_mate(v0));
        let v5 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::get_sqrt_price_at_tick(0xaf57dc4bda93e2a606188ede73b324c24ae0953ff98e91858ba636badcd47aba::i32_utils::lib_to_mate(v1));
        let v6 = 0x959b182abc9cfb02be3bd8efa9b96d574fe48a4e28ea6b724fe48b327235242::state::init_swap_state(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::liquidity<T0, T1>(arg0), v3, 0xaf57dc4bda93e2a606188ede73b324c24ae0953ff98e91858ba636badcd47aba::i32_utils::mate_to_lib(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg0)), arg3, arg4, v4, v5, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_fee_rate<T0, T1>(arg0));
