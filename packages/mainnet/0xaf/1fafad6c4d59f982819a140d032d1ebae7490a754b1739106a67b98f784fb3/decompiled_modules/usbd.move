module 0xaf1fafad6c4d59f982819a140d032d1ebae7490a754b1739106a67b98f784fb3::usbd {
    ...
    fun init(arg0: USBD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (1000000000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<USBD>>(0x2::coin::mint<USBD>(&mut v5, 1000000000000000000, arg1), v6);
        };
