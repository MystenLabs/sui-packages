module 0xaf012ed978dca0df147bd03432d9044c599a0612479b79b91e56db3b79eaefed::reward5221 {
    struct REWARD5221 has drop {
        dummy_field: bool,
    }

    struct TICKET_5221 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5221(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5221>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5221>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5221, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5221>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5221>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5221>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5221>>(v5, 0x2::tx_context::sender(arg1));
    }
