module 0xa17a409164d1676db71b411ab50813ba2c7dd547d2df538c699049566f1ff922::asset_manager {
    ...
    entry fun recv_message<T0>(arg0: &mut Config, arg1: &mut 0xf3b1e696a66d02cb776dc15aae73c68bc8f03adcb6ba0ec7f6332d9d90a6a3d2::connectionv3::State, arg2: &mut 0x4a25336d949648eddf4b5cf78e46d67bc529efffe4a5cca5169164116a56ea48::rate_limits::Config, arg3: u256, arg4: vector<u8>, arg5: u256, arg6: vector<u8>, arg7: vector<vector<u8>>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        enforce_version(arg0, 6);
        ...
        0x4a25336d949648eddf4b5cf78e46d67bc529efffe4a5cca5169164116a56ea48::rate_limits::verify_withdraw<T0>(arg2, &arg0.publisher, arg8, (v1 as u128));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(0x2::object_bag::borrow_mut<0x1::string::String, 0x2::coin::Coin<T0>>(&mut arg0.token_deposits, 0x1::string::utf8(0xa17a409164d1676db71b411ab50813ba2c7dd547d2df538c699049566f1ff922::transfer_msg::token(&v0))), v1, arg9), 0x2::address::from_bytes(0xa17a409164d1676db71b411ab50813ba2c7dd547d2df538c699049566f1ff922::transfer_msg::to(&v0)));
    }
    ...
    entry fun set_rate_limit_id(arg0: &mut Config, arg1: 0x1::string::String, arg2: &0x2::package::UpgradeCap) {
        enforce_version(arg0, 6);
