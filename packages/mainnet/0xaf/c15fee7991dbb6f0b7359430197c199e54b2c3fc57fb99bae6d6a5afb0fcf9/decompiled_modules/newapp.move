module 0xafc15fee7991dbb6f0b7359430197c199e54b2c3fc57fb99bae6d6a5afb0fcf9::newapp {
    ...
    fun calc_all_amount(arg0: &0x2::table::Table<address, User>, arg1: &User) : (u64, u64, u8) {
        ...
        let v2 = 0;
        let v3 = 0;
        while (v3 < 0x1::vector::length<address>(&arg1.invitees)) {
    ...
    public fun get_ShareList<T0>(arg0: &mut Contract<T0>, arg1: &mut 0x2::tx_context::TxContext) : vector<Share> {
        ...
        while (v2 < 0x1::vector::length<address>(&v1.invitees)) {
            let v4 = 0x2::table::borrow<address, User>(v0, *0x1::vector::borrow<address>(&v1.invitees, v2));
            let (v5, v6) = calc_amount(v0, v4);
            let (v7, v8, v9) = calc_all_amount(v0, v4);
            let v10 = Share{
                max_level                 : v9,
                total_amount              : v4.total_amount,
                underway_amount           : v4.underway_amount,
                direct_total_amount       : v5,
                direct_underway_amount    : v6,
                community_total_amount    : v7,
                community_underway_amount : v8,
            };
            0x1::vector::push_back<Share>(&mut v3, v10);
            v2 = v2 + 1;
        };
        v3
    }
    ...
    public fun get_power_center<T0>(arg0: &mut Contract<T0>, arg1: &mut 0x2::tx_context::TxContext) : Share {
        let v0 = &arg0.users;
        let v1 = 0x2::table::borrow<address, User>(v0, 0x2::tx_context::sender(arg1));
        let (v2, v3) = calc_amount(v0, v1);
        let (v4, v5, v6) = calc_all_amount(v0, v1);
        Share{
            max_level                 : v6,
            total_amount              : v1.total_amount,
            underway_amount           : v1.underway_amount,
            direct_total_amount       : v2,
            direct_underway_amount    : v3,
            community_total_amount    : v4,
            community_underway_amount : v5,
        }
    }
    ...
    public entry fun purchase<T0, T1>(arg0: &mut Contract<T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = Order{
            ...
            start_time   : 0x2::tx_context::epoch_timestamp_ms(arg5),
            amount       : arg3,
            rate         : arg4,
            sui_amount   : v4,
            yy_amount    : v5,
        ...
        0xafc15fee7991dbb6f0b7359430197c199e54b2c3fc57fb99bae6d6a5afb0fcf9::event::purchase_event(v0, arg3, v3, v4, v5);
    }
    ...
    public entry fun unstake<T0>(arg0: &mut Contract<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::table::borrow_mut<address, User>(&mut arg0.users, 0x2::tx_context::sender(arg2));
        ...
        let v3 = (0x2::tx_context::epoch_timestamp_ms(arg2) - v2.start_time) / 86400;
    ...
    fun update_user_level(arg0: &0x2::table::Table<address, User>, arg1: &mut User, arg2: address) {
