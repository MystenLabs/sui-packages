module 0xafe2da82ad6235c9336dd112340918574b5703a3c7a2d3e4f11fe799cf01b7ac::red_packet {
    ...
    fun get_random(arg0: &0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::WeatherOracle, arg1: u64, arg2: &0x2::tx_context::TxContext) : u64 {
        ...
        0x1::vector::append<u8>(&mut v0, 0x2::hex::decode(0x2::bcs::into_remainder_bytes(0x2::bcs::new(convert_number_to_byte(0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::city_weather_oracle_pressure(arg0, 2988507))))));
