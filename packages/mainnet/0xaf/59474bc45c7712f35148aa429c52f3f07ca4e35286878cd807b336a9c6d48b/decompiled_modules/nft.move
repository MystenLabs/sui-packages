module 0xaf59474bc45c7712f35148aa429c52f3f07ca4e35286878cd807b336a9c6d48b::nft {
    ...
    entry fun mint(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = NFT{
            ...
            media_type     : 0x1::string::utf8(arg5),
            created_at     : v0,
            file_hash      : 0x1::string::utf8(arg6),
        };
