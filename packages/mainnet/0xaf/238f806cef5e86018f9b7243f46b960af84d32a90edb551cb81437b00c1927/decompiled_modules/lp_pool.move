module 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::lp_pool {
    ...
    entry fun add_liquidity_token<T0>(arg0: &0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: &0x2::clock::Clock, arg23: &0x2::tx_context::TxContext) {
        ...
        assert!(arg14 <= 30, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::invalid_config_range());
        let v2 = if (arg18 > 0) {
            if (arg18 < arg19) {
                arg19 < 10000
            } else {
    ...
    public fun complete_rebalancing<T0, T1>(arg0: &0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: 0x2::balance::Balance<T1>, arg6: RebalanceProcess, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        let v13 = get_mut_token_pool(v0, &v12);
        assert!(v13.state.is_active, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::token_pool_already_active());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg4) == v13.config.oracle_id, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::oracle_mismatched());
        ...
        assert!(arg2 == v14, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::rebalance_process_field_mismatched());
        assert!(v15 == 0x1::type_name::get<T0>(), 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::rebalance_process_field_mismatched());
        assert!(v16 == v3, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::rebalance_process_field_mismatched());
        assert!(v18 == v6, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::rebalance_process_field_mismatched());
        assert!(v20 == 0x1::type_name::get<T1>(), 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::rebalance_process_field_mismatched());
        assert!(v21 == v5, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::rebalance_process_field_mismatched());
        assert!(v22 == v8, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::rebalance_process_field_mismatched());
        assert!((((0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(0x2::balance::value<T1>(&arg5), v13.config.liquidity_token_decimal, v8, v9) as u128) * ((10000 + v1) as u128) / 10000) as u64) >= v19, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::exceed_rebalance_cost_threshold());
        v13.state.liquidity_amount = v13.state.liquidity_amount + 0x2::balance::value<T1>(&arg5);
        0x2::balance::join<T1>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut v0.id, v20), arg5);
    ...
    public fun rebalance<T0, T1>(arg0: &0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) : (RebalanceProcess, 0x2::balance::Balance<T0>) {
        ...
        assert!(v13.state.is_active, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::token_pool_already_active());
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg4) == v13.config.oracle_id, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::oracle_mismatched());
        let v14 = RebalanceProcess{
            index           : arg2,
            token_type_a    : 0x1::type_name::get<T0>(),
            token_decimal_a : v2,
            token_amount_a  : arg5,
            oracle_price_a  : v5,
            reduced_usd     : 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(arg5, v2, v5, v6),
