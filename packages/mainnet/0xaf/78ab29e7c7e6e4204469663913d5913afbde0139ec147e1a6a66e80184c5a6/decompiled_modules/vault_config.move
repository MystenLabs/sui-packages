module 0x2aab8bd97b4e5d97c06d363d82fe09eb9f81bef61fedb0215fbbd5884a62221d::vault_config {
    ...
    public(friend) fun borrow_withdraw_cap(arg0: &VaultTokenHolder) : &0x7a20d590d8d0a71e15f866897ea29fb420a32cbe7b83ea3a611b7483589525d0::cloud_wallet_config::QuickWithdrawCap {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0x7a20d590d8d0a71e15f866897ea29fb420a32cbe7b83ea3a611b7483589525d0::cloud_wallet_config::QuickWithdrawCap>(&arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"))
    }
    ...
    public(friend) fun only_allow_version(arg0: &VaultConfig) {
        assert!(arg0.version <= 18446744073709551614, 10007);
    }
    ...
    public fun set_cloud_wallet_withdraw_cap(arg0: &mut 0x7a20d590d8d0a71e15f866897ea29fb420a32cbe7b83ea3a611b7483589525d0::cloud_wallet_config::CloudWalletConfig, arg1: &VaultConfig, arg2: &mut VaultTokenHolder, arg3: 0x2::transfer::Receiving<0x7a20d590d8d0a71e15f866897ea29fb420a32cbe7b83ea3a611b7483589525d0::cloud_wallet_config::QuickWithdrawCap>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg2.id, 0x1::ascii::string(b"quick_withdraw_cap"))) {
            0x7a20d590d8d0a71e15f866897ea29fb420a32cbe7b83ea3a611b7483589525d0::cloud_wallet_config::delete_quick_withdraw_cap(arg0, 0x2::dynamic_field::remove<0x1::ascii::String, 0x7a20d590d8d0a71e15f866897ea29fb420a32cbe7b83ea3a611b7483589525d0::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, 0x1::ascii::string(b"quick_withdraw_cap")));
        };
        0x2::dynamic_field::add<0x1::ascii::String, 0x7a20d590d8d0a71e15f866897ea29fb420a32cbe7b83ea3a611b7483589525d0::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, 0x1::ascii::string(b"quick_withdraw_cap"), 0x2::transfer::public_receive<0x7a20d590d8d0a71e15f866897ea29fb420a32cbe7b83ea3a611b7483589525d0::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, arg3));
    }

    public fun set_conf_version(arg0: &mut VaultConfig, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        only_admin(arg0, arg2);
        only_allow_version(arg0);
        assert!(arg1 <= 18446744073709551614, 10012);
        arg0.version = arg1;
    }
