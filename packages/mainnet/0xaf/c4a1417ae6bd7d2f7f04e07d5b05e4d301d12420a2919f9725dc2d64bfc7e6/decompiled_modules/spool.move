module 0xafc4a1417ae6bd7d2f7f04e07d5b05e4d301d12420a2919f9725dc2d64bfc7e6::spool {
    struct Spool has store, key {
        ...
        ve_sca_bind: 0x2::table::Table<0xafc4a1417ae6bd7d2f7f04e07d5b05e4d301d12420a2919f9725dc2d64bfc7e6::typed_id::TypedID<0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::ve_sca::VeScaKey>, 0x2::object::ID>,
        stakes: u64,
        min_stakes: u64,
        max_stakes: u64,
        rewards: 0x2::bag::Bag,
    ...
    public(friend) fun new<T0>(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Spool {
        Spool{
            ...
            ve_sca_bind            : 0x2::table::new<0xafc4a1417ae6bd7d2f7f04e07d5b05e4d301d12420a2919f9725dc2d64bfc7e6::typed_id::TypedID<0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::ve_sca::VeScaKey>, 0x2::object::ID>(arg2),
            stakes                 : 0,
            min_stakes             : arg0,
            max_stakes             : arg1,
    ...
    public(friend) fun accrue_points(arg0: &mut Spool, arg1: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&arg0.points_list)) {
            ...
            v2.index = v2.index + 0xafc4a1417ae6bd7d2f7f04e07d5b05e4d301d12420a2919f9725dc2d64bfc7e6::utils::mul_div(1000000000, v5, v2.weighted_amount);
            v1 = v1 + 1;
        };
    }
    ...
    public(friend) fun bind_ve_sca_to_spool_account(arg0: &mut Spool, arg1: 0xafc4a1417ae6bd7d2f7f04e07d5b05e4d301d12420a2919f9725dc2d64bfc7e6::typed_id::TypedID<0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::ve_sca::VeScaKey>, arg2: 0x2::object::ID) {
        0x2::table::add<0xafc4a1417ae6bd7d2f7f04e07d5b05e4d301d12420a2919f9725dc2d64bfc7e6::typed_id::TypedID<0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::ve_sca::VeScaKey>, 0x2::object::ID>(&mut arg0.ve_sca_bind, arg1, arg2);
    }
    ...
    public fun is_ve_sca_binded(arg0: &Spool, arg1: 0xafc4a1417ae6bd7d2f7f04e07d5b05e4d301d12420a2919f9725dc2d64bfc7e6::typed_id::TypedID<0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::ve_sca::VeScaKey>) : bool {
        0x2::table::contains<0xafc4a1417ae6bd7d2f7f04e07d5b05e4d301d12420a2919f9725dc2d64bfc7e6::typed_id::TypedID<0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::ve_sca::VeScaKey>, 0x2::object::ID>(&arg0.ve_sca_bind, arg1)
    }
    ...
    public(friend) fun unbind_ve_sca_from_spool_account(arg0: &mut Spool, arg1: 0xafc4a1417ae6bd7d2f7f04e07d5b05e4d301d12420a2919f9725dc2d64bfc7e6::typed_id::TypedID<0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::ve_sca::VeScaKey>, arg2: 0x2::object::ID) {
        assert!(0x2::table::remove<0xafc4a1417ae6bd7d2f7f04e07d5b05e4d301d12420a2919f9725dc2d64bfc7e6::typed_id::TypedID<0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::ve_sca::VeScaKey>, 0x2::object::ID>(&mut arg0.ve_sca_bind, arg1) == arg2, 1);
    }
