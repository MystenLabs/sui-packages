module 0xaf244cf0469f73dbc430753029dc3fd34ebb2bafbb062192bac16ecf31194bc6::suigirl {
    ...
    public entry fun airdrop(arg0: &mut Suigirl, arg1: address, arg2: u64, arg3: &0x2::transfer_policy::TransferPolicy<NFT>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        let v4 = &mut v3;
        mint_nft(arg0, arg1, arg2, v4, &v2, arg3, arg4);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v2, arg1);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v3);
    }

    public entry fun batch_set_character_types(arg0: &mut Suigirl, arg1: vector<u64>, arg2: vector<vector<u8>>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    fun generate_attributes(arg0: u64, arg1: &Suigirl) : 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
    ...
    public fun get_character_type(arg0: &Suigirl, arg1: u64) : 0x1::string::String {
    ...
    fun init(arg0: SUIGIRL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::package::claim<SUIGIRL>(arg0, arg1);
        ...
        let v5 = &mut v4;
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Suigirl #{token_id}"));
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<NFT>(&mut v10, &v9, 1000, 1000000000);
        ...
        let v11 = Suigirl{
            ...
            image_base          : 0x1::string::utf8(b"https://storage.googleapis.com/sui-girl/images"),
            character_types     : 0x2::table::new<u64, 0x1::string::String>(arg1),
        };
        0x2::transfer::share_object<Suigirl>(v11);
    }

    public fun max_mint_per_wallet(arg0: &Suigirl) : u64 {
        arg0.max_mint_per_wallet
    }

    public fun max_supply(arg0: &Suigirl) : u64 {
        arg0.max_supply
    }

    public entry fun mint(arg0: &mut Suigirl, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<NFT>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(arg0.paused == 0, 6);
    ...
    public fun mint_count_of(arg0: &Suigirl, arg1: address) : u64 {
    ...
    fun mint_nft(arg0: &mut Suigirl, arg1: address, arg2: u64, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<NFT>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        while (v0 < arg2) {
    ...
    public fun paused(arg0: &Suigirl) : u8 {
        arg0.paused
    }

    public fun price(arg0: &Suigirl) : u64 {
        arg0.price
    }

    public entry fun set_character_type(arg0: &mut Suigirl, arg1: u64, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.admin, 0);
    ...
    public entry fun set_image_base(arg0: &mut Suigirl, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0);
        arg0.image_base = 0x1::string::utf8(arg1);
    }

    public entry fun set_max_mint_per_wallet(arg0: &mut Suigirl, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0);
        arg0.max_mint_per_wallet = arg1;
    }

    public entry fun set_max_supply(arg0: &mut Suigirl, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0);
    ...
    public entry fun set_paused(arg0: &mut Suigirl, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0);
        assert!(arg1 == 0 || arg1 == 1, 8);
        arg0.paused = arg1;
    }

    public entry fun set_price(arg0: &mut Suigirl, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0);
        assert!(arg1 > 0, 2);
        arg0.price = arg1;
        let v0 = PriceUpdated{
    ...
    public entry fun set_treasury(arg0: &mut Suigirl, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0);
        arg0.treasury = arg1;
    }

    public fun total_supply(arg0: &Suigirl) : u64 {
        arg0.total_supply
    }

    public entry fun transfer_admin(arg0: &mut Suigirl, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0);
        arg0.admin = arg1;
    ...
    public entry fun transfer_publisher(arg0: 0x2::package::Publisher, arg1: &Suigirl, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg1.admin, 0);
        0x2::transfer::public_transfer<0x2::package::Publisher>(arg0, arg2);
    }

    public entry fun update_display(arg0: &Suigirl, arg1: &mut 0x2::display::Display<NFT>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.admin, 0);
        0x2::display::add<NFT>(arg1, 0x1::string::utf8(arg2), 0x1::string::utf8(arg3));
        0x2::display::update_version<NFT>(arg1);
    }

    public entry fun update_royalty_policy(arg0: &Suigirl, arg1: &mut 0x2::transfer_policy::TransferPolicy<NFT>, arg2: &0x2::transfer_policy::TransferPolicyCap<NFT>, arg3: u16, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == arg0.admin, 0);
        assert!(arg3 <= 10000, 8);
        0x2::transfer_policy::remove_rule<NFT, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Rule, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Config>(arg1, arg2);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<NFT>(arg1, arg2, arg3, arg4);
    }

    public entry fun withdraw_royalty(arg0: &Suigirl, arg1: &mut 0x2::transfer_policy::TransferPolicy<NFT>, arg2: &0x2::transfer_policy::TransferPolicyCap<NFT>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.admin, 0);
