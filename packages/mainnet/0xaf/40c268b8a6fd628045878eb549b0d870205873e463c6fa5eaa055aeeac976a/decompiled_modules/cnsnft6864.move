module 0xaf40c268b8a6fd628045878eb549b0d870205873e463c6fa5eaa055aeeac976a::cnsnft6864 {
    struct CNSNFT6864 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6864, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6864>(arg0, arg1);
