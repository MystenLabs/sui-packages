module 0xaf8d6c8bcdd52df96b36ceefa3f7144ea48cab39ec44a1baeba6a2e1dbd7a8ab::cnsnft3846 {
    struct CNSNFT3846 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3846, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3846>(arg0, arg1);
