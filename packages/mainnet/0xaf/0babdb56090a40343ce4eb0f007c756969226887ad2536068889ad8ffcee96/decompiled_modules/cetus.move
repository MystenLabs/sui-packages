module 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::cetus {
    ...
    public fun flash_loan<T0, T1>(arg0: &mut Vault, arg1: &0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::VaultsManager, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: u64, arg4: bool, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, FlashLoanReceipt) {
        ...
        assert!(arg0.pool == v1, 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::pool_id_mismatch());
        let v2 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg2);
        let v3 = (v2 as u256) * 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::constants::multiplier() / 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::constants::uint64_max();
        let (v4, v5, v6) = if (arg4) {
            let v7 = take_free_asset_by_amount<T0>(arg0, arg3);
            (0x2::coin::from_balance<T0>(v7, arg5), 0x2::coin::zero<T1>(arg5), (((arg3 as u256) * v3 * v3 / 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::constants::multiplier() / 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::constants::multiplier()) as u64))
        } else {
            let v8 = take_free_asset_by_amount<T1>(arg0, arg3);
            (0x2::coin::zero<T0>(arg5), 0x2::coin::from_balance<T1>(v8, arg5), (((arg3 as u256) * 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::constants::multiplier() / v3 * v3 / 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::constants::multiplier()) as u64))
        };
    ...
    public fun migrate<T0, T1>(arg0: &mut Vault, arg1: &0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::VaultsManager, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u32, arg5: u32, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v25 > 0, 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::liquidity_zero());
        arg0.liquidity = v25;
        let v26 = if (v11) {
            assert!(0x2::balance::value<T0>(&v24) == 0, 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::liquidity_mismatch());
            0x2::balance::value<T1>(&v23)
        } else {
            assert!(0x2::balance::value<T1>(&v23) == 0, 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::liquidity_mismatch());
    ...
    public fun update_slippage(arg0: &mut Vault, arg1: &0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::VaultsManager, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::checked_package_version(arg1);
        0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::check_pool_manager_role(arg1, 0x2::tx_context::sender(arg3));
        assert!(arg2 <= 1000, 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::fee_rate());
        arg0.slippage = arg2;
