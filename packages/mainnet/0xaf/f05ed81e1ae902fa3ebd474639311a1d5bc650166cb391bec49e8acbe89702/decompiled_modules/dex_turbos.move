module 0xaff05ed81e1ae902fa3ebd474639311a1d5bc650166cb391bec49e8acbe89702::dex_turbos {
    ...
    public fun swap_cross<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v0 > 0, 0xaff05ed81e1ae902fa3ebd474639311a1d5bc650166cb391bec49e8acbe89702::constants::get_zero_amount_error());
        ...
        let v1 = SwapExecuted{
            ...
            trader       : arg1,
            pool_address : 0xaff05ed81e1ae902fa3ebd474639311a1d5bc650166cb391bec49e8acbe89702::constants::get_turbos_sui_usdc_pool(),
        };
