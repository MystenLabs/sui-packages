module 0xafd311ae7ec708dc27eabce5449dd40c38c2b15fa0ec193d2005cbd6a87d2408::fins_access {
    ...
    public entry fun seal_approve_access(arg0: vector<u8>, arg1: &mut AccessRegistry, arg2: &0xafd311ae7ec708dc27eabce5449dd40c38c2b15fa0ec193d2005cbd6a87d2408::nft::AccessPass, arg3: &0x2::tx_context::TxContext) {
    ...
    public entry fun seal_approve_gasless(arg0: vector<u8>, arg1: &0xafd311ae7ec708dc27eabce5449dd40c38c2b15fa0ec193d2005cbd6a87d2408::nft::AccessPass, arg2: &0x2::tx_context::TxContext) {
        assert!(valid(arg0), 2);
        assert!(verify_ownership(arg1, 0x2::tx_context::sender(arg2)), 1);
    }
    ...
    fun verify_ownership(arg0: &0xafd311ae7ec708dc27eabce5449dd40c38c2b15fa0ec193d2005cbd6a87d2408::nft::AccessPass, arg1: address) : bool {
        true
    }
