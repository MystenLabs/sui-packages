module 0xaf5d7b31ee971fc0fa928cdaf1328c94bf9afa010806ff1754dc3fa1f94c29ee::fairmiles {
    ...
    public entry fun burn(arg0: &Authority, arg1: &mut 0x2::coin::TreasuryCap<FAIRMILES>, arg2: 0x2::coin::Coin<FAIRMILES>, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(0x2::tx_context::sender(arg3) == arg0.admin, 0);
        0x2::coin::burn<FAIRMILES>(arg1, arg2)
    }
