module 0xafd4cf941f3e2448e2623dc9c8f27125a24653580380b050a575f0b03a824e99::reward1177 {
    struct REWARD1177 has drop {
        dummy_field: bool,
    }

    struct TICKET_1177 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1177(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1177>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1177>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1177, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1177>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1177>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1177>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1177>>(v5, 0x2::tx_context::sender(arg1));
    }
