module 0xaf65bc5e3e29066938170e3e070c2de6e1bedf9abec2788a40772b77f29172ee::bonding_curve {
    ...
    fun add_liquidity<T0, T1>(arg0: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::LP<T0, T1>>>(0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::mint<T0, T1>(v0, v1, 0x2::coin::from_balance<T0>(arg1, arg3), 0x2::coin::from_balance<T1>(arg2, arg3), arg3), @0x90d307703726f41479197fa006934d110eb5220e7f57720ecf71fa2adfc086cc);
        0x2::object::id<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::PairMetadata<T0, T1>>(v0)
    }

    public(friend) fun buy_<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: u64, arg4: u64, arg5: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0xaf65bc5e3e29066938170e3e070c2de6e1bedf9abec2788a40772b77f29172ee::locked_coin::LockedCoin<T0>, 0x2::balance::Balance<0x2::sui::SUI>) {
        assert!(!arg0.ended, 3);
        ...
        let v14 = if (v13 >= arg0.lock_amount || 0x2::clock::timestamp_ms(arg6) > arg0.unlock_timestamp) {
            0xaf65bc5e3e29066938170e3e070c2de6e1bedf9abec2788a40772b77f29172ee::locked_coin::zero<T0>(arg7)
        } else {
            ...
            v12 = v15;
            0xaf65bc5e3e29066938170e3e070c2de6e1bedf9abec2788a40772b77f29172ee::locked_coin::from_balance<T0>(0x2::balance::split<T0>(&mut v11, v15), arg7)
        };
    ...
    fun seed_to_dex<T0>(arg0: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg1: &mut BondingCurve<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        0x2::event::emit<BondingCurveEndedEvent>(v5);
        v2
    }
