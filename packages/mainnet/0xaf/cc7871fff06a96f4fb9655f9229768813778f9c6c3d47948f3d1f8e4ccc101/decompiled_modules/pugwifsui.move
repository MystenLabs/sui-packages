module 0xafcc7871fff06a96f4fb9655f9229768813778f9c6c3d47948f3d1f8e4ccc101::pugwifsui {
    ...
    fun init(arg0: PUGWIFSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PUGWIFSUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"PugwifSui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"PugwifSui Collection OF"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeig2jvafu2dieydmezgf2ivqowa5fmo72sm36ebfbmpbh7v2cuxrkm"));
