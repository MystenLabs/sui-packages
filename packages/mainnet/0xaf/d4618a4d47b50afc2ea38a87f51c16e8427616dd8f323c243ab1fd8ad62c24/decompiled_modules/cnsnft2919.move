module 0xafd4618a4d47b50afc2ea38a87f51c16e8427616dd8f323c243ab1fd8ad62c24::cnsnft2919 {
    struct CNSNFT2919 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2919, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2919>(arg0, arg1);
