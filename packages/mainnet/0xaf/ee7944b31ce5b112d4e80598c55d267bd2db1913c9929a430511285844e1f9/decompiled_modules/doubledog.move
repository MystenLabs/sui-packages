module 0xafee7944b31ce5b112d4e80598c55d267bd2db1913c9929a430511285844e1f9::doubledog {
    struct DOUBLEDOG has drop {
        dummy_field: bool,
    }

    fun init(arg0: DOUBLEDOG, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DOUBLEDOG>(arg0, 6, b"DOUBLEDOG", b"DoubleDog Coin", b" ", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
