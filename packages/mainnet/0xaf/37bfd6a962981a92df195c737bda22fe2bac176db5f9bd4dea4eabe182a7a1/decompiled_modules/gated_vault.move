module 0xaf37bfd6a962981a92df195c737bda22fe2bac176db5f9bd4dea4eabe182a7a1::gated_vault {
    ...
    public(friend) fun add_to_registry(arg0: &mut GatedVaultRegistry, arg1: &0x2::clock::Clock, arg2: u64, arg3: 0x2::coin::Coin<0x18d1215fb5a050ed22da5cdefb9601adead8a9c3576e30c9bc03cbdb2eb17b47::generis::GENERIS>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v0 = GatedVaultRegistryItem{
            ...
            unlock_date : 0xaf37bfd6a962981a92df195c737bda22fe2bac176db5f9bd4dea4eabe182a7a1::vault_constants::get_lock_duration_for_level(arg1, arg2),
        };
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<GatedVaultAdminCap>(v1, @0xa5b1611d756c1b2723df1b97782cacfd10c8f94df571935db87b7f54ef653d66);
    }
