module 0xaf16ab4503ae99302bf072c199f181e19e6054902d11f49b66ceba707758ac85::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"creater", b"creater", b"create", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-08T19-03-29.214Z-Screenshot 2025-10-08 at 23.03.01.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"creater"),
            symbol     : 0x1::string::utf8(b"creater"),
            decimals   : 9,
