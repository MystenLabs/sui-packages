module 0xafde00ead81e23ace89f1410e1495f23f6000a488aac6afd42352331888d248f::sfloki {
    ...
    fun init(arg0: SFLOKI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SFLOKI>(arg0, 9, b"SFLOKI", b"SuiFloki-Inu", b"The first meme token on Sui Blockchain", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://imagetolink.com/ib/xND7a2PK0X.jpg")), arg1);
        let v2 = 0x2::coin::treasury_into_supply<SFLOKI>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<SFLOKI>>(0x2::coin::from_balance<SFLOKI>(0x2::balance::increase_supply<SFLOKI>(&mut v2, 1000000000000000000), arg1), 0x2::tx_context::sender(arg1));
