module 0xaf5a5d1d7582b83e01ea7492f70168bd4f75c46c378717d1b5ca773262f5b300::party {
    ...
    public entry fun testSwap<T0, T1, T2>(arg0: &mut Reserve<T0>, arg1: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg2: &0x2::clock::Clock, arg3: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg4: &mut 0x2::tx_context::TxContext) {
        0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::swap_router::swap_a_b<T0, T1, T2>(arg1, 0x1::vector::singleton<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.coins, 1, arg4)), 100000000, 0, 4295048016, true, @0x5062e00485cc6992d6d2cf4356898fde27fa1392444b4d278ef5dd50cc7f49f3, 1786901767461, arg2, arg3, arg4);
    }

    public entry fun withdraw<T0>(arg0: &mut Reserve<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.coins, 1, arg1), 0x2::tx_context::sender(arg1));
    }
