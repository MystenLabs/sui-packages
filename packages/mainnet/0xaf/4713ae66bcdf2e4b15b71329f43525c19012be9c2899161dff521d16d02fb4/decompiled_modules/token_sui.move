module 0xaf4713ae66bcdf2e4b15b71329f43525c19012be9c2899161dff521d16d02fb4::token_sui {
    struct TOKEN_SUI has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_SUI>(arg0, 9, b"LIMOB", b"Sui Lion Limob", b"The official unofficial Sui mascot.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://cdnb.artstation.com/p/assets/images/images/080/697/995/large/l-zz-0370.jpg?1728297608")), arg1);
        let v2 = v0;
