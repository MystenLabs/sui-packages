module 0x1ec95c2ae3fef0d51af76153af6b1670d574fff02cf076764faaeba75af16b8f::pool {
    ...
    fun buy<T0>(arg0: &mut Ref, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::balance::Balance<T0>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun buy_token_private<T0>(arg0: &mut Ref, arg1: &mut PrivatePool<T0>, arg2: &0x2::clock::Clock, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        *v3 = *v3 + v2;
        let v4 = 0x2::balance::split<T0>(&mut arg1.token, v2 * arg1.price * arg0.token_decimal);
        buy<T0>(arg0, arg3, v4, v0, arg4);
    ...
    public entry fun buy_token_public<T0>(arg0: &mut Ref, arg1: &mut PublicPool<T0>, arg2: address, arg3: &0x2::clock::Clock, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::balance::split<T0>(&mut arg1.token, v2 * arg1.price * arg0.token_decimal);
        buy<T0>(arg0, arg4, v5, v0, arg5);
        arg1.revenue = arg1.revenue + v2;
        ...
        if (0x2::address::to_u256(arg2) != 1) {
            ...
            if (0x2::table::contains<address, address>(&mut arg0.ref_wallet, v0)) {
                let v6 = 0x2::table::borrow_mut<address, u64>(&mut arg0.ref_amount, arg2);
                *v6 = *v6 + v2;
            } else {
    ...
    public entry fun changeAdmin(arg0: address, arg1: &mut Ref, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun set_public_pool_info<T0>(arg0: &mut Ref, arg1: &mut PublicPool<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg6), 1);
        arg1.start_date = arg2;
        arg1.end_date = arg3;
        arg1.price = arg4;
        arg1.sale_amount = arg5;
    }
    ...
    public entry fun withdraw_from_private_pool<T0>(arg0: &mut PublicPool<T0>, arg1: &mut Ref, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun withdraw_from_public_pool<T0>(arg0: &mut PrivatePool<T0>, arg1: &mut Ref, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.admin == 0x2::tx_context::sender(arg4), 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.token, arg3, arg4), arg2);
    }
