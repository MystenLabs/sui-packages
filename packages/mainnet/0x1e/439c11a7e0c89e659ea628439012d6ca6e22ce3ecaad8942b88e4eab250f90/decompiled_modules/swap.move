module 0x1e439c11a7e0c89e659ea628439012d6ca6e22ce3ecaad8942b88e4eab250f90::swap {
    struct Swaping {
        id: 0x2::object::ID,
    ...
    public fun after_swap<T0>(arg0: 0x2::coin::Coin<T0>, arg1: Swaping) : (0x2::coin::Coin<T0>, 0x2::object::ID, 0x1::type_name::TypeName, u64) {
        let Swaping {
            id                    : v0,
            from_coin_type        : v1,
            total_from_amount     : v2,
    ...
    public fun before_swap<T0, T1>(arg0: u64, arg1: u64, arg2: 0x2::object::ID) : Swaping {
