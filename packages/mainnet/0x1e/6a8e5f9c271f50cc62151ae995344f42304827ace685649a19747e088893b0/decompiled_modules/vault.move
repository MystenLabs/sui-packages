module 0x1e6a8e5f9c271f50cc62151ae995344f42304827ace685649a19747e088893b0::vault {
    ...
    public fun admin_claim<T0>(arg0: &0x1e6a8e5f9c271f50cc62151ae995344f42304827ace685649a19747e088893b0::admin::AdminCap, arg1: &mut Vault<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<VaultShare<T0>> {
        assert!(arg1.version == 1, 2);
        0x2::coin::from_balance<VaultShare<T0>>(claim_balance<T0>(arg1, @0x0, 0x1::option::some<u64>(arg2)), arg3)
    }

    public fun admin_claim_all<T0>(arg0: &0x1e6a8e5f9c271f50cc62151ae995344f42304827ace685649a19747e088893b0::admin::AdminCap, arg1: &mut Vault<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<VaultShare<T0>> {
        assert!(arg1.version == 1, 2);
    ...
    public fun create<T0>(arg0: &0x1e6a8e5f9c271f50cc62151ae995344f42304827ace685649a19747e088893b0::admin::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun migrate_vault<T0>(arg0: &mut Vault<T0>, arg1: &0x1e6a8e5f9c271f50cc62151ae995344f42304827ace685649a19747e088893b0::admin::AdminCap) {
        assert!(arg0.version < 1, 2);
        arg0.version = 1;
    }
