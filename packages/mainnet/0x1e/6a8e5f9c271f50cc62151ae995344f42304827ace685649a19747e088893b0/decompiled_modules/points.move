module 0x1e6a8e5f9c271f50cc62151ae995344f42304827ace685649a19747e088893b0::points {
    ...
    public fun mint(arg0: &0x1e6a8e5f9c271f50cc62151ae995344f42304827ace685649a19747e088893b0::admin::AdminCap, arg1: &mut PointsData, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<POINTS> {
        assert!(arg1.version == 1, 2);
        0x2::coin::mint<POINTS>(&mut arg1.treasury, arg2, arg3)
    }

    public fun new<T0>(arg0: &0x1e6a8e5f9c271f50cc62151ae995344f42304827ace685649a19747e088893b0::admin::AdminCap, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = Config<T0>{
    ...
    public(friend) fun add_ref<T0>(arg0: &0x2::coin::Coin<T0>, arg1: &0x1e6a8e5f9c271f50cc62151ae995344f42304827ace685649a19747e088893b0::player::Player, arg2: &TotalVolume<T0>, arg3: &mut VolumeRewardRegistry<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.version == 1, 2);
        assert!(arg3.version == 1, 2);
        let v0 = 0x1e6a8e5f9c271f50cc62151ae995344f42304827ace685649a19747e088893b0::player::referrer(arg1);
