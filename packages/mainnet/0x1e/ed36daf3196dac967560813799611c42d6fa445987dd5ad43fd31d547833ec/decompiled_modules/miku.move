module 0x1eed36daf3196dac967560813799611c42d6fa445987dd5ad43fd31d547833ec::miku {
    ...
    fun init(arg0: MIKU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/48BVWSkY5XxZ9HwaKet2kAYvjP9gPviUmm8Xg2EKCLNx.png?size=lg&key=eca3e9                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<MIKU>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MIKU      ")))), trim_right(b"MIKU                            "), trim_right(b"MIKU                                                                                                                                                                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
