module 0x1edc5d088c2f80791911657d1356ed5c53cb55a90f0df4e3de69724306949aa0::treasury {
    ...
    fun check_version(arg0: &Treasury) {
        0x1edc5d088c2f80791911657d1356ed5c53cb55a90f0df4e3de69724306949aa0::version::check_version(arg0.version);
    }

    public(friend) fun create_treasury(arg0: &mut 0x2::tx_context::TxContext) : Treasury {
        Treasury{
            id      : 0x2::object::new(arg0),
            version : 0x1edc5d088c2f80791911657d1356ed5c53cb55a90f0df4e3de69724306949aa0::version::current_version(),
    ...
    public fun withdraw<T0>(arg0: &0x1edc5d088c2f80791911657d1356ed5c53cb55a90f0df4e3de69724306949aa0::admin::AdminCap, arg1: &mut Treasury, arg2: &mut 0x2::tx_context::TxContext) {
        check_version(arg1);
    ...
    public fun withdraw_some<T0>(arg0: &0x1edc5d088c2f80791911657d1356ed5c53cb55a90f0df4e3de69724306949aa0::admin::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        check_version(arg1);
