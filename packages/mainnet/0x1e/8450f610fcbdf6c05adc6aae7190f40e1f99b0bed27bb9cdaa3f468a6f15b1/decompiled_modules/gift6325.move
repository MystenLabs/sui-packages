module 0x1e8450f610fcbdf6c05adc6aae7190f40e1f99b0bed27bb9cdaa3f468a6f15b1::gift6325 {
    struct GIFT6325 has drop {
        dummy_field: bool,
    }

    struct TICKET_6325 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6325(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6325>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6325>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6325, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6325>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6325>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6325>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6325>>(v5, 0x2::tx_context::sender(arg1));
    }
