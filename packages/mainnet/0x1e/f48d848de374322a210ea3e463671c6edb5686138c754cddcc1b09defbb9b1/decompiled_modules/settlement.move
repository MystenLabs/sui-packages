module 0x1ef48d848de374322a210ea3e463671c6edb5686138c754cddcc1b09defbb9b1::settlement {
    ...
    public fun complete_fulfill<T0: drop>(arg0: &mut SettlementState, arg1: FulfillReceipt, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::tx_context::TxContext) {
        ...
        0x1ef48d848de374322a210ea3e463671c6edb5686138c754cddcc1b09defbb9b1::events::emit_order_fulfilled(v0, 0, v5, v1, v3, 0x2::tx_context::sender(arg3));
    }
    ...
    public fun lz_receive(arg0: &mut SettlementState, arg1: &mut 0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp, arg2: u32, arg3: vector<u8>, arg4: &0x2::clock::Clock) {
        assert!(0x2::table::contains<u32, bool>(&arg0.accepted_sources, arg2) && *0x2::table::borrow<u32, bool>(&arg0.accepted_sources, arg2), 8);
        ...
        0x1ef48d848de374322a210ea3e463671c6edb5686138c754cddcc1b09defbb9b1::events::emit_swap_order_received(v0, v1, v2, v3, arg2);
    }
    ...
    public fun withdraw_fallback<T0: drop>(arg0: &mut SettlementState, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x1ef48d848de374322a210ea3e463671c6edb5686138c754cddcc1b09defbb9b1::events::emit_fallback_withdrawn(arg1, 0x2::coin::value<T0>(&arg2), v1);
    }
