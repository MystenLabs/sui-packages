module 0x1ec2488f8f709fd681a491d5c8006f02e93efacb1cff73e46c2225f1871da456::cnsnft4807 {
    struct CNSNFT4807 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4807, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4807>(arg0, arg1);
