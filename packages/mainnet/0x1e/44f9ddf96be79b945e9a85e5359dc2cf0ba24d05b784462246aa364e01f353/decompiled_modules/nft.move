module 0x1e44f9ddf96be79b945e9a85e5359dc2cf0ba24d05b784462246aa364e01f353::nft {
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = v9;
        let v11 = v8;
        0x1e44f9ddf96be79b945e9a85e5359dc2cf0ba24d05b784462246aa364e01f353::royalty_rule::add<Item>(&mut v11, &v10, 200, 100000);
    ...
    fun verifyMintSignature(arg0: address, arg1: address, arg2: u8, arg3: u8, arg4: vector<u8>, arg5: vector<u8>) : bool {
        ...
        0x1::string::append(&mut v0, 0x1::string::utf8(b"-"));
        0x1::string::append(&mut v0, 0x1e44f9ddf96be79b945e9a85e5359dc2cf0ba24d05b784462246aa364e01f353::string::u8_to_string(arg2));
        0x1::string::append(&mut v0, 0x1::string::utf8(b"-"));
        0x1::string::append(&mut v0, 0x1e44f9ddf96be79b945e9a85e5359dc2cf0ba24d05b784462246aa364e01f353::string::u8_to_string(arg3));
