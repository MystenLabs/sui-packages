module 0x1ed7ab878b7eaae4b51ba5674aedf709a2d635f9ccb6bca5c2a5c0e648a23310::tick_query {
    ...
    fun collect_in_word(arg0: &0x2::table::Table<0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, u256>, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg2: u32, arg3: &mut vector<0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32>, arg4: &mut u32) {
        ...
        while (v0 <= 255) {
            if (*0x2::table::borrow<0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, u256>(arg0, arg1) & 1 << v0 != 0) {
                let v1 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::mul(arg1, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from(256));
                let v2 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from((v0 as u32));
                let v3 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::mul(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::add(v1, v2), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from(arg2));
                let v4 = TickDebugLog{
                    word        : arg1,
                    i           : v0,
                    tick_base   : v1,
                ...
                0x2::event::emit<TickDebugLog>(v4);
                0x1::vector::push_back<0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32>(arg3, v3);
                *arg4 = *arg4 + 1;
            };
            v0 = v0 + 1;
        };
    ...
    public entry fun get_ticks_by_bitmap<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: u32) {
        ...
        let v3 = 0;
        let v4 = PreCollectDebugLog{
            current_word : v1,
            tick_spacing : v0,
            found        : v3,
        };
        0x2::event::emit<PreCollectDebugLog>(v4);
        let v5 = &mut v2;
        let v6 = &mut v3;
        collect_in_word(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::bitmap(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_tick_manager<T0, T1>(arg0)), v1, v0, v5, v6);
    }
