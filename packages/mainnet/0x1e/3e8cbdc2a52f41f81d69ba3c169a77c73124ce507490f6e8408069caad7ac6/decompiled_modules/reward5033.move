module 0x1e3e8cbdc2a52f41f81d69ba3c169a77c73124ce507490f6e8408069caad7ac6::reward5033 {
    struct REWARD5033 has drop {
        dummy_field: bool,
    }

    struct TICKET_5033 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5033(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5033>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5033>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5033, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5033>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5033>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5033>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5033>>(v5, 0x2::tx_context::sender(arg1));
    }
