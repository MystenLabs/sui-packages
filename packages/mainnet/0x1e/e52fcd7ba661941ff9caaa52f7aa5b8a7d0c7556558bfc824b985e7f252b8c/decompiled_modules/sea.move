module 0x1ee52fcd7ba661941ff9caaa52f7aa5b8a7d0c7556558bfc824b985e7f252b8c::sea {
    struct SEA has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SEA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<SEA>(&mut v2, 10000000, 0x2::tx_context::sender(arg1), arg1);
