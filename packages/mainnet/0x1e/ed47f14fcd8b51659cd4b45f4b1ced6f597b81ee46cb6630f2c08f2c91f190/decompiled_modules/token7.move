module 0x1eed47f14fcd8b51659cd4b45f4b1ced6f597b81ee46cb6630f2c08f2c91f190::token7 {
    ...
    fun init(arg0: TOKEN7, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN7>(arg0, 9, b"li.fi", b"li.fi", b"", 0x1::option::none<0x2::url::Url>(), arg1);
