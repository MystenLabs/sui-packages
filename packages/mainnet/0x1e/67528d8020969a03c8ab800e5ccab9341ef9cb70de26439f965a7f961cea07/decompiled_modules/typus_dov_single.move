module 0xa76499eda1d37751473de5f30e106f35943ada2f6ea764861243e7f5aa5bcc97::typus_dov_single {
    ...
    entry fun force_drop_bid_nodes(arg0: &mut Registry, arg1: u64, arg2: u8, arg3: vector<address>, arg4: &0x2::tx_context::TxContext) {
        version_check(arg0);
        ...
        while (0x1::vector::length<address>(&arg3) > 0) {
            0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::force_drop_share(&mut arg0.bid_vault_registry.user_share_registry, arg1, arg2, 0x1::vector::pop_back<address>(&mut arg3));
        };
    }

    entry fun force_drop_deposit_nodes(arg0: &mut Registry, arg1: u64, arg2: u8, arg3: vector<address>, arg4: &0x2::tx_context::TxContext) {
        version_check(arg0);
        0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::authority::verify<ManagerCap>(&arg0.authority, arg4);
        while (0x1::vector::length<address>(&arg3) > 0) {
            0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::force_drop_share(&mut arg0.deposit_vault_registry.user_share_registry, arg1, arg2, 0x1::vector::pop_back<address>(&mut arg3));
        };
    }
