module 0x1e007b999a259791a19c01b02a53826592ab5d7c001ef2a153a01b1c03b558a3::cons_script {
    struct ConsCap has store, key {
        id: 0x2::object::UID,
    }

    struct Cons has store, key {
        id: 0x2::object::UID,
        is_close: bool,
    ...
    public entry fun close(arg0: &ConsCap, arg1: &mut Cons, arg2: &mut 0x2::tx_context::TxContext) {
        arg1.is_close = true;
    }

    public entry fun del(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut Cons, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS, 0x2::sui::SUI>, arg3: u128, arg4: u128, arg5: u64, arg6: u32, arg7: u32, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun deposit_coin(arg0: &mut Cons, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: 0x2::coin::Coin<0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun deposit_sui(arg0: &mut Cons, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_close, 1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<Cons>(v0);
        let v1 = ConsCap{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<ConsCap>(v1, 0x2::tx_context::sender(arg0));
    }
    ...
    public entry fun open(arg0: &ConsCap, arg1: &mut Cons, arg2: &mut 0x2::tx_context::TxContext) {
        arg1.is_close = false;
    }

    public entry fun remove(arg0: &mut Cons, arg1: &mut 0xdee9::clob_v2::Pool<0x2::sui::SUI, 0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN, 0x2::sui::SUI>, arg6: u128, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_close, 1);
        ...
        let (v1, v2, _) = 0xdee9::clob_v2::swap_exact_base_for_quote<0x2::sui::SUI, 0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN>(arg1, arg2, &v0, 1000000000, 0xdee9::clob_v2::withdraw_base<0x2::sui::SUI, 0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN>(arg1, 5000000000, &v0, arg7), 0x2::coin::zero<0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN>(arg7), arg3, arg7);
        let v4 = v2;
    ...
    public entry fun sub(arg0: &mut Cons, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg2: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_close, 1);
    ...
    public entry fun withdraw_coin(arg0: &ConsCap, arg1: &mut Cons, arg2: &mut 0x2::tx_context::TxContext) {
