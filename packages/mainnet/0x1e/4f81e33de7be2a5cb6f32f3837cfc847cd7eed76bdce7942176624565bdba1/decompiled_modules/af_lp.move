module 0x1e4f81e33de7be2a5cb6f32f3837cfc847cd7eed76bdce7942176624565bdba1::af_lp {
    ...
    fun init(arg0: AF_LP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = &mut v1;
        0x1::vector::push_back<u64>(v2, 578000000000000000);
        0x1::vector::push_back<u64>(v2, 422000000000000018);
