module 0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::dex_deepbook {
    ...
    struct DeepBookReverseSwapExecuted has copy, drop {
        sender: address,
        usdc_amount_in: u64,
        sui_amount_out: u64,
        pool_id: address,
    ...
    public fun calculate_usdc_output(arg0: u64) : u64 {
        arg0 * 3830000 / 1000000000
    }

    public fun get_deepbook_package() : address {
        0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::constants::deepbook_package()
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = DeepBookRealSwapExecuted{
            ...
            sui_amount_in   : arg0,
            usdc_amount_out : calculate_usdc_output(arg0),
            pool_id         : arg2,
            package         : 0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::constants::deepbook_package(),
