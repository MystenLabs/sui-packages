module 0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::dex_kriya {
    ...
    public fun get_kriya_amm_contract() : address {
        0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::constants::kriya_amm_contract()
    }

    public fun get_kriya_package() : address {
        0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::constants::kriya_package()
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = KriyaSwapExecuted{
            ...
            package        : 0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::constants::kriya_package(),
