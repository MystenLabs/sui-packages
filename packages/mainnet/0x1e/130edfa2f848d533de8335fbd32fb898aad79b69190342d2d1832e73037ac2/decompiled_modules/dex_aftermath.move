module 0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::dex_aftermath {
    ...
    public fun calculate_aftermath_fee(arg0: u64) : u64 {
        arg0 * 250 / 1000000
    }
    ...
    public fun get_aftermath_package() : address {
        0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::constants::aftermath_package()
    }
    ...
    public fun is_aftermath_operational() : bool {
        0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::constants::aftermath_package() != @0x0
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = AftermathSwapExecuted{
            ...
            package        : 0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::constants::aftermath_package(),
