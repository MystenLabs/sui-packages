module 0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::dex_cetus {
    ...
    public fun get_cetus_package() : address {
        0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::constants::cetus_package()
    }

    public fun get_cetus_sui_usdc_pool() : address {
        0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::constants::cetus_sui_usdc_pool()
    }

    public fun is_cetus_operational() : bool {
        0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::constants::cetus_package() != @0x0
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = CetusSwapExecuted{
            ...
            package        : 0x1e130edfa2f848d533de8335fbd32fb898aad79b69190342d2d1832e73037ac2::constants::cetus_package(),
