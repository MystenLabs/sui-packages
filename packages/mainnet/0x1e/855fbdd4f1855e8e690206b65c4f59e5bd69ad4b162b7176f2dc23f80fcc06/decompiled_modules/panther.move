module 0x1e855fbdd4f1855e8e690206b65c4f59e5bd69ad4b162b7176f2dc23f80fcc06::panther {
    struct PANTHER has drop {
        dummy_field: bool,
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<PANTHER>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<PANTHER>>(0x2::coin::mint<PANTHER>(arg0, arg1, arg3), arg2);
    }
    ...
    fun init(arg0: PANTHER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<PANTHER>>(0x2::coin::mint<PANTHER>(&mut v5, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
