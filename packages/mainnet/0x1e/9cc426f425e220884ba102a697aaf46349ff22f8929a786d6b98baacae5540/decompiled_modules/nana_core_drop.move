module 0x1e9cc426f425e220884ba102a697aaf46349ff22f8929a786d6b98baacae5540::nana_core_drop {
    struct NANA_CORE_DROP has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NANA_CORE_DROP, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NANA_CORE_DROP>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"nana core drop"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"nana core drops"));
