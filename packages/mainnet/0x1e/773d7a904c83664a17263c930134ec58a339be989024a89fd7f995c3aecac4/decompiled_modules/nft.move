module 0x1e773d7a904c83664a17263c930134ec58a339be989024a89fd7f995c3aecac4::nft {
    ...
    public entry fun mint_to_anyone(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Gitnft{
            id        : 0x2::object::new(arg3),
            name      : arg0,
            image_url : arg1,
        };
        0x2::transfer::transfer<Gitnft>(v0, arg2);
    }
