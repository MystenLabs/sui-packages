module 0x1e9543e49cadbfcdf515f45ef295f187c8dda58d60b2b46e0daa514be6e3076b::cnsnft3163 {
    struct CNSNFT3163 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3163, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3163>(arg0, arg1);
