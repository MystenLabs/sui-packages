module 0x1e349f8d0f89558e6ff240502fcc5ec9caa5103364d3b70995b99a6f7c51ab7a::protocol_fees {
    ...
    public(friend) fun claim_default_referral_fees(arg0: &mut ProtocolFees) : u64 {
        let v0 = 0x1e349f8d0f89558e6ff240502fcc5ec9caa5103364d3b70995b99a6f7c51ab7a::margin_constants::default_referral();
    ...
    public(friend) fun decrease_shares(arg0: &mut ProtocolFees, arg1: 0x1::option::Option<0x2::object::ID>, arg2: u64) {
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, ReferralTracker>(&mut arg0.referrals, 0x1::option::destroy_with_default<0x2::object::ID>(arg1, 0x1e349f8d0f89558e6ff240502fcc5ec9caa5103364d3b70995b99a6f7c51ab7a::margin_constants::default_referral()));
        update_unclaimed_fees(v0, arg0.fees_per_share);
    ...
    public(friend) fun default_protocol_fees(arg0: &mut 0x2::tx_context::TxContext) : ProtocolFees {
        ...
        0x2::table::add<0x2::object::ID, ReferralTracker>(&mut v0.referrals, 0x1e349f8d0f89558e6ff240502fcc5ec9caa5103364d3b70995b99a6f7c51ab7a::margin_constants::default_referral(), v1);
        v0
    }
    ...
    public(friend) fun increase_fees_accrued(arg0: &mut ProtocolFees, arg1: 0x2::object::ID, arg2: u64) {
        ...
        if (arg0.total_shares > 0) {
            arg0.fees_per_share = arg0.fees_per_share + 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::math::div(v2, arg0.total_shares);
    ...
    public(friend) fun referral_tracker(arg0: &ProtocolFees, arg1: 0x2::object::ID) : (u64, u64) {
        ...
        (v0.current_shares, v0.unclaimed_fees + 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::math::mul(v0.current_shares, arg0.fees_per_share - v0.last_fees_per_share))
    }
    ...
    fun update_unclaimed_fees(arg0: &mut ReferralTracker, arg1: u64) {
        arg0.unclaimed_fees = arg0.unclaimed_fees + 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::math::mul(arg0.current_shares, arg1 - arg0.last_fees_per_share);
