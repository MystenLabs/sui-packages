module 0x1ea76c53ca545c0cf5a2119e116ed18fcd6e07d7e2e4d1e83a498a94e2b0a7a2::reward2170 {
    struct REWARD2170 has drop {
        dummy_field: bool,
    }

    struct TICKET_2170 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2170(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2170>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2170>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2170, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2170>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2170>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2170>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2170>>(v5, 0x2::tx_context::sender(arg1));
    }
