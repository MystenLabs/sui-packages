module 0x1e205486ae61562a04a6de217d3a3cb8b2c9a1e88bbbe2134763c55a3f6aa49f::PCW_TWAP_oracle {
    ...
    fun finalize_window(arg0: &mut SimpleTWAP, arg1: u64, arg2: u64, arg3: u128) {
        ...
        let v7 = (v0 as u256) * (arg0.max_movement_ppm as u256) / (0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::ppm_denominator() as u256);
    ...
    public fun get_ninety_day_twap(arg0: &SimpleTWAP, arg1: &0x2::clock::Clock) : 0x1::option::Option<u128> {
        get_window_twap(arg0, 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::ninety_days_ms(), arg1)
    }
    ...
    fun maybe_commit_checkpoint(arg0: &mut SimpleTWAP, arg1: u64) {
        if (arg1 >= arg0.last_checkpoint_at + 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::one_week_ms()) {
    ...
    public fun new(arg0: u128, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) : SimpleTWAP {
        assert!(arg0 > 0, 1);
        assert!(arg1 > 0, 1);
        assert!(arg2 > 0 && arg2 < 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::ppm_denominator(), 1);
    ...
    public fun new_default(arg0: u128, arg1: &0x2::clock::Clock) : SimpleTWAP {
        new(arg0, 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::twap_price_cap_window(), 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::default_twap_max_movement_ppm(), arg1)
    }
    ...
    fun record_checkpoint(arg0: &mut SimpleTWAP, arg1: u64) {
        ...
        if (0x1::vector::length<Checkpoint>(&arg0.checkpoints) >= 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::max_twap_checkpoints()) {
    ...
    fun simulate_triangle_correction(arg0: &SimpleTWAP, arg1: u256, arg2: u64, arg3: u64) : u256 {
        ...
        let v9 = (v0 as u256) * (arg0.max_movement_ppm as u256) / (0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::ppm_denominator() as u256);
    ...
    public fun try_commit_checkpoint(arg0: &mut SimpleTWAP, arg1: &0x2::clock::Clock) : bool {
        let v0 = 0x2::clock::timestamp_ms(arg1);
        if (v0 >= arg0.last_checkpoint_at + 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::one_week_ms()) {
            catch_up_to(arg0, v0);
