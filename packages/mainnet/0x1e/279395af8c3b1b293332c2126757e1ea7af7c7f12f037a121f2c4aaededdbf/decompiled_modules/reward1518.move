module 0x1e279395af8c3b1b293332c2126757e1ea7af7c7f12f037a121f2c4aaededdbf::reward1518 {
    struct REWARD1518 has drop {
        dummy_field: bool,
    }

    struct TICKET_1518 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1518(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1518>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1518>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1518, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1518>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1518>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1518>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1518>>(v5, 0x2::tx_context::sender(arg1));
    }
