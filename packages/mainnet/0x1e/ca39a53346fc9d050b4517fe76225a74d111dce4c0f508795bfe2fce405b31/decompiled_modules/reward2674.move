module 0x1eca39a53346fc9d050b4517fe76225a74d111dce4c0f508795bfe2fce405b31::reward2674 {
    struct REWARD2674 has drop {
        dummy_field: bool,
    }

    struct TICKET_2674 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2674(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2674>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2674>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2674, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2674>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2674>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2674>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2674>>(v5, 0x2::tx_context::sender(arg1));
    }
