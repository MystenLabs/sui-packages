module 0x1e0574f535c1d43f97a6de4731012748d7596dcafff636b7a8bd8f041de0400d::basic_token {
    ...
    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<BASIC_TOKEN>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun transfer_tokens(arg0: 0x2::coin::Coin<BASIC_TOKEN>, arg1: address) {
        0x2::transfer::public_transfer<0x2::coin::Coin<BASIC_TOKEN>>(arg0, arg1);
    }
