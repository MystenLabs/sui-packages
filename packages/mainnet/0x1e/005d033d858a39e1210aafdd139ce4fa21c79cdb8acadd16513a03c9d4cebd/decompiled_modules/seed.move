module 0x1e005d033d858a39e1210aafdd139ce4fa21c79cdb8acadd16513a03c9d4cebd::seed {
    ...
    fun init(arg0: SEED, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::mint_and_transfer<SEED>(&mut v2, 1000000000000000, 0x2::tx_context::sender(arg1), arg1);
