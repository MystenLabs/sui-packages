module 0x1eeb50d8e5f3fa33b08a363edbb03dacd06e6e8dfa6b43b4419c30d108faed8e::cnsnft1188 {
    struct CNSNFT1188 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1188, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1188>(arg0, arg1);
