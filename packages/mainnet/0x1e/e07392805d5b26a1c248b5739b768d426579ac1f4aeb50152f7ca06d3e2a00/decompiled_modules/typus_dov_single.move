module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single {
    ...
    public(friend) fun activate_<T0, T1, T2>(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64) {
        ...
        let (v21, v22, v23) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_date_from_ts(v1.info.expiration_ts_ms / 1000);
        0x1::string::append_utf8(&mut v20, b"-");
        0x1::string::append_utf8(&mut v20, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_pad_2_number_string(v23));
        0x1::string::append_utf8(&mut v20, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_month_short_string(v22));
        0x1::string::append_utf8(&mut v20, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_pad_2_number_string(v21));
        if (v1.info.period == 3) {
            0x1::string::append_utf8(&mut v20, b"-");
            0x1::string::append_utf8(&mut v20, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_pad_2_number_string(v1.info.expiration_ts_ms % 86400000 / 3600000));
            0x1::string::append_utf8(&mut v20, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_pad_2_number_string(v1.info.expiration_ts_ms % 3600000 / 60000));
        } else {
            0x1::vector::reverse<u64>(&mut v12);
            while (!0x1::vector::is_empty<u64>(&v12)) {
                0x1::string::append_utf8(&mut v20, b"-");
                0x1::string::append_utf8(&mut v20, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::u64_to_bytes(0x1::vector::pop_back<u64>(&mut v12), v5));
            };
        };
        ...
        let v24 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::new_bid_vault<T0, T1>(v1.info.index, v20, arg4);
        let v25 = 0;
        let v26 = 0;
        if (v17 == 0 || 0x2::clock::timestamp_ms(arg3) >= v1.info.expiration_ts_ms) {
            v1.info.status = 4;
            let v27 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::active_share_supply(v3) + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::deactivating_share_supply(v3);
            if (v27 > 0) {
                let v28 = &mut arg0.id;
                let v29 = &mut v24;
                ...
                v26 = v30;
                v25 = v31;
                let (_, _) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::recoup<T0>(v3, v27, arg4);
            };
        } else {
            v1.info.status = 1;
        };
        0x2::dynamic_object_field::add<u64, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::BidVault>(&mut arg0.bid_vault_registry, arg1, v24);
        (v10, v17, v26, v25)
    }
    ...
    entry fun old_delivery<T0, T1, T2>(arg0: &mut Registry, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg0.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg1);
        let v2 = &mut arg0.deposit_vault_registry;
        let v3 = get_mut_deposit_vault(v2, arg1);
        ...
        let v9 = &mut arg0.auction_registry;
        assert!(v1.info.status == 2, 3);
        let (v10, v11, v12, v13, v14, v15, v16, v17) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::old_delivery<T1>(v8, v7, take_auction(v9, arg1), arg2, arg3, arg4);
        let v18 = v11;
        v1.info.delivery_infos.total_delivery_size = v1.info.delivery_infos.total_delivery_size + v13;
        v1.info.delivery_infos.total_bidder_bid_value = v1.info.delivery_infos.total_bidder_bid_value + v14;
        v1.info.delivery_infos.total_bidder_fee = v1.info.delivery_infos.total_bidder_fee + v15;
        ...
        0x1::vector::push_back<u64>(v24, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v1.config.u64_padding, 3));
        0x1::vector::push_back<u64>(v24, v1.config.bid_incentive_bp);
        emit_delivery_event(arg0, arg1, arg2, v23, arg4);
    }
    ...
    fun vault_delivery_<T0, T1, T2>(arg0: &mut 0x2::object::UID, arg1: &mut PortfolioVault, arg2: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::DepositVault, arg3: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::BidVault, arg4: 0x2::balance::Balance<T1>, arg5: &0x2::tx_context::TxContext) : (u64, u64) {
        let v0 = if (arg1.config.deposit_incentive_bp > 0 && 0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(arg0, 0x1::type_name::get<T1>())) {
            ...
            let v4 = arg1.info.option_type % 2 == 0 && arg1.info.option_type != 6;
            let v5 = if (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::match_types<T0, T1>()) {
                ((((0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::active_share_supply(arg2) + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::deactivating_share_supply(arg2)) as u128) * (arg1.config.deposit_incentive_bp as u128) / 10000 / (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&arg1.config.u64_padding, 3)) as u128)) as u64)
            } else if (0x1::type_name::get<T1>() != arg1.info.settlement_base && 0x1::type_name::get<T1>() != arg1.info.settlement_quote) {
                ((((0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::active_share_supply(arg2) + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::deactivating_share_supply(arg2)) as u128) * (arg1.config.deposit_incentive_bp as u128) / 10000 / (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&arg1.config.u64_padding, 3)) as u128)) as u64)
            } else if (v4) {
                (((((((0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::active_share_supply(arg2) + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::deactivating_share_supply(arg2)) as u128) * (arg1.config.deposit_incentive_bp as u128) / 10000 / (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&arg1.config.u64_padding, 3)) as u128)) as u64) as u128) * (arg1.info.oracle_info.price as u128) / (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(arg1.info.oracle_info.decimal) as u128) * (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(arg1.info.b_token_decimal) as u128) / (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(arg1.info.d_token_decimal) as u128)) as u64)
            } else {
                (((((((0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::active_share_supply(arg2) + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::deactivating_share_supply(arg2)) as u128) * (arg1.config.deposit_incentive_bp as u128) / 10000 / (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&arg1.config.u64_padding, 3)) as u128)) as u64) as u128) * (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(arg1.info.oracle_info.decimal) as u128) / (arg1.info.oracle_info.price as u128) * (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(arg1.info.b_token_decimal) as u128) / (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(arg1.info.d_token_decimal) as u128)) as u64)
            };
            let v6 = if (v5 > v2) {
                if (v2 > v3) {
                    v3
            ...
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::set_u64_padding_value(&mut arg1.config.u64_padding, 0, v3 - v6);
            v6
        } else {
            0
        };
        let v7 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&arg1.config.u64_padding, 2);
        if (v0 == 0 && v7 == 0) {
            ...
            if (v0 > 0) {
                0x2::balance::join<T1>(&mut v8, 0x2::balance::split<T1>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(arg0, 0x1::type_name::get<T1>()), v0));
            };
            if (v7 > 0) {
                let v9 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg1.id, 0x1::type_name::get<T1>());
                0x2::balance::join<T1>(&mut v8, 0x2::balance::split<T1>(v9, v7));
                let v10 = if (v7 < 0x2::balance::value<T1>(v9)) {
                    v7
                } else {
                    0x2::balance::value<T1>(v9)
                };
                0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::set_u64_padding_value(&mut arg1.config.u64_padding, 2, v10);
            };
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::delivery_b<T0, T1>(arg2, arg3, arg4, v8, arg5);
        } else {
            if (v0 > 0) {
            ...
            let v11 = if (v7 > 0) {
                let v12 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T2>>(&mut arg1.id, 0x1::type_name::get<T2>());
                let v13 = if (v7 < 0x2::balance::value<T2>(v12)) {
                    v7
                } else {
                    0x2::balance::value<T2>(v12)
                };
                0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::set_u64_padding_value(&mut arg1.config.u64_padding, 2, v13);
                0x2::balance::split<T2>(v12, v7)
            } else {
                0x2::balance::zero<T2>()
            };
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::delivery_i<T0, T1, T2>(arg2, arg3, arg4, v11, arg5);
        };
        (v0, v7)
    }
