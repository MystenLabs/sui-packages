module 0x1e8fac4d6408df49001a4a62d283e31f20f3272acbfe3813d0bf178bc9f1e8b2::global {
    ...
    public(friend) fun earn_fee<T0>(arg0: &mut VaultRegistry, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<T0>) {
        ...
        0x1e8fac4d6408df49001a4a62d283e31f20f3272acbfe3813d0bf178bc9f1e8b2::event::emit_fee_earned(arg1, v1, v0, 0x2::balance::join<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.fee_earned, v1), arg2));
    }

    public fun get_vault_id<T0, T1>(arg0: &VaultRegistry) : 0x2::object::ID {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, 0x2::table::Table<0x1::type_name::TypeName, 0x2::object::ID>>(&arg0.created, v0), 0x1e8fac4d6408df49001a4a62d283e31f20f3272acbfe3813d0bf178bc9f1e8b2::error::wrong_vault());
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, 0x2::object::ID>(v1, v2), 0x1e8fac4d6408df49001a4a62d283e31f20f3272acbfe3813d0bf178bc9f1e8b2::error::not_coin_type());
    ...
    public(friend) fun register<T0, T1>(arg0: &mut VaultRegistry, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::table::contains<0x1::type_name::TypeName, 0x2::object::ID>(v2, v1), 0x1e8fac4d6408df49001a4a62d283e31f20f3272acbfe3813d0bf178bc9f1e8b2::error::vault_already_exists());
