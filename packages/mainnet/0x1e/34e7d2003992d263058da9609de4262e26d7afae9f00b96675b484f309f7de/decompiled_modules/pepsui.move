module 0x1e34e7d2003992d263058da9609de4262e26d7afae9f00b96675b484f309f7de::pepsui {
    ...
    fun init(arg0: PEPSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PEPSUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"PepSui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The PepSui collection consists of 111 NFTs inspired by the famous and beloved character Pepe."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifmddjktyqdumbjh47yzv76dtoqc6kus6autmumgxb7j3tovdmpxi"));
