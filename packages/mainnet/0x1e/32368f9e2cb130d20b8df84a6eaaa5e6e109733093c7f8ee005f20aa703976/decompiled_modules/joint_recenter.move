module 0x472d27d6bba8725a15b72ed5e388d167dc5c2a597734abbdd50c869e4869ce3e::joint_recenter {
    ...
    struct OrdinaryBluefinConsolidated has copy, drop {
        source_position_id: 0x2::object::ID,
        destination_position_id: 0x2::object::ID,
        source_liquidity: u128,
    ...
    public fun consolidate_ordinary_bluefin<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg5: u64, arg6: u64, arg7: u64, arg8: bool, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: &mut 0x2::tx_context::TxContext) {
        assert_deadline(arg0, arg14);
        let (v0, v1, v2) = close_ordinary_bluefin_to_sui<T0, T1>(arg0, arg1, arg2, arg3, arg5, arg6, arg14);
        let v3 = v2;
        let v4 = v1;
        let v5 = v0;
        settle_profit_sui<T1>(v3, arg13);
        let (v6, v7, v8, v9) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg0, arg1, arg2, arg4, v5, v4, arg7, arg8);
        let v10 = v9;
        let v11 = v8;
        ...
        assert!(v12 <= arg11, 10);
        assert!(v13 <= arg12, 11);
        let v14 = OrdinaryBluefinConsolidated{
            source_position_id      : 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&arg3),
            destination_position_id : 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(arg4),
            source_liquidity        : 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(&arg3),
            source_principal_a      : 0x2::balance::value<T0>(&v5),
            source_principal_b      : 0x2::balance::value<T1>(&v4),
            profit_b                : 0x2::balance::value<T1>(&v3),
            deposited_a             : v6,
            deposited_b             : v7,
            residual_a              : v12,
            residual_b              : v13,
        };
        0x2::event::emit<OrdinaryBluefinConsolidated>(v14);
        if (v12 > 0) {
            0x2::balance::send_funds<T0>(v11, 0x2::tx_context::sender(arg15));
        } else {
            0x2::balance::destroy_zero<T0>(v11);
        };
        if (v13 > 0) {
            0x2::balance::send_funds<T1>(v10, 0x2::tx_context::sender(arg15));
        } else {
