module 0x1eee8b5dd7e1d5a1788e7efe8281336003a67b445e8ef0bb11489bc8b32b20b3::staked_lp {
    ...
    public fun into_token<T0>(arg0: StakedLP<T0>, arg1: &0x2::clock::Clock, arg2: &0x2::token::TokenPolicy<T0>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::token::Token<T0> {
        ...
        assert!(0x2::clock::timestamp_ms(arg1) >= v2, 0x1eee8b5dd7e1d5a1788e7efe8281336003a67b445e8ef0bb11489bc8b32b20b3::errors::lp_stake_time_not_passed());
        0x2::object::delete(v0);
        0x1eee8b5dd7e1d5a1788e7efe8281336003a67b445e8ef0bb11489bc8b32b20b3::token_ir::from_balance<T0>(arg2, v1, arg3)
    }
