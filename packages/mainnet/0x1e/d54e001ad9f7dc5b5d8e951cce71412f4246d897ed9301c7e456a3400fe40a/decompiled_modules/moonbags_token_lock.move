module 0x1ed54e001ad9f7dc5b5d8e951cce71412f4246d897ed9301c7e456a3400fe40a::moonbags_token_lock {
    ...
    public entry fun cancel_admin_change(arg0: &AdminCap, arg1: &mut Configuration) {
        arg1.timelock_execute_time = 0;
    }
    ...
    public entry fun execute_admin_change(arg0: &AdminCap, arg1: &mut Configuration, arg2: &0x2::clock::Clock) {
        assert!(0x2::clock::timestamp_ms(arg2) >= arg1.timelock_execute_time, 6);
        assert!(arg1.timelock_execute_time > 0, 7);
        arg1.admin = arg1.pending_admin;
        arg1.timelock_execute_time = 0;
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Configuration{
            ...
            pending_admin         : 0x2::tx_context::sender(arg0),
            timelock_execute_time : 0,
        };
        0x2::transfer::public_share_object<Configuration>(v1);
    }

    public entry fun propose_admin_change(arg0: &AdminCap, arg1: &mut Configuration, arg2: address, arg3: &0x2::clock::Clock) {
        arg1.pending_admin = arg2;
        arg1.timelock_execute_time = 0x2::clock::timestamp_ms(arg3) + 86400000;
    }

    public entry fun update_lock_fee(arg0: &AdminCap, arg1: &mut Configuration, arg2: u64) {
        assert!(arg2 <= 10000, 5);
        arg1.lock_fee = arg2;
    }
