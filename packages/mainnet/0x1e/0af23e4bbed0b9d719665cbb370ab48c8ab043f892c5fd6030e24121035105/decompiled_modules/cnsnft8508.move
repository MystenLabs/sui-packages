module 0x1e0af23e4bbed0b9d719665cbb370ab48c8ab043f892c5fd6030e24121035105::cnsnft8508 {
    struct CNSNFT8508 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8508, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8508>(arg0, arg1);
