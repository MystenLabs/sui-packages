module 0xce54a2ff5c465d8a2334e7538a8d12fa9df141e49d9c1215bba18b664831031f::lsd_lockdrop {
    ...
    public fun emergency_withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &mut LsdLockdropVault, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0xcfc06c5e96b2a09666851de57669afcf97bc9bb7dd5ac50ea3dbe801c9f24772::hive_profile::HiveProfile, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::clock::timestamp_ms(arg0);
        let (_, _, _, v3) = 0xcfc06c5e96b2a09666851de57669afcf97bc9bb7dd5ac50ea3dbe801c9f24772::hive_profile::get_profile_meta_info(arg3);
        assert!(0xcfc06c5e96b2a09666851de57669afcf97bc9bb7dd5ac50ea3dbe801c9f24772::hive_profile::exists_for_profile(arg3, 0xcfc06c5e96b2a09666851de57669afcf97bc9bb7dd5ac50ea3dbe801c9f24772::hive_profile::get_hive_app_name(&arg1.user_profile_access_cap)), 5104);
        let v4 = 0xcfc06c5e96b2a09666851de57669afcf97bc9bb7dd5ac50ea3dbe801c9f24772::hive_profile::remove_app_from_profile<UserLsdLockdropPosition>(&arg1.user_profile_access_cap, arg3, arg4);
        let v5 = 0x2::coin::into_balance<0x2::sui::SUI>(arg2);
        let UserLsdLockdropPosition {
            id                          : v6,
            lockup_weeks                : _,
            sui_locked_per_position     : v8,
            weighted_units_per_position : v9,
            unlock_timestamps           : v10,
            withdrawl_window_flag       : v11,
            total_sui_locked            : _,
            total_sui_weighted_units    : _,
        } = v4;
        0x2::object::delete(v6);
        0x2::table::drop<u64, bool>(v11);
        0x2::table::drop<u64, u64>(v8);
        0x2::table::drop<u64, u64>(v10);
        0x2::table::drop<u64, u128>(v9);
        0x616fa729bb4fbddf2cfc165b1ce19c1d7d738252283a250dc0183b3e015d148b::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v5, v4.total_sui_locked), v3, arg4);
        0x616fa729bb4fbddf2cfc165b1ce19c1d7d738252283a250dc0183b3e015d148b::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v5, 0x2::tx_context::sender(arg4), arg4);
    }
