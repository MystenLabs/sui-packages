module 0x1e21518fb6eb0c8e050812e89007db64c3bc9fe538c896a43c5d2e771952d96b::reward4281 {
    struct REWARD4281 has drop {
        dummy_field: bool,
    }

    struct TICKET_4281 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4281(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4281>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4281>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4281, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4281>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4281>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4281>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4281>>(v5, 0x2::tx_context::sender(arg1));
    }
