module 0xf4e0686b311e9b9d6da7e61fc42dae4254828f5ee3ded8ab5480ecd27e46ff08::points {
    ...
    public fun burn_points<T0: drop>(arg0: &mut PointsManager<T0>, arg1: 0x2::coin::Coin<0x34fe4f3c9e450fed4d0a3c587ed842eec5313c30c3cc3c0841247c49425e246b::suilend_point::SUILEND_POINT>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_version_and_upgrade<T0>(arg0);
        let v0 = arg0.ratio;
        let v1 = 0x2::coin::value<0x34fe4f3c9e450fed4d0a3c587ed842eec5313c30c3cc3c0841247c49425e246b::suilend_point::SUILEND_POINT>(&arg1) * v0.numerator / v0.denominator;
        assert!(v1 <= 0x2::balance::value<T0>(&arg0.balance), 1);
        let v2 = BurnEvent{
            manager_id    : 0x2::object::uid_to_inner(&arg0.id),
            claim_amount  : v1,
            points_burned : 0x2::coin::value<0x34fe4f3c9e450fed4d0a3c587ed842eec5313c30c3cc3c0841247c49425e246b::suilend_point::SUILEND_POINT>(&arg1),
        };
        0x2::event::emit<BurnEvent>(v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x34fe4f3c9e450fed4d0a3c587ed842eec5313c30c3cc3c0841247c49425e246b::suilend_point::SUILEND_POINT>>(arg1, @0x0);
