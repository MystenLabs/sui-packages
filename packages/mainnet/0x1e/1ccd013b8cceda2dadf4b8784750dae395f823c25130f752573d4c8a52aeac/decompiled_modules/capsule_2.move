module 0xf4e0686b311e9b9d6da7e61fc42dae4254828f5ee3ded8ab5480ecd27e46ff08::capsule_2 {
    ...
    public fun burn_capsule<T0: drop>(arg0: &mut CapsuleManager<T0>, arg1: 0x8a7e85138643db888096f2db04766d549ca496583e41c3a683c6e1539a64ac::suilend_capsule::SuilendCapsule, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v0 = if (0x8a7e85138643db888096f2db04766d549ca496583e41c3a683c6e1539a64ac::suilend_capsule::rarity(&arg1) == 0x1::string::utf8(b"common_s2")) {
            arg0.amounts.common
        } else if (0x8a7e85138643db888096f2db04766d549ca496583e41c3a683c6e1539a64ac::suilend_capsule::rarity(&arg1) == 0x1::string::utf8(b"uncommon_s2")) {
            arg0.amounts.uncommon
        } else {
            assert!(0x8a7e85138643db888096f2db04766d549ca496583e41c3a683c6e1539a64ac::suilend_capsule::rarity(&arg1) == 0x1::string::utf8(b"rare_s2"), 2);
            arg0.amounts.rare
        };
