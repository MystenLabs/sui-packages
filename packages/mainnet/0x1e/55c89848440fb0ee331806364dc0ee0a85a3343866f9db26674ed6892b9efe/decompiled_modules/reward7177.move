module 0x1e55c89848440fb0ee331806364dc0ee0a85a3343866f9db26674ed6892b9efe::reward7177 {
    struct REWARD7177 has drop {
        dummy_field: bool,
    }

    struct TICKET_7177 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7177(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7177>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7177>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7177, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7177>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7177>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7177>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7177>>(v5, 0x2::tx_context::sender(arg1));
    }
