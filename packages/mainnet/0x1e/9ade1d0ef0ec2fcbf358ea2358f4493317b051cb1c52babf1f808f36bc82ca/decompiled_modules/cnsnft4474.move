module 0x1e9ade1d0ef0ec2fcbf358ea2358f4493317b051cb1c52babf1f808f36bc82ca::cnsnft4474 {
    struct CNSNFT4474 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4474, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4474>(arg0, arg1);
