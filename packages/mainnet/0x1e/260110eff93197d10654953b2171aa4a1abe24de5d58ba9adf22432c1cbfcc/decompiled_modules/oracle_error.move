module 0x1e260110eff93197d10654953b2171aa4a1abe24de5d58ba9adf22432c1cbfcc::oracle_error {
    public fun histories_length_overflow() : u64 {
        6009
    }
    ...
    public fun invalid_primary_oracle_provider() : u64 {
        6011
    }

    public fun no_oracle_provider_config_available() : u64 {
        6013
    }
    ...
    public fun provider_can_not_be_empty() : u64 {
        6002
    }
    ...
    public fun subtraction_overflows_downwards() : u64 {
        6100
    }
