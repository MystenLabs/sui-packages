module 0x7dcd601d40cf741f112f2a872f522d6108b11df5d7c9b0041f7eb52083c78933::nft_display {
    ...
    fun init(arg0: NFT_DISPLAY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0x7dcd601d40cf741f112f2a872f522d6108b11df5d7c9b0041f7eb52083c78933::anniversary_vault::Today365>(&v0, v1, v3, arg1);
        0x2::display::update_version<0x7dcd601d40cf741f112f2a872f522d6108b11df5d7c9b0041f7eb52083c78933::anniversary_vault::Today365>(&mut v5);
        0x2::transfer::public_share_object<0x2::display::Display<0x7dcd601d40cf741f112f2a872f522d6108b11df5d7c9b0041f7eb52083c78933::anniversary_vault::Today365>>(v5);
        ...
        let v10 = 0x2::display::new_with_fields<0x7dcd601d40cf741f112f2a872f522d6108b11df5d7c9b0041f7eb52083c78933::nostalgia_ticket::NostalgiaTicket>(&v0, v6, v8, arg1);
        0x2::display::update_version<0x7dcd601d40cf741f112f2a872f522d6108b11df5d7c9b0041f7eb52083c78933::nostalgia_ticket::NostalgiaTicket>(&mut v10);
        0x2::transfer::public_share_object<0x2::display::Display<0x7dcd601d40cf741f112f2a872f522d6108b11df5d7c9b0041f7eb52083c78933::nostalgia_ticket::NostalgiaTicket>>(v10);
