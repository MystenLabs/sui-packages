module 0x7da53a4a12cfa13feacdeb21046997cf4518f44ab55c2ece1bc4f3cdc731b5b3::reward1707 {
    struct REWARD1707 has drop {
        dummy_field: bool,
    }

    struct TICKET_1707 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1707(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1707>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1707>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1707, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1707>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1707>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1707>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1707>>(v5, 0x2::tx_context::sender(arg1));
    }
