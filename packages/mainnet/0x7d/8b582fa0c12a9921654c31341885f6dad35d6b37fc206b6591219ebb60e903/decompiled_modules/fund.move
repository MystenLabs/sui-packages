module 0x7d8b582fa0c12a9921654c31341885f6dad35d6b37fc206b6591219ebb60e903::fund {
    ...
    public fun to_shares(arg0: &Fund, arg1: u64, arg2: bool) : u64 {
        ...
        if (arg2) {
            (0x7d8b582fa0c12a9921654c31341885f6dad35d6b37fc206b6591219ebb60e903::math128::mul_div_up((arg1 as u128), arg0.shares, arg0.underlying) as u64)
        } else {
            (0x7d8b582fa0c12a9921654c31341885f6dad35d6b37fc206b6591219ebb60e903::math128::mul_div_down((arg1 as u128), arg0.shares, arg0.underlying) as u64)
        }
    }
    ...
    public fun to_underlying(arg0: &Fund, arg1: u64, arg2: bool) : u64 {
        ...
        if (arg2) {
            (0x7d8b582fa0c12a9921654c31341885f6dad35d6b37fc206b6591219ebb60e903::math128::mul_div_up((arg1 as u128), arg0.underlying, arg0.shares) as u64)
        } else {
            (0x7d8b582fa0c12a9921654c31341885f6dad35d6b37fc206b6591219ebb60e903::math128::mul_div_down((arg1 as u128), arg0.underlying, arg0.shares) as u64)
        }
    }
