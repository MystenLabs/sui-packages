module 0x7d068aaacaf7ad79827837bce6cab85c215a1104e006b76e8a0292a75095d290::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"PB", b"PepeBackwards", b"pepe looping", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-20T03-03-26.253Z-Scherm%C3%82%C2%ADafbeelding%202025-09-20%20om%2006.56.38.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"PepeBackwards"),
            symbol     : 0x1::string::utf8(b"PB"),
            decimals   : 9,
