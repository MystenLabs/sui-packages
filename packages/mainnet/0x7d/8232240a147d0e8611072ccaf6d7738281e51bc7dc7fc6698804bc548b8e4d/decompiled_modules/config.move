module 0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::acl::ACL,
        package_version: u64,
    }
    ...
    public(friend) fun add_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        ...
        0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::acl::Member> {
        0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::acl::get_members(&arg0.acl)
    }

    public(friend) fun remove_member(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        checked_package_version(arg1);
        0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public(friend) fun remove_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public(friend) fun set_roles(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public(friend) fun add_operator(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: u128, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::acl::set_roles(&mut arg1.acl, 0x2::object::id_address<OperatorCap>(&v0), arg2);
    ...
    public fun check_rebalance_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::acl::has_role(&arg0.acl, arg1, 2), 3);
    }

    public fun check_reward_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::acl::has_role(&arg0.acl, arg1, 1), 2);
    }

    public fun check_vault_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::acl::has_role(&arg0.acl, arg1, 0), 1);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GlobalConfig{
            ...
            acl             : 0x7d8232240a147d0e8611072ccaf6d7738281e51bc7dc7fc6698804bc548b8e4d::acl::new(arg0),
            package_version : 1,
        };
