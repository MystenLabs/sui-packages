module 0x7dc92c71b8b228d9e6161566ed3dc3a74a8fb22d99da8e153224b2ce9ae13fc0::birds_nft {
    ...
    public fun buy(arg0: &mut BirdConfig, arg1: &mut SaleConfig, arg2: &mut FeePool<0x2::sui::SUI>, arg3: u16, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &0x2::random::Random, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::random::new_generator(arg6, arg7);
        let v6 = 0;
        let v7 = 0;
        let v8 = 0;
        while (v8 < 0x1::vector::length<u16>(&v4.rate)) {
            let v9 = v7 + *0x1::vector::borrow<u16>(&v4.rate, v8);
            v7 = v9;
            if (0x2::random::generate_u16_in_range(&mut v5, 1, 10000) <= v9) {
                v6 = (v8 as u16);
                break
            };
            v8 = v8 + 1;
        };
        let v10 = 0x2::random::generate_u8_in_range(&mut v5, 0, arg0.total_sub_type - 1);
        let v11 = generate_nft_img_id(arg0, arg6, v6 + 1, v10 + 1, arg7);
        let v12 = BirdNFT{
            id            : 0x2::object::new(arg7),
            xid           : arg1.total_sold,
            type          : v6,
            type_name     : *0x2::table::borrow<u16, 0x1::string::String>(&arg0.type_name, v6),
            sub_type      : v10,
            sub_type_name : *0x2::table::borrow<u8, 0x1::string::String>(&arg0.sub_type_name, v10),
            gen_id        : v11,
        ...
        let v13 = MintedEvent{
            ...
            id          : 0x2::object::id<BirdNFT>(&v12),
            xid         : v12.xid,
            type        : v6,
            sub_type    : v10,
            gen_id      : v11,
            max_mating  : v12.max_mating,
            mating_left : v12.mating_left,
        };
        0x2::event::emit<MintedEvent>(v13);
        0x2::transfer::public_transfer<BirdNFT>(v12, v3);
    }
