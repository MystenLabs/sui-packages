module 0x7df92abbd06e162b183e9dbf0956ff55952ecdf34ba53d8dc31e77b60aaa49ae::reward5593 {
    struct REWARD5593 has drop {
        dummy_field: bool,
    }

    struct TICKET_5593 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5593(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5593>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5593>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5593, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5593>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5593>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5593>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5593>>(v5, 0x2::tx_context::sender(arg1));
    }
