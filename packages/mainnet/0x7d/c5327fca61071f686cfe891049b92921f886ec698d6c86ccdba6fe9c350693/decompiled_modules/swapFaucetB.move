module 0x7dc5327fca61071f686cfe891049b92921f886ec698d6c86ccdba6fe9c350693::swapFaucetB {
    ...
    fun init(arg0: SWAPFAUCETB, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SWAPFAUCETB>(arg0, 6, b"looikaizhi_Faucet", b"LKZF_B", b"Who can let me become a memecoin!!(This is faucet)", 0x1::option::none<0x2::url::Url>(), arg1);
