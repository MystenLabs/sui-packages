module 0x7dc2bbbc44a99908e7f9d416b965027ee34cc6cf763e7db495b6b2748224ffcc::pvp_blackjack {
    ...
    fun finalize_game<T0>(arg0: &mut Room<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 > v1) {
            ...
            0x2::balance::join<T0>(&mut arg0.host_stake, 0x2::coin::into_balance<T0>(0x2::coin::take<T0>(&mut arg0.guest_stake, 0x2::balance::value<T0>(&arg0.guest_stake), arg1)));
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.host_stake, 0x2::balance::value<T0>(&arg0.host_stake), arg1), arg0.host);
            let v3 = RoomGameFinishedEvent{
                room_id   : 0x2::object::uid_to_inner(&arg0.id),
                winner    : arg0.host,
                host_sum  : arg0.host_sum,
                guest_sum : arg0.guest_sum,
            };
            0x2::event::emit<RoomGameFinishedEvent>(v3);
        } else if (v1 > v0) {
