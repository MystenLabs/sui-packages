module 0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::dragon_egg {
    ...
    public entry fun buy_dragon_egg_fire(arg0: &mut DragonEggGlobal, arg1: vector<0x2::coin::Coin<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 2);
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = 10000;
        let v2 = 0x1::vector::pop_back<0x2::coin::Coin<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>>(&mut arg1);
        assert!(!0x2::table::contains<address, bool>(&arg0.bought_list, v0), 5);
        0x2::pay::join_vec<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(&mut v2, arg1);
        assert!(0x2::coin::value<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(&v2) >= v1 * 1000000000, 4);
        0x2::balance::join<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(&mut arg0.balance_SHUI, 0x2::coin::into_balance<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(0x2::coin::split<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(&mut v2, v1 * 1000000000, arg2)));
        if (0x2::coin::value<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(&v2) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>>(v2, v0);
        } else {
            0x2::coin::destroy_zero<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(v2);
        };
    ...
    public entry fun buy_dragon_egg_ice(arg0: &mut DragonEggGlobal, arg1: vector<0x2::coin::Coin<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 2);
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = 10000;
        let v2 = 0x1::vector::pop_back<0x2::coin::Coin<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>>(&mut arg1);
    ...
    public entry fun get_left_egg_num(arg0: &DragonEggGlobal) : 0x1::string::String {
        ...
        0x1::vector::append<u8>(&mut v1, 0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::utils::numbers_to_ascii_vector((arg0.egg_fire_bought_num as u16)));
        0x1::vector::push_back<u8>(&mut v1, 0x1::ascii::byte(0x1::ascii::char(44)));
        0x1::vector::append<u8>(&mut v1, 0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::utils::numbers_to_ascii_vector((arg0.egg_ice_bought_num as u16)));
        0x1::string::utf8(v1)
    }
