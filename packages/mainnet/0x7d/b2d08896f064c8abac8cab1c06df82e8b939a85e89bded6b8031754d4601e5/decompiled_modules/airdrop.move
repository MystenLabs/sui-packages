module 0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::airdrop {
    ...
    public fun change_owner(arg0: &mut AirdropGlobal, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.creator == 0x2::tx_context::sender(arg2), 2);
        arg0.creator = arg1;
    }

    public entry fun claim_airdrop(arg0: &mut 0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::mission::MissionGlobal, arg1: &mut AirdropGlobal, arg2: &0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::metaIdentity::MetaIdentity, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 0, 9);
        assert!(0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::metaIdentity::is_active(arg2), 5);
        assert!(arg1.start > 0, 4);
        ...
        assert!(arg1.total_daily_claim_amount < get_daily_limit(v3), 6);
        let v4 = 0;
        ...
        assert!(v0 - v4 > 60000, 3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>>(0x2::coin::from_balance<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(0x2::balance::split<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(&mut arg1.balance_SHUI, v2), arg4), 0x2::tx_context::sender(arg4));
        let v5 = &mut arg1.daily_claim_records_list;
        record_claim_time(v5, v0, v1);
        0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::mission::add_process(arg0, 0x1::string::utf8(b"claim airdrop"), arg2);
    }

    public entry fun claim_boat_whitelist_airdrop(arg0: &mut AirdropGlobal, arg1: &mut 0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::boat_ticket::BoatTicket, arg2: &0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::metaIdentity::MetaIdentity, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 9);
        assert!(0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::metaIdentity::is_active(arg2), 5);
        assert!(!0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::boat_ticket::is_claimed(arg1), 7);
        assert!(arg0.white_list_claim_amount <= 20000, 8);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>>(0x2::coin::from_balance<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(0x2::balance::split<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(&mut arg0.balance_SHUI, 10000 * 1000000000), arg3), 0x2::tx_context::sender(arg3));
        0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::boat_ticket::record_white_list_clamed(arg1);
        arg0.white_list_claim_amount = arg0.white_list_claim_amount + 1;
    }
    ...
    public entry fun get_total_shui_balance(arg0: &AirdropGlobal) : u64 {
        0x2::balance::value<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(&arg0.balance_SHUI)
    }

    public entry fun get_white_list_claim_amount(arg0: &AirdropGlobal) : u64 {
        arg0.white_list_claim_amount
    }

    public fun increment(arg0: &mut AirdropGlobal, arg1: u64) {
        assert!(arg0.version == 0, 9);
        arg0.version = arg1;
    }
    ...
    public fun init_funds_from_main_contract(arg0: &mut AirdropGlobal, arg1: &mut 0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::Global, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.creator == 0x2::tx_context::sender(arg2), 2);
        0x2::balance::join<0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::SHUI>(&mut arg0.balance_SHUI, 0x7db2d08896f064c8abac8cab1c06df82e8b939a85e89bded6b8031754d4601e5::shui::extract_airdrop_balance(arg1, arg2));
    }
