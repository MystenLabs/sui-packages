module 0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::resolver {
    ...
    struct MergeProposal has key {
        ...
        attestations: vector<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::Attestation>,
    }
    ...
    public fun abort_merge(arg0: &0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::MemoryTree, arg1: &mut MergeProposal, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == status_pending(), 16);
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg1.proposed_by || v0 == 0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::owner(arg0), 1);
    ...
    public fun finalize_merge(arg0: &mut 0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::MemoryTree, arg1: &mut MergeProposal, arg2: &ResolverRef, arg3: vector<u8>, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == status_pending(), 16);
        assert!(0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::has_permission(arg0, 0x2::tx_context::sender(arg6), 0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::perm_merge(), &arg1.into_branch, 0x2::tx_context::epoch(arg6)), 2);
        assert!(0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::branch_head(arg0, &arg1.into_branch) == arg1.into_head, 18);
        assert!(verdict_approved(&arg2.config, arg2.kind, &arg1.attestations), 19);
        let v0 = 0x1::string::utf8(arg3);
        let v1 = 0x2::object::id<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::MemoryTree>(arg0);
        ...
        0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::advance_branch(arg0, &arg1.into_branch, arg4);
        ...
        let v4 = MergeFinalized{
            tree_id          : v1,
            proposal_id      : 0x2::object::id<MergeProposal>(arg1),
            merge_commit_id  : 0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::mint_merge_commit(v1, v2, v0, arg4, 0x2::tx_context::sender(arg6), arg1.into_branch, 0x1::string::utf8(b"merge"), arg1.resolver, arg1.attestations, 0x2::tx_context::epoch(arg6), arg5, arg6),
    ...
    public fun propose_merge(arg0: &0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::MemoryTree, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: &ResolverRef, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::string::utf8(arg1);
        let v1 = 0x1::string::utf8(arg2);
        let v2 = 0x2::tx_context::sender(arg8);
        assert!(0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::has_permission(arg0, v2, 0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::perm_propose(), &v0, 0x2::tx_context::epoch(arg8)), 2);
        assert!(0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::has_branch(arg0, &v0), 2);
        assert!(0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::has_branch(arg0, &v1), 2);
        let v3 = 0x2::object::id<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::MemoryTree>(arg0);
        ...
        let v6 = MergeProposal{
            ...
            attestations              : 0x1::vector::empty<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::Attestation>(),
        };
    ...
    public fun submit_attestation(arg0: &mut MergeProposal, arg1: &ResolverRef, arg2: u8, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::Attestation>(&mut arg0.attestations, 0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::new_attestation(v1, arg2, arg3));
    ...
    fun verdict_and(arg0: &vector<u8>, arg1: &vector<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::Attestation>) : bool {
        let v0 = 0x2::bcs::new(*arg0);
        let v1 = 0;
        while (v1 < 0x2::bcs::peel_vec_length(&mut v0)) {
            let v2 = 0x2::bcs::peel_vec_u8(&mut v0);
    ...
    fun verdict_approved(arg0: &vector<u8>, arg1: u8, arg2: &vector<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::Attestation>) : bool {
        if (arg1 == 0 || arg1 == 1) {
            return true
        };
        if (arg1 == 2) {
    ...
    fun verdict_jury(arg0: &vector<u8>, arg1: &vector<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::Attestation>) : bool {
        let v0 = 0x2::bcs::new(*arg0);
        let v1 = 0x2::bcs::peel_vec_address(&mut v0);
        ...
        let v3 = 0;
        let v4 = 0;
        while (v4 < 0x1::vector::length<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::Attestation>(arg1)) {
            let v5 = 0x1::vector::borrow<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::Attestation>(arg1, v4);
            let v6 = 0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::attest_signer(v5);
            let v7 = if (0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::attest_kind(v5) == 1) {
    ...
    fun verdict_llm(arg0: &vector<u8>, arg1: &vector<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::Attestation>) : bool {
        let v0 = 0x2::bcs::new(*arg0);
        let v1 = 0x2::bcs::peel_option_address(&mut v0);
        let v2 = 0;
        let v3 = 0;
        while (v3 < 0x1::vector::length<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::Attestation>(arg1)) {
            let v4 = 0x1::vector::borrow<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::Attestation>(arg1, v3);
            if (0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::attest_kind(v4) == 4) {
                if (0x1::option::is_some<address>(&v1)) {
                    if (0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::attest_signer(v4) == *0x1::option::borrow<address>(&v1)) {
                        v2 = v2 + 1;
                    };
                } else {
                    v2 = v2 + 1;
    ...
    fun verdict_sequence(arg0: &vector<u8>, arg1: &vector<0x7df9719d799386d34d657c49ae8cd6f5f03b39036f7c428b556095e42afd852f::tree::Attestation>) : bool {
