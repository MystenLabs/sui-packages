module 0x7d5c1d7a7d033aa3c865a4c6c8be93605518e80b991a4199d54d325877523d03::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"cm", b"COIn imag", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-18T12-34-36.486Z-crypto.webp")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"COIn imag"),
            symbol     : 0x1::string::utf8(b"cm"),
            decimals   : 9,
