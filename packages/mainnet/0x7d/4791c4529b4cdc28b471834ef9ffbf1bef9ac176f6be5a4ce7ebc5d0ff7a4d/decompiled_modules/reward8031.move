module 0x7d4791c4529b4cdc28b471834ef9ffbf1bef9ac176f6be5a4ce7ebc5d0ff7a4d::reward8031 {
    struct REWARD8031 has drop {
        dummy_field: bool,
    }

    struct TICKET_8031 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8031(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8031>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8031>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8031, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8031>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8031>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8031>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8031>>(v5, 0x2::tx_context::sender(arg1));
    }
