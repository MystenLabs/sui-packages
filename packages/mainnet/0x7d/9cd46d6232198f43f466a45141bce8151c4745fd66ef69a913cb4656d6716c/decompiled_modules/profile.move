module 0x7d9cd46d6232198f43f466a45141bce8151c4745fd66ef69a913cb4656d6716c::profile {
    ...
    public fun accept_link_address_request(arg0: &mut ProfileManager, arg1: LinkAddressRquest, arg2: &mut Profile, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::uid_to_inner(&arg2.id) == arg1.profile_id, 0x7d9cd46d6232198f43f466a45141bce8151c4745fd66ef69a913cb4656d6716c::error::not_authorized_error());
    ...
    public fun assert_address_profile_not_overlap_with_others(arg0: &ProfileManager, arg1: address, arg2: vector<address>) {
        assert!(!is_address_profile_overlap_with_others(arg0, arg1, arg2), 0x7d9cd46d6232198f43f466a45141bce8151c4745fd66ef69a913cb4656d6716c::error::address_not_belong_to_same_profile_error());
    }
    ...
    public fun assert_is_address_linked(arg0: &ProfileManager, arg1: address) {
        assert!(is_address_linked(arg0, arg1), 0x7d9cd46d6232198f43f466a45141bce8151c4745fd66ef69a913cb4656d6716c::error::address_not_linked_error());
    }

    public fun assert_is_address_not_linked(arg0: &ProfileManager, arg1: address) {
        assert!(!is_address_linked(arg0, arg1), 0x7d9cd46d6232198f43f466a45141bce8151c4745fd66ef69a913cb4656d6716c::error::address_has_linked_error());
    }

    public fun assert_is_addresses_in_same_profile(arg0: &ProfileManager, arg1: address, arg2: address) {
        assert!(is_addresses_in_same_profile(arg0, arg1, arg2), 0x7d9cd46d6232198f43f466a45141bce8151c4745fd66ef69a913cb4656d6716c::error::address_not_belong_to_same_profile_error());
    }
    ...
    public fun assert_is_profile_manager_admin(arg0: &ProfileManager, arg1: address) {
        assert!(is_profile_manager_admin(arg0, arg1), 0x7d9cd46d6232198f43f466a45141bce8151c4745fd66ef69a913cb4656d6716c::error::not_authorized_error());
    }
    ...
    fun internal_remove_linked_address(arg0: &mut ProfileManager, arg1: &mut Profile, arg2: address) {
        ...
        assert!(v0, 0x7d9cd46d6232198f43f466a45141bce8151c4745fd66ef69a913cb4656d6716c::error::not_authorized_error());
        ...
        assert!(0x2::object::uid_to_inner(&arg1.id) == v2.profile_id, 0x7d9cd46d6232198f43f466a45141bce8151c4745fd66ef69a913cb4656d6716c::error::not_authorized_error());
    }
    ...
    public fun profile_manager_add_admin(arg0: &mut ProfileManager, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x1::vector::contains<address>(&arg0.admins, &arg1), 0x7d9cd46d6232198f43f466a45141bce8151c4745fd66ef69a913cb4656d6716c::error::duplicated_error());
    ...
    public fun profile_manager_remove_admin(arg0: &mut ProfileManager, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 && 0x1::vector::length<address>(&arg0.admins) > 1, 0x7d9cd46d6232198f43f466a45141bce8151c4745fd66ef69a913cb4656d6716c::error::not_authorized_error());
    ...
    public fun transfer_profile_ownership(arg0: Profile, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::contains<address>(&arg0.linked_addresses, &arg1), 0x7d9cd46d6232198f43f466a45141bce8151c4745fd66ef69a913cb4656d6716c::error::not_authorized_error());
        arg0.owner = arg1;
        arg0.updated_at = 0x2::clock::timestamp_ms(arg2);
