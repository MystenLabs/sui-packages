module 0x7d5cc666e22714ec38ae40cd6c9a958751d5adf017294329f8d8988cb630a9b6::cnsnft2704 {
    struct CNSNFT2704 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2704, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2704>(arg0, arg1);
