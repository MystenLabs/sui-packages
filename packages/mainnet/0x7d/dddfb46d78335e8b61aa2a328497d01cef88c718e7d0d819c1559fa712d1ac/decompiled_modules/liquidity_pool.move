module 0x7ddddfb46d78335e8b61aa2a328497d01cef88c718e7d0d819c1559fa712d1ac::liquidity_pool {
    ...
    public fun complete_fulfill_swap_request<T0, T1, T2>(arg0: &BankOwnerCap<T0>, arg1: address, arg2: SwapHotPotato, arg3: &mut Bank<T0>, arg4: &0x2::clock::Clock, arg5: 0x2::coin::Coin<T2>, arg6: vector<u8>, arg7: u64, arg8: vector<vector<u8>>, arg9: u64, arg10: vector<u8>, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(arg3.version == 1, 1);
        assert!(arg3.transaction_digest != *0x2::tx_context::digest(arg11), 5);
        arg3.transaction_digest = *0x2::tx_context::digest(arg11);
        ...
        let v3 = &mut arg3.roots;
        assert!(0x1::vector::borrow<MerkleRootState>(v3, 0).epoch == arg9, 6);
        assert!(0x7ddddfb46d78335e8b61aa2a328497d01cef88c718e7d0d819c1559fa712d1ac::verification::verify_merkle_aggregation(arg7, arg10, arg8, 0x1::vector::borrow<MerkleRootState>(v3, 0).root), 7);
        assert!(0x7ddddfb46d78335e8b61aa2a328497d01cef88c718e7d0d819c1559fa712d1ac::alt_bn128_bls::verify(arg6, arg10, 0x7ddddfb46d78335e8b61aa2a328497d01cef88c718e7d0d819c1559fa712d1ac::verification::create_swap_message_hash(0x1::type_name::get<T1>(), v0.expected_input_amount, v0.minimum_output_amount, v0.valid_till, 0x2::address::to_bytes(arg1))), 8);
        let v4 = SwapEvent{
            user                : v0.user,
    ...
    public fun update_merkle_root_state<T0>(arg0: &BankOwnerCap<T0>, arg1: &mut Bank<T0>, arg2: u64, arg3: vector<u8>, arg4: u64, arg5: vector<vector<u8>>, arg6: vector<u8>, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x7ddddfb46d78335e8b61aa2a328497d01cef88c718e7d0d819c1559fa712d1ac::verification::verify_merkle_aggregation(arg4, arg6, arg5, 0x1::vector::borrow<MerkleRootState>(v0, 0).root), 7);
        assert!(0x7ddddfb46d78335e8b61aa2a328497d01cef88c718e7d0d819c1559fa712d1ac::alt_bn128_bls::verify(arg7, arg6, 0x7ddddfb46d78335e8b61aa2a328497d01cef88c718e7d0d819c1559fa712d1ac::verification::create_merkle_root_message_hash(arg3, arg2)), 8);
    ...
    public fun withdraw_tokens<T0, T1>(arg0: &BankOwnerCap<T0>, arg1: address, arg2: &mut Bank<T0>, arg3: address, arg4: u64, arg5: u64, arg6: u64, arg7: vector<vector<u8>>, arg8: u64, arg9: vector<u8>, arg10: vector<u8>, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.version == 1, 1);
        assert!(arg2.transaction_digest != *0x2::tx_context::digest(arg11), 5);
        arg2.transaction_digest = *0x2::tx_context::digest(arg11);
        let v0 = BalanceKey<T1>{dummy_field: false};
        let v1 = 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut 0x2::dynamic_field::borrow_mut<BalanceKey<T1>, BankBalance<T1>>(&mut arg2.id, v0).amount, arg4), arg11);
        0x2::table::add<address, bool>(&mut arg2.jupnet_withdraw_requests, arg1, true);
        let v2 = &mut arg2.roots;
        assert!(0x1::vector::borrow<MerkleRootState>(v2, 0).epoch == arg8, 6);
        assert!(0x7ddddfb46d78335e8b61aa2a328497d01cef88c718e7d0d819c1559fa712d1ac::verification::verify_merkle_aggregation(arg6, arg9, arg7, 0x1::vector::borrow<MerkleRootState>(v2, 0).root), 7);
        assert!(0x7ddddfb46d78335e8b61aa2a328497d01cef88c718e7d0d819c1559fa712d1ac::alt_bn128_bls::verify(arg10, arg9, 0x7ddddfb46d78335e8b61aa2a328497d01cef88c718e7d0d819c1559fa712d1ac::verification::create_withdrawal_message_hash(0x1::type_name::get<T1>(), arg4, arg5, arg3, arg9)), 8);
