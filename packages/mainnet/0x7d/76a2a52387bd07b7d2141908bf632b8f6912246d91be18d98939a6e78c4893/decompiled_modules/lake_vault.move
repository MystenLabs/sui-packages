module 0x7d76a2a52387bd07b7d2141908bf632b8f6912246d91be18d98939a6e78c4893::lake_vault {
    ...
    public fun new<T0, T1>(arg0: &AdminCap, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : LakeVault<T0, T1> {
        let v0 = LakeVault<T0, T1>{
            ...
            stake_table         : 0x2::table::new<address, StakeData<T0, T1>>(arg2),
    ...
    public fun default<T0, T1>(arg0: &AdminCap, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<LakeVault<T0, T1>>(new<T0, T1>(arg0, arg1, arg2));
    }
    ...
    public fun get_stake_data<T0, T1>(arg0: &LakeVault<T0, T1>, arg1: address, arg2: &0x2::clock::Clock) : StakeDataDisplay {
    ...
    public fun set_stake_cap<T0, T1>(arg0: &mut LakeVault<T0, T1>, arg1: &AdminCap, arg2: u64) {
        arg0.stake_cap = arg2;
    }
