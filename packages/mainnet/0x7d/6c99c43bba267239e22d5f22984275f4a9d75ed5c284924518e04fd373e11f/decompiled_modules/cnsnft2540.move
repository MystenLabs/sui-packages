module 0x7d6c99c43bba267239e22d5f22984275f4a9d75ed5c284924518e04fd373e11f::cnsnft2540 {
    struct CNSNFT2540 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2540, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2540>(arg0, arg1);
