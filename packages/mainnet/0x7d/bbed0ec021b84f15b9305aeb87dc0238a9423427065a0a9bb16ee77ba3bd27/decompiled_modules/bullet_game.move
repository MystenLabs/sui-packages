module 0xf58bb0ff50678cc11e3344aff2424359485592fa9d0f401387b83509183596c4::bullet_game {
    ...
    struct BurnPotEvent has copy, drop {
        amount: u64,
    }
    ...
    public fun burn_pot<T0>(arg0: &mut BurnPot<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg0.balance;
        let v1 = 0x2::balance::value<T0>(v0);
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(v0, v1, arg1), @0x0);
            let v2 = BurnPotEvent{amount: v1};
            0x2::event::emit<BurnPotEvent>(v2);
        };
    }
    ...
    public fun transfer_distribute_bets_cap(arg0: DistributeBetsCap, arg1: address) {
        0x2::transfer::transfer<DistributeBetsCap>(arg0, arg1);
    }

    public fun transfer_place_bet_cap(arg0: PlaceBetCap, arg1: address) {
        0x2::transfer::transfer<PlaceBetCap>(arg0, arg1);
    }
