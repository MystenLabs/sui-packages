module 0x7d9cdd02cfd2d475e1f7f5363f51f9c45e01ad404e387e373566d897fcd01a57::reward1003 {
    struct REWARD1003 has drop {
        dummy_field: bool,
    }

    struct TICKET_1003 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1003(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1003>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1003>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1003, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1003>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1003>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1003>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1003>>(v5, 0x2::tx_context::sender(arg1));
    }
