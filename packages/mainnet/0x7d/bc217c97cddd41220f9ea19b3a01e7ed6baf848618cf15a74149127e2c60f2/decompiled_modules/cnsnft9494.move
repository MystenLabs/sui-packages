module 0x7dbc217c97cddd41220f9ea19b3a01e7ed6baf848618cf15a74149127e2c60f2::cnsnft9494 {
    struct CNSNFT9494 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9494, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9494>(arg0, arg1);
