module 0x7d674478cee12050bbedb635bdda360dbaf369fc790645ec64e688cec07c82ba::router {
    ...
    public fun finalize_swap<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u16, arg6: address, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        if (arg5 > 0) {
            if (arg4) {
                ...
                let v2 = (((0x2::coin::value<T1>(&arg0) as u128) * (arg5 as u128) / 10000) as u64);
                if (v2 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg0, v2, arg7), arg6);
                    let v3 = Commission{
                        rate       : arg5,
                        direction  : arg4,
                        amount     : v2,
