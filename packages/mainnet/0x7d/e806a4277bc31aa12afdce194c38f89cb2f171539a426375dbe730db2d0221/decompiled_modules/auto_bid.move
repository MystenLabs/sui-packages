module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::auto_bid {
    ...
    entry fun exercise<T0, T1>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: &mut StrategyPoolV2, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        let v17 = v16;
        let v18 = 0x2::object::id<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::BidVault>(v16);
        let v19 = 0;
        while (v19 < v15) {
            let v20 = 0x2::table_vec::borrow_mut<StrategyV2>(v14, v19);
            if (!0x1::vector::is_empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v20.receipts)) {
                let v21 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_receipt_vid(0x1::vector::borrow<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v20.receipts, 0));
                if (v21 != v18) {
                    v18 = v21;
                    v17 = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_mut_bid_vault_by_id(v8, &v18);
                    break
                };
            };
            v19 = v19 + 1;
        ...
        let v22 = 0;
        while (v22 < v15) {
            let v23 = 0x2::table_vec::borrow_mut<StrategyV2>(v14, v22);
            if (!0x1::vector::is_empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v23.receipts)) {
                let v24 = 0x1::vector::empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>();
                let v25 = 0;
                let v26 = 0x1::vector::length<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v23.receipts);
                while (v25 < v26) {
                    if (v18 == 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_receipt_vid(0x1::vector::borrow<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v23.receipts, v25))) {
                        0x1::vector::push_back<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&mut v24, 0x1::vector::remove<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&mut v23.receipts, v25));
                        v26 = v26 - 1;
                        continue
                    };
                    v25 = v25 + 1;
                };
                if (!0x1::vector::is_empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v24)) {
                    let (v27, v28, v29) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::delegate_exercise<T0>(v17, v24);
                    if (!0x2::dynamic_field::exists_<0x1::string::String>(&v23.id, 0x1::string::utf8(b"profit"))) {
                        0x2::dynamic_field::add<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v23.id, 0x1::string::utf8(b"profit"), 0x2::balance::zero<T0>());
                    };
                    0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v23.id, 0x1::string::utf8(b"profit")), v29);
                    v23.accumulated_profit = v23.accumulated_profit + v27;
                    0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::emit_exercise_event(v13, v27, v28, 0x1::option::none<0x1::type_name::TypeName>(), 0, v23.user);
                    update_u64_padding<T0, T1>(v23);
                    let v30 = 0x1::vector::borrow_mut<u64>(&mut v23.u64_padding, 2);
                    *v30 = *v30 + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_vault_u64_padding_value(v17, 1) * v28 / 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_o_token_decimal(v13)) * 11000 / 10000 * (10000 - 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_vault_u64_padding_value(v17, 2)) / 10000;
                } else {
                    0x1::vector::destroy_empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(v24);
                };
            };
            v22 = v22 + 1;
        };
