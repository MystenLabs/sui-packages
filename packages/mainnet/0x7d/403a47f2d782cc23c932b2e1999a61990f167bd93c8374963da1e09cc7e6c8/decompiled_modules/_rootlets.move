module 0x7d403a47f2d782cc23c932b2e1999a61990f167bd93c8374963da1e09cc7e6c8::_rootlets {
    struct _ROOTLETS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _ROOTLETS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_ROOTLETS>(arg0, arg1);
