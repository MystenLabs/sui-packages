module 0x7dafdc4f52dd75cbac15aa2de86c56be280f72b4e51786e15368a08bfd85b50c::health_data_pool {
    ...
    public entry fun create_pool<T0>(arg0: &AdminCap, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: vector<vector<u8>>, arg9: u8, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<vector<u8>>(&arg8);
        assert!(v0 > 0, 19);
        assert!((arg9 as u64) > 0 && (arg9 as u64) <= v0, 18);
        assert!(arg5 > 0x2::clock::timestamp_ms(arg10), 4);
        let v1 = if (arg7) {
            0
        } else {
            arg5 + arg6
        ...
        let v2 = Pool<T0>{
            ...
            stake_per_user           : arg2,
            reward_per_user          : arg3,
            required_participants    : arg4,
            current_participants     : 0,
            commencement_deadline_ms : arg5,
            contract_length_ms       : arg6,
            is_rolling               : arg7,
            pool_ends_ms             : v1,
            status                   : 0,
            participants             : 0x2::table::new<address, Participant<T0>>(arg11),
            oracle_signers           : arg8,
            oracle_threshold         : arg9,
            used_nonces              : 0x2::table::new<vector<u8>, bool>(arg11),
        };
        let v3 = PoolCreated{
    ...
    public entry fun join_pool<T0>(arg0: &mut Pool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<T0>(&arg1) == arg0.stake_per_user, 12);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(!0x2::table::contains<address, Participant<T0>>(&arg0.participants, v0), 7);
        let v1 = 0x2::clock::timestamp_ms(arg2);
        let v2 = if (arg0.is_rolling) {
            v1 + arg0.contract_length_ms
        } else {
            arg0.commencement_deadline_ms + arg0.contract_length_ms
        };
        let v3 = Participant<T0>{
            stake            : 0x2::coin::into_balance<T0>(arg1),
            joined_at_ms     : v1,
            contract_ends_ms : v2,
            claimed          : false,
            flagged          : false,
        };
        0x2::table::add<address, Participant<T0>>(&mut arg0.participants, v0, v3);
        arg0.current_participants = arg0.current_participants + 1;
        if (arg0.status == 0 && arg0.current_participants >= arg0.required_participants) {
            arg0.status = 1;
            let v4 = PoolLive{
                pool_id : 0x2::object::id<Pool<T0>>(arg0),
                at_ms   : v1,
            };
            0x2::event::emit<PoolLive>(v4);
        };
        let v5 = ParticipantJoined{
            pool_id              : 0x2::object::id<Pool<T0>>(arg0),
            participant          : v0,
            contract_ends_ms     : v2,
            current_participants : arg0.current_participants,
        };
