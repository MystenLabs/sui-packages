module 0x7d174764575e04a0d846a7493fc0cf2c6ac6dd00c14414434903aa3706064f62::cnsnft2665 {
    struct CNSNFT2665 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2665, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2665>(arg0, arg1);
