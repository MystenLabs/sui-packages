module 0x7d44ddf461ff0ddac303e66c3d9730b065d917c457301efcfb8fe0d29a514cd6::puppybears {
    struct PUPPYBEARS has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"9718745f-0371-40f2-953b-6aaed015db4e"),
        };
        0x2::event::emit<AddNftMetadataEvent>(v0);
    }

    fun init(arg0: PUPPYBEARS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PUPPYBEARS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"puppybears"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x"726f616d696e672070757070796265617273f09f8cbb20617274206275696c74206279206578206469736e65792c206e69636b656c6f64656f6e2c206d617474656c2c206e6574666c6978202b20616d617a6f6e20616e696d61746f727320f09f8cbc20776f6f66"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"https://byzantion.mypinata.cloud/ipfs/QmVbx2S1knkENpm2icePWCCLK5bgMhmhGgcEJHYeJAfZX6"));
