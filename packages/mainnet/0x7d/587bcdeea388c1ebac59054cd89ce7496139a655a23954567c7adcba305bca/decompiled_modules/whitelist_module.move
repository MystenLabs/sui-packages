module 0x7d587bcdeea388c1ebac59054cd89ce7496139a655a23954567c7adcba305bca::whitelist_module {
    ...
    public fun add_whitelist(arg0: &mut WhitelistContainer, arg1: vector<address>, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < v0) {
            ...
            let v4 = existed(arg0, *v2);
            if (v4 == false) {
                let v5 = arg0.elements;
                let v6 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Whitelist>(&mut arg0.id, *0x1::vector::borrow<0x2::object::ID>(&v5, 0x1::vector::length<0x2::object::ID>(&v5) - 1));
                let v7 = v6.whitelist_elements;
                if (0x1::vector::length<WhiteListElement>(&v7) < 100) {
                    let v8 = WhiteListElement{
                        wallet_address : *v2,
                        limit          : *v3,
                        bought         : 0,
                    };
                    0x1::vector::push_back<WhiteListElement>(&mut v6.whitelist_elements, v8);
                } else {
                    let v9 = 0x1::vector::empty<WhiteListElement>();
                    let v10 = WhiteListElement{
                        wallet_address : *v2,
                        limit          : *v3,
                        bought         : 0,
                    };
                    0x1::vector::push_back<WhiteListElement>(&mut v9, v10);
                    let v11 = Whitelist{
                        id                 : 0x2::object::new(arg3),
                        whitelist_elements : v9,
                    };
                    let v12 = 0x2::object::id<Whitelist>(&v11);
                    0x1::vector::push_back<0x2::object::ID>(&mut arg0.elements, v12);
                    0x2::dynamic_object_field::add<0x2::object::ID, Whitelist>(&mut arg0.id, v12, v11);
                };
            };
            v1 = v1 + 1;
        };
        let v13 = AddWhitelistEvent{
            round_id : arg0.owner,
            wallets  : arg1,
            limits   : arg2,
            boughts  : 0x1::vector::empty<u64>(),
        };
        0x2::event::emit<AddWhitelistEvent>(v13);
    }
