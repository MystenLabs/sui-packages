module 0x7d70ece20621739b81eb04a8f747439ee865c90c10d7696b9b04b9307b1b89fa::bet_manager {
    public fun black() : u8 {
        1
    }
    ...
    public fun won_bet(arg0: u8, arg1: u64, arg2: 0x1::option::Option<u64>) : bool {
        ...
        if (arg0 == 73) {
            let v0 = vector[0, 37, 2];
            return 0x1::vector::contains<u64>(&v0, &arg1)
        };
        if (arg0 == 74) {
            let v1 = vector[37, 2, 3];
            return 0x1::vector::contains<u64>(&v1, &arg1)
        };
        if (arg0 == 75) {
            let v2 = vector[0, 1, 2];
