module 0xe5099fcd45747074d0ef5eabce07a9bd1c3b0c1862435bf2a09c3a81e0604373::router {
    ...
    fun assert_acceptable_slippage_on_amount_out() {
        abort 5
    }
    ...
    public fun begin_router_tx_r1_w1<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: u64, arg3: &0xe5099fcd45747074d0ef5eabce07a9bd1c3b0c1862435bf2a09c3a81e0604373::protocol_fee::ProtocolFeeConfig, arg4: &0xe5099fcd45747074d0ef5eabce07a9bd1c3b0c1862435bf2a09c3a81e0604373::treasury::Treasury, arg5: address, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : RouterSwapCapExtended<RouterDataV1, WrapperDataV1<T0>> {
        begin_router_tx_r1_w1_varied_in<T0, T1>(arg0, 0x2::coin::value<T0>(&arg0), arg1, arg2, arg3, arg4, arg5, arg6, arg7)
    }

    public fun begin_router_tx_r1_w1_varied_in<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xe5099fcd45747074d0ef5eabce07a9bd1c3b0c1862435bf2a09c3a81e0604373::protocol_fee::ProtocolFeeConfig, arg5: &0xe5099fcd45747074d0ef5eabce07a9bd1c3b0c1862435bf2a09c3a81e0604373::treasury::Treasury, arg6: address, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : RouterSwapCapExtended<RouterDataV1, WrapperDataV1<T0>> {
        let v0 = 0x2::coin::into_balance<T0>(arg0);
        let v1 = 0x2::balance::value<T0>(&v0);
        if (v1 != arg1) {
            let v2 = (arg2 as u128) * (v1 as u128) / (arg1 as u128);
            arg2 = (v2 as u64);
        };
        assert_route_starts_with_non_zero_value(v1);
        let v3 = if (arg6 != @0x0 && arg7 != 0) {
            let v4 = 0x2::coin::take<T0>(&mut v0, 0xe5099fcd45747074d0ef5eabce07a9bd1c3b0c1862435bf2a09c3a81e0604373::protocol_fee::take_percent_base_18(v1, arg7), arg8);
            collect_integrator_fee<T0>(arg4, arg5, v4, arg6, arg8)
        } else {
        ...
        let v5 = RouterDataV1{
            ...
            slippage               : arg3,
            protocol_fee_recipient : 0xe5099fcd45747074d0ef5eabce07a9bd1c3b0c1862435bf2a09c3a81e0604373::protocol_fee::dev_wallet(arg4),
            integrator_fee_config  : v3,
    ...
    public fun end_router_tx_r1_w1<T0, T1>(arg0: RouterSwapCapExtended<RouterDataV1, WrapperDataV1<T0>>, arg1: &mut 0x2::balance::Balance<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v16 = if (v1 > v10) {
            let v17 = v1 - v10;
            let v18 = 0x1::u64::min(v17 - v17 / 10, v1 / 100);
            let v19 = 0x2::coin::take<T1>(arg1, v18, arg2);
            if (v15.recipient == @0x0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v19, v12);
                0
            } else {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v19, v18 / 2, arg2), v15.recipient);
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v19, v12);
                0x2::coin::value<T1>(&v19)
            }
        } else {
            if (v1 < v10 - (((v10 as u128) * (v11 as u128) / 1000000000000000000) as u64)) {
                assert_acceptable_slippage_on_amount_out();
            };
            0
        };
        0xe5099fcd45747074d0ef5eabce07a9bd1c3b0c1862435bf2a09c3a81e0604373::events::emit_swap_completed_event(v9.type, v9.amount, v15.fee_percent_base_18, v14, v8.type, 0x2::balance::value<T1>(arg1), v16, v15.recipient, arg2);
    }
