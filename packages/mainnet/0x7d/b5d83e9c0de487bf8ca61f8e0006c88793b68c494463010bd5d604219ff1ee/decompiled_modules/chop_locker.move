module 0x7db5d83e9c0de487bf8ca61f8e0006c88793b68c494463010bd5d604219ff1ee::chop_locker {
    ...
    public fun calculate_apy<T0>(arg0: &0x2::balance::Balance<T0>, arg1: u64, arg2: &0x2::balance::Balance<T0>, arg3: u64) : u64 {
        ...
        let v0 = 365;
        let v1 = (0x2::balance::value<T0>(arg0) as u128) * (1000000 as u128) / (arg1 as u128) * ((0x2::balance::value<T0>(arg2) / v0) as u128) * (1000000 as u128) / (v0 as u128) / 1000000000 * (((100 * arg3 / 90 + 50) * 1000) as u128) * (365 as u128) * (1000000 as u128) * 100 / 1;
