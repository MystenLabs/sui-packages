module 0x7dbdcafa0475b0c10370e69b0fef626ae016a204a95c621d4fb6a57abab1a65c::wyst {
    struct WYST has drop {
        dummy_field: bool,
    }

    fun init(arg0: WYST, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<WYST>(arg0, 1, b"WYST", b"Demo Wyoming stable token", b"Demon of a token wit compliance features", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://en.wikipedia.org/wiki/File:Bucking_Horse_and_Rider_logo.png")), true, arg1);
        let v3 = v0;
