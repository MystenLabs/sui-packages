module 0x7dd03ca2dfff17c40fd0b6d9e85b5e68f12499e68d35e5e8483a4c16409bfe42::current_lp_provider {
    ...
    fun assert_valid_package_version(arg0: &CurrentLpProvider) {
        ...
        assert!(0x2::vec_set::contains<u16>(&arg0.versions, &v0), 13906834943142592514);
    }

    fun assert_valid_usdb_manager(arg0: &CurrentLpProvider, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x2::vec_set::contains<address>(&arg0.usdb_managers, &v0), 13906834960322592772);
    }
