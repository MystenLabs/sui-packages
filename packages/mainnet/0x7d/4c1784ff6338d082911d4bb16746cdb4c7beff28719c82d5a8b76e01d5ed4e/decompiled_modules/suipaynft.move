module 0x7d4c1784ff6338d082911d4bb16746cdb4c7beff28719c82d5a8b76e01d5ed4e::suipaynft {
    ...
    fun init(arg0: SUIPAYNFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<NFT>>(v23, 0x2::tx_context::sender(arg1));
        let v24 = ContractInfo{
        ...
        0x2::transfer::share_object<ContractInfo>(v24);
    ...
    fun mint0(arg0: &mut ContractInfo, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u8, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        payment_processing(arg1, v0, arg0.owner_address, v3, arg5);
        let v4 = 0x2::tx_context::sender(arg5);
        mintInternal(arg0, arg2, 0, 0x1::string::utf8(b"Supporter"), v4, arg3, arg4, arg5)
    }
    ...
    fun mintInternal(arg0: &mut ContractInfo, arg1: u8, arg2: u16, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        if (arg2 == 0) {
            arg2 = ((0x7d4c1784ff6338d082911d4bb16746cdb4c7beff28719c82d5a8b76e01d5ed4e::pseudorandom::rand_u32(arg7) % 65535) as u16);
        };
