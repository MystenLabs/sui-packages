module 0x7d2a68288a8687c54901d3e47511dc65c5a41c50d09378305c556a65cbe2f782::thunder {
    ...
    entry fun signal(arg0: &mut Storm, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, arg1)) {
            let v3 = 0x2::dynamic_field::borrow_mut<vector<u8>, Ragtag>(&mut arg0.id, arg1);
            ...
            0x2::dynamic_field::add<vector<u8>, Ragtag>(&mut arg0.id, arg1, v5);
        };
        let v6 = Signaled{
            name_hash    : arg1,
            timestamp_ms : v1,
