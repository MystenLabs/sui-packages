module 0x7df9ceb15c66027275d3bf3741ea2b9fde7d55aceebab23d71353d035a582356::reward9727 {
    struct REWARD9727 has drop {
        dummy_field: bool,
    }

    struct TICKET_9727 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9727(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9727>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9727>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9727, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9727>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9727>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9727>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9727>>(v5, 0x2::tx_context::sender(arg1));
    }
