module 0xd3453d9be7e35efe222f78a810bb3af1859fd1600926afced8b4936d825c9a05::vaults {
    ...
    public fun checked_package_version(arg0: &VaultsManager) {
        assert!(12 >= arg0.package_version, 3);
    }
    ...
    public fun governance_migrate_position<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::rewarder::RewarderManager, arg3: &0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::config::GlobalConfig, arg4: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::Pool, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position {
        check_emergency_restore_version(arg0);
        check_rebalance_role(arg0, 0x2::tx_context::sender(arg8));
        assert!(arg1.is_pause, 33);
        assert!(arg1.status == 1, 17);
        assert!(0x1::vector::length<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&arg1.positions) == 1, 2);
        ...
        let v1 = 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::withdraw(arg3, arg2, arg4, v0, arg7);
        let (v2, v3) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::tick_range(&v1);
        let v4 = 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v1);
        let v5 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::info_liquidity(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::borrow_position_info<T0, T1>(arg6, v4));
        let v6 = &mut v1;
        let (v7, v8) = remove_liquidity_from_clmm<T0, T1>(arg5, arg6, v6, v5, 0, 0, arg7);
        let v9 = v8;
        let v10 = v7;
        let v11 = 0x2::balance::value<T0>(&v10);
        let v12 = 0x2::balance::value<T1>(&v9);
        let v13 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::open_position<T0, T1>(arg5, arg6, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(v2), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(v3), arg8);
        let v14 = 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v13);
        let v15 = 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::deposit_v2<T0, T1>(arg3, arg2, arg4, arg6, v13, arg7, arg8);
        let v16 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg6);
        let (v17, v18, v19) = check_is_fix_coin_a(v2, v3, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_tick_index<T0, T1>(arg6), v16, v11, v12);
        let (v20, v21) = if (v17) {
            (v11, v19 + v19 * (0x2::table::borrow<0x2::object::ID, OracleInfo>(&arg0.price_oracles, new_pool_key<T0, T1>()).slippage as u64) / 2000)
        } else {
            (v18 + v18 * (0x2::table::borrow<0x2::object::ID, OracleInfo>(&arg0.price_oracles, new_pool_key<T0, T1>()).slippage as u64) / 2000, v12)
        };
        let (v22, v23) = 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::add_liquidity_fix_coin<T0, T1>(arg3, arg5, arg2, arg4, arg6, &mut v15, 0x2::coin::from_balance<T0>(v10, arg8), 0x2::coin::from_balance<T1>(v9, arg8), v20, v21, v17, arg7, arg8);
        let v24 = v23;
        let v25 = v22;
        let v26 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::info_liquidity(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::borrow_position_info<T0, T1>(arg6, v14));
        assert!(v26 > 0, 30);
        arg1.liquidity = v26;
        let v27 = if (v17) {
            assert!(0x2::balance::value<T0>(&v25) == 0, 8);
            0x2::balance::value<T1>(&v24)
        } else {
            assert!(0x2::balance::value<T1>(&v24) == 0, 8);
            0x2::balance::value<T0>(&v25)
        };
        let v28 = MigrateLiquidityEvent{
            vault_id             : 0x2::object::id<Vault<T2>>(arg1),
            old_position         : v4,
            new_position         : v14,
            ...
            new_wrapped_position : 0x2::object::id<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&v15),
            remaining_amount     : v27,
            old_tick_lower       : v2,
            old_tick_upper       : v3,
            old_liquidity        : v5,
            new_liquidity        : v26,
            current_sqrt_price   : v16,
            tick_lower           : v2,
            tick_upper           : v3,
        };
        0x2::event::emit<MigrateLiquidityEvent>(v28);
        merge_harvest_asset<T0, T2>(arg1, v25);
        merge_harvest_asset<T1, T2>(arg1, v24);
        0x1::vector::push_back<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&mut arg1.positions, v15);
        v1
    }
