module 0x7d708ee667a1ae667d36ab592d931cd7e916a61cc5e992fe113e495332467d65::reward4968 {
    struct REWARD4968 has drop {
        dummy_field: bool,
    }

    struct TICKET_4968 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4968(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4968>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4968>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4968, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4968>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4968>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4968>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4968>>(v5, 0x2::tx_context::sender(arg1));
    }
