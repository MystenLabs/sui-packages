module 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid {
    ...
    public entry fun change_fee(arg0: &mut LiquidStore, arg1: &AdminCap, arg2: &mut 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 16, 5);
        if (arg3 > 50) {
            abort 9
        };
        0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::set_metadata_token_fee_permyriad(arg2, arg3);
    }
    ...
    public entry fun deposit_v2(arg0: &mut LiquidStore, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = deposit_v2_no_entry(arg0, arg1, arg2, arg3, arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN>>(v0, 0x2::tx_context::sender(arg4));
    }

    public entry fun deposit_v2_limit(arg0: &mut LiquidStore, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg3: u64, arg4: &mut 0x3::sui_system::SuiSystemState, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = deposit_v2_no_entry(arg0, arg1, arg2, arg4, arg5);
        if (0x2::coin::value<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN>(&v0) < arg3) {
            abort 10
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN>>(v0, 0x2::tx_context::sender(arg5));
    }

    public fun deposit_v2_no_entry(arg0: &mut LiquidStore, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN> {
        assert!(arg0.version == 16, 5);
        let v0 = get_current_price_reverse(arg0, arg3, arg4);
        0x2::coin::put<0x2::sui::SUI>(&mut arg0.pending_pool, arg1);
        let v1 = 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::mint_and_return(0x1::option::borrow_mut<0x2::coin::TreasuryCap<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN>>(&mut arg0.treasury), (((0x2::coin::value<0x2::sui::SUI>(&arg1) as u128) * (v0 as u128) / (1000000000 as u128)) as u64), arg4);
        let v2 = PriceEvent{
            price         : 0,
            price_reverse : v0,
        };
    ...
    public entry fun fulfill_v2(arg0: &mut LiquidStore, arg1: LiquidStoreWithdrawPromise, arg2: &mut 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = fulfill_v2_no_entry(arg0, arg1, arg2, arg3, arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v0, 0x2::tx_context::sender(arg4));
    }

    public fun fulfill_v2_no_entry(arg0: &mut LiquidStore, arg1: LiquidStoreWithdrawPromise, arg2: &mut 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        assert!(arg0.version == 16, 5);
        assert!(arg1.fulfilled_at_epoch <= 0x2::tx_context::epoch(arg4), 2);
        once_per_epoch_if_needed_v2(arg0, arg2, arg3, arg4);
        let v0 = if (0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_promised_pool::is_there_promised_staked_sui(&arg0.promised_pool, 0x2::object::id<LiquidStoreWithdrawPromise>(&arg1))) {
            0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_promised_pool::take_promised_staked_sui(&mut arg0.promised_pool, 0x2::object::id<LiquidStoreWithdrawPromise>(&arg1), arg3, arg4)
        } else {
            0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_promised_pool::take_sui(&mut arg0.promised_pool, arg1.sui_amount, arg4)
        };
        if (arg1.sui_amount > 0x2::coin::value<0x2::sui::SUI>(&v0)) {
            abort 10
        };
    ...
    fun gather_development_fees_and_increment_epoch_v2(arg0: &mut LiquidStore, arg1: &0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 > v1) {
            ...
            0x2::coin::put<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN>(&mut arg0.fee_pool_token, 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::mint_and_return(0x1::option::borrow_mut<0x2::coin::TreasuryCap<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN>>(&mut arg0.treasury), (((get_token_supply(arg0) as u128) * ((0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::get_metadata_token_fee_permyriad(arg1, 50) * (v0 - v1)) as u128) / 3650000) as u64), arg3));
    ...
    public entry fun once_per_epoch_if_needed_v2(arg0: &mut LiquidStore, arg1: &mut 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 > arg0.liquid_store_epoch) {
            ...
            gather_development_fees_and_increment_epoch_v2(arg0, arg1, arg2, arg3);
    ...
    public(friend) fun store_epoch(arg0: &LiquidStore) : u64 {
        arg0.liquid_store_epoch
    }
    ...
    public entry fun withdraw_fast(arg0: &mut LiquidStore, arg1: 0x2::coin::Coin<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN>, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = withdraw_fast_no_entry(arg0, arg1, arg2, arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v0, 0x2::tx_context::sender(arg3));
    }

    public entry fun withdraw_fast_limit(arg0: &mut LiquidStore, arg1: 0x2::coin::Coin<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN>, arg2: u64, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = withdraw_fast_no_entry(arg0, arg1, arg3, arg4);
    ...
    public fun withdraw_fast_no_entry(arg0: &mut LiquidStore, arg1: 0x2::coin::Coin<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN>, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        assert!(arg0.version == 16, 5);
        ...
        0x2::coin::take<0x2::sui::SUI>(&mut v5, v2 - (v17 as u64), arg3)
    }
    ...
    public entry fun withdraw_v2(arg0: &mut LiquidStore, arg1: 0x2::coin::Coin<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN>, arg2: &mut 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = withdraw_v2_no_entry(arg0, arg1, arg2, arg3, arg4);
        0x2::transfer::public_transfer<LiquidStoreWithdrawPromise>(v0, 0x2::tx_context::sender(arg4));
    }

    public entry fun withdraw_v2_limit(arg0: &mut LiquidStore, arg1: 0x2::coin::Coin<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN>, arg2: &mut 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg3: u64, arg4: &mut 0x3::sui_system::SuiSystemState, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = withdraw_v2_no_entry(arg0, arg1, arg2, arg4, arg5);
        if (v0.sui_amount < arg3) {
            abort 10
        };
        0x2::transfer::public_transfer<LiquidStoreWithdrawPromise>(v0, 0x2::tx_context::sender(arg5));
    }

    public fun withdraw_v2_no_entry(arg0: &mut LiquidStore, arg1: 0x2::coin::Coin<0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_coin::SUIDOUBLE_LIQUID_COIN>, arg2: &mut 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) : LiquidStoreWithdrawPromise {
        assert!(arg0.version == 16, 5);
