module 0x7d852db572f4f5bd7fecdb11c3fb4be465ad7fe6ad2eb9965fbf6b7fa9e21af8::reward1196 {
    struct REWARD1196 has drop {
        dummy_field: bool,
    }

    struct TICKET_1196 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1196(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1196>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1196>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1196, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1196>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1196>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1196>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1196>>(v5, 0x2::tx_context::sender(arg1));
    }
