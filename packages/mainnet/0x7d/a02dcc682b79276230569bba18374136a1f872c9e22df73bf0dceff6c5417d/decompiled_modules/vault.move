module 0x220caae17de736a4f02d34c2e3a62deb7f7981e7eeb970ccb477c7b23576d3b7::vault {
    ...
    public fun compute_health_factor(arg0: &LoanInfo, arg1: u64, arg2: u64) : u64 {
        (((arg0.collateral_amount as u128) * (arg1 as u128) * ((arg2 + 500) as u128) / (1000000000 as u128) * (arg0.principal as u128)) as u64)
    }

    public fun compute_health_factor_inverse(arg0: &LoanInfo, arg1: u64, arg2: u64) : u64 {
        (((arg0.collateral_amount as u128) * (1000000000 as u128) * ((arg2 + 500) as u128) / (arg1 as u128) * (arg0.principal as u128)) as u64)
    }
