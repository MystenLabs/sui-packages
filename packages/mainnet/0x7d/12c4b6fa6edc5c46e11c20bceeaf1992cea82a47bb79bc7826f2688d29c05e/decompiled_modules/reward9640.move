module 0x7d12c4b6fa6edc5c46e11c20bceeaf1992cea82a47bb79bc7826f2688d29c05e::reward9640 {
    struct REWARD9640 has drop {
        dummy_field: bool,
    }

    struct TICKET_9640 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9640(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9640>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9640>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9640, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9640>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9640>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9640>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9640>>(v5, 0x2::tx_context::sender(arg1));
    }
