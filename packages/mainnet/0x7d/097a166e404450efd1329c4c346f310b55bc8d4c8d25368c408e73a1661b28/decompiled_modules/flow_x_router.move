module 0x7d097a166e404450efd1329c4c346f310b55bc8d4c8d25368c408e73a1661b28::flow_x_router {
    ...
    public entry fun buy_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x7d097a166e404450efd1329c4c346f310b55bc8d4c8d25368c408e73a1661b28::utils::send_coin<T0>(v2, 0x2::tx_context::sender(arg4));
        0x7d097a166e404450efd1329c4c346f310b55bc8d4c8d25368c408e73a1661b28::utils::send_coin<0x2::sui::SUI>(arg3, 0x2::tx_context::sender(arg4));
        0x7d097a166e404450efd1329c4c346f310b55bc8d4c8d25368c408e73a1661b28::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, v0, arg4), arg0.admin);
        let v3 = BuyEvent<T0>{
    ...
    public entry fun sell_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x7d097a166e404450efd1329c4c346f310b55bc8d4c8d25368c408e73a1661b28::utils::send_coin<T0>(arg3, 0x2::tx_context::sender(arg4));
        0x7d097a166e404450efd1329c4c346f310b55bc8d4c8d25368c408e73a1661b28::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg4));
        0x7d097a166e404450efd1329c4c346f310b55bc8d4c8d25368c408e73a1661b28::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v2, arg4), arg0.admin);
        let v3 = SellEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg4),
            amount_in  : arg2,
            amount_out : v1 - v2,
    ...
    public entry fun sell_exact_out<T0>(arg0: &FeeObject, arg1: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg2: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::PairMetadata<T0, 0x2::sui::SUI>, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x7d097a166e404450efd1329c4c346f310b55bc8d4c8d25368c408e73a1661b28::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg6));
        0x7d097a166e404450efd1329c4c346f310b55bc8d4c8d25368c408e73a1661b28::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v1, arg6), arg0.admin);
        let v2 = SellEvent<T0>{
