module 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::hd4b1f {
    ...
    public(friend) fun h350bd(arg0: &0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::orderbook::Orderbook, arg1: &mut vector<0x1::option::Option<u128>>) : H5fd6f {
        0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h95cce::h21ed2(arg1);
        let v0 = H5fd6f{
            h8b8ea : vector[],
            h5db44 : vector[],
            hf2776 : vector[],
        ...
        while (v1 < 0x1::vector::length<0x1::option::Option<u128>>(arg1)) {
            ...
            if (0x1::option::is_some<u128>(v2)) {
                ...
                let v4 = 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::orderbook::get_order(arg0, v3);
                if (0x1::option::is_some<0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::orderbook::Order>(&v4)) {
                    let v5 = 0x1::option::extract<0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::orderbook::Order>(&mut v4);
                    let (_, v7, _, v9, _, _) = 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::orderbook::as_parts(&v5);
                    0x1::vector::push_back<u128>(&mut v0.h8b8ea, v3);
                    0x1::vector::push_back<u64>(&mut v0.h5db44, 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h5a57f::h321c0(v3));
    ...
    public(friend) fun h60fb1(arg0: &mut H5fd6f, arg1: &vector<u64>, arg2: &vector<u64>, arg3: &vector<u64>, arg4: &vector<u64>, arg5: &vector<u64>, arg6: &vector<u64>, arg7: &vector<u64>, arg8: u64, arg9: u64, arg10: u64, arg11: bool, arg12: u64, arg13: u64, arg14: &0x1::option::Option<u64>, arg15: &0x1::option::Option<u64>, arg16: u64, arg17: &mut u256, arg18: &mut vector<u64>, arg19: u64) {
        ...
        while (v0 < 0x1::vector::length<u64>(arg1)) {
            ...
            v0 = v0 + 1;
            let v2 = 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h5a57f::h8da4b(arg11, *0x1::vector::borrow<u64>(arg2, v1), arg12, arg14, arg15, 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h5a57f::he2d3a(arg6, v1), arg7);
            ...
            while (v7 < 0x1::vector::length<u128>(&arg0.h8b8ea)) {
                if (!*0x1::vector::borrow<bool>(&arg0.h914ca, v7) && !*0x1::vector::borrow<bool>(&arg0.hbdc54, v7)) {
                    ...
                    if (v11) {
                        let v12 = 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h5a57f::h9aa0e(*0x1::vector::borrow<u64>(&arg0.hf2776, v7), arg16);
                        if (v12 > *arg17) {
                            v6 = true;
                        } else {
                            *arg17 = *arg17 - v12;
            ...
            if (!v5) {
                if (v6) {
                    0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h1ec67::h67a26(531, v1, arg19);
                };
                0x1::vector::push_back<u64>(arg18, v1);
            };
        };
    ...
    fun hbecec(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u256) : u64 {
        ...
        if (arg6 > 0 && 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h5a57f::h9aa0e(arg1, arg0) < arg6) {
            return 507
        };
        0
    }
    ...
    public(friend) fun hca436(arg0: &vector<u64>, arg1: bool, arg2: &vector<u64>, arg3: &vector<u64>, arg4: &vector<u64>, arg5: &vector<u64>, arg6: &vector<u64>, arg7: u64, arg8: u64, arg9: u64, arg10: u256, arg11: &0x1::option::Option<u64>, arg12: &0x1::option::Option<u64>, arg13: u64, arg14: &mut u256, arg15: u256, arg16: u64) : H2226f {
        ...
        while (v4 < 0x1::vector::length<u64>(arg0)) {
            ...
            v4 = v4 + 1;
            let v6 = 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h5a57f::h8da4b(arg1, *0x1::vector::borrow<u64>(arg2, v5), arg8, arg11, arg12, 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h5a57f::he2d3a(arg5, v5), arg6);
            if (0x1::option::is_none<u64>(&v6)) {
                0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h1ec67::h67a26(517, v5, arg16);
            ...
            if (v8 == 0) {
                if (*arg14 < arg15) {
                    ...
                    let v12 = 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h5a57f::h9aa0e(v11, arg13);
                    if (v12 <= *arg14) {
                        ...
                        *arg14 = 0;
                        if (v13 == 0 || arg10 > 0 && 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h5a57f::h9aa0e(v13, arg13) < arg10) {
                            v9 = 526;
                        } else {
                            v10 = v13;
                        };
            ...
            if (v9 != 0) {
                0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h1ec67::h67a26(v9, v5, arg16);
                v10 = 0;
            } else {
                v3 = true;
            };
    ...
    public(friend) fun hde79f(arg0: &vector<u64>, arg1: bool, arg2: bool, arg3: &vector<u64>, arg4: &vector<u64>, arg5: &vector<u64>, arg6: u64, arg7: u64, arg8: u64, arg9: u256, arg10: &0x1::option::Option<u64>, arg11: &0x1::option::Option<u64>, arg12: &0x1::option::Option<u64>, arg13: u64, arg14: &mut u256, arg15: u64) : H2226f {
        ...
        while (v6 < v5) {
            ...
            if (v9 == 0) {
                ...
                let v14 = 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h5a57f::h9aa0e(v13, arg13);
                if (v14 <= *arg14) {
                    v12 = v13;
                    *arg14 = *arg14 - v14;
                } else {
                    ...
                    *arg14 = 0;
                    if (v15 == 0 || arg9 > 0 && 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h5a57f::h9aa0e(v15, *0x1::vector::borrow<u64>(arg3, v7)) < arg9) {
                        v9 = 526;
                    } else {
                        v12 = v15;
                    };
            ...
            if (v9 != 0) {
                0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h1ec67::h67a26(v9, v7, arg15);
                v12 = 0;
            } else {
                v2 = true;
            };
    ...
    public(friend) fun he3d6c(arg0: &H5fd6f, arg1: &mut vector<0x1::option::Option<u128>>, arg2: &mut vector<u128>) {
        ...
        while (v0 < 0x1::vector::length<u128>(&arg0.h8b8ea)) {
            if (*0x1::vector::borrow<bool>(&arg0.h914ca, v0)) {
                0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h95cce::h88a9c(arg1, *0x1::vector::borrow<u128>(&arg0.h8b8ea, v0));
            } else {
    ...
    public(friend) fun hecae9(arg0: &H5fd6f, arg1: u64) : u256 {
        ...
        while (v1 < 0x1::vector::length<u128>(&arg0.h8b8ea)) {
            v0 = v0 + 0x7dba21c12a68741f8e5764d325ce007abd5258d4cae108ff97fca9727d12993a::h5a57f::h9aa0e(*0x1::vector::borrow<u64>(&arg0.hf2776, v1), arg1);
            v1 = v1 + 1;
        };
        v0
    }
