module 0x403e7529425d6293f84c9fe6286a4e5534a3eeb3bbfb56e353e919a4cfacbe49::reward1239 {
    struct REWARD1239 has drop {
        dummy_field: bool,
    }

    struct TICKET_1239 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1239(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1239>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1239>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1239, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1239>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1239>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1239>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1239>>(v5, 0x2::tx_context::sender(arg1));
    }
