module 0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::ve_token {
    ...
    public(friend) fun split(arg0: &mut VeToken, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : VeToken {
        assert!(arg1 > 0 && arg1 < 0x2::balance::value<0x307bcac69a2b657cd7d06b895d290cfaa728a243a4119e01a9300535943aac2::mmt::MMT>(&arg0.balance), 0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::error::e_invalid_split_amount());
        VeToken{
    ...
    public fun bond_info(arg0: &VeToken) : (u64, u8, u64) {
        (0x2::balance::value<0x307bcac69a2b657cd7d06b895d290cfaa728a243a4119e01a9300535943aac2::mmt::MMT>(&arg0.balance), arg0.bond_mode, arg0.unbond_at)
    }
    ...
    public(friend) fun create(arg0: &0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::ve_mmt::VeMMT, arg1: 0x2::balance::Balance<0x307bcac69a2b657cd7d06b895d290cfaa728a243a4119e01a9300535943aac2::mmt::MMT>, arg2: u64, arg3: u8, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : VeToken {
        assert!(arg3 == 1 || arg3 == 2, 0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::error::e_invalid_bond_mode());
        assert!(arg2 >= 0x2::clock::timestamp_ms(arg4) && arg2 < 18446744073709551615, 0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::error::e_invalid_unbond_at());
        if (arg3 == 2) {
            assert!(arg2 == 0x2::clock::timestamp_ms(arg4) + 0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::vote_power::max_bond_epochs(0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::ve_mmt::vp_config(arg0)) * 0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::epoch::epoch_interval_ms(0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::ve_mmt::ep_config(arg0)), 0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::error::e_invalid_unbond_at());
        };
        VeToken{
    ...
    public(friend) fun extend(arg0: &mut VeToken, arg1: u64, arg2: &0x2::clock::Clock) {
        ...
        assert!(v0, 0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::error::e_invalid_unbond_at());
        arg0.unbond_at = arg1;
    }
    ...
    public(friend) fun merge(arg0: &mut VeToken, arg1: VeToken) {
        assert!(check_merge_allowed(arg0, &arg1), 0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::error::e_invalid_merge());
        let VeToken {
            id        : v0,
            bond_mode : _,
            unbond_at : _,
        ...
        0x2::balance::join<0x307bcac69a2b657cd7d06b895d290cfaa728a243a4119e01a9300535943aac2::mmt::MMT>(&mut arg0.balance, v3);
    }
    ...
    public(friend) fun withdraw(arg0: VeToken, arg1: &0x2::clock::Clock) : 0x2::balance::Balance<0x307bcac69a2b657cd7d06b895d290cfaa728a243a4119e01a9300535943aac2::mmt::MMT> {
        assert!(0x2::clock::timestamp_ms(arg1) >= unbond_at(&arg0), 0x40a75086cf3902b3bae80aba77f01e8aea44ef60d319a8017c7a5c081f8f8b43::error::e_not_unbond_yet());
        let VeToken {
            id        : v0,
            bond_mode : _,
            unbond_at : _,
