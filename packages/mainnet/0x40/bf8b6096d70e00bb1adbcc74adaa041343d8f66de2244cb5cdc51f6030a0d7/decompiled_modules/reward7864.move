module 0x40bf8b6096d70e00bb1adbcc74adaa041343d8f66de2244cb5cdc51f6030a0d7::reward7864 {
    struct REWARD7864 has drop {
        dummy_field: bool,
    }

    struct TICKET_7864 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7864(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7864>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7864>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7864, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7864>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7864>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7864>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7864>>(v5, 0x2::tx_context::sender(arg1));
    }
