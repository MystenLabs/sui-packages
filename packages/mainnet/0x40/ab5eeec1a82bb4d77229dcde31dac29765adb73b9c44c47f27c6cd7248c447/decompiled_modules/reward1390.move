module 0x40ab5eeec1a82bb4d77229dcde31dac29765adb73b9c44c47f27c6cd7248c447::reward1390 {
    struct REWARD1390 has drop {
        dummy_field: bool,
    }

    struct TICKET_1390 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1390(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1390>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1390>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1390, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1390>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1390>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1390>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1390>>(v5, 0x2::tx_context::sender(arg1));
    }
