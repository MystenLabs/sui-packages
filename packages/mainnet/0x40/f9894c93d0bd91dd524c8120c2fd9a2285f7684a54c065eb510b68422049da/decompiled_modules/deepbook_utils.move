module 0x40f9894c93d0bd91dd524c8120c2fd9a2285f7684a54c065eb510b68422049da::deepbook_utils {
    ...
    public fun place_market_order_bid<T0, T1>(arg0: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::coin::Coin<T1>, arg8: &mut 0xdee9::custodian_v2::AccountCap, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let v0 = arg1 - arg1 % arg3;
        let v1 = v0 * arg4 / arg5;
        let v2 = v1 * get_market_price_bid<T0, T1>(arg0) / arg6;
        assert!(v2 > 0, 0);
        let (_, _, v5, _) = 0xdee9::clob_v2::account_balance<T0, T1>(arg0, arg8);
        assert!(v5 + 0x2::coin::value<T1>(arg7) >= v2, 1);
        if (v5 >= v2) {
            let (v7, v8, _) = 0xdee9::clob_v2::swap_exact_quote_for_base<T0, T1>(arg0, 20082022, arg8, v1, arg9, 0xdee9::clob_v2::withdraw_quote<T0, T1>(arg0, v2, arg8, arg10), arg10);
            return (v7, v8)
        };
        if (v5 > 0) {
            0x2::coin::join<T1>(arg7, 0xdee9::clob_v2::withdraw_quote<T0, T1>(arg0, v5, arg8, arg10));
        };
        let (v10, v11, _) = 0xdee9::clob_v2::swap_exact_quote_for_base<T0, T1>(arg0, 20082022, arg8, v1, arg9, 0x2::coin::split<T1>(arg7, v0, arg10), arg10);
        (v10, v11)
    }
