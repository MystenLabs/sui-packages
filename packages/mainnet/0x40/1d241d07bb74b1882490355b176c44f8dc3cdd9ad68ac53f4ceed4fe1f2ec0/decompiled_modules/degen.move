module 0x401d241d07bb74b1882490355b176c44f8dc3cdd9ad68ac53f4ceed4fe1f2ec0::degen {
    ...
    fun init(arg0: DEGEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/WDP8D_ImeipM8SnX?width=64&height=64&fit=crop&quality=95&format=auto                                                                                                                                                                                                                      ");
