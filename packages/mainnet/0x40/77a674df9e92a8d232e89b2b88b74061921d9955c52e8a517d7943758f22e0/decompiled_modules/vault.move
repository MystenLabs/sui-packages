module 0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::vault {
    ...
    public fun verify_signature(arg0: &VaultConfig, arg1: vector<u8>, arg2: vector<vector<u8>>, arg3: vector<vector<u8>>) : bool {
        ...
        0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::utils::verify_signature(&arg0.signers, arg0.threshold, arg1, arg2, arg3)
    }
    ...
    public fun deposit_dual_token_v2<T0, T1>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: u64, arg3: u128, arg4: 0x1::ascii::String, arg5: 0x1::ascii::String, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &AccessCap, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = calculate_fee(arg2, arg1.deposit.fee_bps);
        let v4 = arg2 - v3;
        arg1.hwm = arg1.hwm + (v4 as u128);
        let v5 = 0xee61158dda590976951425962b7486e121af4888eead3f5eba248738fe6d7b6e::fast_price_feed::safe_mul_div_u64(v4, 1000000, arg1.rate);
        ...
        if (v3 > 0) {
            withdraw_fee_internal<T0, T1>(arg1, v3, arg8, arg10);
        };
        0x2::coin::mint_and_transfer<T1>(&mut arg1.treasury_cap, v5, v2, arg10);
        let v6 = DualTokenDepositEventV2{
            sender         : v2,
            amount         : arg2,
            net_amount     : v4,
            lp             : v5,
        ...
        0x2::event::emit<DualTokenDepositEventV2>(v6);
    }
    ...
    public fun deposit_v2<T0, T1>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u128, arg4: &0x2::clock::Clock, arg5: &AccessCap, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        arg1.hwm = arg1.hwm + (v4 as u128);
        let v6 = 0xee61158dda590976951425962b7486e121af4888eead3f5eba248738fe6d7b6e::fast_price_feed::safe_mul_div_u64(v4, 1000000, arg1.rate);
        arg1.total_deposit = arg1.total_deposit + (v4 as u128);
    ...
    public fun move_token_to_withdraw_assets_sigs<T0, T1, T2>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: u64, arg4: u64, arg5: vector<vector<u8>>, arg6: vector<vector<u8>>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::utils::verify_signature(&arg1.signers, arg1.threshold, v1, arg5, arg6);
        if (v0 == 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())) {
    ...
    fun redeem_dual_v2_internal<T0, T1, T2, T3>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<vector<0x1::ascii::String>>, arg4: vector<u64>, arg5: vector<vector<u64>>, arg6: vector<u64>, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x2::coin::Coin<T3>) {
        ...
        0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::utils::verify_signature(&arg0.signers, arg0.threshold, v1, arg8, arg9);
        ...
        if (v19 > 0) {
            ...
            while (v27 < v19) {
                ...
                assert!(0x1::option::borrow<0x1::ascii::String>(&v28.token_a) == &v21, 33);
                assert!(v34 == &v22, 34);
                ...
                if (v35 && v37) {
                    ...
                    assert!(v28.token_a_amount >= *v39, 35);
                    v23 = v23 + *v39;
                    let v40 = 0x1::vector::borrow<u64>(v32, v38);
                    assert!(v28.token_b_amount >= *v40, 36);
                    v24 = v24 + *v40;
                } else if (v35) {
                    let v41 = 0x1::vector::borrow<u64>(v32, v36);
                    assert!(v28.token_a_amount >= *v41, 35);
                    v23 = v23 + *v41;
                } else if (v37) {
                    let v42 = 0x1::vector::borrow<u64>(v32, v38);
                    assert!(v28.token_b_amount >= *v42, 36);
                    v24 = v24 + *v42;
                };
                v25 = v25 + v28.amount;
                v26 = v26 + *v33;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut v54, v56, arg11), arg1.fee_receiver);
        0x2::transfer::public_transfer<0x2::coin::Coin<T3>>(0x2::coin::split<T3>(&mut v55, v57, arg11), arg1.fee_receiver);
        arg1.total_withdraw = arg1.total_withdraw + (v26 as u128);
        let v58 = DualTokensRedeemEvent{
            receiver                            : arg2,
            item_amount                         : v25,
        ...
        0x2::event::emit<DualTokensRedeemEvent>(v58);
        (v54, v55)
    }
    ...
    public entry fun redeem_fee<T0, T1>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::clock::timestamp_ms(arg3) - arg2.lock_duration_ms;
        let v2 = 0x1::vector::empty<PendingRedeemV2>();
        let v3 = 0x1::vector::empty<PendingRedeemV2>();
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg2.id, b"pending_redeems_v2")) {
            0x2::dynamic_field::add<vector<u8>, 0x2::table::Table<address, vector<PendingRedeemV2>>>(&mut arg2.id, b"pending_redeems_v2", 0x2::table::new<address, vector<PendingRedeemV2>>(arg4));
        };
        ...
        assert!(0x2::table::contains<address, vector<PendingRedeemV2>>(v4, v0) || 0x2::table::contains<address, vector<PendingRedeem>>(&arg2.pending_redeems, v0), 7);
        if (0x2::table::contains<address, vector<PendingRedeemV2>>(v4, v0)) {
            let v5 = 0x2::table::remove<address, vector<PendingRedeemV2>>(v4, v0);
            let v6 = 0;
            while (v6 < 0x1::vector::length<PendingRedeemV2>(&v5)) {
                let v7 = 0x1::vector::borrow<PendingRedeemV2>(&v5, v6);
                if (v7.withdraw_time <= v1) {
                    0x1::vector::push_back<PendingRedeemV2>(&mut v2, *v7);
                } else {
                    0x1::vector::push_back<PendingRedeemV2>(&mut v3, *v7);
                };
                v6 = v6 + 1;
            };
            if (0x1::vector::length<PendingRedeemV2>(&v3) > 0) {
                0x2::table::add<address, vector<PendingRedeemV2>>(v4, v0, v3);
            };
        };
        let v8 = 0x1::vector::empty<PendingRedeem>();
        let v9 = 0x1::vector::empty<PendingRedeem>();
        if (0x2::table::contains<address, vector<PendingRedeem>>(&arg2.pending_redeems, v0)) {
            let v10 = 0x2::table::remove<address, vector<PendingRedeem>>(&mut arg2.pending_redeems, v0);
            let v11 = 0;
            while (v11 < 0x1::vector::length<PendingRedeem>(&v10)) {
                let v12 = 0x1::vector::borrow<PendingRedeem>(&v10, v11);
                if (v12.withdraw_time <= v1) {
                    0x1::vector::push_back<PendingRedeem>(&mut v8, *v12);
                } else {
                    0x1::vector::push_back<PendingRedeem>(&mut v9, *v12);
                };
                v11 = v11 + 1;
            };
            if (0x1::vector::length<PendingRedeem>(&v9) > 0) {
                0x2::table::add<address, vector<PendingRedeem>>(&mut arg2.pending_redeems, v0, v9);
            };
        };
        let v13 = 0x1::vector::length<PendingRedeemV2>(&v2);
        let v14 = 0x1::vector::length<PendingRedeem>(&v8);
        assert!(v13 > 0 || v14 > 0, 19);
        let v15 = 0;
        if (v13 > 0) {
            let v16 = 0;
            while (v16 < v13) {
                v15 = v15 + 0x1::vector::borrow<PendingRedeemV2>(&v2, v16).amount;
                v16 = v16 + 1;
            };
        };
        if (v14 > 0) {
            let v17 = 0;
            while (v17 < v14) {
                v15 = v15 + 0x1::vector::borrow<PendingRedeem>(&v8, v17).amount;
                v17 = v17 + 1;
            };
        };
        arg2.pending_redemptions = arg2.pending_redemptions - (v15 as u128);
        let v18 = spend_withdraw_asset<T0, T1, T0>(arg2, v15, arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v18, arg2.fee_receiver);
        let v19 = RedeemFeeEvent{
            receiver : arg2.fee_receiver,
            amount   : v15,
            vault_id : 0x2::object::id<Vault<T0, T1>>(arg2),
        };
        0x2::event::emit<RedeemFeeEvent>(v19);
    }
    ...
    fun redeem_v2_internal<T0, T1, T2>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<u64>, arg4: vector<u64>, arg5: vector<u64>, arg6: u64, arg7: vector<vector<u8>>, arg8: vector<vector<u8>>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::utils::verify_signature(&arg0.signers, arg0.threshold, v1, arg7, arg8);
        let v4 = 0x1::vector::empty<PendingRedeemV2>();
        let v5 = 0x1::vector::empty<PendingRedeemV2>();
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg1.id, b"pending_redeems_v2")) {
        ...
        if (v19 > 0) {
            ...
            while (v24 < v19) {
                ...
                assert!(0x1::option::borrow<0x1::ascii::String>(&v25.token_a) == &v3, 32);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut v36, v37, arg10), arg1.fee_receiver);
    ...
    public fun withdraw_dual_v2<T0, T1, T2, T3>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: &0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::PriceFeedConfig, arg3: 0x2::coin::Coin<T1>, arg4: u128, arg5: &vector<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>, arg6: &vector<0xae9d0a79257bb9926a99088b385e99ccbda3d3e58aefc74568c58ef54c7212f4::nodo_price_feed::NodoPriceFeedInfo>, arg7: &0x2::clock::Clock, arg8: &AccessCap, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0xee61158dda590976951425962b7486e121af4888eead3f5eba248738fe6d7b6e::fast_price_feed::safe_mul_div_u64(v1, arg1.rate, 1000000);
        ...
        let v7 = if (v4 == 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())) {
            ...
            (0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::utils::get_amount_out(arg2, 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), v4, arg5, arg6, v3 / 2, arg7) as u64)
        };
        let v8 = if (v5 == 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())) {
            v3 / 2
        } else {
            (0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::utils::get_amount_out(arg2, 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), v5, arg5, arg6, v3 / 2, arg7) as u64)
        };
        ...
        arg1.hwm = v10;
        0x2::coin::burn<T1>(&mut arg1.treasury_cap, arg3);
    ...
    public fun withdraw_v2<T0, T1, T2>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: &0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::PriceFeedConfig, arg3: 0x2::coin::Coin<T1>, arg4: u128, arg5: &vector<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>, arg6: &vector<0xae9d0a79257bb9926a99088b385e99ccbda3d3e58aefc74568c58ef54c7212f4::nodo_price_feed::NodoPriceFeedInfo>, arg7: &0x2::clock::Clock, arg8: &AccessCap, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (v8) {
            ...
            v5 = true;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v10, v11, arg9), arg1.fee_receiver);
            ...
            let v12 = (0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::utils::get_amount_out(arg2, 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), v7, arg5, arg6, v3, arg7) as u64);
            v6 = v12;
            add_pending_redeem_v2<T0, T1>(arg1, v0, v3, v1, 0x1::option::some<0x1::ascii::String>(v7), v12, 0x1::option::none<0x1::ascii::String>(), 0, arg7, arg9);
        };
        if (arg1.liquidity > (v3 as u128)) {
            arg1.liquidity = arg1.liquidity - (v3 as u128);
        } else {
