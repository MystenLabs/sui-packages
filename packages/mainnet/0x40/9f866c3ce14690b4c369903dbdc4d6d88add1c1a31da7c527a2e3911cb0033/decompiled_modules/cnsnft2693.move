module 0x409f866c3ce14690b4c369903dbdc4d6d88add1c1a31da7c527a2e3911cb0033::cnsnft2693 {
    struct CNSNFT2693 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2693, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2693>(arg0, arg1);
