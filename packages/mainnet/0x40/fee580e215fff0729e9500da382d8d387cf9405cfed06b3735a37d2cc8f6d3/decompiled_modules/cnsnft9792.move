module 0x40fee580e215fff0729e9500da382d8d387cf9405cfed06b3735a37d2cc8f6d3::cnsnft9792 {
    struct CNSNFT9792 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9792, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9792>(arg0, arg1);
