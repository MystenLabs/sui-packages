module 0x405abd3f4d6ce9230f2280060a7c93c930f1e2c9ebebb124298f4a1329ed26a6::protocol_config {
    ...
    public(friend) fun calculate_interest_with_borrow(arg0: &ProtocolConfig, arg1: u64, arg2: u64, arg3: u64) : u64 {
        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(arg3, interest_rate(arg0, arg1)), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::div(arg2, 0x405abd3f4d6ce9230f2280060a7c93c930f1e2c9ebebb124298f4a1329ed26a6::margin_constants::year_ms()))
    }
    ...
    public(friend) fun interest_rate(arg0: &ProtocolConfig, arg1: u64) : u64 {
        ...
        if (arg1 < v0) {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(arg1, arg0.interest_config.base_slope) + arg0.interest_config.base_rate
        } else {
            arg0.interest_config.base_rate + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(v0, arg0.interest_config.base_slope) + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(arg1 - v0, arg0.interest_config.excess_slope)
        }
    }
    ...
    public fun new_interest_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : InterestConfig {
        assert!(arg2 <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling(), 1);
        InterestConfig{
            base_rate           : arg0,
            base_slope          : arg1,
    ...
    public fun new_margin_pool_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : MarginPoolConfig {
        assert!(arg1 <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling(), 1);
        assert!(arg3 >= 0x405abd3f4d6ce9230f2280060a7c93c930f1e2c9ebebb124298f4a1329ed26a6::margin_constants::min_min_borrow(), 1);
        assert!(arg2 <= 0x405abd3f4d6ce9230f2280060a7c93c930f1e2c9ebebb124298f4a1329ed26a6::margin_constants::max_protocol_spread(), 1);
        let v0 = arg0 / 10;
        MarginPoolConfig{
            supply_cap                    : arg0,
            ...
            rate_limit_refill_rate_per_ms : v0 / 0x405abd3f4d6ce9230f2280060a7c93c930f1e2c9ebebb124298f4a1329ed26a6::margin_constants::day_ms(),
