module 0x401d55beb5c238551fd0b397d822bc5894547bfb656213ed505a6f77fa640b9f::amm {
    ...
    struct MarketState<phantom T0, phantom T1> has store {
    ...
    public fun add_liquidity<T0, T1>(arg0: &mut MarketState<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LP<T0, T1>> {
    ...
    fun calc_trade_sell_pt<T0, T1>(arg0: &mut MarketState<T0, T1>, arg1: PreComputeMarket, arg2: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg3: u64) : (u64, u64) {
        ...
        let v7 = 0x401d55beb5c238551fd0b397d822bc5894547bfb656213ed505a6f77fa640b9f::utils::asset_to_sy(((0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::get_raw_value(v6) >> 64) as u64), arg2);
        let v8 = 0x401d55beb5c238551fd0b397d822bc5894547bfb656213ed505a6f77fa640b9f::utils::asset_to_sy(((0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::get_raw_value(v5) >> 64) as u64), arg2);
    ...
    fun execute_trade_core_sell_pt<T0, T1>(arg0: &mut MarketState<T0, T1>, arg1: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::coin::Coin<T1>) {
        ...
        set_new_market_state_trade<T0, T1>(arg0, v0, arg1, v1, arg3);
        (v3, v4)
    }
    ...
    fun get_rate_scalar<T0, T1>(arg0: &MarketState<T0, T1>, arg1: u64) : 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64 {
    ...
    public fun is_expired<T0, T1>(arg0: &MarketState<T0, T1>, arg1: &0x2::clock::Clock) : bool {
    ...
    public fun pre_compute_value<T0, T1>(arg0: &MarketState<T0, T1>, arg1: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg2: &0x2::clock::Clock) : PreComputeMarket {
        ...
        let v3 = 0x401d55beb5c238551fd0b397d822bc5894547bfb656213ed505a6f77fa640b9f::utils::sy_to_asset(0x2::balance::value<T1>(&arg0.total_sy), arg1);
        assert!(v2 > 0 && v3 > 0, 6);
        PreComputeMarket{
            rate_scalar : v1,
            total_asset : v3,
    ...
    public fun remove_liquidity<T0, T1>(arg0: &mut MarketState<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
    ...
    fun set_initial_ln_implied_rate<T0, T1>(arg0: &mut MarketState<T0, T1>, arg1: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg2: &0x2::clock::Clock) {
        if (is_expired<T0, T1>(arg0, arg2)) {
            abort 4
        };
        let v0 = arg0.expiry - 0x2::clock::timestamp_ms(arg2);
        arg0.last_ln_implied_rate = get_ln_implied_rate(0x2::balance::value<T0>(&arg0.total_pt), 0x401d55beb5c238551fd0b397d822bc5894547bfb656213ed505a6f77fa640b9f::utils::sy_to_asset(0x2::balance::value<T1>(&arg0.total_sy), arg1), get_rate_scalar<T0, T1>(arg0, v0), arg0.initial_anchor, v0);
    }

    fun set_new_market_state_trade<T0, T1>(arg0: &mut MarketState<T0, T1>, arg1: PreComputeMarket, arg2: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg3: u64, arg4: &0x2::clock::Clock) {
        arg0.last_ln_implied_rate = get_ln_implied_rate(0x2::balance::value<T0>(&arg0.total_pt), arg1.total_asset, arg1.rate_scalar, arg1.rate_anchor, arg0.expiry - 0x2::clock::timestamp_ms(arg4));
    ...
    public fun swap_exact_pt_for_sy<T0, T1>(arg0: &mut MarketState<T0, T1>, arg1: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
