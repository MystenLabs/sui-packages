module 0x40e3827aa54921bb7c1c1cf1e1258338ae922aecaf7da171bd81e6fc2b834dcf::cnsnft5000 {
    struct CNSNFT5000 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5000, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5000>(arg0, arg1);
