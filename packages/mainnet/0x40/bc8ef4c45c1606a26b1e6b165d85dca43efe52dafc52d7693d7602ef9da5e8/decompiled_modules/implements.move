module 0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::implements {
    ...
    public(friend) fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LP<T0, T1>>, vector<u64>) {
        ...
        let v9 = if (0 == v6) {
            let v10 = 0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::math::sqrt(0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::math::mul_to_u128(v7, v8));
            assert!(v10 > 1000, 8);
    ...
    public(friend) fun add_points(arg0: &mut Global, arg1: &0x2::clock::Clock, arg2: address, arg3: bool, arg4: u64) {
        ...
        if (arg3) {
            v1.swap_count = v1.swap_count + 1;
            if (v1.swap_count == 1) {
                v1.point = v1.point + 30;
            } else if (v1.swap_count == 11) {
                v1.point = v1.point + 50;
            } else if (v1.swap_count == 21) {
                v1.point = v1.point + 80;
            };
            if (arg4 >= 5000 * 1000000000) {
                v1.point = v1.point + 150;
            } else if (arg4 >= 1000 * 1000000000) {
                v1.point = v1.point + 70;
            } else if (arg4 >= 100 * 1000000000) {
                v1.point = v1.point + 40;
            };
        } else {
            v1.lp_count = v1.lp_count + 1;
            v1.point = v1.point + 50;
            if (arg4 >= 5000 * 1000000000) {
                v1.point = v1.point + 75;
            } else if (arg4 >= 1000 * 1000000000) {
                v1.point = v1.point + 75;
            };
        };
        let v2 = v1.inviter;
        if (v2 != arg2) {
            if (!0x2::table::contains<address, UserInfo>(&mut arg0.users, v2)) {
                let v3 = UserInfo{
                    inviter        : arg2,
                    point          : 0,
                    last_update_at : 0,
                ...
                0x2::table::add<address, UserInfo>(&mut arg0.users, v2, v3);
            };
            let v4 = 0x2::table::borrow_mut<address, UserInfo>(&mut arg0.users, v2);
            if (arg3) {
                v4.point = v4.point + 10;
                v4.invite_point = v4.invite_point + 10;
            } else {
                v4.point = v4.point + 20;
                v4.invite_point = v4.invite_point + 20;
            };
        };
    }
    ...
    public fun calc_optimal_coin_values(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : (u64, u64) {
        ...
        let v0 = 0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::math::mul_div(arg0, arg5, arg4);
        if (v0 <= arg1) {
            assert!(v0 >= arg3, 4);
            return (arg0, v0)
        };
        let v1 = 0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::math::mul_div(arg1, arg4, arg5);
        assert!(v1 <= arg0, 6);
        assert!(v1 >= arg2, 3);
        (v1, arg1)
    }

    public(friend) fun consume_points(arg0: &mut Global, arg1: address, arg2: u64) {
        assert!(0x2::table::contains<address, UserInfo>(&mut arg0.users, arg1), 16);
        let v0 = 0x2::table::borrow_mut<address, UserInfo>(&mut arg0.users, arg1);
        assert!(v0.point >= arg2, 17);
        v0.point = v0.point - arg2;
    }
    ...
    public fun get_amount_out(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::math::mul_div_u128(v0, (arg2 as u128), (arg1 as u128) * (10000 as u128) + v0)
    }
    ...
    public fun get_fee_to_fundation(arg0: u64) : u64 {
        0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::math::mul_div(arg0, 30 / 5, 10000)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Global{
            ...
            has_paused  : false,
            controller  : @0x4d2f206306cf247a7d02c29120496f50bad39dce31cc2ce5a2696415570aa3cc,
            beneficiary : @0x4d2f206306cf247a7d02c29120496f50bad39dce31cc2ce5a2696415570aa3cc,
    ...
    public fun is_order<T0, T1>() : bool {
        ...
        let v2 = 0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::comparator::compare<0x1::type_name::TypeName>(&v0, &v1);
        assert!(!0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::comparator::is_equal(&v2), 9);
        0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::comparator::is_smaller_than(&v2)
    }
    ...
    public(friend) fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        (0x2::coin::take<T0>(&mut arg0.coin_x, 0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::math::mul_div(v1, v0, v3), arg3), 0x2::coin::take<T1>(&mut arg0.coin_y, 0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::math::mul_div(v2, v0, v3), arg3))
    }
    ...
    public(friend) fun swap_out<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        let (v0, v1) = swap_out_inner<T0, T1>(arg0, arg1, arg2, arg3, arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v1, 0x2::tx_context::sender(arg4));
        v0
    }

    public(friend) fun swap_out_inner<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::coin::Coin<T1>) {
        ...
        if (arg3) {
            ...
            (v12, 0x2::coin::take<T1>(&mut v2.coin_y, v7, arg4))
        } else {
            ...
            0x1::vector::push_back<u64>(&mut v23, 0);
            (v23, 0x2::coin::take<T1>(&mut v13.coin_x, v18, arg4))
        }
    }
