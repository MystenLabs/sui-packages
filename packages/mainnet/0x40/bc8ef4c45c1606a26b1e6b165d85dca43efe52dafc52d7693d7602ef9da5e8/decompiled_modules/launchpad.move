module 0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::launchpad {
    ...
    public entry fun claim<T0, T1>(arg0: &mut LaunchInfo<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::table::borrow_mut<address, UserInfo>(&mut arg0.userInfos, v0);
        assert!(v1.paid_amount > 0, 1014);
        assert!(v1.claimed_amount == 0, 1011);
        assert!(!v1.is_freeze, 1013);
        let v2 = 0x40bc8ef4c45c1606a26b1e6b165d85dca43efe52dafc52d7693d7602ef9da5e8::math::mul_div(arg0.claim_amount_per_coin_uint, v1.paid_amount, arg0.pay_coin_unit);
        assert!(v2 > 0, 1005);
    ...
    public entry fun create_launch<T0>(arg0: u64, arg1: u64, arg2: &0x2::coin::CoinMetadata<T0>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        create_launch_internal<T0>(arg0, arg1, get_coin_unit<T0>(arg2), arg3, arg4, arg5);
    }

    fun create_launch_internal<T0>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0 < arg1, 1002);
        assert!(arg4 > 0 && arg4 < arg3, 1009);
        let v0 = LaunchCap{id: 0x2::object::new(arg5)};
        let v1 = LaunchInfo<T0>{
            ...
            claim_start_at             : 0,
            claim_balance              : 0x2::bag::new(arg5),
            userInfos                  : 0x2::table::new<address, UserInfo>(arg5),
        };
        0x2::transfer::share_object<LaunchInfo<T0>>(v1);
        0x2::transfer::transfer<LaunchCap>(v0, 0x2::tx_context::sender(arg5));
    }

    public entry fun create_launch_pay_sui(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        create_launch_internal<0x2::sui::SUI>(arg0, arg1, 1000000000, arg2, arg3, arg4);
    }
    ...
    public entry fun get_launch_data<T0, T1>(arg0: &LaunchInfo<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, UserInfo>(&arg0.userInfos, v0)) {
            let v3 = *0x2::table::borrow<address, UserInfo>(&arg0.userInfos, v0);
            v1 = v3.paid_amount;
    ...
    public entry fun purchase<T0>(arg0: &mut LaunchInfo<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 <= arg0.total_pay_supply - arg0.sold_pay_amount, 1006);
        arg0.sold_pay_amount = arg0.sold_pay_amount + v1;
        ...
        0x2::balance::join<T0>(&mut arg0.total_paid, 0x2::coin::into_balance<T0>(arg2));
        let v5 = arg0.total_pay_supply - arg0.sold_pay_amount;
        if (v5 < arg0.remain_pay_supply) {
            arg0.remain_pay_supply = v5;
        };
