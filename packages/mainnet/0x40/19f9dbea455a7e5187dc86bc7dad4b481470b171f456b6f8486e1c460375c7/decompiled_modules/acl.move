module 0x4019f9dbea455a7e5187dc86bc7dad4b481470b171f456b6f8486e1c460375c7::acl {
    ...
    public fun new(arg0: &mut 0x2::tx_context::TxContext) : ACL {
        ...
        0x2::vec_set::insert<address>(&mut v0, @0x57f27020590aa2111df5d41df99a19daad430f38f9896251f4d0bb70febb956f);
        0x2::vec_set::insert<address>(&mut v0, @0x2e00d2bf9e2424537d6a37b2fc1ca576bef7d5eaca1e7788a136aca29202a2c);
        ...
        0x2::table::add<u8, 0x2::vec_set::VecSet<address>>(&mut v1, 4, 0x2::vec_set::empty<address>());
        ACL{
            admins           : v0,
            roles            : v1,
    ...
    fun remove_from_all_roles(arg0: &mut ACL, arg1: address) {
        ...
        let v4 = 0x2::table::borrow_mut<u8, 0x2::vec_set::VecSet<address>>(&mut arg0.roles, 4);
        if (0x2::vec_set::contains<address>(v4, &arg1)) {
            0x2::vec_set::remove<address>(v4, &arg1);
        };
    }
