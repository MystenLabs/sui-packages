module 0x40f7043d376c842a442ab026cbdfaa0b56af9fea9d81dcbb16f74d11f23740d7::cnsnft7586 {
    struct CNSNFT7586 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7586, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7586>(arg0, arg1);
