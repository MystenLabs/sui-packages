module 0x40b9b208d2c0be257a51c883e6ab0a47fb112c2e03fc85b03a9011e35d949026::reward1030 {
    struct REWARD1030 has drop {
        dummy_field: bool,
    }

    struct TICKET_1030 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1030(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1030>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1030>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1030, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1030>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1030>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1030>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1030>>(v5, 0x2::tx_context::sender(arg1));
    }
