module 0x40deb5faabeabc977f9dc50c6ef30b154f0757a9fdcdde0136ce392841604b2b::jackpot {
    ...
    struct GamePausedKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun buy_ticket<T0>(arg0: &mut Vault, arg1: &mut Record, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, 0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::object::id_address<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, 0x2::sui::SUI>>(arg5) == @0x15a1adef56e1b716c29a6ce7df539fd7b8080da283199c92c6caa6f641a61c3f, 18);
        assert!(0x2::object::id_address<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig>(arg4) == @0x3db251ba509a8d5d8777b6338836082335d93eecbdd09a11e190a1cff51c352, 18);
        let v0 = enter(arg0, arg1, arg2, arg6, arg7);
        let v1 = 0x2::balance::value<0x2::sui::SUI>(&v0);
        let (v2, v3) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, 0x2::sui::SUI>(arg6, arg4, arg5, 0x2::balance::zero<T0>(), v0, false, true, v1, arg3, 79226673515401279992447579054);
        let v4 = v3;
        let v5 = v2;
        assert!(0x2::balance::value<0x2::sui::SUI>(&v4) == 0, 19);
        0x2::balance::destroy_zero<0x2::sui::SUI>(v4);
        let v6 = Bought{
            ticket_number : arg0.tickets_issued,
            buyer         : 0x2::tx_context::sender(arg7),
            sui_in        : v1,
            manifest_out  : 0x2::balance::value<T0>(&v5),
        };
        0x2::event::emit<Bought>(v6);
        0x2::coin::from_balance<T0>(v5, arg7)
    }
    ...
    fun enter(arg0: &mut Vault, arg1: &mut Record, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        let v2 = take_burn_credit(arg0, 0x2::tx_context::sender(arg4));
        let v3 = mul_div(arg0.odds_denominator * 1000000000, 2500, 10000);
        let v4 = if (v0 > v3) {
            v3
        } else {
            v0
        };
        let v5 = drought_multiplier_x100(arg0);
        let v6 = fee_for(v0, effective_weight(v4, v5, v2, arg0.odds_denominator * 1000000000));
        let v7 = mul_div(v6, 7000, 10000);
        let v8 = mul_div(v6, 2000, 10000);
        let v9 = v6 - v7 - v8;
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.jackpot, 0x2::balance::split<0x2::sui::SUI>(&mut v1, v7));
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.burn_bucket, 0x2::balance::split<0x2::sui::SUI>(&mut v1, v8));
        if (v9 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v1, v9), arg4), arg0.ops);
        };
        arg0.tickets_issued = arg0.tickets_issued + 1;
        arg0.tickets_open = arg0.tickets_open + 1;
        let v10 = arg0.tickets_issued;
        let v11 = Ticket{
            number           : v10,
            weight_mist      : v4,
        ...
        0x2::dynamic_field::add<u64, Ticket>(&mut arg0.id, v10, v11);
        if (v2 > 100) {
            let v12 = TicketBoostKey{number: v10};
            0x2::dynamic_field::add<TicketBoostKey, u64>(&mut arg0.id, v12, v2);
            let v13 = BoostSpent{
                who           : 0x2::tx_context::sender(arg4),
                ticket_number : v10,
                boost_x100    : v2,
            };
            0x2::event::emit<BoostSpent>(v13);
        };
        arg0.sui_since_win = arg0.sui_since_win + v0;
        arg1.commits = arg1.commits + 1;
        arg1.total_committed_mist = arg1.total_committed_mist + v0;
        arg1.last_commit_ms = 0x2::clock::timestamp_ms(arg3);
        arg1.commits_display = u64_to_string(arg1.commits);
        arg1.total_display = mist_to_string(arg1.total_committed_mist);
        let v14 = Committed{
            ticket_number       : v10,
    ...
    public fun fee_for(arg0: u64, arg1: u64) : u64 {
        ...
        mul_div(v0, 100, 10000)
    }

    fun game_paused(arg0: &Vault) : bool {
        let v0 = GamePausedKey{dummy_field: false};
        0x2::dynamic_field::exists_with_type<GamePausedKey, bool>(&arg0.id, v0) && *0x2::dynamic_field::borrow<GamePausedKey, bool>(&arg0.id, v0)
    }
    ...
    public fun legacy_locked(arg0: &Vault) : bool {
        arg0.paused
    }

    public fun lock_legacy(arg0: &AdminCap, arg1: &mut Vault) {
    ...
    public fun set_paused(arg0: &AdminCap, arg1: &mut Vault, arg2: bool) {
        assert_cap(arg0, arg1);
        let v0 = GamePausedKey{dummy_field: false};
        if (0x2::dynamic_field::exists_with_type<GamePausedKey, bool>(&arg1.id, v0)) {
            *0x2::dynamic_field::borrow_mut<GamePausedKey, bool>(&mut arg1.id, v0) = arg2;
        } else {
            0x2::dynamic_field::add<GamePausedKey, bool>(&mut arg1.id, v0, arg2);
        };
    }
