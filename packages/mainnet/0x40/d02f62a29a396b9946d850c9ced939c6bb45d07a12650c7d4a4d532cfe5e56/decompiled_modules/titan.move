module 0x40d02f62a29a396b9946d850c9ced939c6bb45d07a12650c7d4a4d532cfe5e56::titan {
    ...
    fun init(arg0: TITAN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<TITAN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TITAN   ")))), trim_right(b"TITAN                           "), trim_right(b"The Ultimate Safe Browser Unlock Limitation, Use a Secure Browser for All Your Digital Activities. We guarantee that everything you do in Titan Browser stays known only to you.                                                                                                                                                "), v2, arg1);
        let v5 = v3;
