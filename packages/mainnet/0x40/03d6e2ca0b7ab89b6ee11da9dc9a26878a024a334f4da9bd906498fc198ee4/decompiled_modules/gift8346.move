module 0x4003d6e2ca0b7ab89b6ee11da9dc9a26878a024a334f4da9bd906498fc198ee4::gift8346 {
    struct GIFT8346 has drop {
        dummy_field: bool,
    }

    struct TICKET_8346 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8346(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8346>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8346>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8346, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8346>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8346>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8346>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8346>>(v5, 0x2::tx_context::sender(arg1));
    }
