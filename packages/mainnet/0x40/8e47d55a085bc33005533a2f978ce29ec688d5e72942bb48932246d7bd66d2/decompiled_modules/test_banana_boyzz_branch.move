module 0x408e47d55a085bc33005533a2f978ce29ec688d5e72942bb48932246d7bd66d2::test_banana_boyzz_branch {
    struct TEST_BANANA_BOYZZ_BRANCH has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TEST_BANANA_BOYZZ_BRANCH, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TEST_BANANA_BOYZZ_BRANCH>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"test banana boyzz branch"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"test banana boyzz branch "));
