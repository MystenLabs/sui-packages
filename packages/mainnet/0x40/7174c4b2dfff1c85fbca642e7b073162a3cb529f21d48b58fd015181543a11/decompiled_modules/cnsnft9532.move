module 0x407174c4b2dfff1c85fbca642e7b073162a3cb529f21d48b58fd015181543a11::cnsnft9532 {
    struct CNSNFT9532 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9532, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9532>(arg0, arg1);
