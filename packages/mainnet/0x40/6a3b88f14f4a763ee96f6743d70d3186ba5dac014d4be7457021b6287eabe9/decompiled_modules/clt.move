module 0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::clt {
    struct CLT has drop {
        dummy_field: bool,
    }
    ...
    public fun createClt<T0>(arg0: 0x2::coin::TreasuryCap<T0>, arg1: 0x2::coin::CoinMetadata<T0>, arg2: &0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::version::Version, arg3: &mut 0x2::tx_context::TxContext) : CltAdminCap {
        ...
        0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::cap_vault::createVault<CltAdminCap>(arg3);
        v0
    }

    public fun depositToken<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut CltVault<T0>, arg3: &mut 0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::archieve::UserArchieve, arg4: &0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::version::Version, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, DepositProof) {
        0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::version::checkVersion(arg4, 1);
        ...
        0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::archieve::verUpdateTokenPegNonce(v3, arg3);
        let v4 = DepositProof{
            owner   : v0,
            balance : v2,
        };
        let v5 = CltDeposited{
            ...
            nonce         : v3,
            balance       : v2,
            total_deposit : 0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::archieve::increaseTotalDeposit(v2, arg3),
        };
        0x2::event::emit<CltDeposited>(v5);
        (0x2::coin::mint_balance<T0>(treasureMut<T0>(arg2), v2), v4)
    }

    public fun depositTokenForOrder<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut CltVault<T0>, arg3: &mut 0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::archieve::UserArchieve, arg4: &0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::version::Version, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, DepositProof, u128) {
        0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::version::checkVersion(arg4, 1);
        0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::archieve::verifySignature(arg0, arg1, &arg2.validator);
        let v0 = 0x2::tx_context::sender(arg6);
        let v1 = 0x2::bcs::new(arg1);
    ...
    public fun setValidator<T0>(arg0: &CltAdminCap, arg1: vector<u8>, arg2: &mut CltVault<T0>, arg3: &0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::version::Version) {
