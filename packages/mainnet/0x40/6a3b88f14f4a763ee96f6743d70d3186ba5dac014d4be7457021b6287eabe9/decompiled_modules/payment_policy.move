module 0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::payment_policy {
    ...
    public(friend) fun payByClt<T0: store + key, T1>(arg0: &mut 0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::clt::CltVault<T1>, arg1: &mut PolicyVault<T0>, arg2: 0x2::transfer_policy::TransferRequest<T0>, arg3: &0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::public_kiosk::KOrder, arg4: &mut 0x2::balance::Balance<T1>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, u64, u64) {
        let (_, v1, v2, v3) = 0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::public_kiosk::orderInfo(arg3);
        ...
        let v8 = 0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::constants::max_fee();
        let v9 = 0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::math::div(0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::math::mul(v7, arg5), v8);
        let v10 = 0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::math::div(0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::math::mul(v7, *v6), v8);
        0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::clt::withdrawTo<T1>(0x2::balance::split<T1>(arg4, v7 - v9 - v10), v2, arg0, arg6);
    ...
    public(friend) fun payByCoin<T0: store + key, T1>(arg0: &mut PolicyVault<T0>, arg1: 0x2::transfer_policy::TransferRequest<T0>, arg2: &0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::public_kiosk::KOrder, arg3: &mut 0x2::balance::Balance<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, u64, u64) {
        let (_, v1, v2, v3) = 0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::public_kiosk::orderInfo(arg2);
        ...
        let v8 = 0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::constants::max_fee();
        let v9 = 0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::math::div(0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::math::mul(v7, arg4), v8);
        let v10 = 0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::math::div(0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::math::mul(v7, *v6), v8);
    ...
    public fun withdrawRoyalFeeToken<T0: store + key, T1>(arg0: &PolicyVaultCap, arg1: &mut PolicyVault<T0>, arg2: &mut 0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::clt::CltVault<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        0x406a3b88f14f4a763ee96f6743d70d3186ba5dac014d4be7457021b6287eabe9::clt::withdrawTo<T1>(withdrawRoyalFee<T0, T1>(arg0, arg1), 0x2::tx_context::sender(arg3), arg2, arg3);
    }
