module 0x40ae98cf8cb4d64247868546d04c87f46e9ec158ee30e3b3ae3a48e4999c5391::cnsnft9340 {
    struct CNSNFT9340 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9340, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9340>(arg0, arg1);
