module 0x404c94f353e200c4b3ff2dad2a9adc9bd01541347527953e3648c0c7f49ff680::cnsnft2830 {
    struct CNSNFT2830 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2830, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2830>(arg0, arg1);
