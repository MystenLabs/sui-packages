module 0x402c1f2f353eaf3eb28c1652a0c22fa2cf59f8d4a6c280ad1662b74b98ad6993::flash_swap_module {
    public entry fun swap<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::zero<T1>(arg5);
        let (v1, v2) = do_swap<T0, T1>(arg0, v0, arg1, true, true, 79226673515401279992447579055, arg2, arg3, arg4, arg5);
