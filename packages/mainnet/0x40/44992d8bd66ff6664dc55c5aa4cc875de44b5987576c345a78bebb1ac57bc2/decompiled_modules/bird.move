module 0x4044992d8bd66ff6664dc55c5aa4cc875de44b5987576c345a78bebb1ac57bc2::bird {
    ...
    public fun action(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::ed25519::ed25519_verify(&arg0, &arg2.validator_pubkey, &arg1), 8000);
    ...
    public fun breakEgg(arg0: address, arg1: u64, arg2: u128, arg3: &mut BirdStore, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        0x1::debug::print<address>(&arg0);
        ...
        if (!0x2::object_table::contains<address, EggBreak>(&arg3.breaks, arg0)) {
            ...
            0x2::object_table::add<address, EggBreak>(&mut arg3.breaks, arg0, v1);
        } else {
            let v2 = 0x2::object_table::borrow_mut<address, EggBreak>(&mut arg3.breaks, arg0);
            v2.amount = v2.amount + arg1;
            v2.last_time = 0x2::clock::timestamp_ms(arg4);
        };
    ...
    public entry fun change_admin(arg0: BirdAdminCap, arg1: address, arg2: &mut 0x4044992d8bd66ff6664dc55c5aa4cc875de44b5987576c345a78bebb1ac57bc2::version::Version) {
        0x4044992d8bd66ff6664dc55c5aa4cc875de44b5987576c345a78bebb1ac57bc2::version::checkVersion(arg2, 1);
        0x2::transfer::transfer<BirdAdminCap>(arg0, arg1);
    }

    public fun checkIn(arg0: address, arg1: u64, arg2: u128, arg3: &mut BirdStore, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun set_validator(arg0: &BirdAdminCap, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut 0x4044992d8bd66ff6664dc55c5aa4cc875de44b5987576c345a78bebb1ac57bc2::version::Version) {
        0x4044992d8bd66ff6664dc55c5aa4cc875de44b5987576c345a78bebb1ac57bc2::version::checkVersion(arg3, 1);
