module 0x40fbc7fb881c1ceb9c0e5156869b30bccab052933fe0d776b86212efe682af89::cnsnft9001 {
    struct CNSNFT9001 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9001, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3561"));
        let v4 = 0x2::package::claim<CNSNFT9001>(arg0, arg1);
