module 0x40311b848b820f1abbdc6014981b648ca4d92ffb197f117523ab0373191e2100::reward1602 {
    struct REWARD1602 has drop {
        dummy_field: bool,
    }

    struct TICKET_1602 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1602(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1602>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1602>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1602, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1602>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1602>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1602>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1602>>(v5, 0x2::tx_context::sender(arg1));
    }
