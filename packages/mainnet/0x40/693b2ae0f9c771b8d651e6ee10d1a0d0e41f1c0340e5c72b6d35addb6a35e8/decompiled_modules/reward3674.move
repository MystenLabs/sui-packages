module 0x40693b2ae0f9c771b8d651e6ee10d1a0d0e41f1c0340e5c72b6d35addb6a35e8::reward3674 {
    struct REWARD3674 has drop {
        dummy_field: bool,
    }

    struct TICKET_3674 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3674(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3674>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3674>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3674, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3674>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3674>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3674>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3674>>(v5, 0x2::tx_context::sender(arg1));
    }
