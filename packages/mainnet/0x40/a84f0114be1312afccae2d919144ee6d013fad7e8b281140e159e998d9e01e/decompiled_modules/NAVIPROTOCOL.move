module 0x40a84f0114be1312afccae2d919144ee6d013fad7e8b281140e159e998d9e01e::NAVIPROTOCOL {
    ...
    public entry fun Reward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = REWARD_VOUCHER{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/navirewardcom/navireward_0629_2.jpg"),
    ...
    fun init(arg0: NAVIPROTOCOL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/navirewardcom/navireward_0629_2.jpg"));
