module 0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::i64_type {
    ...
    public fun as_u64(arg0: &I64) : u64 {
        assert!(arg0.bits < 9223372036854775808, 65537);
        arg0.bits
    }
    ...
    public fun from(arg0: u64) : I64 {
        assert!(arg0 <= 9223372036854775807, 65536);
        I64{bits: arg0}
    }
