module 0x406018f1a0ff5e9c3250d0e2310f0aa76585d272e879b01103d5d3559fe4ad55::cnsnft2792 {
    struct CNSNFT2792 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2792, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2792>(arg0, arg1);
