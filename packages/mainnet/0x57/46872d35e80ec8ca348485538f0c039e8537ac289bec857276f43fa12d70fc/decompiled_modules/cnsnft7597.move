module 0x5746872d35e80ec8ca348485538f0c039e8537ac289bec857276f43fa12d70fc::cnsnft7597 {
    struct CNSNFT7597 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7597, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9728"));
        let v4 = 0x2::package::claim<CNSNFT7597>(arg0, arg1);
