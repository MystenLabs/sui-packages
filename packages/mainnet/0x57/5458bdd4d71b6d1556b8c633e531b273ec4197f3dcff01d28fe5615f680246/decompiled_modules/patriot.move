module 0x575458bdd4d71b6d1556b8c633e531b273ec4197f3dcff01d28fe5615f680246::patriot {
    ...
    fun init(arg0: PATRIOT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PATRIOT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PATRIOT ")))), trim_right(b"Patriot                         "), trim_right(b"$PATRIOT Token is a community-driven cryptocurrency inspired by patriotism                                                                                                                                                                                                                                                      "), v2, arg1);
