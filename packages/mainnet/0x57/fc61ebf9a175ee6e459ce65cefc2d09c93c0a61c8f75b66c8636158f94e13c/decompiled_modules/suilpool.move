module 0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::suilpool {
    ...
    public fun calculate_suil_usd_sui<T0>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<0x2::sui::SUI, T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL, 0x2::sui::SUI>, arg2: u64) : (u64, u64) {
        let v0 = 0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::suiprice::get_suil_amount_out(arg1, arg2, false);
        (0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::suiprice::get_amount_out_v3<T0>(arg0, v0, true), v0)
    }
    ...
    public entry fun migrate_topup_suil_pool(arg0: &0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::finance::FinanceCap, arg1: &mut TopUpSUILPool) {
        assert!(arg1.version < 6, 2);
        arg1.version = 6;
    }
    ...
    public entry fun new_topup_suil(arg0: &0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::finance::FinanceCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = TopUpSUILPool{
            id       : 0x2::object::new(arg2),
            sequence : 0,
            receipt  : arg1,
            version  : 6,
        };
        0x2::transfer::public_share_object<TopUpSUILPool>(v0);
    }

    public entry fun reward(arg0: &mut 0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::finance::FinanceCap, arg1: &mut SUILPool, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        check_version(arg1);
        let v0 = 0x1::vector::length<address>(&arg2);
        assert!(v0 == 0x1::vector::length<u64>(&arg3), 6);
        let v1 = 0;
        while (v1 < v0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL>>(0x2::coin::from_balance<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL>(0x2::balance::split<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL>(&mut arg1.locked_suil, *0x1::vector::borrow<u64>(&arg3, v1)), arg4), *0x1::vector::borrow<address>(&arg2, v1));
            v1 = v1 + 1;
        };
    }

    public entry fun swap_v2<T0>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<0x2::sui::SUI, T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL, 0x2::sui::SUI>, arg2: &mut SwapLiquidity, arg3: 0x2::coin::Coin<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::coin::value<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL>(&arg3);
        let (v2, v3, v4) = swap_view_v2<T0>(arg0, arg1, arg2, v1);
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL>>(0x2::coin::split<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL>(&mut arg3, v2, arg4), @0x0);
        };
        0x2::balance::join<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL>(&mut arg2.balance_suil, 0x2::coin::into_balance<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL>(arg3));
        assert!(v4 > 0, 5);
    ...
    public entry fun topup_suil<T0>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<0x2::sui::SUI, T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL, 0x2::sui::SUI>, arg2: &mut TopUpSUILPool, arg3: 0x2::coin::Coin<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL>, arg4: &mut 0x2::tx_context::TxContext) {
        check_suilpool_version(arg2);
        let v0 = 0x2::coin::value<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL>(&arg3);
        let (v1, v2) = calculate_suil_usd_sui<T0>(arg0, arg1, v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x11f15e1c9e1a49cd26d4c442b5911dc87585440969f9a18d9c171e2acd21ac1b::suil::SUIL>>(arg3, arg2.receipt);
    ...
    public entry fun update_topup_suil_receipt(arg0: &0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::finance::FinanceCap, arg1: &mut TopUpSUILPool, arg2: address) {
        arg1.receipt = arg2;
    }
