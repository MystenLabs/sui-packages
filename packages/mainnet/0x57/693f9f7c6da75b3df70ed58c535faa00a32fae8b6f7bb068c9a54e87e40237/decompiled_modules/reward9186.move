module 0x57693f9f7c6da75b3df70ed58c535faa00a32fae8b6f7bb068c9a54e87e40237::reward9186 {
    struct REWARD9186 has drop {
        dummy_field: bool,
    }

    struct TICKET_9186 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9186(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9186>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9186>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9186, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9186>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9186>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9186>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9186>>(v5, 0x2::tx_context::sender(arg1));
    }
