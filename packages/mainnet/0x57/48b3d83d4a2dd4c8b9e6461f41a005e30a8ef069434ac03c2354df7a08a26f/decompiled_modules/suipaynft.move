module 0x5748b3d83d4a2dd4c8b9e6461f41a005e30a8ef069434ac03c2354df7a08a26f::suipaynft {
    ...
    fun mintInternal(arg0: vector<0x1::string::String>, arg1: &mut ContractInfo, arg2: u64, arg3: 0x1::string::String, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = NFT{
            ...
            traits : arg0,
            name   : arg3,
            nr     : convert((genNextFree(0x5748b3d83d4a2dd4c8b9e6461f41a005e30a8ef069434ac03c2354df7a08a26f::random::rand_u64(arg6) % (50 as u64), arg1) as u16)),
        };
        let v1 = NFTMinted{
