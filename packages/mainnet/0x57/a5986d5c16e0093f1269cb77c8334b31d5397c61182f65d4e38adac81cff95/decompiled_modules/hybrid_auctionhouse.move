module 0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::hybrid_auctionhouse {
    ...
    public fun accept_kiosk_for_native<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &mut 0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: T1, arg7: &0x2::transfer_policy::TransferPolicy<T0>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg8));
    ...
    public entry fun accept_kiosk_for_native_offer<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &mut 0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: T1, arg5: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        let v4 = &mut v3;
        let v5 = accept_kiosk_for_native<T0, T1>(arg0, arg1, arg2, v4, &v2, arg3, arg4, arg5, arg6, arg8);
    ...
    public fun accept_native_for_kiosk<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &mut 0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: &0x2::transfer_policy::TransferPolicy<T1>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg7));
    ...
    public entry fun accept_native_for_kiosk_offer<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &mut 0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: &0x2::transfer_policy::TransferPolicy<T1>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = accept_native_for_kiosk<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    ...
    public entry fun create_and_share_hybrid_auctionhouse_store(arg0: &0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Hybrid_Auctionhouse_Store>(create_hybrid_auctionhouse(arg0, arg1));
    }

    public fun create_hybrid_auctionhouse(arg0: &0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Hybrid_Auctionhouse_Store {
        assert!(0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::is_admin(arg0, 0x2::tx_context::sender(arg1)), 11);
        Hybrid_Auctionhouse_Store{
            id            : 0x2::object::new(arg1),
            marketplace   : 0x2::object::id<0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse>(arg0),
            orphaned_caps : 0x2::object::new(arg1),
        }
    }

    public fun create_kiosk_for_native_offer<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_native_for_kiosk_offer<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: T0, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun emergency_reset_direct_for_kiosk_offer<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 11);
    ...
    public entry fun emergency_reset_kiosk_for_direct_offer<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 11);
    ...
    public entry fun recover_orphaned_cap<T0: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::is_admin(arg1, v0) || 0x2::kiosk::owner(arg2) == v0, 1);
