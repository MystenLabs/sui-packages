module 0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::nft_auctionhouse {
    ...
    public fun accept_native_nft_offer<T0: store + key, T1: store + key>(arg0: &mut NFT_Auctionhouse_Store, arg1: &mut 0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: T1, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg4));
        let NftEscrow {
            id  : v7,
            nft : v8,
    ...
    public entry fun create_and_share_create_nft_auctionhouse_store(arg0: &0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<NFT_Auctionhouse_Store>(create_nft_auctionhouse(arg0, arg1));
    }

    public fun create_native_nft_offer<T0: store + key, T1: store + key>(arg0: &mut NFT_Auctionhouse_Store, arg1: T0, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_nft_auctionhouse(arg0: &0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : NFT_Auctionhouse_Store {
    ...
    public entry fun emergency_reset_direct_offer<T0: store + key, T1: store + key>(arg0: &mut NFT_Auctionhouse_Store, arg1: &0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
