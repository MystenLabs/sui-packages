module 0x57a5986d5c16e0093f1269cb77c8334b31d5397c61182f65d4e38adac81cff95::auctionhouse {
    ...
    fun init(arg0: AUCTIONHOUSE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = b"SUIVERSE Auction House";
        let v3 = b"Your Web3 World, All In One Place!";
        let v4 = b"https://suiverse.space";
        let v5 = AuctionHouse{
            id          : 0x2::object::new(arg1),
