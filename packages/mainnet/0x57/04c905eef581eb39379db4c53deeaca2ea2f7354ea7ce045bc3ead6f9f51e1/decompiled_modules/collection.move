module 0x5704c905eef581eb39379db4c53deeaca2ea2f7354ea7ce045bc3ead6f9f51e1::collection {
    ...
    public entry fun changeCollectionDescription(arg0: 0x1::string::String, arg1: &mut Collection, arg2: &mut 0x2::tx_context::TxContext) {
        0x5704c905eef581eb39379db4c53deeaca2ea2f7354ea7ce045bc3ead6f9f51e1::admin::is_admin(arg1.admin, 0x2::tx_context::sender(arg2));
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Collection{
            ...
            name                   : 0x1::string::utf8(b"Pickle Origins"),
            description            : 0x1::string::utf8(b"This collection is very important to us, it's where the Pickle Adventure journey began. It became the concept for the collection you know now as Pickle Adventure"),
            supply                 : 333,
            url                    : 0x2::url::new_unsafe_from_bytes(b"https://bettasui.xyz/collection/33/profile.png"),
            metadata_uri           : 0x1::string::utf8(b"https://ipfs.io/ipfs/QmeL2QZEZkCSqtFGq6MhGrTkZgHTfCUGPvfhtH5DY2w9cC/pickle origins"),
            minted                 : 0,
            max_mint_per_whitelist : 5,
            whitelist_price        : 0,
            max_public_per_wallet  : 333,
            public_price           : 0,
            launchpad_fee          : 3,
