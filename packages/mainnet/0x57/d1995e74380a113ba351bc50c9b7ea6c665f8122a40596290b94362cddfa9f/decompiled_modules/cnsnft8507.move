module 0x57d1995e74380a113ba351bc50c9b7ea6c665f8122a40596290b94362cddfa9f::cnsnft8507 {
    struct CNSNFT8507 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8507, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8507>(arg0, arg1);
