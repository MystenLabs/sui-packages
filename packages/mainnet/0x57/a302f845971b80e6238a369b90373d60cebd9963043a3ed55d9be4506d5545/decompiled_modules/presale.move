module 0x57a302f845971b80e6238a369b90373d60cebd9963043a3ed55d9be4506d5545::presale {
    ...
    struct PresaleStorage has key {
        ...
        balanceToken: 0x2::balance::Balance<0x2d461a2c2d0fc644199b7da633a2fb425aa97a6ce60aadb26cd6102fd2f3a0e2::seatoken::SEATOKEN>,
        maxToken: u64,
        hardCap: u64,
        startTime: u64,
        endTime: u64,
    ...
    public entry fun emergency_withdrawal_token(arg0: &PreSaleAdminCap, arg1: &mut PresaleStorage, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2d461a2c2d0fc644199b7da633a2fb425aa97a6ce60aadb26cd6102fd2f3a0e2::seatoken::SEATOKEN>>(0x2::coin::take<0x2d461a2c2d0fc644199b7da633a2fb425aa97a6ce60aadb26cd6102fd2f3a0e2::seatoken::SEATOKEN>(&mut arg1.balanceToken, 0x2::balance::value<0x2d461a2c2d0fc644199b7da633a2fb425aa97a6ce60aadb26cd6102fd2f3a0e2::seatoken::SEATOKEN>(&arg1.balanceToken), arg2), 0x2::tx_context::sender(arg2));
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = PresaleStorage{
            ...
            balanceToken : 0x2::balance::zero<0x2d461a2c2d0fc644199b7da633a2fb425aa97a6ce60aadb26cd6102fd2f3a0e2::seatoken::SEATOKEN>(),
            maxToken     : 1000,
            hardCap      : 100,
    ...
    public entry fun purchase_token(arg0: &mut PresaleStorage, arg1: &0x2::clock::Clock, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::vec_map::contains<address, u64>(&arg0.balances, &v2)) {
            ...
            let (_, _) = 0x2::vec_map::remove<address, u64>(&mut arg0.balances, &v4);
        };
    ...
    public entry fun transfer_token_to_contract(arg0: &PreSaleAdminCap, arg1: &mut PresaleStorage, arg2: &mut 0x2::coin::Coin<0x2d461a2c2d0fc644199b7da633a2fb425aa97a6ce60aadb26cd6102fd2f3a0e2::seatoken::SEATOKEN>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(is_owner(arg1, 0x2::tx_context::sender(arg3)) == true, 7);
        0x2::balance::join<0x2d461a2c2d0fc644199b7da633a2fb425aa97a6ce60aadb26cd6102fd2f3a0e2::seatoken::SEATOKEN>(&mut arg1.balanceToken, 0x2::balance::split<0x2d461a2c2d0fc644199b7da633a2fb425aa97a6ce60aadb26cd6102fd2f3a0e2::seatoken::SEATOKEN>(0x2::coin::balance_mut<0x2d461a2c2d0fc644199b7da633a2fb425aa97a6ce60aadb26cd6102fd2f3a0e2::seatoken::SEATOKEN>(arg2), 0x2::coin::value<0x2d461a2c2d0fc644199b7da633a2fb425aa97a6ce60aadb26cd6102fd2f3a0e2::seatoken::SEATOKEN>(arg2)));
    }
    ...
    public entry fun withdraw(arg0: &mut PresaleStorage, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (0x2::vec_map::contains<address, u64>(&arg0.balances, &v0)) {
            let v2 = 0x2::tx_context::sender(arg2);
            *0x2::vec_map::get<address, u64>(&arg0.balances, &v2) > 0
        } else {
            false
        };
        assert!(v1, 4);
        let v3 = 0x2::tx_context::sender(arg2);
        if (0x2::vec_map::contains<address, bool>(&arg0.refunded, &v3)) {
            let v4 = 0x2::tx_context::sender(arg2);
            assert!(*0x2::vec_map::get<address, bool>(&arg0.refunded, &v4) == false, 5);
        };
        let v5 = 0x2::tx_context::sender(arg2);
        let (v6, v7) = caculator_claim(arg0.totalRaised, *0x2::vec_map::get<address, u64>(&arg0.balances, &v5), arg0.hardCap, arg0.maxToken / arg0.hardCap);
        let v8 = 0x2::tx_context::sender(arg2);
        if (0x2::vec_map::contains<address, u64>(&arg0.balances, &v8)) {
            let v9 = 0x2::tx_context::sender(arg2);
            let (_, _) = 0x2::vec_map::remove<address, u64>(&mut arg0.balances, &v9);
            0x2::vec_map::insert<address, u64>(&mut arg0.balances, 0x2::tx_context::sender(arg2), 0);
        };
        let v12 = 0x2::tx_context::sender(arg2);
        if (0x2::vec_map::contains<address, bool>(&arg0.refunded, &v12)) {
            let v13 = 0x2::tx_context::sender(arg2);
            let (_, _) = 0x2::vec_map::remove<address, bool>(&mut arg0.refunded, &v13);
            0x2::vec_map::insert<address, bool>(&mut arg0.refunded, 0x2::tx_context::sender(arg2), true);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2d461a2c2d0fc644199b7da633a2fb425aa97a6ce60aadb26cd6102fd2f3a0e2::seatoken::SEATOKEN>>(0x2::coin::take<0x2d461a2c2d0fc644199b7da633a2fb425aa97a6ce60aadb26cd6102fd2f3a0e2::seatoken::SEATOKEN>(&mut arg0.balanceToken, v6, arg2), 0x2::tx_context::sender(arg2));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.balanceSUI, v7, arg2), 0x2::tx_context::sender(arg2));
    }
