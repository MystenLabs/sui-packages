module 0x57c3c6d40a2f62a8c8c0fa2fa98b021a2425dec17285ad5d91562fa1612433ce::boredtoilet {
    ...
    public entry fun burn_nft(arg0: CLUB, arg1: &mut NFTCollection) {
        let CLUB {
            id          : v0,
            name        : _,
            description : _,
    ...
    fun create_nft(arg0: &NFTCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : CLUB {
        let v0 = 0x1::string::utf8(b"Bored Toilet Club #");
        ...
        let v2 = if (0x2::table::contains<u64, 0x2::url::Url>(&arg0.preset_urls, arg1)) {
            *0x2::table::borrow<u64, 0x2::url::Url>(&arg0.preset_urls, arg1)
            ...
            let v3 = 0x1::string::utf8(b"https://boredtoilet.club/images/");
        ...
        CLUB{
            ...
            name        : v0,
            description : 0x1::string::utf8(x"426f72656420546f696c657420436c756220e2809420636c6f6767656420696e746f207265616c69747920627920546f696c65742044757374206f6e205375692e2057686572652074686520626f726564206265636f6d65206c6567656e6461727920616e642074686520666c75736820697320657465726e616c2e"),
            image_url   : v2,
            attributes  : v1,
            token_id    : arg1,
        }
    ...
    public fun get_token_id(arg0: &CLUB) : u64 {
        arg0.token_id
    }
    ...
    fun init(arg0: BOREDTOILET, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BOREDTOILET>(arg0, arg1);
        let v1 = NFTCollection{
            ...
            mint_start        : 1752332400000,
            phase_end         : 1752332400000 + 3600000,
            admin_address     : @0x4a6092d16bf52d6b8e4e1447a05ff622e595e02052a0866c22e3da731bccd7f0,
            treasury_address  : @0x4a6092d16bf52d6b8e4e1447a05ff622e595e02052a0866c22e3da731bccd7f0,
            phase1_price      : 100,
            phase2_price      : 9000000000,
        ...
        let v4 = 0x2::display::new<CLUB>(&v0, arg1);
        0x2::display::add<CLUB>(&mut v4, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<CLUB>(&mut v4, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<CLUB>(&mut v4, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://walrus.tusky.io/{image_url}"));
        0x2::display::add<CLUB>(&mut v4, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
        0x2::display::update_version<CLUB>(&mut v4);
        let (v5, v6) = 0x2::transfer_policy::new<CLUB>(&v0, arg1);
        0x2::transfer::transfer<AdminCap>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<CLUB>>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<CLUB>>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<CLUB>>(v5);
    ...
    public entry fun mint_all(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<CLUB>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = if (v4) {
            if (arg0.phase2_minted >= 3884) {
                0
            } else {
                3884 - arg0.phase2_minted
            }
        } else {
            0
        };
        ...
        if (v2 && v8 > 0) {
            while (v12 < v8) {
                ...
                0x2::kiosk::lock<CLUB>(arg5, arg6, arg2, v14);
                let v15 = NFTMinted{
                    nft_id   : 0x2::object::id<CLUB>(&v14),
                    token_id : v13,
                    minter   : v0,
                    phase    : 1,
                };
        ...
        if (v4 && v9 > 0) {
            ...
            while (v16 < v9) {
                ...
                0x2::kiosk::lock<CLUB>(arg5, arg6, arg2, v18);
                let v19 = NFTMinted{
                    nft_id   : 0x2::object::id<CLUB>(&v18),
                    token_id : v17,
                    minter   : v0,
                    phase    : 2,
                };
    ...
    public entry fun mint_phase1(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<CLUB>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < arg7) {
            ...
            arg0.minted = arg0.minted + 1;
            arg0.phase1_minted = arg0.phase1_minted + 1;
            0x2::kiosk::lock<CLUB>(arg5, arg6, arg2, v6);
            let v7 = NFTMinted{
                nft_id   : 0x2::object::id<CLUB>(&v6),
                token_id : v5,
                minter   : v0,
                phase    : 1,
            };
    ...
    public entry fun mint_phase2(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<CLUB>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        assert!(v1 <= arg0.phase_end, 3);
        ...
        assert!(v2 > 0 && arg7 <= v2, 7);
        assert!(arg0.phase2_minted + arg7 <= 3884, 15);
        assert!(arg0.minted + arg7 <= 4444, 1);
    ...
    public entry fun mint_public(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<CLUB>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        ...
        while (v3 < arg7) {
            ...
            0x2::kiosk::lock<CLUB>(arg5, arg6, arg2, v5);
            let v6 = NFTMinted{
                nft_id   : 0x2::object::id<CLUB>(&v5),
                token_id : v4,
                minter   : v0,
                phase    : 100,
            };
    ...
    public entry fun team_mint(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: &0x2::transfer_policy::TransferPolicy<CLUB>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 1;
        while (v0 <= 310) {
            let v1 = remove_specific_id(arg1, v0);
            let v2 = create_nft(arg1, v1, arg5);
            arg1.minted = arg1.minted + 1;
            0x2::kiosk::lock<CLUB>(arg3, arg4, arg2, v2);
            let v3 = NFTMinted{
                nft_id   : 0x2::object::id<CLUB>(&v2),
                token_id : v1,
    ...
    public entry fun team_mint_batch(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: &0x2::transfer_policy::TransferPolicy<CLUB>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        while (arg5 <= arg6) {
            let v0 = remove_specific_id(arg1, arg5);
            let v1 = create_nft(arg1, v0, arg7);
            arg1.minted = arg1.minted + 1;
            0x2::kiosk::lock<CLUB>(arg3, arg4, arg2, v1);
            let v2 = NFTMinted{
                nft_id   : 0x2::object::id<CLUB>(&v1),
                token_id : v0,
