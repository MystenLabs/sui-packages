module 0x575c2bc0455590f0c6e2e5a355c14323d5e6cba7653fc3e7ecb4c7408e6efbe9::lofi_the_yeti {
    ...
    fun init(arg0: LOFI_THE_YETI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Lofi"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidt3by4co4j4v3y3hmgwnv3smpfo77w3jhuhpunatt2suoemqrile"));
