module 0x57611c143e0f42a68b471fefb74c7f22f5710584bd56202ba8eddb121ae2c622::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"BIT", b"Bitcoin", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2026-01-07T09-59-25.775Z-600x600 (2).jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Bitcoin"),
            symbol     : 0x1::string::utf8(b"BIT"),
            decimals   : 9,
