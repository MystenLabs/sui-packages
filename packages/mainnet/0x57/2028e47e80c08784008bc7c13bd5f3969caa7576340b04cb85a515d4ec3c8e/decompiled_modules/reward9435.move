module 0x572028e47e80c08784008bc7c13bd5f3969caa7576340b04cb85a515d4ec3c8e::reward9435 {
    struct REWARD9435 has drop {
        dummy_field: bool,
    }

    struct TICKET_9435 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9435(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9435>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9435>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9435, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9435>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9435>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9435>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9435>>(v5, 0x2::tx_context::sender(arg1));
    }
