module 0x578d454e00bb6435ad4e0385bf855397e1cb525079e13a518ff4f0fb615d114c::cnsnft2390 {
    struct CNSNFT2390 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2390, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2390>(arg0, arg1);
