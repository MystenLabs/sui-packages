module 0x57312e4d88d786abb000f977b9e6693553b877189ab1c366c2bb4c1193c412fa::mizu_no_ikari_the_collection {
    struct MIZU_NO_IKARI_THE_COLLECTION has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MIZU_NO_IKARI_THE_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MIZU_NO_IKARI_THE_COLLECTION>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Mizu no Ikari the Collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Mizu no Ikari means The wrath of water. "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidenfnwiblgsbr76g7vg5py2nzpf36bsnr5qfwggbwirnsnrspvnu"));
