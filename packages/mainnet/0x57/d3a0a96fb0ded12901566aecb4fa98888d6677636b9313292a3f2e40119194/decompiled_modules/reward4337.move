module 0x57d3a0a96fb0ded12901566aecb4fa98888d6677636b9313292a3f2e40119194::reward4337 {
    struct REWARD4337 has drop {
        dummy_field: bool,
    }

    struct TICKET_4337 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4337(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4337>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4337>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4337, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4337>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4337>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4337>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4337>>(v5, 0x2::tx_context::sender(arg1));
    }
