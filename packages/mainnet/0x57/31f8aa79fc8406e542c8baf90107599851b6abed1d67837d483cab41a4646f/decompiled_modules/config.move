module 0x21c4cc0011cda95bd52e335e7f9866a83308e1aa8afd0d2c75d8700ce1b0a16f::config {
    ...
    public(friend) fun take_all_fees<T0, T1, T2>(arg0: &mut Config<T0, T1, T2>) : 0x2::balance::Balance<T0> {
