module 0x57e5d4be20f92b3caac85e3112064ce3bda95e1862d1fc4e0e2cfd3dfc6180f3::kings___shadows {
    struct KINGS___SHADOWS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: KINGS___SHADOWS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<KINGS___SHADOWS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Kings & Shadows"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Kings & Shadows is a 111-edition PFP NFT collection that explores the divine hierarchy of Kings, Angels, and Shadows within a fractured realm. Each piece embodies a distinct identity forged inside a cosmic structure of power and purpose."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibmpxwzivdx4lf2ilv5fz4jrcbwxef5abbvr2cswsbqabo4cwbjqi"));
