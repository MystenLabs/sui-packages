module 0x57d3db20df5939f6491d9d1cd48ff42afbc993ab0c1778930388ed17470d325f::stonker {
    ...
    fun input_signal_internal(arg0: &mut Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &0x2::clock::Clock, arg4: u64, arg5: bool, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg5 && v7 + v8 < arg4) {
            let v10 = (((arg0.parameters.order_size_base as u128) * (v7 as u128) / (arg0.parameters.single_base as u128)) as u64);
            let v11 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg1);
            if (v11 < v10) {
                let v12 = OutOfBalanceEvent{
                    is_buy           : true,
                    balance_required : v10,
                    balance          : v11,
                };
                0x2::event::emit<OutOfBalanceEvent>(v12);
                return
            };
            let v13 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg7);
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v13, 0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::immediate_or_cancel(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::self_matching_allowed(), v7, arg0.parameters.order_size_base, true, false, 0x2::clock::timestamp_ms(arg3) + 1000, arg3, arg7);
            return
        };
        if (!arg5 && arg4 + v8 < v6) {
            let v14 = arg0.parameters.order_size_base;
            let v15 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0x2::sui::SUI>(arg1);
            if (v15 < v14) {
                let v16 = OutOfBalanceEvent{
                    is_buy           : false,
                    balance_required : v14,
                    balance          : v15,
                };
                0x2::event::emit<OutOfBalanceEvent>(v16);
                return
            };
