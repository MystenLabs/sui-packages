module 0x57a58a799eba2b1722936948df6a0a4c9f6fbb7c9c47fa050b9fdf0245456289::suifolk {
    struct SUIFOLK has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUIFOLK, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUIFOLK>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SuiFolk"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"SuiFolk - 20 Pixel Art NFTs inspired by Viking folklore, forged for the Sui blockchain. Collect your legacy, block by block."));
