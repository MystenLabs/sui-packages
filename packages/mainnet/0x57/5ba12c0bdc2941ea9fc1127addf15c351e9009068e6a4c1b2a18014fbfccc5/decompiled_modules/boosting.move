module 0x9e6d08c834126114d8ba66239a2c0637939087a4e5b91a752e956798f76be024::boosting {
    ...
    public fun claim_refund_pre_subscribe(arg0: &0x9e6d08c834126114d8ba66239a2c0637939087a4e5b91a752e956798f76be024::guild::Config, arg1: &mut PreSubscribe, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = check_can_claim_refund_pre_subscribe(arg1, v0, 0, arg2);
        let v2 = check_can_claim_refund_pre_subscribe(arg1, v0, 1, arg2);
        assert!(v1 || v2, 7012);
        let v3 = 0;
        let v4 = v3;
        if (v1) {
            v4 = v3 + *0x2::table::borrow<u8, u64>(&arg1.price_per_class, 0);
            0x2::vec_set::remove<address>(0x2::table::borrow_mut<u8, 0x2::vec_set::VecSet<address>>(&mut arg1.subscribers, 0), &v0);
        };
        if (v2) {
            v4 = v4 + *0x2::table::borrow<u8, u64>(&arg1.price_per_class, 1);
            0x2::vec_set::remove<address>(0x2::table::borrow_mut<u8, 0x2::vec_set::VecSet<address>>(&mut arg1.subscribers, 1), &v0);
        };
        arg1.total_refund = arg1.total_refund + v4;
