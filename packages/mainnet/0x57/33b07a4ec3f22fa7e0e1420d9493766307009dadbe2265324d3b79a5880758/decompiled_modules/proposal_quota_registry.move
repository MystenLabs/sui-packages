module 0x5733b07a4ec3f22fa7e0e1420d9493766307009dadbe2265324d3b79a5880758::proposal_quota_registry {
        ...
        while (v2 < 0x1::vector::length<address>(&arg2)) {
            ...
            if (v0) {
                ...
                if (v7) {
                    ...
                    assert!(0x1::vector::length<QuotaEntry>(&arg0.quotas) < 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::max_quota_entries(), 1);
                    let v19 = QuotaEntry{
                        user : v3,
                        info : v6,
                    };
