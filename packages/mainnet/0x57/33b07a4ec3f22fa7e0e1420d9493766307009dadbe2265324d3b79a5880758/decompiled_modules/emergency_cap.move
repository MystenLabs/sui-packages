module 0x5733b07a4ec3f22fa7e0e1420d9493766307009dadbe2265324d3b79a5880758::emergency_cap {
    ...
    public fun assert_ready(arg0: &EmergencyCap, arg1: &0x2::clock::Clock) {
        ...
        let v2 = if (arg0.created_at > 0 && v1 - arg0.created_at < 60 * 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::one_day_ms()) {
            0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::one_day_ms()
        } else {
            0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::one_week_ms()
        };
