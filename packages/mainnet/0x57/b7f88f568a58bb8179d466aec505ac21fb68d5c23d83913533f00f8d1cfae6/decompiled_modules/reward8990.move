module 0x57b7f88f568a58bb8179d466aec505ac21fb68d5c23d83913533f00f8d1cfae6::reward8990 {
    struct REWARD8990 has drop {
        dummy_field: bool,
    }

    struct TICKET_8990 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8990(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8990>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8990>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8990, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8990>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8990>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8990>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8990>>(v5, 0x2::tx_context::sender(arg1));
    }
