module 0x573efd84dc663c6834a24be4298eb3bf73ff59dbf98abfe639b82886ef28edab::distributor {
    ...
    public(friend) fun new<T0>(arg0: u64, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : VestingSchedule {
        ...
        0x2::dynamic_field::add<0x573efd84dc663c6834a24be4298eb3bf73ff59dbf98abfe639b82886ef28edab::utils::Marker<T0>, 0x2::balance::Balance<T0>>(&mut v0.id, 0x573efd84dc663c6834a24be4298eb3bf73ff59dbf98abfe639b82886ef28edab::utils::marker<T0>(), 0x2::coin::into_balance<T0>(arg2));
        v0
    }
    ...
    public(friend) fun recover<T0>(arg0: &mut VestingSchedule, arg1: u64) : 0x2::balance::Balance<T0> {
        0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x573efd84dc663c6834a24be4298eb3bf73ff59dbf98abfe639b82886ef28edab::utils::Marker<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x573efd84dc663c6834a24be4298eb3bf73ff59dbf98abfe639b82886ef28edab::utils::marker<T0>()), arg1)
    }
    ...
    public entry fun release<T0: drop>(arg0: &mut VestingSchedule, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 > 0, 1);
        released(arg0, v0, v1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x573efd84dc663c6834a24be4298eb3bf73ff59dbf98abfe639b82886ef28edab::utils::Marker<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x573efd84dc663c6834a24be4298eb3bf73ff59dbf98abfe639b82886ef28edab::utils::marker<T0>()), v1), arg2), v0);
    }
    ...
    public(friend) fun top_up<T0>(arg0: &mut VestingSchedule, arg1: 0x2::coin::Coin<T0>) {
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x573efd84dc663c6834a24be4298eb3bf73ff59dbf98abfe639b82886ef28edab::utils::Marker<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x573efd84dc663c6834a24be4298eb3bf73ff59dbf98abfe639b82886ef28edab::utils::marker<T0>()), 0x2::coin::into_balance<T0>(arg1));
    }
