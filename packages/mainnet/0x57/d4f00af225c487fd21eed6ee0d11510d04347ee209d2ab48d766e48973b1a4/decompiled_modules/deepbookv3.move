module 0x57d4f00af225c487fd21eed6ee0d11510d04347ee209d2ab48d766e48973b1a4::deepbookv3 {
    ...
    public fun swap_a2b<T0, T1>(arg0: &mut 0x57d4f00af225c487fd21eed6ee0d11510d04347ee209d2ab48d766e48973b1a4::config::Config, arg1: &mut DeepbookV3Config, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x57d4f00af225c487fd21eed6ee0d11510d04347ee209d2ab48d766e48973b1a4::utils::transfer_or_destroy_coin<T0>(v11, arg6);
        0x57d4f00af225c487fd21eed6ee0d11510d04347ee209d2ab48d766e48973b1a4::utils::transfer_or_destroy_coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(v9, arg6);
        let (v13, _) = 0x57d4f00af225c487fd21eed6ee0d11510d04347ee209d2ab48d766e48973b1a4::config::pay_fee<T1>(arg0, v10, arg6);
        v13
    }

    public fun swap_b2a<T0, T1>(arg0: &mut 0x57d4f00af225c487fd21eed6ee0d11510d04347ee209d2ab48d766e48973b1a4::config::Config, arg1: &mut DeepbookV3Config, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T1>, arg4: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x2::event::emit<DeepbookV3SwapEvent>(v12);
        0x57d4f00af225c487fd21eed6ee0d11510d04347ee209d2ab48d766e48973b1a4::utils::transfer_or_destroy_coin<T1>(v10, arg6);
        0x57d4f00af225c487fd21eed6ee0d11510d04347ee209d2ab48d766e48973b1a4::utils::transfer_or_destroy_coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(v9, arg6);
        let (v13, _) = 0x57d4f00af225c487fd21eed6ee0d11510d04347ee209d2ab48d766e48973b1a4::config::pay_fee<T0>(arg0, v11, arg6);
        v13
    }
