module 0x57426b388990b0be4b0ef1a120f825ec44da93a6c65c7937b03ebf6240bcf1e2::market_maker {
    ...
    fun internal_rebalance_swap_sell<T0, T1>(arg0: 0x2::object::ID, arg1: &mut 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::LiquidityPool<T0>, arg2: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg3: u64, arg4: u64, arg5: 0x2::balance::Balance<T0>, arg6: u64, arg7: 0x1::option::Option<DepositAddress>, arg8: 0x1::option::Option<DepositAddress>, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        let v0 = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::simulate_sell_swap_reverse<T0, T1>(arg1, arg2, arg10, arg4);
        let (v1, _, _, _, _, _, v7, v8, _) = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::simulation_result_inner(&v0);
        let v10 = v1 + v7 + v8;
        let v11 = if (0x2::balance::value<T0>(&arg5) > v10) {
            0x2::balance::split<T0>(&mut arg5, 0x2::balance::value<T0>(&arg5) - v10)
        } else {
            0x2::balance::zero<T0>()
        };
        let v12 = v11;
        let (v13, _) = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::get_price<T0, T1>(arg2, arg10);
        let v15 = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(((arg6 - arg3) as u128), v13, 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::get_precision());
        ...
        if (0x2::balance::value<T0>(&arg5) > v16) {
            0x2::balance::join<T0>(&mut v12, 0x2::balance::split<T0>(&mut arg5, 0x2::balance::value<T0>(&arg5) - v16));
        };
        ...
        if (v37 < v33) {
            0x2::balance::join<T0>(&mut arg5, v12);
            let v47 = RebalanceSwapSellEvent{
                ...
                quote_out          : 0,
                min_base_threshold : arg6,
                base_liquidity     : arg3,
                base_receiver      : arg7,
                quote_receiver     : arg8,
                surplus_returned   : arg9,
            };
            ...
            let v50 = v49;
            let v51 = v48;
            0x2::balance::join<T0>(&mut v51, v12);
    ...
    fun quote_asset_is_trading<T0, T1>(arg0: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::LiquidityPool<T0>) : bool {
        let (_, _, _, _, _, _, _, v7) = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::quote_asset_info_inner(0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::get_quote_asset_info<T0, T1>(arg0));
        v7
    }
    ...
    public fun rebalance_swap_sell<T0, T1>(arg0: &mut 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: 0x1::option::Option<DepositAddress>, arg6: 0x1::option::Option<DepositAddress>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (arg3 == 0) {
            ...
            if (v2 > 0) {
                0x2::balance::split<T0>(&mut v0, v2)
            } else {
                0x2::balance::zero<T0>()
            }
        } else if (0x2::balance::value<T0>(&v0) > arg3) {
            0x2::balance::split<T0>(&mut v0, 0x2::balance::value<T0>(&v0) - arg3)
        } else {
            0x2::balance::zero<T0>()
        };
        let v3 = v1;
        let v4 = 0x2::balance::value<T0>(&v3);
        let v5 = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::get_pool_info<T0>(arg0);
        let (v6, v7, _, _, _, _, v12) = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::pool_info_inner(&v5);
        if (v12) {
            let v13 = RebalanceSwapSellEvent{
                pool_id            : v6,
            ...
            0x2::event::emit<RebalanceSwapSellEvent>(v13);
            let v14 = if (0x1::option::is_some<DepositAddress>(&arg5)) {
                0x1::option::borrow<DepositAddress>(&arg5).address
            } else {
                0x2::tx_context::sender(arg8)
            };
            if (0x2::balance::value<T0>(&v0) > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg8), v14);
            } else {
        ...
        let v15 = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::get_quote_balance<T0, T1>(arg0);
        let v16 = rebalance_swap_sell_skip_status<T0, T1>(arg0, arg1, 0x2::balance::value<T0>(&v0), v7, v15, arg4, v4, arg7);
        let (v17, v18) = if (0x1::option::is_some<u64>(&v16)) {
            let v19 = RebalanceSwapSellEvent{
                pool_id            : v6,
                sender             : 0x2::tx_context::sender(arg8),
                status             : *0x1::option::borrow<u64>(&v16),
                base_out           : 0x2::balance::value<T0>(&v0),
                quote_out          : 0,
                min_base_threshold : arg4,
                base_liquidity     : v7,
            ...
            internal_rebalance_swap_sell<T0, T1>(v6, arg0, arg1, v7, v15, v0, arg4, arg5, arg6, v4, arg7, arg8)
        };
        let v20 = v18;
        let v21 = v17;
    ...
    fun rebalance_swap_sell_skip_status<T0, T1>(arg0: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock) : 0x1::option::Option<u64> {
        if (arg2 == 0) {
            if (arg6 == 0) {
                0x1::option::some<u64>(6004)
            } else {
                0x1::option::some<u64>(6005)
            }
        } else if (arg3 >= arg5) {
            0x1::option::some<u64>(6001)
        } else if (arg4 == 0) {
            0x1::option::some<u64>(6002)
        } else if (!quote_asset_is_trading<T0, T1>(arg0)) {
            0x1::option::some<u64>(6007)
        } else {
            let v1 = try_get_valid_price<T0, T1>(arg1, arg7);
            let v2 = if (0x1::option::is_none<0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::PriceData>(&v1)) {
                true
            } else {
                let v3 = try_get_valid_price<T1, T0>(arg1, arg7);
                0x1::option::is_none<0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::PriceData>(&v3)
            };
            if (v2) {
                0x1::option::some<u64>(6006)
            } else {
                0x1::option::none<u64>()
            }
        }
    ...
    fun try_get_valid_price<T0, T1>(arg0: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg1: &0x2::clock::Clock) : 0x1::option::Option<0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::PriceData> {
        ...
        if (0x1::option::is_none<0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::PriceData>(&v1)) {
            return 0x1::option::none<0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::PriceData>()
        };
        ...
        if (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::internal_price::is_expired<T0, T1>(&v2, arg1)) {
            return 0x1::option::none<0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::PriceData>()
        };
        v1
    }
