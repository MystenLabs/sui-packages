module 0x576761e67eb894780501916cb1e973222428b69dc535ed84b30601469569104b::warehouse {
    ...
    public fun deposit_nft<T0: store + key>(arg0: &mut Warehouse<T0>, arg1: T0) {
        ...
        0x2::dynamic_field::add<0x2::object::ID, T0>(&mut arg0.id, 0x2::object::id<T0>(&arg1), arg1);
    }

    public fun exists_<T0: store + key>(arg0: &Warehouse<T0>, arg1: 0x2::object::ID) : bool {
        0x2::dynamic_field::exists_with_type<0x2::object::ID, T0>(&arg0.id, arg1)
    }
    ...
    public fun redeem_nft<T0: store + key>(arg0: &mut Warehouse<T0>, arg1: 0x2::object::ID) : T0 {
        ...
        arg0.total_deposited = arg0.total_deposited - 1;
        0x2::dynamic_field::remove<0x2::object::ID, T0>(&mut arg0.id, arg1)
    }
