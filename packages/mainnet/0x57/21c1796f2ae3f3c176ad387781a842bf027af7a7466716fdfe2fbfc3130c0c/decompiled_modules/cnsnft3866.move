module 0x5721c1796f2ae3f3c176ad387781a842bf027af7a7466716fdfe2fbfc3130c0c::cnsnft3866 {
    struct CNSNFT3866 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3866, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3866>(arg0, arg1);
