module 0x57c8461d31a4b88204aff79178227055bb05c277154a652c6da5a660fd8fc12b::bbb {
    struct BBB has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BBB, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BBB>(arg0, 9, b"HIHIHI", b"Testing HIHIHI Token", b"Some description", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
