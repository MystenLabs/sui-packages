module 0x579bba19087a2caa50244f489c5b715d7aacf44ad5bd81a72f32d6998346cab6::debt {
    ...
    public fun calc_debt(arg0: &Debt, arg1: &mut 0x579bba19087a2caa50244f489c5b715d7aacf44ad5bd81a72f32d6998346cab6::trusted_prices::TrustedPriceData) : u64 {
        ...
        while (!0x1::vector::is_empty<0x1::type_name::TypeName>(&v0)) {
            ...
            let v3 = 0x579bba19087a2caa50244f489c5b715d7aacf44ad5bd81a72f32d6998346cab6::trusted_prices::pull_raw_price(arg1, v2);
            v1 = v1 + 0x579bba19087a2caa50244f489c5b715d7aacf44ad5bd81a72f32d6998346cab6::price::calc_value(&v3, *0x2::table::borrow<0x1::type_name::TypeName, u64>(&arg0.open_debt, v2));
        };
        v1
    }
