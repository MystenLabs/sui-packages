module 0x572e311103ff8a669480bc8a6c6a8df96bc551ae7ded82cb08b609a486f52df9::apes {
    ...
    fun init(arg0: APES, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<APES>(arg0, 9, b"Sui Apes", b"APES", b"The apes have come together to build the strongest community in the crypto world, uniting to HODL, invest, and take over the meme-coin universe.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://orange-upper-booby-780.mypinata.cloud/ipfs/QmNwjx5Bqnh6wiTbrhJuuKXRQb4EsMumMNTSjNuDWfbm9z"))), false, arg1);
        let v3 = v0;
