module 0x57fb97f56c51e096bac289e9aa3beb103dce8aaa906af1140f0da769a080487e::arbitrage {
    ...
    fun attempt_cetus_arbitrage(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        arg0
    }
    ...
    fun execute_real_cetus_arbitrage(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v0 = attempt_cetus_arbitrage(arg0, arg3);
