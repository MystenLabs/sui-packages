module 0x57ddc7eca0c73af80ae01507f489845ff284ae103e8d7264b09f61550fd41574::staked_lp {
    ...
    public fun into_token<T0>(arg0: StakedLP<T0>, arg1: &0x2::clock::Clock, arg2: &0x2::token::TokenPolicy<T0>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::token::Token<T0> {
        ...
        0x2::object::delete(v0);
        0x57ddc7eca0c73af80ae01507f489845ff284ae103e8d7264b09f61550fd41574::token_ir::from_balance<T0>(arg2, v1, arg3)
    }
