module 0x57ddc7eca0c73af80ae01507f489845ff284ae103e8d7264b09f61550fd41574::index {
    ...
    public fun add_interest_pool<T0, T1>(arg0: &mut Registry, arg1: address) {
        0x2::table::add<0x1::type_name::TypeName, address>(interest_pools_mut(arg0), 0x1::type_name::get<RegistryKey<T0, T1>>(), arg1);
    }
    ...
    public fun add_staking_pool<T0, T1>(arg0: &mut Registry, arg1: address) {
        0x2::table::add<0x1::type_name::TypeName, address>(staking_pools_mut(arg0), 0x1::type_name::get<RegistryKey<T0, T1>>(), arg1);
    }
