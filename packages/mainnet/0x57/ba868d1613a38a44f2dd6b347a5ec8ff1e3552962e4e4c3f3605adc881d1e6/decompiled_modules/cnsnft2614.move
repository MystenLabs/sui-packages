module 0x57ba868d1613a38a44f2dd6b347a5ec8ff1e3552962e4e4c3f3605adc881d1e6::cnsnft2614 {
    struct CNSNFT2614 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2614, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2614>(arg0, arg1);
