module 0x577a53ec16938c57595628925572768354487507bd22092a8c9f903a2708dd6d::cnsnft5106 {
    struct CNSNFT5106 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5106, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9567"));
        let v4 = 0x2::package::claim<CNSNFT5106>(arg0, arg1);
