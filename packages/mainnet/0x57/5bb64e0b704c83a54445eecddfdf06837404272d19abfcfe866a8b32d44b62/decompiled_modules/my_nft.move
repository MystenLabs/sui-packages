module 0x575bb64e0b704c83a54445eecddfdf06837404272d19abfcfe866a8b32d44b62::my_nft {
    struct Sleeper has store, key {
        id: 0x2::object::UID,
    ...
    fun init(arg0: MY_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<Sleeper>(&v4, v0, v2, arg1);
        0x2::display::update_version<Sleeper>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<Sleeper>>(v5, 0x2::tx_context::sender(arg1));
    }
    ...
    public entry fun mint(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<Sleeper>(v0, arg2);
    }
