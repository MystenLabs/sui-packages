module 0x570a6d48bab9d3a24b8ac060372bb0080f2c36a9ea13f8337be6e6d740586391::test_coin {
    ...
    fun init(arg0: TEST_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST_COIN>(arg0, 6, b"SUDC/DOG", b"DOG", b"Template Coin Description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"ccc"))), arg1);
