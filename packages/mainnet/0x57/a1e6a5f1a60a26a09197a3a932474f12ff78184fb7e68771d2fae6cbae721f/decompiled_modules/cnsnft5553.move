module 0x57a1e6a5f1a60a26a09197a3a932474f12ff78184fb7e68771d2fae6cbae721f::cnsnft5553 {
    struct CNSNFT5553 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5553, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5553>(arg0, arg1);
