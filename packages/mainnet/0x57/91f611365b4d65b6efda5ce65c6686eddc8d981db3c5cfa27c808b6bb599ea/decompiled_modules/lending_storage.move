module 0x5791f611365b4d65b6efda5ce65c6686eddc8d981db3c5cfa27c808b6bb599ea::lending_storage {
    ...
    public(friend) fun create_collection<T0, T1: store + key>(arg0: &mut LendingStorage, arg1: 0x1::ascii::String, arg2: 0x1::ascii::String, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v2 = Collection<T0>{
            ...
            offers    : 0x2::object_table::new<0x2::object::ID, Offer>(arg5),
            interest  : arg3,
            period    : arg4,
            name      : arg1,
            url       : arg2,
    ...
    public(friend) fun create_offer<T0>(arg0: &mut LendingStorage, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v2 = Offer{
            ...
            start_time : arg3,
            period     : get_collection_period<T0>(v1),
            is_started : false,
            is_repaid  : false,
            is_claimed : false,
        };
    ...
    public fun get_collection_period<T0>(arg0: &Collection<T0>) : u64 {
        arg0.period
    }
