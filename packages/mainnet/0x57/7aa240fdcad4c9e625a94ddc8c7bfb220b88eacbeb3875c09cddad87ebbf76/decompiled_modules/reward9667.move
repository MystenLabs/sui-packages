module 0x577aa240fdcad4c9e625a94ddc8c7bfb220b88eacbeb3875c09cddad87ebbf76::reward9667 {
    struct REWARD9667 has drop {
        dummy_field: bool,
    }

    struct TICKET_9667 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9667(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9667>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9667>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9667, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9667>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9667>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9667>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9667>>(v5, 0x2::tx_context::sender(arg1));
    }
