module 0x11cd053adc482718264550b322c35a68f65d56c2bbbe01639f69086124024f4d::cnsnft7559 {
    struct CNSNFT7559 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7559, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9896"));
        let v4 = 0x2::package::claim<CNSNFT7559>(arg0, arg1);
