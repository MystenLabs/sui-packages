module 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::pause_state {
    ...
    fun assert_can_apply_expiring_lock(arg0: &PauseState, arg1: u64) {
        assert!(arg0.lock_kind != 3, 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_pause_kind_mismatch());
        assert!(!is_paused(arg0, arg1), 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_already_paused());
    }
    ...
    public(friend) fun set_global(arg0: &mut PauseState, arg1: u64, arg2: u64) {
        ...
        assert!(arg1 > 0, 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_pause_ttl_too_long());
        assert!(arg1 <= 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::constants::max_global_pause_ttl_ms(), 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_pause_ttl_too_long());
        arg0.lock_kind = 1;
    ...
    public(friend) fun set_scoped(arg0: &mut PauseState, arg1: u64, arg2: u64) {
        assert_can_apply_expiring_lock(arg0, arg2);
        assert!(arg1 > 0, 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_pause_ttl_too_long());
        assert!(arg1 <= 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::constants::max_scoped_pause_ttl_ms(), 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_pause_ttl_too_long());
        arg0.lock_kind = 2;
        arg0.locked_at_ms = arg2;
        arg0.ttl_ms = arg1;
    }
    ...
    public(friend) fun set_watermark(arg0: &mut PauseState, arg1: u64) : bool {
        ...
        arg0.lock_kind = 4;
        arg0.locked_at_ms = arg1;
        arg0.ttl_ms = 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::constants::max_global_pause_ttl_ms();
        true
    }
