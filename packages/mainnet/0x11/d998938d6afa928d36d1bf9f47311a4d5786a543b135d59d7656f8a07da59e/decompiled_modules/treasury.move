module 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::treasury {
    ...
    public fun withdraw_all<T0>(arg0: &mut Treasury<T0>, arg1: &0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::caps::MarketAdminCap, arg2: 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::timelock::TimelockReceipt, arg3: address, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::timelock::consume_receipt_with_payload(arg2, 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::timelock::action_treasury_withdraw(), 0x2::object::id<Treasury<T0>>(arg0), withdraw_payload_hash(arg3, arg4), arg5);
        ...
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.balance) <= arg4, 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_amount_exceeds_max());
    ...
    public fun collect_fee<T0, T1: drop>(arg0: &mut Treasury<T0>, arg1: &T1, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: u16) : (0x2::balance::Balance<0x2::sui::SUI>, u64) {
        ...
        assert!(arg3 <= 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::constants::protocol_max_fee_bps(), 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_invalid_bps());
        let v0 = 0x2::balance::value<0x2::sui::SUI>(&arg2);
        if (v0 == 0 || arg3 == 0) {
            return (arg2, 0)
        };
        let v1 = 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::math_ext::mul_div_down_u64(v0, (arg3 as u64), (0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::constants::bps_denominator() as u64));
        if (v1 == 0) {
            return (arg2, 0)
        };
