module 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::watermark {
    ...
    public fun check_and_update(arg0: &mut Watermark, arg1: u128, arg2: u128, arg3: u64, arg4: u64) : u8 {
        ...
        if (arg2 > arg0.window_start_index && arg4 > arg0.window_start_ms) {
            if (0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::math_ext::is_spike_violation(arg2 - arg0.window_start_index, arg0.window_start_index, arg4 - arg0.window_start_ms, arg0.cumulative_apy_e9)) {
                return 3
            };
        };
        0
    ...
    public fun check_single_step(arg0: u128, arg1: u128, arg2: u64, arg3: u64, arg4: &Watermark) : u8 {
        ...
        if (arg1 < arg0) {
            if (arg1 < 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::math_ext::mul_div_down_u128(arg0, ((10000 - arg4.drop_bps) as u128), 10000)) {
                return 1
            };
            return 0
        };
        if (arg1 > arg0 && arg3 > arg2) {
            if (0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::math_ext::is_spike_violation(arg1 - arg0, arg0, arg3 - arg2, arg4.spike_apy_e9)) {
                return 2
            };
        };
        0
    ...
    public fun default() : Watermark {
        Watermark{
            ...
            cumulative_apy_e9  : 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::constants::max_apy_e9(),
            window_start_index : 0,
            window_start_ms    : 0,
            window_ms          : 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::constants::cumulative_window_ms(),
        }
    }
    ...
    public fun new(arg0: u64, arg1: u64, arg2: u64) : Watermark {
        assert!(arg0 <= 9999, 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_watermark_param_out_of_range());
        assert!(arg1 <= 10000000000, 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_watermark_param_out_of_range());
        assert!(arg2 <= 440000000, 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_watermark_param_out_of_range());
        Watermark{
            drop_bps           : arg0,
            spike_apy_e9       : arg1,
    ...
    public fun set_cumulative_apy_e9(arg0: &mut Watermark, arg1: u64) {
        assert!(arg1 <= 440000000, 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_watermark_param_out_of_range());
        arg0.cumulative_apy_e9 = arg1;
    }

    public fun set_drop_bps(arg0: &mut Watermark, arg1: u64) {
        assert!(arg1 <= 9999, 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_watermark_param_out_of_range());
        arg0.drop_bps = arg1;
    }
    ...
    public(friend) fun set_window_ms(arg0: &mut Watermark, arg1: u64) {
        assert!(arg1 > 0, 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_watermark_param_out_of_range());
        arg0.window_ms = arg1;
    }
