module 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::events {
    ...
    struct VaultShareRedeemed has copy, drop {
        vault_id: 0x2::object::ID,
        redeemer: address,
        shares_burned: u64,
        entry_epoch: u64,
    ...
    public(friend) fun emit_paused(arg0: u8, arg1: 0x2::object::ID, arg2: u8, arg3: u64, arg4: vector<u8>) {
        assert!(0x1::vector::length<u8>(&arg4) <= 256, 0x11d998938d6afa928d36d1bf9f47311a4d5786a543b135d59d7656f8a07da59e::errors::e_pause_reason_too_long());
        let v0 = Paused{
            scope     : arg0,
            object_id : arg1,
            lock_kind : arg2,
    ...
    public(friend) fun emit_vault_share_redeemed(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
        let v0 = VaultShareRedeemed{
            vault_id       : arg0,
            redeemer       : arg1,
            shares_burned  : arg2,
            entry_epoch    : arg3,
        ...
        0x2::event::emit<VaultShareRedeemed>(v0);
    }
