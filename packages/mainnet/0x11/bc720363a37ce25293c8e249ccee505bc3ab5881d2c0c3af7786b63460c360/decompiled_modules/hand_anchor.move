module 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::hand_anchor {
    ...
    fun execute_settle<T0>(arg0: &mut 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: vector<u64>, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(arg1.status == 1, 501);
        assert!(arg1.table_id == 0x2::object::id<0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::TableAnchor<T0>>(arg0), 502);
        ...
        while (v3 < v0) {
            ...
            0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::apply_seat_outcome<T0>(arg0, v4.seat_idx, v4.seat_epoch, v4.address, *0x1::vector::borrow<u64>(&arg2, v3));
            v3 = v3 + 1;
        };
        if (arg3 > 0) {
            assert!(arg3 <= 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::escrow_value<T0>(arg0), 511);
            0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::accrue_rake<T0>(arg0, 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::take_from_escrow<T0>(arg0, arg3));
        };
        arg1.status = 2;
        0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::clear_active_hand<T0>(arg0, 0x2::object::id<HandAnchor>(arg1));
        let v5 = HandSettled{
    ...
    fun execute_void<T0>(arg0: &mut 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(arg1.status == 1, 501);
        assert!(arg1.table_id == 0x2::object::id<0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::TableAnchor<T0>>(arg0), 502);
        let v0 = 0;
        while (v0 < 0x1::vector::length<HandPlayer>(&arg1.player_list)) {
            let v1 = 0x1::vector::borrow<HandPlayer>(&arg1.player_list, v0);
            0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::apply_seat_outcome<T0>(arg0, v1.seat_idx, v1.seat_epoch, v1.address, v1.start_stack);
            v0 = v0 + 1;
        };
        arg1.status = 3;
        0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::clear_active_hand<T0>(arg0, 0x2::object::id<HandAnchor>(arg1));
    ...
    public fun open_board_card(arg0: &mut HandAnchor, arg1: &0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::coordinator_registry::CoordinatorRegistry, arg2: u8, arg3: &0x2::tx_context::TxContext) {
        0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::coordinator_registry::assert_coordinator(arg1, arg3);
    ...
    public fun settle_hand<T0>(arg0: &mut 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: &0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::coordinator_registry::CoordinatorRegistry, arg3: vector<u64>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::coordinator_registry::assert_coordinator(arg2, arg6);
        execute_settle<T0>(arg0, arg1, arg3, arg4, arg5);
    }

    public fun settle_hand_with_quorum<T0>(arg0: &mut 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: vector<u64>, arg3: u64, arg4: u64, arg5: vector<vector<u8>>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == 1, 501);
        let v0 = 0x1::vector::length<HandPlayer>(&arg1.player_list);
        assert!(0x1::vector::length<u64>(&arg2) == v0, 508);
        ...
        arg1.trust_model = 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::version::trust_player_quorum();
        execute_settle<T0>(arg0, arg1, arg2, arg3, arg6);
    }
    ...
    public fun start_hand<T0>(arg0: &mut 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::TableAnchor<T0>, arg1: &0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::coordinator_registry::CoordinatorRegistry, arg2: u64, arg3: vector<HandPlayer>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<address>, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::coordinator_registry::assert_coordinator(arg1, arg9);
        ...
        while (v2 < v0) {
            ...
            0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::assert_seat_matches<T0>(arg0, v3.seat_idx, v3.seat_epoch, v3.address, v3.account_id);
            assert!(v3.start_stack == 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::seat_current_stack<T0>(arg0, v3.seat_idx), 512);
            let v4 = 0x1::vector::length<u8>(&v3.session_pubkey);
            assert!(v4 == 0 || v4 == 32, 516);
            v2 = v2 + 1;
        };
        let v5 = 0x2::object::id<0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::TableAnchor<T0>>(arg0);
        let v6 = HandAnchor{
            ...
            committee_list      : arg6,
            status              : 1,
            trust_model         : 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::version::trust_prototype(),
        ...
        0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::mark_active_hand<T0>(arg0, v7);
        let v8 = HandStarted{
            hand_id           : v7,
            table_id          : v5,
    ...
    public fun void_hand<T0>(arg0: &mut 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: &0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::coordinator_registry::CoordinatorRegistry, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::coordinator_registry::assert_coordinator(arg2, arg5);
        execute_void<T0>(arg0, arg1, arg3, arg4);
    }

    public fun void_hand_after_deadline<T0>(arg0: &mut 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == 1, 501);
