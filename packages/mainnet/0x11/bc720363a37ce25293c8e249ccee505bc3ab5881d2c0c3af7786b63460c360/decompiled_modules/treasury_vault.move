module 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::treasury_vault {
    ...
    public fun open_vault<T0>(arg0: &mut 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::player_account::PlayerAccount, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::player_account::owner(arg0) == v0, 300);
        assert!(0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::player_account::is_active(arg0), 308);
        let v1 = TreasuryVault<T0>{
            id                : 0x2::object::new(arg1),
            owner             : v0,
            account_id        : 0x2::object::id<0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::player_account::PlayerAccount>(arg0),
        ...
        0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::player_account::register_vault<T0>(arg0, v2);
        let v3 = VaultOpened{
            vault_id   : v2,
            owner      : v0,
            account_id : 0x2::object::id<0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::player_account::PlayerAccount>(arg0),
        ...
        0x2::transfer::transfer<TreasuryVault<T0>>(v1, v0);
    }

    public fun open_withdrawal_ledger<T0>(arg0: &0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::player_account::PlayerAccount, arg1: &TreasuryVault<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun withdraw_with_fee<T0>(arg0: &mut TreasuryVault<T0>, arg1: &mut 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::platform_fee_vault::PlatformFeeVault<T0>, arg2: &mut WithdrawalLedger<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::platform_fee_vault::fee_bps<T0>(arg1);
        let v3 = (((v1 as u128) * (v2 as u128) / 10000) as u64);
        let v4 = 0x2::balance::split<T0>(&mut arg0.available_balance, arg3);
        if (v3 > 0) {
            0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::platform_fee_vault::accept_fee<T0>(arg1, 0x2::balance::split<T0>(&mut v4, v3));
            let v5 = ProfitWithdrawalFeeCharged{
                vault_id          : 0x2::object::id<TreasuryVault<T0>>(arg0),
                fee_vault_id      : 0x2::object::id<0x11bc720363a37ce25293c8e249ccee505bc3ab5881d2c0c3af7786b63460c360::platform_fee_vault::PlatformFeeVault<T0>>(arg1),
                owner             : v0,
                coin_type         : 0x1::type_name::with_defining_ids<T0>(),
                profit_fee_basis  : v1,
