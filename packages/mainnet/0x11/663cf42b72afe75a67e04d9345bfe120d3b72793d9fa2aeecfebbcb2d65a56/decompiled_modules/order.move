module 0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::order {
    ...
    struct OrderBookDecimalsSetEvent has copy, drop {
        order_book_id: 0x2::object::ID,
        side: vector<u8>,
        decimals: u8,
        source: vector<u8>,
    ...
    public(friend) fun add_tpsl_level(arg0: &mut Order, arg1: u8, arg2: u128, arg3: u128, arg4: u64, arg5: bool) : u64 {
        ...
        assert!(v0 < 18446744073709551615, 13906838499376889879);
        let v1 = (v0 as u64);
    ...
    public fun assert_initialized<T0, T1, T2>(arg0: &OrderBook<T0, T1, T2>) {
        assert!(arg0.base_decimals != 0 && arg0.quote_decimals != 0, 13906836605296967713);
    }

    public(friend) fun assert_market_matches(arg0: &Order, arg1: 0x2::object::ID) {
        assert!(arg0.market_id == arg1, 13906839040541720583);
    }

    fun assert_metadata_type_matches<T0, T1, T2>(arg0: bool) {
        let v0 = if (arg0) {
            0x1::type_name::with_defining_ids<T0>()
        } else {
            0x1::type_name::with_defining_ids<T1>()
        };
        assert!(0x1::type_name::with_defining_ids<T2>() == v0, 13906836424908865577);
    }

    public(friend) fun assert_order_book_matches<T0, T1, T2>(arg0: &OrderBook<T0, T1, T2>, arg1: &Order) {
        assert!(arg1.order_book_id == 0x2::object::id<OrderBook<T0, T1, T2>>(arg0), 13906839019066753029);
        assert!(arg1.market_id == arg0.market_id, 13906839023361720325);
    }

    public(friend) fun assert_order_cap_matches(arg0: &Order, arg1: &OrderCap) {
        assert!(arg1.order_id == 0x2::object::uid_to_inner(&arg0.id), 13906838997591785475);
        assert!(arg1.position_id == arg0.position_id, 13906839001886752771);
    }

    public(friend) fun assert_receipt_matches_order(arg0: &Order, arg1: &ExecuteReceipt) {
        assert!(arg1.order_id == 0x2::object::uid_to_inner(&arg0.id), 13906839057721720841);
        assert!(arg1.position_id == arg0.position_id, 13906839062016688137);
    }

    public fun base_decimals<T0, T1, T2>(arg0: &OrderBook<T0, T1, T2>) : u8 {
        arg0.base_decimals
    }

    public(friend) fun borrow_position_cap(arg0: &Order) : &0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        assert!(0x1::option::is_some<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>(&arg0.position_cap), 13906837369801015327);
        0x1::option::borrow<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>(&arg0.position_cap)
    }
    ...
    public(friend) fun cancel<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: Order, arg2: OrderCap) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        ...
        assert!(arg1.status == 0, 13906837855131271183);
        let (v3, v4, v5, _) = destroy_order(arg1);
        assert!(v1 == v3, 13906837863720419331);
    ...
    public(friend) fun claim_orphan<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: OrderCap) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        ...
        assert!(0x2::dynamic_field::exists_<OrphanDfKey>(&arg0.id, v3), 13906838190138589197);
    ...
    public(friend) fun cleanup_and_claim_orphan<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: Order, arg2: OrderCap) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        ...
        assert!(v1 == v4, 13906838138598326275);
        v3
    }
    ...
    public(friend) fun close<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: Order, arg2: OrderCap) {
        ...
        0x2::object::delete(v0);
        assert!(arg1.status == 2, 13906837949620682769);
        let (v3, v4, v5, _) = destroy_order(arg1);
        assert!(v1 == v3, 13906837958209699843);
    ...
    public fun create_order_book<T0, T1, T2>(arg0: &0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::global_config::AdminCap, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_order_book_with_registry<T0, T1, T2>(arg0: &0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::global_config::AdminCap, arg1: &mut 0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::order_book_registry::OrderBookRegistry, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = new_order_book<T0, T1, T2>(arg2, arg3, arg4, arg5, arg6);
        let v1 = 0x2::object::id<OrderBook<T0, T1, T2>>(&v0);
        0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::order_book_registry::register(arg1, arg2, v1);
    ...
    fun destroy_order(arg0: Order) : (0x2::object::ID, 0x2::object::ID, 0x1::option::Option<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>, u8) {
        ...
        let v15 = v9;
        let v16 = v0;
        assert!(0x2::bag::is_empty(&v15), 13906837021907877907);
    ...
    public fun executed_ratio_sum(arg0: &Order, arg1: u8) : u64 {
        let v0 = 0;
        let v1 = 0;
        while (v1 < 0x1::vector::length<ExecutionRecord>(&arg0.executions)) {
            let v2 = 0x1::vector::borrow<ExecutionRecord>(&arg0.executions, v1);
            if (v2.trigger_type == arg1) {
                v0 = v0 + v2.effective_close_ratio_bps;
            };
            v1 = v1 + 1;
        };
        v0
    ...
    public fun harvest_fees<T0, T1, T2, T3>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::global_config::AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun init_decimals_via_coin_metadata<T0, T1, T2, T3>(arg0: &0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::global_config::AdminCap, arg1: &mut OrderBook<T0, T1, T2>, arg2: &0x2::coin::CoinMetadata<T3>, arg3: bool) {
        assert_metadata_type_matches<T1, T2, T3>(arg3);
        if (arg3) {
            set_base_decimals<T0, T1, T2>(arg1, 0x2::coin::get_decimals<T3>(arg2), b"coin_metadata");
        } else {
            set_quote_decimals<T0, T1, T2>(arg1, 0x2::coin::get_decimals<T3>(arg2), b"coin_metadata");
        };
    }

    public fun init_decimals_via_currency<T0, T1, T2, T3>(arg0: &0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::global_config::AdminCap, arg1: &mut OrderBook<T0, T1, T2>, arg2: &0x2::coin_registry::Currency<T3>, arg3: bool) {
        assert_metadata_type_matches<T1, T2, T3>(arg3);
        if (arg3) {
            set_base_decimals<T0, T1, T2>(arg1, 0x2::coin_registry::decimals<T3>(arg2), b"currency");
        } else {
            set_quote_decimals<T0, T1, T2>(arg1, 0x2::coin_registry::decimals<T3>(arg2), b"currency");
        };
    }
    ...
    public fun is_initialized<T0, T1, T2>(arg0: &OrderBook<T0, T1, T2>) : bool {
        arg0.base_decimals != 0 && arg0.quote_decimals != 0
    }
    ...
    public(friend) fun new_order<T0, T1, T2>(arg0: &OrderBook<T0, T1, T2>, arg1: 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap, arg2: 0x2::object::ID, arg3: bool, arg4: u128, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (Order, OrderCap) {
        ...
        assert!(!0x2::table::contains<0x2::object::ID, 0x2::object::ID>(&arg0.order_index, v0), 13906837133575847937);
        let v1 = Order{
    ...
    fun new_order_book<T0, T1, T2>(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : OrderBook<T0, T1, T2> {
        assert!(arg1 <= 10000, 13906835888035332095);
        OrderBook<T0, T1, T2>{
    ...
    public(friend) fun park_cap_post_completion(arg0: &mut Order, arg1: 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap) {
        assert!(arg0.status == 2, 13906837580253495313);
        assert!(0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::position_cap_position_id(&arg1) == arg0.position_id, 13906837593138921497);
        assert!(0x1::option::is_none<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>(&arg0.position_cap), 13906837601728987163);
    ...
    public fun pause<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::global_config::AdminCap) {
    ...
    public fun quote_decimals<T0, T1, T2>(arg0: &OrderBook<T0, T1, T2>) : u8 {
        arg0.quote_decimals
    }
    ...
    public fun register_existing_order_book<T0, T1, T2>(arg0: &0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::global_config::AdminCap, arg1: &mut 0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::order_book_registry::OrderBookRegistry, arg2: &OrderBook<T0, T1, T2>) {
        0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::order_book_registry::register(arg1, arg2.market_id, 0x2::object::id<OrderBook<T0, T1, T2>>(arg2));
    }
    ...
    public(friend) fun remove_settlement<T0>(arg0: &mut Order) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.settlements, v0), 13906837790706499595);
    ...
    public(friend) fun remove_triggered_level(arg0: &mut Order, arg1: u8, arg2: u64) {
        ...
        abort 13906838851564077077
    }

    public fun resume<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::global_config::AdminCap) {
        arg0.is_active = true;
        let v0 = OrderBookPausedEvent{
            order_book_id : 0x2::object::id<OrderBook<T0, T1, T2>>(arg0),
            is_active     : true,
    ...
    public(friend) fun return_position_cap(arg0: &mut Order, arg1: 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap, arg2: u64) {
        assert!(0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::position_cap_position_id(&arg1) == arg0.position_id, 13906837468584869913);
        0x1::option::fill<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>(&mut arg0.position_cap, arg1);
        arg0.status = 0;
        arg0.updated_ts = arg2;
    }

    fun set_base_decimals<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: u8, arg2: vector<u8>) {
        assert!(arg0.base_decimals == 0, 13906836459268210723);
        assert!(arg1 != 0, 13906836463563440167);
        arg0.base_decimals = arg1;
        let v0 = OrderBookDecimalsSetEvent{
            order_book_id : 0x2::object::id<OrderBook<T0, T1, T2>>(arg0),
            side          : b"base",
            decimals      : arg1,
            source        : arg2,
        };
        0x2::event::emit<OrderBookDecimalsSetEvent>(v0);
    }

    fun set_quote_decimals<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: u8, arg2: vector<u8>) {
        assert!(arg0.quote_decimals == 0, 13906836527987818533);
        assert!(arg1 != 0, 13906836532282916903);
        arg0.quote_decimals = arg1;
        let v0 = OrderBookDecimalsSetEvent{
            order_book_id : 0x2::object::id<OrderBook<T0, T1, T2>>(arg0),
            side          : b"quote",
            decimals      : arg1,
    ...
    public(friend) fun share_order<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: Order) {
        assert!(arg1.order_book_id == 0x2::object::id<OrderBook<T0, T1, T2>>(arg0), 13906837318259703813);
    ...
    public(friend) fun take_parked_cap(arg0: &mut Order) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        assert!(arg0.status == 2, 13906837653267939345);
        assert!(0x1::option::is_some<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>(&arg0.position_cap), 13906837657563693085);
    ...
    public(friend) fun take_position_cap(arg0: &mut Order) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        assert!(arg0.status == 0, 13906837395569770511);
        arg0.status = 1;
        0x1::option::extract<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>(&mut arg0.position_cap)
    }
    ...
    public fun update_fee_params<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::global_config::AdminCap, arg2: u64, arg3: u64) {
        assert!(arg2 <= 10000, 13906836789978464255);
        arg0.fee_rate_bps = arg2;
        arg0.fee_cap = arg3;
    }

    public fun update_params<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0xacfd46ee010b19ca9d0f001dc55a1e4d3fa9ca7004285ca1b0629397487feff5::global_config::AdminCap, arg2: u64) {
