module 0x11351a3f5a8ca490b66bbc0a53953a02de16f4c5f7212dbf108a32d98a23965a::cnsnft7907 {
    struct CNSNFT7907 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7907, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6732"));
        let v4 = 0x2::package::claim<CNSNFT7907>(arg0, arg1);
