module 0x119cd9be60a8e11ffdc3eed23e77891007aee72bcbe89169aa173936f0d3c8f6::config {
    ...
    struct AmbassadorConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x119cd9be60a8e11ffdc3eed23e77891007aee72bcbe89169aa173936f0d3c8f6::acl::ACL,
    ...
    public fun add_role(arg0: &AdminCap, arg1: &mut AmbassadorConfig, arg2: address, arg3: u8) {
        0x119cd9be60a8e11ffdc3eed23e77891007aee72bcbe89169aa173936f0d3c8f6::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut AmbassadorConfig, arg2: address, arg3: u8) {
        0x119cd9be60a8e11ffdc3eed23e77891007aee72bcbe89169aa173936f0d3c8f6::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public(friend) fun check_staff(arg0: &AmbassadorConfig, arg1: address) {
        assert!(0x119cd9be60a8e11ffdc3eed23e77891007aee72bcbe89169aa173936f0d3c8f6::acl::has_role(&arg0.acl, arg1, 0), 0);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = AmbassadorConfig{
            ...
            acl                     : 0x119cd9be60a8e11ffdc3eed23e77891007aee72bcbe89169aa173936f0d3c8f6::acl::new(arg0),
    ...
    public(friend) fun set_ambassador_pause(arg0: &mut AmbassadorConfig, arg1: 0x2::object::ID, arg2: bool, arg3: &0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<0x2::object::ID, bool>(&arg0.pause_table, arg1)) {
            *0x2::table::borrow_mut<0x2::object::ID, bool>(&mut arg0.pause_table, arg1) = arg2;
        } else {
    ...
    public(friend) fun set_ambassador_requested_time(arg0: &mut AmbassadorConfig, arg1: 0x2::object::ID, arg2: u64) {
        if (0x2::table::contains<0x2::object::ID, u64>(&arg0.requested_time_table, arg1)) {
            *0x2::table::borrow_mut<0x2::object::ID, u64>(&mut arg0.requested_time_table, arg1) = arg2;
        } else {
