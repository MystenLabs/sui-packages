module 0x110bb9da8ad90914ef46973872012f5b539f29bc03e391a78a5b9a07e0acd66a::shieldcoin {
    ...
    fun init(arg0: SHIELDCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin_registry::new_currency_with_otw<SHIELDCOIN>(arg0, 9, 0x1::string::utf8(b"ZEC"), 0x1::string::utf8(b"ShieldCoin"), 0x1::string::utf8(b"Private ZEC on Sui with zk-SNARKs, 21M max supply"), 0x1::string::utf8(b""), arg1);
