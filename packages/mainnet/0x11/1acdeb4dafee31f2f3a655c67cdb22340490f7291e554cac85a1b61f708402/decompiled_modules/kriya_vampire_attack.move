module 0x111acdeb4dafee31f2f3a655c67cdb22340490f7291e554cac85a1b61f708402::kriya_vampire_attack {
    ...
    public entry fun add_incentives_for_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut KriyaLockdropForPool<T0, T1>, arg2: &KriyaAttackConfig, arg3: 0x2::coin::Coin<0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive::HIVE>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (u64, 0x1::string::String) {
    ...
    public fun destroy_user_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &KriyaLockdropForPool<T0, T1>, arg4: &mut 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::HiveProfile, arg5: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, u128, u128) {
        ...
        } = 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::entry_remove_app_from_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, arg5);
        0x2::object::delete(v0);
        0x2::table::drop<u64, bool>(v5);
        (v1, v2, v3, v4, v6, v7)
    }

    public fun does_user_have_position<T0, T1>(arg0: &0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::HiveProfile, arg1: &KriyaLockdropForPool<T0, T1>) : bool {
    ...
    public fun extract_liquidity_from_kriya<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &mut KriyaLockdropForPool<T0, T1>, arg4: &mut 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::Pool<T0, T1>, arg5: &mut 0x2::tx_context::TxContext) : (u128, u8, u128, u64, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive::HIVE>) {
        0x2::clock::timestamp_ms(arg0);
        ...
        (arg3.total_lp_locked, arg3.precision, arg3.total_weighted_units, arg3.total_hive_incentives, v3, v4, 0x2::balance::withdraw_all<0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive::HIVE>(&mut arg3.available_hive_tokens))
    }

    public fun get_user_position<T0, T1>(arg0: &0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::HiveProfile, arg1: &KriyaLockdropForPool<T0, T1>) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u128, u64) {
        let v0 = 0x1::vector::empty<u64>();
        let v1 = 0x1::vector::empty<u64>();
        let v2 = 0x1::vector::empty<u128>();
        let v3 = 0x1::vector::empty<bool>();
        let v4 = 0x1::vector::empty<u64>();
        let v5 = 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::get_hive_app_name(&arg1.user_profile_access_cap);
        if (!0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::exists_for_profile(arg0, v5)) {
            return (0x1::vector::empty<u64>(), v0, v1, v2, v3, v4, 0, 0)
        };
        let v6 = 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::borrow_from_profile<UserKriyaHivePosition>(arg0, v5);
        let v7 = 0;
    ...
    public entry fun initialize_attack_on_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::config::HiveEntryCap, arg2: 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::HiveAppAccessCapability, arg3: 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::KriyaLPToken<T0, T1>, arg4: &mut KriyaAttackConfig, arg5: 0x1::string::String, arg6: u8, arg7: 0x2::coin::Coin<0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive::HIVE>, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : address {
        ...
        let v4 = KriyaLockdropForPool<T0, T1>{
            ...
            available_hive_tokens   : 0x2::balance::split<0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive::HIVE>(&mut v0, arg8),
        ...
        0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::coin_helper::destroy_or_transfer_balance<0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive::HIVE>(v0, 0x2::tx_context::sender(arg9), arg9);
    ...
    public entry fun initialize_kriya_attack_config(arg0: &0x2::clock::Clock, arg1: &0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::config::HiveEntryCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) : address {
    ...
    public entry fun lock_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &mut KriyaLockdropForPool<T0, T1>, arg4: &mut 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::HiveProfile, arg5: 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::KriyaLPToken<T0, T1>, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : (0x1::string::String, u8) {
        ...
        let v4 = if (0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::exists_for_profile(arg4, 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::get_hive_app_name(&arg3.user_profile_access_cap))) {
            0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::entry_remove_app_from_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, arg8)
        } else {
        ...
        0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::entry_add_app_to_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, v4, arg8);
    ...
    public fun simulate_withdraw_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &KriyaAttackConfig, arg2: &KriyaLockdropForPool<T0, T1>, arg3: &0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::HiveProfile, arg4: u128, arg5: u64) : (u64, u64, bool) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        ...
        let v2 = 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::borrow_from_profile<UserKriyaHivePosition>(arg3, v1);
    ...
    public entry fun withdraw_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &mut KriyaLockdropForPool<T0, T1>, arg4: &mut 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::HiveProfile, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (0x1::string::String, u8) {
        ...
        let v5 = 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::entry_remove_app_from_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, arg7);
        ...
        0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::entry_add_app_to_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, v5, arg7);
