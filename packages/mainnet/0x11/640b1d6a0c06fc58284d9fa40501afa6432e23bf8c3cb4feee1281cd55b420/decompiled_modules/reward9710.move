module 0x11640b1d6a0c06fc58284d9fa40501afa6432e23bf8c3cb4feee1281cd55b420::reward9710 {
    struct REWARD9710 has drop {
        dummy_field: bool,
    }

    struct TICKET_9710 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9710(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9710>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9710>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9710, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9710>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9710>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9710>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9710>>(v5, 0x2::tx_context::sender(arg1));
    }
