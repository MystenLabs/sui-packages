module 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::create_match_tool {
    ...
    public fun execute(arg0: &mut 0xe465ec2863d8208a4943744f056f978fefa502d67d0a021de65efdee209ee83a::proof_of_uid::ProofOfUID, arg1: &mut CreateMatchState, arg2: &mut 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game_caps::GameCapStore, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u8, arg9: u64, arg10: vector<u8>, arg11: vector<u8>, arg12: u64, arg13: &0x2::clock::Clock, arg14: u64, arg15: u8, arg16: u64, arg17: u64, arg18: &mut 0x2::tx_context::TxContext) : 0xe465ec2863d8208a4943744f056f978fefa502d67d0a021de65efdee209ee83a::tagged_output::TaggedOutput {
        ...
        let (v0, v1) = if (arg14 == 0) {
            ...
            0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game::new_match((arg3 as u32), (arg4 as u32), (arg5 as u32), (arg6 as u32), (arg7 as u32), arg8, (arg9 as u32), (arg12 as u32), arg10, arg11, arg13, arg18)
        } else {
            let v3 = 0x1::vector::empty<u32>();
            let v4 = &mut v3;
            0x1::vector::push_back<u32>(v4, (arg16 as u32));
            0x1::vector::push_back<u32>(v4, (arg17 as u32));
            0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game::new_match_from_snapshot((arg3 as u32), (arg4 as u32), (arg5 as u32), (arg6 as u32), (arg7 as u32), arg8, (arg9 as u32), (arg12 as u32), arg10, arg11, v3, arg15, (arg14 as u32), arg13, arg18)
        };
        let v5 = v1;
        let v6 = v0;
        let v7 = 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game::game_cap_game_id(&v6);
        0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game_caps::store_cap(arg2, 0x2::object::id_to_address(&v7), v6, 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game_caps::execution_id_from_worksheet(arg0));
        0x2::transfer::public_share_object<0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game::Match>(v5);
        0xe465ec2863d8208a4943744f056f978fefa502d67d0a021de65efdee209ee83a::tagged_output::with_named_payload(0xe465ec2863d8208a4943744f056f978fefa502d67d0a021de65efdee209ee83a::tagged_output::with_named_payload(0xe465ec2863d8208a4943744f056f978fefa502d67d0a021de65efdee209ee83a::tagged_output::new(b"ok"), b"match_id", 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::utils::addr_payload(0x2::object::id_to_address(&v7))), b"state", 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::utils::raw_json_payload(0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::play_hand_tool::build_state_json(&v5, 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game::to_act(&v5))))
    }
