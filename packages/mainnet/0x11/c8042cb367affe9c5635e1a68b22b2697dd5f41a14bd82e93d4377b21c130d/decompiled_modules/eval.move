module 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::eval {
    ...
    public fun best_of_seven(arg0: &vector<u8>) : HandRank {
        assert!(0x1::vector::length<u8>(arg0) == 7, 13906834423451746309);
        let v0 = 0;
        while (v0 < 7) {
            assert!(*0x1::vector::borrow<u8>(arg0, v0) < 52, 13906834440631353345);
            v0 = v0 + 1;
        };
        let v1 = HandRank{
            class  : 0,
        ...
        while (v3 < 7) {
            ...
            while (v4 < 7) {
                ...
                let v7 = evaluate_five(&v5);
                if (v2 || hand_rank_cmp(&v7, &v1) == 2) {
                    v1 = v7;
                    v2 = false;
                };
                v4 = v4 + 1;
    ...
    public fun evaluate_five(arg0: &vector<u8>) : HandRank {
        assert!(0x1::vector::length<u8>(arg0) == 5, 13906834569480503299);
        ...
        while (v3 < 5) {
            ...
            assert!(v4 < 52, 13906834612430045185);
            let v5 = 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::types::card_rank(v4);
            0x1::vector::push_back<u8>(&mut v1, v5);
            0x1::vector::push_back<u8>(&mut v2, 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::types::card_suit(v4));
