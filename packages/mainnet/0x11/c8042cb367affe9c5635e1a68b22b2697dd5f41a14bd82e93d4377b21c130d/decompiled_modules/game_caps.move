module 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game_caps {
    ...
    public(friend) fun assert_execution(arg0: &GameCapStore, arg1: address, arg2: 0x1::option::Option<0x2::object::ID>) {
        ...
        assert!(*0x2::dynamic_field::borrow<ExecutionBindingKey, 0x2::object::ID>(&arg0.id, v1) == 0x1::option::destroy_some<0x2::object::ID>(arg2), 13906834432041418753);
    }

    public(friend) fun borrow_cap(arg0: &GameCapStore, arg1: address) : &0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game::GameCap {
        0x2::dynamic_object_field::borrow<address, 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game::GameCap>(&arg0.id, arg1)
    }
    ...
    public(friend) fun store_cap(arg0: &mut GameCapStore, arg1: address, arg2: 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game::GameCap, arg3: 0x1::option::Option<0x2::object::ID>) {
        0x2::dynamic_object_field::add<address, 0x11c8042cb367affe9c5635e1a68b22b2697dd5f41a14bd82e93d4377b21c130d::game::GameCap>(&mut arg0.id, arg1, arg2);
