module 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_config {
    ...
    fun assert_supported_policy_version(arg0: u64) {
        assert!(arg0 == 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_governance::minimum_start_policy_version(), 3);
    }
    ...
    public(friend) fun asset_type_matches_config<T0>(arg0: &TypedFeeConfig<T0>) : bool {
        0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::onchain_asset_lane_manager::matches_supported_order_typed_non_sui_asset_bytes<T0>(&arg0.asset_type_bytes)
    }

    public(friend) fun bps<T0>(arg0: &TypedFeeConfig<T0>) : u64 {
        arg0.bps
    }
    ...
    public(friend) fun config_params_valid<T0>(arg0: u64, arg1: u8, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : bool {
        arg0 == 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_governance::minimum_start_policy_version() && 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_governance::admin_update_params_valid<T0>(arg1, arg2, arg3, arg4, arg5)
    }
    ...
    public(friend) fun config_shape_valid<T0>(arg0: &TypedFeeConfig<T0>) : bool {
        if (config_target_supported<T0>()) {
    ...
    public(friend) fun config_target_supported<T0>() : bool {
        0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::order_payment_assets::is_supported_order_payment_usdc_coin_type<T0>() && 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_policy::typed_collateral_fee_policy_closed<T0>()
    }

    public(friend) fun config_version<T0>(arg0: &TypedFeeConfig<T0>) : u64 {
        arg0.config_version
    }
    ...
    public(friend) fun create_minimum_start_config<T0>(arg0: &TypedFeeAdminCap<T0>, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) : TypedFeeConfig<T0> {
        create_config<T0>(arg0, 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_governance::minimum_start_policy_version(), 1, 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_governance::native_sui_usdc_decimals(), 0, 0, 0, 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_governance::min_viable_order_amount_floor(), arg1, arg2)
    }
    ...
    public(friend) fun decimals<T0>(arg0: &TypedFeeConfig<T0>) : u8 {
        arg0.decimals
    }

    public(friend) fun disabled_seed_entry_creates_enabled_config<T0>() : bool {
        disabled_seed_entry_source_candidate<T0>() && false
    }

    public(friend) fun disabled_seed_entry_expected_custody<T0>() : 0x1::option::Option<address> {
    ...
    public(friend) fun disabled_seed_entry_hard_one_shot_claimed<T0>() : bool {
        disabled_seed_entry_source_candidate<T0>() && false
    }

    public(friend) fun disabled_seed_entry_runtime_enablement_allowed<T0>() : bool {
        disabled_seed_entry_source_candidate<T0>() && false
    }

    public(friend) fun disabled_seed_entry_shares_or_vaults_config<T0>() : bool {
        disabled_seed_entry_source_candidate<T0>() && false
    }

    public(friend) fun disabled_seed_entry_source_candidate<T0>() : bool {
        0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::onchain_asset_lane_manager::matches_sui_usdc_testnet_type<T0>() && config_target_supported<T0>()
    }

    public(friend) fun e_invalid_params() : u64 {
        2
    }

    public(friend) fun e_invalid_version() : u64 {
        3
    }

    public(friend) fun e_seed_entry_retired() : u64 {
        5
    }

    public(friend) fun e_unauthorized_seed() : u64 {
        4
    }

    public(friend) fun e_unsupported_asset() : u64 {
        1
    }
    ...
    public(friend) fun enabled<T0>(arg0: &TypedFeeConfig<T0>) : bool {
        arg0.enabled
    }
    ...
    public(friend) fun max_fee_amount<T0>(arg0: &TypedFeeConfig<T0>) : u64 {
        arg0.max_fee_amount
    }

    public(friend) fun min_fee_amount<T0>(arg0: &TypedFeeConfig<T0>) : u64 {
        arg0.min_fee_amount
    }

    public(friend) fun min_viable_order_amount<T0>(arg0: &TypedFeeConfig<T0>) : u64 {
        arg0.min_viable_order_amount
    }

    public(friend) fun minimum_start_config<T0>(arg0: &TypedFeeConfig<T0>) : bool {
        if (config_shape_valid<T0>(arg0)) {
            if (arg0.policy_version == 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_governance::minimum_start_policy_version()) {
                if (arg0.config_version >= 1) {
                    if (arg0.decimals == 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_governance::native_sui_usdc_decimals()) {
                        if (arg0.bps == 0) {
                            if (arg0.min_fee_amount == 0) {
                                if (arg0.max_fee_amount == 0) {
                                    arg0.min_viable_order_amount == 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_governance::min_viable_order_amount_floor()
                                } else {
                                    false
                                }
                            } else {
    ...
    public(friend) fun network<T0>(arg0: &TypedFeeConfig<T0>) : u8 {
        arg0.network
    }

    public(friend) fun network_for_config_target<T0>() : u8 {
        if (0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::onchain_asset_lane_manager::matches_sui_usdc_testnet_type<T0>()) {
            return 1
        };
        if (0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::onchain_asset_lane_manager::matches_sui_usdc_mainnet_type<T0>()) {
            return 2
        };
        0
    }

    public(friend) fun network_mainnet() : u8 {
        2
    }

    public(friend) fun network_testnet() : u8 {
        1
    }

    public(friend) fun network_unsupported() : u8 {
        0
    }
    ...
    public(friend) fun policy_version<T0>(arg0: &TypedFeeConfig<T0>) : u64 {
        arg0.policy_version
    }
    ...
    public(friend) fun seed_entry_absent() : u8 {
        0
    }

    public(friend) fun seed_entry_classification<T0>() : u8 {
        if (disabled_seed_entry_source_candidate<T0>()) {
            return 2
        };
        0
    ...
    public(friend) fun seed_entry_operator_gated_testnet_retained() : u8 {
        1
    }

    public(friend) fun seed_entry_retired_after_seed() : u8 {
        2
    }
    ...
    public(friend) fun seed_sui_usdc_testnet_minimum_start_config<T0>(arg0: &0x2::tx_context::TxContext) {
    ...
    fun supported_asset_type_bytes<T0>() : vector<u8> {
        let v0 = 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::onchain_asset_lane_manager::supported_order_typed_non_sui_asset_bytes<T0>();
        assert!(0x1::option::is_some<vector<u8>>(&v0), 1);
        0x1::option::destroy_some<vector<u8>>(v0)
    }

    public(friend) fun testnet_usdc_seed_custody() : address {
        @0x3b8916cf8bc90fdfcb0a5fd511f35a3d1ddc567817ca9e6164f9dd217077d1fe
    }

    public(friend) fun testnet_usdc_seed_operator() : address {
        @0x3b8916cf8bc90fdfcb0a5fd511f35a3d1ddc567817ca9e6164f9dd217077d1fe
    }
