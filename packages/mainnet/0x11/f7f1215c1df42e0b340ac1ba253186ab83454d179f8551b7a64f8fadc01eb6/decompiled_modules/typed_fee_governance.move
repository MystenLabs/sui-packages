module 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_governance {
    public(friend) fun admin_mutability_required_before_runtime<T0>() : bool {
        fee_governance_target<T0>()
    }
    ...
    public(friend) fun fee_governance_target<T0>() : bool {
    ...
    public(friend) fun future_admin_update_rules_pinned<T0>() : bool {
        fee_governance_target<T0>() && 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_policy::generic_zero_fee_path_rejected<T0>()
    }

    public(friend) fun generic_zero_fee_fallback_rejected<T0>() : bool {
        0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_policy::generic_zero_fee_path_rejected<T0>() && 0x11f7f1215c1df42e0b340ac1ba253186ab83454d179f8551b7a64f8fadc01eb6::typed_fee_policy::exact_typed_fee_policy_required<T0>()
    }

    public(friend) fun governance_policy_version<T0>() : 0x1::option::Option<u64> {
        if (fee_governance_target<T0>()) {
    ...
    public(friend) fun runtime_config_object_published<T0>() : bool {
        fee_governance_target<T0>() && false
    }
