module 0x11eb2ce120950ded7f1a9b4bbb23111757ce2311a5ad7fa1ab84b6b60f4f0ca1::reward4562 {
    struct REWARD4562 has drop {
        dummy_field: bool,
    }

    struct TICKET_4562 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4562(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4562>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4562>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4562, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4562>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4562>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4562>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4562>>(v5, 0x2::tx_context::sender(arg1));
    }
