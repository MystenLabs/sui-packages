module 0x11f370e2e2afeec3041e352331e70a257b0627b58a91527b47d3cfa52d944dfa::cnsnft2505 {
    struct CNSNFT2505 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2505, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2505>(arg0, arg1);
