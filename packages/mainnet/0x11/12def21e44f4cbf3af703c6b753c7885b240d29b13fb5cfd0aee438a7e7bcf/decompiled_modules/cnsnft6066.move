module 0x1112def21e44f4cbf3af703c6b753c7885b240d29b13fb5cfd0aee438a7e7bcf::cnsnft6066 {
    struct CNSNFT6066 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6066, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTRU2LVfvwnEAZceKHWq2ZqZaJWjcNtV2Bqi2hkhVDpvB?ref=1010"));
        let v4 = 0x2::package::claim<CNSNFT6066>(arg0, arg1);
