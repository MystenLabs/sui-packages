module 0xba0b81fdf50cba87ac4a95686dfed7baf21323adea809b41875b040fff6c072a::harvest {
    ...
    public(friend) fun unregister_harvest_protocol(arg0: &mut HarvestConfig, arg1: &0xc8b07577c7390e9f8749d031f980676d060e22d819c3577b02573018959e68dd::vault::AdminCap, arg2: u8) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<HarvestInfo>(&arg0.protocols)) {
