module 0x11a9d449b3fe99e559d5fa581ac95c485981e23877f3335b2f29d3dbd42a60cb::cnsnft2011 {
    struct CNSNFT2011 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2011, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2011>(arg0, arg1);
