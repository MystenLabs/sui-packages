module 0x11d6b074eedf8e2d6d0a21f119e2edd8c9e6738acf06740d7c5107e9e5551adb::position {
    ...
    struct PositionManager has store {
        tick_spacing: u32,
        position_index: u64,
        positions: 0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::LinkedTable<0x2::object::ID, PositionInfo>,
    }
    ...
    struct Position has store, key {
        ...
        tick_lower_index: 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::I32,
        tick_upper_index: 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::I32,
        liquidity: u128,
    }
    ...
    public(friend) fun new(arg0: u32, arg1: &mut 0x2::tx_context::TxContext) : PositionManager {
        PositionManager{
            tick_spacing   : arg0,
            position_index : 0,
            positions      : 0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::new<0x2::object::ID, PositionInfo>(arg1),
        }
    }

    fun borrow_mut_position_info(arg0: &mut PositionManager, arg1: 0x2::object::ID) : &mut PositionInfo {
        assert!(0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 6);
        let v0 = 0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::borrow_mut<0x2::object::ID, PositionInfo>(&mut arg0.positions, arg1);
    ...
    public fun borrow_position_info(arg0: &PositionManager, arg1: 0x2::object::ID) : &PositionInfo {
        assert!(0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 6);
        let v0 = 0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::borrow<0x2::object::ID, PositionInfo>(&arg0.positions, arg1);
        assert!(v0.position_id == arg1, 6);
        v0
    }

    public fun check_position_tick_range(arg0: 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::I32, arg1: 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::I32, arg2: u32) {
        let v0 = if (0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::lt(arg0, arg1)) {
            if (0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::gte(arg0, 0x11d6b074eedf8e2d6d0a21f119e2edd8c9e6738acf06740d7c5107e9e5551adb::tick_math::min_tick())) {
                if (0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::lte(arg1, 0x11d6b074eedf8e2d6d0a21f119e2edd8c9e6738acf06740d7c5107e9e5551adb::tick_math::max_tick())) {
                    if (0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::mod(arg0, 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::from(arg2)) == 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::zero()) {
                        0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::mod(arg1, 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::from(arg2)) == 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::zero()
                    } else {
                        false
                    }
                } else {
    ...
    public(friend) fun close_position(arg0: &mut PositionManager, arg1: Position) {
        ...
        0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::remove<0x2::object::ID, PositionInfo>(&mut arg0.positions, v0);
        destroy(arg1);
    }
    ...
    public fun fetch_positions(arg0: &PositionManager, arg1: vector<0x2::object::ID>, arg2: u64) : vector<PositionInfo> {
        ...
        let v1 = if (0x1::vector::is_empty<0x2::object::ID>(&arg1)) {
            0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::head<0x2::object::ID, PositionInfo>(&arg0.positions)
        } else {
        ...
        while (0x1::option::is_some<0x2::object::ID>(&v2)) {
            let v4 = 0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::borrow_node<0x2::object::ID, PositionInfo>(&arg0.positions, *0x1::option::borrow<0x2::object::ID>(&v2));
            v2 = 0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::next<0x2::object::ID, PositionInfo>(v4);
            0x1::vector::push_back<PositionInfo>(&mut v0, *0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::borrow_value<0x2::object::ID, PositionInfo>(v4));
            let v5 = v3 + 1;
            v3 = v5;
            if (v5 == arg2) {
                break
    ...
    public(friend) fun increase_liquidity(arg0: &mut PositionManager, arg1: &mut Position, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: vector<u128>, arg7: u128) : u128 {
        ...
        update_rewards_internal(v0, arg6);
        update_magma_distribution_internal(v0, arg7);
        assert!(0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::math_u128::add_check(v0.liquidity, arg2), 8);
        v0.liquidity = v0.liquidity + arg2;
        arg1.liquidity = v0.liquidity;
        v0.liquidity
    }
    ...
    public fun info_tick_range(arg0: &PositionInfo) : (0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::I32, 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::I32) {
    ...
    public fun inited_rewards_count(arg0: &PositionManager, arg1: 0x2::object::ID) : u64 {
        0x1::vector::length<PositionReward>(&0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::borrow<0x2::object::ID, PositionInfo>(&arg0.positions, arg1).rewards)
    }

    public fun is_position_exist(arg0: &PositionManager, arg1: 0x2::object::ID) : bool {
        0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1)
    }
    ...
    fun new_position_name(arg0: u64, arg1: u64) : 0x1::string::String {
        ...
        0x1::string::append(&mut v0, 0x11d6b074eedf8e2d6d0a21f119e2edd8c9e6738acf06740d7c5107e9e5551adb::utils::str(arg0));
        0x1::string::append_utf8(&mut v0, b"-");
        0x1::string::append(&mut v0, 0x11d6b074eedf8e2d6d0a21f119e2edd8c9e6738acf06740d7c5107e9e5551adb::utils::str(arg1));
        v0
    }

    public(friend) fun open_position<T0, T1>(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: u64, arg3: 0x1::string::String, arg4: 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::I32, arg5: 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::I32, arg6: &mut 0x2::tx_context::TxContext) : Position {
        ...
        0xafb7215f61e59a98006a9dd6550b133704d5fb7b72ce10ef02ddeae74c2332ed::linked_table::push_back<0x2::object::ID, PositionInfo>(&mut arg0.positions, v2, v3);
    ...
    public fun set_display(arg0: &0x11d6b074eedf8e2d6d0a21f119e2edd8c9e6738acf06740d7c5107e9e5551adb::config::GlobalConfig, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun tick_range(arg0: &Position) : (0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::I32, 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::i32::I32) {
        (arg0.tick_lower_index, arg0.tick_upper_index)
    }
    ...
    fun update_fee_internal(arg0: &mut PositionInfo, arg1: u128, arg2: u128) {
        let v0 = (0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::full_math_u128::mul_shr(arg0.liquidity, 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::math_u128::wrapping_sub(arg1, arg0.fee_growth_inside_a), 64) as u64);
        let v1 = (0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::full_math_u128::mul_shr(arg0.liquidity, 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::math_u128::wrapping_sub(arg2, arg0.fee_growth_inside_b), 64) as u64);
        assert!(0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::math_u64::add_check(arg0.fee_owned_a, v0), 1);
        assert!(0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::math_u64::add_check(arg0.fee_owned_b, v1), 1);
    ...
    fun update_magma_distribution_internal(arg0: &mut PositionInfo, arg1: u128) {
        let v0 = (0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::full_math_u128::mul_shr(arg0.liquidity, 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::math_u128::wrapping_sub(arg1, arg0.magma_distribution_growth_inside), 64) as u64);
        assert!(0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::math_u64::add_check(arg0.magma_distribution_owned, v0), 9223374351842148351);
    ...
    fun update_points_internal(arg0: &mut PositionInfo, arg1: u128) {
        let v0 = 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::full_math_u128::mul_shr(arg0.liquidity, 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::math_u128::wrapping_sub(arg1, arg0.points_growth_inside), 64);
        assert!(0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::math_u128::add_check(arg0.points_owned, v0), 3);
    ...
    fun update_rewards_internal(arg0: &mut PositionInfo, arg1: vector<u128>) {
        ...
        while (v0 < 0x1::vector::length<u128>(&arg1)) {
            ...
            if (0x1::vector::length<PositionReward>(&arg0.rewards) > v0) {
                ...
                let v3 = (0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::full_math_u128::mul_shr(0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::math_u128::wrapping_sub(v1, v2.growth_inside), arg0.liquidity, 64) as u64);
                assert!(0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::math_u64::add_check(v2.amount_owned, v3), 1);
                v2.growth_inside = v1;
                v2.amount_owned = v2.amount_owned + v3;
            } else {
                let v4 = PositionReward{
                    growth_inside : v1,
                    amount_owned  : (0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::full_math_u128::mul_shr(v1, arg0.liquidity, 64) as u64),
                };
