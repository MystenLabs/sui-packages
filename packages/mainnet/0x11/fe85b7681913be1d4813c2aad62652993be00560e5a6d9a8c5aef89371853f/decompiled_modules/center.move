module 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::center {
    ...
    struct BiglottoCenter<phantom T0> has key {
        ...
        payment_config: 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::payment::PaymentConfig,
        draw_config: 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::draw::DrawConfig,
        payouts_config: 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::payouts::PayoutsConfig,
        jackpot_combination: 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::combination::Combination,
    ...
    public fun create<T0>(arg0: &AdminCap, arg1: vector<address>, arg2: 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::payment::PaymentConfig, arg3: 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::draw::DrawConfig, arg4: 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::payouts::PayoutsConfig, arg5: 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::combination::Combination, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun draw_config<T0>(arg0: &BiglottoCenter<T0>) : &0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::draw::DrawConfig {
        &arg0.draw_config
    }
    ...
    public fun jackpot_combination<T0>(arg0: &BiglottoCenter<T0>) : 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::combination::Combination {
    ...
    public fun payment_config<T0>(arg0: &BiglottoCenter<T0>) : &0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::payment::PaymentConfig {
        &arg0.payment_config
    }

    public fun payouts_config<T0>(arg0: &BiglottoCenter<T0>) : &0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::payouts::PayoutsConfig {
        &arg0.payouts_config
    }
    ...
    public fun ticket_cost<T0>(arg0: &BiglottoCenter<T0>) : u64 {
        0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::payment::ticket_cost(payment_config<T0>(arg0))
    }

    public fun update_draw_config<T0>(arg0: &AdminCap, arg1: &mut BiglottoCenter<T0>, arg2: 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::draw::DrawConfig) {
        assert_valid_package_version<T0>(arg1);
        arg1.draw_config = arg2;
    }

    public fun update_payment_config<T0>(arg0: &AdminCap, arg1: &mut BiglottoCenter<T0>, arg2: 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::payment::PaymentConfig) {
        assert_valid_package_version<T0>(arg1);
        arg1.payment_config = arg2;
    }

    public fun update_payouts_config<T0>(arg0: &AdminCap, arg1: &mut BiglottoCenter<T0>, arg2: 0x11fe85b7681913be1d4813c2aad62652993be00560e5a6d9a8c5aef89371853f::payouts::PayoutsConfig) {
        assert_valid_package_version<T0>(arg1);
