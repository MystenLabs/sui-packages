module 0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::vault {
    ...
    fun convert<T0>(arg0: u64, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg2: u64) : u64 {
        ...
        if (arg0 == 0) {
            0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::math::mul_div(arg2, v3, v0 + v1 - v2)
        } else {
            0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::math::mul_div(arg2, v0 + v1 - v2, v3)
        }
    }
    ...
    public entry fun deposit<T0>(arg0: &GlobalConfig, arg1: &mut PoolInfo<T0>, arg2: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg3: &mut 0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::PSUICONTROLLER<0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::PSUI>, arg4: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg6: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T0>, arg7: 0x2::coin::Coin<T0>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = balance<T0>(arg1, arg5) - v3;
        let v6 = if (0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::total_supply(arg3) == 0) {
            v5
        } else {
            0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::math::mul_div(v5, 0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::total_supply(arg3), v3)
        };
        0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::mint(arg3, v6, v1, arg9);
        let v7 = 0x2::object_table::borrow_mut<address, UserRegistry<T0>>(&mut arg1.users, v1);
        v7.stake_amount = v7.stake_amount + v0;
    ...
    fun get_price_per_full_share<T0>(arg0: &PoolInfo<T0>, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg2: &0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::PSUICONTROLLER<0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::PSUI>) : u64 {
        if (0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::total_supply(arg2) == 0) {
            return 1000000000
        };
        0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::math::mul_div(balance<T0>(arg0, arg1), 1000000000, 0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::total_supply(arg2))
    }

    public entry fun harvest<T0>(arg0: &GlobalConfig, arg1: &mut PoolInfo<T0>, arg2: &mut 0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::PSUICONTROLLER<0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::PSUI>, arg3: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg4: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T0>, arg5: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg6: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 1);
        ...
        if (0x2::coin::value<T0>(&v0) + v1 > 1000000) {
            let v2 = 0x2::coin::take<T0>(&mut arg1.total_reward_token, v1, arg8);
            0x2::coin::join<T0>(&mut v2, v0);
            let v3 = 0x2::coin::value<T0>(&v2);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v2, 0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::math::mul_div(v3, arg0.performance_fee, 100), arg8), arg0.admin);
            let v4 = &mut arg1.pool_account;
            earn<T0>(arg3, v4, arg5, arg6, v2, arg7, arg8);
            ...
            let v6 = HarvestEvent{
                amount    : 0x2::coin::value<T0>(&v0) + v1,
                timestamp : 0x2::clock::timestamp_ms(arg7),
            };
    ...
    public entry fun withdraw<T0>(arg0: &GlobalConfig, arg1: &mut PoolInfo<T0>, arg2: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg3: &mut 0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::PSUICONTROLLER<0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::PSUI>, arg4: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg6: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T0>, arg7: 0x2::coin::Coin<0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::PSUI>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg9);
        assert!(0x2::object_table::contains<address, UserRegistry<T0>>(&arg1.users, v0), 3);
        let v1 = 0x2::coin::value<0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::PSUI>(&arg7);
        assert!(v1 > 0, 5);
        harvest<T0>(arg0, arg1, arg3, arg2, arg6, arg4, arg5, arg8, arg9);
        let v2 = 0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::math::mul_div(balance<T0>(arg1, arg5), v1, 0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::total_supply(arg3));
        let v3 = v2;
        assert!(v2 > 0, 6);
        0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::psui::burn(arg3, arg7);
        let v4 = available<T0>(arg1);
        if (v4 < v2) {
            let v5 = convert<T0>(0, arg5, v2 - v4);
        ...
        let v7 = 0x1143c9e1f2ba079d23b8a2a6ac4a1383f46b1cd33859108bb956d7cdc5d4222b::math::mul_div(v3, arg0.performance_fee, 100);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.total_reward_token, v7, arg9), arg0.admin);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.total_reward_token, v3 - v7, arg9), v0);
