module 0x114a796c6a09a9822922ff6230257c5ead1ddd93e76faa90ed593417e8b88db7::cnsnft9069 {
    struct CNSNFT9069 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9069, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9069>(arg0, arg1);
