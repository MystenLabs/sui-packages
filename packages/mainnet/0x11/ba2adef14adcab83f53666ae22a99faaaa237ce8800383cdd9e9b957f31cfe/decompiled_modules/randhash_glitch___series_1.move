module 0x11ba2adef14adcab83f53666ae22a99faaaa237ce8800383cdd9e9b957f31cfe::randhash_glitch___series_1 {
    ...
    fun init(arg0: RANDHASH_GLITCH___SERIES_1, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<RANDHASH_GLITCH___SERIES_1>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(x"52616e644861736820476c6974636820e28093205365726965732031"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeie2nv77z3rqhav7ppz727ws5qsbuirdanfgorgu6oolerrlnfn5du"));
