module 0xd6c7e153379251e03f6f3c07dea4bcf27a1832f8dfccafdf5aa9a262a5053c4b::scallop_adapter {
    ...
    public fun new_scallop_state_v2<T0: drop>(arg0: &mut ScallopVault, arg1: &0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_account::IncentiveAccounts, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg3: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Scallop>, arg4: &mut 0x2::tx_context::TxContext) : (ScallopState, 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<Scallop, T0>) {
        if (arg0.is_redeeming) {
            err_redeeming();
        };
        update_record_value(arg0, arg1, arg2);
        let v0 = 0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::sub(0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::from(1), check_and_extract_weight<T0>(arg0, arg3));
        let v1 = v0;
        let v2 = ScallopState{
            collateral : 0x2::vec_map::empty<0x1::ascii::String, u64>(),
            borrow     : 0x2::vec_map::empty<0x1::ascii::String, u64>(),
        ...
        if (0x1::vector::length<0x1::ascii::String>(&v3) > 0) {
            let v4 = 0x1::vector::pop_back<0x1::ascii::String>(&mut v3);
            abort 0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::ceil(0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::mul_u64(v0, *0x2::vec_map::get<0x1::ascii::String, u64>(&arg0.record.borrow, &v4)))
        };
        ...
        (v2, new_generated_state_proof_message<T0>(arg0, arg4))
    }
