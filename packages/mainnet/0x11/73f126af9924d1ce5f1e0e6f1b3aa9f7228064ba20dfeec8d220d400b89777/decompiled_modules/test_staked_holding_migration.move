module 0x1173f126af9924d1ce5f1e0e6f1b3aa9f7228064ba20dfeec8d220d400b89777::test_staked_holding_migration {
    ...
    public entry fun migrate_users_data(arg0: &MaintainerRole, arg1: &mut TestLocker, arg2: vector<0x1::string::String>, arg3: vector<u64>, arg4: vector<0x1::string::String>, arg5: vector<address>, arg6: &UpgradeVersion, arg7: u64, arg8: &PauseUnpauseContract, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg9);
        ...
        process_accounts_and_amounts(arg1, arg2, arg3, 1 * 1000000000, arg7);
        ...
        0x2::event::emit<MigratedData>(v1);
    }
    ...
    fun process_accounts_and_amounts(arg0: &mut TestLocker, arg1: vector<0x1::string::String>, arg2: vector<u64>, arg3: u64, arg4: u64) {
        ...
        while (v2 < v0) {
            ...
            assert!(arg3 <= *0x1::vector::borrow<u64>(&arg2, v2), 13);
            let v4 = v3 + *0x1::vector::borrow<u64>(&arg2, v2);
            v3 = v4;
            assert!(arg4 >= v4, 15);
            arg0.remaining_vestable_balance = arg4 - v4;
            let v5 = Locker{
            ...
            0x2::vec_map::insert<0x1::string::String, Locker>(&mut arg0.lockers, *0x1::vector::borrow<0x1::string::String>(&arg1, v2), v5);
            v2 = v2 + 1;
        };
    }
    ...
    public entry fun update_hydro_locker_with_new_gth_holders_accounts(arg0: &MaintainerRole, arg1: &mut TestLocker, arg2: vector<0x1::string::String>, arg3: vector<u64>, arg4: vector<address>, arg5: &UpgradeVersion, arg6: &PauseUnpauseContract, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = arg1.remaining_vestable_balance;
        process_accounts_and_amounts(arg1, arg2, arg3, 1 * 1000000000, v1);
        add_users_sui_accounts(arg0, arg1, arg2, arg4, arg5, arg6, arg7);
        let v2 = UpdateMigratedData{
            evm_addresses : arg2,
            sui_accounts  : arg4,
            amounts       : arg3,
        };
        0x2::event::emit<UpdateMigratedData>(v2);
    }
