module 0x113e6e970cf99dec306221bc56725ee339d40414b759e9f5289622c61f60300e::floki {
    ...
    fun init(arg0: FLOKI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/49qVhVMwqGvXmHmTWBLtoy9Zpt7ujhrPSYntX6iQpump.png?size=lg&key=3cfff5                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<FLOKI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Floki     ")))), trim_right(b"FlokiBlue                       "), trim_right(b"Floki on Sui, im floki blue.  Guide your adventure on Solana. Like the Floki the Viking, he navigates to new horizons                                                                                                                                                                                                           "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
