module 0x21d001e8b07da2e3facb3e2d636bbaef43ba3c978bd84810368840b7d57c5068::events {
    ...
    struct DonatedCollateral<phantom T0> has copy, drop {
        sender: address,
        account_id: u64,
        collateral: u64,
    }
    ...
    struct DonatedToMarketVault has copy, drop {
        sender: address,
        ch_id: 0x2::object::ID,
        new_balance: u64,
    }
    ...
    struct WithdrewAllVaultFunds has copy, drop {
        sender: address,
        ch_id: 0x2::object::ID,
    ...
    public(friend) fun emit_created_assistant_account_cap(arg0: u64, arg1: 0x2::object::ID) {
        let v0 = CreatedAssistantAccountCap{
            account_id       : arg0,
            assistant_cap_id : arg1,
        };
        0x2::event::emit<CreatedAssistantAccountCap>(v0);
    }
    ...
    public(friend) fun emit_donated_collateral<T0>(arg0: address, arg1: u64, arg2: u64) {
        let v0 = DonatedCollateral<T0>{
            sender     : arg0,
            account_id : arg1,
            collateral : arg2,
        };
        0x2::event::emit<DonatedCollateral<T0>>(v0);
    }
    ...
    public(friend) fun emit_donated_to_market_vault(arg0: address, arg1: 0x2::object::ID, arg2: u64) {
        let v0 = DonatedToMarketVault{
            sender      : arg0,
            ch_id       : arg1,
            new_balance : arg2,
        };
        0x2::event::emit<DonatedToMarketVault>(v0);
    }
    ...
    public(friend) fun emit_revoked_assistant_account_cap(arg0: u64, arg1: 0x2::object::ID) {
        let v0 = RevokedAssistantAccountCap{
            account_id       : arg0,
            assistant_cap_id : arg1,
        };
        0x2::event::emit<RevokedAssistantAccountCap>(v0);
    }
    ...
    public(friend) fun emit_withdrew_all_vault_funds(arg0: address, arg1: 0x2::object::ID, arg2: u64, arg3: u64) {
        let v0 = WithdrewAllVaultFunds{
            sender                : arg0,
            ch_id                 : arg1,
            collateral_amount     : arg2,
            insurance_fund_amount : arg3,
        };
        0x2::event::emit<WithdrewAllVaultFunds>(v0);
    }
