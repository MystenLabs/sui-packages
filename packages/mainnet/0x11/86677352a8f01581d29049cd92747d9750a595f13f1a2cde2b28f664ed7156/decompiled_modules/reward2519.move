module 0x1186677352a8f01581d29049cd92747d9750a595f13f1a2cde2b28f664ed7156::reward2519 {
    struct REWARD2519 has drop {
        dummy_field: bool,
    }

    struct TICKET_2519 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2519(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2519>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2519>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2519, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2519>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2519>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2519>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2519>>(v5, 0x2::tx_context::sender(arg1));
    }
