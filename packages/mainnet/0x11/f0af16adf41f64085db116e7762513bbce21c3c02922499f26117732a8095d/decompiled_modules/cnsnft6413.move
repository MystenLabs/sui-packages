module 0x11f0af16adf41f64085db116e7762513bbce21c3c02922499f26117732a8095d::cnsnft6413 {
    struct CNSNFT6413 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6413, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1795"));
        let v4 = 0x2::package::claim<CNSNFT6413>(arg0, arg1);
