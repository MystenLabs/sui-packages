module 0x11c8576b6f83cd55c8b90ddadeb61f749b365d58914bb6f7bb180946fa4fc373::collection_for_edition {
    struct COLLECTION_FOR_EDITION has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: COLLECTION_FOR_EDITION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<COLLECTION_FOR_EDITION>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Collection for Edition"));
