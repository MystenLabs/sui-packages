module 0x11ba8014096176e9df0c3d74813c59c027791523ec92c53e2a3bc9bbfc6d82ba::zen_nft {
    ...
    fun assert_is_zen_coin<T0>() {
        assert!(0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>())) == b"2665dc784c7ff17fddba2442b36cb8b2bbc8adfa9fe08794fd941d80ef2758ec::zen::ZEN", 4);
    }
