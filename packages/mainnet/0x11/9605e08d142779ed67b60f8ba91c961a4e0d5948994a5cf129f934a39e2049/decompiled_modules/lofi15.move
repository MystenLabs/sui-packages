module 0x119605e08d142779ed67b60f8ba91c961a4e0d5948994a5cf129f934a39e2049::lofi15 {
    struct LOFI15 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LOFI15, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://i.postimg.cc/mgPSv160/LOFI.png";
        let v1 = if (0x1::vector::is_empty<u8>(&v0)) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v0))
        };
        let (v2, v3) = 0x2::coin::create_currency<LOFI15>(arg0, 9, b"LOFI15", b"LOFI15", b"LOFI15", v1, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LOFI15>>(v3);
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<LOFI15>>(v2);
    ...
    public entry fun transfer_with_tax(arg0: &TaxStorage, arg1: &AdminCap, arg2: &mut 0x2::coin::Coin<LOFI15>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        ...
        let v3 = 0x2::balance::split<LOFI15>(0x2::coin::balance_mut<LOFI15>(arg2), arg3);
        if (v0 > 0) {
            let v4 = arg3 * v0 / 10000;
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI15>>(0x2::coin::from_balance<LOFI15>(0x2::balance::split<LOFI15>(&mut v3, v4), arg5), arg1.admin_address);
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI15>>(0x2::coin::from_balance<LOFI15>(0x2::balance::split<LOFI15>(&mut v3, arg3 - v4), arg5), arg4);
            0x2::balance::destroy_zero<LOFI15>(v3);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI15>>(0x2::coin::from_balance<LOFI15>(v3, arg5), arg4);
        };
    }
