module 0x1106a2debf952425e74a6e00ae07a1d332977fe6619dbfd5488b7a351a225f8b::sui_vault {
    ...
    public entry fun send_sui_to_vault(arg0: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut SuiVault, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<0x2::sui::SUI>(arg0) < 4319421160000000) {
            abort 2
        };
        0x2::coin::join<0x2::sui::SUI>(&mut arg1.coin, 0x2::coin::split<0x2::sui::SUI>(arg0, 4319421160000000, arg2));
