module 0x1122bb9f1fbd168cce4c2325c3da7d636081078d23e560472781816d8e1897e3::registry {
    ...
    public fun approve<T0: drop>(arg0: &0x1122bb9f1fbd168cce4c2325c3da7d636081078d23e560472781816d8e1897e3::admin::AdminCap, arg1: &mut AdapterRegistry, arg2: u64) {
    ...
    public fun revoke<T0: drop>(arg0: &0x1122bb9f1fbd168cce4c2325c3da7d636081078d23e560472781816d8e1897e3::admin::AdminCap, arg1: &mut AdapterRegistry) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        if (0x2::vec_map::contains<0x1::type_name::TypeName, AdapterInfo>(&arg1.approved, &v0)) {
