module 0x11defe1b143db1fac84baf403da8299b0ea56a3c7d37f11b72f1aa6729060a53::parameterized {
    ...
    public entry fun claimN<T0: store + key>(arg0: &mut TransferParams, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun claimS(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut TransferParams, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
    ...
    public entry fun claimT<T0>(arg0: &mut TransferParams, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
