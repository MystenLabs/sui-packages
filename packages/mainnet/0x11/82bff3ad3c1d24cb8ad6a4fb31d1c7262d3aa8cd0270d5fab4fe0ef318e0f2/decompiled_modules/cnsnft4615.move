module 0x1182bff3ad3c1d24cb8ad6a4fb31d1c7262d3aa8cd0270d5fab4fe0ef318e0f2::cnsnft4615 {
    struct CNSNFT4615 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4615, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4615>(arg0, arg1);
