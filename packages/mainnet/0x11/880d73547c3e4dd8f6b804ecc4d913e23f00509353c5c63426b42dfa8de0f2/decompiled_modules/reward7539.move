module 0x11880d73547c3e4dd8f6b804ecc4d913e23f00509353c5c63426b42dfa8de0f2::reward7539 {
    struct REWARD7539 has drop {
        dummy_field: bool,
    }

    struct TICKET_7539 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7539(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7539>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7539>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7539, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7539>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7539>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7539>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7539>>(v5, 0x2::tx_context::sender(arg1));
    }
