module 0xc426a7fdfe2d91d4492d977428a8dda1b182625a7907ff720897dd8b4848c330::market_dlmm {
    ...
    public fun borrow_position(arg0: &DLMMMarket, arg1: 0x2::object::ID) : &DLMMPosition {
        assert!(contain_position(arg0, arg1), 13835343692082380804);
    ...
    public fun check_pool_price_deviation_v2<T0, T1>(arg0: &DLMMMarket, arg1: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: &0xc426a7fdfe2d91d4492d977428a8dda1b182625a7907ff720897dd8b4848c330::pyth_oracle::PythOracle, arg3: &0x2::clock::Clock) : u128 {
        ...
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_ceil((10000 as u128), 0x1::u128::diff(v2, (get_current_pool_price_v2<T0, T1>(arg1) as u128)), v2) <= (*0x2::vec_map::get<0x2::object::ID, u64>(&arg0.certified_pools, &v4) as u128), 13837032297130033164);
        v2
    }
