module 0x1192c9e20b4b0a8848a73a8c711b43e38f7ea1f307b556aab6ffab4e982e9c59::purchase_manager {
    ...
    public fun new(arg0: &mut 0x2::tx_context::TxContext) : PurchaseManager {
    ...
    public fun create_purchase_certificate(arg0: &mut PurchaseManager, arg1: 0x2::object::ID, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : (PurchaseCertificate, 0x2::object::ID) {
    ...
    public fun set_display(arg0: &0x1192c9e20b4b0a8848a73a8c711b43e38f7ea1f307b556aab6ffab4e982e9c59::config::PackageVersion, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public fun transfer_purchase_certificate_to(arg0: &mut PurchaseManager, arg1: PurchaseCertificate, arg2: address) {
    ...
    public fun update_for_purchase(arg0: &mut PurchaseManager, arg1: &mut PurchaseCertificate, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) : u64 {
    ...
    public fun update_for_redeem(arg0: &mut PurchaseManager, arg1: &mut PurchaseCertificate, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<address, PurchaseInfo>(&arg0.purchases, 0x2::tx_context::sender(arg4)), 1);
