module 0x1192c9e20b4b0a8848a73a8c711b43e38f7ea1f307b556aab6ffab4e982e9c59::white_list {
    ...
    public fun add_white_listed_address(arg0: &mut WhiteList, arg1: address, arg2: u64) {
        assert!(!0x2::table::contains<address, u64>(&mut arg0.addresses, arg1), 2);
    ...
    public fun add_white_listed_addresses(arg0: &mut WhiteList, arg1: vector<address>, arg2: u64) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg1)) {
            ...
            if (!0x2::table::contains<address, u64>(&mut arg0.addresses, v1)) {
    ...
    public fun remove_white_listed_address(arg0: &mut WhiteList, arg1: address) {
        assert!(0x2::table::contains<address, u64>(&mut arg0.addresses, arg1), 1);
