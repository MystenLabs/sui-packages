module 0x11151e2f7af0759c61bf23df0f58f62b4d82b19f8d7f4ec256e9ec4f467de906::jecto {
    ...
    fun init(arg0: JECTO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = MyJECTO{
            ...
            name         : b"JECTO",
            symbol       : b"JECTO",
            description  : b"This is my JECTO",
            image_url    : v0,
        };
        let (v2, v3) = 0x2::coin::create_currency<JECTO>(arg0, 9, b"JECTO", b"JECTO", b"This is my JECTO", 0x1::option::some<0x2::url::Url>(v0), arg1);
        let v4 = v2;
        ...
        v1.total_supply = v5;
        0x2::transfer::public_freeze_object<0x2::coin::TreasuryCap<JECTO>>(v4);
    ...
    fun mint_initial(arg0: &mut MyJECTO, arg1: &mut 0x2::coin::TreasuryCap<JECTO>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<JECTO> {
