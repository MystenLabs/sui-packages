module 0x110662f8c5e7c0e8d63eca605522bf2786e71849391a5e00fd84766159769e7c::btc {
    struct BTC has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BTC, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/qEZwt6ZjVNz6cHftmC3mv7g2QKMo3CuxM7gXYREpump.png?size=lg&key=d2a104                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BTC>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BTC     ")))), trim_right(b"Big Tiddy Coin                  "), trim_right(b"Big Tiddy Coin                                                                                                                                                                                                                                                                                                                  "), v2, arg1);
        let v5 = v3;
