module 0x11de8ffeb1c7e283d62a77ce49dbe7802c81cc332d9d42a5facf16fd770ac0a3::meta_vault_allocator {
    ...
    public(friend) fun set_min_rebalance_interval(arg0: &mut AllocatorState, arg1: &0x11de8ffeb1c7e283d62a77ce49dbe7802c81cc332d9d42a5facf16fd770ac0a3::meta_vault_governance::Governance, arg2: u64, arg3: address, arg4: &0x2::tx_context::TxContext) {
        0x11de8ffeb1c7e283d62a77ce49dbe7802c81cc332d9d42a5facf16fd770ac0a3::meta_vault_governance::ensure_curator(arg1, 0x2::tx_context::sender(arg4));
        arg0.min_rebalance_interval = arg2;
        0x11de8ffeb1c7e283d62a77ce49dbe7802c81cc332d9d42a5facf16fd770ac0a3::meta_vault_events::emit_set_min_rebalance_interval(arg3, arg2, arg4);
    }
    ...
    public(friend) fun update_last_rebalance(arg0: &mut AllocatorState, arg1: u64, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        0x11de8ffeb1c7e283d62a77ce49dbe7802c81cc332d9d42a5facf16fd770ac0a3::meta_vault_events::emit_update_last_rebalance(arg2, arg1, arg3);
    }
