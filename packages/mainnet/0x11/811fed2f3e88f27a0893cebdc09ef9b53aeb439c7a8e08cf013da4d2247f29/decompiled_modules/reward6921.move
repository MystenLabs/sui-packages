module 0x11811fed2f3e88f27a0893cebdc09ef9b53aeb439c7a8e08cf013da4d2247f29::reward6921 {
    struct REWARD6921 has drop {
        dummy_field: bool,
    }

    struct TICKET_6921 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6921(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6921>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6921>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6921, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6921>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6921>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6921>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6921>>(v5, 0x2::tx_context::sender(arg1));
    }
