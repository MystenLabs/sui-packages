module 0x115d90afbc754d9aa1a31ec1c4c652c3f1aabac1f1ec226de86932cb269d2378::reward2107 {
    struct REWARD2107 has drop {
        dummy_field: bool,
    }

    struct TICKET_2107 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2107(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2107>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2107>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2107, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2107>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2107>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2107>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2107>>(v5, 0x2::tx_context::sender(arg1));
    }
