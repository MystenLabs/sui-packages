module 0x1187f841eefed30e796b22af05f7d006ea8103f3f1aeaf9ba26ac5a373cb6723::cnsnft6582 {
    struct CNSNFT6582 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6582, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6582>(arg0, arg1);
