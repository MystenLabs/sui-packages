module 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::oracle {
    ...
    public fun get_market_start_time(arg0: &Oracle) : u64 {
        arg0.market_start_time
    }

    public(friend) fun get_twap(arg0: &Oracle, arg1: &0x2::clock::Clock) : u128 {
        let v0 = 0x2::clock::timestamp_ms(arg1);
        assert!(v0 == arg0.last_timestamp, 6);
        assert!(arg0.last_timestamp != 0, 0);
        assert!(v0 - arg0.market_start_time >= arg0.twap_start_delay, 1);
        assert!(v0 >= arg0.market_start_time, 0);
        let v1 = v0 - arg0.market_start_time - arg0.twap_start_delay;
        assert!(v1 > 0, 2);
    ...
    fun multi_full_window_accumulation(arg0: &mut Oracle, arg1: u128, arg2: u64, arg3: u64) {
        ...
        let v19 = if (arg1 >= arg0.last_window_twap) {
            0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::math::saturating_add(arg0.last_window_twap, 0x1::u128::min(v18, v0))
        } else {
            0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::math::saturating_sub(arg0.last_window_twap, 0x1::u128::min(v18, v0))
        };
        arg0.last_timestamp = arg3;
        arg0.last_window_end = arg3;
    ...
    public(friend) fun new_oracle(arg0: u128, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Oracle {
        assert!(arg0 > 0, 3);
        assert!(arg3 > 0, 4);
        assert!(arg2 < 604800000, 5);
        assert!(arg2 % 60000 == 0, 13);
        Oracle{
            ...
            last_window_end                  : arg1,
            last_window_twap                 : arg0,
            twap_start_delay                 : arg2,
            twap_cap_step                    : arg3,
            market_start_time                : arg1,
    ...
    fun one_step_cap_price_change(arg0: u128, arg1: u128, arg2: u64) : u128 {
        if (arg1 > arg0) {
            0x1::u128::min(arg1, 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::math::saturating_add(arg0, (arg2 as u128)))
        } else {
            0x1::u128::max(arg1, 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::math::saturating_sub(arg0, (arg2 as u128)))
        }
    }
    ...
    public(friend) fun write_observation(arg0: &mut Oracle, arg1: u64, arg2: u128) {
        assert!(arg1 >= arg0.last_timestamp, 0);
        let v0 = arg0.market_start_time + arg0.twap_start_delay;
