module 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::conditional_token {
    ...
    public(friend) fun mint(arg0: &0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::market_state::MarketState, arg1: &mut Supply, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : ConditionalToken {
        0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::market_state::assert_in_trading_or_pre_trading(arg0);
        assert!(arg2 > 0, 4);
        assert!(0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::market_state::market_id(arg0) == arg1.market_id, 1);
    ...
    public(friend) fun new_supply(arg0: &0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::market_state::MarketState, arg1: u8, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) : Supply {
        0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::market_state::validate_outcome(arg0, (arg2 as u64));
        assert!(arg1 <= 1, 0);
        Supply{
