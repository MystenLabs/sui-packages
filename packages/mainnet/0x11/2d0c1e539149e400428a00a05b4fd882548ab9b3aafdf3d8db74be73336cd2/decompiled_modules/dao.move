module 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::dao {
    ...
    public(friend) fun create<T0, T1>(arg0: u64, arg1: u64, arg2: 0x1::ascii::String, arg3: 0x1::ascii::String, arg4: u64, arg5: u64, arg6: u8, arg7: u8, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::ascii::String, arg11: 0x1::ascii::String, arg12: 0x1::ascii::String, arg13: 0x1::ascii::String, arg14: u64, arg15: u64, arg16: u128, arg17: u64, arg18: &0x2::clock::Clock, arg19: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::destroy_zero<T0>(0x2::coin::zero<T0>(arg19));
        0x2::coin::destroy_zero<T1>(0x2::coin::zero<T1>(arg19));
        let v0 = if (0x1::ascii::is_empty(&arg3)) {
            0x2::url::new_unsafe(arg10)
        } else {
            0x2::url::new_unsafe(arg3)
        };
        let v1 = 0x2::clock::timestamp_ms(arg18);
        ...
        let v2 = DAO{
            ...
            proposals                    : 0x2::table::new<0x2::object::ID, ProposalInfo>(arg19),
    ...
    public entry fun create_proposal<T0, T1>(arg0: &mut DAO, arg1: &mut 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::fee::FeeManager, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T1>, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: 0x1::option::Option<vector<u64>>, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::vectors::check_valid_outcomes(arg9, 1024), 12);
    ...
    public(friend) fun sign_result(arg0: &mut DAO, arg1: 0x2::object::ID, arg2: &0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::market_state::MarketState, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x2::object::ID, ProposalInfo>(&arg0.proposals, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, ProposalInfo>(&mut arg0.proposals, arg1);
        assert!(!v0.executed, 6);
        assert!(0x2::object::id<0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::market_state::MarketState>(arg2) == v0.market_state_id, 2);
        assert!(0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::market_state::market_id(arg2) == arg1, 2);
        assert!(0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::market_state::dao_id(arg2) == 0x2::object::uid_to_inner(&arg0.id), 2);
        0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::market_state::assert_market_finalized(arg2);
        let v1 = 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::market_state::get_winning_outcome(arg2);
        let v2 = 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::market_state::get_outcome_message(arg2, v1);
    ...
    public entry fun sign_result_entry<T0, T1>(arg0: &mut DAO, arg1: 0x2::object::ID, arg2: &mut 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::coin_escrow::TokenEscrow<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::coin_escrow::get_market_state_id<T0, T1>(arg2) == get_proposal_info(arg0, arg1).market_state_id, 2);
        sign_result(arg0, arg1, 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::coin_escrow::get_market_state_mut<T0, T1>(arg2), arg3, arg4);
    }
