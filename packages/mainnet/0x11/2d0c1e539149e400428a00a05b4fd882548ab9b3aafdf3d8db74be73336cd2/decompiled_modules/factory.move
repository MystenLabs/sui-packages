module 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::factory {
    ...
    public entry fun create_dao<T0, T1>(arg0: &mut Factory, arg1: &mut 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::fee::FeeManager, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: 0x1::ascii::String, arg6: 0x1::ascii::String, arg7: u64, arg8: u64, arg9: &0x2::coin::CoinMetadata<T0>, arg10: &0x2::coin::CoinMetadata<T1>, arg11: u64, arg12: u64, arg13: u128, arg14: u64, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 1);
        let v0 = get_type_string<T1>();
        assert!(0x2::vec_set::contains<0x1::string::String>(&arg0.allowed_stable_types, &v0), 4);
        0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::fee::deposit_dao_creation_payment(arg1, arg2, arg15, arg16);
        ...
        0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::dao::create<T0, T1>(arg3, arg4, arg5, arg6, arg7, arg8, 0x2::coin::get_decimals<T0>(arg9), 0x2::coin::get_decimals<T1>(arg10), 0x2::coin::get_name<T0>(arg9), 0x2::coin::get_name<T1>(arg10), v2, v4, 0x2::coin::get_symbol<T0>(arg9), 0x2::coin::get_symbol<T1>(arg10), arg11, arg12, arg13, arg14, arg15, arg16);
    ...
    public entry fun disable_dao_proposals(arg0: &mut 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::dao::DAO, arg1: &FactoryOwnerCap) {
        0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::dao::disable_proposals(arg0);
    }
    ...
    public entry fun request_verification(arg0: &mut 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::fee::FeeManager, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::dao::DAO, arg3: 0x1::string::String, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::dao::is_verified(arg2), 2);
        0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::fee::deposit_verification_payment(arg0, arg1, arg4, arg5);
        let v0 = 0x2::object::new(arg5);
        0x2::object::delete(v0);
        0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::dao::set_pending_verification(arg2, arg3);
        let v1 = VerificationRequested{
            dao_id          : 0x2::object::id<0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::dao::DAO>(arg2),
    ...
    public entry fun verify_dao(arg0: &ValidatorAdminCap, arg1: &mut 0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::dao::DAO, arg2: 0x2::object::ID, arg3: 0x1::string::String, arg4: bool, arg5: 0x1::string::String, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::dao::set_verification(arg1, arg3, arg4);
        let v0 = DAOReviewed{
            dao_id          : 0x2::object::id<0x112d0c1e539149e400428a00a05b4fd882548ab9b3aafdf3d8db74be73336cd2::dao::DAO>(arg1),
