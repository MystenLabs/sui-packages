module 0x11a3fcebb74478a26593b7aebf5c465381b998fc0ca6c40098a2aa2238c54cb2::poetry_contest {
    ...
    public entry fun create_contest<T0: store + key>(arg0: vector<u8>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Contest<T0>{
            ...
            submission_end_time   : arg3,
            voting_start_time     : arg4,
            voting_end_time       : arg5,
            funds                 : 0x2::balance::zero<0x2::sui::SUI>(),
            manager               : 0x2::tx_context::sender(arg6),
            beneficiary           : 0x2::tx_context::sender(arg6),
        };
        0x2::transfer::share_object<Contest<T0>>(v1);
    }

    public entry fun mutate_beneficiary<T0: store + key>(arg0: address, arg1: &mut Contest<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun mutate_submission_end_timestamp<T0: store + key>(arg0: u64, arg1: &mut Contest<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.manager == 0x2::tx_context::sender(arg2), 5);
        arg1.submission_end_time = arg0;
    }

    public entry fun mutate_submission_start_timestamp<T0: store + key>(arg0: u64, arg1: &mut Contest<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.manager == 0x2::tx_context::sender(arg2), 5);
        arg1.submission_start_time = arg0;
    }

    public entry fun mutate_voting_end_timestamp<T0: store + key>(arg0: u64, arg1: &mut Contest<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.manager == 0x2::tx_context::sender(arg2), 5);
        arg1.voting_end_time = arg0;
    }

    public entry fun mutate_voting_start_timestamp<T0: store + key>(arg0: u64, arg1: &mut Contest<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.manager == 0x2::tx_context::sender(arg2), 5);
        arg1.voting_start_time = arg0;
    }
    ...
    public entry fun submit_poem<T0: store + key>(arg0: &T0, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut Contest<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > arg2.submission_start_time && v0 < arg2.submission_end_time, 1);
    ...
    public entry fun withdraw_proceeds<T0: store + key>(arg0: &mut Contest<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.beneficiary == 0x2::tx_context::sender(arg1), 4);
