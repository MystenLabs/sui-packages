module 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::akashi_collection {
    struct Akashi has store, key {
        id: 0x2::object::UID,
    ...
    struct AKASHI_COLLECTION has drop {
        dummy_field: bool,
    }

    public entry fun claim(arg0: &mut InfoCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::witness::check_owner(arg2), 1);
    ...
    public entry fun burnNFT(arg0: &mut InfoCollection, arg1: Akashi, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::witness::check_owner(arg2), 1);
        let v0 = NFTBurn{
            object_id : 0x2::object::id<Akashi>(&arg1),
    ...
    fun checkOwnerSign(arg0: vector<u8>, arg1: &mut 0x2::tx_context::TxContext) : bool {
        ...
        0x1::string::sub_string(&v1, 0, 66) == v0 && 0x1::string::sub_string(&v1, 67, 0x1::string::length(&v1)) == 0x1::string::utf8(0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_project())
    }
    ...
    fun init(arg0: AKASHI_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_description_nft()));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_website()));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://tocen.co/"));
        let v4 = 0x2::package::claim<AKASHI_COLLECTION>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<Akashi>(&v4, v0, v2, arg1);
        0x2::display::update_version<Akashi>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<Akashi>>(v5, 0x2::tx_context::sender(arg1));
    }

    fun init_infocollection(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = PoolMint{
            sum_nft         : 0,
            price_mint      : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_price_mint_whitelist(),
            timestamp_start : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_time_start_whitelist(),
            timestamp_end   : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_time_end_whitelist(),
            user_mint_max   : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_user_mint_max_whitelist(),
            supply          : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_hard_cap_whitelist(),
        };
        let v1 = PoolMint{
            sum_nft         : 0,
            price_mint      : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_price_mint_holder(),
            timestamp_start : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_time_start_holder(),
            timestamp_end   : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_time_end_holder(),
            user_mint_max   : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_user_mint_max_holder(),
            supply          : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_hard_cap_holder(),
        };
        let v2 = PoolMint{
            sum_nft         : 0,
            price_mint      : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_price_mint_public(),
            timestamp_start : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_time_start_public(),
            timestamp_end   : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_time_end_public(),
            user_mint_max   : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_user_mint_max_public(),
            supply          : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_hard_cap_public(),
        };
        let v3 = PoolMint{
            sum_nft         : 0,
            price_mint      : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_price_mint_private(),
            timestamp_start : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_time_start_private(),
            timestamp_end   : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_time_end_private(),
            user_mint_max   : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_user_mint_max_private(),
            supply          : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_hard_cap_private(),
        };
        let v4 = InfoCollection{
            id                    : 0x2::object::new(arg0),
            name_nft              : 0x1::string::utf8(0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_name_nft()),
            description_nft       : 0x1::string::utf8(0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_description_nft()),
            ourl                  : 0x1::string::utf8(0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_image_url()),
            metadata              : 0x1::string::utf8(0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_metadata_url()),
            sum_nft               : 0,
            ...
            supply                : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_hard_cap_total(),
            white_list_address    : 0x2::table::new<address, bool>(arg0),
            white_list_private    : 0x2::table::new<address, bool>(arg0),
            version               : 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_version(),
        };
    ...
    fun mint(arg0: &mut InfoCollection, arg1: &mut 0x2::tx_context::TxContext) : Akashi {
        ...
        Akashi{
            ...
            name    : v0,
            img_url : img_url(*0x1::string::bytes(&arg0.ourl), arg0.sum_nft, 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_type_image()),
            link    : img_url(*0x1::string::bytes(&arg0.metadata), arg0.sum_nft, 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_type_metadata()),
        }
    }
    ...
    public entry fun mint_nft_with_airdrop(arg0: &mut InfoCollection, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::witness::check_owner(arg3), 1);
        let v0 = 0;
        while (v0 < arg1) {
            let v1 = mint(arg0, arg3);
            let v2 = NFTMinted{
                object_id : 0x2::object::id<Akashi>(&v1),
                creator   : arg2,
                name      : v1.name,
                image_url : v1.img_url,
            };
            0x2::event::emit<NFTMinted>(v2);
            0x2::transfer::public_transfer<Akashi>(v1, arg2);
            v0 = v0 + 1;
        };
    }
    ...
    public entry fun mint_nft_with_holder(arg0: &mut InfoCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_key_holder();
        ...
        if (0x2::dynamic_field::exists_<address>(&arg0.id, 0x2::tx_context::sender(arg5))) {
            let v1 = &mut 0x2::dynamic_field::borrow_mut<address, AddressMintedPool>(&mut arg0.id, 0x2::tx_context::sender(arg5)).pool_holder;
            assert!(*v1 < arg0.option_mint_holder.user_mint_max, 7);
            *v1 = *v1 + 1;
        } else {
        ...
        transferSui(v3, arg1, arg0.option_mint_holder.price_mint, arg5);
        let v4 = mint(arg0, arg5);
        let v5 = NFTMinted{
            object_id : 0x2::object::id<Akashi>(&v4),
            creator   : 0x2::tx_context::sender(arg5),
            name      : v4.name,
            image_url : v4.img_url,
        };
        0x2::event::emit<NFTMinted>(v5);
        0x2::transfer::public_transfer<Akashi>(v4, 0x2::tx_context::sender(arg5));
    }

    public entry fun mint_nft_with_private(arg0: &mut InfoCollection, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_key_private();
        ...
        assert!(arg0.option_mint_private.timestamp_start <= 0x2::clock::timestamp_ms(arg3), 11);
        assert!(arg0.option_mint_private.timestamp_end >= 0x2::clock::timestamp_ms(arg3), 2);
        if (0x2::dynamic_field::exists_<address>(&arg0.id, 0x2::tx_context::sender(arg4))) {
            let v1 = &mut 0x2::dynamic_field::borrow_mut<address, AddressMintedPool>(&mut arg0.id, 0x2::tx_context::sender(arg4)).pool_private;
            ...
            *v1 = *v1 + 1;
            ...
            0x2::dynamic_field::add<address, AddressMintedPool>(&mut arg0.id, 0x2::tx_context::sender(arg4), v2);
        };
        arg0.option_mint_private.sum_nft = arg0.option_mint_private.sum_nft + 1;
        let v3 = mint(arg0, arg4);
        let v4 = NFTMinted{
            object_id : 0x2::object::id<Akashi>(&v3),
            creator   : 0x2::tx_context::sender(arg4),
            name      : v3.name,
            image_url : v3.img_url,
        };
        0x2::event::emit<NFTMinted>(v4);
        0x2::transfer::public_transfer<Akashi>(v3, 0x2::tx_context::sender(arg4));
    }
    ...
    public entry fun mint_nft_with_public(arg0: &mut InfoCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<address>(&arg0.id, 0x2::tx_context::sender(arg5))) {
            let v0 = &mut 0x2::dynamic_field::borrow_mut<address, AddressMintedPool>(&mut arg0.id, 0x2::tx_context::sender(arg5)).pool_public;
        ...
        transferSui(v2, arg1, arg0.option_mint_public.price_mint, arg5);
        ...
        0x2::event::emit<NFTMinted>(v4);
        0x2::transfer::public_transfer<Akashi>(v3, 0x2::tx_context::sender(arg5));
    }

    public entry fun mint_nft_with_whitelist(arg0: &mut InfoCollection, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xfd9f267d8a1abe41558e9ac3edf875bd11cf42ce8e154726661b432444f1be21::utils::get_key_whitelist();
        assert!(0x2::ed25519::ed25519_verify(&arg1, &v0, &arg2), 12);
        assert!(checkOwnerSign(arg2, arg4), 12);
        assert!(arg0.option_mint_whitelist.sum_nft < arg0.option_mint_whitelist.supply, 5);
        assert!(arg0.option_mint_whitelist.timestamp_start <= 0x2::clock::timestamp_ms(arg3), 11);
        assert!(arg0.option_mint_whitelist.timestamp_end >= 0x2::clock::timestamp_ms(arg3), 2);
        if (0x2::dynamic_field::exists_<address>(&arg0.id, 0x2::tx_context::sender(arg4))) {
            let v1 = &mut 0x2::dynamic_field::borrow_mut<address, AddressMintedPool>(&mut arg0.id, 0x2::tx_context::sender(arg4)).pool_whitelist;
    ...
    public entry fun setup_cle(arg0: &mut InfoCollection, arg1: address) {
        0x2::dynamic_field::remove<address, AddressMintedPool>(&mut arg0.id, arg1);
    }
