module 0x1166e7abc3095287f740b2cb148e655ed336076cd44675901ecf3d34e1be6be5::cnsnft8871 {
    struct CNSNFT8871 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8871, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8871>(arg0, arg1);
