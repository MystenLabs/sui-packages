module 0x119fefb183d3ffb5ab0bfb880ec4fc1e3db529f24c7cb6dc5fc9b6fe3e01ee2a::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"MON", b"Money Coin", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-03T08-54-23.155Z-money.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Money Coin"),
            symbol     : 0x1::string::utf8(b"MON"),
            decimals   : 9,
