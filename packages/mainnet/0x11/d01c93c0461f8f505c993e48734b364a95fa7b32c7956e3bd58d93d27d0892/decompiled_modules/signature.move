    ...
    public fun verify(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>) : address {
        if (arg2 == b"Bluefin Pro Withdrawal") {
            ...
            let v1 = if (arg2 == 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::payload_type_setting_funding_rate()) {
                ...
                true
            } else if (arg2 == 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::payload_type_tee_user_trade_fee_update()) {
                true
            } else {
                arg2 == 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::payload_type_tee_update_account_type()
            };
            assert!(v1, 2004);
