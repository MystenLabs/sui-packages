module 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::alphafi_cetus_investor {
    ...
    public fun migrate_to_new_pool<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, 0x2::sui::SUI>, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS, 0x2::sui::SUI>, arg6: u32, arg7: u32, arg8: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg9: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg10: bool, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::open_position<T0, T1>(arg2, arg8, arg6, arg7, arg12);
        ...
        let v7 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::fee_rate<T0, T1>(arg8);
        let v8 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg8);
        let v9 = if (v7 == 100) {
        ...
        let (v11, v12) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::remove_liquidity<T0, T1>(arg2, arg9, &mut v0, v2, arg11);
        let v13 = v12;
        let v14 = v11;
        ...
        let (v15, v16) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg1, arg2, v14, v13, arg8, v9, v10, arg11, arg12);
        let (_, v18, v19, v20) = get_balances_in_ratio<T0, T1>(arg0, v15, v16, arg8, true);
        let v21 = v19;
        let v22 = v18;
        if (0x2::balance::value<T0>(&v22) > 100 || 0x2::balance::value<T1>(&v21) > 100) {
            let v23 = if (0x2::balance::value<T0>(&v22) == 0 || v20 == false) {
                0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg2, arg8, &mut v1, 0x2::balance::value<T1>(&v21), false, arg11)
            } else {
                0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg2, arg8, &mut v1, 0x2::balance::value<T0>(&v22), true, arg11)
            };
            let v24 = v23;
            ...
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_add_liquidity<T0, T1>(arg2, arg8, 0x2::balance::split<T0>(&mut v22, v25), 0x2::balance::split<T1>(&mut v21, v26), v24);
        } else {
            0x2::balance::join<T0>(&mut arg0.free_balance_a, v22);
            0x2::balance::join<T1>(&mut arg0.free_balance_b, v21);
        };
        ...
        let (v27, v28, _) = autocompound_internal<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg9, arg11, arg12);
        let (_, v31, v32, v33) = get_balances_in_ratio<T0, T1>(arg0, v27, v28, arg8, true);
        let v34 = v32;
        let v35 = v31;
        ...
        if (0x2::balance::value<T0>(&v35) > 100 || 0x2::balance::value<T1>(&v34) > 100) {
            deposit<T0, T1>(arg0, arg2, arg8, v35, v34, v33, arg11);
        } else {
