module 0x6a1e4b44069db896e9ca047d36c1a56d7d5a9113861663ac7cd329ab068d1423::cnsnft4153 {
    struct CNSNFT4153 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4153, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4153>(arg0, arg1);
