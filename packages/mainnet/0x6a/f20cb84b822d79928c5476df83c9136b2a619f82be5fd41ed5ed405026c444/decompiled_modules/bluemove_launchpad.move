module 0x6af20cb84b822d79928c5476df83c9136b2a619f82be5fd41ed5ed405026c444::bluemove_launchpad {
    ...
    public entry fun burn_nft(arg0: Duckies, arg1: &mut 0x2::tx_context::TxContext) {
        let Duckies {
            id          : v0,
            name        : v1,
            description : _,
        ...
        let v5 = BurnEvent{
            object_id : 0x2::object::id<Duckies>(&arg0),
    ...
    public entry fun claim_nfts(arg0: &mut LaunchpadData, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v11 > 0) {
            ...
            let v18 = MintNFTEvent{
                object_id : 0x2::object::id<Duckies>(&v17),
                creator   : v0,
                name      : v14,
            };
            0x2::event::emit<MintNFTEvent>(v18);
            0x2::transfer::public_transfer<Duckies>(v17, v0);
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LaunchpadData{
            ...
            minted         : 0,
            current_nft    : 0,
            base_name      : 0x1::string::utf8(b"Duckies #"),
            base_url       : 0x1::string::utf8(b"https://static.bluemove.net/duckies-1/"),
            base_image_url : 0x1::string::utf8(b"https://ipfs.io/ipfs/QmRPXJ1ZXEFR422bw3sHqWp1N9CBfBe8TGC7LiwETZtNb1/"),
            description    : 0x1::string::utf8(b"The First 2500 unique Duck NFTs use a DAO Mechanism Consept & Hold to Earn utility on Sui Network."),
            ...
            fund_address   : @0x9ff49411f4fb4679b46fd17c97d3a5682231a308164180903c224deed67f85eb,
            balance        : 0x2::balance::zero<0x2::sui::SUI>(),
            total_nft      : v0,
            pre_mint       : 0,
        };
        let v2 = 0x2::tx_context::sender(arg1);
        let (v3, v4) = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::create_with_mint_cap<BLUEMOVE_LAUNCHPAD, Duckies>(&arg0, 0x1::option::some<u64>(v0), arg1);
        let v5 = v3;
        let v6 = Witness{dummy_field: false};
        let v7 = 0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::from_witness<Duckies, Witness>(v6);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::add_domain<Duckies, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::creators::Creators>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::creators::new(0x2::vec_set::singleton<address>(v2)));
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::add_domain<Duckies, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::display_info::DisplayInfo>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::display_info::new(0x1::string::utf8(b"Duckies"), 0x1::string::utf8(b"The First 2500 unique Duck NFTs use a DAO Mechanism Consept & Hold to Earn utility on Sui Network.")));
        ...
        let v11 = 0x2::display::new<Duckies>(&v8, arg1);
        0x2::display::add<Duckies>(&mut v11, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<Duckies>(&mut v11, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<Duckies>(&mut v11, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{image_url}"));
        0x2::display::add<Duckies>(&mut v11, 0x1::string::utf8(b"tags"), 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::display::from_vec(v9));
        0x2::display::update_version<Duckies>(&mut v11);
        0x2::transfer::public_transfer<0x2::display::Display<Duckies>>(v11, 0x2::tx_context::sender(arg1));
        let (v12, v13) = 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::init_policy<Duckies>(&v8, arg1);
        let v14 = v13;
        let v15 = v12;
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::enforce<Duckies>(&mut v15, &v14);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::transfer_allowlist::enforce<Duckies>(&mut v15, &v14);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::create_domain_and_add_strategy<Duckies>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty::from_address(@0x9ff49411f4fb4679b46fd17c97d3a5682231a308164180903c224deed67f85eb, arg1), 1000, arg1);
        0x2::transfer::public_transfer<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Duckies>>(v4, v2);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v8, v2);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<Duckies>>(v14, v2);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<Duckies>>(v15);
        0x2::transfer::public_share_object<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<Duckies>>(v5);
    ...
    public entry fun pre_nfts(arg0: &mut LaunchpadData, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg1 > 0) {
            ...
            0x2::transfer::public_transfer<Duckies>(v4, arg2);
            arg0.current_nft = v0;
            arg1 = arg1 - 1;
        };
    }
