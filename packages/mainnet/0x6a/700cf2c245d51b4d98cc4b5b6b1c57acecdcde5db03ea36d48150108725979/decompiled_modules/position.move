module 0x6a700cf2c245d51b4d98cc4b5b6b1c57acecdcde5db03ea36d48150108725979::position {
    ...
    public(friend) fun mark_position_staked(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: bool) {
        ...
        assert!(v0.fullsail_distribution_staked != arg2, 11);
    ...
    fun new_position_name(arg0: u64, arg1: u64) : 0x1::string::String {
        ...
        0x1::string::append(&mut v0, 0x6a700cf2c245d51b4d98cc4b5b6b1c57acecdcde5db03ea36d48150108725979::utils::str(arg0));
        0x1::string::append_utf8(&mut v0, b"-");
        0x1::string::append(&mut v0, 0x6a700cf2c245d51b4d98cc4b5b6b1c57acecdcde5db03ea36d48150108725979::utils::str(arg1));
        v0
    }
    ...
    public fun set_display(arg0: &0x6a700cf2c245d51b4d98cc4b5b6b1c57acecdcde5db03ea36d48150108725979::config::GlobalConfig, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        0x6a700cf2c245d51b4d98cc4b5b6b1c57acecdcde5db03ea36d48150108725979::config::checked_package_version(arg0);
        let v0 = 0x1::vector::empty<0x1::string::String>();
        0x1::vector::push_back<0x1::string::String>(&mut v0, 0x1::string::utf8(b"name"));
        0x1::vector::push_back<0x1::string::String>(&mut v0, 0x1::string::utf8(b"coin_a"));
        0x1::vector::push_back<0x1::string::String>(&mut v0, 0x1::string::utf8(b"coin_b"));
    ...
    fun update_fullsail_distribution_internal(arg0: &mut PositionInfo, arg1: u128) {
        ...
        assert!(0x273edb422b3404487a0e700224f541852e799957e4e289363a1675a8dcee158b::math_u64::add_check(arg0.fullsail_distribution_owned, v0), 9223374347547181055);
