module 0x6abba66f4c68bae2d42531504cf74d86dee734e0bb30a97f993295615632a771::navi_reward_w5 {
    struct NAVI_REWARD_W5 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = NAVI_REWARD{
                ...
                image_url   : 0x1::string::utf8(b"ipfs://QmcKrYp1wWtMvSH7NNAjebSB7aXqyWzPm9WYTNgUioabum"),
                description : 0x1::string::utf8(b"Exclusive Reward for NAVI Participants"),
    ...
    fun init(arg0: NAVI_REWARD_W5, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmcKrYp1wWtMvSH7NNAjebSB7aXqyWzPm9WYTNgUioabum"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Exclusive Reward for NAVI Participants"));
        ...
        let v4 = 0x2::package::claim<NAVI_REWARD_W5>(arg0, arg1);
