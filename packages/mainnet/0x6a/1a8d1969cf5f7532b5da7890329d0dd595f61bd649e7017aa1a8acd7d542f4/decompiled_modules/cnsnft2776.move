module 0x6a1a8d1969cf5f7532b5da7890329d0dd595f61bd649e7017aa1a8acd7d542f4::cnsnft2776 {
    struct CNSNFT2776 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2776, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2776>(arg0, arg1);
