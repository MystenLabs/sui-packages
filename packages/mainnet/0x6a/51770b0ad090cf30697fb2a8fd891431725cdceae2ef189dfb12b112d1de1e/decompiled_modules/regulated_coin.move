module 0x6a51770b0ad090cf30697fb2a8fd891431725cdceae2ef189dfb12b112d1de1e::regulated_coin {
    ...
    fun init(arg0: REGULATED_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<REGULATED_COIN>(arg0, 5, b"dudu", b"dudu", b"Example Regulated Coin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://img.freepik.com/vektoren-kostenlos/vogel-bunner-farbverlauf-designvektor_343694-2506.jpg")), true, arg1);
