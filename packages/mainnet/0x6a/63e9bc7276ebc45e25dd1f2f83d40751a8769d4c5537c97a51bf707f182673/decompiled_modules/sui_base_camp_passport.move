module 0x6a63e9bc7276ebc45e25dd1f2f83d40751a8769d4c5537c97a51bf707f182673::sui_base_camp_passport {
    struct SUI_BASE_CAMP_PASSPORT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_BASE_CAMP_PASSPORT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_BASE_CAMP_PASSPORT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sui Base Camp Passport"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifpt4xwfzversnwcmyjxxcubwv6crmcvnnmemixvph4o4e3grgrha"));
