module 0x6a68d41497c29eddc172bcf381822040acdc3a4114f2aa1b79a6f82d9d9ba2bc::bluemove_launchpad {
    ...
    public entry fun claim_nfts(arg0: &mut LaunchpadData, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v11 > 0) {
            ...
            let v18 = MintNFTEvent{
                object_id : 0x2::object::id<Eggworld>(&v17),
                creator   : v0,
                name      : v14,
            };
            0x2::event::emit<MintNFTEvent>(v18);
            0x2::transfer::public_transfer<Eggworld>(v17, v0);
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LaunchpadData{
            ...
            minted         : 0,
            current_nft    : 0,
            base_name      : 0x1::string::utf8(b"Eggworld #"),
            base_url       : 0x1::string::utf8(b"https://static.bluemove.net/eggworld/"),
            base_image_url : 0x1::string::utf8(b"https://ipfs.io/ipfs/Qme6PHU6yt1ZmwTvjL4KFNh66xW1H1kTagnz8jzpitBhpf/"),
            description    : 0x1::string::utf8(b"The first AI enhanced collection on the Sui network"),
            ...
            fund_address   : @0x61ff6e129ae82012b72595eb8d60b5040db87a93c1506d0223d7bcb2edb5e553,
