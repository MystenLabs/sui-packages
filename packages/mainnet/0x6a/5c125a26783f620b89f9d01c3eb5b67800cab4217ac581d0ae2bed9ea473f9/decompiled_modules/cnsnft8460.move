module 0x6a5c125a26783f620b89f9d01c3eb5b67800cab4217ac581d0ae2bed9ea473f9::cnsnft8460 {
    struct CNSNFT8460 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8460, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8460>(arg0, arg1);
