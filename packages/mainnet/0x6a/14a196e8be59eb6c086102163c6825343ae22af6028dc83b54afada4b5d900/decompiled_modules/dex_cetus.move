module 0x6a14a196e8be59eb6c086102163c6825343ae22af6028dc83b54afada4b5d900::dex_cetus {
    ...
    public fun get_cetus_package() : address {
        0x6a14a196e8be59eb6c086102163c6825343ae22af6028dc83b54afada4b5d900::constants::cetus_package()
    }

    public fun get_cetus_sui_usdc_pool() : address {
        0x6a14a196e8be59eb6c086102163c6825343ae22af6028dc83b54afada4b5d900::constants::cetus_sui_usdc_pool()
    }

    public fun is_cetus_operational() : bool {
        0x6a14a196e8be59eb6c086102163c6825343ae22af6028dc83b54afada4b5d900::constants::cetus_package() != @0x0
    }
    ...
    public entry fun swap_sui_to_usdc(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = CetusSwapExecuted{
            ...
            package        : 0x6a14a196e8be59eb6c086102163c6825343ae22af6028dc83b54afada4b5d900::constants::cetus_package(),
