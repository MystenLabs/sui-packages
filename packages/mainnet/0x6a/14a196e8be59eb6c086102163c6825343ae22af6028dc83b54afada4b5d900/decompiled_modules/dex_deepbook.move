module 0x6a14a196e8be59eb6c086102163c6825343ae22af6028dc83b54afada4b5d900::dex_deepbook {
    ...
    public fun get_deepbook_package() : address {
        0x6a14a196e8be59eb6c086102163c6825343ae22af6028dc83b54afada4b5d900::constants::deepbook_package()
    }
    ...
    public entry fun swap_sui_to_usdc(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = DeepBookSwapExecuted{
            ...
            package        : 0x6a14a196e8be59eb6c086102163c6825343ae22af6028dc83b54afada4b5d900::constants::deepbook_package(),
