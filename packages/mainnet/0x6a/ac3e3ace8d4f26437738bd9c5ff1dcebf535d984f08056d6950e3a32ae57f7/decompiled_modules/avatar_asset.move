module 0x6aac3e3ace8d4f26437738bd9c5ff1dcebf535d984f08056d6950e3a32ae57f7::avatar_asset {
    struct AVATAR_ASSET has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: AVATAR_ASSET, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<AVATAR_ASSET>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Avatar Asset"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is a collection of Conversia Avatar asset"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreif3vk33fscbmpw75gi5exsmgfznqkf2zemlwtpdhreko6cpsorhfe"));
