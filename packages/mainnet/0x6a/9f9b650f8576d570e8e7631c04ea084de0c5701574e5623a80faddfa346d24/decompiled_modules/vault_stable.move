module 0x6a9f9b650f8576d570e8e7631c04ea084de0c5701574e5623a80faddfa346d24::vault_stable {
    struct Vault has key {
        ...
        kusd_cap: 0x2::coin::TreasuryCap<0x6a9f9b650f8576d570e8e7631c04ea084de0c5701574e5623a80faddfa346d24::kusd::KUSD>,
    ...
    struct OperatorWithdrawEvent has copy, drop, store {
        epoch: u64,
        amount: u64,
    }
    ...
    public entry fun claim_and_transfer_kusd(arg0: &mut Vault, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x6a9f9b650f8576d570e8e7631c04ea084de0c5701574e5623a80faddfa346d24::kusd::KUSD>>(v0, 0x2::tx_context::sender(arg1));
    }
    ...
    public fun claim_kusd(arg0: &mut Vault, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x6a9f9b650f8576d570e8e7631c04ea084de0c5701574e5623a80faddfa346d24::kusd::KUSD> {
        assert!(arg0.version == 1, 1010);
        ...
        0x2::coin::mint<0x6a9f9b650f8576d570e8e7631c04ea084de0c5701574e5623a80faddfa346d24::kusd::KUSD>(&mut arg0.kusd_cap, v1, arg1)
    }
    ...
    public fun claim_usdc(arg0: &mut Vault, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC> {
        ...
        while (v1 < 0x2::linked_table::length<u64, WithdrawRequest>(v2)) {
            ...
            if (v4 < arg0.current_epoch) {
                ...
                if (0x2::clock::timestamp_ms(arg1) - v7.timestamp > arg0.withdraw_lock_time) {
        ...
        let v8 = if (arg0.supply_usdc > v3) {
            arg0.supply_usdc - v3
        } else {
            0
        };
        arg0.supply_usdc = v8;
        let v9 = WithdrawClaimedEvent{
            user        : v0,
            usdc_amount : v3,
            epoch       : arg0.current_epoch,
        };
        0x2::event::emit<WithdrawClaimedEvent>(v9);
    ...
    public entry fun deposit_usdc(arg0: &mut Vault, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 1001);
        assert!(arg0.supply_usdc + v0 <= arg0.max_deposit, 1014);
        ...
        arg0.supply_usdc = arg0.supply_usdc + v0;
    ...
    public fun end_epoch(arg0: &mut Vault, arg1: &OperatorCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC> {
        assert!(arg0.version == 1, 1010);
        ...
        0x2::coin::from_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(0x2::balance::split<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg0.balance, arg0.pending_fund), arg3)
    }

    public entry fun end_epoch_and_transfer(arg0: &mut Vault, arg1: &OperatorCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = end_epoch(arg0, arg1, arg2, arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(v0, 0x2::tx_context::sender(arg3));
    }
    ...
    fun init_vault(arg0: 0x2::coin::TreasuryCap<0x6a9f9b650f8576d570e8e7631c04ea084de0c5701574e5623a80faddfa346d24::kusd::KUSD>, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : Vault {
        Vault{
            ...
            epoch_history               : 0x2::table::new<u64, EpochData>(arg3),
            deposit_requests            : 0x2::table::new<address, 0x2::linked_table::LinkedTable<u64, DepositRequest>>(arg3),
            withdraw_requests           : 0x2::table::new<address, 0x2::linked_table::LinkedTable<u64, WithdrawRequest>>(arg3),
            kusd_cap                    : arg0,
    ...
    public entry fun operator_init_vault(arg0: 0x2::coin::TreasuryCap<0x6a9f9b650f8576d570e8e7631c04ea084de0c5701574e5623a80faddfa346d24::kusd::KUSD>, arg1: &OperatorCap, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Vault>(init_vault(arg0, arg2, arg3, arg4));
    }

    public fun operator_withdraw(arg0: &mut Vault, arg1: &OperatorCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC> {
        assert!(arg0.version == 1, 1010);
        assert!(arg2 > 0, 1015);
        let v0 = OperatorWithdrawEvent{
            epoch  : arg0.current_epoch,
            amount : arg2,
        };
        0x2::event::emit<OperatorWithdrawEvent>(v0);
    ...
    public entry fun operator_withdraw_and_transfer(arg0: &mut Vault, arg1: &OperatorCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = operator_withdraw(arg0, arg1, arg2, arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(v0, 0x2::tx_context::sender(arg3));
    }
    ...
    public entry fun request_withdraw(arg0: &mut Vault, arg1: 0x2::coin::Coin<0x6a9f9b650f8576d570e8e7631c04ea084de0c5701574e5623a80faddfa346d24::kusd::KUSD>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 1010);
        assert!(!arg0.paused, 1006);
        let v0 = 0x2::coin::value<0x6a9f9b650f8576d570e8e7631c04ea084de0c5701574e5623a80faddfa346d24::kusd::KUSD>(&arg1);
        assert!(v0 > 0, 1004);
        assert!(arg0.total_kusd > 0, 1005);
        let v1 = 0x2::tx_context::sender(arg2);
        arg0.total_pending_burned_kusd = arg0.total_pending_burned_kusd + v0;
        0x2::coin::burn<0x6a9f9b650f8576d570e8e7631c04ea084de0c5701574e5623a80faddfa346d24::kusd::KUSD>(&mut arg0.kusd_cap, arg1);
    ...
    public entry fun update_max_deposit(arg0: &mut Vault, arg1: &OperatorCap, arg2: u64) {
        assert!(arg0.version == 1, 1010);
