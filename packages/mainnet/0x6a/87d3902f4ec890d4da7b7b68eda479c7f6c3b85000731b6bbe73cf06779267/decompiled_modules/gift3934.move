module 0x6a87d3902f4ec890d4da7b7b68eda479c7f6c3b85000731b6bbe73cf06779267::gift3934 {
    struct GIFT3934 has drop {
        dummy_field: bool,
    }

    struct TICKET_3934 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3934(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3934>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3934>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3934, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3934>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3934>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3934>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3934>>(v5, 0x2::tx_context::sender(arg1));
    }
