module 0x9272d9d9585d081fe25318c24ca7f80916c6e19c7ec50840063764a751f234de::state {
    ...
    public(friend) fun add_paired_emitter(arg0: &mut State, arg1: u16, arg2: address) {
        assert!(!0x2::table::contains<u16, address>(&arg0.emitter_paired.pairs, arg1), 9);
        0x2::table::add<u16, address>(&mut arg0.emitter_paired.pairs, arg1, arg2);
    }
    ...
    public(friend) fun new_state(arg0: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::emitter::EmitterCap, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : State {
        ...
        0x2::vec_set::insert<u64>(&mut v0, 4);
    ...
    entry fun update_cctp_mayan_caller(arg0: &AdminCap, arg1: &mut State, arg2: u32, arg3: address) {
        *0x2::table::borrow_mut<u32, address>(&mut arg1.cctp_mayan_caller_registry, arg2) = arg3;
    }

    entry fun update_cctp_mayan_recipient(arg0: &AdminCap, arg1: &mut State, arg2: u32, arg3: address, arg4: address) {
        let v0 = MayanRecipientKey{
            cctp_dest_domain : arg2,
            coin_metadata_id : arg3,
        };
        *0x2::table::borrow_mut<MayanRecipientKey, address>(&mut arg1.cctp_mayan_recipient_registry, v0) = arg4;
    }

    entry fun update_paired_emitter(arg0: &AdminCap, arg1: &mut State, arg2: u16, arg3: address) {
        *0x2::table::borrow_mut<u16, address>(&mut arg1.emitter_paired.pairs, arg2) = arg3;
    }
