module 0x1f246b075220ec5f49435224ca862fa60c254b9c544c8961764b1bfe77bf8728::pool_rewards {
    ...
    public fun claim_rewards(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    }
    ...
    public fun stake_nft(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: 0x1f246b075220ec5f49435224ca862fa60c254b9c544c8961764b1bfe77bf8728::creature_nft::CreatureNFT, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object_table::borrow_mut<0x2::object::ID, Pool>(&mut arg0.pools, arg1);
        assert!(v0.is_active, 2);
        let v1 = 0x2::clock::timestamp_ms(arg3);
