module 0x1f246b075220ec5f49435224ca862fa60c254b9c544c8961764b1bfe77bf8728::creature_nft {
    ...
    public fun admin_mint_nft_v3(arg0: &AdminCap, arg1: &mut BrainrotCollection, arg2: 0x1::string::String, arg3: vector<u64>, arg4: vector<u64>, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg8: address, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = CreatureNFTv2{
            id         : v8,
            metadata   : v7,
            creator    : 0x2::tx_context::sender(arg10),
            created_at : 0x2::clock::timestamp_ms(arg9),
        };
        0x2::transfer::public_transfer<CreatureNFTv2>(v10, arg8);
    }
