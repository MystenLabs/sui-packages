module 0x6ac1dca39b860dd105b38171c51dfe6b0bb5b7c4008c4575a2327fd036f92d48::cnsnft4866 {
    struct CNSNFT4866 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4866, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8238"));
        let v4 = 0x2::package::claim<CNSNFT4866>(arg0, arg1);
