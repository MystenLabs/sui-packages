module 0x6aab3440ab6b2442d23089c3520ac8e2a61da91e2df927d1a9066f6268f6cf86::test_token_custom_burn {
    ...
    public fun mint(arg0: &mut ProtectedTreasury, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = TreasuryCapKey{dummy_field: false};
        0x2::transfer::public_transfer<0x2::coin::Coin<TEST_TOKEN_CUSTOM_BURN>>(0x2::coin::mint<TEST_TOKEN_CUSTOM_BURN>(0x2::dynamic_object_field::borrow_mut<TreasuryCapKey, 0x2::coin::TreasuryCap<TEST_TOKEN_CUSTOM_BURN>>(&mut arg0.id, v0), arg1, arg3), arg2);
    }
