module 0x6a42fc1b875f297859d23eadc0765fa38f0d5cae13f5775d57d738790bfb6c8e::grok {
    ...
    fun init(arg0: GROK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/bsc/0xd08b9e557d1f64c8dd50a168453ea302a83e47fc.png?size=lg&key=b6c471                                                                                                                                                                                                                 ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<GROK>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Grok    ")))), trim_right(b"Grok Inu                        "), trim_right(b"The token was inspired by Satoshi Nakamoto's Shiba Bonk dog that was always sick and could not be cured, thanks to AI technology and doctors successfully assembling machine parts.                                                                                                                                             "), v2, arg1);
        let v5 = v3;
