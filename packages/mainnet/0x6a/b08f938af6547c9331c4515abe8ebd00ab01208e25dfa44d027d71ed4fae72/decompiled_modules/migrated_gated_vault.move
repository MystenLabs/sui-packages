module 0x1f015c1a000631f2c0afd0258b299c63ffb8e5452e0c0f9be8fc28d2e20ad9b4::migrated_gated_vault {
    ...
    public(friend) fun remove_from_registry_for_migration(arg0: &mut GatedVaultRegistry, arg1: address, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 == 0x2::tx_context::sender(arg3), 9223372968862679039);
    ...
    public fun migrate_gated_vault(arg0: &mut 0x1f015c1a000631f2c0afd0258b299c63ffb8e5452e0c0f9be8fc28d2e20ad9b4::gated_vault::GatedVaultRegistry, arg1: &mut GatedVaultRegistry, arg2: &mut MigrationVault, arg3: vector<0x2::object::ID>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<address, 0x2::table::Table<0x2::object::ID, 0x1f015c1a000631f2c0afd0258b299c63ffb8e5452e0c0f9be8fc28d2e20ad9b4::gated_vault::GatedVaultRegistryItem>>(v1, v0), 9223372736934445055);
    ...
    public fun withdraw_from_migration_vault(arg0: &GatedVaultAdminCap, arg1: &mut MigrationVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2d6d59adaaa08b912e629dad9e60df7a83e849ccb28e78c4c536b72780ff67de::generis::GENERIS> {
        0x2::coin::from_balance<0x2d6d59adaaa08b912e629dad9e60df7a83e849ccb28e78c4c536b72780ff67de::generis::GENERIS>(0x2::balance::split<0x2d6d59adaaa08b912e629dad9e60df7a83e849ccb28e78c4c536b72780ff67de::generis::GENERIS>(&mut arg1.balance, arg2), arg3)
    }
