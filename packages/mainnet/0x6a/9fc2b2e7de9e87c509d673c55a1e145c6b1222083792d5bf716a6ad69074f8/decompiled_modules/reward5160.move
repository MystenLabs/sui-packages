module 0x6a9fc2b2e7de9e87c509d673c55a1e145c6b1222083792d5bf716a6ad69074f8::reward5160 {
    struct REWARD5160 has drop {
        dummy_field: bool,
    }

    struct TICKET_5160 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5160(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5160>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5160>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5160, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5160>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5160>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5160>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5160>>(v5, 0x2::tx_context::sender(arg1));
    }
