module 0x6a2e267128a399d2b51d06e5b945483dad1daa8df1e101aee071131a03a16611::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"pepe2", b"pepe2", b"pepe2", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-20T03-08-34.691Z-Scherm%C3%82%C2%ADafbeelding%202025-09-20%20om%2006.56.38.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"pepe2"),
            symbol     : 0x1::string::utf8(b"pepe2"),
            decimals   : 9,
