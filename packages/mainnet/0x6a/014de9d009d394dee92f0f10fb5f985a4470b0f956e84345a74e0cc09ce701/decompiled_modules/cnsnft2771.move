module 0x6a014de9d009d394dee92f0f10fb5f985a4470b0f956e84345a74e0cc09ce701::cnsnft2771 {
    struct CNSNFT2771 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2771, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2771>(arg0, arg1);
