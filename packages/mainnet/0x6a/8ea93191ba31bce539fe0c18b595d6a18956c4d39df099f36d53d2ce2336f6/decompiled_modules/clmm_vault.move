module 0x6a8ea93191ba31bce539fe0c18b595d6a18956c4d39df099f36d53d2ce2336f6::clmm_vault {
    ...
    public fun assert_fee_reward_claimed<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &ClmmVault, arg3: &0x2::clock::Clock) {
        ...
        assert!(v1 == 0 && v2 == 0, 0x6a8ea93191ba31bce539fe0c18b595d6a18956c4d39df099f36d53d2ce2336f6::error::fee_claim_err());
        ...
        while (v4 < 0x1::vector::length<u64>(&v3)) {
            let v5 = 0;
            assert!(0x1::vector::borrow<u64>(&v3, v4) == &v5, 0x6a8ea93191ba31bce539fe0c18b595d6a18956c4d39df099f36d53d2ce2336f6::error::mining_claim_err());
            v4 = v4 + 1;
        };
    }
    ...
    fun increase_liquidity_to_clmm<T0, T1>(arg0: &mut ClmmVault, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &mut 0x2::balance::Balance<T0>, arg4: &mut 0x2::balance::Balance<T1>, arg5: u128, arg6: &0x2::clock::Clock) : (u64, u64, u128) {
        ...
        assert!(v1 <= 0x2::balance::value<T0>(arg3), 0x6a8ea93191ba31bce539fe0c18b595d6a18956c4d39df099f36d53d2ce2336f6::error::amount_in_above_max_limit());
        assert!(v2 <= 0x2::balance::value<T1>(arg4), 0x6a8ea93191ba31bce539fe0c18b595d6a18956c4d39df099f36d53d2ce2336f6::error::amount_in_above_max_limit());
    ...
    public fun update_liquidity_offset(arg0: &mut ClmmVault, arg1: u32, arg2: u32) {
        assert!(arg1 > 0 && arg2 > 0, 0x6a8ea93191ba31bce539fe0c18b595d6a18956c4d39df099f36d53d2ce2336f6::error::invalid_liquidity_range());
