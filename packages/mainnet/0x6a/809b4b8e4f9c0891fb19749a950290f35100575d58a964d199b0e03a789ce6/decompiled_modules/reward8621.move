module 0x6a809b4b8e4f9c0891fb19749a950290f35100575d58a964d199b0e03a789ce6::reward8621 {
    struct REWARD8621 has drop {
        dummy_field: bool,
    }

    struct TICKET_8621 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8621(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8621>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8621>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8621, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8621>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8621>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8621>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8621>>(v5, 0x2::tx_context::sender(arg1));
    }
