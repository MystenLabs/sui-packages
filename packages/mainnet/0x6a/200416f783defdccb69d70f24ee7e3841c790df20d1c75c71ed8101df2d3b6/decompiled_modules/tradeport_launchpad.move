module 0x6a200416f783defdccb69d70f24ee7e3841c790df20d1c75c71ed8101df2d3b6::tradeport_launchpad {
    ...
    fun add_nft_metadata_0(arg0: &mut Group, arg1: bool, arg2: u64, arg3: 0x2::bag::Bag, arg4: &mut 0x2::tx_context::TxContext) {
        if (arg1) {
            ...
            0x2::dynamic_object_field::add<vector<u8>, 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::Warehouse<0x2::bag::Bag>>(&mut arg0.id, b"warehouse", v0);
        } else {
    ...
    fun format_attributes(arg0: vector<0x1::string::String>, arg1: vector<0x1::string::String>) : 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
    ...
    public fun get_nft_metadata(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: 0x1::string::String, arg3: u64, arg4: 0x1::string::String, arg5: u64, arg6: 0x1::string::String, arg7: u64, arg8: u64, arg9: u64, arg10: vector<u8>, arg11: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg12: &mut 0x2::tx_context::TxContext) : (0x2::bag::Bag, 0x1::option::Option<0x2::bag::Bag>) {
        ...
        assert!(v6.minted == 0 || v6.minted < v6.max_supply, 9);
        ...
        assert!(arg3 == 0, 4);
        get_nft_metadata_0(arg0, v2, v7, arg12)
    }
    ...
    fun get_nft_metadata_0(arg0: &0x2::clock::Clock, arg1: &mut Group, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : (0x2::bag::Bag, 0x1::option::Option<0x2::bag::Bag>) {
        ...
        if (arg2 && !0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::is_empty<0x2::bag::Bag>(v0)) {
            return (0x6a200416f783defdccb69d70f24ee7e3841c790df20d1c75c71ed8101df2d3b6::warehouse_utils::redeem_random_nft<0x2::bag::Bag>(arg0, v0, arg3), 0x1::option::some<0x2::bag::Bag>(0x6a200416f783defdccb69d70f24ee7e3841c790df20d1c75c71ed8101df2d3b6::warehouse_utils::redeem_random_nft<0x2::bag::Bag>(arg0, v0, arg3)))
        };
        (0x6a200416f783defdccb69d70f24ee7e3841c790df20d1c75c71ed8101df2d3b6::warehouse_utils::redeem_random_nft<0x2::bag::Bag>(arg0, v0, arg3), 0x1::option::none<0x2::bag::Bag>())
    }
