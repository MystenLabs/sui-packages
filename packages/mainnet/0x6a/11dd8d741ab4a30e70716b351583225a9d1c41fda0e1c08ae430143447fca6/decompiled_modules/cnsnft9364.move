module 0x6a11dd8d741ab4a30e70716b351583225a9d1c41fda0e1c08ae430143447fca6::cnsnft9364 {
    struct CNSNFT9364 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9364, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9364>(arg0, arg1);
