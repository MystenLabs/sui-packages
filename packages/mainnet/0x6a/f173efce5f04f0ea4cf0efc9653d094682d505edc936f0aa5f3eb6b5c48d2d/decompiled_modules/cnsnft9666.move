module 0x6af173efce5f04f0ea4cf0efc9653d094682d505edc936f0aa5f3eb6b5c48d2d::cnsnft9666 {
    struct CNSNFT9666 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9666, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9666>(arg0, arg1);
