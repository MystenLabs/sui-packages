module 0x6aaf3877ea11bf0a508869fb89ed7c047009950991b3958e704bc41093037b11::_squid_keys {
    struct _SQUID_KEYS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _SQUID_KEYS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_SQUID_KEYS>(arg0, arg1);
