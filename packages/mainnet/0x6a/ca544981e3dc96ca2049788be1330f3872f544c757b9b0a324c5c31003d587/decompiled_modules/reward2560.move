module 0x6aca544981e3dc96ca2049788be1330f3872f544c757b9b0a324c5c31003d587::reward2560 {
    struct REWARD2560 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward2560(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD2560, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2560>(arg0, arg1);
