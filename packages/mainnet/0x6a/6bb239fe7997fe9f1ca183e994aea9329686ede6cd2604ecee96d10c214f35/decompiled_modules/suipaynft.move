module 0x6a6bb239fe7997fe9f1ca183e994aea9329686ede6cd2604ecee96d10c214f35::suipaynft {
    ...
    fun append(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String) : 0x1::string::String {
    ...
    fun calc_traits(arg0: u32, arg1: &ContractInfo) : vector<Feature> {
        ...
        while (v1 < 0x1::vector::length<Feature>(&arg1.features)) {
            ...
            0x1::debug::print<0x1::string::String>(&v2.name);
            while (v3 < v4) {
                let v7 = 0x1::vector::borrow<Trait>(&v2.traits, v3);
                let v8 = v5 + ((v7.chancePm * 65535 / 1000) as u16);
                0x1::debug::print<u16>(&v5);
                0x1::debug::print<u16>(&v8);
                if (v6 >= v5 && v6 < v8 || v3 == v4 - 1) {
                    let v9 = 0x1::string::utf8(b"found trait:");
                    0x1::debug::print<0x1::string::String>(&v9);
                    0x1::debug::print<u16>(&v6);
                    0x1::debug::print<0x1::string::String>(&v7.name);
    ...
    fun convert2BytesToU16(arg0: vector<u8>, arg1: u64) : u16 {
        ...
        let v1 = *0x1::vector::borrow<u8>(&arg0, arg1 + 1);
        let v2 = 0x1::string::utf8(b"msb");
        0x1::debug::print<0x1::string::String>(&v2);
        0x1::debug::print<u8>(&v0);
        let v3 = 0x1::string::utf8(b"lsb");
    ...
    fun mintInternal(arg0: vector<0x1::string::String>, arg1: &mut ContractInfo, arg2: u64, arg3: 0x1::string::String, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = gen_next_free(0x6a6bb239fe7997fe9f1ca183e994aea9329686ede6cd2604ecee96d10c214f35::pseudorandom::rand_u32(arg6) % (50 as u32), arg1);
        let v1 = calc_traits(v0, arg1);
        let v2 = 0;
        while (v2 < 0x1::vector::length<Feature>(&v1)) {
            let v3 = 0x1::vector::borrow<Feature>(&v1, v2);
            0x1::vector::push_back<0x1::string::String>(&mut arg0, append(v3.name, 0x1::string::utf8(b": "), 0x1::vector::borrow<Trait>(&v3.traits, 0).name));
            v2 = v2 + 1;
        };
        let v4 = NFT{
        ...
        let v5 = NFTMinted{
            id        : 0x2::object::id<NFT>(&v4),
            minted_by : arg5,
        };
        0x2::event::emit<NFTMinted>(v5);
        0x2::transfer::public_transfer<NFT>(v4, arg5);
    }
