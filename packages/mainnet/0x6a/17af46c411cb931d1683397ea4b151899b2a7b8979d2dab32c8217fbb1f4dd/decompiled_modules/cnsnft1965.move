module 0x6a17af46c411cb931d1683397ea4b151899b2a7b8979d2dab32c8217fbb1f4dd::cnsnft1965 {
    struct CNSNFT1965 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1965, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1965>(arg0, arg1);
