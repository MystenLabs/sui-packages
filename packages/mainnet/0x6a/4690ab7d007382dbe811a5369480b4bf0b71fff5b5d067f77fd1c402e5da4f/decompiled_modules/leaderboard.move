module 0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::leaderboard {
    ...
    public fun find_rank_2(arg0: &Leaderboard, arg1: u64, arg2: u64) : u64 {
        ...
        let v1 = 1;
        let (v2, _) = 0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::big_vector::min_slice<ChakraItem>(&arg0.chakras);
        let v4 = v2;
        while (!0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::big_vector::slice_is_null(&v4)) {
            let v5 = 0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::big_vector::borrow_slice<ChakraItem>(&arg0.chakras, v4);
            let v6 = 0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::big_vector::slice_bisect_right<ChakraItem>(v5, v0);
            let v7 = v1 + v6;
            v1 = v7;
            if (v6 < 0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::big_vector::slice_length<ChakraItem>(v5) && 0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::big_vector::slice_key<ChakraItem>(v5, v6) == v0) {
                return v7
            };
            if (v6 == 0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::big_vector::slice_length<ChakraItem>(v5)) {
                v4 = 0x88df0e25aeb8dccd0a4d54eb09acaf49957ee1c87add4273a48725f97fb30a15::big_vector::slice_next<ChakraItem>(v5);
            } else {
                break
            };
        };
