module 0x6a6aa1acb29ac451c27c8b6d1229df777e0e00eb2c1be5efcffc03948fe3cd2f::cnsnft9024 {
    struct CNSNFT9024 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9024, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9024>(arg0, arg1);
