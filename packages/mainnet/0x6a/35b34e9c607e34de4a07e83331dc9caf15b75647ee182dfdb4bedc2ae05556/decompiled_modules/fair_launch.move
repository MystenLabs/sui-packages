module 0x6a35b34e9c607e34de4a07e83331dc9caf15b75647ee182dfdb4bedc2ae05556::fair_launch {
    ...
    fun collect_finalize_market_fee<T0, T1>(arg0: &0x6a35b34e9c607e34de4a07e83331dc9caf15b75647ee182dfdb4bedc2ae05556::main::MainConfig, arg1: &mut FairLaunch<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun finalize_fair_launch<T0, T1>(arg0: &0x6a35b34e9c607e34de4a07e83331dc9caf15b75647ee182dfdb4bedc2ae05556::main::MainConfig, arg1: &mut FairLaunch<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg6);
        let v1 = 0x2::balance::value<T1>(&arg1.balance_y);
        assert!(v1 >= arg1.soft_cap && v0 > arg1.end_time, 8);
        if (v0 < arg1.timestamp_last_ms + 0x6a35b34e9c607e34de4a07e83331dc9caf15b75647ee182dfdb4bedc2ae05556::main::curator_finalizing_cooldown(arg0) || v0 < arg1.end_time + 0x6a35b34e9c607e34de4a07e83331dc9caf15b75647ee182dfdb4bedc2ae05556::main::curator_finalizing_cooldown(arg0)) {
