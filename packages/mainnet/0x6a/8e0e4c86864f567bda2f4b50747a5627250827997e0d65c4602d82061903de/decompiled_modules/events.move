module 0x6a8e0e4c86864f567bda2f4b50747a5627250827997e0d65c4602d82061903de::events {
    ...
    struct RegressionData has copy, drop, store {
        adjusted_anchor_price: u64,
        basis_bps: u64,
        basis_is_positive: bool,
        regression_adj_decibps: u64,
        regression_adj_is_positive: bool,
    }
    ...
    struct MispricingSweepEvent has copy, drop {
        pool_id: 0x2::object::ID,
        timestamp_ms: u64,
        is_bid_sweep: bool,
        mispriced_level_price: u64,
        input_price: u64,
        mispricing_pct: u64,
        sweep_price: u64,
        sweep_qty: u64,
    ...
    public(friend) fun emit_execution_detail(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: bool, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: bool, arg20: u64, arg21: u64, arg22: bool, arg23: bool, arg24: u64, arg25: u64, arg26: bool, arg27: u64, arg28: bool) {
        let v0 = RegressionData{
            adjusted_anchor_price      : arg24,
            basis_bps                  : arg25,
            basis_is_positive          : arg26,
            regression_adj_decibps     : arg27,
            regression_adj_is_positive : arg28,
        };
        let v1 = MMExecutionDetailEvent{
            state_id            : arg0,
            pool_id             : arg1,
            price_sequence      : arg2,
        ...
        0x2::event::emit<MMExecutionDetailEvent>(v1);
    }
    ...
    public(friend) fun emit_mispricing_sweep(arg0: 0x2::object::ID, arg1: u64, arg2: bool, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64) {
        let v0 = MispricingSweepEvent{
            pool_id               : arg0,
            timestamp_ms          : arg1,
            is_bid_sweep          : arg2,
            mispriced_level_price : arg3,
            input_price           : arg4,
            mispricing_pct        : arg5,
            sweep_price           : arg6,
            sweep_qty             : arg7,
            filled_qty            : arg8,
            profit_estimate       : arg9,
        };
        0x2::event::emit<MispricingSweepEvent>(v0);
    }
    ...
    public(friend) fun emit_pool_registered(arg0: 0x2::object::ID, arg1: 0x6a8e0e4c86864f567bda2f4b50747a5627250827997e0d65c4602d82061903de::config::MMConfig, arg2: u64) {
