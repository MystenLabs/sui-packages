module 0x6a63794b34bb7e566fdd43704e165453015eef9ec73f52f0e049b9eb627af31a::dump_it {
    struct DUMP_IT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DUMP_IT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DUMP_IT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Dump.it"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Dump.it "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://vLs53xEA3O60k9w8Ey_TDSyJVF0m8h2tzE9eU3za-wo"));
