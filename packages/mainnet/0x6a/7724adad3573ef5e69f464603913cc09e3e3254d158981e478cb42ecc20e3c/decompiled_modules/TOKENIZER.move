module 0x6a7724adad3573ef5e69f464603913cc09e3e3254d158981e478cb42ecc20e3c::TOKENIZER {
    ...
    fun init(arg0: TOKENIZER, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKENIZER>(arg0, 9, b"CICC", b"Council of International Chambers of Commerce", b"Tokenized representation of assets backed by ART20 NFTs", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://salmon-accused-puma-149.mypinata.cloud/ipfs/bafkreifufqxd6etuy47bosqlwwu5coffoup2a5rrpi3jqrcvdygodgnueu?pinataGatewayToken=Nc4R8TH9sXtjJQUiqvn_ZXvRnNYOlp6eH8lT7JTr0zEUEZV2BjEMU-81HiF2dy5x")), arg1);
        let v2 = v0;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<TOKENIZER>>(0x2::coin::mint<TOKENIZER>(&mut v2, 100000000000000, arg1), 0x2::tx_context::sender(arg1));
