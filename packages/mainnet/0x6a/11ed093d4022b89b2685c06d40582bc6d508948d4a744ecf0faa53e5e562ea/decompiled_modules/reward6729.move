module 0x6a11ed093d4022b89b2685c06d40582bc6d508948d4a744ecf0faa53e5e562ea::reward6729 {
    struct REWARD6729 has drop {
        dummy_field: bool,
    }

    struct TICKET_6729 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6729(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6729>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6729>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6729, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6729>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6729>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6729>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6729>>(v5, 0x2::tx_context::sender(arg1));
    }
