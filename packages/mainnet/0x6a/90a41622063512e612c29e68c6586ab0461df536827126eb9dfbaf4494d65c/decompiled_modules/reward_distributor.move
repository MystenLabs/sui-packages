module 0x74df751c1e5821fde9f56dc3d3afe1305621c337d2b13e0152a858d3e41eb070::reward_distributor {
    ...
    public fun checkpoint_token<T0>(arg0: &mut RewardDistributor<T0>, arg1: &0x74df751c1e5821fde9f56dc3d3afe1305621c337d2b13e0152a858d3e41eb070::reward_distributor_cap::RewardDistributorCap, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock) {
        ...
        checkpoint_token_internal_v2<T0>(arg0, 0x2::coin::value<T0>(&arg2), 0x74df751c1e5821fde9f56dc3d3afe1305621c337d2b13e0152a858d3e41eb070::common::current_timestamp(arg3));
    }
    ...
    fun checkpoint_token_internal_v2<T0>(arg0: &mut RewardDistributor<T0>, arg1: u64, arg2: u64) {
        let v0 = arg0.last_token_time;
        let v1 = arg2 - v0;
        let v2 = 0x74df751c1e5821fde9f56dc3d3afe1305621c337d2b13e0152a858d3e41eb070::common::to_period(v0);
        let v3 = 0;
        while (v3 < 20) {
            ...
            v2 = v2 + 0x74df751c1e5821fde9f56dc3d3afe1305621c337d2b13e0152a858d3e41eb070::common::epoch();
            if (arg2 < v2) {
                if (v1 == 0 && arg2 == v0) {
