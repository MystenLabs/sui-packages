module 0x6a3937ee92c5903d64f456f7aea39b5e86e50675eb918aec47615a75b547a201::cnsnft1059 {
    struct CNSNFT1059 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1059, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6387"));
        let v4 = 0x2::package::claim<CNSNFT1059>(arg0, arg1);
