module 0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::lotus_math {
    ...
    public(friend) fun mul_div_u64(arg0: u64, arg1: u64, arg2: u64) : u64 {
    ...
    public(friend) fun scale_from_float(arg0: u128, arg1: u64) : u64 {
        let v0 = (((arg0 as u128) * (0x2::math::pow(10, (arg1 as u8)) as u128) / 1000000000) as u128);
        assert!(v0 < 18446744073709551615, 1);
        (v0 as u64)
    }

    public(friend) fun scale_to_float(arg0: u64, arg1: u64) : u128 {
        (((arg0 as u128) * 1000000000 / (0x2::math::pow(10, (arg1 as u8)) as u128)) as u128)
    }
