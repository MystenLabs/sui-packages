module 0x4fb3bd86f61c02c4004a6880f7aae8310d26b2ca1ba8b5e68c0fcfc31a331677::DOGE {
    ...
    fun init(arg0: DOGE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<DOGE>(arg0, 9, b"HARRIS", b"Kamala Harris Doge", b"Kamala Harris Doge pump to millions", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
