module 0x4f0777c1d88297c17de9adf59abb736c96f9deab679a34d6dd3e24fccad03829::margin_state {
    ...
    public(friend) fun update(arg0: &mut State, arg1: &0x4f0777c1d88297c17de9adf59abb736c96f9deab679a34d6dd3e24fccad03829::protocol_config::ProtocolConfig, arg2: &0x2::clock::Clock) : u64 {
        let v0 = 0x2::clock::timestamp_ms(arg2);
        if (arg0.last_index_update_timestamp == v0) {
            return 0
        };
        let v1 = 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::math::mul(arg0.total_borrow, 0x4f0777c1d88297c17de9adf59abb736c96f9deab679a34d6dd3e24fccad03829::protocol_config::time_adjusted_rate(arg1, utilization_rate(arg0), v0 - arg0.last_index_update_timestamp));
