module 0x4fb2659183362a94863d327f8fd2883967d9dcc4044db0609ec5f399ac3b90f6::STORE {
    ...
    public entry fun buy_nft_entry<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg3: &mut 0x2::kiosk::Kiosk, arg4: 0x2::object::ID, arg5: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg6: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::object::id<0x2::kiosk::Kiosk>(arg3) == v5, 3);
        assert!(0x2::kiosk::has_item(arg3, arg4), 2);
        assert!(0x2::kiosk::is_listed(arg3, arg4), 5);
        assert!(0x2::coin::value<0x2::sui::SUI>(arg6) >= v8, 4);
        let (v9, v10) = 0x2::kiosk::purchase_with_cap<T0>(arg3, v7, 0x2::coin::split<0x2::sui::SUI>(arg6, v8, arg8));
        let v11 = v10;
        0x2::kiosk::lock<T0>(arg1, &v2, arg5, v9);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T0>(&mut v11, arg1);
        if (arg7 > 0) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg5, &mut v11, 0x2::coin::split<0x2::sui::SUI>(arg6, arg7, arg8));
        };
