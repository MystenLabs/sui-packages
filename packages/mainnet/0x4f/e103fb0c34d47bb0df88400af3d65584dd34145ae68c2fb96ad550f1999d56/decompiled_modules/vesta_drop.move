module 0x4fe103fb0c34d47bb0df88400af3d65584dd34145ae68c2fb96ad550f1999d56::vesta_drop {
    ...
    public fun allocate<T0>(arg0: &AdminCap, arg1: &mut VestaDrop<T0>, arg2: address, arg3: u64) {
        assert!(arg0.vesta_drop == 0x2::object::id<VestaDrop<T0>>(arg1), 0x4fe103fb0c34d47bb0df88400af3d65584dd34145ae68c2fb96ad550f1999d56::error::admin_error());
    ...
    public fun claim<T0>(arg0: &mut VestaDrop<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg1) / 1000 >= arg0.start_time, 0x4fe103fb0c34d47bb0df88400af3d65584dd34145ae68c2fb96ad550f1999d56::error::claim_not_start_error());
        assert!(0x2::table::contains<address, AirdropInfo>(&arg0.claims, 0x2::tx_context::sender(arg2)), 0x4fe103fb0c34d47bb0df88400af3d65584dd34145ae68c2fb96ad550f1999d56::error::no_allocate_error());
        let v0 = 0x2::table::borrow_mut<address, AirdropInfo>(&mut arg0.claims, 0x2::tx_context::sender(arg2));
        assert!(!v0.claimed, 0x4fe103fb0c34d47bb0df88400af3d65584dd34145ae68c2fb96ad550f1999d56::error::already_claimed_error());
        v0.claimed = true;
        assert!(0x2::balance::value<T0>(&arg0.balance) >= v0.amount, 0x4fe103fb0c34d47bb0df88400af3d65584dd34145ae68c2fb96ad550f1999d56::error::not_enough_fund_error());
        let v1 = v0.amount;
    ...
    public fun create<T0>(arg0: u64, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg1) / 1000 < arg0, 0x4fe103fb0c34d47bb0df88400af3d65584dd34145ae68c2fb96ad550f1999d56::error::start_time_error());
        let v0 = VestaDrop<T0>{
    ...
    public fun update_start_time<T0>(arg0: &AdminCap, arg1: &mut VestaDrop<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(0x2::clock::timestamp_ms(arg3) / 1000 < arg2, 0x4fe103fb0c34d47bb0df88400af3d65584dd34145ae68c2fb96ad550f1999d56::error::start_time_error());
        assert!(arg0.vesta_drop == 0x2::object::id<VestaDrop<T0>>(arg1), 0x4fe103fb0c34d47bb0df88400af3d65584dd34145ae68c2fb96ad550f1999d56::error::admin_error());
