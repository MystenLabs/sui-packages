module 0x4fe1ffa14aa5087607dd32e8cce3993185bf6353681b8ced0784cb54740a05d7::CHILLGUY {
    struct CHILLGUY has drop {
        dummy_field: bool,
    }

    fun init(arg0: CHILLGUY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<CHILLGUY>(arg0, 2, b"CHILLGUY", b"Just a chill guy", b"Just a chill guy", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/9PbUm_v6CfD4jeUBcECuUy2N0wvzLXbTq7nxNcIvXrs?ext=png")), arg1);
