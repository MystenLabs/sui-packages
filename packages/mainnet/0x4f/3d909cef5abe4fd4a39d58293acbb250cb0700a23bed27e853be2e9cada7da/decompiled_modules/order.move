module 0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::order {
    ...
    fun assert_coin_has_non_zero_value<T0>(arg0: &0x2::coin::Coin<T0>) {
        assert!(0 < 0x2::coin::value<T0>(arg0), 9223374304597639171);
    }

    fun assert_coin_types_differ_for_self_transfer<T0, T1>(arg0: address, arg1: address) {
        if (arg0 == arg1) {
            assert!(0x1::type_name::get<T0>() != 0x1::type_name::get<T1>(), 9223374343252213761);
        };
    }

    fun assert_current_timestamp_is_less_than_expiry_timestamp(arg0: &0x2::clock::Clock, arg1: u64) {
        assert!(0x2::clock::timestamp_ms(arg0) < arg1, 9223374437741887495);
    }

    fun assert_input_params_match_encrypted_fields<T0, T1>(arg0: &Order<T0, T1>, arg1: u64, arg2: u64, arg3: vector<u8>) {
        assert!(arg0.encrypted_fields == blake2b256(arg1, arg2, arg3), 9223374394792083461);
    }

    fun assert_trade_resulted_in_valid_price(arg0: u64, arg1: u64) {
        assert!(arg0 <= arg1, 9223374321777901577);
    }

    public fun begin_tx<T0, T1>(arg0: &mut Order<T0, T1>, arg1: &0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::Config, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (OrderCap<T1>, 0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::assert_interacting_with_most_up_to_date_package(arg1);
        let v0 = 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.remaining_balance, arg2), arg3);
        0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::take_protocol_fee<T0>(arg1, &mut v0, arg3);
        let v1 = &mut v0;
    ...
    public fun close_order<T0, T1>(arg0: Order<T0, T1>, arg1: &0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::Config, arg2: &mut 0x2::tx_context::TxContext) {
        0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::assert_interacting_with_most_up_to_date_package(arg1);
        let Order {
            id                    : v0,
            user                  : v1,
        ...
        0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::events::emit_closed_order_event<T0, T1>(0x2::object::id<Order<T0, T1>>(&arg0), v1, v3, v2, 0x2::balance::value<T0>(&v9), 0x2::balance::value<0x2::sui::SUI>(&v8), v6);
    }

    public fun create_order<T0, T1>(arg0: &0xce8245f6a3fb68f78dafe4d5f7ea7608b31292a6d43b4b7d4825861bd1295320::config::Config, arg1: &0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::Config, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: vector<u8>, arg5: address, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        create_order_with_integrator_fee<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0, @0x0, arg7);
    }

    public fun create_order_with_integrator_fee<T0, T1>(arg0: &0xce8245f6a3fb68f78dafe4d5f7ea7608b31292a6d43b4b7d4825861bd1295320::config::Config, arg1: &0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::Config, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: vector<u8>, arg5: address, arg6: vector<u8>, arg7: u16, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg9);
        0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::assert_interacting_with_most_up_to_date_package(arg1);
        0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::assert_enough_gas_was_provided(arg1, &arg3);
        ...
        0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::events::emit_created_order_event<T0, T1>(0x2::object::id<Order<T0, T1>>(&v2), v2.user, arg4, v2.recipient, v2.input_amount, 0x2::balance::value<0x2::sui::SUI>(&v2.gas), v2.encrypted_fields, v2.integrator_fee_config.fee_bps, v2.integrator_fee_config.fee_recipient);
        transfer<T0, T1>(v2, arg0, arg4);
    }

    public fun finish_tx<T0, T1>(arg0: &mut Order<T0, T1>, arg1: &0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::Config, arg2: OrderCap<T1>, arg3: 0x2::coin::Coin<T1>, arg4: &0x2::clock::Clock, arg5: u64, arg6: u64, arg7: vector<u8>) {
        0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::assert_interacting_with_most_up_to_date_package(arg1);
        ...
        0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::events::emit_executed_trade_event<T0, T1>(0x2::object::uid_to_inner(&arg0.id), arg0.user, arg0.recipient, v1, v0, v2);
    }

    fun init(arg0: ORDER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::create_config<ORDER>(&arg0, arg1);
        0x2::transfer::public_transfer<0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::admin::AdminCap>(0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::admin::create_admin_cap<ORDER>(&arg0, arg1), v0);
    ...
    fun take_integrator_fee<T0, T1>(arg0: &Order<T0, T1>, arg1: &mut 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg1, 0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config::calculate_fee(0x2::coin::value<T0>(arg1), (v0 as u128)), arg2), arg0.integrator_fee_config.fee_recipient);
    }
