module 0x4f60d836e64745524699859fdb1959c36a91ecfb859ea9771182aa249f36c515::FROGS {
    ...
    fun init(arg0: FROGS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<FROGS>(&mut v3, 210000000000, 0x2::tx_context::sender(arg1), arg1);
