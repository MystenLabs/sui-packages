module 0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin {
    ...
    struct OtherStats has store {
        ...
        total_project_pre_amount: u64,
        total_project_pst_amount: u64,
    ...
    public(friend) fun add_total_project_pre_amount(arg0: &mut GlobalNetworkData, arg1: u64) {
        arg0.other_stats.total_project_pre_amount = arg0.other_stats.total_project_pre_amount + arg1;
    }

    public(friend) fun add_total_project_pst_amount(arg0: &mut GlobalNetworkData, arg1: u64) {
        arg0.other_stats.total_project_pst_amount = arg0.other_stats.total_project_pst_amount + arg1;
    }
    ...
    public(friend) fun dynamic_power_totals(arg0: &GlobalNetworkData) : (u64, u64, u64) {
        (arg0.reward_stats.total_dynamic_power_distributed, arg0.reward_stats.total_dynamic_power, arg0.reward_stats.total_dynamic_power_distributed_amount)
    }

    public(friend) fun invest_totals(arg0: &GlobalNetworkData) : (u64, u64, u64, u64) {
        (arg0.invest_stats.total_sui_invested_unit, arg0.invest_stats.total_sui_invested_amount, arg0.invest_stats.total_invested_amount, arg0.invest_stats.total_asset_invested)
    }
    ...
    public fun new() : GlobalNetworkData {
        ...
        let v3 = OtherStats{
            ...
            total_project_pre_amount         : 0,
            total_project_pst_amount         : 0,
    ...
    public(friend) fun repair_v1_fake_sui_dynamic_totals(arg0: &mut GlobalNetworkData, arg1: u64, arg2: u64, arg3: u64, arg4: u64) {
        assert!(arg0.reward_stats.total_dynamic_power_distributed >= arg1, 1002);
        assert!(arg0.reward_stats.total_dynamic_power >= arg2, 1002);
        assert!(arg0.reward_stats.total_dynamic_power_distributed_amount == arg4, 1002);
        arg0.reward_stats.total_dynamic_power_distributed = arg0.reward_stats.total_dynamic_power_distributed - arg1;
        arg0.reward_stats.total_dynamic_power = arg0.reward_stats.total_dynamic_power - arg2 + arg3;
    }

    public(friend) fun repair_v1_fake_sui_totals(arg0: &mut GlobalNetworkData, arg1: u64, arg2: u64) {
        assert!(arg0.invest_stats.total_sui_invested_unit >= arg1, 1002);
        assert!(arg0.invest_stats.total_sui_invested_amount >= arg2, 1002);
        assert!(arg0.invest_stats.total_invested_amount >= arg2, 1002);
        assert!(arg0.invest_stats.total_asset_invested >= arg2, 1002);
        arg0.invest_stats.total_sui_invested_unit = arg0.invest_stats.total_sui_invested_unit - arg1;
        arg0.invest_stats.total_sui_invested_amount = arg0.invest_stats.total_sui_invested_amount - arg2;
        arg0.invest_stats.total_invested_amount = arg0.invest_stats.total_invested_amount - arg2;
        arg0.invest_stats.total_asset_invested = arg0.invest_stats.total_asset_invested - arg2;
    }
