module 0x4f4c910b601012eb87a3f920e435f1989c144ad26d3fd57ec05ca5a95b2a6016::reward4494 {
    struct REWARD4494 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward4494(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD4494, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4494>(arg0, arg1);
