module 0x4f04c5f0da30a210a8d972d7e4f919f468da397ccb1e1b677c7e95668565ce1a::cnsnft9764 {
    struct CNSNFT9764 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9764, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9764>(arg0, arg1);
