module 0x4f3b601605d93757c699ad2dae8c7b7bfb17e1b351bc96018eb01f271a8ae4b8::reward5595 {
    struct REWARD5595 has drop {
        dummy_field: bool,
    }

    struct TICKET_5595 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5595(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5595>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5595>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5595, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5595>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5595>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5595>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5595>>(v5, 0x2::tx_context::sender(arg1));
    }
