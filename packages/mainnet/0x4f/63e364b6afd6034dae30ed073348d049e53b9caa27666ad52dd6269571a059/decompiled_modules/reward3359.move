module 0x4f63e364b6afd6034dae30ed073348d049e53b9caa27666ad52dd6269571a059::reward3359 {
    struct REWARD3359 has drop {
        dummy_field: bool,
    }

    struct TICKET_3359 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3359(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3359>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3359>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3359, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3359>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3359>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3359>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3359>>(v5, 0x2::tx_context::sender(arg1));
    }
