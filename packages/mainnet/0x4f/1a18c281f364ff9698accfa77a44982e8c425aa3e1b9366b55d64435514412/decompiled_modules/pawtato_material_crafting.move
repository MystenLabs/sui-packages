module 0x5e72144d03621d7eaf23dabd3af43b6c871660652435283e267cbd7228cb0dda::pawtato_material_crafting {
    ...
    fun process_gemstone_rewards<T0, T1, T2, T3, T4>(arg0: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land::StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: 0x2::object::ID, arg3: address, arg4: 0x2::object::ID, arg5: u64, arg6: &0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_package_cap::PawtatoPackageCap, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0;
        while (v1 < arg5) {
            let v2 = 0x2::random::new_generator(arg7, arg8);
            if (0x2::random::generate_u64_in_range(&mut v2, 0, 100000 - 1) < calculate_gemstone_drop_chance(0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land::get_staked_tool_for_upgrading_with_cap(arg6, arg0, arg3, arg4))) {
                let v3 = roll_gemstone_index(arg7, arg8);
                let v4 = 1000000000;
                *0x1::vector::borrow_mut<u64>(&mut v0, (v3 as u64)) = *0x1::vector::borrow<u64>(&v0, (v3 as u64)) + v4;
                if (v3 == 0) {
                    0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::transfer_coin<T0>(0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::mint_coin_with_cap<T0>(arg6, arg1, arg2, v4, arg8), arg3);
                } else if (v3 == 1) {
                    0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::transfer_coin<T1>(0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::mint_coin_with_cap<T1>(arg6, arg1, arg2, v4, arg8), arg3);
                } else if (v3 == 2) {
                    0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::transfer_coin<T2>(0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::mint_coin_with_cap<T2>(arg6, arg1, arg2, v4, arg8), arg3);
                } else if (v3 == 3) {
                    0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::transfer_coin<T3>(0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::mint_coin_with_cap<T3>(arg6, arg1, arg2, v4, arg8), arg3);
                } else {
                    0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::transfer_coin<T4>(0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::mint_coin_with_cap<T4>(arg6, arg1, arg2, v4, arg8), arg3);
                };
            };
            v1 = v1 + 1;
        };
        if (*0x1::vector::borrow<u64>(&v0, 0) + *0x1::vector::borrow<u64>(&v0, 1) + *0x1::vector::borrow<u64>(&v0, 2) + *0x1::vector::borrow<u64>(&v0, 3) + *0x1::vector::borrow<u64>(&v0, 4) > 0) {
            let v5 = GemstonesFound{
                user             : arg3,
                gravel_processed : arg5,
                gemstone_counts  : v0,
            };
            0x2::event::emit<GemstonesFound>(v5);
        };
    }
    ...
    fun roll_gemstone_index(arg0: &0x2::random::Random, arg1: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x2::random::new_generator(arg0, arg1);
        (0x2::random::generate_u8_in_range(&mut v0, 0, 4) as u64)
    }
    ...
    public entry fun upgrade_version(arg0: &CraftingAdminCap, arg1: &mut CraftingSystem) {
        assert!(arg1.version < 1, 13906837262424866815);
        arg1.version = 1;
    }
