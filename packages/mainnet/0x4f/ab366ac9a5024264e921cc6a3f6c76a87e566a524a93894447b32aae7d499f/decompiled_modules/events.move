module 0x4fab366ac9a5024264e921cc6a3f6c76a87e566a524a93894447b32aae7d499f::events {
    ...
    struct UpdateMinMrToleranceRatio has copy, drop {
        vault_id: 0x2::object::ID,
    ...
    public(friend) fun emit_update_min_mr_tolerance_ratio(arg0: 0x2::object::ID, arg1: u256) {
        let v0 = UpdateMinMrToleranceRatio{
            vault_id               : arg0,
            min_mr_tolerance_ratio : arg1,
        };
        0x2::event::emit<UpdateMinMrToleranceRatio>(v0);
    }
