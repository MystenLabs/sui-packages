module 0x4fda476ab2d87d14e7e920b89c6338eac97880e0cd53531cd448494b8a7e2383::meme_token {
    ...
    public entry fun burn(arg0: &AdminCap, arg1: &mut 0x2::coin::TreasuryCap<MEME_TOKEN>, arg2: 0x2::coin::Coin<MEME_TOKEN>, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::burn<MEME_TOKEN>(arg1, arg2);
        let v0 = BurnEvent{
            amount : 0x2::coin::value<MEME_TOKEN>(&arg2),
            burner : 0x2::tx_context::sender(arg3),
        };
        0x2::event::emit<BurnEvent>(v0);
    }

    public entry fun mint(arg0: &AdminCap, arg1: &mut 0x2::coin::TreasuryCap<MEME_TOKEN>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 1);
        assert!(0x2::coin::total_supply<MEME_TOKEN>(arg1) + arg2 <= 10000000000000, 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<MEME_TOKEN>>(0x2::coin::mint<MEME_TOKEN>(arg1, arg2, arg4), arg3);
        let v0 = MintEvent{
            amount    : arg2,
            recipient : arg3,
        };
    ...
    public fun balance_of(arg0: &0x2::balance::Balance<MEME_TOKEN>) : u64 {
        0x2::balance::value<MEME_TOKEN>(arg0)
    }
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"DD", b"DIAMOND", b"Token made like a diamond", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://scarlet-visual-gopher-984.mypinata.cloud/ipfs/bafybeien2nudei6twjl7q7nqx6o4656bbe7isvejcveub7bdeeirrl6l74")), arg1);
    ...
    public entry fun transfer_treasury_cap(arg0: &AdminCap, arg1: 0x2::coin::TreasuryCap<MEME_TOKEN>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<MEME_TOKEN>>(arg1, arg2);
    }
