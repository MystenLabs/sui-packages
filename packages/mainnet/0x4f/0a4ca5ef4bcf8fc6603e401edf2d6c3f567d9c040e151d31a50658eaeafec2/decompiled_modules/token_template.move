module 0x4f0a4ca5ef4bcf8fc6603e401edf2d6c3f567d9c040e151d31a50658eaeafec2::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT2680305", b"BatchToken2 680305", b"Second parallel deployment", 0x1::option::none<0x2::url::Url>(), arg1);
