module 0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::a6 {
    ...
    fun apply<T0, T1>(arg0: &mut A<T0, T1>, arg1: &0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::vault::Vault<T1>, arg2: &0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::aftermath_perp_adapter::PerpAccount<T0, T1>, arg3: &0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::config::LotusConfig, arg4: u64, arg5: 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::ClearingHouse<T1>, arg6: &mut 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::account::Account<T1>, arg7: &0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed_storage::PriceFeedStorage, arg8: &0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed_storage::PriceFeedStorage, arg9: u64, arg10: u64, arg11: u64, arg12: u8, arg13: u64, arg14: u64, arg15: u64, arg16: bool, arg17: bool, arg18: u8, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: u64, arg27: u64, arg28: u64, arg29: u64, arg30: u64, arg31: u64, arg32: u64, arg33: u64, arg34: &0x2::clock::Clock, arg35: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::vault::assert_executor<T1>(arg1, arg0.d, 0x2::tx_context::sender(arg35));
        ...
        let v52 = if (v51) {
            if (arg33 > 0) {
                let (v53, _) = 0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::mkpc(true, v6, v9, v3, v2, arg0.off, v26);
                v53
            } else {
        ...
        let v59 = if (v58) {
            if (arg33 > 0) {
                let (v60, _) = 0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::mkpc(false, v6, v9, v3, v2, arg0.off, v26);
                v60
            } else {
        ...
        let v68 = if (arg33 > 0) {
            0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::rqdx(arg0.b.o != 0, arg0.b.p, v57, arg0.b.e, v1, arg0.refresh)
        } else {
            0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::rqd(arg0.b.o != 0, arg0.b.p, v57, true, econ_bound(v47, arg0.cost, true), arg0.improve, v26, arg0.b.e, v1, arg0.refresh)
        };
        let v69 = v68;
        let v70 = if (arg33 > 0) {
            0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::rqdx(arg0.x.o != 0, arg0.x.p, v64, arg0.x.e, v1, arg0.refresh)
        } else {
            0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::rqd(arg0.x.o != 0, arg0.x.p, v64, false, econ_bound(v48, arg0.cost, false), arg0.improve, v26, arg0.x.e, v1, arg0.refresh)
        };
        let v71 = v70;
        ...
        let v74 = if (v69 == 0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::act_replace()) {
            if (v57 > 0) {
                v40 > 0
            } else {
                false
        ...
        let v75 = if (v71 == 0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::act_replace()) {
            if (v64 > 0) {
                v41 > 0
            } else {
                false
        ...
        let v80 = false;
        let v81 = false;
        if (v69 != 0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::act_keep() && arg0.b.o != 0) {
            let v82 = &mut arg5;
            ...
            v80 = v84;
        } else if (v69 == 0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::act_keep() && arg0.b.o != 0) {
            v18 = v18 | 1;
        };
        if (v71 != 0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::act_keep() && arg0.x.o != 0) {
            let v85 = &mut arg5;
            ...
            v81 = v87;
        } else if (v71 == 0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::act_keep() && arg0.x.o != 0) {
            v18 = v18 | 8;
        };
        let v88 = if (v69 == 0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::act_replace()) {
            if (v57 > 0) {
                v40 > 0
            } else {
                false
        ...
        let v89 = if (v71 == 0x8588bf772f76920555f443cccfee2fe1b37afb8241105141d3a5159e23d5c3c::m1::act_replace()) {
            if (v64 > 0) {
                v41 > 0
            } else {
                false
    ...
    fun apply_portfolio<T0, T1, T2>(arg0: &mut A<T0, T2>, arg1: &0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::vault::Vault<T2>, arg2: &0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::aftermath_perp_adapter::PerpAccount<T1, T2>, arg3: &0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::config::LotusConfig, arg4: u64, arg5: 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::ClearingHouse<T2>, arg6: &mut 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::account::Account<T2>, arg7: &0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed_storage::PriceFeedStorage, arg8: &0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed_storage::PriceFeedStorage, arg9: u64, arg10: u64, arg11: u64, arg12: u8, arg13: u64, arg14: u64, arg15: u64, arg16: bool, arg17: bool, arg18: u8, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: u64, arg27: u64, arg28: u64, arg29: u64, arg30: u64, arg31: u64, arg32: u64, arg33: u64, arg34: &A<T1, T2>, arg35: &0x2::clock::Clock, arg36: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(arg34.v == 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::vault::id<T2>(arg1) && arg34.d == arg0.d, 1);
        assert!(arg34.p == 0x2::object::id<0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::aftermath_perp_adapter::PerpAccount<T1, T2>>(arg2) && arg34.a == 0x2::object::id<0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::account::Account<T2>>(arg6), 1);
        ...
        0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::vault::assert_executor<T2>(arg1, arg0.d, 0x2::tx_context::sender(arg36));
        if (arg9 <= arg0.n || arg10 <= arg0.ts) {
