module 0x4f8e1ae9a5859440bd7d2bc2f1a76508bf6f26bdb18745d3d90547fde524d1ea::game {
    ...
    public entry fun claim_referral_rewards(arg0: &mut GameState, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x2::sui::SUI>(&arg0.referral_rewards);
        assert!(v0 > 0, 11);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.referral_rewards, v0), arg1), 0x2::tx_context::sender(arg1));
    }
    ...
    public entry fun place_bet(arg0: &mut GameState, arg1: &mut 0x4f8e1ae9a5859440bd7d2bc2f1a76508bf6f26bdb18745d3d90547fde524d1ea::player_registry::Registry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::coin::value<0x2::sui::SUI>(&arg2);
        let v2 = 0x2::clock::timestamp_ms(arg4);
        assert!(v1 >= 0 && v1 <= 1000000000000, 4);
        0x4f8e1ae9a5859440bd7d2bc2f1a76508bf6f26bdb18745d3d90547fde524d1ea::player_registry::register_player(arg1, v0, arg3, 0x4f8e1ae9a5859440bd7d2bc2f1a76508bf6f26bdb18745d3d90547fde524d1ea::player_registry::get_jackpot_game_id(), arg4);
        let v3 = if (0x4f8e1ae9a5859440bd7d2bc2f1a76508bf6f26bdb18745d3d90547fde524d1ea::player_registry::is_valid_referrer(arg1, arg3)) {
            let v4 = 0x4f8e1ae9a5859440bd7d2bc2f1a76508bf6f26bdb18745d3d90547fde524d1ea::player_registry::get_player_address(arg1, arg3);
            if (v4 == v0) {
                arg0.admin
            } else {
                v4
        ...
        let v6 = v5.total_tickets;
        let v7 = v6 + v1;
        let v8 = 0x2::coin::into_balance<0x2::sui::SUI>(arg2);
        0x4f8e1ae9a5859440bd7d2bc2f1a76508bf6f26bdb18745d3d90547fde524d1ea::player_registry::update_jackpot_deposit(arg1, v0, v1);
        if (v3 != arg0.admin) {
            let v9 = v1 * 1 / 100;
            if (v9 > 0) {
                0x2::balance::join<0x2::sui::SUI>(&mut arg0.referral_rewards, 0x2::balance::split<0x2::sui::SUI>(&mut v8, v9));
                let v10 = ReferralRewardAdded{
                    referrer  : v3,
                    amount    : v9,
                    timestamp : v2,
                };
                0x2::event::emit<ReferralRewardAdded>(v10);
            };
        };
        let v11 = v1 * 8 / 100;
        if (v11 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v8, v11), arg5), arg0.admin);
        };
        0x2::balance::join<0x2::sui::SUI>(&mut v5.pool, v8);
        ...
        0x2::table::add<address, RoundPlayer>(&mut v5.players, v0, v12);
