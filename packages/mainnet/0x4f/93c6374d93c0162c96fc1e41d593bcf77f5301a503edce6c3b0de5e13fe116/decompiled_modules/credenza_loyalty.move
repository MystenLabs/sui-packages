module 0x4f93c6374d93c0162c96fc1e41d593bcf77f5301a503edce6c3b0de5e13fe116::credenza_loyalty {
    ...
    struct LoyaltyConfig has store, key {
        id: 0x2::object::UID,
        ownership: 0x4f93c6374d93c0162c96fc1e41d593bcf77f5301a503edce6c3b0de5e13fe116::ownership::CredenzaOwnership,
    ...
    public fun add_points(arg0: &mut LoyaltyConfig, arg1: address, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0x4f93c6374d93c0162c96fc1e41d593bcf77f5301a503edce6c3b0de5e13fe116::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg4));
    ...
    fun init(arg0: CREDENZA_LOYALTY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = LoyaltyConfig{
            id              : v7,
            ownership       : 0x4f93c6374d93c0162c96fc1e41d593bcf77f5301a503edce6c3b0de5e13fe116::ownership::create_ownership(0x2::object::uid_to_inner(&v7), arg1),
            policy_id       : 0x2::object::id<0x2::token::TokenPolicy<CREDENZA_LOYALTY>>(&v6),
            treasury_cap    : v2,
            lifetime_points : 0x2::table::new<address, u64>(arg1),
            coin            : 0x2::bag::new(arg1),
            rate            : 0,
        };
        0x4f93c6374d93c0162c96fc1e41d593bcf77f5301a503edce6c3b0de5e13fe116::ownership::add_owner(&mut v8.ownership, 0x2::tx_context::sender(arg1));
    ...
    public fun set_coin<T0>(arg0: &mut LoyaltyConfig, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x4f93c6374d93c0162c96fc1e41d593bcf77f5301a503edce6c3b0de5e13fe116::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
    ...
    public fun set_owner(arg0: &mut LoyaltyConfig, arg1: address, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        0x4f93c6374d93c0162c96fc1e41d593bcf77f5301a503edce6c3b0de5e13fe116::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        0x4f93c6374d93c0162c96fc1e41d593bcf77f5301a503edce6c3b0de5e13fe116::ownership::set_owner(&mut arg0.ownership, arg1, arg2);
    }
