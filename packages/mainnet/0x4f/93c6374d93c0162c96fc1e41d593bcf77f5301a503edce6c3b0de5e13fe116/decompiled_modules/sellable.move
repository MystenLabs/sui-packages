module 0x4f93c6374d93c0162c96fc1e41d593bcf77f5301a503edce6c3b0de5e13fe116::sellable {
    ...
    public fun create_config<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : (T0, CredenzaSellableConfig<T0>) {
        ...
        let v1 = CredenzaSellableConfig<T0>{
            id                      : v0,
            ownership               : 0x4f93c6374d93c0162c96fc1e41d593bcf77f5301a503edce6c3b0de5e13fe116::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
        ...
        0x4f93c6374d93c0162c96fc1e41d593bcf77f5301a503edce6c3b0de5e13fe116::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg1));
    ...
    public fun set_beneficiary_adress<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x4f93c6374d93c0162c96fc1e41d593bcf77f5301a503edce6c3b0de5e13fe116::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg2));
