module 0x4f1793f1ae40abbfcf593587f1c81e4f5875e06fb9b67fbd3407be9282431f32::oracle {
    struct OracleAdminCap has key {
        id: 0x2::object::UID,
    }

    struct OracleFeederCap has key {
        id: 0x2::object::UID,
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<OracleFeederCap>(v1, 0x2::tx_context::sender(arg0));
        let v2 = PriceOracle{
