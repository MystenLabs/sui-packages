module 0x4f87a279f06d61e09d776677fd224f389fddc87c2b87f155548f3952bcae9531::cnsnft4191 {
    struct CNSNFT4191 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4191, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4191>(arg0, arg1);
