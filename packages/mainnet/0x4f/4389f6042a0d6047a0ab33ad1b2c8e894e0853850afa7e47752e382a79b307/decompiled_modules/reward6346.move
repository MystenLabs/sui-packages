module 0x4f4389f6042a0d6047a0ab33ad1b2c8e894e0853850afa7e47752e382a79b307::reward6346 {
    struct REWARD6346 has drop {
        dummy_field: bool,
    }

    struct TICKET_6346 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6346(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6346>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6346>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6346, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6346>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6346>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6346>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6346>>(v5, 0x2::tx_context::sender(arg1));
    }
