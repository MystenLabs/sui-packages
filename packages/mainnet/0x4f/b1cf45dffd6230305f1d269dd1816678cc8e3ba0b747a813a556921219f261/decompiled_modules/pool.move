module 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::pool {
    ...
    public fun collect_protocol_fees<T0, T1, T2: store, T3: drop>(arg0: &mut Pool<T0, T1, T2, T3>, arg1: &0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::global_admin::GlobalAdmin, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::version::assert_version_and_upgrade(&mut arg0.version, 1);
        let (v0, v1) = 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::fees::withdraw<T0, T1>(&mut arg0.protocol_fees);
    ...
    public(friend) fun compute_swap_fees_<T0, T1, T2: store, T3: drop>(arg0: &Pool<T0, T1, T2, T3>, arg1: u64) : (u64, u64) {
        ...
        let (v2, v3) = 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::fees::fee_ratio_(&arg0.pool_fee_config);
        let v4 = 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::math::safe_mul_div_up(arg1, v2, v3);
        let v5 = 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::math::safe_mul_div_up(v4, v0, v1);
        (v5, v4 - v5)
    }
    ...
    public(friend) fun get_quote<T0, T1, T2: store, T3: drop>(arg0: &Pool<T0, T1, T2, T3>, arg1: u64, arg2: u64, arg3: bool) : 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::quote::SwapQuote {
