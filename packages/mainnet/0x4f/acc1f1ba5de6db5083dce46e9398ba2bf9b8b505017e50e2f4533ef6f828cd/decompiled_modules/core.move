module 0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::core {
    ...
    public fun add_liquidity<T0, T1, T2>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T2>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LPCoin<T0, T1, T2>> {
        assert!(0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::curve::is_curve<T0>(), 14);
    ...
    public fun calculate_s_value_out<T0, T1, T2>(arg0: &Pool<T0, T1, T2>, arg1: u64, arg2: u64, arg3: u64, arg4: bool) : u64 {
        assert!(!0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::curve::is_volatile<T0>(), 14);
        let v0 = (arg1 as u256);
        ...
        let v6 = if (arg4) {
            v4 - y((v0 - v0 * 500000000000000 / 1000000000000000000) * 1000000000000000000 / v5 + v3, k<0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::curve::Stable>(arg2, arg3, arg0.decimals_x, arg0.decimals_y), v4)
        } else {
            v3 - y((v0 - v0 * 500000000000000 / 1000000000000000000) * 1000000000000000000 / v5 + v4, k<0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::curve::Stable>(arg2, arg3, arg0.decimals_x, arg0.decimals_y), v3)
        };
        let v7 = if (arg4) {
            v2
        } else {
    ...
    fun create_pool<T0, T1, T2>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T2>, arg4: u64, arg5: u64, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LPCoin<T0, T1, T2>> {
        ...
        let v7 = PoolCreated<Pool<0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::curve::Volatile, T1, T2>>{
        ...
        0x2::event::emit<PoolCreated<Pool<0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::curve::Volatile, T1, T2>>>(v7);
    ...
    public fun create_s_pool<T0, T1>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LPCoin<0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::curve::Stable, T0, T1>> {
        create_pool<0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::curve::Stable, T0, T1>(arg0, arg1, arg2, arg3, 0x2::math::pow(10, 0x2::coin::get_decimals<T0>(arg4)), 0x2::math::pow(10, 0x2::coin::get_decimals<T1>(arg5)), true, arg6)
    }

    public fun create_v_pool<T0, T1>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LPCoin<0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::curve::Volatile, T0, T1>> {
        create_pool<0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::curve::Volatile, T0, T1>(arg0, arg1, arg2, arg3, 0, 0, false, arg4)
    }
    ...
    public fun get_coin_x_price<T0, T1, T2>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: u64) : u64 {
        ...
        if (0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::curve::is_volatile<T0>()) {
    ...
    public fun swap_token_x<T0, T1, T2>(arg0: &mut DEXStorage, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        let v7 = if (0x4facc1f1ba5de6db5083dce46e9398ba2bf9b8b505017e50e2f4533ef6f828cd::curve::is_volatile<T0>()) {
