module 0x4f479fca1fc96300a75d57f3f344f439b4dd2b63aa4d7e3607b864c48419de65::StakeManagement {
    ...
    struct RemovePool has copy, drop {
        id: u64,
        signer_addr: address,
    }

    struct BalanceRefund has copy, drop {
        pool_id: u64,
        treasury_addr: address,
    ...
    public fun Refund<T0>(arg0: u64, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = BalanceRefund{
            pool_id       : arg0,
            treasury_addr : 0x2::tx_context::sender(arg3),
            founder_addr  : arg1,
            amount        : 0x2::coin::value<T0>(&arg2),
        };
        0x2::event::emit<BalanceRefund>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, arg1);
    }

    public fun Remove(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = RemovePool{
            id          : arg0,
            signer_addr : 0x2::tx_context::sender(arg1),
        };
        0x2::event::emit<RemovePool>(v0);
    }

    public fun Reward<T0>(arg0: u64, arg1: address, arg2: address, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg3) * 5 / 1000;
        let v1 = StakeReward{
            pool_id       : arg0,
            treasury_addr : 0x2::tx_context::sender(arg4),
            lender_addr   : arg1,
            amount        : 0x2::coin::value<T0>(&arg3),
        };
        0x2::event::emit<StakeReward>(v1);
        let v2 = PlatformCommission{
            pool_id : arg0,
            addr    : arg2,
            amount  : v0,
        };
        0x2::event::emit<PlatformCommission>(v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg3, v0, arg4), arg2);
