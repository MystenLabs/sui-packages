module 0x4f5937b773915de347279f375c0dcf7207995e561656a88a00f6c04c9a8145aa::cnsnft4781 {
    struct CNSNFT4781 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4781, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4781>(arg0, arg1);
