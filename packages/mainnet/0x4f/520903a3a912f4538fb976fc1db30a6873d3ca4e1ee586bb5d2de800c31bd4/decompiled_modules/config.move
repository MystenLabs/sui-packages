module 0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::config {
    ...
    struct GlobalConfig has store, key {
        ...
        acl: 0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::ACL,
        package_version: u64,
    }
    ...
    public fun acl(arg0: &GlobalConfig) : &0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::ACL {
        &arg0.acl
    }
    ...
    public fun cancel(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::cancel(&mut arg0.acl, arg1, arg2, arg3);
    }

    public fun execute(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::execute(&mut arg0.acl, arg1, arg2, arg3);
    }

    public fun get_fund_receiver(arg0: &GlobalConfig) : address {
        0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::get_fund_receiver(&arg0.acl)
    }

    public fun get_reward_receiver(arg0: &GlobalConfig) : address {
        0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::get_reward_receiver(&arg0.acl)
    }
    ...
    public fun propose(arg0: &mut GlobalConfig, arg1: u8, arg2: u8, arg3: address, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) : u64 {
        checked_package_version(arg0);
        0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::propose(&mut arg0.acl, arg1, arg2, arg3, arg4, arg5)
    }
    ...
    public fun set_publisher(arg0: &mut GlobalConfig, arg1: 0x2::package::Publisher, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::set_publisher(&mut arg0.acl, arg1, arg2, arg3);
    }
    ...
    public fun set_upgrade_cap(arg0: &mut GlobalConfig, arg1: 0x2::package::UpgradeCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::set_upgrade_cap(&mut arg0.acl, arg1, arg2, arg3);
    }

    public fun vote(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::vote(&mut arg0.acl, arg1, arg2, arg3);
    }
    ...
    public fun check_config_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::has_role(&arg0.acl, arg1, 0), 5003);
    }

    public fun check_pool_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::has_role(&arg0.acl, arg1, 1), 5003);
    }

    public fun check_reward_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::has_role(&arg0.acl, arg1, 2), 5003);
    }

    public fun check_upgrade_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::has_role(&arg0.acl, arg1, 3), 5003);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                   : 0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::acl::new(arg0),
            package_version       : 1,
        };
