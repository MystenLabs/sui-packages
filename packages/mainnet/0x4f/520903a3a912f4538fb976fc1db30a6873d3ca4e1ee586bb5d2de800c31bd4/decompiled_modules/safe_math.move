module 0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::safe_math {
    ...
    public fun sqrt_u128(arg0: u128) : u128 {
        ...
        let v0 = 1 << (0x4f520903a3a912f4538fb976fc1db30a6873d3ca4e1ee586bb5d2de800c31bd4::bit_math::most_significant_bit(arg0) + 1) / 2;
        let v1 = (arg0 / v0 + v0) / 2;
        while (v1 < v0) {
            let v2 = arg0 / v1 + v1;
            v1 = v2 / 2;
    ...
    public fun sub_u128_cape_zero(arg0: u128, arg1: u128) : u128 {
        if (arg0 >= arg1) {
            arg0 - arg1
        } else {
            0
