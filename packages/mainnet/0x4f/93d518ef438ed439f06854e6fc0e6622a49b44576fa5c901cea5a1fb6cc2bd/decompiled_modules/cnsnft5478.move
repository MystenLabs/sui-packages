module 0x4f93d518ef438ed439f06854e6fc0e6622a49b44576fa5c901cea5a1fb6cc2bd::cnsnft5478 {
    struct CNSNFT5478 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5478, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5478>(arg0, arg1);
