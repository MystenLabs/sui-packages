module 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::risk_engine {
    ...
    public fun compute_effective_initial_margin_bps(arg0: &RiskRegistry, arg1: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::MarketRegistry, arg2: vector<u8>) : u64 {
    ...
    public fun compute_effective_maintenance_margin_bps(arg0: &RiskRegistry, arg1: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::MarketRegistry, arg2: vector<u8>) : u64 {
        assert!(0x2::table::contains<vector<u8>, MarketRiskParams>(&arg0.params, arg2), 1);
        let v0 = 0x2::table::borrow<vector<u8>, MarketRiskParams>(&arg0.params, arg2);
        apply_multiplier(v0.maintenance_margin_ratio_bps, get_oi_multiplier(v0, arg1, arg2))
    }

    public fun compute_margin_check(arg0: &RiskRegistry, arg1: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::MarketRegistry, arg2: vector<u8>, arg3: u64, arg4: u64) : MarginCheckResult {
        assert!(0x2::table::contains<vector<u8>, MarketRiskParams>(&arg0.params, arg2), 1);
        let v0 = 0x2::table::borrow<vector<u8>, MarketRiskParams>(&arg0.params, arg2);
        let v1 = 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_calculator::compute_initial_margin(arg3, v0.initial_margin_ratio_bps);
        let v2 = 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_calculator::compute_maintenance_margin(arg3, v0.maintenance_margin_ratio_bps);
    ...
    public fun compute_oi_utilization_bps(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::MarketRegistry, arg1: vector<u8>) : u64 {
        let v0 = 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::borrow_market(arg0, arg1);
        let v1 = 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::market_total_oi_cap(v0);
        if (v1 == 0) {
            return 0
        };
        (((0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::market_total_oi(v0) as u128) * (10000 as u128) / (v1 as u128)) as u64)
    }
    ...
    fun get_oi_multiplier(arg0: &MarketRiskParams, arg1: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::MarketRegistry, arg2: vector<u8>) : u64 {
    ...
    public fun register_market_risk(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut RiskRegistry, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u64>, arg7: vector<u64>) {
    ...
    public fun set_escalation_tiers(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut RiskRegistry, arg2: vector<u8>, arg3: vector<u64>, arg4: vector<u64>) {
    ...
    public fun update_market_risk(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut RiskRegistry, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64) {
        assert!(0x2::table::contains<vector<u8>, MarketRiskParams>(&arg1.params, arg2), 1);
        assert!(arg3 >= 1, 2);
        assert!(arg3 <= 20, 3);
        assert!(arg4 > 0, 4);
    ...
    public fun validate_initial_margin(arg0: &RiskRegistry, arg1: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::MarketRegistry, arg2: vector<u8>, arg3: u64, arg4: u64) {
    ...
    public fun validate_maintenance_margin(arg0: &RiskRegistry, arg1: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::MarketRegistry, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64, arg6: bool, arg7: u64, arg8: u64) {
        assert!(0x2::table::contains<vector<u8>, MarketRiskParams>(&arg0.params, arg2), 1);
        let v0 = 0x2::table::borrow<vector<u8>, MarketRiskParams>(&arg0.params, arg2);
        let v1 = 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_calculator::compute_account_equity(arg7, 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_calculator::compute_unrealized_pnl(arg3, arg4, arg5, arg6), arg8);
        assert!(0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_calculator::signed_is_negative(&v1) && false || 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_calculator::signed_value(&v1) >= apply_multiplier(0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_calculator::compute_maintenance_margin(0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_calculator::compute_notional_value(arg3, arg5), v0.maintenance_margin_ratio_bps), get_oi_multiplier(v0, arg1, arg2)), 12);
    }

    public fun validate_position_change(arg0: &RiskRegistry, arg1: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::MarketRegistry, arg2: vector<u8>, arg3: u64, arg4: u64) {
