module 0x4f61fe56a6f73d29be0e21f31d991a57c762f1da236823bf5b3f263a8c242b08::cnsnft2903 {
    struct CNSNFT2903 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2903, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8861"));
        let v4 = 0x2::package::claim<CNSNFT2903>(arg0, arg1);
