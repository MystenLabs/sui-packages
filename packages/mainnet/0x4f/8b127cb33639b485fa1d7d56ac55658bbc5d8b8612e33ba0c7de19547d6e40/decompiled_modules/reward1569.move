module 0x4f8b127cb33639b485fa1d7d56ac55658bbc5d8b8612e33ba0c7de19547d6e40::reward1569 {
    struct REWARD1569 has drop {
        dummy_field: bool,
    }

    struct TICKET_1569 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1569(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1569>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1569>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1569, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1569>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1569>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1569>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1569>>(v5, 0x2::tx_context::sender(arg1));
    }
