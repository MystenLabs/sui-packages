module 0x4f7ce4eec09923dad935f9d968d8507e61c98a79069bb3e50b63def658f2928b::reward5570 {
    struct REWARD5570 has drop {
        dummy_field: bool,
    }

    struct TICKET_5570 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5570(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5570>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5570>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5570, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5570>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5570>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5570>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5570>>(v5, 0x2::tx_context::sender(arg1));
    }
