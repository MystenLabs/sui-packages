module 0x4f8aecf3fc887eeaa9eab89f6315f436ea199163d224af66fb8d61515d0f80e0::wild_horses {
    struct WILD_HORSES has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"8a07b333-1bd3-4522-896d-b88c2c0decc1"),
        };
    ...
    fun init(arg0: WILD_HORSES, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WILD_HORSES>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Wild horses"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Collection of black and white horse photographs. Limited edition of 10 each "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmXxfkNVCQ4NgqxacELvnv3RiZPi2KPfubhMCS2Tor2fBv"));
