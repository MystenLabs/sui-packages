module 0x4f9f3fbbf1dba75c0ca481a05e93bad6ba6d2dd419f799c49974dd1ecc0aef74::token {
    ...
    struct RootletsLanguage has store, key {
        id: 0x2::object::UID,
        number: u64,
    ...
    public(friend) fun id(arg0: &RootletsLanguage) : 0x2::object::ID {
        0x2::object::id<RootletsLanguage>(arg0)
    }

    public(friend) fun attributes(arg0: &RootletsLanguage) : &0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        &arg0.attributes
    }

    fun burn(arg0: RootletsLanguage, arg1: &mut Supply, arg2: &Data) : 0x2::object::UID {
        let RootletsLanguage {
            id         : v0,
            number     : v1,
            image      : _,
            attributes : v3,
    ...
    public fun buy_on_curve(arg0: 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveBuyOrder<RootletsLanguage>, arg1: &Data, arg2: &mut Supply, arg3: &mut 0x2::tx_context::TxContext) : (vector<RootletsLanguage>, 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveBuyOrder<RootletsLanguage>) {
        assert!(0x1::option::is_some<0x2::object::ID>(&arg1.curve), 0);
        let v0 = 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::buy_order_curve<RootletsLanguage>(&arg0);
        assert!(&v0 == 0x1::option::borrow<0x2::object::ID>(&arg1.curve), 0);
        (mint(arg1, arg2, 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::buy_order_size<RootletsLanguage>(&arg0), arg3), arg0)
    }
    ...
    public(friend) fun image(arg0: &RootletsLanguage) : &0x1::string::String {
        &arg0.image
    }

    fun init(arg0: TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TOKEN>(arg0, arg1);
        let v1 = 0x2::display::new<RootletsLanguage>(&v0, arg1);
        0x2::display::add<RootletsLanguage>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"ROOTLETS LANGUAGE #{number}"));
        0x2::display::add<RootletsLanguage>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"ROOTLETS LANGUAGE AND PHILOSOPHY ROOT"));
        0x2::display::add<RootletsLanguage>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"ipfs://{image}"));
        0x2::display::add<RootletsLanguage>(&mut v1, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
        0x2::display::update_version<RootletsLanguage>(&mut v1);
        let v2 = Supply{
        ...
        0x2::transfer::public_transfer<0x2::display::Display<RootletsLanguage>>(v1, 0x2::tx_context::sender(arg1));
        0x2::transfer::transfer<ManagerCap>(v4, 0x2::tx_context::sender(arg1));
    }

    fun mint(arg0: &Data, arg1: &mut Supply, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : vector<RootletsLanguage> {
        assert!(arg2 > 0 && arg2 <= 1000, 0);
        assert!(arg2 <= 0x1::vector::length<vector<u64>>(&arg1.bitmaps), 9223372706869673983);
        let v0 = 0;
        let v1 = 0x1::vector::empty<RootletsLanguage>();
        while (v0 < arg2) {
            ...
            let v7 = RootletsLanguage{
                id         : 0x2::object::new(arg3),
                number     : 0x1::vector::pop_back<u64>(&mut v2),
                image      : *0x2::table::borrow<u64, 0x1::string::String>(&arg0.images, v3),
                attributes : v6,
            };
            0x1::vector::push_back<RootletsLanguage>(&mut v1, v7);
            v0 = v0 + 1;
        };
        v1
    }

    public(friend) fun number(arg0: &RootletsLanguage) : u64 {
        arg0.number
    }
    ...
    public fun sell_on_curve(arg0: vector<RootletsLanguage>, arg1: 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveSellOrder<RootletsLanguage>, arg2: &mut Supply, arg3: &Data) : (vector<0x2::object::UID>, 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveSellOrder<RootletsLanguage>) {
        assert!(0x1::option::is_some<0x2::object::ID>(&arg3.curve), 0);
        let v0 = 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::sell_order_curve<RootletsLanguage>(&arg1);
        assert!(&v0 == 0x1::option::borrow<0x2::object::ID>(&arg3.curve), 0);
        let v1 = 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::sell_asset_ids<RootletsLanguage>(&arg1);
        assert!(0x1::vector::length<0x2::object::ID>(&v1) == 0x1::vector::length<RootletsLanguage>(&arg0), 0);
        let v2 = 0;
        let v3 = 0x1::vector::empty<0x2::object::UID>();
        while (v2 < 0x1::vector::length<0x2::object::ID>(&v1)) {
            let v4 = 0x1::vector::pop_back<RootletsLanguage>(&mut arg0);
            assert!(id(&v4) == 0x1::vector::pop_back<0x2::object::ID>(&mut v1), 0);
            0x1::vector::push_back<0x2::object::UID>(&mut v3, burn(v4, arg2, arg3));
            v2 = v2 + 1;
        };
        0x1::vector::destroy_empty<RootletsLanguage>(arg0);
