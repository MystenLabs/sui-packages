module 0x4f65b8c84e7879a5f3fb21b5be0c96198f4c29cddd5c54a62cf08a0f45341496::reward8952 {
    struct REWARD8952 has drop {
        dummy_field: bool,
    }

    struct TICKET_8952 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8952(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8952>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8952>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8952, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8952>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8952>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8952>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8952>>(v5, 0x2::tx_context::sender(arg1));
    }
