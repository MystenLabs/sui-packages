module 0x467cb0c052b6a7a3d08cd2430c050cd16bb6256dacd656db1b97a2b36044249a::reward2276 {
    struct REWARD2276 has drop {
        dummy_field: bool,
    }

    struct TICKET_2276 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2276(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2276>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2276>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2276, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2276>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2276>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2276>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2276>>(v5, 0x2::tx_context::sender(arg1));
    }
