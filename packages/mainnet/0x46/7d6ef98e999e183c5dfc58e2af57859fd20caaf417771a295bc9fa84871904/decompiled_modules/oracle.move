module 0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::oracle {
    ...
    public(friend) fun calculate_price<T0, T1>(arg0: &0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_registry::MarginRegistry, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : u64 {
        let v0 = get_decimals<T0>(arg0);
        let v1 = get_decimals<T1>(arg0);
        if (v0 > v1) {
            let v3 = (0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::math::div(calculate_usd_price<T0>(arg1, arg0, 0x1::u64::pow(10, v0), arg3), calculate_usd_price<T1>(arg2, arg0, 0x1::u64::pow(10, v1), arg3)) as u128) / 0x1::u128::pow(10, v0 - v1);
            assert!(v3 <= (0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::constants::max_price() as u128), 6);
            (v3 as u64)
        } else if (v1 > v0) {
            let v4 = (0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::math::div(calculate_usd_price<T0>(arg1, arg0, 0x1::u64::pow(10, v0), arg3), calculate_usd_price<T1>(arg2, arg0, 0x1::u64::pow(10, v1), arg3)) as u128) * 0x1::u128::pow(10, v1 - v0);
            assert!(v4 <= (0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::constants::max_price() as u128), 6);
            (v4 as u64)
        } else {
            0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::math::div(calculate_usd_price<T0>(arg1, arg0, 0x1::u64::pow(10, v0), arg3), calculate_usd_price<T1>(arg2, arg0, 0x1::u64::pow(10, v1), arg3))
        }
    }

    public(friend) fun calculate_target_amount<T0>(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_registry::MarginRegistry, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        calculate_target_currency_amount(price_config<T0>(arg0, arg1, false, arg3), arg2)
    }

    public(friend) fun calculate_target_currency<T0, T1>(arg0: &0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_registry::MarginRegistry, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: u64, arg4: &0x2::clock::Clock) : u64 {
    ...
    public(friend) fun calculate_usd_price<T0>(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_registry::MarginRegistry, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        calculate_usd_currency_amount(price_config<T0>(arg0, arg1, true, arg3), arg2)
    }

    fun get_config_for_type<T0>(arg0: &0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_registry::MarginRegistry) : CoinTypeData {
        let v0 = 0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_registry::get_config<PythConfig>(arg0);
    ...
    fun get_decimals<T0>(arg0: &0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_registry::MarginRegistry) : u8 {
        let v0 = get_config_for_type<T0>(arg0);
        v0.decimals
    }

    public(friend) fun get_pyth_price<T0>(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_registry::MarginRegistry, arg2: &0x2::clock::Clock) : (u64, u8) {
        let (v0, v1, _, _) = get_validated_pyth_price<T0>(arg0, arg1, arg2);
        (v0, v1)
    }

    fun get_validated_pyth_price<T0>(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_registry::MarginRegistry, arg2: &0x2::clock::Clock) : (u64, u8, u64, CoinTypeData) {
        let v0 = get_config_for_type<T0>(arg1);
        let v1 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::pyth::get_price_no_older_than(arg0, arg2, 0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_registry::get_config<PythConfig>(arg1).max_age_secs);
    ...
    public fun new_coin_type_data_from_currency<T0>(arg0: &0x2::coin_registry::Currency<T0>, arg1: vector<u8>, arg2: u64, arg3: u64) : CoinTypeData {
        assert!(arg2 <= 0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_constants::max_conf_bps(), 5);
        assert!(arg3 <= 0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_constants::max_ewma_difference_bps(), 5);
        CoinTypeData{
    ...
    fun price_config<T0>(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_registry::MarginRegistry, arg2: bool, arg3: &0x2::clock::Clock) : ConversionConfig {
