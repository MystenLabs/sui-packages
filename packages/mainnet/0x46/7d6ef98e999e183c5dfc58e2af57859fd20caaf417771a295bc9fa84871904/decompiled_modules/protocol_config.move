module 0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::protocol_config {
    ...
    public(friend) fun calculate_interest_with_borrow(arg0: &ProtocolConfig, arg1: u64, arg2: u64, arg3: u64) : u64 {
        0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::math::mul(0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::math::mul(arg3, interest_rate(arg0, arg1)), 0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::math::div(arg2, 0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_constants::year_ms()))
    }
    ...
    public(friend) fun interest_rate(arg0: &ProtocolConfig, arg1: u64) : u64 {
        ...
        if (arg1 < v0) {
            0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::math::mul(arg1, arg0.interest_config.base_slope) + arg0.interest_config.base_rate
        } else {
            arg0.interest_config.base_rate + 0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::math::mul(v0, arg0.interest_config.base_slope) + 0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::math::mul(arg1 - v0, arg0.interest_config.excess_slope)
        }
    }
    ...
    public fun new_interest_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : InterestConfig {
        assert!(arg2 <= 0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::constants::float_scaling(), 1);
        InterestConfig{
            base_rate           : arg0,
            base_slope          : arg1,
    ...
    public fun new_margin_pool_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : MarginPoolConfig {
        assert!(arg1 <= 0x4626eeeb99b797e25ba1766861336145b393f346b47db2942f79c703a85572c8::constants::float_scaling(), 1);
        assert!(arg3 >= 0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_constants::min_min_borrow(), 1);
        assert!(arg2 <= 0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_constants::max_protocol_spread(), 1);
        let v0 = arg0 / 10;
        MarginPoolConfig{
            supply_cap                    : arg0,
            ...
            rate_limit_refill_rate_per_ms : v0 / 0x467d6ef98e999e183c5dfc58e2af57859fd20caaf417771a295bc9fa84871904::margin_constants::day_ms(),
