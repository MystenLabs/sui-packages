module 0x467beccfed14de4af966dbaf157a44ff569b7a69f310e6bf5a395ffcf497dfaa::suiborg_genesis___cybernetic_utility_nft {
    struct SUIBORG_GENESIS___CYBERNETIC_UTILITY_NFT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"4bda7545-0a69-4a09-ad03-7fbd5a33ce2e"),
        };
    ...
    fun init(arg0: SUIBORG_GENESIS___CYBERNETIC_UTILITY_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUIBORG_GENESIS___CYBERNETIC_UTILITY_NFT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SuiBorg Genesis - Cybernetic Utility NFT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"10 cybernetic canines with cosmic designs, trading bot VIP access, and exclusive utilities"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmTyob2bf2EVi1FmMfRWxHFiPBMLJGWkVHtDDZJyrzTU5o"));
