module 0x46d687e59a63b378cc6a2f922aab6f13ca8be365237f0e13424f94d79c284e98::apples {
    ...
    fun init(arg0: APPLES, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<APPLES>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Apples"));
