module 0x46979bff576697a56111135f2dd4ffa72a418a12a4e502b3682cbfd10257e37c::SCOIN {
    ...
    fun init(arg0: SCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SCOIN>(arg0, 9, b"GASCOIN", x"d0857569", b"Ecosystem coin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/QmdPsqEurFWTSFWPX7Nj5kTNjnreWeNJNbQf3pyjqYLBkj")), arg1);
