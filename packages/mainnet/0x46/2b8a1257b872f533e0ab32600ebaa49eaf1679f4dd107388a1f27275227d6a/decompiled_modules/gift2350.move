module 0x462b8a1257b872f533e0ab32600ebaa49eaf1679f4dd107388a1f27275227d6a::gift2350 {
    struct GIFT2350 has drop {
        dummy_field: bool,
    }

    struct TICKET_2350 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2350(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2350>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2350>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2350, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2350>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2350>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2350>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2350>>(v5, 0x2::tx_context::sender(arg1));
    }
