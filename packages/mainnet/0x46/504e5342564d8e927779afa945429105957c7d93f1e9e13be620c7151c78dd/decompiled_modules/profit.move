module 0x46504e5342564d8e927779afa945429105957c7d93f1e9e13be620c7151c78dd::profit {
    ...
    fun init(arg0: PROFIT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PROFIT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Profit    ")))), trim_right(b"Profitcoin                      "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
