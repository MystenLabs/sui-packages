module 0x46b5ff6e093d67984318a818c0531f18037152cedb89182181b802126b442ae3::deposit_agent_config {
    ...
    public(friend) fun token_holder_receive<T0>(arg0: &mut DepositAgentConfig, arg1: &0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet_config::CloudWalletConfig, arg2: &mut 0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet_config::CloudWalletTokenHolder, arg3: u256, arg4: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg5: address, arg6: u64, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        check_signer(arg0, 0x46b5ff6e093d67984318a818c0531f18037152cedb89182181b802126b442ae3::utils::ecrecover(arg7, get_collect_to_sign_msg<T0>(0x2::object::id_address<DepositAgentTokenHolder>(v0), arg3, 0x2::coin::value<T0>(&v1), arg5, arg6)));
        0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet::mm_credit<T0>(arg1, arg2, v1, arg8);
    }
    ...
    public(friend) fun when_to_address_match(arg0: &0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet_config::CloudWalletTokenHolder, arg1: address) {
        assert!(arg1 == 0x2::object::id_address<0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet_config::CloudWalletTokenHolder>(arg0), 40012);
    }
