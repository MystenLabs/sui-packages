module 0x46956f33fbd3b3396cb2bc5aa6de2702d6832fad38c762092561bb332028d471::vapor {
    ...
    public fun burn(arg0: &mut Treasury, arg1: 0x2::coin::Coin<VAPOR>) {
        0x2::balance::decrease_supply<VAPOR>(&mut arg0.supply, 0x2::coin::into_balance<VAPOR>(arg1));
    }

    entry fun create_mint_cap(arg0: &0x46956f33fbd3b3396cb2bc5aa6de2702d6832fad38c762092561bb332028d471::admin::OwnerCap<VAPOR_ADMIN>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: VAPOR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x46956f33fbd3b3396cb2bc5aa6de2702d6832fad38c762092561bb332028d471::admin::transfer_owner_cap<VAPOR_ADMIN>(0x46956f33fbd3b3396cb2bc5aa6de2702d6832fad38c762092561bb332028d471::admin::create_owner_cap<VAPOR_ADMIN>(v0, arg1), 0x2::tx_context::sender(arg1));
    ...
    public fun invalidate_mint_cap(arg0: &0x46956f33fbd3b3396cb2bc5aa6de2702d6832fad38c762092561bb332028d471::admin::OwnerCap<VAPOR_ADMIN>, arg1: &mut Treasury, arg2: 0x2::object::ID) {
