module 0x46cc5fb87ebb578faafe596a9c02cb43e8cf790700856b57131763edad535f2f::cnsnft4264 {
    struct CNSNFT4264 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4264, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4264>(arg0, arg1);
