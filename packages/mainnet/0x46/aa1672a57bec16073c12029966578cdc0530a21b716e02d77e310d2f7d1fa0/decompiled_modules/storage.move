module 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::storage {
    ...
    fun decrease_balance(arg0: &mut TokenBalance, arg1: address, arg2: u256) {
        ...
        assert!(v0 >= arg2, 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::error::insufficient_balance());
    ...
    public entry fun init_reserve<T0>(arg0: &StorageAdminCap, arg1: &0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::pool::PoolAdminCap, arg2: &0x2::clock::Clock, arg3: &mut Storage, arg4: u8, arg5: bool, arg6: u256, arg7: u256, arg8: u256, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: u256, arg14: u256, arg15: u256, arg16: u256, arg17: u256, arg18: &0x2::coin::CoinMetadata<T0>, arg19: &mut 0x2::tx_context::TxContext) {
        version_verification(arg3);
        let v0 = arg3.reserves_count;
        assert!(v0 < 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::constants::max_number_of_reserves(), 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::error::no_more_reserves_allowed());
        ...
        let v5 = ReserveData{
            ...
            current_supply_index  : 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::ray_math::ray(),
            current_borrow_index  : 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::ray_math::ray(),
            supply_balance        : v1,
            borrow_balance        : v2,
        ...
        0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::pool::create_pool<T0>(arg1, 0x2::coin::get_decimals<T0>(arg18), arg19);
    }
    ...
    fun percentage_ray_validation(arg0: u256) {
        assert!(arg0 <= 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::ray_math::ray(), 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::error::invalid_value());
    }
    ...
    public fun reserve_validation<T0>(arg0: &Storage) {
        ...
        while (v0 < arg0.reserves_count) {
            assert!(0x2::table::borrow<u8, ReserveData>(&arg0.reserves, v0).coin_type != 0x1::type_name::into_string(0x1::type_name::get<T0>()), 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::error::duplicate_reserve());
            v0 = v0 + 1;
        };
    }
    ...
    public entry fun version_migrate(arg0: &StorageAdminCap, arg1: &mut Storage) {
        assert!(arg1.version < 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::version::this_version(), 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::error::not_available_version());
    ...
    public fun when_not_paused(arg0: &Storage) {
        assert!(!pause(arg0), 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::error::paused());
    }

    public fun withdraw_treasury<T0>(arg0: &StorageAdminCap, arg1: &0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::pool::PoolAdminCap, arg2: &mut Storage, arg3: u8, arg4: &mut 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::pool::Pool<T0>, arg5: u64, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(get_coin_type(arg2, arg3) == 0x1::type_name::into_string(0x1::type_name::get<T0>()), 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::error::invalid_coin_type());
        let (v0, _) = get_index(arg2, arg3);
        let v2 = 0x2::table::borrow_mut<u8, ReserveData>(&mut arg2.reserves, arg3);
        let v3 = v2.treasury_balance;
        let v4 = 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::safe_math::min((0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::pool::normal_amount<T0>(arg4, arg5) as u256), 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::ray_math::ray_mul(v3, v0));
        let v5 = 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::ray_math::ray_div(v4, v0);
        v2.treasury_balance = v3 - v5;
        decrease_total_supply_balance(arg2, arg3, v5);
        0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::pool::withdraw_reserve_balance<T0>(arg1, arg4, 0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::pool::unnormal_amount<T0>(arg4, (v4 as u64)), arg6, arg7);
        let v6 = WithdrawTreasuryEvent{
            sender    : 0x2::tx_context::sender(arg7),
            recipient : arg6,
            asset     : arg3,
            amount    : v4,
            poolId    : 0x2::object::uid_to_address(0x46aa1672a57bec16073c12029966578cdc0530a21b716e02d77e310d2f7d1fa0::pool::uid<T0>(arg4)),
            before    : v3,
