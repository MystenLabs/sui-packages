module 0x46693a6fcff4f2133e187a3ec12978509695ea76d8e80f457b3e3caa3a710080::warranty {
    ...
    public(friend) fun activate_warranty(arg0: &mut Warranty, arg1: &0x2::clock::Clock) : ActivatedPotato {
        arg0.activated = true;
        arg0.guarantee_until = 0x2::clock::timestamp_ms(arg1) + 2592000000 * arg0.guarantee_until;
    ...
    public entry fun cancel_ticket(arg0: WarrantyClaimTicket, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<Warranty>(v3, v3.beneficiary);
        let v5 = WarrantyClaimTicketCanceled{
            ticket_id   : 0x2::object::uid_to_inner(&v4),
            warranty_id : 0x2::object::id<Warranty>(&v3),
        };
        0x2::event::emit<WarrantyClaimTicketCanceled>(v5);
    }

    public entry fun create_claim_ticket(arg0: Warranty, arg1: 0x1::string::String, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun new_warranty(arg0: 0x2::object::ID, arg1: vector<vector<u8>>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : Warranty {
        assert!(0x1::vector::length<vector<u8>>(&arg1) == 2, 201);
        let v0 = *0x1::vector::borrow<vector<u8>>(&arg1, 0);
        let v1 = *0x1::vector::borrow<vector<u8>>(&arg1, 1);
        let v2 = 0x2::bcs::new(v0);
        assert!(0x2::ed25519::ed25519_verify(&v1, &arg2, &v0), 201);
        Warranty{
            id                : 0x2::object::new(arg3),
            escrow_id         : arg0,
            beneficiary       : 0x2::bcs::peel_address(&mut v2),
            coin_type_name    : 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v2)),
            cover_coin_amount : 0x2::bcs::peel_u64(&mut v2),
            price             : 0x2::bcs::peel_u64(&mut v2),
            guarantee_until   : 0x2::bcs::peel_u64(&mut v2),
            activated         : false,
        }
    }
