module 0x46bce10b7234a5ec3406d0955645161415d5eff869061d309f337cd38f0d21a0::crank {
    ...
    public fun check_crank_liveness<T0>(arg0: &CrankConfig, arg1: &mut 0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::vault::Vault<T0>, arg2: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg2);
        if (v0 - arg0.last_heartbeat_ms > arg0.max_heartbeat_gap_ms) {
            if (!0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::vault::is_auto_paused<T0>(arg1)) {
                0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::vault::trigger_auto_pause<T0>(arg1);
    ...
    public(friend) fun update_config(arg0: &mut CrankConfig, arg1: &0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::vault::AdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64) {
    ...
    public fun validate_heartbeat<T0>(arg0: &mut CrankConfig, arg1: &mut 0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::vault::Vault<T0>, arg2: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg2);
        assert!(v0 - arg0.last_heartbeat_ms >= arg0.min_heartbeat_interval_ms, 606);
        0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::vault::update_heartbeat_tvl<T0>(arg1, arg2);
        arg0.last_heartbeat_ms = v0;
        let v1 = 0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::vault::last_heartbeat_tvl<T0>(arg1);
        ...
        if (0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::vault::is_auto_paused<T0>(arg1)) {
            0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::vault::trigger_auto_unpause<T0>(arg1);
    ...
    public fun validate_reroute<T0>(arg0: &mut CrankConfig, arg1: &0x46bce10b7234a5ec3406d0955645161415d5eff869061d309f337cd38f0d21a0::apy::ApyRegistry, arg2: &0x46bce10b7234a5ec3406d0955645161415d5eff869061d309f337cd38f0d21a0::strategy::StrategyRegistry, arg3: &0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::vault::Vault<T0>, arg4: u8, arg5: u8, arg6: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg6);
        assert!(0x46bce10b7234a5ec3406d0955645161415d5eff869061d309f337cd38f0d21a0::strategy::count_available(arg2) >= 2, 600);
        assert!(0x46bce10b7234a5ec3406d0955645161415d5eff869061d309f337cd38f0d21a0::strategy::is_available(arg2, arg5), 601);
        assert!(arg4 != arg5, 602);
        let v1 = 0x46bce10b7234a5ec3406d0955645161415d5eff869061d309f337cd38f0d21a0::apy::get_total_apy(arg1, arg4);
        let v2 = 0x46bce10b7234a5ec3406d0955645161415d5eff869061d309f337cd38f0d21a0::apy::get_total_apy(arg1, arg5);
        assert!(v2 > v1, 607);
        let v3 = if (v1 == 0) {
            10000
        } else {
        ...
        0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::floors::assert_spread(v3);
        assert!(v2 >= arg0.min_apy_bps, 604);
        0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::floors::assert_min_apy(v2);
        let v4 = v0 - arg0.last_reroute_ms;
        assert!(v4 >= arg0.reroute_cooldown_ms, 605);
        0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::floors::assert_cooldown(v4);
        if (arg4 != 0) {
            0x46bce10b7234a5ec3406d0955645161415d5eff869061d309f337cd38f0d21a0::apy::assert_not_stale(arg1, arg4, arg6);
        };
        0x46bce10b7234a5ec3406d0955645161415d5eff869061d309f337cd38f0d21a0::apy::assert_not_stale(arg1, arg5, arg6);
        let (_, v6) = 0x46bce10b7234a5ec3406d0955645161415d5eff869061d309f337cd38f0d21a0::strategy::decode_strategy(arg5);
        if (v6 == 2) {
            assert!(!0x14de5ce960a411ab210ea069c1c73f9cb86d69ff0773ee0fa5a3bd5e96f00b6b::vault::is_depeg_active<T0>(arg3), 611);
        };
