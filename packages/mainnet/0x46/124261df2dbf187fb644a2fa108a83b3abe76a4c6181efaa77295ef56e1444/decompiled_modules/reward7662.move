module 0x46124261df2dbf187fb644a2fa108a83b3abe76a4c6181efaa77295ef56e1444::reward7662 {
    struct REWARD7662 has drop {
        dummy_field: bool,
    }

    struct TICKET_7662 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7662(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7662>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7662>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7662, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7662>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7662>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7662>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7662>>(v5, 0x2::tx_context::sender(arg1));
    }
