module 0x46d62677b87855388dd89b310f9f7b61e47349e733d64353527581c8b2ec75b3::nft_module {
    ...
    public entry fun add_whitelist(arg0: &mut Admin, arg1: &mut 0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::WhitelistContainer, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(isAdmin(arg0, 0x2::tx_context::sender(arg4)) == true, 0);
        0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::add_whitelist(arg1, arg2, arg3, arg4);
    }

    public entry fun add_whitelist_with_bought(arg0: &mut Admin, arg1: &mut 0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::WhitelistContainer, arg2: vector<address>, arg3: vector<u64>, arg4: vector<u64>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(isAdmin(arg0, 0x2::tx_context::sender(arg5)) == true, 0);
        0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::add_whitelist_with_bought(arg1, arg2, arg3, arg4, arg5);
    }
    ...
    public entry fun create_new_round(arg0: &mut Admin, arg1: &mut Container, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::create_whitelist_conatiner(v2, arg9);
        let v4 = 0;
        if (arg7 == true) {
            v4 = arg8;
        };
    ...
    public entry fun delete_wallet_address_in_whitelist(arg0: &mut Admin, arg1: &mut 0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::WhitelistContainer, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(isAdmin(arg0, 0x2::tx_context::sender(arg3)) == true, 0);
        0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::delete_wallet_in_whitelist(arg1, arg2, arg3);
    }
    ...
    public entry fun mint_nft(arg0: &mut Container, arg1: &mut Admin, arg2: &mut 0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::WhitelistContainer, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.total_supply > arg0.total_minted, 10);
        assert!(arg0.total_supply >= arg4, 10);
        let v0 = 0x2::tx_context::sender(arg6);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Round>(&mut arg0.id, 0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::get_id(arg2));
        ...
        if (v1.is_public == true) {
            if (0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::existed(arg2, v0) == true) {
                0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::update_whitelist(arg2, arg4, v0, false, arg6);
            } else {
                let v2 = 0x1::vector::empty<address>();
                let v3 = 0x1::vector::empty<u64>();
                0x1::vector::push_back<address>(&mut v2, v0);
                0x1::vector::push_back<u64>(&mut v3, v1.limit_minted);
                0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::add_whitelist(arg2, v2, v3, arg6);
                0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::update_whitelist(arg2, arg4, v0, false, arg6);
            };
        } else {
            0xcb82cac2fa54c620e9427a2cff07f3cd96b6b823f06ec4d57e9489d6987ba1fc::whitelist_module::update_whitelist(arg2, arg4, v0, false, arg6);
