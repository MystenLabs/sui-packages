module 0x461548bb2def4a55c6ed7537ac65cdcc0a541206cef9a80a9936f1ec656e7593::movexnft8044 {
    struct MOVEXNFT8044 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT8044, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT8044>(arg0, arg1);
