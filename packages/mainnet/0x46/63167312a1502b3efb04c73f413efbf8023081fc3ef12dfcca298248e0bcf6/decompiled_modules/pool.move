module 0x4663167312a1502b3efb04c73f413efbf8023081fc3ef12dfcca298248e0bcf6::pool {
    ...
    public entry fun create_pool<T0, T1>(arg0: &0x4663167312a1502b3efb04c73f413efbf8023081fc3ef12dfcca298248e0bcf6::admin::AdminCap, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun set_enabled<T0, T1>(arg0: &0x4663167312a1502b3efb04c73f413efbf8023081fc3ef12dfcca298248e0bcf6::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: bool) {
        arg1.enabled = arg2;
        let v0 = SetEnabledEvent<T0, T1>{enabled: arg2};
        0x2::event::emit<SetEnabledEvent<T0, T1>>(v0);
    }

    public entry fun set_end_time<T0, T1>(arg0: &0x4663167312a1502b3efb04c73f413efbf8023081fc3ef12dfcca298248e0bcf6::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: u64) {
    ...
    public entry fun set_lock_duration<T0, T1>(arg0: &0x4663167312a1502b3efb04c73f413efbf8023081fc3ef12dfcca298248e0bcf6::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: u64) {
        arg1.lock_duration = arg2;
        let v0 = SetLockDurationEvent<T0, T1>{lock_duration: arg2};
        0x2::event::emit<SetLockDurationEvent<T0, T1>>(v0);
    }

    public entry fun set_start_time<T0, T1>(arg0: &0x4663167312a1502b3efb04c73f413efbf8023081fc3ef12dfcca298248e0bcf6::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: u64) {
        let v0 = 0x2::clock::timestamp_ms(arg2) / 1000;
    ...
    public entry fun withdraw<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut Credential<T0, T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 >= arg3, 5);
        let v1 = 0x2::clock::timestamp_ms(arg1) / 1000;
        assert!(v1 >= 0x2::math::min(arg2.lock_until, arg0.end_time), 6);
        refresh_pool<T0, T1>(arg0, v1);
