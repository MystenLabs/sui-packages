module 0x467ae5203c1dbcfd1313bf0a4af5f960d233dbb369c70f617400bdbddc7c893a::blastwheelz {
    ...
    public fun mint_and_transfer_to_kiosk<T0>(arg0: &mut Collection<T0>, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::kiosk::Kiosk, arg4: &mut 0x2::transfer_policy::TransferPolicy<NFT<T0>>, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: address, arg12: 0x2::coin::Coin<0x2::sui::SUI>, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        0x467ae5203c1dbcfd1313bf0a4af5f960d233dbb369c70f617400bdbddc7c893a::rules::prove_personal_kiosk_rule<NFT<T0>>(arg3, &mut v1);
        0x467ae5203c1dbcfd1313bf0a4af5f960d233dbb369c70f617400bdbddc7c893a::rules::prove_kiosk_lock_rule<NFT<T0>>(&mut v1, arg1);
        0x467ae5203c1dbcfd1313bf0a4af5f960d233dbb369c70f617400bdbddc7c893a::rules::pay_royalty_rule<NFT<T0>>(arg4, &mut v1, arg12);
    ...
    public fun setup_transfer_policy<T0>(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v1;
        let v3 = v0;
        0x467ae5203c1dbcfd1313bf0a4af5f960d233dbb369c70f617400bdbddc7c893a::rules::add_personal_kiosk_rule<NFT<T0>>(&mut v3, &v2);
        0x467ae5203c1dbcfd1313bf0a4af5f960d233dbb369c70f617400bdbddc7c893a::rules::add_kiosk_lock_rule<NFT<T0>>(&mut v3, &v2);
        0x467ae5203c1dbcfd1313bf0a4af5f960d233dbb369c70f617400bdbddc7c893a::rules::add_royalty_rule<NFT<T0>>(&mut v3, &v2, 0x467ae5203c1dbcfd1313bf0a4af5f960d233dbb369c70f617400bdbddc7c893a::rules::new_royalty_config(500, 0));
