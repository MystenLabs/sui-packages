module 0x469d738cb3baa4c59dd5491c731e527f0dbe7833a7f29dacb3a0f452208f23fa::reward8967 {
    struct REWARD8967 has drop {
        dummy_field: bool,
    }

    struct TICKET_8967 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8967(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8967>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8967>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8967, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8967>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8967>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8967>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8967>>(v5, 0x2::tx_context::sender(arg1));
    }
