module 0x46f265dafb6c6bb8f1cc323c96e987a332c85d37994bcc6ec4572645acdc31ac::ions {
    ...
    fun increment_global_claim_index(arg0: &0x2::clock::Clock, arg1: &mut SeasonRewards) {
        ...
        if (arg1.total_points > 0) {
            arg1.global_claim_index = arg1.global_claim_index + 0x46f265dafb6c6bb8f1cc323c96e987a332c85d37994bcc6ec4572645acdc31ac::math::mul_div_u256(((v0 - arg1.last_time) as u256), (arg1.rewards_distribution_rate as u256) * (1000000000 as u256), (arg1.total_points as u256));
        };
        arg1.last_time = v0;
    }

    fun increment_user_claim_index(arg0: &SeasonRewards, arg1: &mut UserSeasonInfo) : u64 {
        let v0 = (0x46f265dafb6c6bb8f1cc323c96e987a332c85d37994bcc6ec4572645acdc31ac::math::mul_div_u256(arg0.global_claim_index - arg1.claim_index, (arg1.points_earned as u256), (1000000000 as u256)) as u64);
        ...
        if (v0 > 0 && v0 > v1) {
            ...
            let v4 = if (!v2.is_time_based_distribution) {
                if (v2.total_points > 0) {
                    (0x46f265dafb6c6bb8f1cc323c96e987a332c85d37994bcc6ec4572645acdc31ac::math::mul_div_u256((v3.points_earned as u256), (v2.rewards_allocated as u256), (v2.total_points as u256)) as u64)
                } else {
                    0
                }
            } else {
                v3.claim_index = v2.global_claim_index;
                (0x46f265dafb6c6bb8f1cc323c96e987a332c85d37994bcc6ec4572645acdc31ac::math::mul_div_u256(v2.global_claim_index - v3.claim_index, (v3.points_earned as u256), (1000000000 as u256)) as u64)
            };
            ...
            if (0x2::linked_table::contains<u64, UserSeasonInfo>(&arg2.season_info, v2)) {
                ...
                if (!v5.is_time_based_distribution) {
                    if (v5.total_points > 0) {
                        v4 = v3 + (0x46f265dafb6c6bb8f1cc323c96e987a332c85d37994bcc6ec4572645acdc31ac::math::mul_div_u256((v6.points_earned as u256), (v5.rewards_allocated as u256), (v5.total_points as u256)) as u64) - v6.claimed_amount;
                    };
                } else {
                    v4 = v3 + (0x46f265dafb6c6bb8f1cc323c96e987a332c85d37994bcc6ec4572645acdc31ac::math::mul_div_u256(v5.global_claim_index - v6.claim_index, (v6.points_earned as u256), (1000000000 as u256)) as u64);
                };
            };
        };
        if (0x2::linked_table::contains<u64, SeasonRewards>(&arg1.season_alloc, v1) && 0x2::linked_table::contains<u64, UserSeasonInfo>(&arg2.season_info, v1)) {
            ...
            if (!v9 && !(v7.start_time > v0)) {
                if (v7.is_time_based_distribution && v7.total_points > 0) {
                    v4 = v4 + (0x46f265dafb6c6bb8f1cc323c96e987a332c85d37994bcc6ec4572645acdc31ac::math::mul_div_u256(v7.global_claim_index + 0x46f265dafb6c6bb8f1cc323c96e987a332c85d37994bcc6ec4572645acdc31ac::math::mul_div_u256(((v0 - v7.last_time) as u256), (((v7.rewards_distribution_rate as u256) * 1000000000) as u256), (v7.total_points as u256)) - v8.claim_index, (v8.points_earned as u256), (1000000000 as u256)) as u64);
                };
            };
        };
        v4
