module 0x46ae346792aabdb9668e22fc9d8b987bd4c69653409472a9d90ac0b716c386e9::ruggg {
    ...
    fun init(arg0: RUGGG, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<RUGGG>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Ruggg"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"asdf"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://eaqnf_mvN8VG01ZWcSH-lAdM8VpvfJaCMtaW2D8gim4"));
