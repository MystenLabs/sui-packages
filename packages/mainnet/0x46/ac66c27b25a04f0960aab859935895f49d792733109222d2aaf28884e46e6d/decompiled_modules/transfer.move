module 0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::transfer {
    ...
    public fun redeem_transfer_with_payload<T0>(arg0: &0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::owner::FundCap, arg1: &mut 0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::state::State, arg2: 0x26efee2b51c911237888e5dc6702868abca3c7ac12c53f76ef8eba0697695e3d::complete_transfer_with_payload::RedeemerReceipt<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, _) = 0x26efee2b51c911237888e5dc6702868abca3c7ac12c53f76ef8eba0697695e3d::complete_transfer_with_payload::redeem_coin<T0>(0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::state::emitter_cap(arg1), arg2);
        let v3 = v1;
        let v4 = v0;
        let v5 = 0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::message::deserialize(0x26efee2b51c911237888e5dc6702868abca3c7ac12c53f76ef8eba0697695e3d::transfer_with_payload::payload(&v3));
        let v6 = 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::to_address(0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::message::recipient(&v5));
        let v7 = 0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::state::get_relayer_fee(arg1, 0x2::coin::value<T0>(&v4));
    ...
    public fun send_tokens_with_payload<T0>(arg0: &0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::state::State, arg1: 0x2::coin::Coin<T0>, arg2: 0x26efee2b51c911237888e5dc6702868abca3c7ac12c53f76ef8eba0697695e3d::token_registry::VerifiedAsset<T0>, arg3: u16, arg4: address, arg5: u32, arg6: u128, arg7: u8, arg8: 0x1::string::String, arg9: u32, arg10: &0x2::tx_context::TxContext) : 0x26efee2b51c911237888e5dc6702868abca3c7ac12c53f76ef8eba0697695e3d::transfer_tokens_with_payload::TransferTicket<T0> {
        ...
        assert!(0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::state::contract_registered(arg0, arg3), 1);
        let v1 = LogBridgeTo{
            _adaptorId : arg7,
        ...
        let (v3, v4) = 0x26efee2b51c911237888e5dc6702868abca3c7ac12c53f76ef8eba0697695e3d::transfer_tokens_with_payload::prepare_transfer<T0>(0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::state::emitter_cap(arg0), arg2, arg1, arg3, 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::to_bytes(0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::state::foreign_contract_address(arg0, arg3)), 0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::message::serialize(0x46ac66c27b25a04f0960aab859935895f49d792733109222d2aaf28884e46e6d::message::new(v0)), arg5);
