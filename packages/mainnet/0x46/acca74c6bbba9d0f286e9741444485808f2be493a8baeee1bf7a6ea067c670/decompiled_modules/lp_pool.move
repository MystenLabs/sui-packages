module 0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::lp_pool {
    ...
    public(friend) fun calculate_lp_fee(arg0: &LiquidityPool, arg1: 0x1::type_name::TypeName, arg2: u64, arg3: u64, arg4: bool) : (u64, u64) {
        ...
        let v14 = v7 + v13;
        ((((arg2 as u128) * (v14 as u128) / (0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::math::get_bp_scale() as u128)) as u64), (((arg3 as u128) * (v14 as u128) / (0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::math::get_bp_scale() as u128)) as u64))
    }
    ...
    fun calculate_swap_fee(arg0: &LiquidityPool, arg1: 0x1::type_name::TypeName, arg2: u64, arg3: u64, arg4: bool) : (u64, u64) {
        ...
        let v1 = v0.config.spot_config;
        let v2 = v0.state.value_in_usd;
        let v3 = (((arg0.pool_info.tvl_usd as u128) * (v1.target_weight_bp as u128) / (0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::math::get_bp_scale() as u128)) as u64);
        let v4 = if (v3 > v2) {
            v3 - v2
        } else {
            v2 - v3
        ...
        let v13 = v7 + v12;
        ((((arg2 as u128) * (v13 as u128) / (0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::math::get_bp_scale() as u128)) as u64), (((arg3 as u128) * (v13 as u128) / (0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::math::get_bp_scale() as u128)) as u64))
    }
    ...
    entry fun manager_emergency_withdraw<T0, T1>(arg0: &0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::admin::Version, arg1: &mut Registry, arg2: u64, arg3: ManagerDepositReceipt, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        ...
        assert!(0x1::type_name::with_defining_ids<T1>() == v6.lp_token_type, 0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::error::lp_token_type_mismatched());
    ...
    public fun mint_lp<T0, T1>(arg0: &mut 0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::admin::Version, arg1: &mut Registry, arg2: &mut 0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::treasury_caps::TreasuryCaps, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v2 >= v3.config.spot_config.min_deposit, 0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::error::deposit_amount_insufficient());
        assert!(v3.state.liquidity_amount + v2 <= v3.config.spot_config.max_capacity, 0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::error::reach_max_capacity());
        ...
        0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::admin::charge_fee<T0>(arg0, v10);
        ...
        0x2::coin::mint<T1>(0xec30955b1e100617a02fecec432d2c845f17b2f3d68827f390563faba112513b::treasury_caps::get_mut_treasury_cap<T1>(arg2), v8, arg7)
    }
