module 0x461512ec8ae3a3ae17adc6712d4a98df64c6ed0afe3ad52d0469db791f884668::cnsnft4898 {
    struct CNSNFT4898 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4898, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4898>(arg0, arg1);
