module 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_position {
    ...
    public(friend) fun shrink(arg0: &mut Position, arg1: u32, arg2: u64) {
        ...
        assert!(v0, 9223372273077977087);
        assert!(*0x2::table::borrow<u32, u64>(&arg0.shares, arg1) >= arg2, 9223372277372944383);
