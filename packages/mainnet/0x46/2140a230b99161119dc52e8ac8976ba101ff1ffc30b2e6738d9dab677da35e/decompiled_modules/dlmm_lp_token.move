module 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_lp_token {
    ...
    struct DlmmLpToken has store, key {
        id: 0x2::object::UID,
        pair_id: 0x2::object::ID,
    ...
    public fun balance_of(arg0: &DlmmLpToken, arg1: u32, arg2: address) : u64 {
    ...
    public fun burn(arg0: &mut DlmmLpToken, arg1: &MintCap, arg2: u32, arg3: address, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(arg1.lp_token == 0x2::object::id<DlmmLpToken>(arg0) && arg1.pair_id == arg0.pair_id, 9223372492121309183);
    ...
    public(friend) fun create(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) : (DlmmLpToken, MintCap) {
        let v0 = DlmmLpToken{
        ...
        let v1 = MintCap{
            pair_id   : arg0,
            pair_uniq : arg1,
            lp_token  : 0x2::object::id<DlmmLpToken>(&v0),
        };
        (v0, v1)
    }

    public fun emit_mint_events_bundle(arg0: &DlmmLpToken, arg1: 0x2::object::ID, arg2: vector<EventTransfer>) {
        let v0 = EventMint{
            pair_id         : arg1,
    ...
    public fun mint(arg0: &mut DlmmLpToken, arg1: &MintCap, arg2: u32, arg3: address, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (u64, EventTransfer) {
        assert!(arg1.lp_token == 0x2::object::id<DlmmLpToken>(arg0) && arg1.pair_id == arg0.pair_id, 9223372380452159487);
        if (!0x2::table::contains<u32, 0x2::table::Table<address, u64>>(&arg0.balances, arg2)) {
    ...
    public fun total_supply(arg0: &DlmmLpToken, arg1: u32) : u64 {
