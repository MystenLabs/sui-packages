module 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_factory {
    ...
    public fun close_bin_step_preset(arg0: &mut Factory, arg1: &AdminCap, arg2: u64, arg3: u16) {
        check_admin(arg0, arg1);
        assert!(0x2::vec_map::contains<u64, 0x2::vec_set::VecSet<u16>>(&arg0.opened_bin_steps, &arg2) && 0x2::vec_set::contains<u16>(0x2::vec_map::get<u64, 0x2::vec_set::VecSet<u16>>(&arg0.opened_bin_steps, &arg2), &arg3), 9223373316755030015);
    ...
    public fun grant_admin(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<Factory>(arg1), 9223372840013660159);
    ...
    public fun grant_protocol_fee_cap(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<Factory>(arg1), 9223373054762024959);
    ...
    public fun revoke_admin(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: 0x2::object::ID) {
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_admin, &arg2), 9223372895848235007);
    ...
    public fun revoke_protocol_fee_cap(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: 0x2::object::ID) {
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_protocol_fee_cap, &arg2), 9223373110596599807);
        0x2::vec_set::remove<0x2::object::ID>(&mut arg0.allowed_admin, &arg2);
    ...
    public fun set_default_partner(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: &0xbb1e485664a4d5099154f9c8f10a54d49e2e7dc02c8e358253f0cd5c14eaa1bd::partner::Partner) {
        assert!(0x2::package::from_package<Factory>(arg1), 9223372938797907967);
    ...
    public fun set_max_bins_in_position(arg0: &mut Factory, arg1: &AdminCap, arg2: u64) {
        ...
        assert!(v0 != arg2, 9223373007517384703);
