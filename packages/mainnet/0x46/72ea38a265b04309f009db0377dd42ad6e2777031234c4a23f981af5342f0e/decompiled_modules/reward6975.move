module 0x4672ea38a265b04309f009db0377dd42ad6e2777031234c4a23f981af5342f0e::reward6975 {
    struct REWARD6975 has drop {
        dummy_field: bool,
    }

    struct TICKET_6975 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6975(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6975>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6975>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6975, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6975>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6975>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6975>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6975>>(v5, 0x2::tx_context::sender(arg1));
    }
