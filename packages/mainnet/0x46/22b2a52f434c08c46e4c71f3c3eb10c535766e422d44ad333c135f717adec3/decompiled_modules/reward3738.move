module 0x4622b2a52f434c08c46e4c71f3c3eb10c535766e422d44ad333c135f717adec3::reward3738 {
    struct REWARD3738 has drop {
        dummy_field: bool,
    }

    struct TICKET_3738 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3738(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3738>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3738>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3738, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3738>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3738>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3738>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3738>>(v5, 0x2::tx_context::sender(arg1));
    }
