module 0x4697c810b9339eecce1028035e637e926587498fc6425397d63f4f37e69faa92::omg_protocol {
    ...
    fun update_campaign_rewards_(arg0: &mut WrapperState, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2 * v0.reward_rate * 0x2::balance::value<OMG_PROTOCOL>(&v0.omg_usd_reserves) / 1000000000000000;
        if (v3 != 0) {
            arg0.total_wrapped = arg0.total_wrapped + v3;
            0x2::balance::join<OMG_PROTOCOL>(&mut v0.omg_usd_reserves, 0x2::coin::into_balance<OMG_PROTOCOL>(0x2::coin::mint<OMG_PROTOCOL>(&mut arg0.treasury_cap, v3, arg3)));
        };
