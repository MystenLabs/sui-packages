module 0x46be4b420dc2711c7ebec5eb0dece43c8c35823986486c28dafa94bc0e6d3e3d::bluefin {
    public fun atob<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg1: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg2: vector<0x2::coin::Coin<T0>>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, u64) {
        let (v0, v1) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, T1>(arg4, arg0, arg1, 0x2::coin::into_balance<T0>(0x46be4b420dc2711c7ebec5eb0dece43c8c35823986486c28dafa94bc0e6d3e3d::help::merge_all<T0>(arg2, arg5)), 0x2::balance::zero<T1>(), true, true, arg3, 0, 4295048017);
        let v2 = v1;
        0x46be4b420dc2711c7ebec5eb0dece43c8c35823986486c28dafa94bc0e6d3e3d::help::transfer<T0>(0x2::coin::from_balance<T0>(v0, arg5), 0x2::tx_context::sender(arg5));
    ...
    public fun btoa<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg1: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg2: vector<0x2::coin::Coin<T1>>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u64) {
        let (v0, v1) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, T1>(arg4, arg0, arg1, 0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x46be4b420dc2711c7ebec5eb0dece43c8c35823986486c28dafa94bc0e6d3e3d::help::merge_all<T1>(arg2, arg5)), false, true, arg3, 0, 79226673515401279992447579054);
        let v2 = v0;
        0x46be4b420dc2711c7ebec5eb0dece43c8c35823986486c28dafa94bc0e6d3e3d::help::transfer<T1>(0x2::coin::from_balance<T1>(v1, arg5), 0x2::tx_context::sender(arg5));
