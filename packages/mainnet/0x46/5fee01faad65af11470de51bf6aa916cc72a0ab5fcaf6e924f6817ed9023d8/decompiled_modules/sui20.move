module 0x465fee01faad65af11470de51bf6aa916cc72a0ab5fcaf6e924f6817ed9023d8::sui20 {
    ...
    public fun mint<T0>(arg0: &mut Global, arg1: &0x2::clock::Clock, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v5.minted_amount;
        let v7 = 0x1::vector::length<address>(&v3.users);
        if (!0x1::vector::contains<address>(&v3.users, &v0)) {
            let v8 = 0;
            while (v8 < v7) {
                if (v6 > 0x2::table::borrow<address, UserInfo>(&v3.user_infos, *0x1::vector::borrow<address>(&v3.users, v8)).minted_amount) {
                    0x1::vector::insert<address>(&mut v3.users, v0, v8);
                    break
                };
                v8 = v8 + 1;
            };
            let v9 = 0x1::vector::length<address>(&v3.users);
            if (v9 == v7 && v7 < 20) {
                0x1::vector::push_back<address>(&mut v3.users, v0);
            } else if (v9 > 20) {
                0x1::vector::pop_back<address>(&mut v3.users);
            };
        };
        let v10 = Sui20{
        ...
        0x2::transfer::public_transfer<Sui20>(v10, v0);
    }
