module 0x461860a2db9a87471e593100c3fecd556efd6ee7a37ab319ad37ec89a5c43e3b::game2508 {
    struct GAME2508 has drop {
        dummy_field: bool,
    }

    struct TICKET_2508 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2508(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2508>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2508>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME2508, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME2508>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2508>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2508>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2508>>(v5, 0x2::tx_context::sender(arg1));
    }
