module 0x4657a4c06c624af78addc77d5960769a5be40d94c159c841746456484d58ee81::reward4956 {
    struct REWARD4956 has drop {
        dummy_field: bool,
    }

    struct TICKET_4956 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4956(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4956>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4956>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4956, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4956>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4956>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4956>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4956>>(v5, 0x2::tx_context::sender(arg1));
    }
