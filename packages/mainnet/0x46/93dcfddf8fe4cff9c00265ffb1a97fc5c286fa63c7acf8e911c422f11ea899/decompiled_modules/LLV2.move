module 0x4693dcfddf8fe4cff9c00265ffb1a97fc5c286fa63c7acf8e911c422f11ea899::LLV2 {
    ...
    public entry fun new_lotus_pool<T0, T1>(arg0: &CreatePoolLock, arg1: &mut Factory, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: address, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: address, arg15: &0x2::clock::Clock, arg16: &Config, arg17: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > 0, 5);
        assert!(arg5 > 0, 5);
        ...
        let v3 = v2 * arg16.init_b_percent / 10000;
        let v4 = v2 * arg16.reward_percent / 10000;
        assert!(v3 > 0, 21);
        assert!(v4 > 0, 21);
        let v5 = v3 / arg8;
        assert!(v3 == v5 * arg8, 23);
        assert!(v5 > 0, 21);
        let v6 = 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, arg3, arg17));
        let v7 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v1, v3, arg17));
        let v8 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v1, v4, arg17));
        create_lotus_pool<T0, T1>(arg1, v6, v7, v8, 0x2::coin::into_balance<T1>(v1), arg6, arg7, v5, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg17);
