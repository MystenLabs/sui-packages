module 0x465023558fee3d81c034ffd5e07d0baaf2257cd1e8b231c68e0c9ac170ed10fa::qanda {
    ...
    public entry fun question(arg0: &mut 0x465023558fee3d81c034ffd5e07d0baaf2257cd1e8b231c68e0c9ac170ed10fa::community::Community, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Qanda{
            ...
            owner           : 0x465023558fee3d81c034ffd5e07d0baaf2257cd1e8b231c68e0c9ac170ed10fa::community::get_address_admin(),
        ...
        0x465023558fee3d81c034ffd5e07d0baaf2257cd1e8b231c68e0c9ac170ed10fa::community::update_qandas(arg0, arg3);
        0x2::transfer::share_object<Qanda>(v0);
    }

    public entry fun question_by_admin(arg0: &mut 0x465023558fee3d81c034ffd5e07d0baaf2257cd1e8b231c68e0c9ac170ed10fa::community::Community, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = Qanda{
    ...
    public entry fun reply_qanda(arg0: &mut 0x465023558fee3d81c034ffd5e07d0baaf2257cd1e8b231c68e0c9ac170ed10fa::community::Community, arg1: &mut Qanda, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
