module 0x46d20e8189161a085dd20c9fee9798a0e74b6d7f5a80cc01e50736ca1abcb3cd::reward8448 {
    struct REWARD8448 has drop {
        dummy_field: bool,
    }

    struct TICKET_8448 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8448(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8448>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8448>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8448, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8448>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8448>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8448>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8448>>(v5, 0x2::tx_context::sender(arg1));
    }
