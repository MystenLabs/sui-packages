module 0x464e68ac086000d47da4809153a6d8776e0552b1ee6276204fdca6d295815d6f::dogeaaa {
    ...
    fun init(arg0: DOGEAAA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/7RDNpDeeeiztCjMXTZSCtjcrPF8JjRTgtBZdHxB8ZoEB.png                                                                                                                                                                                                                               ");
