module 0x460f2ed6cee6dc4fa91442765fc6b9c2b8db5aa1b70bb7866931e350ac0a488e::reward9323 {
    struct REWARD9323 has drop {
        dummy_field: bool,
    }

    struct TICKET_9323 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9323(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9323>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9323>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9323, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9323>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9323>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9323>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9323>>(v5, 0x2::tx_context::sender(arg1));
    }
