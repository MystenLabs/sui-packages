module 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::rewarder {
    ...
    public(friend) fun calculate_reward_emission(arg0: &mut RewarderManager, arg1: &0x2::clock::Clock) : vector<u128> {
        ...
        while (v0 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            ...
            let v5 = if (v4.emission_per_ms > 0 && v3 > v2) {
                0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::mul_u128(v4.emission_per_ms, ((v3 - v2) as u128))
            } else {
                0
            };
    ...
    public fun deposit_reward<T0>(arg0: &0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) {
    ...
    public fun emergent_withdraw<T0>(arg0: &0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::config::checked_package_version(arg0);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg3), 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::config::get_reward_receiver(arg0));
    ...
    public fun get_reward_emission<T0>(arg0: &RewarderManager, arg1: &0x2::clock::Clock) : u128 {
        ...
        if (v1 > 0 && v2 > v3) {
            return 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::mul_u128(v1, ((v2 - v3) as u128))
        };
        0
    }
    ...
    public fun simulate_reward_emission(arg0: &RewarderManager, arg1: &0x2::clock::Clock) : vector<u128> {
        ...
        while (v0 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            ...
            let v4 = if (v3.emission_per_ms > 0 && v2 > arg0.last_update_timestamp) {
                0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::mul_u128(v3.emission_per_ms, ((v2 - arg0.last_update_timestamp) as u128))
            } else {
                0
            };
