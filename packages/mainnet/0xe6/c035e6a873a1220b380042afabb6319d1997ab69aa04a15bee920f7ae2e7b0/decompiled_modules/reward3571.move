module 0xe6c035e6a873a1220b380042afabb6319d1997ab69aa04a15bee920f7ae2e7b0::reward3571 {
    struct REWARD3571 has drop {
        dummy_field: bool,
    }

    struct TICKET_3571 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3571(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3571>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3571>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3571, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3571>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3571>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3571>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3571>>(v5, 0x2::tx_context::sender(arg1));
    }
