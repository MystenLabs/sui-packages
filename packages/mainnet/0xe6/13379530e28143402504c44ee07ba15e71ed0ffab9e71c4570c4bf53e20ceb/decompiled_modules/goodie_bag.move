module 0xe613379530e28143402504c44ee07ba15e71ed0ffab9e71c4570c4bf53e20ceb::goodie_bag {
    ...
    public fun get_random_goodie(arg0: &mut GoodieBagList, arg1: &0xe613379530e28143402504c44ee07ba15e71ed0ffab9e71c4570c4bf53e20ceb::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0xe613379530e28143402504c44ee07ba15e71ed0ffab9e71c4570c4bf53e20ceb::version::checkVersion(arg1, 3);
        ...
        let v1 = if (v0 == 1) {
            ...
            0xe613379530e28143402504c44ee07ba15e71ed0ffab9e71c4570c4bf53e20ceb::rand::rng(0, v0, arg2) % v0
        };
        let v2 = RandomIndex{
    ...
    public fun mint_participation_token(arg0: address, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut PopList, arg5: &GoodieBagList, arg6: &0xe613379530e28143402504c44ee07ba15e71ed0ffab9e71c4570c4bf53e20ceb::version::Version, arg7: &mut 0x2::tx_context::TxContext) {
