module 0xe600e9a159f458a424935d851f9d2ace6dfe67dfbea91c733269c33b7d94b7dc::drawp {
    struct DRAWP has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DRAWP, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DRAWP>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"drawp"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"drawp "));
