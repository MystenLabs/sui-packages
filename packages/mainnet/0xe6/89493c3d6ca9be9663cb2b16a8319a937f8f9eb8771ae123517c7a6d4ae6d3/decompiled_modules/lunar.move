module 0xe689493c3d6ca9be9663cb2b16a8319a937f8f9eb8771ae123517c7a6d4ae6d3::lunar {
    ...
    fun init(arg0: LUNAR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/6sMNgCUeiR4RYfoaRS8FQoLCTNReGazTig4hfcjcpump.png?size=lg&key=8d634f                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<LUNAR>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"LUNAR   ")))), trim_right(b"MOON AURA                       "), trim_right(b"Moon Aura is built around the idea that consistency outshines intensity. Its not about overwhelming energy  its about steady presence.                                                                                                                                                                                          "), v2, arg1);
        let v5 = v3;
