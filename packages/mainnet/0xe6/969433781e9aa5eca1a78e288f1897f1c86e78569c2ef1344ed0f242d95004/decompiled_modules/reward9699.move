module 0xe6969433781e9aa5eca1a78e288f1897f1c86e78569c2ef1344ed0f242d95004::reward9699 {
    struct REWARD9699 has drop {
        dummy_field: bool,
    }

    struct TICKET_9699 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9699(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9699>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9699>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9699, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9699>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9699>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9699>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9699>>(v5, 0x2::tx_context::sender(arg1));
    }
