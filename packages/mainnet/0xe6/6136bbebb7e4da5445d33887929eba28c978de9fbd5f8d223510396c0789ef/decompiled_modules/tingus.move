module 0xe66136bbebb7e4da5445d33887929eba28c978de9fbd5f8d223510396c0789ef::tingus {
    ...
    fun init(arg0: TINGUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<TINGUS>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<TINGUS>>(v4);
    }
