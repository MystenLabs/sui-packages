module 0xd3f2fa865c3d692066e87f12291a7e2fbd3281747d4325ef044250a9da629e85::mosh_v2 {
    ...
    struct CampaignRequestKey has copy, drop, store {
        request_key: vector<u8>,
    }

    struct CampaignRequestReceipt has copy, drop, store {
        payload_hash: vector<u8>,
        campaign_id: u64,
    }

    struct VoucherIssueRequestKey has copy, drop, store {
        campaign_id: u64,
        batch_index: u64,
    }

    struct VoucherIssueRequestReceipt has copy, drop, store {
        payload_hash: vector<u8>,
        issued: u64,
    }
    ...
    public fun activate_rotation_batch(arg0: &0xd3f2fa865c3d692066e87f12291a7e2fbd3281747d4325ef044250a9da629e85::spunks::AdminCap, arg1: &mut RerollPoolV2, arg2: u64, arg3: u64, arg4: u64) {
        assert_admin(arg0, arg1);
        ...
        assert!(0x2::table::borrow<u64, RotationRecord>(&arg1.rotations, arg2).status == 1, 7);
        assert!(arg4 > 0 && arg4 <= 20, 4);
        assert!(arg3 < arg1.staging_expected, 4);
        let v0 = if (arg4 > arg1.staging_expected - arg3) {
            arg1.staging_expected
        } else {
            arg3 + arg4
        };
        while (arg3 < v0) {
            if (0x2::table::contains<u64, PoolPieceV2>(&arg1.staging_registry, arg3)) {
                let v1 = 0x2::table::remove<u64, PoolPieceV2>(&mut arg1.staging_registry, arg3);
                ...
                assert!(!0x2::table::contains<u64, PoolPieceV2>(&arg1.active_registry, arg3), 31);
                0x2::table::add<u64, PoolPieceV2>(&mut arg1.active_registry, arg3, v1);
                arg1.staging_seeded = arg1.staging_seeded - 1;
            } else {
                assert!(0x2::table::contains<u64, PoolPieceV2>(&arg1.active_registry, arg3), 7);
            };
            arg3 = arg3 + 1;
        };
    }
    ...
    public fun active_selection_count(arg0: &RerollPoolV2) : u64 {
        0x2::table::length<u64, PoolPieceV2>(&arg0.active_registry)
    }
    ...
    public fun archive_active_rotation_batch(arg0: &0xd3f2fa865c3d692066e87f12291a7e2fbd3281747d4325ef044250a9da629e85::spunks::AdminCap, arg1: &mut RerollPoolV2, arg2: u64, arg3: u64, arg4: u64) {
        assert_admin(arg0, arg1);
        assert_not_deprecated(arg1);
        assert!(arg1.staging_rotation_id == arg2, 7);
        assert!(0x2::table::contains<u64, RotationRecord>(&arg1.rotations, arg2), 7);
        ...
        while (arg3 < v0) {
            let v1 = if (0x2::table::contains<u64, u64>(&arg1.shuffle, arg3)) {
                *0x2::table::borrow<u64, u64>(&arg1.shuffle, arg3)
            } else {
                arg3
            };
            if (0x2::table::contains<u64, PoolPieceV2>(&arg1.active_registry, v1)) {
                0x2::table::remove<u64, PoolPieceV2>(&mut arg1.active_registry, v1);
            };
            arg3 = arg3 + 1;
        };
    }
    ...
    public fun campaign_minted(arg0: &VoucherCampaign) : u64 {
        arg0.minted
    }
    ...
    public fun cancel_rotation(arg0: &0xd3f2fa865c3d692066e87f12291a7e2fbd3281747d4325ef044250a9da629e85::spunks::AdminCap, arg1: &mut RerollPoolV2, arg2: u64) {
        assert!(arg1.staging_expected <= 20, 7);
        let v0 = arg1.staging_expected;
        cancel_rotation_batch(arg0, arg1, arg2, 0, v0);
        finalize_rotation_cancellation(arg0, arg1, arg2);
    }

    public fun cancel_rotation_batch(arg0: &0xd3f2fa865c3d692066e87f12291a7e2fbd3281747d4325ef044250a9da629e85::spunks::AdminCap, arg1: &mut RerollPoolV2, arg2: u64, arg3: u64, arg4: u64) {
        assert_admin(arg0, arg1);
        assert!(arg1.staging_rotation_id == arg2, 7);
        assert!(arg1.active_rotation_id != 0, 7);
        assert!(0x2::table::length<u64, PoolPieceV2>(&arg1.active_registry) == arg1.remaining, 7);
        assert!(arg4 > 0 && arg4 <= 20, 4);
        assert!(arg3 < arg1.staging_expected, 4);
        let v0 = if (arg4 > arg1.staging_expected - arg3) {
            arg1.staging_expected
    ...
    public fun create_campaign_idempotent(arg0: &0xd3f2fa865c3d692066e87f12291a7e2fbd3281747d4325ef044250a9da629e85::spunks::AdminCap, arg1: &mut RerollPoolV2, arg2: vector<u8>, arg3: vector<u8>, arg4: u8, arg5: u64, arg6: u64, arg7: u64, arg8: vector<u16>, arg9: vector<u8>, arg10: vector<vector<u8>>, arg11: vector<vector<u8>>, arg12: vector<u64>, arg13: vector<0x2::object::ID>, arg14: &0x2::clock::Clock) : u64 {
        assert_hash(&arg2);
        assert_hash(&arg3);
        let v0 = CampaignRequestKey{request_key: arg2};
        if (0x2::dynamic_field::exists<CampaignRequestKey>(&arg1.id, v0)) {
            let v1 = 0x2::dynamic_field::borrow<CampaignRequestKey, CampaignRequestReceipt>(&arg1.id, v0);
            assert!(v1.payload_hash == arg3, 16);
            return v1.campaign_id
        };
        let v2 = create_campaign(arg0, arg1, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14);
        let v3 = CampaignRequestReceipt{
            payload_hash : arg3,
            campaign_id  : v2,
        };
        0x2::dynamic_field::add<CampaignRequestKey, CampaignRequestReceipt>(&mut arg1.id, v0, v3);
        v2
    }
    ...
    public fun finalize_active_rotation_archive(arg0: &0xd3f2fa865c3d692066e87f12291a7e2fbd3281747d4325ef044250a9da629e85::spunks::AdminCap, arg1: &mut RerollPoolV2, arg2: u64) {
        assert_admin(arg0, arg1);
        assert_not_deprecated(arg1);
        assert!(arg1.staging_rotation_id == arg2, 7);
        assert!(0x2::table::contains<u64, RotationRecord>(&arg1.rotations, arg2), 7);
        ...
        assert!(0x2::table::length<u64, PoolPieceV2>(&arg1.active_registry) == 0, 8);
        let v0 = 0;
        while (v0 < arg1.remaining) {
            if (0x2::table::contains<u64, u64>(&arg1.shuffle, v0)) {
                0x2::table::remove<u64, u64>(&mut arg1.shuffle, v0);
            };
            v0 = v0 + 1;
        };
        0x2::table::borrow_mut<u64, RotationRecord>(&mut arg1.rotations, arg1.active_rotation_id).status = 3;
        arg1.active_rotation_id = 0;
    }

    public fun finalize_rotation_activation(arg0: &0xd3f2fa865c3d692066e87f12291a7e2fbd3281747d4325ef044250a9da629e85::spunks::AdminCap, arg1: &mut RerollPoolV2, arg2: u64, arg3: &0x2::clock::Clock) {
        assert_admin(arg0, arg1);
        assert_not_deprecated(arg1);
        let v0 = if (arg1.active_rotation_id == arg2) {
            if (0x2::table::contains<u64, RotationRecord>(&arg1.rotations, arg2)) {
        ...
        assert!(0x2::table::contains<u64, RotationRecord>(&arg1.rotations, arg2), 7);
        assert!(0x2::table::borrow<u64, RotationRecord>(&arg1.rotations, arg2).status == 1, 7);
        assert!(arg1.staging_seeded == 0, 8);
        assert!(0x2::table::length<u64, PoolPieceV2>(&arg1.staging_registry) == 0, 8);
        assert!(0x2::table::length<u64, bool>(&arg1.staging_sources) == 0, 8);
        assert!(0x2::table::length<vector<u8>, bool>(&arg1.staging_metadata) == 0, 8);
        assert!(0x2::table::length<vector<u8>, bool>(&arg1.staging_art) == 0, 8);
        assert!(0x2::table::length<u64, PoolPieceV2>(&arg1.active_registry) == arg1.remaining, 8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        let v2 = 0x2::table::borrow_mut<u64, RotationRecord>(&mut arg1.rotations, arg2);
        v2.status = 2;
        v2.activated_at_ms = v1;
        arg1.active_rotation_id = arg2;
        arg1.staging_rotation_id = 0;
        arg1.staging_expected = 0;
        arg1.next_rotation_after_ms = v1 + 604800000;
        if (arg1.resume_open_after_rotation) {
            arg1.is_open = true;
        };
        arg1.resume_open_after_rotation = false;
        let v3 = PoolRotationV2Activated{
            pool_id         : 0x2::object::id<RerollPoolV2>(arg1),
            season          : arg1.season,
            rotation_id     : arg2,
            remaining       : arg1.remaining,
        ...
        0x2::event::emit<PoolRotationV2Activated>(v3);
    }

    public fun finalize_rotation_cancellation(arg0: &0xd3f2fa865c3d692066e87f12291a7e2fbd3281747d4325ef044250a9da629e85::spunks::AdminCap, arg1: &mut RerollPoolV2, arg2: u64) {
        assert_admin(arg0, arg1);
        let v0 = if (arg1.staging_rotation_id == 0) {
            if (0x2::table::contains<u64, RotationRecord>(&arg1.rotations, arg2)) {
                0x2::table::borrow<u64, RotationRecord>(&arg1.rotations, arg2).status == 4
            } else {
                false
            }
        } else {
    ...
    public fun issue_vouchers_batch_idempotent(arg0: &0xd3f2fa865c3d692066e87f12291a7e2fbd3281747d4325ef044250a9da629e85::spunks::AdminCap, arg1: &mut RerollPoolV2, arg2: u64, arg3: u64, arg4: vector<address>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = VoucherIssueRequestKey{
            campaign_id : arg2,
            batch_index : arg3,
        };
        let v1 = 0x1::bcs::to_bytes<vector<address>>(&arg4);
        if (0x2::dynamic_field::exists<VoucherIssueRequestKey>(&arg1.id, v0)) {
            assert!(0x2::dynamic_field::borrow<VoucherIssueRequestKey, VoucherIssueRequestReceipt>(&arg1.id, v0).payload_hash == 0x2::hash::blake2b256(&v1), 16);
            return
        };
        issue_vouchers_batch(arg0, arg1, arg2, arg4, arg5, arg6);
        let v2 = VoucherIssueRequestReceipt{
            payload_hash : 0x2::hash::blake2b256(&v1),
            issued       : 0x1::vector::length<address>(&arg4),
        };
        0x2::dynamic_field::add<VoucherIssueRequestKey, VoucherIssueRequestReceipt>(&mut arg1.id, v0, v2);
    }
    ...
    public fun shuffle_count(arg0: &RerollPoolV2) : u64 {
        0x2::table::length<u64, u64>(&arg0.shuffle)
    }

    public fun staging_expected(arg0: &RerollPoolV2) : u64 {
        arg0.staging_expected
    }
    ...
    public fun staging_selection_count(arg0: &RerollPoolV2) : u64 {
        0x2::table::length<u64, PoolPieceV2>(&arg0.staging_registry)
    }
