module 0xe68d36be913c669093c0daab8a51e7ae6e16bdbea8fb68af1af532826d9f43c6::cnsnft2196 {
    struct CNSNFT2196 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2196, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2196>(arg0, arg1);
