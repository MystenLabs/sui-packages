module 0xe691aeb328ba898b3374ed75fdffd3306619ad71bab29aa303b0227bf2bb0708::sq {
    ...
    public fun ci(arg0: &mut SQR, arg1: u64, arg2: bool) : u64 {
        if (arg1 <= arg0.ci) {
            assert!(arg2, 200);
            return 200
        };
    ...
    public fun cit(arg0: &mut SQR, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: bool, arg5: &0x2::tx_context::TxContext) : u64 {
        vaw(arg0, arg5);
        let v0 = ci(arg0, arg2, arg4);
        if (v0 != 0) {
            return v0
        };
        let v1 = ct(arg1, arg3, arg4);
    ...
    public fun ii(arg0: &mut SQR, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        vaw(arg0, arg2);
        arg0.ci = arg1;
    }
    ...
    fun vaw(arg0: &SQR, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::contains<address>(&arg0.allowed, &v0), 202);
    }
