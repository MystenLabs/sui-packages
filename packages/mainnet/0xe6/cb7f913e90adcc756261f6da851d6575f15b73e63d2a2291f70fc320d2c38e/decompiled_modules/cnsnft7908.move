module 0xe6cb7f913e90adcc756261f6da851d6575f15b73e63d2a2291f70fc320d2c38e::cnsnft7908 {
    struct CNSNFT7908 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7908, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7908>(arg0, arg1);
