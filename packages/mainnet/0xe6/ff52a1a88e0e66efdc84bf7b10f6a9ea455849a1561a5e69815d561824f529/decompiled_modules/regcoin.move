module 0xe6ff52a1a88e0e66efdc84bf7b10f6a9ea455849a1561a5e69815d561824f529::regcoin {
    ...
    fun init(arg0: REGCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<REGCOIN>(arg0, 6, b"turb", b"turb coin", b"elooo", 0x1::option::none<0x2::url::Url>(), false, arg1);
