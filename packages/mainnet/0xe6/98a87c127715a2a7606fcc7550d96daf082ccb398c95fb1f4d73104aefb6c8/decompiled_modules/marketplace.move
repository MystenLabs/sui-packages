module 0xe698a87c127715a2a7606fcc7550d96daf082ccb398c95fb1f4d73104aefb6c8::marketplace {
    ...
    public entry fun deposit_nft_to_admin<T0: store + key>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<T0>(arg0, @0x8cfed3962605beacf459a4bab2830a7c8e95bab8e60c228e65b2837565bd5fb8);
        let v0 = NFTDeposited{
            nft_id : 0x2::object::id<T0>(&arg0),
            seller : 0x2::tx_context::sender(arg1),
            admin  : @0x8cfed3962605beacf459a4bab2830a7c8e95bab8e60c228e65b2837565bd5fb8,
        };
        0x2::event::emit<NFTDeposited>(v0);
    }
    ...
    public entry fun end_auction<T0: store + key>(arg0: &mut Auction, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.highest_bidder != @0x0) {
            let v0 = arg0.current_bid * 75 / 1000;
    ...
    public entry fun list_nft<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk::has_access(arg0, arg1), 5);
    ...
    public entry fun place_nft<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::kiosk::has_access(arg0, arg1), 5);
