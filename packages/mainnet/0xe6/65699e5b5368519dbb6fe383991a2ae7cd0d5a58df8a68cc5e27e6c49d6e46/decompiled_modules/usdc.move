module 0xe665699e5b5368519dbb6fe383991a2ae7cd0d5a58df8a68cc5e27e6c49d6e46::usdc {
    struct USDC has drop {
        dummy_field: bool,
    }

    fun init(arg0: USDC, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0xbd4c85cadfe1b0ff08ee8f32a2f9bafc3936c0e2e4f70ac3c8efb76a060bccbb::upgrade_service::new<USDC>(arg0, 0x2::tx_context::sender(arg1), arg1);
        ...
        0x2::transfer::public_share_object<0x3c14bf12288b9705924ec84a914a66faa27ec1057604e47f7ce99a55236577a0::treasury::Treasury<USDC>>(0x3c14bf12288b9705924ec84a914a66faa27ec1057604e47f7ce99a55236577a0::treasury::new<USDC>(v2, v3, 0x2::tx_context::sender(arg1), 0x2::tx_context::sender(arg1), 0x2::tx_context::sender(arg1), 0x2::tx_context::sender(arg1), 0x2::tx_context::sender(arg1), arg1));
        0x2::transfer::public_share_object<0xbd4c85cadfe1b0ff08ee8f32a2f9bafc3936c0e2e4f70ac3c8efb76a060bccbb::upgrade_service::UpgradeService<USDC>>(v0);
    }
