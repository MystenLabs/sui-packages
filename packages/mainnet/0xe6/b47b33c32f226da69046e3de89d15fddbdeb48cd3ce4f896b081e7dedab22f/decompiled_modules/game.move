module 0xe6b47b33c32f226da69046e3de89d15fddbdeb48cd3ce4f896b081e7dedab22f::game {
    ...
    entry fun create_game(arg0: vector<u8>, arg1: vector<u8>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<0x1::string::String, vector<0x1::string::String>>(&mut v1, 0x1::string::utf8(b"kborrt"), v4);
        let v6 = Game{
