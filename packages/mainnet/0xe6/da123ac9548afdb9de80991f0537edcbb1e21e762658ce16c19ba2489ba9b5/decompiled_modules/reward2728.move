module 0xe6da123ac9548afdb9de80991f0537edcbb1e21e762658ce16c19ba2489ba9b5::reward2728 {
    struct REWARD2728 has drop {
        dummy_field: bool,
    }

    struct TICKET_2728 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2728(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2728>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2728>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2728, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2728>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2728>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2728>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2728>>(v5, 0x2::tx_context::sender(arg1));
    }
