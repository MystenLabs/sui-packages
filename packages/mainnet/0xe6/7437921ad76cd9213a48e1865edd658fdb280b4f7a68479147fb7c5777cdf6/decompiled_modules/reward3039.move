module 0xe67437921ad76cd9213a48e1865edd658fdb280b4f7a68479147fb7c5777cdf6::reward3039 {
    struct REWARD3039 has drop {
        dummy_field: bool,
    }

    struct TICKET_3039 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3039(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3039>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3039>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3039, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3039>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3039>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3039>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3039>>(v5, 0x2::tx_context::sender(arg1));
    }
