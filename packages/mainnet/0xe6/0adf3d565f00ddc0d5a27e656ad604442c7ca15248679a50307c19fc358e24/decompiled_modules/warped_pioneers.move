module 0xe60adf3d565f00ddc0d5a27e656ad604442c7ca15248679a50307c19fc358e24::warped_pioneers {
    struct WARPED_PIONEERS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WARPED_PIONEERS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WARPED_PIONEERS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Warped Pioneers"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The first explorers to step through the portal and venture into the Warped Universe. First to arrive, first to survive."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeif3ztmko2peomxvx5egb4wf6iffjz4i6qbhor4hbun26leozqpnyy"));
