module 0xe660e1f9a29483fce4a4b0946921cca0f7fb8cd572e404434a46b87a63b5d919::reward6062 {
    struct REWARD6062 has drop {
        dummy_field: bool,
    }

    struct TICKET_6062 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6062(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6062>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6062>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6062, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6062>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6062>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6062>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6062>>(v5, 0x2::tx_context::sender(arg1));
    }
