module 0xe6db9f870fdfcf3a033029d16ff14136f95d159439775e8a40a95ae046ce52a6::popeye_kids_ {
    struct POPEYE_KIDS_ has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"ae94a8a9-8583-4538-a4d8-4b20a797f674"),
        };
    ...
    fun init(arg0: POPEYE_KIDS_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<POPEYE_KIDS_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Popeye kids!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"As refreshing as the wind,yet as powerful as an engine! I will draw the gestures of such children."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmWGkdLCgDzjeiTuhAeTS314fanDox6SRHQiSvSPK8w52j"));
