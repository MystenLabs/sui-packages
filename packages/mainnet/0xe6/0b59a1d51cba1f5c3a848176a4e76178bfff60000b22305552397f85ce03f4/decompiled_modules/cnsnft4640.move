module 0xe60b59a1d51cba1f5c3a848176a4e76178bfff60000b22305552397f85ce03f4::cnsnft4640 {
    struct CNSNFT4640 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4640, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4640>(arg0, arg1);
