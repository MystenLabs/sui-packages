module 0xe61d1449933a2d9e95c7ff91fba936a409f2e068afdde609fd6b690efa52343a::cnsnft9815 {
    struct CNSNFT9815 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9815, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9815>(arg0, arg1);
