module 0xe624c6d653f4061d1fc1ea14b3e18108b197e32d5d020e21691b79354ce16421::reward8666 {
    struct REWARD8666 has drop {
        dummy_field: bool,
    }

    struct TICKET_8666 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8666(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8666>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8666>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8666, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8666>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8666>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8666>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8666>>(v5, 0x2::tx_context::sender(arg1));
    }
