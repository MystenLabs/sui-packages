module 0xe6b041109d263a2154aa3bbc942e7cb5545d0b46907b801d3e34e27d9229d3f1::reward2631 {
    struct REWARD2631 has drop {
        dummy_field: bool,
    }

    struct TICKET_2631 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2631(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2631>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2631>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2631, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2631>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2631>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2631>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2631>>(v5, 0x2::tx_context::sender(arg1));
    }
