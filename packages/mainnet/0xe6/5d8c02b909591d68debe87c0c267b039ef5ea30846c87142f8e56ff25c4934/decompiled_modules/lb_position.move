module 0x4ab53fcc80fbdd51fc4c669db196b6f5c6acccedc138fb41e618a05a9e244523::lb_position {
    ...
    public(friend) fun close_position(arg0: &mut LBPositionManager, arg1: LBPosition) {
        ...
        assert!(v0, 203);
        destroy_position_info(0x2::table::remove<0x2::object::ID, LBPositionInfo>(&mut arg0.positions, 0x2::object::id<LBPosition>(&arg1)));
        destroy(arg1);
    }
    ...
    public(friend) fun decrease_position_total_bins(arg0: &mut LBPosition, arg1: u64) {
        arg0.total_bins = 0x4ab53fcc80fbdd51fc4c669db196b6f5c6acccedc138fb41e618a05a9e244523::safe_math::sub_u64(arg0.total_bins, arg1);
    }
