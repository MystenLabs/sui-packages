module 0x4ab53fcc80fbdd51fc4c669db196b6f5c6acccedc138fb41e618a05a9e244523::rewarder {
    ...
    public fun calc_reward_emission(arg0: &RewarderManager, arg1: &0x2::clock::Clock) : vector<u128> {
        ...
        while (v0 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            ...
            let v4 = if (v3.emission_per_ms > 0 && v2 > arg0.last_update_timestamp) {
                0x4ab53fcc80fbdd51fc4c669db196b6f5c6acccedc138fb41e618a05a9e244523::safe_math::mul_u128(v3.emission_per_ms, (0x4ab53fcc80fbdd51fc4c669db196b6f5c6acccedc138fb41e618a05a9e244523::safe_math::sub_u64(v2, arg0.last_update_timestamp) as u128))
            } else {
                0
            };
    ...
    public fun deposit_reward<T0>(arg0: &0x4ab53fcc80fbdd51fc4c669db196b6f5c6acccedc138fb41e618a05a9e244523::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) {
    ...
    public fun emergent_withdraw<T0>(arg0: &0x4ab53fcc80fbdd51fc4c669db196b6f5c6acccedc138fb41e618a05a9e244523::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x4ab53fcc80fbdd51fc4c669db196b6f5c6acccedc138fb41e618a05a9e244523::config::checked_package_version(arg0);
        0x4ab53fcc80fbdd51fc4c669db196b6f5c6acccedc138fb41e618a05a9e244523::config::check_reward_role(arg0, 0x2::tx_context::sender(arg3));
        let v0 = withdraw_reward<T0>(arg1, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg3), 0x4ab53fcc80fbdd51fc4c669db196b6f5c6acccedc138fb41e618a05a9e244523::config::get_reward_receiver(arg0));
    ...
    public(friend) fun get_reward_emission<T0>(arg0: &RewarderManager, arg1: &0x2::clock::Clock) : u128 {
        ...
        if (v0 > 0 && v1 > v2) {
            0x4ab53fcc80fbdd51fc4c669db196b6f5c6acccedc138fb41e618a05a9e244523::safe_math::mul_u128(v0, (0x4ab53fcc80fbdd51fc4c669db196b6f5c6acccedc138fb41e618a05a9e244523::safe_math::sub_u64(v1, v2) as u128))
        } else {
            0
        }
    }
