module 0xe689c647b35421566d26c04f3823ae018ad492eb369e47f30f842031cc8a7664::big_vector {
    ...
    fun leaf_insert<T0: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u128, arg3: T0) : (u128, u64) {
        ...
        let v3 = Slice<T0>{
            prev : arg1,
            next : v0.next,
            keys : 0xe689c647b35421566d26c04f3823ae018ad492eb369e47f30f842031cc8a7664::utils::pop_until<u128>(&mut v0.keys, v2),
            vals : 0xe689c647b35421566d26c04f3823ae018ad492eb369e47f30f842031cc8a7664::utils::pop_until<T0>(&mut v0.vals, v2),
        };
    ...
    fun node_insert<T0: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u8, arg3: u128, arg4: T0) : (u128, u64) {
        ...
        let v6 = Slice<u64>{
            prev : arg1,
            next : v4.next,
            keys : 0xe689c647b35421566d26c04f3823ae018ad492eb369e47f30f842031cc8a7664::utils::pop_until<u128>(&mut v4.keys, v5),
            vals : 0xe689c647b35421566d26c04f3823ae018ad492eb369e47f30f842031cc8a7664::utils::pop_until<u64>(&mut v4.vals, v5),
        };
    ...
    fun slice_redistribute<T0: store, T1: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u128, arg3: u64) : u128 {
        ...
        let (v7, v20) = if (v19) {
            let v21 = 0xe689c647b35421566d26c04f3823ae018ad492eb369e47f30f842031cc8a7664::utils::pop_until<T1>(&mut v7, v17);
            0x1::vector::append<T1>(&mut v21, v13);
            (v7, v21)
        } else {
            0x1::vector::append<T1>(&mut v7, v13);
            (v7, 0xe689c647b35421566d26c04f3823ae018ad492eb369e47f30f842031cc8a7664::utils::pop_n<T1>(&mut v13, v18))
        };
        let (v8, v22, v23) = if (v2 && v19) {
            let v24 = 0xe689c647b35421566d26c04f3823ae018ad492eb369e47f30f842031cc8a7664::utils::pop_until<u128>(&mut v8, v17);
            0x1::vector::append<u128>(&mut v24, v11);
            (v8, *0x1::vector::borrow<u128>(&v24, 0), v24)
        } else {
            let (v25, v26, v8) = if (v2 && !v19) {
                let v27 = v11;
                let v28 = 0xe689c647b35421566d26c04f3823ae018ad492eb369e47f30f842031cc8a7664::utils::pop_n<u128>(&mut v27, v18);
                0x1::vector::append<u128>(&mut v8, v27);
                (*0x1::vector::borrow<u128>(&v28, 0), v28, v8)
            } else {
                let (v8, v29, v30) = if (!v2 && v19) {
                    let v31 = 0xe689c647b35421566d26c04f3823ae018ad492eb369e47f30f842031cc8a7664::utils::pop_until<u128>(&mut v8, v17);
                    ...
                    (v8, 0x1::vector::pop_back<u128>(&mut v32), 0xe689c647b35421566d26c04f3823ae018ad492eb369e47f30f842031cc8a7664::utils::pop_n<u128>(&mut v32, v18 - 1))
                };
                (v29, v30, v8)
            };
            (v8, v25, v26)
