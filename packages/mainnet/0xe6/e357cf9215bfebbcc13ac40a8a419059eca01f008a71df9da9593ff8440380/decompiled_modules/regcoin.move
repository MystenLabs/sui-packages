module 0xe6e357cf9215bfebbcc13ac40a8a419059eca01f008a71df9da9593ff8440380::regcoin {
    ...
    fun init(arg0: REGCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::mint_and_transfer<REGCOIN>(&mut v3, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
