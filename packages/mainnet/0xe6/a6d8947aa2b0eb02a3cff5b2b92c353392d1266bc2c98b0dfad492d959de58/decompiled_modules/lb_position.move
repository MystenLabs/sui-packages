module 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::lb_position {
    ...
    fun clear_bit_in_bitmap(arg0: u8, arg1: u8) : u8 {
        (((arg0 as u64) & 18446744073709551615 - (1 << arg1)) as u8)
    }
    ...
    public(friend) fun collect_fees(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::add_u64(v1.collected_fees_x, ((0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::mul_u128(v2, 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::sub_u128(arg3, v1.fee_growth_inside_last_x)) >> 64) as u64)), 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::add_u64(v1.collected_fees_y, ((0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::mul_u128(v2, 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::sub_u128(arg4, v1.fee_growth_inside_last_y)) >> 64) as u64)))
    }
    ...
    fun count_active_bins(arg0: u8) : u8 {
        let v0 = (arg0 as u64);
        let v1 = v0 - (v0 >> 1 & 6148914691236517205);
        let v2 = (v1 & 3689348814741910323) + (v1 >> 2 & 3689348814741910323);
        let v3 = v2 + (v2 >> 4) & 1085102592571150095;
        let v4 = v3 + (v3 >> 8);
        let v5 = v4 + (v4 >> 16);
        ((v5 + (v5 >> 32) & 255) as u8)
    }
    ...
    fun count_active_bins_before_position(arg0: u8, arg1: u8) : u8 {
        ...
        count_active_bins((((arg0 as u64) & (1 << arg1) - 1) as u8))
    }
    ...
    public fun get_pending_fees(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::add_u64(v1.collected_fees_x, ((v2 * (arg3 - v1.fee_growth_inside_last_x) >> 64) as u64)), 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::add_u64(v1.collected_fees_y, ((v2 * (arg4 - v1.fee_growth_inside_last_y) >> 64) as u64)))
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 3) {
            ...
            v3 = 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }
    ...
    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128, arg5: u128) {
        ...
        if (contains_bin(v0, arg2)) {
            ...
            let v2 = v1.amount;
            if (v2 > 0) {
                v1.collected_fees_x = 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::add_u64(v1.collected_fees_x, 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::u128_to_u64(v2 * 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::sub_u128(arg4, v1.fee_growth_inside_last_x) >> 64));
                v1.collected_fees_y = 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::add_u64(v1.collected_fees_y, 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::u128_to_u64(v2 * 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::sub_u128(arg5, v1.fee_growth_inside_last_y) >> 64));
            };
            v1.amount = 0xe6a6d8947aa2b0eb02a3cff5b2b92c353392d1266bc2c98b0dfad492d959de58::safe_math::add_u128(v1.amount, arg3);
