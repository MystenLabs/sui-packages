module 0xe649354aa848a8ae43d52a2bf75301b3d67dd6654c8df525650c5afe86518dc5::voxx_book_pass {
    ...
    fun init(arg0: VOXX_BOOK_PASS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<VOXX_BOOK_PASS>(arg0, arg1);
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://NX9d82Xps_mxQLAQtG_e9gQIX-T5k5fWkpZIgiMAUOs"));
