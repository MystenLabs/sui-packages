module 0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::config {
    ...
    fun init(arg0: CONFIG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<u8, bool>(&mut v0, 0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::version::module_type_archive(), false);
        0x2::table::add<u8, bool>(&mut v0, 0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::version::module_type_checkin(), false);
        0x2::table::add<u8, bool>(&mut v0, 0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::version::module_type_mission(), false);
        0x2::table::add<u8, bool>(&mut v0, 0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::version::module_type_game(), false);
        let v1 = Config{
    ...
    public fun pause_trigger(arg0: &0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::manager::AdminCap, arg1: &mut Config, arg2: u8, arg3: bool) {
    ...
    public fun update_bird_energy(arg0: &0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::manager::AdminCap, arg1: &mut Config, arg2: u8, arg3: u64) {
    ...
    public fun update_bonus(arg0: &0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::manager::AdminCap, arg1: &mut Config, arg2: u8, arg3: u64) {
    ...
    public fun update_max_checkin_days(arg0: &0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::manager::AdminCap, arg1: &mut Config, arg2: u8) {
        arg1.max_checkin_days = arg2;
    }

    public fun update_preying_time(arg0: &0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::manager::AdminCap, arg1: &mut Config, arg2: u64) {
        arg1.preying_time = arg2;
    }

    public fun update_time_lock_withdrawal(arg0: &0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::manager::AdminCap, arg1: &mut Config, arg2: u64) {
        arg1.time_lock_withdrawal = arg2;
    }

    public fun update_validator(arg0: &0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::manager::AdminCap, arg1: vector<u8>, arg2: &mut Config) {
        assert!(0x1::vector::length<u8>(&arg1) == 32, 1007);
        0x1::option::swap_or_fill<vector<u8>>(&mut arg2.validator, arg1);
    }

    public fun update_worm_energy(arg0: &0xe637c0d19def5f6fffebea2131f1413175c25d95aa6de3fa130b25db2b882091::manager::AdminCap, arg1: &mut Config, arg2: u16, arg3: u64) {
