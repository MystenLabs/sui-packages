module 0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::bot {
    ...
    struct ArbitrageBot has key {
        ...
        min_trade_size: u64,
        max_trade_size: u64,
        total_profit_usdc: 0x2::balance::Balance<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>,
        total_profit_wusdc: 0x2::balance::Balance<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>,
        trading_balance_usdc: 0x2::balance::Balance<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>,
        trading_balance_wusdc: 0x2::balance::Balance<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>,
        active: bool,
    ...
    public fun create_new_bot(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = ArbitrageBot{
            ...
            total_profit_usdc     : 0x2::balance::zero<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>(),
            total_profit_wusdc    : 0x2::balance::zero<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>(),
            trading_balance_usdc  : 0x2::balance::zero<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>(),
            trading_balance_wusdc : 0x2::balance::zero<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>(),
            active                : true,
    ...
    public entry fun deposit_usdc(arg0: &mut ArbitrageBot, arg1: 0x2::coin::Coin<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>(&arg1);
        assert!(v0 >= 1000000, 5);
        0x2::balance::join<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>(&mut arg0.trading_balance_usdc, 0x2::coin::into_balance<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>(arg1));
    ...
    public entry fun deposit_wusdc(arg0: &mut ArbitrageBot, arg1: 0x2::coin::Coin<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>(&arg1);
        assert!(v0 >= 1000000, 5);
        0x2::balance::join<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>(&mut arg0.trading_balance_wusdc, 0x2::coin::into_balance<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>(arg1));
        let v1 = FundsDeposited{
            amount    : v0,
            is_usdc   : false,
            timestamp : 0x2::tx_context::epoch(arg2),
    ...
    public fun get_total_profit_usdc(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>(&arg0.total_profit_usdc)
    }

    public fun get_total_profit_wusdc(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>(&arg0.total_profit_wusdc)
    }

    public fun get_trading_balance_usdc(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>(&arg0.trading_balance_usdc)
    }

    public fun get_trading_balance_wusdc(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>(&arg0.trading_balance_wusdc)
    }
    ...
    public entry fun withdraw_profits(arg0: &mut ArbitrageBot, arg1: u64, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>>(0x2::coin::from_balance<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>(0x2::balance::split<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::usdc::USDC>(&mut arg0.total_profit_usdc, arg1), arg3), arg0.owner);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>>(0x2::coin::from_balance<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>(0x2::balance::split<0xb82435d2c5873544e5ea9582e95999d01b9558830e4353b3e93ff64b4073b3fb::coin::COIN>(&mut arg0.total_profit_wusdc, arg1), arg3), arg0.owner);
        };
    }
