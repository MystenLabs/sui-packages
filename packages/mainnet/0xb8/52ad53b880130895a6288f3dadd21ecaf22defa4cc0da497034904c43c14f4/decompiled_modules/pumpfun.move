module 0xb852ad53b880130895a6288f3dadd21ecaf22defa4cc0da497034904c43c14f4::pumpfun {
    ...
    fun init(arg0: PUMPFUN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PUMPFUN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"PumpFun"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"PumpFun Official NFT "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://ihAMJ7ggvwrSBG9-GsGEhhkd39-Ab3KVtXLLouX_x5E"));
