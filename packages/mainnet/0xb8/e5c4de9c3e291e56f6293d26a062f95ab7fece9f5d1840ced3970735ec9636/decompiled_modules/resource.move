module 0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::resource {
    ...
    struct Resource has key {
        id: 0x2::object::UID,
        table: 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::table::Table<address, Tags>,
    }

    public fun remove(arg0: &mut Resource, arg1: address, arg2: vector<0x1::string::String>) {
        if (0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::table::contains<address, Tags>(&arg0.id, &arg0.table, arg1)) {
            let v0 = 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::table::borrow_mut<address, Tags>(&mut arg0.id, &mut arg0.table, arg1);
            let v1 = 0;
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : Resource {
        ...
        Resource{
            id    : v0,
            table : 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::table::new<address, Tags>(&v1),
        }
    }
    ...
    public fun add(arg0: &mut Resource, arg1: address, arg2: 0x1::option::Option<0x1::string::String>, arg3: vector<0x1::string::String>) {
        ...
        if (0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::table::contains<address, Tags>(&arg0.id, &arg0.table, arg1)) {
            ...
            while (v2 < 0x1::vector::length<0x1::string::String>(&arg3)) {
                ...
                if (0x1::string::length(v3) <= 64) {
                    if (!0x1::vector::contains<0x1::string::String>(&v0.tags, v3)) {
                        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::resource::TAG_COUNT(0x1::vector::length<0x1::string::String>(&v0.tags));
            ...
            0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::resource::TAG_LEN(0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::table::length<address, Tags>(&arg0.table));
            let v4 = 0x1::string::utf8(b"");
            if (0x1::option::is_some<0x1::string::String>(&arg2)) {
                let v5 = 0x1::option::borrow<0x1::string::String>(&arg2);
                0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::ASSERT_NAMELEN(v5);
                v4 = *v5;
            };
            ...
            while (v7 < 0x1::vector::length<0x1::string::String>(&arg3)) {
                ...
                if (0x1::string::length(v8) <= 64) {
                    if (!0x1::vector::contains<0x1::string::String>(&v6, v8)) {
                        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::resource::TAG_COUNT(0x1::vector::length<0x1::string::String>(&v6));
            ...
            0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::table::add<address, Tags>(&mut arg0.id, &mut arg0.table, arg1, v9);
        };
    }
    ...
    public fun removeall(arg0: &mut Resource, arg1: address) {
        if (0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::table::contains<address, Tags>(&arg0.id, &arg0.table, arg1)) {
            0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::table::remove<address, Tags>(&mut arg0.id, &mut arg0.table, arg1);
        };
    }
    ...
    public(friend) fun switch(arg0: &mut Resource, arg1: &address, arg2: &0x1::string::String) : bool {
        if (0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::table::contains<address, Tags>(&arg0.id, &arg0.table, *arg1)) {
            ...
            0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::table::add<address, Tags>(&mut arg0.id, &mut arg0.table, *arg1, v3);
        };
        true
    }
