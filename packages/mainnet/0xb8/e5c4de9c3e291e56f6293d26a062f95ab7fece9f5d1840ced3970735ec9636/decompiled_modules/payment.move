module 0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::payment {
    ...
    fun create_imp<T0>(arg0: &vector<address>, arg1: &mut vector<0x2::coin::Coin<T0>>, arg2: &0x1::option::Option<address>, arg3: &0x1::option::Option<address>, arg4: u64, arg5: &0x1::string::String, arg6: &0x1::option::Option<address>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : address {
        ...
        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::payment::REC_COUNT(v0);
        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::payment::COUNTS_NOT_MATCH(v0 == 0x1::vector::length<0x2::coin::Coin<T0>>(arg1));
        let v2 = 0;
    ...
    public fun create_withGuard<T0>(arg0: vector<address>, arg1: vector<0x2::coin::Coin<T0>>, arg2: 0x1::option::Option<address>, arg3: &0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::guard::Guard, arg4: u64, arg5: 0x1::string::String, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : address {
        let v0 = &mut arg1;
        let v1 = 0x1::option::some<address>(0x2::object::id_address<0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::guard::Guard>(arg3));
        let v2 = 0x1::option::none<address>();
        0x1::vector::destroy_empty<0x2::coin::Coin<T0>>(arg1);
        create_imp<T0>(&arg0, v0, &arg2, &v1, arg4, &arg5, &v2, arg6, arg7)
    }

    public fun guard_query<T0>(arg0: &Payment<T0>, arg1: &mut 0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::Passport) {
        ...
        if (v2 == 1200) {
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<address>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_ADDRESS(), &arg0.signer);
        } else if (v2 == 1201) {
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<u128>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_U128(), &arg0.amount);
        } else if (v2 == 1202) {
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<0x1::string::String>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_STRING(), &arg0.remark);
        } else if (v2 == 1203) {
            ...
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<address>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_ADDRESS(), 0x1::option::borrow<address>(&arg0.for_guard));
        } else if (v2 == 1206) {
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<address>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_ADDRESS(), 0x1::option::borrow<address>(&arg0.for_object));
        } else if (v2 == 1207) {
            ...
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<u128>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_U128(), &v10);
        } else if (v2 == 1210) {
            ...
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<address>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_ADDRESS(), 0x1::option::borrow<address>(&arg0.from));
        } else if (v2 == 1213) {
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<u64>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_U64(), &arg0.index);
        } else if (v2 == 1214) {
            let v12 = false;
            if (0x1::option::is_some<address>(&arg0.for_object) && 0x1::option::is_some<address>(&arg0.for_guard)) {
                let v13 = if (*0x1::option::borrow<address>(&arg0.for_object) == 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::passport::GET_ADDRESS(v1)) {
                    if (*0x1::option::borrow<address>(&arg0.for_guard) == 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::passport::GET_ADDRESS(v1)) {
                        arg0.index == 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::passport::GET_U64(v1)
                    } else {
                        false
                    }
                } else {
            ...
            let v14 = 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::passport::GET_ADDRESS(v1);
            let v15 = 0;
            if (0x1::option::is_some<address>(&arg0.for_object) && 0x1::option::is_some<address>(&arg0.for_guard)) {
                let v16 = if (*0x1::option::borrow<address>(&arg0.for_object) == 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::passport::GET_ADDRESS(v1)) {
                    if (*0x1::option::borrow<address>(&arg0.for_guard) == 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::passport::GET_ADDRESS(v1)) {
                        arg0.index == 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::passport::GET_U64(v1)
                    } else {
                        false
            ...
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<u128>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_U128(), &v15);
        } else if (v2 == 1216) {
            let v17 = 0x1::type_name::get<T0>();
            let v18 = 0x1::string::from_ascii(*0x1::type_name::borrow_string(&v17));
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<0x1::string::String>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_STRING(), &v18);
        } else if (v2 == 1217) {
            let v19 = 0x1::type_name::get_with_original_ids<T0>();
            let v20 = 0x1::string::from_ascii(*0x1::type_name::borrow_string(&v19));
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<0x1::string::String>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_STRING(), &v20);
        } else {
    ...
    public fun unwrap_assert<T0>(arg0: CoinWrapper<T0>, arg1: &Payment<T0>) : 0x2::coin::Coin<T0> {
        ...
        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::payment::NOT_MATCH(v2 == 0x2::object::id_address<Payment<T0>>(arg1));
        0x2::object::delete(v0);
        v1
    }
