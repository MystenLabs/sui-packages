module 0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::order {
    ...
    struct Order<phantom T0> has key {
        id: 0x2::object::UID,
        items: vector<0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::Item>,
    ...
    public(friend) fun order<T0>(arg0: &address, arg1: 0x2::coin::Coin<T0>, arg2: &vector<0x1::string::String>, arg3: &vector<u64>, arg4: &vector<u64>, arg5: &vector<0x1::option::Option<0x1::string::String>>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : Order<T0> {
        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::ORD_COIN(0x2::coin::value<T0>(&arg1) >= arg6);
        let v0 = 0x2::tx_context::sender(arg8);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, v0);
        let v1 = Order<T0>{
            id            : 0x2::object::new(arg8),
            items         : 0x1::vector::empty<0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::Item>(),
        ...
        while (v2 < 0x1::vector::length<0x1::string::String>(arg2)) {
            0x1::vector::push_back<0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::Item>(&mut v1.items, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::Item_new(0x1::vector::borrow<0x1::string::String>(arg2, v2), 0x1::vector::borrow<0x1::option::Option<0x1::string::String>>(arg5, v2), *0x1::vector::borrow<u64>(arg3, v2), *0x1::vector::borrow<u64>(arg4, v2)));
            v2 = v2 + 1;
        };
        v1
    }
    ...
    public fun ASSERT_ORDER_PERMISSION<T0>(arg0: &Order<T0>, arg1: &address) {
        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::ORD_PERM(hasOrderPermission<T0>(arg0, arg1));
    }

    public fun agent_set<T0>(arg0: &mut Order<T0>, arg1: vector<address>, arg2: &0x2::tx_context::TxContext) {
        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::AGENT_COUNT(0x1::vector::length<address>(&arg1));
        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::ORD_PAYER(arg0.payer == 0x2::tx_context::sender(arg2));
        arg0.agent = arg1;
    }

    public(friend) fun create<T0>(arg0: Order<T0>) : address {
        let v0 = 0x2::object::id_address<Order<T0>>(&arg0);
        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::NewOrderEvent_emit(&v0, &arg0.service, &arg0.progress, arg0.amount);
    ...
    public(friend) fun discount_order<T0>(arg0: &address, arg1: 0x2::coin::Coin<T0>, arg2: &vector<0x1::string::String>, arg3: &vector<u64>, arg4: &vector<u64>, arg5: &vector<0x1::option::Option<0x1::string::String>>, arg6: u64, arg7: Discount, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : Order<T0> {
        ...
        let v1 = if (arg7.service != *arg0) {
            ...
            !0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::time_in_range2(arg7.time_start, arg7.time_end, arg8)
        };
        if (v1) {
        ...
        if (arg7.type == 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::DISCOUNT_TYPE_MINUS()) {
            if (arg7.off >= arg6) {
                arg6 = 0;
            } else {
                arg6 = arg6 - arg7.off;
            };
        } else if (arg7.type == 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::DISCOUNT_TYPE_OFF_RATIO()) {
            0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::DNT_OFF(arg7.off);
            let v3 = (arg6 as u128) * ((10000 - arg7.off) as u128) / 10000;
            arg6 = (v3 as u64);
        } else {
            0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::DNT_TYPE2();
        };
    ...
    public(friend) fun discounts(arg0: &address, arg1: &0x1::string::String, arg2: u8, arg3: u64, arg4: &0x1::option::Option<u64>, arg5: &0x1::option::Option<u64>, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : vector<Discount> {
        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::ASSERT_DISCOUNT_NEW(arg1, arg2, arg3);
        let v0 = 0;
        ...
        while (v0 < arg7) {
            let v3 = Discount{
                ...
                off           : arg3,
                time_start    : v2,
                time_end      : 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::time_expand(arg6, v2),
                service       : *arg0,
            };
    ...
    public(friend) fun dispute<T0>(arg0: &mut Order<T0>, arg1: &address) {
        if (!0x1::vector::contains<address>(&arg0.dispute, arg1)) {
            0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::DNT_COUNT(0x1::vector::length<address>(&arg0.dispute));
            0x1::vector::push_back<address>(&mut arg0.dispute, *arg1);
        };
    }

    public fun guard_query<T0>(arg0: &Order<T0>, arg1: &mut 0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::Passport) {
        let v0 = 0x2::object::id_address<Order<T0>>(arg0);
        let (v1, v2, _) = 0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::ON_PASSPORT(arg1, &v0);
        if (v2 == 500) {
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<u64>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_U64(), &arg0.amount);
        } else if (v2 == 501) {
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<address>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_ADDRESS(), &arg0.payer);
        } else if (v2 == 502) {
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<address>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_ADDRESS(), &arg0.service);
        } else if (v2 == 503) {
            ...
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<address>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_ADDRESS(), 0x1::option::borrow<address>(&arg0.progress));
        } else if (v2 == 505) {
            ...
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<address>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_ADDRESS(), 0x1::option::borrow<address>(&arg0.discount));
        } else if (v2 == 508) {
            ...
            0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<u64>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_U64(), &v11);
        } else if (v2 == 514) {
            ...
            let v18 = 0x1::vector::length<0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::Item>(&arg0.items);
            ...
            let (v20, _, _) = 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::Item_find(&arg0.items, &v19);
            let v23 = v20;
            if (v23) {
            ...
            let v24 = 0x1::string::utf8(0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::passport::GET_VEC_U8(v1));
            let (v25, v26, _) = 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::Item_find(&arg0.items, &v24);
            let v28 = v26;
            if (v25) {
            ...
            let v29 = 0x1::string::utf8(0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::passport::GET_VEC_U8(v1));
            let (v30, _, v32) = 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::Item_find(&arg0.items, &v29);
            let v33 = v32;
            if (v30) {
                0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::BUILD_RESULT_DATA<u64>(v1, 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_STATIC_U64(), &v33);
            };
        } else if (v2 == 521) {
    ...
    fun ops_to_progress<T0>(arg0: &Order<T0>, arg1: &mut 0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::progress::Progress) {
        let v0 = arg0.agent;
        0x1::vector::push_back<address>(&mut v0, arg0.payer);
        0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::progress::OrderPayer_set(arg1, &v0);
    }
    ...
    public fun order_ops_to_progress<T0>(arg0: &mut Order<T0>, arg1: &mut 0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::progress::Progress) {
        if (0x1::option::is_some<address>(&arg0.progress)) {
            0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::order::PROGRESS(*0x1::option::borrow<address>(&arg0.progress) == 0x2::object::id_address<0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::progress::Progress>(arg1));
    ...
    public fun receive<T0, T1>(arg0: &mut Order<T0>, arg1: 0x2::transfer::Receiving<0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::payment::CoinWrapper<T1>>, arg2: &0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::payment::Payment<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        ASSERT_ORDER_PERMISSION<T0>(arg0, &v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::payment::unwrap_assert<T1>(0x2::transfer::public_receive<0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::payment::CoinWrapper<T1>>(&mut arg0.id, arg1), arg2), arg0.payer);
    }
    ...
    public(friend) fun set_progress<T0>(arg0: &mut Order<T0>, arg1: &mut 0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::progress::Progress, arg2: &address) {
        arg0.progress = 0x1::option::some<address>(0x2::object::id_address<0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::progress::Progress>(arg1));
    ...
    public fun witness<T0>(arg0: &mut 0xb8e5c4de9c3e291e56f6293d26a062f95ab7fece9f5d1840ced3970735ec9636::passport::Passport, arg1: u8, arg2: vector<u8>, arg3: vector<u8>, arg4: &Order<T0>) {
        let v0 = 0;
        let v1 = 0x1::vector::empty<address>();
        while (v0 < 0x1::vector::length<u8>(&arg3)) {
            let v2 = 0x1::vector::borrow<u8>(&arg3, v0);
            if (*v2 == 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_ORDER_PROGRESS()) {
                0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::passport::OBJECT_INVALID_WITH_TYPE(0x1::option::is_some<address>(&arg4.progress));
                0x1::vector::push_back<address>(&mut v1, *0x1::option::borrow<address>(&arg4.progress));
            } else if (*v2 == 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_ORDER_MACHINE()) {
                0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::passport::OBJECT_INVALID_WITH_TYPE(0x1::option::is_some<address>(&arg4.machine));
                0x1::vector::push_back<address>(&mut v1, *0x1::option::borrow<address>(&arg4.machine));
            } else if (*v2 == 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::TYPE_ORDER_SERVICE()) {
