module 0xb8840309b105d99da780949ad035c3bf9f34432e7213d2e947fdd1fc069e0388::h0d1a7 {
    struct H291e0 has copy, drop {
        h32609: u64,
        h9c1a1: u64,
    }

    struct H3b276 has copy, drop {
        hc4051: u64,
    }
    ...
    public fun h011fb<T0, T1, T2>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x99503febc627747fa177d5f14abe7f759e774da918221f6d27f2b6b7b3e8a8a4::hbdcc6::H0128d, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: vector<u64>, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<u64>, arg12: vector<u64>, arg13: vector<u64>, arg14: vector<u64>, arg15: u64, arg16: u64, arg17: 0x1::option::Option<0x2::object::ID>, arg18: 0x1::option::Option<u64>, arg19: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<u64>(&arg18)) {
            let v2 = H3b276{hc4051: *0x1::option::borrow<u64>(&arg18)};
            0x2::event::emit<H3b276>(v2);
        };
        let v3 = 0x99503febc627747fa177d5f14abe7f759e774da918221f6d27f2b6b7b3e8a8a4::hbdcc6::h50957(arg1, arg2, arg19);
        let (v4, v5, v6) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_book_params<T0, T1>(arg0);
        ...
        let v10 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T2>(arg2);
        let v11 = if (v8 > arg4) {
            v8 - arg4
        } else {
            0
        ...
        let (_, _, _) = h0ac4a<T0, T1>(arg0, arg2, &v3, arg3, v11, v12, v10, &arg6, &arg7, &arg10, &arg11, &arg12, v7, v6, v4, v5, arg19);
        let (v16, v17) = if ((0x1::vector::length<u64>(&arg8) > 0 || 0x1::vector::length<u64>(&arg9) > 0) && 0x1::option::is_some<0x2::object::ID>(&arg17)) {
        ...
        let v18 = v17;
        let v19 = v16;
        let (_, _, _) = ha78b6<T0, T1, T2>(arg0, arg2, &v3, arg3, arg4, arg5, &arg8, &arg9, arg10, &arg11, &arg12, &arg13, &arg14, arg15, arg16, v7, v6, v4, v5, &v19, &v18, arg19);
    }
    ...
    public fun he605f<T0, T1, T2>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x99503febc627747fa177d5f14abe7f759e774da918221f6d27f2b6b7b3e8a8a4::hbdcc6::H0128d, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2::clock::Clock, arg4: bool, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<u64>, arg12: vector<u64>, arg13: vector<u64>, arg14: vector<u64>, arg15: 0x1::option::Option<0x2::object::ID>, arg16: 0x1::option::Option<u64>, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<u64>(&arg16)) {
            let v2 = H3b276{hc4051: *0x1::option::borrow<u64>(&arg16)};
            0x2::event::emit<H3b276>(v2);
        };
        let v3 = 0x99503febc627747fa177d5f14abe7f759e774da918221f6d27f2b6b7b3e8a8a4::hbdcc6::h50957(arg1, arg2, arg17);
        if (arg4) {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::cancel_all_orders<T0, T1>(arg0, arg2, &v3, arg3, arg17);
        };
        let (v4, v5, v6) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_book_params<T0, T1>(arg0);
        ...
        let (v13, v14, v15) = h0ac4a<T0, T1>(arg0, arg2, &v3, arg3, v10, v11, v9, &arg7, &arg8, &arg11, &arg12, &arg13, v12, v6, v4, v5, arg17);
        let v16 = 0x1::vector::length<u64>(&arg9) > 0 || 0x1::vector::length<u64>(&arg10) > 0;
        let (v17, v18) = if (v16 && 0x1::option::is_some<0x2::object::ID>(&arg15)) {
        ...
        if (v16) {
            ...
            let v25 = v23;
            let v26 = v21;
            let v27 = if (0x1::vector::length<u64>(&v26) > 0) {
                *0x1::vector::borrow<u64>(&v26, 0)
            } else {
                0
            };
            let v28 = if (0x1::vector::length<u64>(&v25) > 0) {
                *0x1::vector::borrow<u64>(&v25, 0)
            } else {
                0
            };
            let v29 = 0;
            while (v29 < 0x1::vector::length<u64>(&arg9)) {
                let v30 = *0x1::vector::borrow<u64>(&arg9, v29);
                let v31 = h1fdbf(v4, *0x1::vector::borrow<u64>(&arg11, v30), true, v27, v28);
                let v32 = if (v31 == 0) {
                    0
                } else {
                    hf29cd(v4, v31, true, v27, v28, *0x1::vector::borrow<u64>(&arg14, v30), haf5ec(&v20, v31, true))
                };
                *0x1::vector::borrow_mut<u64>(&mut arg11, v30) = v32;
                v29 = v29 + 1;
            };
            v29 = 0;
            while (v29 < 0x1::vector::length<u64>(&arg10)) {
                let v33 = *0x1::vector::borrow<u64>(&arg10, v29);
                let v34 = h1fdbf(v4, *0x1::vector::borrow<u64>(&arg11, v33), false, v27, v28);
                let v35 = if (v34 == 0) {
                    0
                } else {
                    hf29cd(v4, v34, false, v27, v28, *0x1::vector::borrow<u64>(&arg14, v33), haf5ec(&v19, v34, false))
                };
                *0x1::vector::borrow_mut<u64>(&mut arg11, v33) = v35;
                v29 = v29 + 1;
            };
        };
        let (_, _, _) = h22b6d<T0, T1>(arg0, arg2, &v3, arg3, v13, v14, v15, &arg9, &arg10, &arg11, &arg12, &arg13, v12, v6, v4, v5, arg17);
    }
