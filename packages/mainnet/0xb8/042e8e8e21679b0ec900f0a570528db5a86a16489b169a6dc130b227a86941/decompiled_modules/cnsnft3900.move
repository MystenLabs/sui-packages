module 0xb8042e8e8e21679b0ec900f0a570528db5a86a16489b169a6dc130b227a86941::cnsnft3900 {
    struct CNSNFT3900 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3900, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3900>(arg0, arg1);
