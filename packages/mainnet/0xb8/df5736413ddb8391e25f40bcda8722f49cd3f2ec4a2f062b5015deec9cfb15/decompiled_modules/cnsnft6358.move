module 0xb8df5736413ddb8391e25f40bcda8722f49cd3f2ec4a2f062b5015deec9cfb15::cnsnft6358 {
    struct CNSNFT6358 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6358, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6358>(arg0, arg1);
