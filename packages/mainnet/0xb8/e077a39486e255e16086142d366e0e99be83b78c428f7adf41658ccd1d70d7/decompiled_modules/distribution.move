module 0xb8e077a39486e255e16086142d366e0e99be83b78c428f7adf41658ccd1d70d7::distribution {
    ...
    fun init(arg0: DISTRIBUTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = DistributionCap{id: 0x2::object::new(arg1)};
        0x2::transfer::public_transfer<DistributionCap>(v0, 0x2::tx_context::sender(arg1));
    }
    ...
    entry fun mint<T0: store + key>(arg0: &mut Distribution<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.phase == 3, 13906834689739456511);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= arg0.public_price * arg2, 13906834694034423807);
        assert!(0x2::table_vec::length<T0>(&arg0.items) >= arg2, 13906834698329391103);
        let v0 = 0;
        while (v0 < arg2) {
            let v1 = mint_internal<T0>(arg0, arg3, arg4);
            let v2 = Minted{id: 0x2::object::id<T0>(&v1)};
    ...
    fun mint_internal<T0: store + key>(arg0: &mut Distribution<T0>, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) : T0 {
        let v0 = 0x2::random::new_generator(arg1, arg2);
        0x2::table_vec::swap_remove<T0>(&mut arg0.items, 0x2::random::generate_u64_in_range(&mut v0, 0, 0x2::table_vec::length<T0>(&arg0.items) - 1))
    }
    ...
    entry fun og_mint<T0: store + key>(arg0: &mut Distribution<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut OGCap, arg3: u64, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.current_mint + arg3 <= arg2.max_mint, 13906834801408606207);
        assert!(arg0.phase == 1, 13906834805703573503);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= arg0.og_price * arg3, 13906834809998540799);
        assert!(0x2::table_vec::length<T0>(&arg0.items) >= arg3, 13906834814293508095);
        let v0 = 0;
        while (v0 < arg3) {
            let v1 = mint_internal<T0>(arg0, arg4, arg5);
            let v2 = Minted{id: 0x2::object::id<T0>(&v1)};
            0x2::event::emit<Minted>(v2);
            0x2::transfer::public_transfer<T0>(v1, 0x2::tx_context::sender(arg5));
            v0 = v0 + 1;
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, arg0.admin);
        arg0.og_minted = arg0.og_minted + arg3;
    ...
    entry fun whitelist_mint<T0: store + key>(arg0: &mut Distribution<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut WhitelistCap, arg3: u64, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.current_mint + arg3 <= arg2.max_mint, 13906834925962657791);
        assert!(arg0.phase == 2, 13906834930257625087);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= arg0.whitelist_price * arg3, 13906834934552592383);
        assert!(0x2::table_vec::length<T0>(&arg0.items) >= arg3, 13906834938847559679);
        let v0 = 0;
        while (v0 < arg3) {
            let v1 = mint_internal<T0>(arg0, arg4, arg5);
            let v2 = Minted{id: 0x2::object::id<T0>(&v1)};
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, arg0.admin);
        arg0.whitelist_minted = arg0.whitelist_minted + arg3;
        arg0.total_minted = arg0.total_minted + arg3;
        arg2.current_mint = arg2.current_mint + arg3;
    }
