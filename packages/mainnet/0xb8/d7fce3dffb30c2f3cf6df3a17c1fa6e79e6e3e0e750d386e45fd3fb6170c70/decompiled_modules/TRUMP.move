module 0xb8d7fce3dffb30c2f3cf6df3a17c1fa6e79e6e3e0e750d386e45fd3fb6170c70::TRUMP {
    struct TRUMP has drop {
        dummy_field: bool,
    }

    fun init(arg0: TRUMP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TRUMP>(arg0, 9, b"TRUMP", b"Donald Trump", b"Donald Trump Boost", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
