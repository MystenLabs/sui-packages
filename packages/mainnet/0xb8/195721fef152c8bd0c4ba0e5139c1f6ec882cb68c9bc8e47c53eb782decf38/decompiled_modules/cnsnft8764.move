module 0xb8195721fef152c8bd0c4ba0e5139c1f6ec882cb68c9bc8e47c53eb782decf38::cnsnft8764 {
    struct CNSNFT8764 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8764, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8764>(arg0, arg1);
