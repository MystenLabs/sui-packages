module 0xb88f9149c55d6314b7ae436a730cfbf3a5d53522f37e2d56288531bb8adc7071::market {
    ...
    public fun buy(arg0: &mut Marketplace, arg1: 0x2::object::ID, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::Movescription {
        ...
        let v11 = v4 - v10;
        assert!(v11 > 0, 3);
        0x2::pay::split_and_transfer<0x2::sui::SUI>(arg2, v11, v5, arg5);
        ...
        0x2::table::remove<0x2::object::ID, bool>(&mut v12.listing, 0x2::object::id<Listing>(&v2));
        ...
        0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::inject_sui(&mut v15, 0x2::coin::split<0x2::sui::SUI>(arg2, v10 * v0.lock_ratio / 1000, arg5));
    ...
    public entry fun list(arg0: &mut Marketplace, arg1: 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::Movescription, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0xb88f9149c55d6314b7ae436a730cfbf3a5d53522f37e2d56288531bb8adc7071::critbit::find_leaf<vector<Listing>>(&arg0.listing, arg2);
        if (v3) {
            0x1::vector::push_back<Listing>(0xb88f9149c55d6314b7ae436a730cfbf3a5d53522f37e2d56288531bb8adc7071::critbit::borrow_mut_leaf_by_index<vector<Listing>>(&mut arg0.listing, v4), v2);
        } else {
            0xb88f9149c55d6314b7ae436a730cfbf3a5d53522f37e2d56288531bb8adc7071::critbit::insert_leaf<vector<Listing>>(&mut arg0.listing, arg2, 0x1::vector::singleton<Listing>(v2));
        };
        ...
        if (0x2::table::contains<address, ListingInfo>(&arg0.listing_info, 0x2::tx_context::sender(arg3))) {
            0x2::table::add<0x2::object::ID, bool>(&mut 0x2::table::borrow_mut<address, ListingInfo>(&mut arg0.listing_info, 0x2::tx_context::sender(arg3)).listing, 0x2::object::id<Listing>(&v2), true);
        } else {
            let v5 = 0x2::table::new<0x2::object::ID, bool>(arg3);
            0x2::table::add<0x2::object::ID, bool>(&mut v5, 0x2::object::id<Listing>(&v2), true);
            let v6 = ListingInfo{
                id      : 0x2::object::new(arg3),
                listing : v5,
            };
            0x2::table::add<address, ListingInfo>(&mut arg0.listing_info, 0x2::tx_context::sender(arg3), v6);
        };
