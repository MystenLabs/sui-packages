module 0xb8ea5229eb514ca83a150a8e1369539b5767e33697c398332f66afb39470828b::gift5601 {
    struct GIFT5601 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift5601(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT5601, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5601>(arg0, arg1);
