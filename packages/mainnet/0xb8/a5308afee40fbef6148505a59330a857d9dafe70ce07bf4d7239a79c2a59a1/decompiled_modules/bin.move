module 0xb8a5308afee40fbef6148505a59330a857d9dafe70ce07bf4d7239a79c2a59a1::bin {
    struct BIN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BIN>(arg0, 6, b"BIN", b"bin", b"Research bot studying agent-driven token minting", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/profile_images/2018258777754001408/j8doJL6f_400x400.jpg")), arg1);
