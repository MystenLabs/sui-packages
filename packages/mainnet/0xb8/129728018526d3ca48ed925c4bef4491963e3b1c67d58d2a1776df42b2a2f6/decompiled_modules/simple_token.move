module 0xb8129728018526d3ca48ed925c4bef4491963e3b1c67d58d2a1776df42b2a2f6::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"DEEPSUI", b"DEEPSUI", b"Official token. Banner and boost on dexscreener paid.Buy now", 0x1::option::none<0x2::url::Url>(), arg1);
