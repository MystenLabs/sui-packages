module 0x8a98290668a674241f7d42e95cfd47ddabb4de9e2e76e52b79a0af9d542a4e90::marketplace {
    ...
    public fun accept_unlisted_bid<T0: store + key>(arg0: &0x2::clock::Clock, arg1: &mut MarketPlaceStore, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: address, arg7: 0x2::object::ID, arg8: bool, arg9: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg10: &mut 0xb52b5bf61cf58c7d785c1fddee3eb1baae54ebb0a3b15f2007b314670d0dddc7::ions::AnimaIONs, arg11: &mut 0xb52b5bf61cf58c7d785c1fddee3eb1baae54ebb0a3b15f2007b314670d0dddc7::ions::AnimaChef, arg12: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        let v19 = v11;
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Rule>(arg9)) {
            if (0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<T0>(arg9, v17 - v10) != v11) {
                v19 = 0;
                v18 = 0;
            };
        };
        0x2::kiosk::list<T0>(arg3, arg4, arg5, v18);
        let (v20, v21) = 0x2::kiosk::purchase<T0>(arg3, arg5, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v9, v18), arg12));
        let v22 = v21;
        if (v19 > 0 && 0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Rule>(arg9)) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg9, &mut v22, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v9, v19), arg12));
        };
        ...
        0x2::kiosk::lock<T0>(arg2, &arg1.escrow_kiosk_cap, arg9, v20);
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::Rule>(arg9)) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T0>(&mut v22, arg2);
        };
        v8.lifetime_volume = v8.lifetime_volume + (v17 as u128);
        update_collection_avg_price<T0>(v8, v17);
        let (v23, v24) = if (v8.ion_points_enabled) {
            let v25 = if (v8.ion_collection_multiplier == 0) {
                1000
            } else {
                v8.ion_collection_multiplier
            };
            let v26 = 0x8a98290668a674241f7d42e95cfd47ddabb4de9e2e76e52b79a0af9d542a4e90::helpers::calculate_bid_proximity_multiplier(v17, v8.avg_sale_price);
            let v27 = 0x8a98290668a674241f7d42e95cfd47ddabb4de9e2e76e52b79a0af9d542a4e90::helpers::calculate_time_multiplier(0x2::clock::timestamp_ms(arg0) - v3, true);
            let v28 = 0x8a98290668a674241f7d42e95cfd47ddabb4de9e2e76e52b79a0af9d542a4e90::helpers::calculate_ion_points(v17, v25, v26, v27);
            award_ion_points_with_referral(v0, arg1, arg10, v28, arg0, arg11);
            let v29 = 0x8a98290668a674241f7d42e95cfd47ddabb4de9e2e76e52b79a0af9d542a4e90::helpers::calculate_ion_points(v17, v25, v26, v27);
            let v30 = 0x2::linked_table::borrow_mut<address, UserInfo>(&mut arg1.user_activity, arg6);
            v30.claimable_points = v30.claimable_points + v29;
            (v29, v28)
        } else {
            (0, 0)
        };
        let v31 = BidAcceptedEvent{
            nft_type          : v1,
            nft_id            : arg5,
            seller            : v0,
            buyer             : arg6,
        ...
        0x2::event::emit<BidAcceptedEvent>(v31);
        v22
    }
