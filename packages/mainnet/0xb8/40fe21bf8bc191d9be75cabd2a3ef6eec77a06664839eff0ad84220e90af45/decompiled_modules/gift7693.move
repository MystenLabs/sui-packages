module 0xb840fe21bf8bc191d9be75cabd2a3ef6eec77a06664839eff0ad84220e90af45::gift7693 {
    struct GIFT7693 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift7693(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT7693, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7693>(arg0, arg1);
