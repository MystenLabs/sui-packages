module 0xb8fc4524de72c51e0702c9bd091e9f1617e8e3e1ed7a0d85848b8b1eff83699d::ScallopGift {
    ...
    public entry fun GiftFromScallop(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SCALLOPGIFT_TICKET{
                id          : 0x2::object::new(arg1),
                name        : 0x1::string::utf8(b"10000 SCA Voucher"),
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/scallopgiftcom_0701/scallopgiftcom_0701_1.jpg"),
    ...
    fun init(arg0: SCALLOPGIFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/scallopgiftcom_0701/scallopgiftcom_0701_1.jpg"));
