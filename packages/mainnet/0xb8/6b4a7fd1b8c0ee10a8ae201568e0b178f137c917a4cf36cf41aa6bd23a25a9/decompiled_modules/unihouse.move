module 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::unihouse {
    ...
    struct RedeemRequest<phantom T0> has store, key {
        id: 0x2::object::UID,
        s_coin: 0x2::coin::Coin<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::StakedHouseCoin<T0>>,
        created_at: u64,
        sender: address,
    }
    ...
    struct BlackjackGameResult<phantom T0, phantom T1> has copy, drop {
        ...
        bet_size: u64,
        bet_returned: u64,
        player_hands: vector<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::game_structs::BlackjackHand>,
    ...
    struct PlinkoGameResult<phantom T0, phantom T1> has copy, drop {
        ...
        bet_size: u64,
        bet_returned: u64,
        ball_outcomes: vector<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::game_structs::BallOutcome>,
        bet_results: vector<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::game_structs::BetResult<T0>>,
        origin: 0x1::string::String,
    }
    ...
    struct RangeGameResult<phantom T0, phantom T1> has copy, drop {
        player: address,
        origin: 0x1::string::String,
        bet_results: vector<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::game_structs::RangeGame>,
    }
    ...
    public fun deposit<T0>(arg0: &mut Unihouse, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::StakedHouseCoin<T0>> {
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::deposit<T0>(borrow_house_mut<T0>(arg0), 0x2::coin::into_balance<T0>(arg1), arg2)
    }

    public fun deposit_house_pool<T0>(arg0: &mut Unihouse, arg1: 0x2::coin::Coin<T0>) {
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::deposit_house_pool<T0>(borrow_house_mut<T0>(arg0), 0x2::coin::into_balance<T0>(arg1));
    }
    ...
    public fun house_metadata<T0>(arg0: &Unihouse) : (u64, u64, u64, u64) {
        ...
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::house_metadata<T0>(0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::House<T0>>(&arg0.id, v0))
    }
    ...
    public fun join<T0, T1: drop>(arg0: &mut Unihouse, arg1: T1, arg2: 0x2::balance::Balance<T0>) {
        ...
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::join<T0>(borrow_house_mut<T0>(arg0), arg2);
    }
    ...
    public fun join_with_fee<T0, T1: drop>(arg0: &mut Unihouse, arg1: T1, arg2: 0x2::balance::Balance<T0>) {
        ...
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::join_with_fee<T0>(borrow_house_mut<T0>(arg0), arg2);
    }

    public fun max_risk<T0>(arg0: &Unihouse) : u64 {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::dynamic_object_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 2);
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::max_risk<T0>(0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::House<T0>>(&arg0.id, v0))
    }
    ...
    public fun split<T0, T1: drop>(arg0: &mut Unihouse, arg1: T1, arg2: u64) : 0x2::balance::Balance<T0> {
        ...
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::split<T0>(borrow_house_mut<T0>(arg0), arg2)
    }
    ...
    public fun split_with_reimbursement<T0, T1: drop>(arg0: &mut Unihouse, arg1: T1, arg2: u64) : 0x2::balance::Balance<T0> {
        ...
        v0.current_epoch_risk_count = v0.current_epoch_risk_count + arg2;
        assert!(v0.current_epoch_risk_count <= v0.daily_risk_limit, 8);
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::split_with_reimbursement<T0>(borrow_house_mut<T0>(arg0), arg2)
    }
    ...
    public fun withdraw_house_pool<T0>(arg0: &AdminCap, arg1: &mut Unihouse, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x2::coin::from_balance<T0>(0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::withdraw_house_pool<T0>(borrow_house_mut<T0>(arg1), arg2), arg3)
    }

    public fun output<T0, T1: drop>(arg0: &mut Unihouse, arg1: u64) : 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::OutputCarrier<T0, T1> {
        let v0 = borrow_house_mut<T0>(arg0);
        let (v1, v2) = 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::split_for_pipe<T0>(v0, arg1, false);
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::output<T0, T1>(borrow_pipe_mut<T0, T1>(arg0), v1, v2)
    }
    ...
    fun assert_valid_voucher_value<T0, T1>(arg0: &Unihouse, arg1: &0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::voucher::UnihouseVoucher<T0, T1>) {
        let v0 = voucher_max_value<T0>(arg0);
        if (0x1::option::is_none<u64>(&v0)) {
            return
        };
        assert!(0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::voucher::value<T0, T1>(arg1) <= 0x1::option::destroy_some<u64>(v0), 5);
    }
    ...
    public fun assert_within_risk<T0, T1: drop>(arg0: &mut Unihouse, arg1: T1, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(arg2 <= 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::max_risk<T0>(v1), 3);
        assert!(0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::math::mul_rate(arg2, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::fee_rate()) <= 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::house_balance<T0>(v1), 9);
    }
    ...
    public fun borrow_house<T0>(arg0: &Unihouse) : &0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::House<T0> {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::dynamic_object_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 2);
        0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::House<T0>>(&arg0.id, v0)
    }

    fun borrow_house_mut<T0>(arg0: &mut Unihouse) : &mut 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::House<T0> {
        assert_valid_version(arg0);
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::dynamic_object_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 2);
        0x2::dynamic_object_field::borrow_mut<0x1::type_name::TypeName, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::House<T0>>(&mut arg0.id, v0)
    }
    ...
    public fun borrow_pipe<T0, T1: drop>(arg0: &Unihouse) : &0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::Pipe<T0, T1> {
        if (!pipe_exists<T0, T1>(arg0)) {
            err_pipe_not_exists();
        };
        0x2::dynamic_field::borrow<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::PipeType<T0, T1>, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::Pipe<T0, T1>>(&arg0.id, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::new_type<T0, T1>())
    }

    fun borrow_pipe_mut<T0, T1: drop>(arg0: &mut Unihouse) : &mut 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::Pipe<T0, T1> {
        if (!pipe_exists<T0, T1>(arg0)) {
            err_pipe_not_exists();
        };
        0x2::dynamic_field::borrow_mut<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::PipeType<T0, T1>, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::Pipe<T0, T1>>(&mut arg0.id, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::new_type<T0, T1>())
    }

    public fun buy_voucher<T0, T1>(arg0: &mut Unihouse, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::voucher::UnihouseVoucher<T0, T1> {
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::voucher_deposit<T0>(borrow_house_mut<T0>(arg0), arg1);
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::voucher::mint<T0, T1>(0x2::coin::value<T0>(&arg1), 0x2::clock::timestamp_ms(arg2) + 7776000000, arg3)
    }
    ...
    public fun create_house<T0>(arg0: &AdminCap, arg1: &mut Unihouse, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<0x1::type_name::TypeName, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::House<T0>>(&mut arg1.id, v0, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::new<T0>(arg2));
    }

    public fun create_pipe<T0, T1: drop>(arg0: &AdminCap, arg1: &mut Unihouse) {
        0x2::dynamic_field::add<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::PipeType<T0, T1>, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::Pipe<T0, T1>>(&mut arg1.id, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::new_type<T0, T1>(), 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::new_pipe<T0, T1>());
    }

    public fun destroy_pipe<T0, T1: drop>(arg0: &AdminCap, arg1: &mut Unihouse) {
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::destroy<T0, T1>(0x2::dynamic_field::remove<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::PipeType<T0, T1>, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::Pipe<T0, T1>>(&mut arg1.id, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::new_type<T0, T1>()));
    }
    ...
    public fun emit_blackjack_game_result<T0, T1: drop>(arg0: &mut Unihouse, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64, arg5: vector<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::game_structs::BlackjackHand>, arg6: vector<u8>, arg7: address, arg8: 0x1::string::String) {
        assert!(game_config_exists<T0, T1>(arg0), 4);
    ...
    public fun emit_plinko_game_result<T0, T1: drop>(arg0: &Unihouse, arg1: 0x1::option::Option<0x2::object::ID>, arg2: 0x1::option::Option<address>, arg3: u8, arg4: u64, arg5: u64, arg6: u64, arg7: vector<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::game_structs::BallOutcome>, arg8: vector<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::game_structs::BetResult<T0>>, arg9: 0x1::string::String) {
        assert!(game_config_exists<T0, T1>(arg0), 4);
    ...
    public fun emit_range_game_results<T0, T1: drop>(arg0: &Unihouse, arg1: address, arg2: 0x1::string::String, arg3: vector<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::game_structs::RangeGame>) {
        assert!(game_config_exists<T0, T1>(arg0), 4);
    ...
    public fun fulfill_redeem_request<T0>(arg0: &mut Unihouse, arg1: &AdminCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::redeem<T0>(borrow_house_mut<T0>(arg0), 0x2::coin::into_balance<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::StakedHouseCoin<T0>>(v1), v3), arg3), v3);
    }
    ...
    public fun input<T0, T1: drop>(arg0: &mut Unihouse, arg1: 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::InputCarrier<T0, T1>) {
        let v0 = borrow_pipe_mut<T0, T1>(arg0);
        let (v1, v2) = 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::destroy_input_carrier<T0, T1>(arg1, v0);
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::join_from_pipe<T0>(borrow_house_mut<T0>(arg0), v1, v2, false);
    }

    public fun input_to_house<T0, T1: drop>(arg0: &mut Unihouse, arg1: 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::InputCarrier<T0, T1>) {
        let v0 = borrow_pipe_mut<T0, T1>(arg0);
        let (v1, v2) = 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::destroy_input_carrier<T0, T1>(arg1, v0);
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::join_from_pipe<T0>(borrow_house_mut<T0>(arg0), v1, v2, true);
    }
    ...
    public fun output_from_house<T0, T1: drop>(arg0: &mut Unihouse, arg1: u64) : 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::OutputCarrier<T0, T1> {
        let v0 = borrow_house_mut<T0>(arg0);
        let (v1, v2) = 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::split_for_pipe<T0>(v0, arg1, true);
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::output<T0, T1>(borrow_pipe_mut<T0, T1>(arg0), v1, v2)
    }
    ...
    public fun pipe_exists<T0, T1: drop>(arg0: &Unihouse) : bool {
        0x2::dynamic_field::exists_with_type<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::PipeType<T0, T1>, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::Pipe<T0, T1>>(&arg0.id, 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::pipe::new_type<T0, T1>())
    }
    ...
    public fun redeem_request<T0>(arg0: &mut Unihouse, arg1: 0x2::coin::Coin<0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::StakedHouseCoin<T0>>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
    ...
    public fun redeem_voucher<T0, T1>(arg0: &mut Unihouse, arg1: &mut 0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::voucher::UnihouseVoucher<T0, T1>, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_valid_voucher_value<T0, T1>(arg0, arg1);
        0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::voucher::deduct<T0, T1>(arg1, arg2, arg3);
        0x2::coin::from_balance<T0>(0xb86b4a7fd1b8c0ee10a8ae201568e0b178f137c917a4cf36cf41aa6bd23a25a9::house::split_for_voucher<T0>(borrow_house_mut<T0>(arg0), arg3), arg4)
    }
