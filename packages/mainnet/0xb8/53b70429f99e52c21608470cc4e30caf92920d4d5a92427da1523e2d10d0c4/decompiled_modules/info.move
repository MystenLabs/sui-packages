module 0xb853b70429f99e52c21608470cc4e30caf92920d4d5a92427da1523e2d10d0c4::info {
    public fun get_description_nft() : vector<u8> {
        b"Karafuru Sui! Karafuru is home to 5,555 generative arts where colors reign supreme. Leave the drab reality and enter the world"
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/QmZfjpjxLw3oE28Ac41SuFnytKVJpkV8Y6ZNq5m3JB9jzN/"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/QmdJ8S7YfZmXQJYdieyHJhNpAUnqQ8KEQsgZ4EAdwYk7tx/"
    }
