module 0xb84d7d2f5edf0bb8540c170dfb262d9dd634adaff456c52f3074a7f773c18e9d::cnsnft2195 {
    struct CNSNFT2195 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2195, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2195>(arg0, arg1);
