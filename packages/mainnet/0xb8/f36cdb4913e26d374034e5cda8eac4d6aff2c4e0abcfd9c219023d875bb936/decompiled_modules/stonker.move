module 0xb8f36cdb4913e26d374034e5cda8eac4d6aff2c4e0abcfd9c219023d875bb936::stonker {
    ...
    fun adjust_maker_orders(arg0: &mut Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &0x2::clock::Clock, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        while (v14 < 0x1::vector::length<u128>(&v5)) {
            ...
            v14 = v14 + 1;
            assert!(v15 != 0, 13906837382683951103);
            if (order_is_bid(v15)) {
                if (v11 == 0) {
                    v12 = v15;
                    continue
        ...
        ensure_maker_order_is_correct(arg0, arg1, arg2, v8, arg4 - v1, v2, true, arg0.parameters.maker_max_shallow_quantity_base, 0, arg3, arg5);
        ensure_maker_order_is_correct(arg0, arg1, arg2, v10, arg4 + v1, v2, false, arg0.parameters.maker_max_shallow_quantity_base, 0, arg3, arg5);
        ensure_maker_order_is_correct(arg0, arg1, arg2, v12, arg4 - v3, v4, true, arg0.parameters.maker_max_deep_quantity_base, 1, arg3, arg5);
        ensure_maker_order_is_correct(arg0, arg1, arg2, v13, arg4 + v3, v4, false, arg0.parameters.maker_max_deep_quantity_base, 1, arg3, arg5);
    }
    ...
    fun ensure_maker_order_is_correct(arg0: &Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: u128, arg4: u64, arg5: u64, arg6: bool, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &0x2::tx_context::TxContext) {
        ...
        if (v1) {
            ...
            if (v3 > 0x2::clock::timestamp_ms(arg9) && v3 - 0x2::clock::timestamp_ms(arg9) > arg0.parameters.maker_order_ttl_ms / 2) {
                return
            };
        };
        let v4 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg10);
        if (arg3 != 0) {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::cancel_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v4, arg3, arg9, arg10);
        };
        if (arg6) {
            let v5 = arg7;
            ...
            let (v7, v8, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_book_params<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2);
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v4, arg8, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::post_only(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::cancel_maker(), arg4 / v7 * v7, v5 / v8 * v8, true, false, 0x2::clock::timestamp_ms(arg9) + arg0.parameters.maker_order_ttl_ms, arg9, arg10);
        } else {
            let v10 = arg7;
            let v11 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0x2::sui::SUI>(arg1);
            if (arg7 > v11) {
                v10 = v11;
            };
            let (v12, v13, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_book_params<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2);
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v4, arg8, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::post_only(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::cancel_maker(), (arg4 + v12 - 1) / v12 * v12, v10 / v13 * v13, false, false, 0x2::clock::timestamp_ms(arg9) + arg0.parameters.maker_order_ttl_ms, arg9, arg10);
        };
    }
