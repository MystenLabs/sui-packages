module 0xceacb3de3e57db56696c448c22c26bbc60e003e1ec1e1ca9f3bf7c0d8f8bfde0::config {
    ...
    public fun min_spread_floor_bps(arg0: &MMConfig) : u64 {
        let v0 = 0x1::string::utf8(b"min_spread_floor");
        if (0x2::vec_map::contains<0x1::string::String, u64>(&arg0.extra_fields, &v0)) {
            *0x2::vec_map::get<0x1::string::String, u64>(&arg0.extra_fields, &v0)
        } else {
            0
        }
    }
    ...
    public fun with_max_price(arg0: MMConfig, arg1: u64) : MMConfig {
        arg0.max_price = arg1;
        assert_valid(&arg0);
        arg0
    }
    ...
    public fun with_min_price(arg0: MMConfig, arg1: u64) : MMConfig {
        arg0.min_price = arg1;
        assert_valid(&arg0);
        arg0
    }

    public fun with_min_spread_floor(arg0: MMConfig, arg1: u64) : MMConfig {
        let v0 = 0x1::string::utf8(b"min_spread_floor");
        if (0x2::vec_map::contains<0x1::string::String, u64>(&arg0.extra_fields, &v0)) {
            let (_, _) = 0x2::vec_map::remove<0x1::string::String, u64>(&mut arg0.extra_fields, &v0);
        };
        0x2::vec_map::insert<0x1::string::String, u64>(&mut arg0.extra_fields, v0, arg1);
        arg0
    }
