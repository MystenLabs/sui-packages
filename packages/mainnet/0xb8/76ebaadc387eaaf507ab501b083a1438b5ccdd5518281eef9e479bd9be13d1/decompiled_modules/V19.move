module 0xb876ebaadc387eaaf507ab501b083a1438b5ccdd5518281eef9e479bd9be13d1::V19 {
    ...
    public fun deepbook_a_to_b_lot_validation<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut AccessList, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v7 = MEVStepEvent{
            ...
            coin_in_left : 0x2::coin::value<T0>(&v6),
        };
        0x2::event::emit<MEVStepEvent>(v7);
    ...
    public fun deepbook_a_to_b_lot_validation_with_flow<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: u64, arg4: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg5: &0x2::clock::Clock, arg6: &mut AccessList, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = 0x2::coin::value<T0>(&arg1);
        let v2 = v1 % arg0;
        let v3 = 0x2::coin::split<T0>(&mut arg1, v2, arg7);
