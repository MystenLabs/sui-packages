module 0xb82d9208cde5a0b1aef064acfb5612b085bded9a7103a74f3465439b64d740d0::rootlets_ {
    struct ROOTLETS_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ROOTLETS_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ROOTLETS_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Rootlets "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Rootlets"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifcam7vkdd46gtvszrjxtmm7dxwluxwdinlhps2mobkbh2wibluam"));
