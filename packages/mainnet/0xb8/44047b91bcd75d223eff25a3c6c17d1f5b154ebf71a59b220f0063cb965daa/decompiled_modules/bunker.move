module 0xb844047b91bcd75d223eff25a3c6c17d1f5b154ebf71a59b220f0063cb965daa::bunker {
    ...
    fun init(arg0: BUNKER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/3WzaZwVmjr3JMWKknJtnEn3R4kaX9pVkwQJmC9fxpump.png                                                                                                                                                                                                                               ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BUNKER>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Bunker      ")))), trim_right(b"Bunkercoin                      "), trim_right(b"With all of the wars and violence, why would you have a coin that buys you a house when in reality you need a bunker?                                                                                                                                                                                                           "), v2, arg1);
