module 0xb8c8a91d108bc9a63525a92a569bc876c13edbb58c0764d57de84025aca2524c::config {
    ...
    public fun add_plan(arg0: &mut Config, arg1: &0xb8c8a91d108bc9a63525a92a569bc876c13edbb58c0764d57de84025aca2524c::admin::AdminCap, arg2: u64, arg3: u64) {
    ...
    public fun remove_plan(arg0: &mut Config, arg1: &0xb8c8a91d108bc9a63525a92a569bc876c13edbb58c0764d57de84025aca2524c::admin::AdminCap, arg2: u64) {
    ...
    public fun set_paused(arg0: &mut Config, arg1: &0xb8c8a91d108bc9a63525a92a569bc876c13edbb58c0764d57de84025aca2524c::admin::AdminCap, arg2: bool) {
        arg0.paused = arg2;
    }

    public fun update_fee_receiver(arg0: &mut Config, arg1: &0xb8c8a91d108bc9a63525a92a569bc876c13edbb58c0764d57de84025aca2524c::admin::AdminCap, arg2: address) {
        arg0.fee_receiver = arg2;
    }

    public fun update_plan(arg0: &mut Config, arg1: &0xb8c8a91d108bc9a63525a92a569bc876c13edbb58c0764d57de84025aca2524c::admin::AdminCap, arg2: u64, arg3: u64) {
        assert!(0x2::vec_map::contains<u64, SubscriptionPlan>(&arg0.plans, &arg2), 102);
        assert!(arg3 > 0, 105);
        let (_, _) = 0x2::vec_map::remove<u64, SubscriptionPlan>(&mut arg0.plans, &arg2);
