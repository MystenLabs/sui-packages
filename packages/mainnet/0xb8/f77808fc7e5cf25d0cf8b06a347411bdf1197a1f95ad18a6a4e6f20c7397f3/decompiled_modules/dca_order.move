module 0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_order {
    ...
    public fun cancel_order<T0, T1>(arg0: &0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::base_config::BaseConfig, arg1: &mut Order<T0, T1>, arg2: &mut OrderIndexer, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
    ...
    public fun flash_loan_for_make_deal<T0, T1>(arg0: &0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::base_config::BaseConfig, arg1: &0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::DCAConfig, arg2: &mut 0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::ProtocolFeeVault, arg3: &mut Order<T0, T1>, arg4: u64, arg5: vector<0x1::string::String>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, MakeDealReceipt) {
        0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::base_config::checked_package_version(arg0);
        ...
        let v2 = if (arg3.fee_rate > 0) {
            ...
            0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::receive_fee<T0>(arg2, 0x2::balance::split<T0>(&mut v1, v3));
            v3
        } else {
            0
        };
        let v4 = if (0x2::balance::value<T0>(&arg3.in_balance) >= arg3.in_amount_per_cycle) {
    ...
    public fun open_order<T0, T1>(arg0: &0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::base_config::BaseConfig, arg1: &0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::DCAConfig, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: 0x1::string::String, arg11: &0x2::clock::Clock, arg12: &mut OrderIndexer, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = Order<T0, T1>{
            ...
            in_amount_per_cycle      : arg4,
            amount_left_next_cycle   : arg4,
            next_cycle_at            : v3,
    ...
    fun parse_signature(arg0: vector<u8>) : (address, vector<u8>, vector<u8>) {
        ...
        let v6 = 0;
        while (v6 < 0x1::vector::length<u8>(&v1)) {
            0x1::vector::push_back<u8>(&mut v5, *0x1::vector::borrow<u8>(&v1, v6));
            v6 = v6 + 1;
        };
        (0x2::address::from_bytes(0x2::hash::blake2b256(&v5)), v1, v2)
    }

    public fun repay_for_make_deal<T0, T1>(arg0: &0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::base_config::BaseConfig, arg1: &mut Order<T0, T1>, arg2: &mut OrderIndexer, arg3: 0x2::coin::Coin<T1>, arg4: MakeDealReceipt, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::base_config::checked_package_version(arg0);
        let MakeDealReceipt {
            order_id           : v0,
            in_amount          : v1,
    ...
    fun validate_keepers<T0, T1>(arg0: &0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::base_config::BaseConfig, arg1: &0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::DCAConfig, arg2: &Order<T0, T1>, arg3: u64, arg4: vector<0x1::string::String>) : bool {
        if (0x1::vector::length<0x1::string::String>(&arg4) < 0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::keeper_threshold(arg1)) {
            return false
        };
        ...
        0x2::vec_set::size<address>(&v0) >= 0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::keeper_threshold(arg1)
    }

    fun validate_order<T0, T1>(arg0: address, arg1: &0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::base_config::BaseConfig, arg2: &0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::DCAConfig, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: 0x1::string::String, arg10: &0x2::clock::Clock) {
        assert!(0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::is_coin_allow<T0, T1>(arg2), 15);
        assert!(arg3 >= 0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::min_cycle_count(arg2), 0);
        assert!(arg4 >= arg6, 7);
        assert!(arg5 >= 0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::min_cycle_frequency(arg2), 1);
        ...
        assert!(v1 <= 0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::oracle_valid_duration(arg2), 11);
    ...
    fun verify_internal(arg0: &0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::base_config::BaseConfig, arg1: vector<u8>, arg2: &0x1::string::String, arg3: u8) : (bool, address) {
        let (v0, v1, v2) = parse_signature(0x2::hex::decode(*0x1::string::as_bytes(arg2)));
        let v3 = v2;
        let v4 = v1;
        if (arg3 == 0) {
            0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::checked_oracle(arg0, v0);
        } else {
            0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::dca_config::checked_keeper(arg0, v0);
        };
        (0x2::ed25519::ed25519_verify(&v3, &v4, &arg1), v0)
    }

    public fun withdraw<T0, T1>(arg0: &0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::base_config::BaseConfig, arg1: &mut Order<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::base_config::checked_package_version(arg0);
