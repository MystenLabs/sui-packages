module 0xb850ecad49a98ea3c3323e47d7dd3a4e143fe9edf7d08a79b500bb5d0b555347::usdq {
    ...
    fun init(arg0: USDQ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (10000000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<USDQ>>(0x2::coin::mint<USDQ>(&mut v5, 10000000000000000, arg1), v6);
        };
