module 0xb8d2044fe2c4f9db7c59f90cf0f689f1bf8a15421e67a1cd0117aac2accd2ef2::reward1553 {
    struct REWARD1553 has drop {
        dummy_field: bool,
    }

    struct TICKET_1553 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1553(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1553>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1553>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1553, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1553>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1553>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1553>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1553>>(v5, 0x2::tx_context::sender(arg1));
    }
