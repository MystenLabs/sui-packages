module 0xb87cc835088e823ea4c139c1c7a81cfd24ce20eedbfb8db09e7c0e6dc1460e1f::cnsnft4692 {
    struct CNSNFT4692 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4692, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6381"));
        let v4 = 0x2::package::claim<CNSNFT4692>(arg0, arg1);
