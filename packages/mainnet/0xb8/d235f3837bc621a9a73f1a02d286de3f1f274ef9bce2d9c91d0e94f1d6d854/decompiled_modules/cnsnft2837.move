module 0xb8d235f3837bc621a9a73f1a02d286de3f1f274ef9bce2d9c91d0e94f1d6d854::cnsnft2837 {
    struct CNSNFT2837 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2837, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5673"));
        let v4 = 0x2::package::claim<CNSNFT2837>(arg0, arg1);
