module 0x34503b8fd4b6b28cd020913768cd444d430851f49f16b7c68069cb37b011bd58::pyth {
    ...
    public fun pyth_price(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0x2::clock::Clock) {
        let v0 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::pyth::get_price_no_older_than(arg0, arg1, 100);
        ...
        let v4 = PriceEvent{
            price   : 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v3),
            decimal : 0,
            price_  : v0,
        };
        0x2::event::emit<PriceEvent>(v4);
    }
