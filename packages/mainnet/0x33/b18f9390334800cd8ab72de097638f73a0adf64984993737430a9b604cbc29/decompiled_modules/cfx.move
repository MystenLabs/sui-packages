module 0x639fc9a599c22c4fb0f28279c6f7624258a9c4ab4e54fbddc3661b6a830de357::cfx {
    ...
    fun op<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: bool, arg2: u128, arg3: u128, arg4: u64, arg5: u64, arg6: u8, arg7: u8, arg8: u64) : (u64, u64) {
        assert!(arg4 > 0, 1);
        assert!(arg4 <= arg5, 2);
        assert!(arg8 < arg4, 3);
        let v0 = 0;
        ...
        while (v4 < arg6) {
            ...
            let (v5, v6, v7, v8) = sm<T0, T1>(arg0, v3, arg1, arg2);
            if (v7) {
                break
            };
            if (!pk(v6, arg3, arg1)) {
        ...
        while (v4 < arg7) {
            ...
            let v9 = (v2 + v3) / 2;
            let (v10, v11, v12, v13) = sm<T0, T1>(arg0, v9, arg1, arg2);
            if (pk(v11, arg3, arg1) && !v12) {
                v0 = v10;
                v1 = v13;
                v2 = v9;
                continue
    ...
    fun sm<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: u64, arg2: bool, arg3: u128) : (u64, u128, bool, u64) {
        if (arg1 == 0) {
            return (0, 0, true, 0)
        };
    ...
    fun sw<T0, T1>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg2: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg3: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &0x2::clock::Clock, arg6: u128, arg7: bool, arg8: u64, arg9: u64, arg10: u8, arg11: u8, arg12: u64, arg13: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        let v2 = sp(arg6);
        let (v3, v4) = op<T0, T1>(arg0, arg7, arg6, v2, arg8, arg9, arg10, arg11, arg12);
        if (v3 < arg8) {
            return (0, 0, 0)
        };
        let (v5, v6, v7) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap_with_partner<T0, T1>(arg4, arg0, arg1, arg7, true, v3, iv(arg6), arg5);
        let v8 = v7;
        let v9 = v6;
        let v10 = v5;
        ...
        let v13 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::current_ref_fee_rate(arg1, 0x2::clock::timestamp_ms(arg5));
        let v14 = (((v4 as u128) * (v13 as u128) / 10000) as u64);
        let v15 = v11 - v14;
        let v16 = DBG{
            pay      : v11,
            sim_fee  : v4,
        ...
        assert!(v12 >= v17, 6);
        let (v18, v19) = if (arg7) {
            (0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::withdraw_coin<T0>(arg2, v11, arg13), 0x2::coin::zero<T1>(arg13))
        } else {
            (0x2::coin::zero<T0>(arg13), 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::withdraw_coin<T1>(arg3, v11, arg13))
        };
        let v20 = v19;
        let v21 = v18;
        let (v22, v23) = if (arg7) {
            (0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v21, v11, arg13)), 0x2::balance::zero<T1>())
        } else {
            (0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v20, v11, arg13)))
        };
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap_with_partner<T0, T1>(arg4, arg0, arg1, v22, v23, v8);
        0x2::coin::join<T0>(&mut v21, 0x2::coin::from_balance<T0>(v10, arg13));
        0x2::coin::join<T1>(&mut v20, 0x2::coin::from_balance<T1>(v9, arg13));
