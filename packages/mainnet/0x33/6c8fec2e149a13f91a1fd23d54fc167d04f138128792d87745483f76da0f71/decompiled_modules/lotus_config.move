module 0x336c8fec2e149a13f91a1fd23d54fc167d04f138128792d87745483f76da0f71::lotus_config {
    ...
    public fun assert_current_version(arg0: &LotusConfig) {
        assert!(arg0.current_version == 0x336c8fec2e149a13f91a1fd23d54fc167d04f138128792d87745483f76da0f71::consts::GET_CURRENT_VERSION(), 13906835067696578559);
    }
    ...
    public fun update_early_withdrawal_fee_bps(arg0: &mut LotusConfig, arg1: &LotusConfigCap, arg2: u64) {
        ...
        assert!(arg2 < 100, 13906834715509260287);
