module 0x3377b99af6447ce2bfbeab04ea4b2d29ba8828b43cdb34038ae27988037454b8::c_23_testcollectiononsui {
    struct C_23_TESTCOLLECTIONONSUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: C_23_TESTCOLLECTIONONSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<C_23_TESTCOLLECTIONONSUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"23 TestCollectionOnSui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"null"));
        ...
        let v7 = PublishEvent{
            ...
            collection_id      : 0x1::string::utf8(b"undefined"),
        };
        0x2::event::emit<PublishEvent>(v7);
