module 0x332aab6c6ffb0205224b8e407202fc943d1bb4569972bf96a7de3b64994de39e::reward3992 {
    struct REWARD3992 has drop {
        dummy_field: bool,
    }

    struct TICKET_3992 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3992(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3992>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3992>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3992, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3992>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3992>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3992>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3992>>(v5, 0x2::tx_context::sender(arg1));
    }
