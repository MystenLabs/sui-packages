module 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::umi_signer {
    ...
    public fun borrow_for_signing<T0: store + key>(arg0: &mut UmiSigner, arg1: ChainId, arg2: &0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::SigningPolicy, arg3: 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::SigningRequest, arg4: &mut 0x2::tx_context::TxContext) : (T0, BorrowReceipt<T0>) {
        assert!(has_wallet(arg0, arg1), 3);
        assert!(0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::signer_id(&arg3) == 0x2::object::id<UmiSigner>(arg0), 8);
        assert!(0x2::object::id<0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::SigningPolicy>(arg2) == arg0.policy_id, 9);
        0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::verify_request<UmiSigner>(&arg3, arg2, arg0, arg4);
        0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::destroy_request(arg3);
        ...
        let v7 = SigningOccurred{
            ...
            chain_id    : arg1.name,
            wallet_id   : v2,
            intent_hash : 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::intent_hash(&arg3),
        };
    ...
    entry fun default(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::share(v3);
        0x2::transfer::transfer<UmiSignerOwnerCap>(v2, 0x2::tx_context::sender(arg0));
        0x2::transfer::public_transfer<0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::SigningPolicyCap>(v4, 0x2::tx_context::sender(arg0));
    }
    ...
    public fun lock<T0: store + key>(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: &0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::SigningPolicy, arg4: T0, arg5: &0x2::tx_context::TxContext) {
    ...
    public fun new_with_policy(arg0: address, arg1: &mut 0x2::tx_context::TxContext) : (UmiSigner, UmiSignerOwnerCap, 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::SigningPolicy, 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::SigningPolicyCap) {
        let (v0, v1) = 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::new(arg1);
        let v2 = v1;
        let v3 = v0;
        let (v4, v5) = new_internal(arg1, 0x2::object::id<0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::SigningPolicy>(&v3), arg0);
        let v6 = 0x1::vector::empty<address>();
        0x1::vector::push_back<address>(&mut v6, arg0);
        0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::authorization_rule::add(&mut v3, &v2, v6);
        (v4, v5, v3, v2)
    }
    ...
    public fun place<T0: store + key>(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: T0, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(v1 == 0x1::ascii::string(b"0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317") || v1 == 0x1::ascii::string(b"dd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317"), 7);
        ...
        0x2::event::emit<WalletPlaced>(v2);
    }
