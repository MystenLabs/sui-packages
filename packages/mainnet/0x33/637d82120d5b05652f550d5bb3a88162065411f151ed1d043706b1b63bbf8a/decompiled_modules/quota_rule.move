module 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::quota_rule {
    ...
    public fun add(arg0: &mut 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::SigningPolicy, arg1: &0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::SigningPolicyCap, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: 0x1::option::Option<u64>) {
        ...
        0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::add_stackable_rule<Rule, Config>(v2, arg0, arg1, v3);
    }

    fun check_and_update_quota<T0: copy + drop + store>(arg0: &mut 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::umi_signer::UmiSigner, arg1: T0, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: u64, arg6: u64) {
        if (!0x2::dynamic_field::exists_<T0>(0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::umi_signer::uid(arg0), arg1)) {
            let v0 = QuotaState{
                window_start_time    : 0,
                window_request_count : 0,
                total_request_count  : 0,
            };
            0x2::dynamic_field::add<T0, QuotaState>(0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::umi_signer::uid_mut(arg0), arg1, v0);
        };
        let v1 = 0x2::dynamic_field::borrow_mut<T0, QuotaState>(0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::umi_signer::uid_mut(arg0), arg1);
        if (0x1::option::is_some<u64>(&arg2)) {
    ...
    public fun get_global_quota_state(arg0: &0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::umi_signer::UmiSigner) : (u64, u64, u64) {
        let v0 = 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::umi_signer::uid(arg0);
    ...
    public fun get_user_quota_state(arg0: &0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::umi_signer::UmiSigner, arg1: address) : (u64, u64, u64) {
        let v0 = 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::umi_signer::uid(arg0);
    ...
    public fun prove(arg0: &mut 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::SigningRequest, arg1: &0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::SigningPolicy, arg2: &mut 0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::umi_signer::UmiSigner, arg3: &0x2::tx_context::TxContext) {
        ...
        0x33637d82120d5b05652f550d5bb3a88162065411f151ed1d043706b1b63bbf8a::signing_policy::add_receipt<Rule>(v5, arg0);
    }
