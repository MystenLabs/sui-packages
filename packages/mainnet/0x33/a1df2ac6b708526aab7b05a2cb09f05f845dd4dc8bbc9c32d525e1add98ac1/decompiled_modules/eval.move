module 0x33a1df2ac6b708526aab7b05a2cb09f05f845dd4dc8bbc9c32d525e1add98ac1::eval {
    ...
    public fun evaluate_five(arg0: &vector<u8>) : HandRank {
        ...
        while (v3 < 5) {
            ...
            let v5 = 0x33a1df2ac6b708526aab7b05a2cb09f05f845dd4dc8bbc9c32d525e1add98ac1::types::card_rank(v4);
            0x1::vector::push_back<u8>(&mut v1, v5);
            0x1::vector::push_back<u8>(&mut v2, 0x33a1df2ac6b708526aab7b05a2cb09f05f845dd4dc8bbc9c32d525e1add98ac1::types::card_suit(v4));
