module 0x339b5a3a78c04f5cccb1e3e4a6f492166911d377eae8f69b3a532b98cdd37a33::cnsnft5184 {
    struct CNSNFT5184 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5184, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1696"));
        let v4 = 0x2::package::claim<CNSNFT5184>(arg0, arg1);
