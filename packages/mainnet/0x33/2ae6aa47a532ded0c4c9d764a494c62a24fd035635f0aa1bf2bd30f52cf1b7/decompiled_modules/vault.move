module 0xa0d6e83196f523bb0623187d789ce602d1f63b3e7baa02b580df7ff0ccd17e0::vault {
    ...
    public fun check_rebalance_loop<T0, T1, T2>(arg0: &0xa0d6e83196f523bb0623187d789ce602d1f63b3e7baa02b580df7ff0ccd17e0::config::GlobalConfig, arg1: &mut Strategy, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg5: &mut 0x2::tx_context::TxContext) : (vector<CheckRebalance>, 0x1::option::Option<0x2::object::ID>) {
        ...
        assert!(arg1.status == 0, 15);
        assert!(arg3 > 0, 19);
        assert!(is_vault_exists(arg1, arg2), 23);
        ...
        let v4 = 0;
        loop {
            let v5 = if (!0x1::option::is_none<0x2::object::ID>(v3)) {
                if (v1 < arg3) {
                    v4 < 200
                } else {
                    false
            ...
            if (v5) {
                let v6 = *0x1::option::borrow<0x2::object::ID>(v3);
                let v7 = check_rebalance<T0, T1, T2>(arg0, arg1, v6, arg4, arg5);
                if (v7.rebalance) {
                    0x1::vector::push_back<CheckRebalance>(&mut v0, v7);
                    v1 = v1 + 1;
                };
                v3 = 0x2::linked_table::next<0x2::object::ID, VaultInfo>(&arg1.vaults, v6);
                v4 = v4 + 1;
            } else {
                break
            };
    ...
    public fun is_vault_exists(arg0: &Strategy, arg1: 0x2::object::ID) : bool {
        0x2::linked_table::contains<0x2::object::ID, VaultInfo>(&arg0.vaults, arg1)
    }
    ...
    public fun open_vault<T0, T1, T2>(arg0: &0xa0d6e83196f523bb0623187d789ce602d1f63b3e7baa02b580df7ff0ccd17e0::config::GlobalConfig, arg1: &mut Strategy, arg2: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg3: u32, arg4: bool, arg5: u32, arg6: bool, arg7: u32, arg8: bool, arg9: u32, arg10: bool, arg11: u32, arg12: u32, arg13: &mut 0x2::tx_context::TxContext) : Vault {
        ...
        assert!(arg11 * arg1.tick_spacing < 443636, 21);
        assert!(arg12 * arg1.tick_spacing < 443636, 22);
    ...
    public(friend) fun update_vault_base_rebalance_threshold_by_owner(arg0: &0xa0d6e83196f523bb0623187d789ce602d1f63b3e7baa02b580df7ff0ccd17e0::config::GlobalConfig, arg1: &mut Strategy, arg2: &Vault, arg3: u32) : u32 {
        0xa0d6e83196f523bb0623187d789ce602d1f63b3e7baa02b580df7ff0ccd17e0::config::checked_package_version(arg0);
        borrow_mut_vault_info(arg1, 0x2::object::id<Vault>(arg2)).base_rebalance_threshold = arg3;
        arg3
    }
    ...
    public(friend) fun update_vault_limit_rebalance_threshold_by_owner(arg0: &0xa0d6e83196f523bb0623187d789ce602d1f63b3e7baa02b580df7ff0ccd17e0::config::GlobalConfig, arg1: &mut Strategy, arg2: &Vault, arg3: u32) : u32 {
        0xa0d6e83196f523bb0623187d789ce602d1f63b3e7baa02b580df7ff0ccd17e0::config::checked_package_version(arg0);
        borrow_mut_vault_info(arg1, 0x2::object::id<Vault>(arg2)).limit_rebalance_threshold = arg3;
        arg3
    }
