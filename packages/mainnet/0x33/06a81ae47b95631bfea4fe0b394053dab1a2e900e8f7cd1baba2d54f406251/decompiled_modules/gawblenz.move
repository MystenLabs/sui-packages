module 0x3306a81ae47b95631bfea4fe0b394053dab1a2e900e8f7cd1baba2d54f406251::gawblenz {
    ...
    public fun create(arg0: &mut AdminCap, arg1: &mut 0x3306a81ae47b95631bfea4fe0b394053dab1a2e900e8f7cd1baba2d54f406251::distribution::Distribution<Gawblen>, arg2: 0x1::string::String, arg3: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x3306a81ae47b95631bfea4fe0b394053dab1a2e900e8f7cd1baba2d54f406251::distribution::add_nft<Gawblen>(arg1, v1);
    ...
    public fun create_and_keep(arg0: &mut AdminCap, arg1: 0x1::string::String, arg2: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>, arg3: &0x2::transfer_policy::TransferPolicy<Gawblen>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3;
        let v5 = v2;
        0x2::kiosk::lock<Gawblen>(&mut v5, &v4, arg3, v1);
