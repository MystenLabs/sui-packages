module 0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool {
    ...
    public fun award_pulse(arg0: &mut RewardPool, arg1: u64, arg2: address, arg3: &PoolAdminCap, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.pulse_pool, arg1), arg4), arg2);
    }

    public fun award_spark(arg0: &mut RewardPool, arg1: u64, arg2: address, arg3: &PoolAdminCap, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<PrizeAwarded>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.spark_pool, arg1), arg4), arg2);
    }

    public fun award_surge(arg0: &mut RewardPool, arg1: u64, arg2: address, arg3: &PoolAdminCap, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<PrizeAwarded>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.surge_pool, arg1), arg4), arg2);
    }

    public fun deposit_yield(arg0: &mut RewardPool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &PoolAdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v0 - v2 - v3 - v4;
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v1, v2), arg3), @0x1de8cef32b6324c2ade5659caa86db8e0dc3c1fd7a76dda17ff4c8de330f5f95);
        };
