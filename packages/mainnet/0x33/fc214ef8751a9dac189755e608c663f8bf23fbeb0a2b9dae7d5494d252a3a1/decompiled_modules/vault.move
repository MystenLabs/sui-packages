module 0x33fc214ef8751a9dac189755e608c663f8bf23fbeb0a2b9dae7d5494d252a3a1::vault {
    ...
    public fun claim_referee_rewards<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x33fc214ef8751a9dac189755e608c663f8bf23fbeb0a2b9dae7d5494d252a3a1::events::emit_referee_rewards_claimed_event(0x2::balance::value<T0>(&v2));
    ...
    public fun claim_referrer_rewards<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x33fc214ef8751a9dac189755e608c663f8bf23fbeb0a2b9dae7d5494d252a3a1::events::emit_referrer_rewards_claimed_event(0x2::balance::value<T0>(&v2));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v2, arg1), v0);
    }
