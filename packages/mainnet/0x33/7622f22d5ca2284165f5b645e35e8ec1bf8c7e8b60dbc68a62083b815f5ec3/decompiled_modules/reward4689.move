module 0x337622f22d5ca2284165f5b645e35e8ec1bf8c7e8b60dbc68a62083b815f5ec3::reward4689 {
    struct REWARD4689 has drop {
        dummy_field: bool,
    }

    struct TICKET_4689 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4689(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4689>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4689>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4689, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4689>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4689>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4689>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4689>>(v5, 0x2::tx_context::sender(arg1));
    }
