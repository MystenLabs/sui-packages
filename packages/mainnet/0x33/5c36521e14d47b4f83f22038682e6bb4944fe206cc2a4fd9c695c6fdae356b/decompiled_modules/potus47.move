module 0x335c36521e14d47b4f83f22038682e6bb4944fe206cc2a4fd9c695c6fdae356b::potus47 {
    ...
    fun init(arg0: POTUS47, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<POTUS47>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<POTUS47>>(v4);
    }
