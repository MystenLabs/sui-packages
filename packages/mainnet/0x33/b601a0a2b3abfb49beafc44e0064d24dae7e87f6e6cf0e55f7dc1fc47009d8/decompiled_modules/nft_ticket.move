module 0x33b601a0a2b3abfb49beafc44e0064d24dae7e87f6e6cf0e55f7dc1fc47009d8::nft_ticket {
    ...
    public entry fun mint(arg0: vector<u8>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<LotteryTicket>(v2, 0x2::tx_context::sender(arg1));
    }
