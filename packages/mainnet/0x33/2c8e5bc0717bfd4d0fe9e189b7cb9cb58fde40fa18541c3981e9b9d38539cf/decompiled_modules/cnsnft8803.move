module 0x332c8e5bc0717bfd4d0fe9e189b7cb9cb58fde40fa18541c3981e9b9d38539cf::cnsnft8803 {
    struct CNSNFT8803 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8803, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1307"));
        let v4 = 0x2::package::claim<CNSNFT8803>(arg0, arg1);
