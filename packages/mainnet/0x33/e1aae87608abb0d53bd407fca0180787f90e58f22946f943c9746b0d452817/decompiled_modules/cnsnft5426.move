module 0x33e1aae87608abb0d53bd407fca0180787f90e58f22946f943c9746b0d452817::cnsnft5426 {
    struct CNSNFT5426 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5426, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5426>(arg0, arg1);
