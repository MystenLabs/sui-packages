module 0x337d95edf239319e079fae6472e998301775a1d3587e3e9d590f906f0ef1c58c::game_room {
    ...
    public fun complete_game(arg0: &mut GameRoomStore, arg1: address, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        v0.updated_at = v1;
        let v2 = v0.total_prize_pool * 7 / 100;
        v0.platform_fee_collected = v2;
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(0x2::coin::take<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg0.usdc_treasury, v2, arg5), @0x32572830354edf43effe74bb5f67e3fa6aa99bbc0133b9152fce5e30f45ca841);
        };
        let v3 = v0.total_prize_pool - v2;
        let v4 = 0x1::vector::length<address>(&arg2);
        let v5 = 0x1::string::as_bytes(&v0.winner_split_rule);
        let v6 = b"winner_takes_all";
        if (v5 == &v6) {
            assert!(v4 == 1, 11);
        } else {
            let v7 = b"top_2";
        ...
        while (v12 < v4) {
            ...
            let v23 = *0x1::vector::borrow<address>(&arg2, v12);
            if (0x2::table::contains<address, GameRoomParticipant>(&v0.participants, v23)) {
                let v24 = 0x2::table::borrow_mut<address, GameRoomParticipant>(&mut v0.participants, v23);
                v24.is_winner = true;
                v24.earnings = v22;
                v24.score = *0x1::vector::borrow<u64>(&arg3, v12);
            };
            if (v22 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(0x2::coin::take<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg0.usdc_treasury, v22, arg5), v23);
            };
            v12 = v12 + 1;
        };
        v0.total_prize_pool = 0;
        let v25 = GameCompleted{
            room_id          : arg1,
            winners          : arg2,
            total_prize_pool : v0.total_prize_pool,
            platform_fee     : v2,
        };
        0x2::event::emit<GameCompleted>(v25);
    }
