module 0x33ec91f0777bee3df31ca967752efb6d13c60cfba4df469ab4818198e4e2ff2e::reward_nft_w {
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = REWARD_NFT{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmZci5H91Lr5peciFeHHMqApxfr5L2zwTGUPfqC4ozpwEN"),
            };
            let v1 = MintEvent{
    ...
    fun init(arg0: REWARD_NFT_W, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmZci5H91Lr5peciFeHHMqApxfr5L2zwTGUPfqC4ozpwEN"));
