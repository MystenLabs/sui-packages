module 0x3354e84cf0fbd8bb4373234a77fa10a7ec28dd0b4b6e5ab0248731535288b81d::gift6760 {
    struct GIFT6760 has drop {
        dummy_field: bool,
    }

    struct TICKET_6760 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6760(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6760>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6760>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6760, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6760>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6760>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6760>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6760>>(v5, 0x2::tx_context::sender(arg1));
    }
