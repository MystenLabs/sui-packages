module 0x33dfab12f9aaf3a43873b3929c78cfed521c862c12617918722780a3f961db47::ai_experiments_2025 {
    struct AI_EXPERIMENTS_2025 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: AI_EXPERIMENTS_2025, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<AI_EXPERIMENTS_2025>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"AI Experiments 2025"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"AI Illustrations created by Ocularmagic in 2025."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeib24vazkmhskt2afb3bbxtzaqdus2reh7iznzsyk4c4trj43gveyu"));
