module 0x3322f429ab0ae4c5ef65594593ccd7c967fb9b918ce782a2155f6b5e52ac8efd::cnsnft1299 {
    struct CNSNFT1299 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1299, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4556"));
        let v4 = 0x2::package::claim<CNSNFT1299>(arg0, arg1);
