module 0x33711057b3d7b51cd781d9d9dbb4fd69cf03f0e14ea19949deb9214b47132790::dex_dao {
    struct PoolsGovernor has store, key {
        id: 0x2::object::UID,
        governor_profile: 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile,
        ...
        dex_dao_cap: 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::config::DexDaoCapability,
    ...
    struct PoolHive<phantom T0> has store, key {
        ...
        gems_available: 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::HiveGems,
    ...
    struct Proposal has store {
        proposal_id: u64,
        proposer: address,
        deposit: 0x2::balance::Balance<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>,
    ...
    fun accrue_hive_for_bee_box<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut LpBeeBox<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::HiveGems {
        ...
        if (v1 == 0) {
            ...
            return 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::zero()
        };
        let v2 = arg3 - arg1.last_claim_epoch;
        let v3 = 0;
        if (v2 > 0 && arg1.total_staked > 0) {
            let v4 = 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div_u256((arg0.gems_schedule.gems_per_epoch as u256), (v1 as u256), (arg0.total_gems_points as u256));
            let v5 = 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div_u256((v2 as u256), (v4 as u256), (arg1.total_staked as u256));
            arg1.global_claim_index = arg1.global_claim_index + v5;
            arg1.last_claim_epoch = arg3;
            let v6 = (0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div_u256((arg1.total_staked as u256), (v5 as u256), (1000000 as u256)) as u64);
            let v7 = 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::zero();
            if (v6 <= 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_available_gems_in_profile(&arg0.governor_profile)) {
                0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::join(&mut v7, 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::withdraw_gems_from_profile(&mut arg0.governor_profile, v6, arg4));
            };
            0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::join(&mut arg1.gems_available, v7);
        ...
        if (v9 > 0 && arg1.global_claim_index > arg2.claim_index) {
            let v10 = (0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div_u256(((arg1.global_claim_index - arg2.claim_index) as u256), (v9 as u256), (1000000 as u256)) as u64);
            v3 = v10;
            arg2.claim_index = arg1.global_claim_index;
            arg2.total_gems_earned = arg2.total_gems_earned + v10;
        };
        if (v3 > 0) {
            0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::split(&mut arg1.gems_available, v3)
        } else {
            0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::zero()
        }
    }
    ...
    public fun add_more_fruits<T0, T1>(arg0: &mut PoolHive<T0>, arg1: 0x2::balance::Balance<T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        if (v0 >= v4.start_epoch) {
            ...
            if (v7 > 0) {
                v4.claim_index = v4.claim_index + (0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div(1000000, 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div(v4.fruits_per_epoch, v7, 1000000), arg0.total_staked) as u256);
                v4.last_claim_epoch = v0;
            };
        };
        0x2::balance::join<T1>(&mut v4.available_fruits, 0x2::balance::split<T1>(&mut arg1, arg2));
        let v8 = 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div(1000000, arg2, v4.end_epoch - v6);
    ...
    public fun add_more_fruits_coins<T0, T1>(arg0: &mut PoolHive<T0>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::coin_helper::destroy_or_transfer_balance<T1>(v0, 0x2::tx_context::sender(arg3), arg3);
    }
    ...
    fun claim_fruit_for_bee_box<T0, T1>(arg0: &mut BeeFruit<T1>, arg1: &mut LpBeeBox<T0>, arg2: address, arg3: u64, arg4: u64, arg5: address, arg6: 0x1::string::String) : 0x2::balance::Balance<T1> {
        ...
        if (v3 > 0) {
            arg0.claim_index = arg0.claim_index + 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div_u256((1000000 as u256), 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div_u256((arg0.fruits_per_epoch as u256), (v3 as u256), (1000000 as u256)), (arg3 as u256));
        ...
        let v6 = (0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div_u256(((arg0.claim_index - *v5) as u256), (0x2::balance::value<T0>(&arg1.staked_balance) as u256), (1000000 as u256)) as u64);
        *v5 = arg0.claim_index;
        if (v6 > 0) {
    ...
    fun deposit_gems_and_unbond_shares<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: address, arg3: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg4: address, arg5: LpBeeBox<T0>, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T0>(&arg5.staked_balance) >= arg6, 7008);
        let v0 = &mut arg5;
        let v1 = accrue_hive_for_bee_box<T0>(arg0, arg1, v0, arg7, arg8);
        let v2 = 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::value(&v1);
        if (v2 > 0) {
            0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::deposit_gems_in_profile(arg3, v1);
        } else {
            0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::destroy_zero(v1);
        };
    ...
    public fun deposit_hive_as_incentives(arg0: &mut PoolsGovernor, arg1: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HiveVault, arg2: 0x2::coin::Coin<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::burn_hive_for_gems(arg1, &mut arg0.governor_profile, arg2, arg3, arg4);
    }

    fun deposit_into_bee_box<T0>(arg0: address, arg1: 0x1::string::String, arg2: &mut PoolsGovernor, arg3: &mut PoolHive<T0>, arg4: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg5: LpBeeBox<T0>, arg6: 0x2::balance::Balance<T0>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg5;
        let v1 = accrue_hive_for_bee_box<T0>(arg2, arg3, v0, arg7, arg8);
        let v2 = 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::value(&v1);
        if (v2 > 0) {
            0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::deposit_gems_in_profile(arg4, v1);
        } else {
            0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::destroy_zero(v1);
        };
    ...
    public fun deposit_into_bee_box_1_fruits<T0, T1>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        let (v2, _, _, _) = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_profile_meta_info(&arg0.governor_profile);
        let (v6, _, _, _, _, _, _, _) = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_following_subscription_info(arg2, v2);
        if (!v6) {
            0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::make_forever_follower_of_comp_profile(0, arg2, &mut arg0.governor_profile, arg4);
        };
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 1, 7006);
        let (v14, v15, v16, v17) = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_profile_meta_info(arg2);
    ...
    public fun deposit_into_bee_box_3_fruits<T0, T1, T2, T3>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T3>) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        let (v2, _, _, _) = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_profile_meta_info(&arg0.governor_profile);
    ...
    public fun deposit_into_bee_box_no_fruits<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x2::tx_context::epoch(arg4);
        let (v1, _, _, _) = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_profile_meta_info(&arg0.governor_profile);
        let (v5, _, _, _, _, _, _, _) = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_following_subscription_info(arg2, v1);
        if (!v5) {
            0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::make_forever_follower_of_comp_profile(0, arg2, &mut arg0.governor_profile, arg4);
        };
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 0, 7006);
        let (v13, v14, v15, v16) = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_profile_meta_info(arg2);
    ...
    fun destroy_proposal(arg0: Proposal) : (u64, address, 0x2::balance::Balance<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>, 0x1::string::String, 0x1::string::String, 0x1::string::String, u64, u64, u64, u64, u64, u64, u64, u64, 0x1::option::Option<FruitLife>, 0x1::option::Option<vector<u64>>, 0x1::option::Option<vector<u64>>, 0x1::option::Option<vector<u64>>) {
        let Proposal {
            proposal_id           : v0,
            proposer              : v1,
            deposit               : v2,
    ...
    public entry fun evaluateProposal<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HiveVault, arg3: u64, arg4: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveDisperser, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x2::object::uid_to_address(&arg1.id);
        ...
        let v4 = if (v3 == 0) {
            ...
            0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div_u128((1000000 as u128), (v2 as u128), (v3 as u128))
        };
        let v5 = 0;
        let v6 = if (arg0.vote_config.proposal_required_quorum > v4) {
            v1.proposal_status = 5;
            0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::deposit_gems_for_hive(arg4, 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::burn_hive_and_return_gems(arg2, 0x2::balance::withdraw_all<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(&mut v1.deposit), v1.proposer, arg5));
            0x1::string::to_ascii(0x1::string::utf8(b"PROPOSAL_STATUS_CANCELLED"))
        } else {
            let v7 = 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div_u128((1000000 as u128), (v1.yes_votes as u128), (v2 as u128));
            v5 = v7;
            ...
            0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::coin_helper::destroy_or_transfer_balance<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(0x2::balance::withdraw_all<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(&mut v1.deposit), v1.proposer, arg5);
            v6
        };
        ...
        0x1::string::append(&mut v9, 0x1::string::utf8(x"0a"));
        let v10 = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::entry_borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg0.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")), arg5);
    ...
    public entry fun executeProposalToAddFruit<T0, T1>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::entry_borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg0.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")), arg3);
    ...
    public entry fun executeThreePoolProposal<T0, T1, T2, T3>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::LP<T0, T1, T2, T3>>, arg2: &mut 0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::LiquidityPool<T0, T1, T2, T3>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch(arg4);
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        ...
        if (v3.proposal_type == 0) {
            ...
            0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::update_fee_for_pool<T0, T1, T2, T3>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v4, 0), *0x1::vector::borrow<u64>(&v4, 1));
        };
        if (v3.proposal_type == 1) {
            ...
            0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::update_stable_config<T0, T1, T2, T3>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v5, 0), *0x1::vector::borrow<u64>(&v5, 1), *0x1::vector::borrow<u64>(&v5, 2));
        };
        if (v3.proposal_type == 2) {
            ...
            0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::update_weighted_config<T0, T1, T2, T3>(arg2, &arg0.dex_dao_cap, 0x1::option::extract<vector<u64>>(&mut v3.new_weights), *0x1::vector::borrow<u64>(&v6, 0));
        };
        if (v3.proposal_type == 3) {
            ...
            0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::update_curved_A_and_gamma<T0, T1, T2, T3>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v7, 0), *0x1::vector::borrow<u64>(&v7, 1), (*0x1::vector::borrow<u64>(&v7, 2) as u256), *0x1::vector::borrow<u64>(&v7, 3));
        };
        ...
        0x1::string::append(&mut v10, 0x1::string::utf8(x"0a"));
        let v11 = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::entry_borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg0.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")), arg4);
    ...
    public entry fun executeTwoPoolProposal<T0, T1, T2>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::LP<T0, T1, T2>>, arg2: &mut 0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::LiquidityPool<T0, T1, T2>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch(arg4);
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        let v2 = 0x1::string::to_ascii(0x1::string::utf8(b"PROPOSAL_EXECUTED"));
        ...
        if (v3.proposal_type == 0) {
            v2 = 0x1::string::to_ascii(0x1::string::utf8(b"UPDATE_FEE_BREAKDOWN_EXECUTED"));
            let v4 = 0x1::option::extract<vector<u64>>(&mut v3.new_fee_info);
            0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::update_fee_for_pool<T0, T1, T2>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v4, 0), *0x1::vector::borrow<u64>(&v4, 1));
        };
        if (v3.proposal_type == 1) {
            v2 = 0x1::string::to_ascii(0x1::string::utf8(b"UPDATE_STABLE_CONFIG_EXECUTED"));
            let v5 = 0x1::option::extract<vector<u64>>(&mut v3.new_params);
            0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::update_stable_config<T0, T1, T2>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v5, 0), *0x1::vector::borrow<u64>(&v5, 1), *0x1::vector::borrow<u64>(&v5, 2));
        };
        if (v3.proposal_type == 2) {
            v2 = 0x1::string::to_ascii(0x1::string::utf8(b"UPDATE_WEIGHTED_CONFIG_EXECUTED"));
            let v6 = 0x1::option::extract<vector<u64>>(&mut v3.new_params);
            0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::update_weighted_config<T0, T1, T2>(arg2, &arg0.dex_dao_cap, 0x1::option::extract<vector<u64>>(&mut v3.new_weights), *0x1::vector::borrow<u64>(&v6, 0));
        };
        if (v3.proposal_type == 3) {
            v2 = 0x1::string::to_ascii(0x1::string::utf8(b"UPDATE_CURVED_A_AND_GAMMA_EXECUTED"));
            let v7 = 0x1::option::extract<vector<u64>>(&mut v3.new_params);
            0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::update_curved_A_and_gamma<T0, T1, T2>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v7, 0), *0x1::vector::borrow<u64>(&v7, 1), (*0x1::vector::borrow<u64>(&v7, 2) as u256), *0x1::vector::borrow<u64>(&v7, 3));
        };
        if (v3.proposal_type == 4) {
            v2 = 0x1::string::to_ascii(0x1::string::utf8(b"UPDATE_CURVED_FEE_PARAMS_EXECUTED"));
            let v8 = 0x1::option::extract<vector<u64>>(&mut v3.new_params);
            0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::update_curved_config_fee_params<T0, T1, T2>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v8, 0), *0x1::vector::borrow<u64>(&v8, 1), *0x1::vector::borrow<u64>(&v8, 2), *0x1::vector::borrow<u64>(&v8, 3), *0x1::vector::borrow<u64>(&v8, 4), *0x1::vector::borrow<u64>(&v8, 5));
        };
        let v9 = 0x2::linked_table::borrow<0x1::ascii::String, SystemBuzz>(&arg0.managed_buzzes, v2);
        let v10 = v9.buzz;
        0x1::string::append(&mut v10, 0x1::string::utf8(x"0a0a"));
    ...
    public fun get_pool_hive<T0>(arg0: &PoolHive<T0>) : (u64, u64, u64, u256, u64, u64, vector<0x1::ascii::String>) {
        (arg0.total_staked, arg0.total_unbonding, 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::value(&arg0.gems_available), arg0.global_claim_index, arg0.last_claim_epoch, arg0.next_proposal_id, arg0.bee_fruit_list)
    }
    ...
    public fun initialize_pools_manager(arg0: &0x2::clock::Clock, arg1: 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::config::DexDaoCapability, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2e9498df0f78cd3fed9eb78a58ab3a622dc43df1332da201bb7d6a12070bbb02::hsui_vault::HSuiVault, arg4: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfileMappingStore, arg5: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveManager, arg6: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HSuiDisperser<0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hsui::HSUI>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::entry_add_to_composable_profile<PoolGovernorBuzzes>(&mut v2, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")), v3, arg17);
        let v4 = GemsSchedule{
            start_epoch    : arg8,
            end_epoch      : arg8 + 352,
            gems_per_epoch : 0,
        ...
        let v5 = VoteConfig{
            ...
            proposal_required_quorum    : 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div(1000000, arg14, 100),
            proposal_approval_threshold : 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div(1000000, arg15, 100),
        };
    ...
    public entry fun interact_with_governance_buzz(arg0: &mut PoolsGovernor, arg1: &0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg2: u64, arg3: 0x1::string::String, arg4: &0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3) = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_profile_meta_info(arg1);
        if (!v2) {
    ...
    public entry fun kraft_new_pool_hive_three_token_amm<T0, T1, T2, T3>(arg0: &mut PoolsGovernor, arg1: &mut 0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::LiquidityPool<T0, T1, T2, T3>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 7038);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::LP<T0, T1, T2, T3>>());
        let v1 = 0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::get_liquidity_pool_id<T0, T1, T2, T3>(arg1);
        ...
        let v6 = PoolHive<0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::LP<T0, T1, T2, T3>>{
            id                 : v3,
            total_staked       : 0,
            total_unbonding    : 0,
            lp_bee_boxes       : 0x2::linked_table::new<address, LpBeeBox<0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::LP<T0, T1, T2, T3>>>(arg2),
            gems_available     : 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::zero(),
        ...
        0x2::transfer::share_object<PoolHive<0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::LP<T0, T1, T2, T3>>>(v6);
        ...
        let v8 = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::entry_borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg0.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")), arg2);
        ...
        0x66955644aee942db479b15cda60d11bc1bc6d67fa90024667142c900391b0d1a::three_pool::set_pool_hive_addr<T0, T1, T2, T3>(arg1, &arg0.dex_dao_cap, v5);
    }

    public entry fun kraft_new_pool_hive_two_token_amm<T0, T1, T2>(arg0: &mut PoolsGovernor, arg1: &mut 0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::LiquidityPool<T0, T1, T2>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 7038);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::LP<T0, T1, T2>>());
        let v1 = 0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::get_liquidity_pool_id<T0, T1, T2>(arg1);
        let v2 = 0x2::tx_context::epoch(arg2);
        assert!(!0x2::linked_table::contains<0x1::ascii::String, address>(&arg0.pool_hives, v0), 7005);
        let v3 = 0x2::object::new(arg2);
        let v4 = 0x2::object::uid_to_inner(&v3);
        let v5 = 0x2::object::id_to_address(&v4);
        let v6 = PoolHive<0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::LP<T0, T1, T2>>{
            id                 : v3,
            total_staked       : 0,
            total_unbonding    : 0,
            lp_bee_boxes       : 0x2::linked_table::new<address, LpBeeBox<0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::LP<T0, T1, T2>>>(arg2),
            gems_available     : 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::hive_gems::zero(),
            global_claim_index : 0,
            last_claim_epoch   : v2,
            bee_fruit_list     : 0x1::vector::empty<0x1::ascii::String>(),
        ...
        0x2::transfer::share_object<PoolHive<0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::LP<T0, T1, T2>>>(v6);
        0x2::linked_table::push_back<0x1::ascii::String, address>(&mut arg0.pool_hives, v0, v5);
        0x2::linked_table::push_back<address, u64>(&mut arg0.gems_points_map, v5, 0);
        arg0.active_pool_hives = arg0.active_pool_hives + 1;
        let v7 = 0x2::linked_table::borrow<0x1::ascii::String, SystemBuzz>(&arg0.managed_buzzes, 0x1::string::to_ascii(0x1::string::utf8(b"POOL_HIVE_KRAFTED")));
        ...
        0x2::event::emit<PoolHiveKraftd>(v9);
        0x6bd8a0e73fe2dfaa3a2839ea627c5fd1fbc3bbfc37e074abb1ab9f2bb58588a1::two_pool::set_pool_hive_addr<T0, T1, T2>(arg1, &arg0.dex_dao_cap, v5);
    }

    public fun like_governor_buzz(arg0: &mut PoolsGovernor, arg1: &0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3) = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_profile_meta_info(arg1);
        if (!v2) {
    ...
    public entry fun removeExpiredProposal<T0>(arg0: &mut PoolHive<T0>, arg1: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HiveVault, arg2: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveDisperser, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 7038);
        ...
        let v19 = v3;
        if (0x2::balance::value<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(&v19) > 0) {
            0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::deposit_gems_for_hive(arg2, 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::burn_hive_and_return_gems(arg1, v19, v2, arg4));
        } else {
            0x2::balance::destroy_zero<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(v19);
        };
    ...
    public entry fun submit_proposal<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: 0x2::coin::Coin<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>, arg3: u64, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::option::Option<vector<u64>>, arg8: 0x1::option::Option<vector<u64>>, arg9: 0x1::option::Option<vector<u64>>, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch(arg10);
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        let v2 = 0x1::string::to_ascii(0x1::string::utf8(b"INVALID_PROPOSAL_TYPE"));
        let v3 = 0x2::coin::into_balance<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(arg2);
        assert!(arg0.vote_config.proposal_required_deposit <= 0x2::balance::value<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(&v3), 7018);
        ...
        if (arg3 == 4) {
            ...
            0xdde9a76be1b28fd2752658c13a0ef08079a7dd8407573621cf1d59be698c9a07::curved_math::assert_new_config_params(*0x1::vector::borrow<u64>(&v16, 0), *0x1::vector::borrow<u64>(&v16, 1), *0x1::vector::borrow<u64>(&v16, 2), *0x1::vector::borrow<u64>(&v16, 3), *0x1::vector::borrow<u64>(&v16, 4), *0x1::vector::borrow<u64>(&v16, 5));
            assert!(0x1::vector::length<u64>(&v16) >= 6, 7019);
        };
        let v17 = Proposal{
            proposal_id           : arg1.next_proposal_id,
            proposer              : 0x2::tx_context::sender(arg10),
            deposit               : 0x2::balance::split<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(&mut v3, arg0.vote_config.proposal_required_deposit),
            title                 : arg4,
            description           : arg5,
            link                  : arg6,
            proposal_type         : arg3,
        ...
        let v21 = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::entry_borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg0.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")), arg10);
        make_new_governor_buzz(v21, v1, v20, v19.gen_ai, arg10);
        0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::coin_helper::destroy_or_transfer_balance<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(v3, 0x2::tx_context::sender(arg10), arg10);
    }

    public entry fun submit_proposal_to_add_fruit<T0, T1>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: 0x2::coin::Coin<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>, arg3: u64, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch(arg9);
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        let v2 = 0x2::coin::into_balance<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(arg2);
        assert!(arg0.vote_config.proposal_required_deposit <= 0x2::balance::value<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(&v2), 7018);
        ...
        let v4 = Proposal{
            ...
            deposit               : 0x2::balance::split<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(&mut v2, arg0.vote_config.proposal_required_deposit),
            title                 : arg4,
            description           : arg5,
            link                  : arg6,
            proposal_type         : arg3,
        ...
        arg1.next_proposal_id = arg1.next_proposal_id + 1;
        let v8 = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::entry_borrow_mut_from_composable_profile<PoolGovernorBuzzes>(&mut arg0.governor_profile, 0x1::string::to_ascii(0x1::string::utf8(b"pool_governor_buzzes")), arg9);
        make_new_governor_buzz(v8, v1, v7, v6.gen_ai, arg9);
        0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::coin_helper::destroy_or_transfer_balance<0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive::HIVE>(v2, 0x2::tx_context::sender(arg9), arg9);
    }

    public fun transition_into_next_gems_cycle(arg0: &0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::config::HiveDaoCapability, arg1: &mut PoolsGovernor, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 0, 7038);
        ...
        arg1.gems_schedule.gems_per_epoch = arg1.gems_schedule.gems_per_epoch + 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div_u128((arg1.gems_schedule.gems_per_epoch as u128), (v1 as u128), (1000000 as u128));
    ...
    public fun unbond_from_bee_box_1_fruit<T0, T1>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 1, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
    ...
    public fun unbond_from_bee_box_2_fruits<T0, T1, T2>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 2, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
    ...
    public fun unbond_from_bee_box_3_fruits<T0, T1, T2, T3>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T3>) {
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 3, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        let (v2, v3, v4) = verify_and_extract_bee_box<T0>(arg0, arg1, arg2, arg4);
    ...
    public fun unbond_from_bee_box_no_fruit<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 0, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
    ...
    public fun unlike_governor_buzz(arg0: &mut PoolsGovernor, arg1: &0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3) = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_profile_meta_info(arg1);
        if (!v2) {
            assert!(v3 == 0x2::tx_context::sender(arg3), 7041);
        };
    ...
    public fun unlock_from_bee_box<T0>(arg0: &mut PoolHive<T0>, arg1: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg2: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert!(arg0.module_version == 0, 7038);
        let (v0, v1, v2, v3) = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_profile_meta_info(arg1);
    ...
    public fun update_gems_per_epoch(arg0: &mut PoolsGovernor, arg1: &0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::config::HiveDaoCapability, arg2: u64) {
        assert!(arg0.module_version == 0, 7038);
        assert!(arg2 < 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_available_gems_in_profile(&arg0.governor_profile) / 3, 7040);
    ...
    public fun update_pool_hive_points(arg0: &mut PoolsGovernor, arg1: &0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::config::HiveDaoCapability, arg2: vector<address>, arg3: vector<u64>) {
        assert!(arg0.module_version == 0, 7038);
    ...
    public fun update_pools_governance_params(arg0: &mut PoolsGovernor, arg1: &0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::config::HiveDaoCapability, arg2: vector<u64>) {
        assert!(arg0.module_version == 0, 7038);
        ...
        if (50 >= v5 && v5 >= 10) {
            arg0.vote_config.proposal_required_quorum = 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div(1000000, v5, 100);
        };
        let v6 = *0x1::vector::borrow<u64>(&arg2, 6);
        if (70 > v6 && v6 >= 40) {
            arg0.vote_config.proposal_approval_threshold = 0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::math::mul_div(1000000, v6, 100);
        };
    ...
    public fun update_system_buzz(arg0: &mut PoolsGovernor, arg1: &0xf16195c9c3d7b8abb884c854848adfbcee550ed37558fa7ec67da8ffaf593c2e::config::BuidlersRoyaltyCollectionAbility, arg2: 0x1::ascii::String, arg3: 0x1::string::String, arg4: 0x1::option::Option<0x1::string::String>, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    fun verify_and_extract_bee_box<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::HiveProfile, arg3: &mut 0x2::tx_context::TxContext) : (LpBeeBox<T0>, address, 0x1::string::String) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let (v0, v1, v2, v3) = 0x8e95d85cf522a6be4c4cce8ec2be389fbc877cc2c3e9b77c4b95476eecf47fc2::hive_profile::get_profile_meta_info(arg2);
