module 0x33a4b1b650e385e2676fe293c2ceacc48071fabc1cc0548f1d1bc5b7704aa26a::cnsnft8227 {
    struct CNSNFT8227 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8227, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8227>(arg0, arg1);
