module 0x338da168a8d10cc6598f9e9726919e01e43543ebac3aea73a30b0239a971dd50::sui_miner {
    ...
    public fun attributes(arg0: &SuiMiner) : &0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        &arg0.attributes
    }
    ...
    public entry fun mint(arg0: &AdminCap, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<SuiMiner>(v2, arg6);
    }
