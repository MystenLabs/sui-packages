module 0x336c2d0fe2a4993a9787a6626adb0d2a2eb57a37ce43e5d0bc9388ede981fe4b::reward2730 {
    struct REWARD2730 has drop {
        dummy_field: bool,
    }

    struct TICKET_2730 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2730(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2730>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2730>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2730, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2730>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2730>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2730>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2730>>(v5, 0x2::tx_context::sender(arg1));
    }
