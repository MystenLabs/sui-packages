module 0x338d774988ae5a48c7110e8129f8d022f629e22f5ff0e96c733cd00091dbc721::reward7321 {
    struct REWARD7321 has drop {
        dummy_field: bool,
    }

    struct TICKET_7321 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7321(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7321>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7321>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7321, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7321>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7321>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7321>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7321>>(v5, 0x2::tx_context::sender(arg1));
    }
