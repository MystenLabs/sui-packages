module 0x333bf1018cfc3640e3379e2541734241994df60b4e3bba42be4a9f57c3e3385c::reward2959 {
    struct REWARD2959 has drop {
        dummy_field: bool,
    }

    struct TICKET_2959 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2959(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2959>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2959>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2959, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2959>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2959>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2959>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2959>>(v5, 0x2::tx_context::sender(arg1));
    }
