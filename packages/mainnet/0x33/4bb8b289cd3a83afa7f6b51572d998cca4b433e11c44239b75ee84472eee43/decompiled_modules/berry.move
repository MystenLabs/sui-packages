module 0x334bb8b289cd3a83afa7f6b51572d998cca4b433e11c44239b75ee84472eee43::berry {
    struct BERRY has drop {
        dummy_field: bool,
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<BERRY>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<BERRY>>(0x2::coin::mint<BERRY>(arg0, arg1, arg3), arg2);
    }

    fun init(arg0: BERRY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = trim_right(b"111111111   ");
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/5XUEeFuEKsgd27HrQTqkEe157Wb366c9ApgE3YAypump.png?size=lg&key=01911e                                                                                                                                                                                                            ");
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<BERRY>>(0x2::coin::mint<BERRY>(&mut v5, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
