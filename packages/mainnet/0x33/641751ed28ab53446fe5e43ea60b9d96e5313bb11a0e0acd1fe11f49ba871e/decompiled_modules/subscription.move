module 0x33641751ed28ab53446fe5e43ea60b9d96e5313bb11a0e0acd1fe11f49ba871e::subscription {
    ...
    public entry fun create_tier(arg0: u64, arg1: u64, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<Tier>(v2);
    }
    ...
    public entry fun renew(arg0: &mut SubscriptionToken, arg1: &Tier, arg2: &mut 0x33641751ed28ab53446fe5e43ea60b9d96e5313bb11a0e0acd1fe11f49ba871e::creator_profile::CreatorProfile, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(arg0.subscriber == v0, 1);
        assert!(arg1.active, 2);
        assert!(0x2::object::id<Tier>(arg1) == arg0.tier_id, 1);
        assert!(0x33641751ed28ab53446fe5e43ea60b9d96e5313bb11a0e0acd1fe11f49ba871e::creator_profile::get_creator(arg2) == arg1.creator, 1);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) >= arg1.price, 3);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, arg1.price, arg5), arg1.creator);
        0x33641751ed28ab53446fe5e43ea60b9d96e5313bb11a0e0acd1fe11f49ba871e::creator_profile::add_earnings(arg2, arg1.price);
    ...
    public entry fun subscribe(arg0: &Tier, arg1: &mut 0x33641751ed28ab53446fe5e43ea60b9d96e5313bb11a0e0acd1fe11f49ba871e::creator_profile::CreatorProfile, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.active, 2);
        assert!(0x33641751ed28ab53446fe5e43ea60b9d96e5313bb11a0e0acd1fe11f49ba871e::creator_profile::get_creator(arg1) == arg0.creator, 1);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= arg0.price, 3);
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        let v2 = v1 + arg0.duration;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, arg0.price, arg4), arg0.creator);
        0x33641751ed28ab53446fe5e43ea60b9d96e5313bb11a0e0acd1fe11f49ba871e::creator_profile::increment_subscriber_count(arg1);
        0x33641751ed28ab53446fe5e43ea60b9d96e5313bb11a0e0acd1fe11f49ba871e::creator_profile::add_earnings(arg1, arg0.price);
