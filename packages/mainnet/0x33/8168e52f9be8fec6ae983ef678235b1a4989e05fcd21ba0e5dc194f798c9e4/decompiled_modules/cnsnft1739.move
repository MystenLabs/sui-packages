module 0x338168e52f9be8fec6ae983ef678235b1a4989e05fcd21ba0e5dc194f798c9e4::cnsnft1739 {
    struct CNSNFT1739 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1739, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3070"));
        let v4 = 0x2::package::claim<CNSNFT1739>(arg0, arg1);
