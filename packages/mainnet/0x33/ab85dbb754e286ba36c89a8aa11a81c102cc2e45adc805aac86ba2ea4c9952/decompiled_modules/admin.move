module 0x48db008a3c9e638dd17d20702632d9909c3c075e44eb339f890fb29503ec3050::admin {
    ...
    public entry fun bootstrap_v2_state(arg0: &0x2::package::UpgradeCap, arg1: &mut 0x2::tx_context::TxContext) : AdminCap {
        ...
        assert!(0x2::object::id_to_address(&v0) == @0x0, 0x48db008a3c9e638dd17d20702632d9909c3c075e44eb339f890fb29503ec3050::constants::err_not_bootstrapped());
        let v1 = BootstrapRegistry{
            id   : 0x2::object::new(arg1),
            done : false,
        };
        let v2 = &mut v1;
        0x2::transfer::share_object<BootstrapRegistry>(v1);
        bootstrap(v2, arg1)
    }
