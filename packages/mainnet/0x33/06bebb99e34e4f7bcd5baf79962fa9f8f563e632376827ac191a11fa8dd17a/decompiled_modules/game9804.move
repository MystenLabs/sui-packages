module 0x3306bebb99e34e4f7bcd5baf79962fa9f8f563e632376827ac191a11fa8dd17a::game9804 {
    struct GAME9804 has drop {
        dummy_field: bool,
    }

    struct TICKET_9804 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9804(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9804>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9804>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME9804, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME9804>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9804>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9804>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9804>>(v5, 0x2::tx_context::sender(arg1));
    }
