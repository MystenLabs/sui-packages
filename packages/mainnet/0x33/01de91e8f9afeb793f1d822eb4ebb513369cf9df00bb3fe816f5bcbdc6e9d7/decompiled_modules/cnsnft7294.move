module 0x3301de91e8f9afeb793f1d822eb4ebb513369cf9df00bb3fe816f5bcbdc6e9d7::cnsnft7294 {
    struct CNSNFT7294 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7294, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7294>(arg0, arg1);
