module 0x33f5c9c1ebb9fc0e72caf60bac0120dd471071d292c75cd3ee5d350839f0794d::critical_mass {
    struct Game has key {
        id: 0x2::object::UID,
    ...
    public entry fun admin_set_state(arg0: &mut Game, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun admin_withdraw_fees(arg0: &mut Game, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.admin_balance), arg1), arg0.admin);
    }
    ...
    public entry fun buy_key(arg0: &mut Game, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.current_key_price = arg0.current_key_price + 50000000;
