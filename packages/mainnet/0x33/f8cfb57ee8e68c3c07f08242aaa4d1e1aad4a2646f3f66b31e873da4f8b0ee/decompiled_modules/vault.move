module 0xf4719ea787e63d9c21d6f5711e1b65110dd8b4f23c14ceab16fa20ab8ac023f4::vault {
    ...
    public fun create_and_transfer_vault<T0>(arg0: address, arg1: &mut 0x2::tx_context::TxContext) : 0xf4719ea787e63d9c21d6f5711e1b65110dd8b4f23c14ceab16fa20ab8ac023f4::helper::CapInfo {
        let (v0, v1) = create_vault<T0>(arg1);
        let v2 = v1;
        transfer_vault<T0>(v0, arg0, arg1);
        transfer_vault_cap<T0>(v2, arg0);
        0xf4719ea787e63d9c21d6f5711e1b65110dd8b4f23c14ceab16fa20ab8ac023f4::helper::create_cap_info<T0>(0x2::object::id<VaultCap<T0>>(&v2))
    }
    ...
    public(friend) fun withdraw_by_pool_type<T0>(arg0: &mut Vault<T0>, arg1: &0x1::ascii::String) : 0x2::balance::Balance<T0> {
        assert!(0xf4719ea787e63d9c21d6f5711e1b65110dd8b4f23c14ceab16fa20ab8ac023f4::helper::validate_pool_type(arg1), 0);
    ...
    public(friend) fun withdraw_vault_monthly_direct<T0>(arg0: &mut Vault<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        0x2::balance::split<T0>(&mut arg0.monthly_balance, arg1)
    }
    ...
    public(friend) fun withdraw_vault_yearly_direct<T0>(arg0: &mut Vault<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        0x2::balance::split<T0>(&mut arg0.yearly_balance, arg1)
    }
