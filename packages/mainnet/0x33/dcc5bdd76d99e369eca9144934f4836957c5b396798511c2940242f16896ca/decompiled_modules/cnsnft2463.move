module 0x33dcc5bdd76d99e369eca9144934f4836957c5b396798511c2940242f16896ca::cnsnft2463 {
    struct CNSNFT2463 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2463, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2463>(arg0, arg1);
