module 0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::subscription {
    ...
    public entry fun create_account(arg0: &mut SkillRegistryAdmin, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        create_account_impl(arg0, v0, v0, arg1);
    }

    fun create_account_impl(arg0: &mut SkillRegistryAdmin, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<WalcraftAccount>(v0, arg2);
    }

    fun delegate_has_access(arg0: &SkillRegistryAdmin, arg1: &0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::SkillVersion, arg2: address) : bool {
        if (!0x2::table::contains<address, 0x2::object::ID>(&arg0.delegate_accounts, arg2)) {
            return false
        };
        0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::version_has_allowed_account(arg1, *0x2::table::borrow<address, 0x2::object::ID>(&arg0.delegate_accounts, arg2))
    }
    ...
    fun owner_has_access(arg0: &SkillRegistryAdmin, arg1: &0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::SkillVersion, arg2: address) : bool {
        if (!0x2::table::contains<address, 0x2::object::ID>(&arg0.accounts, arg2)) {
            return false
        };
        0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::version_has_allowed_account(arg1, *0x2::table::borrow<address, 0x2::object::ID>(&arg0.accounts, arg2))
    }
    ...
    entry fun seal_approve(arg0: vector<u8>, arg1: &SkillRegistryAdmin, arg2: &0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::SkillVersion, arg3: &0x2::tx_context::TxContext) {
        assert!(arg1.version == 1, 300);
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = if (arg0 == *0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::version_seal_key_id(arg2)) {
            if (arg1.admin == v0) {
                true
    ...
    public fun seal_key_id(arg0: &0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::SkillVersion) : vector<u8> {
        *0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::version_seal_key_id(arg0)
    }
    ...
    public entry fun subscribe(arg0: &mut WalcraftAccount, arg1: &mut WalcraftAccount, arg2: &0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::SkillRegistry, arg3: &mut 0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::SkillVersion, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 300);
        assert!(arg1.version == 1, 300);
        assert!(can_manage_account(arg0, 0x2::tx_context::sender(arg4)), 108);
        let v0 = 0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::version_price(arg3);
        assert!(v0 > 0, 103);
        assert!(0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::version_registry_id(arg3) == 0x2::object::id<0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::SkillRegistry>(arg2), 203);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.balance) >= v0, 100);
        let v1 = 0x2::object::id<WalcraftAccount>(arg0);
        assert!(!0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::version_has_allowed_account(arg3, v1), 104);
        assert!(arg1.owner == 0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::registry_owner(arg2), 108);
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.balance, 0x2::balance::split<0x2::sui::SUI>(&mut arg0.balance, v0));
        0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::add_allowed_account(arg3, v1);
        arg0.total_spent = arg0.total_spent + v0;
        let v2 = Subscribed{
            account_id  : v1,
            owner       : arg0.owner,
            registry_id : 0x2::object::id<0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::SkillRegistry>(arg2),
            version_id  : 0x2::object::id<0x3389b8589ec31afd6787d3d8af5d498e9248010efbbd99ceb2113df5cbdb1a4d::registry::SkillVersion>(arg3),
            amount_paid : v0,
            paid_by     : 0x2::tx_context::sender(arg4),
        };
        0x2::event::emit<Subscribed>(v2);
    }
