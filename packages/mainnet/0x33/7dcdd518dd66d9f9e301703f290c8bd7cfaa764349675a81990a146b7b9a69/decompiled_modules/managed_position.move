module 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position {
    ...
    struct FrozenExitConsent<phantom T0> has store, key {
        id: 0x2::object::UID,
    ...
    struct FrozenExitConsentKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    struct InKindOwnerPayout<phantom T0> {
        position_id: 0x2::object::ID,
        leg_accounting_id: 0x2::object::ID,
        destination: address,
        shares_burned: u128,
    ...
    struct ConsentedForceExitTicket<phantom T0> {
    ...
    struct ForceExitAdapterReceipt<phantom T0, phantom T1> {
        registry_id: 0x2::object::ID,
        strategy_id: vector<u8>,
        guardrails_id: 0x2::object::ID,
        guardrails_hash: vector<u8>,
    ...
    struct InKindCostBasisRemoved has copy, drop {
        position_id: 0x2::object::ID,
        leg_accounting_id: 0x2::object::ID,
        payout_destination: address,
        shares_burned: u128,
    ...
    public(friend) fun adapter_nonce_for_package(arg0: &OpportunityAccounting) : u64 {
        arg0.adapter_nonce
    }
    ...
    public(friend) fun assert_exact_adapter_binding<T0, T1>(arg0: &OpportunityAccounting, arg1: vector<u8>) {
        assert_adapter_source<T0, T1>(arg0);
        assert!(arg0.adapter_id == arg1, 28);
    }
    ...
    public(friend) fun attest_force_exit_adapter_return<T0: drop, T1>(arg0: &OpportunityAccounting, arg1: &Position, arg2: ConsentedForceExitTicket<T1>, arg3: &T0, arg4: 0x1::option::Option<0x2::coin::Coin<T1>>) : ForceExitAdapterReceipt<T0, T1> {
        let ConsentedForceExitTicket {
            ...
            position_id           : v8,
            pot_id                : v9,
            accounting_asset      : v10,
            native_asset_binding  : v11,
            adapter_source        : v12,
            adapter_nonce         : v13,
            shares                : v14,
            reserved_basis_micros : v15,
            settle_after_ms       : v16,
        } = arg2;
        let v17 = v11;
        assert_adapter_receipt<T0, T1>(arg0, v7, v12, v13);
        assert!(v8 == 0x2::object::id<Position>(arg1), 32);
        assert!(arg1.shares == v14, 32);
        assert!(arg0.accounting_asset == v10, 32);
        assert!(0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::guardrails_v2::same_native_asset_binding(&arg0.native_asset_binding, &v17), 32);
        assert!(preview_deployed_exit_basis<T1>(arg0, arg1, v14) == v15, 32);
    ...
    public(friend) fun authorize_consented_force_exit<T0>(arg0: &OpportunityAccounting, arg1: &Position, arg2: 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::leader_policy::EnteredExitModeAuthorization, arg3: 0x2::object::ID, arg4: u64, arg5: u64) : ConsentedForceExitTicket<T0> {
        let (v0, v1, v2, v3, v4, v5, v6) = 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::leader_policy::consume_entered_exit_mode_authorization(arg2);
        assert!(arg4 > arg5, 33);
        assert!(0x2::object::id<OpportunityAccounting>(arg0) == arg1.leg_accounting_id, 5);
        assert!(arg0.accounting_asset == 0x1::type_name::with_original_ids<T0>(), 6);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.strategy_registry_id), 32);
        assert!(0x1::option::is_some<vector<u8>>(&arg0.strategy_id), 32);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.guardrails_id), 32);
        assert!(0x1::option::is_some<vector<u8>>(&arg0.guardrails_hash), 32);
        assert!(*0x1::option::borrow<0x2::object::ID>(&arg0.strategy_registry_id) == v0, 32);
        assert!(*0x1::option::borrow<vector<u8>>(&arg0.strategy_id) == v1, 32);
        assert!(*0x1::option::borrow<0x2::object::ID>(&arg0.guardrails_id) == v2, 32);
        assert!(*0x1::option::borrow<vector<u8>>(&arg0.guardrails_hash) == v3, 32);
        assert!(matches_force_exit_policy(arg1, v1, v2, v4), 24);
        let v7 = arg1.shares;
        assert!(v7 > 0, 2);
        assert!(arg0.total_assets_micros <= arg0.fee_basis_assets_micros, 31);
        ConsentedForceExitTicket<T0>{
            registry_id           : v0,
            strategy_id           : v1,
            guardrails_id         : v2,
            guardrails_hash       : v3,
            ...
            position_id           : 0x2::object::id<Position>(arg1),
            pot_id                : arg3,
            accounting_asset      : arg0.accounting_asset,
            native_asset_binding  : arg0.native_asset_binding,
            adapter_source        : arg0.adapter_source,
            adapter_nonce         : arg0.adapter_nonce,
            shares                : v7,
            reserved_basis_micros : preview_deployed_exit_basis<T0>(arg0, arg1, v7),
            settle_after_ms       : arg4,
        }
    }

    public(friend) fun authorize_full_owner_in_kind_exit<T0: drop, T1>(arg0: &mut OpportunityAccounting, arg1: &mut Position, arg2: &T0, arg3: u128, arg4: &0x2::tx_context::TxContext) : InKindOwnerPayout<T1> {
        assert_adapter_source<T0, T1>(arg0);
        assert!(0x2::tx_context::sender(arg4) == arg1.depositor, 3);
        assert!(0x2::object::id<OpportunityAccounting>(arg0) == arg1.leg_accounting_id, 5);
        assert!(0x1::type_name::with_original_ids<T1>() == arg1.origin_asset, 6);
        let v0 = arg1.shares;
        assert!(v0 > 0, 2);
        assert!(arg0.total_shares >= v0, 16);
        assert!(arg3 > 0, 1);
        assert!(arg0.deployed_assets_micros >= arg3, 22);
        assert!(arg0.total_assets_micros >= arg3, 10);
        let v1 = arg0.total_shares;
        arg1.shares = 0;
        arg0.total_shares = arg0.total_shares - v0;
        reduce_fee_basis_for_burn(arg0, v0, v1);
        arg0.deployed_assets_micros = arg0.deployed_assets_micros - arg3;
        arg0.total_assets_micros = arg0.total_assets_micros - arg3;
        arg0.adapter_nonce = arg0.adapter_nonce + 1;
        assert_accounting_invariant(arg0);
        let v2 = 0x2::object::id<Position>(arg1);
        let v3 = arg1.leg_accounting_id;
        let v4 = arg1.payout_destination;
        let v5 = InKindCostBasisRemoved{
            position_id               : v2,
            leg_accounting_id         : v3,
            payout_destination        : v4,
            shares_burned             : v0,
            cost_basis_removed_micros : arg3,
            terminal_adapter_nonce    : arg0.adapter_nonce,
        };
        0x2::event::emit<InKindCostBasisRemoved>(v5);
        InKindOwnerPayout<T1>{
            position_id            : v2,
            leg_accounting_id      : v3,
            destination            : v4,
            shares_burned          : v0,
    ...
    public(friend) fun cancel_frozen_exit_consent<T0>(arg0: &mut OpportunityAccounting, arg1: &mut Position, arg2: 0x2::object::ID, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg1.depositor, 3);
        let v0 = FrozenExitConsentKey{dummy_field: false};
        assert!(0x2::dynamic_object_field::exists_<FrozenExitConsentKey>(&arg1.id, v0), 24);
        let v1 = FrozenExitConsentKey{dummy_field: false};
        let FrozenExitConsent {
            ...
            position_id               : v6,
            shares                    : v7,
            frozen_assets_micros      : v8,
            frozen_pps                : _,
            reserved_fee_basis_micros : _,
            fee_basis_before_micros   : v11,
            high_water_before_pps     : v12,
            payout_destination        : _,
            self_settle_deadline_ms   : v14,
        } = 0x2::dynamic_object_field::remove<FrozenExitConsentKey, FrozenExitConsent<T0>>(&mut arg1.id, v1);
        assert!(v3 == arg2, 24);
        assert!(v4 == 0x2::object::id<OpportunityAccounting>(arg0), 5);
        assert!(v5 == arg0.accounting_asset, 6);
        assert!(v6 == 0x2::object::id<Position>(arg1), 5);
        assert!(arg3 > v14, 24);
        arg1.shares = arg1.shares + v7;
        arg0.total_shares = arg0.total_shares + v7;
        arg0.deployed_assets_micros = arg0.deployed_assets_micros + v8;
        arg0.total_assets_micros = arg0.total_assets_micros + v8;
        arg0.fee_basis_assets_micros = v11;
        arg0.high_water_pps = v12;
        assert_accounting_invariant(arg0);
    ...
    public(friend) fun consume_and_reserve_consented_force_exit<T0, T1>(arg0: &mut OpportunityAccounting, arg1: &mut Position, arg2: 0x2::object::ID, arg3: u64, arg4: ForceExitAdapterReceipt<T0, T1>) : (address, u128, u128, 0x1::option::Option<0x2::coin::Coin<T1>>) {
        ...
        assert!(v8 == 0x2::object::id<Position>(arg1), 32);
        assert!(arg0.accounting_asset == v10, 32);
        assert!(0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::guardrails_v2::same_native_asset_binding(&arg0.native_asset_binding, &v18), 32);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.strategy_registry_id), 32);
        assert!(0x1::option::is_some<vector<u8>>(&arg0.strategy_id), 32);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.guardrails_id), 32);
        assert!(0x1::option::is_some<vector<u8>>(&arg0.guardrails_hash), 32);
        ...
        assert!(*0x1::option::borrow<vector<u8>>(&arg0.guardrails_hash) == v3, 32);
        assert!(matches_force_exit_policy(arg1, v1, v2, v4), 24);
        assert!(v14 > 0 && v14 == arg1.shares, 32);
        assert!(v15 == preview_deployed_exit_basis<T1>(arg0, arg1, v14), 32);
        assert!(arg0.total_assets_micros <= arg0.fee_basis_assets_micros, 31);
        let v19 = arg0.total_shares;
        arg1.shares = 0;
        arg0.total_shares = arg0.total_shares - v14;
        reduce_fee_basis_for_burn(arg0, v14, v19);
        arg0.deployed_assets_micros = arg0.deployed_assets_micros - v15;
        arg0.total_assets_micros = arg0.total_assets_micros - v15;
        arg0.adapter_nonce = arg0.adapter_nonce + 1;
        assert_accounting_invariant(arg0);
        let v20 = arg1.payout_destination;
        let v21 = OwnerExitRecorded{
            position_id        : v8,
            leg_accounting_id  : arg1.leg_accounting_id,
            payout_destination : v20,
            origin_chain       : arg1.origin_chain,
            origin_asset       : arg1.origin_asset,
            shares_burned      : v14,
            assets_micros      : v15,
        };
        0x2::event::emit<OwnerExitRecorded>(v21);
        (v20, v14, v15, v17)
    }

    public(friend) fun consume_frozen_exit_consent<T0>(arg0: &OpportunityAccounting, arg1: &mut Position, arg2: 0x2::object::ID) : (u128, u128, u128, u128, address) {
        let v0 = FrozenExitConsentKey{dummy_field: false};
        assert!(0x2::dynamic_object_field::exists_<FrozenExitConsentKey>(&arg1.id, v0), 24);
        let v1 = FrozenExitConsentKey{dummy_field: false};
        let FrozenExitConsent {
            ...
            frozen_assets_micros      : v8,
            frozen_pps                : v9,
            reserved_fee_basis_micros : v10,
            fee_basis_before_micros   : _,
            high_water_before_pps     : _,
            payout_destination        : v13,
    ...
    public(friend) fun consume_in_kind_owner_payout<T0>(arg0: InKindOwnerPayout<T0>) : (0x2::object::ID, 0x2::object::ID, address, u128, u128, u64) {
        let InKindOwnerPayout {
            position_id            : v0,
            leg_accounting_id      : v1,
            destination            : v2,
            shares_burned          : v3,
            cost_basis_micros      : v4,
            terminal_adapter_nonce : v5,
        } = arg0;
        (v0, v1, v2, v3, v4, v5)
    }
    ...
    fun record_and_share_local_deposit<T0>(arg0: &mut OpportunityAccounting, arg1: vector<0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_route::RouteLegBinding>, arg2: 0x1::option::Option<0x2::object::ID>, arg3: u128, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = record_local_deposit_internal<T0>(arg0, arg1, arg2, arg3, arg4);
        0x2::transfer::share_object<Position>(v0);
    ...
    public(friend) fun record_local_deposit<T0>(arg0: &mut OpportunityAccounting, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, 0x2::coin::Coin<T0>) {
        ...
        (record_and_share_local_deposit<T0>(arg0, v0, 0x1::option::none<0x2::object::ID>(), (0x2::coin::value<T0>(&arg1) as u128), arg2), arg1)
    }
    ...
    public(friend) fun record_local_deposit_with_verified_route<T0>(arg0: &mut OpportunityAccounting, arg1: vector<0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_route::RouteLegBinding>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, 0x2::coin::Coin<T0>) {
        assert_plain_accounting(arg0);
        (record_and_share_local_deposit<T0>(arg0, arg1, 0x1::option::none<0x2::object::ID>(), (0x2::coin::value<T0>(&arg2) as u128), arg3), arg2)
    }
    ...
    public(friend) fun record_managed_local_deposit<T0>(arg0: &mut OpportunityAccounting, arg1: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::day::ProtocolConfig, arg2: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::strategy_registry::StrategyRegistry, arg3: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::guardrails_v2::GuardrailsV2, arg4: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::adapter_registry::AdapterRegistryV2, arg5: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::leader_policy::LeaderPolicy, arg6: u64, arg7: 0x2::coin::Coin<T0>, arg8: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, 0x2::coin::Coin<T0>) {
        ...
        (record_and_share_local_deposit<T0>(arg0, v1, v0, (0x2::coin::value<T0>(&arg7) as u128), arg8), arg7)
    }
    ...
    public(friend) fun record_managed_local_deposit_with_verified_route<T0>(arg0: &mut OpportunityAccounting, arg1: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::day::ProtocolConfig, arg2: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::strategy_registry::StrategyRegistry, arg3: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::guardrails_v2::GuardrailsV2, arg4: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::adapter_registry::AdapterRegistryV2, arg5: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::leader_policy::LeaderPolicy, arg6: vector<0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_route::RouteLegBinding>, arg7: u64, arg8: 0x2::coin::Coin<T0>, arg9: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, 0x2::coin::Coin<T0>) {
        ...
        (record_and_share_local_deposit<T0>(arg0, arg6, v0, (0x2::coin::value<T0>(&arg8) as u128), arg9), arg8)
    }
    ...
    public(friend) fun reserve_deployed_exit_for_frozen_consent<T0>(arg0: &mut OpportunityAccounting, arg1: &mut Position, arg2: 0x2::object::ID, arg3: u128, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == arg1.depositor, 3);
        let v0 = FrozenExitConsentKey{dummy_field: false};
        assert!(!0x2::dynamic_object_field::exists_<FrozenExitConsentKey>(&arg1.id, v0), 24);
        let v1 = price_per_share_micros(arg0);
        let v2 = arg0.fee_basis_assets_micros;
        let v3 = arg0.high_water_pps;
        let v4 = if (arg3 == arg0.total_shares) {
            arg0.fee_basis_assets_micros
        } else {
            convert_to_assets(arg3, arg0.fee_basis_assets_micros, arg0.total_shares)
        };
        let v5 = reserve_deployed_exit_for_closeout<T0>(arg0, arg1, arg3, arg5);
        let v6 = FrozenExitConsent<T0>{
            ...
            position_id               : 0x2::object::id<Position>(arg1),
            shares                    : arg3,
            frozen_assets_micros      : v5,
            frozen_pps                : v1,
            reserved_fee_basis_micros : v4,
            fee_basis_before_micros   : v2,
            high_water_before_pps     : v3,
            payout_destination        : arg1.payout_destination,
            self_settle_deadline_ms   : arg4,
        };
        let v7 = FrozenExitConsentKey{dummy_field: false};
        0x2::dynamic_object_field::add<FrozenExitConsentKey, FrozenExitConsent<T0>>(&mut arg1.id, v7, v6);
    }
