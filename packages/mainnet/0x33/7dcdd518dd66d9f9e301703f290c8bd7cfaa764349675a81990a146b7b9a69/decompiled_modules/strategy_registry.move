module 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::strategy_registry {
    ...
    fun assert_required_guardrails_refinement(arg0: &StrategyRegistry, arg1: &vector<u8>, arg2: 0x2::object::ID, arg3: &vector<u8>) {
        ...
        let v1 = GuardrailsRefinementAnchorKey{strategy_id: *arg1};
        assert!(0x2::dynamic_field::exists<GuardrailsRefinementAnchorKey>(&arg0.id, v1), 18);
        let v2 = 0x2::dynamic_field::borrow<GuardrailsRefinementAnchorKey, GuardrailsRefinementAnchor>(&arg0.id, v1);
        assert!(v2.v1_guardrails_id == 0x2::object::id_from_address(@0x789341ea271ad1171fe0d8b6df181c9d6cdbc21b518475246005ffa17db29cb8), 18);
        assert!(v2.v1_guardrails_hash == x"76961077934bb9149397e1cd1aa6d9744a213fa2fec92b9ab98bdbb8099f9827", 18);
        assert!(v2.v2_guardrails_id == arg2, 18);
        assert!(&v2.v2_guardrails_hash == arg3, 18);
    }
