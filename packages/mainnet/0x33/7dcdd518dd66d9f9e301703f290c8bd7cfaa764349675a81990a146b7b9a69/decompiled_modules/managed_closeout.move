module 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_closeout {
    ...
    public(friend) fun cancel_frozen_exit_pot_consent<T0>(arg0: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::OpportunityAccounting, arg1: &FrozenExitPot<T0>, arg2: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::Position, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(!arg1.funded, 13);
        0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::cancel_frozen_exit_consent<T0>(arg0, arg2, 0x2::object::id<FrozenExitPot<T0>>(arg1), 0x2::clock::timestamp_ms(arg3), arg4);
    }
    ...
    public(friend) fun force_exit_pot_binding<T0>(arg0: &FrozenExitPot<T0>) : (0x2::object::ID, u64) {
        (0x2::object::id<FrozenExitPot<T0>>(arg0), arg0.self_settle_deadline_ms)
    }

    public(friend) fun fund_frozen_exit_pot_from_consent<T0, T1>(arg0: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::OpportunityAccounting, arg1: &mut FrozenExitPot<T1>, arg2: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::Position, arg3: 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::AdapterReturnReceipt<T0, T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let (v0, v1, v2, v3, v4) = 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::consume_frozen_exit_consent<T1>(arg0, arg2, 0x2::object::id<FrozenExitPot<T1>>(arg1));
        let v5 = 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::consume_adapter_full_return<T0, T1>(arg0, 0x2::object::id<FrozenExitPot<T1>>(arg1), arg3);
        let v6 = if (0x1::option::is_some<0x2::coin::Coin<T1>>(&v5)) {
            0x1::option::destroy_some<0x2::coin::Coin<T1>>(v5)
        } else {
            0x1::option::destroy_none<0x2::coin::Coin<T1>>(v5);
            0x2::coin::zero<T1>(arg4)
        };
        let v7 = v6;
        let v8 = (0x2::coin::value<T1>(&v7) as u128);
        assert!(v1 <= 18446744073709551615, 10);
        assert!(v8 <= 18446744073709551615, 10);
        let v9 = if (v8 >= v1) {
            v1
        } else {
            v8
        ...
        let (v11, v12, v13, v14) = 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::fee_policy_for_package(arg0);
        let v15 = mul_bps_floor(v10, v11);
        let v16 = v8 - v9;
        let v17 = if (v15 > v16) {
            v16
        } else {
        ...
        let v18 = mul_bps_floor(v17, v12);
        let v19 = v17 - v18;
        assert!(v19 <= 18446744073709551615 && v18 <= 18446744073709551615, 10);
        if (v19 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v7, (v19 as u64), arg4), v13);
        };
        if (v18 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v7, (v18 as u64), arg4), v14);
        };
        let v20 = if (v9 > 0) {
            0x2::coin::split<T1>(&mut v7, (v9 as u64), arg4)
        } else {
            0x2::coin::zero<T1>(arg4)
        };
        let v21 = (0x2::coin::value<T1>(&v7) as u128);
        if (v21 > 0) {
            0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::credit_remaining_leg_dust(arg0, v21);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v7, 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::adapter_destination_for_package(arg0));
        } else {
            0x2::coin::destroy_zero<T1>(v7);
        };
        let v22 = FrozenExitClaim{
            ...
            share_start            : 0,
            share_end              : v0,
            reserved_assets_micros : v9,
        };
        let v23 = 0x2::object::id<FrozenExitClaim>(&v22);
        0x2::dynamic_object_field::add<0x2::object::ID, FrozenExitClaim>(&mut arg1.id, v23, v22);
        arg1.total_reserved_shares = v0;
        arg1.remaining_reserved_shares = v0;
        arg1.total_reserved_assets_micros = v9;
        arg1.remaining_reserved_assets_micros = v9;
        arg1.measured_total_micros = v9;
        arg1.exit_pps = v2;
        arg1.active_claims = 1;
        arg1.funded = true;
        0x2::balance::join<T1>(&mut arg1.proceeds, 0x2::coin::into_balance<T1>(v20));
        v23
    }
    ...
    public fun owner_cancel_frozen_exit_consent<T0>(arg0: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::OpportunityAccounting, arg1: &FrozenExitPot<T0>, arg2: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::Position, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        cancel_frozen_exit_pot_consent<T0>(arg0, arg1, arg2, arg3, arg4);
    }

    public fun owner_fund_frozen_exit_from_consent<T0, T1>(arg0: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::OpportunityAccounting, arg1: &mut FrozenExitPot<T1>, arg2: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::Position, arg3: 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::AdapterReturnReceipt<T0, T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        fund_frozen_exit_pot_from_consent<T0, T1>(arg0, arg1, arg2, arg3, arg4)
    }

    public fun owner_prepare_frozen_exit_with_consent<T0>(arg0: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::OpportunityAccounting, arg1: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::Position, arg2: u128, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        prepare_frozen_exit_pot_with_consent<T0>(arg0, arg1, arg2, arg3, arg4, arg5)
    }

    public(friend) fun prepare_consented_force_exit_pot<T0>(arg0: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::OpportunityAccounting, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : FrozenExitPot<T0> {
        let v0 = 0x2::clock::timestamp_ms(arg1);
        new_frozen_exit_pot<T0>(0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::accounting_id(arg0), 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::accounting_asset(arg0), v0 + 300000, v0, arg2)
    }
    ...
    public(friend) fun prepare_frozen_exit_pot<T0>(arg0: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::OpportunityAccounting, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : FrozenExitPot<T0> {
        assert_package_frozen_exit_deadline(0x2::clock::timestamp_ms(arg2), arg1);
        abort 17
    }

    public(friend) fun prepare_frozen_exit_pot_with_consent<T0>(arg0: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::OpportunityAccounting, arg1: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::Position, arg2: u128, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x2::clock::timestamp_ms(arg4);
        assert_package_frozen_exit_deadline(v0, arg3);
        let v1 = new_frozen_exit_pot<T0>(0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::accounting_id(arg0), 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::accounting_asset(arg0), arg3, v0, arg5);
        let v2 = 0x2::object::id<FrozenExitPot<T0>>(&v1);
        0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::reserve_deployed_exit_for_frozen_consent<T0>(arg0, arg1, v2, arg2, arg3, arg5);
        0x2::transfer::share_object<FrozenExitPot<T0>>(v1);
        v2
    }
    ...
    public(friend) fun reserve_and_fund_consented_force_exit_pot<T0, T1>(arg0: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::OpportunityAccounting, arg1: FrozenExitPot<T1>, arg2: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::Position, arg3: 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::ForceExitAdapterReceipt<T0, T1>, arg4: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, 0x2::object::ID) {
        assert!(arg1.ledger_id == 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::accounting_id(arg0), 12);
        assert!(arg1.accounting_asset == 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::accounting_asset(arg0), 8);
        assert!(!arg1.funded && arg1.active_claims == 0, 13);
        let (v0, v1, v2, v3) = 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::consume_and_reserve_consented_force_exit<T0, T1>(arg0, arg2, 0x2::object::id<FrozenExitPot<T1>>(&arg1), arg1.self_settle_deadline_ms, arg3);
        let v4 = v3;
        let v5 = if (0x1::option::is_some<0x2::coin::Coin<T1>>(&v4)) {
            (0x2::coin::value<T1>(0x1::option::borrow<0x2::coin::Coin<T1>>(&v4)) as u128)
        } else {
            0
        };
        assert!(v5 <= v2, 18);
        let v6 = FrozenExitClaim{
            id                     : 0x2::object::new(arg4),
            ledger_id              : arg1.ledger_id,
            accounting_asset       : arg1.accounting_asset,
            payout_destination     : v0,
            position_id            : 0x2::object::id<0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::Position>(arg2),
            shares                 : v1,
            share_start            : 0,
            share_end              : v1,
            reserved_assets_micros : v2,
        };
        let v7 = 0x2::object::id<FrozenExitClaim>(&v6);
        0x2::dynamic_object_field::add<0x2::object::ID, FrozenExitClaim>(&mut arg1.id, v7, v6);
        arg1.total_reserved_shares = v1;
        arg1.remaining_reserved_shares = v1;
        arg1.total_reserved_assets_micros = v2;
        arg1.remaining_reserved_assets_micros = v2;
        arg1.measured_total_micros = v5;
        let v8 = if (v1 == 0) {
            0
        } else {
            (((v5 as u256) * (1000000 as u256) / (v1 as u256)) as u128)
        };
        arg1.exit_pps = v8;
        arg1.active_claims = 1;
        arg1.funded = true;
        if (0x1::option::is_some<0x2::coin::Coin<T1>>(&v4)) {
            0x2::balance::join<T1>(&mut arg1.proceeds, 0x2::coin::into_balance<T1>(0x1::option::destroy_some<0x2::coin::Coin<T1>>(v4)));
        } else {
            0x1::option::destroy_none<0x2::coin::Coin<T1>>(v4);
        };
        0x2::transfer::share_object<FrozenExitPot<T1>>(arg1);
        (0x2::object::id<FrozenExitPot<T1>>(&arg1), v7)
    }
