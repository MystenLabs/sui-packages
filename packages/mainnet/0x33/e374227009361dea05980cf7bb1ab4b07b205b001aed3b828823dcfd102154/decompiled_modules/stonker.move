module 0x33e374227009361dea05980cf7bb1ab4b07b205b001aed3b828823dcfd102154::stonker {
    ...
    fun adjust_maker_orders(arg0: &Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::tx_context::TxContext) {
        ...
        let (v0, v1) = get_asset_balances(arg1, arg2);
        if (convert_to_quote_at_price(arg0, v0, arg4) + v1 < 15000 * 1000000) {
            return
        };
        let v2 = arg4 / 10000;
        let v3 = v2 * arg0.parameters.maker_shallow_place_bps_times_1k / 1000;
        let v4 = v3 / 4;
        let v5 = v2 * arg0.parameters.maker_deep_place_bps_times_1k / 1000;
        let v6 = v5 / 4;
        let v7 = 0x2::vec_set::into_keys<u128>(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::account_open_orders<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1));
        if (0x1::vector::length<u128>(&v7) > 4) {
            ...
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::cancel_all_orders<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v8, arg3, arg7);
            v7 = 0x2::vec_set::into_keys<u128>(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::account_open_orders<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1));
        };
        let v9 = &mut v7;
        sort_vector(v9);
        let v10 = 0;
        ...
        let v15 = 0;
        let v16 = 0;
        while (v16 < 0x1::vector::length<u128>(&v7)) {
            let v17 = *0x1::vector::borrow<u128>(&v7, v16);
            v16 = v16 + 1;
            assert!(v17 != 0, 13906837859425320959);
            if (order_is_bid(v17)) {
                if (v13 == 0) {
                    v14 = v17;
                    continue
        ...
        ensure_maker_order_is_correct(arg0, arg1, arg2, v10, arg4 - v3, v4, true, arg0.parameters.maker_max_shallow_quantity_base, 0, arg5, arg6, arg3, arg7);
        ensure_maker_order_is_correct(arg0, arg1, arg2, v12, arg4 + v3, v4, false, arg0.parameters.maker_max_shallow_quantity_base, 0, arg5, arg6, arg3, arg7);
        if (arg0.parameters.maker_deep_trades_enabled) {
            ensure_maker_order_is_correct(arg0, arg1, arg2, v14, arg4 - v5, v6, true, arg0.parameters.maker_max_deep_quantity_base, 1, arg5, arg6, arg3, arg7);
            ensure_maker_order_is_correct(arg0, arg1, arg2, v15, arg4 + v5, v6, false, arg0.parameters.maker_max_deep_quantity_base, 1, arg5, arg6, arg3, arg7);
        };
    }

    fun check_sender(arg0: &Stonker, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 13906834621019979775);
    }
    ...
    fun ensure_maker_order_is_correct(arg0: &Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: u128, arg4: u64, arg5: u64, arg6: bool, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock, arg12: &0x2::tx_context::TxContext) {
        ...
        if (arg6) {
            let v5 = arg7;
            let v6 = convert_to_base_at_price(arg0, get_available_quote_balance(arg1), arg4);
            if (arg7 > v6) {
                v5 = v6;
            };
            ...
            let v13 = arg7;
            let v14 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0x2::sui::SUI>(arg1);
            if (arg7 > v14) {
                v13 = v14;
            };
    ...
    public fun input_signal(arg0: &mut Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: &0x2::clock::Clock, arg5: u64, arg6: u8, arg7: u64, arg8: u64, arg9: &0x2::tx_context::TxContext) {
        ...
        if (arg6 == 0 || arg6 == 1) {
            try_make_taker_trade(arg0, arg1, arg2, arg3, arg4, arg5, arg6 == 0, v10, v11, arg9);
        };
        adjust_maker_orders(arg0, arg1, arg2, arg4, arg5, v10, v11, arg9);
    }
    ...
    public fun set_maker_max_deep_quantity_base(arg0: &mut Stonker, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        check_sender(arg0, arg2);
        arg0.parameters.maker_max_deep_quantity_base = arg1;
    }
