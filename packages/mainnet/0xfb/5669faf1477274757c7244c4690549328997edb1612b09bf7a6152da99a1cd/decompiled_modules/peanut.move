module 0xfb5669faf1477274757c7244c4690549328997edb1612b09bf7a6152da99a1cd::peanut {
    ...
    fun init(arg0: PEANUT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<PEANUT>(&mut v3, 420690000000000000, 0x2::tx_context::sender(arg1), arg1);
