module 0xfbe102fe3c9a30c00f980490ae96a750f682ee1c43eedf15cf2f7a47e561ac37::reward6490 {
    struct REWARD6490 has drop {
        dummy_field: bool,
    }

    struct TICKET_6490 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6490(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6490>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6490>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6490, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6490>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6490>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6490>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6490>>(v5, 0x2::tx_context::sender(arg1));
    }
