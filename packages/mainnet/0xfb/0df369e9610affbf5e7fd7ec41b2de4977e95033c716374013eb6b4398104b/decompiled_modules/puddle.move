module 0xfb0df369e9610affbf5e7fd7ec41b2de4977e95033c716374013eb6b4398104b::puddle {
    ...
    public entry fun invest<T0: drop, T1: drop>(arg0: &mut PuddleCap<T0>, arg1: &mut 0x2::coin::TreasuryCap<T1>, arg2: &mut Puddles<T0>, arg3: &mut 0xfb0df369e9610affbf5e7fd7ec41b2de4977e95033c716374013eb6b4398104b::invest::God<T0>, arg4: address, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T0>(&arg2.balance) >= arg5, 14);
        let v0 = 0x2::object::id_from_address(arg4);
        if (0x1::vector::contains<0x2::object::ID>(&arg2.investments.invests, &v0)) {
            0x2::table::add<0x2::object::ID, u64>(&mut arg2.investments.cost_table, v0, 0x2::table::remove<0x2::object::ID, u64>(&mut arg2.investments.cost_table, v0) + arg5);
            0x2::balance::join<T1>(0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T1>>(&mut arg2.investments.balanec_bag, v0), 0xfb0df369e9610affbf5e7fd7ec41b2de4977e95033c716374013eb6b4398104b::invest::buy_coin<T0, T1>(arg1, arg3, arg4, 0x2::balance::split<T0>(&mut arg2.balance, arg5), arg5, arg6));
        } else {
            0x1::vector::push_back<0x2::object::ID>(&mut arg2.investments.invests, v0);
            0x2::table::add<0x2::object::ID, u64>(&mut arg2.investments.cost_table, v0, arg5);
            0x2::bag::add<0x2::object::ID, 0x2::balance::Balance<T1>>(&mut arg2.investments.balanec_bag, v0, 0xfb0df369e9610affbf5e7fd7ec41b2de4977e95033c716374013eb6b4398104b::invest::buy_coin<T0, T1>(arg1, arg3, arg4, 0x2::balance::split<T0>(&mut arg2.balance, arg5), arg5, arg6));
        };
    }

    public entry fun arbitrage<T0: drop, T1: drop>(arg0: &mut PuddleCap<T1>, arg1: &mut 0x2::coin::TreasuryCap<T0>, arg2: &mut Puddles<T1>, arg3: &mut 0xfb0df369e9610affbf5e7fd7ec41b2de4977e95033c716374013eb6b4398104b::invest::God<T1>, arg4: address, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id_from_address(arg4);
        let v1 = 0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg2.investments.balanec_bag, v0);
        assert!(arg5 <= 0x2::balance::value<T0>(v1), 14);
        let v2 = 0xfb0df369e9610affbf5e7fd7ec41b2de4977e95033c716374013eb6b4398104b::invest::sale_coin<T0, T1>(arg1, arg3, arg4, v1, arg5, arg6);
        let v3 = *0x2::table::borrow<0x2::object::ID, u64>(&arg2.investments.cost_table, v0);
        let v4 = 0x2::balance::value<T1>(&v2) - v3;
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v2, v4 * (arg2.commission_percentage as u64) / 100), arg6), arg2.metadata.trader);
        if (0x2::balance::value<T1>(&v2) > v3) {
            let v5 = 0x2::balance::split<T1>(&mut v2, v4 * (100 - (arg2.commission_percentage as u64)) / 100);
            let v6 = &mut v5;
            give_out_bonus<T1>(arg2, v6, arg6);
            if (0x2::balance::value<T1>(&v5) == 0) {
                0x2::balance::destroy_zero<T1>(v5);
            } else {
                0x2::balance::join<T1>(&mut arg2.balance, v5);
            };
        };
        0x2::balance::join<T1>(&mut arg2.balance, v2);
    }
    ...
    public entry fun create_puddle<T0: drop>(arg0: &mut PuddleStatistics, arg1: u64, arg2: address, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = new_puddle<T0>(arg1, arg2, arg3, arg4);
        let v1 = PuddleCap<T0>{
        ...
        0x2::table::add<0x2::object::ID, address>(&mut arg0.puddle_owner_table, 0x2::object::uid_to_inner(&v0.id), 0x2::tx_context::sender(arg4));
    ...
    public fun new_puddle<T0: drop>(arg0: u64, arg1: address, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) : Puddles<T0> {
        let v0 = HolderInfo{
            holders             : 0x1::vector::empty<address>(),
            holder_amount_table : 0x2::table::new<address, u64>(arg3),
        };
        let v1 = MarketInfo{
            items              : 0x1::vector::empty<0x2::object::ID>(),
            item_listing_table : 0x2::table::new<0x2::object::ID, bool>(arg3),
        };
        ...
        let v3 = InvestmentsRecord{
            ...
            cost_table    : 0x2::table::new<0x2::object::ID, u64>(arg3),
            balanec_bag   : 0x2::bag::new(arg3),
            total_rewards : 0,
        };
        let v4 = PuddleState{
            is_close     : false,
