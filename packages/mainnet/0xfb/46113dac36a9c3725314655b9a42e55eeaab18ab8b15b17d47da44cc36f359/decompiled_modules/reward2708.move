module 0xfb46113dac36a9c3725314655b9a42e55eeaab18ab8b15b17d47da44cc36f359::reward2708 {
    struct REWARD2708 has drop {
        dummy_field: bool,
    }

    struct TICKET_2708 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2708(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2708>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2708>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2708, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2708>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2708>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2708>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2708>>(v5, 0x2::tx_context::sender(arg1));
    }
