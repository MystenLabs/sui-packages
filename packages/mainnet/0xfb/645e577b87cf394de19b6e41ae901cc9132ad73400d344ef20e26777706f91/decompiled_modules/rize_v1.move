module 0x688bc8ddbf5f1ddd188186590d597300139ff377e1f63275efedd9bea6bd3a6b::rize_v1 {
    ...
    struct TestUpgradeContract has copy, drop {
        dummy_field: bool,
    }
    ...
    public fun increment_version(arg0: &mut RizeV1, arg1: &0x688bc8ddbf5f1ddd188186590d597300139ff377e1f63275efedd9bea6bd3a6b::role::AdminCap) {
        0x688bc8ddbf5f1ddd188186590d597300139ff377e1f63275efedd9bea6bd3a6b::version::increment_version(&mut arg0.version);
    }
    ...
    public fun some_upgraded_contract(arg0: &RizeV1) {
        check_version(arg0);
        let v0 = TestUpgradeContract{dummy_field: false};
        0x2::event::emit<TestUpgradeContract>(v0);
    }
