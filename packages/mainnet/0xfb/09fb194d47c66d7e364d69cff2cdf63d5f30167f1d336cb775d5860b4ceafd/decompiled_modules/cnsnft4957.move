module 0xfb09fb194d47c66d7e364d69cff2cdf63d5f30167f1d336cb775d5860b4ceafd::cnsnft4957 {
    struct CNSNFT4957 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4957, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4957>(arg0, arg1);
