module 0xfb96218825f75561d909ec33a910ea05ce6d80502df3c35d27cba41f8de76f11::cnsnft4872 {
    struct CNSNFT4872 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4872, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4872>(arg0, arg1);
