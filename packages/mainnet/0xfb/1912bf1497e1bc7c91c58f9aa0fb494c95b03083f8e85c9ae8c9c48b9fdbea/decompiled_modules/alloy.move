module 0xfb1912bf1497e1bc7c91c58f9aa0fb494c95b03083f8e85c9ae8c9c48b9fdbea::alloy {
    ...
    struct MarketInstance has store {
        market_name: 0x1::string::String,
        guesses: 0xfb1912bf1497e1bc7c91c58f9aa0fb494c95b03083f8e85c9ae8c9c48b9fdbea::big_queue::BigQueue<Guess>,
        round_number: u64,
        ai_prediction: 0x1::option::Option<u64>,
    ...
    public fun create_market_instance<T0>(arg0: &MarketAdminCap, arg1: &mut MarketConfig, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = MarketInstance{
            market_name         : arg3,
            guesses             : 0xfb1912bf1497e1bc7c91c58f9aa0fb494c95b03083f8e85c9ae8c9c48b9fdbea::big_queue::new<Guess>(5000, arg7),
    ...
    public fun debug(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0x2::clock::Clock) {
        ...
        let v5 = Debug{
            ...
            price_id : 0x1::string::utf8(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v4)),
        };
    ...
    public fun place_guess<T0>(arg0: &mut MarketConfig, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: address, arg5: u64, arg6: 0x2::coin::Coin<T0>, arg7: 0x1::string::String, arg8: &0x2::clock::Clock) {
        ...
        0xfb1912bf1497e1bc7c91c58f9aa0fb494c95b03083f8e85c9ae8c9c48b9fdbea::big_queue::push_back<Guess>(&mut v4.guesses, v5);
    }
    ...
    public fun release_unsettled_market<T0>(arg0: &MarketAdminCap, arg1: &mut MarketConfig, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: &0x2::clock::Clock, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<u64>(&arg6)) {
            v3 = 0xfb1912bf1497e1bc7c91c58f9aa0fb494c95b03083f8e85c9ae8c9c48b9fdbea::big_queue::length<Guess>(&v2.guesses) - *0x1::option::borrow<u64>(&arg6);
        };
        while (0xfb1912bf1497e1bc7c91c58f9aa0fb494c95b03083f8e85c9ae8c9c48b9fdbea::big_queue::length<Guess>(&v2.guesses) > v3) {
            let v4 = 0xfb1912bf1497e1bc7c91c58f9aa0fb494c95b03083f8e85c9ae8c9c48b9fdbea::big_queue::pop_front<Guess>(&mut v2.guesses);
        ...
        if (0xfb1912bf1497e1bc7c91c58f9aa0fb494c95b03083f8e85c9ae8c9c48b9fdbea::big_queue::length<Guess>(&v2.guesses) == 0) {
            v2.released = true;
    ...
    public fun settle_or_continue<T0>(arg0: &MarketAdminCap, arg1: &mut MarketConfig, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: 0x1::option::Option<u64>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0;
        if (0x1::option::is_some<u64>(&arg6)) {
            v5 = 0xfb1912bf1497e1bc7c91c58f9aa0fb494c95b03083f8e85c9ae8c9c48b9fdbea::big_queue::length<Guess>(&v4.guesses) - *0x1::option::borrow<u64>(&arg6);
        };
        while (0xfb1912bf1497e1bc7c91c58f9aa0fb494c95b03083f8e85c9ae8c9c48b9fdbea::big_queue::length<Guess>(&v4.guesses) > v5) {
            let v6 = 0xfb1912bf1497e1bc7c91c58f9aa0fb494c95b03083f8e85c9ae8c9c48b9fdbea::big_queue::pop_front<Guess>(&mut v4.guesses);
        ...
        if (0xfb1912bf1497e1bc7c91c58f9aa0fb494c95b03083f8e85c9ae8c9c48b9fdbea::big_queue::length<Guess>(&v4.guesses) == 0) {
            v4.settled = true;
