module 0xfb9d746bc8a2c1a11d7f78af15e6522b6a65597ef375db7446d6f97a182e5d7e::easy_swap {
    ...
    public fun easy_swap_A<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun easy_swap_B<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::coin::into_balance<T1>(arg2);
        let v2 = 0x2::balance::zero<T0>();
        let v3 = &mut v2;
        let v4 = &mut v1;
        swap_cetus<T0, T1>(arg0, arg1, v3, v4, false, true, 0x2::balance::value<T1>(&v1), 79226673515401279992447579055, arg4);
        if (arg3 != 0) {
            assert!(0x2::balance::value<T0>(&v2) > arg3, 0);
        };
        let v5 = 0x2::balance::zero<T1>();
        let v6 = &mut v2;
        let v7 = &mut v5;
        swap_cetus<T0, T1>(arg0, arg1, v6, v7, true, true, 0x2::balance::value<T0>(&v2), 4295048016, arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v1, arg5), v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v2, arg5), v0);
