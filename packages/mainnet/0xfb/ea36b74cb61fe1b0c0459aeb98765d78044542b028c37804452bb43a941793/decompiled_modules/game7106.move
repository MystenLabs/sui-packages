module 0xfbea36b74cb61fe1b0c0459aeb98765d78044542b028c37804452bb43a941793::game7106 {
    struct GAME7106 has drop {
        dummy_field: bool,
    }

    struct TICKET_7106 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7106(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7106>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7106>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME7106, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME7106>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7106>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7106>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7106>>(v5, 0x2::tx_context::sender(arg1));
    }
