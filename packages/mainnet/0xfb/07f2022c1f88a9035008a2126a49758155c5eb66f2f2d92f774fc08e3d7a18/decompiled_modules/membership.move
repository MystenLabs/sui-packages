module 0xfb07f2022c1f88a9035008a2126a49758155c5eb66f2f2d92f774fc08e3d7a18::membership {
    ...
    struct MembershipList has store, key {
        id: 0x2::object::UID,
        ownership: 0xfb07f2022c1f88a9035008a2126a49758155c5eb66f2f2d92f774fc08e3d7a18::ownership::CredenzaOwnership,
    ...
    public fun buy_membership<T0>(arg0: &mut MembershipList, arg1: &0xfb07f2022c1f88a9035008a2126a49758155c5eb66f2f2d92f774fc08e3d7a18::sellable::CredenzaSellableConfig<MEMBERSHIP>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(!0x2::table::contains<address, 0x1::string::String>(&arg0.members, v0), 1);
        0xfb07f2022c1f88a9035008a2126a49758155c5eb66f2f2d92f774fc08e3d7a18::sellable::accept_payment_coin<MEMBERSHIP, T0>(arg1, arg2, arg3);
        set_membership_internal(arg0, v0, 0x1::string::utf8(b""));
    }

    fun init(arg0: MEMBERSHIP, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::new(arg1);
        let (_, v2) = 0xfb07f2022c1f88a9035008a2126a49758155c5eb66f2f2d92f774fc08e3d7a18::sellable::create_config<MEMBERSHIP>(arg0, arg1);
        let v3 = MembershipList{
            id        : v0,
            ownership : 0xfb07f2022c1f88a9035008a2126a49758155c5eb66f2f2d92f774fc08e3d7a18::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
            members   : 0x2::table::new<address, 0x1::string::String>(arg1),
        };
        0xfb07f2022c1f88a9035008a2126a49758155c5eb66f2f2d92f774fc08e3d7a18::ownership::add_owner(&mut v3.ownership, 0x2::tx_context::sender(arg1));
        ...
        0x2::transfer::public_share_object<0xfb07f2022c1f88a9035008a2126a49758155c5eb66f2f2d92f774fc08e3d7a18::sellable::CredenzaSellableConfig<MEMBERSHIP>>(v2);
    }

    public fun remove_membership(arg0: &mut MembershipList, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0xfb07f2022c1f88a9035008a2126a49758155c5eb66f2f2d92f774fc08e3d7a18::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg2));
    ...
    public fun set_membership(arg0: &mut MembershipList, arg1: address, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        0xfb07f2022c1f88a9035008a2126a49758155c5eb66f2f2d92f774fc08e3d7a18::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
    ...
    public fun set_owner(arg0: &mut MembershipList, arg1: address, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        0xfb07f2022c1f88a9035008a2126a49758155c5eb66f2f2d92f774fc08e3d7a18::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        0xfb07f2022c1f88a9035008a2126a49758155c5eb66f2f2d92f774fc08e3d7a18::ownership::set_owner(&mut arg0.ownership, arg1, arg2);
    }
