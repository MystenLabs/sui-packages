module 0xfb119deba47f7cd70c985326b2a6f07c0233bbd1fc1c7719ea4dab33b85eb6ac::qanda {
    ...
    public entry fun question(arg0: &mut 0xfb119deba47f7cd70c985326b2a6f07c0233bbd1fc1c7719ea4dab33b85eb6ac::community::Community, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Qanda{
            ...
            owner           : 0xfb119deba47f7cd70c985326b2a6f07c0233bbd1fc1c7719ea4dab33b85eb6ac::community::get_address_admin(),
        ...
        0xfb119deba47f7cd70c985326b2a6f07c0233bbd1fc1c7719ea4dab33b85eb6ac::community::update_qandas(arg0, arg3);
        0x2::transfer::share_object<Qanda>(v0);
    }

    public entry fun question_by_admin(arg0: &mut 0xfb119deba47f7cd70c985326b2a6f07c0233bbd1fc1c7719ea4dab33b85eb6ac::community::Community, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = Qanda{
    ...
    public entry fun reply_qanda(arg0: &mut 0xfb119deba47f7cd70c985326b2a6f07c0233bbd1fc1c7719ea4dab33b85eb6ac::community::Community, arg1: &mut Qanda, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
