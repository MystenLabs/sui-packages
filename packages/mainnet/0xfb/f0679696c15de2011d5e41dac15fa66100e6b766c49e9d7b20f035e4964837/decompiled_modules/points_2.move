module 0xf4e0686b311e9b9d6da7e61fc42dae4254828f5ee3ded8ab5480ecd27e46ff08::points_2 {
    ...
    public fun burn_points<T0: drop>(arg0: &mut PointsManager<T0>, arg1: 0x2::coin::Coin<0x97d2a76efce8e7cdf55b781bd3d23382237fb1d095f9b9cad0bf1fd5f7176b62::suilend_point_2::SUILEND_POINT_2>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_version_and_upgrade<T0>(arg0);
        let v0 = arg0.ratio;
        let v1 = (((0x2::coin::value<0x97d2a76efce8e7cdf55b781bd3d23382237fb1d095f9b9cad0bf1fd5f7176b62::suilend_point_2::SUILEND_POINT_2>(&arg1) as u128) * (v0.numerator as u128) / (v0.denominator as u128)) as u64);
        assert!(v1 <= 0x2::balance::value<T0>(&arg0.balance), 1);
        let v2 = BurnEvent{
            manager_id    : 0x2::object::uid_to_inner(&arg0.id),
            claim_amount  : v1,
            points_burned : 0x2::coin::value<0x97d2a76efce8e7cdf55b781bd3d23382237fb1d095f9b9cad0bf1fd5f7176b62::suilend_point_2::SUILEND_POINT_2>(&arg1),
        };
        0x2::event::emit<BurnEvent>(v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x97d2a76efce8e7cdf55b781bd3d23382237fb1d095f9b9cad0bf1fd5f7176b62::suilend_point_2::SUILEND_POINT_2>>(arg1, @0x0);
