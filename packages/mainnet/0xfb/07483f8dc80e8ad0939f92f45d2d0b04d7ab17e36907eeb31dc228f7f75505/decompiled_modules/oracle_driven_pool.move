module 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::oracle_driven_pool {
    ...
    public fun add_pool<T0, T1>(arg0: &mut 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::ownable::AdminCap, arg1: &0x2::coin::CoinMetadata<T0>, arg2: &0x2::coin::CoinMetadata<T1>, arg3: address, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::ownable::register_pool(arg0, 0x1::string::from_ascii(v6), v3);
    ...
    fun assert_valid_k_value(arg0: u64) {
        assert!(0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::lt_one(arg0), 1);
        assert!(arg0 > 0, 1);
    }

    public fun assert_version<T0, T1>(arg0: &Pool<T0, T1>) {
        assert!(arg0.version == 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::version::get_program_version(), 12);
    }
    ...
    fun calculate_deviation_amounts<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64) : (vector<u64>, vector<u64>) {
        ...
        while (v0 < 0x1::vector::length<u64>(&arg0.core_data.deviation_thresholds)) {
            let v3 = 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::safe_mul_div_u64(*0x1::vector::borrow<u64>(&arg0.core_data.deviation_thresholds, v0), arg1, 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::get_one());
    ...
    fun calculate_trade_slippage<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64, arg2: bool, arg3: u64) : u64 {
        ...
        let v9 = if (arg2) {
            ...
            while (v11 < 0x1::vector::length<u64>(&v8)) {
                0x1::vector::push_back<u64>(&mut v10, 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::mul(*0x1::vector::borrow<u64>(&v8, v11), arg3));
                v11 = v11 + 1;
            };
            v10
        };
        ...
        while (v14 < 0x1::vector::length<u64>(&v12)) {
            ...
            if (v16 > 0) {
                ...
                if (v14 == 0) {
                    v15 = v15 + 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::mul(v17, get_trade_k_without_deviation<T0, T1>(arg0, arg2, get_trade_base_amount(arg1, arg2, arg3)));
                } else {
                    v15 = v15 + 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::mul(v17, *0x1::vector::borrow<u64>(&arg0.core_data.k_deviation_tiers, v14 - 1));
                };
            };
            v14 = v14 + 1;
        };
    ...
    public(friend) fun claim_assets<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<BasePoolLiquidityCoin<T0, T1>>, arg2: 0x2::coin::Coin<QuotePoolLiquidityCoin<T0, T1>>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        assert!(v0 > 0 || v1 > 0, 11);
        let v2 = if (v0 > 0) {
            0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::safe_mul_div_u64(get_quote_balance<T0, T1>(arg0), v0, get_quote_capital_coin_supply<T0, T1>(arg0))
        } else {
            0
        };
        let v3 = if (v1 > 0) {
            0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::safe_mul_div_u64(get_base_balance<T0, T1>(arg0), v1, get_base_capital_coin_supply<T0, T1>(arg0))
        } else {
            0
        };
    ...
    public(friend) fun destroy_pool<T0, T1>(arg0: &mut 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::ownable::AdminCap, arg1: &Pool<T0, T1>) {
        ...
        0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::ownable::destroy_pool(arg0, 0x1::string::from_ascii(v2));
    }
    ...
    public fun get_lp_base_balance<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64) : u64 {
        ...
        if (v0 == 0) {
            ...
            0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::safe_mul_div_u64(arg1, get_base_balance<T0, T1>(arg0), v0)
        }
    }
    ...
    public fun get_lp_quote_balance<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64) : u64 {
        ...
        if (v0 == 0) {
            ...
            0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::safe_mul_div_u64(arg1, get_quote_balance<T0, T1>(arg0), v0)
        }
    }
    ...
    fun get_trade_base_amount(arg0: u64, arg1: bool, arg2: u64) : u64 {
        if (arg1) {
            ...
            0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::mul(arg0, arg2)
        }
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::ownable::grant_admin_cap(0x2::tx_context::sender(arg0), arg0);
    }
    ...
    fun query_buy_base_coin_internal<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64, arg2: u64) : u64 {
        ...
        0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::mul(0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::mul(arg2, 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::get_one() + calculate_total_slippage<T0, T1>(arg0, arg2, true, 0)), arg1)
    }
    ...
    fun query_sell_base_coin_internal<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64, arg2: u64) : u64 {
        ...
        0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::safe_mul_div_u64(arg2, arg1, 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::get_one() + calculate_total_slippage<T0, T1>(arg0, 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::mul(arg2, arg1), false, 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::safe_mul_div_u64(0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::get_one(), 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::get_one(), arg1)))
    }
    ...
    fun query_sell_quote_coin_internal<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64, arg2: u64) : u64 {
        ...
        0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::safe_mul_div_u64(arg2, arg1, 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::get_one() + calculate_total_slippage<T0, T1>(arg0, 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::mul(arg2, arg1), true, 0))
    }
