module 0xfb09385ab19aad9d899dd13bafa8e2532ab10ee670bc9d3c443825339f8e124f::gnome {
    ...
    fun init(arg0: GNOME, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/He2dfTaw9s37dVJnfRs192PvA6pmbN1v7MyL1FuXpump.png?size=lg&key=e7c592                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<GNOME>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"GNOME     ")))), trim_right(b"GNOME                           "), trim_right(b"There's no Santa in crypto, only Christmas $GNOME. On his pepe reindeer, he's already fucking giving out presents. Who was this year a good Hold'em will get real magic                                                                                                                                                         "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
