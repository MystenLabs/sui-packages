module 0xfb3462779586d6c37e1a4b1e6378c5b252373a4dc0ae9df4217b5d20b74ca382::reward7032 {
    struct REWARD7032 has drop {
        dummy_field: bool,
    }

    struct TICKET_7032 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7032(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7032>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7032>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7032, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7032>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7032>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7032>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7032>>(v5, 0x2::tx_context::sender(arg1));
    }
