module 0x75a2c16938fba807c6e9ff14069bb55e3b7309d184e61e93f2cda22622a29b9::port {
    ...
    public fun stake_status(arg0: &Stake, arg1: address) : bool {
        if (!0x2::table::contains<address, vector<0x2::object::ID>>(&arg0.user_record, arg1)) {
            return false
        };
        if (0x1::vector::length<0x2::object::ID>(0x2::table::borrow<address, vector<0x2::object::ID>>(&arg0.user_record, arg1)) == 0) {
            return false
        };
        true
    }
