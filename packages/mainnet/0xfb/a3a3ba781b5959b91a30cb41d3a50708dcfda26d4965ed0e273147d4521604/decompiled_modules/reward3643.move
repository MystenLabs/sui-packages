module 0xfba3a3ba781b5959b91a30cb41d3a50708dcfda26d4965ed0e273147d4521604::reward3643 {
    struct REWARD3643 has drop {
        dummy_field: bool,
    }

    struct TICKET_3643 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3643(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3643>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3643>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3643, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3643>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3643>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3643>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3643>>(v5, 0x2::tx_context::sender(arg1));
    }
