module 0xfb03ecfef8367faf7110911e851aebe6eb3c7b696839f25123aea62ff640ba6d::cnsnft8816 {
    struct CNSNFT8816 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8816, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2140"));
        let v4 = 0x2::package::claim<CNSNFT8816>(arg0, arg1);
