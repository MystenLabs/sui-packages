module 0xfbdf3fef80af681986b671b0d01b3044a87b065ec9f34e6a7dc234fd9b562ac9::prediction {
    ...
    public entry fun claim(arg0: &mut Rounds, arg1: u64, arg2: &mut Epoch, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0.upordown) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, ((v1 * v0.downamount / v0.upamount / 5 + v1) as u64), arg3), 0x2::tx_context::sender(arg3));
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, ((v2 * v0.upamount / v0.downamount / 5 + v2) as u64), arg3), 0x2::tx_context::sender(arg3));
