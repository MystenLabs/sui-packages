module 0xfb992a949596ff6f0e1e76faa44a958e98385f2a1d5e5b1425d68e2b6be82012::cnsnft1050 {
    struct CNSNFT1050 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1050, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1050>(arg0, arg1);
