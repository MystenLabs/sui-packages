module 0xfb6a4fad49d6e58c02dcec45d3f08212c5d50464d8cebb54ed459ab4a8dee8a7::capybara_lootbox {
    ...
    fun exchange_fruits_to_kapybara(arg0: &mut DataStorage, arg1: NFTFruit, arg2: NFTFruit, arg3: NFTFruit, arg4: NFTFruit, arg5: NFTFruit, arg6: &mut 0x2::tx_context::TxContext) {
        let NFTFruit {
            id         : v0,
            fruit_type : v1,
        } = arg1;
    ...
    fun init(arg0: CAPYBARA_LOOTBOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = &mut v1;
        0x1::vector::push_back<0x1::string::String>(v2, 0x1::string::utf8(b"Capybara NFT {fruit_type} fruit"));
        0x1::vector::push_back<0x1::string::String>(v2, 0x1::string::utf8(b"https://capybara_static.8gen.team/{fruit_type}.png"));
        0x1::vector::push_back<0x1::string::String>(v2, 0x1::string::utf8(b"https://capybara_static.8gen.team/{fruit_type}_preview.png"));
        let v3 = DataStorage{
            id                   : 0x2::object::new(arg1),
            total_lootbox        : 0,
        ...
        0x2::transfer::share_object<DataStorage>(v3);
        0x2::transfer::public_transfer<0x2::package::Publisher>(0x2::package::claim<CAPYBARA_LOOTBOX>(arg0, arg1), 0x2::address::from_bytes(0x2::address::to_bytes(@0x3a1a0722453ff6da8a9695ef9588bd0ef57e60df8eee12f45cb792a170f179e1)));
    }
