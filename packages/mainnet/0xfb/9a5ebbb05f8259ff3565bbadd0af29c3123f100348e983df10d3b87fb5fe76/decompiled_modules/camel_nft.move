module 0xfb9a5ebbb05f8259ff3565bbadd0af29c3123f100348e983df10d3b87fb5fe76::camel_nft {
    ...
    entry fun remove_trait(arg0: &mut Camel, arg1: 0x1::string::String) {
        let (v0, v1) = 0x1::vector::index_of<0x1::string::String>(&arg0.traits, &arg1);
        if (v0) {
            0x1::vector::remove<0x1::string::String>(&mut arg0.traits, v1);
        };
    }
    ...
    entry fun update_trait(arg0: &mut Camel, arg1: u64, arg2: 0x1::string::String) {
        if (0x1::vector::contains<0x1::string::String>(&arg0.traits, &arg2)) {
            0x1::vector::push_back<0x1::string::String>(&mut arg0.traits, arg2);
            0x1::vector::swap_remove<0x1::string::String>(&mut arg0.traits, arg1);
        };
    }
