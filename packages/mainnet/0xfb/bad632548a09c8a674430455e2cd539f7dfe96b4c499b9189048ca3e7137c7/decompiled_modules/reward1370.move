module 0xfbbad632548a09c8a674430455e2cd539f7dfe96b4c499b9189048ca3e7137c7::reward1370 {
    struct REWARD1370 has drop {
        dummy_field: bool,
    }

    struct TICKET_1370 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1370(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1370>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1370>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1370, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1370>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1370>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1370>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1370>>(v5, 0x2::tx_context::sender(arg1));
    }
