module 0xfbaca545658d0974d6fe8f5eae5fb5864a42e75dbd54b475f8390e5c20e4499f::c_28_testcollectiononsui {
    struct C_28_TESTCOLLECTIONONSUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: C_28_TESTCOLLECTIONONSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<C_28_TESTCOLLECTIONONSUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"28 TestCollectionOnSui"));
        ...
        let v7 = CreateCollectionEvent{
            ...
            collection_id      : 0x1::string::utf8(b"4242004c-9907-4e6f-a27f-5b005cf63290"),
        };
