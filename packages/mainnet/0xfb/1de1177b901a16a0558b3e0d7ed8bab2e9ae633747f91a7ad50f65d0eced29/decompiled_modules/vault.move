module 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::vault {
    ...
    public(friend) fun add_deposit_request<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: 0x2::balance::Balance<T1>, arg2: address, arg3: u8) {
        let v0 = 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::constants::strategy_active();
        assert!(&arg0.state == &v0, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::strategy_not_active());
        let v1 = 0x2::balance::value<T1>(&arg1);
        assert!(v1 > 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::constants::min_deposit_amount(), 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::deposit_amount_too_low());
    ...
    public fun calculate_lp_token_share<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &0xdee9::clob_v2::Pool<T0, T1>, arg2: u64) : (u64, u64) {
        ...
        assert!(v4 > 0, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::invalidLPToken());
    ...
    public(friend) fun claim_withdrawal<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::table::contains<address, ClaimableWithdrawals<T0, T1>>(&arg0.claimable_withdrawals, arg1), 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::claim_does_not_exist());
    ...
    public(friend) fun mark_state_as_ready_for_withdrawal_processing<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>) {
        let v0 = &arg0.deposit_queue;
        let v1 = 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::constants::strategy_paused_and_ready_for_deposit_processing();
        assert!(&arg0.state == &v1 && v0.pending_requests == 0, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::strategy_not_ready_for_withdrawal_processing());
        arg0.state = 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::constants::strategy_paused_and_ready_for_withdrawal_processing();
    }
    ...
    fun mint_lp_token<T0>(arg0: &mut 0x2::coin::TreasuryCap<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = if (v0 == 0) {
            ...
            assert!(v2 > 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::constants::minimal_liquidity(), 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::notEnoughInitialLiquidity());
            v2
        } else {
            0x2::math::min(0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::safe_math::safe_mul_div_u64(arg3, v0, arg1), 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::safe_math::safe_mul_div_u64(arg4, v0, arg2))
        };
        assert!(v1 > 0, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::liquidityInsufficientMinted());
        0x2::coin::mint<T0>(arg0, v1, arg5)
    }

    public(friend) fun new_vault<T0, T1, T2>(arg0: &0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::app::AdminCap, arg1: 0x2::coin::TreasuryCap<T2>, arg2: &0xdee9::clob_v2::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, VaultCap) {
        ...
        let v2 = Vault<T0, T1, T2>{
            ...
            epoch_counter         : 0,
            state                 : 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::constants::strategy_active(),
    ...
    public(friend) fun pause_strategy_and_mark_ready_for_deposit_processing<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>) {
        let v0 = 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::constants::strategy_active();
        assert!(&arg0.state == &v0, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::strategy_not_active());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::invalid_pool());
        ...
        arg0.state = 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::constants::strategy_paused_and_ready_for_deposit_processing();
    }
    ...
    public(friend) fun process_deposits<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::constants::strategy_paused_and_ready_for_deposit_processing();
        assert!(&arg0.state == &v0, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::strategy_not_ready_for_deposit_processing());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::invalid_pool());
        let v1 = &arg0.deepbook_account_cap;
        let (v2, v3, v4, v5) = get_deepbook_account_assets<T0, T1, T2>(arg0, arg1);
        assert!(v3 == 0, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::locked_base_asset_found());
        assert!(v5 == 0, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::locked_quote_asset_found());
        ...
        while (v12 < arg3 && 0x2::linked_table::length<address, DepositRequest<T1>>(&v13.requests) > 0) {
            ...
            let v21 = if (v4 == 0) {
                0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::safe_math::safe_mul_div_u64(v20, 1, 2)
            } else {
                0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::safe_math::safe_mul_div_u64(v20, v2, 1000 * v4 + v2)
            };
            let v22 = 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::safe_math::safe_mul_div_u64(v21, v8, 1000000) * 1000;
    ...
    public(friend) fun process_withdrawals<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::constants::strategy_paused_and_ready_for_withdrawal_processing();
        assert!(&arg0.state == &v0, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::strategy_not_ready_for_withdrawal_processing());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::invalid_pool());
        let v1 = &arg0.deepbook_account_cap;
        let v2 = 0;
    ...
    public(friend) fun revoke_trading_permission<T0, T1, T2>(arg0: &VaultCap, arg1: &mut Vault<T0, T1, T2>, arg2: address) {
        assert!(get_vault_id_from_vault_cap(arg0) == get_vault_id_from_vault<T0, T1, T2>(arg1), 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::invalid_vault_cap());
        let (v0, v1) = 0x1::vector::index_of<address>(&arg1.whitelisted_addresses, &arg2);
        assert!(v0, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::address_not_whitelisted());
    ...
    public(friend) fun start_strategy<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &0x2::clock::Clock) {
        let v0 = &arg0.withdraw_queue;
        let v1 = 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::constants::strategy_paused_and_ready_for_withdrawal_processing();
        assert!(&arg0.state == &v1 && v0.pending_requests == 0, 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::error::strategy_not_ready_to_make_active());
        arg0.state = 0xfb1de1177b901a16a0558b3e0d7ed8bab2e9ae633747f91a7ad50f65d0eced29::constants::strategy_active();
