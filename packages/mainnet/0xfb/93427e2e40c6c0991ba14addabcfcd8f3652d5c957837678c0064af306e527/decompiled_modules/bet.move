module 0xfb93427e2e40c6c0991ba14addabcfcd8f3652d5c957837678c0064af306e527::bet {
    ...
    public entry fun bet<T0: drop>(arg0: &mut 0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::Launchpad, arg1: &mut 0x2c16a2f0f293560b948a694695a283614f87a16bbc64532ba4c5d0fa23db49de::collection::Collection<T0>, arg2: &mut Registry, arg3: &0x2::clock::Clock, arg4: vector<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.status, 10008);
        let v0 = 0x1::type_name::get<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>();
        assert!(0x1::vector::contains<0x1::type_name::TypeName>(&arg2.allowlist, &v0), 10007);
        let (v1, v2) = current_bet_round_index(arg3, arg2);
        assert!(v1, 10004);
        let v3 = 0;
        0x1::vector::reverse<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>(&mut arg4);
        let v4 = 0x1::vector::empty<0x2::object::ID>();
        while (v3 < 0x1::vector::length<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>(&arg4)) {
            let v5 = 0x1::vector::pop_back<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>(&mut arg4);
            ...
            0x2c16a2f0f293560b948a694695a283614f87a16bbc64532ba4c5d0fa23db49de::collection::decorate_with_witness<Witness, T0>(v9, arg0, arg1, &mut v5, 0x1::option::some<bool>(true), v6, v7, v8);
            0x1::vector::push_back<0x2::object::ID>(&mut v4, 0x2::object::id<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>(&v5));
            bet_<T0>(arg2, v5, v2, arg5, arg6);
            v3 = v3 + 1;
        };
        0x1::vector::destroy_empty<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>(arg4);
        let v10 = BetEvent{
    ...
    public entry fun add_allowlist<T0: drop>(arg0: &mut 0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::Launchpad, arg1: &mut Registry, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"bet_admin_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::borrow_access(arg0), 0x2::tx_context::sender(arg2), v0);
        let v1 = 0x1::type_name::get<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>();
    ...
    fun bet_<T0>(arg0: &mut Registry, arg1: 0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = BetKey{id: 0x2::object::id<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>(&arg1)};
        assert!(!0x2::dynamic_field::exists_<BetKey>(&mut arg0.id, v0), 10001);
        let v1 = BetKey{id: 0x2::object::id<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>(&arg1)};
        ...
        0x2::transfer::public_transfer<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>(arg1, 0x2::tx_context::sender(arg4));
    }
    ...
    public entry fun create_registry<T0: drop>(arg0: &mut 0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::Launchpad, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<0x1::ascii::String>, arg4: vector<0x1::ascii::String>, arg5: bool, arg6: vector<u64>, arg7: vector<u64>, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"bet_admin_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::borrow_access(arg0), 0x2::tx_context::sender(arg8), v0);
        let v1 = 0x1::vector::empty<0x1::type_name::TypeName>();
        0x1::vector::push_back<0x1::type_name::TypeName>(&mut v1, 0x1::type_name::get<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>());
        let v2 = Registry{
    ...
    public fun handle_attributes<T0>(arg0: &mut Registry, arg1: &0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>) : (vector<0x1::ascii::String>, vector<0x1::ascii::String>) {
    ...
    public entry fun init_(arg0: &mut 0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::Launchpad, arg1: 0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<BET>(&arg1), 10010);
        0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::put_publisher<BET>(arg0, arg1, arg2);
    }

    public entry fun remove_allowlist<T0: drop>(arg0: &mut 0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::Launchpad, arg1: &mut Registry, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"bet_admin_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::borrow_access(arg0), 0x2::tx_context::sender(arg2), v0);
        let v1 = 0x1::type_name::get<0x5f95c123f3fe7f0e0ef55e58ed2658adf1ae1799e26c6da7b5e69d26c836841f::nft::Nft<T0>>();
    ...
    public entry fun set_attributes(arg0: &mut 0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::Launchpad, arg1: &mut Registry, arg2: vector<0x1::ascii::String>, arg3: vector<0x1::ascii::String>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"bet_admin_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::borrow_access(arg0), 0x2::tx_context::sender(arg4), v0);
    ...
    public entry fun set_betted_image_url(arg0: &mut 0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::Launchpad, arg1: &mut Registry, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"bet_admin_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::borrow_access(arg0), 0x2::tx_context::sender(arg3), v0);
    ...
    public entry fun set_name(arg0: &mut 0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::Launchpad, arg1: &mut Registry, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"bet_admin_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::borrow_access(arg0), 0x2::tx_context::sender(arg3), v0);
    ...
    public entry fun set_rounds(arg0: &mut 0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::Launchpad, arg1: &mut Registry, arg2: vector<u64>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"bet_admin_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::borrow_access(arg0), 0x2::tx_context::sender(arg4), v0);
    ...
    public entry fun set_status(arg0: &mut 0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::Launchpad, arg1: &mut Registry, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"bet_admin_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::borrow_access(arg0), 0x2::tx_context::sender(arg3), v0);
        arg1.status = arg2;
    ...
    public entry fun set_winner(arg0: &mut 0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::Launchpad, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"bet_admin_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(0x5ebae62cba75b5cc5ec12c191ca3c00e60b713e63b27db6b675ac677cca84ffa::launchpad::borrow_access(arg0), 0x2::tx_context::sender(arg4), v0);
