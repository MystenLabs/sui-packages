module 0xfbe301c3698e71b87029d0dcdb8412a24f7dad9323648879c78de75b68614e57::lp_token {
    ...
    fun init(arg0: LP_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<LP_TOKEN>(arg0, 9, b"USDC-SUI", b"USDC-SUI", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://yd4ro365yw67pia6vjysex7ub3hviwgdukmtgoan7hvwaz4visia.arweave.net/wPkXb93FvfegHqpxIl_0Ds9UWMOimTM4DfnrYGeVRJA")), arg1);
        let v2 = v1;
        let v3 = v0;
