module 0x4a3733327536ae46d52cd1414624bfd4bd336a1cfaf7d49327916f1a2e890042::settlement {
    ...
    public fun lz_receive(arg0: &mut SettlementState, arg1: &0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp, arg2: 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Call<0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::LzReceiveParam, 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Void>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x4a3733327536ae46d52cd1414624bfd4bd336a1cfaf7d49327916f1a2e890042::events::emit_swap_order_received(v0, v10, v11, v12, v13, v14);
    }
    ...
    public fun claim_direct<T0: drop>(arg0: &mut SettlementState, arg1: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg2: address) {
        ...
        0x4a3733327536ae46d52cd1414624bfd4bd336a1cfaf7d49327916f1a2e890042::events::emit_order_claimed_direct(0x2::coin::value<T0>(&v2), arg2);
    }
    ...
    public fun complete_fulfill<T0: drop>(arg0: &mut SettlementState, arg1: FulfillReceipt, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::tx_context::TxContext) {
        ...
        0x4a3733327536ae46d52cd1414624bfd4bd336a1cfaf7d49327916f1a2e890042::events::emit_order_fulfilled(v0, v1, 0, v7, v2, v4, 0x2::tx_context::sender(arg3), v5);
    }
    ...
    fun decode_swap_order(arg0: &vector<u8>) : (u64, address, u64, address, u64) {
        assert!(0x1::vector::length<u8>(arg0) == 89, 7);
        assert!(*0x1::vector::borrow<u8>(arg0, 0) == 1, 7);
        (read_u64_le(arg0, 1), read_address(arg0, 9), read_u64_le(arg0, 41), read_address(arg0, 49), read_u64_le(arg0, 81))
    }
    ...
    public fun fulfill_order_swap_a_to_b<T0, T1>(arg0: &mut SettlementState, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: u32, arg4: u64, arg5: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let (v5, v6) = 0x4a3733327536ae46d52cd1414624bfd4bd336a1cfaf7d49327916f1a2e890042::aggregator::swap_a_to_b<T0, T1>(arg1, arg2, 0x2::transfer::public_receive<0x2::coin::Coin<T0>>(&mut arg0.id, arg5), v1.min_output, arg6, arg7);
        let v7 = v6;
        let v8 = v5;
        ...
        0x4a3733327536ae46d52cd1414624bfd4bd336a1cfaf7d49327916f1a2e890042::events::emit_order_fulfilled(arg3, arg4, 0, 0x2::coin::value<T1>(&v8), v2, v3, 0x2::tx_context::sender(arg7), v4);
    }
    ...
    public fun fulfill_order_swap_b_to_a<T0, T1>(arg0: &mut SettlementState, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: u32, arg4: u64, arg5: 0x2::transfer::Receiving<0x2::coin::Coin<T1>>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let (v5, v6) = 0x4a3733327536ae46d52cd1414624bfd4bd336a1cfaf7d49327916f1a2e890042::aggregator::swap_b_to_a<T0, T1>(arg1, arg2, 0x2::transfer::public_receive<0x2::coin::Coin<T1>>(&mut arg0.id, arg5), v1.min_output, arg6, arg7);
        let v7 = v6;
        let v8 = v5;
        ...
        0x4a3733327536ae46d52cd1414624bfd4bd336a1cfaf7d49327916f1a2e890042::events::emit_order_fulfilled(arg3, arg4, 0, 0x2::coin::value<T0>(&v8), v2, v3, 0x2::tx_context::sender(arg7), v4);
    }
    ...
    public fun fulfill_order_usdc<T0: drop>(arg0: &mut SettlementState, arg1: u32, arg2: u64, arg3: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        0x4a3733327536ae46d52cd1414624bfd4bd336a1cfaf7d49327916f1a2e890042::events::emit_order_fulfilled(arg1, arg2, 0, v7, v2, v4, 0x2::tx_context::sender(arg5), v5);
    }
    ...
    public fun withdraw_fallback<T0: drop>(arg0: &mut SettlementState, arg1: u32, arg2: u64, arg3: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v6, v4);
        0x4a3733327536ae46d52cd1414624bfd4bd336a1cfaf7d49327916f1a2e890042::events::emit_fallback_withdrawn(arg1, arg2, 0x2::coin::value<T0>(&v6), v4, v5);
    }
