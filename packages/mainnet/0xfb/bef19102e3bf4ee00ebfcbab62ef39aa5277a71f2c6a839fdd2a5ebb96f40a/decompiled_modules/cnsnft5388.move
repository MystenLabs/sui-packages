module 0xfbbef19102e3bf4ee00ebfcbab62ef39aa5277a71f2c6a839fdd2a5ebb96f40a::cnsnft5388 {
    struct CNSNFT5388 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5388, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5388>(arg0, arg1);
