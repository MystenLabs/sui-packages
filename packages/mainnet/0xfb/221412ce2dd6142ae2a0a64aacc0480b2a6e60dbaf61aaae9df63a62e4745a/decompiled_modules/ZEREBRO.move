module 0xfb221412ce2dd6142ae2a0a64aacc0480b2a6e60dbaf61aaae9df63a62e4745a::ZEREBRO {
    struct ZEREBRO has drop {
        dummy_field: bool,
    }

    fun init(arg0: ZEREBRO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<ZEREBRO>(arg0, 2, b"ZEREBRO", b"ZEREBRO", b"ZEREBRO", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/jWHb4c0mr_QYGnzvZo_VYZNCSeBPmikBoaX-cXDF-L4?ext=png")), arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<ZEREBRO>>(v2);
        0x2::transfer::public_transfer<0x2::coin::DenyCap<ZEREBRO>>(v1, @0x7c3c58155b85c3ecf4864777fce255a7e405ffa3b6e443e736976588910f0e8d);
        let v3 = v0;
