module 0xfb6097ffb82fd3a67c21f0d2d68281a16768ef07c4af5455647bd1cfb5ceea09::arena {
    ...
    public fun initArenaPool<T0>(arg0: &mut PoolConfig, arg1: u16, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(has_right(arg0, arg2), 3);
        new_arena_pool<T0>(0x2::object::id<PoolConfig>(arg0), arg0.fund_addr, arg0.expired_ms, arg1, arg0.fee_cut, arg2);
    }
    ...
    fun new_arena_pool<T0>(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u16, arg4: u32, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = ArenaPool<T0>{
            ...
            all_pool_users : 0,
            pool_count     : 0,
            latest_pools   : 0x2::table::new<u32, 0x2::object::ID>(arg5),
            is_deleted     : false,
        };
        0x2::dynamic_object_field::add<vector<u8>, 0x2::table::Table<0x2::object::ID, PoolDetail>>(&mut v1.id, b"pools", 0x2::table::new<0x2::object::ID, PoolDetail>(arg5));
    ...
    fun random_winner<T0>(arg0: &0x2::random::Random, arg1: &mut ArenaPool<T0>, arg2: 0x2::object::ID, arg3: address, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xfb6097ffb82fd3a67c21f0d2d68281a16768ef07c4af5455647bd1cfb5ceea09::random::get_lucky_number(arg0, 0, v0.num_users, arg5);
        v0.winner = v1 + 1;
