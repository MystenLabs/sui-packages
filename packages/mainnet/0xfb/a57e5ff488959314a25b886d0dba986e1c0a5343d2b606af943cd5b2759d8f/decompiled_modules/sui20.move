module 0xfba57e5ff488959314a25b886d0dba986e1c0a5343d2b606af943cd5b2759d8f::sui20 {
    ...
    public fun mint<T0>(arg0: &mut Global, arg1: &0x2::clock::Clock, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.fee, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, v3.meta.fee, arg4)));
