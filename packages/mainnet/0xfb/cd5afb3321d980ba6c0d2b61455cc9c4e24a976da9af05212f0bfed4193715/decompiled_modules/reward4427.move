module 0xfbcd5afb3321d980ba6c0d2b61455cc9c4e24a976da9af05212f0bfed4193715::reward4427 {
    struct REWARD4427 has drop {
        dummy_field: bool,
    }

    struct TICKET_4427 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4427(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4427>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4427>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4427, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4427>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4427>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4427>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4427>>(v5, 0x2::tx_context::sender(arg1));
    }
