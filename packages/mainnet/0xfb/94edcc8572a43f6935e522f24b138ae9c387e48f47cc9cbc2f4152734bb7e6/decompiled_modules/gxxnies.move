module 0xfb94edcc8572a43f6935e522f24b138ae9c387e48f47cc9cbc2f4152734bb7e6::gxxnies {
    ...
    fun create_nft(arg0: &NFTCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : NFT {
        let v0 = 0x1::string::utf8(b"gxxnies #");
        ...
        let v2 = if (0x2::table::contains<u64, 0x2::url::Url>(&arg0.preset_urls, arg1)) {
            *0x2::table::borrow<u64, 0x2::url::Url>(&arg0.preset_urls, arg1)
            ...
            let v3 = 0x1::string::utf8(b"https://gxxnies.io/nft/");
        ...
        NFT{
            ...
            name        : v0,
            description : 0x1::string::utf8(b"gxxnies NFTs manufactured by gxxnies"),
            image_url   : v2,
            attributes  : v1,
            token_id    : arg1,
        }
    ...
    fun init(arg0: GXXNIES, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<GXXNIES>(arg0, arg1);
        let v1 = NFTCollection{
            ...
            mint_start        : 1744065000000,
            phase_end         : 1744066800000,
    ...
    public entry fun mint_all(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = v8 + v9;
        let v11 = v8 * 1000000000 + v9 * 2000000000;
        assert!(v10 > 0, 7);
