module 0xfbfce162f72afb13b057f3a6028ba67f35c1d0230757d0f22b149341704ccf23::c_15_test_collection_sui {
    struct C_15_TEST_COLLECTION_SUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: C_15_TEST_COLLECTION_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<C_15_TEST_COLLECTION_SUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"15 test collection sui"));
        ...
        let v7 = CreateCollectionEvent{
            ...
            collection_id      : 0x1::string::utf8(b"a6e23e74-6793-489e-91f7-e4dd6e69cf18"),
        };
