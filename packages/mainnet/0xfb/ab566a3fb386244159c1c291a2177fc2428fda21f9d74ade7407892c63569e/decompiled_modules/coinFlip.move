module 0xfbab566a3fb386244159c1c291a2177fc2428fda21f9d74ade7407892c63569e::coinFlip {
    ...
    public entry fun play_game(arg0: &mut CoinFlip, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = pseudoRandomNumGenerator(&v1);
        let v3 = 0x2::table::length<u64, History>(&arg0.history_all);
        let v4 = 0;
        if (0x2::table::contains<address, 0x2::table::Table<u64, History>>(&arg0.history, 0x2::tx_context::sender(arg4))) {
            v4 = 0x2::table::length<u64, History>(0x2::table::borrow<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg4)));
        };
        let v5 = get_hash(0x2::clock::timestamp_ms(arg3) + v3 + 1 + v4 + 1);
        let v6 = b"lose";
        let v7 = 0;
        let v8 = if ((safe_selection(999, &v5) + (*0x1::vector::borrow<u8>(&v2, 0) as u64)) % 2 == 0) {
            b"head"
        } else {
            b"tail"
        };
        if (arg2 == v8) {
            ...
            let v11 = v9 - v10;
            v7 = v11;
            0x2::coin::join<0x2::sui::SUI>(&mut arg1, 0x2::coin::take<0x2::sui::SUI>(&mut arg0.bank, v11 - v0, arg4));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, 0x2::tx_context::sender(arg4));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.bank, v10, arg4), arg0.treasury);
        } else {
            if (arg0.fee > 0) {
        ...
        let v12 = History{
            ...
            bet_amount : v0,
            result     : 0x1::string::utf8(v8),
            profit     : v7,
            time       : 0x2::clock::timestamp_ms(arg3),
            winning    : 0x1::string::utf8(v6),
        };
        if (0x2::table::contains<address, 0x2::table::Table<u64, History>>(&arg0.history, 0x2::tx_context::sender(arg4))) {
            0x2::table::add<u64, History>(0x2::table::borrow_mut<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg4)), v4 + 1, v12);
        } else {
            let v13 = 0x2::table::new<u64, History>(arg4);
            0x2::table::add<u64, History>(&mut v13, 1, v12);
            0x2::table::add<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg4), v13);
        };
        0x2::table::add<u64, History>(&mut arg0.history_all, v3 + 1, v12);
        0x2::event::emit<History>(v12);
    }
