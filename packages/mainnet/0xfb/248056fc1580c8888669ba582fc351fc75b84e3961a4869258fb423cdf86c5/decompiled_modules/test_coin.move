module 0xfb248056fc1580c8888669ba582fc351fc75b84e3961a4869258fb423cdf86c5::test_coin {
    ...
    public fun mint_max_supply(arg0: &mut 0x2::coin::TreasuryCap<TEST_COIN>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<TEST_COIN> {
        assert!(0x2::coin::total_supply<TEST_COIN>(arg0) + 10000000 <= 10000000, 0);
        0x2::coin::mint<TEST_COIN>(arg0, 10000000, arg1)
    }
