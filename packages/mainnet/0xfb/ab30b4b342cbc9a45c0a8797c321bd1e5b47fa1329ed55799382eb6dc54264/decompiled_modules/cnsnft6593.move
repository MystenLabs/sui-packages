module 0xfbab30b4b342cbc9a45c0a8797c321bd1e5b47fa1329ed55799382eb6dc54264::cnsnft6593 {
    struct CNSNFT6593 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6593, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6593>(arg0, arg1);
