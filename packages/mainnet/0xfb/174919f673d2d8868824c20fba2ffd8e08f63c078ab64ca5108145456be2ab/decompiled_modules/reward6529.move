module 0xfb174919f673d2d8868824c20fba2ffd8e08f63c078ab64ca5108145456be2ab::reward6529 {
    struct REWARD6529 has drop {
        dummy_field: bool,
    }

    struct TICKET_6529 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6529(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6529>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6529>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6529, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6529>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6529>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6529>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6529>>(v5, 0x2::tx_context::sender(arg1));
    }
