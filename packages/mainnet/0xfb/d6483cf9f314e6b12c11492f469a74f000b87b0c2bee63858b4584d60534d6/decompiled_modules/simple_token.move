module 0xfbd6483cf9f314e6b12c11492f469a74f000b87b0c2bee63858b4584d60534d6::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"GG", b"GG", b"Official token. Banner on Dexscreener paid and Boost!", 0x1::option::none<0x2::url::Url>(), arg1);
