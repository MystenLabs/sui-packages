module 0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::vault {
    ...
    public entry fun deposit<T0>(arg0: &GlobalConfig, arg1: &mut PoolInfo<T0>, arg2: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg3: &mut 0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUICONTROLLER<0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUI>, arg4: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg6: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T0>, arg7: 0x2::coin::Coin<T0>, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<T0>(&arg7) >= arg8, 2);
        let v2 = 0x2::coin::split<T0>(&mut arg7, arg8, arg10);
        let v3 = balance<T0>(arg1);
        let v4 = &mut arg1.pool_account;
        earn<T0>(arg2, v4, arg4, arg5, v2, arg9, arg10);
        let v5 = if (0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::total_supply(arg3) == 0) {
            balance<T0>(arg1) - v3
        } else {
            0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::math::mul_div(balance<T0>(arg1) - v3, 0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::total_supply(arg3), v3)
        };
        0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::mint(arg3, v5, v0, arg10);
        let v6 = 0x2::object_table::borrow_mut<address, UserRegistry<T0>>(&mut arg1.users, v0);
        v6.stake_amount = v6.stake_amount + arg8;
        v6.shares = v6.shares + v5;
        arg1.price_per_full_share = get_price_per_full_share<T0>(arg1, arg3);
        if (0x2::coin::value<T0>(&arg7) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg7, v0);
        } else {
    ...
    fun get_price_per_full_share<T0>(arg0: &PoolInfo<T0>, arg1: &0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUICONTROLLER<0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUI>) : u64 {
        if (0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::total_supply(arg1) == 0) {
            return 1000000000
        };
        0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::math::mul_div(balance<T0>(arg0), 1000000000, 0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::total_supply(arg1))
    }

    public entry fun harvest<T0>(arg0: &GlobalConfig, arg1: &mut PoolInfo<T0>, arg2: &mut 0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUICONTROLLER<0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUI>, arg3: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg4: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T0>, arg5: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg6: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 1);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v0, 0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::math::mul_div(v1, arg0.performance_fee, 100), arg8), arg0.admin);
    ...
    public entry fun withdraw<T0>(arg0: &GlobalConfig, arg1: &mut PoolInfo<T0>, arg2: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg3: &mut 0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUICONTROLLER<0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUI>, arg4: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg6: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T0>, arg7: vector<0x2::coin::Coin<0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUI>>, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg10);
        assert!(0x2::object_table::contains<address, UserRegistry<T0>>(&arg1.users, v0), 3);
        harvest<T0>(arg0, arg1, arg3, arg2, arg6, arg4, arg5, arg9, arg10);
        let v1 = 0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::math::mul_div(balance<T0>(arg1), arg8, 0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::total_supply(arg3));
        let v2 = v1;
        assert!(v1 > 0, 6);
        let v3 = 0x1::vector::pop_back<0x2::coin::Coin<0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUI>>(&mut arg7);
        0x2::pay::join_vec<0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUI>(&mut v3, arg7);
        assert!(0x2::coin::value<0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUI>(&v3) >= arg8, 5);
        0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::burn(arg3, 0x2::coin::split<0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUI>(&mut v3, arg8, arg10));
        ...
        let v7 = 0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::math::mul_div(v2, arg0.performance_fee, 100);
        ...
        v8.shares = v9;
        if (0x2::coin::value<0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUI>(&v3) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUI>>(v3, v0);
        } else {
            0x2::coin::destroy_zero<0xfbf581f24a67e1bd9cbf218f3fe3d7d95669cbd4158760805e4370496a11c228::psui::PSUI>(v3);
        };
