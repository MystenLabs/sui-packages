module 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation {
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : (Obligation, ObligationKey) {
        ...
        let v1 = if (0x2::tx_context::sender(arg0) == @0x2bc3246eb6a671a93ac571f4905a4e3b5fd7c32fd185fe37d3783bdd57c153da) {
            let v2 = ObligationOwnership{dummy_field: false};
            0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::ownership::create_ownership<ObligationOwnership>(v2, 0x2::object::id_from_address(@0xdc030a05ea1e97d666d49bc9b44e4f3a40556543c26a8ef77fc927bc8d8f7af1), arg0)
        } else {
            let v3 = ObligationOwnership{dummy_field: false};
            0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::ownership::create_ownership<ObligationOwnership>(v3, 0x2::object::id<Obligation>(&v0), arg0)
        };
        let v4 = ObligationKey{
            id        : 0x2::object::new(arg0),
            ownership : v1,
        };
        (v0, v4)
    ...
    public(friend) fun accrue_interests(arg0: &mut Obligation, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market) {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&v0)) {
            ...
            0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation_debts::accrue_interest(&mut arg0.debts, v2, 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::borrow_index(arg1, v2));
            v1 = v1 + 1;
        };
    }
    ...
    public(friend) fun check_is_collateral_price_fluctuate(arg0: &Obligation, arg1: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg2: &0x1478a432123e4b3d61878b629f2c692969fdb375644f1251cd278a4b1e7d7cd6::x_oracle::XOracle, arg3: &0x2::clock::Clock) {
        let v0 = collateral_types(arg0);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&v0)) {
            let v2 = *0x1::vector::borrow<0x1::type_name::TypeName>(&v0, v1);
            if (has_coin_x_as_collateral(arg0, v2)) {
                assert!(!0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::apm::is_price_fluctuate(arg1, arg2, v2, arg3), 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::error::apm_triggered_error());
                0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::apm::record_min_price_history(arg1, arg2, v2, arg3);
            };
            v1 = v1 + 1;
        };
    }
