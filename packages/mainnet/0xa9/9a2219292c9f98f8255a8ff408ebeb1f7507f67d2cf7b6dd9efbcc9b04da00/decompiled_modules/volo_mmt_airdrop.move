module 0xa99a2219292c9f98f8255a8ff408ebeb1f7507f67d2cf7b6dd9efbcc9b04da00::volo_mmt_airdrop {
    ...
    public fun mint(arg0: &MinterCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Volo_Momentum_xBTC{
            ...
            url         : 0x2::url::new_unsafe_from_bytes(b"https://x4rjmmpwhoncvduw.public.blob.vercel-storage.com/uploads/2025-08-15/wekxmwxi428bayj9zic2-BmhDCahM0qiZuu5S5ccwm8JRyEUIn5"),
        };
        let v1 = NFTMinted{
