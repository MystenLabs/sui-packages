module 0x23a2ce41100ea516704bed56fd05cef811608c78a6ed443b0f61024d58268bb6::nsfw {
    ...
    entry fun mint_2(arg0: &Registry, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<Template>(&arg0.templates);
        assert!(v0 > 0, 1);
        ...
        0x2::transfer::public_transfer<RandomHentai>(v3, 0x2::tx_context::sender(arg2));
    }
