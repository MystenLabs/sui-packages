module 0xa9f7d00f9f20c39fed666814160f40282d8b19a6c9f2a23b81c695813530b1f3::reward2319 {
    struct REWARD2319 has drop {
        dummy_field: bool,
    }

    struct TICKET_2319 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2319(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2319>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2319>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2319, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2319>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2319>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2319>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2319>>(v5, 0x2::tx_context::sender(arg1));
    }
