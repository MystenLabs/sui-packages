module 0xa98d5b28185b69d3f41d8f1e7404050dccaa51ea7b7f76c808a3912d33479da1::reward6605 {
    struct REWARD6605 has drop {
        dummy_field: bool,
    }

    struct TICKET_6605 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6605(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6605>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6605>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6605, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6605>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6605>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6605>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6605>>(v5, 0x2::tx_context::sender(arg1));
    }
