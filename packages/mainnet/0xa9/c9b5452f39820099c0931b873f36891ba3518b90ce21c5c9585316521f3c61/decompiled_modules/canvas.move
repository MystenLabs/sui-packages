module 0xa9c9b5452f39820099c0931b873f36891ba3518b90ce21c5c9585316521f3c61::canvas {
    ...
    fun make_data_url(arg0: 0x1::string::String) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"data:image/svg+xml;utf8,");
    ...
    public entry fun mint_blank(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = CanvasNFT{
            ...
            pixels    : v0,
            image_url : make_data_url(render_canvas_svg(&v0)),
        };
    ...
    public entry fun mint_red_pen(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = RedPen{
            id        : 0x2::object::new(arg0),
            pixels    : v0,
            image_url : make_data_url(render_pen_svg(&v0)),
        };
    ...
    public entry fun paint_overwrite(arg0: &mut CanvasNFT, arg1: vector<u8>, arg2: &0x2::tx_context::TxContext) {
        ...
        arg0.pixels = arg1;
        arg0.image_url = make_data_url(render_canvas_svg(&arg0.pixels));
    }
