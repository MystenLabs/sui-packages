module 0xa90218c8ec02c619b2b4db3e3d32cfeb5c1cf762879ef75bae9f27020751d0f8::sheet {
    ...
    fun add_creditor<T0, T1, T2>(arg0: &mut Sheet<T0, T1>) {
    ...
    fun add_debtor<T0, T1, T2>(arg0: &mut Sheet<T0, T1>) {
    ...
    public fun collect<T0: drop, T1, T2>(arg0: &mut Sheet<T0, T2>, arg1: Collector<T0, T1, T2>, arg2: T0) : 0x2::balance::Balance<T2> {
        ...
        let v3 = v2;
        assert!(0x1::option::is_some<Repayment<T0, T1, T2>>(&v3), 9223372535070982143);
        let Repayment {
            balance : v4,
            credit  : v5,
            debt    : v6,
        ...
        assert!(v1 == 0x2::balance::value<T2>(&v7), 9223372569430720511);
        v7
    }
    ...
    fun destroy_credit<T0>(arg0: Credit<T0>) {
        ...
        assert!(v0 == 0, 9223373248035553279);
    }

    fun destroy_debt<T0>(arg0: Debt<T0>) {
        let Debt { pos0: v0 } = arg0;
        assert!(v0 == 0, 9223373269510389759);
    }
    ...
    fun record_collect<T0, T1, T2>(arg0: &mut Sheet<T0, T2>, arg1: &mut Collector<T0, T1, T2>) : u64 {
        let v0 = debtor<T1>();
        assert!(0x2::vec_map::contains<Debtor, Credit<T2>>(&arg0.credits, &v0), 9223372775589150719);
    ...
    fun record_repay<T0, T1, T2>(arg0: &mut Sheet<T1, T2>, arg1: &mut Collector<T0, T1, T2>) : u64 {
        let v0 = creditor<T0>();
        assert!(0x2::vec_map::contains<Creditor, Debt<T2>>(&arg0.debts, &v0), 9223372728344510463);
        let v1 = 0x2::vec_map::get_mut<Creditor, Debt<T2>>(&mut arg0.debts, &v0);
    ...
    public fun remove_creditor<T0: drop, T1, T2>(arg0: &mut Sheet<T0, T1>, arg1: T0) {
        let v0 = creditor<T2>();
        assert!(0x2::vec_map::contains<Creditor, Debt<T1>>(&arg0.debts, &v0), 9223372891553267711);
    ...
    public fun remove_debtor<T0: drop, T1, T2>(arg0: &mut Sheet<T0, T1>, arg1: T0) {
        let v0 = debtor<T2>();
        assert!(0x2::vec_map::contains<Debtor, Credit<T1>>(&arg0.credits, &v0), 9223372848603594751);
    ...
    public fun repay<T0, T1: drop, T2>(arg0: &mut Sheet<T1, T2>, arg1: &mut Collector<T0, T1, T2>, arg2: 0x2::balance::Balance<T2>, arg3: T1) {
        assert!(0x1::option::is_none<Repayment<T0, T1, T2>>(&arg1.repayment), 9223372457761570815);
    ...
    fun sub_credit<T0>(arg0: &mut Credit<T0>, arg1: Credit<T0>) : u64 {
        let Credit { pos0: v0 } = arg1;
        assert!(arg0.pos0 >= v0, 9223373149251305471);
        let v1 = arg0.pos0 - v0;
        arg0.pos0 = v1;
        v1
    }
    ...
    fun sub_debt<T0>(arg0: &mut Debt<T0>, arg1: Debt<T0>) : u64 {
        let Debt { pos0: v0 } = arg1;
        assert!(arg0.pos0 >= v0, 9223373213675814911);
        let v1 = arg0.pos0 - v0;
        arg0.pos0 = v1;
        v1
    }
