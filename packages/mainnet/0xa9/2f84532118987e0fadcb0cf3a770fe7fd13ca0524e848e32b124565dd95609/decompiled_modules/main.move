module 0x9985186072d699b5ec8c42c8e84b801b0db5d4cff26600893b905c641cb02855::main {
    ...
    struct Detail has copy, drop {
        a_b: u64,
        b_b: u64,
        a_c_t: 0x1::ascii::String,
        b_c_t: 0x1::ascii::String,
        fee: u64,
        amt: u64,
    }
    ...
    public fun fixed_swap_a_to_b_in<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T0>, arg4: u64) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg1, arg2, 0x2::balance::split<T0>(&mut v5, v6), 0x2::balance::zero<T1>(), v3);
        let v7 = Detail{
            a_b   : 0x2::balance::value<T0>(&v5),
            b_b   : 0x2::balance::value<T1>(&v4),
            a_c_t : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            b_c_t : 0x1::type_name::into_string(0x1::type_name::get<T1>()),
            fee   : v6,
            amt   : arg4,
        };
        0x2::event::emit<Detail>(v7);
        (v5, v4)
    }
    ...
    public fun fixed_swap_b_to_a_in<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T1>, arg4: u64) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg1, arg2, 0x2::balance::zero<T0>(), 0x2::balance::split<T1>(&mut v4, v6), v3);
        let v7 = Detail{
            a_b   : 0x2::balance::value<T0>(&v5),
            b_b   : 0x2::balance::value<T1>(&v4),
            a_c_t : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
