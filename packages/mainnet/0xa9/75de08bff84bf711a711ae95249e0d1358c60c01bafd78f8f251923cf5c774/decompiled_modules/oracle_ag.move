module 0xa975de08bff84bf711a711ae95249e0d1358c60c01bafd78f8f251923cf5c774::oracle_ag {
    ...
    public fun new(arg0: &mut 0x2::tx_context::TxContext) : (OracleAggregator, OracleAggregatorCap) {
        let v0 = OracleAggregator{
            ...
            max_age             : 0xa975de08bff84bf711a711ae95249e0d1358c60c01bafd78f8f251923cf5c774::consts::GET_PYTH_MAX_AGE(),
        };
    ...
    public fun calc_usd_value<T0>(arg0: &OracleAggregator, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        ...
        0xa975de08bff84bf711a711ae95249e0d1358c60c01bafd78f8f251923cf5c774::math::scale_from_float(0xa975de08bff84bf711a711ae95249e0d1358c60c01bafd78f8f251923cf5c774::math::mul(0xa975de08bff84bf711a711ae95249e0d1358c60c01bafd78f8f251923cf5c774::math::scale_to_float(arg2, v1), 0xa975de08bff84bf711a711ae95249e0d1358c60c01bafd78f8f251923cf5c774::math::scale_to_float(v0, v1)), 0xa975de08bff84bf711a711ae95249e0d1358c60c01bafd78f8f251923cf5c774::consts::GET_USDC_DECIMALS())
    }
