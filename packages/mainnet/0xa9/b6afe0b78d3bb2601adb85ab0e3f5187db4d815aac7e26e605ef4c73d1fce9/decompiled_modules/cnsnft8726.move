module 0xa9b6afe0b78d3bb2601adb85ab0e3f5187db4d815aac7e26e605ef4c73d1fce9::cnsnft8726 {
    struct CNSNFT8726 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8726, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8726>(arg0, arg1);
