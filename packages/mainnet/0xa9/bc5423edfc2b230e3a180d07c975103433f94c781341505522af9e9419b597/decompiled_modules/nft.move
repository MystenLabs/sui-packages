module 0xa9bc5423edfc2b230e3a180d07c975103433f94c781341505522af9e9419b597::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<SNFT>(v6, @0xca457422044fc2eaeddb747123367ccd7fe4718a4ce5ecf6678055092a064bd0);
    }
