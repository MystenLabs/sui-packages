module 0xa9540137b27bb500fbcbe16a1c6798f2baabc66f02fda5249d3e909cb76a2e8e::cnsnft5399 {
    struct CNSNFT5399 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5399, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5399>(arg0, arg1);
