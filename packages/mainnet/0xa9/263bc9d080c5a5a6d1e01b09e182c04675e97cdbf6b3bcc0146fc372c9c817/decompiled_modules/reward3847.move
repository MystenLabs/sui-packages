module 0xa9263bc9d080c5a5a6d1e01b09e182c04675e97cdbf6b3bcc0146fc372c9c817::reward3847 {
    struct REWARD3847 has drop {
        dummy_field: bool,
    }

    struct TICKET_3847 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3847(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3847>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3847>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3847, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3847>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3847>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3847>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3847>>(v5, 0x2::tx_context::sender(arg1));
    }
