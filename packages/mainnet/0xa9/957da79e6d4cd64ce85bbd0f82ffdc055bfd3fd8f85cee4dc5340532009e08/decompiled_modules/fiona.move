module 0xa9957da79e6d4cd64ce85bbd0f82ffdc055bfd3fd8f85cee4dc5340532009e08::fiona {
    ...
    fun init(arg0: FIONA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FIONA>(arg0, 9, b"FIONA", b"Fiona", b"Fiona", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/QmU5CzoLw59yApYXNQBRf9CkzJbP7iYxssxZCq62EzqeTM")), arg1);
        let v2 = v0;
