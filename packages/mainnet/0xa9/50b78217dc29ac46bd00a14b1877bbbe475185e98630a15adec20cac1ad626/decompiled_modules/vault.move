module 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault {
    ...
    fun adjust_user_share_limited<T0>(arg0: &mut UserShareRegistry, arg1: &mut SubVault<T0>, arg2: u64, arg3: u64, arg4: 0x1::option::Option<UserShareKey>, arg5: u64) : (0x1::option::Option<UserShareKey>, u64, u64) {
        let v0 = if (0x1::option::is_some<UserShareKey>(&arg4)) {
            arg4
        } else {
        ...
        let v2 = if (arg2 > 0 && arg3 > 0) {
            while (0x1::option::is_some<UserShareKey>(&v1) && arg5 > 0) {
                let v3 = *0x1::option::borrow<UserShareKey>(&v1);
                ...
                let v5 = (((arg3 as u128) * (v4 as u128) / (arg2 as u128)) as u64);
                arg3 = arg3 - v5;
                arg2 = arg2 - v4;
                v1 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::next<UserShareKey, u64>(&mut arg0.id, &arg1.user_shares, v3);
                if (v4 >= v5) {
    ...
    public fun delivery_with_rewards<T0, T1, T2>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut UserShareRegistry, arg3: &mut DepositVault<T0, T1>, arg4: &mut BidVault<T0, T2>, arg5: u64, arg6: 0x2::balance::Balance<T2>, arg7: 0x2::vec_map::VecMap<address, u64>, arg8: 0x2::balance::Balance<T2>, arg9: &0x2::tx_context::TxContext) {
        refund<T0, T1>(arg0, arg1, arg3, arg5, arg9);
        let v0 = 0x2::balance::value<T2>(&arg6);
        let v1 = v0 * 1000 / 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4);
        0x2::balance::join<T2>(&mut arg4.performance_fee_sub_vault.balance, 0x2::balance::split<T2>(&mut arg6, v1));
        0x2::balance::join<T2>(&mut arg4.premium_sub_vault.balance, arg6);
        let v2 = 0x2::balance::value<T2>(&arg8);
        if (v2 > 0) {
            0x2::balance::join<T2>(&mut arg4.premium_sub_vault.balance, arg8);
        } else {
            0x2::balance::destroy_zero<T2>(arg8);
        };
        let v3 = v2 + v0 - v1;
        let v4 = v1;
        let v5 = arg3.active_sub_vault.share_supply + arg3.deactivating_sub_vault.share_supply;
        let v6 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::first<UserShareKey, u64>(&arg3.active_sub_vault.user_shares);
        while (0x1::option::is_some<UserShareKey>(&v6)) {
            let v7 = *0x1::option::borrow<UserShareKey>(&v6);
            let v8 = *0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::borrow<UserShareKey, u64>(&arg1.id, &arg3.active_sub_vault.user_shares, v7);
            let v9 = (((v3 as u128) * (v8 as u128) / (v5 as u128)) as u64);
            let v10 = (((v4 as u128) * (v8 as u128) / (v5 as u128)) as u64);
            let v11 = &mut arg4.premium_sub_vault;
            add_share<T2>(arg2, v11, v7.user, v9);
            let v12 = &mut arg4.performance_fee_sub_vault;
            add_share<T2>(arg2, v12, v7.user, v10);
            v3 = v3 - v9;
            v4 = v4 - v10;
            v5 = v5 - v8;
            v6 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::next<UserShareKey, u64>(&arg1.id, &arg3.active_sub_vault.user_shares, v7);
        };
        let v13 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::first<UserShareKey, u64>(&arg3.deactivating_sub_vault.user_shares);
        while (0x1::option::is_some<UserShareKey>(&v13)) {
            let v14 = *0x1::option::borrow<UserShareKey>(&v13);
            let v15 = *0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::borrow<UserShareKey, u64>(&arg1.id, &arg3.deactivating_sub_vault.user_shares, v14);
            let v16 = (((v3 as u128) * (v15 as u128) / (v5 as u128)) as u64);
            let v17 = (((v4 as u128) * (v15 as u128) / (v5 as u128)) as u64);
            let v18 = &mut arg4.premium_sub_vault;
            add_share<T2>(arg2, v18, v14.user, v16);
            let v19 = &mut arg4.performance_fee_sub_vault;
            add_share<T2>(arg2, v19, v14.user, v17);
            v3 = v3 - v16;
            v4 = v4 - v17;
            v5 = v5 - v15;
            v13 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::next<UserShareKey, u64>(&arg1.id, &arg3.deactivating_sub_vault.user_shares, v14);
        };
        while (!0x2::vec_map::is_empty<address, u64>(&arg7)) {
            let (v20, v21) = 0x2::vec_map::pop<address, u64>(&mut arg7);
            let v22 = &mut arg4.bidder_sub_vault;
            add_share<T2>(arg2, v22, v20, v21);
        };
        let v23 = Delivery<T0, T2>{
            signer          : 0x2::tx_context::sender(arg9),
            premium         : v0,
            performance_fee : v1,
        };
        0x2::event::emit<Delivery<T0, T2>>(v23);
    }
    ...
    public fun hotfix_bid_vault_v2<T0, T1>(arg0: &mut UserShareRegistry, arg1: &mut BidVault<T0, T1>, arg2: u64, arg3: u64, arg4: 0x1::option::Option<UserShareKey>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<UserShareKey>, u64, u64) {
        if (0x2::balance::value<T1>(&arg1.premium_sub_vault.balance) != arg1.premium_sub_vault.share_supply) {
            let v3 = &mut arg1.premium_sub_vault;
            adjust_user_share_limited<T1>(arg0, v3, arg2, arg3, arg4, arg5)
        } else {
            (0x1::option::none<UserShareKey>(), 0, 0)
        }
    }
    ...
    public fun hotfix_deposit_vault<T0, T1>(arg0: &mut UserShareRegistry, arg1: &mut DepositVault<T0, T1>, arg2: u64, arg3: u64, arg4: u64, arg5: 0x1::option::Option<UserShareKey>, arg6: u64) : (0x1::option::Option<UserShareKey>, u64, u64, u64) {
        let v0 = if (0x1::option::is_some<UserShareKey>(&arg5)) {
            ...
            0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::first<UserShareKey, u64>(&arg1.active_sub_vault.user_shares)
        };
        let v1 = v0;
        while (0x1::option::is_some<UserShareKey>(&v1) && arg6 > 0) {
            let v2 = *0x1::option::borrow<UserShareKey>(&v1);
            let v3 = *0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::borrow<UserShareKey, u64>(&mut arg0.id, &arg1.active_sub_vault.user_shares, v2);
            let v4 = (((arg2 as u128) * (v3 as u128) / (arg4 as u128)) as u64);
            let v5 = (((arg3 as u128) * (v3 as u128) / (arg4 as u128)) as u64);
            arg2 = arg2 - v4;
            arg3 = arg3 - v5;
            arg4 = arg4 - v3;
            v1 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::next<UserShareKey, u64>(&mut arg0.id, &arg1.active_sub_vault.user_shares, v2);
            if (v3 >= v4) {
                let v6 = &mut arg1.active_sub_vault;
                remove_share<T1>(arg0, v6, v2.user, 0x1::option::some<u64>(v3 - v4));
            } else {
                let v7 = &mut arg1.active_sub_vault;
                add_share<T1>(arg0, v7, v2.user, v4 - v3);
            };
            let v8 = &mut arg1.warmup_sub_vault;
            add_share<T1>(arg0, v8, v2.user, v5);
            arg6 = arg6 - 1;
        };
        (v1, arg2, arg3, arg4)
    }
    ...
    public fun hotfix_deposit_vault_balance<T0, T1>(arg0: &mut DepositVault<T0, T1>, arg1: 0x2::balance::Balance<T1>) {
        0x2::balance::join<T1>(&mut arg0.warmup_sub_vault.balance, arg1);
    }
    ...
    public fun settle_adjust_active_user_share_ratio_v2<T0, T1>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut DepositVault<T0, T1>, arg3: u64, arg4: u64, arg5: 0x1::option::Option<UserShareKey>, arg6: u64) : (0x1::option::Option<UserShareKey>, u64, u64) {
        let v0 = &mut arg2.active_sub_vault;
        adjust_user_share_limited<T1>(arg1, v0, arg3, arg4, arg5, arg6)
    }
    ...
    public fun settle_adjust_deactivating_user_share_ratio_v2<T0, T1>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut DepositVault<T0, T1>, arg3: u64, arg4: u64, arg5: 0x1::option::Option<UserShareKey>, arg6: u64) : (0x1::option::Option<UserShareKey>, u64, u64) {
        let v0 = &mut arg2.deactivating_sub_vault;
        adjust_user_share_limited<T1>(arg1, v0, arg3, arg4, arg5, arg6)
    }
    ...
    public fun settle_bidder_balance<T0, T1, T2, T3>(arg0: &T0, arg1: &UserShareRegistry, arg2: &mut DepositVault<T0, T1>, arg3: &mut BidVault<T0, T2>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: 0x1::option::Option<UserShareKey>, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<UserShareKey> {
        assert!(arg4 > 0, 0);
        let v0 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg5);
        let v1 = if (0x1::option::is_some<UserShareKey>(&arg8)) {
            arg8
        } else {
            0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::first<UserShareKey, u64>(&arg3.bidder_sub_vault.user_shares)
        };
        let v2 = v1;
        if (arg6 != 0 || arg7 != 0) {
            if (arg4 < v0) {
                while (0x1::option::is_some<UserShareKey>(&v2) && arg9 > 0) {
                    let v3 = *0x1::option::borrow<UserShareKey>(&v2);
                    let v4 = *0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::borrow<UserShareKey, u64>(&arg1.id, &arg3.bidder_sub_vault.user_shares, v3);
                    let v5 = 0x2::balance::split<T1>(&mut arg2.active_sub_vault.balance, (((arg6 as u256) * ((v0 - arg4) as u256) / (v0 as u256) * (v4 as u256) / (arg3.bidder_sub_vault.share_supply as u256)) as u64));
                    0x2::balance::join<T1>(&mut v5, 0x2::balance::split<T1>(&mut arg2.deactivating_sub_vault.balance, (((arg7 as u256) * ((v0 - arg4) as u256) / (v0 as u256) * (v4 as u256) / (arg3.bidder_sub_vault.share_supply as u256)) as u64)));
                    0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v5, arg10), v3.user);
                    v2 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::next<UserShareKey, u64>(&arg1.id, &arg3.bidder_sub_vault.user_shares, v3);
                    arg9 = arg9 - 1;
                };
            } else {
                v2 = 0x1::option::none<UserShareKey>();
            };
        };
        v2
    }
    ...
    public fun settle_bidder_balance_with_rewards<T0, T1, T2, T3>(arg0: &T0, arg1: &UserShareRegistry, arg2: &mut DepositVault<T0, T1>, arg3: &mut BidVault<T0, T2>, arg4: &mut 0x2::balance::Balance<T1>, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: 0x1::option::Option<UserShareKey>, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<UserShareKey> {
        assert!(arg6 > 0, 0);
        let v0 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg7);
        let v1 = if (0x1::option::is_some<UserShareKey>(&arg10)) {
            arg10
        } else {
            0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::first<UserShareKey, u64>(&arg3.bidder_sub_vault.user_shares)
        };
        ...
        if (arg8 != 0 || arg9 != 0) {
            if (arg6 < v0) {
                let v3 = arg8 + arg9;
                while (0x1::option::is_some<UserShareKey>(&v2) && arg11 > 0) {
                    let v4 = *0x1::option::borrow<UserShareKey>(&v2);
                    let v5 = (((v3 as u256) * ((v0 - arg6) as u256) / (v0 as u256) * (*0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::borrow<UserShareKey, u64>(&arg1.id, &arg3.bidder_sub_vault.user_shares, v4) as u256) / (arg3.bidder_sub_vault.share_supply as u256)) as u64);
                    let v6 = 0x2::balance::zero<T1>();
                    if (arg5 < v0) {
                        if ((v5 as u64) <= 0x2::balance::value<T1>(arg4)) {
                            0x2::balance::join<T1>(&mut v6, 0x2::balance::split<T1>(arg4, (v5 as u64)));
                        } else {
                            let v7 = 0x2::balance::value<T1>(arg4);
                            0x2::balance::join<T1>(&mut v6, 0x2::balance::split<T1>(arg4, v7));
                            let v8 = v5 - v7;
                            let v9 = (((v8 as u128) * (arg8 as u128) / (v3 as u128)) as u64);
                            0x2::balance::join<T1>(&mut v6, 0x2::balance::split<T1>(&mut arg2.active_sub_vault.balance, v9));
                            0x2::balance::join<T1>(&mut v6, 0x2::balance::split<T1>(&mut arg2.deactivating_sub_vault.balance, v8 - v9));
                        };
                    } else {
                        0x2::balance::join<T1>(&mut v6, 0x2::balance::split<T1>(&mut arg2.active_sub_vault.balance, (((v5 as u128) * (arg8 as u128) / (v3 as u128)) as u64)));
                        0x2::balance::join<T1>(&mut v6, 0x2::balance::split<T1>(&mut arg2.deactivating_sub_vault.balance, (((v5 as u128) * (arg9 as u128) / (v3 as u128)) as u64)));
                    };
                    0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v6, arg12), v4.user);
                    v2 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::next<UserShareKey, u64>(&arg1.id, &arg3.bidder_sub_vault.user_shares, v4);
                    arg11 = arg11 - 1;
                };
            } else {
                v2 = 0x1::option::none<UserShareKey>();
    ...
    public fun settle_fund<T0, T1, T2, T3>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut UserShareRegistry, arg3: &mut DepositVault<T0, T1>, arg4: &mut BidVault<T0, T2>, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (v1 != 0) {
            ...
            if (arg7 > v0) {
                ...
                v2 = v6;
                if (v6 != 0) {
                    let v7 = 0x2::balance::value<T2>(&arg4.performance_fee_sub_vault.balance);
                    if (v6 > v7) {
                        v2 = v7;
                    };
                    0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut arg4.performance_fee_sub_vault.balance, v2), arg11), @0xb90d6bddf3df46fc5590d412d062c00145dfae1d31446c0f206c61edf02ef5ba);
                };
            };
            if (v4 < v0) {
                let v8 = active_share_supply<T0, T1>(arg3) + deactivating_share_supply<T0, T1>(arg3);
                let v9 = (v1 as u256) * ((v0 - v4) as u256) / (v0 as u256);
                let v10 = 0x2::balance::split<T1>(&mut arg3.active_sub_vault.balance, ((v9 * (arg3.active_sub_vault.share_supply as u256) / (v8 as u256)) as u64));
                let v11 = &mut arg3.active_sub_vault;
                adjust_user_share_ratio<T1>(arg1, v11);
                let v12 = &mut arg3.deactivating_sub_vault;
                adjust_user_share_ratio<T1>(arg1, v12);
                0x2::balance::join<T1>(&mut v10, 0x2::balance::split<T1>(&mut arg3.deactivating_sub_vault.balance, ((v9 * (arg3.deactivating_sub_vault.share_supply as u256) / (v8 as u256)) as u64)));
                while (!0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::is_empty<UserShareKey, u64>(&arg4.bidder_sub_vault.user_shares)) {
                    let (v13, v14) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::pop_front<UserShareKey, u64>(&mut arg2.id, &mut arg4.bidder_sub_vault.user_shares);
                    let v15 = v13;
                    0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v10, (((0x2::balance::value<T1>(&v10) as u128) * (v14 as u128) / (arg4.bidder_sub_vault.share_supply as u128)) as u64)), arg11), v15.user);
                    arg4.bidder_sub_vault.share_supply = arg4.bidder_sub_vault.share_supply - v14;
                };
                0x2::balance::destroy_zero<T1>(v10);
            };
            if (0x2::balance::value<T2>(&arg4.performance_fee_sub_vault.balance) > 0) {
                let v16 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::first<UserShareKey, u64>(&arg4.performance_fee_sub_vault.user_shares);
                while (0x1::option::is_some<UserShareKey>(&v16)) {
                    let v17 = *0x1::option::borrow<UserShareKey>(&v16);
                    v16 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::next<UserShareKey, u64>(&arg2.id, &arg4.performance_fee_sub_vault.user_shares, v17);
                    let v18 = &mut arg4.performance_fee_sub_vault;
                    let (_, v20) = withdraw_<T2>(arg2, v18, 0x1::option::none<u64>(), v17.user);
                    let v21 = &mut arg4.premium_sub_vault;
                    deposit_<T2>(arg2, v21, v20, v17.user);
                };
            };
            let v22 = &mut arg3.deactivating_sub_vault;
            let v23 = &mut arg3.inactive_sub_vault;
            rock_n_roll<T1>(arg1, v22, v23);
        ...
        if (!arg3.has_next) {
            let v26 = &mut arg3.active_sub_vault;
            let v27 = &mut arg3.inactive_sub_vault;
            rock_n_roll<T1>(arg1, v26, v27);
        };
        let v28 = Settle<T0, T2>{
            signer              : 0x2::tx_context::sender(arg11),
        ...
        0x2::event::emit<Settle<T0, T2>>(v28);
        v2
    }
    ...
    public fun settle_fund_with_rewards<T0, T1, T2, T3>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut UserShareRegistry, arg3: &mut DepositVault<T0, T1>, arg4: &mut BidVault<T0, T2>, arg5: &mut 0x2::balance::Balance<T1>, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(arg8 > 0, 0);
        let v0 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg9);
        let v1 = active_balance<T0, T1>(arg3) + deactivating_balance<T0, T1>(arg3);
        let v2 = 0;
        if (v1 != 0) {
            let v3 = if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T1, T2>()) {
                ...
                ((((((0x2::balance::value<T2>(&arg4.performance_fee_sub_vault.balance) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4) as u128) / (1000 as u128)) as u64) as u128) * (arg10 as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg11) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg6) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg7) as u128)) as u64)
            } else {
                ((((((0x2::balance::value<T2>(&arg4.performance_fee_sub_vault.balance) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4) as u128) / (1000 as u128)) as u64) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg11) as u128) / (arg10 as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg6) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg7) as u128)) as u64)
            };
            let v4 = arg8 - (((v0 as u128) * (v3 as u128) / (v1 as u128)) as u64);
            let v5 = if (arg8 > v0) {
                let v6 = if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T1, T2>()) {
                    (((v1 as u128) * ((arg8 - v0) as u128) / (v0 as u128)) as u64)
                } else if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T1, T3>()) {
                    (((arg10 as u128) * ((((v1 as u128) * ((arg8 - v0) as u128) / (v0 as u128)) as u64) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg11) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg7) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg6) as u128)) as u64)
                } else {
                    (((0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg11) as u128) * ((((v1 as u128) * ((arg8 - v0) as u128) / (v0 as u128)) as u64) as u128) / (arg10 as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg7) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg6) as u128)) as u64)
                };
                let v7 = v6 * 1000 / 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4);
                v2 = v7;
                if (v7 != 0) {
                    let v8 = 0x2::balance::value<T2>(&arg4.performance_fee_sub_vault.balance);
                    if (v7 > v8) {
                        v2 = v8;
                    };
                    0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut arg4.performance_fee_sub_vault.balance, v2), arg12), @0xb90d6bddf3df46fc5590d412d062c00145dfae1d31446c0f206c61edf02ef5ba);
                };
                v2
            } else if ((((v1 as u256) * ((v0 - v4) as u256) / (v0 as u256)) as u64) <= 0x2::balance::value<T1>(arg5)) {
                let v9 = 0x2::balance::value<T2>(&arg4.performance_fee_sub_vault.balance);
                0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut arg4.performance_fee_sub_vault.balance, v9), arg12), @0xb90d6bddf3df46fc5590d412d062c00145dfae1d31446c0f206c61edf02ef5ba);
                v9
            } else {
                0
            };
            v2 = v5;
            if (v4 < v0) {
                let v10 = (v1 as u256) * ((v0 - v4) as u256) / (v0 as u256);
                let v11 = active_share_supply<T0, T1>(arg3) + deactivating_share_supply<T0, T1>(arg3);
                let v12 = 0x2::balance::zero<T1>();
                if (arg8 < v0) {
                    if ((v10 as u64) <= 0x2::balance::value<T1>(arg5)) {
                        0x2::balance::join<T1>(&mut v12, 0x2::balance::split<T1>(arg5, (v10 as u64)));
                    } else {
                        let v13 = 0x2::balance::value<T1>(arg5);
                        0x2::balance::join<T1>(&mut v12, 0x2::balance::split<T1>(arg5, v13));
                        let v14 = v10 - (v13 as u256);
                        0x2::balance::join<T1>(&mut v12, 0x2::balance::split<T1>(&mut arg3.active_sub_vault.balance, ((v14 * (arg3.active_sub_vault.share_supply as u256) / (v11 as u256)) as u64)));
                        0x2::balance::join<T1>(&mut v12, 0x2::balance::split<T1>(&mut arg3.deactivating_sub_vault.balance, ((v14 * (arg3.deactivating_sub_vault.share_supply as u256) / (v11 as u256)) as u64)));
                    };
                } else {
                    0x2::balance::join<T1>(&mut v12, 0x2::balance::split<T1>(&mut arg3.active_sub_vault.balance, ((v10 * (arg3.active_sub_vault.share_supply as u256) / (v11 as u256)) as u64)));
                    0x2::balance::join<T1>(&mut v12, 0x2::balance::split<T1>(&mut arg3.deactivating_sub_vault.balance, ((v10 * (arg3.deactivating_sub_vault.share_supply as u256) / (v11 as u256)) as u64)));
                };
                let v15 = &mut arg3.active_sub_vault;
                adjust_user_share_ratio<T1>(arg1, v15);
                let v16 = &mut arg3.deactivating_sub_vault;
                adjust_user_share_ratio<T1>(arg1, v16);
                while (!0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::is_empty<UserShareKey, u64>(&arg4.bidder_sub_vault.user_shares)) {
                    let (v17, v18) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::pop_front<UserShareKey, u64>(&mut arg2.id, &mut arg4.bidder_sub_vault.user_shares);
                    let v19 = v17;
                    0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v12, (((0x2::balance::value<T1>(&v12) as u128) * (v18 as u128) / (arg4.bidder_sub_vault.share_supply as u128)) as u64)), arg12), v19.user);
                    arg4.bidder_sub_vault.share_supply = arg4.bidder_sub_vault.share_supply - v18;
                };
                0x2::balance::destroy_zero<T1>(v12);
            };
            if (0x2::balance::value<T2>(&arg4.performance_fee_sub_vault.balance) > 0) {
                let v20 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::first<UserShareKey, u64>(&arg4.performance_fee_sub_vault.user_shares);
                while (0x1::option::is_some<UserShareKey>(&v20)) {
                    let v21 = *0x1::option::borrow<UserShareKey>(&v20);
                    v20 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::next<UserShareKey, u64>(&arg2.id, &arg4.performance_fee_sub_vault.user_shares, v21);
                    let v22 = &mut arg4.performance_fee_sub_vault;
                    let (_, v24) = withdraw_<T2>(arg2, v22, 0x1::option::none<u64>(), v21.user);
                    let v25 = &mut arg4.premium_sub_vault;
                    deposit_<T2>(arg2, v25, v24, v21.user);
                };
            };
            let v26 = &mut arg3.deactivating_sub_vault;
            let v27 = &mut arg3.inactive_sub_vault;
            rock_n_roll<T1>(arg1, v26, v27);
            arg4.bidder_sub_vault.share_supply = 0;
            while (!0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::is_empty<UserShareKey, u64>(&arg4.bidder_sub_vault.user_shares)) {
        ...
        if (!arg3.has_next) {
            let v30 = &mut arg3.active_sub_vault;
            let v31 = &mut arg3.inactive_sub_vault;
            rock_n_roll<T1>(arg1, v30, v31);
        };
        let v32 = Settle<T0, T2>{
            signer              : 0x2::tx_context::sender(arg12),
            settled_share_price : arg8,
            share_price_decimal : arg9,
            spot_price          : arg10,
            spot_price_decimal  : arg11,
        };
        0x2::event::emit<Settle<T0, T2>>(v32);
        v2
    }
    ...
    public fun settle_performance_fee_balance<T0, T1, T2, T3>(arg0: &T0, arg1: &mut DepositVault<T0, T1>, arg2: &mut BidVault<T0, T2>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64) {
        assert!(arg5 > 0, 0);
        let v0 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg6);
        let v1 = active_balance<T0, T1>(arg1);
        let v2 = deactivating_balance<T0, T1>(arg1);
        let v3 = v1 + v2;
        let v4 = 0;
        let v5 = if (v3 != 0) {
            let v6 = if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T1, T2>()) {
                (((0x2::balance::value<T2>(&arg2.performance_fee_sub_vault.balance) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4) as u128) / (1000 as u128)) as u64)
            } else if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T2, T3>()) {
                ((((((0x2::balance::value<T2>(&arg2.performance_fee_sub_vault.balance) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4) as u128) / (1000 as u128)) as u64) as u128) * (arg7 as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg8) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg3) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg4) as u128)) as u64)
            } else {
                ((((((0x2::balance::value<T2>(&arg2.performance_fee_sub_vault.balance) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4) as u128) / (1000 as u128)) as u64) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg8) as u128) / (arg7 as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg3) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg4) as u128)) as u64)
            };
            if (arg5 > v0) {
                let v7 = if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T1, T2>()) {
                    (((v3 as u128) * ((arg5 - v0) as u128) / (v0 as u128)) as u64)
                } else if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T1, T3>()) {
                    (((arg7 as u128) * ((((v3 as u128) * ((arg5 - v0) as u128) / (v0 as u128)) as u64) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg8) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg4) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg3) as u128)) as u64)
                } else {
                    (((0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg8) as u128) * ((((v3 as u128) * ((arg5 - v0) as u128) / (v0 as u128)) as u64) as u128) / (arg7 as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg4) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg3) as u128)) as u64)
                };
                let v8 = v7 * 1000 / 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4);
                v4 = v8;
                if (v8 != 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut arg2.performance_fee_sub_vault.balance, v8), arg9), @0xb90d6bddf3df46fc5590d412d062c00145dfae1d31446c0f206c61edf02ef5ba);
                };
            };
            arg5 - (((v0 as u128) * (v6 as u128) / (v3 as u128)) as u64)
        } else {
            v0
        };
        let v9 = Settle<T0, T2>{
            signer              : 0x2::tx_context::sender(arg9),
            settled_share_price : arg5,
            share_price_decimal : arg6,
            spot_price          : arg7,
            spot_price_decimal  : arg8,
        };
        0x2::event::emit<Settle<T0, T2>>(v9);
        (v4, v5, v1, v2)
    }
    ...
    public fun settle_performance_fee_balance_with_rewards<T0, T1, T2, T3>(arg0: &T0, arg1: &mut DepositVault<T0, T1>, arg2: &mut BidVault<T0, T2>, arg3: &mut 0x2::balance::Balance<T1>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64) {
        ...
        let v5 = if (v3 != 0) {
            let v6 = if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T1, T2>()) {
                ...
                ((((((0x2::balance::value<T2>(&arg2.performance_fee_sub_vault.balance) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4) as u128) / (1000 as u128)) as u64) as u128) * (arg8 as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg9) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg4) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg5) as u128)) as u64)
            } else {
                ((((((0x2::balance::value<T2>(&arg2.performance_fee_sub_vault.balance) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4) as u128) / (1000 as u128)) as u64) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg9) as u128) / (arg8 as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg4) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg5) as u128)) as u64)
            };
            let v7 = arg6 - (((v0 as u128) * (v6 as u128) / (v3 as u128)) as u64);
            let v8 = if (arg6 > v0) {
                let v9 = if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T1, T2>()) {
                    (((v3 as u128) * ((arg6 - v0) as u128) / (v0 as u128)) as u64)
                } else if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T1, T3>()) {
                    (((arg8 as u128) * ((((v3 as u128) * ((arg6 - v0) as u128) / (v0 as u128)) as u64) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg9) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg5) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg4) as u128)) as u64)
                } else {
                    (((0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg9) as u128) * ((((v3 as u128) * ((arg6 - v0) as u128) / (v0 as u128)) as u64) as u128) / (arg8 as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg5) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg4) as u128)) as u64)
                };
                let v10 = v9 * 1000 / 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4);
                if (v10 != 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut arg2.performance_fee_sub_vault.balance, v10), arg10), @0xb90d6bddf3df46fc5590d412d062c00145dfae1d31446c0f206c61edf02ef5ba);
                };
                v10
            } else if ((((v3 as u256) * ((v0 - v7) as u256) / (v0 as u256)) as u64) <= 0x2::balance::value<T1>(arg3)) {
                let v11 = 0x2::balance::value<T2>(&arg2.performance_fee_sub_vault.balance);
                0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut arg2.performance_fee_sub_vault.balance, v11), arg10), @0xb90d6bddf3df46fc5590d412d062c00145dfae1d31446c0f206c61edf02ef5ba);
                v11
            } else {
                0
            };
        ...
        let v12 = Settle<T0, T2>{
            signer              : 0x2::tx_context::sender(arg10),
            settled_share_price : arg6,
            share_price_decimal : arg7,
            spot_price          : arg8,
            spot_price_decimal  : arg9,
        };
        0x2::event::emit<Settle<T0, T2>>(v12);
        (v4, v5, v1, v2)
    }
    ...
    public fun settle_remained_performance_fee_combination<T0, T1>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut BidVault<T0, T1>, arg3: u64) {
        let v0 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::first<UserShareKey, u64>(&arg2.performance_fee_sub_vault.user_shares);
        while (0x1::option::is_some<UserShareKey>(&v0) && arg3 > 0) {
            let v1 = *0x1::option::borrow<UserShareKey>(&v0);
            v0 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::next<UserShareKey, u64>(&arg1.id, &arg2.performance_fee_sub_vault.user_shares, v1);
            let v2 = &mut arg2.performance_fee_sub_vault;
            let (_, v4) = withdraw_<T1>(arg1, v2, 0x1::option::none<u64>(), v1.user);
            let v5 = &mut arg2.premium_sub_vault;
            deposit_<T1>(arg1, v5, v4, v1.user);
            arg3 = arg3 - 1;
        };
    }

    public fun settle_reset_bidder_user_share<T0, T1>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut BidVault<T0, T1>, arg3: u64) {
        arg2.bidder_sub_vault.share_supply = 0;
        while (!0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::is_empty<UserShareKey, u64>(&arg2.bidder_sub_vault.user_shares) && arg3 > 0) {
            let (_, _) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::pop_front<UserShareKey, u64>(&mut arg1.id, &mut arg2.bidder_sub_vault.user_shares);
            arg3 = arg3 - 1;
        };
    }
    ...
    public fun settle_rock_n_roll_active<T0, T1>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut DepositVault<T0, T1>, arg3: u64) {
        if (!arg2.has_next) {
            let v0 = &mut arg2.active_sub_vault;
            let v1 = &mut arg2.inactive_sub_vault;
            let (_, _) = rock_n_roll_limited<T1>(arg1, v0, v1, arg3);
        };
    }
