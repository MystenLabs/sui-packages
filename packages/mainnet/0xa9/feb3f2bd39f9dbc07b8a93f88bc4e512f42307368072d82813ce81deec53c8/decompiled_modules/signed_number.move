module 0xa9feb3f2bd39f9dbc07b8a93f88bc4e512f42307368072d82813ce81deec53c8::signed_number {
    ...
    public fun div_uint(arg0: Number, arg1: u128) : Number {
        Number{
            value : 0xa9feb3f2bd39f9dbc07b8a93f88bc4e512f42307368072d82813ce81deec53c8::library::base_div(arg0.value, arg1),
            sign  : arg0.sign,
        }
    }
    ...
    public fun mul_uint(arg0: Number, arg1: u128) : Number {
        Number{
            value : 0xa9feb3f2bd39f9dbc07b8a93f88bc4e512f42307368072d82813ce81deec53c8::library::base_mul(arg0.value, arg1),
            sign  : arg0.sign,
        }
    }
    ...
    public fun one() : Number {
        Number{
            value : 0xa9feb3f2bd39f9dbc07b8a93f88bc4e512f42307368072d82813ce81deec53c8::library::base_uint(),
            sign  : true,
        }
    }
