module 0xa935ae67c6797dc136b6a3717bf8a96e2d3bf6aa658905c3b44754e6540d9c49::swap_aggregator {
    public entry fun swap<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: bool, arg4: bool, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = cetus_swap<T0, T1>(arg0, arg1, arg3, arg4, arg5, arg6, arg7);
        let v3 = v2;
        ...
        0x2::pay::keep<T1>(0x2::coin::from_balance<T1>(v1, arg8), arg8);
        reture_back_or_delete<T0>(v4, arg8);
    }
