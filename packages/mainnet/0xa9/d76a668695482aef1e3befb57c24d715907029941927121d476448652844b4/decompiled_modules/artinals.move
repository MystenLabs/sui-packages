module 0xa9d76a668695482aef1e3befb57c24d715907029941927121d476448652844b4::artinals {
    struct ARTINALS has drop {
        dummy_field: bool,
    }
    ...
    struct PublicTreasury has store, key {
        id: 0x2::object::UID,
        cap: 0x2::coin::TreasuryCap<ARTINALS>,
    ...
    fun init(arg0: ARTINALS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ARTINALS>(arg0, 9, b"XYZ", b"XYZ", b"XYZ is native test coin only for testing purposes", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://salmon-accused-puma-149.mypinata.cloud/ipfs/bafkreihtz6vozbrc3fl5bezr2tlx6fcjn23s3cekvvbf3jhlhbybz7axpy?pinataGatewayToken=Nc4R8TH9sXtjJQUiqvn_ZXvRnNYOlp6eH8lT7JTr0zEUEZV2BjEMU-81HiF2dy5x")), arg1);
        let v2 = v0;
        0x2::transfer::public_transfer<0x2::coin::Coin<ARTINALS>>(0x2::coin::mint<ARTINALS>(&mut v2, 100000000000000000, arg1), 0x2::tx_context::sender(arg1));
        let v3 = PublicTreasury{
            id      : 0x2::object::new(arg1),
            cap     : v2,
            records : 0x2::table::new<address, MintRecord>(arg1),
        };
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<ARTINALS>>(v1);
    ...
    fun mint_internal(arg0: &mut PublicTreasury, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<ARTINALS>>(0x2::coin::mint<ARTINALS>(&mut arg0.cap, arg1, arg4), arg2);
        let v5 = MintEvent{
            minter    : v0,
            amount    : arg1,
            timestamp : v1,
