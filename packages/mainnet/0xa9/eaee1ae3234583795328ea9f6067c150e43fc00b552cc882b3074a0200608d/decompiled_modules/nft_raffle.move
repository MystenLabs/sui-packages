module 0xa9eaee1ae3234583795328ea9f6067c150e43fc00b552cc882b3074a0200608d::nft_raffle {
    ...
    public entry fun create_raffle<T0: store + key>(arg0: T0, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: address, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<vector<u8>, T0>(&mut v1.id, b"nft", arg0);
        let v2 = RaffleCreated{
            raffle_id    : 0x2::object::id<Raffle>(&v1),
            creator      : 0x2::tx_context::sender(arg8),
    ...
    public entry fun draw_winner<T0: store + key>(arg0: &AdminCap, arg1: &mut Raffle, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun end_raffle<T0: store + key>(arg0: &mut Raffle, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    fun generate_random_number(arg0: vector<u8>, arg1: u64) : u64 {
        ...
        (0x1::vector::pop_back<u8>(&mut arg0) as u64) % arg1
    }
