module 0xa9652dd9560b86aa3b6acd15e1789017cefa8f198fcf349f96f4c921eeb1d7a8::collection_for_edition_tgqlzq {
    struct COLLECTION_FOR_EDITION_TGQLZQ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: COLLECTION_FOR_EDITION_TGQLZQ, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<COLLECTION_FOR_EDITION_TGQLZQ>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Collection for Edition tgqlzq"));
