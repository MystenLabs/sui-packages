module 0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::milestone {
    ...
    public fun check_if_update_milestone<T0, T1>(arg0: &mut LockedPool<T0, T1>, arg1: &VestingConfig, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) : (bool, bool, bool) {
        ...
        ((0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::cetus::get_token_price<T0, T1>(arg2) as u64) * arg1.total_supply >= get_milestone_target_fdv(arg0.milestone_round, arg1), arg0.current_milestone_start, v0)
    }

    public fun claim<T0, T1>(arg0: &mut LockedPool<T0, T1>, arg1: &mut 0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::project_manager::FundingProof, arg2: &VestingConfig, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg2);
        let v0 = claimable<T0, T1>(arg0, arg1, arg2);
        assert!(v0 > 0, 0);
        assert!(0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::project_manager::get_proof_project_id(arg1) == arg0.project_id, 1);
        0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::project_manager::update_proof_claimed(arg1, v0);
    ...
    public(friend) fun claimable<T0, T1>(arg0: &LockedPool<T0, T1>, arg1: &0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::project_manager::FundingProof, arg2: &VestingConfig) : u64 {
        assert!(0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::project_manager::get_proof_project_id(arg1) == arg0.project_id, 1);
        let v0 = (0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::project_manager::get_proof_token(arg1) as u128) * (get_milestone_total_unlocked(arg0.milestone_round, arg2) as u128) / (arg2.locked_supply as u128);
        let v1 = 0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::project_manager::get_proof_claimed(arg1);
        if ((v0 as u64) > v1) {
            (v0 as u64) - v1
        } else {
            0
    ...
    public(friend) entry fun new_wallet<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: 0x2::coin::Coin<T0>, arg2: u8, arg3: &0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::project_manager::ProjectManager<T0>, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = LockedPool<T0, T1>{
            ...
            start_times             : 0,
            position_id             : arg4,
            project_id              : 0x2::object::id<0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::project_manager::ProjectManager<T0>>(arg3),
        };
    ...
    public fun update_milestone<T0, T1>(arg0: &0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::launchpad_manager_config::LaunchAdmin, arg1: &mut LockedPool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::project_manager::ProjectManager<T0>, arg4: &0x2::clock::Clock, arg5: &VestingConfig) {
        assert_version(arg5);
        let v0 = (0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::cetus::get_token_price<T0, T1>(arg2) as u64) * arg5.total_supply;
        ...
        if (arg1.current_milestone_start == false) {
            ...
            let v1 = MilestoneUpdatedEvent{
                ...
                count                 : 0xa91402d64ccda6f0cd354780df0f339efc55d6a06776b6b7134a50e53789ce07::project_manager::get_project_count<T0>(arg3),
