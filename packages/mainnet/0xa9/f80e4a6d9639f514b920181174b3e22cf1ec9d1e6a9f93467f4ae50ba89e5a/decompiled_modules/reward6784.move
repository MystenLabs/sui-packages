module 0xa9f80e4a6d9639f514b920181174b3e22cf1ec9d1e6a9f93467f4ae50ba89e5a::reward6784 {
    struct REWARD6784 has drop {
        dummy_field: bool,
    }

    struct TICKET_6784 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6784(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6784>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6784>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6784, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6784>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6784>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6784>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6784>>(v5, 0x2::tx_context::sender(arg1));
    }
