module 0xa91cb9970cf518c155b879d761bc531501e1efd3fc6c0115efdc7a4bacb4e862::router {
    struct OrderRecord has copy, drop {
        order_id: u64,
        decimal: u8,
        from_coin_address: 0x1::ascii::String,
        from_amount: u64,
        to_coin_address: 0x1::ascii::String,
        out_amount: u64,
    }
    ...
    public fun finalize<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: u64, arg3: address, arg4: address, arg5: u64, arg6: u8, arg7: 0x1::ascii::String, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 > 0, 8);
        ...
        if (arg2 > 0) {
            let v2 = &mut arg0;
            let (v3, _) = split_with_percentage_for_commission<T0>(v2, arg2, arg3, arg9);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v3, v1);
            destroy_or_transfer<T0>(arg0, arg9);
        } else {
        ...
        let v5 = OrderRecord{
            order_id          : arg5,
            decimal           : arg6,
            from_coin_address : arg7,
            from_amount       : arg8,
            to_coin_address   : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            out_amount        : v0,
        };
        0x2::event::emit<OrderRecord>(v5);
    }

    public fun finalize_without_transfer<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: u8, arg3: 0x1::ascii::String, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u64) {
        let v0 = 0x2::coin::value<T0>(&arg0);
        let v1 = OrderRecord{
            order_id          : arg1,
            decimal           : arg2,
            from_coin_address : arg3,
            from_amount       : arg4,
            to_coin_address   : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            out_amount        : v0,
        };
