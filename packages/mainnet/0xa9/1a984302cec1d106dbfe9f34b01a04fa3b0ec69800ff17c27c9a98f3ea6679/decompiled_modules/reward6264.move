module 0xa91a984302cec1d106dbfe9f34b01a04fa3b0ec69800ff17c27c9a98f3ea6679::reward6264 {
    struct REWARD6264 has drop {
        dummy_field: bool,
    }

    struct TICKET_6264 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6264(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6264>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6264>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6264, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6264>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6264>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6264>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6264>>(v5, 0x2::tx_context::sender(arg1));
    }
