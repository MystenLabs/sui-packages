module 0xa94a5683f8e0c93e8179c271e32588ae2a63d22b60526a804f62881b9d61392c::agu_token {
    ...
    fun init(arg0: AGU_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGU_TOKEN>(arg0, 6, b"ceshi6", b"ceshi666", b"AGU Token on Sui Network", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://cryptologos.cc/logos/agoras-tokens-agrs-logo.png?v=040")), arg1);
        let v2 = v0;
