module 0xa9019aaa84d4fa7896a6fdb144531b6a13b7d46db379da17865016c5fa9e0909::q64x64 {
    ...
    public fun log2(arg0: u128) : u128 {
        ...
        let v3 = 0xa9019aaa84d4fa7896a6fdb144531b6a13b7d46db379da17865016c5fa9e0909::bit_math::most_significant_bit(v1);
        let v4 = 64;
        let v5 = if (v3 >= v4) {
    ...
    public fun sqrt(arg0: u128) : u128 {
        ...
        let v0 = 0xa9019aaa84d4fa7896a6fdb144531b6a13b7d46db379da17865016c5fa9e0909::bit_math::most_significant_bit(arg0);
        let v1 = if (v0 >= 64) {
            1 << (v0 + 64) / 2
        } else {
            1 << (v0 + 64) / 2
