module 0xa92f6ea72d00cf5a6c976e26ec89805ff2f2c14cbe8f9001ad46d5d180f15e98::cnsnft6217 {
    struct CNSNFT6217 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6217, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6153"));
        let v4 = 0x2::package::claim<CNSNFT6217>(arg0, arg1);
