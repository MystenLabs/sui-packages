module 0xa9e0b51d0d122344f40de689ca7c273c393aeacabe28f2c29083dbaa4115b2ac::ownable {
    ...
    public fun assert_version(arg0: &AdminCap) {
        assert!(arg0.version == 0xa9e0b51d0d122344f40de689ca7c273c393aeacabe28f2c29083dbaa4115b2ac::version::get_program_version(), 2);
    }
    ...
    public(friend) fun grant_admin_cap(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = AdminCap{
            ...
            version : 0xa9e0b51d0d122344f40de689ca7c273c393aeacabe28f2c29083dbaa4115b2ac::version::get_program_version(),
        };
    ...
    public(friend) fun migrate(arg0: &mut AdminCap, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0xa9e0b51d0d122344f40de689ca7c273c393aeacabe28f2c29083dbaa4115b2ac::version::get_program_version();
