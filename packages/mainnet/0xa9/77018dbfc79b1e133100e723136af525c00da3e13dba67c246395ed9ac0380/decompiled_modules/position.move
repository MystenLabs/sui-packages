module 0xa977018dbfc79b1e133100e723136af525c00da3e13dba67c246395ed9ac0380::position {
    ...
    public(friend) fun check_position_cap_matches<T0>(arg0: &Position<T0>, arg1: &PositionCap) {
        assert!(0x2::object::id<Position<T0>>(arg0) == arg1.position_id, 0xa977018dbfc79b1e133100e723136af525c00da3e13dba67c246395ed9ac0380::errors::err_position_cap_not_match());
    }
    ...
    public(friend) fun destroy_position<T0>(arg0: Position<T0>, arg1: &0xa977018dbfc79b1e133100e723136af525c00da3e13dba67c246395ed9ac0380::config::GlobalConfig) {
        let Position {
            id                   : v0,
        ...
        0x2::transfer::public_transfer<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>>(v3, 0xa977018dbfc79b1e133100e723136af525c00da3e13dba67c246395ed9ac0380::config::collect_obligation_owner_cap_address(arg1));
    }
