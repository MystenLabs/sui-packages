module 0xa977018dbfc79b1e133100e723136af525c00da3e13dba67c246395ed9ac0380::config {
    ...
    public(friend) fun assert_global_close_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_close_pause, 0xa977018dbfc79b1e133100e723136af525c00da3e13dba67c246395ed9ac0380::errors::err_global_close_paused());
    }

    public(friend) fun assert_global_open_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_open_pause, 0xa977018dbfc79b1e133100e723136af525c00da3e13dba67c246395ed9ac0380::errors::err_global_open_paused());
    }

    public(friend) fun assert_package_version(arg0: &GlobalConfig) {
        assert!(check_package_version(arg0), 0xa977018dbfc79b1e133100e723136af525c00da3e13dba67c246395ed9ac0380::errors::err_wrong_version());
    }
