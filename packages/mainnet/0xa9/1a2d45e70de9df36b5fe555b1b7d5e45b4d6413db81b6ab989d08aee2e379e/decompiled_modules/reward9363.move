module 0xa91a2d45e70de9df36b5fe555b1b7d5e45b4d6413db81b6ab989d08aee2e379e::reward9363 {
    struct REWARD9363 has drop {
        dummy_field: bool,
    }

    struct TICKET_9363 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9363(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9363>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9363>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9363, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9363>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9363>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9363>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9363>>(v5, 0x2::tx_context::sender(arg1));
    }
