module 0xa9b90e29e6d0c5853888a23142ec33e1da38ab5c8a84ed2a2cde4399f0264acd::reward8454 {
    struct REWARD8454 has drop {
        dummy_field: bool,
    }

    struct TICKET_8454 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8454(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8454>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8454>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8454, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8454>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8454>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8454>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8454>>(v5, 0x2::tx_context::sender(arg1));
    }
