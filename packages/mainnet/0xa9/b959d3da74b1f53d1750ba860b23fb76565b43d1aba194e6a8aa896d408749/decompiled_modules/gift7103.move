module 0xa9b959d3da74b1f53d1750ba860b23fb76565b43d1aba194e6a8aa896d408749::gift7103 {
    struct GIFT7103 has drop {
        dummy_field: bool,
    }

    struct TICKET_7103 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift7103(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7103>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7103>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT7103, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7103>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7103>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7103>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7103>>(v5, 0x2::tx_context::sender(arg1));
    }
