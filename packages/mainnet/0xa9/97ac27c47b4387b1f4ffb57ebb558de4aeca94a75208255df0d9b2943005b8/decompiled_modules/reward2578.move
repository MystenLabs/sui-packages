module 0xa997ac27c47b4387b1f4ffb57ebb558de4aeca94a75208255df0d9b2943005b8::reward2578 {
    struct REWARD2578 has drop {
        dummy_field: bool,
    }

    struct TICKET_2578 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2578(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2578>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2578>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2578, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2578>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2578>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2578>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2578>>(v5, 0x2::tx_context::sender(arg1));
    }
