module 0xa92d401a52a118eb54f9c1e8f4ac0d717af569b9a5c19fe030a702c64dc6ece5::reward6792 {
    struct REWARD6792 has drop {
        dummy_field: bool,
    }

    struct TICKET_6792 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6792(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6792>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6792>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6792, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6792>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6792>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6792>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6792>>(v5, 0x2::tx_context::sender(arg1));
    }
