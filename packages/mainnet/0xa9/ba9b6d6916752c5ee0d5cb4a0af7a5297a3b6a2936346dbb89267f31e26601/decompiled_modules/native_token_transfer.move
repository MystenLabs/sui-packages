module 0xa9ba9b6d6916752c5ee0d5cb4a0af7a5297a3b6a2936346dbb89267f31e26601::native_token_transfer {
    struct NativeTokenTransfer has copy, drop, store {
        amount: 0xa9ba9b6d6916752c5ee0d5cb4a0af7a5297a3b6a2936346dbb89267f31e26601::trimmed_amount::TrimmedAmount,
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : NativeTokenTransfer {
        assert!(0xa9ba9b6d6916752c5ee0d5cb4a0af7a5297a3b6a2936346dbb89267f31e26601::bytes4::to_bytes(0xa9ba9b6d6916752c5ee0d5cb4a0af7a5297a3b6a2936346dbb89267f31e26601::bytes4::take(arg0)) == x"994e5454", 13906834603840176130);
        ...
        NativeTokenTransfer{
            amount       : 0xa9ba9b6d6916752c5ee0d5cb4a0af7a5297a3b6a2936346dbb89267f31e26601::trimmed_amount::new(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_u64_be(arg0), 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_u8(arg0)),
    ...
    public fun to_bytes(arg0: NativeTokenTransfer) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v7, 0xa9ba9b6d6916752c5ee0d5cb4a0af7a5297a3b6a2936346dbb89267f31e26601::trimmed_amount::to_bytes(&v6));
