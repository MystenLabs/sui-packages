module 0xa9ba9b6d6916752c5ee0d5cb4a0af7a5297a3b6a2936346dbb89267f31e26601::transceiver_message_data {
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : TransceiverMessageData<vector<u8>> {
        ...
        TransceiverMessageData<vector<u8>>{
            ...
            ntt_manager_payload           : 0xa9ba9b6d6916752c5ee0d5cb4a0af7a5297a3b6a2936346dbb89267f31e26601::ntt_manager_message::take_bytes(arg0),
        }
    }
    ...
    public fun to_bytes(arg0: TransceiverMessageData<vector<u8>>) : vector<u8> {
        ...
        let v4 = 0xa9ba9b6d6916752c5ee0d5cb4a0af7a5297a3b6a2936346dbb89267f31e26601::ntt_manager_message::to_bytes(v2);
