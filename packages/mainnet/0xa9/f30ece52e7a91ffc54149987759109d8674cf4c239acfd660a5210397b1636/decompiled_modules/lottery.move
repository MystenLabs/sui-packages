module 0xa9f30ece52e7a91ffc54149987759109d8674cf4c239acfd660a5210397b1636::lottery {
    ...
    public entry fun buy_lottory(arg0: &mut Lottery, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    fun get_random(arg0: &0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::WeatherOracle, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) : u64 {
        ...
        0x1::vector::append<u8>(&mut v0, 0xa9f30ece52e7a91ffc54149987759109d8674cf4c239acfd660a5210397b1636::utils::u32_to_ascii(0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::city_weather_oracle_pressure(arg0, 2988507)));
        0x1::vector::append<u8>(&mut v0, 0xa9f30ece52e7a91ffc54149987759109d8674cf4c239acfd660a5210397b1636::utils::u32_to_ascii(0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::city_weather_oracle_pressure(arg0, 2147714)));
        0x1::vector::append<u8>(&mut v0, 0xa9f30ece52e7a91ffc54149987759109d8674cf4c239acfd660a5210397b1636::utils::u32_to_ascii(0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::city_weather_oracle_temp(arg0, 1785286)));
        0x1::vector::append<u8>(&mut v0, 0xa9f30ece52e7a91ffc54149987759109d8674cf4c239acfd660a5210397b1636::utils::u64_to_ascii(0x2::clock::timestamp_ms(arg2)));
    ...
    public entry fun withdraw(arg0: &AdminCap, arg1: &mut Lottery, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.reward_pool, 0x2::balance::value<0x2::sui::SUI>(&arg1.reward_pool), arg2), 0x2::tx_context::sender(arg2));
    }
