module 0xa95602abb3495099056976cc784c6d172aecc3491617cf3aad7f17bcdd879313::LOPY {
    struct LOPY has drop {
        dummy_field: bool,
    }

    fun init(arg0: LOPY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<LOPY>(arg0, 9, b"ELON", b"Elon Musk", b"Elon Musk wif Trump", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
