module 0xa9425518068ad66c32e4c75f24ebadfb83ee78128c746ab9a45411751bd88576::vault {
    ...
    public(friend) fun initialize<T0, T1>(arg0: 0x2::object::ID, arg1: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = Vault<T0, T1>{
