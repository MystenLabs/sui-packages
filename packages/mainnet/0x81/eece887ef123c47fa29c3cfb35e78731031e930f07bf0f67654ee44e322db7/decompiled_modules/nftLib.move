module 0xafa3e6b3070c5c5683ea78ca5529758dbf46ddeaca8d4045c6185c48577361ab::nftLib {
        ...
        while (v0 <= 0x2::vec_map::size<u64, Achievement>(&arg0.achievements)) {
            ...
            while (v2 < 0x1::vector::length<u8>(&arg4)) {
                ...
                if (v3 == v1.achievementType) {
                    if (v1.communityId != arg2 && v1.communityId != 0xafa3e6b3070c5c5683ea78ca5529758dbf46ddeaca8d4045c6185c48577361ab::commonLib::getZeroId()) {
                        continue
                    };
