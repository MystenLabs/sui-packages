module 0x81c0a61f8e3cd32627d94f4e426ca125537fefd9975a94d0a255569b67077807::cnsnft5498 {
    struct CNSNFT5498 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5498, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8984"));
        let v4 = 0x2::package::claim<CNSNFT5498>(arg0, arg1);
