module 0x81329157565290ffe41cb19c7a75e36d6cb76bac0bad0ce9a1943e9f31fb165d::cnsnft4081 {
    struct CNSNFT4081 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4081, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7160"));
        let v4 = 0x2::package::claim<CNSNFT4081>(arg0, arg1);
