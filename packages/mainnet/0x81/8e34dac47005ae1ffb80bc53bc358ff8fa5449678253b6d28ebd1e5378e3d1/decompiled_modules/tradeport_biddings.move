module 0x818e34dac47005ae1ffb80bc53bc358ff8fa5449678253b6d28ebd1e5378e3d1::tradeport_biddings {
    ...
    public fun create_multi_bid(arg0: &mut Store, arg1: 0x1::option::Option<0x1::ascii::String>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<0x2::object::ID, MultiBid>(&mut arg0.id, 0x2::object::id<MultiBid>(&v0), v0);
    }
