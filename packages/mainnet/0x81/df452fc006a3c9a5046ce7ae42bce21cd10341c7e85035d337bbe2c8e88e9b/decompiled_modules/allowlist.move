module 0x81df452fc006a3c9a5046ce7ae42bce21cd10341c7e85035d337bbe2c8e88e9b::allowlist {
    ...
    fun approve_internal(arg0: address, arg1: vector<u8>, arg2: &Allowlist) : bool {
        if (!0x81df452fc006a3c9a5046ce7ae42bce21cd10341c7e85035d337bbe2c8e88e9b::utils::is_prefix(namespace(arg2), arg1)) {
            return false
        };
