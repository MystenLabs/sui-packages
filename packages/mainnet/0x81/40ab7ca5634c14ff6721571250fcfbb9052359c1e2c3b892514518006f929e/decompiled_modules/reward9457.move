module 0x8140ab7ca5634c14ff6721571250fcfbb9052359c1e2c3b892514518006f929e::reward9457 {
    struct REWARD9457 has drop {
        dummy_field: bool,
    }

    struct TICKET_9457 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9457(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9457>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9457>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9457, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9457>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9457>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9457>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9457>>(v5, 0x2::tx_context::sender(arg1));
    }
