module 0x8f19f70c0ce1f69c5533e1e981b5b0342b309cb1d324ee6b0d5e9b969d1cc639::bank {
    ...
    public fun burn_btoken<T0, T1, T2>(arg0: &mut Bank<T0, T1, T2>, arg1: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &mut 0x2::coin::Coin<T2>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(arg3 > 0, 14);
        0x2::balance::decrease_supply<T2>(&mut arg0.btoken_supply, 0x2::coin::into_balance<T2>(0x2::coin::split<T2>(arg2, arg3, arg4)));
        assert!(arg3 > 0, 15);
        assert!(0x2::balance::value<T1>(&arg0.funds_available) > arg3, 17);
        let v1 = BurnBTokenEvent{
            ...
            withdrawn_amount  : arg3,
            burned_amount     : arg3,
        };
        0x8f19f70c0ce1f69c5533e1e981b5b0342b309cb1d324ee6b0d5e9b969d1cc639::events::emit_event<BurnBTokenEvent>(v1);
        0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.funds_available, arg3), arg4)
    }
    ...
    public fun mint_btoken<T0, T1, T2>(arg0: &mut Bank<T0, T1, T2>, arg1: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &mut 0x2::coin::Coin<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        0x8f19f70c0ce1f69c5533e1e981b5b0342b309cb1d324ee6b0d5e9b969d1cc639::version::assert_version_and_upgrade(&mut arg0.version, 1);
        if (0x2::balance::supply_value<T2>(&arg0.btoken_supply) == 0) {
            assert!(arg3 > 1000, 16);
        } else {
        ...
        0x8f19f70c0ce1f69c5533e1e981b5b0342b309cb1d324ee6b0d5e9b969d1cc639::events::emit_event<MintBTokenEvent>(v0);
        0x2::balance::join<T1>(&mut arg0.funds_available, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(arg2, arg3, arg4)));
        0x2::coin::from_balance<T2>(0x2::balance::increase_supply<T2>(&mut arg0.btoken_supply, arg3), arg4)
    }
