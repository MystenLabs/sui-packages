module 0x81403faba6eefd5bd3ed8ea05b05e2dd818c8a301917cc3778d66d77e34d51a8::cnsnft5440 {
    struct CNSNFT5440 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5440, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4814"));
        let v4 = 0x2::package::claim<CNSNFT5440>(arg0, arg1);
