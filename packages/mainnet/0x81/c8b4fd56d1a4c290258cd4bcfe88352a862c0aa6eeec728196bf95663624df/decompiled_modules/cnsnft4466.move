module 0x81c8b4fd56d1a4c290258cd4bcfe88352a862c0aa6eeec728196bf95663624df::cnsnft4466 {
    struct CNSNFT4466 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4466, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4466>(arg0, arg1);
