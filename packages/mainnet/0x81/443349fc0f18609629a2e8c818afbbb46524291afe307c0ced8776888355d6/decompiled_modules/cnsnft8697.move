module 0x81443349fc0f18609629a2e8c818afbbb46524291afe307c0ced8776888355d6::cnsnft8697 {
    struct CNSNFT8697 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8697, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8697>(arg0, arg1);
