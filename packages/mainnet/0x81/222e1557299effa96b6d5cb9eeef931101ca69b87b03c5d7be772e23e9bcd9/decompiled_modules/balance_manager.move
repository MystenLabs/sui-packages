module 0x81222e1557299effa96b6d5cb9eeef931101ca69b87b03c5d7be772e23e9bcd9::balance_manager {
    ...
    public(friend) fun get_referral_id(arg0: &BalanceManager) : 0x1::option::Option<0x2::object::ID> {
        let v0 = 0x81222e1557299effa96b6d5cb9eeef931101ca69b87b03c5d7be772e23e9bcd9::constants::referral_df_key();
    ...
    public fun new_with_custom_owner_and_caps(arg0: address, arg1: &mut 0x2::tx_context::TxContext) : (BalanceManager, DepositCap, WithdrawCap, TradeCap) {
        let v0 = new_with_custom_owner(arg0, arg1);
        let v1 = &mut v0;
        let v2 = mint_deposit_cap_internal(v1, arg1);
        let v3 = &mut v0;
        let v4 = mint_withdraw_cap_internal(v3, arg1);
        let v5 = &mut v0;
        (v0, v2, v4, mint_trade_cap_internal(v5, arg1))
    }
    ...
    public fun register_manager(arg0: &BalanceManager, arg1: &mut 0x81222e1557299effa96b6d5cb9eeef931101ca69b87b03c5d7be772e23e9bcd9::registry::Registry) {
        0x81222e1557299effa96b6d5cb9eeef931101ca69b87b03c5d7be772e23e9bcd9::registry::add_balance_manager(arg1, owner(arg0), id(arg0));
    }
    ...
    public fun set_referral(arg0: &mut BalanceManager, arg1: &DeepBookReferral, arg2: &TradeCap) {
        ...
        0x2::dynamic_field::remove_if_exists<vector<u8>, 0x2::object::ID>(&mut arg0.id, 0x81222e1557299effa96b6d5cb9eeef931101ca69b87b03c5d7be772e23e9bcd9::constants::referral_df_key());
        0x2::dynamic_field::add<vector<u8>, 0x2::object::ID>(&mut arg0.id, 0x81222e1557299effa96b6d5cb9eeef931101ca69b87b03c5d7be772e23e9bcd9::constants::referral_df_key(), 0x2::object::uid_to_inner(&arg1.id));
    ...
    public fun unset_referral(arg0: &mut BalanceManager, arg1: &TradeCap) {
        ...
        0x2::dynamic_field::remove_if_exists<vector<u8>, 0x2::object::ID>(&mut arg0.id, 0x81222e1557299effa96b6d5cb9eeef931101ca69b87b03c5d7be772e23e9bcd9::constants::referral_df_key());
        let v0 = DeepBookReferralSetEvent{
            referral_id        : 0x2::object::id_from_bytes(b""),
            balance_manager_id : 0x2::object::uid_to_inner(&arg0.id),
        };
        0x2::event::emit<DeepBookReferralSetEvent>(v0);
    }
