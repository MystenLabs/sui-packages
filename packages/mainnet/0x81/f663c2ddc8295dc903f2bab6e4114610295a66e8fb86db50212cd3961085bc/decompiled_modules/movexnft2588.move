module 0x81f663c2ddc8295dc903f2bab6e4114610295a66e8fb86db50212cd3961085bc::movexnft2588 {
    struct MOVEXNFT2588 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT2588, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT2588>(arg0, arg1);
