module 0x81bf6ea8fb1e1c70485a2fa642b582c4162e0bcc0353cbc49768956e13f78511::cnsnft1448 {
    struct CNSNFT1448 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1448, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1448>(arg0, arg1);
