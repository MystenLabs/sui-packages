module 0xb85447e328ca363f4121459093958560b4df45cecb89d4804c8d01def4361eb2::sgc {
    struct SGC has drop {
        dummy_field: bool,
    }
    ...
    public entry fun admin_mint(arg0: &mut Minter, arg1: &mut AdminTotal, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 >= arg1.cycle) {
            ...
            0x2::coin::mint_and_transfer<SGC>(&mut arg0.cap, 500000000000000, 0x2::tx_context::sender(arg2), arg2);
        };
    }
