module 0x8150f2d0d0d83c34860c685491a7bf221248f9d1c554fb1d6096f8f94e6d343a::cnsnft6871 {
    struct CNSNFT6871 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6871, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6871>(arg0, arg1);
