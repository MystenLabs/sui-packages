module 0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::settings {
    struct WorkspaceSettings has store {
        ...
        workspace_cap: 0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::workspace_registry::WorkspaceCap,
        id_counter: u16,
    }
    ...
    public(friend) fun borrow_workspace_cap(arg0: &WorkspaceSettings) : &0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::workspace_registry::WorkspaceCap {
        &arg0.workspace_cap
    }

    public(friend) fun eject_approve_caps(arg0: &mut WorkspaceSettings, arg1: 0x2::object::ID, arg2: vector<0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::approve_interface::ApproveCap>, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) {
        arg0.is_operational = false;
        0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::workspace_registry::eject(&arg0.workspace_cap, arg1, arg3, arg2, arg4);
    }
    ...
    public(friend) fun get_settings_fields(arg0: &WorkspaceSettings) : (0x1::string::String, bool, 0x2::vec_set::VecSet<0x2::object::ID>, 0x2::vec_set::VecSet<0x2::object::ID>, &0x2::vec_map::VecMap<u16, ActionGroup>, &0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::workspace_registry::WorkspaceCap, u16) {
    ...
    public fun get_workspace_settings_fields(arg0: &WorkspaceSettings) : (0x1::string::String, bool, bool, 0x1::option::Option<0x2::object::ID>, 0x2::vec_set::VecSet<0x2::object::ID>, 0x2::vec_set::VecSet<0x2::object::ID>, 0x2::object::ID, &0x2::vec_map::VecMap<u16, ActionGroup>, u16) {
        (arg0.name, arg0.is_operational, arg0.is_paused, arg0.admin_pause_cap_id, arg0.allowed_tx_effect_module_ids, arg0.allowed_tx_assemble_module_ids, 0x2::object::id<0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::workspace_registry::WorkspaceCap>(&arg0.workspace_cap), &arg0.tx_effect_module_groups, arg0.id_counter)
    }
    ...
    public(friend) fun init_workspace_settings(arg0: 0x1::string::String, arg1: 0x1::option::Option<0x2::object::ID>, arg2: &mut 0x2::tx_context::TxContext) : WorkspaceSettings {
        WorkspaceSettings{
            ...
            workspace_cap                  : 0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::workspace_registry::create_workspace_cap(arg2),
            id_counter                     : 0,
        }
    }
