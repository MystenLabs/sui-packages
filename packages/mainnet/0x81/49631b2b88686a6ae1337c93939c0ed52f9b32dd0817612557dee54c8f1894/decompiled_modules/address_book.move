module 0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::address_book {
    ...
    public(friend) fun get_address_ids_by_address(arg0: &AddressBook, arg1: 0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::library::NetworkAddress) : vector<u16> {
        ...
        while (!0x1::vector::is_empty<u16>(&v1)) {
            ...
            let v4 = 0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::library::get_address_raw(&arg1);
            let v5 = v3.address_;
            let v6 = if (&v4 == &v5) {
                let v7 = 0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::library::get_network_id(&arg1);
