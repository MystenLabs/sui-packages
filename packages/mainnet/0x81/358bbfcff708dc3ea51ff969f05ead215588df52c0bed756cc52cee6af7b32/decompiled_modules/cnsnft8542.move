module 0x81358bbfcff708dc3ea51ff969f05ead215588df52c0bed756cc52cee6af7b32::cnsnft8542 {
    struct CNSNFT8542 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8542, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8542>(arg0, arg1);
