module 0x60edcdd61727c06b94e0e9e5b034240d3c905d00a82ffb06b63d9aedbac2c5a0::balance_locker {
    ...
    public fun clear_balance_assets_of<T0, T1: drop>(arg0: &mut 0x60edcdd61727c06b94e0e9e5b034240d3c905d00a82ffb06b63d9aedbac2c5a0::asset_locker::AssetLocker<0x2::balance::Balance<T0>, T1>, arg1: &mut T1, arg2: address) {
        let v0 = 0x60edcdd61727c06b94e0e9e5b034240d3c905d00a82ffb06b63d9aedbac2c5a0::asset_locker::assets_of_mut<0x2::balance::Balance<T0>, T1>(arg0, arg1, arg2);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x2::balance::Balance<T0>>(v0)) {
            if (0x2::balance::value<T0>(0x1::vector::borrow<0x2::balance::Balance<T0>>(v0, v1)) == 0) {
                0x2::balance::destroy_zero<T0>(0x1::vector::remove<0x2::balance::Balance<T0>>(v0, v1));
            };
            v1 = v1 + 1;
        };
    }
