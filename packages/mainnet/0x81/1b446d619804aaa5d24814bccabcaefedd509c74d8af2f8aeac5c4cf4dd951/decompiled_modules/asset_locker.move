module 0x60edcdd61727c06b94e0e9e5b034240d3c905d00a82ffb06b63d9aedbac2c5a0::asset_locker {
    ...
    public fun drop<T0: store, T1: drop>(arg0: AssetLocker<T0, T1>) {
        let AssetLocker {
            id        : v0,
            assets_of : v1,
        } = arg0;
        0x2::object::delete(v0);
        0x2::table::destroy_empty<address, vector<T0>>(v1);
    }

    public fun drop_assets_of<T0: store, T1: drop>(arg0: &mut AssetLocker<T0, T1>, arg1: address) {
        0x1::vector::destroy_empty<T0>(0x2::table::remove<address, vector<T0>>(&mut arg0.assets_of, arg1));
    }
