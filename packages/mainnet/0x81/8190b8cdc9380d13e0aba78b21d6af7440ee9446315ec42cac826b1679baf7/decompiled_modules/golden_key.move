module 0x818190b8cdc9380d13e0aba78b21d6af7440ee9446315ec42cac826b1679baf7::golden_key {
    ...
    public fun blacklist_minter(arg0: &AdminCap, arg1: &Version, arg2: &mut BlacklistedMinters, arg3: address) {
        checkVersion(arg1, 1);
        assert!(!0x1::vector::contains<address>(&arg2.minters, &arg3), 9223372681100132357);
    ...
    public fun checkVersion(arg0: &Version, arg1: u64) {
        assert!(arg1 == arg0.version, 9223372513596276739);
    }
    ...
    public entry fun migrate(arg0: &AdminCap, arg1: &mut Version, arg2: u64) {
        assert!(arg2 > arg1.version, 9223372530776145923);
        arg1.version = arg2;
    }
    ...
    public fun mint_golden_key(arg0: &MinterCap, arg1: &Version, arg2: &mut GkSupply, arg3: &BlacklistedMinters, arg4: &mut 0x2::tx_context::TxContext) : GoldenKey {
        ...
        assert!(!0x1::vector::contains<address>(&arg3.minters, &v0), 9223372732639739909);
        let v1 = get_total_supply(arg2);
        assert!(v1 < 2000, 9223372745524379649);
        let v2 = GoldenKey{
