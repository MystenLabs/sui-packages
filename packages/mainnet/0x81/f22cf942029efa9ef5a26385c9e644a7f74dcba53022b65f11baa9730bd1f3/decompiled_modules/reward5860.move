module 0x81f22cf942029efa9ef5a26385c9e644a7f74dcba53022b65f11baa9730bd1f3::reward5860 {
    struct REWARD5860 has drop {
        dummy_field: bool,
    }

    struct TICKET_5860 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5860(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5860>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5860>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5860, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5860>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5860>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5860>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5860>>(v5, 0x2::tx_context::sender(arg1));
    }
