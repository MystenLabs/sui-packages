module 0x97e6c267e6887d5cdb11543e87b22c1ae67c81dbc8d17ab8541066d31d279bc4::pool_rewards {
    ...
    struct StakedNFT has store, key {
        id: 0x2::object::UID,
        nft: 0x97e6c267e6887d5cdb11543e87b22c1ae67c81dbc8d17ab8541066d31d279bc4::creature_nft::CreatureNFT,
        owner: address,
        pool_id: 0x2::object::ID,
        stake_time: u64,
        weight: u64,
    ...
    fun check_nft_has_all_required_elements(arg0: &0x97e6c267e6887d5cdb11543e87b22c1ae67c81dbc8d17ab8541066d31d279bc4::creature_nft::CreatureNFT, arg1: &vector<u64>) : bool {
    ...
    public fun delete_pool(arg0: &PoolAdminCap, arg1: &mut PoolSystem, arg2: 0x2::object::ID, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < 0x1::vector::length<0x2::object::ID>(&v0.staked_nft_ids)) {
            ...
            if (0x2::object_table::contains<0x2::object::ID, StakedNFT>(&v0.staked_nfts, v3)) {
                ...
                0x2::transfer::public_transfer<0x97e6c267e6887d5cdb11543e87b22c1ae67c81dbc8d17ab8541066d31d279bc4::creature_nft::CreatureNFT>(v6, v4.owner);
            };
            v2 = v2 + 1;
        };
        let Pool {
    ...
    fun extract_nft_element_ids(arg0: &0x97e6c267e6887d5cdb11543e87b22c1ae67c81dbc8d17ab8541066d31d279bc4::creature_nft::CreatureNFT) : vector<u64> {
        0x97e6c267e6887d5cdb11543e87b22c1ae67c81dbc8d17ab8541066d31d279bc4::creature_nft::get_all_item_ids(arg0)
    }
    ...
    public fun stake_nft(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: 0x97e6c267e6887d5cdb11543e87b22c1ae67c81dbc8d17ab8541066d31d279bc4::creature_nft::CreatureNFT, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object_table::borrow_mut<0x2::object::ID, Pool>(&mut arg0.pools, arg1);
        assert!(v0.is_active, 2);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        ...
        let v3 = 0x2::object::id<0x97e6c267e6887d5cdb11543e87b22c1ae67c81dbc8d17ab8541066d31d279bc4::creature_nft::CreatureNFT>(&arg2);
        let v4 = 1;
        let v5 = StakedNFT{
    ...
    public fun unstake_nft(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x97e6c267e6887d5cdb11543e87b22c1ae67c81dbc8d17ab8541066d31d279bc4::creature_nft::CreatureNFT>(v7, v1);
        let v14 = NFTUnstaked{
            pool_id           : arg1,
            nft_id            : arg2,
            owner             : v1,
    ...
    public fun update_pool_rewards(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object_table::borrow_mut<0x2::object::ID, Pool>(&mut arg0.pools, arg1);
        let v1 = 0x2::clock::timestamp_ms(arg2);
    ...
    fun validate_nft_requirements(arg0: &Pool, arg1: &0x97e6c267e6887d5cdb11543e87b22c1ae67c81dbc8d17ab8541066d31d279bc4::creature_nft::CreatureNFT) {
