module 0x812649979c180941dbdac5cfba72e38bb0acf8ad9898e996730525595824eb84::cnsnft9164 {
    struct CNSNFT9164 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9164, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9164>(arg0, arg1);
