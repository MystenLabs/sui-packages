module 0x5c2e311a1522127325affecc7890404bc337fb094ad8b41145b48d984ea5dee3::kiosk_staking {
    ...
    public fun stake_with_nft<T0: store + key>(arg0: &mut Global, arg1: &mut 0x2::kiosk::Kiosk, arg2: T0, arg3: 0x2::transfer_policy::TransferRequest<T0>, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.enabled, 1);
        let v0 = ensure_supported<T0>(arg0);
        assert_staking_kiosk(arg0, arg1);
        let v1 = 0x2::object::id<T0>(&arg2);
        assert!(!0x2::table::contains<0x2::object::ID, StakedItemInfo>(&arg0.staked, v1), 4);
        0x2::kiosk::lock<T0>(arg1, &arg0.staking_cap, arg4, arg2);
        ...
        let v8 = StakedItemInfo{
            kiosk_id  : v5,
            staker    : v6,
            staked_at : v7,
            item_type : v0,
        };
        0x2::table::add<0x2::object::ID, StakedItemInfo>(&mut arg0.staked, v1, v8);
        inc_active(arg0, v6);
        let v9 = Staked{
            kiosk            : v5,
            item             : v1,
