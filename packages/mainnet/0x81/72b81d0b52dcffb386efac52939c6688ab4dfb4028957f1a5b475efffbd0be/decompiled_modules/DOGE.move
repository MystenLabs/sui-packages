module 0x8172b81d0b52dcffb386efac52939c6688ab4dfb4028957f1a5b475efffbd0be::DOGE {
    ...
    fun init(arg0: DOGE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<DOGE>(arg0, 9, b"MEOWTH", b"MEOWTH MILLIONS", b"MEOWTH MILLIONS Token", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
