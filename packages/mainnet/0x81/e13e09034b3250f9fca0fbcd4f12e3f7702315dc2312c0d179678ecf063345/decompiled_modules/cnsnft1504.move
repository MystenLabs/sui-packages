module 0x81e13e09034b3250f9fca0fbcd4f12e3f7702315dc2312c0d179678ecf063345::cnsnft1504 {
    struct CNSNFT1504 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1504, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3567"));
        let v4 = 0x2::package::claim<CNSNFT1504>(arg0, arg1);
