module 0x250880a4c1a268da8011b164f599d4e100cefce84f862d36396cd1a943ee8a35::vault {
    ...
    entry fun provision<T0>(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: vector<vector<u8>>, arg5: vector<address>, arg6: u64, arg7: 0x2::coin::Coin<T0>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x250880a4c1a268da8011b164f599d4e100cefce84f862d36396cd1a943ee8a35::policy::new_policy(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg8, arg9);
        let v2 = v0;
        let v3 = new<T0>(&v2, arg9);
        let v4 = &mut v3;
        deposit<T0>(v4, arg7);
        0x2::transfer::public_transfer<0x250880a4c1a268da8011b164f599d4e100cefce84f862d36396cd1a943ee8a35::policy::PolicyOwnerCap>(v1, 0x2::tx_context::sender(arg9));
        0x250880a4c1a268da8011b164f599d4e100cefce84f862d36396cd1a943ee8a35::policy::share_policy(v2);
    ...
    public fun vault_transfer<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x250880a4c1a268da8011b164f599d4e100cefce84f862d36396cd1a943ee8a35::policy::AgentPolicy, arg2: u64, arg3: address, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x250880a4c1a268da8011b164f599d4e100cefce84f862d36396cd1a943ee8a35::policy::assert_recipient_allowed(arg1, arg3);
        let (v0, v1) = vault_spend<T0>(arg0, arg1, arg2, @0x0, b"transfer", arg4, arg5, arg6);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v0, arg3);
        0x2::transfer::public_transfer<0x250880a4c1a268da8011b164f599d4e100cefce84f862d36396cd1a943ee8a35::policy::ActionReceipt>(v1, 0x250880a4c1a268da8011b164f599d4e100cefce84f862d36396cd1a943ee8a35::policy::owner(arg1));
    }
