module 0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::dao_vault {
    ...
    public fun add_deposit_coin<T0>(arg0: &mut Vault, arg1: &ManagerCap, arg2: &0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::coin_registry::CoinRegistry) {
        assert!(arg1.vault_id == 0x2::object::id<Vault>(arg0), 5);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x2::vec_set::contains<0x1::ascii::String>(0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::coin_registry::coins(arg2), &v0), 22);
        process_add_deposit_coin<T0>(arg0);
    }

    public fun add_swap_coin<T0>(arg0: &mut Vault, arg1: &ManagerCap, arg2: &0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::coin_registry::CoinRegistry) {
        assert!(arg1.vault_id == 0x2::object::id<Vault>(arg0), 5);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x2::vec_set::contains<0x1::ascii::String>(0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::coin_registry::coins(arg2), &v0), 22);
    ...
    public fun calculate_total_value_locked_in_usd<T0>(arg0: &Vault, arg1: &0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::coin_registry::CoinRegistry, arg2: &mut TotalValueLockedCalculation, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x2::clock::Clock) {
        let v0 = 0x1::vector::pop_back<0x1::ascii::String>(&mut arg2.remaining_coins);
        arg2.value = arg2.value + 0x2::balance::value<T0>(0x2::bag::borrow<0x1::ascii::String, 0x2::balance::Balance<T0>>(&arg0.balance_storage, v0)) * 0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::price::usd_price(0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::coin_registry::get_price_feed_id(arg1, &v0), arg4, arg5) / 0x2::math::pow(10, 0x2::coin::get_decimals<T0>(arg3));
    }

    public fun deposit_coin<T0>(arg0: &mut Vault, arg1: &0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::coin_registry::CoinRegistry, arg2: TotalValueLocked, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 1);
        let v0 = 0x2::coin::value<T0>(&arg5);
        assert!(v0 > 0, 2);
        let v1 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        let v2 = usd_to_shares(arg0, arg2, 0x2::coin::value<T0>(&arg5) * 0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::price::usd_price(0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::coin_registry::get_price_feed_id(arg1, &v1), arg4, arg6) / 0x2::math::pow(10, 0x2::coin::get_decimals<T0>(arg3)));
        assert!(v2 > 0, 2);
    ...
    public fun execute_withdrawal<T0>(arg0: &mut Vault, arg1: &mut Withdrawal, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(0x1::vector::pop_back<0x1::ascii::String>(&mut arg1.coins) == 0x1::type_name::into_string(0x1::type_name::get<T0>()), 13906835406998994943);
    ...
    public fun finalize_withdrawal(arg0: &mut Vault, arg1: Withdrawal, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        burn_lp(arg0, 0x2::tx_context::sender(arg2), v2);
        0x1::vector::destroy_empty<0x1::ascii::String>(v3);
        0x2::object::delete(v0);
    }

    public fun flashloan_for_swap<T0>(arg0: &mut Vault, arg1: &ManagerCap, arg2: &0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::coin_registry::CoinRegistry, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanForSwap) {
        assert!(arg5 > 0, 2);
        assert!(arg1.vault_id == 0x2::object::id<Vault>(arg0), 5);
        assert!(!arg0.paused, 1);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        let v1 = arg5 * 0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::price::usd_price(0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::coin_registry::get_price_feed_id(arg2, &v0), arg4, arg6) / 0x2::math::pow(10, 0x2::coin::get_decimals<T0>(arg3));
    ...
    public fun initiate_withdrawal(arg0: &mut Vault, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : Withdrawal {
        assert!(!arg0.paused, 1);
        let v0 = get_liquidity_provider_balance(arg0, 0x2::tx_context::sender(arg3));
        assert!(v0 > 0 && v0 >= arg1, 3);
        Withdrawal{
    ...
    public fun return_flashloan_from_swap<T0>(arg0: &mut Vault, arg1: &0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::coin_registry::CoinRegistry, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: FlashLoanForSwap, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::coin::value<T0>(&arg5) * 0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::price::usd_price(0x8172c9e07390a697d837cdcec5a8722b9446c6229bed09df3ca03d7b463dae5a::coin_registry::get_price_feed_id(arg1, &v3), arg3, arg6) / 0x2::math::pow(10, 0x2::coin::get_decimals<T0>(arg2));
