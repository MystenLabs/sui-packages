module 0x81b5df55d237da081483b2e20670bc5c6a5c892e840fd3705514597cc074ab51::containers {
    struct CONTAINERS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CONTAINERS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CONTAINERS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"containers"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"containers for sale"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeid5rkd2vd4vggz4deptxyodcydv3u6im4aej4zeclomxxadvhajce"));
