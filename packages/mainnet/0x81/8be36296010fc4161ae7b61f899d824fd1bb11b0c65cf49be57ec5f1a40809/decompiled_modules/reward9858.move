module 0x818be36296010fc4161ae7b61f899d824fd1bb11b0c65cf49be57ec5f1a40809::reward9858 {
    struct REWARD9858 has drop {
        dummy_field: bool,
    }

    struct TICKET_9858 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9858(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9858>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9858>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9858, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9858>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9858>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9858>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9858>>(v5, 0x2::tx_context::sender(arg1));
    }
