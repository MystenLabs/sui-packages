module 0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction {
    ...
    public fun create_auction<T0: store + key, T1>(arg0: &0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::AuctionHouse, arg1: &mut 0x2::kiosk::Kiosk, arg2: T0, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : Auction<T0, T1> {
        let v0 = 0x2::object::id<T0>(&arg2);
        0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::deposit_item<T0>(arg0, arg1, arg2);
    ...
    public entry fun create_auction_from_kiosk<T0: store + key, T1>(arg0: &0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::AuctionHouse, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::kiosk::Kiosk, arg4: 0x2::object::ID, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = create_auction<T0, T1>(arg0, arg3, 0x2::kiosk::take<T0>(arg1, &arg2, arg4), arg5, arg6, arg7);
        0x2::transfer::public_share_object<Auction<T0, T1>>(v0);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(arg2, 0x2::tx_context::sender(arg7));
    }
    ...
    public entry fun create_auction_from_kiosk_with_lock<T0: store + key, T1>(arg0: &0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::AuctionHouse, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::object::ID, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = create_auction_with_lock<T0, T1>(arg0, arg3, arg4, v0, arg6, arg7, arg8);
    ...
    public fun create_auction_with_lock<T0: store + key, T1>(arg0: &0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::AuctionHouse, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::transfer_policy::TransferPolicy<T0>, arg3: T0, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : Auction<T0, T1> {
        ...
        0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::deposit_item_with_lock<T0>(arg0, arg1, arg2, arg3);
    ...
    public fun finalize_auction<T0: store + key, T1>(arg0: &mut 0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::AuctionHouse, arg1: &mut 0x2::kiosk::Kiosk, arg2: Auction<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<address>(&v8)) {
            ...
            0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::get_fee_from_payment<T1>(arg0, &mut v12, arg4);
            let v13 = 0x2::coin::value<T1>(&v12);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v12, v2);
            0x2::transfer::public_transfer<T0>(0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::withdraw_item<T0>(arg0, arg1, v1), v11);
            ...
            0x2::transfer::public_transfer<T0>(0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::withdraw_item<T0>(arg0, arg1, v1), v2);
    ...
    public fun finalize_auction_with_lock<T0: store + key, T1>(arg0: &mut 0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::AuctionHouse, arg1: &mut 0x2::kiosk::Kiosk, arg2: Auction<T0, T1>, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<address>(&v8)) {
            ...
            0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::get_fee_from_payment<T1>(arg0, &mut v12, arg5);
            let v13 = 0x2::coin::value<T1>(&v12);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v12, v2);
            let (v14, v15) = 0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::withdraw_item_with_lock<T0>(arg0, arg1, v1, arg5);
            ...
            0x2::balance::destroy_zero<T1>(v7);
            let (v20, v21) = 0x81218dcaf73d16099461cf36a7872f30a7acb23d36bba1126c3c0013d993a98d::auction_house::withdraw_item_with_lock<T0>(arg0, arg1, v1, arg5);
