module 0x815e835f32498271a51a77cc80fff84ffe75e015a2df3da16bfee0f31433797f::plhh {
    ...
    public entry fun purchase_tokens(arg0: &mut PreSaleConfig, arg1: &0x2::clock::Clock, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch(arg5);
        if (v0 >= arg0.phase_start_time + 17) {
        ...
        let v4 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::get_price_info_from_price_info_object(arg4);
        let v5 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::get_price_identifier(&v4);
        assert!(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v5) == x"23d7315113f5b1d3ba7a83604c44b94d79f4fd69af77f804fc7f920a6dc65744", 44);
        let v6 = ((arg0.current_phase - 1) as u64);
        let v7 = *0x1::vector::borrow<u64>(&arg0.phase_tokens_sold, v6);
        assert!(v7 + arg3 <= *0x1::vector::borrow<u64>(&arg0.phase_token_allocations, v6), 0);
        *0x1::vector::borrow_mut<u64>(&mut arg0.phase_tokens_sold, v6) = v7 + arg3;
        let v8 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_expo(&v3);
        let v9 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_price(&v3);
        let v10 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_is_negative(&v8);
        let v11 = if (v10) {
            0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_negative(&v8)
        } else {
            0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v8)
        };
        let v12 = if (v10) {
            0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v9) * pow10((v11 as u8))
        } else {
            0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v9) / pow10((v11 as u8))
        };
        let v13 = v12 / 10000000;
        let v14 = (((v2 as u128) * 100000000 / 100 * 1000000000 / (v13 as u128) * (arg3 as u128) / 1000000000 * 10) as u64);
        assert!(0x2::coin::value<0x2::sui::SUI>(arg2) >= v14, 21);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.presale_funds, 0x2::balance::split<0x2::sui::SUI>(0x2::coin::balance_mut<0x2::sui::SUI>(arg2), v14));
        0x2::transfer::public_transfer<0x2::coin::Coin<PLHH>>(0x2::coin::mint<PLHH>(&mut arg0.treasury_cap, arg3, arg5), 0x2::tx_context::sender(arg5));
        arg0.total_sold = arg0.total_sold + arg3;
        arg0.market_cap_usd_cents = arg0.total_sold * v2 / 1000000000;
        let v15 = TokensPurchased{
        ...
        0x2::event::emit<TokensPurchased>(v15);
        check_burn_thresholds(arg0, arg5);
    }
    ...
    public entry fun withdraw_funds(arg0: &mut PreSaleConfig, arg1: &AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.admin, 8);
        let v0 = if (arg2 == 0) {
