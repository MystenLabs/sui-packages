module 0x81fb142a757e0380bf0e961d2df3bdbe50fdb0dea6c2298c0b8e33472357709a::sixtwentyone {
    ...
    entry fun getRound(arg0: &Round, arg1: u64) : (u64, vector<u8>, u64) {
        (0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, arg1 - 1).round, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, arg1 - 1).draw_numbers, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, arg1 - 1).draw_time_ms)
    }
    ...
    entry fun latestRound(arg0: &Round) : (u64, vector<u8>, u64) {
        ...
        (0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0 - 1).round, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0 - 1).draw_numbers, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0 - 1).draw_time_ms)
    }
    ...
    entry fun run(arg0: &mut Round, arg1: u8, arg2: u8, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<u64, RoundMetadata>(&mut arg0.rounds, v0, v1);
