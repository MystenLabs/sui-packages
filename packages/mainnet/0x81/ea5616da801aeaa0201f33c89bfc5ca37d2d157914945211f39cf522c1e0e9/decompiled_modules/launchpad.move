module 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::launchpad {
    ...
    fun claim_fund_pre_sale_for<T0, T1>(arg0: &mut Launchpad<T0, T1>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (arg0.pre_sale_config.total_deposit_amount <= arg0.pre_sale_config.soft_cap) {
            ...
            v0 - 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(v0, arg0.pre_sale_config.max_sale_amount, arg0.pre_sale_config.total_deposit_amount), arg0.pre_sale_config.fixed_price, 100000000) + 1
        };
    ...
    public entry fun claim_pre_sale<T0, T1>(arg0: &mut Launchpad<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = if (arg0.pre_sale_config.total_deposit_amount <= arg0.pre_sale_config.soft_cap) {
            ...
            0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(v2, 100000000, arg0.pre_sale_config.fixed_price)
        } else {
            0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(v2, arg0.pre_sale_config.max_sale_amount, arg0.pre_sale_config.total_deposit_amount)
        };
        if (v3 > 0) {
    ...
    public entry fun claim_public_sale<T0, T1>(arg0: &mut Launchpad<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = if (arg0.public_sale_config.total_deposit_amount <= arg0.public_sale_config.soft_cap) {
            (0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(v2, 100000000, arg0.public_sale_config.min_price), 0)
        } else if (arg0.public_sale_config.total_deposit_amount <= arg0.public_sale_config.hard_cap) {
            (0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(v2, 100000000, 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(arg0.public_sale_config.total_deposit_amount, 100000000, arg0.public_sale_config.fixed_sale_amount)), 0)
        } else {
            let v5 = 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(v2, arg0.public_sale_config.fixed_sale_amount, arg0.public_sale_config.total_deposit_amount);
            (v5, v2 - 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(v5, arg0.public_sale_config.max_price, 100000000) + 1)
        };
    ...
    public entry fun collect_remaining_tokens<T0, T1>(arg0: &AdminCap, arg1: &mut Launchpad<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = if (arg1.pre_sale_config.total_deposit_amount <= arg1.pre_sale_config.soft_cap) {
            ...
            arg1.pre_sale_config.max_sale_amount - 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(arg1.pre_sale_config.total_deposit_amount, 100000000, arg1.pre_sale_config.fixed_price)
        } else {
            0
        };
        let v1 = if (arg1.public_sale_config.total_deposit_amount <= arg1.public_sale_config.soft_cap) {
            arg1.public_sale_config.fixed_sale_amount - 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(arg1.public_sale_config.total_deposit_amount, 100000000, arg1.public_sale_config.min_price)
        } else if (arg1.public_sale_config.total_deposit_amount <= arg1.public_sale_config.hard_cap) {
            arg1.public_sale_config.fixed_sale_amount - 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(arg1.public_sale_config.total_deposit_amount, 100000000, 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(arg1.public_sale_config.total_deposit_amount, 100000000, arg1.public_sale_config.fixed_sale_amount))
        } else {
            0
        };
        let v2 = WalletDfKey<T1>{dummy_field: false};
    ...
    public entry fun initialize<T0: drop, T1: drop>(arg0: &AdminCap, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        v0.soft_cap = 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(v0.fixed_price, v0.min_sale_amount, 100000000);
        v0.hard_cap = 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(v0.fixed_price, v0.max_sale_amount, 100000000);
        ...
        v1.soft_cap = 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(v1.fixed_sale_amount, v1.min_price, 100000000);
        v1.hard_cap = 0x81ea5616da801aeaa0201f33c89bfc5ca37d2d157914945211f39cf522c1e0e9::u64::mul_div(v1.fixed_sale_amount, v1.max_price, 100000000);
