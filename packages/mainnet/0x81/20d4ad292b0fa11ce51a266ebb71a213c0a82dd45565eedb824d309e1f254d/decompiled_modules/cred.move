module 0x8120d4ad292b0fa11ce51a266ebb71a213c0a82dd45565eedb824d309e1f254d::cred {
    ...
    fun init(arg0: CRED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x8120d4ad292b0fa11ce51a266ebb71a213c0a82dd45565eedb824d309e1f254d::sellable::create_config<CRED>(arg0, arg1);
        0x2::transfer::public_share_object<0x8120d4ad292b0fa11ce51a266ebb71a213c0a82dd45565eedb824d309e1f254d::sellable::CredenzaSellableConfig<CRED>>(v1);
