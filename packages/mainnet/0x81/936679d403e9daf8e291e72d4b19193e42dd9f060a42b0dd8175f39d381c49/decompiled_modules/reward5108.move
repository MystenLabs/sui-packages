module 0x81936679d403e9daf8e291e72d4b19193e42dd9f060a42b0dd8175f39d381c49::reward5108 {
    struct REWARD5108 has drop {
        dummy_field: bool,
    }

    struct TICKET_5108 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5108(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5108>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5108>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5108, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5108>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5108>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5108>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5108>>(v5, 0x2::tx_context::sender(arg1));
    }
