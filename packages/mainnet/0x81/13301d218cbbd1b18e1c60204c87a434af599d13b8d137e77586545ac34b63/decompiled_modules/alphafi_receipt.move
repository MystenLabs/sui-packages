module 0x18533807391b15db5f1f530f54b32553372e5c204d179928d8da0a1753cbb63c::alphafi_receipt {
    struct TransferRequestKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    struct TransferRequest has store, key {
        id: 0x2::object::UID,
        receipt_id: 0x2::object::ID,
        auto_accept_timestamp: u64,
        receiver: address,
    }
    ...
    public fun cancel_request_transfer(arg0: &mut AlphaFiReceipt, arg1: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        verify_owner(arg0, arg1);
        let v0 = TransferRequestKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<TransferRequestKey>(&arg0.id, v0), 10);
        let v1 = TransferRequestKey{dummy_field: false};
        let TransferRequest {
            id                    : v2,
            receipt_id            : _,
            auto_accept_timestamp : _,
            receiver              : _,
        } = 0x2::dynamic_field::remove<TransferRequestKey, TransferRequest>(&mut arg0.id, v1);
    ...
    public fun create_request_transfer(arg0: &mut AlphaFiReceipt, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        verify_owner(arg0, arg3);
        assert!(arg1 != 0x2::tx_context::sender(arg3), 7);
        let v0 = TransferRequestKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists_<TransferRequestKey>(&arg0.id, v0), 8);
        let v1 = TransferRequest{
            id                    : 0x2::object::new(arg3),
            receipt_id            : 0x2::object::id<AlphaFiReceipt>(arg0),
            auto_accept_timestamp : 0x2::clock::timestamp_ms(arg2) + 172800000,
            receiver              : arg1,
        };
        let v2 = TransferRequestKey{dummy_field: false};
        0x2::dynamic_field::add<TransferRequestKey, TransferRequest>(&mut arg0.id, v2, v1);
    }

    public fun fulfill_transfer_request(arg0: AlphaFiReceipt, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg0;
        verify_version(v0);
        verify_owner(&arg0, arg2);
        let v1 = TransferRequestKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<TransferRequestKey>(&arg0.id, v1), 10);
        let v2 = TransferRequestKey{dummy_field: false};
        let v3 = 0x2::dynamic_field::remove<TransferRequestKey, TransferRequest>(&mut arg0.id, v2);
        assert!(v3.auto_accept_timestamp <= 0x2::clock::timestamp_ms(arg1), 11);
        let v4 = v3.receiver;
        arg0.client_address = v4;
        let TransferRequest {
            id                    : v5,
            receipt_id            : _,
            auto_accept_timestamp : _,
        ...
        0x2::transfer::transfer<AlphaFiReceipt>(arg0, v4);
    }
    ...
    public fun remove_white_listed_address(arg0: &mut WhiteListedAddressForTransfer, arg1: &AdminCap, arg2: address) {
        assert!(0x2::vec_set::contains<address>(&arg0.addresses, &arg2), 5);
    ...
    public fun transfer_receipt_to_new_owner(arg0: AlphaFiReceipt, arg1: address, arg2: &mut WhiteListedAddressForTransfer, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        verify_version(v0);
        verify_owner(&arg0, arg3);
        let v1 = arg0.client_address;
        if (arg1 != v1) {
            assert!(0x2::vec_set::contains<address>(&arg2.addresses, &v1), 5);
            arg0.client_address = arg1;
            0x2::vec_set::remove<address>(&mut arg2.addresses, &v1);
        };
    ...
    fun verify_version(arg0: &mut AlphaFiReceipt) {
        let v0 = VersionKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<VersionKey>(&arg0.id, v0)) {
            let v1 = VersionKey{dummy_field: false};
            assert!(2 >= 0x2::dynamic_field::remove<VersionKey, u64>(&mut arg0.id, v1), 9);
        };
        let v2 = VersionKey{dummy_field: false};
        0x2::dynamic_field::add<VersionKey, u64>(&mut arg0.id, v2, 2);
    }
