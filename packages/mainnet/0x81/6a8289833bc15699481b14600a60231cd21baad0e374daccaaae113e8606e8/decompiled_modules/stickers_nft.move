module 0xb908f3c6fea6865d32e2048c520cdfe3b5c5bbcebb658117c41bad70f52b7ccc::stickers_nft {
    ...
    struct StickersBurned has copy, drop {
        stickers_id: 0x2::object::ID,
        key: 0x1::string::String,
    }
    ...
    public fun burn(arg0: Stickers) {
        ...
        let v9 = v0;
        let v10 = StickersBurned{
            stickers_id : 0x2::object::uid_to_inner(&v9),
            key         : v7,
        };
        0x2::event::emit<StickersBurned>(v10);
