module 0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::escrow {
    ...
    struct MaxBatchSlotsKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    struct BatchOriginKey has copy, drop, store {
        dummy_field: bool,
    }

    struct BatchHoldReleasedKey has copy, drop, store {
        dummy_field: bool,
    }

    struct ActiveFreedKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun batch_origin<T0>(arg0: &Job<T0>) : 0x1::option::Option<0x2::object::ID> {
        let v0 = BatchOriginKey{dummy_field: false};
        if (0x2::dynamic_field::exists<BatchOriginKey>(&arg0.id, v0)) {
            let v2 = BatchOriginKey{dummy_field: false};
            0x1::option::some<0x2::object::ID>(*0x2::dynamic_field::borrow<BatchOriginKey, 0x2::object::ID>(&arg0.id, v2))
        } else {
    ...
    public fun config_max_batch_slots(arg0: &FeeConfig) : u64 {
        let v0 = MaxBatchSlotsKey{dummy_field: false};
        if (0x2::dynamic_field::exists<MaxBatchSlotsKey>(&arg0.id, v0)) {
            let v2 = MaxBatchSlotsKey{dummy_field: false};
            *0x2::dynamic_field::borrow<MaxBatchSlotsKey, u64>(&arg0.id, v2)
        } else {
            250
        }
    }
    ...
    public(friend) fun create_claimed<T0>(arg0: address, arg1: address, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: u64, arg8: &FeeConfig, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = new_claimed_job<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
        0x2::transfer::share_object<Job<T0>>(v0);
        0x2::object::uid_to_inner(&v0.id)
    }

    public(friend) fun create_claimed_from_batch<T0>(arg0: 0x2::object::ID, arg1: address, arg2: address, arg3: 0x2::balance::Balance<T0>, arg4: u64, arg5: vector<u8>, arg6: u64, arg7: u64, arg8: u64, arg9: &FeeConfig, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = new_claimed_job<T0>(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
        let v1 = BatchOriginKey{dummy_field: false};
        0x2::dynamic_field::add<BatchOriginKey, 0x2::object::ID>(&mut v0.id, v1, arg0);
        0x2::transfer::share_object<Job<T0>>(v0);
        0x2::object::uid_to_inner(&v0.id)
    }
    ...
    public(friend) fun decline_settle_pkg<T0>(arg0: &mut Job<T0>, arg1: &FeeConfig, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg1);
    ...
    public fun is_active_freed<T0>(arg0: &Job<T0>) : bool {
        let v0 = ActiveFreedKey{dummy_field: false};
        0x2::dynamic_field::exists<ActiveFreedKey>(&arg0.id, v0)
    }

    public fun is_batch_hold_released<T0>(arg0: &Job<T0>) : bool {
        let v0 = BatchHoldReleasedKey{dummy_field: false};
        0x2::dynamic_field::exists<BatchHoldReleasedKey>(&arg0.id, v0)
    }

    public fun is_batch_origin_job<T0>(arg0: &Job<T0>) : bool {
        let v0 = BatchOriginKey{dummy_field: false};
        0x2::dynamic_field::exists<BatchOriginKey>(&arg0.id, v0)
    }
    ...
    public(friend) fun mark_active_freed_pkg<T0>(arg0: &mut Job<T0>) {
        let v0 = ActiveFreedKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists<ActiveFreedKey>(&arg0.id, v0), 24);
        let v1 = ActiveFreedKey{dummy_field: false};
        0x2::dynamic_field::add<ActiveFreedKey, bool>(&mut arg0.id, v1, true);
    }

    public(friend) fun mark_batch_hold_released_pkg<T0>(arg0: &mut Job<T0>) {
        let v0 = BatchHoldReleasedKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists<BatchHoldReleasedKey>(&arg0.id, v0), 23);
        let v1 = BatchHoldReleasedKey{dummy_field: false};
        0x2::dynamic_field::add<BatchHoldReleasedKey, bool>(&mut arg0.id, v1, true);
    }
    ...
    fun new_claimed_job<T0>(arg0: address, arg1: address, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: u64, arg8: &FeeConfig, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : Job<T0> {
        assert_version(arg8);
        assert!(arg0 != arg1, 9);
        ...
        let v4 = JobCreated{
            job_id           : 0x2::object::uid_to_inner(&v2.id),
            buyer            : arg0,
            seller           : arg1,
            amount           : v0,
            fee_bps          : arg3,
    ...
    public fun set_max_batch_slots(arg0: &AdminCap, arg1: &mut FeeConfig, arg2: u64) {
        assert_version(arg1);
        assert!(arg2 >= 1 && arg2 <= 512, 22);
        let v0 = MaxBatchSlotsKey{dummy_field: false};
        if (0x2::dynamic_field::exists<MaxBatchSlotsKey>(&arg1.id, v0)) {
            let v1 = MaxBatchSlotsKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<MaxBatchSlotsKey, u64>(&mut arg1.id, v1) = arg2;
        } else {
            let v2 = MaxBatchSlotsKey{dummy_field: false};
            0x2::dynamic_field::add<MaxBatchSlotsKey, u64>(&mut arg1.id, v2, arg2);
        };
    }
