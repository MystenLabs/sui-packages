module 0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::reputation {
    ...
    public fun decline_v2<T0>(arg0: &mut 0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::escrow::Job<T0>, arg1: &mut AgentScore, arg2: &0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::escrow::FeeConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.agent == 0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::escrow::seller<T0>(arg0), 4);
        0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::escrow::decline_settle_pkg<T0>(arg0, arg2, arg3, arg4);
        if (0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::escrow::is_claimed_job<T0>(arg0) && !0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::escrow::is_active_freed<T0>(arg0)) {
            0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::escrow::mark_active_freed_pkg<T0>(arg0);
    ...
    public fun set_active_seller_jobs(arg0: &0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::escrow::AdminCap, arg1: &mut AgentScore, arg2: u64, arg3: &0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::escrow::FeeConfig, arg4: &0x2::clock::Clock) {
        0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::escrow::assert_version_pkg(arg3);
        assert!(arg2 <= 0x358a819c1c016e2cc84ef5fbea81cba90c31f7f8a62bf45cb5e5276acf198bdd::escrow::config_tier_active_cap(arg3, 4), 11);
        let v0 = ActiveSellerJobsKey{dummy_field: false};
        if (0x2::dynamic_field::exists<ActiveSellerJobsKey>(&arg1.id, v0)) {
            let v1 = ActiveSellerJobsKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<ActiveSellerJobsKey, u64>(&mut arg1.id, v1) = arg2;
        } else {
            let v2 = ActiveSellerJobsKey{dummy_field: false};
            0x2::dynamic_field::add<ActiveSellerJobsKey, u64>(&mut arg1.id, v2, arg2);
        };
        let v3 = 0x2::clock::timestamp_ms(arg4);
        arg1.updated_at_ms = v3;
        let v4 = ActiveSellerJobsChanged{
            score_id           : 0x2::object::uid_to_inner(&arg1.id),
            agent              : arg1.agent,
            job_id             : 0x2::object::id_from_address(@0x0),
            active_seller_jobs : arg2,
            delta              : 2,
            timestamp_ms       : v3,
        };
        0x2::event::emit<ActiveSellerJobsChanged>(v4);
    }
