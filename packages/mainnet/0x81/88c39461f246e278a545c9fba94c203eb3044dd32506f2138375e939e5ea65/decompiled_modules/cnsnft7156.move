module 0x8188c39461f246e278a545c9fba94c203eb3044dd32506f2138375e939e5ea65::cnsnft7156 {
    struct CNSNFT7156 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7156, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7156>(arg0, arg1);
