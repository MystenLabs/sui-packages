module 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house {
    ...
    struct HouseConfigTag has copy, drop, store {
        dummy_field: bool,
    }

    struct HouseConfig has drop, store {
        house_fee_rate: u64,
        max_risk: u64,
        house_deposit_fee: u64,
    }
    ...
    public fun get_house_deposit_fee_or_default<T0>(arg0: &House<T0>, arg1: u64) : u64 {
        let v0 = HouseConfigTag{dummy_field: false};
        if (0x2::dynamic_field::exists_<HouseConfigTag>(&arg0.id, v0)) {
            let v2 = HouseConfigTag{dummy_field: false};
            0x2::dynamic_field::borrow<HouseConfigTag, HouseConfig>(&arg0.id, v2).house_deposit_fee
        } else {
            arg1
        }
    }
    ...
    public fun house_fee_rate_or_override<T0>(arg0: &House<T0>, arg1: u64) : u64 {
        let v0 = HouseConfigTag{dummy_field: false};
        if (0x2::dynamic_field::exists_<HouseConfigTag>(&arg0.id, v0)) {
            let v2 = HouseConfigTag{dummy_field: false};
            0x2::dynamic_field::borrow<HouseConfigTag, HouseConfig>(&arg0.id, v2).house_fee_rate
        } else {
            arg1
        }
    }

    public fun house_max_risk_or_default<T0>(arg0: &House<T0>) : u64 {
        let v0 = HouseConfigTag{dummy_field: false};
        if (0x2::dynamic_field::exists_<HouseConfigTag>(&arg0.id, v0)) {
            let v2 = HouseConfigTag{dummy_field: false};
            0x2::dynamic_field::borrow<HouseConfigTag, HouseConfig>(&arg0.id, v2).max_risk
        } else {
            total_pool_balance<T0>(arg0) / 20
        }
    }
    ...
    public(friend) fun join_with_fee<T0>(arg0: &mut House<T0>, arg1: 0x2::balance::Balance<T0>) {
        err_deprecated();
        let v0 = 0x2::balance::value<T0>(&arg1);
        if (v0 > max_risk<T0>(arg0)) {
            err_exceed_max_risk();
        };
        let v1 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_rate(v0, 300000);
        let v2 = JoinHouseEvent<T0>{
            amount    : 0x2::balance::value<T0>(&arg1),
            fee_taken : 0x1::option::some<u64>(v1),
        };
        0x2::event::emit<JoinHouseEvent<T0>>(v2);
        0x2::balance::join<T0>(&mut arg0.house_pool, 0x2::balance::split<T0>(&mut arg1, v1));
        0x2::balance::join<T0>(&mut arg0.pool, arg1);
    }

    public(friend) fun join_with_fee_v2<T0>(arg0: &mut House<T0>, arg1: 0x2::balance::Balance<T0>, arg2: u64) {
        let v0 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_rate(0x2::balance::value<T0>(&arg1), house_fee_rate_or_override<T0>(arg0, arg2));
    ...
    public fun max_risk<T0>(arg0: &House<T0>) : u64 {
        house_max_risk_or_default<T0>(arg0)
    }
    ...
    public(friend) fun redeem<T0>(arg0: &mut House<T0>, arg1: 0x2::balance::Balance<StakedHouseCoin<T0>>, arg2: address) : 0x2::balance::Balance<T0> {
        ...
        let v1 = (((v0 as u128) * (total_pool_balance<T0>(arg0) as u128) / (0x2::balance::supply_value<StakedHouseCoin<T0>>(&arg0.supply) as u128)) as u64);
    ...
    public(friend) fun set_house_config<T0>(arg0: &mut House<T0>, arg1: u64, arg2: u64, arg3: u64) {
        let v0 = HouseConfigTag{dummy_field: false};
        0x2::dynamic_field::remove_if_exists<HouseConfigTag, HouseConfig>(&mut arg0.id, v0);
        let v1 = HouseConfigTag{dummy_field: false};
        let v2 = HouseConfig{
            house_fee_rate    : arg1,
            max_risk          : arg2,
            house_deposit_fee : arg3,
        };
        0x2::dynamic_field::add<HouseConfigTag, HouseConfig>(&mut arg0.id, v1, v2);
    }
    ...
    public(friend) fun split_with_reimbursement_v2<T0>(arg0: &mut House<T0>, arg1: u64, arg2: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_rate(arg1, house_fee_rate_or_override<T0>(arg0, arg2));
        assert!(v0 <= 0x2::balance::value<T0>(&arg0.house_pool), 3);
        0x2::balance::join<T0>(&mut arg0.pool, 0x2::balance::split<T0>(&mut arg0.house_pool, v0));
        assert!(arg1 <= 0x2::balance::value<T0>(&arg0.pool), 1);
        let v1 = SplitHouseEvent<T0>{
    ...
    public(friend) fun withdraw_pool<T0>(arg0: &mut House<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        0x2::balance::split<T0>(&mut arg0.pool, arg1)
    }
