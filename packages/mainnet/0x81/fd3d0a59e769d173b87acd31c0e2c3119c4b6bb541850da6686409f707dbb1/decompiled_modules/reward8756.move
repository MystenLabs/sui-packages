module 0x81fd3d0a59e769d173b87acd31c0e2c3119c4b6bb541850da6686409f707dbb1::reward8756 {
    struct REWARD8756 has drop {
        dummy_field: bool,
    }

    struct TICKET_8756 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8756(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8756>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8756>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8756, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8756>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8756>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8756>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8756>>(v5, 0x2::tx_context::sender(arg1));
    }
