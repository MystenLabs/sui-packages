module 0x65424ceb2c6eab8d68b6c26340faee7b081569471a3d20736d7e57bf1e253ac::sui_silver_card_contract {
    ...
    public fun buy_card_direct_returns<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: 0x1::ascii::String, arg2: u64, arg3: 0x1::ascii::String, arg4: &CardConfigs, arg5: &mut PurchaseRecord, arg6: &mut FeeTierList, arg7: &mut SwapFeeList, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : &0x2::coin::Coin<T0> {
        assert!(arg4.version == 4, 3);
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::address::to_ascii_string(arg4.usdc_address) == 0x1::type_name::get_address(&v0), 6);
        assert!(0x2::coin::value<T0>(arg0) >= arg2, 0);
    ...
    public fun transfer_coin_object<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg0, 0x2::coin::value<T0>(arg0), arg1), 0x2::tx_context::sender(arg1));
    }
