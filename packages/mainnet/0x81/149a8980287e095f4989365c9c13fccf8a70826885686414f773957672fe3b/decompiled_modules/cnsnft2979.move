module 0x81149a8980287e095f4989365c9c13fccf8a70826885686414f773957672fe3b::cnsnft2979 {
    struct CNSNFT2979 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2979, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2979>(arg0, arg1);
