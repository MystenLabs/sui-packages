module 0x8154af2d1c7414181ab502ae8840ad77a3b9fe9c34a9fb74511f2a2491bdcda9::cnsnft5633 {
    struct CNSNFT5633 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5633, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5781"));
        let v4 = 0x2::package::claim<CNSNFT5633>(arg0, arg1);
