module 0x81068c7c4a7dbb98584f07ff1c5e15d18b2897fa49483e749c582b22dc766d69::reward1656 {
    struct REWARD1656 has drop {
        dummy_field: bool,
    }

    struct TICKET_1656 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1656(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1656>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1656>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1656, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1656>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1656>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1656>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1656>>(v5, 0x2::tx_context::sender(arg1));
    }
