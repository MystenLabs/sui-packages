module 0x81f1301f73c6c1d5b008322869cad1c8f73c59d5dbe67bd45e4fc7c4843b070b::bonding_curve {
    ...
    public(friend) fun buy_<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: u64, arg4: u64, arg5: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x81f1301f73c6c1d5b008322869cad1c8f73c59d5dbe67bd45e4fc7c4843b070b::locked_coin::LockedCoin<T0>, 0x2::balance::Balance<0x2::sui::SUI>) {
        assert!(!arg0.ended, 3);
        ...
        let v14 = if (v13 >= arg0.lock_amount || 0x2::clock::timestamp_ms(arg6) > arg0.unlock_timestamp) {
            0x81f1301f73c6c1d5b008322869cad1c8f73c59d5dbe67bd45e4fc7c4843b070b::locked_coin::zero<T0>(arg7)
        } else {
            ...
            v12 = v15;
            0x81f1301f73c6c1d5b008322869cad1c8f73c59d5dbe67bd45e4fc7c4843b070b::locked_coin::from_balance<T0>(0x2::balance::split<T0>(&mut v11, v15), arg7)
        };
