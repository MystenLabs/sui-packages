module 0x818525ab3b8b0d5b30c839e4e73854d7ec8af329dc08b7a67dd8bd9ce43bef28::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"Make Europe Great Again", b"MEGA", b"https://iili.io/2tmTR1t.png", 0x1::option::none<0x2::url::Url>(), arg1);
