module 0x8123f2fe893a262de1127e8ca1a9e9eb9d337505bc51f838051c77492ecfa987::vault_config {
    ...
    public(friend) fun borrow_withdraw_cap(arg0: &VaultTokenHolder) : &0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet_config::QuickWithdrawCap {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet_config::QuickWithdrawCap>(&arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"))
    }
    ...
    public fun set_cloud_wallet_withdraw_cap(arg0: &mut 0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet_config::CloudWalletConfig, arg1: &VaultConfig, arg2: &mut VaultTokenHolder, arg3: 0x2::transfer::Receiving<0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet_config::QuickWithdrawCap>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg2.id, 0x1::ascii::string(b"quick_withdraw_cap"))) {
            0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet_config::delete_quick_withdraw_cap(arg0, 0x2::dynamic_field::remove<0x1::ascii::String, 0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, 0x1::ascii::string(b"quick_withdraw_cap")));
        };
        0x2::dynamic_field::add<0x1::ascii::String, 0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, 0x1::ascii::string(b"quick_withdraw_cap"), 0x2::transfer::public_receive<0x10e0146cd3124bf035a30ff65966c011876bb261b2b05c654d108ca68ef130d8::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, arg3));
    }
