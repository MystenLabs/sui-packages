module 0x814869ec04e80b074afed45eacdbf00502922e57c933a00dfa16aabbe3be5c5b::elxai {
    ...
    fun init(arg0: ELXAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/jriiULJQwgqdU48hTv1eKqK4ipCiCWBnP9CZbonpump.png                                                                                                                                                                                                                                ");
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<ELXAI>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<ELXAI>>(v4);
    }
