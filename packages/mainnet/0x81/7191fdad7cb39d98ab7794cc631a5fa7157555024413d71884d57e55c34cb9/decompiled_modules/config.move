module 0x817191fdad7cb39d98ab7794cc631a5fa7157555024413d71884d57e55c34cb9::config {
    ...
    public fun assert_protocol_enabled(arg0: &VeScaProtocolConfig) {
        assert!(arg0.enabled, 0x817191fdad7cb39d98ab7794cc631a5fa7157555024413d71884d57e55c34cb9::error_code::protocol_disabled());
    }

    public fun assert_protocol_version(arg0: &VeScaProtocolConfig) {
        assert!(arg0.version == 1, 0x817191fdad7cb39d98ab7794cc631a5fa7157555024413d71884d57e55c34cb9::error_code::protocol_version_mismatch());
    }
    ...
    public fun upgrade_protocol_version(arg0: &VeScaProtocolAdminCap, arg1: &mut VeScaProtocolConfig, arg2: u64) {
        assert!(arg2 > arg1.version, 0x817191fdad7cb39d98ab7794cc631a5fa7157555024413d71884d57e55c34cb9::error_code::protocol_version_downgrade());
        arg1.version = arg2;
    }
