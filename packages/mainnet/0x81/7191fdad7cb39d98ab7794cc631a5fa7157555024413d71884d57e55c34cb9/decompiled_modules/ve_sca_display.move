module 0x817191fdad7cb39d98ab7794cc631a5fa7157555024413d71884d57e55c34cb9::ve_sca_display {
    ...
    fun init(arg0: VE_SCA_DISPLAY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0x817191fdad7cb39d98ab7794cc631a5fa7157555024413d71884d57e55c34cb9::ve_sca::VeScaKey>(&v0, v1, v3, arg1);
        0x2::display::update_version<0x817191fdad7cb39d98ab7794cc631a5fa7157555024413d71884d57e55c34cb9::ve_sca::VeScaKey>(&mut v5);
        let v6 = 0x2::tx_context::sender(arg1);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, v6);
        0x2::transfer::public_transfer<0x2::display::Display<0x817191fdad7cb39d98ab7794cc631a5fa7157555024413d71884d57e55c34cb9::ve_sca::VeScaKey>>(v5, v6);
    }
