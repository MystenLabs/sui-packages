module 0x81b84693474d494c7deced66a5e9b6e48523929d09870127006611760cdfd1c6::stonker {
    ...
    fun default_stonker_parameters() : StonkerParameters {
        StonkerParameters{
            ...
            position_limit_quote     : 12000 * 1000000,
    ...
    fun should_repeat_order(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::OrderInfo) : bool {
        if (0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(arg0) < 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(arg0)) {
            return false
        };
        let v0 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::fills(arg0);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::fill::Fill>(&v0)) {
            let v2 = 0x1::vector::borrow<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::fill::Fill>(&v0, v1);
            v1 = v1 + 1;
            let v3 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::fill::balance_manager_id(v2);
            let v4 = 0x2::object::id_to_bytes(&v3);
            let v5 = 154;
            let v6 = if (0x1::vector::borrow<u8>(&v4, 1) == &v5) {
                let v7 = 218;
                if (0x1::vector::borrow<u8>(&v4, 2) == &v7) {
                    let v8 = 43;
                    if (0x1::vector::borrow<u8>(&v4, 30) == &v8) {
                        let v9 = 16;
                        0x1::vector::borrow<u8>(&v4, 31) == &v9
                    } else {
                        false
                    }
                } else {
