module 0xff2251ea99230ed1cbe3a347a209352711c6723fcdcd9286e16636e65bb55cab::tradeport_listings {
    ...
    public fun add_sponsored_listing<T0: store + key>(arg0: &mut Store, arg1: &0x2::clock::Clock, arg2: 0x2::object::ID, arg3: u64, arg4: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(is_supported_nft_type<T0>(), 7);
    ...
    entry fun admin_cancel_ob_listing_with_transfer_policy<T0: store + key>(arg0: &mut Store, arg1: &mut 0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::Store, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: &0x2::tx_context::TxContext) {
        verify_version(arg0);
        ...
        0x2::kiosk::return_purchase_cap<T0>(arg2, 0x2::dynamic_object_field::remove<0x2::object::ID, 0x2::kiosk::PurchaseCap<T0>>(&mut v0.id, arg3));
        let SimpleListing {
            id                    : v1,
            type                  : v2,
            nft_id                : v3,
        ...
        if (0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::is_market_authorized(arg1, &arg0.id)) {
            0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::remove_listing<T0>(arg1, &arg0.id, 0x2::object::uid_to_inner(&v7));
        };
    ...
    entry fun admin_cancel_ob_listing_without_transfer_policy<T0: store + key>(arg0: &mut Store, arg1: &mut 0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::Store, arg2: 0x2::object::ID, arg3: &0x2::tx_context::TxContext) {
        verify_version(arg0);
    ...
    public fun buy_ob_listing_without_transfer_policy<T0: store + key>(arg0: &mut Store, arg1: &mut 0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::Store, arg2: 0x2::object::ID, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(is_supported_nft_type<T0>(), 7);
        remove_sponsored_listing_if_exists<T0>(arg0, arg2);
        ...
        if (0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::is_market_authorized(arg1, &arg0.id)) {
            0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::remove_listing<T0>(arg1, &arg0.id, 0x2::object::uid_to_inner(&v8));
        };
    ...
    public fun cancel_ob_listing_with_transfer_policy<T0: store + key>(arg0: &mut Store, arg1: &mut 0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::Store, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID) {
    ...
    public fun cancel_ob_listing_without_transfer_policy<T0: store + key>(arg0: &mut Store, arg1: &mut 0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::Store, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        remove_sponsored_listing_if_exists<T0>(arg0, arg2);
        let v0 = 0x2::dynamic_object_field::remove<0x2::object::ID, SimpleListing<T0>>(&mut arg0.id, arg2);
    ...
    public fun create_ob_listing_with_transfer_policy<T0: store + key>(arg0: &mut Store, arg1: &mut 0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::Store, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: address, arg5: 0x2::object::ID, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::is_market_authorized(arg1, &arg0.id)) {
            0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::add_listing<T0>(arg1, &arg0.id, 0x2::object::uid_to_inner(&v2.id), arg4, arg5, arg6, arg7);
        };
    ...
    public fun create_ob_listing_without_transfer_policy<T0: store + key>(arg0: &mut Store, arg1: &mut 0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::Store, arg2: T0, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(is_supported_nft_type<T0>(), 7);
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0;
        ...
        if (0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::is_market_authorized(arg1, &arg0.id)) {
            0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::add_listing<T0>(arg1, &arg0.id, 0x2::object::uid_to_inner(&v3.id), v0, v2, arg3, arg4);
        };
    ...
    fun is_supported_nft_type<T0>() : bool {
        ...
        let v3 = 0x1::ascii::length(&v1) > 0x1::ascii::length(&v2) && 0x1::ascii::substring(&v1, 0, 0x1::ascii::length(&v2)) == v2;
        !v3
    }
    ...
    public fun relist_ob_listing_with_transfer_policy<T0: store + key>(arg0: &mut Store, arg1: &mut 0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::Store, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(is_supported_nft_type<T0>(), 7);
        if (0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::is_market_authorized(arg1, &arg0.id)) {
            let v0 = 0x2::dynamic_object_field::borrow<0x2::object::ID, SimpleListing<T0>>(&arg0.id, arg4);
            let v1 = 0x2::object::uid_to_inner(&v0.id);
            0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::remove_listing<T0>(arg1, &arg0.id, v1);
            0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::add_listing<T0>(arg1, &arg0.id, v1, v0.seller, arg4, arg5, arg6);
        };
    ...
    public fun relist_ob_listing_without_transfer_policy<T0: store + key>(arg0: &mut Store, arg1: &mut 0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::Store, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(is_supported_nft_type<T0>(), 7);
        if (0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::is_market_authorized(arg1, &arg0.id)) {
            let v0 = 0x2::dynamic_object_field::borrow<0x2::object::ID, SimpleListing<T0>>(&arg0.id, arg2);
            let v1 = 0x2::object::uid_to_inner(&v0.id);
            0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::remove_listing<T0>(arg1, &arg0.id, v1);
            0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::add_listing<T0>(arg1, &arg0.id, v1, v0.seller, arg2, arg3, arg4);
        };
    ...
    public fun report_ob_listing<T0: store + key>(arg0: &Store, arg1: &mut 0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::Store, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, SimpleListing<T0>>(&arg0.id, arg2), 3);
        let v0 = 0x2::dynamic_object_field::borrow<0x2::object::ID, SimpleListing<T0>>(&arg0.id, arg2);
        if (0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::is_market_authorized(arg1, &arg0.id)) {
            0x6cefebb11191abd347654200a6fd8ae47fa97b54506e4e680db64dae54d0b12::tradeport_orderbook::add_listing<T0>(arg1, &arg0.id, 0x2::object::uid_to_inner(&v0.id), v0.seller, arg2, v0.price, arg3);
        };
    }
