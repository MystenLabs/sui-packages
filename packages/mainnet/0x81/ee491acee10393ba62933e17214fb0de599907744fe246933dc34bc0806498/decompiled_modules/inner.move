module 0x81ee491acee10393ba62933e17214fb0de599907744fe246933dc34bc0806498::inner {
    ...
    public(friend) fun link_evm(arg0: &mut StateV1, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::tx_context::TxContext) {
        ...
        0x81ee491acee10393ba62933e17214fb0de599907744fe246933dc34bc0806498::events::emit_evm_linked(v0, arg1);
    }
    ...
    public(friend) fun link_solana(arg0: &mut StateV1, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::tx_context::TxContext) {
        ...
        0x81ee491acee10393ba62933e17214fb0de599907744fe246933dc34bc0806498::events::emit_solana_linked(v0, arg1);
    }
    ...
    public(friend) fun unlink_evm(arg0: &mut StateV1, arg1: vector<u8>, arg2: &0x2::tx_context::TxContext) {
        ...
        0x81ee491acee10393ba62933e17214fb0de599907744fe246933dc34bc0806498::events::emit_evm_unlinked(v0, arg1);
    }
    ...
    public(friend) fun unlink_solana(arg0: &mut StateV1, arg1: vector<u8>, arg2: &0x2::tx_context::TxContext) {
        ...
        0x81ee491acee10393ba62933e17214fb0de599907744fe246933dc34bc0806498::events::emit_solana_unlinked(v0, arg1);
    }
