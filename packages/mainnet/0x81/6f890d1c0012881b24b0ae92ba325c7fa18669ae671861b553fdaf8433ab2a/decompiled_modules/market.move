module 0x816f890d1c0012881b24b0ae92ba325c7fa18669ae671861b553fdaf8433ab2a::market {
    ...
    public fun get_market_data_v2(arg0: &Global, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        let v24 = if (0x2::bag::contains<u64>(&v1.stores, v2.head)) {
            0x2::bag::borrow<u64, StoreV2>(&v1.stores, v18).price_per_amount
        } else {
            0
        };
        let v25 = QueryDataEventV2{
            tick          : arg2,
            traders       : v1.traders,
            txs           : v1.txs,
            volume_24h    : v6,
        ...
        0x2::event::emit<QueryDataEventV2>(v25);
    }
