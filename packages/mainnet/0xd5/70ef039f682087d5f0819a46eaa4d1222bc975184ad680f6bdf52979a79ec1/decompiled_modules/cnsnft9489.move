module 0xd570ef039f682087d5f0819a46eaa4d1222bc975184ad680f6bdf52979a79ec1::cnsnft9489 {
    struct CNSNFT9489 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9489, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9489>(arg0, arg1);
