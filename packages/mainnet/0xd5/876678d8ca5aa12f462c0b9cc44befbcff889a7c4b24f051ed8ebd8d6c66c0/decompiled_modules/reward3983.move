module 0xd5876678d8ca5aa12f462c0b9cc44befbcff889a7c4b24f051ed8ebd8d6c66c0::reward3983 {
    struct REWARD3983 has drop {
        dummy_field: bool,
    }

    struct TICKET_3983 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3983(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3983>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3983>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3983, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3983>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3983>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3983>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3983>>(v5, 0x2::tx_context::sender(arg1));
    }
