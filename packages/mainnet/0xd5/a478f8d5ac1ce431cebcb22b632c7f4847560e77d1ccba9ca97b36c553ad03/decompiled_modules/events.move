module 0xd5a478f8d5ac1ce431cebcb22b632c7f4847560e77d1ccba9ca97b36c553ad03::events {
    ...
    public fun emit_add_market(arg0: address, arg1: address, arg2: u64, arg3: u64, arg4: address, arg5: u8, arg6: address, arg7: address) {
    ...
    public fun emit_allocate(arg0: address, arg1: address, arg2: address, arg3: u64) {
    ...
    public fun emit_allocator_added(arg0: address, arg1: address, arg2: address) {
    ...
    public fun emit_allocator_removed(arg0: address) {
        let v0 = AllocatorRemovedEvent{cap_id: arg0};
        0x2::event::emit<AllocatorRemovedEvent>(v0);
    }

    public fun emit_claim_management_fee(arg0: address, arg1: address, arg2: u64) {
    ...
    public fun emit_claim_performance_fee(arg0: address, arg1: address, arg2: u64) {
    ...
    public fun emit_claim_reward(arg0: address, arg1: address, arg2: address, arg3: 0x1::ascii::String, arg4: u64) {
    ...
    public fun emit_collect_reward(arg0: address, arg1: u64, arg2: 0x1::ascii::String, arg3: u64) {
    ...
    public fun emit_create_receipt(arg0: address, arg1: address, arg2: address) {
    ...
    public fun emit_create_vault(arg0: address, arg1: address) {
    ...
    public fun emit_curator_added(arg0: address, arg1: address, arg2: address) {
    ...
    public fun emit_curator_removed(arg0: address) {
        let v0 = CuratorRemovedEvent{cap_id: arg0};
        0x2::event::emit<CuratorRemovedEvent>(v0);
    }

    public fun emit_deallocate(arg0: address, arg1: address, arg2: address, arg3: u64) {
    ...
    public fun emit_deposit(arg0: address, arg1: address, arg2: address, arg3: address, arg4: u64, arg5: u64) {
        let v0 = DepositEvent{
            vault        : arg0,
            sender       : arg1,
            receipt_id   : arg2,
    ...
    public fun emit_deposit_reward_balance(arg0: address, arg1: 0x1::ascii::String, arg2: u64) {
    ...
    public fun emit_proposal_cancelled(arg0: address, arg1: u8, arg2: address) {
    ...
    public fun emit_proposal_created(arg0: address, arg1: u8, arg2: address, arg3: u64) {
    ...
    public fun emit_proposal_executed(arg0: address, arg1: u8, arg2: address) {
    ...
    public fun emit_reward_rule_created(arg0: address, arg1: address, arg2: 0x1::ascii::String, arg3: address) {
    ...
    public fun emit_reward_rule_disabled(arg0: address, arg1: address, arg2: 0x1::ascii::String) {
    ...
    public fun emit_set_default_market(arg0: address, arg1: address) {
    ...
    public fun emit_set_loss(arg0: address, arg1: address, arg2: u64) {
        let v0 = SetLossEvent{
            vault        : arg0,
            pool_address : arg1,
            loss         : arg2,
    ...
    public fun emit_set_management_fee(arg0: address, arg1: u64, arg2: u64) {
    ...
    public fun emit_set_market_cap_and_penalty(arg0: address, arg1: address, arg2: u64, arg3: u64) {
    ...
    public fun emit_set_market_status(arg0: address, arg1: address, arg2: u8) {
    ...
    public fun emit_set_paused(arg0: address, arg1: bool) {
    ...
    public fun emit_set_performance_fee(arg0: address, arg1: u64, arg2: u64) {
    ...
    public fun emit_set_reward_rate(arg0: address, arg1: 0x1::ascii::String, arg2: u64, arg3: u64, arg4: u256) {
    ...
    public fun emit_sync_market_balance(arg0: address, arg1: address, arg2: u64) {
    ...
    public fun emit_withdraw(arg0: address, arg1: address, arg2: address, arg3: address, arg4: u64, arg5: u64) {
