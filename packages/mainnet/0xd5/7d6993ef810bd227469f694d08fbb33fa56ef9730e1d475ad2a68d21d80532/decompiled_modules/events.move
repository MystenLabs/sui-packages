module 0xd57d6993ef810bd227469f694d08fbb33fa56ef9730e1d475ad2a68d21d80532::events {
    ...
    public(friend) fun emit_add_registry_event<T0>(arg0: vector<u8>, arg1: &0x2::tx_context::TxContext) {
        let v0 = AddRegistryEvent{
            ...
            xasset_type : 0x1::ascii::string(0xd57d6993ef810bd227469f694d08fbb33fa56ef9730e1d475ad2a68d21d80532::utils::type_to_bytes<T0>()),
            price_id    : arg0,
        };
