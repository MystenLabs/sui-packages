module 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward {
    ...
    public fun add_reward_token(arg0: &mut Reward, arg1: &0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::RewardCap, arg2: 0x1::type_name::TypeName) {
        0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::validate(arg1, 0x2::object::id<Reward>(arg0));
    ...
    public fun balance_of(arg0: &Reward, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock) : u64 {
        balance_of_at(arg0, arg1, 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::current_timestamp(arg2))
    }
    ...
    public fun create(arg0: 0x2::object::ID, arg1: vector<0x1::type_name::TypeName>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : (Reward, 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::RewardCap) {
        ...
        (v1, 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::create(0x2::object::uid_to_inner(&v0), arg3))
    }

    public fun deposit(arg0: &mut Reward, arg1: &0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::RewardCap, arg2: u64, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::validate(arg1, 0x2::object::id<Reward>(arg0));
    ...
    fun earned_internal<T0>(arg0: &Reward, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock) : (u64, u64) {
        ...
        let v2 = if (0x2::table::contains<0x1::type_name::TypeName, 0x2::table::Table<0x2::object::ID, u64>>(&arg0.last_earn, v0) && 0x2::table::contains<0x2::object::ID, u64>(0x2::table::borrow<0x1::type_name::TypeName, 0x2::table::Table<0x2::object::ID, u64>>(&arg0.last_earn, v0), arg1)) {
            0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::epoch_start(*0x2::table::borrow<0x2::object::ID, u64>(0x2::table::borrow<0x1::type_name::TypeName, 0x2::table::Table<0x2::object::ID, u64>>(&arg0.last_earn, v0), arg1))
        } else {
            0
        };
        ...
        let v5 = v4;
        let v6 = (0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::epoch_start(0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::current_timestamp(arg2)) - v4) / 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::epoch();
        if (v6 > 0) {
            let v7 = 0;
            while (v7 < v6 && v7 < 100) {
                ...
                let v8 = 0x2::table::borrow<u64, Checkpoint>(0x2::table::borrow<0x2::object::ID, 0x2::table::Table<u64, Checkpoint>>(&arg0.checkpoints, arg1), get_prior_balance_index(arg0, arg1, v5 + 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::epoch() - 1));
                let v9 = get_prior_supply_index(arg0, v5 + 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::epoch() - 1);
                ...
                v5 = v5 + 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::epoch();
                v7 = v7 + 1;
            };
        };
        (v1, v5)
    ...
    public fun get_reward_internal<T0>(arg0: &mut Reward, arg1: &0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::RewardCap, arg2: address, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0x2::balance::Balance<T0>> {
        0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::validate(arg1, 0x2::object::id<Reward>(arg0));
    ...
    public fun notify_reward_amount_internal<T0>(arg0: &mut Reward, arg1: &0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::RewardCap, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::validate(arg1, 0x2::object::id<Reward>(arg0));
        let v0 = 0x2::balance::value<T0>(&arg2);
        let v1 = 0x1::type_name::get<T0>();
        let v2 = 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::epoch_start(0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::current_timestamp(arg3));
    ...
    public fun rewards_this_epoch<T0>(arg0: &Reward, arg1: &0x2::clock::Clock) : u64 {
        rewards_at_epoch<T0>(arg0, 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::epoch_start(0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::current_timestamp(arg1)))
    }

    public fun total_supply(arg0: &Reward, arg1: &0x2::clock::Clock) : u64 {
        total_supply_at(arg0, 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::current_timestamp(arg1))
    }
    ...
    public fun update_balances(arg0: &mut Reward, arg1: &0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::RewardCap, arg2: vector<u64>, arg3: vector<0x2::object::ID>, arg4: u64, arg5: bool, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::validate(arg1, 0x2::object::id<Reward>(arg0));
        assert!(arg0.balance_update_enabled, 931921756019291001);
        assert!(arg4 % 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::epoch() == 0, 97211664930268266);
        ...
        assert!(arg4 < 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::epoch_start(0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::current_timestamp(arg6)), 987934305039328400);
        let v0 = 0;
    ...
    public fun withdraw(arg0: &mut Reward, arg1: &0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::RewardCap, arg2: u64, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward_cap::validate(arg1, 0x2::object::id<Reward>(arg0));
        let v0 = 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::current_timestamp(arg4);
        let v1 = total_supply_at(arg0, v0) - arg2;
        let v2 = balance_of(arg0, arg3, arg4) - arg2;
    ...
    fun write_checkpoint_internal(arg0: &mut Reward, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::epoch_start(arg3);
        let v2 = if (v0 > 0) {
    ...
    fun write_supply_checkpoint_internal(arg0: &mut Reward, arg1: u64, arg2: u64) {
        let v0 = arg0.supply_num_checkpoints;
        let v1 = 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::common::epoch_start(arg1);
        let v2 = if (v0 > 0) {
