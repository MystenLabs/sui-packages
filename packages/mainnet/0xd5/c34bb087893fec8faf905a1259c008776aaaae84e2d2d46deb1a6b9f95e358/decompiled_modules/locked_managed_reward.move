module 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::locked_managed_reward {
    ...
    public fun borrow_reward(arg0: &LockedManagedReward) : &0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward::Reward {
        &arg0.reward
    }
    ...
    public(friend) fun get_reward<T0>(arg0: &mut LockedManagedReward, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        let v0 = ve(arg0);
        let v1 = 0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward::get_reward_internal<T0>(&mut arg0.reward, &arg0.reward_cap, 0x2::object::id_to_address(&v0), arg1, arg2, arg3);
    ...
    public(friend) fun notify_reward_amount<T0>(arg0: &mut LockedManagedReward, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        0xd5c34bb087893fec8faf905a1259c008776aaaae84e2d2d46deb1a6b9f95e358::reward::notify_reward_amount_internal<T0>(&mut arg0.reward, &arg0.reward_cap, 0x2::coin::into_balance<T0>(arg1), arg2, arg3);
    }
