module 0xd53fa80fbbbabd9e381db3aadbd7eb9809f7c70ea252b10829d7a8a4c1428c36::cnsnft4152 {
    struct CNSNFT4152 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4152, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4152>(arg0, arg1);
