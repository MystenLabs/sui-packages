module 0xd533ad2457ca872d9bf50b65b5e3ba1badeae87248c1fb37a3dacc4a32fa84a9::faucet_coin {
    ...
    fun init(arg0: FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCET_COIN>(arg0, 6, b"z0yuan", b"z0yuanFaucet", b"z0yuan Faucet Coin", 0x1::option::none<0x2::url::Url>(), arg1);
