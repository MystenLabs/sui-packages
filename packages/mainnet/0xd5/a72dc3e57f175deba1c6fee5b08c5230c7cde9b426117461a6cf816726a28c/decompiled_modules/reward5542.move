module 0xd5a72dc3e57f175deba1c6fee5b08c5230c7cde9b426117461a6cf816726a28c::reward5542 {
    struct REWARD5542 has drop {
        dummy_field: bool,
    }

    struct TICKET_5542 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5542(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5542>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5542>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5542, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5542>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5542>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5542>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5542>>(v5, 0x2::tx_context::sender(arg1));
    }
