module 0xd5b6baf5e6d51cbb7170d2c2d90cb9720b3e49ae2f0a6f05f4890d0de5c86c0c::kiosk_nft {
    ...
    public fun create_collection(arg0: &0xd5b6baf5e6d51cbb7170d2c2d90cb9720b3e49ae2f0a6f05f4890d0de5c86c0c::cap::AdminCap, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Collection {
        Collection{
    ...
    public fun get_royalty_fee_amount(arg0: &0xd5b6baf5e6d51cbb7170d2c2d90cb9720b3e49ae2f0a6f05f4890d0de5c86c0c::cap::AdminCap, arg1: &0x2::transfer_policy::TransferPolicy<Nft>, arg2: u64) : u64 {
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<Nft>(arg1, arg2)
    }
    ...
    fun init(arg0: KIOSK_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0xd5b6baf5e6d51cbb7170d2c2d90cb9720b3e49ae2f0a6f05f4890d0de5c86c0c::cap::AdminCap>(0xd5b6baf5e6d51cbb7170d2c2d90cb9720b3e49ae2f0a6f05f4890d0de5c86c0c::cap::new(arg1), 0x2::tx_context::sender(arg1));
    }

    public fun mint_nft(arg0: &0xd5b6baf5e6d51cbb7170d2c2d90cb9720b3e49ae2f0a6f05f4890d0de5c86c0c::cap::AdminCap, arg1: &mut Collection, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) : Nft {
        assert!(arg1.version == 1, 0);
        assert!(arg1.minted < arg1.mint_supply, 2);
        assert!(arg1.creator == 0x2::tx_context::sender(arg6), 3);
