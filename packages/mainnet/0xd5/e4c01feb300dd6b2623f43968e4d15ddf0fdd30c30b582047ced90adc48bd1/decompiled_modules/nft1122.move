module 0xd5e4c01feb300dd6b2623f43968e4d15ddf0fdd30c30b582047ced90adc48bd1::nft1122 {
    struct NFT1122 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NFT1122, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<NFT1122>(arg0, arg1);
