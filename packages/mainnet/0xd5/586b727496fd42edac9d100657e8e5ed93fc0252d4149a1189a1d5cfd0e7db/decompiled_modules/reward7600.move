module 0xd5586b727496fd42edac9d100657e8e5ed93fc0252d4149a1189a1d5cfd0e7db::reward7600 {
    struct REWARD7600 has drop {
        dummy_field: bool,
    }

    struct TICKET_7600 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7600(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7600>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7600>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7600, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7600>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7600>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7600>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7600>>(v5, 0x2::tx_context::sender(arg1));
    }
