module 0xd580fa1111f4510904c691115d1ba402617736b83b2a2aa9c160214cab2a7058::c_30_test_collection_sui {
    struct C_30_TEST_COLLECTION_SUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: C_30_TEST_COLLECTION_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<C_30_TEST_COLLECTION_SUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"30 test collection sui"));
        ...
        let v7 = CreateCollectionEvent{
            ...
            collection_id      : 0x1::string::utf8(b"3d90d5b9-0e97-4a46-b411-748c4e6003ff"),
        };
