module 0xd5b3a04d1a878965cce9c4ab1de7130ead5e7ff2029073b82f029febad2e573c::my_test_collection {
    struct MY_TEST_COLLECTION has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MY_TEST_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MY_TEST_COLLECTION>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"My test collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"My test collection "));
