module 0xd5a99b84660aa1dfd7418b6e760c1347807634124ddd9b1957d9adf479d0b0b3::reward9314 {
    struct REWARD9314 has drop {
        dummy_field: bool,
    }

    struct TICKET_9314 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9314(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9314>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9314>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9314, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9314>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9314>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9314>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9314>>(v5, 0x2::tx_context::sender(arg1));
    }
