module 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::lending {
    ...
    fun cap_pull_or_full_drain(arg0: u64, arg1: u64) : u64 {
        if (arg1 == 0) {
            return 0
        };
        if (arg0 >= arg1) {
    ...
    public fun distribute_lp_yield(arg0: &mut PoolLending, arg1: u64, arg2: u64) {
        let v0 = state_mut(arg0);
        let v1 = (arg1 as u128) + (v0.unrealized_lp_yield_x as u128);
        let v2 = (arg2 as u128) + (v0.unrealized_lp_yield_y as u128);
        assert!(v1 >= (v0.pending_burn_x as u128), 623);
        assert!(v2 >= (v0.pending_burn_y as u128), 623);
        let v3 = v1 - (v0.pending_burn_x as u128);
        let v4 = v2 - (v0.pending_burn_y as u128);
        let v5 = v0.undistributed_lp_yield_x;
        let v6 = v0.undistributed_lp_yield_y;
        let v7 = arg1 == 0 && arg2 == 0;
        if (v7) {
            assert!(arg1 == 0 && arg2 == 0, 622);
            v0.pending_protocol_yield_x = v0.pending_protocol_yield_x + v5 + (v3 as u64);
            ...
            0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::yield_index::advance(&mut v0.lp_yield_growth_x, v3, v3 + (v5 as u128));
            if (v0.lp_yield_growth_x != v0.lp_yield_growth_x) {
                let v8 = &mut v0.unrealized_lp_yield_x;
                let v9 = &mut v0.pending_burn_x;
                adjust_deferred(v8, v9, v5, 0);
                v0.undistributed_lp_yield_x = 0;
            };
        };
        if (v7) {
            v0.pending_protocol_yield_y = v0.pending_protocol_yield_y + v6 + (v4 as u64);
            ...
            0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::yield_index::advance(&mut v0.lp_yield_growth_y, v4, v4 + (v6 as u128));
            if (v0.lp_yield_growth_y != v0.lp_yield_growth_y) {
                let v10 = &mut v0.unrealized_lp_yield_y;
                let v11 = &mut v0.pending_burn_y;
                adjust_deferred(v10, v11, v6, 0);
                v0.undistributed_lp_yield_y = 0;
            };
        };
    }
    ...
    fun finalize_protocol_claim_x<T0, T1>(arg0: &mut PoolLending, arg1: &mut 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::Custody<T0, T1>, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        if (v0 > 0) {
            ...
            if (v5 > 0) {
                0x2::coin::join<T0>(&mut arg3, 0x2::coin::from_balance<T0>(0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::withdraw_reserved_yield_x<T0, T1>(arg1, v5, (v1 as u64)), arg4));
            };
        };
    ...
    fun finalize_protocol_claim_y<T0, T1>(arg0: &mut PoolLending, arg1: &mut 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::Custody<T0, T1>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (v0 > 0) {
            ...
            let v5 = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::min_u64(v0, v4);
            if (v5 > 0) {
                0x2::coin::join<T1>(&mut arg3, 0x2::coin::from_balance<T1>(0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::withdraw_reserved_yield_y<T0, T1>(arg1, v5, (v2 as u64)), arg4));
            };
        };
        let v6 = state_mut(arg0);
    ...
    public fun lp_entitlement(arg0: &PoolLending, arg1: u64, arg2: u64) : (u128, u128) {
        ...
        assert!(v1 >= (v0.pending_burn_x as u128), 623);
        assert!(v2 >= (v0.pending_burn_y as u128), 623);
        (v1 - (v0.pending_burn_x as u128) + (v0.undistributed_lp_yield_x as u128), v2 - (v0.pending_burn_y as u128) + (v0.undistributed_lp_yield_y as u128))
    }
    ...
    fun recall_close_x<T0, T1>(arg0: &mut PoolLending, arg1: &mut 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::Custody<T0, T1>, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::object::ID, arg5: u64, arg6: &0x2::clock::Clock) : u64 {
        ...
        reconcile_recall_x<T0, T1>(arg0, arg1, arg2, arg4, arg5, arg6);
        v0
    }
    ...
    fun recall_close_y<T0, T1>(arg0: &mut PoolLending, arg1: &mut 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::Custody<T0, T1>, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: 0x2::coin::Coin<T1>, arg4: 0x2::object::ID, arg5: u64, arg6: &0x2::clock::Clock) : u64 {
        ...
        reconcile_recall_y<T0, T1>(arg0, arg1, arg2, arg4, arg5, arg6);
        v0
    }
    ...
    fun recall_open(arg0: &PoolLending, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: u64, arg3: u64, arg4: u64, arg5: bool, arg6: &0x2::clock::Clock) : (u64, u64, u64) {
        ...
        (v1, cap_pull_or_full_drain(v2, v3), v3)
    }
    ...
    fun recall_residue(arg0: u64, arg1: u64) : u64 {
        if (arg1 >= arg0) {
            return 0
        };
        let v0 = arg0 - arg1;
    ...
    fun reconcile_recall_x<T0, T1>(arg0: &mut PoolLending, arg1: &mut 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::Custody<T0, T1>, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: 0x2::object::ID, arg4: u64, arg5: &0x2::clock::Clock) {
        let v0 = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::deployed_x<T0, T1>(arg1);
        if (v0 == 0) {
            return
        };
        let v1 = recall_residue(v0, read_live_collateral(arg0, arg2, arg4, arg5));
        if (v1 == 0) {
            return
        };
        let v2 = state_mut(arg0);
        write_off_side_residue(v2, arg3, true, v1, 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::claims_value_x<T0, T1>(arg1), 0x2::clock::timestamp_ms(arg5));
        0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::reduce_deployed_x<T0, T1>(arg1, v1);
    }

    fun reconcile_recall_y<T0, T1>(arg0: &mut PoolLending, arg1: &mut 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::Custody<T0, T1>, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: 0x2::object::ID, arg4: u64, arg5: &0x2::clock::Clock) {
        let v0 = 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::deployed_y<T0, T1>(arg1);
        if (v0 == 0) {
            return
        };
        ...
        let v2 = state_mut(arg0);
        write_off_side_residue(v2, arg3, false, v1, 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::claims_value_y<T0, T1>(arg1), 0x2::clock::timestamp_ms(arg5));
        0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody::reduce_deployed_y<T0, T1>(arg1, v1);
    }
    ...
    fun socialize_side_gap(arg0: &mut PoolLendingState, arg1: bool, arg2: u64, arg3: u64) : (u64, u64, u64) {
        ...
        let v8 = (arg3 as u128) + (v6 as u128);
        assert!(v8 >= (v7 as u128), 623);
        let v9 = v8 - (v7 as u128);
        let v10 = if ((v5 as u128) < v9) {
            v5
        } else {
            (v9 as u64)
        };
        if (v10 > 0) {
            if (arg1) {
                0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::yield_index::advance(&mut arg0.lp_yield_growth_x, v9, v9 - (v10 as u128));
                let v11 = &mut arg0.unrealized_lp_yield_x;
                let v12 = &mut arg0.pending_burn_x;
                adjust_deferred(v11, v12, 0, v10);
            } else {
                0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::yield_index::advance(&mut arg0.lp_yield_growth_y, v9, v9 - (v10 as u128));
                let v13 = &mut arg0.unrealized_lp_yield_y;
                let v14 = &mut arg0.pending_burn_y;
                adjust_deferred(v13, v14, 0, v10);
            };
        };
        (v1, v4, v10)
    }
