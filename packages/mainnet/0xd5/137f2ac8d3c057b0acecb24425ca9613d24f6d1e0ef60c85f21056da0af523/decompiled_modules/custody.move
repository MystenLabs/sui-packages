module 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::custody {
    ...
    public(friend) fun withdraw_reserved_yield_x<T0, T1>(arg0: &mut Custody<T0, T1>, arg1: u64, arg2: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x2::balance::value<T0>(&arg0.idle_x);
        assert!(v0 >= arg2 && arg1 <= v0 - arg2, 701);
        0x2::balance::split<T0>(&mut arg0.idle_x, arg1)
    }

    public(friend) fun withdraw_reserved_yield_y<T0, T1>(arg0: &mut Custody<T0, T1>, arg1: u64, arg2: u64) : 0x2::balance::Balance<T1> {
