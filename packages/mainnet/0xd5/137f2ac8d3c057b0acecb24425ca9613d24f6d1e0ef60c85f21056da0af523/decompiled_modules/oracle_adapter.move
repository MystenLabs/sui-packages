module 0xc975241310ca7dbd25481d1cc06058d7d5a086e68b675ee3ecdeae0d29c0137::oracle_adapter {
    ...
    fun checked_bin_id(arg0: bool, arg1: u32) : 0x1::option::Option<u32> {
        if (arg0) {
            let v1 = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::constants::bin_id_offset();
            if (v1 < arg1) {
                return 0x1::option::none<u32>()
            };
            0x1::option::some<u32>(v1 - arg1)
        } else {
            let v2 = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::constants::bin_id_offset();
            if (arg1 > 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::bitmap::max_bin_id() - v2) {
                return 0x1::option::none<u32>()
            };
    ...
    fun checked_oracle_conf_pair(arg0: &FeedReading, arg1: &FeedReading, arg2: u16) : bool {
        ...
        let v0 = (arg2 as u128);
        let v1 = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::constants::bps_denominator_u128();
        if (0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::checked_mul((arg0.conf_mag as u128), v1) > 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::checked_mul((arg0.price_mag as u128), v0)) {
            return false
        };
        if (0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::checked_mul((arg1.conf_mag as u128), v1) > 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::u128_math::checked_mul((arg1.price_mag as u128), v0)) {
            return false
        };
        true
    }
    ...
    public fun compute_oracle_bin_id_from_feeds(arg0: 0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::feed::Feed, arg1: 0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::feed::Feed, arg2: u32, arg3: u32, arg4: u8, arg5: u8, arg6: u16, arg7: u64, arg8: u16, arg9: u64, arg10: &0x2::clock::Clock) : 0x1::option::Option<OracleBinUpdate> {
        ...
        if (!0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fee_params::is_valid_bin_step(arg6)) {
            return 0x1::option::none<OracleBinUpdate>()
        };
        if (arg9 == 0 || arg9 > (0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fee_params::max_oracle_pair_skew_ms() as u64)) {
            return 0x1::option::none<OracleBinUpdate>()
        };
        ...
        let (v11, v12) = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fixed_point64::log2(0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fixed_point64::from_raw(v10));
        let (_, v14) = 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fixed_point64::log2(0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fixed_point64::from_fraction(((0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::constants::bps_denominator_u16() + arg6) as u64), 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::constants::bps_denominator_u64()));
        let v15 = checked_bin_id(v11, 0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fixed_point64::to_u32_round(0x577c62ef50b3e5780b988024c58c3c31528c89435bb0614aebed4b309ac8c7a2::fixed_point64::div(v12, v14)));
