module 0xd5b3caeb2d3e5486541352bac52f281caa36bf9a39be8bbc56a62bd72c47a34d::xx {
    struct XX has drop {
        dummy_field: bool,
    }

    fun init(arg0: XX, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/dIYwzkUeYtwcHDeSSp8hT6jmvD7OZHfbu8VxZEuztxY";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/dIYwzkUeYtwcHDeSSp8hT6jmvD7OZHfbu8VxZEuztxY"))
        };
