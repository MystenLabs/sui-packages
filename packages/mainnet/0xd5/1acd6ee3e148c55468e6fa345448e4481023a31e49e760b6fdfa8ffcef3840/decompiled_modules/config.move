module 0xd51acd6ee3e148c55468e6fa345448e4481023a31e49e760b6fdfa8ffcef3840::config {
    ...
    public fun checked_pause(arg0: &GlobalConfig) {
        assert!(!arg0.pause, 7);
    }
    ...
    public(friend) fun deduct_fee<T0>(arg0: &mut GlobalConfig, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u64) {
    ...
    public(friend) fun destroy_wrap_context(arg0: WrapContext) : (0x2::object::ID, 0x1::type_name::TypeName, 0x1::type_name::TypeName, u64, u64, vector<u8>) {
        let WrapContext {
            id               : v0,
            from             : v1,
            target           : v2,
    ...
    public(friend) fun get_wrap_context_id(arg0: &WrapContext) : 0x2::object::ID {
        arg0.id
    }
    ...
    public(friend) fun new_wrap_context(arg0: 0x1::type_name::TypeName, arg1: 0x1::type_name::TypeName, arg2: u64, arg3: u64, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) : WrapContext {
        WrapContext{
            id               : 0x2::object::id_from_address(0x2::tx_context::fresh_object_address(arg5)),
            from             : arg0,
            target           : arg1,
            amount           : arg2,
