module 0xd5539f20366458cdaca56da9d403429540fafd4b0ad011a33ffafd5a26bcb5d0::treasury {
    ...
    fun init(arg0: TREASURY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TREASURY>(arg0, 9, b"cUSD", b"Wrapped cUSD", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://imgurlzx.com/token-image/token-igxyUUMm3e.svg"))), arg1);
