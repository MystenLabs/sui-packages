module 0xd56ea9195d2a259d537d37d1c9e229c771ab5e72b366c030f03648446b3d38fe::dino_editions {
    struct DINO_EDITIONS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DINO_EDITIONS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DINO_EDITIONS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Dino Editions"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Dino Editions "));
