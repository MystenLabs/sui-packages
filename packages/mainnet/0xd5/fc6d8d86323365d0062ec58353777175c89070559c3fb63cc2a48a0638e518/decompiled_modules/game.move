module 0xd5fc6d8d86323365d0062ec58353777175c89070559c3fb63cc2a48a0638e518::game {
    ...
    public fun finish_evaluation(arg0: 0x2::object::ID, arg1: vector<u8>, arg2: &mut ConvenienceStore, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0;
        while (v6 < v2) {
            let v8 = 0xd5fc6d8d86323365d0062ec58353777175c89070559c3fb63cc2a48a0638e518::math::get_random_u64_in_range(&v5, tickets_left(arg2));
            let v9 = &v5;
