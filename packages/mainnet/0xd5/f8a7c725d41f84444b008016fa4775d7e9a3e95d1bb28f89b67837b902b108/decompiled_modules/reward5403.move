module 0xd5f8a7c725d41f84444b008016fa4775d7e9a3e95d1bb28f89b67837b902b108::reward5403 {
    struct REWARD5403 has drop {
        dummy_field: bool,
    }

    struct TICKET_5403 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5403(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5403>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5403>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5403, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5403>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5403>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5403>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5403>>(v5, 0x2::tx_context::sender(arg1));
    }
