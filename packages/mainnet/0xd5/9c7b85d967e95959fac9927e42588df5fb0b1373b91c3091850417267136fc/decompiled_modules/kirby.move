module 0xd59c7b85d967e95959fac9927e42588df5fb0b1373b91c3091850417267136fc::kirby {
    ...
    fun init(arg0: KIRBY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<KIRBY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"KIRBY   ")))), trim_right(b"Kirby                           "), trim_right(b"Walter is a vlogger dog. And also he's the presenter of GoPro                                                                                                                                                                                                                                                                   "), v2, arg1);
