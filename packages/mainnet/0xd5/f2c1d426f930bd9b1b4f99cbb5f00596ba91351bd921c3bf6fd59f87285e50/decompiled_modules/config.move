module 0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::config {
    ...
    struct GlobalConfig has store, key {
        ...
        acl: 0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::ACL,
        package_version: u64,
    }
    ...
    public fun acl(arg0: &GlobalConfig) : &0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::ACL {
        &arg0.acl
    }

    public fun add_role(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u8) {
        checked_package_version(arg0);
        0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::add_role(&mut arg0.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::Member> {
        0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        checked_package_version(arg0);
        0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun remove_role(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u8) {
        checked_package_version(arg0);
        0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::remove_role(&mut arg0.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        checked_package_version(arg0);
        0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun add_bin_step(arg0: &mut GlobalConfig, arg1: u16, arg2: u16, arg3: u16, arg4: u16, arg5: u16, arg6: u32, arg7: u16, arg8: u32, arg9: &0x2::tx_context::TxContext) {
        assert!(arg1 >= 1, 1);
        checked_package_version(arg0);
    ...
    public fun add_whitelist_token(arg0: &mut GlobalConfig, arg1: 0x1::type_name::TypeName, arg2: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_quote_whitelist_role(arg0, 0x2::tx_context::sender(arg2));
        if (!0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.quote_asset_whitelist, &arg1)) {
            0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg0.quote_asset_whitelist, arg1);
        };
    }

    public fun base_factor(arg0: &GlobalConfig, arg1: u16) : u16 {
    ...
    public fun check_bin_step_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::has_role(&arg0.acl, arg1, 1), 1);
    }

    public fun check_pair_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::has_role(&arg0.acl, arg1, 0), 5);
    }

    public fun check_protocol_fee_claim_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::has_role(&arg0.acl, arg1, 2), 2);
    }

    public fun check_quote_whitelist_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::has_role(&arg0.acl, arg1, 4), 11);
    }

    public fun check_rewarder_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::has_role(&arg0.acl, arg1, 3), 3);
    }
    ...
    public fun delete_whitelist_token(arg0: &mut GlobalConfig, arg1: 0x1::type_name::TypeName, arg2: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_quote_whitelist_role(arg0, 0x2::tx_context::sender(arg2));
        if (0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.quote_asset_whitelist, &arg1)) {
            0x2::vec_set::remove<0x1::type_name::TypeName>(&mut arg0.quote_asset_whitelist, &arg1);
        };
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                   : 0xd5f2c1d426f930bd9b1b4f99cbb5f00596ba91351bd921c3bf6fd59f87285e50::acl::new(arg0),
            package_version       : 1,
        };
    ...
    public fun update_bin_step(arg0: &mut GlobalConfig, arg1: u16, arg2: u16, arg3: u16, arg4: u16, arg5: u16, arg6: u32, arg7: u16, arg8: u32, arg9: &0x2::tx_context::TxContext) {
        assert!(arg1 >= 1, 1);
        checked_package_version(arg0);
        check_bin_step_manager_role(arg0, 0x2::tx_context::sender(arg9));
        let v0 = 0x2::vec_map::get_mut<u16, FeeParameters>(&mut arg0.bin_steps, &arg1);
        v0.base_factor = arg2;
        v0.filter_period = arg3;
        v0.decay_period = arg4;
        v0.reduction_factor = arg5;
        v0.variable_fee_control = arg6;
        v0.protocol_share = arg7;
        v0.max_volatility_accumulator = arg8;
        let v1 = SetBinStepEvent{
            bin_step                   : arg1,
            base_factor                : arg2,
            filter_period              : arg3,
