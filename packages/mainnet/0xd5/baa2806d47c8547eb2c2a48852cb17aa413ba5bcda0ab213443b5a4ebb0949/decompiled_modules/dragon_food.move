module 0x6a7ea1255160d2d3c77aa80440f17d4ae9092ef547141a34185e5b41c1c31c66::dragon_food {
    ...
    struct DragonFoodInMigration has store, key {
        id: 0x2::object::UID,
        dragon_food_cap: 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonFoodCapability,
        hive_available: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>,
        honey_available: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>,
    ...
    struct PoolHiveInMigration<phantom T0> has store, key {
        id: 0x2::object::UID,
        honey_available: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>,
        hive_available: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>,
        voting_bribes: vector<0x1::string::String>,
        pool_hive_vec: vector<u256>,
        active_hive_energy: 0x2::linked_table::LinkedTable<u64, u128>,
        active_honey_health: 0x2::linked_table::LinkedTable<u64, u128>,
        staked_balances_tab: 0x2::linked_table::LinkedTable<address, 0x2::balance::Balance<T0>>,
        emissions_indexes_tab: 0x2::linked_table::LinkedTable<address, vector<u256>>,
        dragon_bees_tab: 0x2::linked_table::LinkedTable<address, 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::MysticalBee>,
        locked_bees_tab: 0x2::linked_table::LinkedTable<address, vector<u64>>,
    }
    ...
    public entry fun delete_dragon_foodV1(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonDaoCapability, arg1: DragonFood, arg2: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) = delete_dragon_food(arg0, arg1);
        let v12 = DragonFoodInMigration{
        ...
        0x2::transfer::transfer<DragonFoodInMigration>(v12, 0x2::tx_context::sender(arg2));
    }
    ...
    public fun delete_pool_hive<T0, T1, T2, T3>(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonDaoCapability, arg1: PoolHive<T0>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, vector<0x1::string::String>, vector<u256>, 0x2::linked_table::LinkedTable<u64, u128>, 0x2::linked_table::LinkedTable<u64, u128>, 0x2::linked_table::LinkedTable<address, 0x2::balance::Balance<T0>>, 0x2::linked_table::LinkedTable<address, vector<u256>>, 0x2::linked_table::LinkedTable<address, 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::MysticalBee>, 0x2::linked_table::LinkedTable<address, vector<u64>>) {
        ...
        let VotingBribes {
            ...
            bribe                     : v12,
            is_meme_token             : _,
            cycle_to_hive_bribes_map  : v14,
            cycle_to_honey_bribes_map : v15,
        ...
        if (0x2::balance::value<T1>(&v10) > 0) {
            0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<T1>(0x2::balance::withdraw_all<T1>(&mut v10), 0x2::tx_context::sender(arg2), arg2);
        };
        if (0x2::balance::value<T2>(&v16) > 0) {
            0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<T2>(0x2::balance::withdraw_all<T2>(&mut v16), 0x2::tx_context::sender(arg2), arg2);
        };
        ...
        0x2::linked_table::drop<u64, u64>(v15);
        let PoolHive {
            id                       : v17,
            pool_addr                : _,
            total_staked             : v19,
            staked_for_honey         : v20,
            honey_available          : v21,
            hive_available           : v22,
            global_hive_claim_index  : v23,
            global_honey_claim_index : v24,
            last_claim_epoch         : v25,
            last_claim_honey_epoch   : v26,
            ongoing_cycle            : v27,
            cur_cycle_start_epoch    : v28,
            bribes                   : v29,
            added_hive_energy        : v30,
            active_hive_energy       : v31,
            removed_hive_energy      : v32,
            added_honey_health       : v33,
            active_honey_health      : v34,
            removed_honey_health     : v35,
            resting_dragons          : v36,
        ...
        0x2::linked_table::destroy_empty<u64, Proposal>(v38);
        let v42 = 0x1::vector::empty<u256>();
        0x1::vector::push_back<u256>(&mut v42, (v19 as u256));
        0x1::vector::push_back<u256>(&mut v42, (v20 as u256));
        0x1::vector::push_back<u256>(&mut v42, (v23 as u256));
        0x1::vector::push_back<u256>(&mut v42, (v24 as u256));
        0x1::vector::push_back<u256>(&mut v42, (v25 as u256));
        0x1::vector::push_back<u256>(&mut v42, (v26 as u256));
        0x1::vector::push_back<u256>(&mut v42, (v27 as u256));
        0x1::vector::push_back<u256>(&mut v42, (v28 as u256));
        0x1::vector::push_back<u256>(&mut v42, (v30 as u256));
        0x1::vector::push_back<u256>(&mut v42, (v32 as u256));
        0x1::vector::push_back<u256>(&mut v42, (v33 as u256));
        0x1::vector::push_back<u256>(&mut v42, (v35 as u256));
        let Bribes {
            voting_bribes           : v43,
            hive_bribe              : v44,
            honey_bribe             : v45,
            hive_fee_claim_indexes  : v46,
            honey_fee_claim_indexes : v47,
        } = v29;
        let v48 = v45;
        let v49 = v44;
        if (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&v49) > 0) {
            0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(0x2::balance::withdraw_all<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v49), 0x2::tx_context::sender(arg2), arg2);
        };
        if (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v48) > 0) {
            0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(0x2::balance::withdraw_all<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v48), 0x2::tx_context::sender(arg2), arg2);
        };
        0x2::balance::destroy_zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(v49);
        0x2::balance::destroy_zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(v48);
        0x2::linked_table::drop<u64, u256>(v46);
        0x2::linked_table::drop<u64, u256>(v47);
        let v50 = 0x2::linked_table::new<address, 0x2::balance::Balance<T0>>(arg2);
        let v51 = 0x2::linked_table::new<address, vector<u256>>(arg2);
        let v52 = 0x2::linked_table::new<address, 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::MysticalBee>(arg2);
        let v53 = 0x2::linked_table::new<address, vector<u64>>(arg2);
        let v54 = *0x2::linked_table::front<address, DragonDen<T0>>(&v41);
        while (0x1::option::is_some<address>(&v54)) {
            let v55 = *0x1::option::borrow<address>(&v54);
            v54 = *0x2::linked_table::next<address, DragonDen<T0>>(&v41, v55);
            let DragonDen {
                staked_balance    : v56,
                hive_claim_index  : v57,
                honey_claim_index : v58,
                dragon_bee        : v59,
                rewards_indexes   : v60,
                is_locked         : _,
            } = 0x2::linked_table::remove<address, DragonDen<T0>>(&mut v41, v55);
            let v62 = v59;
            0x2::linked_table::drop<0x1::ascii::String, u256>(v60);
            0x2::linked_table::push_back<address, 0x2::balance::Balance<T0>>(&mut v50, v55, v56);
            let v63 = 0x1::vector::empty<u256>();
            0x1::vector::push_back<u256>(&mut v63, v57);
            0x1::vector::push_back<u256>(&mut v63, v58);
            0x2::linked_table::push_back<address, vector<u256>>(&mut v51, v55, v63);
            if (0x1::option::is_some<LockedDragonBee>(&v62)) {
                let LockedDragonBee {
                    version                 : v64,
                    locked_at_cycle         : v65,
                    mystical_bee            : v66,
                    increment_cycle         : v67,
                    increase_in_energy      : v68,
                    increase_in_health      : v69,
                    hive_energy             : v70,
                    temp_hive_energy        : v71,
                    honey_health            : v72,
                    temp_honey_health       : v73,
                    dao_vote_cycle          : v74,
                    bribes_claimed_till     : v75,
                    fees_claimed_till       : v76,
                    hive_fee_claim_indexes  : v77,
                    honey_fee_claim_indexes : v78,
                    withdrawable_at_cycle   : v79,
                } = 0x1::option::extract<LockedDragonBee>(&mut v62);
                0x2::linked_table::drop<u64, u256>(v77);
                0x2::linked_table::drop<u64, u256>(v78);
                0x2::linked_table::push_back<address, 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::MysticalBee>(&mut v52, v55, v66);
                let v80 = 0x1::vector::empty<u64>();
                0x1::vector::push_back<u64>(&mut v80, v64);
                0x1::vector::push_back<u64>(&mut v80, v65);
                0x1::vector::push_back<u64>(&mut v80, v67);
                0x1::vector::push_back<u64>(&mut v80, (v68 as u64));
                0x1::vector::push_back<u64>(&mut v80, (v69 as u64));
                0x1::vector::push_back<u64>(&mut v80, (v70 as u64));
                0x1::vector::push_back<u64>(&mut v80, (v71 as u64));
                0x1::vector::push_back<u64>(&mut v80, (v72 as u64));
                0x1::vector::push_back<u64>(&mut v80, (v73 as u64));
                0x1::vector::push_back<u64>(&mut v80, v74);
                0x1::vector::push_back<u64>(&mut v80, v75);
                0x1::vector::push_back<u64>(&mut v80, v76);
                0x1::vector::push_back<u64>(&mut v80, v79);
                0x2::linked_table::push_back<address, vector<u64>>(&mut v53, v55, v80);
            };
            0x1::option::destroy_none<LockedDragonBee>(v62);
        };
        0x2::linked_table::destroy_empty<address, DragonDen<T0>>(v41);
        (v21, v22, v43, v42, v31, v34, v50, v51, v52, v53)
    }

    public entry fun delete_pool_hiveV1<T0, T1, T2, T3>(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonDaoCapability, arg1: PoolHive<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3, v4, v5, v6, v7, v8, v9) = delete_pool_hive<T0, T1, T2, T3>(arg0, arg1, arg2);
        let v10 = PoolHiveInMigration<T0>{
            id                    : 0x2::object::new(arg2),
            honey_available       : v0,
            hive_available        : v1,
            voting_bribes         : v2,
            ...
            staked_balances_tab   : v6,
            emissions_indexes_tab : v7,
            dragon_bees_tab       : v8,
            locked_bees_tab       : v9,
        };
        0x2::transfer::transfer<PoolHiveInMigration<T0>>(v10, 0x2::tx_context::sender(arg2));
    }
    ...
    public fun destroy_dragon_food_in_migration(arg0: DragonFoodInMigration) : (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonFoodCapability, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, 0x2::linked_table::LinkedTable<u64, u128>, 0x2::linked_table::LinkedTable<u64, u128>, vector<u128>, 0x2::linked_table::LinkedTable<u64, u128>, 0x2::linked_table::LinkedTable<u64, u128>, 0x2::linked_table::LinkedTable<u64, u128>, 0x2::linked_table::LinkedTable<u64, u128>, 0x2::linked_table::LinkedTable<u64, u128>, 0x2::linked_table::LinkedTable<u64, u128>) {
        let DragonFoodInMigration {
            id                   : v0,
            dragon_food_cap      : v1,
            hive_available       : v2,
            honey_available      : v3,
            total_hive_energy    : v4,
            total_honey_health   : v5,
            values_vec           : v6,
            hive_increase_votes  : v7,
            hive_decrease_votes  : v8,
            hive_same_votes      : v9,
            honey_increase_votes : v10,
            honey_decrease_votes : v11,
            honey_same_votes     : v12,
        } = arg0;
        0x2::object::delete(v0);
    ...
    public fun destroy_pool_hive_in_migration<T0>(arg0: PoolHiveInMigration<T0>) : (0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, vector<0x1::string::String>, vector<u256>, 0x2::linked_table::LinkedTable<u64, u128>, 0x2::linked_table::LinkedTable<u64, u128>, 0x2::linked_table::LinkedTable<address, 0x2::balance::Balance<T0>>, 0x2::linked_table::LinkedTable<address, vector<u256>>, 0x2::linked_table::LinkedTable<address, 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::MysticalBee>, 0x2::linked_table::LinkedTable<address, vector<u64>>) {
        let PoolHiveInMigration {
            id                    : v0,
            honey_available       : v1,
            hive_available        : v2,
            voting_bribes         : v3,
            pool_hive_vec         : v4,
            active_hive_energy    : v5,
            active_honey_health   : v6,
            staked_balances_tab   : v7,
            emissions_indexes_tab : v8,
            dragon_bees_tab       : v9,
            locked_bees_tab       : v10,
        } = arg0;
        0x2::object::delete(v0);
