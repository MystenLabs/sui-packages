module 0xd58097e323dd3300cacc156e957f12a0befba35576fbea9a22523b3035be88c2::gift9867 {
    struct GIFT9867 has drop {
        dummy_field: bool,
    }

    struct TICKET_9867 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9867(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9867>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9867>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9867, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9867>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9867>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9867>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9867>>(v5, 0x2::tx_context::sender(arg1));
    }
