module 0xd57aa7d55732e7d4d1b8a8432302dda00fa0b58f91e4c234b4e8ffb4838c87f6::staking {
    ...
    public entry fun withdraw(arg0: &mut Pool, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        v1.stake_amount = v1.stake_amount - arg1 * 2;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.total_staked_balance, arg1 * 2, arg2), v0);
    }
