module 0xd55a12d5e29dd29b7722e8853349d3abbf36097eb4a3550583d6c6997066f657::cnsnft2694 {
    struct CNSNFT2694 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2694, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2694>(arg0, arg1);
