module 0xd5e9f41c53f9007355586f3570b63531cdb422420fd43f6ff8d0775911664715::kiosk_swap {
    ...
    struct KioskOwnershipUpdated has copy, drop {
        proposal_id: 0x2::object::ID,
        kiosk_id: 0x2::object::ID,
        old_owner: address,
        new_owner: address,
    ...
    struct KioskReindexTrigger has copy, drop {
        kiosk_id: 0x2::object::ID,
    ...
    public fun trigger_kiosk_reindex(arg0: &0x2::kiosk::Kiosk, arg1: &0x2::tx_context::TxContext) {
        let v0 = KioskReindexTrigger{
            kiosk_id      : 0x2::object::id<0x2::kiosk::Kiosk>(arg0),
            current_owner : 0x2::kiosk::owner(arg0),
            triggered_by  : 0x2::tx_context::sender(arg1),
            timestamp     : 0,
        };
        0x2::event::emit<KioskReindexTrigger>(v0);
    }

    public fun trigger_swap_reindex(arg0: &0x2::kiosk::Kiosk, arg1: &0x2::kiosk::Kiosk, arg2: &0x2::tx_context::TxContext) {
        trigger_kiosk_reindex(arg0, arg2);
        trigger_kiosk_reindex(arg1, arg2);
    }
