module 0xd5c72a1ceed8954332d01484a4790bcad1c2172cd911c7a031ab06c515ff4e1f::regulated_coin {
    struct REGULATED_COIN has drop {
        dummy_field: bool,
    }

    entry fun mint(arg0: &mut 0x2::coin::TreasuryCap<REGULATED_COIN>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REGULATED_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<REGULATED_COIN>(arg0, 5, b"der", b"bubuu", b"Example Regulated Coin", 0x1::option::none<0x2::url::Url>(), true, arg1);
