module 0xd56ae163671268a482cc73b7cd710e20c72130a5137c70a944e6cf56438fedc4::app_cap_display {
    ...
    public(friend) fun new(arg0: 0xd56ae163671268a482cc73b7cd710e20c72130a5137c70a944e6cf56438fedc4::name::Name, arg1: bool) : AppCapDisplay {
        let v0 = if (arg1) {
            100
        } else {
            0
        ...
        AppCapDisplay{
            title            : 0xd56ae163671268a482cc73b7cd710e20c72130a5137c70a944e6cf56438fedc4::name::to_string(&arg0),
            link_opacity     : v0,
    ...
    public(friend) fun uri_encode_text(arg0: 0xd56ae163671268a482cc73b7cd710e20c72130a5137c70a944e6cf56438fedc4::name::Name) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"");
        let (v1, v2) = render_batch(0xd56ae163671268a482cc73b7cd710e20c72130a5137c70a944e6cf56438fedc4::name::app_to_string(&arg0), 13, 30, 26, 29, 0x1::string::utf8(b"FFFFFF"));
        0x1::string::append(&mut v0, v1);
        let (v3, _) = render_batch(0xd56ae163671268a482cc73b7cd710e20c72130a5137c70a944e6cf56438fedc4::name::org_to_string(&arg0), 22, v2, 15, 12, 0x1::string::utf8(b"E0E1EC"));
