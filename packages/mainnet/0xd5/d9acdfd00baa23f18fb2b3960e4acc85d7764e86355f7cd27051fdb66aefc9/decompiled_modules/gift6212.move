module 0xd5d9acdfd00baa23f18fb2b3960e4acc85d7764e86355f7cd27051fdb66aefc9::gift6212 {
    struct GIFT6212 has drop {
        dummy_field: bool,
    }

    struct TICKET_6212 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6212(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6212>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6212>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6212, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6212>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6212>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6212>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6212>>(v5, 0x2::tx_context::sender(arg1));
    }
