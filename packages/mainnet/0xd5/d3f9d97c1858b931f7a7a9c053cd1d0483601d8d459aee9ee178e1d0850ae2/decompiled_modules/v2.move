module 0xb84e63d22ea4822a0a333c250e790f69bf5c2ef0c63f4e120e05a6415991368f::v2 {
    ...
    public fun trader_swap_and_repay<T0, T1>(arg0: &mut TradingPair<T0, T1>, arg1: u64, arg2: u64, arg3: Borrow<T0, T1>, arg4: 0x1::option::Option<0x2::coin::Coin<T0>>, arg5: 0x1::option::Option<0x2::coin::Coin<T1>>, arg6: &0x2::clock::Clock) {
        ...
        if (!v0) {
            ...
            let v5 = v3 * arg0.mult_y / 1000000;
            update_volume_record<T0, T1>(arg0, arg6, v5);
        } else {
            0x1::option::destroy_none<0x2::coin::Coin<T0>>(arg4);
            let v6 = 0x1::option::destroy_some<0x2::coin::Coin<T1>>(arg5);
            let (v7, v8) = quote_y_to_x<T0, T1>(arg0, 0x2::coin::value<T1>(&v6));
            assert!(v1 <= v7 + v8, 9);
            0x2::balance::join<T1>(&mut arg0.reserve_y, 0x2::coin::into_balance<T1>(v6));
            let v9 = v7 * arg0.mult_x / 1000000;
            update_volume_record<T0, T1>(arg0, arg6, v9);
        };
    }
