module 0xd5737054a0a5166df815d663087e215e7382a0e8bab8eb406e970566dcde76d5::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public fun launchpad_mint(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &0x2::transfer_policy::TransferPolicy<Nft>, arg8: &mut 0x2497004f3f3ff0f78bdb6c05c62c3c45b06ff531ea9ffd7fa191c7223b729a8::launch_manager::Launch, arg9: &mut 0x2497004f3f3ff0f78bdb6c05c62c3c45b06ff531ea9ffd7fa191c7223b729a8::launchpad::Launchpad, arg10: u64, arg11: &mut Config, arg12: &mut 0x2::tx_context::TxContext) {
        assert_mintable(arg11);
        let v0 = impl_mint(arg0, arg2, arg1, arg10, arg3, arg4, arg12);
        let v1 = MintNftEvent{nft_id: 0x2::object::uid_to_inner(&v0.id)};
        0x2::event::emit<MintNftEvent>(v1);
        arg11.mint_count = arg11.mint_count + 1;
        0x2497004f3f3ff0f78bdb6c05c62c3c45b06ff531ea9ffd7fa191c7223b729a8::launch_manager::mint_with_kiosk<Nft>(arg8, v0, arg5, arg7, arg6, arg9, arg12);
    }
