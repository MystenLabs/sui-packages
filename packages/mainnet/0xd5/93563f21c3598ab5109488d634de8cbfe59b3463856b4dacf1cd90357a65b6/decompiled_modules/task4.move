module 0xd593563f21c3598ab5109488d634de8cbfe59b3463856b4dacf1cd90357a65b6::task4 {
    ...
    public entry fun deposit(arg0: &mut PrizePool, arg1: 0x2::coin::Coin<0xf55b7f267fbf88f6e195bdb979316293ec492882273e7deffc078a6615ec2bfd::faucetcoin::FAUCETCOIN>) {
    ...
    fun random_num(arg0: &mut 0x2::tx_context::TxContext) : u8 {
    ...
    public entry fun start_game(arg0: &mut PrizePool, arg1: u8, arg2: 0x2::coin::Coin<0xf55b7f267fbf88f6e195bdb979316293ec492882273e7deffc078a6615ec2bfd::faucetcoin::FAUCETCOIN>, arg3: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v3 = random_num(arg3);
        let v4 = 0x1::string::utf8(b"The number is:");
