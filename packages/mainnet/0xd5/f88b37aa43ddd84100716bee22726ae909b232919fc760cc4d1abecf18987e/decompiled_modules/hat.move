module 0xd5f88b37aa43ddd84100716bee22726ae909b232919fc760cc4d1abecf18987e::hat {
    struct HAT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: HAT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<HAT>(&mut v3, 100000000000000, 0x2::tx_context::sender(arg1), arg1);
