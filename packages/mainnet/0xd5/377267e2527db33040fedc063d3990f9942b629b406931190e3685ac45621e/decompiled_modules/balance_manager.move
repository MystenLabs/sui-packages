module 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::balance_manager {
    ...
    public(friend) fun get_referral_id(arg0: &BalanceManager) : 0x1::option::Option<0x2::object::ID> {
        let v0 = 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::constants::referral_df_key();
    ...
    public fun set_referral(arg0: &mut BalanceManager, arg1: &DeepBookReferral, arg2: &TradeCap) {
        ...
        0x2::dynamic_field::remove_if_exists<vector<u8>, 0x2::object::ID>(&mut arg0.id, 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::constants::referral_df_key());
        0x2::dynamic_field::add<vector<u8>, 0x2::object::ID>(&mut arg0.id, 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::constants::referral_df_key(), 0x2::object::uid_to_inner(&arg1.id));
