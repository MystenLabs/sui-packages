module 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::registry {
    ...
    public fun disable_version(arg0: &mut Registry, arg1: u64, arg2: &DeepbookAdminCap) {
        ...
        assert!(arg1 != 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::constants::current_version(), 6);
    ...
    fun init(arg0: REGISTRY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = RegistryInner{
            allowed_versions : 0x2::vec_set::singleton<u64>(0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::constants::current_version()),
            pools            : 0x2::bag::new(arg1),
            treasury_address : 0x2::tx_context::sender(arg1),
        };
        let v1 = Registry{
            id    : 0x2::object::new(arg1),
            inner : 0x2::versioned::create<RegistryInner>(0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::constants::current_version(), v0, arg1),
        };
