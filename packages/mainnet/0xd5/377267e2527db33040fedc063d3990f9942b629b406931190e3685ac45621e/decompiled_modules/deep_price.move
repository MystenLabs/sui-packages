module 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::deep_price {
    ...
    public(friend) fun deep_quantity_u128(arg0: &OrderDeepPrice, arg1: u128, arg2: u128) : u128 {
        if (arg0.asset_is_base) {
            0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::math::mul_u128(arg1, (arg0.deep_per_asset as u128))
        } else {
            0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::math::mul_u128(arg2, (arg0.deep_per_asset as u128))
        }
    }
    ...
    public(friend) fun fee_quantity(arg0: &OrderDeepPrice, arg1: u64, arg2: u64, arg3: bool) : 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::balances::Balances {
        let v0 = if (arg0.asset_is_base) {
            0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::math::mul(arg1, arg0.deep_per_asset)
        } else {
            0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::math::mul(arg2, arg0.deep_per_asset)
        };
        if (arg0.deep_per_asset > 0) {
            0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::balances::new(0, 0, v0)
        } else if (arg3) {
            0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::balances::new(0, 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::math::mul(arg2, 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::constants::fee_penalty_multiplier()), 0)
        } else {
            0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::balances::new(0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::math::mul(arg1, 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::constants::fee_penalty_multiplier()), 0, 0)
        }
    }
