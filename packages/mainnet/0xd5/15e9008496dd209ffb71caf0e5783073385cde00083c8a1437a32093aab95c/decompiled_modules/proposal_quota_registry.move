module 0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::proposal_quota_registry {
    ...
    public(friend) fun new() : ProposalQuotaRegistry {
    ...
    fun period_start_preserving_old_reset(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        let v0 = saturating_add(arg1, arg2);
        if (v0 <= arg0) {
            arg0
        } else if (v0 >= arg3) {
            v0 - arg3
    ...
    public(friend) fun set_quotas(arg0: &mut ProposalQuotaRegistry, arg1: 0x2::object::ID, arg2: vector<address>, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock) {
            ...
            if (v0) {
                ...
                if (v7) {
                    ...
                    let v13 = if (v11 > 0) {
                        ...
                        period_start_preserving_old_reset(v1, v10.feeless_proposal_period_start_ms, v10.period_ms, arg3)
                    };
                    let v14 = if (v12 > 0) {
                        v10.sponsor_period_start_ms + v12 * v10.period_ms
                    } else {
                        period_start_preserving_old_reset(v1, v10.sponsor_period_start_ms, v10.period_ms, arg3)
                    };
                    let v15 = if (v11 > 0) {
                        0
                    } else {
                    ...
                    assert!(0x1::vector::length<QuotaEntry>(&arg0.quotas) < 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::max_quota_entries(), 1);
                    let v19 = QuotaEntry{
                        user : v3,
                        info : v6,
                    };
    ...
    public(friend) fun use_feeless_quota(arg0: &mut ProposalQuotaRegistry, arg1: 0x2::object::ID, arg2: address, arg3: &0x2::clock::Clock) {
    ...
    public(friend) fun use_sponsor_quota(arg0: &mut ProposalQuotaRegistry, arg1: 0x2::object::ID, arg2: address, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock) {
        let (v0, v1) = find_user_index(&arg0.quotas, arg2);
        assert!(v0, 2);
        let v2 = &mut 0x1::vector::borrow_mut<QuotaEntry>(&mut arg0.quotas, v1).info;
