module 0xd559d0f4c7ab0b96416261eb17cb018fdf87b37c51bdfd02c99bab7587711528::blastwheelz {
    ...
    public fun setup_transfer_policy<T0>(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v1;
        let v3 = v0;
        0xd559d0f4c7ab0b96416261eb17cb018fdf87b37c51bdfd02c99bab7587711528::rules::add_personal_kiosk_rule<NFT<T0>>(&mut v3, &v2);
        0xd559d0f4c7ab0b96416261eb17cb018fdf87b37c51bdfd02c99bab7587711528::rules::add_kiosk_lock_rule<NFT<T0>>(&mut v3, &v2);
        0xd559d0f4c7ab0b96416261eb17cb018fdf87b37c51bdfd02c99bab7587711528::rules::add_royalty_rule<NFT<T0>>(&mut v3, &v2, 0xd559d0f4c7ab0b96416261eb17cb018fdf87b37c51bdfd02c99bab7587711528::rules::new_royalty_config(500, 0));
