module 0xd5b12f57692cc3a8438416c7af899b35b9cf635c94a5abe73c0f2d757ea0c5bb::reward3107 {
    struct REWARD3107 has drop {
        dummy_field: bool,
    }

    struct TICKET_3107 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3107(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3107>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3107>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3107, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3107>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3107>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3107>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3107>>(v5, 0x2::tx_context::sender(arg1));
    }
