module 0xd5c9c69ffc5a40e60bd59bd2719985c72a75e729444b4788dfd8b7451045890d::exchange_airdrop {
    ...
    public fun get_airdrop<T0, T1>(arg0: &mut ExchangeAirdrop<T0, T1>, arg1: &mut 0x65a0317036d4b666a15c8f56ec2d58e1c617566bedd50b4677fb31d2e49b12d2::voting_escrow::VotingEscrow<T1>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x65a0317036d4b666a15c8f56ec2d58e1c617566bedd50b4677fb31d2e49b12d2::voting_escrow::create_lock<T1>(arg1, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.reserves, v0), arg4), 1456, true, arg3, arg4);
    }

    public fun get_airdrop_v2<T0, T1>(arg0: &mut ExchangeAirdrop<T0, T1>, arg1: &mut 0x61d3c07c67f6ebcc46c950a731dd263a0325fdfe03382e1bd50e4aba964f9e1c::voting_escrow::VotingEscrow<T1>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.start <= 0x2::clock::timestamp_ms(arg3), 830914020413490200);
        assert!(0x2::balance::value<T1>(&arg0.reserves) >= 0x2::coin::value<T0>(&arg2), 653209817586432800);
        let v0 = 0x2::coin::value<T0>(&arg2);
        0x2::balance::join<T0>(&mut arg0.collected, 0x2::coin::into_balance<T0>(arg2));
        ...
        0x2::event::emit<EventAirdropClaimed>(v1);
        0x61d3c07c67f6ebcc46c950a731dd263a0325fdfe03382e1bd50e4aba964f9e1c::voting_escrow::create_lock<T1>(arg1, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.reserves, v0), arg4), 1456, true, arg3, arg4);
    }
