module 0xd5ef4e8e31c352511f2f5c80c9201904796f86b1352c2b9df12e2f6c891205f5::cnsnft2814 {
    struct CNSNFT2814 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2814, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2814>(arg0, arg1);
