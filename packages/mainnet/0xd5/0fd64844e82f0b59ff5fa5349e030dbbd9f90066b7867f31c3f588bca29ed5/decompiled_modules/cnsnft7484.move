module 0xd50fd64844e82f0b59ff5fa5349e030dbbd9f90066b7867f31c3f588bca29ed5::cnsnft7484 {
    struct CNSNFT7484 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7484, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9733"));
        let v4 = 0x2::package::claim<CNSNFT7484>(arg0, arg1);
