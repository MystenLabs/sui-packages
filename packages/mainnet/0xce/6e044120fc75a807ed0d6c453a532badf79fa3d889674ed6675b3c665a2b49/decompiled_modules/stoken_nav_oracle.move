module 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_nav_oracle {
    ...
    public fun create_nav_oracle<T0>(arg0: 0x2::object::ID, arg1: address, arg2: address, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (NavOracleAdminCap, NavOracleManagerCap, NavOracleProviderCap) {
        ...
        assert!(arg3 >= 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_math::min_cooldown_secs() && arg3 <= 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_math::max_cooldown_secs(), 5);
        let v0 = NavOracle<T0>{
    ...
    public fun finalize_global_round<T0, T1>(arg0: &mut NavOracle<T0>, arg1: &mut 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_vault::Vault<T0, T1>, arg2: &NavOracleProviderCap, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_version<T0>(arg0);
        ...
        assert!(v1.nav_oracle_id == v0 && v1.vault_id == 0x2::object::id<0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_vault::Vault<T0, T1>>(arg1), 5);
        ...
        assert!(v2 > 0 && v3 > 0, 5);
        let v7 = 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_math::mul_div(v2, 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_math::price_precision(), v3);
        assert!(v7 > 0, 5);
        ...
        0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_vault::update_price_from_oracle_service<T0, T1>(arg1, v7, arg4);
        ...
        let v8 = GlobalNavRoundFinalizedEvent{
            nav_oracle_id    : 0x2::object::id<NavOracle<T0>>(arg0),
            vault_id         : 0x2::object::id<0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_vault::Vault<T0, T1>>(arg1),
            round_id         : arg3,
            global_nav       : v2,
            global_shares    : v3,
            calculated_price : v7,
    ...
    public fun update_vault_price_from_nav<T0, T1>(arg0: &mut NavOracle<T0>, arg1: &mut 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_vault::Vault<T0, T1>, arg2: &NavOracleProviderCap, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_version<T0>(arg0);
        assert!(!has_global_state<T0>(arg0), 5);
        assert!(0x2::object::id<0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_vault::Vault<T0, T1>>(arg1) == arg0.vault_id, 5);
        assert_provider<T0>(arg0, arg2, arg5);
        let v0 = 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_vault::total_shares<T0, T1>(arg1);
        assert!(v0 > 0, 5);
        let v1 = 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_math::mul_div(0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_math::scale_nav_for_price(arg3 + 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_vault::total_idle<T0, T1>(arg1), 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_vault::get_share_decimals<T0, T1>(arg1), 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_vault::get_underlying_decimals<T0, T1>(arg1)), 0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_math::price_precision(), v0);
        ...
        0xce6e044120fc75a807ed0d6c453a532badf79fa3d889674ed6675b3c665a2b49::stoken_vault::update_price_from_oracle_service<T0, T1>(arg1, v1, arg4);
    }
