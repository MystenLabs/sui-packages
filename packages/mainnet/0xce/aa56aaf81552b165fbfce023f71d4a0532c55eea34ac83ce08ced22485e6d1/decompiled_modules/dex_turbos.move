module 0xceaa56aaf81552b165fbfce023f71d4a0532c55eea34ac83ce08ced22485e6d1::dex_turbos {
    ...
    public fun swap_cross<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v0 > 0, 0xceaa56aaf81552b165fbfce023f71d4a0532c55eea34ac83ce08ced22485e6d1::constants::get_zero_amount_error());
        ...
        let v1 = SwapExecuted{
            ...
            trader       : arg1,
            pool_address : 0xceaa56aaf81552b165fbfce023f71d4a0532c55eea34ac83ce08ced22485e6d1::constants::get_turbos_sui_usdc_pool(),
        };
        0x2::event::emit<SwapExecuted>(v1);
        abort 0xceaa56aaf81552b165fbfce023f71d4a0532c55eea34ac83ce08ced22485e6d1::constants::get_zero_amount_error()
    }
