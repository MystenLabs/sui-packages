module 0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::gamio_collection_snake_legend {
    ...
    public entry fun claim(arg0: &mut InfoCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::witness::check_owner(arg2), 1);
    ...
    fun init(arg0: GAMIO_COLLECTION_SNAKE_LEGEND, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::snake_item::get_description_nft()));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::snake_item::get_website()));
    ...
    fun init_infocollection(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = InfoCollection{
            ...
            name_nft        : 0x1::string::utf8(0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::snake_item::get_name_nft()),
            description_nft : 0x1::string::utf8(0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::snake_item::get_description_nft()),
            ourl            : 0x1::string::utf8(0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::snake_item::get_image_url()),
            metadata        : 0x1::string::utf8(0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::snake_item::get_metadata_url()),
            sum_nft         : 0,
            sui_deposit     : 0x2::balance::zero<0x2::sui::SUI>(),
            hard_cap        : 0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::snake_item::get_hard_cap(),
            price_mint      : 0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::snake_item::get_price_mint(),
        };
    ...
    public entry fun mix_egg_stone<T0: store + key, T1: store + key>(arg0: &mut InfoCollection, arg1: vector<u8>, arg2: vector<u8>, arg3: T0, arg4: T1, arg5: vector<u8>, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::snake_item::get_key();
        ...
        assert!(0x1::type_name::into_string(0x1::type_name::get<T0>()) == 0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::snake_item::get_type_egg1() || 0x1::type_name::into_string(0x1::type_name::get<T0>()) == 0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::snake_item::get_type_egg2(), 9);
        assert!(0x1::type_name::into_string(0x1::type_name::get<T1>()) == 0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::snake_item::get_type_gem(), 9);
    ...
    public entry fun mix_egg_sui<T0: store + key>(arg0: &mut InfoCollection, arg1: &mut EggsBasket, arg2: vector<u8>, arg3: vector<u8>, arg4: T0, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: vector<u8>, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 == 1) {
            ...
            let v5 = 0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::broken_egg::mint(arg8);
            let v6 = NFTMintedEggs{
                object_id : 0x2::object::id<0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::broken_egg::BrokenEgg>(&v5),
                creator   : 0x2::tx_context::sender(arg8),
            ...
            0x2::transfer::public_transfer<0xcee8e9c7bb7ececa8c4097556ee3b5d4023c35ccee2603cf6745ad832461fff2::broken_egg::BrokenEgg>(v5, 0x2::tx_context::sender(arg8));
        };
