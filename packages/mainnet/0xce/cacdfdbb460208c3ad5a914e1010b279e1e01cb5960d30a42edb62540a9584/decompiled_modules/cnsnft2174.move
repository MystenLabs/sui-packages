module 0xcecacdfdbb460208c3ad5a914e1010b279e1e01cb5960d30a42edb62540a9584::cnsnft2174 {
    struct CNSNFT2174 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2174, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1000"));
        let v4 = 0x2::package::claim<CNSNFT2174>(arg0, arg1);
