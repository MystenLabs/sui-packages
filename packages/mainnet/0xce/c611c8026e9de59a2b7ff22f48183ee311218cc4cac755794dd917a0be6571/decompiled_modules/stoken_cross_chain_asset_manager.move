module 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_cross_chain_asset_manager {
    ...
    public fun accept_adapter<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<address, AdapterBinding>(&arg0.adapters, arg2), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_no_pending_adapter());
        let v0 = now_secs(arg3);
        let v1 = arg0.adapter_count;
        let v2 = 0x2::table::borrow_mut<address, AdapterBinding>(&mut arg0.adapters, arg2);
        assert!(v2.status == 0, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_no_pending_adapter());
        assert!(v0 >= v2.created_at + arg0.gov_cooldowns.adapter_change_cooldown, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_adapter_delay_not_elapsed());
        assert!(v1 < 8, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_max_adapters_reached());
        v2.status = 1;
        v2.active = true;
        v2.updated_at = v0;
    ...
    public fun accept_aggregator<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(0x1::option::is_some<PendingAddress>(&arg0.pending_aggregator), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_no_pending_config());
        let v0 = 0x1::option::extract<PendingAddress>(&mut arg0.pending_aggregator);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.gov_cooldowns.config_change_cooldown, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_config_delay_not_elapsed());
    ...
    public fun accept_cctp_messenger<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0>(arg0, arg1, arg3);
        assert!(0x1::option::is_some<PendingAddress>(&arg0.pending_token_messenger_minter), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_no_pending_config());
    ...
    public fun accept_limits<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0>(arg0, arg1, arg3);
        assert!(0x1::option::is_some<PendingLimits>(&arg0.pending_limits), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_no_pending_limits_change());
        let v0 = 0x1::option::extract<PendingLimits>(&mut arg0.pending_limits);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.gov_cooldowns.limits_cooldown, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_limits_change_timelock_active());
    ...
    public fun accept_manager<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0>(arg0, arg1, arg3);
        assert!(0x1::option::is_some<PendingRole>(&arg0.pending_manager), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_no_pending_manager_change());
        let v0 = 0x1::option::extract<PendingRole>(&mut arg0.pending_manager);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.gov_cooldowns.manager_change_cooldown, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_manager_change_cooldown_not_expired());
    ...
    public fun accept_processor<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0>(arg0, arg1, arg3);
        assert!(0x1::option::is_some<PendingRole>(&arg0.pending_processor), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_no_pending_processor_change());
        let v0 = 0x1::option::extract<PendingRole>(&mut arg0.pending_processor);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.gov_cooldowns.processor_change_cooldown, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_processor_change_cooldown_not_expired());
    ...
    public fun accept_withdraw_destination<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0>(arg0, arg1, arg3);
        assert!(0x1::option::is_some<PendingAddress>(&arg0.pending_withdraw_destination), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_no_pending_withdraw_destination());
        let v0 = 0x1::option::extract<PendingAddress>(&mut arg0.pending_withdraw_destination);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.gov_cooldowns.config_change_cooldown, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_withdraw_destination_delay_not_elapsed());
    ...
    public fun assert_adapter_active<T0>(arg0: &CrossChainAssetManager<T0>, arg1: address) {
        assert!(0x2::table::contains<address, AdapterBinding>(&arg0.adapters, arg1), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_adapter_not_allowed());
        let v0 = 0x2::table::borrow<address, AdapterBinding>(&arg0.adapters, arg1);
        assert!(v0.status == 1, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_adapter_not_active());
        assert!(v0.active, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_adapter_disabled());
    }

    fun assert_admin<T0>(arg0: &CrossChainAssetManager<T0>, arg1: &CcamAdminCap) {
        assert!(arg1.ccam_id == 0x2::object::id<CrossChainAssetManager<T0>>(arg0), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::unauthorized());
    ...
    fun assert_processor<T0>(arg0: &CrossChainAssetManager<T0>, arg1: &CcamProcessorCap, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1.ccam_id == 0x2::object::id<CrossChainAssetManager<T0>>(arg0), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::unauthorized());
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg2) == arg0.processor, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::unauthorized());
    }
    ...
    fun check_processor_limits<T0>(arg0: &CrossChainAssetManager<T0>, arg1: u64, arg2: u64) {
        assert!(arg1 <= arg0.processor_max_per_tx, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_amount_exceeds_max());
        assert!(arg0.processor_daily_used + arg1 <= arg0.processor_daily_limit, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_daily_limit_exceeded());
        if (arg0.last_operation_time > 0 && arg0.processor_cooldown > 0) {
            assert!(arg2 >= arg0.last_operation_time + arg0.processor_cooldown, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_cooldown_not_elapsed());
        };
    }
    ...
    fun deposit_internal<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: 0x2::coin::Coin<T0>) {
        ...
        assert!(v0 > 0, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_zero_amount());
    ...
    public fun disable_adapter<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert_manager<T0>(arg0, arg1, arg4);
        assert!(0x2::table::contains<address, AdapterBinding>(&arg0.adapters, arg2), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_adapter_not_allowed());
    ...
    public fun emergency_sweep<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_manager<T0>(arg0, arg1, arg4);
        assert!(arg0.paused, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_not_paused());
        assert!(now_secs(arg3) >= arg0.paused_at + arg0.gov_cooldowns.emergency_cooldown, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_emergency_cooldown_not_met());
        ...
        assert!(v0 >= v1, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_insufficient_funds());
    ...
    public fun execute_swap<T0, T1>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamProcessorCap, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        require_not_paused<T0>(arg0);
        assert!(arg2 > 0, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_zero_amount());
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = 0x1::type_name::with_defining_ids<T1>();
        assert!(v0 != v1, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_swap_tokens_must_differ());
        assert!(0x1::option::is_some<address>(&arg0.aggregator), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_aggregator_not_set());
        assert!(token_allowed<T0>(arg0, v0), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_token_not_allowed());
        assert!(token_allowed<T0>(arg0, v1), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_token_not_allowed());
        let v2 = now_secs(arg4);
        maybe_reset_daily<T0>(arg0, v2);
        check_processor_limits<T0>(arg0, arg2, v2);
        assert!(0x2::balance::value<T0>(&arg0.underlying) >= arg2, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_insufficient_funds());
    ...
    public fun pause<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0>(arg0, arg1, arg3);
        assert!(!arg0.paused, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_already_paused());
        arg0.paused = true;
        arg0.paused_at = now_secs(arg2);
    ...
    public fun propose_adapter<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, AdapterBinding>(&arg0.adapters, arg2)) {
            ...
            assert!(v0.status != 1, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_adapter_already_allowed());
            assert!(v0.status != 0, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_adapter_already_pending());
        };
    ...
    public fun propose_aggregator<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert_manager<T0>(arg0, arg1, arg4);
        assert!(0x1::option::is_none<PendingAddress>(&arg0.pending_aggregator), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_config_unchanged());
        let v0 = now_secs(arg3);
    ...
    public fun propose_cctp_messenger<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert_manager<T0>(arg0, arg1, arg4);
        assert!(0x1::option::is_none<PendingAddress>(&arg0.pending_token_messenger_minter), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_config_unchanged());
        let v0 = now_secs(arg3);
        let v1 = PendingAddress{
            value       : arg2,
            proposed_at : v0,
    ...
    public fun propose_limits<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        ...
        assert!(v0, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_no_limits_changes());
        if (0x1::option::is_some<u64>(&arg2)) {
            assert!(*0x1::option::borrow<u64>(&arg2) <= 1000000000000000000, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_invalid_limit());
        };
        if (0x1::option::is_some<u64>(&arg3)) {
            assert!(*0x1::option::borrow<u64>(&arg3) <= 1000000000000000000, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_invalid_limit());
        };
    ...
    public fun propose_manager<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(arg2 != arg0.manager, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_invalid_manager());
        let v0 = now_secs(arg3);
        let v1 = PendingRole{
            value       : arg2,
            proposed_at : v0,
    ...
    public fun propose_processor<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert_manager<T0>(arg0, arg1, arg4);
        assert!(arg2 != @0x0, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::invalid_argument());
        assert!(arg2 != arg0.processor, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_invalid_processor());
        let v0 = now_secs(arg3);
        let v1 = PendingRole{
            value       : arg2,
            proposed_at : v0,
    ...
    public fun propose_withdraw_destination<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(!v0, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_withdraw_destination_already_allowed());
        assert!(0x1::option::is_none<PendingAddress>(&arg0.pending_withdraw_destination), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_config_unchanged());
        let v1 = now_secs(arg3);
    ...
    public fun remove_withdraw_destination<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: address, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0>(arg0, arg1, arg3);
        assert!(0x2::table::contains<address, bool>(&arg0.withdraw_destinations, arg2) && *0x2::table::borrow<address, bool>(&arg0.withdraw_destinations, arg2), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_withdraw_destination_not_allowed());
    ...
    fun require_not_force_paused<T0>(arg0: &CrossChainAssetManager<T0>) {
        assert!(!arg0.force_paused, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_force_paused_by_admin());
    }
    ...
    fun return_to_proxy_internal<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg1 > 0, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_zero_amount());
        assert!(0x2::balance::value<T0>(&arg0.underlying) >= arg1, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_insufficient_funds());
    ...
    public fun send_via_cctp<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamProcessorCap, arg2: u64, arg3: u32, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        require_not_paused<T0>(arg0);
        assert!(arg2 > 0, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_zero_amount());
        assert!(arg4 != @0x0, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_invalid_mint_recipient());
        assert!(0x1::option::is_some<address>(&arg0.token_messenger_minter), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_cctp_messenger_not_set());
        assert!(0x2::table::contains<u32, CctpDestination>(&arg0.cctp_destinations, arg3), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_cctp_destination_not_allowed());
        let v0 = 0x2::table::borrow<u32, CctpDestination>(&arg0.cctp_destinations, arg3);
        assert!(v0.active && v0.recipient == arg4, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_cctp_destination_not_allowed());
    ...
    public fun set_cctp_destination<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: u32, arg3: address, arg4: bool, arg5: &0x2::tx_context::TxContext) {
        assert_manager<T0>(arg0, arg1, arg5);
        assert!(arg3 != @0x0, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_invalid_mint_recipient());
        if (arg4) {
    ...
    fun validate_cooldown(arg0: u64) {
        assert!(arg0 >= 60 && arg0 <= 604800, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_invalid_cooldown());
    }
    ...
    public fun withdraw<T0>(arg0: &mut CrossChainAssetManager<T0>, arg1: &CcamManagerCap, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg2 > 0, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_zero_amount());
        assert!(0x2::table::contains<address, bool>(&arg0.withdraw_destinations, arg3) && *0x2::table::borrow<address, bool>(&arg0.withdraw_destinations, arg3), 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_withdraw_destination_not_allowed());
        assert!(0x2::balance::value<T0>(&arg0.underlying) >= arg2, 0x7906af08486368060cc9c19de3ffd910b55a17d6255bc7fc9038f91c075a5190::stoken_errors::escrow_insufficient_funds());
