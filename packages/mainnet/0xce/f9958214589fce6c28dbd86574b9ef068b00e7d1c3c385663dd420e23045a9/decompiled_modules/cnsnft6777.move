module 0xcef9958214589fce6c28dbd86574b9ef068b00e7d1c3c385663dd420e23045a9::cnsnft6777 {
    struct CNSNFT6777 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6777, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6777>(arg0, arg1);
