module 0xcee8284a528a5c08f8a50ba5d53b62a044c7a0775c1b992847468ed28f64908d::suipaynft {
    ...
    fun mintInternal(arg0: &mut ContractInfo, arg1: u8, arg2: u16, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: bool, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        if (arg2 == 0) {
            arg2 = ((0xcee8284a528a5c08f8a50ba5d53b62a044c7a0775c1b992847468ed28f64908d::pseudorandom::rand_u32(arg8) % 65535) as u16);
        };
        ...
        if (arg7) {
            0x2::kiosk::place<NFT>(arg5, arg6, v16);
        } else {
            0x2::transfer::public_transfer<NFT>(v16, arg0.owner_address);
        };
