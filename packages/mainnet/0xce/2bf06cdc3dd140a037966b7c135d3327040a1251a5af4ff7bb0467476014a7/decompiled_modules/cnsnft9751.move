module 0xce2bf06cdc3dd140a037966b7c135d3327040a1251a5af4ff7bb0467476014a7::cnsnft9751 {
    struct CNSNFT9751 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9751, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9751>(arg0, arg1);
