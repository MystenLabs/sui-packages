module 0xce3b569b15c51835ea06133ccc683c24060f23b5475e555891cd79f5a942e82a::cnsnft4338 {
    struct CNSNFT4338 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4338, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4338>(arg0, arg1);
