module 0xe39b9ba59dd4c523df7a3a8d0eacf0e18576a88b38138b58ccbf1f0daa8aa64d::game {
    ...
    struct RepairConfigKey has copy, drop, store {
        dummy_field: bool,
    }

    struct RepairTableKey has copy, drop, store {
        dummy_field: bool,
    }

    struct TankDurability has store {
        last_repair_ms: u64,
        total_earned_at_last_repair: u64,
    }

    struct RepairConfig has store {
        enabled: bool,
        decay_period_ms: u64,
        fee_bps: u64,
        activated_at_ms: u64,
    ...
    struct TankRepaired has copy, drop {
        player: address,
        bub_cost: u64,
        bub_earned_since_repair: u64,
    }

    struct CosmeticBonusTableKey has copy, drop, store {
        dummy_field: bool,
    }

    struct CosmeticBonusAppliedKey has copy, drop, store {
        dummy_field: bool,
    }

    struct CosmeticBonus has copy, drop, store {
        bonus_type: u8,
        bonus_bps: u64,
    }

    struct PartnerClaimsKey has copy, drop, store {
        dummy_field: bool,
    }

    struct PartnerClaimsKeyV2 has copy, drop, store {
        dummy_field: bool,
    }

    struct PartnerPackClaimed has copy, drop {
        player: address,
        nft_id: address,
        tank_upgraded_to: u8,
        bubblers_minted: vector<u8>,
        cosmetic_type_id: u64,
    }
    ...
    entry fun admin_clear_cosmetic<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: u64, arg3: &0x2::clock::Clock) {
        ...
        if (0x2::table::contains<address, PlayerTank>(&arg0.player_tanks, v1)) {
            ensure_repair_record<T0, T1>(arg0, v1, v2);
            let v3 = calculate_pending_rewards_v2<T0, T1>(arg0, 0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, v1), v1, v2);
    ...
    entry fun admin_init_cosmetic_bonus<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = CosmeticBonusTableKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists_<CosmeticBonusTableKey>(&arg0.id, v0), 300);
        let v1 = CosmeticBonusTableKey{dummy_field: false};
        0x2::dynamic_field::add<CosmeticBonusTableKey, 0x2::table::Table<u64, CosmeticBonus>>(&mut arg0.id, v1, 0x2::table::new<u64, CosmeticBonus>(arg2));
        let v2 = CosmeticBonusAppliedKey{dummy_field: false};
        0x2::dynamic_field::add<CosmeticBonusAppliedKey, 0x2::table::Table<u64, u64>>(&mut arg0.id, v2, 0x2::table::new<u64, u64>(arg2));
    }

    entry fun admin_init_partner_claims<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = PartnerClaimsKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists_<PartnerClaimsKey>(&arg0.id, v0), 401);
        let v1 = PartnerClaimsKey{dummy_field: false};
        0x2::dynamic_field::add<PartnerClaimsKey, 0x2::table::Table<address, bool>>(&mut arg0.id, v1, 0x2::table::new<address, bool>(arg2));
    }

    entry fun admin_init_partner_claims_v2<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = PartnerClaimsKeyV2{dummy_field: false};
        assert!(!0x2::dynamic_field::exists_<PartnerClaimsKeyV2>(&arg0.id, v0), 401);
        let v1 = PartnerClaimsKeyV2{dummy_field: false};
        0x2::dynamic_field::add<PartnerClaimsKeyV2, 0x2::table::Table<address, bool>>(&mut arg0.id, v1, 0x2::table::new<address, bool>(arg2));
    }
    ...
    entry fun admin_init_repair_system<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = RepairConfigKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists_<RepairConfigKey>(&arg0.id, v0), 204);
        assert!(arg2 > 0, 7);
        assert!(arg3 <= 10000, 7);
        let v1 = RepairConfigKey{dummy_field: false};
        let v2 = RepairConfig{
            enabled         : true,
            decay_period_ms : arg2,
            fee_bps         : arg3,
            activated_at_ms : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::dynamic_field::add<RepairConfigKey, RepairConfig>(&mut arg0.id, v1, v2);
        let v3 = RepairTableKey{dummy_field: false};
        0x2::dynamic_field::add<RepairTableKey, 0x2::table::Table<address, TankDurability>>(&mut arg0.id, v3, 0x2::table::new<address, TankDurability>(arg5));
    }
    ...
    entry fun admin_remove_cosmetic_bonus<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: u64) {
        let v0 = CosmeticBonusTableKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<CosmeticBonusTableKey, 0x2::table::Table<u64, CosmeticBonus>>(&mut arg0.id, v0);
        if (0x2::table::contains<u64, CosmeticBonus>(v1, arg2)) {
            0x2::table::remove<u64, CosmeticBonus>(v1, arg2);
        };
    }

    entry fun admin_remove_partner_claims_v1<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap) {
        let v0 = PartnerClaimsKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<PartnerClaimsKey>(&arg0.id, v0), 400);
        let v1 = PartnerClaimsKey{dummy_field: false};
        0x2::table::destroy_empty<address, bool>(0x2::dynamic_field::remove<PartnerClaimsKey, 0x2::table::Table<address, bool>>(&mut arg0.id, v1));
    }
    ...
    entry fun admin_repair_player<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: address, arg3: &0x2::clock::Clock) {
        let v0 = if (0x2::table::contains<address, PlayerTank>(&arg0.player_tanks, arg2)) {
            0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, arg2).total_earned
        } else {
            0
        };
        let v1 = RepairTableKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow_mut<RepairTableKey, 0x2::table::Table<address, TankDurability>>(&mut arg0.id, v1);
        if (0x2::table::contains<address, TankDurability>(v2, arg2)) {
            let v3 = 0x2::table::borrow_mut<address, TankDurability>(v2, arg2);
            v3.last_repair_ms = 0x2::clock::timestamp_ms(arg3);
            v3.total_earned_at_last_repair = v0;
        } else {
            let v4 = TankDurability{
                last_repair_ms              : 0x2::clock::timestamp_ms(arg3),
                total_earned_at_last_repair : v0,
            };
            0x2::table::add<address, TankDurability>(v2, arg2, v4);
        };
    }

    entry fun admin_set_cosmetic_bonus<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: u64, arg3: u8, arg4: u64) {
        assert!(arg3 <= 2, 7);
        assert!(arg4 <= 5000, 7);
        let v0 = CosmeticBonusTableKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<CosmeticBonusTableKey, 0x2::table::Table<u64, CosmeticBonus>>(&mut arg0.id, v0);
        if (0x2::table::contains<u64, CosmeticBonus>(v1, arg2)) {
            let v2 = 0x2::table::borrow_mut<u64, CosmeticBonus>(v1, arg2);
            v2.bonus_type = arg3;
            v2.bonus_bps = arg4;
        } else {
            let v3 = CosmeticBonus{
                bonus_type : arg3,
                bonus_bps  : arg4,
            };
            0x2::table::add<u64, CosmeticBonus>(v1, arg2, v3);
        };
    }
    ...
    entry fun admin_set_repair_config<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: bool, arg3: u64, arg4: u64) {
        assert!(arg3 > 0, 7);
        assert!(arg4 <= 10000, 7);
        let v0 = RepairConfigKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<RepairConfigKey, RepairConfig>(&mut arg0.id, v0);
        v1.enabled = arg2;
        v1.decay_period_ms = arg3;
        v1.fee_bps = arg4;
    }
    ...
    entry fun admin_update_cosmetic_metadata<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: u64, arg3: vector<u8>, arg4: vector<u8>) {
        assert!(0x2::table::contains<u64, CosmeticType>(&arg0.cosmetic_types, arg2), 1);
        let v0 = 0x2::table::borrow_mut<u64, CosmeticType>(&mut arg0.cosmetic_types, arg2);
    ...
    fun calculate_pending_rewards_v2<T0, T1>(arg0: &GameState<T0, T1>, arg1: &PlayerTank, arg2: address, arg3: u64) : u64 {
        if (arg1.total_pressure == 0 || arg0.total_network_pressure == 0) {
            return 0
        };
        let v0 = RepairConfigKey{dummy_field: false};
        let v1 = if (0x2::dynamic_field::exists_<RepairConfigKey>(&arg0.id, v0)) {
            let v2 = RepairConfigKey{dummy_field: false};
            let v3 = 0x2::dynamic_field::borrow<RepairConfigKey, RepairConfig>(&arg0.id, v2);
            let v4 = if (v3.enabled) {
                let v5 = RepairTableKey{dummy_field: false};
                0x2::dynamic_field::exists_<RepairTableKey>(&arg0.id, v5)
            } else {
                false
            };
            if (v4) {
                let v6 = RepairTableKey{dummy_field: false};
                let v7 = 0x2::dynamic_field::borrow<RepairTableKey, 0x2::table::Table<address, TankDurability>>(&arg0.id, v6);
                if (0x2::table::contains<address, TankDurability>(v7, arg2)) {
                    let v8 = 0x2::table::borrow<address, TankDurability>(v7, arg2).last_repair_ms + v3.decay_period_ms;
                    if (arg3 > v8) {
                        v8
                    } else {
                        arg3
        ...
        if (v1 <= arg1.last_claim_time) {
            return 0
        };
        let v9 = ((((((calculate_current_emission<T0, T1>(arg0, arg3) as u128) * ((v1 - arg1.last_claim_time) as u128) / (86400000 as u128)) as u64) as u128) * (arg1.total_pressure as u128) / (arg0.total_network_pressure as u128)) as u64);
        let v10 = 20000000000000000 - arg0.total_minted;
        if (v9 > v10) {
            v10
        } else {
            v9
    ...
    entry fun claim_partner_pack<T0, T1, T2: key>(arg0: &mut GameState<T0, T1>, arg1: &T2, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        do_claim_partner_pack<T0, T1>(arg0, 0x2::object::id_address<T2>(arg1), arg2, arg3);
    }

    public fun claim_partner_pack_kiosk<T0, T1, T2: store + key>(arg0: &mut GameState<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::kiosk::borrow_val<T2>(arg1, arg2, 0x2::object::id_from_address(arg3));
        let v2 = v0;
        do_claim_partner_pack<T0, T1>(arg0, 0x2::object::id_address<T2>(&v2), arg4, arg5);
        0x2::kiosk::return_val<T2>(arg1, v2, v1);
    }
    ...
    entry fun claim_rewards<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &mut MintVault<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        ensure_repair_record<T0, T1>(arg0, v0, v1);
        let v2 = 0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, v0);
        let v3 = calculate_pending_rewards_v2<T0, T1>(arg0, v2, v0, v1) + v2.unclaimed_rewards;
        assert!(v3 > 0, 20);
    ...
    entry fun display_cosmetic<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &BubbleCosmetic, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::clock::timestamp_ms(arg2);
        ensure_repair_record<T0, T1>(arg0, v0, v1);
        let v2 = calculate_pending_rewards_v2<T0, T1>(arg0, 0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, v0), v0, v1);
    ...
    entry fun display_cosmetic_v4<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &mut CosmeticVault, arg2: BubbleCosmetic, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 6);
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x2::table::contains<address, PlayerTank>(&arg0.player_tanks, v0), 10);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        ...
        assert!(0x1::vector::length<u64>(&v4.displayed_cosmetic_ids) < get_tank_cosmetic_slots(v4.tier), 16);
        let v5 = arg2.cosmetic_instance_id;
        let v6 = arg2.cosmetic_type_id;
        assert!(!0x2::table::contains<u64, DisplayedCosmeticInfo>(&arg0.displayed_cosmetics, v5), 19);
        let v7 = if (0x2::table::contains<u64, CosmeticType>(&arg0.cosmetic_types, v6)) {
            let v8 = 0x2::table::borrow<u64, CosmeticType>(&arg0.cosmetic_types, v6);
            let v9 = 0;
            let v10 = 0;
            while (v10 < 0x1::vector::length<u64>(&v4.displayed_cosmetic_ids)) {
                let v11 = *0x1::vector::borrow<u64>(&v4.displayed_cosmetic_ids, v10);
                if (0x2::table::contains<u64, DisplayedCosmeticInfo>(&arg0.displayed_cosmetics, v11)) {
                    if (0x2::table::borrow<u64, DisplayedCosmeticInfo>(&arg0.displayed_cosmetics, v11).cosmetic_type_id == v6) {
                        v9 = v9 + 1;
                    };
                };
                v10 = v10 + 1;
            };
            assert!(v9 < v8.per_facility, 17);
            v8.bubble_pressure
        } else {
            arg2.bubble_pressure
        };
        let v12 = 0;
        let v13 = CosmeticBonusTableKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<CosmeticBonusTableKey>(&arg0.id, v13)) {
            let v14 = CosmeticBonusTableKey{dummy_field: false};
            let v15 = 0x2::dynamic_field::borrow<CosmeticBonusTableKey, 0x2::table::Table<u64, CosmeticBonus>>(&arg0.id, v14);
            if (0x2::table::contains<u64, CosmeticBonus>(v15, v6)) {
                let v16 = *0x2::table::borrow<u64, CosmeticBonus>(v15, v6);
                let v17 = 0;
                let v18 = 0;
                while (v18 < 0x1::vector::length<u64>(&v4.displayed_cosmetic_ids)) {
                    let v19 = *0x1::vector::borrow<u64>(&v4.displayed_cosmetic_ids, v18);
                    if (0x2::table::contains<u64, DisplayedCosmeticInfo>(&arg0.displayed_cosmetics, v19)) {
                        v17 = v17 + 0x2::table::borrow<u64, DisplayedCosmeticInfo>(&arg0.displayed_cosmetics, v19).bubble_pressure;
                    };
                    v18 = v18 + 1;
                };
                let v20 = if (v4.total_pressure > v17) {
                    v4.total_pressure - v17
                } else {
                    0
                };
                if (v16.bonus_type == 0 || v16.bonus_type == 2) {
                    v12 = (((v20 as u128) * (v16.bonus_bps as u128) / (10000 as u128)) as u64);
                };
            };
        };
        let v21 = v7 + v12;
        let v22 = DisplayedCosmeticInfo{
            owner            : v0,
            cosmetic_type_id : v6,
            bubble_pressure  : v21,
        };
        0x2::table::add<u64, DisplayedCosmeticInfo>(&mut arg0.displayed_cosmetics, v5, v22);
        let v23 = if (v12 > 0) {
            let v24 = CosmeticBonusAppliedKey{dummy_field: false};
            0x2::dynamic_field::exists_<CosmeticBonusAppliedKey>(&arg0.id, v24)
        } else {
            false
        };
        if (v23) {
            let v25 = CosmeticBonusAppliedKey{dummy_field: false};
            let v26 = 0x2::dynamic_field::borrow_mut<CosmeticBonusAppliedKey, 0x2::table::Table<u64, u64>>(&mut arg0.id, v25);
            if (0x2::table::contains<u64, u64>(v26, v5)) {
                *0x2::table::borrow_mut<u64, u64>(v26, v5) = v12;
            } else {
                0x2::table::add<u64, u64>(v26, v5, v12);
            };
        };
        0x2::table::add<u64, BubbleCosmetic>(&mut arg1.cosmetics, v5, arg2);
        let v27 = 0x2::table::borrow_mut<address, PlayerTank>(&mut arg0.player_tanks, v0);
        0x1::vector::push_back<u64>(&mut v27.displayed_cosmetic_ids, v5);
        v27.total_pressure = v27.total_pressure + v21;
        arg0.total_network_pressure = arg0.total_network_pressure + v21;
    }

    fun do_claim_partner_pack<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 6);
        let v0 = PartnerClaimsKeyV2{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<PartnerClaimsKeyV2>(&arg0.id, v0), 400);
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = PartnerClaimsKeyV2{dummy_field: false};
        let v3 = 0x2::dynamic_field::borrow_mut<PartnerClaimsKeyV2, 0x2::table::Table<address, bool>>(&mut arg0.id, v2);
        assert!(!0x2::table::contains<address, bool>(v3, arg1), 402);
        assert!(!0x2::table::contains<address, bool>(v3, v1), 402);
        0x2::table::add<address, bool>(v3, arg1, true);
        0x2::table::add<address, bool>(v3, v1, true);
        if (!0x2::table::contains<address, PlayerTank>(&arg0.player_tanks, v1)) {
            ...
            let v6 = PlayerTank{
                ...
                total_tank_pressure    : 0,
                upgrade_levels         : v4,
                last_claim_time        : 0x2::clock::timestamp_ms(arg2),
                total_earned           : 0,
                unclaimed_rewards      : 0,
                referrer               : @0x0,
                has_referrer           : false,
            };
            0x2::table::add<address, PlayerTank>(&mut arg0.player_tanks, v1, v6);
            arg0.total_players = arg0.total_players + 1;
        };
        let v7 = 0x2::table::borrow_mut<address, PlayerTank>(&mut arg0.player_tanks, v1);
        if (v7.tier < 4) {
            v7.tier = 4;
            v7.last_upgrade_time = 0x2::clock::timestamp_ms(arg2);
        };
        let v8 = x"030507";
        let v9 = 0x1::vector::empty<u8>();
        let v10 = 0;
        while (v10 < 0x1::vector::length<u8>(&v8)) {
            let v11 = *0x1::vector::borrow<u8>(&v8, v10);
            let (v12, v13, _, v15, v16) = get_bubbler_stats(v11);
            let v17 = arg0.next_bubbler_id;
            arg0.next_bubbler_id = v17 + 1;
            let v18 = BubbleGenerator{
                ...
                tank_pressure   : v13,
                image_url       : v16,
                attributes      : make_bubbler_attrs(v11, v15),
            };
            0x2::transfer::public_transfer<BubbleGenerator>(v18, v1);
            0x1::vector::push_back<u8>(&mut v9, v11);
            v10 = v10 + 1;
        };
        let v19 = 18;
        assert!(0x2::table::contains<u64, CosmeticType>(&arg0.cosmetic_types, v19), 1);
        let v20 = 0x2::table::borrow_mut<u64, CosmeticType>(&mut arg0.cosmetic_types, v19);
        let v21 = v20.name;
        let v22 = v20.bubble_pressure;
        v20.minted = v20.minted + 1;
        let v23 = arg0.next_cosmetic_instance_id;
        arg0.next_cosmetic_instance_id = v23 + 1;
        let v24 = BubbleCosmetic{
            id                   : 0x2::object::new(arg3),
            cosmetic_instance_id : v23,
            cosmetic_type_id     : v19,
            name                 : v21,
            bubble_pressure      : v22,
            image_url            : v20.image_url,
            attributes           : make_cosmetic_attrs(v21),
        };
        0x2::transfer::public_transfer<BubbleCosmetic>(v24, v1);
        let v25 = PartnerPackClaimed{
            player           : v1,
            nft_id           : arg1,
            tank_upgraded_to : 4,
            bubblers_minted  : v9,
        ...
        0x2::event::emit<PartnerPackClaimed>(v25);
    }
    ...
    fun ensure_repair_record<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: address, arg2: u64) {
        let v0 = RepairConfigKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<RepairConfigKey>(&arg0.id, v0)) {
            return
        };
        let v1 = RepairConfigKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow<RepairConfigKey, RepairConfig>(&arg0.id, v1);
        if (!v2.enabled) {
            return
        };
        let v3 = RepairTableKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<RepairTableKey>(&arg0.id, v3)) {
            return
        };
        let v4 = v2.activated_at_ms;
        let (v5, v6) = if (0x2::table::contains<address, PlayerTank>(&arg0.player_tanks, arg1)) {
            let v7 = 0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, arg1);
            (v7.total_earned, v7.last_claim_time)
        } else {
            (0, 0)
        };
        let v8 = if (v6 >= v4) {
        ...
        let v9 = RepairTableKey{dummy_field: false};
        let v10 = 0x2::dynamic_field::borrow_mut<RepairTableKey, 0x2::table::Table<address, TankDurability>>(&mut arg0.id, v9);
        if (!0x2::table::contains<address, TankDurability>(v10, arg1)) {
            let v11 = TankDurability{
                last_repair_ms              : v8,
                total_earned_at_last_repair : v5,
            };
            0x2::table::add<address, TankDurability>(v10, arg1, v11);
        };
    }
    ...
    fun get_effective_durability<T0, T1>(arg0: &GameState<T0, T1>, arg1: address, arg2: u64) : u64 {
        let v0 = RepairConfigKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<RepairConfigKey>(&arg0.id, v0)) {
            return 10000
        };
        ...
        let v4 = RepairTableKey{dummy_field: false};
        let v5 = 0x2::dynamic_field::borrow<RepairTableKey, 0x2::table::Table<address, TankDurability>>(&arg0.id, v4);
        if (!0x2::table::contains<address, TankDurability>(v5, arg1)) {
            return 10000
        };
        if (arg2 >= 0x2::table::borrow<address, TankDurability>(v5, arg1).last_repair_ms + v2.decay_period_ms) {
            0
        } else {
            10000
        }
    ...
    fun get_fusion_costs(arg0: u8) : (u64, u64, u64) {
        if (arg0 == 0) {
            (800000000, 25000000000000, 500000000)
        } else if (arg0 == 1) {
            (1600000000, 25000000000000, 500000000)
        } else if (arg0 == 2) {
            (2400000000, 25000000000000, 750000000)
        } else if (arg0 == 3) {
            (6800000000, 25000000000000, 750000000)
        } else if (arg0 == 4) {
            (15000000000, 25000000000000, 1000000000)
        } else if (arg0 == 5) {
            (25400000000, 25000000000000, 1000000000)
        } else if (arg0 == 6) {
            (59400000000, 25000000000000, 1250000000)
        } else if (arg0 == 7) {
            (117200000000, 25000000000000, 1500000000)
        } else if (arg0 == 8) {
            (204000000000, 25000000000000, 1750000000)
        } else if (arg0 == 9) {
            (510000000000, 25000000000000, 2000000000)
        } else if (arg0 == 10) {
            (680000000000, 50000000000000, 2500000000)
        } else {
            (1020000000000, 100000000000000, 3000000000)
        }
    }
    ...
    entry fun remove_cosmetic<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &BubbleCosmetic, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        ensure_repair_record<T0, T1>(arg0, v2, v3);
        let v4 = calculate_pending_rewards_v2<T0, T1>(arg0, 0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, v2), v2, v3);
    ...
    entry fun remove_cosmetic_v2<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &mut CosmeticVault, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::clock::timestamp_ms(arg3);
        ensure_repair_record<T0, T1>(arg0, v0, v2);
        let v3 = calculate_pending_rewards_v2<T0, T1>(arg0, 0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, v0), v0, v2);
    ...
    entry fun remove_cosmetic_v3<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &mut CosmeticVault, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 6);
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x2::table::contains<u64, DisplayedCosmeticInfo>(&arg0.displayed_cosmetics, arg2), 18);
        assert!(0x2::table::borrow<u64, DisplayedCosmeticInfo>(&arg0.displayed_cosmetics, arg2).owner == v0, 4);
        ...
        v5.total_pressure = v5.total_pressure - v1.bubble_pressure;
        arg0.total_network_pressure = arg0.total_network_pressure - v1.bubble_pressure;
        let v8 = CosmeticBonusAppliedKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<CosmeticBonusAppliedKey>(&arg0.id, v8)) {
            let v9 = CosmeticBonusAppliedKey{dummy_field: false};
            let v10 = 0x2::dynamic_field::borrow_mut<CosmeticBonusAppliedKey, 0x2::table::Table<u64, u64>>(&mut arg0.id, v9);
            if (0x2::table::contains<u64, u64>(v10, arg2)) {
                0x2::table::remove<u64, u64>(v10, arg2);
            };
        };
        if (0x2::table::contains<u64, BubbleCosmetic>(&arg1.cosmetics, arg2)) {
            0x2::transfer::public_transfer<BubbleCosmetic>(0x2::table::remove<u64, BubbleCosmetic>(&mut arg1.cosmetics, arg2), v0);
    ...
    entry fun repair_tank<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 6);
        let v0 = RepairConfigKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<RepairConfigKey>(&arg0.id, v0), 200);
        let v1 = RepairConfigKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow<RepairConfigKey, RepairConfig>(&arg0.id, v1);
        assert!(v2.enabled, 201);
        let v3 = v2.fee_bps;
        let v4 = 0x2::tx_context::sender(arg3);
        assert!(0x2::table::contains<address, PlayerTank>(&arg0.player_tanks, v4), 10);
        let v5 = 0x2::clock::timestamp_ms(arg2);
        assert!(get_effective_durability<T0, T1>(arg0, v4, v5) == 0, 202);
        let v6 = 0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, v4);
        assert!(calculate_pending_rewards_v2<T0, T1>(arg0, v6, v4, v5) == 0 && v6.unclaimed_rewards == 0, 203);
        let v7 = RepairTableKey{dummy_field: false};
        let v8 = 0x2::dynamic_field::borrow<RepairTableKey, 0x2::table::Table<address, TankDurability>>(&arg0.id, v7);
        let v9 = if (0x2::table::contains<address, TankDurability>(v8, v4)) {
            0x2::table::borrow<address, TankDurability>(v8, v4).total_earned_at_last_repair
        } else {
            0
        };
        let v10 = if (v6.total_earned > v9) {
            v6.total_earned - v9
        } else {
            0
        };
        let v11 = (((v10 as u128) * (v3 as u128) / (10000 as u128)) as u64);
        if (v11 > 0) {
            let v12 = process_bub_payment<T0>(arg1, v11, arg3);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v12, arg3), @0x0);
            arg0.total_burned = arg0.total_burned + v11;
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, v4);
        };
        let v13 = RepairTableKey{dummy_field: false};
        let v14 = 0x2::dynamic_field::borrow_mut<RepairTableKey, 0x2::table::Table<address, TankDurability>>(&mut arg0.id, v13);
        if (0x2::table::contains<address, TankDurability>(v14, v4)) {
            let v15 = 0x2::table::borrow_mut<address, TankDurability>(v14, v4);
            v15.last_repair_ms = v5;
            v15.total_earned_at_last_repair = v6.total_earned;
        } else {
            let v16 = TankDurability{
                last_repair_ms              : v5,
                total_earned_at_last_repair : v6.total_earned,
            };
            0x2::table::add<address, TankDurability>(v14, v4, v16);
        };
        0x2::table::borrow_mut<address, PlayerTank>(&mut arg0.player_tanks, v4).last_claim_time = v5;
        let v17 = TankRepaired{
            player                  : v4,
            bub_cost                : v11,
            bub_earned_since_repair : v10,
        };
        0x2::event::emit<TankRepaired>(v17);
    }
    ...
    entry fun stake_bubbler<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: BubbleGenerator, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<address, PlayerTank>(&arg0.player_tanks, v0), 10);
        let v3 = 0x2::clock::timestamp_ms(arg2);
        ensure_repair_record<T0, T1>(arg0, v0, v3);
        let v4 = calculate_pending_rewards_v2<T0, T1>(arg0, 0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, v0), v0, v3);
        let v5 = 0x2::table::borrow_mut<address, PlayerTank>(&mut arg0.player_tanks, v0);
        if (v4 > 0) {
            v5.unclaimed_rewards = v5.unclaimed_rewards + v4;
        };
