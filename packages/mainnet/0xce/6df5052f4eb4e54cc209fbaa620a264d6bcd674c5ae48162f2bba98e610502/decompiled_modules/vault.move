module 0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::vault {
    ...
    struct Treasury has key {
        id: 0x2::object::UID,
        rewardsTreasury: 0x2::balance::Balance<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>,
    ...
    public entry fun getReward(arg0: &mut UserState, arg1: &mut RewardState, arg2: &mut Treasury, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        *v1 = 0;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>>(0x2::coin::take<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>(&mut arg2.rewardsTreasury, *v1, arg4), 0x2::tx_context::sender(arg4));
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Treasury{
            id                  : 0x2::object::new(arg0),
            rewardsTreasury     : 0x2::balance::zero<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>(),
    ...
    public entry fun setRewardAmount(arg0: &AdminCap, arg1: 0x2::coin::Coin<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>, arg2: &mut UserState, arg3: &mut RewardState, arg4: &mut Treasury, arg5: &0x2::clock::Clock) {
        let v0 = 0x2::coin::value<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>(&arg1);
        ...
        0x2::balance::join<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>(&mut arg4.rewardsTreasury, 0x2::coin::into_balance<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>(arg1));
        ...
        assert!(arg3.rewardRate * arg3.duration <= 0x2::balance::value<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>(&arg4.rewardsTreasury), 103);
    ...
    public entry fun stake(arg0: 0x2::coin::Coin<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>, arg1: &mut UserState, arg2: &mut RewardState, arg3: &mut Treasury, arg4: &mut 0x2::coin::TreasuryCap<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = if (v1 == 0) {
            ...
            v2 * 0x2::balance::value<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>(&arg3.rewardsTreasury) / v1
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>>(0x2::coin::mint<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>(arg4, v3, arg6), v0);
    ...
    public entry fun withdraw(arg0: &mut UserState, arg1: &mut RewardState, arg2: &mut Treasury, arg3: &mut 0x2::coin::TreasuryCap<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        ...
        *v3 = *v3 - arg4;
        0x2::coin::burn<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>(arg3, 0x2::coin::take<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>(&mut arg2.rewardsTreasury, arg4 * 0x2::balance::value<0xce6df5052f4eb4e54cc209fbaa620a264d6bcd674c5ae48162f2bba98e610502::stpop::STPOP>(&arg2.rewardsTreasury) / v2, arg6));
