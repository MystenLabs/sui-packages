module 0xcee13a64a0344b8768313aea9faa59aafd0d80b356d3a29d77f51e229d3147b9::launchpad {
    ...
    public fun borrow<T0: store + key>(arg0: &Launchpad, arg1: 0x2::object::ID) : &T0 {
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::borrow_object<T0>(&arg0.buckets, arg1)
    }
    ...
    public fun borrow_mut<T0: drop, T1: store + key>(arg0: &T0, arg1: &mut Launchpad, arg2: 0x2::object::ID) : &mut T1 {
        ...
        0x1::vector::push_back<0x2::object::ID>(v1, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"borrow_role"));
        assert_anyone_match_for_witness(arg1, 0x1::type_name::get<T0>(), v0);
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::borrow_mut_object<T1>(&mut arg1.buckets, arg2)
    }

    fun assert_anyone_match_for_sender(arg0: &Launchpad, arg1: vector<0x2::object::ID>, arg2: &mut 0x2::tx_context::TxContext) {
        0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::assert_anyone_match_for_sender(&arg0.access, 0x2::tx_context::sender(arg2), arg1);
    }

    fun assert_anyone_match_for_witness(arg0: &Launchpad, arg1: 0x1::type_name::TypeName, arg2: vector<0x2::object::ID>) {
        0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::assert_anyone_match_for_witness(&arg0.access, arg1, arg2);
    }
    ...
    public entry fun grant_roles_for_witness<T0>(arg0: &mut Launchpad, arg1: vector<0x2::object::ID>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::grant_roles_for_witness<T0>(&mut arg0.access, arg1, arg2);
    }

    public fun has_role_for_witness(arg0: &Launchpad, arg1: 0x1::type_name::TypeName, arg2: 0x2::object::ID) : bool {
        0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::has_role_for_witness(&arg0.access, arg1, arg2)
    }
    ...
    public entry fun revoke_roles_for_witness<T0>(arg0: &mut Launchpad, arg1: vector<0x2::object::ID>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert_anyone_match_for_sender(arg0, v0, arg2);
        0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::revoke_roles_for_witness<T0>(&mut arg0.access, arg1);
    }

    public fun exists_object<T0: store + key>(arg0: &Launchpad, arg1: 0x2::object::ID) : bool {
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::exists_object<T0>(&arg0.buckets, arg1)
    }

    public fun get_object_id<T0: store + key>(arg0: &mut Launchpad, arg1: u64) : 0x2::object::ID {
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::get_object_id<T0>(&arg0.buckets, arg1)
    }
    ...
    public entry fun put<T0: store + key>(arg0: &mut Launchpad, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut v0;
        0x1::vector::push_back<0x2::object::ID>(v1, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"admin_role"));
        0x1::vector::push_back<0x2::object::ID>(v1, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"put_role"));
        assert_anyone_match_for_sender(arg0, v0, arg2);
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::put<T0>(&mut arg0.buckets, arg1, arg2);
    }
    ...
    public fun take<T0: store + key>(arg0: &mut Launchpad, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        let v1 = &mut v0;
        0x1::vector::push_back<0x2::object::ID>(v1, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"admin_role"));
        0x1::vector::push_back<0x2::object::ID>(v1, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"take_role"));
        assert_anyone_match_for_sender(arg0, v0, arg2);
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::take<T0>(&mut arg0.buckets, arg1, arg2)
    }
    ...
    public entry fun bind<T0: store + key>(arg0: &mut Launchpad, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut v0;
        0x1::vector::push_back<0x2::object::ID>(v1, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"admin_role"));
        0x1::vector::push_back<0x2::object::ID>(v1, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"bind_role"));
        assert_anyone_match_for_sender(arg0, v0, arg2);
        if (0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::exists_bucket<T0>(&arg0.id)) {
            0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::assert_empty_bucket<T0>(&arg0.id);
        };
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::put<T0>(&mut arg0.id, arg1, arg2);
    }

    public fun borrow_access(arg0: &Launchpad) : &0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::Access {
        &arg0.access
    }

    public fun borrow_bind<T0: store + key>(arg0: &Launchpad) : &T0 {
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::assert_not_empty_bucket<T0>(&arg0.id);
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::borrow_object<T0>(&arg0.id, 0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::get_object_id<T0>(&arg0.id, 0))
    }

    public fun borrow_mut_access<T0>(arg0: &T0, arg1: &mut Launchpad) : &mut 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::Access {
        assert_version(arg1);
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        let v1 = &mut v0;
        0x1::vector::push_back<0x2::object::ID>(v1, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"admin_role"));
        0x1::vector::push_back<0x2::object::ID>(v1, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"borrow_access_role"));
        assert_anyone_match_for_witness(arg1, 0x1::type_name::get<T0>(), v0);
        &mut arg1.access
    }
    ...
    public fun borrow_mut_bind<T0, T1: store + key>(arg0: &T0, arg1: &mut Launchpad) : &mut T1 {
        ...
        0x1::vector::push_back<0x2::object::ID>(v1, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"borrow_role"));
        assert_anyone_match_for_witness(arg1, 0x1::type_name::get<T0>(), v0);
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::assert_not_empty_bucket<T1>(&arg1.id);
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::borrow_mut_object<T1>(&mut arg1.id, 0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::get_object_id<T1>(&arg1.id, 0))
    }
    ...
    public fun bucket_size<T0: store + key>(arg0: &Launchpad) : u64 {
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::size<T0>(&arg0.buckets)
    }
    ...
    public fun has_role(arg0: &Launchpad, arg1: address, arg2: 0x2::object::ID) : bool {
        0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::has_role_for_sender(&arg0.access, arg1, arg2)
    }
    ...
    public fun init_launchpad<T0: drop>(arg0: &mut 0x2::package::Publisher, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) : Launchpad {
        assert_owner(arg0);
        let v0 = 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::init_access(arg2);
        *0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::borrow_mut_name(&mut v0) = 0x1::string::utf8(b"Access for launchpad");
        ...
        0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::grant_roles_for_witness<T0>(&mut v0, v1, arg2);
        let v2 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v2, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"admin_role"));
        0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::grant_roles_for_sender(&mut v0, 0x2::tx_context::sender(arg2), v2, arg2);
        let v3 = Launchpad{
    ...
    public entry fun migrate(arg0: &mut Launchpad, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"admin_role"));
    ...
    public fun unbind<T0: store + key>(arg0: &mut Launchpad, arg1: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        let v1 = &mut v0;
        0x1::vector::push_back<0x2::object::ID>(v1, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"admin_role"));
        0x1::vector::push_back<0x2::object::ID>(v1, 0x82041ef7e60f0ce619e206637c8d63c0dd22461f51d57988bdfb6cae9672bd86::access::to_role(b"unbind_role"));
        assert_anyone_match_for_sender(arg0, v0, arg1);
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::assert_not_empty_bucket<T0>(&arg0.id);
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::take<T0>(&mut arg0.id, 0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::get_object_id<T0>(&arg0.id, 0), arg1)
    }
