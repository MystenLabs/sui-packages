module 0xcee1715e3437b730073ebedab0f20a5a13ac6f5601d7d803571353d079fa8082::klaus {
    ...
    fun init(arg0: KLAUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<KLAUS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Klaus   ")))), trim_right(b"Klaus                           "), trim_right(b"Klaus is a meme coin inspired by the famous Klaus memecoin.                                                                                                                                                                                                                                                                     "), v2, arg1);
