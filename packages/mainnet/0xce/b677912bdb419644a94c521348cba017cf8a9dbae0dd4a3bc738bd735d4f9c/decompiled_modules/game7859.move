module 0xceb677912bdb419644a94c521348cba017cf8a9dbae0dd4a3bc738bd735d4f9c::game7859 {
    struct GAME7859 has drop {
        dummy_field: bool,
    }

    struct TICKET_7859 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7859(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7859>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7859>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME7859, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME7859>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7859>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7859>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7859>>(v5, 0x2::tx_context::sender(arg1));
    }
