module 0xce6e91231e8daed17e69cf1cc021131abd487f4ce71897b9172b2fe72df87c77::trump {
    ...
    fun init(arg0: TRUMP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/9Nu9hDDdBQXRhLPqhGENQwtT7zCDrTtwwuiX6x7vmKUx.png?size=lg&key=a454d0                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<TRUMP>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TRUMP   ")))), trim_right(b"UK's Fartcoin                   "), trim_right(b"Trump means Fart                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
