module 0xce8548ebe0ee7cd961459df186e2e4b8ca9c0f3e34ba4c9afbe70332cbc30593::reward4685 {
    struct REWARD4685 has drop {
        dummy_field: bool,
    }

    struct TICKET_4685 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4685(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_4685>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4685, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4685>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4685>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4685>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4685>>(v5, 0x2::tx_context::sender(arg1));
    }
