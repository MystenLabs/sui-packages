module 0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::typus_dov_single {
    ...
    struct Registry has key {
        id: 0x2::object::UID,
        num_of_vault: u64,
        authority: 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::Authority,
        fee_pool: 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::balance_pool::BalancePool,
    ...
    public(friend) fun activate_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let v6 = v1.config.active_vault_config.strike_increment;
        let v7 = 0x1::vector::empty<u64>();
        let v8 = 0x1::vector::length<PayoffConfig>(&v1.config.active_vault_config.payoff_configs);
        while (v8 > 0) {
            let v9 = 0x1::vector::borrow_mut<PayoffConfig>(&mut v1.config.active_vault_config.payoff_configs, v8 - 1);
            let v10 = calculate_strike(v4, v9.strike_bp, v6);
            let v11 = if (v1.info.option_type % 2 == 1 && v10 > v6) {
                v10 - v6
            } else {
                v10
            };
            0x1::option::fill<u64>(&mut v9.strike, v11);
            0x1::vector::push_back<u64>(&mut v7, v11);
            v8 = v8 - 1;
        };
        let v12 = calculate_max_auction_size(v1.info.o_token_decimal, v1.config.leverage, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_share_supply(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_share_supply(v3), calculate_max_loss_per_unit(v1.info.option_type, v4, v5, v1.info.d_token_decimal, v1.info.o_token_decimal, v1.config.active_vault_config.payoff_configs, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(2)), v1.config.bid_lot_size);
        let v13 = OracleInfo{
            price   : v4,
            decimal : v5,
        };
        v1.info.oracle_info = v13;
        let v14 = DeliveryInfos{
            round                     : v1.info.round,
            max_size                  : v12,
        ...
        v1.info.delivery_infos = v14;
        if (v12 == 0 || 0x2::clock::timestamp_ms(arg3) >= v1.info.expiration_ts_ms) {
            v1.info.status = 4;
            let v15 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_share_supply(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_share_supply(v3);
            if (v15 > 0) {
                let (_, _) = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::recoup<T0>(v3, v15, arg4);
            };
        } else {
            v1.info.status = 1;
        };
        let v18 = v1.info.settlement_base_name;
        let (v19, v20, v21) = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_date_from_ts(v1.info.expiration_ts_ms / 1000);
        0x1::string::append_utf8(&mut v18, b"-");
        0x1::string::append_utf8(&mut v18, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v21));
        0x1::string::append_utf8(&mut v18, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_month_short_string(v20));
        0x1::string::append_utf8(&mut v18, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v19));
        if (v1.info.period == 3) {
            0x1::string::append_utf8(&mut v18, b"-");
            0x1::string::append_utf8(&mut v18, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v1.info.expiration_ts_ms % 86400000 / 3600000));
            0x1::string::append_utf8(&mut v18, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v1.info.expiration_ts_ms % 3600000 / 60000));
        } else {
            0x1::vector::reverse<u64>(&mut v7);
            while (!0x1::vector::is_empty<u64>(&v7)) {
                0x1::string::append_utf8(&mut v18, b"-");
                0x1::string::append_utf8(&mut v18, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::u64_to_bytes(0x1::vector::pop_back<u64>(&mut v7), v5));
            };
        };
        if (v1.info.option_type == 0) {
            0x1::string::append_utf8(&mut v18, b"-Call");
        } else if (v1.info.option_type == 1) {
            0x1::string::append_utf8(&mut v18, b"-Put");
        } else if (v1.info.option_type == 2) {
            0x1::string::append_utf8(&mut v18, b"-CallSpread");
        } else if (v1.info.option_type == 3) {
            0x1::string::append_utf8(&mut v18, b"-PutSpread");
        } else if (v1.info.option_type == 4) {
            0x1::string::append_utf8(&mut v18, b"-CappedCall");
        } else if (v1.info.option_type == 5) {
            0x1::string::append_utf8(&mut v18, b"-CappedPut");
        } else if (v1.info.option_type == 6) {
            0x1::string::append_utf8(&mut v18, b"-UsdcCappedCall");
        };
        0x2::dynamic_object_field::add<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(&mut arg0.bid_vault_registry, arg1, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::new_bid_vault<T0, T1>(v1.info.index, v18, arg4));
        (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::activate<T0>(v3, v1.config.has_next, arg4), v12)
    }

    public(friend) fun auction_exists(arg0: &0x2::object::UID, arg1: u64) : bool {
        0x2::dynamic_object_field::exists_with_type<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::Auction>(arg0, arg1)
    }
    ...
    public(friend) fun calculate_in_usd<T0>(arg0: &PortfolioVault, arg1: u64, arg2: bool) : u64 {
        ...
        if (0x1::type_name::get<T0>() != arg0.info.settlement_base) {
            let v2 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v0);
            if (arg2) {
                (arg1 - arg1 % v2) / v2 + 1
            } else {
                arg1 / v2
            ...
            let v3 = (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v0) as u128) * (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(arg0.info.oracle_info.decimal) as u128);
    ...
    public(friend) fun calculate_max_auction_size(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(arg0) * arg1) as u128) * (arg2 as u128) / (arg3 as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(2) as u128)) as u64) / arg4 * arg4
    }
    ...
    public(friend) fun calculate_max_loss_per_unit(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: vector<PayoffConfig>, arg6: u64) : u64 {
        ...
        let v6 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::zero();
        while (!0x1::vector::is_empty<u64>(&v0)) {
            let v7 = calculate_portfolio_payoff_by_price(arg0, 0x1::vector::pop_back<u64>(&mut v0), arg2, arg3, arg5, arg6, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(arg4), arg4);
            if (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::compare(&v6, &v7) == 2) {
                v6 = v7;
            };
        };
        assert!(0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::is_neg(&v6), 14);
        let v8 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::neg(&v6);
        let v9 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::as_u64(&v8);
        assert!(v9 > 0, 14);
        v9
    }
    ...
    public(friend) fun calculate_option_payoff(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        if (arg0 % 2 == 0 && arg0 != 6) {
            if (arg1 >= arg3) {
                (((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(arg2) as u128) * ((arg1 - arg3) as u128) / (arg1 as u128)) as u64)
            } else {
                0
            }
        } else if (arg0 % 2 == 1) {
    ...
    public(friend) fun calculate_portfolio_payoff_by_price(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: vector<PayoffConfig>, arg5: u64, arg6: u64, arg7: u64) : 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::I64 {
        let v0 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::zero();
        while (!0x1::vector::is_empty<PayoffConfig>(&arg4)) {
            ...
            let v2 = if (v1.is_buyer) {
                0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::from(1)
            } else {
                0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::neg_from(1)
            };
            let v3 = v2;
            let v4 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::from((((calculate_option_payoff(arg0, arg1, arg2, *0x1::option::borrow<u64>(&v1.strike)) as u128) * (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(arg3) as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(arg2) as u128)) as u64));
            let v5 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::mul(&v4, &v3);
            let v6 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::from(v1.weight);
            let v7 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::mul(&v5, &v6);
            let v8 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::from(arg5);
            let v9 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::mul(&v7, &v8);
            let v10 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::from(0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(2));
            let v11 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::div(&v9, &v10);
            let v12 = &v0;
            v0 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::add(v12, &v11);
        };
        let v13 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::abs(&v0);
        if (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::is_neg(&v0)) {
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::neg_from((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::as_u64(&v13) as u128) * (arg6 as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(arg7) as u128)) as u64))
        } else {
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::from((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::as_u64(&v13) as u128) * (arg6 as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(arg7) as u128)) as u64))
        }
    }
    ...
    public(friend) fun close_(arg0: &mut Registry, arg1: u64) {
        ...
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::close(get_mut_deposit_vault(v1, arg1));
    }
    ...
    public(friend) fun create_scallop_spool_account_<T0>(arg0: &mut Registry, arg1: u64, arg2: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (address, address) {
        ...
        let v1 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::scallop::new_spool_account<T0>(arg2, arg3, arg4);
    ...
    public(friend) fun delivery_<T0, T1, T2>(arg0: &mut Registry, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        let (v10, v11, v12, v13, v14, v15, v16, v17) = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::delivery<T1>(v8, v7, take_auction(v9, arg1), arg2, arg3, arg4);
        let v18 = v11;
        let v19 = v10;
        ...
        let v21 = if (v1.config.deposit_incentive_bp > 0 && 0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&arg0.id, 0x1::type_name::get<T1>())) {
            ...
            let v24 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_u64_padding_value(&v1.config.u64_padding, 0);
            let v25 = v1.info.option_type % 2 == 0 && v1.info.option_type != 6;
            let v26 = if (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::match_types<T0, T1>()) {
                ((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_share_supply(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_share_supply(v3)) as u128) * (v1.config.deposit_incentive_bp as u128) / 10000 / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_u64_padding_value(&v1.config.u64_padding, 3)) as u128)) as u64)
            } else if (v25) {
                (((((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_share_supply(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_share_supply(v3)) as u128) * (v1.config.deposit_incentive_bp as u128) / 10000 / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_u64_padding_value(&v1.config.u64_padding, 3)) as u128)) as u64) as u128) * (v1.info.oracle_info.price as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.oracle_info.decimal) as u128) * (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.b_token_decimal) as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.d_token_decimal) as u128)) as u64)
            } else {
                (((((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_share_supply(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_share_supply(v3)) as u128) * (v1.config.deposit_incentive_bp as u128) / 10000 / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_u64_padding_value(&v1.config.u64_padding, 3)) as u128)) as u64) as u128) * (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.oracle_info.decimal) as u128) / (v1.info.oracle_info.price as u128) * (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.b_token_decimal) as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.d_token_decimal) as u128)) as u64)
            };
            let v27 = if (v26 > v23) {
                if (v23 > v24) {
                    v24
            ...
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut v1.config.u64_padding, 0, v24 - v27);
            v27
        } else {
            0
        };
        let v28 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_u64_padding_value(&v1.config.u64_padding, 2);
        if (v21 == 0 && v28 == 0) {
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::delivery<T0, T1>(v3, v5, v19);
        } else if (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::match_types<T1, T2>()) {
            ...
            if (v28 > 0) {
                ...
                0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut v1.config.u64_padding, 2, v31);
            };
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::delivery_b<T0, T1>(v3, v5, v19, v29, arg4);
        } else {
            if (v21 > 0) {
            ...
            let v32 = if (v28 > 0) {
                ...
                0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut v1.config.u64_padding, 2, v34);
                0x2::balance::split<T2>(v33, v28)
            } else {
                0x2::balance::zero<T2>()
            };
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::delivery_i<T0, T1, T2>(v3, v5, v19, v32, arg4);
        };
        if (0x2::balance::value<T1>(&v18) > 0) {
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut v1.config.u64_padding, 0, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_u64_padding_value(&v1.config.u64_padding, 0) + 0x2::balance::value<T1>(&v18));
    ...
    public(friend) fun deposit_scallop_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_u64_padding_value(&v0.config.u64_padding, 1) == 1, 36);
        let v1 = &mut arg0.deposit_vault_registry;
        let v2 = get_mut_deposit_vault(v1, arg1);
        let v3 = &mut arg0.additional_config_registry;
        let v4 = get_mut_additional_config(v3, arg1);
        assert!(0x2::dynamic_field::exists_with_type<vector<u8>, 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool_account::SpoolAccount<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&mut v4.id, b"scallop_spool_account"), 38);
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::scallop::deposit<T0>(v2, arg2, arg3, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool_account::SpoolAccount<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&mut v4.id, b"scallop_spool_account"), arg5, arg6)
    }
    ...
    public(friend) fun drop_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        ...
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::add_authorized_user(&mut v4, 0x2::tx_context::sender(arg2));
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::destroy(v4, arg2);
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::drop_deposit_vault<T0, T1>(0x2::dynamic_object_field::remove<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::DepositVault>(&mut arg0.deposit_vault_registry, arg1));
    }
    ...
    public(friend) fun fixed_incentivise_<T0>(arg0: &mut Registry, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64) : u64 {
        ...
        let v2 = 0x2::balance::value<T0>(0x2::dynamic_field::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&v1.id, 0x1::type_name::get<T0>()));
        let v3 = if (arg3 < v2) {
            arg3
        } else {
            v2
        };
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut v1.config.u64_padding, 2, v3);
    ...
    public(friend) fun get_auction(arg0: &0x2::object::UID, arg1: u64) : &0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::Auction {
        assert!(auction_exists(arg0, arg1), 1);
        0x2::dynamic_object_field::borrow<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::Auction>(arg0, arg1)
    }

    public(friend) fun get_bid_vault(arg0: &0x2::object::UID, arg1: u64) : &0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault {
        0x2::dynamic_object_field::borrow<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(arg0, arg1)
    }

    public(friend) fun get_bid_vault_by_id_or_index(arg0: &0x2::object::UID, arg1: &0x2::object::ID, arg2: u64) : &0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault {
        if (0x2::dynamic_object_field::exists_with_type<address, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(arg0, 0x2::object::id_to_address(arg1))) {
            0x2::dynamic_object_field::borrow<address, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(arg0, 0x2::object::id_to_address(arg1))
        } else {
            get_bid_vault(arg0, arg2)
        }
    }

    public(friend) fun get_deposit_vault(arg0: &0x2::object::UID, arg1: u64) : &0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::DepositVault {
        0x2::dynamic_object_field::borrow<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::DepositVault>(arg0, arg1)
    }
    ...
    public(friend) fun get_mut_auction(arg0: &mut 0x2::object::UID, arg1: u64) : &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::Auction {
        assert!(auction_exists(arg0, arg1), 1);
        0x2::dynamic_object_field::borrow_mut<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::Auction>(arg0, arg1)
    }

    public(friend) fun get_mut_bid_vault(arg0: &mut 0x2::object::UID, arg1: u64) : &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault {
        0x2::dynamic_object_field::borrow_mut<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(arg0, arg1)
    }

    public(friend) fun get_mut_bid_vault_by_id(arg0: &mut 0x2::object::UID, arg1: &0x2::object::ID) : &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault {
        0x2::dynamic_object_field::borrow_mut<address, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(arg0, 0x2::object::id_to_address(arg1))
    }

    public(friend) fun get_mut_deposit_vault(arg0: &mut 0x2::object::UID, arg1: u64) : &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::DepositVault {
        0x2::dynamic_object_field::borrow_mut<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::DepositVault>(arg0, arg1)
    }
    ...
    public(friend) fun get_mut_portfolio_vault_authority(arg0: &mut PortfolioVault) : &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::Authority {
        &mut arg0.authority
    }

    public(friend) fun get_mut_refund_vault<T0>(arg0: &mut 0x2::object::UID) : &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::RefundVault {
        0x2::dynamic_object_field::borrow_mut<0x1::type_name::TypeName, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::RefundVault>(arg0, 0x1::type_name::get<T0>())
    }

    public(friend) fun get_mut_registry_inner(arg0: &mut Registry) : (&mut 0x2::object::UID, &mut u64, &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::Authority, &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::balance_pool::BalancePool, &mut 0x2::object::UID, &mut 0x2::object::UID, &mut 0x2::object::UID, &mut 0x2::object::UID, &mut 0x2::object::UID, &mut 0x2::object::UID, &mut u64, &mut bool) {
    ...
    public(friend) fun get_new_bid_incentive_balance<T0>(arg0: &mut 0x2::object::UID, arg1: &mut PortfolioVault, arg2: &0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::Auction, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        if (arg1.config.bid_incentive_bp > 0 && 0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(arg0, 0x1::type_name::get<T0>())) {
            let (_, _, v3, v4) = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::get_bid_info(arg2, arg3, arg4, 0x2::clock::timestamp_ms(arg5));
            ...
            let v7 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_u64_padding_value(&arg1.config.u64_padding, 0);
            ...
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut arg1.config.u64_padding, 0, v7 - v8);
        };
        v0
    }
    ...
    public(friend) fun get_otc_incentive_balance<T0>(arg0: &mut 0x2::object::UID, arg1: &mut PortfolioVault, arg2: u64, arg3: u64, arg4: u64) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>) {
        ...
        if (0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(arg0, 0x1::type_name::get<T0>())) {
            ...
            let v4 = &mut v0;
            let v5 = request_incentive<T0>(v3, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_u64_padding_value(&arg1.config.u64_padding, 0), arg2, v4);
            let v6 = &mut v1;
            let v7 = request_incentive<T0>(v3, v5, arg3, v6);
            let v8 = &mut v2;
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut arg1.config.u64_padding, 0, request_incentive<T0>(v3, v7, arg4, v8));
        };
        (v0, v1, v2)
    }
    ...
    public(friend) fun get_portfolio_vault_authority(arg0: &PortfolioVault) : &0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::Authority {
        &arg0.authority
    }

    public(friend) fun get_refund_vault<T0>(arg0: &0x2::object::UID) : &0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::RefundVault {
        0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::RefundVault>(arg0, 0x1::type_name::get<T0>())
    }

    public(friend) fun get_registry_inner(arg0: &Registry) : (&0x2::object::UID, &u64, &0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::Authority, &0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::balance_pool::BalancePool, &0x2::object::UID, &0x2::object::UID, &0x2::object::UID, &0x2::object::UID, &0x2::object::UID, &0x2::object::UID, &u64, &bool) {
    ...
    public(friend) fun new_portfolio_vault_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: bool, arg26: vector<PayoffConfig>, arg27: u64, arg28: u64, arg29: u64, arg30: u64, arg31: vector<address>, arg32: &0x2::clock::Clock, arg33: &mut 0x2::tx_context::TxContext) : (u64, Info, Config) {
        ...
        let v13 = PortfolioVault{
            ...
            info      : v11,
            config    : v12,
            authority : 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::new(arg31, arg33),
        };
        ...
        0x2::dynamic_object_field::add<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::DepositVault>(&mut arg0.deposit_vault_registry, v7, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::new_deposit_vault<T0, T1>(v7, arg15, v14, arg33));
        ...
        if (!0x2::dynamic_object_field::exists_with_type<0x1::type_name::TypeName, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::RefundVault>(&arg0.refund_vault_registry, 0x1::type_name::get<T1>())) {
            0x2::dynamic_object_field::add<0x1::type_name::TypeName, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::RefundVault>(&mut arg0.refund_vault_registry, 0x1::type_name::get<T1>(), 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::new_refund_vault<T1>(arg33));
        };
    ...
    public(friend) fun new_registry_(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Registry{
            ...
            num_of_vault               : 0,
            authority                  : 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::new(0x1::vector::singleton<address>(0x2::tx_context::sender(arg0)), arg0),
            fee_pool                   : 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::balance_pool::new(0x1::vector::singleton<address>(0x2::tx_context::sender(arg0)), arg0),
    ...
    public(friend) fun otc_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: u64, arg4: 0x2::balance::Balance<T1>, arg5: 0x2::balance::Balance<T1>, arg6: 0x2::balance::Balance<T1>, arg7: 0x2::balance::Balance<T1>, arg8: 0x2::balance::Balance<T1>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!auction_exists(&arg0.auction_registry, arg1), 0);
        assert!(v1.info.status == 1 || v1.info.status == 3, 3);
        assert!((((arg2 as u128) * (arg3 as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.o_token_decimal) as u128)) as u64) <= 0x2::balance::value<T1>(&arg4) + 0x2::balance::value<T1>(&arg6), 2);
        let v6 = 0x2::balance::value<T1>(&arg5);
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::balance_pool::put<T1>(&mut arg0.fee_pool, arg5);
        let v7 = 0x2::balance::value<T1>(&arg7);
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::balance_pool::put<T1>(&mut arg0.fee_pool, arg7);
        ...
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::new_bid(v5, arg3, arg10);
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::delivery_b<T0, T1>(v3, v5, arg4, arg8, arg10);
    ...
    public(friend) fun recoup_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        v1.info.status = 4;
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::recoup<T0>(v3, ((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_share_supply(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_share_supply(v3)) as u128) * ((v1.info.delivery_infos.max_size - v1.info.delivery_infos.total_delivery_size) as u128) / (v1.info.delivery_infos.max_size as u128)) as u64), arg3)
    }

    public(friend) fun refund_vault_exists<T0>(arg0: &0x2::object::UID) : bool {
        0x2::dynamic_object_field::exists_with_type<0x1::type_name::TypeName, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::RefundVault>(arg0, 0x1::type_name::get<T0>())
    }
    ...
    public(friend) fun set_available_incentive_amount_(arg0: &mut Registry, arg1: u64, arg2: u64) : u64 {
        let v0 = &mut arg0.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg1);
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut v1.config.u64_padding, 0, arg2);
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_u64_padding_value(&v1.config.u64_padding, 0)
    }

    public(friend) fun set_enable_scallop_flag_(arg0: &mut Registry, arg1: u64, arg2: bool) {
        let v0 = &mut arg0.portfolio_vault_registry;
        if (arg2) {
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut get_mut_portfolio_vault(v0, arg1).config.u64_padding, 1, 1);
        } else {
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut get_mut_portfolio_vault(v0, arg1).config.u64_padding, 1, 0);
        };
    }
    ...
    public(friend) fun settle_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        let v8 = calculate_portfolio_payoff_by_price(v1.info.option_type, v6, v7, v1.info.d_token_decimal, v1.config.active_vault_config.payoff_configs, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(2), v1.info.delivery_infos.total_delivery_size, v1.info.o_token_decimal);
        let v9 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_balance<T0>(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_balance<T0>(v3);
        let v10 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::from(v9);
        let v11 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::add(&v10, &v8);
        let v12 = if (v9 != 0) {
            (((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(8) as u128) * (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::i64::as_u64(&v11) as u128) / (v9 as u128)) as u64)
        } else {
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(8)
        };
        let v13 = 8;
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::settle<T0, T1>(v3, v5, v12, v13, arg4);
        let v14 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_balance<T0>(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::inactive_balance<T0>(v3) - 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::inactive_balance<T0>(v3);
        ...
        if (v1.info.period == 0) {
            ...
            let (_, v17, _) = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_date_from_ts(v1.info.expiration_ts_ms / 1000 + 2419200);
            let (_, v20, _) = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_date_from_ts(v1.info.expiration_ts_ms / 1000 + 3024000);
            if (v17 != v20) {
        ...
        let v22 = 0x2::dynamic_object_field::remove<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(&mut arg0.bid_vault_registry, arg1);
        if (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::bid_share_supply(&v22) == 0) {
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::drop_bid_vault<T0>(v22);
        } else {
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::set_bid_vault_u64_padding_value(&mut v22, 0, v6);
            0x2::dynamic_object_field::add<address, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(&mut arg0.bid_vault_registry, 0x2::object::id_address<0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(&v22), v22);
        };
        (v6, v7, v9, v14, v12)
    }
    ...
    public(friend) fun take_auction(arg0: &mut 0x2::object::UID, arg1: u64) : 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::Auction {
        assert!(auction_exists(arg0, arg1), 1);
        0x2::dynamic_object_field::remove<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::Auction>(arg0, arg1)
    }
    ...
    public(friend) fun terminate_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        ...
        v1.info.status = 5;
        let v2 = &mut arg0.deposit_vault_registry;
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::terminate<T0>(get_mut_deposit_vault(v2, arg1), arg2);
    }
    ...
    public(friend) fun update_auction_config_(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: bool, arg12: &0x2::clock::Clock, arg13: &0x2::tx_context::TxContext) {
        ...
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::update_auction_config(get_mut_auction(v0, arg1), arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13);
    }
    ...
    public(friend) fun update_config_(arg0: &mut Registry, arg1: u64, arg2: 0x1::option::Option<address>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: 0x1::option::Option<u64>, arg8: 0x1::option::Option<u64>, arg9: 0x1::option::Option<u64>, arg10: 0x1::option::Option<u64>, arg11: 0x1::option::Option<0x1::option::Option<vector<u8>>>, arg12: 0x1::option::Option<u64>, arg13: 0x1::option::Option<u64>, arg14: 0x1::option::Option<u64>, arg15: 0x1::option::Option<u64>, arg16: 0x1::option::Option<u64>, arg17: 0x1::option::Option<u64>, arg18: 0x1::option::Option<u64>, arg19: 0x1::option::Option<u64>, arg20: 0x1::option::Option<u64>, arg21: 0x1::option::Option<u64>, arg22: &0x2::tx_context::TxContext) : (Config, Config) {
        ...
        if (0x1::option::is_some<u64>(&arg9)) {
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::update_fee(v3, 0x1::option::destroy_some<u64>(arg9), arg22);
        };
        ...
        if (0x1::option::is_some<u64>(&arg21)) {
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut v1.config.u64_padding, 3, 0x1::option::destroy_some<u64>(arg21));
        };
        (v1.config, v1.config)
    }
    ...
    public(friend) fun update_strike_(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock) : (u64, u64, VaultConfig) {
        ...
        let v5 = v3.config.active_vault_config.strike_increment;
        let v6 = 0x1::vector::length<PayoffConfig>(&v3.config.active_vault_config.payoff_configs);
        while (v6 > 0) {
            let v7 = 0x1::vector::borrow_mut<PayoffConfig>(&mut v3.config.active_vault_config.payoff_configs, v6 - 1);
            let v8 = calculate_strike(v0, v7.strike_bp, v5);
            let v9 = if (v3.info.option_type % 2 == 1 && v8 > v5) {
                v8 - v5
            } else {
                v8
            };
            0x1::option::swap<u64>(&mut v7.strike, v9);
            0x1::vector::push_back<u64>(&mut v4, v9);
            v6 = v6 - 1;
        };
        if (v3.info.period == 3) {
            let v10 = &mut arg0.bid_vault_registry;
            let v11 = v3.info.settlement_base_name;
            let (v12, v13, v14) = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_date_from_ts(v3.info.expiration_ts_ms / 1000);
            0x1::string::append_utf8(&mut v11, b"-");
            0x1::string::append_utf8(&mut v11, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v14));
            0x1::string::append_utf8(&mut v11, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_month_short_string(v13));
            0x1::string::append_utf8(&mut v11, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v12));
            0x1::string::append_utf8(&mut v11, b"-");
            0x1::string::append_utf8(&mut v11, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v3.info.expiration_ts_ms % 86400000 / 3600000));
            0x1::string::append_utf8(&mut v11, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v3.info.expiration_ts_ms % 3600000 / 60000));
            0x1::vector::reverse<u64>(&mut v4);
            while (!0x1::vector::is_empty<u64>(&v4)) {
                0x1::string::append_utf8(&mut v11, b"-");
                0x1::string::append_utf8(&mut v11, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::u64_to_bytes(0x1::vector::pop_back<u64>(&mut v4), v1));
            };
            if (v3.info.option_type == 0) {
                0x1::string::append_utf8(&mut v11, b"-Call");
            } else if (v3.info.option_type == 1) {
                0x1::string::append_utf8(&mut v11, b"-Put");
            } else if (v3.info.option_type == 2) {
                0x1::string::append_utf8(&mut v11, b"-CallSpread");
            } else if (v3.info.option_type == 3) {
                0x1::string::append_utf8(&mut v11, b"-PutSpread");
            } else if (v3.info.option_type == 4) {
                0x1::string::append_utf8(&mut v11, b"-CappedCall");
            } else if (v3.info.option_type == 5) {
                0x1::string::append_utf8(&mut v11, b"-CappedPut");
            } else if (v3.info.option_type == 6) {
                0x1::string::append_utf8(&mut v11, b"-UsdcCappedCall");
            };
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::update_bid_receipt_display(get_mut_bid_vault(v10, arg1), v11);
        };
        let v15 = v3.config.active_vault_config;
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut v15.u64_padding, 0, v3.info.round);
        (v0, v1, v15)
    }
    ...
    public(friend) fun validate_bid_amount(arg0: &PortfolioVault, arg1: &0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::Auction, arg2: u64) {
        assert!(arg2 >= arg0.config.bid_lot_size && arg2 % arg0.config.bid_lot_size == 0, 23);
        assert!(arg2 >= arg0.config.min_bid_size, 27);
        assert!(arg0.config.max_bid_entry == 0 || 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::dutch::bid_index(arg1) < arg0.config.max_bid_entry, 24);
    }

    public(friend) fun validate_capacity(arg0: &Registry, arg1: u64) {
        let v0 = get_portfolio_vault(&arg0.portfolio_vault_registry, arg1);
        let v1 = get_deposit_vault(&arg0.deposit_vault_registry, arg1);
        assert!(0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_share_supply(v1) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::warmup_share_supply(v1) <= v0.config.capacity, 26);
        let v2 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::get_deposit_shares(v1);
        assert!(v0.config.max_deposit_entry == 0 || 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::big_vector::length<0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::DepositShare>(v2) <= v0.config.max_deposit_entry, 25);
    }
    ...
    public(friend) fun validate_portfolio_authority(arg0: &Registry, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::double_verify(&arg0.authority, &get_portfolio_vault(&arg0.portfolio_vault_registry, arg1).authority, arg2);
    }

    public(friend) fun validate_registry_authority(arg0: &Registry, arg1: &0x2::tx_context::TxContext) {
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::authority::verify(&arg0.authority, arg1);
    }
    ...
    public(friend) fun withdraw_xxx_scallop_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg5: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::scallop::withdraw_xxx<T0>(&mut arg0.fee_pool, v1, 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x1::type_name::get<T0>()), arg2, arg3, arg4, arg5, 0x2::dynamic_field::borrow_mut<vector<u8>, 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool_account::SpoolAccount<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&mut get_mut_additional_config(v2, arg1).id, b"scallop_spool_account"), arg6, arg7)
    }
    ...
    public(friend) fun withdraw_xyx_scallop_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg5: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        let v1 = get_mut_deposit_vault(v0, arg1);
        let v2 = &mut arg0.additional_config_registry;
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::scallop::withdraw_xyx<T0>(&mut arg0.fee_pool, v1, 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x1::type_name::get<T0>()), arg2, arg3, arg4, arg5, 0x2::dynamic_field::borrow_mut<vector<u8>, 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool_account::SpoolAccount<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&mut get_mut_additional_config(v2, arg1).id, b"scallop_spool_account"), arg6, arg7)
    }
