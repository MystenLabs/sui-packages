module 0x7585869d87d845b2638f5f9c67d86e22c91ade50b07bfac7e187791dc80fb752::events {
    struct ConnectorCreated<phantom T0> has copy, drop {
        connector_id: 0x2::object::ID,
    }

    struct ConnectorCreatedV2<phantom T0> has copy, drop {
        connector_id: 0x2::object::ID,
    }

    struct ConnectorCreatedV3<phantom T0> has copy, drop {
        connector_id: 0x2::object::ID,
    }
    ...
    public fun emit_buy<T0>(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: address, arg6: bool, arg7: u64, arg8: u64, arg9: u64, arg10: u64) {
    ...
    public fun emit_complete<T0>(arg0: 0x2::object::ID) {
        let v0 = BondingCurveComplete<T0>{curve_id: arg0};
        0x2::event::emit<BondingCurveComplete<T0>>(v0);
    }

    public fun emit_connector_create<T0>(arg0: 0x2::object::ID) {
        let v0 = ConnectorCreated<T0>{connector_id: arg0};
        0x2::event::emit<ConnectorCreated<T0>>(v0);
    }

    public fun emit_connector_create_v2<T0>(arg0: 0x2::object::ID) {
        let v0 = ConnectorCreatedV2<T0>{connector_id: arg0};
        0x2::event::emit<ConnectorCreatedV2<T0>>(v0);
    }

    public fun emit_connector_create_v3<T0>(arg0: 0x2::object::ID) {
        let v0 = ConnectorCreatedV3<T0>{connector_id: arg0};
        0x2::event::emit<ConnectorCreatedV3<T0>>(v0);
    }

    public fun emit_curve_create<T0>(arg0: 0x2::object::ID, arg1: address, arg2: 0x1::string::String, arg3: 0x1::ascii::String, arg4: 0x1::string::String, arg5: 0x1::option::Option<0x2::url::Url>, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String) {
    ...
    public fun emit_migrate<T0>(arg0: 0x2::object::ID, arg1: 0x2::object::ID) {
    ...
    public fun emit_sell<T0>(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64) {
