module 0xbbda8e2341d0e829388d8dd227f801718aab143305442d663ca8fa014393325b::lp_manager {
    ...
    public fun withdraw_and_transfer_cetus_position_after_timeout_and(arg0: &mut LiquidityManager, arg1: &ManagerCap, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1);
        assert!(0x1::option::is_some<u64>(&arg0.timer), 2);
        assert!(0x2::clock::timestamp_ms(arg3) >= *0x1::option::borrow<u64>(&arg0.timer), 1);
        let v0 = CetusPositionKey{id: arg2};
        0x2::transfer::public_transfer<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(0x2::bag::remove<CetusPositionKey, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut arg0.fields, v0), 0x2::tx_context::sender(arg4));
    }

    public fun withdraw_and_transfer_cetus_position_as_admin(arg0: &mut LiquidityManager, arg1: &ManagerCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1);
        let v0 = CetusPositionKey{id: arg2};
        0x2::transfer::public_transfer<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(0x2::bag::remove<CetusPositionKey, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut arg0.fields, v0), 0x2::tx_context::sender(arg3));
    }

    public fun withdraw_and_transfer_turbos_position_after_timeout(arg0: &mut LiquidityManager, arg1: &ManagerCap, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1);
        assert!(0x1::option::is_some<u64>(&arg0.timer), 2);
        assert!(0x2::clock::timestamp_ms(arg3) >= *0x1::option::borrow<u64>(&arg0.timer), 1);
        let v0 = TurbosPositionKey{id: arg2};
        0x2::transfer::public_transfer<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(0x2::bag::remove<TurbosPositionKey, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(&mut arg0.fields, v0), 0x2::tx_context::sender(arg4));
    }

    public fun withdraw_and_transfer_turbos_position_as_admin(arg0: &mut LiquidityManager, arg1: &ManagerCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1);
        let v0 = TurbosPositionKey{id: arg2};
        0x2::transfer::public_transfer<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(0x2::bag::remove<TurbosPositionKey, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(&mut arg0.fields, v0), 0x2::tx_context::sender(arg3));
    }
