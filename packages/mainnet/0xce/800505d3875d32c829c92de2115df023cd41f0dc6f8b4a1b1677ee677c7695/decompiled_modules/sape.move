module 0xce800505d3875d32c829c92de2115df023cd41f0dc6f8b4a1b1677ee677c7695::sape {
    ...
    fun init(arg0: SAPE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<SAPE>>(0x2::coin::from_balance<SAPE>(0x2::balance::increase_supply<SAPE>(&mut v2, 10000000000000000000), arg1), 0x2::tx_context::sender(arg1));
