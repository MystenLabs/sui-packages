module 0xcef7cc99d12735a698c7d5e6369e728e2faf606bbd74b52baff4681909be07ea::gift7067 {
    struct GIFT7067 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift7067(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT7067, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7067>(arg0, arg1);
