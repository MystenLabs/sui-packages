module 0xcefad1be5e88bc360fb8ebe980871b7b628abb8422cde6d90f920e364e98e8f9::cnsnft5612 {
    struct CNSNFT5612 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5612, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5612>(arg0, arg1);
