module 0xce466e4a54bec4a2dc34dc6f19b6a371947f4aa930ca5318e71ddcdb46789da4::collection {
    ...
    public fun create_with_mint_cap<T0: drop, T1>(arg0: &T0, arg1: 0x1::option::Option<u64>, arg2: &mut 0x2::tx_context::TxContext) : (Collection<T1>, 0xce466e4a54bec4a2dc34dc6f19b6a371947f4aa930ca5318e71ddcdb46789da4::mint_cap::MintCap<T1>) {
        let v0 = create_from_otw<T0, T1>(arg0, arg2);
        (v0, 0xce466e4a54bec4a2dc34dc6f19b6a371947f4aa930ca5318e71ddcdb46789da4::mint_cap::new<T0, T1>(arg0, 0x2::object::id<Collection<T1>>(&v0), arg1, arg2))
    }
