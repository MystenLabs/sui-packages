module 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market {
    ...
    public(friend) fun borrow<T0>(arg0: &mut Market, arg1: u64, arg2: &0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::oracle::Oracle, arg3: bool, arg4: &0x2::clock::Clock) : LiquidityPromise<T0> {
        assert!(arg0.coin_type == 0x1::type_name::get<T0>(), 5);
        refresh_with_price(arg0, arg2, arg4);
        if (!arg3) {
            verify_borrow_limit(arg0, arg1);
        };
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::flow_limiter::check_and_update(&mut arg0.outflow_limiter, arg1, arg4);
    ...
    public(friend) fun fulfill_promise_sui(arg0: &mut Market, arg1: LiquidityPromise<0x2::sui::SUI>, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        if (v5 > 0) {
            ...
            0x2::coin::join<0x2::sui::SUI>(&mut v4, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker::remove_stake(0x2::dynamic_field::borrow_mut<SuiStakingEnabledKey, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker::SuiStaker>(&mut arg0.id, v7), v5, arg2, false, arg4));
        };
    ...
    public(friend) fun remove_liquidity<T0>(arg0: &mut Market, arg1: 0x2::balance::Balance<XToken<T0>>, arg2: &0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::oracle::Oracle, arg3: &0x2::clock::Clock) : LiquidityPromise<T0> {
        ...
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::flow_limiter::check_and_update(&mut arg0.outflow_limiter, 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::to_u64(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::mul(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(0x2::balance::value<XToken<T0>>(&arg1)), arg0.xtoken_ratio)), arg3);
