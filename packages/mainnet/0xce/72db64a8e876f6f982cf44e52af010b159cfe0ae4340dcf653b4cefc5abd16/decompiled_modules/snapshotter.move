module 0xce72db64a8e876f6f982cf44e52af010b159cfe0ae4340dcf653b4cefc5abd16::snapshotter {
    struct BUT_TGE has drop {
        dummy_field: bool,
    }

    struct Simulation<phantom T0, phantom T1, phantom T2> has copy, drop {
        account: address,
        allocation: u64,
    }

    struct AirdropAllocation<phantom T0, phantom T1, phantom T2> has copy, drop {
        account: address,
        allocation: u64,
    }

    struct Snapshotter<phantom T0, phantom T1, phantom T2> has key {
        id: 0x2::object::UID,
        total_points: u64,
    ...
    public fun new<T0, T1, T2>(arg0: &0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::point::PointCenter<T0>, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Snapshotter<T0, T1, T2> {
    ...
    public fun create<T0, T1, T2>(arg0: &0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::point::PointCenter<T0>, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = new<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4);
        0x2::transfer::transfer<Snapshotter<T0, T1, T2>>(v0, 0x2::tx_context::sender(arg4));
    }

    public fun destroy<T0, T1, T2>(arg0: Snapshotter<T0, T1, T2>) {
        let Snapshotter {
            id                    : v0,
            total_points          : _,
            total_allocation      : _,
    ...
    public fun simulate<T0, T1, T2>(arg0: &mut Snapshotter<T0, T1, T2>, arg1: &0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::point::PointCenter<T0>, arg2: &0x2::clock::Clock, arg3: u64) {
        let v0 = 0;
        while (v0 < arg3 && 0x1::option::is_some<address>(&arg0.cursor)) {
            ...
            if (v2 > 0) {
                ...
                let v4 = Simulation<T0, T1, T2>{
                    account    : v1,
                    allocation : v3,
                };
                0x2::event::emit<Simulation<T0, T1, T2>>(v4);
    ...
    public fun snapshot<T0, T1, T2>(arg0: &mut Snapshotter<T0, T1, T2>, arg1: &mut 0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::point::PointCenter<T0>, arg2: &0x2::clock::Clock, arg3: &0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::privilege::Privilege<T0, BUT_TGE>, arg4: &mut 0x7043eeab02e5ce9e9272e6fdd0006759721f995e2026850683c3674bb519e13f::airdrop::AirdropPool<T1, T2>, arg5: u64, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < arg5 && 0x1::option::is_some<address>(&arg0.cursor)) {
            ...
            if (v3 > 0) {
                ...
                let v5 = AirdropAllocation<T0, T1, T2>{
                    account    : v1,
                    allocation : v4,
                };
                0x2::event::emit<AirdropAllocation<T0, T1, T2>>(v5);
                arg0.allocated_user = arg0.allocated_user + 1;
                arg0.cumulative_allocation = arg0.cumulative_allocation + v4;
                let v6 = BUT_TGE{dummy_field: false};
                0x2::transfer::public_transfer<0x7043eeab02e5ce9e9272e6fdd0006759721f995e2026850683c3674bb519e13f::airdrop::Eligibility>(0x7043eeab02e5ce9e9272e6fdd0006759721f995e2026850683c3674bb519e13f::airdrop::allocate<T1, T2>(arg4, v4, arg7), v1);
                if (arg6) {
