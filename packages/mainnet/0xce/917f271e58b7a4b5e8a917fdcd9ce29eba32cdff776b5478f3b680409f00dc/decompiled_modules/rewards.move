module 0x6e957f725baa33b6b8dd4bb543977ba1c00e1bb9dd4af6562f1f52c76378c372::rewards {
    ...
    struct RewardLocked<phantom T0> has copy, drop {
        order_id: vector<u8>,
        locked_reward_id: 0x2::object::ID,
        beneficiary: address,
        amount: u64,
        unlock_at_ms: u64,
        role: u64,
    ...
    public fun claim<T0>(arg0: LockedReward<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.beneficiary, 6);
        release_reward<T0>(arg0, arg1, arg2);
    }
    ...
    public fun create_release_cap(arg0: &AdminCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 != @0x0, 2);
        let v0 = ReleaseCap{id: 0x2::object::new(arg2)};
        0x2::transfer::transfer<ReleaseCap>(v0, arg1);
    }
    ...
    public fun distribute<T0>(arg0: &RewardConfig, arg1: 0x2::coin::Coin<T0>, arg2: address, arg3: address, arg4: address, arg5: address, arg6: vector<address>, arg7: address, arg8: vector<u8>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::clock::timestamp_ms(arg9) + arg0.lock_duration_ms;
        let v6 = &mut arg1;
        lock_share<T0>(v6, v2, arg3, arg7, arg8, v5, 2, 0, arg10);
        let v7 = &mut arg1;
        lock_share<T0>(v7, v3, arg4, arg7, arg8, v5, 3, 0, arg10);
        let v8 = &mut arg1;
        lock_share<T0>(v8, v4, arg5, arg7, arg8, v5, 4, 0, arg10);
        let v9 = 0;
        while (v9 < 8) {
            let v10 = bps_amount(v1, *0x1::vector::borrow<u64>(&arg0.upline_bps, v9));
            let v11 = resolved_recipient(*0x1::vector::borrow<address>(&arg6, v9), arg7);
            let v12 = &mut arg1;
            lock_share<T0>(v12, v10, v11, arg7, arg8, v5, 5, v9 + 1, arg10);
            let v13 = UplineRewardPaid<T0>{
                order_id  : arg8,
                level     : v9 + 1,
                recipient : v11,
                amount    : v10,
            };
            0x2::event::emit<UplineRewardPaid<T0>>(v13);
            v9 = v9 + 1;
        };
        lock_coin<T0>(arg1, arg2, arg8, v5, 1, 0, arg10);
        let v14 = DistributionCompleted<T0>{
            order_id                 : arg8,
            total_amount             : v1,
            consumer                 : arg2,
        ...
        0x2::event::emit<DistributionCompleted<T0>>(v14);
    }
    ...
    fun lock_coin<T0>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = LockedReward<T0>{
        ...
        let v1 = RewardLocked<T0>{
            order_id         : arg2,
            locked_reward_id : 0x2::object::id<LockedReward<T0>>(&v0),
            beneficiary      : arg1,
        ...
        0x2::event::emit<RewardLocked<T0>>(v1);
        0x2::transfer::share_object<LockedReward<T0>>(v0);
    }
    ...
    fun lock_share<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: u64, arg2: address, arg3: address, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        if (arg1 > 0) {
            let v0 = 0x2::coin::split<T0>(arg0, arg1, arg8);
            lock_coin<T0>(v0, resolved_recipient(arg2, arg3), arg4, arg5, arg6, arg7, arg8);
        };
    }
    ...
    public fun release<T0>(arg0: &ReleaseCap, arg1: LockedReward<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        release_reward<T0>(arg1, arg2, arg3);
    }

    fun release_reward<T0>(arg0: LockedReward<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let LockedReward {
            id           : v0,
            order_id     : v1,
            beneficiary  : v2,
