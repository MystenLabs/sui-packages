module 0xce9960ad201d475153a67c0b51e266c261dbbdc62a81e5010071a46489ed5438::cnsnft9699 {
    struct CNSNFT9699 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9699, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2144"));
        let v4 = 0x2::package::claim<CNSNFT9699>(arg0, arg1);
