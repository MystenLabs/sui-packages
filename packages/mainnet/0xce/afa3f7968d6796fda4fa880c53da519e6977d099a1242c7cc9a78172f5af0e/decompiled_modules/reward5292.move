module 0xceafa3f7968d6796fda4fa880c53da519e6977d099a1242c7cc9a78172f5af0e::reward5292 {
    struct REWARD5292 has drop {
        dummy_field: bool,
    }

    struct TICKET_5292 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5292(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5292>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5292>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5292, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5292>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5292>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5292>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5292>>(v5, 0x2::tx_context::sender(arg1));
    }
