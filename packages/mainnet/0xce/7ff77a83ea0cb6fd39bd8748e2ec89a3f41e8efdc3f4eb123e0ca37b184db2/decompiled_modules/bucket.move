module 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket {
    ...
    public(friend) fun handle_borrow<T0>(arg0: &mut Bucket<T0>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock, arg3: 0x2::balance::Balance<T0>, arg4: u64, arg5: 0x1::option::Option<address>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = if (bottle_exists<T0>(arg0, v0)) {
            ...
            v3 = v2 + 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::destroy_surplus_bottle(0x2::table::remove<address, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::Bottle>(&mut arg0.surplus_bottle_table, v0));
        ...
        let v7 = v4;
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::record_borrow(&mut v7, v3, arg4, arg6);
        ...
        if (v1) {
            0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket_events::emit_bottle_created<T0>(v0, &v7);
        } else {
            0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket_events::emit_bottle_updated<T0>(v0, &v7);
        };
        ...
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::insert(&mut arg0.bottle_table, v0, v7, arg5);
    }
    ...
    public(friend) fun handle_top_up<T0>(arg0: &mut Bucket<T0>, arg1: 0x2::balance::Balance<T0>, arg2: address, arg3: 0x1::option::Option<address>) {
        ...
        let v2 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::remove_bottle(&mut arg0.bottle_table, arg2);
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::record_top_up(&mut v2, 0x2::balance::value<T0>(&arg1));
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::update_stake_and_total_stake(&mut arg0.bottle_table, &mut v2);
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket_events::emit_bottle_updated<T0>(arg2, &v2);
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::insert(&mut arg0.bottle_table, arg2, v2, arg3);
