module 0x2faf45ddcc489dfbf85239301f7ecc3320c1d25fd0144a34cc85f615ceaab09b::genre {
    ...
    public entry fun update_symbol(arg0: &0x2::coin::TreasuryCap<GENRE>, arg1: &mut 0x2::coin::CoinMetadata<GENRE>, arg2: 0x1::ascii::String) {
        0x2::coin::update_symbol<GENRE>(arg0, arg1, arg2);
    }
    ...
    public entry fun update_url(arg0: &0x2::coin::TreasuryCap<GENRE>, arg1: &mut 0x2::coin::CoinMetadata<GENRE>, arg2: 0x1::ascii::String) {
        0x2::coin::update_icon_url<GENRE>(arg0, arg1, arg2);
    }
