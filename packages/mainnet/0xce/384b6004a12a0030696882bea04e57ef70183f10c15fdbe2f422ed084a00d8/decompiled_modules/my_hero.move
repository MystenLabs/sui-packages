module 0xce384b6004a12a0030696882bea04e57ef70183f10c15fdbe2f422ed084a00d8::my_hero {
    ...
    fun init(arg0: MY_HERO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = mint(0x1::string::utf8(b"Whaleme"), 0x1::string::utf8(b"QmfD3KnEbyjREGzHo7XKPcUpRd6eUyVZimvYnPNCqHGTua"), arg1);
