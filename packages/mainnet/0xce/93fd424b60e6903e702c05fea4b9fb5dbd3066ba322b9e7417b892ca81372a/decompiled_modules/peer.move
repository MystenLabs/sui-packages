module 0xce93fd424b60e6903e702c05fea4b9fb5dbd3066ba322b9e7417b892ca81372a::peer {
    struct Peer has store {
        ...
        token_decimals: u8,
        inbound_rate_limit: 0xce93fd424b60e6903e702c05fea4b9fb5dbd3066ba322b9e7417b892ca81372a::rate_limit::RateLimitState,
    }
    ...
    public fun borrow_inbound_rate_limit_mut(arg0: &mut Peer) : &mut 0xce93fd424b60e6903e702c05fea4b9fb5dbd3066ba322b9e7417b892ca81372a::rate_limit::RateLimitState {
    ...
    public fun new(arg0: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg1: u8, arg2: u64) : Peer {
        Peer{
            address            : arg0,
            token_decimals     : arg1,
            inbound_rate_limit : 0xce93fd424b60e6903e702c05fea4b9fb5dbd3066ba322b9e7417b892ca81372a::rate_limit::new(arg2),
        }
    }
