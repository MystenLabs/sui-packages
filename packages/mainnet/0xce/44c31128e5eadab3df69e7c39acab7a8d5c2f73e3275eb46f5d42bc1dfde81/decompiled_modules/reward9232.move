module 0xce44c31128e5eadab3df69e7c39acab7a8d5c2f73e3275eb46f5d42bc1dfde81::reward9232 {
    struct REWARD9232 has drop {
        dummy_field: bool,
    }

    struct TICKET_9232 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9232(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9232>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9232>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9232, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9232>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9232>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9232>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9232>>(v5, 0x2::tx_context::sender(arg1));
    }
