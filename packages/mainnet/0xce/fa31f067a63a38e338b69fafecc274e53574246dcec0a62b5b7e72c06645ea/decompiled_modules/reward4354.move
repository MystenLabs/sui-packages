module 0xcefa31f067a63a38e338b69fafecc274e53574246dcec0a62b5b7e72c06645ea::reward4354 {
    struct REWARD4354 has drop {
        dummy_field: bool,
    }

    struct TICKET_4354 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4354(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4354>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4354>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4354, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4354>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4354>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4354>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4354>>(v5, 0x2::tx_context::sender(arg1));
    }
