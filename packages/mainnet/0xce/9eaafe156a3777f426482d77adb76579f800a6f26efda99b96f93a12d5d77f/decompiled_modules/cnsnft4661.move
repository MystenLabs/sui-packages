module 0xce9eaafe156a3777f426482d77adb76579f800a6f26efda99b96f93a12d5d77f::cnsnft4661 {
    struct CNSNFT4661 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4661, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4661>(arg0, arg1);
