module 0xce7381ad0392d5dea7ef85710e17751a0dbf36dc399ba76faddb4c165df441e2::none {
    ...
    fun init(arg0: NONE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NONE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"None"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"jaajhdasjhdjasjd"));
