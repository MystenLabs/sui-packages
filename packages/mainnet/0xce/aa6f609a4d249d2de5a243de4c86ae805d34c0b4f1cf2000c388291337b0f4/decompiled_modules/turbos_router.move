module 0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::turbos_router {
    ...
    public entry fun buy_exact_in<T0, T1, T2>(arg0: &FeeObject, arg1: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: u128, arg7: u64, arg8: &0x2::clock::Clock, arg9: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg10: bool, arg11: 0x1::string::String, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg10) {
            ...
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T0>(0x2::coin::split<T0>(&mut arg2, v0, arg12), arg0.admin);
        } else {
            assert!(0x2::coin::value<T1>(&arg3) >= arg4, 3);
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T1>(0x2::coin::split<T1>(&mut arg3, v0, arg12), arg0.admin);
        };
        if (arg10) {
            ...
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T0>(v4, 0x2::tx_context::sender(arg12));
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T1>(v5, 0x2::tx_context::sender(arg12));
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T1>(arg3, 0x2::tx_context::sender(arg12));
            assert!(v6 >= arg5, 4);
            let v7 = BuyEvent<T1>{
            ...
            assert!(v12 >= arg5, 4);
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T1>(v10, 0x2::tx_context::sender(arg12));
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T0>(v11, 0x2::tx_context::sender(arg12));
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T0>(arg2, 0x2::tx_context::sender(arg12));
            let v13 = BuyEvent<T0>{
                recipient  : 0x2::tx_context::sender(arg12),
                amount_in  : v1,
                amount_out : v12,
    ...
    public entry fun sell_exact_in<T0, T1, T2>(arg0: &FeeObject, arg1: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: u128, arg7: u64, arg8: &0x2::clock::Clock, arg9: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg10: bool, arg11: 0x1::string::String, arg12: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg10) {
            ...
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T1>(0x2::coin::split<T1>(&mut v4, v6, arg12), arg0.admin);
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T1>(v4, 0x2::tx_context::sender(arg12));
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T0>(v3, 0x2::tx_context::sender(arg12));
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T1>(arg3, 0x2::tx_context::sender(arg12));
            let v7 = SellEvent<T0>{
                recipient  : 0x2::tx_context::sender(arg12),
                amount_in  : arg4,
            ...
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T0>(0x2::coin::split<T0>(&mut v11, v13, arg12), arg0.admin);
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T0>(v11, 0x2::tx_context::sender(arg12));
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T1>(v10, 0x2::tx_context::sender(arg12));
            0xceaa6f609a4d249d2de5a243de4c86ae805d34c0b4f1cf2000c388291337b0f4::utils::send_coin<T0>(arg2, 0x2::tx_context::sender(arg12));
