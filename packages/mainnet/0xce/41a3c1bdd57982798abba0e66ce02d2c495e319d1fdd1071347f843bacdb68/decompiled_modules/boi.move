module 0xce41a3c1bdd57982798abba0e66ce02d2c495e319d1fdd1071347f843bacdb68::boi {
    struct BOI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BOI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::transfer::public_transfer<0x2::coin::Coin<BOI>>(0x2::coin::mint<BOI>(&mut v2, 1000000000, arg1), 0x2::tx_context::sender(arg1));
