module 0xce37f30be45c1ba307ac0d2757fa4e7773190e882360f8355ea26242f6cc441e::router_script {
    ...
    public entry fun deepbook<T0, T1>(arg0: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg1: u64, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut 0x2::coin::Coin<T1>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xdee9::clob_v2::create_account(arg5);
        0xdee9::clob_v2::deposit_base<T0, T1>(arg0, 0x2::coin::split<T0>(arg2, 5000000000, arg5), &v0);
        0xdee9::clob_v2::deposit_quote<T0, T1>(arg0, 0x2::coin::split<T1>(arg3, 5000000, arg5), &v0);
        let (v1, v2, _) = 0xdee9::clob_v2::swap_exact_base_for_quote<T0, T1>(arg0, arg1, &v0, 5000000000, 0xdee9::clob_v2::withdraw_base<T0, T1>(arg0, 5000000000, &v0, arg5), 0x2::coin::zero<T1>(arg5), arg4, arg5);
        let v4 = v2;
        0x2::coin::join<T0>(arg2, v1);
        let (v5, v6, _) = 0xdee9::clob_v2::swap_exact_quote_for_base<T0, T1>(arg0, arg1, &v0, 0x2::coin::value<T1>(&v4), arg4, v4, arg5);
        0x2::coin::join<T0>(arg2, v5);
        0x2::coin::join<T1>(arg3, 0xdee9::clob_v2::withdraw_quote<T0, T1>(arg0, 5000000, &v0, arg5));
        0x2::coin::join<T1>(arg3, v6);
        0x2::transfer::public_transfer<0xdee9::custodian_v2::AccountCap>(v0, 0x2::tx_context::sender(arg5));
    }
    ...
    public entry fun navi<T0>(arg0: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg1: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg2: vector<0x2::coin::Coin<T0>>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = merge_coins<T0>(arg2, arg4);
        send_coin<T0>(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::redeem::redeem<T0>(arg0, arg1, 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::mint::mint<T0>(arg0, arg1, v0, arg3, arg4), arg3, arg4), 0x2::tx_context::sender(arg4));
    }
