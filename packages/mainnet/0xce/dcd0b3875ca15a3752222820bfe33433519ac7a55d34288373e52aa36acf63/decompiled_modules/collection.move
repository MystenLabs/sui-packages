module 0xcedcd0b3875ca15a3752222820bfe33433519ac7a55d34288373e52aa36acf63::collection {
    ...
    public entry fun mint(arg0: &mut CreepyPopsCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = arg0.minted + 1;
        let v3 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v3, b"https://creepy-pops.vercel.app/");
        let v4 = 0x1::vector::empty<vector<u8>>();
        let v5 = &mut v4;
        0x1::vector::push_back<vector<u8>>(v5, b"ipfs://bafybeihmh3u3kowucic5pdgvvepgioqd2oakalylrhr233g5fmadb7eyau/");
        0x1::vector::push_back<vector<u8>>(v5, int_to_bytes(v2));
        0x1::vector::push_back<vector<u8>>(v5, b".json");
        let v6 = 0x1::vector::empty<vector<u8>>();
        let v7 = &mut v6;
        0x1::vector::push_back<vector<u8>>(v7, b"ipfs.io/ipfs/bafybeidjgewkhezkm7cctnfpexzi566x55wf6v2b6bgh4vjeqrfqta4ouy/");
        0x1::vector::push_back<vector<u8>>(v7, int_to_bytes(v2));
        0x1::vector::push_back<vector<u8>>(v7, b".png");
        let v8 = 0x1::vector::empty<vector<u8>>();
        let v9 = &mut v8;
        0x1::vector::push_back<vector<u8>>(v9, b"ipfs.io/ipfs/bafybeidjgewkhezkm7cctnfpexzi566x55wf6v2b6bgh4vjeqrfqta4ouy/");
        0x1::vector::push_back<vector<u8>>(v9, int_to_bytes(v2));
        0x1::vector::push_back<vector<u8>>(v9, b".png");
        let v10 = 0x1::vector::empty<vector<u8>>();
        let v11 = &mut v10;
        0x1::vector::push_back<vector<u8>>(v11, b"ipfs.io/ipfs/bafybeidjgewkhezkm7cctnfpexzi566x55wf6v2b6bgh4vjeqrfqta4ouy/");
        0x1::vector::push_back<vector<u8>>(v11, int_to_bytes(v2));
        0x1::vector::push_back<vector<u8>>(v11, b".png");
        let v12 = CreepyPopsNft{
        ...
        let v13 = CreepyPopsNftMinted{
            id      : 0x2::object::uid_to_inner(&v12.id),
            creator : 0x2::tx_context::sender(arg2),
        };
        0x2::event::emit<CreepyPopsNftMinted>(v13);
        0x2::transfer::transfer<CreepyPopsNft>(v12, 0x2::tx_context::sender(arg2));
        arg0.minted = arg0.minted + 1;
        if (v0) {
            let v14 = 0x2::tx_context::sender(arg2);
            0x2::vec_set::remove<address>(&mut arg0.whitelist, &v14);
        };
    }
