module 0xce84ccf3775d4c760d331ab4c21cbdba7fb463c7ed93d2265a4acaca31103499::magma_clmm {
    public fun magma_clmm_add_liquidity<T0, T1>(arg0: &mut 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::Pool<T0, T1>, arg1: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::config::GlobalConfig, arg2: &0x2::clock::Clock, arg3: &mut 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::position::Position, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T1>, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v4 = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::current_sqrt_price<T0, T1>(arg0);
        let v5 = 0;
        let v6 = 0;
        if (v4 < v3) {
            let v7 = if (v4 <= v2) {
                0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::clmm_math::get_liquidity_from_a(v2, v3, 0x2::coin::value<T0>(&arg4), false)
            } else {
                0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::clmm_math::get_liquidity_from_a(v4, v3, 0x2::coin::value<T0>(&arg4), false)
            };
            v5 = v7;
        };
        if (v4 > v2) {
            let v8 = if (v4 >= v3) {
                0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::clmm_math::get_liquidity_from_b(v2, v3, 0x2::coin::value<T1>(&arg5), false)
            } else {
                0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::clmm_math::get_liquidity_from_b(v2, v4, 0x2::coin::value<T1>(&arg5), false)
            };
            v6 = v8;
        };
        let v9 = if (v4 <= v2) {
        ...
        let v10 = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::add_liquidity<T0, T1>(arg1, arg0, arg3, v9, arg2, arg6);
