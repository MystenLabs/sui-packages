module 0xcee8f8675270ff1db81abdfb8c5d47cda4747f693bf64e2838884949d37d3247::access_control {
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : (AccessControl, Admin) {
        ...
        let v2 = &mut v0;
        new_role_singleton_impl(v2, 0xcee8f8675270ff1db81abdfb8c5d47cda4747f693bf64e2838884949d37d3247::constants::super_admin_role(), 0x2::object::uid_to_address(&v1.id));
        (v0, v1)
    }
    ...
    fun assert_super_admin(arg0: &Admin, arg1: &AccessControl) {
        assert!(has_role(arg0, arg1, 0xcee8f8675270ff1db81abdfb8c5d47cda4747f693bf64e2838884949d37d3247::constants::super_admin_role()), 9223372741229543427);
    }
