module 0x3e043c13394090b0c8de3cd8575a5d95766d7ac175f7fb7dfff8f1e908937d77::cnsnft6404 {
    struct CNSNFT6404 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6404, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6404>(arg0, arg1);
