module 0x3eab807c81f85bc1e90277f703b434e3cc62bf3d21eafa0be0831f3193e3b06f::mumumu {
    ...
    fun init(arg0: MUMUMU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = &mut v4;
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Mumumu v8 #{token_id}"));
