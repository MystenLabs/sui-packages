module 0x3e838a8a4e1ca3245a29260d58d0a96fbd7227fcf0e683a48e2375f69dbd2976::reward7033 {
    struct REWARD7033 has drop {
        dummy_field: bool,
    }

    struct TICKET_7033 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7033(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7033>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7033>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7033, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7033>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7033>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7033>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7033>>(v5, 0x2::tx_context::sender(arg1));
    }
