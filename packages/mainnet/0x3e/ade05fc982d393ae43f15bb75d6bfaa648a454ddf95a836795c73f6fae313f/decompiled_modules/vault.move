module 0x3eade05fc982d393ae43f15bb75d6bfaa648a454ddf95a836795c73f6fae313f::vault {
    ...
    public fun flash_loan<T0>(arg0: &mut Vault, arg1: &AccessList, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanReceipt) {
    ...
    public fun repay_flash_loan<T0>(arg0: &mut Vault, arg1: 0x2::coin::Coin<T0>, arg2: FlashLoanReceipt, arg3: &0x2::tx_context::TxContext) {
