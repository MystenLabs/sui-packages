module 0x3e4021f308d45cef958b15ac5ea0e495d541a7073e7d0d74123de1f192e3cb3a::cnsnft9993 {
    struct CNSNFT9993 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9993, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9993>(arg0, arg1);
