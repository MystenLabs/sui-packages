module 0x3ecb09e48fa93da6b7e99601c3a8f8ebb6628238e230ba26e72d77d0df5a20c6::escrow {
    ...
    fun new_offer<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &0x3ecb09e48fa93da6b7e99601c3a8f8ebb6628238e230ba26e72d77d0df5a20c6::marketplace::MarketPlace, arg6: &mut 0x2::tx_context::TxContext) : (Offer<T0>, OfferCap<T0>) {
        assert!(0x2::kiosk::has_access(arg0, arg1), 100);
        let v0 = 0x2::coin::into_balance<0x2::sui::SUI>(arg3);
        let v1 = 0x2::balance::value<0x2::sui::SUI>(&v0);
        let v2 = (((0x3ecb09e48fa93da6b7e99601c3a8f8ebb6628238e230ba26e72d77d0df5a20c6::marketplace::get_fee(arg5, 0x2::tx_context::sender(arg6)) as u128) * (v1 as u128) / 10000) as u64);
    ...
    public fun offer<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &0x3ecb09e48fa93da6b7e99601c3a8f8ebb6628238e230ba26e72d77d0df5a20c6::marketplace::MarketPlace, arg6: &mut 0x2::tx_context::TxContext) {
