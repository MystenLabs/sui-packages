module 0x3e215e38d6647222b0f579300cef73eac8f22651d1fb630356f24900219769a0::capybara_lootbox {
    ...
    public entry fun open_lootbox(arg0: &mut DataStorage, arg1: &0x2::random::Random, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &EmptyTransferPolicy<NFTLootbox>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        let (v1, v2) = 0x2::kiosk::purchase_with_cap<NFTLootbox>(arg2, 0x2::kiosk::list_with_purchase_cap<NFTLootbox>(arg2, arg3, arg4, 0, arg6), 0x2::coin::zero<0x2::sui::SUI>(arg6));
    ...
    public fun update_storage(arg0: &0x3e215e38d6647222b0f579300cef73eac8f22651d1fb630356f24900219769a0::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
