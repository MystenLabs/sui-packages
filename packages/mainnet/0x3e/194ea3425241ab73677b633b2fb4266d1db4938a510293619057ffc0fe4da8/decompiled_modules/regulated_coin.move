module 0x3e194ea3425241ab73677b633b2fb4266d1db4938a510293619057ffc0fe4da8::regulated_coin {
    ...
    fun init(arg0: REGULATED_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<REGULATED_COIN>(arg0, 5, b"$buubuu", b"bubuu", b"Example Regulated Coin", 0x1::option::none<0x2::url::Url>(), true, arg1);
