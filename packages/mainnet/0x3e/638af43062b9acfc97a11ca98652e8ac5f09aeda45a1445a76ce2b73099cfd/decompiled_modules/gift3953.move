module 0x3e638af43062b9acfc97a11ca98652e8ac5f09aeda45a1445a76ce2b73099cfd::gift3953 {
    struct GIFT3953 has drop {
        dummy_field: bool,
    }

    struct TICKET_3953 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3953(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3953>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3953>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3953, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3953>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3953>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3953>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3953>>(v5, 0x2::tx_context::sender(arg1));
    }
