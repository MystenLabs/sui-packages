module 0x3e14466185b0d4f933e358eac73a4c5e39ec704b4d462851a55f9717d1d0701f::arena {
    ...
    fun init(arg0: ARENA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<ARENA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Arena       ")))), trim_right(b"Alpha Arena                     "), trim_right(b"Alpha Arena is a project where 6 LLMs are actively trading against each other in a test to see how LLMs trade, learn and think autonomously.                                                                                                                                                                                    "), v2, arg1);
