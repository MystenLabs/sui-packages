module 0x3e850d6bde8e26de7d4d84afc0c4760d3da73321c5919dd121f26dcea999f7cd::SPEPE {
    ...
    fun init(arg0: SPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SPEPE>(arg0, 9, b"$SPepe", b"SuiPepe", b" ", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://https-pinksale.finance/anhcuatung/spe.png")), arg1);
