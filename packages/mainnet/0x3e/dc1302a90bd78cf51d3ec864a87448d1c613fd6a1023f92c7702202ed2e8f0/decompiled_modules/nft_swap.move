module 0x3edc1302a90bd78cf51d3ec864a87448d1c613fd6a1023f92c7702202ed2e8f0::nft_swap {
    ...
    public fun accept_trade_improved<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::transfer_policy::TransferPolicy<T0>, arg7: &mut 0x2::tx_context::TxContext) : (vector<0x2::transfer_policy::TransferRequest<T0>>, vector<0x2::transfer_policy::TransferRequest<T0>>) {
        ...
        let v27 = 0x1::vector::empty<0x2::transfer_policy::TransferRequest<T0>>();
        let v28 = 0x1::vector::empty<0x2::transfer_policy::TransferRequest<T0>>();
        let v29 = 0;
        while (v29 < 0x1::vector::length<0x2::object::ID>(&v13)) {
            let v30 = *0x1::vector::borrow<0x2::object::ID>(&v13, v29);
            if (0x2::kiosk::is_listed(arg2, v30)) {
                0x2::kiosk::delist<T0>(arg2, arg3, v30);
            };
            let (v31, v32) = 0x2::kiosk::purchase_with_cap<T0>(arg2, 0x2::kiosk::list_with_purchase_cap<T0>(arg2, arg3, v30, 0, arg7), 0x2::coin::zero<0x2::sui::SUI>(arg7));
            0x2::kiosk::lock<T0>(&mut v7, &v6, arg6, v31);
            0x1::vector::push_back<0x2::transfer_policy::TransferRequest<T0>>(&mut v28, v32);
            v29 = v29 + 1;
        };
        ...
        while (v34 < 0x1::vector::length<0x2::object::ID>(&v11)) {
            ...
            if (0x2::dynamic_object_field::exists_<vector<u8>>(&v33.id, v36)) {
                ...
                0x1::vector::push_back<0x2::transfer_policy::TransferRequest<T0>>(&mut v27, v38);
            };
            v34 = v34 + 1;
        };
        if (v10 > 0) {
