module 0x3eddb3d0e1555a5736d51e853c33daee77f106d04cbb4228fb6e606844f411a7::participant {
    ...
    public(friend) fun get_probs_in_bps(arg0: &Participant, arg1: u64) : vector<u32> {
        ...
        while (v1 < arg0.total_user) {
            0x1::vector::push_back<u32>(&mut v0, 0x3eddb3d0e1555a5736d51e853c33daee77f106d04cbb4228fb6e606844f411a7::utils::get_prob_bps(arg0.total_amount, *0x1::vector::borrow<u64>(&arg0.index_amount, (v1 as u64)), arg1, *0x1::vector::borrow<u64>(&arg0.index_joined_at, (v1 as u64))));
            v1 = v1 + 1;
        };
        v0
    }
