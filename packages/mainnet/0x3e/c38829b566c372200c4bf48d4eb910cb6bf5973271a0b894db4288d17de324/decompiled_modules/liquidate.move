module 0xe2e3ba3661471a1a3af5550e8dee9ec71aeb2134a2aa3bc287e8b6a8a492147d::liquidate {
    ...
    public fun mock_custom_liquidate<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (CustomLiquidateReceipt<T0, T1>, 0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::swap::SwapContext) {
        let (v0, v1) = 0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::swap::new_swap_context(arg3);
        let v2 = v0;
        let v3 = CustomLiquidateReceipt<T0, T1>{
            ticket     : v1,
            debt_quota : arg2,
        };
        0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::swap::put_balance<T0>(&mut v2, 0x2::coin::into_balance<T0>(arg0));
        0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::swap::put_balance<T1>(&mut v2, 0x2::coin::into_balance<T1>(arg1));
        (v3, v2)
    }
