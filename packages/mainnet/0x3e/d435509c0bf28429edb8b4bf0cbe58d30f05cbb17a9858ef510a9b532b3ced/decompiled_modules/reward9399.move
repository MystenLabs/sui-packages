module 0x3ed435509c0bf28429edb8b4bf0cbe58d30f05cbb17a9858ef510a9b532b3ced::reward9399 {
    struct REWARD9399 has drop {
        dummy_field: bool,
    }

    struct TICKET_9399 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9399(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9399>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9399>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9399, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9399>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9399>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9399>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9399>>(v5, 0x2::tx_context::sender(arg1));
    }
