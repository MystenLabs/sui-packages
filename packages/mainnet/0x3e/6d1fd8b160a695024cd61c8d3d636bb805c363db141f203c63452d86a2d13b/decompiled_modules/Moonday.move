module 0x3e6d1fd8b160a695024cd61c8d3d636bb805c363db141f203c63452d86a2d13b::Moonday {
    struct MOONDAY has drop {
        dummy_field: bool,
    }

    fun init(arg0: MOONDAY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = if (b"https://storage.googleapis.com/moonday/tokens/21c56d9e-5137-4ad2-a013-609100fe9ca2/4444.png" == b"") {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://storage.googleapis.com/moonday/tokens/21c56d9e-5137-4ad2-a013-609100fe9ca2/4444.png"))
        };
        let v1 = b"TEST3";
        let v2 = b"Test32";
        let v3 = b"jhdfjdhf";
