module 0x6dc234e9a85395da22e63aaa15ea9f1e14ae039a1ce5dfca30f1189558c7419e::newapp {
    ...
    fun clac_level_diff(arg0: &mut Global_NetworkStatistics, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64) {
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 20) {
            let v3 = 0x2::table::borrow_mut<address, User>(arg1, 0x1::option::extract<address>(&mut v0));
            let v4 = get_user_level(v3);
            if (v4 == 0) {
                v0 = v3.inviter;
                v1 = v1 + 1;
                continue
            ...
            if (v4 > 0) {
                let v5 = arg3 * (get_reward_percentage(v4) - 0) / 100;
                if (v3.underway_power > 0) {
                    ...
                    v3.daily_static_revenue = v3.daily_static_revenue + v7;
                    handler_out(arg0, v3);
                };
                v2 = v3.inviter;
            };
        ...
        if (0x1::option::is_some<address>(&v0) && 0x1::option::is_some<address>(&v2)) {
            let v8 = 0x2::table::borrow_mut<address, User>(arg1, 0x1::option::extract<address>(&mut v2));
            let v9 = arg3 * 2 / 100;
            if (v8.underway_power > 0) {
                let v10 = v8.total_static_power - v8.total_revenue;
                let v11 = if (v10 > v9) {
                    v9
                } else {
                    v10
                };
                v8.balance = v8.balance + v11;
                v8.total_revenue = v8.total_revenue + v11;
                v8.daily_static_revenue = v8.daily_static_revenue + v11;
                handler_out(arg0, v8);
            };
        };
    }
