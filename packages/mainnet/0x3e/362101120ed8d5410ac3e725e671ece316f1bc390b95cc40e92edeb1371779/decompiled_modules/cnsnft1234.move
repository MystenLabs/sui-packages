module 0x3e362101120ed8d5410ac3e725e671ece316f1bc390b95cc40e92edeb1371779::cnsnft1234 {
    struct CNSNFT1234 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1234, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1234>(arg0, arg1);
