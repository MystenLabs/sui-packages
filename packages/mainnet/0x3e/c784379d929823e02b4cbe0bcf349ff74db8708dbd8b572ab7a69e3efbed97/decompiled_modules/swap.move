module 0x3ec784379d929823e02b4cbe0bcf349ff74db8708dbd8b572ab7a69e3efbed97::swap {
    ...
    public fun take_swap_fee<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 < 1000000000, 104);
        assert!(arg1 > 0, 105);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg0, 0x2::coin::value<T0>(arg0) * arg1 / 1000000000, arg3), arg2);
    }
