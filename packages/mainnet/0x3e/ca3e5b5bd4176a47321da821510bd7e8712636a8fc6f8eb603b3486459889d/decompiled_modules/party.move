module 0x3eca3e5b5bd4176a47321da821510bd7e8712636a8fc6f8eb603b3486459889d::party {
    ...
    public entry fun consume<T0>(arg0: &mut Reserve<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x1::vector::pop_back<0x2::coin::Coin<T0>>(&mut arg0.coins), 0x2::tx_context::sender(arg2));
