module 0x3e4dc1238e9ba6d963e3c7a6cd8f1996fae8394784ecfa60328e4a1309855f3a::cnsnft2095 {
    struct CNSNFT2095 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2095, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2095>(arg0, arg1);
