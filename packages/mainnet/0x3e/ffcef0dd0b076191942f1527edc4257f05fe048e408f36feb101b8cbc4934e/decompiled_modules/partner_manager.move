module 0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::partner_manager {
    ...
    public(friend) fun collect_commission_if_necessary<T0>(arg0: &mut PartnerRegistry, arg1: &mut 0x2::coin::Coin<T0>, arg2: &0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::commission::Commission, arg3: &mut 0x2::tx_context::TxContext) {
        if (!0x2::bag::contains<address>(&arg0.partners, 0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::commission::partner(arg2))) {
            0x2::bag::add<address, 0x2::bag::Bag>(&mut arg0.partners, 0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::commission::partner(arg2), 0x2::bag::new(arg3));
        };
        let v0 = 0x2::bag::borrow_mut<address, 0x2::bag::Bag>(&mut arg0.partners, 0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::commission::partner(arg2));
        let v1 = if (0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::commission::type(arg2) == 0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::commission_type::flat()) {
            if (0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::commission::value(arg2) > 0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::math::mul_div(0x2::coin::value<T0>(arg1), arg0.max_comission_percentage, 1000000)) {
                abort 1
            };
            0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::commission::value(arg2)
        } else {
            if (0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::commission::value(arg2) > arg0.max_comission_percentage) {
                abort 1
            };
            0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::math::mul_div(0x2::coin::value<T0>(arg1), 0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::commission::value(arg2), 1000000)
        };
        collect<T0>(v0, 0x2::coin::split<T0>(arg1, v1, arg3), arg3);
    }

    public entry fun config_max_comission_percentage(arg0: &0x3effcef0dd0b076191942f1527edc4257f05fe048e408f36feb101b8cbc4934e::admin_cap::AdminCap, arg1: &mut PartnerRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
