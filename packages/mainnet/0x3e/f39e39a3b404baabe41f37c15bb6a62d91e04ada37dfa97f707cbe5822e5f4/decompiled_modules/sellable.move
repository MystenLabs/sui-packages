module 0x3ef39e39a3b404baabe41f37c15bb6a62d91e04ada37dfa97f707cbe5822e5f4::sellable {
    struct CredenzaSellableAssetConfig has store, key {
        id: 0x2::object::UID,
        asset_id: u64,
        price_fiat: u64,
        price_fiat_for_currency: 0x2::table::Table<vector<u8>, u64>,
        price_sui: u64,
        price_coin: u64,
    }
    ...
    struct CredenzaSellableConfig<phantom T0> has store, key {
        id: 0x2::object::UID,
        ownership: 0x3ef39e39a3b404baabe41f37c15bb6a62d91e04ada37dfa97f707cbe5822e5f4::ownership::CredenzaOwnership,
    ...
    public fun set_owner<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: address, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        0x3ef39e39a3b404baabe41f37c15bb6a62d91e04ada37dfa97f707cbe5822e5f4::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        0x3ef39e39a3b404baabe41f37c15bb6a62d91e04ada37dfa97f707cbe5822e5f4::ownership::set_owner(&mut arg0.ownership, arg1, arg2);
    }
    ...
    public fun create_config<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : (T0, CredenzaSellableConfig<T0>) {
        ...
        let v1 = CredenzaSellableConfig<T0>{
            id                      : v0,
            ownership               : 0x3ef39e39a3b404baabe41f37c15bb6a62d91e04ada37dfa97f707cbe5822e5f4::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
            beneficiary_address     : 0x2::tx_context::sender(arg1),
            price_fiat              : 0,
            price_fiat_for_currency : 0x2::table::new<vector<u8>, u64>(arg1),
            price_sui               : 0,
            price_coin              : 0,
            asset_prices            : 0x2::table::new<u64, CredenzaSellableAssetConfig>(arg1),
            coin                    : 0x2::bag::new(arg1),
        };
        0x3ef39e39a3b404baabe41f37c15bb6a62d91e04ada37dfa97f707cbe5822e5f4::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg1));
    ...
    fun get_sellable_asset_config_mut<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : &mut CredenzaSellableAssetConfig {
        if (!0x2::table::contains<u64, CredenzaSellableAssetConfig>(&arg0.asset_prices, arg1)) {
            let v0 = CredenzaSellableAssetConfig{
                ...
                asset_id                : arg1,
                price_fiat              : 0,
                price_fiat_for_currency : 0x2::table::new<vector<u8>, u64>(arg2),
                price_sui               : 0,
                price_coin              : 0,
            };
    ...
    public fun set_asset_price_fiat<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x3ef39e39a3b404baabe41f37c15bb6a62d91e04ada37dfa97f707cbe5822e5f4::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        let v0 = get_sellable_asset_config_mut<T0>(arg0, arg1, arg3);
        v0.price_fiat = arg2;
        set_asset_price_fiat_for_currency_internal(v0, b"USD", arg2);
    }

    public fun set_asset_price_fiat_for_currency<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: u64, arg2: vector<u8>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0x3ef39e39a3b404baabe41f37c15bb6a62d91e04ada37dfa97f707cbe5822e5f4::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg4));
        let v0 = get_sellable_asset_config_mut<T0>(arg0, arg1, arg4);
        if (arg2 == b"USD") {
            v0.price_fiat = arg3;
        };
        set_asset_price_fiat_for_currency_internal(v0, arg2, arg3);
    }

    fun set_asset_price_fiat_for_currency_internal(arg0: &mut CredenzaSellableAssetConfig, arg1: vector<u8>, arg2: u64) {
        if (0x2::table::contains<vector<u8>, u64>(&arg0.price_fiat_for_currency, arg1)) {
            0x2::table::remove<vector<u8>, u64>(&mut arg0.price_fiat_for_currency, arg1);
        };
        0x2::table::add<vector<u8>, u64>(&mut arg0.price_fiat_for_currency, arg1, arg2);
    }
    ...
    public fun set_beneficiary_adress<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x3ef39e39a3b404baabe41f37c15bb6a62d91e04ada37dfa97f707cbe5822e5f4::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg2));
    ...
    public fun set_price_fiat<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        set_price_fiat_for_currency_internal<T0>(arg0, b"USD", arg1);
    }

    public fun set_price_fiat_for_currency<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: vector<u8>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x3ef39e39a3b404baabe41f37c15bb6a62d91e04ada37dfa97f707cbe5822e5f4::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        if (arg1 == b"USD") {
            arg0.price_fiat = arg2;
        };
        set_price_fiat_for_currency_internal<T0>(arg0, arg1, arg2);
    }

    fun set_price_fiat_for_currency_internal<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: vector<u8>, arg2: u64) {
        if (0x2::table::contains<vector<u8>, u64>(&arg0.price_fiat_for_currency, arg1)) {
            0x2::table::remove<vector<u8>, u64>(&mut arg0.price_fiat_for_currency, arg1);
        };
        0x2::table::add<vector<u8>, u64>(&mut arg0.price_fiat_for_currency, arg1, arg2);
