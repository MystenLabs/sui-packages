module 0x3e5f6421aeef9672cedbd108e7ba6464daeebc313c53ea0fb3999f67e19f868d::movexnft2723 {
    struct MOVEXNFT2723 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT2723, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT2723>(arg0, arg1);
