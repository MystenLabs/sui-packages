module 0x3eae40d07c92b8e63a5cc41a612711d448cd29419a86f905b2b4efbfb7e91d0e::plastic {
    ...
    fun init(arg0: PLASTIC, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PLASTIC>(arg0, 9, b"PLASTIC", b"Plastic Coin", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://dxe233s0t38k9.cloudfront.net/Frame%203.png")), arg1);
