module 0x3e7f8c93914c8b6cfb69b953f117f25e9c84748e03ae129b8f86b157367c2a2a::tradeport_bridge {
    ...
    public fun add_exclusive_transfer_policy<T0>(arg0: &mut Manager, arg1: 0x1::ascii::String, arg2: 0x2::transfer_policy::TransferPolicy<T0>) {
        verify_version(arg0);
        let v0 = 0x1::type_name::get<T0>();
        assert!(arg1 == *0x1::type_name::borrow_string(&v0), 3);
        assert!(0x2::table::contains<0x1::ascii::String, Bridge>(&arg0.bridges, arg1), 5);
        assert!(0x2::vec_set::size<0x1::type_name::TypeName>(0x2::transfer_policy::rules<T0>(&arg2)) == 0, 10);
        0x2::dynamic_object_field::add<0x1::ascii::String, 0x2::transfer_policy::TransferPolicy<T0>>(&mut 0x2::table::borrow_mut<0x1::ascii::String, Bridge>(&mut arg0.bridges, arg1).id, arg1, arg2);
    }
    ...
    public fun bridge_coin_to_nft<T0: store + key, T1>(arg0: &mut Manager, arg1: 0x2::coin::Coin<T1>, arg2: 0x2::object::ID, arg3: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        let v8 = if (0x2::dynamic_object_field::exists_with_type<0x1::ascii::String, 0x2::transfer_policy::TransferPolicy<T0>>(&v4.id, v1)) {
        ...
        let (v9, v10) = 0x2::kiosk::purchase_with_cap<T0>(&mut arg0.kiosk, 0x2::kiosk::list_with_purchase_cap<T0>(&mut arg0.kiosk, &arg0.kiosk_owner_cap, arg2, 0, arg7), 0x2::coin::zero<0x2::sui::SUI>(arg7));
        let v11 = v10;
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Rule>(v8)) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(v8, &mut v11, arg4);
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(arg4);
        };
        0x2::kiosk::lock<T0>(arg5, arg6, v8, v9);
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::Rule>(v8)) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T0>(&mut v11, arg5);
        };
        let v12 = BridgeNftToCoinEvent{
        ...
        0x2::event::emit<BridgeNftToCoinEvent>(v12);
        v11
    }
    ...
    public fun bridge_nft_to_coin<T0: store + key, T1>(arg0: &mut Manager, arg1: 0x2::object::ID, arg2: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::coin::Coin<T1>) {
        ...
        let (v9, v10) = 0x2::kiosk::purchase_with_cap<T0>(arg4, 0x2::kiosk::list_with_purchase_cap<T0>(arg4, arg5, arg1, 0, arg6), 0x2::coin::zero<0x2::sui::SUI>(arg6));
        let v11 = v10;
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Rule>(v8)) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(v8, &mut v11, arg3);
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(arg3);
        };
        0x2::kiosk::lock<T0>(&mut arg0.kiosk, &arg0.kiosk_owner_cap, v8, v9);
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::Rule>(v8)) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T0>(&mut v11, &arg0.kiosk);
        };
        let v12 = BridgeNftToCoinEvent{
            bridge_id : 0x2::object::id<Bridge>(v4),
            nft_type  : v1,
