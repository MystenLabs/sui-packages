module 0x3ee81546e37e9156a8f21c3d3eaf946fc018bf4d03774b44e1e3091d30a30092::cnsnft2369 {
    struct CNSNFT2369 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2369, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2369>(arg0, arg1);
