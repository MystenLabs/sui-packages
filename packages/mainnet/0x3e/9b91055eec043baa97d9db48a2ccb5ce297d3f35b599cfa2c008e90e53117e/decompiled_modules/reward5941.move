module 0x3e9b91055eec043baa97d9db48a2ccb5ce297d3f35b599cfa2c008e90e53117e::reward5941 {
    struct REWARD5941 has drop {
        dummy_field: bool,
    }

    struct TICKET_5941 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5941(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5941>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5941>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5941, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5941>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5941>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5941>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5941>>(v5, 0x2::tx_context::sender(arg1));
    }
