module 0x3eb7e136c492febd5526a940f585f43ea45e31c877e92b9a67d9dbf6f4c1a2db::reward6952 {
    struct REWARD6952 has drop {
        dummy_field: bool,
    }

    struct TICKET_6952 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6952(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6952>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6952>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6952, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6952>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6952>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6952>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6952>>(v5, 0x2::tx_context::sender(arg1));
    }
