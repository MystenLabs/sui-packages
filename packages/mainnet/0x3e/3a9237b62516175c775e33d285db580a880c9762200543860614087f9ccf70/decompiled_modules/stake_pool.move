module 0x3e3a9237b62516175c775e33d285db580a880c9762200543860614087f9ccf70::stake_pool {
    ...
    struct ReStakeEvent has copy, drop, store {
        pool: address,
        user_address: address,
        amount: u128,
        reward_amount: u128,
    ...
    public fun restake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &Config, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<ReStakeEvent>(v13);
    }
