module 0x3e76f252ef9f61be2ce4515546c3e3e2a07ab97219229f72035db4fb78b68464::pool {
    ...
    public(friend) entry fun create_pool<T0>(arg0: u8, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool<T0>{
