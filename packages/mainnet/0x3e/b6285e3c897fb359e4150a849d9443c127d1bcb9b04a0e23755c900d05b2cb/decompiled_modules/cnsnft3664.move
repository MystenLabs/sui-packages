module 0x3eb6285e3c897fb359e4150a849d9443c127d1bcb9b04a0e23755c900d05b2cb::cnsnft3664 {
    struct CNSNFT3664 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3664, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3664>(arg0, arg1);
