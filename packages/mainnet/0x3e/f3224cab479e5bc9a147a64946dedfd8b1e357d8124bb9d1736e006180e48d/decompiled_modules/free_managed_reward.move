module 0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::free_managed_reward {
    ...
    public fun borrow_reward(arg0: &FreeManagedReward) : &0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward::Reward {
        &arg0.reward
    }
    ...
    public(friend) fun create(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x1::type_name::TypeName, arg3: &mut 0x2::tx_context::TxContext) : FreeManagedReward {
        ...
        let (v2, v3) = 0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward::create(0x2::object::uid_to_inner(&v1), v0, false, arg3);
        FreeManagedReward{
            id         : v1,
            voter      : arg0,
            ve         : arg1,
    ...
    public(friend) fun deposit(arg0: &mut FreeManagedReward, arg1: u64, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward::deposit(&mut arg0.reward, &arg0.reward_cap, arg1, arg2, arg3, arg4);
    }
    ...
    public(friend) fun get_reward<T0>(arg0: &mut FreeManagedReward, arg1: address, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward::get_reward_internal<T0>(&mut arg0.reward, &arg0.reward_cap, arg1, arg2, arg3, arg4);
    ...
    public fun notify_reward_amount<T0>(arg0: &mut FreeManagedReward, arg1: 0x1::option::Option<0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::whitelisted_tokens::WhitelistedToken>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        if (!0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward::rewards_contains(&arg0.reward, v0)) {
            assert!(0x1::option::is_some<0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::whitelisted_tokens::WhitelistedToken>(&arg1), 9223372389042094079);
            0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::whitelisted_tokens::validate<T0>(0x1::option::extract<0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::whitelisted_tokens::WhitelistedToken>(&mut arg1), voter(arg0));
        ...
        if (0x1::option::is_some<0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::whitelisted_tokens::WhitelistedToken>(&arg1)) {
            0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::whitelisted_tokens::validate<T0>(0x1::option::extract<0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::whitelisted_tokens::WhitelistedToken>(&mut arg1), voter(arg0));
        };
        0x1::option::destroy_none<0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::whitelisted_tokens::WhitelistedToken>(arg1);
    ...
    public fun rewards_list(arg0: &FreeManagedReward) : vector<0x1::type_name::TypeName> {
        0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward::rewards_list(&arg0.reward)
    }
    ...
    public(friend) fun withdraw(arg0: &mut FreeManagedReward, arg1: u64, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward::withdraw(&mut arg0.reward, &arg0.reward_cap, arg1, arg2, arg3, arg4);
    }
