module 0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward {
    ...
    struct EventWithdrawReward has copy, drop, store {
        wrapper_reward_id: 0x2::object::ID,
        sender: address,
        token_name: 0x1::type_name::TypeName,
        epoch_start: u64,
    ...
    public fun withdraw_reward_amount_internal<T0>(arg0: &mut Reward, arg1: &0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward_cap::RewardCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward_cap::validate(arg1, 0x2::object::id<Reward>(arg0));
        assert!(arg0.balance_update_enabled, 922379188456102400);
        assert!(arg2 % 0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::common::epoch() == 0, 179263045518267390);
        assert!(!is_epoch_final(arg0, arg2), 634801927365182900);
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, 0x2::table::Table<u64, u64>>(&arg0.token_rewards_per_epoch, v0), 448209163720945870);
        let v1 = 0x2::table::borrow_mut<0x1::type_name::TypeName, 0x2::table::Table<u64, u64>>(&mut arg0.token_rewards_per_epoch, v0);
        assert!(0x2::table::contains<u64, u64>(v1, arg2), 512066394871320850);
        let v2 = 0x2::table::remove<u64, u64>(v1, arg2);
        0x2::table::add<u64, u64>(v1, arg2, 0);
        let v3 = EventWithdrawReward{
            wrapper_reward_id : arg0.wrapper_reward_id,
        ...
        0x2::event::emit<EventWithdrawReward>(v3);
