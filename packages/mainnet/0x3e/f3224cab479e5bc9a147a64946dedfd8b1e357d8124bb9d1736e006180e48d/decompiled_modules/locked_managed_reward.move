module 0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::locked_managed_reward {
    ...
    public fun borrow_reward(arg0: &LockedManagedReward) : &0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward::Reward {
        &arg0.reward
    }
    ...
    public(friend) fun get_reward<T0>(arg0: &mut LockedManagedReward, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        let v0 = ve(arg0);
        let v1 = 0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward::get_reward_internal<T0>(&mut arg0.reward, &arg0.reward_cap, 0x2::object::id_to_address(&v0), arg1, arg2, arg3);
    ...
    public(friend) fun notify_reward_amount<T0>(arg0: &mut LockedManagedReward, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::reward::notify_reward_amount_internal<T0>(&mut arg0.reward, &arg0.reward_cap, 0x2::coin::into_balance<T0>(arg1), arg2, arg3);
    }
