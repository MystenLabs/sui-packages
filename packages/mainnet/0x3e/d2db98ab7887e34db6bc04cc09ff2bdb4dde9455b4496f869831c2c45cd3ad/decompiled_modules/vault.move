module 0x35adb403859f51bfd9d5f250e7128a0c2059f57fbeb51dec68948e56212e02ad::vault {
    ...
    fun calculate_tvl_base_on_quote(arg0: &0x35adb403859f51bfd9d5f250e7128a0c2059f57fbeb51dec68948e56212e02ad::pyth_oracle::PythOracle, arg1: &0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, arg2: 0x1::option::Option<0x1::type_name::TypeName>, arg3: &0x2::clock::Clock) : u128 {
        let v0 = 0x35adb403859f51bfd9d5f250e7128a0c2059f57fbeb51dec68948e56212e02ad::pyth_oracle::new_price(1 * 0x1::u64::pow(10, 0x35adb403859f51bfd9d5f250e7128a0c2059f57fbeb51dec68948e56212e02ad::pyth_oracle::price_multiplier_decimal()), 0x35adb403859f51bfd9d5f250e7128a0c2059f57fbeb51dec68948e56212e02ad::pyth_oracle::price_multiplier_decimal());
        let v1 = 0;
        let v2 = 0;
        while (v2 < 0x2::vec_map::length<0x1::type_name::TypeName, u64>(arg1)) {
            let (v3, v4) = 0x2::vec_map::get_entry_by_idx<0x1::type_name::TypeName, u64>(arg1, v2);
            let v5 = 0x35adb403859f51bfd9d5f250e7128a0c2059f57fbeb51dec68948e56212e02ad::pyth_oracle::get_price_by_type(arg0, *v3, arg3);
            let (v6, _) = 0x35adb403859f51bfd9d5f250e7128a0c2059f57fbeb51dec68948e56212e02ad::pyth_oracle::calculate_prices(&v5, &v0);
            v1 = v1 + 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor((v6 as u128), (*v4 as u128), (0x1::u64::pow(10, 0x35adb403859f51bfd9d5f250e7128a0c2059f57fbeb51dec68948e56212e02ad::pyth_oracle::price_multiplier_decimal()) as u128));
            v2 = v2 + 1;
        };
        v1
    }
