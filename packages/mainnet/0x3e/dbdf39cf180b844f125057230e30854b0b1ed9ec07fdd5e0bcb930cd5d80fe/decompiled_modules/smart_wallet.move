module 0x3edbdf39cf180b844f125057230e30854b0b1ed9ec07fdd5e0bcb930cd5d80fe::smart_wallet {
    ...
    public fun add_executor(arg0: &mut SmartWallet, arg1: address, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun initialize_wallet(arg0: address, arg1: vector<address>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun remove_executor(arg0: &mut SmartWallet, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin_address, 1);
