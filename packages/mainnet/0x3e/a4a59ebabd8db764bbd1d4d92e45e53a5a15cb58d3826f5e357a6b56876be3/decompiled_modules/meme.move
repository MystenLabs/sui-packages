module 0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::meme {
    ...
    public fun accept_connector<T0>(arg0: &mut MemeConfig, arg1: 0x2::transfer::Receiving<0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::connector::Connector<T0>>, arg2: &mut 0x2::tx_context::TxContext) {
        enforce_config_version(arg0);
    }

    public fun accept_connector_v2<T0>(arg0: &mut MemeConfig, arg1: 0x2::transfer::Receiving<0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::connector_v2::ConnectorV2<T0>>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        enforce_config_version(arg0);
    }

    public fun accept_connector_v3<T0>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg1: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x2::clock::Clock, arg4: &mut MemeConfig, arg5: 0x2::transfer::Receiving<0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::connector_v3::ConnectorV3<T0>>, arg6: &0x2::coin::CoinMetadata<T0>, arg7: &mut 0x2::tx_context::TxContext) {
        enforce_config_version(arg4);
        let v0 = 0x2::transfer::public_receive<0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::connector_v3::ConnectorV3<T0>>(&mut arg4.id, arg5);
        let v1 = 0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::connector_v3::get_temp_id<T0>(&v0);
        ...
        let v5 = v2;
        assert!(0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::connector_v3::get_creator<T0>(&v0) == v4, 11);
    ...
    fun buy_returns_internal<T0>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg1: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x2::clock::Clock, arg4: &mut BondingCurve<T0>, arg5: &MemeConfig, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: u64, arg8: u64, arg9: address, arg10: bool, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let v3 = v2;
        let v4 = 0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::math::get_amount_in(v2, v1, v0);
        let v5 = v4;
        let v6 = 0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::math::get_fee_amount(v4, arg5.swap_fee_bps);
        let v7 = v6;
        if (0x2::coin::value<0x2::sui::SUI>(&arg6) < v4 + v6) {
            let v8 = 0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::math::get_fee_amount(0x2::coin::value<0x2::sui::SUI>(&arg6), arg5.swap_fee_bps);
            v7 = v8;
            let v9 = 0x2::coin::value<0x2::sui::SUI>(&arg6) - v8;
            v5 = v9;
            let v10 = 0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::math::get_amount_out(v9, v1, v0);
            v3 = v10;
            assert!(v10 >= arg8, 2);
        };
        ...
        if (arg4.available_token_reserves == 0) {
            ...
            0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::events::emit_complete<T0>(get_id<T0>(arg4));
        };
    ...
    fun create_bonding_curve_v3<T0>(arg0: &0x2::coin::CoinMetadata<T0>, arg1: 0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::connector_v3::ConnectorV3<T0>, arg2: &MemeConfig, arg3: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        enforce_config_version(arg2);
        let (v0, v1, v2, v3, v4, v5, v6) = 0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::connector_v3::deconstruct<T0>(arg1);
        ...
        0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::events::emit_curve_create<T0>(get_id<T0>(&v7), v5, 0x2::coin::get_name<T0>(arg0), 0x2::coin::get_symbol<T0>(arg0), 0x2::coin::get_description<T0>(arg0), 0x2::coin::get_icon_url<T0>(arg0), v2, v3, v4);
        v7
    }
    ...
    public fun place_dev_order(arg0: &mut MemeConfig, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::math::get_amount_in(arg3, arg0.virtual_sui_amount, 1000000000000000);
        let v2 = 0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::math::get_fee_amount(v1, arg0.swap_fee_bps);
    ...
    public fun sell_returns<T0>(arg0: &mut BondingCurve<T0>, arg1: &MemeConfig, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v1 = 0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::math::get_amount_out(v0, 0x2::balance::value<T0>(&arg0.token_balance), arg0.virtual_sui_amount + 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance));
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v2, 0x3ea4a59ebabd8db764bbd1d4d92e45e53a5a15cb58d3826f5e357a6b56876be3::math::get_fee_amount(v1, arg1.swap_fee_bps), arg4), @0xa8125cc1a3c3d425a317d405b4089402cf0a9e20fb8a484a0f98973baec09c0b);
