module 0x3eb954cd2e9d56a3921f04f220110c74f467bfd142b9c192c914c2784542e8f5::omg {
    struct OMG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: OMG, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<OMG>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"OMG"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"New paper from sapce."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifgrg3vlobfn2z3aij2n2wl65vjrqiqboodnutfx2stchqlzuklpu"));
