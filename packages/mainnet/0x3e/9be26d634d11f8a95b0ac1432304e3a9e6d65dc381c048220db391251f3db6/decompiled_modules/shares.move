module 0x3e9be26d634d11f8a95b0ac1432304e3a9e6d65dc381c048220db391251f3db6::shares {
    ...
    public(friend) fun deduct(arg0: &mut ShareReceipt, arg1: u128) {
        assert!(arg0.shares >= arg1, 0x3e9be26d634d11f8a95b0ac1432304e3a9e6d65dc381c048220db391251f3db6::errors::insufficient_shares());
        arg0.shares = arg0.shares - arg1;
    }
    ...
    public fun destroy_zero(arg0: ShareReceipt) {
        ...
        assert!(v2 == 0, 0x3e9be26d634d11f8a95b0ac1432304e3a9e6d65dc381c048220db391251f3db6::errors::share_receipt_not_empty());
        0x2::object::delete(v0);
    }
    ...
    public fun join(arg0: &mut ShareReceipt, arg1: ShareReceipt) {
        ...
        assert!(v1 == arg0.vault_id, 0x3e9be26d634d11f8a95b0ac1432304e3a9e6d65dc381c048220db391251f3db6::errors::wrong_vault_id());
