module 0xc6b5f087beaee003d909fff9e3e02b12c8b3c90e9fda2e9271ca98941186aac4::launchpad {
    ...
    public fun boost<T0>(arg0: &LaunchpadConfig, arg1: &mut BondingPool<T0>, arg2: u8, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = vector[100000000, 100000000, 100000000, 100000000, 100000000];
    ...
    fun buy_internal<T0>(arg0: &LaunchpadConfig, arg1: &mut BondingPool<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(v2 < v3, 4);
        let v4 = v3 - v2;
        if (mul_div(v0, 10000 - 200, 10000) > v4) {
            let v5 = ceil_mul_div(v4, 10000, 10000 - 200);
            let v6 = v0 - v5;
            if (v6 > 0) {
        ...
        let v7 = mul_div(v1, 120, 10000);
        let v8 = mul_div(v1, 80, 10000);
    ...
    fun compute_sqrt_price_x64(arg0: u64, arg1: u64) : u128 {
        (sqrt_u256((arg1 as u256) * 340282366920938463463374607431768211456 / (arg0 as u256)) as u128)
    }
    ...
    public fun preview_buy<T0>(arg0: &BondingPool<T0>, arg1: u64) : u64 {
        let v0 = curve_buy_tokens_out(arg0.virtual_sui, 0x2::balance::value<0x2::sui::SUI>(&arg0.real_sui), 0x2::balance::value<T0>(&arg0.real_tokens), mul_div(arg1, 10000 - 200, 10000));
        let v1 = v0;
    ...
    public fun preview_sell<T0>(arg0: &BondingPool<T0>, arg1: u64) : u64 {
        mul_div(curve_sell_sui_out(arg0.virtual_sui, 0x2::balance::value<0x2::sui::SUI>(&arg0.real_sui), 0x2::balance::value<T0>(&arg0.real_tokens), arg1), 10000 - 200, 10000)
    }
    ...
    public fun sell<T0>(arg0: &LaunchpadConfig, arg1: &mut BondingPool<T0>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v4 = mul_div(v3, 120, 10000);
        let v5 = mul_div(v3, 80, 10000);
        let v6 = v3 - v4 - v5;
        assert!(v6 >= arg3, 5);
