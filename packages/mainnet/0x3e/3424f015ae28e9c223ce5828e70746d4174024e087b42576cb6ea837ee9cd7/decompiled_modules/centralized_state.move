module 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::centralized_state {
    ...
    public(friend) fun check_save_receipt(arg0: &mut State, arg1: 0x1::string::String, arg2: u128) {
        ...
        let (v1, _) = 0x2::vec_map::get_entry_by_idx<ReceiptKey, bool>(&arg0.receipts, 0);
        assert!(arg1 != v1.nid || arg2 > v1.conn_sn, 90);
    ...
    public(friend) fun reset_receipt(arg0: &mut State) {
        let (v0, v1) = 0x2::vec_map::pop<ReceiptKey, bool>(&mut arg0.receipts);
        arg0.receipts = 0x2::vec_map::empty<ReceiptKey, bool>();
        0x2::vec_map::insert<ReceiptKey, bool>(&mut arg0.receipts, v0, v1);
    }
