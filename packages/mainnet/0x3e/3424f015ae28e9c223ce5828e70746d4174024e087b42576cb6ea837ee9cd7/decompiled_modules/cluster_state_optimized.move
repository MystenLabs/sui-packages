module 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::cluster_state_optimized {
    ...
    public(friend) fun create(arg0: &mut 0x2::tx_context::TxContext) : State {
        State{
            message_fee          : 0x2::vec_map::empty<0x1::string::String, u64>(),
            response_fee         : 0x2::vec_map::empty<0x1::string::String, u64>(),
            receipts             : 0x2::table::new<ReceiptKey, bool>(arg0),
            conn_sn              : 0,
