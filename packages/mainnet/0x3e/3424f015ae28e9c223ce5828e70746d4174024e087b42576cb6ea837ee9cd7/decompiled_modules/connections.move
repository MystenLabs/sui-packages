module 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::connections {
    ...
    public(friend) fun register(arg0: &mut 0x2::bag::Bag, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::string::as_bytes(&v0) == &v1) {
            ...
            let v3 = b"cluster";
            assert!(0x1::string::as_bytes(&v2) == &v3, 0);
            0x2::transfer::public_transfer<0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::cluster_state_optimized::AdminCap>(0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::cluster_state_optimized::create_admin_cap(arg1, arg2), 0x2::tx_context::sender(arg2));
            0x2::bag::add<0x1::string::String, 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::cluster_state_optimized::State>(arg0, arg1, 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::cluster_connection::connect(arg2));
        };
    }
