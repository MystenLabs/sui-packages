module 0x55e402b66a46498fafcffa60b23b8fc7bb51771d5d0d4c0fc284c57f438e8519::collection {
    ...
    struct Phase has store, key {
        ...
        joiners: 0x2::table::Table<address, u16>,
    }
    ...
    public entry fun add_phase<T0: drop>(arg0: &mut AdminCap, arg1: &mut MintData, arg2: u64, arg3: u64, arg4: u64, arg5: u16, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = Phase{
            ...
            mint_per_user : arg5,
            coin_type     : v0,
            joiners       : 0x2::table::new<address, u16>(arg6),
        };
    ...
    fun init(arg0: COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nikka>(&mut v9, 0x1::string::utf8(b"url"), 0x1::string::utf8(b"{url}"));
        0x2::display::add<Nikka>(&mut v9, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{image_url}"));
    ...
    public entry fun mint<T0: drop>(arg0: &mut MintData, arg1: 0x2::object::ID, arg2: &mut 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Phase>(&mut arg0.id, arg1);
        assert!(v1 <= arg0.limit_mint, 403);
        assert!(v3.end_time >= v2, 406);
        assert!(v3.start_time <= v2, 406);
        assert!(0x1::type_name::get<T0>() == v3.coin_type, 407);
        assert!(arg3 == v3.mint_price, 404);
        let v4 = &mut v3.joiners;
        if (0x2::table::contains<address, u16>(v4, v0) == true) {
            let v5 = 0x2::table::borrow_mut<address, u16>(v4, v0);
            assert!(*v5 < v3.mint_per_user, 408);
            *v5 = *v5 + 1;
        } else {
            0x2::table::add<address, u16>(v4, v0, 1);
        };
        let v6 = CoinKey{dummy_field: false};
        if (!0x2::dynamic_object_field::exists_<CoinKey>(&arg0.id, v6)) {
            let v7 = CoinKey{dummy_field: false};
            0x2::dynamic_object_field::add<CoinKey, 0x2::coin::Coin<T0>>(&mut arg0.id, v7, 0x2::coin::split<T0>(arg2, arg3, arg5));
        } else {
            let v8 = CoinKey{dummy_field: false};
            0x2::coin::join<T0>(0x2::dynamic_object_field::borrow_mut<CoinKey, 0x2::coin::Coin<T0>>(&mut arg0.id, v8), 0x2::coin::split<T0>(arg2, arg3, arg5));
        };
        let v9 = num_str(v1);
        let v10 = arg0.base_name;
        let v11 = arg0.base_image_url;
        0x1::string::append(&mut v10, v9);
        0x1::string::append(&mut v11, v9);
        0x1::string::append_utf8(&mut v11, b".webp");
        let v12 = Nikka{
        ...
        0x2::transfer::public_transfer<Nikka>(v12, v0);
