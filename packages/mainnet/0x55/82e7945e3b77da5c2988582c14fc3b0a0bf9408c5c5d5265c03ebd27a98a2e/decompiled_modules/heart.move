module 0x5582e7945e3b77da5c2988582c14fc3b0a0bf9408c5c5d5265c03ebd27a98a2e::heart {
    ...
    fun init(arg0: HEART, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<HEART>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Heart"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Heart nft SUI welcome"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidvpmmekg5oxyektdhzykmsdrqj3oz6fymfa4iqjvpjs2ofe23ngy"));
