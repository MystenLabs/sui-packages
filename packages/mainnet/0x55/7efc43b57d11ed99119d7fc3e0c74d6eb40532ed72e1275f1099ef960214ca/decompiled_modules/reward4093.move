module 0x557efc43b57d11ed99119d7fc3e0c74d6eb40532ed72e1275f1099ef960214ca::reward4093 {
    struct REWARD4093 has drop {
        dummy_field: bool,
    }

    struct TICKET_4093 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4093(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4093>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4093>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4093, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4093>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4093>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4093>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4093>>(v5, 0x2::tx_context::sender(arg1));
    }
