module 0x551d346e6976c5793e4e673c61f54e15616235c08dd75b5106343f9338fc9d48::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"GETOUTBIDEN", b"Get Out Biden", b"Officia token", 0x1::option::none<0x2::url::Url>(), arg1);
