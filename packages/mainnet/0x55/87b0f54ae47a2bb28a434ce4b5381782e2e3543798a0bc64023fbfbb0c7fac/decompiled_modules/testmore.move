module 0x5587b0f54ae47a2bb28a434ce4b5381782e2e3543798a0bc64023fbfbb0c7fac::testmore {
    struct TESTMORE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TESTMORE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TESTMORE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"TestMore"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Testmore"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://eHVd_brT_6LnQ_pjtIn5s18taUXU4SF_TpeOqAboDYc"));
