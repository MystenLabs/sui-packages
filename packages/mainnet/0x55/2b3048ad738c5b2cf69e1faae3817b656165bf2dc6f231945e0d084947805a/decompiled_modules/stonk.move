module 0x552b3048ad738c5b2cf69e1faae3817b656165bf2dc6f231945e0d084947805a::stonk {
    struct STONK has drop {
        dummy_field: bool,
    }

    fun init(arg0: STONK, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin_registry::new_currency_with_otw<STONK>(arg0, 9, untag(b"SSTONK"), untag(b"NStonk"), untag(b"D"), untag(b"Ihttps://silver-perfect-wren-754.mypinata.cloud/ipfs/bafkreih2rwx6pvokqcuxjfz6mwec7pngauybc53nm6oqsh7fsdwrpasatu"), arg1);
        let v2 = v1;
        let v3 = v0;
