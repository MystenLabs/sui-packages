module 0x55d353c371b7e7e2f9862c483569500f024a37860ef784f6f883e5980a315589::cnsnft7262 {
    struct CNSNFT7262 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7262, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7262>(arg0, arg1);
