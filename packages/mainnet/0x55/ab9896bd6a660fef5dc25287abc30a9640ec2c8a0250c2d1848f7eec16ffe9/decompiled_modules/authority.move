module 0x55ab9896bd6a660fef5dc25287abc30a9640ec2c8a0250c2d1848f7eec16ffe9::authority {
    struct PACKAGE {
        dummy_field: bool,
    }
    ...
    public fun add_authorization(arg0: &mut 0x2::object::UID, arg1: &AuthorityCap<PACKAGE, ADMIN>) {
        ...
        0x55ab9896bd6a660fef5dc25287abc30a9640ec2c8a0250c2d1848f7eec16ffe9::events::emit_added_authorization(0x2::object::uid_to_inner(arg0));
    }
    ...
    public fun remove_authorization(arg0: &mut 0x2::object::UID, arg1: &AuthorityCap<PACKAGE, ADMIN>) {
        ...
        0x55ab9896bd6a660fef5dc25287abc30a9640ec2c8a0250c2d1848f7eec16ffe9::events::emit_removed_authorization(0x2::object::uid_to_inner(arg0));
    }
