module 0x5596c86b99812bec93bf8fe3b9ac904e155913add96eb740287cad4676060b62::fred {
    ...
    fun init(arg0: FRED, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<FRED>(&mut v3, 420690000000000000, 0x2::tx_context::sender(arg1), arg1);
