module 0x5552a252e832d8729d6e62702cb7bf50bbd6aeb614e13e73c945396b69d8ea69::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"FV", b"Joke", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-31T12-00-43.077Z-cartoon-cute-school-boy-photo.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Joke"),
            symbol     : 0x1::string::utf8(b"FV"),
            decimals   : 9,
