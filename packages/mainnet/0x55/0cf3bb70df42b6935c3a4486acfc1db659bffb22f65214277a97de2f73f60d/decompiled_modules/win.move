module 0x550cf3bb70df42b6935c3a4486acfc1db659bffb22f65214277a97de2f73f60d::win {
    struct WIN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<WIN>(&mut v2, 1000000000000000, 0x2::tx_context::sender(arg1), arg1);
