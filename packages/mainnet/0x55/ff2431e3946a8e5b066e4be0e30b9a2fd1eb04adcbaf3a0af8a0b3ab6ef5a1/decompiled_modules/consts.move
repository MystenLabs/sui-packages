module 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::consts {
    ...
    public(friend) fun F0FundingPurchase() : u8 {
        50
    }

    public(friend) fun F0FundingWithdraw() : u8 {
        51
    }
    ...
    public(friend) fun F0UserSetProfitLayer() : u8 {
        16
    }
    ...
    public(friend) fun USER_PROFIT_SHARING_LAYER() : u8 {
        10
    }
