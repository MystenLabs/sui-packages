module 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::package_state {
    ...
    public(friend) fun check_version(arg0: &State) {
        assert!(0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::consts::VERSION() >= arg0.available_version, 3);
    }

    public(friend) fun get_config<T0: store>(arg0: &State, arg1: u8) : &T0 {
        0x2::dynamic_field::borrow<u8, T0>(&arg0.id, arg1)
    }

    fun get_feature_bit(arg0: &State, arg1: u8, arg2: u8) : bool {
        0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::utils::get_bit(*0x1::vector::borrow<u256>(&arg0.features, (arg1 as u64)), arg2)
    }
    ...
    public(friend) fun init_(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = State{
            ...
            available_version : 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::consts::VERSION(),
    ...
    entry fun set_config<T0: drop + store>(arg0: &mut State, arg1: u8, arg2: T0, arg3: &0x2::tx_context::TxContext) {
        check_admin(arg0, arg3);
        0x2::dynamic_field::remove_if_exists<u8, T0>(&mut arg0.id, arg1);
        0x2::dynamic_field::add<u8, T0>(&mut arg0.id, arg1, arg2);
    }
