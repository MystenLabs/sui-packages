module 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::vault {
    ...
    public(friend) fun borrow<T0>(arg0: &Vault) : &0x2::balance::Balance<T0> {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0x2::balance::Balance<T0>>(&arg0.id, 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::utils::get_type_name_string<T0>())
    }

    public(friend) fun borrow_mut<T0>(arg0: &mut Vault) : &mut 0x2::balance::Balance<T0> {
        0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut arg0.id, 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::utils::get_type_name_string<T0>())
    }
    ...
    fun makesure<T0>(arg0: &mut Vault) {
        let v0 = 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::utils::get_type_name_string<T0>();
