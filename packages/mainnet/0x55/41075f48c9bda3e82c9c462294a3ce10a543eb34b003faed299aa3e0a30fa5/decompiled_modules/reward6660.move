module 0x5541075f48c9bda3e82c9c462294a3ce10a543eb34b003faed299aa3e0a30fa5::reward6660 {
    struct REWARD6660 has drop {
        dummy_field: bool,
    }

    struct TICKET_6660 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6660(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6660>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6660>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6660, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6660>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6660>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6660>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6660>>(v5, 0x2::tx_context::sender(arg1));
    }
