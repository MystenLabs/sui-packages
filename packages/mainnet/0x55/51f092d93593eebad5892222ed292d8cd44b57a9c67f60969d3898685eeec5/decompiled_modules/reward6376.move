module 0x5551f092d93593eebad5892222ed292d8cd44b57a9c67f60969d3898685eeec5::reward6376 {
    struct REWARD6376 has drop {
        dummy_field: bool,
    }

    struct TICKET_6376 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6376(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6376>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6376>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6376, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6376>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6376>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6376>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6376>>(v5, 0x2::tx_context::sender(arg1));
    }
