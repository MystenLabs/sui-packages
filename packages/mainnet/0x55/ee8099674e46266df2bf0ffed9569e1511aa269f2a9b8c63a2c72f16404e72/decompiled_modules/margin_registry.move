module 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry {
    ...
    struct MinOpenRiskRatioKey has copy, drop, store {
        pos0: 0x2::object::ID,
    }
    ...
    struct MinOpenRiskRatioUpdated has copy, drop {
        pool_id: 0x2::object::ID,
    ...
    public fun min_open_risk_ratio(arg0: &MarginRegistry, arg1: 0x2::object::ID) : u64 {
        let v0 = liquidation_risk_ratio(arg0, arg1);
        let v1 = min_borrow_risk_ratio(arg0, arg1);
        let v2 = MinOpenRiskRatioKey{pos0: arg1};
        if (0x2::dynamic_field::exists_with_type<MinOpenRiskRatioKey, u64>(&arg0.id, v2)) {
            let v4 = *0x2::dynamic_field::borrow<MinOpenRiskRatioKey, u64>(&arg0.id, v2);
            if (v4 > v0 && v4 <= v1) {
                v4
            } else {
                (v0 + v1) / 2
    ...
    public fun register_deepbook_pool<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: PoolConfig, arg4: &0x2::clock::Clock) {
        ...
        assert!(0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::default_price_tolerance() + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() <= arg3.risk_ratios.liquidation_risk_ratio, 24);
    ...
    public fun set_min_open_risk_ratio<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock) {
        load_inner(arg0);
        let v0 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::id<T0, T1>(arg2);
        assert!(arg3 > liquidation_risk_ratio(arg0, v0) && arg3 <= min_borrow_risk_ratio(arg0, v0), 1);
        let v1 = MinOpenRiskRatioKey{pos0: v0};
        if (0x2::dynamic_field::exists_with_type<MinOpenRiskRatioKey, u64>(&arg0.id, v1)) {
            *0x2::dynamic_field::borrow_mut<MinOpenRiskRatioKey, u64>(&mut arg0.id, v1) = arg3;
        } else {
            0x2::dynamic_field::add<MinOpenRiskRatioKey, u64>(&mut arg0.id, v1, arg3);
        };
        let v2 = MinOpenRiskRatioUpdated{
            pool_id             : v0,
            min_open_risk_ratio : arg3,
            timestamp           : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<MinOpenRiskRatioUpdated>(v2);
    }
    ...
    public fun set_price_tolerance<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        let v1 = CurrentPriceKey{pool_id: v0};
        assert!(0x2::dynamic_field::exists_with_type<CurrentPriceKey, CurrentPriceData>(&arg0.id, v1), 18);
        assert!(arg3 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() <= liquidation_risk_ratio(arg0, v0), 24);
    ...
    public fun update_risk_params<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: PoolConfig, arg4: &0x2::clock::Clock) {
        let v0 = CurrentPriceKey{pool_id: 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::id<T0, T1>(arg2)};
        let v1 = if (0x2::dynamic_field::exists_with_type<CurrentPriceKey, CurrentPriceData>(&arg0.id, v0)) {
            0x2::dynamic_field::borrow<CurrentPriceKey, CurrentPriceData>(&arg0.id, v0).tolerance
        } else {
            0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::default_price_tolerance()
        };
        assert!(v1 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() <= arg3.risk_ratios.liquidation_risk_ratio, 24);
        let v2 = load_inner_mut(arg0);
        let v3 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::id<T0, T1>(arg2);
        assert!(0x2::table::contains<0x2::object::ID, PoolConfig>(&v2.pool_registry, v3), 3);
        let v4 = 0x2::table::remove<0x2::object::ID, PoolConfig>(&mut v2.pool_registry, v3);
        assert!(arg3.risk_ratios.liquidation_risk_ratio <= v4.risk_ratios.liquidation_risk_ratio, 1);
        assert!(v4.enabled, 4);
        ...
        0x2::table::add<0x2::object::ID, PoolConfig>(&mut v2.pool_registry, v3, arg3);
        let v5 = DeepbookPoolConfigUpdated{
            pool_id   : v3,
            config    : arg3,
            timestamp : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<DeepbookPoolConfigUpdated>(v5);
    }
