module 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::rate_limiter {
    ...
    public(friend) fun record_deposit(arg0: &mut RateLimiter, arg1: u64, arg2: &0x2::clock::Clock) {
        if (!arg0.enabled) {
            return
        };
        refill(arg0, arg2);
        arg0.available = (0x1::u128::min((arg0.available as u128) + (arg1 as u128), (arg0.capacity as u128)) as u64);
    }
