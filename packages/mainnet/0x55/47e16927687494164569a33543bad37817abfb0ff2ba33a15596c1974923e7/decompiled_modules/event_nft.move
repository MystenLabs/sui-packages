module 0x5547e16927687494164569a33543bad37817abfb0ff2ba33a15596c1974923e7::event_nft {
    ...
    fun init(arg0: EVENT_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<EventNFT>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://wal-aggregator-mainnet.staketab.org/v1/{image_cid}"));
