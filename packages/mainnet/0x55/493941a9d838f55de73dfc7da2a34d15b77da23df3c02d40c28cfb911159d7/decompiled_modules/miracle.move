module 0x55493941a9d838f55de73dfc7da2a34d15b77da23df3c02d40c28cfb911159d7::miracle {
    ...
    public fun create(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Miracle {
        assert!(arg0 > 0, 0x55493941a9d838f55de73dfc7da2a34d15b77da23df3c02d40c28cfb911159d7::errors::E_BAD_SPLIT());
        Miracle{
    ...
    public fun maybe_trigger(arg0: &mut Miracle, arg1: u64) : (bool, u64, u64, u64, u64) {
        ...
        assert!(v0 > 0, 0x55493941a9d838f55de73dfc7da2a34d15b77da23df3c02d40c28cfb911159d7::errors::E_BAD_SPLIT());
        if (arg1 % v0 == 0) {
    ...
    public fun set_params(arg0: &mut Miracle, arg1: u64, arg2: u64) {
        assert!(arg1 > 0, 0x55493941a9d838f55de73dfc7da2a34d15b77da23df3c02d40c28cfb911159d7::errors::E_BAD_SPLIT());
        arg0.base_odds = arg1;
