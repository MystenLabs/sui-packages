module 0x55493941a9d838f55de73dfc7da2a34d15b77da23df3c02d40c28cfb911159d7::faith {
    ...
    public fun accrue_to(arg0: address, arg1: u64, arg2: &mut SupplyCap, arg3: &RadianceIndex, arg4: &mut Buckets, arg5: &mut 0x2::tx_context::TxContext) {
        assert!((arg2.minted as u128) + (arg1 as u128) <= (arg2.cap as u128), 0x55493941a9d838f55de73dfc7da2a34d15b77da23df3c02d40c28cfb911159d7::errors::E_SUPPLY_CAP());
    ...
    public fun claim_if_any(arg0: address, arg1: u64, arg2: &mut SupplyCap, arg3: &mut RadianceIndex, arg4: &mut Buckets) : u64 {
        ...
        bump_radiance_index((v4 as u128), arg3);
        v2.raw = 0;
        v2.index_snap = arg3.index_accum;
        let v6 = RadianceClaimed{
            owner   : arg0,
            refined : v5,
            fee     : v4,
        };
        0x2::event::emit<RadianceClaimed>(v6);
        v5
    }
    ...
    public fun claim_if_any_with_multiplier(arg0: address, arg1: u64, arg2: u64, arg3: &mut SupplyCap, arg4: &mut RadianceIndex, arg5: &mut Buckets) : u64 {
        ...
        let v5 = (v4 as u64);
        let v6 = (((v3 - v4) * (arg2 as u128) / 10000) as u64);
