module 0x55072278227e69ac2f80714805567fddbe5dd72a5ec8954075f599637be96fde::reward1888 {
    struct REWARD1888 has drop {
        dummy_field: bool,
    }

    struct TICKET_1888 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1888(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1888>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1888>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1888, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1888>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1888>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1888>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1888>>(v5, 0x2::tx_context::sender(arg1));
    }
