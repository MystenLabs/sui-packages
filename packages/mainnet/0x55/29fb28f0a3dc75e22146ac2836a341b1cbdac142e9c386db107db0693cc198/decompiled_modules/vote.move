module 0x5529fb28f0a3dc75e22146ac2836a341b1cbdac142e9c386db107db0693cc198::vote {
    ...
    public entry fun mint(arg0: &mut Votecap, arg1: &mut Mintlist, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(!0x2::table::contains<address, u64>(&arg1.mintlist, v0), 1);
        0x2::table::add<address, u64>(&mut arg1.mintlist, v0, 100);
        0x2::transfer::public_transfer<0x2::coin::Coin<VOTE>>(0x2::coin::mint<VOTE>(&mut arg0.cap, 100, arg2), v0);
    }
    ...
    fun init(arg0: VOTE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<Votecap>(v5);
        0x2::transfer::share_object<Mintlist>(v0);
        0x2::transfer::share_object<VoteStore>(v1);
    }

    public entry fun register_voter<T0>(arg0: &0x2::coin::Coin<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<T0>(arg0) != 100, 1);
        let v0 = VoteToken<T0>{
            id     : 0x2::object::new(arg1),
            amount : 100,
        };
        0x2::transfer::public_transfer<VoteToken<T0>>(v0, 0x2::tx_context::sender(arg1));
    }
