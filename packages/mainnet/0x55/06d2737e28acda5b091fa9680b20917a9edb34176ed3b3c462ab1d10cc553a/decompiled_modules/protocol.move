module 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::protocol {
    ...
    fun calculate_end(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64) : u64 {
        0x2::math::max(arg4, arg5) + 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::utils::ceil_div(arg0 - arg1 - arg2, arg7) * arg3 + arg6
    }
    ...
    public fun calculate_withdrawal_fees(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        ...
        arg3 * 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::utils::ceil_div(arg1 - arg0, arg2)
    }

    public entry fun cancel<T0>(arg0: &mut Contract<T0>, arg1: &0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::Config, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert_cancel<T0>(arg0, 0x2::tx_context::sender(arg3));
        let v0 = 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::utils::timestamp_seconds(arg2);
    ...
    public entry fun create<T0>(arg0: &0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::Config, arg1: &0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::fee_manager::FeeTable, arg2: &0x2::clock::Clock, arg3: &mut 0x2::coin::Coin<T0>, arg4: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: bool, arg11: bool, arg12: bool, arg13: bool, arg14: bool, arg15: bool, arg16: bool, arg17: bool, arg18: u64, arg19: vector<u8>, arg20: address, arg21: address, arg22: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::utils::timestamp_seconds(arg2);
        if (arg8 == 0) {
            arg8 = v0;
        };
        ...
        let v2 = 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::fee_manager::get_streamflow_fee(arg1, arg0, arg21);
        let v3 = 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::fee_manager::get_partner_fee(arg1, arg0, arg21);
        ...
        if (arg17 && arg18 > 0) {
            let v10 = calculate_withdrawal_fees(arg8, v1, arg18, 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::get_tx_fee(arg0));
            assert!(0x2::coin::value<0x2::sui::SUI>(arg4) >= v10, 13);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg4, v10, arg22), 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::get_withdrawor(arg0));
        };
    ...
    public entry fun pause<T0>(arg0: &mut Contract<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::utils::timestamp_seconds(arg1);
        assert!(v0 < arg0.end, 5);
    ...
    public entry fun topup<T0>(arg0: &mut Contract<T0>, arg1: &0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::Config, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.meta.automatic_withdrawal && arg0.meta.withdrawal_frequency > 0) {
            let v2 = calculate_withdrawal_fees(v0, arg0.end, arg0.meta.withdrawal_frequency, 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::get_tx_fee(arg1));
            if (v2 > 0) {
                assert!(0x2::coin::value<0x2::sui::SUI>(arg3) >= v2, 13);
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg3, v2, arg5), 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::get_withdrawor(arg1));
            };
        };
    }
    ...
    public entry fun update<T0>(arg0: &mut Contract<T0>, arg1: &0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::Config, arg2: &0x2::clock::Clock, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: 0x1::option::Option<bool>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg4 == 0x1::option::some<bool>(true) && !arg0.meta.automatic_withdrawal) {
            ...
            let v3 = calculate_withdrawal_fees(arg0.start, arg0.end, v2, 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::get_tx_fee(arg1));
            assert!(0x2::coin::value<0x2::sui::SUI>(arg3) >= v3, 13);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg3, v3, arg7), 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::get_withdrawor(arg1));
        };
        if (0x1::option::is_some<u64>(&arg6)) {
            let v4 = 0x1::option::destroy_some<u64>(arg6);
            assert!(arg0.meta.can_update_rate, 3);
            assert!(v4 > 0, 6);
            let v5 = 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::utils::timestamp_seconds(arg2);
            ...
            if (v7 < arg0.end && arg0.meta.automatic_withdrawal) {
                let v8 = calculate_withdrawal_fees(v7, arg0.end, arg0.meta.withdrawal_frequency, 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::get_tx_fee(arg1));
                assert!(0x2::coin::value<0x2::sui::SUI>(arg3) >= v8, 13);
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg3, v8, arg7), 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::get_withdrawor(arg1));
            };
        };
    }
    ...
    public entry fun withdraw<T0>(arg0: &mut Contract<T0>, arg1: &0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::Config, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.closed, 5);
        let v0 = 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::utils::timestamp_seconds(arg2);
    ...
    fun withdraw_by_amount<T0>(arg0: &mut Contract<T0>, arg1: &0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::Config, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 > 0) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.balance, v1, arg4), 0x2844f6bcf1c2054175cc92627ec74426a890a8a4f6f2c50f8304d34b0aadf12::admin::get_treasury(arg1));
        };
        if (v2 > 0) {
