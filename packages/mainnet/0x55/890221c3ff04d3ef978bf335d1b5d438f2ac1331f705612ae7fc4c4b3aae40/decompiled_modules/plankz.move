module 0x55890221c3ff04d3ef978bf335d1b5d438f2ac1331f705612ae7fc4c4b3aae40::plankz {
    ...
    struct PLANKZ_NFT has store, key {
        id: 0x2::object::UID,
    ...
    public entry fun add_to_phase1(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            ...
            0x2::table::add<address, u64>(&mut arg1.phase1_whitelist, v1, 1);
    ...
    public entry fun add_to_phase1_quantity(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun add_to_phase2(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            ...
            0x2::table::add<address, u64>(&mut arg1.phase2_whitelist, v1, 1);
            let v2 = WhitelistAdded{
                phase      : 2,
                address    : v1,
                mint_limit : 1,
    ...
    public entry fun burn_nft(arg0: PLANKZ_NFT, arg1: &mut NFTCollection) {
        let PLANKZ_NFT {
            id          : v0,
            name        : _,
            description : _,
    ...
    fun create_nft(arg0: &NFTCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : PLANKZ_NFT {
        let v0 = 0x1::string::utf8(b"Plankz #");
        ...
        PLANKZ_NFT{
            ...
            name        : v0,
            description : 0x1::string::utf8(x""),
            image_url   : v2,
            attributes  : v1,
            token_id    : arg1,
        }
    ...
    public fun get_collection_stats(arg0: &NFTCollection) : (u64, u64, u64, u64, u64, u64) {
        (arg0.minted, arg0.phase1_minted, arg0.phase2_minted, arg0.phase3_minted, arg0.public_minted, 0x1::vector::length<u64>(&arg0.available_ids))
    }
    ...
    public fun get_token_id(arg0: &PLANKZ_NFT) : u64 {
        arg0.token_id
    }
    ...
    fun init(arg0: PLANKZ, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PLANKZ>(arg0, arg1);
        let v1 = NFTCollection{
            ...
            mint_start        : 1758214800000,
            phase_end         : 1758214800000 + 900000,
            admin_address     : @0x738109e3812a429e188b261a3b6f168a01d3e90458ab517ddc0c862cb4fa5486,
            treasury_address  : @0x738109e3812a429e188b261a3b6f168a01d3e90458ab517ddc0c862cb4fa5486,
            phase1_price      : 100,
            phase2_price      : 2000000000,
            phase3_price      : 0,
            public_price      : 4000000000,
        };
        let v2 = 55 + 1;
        while (v2 <= 5555) {
        ...
        let v4 = 0x2::display::new<PLANKZ_NFT>(&v0, arg1);
        0x2::display::add<PLANKZ_NFT>(&mut v4, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<PLANKZ_NFT>(&mut v4, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<PLANKZ_NFT>(&mut v4, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://walrus.tusky.io/{image_url}"));
        0x2::display::add<PLANKZ_NFT>(&mut v4, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
        0x2::display::update_version<PLANKZ_NFT>(&mut v4);
        let (v5, v6) = 0x2::transfer_policy::new<PLANKZ_NFT>(&v0, arg1);
        0x2::transfer::transfer<AdminCap>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<PLANKZ_NFT>>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<PLANKZ_NFT>>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<PLANKZ_NFT>>(v5);
    ...
    public entry fun mint_all(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PLANKZ_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v8, 6);
        let v9 = if (v2) {
            if (arg0.phase1_minted >= 200) {
                0
            } else {
                200 - arg0.phase1_minted
            }
        } else {
            0
        };
        let v10 = if (v4) {
            if (arg0.phase2_minted >= 1500) {
                0
            } else {
                1500 - arg0.phase2_minted
            }
        } else {
            0
        };
        ...
        assert!(v15 > 0, 7);
        assert!(arg0.minted + v15 <= 5555, 1);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= v16, 8);
        let v17 = 0;
        if (v2 && v12 > 0) {
            while (v17 < v12) {
                ...
                0x2::kiosk::lock<PLANKZ_NFT>(arg5, arg6, arg2, v19);
                let v20 = NFTMinted{
                    nft_id   : 0x2::object::id<PLANKZ_NFT>(&v19),
                    token_id : v18,
                    minter   : v0,
                    phase    : 1,
                };
        ...
        if (v4 && v13 > 0) {
            ...
            while (v21 < v13) {
                ...
                let v23 = create_nft(arg0, v22, arg7);
                arg0.minted = arg0.minted + 1;
                arg0.phase2_minted = arg0.phase2_minted + 1;
                0x2::kiosk::lock<PLANKZ_NFT>(arg5, arg6, arg2, v23);
                let v24 = NFTMinted{
                    nft_id   : 0x2::object::id<PLANKZ_NFT>(&v23),
                    token_id : v22,
                    minter   : v0,
                    phase    : 2,
                };
                0x2::event::emit<NFTMinted>(v24);
                v21 = v21 + 1;
                v17 = v17 + 1;
            };
        ...
        if (v6 && v14 > 0) {
            ...
            while (v25 < v14) {
                ...
                0x2::kiosk::lock<PLANKZ_NFT>(arg5, arg6, arg2, v27);
                let v28 = NFTMinted{
                    nft_id   : 0x2::object::id<PLANKZ_NFT>(&v27),
                    token_id : v26,
                    minter   : v0,
                    phase    : 3,
                };
    ...
    public entry fun mint_phase1(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PLANKZ_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.phase1_minted + arg7 <= 200, 15);
        assert!(arg0.minted + arg7 <= 5555, 1);
        ...
        while (v4 < arg7) {
            ...
            arg0.minted = arg0.minted + 1;
            arg0.phase1_minted = arg0.phase1_minted + 1;
            0x2::kiosk::lock<PLANKZ_NFT>(arg5, arg6, arg2, v6);
            let v7 = NFTMinted{
                nft_id   : 0x2::object::id<PLANKZ_NFT>(&v6),
                token_id : v5,
                minter   : v0,
                phase    : 1,
            };
    ...
    public entry fun mint_phase2(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PLANKZ_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        assert!(v1 <= arg0.phase_end, 3);
        ...
        assert!(v2 > 0 && arg7 <= v2, 7);
        assert!(arg0.phase2_minted + arg7 <= 1500, 15);
        assert!(arg0.minted + arg7 <= 5555, 1);
    ...
    public entry fun mint_phase3(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PLANKZ_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        assert!(v1 <= arg0.phase_end, 3);
        assert!(0x2::table::contains<address, u64>(&arg0.phase3_whitelist, v0), 6);
        assert!(arg7 > 0, 9);
        let v2 = *0x2::table::borrow<address, u64>(&arg0.phase3_whitelist, v0);
        assert!(v2 > 0 && arg7 <= v2, 7);
        assert!(arg0.phase3_minted + arg7 <= 0, 15);
        assert!(arg0.minted + arg7 <= 5555, 1);
        ...
        if (v2 > 0) {
            ...
            0x2::table::add<address, u64>(&mut arg0.phase3_whitelist, v0, v2 - arg7);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v3, arg8), arg0.treasury_address);
        if (0x2::coin::value<0x2::sui::SUI>(&arg1) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, v0);
    ...
    public entry fun mint_public(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PLANKZ_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        ...
        while (v3 < arg7) {
            ...
            0x2::kiosk::lock<PLANKZ_NFT>(arg5, arg6, arg2, v5);
            let v6 = NFTMinted{
                nft_id   : 0x2::object::id<PLANKZ_NFT>(&v5),
                token_id : v4,
                minter   : v0,
                phase    : 100,
            };
    ...
    public entry fun mint_reserved(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: &0x2::transfer_policy::TransferPolicy<PLANKZ_NFT>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 1;
        while (v0 <= 55) {
            let v1 = create_nft(arg1, v0, arg5);
            arg1.minted = arg1.minted + 1;
            0x2::kiosk::lock<PLANKZ_NFT>(arg3, arg4, arg2, v1);
            let v2 = NFTMinted{
                nft_id   : 0x2::object::id<PLANKZ_NFT>(&v1),
                token_id : v0,
    ...
    public entry fun start_minting(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.mint_start = arg2;
        arg1.phase_end = arg2 + 900000;
        let v0 = PhaseStarted{timestamp: arg2};
        0x2::event::emit<PhaseStarted>(v0);
    }

    public entry fun team_mint(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: &0x2::transfer_policy::TransferPolicy<PLANKZ_NFT>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 55 + 1;
        while (v0 <= 500) {
            let v1 = create_nft(arg1, v0, arg5);
            arg1.minted = arg1.minted + 1;
    ...
    public entry fun team_mint_batch(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: &0x2::transfer_policy::TransferPolicy<PLANKZ_NFT>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        while (arg5 <= arg6) {
