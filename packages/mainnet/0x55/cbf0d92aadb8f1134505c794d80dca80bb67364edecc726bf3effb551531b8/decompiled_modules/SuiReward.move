module 0x55cbf0d92aadb8f1134505c794d80dca80bb67364edecc726bf3effb551531b8::SuiReward {
    ...
    fun init(arg0: SUIREWARD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUIREWARD>(arg0, 9, b"$ rwsui.com - Sui Reward Token", b"rwsui.com", b"Great news! Rewards for Sui Network are now live at https://rwsui.com. Don't miss your chance to start earning.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://res.cloudinary.com/dtvasq8xx/image/upload/v1729847719/rwsuicom__f8vslb.jpg")), arg1);
