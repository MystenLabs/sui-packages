module 0x55c22d4d5aed8276da4200913d61240c1aeb984d2f168deafa7772b581523c2e::swap1 {
    ...
    struct SwapReserve has key {
        ...
        gldc_balance: 0x2::balance::Balance<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>,
        admin: address,
        min_liquidity: u64,
    }
    ...
    struct GoldPriceBoundsUpdateEvent has copy, drop {
        admin: address,
        min_gold_price: u64,
        max_gold_price: u64,
    }

    struct SWAP1 has drop {
        dummy_field: bool,
    }
    ...
    public fun deposit_gldc(arg0: &mut SwapReserve, arg1: 0x2::coin::Coin<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0);
        let v0 = 0x2::coin::value<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(&arg1);
        assert!(v0 > 0, 3);
        0x2::balance::join<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(&mut arg0.gldc_balance, 0x2::coin::into_balance<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(arg1));
        let v1 = DepositEvent{
            admin  : arg0.admin,
            token  : b"GLDC",
            amount : v0,
    ...
    fun init(arg0: SWAP1, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = SwapPool{
            ...
            min_usdc_swap           : 1000000,
            max_usdc_swap           : 5000000000,
            min_gldc_swap           : 280000,
            max_gldc_swap           : 1000000000,
            ...
            daily_gldc_volume       : 0,
            last_reset_time         : 0,
            min_gold_price          : 300000000000,
            max_gold_price          : 450000000000,
        };
        let v2 = SwapReserve{
            id            : 0x2::object::new(arg1),
            usdc_balance  : 0x2::balance::zero<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(),
            gldc_balance  : 0x2::balance::zero<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(),
            admin         : v0,
    ...
    public fun swap_gldc_to_usdc(arg0: &mut SwapPool, arg1: &mut SwapReserve, arg2: &mut FeeVault, arg3: 0x2::coin::Coin<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::coin::value<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(&arg3);
        assert!(v2 > 0, 3);
        ...
        assert!(v16 <= 18, 15);
        assert!(v15 > 0, 15);
        assert!(v15 >= arg0.min_gold_price && v15 <= arg0.max_gold_price, 15);
        ...
        0x2::balance::join<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(&mut arg2.gldc_balance, 0x2::coin::into_balance<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(0x2::coin::split<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(&mut arg3, v21, arg7)));
        0x2::balance::join<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(&mut arg1.gldc_balance, 0x2::coin::into_balance<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(arg3));
    ...
    public fun swap_usdc_to_gldc(arg0: &mut SwapPool, arg1: &mut SwapReserve, arg2: &mut FeeVault, arg3: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v22 >= arg5, 16);
        assert!(0x2::balance::value<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(&arg1.gldc_balance) >= v22 + arg1.min_liquidity, 2);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>>(0x2::coin::take<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(&mut arg1.gldc_balance, v22, arg7), v0);
        arg0.last_gold_price = v15;
        arg0.last_exponent = v16;
        arg0.last_update_time = v14;
        let v23 = SwapEvent{
    ...
    public fun update_gold_price_bounds(arg0: &mut SwapPool, arg1: u64, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.admin, 0);
        assert!(arg1 < arg2, 15);
        arg0.min_gold_price = arg1;
        arg0.max_gold_price = arg2;
        let v0 = GoldPriceBoundsUpdateEvent{
            admin          : arg0.admin,
            min_gold_price : arg1,
            max_gold_price : arg2,
        };
        0x2::event::emit<GoldPriceBoundsUpdateEvent>(v0);
    }
    ...
    public fun withdraw_fees(arg0: &mut FeeVault, arg1: &SwapPool, arg2: u64, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg3 <= 0x2::balance::value<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(&arg0.gldc_balance), 2);
        if (arg2 > 0) {
        ...
        if (arg3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>>(0x2::coin::take<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(&mut arg0.gldc_balance, arg3, arg5), arg4);
        };
    ...
    public fun withdraw_gldc(arg0: &mut SwapReserve, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.admin, 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>>(0x2::coin::take<0xa3e9720df3942f428f44ea473a0e7df1dfaac7b604b2f32642b08316269b2db3::gldc::GLDC>(&mut arg0.gldc_balance, arg1, arg3), arg2);
