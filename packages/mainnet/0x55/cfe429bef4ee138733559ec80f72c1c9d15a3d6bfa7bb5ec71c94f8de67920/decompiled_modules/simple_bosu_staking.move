module 0x55cfe429bef4ee138733559ec80f72c1c9d15a3d6bfa7bb5ec71c94f8de67920::simple_bosu_staking {
    ...
    public entry fun claim_rewards<T0>(arg0: &mut StakingPool<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v3 > 0) {
            ...
            if (0x2::balance::value<T0>(&arg0.reward_pool) >= v4) {
    ...
    public fun get_pool_info<T0>(arg0: &StakingPool<T0>) : (u64, u64, u64, u64, bool) {
        (arg0.lock_period_days, arg0.daily_reward_rate, arg0.early_unstake_penalty, arg0.total_staked, arg0.is_emergency)
    }
