module 0x55c6a5063548ddd628c17550de278613b0d7e232027c5742397e8a5ed5c6c668::nft {
    ...
    entry fun mint(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Nft{
            ...
            name        : 0x1::string::utf8(b"lz1998"),
            description : 0x1::string::utf8(b"lz1998 NFT"),
            creator     : 0x2::tx_context::sender(arg1),
            url         : 0x2::url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/9082086?v=4"),
        };
