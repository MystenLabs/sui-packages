module 0x555312ba84e0b77ee2aab2a31bcb96a7d317ec5d561e879065f5efdfc48df65d::cnsnft1817 {
    struct CNSNFT1817 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1817, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1817>(arg0, arg1);
