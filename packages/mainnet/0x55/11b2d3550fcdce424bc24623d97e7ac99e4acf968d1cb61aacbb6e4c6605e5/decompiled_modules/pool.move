module 0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::pool {
    ...
    public fun calc_reward_for<T0, T1>(arg0: &Pool<T0, T1>, arg1: &0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::position::Position) : u256 {
        (0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::position::value(arg1) as u256) * arg0.acc_reward_per_share / 1000000
    }
    ...
    public fun estimate_pending_reward<T0, T1>(arg0: &Pool<T0, T1>, arg1: &0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::position::Position, arg2: &0x2::clock::Clock) : u64 {
        ...
        let v3 = v2;
        if (0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::utils::to_seconds(v0) > 0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::utils::to_seconds(arg0.last_reward_at_ms) && v1 != 0) {
            v3 = v2 + ((get_multiplier<T0, T1>(arg0, v0) * arg0.reward_per_seconds) as u256) * 1000000 / (v1 as u256);
        };
        (((0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::position::value(arg1) as u256) * v3 / 1000000 - 0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::position::reward_debt(arg1)) as u64)
    }
    ...
    public fun update_pool<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock) {
        if (0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::utils::to_seconds(0x2::clock::timestamp_ms(arg1)) <= 0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::utils::to_seconds(arg0.last_reward_at_ms)) {
            return
        };
        ...
        if (v0 == 0) {
            arg0.last_reward_at_ms = 0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::utils::to_milliseconds(0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::utils::to_seconds(0x2::clock::timestamp_ms(arg1)));
            return
        };
        arg0.acc_reward_per_share = arg0.acc_reward_per_share + ((get_multiplier<T0, T1>(arg0, 0x2::clock::timestamp_ms(arg1)) * arg0.reward_per_seconds) as u256) * 1000000 / (v0 as u256);
        arg0.last_reward_at_ms = 0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::utils::to_milliseconds(0x5511b2d3550fcdce424bc24623d97e7ac99e4acf968d1cb61aacbb6e4c6605e5::utils::to_seconds(0x2::clock::timestamp_ms(arg1)));
    }
