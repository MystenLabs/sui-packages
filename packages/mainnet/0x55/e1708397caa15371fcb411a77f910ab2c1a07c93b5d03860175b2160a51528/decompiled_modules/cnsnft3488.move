module 0x55e1708397caa15371fcb411a77f910ab2c1a07c93b5d03860175b2160a51528::cnsnft3488 {
    struct CNSNFT3488 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3488, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3488>(arg0, arg1);
