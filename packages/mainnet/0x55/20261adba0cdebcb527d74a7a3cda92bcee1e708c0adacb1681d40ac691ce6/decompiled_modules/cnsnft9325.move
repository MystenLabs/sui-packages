module 0x5520261adba0cdebcb527d74a7a3cda92bcee1e708c0adacb1681d40ac691ce6::cnsnft9325 {
    struct CNSNFT9325 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9325, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9325>(arg0, arg1);
