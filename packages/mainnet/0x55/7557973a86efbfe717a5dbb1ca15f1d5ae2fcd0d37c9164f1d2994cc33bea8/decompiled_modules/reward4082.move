module 0x557557973a86efbfe717a5dbb1ca15f1d5ae2fcd0d37c9164f1d2994cc33bea8::reward4082 {
    struct REWARD4082 has drop {
        dummy_field: bool,
    }

    struct TICKET_4082 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4082(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4082>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4082>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4082, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4082>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4082>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4082>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4082>>(v5, 0x2::tx_context::sender(arg1));
    }
