module 0x55bf2083cde7d17187f12c56d2e36d39d6aed228095aed0c846dd7161923fe6b::bbb {
    struct BBB has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BBB, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<BBB>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BBB     ")))), trim_right(b"BBB                             "), trim_right(b"Token creator token.                                                                                                                                                                                                                                                                                                            "), v2, arg1);
