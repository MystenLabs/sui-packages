module 0x55fb600ee9b94c4ac9b2e54732f6693525406f478ced5c4d6f026246883b4a8f::cnsnft4007 {
    struct CNSNFT4007 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4007, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4007>(arg0, arg1);
