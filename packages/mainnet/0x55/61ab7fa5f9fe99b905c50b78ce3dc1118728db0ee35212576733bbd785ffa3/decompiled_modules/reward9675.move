module 0x5561ab7fa5f9fe99b905c50b78ce3dc1118728db0ee35212576733bbd785ffa3::reward9675 {
    struct REWARD9675 has drop {
        dummy_field: bool,
    }

    struct TICKET_9675 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9675(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9675>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9675>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9675, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9675>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9675>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9675>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9675>>(v5, 0x2::tx_context::sender(arg1));
    }
