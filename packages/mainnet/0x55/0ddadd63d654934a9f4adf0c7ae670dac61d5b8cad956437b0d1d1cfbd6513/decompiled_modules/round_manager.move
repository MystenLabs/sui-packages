module 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::round_manager {
    ...
    public entry fun add_faith_treasury_cap_to_global_v2_entry(arg0: &mut GlobalV2, arg1: 0x2::coin::TreasuryCap<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>) {
        ...
        0x2::dynamic_object_field::add<FaithTreasuryCapKey, 0x2::coin::TreasuryCap<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>>(&mut arg0.id, v0, arg1);
    }
    ...
    fun assert_version_v2(arg0: &GlobalV2) {
        assert!(arg0.version == 5, 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_INVALID_VERSION());
    }
    ...
    fun claim_faith_internal(arg0: &mut GlobalV2, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::claim_if_any_with_multiplier(arg1, 1500, soul_age_multiplier_bps_for_user(arg0, arg1), &mut arg0.cap, &mut arg0.idx, &mut arg0.buckets);
        if (v0 > 0) {
            let v1 = faith_treasury_cap_mut(arg0);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>>(0x2::coin::mint<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>(v1, v0, arg2), arg1);
            if (0x2::table::contains<address, PlayerRecord>(&arg0.player_records, arg1)) {
                let v2 = 0x2::table::borrow_mut<address, PlayerRecord>(&mut arg0.player_records, arg1);
                v2.soul_age_rounds = 0;
                v2.soul_start_round = arg0.round.index;
            };
        };
        v0
    }
