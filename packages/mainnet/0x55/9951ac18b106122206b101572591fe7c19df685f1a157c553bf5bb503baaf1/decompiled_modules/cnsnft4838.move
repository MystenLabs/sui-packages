module 0x559951ac18b106122206b101572591fe7c19df685f1a157c553bf5bb503baaf1::cnsnft4838 {
    struct CNSNFT4838 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4838, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4838>(arg0, arg1);
