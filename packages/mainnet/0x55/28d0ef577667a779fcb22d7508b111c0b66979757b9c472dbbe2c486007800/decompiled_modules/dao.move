module 0xdde7f6b816b0a602ed57f3b5c2e264ab74726b96c4daef1ffe7f01eef25be761::dao {
    ...
    public entry fun take_profit(arg0: &0xdde7f6b816b0a602ed57f3b5c2e264ab74726b96c4daef1ffe7f01eef25be761::operator::OperatorCap, arg1: &mut DAOFund, arg2: &0xdde7f6b816b0a602ed57f3b5c2e264ab74726b96c4daef1ffe7f01eef25be761::dao_config::GlobalDaoConfig, arg3: vector<u64>, arg4: vector<u64>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < v0) {
            ...
            if (*v8 > 0) {
                v5 = v5 + *0x2::vec_map::get<0x1::ascii::String, u64>(&arg1.asset_balances, v6) * 0x1::u64::pow(10, 9) / 0x1::u64::pow(10, (*v9 as u8)) * *v8 / 10000;
            };
            v4 = v4 + 1;
        };
        let (v10, v11) = 0xdde7f6b816b0a602ed57f3b5c2e264ab74726b96c4daef1ffe7f01eef25be761::dao_config::get_dao_fee_config(arg2);
        let v12 = v5 - ((v5 * v10 / v11) as u64);
        if (v12 > ((arg1.fundraise_goal * (arg1.hurdle_rate_numerator + 10000) / 10000) as u64)) {
            v2 = true;
            v3 = (((((v12 - arg1.fundraise_goal * (arg1.hurdle_rate_numerator + 10000) / 10000) * arg1.carried_interest_numerator / 10000) as u64) * 10000 / v12) as u64);
        };
        let v13 = 0;
        let v14 = 0x2::vec_map::empty<0x1::ascii::String, u64>();
        let v15 = 0x2::vec_map::empty<0x1::ascii::String, u64>();
        while (v13 < v1) {
            let (v16, v17) = 0x2::vec_map::get_entry_by_idx_mut<0x1::ascii::String, u64>(&mut arg1.asset_balances, v13);
        ...
        0xdde7f6b816b0a602ed57f3b5c2e264ab74726b96c4daef1ffe7f01eef25be761::stamp::transfer(0xdde7f6b816b0a602ed57f3b5c2e264ab74726b96c4daef1ffe7f01eef25be761::stamp::mint_and_emit(0x2::object::id<DAOFund>(arg1), v15, arg6), 0x2::tx_context::sender(arg6));
        if (0x2::vec_map::is_empty<0x1::ascii::String, u64>(&v14)) {
            0x2::vec_map::destroy_empty<0x1::ascii::String, u64>(v14);
        } else {
            0xdde7f6b816b0a602ed57f3b5c2e264ab74726b96c4daef1ffe7f01eef25be761::stamp::transfer(0xdde7f6b816b0a602ed57f3b5c2e264ab74726b96c4daef1ffe7f01eef25be761::stamp::mint_and_emit(0x2::object::id<DAOFund>(arg1), v14, arg6), arg1.creator);
        };
