module 0x550d6bf47b36609c8acc99fad4154a30df33e1d3a79a0a92dabb6d17d768bb2b::reward7120 {
    struct REWARD7120 has drop {
        dummy_field: bool,
    }

    struct TICKET_7120 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7120(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7120>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7120>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7120, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7120>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7120>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7120>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7120>>(v5, 0x2::tx_context::sender(arg1));
    }
