module 0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::kiosk_auctionhouse {
    ...
    public fun accept_offer<T0: store + key, T1: store + key>(arg0: &mut Kiosk_Auctionhouse_Store, arg1: &mut 0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::kiosk::Kiosk, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: 0x2::object::ID, arg9: &0x2::transfer_policy::TransferPolicy<T0>, arg10: 0x2::coin::Coin<0x2::sui::SUI>, arg11: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg10));
    ...
    public entry fun complete_atomic_swap<T0: store + key, T1: store + key>(arg0: &mut Kiosk_Auctionhouse_Store, arg1: &mut 0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::kiosk::Kiosk, arg6: 0x2::object::ID, arg7: &mut 0x2::kiosk::Kiosk, arg8: &0x2::kiosk::KioskOwnerCap, arg9: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg10: &mut 0x2::transfer_policy::TransferPolicy<T1>, arg11: 0x2::coin::Coin<0x2::sui::SUI>, arg12: 0x2::coin::Coin<0x2::sui::SUI>, arg13: 0x2::coin::Coin<0x2::sui::SUI>, arg14: &mut 0x2::tx_context::TxContext) {
        ...
        0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg11));
        0x2::object::delete(v0);
    ...
    public fun crate_kiosk_auctionhouse(arg0: &0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Kiosk_Auctionhouse_Store {
        Kiosk_Auctionhouse_Store{
            id            : 0x2::object::new(arg1),
            auction_house : 0x2::object::id<0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::auctionhouse::AuctionHouse>(arg0),
            orphaned_caps : 0x2::object::new(arg1),
        }
    }

    public entry fun create_and_share_kiosk_auctionhouse_store(arg0: &0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun emergency_reset_accept_offer<T0: store + key>(arg0: &mut Kiosk_Auctionhouse_Store, arg1: &0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 8);
    ...
    public entry fun emergency_reset_offer<T0: store + key, T1: store + key>(arg0: &mut Kiosk_Auctionhouse_Store, arg1: &0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 8);
    ...
    public entry fun recover_orphaned_cap<T0: store + key>(arg0: &mut Kiosk_Auctionhouse_Store, arg1: &0x55ab71dd81288556e39036109793e319beebece6b4093cc227d143a3fa29504e::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) {
