module 0x257a2e2574ba118fb25ee2bb110db032a827a70e2b621dfc0005c8cffbc24a48::withdrawal_queue {
    ...
    struct BridgeMinFeeKey has copy, drop, store {
        dummy_field: bool,
    }

    struct BridgeMinFeeConfig has store {
        default_min_fee: u64,
        chain_min_fees: 0x2::vec_map::VecMap<u16, u64>,
    }
    ...
    struct BridgeMinFeeUpdated<phantom T0> has copy, drop {
        min_fee: u64,
    }

    struct ChainBridgeMinFeeUpdated<phantom T0> has copy, drop {
        evm_destination_chain: u16,
        min_fee: u64,
        removed: bool,
    }
    ...
    fun assert_valid_package_version<T0>(arg0: &Queue<T0>) {
        let v0 = 4;
        assert!(0x2::vec_set::contains<u16>(&arg0.allowed_versions, &v0), 13906838284628000783);
    }
    ...
    fun borrow_min_fee_config_mut<T0>(arg0: &mut Queue<T0>) : &mut BridgeMinFeeConfig {
        let v0 = BridgeMinFeeKey{dummy_field: false};
        if (!0x2::dynamic_field::exists<BridgeMinFeeKey>(&arg0.id, v0)) {
            let v1 = BridgeMinFeeKey{dummy_field: false};
            let v2 = BridgeMinFeeConfig{
                default_min_fee : 0,
                chain_min_fees  : 0x2::vec_map::empty<u16, u64>(),
            };
            0x2::dynamic_field::add<BridgeMinFeeKey, BridgeMinFeeConfig>(&mut arg0.id, v1, v2);
        };
        let v3 = BridgeMinFeeKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<BridgeMinFeeKey, BridgeMinFeeConfig>(&mut arg0.id, v3)
    }

    public fun bridge_chain_min_fees<T0>(arg0: &Queue<T0>) : (vector<u16>, vector<u64>) {
        let v0 = vector[];
        let v1 = vector[];
        let v2 = BridgeMinFeeKey{dummy_field: false};
        if (0x2::dynamic_field::exists<BridgeMinFeeKey>(&arg0.id, v2)) {
            let v3 = BridgeMinFeeKey{dummy_field: false};
            let v4 = 0x2::dynamic_field::borrow<BridgeMinFeeKey, BridgeMinFeeConfig>(&arg0.id, v3);
            let v5 = 0;
            while (v5 < 0x2::vec_map::length<u16, u64>(&v4.chain_min_fees)) {
                let (v6, v7) = 0x2::vec_map::get_entry_by_idx<u16, u64>(&v4.chain_min_fees, v5);
    ...
    public fun bridge_default_min_fee<T0>(arg0: &Queue<T0>) : u64 {
        let v0 = BridgeMinFeeKey{dummy_field: false};
        if (0x2::dynamic_field::exists<BridgeMinFeeKey>(&arg0.id, v0)) {
            let v2 = BridgeMinFeeKey{dummy_field: false};
            0x2::dynamic_field::borrow<BridgeMinFeeKey, BridgeMinFeeConfig>(&arg0.id, v2).default_min_fee
        } else {
            0
        }
    }
    ...
    public fun bridge_fee_amount<T0>(arg0: &Queue<T0>, arg1: u16, arg2: u64) : u64 {
        ...
        let v1 = if (0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::eq(v0, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::zero())) {
            0
        } else {
        ...
        let v2 = bridge_min_fee_floor<T0>(arg0, arg1);
        if (v1 >= v2) {
            v1
        } else {
            v2
    ...
    public fun bridge_min_fee<T0>(arg0: &Queue<T0>, arg1: u16) : u64 {
        bridge_min_fee_floor<T0>(arg0, arg1)
    }

    fun bridge_min_fee_floor<T0>(arg0: &Queue<T0>, arg1: u16) : u64 {
        let v0 = BridgeMinFeeKey{dummy_field: false};
        if (!0x2::dynamic_field::exists<BridgeMinFeeKey>(&arg0.id, v0)) {
            return 0
        };
        let v1 = BridgeMinFeeKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow<BridgeMinFeeKey, BridgeMinFeeConfig>(&arg0.id, v1);
        if (0x2::vec_map::contains<u16, u64>(&v2.chain_min_fees, &arg1)) {
            *0x2::vec_map::get<u16, u64>(&v2.chain_min_fees, &arg1)
        } else {
            v2.default_min_fee
        }
    }
    ...
    public fun create_queue<T0>(arg0: &0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Queue<T0>{
            ...
            allowed_versions : 0x2::vec_set::singleton<u16>(4),
        };
        0x2::transfer::share_object<Queue<T0>>(v0);
    }

    fun decode_native_route<T0>(arg0: &vector<u8>) : u64 {
        assert!(0x1::vector::length<u8>(arg0) > 0, 13906838641109630981);
        assert!(*0x1::vector::borrow<u8>(arg0, 0) == 1, 13906838645404598277);
        let v0 = b"";
        let v1 = 1;
        ...
        assert!(0x1::vector::length<u8>(&v3) == 0, 13906838701239173125);
        assert!(0x2::bcs::peel_vec_u8(&mut v2) == 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())), 13906838709829107717);
        0x2::bcs::peel_u64(&mut v2)
    }

    fun decode_wormhole_route(arg0: &vector<u8>) : WormholeRoute {
        assert!(0x1::vector::length<u8>(arg0) > 0, 13906838529440481285);
        assert!(*0x1::vector::borrow<u8>(arg0, 0) == 0, 13906838533735448581);
        let v0 = b"";
        let v1 = 1;
        while (v1 < 0x1::vector::length<u8>(arg0)) {
            0x1::vector::push_back<u8>(&mut v0, *0x1::vector::borrow<u8>(arg0, v1));
        ...
        let v2 = 0x2::bcs::new(v0);
        let v3 = 0x2::bcs::into_remainder_bytes(v2);
        assert!(0x1::vector::length<u8>(&v3) == 0, 13906838598159958021);
        WormholeRoute{
    ...
    public fun execute_native<T0, T1>(arg0: &mut Queue<T1>, arg1: u64, arg2: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest, arg3: &mut 0xebd4336ac8d5a12fc7d314b84f8c06a8190dcdfc3c9ef4133ffb53e0aed3c70a::custody_vault::CustodyVault<T1>, arg4: &mut 0x86e05a9f95757ed4574cf209683e69e5e1fa4ac7ce7a529c91848343a232c989::credit_registry::CreditRegistry<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<T0>(&v7) >= decode_native_route<T0>(&v5), 13906837563073101833);
    ...
    public fun has_chain_bridge_min_fee<T0>(arg0: &Queue<T0>, arg1: u16) : bool {
        let v0 = BridgeMinFeeKey{dummy_field: false};
        if (!0x2::dynamic_field::exists<BridgeMinFeeKey>(&arg0.id, v0)) {
            return false
        };
        let v1 = BridgeMinFeeKey{dummy_field: false};
        0x2::vec_map::contains<u16, u64>(&0x2::dynamic_field::borrow<BridgeMinFeeKey, BridgeMinFeeConfig>(&arg0.id, v1).chain_min_fees, &arg1)
    }
    ...
    fun peek_route_tag(arg0: &vector<u8>) : u8 {
        assert!(0x1::vector::length<u8>(arg0) > 0, 13906838499375841287);
        let v0 = *0x1::vector::borrow<u8>(arg0, 0);
        assert!(v0 == 0 || v0 == 1, 13906838507965775879);
        v0
    }
    ...
    fun resolve_bridge_fee<T0>(arg0: &Queue<T0>, arg1: u16, arg2: u64) : u64 {
        ...
        assert!(arg2 > v0, 13906838477901791251);
        v0
    }
    ...
    public fun set_bridge_min_fee<T0>(arg0: &mut Queue<T0>, arg1: &0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::AdminCap, arg2: u64) {
        assert_valid_package_version<T0>(arg0);
        borrow_min_fee_config_mut<T0>(arg0).default_min_fee = arg2;
        let v0 = BridgeMinFeeUpdated<T0>{min_fee: arg2};
        0x2::event::emit<BridgeMinFeeUpdated<T0>>(v0);
    }
    ...
    public fun set_chain_bridge_min_fee<T0>(arg0: &mut Queue<T0>, arg1: &0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::AdminCap, arg2: u16, arg3: u64) {
        assert_valid_package_version<T0>(arg0);
        let v0 = borrow_min_fee_config_mut<T0>(arg0);
        if (0x2::vec_map::contains<u16, u64>(&v0.chain_min_fees, &arg2)) {
            *0x2::vec_map::get_mut<u16, u64>(&mut v0.chain_min_fees, &arg2) = arg3;
        } else {
            0x2::vec_map::insert<u16, u64>(&mut v0.chain_min_fees, arg2, arg3);
        };
        let v1 = ChainBridgeMinFeeUpdated<T0>{
            evm_destination_chain : arg2,
            min_fee               : arg3,
            removed               : false,
        };
        0x2::event::emit<ChainBridgeMinFeeUpdated<T0>>(v1);
    }
    ...
    public fun unset_chain_bridge_min_fee<T0>(arg0: &mut Queue<T0>, arg1: &0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::AdminCap, arg2: u16) {
        assert_valid_package_version<T0>(arg0);
        let v0 = BridgeMinFeeKey{dummy_field: false};
        let v1 = if (0x2::dynamic_field::exists<BridgeMinFeeKey>(&arg0.id, v0)) {
            let v2 = BridgeMinFeeKey{dummy_field: false};
            let v3 = 0x2::dynamic_field::borrow_mut<BridgeMinFeeKey, BridgeMinFeeConfig>(&mut arg0.id, v2);
            if (0x2::vec_map::contains<u16, u64>(&v3.chain_min_fees, &arg2)) {
                let (_, _) = 0x2::vec_map::remove<u16, u64>(&mut v3.chain_min_fees, &arg2);
                true
            } else {
                false
            }
        ...
        let v6 = ChainBridgeMinFeeUpdated<T0>{
            evm_destination_chain : arg2,
            min_fee               : bridge_min_fee<T0>(arg0, arg2),
            removed               : v1,
        };
        0x2::event::emit<ChainBridgeMinFeeUpdated<T0>>(v6);
    }
