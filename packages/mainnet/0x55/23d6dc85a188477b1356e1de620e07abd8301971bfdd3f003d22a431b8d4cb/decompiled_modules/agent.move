module 0x5523d6dc85a188477b1356e1de620e07abd8301971bfdd3f003d22a431b8d4cb::agent {
    ...
    fun init(arg0: AGENT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGENT>(arg0, 9, b"MAT", b"My Agent Token", b"This is a test agent token", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://example.com/icon.png")), arg1);
