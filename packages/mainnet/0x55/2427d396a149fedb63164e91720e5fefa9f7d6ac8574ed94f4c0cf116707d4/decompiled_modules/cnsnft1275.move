module 0x552427d396a149fedb63164e91720e5fefa9f7d6ac8574ed94f4c0cf116707d4::cnsnft1275 {
    struct CNSNFT1275 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1275, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9491"));
        let v4 = 0x2::package::claim<CNSNFT1275>(arg0, arg1);
