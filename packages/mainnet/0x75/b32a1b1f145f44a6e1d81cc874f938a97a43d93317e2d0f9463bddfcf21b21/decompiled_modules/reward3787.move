module 0x75b32a1b1f145f44a6e1d81cc874f938a97a43d93317e2d0f9463bddfcf21b21::reward3787 {
    struct REWARD3787 has drop {
        dummy_field: bool,
    }

    struct TICKET_3787 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3787(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3787>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3787>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3787, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3787>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3787>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3787>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3787>>(v5, 0x2::tx_context::sender(arg1));
    }
