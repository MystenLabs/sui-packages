module 0x750ae7b19b5a837e6b171533b1ca3e340a135c81ea32ec180e0a854076fd3e97::floombus {
    ...
    fun init(arg0: FLOOMBUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<FLOOMBUS>(arg0, 9, b"FLOOMBUS", b"FLOOMBUS", b"This is FLOOMBUS", 0x1::option::some<0x2::url::Url>(v0), arg1);
        let v4 = v2;
