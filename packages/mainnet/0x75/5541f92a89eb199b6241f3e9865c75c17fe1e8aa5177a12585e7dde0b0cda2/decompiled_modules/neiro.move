module 0x755541f92a89eb199b6241f3e9865c75c17fe1e8aa5177a12585e7dde0b0cda2::neiro {
    ...
    fun init(arg0: NEIRO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<NEIRO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Neiro   ")))), trim_right(b"Baby Neiro                      "), trim_right(b"After an attempt on President Trump's life during his last speech, he told everyone to FIGHT, encouraging us to continue fighting to Make America Great Again                                                                                                                                                                   "), v2, arg1);
