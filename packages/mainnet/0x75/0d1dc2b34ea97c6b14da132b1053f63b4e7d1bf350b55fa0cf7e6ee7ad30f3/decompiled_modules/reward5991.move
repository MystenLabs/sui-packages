module 0x750d1dc2b34ea97c6b14da132b1053f63b4e7d1bf350b55fa0cf7e6ee7ad30f3::reward5991 {
    struct REWARD5991 has drop {
        dummy_field: bool,
    }

    struct TICKET_5991 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5991(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5991>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5991>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5991, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5991>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5991>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5991>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5991>>(v5, 0x2::tx_context::sender(arg1));
    }
