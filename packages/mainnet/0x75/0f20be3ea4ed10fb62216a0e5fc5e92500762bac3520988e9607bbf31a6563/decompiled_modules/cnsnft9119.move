module 0x750f20be3ea4ed10fb62216a0e5fc5e92500762bac3520988e9607bbf31a6563::cnsnft9119 {
    struct CNSNFT9119 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9119, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9119>(arg0, arg1);
