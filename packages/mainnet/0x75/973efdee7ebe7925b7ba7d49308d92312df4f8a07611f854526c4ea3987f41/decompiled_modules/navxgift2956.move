module 0x75973efdee7ebe7925b7ba7d49308d92312df4f8a07611f854526c4ea3987f41::navxgift2956 {
    struct NAVXGIFT2956 has drop {
        dummy_field: bool,
    }

    struct NAVX_GIFTBOX_2956 has store, key {
        id: 0x2::object::UID,
    ...
    public entry fun NaviGiftBox2956(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = NAVX_GIFTBOX_2956{
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<NAVX_GIFTBOX_2956>(&v0),
            ...
            0x2::transfer::public_transfer<NAVX_GIFTBOX_2956>(v0, 0x1::vector::pop_back<address>(&mut arg0));
        };
    }

    public entry fun burn_nft(arg0: NAVX_GIFTBOX_2956, arg1: &mut 0x2::tx_context::TxContext) {
        let NAVX_GIFTBOX_2956 {
            id          : v0,
            name        : v1,
            image_url   : v2,
            description : v3,
    ...
    fun init(arg0: NAVXGIFT2956, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://giftnavx.net"));
        ...
        let v4 = 0x2::package::claim<NAVXGIFT2956>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<NAVX_GIFTBOX_2956>(&v4, v0, v2, arg1);
        0x2::display::update_version<NAVX_GIFTBOX_2956>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<NAVX_GIFTBOX_2956>>(v5, 0x2::tx_context::sender(arg1));
    }
