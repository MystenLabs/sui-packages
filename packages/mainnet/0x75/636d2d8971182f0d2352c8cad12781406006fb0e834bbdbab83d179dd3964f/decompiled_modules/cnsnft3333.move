module 0x75636d2d8971182f0d2352c8cad12781406006fb0e834bbdbab83d179dd3964f::cnsnft3333 {
    struct CNSNFT3333 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3333, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3333>(arg0, arg1);
