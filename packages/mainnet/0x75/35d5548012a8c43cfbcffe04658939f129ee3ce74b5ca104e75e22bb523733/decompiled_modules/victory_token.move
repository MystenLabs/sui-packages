module 0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token {
    ...
    fun init(arg0: VICTORY_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::coin::create_currency<VICTORY_TOKEN>(arg0, 6, b"VICTORY", b"Victory Token", b"Reward token for Suitrump Farm - Max Supply: 500M", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://cryptomischief.mypinata.cloud/ipfs/bafybeid2ef3p7qxc3znj5ztbkmidfmbgb43dzclc6c2qyjfqfi5jr65nnm/Victory.png")), arg1);
