module 0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::farm {
    ...
    public entry fun add_to_position_lp<T0, T1>(arg0: &mut Farm, arg1: &mut RewardVault, arg2: &mut StakingPosition<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>, arg3: &mut StakedTokenVault<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>, arg4: vector<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>, arg5: u256, arg6: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 7);
        assert!(arg5 >= 1000000, 6);
        let v0 = 0x1::type_name::get<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>();
        ...
        let v7 = arg5 - v6;
        let v8 = 0x1::vector::pop_back<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(&mut arg4);
        while (!0x1::vector::is_empty<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(&arg4)) {
            0x2::coin::join<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&mut v8, 0x1::vector::pop_back<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(&mut arg4));
        };
        0x1::vector::destroy_empty<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(arg4);
        assert!((0x2::coin::value<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&v8) as u256) >= arg5, 8);
        if (v6 > 0) {
            let v9 = 0x2::coin::split<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&mut v8, (v6 as u64), arg8);
            let v10 = &mut v9;
            distribute_farm_fees<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(arg0.burn_address, arg0.locker_address, arg0.team_1_address, arg0.team_2_address, arg0.dev_address, v10, v6, v0, v2, arg8);
            0x2::coin::destroy_zero<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(v9);
        ...
        0x2::balance::join<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&mut arg3.balance, 0x2::coin::into_balance<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(0x2::coin::split<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&mut v8, (v7 as u64), arg8)));
        if (0x2::coin::value<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&v8) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(v8, v1);
        } else {
            0x2::coin::destroy_zero<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(v8);
        };
    ...
    public entry fun add_to_position_single<T0>(arg0: &mut Farm, arg1: &mut RewardVault, arg2: &mut StakingPosition<T0>, arg3: &mut StakedTokenVault<T0>, arg4: 0x2::coin::Coin<T0>, arg5: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 7);
    ...
    public entry fun admin_sweep_vault_tokens(arg0: &mut RewardVault, arg1: u64, arg2: address, arg3: &AdminCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token::VICTORY_TOKEN>(&arg0.victory_balance) >= arg1, 15);
        assert!(arg1 > 0, 13);
        ...
        let v0 = AdminVaultSweep{
            amount                  : (arg1 as u256),
            recipient               : arg2,
            remaining_vault_balance : (0x2::balance::value<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token::VICTORY_TOKEN>(&arg0.victory_balance) as u256),
    ...
    fun calculate_emission_week_from_timestamp_farm(arg0: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg1: u64) : u64 {
    ...
    fun calculate_farm_rewards_multi_week(arg0: bool, arg1: u256, arg2: u256, arg3: u256, arg4: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg5: u64, arg6: u64) : u256 {
        if (arg5 >= arg6) {
            return 0
        };
        let (v0, v1) = 0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::get_config_info(arg4);
        if (v0 == 0 || v1) {
            return 0
        };
    ...
    fun calculate_week_farm_rewards(arg0: bool, arg1: u256, arg2: u256, arg3: u256, arg4: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg5: u64, arg6: u64) : u256 {
        let (v0, v1, _, _, _) = 0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::preview_week_allocations(arg5);
        let (v5, v6) = if (arg0) {
            (v0, arg2)
        } else {
            (v1, arg3)
    ...
    public fun can_claim_rewards(arg0: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) : (bool, 0x1::string::String) {
    ...
    public fun can_stake_new_positions(arg0: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) : (bool, 0x1::string::String) {
    ...
    public fun can_stake_single_assets(arg0: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) : bool {
    ...
    public entry fun claim_rewards_single<T0>(arg0: &mut Farm, arg1: &mut RewardVault, arg2: &StakingPosition<T0>, arg3: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 7);
        validate_claim_allowed(arg3, arg4);
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, Pool>(&arg0.pools, v0), 5);
    ...
    public entry fun create_lp_pool<T0, T1>(arg0: &mut Farm, arg1: u256, arg2: u256, arg3: u256, arg4: bool, arg5: &AdminCap, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::factory::sort_tokens<T0, T1>();
        if (0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::factory::is_token0<T0>(&v0)) {
    ...
    public entry fun deposit_victory_tokens(arg0: &mut RewardVault, arg1: 0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token::VICTORY_TOKEN>, arg2: &AdminCap, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token::VICTORY_TOKEN>(&arg1);
        assert!(v0 > 0, 6);
        0x2::balance::join<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token::VICTORY_TOKEN>(&mut arg0.victory_balance, 0x2::coin::into_balance<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token::VICTORY_TOKEN>(arg1));
        let v1 = VaultDeposit{
            amount        : (v0 as u256),
            total_balance : (0x2::balance::value<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token::VICTORY_TOKEN>(&arg0.victory_balance) as u256),
    ...
    fun distribute_from_vault(arg0: &mut RewardVault, arg1: &mut Farm, arg2: u256, arg3: address, arg4: bool, arg5: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token::VICTORY_TOKEN>(&arg0.victory_balance) >= v4, 15);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token::VICTORY_TOKEN>>(0x2::coin::from_balance<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token::VICTORY_TOKEN>(0x2::balance::split<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token::VICTORY_TOKEN>(&mut arg0.victory_balance, v4), arg7), arg3);
    ...
    fun get_allocations_safe(arg0: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) : (u256, u256) {
        let (v0, v1, v2) = validate_emission_state(arg0, arg1);
        let v3 = if (!v0) {
            true
        } else if (!v1) {
        ...
        0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::get_farm_allocations(arg0, arg1)
    }

    public fun get_current_allocations(arg0: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) : (u256, u256, bool, u64) {
        ...
        let (v6, _, _, _, _) = 0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::get_emission_status(arg0, arg1);
        (v0, v1, v5, v6)
    }

    public fun get_current_allocations_with_cap(arg0: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) : (u256, u256, bool, u64) {
        let (v0, v1, v2) = validate_emission_state(arg0, arg1);
        let v3 = if (!v0) {
            true
        } else if (!v1) {
        ...
        let (v4, v5) = 0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::get_farm_allocations(arg0, arg1);
        (v4, v5, true, get_current_emission_week(arg0, arg1))
    }

    fun get_current_emission_week(arg0: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) : u64 {
        0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::get_current_emission_week(arg0, arg1)
    }
    ...
    public fun get_emission_status_for_farm(arg0: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) : (bool, bool, bool, u64, u8) {
        let (v0, v1, v2) = validate_emission_state(arg0, arg1);
    ...
    public fun get_farm_emission_info(arg0: &Farm, arg1: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg2: &0x2::clock::Clock) : (bool, bool, bool, u64, u64, u64, u64) {
    ...
    public fun get_pending_rewards<T0>(arg0: &Farm, arg1: address, arg2: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : u256 {
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::table::contains<0x1::type_name::TypeName, Pool>(&arg0.pools, v0)) {
            return 0
        };
    ...
    public fun get_pool_reward_status<T0>(arg0: &Farm, arg1: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg2: &0x2::clock::Clock) : (bool, u256, 0x1::string::String) {
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::table::contains<0x1::type_name::TypeName, Pool>(&arg0.pools, v0)) {
    ...
    public fun get_user_token_stakes(arg0: &Farm, arg1: address, arg2: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : vector<UserTokenStake> {
    ...
    public fun get_vault_balance(arg0: &RewardVault) : u256 {
        (0x2::balance::value<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::victory_token::VICTORY_TOKEN>(&arg0.victory_balance) as u256)
    }
    ...
    public entry fun initialize_farm_tracking(arg0: &mut Farm, arg1: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg2: &AdminCap, arg3: &0x2::clock::Clock) {
        let (v0, _) = 0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::get_config_info(arg1);
    ...
    public fun is_lp_type_allowed<T0, T1>(arg0: &Farm) : bool {
        0x2::table::contains<0x1::type_name::TypeName, bool>(&arg0.allowed_lp_types, 0x1::type_name::get<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>())
    }

    public entry fun mass_update_pools_batch(arg0: &mut Farm, arg1: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: &AdminCap, arg6: &mut 0x2::tx_context::TxContext) : (bool, u64) {
    ...
    public entry fun pause_emissions_safely(arg0: &mut Farm, arg1: &mut 0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg2: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::AdminCap, arg3: &AdminCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::set_pause_state(arg2, arg1, true, arg4, arg5);
    ...
    public entry fun stake_lp<T0, T1>(arg0: &mut Farm, arg1: &mut RewardVault, arg2: vector<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>, arg3: u256, arg4: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 7);
        ...
        let v10 = arg3 - v9;
        let v11 = 0x1::vector::pop_back<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(&mut arg2);
        while (!0x1::vector::is_empty<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(&arg2)) {
            0x2::coin::join<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&mut v11, 0x1::vector::pop_back<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(&mut arg2));
        };
        0x1::vector::destroy_empty<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(arg2);
        assert!((0x2::coin::value<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&v11) as u256) >= arg3, 8);
        ...
        if (v9 > 0) {
            let v13 = 0x2::coin::split<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&mut v11, (v9 as u64), arg6);
            let v14 = &mut v13;
            distribute_farm_fees<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(arg0.burn_address, arg0.locker_address, arg0.team_1_address, arg0.team_2_address, arg0.dev_address, v14, v9, v0, v1, arg6);
            0x2::coin::destroy_zero<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(v13);
        ...
        let v16 = StakedTokenVault<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>{
            id                      : 0x2::object::new(arg6),
            balance                 : 0x2::coin::into_balance<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(0x2::coin::split<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&mut v11, (v10 as u64), arg6)),
            owner                   : v2,
            pool_type               : v0,
            amount                  : v10,
            initial_stake_timestamp : v1,
        };
        if (0x2::coin::value<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&v11) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(v11, v2);
        } else {
            0x2::coin::destroy_zero<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(v11);
        };
        let v17 = StakingPosition<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>{
            id                      : 0x2::object::new(arg6),
            owner                   : v2,
            pool_type               : v0,
            amount                  : v10,
        ...
        0x2::transfer::share_object<StakedTokenVault<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(v16);
        0x2::transfer::transfer<StakingPosition<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(v17, v2);
    ...
    public entry fun stake_single<T0>(arg0: &mut Farm, arg1: &mut RewardVault, arg2: 0x2::coin::Coin<T0>, arg3: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 7);
    ...
    public entry fun unstake_lp<T0, T1>(arg0: &mut Farm, arg1: &mut RewardVault, arg2: StakingPosition<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>, arg3: &mut StakedTokenVault<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>, arg4: u256, arg5: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 7);
        ...
        assert!(0x2::balance::value<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&arg3.balance) >= (arg4 as u64), 8);
        ...
        if (v22 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(0x2::coin::from_balance<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(0x2::balance::split<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&mut arg3.balance, v22), arg7), v1);
        };
        if (v21 > 0) {
            let v27 = 0x2::coin::from_balance<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(0x2::balance::split<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&mut arg3.balance, v21), arg7);
            let v28 = &mut v27;
            distribute_farm_fees<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(v4, v5, v6, v7, v8, v28, v20, v0, v3, arg7);
            0x2::coin::destroy_zero<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(v27);
        ...
        if (arg4 == arg2.amount) {
            ...
            if (0x2::balance::value<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>(&arg3.balance) == 0) {
                arg3.owner = @0x0;
            };
        } else {
            arg2.amount = arg2.amount - arg4;
            0x2::transfer::transfer<StakingPosition<0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::pair::LPCoin<T0, T1>>>(arg2, v1);
        };
        let v41 = Unstaked{
            staker    : v1,
            pool_type : v0,
    ...
    fun update_pool_accumulator_masterchef(arg0: &mut Pool, arg1: u256, arg2: u256, arg3: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg4: &0x2::clock::Clock, arg5: u64) {
    ...
    public entry fun update_pool_config<T0>(arg0: &mut Farm, arg1: u256, arg2: u256, arg3: u256, arg4: bool, arg5: &AdminCap, arg6: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, Pool>(&arg0.pools, v0), 5);
        assert!(arg2 <= 1000 && arg3 <= 1000, 3);
    ...
    public entry fun update_single_pool<T0>(arg0: &mut Farm, arg1: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, Pool>(&arg0.pools, v0), 5);
    ...
    fun validate_new_stake_allowed(arg0: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) {
        let (v0, v1, v2) = validate_emission_state(arg0, arg1);
        assert!(v0, 16);
        assert!(v1, 18);
        assert!(!v2, 17);
    ...
    fun validate_unstake_allowed(arg0: &0x7535d5548012a8c43cfbcffe04658939f129ee3ce74b5ca104e75e22bb523733::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) {
        let (v0, _, v2) = validate_emission_state(arg0, arg1);
        assert!(v0, 16);
        assert!(!v2, 17);
    }
