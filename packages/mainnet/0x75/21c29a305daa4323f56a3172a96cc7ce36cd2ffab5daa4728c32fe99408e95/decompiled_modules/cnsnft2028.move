module 0x7521c29a305daa4323f56a3172a96cc7ce36cd2ffab5daa4728c32fe99408e95::cnsnft2028 {
    struct CNSNFT2028 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2028, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2028>(arg0, arg1);
