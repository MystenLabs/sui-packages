module 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::book {
    ...
    struct Book has store {
        ...
        tick_size: u64,
        min_size: u64,
        asks: 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::BigVector<Order>,
        bids: 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::BigVector<Order>,
    ...
    public(friend) fun empty(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : Book {
        ...
        Book{
            ...
            tick_size         : arg2,
            min_size          : arg3,
            asks              : 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::empty<Order>(0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::max_slice_size(), 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::max_fan_out(), arg7),
            bids              : 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::empty<Order>(0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::max_slice_size(), 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::max_fan_out(), arg7),
    ...
    fun book_side(arg0: &Book, arg1: u128) : &0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::BigVector<Order> {
        let (v0, _, _) = 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::obutils::decode_order_id(arg1);
        if (v0) {
            &arg0.bids
        } else {
            &arg0.asks
    ...
    fun book_side_mut(arg0: &mut Book, arg1: u128) : &mut 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::BigVector<Order> {
        let (v0, _, _) = 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::obutils::decode_order_id(arg1);
        if (v0) {
            &mut arg0.bids
        } else {
    ...
    fun book_sizes(arg0: &Book) : (u64, u64) {
        (0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::length<Order>(&arg0.bids), 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::length<Order>(&arg0.asks))
    }

    public(friend) fun cancel_order(arg0: &mut Book, arg1: u128, arg2: address, arg3: bool) : (0x1::option::Option<0x2::object::ID>, u64) {
        let v0 = 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::remove<Order>(book_side_mut(arg0, arg1), arg1);
        ...
        let v1 = &mut v0;
        setStatus(v1, 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::canceled());
    ...
    fun inject_limit_order(arg0: &mut Book, arg1: Order) {
        if (arg1.is_bid) {
            0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::insert<Order>(&mut arg0.bids, arg1.order_id, arg1);
        } else {
            0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::insert<Order>(&mut arg0.asks, arg1.order_id, arg1);
        };
    }

    fun inject_taker_order(arg0: &Order, arg1: &TradeProof) : bool {
        let v0 = if (arg0.ord_type <= 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::ord_cross()) {
            true
        } else if (arg0.status >= 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::filled()) {
            true
        } else {
    ...
    fun match_against_book(arg0: &mut Book, arg1: &mut Order, arg2: &mut TradeProof, arg3: bool, arg4: u64) {
        ...
        let (v4, v5) = if (v2) {
            0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::min_slice<Order>(v3)
        } else {
            0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::max_slice<Order>(v3)
        };
        let v6 = v5;
        let v7 = v4;
        while (!0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::slice_is_null(&v7) && 0x1::vector::length<Bill>(v0) < 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::max_fills()) {
            let v8 = 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::slice_borrow_mut<Order>(0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::borrow_slice_mut<Order>(v3, v7), v6);
            let v9 = match_maker(arg1, v8, v0, v1, arg3, arg4);
            if (!v9) {
                break
            };
            let (v10, v11) = if (v2) {
                0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::next_slice<Order>(v3, v7, v6)
            } else {
                0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::prev_slice<Order>(v3, v7, v6)
            };
            v6 = v11;
            v7 = v10;
        };
        ...
        while (v12 > 0) {
            v12 = v12 - 1;
            0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::remove<Order>(v3, 0x1::vector::borrow_mut<ExpiredBill>(v1, v12).maker_order_id);
        };
        ...
        while (v13 > 0) {
            ...
            if (v14.maker_filled) {
                0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::remove<Order>(v3, v14.maker_ordid);
            };
            let v15 = &mut arg0.analysis;
            analysis_exec(v15, v14.exec_qty, v14.exec_price);
        };
        if (0x1::vector::length<Bill>(v0) == 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::max_fills()) {
    ...
    fun match_maker(arg0: &mut Order, arg1: &mut Order, arg2: &mut vector<Bill>, arg3: &mut vector<ExpiredBill>, arg4: bool, arg5: u64) : bool {
        if (order_expired0(arg1, arg5)) {
            setStatus(arg1, 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::expired());
            let v0 = ExpiredBill{
        ...
        if (arg0.is_bid) {
            ...
            if (arg0.ord_type == 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::ord_market()) {
                if (arg0.remain_qty < arg1.price) {
                    setStatus(arg0, 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::completed());
                    return false
                };
                arg1.remain_qty = 0;
                arg1.filled_qty = 1;
        ...
        if (arg0.ord_type == 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::ord_market()) {
            ...
            let v6 = Bill{
                ...
                maker_filled : arg1.status == 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::filled(),
            };
            0x1::vector::push_back<Bill>(arg2, v6);
            return false
        };
        if (arg0.price > arg1.price) {
            setStatus(arg0, 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::live());
            return false
        };
        arg0.remain_qty = 0;
        arg0.filled_qty = 1;
    ...
    fun median_price(arg0: u64, arg1: u64, arg2: u64) : u64 {
        if (arg0 == 0) {
            ...
            0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::math::div(0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::math::mul(arg1 + arg2, arg0), arg1 + arg0)
        }
    }
    ...
    public(friend) fun order(arg0: &Book, arg1: u128) : &Order {
        0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::borrow<Order>(book_side(arg0, arg1), arg1)
    }

    public(friend) fun order_expired(arg0: &Book, arg1: u128, arg2: u64) : bool {
        order_expired0(0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::borrow<Order>(book_side(arg0, arg1), arg1), arg2)
    }
    ...
    public(friend) fun order_info2(arg0: &Book, arg1: u128) : (bool, address, u64, 0x1::option::Option<0x2::object::ID>, u64) {
        let v0 = 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::borrow<Order>(book_side(arg0, arg1), arg1);
        (v0.is_bid, v0.trader, v0.remain_qty, v0.nft_id, v0.price)
    }

    fun order_mut(arg0: &mut Book, arg1: u128) : &mut Order {
        0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::borrow_mut<Order>(book_side_mut(arg0, arg1), arg1)
    }
    ...
    public(friend) fun place_cross(arg0: &mut Book, arg1: &OrderInfo, arg2: u64) : (0x1::option::Option<Bill>, 0x1::option::Option<ExpiredBill>, address, u64) {
        ...
        let v4 = if (arg1.ord_type == 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::ord_cross()) {
        ...
        assert!(v4, 18);
        let v5 = to_order(0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::obutils::encode_order_id(arg1.is_bid, arg1.price, v0), arg1);
        let v6 = &mut v5;
        setStatus(v6, 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::live());
        if (order_expired0(v3, arg2)) {
            setStatus(v3, 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::expired());
            let v11 = ExpiredBill{
            ...
            0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::remove<Order>(book_side_mut(arg0, v1), v1);
            (0x1::option::none<Bill>(), 0x1::option::some<ExpiredBill>(v11), v5.trader, v5.remain_qty)
        } else {
            v3.remain_qty = 0;
            v3.filled_qty = 1;
            v3.match_price = v3.price;
            setStatus(v3, 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::filled());
            let v12 = v3.price;
            ...
            let v13 = &mut v5;
            setStatus(v13, 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::completed());
            let v14 = Bill{
                taker_is_bid : true,
            ...
            0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::big_vector::remove<Order>(v15, v1);
    ...
    public(friend) fun place_order(arg0: &mut Book, arg1: &OrderInfo, arg2: u64) : TradeProof {
        ...
        assert!(arg1.ord_type <= 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::ord_limit(), 9);
        let v0 = get_order_id(arg0, arg1.is_bid);
        let v1 = 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::obutils::encode_order_id(arg1.is_bid, arg1.price, v0);
        ...
        let v4 = &mut v2;
        setStatus(v4, 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::live());
        ...
        if (v3.inject) {
            ...
            let v8 = &mut v2;
            setStatus(v8, 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::completed());
        };
        analysis_book_size(arg0);
        emitMarketAnal(arg0, arg2);
        v3
    ...
    fun to_order(arg0: u128, arg1: &OrderInfo) : Order {
        Order{
            ...
            status           : 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::live(),
    ...
    fun update_order_state(arg0: &mut Order, arg1: u64) {
        if (arg0.status >= 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::expired()) {
            return
        };
        if (order_expired0(arg0, arg1)) {
            setStatus(arg0, 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::expired());
            return
        };
        if (arg0.is_bid) {
            if (arg0.ord_type == 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::ord_limit()) {
                if (arg0.filled_qty > 0) {
                    let v0 = if (arg0.remain_qty < arg0.price) {
                        0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::filled()
                    } else {
                        0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::partially_filled()
                    };
                    setStatus(arg0, v0);
                };
            ...
            setStatus(arg0, 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::filled());
        };
    }

    fun validate_inputs(arg0: &OrderInfo, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg0.fill_mode <= 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::ice_berge(), 8);
        assert!(arg0.ord_type <= 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::ord_limit(), 12);
        assert!(arg0.balance > 0, 1);
        assert!(arg0.is_bid && arg0.fill_mode == 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::ice_berge() || !arg0.is_bid && arg0.fill_mode == 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::atomic(), 9);
        if (arg0.fill_mode == 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::ice_berge()) {
        ...
        let v0 = if (arg0.ord_type < 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::ord_limit() && arg0.price == 0) {
            true
        } else if (arg0.ord_type == 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::ord_limit()) {
            if (arg0.price >= 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::min_price()) {
                arg0.price <= 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::max_price()
            } else {
                false
            }
        } else {
    ...
    public(friend) fun validate_offer_price(arg0: &Book, arg1: u64) {
        assert!(arg1 > 0 && arg1 >= 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::math::div(0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::math::mul(arg0.analysis.floor, arg0.min_offer_per), 0x7543ae0745cfbf6129a16b08f3909b21a1d2318859543be6454f7b87845f91cc::constants::max_fee()), 21);
    }
