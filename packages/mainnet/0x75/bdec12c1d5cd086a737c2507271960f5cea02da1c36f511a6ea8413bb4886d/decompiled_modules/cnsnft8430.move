module 0x75bdec12c1d5cd086a737c2507271960f5cea02da1c36f511a6ea8413bb4886d::cnsnft8430 {
    struct CNSNFT8430 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8430, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8430>(arg0, arg1);
