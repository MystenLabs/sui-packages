module 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::config {
    ...
    public(friend) fun increase_version(arg0: &mut GlobalConfig) : (u64, u64) {
        assert!(arg0.version < 8, 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::errors::verion_cant_be_increased());
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            min_tick        : 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::tick_math::min_tick(),
            max_tick        : 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::tick_math::max_tick(),
            version         : 8,
    ...
    public(friend) fun remove_reward_manager(arg0: &mut GlobalConfig, arg1: address) {
        assert!(verify_reward_manager(arg0, arg1), 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::errors::reward_manager_not_found());
        let v0 = 0;
    ...
    public(friend) fun set_reward_manager(arg0: &mut GlobalConfig, arg1: address) {
        assert!(!verify_reward_manager(arg0, arg1), 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::errors::already_a_reward_manger());
    ...
    public fun verify_version(arg0: &GlobalConfig) {
        assert!(arg0.version == 8, 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::errors::version_mismatch());
    }
