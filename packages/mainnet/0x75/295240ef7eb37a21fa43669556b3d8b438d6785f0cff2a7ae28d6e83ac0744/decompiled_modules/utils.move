module 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::utils {
    public fun add_delta(arg0: u128, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::I128) : u128 {
        let v0 = 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::i128H::mate_to_lib(arg1);
        ...
        if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::is_neg(v0)) {
            assert!(arg0 >= v1, 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::errors::insufficient_liquidity());
            arg0 - v1
        } else {
            assert!(v1 < 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::constants::max_u128() - arg0, 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::errors::insufficient_liquidity());
            arg0 + v1
        }
    }
    ...
    public fun deposit_balance<T0>(arg0: &mut 0x2::balance::Balance<T0>, arg1: 0x2::balance::Balance<T0>, arg2: u64) : 0x2::balance::Balance<T0> {
        assert!(0x2::balance::value<T0>(&arg1) >= arg2, 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::errors::insufficient_coin_balance());
    ...
    public fun overflow_add(arg0: u256, arg1: u256) : u256 {
        if (!0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::math_u256::add_check(arg0, arg1)) {
            arg1 - 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::constants::max_u256() - arg0 - 1
        } else {
            arg0 + arg1
        }
    }
    ...
    public fun withdraw_balance<T0>(arg0: &mut 0x2::balance::Balance<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(0x2::balance::value<T0>(arg0) >= arg1, 0x75295240ef7eb37a21fa43669556b3d8b438d6785f0cff2a7ae28d6e83ac0744::errors::insufficient_coin_balance());
