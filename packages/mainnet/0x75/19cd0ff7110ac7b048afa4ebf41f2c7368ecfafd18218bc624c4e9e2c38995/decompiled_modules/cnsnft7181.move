module 0x7519cd0ff7110ac7b048afa4ebf41f2c7368ecfafd18218bc624c4e9e2c38995::cnsnft7181 {
    struct CNSNFT7181 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7181, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7181>(arg0, arg1);
