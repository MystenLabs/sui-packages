module 0x756e7d41bb02b39cbec18512390dfd2b6ff52ecbe7250d605c3ff1d21a83553b::navi_adapter {
    ...
    public fun borrow<T0: drop, T1>(arg0: &mut NaviVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Navi>, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T1>, arg4: u64, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg8: u8, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<Navi, T0, T1> {
        ...
        0x756e7d41bb02b39cbec18512390dfd2b6ff52ecbe7250d605c3ff1d21a83553b::navi_adapter_event::borrow_event<T1>(*0x1::option::borrow<0x2::object::ID>(&arg0.main_vault_id), v1);
    ...
    public fun new<T0: drop>(arg0: &mut NaviAdapterRegistry, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Navi>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x756e7d41bb02b39cbec18512390dfd2b6ff52ecbe7250d605c3ff1d21a83553b::navi_adapter_event::new_navi_vault_event(*0x2::object::uid_as_inner(&v5.id), v3);
    ...
    public fun claim<T0: drop, T1>(arg0: &mut NaviVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Navi>, arg2: &0x2::clock::Clock, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::RewardFund<T1>, arg6: vector<0x1::ascii::String>, arg7: vector<address>, arg8: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<Navi, T0, T1> {
        ...
        0x756e7d41bb02b39cbec18512390dfd2b6ff52ecbe7250d605c3ff1d21a83553b::navi_adapter_event::claim_event<T1>(*0x1::option::borrow<0x2::object::ID>(&arg0.main_vault_id), 0x2::balance::value<T1>(&v0));
    ...
    public fun create_account_cap<T0: drop>(arg0: &mut NaviVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Navi>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        message_pre_check<T0>(arg0, arg1);
        0x756e7d41bb02b39cbec18512390dfd2b6ff52ecbe7250d605c3ff1d21a83553b::navi_adapter_event::new_navi_position_event(*0x2::object::uid_as_inner(&arg0.id));
    ...
    public fun get_res(arg0: &NaviVault, arg1: &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Res {
        let v0 = 0x1::vector::empty<0x1::ascii::String>();
        let v1 = 0x1::vector::empty<u64>();
        let v2 = 0x1::vector::empty<bool>();
        if (0x1::option::is_some<0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap>(&arg0.account_cap)) {
            let v3 = 0x1::option::borrow<0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap>(&arg0.account_cap);
            let (v4, v5) = claimable_value(v3, arg1, arg2, arg3);
            let v6 = v5;
            let v7 = v4;
            while (0x1::vector::length<0x1::ascii::String>(&v7) > 0) {
                0x1::vector::push_back<0x1::ascii::String>(&mut v0, 0x1::vector::pop_back<0x1::ascii::String>(&mut v7));
                0x1::vector::push_back<u64>(&mut v1, 0x1::vector::pop_back<u64>(&mut v6));
                0x1::vector::push_back<bool>(&mut v2, true);
            };
            let (v8, v9) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_assets(arg2, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::account_owner(v3));
            let v10 = v9;
            let v11 = v8;
            let v12 = 0x2::vec_map::empty<0x1::ascii::String, u64>();
            while (0x1::vector::length<u8>(&v11) > 0) {
                let v13 = 0x1::vector::pop_back<u8>(&mut v11);
                let v14 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_coin_type(arg2, v13);
                0x1::vector::push_back<0x1::ascii::String>(&mut v0, v14);
                let v15 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_collateral_balance(arg2, v13, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::account_owner(v3));
                0x1::vector::push_back<u64>(&mut v1, (v15 as u64));
                0x1::vector::push_back<bool>(&mut v2, true);
                let v16 = &mut v12;
            ...
            while (0x1::vector::length<u8>(&v10) > 0) {
                let v18 = 0x1::vector::pop_back<u8>(&mut v10);
                let v19 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_coin_type(arg2, v18);
                0x1::vector::push_back<0x1::ascii::String>(&mut v0, v19);
                let v20 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_loan_balance(arg2, v18, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::account_owner(v3));
                0x1::vector::push_back<u64>(&mut v1, (v20 as u64));
    ...
    fun new_generated_state_proof_message<T0: drop>(arg0: &NaviVault, arg1: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<Navi, T0> {
        ...
        let v3 = stamp();
        0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::set_info<Navi, T0, vector<u8>, bool>(&mut v1, &v3, b"is_sate_generated", true);
        v1
    }
    ...
    public fun new_navi_state<T0: drop>(arg0: &mut NaviVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Navi>, arg2: &mut 0x2::tx_context::TxContext) : (NaviState, 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<Navi, T0>) {
        ...
        while (0x1::vector::length<0x1::ascii::String>(&v4) > 0) {
            ...
            add_amount(v6, v5, 0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::ceil(0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::mul_u64(v0, *0x2::vec_map::get<0x1::ascii::String, u64>(&arg0.record.reward, &v5))));
        };
        ...
        while (0x1::vector::length<0x1::ascii::String>(&v7) > 0) {
            ...
            add_amount(v9, v8, 0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::floor(0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::mul_u64(v0, *0x2::vec_map::get<0x1::ascii::String, u64>(&arg0.record.supply, &v8))));
        };
    ...
    fun new_verified_message<T0: drop>(arg0: &NaviVault, arg1: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<Navi, T0> {
        ...
        let v3 = stamp();
        0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::set_info<Navi, T0, vector<u8>, 0x1::option::Option<0x2::object::ID>>(&mut v1, &v3, b"main_vault_id", arg0.main_vault_id);
        v1
    }
    ...
    public fun repay<T0: drop, T1>(arg0: &mut NaviVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<T0, Navi, T1>, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T1>, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg6: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg7: u8, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<Navi, T0, T1> {
        ...
        0x756e7d41bb02b39cbec18512390dfd2b6ff52ecbe7250d605c3ff1d21a83553b::navi_adapter_event::repay_event<T1>(*0x1::option::borrow<0x2::object::ID>(&arg0.main_vault_id), v1 - 0x2::balance::value<T1>(&v2));
    ...
    public fun supply<T0: drop, T1>(arg0: &mut NaviVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<T0, Navi, T1>, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T1>, arg4: u8, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x756e7d41bb02b39cbec18512390dfd2b6ff52ecbe7250d605c3ff1d21a83553b::navi_adapter_event::supply_event<T1>(*0x1::option::borrow<0x2::object::ID>(&arg0.main_vault_id), v2);
    }

    public fun transfer_res(arg0: Res, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::transfer<Res>(arg0, 0x2::tx_context::sender(arg1));
    }
    ...
    public fun withdraw<T0: drop, T1>(arg0: &mut NaviVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Navi>, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T1>, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg6: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg7: u64, arg8: u8, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<Navi, T0, T1> {
        if (arg0.is_redeeming) {
            err_redeeming();
        };
        if (0x1::option::is_none<0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap>(&arg0.account_cap)) {
        ...
        0x756e7d41bb02b39cbec18512390dfd2b6ff52ecbe7250d605c3ff1d21a83553b::navi_adapter_event::withdraw_event<T1>(*0x1::option::borrow<0x2::object::ID>(&arg0.main_vault_id), v1);
        new_single_asset<T0, T1>(arg0, v0, arg10)
    }
