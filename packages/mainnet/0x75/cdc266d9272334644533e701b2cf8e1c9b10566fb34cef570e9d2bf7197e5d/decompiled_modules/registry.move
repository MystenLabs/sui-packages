module 0x75cdc266d9272334644533e701b2cf8e1c9b10566fb34cef570e9d2bf7197e5d::registry {
    ...
    public fun disable_version(arg0: &mut Registry, arg1: u64, arg2: &AdminCap) {
        assert!(arg1 != 0x75cdc266d9272334644533e701b2cf8e1c9b10566fb34cef570e9d2bf7197e5d::constants::current_version(), 3);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Registry{
            ...
            allowed_versions : 0x2::vec_set::singleton<u64>(0x75cdc266d9272334644533e701b2cf8e1c9b10566fb34cef570e9d2bf7197e5d::constants::current_version()),
