module 0x75f3683f1fcd141ae9831aee3f74262e9ba5458cbfb71297859215dd37e9ed9f::faucetcoin {
    ...
    fun init(arg0: FAUCETCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCETCOIN>(arg0, 2, b"FAUCETCOIN", b"FaucetCoin", b"", 0x1::option::none<0x2::url::Url>(), arg1);
