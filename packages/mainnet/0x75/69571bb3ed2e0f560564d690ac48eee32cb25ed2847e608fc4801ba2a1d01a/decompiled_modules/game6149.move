module 0x7569571bb3ed2e0f560564d690ac48eee32cb25ed2847e608fc4801ba2a1d01a::game6149 {
    struct GAME6149 has drop {
        dummy_field: bool,
    }

    struct TICKET_6149 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6149(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6149>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6149>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME6149, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME6149>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6149>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6149>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6149>>(v5, 0x2::tx_context::sender(arg1));
    }
