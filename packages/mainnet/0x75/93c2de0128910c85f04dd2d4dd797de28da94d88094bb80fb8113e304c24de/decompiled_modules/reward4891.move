module 0x7593c2de0128910c85f04dd2d4dd797de28da94d88094bb80fb8113e304c24de::reward4891 {
    struct REWARD4891 has drop {
        dummy_field: bool,
    }

    struct TICKET_4891 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4891(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4891>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4891>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4891, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4891>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4891>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4891>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4891>>(v5, 0x2::tx_context::sender(arg1));
    }
