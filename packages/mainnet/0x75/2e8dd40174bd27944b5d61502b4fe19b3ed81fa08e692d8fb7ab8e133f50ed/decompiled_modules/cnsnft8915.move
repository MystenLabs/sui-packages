module 0x752e8dd40174bd27944b5d61502b4fe19b3ed81fa08e692d8fb7ab8e133f50ed::cnsnft8915 {
    struct CNSNFT8915 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8915, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8915>(arg0, arg1);
