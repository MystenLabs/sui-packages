    ...
    entry fun exercise<T0, T1>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: &mut StrategyPoolV2, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        while (v17 < v15) {
            ...
            if (!0x1::vector::is_empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v18.receipts)) {
                let v19 = 0;
                let v20 = 0x1::vector::length<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v18.receipts);
                while (v19 < v20) {
                    let v21 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_receipt_vid(0x1::vector::borrow<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v18.receipts, v19));
                    if (v21 != v16) {
                        v16 = v21;
                        break
                    };
        ...
        let v22 = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_mut_bid_vault_by_id(v8, &v16);
        let v23 = 0;
        while (v23 < v15) {
            ...
            if (!0x1::vector::is_empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v24.receipts)) {
                ...
                let v26 = 0;
                let v27 = 0x1::vector::length<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v24.receipts);
                while (v26 < v27) {
                    if (v16 == 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_receipt_vid(0x1::vector::borrow<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v24.receipts, v26))) {
                ...
                if (!0x1::vector::is_empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&v25)) {
                    let (v28, v29, v30) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::delegate_exercise<T0>(v22, v25);
                    ...
                    0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v24.id, 0x1::string::utf8(b"profit")), v30);
                    v24.accumulated_profit = v24.accumulated_profit + v28;
                    0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::emit_exercise_event(v13, v28, v29, 0x1::option::none<0x1::type_name::TypeName>(), 0, v24.user);
                    update_u64_padding<T0, T1>(v24);
                    let v31 = 0x1::vector::borrow_mut<u64>(&mut v24.u64_padding, 2);
                    *v31 = *v31 + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_vault_u64_padding_value(v22, 1) * v29 / 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_o_token_decimal(v13)) * 11000 / 10000 * (10000 - 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_vault_u64_padding_value(v22, 2)) / 10000;
                } else {
