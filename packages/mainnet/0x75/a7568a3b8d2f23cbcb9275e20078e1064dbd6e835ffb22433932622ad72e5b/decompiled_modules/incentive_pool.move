module 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::incentive_pool {
    ...
    struct IncentivePools has store, key {
        id: 0x2::object::UID,
        ...
        ve_sca_bind: 0x2::table::Table<0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation>>,
    }
    ...
    fun accrue_points(arg0: &mut IncentivePool, arg1: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&arg0.points_list)) {
            ...
            v2.index = v2.index + 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::util::mul_div(1000000000, v5, arg0.stakes);
            v1 = v1 + 1;
        };
    }
    ...
    public(friend) fun bind_ve_sca_to_incentive_account(arg0: &mut IncentivePools, arg1: 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, arg2: 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation>) {
        0x2::table::add<0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation>>(&mut arg0.ve_sca_bind, arg1, arg2);
    }
    ...
    public(friend) fun create_incentive_pool_if_not_exist<T0>(arg0: &mut IncentivePools, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::table::contains<0x1::type_name::TypeName, IncentivePool>(&arg0.pools, v0)) {
            let v1 = IncentivePool{
                pool_type   : v0,
                points      : 0x2::table::new<0x1::type_name::TypeName, IncentivePoolPoint>(arg2),
    ...
    public(friend) fun create_incentive_pool_point_if_not_exist<T0, T1>(arg0: &mut IncentivePools, arg1: &0x2::clock::Clock) {
        ...
        if (!0x2::table::contains<0x1::type_name::TypeName, IncentivePoolPoint>(&v0.points, v1)) {
            let v2 = IncentivePoolPoint{
            ...
            0x2::table::add<0x1::type_name::TypeName, IncentivePoolPoint>(&mut v0.points, v1, v2);
            0x1::vector::push_back<0x1::type_name::TypeName>(&mut v0.points_list, v1);
        };
    }

    public(friend) fun create_incentive_pools(arg0: &mut 0x2::tx_context::TxContext) : IncentivePools {
        IncentivePools{
            ...
            ve_sca_bind            : 0x2::table::new<0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation>>(arg0),
        }
    }
    ...
    public fun is_ve_sca_binded(arg0: &IncentivePools, arg1: 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>) : bool {
        0x2::table::contains<0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation>>(&arg0.ve_sca_bind, arg1)
    }
    ...
    public fun reward_fee_recipient(arg0: &IncentivePools) : address {
        assert!(is_reward_fee_recipient_exist(arg0), 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::app_error::reward_fee_recipient_not_exist());
    ...
    public(friend) fun unbind_ve_sca_from_incentive_account(arg0: &mut IncentivePools, arg1: 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, arg2: 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation>) {
        assert!(0x2::table::remove<0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0x75a7568a3b8d2f23cbcb9275e20078e1064dbd6e835ffb22433932622ad72e5b::typed_id::TypedID<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation>>(&mut arg0.ve_sca_bind, arg1) == arg2, 2);
    }
