module 0x75600296810fee975742dea8d92d17b19757b5c00c1059c420b50fd414cf752a::cnsnft7787 {
    struct CNSNFT7787 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7787, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7787>(arg0, arg1);
