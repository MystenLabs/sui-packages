module 0x756fface428581ae4731287363718cce53a81d7ab2c43c86abf163582c4fc86f::cnsnft2713 {
    struct CNSNFT2713 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2713, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2713>(arg0, arg1);
