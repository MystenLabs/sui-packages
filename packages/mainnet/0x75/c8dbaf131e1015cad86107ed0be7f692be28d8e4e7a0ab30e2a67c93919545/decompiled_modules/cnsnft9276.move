module 0x75c8dbaf131e1015cad86107ed0be7f692be28d8e4e7a0ab30e2a67c93919545::cnsnft9276 {
    struct CNSNFT9276 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9276, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9276>(arg0, arg1);
