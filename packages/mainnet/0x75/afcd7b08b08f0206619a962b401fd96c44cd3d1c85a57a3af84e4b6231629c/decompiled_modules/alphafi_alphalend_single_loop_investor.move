module 0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::alphafi_alphalend_single_loop_investor {
    struct EmergencyKey has copy, drop, store {
        dummy_field: bool,
    }

    struct EmergencyInfo<phantom T0> has store {
        is_emergency: bool,
    ...
    public(friend) fun activate_emergency<T0>(arg0: &mut Investor<T0>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(!is_emergency<T0>(arg0), 800);
        let v0 = get_total_borrowed<T0>(arg0, arg1, arg2);
        assert!(v0 == 0, 802);
        if (0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::get_collateral_amount(arg1, arg0.market_id, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::get_position_id(&arg0.position_cap), arg2) > 0) {
            let v1 = 0x2::coin::into_balance<T0>(0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise<T0>(arg1, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::remove_collateral<T0>(arg1, &arg0.position_cap, arg0.market_id, 18446744073709551615, arg2), arg2, arg3));
            join_emergency_balance<T0>(arg0, v1);
        };
        assert!(0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::get_collateral_amount(arg1, arg0.market_id, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::get_position_id(&arg0.position_cap), arg2) == 0, 804);
        let v2 = borrow_emergency_mut<T0>(arg0);
        v2.is_emergency = true;
        arg0.tokensDeposited = get_total_invested<T0>(arg0, arg1, arg2);
        arg0.cur_debt = 0;
        arg0.current_debt_to_supply_ratio = 0;
        emergency_balance_value<T0>(arg0)
    }

    public fun admin_borrow<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::AdminCap, arg1: &0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::Version, arg2: &mut Investor<T0>, arg3: u64, arg4: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg5: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::assert_current_version(arg1);
        assert!(!is_emergency<T0>(arg2), 800);
        ...
        arg2.cur_debt = v1;
        assert!((v1 as u256) < (v0 as u256) * (0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::get_safe_collateral_ratio(arg5, arg2.market_id) as u256) * (arg2.safe_borrow_percentage as u256) / 1000000, 0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::error::high_debt());
    ...
    public fun admin_repay<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::AdminCap, arg1: &0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::Version, arg2: &mut Investor<T0>, arg3: u64, arg4: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg5: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (v0 == 0) {
            ...
            0x1::u64::min(arg3, v0 + 1)
        };
        autocompound<T0>(arg2, arg4, arg5, arg6, arg7);
        repay_to_alphalend<T0>(arg2, arg5, v1, arg6, arg7);
        let v2 = get_total_invested<T0>(arg2, arg5, arg6);
        assert!(v2 > 0, 999999999);
        arg2.tokensDeposited = v2;
        let v3 = get_total_borrowed<T0>(arg2, arg5, arg6);
        arg2.cur_debt = v3;
        arg2.current_debt_to_supply_ratio = (((v3 as u256) * 100000000000000000000 / (v2 as u256)) as u256);
    ...
    public(friend) fun autocompound<T0>(arg0: &mut Investor<T0>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = get_total_invested<T0>(arg0, arg2, arg3);
        if (v0 == 0) {
            return
        };
        let v1 = is_emergency<T0>(arg0);
        let v2 = 0x2::balance::zero<T0>();
        let v3 = if (v1) {
            0
        } else {
            let v4 = v0 - arg0.tokensDeposited;
            if (v4 > 0) {
                0x2::balance::join<T0>(&mut v2, 0x2::coin::into_balance<T0>(0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise<T0>(arg2, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::remove_collateral<T0>(arg2, &arg0.position_cap, arg0.market_id, v4, arg3), arg3, arg4)));
            };
            let v5 = collect_reward<T0, T0>(arg0, arg2, arg3, arg4);
        ...
        let v7 = get_total_borrowed<T0>(arg0, arg2, arg3);
        let v8 = (v7 as u64) - (arg0.cur_debt as u64);
        let v9 = 0x2::balance::value<T0>(&v2);
        let v10 = if (v9 > (v8 as u64)) {
            ((v9 - (v8 as u64)) as u128) * (arg0.performance_fee as u128) / 10000
        } else {
            0
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v2, (v10 as u64)), arg4), 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::get_fee_wallet_address(arg1));
        let v11 = get_total_invested<T0>(arg0, arg2, arg3);
        let v12 = AutoCompoundingEvent{
            ...
            accrued_interest : (v8 as u64),
            fee_collected    : (v10 as u64),
            location         : 1,
        };
        0x2::event::emit<AutoCompoundingEvent>(v12);
        if (0x2::balance::value<T0>(&v2) > 0) {
            if (v1) {
                join_emergency_balance<T0>(arg0, v2);
            } else {
    ...
    fun borrow_emergency_mut<T0>(arg0: &mut Investor<T0>) : &mut EmergencyInfo<T0> {
        let v0 = EmergencyKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<EmergencyKey>(&arg0.id, v0)) {
            let v1 = EmergencyKey{dummy_field: false};
            let v2 = EmergencyInfo<T0>{
                is_emergency : false,
                balance      : 0x2::balance::zero<T0>(),
            };
            0x2::dynamic_field::add<EmergencyKey, EmergencyInfo<T0>>(&mut arg0.id, v1, v2);
        };
        let v3 = EmergencyKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<EmergencyKey, EmergencyInfo<T0>>(&mut arg0.id, v3)
    }

    public fun change_safe_borrow<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::AdminCap, arg1: &0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::Version, arg2: &mut Investor<T0>, arg3: u64) {
        0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::assert_current_version(arg1);
        assert!(arg3 <= 9500, 0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::error::high_safe_borrow());
    ...
    public(friend) fun collect_reward_and_swap_mmt<T0, T1, T2>(arg0: &mut Investor<T0>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>, arg3: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg4: bool, arg5: bool, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = get_total_invested<T0>(arg0, arg1, arg7);
        if (v0 == 0) {
            return
        };
        let v1 = 0x2::balance::zero<T1>();
        ...
        if (arg4) {
            let v3 = collect_reward<T0, T1>(arg0, arg1, arg7, arg8);
            0x2::balance::join<T1>(&mut v1, 0x2::coin::into_balance<T1>(v3));
            if (0x2::balance::value<T1>(&v1) >= arg6 && arg5) {
                let (v4, v5) = 0xaff9333d3d69aec8d4eca3acc80722bdb4607f53544201d1384fa54e5c7955da::alphafi_swapper_utils::swap_momentum<T1, T2>(0x2::coin::from_balance<T1>(v1, arg8), 0x2::coin::zero<T2>(arg8), arg2, arg4, true, 0, arg6, arg7, arg3, arg8);
                let v6 = v4;
                assert!(0x2::coin::value<T1>(&v6) == 0, 1);
                0x2::coin::destroy_zero<T1>(v6);
                0x2::balance::join<T2>(&mut v2, 0x2::coin::into_balance<T2>(v5));
                update_free_rewards<T0, T2>(arg0, v2);
            } else {
                update_free_rewards<T0, T1>(arg0, v1);
                update_free_rewards<T0, T2>(arg0, v2);
            ...
            let v7 = collect_reward<T0, T2>(arg0, arg1, arg7, arg8);
            0x2::balance::join<T2>(&mut v2, 0x2::coin::into_balance<T2>(v7));
            if (0x2::balance::value<T2>(&v2) >= arg0.minimum_swap_amount && arg5) {
                let (v8, v9) = 0xaff9333d3d69aec8d4eca3acc80722bdb4607f53544201d1384fa54e5c7955da::alphafi_swapper_utils::swap_momentum<T1, T2>(0x2::coin::zero<T1>(arg8), 0x2::coin::from_balance<T2>(v2, arg8), arg2, arg4, true, 0, arg6, arg7, arg3, arg8);
                let v10 = v9;
                assert!(0x2::coin::value<T2>(&v10) == 0, 2);
                0x2::coin::destroy_zero<T2>(v10);
                0x2::balance::join<T1>(&mut v1, 0x2::coin::into_balance<T1>(v8));
                update_free_rewards<T0, T1>(arg0, v1);
            } else {
                update_free_rewards<T0, T2>(arg0, v2);
                update_free_rewards<T0, T1>(arg0, v1);
    ...
    public fun create_investor<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::DevCap, arg1: &0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::Version, arg2: &0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::partner::PartnerCap, arg3: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::assert_current_version(arg1);
        let v0 = Investor<T0>{
    ...
    public(friend) fun deactivate_emergency<T0>(arg0: &mut Investor<T0>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(is_emergency<T0>(arg0), 801);
        let v0 = borrow_emergency_mut<T0>(arg0);
        v0.is_emergency = false;
        let v1 = 0x2::balance::withdraw_all<T0>(&mut v0.balance);
        let v2 = 0x2::balance::value<T0>(&v1);
        if (v2 > 0) {
            0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::add_collateral<T0>(arg1, &arg0.position_cap, arg0.market_id, 0x2::coin::from_balance<T0>(v1, arg3), arg2, arg3);
        } else {
            0x2::balance::destroy_zero<T0>(v1);
        };
        let v3 = get_total_invested<T0>(arg0, arg1, arg2);
        arg0.tokensDeposited = v3;
        arg0.cur_debt = get_total_borrowed<T0>(arg0, arg1, arg2);
        let v4 = if (arg0.tokensDeposited == 0) {
            0
        } else {
            (arg0.cur_debt as u256) * 100000000000000000000 / (arg0.tokensDeposited as u256)
        };
        arg0.current_debt_to_supply_ratio = v4;
        v2
    }
    ...
    public(friend) fun deposit<T0>(arg0: &mut Investor<T0>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        if (is_emergency<T0>(arg0)) {
            join_emergency_balance<T0>(arg0, 0x2::coin::into_balance<T0>(arg2));
    ...
    public(friend) fun emergency_balance_value<T0>(arg0: &Investor<T0>) : u64 {
        let v0 = EmergencyKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<EmergencyKey>(&arg0.id, v0)) {
            return 0
        };
        let v1 = EmergencyKey{dummy_field: false};
        0x2::balance::value<T0>(&0x2::dynamic_field::borrow<EmergencyKey, EmergencyInfo<T0>>(&arg0.id, v1).balance)
    }

    public fun emergency_repay<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::EmergencyCap, arg1: &0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::Version, arg2: &mut Investor<T0>, arg3: u256, arg4: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::assert_current_version(arg1);
        assert!(!is_emergency<T0>(arg2), 800);
    ...
    public(friend) fun get_total_invested<T0>(arg0: &Investor<T0>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: &0x2::clock::Clock) : u64 {
        if (is_emergency<T0>(arg0)) {
            return emergency_balance_value<T0>(arg0)
        };
    ...
    public(friend) fun is_emergency<T0>(arg0: &Investor<T0>) : bool {
        let v0 = EmergencyKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<EmergencyKey>(&arg0.id, v0)) {
            return false
        };
        let v1 = EmergencyKey{dummy_field: false};
        0x2::dynamic_field::borrow<EmergencyKey, EmergencyInfo<T0>>(&arg0.id, v1).is_emergency
    }

    fun join_emergency_balance<T0>(arg0: &mut Investor<T0>, arg1: 0x2::balance::Balance<T0>) {
        0x2::balance::join<T0>(&mut borrow_emergency_mut<T0>(arg0).balance, arg1);
    }
    ...
    entry fun set_minimum_swap_amount<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::DevCap, arg1: &0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::Version, arg2: &mut Investor<T0>, arg3: u64) {
        0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::assert_current_version(arg1);
        arg2.minimum_swap_amount = arg3;
    }

    entry fun set_performance_fee<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::DevCap, arg1: &0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::Version, arg2: &mut Investor<T0>, arg3: u64) {
        0x45564ea956f9b25890a5c1c3a199c8d86aabd5291b34723fb662283419ee2f4d::version::assert_current_version(arg1);
    ...
    fun split_emergency_balance<T0>(arg0: &mut Investor<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = borrow_emergency_mut<T0>(arg0);
        assert!(0x2::balance::value<T0>(&v0.balance) >= arg1, 803);
        0x2::balance::split<T0>(&mut v0.balance, arg1)
    }
    ...
    public(friend) fun withdraw_from_alphalend<T0>(arg0: &mut Investor<T0>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        if (is_emergency<T0>(arg0)) {
            assert!(v1 > 0, 805);
            let v2 = split_emergency_balance<T0>(arg0, (v1 as u64));
            let v3 = get_total_invested<T0>(arg0, arg1, arg4);
            arg0.tokensDeposited = v3;
            arg0.cur_debt = get_total_borrowed<T0>(arg0, arg1, arg4);
            return v2
        };
        let v4 = get_total_borrowed<T0>(arg0, arg1, arg4);
        let v5 = ((arg2 as u256) * (v4 as u256) + ((arg3 - 1) as u256)) / (arg3 as u256);
        let v6 = v5;
        ...
        repay_to_alphalend<T0>(arg0, arg1, (v6 as u64), arg4, arg5);
        let v8 = get_total_invested<T0>(arg0, arg1, arg4);
        let v9 = (v1 as u64) - v0 - v8;
        ...
        let v11 = 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise<T0>(arg1, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::remove_collateral<T0>(arg1, &arg0.position_cap, arg0.market_id, (v9 as u64), arg4), arg4, arg5);
        let v12 = get_total_invested<T0>(arg0, arg1, arg4);
        arg0.tokensDeposited = v12;
        arg0.cur_debt = get_total_borrowed<T0>(arg0, arg1, arg4);
        0x2::coin::into_balance<T0>(v11)
    }
