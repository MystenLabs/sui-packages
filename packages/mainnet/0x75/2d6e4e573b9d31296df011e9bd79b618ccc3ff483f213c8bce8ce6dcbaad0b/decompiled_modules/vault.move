module 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::vault {
    ...
    public fun activate<T0>(arg0: &mut DepositVault, arg1: bool, arg2: &0x2::tx_context::TxContext) : u64 {
        ...
        if (v0 > 0) {
            ...
            *v3 = *v3 + v2;
            ...
            let v8 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<DepositShare>(v7);
            let v9 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<DepositShare>(v7);
            let v10 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<DepositShare>(v7, 1);
            let v11 = 0;
            while (v11 < v8) {
                ...
                if (v11 + 1 < v8 && (v11 + 1) % v9 == 0) {
                    v10 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<DepositShare>(v7, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<DepositShare>(v7, v11 + 1));
                };
                v11 = v11 + 1;
            };
        };
    ...
    fun add_deposit_share(arg0: &mut DepositVault, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1 != 0 || arg2 != 0 || arg3 != 0 || arg4 != 0 || arg5 != 0 || arg6 != 0) {
            ...
            0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::push_back<DepositShare>(get_mut_deposit_shares(arg0), v2);
    ...
    public fun compound<T0>(arg0: &mut DepositVault, arg1: vector<TypusDepositReceipt>, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(arg0.has_next, 4);
        assert!(0x1::type_name::get<T0>() == arg0.deposit_token, 1);
        assert!(0x1::type_name::get<T0>() == arg0.bid_token, 1);
        let v0 = 0x2::tx_context::sender(arg2);
        let (v1, v2, v3, v4, v5, v6, v7) = extract_deposit_shares(arg0, arg1);
        let v8 = v5;
        let v9 = v4;
        if (v5 > 0) {
            let v10 = get_mut_deposit_vault_balance<T0>(arg0, 4);
            let v11 = 0x2::balance::split<T0>(v10, v5);
            v8 = v5 - v5;
            arg0.premium_share_supply = arg0.premium_share_supply - v5;
            let v12 = get_mut_deposit_vault_balance<T0>(arg0, 3);
            0x2::balance::join<T0>(v12, v11);
            v9 = v4 + v5;
            arg0.warmup_share_supply = arg0.warmup_share_supply + v5;
        };
        add_deposit_share(arg0, v1, v2, v3, v9, v8, v6, v7, arg2);
        let v13 = Compound{
            signer : v0,
            index  : arg0.index,
            token  : 0x1::type_name::get<T0>(),
    ...
    public fun delivery_b<T0, T1>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: 0x2::balance::Balance<T1>, arg3: 0x2::balance::Balance<T1>, arg4: &0x2::tx_context::TxContext) {
        ...
        let v6 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<DepositShare>(v5);
        let v7 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<DepositShare>(v5);
        let v8 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<DepositShare>(v5, 1);
        let v9 = 0;
        while (v9 < v6) {
            ...
            if (v9 + 1 < v6 && (v9 + 1) % v7 == 0) {
                v8 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<DepositShare>(v5, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<DepositShare>(v5, v9 + 1));
            };
            v9 = v9 + 1;
        };
    }
    ...
    public fun delivery_d<T0, T1>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: 0x2::balance::Balance<T1>, arg3: 0x2::balance::Balance<T0>, arg4: &0x2::tx_context::TxContext) {
        ...
        let v9 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<DepositShare>(v8);
        let v10 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<DepositShare>(v8);
        let v11 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<DepositShare>(v8, 1);
        let v12 = 0;
        while (v12 < v9) {
            ...
            if (v12 + 1 < v9 && (v12 + 1) % v10 == 0) {
                v11 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<DepositShare>(v8, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<DepositShare>(v8, v12 + 1));
            };
            v12 = v12 + 1;
        };
    }
    ...
    public fun deposit<T0>(arg0: &mut DepositVault, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: vector<TypusDepositReceipt>, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        0x2::balance::join<T0>(v1, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::utils::extract_balance<T0>(arg1, arg2, arg4));
    ...
    public fun exercise<T0>(arg0: &mut BidVault, arg1: vector<TypusBidReceipt>, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        while (!0x1::vector::is_empty<TypusBidReceipt>(&arg1)) {
            ...
            let v10 = v3;
            let v11 = remove_bid_share(arg0, 0x2::object::uid_to_address(&v10));
            let BidShare {
                receipt     : _,
                share       : v13,
                u64_padding : _,
            } = v11;
            let v15 = (((0x2::balance::value<T0>(get_bid_vault_balance<T0>(arg0)) as u128) * (v13 as u128) / ((v13 + arg0.share_supply) as u128)) as u64);
            0x2::object::delete(v10);
            let v16 = get_mut_bid_vault_balance<T0>(arg0);
            0x2::balance::join<T0>(&mut v1, 0x2::balance::split<T0>(v16, v15));
        };
        let v17 = 0x2::balance::value<T0>(&v1);
    ...
    public fun exercise_i<T0, T1>(arg0: &mut BidVault, arg1: vector<TypusBidReceipt>, arg2: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        while (!0x1::vector::is_empty<TypusBidReceipt>(&arg1)) {
            ...
            let v11 = v4;
            let v12 = remove_bid_share(arg0, 0x2::object::uid_to_address(&v11));
            let BidShare {
                receipt     : _,
                share       : v14,
                u64_padding : _,
            } = v12;
            let v16 = (((bid_vault_balance<T0>(arg0) as u128) * (v14 as u128) / ((v14 + arg0.share_supply) as u128)) as u64);
            let v17 = (((bid_vault_incentive_balance<T1>(arg0) as u128) * (v14 as u128) / ((v14 + arg0.share_supply) as u128)) as u64);
            0x2::object::delete(v11);
            let v18 = get_mut_bid_vault_balance<T0>(arg0);
            0x2::balance::join<T0>(&mut v1, 0x2::balance::split<T0>(v18, v16));
            let v19 = get_mut_bid_vault_incentive_balance<T1>(arg0);
            0x2::balance::join<T1>(&mut v2, 0x2::balance::split<T1>(v19, v17));
        };
        let v20 = 0x2::balance::value<T0>(&v1);
        0x1::vector::destroy_empty<TypusBidReceipt>(arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v1, arg2), v0);
        ...
        0x2::event::emit<Exercise>(v21);
        (v20, 0x2::balance::value<T1>(&v2))
    }
    ...
    fun extract_deposit_shares(arg0: &mut DepositVault, arg1: vector<TypusDepositReceipt>) : (u64, u64, u64, u64, u64, u64, vector<u64>) {
        ...
        while (!0x1::vector::is_empty<TypusDepositReceipt>(&arg1)) {
            ...
            let v16 = get_mut_deposit_shares(arg0);
            let v17 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<DepositShare>(v16);
            let v18 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<DepositShare>(v16);
            let v19 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice<DepositShare>(v16, 1);
            let v20 = 0;
            while (v20 < v17) {
                if (0x1::vector::borrow<DepositShare>(v19, v20 % v18).receipt == 0x2::object::uid_to_address(&v15)) {
                    let DepositShare {
                        receipt            : _,
                        active_share       : v22,
                        deactivating_share : v23,
                        inactive_share     : v24,
                        warmup_share       : v25,
                        premium_share      : v26,
                        incentive_share    : v27,
                        u64_padding        : v28,
                    } = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::swap_remove<DepositShare>(v16, v20);
                    let v29 = v28;
                    v0 = v0 + v22;
                    v1 = v1 + v23;
                    v2 = v2 + v24;
                    ...
                    v4 = v4 + v26;
                    v5 = v5 + v27;
                    if (0x1::vector::length<u64>(&v29) > 0) {
                        if (0x1::vector::is_empty<u64>(&v6)) {
                            v6 = v29;
                            break
                        };
                        let v30 = 0;
                        while (0x1::vector::length<u64>(&v29) > 0) {
                            let v31 = 0x1::vector::borrow_mut<u64>(&mut v6, v30);
                            *v31 = *v31 + 0x1::vector::pop_back<u64>(&mut v29);
                            v30 = v30 + 1;
                        };
                    } else {
                        break
                    ...
                    if (v20 + 1 < v17 && (v20 + 1) % v18 == 0) {
                        v19 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice<DepositShare>(v16, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<DepositShare>(v16, v20 + 1));
                    };
                    v20 = v20 + 1;
                };
            };
    ...
    public fun get_active_deposit_share(arg0: &DepositVault, arg1: address) : u64 {
        ...
        let v1 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<DepositShare>(v0);
        let v2 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<DepositShare>(v0);
        let v3 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice<DepositShare>(v0, 1);
        let v4 = 0;
        while (v4 < v1) {
            ...
            if (v4 + 1 < v1 && (v4 + 1) % v2 == 0) {
                v3 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice<DepositShare>(v0, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<DepositShare>(v0, v4 + 1));
            };
            v4 = v4 + 1;
        };
        0
    ...
    public fun get_bid_share(arg0: &BidVault, arg1: address) : u64 {
        ...
        let v1 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<BidShare>(v0);
        let v2 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<BidShare>(v0);
        let v3 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice<BidShare>(v0, 1);
        let v4 = 0;
        while (v4 < v1) {
            ...
            if (v4 + 1 < v1 && (v4 + 1) % v2 == 0) {
                v3 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice<BidShare>(v0, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<BidShare>(v0, v4 + 1));
            };
            v4 = v4 + 1;
        };
        0
    ...
    public fun get_bid_shares(arg0: &BidVault) : &0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::BigVector<BidShare> {
        0x2::dynamic_field::borrow<vector<u8>, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::BigVector<BidShare>>(&arg0.id, b"bid_shares")
    }
    ...
    public fun get_deposit_share(arg0: &DepositVault, arg1: u64) : &DepositShare {
        0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow<DepositShare>(get_deposit_shares(arg0), arg1)
    }
    ...
    public fun get_deposit_shares(arg0: &DepositVault) : &0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::BigVector<DepositShare> {
        0x2::dynamic_field::borrow<vector<u8>, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::BigVector<DepositShare>>(&arg0.id, b"deposit_shares")
    }
    ...
    fun get_mut_bid_shares(arg0: &mut BidVault) : &mut 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::BigVector<BidShare> {
        0x2::dynamic_field::borrow_mut<vector<u8>, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::BigVector<BidShare>>(&mut arg0.id, b"bid_shares")
    }
    ...
    fun get_mut_deposit_shares(arg0: &mut DepositVault) : &mut 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::BigVector<DepositShare> {
        0x2::dynamic_field::borrow_mut<vector<u8>, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::BigVector<DepositShare>>(&mut arg0.id, b"deposit_shares")
    }
    ...
    public fun harvest<T0>(arg0: &mut 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let v11 = 0;
        let v12 = arg1.fee_bp;
        let v13 = arg1.fee_share_bp;
        let v14 = arg1.shared_fee_pool;
        if (v5 > 0) {
            let v15 = get_mut_deposit_vault_balance<T0>(arg1, 4);
            let v16 = 0x2::balance::split<T0>(v15, v5);
            let v17 = (((0x2::balance::value<T0>(&v16) as u128) * (v12 as u128) / 10000) as u64);
            let v18 = 0x2::balance::split<T0>(&mut v16, v17);
            if (v13 > 0) {
                let v19 = (((0x2::balance::value<T0>(&v18) as u128) * (v13 as u128) / 10000) as u64);
                v11 = v19;
                0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::balance_pool::put_shared<T0>(arg0, 0x1::option::destroy_some<vector<u8>>(v14), 0x2::balance::split<T0>(&mut v18, v19));
            };
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v16, arg3), v0);
            0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::balance_pool::put<T0>(arg0, v18);
            v8 = v5 - v5;
    ...
    fun init(arg0: VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<TypusDepositReceipt>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<TypusDepositReceipt>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<TypusDepositReceipt>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{image_url}"));
        0x2::display::update_version<TypusDepositReceipt>(&mut v1);
        let v2 = 0x2::display::new<TypusBidReceipt>(&v0, arg1);
        0x2::display::add<TypusBidReceipt>(&mut v2, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<TypusBidReceipt>(&mut v2, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<TypusBidReceipt>(&mut v2, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{image_url}"));
    ...
    public fun new_bid(arg0: &mut BidVault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::push_back<BidShare>(get_mut_bid_shares(arg0), v2);
        0x2::transfer::public_transfer<TypusBidReceipt>(v1, v0);
    }

    public fun new_bid_vault<T0, T1>(arg0: u64, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) : BidVault {
        let v0 = 0x2::object::new(arg4);
        let v1 = 0x1::type_name::get<T1>();
        0x2::dynamic_field::add<vector<u8>, 0x2::balance::Balance<T0>>(&mut v0, b"bid_balance", 0x2::balance::zero<T0>());
        0x2::dynamic_field::add<vector<u8>, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::BigVector<BidShare>>(&mut v0, b"bid_shares", 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::new<BidShare>(4500, arg4));
        let v2 = BidVault{
            id              : v0,
    ...
    public fun new_deposit_vault<T0, T1>(arg0: u64, arg1: u64, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) : DepositVault {
        ...
        0x2::dynamic_field::add<vector<u8>, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::BigVector<DepositShare>>(&mut v0, b"deposit_shares", 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::new<DepositShare>(2500, arg5));
        let v3 = DepositVault{
            id                        : v0,
            deposit_token             : v1,
            bid_token                 : v2,
    ...
    public fun new_refund_vault<T0>(arg0: &mut 0x2::tx_context::TxContext) : RefundVault {
        ...
        0x2::dynamic_field::add<vector<u8>, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::BigVector<RefundShare>>(&mut v0, b"refund_shares", 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::new<RefundShare>(4500, arg0));
        let v2 = RefundVault{
            id           : v0,
            token        : v1,
            share_supply : 0,
    ...
    public fun put_refund<T0>(arg0: &mut RefundVault, arg1: 0x2::balance::Balance<T0>, arg2: address) {
        ...
        let v1 = 0x2::dynamic_field::borrow_mut<vector<u8>, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::BigVector<RefundShare>>(&mut arg0.id, b"refund_shares");
        let v2 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<RefundShare>(v1);
        let v3 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<RefundShare>(v1);
        let v4 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<RefundShare>(v1, 1);
        let v5 = 0;
        while (v5 < v2) {
            ...
            if (v5 + 1 < v2 && (v5 + 1) % v3 == 0) {
                v4 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<RefundShare>(v1, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<RefundShare>(v1, v5 + 1));
            };
            v5 = v5 + 1;
        };
        let v7 = RefundShare{
        ...
        0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::push_back<RefundShare>(v1, v7);
    }
    ...
    public fun recoup<T0>(arg0: &mut DepositVault, arg1: u64, arg2: &0x2::tx_context::TxContext) : (u64, u64) {
        ...
        if (v3 > 0 && arg1 > 0) {
            ...
            let v5 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<DepositShare>(v4);
            let v6 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<DepositShare>(v4);
            let v7 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<DepositShare>(v4, 1);
            let v8 = 0;
            while (v8 < v5) {
                ...
                if (v8 + 1 < v5 && (v8 + 1) % v6 == 0) {
                    v7 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<DepositShare>(v4, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<DepositShare>(v4, v8 + 1));
                };
                v8 = v8 + 1;
            };
        };
    ...
    fun remove_bid_share(arg0: &mut BidVault, arg1: address) : BidShare {
        ...
        let v1 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<BidShare>(v0);
        let v2 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<BidShare>(v0);
        let v3 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<BidShare>(v0, 1);
        let v4 = 0;
        while (v4 < v1) {
            ...
            if (v4 + 1 < v1 && (v4 + 1) % v2 == 0) {
                v3 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<BidShare>(v0, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<BidShare>(v0, v4 + 1));
            };
            v4 = v4 + 1;
        };
        let v5 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::swap_remove<BidShare>(v0, v4);
    ...
    public fun settle<T0, T1>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::type_name::get<T0>() == arg1.deposit_token, 1);
        assert!(0x1::type_name::get<T1>() == arg1.bid_token, 1);
        let v0 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::utils::multiplier(arg3);
        if (active_balance<T0>(arg0) + deactivating_balance<T0>(arg0) != 0) {
            ...
            let v15 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<DepositShare>(v14);
            let v16 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<DepositShare>(v14);
            let v17 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<DepositShare>(v14, 1);
            let v18 = 0;
            while (v18 < v15) {
                ...
                if (v18 + 1 < v15 && (v18 + 1) % v16 == 0) {
                    v17 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<DepositShare>(v14, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<DepositShare>(v14, v18 + 1));
                };
                v18 = v18 + 1;
            };
            if (!v13) {
    ...
    public fun summarize_deposit_shares(arg0: &DepositVault, arg1: vector<TypusDepositReceipt>) : (u64, u64, u64, u64, u64, u64) {
        ...
        while (!0x1::vector::is_empty<TypusDepositReceipt>(&arg1)) {
            ...
            let v15 = get_deposit_shares(arg0);
            let v16 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<DepositShare>(v15);
            let v17 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<DepositShare>(v15);
            let v18 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice<DepositShare>(v15, 1);
            let v19 = 0;
            while (v19 < v16) {
                if (0x1::vector::borrow<DepositShare>(v18, v19 % v17).receipt == 0x2::object::uid_to_address(&v14)) {
                    let v20 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow<DepositShare>(v15, v19);
                    v0 = v0 + v20.active_share;
                    v1 = v1 + v20.deactivating_share;
                    v2 = v2 + v20.inactive_share;
                    v3 = v3 + v20.warmup_share;
                    v4 = v4 + v20.premium_share;
                    v5 = v5 + v20.incentive_share;
                    break
                };
                if (v19 + 1 < v16 && (v19 + 1) % v17 == 0) {
                    v18 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice<DepositShare>(v15, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<DepositShare>(v15, v19 + 1));
                };
                v19 = v19 + 1;
            };
        };
    ...
    public fun take_refund<T0>(arg0: &mut RefundVault, arg1: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v2 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<RefundShare>(v1);
        let v3 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<RefundShare>(v1);
        let v4 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice<RefundShare>(v1, 1);
        let v5 = 0;
        while (v5 < v2) {
            ...
            if (v5 + 1 < v2 && (v5 + 1) % v3 == 0) {
                v4 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice<RefundShare>(v1, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<RefundShare>(v1, v5 + 1));
            };
            v5 = v5 + 1;
        };
        if (v5 == v2) {
        ...
        let RefundShare {
            ...
            share       : v7,
            u64_padding : _,
        } = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::swap_remove<RefundShare>(v1, v5);
    ...
    public fun terminate<T0>(arg0: &mut DepositVault, arg1: &0x2::tx_context::TxContext) {
        ...
        let v7 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::length<DepositShare>(v6);
        let v8 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_size<DepositShare>(v6);
        let v9 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<DepositShare>(v6, 1);
        let v10 = 0;
        while (v10 < v7) {
            ...
            if (v10 + 1 < v7 && (v10 + 1) % v8 == 0) {
                v9 = 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::borrow_slice_mut<DepositShare>(v6, 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::big_vector::slice_id<DepositShare>(v6, v10 + 1));
            };
            v10 = v10 + 1;
        };
        arg0.has_next = false;
    ...
    public fun update_deposit_receipt_display(arg0: &mut DepositVault, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String) {
        arg0.name = arg1;
        arg0.description = arg2;
        arg0.image_url = 0x2::url::new_unsafe(0x1::string::to_ascii(arg3));
    }
