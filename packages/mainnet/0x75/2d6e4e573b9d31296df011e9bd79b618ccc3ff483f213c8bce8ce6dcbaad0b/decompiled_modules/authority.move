module 0x752d6e4e573b9d31296df011e9bd79b618ccc3ff483f213c8bce8ce6dcbaad0b::authority {
    ...
    public fun add_authorized_user(arg0: &mut Authority, arg1: address, arg2: &0x2::tx_context::TxContext) {
        verify(arg0, arg2);
    ...
    public fun remove_authorized_user(arg0: &mut Authority, arg1: address, arg2: &0x2::tx_context::TxContext) {
        verify(arg0, arg2);
        if (0x2::linked_table::contains<address, bool>(&arg0.whitelist, arg1)) {
