module 0x754134471fcf2006b3581890bf7f67daa1f4291feefe8e8c44f2eaf7d19e9341::abc {
    struct ABC has drop {
        dummy_field: bool,
    }

    struct MyAwesomeTokenCap has store, key {
        id: 0x2::object::UID,
    ...
    public entry fun burn(arg0: &mut MyAwesomeTokenCap, arg1: 0x2::coin::Coin<ABC>) {
    ...
    fun init(arg0: ABC, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ABC>(arg0, 5, b"ABC", b"Trade Token", b"description containing multiple words and special characters!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.ibb.co/SXytMt5b/panda.jpg")), arg1);
        let v2 = v0;
        ...
        let v3 = MyAwesomeTokenCap{
            id       : 0x2::object::new(arg1),
            treasury : v2,
        };
        0x2::transfer::public_transfer<MyAwesomeTokenCap>(v3, @0x3f3c5b496a3587aa81b13d70c0681f3b468a6d282fa962b4a2db4ebec16fa6c);
    }

    public entry fun mint(arg0: &mut MyAwesomeTokenCap, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 > 0, 0);
