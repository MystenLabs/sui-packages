module 0x750bcd1195d71bed4a8655cfbb7838123344e40c6e42614d3a6fc8796ef8f494::baby {
    ...
    public entry fun mint(arg0: &mut 0x2::coin::TreasuryCap<BABY>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<BABY>>(0x2::coin::mint<BABY>(arg0, arg1, arg3), arg2);
    }

    fun init(arg0: BABY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BABY>(arg0, 9, b"baby", b"BABY", b"test", 0x1::option::none<0x2::url::Url>(), arg1);
