module 0x751ee08016d4c231062752e62d85bb0ee2eade627cd7637bf170645720e708b5::sy {
    ...
    fun deposit_internal<T0: drop>(arg0: address, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64, arg4: &mut SYStruct<T0>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<SYCoin<T0>> {
        ...
        assert!(v0 > 0, 0x751ee08016d4c231062752e62d85bb0ee2eade627cd7637bf170645720e708b5::error::sy_zero_deposit());
        assert!(arg3 >= arg2, 0x751ee08016d4c231062752e62d85bb0ee2eade627cd7637bf170645720e708b5::error::sy_insufficient_sharesOut());
    ...
    public fun exchangeRate<T0: drop>(arg0: &SYStruct<T0>) : 0x751ee08016d4c231062752e62d85bb0ee2eade627cd7637bf170645720e708b5::fixed_point64::FixedPoint64 {
        0x751ee08016d4c231062752e62d85bb0ee2eade627cd7637bf170645720e708b5::fixed_point64::one()
    }
    ...
    fun redeem_internal<T0: drop>(arg0: address, arg1: 0x2::balance::Balance<SYCoin<T0>>, arg2: u64, arg3: u64, arg4: &mut SYStruct<T0>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(v0 > 0, 0x751ee08016d4c231062752e62d85bb0ee2eade627cd7637bf170645720e708b5::error::sy_zero_redeem());
        assert!(arg3 >= arg2, 0x751ee08016d4c231062752e62d85bb0ee2eade627cd7637bf170645720e708b5::error::sy_insufficient_amountOut());
