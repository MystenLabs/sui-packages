module 0x752b25b72e63d1ba796c8c4041745c1cfe8977288510b6d6ecfdf63498a6370c::gift4395 {
    struct GIFT4395 has drop {
        dummy_field: bool,
    }

    struct TICKET_4395 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4395(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4395>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4395>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4395, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4395>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4395>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4395>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4395>>(v5, 0x2::tx_context::sender(arg1));
    }
