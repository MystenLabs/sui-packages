module 0x751f5cbb4ce535b6994d0bc9f9d1715017698fd60115d980b3749a606ceff1c7::sq {
    struct AC has key {
        id: 0x2::object::UID,
    }
    ...
    public fun cii(arg0: &mut SQR, arg1: &UC, arg2: u64, arg3: bool) : u64 {
        if (arg2 <= arg0.ci) {
            assert!(arg3, 13371);
            return 13371
        };
    ...
    public fun ciit(arg0: &mut SQR, arg1: &UC, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: bool) : u64 {
