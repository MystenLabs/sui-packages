module 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::marketplace {
    ...
    struct Orderbook<phantom T0: store + key, phantom T1> has store, key {
        ...
        asks: 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::CritbitTree<vector<Ask<T0>>>,
        bids: 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::CritbitTree<vector<Bid<T1>>>,
        VERSION: u64,
    }
    ...
    public entry fun create_ask<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: T0, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = if (0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::is_empty<vector<Bid<T1>>>(&arg0.bids)) {
            (false, 0)
        } else {
            let (v4, _) = 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::max_leaf<vector<Bid<T1>>>(&arg0.bids);
            (v4 >= arg2, v4)
        };
        if (v2) {
            let v6 = 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::borrow_mut_leaf_by_key<vector<Bid<T1>>>(&mut arg0.bids, v3);
            ...
            if (0x1::vector::length<Bid<T1>>(v6) == 0) {
                0x1::vector::destroy_empty<Bid<T1>>(0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::remove_leaf_by_key<vector<Bid<T1>>>(&mut arg0.bids, v3));
            };
        } else {
            let (v7, _) = 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::find_leaf<vector<Ask<T0>>>(&arg0.asks, arg2);
            if (v7) {
                0x1::vector::push_back<Ask<T0>>(0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::borrow_mut_leaf_by_key<vector<Ask<T0>>>(&mut arg0.asks, arg2), v1);
            } else {
                0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::insert_leaf<vector<Ask<T0>>>(&mut arg0.asks, arg2, 0x1::vector::singleton<Ask<T0>>(v1));
            };
    ...
    public entry fun create_bid<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = if (0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::is_empty<vector<Ask<T0>>>(&arg0.asks)) {
            (false, 0)
        } else {
            let (v4, _) = 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::min_leaf<vector<Ask<T0>>>(&arg0.asks);
            (v4 <= v0, v4)
        };
        if (v2) {
            let v6 = 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::borrow_mut_leaf_by_key<vector<Ask<T0>>>(&mut arg0.asks, v3);
            ...
            if (0x1::vector::length<Ask<T0>>(v6) == 0) {
                0x1::vector::destroy_empty<Ask<T0>>(0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::remove_leaf_by_key<vector<Ask<T0>>>(&mut arg0.asks, v3));
            };
        } else {
            let (v7, _) = 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::find_leaf<vector<Bid<T1>>>(&arg0.bids, v0);
            if (v7) {
                0x1::vector::push_back<Bid<T1>>(0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::borrow_mut_leaf_by_key<vector<Bid<T1>>>(&mut arg0.bids, v0), v1);
            } else {
                0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::insert_leaf<vector<Bid<T1>>>(&mut arg0.bids, v0, 0x1::vector::singleton<Bid<T1>>(v1));
            };
    ...
    public entry fun create_orderbook<T0: store + key, T1>(arg0: &mut AdminCap, arg1: u64, arg2: u64, arg3: vector<address>, arg4: vector<u64>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Orderbook<T0, T1>{
            ...
            config  : v0,
            asks    : 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::new<vector<Ask<T0>>>(arg5),
            bids    : 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::new<vector<Bid<T1>>>(arg5),
            VERSION : 1,
        };
    ...
    fun remove_ask<T0: store + key>(arg0: &mut 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::CritbitTree<vector<Ask<T0>>>, arg1: u64, arg2: 0x2::object::ID) : Ask<T0> {
        let (v0, _) = 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::find_leaf<vector<Ask<T0>>>(arg0, arg1);
        assert!(v0, 4);
        let v2 = 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::borrow_mut_leaf_by_key<vector<Ask<T0>>>(arg0, arg1);
        let v3 = 0;
        ...
        if (0x1::vector::length<Ask<T0>>(v2) == 0) {
            0x1::vector::destroy_empty<Ask<T0>>(0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::remove_leaf_by_key<vector<Ask<T0>>>(arg0, arg1));
        };
        0x1::vector::remove<Ask<T0>>(v2, v3)
    }

    fun remove_bid<T0>(arg0: &mut 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::CritbitTree<vector<Bid<T0>>>, arg1: u64, arg2: address) : Bid<T0> {
        let (v0, _) = 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::find_leaf<vector<Bid<T0>>>(arg0, arg1);
        assert!(v0, 5);
        let v2 = 0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::borrow_mut_leaf_by_key<vector<Bid<T0>>>(arg0, arg1);
        let v3 = 0;
        ...
        if (0x1::vector::length<Bid<T0>>(v2) == 0) {
            0x1::vector::destroy_empty<Bid<T0>>(0x7540417ebf9d33c30bbcc0f6ee5e2b2e51af7a4fd2a63d326e9dc3fc100a0f54::crit_bit::remove_leaf_by_key<vector<Bid<T0>>>(arg0, arg1));
        };
