module 0x754959c063fc20d5e5c363b52ccf654e9cf72ac27c21682692a3927ab9429adf::stonks_ai_agents {
    struct STONKS_AI_AGENTS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: STONKS_AI_AGENTS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<STONKS_AI_AGENTS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Stonks AI Agents"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"AI Agents that monitor institutional / whale wallets so that investors can make better informed decisions. They are also tailored to look out for potential rug-pulls / honeypots in an investors portfolio."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://I9_oJMvUQsj87yVKjnHyj3kDjWEDEuGuSnVi_NtR8EQ"));
