module 0x754df39c80302f44d3ba7fed8de7f1a45c747deffb4acd8e0a1567f1270c96e9::the_captains_loot {
    ...
    public fun mint(arg0: &PubKey, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: u8, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: u64, arg12: 0x1::string::String, arg13: 0x1::string::String, arg14: &mut Counter, arg15: &MintConfig, arg16: &mut MintStats, arg17: &Payout, arg18: 0x2::coin::Coin<0x2::sui::SUI>, arg19: &0x2::transfer_policy::TransferPolicy<BoxNFT>, arg20: &0x2::clock::Clock, arg21: &mut 0x2::tx_context::TxContext) {
    ...
    fun mint_core(arg0: &PubKey, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: u8, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: u64, arg12: 0x1::string::String, arg13: 0x1::string::String, arg14: &mut Counter, arg15: &MintConfig, arg16: &mut MintStats, arg17: &Payout, arg18: 0x2::coin::Coin<0x2::sui::SUI>, arg19: &0x2::transfer_policy::TransferPolicy<BoxNFT>, arg20: &mut 0x2::kiosk::Kiosk, arg21: &0x2::kiosk::KioskOwnerCap, arg22: &0x2::clock::Clock, arg23: &mut 0x2::tx_context::TxContext) {
        ...
        while (v5 < arg3) {
            ...
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v7, 0x1::string::utf8(b"Capacity"), 0x1::string::utf8(0x1::string::into_bytes(0x1::u64::to_string(arg11))));
            ...
            0x2::kiosk::lock<BoxNFT>(arg20, arg21, arg19, v8);
            v5 = v5 + 1;
        };
    }
