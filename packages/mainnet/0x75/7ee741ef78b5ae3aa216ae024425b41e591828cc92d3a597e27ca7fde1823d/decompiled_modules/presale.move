module 0x757ee741ef78b5ae3aa216ae024425b41e591828cc92d3a597e27ca7fde1823d::presale {
    ...
    struct Treasury has key {
        id: 0x2::object::UID,
        rewardsTreasury: 0x2::balance::Balance<0x757ee741ef78b5ae3aa216ae024425b41e591828cc92d3a597e27ca7fde1823d::token::TOKEN>,
    ...
    public entry fun claim(arg0: &mut UserState, arg1: &mut Treasury, arg2: &mut PresalePool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        *0x2::vec_map::get_mut<address, bool>(&mut arg0.isClaimed, &v0) = true;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x757ee741ef78b5ae3aa216ae024425b41e591828cc92d3a597e27ca7fde1823d::token::TOKEN>>(0x2::coin::take<0x757ee741ef78b5ae3aa216ae024425b41e591828cc92d3a597e27ca7fde1823d::token::TOKEN>(&mut arg1.rewardsTreasury, v2, arg4), v0);
    }
    ...
    public fun getTreasury(arg0: &Treasury) : (u64, u64) {
        (0x2::balance::value<0x2::sui::SUI>(&arg0.stakedCoinsTreasury), 0x2::balance::value<0x757ee741ef78b5ae3aa216ae024425b41e591828cc92d3a597e27ca7fde1823d::token::TOKEN>(&arg0.rewardsTreasury))
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Treasury{
            id                  : 0x2::object::new(arg0),
            rewardsTreasury     : 0x2::balance::zero<0x757ee741ef78b5ae3aa216ae024425b41e591828cc92d3a597e27ca7fde1823d::token::TOKEN>(),
    ...
    public entry fun setRewardAmount(arg0: &AdminCap, arg1: &mut Treasury, arg2: 0x2::coin::Coin<0x757ee741ef78b5ae3aa216ae024425b41e591828cc92d3a597e27ca7fde1823d::token::TOKEN>) {
        0x2::balance::join<0x757ee741ef78b5ae3aa216ae024425b41e591828cc92d3a597e27ca7fde1823d::token::TOKEN>(&mut arg1.rewardsTreasury, 0x2::coin::into_balance<0x757ee741ef78b5ae3aa216ae024425b41e591828cc92d3a597e27ca7fde1823d::token::TOKEN>(arg2));
    }
