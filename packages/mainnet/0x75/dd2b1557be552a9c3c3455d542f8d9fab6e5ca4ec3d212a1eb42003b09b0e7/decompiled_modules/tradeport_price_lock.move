module 0x896ba250043a64e436dcebddf79838f2a3deb5d9c9f13a0b2064646cf13c9c9b::tradeport_price_lock {
    ...
    public fun confirm_coins_request<T0: store + key>(arg0: &mut Store, arg1: &0x2::clock::Clock, arg2: CoinRequest<T0>, arg3: 0x2::object::ID, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &0x2::transfer_policy::TransferPolicy<T0>, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        0x2::dynamic_object_field::add<u64, 0x2::kiosk::PurchaseCap<T0>>(&mut v1.id, 0, 0x2::kiosk::list_with_purchase_cap<T0>(arg4, arg5, arg3, 0, arg10));
        let v2 = 0x2::coin::zero<0x2::sui::SUI>(arg10);
        confirm_strike<T0>(arg0, arg1, v0, arg4, arg6, arg7, arg8, arg9, v2, arg10)
    }

    public fun confirm_strike<T0: store + key>(arg0: &mut Store, arg1: &0x2::clock::Clock, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &0x2::transfer_policy::TransferPolicy<T0>, arg7: u64, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        if (v0.strike_type == 1) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg8, v0.maker_price, arg9), v0.maker);
            0x2::coin::put<0x2::sui::SUI>(&mut arg0.balance, arg8);
        } else {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg8) == 0, 8);
    ...
    public fun create_coin_request<T0: store + key>(arg0: &mut Store, arg1: &0x2::clock::Clock, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : CoinRequest<T0> {
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, Strike<T0>>(&arg0.id, arg2), 4);
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Strike<T0>>(&mut arg0.id, arg2);
        assert!(0x1::option::is_some<u64>(&v0.expire_at) && *0x1::option::borrow<u64>(&v0.expire_at) > 0x2::clock::timestamp_ms(arg1), 3);
        assert!(v0.state == 1, 2);
