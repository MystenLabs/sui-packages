module 0x75e4ae559cfe95b5245d0d5ae9e8ef729dcf309d7481840980d45f1cb26d98e8::cnsnft9658 {
    struct CNSNFT9658 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9658, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9658>(arg0, arg1);
