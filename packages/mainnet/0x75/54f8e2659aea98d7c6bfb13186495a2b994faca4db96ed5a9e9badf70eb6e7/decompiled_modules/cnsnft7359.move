module 0x7554f8e2659aea98d7c6bfb13186495a2b994faca4db96ed5a9e9badf70eb6e7::cnsnft7359 {
    struct CNSNFT7359 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7359, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8465"));
        let v4 = 0x2::package::claim<CNSNFT7359>(arg0, arg1);
