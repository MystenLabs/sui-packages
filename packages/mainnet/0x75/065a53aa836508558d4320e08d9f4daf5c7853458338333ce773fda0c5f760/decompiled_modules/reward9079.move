module 0x75065a53aa836508558d4320e08d9f4daf5c7853458338333ce773fda0c5f760::reward9079 {
    struct REWARD9079 has drop {
        dummy_field: bool,
    }

    struct TICKET_9079 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9079(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9079>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9079>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9079, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9079>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9079>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9079>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9079>>(v5, 0x2::tx_context::sender(arg1));
    }
