module 0x75cf47015a1bb4a9edb7946bc39707586a070574ddab37ea04b11c9582488999::cnsnft3618 {
    struct CNSNFT3618 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3618, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2706"));
        let v4 = 0x2::package::claim<CNSNFT3618>(arg0, arg1);
