module 0x759398ba04d7fb6d2bd7c66e7960d87f361fdeed16e6d395ac566275efb156f3::reward9056 {
    struct REWARD9056 has drop {
        dummy_field: bool,
    }

    struct TICKET_9056 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9056(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9056>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9056>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9056, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9056>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9056>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9056>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9056>>(v5, 0x2::tx_context::sender(arg1));
    }
