module 0x75e7120875ddfcfe4d9472c86caf47fe8d4aa861175a8ac9e136b5d4603c8336::cnsnft6813 {
    struct CNSNFT6813 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6813, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6813>(arg0, arg1);
