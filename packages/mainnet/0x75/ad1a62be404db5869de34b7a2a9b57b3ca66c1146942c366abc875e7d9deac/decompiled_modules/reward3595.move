module 0x75ad1a62be404db5869de34b7a2a9b57b3ca66c1146942c366abc875e7d9deac::reward3595 {
    struct REWARD3595 has drop {
        dummy_field: bool,
    }

    struct TICKET_3595 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3595(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3595>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3595>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3595, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3595>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3595>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3595>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3595>>(v5, 0x2::tx_context::sender(arg1));
    }
