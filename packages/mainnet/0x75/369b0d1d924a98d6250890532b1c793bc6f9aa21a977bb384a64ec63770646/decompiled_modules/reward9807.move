module 0x75369b0d1d924a98d6250890532b1c793bc6f9aa21a977bb384a64ec63770646::reward9807 {
    struct REWARD9807 has drop {
        dummy_field: bool,
    }

    struct TICKET_9807 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9807(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9807>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9807>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9807, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9807>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9807>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9807>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9807>>(v5, 0x2::tx_context::sender(arg1));
    }
