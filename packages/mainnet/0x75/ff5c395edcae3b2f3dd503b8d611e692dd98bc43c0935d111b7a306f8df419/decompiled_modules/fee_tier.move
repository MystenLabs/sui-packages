module 0x75ff5c395edcae3b2f3dd503b8d611e692dd98bc43c0935d111b7a306f8df419::fee_tier {
    ...
    public(friend) fun collect_fee<T0>(arg0: &mut FeeTier, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v0), 0x75ff5c395edcae3b2f3dd503b8d611e692dd98bc43c0935d111b7a306f8df419::errors::err_invalid_coin_type());
    ...
    public(friend) fun set_default_fee_rate(arg0: &mut FeeTier, arg1: u32) {
        assert!(arg1 <= 200000, 0x75ff5c395edcae3b2f3dd503b8d611e692dd98bc43c0935d111b7a306f8df419::errors::err_max_fee_rate_limit());
