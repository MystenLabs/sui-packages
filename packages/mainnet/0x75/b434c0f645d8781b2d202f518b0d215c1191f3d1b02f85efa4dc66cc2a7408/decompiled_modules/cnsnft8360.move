module 0x75b434c0f645d8781b2d202f518b0d215c1191f3d1b02f85efa4dc66cc2a7408::cnsnft8360 {
    struct CNSNFT8360 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8360, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8360>(arg0, arg1);
