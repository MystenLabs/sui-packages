module 0x75c2d079129f6d084bba84aa2043c485346d60bde20532aa22f1cfae0c439090::reward8895 {
    struct REWARD8895 has drop {
        dummy_field: bool,
    }

    struct TICKET_8895 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8895(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8895>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8895>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8895, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8895>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8895>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8895>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8895>>(v5, 0x2::tx_context::sender(arg1));
    }
