module 0x75ecf86d06f900ceaa979339965b5f9fa4e8a43a60816e58cbbfa37762bba5b7::vault {
    ...
    public fun commit_strategy<T0, T1>(arg0: &mut Vault<T0>, arg1: BorrowReceipt<T0>, arg2: 0x2::balance::Balance<T1>, arg3: u8, arg4: u64) {
        ...
        if (v0 > 0) {
            assert!(arg4 >= v0 - v0 * 0x75ecf86d06f900ceaa979339965b5f9fa4e8a43a60816e58cbbfa37762bba5b7::floors::max_slippage_ceil() / 10000, 207);
        };
    ...
    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::token::Token<0xa4ffc4778b541f2c962c1548a80eebb21e884061ac7f5efea419c9aa8dd9a484::receipt::RECEIPT> {
        ...
        let v2 = if (arg0.total_receipts == 0) {
            ...
            let v3 = 0x2::balance::value<T0>(&arg0.idle_balance);
            assert!(v3 > 0, 200);
            (((v0 as u128) * (arg0.total_receipts as u128) / (v3 as u128)) as u64)
        } else {
            assert!(arg0.last_heartbeat_tvl > 0, 210);
            0x75ecf86d06f900ceaa979339965b5f9fa4e8a43a60816e58cbbfa37762bba5b7::floors::assert_heartbeat_age(0x2::clock::timestamp_ms(arg2) - arg0.last_heartbeat_ms);
    ...
    public fun set_vote_lock<T0>(arg0: &mut Vault<T0>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock) {
        ...
        0x75ecf86d06f900ceaa979339965b5f9fa4e8a43a60816e58cbbfa37762bba5b7::floors::assert_vote_lock_duration(v1);
        if (0x2::table::contains<address, u64>(&arg0.vote_locks, arg1)) {
    ...
    public fun update_heartbeat_tvl<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock) {
        ...
        if (v1 > 0) {
            ...
            0x75ecf86d06f900ceaa979339965b5f9fa4e8a43a60816e58cbbfa37762bba5b7::floors::assert_tvl_delta((((v2 as u128) * 10000 / (v1 as u128)) as u64));
        };
