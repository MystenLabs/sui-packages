module 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::rank_list {
    ...
    public(friend) fun distribute_reward(arg0: &mut TodayRank, arg1: u64, arg2: &0x2::clock::Clock) : vector<RankItem> {
        ...
        let v3 = 0;
        while (v3 < v0) {
            v2 = v2 + (0x1::vector::borrow<RankItem>(&arg0.items, v3).amount as u128);
            v3 = v3 + 1;
        };
        if (v2 == 0 || arg1 == 0) {
            return v1
        ...
        v3 = 0;
        while (v3 < v0) {
            let v5 = 0x1::vector::borrow<RankItem>(&arg0.items, v3);
            let v6 = if (v3 + 1 < v0) {
                let v7 = (arg1 as u128) * (v5.amount as u128) / v2;
                v4 = v4 + v7;
                v7
            } else {
                (arg1 as u128) - v4
            ...
            0x1::vector::push_back<RankItem>(&mut v1, v8);
            v3 = v3 + 1;
        };
        let v9 = current_day(arg2);
        if (arg0.day != v9) {
            arg0.day = v9;
