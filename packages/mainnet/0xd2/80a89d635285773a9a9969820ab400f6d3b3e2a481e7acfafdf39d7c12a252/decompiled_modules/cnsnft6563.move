module 0xd280a89d635285773a9a9969820ab400f6d3b3e2a481e7acfafdf39d7c12a252::cnsnft6563 {
    struct CNSNFT6563 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6563, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6563>(arg0, arg1);
