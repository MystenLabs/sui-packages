module 0xd262df2f060348d133526978681445b833573d04bec208c5d7e9f2f884f34320::store {
    ...
    public entry fun collect_profits(arg0: &mut ItemStore, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.paid, v1 * 50 / 1000, arg1), @0x96fa421b3331299e4856b5f50f62ec0af2784a34a7278fcad55c0286a351fee9);
    }
