module 0xd258f50eeda3fba66b317036e125f52f12091f6da223da0501e47da38b52b0dc::test_boxes {
    struct TEST_BOXES has drop {
        dummy_field: bool,
    }
    ...
    struct MintConfig has store, key {
        id: 0x2::object::UID,
        paused: bool,
        default_level_limit: u64,
        total_mint_limit: u64,
        per_level_limits: 0x2::table::Table<u64, u64>,
    }
    ...
    struct MintStats has store, key {
        ...
        per_level: 0x2::table::Table<u64, 0x2::table::Table<address, u64>>,
    }
    ...
    public fun admin_set_default_level_limit(arg0: &AdminCap, arg1: &mut MintConfig, arg2: u64) {
        arg1.default_level_limit = arg2;
    }

    public fun admin_set_level_limit(arg0: &AdminCap, arg1: &mut MintConfig, arg2: u64, arg3: u64) {
        if (0x2::table::contains<u64, u64>(&arg1.per_level_limits, arg2)) {
            *0x2::table::borrow_mut<u64, u64>(&mut arg1.per_level_limits, arg2) = arg3;
        } else {
            0x2::table::add<u64, u64>(&mut arg1.per_level_limits, arg2, arg3);
        };
    }
    ...
    fun ensure_level_bucket(arg0: &mut MintStats, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        if (!0x2::table::contains<u64, 0x2::table::Table<address, u64>>(&arg0.per_level, arg1)) {
            0x2::table::add<u64, 0x2::table::Table<address, u64>>(&mut arg0.per_level, arg1, 0x2::table::new<address, u64>(arg2));
        };
    }

    fun expect_box_level(arg0: u64) : u8 {
        assert!(arg0 > 0 && arg0 <= 3, 12);
        (arg0 as u8)
    }

    public fun get_box_level_by_id(arg0: &0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID) : u8 {
        0x2::kiosk::borrow<BoxNFT>(arg0, arg1, arg2).box_level
    }

    public fun get_level_count(arg0: &MintStats, arg1: u64, arg2: address) : u64 {
        if (0x2::table::contains<u64, 0x2::table::Table<address, u64>>(&arg0.per_level, arg1)) {
            let v1 = 0x2::table::borrow<u64, 0x2::table::Table<address, u64>>(&arg0.per_level, arg1);
    ...
    fun get_level_limit(arg0: &MintConfig, arg1: u64) : u64 {
        if (0x2::table::contains<u64, u64>(&arg0.per_level_limits, arg1)) {
            *0x2::table::borrow<u64, u64>(&arg0.per_level_limits, arg1)
        } else {
            arg0.default_level_limit
        }
    }
    ...
    fun init(arg0: TEST_BOXES, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = MintConfig{
            id                  : 0x2::object::new(arg1),
            paused              : false,
            default_level_limit : 10000,
            total_mint_limit    : 10000,
            per_level_limits    : 0x2::table::new<u64, u64>(arg1),
        };
        ...
        let v5 = MintStats{
            ...
            per_level   : 0x2::table::new<u64, 0x2::table::Table<address, u64>>(arg1),
        };
        0x2::transfer::share_object<MintStats>(v5);
        let v6 = 0x2::package::claim<TEST_BOXES>(arg0, arg1);
        ...
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<BoxNFT>>(v13, @0x552c4e45ef071c3c14e75a5247a9c5dd4e7430e3783e217b663aab1d926d8fa5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v6, @0x552c4e45ef071c3c14e75a5247a9c5dd4e7430e3783e217b663aab1d926d8fa5);
        0x2::transfer::public_transfer<0x2::display::Display<BoxNFT>>(v11, @0x552c4e45ef071c3c14e75a5247a9c5dd4e7430e3783e217b663aab1d926d8fa5);
    }
    ...
    public fun mint(arg0: &PubKey, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: u8, arg7: u64, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: &mut Counter, arg13: &MintConfig, arg14: &mut MintStats, arg15: &Payout, arg16: 0x2::coin::Coin<0x2::sui::SUI>, arg17: &0x2::transfer_policy::TransferPolicy<BoxNFT>, arg18: &0x2::clock::Clock, arg19: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::kiosk::new(arg19);
        let v2 = v1;
        let v3 = v0;
        let v4 = &mut v3;
        mint_core(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, v4, &v2, arg18, arg19);
        let v5 = KioskCreated{
        ...
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v2, 0x2::tx_context::sender(arg19));
    }

    fun mint_core(arg0: &PubKey, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: u8, arg7: u64, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: &mut Counter, arg13: &MintConfig, arg14: &mut MintStats, arg15: &Payout, arg16: 0x2::coin::Coin<0x2::sui::SUI>, arg17: &0x2::transfer_policy::TransferPolicy<BoxNFT>, arg18: &mut 0x2::kiosk::Kiosk, arg19: &0x2::kiosk::KioskOwnerCap, arg20: &0x2::clock::Clock, arg21: &mut 0x2::tx_context::TxContext) {
        assert!(!arg13.paused, 8);
        ...
        0x1::vector::append<u8>(&mut v1, 0x1::string::into_bytes(arg11));
        ...
        assert!(!0x2::table::contains<vector<u8>, bool>(&arg14.used_sigs, v2), 4);
        let v3 = take_suffix(&v1, 66);
        assert_minter_text_matches_prefixed64(arg4, &v3);
        let v4 = 0x2::tx_context::sender(arg21);
        assert!(v4 == arg4, 6);
        assert!(get_level_count(arg14, arg7, v4) + arg3 <= get_level_limit(arg13, arg7), 9);
        assert!(get_mint_count(arg14, v4) + arg3 <= arg13.total_mint_limit, 10);
        if (0x2::table::contains<address, u64>(&arg14.per_address, v4)) {
            let v5 = 0x2::table::borrow_mut<address, u64>(&mut arg14.per_address, v4);
            *v5 = *v5 + arg3;
        } else {
            0x2::table::add<address, u64>(&mut arg14.per_address, v4, arg3);
        };
        ensure_level_bucket(arg14, arg7, arg21);
        if (0x2::table::contains<address, u64>(0x2::table::borrow<u64, 0x2::table::Table<address, u64>>(&arg14.per_level, arg7), v4)) {
            let v6 = 0x2::table::borrow_mut<address, u64>(0x2::table::borrow_mut<u64, 0x2::table::Table<address, u64>>(&mut arg14.per_level, arg7), v4);
            *v6 = *v6 + arg3;
        } else {
            0x2::table::add<address, u64>(0x2::table::borrow_mut<u64, 0x2::table::Table<address, u64>>(&mut arg14.per_level, arg7), v4, arg3);
        };
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg16) == arg2, 5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg16, arg15.recipient);
        0x2::table::add<vector<u8>, bool>(&mut arg14.used_sigs, v2, true);
        let v7 = expect_box_level(arg7);
        let v8 = 0;
        while (v8 < arg3) {
            let v9 = arg12.next_id;
            arg12.next_id = v9 + 1;
            let v10 = BoxNFT{
                id          : 0x2::object::new(arg21),
                box_id      : v9,
                box_level   : v7,
                name        : clone_string(&arg8),
                description : clone_string(&arg9),
                image_url   : clone_string(&arg10),
            };
            let v11 = MintEvent{
                minter       : v4,
                box_id       : v9,
            ...
            0x2::kiosk::lock<BoxNFT>(arg18, arg19, arg17, v10);
            v8 = v8 + 1;
        };
    }
