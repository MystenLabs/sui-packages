module 0xd217e60bac132f689240d92a4e2007dab63ae8cfa8edd857251c71ee110c368b::whale_nft {
    ...
    public fun airdrop_to_kiosk(arg0: &AdminCap, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: u64, arg4: vector<u8>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::kiosk::place<WhaleNFT>(arg1, arg2, v0);
    }
    ...
    fun init(arg0: WHALE_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v6, v7) = 0x2::transfer_policy::new<WhaleNFT>(&v0, arg1);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<WhaleNFT>>(v5, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<WhaleNFT>>(v7, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<WhaleNFT>>(v6);
