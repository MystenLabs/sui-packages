module 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position {
    ...
    public(friend) fun decrease_liquidity(arg0: &mut PositionInfo, arg1: &mut Position, arg2: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::Bin, arg3: u128) {
        ...
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v1.bin_id, 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::id(arg2)), 13906836137144680468);
    ...
    public(friend) fun add_liquidity(arg0: &mut PositionInfo, arg1: &mut Position, arg2: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::Bin, arg3: u128) {
        let v0 = bin_idx(arg1, 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::id(arg2));
        assert!(0x1::vector::length<BinStat>(&arg0.stats) == v0, 13906835819317100564);
        0x1::vector::push_back<BinStat>(&mut arg0.stats, new_bin_stat(arg2, 0));
        let v1 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, v0);
        v1.fee_a_growth = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::fee_a_growth_global(arg2);
        v1.fee_b_growth = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::fee_b_growth_global(arg2);
        v1.rewards_growth = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::rewards_growth_global(arg2);
    ...
    public(friend) fun assert_no_pending_add(arg0: &Position) {
        assert!(arg0.flash_count == 0, 13906837588844412960);
    }
    ...
    public fun borrow_position_info(arg0: &PositionManager, arg1: 0x2::object::ID) : &PositionInfo {
        assert!(0x2::table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 13906837687628529694);
    ...
    public(friend) fun clear_pending_add(arg0: &mut Position) {
        assert!(arg0.flash_count > 0, 13906837537304936482);
    ...
    public(friend) fun close_position_bin(arg0: &mut ClosePositionCert, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::Bin, arg2: BinStat) : (u64, u64) {
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(arg2.bin_id, 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::id(arg1)), 13906836648245788692);
        let v0 = &mut arg2;
    ...
    fun decrease_liquidity_per_bin(arg0: &mut BinStat, arg1: u128) : u128 {
        assert!(arg0.liquidity_share >= arg1, 13906839135031590928);
    ...
    public(friend) fun destroy_cert(arg0: ClosePositionCert) {
        ...
        let v9 = v8;
        assert!(0x1::vector::length<BinStat>(&v9) == 0, 13906837219476963356);
        0x1::vector::destroy_empty<BinStat>(v9);
        assert!(v2 + v5 == 0, 13906837228066504726);
        assert!(v3 + v6 == 0, 13906837232361603096);
        let v10 = v7;
        let v11 = 0;
        while (v11 < 0x1::vector::length<u64>(&v10)) {
            assert!(0x1::vector::pop_back<u64>(&mut v10) == 0, 13906837240951668762);
            v11 = v11 + 1;
        };
    ...
    public(friend) fun increase_liquidity(arg0: &mut PositionInfo, arg1: &mut Position, arg2: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::Bin, arg3: u128) {
        let v0 = bin_idx(arg1, 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::id(arg2));
        let v1 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, v0);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v1.bin_id, 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::id(arg2)), 13906835961051021332);
        let v2 = &mut arg0.fee_owned_a;
        let v3 = &mut arg0.fee_owned_b;
        update_fee_per_bin(v1, 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::fee_a_growth_global(arg2), 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::fee_b_growth_global(arg2), v2, v3);
        let v4 = &mut arg0.rewards_owned;
    ...
    fun increase_liquidity_per_bin(arg0: &mut BinStat, arg1: u128) : u128 {
        assert!(340282366920938463463374607431768211455 - arg0.liquidity_share >= arg1, 13906839070606950414);
        arg0.liquidity_share = arg0.liquidity_share + arg1;
        arg0.liquidity_share
    }
    ...
    public(friend) fun take_reward_from_close_cert(arg0: &mut ClosePositionCert, arg1: u64) : u64 {
        assert!(0x1::vector::length<u64>(&arg0.position_info.rewards_owned) > arg1, 13906836927418531858);
    ...
    public(friend) fun update_fee(arg0: &mut PositionInfo, arg1: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::Bin) {
        ...
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v0.bin_id, 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::id(arg1)), 13906836257403764756);
    ...
    fun update_fee_per_bin(arg0: &mut BinStat, arg1: u128, arg2: u128, arg3: &mut u64, arg4: &mut u64) {
        ...
        *arg3 = *arg3 + 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::dlmm_math::calculate_amount_by_growth(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(arg1, arg0.fee_a_growth), arg0.liquidity_share);
        *arg4 = *arg4 + 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::dlmm_math::calculate_amount_by_growth(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(arg2, arg0.fee_b_growth), arg0.liquidity_share);
    }
    ...
    fun update_reward_per_bin(arg0: &mut BinStat, arg1: vector<u128>, arg2: &mut vector<u64>) {
        ...
        assert!(v1 <= v0, 13906839246700871698);
        let v2 = 0;
        while (v2 < v0) {
    ...
    public(friend) fun update_rewards(arg0: &mut PositionInfo, arg1: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::Bin) {
        let v0 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, bin_idx_on_position_info(arg0, 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::id(arg1)));
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v0.bin_id, 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::bin::id(arg1)), 13906836356188012564);
        if (liquidity_share(v0) == 0) {
            return
        };
