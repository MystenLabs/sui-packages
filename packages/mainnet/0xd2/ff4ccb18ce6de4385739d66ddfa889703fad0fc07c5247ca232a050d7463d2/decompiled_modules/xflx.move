module 0xd2ff4ccb18ce6de4385739d66ddfa889703fad0fc07c5247ca232a050d7463d2::xflx {
    ...
    struct TreasuryManagement has store, key {
        id: 0x2::object::UID,
        total_flx_locked: 0x2::coin::Coin<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>,
        cap: 0x2::coin::TreasuryCap<XFLX>,
    }

    struct Lock has store, key {
        id: 0x2::object::UID,
        flx: 0x2::coin::Coin<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>,
    ...
    public entry fun burn(arg0: &mut TreasuryManagement, arg1: &0x2::clock::Clock, arg2: Lock, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>>(v0, arg3);
    ...
    public fun value(arg0: &Lock) : (u64, u64) {
        (0x2::coin::value<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>(&arg0.flx), 0x2::coin::value<XFLX>(&arg0.xflx))
    }
    ...
    public entry fun cancel_lazy_burn(arg0: &mut TreasuryManagement, arg1: &0x2::clock::Clock, arg2: Lock, arg3: address) {
        ...
        let (v0, v1) = unlock_direct(arg2);
        0x2::coin::join<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>(&mut arg0.total_flx_locked, v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<XFLX>>(v1, arg3);
    }

    fun create_lock(arg0: &0x2::clock::Clock, arg1: 0x2::coin::Coin<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>, arg2: 0x2::coin::Coin<XFLX>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Lock {
    ...
    fun init(arg0: XFLX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = TreasuryManagement{
            ...
            total_flx_locked : 0x2::coin::zero<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>(arg1),
            cap              : v0,
        };
    ...
    public entry fun lazy_burn(arg0: &mut TreasuryManagement, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<XFLX>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::coin::split<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>(&mut arg0.total_flx_locked, calculate_amount_to_receive(v0, arg3), arg5);
        if (arg3 > 0) {
            let v2 = create_lock(arg1, v1, arg2, arg3, arg5);
            0x2::object::id<Lock>(&v2);
            0x2::transfer::transfer<Lock>(v2, arg4);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>>(v1, arg4);
            0x2::coin::burn<XFLX>(&mut arg0.cap, arg2);
        };
    }

    public entry fun mint_and_transfer(arg0: &mut TreasuryManagement, arg1: 0x2::coin::Coin<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 != @0x0, 2);
        let v0 = 0x2::coin::value<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>(&arg1);
        assert!(v0 > 0, 0);
        0x2::coin::join<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>(&mut arg0.total_flx_locked, arg1);
    ...
    fun unlock_direct(arg0: Lock) : (0x2::coin::Coin<0x6a8b5f10dff913b0c03154a11a1094709ee8f2f85716bd560579f929235ab241::flx::FLX>, 0x2::coin::Coin<XFLX>) {
        let Lock {
            id             : v0,
            flx            : v1,
            xflx           : v2,
