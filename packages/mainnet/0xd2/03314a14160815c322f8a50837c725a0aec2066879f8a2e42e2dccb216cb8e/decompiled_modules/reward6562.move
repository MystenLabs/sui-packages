module 0xd203314a14160815c322f8a50837c725a0aec2066879f8a2e42e2dccb216cb8e::reward6562 {
    struct REWARD6562 has drop {
        dummy_field: bool,
    }

    struct TICKET_6562 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6562(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6562>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6562>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6562, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6562>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6562>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6562>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6562>>(v5, 0x2::tx_context::sender(arg1));
    }
