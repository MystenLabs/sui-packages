module 0xd23299d733407d5fe35808ddf196fde885377f5535f8c10e79df895770a88ba7::nectarverse__the_cosmic_sui_swarmers {
    struct NECTARVERSE__THE_COSMIC_SUI_SWARMERS has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"c05dcde6-f766-42e6-bd8c-d0750cd9a639"),
        };
    ...
    fun init(arg0: NECTARVERSE__THE_COSMIC_SUI_SWARMERS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NECTARVERSE__THE_COSMIC_SUI_SWARMERS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"NectarVerse: The Cosmic Sui Swarmers"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Unite with 5,000 cybernetic swarmers defending the hive and thriving across the cosmos."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://Qma5RTZxKbNsFKsGGedHxaWYwE8PohysGMEq71gzjLbgcs"));
