module 0xd21ade26b1ac742195f0d404c91663c406ee33d480b2e5f9c910ff5410407abf::floki {
    ...
    fun init(arg0: FLOKI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FLOKI>(arg0, 4, b"FLOKI", b"Floki Inu Token", b"", 0x1::option::none<0x2::url::Url>(), arg1);
