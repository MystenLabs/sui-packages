module 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::mark_price {
    ...
    public fun get_mark_price_checked(arg0: &MarkPriceRegistry, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock) : u64 {
        assert!(0x2::table::contains<0x2::object::ID, MarkPriceState>(&arg0.states, arg1), 0);
        let v0 = 0x2::table::borrow<0x2::object::ID, MarkPriceState>(&arg0.states, arg1);
        assert_fresh(v0, arg2);
        v0.mark_price
    }
