module 0xd2b4ec5b3f54021e0d14687ccfa7fb796db7a28b6212e3cbb467f0563a565f9a::reward7752 {
    struct REWARD7752 has drop {
        dummy_field: bool,
    }

    struct TICKET_7752 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7752(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7752>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7752>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7752, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7752>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7752>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7752>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7752>>(v5, 0x2::tx_context::sender(arg1));
    }
