module 0xd282c882818f75bb9867b9ba95298f3949e01086f7ba3588032334780ef6e0d1::reward9411 {
    struct REWARD9411 has drop {
        dummy_field: bool,
    }

    struct TICKET_9411 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9411(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9411>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9411>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9411, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9411>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9411>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9411>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9411>>(v5, 0x2::tx_context::sender(arg1));
    }
