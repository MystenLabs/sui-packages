module 0xd2224596a11188eabe802dd1514926f7f3a6745ee08165988a7bbc2bea1782ff::cnsnft8948 {
    struct CNSNFT8948 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8948, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8948>(arg0, arg1);
