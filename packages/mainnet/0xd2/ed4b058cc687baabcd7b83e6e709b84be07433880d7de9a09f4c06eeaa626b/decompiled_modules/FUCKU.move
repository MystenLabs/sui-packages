module 0xd2ed4b058cc687baabcd7b83e6e709b84be07433880d7de9a09f4c06eeaa626b::FUCKU {
    ...
    fun init(arg0: FUCKU, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FUCKU>(arg0, 2, b"FKU", b"FUCKU", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raw.githubusercontent.com/GJJJJJJJ/test/main/Psyduck_AG_anime.svg")), arg1);
