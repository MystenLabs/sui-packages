module 0xd233fcfa1f32de0b4cfd860ca5c781908cf64ca2fa8a437a2294eba80fb81de9::cnsnft5811 {
    struct CNSNFT5811 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5811, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5811>(arg0, arg1);
