module 0xd2b2c525f12e63a3e05fdf110002a3a40c6eb0c26af6b97006781c9f6f18271e::faucetcoin {
    ...
    fun init(arg0: FAUCETCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCETCOIN>(arg0, 2, b"TzyFaucet Coin", b"TFC", b"", 0x1::option::none<0x2::url::Url>(), arg1);
