module 0xd2dbc9c326ffee36b4c89557adc2c924bef9a8735826c7364ae2877ad287ff45::cnsnft9747 {
    struct CNSNFT9747 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9747, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8768"));
        let v4 = 0x2::package::claim<CNSNFT9747>(arg0, arg1);
