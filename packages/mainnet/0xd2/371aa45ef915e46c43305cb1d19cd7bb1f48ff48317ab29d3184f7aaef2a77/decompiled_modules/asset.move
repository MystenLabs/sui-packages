module 0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::asset {
    ...
    fun ensure_valid_source(arg0: u8) {
        ...
        if (v0 == &v1) {
            ...
            if (v0 == &v2) {
                ...
                let v3 = 255;
                assert!(v0 == &v3, 0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::oracle_error::unknown_source());
            };
        };
    }

    public(friend) fun is_check_pass(arg0: &BoundedValueChecker, arg1: &0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::price_feed::PriceFeedComponent, arg2: &0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::price_feed::PriceFeedComponent) : u64 {
        let v0 = is_timestamp_pass(arg0, 0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::price_feed::update_time(arg1), 0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::price_feed::update_time(arg2));
        if (v0 != 0) {
            return v0
        };
        is_value_bounded(arg0, 0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::price_feed::value(arg1), 0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::price_feed::value(arg2))
    }
    ...
    fun is_timestamp_pass(arg0: &BoundedValueChecker, arg1: u64, arg2: u64) : u64 {
        ...
        if (v0 * 1000 <= arg0.max_update_time_gap_ms) {
            ...
            0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::oracle_error::update_time_gap_too_large()
        }
    }
    ...
    fun is_value_bounded(arg0: &BoundedValueChecker, arg1: u64, arg2: u64) : u64 {
        ...
        if (arg1 > arg2) {
            if ((arg1 as u128) >= v0 + v0 * (arg0.deviation_upper_bound_bps as u128) / (10000 as u128)) {
                return 0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::oracle_error::value_above_upper_bound()
            };
        } else if ((arg1 as u128) <= v0 - v0 * (arg0.deviation_lower_bound_bps as u128) / (10000 as u128)) {
            return 0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::oracle_error::value_below_lower_bound()
        };
        0
    }
    ...
    public(friend) fun new_asset_config(arg0: u8, arg1: u8, arg2: u8, arg3: u64, arg4: u64, arg5: u64) : AssetConfig {
        ...
        assert!(arg1 != arg2, 0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::oracle_error::asset_source_conflict());
    ...
    fun new_bounded_value_checker(arg0: u64, arg1: u64, arg2: u64) : BoundedValueChecker {
        assert!(arg0 < 10000, 0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::oracle_error::invalid_bound());
        assert!(arg1 < 10000, 0x3ae4e0c6999229ea9128cd3f88449707f0d1326fc8346af6db86f99bd77c6201::oracle_error::invalid_bound());
        BoundedValueChecker{
