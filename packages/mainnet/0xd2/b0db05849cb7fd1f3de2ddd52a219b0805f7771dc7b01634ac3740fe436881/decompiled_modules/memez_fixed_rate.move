module 0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_fixed_rate {
    ...
    public(friend) fun dump<T0, T1>(arg0: &mut FixedRate<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x1::option::Option<address>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v3 = 0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_fees::take_with_discount<T0>(arg0.meme_swap_fee, &mut arg1, arg0.meme_referrer_fee, arg3);
        ...
        let v7 = 0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_fees::take_with_discount<T1>(arg0.quote_swap_fee, &mut v6, arg0.quote_referrer_fee, arg3);
        let v8 = &mut v6;
        ...
        0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_events::dump<T0, T1>(arg0.memez_fun, arg0.inner_state, v4 + v3, v5 - v7, v3, v7, 0, 0x2::balance::value<T1>(&arg0.quote_balance), 0x2::balance::value<T0>(&arg0.meme_balance), 0, arg2, v1, v9);
        v6
    }
    ...
    public(friend) fun pump<T0, T1>(arg0: &mut FixedRate<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: 0x1::option::Option<address>, arg3: &mut 0x2::tx_context::TxContext) : (bool, 0x2::coin::Coin<T1>, 0x2::coin::Coin<T0>) {
        ...
        assert!(v0 > 0, 2);
        let v1 = amount_before_fee(arg0.quote_raise_amount - 0x2::balance::value<T1>(&arg0.quote_balance), 0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_fees::value(arg0.quote_swap_fee));
        let v2 = if (v0 > v1) {
        ...
        let v10 = 0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_fees::take_with_discount<T0>(arg0.meme_swap_fee, &mut v8, arg0.meme_referrer_fee, arg3);
        let v11 = &mut v8;
    ...
    public(friend) fun dump_amount<T0, T1>(arg0: &FixedRate<T0, T1>, arg1: u64, arg2: u64) : vector<u64> {
        ...
        let v0 = 0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_fees::calculate_with_discount(arg0.meme_swap_fee, arg0.meme_referrer_fee, arg1) + 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::calc_up(arg0.meme_referrer_fee, arg1);
        ...
        let v2 = 0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_fees::calculate_with_discount(arg0.quote_swap_fee, arg0.quote_referrer_fee, v1) + 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::calc_up(arg0.quote_referrer_fee, v1);
    ...
    public(friend) fun new<T0, T1>(arg0: u64, arg1: 0x2::balance::Balance<T0>, arg2: 0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_fees::Fee, arg3: 0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_fees::Fee, arg4: 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::BPS, arg5: 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::BPS) : FixedRate<T0, T1> {
    ...
    public(friend) fun pump_amount<T0, T1>(arg0: &FixedRate<T0, T1>, arg1: u64, arg2: u64) : vector<u64> {
        ...
        let v2 = amount_before_fee(arg0.quote_raise_amount - 0x2::balance::value<T1>(&arg0.quote_balance), 0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_fees::value(arg0.quote_swap_fee));
        let v3 = if (arg1 > v2) {
            arg1 - v2
        } else {
            0
        ...
        let v4 = arg1 - v3;
        let v5 = 0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_fees::calculate_with_discount(arg0.quote_swap_fee, arg0.quote_referrer_fee, v4) + 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::calc_up(arg0.quote_referrer_fee, v4);
        ...
        let v7 = 0x779829966a2e8642c310bed79e6ba603e5acd3c31b25d7d4511e2c9303d6e3ef::memez_fees::calculate_with_discount(arg0.meme_swap_fee, arg0.meme_referrer_fee, v6) + 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::calc_up(arg0.meme_referrer_fee, v6);
