module 0xd25f3e984002eac2fe0fe09be5142813cd2c68cc64fcb59faa1bf32d1824e109::reward4006 {
    struct REWARD4006 has drop {
        dummy_field: bool,
    }

    struct TICKET_4006 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4006(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4006>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4006>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4006, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4006>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4006>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4006>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4006>>(v5, 0x2::tx_context::sender(arg1));
    }
