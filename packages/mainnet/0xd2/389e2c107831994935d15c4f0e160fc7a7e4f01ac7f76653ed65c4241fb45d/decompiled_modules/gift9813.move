module 0xd2389e2c107831994935d15c4f0e160fc7a7e4f01ac7f76653ed65c4241fb45d::gift9813 {
    struct GIFT9813 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift9813(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT9813, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9813>(arg0, arg1);
