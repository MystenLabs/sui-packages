module 0xd276aa79d3b67759e7e423dadc72eaf9e399bf30a9915151f2485713f6a29d26::xx {
    struct XX has drop {
        dummy_field: bool,
    }

    fun init(arg0: XX, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/KJe1AZMglBirsP6ej0c3ZK6vJSZTkJ5qVsDZ4N3HEgo";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/KJe1AZMglBirsP6ej0c3ZK6vJSZTkJ5qVsDZ4N3HEgo"))
        };
