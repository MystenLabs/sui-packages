module 0xd2adcf4324d0c8d4b40ab07aa87c8f6b414737305f58a7c1a9b08b34a9c0cbf0::reward6856 {
    struct REWARD6856 has drop {
        dummy_field: bool,
    }

    struct TICKET_6856 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6856(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6856>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6856>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6856, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6856>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6856>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6856>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6856>>(v5, 0x2::tx_context::sender(arg1));
    }
