module 0xd2b1ff646ec203d0ed0961ba211c49337ad775e6502a54a74cde5ac1ece17730::cnsnft2134 {
    struct CNSNFT2134 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2134, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8986"));
        let v4 = 0x2::package::claim<CNSNFT2134>(arg0, arg1);
