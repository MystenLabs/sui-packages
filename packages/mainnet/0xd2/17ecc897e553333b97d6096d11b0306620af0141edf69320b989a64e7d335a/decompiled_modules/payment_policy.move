module 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::payment_policy {
    ...
    public fun createPolicy<T0: store + key, T1>(arg0: &0x2::package::Publisher, arg1: u64, arg2: u64, arg3: &0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::cap_vault::createVault<PolicyVaultCap>(arg4);
    }

    fun init(arg0: PAYMENT_POLICY, arg1: &mut 0x2::tx_context::TxContext) {
    }

    public fun payByClt<T0: store + key, T1>(arg0: &mut 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::xbird::PegVault<T1>, arg1: &mut PolicyVault<T0>, arg2: 0x2::transfer_policy::TransferRequest<T0>, arg3: &0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::public_kiosk::KOrder, arg4: &mut 0x2::balance::Balance<T1>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        let (_, v1, v2, v3) = 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::public_kiosk::orderInfo(arg3);
        ...
        let v5 = 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::constants::max_fee();
        let v6 = 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::math::div(0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::math::mul(v4, arg5), v5);
        let v7 = 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::math::div(0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::math::mul(v4, 1000), v5);
        0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::xbird::withdrawTo<T1>(0x2::balance::split<T1>(arg4, v4 - v6 - v7), v2, arg0, arg6);
    ...
    public fun payByCoin<T0: store + key, T1>(arg0: &mut PolicyVault<T0>, arg1: 0x2::transfer_policy::TransferRequest<T0>, arg2: &0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::public_kiosk::KOrder, arg3: &mut 0x2::balance::Balance<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        let (_, v1, v2, v3) = 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::public_kiosk::orderInfo(arg2);
        ...
        let v5 = 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::constants::max_fee();
        let v6 = 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::math::div(0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::math::mul(v4, arg4), v5);
        let v7 = 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::math::div(0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::math::mul(v4, 1000), v5);
    ...
    public fun withdrawRoyalFeeToken<T0: store + key, T1>(arg0: &PolicyVaultCap, arg1: &mut PolicyVault<T0>, arg2: &mut 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::xbird::PegVault<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::xbird::withdrawTo<T1>(withdrawRoyalFee<T0, T1>(arg0, arg1), 0x2::tx_context::sender(arg3), arg2, arg3);
    }
