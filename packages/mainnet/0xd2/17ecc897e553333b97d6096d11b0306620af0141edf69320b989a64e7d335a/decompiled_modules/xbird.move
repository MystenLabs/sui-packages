module 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::xbird {
    ...
    public fun depositToken(arg0: vector<u8>, arg1: vector<u8>, arg2: &ValidatorVault, arg3: &mut PegVault<XBIRD>, arg4: &mut 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::archieve::UserArchieve, arg5: &0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::version::Version, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<XBIRD>, DepositProof) {
        0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::version::checkVersion(arg5, 1);
        0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::archieve::verifySignature(arg0, arg1, &arg2.validator);
        ...
        assert!(v2 > 0, 1002);
        0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::archieve::verUpdateTokenPegNonce(v3, arg4);
        let v4 = DepositProof{
            owner   : v0,
            balance : v2,
        };
        let v5 = XBirdDeposited{
            ...
            nonce         : v3,
            balance       : v2,
            total_deposit : 0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::archieve::increaseTotalDeposit(v2, arg4),
        };
    ...
    fun init(arg0: XBIRD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::cap_vault::createVault<XBirdAdminCap>(arg1);
    }

    public fun setValidator(arg0: &XBirdAdminCap, arg1: vector<u8>, arg2: &mut ValidatorVault, arg3: &0xd217ecc897e553333b97d6096d11b0306620af0141edf69320b989a64e7d335a::version::Version) {
