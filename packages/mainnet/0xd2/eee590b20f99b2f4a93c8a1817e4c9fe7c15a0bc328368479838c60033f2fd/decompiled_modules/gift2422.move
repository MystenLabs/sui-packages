module 0xd2eee590b20f99b2f4a93c8a1817e4c9fe7c15a0bc328368479838c60033f2fd::gift2422 {
    struct GIFT2422 has drop {
        dummy_field: bool,
    }

    struct TICKET_2422 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2422(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2422>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2422>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2422, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2422>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2422>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2422>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2422>>(v5, 0x2::tx_context::sender(arg1));
    }
