module 0xd235aca9efc5bf64c8d2c8ece6af97a82dd9e22a79c5a8de733af1bd578914ab::golden_key {
    ...
    public fun blacklist_minter(arg0: &AdminCap, arg1: &Version, arg2: &mut BlacklistedMinters, arg3: address) {
        checkVersion(arg1, 1);
        assert!(!0x1::vector::contains<address>(&arg2.minters, &arg3), 9223372715459870725);
    ...
    public fun checkVersion(arg0: &Version, arg1: u64) {
        assert!(arg1 == arg0.version, 9223372547956015107);
    }
    ...
    fun init(arg0: GOLDEN_KEY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<GoldenKey>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://picsum.photos/200/300?grayscale"));
    ...
    public entry fun migrate(arg0: &AdminCap, arg1: &mut Version, arg2: u64) {
        assert!(arg2 > arg1.version, 9223372565135884291);
        arg1.version = arg2;
    }

    public fun mint_golden_key(arg0: &MinterCap, arg1: &Version, arg2: &mut GkSupply, arg3: &BlacklistedMinters, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &0x2::transfer_policy::TransferPolicy<GoldenKey>, arg7: &mut 0x2::tx_context::TxContext) {
        checkVersion(arg1, 1);
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(!0x1::vector::contains<address>(&arg3.minters, &v0), 9223372779884380165);
        let v1 = get_total_supply(arg2);
        assert!(v1 < 2000, 9223372792769019905);
        let v2 = GoldenKey{
            id          : 0x2::object::new(arg7),
            number      : v1 + 1,
            name        : 0x1::string::utf8(b"Nameee"),
            description : 0x1::string::utf8(b"Descccccc"),
            image_url   : 0x1::string::utf8(b"https://picsum.photos/200/300?grayscale"),
        ...
        0x2::kiosk::lock<GoldenKey>(arg4, arg5, arg6, v2);
    }
