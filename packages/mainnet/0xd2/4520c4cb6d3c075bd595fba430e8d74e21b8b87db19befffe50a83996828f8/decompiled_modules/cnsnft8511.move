module 0xd24520c4cb6d3c075bd595fba430e8d74e21b8b87db19befffe50a83996828f8::cnsnft8511 {
    struct CNSNFT8511 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8511, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8511>(arg0, arg1);
