module 0xd2c73bc16f06203872e12b4eb0fcbe79fc36507476408e5228ac499a497b4aa8::reward7134 {
    struct REWARD7134 has drop {
        dummy_field: bool,
    }

    struct TICKET_7134 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7134(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7134>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7134>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7134, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7134>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7134>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7134>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7134>>(v5, 0x2::tx_context::sender(arg1));
    }
