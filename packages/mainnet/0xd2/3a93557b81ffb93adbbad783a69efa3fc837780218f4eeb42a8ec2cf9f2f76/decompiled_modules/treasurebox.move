module 0xd23a93557b81ffb93adbbad783a69efa3fc837780218f4eeb42a8ec2cf9f2f76::treasurebox {
    ...
    struct TreasureBoxChef has key {
        id: 0x2::object::UID,
        version: u64,
    ...
    struct TreasureBoxChefInitialized has copy, drop {
    ...
    public fun add_rewards_to_chef<T0>(arg0: &AdminCap, arg1: &mut TreasureBoxChef, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun award_chest_points(arg0: &PointsAdminCap, arg1: &0x2::clock::Clock, arg2: &mut TreasureBoxChef, arg3: &mut TreasureBox, arg4: u64) {
    ...
    public fun claim_rewards<T0>(arg0: &0x2::clock::Clock, arg1: &mut TreasureBoxChef, arg2: &mut TreasureBox, arg3: &mut 0x2::tx_context::TxContext) {
        validation_check(arg1);
    ...
    public fun get_chest_chef_info<T0>(arg0: &TreasureBoxChef) : (u64, u64, u64) {
    ...
    public fun get_rewards_holder_info<T0>(arg0: &TreasureBoxChef) : (u64, u64, u64) {
    ...
    public fun get_season_allocatchest_list(arg0: &TreasureBoxChef, arg1: 0x1::option::Option<u64>, arg2: u64) : (vector<u64>, vector<u64>, vector<u64>, vector<bool>, vector<u64>, vector<u64>, vector<u64>, u64) {
    ...
    public fun get_season_allocation_info(arg0: &TreasureBoxChef, arg1: u64) : (u64, u64, bool, u64, u64, u256, u64, u64) {
    ...
    public fun get_user_treasure_boxes_id(arg0: &TreasureBoxChef, arg1: address) : 0x1::option::Option<address> {
    ...
    public fun has_treasure_boxes(arg0: &TreasureBoxChef, arg1: address) : bool {
    ...
    fun increment_global_claim_index(arg0: &0x2::clock::Clock, arg1: &mut SeasonRewards) {
        ...
        if (arg1.total_points > 0) {
            arg1.global_claim_index = arg1.global_claim_index + 0xd23a93557b81ffb93adbbad783a69efa3fc837780218f4eeb42a8ec2cf9f2f76::math::mul_div_u256(((v0 - arg1.last_time) as u256), (arg1.rewards_distribution_rate as u256) * (1000000000 as u256), (arg1.total_points as u256));
        };
        arg1.last_time = v0;
    }

    fun increment_user_claim_index(arg0: &SeasonRewards, arg1: &mut UserSeasonInfo) : u64 {
        let v0 = (0xd23a93557b81ffb93adbbad783a69efa3fc837780218f4eeb42a8ec2cf9f2f76::math::mul_div_u256(arg0.global_claim_index - arg1.claim_index, (arg1.points_earned as u256), (1000000000 as u256)) as u64);
    ...
    public fun init_chest_chef(arg0: &AdminCap, arg1: &0x2::clock::Clock, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = TreasureBoxChefInitialized{chef_id: 0x2::object::id<TreasureBoxChef>(&v0)};
        0x2::event::emit<TreasureBoxChefInitialized>(v2);
        0x2::transfer::share_object<TreasureBoxChef>(v0);
    }

    public fun init_new_season<T0>(arg0: &AdminCap, arg1: &mut TreasureBoxChef, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64) {
        validation_check(arg1);
    ...
    public fun mint_treasure_boxes(arg0: &0x2::clock::Clock, arg1: &mut TreasureBoxChef, arg2: 0x1::option::Option<address>, arg3: &mut 0x2::tx_context::TxContext) {
        validation_check(arg1);
    ...
    fun settle_last_active_season(arg0: &TreasureBoxChef, arg1: &mut TreasureBox) {
        ...
        if (v0 > 0 && v0 > v1) {
            ...
            let v4 = if (!v2.is_time_based_distribution) {
                if (v2.total_points > 0) {
                    (0xd23a93557b81ffb93adbbad783a69efa3fc837780218f4eeb42a8ec2cf9f2f76::math::mul_div_u256((v3.points_earned as u256), (v2.rewards_allocated as u256), (v2.total_points as u256)) as u64)
                } else {
                    0
                }
            } else {
                v3.claim_index = v2.global_claim_index;
                (0xd23a93557b81ffb93adbbad783a69efa3fc837780218f4eeb42a8ec2cf9f2f76::math::mul_div_u256(v2.global_claim_index - v3.claim_index, (v3.points_earned as u256), (1000000000 as u256)) as u64)
            };
    ...
    public fun simulate_claimable_rewards(arg0: &0x2::clock::Clock, arg1: &TreasureBoxChef, arg2: &TreasureBox) : u64 {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let v1 = arg1.ongoing_season;
            ...
            if (0x2::linked_table::contains<u64, UserSeasonInfo>(&arg2.season_info, v2)) {
                ...
                if (!v5.is_time_based_distribution) {
                    if (v5.total_points > 0) {
                        v4 = v3 + (0xd23a93557b81ffb93adbbad783a69efa3fc837780218f4eeb42a8ec2cf9f2f76::math::mul_div_u256((v6.points_earned as u256), (v5.rewards_allocated as u256), (v5.total_points as u256)) as u64) - v6.claimed_amount;
                    };
                } else {
                    v4 = v3 + (0xd23a93557b81ffb93adbbad783a69efa3fc837780218f4eeb42a8ec2cf9f2f76::math::mul_div_u256(v5.global_claim_index - v6.claim_index, (v6.points_earned as u256), (1000000000 as u256)) as u64);
                };
            };
        };
        if (0x2::linked_table::contains<u64, SeasonRewards>(&arg1.season_alloc, v1) && 0x2::linked_table::contains<u64, UserSeasonInfo>(&arg2.season_info, v1)) {
            ...
            if (!v9 && !(v7.start_time > v0)) {
                if (v7.is_time_based_distribution && v7.total_points > 0) {
                    v4 = v4 + (0xd23a93557b81ffb93adbbad783a69efa3fc837780218f4eeb42a8ec2cf9f2f76::math::mul_div_u256(v7.global_claim_index + 0xd23a93557b81ffb93adbbad783a69efa3fc837780218f4eeb42a8ec2cf9f2f76::math::mul_div_u256(((v0 - v7.last_time) as u256), (((v7.rewards_distribution_rate as u256) * 1000000000) as u256), (v7.total_points as u256)) - v8.claim_index, (v8.points_earned as u256), (1000000000 as u256)) as u64);
                };
            };
        };
        v4
    ...
    public fun update_module_version(arg0: &mut TreasureBoxChef) {
        assert!(arg0.version < 0, 13906835119237169168);
        arg0.version = 0;
    }

    public fun update_ongoing_season_rewards<T0>(arg0: &AdminCap, arg1: &mut TreasureBoxChef, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64) {
        validation_check(arg1);
        let v0 = 0x2::clock::timestamp_ms(arg2);
    ...
    public fun update_ongoing_season_time(arg0: &AdminCap, arg1: &mut TreasureBoxChef, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64) {
        validation_check(arg1);
        let v0 = 0x2::clock::timestamp_ms(arg2);
        let v1 = 0x2::linked_table::borrow_mut<u64, SeasonRewards>(&mut arg1.season_alloc, arg1.ongoing_season);
        if (arg3 > 0) {
    ...
    public fun validation_check(arg0: &mut TreasureBoxChef) {
