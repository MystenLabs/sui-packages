module 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::buildings {
    ...
    public(friend) fun has_enough_dirty_cop(arg0: &0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::Resources, arg1: u64) {
        assert!((arg1 as u128) * 0x1::u128::pow(2, 64) < 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::borrow_resource_amount(arg0) / 2, 5);
    }
    ...
    public(friend) fun upgrade_building(arg0: &mut 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::BuildingInfo, arg1: &0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::BuildingRegistry, arg2: 0x1::string::String, arg3: &0x2::clock::Clock) {
        let v0 = 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::borrow_building_info(arg0);
        ...
        assert!(v1 < 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::borrow_building_max_level(arg1), 3);
        let v2 = 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::borrow_building_upgrade_value(arg1, arg2);
        let v3 = 0x2::vec_map::get<u64, 0x2::vec_map::VecMap<0x1::string::String, u128>>(&v2, &v1);
        let v4 = 0x1::string::utf8(b"building_capacity");
        0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::set_building_storage_capacity(arg0, *0x2::vec_map::get<0x1::string::String, u128>(v3, &v4));
        let v5 = 0x1::string::utf8(b"production_rate");
        0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::set_building_production_rate(arg0, *0x2::vec_map::get<0x1::string::String, u128>(v3, &v5));
        let v6 = v1 + 1;
        let v7 = 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::borrow_building_upgrade_value(arg1, arg2);
        let v8 = 0x2::vec_map::get<u64, 0x2::vec_map::VecMap<0x1::string::String, u128>>(&v7, &v6);
        let v9 = 0x1::string::utf8(b"upgrade_cash_cost");
        0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::set_building_upgrade_cash_cost(arg0, *0x2::vec_map::get<0x1::string::String, u128>(v8, &v9));
        let v10 = 0x1::string::utf8(b"upgrade_weapon_cost");
        0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::set_building_upgrade_weapon_cost(arg0, *0x2::vec_map::get<0x1::string::String, u128>(v8, &v10));
        let v11 = 0x1::string::utf8(b"upgrade_turf_cost");
        0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::set_building_upgrade_turf_cost(arg0, *0x2::vec_map::get<0x1::string::String, u128>(v8, &v11));
        let v12 = 0x1::string::utf8(b"upgrade_wait_ms");
        0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::set_building_upgrade_wait_ts(arg0, (0x2::clock::timestamp_ms(arg3) as u128) + *0x2::vec_map::get<0x1::string::String, u128>(v8, &v12));
    }
    ...
    public(friend) fun validate_resource_amount(arg0: &0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::Resources, arg1: u128) {
        assert!(0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::ibuildings::borrow_resource_amount(arg0) >= arg1, 5);
    }
