module 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::igangsters {
    ...
    public(friend) fun update_gangster_stats_df(arg0: &mut GangsterBaseStats, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u128, arg5: u128, arg6: 0x1::string::String, arg7: u64) {
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::string::String, GangsterStats>(&mut arg0.id, arg1);
        v0.name = arg1;
        v0.image = arg3;
        v0.health = arg4;
        v0.attack = arg5;
        v0.description = arg2;
        let v1 = 0;
        while (v1 < 0x1::vector::length<GangsterRecruitCost>(&v0.recruit_cost)) {
            let v2 = 0x1::vector::borrow_mut<GangsterRecruitCost>(&mut v0.recruit_cost, v1);
            if (v2.cost_type == arg6) {
                v2.amount = (arg7 as u128) * 0x1::u128::pow(2, 64);
            };
            v1 = v1 + 1;
        };
    }
