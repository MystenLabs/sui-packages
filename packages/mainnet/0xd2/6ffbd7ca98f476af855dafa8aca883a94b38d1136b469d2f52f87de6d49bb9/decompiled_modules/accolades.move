module 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::accolades {
    ...
    public(friend) fun create_reward_pack(arg0: &mut 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::AccoladeRewardRegistry, arg1: u64, arg2: vector<0x1::string::String>, arg3: vector<vector<0x1::string::String>>, arg4: vector<vector<u64>>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::dynamic_object_fields_exists(arg0, arg1) == false, 0);
        let v0 = 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::new_accolade_reward(arg5);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::string::String>(&arg2)) {
            ...
            0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::add_df_to_reward_registry(&mut v0, *0x1::vector::borrow<0x1::string::String>(&arg2, v1), v2);
            v1 = v1 + 1;
        };
        0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::add_dof_to_reward_registry(arg0, arg1, v0);
    }
    ...
    public(friend) fun map_threshold_to_reward(arg0: &0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::AccoladeRewardRegistry, arg1: &mut 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::AccoladeThresholdMapRegistry, arg2: 0x1::string::String, arg3: u128, arg4: u64) {
        assert!(0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::dynamic_object_fields_exists(arg0, arg4) == true, 1);
        ...
        let v1 = v0;
        let (_, v3) = 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iaccolades::get_accolade_threshold_rewards(arg1);
