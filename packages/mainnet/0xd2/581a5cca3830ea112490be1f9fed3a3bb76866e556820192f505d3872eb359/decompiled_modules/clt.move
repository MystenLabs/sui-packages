module 0xd2581a5cca3830ea112490be1f9fed3a3bb76866e556820192f505d3872eb359::clt {
    struct CLT has drop {
        dummy_field: bool,
    }
    ...
    public fun createClt<T0>(arg0: 0x2::coin::TreasuryCap<T0>, arg1: 0x2::coin::CoinMetadata<T0>, arg2: &0xd2581a5cca3830ea112490be1f9fed3a3bb76866e556820192f505d3872eb359::version::Version, arg3: &mut 0x2::tx_context::TxContext) : CltAdminCap {
    ...
    public fun depositToken<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut CltVault<T0>, arg3: &mut 0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::UserArchieve, arg4: &0xd2581a5cca3830ea112490be1f9fed3a3bb76866e556820192f505d3872eb359::version::Version, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, DepositProof) {
        0xd2581a5cca3830ea112490be1f9fed3a3bb76866e556820192f505d3872eb359::version::checkVersion(arg4, 1);
    ...
    public fun depositTokenForOrder<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: u64, arg3: &mut CltVault<T0>, arg4: &mut 0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::UserArchieve, arg5: &0xd2581a5cca3830ea112490be1f9fed3a3bb76866e556820192f505d3872eb359::version::Version, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, DepositProof, u128) {
        0xd2581a5cca3830ea112490be1f9fed3a3bb76866e556820192f505d3872eb359::version::checkVersion(arg5, 1);
        ...
        let v2 = 0x2::bcs::peel_u64(&mut v1);
        let v3 = 0x2::bcs::peel_u128(&mut v1);
        assert!(arg2 == 0x2::bcs::peel_u64(&mut v1), 1005);
        assert!(0x2::bcs::peel_address(&mut v1) == v0, 1001);
        assert!(v2 > 0, 1002);
        assert!(0x2::bcs::peel_u64(&mut v1) > 0x2::clock::timestamp_ms(arg6), 1004);
        0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::verUpdateTokenPegNonce(v3, arg4);
        let v4 = DepositProof{
            owner   : v0,
            balance : v2,
        };
        let v5 = CltDeposited{
            ...
            nonce         : v3,
            balance       : v2,
            total_deposit : 0x38dba0f0cf9a80c9b9debf580c82f89bb0de4577e6fb448b3ba2ee9e05d539bc::archieve::increaseTotalDeposit(v2, arg4),
        };
        0x2::event::emit<CltDeposited>(v5);
    ...
    public fun setValidator<T0>(arg0: &CltAdminCap, arg1: vector<u8>, arg2: &mut CltVault<T0>, arg3: &0xd2581a5cca3830ea112490be1f9fed3a3bb76866e556820192f505d3872eb359::version::Version) {
