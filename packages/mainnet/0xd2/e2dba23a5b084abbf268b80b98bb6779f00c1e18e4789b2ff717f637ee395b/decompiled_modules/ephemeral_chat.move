module 0xd2e2dba23a5b084abbf268b80b98bb6779f00c1e18e4789b2ff717f637ee395b::ephemeral_chat {
    ...
    public fun bounty_fee_bps(arg0: &Config) : u64 {
        arg0.bounty_fee_bps
    }
    ...
    public fun update_bounty_fee_bps(arg0: &AdminCap, arg1: &mut Config, arg2: u64) {
        assert!(arg2 <= 10000, 13);
        arg1.bounty_fee_bps = arg2;
    }
