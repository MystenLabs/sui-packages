module 0xd23179a075e8ec56df5ec98900f2952d0c7df2cc8ed7d64a875e75681d752f23::cnsnft6119 {
    struct CNSNFT6119 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6119, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6119>(arg0, arg1);
