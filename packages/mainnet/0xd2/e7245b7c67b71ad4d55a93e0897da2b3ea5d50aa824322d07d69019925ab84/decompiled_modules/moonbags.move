module 0x8f70ad5db84e1a99b542f86ccfb1a932ca7ba010a2fa12a1504d839ff4c111c6::moonbags {
    ...
    fun release_turbos_inner<T0>(arg0: &mut Configuration, arg1: 0x1::ascii::String, arg2: address) {
        0x2::transfer::public_transfer<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::TurbosPositionBurnNFT>(0x2::dynamic_object_field::remove<vector<u8>, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::TurbosPositionBurnNFT>(&mut 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, Pool<T0>>(&mut arg0.id, arg1).id, b"turbos_burn_proof"), arg2);
    }

    public fun release_turbos_proof<T0>(arg0: &0x2::package::UpgradeCap, arg1: &mut Configuration, arg2: 0x1::ascii::String, arg3: address) {
        assert!(0x2::object::id_address<0x2::package::UpgradeCap>(arg0) == @0x8db6a874b0828427c59cf0d7cccf50c1523a8b264ab784cbc0bfedb632668b8b, 9001);
        release_turbos_inner<T0>(arg1, arg2, arg3);
    }
