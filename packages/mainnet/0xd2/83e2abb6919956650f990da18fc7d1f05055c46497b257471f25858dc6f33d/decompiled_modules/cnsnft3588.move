module 0xd283e2abb6919956650f990da18fc7d1f05055c46497b257471f25858dc6f33d::cnsnft3588 {
    struct CNSNFT3588 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3588, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3588>(arg0, arg1);
