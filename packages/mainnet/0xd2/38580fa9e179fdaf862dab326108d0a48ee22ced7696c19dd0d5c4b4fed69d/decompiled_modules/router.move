module 0xd238580fa9e179fdaf862dab326108d0a48ee22ced7696c19dd0d5c4b4fed69d::router {
    ...
    public fun steamm_cpmm_swap_a2b_with_return<T0, T1, T2, T3, T4, T5: drop>(arg0: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::pool::Pool<T3, T4, 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::cpmm::CpQuoter, T5>, arg1: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::Bank<T0, T1, T3>, arg2: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::Bank<T0, T2, T4>, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: &mut 0x2::coin::Coin<T1>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, u64) {
        let v0 = 0x2::coin::zero<T2>(arg8);
        let v1 = &mut v0;
        let (v2, v3, v4) = to_btokens<T0, T1, T2, T3, T4>(arg1, arg2, arg3, arg4, v1, true, arg5, arg7, arg8);
        let v5 = v3;
        let v6 = v2;
        0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::cpmm::swap<T3, T4, T5>(arg0, &mut v6, &mut v5, true, v4, arg6, arg8);
        0x2::coin::join<T2>(&mut v0, 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::burn_btoken<T0, T2, T4>(arg2, arg3, &mut v5, 0x2::coin::value<T4>(&v5), arg7, arg8));
        destroy_or_transfer<T3>(v6, arg8);
        destroy_or_transfer<T4>(v5, arg8);
        let v7 = 0x2::coin::value<T2>(&v0);
        let v8 = HopRecord{out_amount: v7};
        0x2::event::emit<HopRecord>(v8);
        (v0, v7)
    }

    public fun steamm_cpmm_swap_b2a_with_return<T0, T1, T2, T3, T4, T5: drop>(arg0: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::pool::Pool<T3, T4, 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::cpmm::CpQuoter, T5>, arg1: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::Bank<T0, T1, T3>, arg2: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::Bank<T0, T2, T4>, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: &mut 0x2::coin::Coin<T2>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, u64) {
        let v0 = 0x2::coin::zero<T1>(arg8);
        let v1 = &mut v0;
        let (v2, v3, v4) = to_btokens<T0, T1, T2, T3, T4>(arg1, arg2, arg3, v1, arg4, false, arg5, arg7, arg8);
        let v5 = v3;
        let v6 = v2;
        0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::cpmm::swap<T3, T4, T5>(arg0, &mut v6, &mut v5, false, v4, arg6, arg8);
        0x2::coin::join<T1>(&mut v0, 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::burn_btoken<T0, T1, T3>(arg1, arg3, &mut v6, 0x2::coin::value<T3>(&v6), arg7, arg8));
        destroy_or_transfer<T3>(v6, arg8);
        destroy_or_transfer<T4>(v5, arg8);
        let v7 = 0x2::coin::value<T1>(&v0);
        let v8 = HopRecord{out_amount: v7};
        0x2::event::emit<HopRecord>(v8);
        (v0, v7)
    }

    public fun steamm_ommv2_swap_a2b_with_return<T0, T1, T2, T3, T4, T5: drop>(arg0: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::pool::Pool<T3, T4, 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::omm_v2::OracleQuoterV2, T5>, arg1: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::Bank<T0, T1, T3>, arg2: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::Bank<T0, T2, T4>, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: 0xe84b649199654d18c38e727212f5d8dacfc3cf78d60d0a7fc85fd589f280eb2b::oracles::OraclePriceUpdate, arg5: 0xe84b649199654d18c38e727212f5d8dacfc3cf78d60d0a7fc85fd589f280eb2b::oracles::OraclePriceUpdate, arg6: &mut 0x2::coin::Coin<T1>, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, u64) {
        let v0 = 0x2::coin::zero<T2>(arg10);
        let v1 = &mut v0;
        let (v2, v3, v4) = to_btokens<T0, T1, T2, T3, T4>(arg1, arg2, arg3, arg6, v1, true, arg7, arg9, arg10);
        let v5 = v3;
        let v6 = v2;
        0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::omm_v2::swap<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg2, arg3, arg4, arg5, &mut v6, &mut v5, true, v4, arg8, arg9, arg10);
        0x2::coin::join<T2>(&mut v0, 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::burn_btoken<T0, T2, T4>(arg2, arg3, &mut v5, 0x2::coin::value<T4>(&v5), arg9, arg10));
        destroy_or_transfer<T3>(v6, arg10);
        destroy_or_transfer<T4>(v5, arg10);
        let v7 = 0x2::coin::value<T2>(&v0);
        let v8 = HopRecord{out_amount: v7};
        0x2::event::emit<HopRecord>(v8);
        (v0, v7)
    ...
    public fun steamm_ommv2_swap_b2a_with_return<T0, T1, T2, T3, T4, T5: drop>(arg0: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::pool::Pool<T3, T4, 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::omm_v2::OracleQuoterV2, T5>, arg1: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::Bank<T0, T1, T3>, arg2: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::Bank<T0, T2, T4>, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: 0xe84b649199654d18c38e727212f5d8dacfc3cf78d60d0a7fc85fd589f280eb2b::oracles::OraclePriceUpdate, arg5: 0xe84b649199654d18c38e727212f5d8dacfc3cf78d60d0a7fc85fd589f280eb2b::oracles::OraclePriceUpdate, arg6: &mut 0x2::coin::Coin<T2>, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, u64) {
        let v0 = 0x2::coin::zero<T1>(arg10);
        let v1 = &mut v0;
        let (v2, v3, v4) = to_btokens<T0, T1, T2, T3, T4>(arg1, arg2, arg3, v1, arg6, false, arg7, arg9, arg10);
        let v5 = v3;
        let v6 = v2;
        0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::omm_v2::swap<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg2, arg3, arg4, arg5, &mut v6, &mut v5, false, v4, arg8, arg9, arg10);
        0x2::coin::join<T1>(&mut v0, 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::burn_btoken<T0, T1, T3>(arg1, arg3, &mut v6, 0x2::coin::value<T3>(&v6), arg9, arg10));
        destroy_or_transfer<T3>(v6, arg10);
        destroy_or_transfer<T4>(v5, arg10);
        let v7 = 0x2::coin::value<T1>(&v0);
        let v8 = HopRecord{out_amount: v7};
