module 0x155590bf3bc39f055650c0c37094e8045bf9166bb07a12f1240ba55a8a7aa873::suinami {
    ...
    fun init(arg0: SUINAMI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUINAMI>(arg0, 2, b"SUINAMI", b"", b"", 0x1::option::none<0x2::url::Url>(), arg1);
