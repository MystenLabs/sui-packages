module 0x15d1e60358a66b08612339bfd470ad1d6e361b890f7cb22578445d5d5aa2d5c9::cnsnft2164 {
    struct CNSNFT2164 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2164, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2164>(arg0, arg1);
