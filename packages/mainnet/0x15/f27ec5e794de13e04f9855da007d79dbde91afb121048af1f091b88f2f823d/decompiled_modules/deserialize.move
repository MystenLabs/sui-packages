module 0x15f27ec5e794de13e04f9855da007d79dbde91afb121048af1f091b88f2f823d::deserialize {
    public fun deserialize_i32(arg0: &mut 0x99de5c967d8206ef4b75c0afab3df2a59eb02b05c282821db803831008ac25b4::cursor::Cursor<u8>) : 0x15f27ec5e794de13e04f9855da007d79dbde91afb121048af1f091b88f2f823d::i64::I64 {
        let v0 = deserialize_u32(arg0);
        if (v0 >> 31 == 1) {
            0x15f27ec5e794de13e04f9855da007d79dbde91afb121048af1f091b88f2f823d::i64::from_u64(((18446744069414584320 + (v0 as u64)) as u64))
        } else {
            0x15f27ec5e794de13e04f9855da007d79dbde91afb121048af1f091b88f2f823d::i64::from_u64((v0 as u64))
        }
    }

    public fun deserialize_i64(arg0: &mut 0x99de5c967d8206ef4b75c0afab3df2a59eb02b05c282821db803831008ac25b4::cursor::Cursor<u8>) : 0x15f27ec5e794de13e04f9855da007d79dbde91afb121048af1f091b88f2f823d::i64::I64 {
        0x15f27ec5e794de13e04f9855da007d79dbde91afb121048af1f091b88f2f823d::i64::from_u64(deserialize_u64(arg0))
    }
