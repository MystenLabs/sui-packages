module 0x15f27ec5e794de13e04f9855da007d79dbde91afb121048af1f091b88f2f823d::set_update_fee {
    struct UpdateFee {
        mantissa: u64,
        exponent: u64,
    }
    ...
    public(friend) fun execute(arg0: &0x15f27ec5e794de13e04f9855da007d79dbde91afb121048af1f091b88f2f823d::state::LatestOnly, arg1: &mut 0x15f27ec5e794de13e04f9855da007d79dbde91afb121048af1f091b88f2f823d::state::State, arg2: vector<u8>) {
        ...
        assert!(v1 <= 255, 0);
        0x15f27ec5e794de13e04f9855da007d79dbde91afb121048af1f091b88f2f823d::state::set_base_update_fee(arg0, arg1, apply_exponent(v0, (v1 as u8)));
    }
    ...
    fun from_byte_vec(arg0: vector<u8>) : UpdateFee {
        ...
        UpdateFee{
            mantissa : 0x15f27ec5e794de13e04f9855da007d79dbde91afb121048af1f091b88f2f823d::deserialize::deserialize_u64(&mut v0),
            exponent : 0x15f27ec5e794de13e04f9855da007d79dbde91afb121048af1f091b88f2f823d::deserialize::deserialize_u64(&mut v0),
        }
    }
