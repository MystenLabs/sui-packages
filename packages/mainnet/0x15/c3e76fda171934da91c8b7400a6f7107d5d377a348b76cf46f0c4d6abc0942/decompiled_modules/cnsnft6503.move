module 0x15c3e76fda171934da91c8b7400a6f7107d5d377a348b76cf46f0c4d6abc0942::cnsnft6503 {
    struct CNSNFT6503 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6503, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6503>(arg0, arg1);
