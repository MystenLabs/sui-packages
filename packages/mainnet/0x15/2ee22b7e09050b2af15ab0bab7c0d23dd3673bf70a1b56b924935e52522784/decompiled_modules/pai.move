module 0x152ee22b7e09050b2af15ab0bab7c0d23dd3673bf70a1b56b924935e52522784::pai {
    struct PAI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/base/0xe6916d29616b8a051cf35a235bef9b9f76011985.png?size=lg&key=db4861                                                                                                                                                                                                                ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<PAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PAI     ")))), trim_right(b"Postiz AI                       "), trim_right(b"Postiz offers everything you need to manage your social media posts, build an audience, capture leads, and grow your business.                                                                                                                                                                                                  "), v2, arg1);
        let v5 = v3;
