module 0x15a94d10c84593a38f5c0d3476f65cd7acaf4f8446dda81b4b43f0e1ef873f61::og_pass_ {
    struct OG_PASS_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: OG_PASS_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<OG_PASS_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"OG PASS "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"OG PASS"));
