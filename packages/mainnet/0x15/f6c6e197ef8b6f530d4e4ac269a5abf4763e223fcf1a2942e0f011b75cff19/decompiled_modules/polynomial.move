module 0x15f6c6e197ef8b6f530d4e4ac269a5abf4763e223fcf1a2942e0f011b75cff19::polynomial {
    ...
    fun add(arg0: &Polynomial, arg1: &Polynomial) : Polynomial {
        ...
        while (v3 < v0) {
            let v4 = if (v3 < v1) {
                0x15f6c6e197ef8b6f530d4e4ac269a5abf4763e223fcf1a2942e0f011b75cff19::gf256::add(*0x1::vector::borrow<u8>(&arg0.coefficients, v3), *0x1::vector::borrow<u8>(&arg1.coefficients, v3))
            } else {
            ...
            if (v3 > v1) {
                ...
                loop {
                    if (v3 < 0x1::vector::length<u8>(&arg0.coefficients) && v1 - v3 < 0x1::vector::length<u8>(&arg1.coefficients)) {
                        v2 = 0x15f6c6e197ef8b6f530d4e4ac269a5abf4763e223fcf1a2942e0f011b75cff19::gf256::add(v2, 0x15f6c6e197ef8b6f530d4e4ac269a5abf4763e223fcf1a2942e0f011b75cff19::gf256::mul(*0x1::vector::borrow<u8>(&arg0.coefficients, v3), *0x1::vector::borrow<u8>(&arg1.coefficients, v1 - v3)));
                    };
                    if (v3 >= v1) {
                        break
                    };
    ...
    fun div_by_monic_linear(arg0: &Polynomial, arg1: u8) : Polynomial {
        ...
        if (v0 > 1) {
            ...
            if (v3 > v4) {
                ...
                loop {
                    let v5 = 0x15f6c6e197ef8b6f530d4e4ac269a5abf4763e223fcf1a2942e0f011b75cff19::gf256::sub(*0x1::vector::borrow<u8>(&arg0.coefficients, v0 - v3 - 1), 0x15f6c6e197ef8b6f530d4e4ac269a5abf4763e223fcf1a2942e0f011b75cff19::gf256::mul(v2, arg1));
                    v2 = v5;
    ...
    public fun evaluate(arg0: &Polynomial, arg1: u8) : u8 {
        ...
        let v2 = 0;
        while (v2 < v0 - 1) {
            let v3 = 0x15f6c6e197ef8b6f530d4e4ac269a5abf4763e223fcf1a2942e0f011b75cff19::gf256::mul(v1, arg1);
            v1 = 0x15f6c6e197ef8b6f530d4e4ac269a5abf4763e223fcf1a2942e0f011b75cff19::gf256::add(v3, *0x1::vector::borrow<u8>(&arg0.coefficients, v0 - v2 - 2));
            v2 = v2 + 1;
        };
        v1
    }
    ...
    fun interpolate_with_numerators(arg0: &vector<u8>, arg1: &vector<u8>, arg2: &vector<Polynomial>) : Polynomial {
        ...
        while (v2 < v0) {
            ...
            while (v4 < v0) {
                if (v4 != v2) {
                    v3 = 0x15f6c6e197ef8b6f530d4e4ac269a5abf4763e223fcf1a2942e0f011b75cff19::gf256::mul(v3, 0x15f6c6e197ef8b6f530d4e4ac269a5abf4763e223fcf1a2942e0f011b75cff19::gf256::sub(*0x1::vector::borrow<u8>(arg0, v2), *0x1::vector::borrow<u8>(arg0, v4)));
                };
                v4 = v4 + 1;
            };
            let v5 = &v1;
            let v6 = scale(0x1::vector::borrow<Polynomial>(arg2, v2), 0x15f6c6e197ef8b6f530d4e4ac269a5abf4763e223fcf1a2942e0f011b75cff19::gf256::div(*0x1::vector::borrow<u8>(arg1, v2), v3));
            v1 = add(v5, &v6);
            v2 = v2 + 1;
        };
        v1
    ...
    fun scale(arg0: &Polynomial, arg1: u8) : Polynomial {
        ...
        while (v2 < 0x1::vector::length<u8>(v0)) {
            0x1::vector::push_back<u8>(&mut v1, 0x15f6c6e197ef8b6f530d4e4ac269a5abf4763e223fcf1a2942e0f011b75cff19::gf256::mul(*0x1::vector::borrow<u8>(v0, v2), arg1));
            v2 = v2 + 1;
        };
        Polynomial{coefficients: v1}
    }
