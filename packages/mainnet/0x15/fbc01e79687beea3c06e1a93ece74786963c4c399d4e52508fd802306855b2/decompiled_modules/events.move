module 0x15fbc01e79687beea3c06e1a93ece74786963c4c399d4e52508fd802306855b2::events {
    ...
    struct CreateVaultEventV1 has copy, drop {
        ...
        vault_coin_type: vector<u8>,
        vault_coin_decimals: u8,
    ...
    struct DepositEventV1 has copy, drop {
        vault_id: 0x2::object::ID,
        vault_coin_type: vector<u8>,
        vault_coin_amount_minted: u64,
        vault_coin_amount_total_supply: u64,
        coin_in_type: vector<u8>,
        coin_in_amount_deposited: u64,
        coin_in_amount_in_vault: u64,
        exchange_rate_vault_coin_to_ref_coin: u128,
    ...
    struct WithdrawEventV1 has copy, drop {
        ...
        fee_coin_amount: u64,
        exchange_rate_vault_coin_to_ref_coin: u128,
        exchange_rate_coin_out_to_ref_coin: u128,
    }
    ...
    struct AuthorizeAppEventV1 has copy, drop {
        app_id: address,
    }

    struct DeauthorizeAppEventV1 has copy, drop {
        app_id: address,
    }
    ...
    public(friend) fun emit_authorize_app_event(arg0: &0x2::object::UID) {
        let v0 = AuthorizeAppEventV1{app_id: 0x2::object::uid_to_address(arg0)};
        emit<AuthorizeAppEventV1>(v0);
    }
    ...
    public(friend) fun emit_create_vault_event<T0>(arg0: 0x2::object::ID, arg1: u8, arg2: u16) {
        ...
        let v1 = CreateVaultEventV1{
            vault_id               : arg0,
            vault_coin_type        : *0x1::ascii::as_bytes(&v0),
            vault_coin_decimals    : arg1,
            protocol_fee_share_bps : arg2,
        };
        emit<CreateVaultEventV1>(v1);
    }

    public(friend) fun emit_deauthorize_app_event(arg0: &0x2::object::UID) {
        let v0 = DeauthorizeAppEventV1{app_id: 0x2::object::uid_to_address(arg0)};
        emit<DeauthorizeAppEventV1>(v0);
    }
    ...
    public(friend) fun emit_deposit_event<T0, T1>(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u128, arg6: u128) {
        ...
        let v2 = DepositEventV1{
            vault_id                             : arg0,
            vault_coin_type                      : *0x1::ascii::as_bytes(&v0),
            vault_coin_amount_minted             : arg1,
            vault_coin_amount_total_supply       : arg2,
            coin_in_type                         : *0x1::ascii::as_bytes(&v1),
            coin_in_amount_deposited             : arg3,
            coin_in_amount_in_vault              : arg4,
            exchange_rate_vault_coin_to_ref_coin : arg5,
    ...
    public(friend) fun emit_swap_event<T0, T1>(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u128, arg7: u128) {
        ...
        let v2 = SwapEventV1{
            ...
            exchange_rate_coin_in_to_ref_coin  : arg6,
            exchange_rate_coin_out_to_ref_coin : arg7,
        };
        emit<SwapEventV1>(v2);
    }
    ...
    public(friend) fun emit_withdraw_event<T0, T1>(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u128, arg7: u128) {
        ...
        let v2 = WithdrawEventV1{
            vault_id                             : arg0,
            vault_coin_type                      : *0x1::ascii::as_bytes(&v0),
            vault_coin_amount_burned             : arg1,
            vault_coin_amount_total_supply       : arg2,
            coin_out_type                        : *0x1::ascii::as_bytes(&v1),
            coin_out_amount_withdrawn            : arg3,
            coin_out_amount_in_vault             : arg4,
            fee_coin_amount                      : arg5,
            exchange_rate_vault_coin_to_ref_coin : arg6,
            exchange_rate_coin_out_to_ref_coin   : arg7,
        };
