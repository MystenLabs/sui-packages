module 0x15b6ac6bce36c234f7f13843079ffa42ae2ddb9b863704cb480f99f3100b62c0::reward1062 {
    struct REWARD1062 has drop {
        dummy_field: bool,
    }

    struct TICKET_1062 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1062(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1062>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1062>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1062, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1062>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1062>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1062>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1062>>(v5, 0x2::tx_context::sender(arg1));
    }
