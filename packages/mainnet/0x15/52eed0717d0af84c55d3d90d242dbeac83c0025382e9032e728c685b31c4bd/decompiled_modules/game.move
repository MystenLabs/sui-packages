module 0x1552eed0717d0af84c55d3d90d242dbeac83c0025382e9032e728c685b31c4bd::game {
    ...
    fun init(arg0: GAME, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Game"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The GameGirl"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://1xRUmUtxdKper6NTfsFn9cjIhCN4K9rUjGjm8aO5-j4"));
