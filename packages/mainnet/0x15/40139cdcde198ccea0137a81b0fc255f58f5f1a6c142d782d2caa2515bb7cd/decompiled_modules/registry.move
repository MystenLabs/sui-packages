module 0x1540139cdcde198ccea0137a81b0fc255f58f5f1a6c142d782d2caa2515bb7cd::registry {
    ...
    struct Registry has key {
        id: 0x2::object::UID,
        version: 0x1540139cdcde198ccea0137a81b0fc255f58f5f1a6c142d782d2caa2515bb7cd::version::Version,
    ...
    public fun get_pair_id<T0>(arg0: &Registry) : 0x2::object::ID {
        0x1540139cdcde198ccea0137a81b0fc255f58f5f1a6c142d782d2caa2515bb7cd::version::assert_current_version(&arg0.version);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Registry{
            ...
            version        : 0x1540139cdcde198ccea0137a81b0fc255f58f5f1a6c142d782d2caa2515bb7cd::version::initialize(),
    ...
    public fun set_price_pair_id<T0>(arg0: &AdminCap, arg1: &mut Registry, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject) {
        0x1540139cdcde198ccea0137a81b0fc255f58f5f1a6c142d782d2caa2515bb7cd::version::assert_current_version(&arg1.version);
    ...
    public fun upgrade_major(arg0: &AdminCap, arg1: &mut Registry) {
        0x1540139cdcde198ccea0137a81b0fc255f58f5f1a6c142d782d2caa2515bb7cd::version::upgrade_major(&mut arg1.version);
    }

    public fun upgrade_minor(arg0: &AdminCap, arg1: &mut Registry) {
        0x1540139cdcde198ccea0137a81b0fc255f58f5f1a6c142d782d2caa2515bb7cd::version::upgrade_minor(&mut arg1.version);
    }

    public fun version(arg0: &Registry) : &0x1540139cdcde198ccea0137a81b0fc255f58f5f1a6c142d782d2caa2515bb7cd::version::Version {
        &arg0.version
    }
