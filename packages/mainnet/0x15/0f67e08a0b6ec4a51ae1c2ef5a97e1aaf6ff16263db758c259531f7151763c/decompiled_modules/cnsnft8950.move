module 0x150f67e08a0b6ec4a51ae1c2ef5a97e1aaf6ff16263db758c259531f7151763c::cnsnft8950 {
    struct CNSNFT8950 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8950, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8950>(arg0, arg1);
