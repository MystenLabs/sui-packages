module 0x15938886bc1c8104d211c817d1708fc9bc34fd53d4d5ddab2311de66056c53bb::cnsnft3627 {
    struct CNSNFT3627 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3627, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3627>(arg0, arg1);
