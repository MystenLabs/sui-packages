module 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory {
    ...
    public fun add_allowed_pair_config<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut Pools, arg2: u32, arg3: &0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x1::string::String, PermissionPairManager>(&mut arg1.id, 0x1::string::utf8(b"permission_pair_manager"));
        if (!0x2::table::contains<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u32>>(&v0.allowed_pair_config, 0x1::type_name::get<T0>())) {
            0x2::table::add<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u32>>(&mut v0.allowed_pair_config, 0x1::type_name::get<T0>(), 0x2::vec_set::empty<u32>());
        };
        0x2::vec_set::insert<u32>(0x2::table::borrow_mut<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u32>>(&mut v0.allowed_pair_config, 0x1::type_name::get<T0>()), arg2);
        let v1 = AddAllowedPairConfigEvent{
            coin_type    : 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())),
            tick_spacing : arg2,
        };
        0x2::event::emit<AddAllowedPairConfigEvent>(v1);
    }
