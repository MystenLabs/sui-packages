module 0x155d374a3b81034c64e40bc5c95de9f5b7527b020c148633f217b9c72c1d6a0d::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"MC3776910", b"MixedConcurrent3 776910", b"Third concurrent deployment", 0x1::option::none<0x2::url::Url>(), arg1);
