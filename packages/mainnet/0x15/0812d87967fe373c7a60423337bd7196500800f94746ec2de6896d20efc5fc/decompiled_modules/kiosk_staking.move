module 0x150812d87967fe373c7a60423337bd7196500800f94746ec2de6896d20efc5fc::kiosk_staking {
    ...
    public fun stake_finalize<T0: store + key>(arg0: &mut Global, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun unstake_finalize<T0: store + key>(arg0: &mut Global, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x2::object::ID, StakedItemInfo>(&arg0.staked, arg2), 2);
        assert_staking_kiosk(arg0, arg1);
        let v0 = 0x2::table::borrow<0x2::object::ID, StakedItemInfo>(&arg0.staked, arg2);
        assert_type_matches<T0>(v0);
        assert!(v0.pending_exit, 11);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        let v2 = v1 - v0.staked_at;
        if (0x2::kiosk::has_item_with_type<T0>(arg1, arg2)) {
            assert!(!0x2::kiosk::is_listed(arg1, arg2), 7);
    ...
    public fun unstake_prepare<T0: store + key>(arg0: &mut Global, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x2::object::ID, StakedItemInfo>(&arg0.staked, arg1), 2);
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, StakedItemInfo>(&mut arg0.staked, arg1);
        assert_type_matches<T0>(v0);
        assert!(0x2::tx_context::sender(arg3) == v0.staker, 10);
        assert!(!v0.pending_exit, 11);
        assert!(0x2::clock::timestamp_ms(arg2) - v0.staked_at >= arg0.min_staking_duration_ms, 3);
        v0.pending_exit = true;
    }
