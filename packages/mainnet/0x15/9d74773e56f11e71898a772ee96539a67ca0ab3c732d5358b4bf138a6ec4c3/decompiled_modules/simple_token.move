module 0x159d74773e56f11e71898a772ee96539a67ca0ab3c732d5358b4bf138a6ec4c3::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"WAVE", b"WAVE", b"Official token on Sui blockchain. Banner, ads and boost on dexscreener already paid.", 0x1::option::none<0x2::url::Url>(), arg1);
