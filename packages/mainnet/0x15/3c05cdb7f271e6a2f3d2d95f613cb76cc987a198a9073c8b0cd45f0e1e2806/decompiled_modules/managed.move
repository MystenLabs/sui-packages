module 0x153c05cdb7f271e6a2f3d2d95f613cb76cc987a198a9073c8b0cd45f0e1e2806::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"Dog", b"DOG", b"https://iili.io/2tmTR1t.png", 0x1::option::none<0x2::url::Url>(), arg1);
