module 0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::oracle {
    struct HiveOracle has store, key {
        id: 0x2::object::UID,
        update_cap: 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::TwapUpdateCap,
    ...
    fun calculate_twap(arg0: u256, arg1: u256, arg2: u64) : u256 {
        let v0 = if (arg0 >= arg1) {
            ...
            0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::overflow_add_u256(arg0, 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::sub_from_max_u256(arg1))
        };
        v0 / (arg2 as u256)
    }
    ...
    public fun setup_hive_oracle(arg0: 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::TwapUpdateCap, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = HiveOracle{
            ...
            window_size        : 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::constants::twap_init_window_size(),
            tolerance          : 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::constants::twap_init_tolerance(),
            module_version     : 0,
        };
        0x2::transfer::share_object<HiveOracle>(v0);
    }

    public fun update_hive_oracle(arg0: &0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::config::HiveDaoCapability, arg1: &mut HiveOracle, arg2: 0x1::option::Option<address>, arg3: 0x1::option::Option<address>, arg4: u64, arg5: u64, arg6: &0x2::tx_context::TxContext) {
        ...
        if (arg4 > 0) {
            assert!(arg4 <= 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::constants::twap_max_window_size(), 1977);
            arg1.window_size = arg4;
        };
        if (arg5 > 0) {
            assert!(arg5 <= 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::constants::twap_max_tolerance(), 1978);
            arg1.tolerance = arg5;
        };
    ...
    public entry fun update_hive_oracle_price<T0, T1, T2, T3, T4, T5>(arg0: &0x2::clock::Clock, arg1: &mut HiveOracle, arg2: &mut 0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::HiveManager, arg3: &0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LiquidityPool<T0, T1, T4>, arg4: &0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::LiquidityPool<T2, T3, T5>, arg5: &0x2::tx_context::TxContext) {
        ...
        let v2 = 0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::get_liquidity_pool_id<T2, T3, T5>(arg4);
        assert!(0x2::object::id_to_address(&v2) == *0x1::option::borrow<address>(&arg1.sui_hive_pool_addr), 1974);
        let v3 = 0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::get_liquidity_pool_id<T0, T1, T4>(arg3);
        assert!(0x2::object::id_to_address(&v3) == *0x1::option::borrow<address>(&arg1.usdc_sui_pool_addr), 1974);
        let (_, v5, v6) = 0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::get_pool_cumulative_prices<T2, T3, T5>(arg4);
        let (_, v8, v9) = 0x151ccb0eb6162492cd3ef910fab5533848609a5190c69feebd5aa534023506cb::two_pool::get_pool_cumulative_prices<T0, T1, T4>(arg3);
        ...
        if (0x1::option::is_some<HiveTwapSnapshot>(&v20)) {
            ...
            let v28 = 0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::mul_div_u256(v26, v27, (0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::math::pow(10, (0xbc580569b4a4ecf5718a221d93df04a1a8c9e43deae51ff9b619305ebf7b6cc8::constants::twap_precision() as u128)) as u256));
            if (v28 > 0) {
                0x1b8c7143edbd369019048d6d46d873e3b1972e356f3c047796c97ab120451fb3::hive_profile::update_hive_twap_info(&arg1.update_cap, arg0, arg2, v26, v27, v28);
            };
        };
