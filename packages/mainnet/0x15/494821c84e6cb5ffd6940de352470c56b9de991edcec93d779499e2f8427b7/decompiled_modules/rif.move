module 0x15494821c84e6cb5ffd6940de352470c56b9de991edcec93d779499e2f8427b7::rif {
    struct RIF has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: RIF, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<RIF>(&mut v3, 420000000000000000, 0x2::tx_context::sender(arg1), arg1);
