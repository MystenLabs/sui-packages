module 0x2e09b4abfee5d2d590f94d9b1370480913ad9dd58363aa73c38552c99bf67dd2::profile {
    ...
    entry fun create_and_keep(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        check_lens(&arg0, &arg1);
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = 0x2::clock::timestamp_ms(arg2);
        let v2 = 0x2::object::new(arg3);
    ...
    public fun destroy(arg0: Profile) {
        let Profile {
            id         : v0,
            owner      : _,
            avatar     : _,
    ...
    public fun set_v2(arg0: &mut Profile, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        check_lens(&arg1, &arg2);
    ...
    public fun transfer_ownership(arg0: Profile, arg1: address) {
        assert!(arg1 != @0x0, 2);
        arg0.owner = arg1;
