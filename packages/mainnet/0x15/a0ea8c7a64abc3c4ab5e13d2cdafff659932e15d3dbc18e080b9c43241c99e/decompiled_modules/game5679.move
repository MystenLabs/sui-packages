module 0x15a0ea8c7a64abc3c4ab5e13d2cdafff659932e15d3dbc18e080b9c43241c99e::game5679 {
    struct GAME5679 has drop {
        dummy_field: bool,
    }

    struct TICKET_5679 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5679(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5679>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5679>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME5679, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME5679>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5679>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5679>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5679>>(v5, 0x2::tx_context::sender(arg1));
    }
