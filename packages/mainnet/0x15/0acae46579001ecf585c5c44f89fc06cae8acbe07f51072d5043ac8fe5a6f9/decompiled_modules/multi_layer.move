module 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::multi_layer {
    ...
    fun get_orders_by_layer<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2::clock::Clock) : vector<LayerOrderInfo> {
        ...
        while (v2 < 0x1::vector::length<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(&v0)) {
            ...
            let (v6, v7, _) = 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::orderbook_analyzer::parse_order_id(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::order_id(v3));
    ...
    public(friend) fun process_layers<T0, T1, T2, T3>(arg0: &mut 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::mm_state::MMState, arg1: &0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::mm_registry::MMRegistry, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T2, T3>, arg5: &0x2::clock::Clock, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &vector<u64>, arg12: &vector<u64>, arg13: &vector<u64>, arg14: &vector<u64>, arg15: &vector<u64>, arg16: u64, arg17: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg18: &0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::config::MMConfig, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::config::is_dry_run(arg18);
        let v3 = 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::config::enable_deep_payment(arg18);
        let v4 = get_orders_by_layer<T0, T1>(arg3, arg2, arg5);
        if (!v2 && 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::config::enable_deep_refill(arg18)) {
            let v5 = 0;
            let v6 = 0;
            while (v6 < v1) {
            ...
            let (_, _) = 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::deep_manager::ensure_deep_balance<T0, T1, T2, T3>(arg3, arg4, arg2, arg17, v5, arg6, arg18, arg5, arg23);
        };
        let v10 = 0;
        while (v10 < v1) {
            let v11 = (v10 as u8);
            ...
            let v21 = 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::orders::round_bid_price(v19, arg19);
            let v22 = 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::orders::round_ask_price(v20, arg19);
            let v23 = if (v12 >= arg20) {
                if (v12 >= 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::config::min_order_size(arg18)) {
                    v21 >= 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::config::min_price(arg18)
                } else {
                    false
                }
            } else {
            ...
            let v24 = if (v13 >= arg20) {
                if (v13 >= 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::config::min_order_size(arg18)) {
                    v22 <= 0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::config::max_price(arg18)
                } else {
                    false
                }
            } else {
        ...
        0x150acae46579001ecf585c5c44f89fc06cae8acbe07f51072d5043ac8fe5a6f9::events::emit_log_bytes(b"multi_layer_executed");
