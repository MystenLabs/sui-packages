module 0x158ddedd0cf73606e92b91f0429dba7686150152a98ca11a6ebd9a5771289fd6::cnsnft3962 {
    struct CNSNFT3962 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3962, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3962>(arg0, arg1);
