module 0x1592ecf6e69d4a4f5dc63912492646e1ec8e21d9763192f04e23a507269e91f6::finger_guessing_game {
    ...
    public fun play(arg0: u64, arg1: &0x2::clock::Clock) {
        ...
        let v1 = if (arg0 == v0) {
            0x1::string::utf8(x"e5958ae593a6efbc8ce5b9b3e5b180e38082")
        } else if (is_player_wine(arg0, v0)) {
            0x1::string::utf8(x"e681ade5969cefbc8ce4bda0e8b5a2e4ba86efbc81")
        } else {
            0x1::string::utf8(x"e98197e686beefbc8ce4bda0e8be93e4ba86efbd9e")
        };
        let v2 = v1;
