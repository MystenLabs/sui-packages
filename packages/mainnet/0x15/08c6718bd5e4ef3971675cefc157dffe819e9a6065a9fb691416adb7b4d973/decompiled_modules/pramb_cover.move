module 0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::pramb_cover {
    ...
    struct RefEvent has copy, drop, store {
    ...
    public entry fun buy_cover<T0>(arg0: &mut Config, arg1: 0x1::ascii::String, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = 0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::u256::as_u64(0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::u256::div(0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::u256::mul(0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::u256::from_u64(arg2), 0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::u256::from_u64(v1.rate_per_day * arg4)), 0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::u256::from_u64(1000000)));
    ...
    public entry fun extend_user_cover<T0>(arg0: &mut Config, arg1: 0x1::ascii::String, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::u256::as_u64(0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::u256::div(0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::u256::mul(0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::u256::from_u64(v2.amount), 0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::u256::from_u64(v0.rate_per_day * arg3)), 0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::u256::from_u64(1000000)));
    ...
    public entry fun invite_ref(arg0: 0x1::ascii::String, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = RefEvent{
            ref       : arg0,
            user_addr : 0x2::tx_context::sender(arg1),
        };
        0x2::event::emit<RefEvent>(v0);
    }

    public entry fun migrate_version(arg0: &mut Config, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        migrate_version_contract(arg0, arg1, arg2);
    }
    ...
    public entry fun update_capacity_token_protocol<T0>(arg0: &mut Config, arg1: 0x1::ascii::String, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.admin, 101);
        assert!(0x2::table::contains<0x1::ascii::String, Protocol>(&arg0.protocols, arg1), 102);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Protocol>(&mut arg0.protocols, arg1);
        let v1 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x2::table::contains<0x1::ascii::String, TokenCapacity>(&v0.max_capacity_tokens, v1), 105);
        let v2 = 0x2::table::borrow_mut<0x1::ascii::String, TokenCapacity>(&mut v0.max_capacity_tokens, v1);
        v2.max_capacity = arg2;
        v2.capacity = arg3;
    }
    ...
    public entry fun withdraw_treasure<T0>(arg0: &mut Config, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == @0x878520e777c712d91f3c431b72ecf2fd9cc8d7f033251e7e68743178cf72e3da || v0 == @0x49cc391ab4d3503e03dbb24c4f9e28f3cdd2ddf8a459e0d43012c3868ffefa1, 101);
        let v1 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
