module 0x152617388dc38bec5907f89c201d426e8224f13fe6950d3a7773aa11a73e1286::xaum_indicator_core {
    ...
    public fun bind_admin_cap(arg0: &mut PriceStorage, arg1: &AdminCap, arg2: 0x195dae755ccc7d61bec62f1814b48b8dd95b27a38e118f80a3e711f1bad67ce7::x_oracle::XOracleAdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1);
        let v0 = AdminCapKey{dummy_field: false};
        0x2::dynamic_object_field::add<AdminCapKey, 0x195dae755ccc7d61bec62f1814b48b8dd95b27a38e118f80a3e711f1bad67ce7::x_oracle::XOracleAdminCap>(&mut arg0.id, v0, arg2);
    }
    ...
    public fun push_gr_indicators_to_x_oracle(arg0: &PriceStorage, arg1: &AdminCap, arg2: &mut 0x195dae755ccc7d61bec62f1814b48b8dd95b27a38e118f80a3e711f1bad67ce7::x_oracle::XOracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1);
        let v0 = AdminCapKey{dummy_field: false};
        0x195dae755ccc7d61bec62f1814b48b8dd95b27a38e118f80a3e711f1bad67ce7::x_oracle::set_gr_indicators(arg2, 0x2::dynamic_object_field::borrow<AdminCapKey, 0x195dae755ccc7d61bec62f1814b48b8dd95b27a38e118f80a3e711f1bad67ce7::x_oracle::XOracleAdminCap>(&arg0.id, v0), ((arg0.ema120_current / 1000000000) as u64), ((arg0.ema90_current / 1000000000) as u64), ((arg0.latest_price / 1000000000) as u64), 0x2::clock::timestamp_ms(arg3) / 1000, arg4);
    }
    ...
    public fun set_price_9dec(arg0: &AdminCap, arg1: &mut PriceStorage, arg2: u64, arg3: &mut 0x195dae755ccc7d61bec62f1814b48b8dd95b27a38e118f80a3e711f1bad67ce7::x_oracle::XOracle, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg1, arg0);
        assert!(arg2 > 0, 0);
