module 0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::vesting {
    struct ACL has key {
        id: 0x2::object::UID,
    ...
    struct SurgeVestingState has key {
        ...
        treasury_cap: 0x2::coin::TreasuryCap<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>,
    }
    ...
    public fun claim_airdrop(arg0: &mut SurgeVestingState, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>>(v0, 0x2::tx_context::sender(arg2));
    }

    public fun claim_airdrop_coin(arg0: &mut SurgeVestingState, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE> {
        ...
        0x2::coin::mint<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>(&mut arg0.treasury_cap, v0, arg2)
    }
    ...
    public fun initialize_surge_vest_state(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: 0x2::coin::TreasuryCap<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun migrate_version(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: &mut SurgeVestingState) {
    ...
    public fun remove_robot_admin(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: &mut ACL, arg2: address) {
        let (v0, v1) = 0x1::vector::index_of<address>(&arg1.robot_admin, &arg2);
        assert!(v0, 0);
        0x1::vector::remove<address>(&mut arg1.robot_admin, v1);
    }

    public fun remove_whitelist_admin(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: &mut ACL, arg2: address) {
    ...
    public fun send_liquidity_and_listing(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: address, arg2: &mut SurgeVestingState, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 != @0x0, 11);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>>(send_liquidity_and_listing_coin(arg0, arg2, arg3, arg4), arg1);
    }

    public fun send_liquidity_and_listing_coin(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: &mut SurgeVestingState, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE> {
        assert!(arg1.version == 0, 9);
        ...
        0x2::coin::mint<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>(&mut arg1.treasury_cap, 50000000000000000, arg3)
    }
    ...
    public fun send_to_community(arg0: &ACL, arg1: &mut SurgeVestingState, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>>(0x2::coin::mint<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>(&mut arg1.treasury_cap, 6527777777777777, arg3), arg1.surge_address_config.community);
    ...
    public fun send_to_core_contributors(arg0: &ACL, arg1: &mut SurgeVestingState, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>>(0x2::coin::mint<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>(&mut arg1.treasury_cap, 2777777777777777, arg3), arg1.surge_address_config.core_contributors);
    ...
    public fun send_to_early_backers(arg0: &ACL, arg1: &mut SurgeVestingState, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>>(0x2::coin::mint<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>(&mut arg1.treasury_cap, 2777777777777777, arg3), arg1.surge_address_config.early_backers);
    ...
    public fun send_to_ecosystem(arg0: &ACL, arg1: &mut SurgeVestingState, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>>(0x2::coin::mint<0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SURGE>(&mut arg1.treasury_cap, 4166666666666666, arg3), arg1.surge_address_config.ecosystem);
    ...
    public fun set_community_address(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: &mut SurgeVestingState, arg2: address) {
        assert!(arg1.version == 0, 9);
        arg1.surge_address_config.community = arg2;
    }

    public fun set_core_contributors_address(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: &mut SurgeVestingState, arg2: address) {
        assert!(arg1.version == 0, 9);
        arg1.surge_address_config.core_contributors = arg2;
    }

    public fun set_early_backers_address(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: &mut SurgeVestingState, arg2: address) {
        assert!(arg1.version == 0, 9);
        arg1.surge_address_config.early_backers = arg2;
    }

    public fun set_ecosystem_address(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: &mut SurgeVestingState, arg2: address) {
        assert!(arg1.version == 0, 9);
        arg1.surge_address_config.ecosystem = arg2;
    }

    public fun set_robot_admin(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: &mut ACL, arg2: address) {
        assert!(!0x1::vector::contains<address>(&arg1.robot_admin, &arg2), 7);
        0x1::vector::push_back<address>(&mut arg1.robot_admin, arg2);
    }

    public fun set_tge_timestamp(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: &mut SurgeVestingState, arg2: u64, arg3: u64) {
        assert!(arg1.version == 0, 9);
    ...
    public fun set_whitelist_admin(arg0: &0x157aff07eba78453d46a98d422913da18f2023a4cd09fcf1cf72085b915db664::surge::SuperAdmin, arg1: &mut ACL, arg2: address) {
