module 0x153e41b51d3d8fc84cab8eb74ed6e4e9be8806fda0e21d10e36bb9d05779aafb::clove {
    ...
    fun init(arg0: CLOVE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CLOVE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"clove"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"clove "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiesxufq6lebe65edtepkvnsv7fysou4szbgvppivdfefstwoe66cm"));
