module 0xeae6d7e69bc29b57491c3c8d3ec3d2f9f2cb53da6672352489e41403b1d57a6::attribution {
    ...
    public fun new<T0, T1, T2, T3>(arg0: &0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::RecordingAdminCap<T2>, arg1: &mut 0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::Recording<T2, T3>, arg2: &0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::Recording<T0, T1>, arg3: 0x2::balance::Balance<T2>, arg4: &mut 0x2::tx_context::TxContext) : RecordingAttribution<T0, T2> {
        let v0 = 0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::id<T0, T1>(arg2);
        let v1 = 0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::id<T2, T3>(arg1);
        assert!(v0 != v1, 0);
        assert!(0xeae6d7e69bc29b57491c3c8d3ec3d2f9f2cb53da6672352489e41403b1d57a6::license::is_attached<T0, T1>(arg2), 1);
        let v2 = ExtensionKey<T0>{dummy_field: false};
        let v3 = RecordingAttribution<T0, T2>{
            id                      : 0x2::derived_object::claim<ExtensionKey<T0>>(0xe737857ae5d0fc1e5bf7837b665d740b531dd331d1882eef4aa0e6dc3cba1f28::recording::uid_mut<T2, T3>(arg1, arg0), v2),
