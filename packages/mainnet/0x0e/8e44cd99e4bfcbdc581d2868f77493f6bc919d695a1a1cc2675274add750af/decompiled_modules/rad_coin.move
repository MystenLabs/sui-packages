module 0xe8e44cd99e4bfcbdc581d2868f77493f6bc919d695a1a1cc2675274add750af::rad_coin {
    ...
    fun init(arg0: RAD_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<RAD_COIN>(arg0, 9, b"RAD", b"RAD", b"radiantarena game coin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::string::to_ascii(0x1::string::utf8(b"https://launcher.radiantarena.com/favicon.svg")))), arg1);
