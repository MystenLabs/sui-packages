module 0xed36d45ea88bcf20f7e61d9664b7d865e68a19a4e90a016a9b7dd4fa8f93683::tale01 {
    ...
    fun init(arg0: TALE01, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"Edition: {index}"));
    ...
    public entry fun update_config(arg0: &AdminCap, arg1: &mut MintConfig, arg2: &mut 0x2::transfer_policy::TransferPolicy<Nft>, arg3: &0x2::transfer_policy::TransferPolicyCap<Nft>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u16, arg9: address, arg10: u64) {
        ...
        let v0 = if (arg1.royalty_bps != arg8) {
            ...
            0xed36d45ea88bcf20f7e61d9664b7d865e68a19a4e90a016a9b7dd4fa8f93683::tale01_royalty::min_amount(0xed36d45ea88bcf20f7e61d9664b7d865e68a19a4e90a016a9b7dd4fa8f93683::tale01_royalty::get_config<Nft>(arg2)) != arg10
        };
        if (v0) {
            0xed36d45ea88bcf20f7e61d9664b7d865e68a19a4e90a016a9b7dd4fa8f93683::tale01_royalty::update<Nft>(arg2, arg3, arg8, arg9, arg10);
