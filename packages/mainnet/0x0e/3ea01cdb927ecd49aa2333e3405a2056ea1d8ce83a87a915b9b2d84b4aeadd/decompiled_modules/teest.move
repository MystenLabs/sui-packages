module 0xe3ea01cdb927ecd49aa2333e3405a2056ea1d8ce83a87a915b9b2d84b4aeadd::teest {
    ...
    fun init(arg0: TEEST, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v0, v1) = 0x2::coin::create_currency<TEEST>(arg0, 9, b"TSTH2", b"TestHash2", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b""))), arg1);
        let v2 = v0;
