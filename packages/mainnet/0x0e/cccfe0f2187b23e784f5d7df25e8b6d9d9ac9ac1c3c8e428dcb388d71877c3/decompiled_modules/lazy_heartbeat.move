module 0xecccfe0f2187b23e784f5d7df25e8b6d9d9ac9ac1c3c8e428dcb388d71877c3::lazy_heartbeat {
    ...
    public fun current_traits(arg0: &NFT, arg1: &0x2::clock::Clock) : (u64, u8, u8, u8, u8, u16) {
    ...
    public fun mutation_flags(arg0: &NFT, arg1: &0x2::clock::Clock) : u16 {
        let v0 = arg0.mutation_seed ^ current_age_seconds(arg0, arg1) / 30;
        let v1 = 0x1::bcs::to_bytes<u64>(&v0);
        let v2 = 0x2::hash::keccak256(&v1);
        (*0x1::vector::borrow<u8>(&v2, 2) as u16) << 8 | (*0x1::vector::borrow<u8>(&v2, 3) as u16)
    }
    ...
    public entry fun setup_display(arg0: &0x2::package::Publisher, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(x"48656172746265617420e28692204261627920e2869220437265617475726520e28692204865726f20e28692204d797468696320e2869220436f736d69632e2041206c6976696e6720312f31204e4654206f6e205375692e"));
