module 0xeea4b39278f417d8320a581b34af2f312c505f89d94a9e74a16c0964cc5ba0d1::alphafi_bluefin_type_1_investor {
    ...
    fun autocompound_internal<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, 0x2::sui::SUI>, arg8: bool, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, bool) {
        ...
        if (v6 >= arg0.minimum_swap_amount) {
            let (v7, v8) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T2, T3>(arg9, arg2, arg5, v5, 0x2::balance::zero<T3>(), true, true, v6, 0, v0);
            0x2::balance::destroy_zero<T2>(v7);
            0x2::coin::join<T3>(&mut v2, 0x2::coin::from_balance<T3>(v8, arg10));
        } else {
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<0x2::sui::SUI>()) == true) {
            let v10 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<0x2::sui::SUI>>(&mut arg0.free_rewards, 0x1::type_name::get<0x2::sui::SUI>());
            let v11 = 0x2::balance::value<0x2::sui::SUI>(v10);
            if (v11 >= arg0.minimum_swap_amount) {
                let (v12, v13) = 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::converter::swap_b2a<T1, 0x2::sui::SUI>(arg3, arg7, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(v10), arg10), true, v11, arg9, arg10);
                let v14 = v12;
                0x2::coin::destroy_zero<0x2::sui::SUI>(v13);
                v9 = (0x2::coin::value<T1>(&v14) as u128) * (arg0.performance_fee as u128) / 10000;
                0x2::balance::join<T1>(&mut arg0.free_balance_b, 0x2::coin::into_balance<T1>(v14));
            };
        };
        let (_, _, v17, v18) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg9, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"));
        let v19 = v18;
        let v20 = v17;
        let v21 = (0x2::balance::value<T0>(&v20) as u128) * (arg0.performance_fee as u128) / 10000;
        let v22 = v9 + (0x2::balance::value<T1>(&v19) as u128) * (arg0.performance_fee as u128) / 10000;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v20, (v21 as u64)), arg10), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_fee_wallet_address(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v19, (v22 as u64)), arg10), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_fee_wallet_address(arg1));
        let (v23, v24) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg2, arg3, v20, v19, arg4, arg6, v0, v1, arg8, arg9, arg10);
        let (_, v26, v27, v28) = get_balances_in_ratio<T0, T1>(arg0, v23, v24, arg4, true, arg10);
        let v29 = v27;
        let v30 = v26;
        ...
        let v33 = AutoCompoundingEvent{
            ...
            fee_collected_a   : (v21 as u64),
            fee_collected_b   : (v22 as u64),
