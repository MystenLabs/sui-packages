module 0xe9c79939a877c880d58ef9ad60b2e0ee7be124ac066f28c9c99690f240f4ec1::reward8295 {
    struct REWARD8295 has drop {
        dummy_field: bool,
    }

    struct TICKET_8295 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8295(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8295>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8295>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8295, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8295>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8295>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8295>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8295>>(v5, 0x2::tx_context::sender(arg1));
    }
