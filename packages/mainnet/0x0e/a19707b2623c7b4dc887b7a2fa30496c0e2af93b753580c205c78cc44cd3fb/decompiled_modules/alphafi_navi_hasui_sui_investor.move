module 0x1380e8f665562eca122931a4552908d828ef74ff9c33d753b308f4087461a9cf::alphafi_navi_hasui_sui_investor {
    ...
    public fun collect_reward_with_two_swaps<T0>(arg0: &mut Investor<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>, arg1: &0x1380e8f665562eca122931a4552908d828ef74ff9c33d753b308f4087461a9cf::version::Version, arg2: &0x2::clock::Clock, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::RewardFund<T0>, arg6: &mut 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::staking::Staking, arg7: &mut 0x3::sui_system::SuiSystemState, arg8: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg9: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI, 0x2::sui::SUI>, arg10: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<DebugClaimable>(v12);
        let v13 = 0;
        let v14 = 0x1::vector::empty<0x1::ascii::String>();
        let v15 = vector[];
        while (v13 < 0x1::vector::length<0x1::ascii::String>(&v10)) {
            if (*0x1::vector::borrow<u256>(&v9, v13) > 0 && *0x1::vector::borrow<0x1::ascii::String>(&v10, v13) == 0x1::type_name::into_string(0x1::type_name::get<T0>())) {
                0x1::vector::push_back<0x1::ascii::String>(&mut v14, *0x1::vector::borrow<0x1::ascii::String>(&v11, v13));
                0x1::vector::append<address>(&mut v15, *0x1::vector::borrow<vector<address>>(&v8, v13));
            };
            v13 = v13 + 1;
        };
        0x2::balance::join<T0>(&mut v2, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::claim_reward_with_account_cap<T0>(arg2, arg4, arg3, arg5, v14, v15, &arg0.navi_acc_cap));
        ...
        let v17 = 0x2::balance::value<T0>(&v2);
        if (v17 >= arg0.minimum_swap_amount) {
            let (v18, v19) = 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::converter::swap_a2b<T0, 0x2::sui::SUI>(arg10, arg8, 0x2::coin::from_balance<T0>(v2, arg11), true, v17, arg2, arg11);
            0x2::coin::destroy_zero<T0>(v18);
            0x2::balance::join<0x2::sui::SUI>(&mut v16, 0x2::coin::into_balance<0x2::sui::SUI>(v19));
        } else {
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<0x2::sui::SUI>()) == true) {
            0x2::balance::join<0x2::sui::SUI>(&mut v16, 0x2::balance::withdraw_all<0x2::sui::SUI>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<0x2::sui::SUI>>(&mut arg0.free_rewards, 0x1::type_name::get<0x2::sui::SUI>())));
        };
        if (0x2::balance::value<0x2::sui::SUI>(&v16) > arg0.minimum_swap_amount) {
            let v20 = 0x2::coin::from_balance<0x2::sui::SUI>(v16, arg11);
            0x2::balance::join<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>(&mut v1, 0x2::coin::into_balance<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>(convert_sui_to_hasui(arg0, arg2, v20, arg9, arg10, arg6, arg7, arg11)));
        } else {
