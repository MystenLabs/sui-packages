module 0xe09553e381193e41effddb04a8d3de86b8107cb72a0dc2c5ad51bdc23623d13::reward3445 {
    struct REWARD3445 has drop {
        dummy_field: bool,
    }

    struct TICKET_3445 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3445(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3445>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3445>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3445, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3445>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3445>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3445>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3445>>(v5, 0x2::tx_context::sender(arg1));
    }
