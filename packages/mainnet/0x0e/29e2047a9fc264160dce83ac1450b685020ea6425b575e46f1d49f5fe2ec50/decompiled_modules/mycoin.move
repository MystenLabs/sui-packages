module 0xe29e2047a9fc264160dce83ac1450b685020ea6425b575e46f1d49f5fe2ec50::mycoin {
    ...
    fun init(arg0: MYCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MYCOIN>(arg0, 5, b"MYCOIN", b"My Custom Coin", b"This is my custom coin description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://bridge-assets.sui.io/usdt.png")), arg1);
