module 0xe03b347f8517fadfa1a94b286f9ce0153b34f20908c196c43d9f531c17803f9::marketplace {
    ...
    struct ListingContentUpdated has copy, drop {
        ...
        old_seal_id: vector<u8>,
        new_seal_id: vector<u8>,
    }
    ...
    public entry fun create_listing(arg0: 0x1::string::String, arg1: vector<u8>, arg2: u64, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_access_pass_seal_id(arg0: &AccessPass) : vector<u8> {
        arg0.seal_id
    }
    ...
    public fun get_seal_id(arg0: &Listing) : vector<u8> {
        arg0.seal_id
    }
    ...
    fun init(arg0: MARKETPLACE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Time-limited access pass for encrypted content on GhostKey. Expires at {expiry_ms} ms."));
    ...
    public entry fun rent_access(arg0: &mut Listing, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v5 > v4, 2);
        let v6 = 0x2::object::uid_to_inner(&arg0.id);
        ...
        0x2::event::emit<AccessRented>(v8);
        let v9 = AccessPass{
        ...
        0x2::transfer::public_transfer<AccessPass>(v9, v7);
    }
    ...
    public fun seal_approve_access(arg0: vector<u8>, arg1: &AccessPass, arg2: &0x2::clock::Clock) : bool {
        if (arg1.seal_id != arg0) {
            return false
        };
        if (0x2::clock::timestamp_ms(arg2) >= arg1.expiry_ms) {
            return false
        };
        true
    }

    public fun seal_approve_access_for_listing(arg0: &Listing, arg1: &AccessPass, arg2: &0x2::clock::Clock) : bool {
        if (arg1.listing_id != 0x2::object::uid_to_inner(&arg0.id)) {
            return false
        };
        if (arg1.seal_id != arg0.seal_id) {
            return false
        };
        if (0x2::clock::timestamp_ms(arg2) >= arg1.expiry_ms) {
            return false
    ...
    public entry fun update_content_references(arg0: &mut Listing, arg1: 0x1::string::String, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.seller, 11);
        ...
        let v0 = ListingContentUpdated{
            ...
            old_seal_id : arg0.seal_id,
            new_seal_id : arg0.seal_id,
        };
