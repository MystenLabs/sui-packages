module 0xe34a306a656689526c9ec0e71c83bf48e54f2c6033f0ee63e5f3342fb8e48ec::vault_config {
    ...
    public(friend) fun borrow_withdraw_cap(arg0: &VaultTokenHolder) : &0xbacc41e5ba49a64baae7e4b7701682e0a00841c99637b76cb545de583107cd26::cloud_wallet_config::QuickWithdrawCap {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0xbacc41e5ba49a64baae7e4b7701682e0a00841c99637b76cb545de583107cd26::cloud_wallet_config::QuickWithdrawCap>(&arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"))
    }
    ...
    public fun remove_withdraw_cap(arg0: &VaultConfig, arg1: &mut VaultTokenHolder, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg1.id, 0x1::ascii::string(b"quick_withdraw_cap"))) {
            0xbacc41e5ba49a64baae7e4b7701682e0a00841c99637b76cb545de583107cd26::cloud_wallet_config::delete_quick_withdraw_cap(0x2::dynamic_field::remove<0x1::ascii::String, 0xbacc41e5ba49a64baae7e4b7701682e0a00841c99637b76cb545de583107cd26::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, 0x1::ascii::string(b"quick_withdraw_cap")));
        };
    }
    ...
    public fun set_cloud_wallet_withdraw_cap(arg0: &VaultConfig, arg1: &mut VaultTokenHolder, arg2: 0x2::transfer::Receiving<0xbacc41e5ba49a64baae7e4b7701682e0a00841c99637b76cb545de583107cd26::cloud_wallet_config::QuickWithdrawCap>, arg3: &mut 0x2::tx_context::TxContext) {
        only_admin(arg0, arg3);
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg1.id, 0x1::ascii::string(b"quick_withdraw_cap"))) {
            0xbacc41e5ba49a64baae7e4b7701682e0a00841c99637b76cb545de583107cd26::cloud_wallet_config::delete_quick_withdraw_cap(0x2::dynamic_field::remove<0x1::ascii::String, 0xbacc41e5ba49a64baae7e4b7701682e0a00841c99637b76cb545de583107cd26::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, 0x1::ascii::string(b"quick_withdraw_cap")));
        };
        0x2::dynamic_field::add<0x1::ascii::String, 0xbacc41e5ba49a64baae7e4b7701682e0a00841c99637b76cb545de583107cd26::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, 0x1::ascii::string(b"quick_withdraw_cap"), 0x2::transfer::public_receive<0xbacc41e5ba49a64baae7e4b7701682e0a00841c99637b76cb545de583107cd26::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, arg2));
    }
