module 0xe66e48a24c266bf3827c81e810d014b9f4f6efe25472d6e35fe437ef292df91::passionnn {
    ...
    public entry fun mint(arg0: &mut AppCap, arg1: 0x1::string::String, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<Passionnn>(v0, 0x2::tx_context::sender(arg3));
    }
