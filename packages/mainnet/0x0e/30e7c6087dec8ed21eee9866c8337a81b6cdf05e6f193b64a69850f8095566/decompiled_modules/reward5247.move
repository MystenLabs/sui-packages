module 0xe30e7c6087dec8ed21eee9866c8337a81b6cdf05e6f193b64a69850f8095566::reward5247 {
    struct REWARD5247 has drop {
        dummy_field: bool,
    }

    struct TICKET_5247 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5247(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5247>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5247>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5247, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5247>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5247>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5247>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5247>>(v5, 0x2::tx_context::sender(arg1));
    }
