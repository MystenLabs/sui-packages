module 0xefd8ea1871f84c63038f88c640fe49eab375713bc024cebd4e07adf215cdf85::gnome {
    ...
    fun init(arg0: GNOME, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<GNOME>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<GNOME>>(v4);
    }
