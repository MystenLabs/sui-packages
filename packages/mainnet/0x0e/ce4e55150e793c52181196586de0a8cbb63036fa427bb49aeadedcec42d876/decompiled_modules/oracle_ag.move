module 0xece4e55150e793c52181196586de0a8cbb63036fa427bb49aeadedcec42d876::oracle_ag {
    ...
    fun new(arg0: &mut 0x2::tx_context::TxContext) : (OracleAggregator, OracleAggregatorCap) {
        let v0 = OracleAggregator{
            ...
            max_age               : 0xece4e55150e793c52181196586de0a8cbb63036fa427bb49aeadedcec42d876::consts::GET_PYTH_MAX_AGE(),
    ...
    public fun assert_oracle_aggregator_cap(arg0: &OracleAggregator, arg1: &OracleAggregatorCap) {
        assert!(0x2::object::id<OracleAggregator>(arg0) == arg1.oracle_aggregator, 9223372255898107903);
    }
    ...
    public fun calc_usd_value<T0>(arg0: &OracleAggregator, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        ...
        (0xece4e55150e793c52181196586de0a8cbb63036fa427bb49aeadedcec42d876::lotus_math::scale_from_float(0xece4e55150e793c52181196586de0a8cbb63036fa427bb49aeadedcec42d876::lotus_math::mul_u128(0xece4e55150e793c52181196586de0a8cbb63036fa427bb49aeadedcec42d876::lotus_math::scale_to_float((arg2 as u128), (get_coin_decimal<T0>(arg0) as u64)), 0xece4e55150e793c52181196586de0a8cbb63036fa427bb49aeadedcec42d876::lotus_math::scale_to_float((v0 as u128), v1)), 0xece4e55150e793c52181196586de0a8cbb63036fa427bb49aeadedcec42d876::consts::GET_USDC_DECIMALS()) as u64)
    }
