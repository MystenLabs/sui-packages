module 0xe438fa4e83a49bc067f4d678273cecf364bf997db5d9e745309dfa22ebcd9163::storage {
    ...
    public fun borrow_reserve(arg0: &Storage, arg1: u8) : &ReserveData {
        0x2::table::borrow<u8, ReserveData>(&arg0.reserves, arg1)
    }

    public fun borrow_reserve_mut(arg0: &mut Storage, arg1: u8) : &mut ReserveData {
        0x2::table::borrow_mut<u8, ReserveData>(&mut arg0.reserves, arg1)
    }
    ...
    public fun decrease_borrow_balance(arg0: &mut ReserveData, arg1: address, arg2: u256) {
        let v0 = &mut arg0.borrow_balance;
        decrease_balance(v0, arg1, arg2);
    }

    public fun decrease_supply_balance(arg0: &mut Storage, arg1: u8, arg2: address, arg3: u256) {
    ...
    public fun increase_borrow_balance(arg0: &mut Storage, arg1: u8, arg2: address, arg3: u256) {
        let v0 = &mut 0x2::table::borrow_mut<u8, ReserveData>(&mut arg0.reserves, arg1).borrow_balance;
        increase_balance(v0, arg2, arg3);
    }

    public fun increase_supply_balance(arg0: &mut Storage, arg1: u8, arg2: address, arg3: u256) {
        let v0 = &mut 0x2::table::borrow_mut<u8, ReserveData>(&mut arg0.reserves, arg1).supply_balance;
        increase_balance(v0, arg2, arg3);
    }
    ...
    public entry fun init_reserve<T0>(arg0: &0x2::clock::Clock, arg1: &mut Storage, arg2: bool, arg3: u256, arg4: u256, arg5: u256, arg6: u256, arg7: u256, arg8: u256, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: &mut 0x2::tx_context::TxContext) {
        only_configurator(arg1, arg13);
        let v0 = arg1.reserves_count;
        assert!(v0 < 255, 43003);
        reserve_validation<T0>(arg1);
        let v1 = TokenBalance{
            user_state   : 0x2::table::new<address, u256>(arg13),
            total_supply : 0,
            treasury     : 0,
        };
        let v2 = TokenBalance{
        ...
        let v5 = ReserveData{
            ...
            current_supply_index  : 0xf62046a601d34fe8b0b567d91652a8620a4f8ccf0da4bd6b501553c50571f35c::ray_math::ray(),
            current_borrow_index  : 0xf62046a601d34fe8b0b567d91652a8620a4f8ccf0da4bd6b501553c50571f35c::ray_math::ray(),
            supply_balance        : v1,
            borrow_balance        : v2,
    ...
    public fun remove_user_collaterals(arg0: &mut Storage, arg1: u8, arg2: address) {
    ...
    public fun remove_user_loans(arg0: &mut Storage, arg1: u8, arg2: address) {
        let v0 = 0x2::table::borrow_mut<address, UserInfo>(&mut arg0.user_info, arg2);
    ...
    public fun update_interest_rate(arg0: &mut Storage, arg1: u8, arg2: u256, arg3: u256) {
        let v0 = 0x2::table::borrow_mut<u8, ReserveData>(&mut arg0.reserves, arg1);
        v0.current_supply_rate = arg3;
        v0.current_borrow_rate = arg2;
    }

    public fun update_state(arg0: &mut Storage, arg1: u8, arg2: u256, arg3: u256, arg4: u64, arg5: u256) {
        let v0 = 0x2::table::borrow_mut<u8, ReserveData>(&mut arg0.reserves, arg1);
        v0.current_borrow_index = arg2;
        v0.current_supply_index = arg3;
        v0.last_update_timestamp = arg4;
        v0.supply_balance.treasury = v0.supply_balance.treasury + arg5;
        v0.supply_balance.total_supply = v0.supply_balance.total_supply + arg5;
    }

    public fun update_user_collaterals(arg0: &mut Storage, arg1: u8, arg2: address) {
        let v0 = 0x2::table::borrow_mut<address, UserInfo>(&mut arg0.user_info, arg2);
        if (!0x1::vector::contains<u8>(&v0.collaterals, &arg1)) {
            0x1::vector::push_back<u8>(&mut v0.collaterals, arg1);
        };
    }

    public fun update_user_loans(arg0: &mut Storage, arg1: u8, arg2: address) {
        let v0 = 0x2::table::borrow_mut<address, UserInfo>(&mut arg0.user_info, arg2);
        if (!0x1::vector::contains<u8>(&v0.loans, &arg1)) {
            0x1::vector::push_back<u8>(&mut v0.loans, arg1);
        };
    }
