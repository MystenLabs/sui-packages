module 0xef46fcc62ac4fffac30a79294f88c162c958682635462afa7e5f0d8f70b38b9::vault_stable {
    struct Vault has key {
        ...
        kusd_cap: 0x2::coin::TreasuryCap<0xef46fcc62ac4fffac30a79294f88c162c958682635462afa7e5f0d8f70b38b9::kusd::KUSD>,
    ...
    public entry fun claim_and_transfer_kusd(arg0: &mut Vault, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xef46fcc62ac4fffac30a79294f88c162c958682635462afa7e5f0d8f70b38b9::kusd::KUSD>>(v0, 0x2::tx_context::sender(arg1));
    }
    ...
    public fun claim_kusd(arg0: &mut Vault, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xef46fcc62ac4fffac30a79294f88c162c958682635462afa7e5f0d8f70b38b9::kusd::KUSD> {
        assert!(arg0.version == 1, 1010);
        ...
        0x2::coin::mint<0xef46fcc62ac4fffac30a79294f88c162c958682635462afa7e5f0d8f70b38b9::kusd::KUSD>(&mut arg0.kusd_cap, v1, arg1)
    }
    ...
    fun init_vault(arg0: 0x2::coin::TreasuryCap<0xef46fcc62ac4fffac30a79294f88c162c958682635462afa7e5f0d8f70b38b9::kusd::KUSD>, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Vault {
        Vault{
    ...
    public entry fun operator_init_vault(arg0: 0x2::coin::TreasuryCap<0xef46fcc62ac4fffac30a79294f88c162c958682635462afa7e5f0d8f70b38b9::kusd::KUSD>, arg1: &OperatorCap, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun request_withdraw(arg0: &mut Vault, arg1: 0x2::coin::Coin<0xef46fcc62ac4fffac30a79294f88c162c958682635462afa7e5f0d8f70b38b9::kusd::KUSD>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 1010);
        assert!(!arg0.paused, 1006);
        let v0 = 0x2::coin::value<0xef46fcc62ac4fffac30a79294f88c162c958682635462afa7e5f0d8f70b38b9::kusd::KUSD>(&arg1);
        assert!(v0 > 0, 1004);
        assert!(arg0.total_kusd > 0, 1005);
        let v1 = 0x2::tx_context::sender(arg2);
        arg0.total_pending_burned_kusd = arg0.total_pending_burned_kusd + v0;
        0x2::coin::burn<0xef46fcc62ac4fffac30a79294f88c162c958682635462afa7e5f0d8f70b38b9::kusd::KUSD>(&mut arg0.kusd_cap, arg1);
