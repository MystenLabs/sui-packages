module 0xe6c325305a817efef96b28f94fa65f8f706f46befb155b8cc30b0c6437581a4::cnsnft7731 {
    struct CNSNFT7731 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7731, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8945"));
        let v4 = 0x2::package::claim<CNSNFT7731>(arg0, arg1);
