module 0xe70b89d1621e95a24511e69cd1390360d66382fe9f12197db982c4173394ddd::vault_contract {
    ...
    public entry fun deposit(arg0: &mut Vault, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xe70b89d1621e95a24511e69cd1390360d66382fe9f12197db982c4173394ddd::vault_nft::mint_nft(arg2, arg3, arg4, v1, arg5);
    }
    ...
    public entry fun withdraw(arg0: &mut Vault, arg1: u64, arg2: 0xe70b89d1621e95a24511e69cd1390360d66382fe9f12197db982c4173394ddd::vault_nft::VaultNFT, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_freeze_object<0xe70b89d1621e95a24511e69cd1390360d66382fe9f12197db982c4173394ddd::vault_nft::VaultNFT>(arg2);
    }
