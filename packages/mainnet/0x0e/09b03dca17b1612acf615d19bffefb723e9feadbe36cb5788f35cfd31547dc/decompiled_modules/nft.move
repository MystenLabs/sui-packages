module 0xe09b03dca17b1612acf615d19bffefb723e9feadbe36cb5788f35cfd31547dc::nft {
    ...
    public entry fun add_object(arg0: &mut VisitorList, arg1: &mut CoCoNFT, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<0x1::string::String, 0xe09b03dca17b1612acf615d19bffefb723e9feadbe36cb5788f35cfd31547dc::item::CoCoItem>(&mut arg1.id, item_key(), 0xe09b03dca17b1612acf615d19bffefb723e9feadbe36cb5788f35cfd31547dc::item::new_item(arg3, arg4, arg5, arg2, arg6));
    }
