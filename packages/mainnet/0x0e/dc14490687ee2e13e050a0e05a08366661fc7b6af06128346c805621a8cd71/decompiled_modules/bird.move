module 0xedc14490687ee2e13e050a0e05a08366661fc7b6af06128346c805621a8cd71::bird {
    ...
    fun init(arg0: BIRD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = BirdStore{
            ...
            total_checkin : 0,
            action_nonce  : 0,
            validator     : 0x1::option::some<vector<u8>>(x"8a6a117bb3187d4477b1aa406c71f8d1edc67192f67f0769f4316f113a3e561c"),
        };
    ...
    public fun update_admin(arg0: BirdAdminCap, arg1: address, arg2: &mut 0xedc14490687ee2e13e050a0e05a08366661fc7b6af06128346c805621a8cd71::version::Version) {
        0xedc14490687ee2e13e050a0e05a08366661fc7b6af06128346c805621a8cd71::version::checkVersion(arg2, 1);
        0x2::transfer::public_transfer<BirdAdminCap>(arg0, arg1);
    }

    public fun update_validator(arg0: &BirdAdminCap, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut 0xedc14490687ee2e13e050a0e05a08366661fc7b6af06128346c805621a8cd71::version::Version) {
        0xedc14490687ee2e13e050a0e05a08366661fc7b6af06128346c805621a8cd71::version::checkVersion(arg3, 1);
        0x1::option::swap<vector<u8>>(&mut arg2.validator, arg1);
    }
