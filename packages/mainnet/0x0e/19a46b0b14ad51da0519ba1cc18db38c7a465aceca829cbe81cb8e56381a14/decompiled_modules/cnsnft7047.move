module 0xe19a46b0b14ad51da0519ba1cc18db38c7a465aceca829cbe81cb8e56381a14::cnsnft7047 {
    struct CNSNFT7047 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7047, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1928"));
        let v4 = 0x2::package::claim<CNSNFT7047>(arg0, arg1);
