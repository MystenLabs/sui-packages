module 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::risk_manager {
    ...
    public fun add_risk(arg0: &mut RiskManager, arg1: u8, arg2: 0x1::option::Option<u64>, arg3: u64) : (bool, u64) {
        let (v0, v1) = if (arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::red() || arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::black()) {
            let v2 = &mut arg0.color_heap;
            add_risk_to_heap(v2, (arg1 as u64) % 2, arg3)
        } else if (arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::even() || arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::odd()) {
            let v3 = &mut arg0.parity_heap;
            add_risk_to_heap(v3, (arg1 as u64) % 2, arg3)
        } else if (arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::first_eighteen() || arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::second_eighteen()) {
            let v4 = &mut arg0.eighteen_heap;
            add_risk_to_heap(v4, (arg1 as u64) % 2, arg3)
        } else if (arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::first_twelve() || arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::second_twelve() || arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::third_twelve()) {
            let v5 = &mut arg0.twelve_heap;
            add_risk_to_heap(v5, (arg1 as u64) % 3, arg3)
        } else if (arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::first_column() || arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::second_column() || arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::third_column()) {
            let v6 = &mut arg0.column_heap;
            add_risk_to_heap(v6, (arg1 as u64) % 3, arg3)
        } else if (arg1 == 0xeb72162cfbecb56f4dd13cd558aadc78162f52f93fe5b24627e5a6f6fe15a74::bet_manager::number()) {
