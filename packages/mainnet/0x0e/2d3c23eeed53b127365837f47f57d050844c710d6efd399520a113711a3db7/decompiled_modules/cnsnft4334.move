module 0xe2d3c23eeed53b127365837f47f57d050844c710d6efd399520a113711a3db7::cnsnft4334 {
    struct CNSNFT4334 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4334, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4334>(arg0, arg1);
