module 0xeda172aa92cec5b85f7aae5bb6adaf84bb7223479ec4540c4af02fd533cb60a::launchpad {
    ...
    public entry fun sell_meme_partial<T0>(arg0: &mut LaunchpadManager<T0>, arg1: MemeBalance, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0 && arg2 <= arg1.amount, 6);
        if (arg2 == arg1.amount) {
            ...
            let v0 = MemeBalance{
                ...
                manager_id : arg1.manager_id,
                name       : arg1.name,
                symbol     : arg1.symbol,
                amount     : arg2,
            };
            arg1.amount = arg1.amount - arg2;
            0x2::transfer::public_transfer<MemeBalance>(arg1, 0x2::tx_context::sender(arg4));
            do_sell<T0>(arg0, v0, arg3, arg4);
        };
    }
