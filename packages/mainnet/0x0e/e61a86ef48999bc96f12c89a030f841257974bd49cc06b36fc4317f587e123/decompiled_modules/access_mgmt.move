module 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::access_mgmt {
    ...
    fun do_grant_manager(arg0: 0x2::object::ID, arg1: &mut ManagerWhitelist, arg2: address, arg3: ManagerScope, arg4: address, arg5: &0x2::clock::Clock) {
        assert!(arg1.character_id == arg0, 250);
    ...
    fun do_revoke_manager(arg0: 0x2::object::ID, arg1: &mut ManagerWhitelist, arg2: address, arg3: address, arg4: &0x2::clock::Clock) {
        assert!(arg1.character_id == arg0, 250);
        let (v0, v1) = find_manager(arg1, arg2);
        if (v0) {
    ...
    entry fun grant_manager(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut ManagerWhitelist, arg2: address, arg3: ManagerScope, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        do_grant_manager(0x2::object::id<0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter>(arg0), arg1, arg2, arg3, 0x2::tx_context::sender(arg5), arg4);
    }
    ...
    entry fun grant_manager_scope_via_hub(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::CharacterHub, arg1: &mut ManagerWhitelist, arg2: address, arg3: bool, arg4: bool, arg5: bool, arg6: bool, arg7: bool, arg8: &0x2::clock::Clock, arg9: &0x2::tx_context::TxContext) {
        let v0 = ManagerScope{
            edit_persona     : arg3,
            set_pricing_mode : arg4,
            manage_passwords : arg5,
        ...
        grant_manager_via_hub(arg0, arg1, arg2, v0, arg8, arg9);
    }

    entry fun grant_manager_via_hub(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::CharacterHub, arg1: &mut ManagerWhitelist, arg2: address, arg3: ManagerScope, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_hub_owner(arg0, 0x2::tx_context::sender(arg5));
        do_grant_manager(0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::hub_character_id(arg0), arg1, arg2, arg3, 0x2::tx_context::sender(arg5), arg4);
    }
    ...
    entry fun revoke_manager(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut ManagerWhitelist, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_owner(arg0, 0x2::tx_context::sender(arg4));
        do_revoke_manager(0x2::object::id<0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter>(arg0), arg1, arg2, 0x2::tx_context::sender(arg4), arg3);
    }

    entry fun revoke_manager_via_hub(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::CharacterHub, arg1: &mut ManagerWhitelist, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        do_revoke_manager(0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::hub_character_id(arg0), arg1, arg2, 0x2::tx_context::sender(arg4), arg3);
    }
