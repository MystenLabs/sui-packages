module 0xe3c1f1104d1d413ad884ed6d136a70c78565d83b5a65a07cb1f1e86aab48f36::asset_forwarder {
    ...
    public fun executed_i_relay_message(arg0: &mut AssetForwarder, arg1: IRelayMessageArgsWithoutCoin, arg2: vector<u8>, arg3: bool) {
        ...
        0xe3c1f1104d1d413ad884ed6d136a70c78565d83b5a65a07cb1f1e86aab48f36::events::emit_funds_paid_with_message_event(v1, v2, arg0.deposit_nonce, v3, v4, v5, v6, arg2, arg3, v7);
    }
    ...
    public fun get_handler_message_args<T0>(arg0: &AssetForwarder, arg1: IRelayMessageArgsWithCoin<T0>, arg2: &mut 0x2::tx_context::TxContext) : (IRelayMessageArgsWithoutCoin, 0x2::coin::Coin<T0>, 0x1::string::String, vector<u8>) {
        ...
        let v10 = v9;
        0x2::object::delete(v0);
        let v11 = IRelayMessageArgsWithoutCoin{
    ...
    public entry fun i_deposit<T0>(arg0: &mut AssetForwarder, arg1: 0x2::coin::Coin<T0>, arg2: u128, arg3: u256, arg4: address, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) : u256 {
        ...
        arg0.deposit_nonce = arg0.deposit_nonce + 1;
        0xe3c1f1104d1d413ad884ed6d136a70c78565d83b5a65a07cb1f1e86aab48f36::events::emit_funds_deposited_event(arg2, v0, arg5, arg3, arg0.deposit_nonce, v1, arg7, arg4, arg6);
        arg0.deposit_nonce
    }
    ...
    public entry fun i_deposit_info_fee<T0>(arg0: &mut AssetForwarder, arg1: 0x2::coin::Coin<T0>, arg2: u256, arg3: &mut 0x2::tx_context::TxContext) : u256 {
        ...
        arg0.deposit_nonce = arg0.deposit_nonce + 1;
        0xe3c1f1104d1d413ad884ed6d136a70c78565d83b5a65a07cb1f1e86aab48f36::events::emit_deposit_info_update_event(v1, v0, arg2, arg0.deposit_nonce, false, 0x2::tx_context::sender(arg3));
        arg0.deposit_nonce
    }
    ...
    public entry fun i_deposit_info_withdraw(arg0: &mut AssetForwarder, arg1: u256, arg2: &mut 0x2::tx_context::TxContext) : u256 {
        when_not_paused(arg0);
        arg0.deposit_nonce = arg0.deposit_nonce + 1;
        0xe3c1f1104d1d413ad884ed6d136a70c78565d83b5a65a07cb1f1e86aab48f36::events::emit_deposit_info_update_event(0x1::string::utf8(b""), 0, arg1, arg0.deposit_nonce, true, 0x2::tx_context::sender(arg2));
        arg0.deposit_nonce
    }
    ...
    public entry fun i_deposit_message<T0>(arg0: &mut AssetForwarder, arg1: 0x2::coin::Coin<T0>, arg2: u128, arg3: u256, arg4: address, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: &mut 0x2::tx_context::TxContext) : u256 {
        ...
        arg0.deposit_nonce = arg0.deposit_nonce + 1;
        0xe3c1f1104d1d413ad884ed6d136a70c78565d83b5a65a07cb1f1e86aab48f36::events::emit_funds_deposited_with_message_event(arg2, v0, arg5, arg3, arg0.deposit_nonce, v1, arg7, arg4, arg6, arg8);
        arg0.deposit_nonce
    }

    public entry fun i_relay<T0>(arg0: &mut AssetForwarder, arg1: 0x2::coin::Coin<T0>, arg2: vector<u8>, arg3: u256, arg4: address, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        when_not_paused(arg0);
        let v0 = 0x2::coin::value<T0>(&arg1);
        is_in_limit(arg0, v0);
        let v1 = 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        let v2 = 0xe3c1f1104d1d413ad884ed6d136a70c78565d83b5a65a07cb1f1e86aab48f36::helper::get_i_relay_msg_hash(v0, arg2, arg3, v1, arg4, 0x2::object::uid_to_bytes(&arg0.id));
        ...
        arg0.deposit_nonce = arg0.deposit_nonce + 1;
        0xe3c1f1104d1d413ad884ed6d136a70c78565d83b5a65a07cb1f1e86aab48f36::events::emit_funds_paid_event(v2, 0x2::tx_context::sender(arg6), arg0.deposit_nonce, arg3, arg2, v1, v0, arg5);
    }

    public entry fun i_relay_message<T0>(arg0: &mut AssetForwarder, arg1: 0x2::coin::Coin<T0>, arg2: vector<u8>, arg3: u256, arg4: vector<u8>, arg5: vector<u8>, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        when_not_paused(arg0);
        let v0 = 0x2::coin::value<T0>(&arg1);
        is_in_limit(arg0, v0);
        let v1 = 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        let v2 = 0xe3c1f1104d1d413ad884ed6d136a70c78565d83b5a65a07cb1f1e86aab48f36::helper::get_i_relay_message_msg_hash(v0, arg2, arg3, v1, arg4, arg5, 0x2::object::uid_to_bytes(&arg0.id));
        assert!(!0x2::table::contains<vector<u8>, bool>(&arg0.execute_record, v2), 3);
        let (_, v4) = 0xe3c1f1104d1d413ad884ed6d136a70c78565d83b5a65a07cb1f1e86aab48f36::helper::get_handler_info(&arg4);
        let v5 = IRelayMessageArgsWithCoin<T0>{
            id                       : 0x2::object::new(arg7),
            creator                  : 0x2::tx_context::sender(arg7),
            message_hash             : v2,
            forwarder                : 0x2::tx_context::sender(arg7),
            deposit_id               : arg3,
            src_chain_id             : arg2,
            dest_token               : v1,
            packet                   : arg5,
            forwarder_router_address : arg6,
            coin                     : arg1,
        };
    ...
    public entry fun withdraw_funds<T0>(arg0: &mut AssetForwarder, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xe3c1f1104d1d413ad884ed6d136a70c78565d83b5a65a07cb1f1e86aab48f36::helper::get_user_balances_key(arg1, &v0);
