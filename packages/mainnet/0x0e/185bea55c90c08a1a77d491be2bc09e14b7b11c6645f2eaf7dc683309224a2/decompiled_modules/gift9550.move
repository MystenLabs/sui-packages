module 0xe185bea55c90c08a1a77d491be2bc09e14b7b11c6645f2eaf7dc683309224a2::gift9550 {
    struct GIFT9550 has drop {
        dummy_field: bool,
    }

    struct TICKET_9550 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9550(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9550>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9550>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9550, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9550>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9550>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9550>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9550>>(v5, 0x2::tx_context::sender(arg1));
    }
