module 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::governance {
    ...
    public(friend) fun add_proposal(arg0: &mut Governance, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: 0x2::object::ID) {
        ...
        assert!(arg3 <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::max_stake_required(), 6);
        if (arg0.stable) {
    ...
    public(friend) fun adjust_vote(arg0: &mut Governance, arg1: 0x1::option::Option<0x2::object::ID>, arg2: 0x1::option::Option<0x2::object::ID>, arg3: u64) {
        ...
        arg0.next_trade_params = leader_above_quorum_params(arg0);
    }
    ...
    fun leader_above_quorum_params(arg0: &Governance) : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::trade_params::TradeParams {
        let v0 = arg0.quorum;
        let v1 = 0x1::option::none<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::trade_params::TradeParams>();
        let v2 = 0;
        while (v2 < 0x2::vec_map::length<0x2::object::ID, Proposal>(&arg0.proposals)) {
            let (_, v4) = 0x2::vec_map::get_entry_by_idx<0x2::object::ID, Proposal>(&arg0.proposals, v2);
            if (v4.votes > v0) {
                v0 = v4.votes;
                v1 = 0x1::option::some<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::trade_params::TradeParams>(to_trade_params(v4));
            };
            v2 = v2 + 1;
        };
        let v5 = v1;
        if (0x1::option::is_some<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::trade_params::TradeParams>(&v5)) {
            0x1::option::destroy_some<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::trade_params::TradeParams>(v5)
        } else {
            0x1::option::destroy_none<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::trade_params::TradeParams>(v5);
            arg0.trade_params
        }
    }
    ...
    public(friend) fun next_trade_params(arg0: &Governance) : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::trade_params::TradeParams {
