module 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::registry {
    ...
    struct DeepbookCorePauseCap has store, key {
        id: 0x2::object::UID,
    }
    ...
    struct AllowedPauseCapsKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    struct AppKeyV2<phantom T0: drop> has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public(friend) fun add_balance_manager(arg0: &mut Registry, arg1: address, arg2: 0x2::object::ID) {
        ...
        assert!(0x2::vec_set::length<0x2::object::ID>(v2) <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::max_balance_managers(), 8);
    }
    ...
    public fun add_stablecoin<T0>(arg0: &mut Registry, arg1: &DeepbookAdminCap) {
        ...
        if (!0x2::dynamic_field::exists_<StableCoinKey>(&arg0.id, v1)) {
            ...
            assert!(!0x2::vec_set::contains<0x1::type_name::TypeName>(v4, &v0), 6);
            0x2::vec_set::insert<0x1::type_name::TypeName>(v4, v0);
        };
    }

    public fun allowed_pause_caps(arg0: &Registry) : 0x2::vec_set::VecSet<0x2::object::ID> {
        let v0 = AllowedPauseCapsKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<AllowedPauseCapsKey>(&arg0.id, v0)) {
            let v2 = AllowedPauseCapsKey{dummy_field: false};
            *0x2::dynamic_field::borrow<AllowedPauseCapsKey, 0x2::vec_set::VecSet<0x2::object::ID>>(&arg0.id, v2)
        } else {
    ...
    public(friend) fun allowed_versions(arg0: &Registry) : 0x2::vec_set::VecSet<u64> {
        0x2::versioned::load_value<RegistryInner>(&arg0.inner).allowed_versions
    }

    public fun assert_app_is_authorized<T0: drop>(arg0: &Registry) {
        let v0 = AppKeyV2<T0>{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<AppKeyV2<T0>>(&arg0.id, v0), 9);
    }

    public fun authorize_app<T0: drop>(arg0: &mut Registry, arg1: &DeepbookAdminCap) {
        let v0 = AppKeyV2<T0>{dummy_field: false};
        0x2::dynamic_field::add<AppKeyV2<T0>, bool>(&mut arg0.id, v0, true);
    }

    public fun deauthorize_app<T0: drop>(arg0: &mut Registry, arg1: &DeepbookAdminCap) : bool {
        let v0 = AppKeyV2<T0>{dummy_field: false};
        0x2::dynamic_field::remove<AppKeyV2<T0>, bool>(&mut arg0.id, v0)
    }
    ...
    public fun disable_version_pause_cap(arg0: &mut Registry, arg1: u64, arg2: &DeepbookCorePauseCap) {
        let v0 = AllowedPauseCapsKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<AllowedPauseCapsKey>(&arg0.id, v0), 10);
        let v1 = AllowedPauseCapsKey{dummy_field: false};
        let v2 = 0x2::object::uid_to_inner(&arg2.id);
        assert!(0x2::vec_set::contains<0x2::object::ID>(0x2::dynamic_field::borrow<AllowedPauseCapsKey, 0x2::vec_set::VecSet<0x2::object::ID>>(&arg0.id, v1), &v2), 10);
        let v3 = 0x2::versioned::load_value_mut<RegistryInner>(&mut arg0.inner);
        assert!(0x2::vec_set::contains<u64>(&v3.allowed_versions, &arg1), 4);
        0x2::vec_set::remove<u64>(&mut v3.allowed_versions, &arg1);
    }
    ...
    public fun mint_pause_cap(arg0: &mut Registry, arg1: &DeepbookAdminCap, arg2: &mut 0x2::tx_context::TxContext) : DeepbookCorePauseCap {
        let v0 = 0x2::object::new(arg2);
        let v1 = AllowedPauseCapsKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<AllowedPauseCapsKey>(&arg0.id, v1)) {
            let v2 = AllowedPauseCapsKey{dummy_field: false};
            0x2::dynamic_field::add<AllowedPauseCapsKey, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.id, v2, 0x2::vec_set::empty<0x2::object::ID>());
        };
        let v3 = AllowedPauseCapsKey{dummy_field: false};
        0x2::vec_set::insert<0x2::object::ID>(0x2::dynamic_field::borrow_mut<AllowedPauseCapsKey, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.id, v3), 0x2::object::uid_to_inner(&v0));
        DeepbookCorePauseCap{id: v0}
    }
    ...
    public fun remove_stablecoin<T0>(arg0: &mut Registry, arg1: &DeepbookAdminCap) {
        ...
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = StableCoinKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<StableCoinKey>(&arg0.id, v1), 7);
        let v2 = StableCoinKey{dummy_field: false};
        let v3 = 0x2::dynamic_field::borrow_mut<StableCoinKey, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>(&mut arg0.id, v2);
        assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(v3, &v0), 7);
        0x2::vec_set::remove<0x1::type_name::TypeName>(v3, &v0);
    }

    public fun revoke_pause_cap(arg0: &mut Registry, arg1: &DeepbookAdminCap, arg2: 0x2::object::ID) {
        let v0 = AllowedPauseCapsKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<AllowedPauseCapsKey>(&arg0.id, v0), 10);
        let v1 = AllowedPauseCapsKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow_mut<AllowedPauseCapsKey, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.id, v1);
        assert!(0x2::vec_set::contains<0x2::object::ID>(v2, &arg2), 10);
        0x2::vec_set::remove<0x2::object::ID>(v2, &arg2);
    }
