module 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager {
    ...
    public fun new_with_custom_owner_caps_v2<T0: drop>(arg0: T0, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::registry::Registry, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : (BalanceManager, DepositCap, WithdrawCap, TradeCap) {
        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::registry::assert_app_is_authorized<T0>(arg1);
        let v0 = new_with_custom_owner(arg2, arg3);
        let v1 = &mut v0;
        let v2 = mint_deposit_cap_internal(v1, arg3);
        let v3 = &mut v0;
        let v4 = mint_withdraw_cap_internal(v3, arg3);
        let v5 = &mut v0;
        (v0, v2, v4, mint_trade_cap_internal(v5, arg3))
    }
