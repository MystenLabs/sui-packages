module 0xeef9096767fd9a4f696b45f60afd8de202f4f35c2ccc4ba50a36c43b8de7399::cnsnft5984 {
    struct CNSNFT5984 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5984, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5984>(arg0, arg1);
