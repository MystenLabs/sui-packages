module 0xe4ac2512312be5f9909354a16e2e2948ed711f717fc038f758db1a1b3cb4182::gift9386 {
    struct GIFT9386 has drop {
        dummy_field: bool,
    }

    struct TICKET_9386 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9386(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9386>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9386>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9386, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9386>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9386>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9386>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9386>>(v5, 0x2::tx_context::sender(arg1));
    }
