module 0xe2c66e8516b740e484bb2a2c01a61e5aa893129f1e1f0c14df1dab6e3b023aa::reward2268 {
    struct REWARD2268 has drop {
        dummy_field: bool,
    }

    struct TICKET_2268 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2268(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2268>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2268>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2268, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2268>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2268>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2268>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2268>>(v5, 0x2::tx_context::sender(arg1));
    }
