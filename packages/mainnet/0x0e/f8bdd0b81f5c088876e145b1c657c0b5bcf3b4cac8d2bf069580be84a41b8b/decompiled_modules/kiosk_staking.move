module 0xef8bdd0b81f5c088876e145b1c657c0b5bcf3b4cac8d2bf069580be84a41b8b::kiosk_staking {
    ...
    public entry fun stake_finalize<T0: store + key>(arg0: &mut Global, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.enabled, 1);
        ...
        let v5 = 0x2::object::id<0x2::kiosk::KioskOwnerCap>(arg4);
        ...
        0x2::table::add<0x2::object::ID, StakedItemInfo>(&mut arg0.staked, arg2, v6);
        inc_active(arg0, v2);
        let v7 = Staked{
            kiosk            : v1,
            item             : arg2,
