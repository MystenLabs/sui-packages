module 0xd4e30c04858a3643e9e18749e801381ff25e24bcf30fc4a13ab688001464a5ba::event_nft {
    ...
    fun init(arg0: EVENT_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<EventNFT>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://aggregator.walrus.space/v1/{image_cid}"));
