module 0xd479f930fa84d9f4fd5f4e8986ae80039f9f8b9978aa84c8f77e153e04e4b199::reward8864 {
    struct REWARD8864 has drop {
        dummy_field: bool,
    }

    struct TICKET_8864 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8864(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8864>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8864>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8864, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8864>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8864>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8864>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8864>>(v5, 0x2::tx_context::sender(arg1));
    }
