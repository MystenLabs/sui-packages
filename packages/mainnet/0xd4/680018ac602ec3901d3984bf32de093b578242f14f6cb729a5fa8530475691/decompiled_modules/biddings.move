module 0xd4680018ac602ec3901d3984bf32de093b578242f14f6cb729a5fa8530475691::biddings {
    ...
    public fun ob_accept_bid<T0: store + key>(arg0: &mut Store, arg1: 0x2::object::ID, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::dynamic_object_field::remove<0x2::object::ID, Bid>(&mut arg0.id, arg1);
        let v1 = 0x1::type_name::get<T0>();
        assert!(*0x1::type_name::borrow_string(&v1) == v0.nft_type, 1);
        let v2 = 0x2::object::id<T0>(&arg2);
