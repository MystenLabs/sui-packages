module 0x295c809ee7cb53af762d80e61f39d9a899481c7798f276456211f8c89a10ef59::campaign {
    ...
    public entry fun delete_campaign(arg0: &AdminCap, arg1: Campaign) {
        ...
        0x2::table::drop<address, bool>(v4);
    ...
    public fun remove_activities(arg0: &AdminCap, arg1: &mut Campaign, arg2: address) : 0x2::table::Table<u64, bool> {
        0x2::table::remove<address, 0x2::table::Table<u64, bool>>(&mut arg1.activities, arg2)
    }

    public fun remove_activities_update(arg0: &AdminCap, arg1: &mut Campaign, arg2: address) {
        0x2::table::drop<u64, bool>(0x2::table::remove<address, 0x2::table::Table<u64, bool>>(&mut arg1.activities, arg2));
    }

    public fun remove_activities_update_last(arg0: &mut Campaign, arg1: address) {
        0x2::table::drop<u64, bool>(0x2::table::remove<address, 0x2::table::Table<u64, bool>>(&mut arg0.activities, arg1));
    }

    public fun remove_referees(arg0: &mut Campaign, arg1: address) {
        0x2::table::remove<address, bool>(&mut arg0.total_referees, arg1);
    }

    public fun remove_referrals(arg0: &AdminCap, arg1: &mut Campaign, arg2: address) : 0x2::table::Table<address, bool> {
        0x2::table::remove<address, 0x2::table::Table<address, bool>>(&mut arg1.referrals, arg2)
    }

    public fun remove_referrals_update(arg0: &AdminCap, arg1: &mut Campaign, arg2: address) {
        0x2::table::drop<address, bool>(0x2::table::remove<address, 0x2::table::Table<address, bool>>(&mut arg1.referrals, arg2));
    }

    public fun remove_referrals_update_last(arg0: &mut Campaign, arg1: address) {
        0x2::table::drop<address, bool>(0x2::table::remove<address, 0x2::table::Table<address, bool>>(&mut arg0.referrals, arg1));
    }
