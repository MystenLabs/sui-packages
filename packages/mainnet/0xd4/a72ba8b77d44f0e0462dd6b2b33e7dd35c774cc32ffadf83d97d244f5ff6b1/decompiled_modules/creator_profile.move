module 0xd4a72ba8b77d44f0e0462dd6b2b33e7dd35c774cc32ffadf83d97d244f5ff6b1::creator_profile {
    ...
    public entry fun create_profile(arg0: &0xd4a72ba8b77d44f0e0462dd6b2b33e7dd35c774cc32ffadf83d97d244f5ff6b1::user_profile::UserProfile, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(0xd4a72ba8b77d44f0e0462dd6b2b33e7dd35c774cc32ffadf83d97d244f5ff6b1::user_profile::get_user(arg0) == v0, 1);
        assert!(0xd4a72ba8b77d44f0e0462dd6b2b33e7dd35c774cc32ffadf83d97d244f5ff6b1::user_profile::is_creator(arg0), 4);
        let v2 = CreatorProfile{
            id                : 0x2::object::new(arg4),
            creator           : v0,
            user_profile_id   : 0x2::object::id<0xd4a72ba8b77d44f0e0462dd6b2b33e7dd35c774cc32ffadf83d97d244f5ff6b1::user_profile::UserProfile>(arg0),
            handle            : arg1,
            banner_url        : arg2,
