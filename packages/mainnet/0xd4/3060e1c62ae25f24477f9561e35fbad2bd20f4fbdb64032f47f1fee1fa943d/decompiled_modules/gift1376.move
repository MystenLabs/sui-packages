module 0xd43060e1c62ae25f24477f9561e35fbad2bd20f4fbdb64032f47f1fee1fa943d::gift1376 {
    struct GIFT1376 has drop {
        dummy_field: bool,
    }

    struct TICKET_1376 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1376(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1376>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1376>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1376, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1376>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1376>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1376>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1376>>(v5, 0x2::tx_context::sender(arg1));
    }
