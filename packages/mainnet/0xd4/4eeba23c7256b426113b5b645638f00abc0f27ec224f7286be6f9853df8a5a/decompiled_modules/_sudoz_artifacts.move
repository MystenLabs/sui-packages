module 0xd44eeba23c7256b426113b5b645638f00abc0f27ec224f7286be6f9853df8a5a::_sudoz_artifacts {
    struct _SUDOZ_ARTIFACTS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _SUDOZ_ARTIFACTS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_SUDOZ_ARTIFACTS>(arg0, arg1);
