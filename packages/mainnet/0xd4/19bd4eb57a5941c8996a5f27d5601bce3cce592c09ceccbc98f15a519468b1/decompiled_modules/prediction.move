module 0xd419bd4eb57a5941c8996a5f27d5601bce3cce592c09ceccbc98f15a519468b1::prediction {
    ...
    public entry fun claim(arg0: &mut Rounds, arg1: u64, arg2: &mut Epoch, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0.upordown) {
            let v1 = *0x2::table::borrow<address, u256>(&v0.upaddress, 0x2::tx_context::sender(arg3));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, ((v1 * v0.downamount / v0.upamount / 95 + v1) as u64), arg3), 0x2::tx_context::sender(arg3));
            ...
            let v2 = *0x2::table::borrow<address, u256>(&v0.downaddress, 0x2::tx_context::sender(arg3));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, ((v2 * v0.upamount / v0.downamount / 95 + v2) as u64), arg3), 0x2::tx_context::sender(arg3));
