module 0xd42725b4eb5491d90c2fd0022d97dcca94ac2655855881c48b2dbd2221df2197::ATLANTIS {
    ...
    fun init(arg0: ATLANTIS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<ATLANTIS>(arg0, 9, b"DOG", b"DOG TRUMP MILLIONS", b"DOG TRUMP MILLIONS AI", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
