module 0x94229b0b27134ca6ca15bce88a66d00deaba7962b25b0c812a7555865ff4daa3::mint_box {
    ...
    public(friend) fun get(arg0: &mut MintBox, arg1: &mut 0x94229b0b27134ca6ca15bce88a66d00deaba7962b25b0c812a7555865ff4daa3::pseudorandom::PseudoRandomCounter, arg2: &mut 0x2::tx_context::TxContext) : u256 {
        assert!(!is_empty(arg0), 2);
        let v0 = &mut arg0.box_ids;
        let v1 = 0x1::vector::empty<u8>();
        0x1::vector::append<u8>(&mut v1, 0x2::object::uid_to_bytes(&arg0.id));
        let v2 = 0x94229b0b27134ca6ca15bce88a66d00deaba7962b25b0c812a7555865ff4daa3::pseudorandom::rand(arg1, v1, arg2);
        let v3 = 0x94229b0b27134ca6ca15bce88a66d00deaba7962b25b0c812a7555865ff4daa3::pseudorandom::select_u64(0x1::vector::length<0x2::object::ID>(v0), &v2);
        ...
        let v5 = 0x94229b0b27134ca6ca15bce88a66d00deaba7962b25b0c812a7555865ff4daa3::pseudorandom::rand(arg1, v1, arg2);
        ...
        0x1::vector::swap_remove<u256>(v4, 0x94229b0b27134ca6ca15bce88a66d00deaba7962b25b0c812a7555865ff4daa3::pseudorandom::select_u64(0x1::vector::length<u256>(v4), &v5))
    }
