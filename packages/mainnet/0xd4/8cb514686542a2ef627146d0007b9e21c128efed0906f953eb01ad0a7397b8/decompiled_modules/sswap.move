module 0xd48cb514686542a2ef627146d0007b9e21c128efed0906f953eb01ad0a7397b8::sswap {
    struct SSWAP has drop {
        dummy_field: bool,
    }

    fun init(arg0: SSWAP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SSWAP>(arg0, 9, b"SSWAP", b"SuiSwap", b"SuiSwap protocol reward token. Fixed supply of 1,000,000,000 SSWAP, minted once at publish.", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
