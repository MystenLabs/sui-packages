        ...
        if (v0 >= v3) {
            ...
            while (0x2::balance::value<0x2::sui::SUI>(&arg11) < v1) {
                ...
                if (0x2::balance::value<0x2::sui::SUI>(&arg11) >= (v7 as u64)) {
                    ...
                    0x2::balance::join<0x2::sui::SUI>(&mut v8, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg11));
                };
                let v9 = get_withdraw_amt(arg0, arg1, arg2, arg5, 0x2::balance::value<0x2::sui::SUI>(&v8));
                let (v10, v11) = navi_repay_and_withdraw_collateral(arg0, arg4, arg5, arg6, arg7, arg8, arg9, arg10, v8, v9, arg13);
                0x2::balance::join<0x2::sui::SUI>(&mut arg11, volo_unstake(arg1, arg2, arg3, v11, arg13));
                0x2::balance::join<0x2::sui::SUI>(&mut arg11, v10);
            };
        };
        let v12 = 0x2::balance::value<0x2::sui::SUI>(&arg11);
        assert!(v12 >= v1, 104);
        add_to_collected_asset<0x2::sui::SUI>(arg0, 0x2::balance::split<0x2::sui::SUI>(&mut arg11, v12 - v1));
        arg11
    }
