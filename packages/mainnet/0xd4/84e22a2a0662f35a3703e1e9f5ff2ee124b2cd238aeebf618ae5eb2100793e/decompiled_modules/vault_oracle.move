module 0x1a377342aa18c9c5f1f09c3c4cc206fab70aa3ab90eacb193488ba0dd0db4d4::vault_oracle {
    ...
    struct DebugNegative has copy, drop {
        number: u64,
    }
    ...
    public fun get_current_price(arg0: &OracleConfig, arg1: &0x2::clock::Clock, arg2: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator) : u256 {
        ...
        if (v2 > v0) {
            let v3 = DebugNegative{number: v2 - v0};
            0x2::event::emit<DebugNegative>(v3);
        };
        assert!(1000 + v0 - v2 < arg0.update_interval, 1002);
