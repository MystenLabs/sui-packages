module 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::main {
    ...
    public fun cancel_order<T0, T1>(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
    ...
    public fun claim_all_output<T0>(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: &Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        withdraw_output<T0>(arg0, arg1, arg2, arg3, arg4)
    }

    public fun claim_all_refundable_input<T0>(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: &Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        validate_global_config(arg0);
    ...
    public fun claim_order<T0, T1>(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        validate_global_config(arg0);
        let Receipt {
            id       : v0,
            order_id : v1,
    ...
    public fun create_order<T0, T1>(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: u8, arg5: u64, arg6: u64, arg7: u8, arg8: u64, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : Receipt {
        validate_global_config(arg0);
        assert!(arg5 > 0, 10);
        assert!(arg3 > 0, 11);
    ...
    public fun end_execute_order<T0, T1>(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::ExecTicket, arg3: 0x2::coin::Coin<T1>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        validate_global_config(arg0);
        let v0 = 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::get_order_id(&arg2);
        ...
        let v2 = 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::get_cycle_number(&arg2);
        ...
        let v5 = 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::get_execution_time(&arg2);
        ...
        let v6 = OrderFilled{
            recipe_id            : v0,
            cycle_number         : 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::get_cycle_number(&arg2),
            fulfilled_time_ms    : v5,
            from_coin_type       : 0x1::type_name::with_defining_ids<T0>(),
            to_coin_type         : 0x1::type_name::with_defining_ids<T1>(),
            amount_in_borrowed   : 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::get_amount_borrowed(&arg2),
            amount_in_spent      : 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::get_amount_in_max(&arg2),
            amount_out           : v3,
            protocol_fee_charged : 0,
        };
        0x2::event::emit<OrderFilled>(v6);
        let (_, _, _, _, _, _, _, _) = 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::destroy_exec_ticket(arg2);
    }
    ...
    public fun operator_end_execute_and_payout<T0, T1>(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::OperatorCap, arg1: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig, arg2: &mut OrderRegistry, arg3: 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::ExecTicket, arg4: 0x2::coin::Coin<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        validate_global_config(arg1);
        let v0 = 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::get_order_id(&arg3);
        assert!(0x2::table::contains<address, Order>(&arg2.orders, v0), 37);
        let v1 = 0x2::table::borrow_mut<address, Order>(&mut arg2.orders, v0);
        validate_order_types<T0, T1>(v1);
        assert!(v1.executing_flag, 27);
        let v2 = 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::get_cycle_number(&arg3);
        assert!(v2 > v1.current_cycle, 27);
        let v3 = 0x2::coin::value<T1>(&arg4);
        assert!(v3 >= v1.min_amount_out, 25);
        assert!(v3 <= v1.max_amount_out, 25);
        let v4 = 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::get_execution_time(&arg3);
        ...
        let v5 = OrderFilled{
            ...
            from_coin_type       : 0x1::type_name::with_defining_ids<T0>(),
            to_coin_type         : 0x1::type_name::with_defining_ids<T1>(),
            amount_in_borrowed   : 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::get_amount_borrowed(&arg3),
            amount_in_spent      : 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::get_amount_in_max(&arg3),
            amount_out           : v3,
            protocol_fee_charged : 0,
        };
        ...
        let (_, _, _, _, _, _, _, _) = 0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::destroy_exec_ticket(arg3);
    }

    public fun operator_finalize_completed<T0, T1>(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::OperatorCap, arg1: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig, arg2: &mut OrderRegistry, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        validate_global_config(arg1);
    ...
    public fun operator_refund_missed_cycle_input<T0>(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::OperatorCap, arg1: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig, arg2: &mut OrderRegistry, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        validate_global_config(arg1);
        assert!(0x2::table::contains<address, Order>(&arg2.orders, arg3), 37);
        let v0 = 0x2::table::borrow_mut<address, Order>(&mut arg2.orders, arg3);
        assert!(v0.status == 0, 33);
    ...
    public fun start_execute_order<T0>(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::OperatorCap, arg1: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig, arg2: &mut OrderRegistry, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::ExecTicket, 0x2::coin::Coin<T0>) {
        validate_global_config(arg1);
        assert!(0x2::table::contains<address, Order>(&arg2.orders, arg3), 37);
        let v0 = 0x2::table::borrow_mut<address, Order>(&mut arg2.orders, arg3);
        ...
        (0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::types::new_exec_ticket(arg3, v5, v5, v1, v2, v3, v4, v1), 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v6, v5), arg5))
    }
    ...
    fun validate_global_config(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig) {
        assert!(!0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::is_paused(arg0), 1);
        assert!(0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::get_version(arg0) == 2, 2);
    }
    ...
    public fun withdraw_output<T0>(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: &Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        validate_global_config(arg0);
        assert!(0x2::table::contains<address, Order>(&arg1.orders, arg2.order_id), 37);
        let v0 = 0x2::table::borrow_mut<address, Order>(&mut arg1.orders, arg2.order_id);
        validate_order_ownership(v0, arg4);
    ...
    public fun withdraw_output_amount<T0>(arg0: &0xd44d9ed3457a536d2ef602c34c7d576fa1ef657743c22182652d9d0a7d9fc3ae::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: &Receipt, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        validate_global_config(arg0);
        assert!(0x2::table::contains<address, Order>(&arg1.orders, arg2.order_id), 37);
        let v0 = 0x2::table::borrow_mut<address, Order>(&mut arg1.orders, arg2.order_id);
