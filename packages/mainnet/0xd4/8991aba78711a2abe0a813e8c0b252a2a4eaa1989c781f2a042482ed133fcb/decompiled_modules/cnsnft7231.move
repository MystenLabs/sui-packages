module 0xd48991aba78711a2abe0a813e8c0b252a2a4eaa1989c781f2a042482ed133fcb::cnsnft7231 {
    struct CNSNFT7231 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7231, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7231>(arg0, arg1);
