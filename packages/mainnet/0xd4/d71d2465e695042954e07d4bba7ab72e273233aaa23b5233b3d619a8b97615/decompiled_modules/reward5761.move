module 0xd4d71d2465e695042954e07d4bba7ab72e273233aaa23b5233b3d619a8b97615::reward5761 {
    struct REWARD5761 has drop {
        dummy_field: bool,
    }

    struct TICKET_5761 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5761(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5761>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5761>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5761, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5761>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5761>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5761>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5761>>(v5, 0x2::tx_context::sender(arg1));
    }
