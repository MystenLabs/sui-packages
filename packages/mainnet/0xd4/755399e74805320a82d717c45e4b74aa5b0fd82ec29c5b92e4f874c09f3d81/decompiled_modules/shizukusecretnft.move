module 0xd4755399e74805320a82d717c45e4b74aa5b0fd82ec29c5b92e4f874c09f3d81::shizukusecretnft {
    ...
    public fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<ShizukuSecretNFT>(v0, 0x2::tx_context::sender(arg3));
    }
