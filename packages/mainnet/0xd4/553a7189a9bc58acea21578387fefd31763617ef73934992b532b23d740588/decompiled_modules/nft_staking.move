module 0xd4553a7189a9bc58acea21578387fefd31763617ef73934992b532b23d740588::nft_staking {
    ...
    struct NFTTypeVerified has copy, drop {
        nft_id: 0x2::object::ID,
        nft_type: 0x1::string::String,
        pool_id: 0x2::object::ID,
        is_allowed: bool,
    ...
    struct NFTTypeAdded has copy, drop {
        nft_id: 0x2::object::ID,
        nft_type: 0x1::string::String,
        pool_id: 0x2::object::ID,
    ...
    public entry fun activate_emergency_mode(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: &0x2::clock::Clock) {
    ...
    public entry fun add_collection(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
    ...
    public entry fun add_funds<T0>(arg0: &mut StakingPool, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun add_nft_type_to_allowed<T0: store + key>(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: &T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
        assert!(!arg0.emergency_mode, 25);
        let v0 = 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        let v1 = 0x2::vec_set::contains<0x1::string::String>(&arg0.allowed_collections, &v0);
        if (!v1) {
            0x2::vec_set::insert<0x1::string::String>(&mut arg0.allowed_collections, v0);
        };
        let v2 = NFTTypeAdded{
            nft_id          : 0x2::object::id<T0>(arg2),
            nft_type        : v0,
            pool_id         : 0x2::object::id<StakingPool>(arg0),
            already_allowed : v1,
        };
        0x2::event::emit<NFTTypeAdded>(v2);
    }

    public entry fun add_reward_token<T0>(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
        assert!(!arg0.emergency_mode, 25);
        assert!(arg2 > 0, 15);
        assert!(arg3 > 0, 11);
    ...
    public entry fun batch_stake_nft<T0: store + key>(arg0: &mut StakingPool, arg1: vector<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
    ...
    public entry fun batch_stake_nft_from_kiosk<T0: store + key>(arg0: &mut StakingPool, arg1: vector<T0>, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun batch_unstake_nft<T0: store + key>(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: vector<0x2::object::ID>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : vector<T0> {
        ...
        while (v0 < 0x1::vector::length<0x2::object::ID>(&arg2)) {
            0x1::vector::push_back<T0>(&mut v1, unstake_nft_internal<T0>(arg0, arg1, 0x1::vector::pop_back<0x2::object::ID>(&mut arg2), arg3, arg4));
            v0 = v0 + 1;
        };
    ...
    public entry fun batch_unstake_nft_entry<T0: store + key>(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: vector<0x2::object::ID>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = batch_unstake_nft<T0>(arg0, arg1, arg2, arg3, arg4);
        let v1 = 0;
        while (v1 < 0x1::vector::length<T0>(&v0)) {
            0x2::transfer::public_transfer<T0>(0x1::vector::pop_back<T0>(&mut v0), 0x2::tx_context::sender(arg4));
            v1 = v1 + 1;
        };
        0x1::vector::destroy_empty<T0>(v0);
    }

    public entry fun batch_unstake_nft_to_kiosk<T0: store + key>(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: vector<0x2::object::ID>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun claim_pending_rewards(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun claim_rewards(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.pool_id == 0x2::object::id<StakingPool>(arg0), 18);
    ...
    public entry fun create_pool<T0>(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64, arg6: u64, arg7: u64, arg8: 0x2::coin::Coin<T0>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun deactivate_emergency_mode(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: &0x2::clock::Clock) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
    ...
    public entry fun emergency_unstake_nft<T0: store + key>(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = emergency_unstake_nft_internal<T0>(arg0, arg1, arg2, arg3, arg4);
        0x2::transfer::public_transfer<T0>(v0, 0x2::tx_context::sender(arg4));
    }

    public entry fun emergency_unstake_nft_entry<T0: store + key>(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = emergency_unstake_nft_internal<T0>(arg0, arg1, arg2, arg3, arg4);
        0x2::transfer::public_transfer<T0>(v0, 0x2::tx_context::sender(arg4));
    }

    public fun emergency_unstake_nft_internal<T0: store + key>(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : T0 {
        assert!(arg1.pool_id == 0x2::object::id<StakingPool>(arg0), 18);
    ...
    public entry fun emergency_withdraw_all_funds<T0>(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
        ...
        if (v4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v3, v4), arg3), 0x2::tx_context::sender(arg3));
        };
    }

    public entry fun emergency_withdraw_funds<T0>(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
        assert!(arg2 > 0, 11);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v3, arg2), arg4), 0x2::tx_context::sender(arg4));
    }
    ...
    public entry fun force_unstake_nft<T0: store + key>(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: 0x2::object::ID, arg3: bool, arg4: &PoolOwnerCap, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = force_unstake_nft_internal<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        0x2::transfer::public_transfer<T0>(v0, arg1.staker);
    }

    public entry fun force_unstake_nft_entry<T0: store + key>(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: 0x2::object::ID, arg3: bool, arg4: &PoolOwnerCap, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = force_unstake_nft_internal<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        0x2::transfer::public_transfer<T0>(v0, arg1.staker);
    }

    public fun force_unstake_nft_internal<T0: store + key>(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: 0x2::object::ID, arg3: bool, arg4: &PoolOwnerCap, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : T0 {
    ...
    public entry fun pause_pool(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: &0x2::clock::Clock) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
    ...
    public entry fun remove_reward_token_entry<T0>(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = remove_reward_token<T0>(arg0, arg1, arg2, arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v0, 0x2::tx_context::sender(arg3));
    }

    public entry fun stake_nft<T0: store + key>(arg0: &mut StakingPool, arg1: T0, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 7);
        assert!(!arg0.emergency_mode, 25);
        let v0 = 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        let v1 = 0x2::vec_set::contains<0x1::string::String>(&arg0.allowed_collections, &v0);
        let v2 = v1;
        if (!v1) {
            let v3 = 0x2::vec_set::into_keys<0x1::string::String>(arg0.allowed_collections);
            let v4 = 0;
            let v5 = false;
            while (v4 < 0x1::vector::length<0x1::string::String>(&v3) && !v5) {
                let v6 = string_split(v0, 0x1::string::utf8(b"::"));
                let v7 = string_split(*0x1::vector::borrow<0x1::string::String>(&v3, v4), 0x1::string::utf8(b"::"));
                if (0x1::vector::length<0x1::string::String>(&v6) >= 2 && 0x1::vector::length<0x1::string::String>(&v7) >= 2) {
                    let v8 = 0x1::string::utf8(b"");
                    0x1::string::append(&mut v8, *0x1::vector::borrow<0x1::string::String>(&v6, 0));
                    0x1::string::append(&mut v8, 0x1::string::utf8(b"::"));
                    0x1::string::append(&mut v8, *0x1::vector::borrow<0x1::string::String>(&v6, 1));
                    let v9 = 0x1::string::utf8(b"");
                    0x1::string::append(&mut v9, *0x1::vector::borrow<0x1::string::String>(&v7, 0));
                    0x1::string::append(&mut v9, 0x1::string::utf8(b"::"));
                    0x1::string::append(&mut v9, *0x1::vector::borrow<0x1::string::String>(&v7, 1));
                    v5 = v8 == v9;
                };
                v4 = v4 + 1;
            };
        ...
        assert!(v2, 18);
        let v10 = 0x2::object::id<T0>(&arg1);
        let v11 = 0x2::clock::timestamp_ms(arg2) / 1000;
        let v12 = NFTStake{
            nft_id            : v10,
            nft_type          : v0,
            staked_at         : v11,
            last_reward_claim : v11,
            claimed_rewards   : 0x2::vec_map::empty<0x1::string::String, u64>(),
            from_kiosk        : false,
        };
        let v13 = 0x2::tx_context::sender(arg3);
        if (0x2::dynamic_field::exists_with_type<address, 0x2::object::ID>(&arg0.id, v13)) {
            let v14 = *0x2::dynamic_field::borrow<address, 0x2::object::ID>(&arg0.id, v13);
            let v15 = borrow_mut_user_stake(arg0, v14);
            assert!(!0x2::table::contains<0x2::object::ID, NFTStake>(&v15.staked_nfts, v10), 17);
            0x2::table::add<0x2::object::ID, NFTStake>(&mut v15.staked_nfts, v10, v12);
            v15.total_staked_count = v15.total_staked_count + 1;
            0x2::dynamic_field::add<0x2::object::ID, T0>(&mut v15.id, v10, arg1);
        } else {
            let v16 = UserStake{
            ...
            0x2::table::add<0x2::object::ID, NFTStake>(&mut v16.staked_nfts, v10, v12);
            0x2::dynamic_field::add<0x2::object::ID, T0>(&mut v16.id, v10, arg1);
            0x2::dynamic_field::add<address, 0x2::object::ID>(&mut arg0.id, v13, 0x2::object::id<UserStake>(&v16));
            0x2::transfer::public_share_object<UserStake>(v16);
            arg0.total_unique_stakers = arg0.total_unique_stakers + 1;
        };
        arg0.total_staked_nfts = arg0.total_staked_nfts + 1;
        update_global_stats_nft_staked(v11, arg3);
        let v17 = NFTStaked{
            pool_id    : 0x2::object::id<StakingPool>(arg0),
            staker     : v13,
            nft_id     : v10,
        ...
        0x2::event::emit<NFTStaked>(v17);
    }

    public entry fun stake_nft_from_kiosk<T0: store + key>(arg0: &mut StakingPool, arg1: T0, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 7);
        assert!(!arg0.emergency_mode, 25);
        assert!(0x2::kiosk::owner(arg2) == 0x2::tx_context::sender(arg5), 0);
        let v0 = 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        ...
        assert!(v2, 18);
        let v10 = 0x2::object::id<T0>(&arg1);
        let v11 = 0x2::clock::timestamp_ms(arg4) / 1000;
        let v12 = NFTStake{
            nft_id            : v10,
            nft_type          : v0,
            staked_at         : v11,
        ...
        arg0.total_staked_nfts = arg0.total_staked_nfts + 1;
        update_global_stats_last_claim_time(v11, arg5);
        let v17 = NFTStaked{
            pool_id    : 0x2::object::id<StakingPool>(arg0),
            staker     : v13,
            nft_id     : v10,
    ...
    fun string_split(arg0: 0x1::string::String, arg1: 0x1::string::String) : vector<0x1::string::String> {
        let v0 = 0x1::vector::empty<0x1::string::String>();
        ...
        while (v3 <= v1) {
            let v5 = false;
            if (v3 + v2 <= v1) {
                v5 = 0x1::string::substring(&arg0, v3, v3 + v2) == arg1;
            };
            if (v5 || v3 == v1) {
                0x1::vector::push_back<0x1::string::String>(&mut v0, 0x1::string::substring(&arg0, v4, v3));
                v4 = v3 + v2;
                v3 = v4;
                continue
            };
    ...
    public entry fun unpause_pool(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: &0x2::clock::Clock) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
    ...
    public entry fun unstake_nft<T0: store + key>(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = unstake_nft_internal<T0>(arg0, arg1, arg2, arg3, arg4);
        0x2::transfer::public_transfer<T0>(v0, 0x2::tx_context::sender(arg4));
    }

    public fun unstake_nft_internal<T0: store + key>(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : T0 {
        assert!(arg1.pool_id == 0x2::object::id<StakingPool>(arg0), 18);
        assert!(arg1.staker == 0x2::tx_context::sender(arg4), 0);
        assert!(0x2::table::contains<0x2::object::ID, NFTStake>(&arg1.staked_nfts, arg2), 16);
        let v0 = 0x2::table::remove<0x2::object::ID, NFTStake>(&mut arg1.staked_nfts, arg2);
    ...
    public entry fun unstake_nft_to_kiosk<T0: store + key>(arg0: &mut StakingPool, arg1: &mut UserStake, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::kiosk::owner(arg3) == 0x2::tx_context::sender(arg6), 0);
        0x2::kiosk::place<T0>(arg3, arg4, unstake_nft_internal<T0>(arg0, arg1, arg2, arg5, arg6));
    }
    ...
    public entry fun update_min_staking_period(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: u64) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
        assert!(!arg0.emergency_mode, 25);
    ...
    public entry fun update_reward_rate(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: 0x1::string::String, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
        assert!(!arg0.emergency_mode, 25);
        assert!(arg3 > 0, 15);
    ...
    public entry fun update_total_rewards(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: 0x1::string::String, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
        assert!(!arg0.emergency_mode, 25);
        assert!(arg3 > 0, 11);
        assert!(0x2::vec_map::contains<0x1::string::String, RewardToken>(&arg0.reward_tokens, &arg2), 20);
    ...
    public entry fun update_tvl_stats(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
    ...
    public entry fun verify_nft_type_for_pool<T0: store + key>(arg0: &StakingPool, arg1: &T0, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        let v1 = 0x2::vec_set::contains<0x1::string::String>(&arg0.allowed_collections, &v0);
        let v2 = false;
        if (!v1) {
            let v3 = 0x2::vec_set::into_keys<0x1::string::String>(arg0.allowed_collections);
            let v4 = 0;
            while (v4 < 0x1::vector::length<0x1::string::String>(&v3) && !v2) {
                let v5 = string_split(v0, 0x1::string::utf8(b"::"));
                let v6 = string_split(*0x1::vector::borrow<0x1::string::String>(&v3, v4), 0x1::string::utf8(b"::"));
                if (0x1::vector::length<0x1::string::String>(&v5) >= 2 && 0x1::vector::length<0x1::string::String>(&v6) >= 2) {
                    let v7 = 0x1::string::utf8(b"");
                    0x1::string::append(&mut v7, *0x1::vector::borrow<0x1::string::String>(&v5, 0));
                    0x1::string::append(&mut v7, 0x1::string::utf8(b"::"));
                    0x1::string::append(&mut v7, *0x1::vector::borrow<0x1::string::String>(&v5, 1));
                    let v8 = 0x1::string::utf8(b"");
                    0x1::string::append(&mut v8, *0x1::vector::borrow<0x1::string::String>(&v6, 0));
                    0x1::string::append(&mut v8, 0x1::string::utf8(b"::"));
                    0x1::string::append(&mut v8, *0x1::vector::borrow<0x1::string::String>(&v6, 1));
        ...
        let v9 = v1 || v2;
        let v10 = NFTTypeVerified{
            nft_id              : 0x2::object::id<T0>(arg1),
            nft_type            : v0,
            pool_id             : 0x2::object::id<StakingPool>(arg0),
            is_allowed          : v9,
            allowed_collections : 0x2::vec_set::into_keys<0x1::string::String>(arg0.allowed_collections),
        };
        0x2::event::emit<NFTTypeVerified>(v10);
    }

    public entry fun withdraw_all_funds_entry<T0>(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 0);
        let (_, v1) = get_coin_info<T0>(arg2);
        let v2 = v1;
        assert!(0x2::vec_map::contains<0x1::string::String, RewardToken>(&arg0.reward_tokens, &v2), 20);
        assert!(0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, v2), 5);
        let v3 = 0x2::balance::value<T0>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut arg0.id, v2));
        if (v3 > 0) {
            let v4 = withdraw_funds<T0>(arg0, arg1, v3, arg2, arg3);
    ...
    public entry fun withdraw_funds_entry<T0>(arg0: &mut StakingPool, arg1: &PoolOwnerCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = withdraw_funds<T0>(arg0, arg1, arg2, arg3, arg4);
