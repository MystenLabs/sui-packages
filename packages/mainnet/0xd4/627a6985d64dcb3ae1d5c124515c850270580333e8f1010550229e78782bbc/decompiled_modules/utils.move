module 0x32a06e67e9f0c2fdab8127e20a3c2282ae62ebfdec3f058d248c73c336ea44d8::utils {
    public fun get_description_nft() : vector<u8> {
        b"Become a Monke, match the vibe!"
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/QmZvMf8tbvAVQa2XrWaG1AV8kLUm1euufnuSWMh4jgv41A/"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeifiddyuzka4sx25giflvz2dvux7i46pvgixp4vvtd5ktdry7bqzia/"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/Monkes_NFT"
    }
