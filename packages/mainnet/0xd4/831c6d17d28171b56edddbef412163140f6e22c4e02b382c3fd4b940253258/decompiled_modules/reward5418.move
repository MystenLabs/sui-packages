module 0xd4831c6d17d28171b56edddbef412163140f6e22c4e02b382c3fd4b940253258::reward5418 {
    struct REWARD5418 has drop {
        dummy_field: bool,
    }

    struct TICKET_5418 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5418(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5418>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5418>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5418, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5418>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5418>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5418>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5418>>(v5, 0x2::tx_context::sender(arg1));
    }
