module 0xd41e2649e07d9dc4856afe5d322f2e11c6081e1366b2880322615660605b4459::cnsnft8008 {
    struct CNSNFT8008 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8008, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9701"));
        let v4 = 0x2::package::claim<CNSNFT8008>(arg0, arg1);
