module 0xd4a36f825c6c09cd5ce6c29608069fbab027d916faf8e0e1f0912611f137948b::cnsnft8800 {
    struct CNSNFT8800 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8800, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8800>(arg0, arg1);
