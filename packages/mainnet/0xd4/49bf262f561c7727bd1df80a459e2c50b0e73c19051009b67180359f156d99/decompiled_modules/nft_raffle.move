module 0xd449bf262f561c7727bd1df80a459e2c50b0e73c19051009b67180359f156d99::nft_raffle {
    ...
    public entry fun settle_nft_raffle<T0: store + key>(arg0: &mut NFT_Raffle<T0>, arg1: vector<u8>, arg2: vector<u8>) {
        ...
        0xd449bf262f561c7727bd1df80a459e2c50b0e73c19051009b67180359f156d99::drand_lib::verify_drand_signature(arg1, arg2, arg0.round);
        arg0.status = 1;
        let v0 = 0xd449bf262f561c7727bd1df80a459e2c50b0e73c19051009b67180359f156d99::drand_lib::derive_randomness(arg1);
        let v1 = 0;
        v1 = v1 + 1;
        let v2 = 0x1::vector::length<address>(&arg0.participants);
        0x1::vector::swap<address>(&mut arg0.participants, 0xd449bf262f561c7727bd1df80a459e2c50b0e73c19051009b67180359f156d99::drand_lib::safe_selection(v2, &v0, 0), v2 - 1);
