module 0xd4dd9c6ffe9bff4cd2934cc998701625d12c9b84a5703fb906c22e2b0d5747c5::blackcoin {
    ...
    fun init(arg0: BLACKCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BLACKCOIN>(arg0, 9, b"BlackCoin", b"Black", b"A Sui Network Special Test Coin", 0x1::option::some<0x2::url::Url>(0xd4dd9c6ffe9bff4cd2934cc998701625d12c9b84a5703fb906c22e2b0d5747c5::icon::get_icon_url()), arg1);
