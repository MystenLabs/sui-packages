module 0xd43b1be8c0327bf9ed887578bd621cfbdd7ec8ee7ea1d3df429cd34e88914902::encoder {
    ...
    public fun encode_length(arg0: u64, arg1: u8) : vector<u8> {
        ...
        if (arg0 < 56) {
            ...
            let v1 = 0xd43b1be8c0327bf9ed887578bd621cfbdd7ec8ee7ea1d3df429cd34e88914902::utils::to_bytes_u64_sign(arg0, false);
    ...
    public fun encode_list(arg0: &vector<vector<u8>>, arg1: bool) : vector<u8> {
        ...
        if (0x1::vector::length<vector<u8>>(&v2) > 0) {
            ...
            if (0x1::vector::length<u8>(&v0) <= 55) {
                ...
                let v4 = 0xd43b1be8c0327bf9ed887578bd621cfbdd7ec8ee7ea1d3df429cd34e88914902::utils::to_bytes_u64_sign(0x1::vector::length<u8>(&v0), false);
    ...
    public fun encode_u128(arg0: u128) : vector<u8> {
        let v0 = 0xd43b1be8c0327bf9ed887578bd621cfbdd7ec8ee7ea1d3df429cd34e88914902::utils::to_bytes_u128_sign(arg0, true);
        encode(&v0)
    }

    public fun encode_u32(arg0: u32) : vector<u8> {
        let v0 = 0xd43b1be8c0327bf9ed887578bd621cfbdd7ec8ee7ea1d3df429cd34e88914902::utils::to_bytes_u32_sign(arg0, true);
        encode(&v0)
    }

    public fun encode_u64(arg0: u64) : vector<u8> {
        let v0 = 0xd43b1be8c0327bf9ed887578bd621cfbdd7ec8ee7ea1d3df429cd34e88914902::utils::to_bytes_u64_sign(arg0, true);
        encode(&v0)
    }
