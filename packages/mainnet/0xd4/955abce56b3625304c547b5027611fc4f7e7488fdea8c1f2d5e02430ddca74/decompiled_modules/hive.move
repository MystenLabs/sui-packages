module 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive {
    ...
    struct HiveVault has store, key {
        id: 0x2::object::UID,
        streamer_profile: 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile,
        gems_kraft_cap: 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::HiveGemKraftCap,
        hive_kraft_cap: 0x2::coin::TreasuryCap<HIVE>,
        stream_buzz_cap: 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::ProfileDofOwnershipCapability,
        active_supply: u64,
        genesis_ms: u64,
    }
    ...
    public fun add_bid_for_streamer_buzzes<T0>(arg0: &0x2::clock::Clock, arg1: &mut HiveVault, arg2: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        let v5 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_borrow_mut_from_profile<StreamerBuzzes<T0>>(&arg1.stream_buzz_cap, &mut arg1.streamer_profile, arg6);
        ...
        if (0x2::linked_table::contains<address, BidInfo>(&v5.bid_by_profiles, v0)) {
            ...
            if (v8 < v5.cur_epoch_stream) {
                ...
                let v12 = (0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::math::mul_div_u128((v7 as u128), (v5.tax_on_bid as u128), (10000 as u128)) as u64);
    ...
    public entry fun add_to_stream_buzz<T0>(arg0: &0x2::clock::Clock, arg1: &mut HiveVault, arg2: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_borrow_mut_from_profile<StreamerBuzzes<T0>>(&arg1.stream_buzz_cap, &mut arg1.streamer_profile, arg5);
    ...
    fun authority_check(arg0: &0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg1: address) : (address, 0x1::string::String) {
        let (v0, v1, v2, v3) = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::get_profile_meta_info(arg0);
        if (!v2) {
            assert!(v3 == arg1, 9873);
        };
        (v0, v1)
    ...
    public fun burn_hive_and_return(arg0: &mut HiveVault, arg1: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg2: 0x2::balance::Balance<HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<HIVE> {
        let (v0, _, _, _) = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::get_profile_meta_info(&arg0.streamer_profile);
        let (v4, _, _, _, _, _, _, _) = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::get_following_subscription_info(arg1, v0);
        if (!v4) {
            0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::make_forever_follower(arg0.genesis_ms, arg1, &mut arg0.streamer_profile);
        };
        let v12 = 0x2::tx_context::sender(arg4);
        0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::deposit_gems_in_profile(arg1, burn_hive_and_return_gems(arg0, 0x2::balance::split<HIVE>(&mut arg2, arg3), v12, arg4));
        arg2
    }

    public fun burn_hive_and_return_gems(arg0: &mut HiveVault, arg1: 0x2::balance::Balance<HIVE>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::HiveGems {
        ...
        0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::withdraw_gems_from_profile(&mut arg0.streamer_profile, v0, arg3)
    }

    public entry fun burn_hive_for_gems(arg0: &mut HiveVault, arg1: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg2: 0x2::coin::Coin<HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = burn_hive_and_return(arg0, arg1, 0x2::coin::into_balance<HIVE>(arg2), arg3, arg4);
        0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::coin_helper::destroy_or_transfer_balance<HIVE>(v0, 0x2::tx_context::sender(arg4), arg4);
    }
    ...
    public fun choose_buzzes_for_X_rewards<T0>(arg0: &mut HiveVault, arg1: &0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg2: u64, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let (v0, _) = authority_check(arg1, 0x2::tx_context::sender(arg5));
        let v2 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_borrow_mut_from_profile<StreamerBuzzes<T0>>(&arg0.stream_buzz_cap, &mut arg0.streamer_profile, arg5);
    ...
    public entry fun deploy_hive_stream<T0>(arg0: &0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::config::HiveEntryCap, arg1: &0x2::clock::Clock, arg2: &mut HiveVault, arg3: 0x1::string::String, arg4: 0x1::option::Option<0x1::string::String>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch(arg5);
        let (_, v2, _, _) = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::get_profile_meta_info(&arg2.streamer_profile);
        let v5 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_borrow_mut_from_profile<StreamerBuzzes<T0>>(&arg2.stream_buzz_cap, &mut arg2.streamer_profile, arg5);
        internal_add_to_stream_buzz<T0>(v5, v0, 0x2::clock::timestamp_ms(arg1), v2, arg3, arg4, arg5);
    }

    public fun deposit_gems_for_hive(arg0: &mut HiveVault, arg1: &mut 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::HiveGems, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = deposit_gems_for_hive_and_return(arg0, arg1, arg2, arg3);
        0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::coin_helper::destroy_or_transfer_balance<HIVE>(v0, 0x2::tx_context::sender(arg3), arg3);
    }

    public fun deposit_gems_for_hive_and_return(arg0: &mut HiveVault, arg1: &mut 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::HiveGems, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<HIVE> {
        kraft_hive(arg0, 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::split(arg1, arg2), arg2, 0x2::tx_context::sender(arg3))
    }

    public entry fun deposit_gems_via_profile(arg0: &mut HiveVault, arg1: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = deposit_gems_via_profile_and_return(arg0, arg1, arg2, arg3);
        0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::coin_helper::destroy_or_transfer_balance<HIVE>(v0, 0x2::tx_context::sender(arg3), arg3);
    }

    public fun deposit_gems_via_profile_and_return(arg0: &mut HiveVault, arg1: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<HIVE> {
        let (v0, _, _, _) = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::get_profile_meta_info(&arg0.streamer_profile);
        let (v4, _, _, _, _, _, _, _) = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::get_following_subscription_info(arg1, v0);
        if (!v4) {
            0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::make_forever_follower(arg0.genesis_ms, arg1, &mut arg0.streamer_profile);
        };
        kraft_hive(arg0, 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::withdraw_gems_from_profile(arg1, arg2, arg3), arg2, 0x2::tx_context::sender(arg3))
    }

    public entry fun entry_add_bid_for_streamer_buzzes<T0>(arg0: &0x2::clock::Clock, arg1: &mut HiveVault, arg2: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = add_bid_for_streamer_buzzes<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::coin_helper::destroy_or_transfer_balance<T0>(v0, 0x2::tx_context::sender(arg6), arg6);
    }

    public entry fun entry_return_expired_bid<T0>(arg0: &mut HiveVault, arg1: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg2: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, _) = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::get_profile_meta_info(arg1);
        assert!(!v2, 9865);
        let v4 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_borrow_mut_from_profile<StreamerBuzzes<T0>>(&arg0.stream_buzz_cap, &mut arg0.streamer_profile, arg2);
        let v5 = return_expired_bid<T0>(v4, arg1, v0, v1, arg2);
        0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::coin_helper::destroy_or_transfer_balance<T0>(v5, 0x2::tx_context::sender(arg2), arg2);
    }
    ...
    public fun get_bid_for_profile_info<T0>(arg0: &HiveVault, arg1: address) : (u64, u64, bool, u64) {
        let v0 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::borrow_from_profile<StreamerBuzzes<T0>>(&arg0.streamer_profile, 0x1::ascii::string(b"STREAMER_BUZZES"));
    ...
    public fun get_dao_hiveprofile_info(arg0: &HiveVault) : (0x1::string::String, u64, 0x1::string::String, u64, vector<u64>, vector<u64>, vector<u64>, vector<u64>, vector<u64>, u64) {
        let (v0, v1, v2, _, v4, v5, v6, v7, v8, v9, v10) = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::get_profile_info(&arg0.streamer_profile);
    ...
    public fun get_hive_buzz_for_user_for_stream<T0>(arg0: &HiveVault, arg1: address, arg2: u64, arg3: u64) : (0x1::string::String, 0x1::option::Option<0x1::string::String>, bool, u64) {
        let v0 = 0x1::vector::borrow<StreamBuzz<T0>>(0x2::linked_table::borrow<u64, vector<StreamBuzz<T0>>>(&0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::borrow_from_profile<StreamerBuzzes<T0>>(&arg0.streamer_profile, 0x1::ascii::string(b"STREAMER_BUZZES")).streamer_buzzes, arg2), arg3);
    ...
    public entry fun increment_stream<T0>(arg0: &0x2::clock::Clock, arg1: &mut HiveVault, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_borrow_mut_from_profile<StreamerBuzzes<T0>>(&arg1.stream_buzz_cap, &mut arg1.streamer_profile, arg2);
    ...
    public fun init_hive_vault<T0>(arg0: &mut 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::config::DegenHiveDeployerCap, arg1: &0x2::clock::Clock, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x364865bf42aa29e593fc05b3c89edbe2149bda83d8c9b5710ae7f2fdf4b5da76::hsui_vault::HSuiVault, arg4: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfileMappingStore, arg5: 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::HiveGemKraftCap, arg6: 0x2::coin::TreasuryCap<HIVE>, arg7: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveManager, arg8: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HSuiDisperser<0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hsui::HSUI>, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::friend_kraft_dof_access_cap(arg4, 0x1::ascii::string(b"STREAMER_BUZZES"), true, true, true, arg10);
        let v1 = 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::kraft_hive_gems(&mut arg5, 1000000000000000);
        0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::deposit_gems_with_manager_profile(arg7, 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::split(&mut v1, 15000000000000));
        let (v2, v3) = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::kraft_owned_hive_profile(arg1, arg2, arg3, arg4, arg7, arg8, arg9, 0x1::string::utf8(b"StreamBuzz"), 0x1::string::utf8(b"Launch your show with StreamBuzz, and interact with your community via HiveBuzzes!"), arg10);
        let v4 = v2;
        ...
        0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_add_to_profile<StreamerBuzzes<T0>>(&v0, &mut v4, v6, arg10);
        let v7 = HiveVault{
            id               : 0x2::object::new(arg10),
            streamer_profile : v4,
            gems_kraft_cap   : arg5,
        ...
        let v8 = &mut v7;
        let v9 = &mut v1;
        let v10 = deposit_gems_for_hive_and_return(v8, v9, 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::value(&v1), arg10);
        ...
        0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::config::vault_setup_by_deployer(arg0);
    }

    public entry fun interact_with_stream_buzz<T0>(arg0: &mut HiveVault, arg1: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg2: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, _, _, _) = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::get_profile_meta_info(arg2);
        buzz_check(arg5, v0);
        let v7 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::borrow_from_profile<StreamerBuzzes<T0>>(&arg0.streamer_profile, 0x1::ascii::string(b"STREAMER_BUZZES"));
        let v8 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::withdraw_gems_from_profile(arg1, v7.buzz_cost_in_hive, arg7);
        ...
        if (0x1::option::is_some<address>(&v7.streamer_profile)) {
            ...
            v10 = v9;
            0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::deposit_gems_in_profile(arg2, 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::split(&mut v8, v9));
            0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::make_forever_follower(v7.stream_init_ms, arg1, arg2);
        } else {
            0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::make_forever_follower(v7.stream_init_ms, arg1, &mut arg0.streamer_profile);
        };
        let v11 = 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::value(&v8);
        let v12 = HiveKraftedForPolDeposit{
            profile      : v1,
            hive_krafted : v11,
        };
        0x2::event::emit<HiveKraftedForPolDeposit>(v12);
        0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::deposit_gems_in_profile(&mut arg0.streamer_profile, v8);
        let v13 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_borrow_mut_from_profile<StreamerBuzzes<T0>>(&arg0.stream_buzz_cap, &mut arg0.streamer_profile, arg7);
    ...
    fun kraft_hive(arg0: &mut HiveVault, arg1: 0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::HiveGems, arg2: u64, arg3: address) : 0x2::balance::Balance<HIVE> {
        assert!(0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::hive_gems::value(&arg1) == arg2, 9876);
        0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::deposit_gems_in_profile(&mut arg0.streamer_profile, arg1);
        let v0 = KraftHive{
            user         : arg3,
            hive_krafted : arg2,
        };
    ...
    fun max_addable_to_bid<T0>(arg0: &StreamerBuzzes<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : (bool, u64) {
        ...
        (true, (0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::math::mul_div_u256((arg4 as u256), ((arg0.stream_init_ms + 7 * 86400000 - arg2) as u256), ((2 * 86400000) as u256)) as u64))
    }
    ...
    public fun query_across_all_bids<T0>(arg0: &HiveVault, arg1: 0x1::option::Option<address>, arg2: u64) : (vector<address>, vector<u64>, vector<u64>, vector<bool>, vector<u64>, u64) {
        ...
        let v5 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::borrow_from_profile<StreamerBuzzes<T0>>(&arg0.streamer_profile, 0x1::ascii::string(b"STREAMER_BUZZES"));
    ...
    public fun query_across_buzzes_for_stream<T0>(arg0: &HiveVault, arg1: u64, arg2: u64, arg3: 0x1::option::Option<address>, arg4: u64) : (vector<address>, vector<0x1::string::String>, vector<0x1::string::String>, vector<bool>, vector<u64>, u64) {
        ...
        let v3 = 0x1::vector::empty<bool>();
        let v4 = 0x1::vector::empty<u64>();
        let v5 = 0x1::vector::borrow<StreamBuzz<T0>>(0x2::linked_table::borrow<u64, vector<StreamBuzz<T0>>>(&0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::borrow_from_profile<StreamerBuzzes<T0>>(&arg0.streamer_profile, 0x1::ascii::string(b"STREAMER_BUZZES")).streamer_buzzes, arg1), arg2);
    ...
    public fun query_across_likes<T0>(arg0: &HiveVault, arg1: u64, arg2: u64, arg3: 0x1::option::Option<address>, arg4: u64) : (vector<address>, u64) {
        let v0 = 0x1::vector::empty<address>();
        let v1 = 0x1::vector::borrow<StreamBuzz<T0>>(0x2::linked_table::borrow<u64, vector<StreamBuzz<T0>>>(&0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::borrow_from_profile<StreamerBuzzes<T0>>(&arg0.streamer_profile, 0x1::ascii::string(b"STREAMER_BUZZES")).streamer_buzzes, arg1), arg2);
    ...
    public fun query_across_streams_for_epoch<T0>(arg0: &HiveVault, arg1: u64, arg2: 0x1::option::Option<u64>, arg3: u64) : (vector<u64>, vector<0x1::string::String>, vector<0x1::string::String>, vector<u64>, vector<u64>, u64) {
        ...
        let v4 = 0x1::vector::empty<u64>();
        let v5 = 0x2::linked_table::borrow<u64, vector<StreamBuzz<T0>>>(&0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::borrow_from_profile<StreamerBuzzes<T0>>(&arg0.streamer_profile, 0x1::ascii::string(b"STREAMER_BUZZES")).streamer_buzzes, arg1);
    ...
    public entry fun retrieve_x_from_buzz<T0>(arg0: &mut HiveVault, arg1: &0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::coin_helper::destroy_or_transfer_balance<T0>(0x2::balance::withdraw_all<T0>(&mut v2.x_earned), 0x2::tx_context::sender(arg4), arg4);
    }

    fun return_expired_bid<T0>(arg0: &mut StreamerBuzzes<T0>, arg1: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg2: address, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        let v8 = (0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::math::mul_div_u128((v3 as u128), (arg0.tax_on_bid as u128), (10000 as u128)) as u64);
    ...
    public fun return_expired_bid_comp_profile<T0>(arg0: &mut HiveVault, arg1: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg2: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        let (v0, v1, v2, _) = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::get_profile_meta_info(arg1);
        assert!(v2, 9866);
        let v4 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_borrow_mut_from_profile<StreamerBuzzes<T0>>(&arg0.stream_buzz_cap, &mut arg0.streamer_profile, arg2);
    ...
    public fun transfer_pol<T0>(arg0: &0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::config::TwoAmmFeeClaimCapability, arg1: &mut HiveVault, arg2: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<HIVE>) {
        let v0 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_borrow_mut_from_profile<StreamerBuzzes<T0>>(&arg1.stream_buzz_cap, &mut arg1.streamer_profile, arg2);
        (0x2::balance::withdraw_all<T0>(&mut v0.x_avail_for_pol), 0x2::balance::withdraw_all<HIVE>(&mut v0.hive_avail_for_pol))
    }

    public fun unlike_stream_buzz<T0>(arg0: &mut HiveVault, arg1: &0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        let (v0, v1) = authority_check(arg1, 0x2::tx_context::sender(arg4));
        let v2 = 0x1::vector::borrow_mut<StreamBuzz<T0>>(0x2::linked_table::borrow_mut<u64, vector<StreamBuzz<T0>>>(&mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_borrow_mut_from_profile<StreamerBuzzes<T0>>(&arg0.stream_buzz_cap, &mut arg0.streamer_profile, arg4).streamer_buzzes, arg2), arg3);
    ...
    public fun update_streamer_buzzes<T0>(arg0: &0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::config::HiveDaoCapability, arg1: &mut HiveVault, arg2: bool, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_borrow_mut_from_profile<StreamerBuzzes<T0>>(&arg1.stream_buzz_cap, &mut arg1.streamer_profile, arg6);
        v0.are_live = arg2;
        if (!v0.are_live && arg2) {
