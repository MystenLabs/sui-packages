module 0xd4e7d02e5e9e08d4540f6586a951d9a26a38a2c4ccc60eaaabbf6c602e2c578c::sale {
    ...
    struct TokenSale has key {
        ...
        purchases_public_count: 0x2::table::Table<address, u8>,
        price: u64,
        total_raised: u64,
    ...
    public fun get_public_purchase_count(arg0: &TokenSale, arg1: address) : u8 {
        if (0x2::table::contains<address, u8>(&arg0.purchases_public_count, arg1)) {
            *0x2::table::borrow<address, u8>(&arg0.purchases_public_count, arg1)
        } else {
            0
        }
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = TokenSale{
            ...
            purchases_public_count   : 0x2::table::new<address, u8>(arg0),
            price                    : 6250000000,
            total_raised             : 0,
    ...
    public entry fun purchase(arg0: &mut TokenSale, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u8, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::coin::value<0x2::sui::SUI>(&arg1);
        let v2 = 0x2::clock::timestamp_ms(arg3);
        assert!(arg2 > 0, 15);
        assert!(!arg0.is_sold_out, 12);
        let v3 = arg0.tokens_per_purchase * (arg2 as u64);
        assert!(arg0.total_tokens_allocated + v3 <= arg0.max_token_supply, 4);
        assert!(v1 == arg0.price * (arg2 as u64), 3);
        if (arg0.current_phase == 0 && arg0.wl1_start_time > 0) {
        ...
        if (arg0.current_phase == 0) {
            ...
            let v6 = if (0x2::table::contains<address, u8>(&arg0.purchases_wl1_count, v0)) {
            ...
            if (0x2::table::contains<address, u64>(&arg0.purchases_wl1, v0)) {
                let v8 = 0x2::table::borrow_mut<address, u64>(&mut arg0.purchases_wl1, v0);
                *v8 = *v8 + v1;
                *0x2::table::borrow_mut<address, u8>(&mut arg0.purchases_wl1_count, v0) = v7;
            } else {
                0x2::table::add<address, u64>(&mut arg0.purchases_wl1, v0, v1);
                0x2::table::add<address, u8>(&mut arg0.purchases_wl1_count, v0, v7);
            };
            if (0x2::table::contains<address, u64>(&arg0.token_allocations_wl1, v0)) {
                let v9 = 0x2::table::borrow_mut<address, u64>(&mut arg0.token_allocations_wl1, v0);
                *v9 = *v9 + v3;
            } else {
                0x2::table::add<address, u64>(&mut arg0.token_allocations_wl1, v0, v3);
            };
            arg0.total_tokens_allocated = arg0.total_tokens_allocated + v3;
            let v10 = if (0x2::table::contains<address, u64>(&arg0.token_allocations_wl1, v0)) {
                *0x2::table::borrow<address, u64>(&arg0.token_allocations_wl1, v0)
            } else {
                0
            };
            let v11 = if (0x2::table::contains<address, u64>(&arg0.token_allocations_wl2, v0)) {
                *0x2::table::borrow<address, u64>(&arg0.token_allocations_wl2, v0)
            } else {
                0
            };
            let v12 = if (0x2::table::contains<address, u64>(&arg0.token_allocations_public, v0)) {
            ...
            let v14 = TokenAllocationEvent{
                buyer                  : v0,
                tokens_allocated       : v3,
                phase                  : 0,
                total_tokens_user      : v10 + v11 + v12,
                total_tokens_allocated : arg0.total_tokens_allocated,
            };
            0x2::event::emit<TokenAllocationEvent>(v14);
            ...
            0x2::table::add<address, u64>(&mut arg0.token_allocations_wl2, v0, v3);
            arg0.total_tokens_allocated = arg0.total_tokens_allocated + v3;
            let v15 = if (0x2::table::contains<address, u64>(&arg0.token_allocations_wl1, v0)) {
                *0x2::table::borrow<address, u64>(&arg0.token_allocations_wl1, v0)
            } else {
                0
            };
            let v16 = if (0x2::table::contains<address, u64>(&arg0.token_allocations_wl2, v0)) {
                *0x2::table::borrow<address, u64>(&arg0.token_allocations_wl2, v0)
            } else {
                0
            };
            let v17 = if (0x2::table::contains<address, u64>(&arg0.token_allocations_public, v0)) {
                *0x2::table::borrow<address, u64>(&arg0.token_allocations_public, v0)
            } else {
                0
            };
            let v18 = PurchaseEvent{
                buyer           : v0,
                amount          : v1,
                phase           : 1,
                purchase_number : 1,
            ...
            0x2::event::emit<PurchaseEvent>(v18);
            let v19 = TokenAllocationEvent{
                buyer                  : v0,
                tokens_allocated       : v3,
                phase                  : 1,
                total_tokens_user      : v15 + v16 + v17,
                total_tokens_allocated : arg0.total_tokens_allocated,
            };
            0x2::event::emit<TokenAllocationEvent>(v19);
        } else {
            assert!(arg0.current_phase == 2, 13);
            let v20 = if (0x2::table::contains<address, u8>(&arg0.purchases_public_count, v0)) {
                *0x2::table::borrow<address, u8>(&arg0.purchases_public_count, v0)
            } else {
                0
            };
            assert!(v20 + arg2 <= 5, 16);
            let v21 = v20 + arg2;
            if (0x2::table::contains<address, u64>(&arg0.purchases_public, v0)) {
                let v22 = 0x2::table::borrow_mut<address, u64>(&mut arg0.purchases_public, v0);
                *v22 = *v22 + v1;
                *0x2::table::borrow_mut<address, u8>(&mut arg0.purchases_public_count, v0) = v21;
            } else {
                0x2::table::add<address, u64>(&mut arg0.purchases_public, v0, v1);
                0x2::table::add<address, u8>(&mut arg0.purchases_public_count, v0, v21);
            };
            if (0x2::table::contains<address, u64>(&arg0.token_allocations_public, v0)) {
                let v23 = 0x2::table::borrow_mut<address, u64>(&mut arg0.token_allocations_public, v0);
                *v23 = *v23 + v3;
            } else {
                0x2::table::add<address, u64>(&mut arg0.token_allocations_public, v0, v3);
            };
            arg0.total_tokens_allocated = arg0.total_tokens_allocated + v3;
            let v24 = if (0x2::table::contains<address, u64>(&arg0.token_allocations_wl1, v0)) {
                *0x2::table::borrow<address, u64>(&arg0.token_allocations_wl1, v0)
            } else {
                0
            };
            let v25 = if (0x2::table::contains<address, u64>(&arg0.token_allocations_wl2, v0)) {
                *0x2::table::borrow<address, u64>(&arg0.token_allocations_wl2, v0)
            } else {
                0
            };
            let v26 = if (0x2::table::contains<address, u64>(&arg0.token_allocations_public, v0)) {
                *0x2::table::borrow<address, u64>(&arg0.token_allocations_public, v0)
            } else {
                0
            };
            let v27 = PurchaseEvent{
                buyer           : v0,
                amount          : v1,
                phase           : 2,
                purchase_number : v21,
            ...
            0x2::event::emit<PurchaseEvent>(v27);
            let v28 = TokenAllocationEvent{
                buyer                  : v0,
                tokens_allocated       : v3,
                phase                  : 2,
                total_tokens_user      : v24 + v25 + v26,
                total_tokens_allocated : arg0.total_tokens_allocated,
            };
            0x2::event::emit<TokenAllocationEvent>(v28);
        };
        let v29 = arg0.total_raised + v1;
        if (arg0.total_tokens_allocated >= arg0.max_token_supply) {
            arg0.is_sold_out = true;
            arg0.current_phase = 3;
            let v30 = SoldOutEvent{
                total_raised           : v29,
                total_tokens_allocated : arg0.total_tokens_allocated,
                max_token_supply       : arg0.max_token_supply,
                timestamp              : v2,
            };
            0x2::event::emit<SoldOutEvent>(v30);
        };
        arg0.total_raised = v29;
