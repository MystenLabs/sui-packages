module 0xd4e97c6bc8d1da624d5671a5fdd3a370a38a915b2c75582f25339f9fd23950fa::cnsnft6617 {
    struct CNSNFT6617 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6617, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6617>(arg0, arg1);
