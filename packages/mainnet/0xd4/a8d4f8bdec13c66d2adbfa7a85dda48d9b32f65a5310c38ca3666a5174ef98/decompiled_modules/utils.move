module 0xd4a8d4f8bdec13c66d2adbfa7a85dda48d9b32f65a5310c38ca3666a5174ef98::utils {
    public fun base_div(arg0: u64, arg1: u64) : u64 {
        (((arg0 as u128) * (0xd4a8d4f8bdec13c66d2adbfa7a85dda48d9b32f65a5310c38ca3666a5174ef98::constants::base_uint() as u128) / (arg1 as u128)) as u64)
    }

    public fun base_mul(arg0: u64, arg1: u64) : u64 {
        (((arg0 as u128) * (arg1 as u128) / (0xd4a8d4f8bdec13c66d2adbfa7a85dda48d9b32f65a5310c38ca3666a5174ef98::constants::base_uint() as u128)) as u64)
    }

    public fun convert_to_protocol_decimals(arg0: u64, arg1: u8) : u64 {
        let v0 = 0xd4a8d4f8bdec13c66d2adbfa7a85dda48d9b32f65a5310c38ca3666a5174ef98::constants::protocol_decimals();
        if (arg1 < v0) {
