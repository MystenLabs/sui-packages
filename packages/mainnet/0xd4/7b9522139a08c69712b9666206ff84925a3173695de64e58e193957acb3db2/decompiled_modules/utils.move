module 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils {
    public fun get_epoch(arg0: &0x2::clock::Clock) : u64 {
        0x2::clock::timestamp_ms(arg0) / 86400000
    }

    public fun get_target_epoch_diff(arg0: &0x2::clock::Clock, arg1: u64) : u64 {
        let v0 = get_epoch(arg0);
        if (v0 >= arg1) {
            0
        } else {
            arg1 - v0
    ...
    public fun split_partial_balance<T0>(arg0: &mut 0x2::balance::Balance<T0>, arg1: 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::ratio::Ratio) : 0x2::balance::Balance<T0> {
        0x2::balance::split<T0>(arg0, 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::ratio::partial(arg1, 0x2::balance::value<T0>(arg0)))
    }
