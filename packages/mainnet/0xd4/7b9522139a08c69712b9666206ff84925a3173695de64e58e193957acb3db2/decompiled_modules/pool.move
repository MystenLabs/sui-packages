module 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::pool {
    struct POOL has drop {
        dummy_field: bool,
    }

    struct TagEvent has copy, drop, store {
        operation: vector<u8>,
        tag: vector<u8>,
    }
    ...
    struct PoolLiquidityMiningInfo has store {
        permission: 0x1::option::Option<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::permission::Permission<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank>>,
        speed: u256,
        ampt: 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::vpt::ValuePerToken,
        last_epoch: u64,
    }
    ...
    struct PoolLsp<phantom T0, phantom T1> has key {
        ...
        pool_y: u64,
        pool_lsp: u64,
        pool_mining_ampt: 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::vpt::ValuePerToken,
        start_epoch: u64,
        end_epoch: u64,
        boost_multiplier: u64,
    }
    ...
    public entry fun add_liquidity_all<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T0>>, arg2: vector<0x2::coin::Coin<T1>>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::merge_coins<T0>(arg1, arg5);
        let v1 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::merge_coins<T1>(arg2, arg5);
    ...
    entry fun add_liquidity_all_tag<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T0>>, arg2: vector<0x2::coin::Coin<T1>>, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        add_liquidity_all<T0, T1>(arg0, arg1, arg2, arg3, arg5, arg6);
        let v0 = TagEvent{
            operation : b"add_liquidity_all_tag",
            tag       : arg4,
        };
        0x2::event::emit<TagEvent>(v0);
    }
    ...
    fun add_liquidity_direct_impl<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T0>>, arg2: vector<0x2::coin::Coin<T1>>, arg3: u64, arg4: u64, arg5: u64, arg6: bool, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : PoolLsp<T0, T1> {
        ...
        let v0 = 0x2::coin::into_balance<T0>(0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::merge_coins<T0>(arg1, arg8));
        let v1 = 0x2::coin::into_balance<T1>(0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::merge_coins<T1>(arg2, arg8));
        assert!(0x2::balance::value<T0>(&v0) >= arg3, 134008);
        assert!(0x2::balance::value<T1>(&v1) >= arg4, 134008);
        update_pool_mining<T0, T1>(arg0, arg7);
        let v2 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::get_epoch(arg7);
        let v3 = v2 + arg5;
        let v4 = 10;
        if (v3 > v2) {
            let v5 = 0;
        ...
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::transfer_or_destroy_zero<T0>(0x2::coin::from_balance<T0>(v0, arg8), v8);
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::transfer_or_destroy_zero<T1>(0x2::coin::from_balance<T1>(v1, arg8), v8);
        ...
        let v12 = if (v11 > 0) {
            ...
            let v13 = 0x2::math::sqrt(v9 + arg3) * 0x2::math::sqrt(v10 + arg4);
            assert!(v13 > 0, 134023);
            v13
        };
        ...
        let v14 = increase_lsp_supply<T0, T1>(arg0, v12, v2, v3, v4, arg8);
        let v15 = LiquidityEvent<T0, T1>{
            pool_index : arg0.index,
            is_added   : true,
            x_amount   : arg3,
            y_amount   : arg4,
            lsp_amount : v12,
            lsp_id     : 0x2::object::uid_to_inner(&v14.id),
        };
        0x2::event::emit<LiquidityEvent<T0, T1>>(v15);
        v14
    }

    entry fun add_liquidity_tag<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T0>>, arg2: vector<0x2::coin::Coin<T1>>, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        add_liquidity<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg7, arg8);
        let v0 = TagEvent{
            operation : b"add_liquidity_tag",
            tag       : arg6,
        };
        0x2::event::emit<TagEvent>(v0);
    }
    ...
    public entry fun change_pool_mining_speed<T0, T1>(arg0: &SwapCap, arg1: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenCap, arg2: &mut Pool<T0, T1>, arg3: u64) {
        do_change_pool_mining_speed<T0, T1>(arg0, arg1, arg2, arg3);
    }

    public entry fun claim_th_reward<T0, T1>(arg0: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenFarm, arg1: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::StakedToken, arg2: &mut Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        do_claim_th_reward<T0, T1>(arg0, arg1, arg2, arg3, arg4);
    }

    fun claim_th_reward_impl<T0, T1>(arg0: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenFarm, arg1: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::StakedToken, arg2: &mut Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(arg2.version == 0, 200000);
        assert!(arg2.th_reward.type == 210, 134022);
        let v0 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::get_epoch(arg3);
        update_th_reward_impl<T0, T1>(arg0, arg2, v0);
        let v1 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::staked_token_pop_data<u64, u64>(arg1, arg2.index);
        if (0x1::option::get_with_default<u64>(&v1, 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::staked_token_get_start_epoch(arg1)) >= arg2.th_reward.start_epcoh) {
            return 134017
        };
        let v2 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::staked_token_get_boost(arg1);
        ...
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::transfer_or_destroy_zero<T0>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg2.th_reward.x, ((v2 * (arg2.th_reward.x_supply as u128) / v4) as u64)), arg4), v5);
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::transfer_or_destroy_zero<T1>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg2.th_reward.y, ((v2 * (arg2.th_reward.y_supply as u128) / v4) as u64)), arg4), v5);
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::staked_token_add_data<u64, u64>(arg1, arg2.index, v0);
        0
    }

    entry fun claim_th_reward_tag<T0, T1>(arg0: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenFarm, arg1: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::StakedToken, arg2: &mut Pool<T0, T1>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        claim_th_reward<T0, T1>(arg0, arg1, arg2, arg4, arg5);
        let v0 = TagEvent{
            operation : b"claim_th_reward_tag",
            tag       : arg3,
        };
        0x2::event::emit<TagEvent>(v0);
    }
    ...
    fun collect_fee<T0>(arg0: &mut 0x2::balance::Balance<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::split_partial_balance<T0>(arg0, 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::ratio::ratio(arg1, 10000))
    }
    ...
    fun compute_withdraw(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u8) : (u64, u64) {
        if (arg4 == 2) {
            return ((((arg0 as u128) * (arg3 as u128) / (arg2 as u128)) as u64), (((arg1 as u128) * (arg3 as u128) / (arg2 as u128)) as u64))
        };
        let v0 = ((arg2 - arg3) as u256);
        let v1 = (arg2 as u256);
        if (arg4 == 0) {
            return (arg0 - (((arg0 as u256) * v0 * v0 / v1 * v1) as u64), 0)
        };
        (0, arg1 - (((arg1 as u256) * v0 * v0 / v1 * v1) as u64))
    }
    ...
    fun create_pool_impl<T0, T1>(arg0: &mut PoolRegistry, arg1: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenFarm, arg2: u8, arg3: u8, arg4: u8, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u8, arg11: u8, arg12: u64, arg13: u64, arg14: u8, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::get_epoch(arg15);
        ...
        let v14 = PoolTokenHolderRewardInfo<T0, T1>{
            ...
            start_epcoh        : v8,
            end_epoch          : v9,
            total_stake_amount : 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::token_farm_get_total_stake_amount(arg1),
            total_stake_boost  : 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::token_farm_get_total_stake_boost(arg1),
        };
        let v15 = PoolLiquidityMiningInfo{
            permission : 0x1::option::none<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::permission::Permission<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank>>(),
            speed      : 0,
            ampt       : 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::vpt::zero(),
            last_epoch : v6 + 1,
        };
        let v16 = Pool<T0, T1>{
            id                    : v2,
    ...
    public entry fun create_pool_no_admin<T0, T1>(arg0: &mut PoolRegistry, arg1: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenFarm, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun do_change_pool_mining_speed<T0, T1>(arg0: &SwapCap, arg1: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenCap, arg2: &mut Pool<T0, T1>, arg3: u64) {
        assert!(arg2.version == 0, 200000);
        arg2.mining.speed = (arg3 as u256);
        if (0x1::option::is_none<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::permission::Permission<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank>>(&arg2.mining.permission)) {
            0x1::option::fill<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::permission::Permission<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank>>(&mut arg2.mining.permission, 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::token_cap_cp_token_bank_permission(arg1));
        };
    }

    public fun do_claim_th_reward<T0, T1>(arg0: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenFarm, arg1: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::StakedToken, arg2: &mut Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = claim_th_reward_impl<T0, T1>(arg0, arg1, arg2, arg3, arg4);
        assert!(v0 == 0, v0);
    }

    public fun do_create_pool<T0, T1>(arg0: &SwapCap, arg1: &mut PoolRegistry, arg2: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenFarm, arg3: u8, arg4: u8, arg5: u8, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u8, arg12: u8, arg13: u64, arg14: u64, arg15: u8, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 0, 200000);
        create_pool_impl<T0, T1>(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17);
    }

    public fun do_create_pool_no_admin<T0, T1>(arg0: &mut PoolRegistry, arg1: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenFarm, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 200000);
    ...
    public fun do_remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank, arg2: PoolLsp<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        remove_liquidity_impl<T0, T1>(arg0, arg1, arg2, arg3, 2, false, arg4, arg5);
    }

    public fun do_remove_liquidity_force<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank, arg2: PoolLsp<T0, T1>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::token_bank_get_public_key(arg1);
        assert!(0x1::option::is_some<vector<u8>>(&v0), 134007);
        let v1 = b"remove-liquidity-force";
        let v2 = 0x2::object::uid_to_inner(&arg2.id);
        0x1::vector::append<u8>(&mut v1, 0x2::bcs::to_bytes<0x2::object::ID>(&v2));
        assert!(0x2::ed25519::ed25519_verify(&arg3, 0x1::option::borrow<vector<u8>>(&v0), &v1), 134007);
        remove_liquidity_impl<T0, T1>(arg0, arg1, arg2, arg2.value, 2, true, arg4, arg5);
    }

    public fun do_remove_liquidity_s<T0, T1>(arg0: &SwapCap, arg1: &mut Pool<T0, T1>, arg2: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank, arg3: PoolLsp<T0, T1>, arg4: u64, arg5: u8, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = get_k2_per_lsp<T0, T1>(arg1);
        remove_liquidity_impl<T0, T1>(arg1, arg2, arg3, arg4, arg5, true, arg6, arg7);
        assert!(get_k2_per_lsp<T0, T1>(arg1) >= v0, 134006);
    }
    ...
    public fun do_swap_x_to_y<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::transfer_or_destroy_zero<T0>(v0, v3);
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::transfer_or_destroy_zero<T1>(v2, v3);
    }
    ...
    public fun do_swap_x_to_y_direct<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v0 = 0x2::coin::into_balance<T0>(0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::merge_coins<T0>(arg1, arg4));
        ...
        let v10 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::get_epoch(arg3);
    ...
    public fun do_swap_y_to_x<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T1>>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::tx_context::sender(arg5);
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::transfer_or_destroy_zero<T1>(v0, v3);
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::transfer_or_destroy_zero<T0>(v2, v3);
    }
    ...
    public fun do_swap_y_to_x_direct<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T1>>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::coin::Coin<T0>) {
        ...
        let v0 = 0x2::coin::into_balance<T1>(0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::merge_coins<T1>(arg1, arg4));
        ...
        let v7 = &mut v5;
        collect_admin_and_th_fee_x<T0, T1>(arg0, v7);
        0x2::balance::join<T1>(&mut arg0.balance.y, v4);
        process_auto_buyback<T0, T1>(arg0);
        update_pool_mining<T0, T1>(arg0, arg3);
        let v8 = 0x2::coin::from_balance<T0>(v5, arg4);
        let v9 = SwapTokenEvent<T0, T1>{
            pool_index : arg0.index,
            x_to_y     : false,
            in_amount  : arg2,
            out_amount : 0x2::coin::value<T0>(&v8),
        };
        0x2::event::emit<SwapTokenEvent<T0, T1>>(v9);
        let v10 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::get_epoch(arg3);
        arg0.total_trade.y = arg0.total_trade.y + (arg2 as u128);
        arg0.total_trade.x = arg0.total_trade.x + (v6 as u128);
        if (v10 != arg0.trade_epoch) {
            arg0.total_trade.y_last_epoch = arg0.total_trade.y_current_epoch;
            arg0.total_trade.x_last_epoch = arg0.total_trade.x_current_epoch;
            arg0.total_trade.y_current_epoch = (arg2 as u128);
            arg0.total_trade.x_current_epoch = (v6 as u128);
            arg0.trade_epoch = v10;
            let (v11, v12, v13) = get_amounts<T0, T1>(arg0);
            let v14 = SnapshotEvent<T0, T1>{
                pool_index : arg0.index,
            ...
            arg0.total_trade.x_current_epoch = arg0.total_trade.x_current_epoch + (v6 as u128);
        };
        (0x2::coin::from_balance<T1>(v0, arg4), v8)
    }

    public fun do_update_th_reward<T0, T1>(arg0: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenFarm, arg1: &mut Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        update_th_reward_impl<T0, T1>(arg0, arg1, 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::get_epoch(arg2));
    }
    ...
    fun increase_lsp_supply<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : PoolLsp<T0, T1> {
        ...
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::vpt::add_amount(&mut arg0.mining.ampt, (arg1 as u256) * (arg4 as u256));
        v3
    }
    ...
    public fun pool_get_mining_ampt<T0, T1>(arg0: &Pool<T0, T1>) : 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::vpt::ValuePerToken {
        arg0.mining.ampt
    }

    public fun pool_get_mining_has_permission<T0, T1>(arg0: &Pool<T0, T1>) : bool {
        0x1::option::is_some<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::permission::Permission<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank>>(&arg0.mining.permission)
    }
    ...
    public entry fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank, arg2: PoolLsp<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        do_remove_liquidity<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    public entry fun remove_liquidity_all<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank, arg2: PoolLsp<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        do_remove_liquidity<T0, T1>(arg0, arg1, arg2, arg2.value, arg3, arg4);
    }

    entry fun remove_liquidity_all_tag<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank, arg2: PoolLsp<T0, T1>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        remove_liquidity_all<T0, T1>(arg0, arg1, arg2, arg4, arg5);
        let v0 = TagEvent{
            operation : b"remove_liquidity_all_tag",
            tag       : arg3,
        };
        0x2::event::emit<TagEvent>(v0);
    }

    fun remove_liquidity_impl<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank, arg2: PoolLsp<T0, T1>, arg3: u64, arg4: u8, arg5: bool, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg4 <= 2, 13400);
        assert!(arg0.version == 0, 200000);
        if (0x2::tx_context::sender(arg7) != arg0.owner) {
            assert!(arg0.freeze & 4 == 0, 134010);
        };
        assert!(arg3 > 0, 13400);
        assert!(arg2.value >= arg3, 134008);
        if (arg5 == false) {
            assert!(0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::get_epoch(arg6) >= arg2.end_epoch, 134019);
        };
        update_pool_mining<T0, T1>(arg0, arg6);
        let v0 = 0x2::tx_context::sender(arg7);
        let (v1, v2, v3) = get_amounts<T0, T1>(arg0);
        let (v4, v5) = if (arg0.pool_type == 100) {
            compute_withdraw(v1, v2, v3, arg3, arg4)
        } else {
            compute_withdraw_stable(v1, v2, v3, arg3, arg0.stable.x_scale, arg0.stable.y_scale, arg0.stable.amp)
        };
        let v6 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::vpt::diff(&arg0.mining.ampt, &arg2.pool_mining_ampt, (arg2.value as u256) * (arg2.boost_multiplier as u256));
        assert!(v6 <= 18446744073709551615, 134006);
        let v7 = (v6 as u64);
        if (0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::token_bank_get_balance_value(arg1) >= v7 && 0x1::option::is_some<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::permission::Permission<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank>>(&arg0.mining.permission) && v7 > 0) {
            0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::do_send_liquidity_mine_token(0x1::option::borrow<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::permission::Permission<0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank>>(&arg0.mining.permission), arg1, v7, v0, arg7);
        };
        let v8 = remove_lsp_supply<T0, T1>(arg0, arg2, arg3, arg7);
        if (v8.value > 0) {
        ...
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::transfer_or_destroy_zero<T0>(0x2::coin::from_balance<T0>(v10, arg7), v0);
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::transfer_or_destroy_zero<T1>(0x2::coin::from_balance<T1>(v9, arg7), v0);
        if (arg4 == 2) {
    ...
    entry fun remove_liquidity_tag<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenBank, arg2: PoolLsp<T0, T1>, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        remove_liquidity<T0, T1>(arg0, arg1, arg2, arg3, arg5, arg6);
        let v0 = TagEvent{
            operation : b"remove_liquidity_tag",
            tag       : arg4,
        };
        0x2::event::emit<TagEvent>(v0);
    }
    ...
    fun remove_lsp_supply<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: PoolLsp<T0, T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : PoolLsp<T0, T1> {
        ...
        0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::vpt::dec_amount(&mut arg0.mining.ampt, (v0 as u256) * (arg1.boost_multiplier as u256));
    ...
    public entry fun swap_x_to_y_all<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::merge_coins<T0>(arg1, arg4);
        do_swap_x_to_y<T0, T1>(arg0, 0x1::vector::singleton<0x2::coin::Coin<T0>>(v0), 0x2::coin::value<T0>(&v0), arg2, arg3, arg4);
    }

    entry fun swap_x_to_y_all_tag<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        swap_x_to_y_all<T0, T1>(arg0, arg1, arg2, arg4, arg5);
        let v0 = TagEvent{
            operation : b"swap_x_to_y_all_tag",
            tag       : arg3,
        };
        0x2::event::emit<TagEvent>(v0);
    }
    ...
    entry fun swap_x_to_y_tag<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        swap_x_to_y<T0, T1>(arg0, arg1, arg2, arg3, arg5, arg6);
        let v0 = TagEvent{
            operation : b"swap_x_to_y_tag",
            tag       : arg4,
        };
        0x2::event::emit<TagEvent>(v0);
    }
    ...
    public entry fun swap_y_to_x_all<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T1>>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::merge_coins<T1>(arg1, arg4);
        do_swap_y_to_x<T0, T1>(arg0, 0x1::vector::singleton<0x2::coin::Coin<T1>>(v0), 0x2::coin::value<T1>(&v0), arg2, arg3, arg4);
    }

    entry fun swap_y_to_x_all_tag<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T1>>, arg2: u64, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        swap_y_to_x_all<T0, T1>(arg0, arg1, arg2, arg4, arg5);
        let v0 = TagEvent{
            operation : b"swap_y_to_x_all_tag",
            tag       : arg3,
        };
        0x2::event::emit<TagEvent>(v0);
    }
    ...
    entry fun swap_y_to_x_tag<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T1>>, arg2: u64, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        swap_y_to_x<T0, T1>(arg0, arg1, arg2, arg3, arg5, arg6);
        let v0 = TagEvent{
            operation : b"swap_y_to_x_tag",
            tag       : arg4,
        };
        0x2::event::emit<TagEvent>(v0);
    }
    ...
    fun update_pool_mining<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock) {
        if (arg0.mining.speed > 0) {
            ...
            if (v0 > arg0.mining.last_epoch) {
                ...
                if (0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::vpt::amount(&arg0.mining.ampt) > 0) {
                    0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::vpt::add_sum(&mut arg0.mining.ampt, ((v0 - arg0.mining.last_epoch) as u256) * arg0.mining.speed);
                };
            };
        };
    }

    public entry fun update_th_reward<T0, T1>(arg0: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenFarm, arg1: &mut Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        do_update_th_reward<T0, T1>(arg0, arg1, arg2, arg3);
    }

    fun update_th_reward_impl<T0, T1>(arg0: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::TokenFarm, arg1: &mut Pool<T0, T1>, arg2: u64) {
        assert!(arg1.version == 0, 200000);
        if (arg2 > arg1.th_reward.end_epoch) {
            ...
            0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::join_balance<T0>(&mut arg1.balance.x_admin, &mut arg1.th_reward.x);
            0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::join_balance<T1>(&mut arg1.balance.y_admin, &mut arg1.th_reward.y);
            0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::join_balance<T0>(&mut arg1.th_reward.x, &mut arg1.balance.x_th);
            0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::utils::join_balance<T1>(&mut arg1.th_reward.y, &mut arg1.balance.y_th);
            ...
            arg1.th_reward.total_stake_amount = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::token_farm_get_total_stake_amount(arg0);
            arg1.th_reward.total_stake_boost = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::TOKEN::token_farm_get_total_stake_boost(arg0);
        };
    }
