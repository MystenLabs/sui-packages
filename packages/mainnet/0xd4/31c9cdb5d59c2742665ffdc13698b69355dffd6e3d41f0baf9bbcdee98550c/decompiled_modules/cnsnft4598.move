module 0xd431c9cdb5d59c2742665ffdc13698b69355dffd6e3d41f0baf9bbcdee98550c::cnsnft4598 {
    struct CNSNFT4598 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4598, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4972"));
        let v4 = 0x2::package::claim<CNSNFT4598>(arg0, arg1);
