module 0xd499c86d6a0cd43b94da8c0ffa6950acad119c2a927d0e260a2515113ce363c3::liquidator {
    ...
    public(friend) fun ensure_caller_whitelisted(arg0: &Liquidator, arg1: address) {
        assert!(0x2::vec_set::contains<address>(&arg0.whitelist, &arg1), 0xd499c86d6a0cd43b94da8c0ffa6950acad119c2a927d0e260a2515113ce363c3::error::not_whitelisted());
    }
    ...
    public fun update_slippage_tolerance(arg0: &LiquidatorAdminCap, arg1: &mut Liquidator, arg2: u32) {
        assert!(arg2 <= 10000, 0xd499c86d6a0cd43b94da8c0ffa6950acad119c2a927d0e260a2515113ce363c3::error::invalid_slippage());
