module 0x2ef642c6a635604fdd4d41a5998823db3ce219518c2a7c87de8458a4ae1d11ea::betting_escrow {
    ...
    public fun claim_winnings<T0>(arg0: &mut BettingPool<T0>, arg1: &mut BetReceipt, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        arg1.claimed = true;
        let v11 = v3 * 400 / 10000;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v4, v11), arg3), @0xc4c4fc159c4b71a6dbbab5cefcf96e704c21cc4ef3d10dcdd8ef736d40c95940);
        let v12 = FeeCollected{
            pool_id    : 0x2::object::uid_to_inner(&arg0.id),
            bettor     : arg1.bettor,
            fee_amount : v11,
            treasury   : @0xc4c4fc159c4b71a6dbbab5cefcf96e704c21cc4ef3d10dcdd8ef736d40c95940,
            timestamp  : 0x2::clock::timestamp_ms(arg2),
        };
        0x2::event::emit<FeeCollected>(v12);
        let v13 = WinningsClaimed{
            pool_id    : 0x2::object::uid_to_inner(&arg0.id),
            receipt_id : 0x2::object::uid_to_inner(&arg1.id),
            bettor     : arg1.bettor,
        ...
        0x2::event::emit<WinningsClaimed>(v13);
