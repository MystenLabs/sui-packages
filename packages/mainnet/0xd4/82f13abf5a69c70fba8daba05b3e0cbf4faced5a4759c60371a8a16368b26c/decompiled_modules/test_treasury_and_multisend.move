module 0xd482f13abf5a69c70fba8daba05b3e0cbf4faced5a4759c60371a8a16368b26c::test_treasury_and_multisend {
    ...
    struct TestTreasuryVault has store, key {
        id: 0x2::object::UID,
        has_distributor_role: 0x2::vec_set::VecSet<address>,
    }

    struct HydroTreasuryVaultBalance<phantom T0> has copy, drop, store {
        dummy_field: bool,
    }
    ...
    struct TEST_TREASURY_AND_MULTISEND has drop {
        dummy_field: bool,
    }

    public entry fun change_owner(arg0: &mut TestTreasuryVault, arg1: Owner, arg2: address, arg3: &UpgradeVersion, arg4: 0x2::package::UpgradeCap, arg5: &0x2::tx_context::TxContext) {
    ...
    entry fun collect_reward<T0>(arg0: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg1: &mut TestTreasuryVault, arg2: &UpgradeVersion, arg3: &0x2::tx_context::TxContext) {
        ...
        let v2 = HydroTreasuryVaultBalance<T0>{dummy_field: false};
        let v3 = &mut arg1.id;
        if (0x2::dynamic_field::exists_<HydroTreasuryVaultBalance<T0>>(v3, v2)) {
            0x2::coin::join<T0>(0x2::dynamic_field::borrow_mut<HydroTreasuryVaultBalance<T0>, 0x2::coin::Coin<T0>>(v3, v2), v1);
        } else {
            0x2::dynamic_field::add<HydroTreasuryVaultBalance<T0>, 0x2::coin::Coin<T0>>(v3, v2, v1);
        };
        let v4 = RewardCollected{reward_amount: 0x2::coin::value<T0>(&v1)};
        0x2::event::emit<RewardCollected>(v4);
    }

    public entry fun grant_distributor_role(arg0: &Owner, arg1: &mut TestTreasuryVault, arg2: &UpgradeVersion, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.version == 0, 2);
    ...
    fun init(arg0: TEST_TREASURY_AND_MULTISEND, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        let v1 = TestTreasuryVault{
            id                   : 0x2::object::new(arg1),
            has_distributor_role : 0x2::vec_set::empty<address>(),
        };
        0x2::vec_set::insert<address>(&mut v1.has_distributor_role, v0);
        0x2::transfer::share_object<TestTreasuryVault>(v1);
        let v2 = Owner{
            id            : 0x2::object::new(arg1),
            owner_address : v0,
        };
    ...
    public entry fun revoke_distributor_role(arg0: &Owner, arg1: &mut TestTreasuryVault, arg2: address, arg3: &UpgradeVersion, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg3.version == 0, 2);
    ...
    public entry fun send_reward<T0>(arg0: vector<address>, arg1: vector<u64>, arg2: &mut TestTreasuryVault, arg3: &UpgradeVersion, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = @0x0;
        ...
        let v3 = HydroTreasuryVaultBalance<T0>{dummy_field: false};
        let v4 = &mut arg2.id;
        assert!(0x2::dynamic_field::exists_<HydroTreasuryVaultBalance<T0>>(v4, v3), 7);
        let v5 = 0x2::dynamic_field::borrow_mut<HydroTreasuryVaultBalance<T0>, 0x2::coin::Coin<T0>>(v4, v3);
