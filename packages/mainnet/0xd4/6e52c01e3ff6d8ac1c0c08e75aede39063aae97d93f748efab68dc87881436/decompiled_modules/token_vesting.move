module 0xd46e52c01e3ff6d8ac1c0c08e75aede39063aae97d93f748efab68dc87881436::token_vesting {
    ...
    fun init(arg0: TOKEN_VESTING, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Cetus Pass"));
