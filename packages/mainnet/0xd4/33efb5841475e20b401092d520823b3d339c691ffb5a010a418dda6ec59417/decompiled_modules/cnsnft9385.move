module 0xd433efb5841475e20b401092d520823b3d339c691ffb5a010a418dda6ec59417::cnsnft9385 {
    struct CNSNFT9385 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9385, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9385>(arg0, arg1);
