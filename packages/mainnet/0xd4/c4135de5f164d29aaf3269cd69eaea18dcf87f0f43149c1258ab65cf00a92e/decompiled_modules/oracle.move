module 0xd4c4135de5f164d29aaf3269cd69eaea18dcf87f0f43149c1258ab65cf00a92e::oracle {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<OraclePath>(v0, 0x2::tx_context::sender(arg0));
    }
    ...
    public fun meta_fees(arg0: &OraclePath) : (u64, u64) {
        (arg0.meta_fwd, arg0.meta_rev)
    }

    public fun path_info(arg0: &OraclePath) : &vector<Hop> {
        &arg0.hops
    }
    ...
    public fun transfer_owner(arg0: OraclePath, arg1: address) {
        0x2::transfer::public_transfer<OraclePath>(arg0, arg1);
    }

    public fun update(arg0: &mut OraclePath, arg1: vector<Hop>, arg2: u64, arg3: u64) {
        assert!(0x1::vector::length<Hop>(&arg1) > 0, 13906834436336386047);
        arg0.hops = arg1;
        arg0.meta_fwd = arg2;
        arg0.meta_rev = arg3;
    }
