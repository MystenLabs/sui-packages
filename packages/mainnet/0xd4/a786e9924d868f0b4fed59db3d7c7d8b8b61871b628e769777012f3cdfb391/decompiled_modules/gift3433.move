module 0xd4a786e9924d868f0b4fed59db3d7c7d8b8b61871b628e769777012f3cdfb391::gift3433 {
    struct GIFT3433 has drop {
        dummy_field: bool,
    }

    struct TICKET_3433 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3433(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3433>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3433>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3433, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3433>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3433>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3433>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3433>>(v5, 0x2::tx_context::sender(arg1));
    }
