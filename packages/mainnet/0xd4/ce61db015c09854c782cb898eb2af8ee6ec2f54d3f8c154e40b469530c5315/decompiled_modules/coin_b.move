module 0xd4ce61db015c09854c782cb898eb2af8ee6ec2f54d3f8c154e40b469530c5315::coin_b {
    ...
    fun init(arg0: COIN_B, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<COIN_B>(arg0, 3, b"COIN_B", b"CB", b"coin_b", 0x1::option::none<0x2::url::Url>(), arg1);
