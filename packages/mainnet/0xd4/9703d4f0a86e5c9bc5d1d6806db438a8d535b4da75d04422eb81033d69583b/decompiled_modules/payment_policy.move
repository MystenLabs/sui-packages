module 0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::payment_policy {
    ...
    public fun createPolicy<T0: store + key, T1>(arg0: &0x2::package::Publisher, arg1: u64, arg2: u64, arg3: &0x5339126dedf9bcd3b7f94bba745d3e9732398586f2a34ffcdf2189b814c5d152::version::Version, arg4: &mut 0x2::tx_context::TxContext) : PolicyVaultCap {
        0x5339126dedf9bcd3b7f94bba745d3e9732398586f2a34ffcdf2189b814c5d152::version::checkVersion(arg3, 2);
        ...
        0x5339126dedf9bcd3b7f94bba745d3e9732398586f2a34ffcdf2189b814c5d152::cap_vault::createVault<PolicyVaultCap>(arg4);
        v6
    }
    ...
    public(friend) fun payByClt<T0: store + key, T1>(arg0: &mut 0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::clt::CltVault<T1>, arg1: &mut PolicyVault<T0>, arg2: 0x2::transfer_policy::TransferRequest<T0>, arg3: &0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::public_kiosk::KOrder, arg4: &mut 0x2::balance::Balance<T1>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, u64, u64) {
        let (_, v1, v2, v3) = 0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::public_kiosk::orderInfo(arg3);
        ...
        let v8 = 0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::constants::max_fee();
        let v9 = 0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::math::div(0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::math::mul(v7, arg5), v8);
        let v10 = 0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::math::div(0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::math::mul(v7, *v6), v8);
        0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::clt::withdrawTo<T1>(0x2::balance::split<T1>(arg4, v7 - v9 - v10), v2, arg0, arg6);
    ...
    public(friend) fun payByCoin<T0: store + key, T1>(arg0: &mut PolicyVault<T0>, arg1: 0x2::transfer_policy::TransferRequest<T0>, arg2: &0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::public_kiosk::KOrder, arg3: &mut 0x2::balance::Balance<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, u64, u64) {
        let (_, v1, v2, v3) = 0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::public_kiosk::orderInfo(arg2);
        ...
        let v8 = 0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::constants::max_fee();
        let v9 = 0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::math::div(0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::math::mul(v7, arg4), v8);
        let v10 = 0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::math::div(0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::math::mul(v7, *v6), v8);
    ...
    public fun withdrawRoyalFeeToken<T0: store + key, T1>(arg0: &PolicyVaultCap, arg1: &mut PolicyVault<T0>, arg2: &mut 0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::clt::CltVault<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::clt::withdrawTo<T1>(withdrawRoyalFee<T0, T1>(arg0, arg1), 0x2::tx_context::sender(arg3), arg2, arg3);
    }
