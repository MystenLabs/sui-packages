module 0xa92b635b7088c139cddb90a4ef4d806921ff3eab387eb32a37a829e9d0eba92a::clt {
    ...
    public fun depositToken<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut CltVault<T0>, arg3: &mut 0x5339126dedf9bcd3b7f94bba745d3e9732398586f2a34ffcdf2189b814c5d152::archieve::UserArchieve, arg4: &0x5339126dedf9bcd3b7f94bba745d3e9732398586f2a34ffcdf2189b814c5d152::version::Version, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, DepositProof) {
        0x5339126dedf9bcd3b7f94bba745d3e9732398586f2a34ffcdf2189b814c5d152::version::checkVersion(arg4, 2);
    ...
    public fun depositTokenForOrderV2<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: u64, arg3: &mut CltVault<T0>, arg4: &mut 0x5339126dedf9bcd3b7f94bba745d3e9732398586f2a34ffcdf2189b814c5d152::archieve::UserArchieve, arg5: &0x5339126dedf9bcd3b7f94bba745d3e9732398586f2a34ffcdf2189b814c5d152::version::Version, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, DepositProof, u128) {
        ...
        assert!(0x2::bcs::peel_u64(&mut v1) == arg2, 1005);
        0x5339126dedf9bcd3b7f94bba745d3e9732398586f2a34ffcdf2189b814c5d152::archieve::verUpdateTokenPegNonce(v3, arg4);
        let v4 = DepositProof{
            owner   : v0,
            balance : v2,
        };
        let v5 = CltDeposited{
            ...
            nonce         : v3,
            balance       : v2,
            total_deposit : 0x5339126dedf9bcd3b7f94bba745d3e9732398586f2a34ffcdf2189b814c5d152::archieve::increaseTotalDeposit(v2, arg4),
        };
        0x2::event::emit<CltDeposited>(v5);
