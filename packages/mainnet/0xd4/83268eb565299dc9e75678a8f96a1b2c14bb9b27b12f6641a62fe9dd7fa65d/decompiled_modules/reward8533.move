module 0xd483268eb565299dc9e75678a8f96a1b2c14bb9b27b12f6641a62fe9dd7fa65d::reward8533 {
    struct REWARD8533 has drop {
        dummy_field: bool,
    }

    struct TICKET_8533 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8533(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8533>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8533>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8533, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8533>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8533>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8533>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8533>>(v5, 0x2::tx_context::sender(arg1));
    }
