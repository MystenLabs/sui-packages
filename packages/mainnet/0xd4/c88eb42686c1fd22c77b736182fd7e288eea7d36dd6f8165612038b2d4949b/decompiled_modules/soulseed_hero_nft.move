module 0xd4c88eb42686c1fd22c77b736182fd7e288eea7d36dd6f8165612038b2d4949b::soulseed_hero_nft {
    ...
    fun init(arg0: SOULSEED_HERO_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"SoulSeed Heroes v1"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"SoulSeed Heroes v1"));
