module 0xd4820657ad1432fd8b6ca4a16be4f559f4953633eeca8f80fc68f8d748bb8c3b::cnsnft8865 {
    struct CNSNFT8865 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8865, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8865>(arg0, arg1);
