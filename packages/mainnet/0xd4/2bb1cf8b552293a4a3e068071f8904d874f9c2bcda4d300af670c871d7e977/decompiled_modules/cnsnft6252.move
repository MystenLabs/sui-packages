module 0xd42bb1cf8b552293a4a3e068071f8904d874f9c2bcda4d300af670c871d7e977::cnsnft6252 {
    struct CNSNFT6252 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6252, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6252>(arg0, arg1);
