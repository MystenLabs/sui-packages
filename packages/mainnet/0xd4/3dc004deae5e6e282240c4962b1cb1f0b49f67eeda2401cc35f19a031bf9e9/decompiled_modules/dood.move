module 0xd43dc004deae5e6e282240c4962b1cb1f0b49f67eeda2401cc35f19a031bf9e9::dood {
    ...
    fun init(arg0: DOOD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/CfJ58KZpVvPm5ketxbUMmRMHZh41AWZh9qx8r9cspump.png                                                                                                                                                                                                                               ");
