module 0x66f505a9d843145e4b539d48287e923178a087dfea5fe4970c851d99a8cee738::kiosk_nft {
    ...
    public fun mint_nft(arg0: &mut Collection, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>, arg6: &mut 0x2::tx_context::TxContext) : Nft {
        assert!(arg0.version == 1, 0);
        assert!(arg0.minted < arg0.mint_supply, 2);
        assert!(arg0.creator == 0x2::tx_context::sender(arg6), 3);
