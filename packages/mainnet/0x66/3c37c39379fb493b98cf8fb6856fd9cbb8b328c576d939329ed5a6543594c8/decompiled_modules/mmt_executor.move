module 0x26dbf8790969ceda9f4cf175762beb11b07b83ec58b8dec4d41241d5a7badc45::mmt_executor {
    ...
    public(friend) fun exec_add_liquidity<T0, T1, T2, T3>(arg0: &mut MmtExecutorConfig, arg1: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T2, T3>, arg2: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg3: u32, arg4: u32, arg5: &mut 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::Vault<T0, T1>, arg6: &mut 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::VaultConfig, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        if (0x2::coin::value<T2>(&v5) > 0) {
            ...
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::add_harvest_assets<T0, T1, T2>(arg6, arg5, v5, v1);
        } else {
            0x2::coin::destroy_zero<T2>(v5);
        };
        if (0x2::coin::value<T3>(&v4) > 0) {
            v7 = arg8 - 0x2::coin::value<T3>(&v4);
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::add_harvest_assets<T0, T1, T3>(arg6, arg5, v4, v1);
        } else {
            0x2::coin::destroy_zero<T3>(v4);
        };
        emit_event_add_liquidity<T2, T3>(arg0, arg1, 0x2::object::id<0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::Vault<T0, T1>>(arg5), v0, v6, v7, arg3, arg4);
        (v6, v7)
    }
    ...
    public(friend) fun exec_add_liquidity_have_coin_a_in_vault<T0, T1, T2>(arg0: &mut MmtExecutorConfig, arg1: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T2>, arg2: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg3: u32, arg4: u32, arg5: &mut 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::Vault<T0, T1>, arg6: &mut 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::VaultConfig, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        if (0x2::coin::value<T0>(&v5) > 0) {
            ...
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::add_fund<T0, T1>(arg5, v5, arg12);
        } else {
            0x2::coin::destroy_zero<T0>(v5);
        };
        if (0x2::coin::value<T2>(&v4) > 0) {
            v7 = arg8 - 0x2::coin::value<T2>(&v4);
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::add_harvest_assets<T0, T1, T2>(arg6, arg5, v4, v1);
        } else {
            0x2::coin::destroy_zero<T2>(v4);
        };
        emit_event_add_liquidity<T0, T2>(arg0, arg1, 0x2::object::id<0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::Vault<T0, T1>>(arg5), v0, v6, v7, arg3, arg4);
        (v6, v7)
    }
    ...
    public(friend) fun exec_add_liquidity_have_coin_b_in_vault<T0, T1, T2>(arg0: &mut MmtExecutorConfig, arg1: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T2, T0>, arg2: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg3: u32, arg4: u32, arg5: &mut 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::Vault<T0, T1>, arg6: &mut 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::VaultConfig, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        if (0x2::coin::value<T0>(&v4) > 0) {
            ...
            0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::add_fund<T0, T1>(arg5, v4, arg12);
        } else {
            0x2::coin::destroy_zero<T0>(v4);
        };
        emit_event_add_liquidity<T2, T0>(arg0, arg1, 0x2::object::id<0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault::Vault<T0, T1>>(arg5), v0, v6, v7, arg3, arg4);
        (v6, v7)
    }
