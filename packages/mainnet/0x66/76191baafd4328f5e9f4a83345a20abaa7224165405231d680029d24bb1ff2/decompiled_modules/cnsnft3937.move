module 0x6676191baafd4328f5e9f4a83345a20abaa7224165405231d680029d24bb1ff2::cnsnft3937 {
    struct CNSNFT3937 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3937, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3937>(arg0, arg1);
