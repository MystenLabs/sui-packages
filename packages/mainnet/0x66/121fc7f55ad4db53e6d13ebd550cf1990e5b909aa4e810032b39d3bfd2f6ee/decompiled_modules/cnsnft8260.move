module 0x66121fc7f55ad4db53e6d13ebd550cf1990e5b909aa4e810032b39d3bfd2f6ee::cnsnft8260 {
    struct CNSNFT8260 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8260, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8260>(arg0, arg1);
