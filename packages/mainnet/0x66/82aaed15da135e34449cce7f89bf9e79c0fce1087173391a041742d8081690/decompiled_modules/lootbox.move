module 0x6682aaed15da135e34449cce7f89bf9e79c0fce1087173391a041742d8081690::lootbox {
    ...
    public fun create_lootbox_display<T0>(arg0: &AdminCap, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Lootbox<T0>>(&mut v0, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"ZLP Lootbox"));
        0x2::display::add<Lootbox<T0>>(&mut v0, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"ZLP Lootbox for your gains!"));
        0x2::display::add<Lootbox<T0>>(&mut v0, 0x1::string::utf8(b"link"), 0x1::string::utf8(b"https://zofai.io/"));
        0x2::display::add<Lootbox<T0>>(&mut v0, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(b"https://app.zofinance.io/"));
        0x2::display::add<Lootbox<T0>>(&mut v0, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"ZO Finance"));
        0x2::display::add<Lootbox<T0>>(&mut v0, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://img.zofinance.io/lootbox.webp"));
