module 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::lb_position {
    ...
    public(friend) fun collect_fees(arg0: &mut LBBinPosition, arg1: u128, arg2: u128) : (u64, u64, u64, u64) {
        let v0 = arg0.amount;
        let v1 = ((0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::mul_u128(v0, 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::sub_u128(arg1, arg0.fee_growth_inside_last_x)) >> 64) as u64);
        let v2 = ((0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::mul_u128(v0, 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::sub_u128(arg2, arg0.fee_growth_inside_last_y)) >> 64) as u64);
        arg0.collected_fees_x = 0;
        arg0.collected_fees_y = 0;
        arg0.fee_growth_inside_last_x = arg1;
        arg0.fee_growth_inside_last_y = arg2;
        (v1, v2, 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u64(arg0.collected_fees_x, v1), 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u64(arg0.collected_fees_y, v2))
    }
    ...
    public(friend) fun collect_reward(arg0: &mut LBBinPosition, arg1: u64, arg2: u128, arg3: u128) : u64 {
        ...
        *0x1::vector::borrow_mut<u128>(&mut arg0.reward_growth_inside_last, arg1) = arg2;
        0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::u128_to_u64(arg3 * 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::sub_u128(arg2, v0) >> 64)
    }
    ...
    public(friend) fun get_pending_fees(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u64(v0.collected_fees_x, ((v1 * (arg3 - v0.fee_growth_inside_last_x) >> 64) as u64)), 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u64(v0.collected_fees_y, ((v1 * (arg4 - v0.fee_growth_inside_last_y) >> 64) as u64)))
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 3) {
            ...
            v3 = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }
    ...
    public(friend) fun increase_bin_liquidity(arg0: &mut LBBinPosition, arg1: u128, arg2: u128, arg3: u128, arg4: vector<u128>, arg5: &mut vector<u64>, arg6: u128) {
        if (arg0.amount > 0) {
            let v0 = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::u128_to_u64(arg0.amount * 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::sub_u128(arg2, arg0.fee_growth_inside_last_x) >> 64);
            let v1 = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::u128_to_u64(arg0.amount * 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::sub_u128(arg3, arg0.fee_growth_inside_last_y) >> 64);
            arg0.collected_fees_x = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u64(arg0.collected_fees_x, v0);
            arg0.collected_fees_y = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u64(arg0.collected_fees_y, v1);
            let v2 = 0;
            ...
            while (v2 < v5) {
                ...
                if (v6 > v7) {
                    let v8 = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::u128_to_u64(0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::q64x64::liquidity_from_amounts(v0, v1, arg6) * (v6 - v7) >> 64);
                    if (v8 > 0) {
                        while (0x1::vector::length<u64>(arg5) <= v2) {
                            0x1::vector::push_back<u64>(arg5, 0);
                        };
                        *0x1::vector::borrow_mut<u64>(arg5, v2) = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u64(*0x1::vector::borrow<u64>(arg5, v2), v8);
                    };
                };
                v2 = v2 + 1;
            };
        };
        arg0.amount = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u128(arg0.amount, arg1);
        arg0.fee_growth_inside_last_x = arg2;
        arg0.fee_growth_inside_last_y = arg3;
        arg0.reward_growth_inside_last = arg4;
    }

    public(friend) fun increase_liquidity(arg0: &mut 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::bin_manager::BinManager, arg1: &mut LBPositionManager, arg2: &mut LBPosition, arg3: vector<u32>, arg4: vector<u128>, arg5: vector<u128>, arg6: vector<u128>, arg7: vector<u128>) {
        let v0 = 0x1::vector::length<u32>(&arg3);
        if (v0 == 0) {
            return
        };
        assert!(v0 <= 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::constants::max_bins_per_operation(), 204);
        let v1 = borrow_position_info_mut(arg1, arg2);
        let v2 = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::bin_manager::borrow_bins_table_mut(arg0);
        let v3 = 0;
        let v4 = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::constants::max_u32();
        let v5 = PackedBins{
            active_bins_bitmap : 0,
            bin_data           : 0x1::vector::empty<LBBinPosition>(),
        };
        let v6 = &mut v5;
        let v7 = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::bin_manager::create_empty_pack();
        let v8 = &mut v7;
        while (v3 < v0) {
            ...
            if (v12 != v4) {
                ...
                v8 = 0x2::table::borrow_mut<u32, 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::bin_manager::PackedBins>(v2, v12);
                v4 = v12;
            };
            if (is_bin_active_in_bitmap(v6.active_bins_bitmap, v13)) {
                ...
                if (v15.amount > 0) {
                    let v16 = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::u128_to_u64(v15.amount * 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::sub_u128(v10, v15.fee_growth_inside_last_x) >> 64);
                    let v17 = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::u128_to_u64(v15.amount * 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::sub_u128(v11, v15.fee_growth_inside_last_y) >> 64);
                    v15.collected_fees_x = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u64(v15.collected_fees_x, v16);
                    v15.collected_fees_y = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u64(v15.collected_fees_y, v17);
                    let v18 = 0;
                    ...
                    while (v18 < v21) {
                        ...
                        if (v22 > v23) {
                            let v24 = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::u128_to_u64(0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::q64x64::liquidity_from_amounts(v16, v17, 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::bin_manager::get_price(0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::bin_manager::get_bin_mut_from_pack(v8, 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::bin_manager::get_bin_index_in_pack(v8, v13)))) * (v22 - v23) >> 64);
                            if (v24 > 0) {
                                while (0x1::vector::length<u64>(&arg2.saved_rewards) <= v18) {
                                    0x1::vector::push_back<u64>(&mut arg2.saved_rewards, 0);
                                };
                                *0x1::vector::borrow_mut<u64>(&mut arg2.saved_rewards, v18) = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u64(*0x1::vector::borrow<u64>(&arg2.saved_rewards, v18), v24);
                            };
                        };
                        v18 = v18 + 1;
                    };
                };
                v15.amount = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u128(v15.amount, *0x1::vector::borrow<u128>(&arg4, v3));
                v15.fee_growth_inside_last_x = v10;
                v15.fee_growth_inside_last_y = v11;
                v15.reward_growth_inside_last = arg7;
            } else {
                if (arg2.total_bins + 1 > 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::constants::max_bins_in_position()) {
                    abort 205
                };
    ...
    public(friend) fun increase_position_total_bins(arg0: &mut LBPosition, arg1: u64) {
        if (arg0.total_bins + arg1 > 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::constants::max_bins_in_position()) {
            abort 205
        };
    ...
    public(friend) fun remove_bin(arg0: &mut LBPositionManager, arg1: &mut LBPosition, arg2: u32) : bool {
        ...
        arg1.total_bins = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::sub_u64(arg1.total_bins, 1);
    ...
    public(friend) fun remove_bins(arg0: &mut LBPositionManager, arg1: &mut LBPosition, arg2: vector<u32>) {
        ...
        while (v3 < v0) {
            ...
            if (v7 != v4) {
                let v9 = if (v4 != 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::constants::max_u32()) {
        ...
        let v10 = if (v4 != 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::constants::max_u32()) {
            if (v6.active_bins_bitmap == 0) {
                !0x1::vector::contains<u32>(&v2, &v4)
            } else {
                false
    ...
    public(friend) fun save_reward(arg0: &mut LBPosition, arg1: u64, arg2: u64) {
        if (arg2 > 0) {
            ...
            *0x1::vector::borrow_mut<u64>(&mut arg0.saved_rewards, arg1) = 0x74d0b73e246c40e8065ddcdf28f8478bd523fcb705c3307d8e89465b4e62e993::safe_math::add_u64(*0x1::vector::borrow<u64>(&arg0.saved_rewards, arg1), arg2);
        };
    }
