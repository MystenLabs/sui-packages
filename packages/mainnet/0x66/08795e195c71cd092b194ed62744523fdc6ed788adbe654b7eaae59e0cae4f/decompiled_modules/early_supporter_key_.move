module 0x6608795e195c71cd092b194ed62744523fdc6ed788adbe654b7eaae59e0cae4f::early_supporter_key_ {
    struct EARLY_SUPPORTER_KEY_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: EARLY_SUPPORTER_KEY_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<EARLY_SUPPORTER_KEY_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Early supporter key "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Early supporter key is proof of early users, Holders of early key have a chance to big reward."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreicv66cay2hobcqc572lyg43hc3eq7zhwlcnszlkknuzudqek46m5i"));
