module 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::storage {
    ...
    public(friend) fun create_emode_pair(arg0: &mut Storage, arg1: EmodeAsset, arg2: EmodeAsset) {
        ...
        assert!(arg1.assetId < arg2.assetId, 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::invalid_value());
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_emode_pair_created(v2, arg1.assetId, arg2.assetId, get_market_id(arg0));
    }
    ...
    public(friend) fun create_new_market(arg0: &mut Storage, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1.is_main_market, 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::invalid_function_call());
        let v2 = Storage{
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_market_created(v6.market_id);
    ...
    fun decrease_balance(arg0: &mut TokenBalance, arg1: address, arg2: u256) {
        ...
        assert!(v0 >= arg2, 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::insufficient_balance());
    ...
    public(friend) fun enter_emode(arg0: &mut Storage, arg1: u64, arg2: address) {
        ...
        let v0 = EMODE_KEY{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<EMODE_KEY, Emode>(&mut arg0.id, v0);
        assert!(0x2::table::borrow<u64, EmodeConfig>(&v1.emodes_pair, arg1).isActive, 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::emode_is_not_active());
        assert!(!0x2::table::contains<address, u64>(&v1.user_emode_id, arg2), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::duplicate_emode());
        0x2::table::add<address, u64>(&mut v1.user_emode_id, arg2, arg1);
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_emode_user_state_changed(arg2, arg1, true, get_market_id(arg0));
    }
    ...
    public(friend) fun exit_emode(arg0: &mut Storage, arg1: address) {
        ...
        let v0 = EMODE_KEY{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<EMODE_KEY, Emode>(&mut arg0.id, v0);
        assert!(0x2::table::contains<address, u64>(&v1.user_emode_id, arg1), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::not_in_emode());
        0x2::table::remove<address, u64>(&mut v1.user_emode_id, arg1);
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_emode_user_state_changed(arg1, *0x2::table::borrow<address, u64>(&v1.user_emode_id, arg1), false, get_market_id(arg0));
    }
    ...
    public fun get_borrow_weight(arg0: &Storage, arg1: u8) : u64 {
        ...
        if (0x2::table::contains<u8, u64>(v1, arg1)) {
            *0x2::table::borrow<u8, u64>(v1, arg1)
            ...
            0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::constants::percentage_benchmark()
        }
    }
    ...
    fun get_emode_asset(arg0: &Storage, arg1: u64, arg2: u8) : &EmodeAsset {
        ...
        if (v1.assetA.assetId == arg2) {
            ...
            assert!(v1.assetB.assetId == arg2, 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::not_in_emode());
            &v1.assetB
        }
    }
    ...
    fun init_main_market(arg0: &mut Storage) {
        let v0 = MARKET_KEY{dummy_field: false};
        assert!(!0x2::dynamic_field::exists_<MARKET_KEY>(&arg0.id, v0), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::invalid_function_call());
    ...
    public entry fun init_reserve<T0>(arg0: &StorageAdminCap, arg1: &0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::pool::PoolAdminCap, arg2: &0x2::clock::Clock, arg3: &mut Storage, arg4: u8, arg5: bool, arg6: u256, arg7: u256, arg8: u256, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: u256, arg14: u256, arg15: u256, arg16: u256, arg17: u256, arg18: &0x2::coin::CoinMetadata<T0>, arg19: &mut 0x2::tx_context::TxContext) {
        version_verification(arg3);
        let v0 = arg3.reserves_count;
        assert!(v0 < 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::constants::max_number_of_reserves(), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::no_more_reserves_allowed());
        ...
        let v5 = ReserveData{
            ...
            current_supply_index  : 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::ray_math::ray(),
            current_borrow_index  : 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::ray_math::ray(),
            supply_balance        : v1,
            borrow_balance        : v2,
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::pool::create_pool_with_market_id<T0>(arg1, 0x2::coin::get_decimals<T0>(arg18), 0x2::dynamic_field::borrow<MARKET_KEY, MarketInfo>(&arg3.id, v6).market_id, arg19);
    }
    ...
    fun percentage_ray_validation(arg0: u256) {
        assert!(arg0 <= 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::ray_math::ray(), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::invalid_value());
    }
    ...
    public(friend) fun remove_borrow_weight(arg0: &mut Storage, arg1: u8) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_borrow_weight_removed(arg1, get_market_id(arg0));
    }
    ...
    public fun reserve_validation<T0>(arg0: &Storage) {
        ...
        while (v0 < arg0.reserves_count) {
            assert!(0x2::table::borrow<u8, ReserveData>(&arg0.reserves, v0).coin_type != 0x1::type_name::into_string(0x1::type_name::get<T0>()), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::duplicate_reserve());
            v0 = v0 + 1;
        };
    }
    ...
    public fun set_base_rate(arg0: &OwnerCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_storage_params_updated(arg2, 0x1::ascii::string(b"base_rate"), arg3, get_market_id(arg1));
    }
    ...
    public fun set_borrow_cap(arg0: &OwnerCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_storage_params_updated(arg2, 0x1::ascii::string(b"borrow_cap_ceiling"), arg3, get_market_id(arg1));
    }

    public(friend) fun set_borrow_weight(arg0: &mut Storage, arg1: u8, arg2: u64) {
        version_verification(arg0);
        assert!(arg2 <= 10 * 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::constants::percentage_benchmark(), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::invalid_value());
        assert!(arg2 >= 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::constants::percentage_benchmark(), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::invalid_value());
        let v0 = BORROW_WEIGHT_KEY{dummy_field: false};
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_borrow_weight_set(arg1, arg2, get_market_id(arg0));
    }
    ...
    public(friend) fun set_designated_liquidators(arg0: &mut Storage, arg1: address, arg2: address, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_liquidator_set(arg1, arg2, arg3, get_market_id(arg0));
    }
    ...
    public(friend) fun set_emode_asset_liquidation_bonus(arg0: &mut Storage, arg1: u64, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_emode_param_set(arg1, arg2, arg3, 0x1::ascii::string(b"liquidation_bonus"), get_market_id(arg0));
    }
    ...
    public(friend) fun set_emode_asset_lt(arg0: &mut Storage, arg1: u64, arg2: u8, arg3: u256) {
        ...
        percentage_ray_validation(arg3);
        v0.lt = arg3;
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_emode_param_set(arg1, arg2, arg3, 0x1::ascii::string(b"lt"), get_market_id(arg0));
    }
    ...
    public(friend) fun set_emode_asset_ltv(arg0: &mut Storage, arg1: u64, arg2: u8, arg3: u256) {
        ...
        percentage_ray_validation(arg3);
        v0.ltv = arg3;
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_emode_param_set(arg1, arg2, arg3, 0x1::ascii::string(b"ltv"), get_market_id(arg0));
    }
    ...
    public(friend) fun set_emode_config_active(arg0: &mut Storage, arg1: u64, arg2: bool) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_emode_active_set(arg1, arg2, get_market_id(arg0));
    }
    ...
    public fun set_jump_rate_multiplier(arg0: &OwnerCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_storage_params_updated(arg2, 0x1::ascii::string(b"jump_rate_multiplier"), arg3, get_market_id(arg1));
    }
    ...
    public fun set_liquidation_bonus(arg0: &OwnerCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_storage_params_updated(arg2, 0x1::ascii::string(b"liquidation_bonus"), arg3, get_market_id(arg1));
    }
    ...
    public fun set_liquidation_ratio(arg0: &OwnerCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_storage_params_updated(arg2, 0x1::ascii::string(b"liquidation_ratio"), arg3, get_market_id(arg1));
    }
    ...
    public fun set_liquidation_threshold(arg0: &OwnerCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_storage_params_updated(arg2, 0x1::ascii::string(b"liquidation_threshold"), arg3, get_market_id(arg1));
    }
    ...
    public fun set_ltv(arg0: &OwnerCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_storage_params_updated(arg2, 0x1::ascii::string(b"ltv"), arg3, get_market_id(arg1));
    }
    ...
    public fun set_multiplier(arg0: &OwnerCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_storage_params_updated(arg2, 0x1::ascii::string(b"multiplier"), arg3, get_market_id(arg1));
    }
    ...
    public fun set_optimal_utilization(arg0: &OwnerCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_storage_params_updated(arg2, 0x1::ascii::string(b"optimal_utilization"), arg3, get_market_id(arg1));
    }

    public entry fun set_pause(arg0: &OwnerCap, arg1: &mut Storage, arg2: bool) {
        version_verification(arg1);
        arg1.paused = arg2;
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_paused(arg2, get_market_id(arg1));
    }
    ...
    public(friend) fun set_protected_liquidation_users(arg0: &mut Storage, arg1: address, arg2: bool) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_protected_user_set(arg1, arg2, get_market_id(arg0));
    }
    ...
    public fun set_reserve_factor(arg0: &OwnerCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_storage_params_updated(arg2, 0x1::ascii::string(b"reserve_factor"), arg3, get_market_id(arg1));
    }
    ...
    public fun set_supply_cap(arg0: &OwnerCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_storage_params_updated(arg2, 0x1::ascii::string(b"supply_cap_ceiling"), arg3, get_market_id(arg1));
    }
    ...
    public fun set_treasury_factor(arg0: &OwnerCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        ...
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_storage_params_updated(arg2, 0x1::ascii::string(b"treasury_factor"), arg3, get_market_id(arg1));
    }
    ...
    public fun verify_emode_support(arg0: &Storage, arg1: address, arg2: u8, arg3: bool, arg4: bool) {
        assert!(is_passed_emode_restrictions(arg0, arg1, arg2, arg3, arg4), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::ineligible_for_emode());
    }

    public fun verify_market_storage_pool<T0>(arg0: &Storage, arg1: &0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::pool::Pool<T0>) {
        assert!(get_market_id(arg0) == 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::pool::get_market_id<T0>(arg1), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::unmatched_market_id());
    }

    public entry fun version_migrate(arg0: &StorageAdminCap, arg1: &mut Storage) {
        assert!(arg1.version < 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::version::this_version(), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::not_available_version());
        arg1.version = 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::version::this_version();
    }
    ...
    public fun when_liquidatable(arg0: &mut Storage, arg1: address, arg2: address) {
        assert!(is_liquidatable(arg0, arg1, arg2), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::not_liquidatable());
    }

    public fun when_not_paused(arg0: &Storage) {
        assert!(!pause(arg0), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::paused());
    }

    public fun withdraw_treasury<T0>(arg0: &StorageAdminCap, arg1: &0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::pool::PoolAdminCap, arg2: &mut Storage, arg3: u8, arg4: &mut 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::pool::Pool<T0>, arg5: u64, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        abort 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::invalid_function_call()
    }

    public fun withdraw_treasury_v2<T0>(arg0: &StorageAdminCap, arg1: &0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::pool::PoolAdminCap, arg2: &mut Storage, arg3: u8, arg4: &mut 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::pool::Pool<T0>, arg5: u64, arg6: address, arg7: &mut 0x3::sui_system::SuiSystemState, arg8: &mut 0x2::tx_context::TxContext) {
        version_verification(arg2);
        verify_market_storage_pool<T0>(arg2, arg4);
        assert!(get_coin_type(arg2, arg3) == 0x1::type_name::into_string(0x1::type_name::get<T0>()), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::invalid_coin_type());
        let (v0, _) = get_index(arg2, arg3);
        let v2 = 0x2::table::borrow_mut<u8, ReserveData>(&mut arg2.reserves, arg3);
        let v3 = v2.treasury_balance;
        let v4 = 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::safe_math::min((0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::pool::normal_amount<T0>(arg4, arg5) as u256), 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::ray_math::ray_mul(v3, v0));
        let v5 = 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::ray_math::ray_div(v4, v0);
        v2.treasury_balance = v3 - v5;
        decrease_total_supply_balance(arg2, arg3, v5);
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::pool::withdraw_reserve_balance_v2<T0>(arg1, arg4, 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::pool::unnormal_amount<T0>(arg4, (v4 as u64)), arg6, arg7, arg8);
        0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::event::emit_withdraw_treasury_event(0x2::tx_context::sender(arg8), arg6, arg3, v4, 0x2::object::uid_to_address(0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::pool::uid<T0>(arg4)), v3, get_treasury_balance(arg2, arg3), v0, get_market_id(arg2));
    }
