module 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::account {
    ...
    public(friend) fun create_child_account_cap(arg0: &AccountCap, arg1: &mut 0x2::tx_context::TxContext) : AccountCap {
        let v0 = arg0.owner;
        assert!(0x2::object::uid_to_address(&arg0.id) == v0, 0x66afec381f0efd7174a2b5eaf4f60a209bcd2bd7e0a46a2cf1317f16fe165fa7::error::required_parent_account_cap());
        AccountCap{
