module 0x667a525b430283da418bd86267e415530d41cf636bbc58ee379b9776f204ac36::kiosk_marketplace {
    ...
    public entry fun buy<T0: store + key>(arg0: &mut MarketplaceConfig, arg1: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v7 < v3, 105);
        let (v8, v9) = 0x2::kiosk::purchase<T0>(arg2, arg3, 0x2::coin::split<0x2::sui::SUI>(&mut v1, v3 - v7, arg5));
        ...
        let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg1, v9);
        0x2::transfer::public_transfer<T0>(v8, v0);
