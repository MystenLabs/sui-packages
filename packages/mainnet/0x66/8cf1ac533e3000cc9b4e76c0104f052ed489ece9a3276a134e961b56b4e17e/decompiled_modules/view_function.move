module 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::view_function {
    public(friend) fun get_user_share_data_bcs(arg0: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::typus_hedge::Registry, arg2: vector<u64>, arg3: &0x2::tx_context::TxContext) : vector<vector<u8>> {
        ...
        while (!0x1::vector::is_empty<u64>(&arg2)) {
            ...
            let (v3, v4, v5) = 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::typus_hedge::get_vault_shares(arg1, v2);
    ...
    public(friend) fun get_vault_data_bcs(arg0: &0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::typus_hedge::Registry, arg1: vector<u64>) : vector<vector<u8>> {
        let v0 = 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::typus_hedge::registry_uid(arg0);
        ...
        while (!0x1::vector::is_empty<u64>(&arg1)) {
            ...
            if (0x2::dynamic_object_field::exists_<u64>(v0, v2)) {
                0x1::vector::push_back<vector<u8>>(&mut v1, 0x1::bcs::to_bytes<0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::typus_hedge::Vault>(0x2::dynamic_object_field::borrow<u64, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::typus_hedge::Vault>(v0, v2)));
            };
        };
        v1
    }
