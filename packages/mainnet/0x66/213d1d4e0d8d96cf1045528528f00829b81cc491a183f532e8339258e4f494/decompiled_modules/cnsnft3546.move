module 0x66213d1d4e0d8d96cf1045528528f00829b81cc491a183f532e8339258e4f494::cnsnft3546 {
    struct CNSNFT3546 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3546, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3546>(arg0, arg1);
