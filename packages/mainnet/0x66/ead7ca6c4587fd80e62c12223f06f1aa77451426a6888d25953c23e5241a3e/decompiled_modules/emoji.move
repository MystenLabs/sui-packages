module 0x66ead7ca6c4587fd80e62c12223f06f1aa77451426a6888d25953c23e5241a3e::emoji {
    ...
    fun init(arg0: EMOJI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<EMOJI>(arg0, 2, b"PEPO", b"", b"", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
