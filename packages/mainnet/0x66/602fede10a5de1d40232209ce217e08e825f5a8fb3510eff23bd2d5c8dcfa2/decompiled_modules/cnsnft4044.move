module 0x66602fede10a5de1d40232209ce217e08e825f5a8fb3510eff23bd2d5c8dcfa2::cnsnft4044 {
    struct CNSNFT4044 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4044, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4044>(arg0, arg1);
