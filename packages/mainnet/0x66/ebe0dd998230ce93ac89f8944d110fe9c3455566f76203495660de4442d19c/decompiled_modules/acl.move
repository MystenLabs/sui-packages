module 0x66ebe0dd998230ce93ac89f8944d110fe9c3455566f76203495660de4442d19c::acl {
    struct Suaxronirqlakgb has key {
        id: 0x2::object::UID,
        coombuckets: 0x2::table::Table<0x1::ascii::String, Ccbvpimweffqras>,
    }

    struct Ccbvpimweffqras has store {
        coomer: address,
        zoomer: address,
        cooming: bool,
    ...
    public entry fun dwoxnosaelsszeb<T0: store + key>(arg0: &mut Suaxronirqlakgb, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Ccbvpimweffqras>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Ccbvpimweffqras>(&mut arg0.coombuckets, arg1);
    ...
    public entry fun dwwsrvdlzwxgfam(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Suaxronirqlakgb, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Ccbvpimweffqras>(&arg2.coombuckets, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Ccbvpimweffqras>(&mut arg2.coombuckets, arg3);
        if (v0.cooming) {
    ...
    public entry fun elrvgixfqbgnnja<T0>(arg0: &mut Suaxronirqlakgb, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Ccbvpimweffqras>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Ccbvpimweffqras>(&mut arg0.coombuckets, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.zoomer, 0);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Suaxronirqlakgb{
            id          : 0x2::object::new(arg0),
            coombuckets : 0x2::table::new<0x1::ascii::String, Ccbvpimweffqras>(arg0),
        };
        0x2::transfer::share_object<Suaxronirqlakgb>(v0);
    }

    public entry fun jgkrkperhdqxlpn(arg0: &mut Suaxronirqlakgb, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Ccbvpimweffqras{
        ...
        0x2::table::add<0x1::ascii::String, Ccbvpimweffqras>(&mut arg0.coombuckets, arg1, v0);
    }

    public entry fun lxuscxvtnjtgqde(arg0: &mut Suaxronirqlakgb, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Ccbvpimweffqras>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Ccbvpimweffqras>(&mut arg0.coombuckets, arg1);
    ...
    public entry fun vrpfewficovnkvn(arg0: &mut Suaxronirqlakgb, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Ccbvpimweffqras>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Ccbvpimweffqras>(&mut arg0.coombuckets, arg1);
    ...
    public entry fun zcezmbdgusdvsof(arg0: &mut Suaxronirqlakgb, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<0x1::ascii::String, Ccbvpimweffqras>(&arg0.coombuckets, arg1)) {
            let v4 = 0x2::table::borrow_mut<0x1::ascii::String, Ccbvpimweffqras>(&mut arg0.coombuckets, arg1);
            ...
            0x2::table::add<0x1::ascii::String, Ccbvpimweffqras>(&mut arg0.coombuckets, arg1, v5);
        };
    }
