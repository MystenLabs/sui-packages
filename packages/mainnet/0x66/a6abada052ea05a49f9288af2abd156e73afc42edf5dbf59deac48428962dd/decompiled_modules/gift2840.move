module 0x66a6abada052ea05a49f9288af2abd156e73afc42edf5dbf59deac48428962dd::gift2840 {
    struct GIFT2840 has drop {
        dummy_field: bool,
    }

    struct TICKET_2840 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2840(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2840>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2840>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2840, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2840>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2840>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2840>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2840>>(v5, 0x2::tx_context::sender(arg1));
    }
