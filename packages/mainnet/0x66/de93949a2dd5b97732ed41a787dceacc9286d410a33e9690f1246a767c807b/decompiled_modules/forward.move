module 0x66de93949a2dd5b97732ed41a787dceacc9286d410a33e9690f1246a767c807b::forward {
    ...
    public fun join(arg0: Offer, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &Config, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : Forward {
        let Offer {
            id             : v0,
            opener         : v1,
            opener_is_long : v2,
        ...
        assert!(feed_id_bytes(arg3) == x"23d7315113f5b1d3ba7a83604c44b94d79f4fd69af77f804fc7f920a6dc65744", 5);
        assert!(feed_id_bytes(arg4) == v4, 5);
        let v6 = read_price_wad(arg3, arg5);
        let v7 = read_price_wad(arg4, arg5);
        let (v8, v9) = apply_open_fee(v3, arg2.open_fee_bps);
        let (_, v11) = apply_open_fee(v3, arg2.open_fee_bps);
        let v12 = v5;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v13, arg6), arg2.treasury);
        let v15 = quote_margin_usd_wad(v8, v6);
        let (v16, v17, v18, v19) = if (v2) {
            (v1, 0x2::tx_context::sender(arg6), v12, v14)
        } else {
            (0x2::tx_context::sender(arg6), v1, v14, v12)
        };
        let v20 = Forward{
