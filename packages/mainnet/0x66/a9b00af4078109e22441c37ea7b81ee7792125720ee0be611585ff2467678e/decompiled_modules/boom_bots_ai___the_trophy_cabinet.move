module 0x66a9b00af4078109e22441c37ea7b81ee7792125720ee0be611585ff2467678e::boom_bots_ai___the_trophy_cabinet {
    struct BOOM_BOTS_AI___THE_TROPHY_CABINET has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BOOM_BOTS_AI___THE_TROPHY_CABINET, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BOOM_BOTS_AI___THE_TROPHY_CABINET>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Boom Bots AI - The Trophy Cabinet"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Welcome to the Boom Bots AI Trophy Cabinet! Explore our prestigious collection of trophies, crafted to honor the skill and dedication of our top players. Each trophy in this cabinet represents a pinnacle achievement in our AI-powered battles, showcasing exclusive designs and details that embody the spirit of competition within the Boom Bots universe. Whether you're aiming to claim your own spot among our champions or admiring the accomplishments of others, our Trophy Cabinet stands as a testament to excellence and camaraderie in our community. Discover these symbols of achievement and celebrate the champions of Boom Bots AI!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://D6twDc89QvzsS7N0qnKxK-24xhfiHuyRjOW4Hck1_wQ"));
