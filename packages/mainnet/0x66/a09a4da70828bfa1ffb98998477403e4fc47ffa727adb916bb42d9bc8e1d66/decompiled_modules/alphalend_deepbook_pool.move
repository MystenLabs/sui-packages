module 0x66a09a4da70828bfa1ffb98998477403e4fc47ffa727adb916bb42d9bc8e1d66::alphalend_deepbook_pool {
    struct Pool<phantom T0> has key {
        ...
        max_exchange_rate: 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::Number,
    }
    ...
    struct AutoCompoundingEvent<phantom T0> has copy, drop {
        pool_id: 0x2::object::ID,
        coin_type: 0x1::type_name::TypeName,
        profit: u64,
        fee_collected: u64,
    ...
    public(friend) fun create<T0>(arg0: &mut 0x2::coin_registry::CoinRegistry, arg1: &mut 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::MarginPool<T0>, arg2: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry::MarginRegistry, arg3: &0x2::clock::Clock, arg4: u8, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : (Pool<T0>, PoolAdminCap<T0>) {
        let v0 = 0x1::string::utf8(b"db");
        0x1::string::append(&mut v0, arg5);
        let v1 = 0x1::string::utf8(b"DeepBook Staked ");
        0x1::string::append(&mut v1, arg5);
        0x1::string::append(&mut v1, 0x1::string::utf8(b" from AlphaLend"));
        let (v2, v3) = 0x2::coin_registry::new_currency<DEEPBOOK_STAKED<T0>>(arg0, arg4, v0, v1, 0x1::string::utf8(b""), arg6, arg8);
        0x2::transfer::public_transfer<0x2::coin_registry::MetadataCap<DEEPBOOK_STAKED<T0>>>(0x2::coin_registry::finalize<DEEPBOOK_STAKED<T0>>(v2, arg8), 0x2::tx_context::sender(arg8));
        let v4 = Pool<T0>{
            ...
            supplier_cap        : 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::mint_supplier_cap(arg2, arg3, arg8),
            referrer            : 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::mint_supply_referral<T0>(arg1, arg2, arg3, arg8),
            collected_fees      : 0,
            version             : 2,
            last_refreshed_at   : 0x2::clock::timestamp_ms(arg3),
            max_exchange_rate   : 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(1),
        };
        (v4, create_pool_admin_cap<T0>(&v4, arg8))
    }
    ...
    fun refresh_total_deposited<T0>(arg0: &mut Pool<T0>, arg1: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::MarginPool<T0>, arg2: &0x2::clock::Clock) {
        ...
        let (v1, v2) = if (arg0.total_lst_supply > 0 && v0 > arg0.collected_fees) {
            let v3 = v0 - arg0.collected_fees;
            let v4 = 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::div(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(v3), 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(arg0.total_lst_supply));
            if (0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::gt(v4, arg0.max_exchange_rate)) {
                let v5 = 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::mul(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::sub(v4, arg0.max_exchange_rate), 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(arg0.total_lst_supply));
                let v6 = 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::to_u64(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::bps_round_up(v5, arg0.spread_fee_bps));
                arg0.max_exchange_rate = 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::div(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(v3 - v6), 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(arg0.total_lst_supply));
                (0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::to_u64(v5), v6)
            } else {
                (0, 0)
            }
        } else {
        ...
        let v7 = AutoCompoundingEvent<T0>{
            pool_id          : 0x2::object::id<Pool<T0>>(arg0),
            coin_type        : 0x1::type_name::with_defining_ids<T0>(),
            profit           : v1,
            fee_collected    : v2,
        ...
        0x2::event::emit<AutoCompoundingEvent<T0>>(v7);
    ...
    public fun withdraw<T0>(arg0: &mut Pool<T0>, arg1: &mut 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::MarginPool<T0>, arg2: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry::MarginRegistry, arg3: 0x2::coin::Coin<DEEPBOOK_STAKED<T0>>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        if (arg0.total_lst_supply == 0) {
            arg0.max_exchange_rate = 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(1);
        };
