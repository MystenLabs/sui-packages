module 0x66f9c1a157532275d36743e37eac0032928fb4013b8d8549d2f9afc9fef5aa2b::reward3010 {
    struct REWARD3010 has drop {
        dummy_field: bool,
    }

    struct TICKET_3010 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3010(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3010>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3010>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3010, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3010>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3010>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3010>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3010>>(v5, 0x2::tx_context::sender(arg1));
    }
