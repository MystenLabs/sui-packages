module 0x66ae7098d82f8a4d569f5cf4d0c5378fbf3d722dc74e350ed785a27c07b88b96::cnsnft2070 {
    struct CNSNFT2070 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2070, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2070>(arg0, arg1);
