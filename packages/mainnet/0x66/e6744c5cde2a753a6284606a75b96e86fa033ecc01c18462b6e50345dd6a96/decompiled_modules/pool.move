module 0x66e6744c5cde2a753a6284606a75b96e86fa033ecc01c18462b6e50345dd6a96::pool {
    ...
    public entry fun add_pool(arg0: &mut 0x66e6744c5cde2a753a6284606a75b96e86fa033ecc01c18462b6e50345dd6a96::launchpadINO::LaunchpadINO, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: u8, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg12);
        assert!(0x66e6744c5cde2a753a6284606a75b96e86fa033ecc01c18462b6e50345dd6a96::launchpadINO::get_vote_id(arg0) != 0x2::object::id_from_address(@0x7b), 135289670009);
        assert!(v0 == 0x66e6744c5cde2a753a6284606a75b96e86fa033ecc01c18462b6e50345dd6a96::launchpadINO::get_owner(arg0), 135289670003);
        let v1 = 0x2::object::new(arg12);
        0x2::object::uid_to_inner(&v1);
        let v2 = Pool{
            id                    : v1,
            launchpad_ino_id      : 0x66e6744c5cde2a753a6284606a75b96e86fa033ecc01c18462b6e50345dd6a96::launchpadINO::get_id(arg0),
        ...
        0x66e6744c5cde2a753a6284606a75b96e86fa033ecc01c18462b6e50345dd6a96::launchpadINO::add_more_pools(arg0, v3);
    ...
    public entry fun claim<T0: store + key>(arg0: &mut Pool, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::vec_map::get_mut<address, Buyer>(&mut arg0.buyers, &v0).claimed = 1;
    }
