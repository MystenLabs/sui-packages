module 0x66e6744c5cde2a753a6284606a75b96e86fa033ecc01c18462b6e50345dd6a96::voting {
    ...
    public entry fun create_vote(arg0: &mut 0x66e6744c5cde2a753a6284606a75b96e86fa033ecc01c18462b6e50345dd6a96::launchpadINO::LaunchpadINO, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(v0 == 0x66e6744c5cde2a753a6284606a75b96e86fa033ecc01c18462b6e50345dd6a96::launchpadINO::get_admin(), 0);
        ...
        0x66e6744c5cde2a753a6284606a75b96e86fa033ecc01c18462b6e50345dd6a96::launchpadINO::update_vote_id(arg0, v3);
    ...
    public entry fun update_vote(arg0: &mut Vote, arg1: u64, arg2: u64, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == 0x66e6744c5cde2a753a6284606a75b96e86fa033ecc01c18462b6e50345dd6a96::launchpadINO::get_admin(), 0);
        arg0.status = arg3;
