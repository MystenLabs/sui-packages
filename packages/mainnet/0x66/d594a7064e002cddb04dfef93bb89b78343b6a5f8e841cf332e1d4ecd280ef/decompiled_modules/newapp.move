module 0x6dc234e9a85395da22e63aaa15ea9f1e14ae039a1ce5dfca30f1189558c7419e::newapp {
    ...
    public entry fun withdraw<T0>(arg0: &mut Contract<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0.balance >= arg1, 1);
        v0.balance = v0.balance - arg1;
        let v1 = arg1 * (arg0.withdraw_charges as u64) / 100;
        let _ = arg1 - v1;
        let v3 = &mut arg0.global_network_statistics;
        v3.total_withdrawn_amount = v3.total_withdrawn_amount + arg1;
        let v4 = v1 / 2;
        let v5 = &mut arg0.prize_pool;
        v5.level5_gross = v5.level5_gross + v4 * 50 / 100;
        v5.level6_gross = v5.level6_gross + v4 * 30 / 100;
        v5.level7_gross = v5.level7_gross + v4 * 20 / 100;
    }
