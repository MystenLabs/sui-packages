module 0xf6190d582f88dc3301e060820ebe81b656d96f6bf71c0f6f2e0cf23cbde0339c::standing_order {
    ...
    struct RegistryPauseSet has copy, drop {
        paused: bool,
    }
    ...
    public fun create<T0>(arg0: &mut AutomationRegistry, arg1: 0x2::balance::Balance<T0>, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        new_shared<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6)
    }

    public fun create_v2<T0>(arg0: &mut AutomationRegistry, arg1: 0x2::balance::Balance<T0>, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x2::clock::timestamp_ms(arg6);
        assert!(arg5 >= v0, 413);
        assert!(arg5 - v0 <= 316224000000, 414);
        new_shared<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg7)
    }
    ...
    public fun execute_due<T0>(arg0: &AutomationRegistry, arg1: &mut StandingOrder<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 >= arg1.next_due_ms, 406);
        assert!(0x2::balance::value<T0>(&arg1.pot) >= arg1.amount_per, 407);
        let v1 = arg1.amount_per;
        arg1.released_total = arg1.released_total + v1;
        arg1.releases_done = arg1.releases_done + 1;
        arg1.next_due_ms = next_cursor_ms(arg1.next_due_ms, arg1.interval_ms, v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.pot, v1), arg3), arg1.recipient);
        let v2 = OrderExecuted{
        ...
        0x2::event::emit<OrderExecuted>(v2);
    }
    ...
    fun new_shared<T0>(arg0: &mut AutomationRegistry, arg1: 0x2::balance::Balance<T0>, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        assert!(arg3 > 0, 408);
        assert!(arg4 > 0, 405);
        assert!(arg4 >= 60000 && arg4 <= 31622400000, 412);
    ...
    fun next_cursor_ms(arg0: u64, arg1: u64, arg2: u64) : u64 {
        let v0 = saturating_add(arg0, arg1);
        if (v0 <= arg2) {
            saturating_add(arg2, arg1)
        } else {
            v0
        }
    }
    ...
    public fun set_paused(arg0: &mut AutomationRegistry, arg1: &AutomationAdminCap, arg2: bool) {
        assert!(arg0.paused != arg2, 415);
        arg0.paused = arg2;
        let v0 = RegistryPauseSet{paused: arg2};
        0x2::event::emit<RegistryPauseSet>(v0);
    }
