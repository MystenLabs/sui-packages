module 0x66b9566466336ac7c4a64f6b0cd789e6ecc85b0aaa5c247bb1be5d9ebc81084c::hop {
    struct HOP has drop {
        dummy_field: bool,
    }
    ...
    public entry fun publisher_payment(arg0: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut CoinWrapper, arg2: u64, arg3: 0x1::string::String, arg4: u64, arg5: &UpgradeVersion, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg5.version == 0, 2);
        assert!(arg2 != 0, 5);
        0x2::coin::join<0x2::sui::SUI>(&mut arg1.coin, 0x2::coin::split<0x2::sui::SUI>(arg0, arg2, arg6));
        let v0 = PublisherPaymentEvent{
            amount     : arg2,
            website_id : arg3,
            node_count : arg4,
        };
        0x2::event::emit<PublisherPaymentEvent>(v0);
    }
