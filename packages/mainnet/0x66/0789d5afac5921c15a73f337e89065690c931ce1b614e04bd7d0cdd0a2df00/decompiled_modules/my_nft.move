module 0x660789d5afac5921c15a73f337e89065690c931ce1b614e04bd7d0cdd0a2df00::my_nft {
    ...
    fun init(arg0: MY_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"I love Aragaki Yui! always~"));
        ...
        let v6 = MyNFT{
            ...
            name      : 0x1::string::utf8(b"Aragaki Yui"),
            image_url : 0x1::string::utf8(b"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMf7IFKBVMp8OCIQkww75L9bv9pUO0WAOLLA&s"),
        };
