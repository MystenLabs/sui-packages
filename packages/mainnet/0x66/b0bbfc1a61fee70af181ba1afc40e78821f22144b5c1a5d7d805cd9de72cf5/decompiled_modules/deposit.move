module 0x66b0bbfc1a61fee70af181ba1afc40e78821f22144b5c1a5d7d805cd9de72cf5::deposit {
    ...
    public fun deposit<T0, T1, T2>(arg0: &mut 0x66b0bbfc1a61fee70af181ba1afc40e78821f22144b5c1a5d7d805cd9de72cf5::vault::Vault<T0, T1, T2>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x1::option::Option<0x2::coin::Coin<T0>>, 0x1::option::Option<0x2::coin::Coin<T1>>) {
        assert!(0x66b0bbfc1a61fee70af181ba1afc40e78821f22144b5c1a5d7d805cd9de72cf5::vault::seed_balance<T0, T1, T2>(arg0) > 0, 4);
        assert!(0x2::coin::value<T0>(&arg3) > 0, 2);
        assert!(0x2::coin::value<T1>(&arg4) > 0, 3);
        let v0 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(0x66b0bbfc1a61fee70af181ba1afc40e78821f22144b5c1a5d7d805cd9de72cf5::vault::position_borrow<T0, T1, T2>(arg0));
        let v1 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg2, arg1, 0x66b0bbfc1a61fee70af181ba1afc40e78821f22144b5c1a5d7d805cd9de72cf5::vault::position_borrow_mut<T0, T1, T2>(arg0), 0x2::coin::value<T0>(&arg3), true, arg5);
        ...
        let v8 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(0x66b0bbfc1a61fee70af181ba1afc40e78821f22144b5c1a5d7d805cd9de72cf5::vault::position_borrow<T0, T1, T2>(arg0));
        let v9 = 0x66b0bbfc1a61fee70af181ba1afc40e78821f22144b5c1a5d7d805cd9de72cf5::vault::mint_vault_coin<T0, T1, T2>(arg0, v8 - v0, v0, arg6);
        emit_event(0x2::object::id<0x66b0bbfc1a61fee70af181ba1afc40e78821f22144b5c1a5d7d805cd9de72cf5::vault::Vault<T0, T1, T2>>(arg0), v0, v8, 0x2::coin::value<T2>(&v9), 0x2::coin::value<T0>(&v7), 0x2::coin::value<T1>(&v6));
        (v9, v4, v5)
    }

    public entry fun deposit_entry<T0, T1, T2>(arg0: &mut 0x66b0bbfc1a61fee70af181ba1afc40e78821f22144b5c1a5d7d805cd9de72cf5::vault::Vault<T0, T1, T2>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
