module 0x9817be432fe15732729b66953e8e845339300f9d4a0fff6f110272e90b772996::receipt {
    ...
    public(friend) fun receipt_id_mut(arg0: &mut Receipt) : &mut 0x2::object::UID {
        &mut arg0.id
    }

    public fun receipt_uid(arg0: &Receipt) : &0x2::object::UID {
        &arg0.id
    }
