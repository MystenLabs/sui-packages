module 0x66dd7f613ae28eccefeb386babb754cde2695ee430b787fbbec4225d677f7580::reward7879 {
    struct REWARD7879 has drop {
        dummy_field: bool,
    }

    struct TICKET_7879 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7879(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7879>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7879>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7879, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7879>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7879>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7879>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7879>>(v5, 0x2::tx_context::sender(arg1));
    }
