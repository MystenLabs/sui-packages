module 0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::auctions {
    ...
    public fun bid(arg0: &mut Auction, arg1: &mut 0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::user_stats::UserStatsRegistry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.highest_bidder != arg0.creator && 0x2::balance::value<0x2::sui::SUI>(&arg0.highest_bidder_deposit) > 0) {
            0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::user_stats::record_outbid(arg1, arg0.highest_bidder, v2, arg0.highest_bid, v1, arg4);
        ...
        0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::user_stats::record_bid(arg1, v0, v2, v1, arg4);
    ...
    public fun close_auction<T0: store + key>(arg0: &AdminCap, arg1: &mut Auction, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::dashboard::Dashboard, arg6: &mut 0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::user_stats::UserStatsRegistry, arg7: &mut 0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::leaderboard::Leaderboard, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1.highest_bid > 0) {
            ...
            0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::user_stats::record_auction_won(arg6, arg1.highest_bidder, v0, v1, arg9);
            0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::leaderboard::update_leaderboard(arg7, arg6, arg1.highest_bidder, arg9);
        };
        let v12 = 0;
        while (v12 < 0x1::vector::length<address>(&arg1.participants)) {
            let v13 = *0x1::vector::borrow<address>(&arg1.participants, v12);
            if (v13 != v2) {
                0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::user_stats::remove_active_bid(arg6, v13, v0);
            };
            v12 = v12 + 1;
        };
        arg1.active = false;
        0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::dashboard::remove_auction(arg5, v0, v1, v2, arg9);
    }

    public fun close_auction_no_policy<T0: store + key>(arg0: &AdminCap, arg1: &mut Auction, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &mut 0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::dashboard::Dashboard, arg5: &mut 0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::user_stats::UserStatsRegistry, arg6: &mut 0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::leaderboard::Leaderboard, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<Auction>(arg1);
        ...
        let v2 = arg1.highest_bidder;
        if (arg1.highest_bid > 0) {
            0x2::transfer::public_transfer<T0>(0x2::kiosk::take<T0>(arg2, arg3, arg1.nft_id), arg1.highest_bidder);
            ...
            0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::user_stats::record_auction_won(arg5, arg1.highest_bidder, v0, v1, arg8);
            0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::leaderboard::update_leaderboard(arg6, arg5, arg1.highest_bidder, arg8);
        };
        let v3 = 0;
        while (v3 < 0x1::vector::length<address>(&arg1.participants)) {
            let v4 = *0x1::vector::borrow<address>(&arg1.participants, v3);
            if (v4 != v2) {
                0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::user_stats::remove_active_bid(arg5, v4, v0);
            };
            v3 = v3 + 1;
        };
        arg1.active = false;
        0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::dashboard::remove_auction(arg4, v0, v1, v2, arg8);
    }

    public fun create<T0: store + key>(arg0: &mut 0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::dashboard::Dashboard, arg1: &mut 0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::user_stats::UserStatsRegistry, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::dashboard::add_auction(arg0, v3, arg7);
        0x66b158b3d63a48399386d2f61809137756cd864a288be29cc580700b98631f57::user_stats::record_auction_created(arg1, v0, v3, arg7);
