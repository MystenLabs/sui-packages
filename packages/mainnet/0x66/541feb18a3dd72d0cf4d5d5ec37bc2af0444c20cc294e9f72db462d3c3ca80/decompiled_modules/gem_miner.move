module 0x66541feb18a3dd72d0cf4d5d5ec37bc2af0444c20cc294e9f72db462d3c3ca80::gem_miner {
    ...
    public entry fun buy_gems(arg0: &mut GameState, arg1: &mut 0x66541feb18a3dd72d0cf4d5d5ec37bc2af0444c20cc294e9f72db462d3c3ca80::player_registry::Registry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = if (0x66541feb18a3dd72d0cf4d5d5ec37bc2af0444c20cc294e9f72db462d3c3ca80::player_registry::is_valid_referrer(arg1, arg3)) {
            let v3 = 0x66541feb18a3dd72d0cf4d5d5ec37bc2af0444c20cc294e9f72db462d3c3ca80::player_registry::get_player_address(arg1, arg3);
            if (v3 == v0) {
                arg0.ceo_address
            } else {
                v3
        ...
        if (v2 == arg0.ceo_address) {
            ...
            0x66541feb18a3dd72d0cf4d5d5ec37bc2af0444c20cc294e9f72db462d3c3ca80::player_registry::add_referral_reward(arg1, v2, arg2, arg4);
        };
    ...
    public entry fun hire_miners(arg0: &mut GameState, arg1: &mut 0x66541feb18a3dd72d0cf4d5d5ec37bc2af0444c20cc294e9f72db462d3c3ca80::player_registry::Registry, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x66541feb18a3dd72d0cf4d5d5ec37bc2af0444c20cc294e9f72db462d3c3ca80::player_registry::get_player_id(arg1, v0);
        let v4 = if (v3 != 0) {
            0x66541feb18a3dd72d0cf4d5d5ec37bc2af0444c20cc294e9f72db462d3c3ca80::player_registry::get_player_address(arg1, v3)
        } else {
            arg0.ceo_address
        };
        let v5 = calculate_egg_sell(v1, 0x2::balance::value<0x2::sui::SUI>(&arg0.balance), arg0.market_eggs) * 1 / 100;
        if (v5 > 0) {
            0x66541feb18a3dd72d0cf4d5d5ec37bc2af0444c20cc294e9f72db462d3c3ca80::player_registry::add_referral_reward(arg1, v4, 0x2::coin::take<0x2::sui::SUI>(&mut arg0.balance, v5, arg3), arg2);
        };
