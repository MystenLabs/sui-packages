module 0x660f548cc90212f259bb9845f07c5d7e13a9e6b131dafe1f26ff833fe9c571fc::vault_config {
    ...
    public(friend) fun borrow_withdraw_cap(arg0: &VaultTokenHolder) : &0x75f575353687734ab7c5910566fdb59e0c04e4fcffdf46c83fad8bc1b71450ee::cloud_wallet_config::QuickWithdrawCap {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0x75f575353687734ab7c5910566fdb59e0c04e4fcffdf46c83fad8bc1b71450ee::cloud_wallet_config::QuickWithdrawCap>(&arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"))
    }
    ...
    public fun remove_withdraw_cap(arg0: &VaultConfig, arg1: &mut VaultTokenHolder, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg1.id, 0x1::ascii::string(b"quick_withdraw_cap"))) {
            0x75f575353687734ab7c5910566fdb59e0c04e4fcffdf46c83fad8bc1b71450ee::cloud_wallet_config::delete_quick_withdraw_cap(0x2::dynamic_field::remove<0x1::ascii::String, 0x75f575353687734ab7c5910566fdb59e0c04e4fcffdf46c83fad8bc1b71450ee::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, 0x1::ascii::string(b"quick_withdraw_cap")));
        };
    }
    ...
    public fun set_cloud_wallet_withdraw_cap(arg0: &VaultConfig, arg1: &mut VaultTokenHolder, arg2: 0x2::transfer::Receiving<0x75f575353687734ab7c5910566fdb59e0c04e4fcffdf46c83fad8bc1b71450ee::cloud_wallet_config::QuickWithdrawCap>, arg3: &mut 0x2::tx_context::TxContext) {
        only_admin(arg0, arg3);
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg1.id, 0x1::ascii::string(b"quick_withdraw_cap"))) {
            0x75f575353687734ab7c5910566fdb59e0c04e4fcffdf46c83fad8bc1b71450ee::cloud_wallet_config::delete_quick_withdraw_cap(0x2::dynamic_field::remove<0x1::ascii::String, 0x75f575353687734ab7c5910566fdb59e0c04e4fcffdf46c83fad8bc1b71450ee::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, 0x1::ascii::string(b"quick_withdraw_cap")));
        };
        0x2::dynamic_field::add<0x1::ascii::String, 0x75f575353687734ab7c5910566fdb59e0c04e4fcffdf46c83fad8bc1b71450ee::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, 0x1::ascii::string(b"quick_withdraw_cap"), 0x2::transfer::public_receive<0x75f575353687734ab7c5910566fdb59e0c04e4fcffdf46c83fad8bc1b71450ee::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, arg2));
    }
