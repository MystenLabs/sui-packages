module 0x90de9a12e1b10d3ff28c57b231c28c1740dff4bb1c1781b951f5ed560a3779f9::ticket {
    ...
    public fun create_ticket(arg0: &0x90de9a12e1b10d3ff28c57b231c28c1740dff4bb1c1781b951f5ed560a3779f9::admin::AdminCap, arg1: u8, arg2: vector<vector<u8>>, arg3: vector<u8>, arg4: u16, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x8438f6d7b1efa6eb1fb7aa2cfa82667de6eaa8c6c1934a11e25b7aa0392417ab::multisig::check_if_sender_is_multisig_address(arg2, arg3, arg4, arg6), 5);
        let v0 = AdminTicket{
    ...
    public fun is_ticket_expired(arg0: &AdminTicket, arg1: &0x2::clock::Clock) : bool {
        0x2::clock::timestamp_ms(arg1) / 1000 >= arg0.created_at + 1200 + 1800
    }

    public fun is_ticket_ready(arg0: &AdminTicket, arg1: &0x2::clock::Clock) : bool {
        0x2::clock::timestamp_ms(arg1) / 1000 >= arg0.created_at + 1200
    }
