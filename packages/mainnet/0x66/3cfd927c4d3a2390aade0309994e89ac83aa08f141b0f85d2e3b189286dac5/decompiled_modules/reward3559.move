module 0x663cfd927c4d3a2390aade0309994e89ac83aa08f141b0f85d2e3b189286dac5::reward3559 {
    struct REWARD3559 has drop {
        dummy_field: bool,
    }

    struct TICKET_3559 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3559(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3559>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3559>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3559, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3559>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3559>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3559>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3559>>(v5, 0x2::tx_context::sender(arg1));
    }
