module 0xdc083ed335b5fe342cca1d5887530336246ed7d80da6bcecbc7c1becb88074ee::mycoin {
    ...
    public entry fun burnCoins(arg0: 0x2::coin::Coin<MYCOIN>, arg1: &mut BridgeState, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::string::length(&arg2) == 42, 117);
        arg1.nonce = arg1.nonce + 1;
        0x2::transfer::public_transfer<0x2::coin::Coin<MYCOIN>>(arg0, 0x2::address::from_u256(0));
        emitBridgeEvent(arg2, 0x2::tx_context::sender(arg4), true, 0x2::coin::value<MYCOIN>(&arg0), arg1.nonce, 0x2::clock::timestamp_ms(arg3));
    }
