module 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float {
    struct Float has copy, drop, store {
        value: u128,
    }

    public fun add(arg0: Float, arg1: Float) : Float {
        if (340282366920938463463374607431768211455 - arg1.value < arg0.value) {
    ...
    public fun div(arg0: Float, arg1: Float) : Float {
        ...
        if (arg0.value > 340282366920938463463374607431768211455 / 1000000000) {
            err_number_too_large();
        };
    ...
    public fun div_u64(arg0: Float, arg1: u64) : Float {
        ...
        Float{value: arg0.value / (arg1 as u128)}
    }
    ...
    public fun mul(arg0: Float, arg1: Float) : Float {
        if (arg1.value > 0 && 340282366920938463463374607431768211455 / arg1.value < arg0.value) {
            err_number_too_large();
        };
    ...
    public fun mul_u64(arg0: Float, arg1: u64) : Float {
        if (arg1 > 0 && 340282366920938463463374607431768211455 / (arg1 as u128) < arg0.value) {
            err_number_too_large();
        };
        Float{value: arg0.value * (arg1 as u128)}
    }
    ...
    public fun round(arg0: Float) : u64 {
        if (arg0.value > 340282366920938463463374607431768211455 - 1000000000 / 2) {
            err_number_too_large();
        };
