module 0x66be95b0fff012af998fa448d1991b7222ef713ad7121784a67f2a2f52726731::reward9743 {
    struct REWARD9743 has drop {
        dummy_field: bool,
    }

    struct TICKET_9743 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9743(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_9743>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9743, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9743>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9743>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9743>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9743>>(v5, 0x2::tx_context::sender(arg1));
    }
