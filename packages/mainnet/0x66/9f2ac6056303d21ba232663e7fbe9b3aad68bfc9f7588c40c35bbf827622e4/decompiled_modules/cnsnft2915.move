module 0x669f2ac6056303d21ba232663e7fbe9b3aad68bfc9f7588c40c35bbf827622e4::cnsnft2915 {
    struct CNSNFT2915 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2915, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8604"));
        let v4 = 0x2::package::claim<CNSNFT2915>(arg0, arg1);
