module 0x21da5a7c7eaba5a757d7f8bdb06818d9cda19d734d469a052252bad5764e7043::storage_lease {
    ...
    public fun renew_lease(arg0: &mut LeaseRegistry, arg1: &mut StorageLease, arg2: u64, arg3: 0x2::coin::Coin<0x21da5a7c7eaba5a757d7f8bdb06818d9cda19d734d469a052252bad5764e7043::sonar_token::SONAR_TOKEN>, arg4: &mut 0x2::coin::TreasuryCap<0x21da5a7c7eaba5a757d7f8bdb06818d9cda19d734d469a052252bad5764e7043::sonar_token::SONAR_TOKEN>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch(arg6);
        let v1 = 0x2::tx_context::sender(arg6);
        assert!(arg1.owner == v1, 7004);
        assert!(arg2 >= 365 && arg2 <= 1095, 7005);
        let v2 = arg5 / 100000;
        assert!(0x2::coin::value<0x21da5a7c7eaba5a757d7f8bdb06818d9cda19d734d469a052252bad5764e7043::sonar_token::SONAR_TOKEN>(&arg3) >= v2, 7003);
        0x2::balance::decrease_supply<0x21da5a7c7eaba5a757d7f8bdb06818d9cda19d734d469a052252bad5764e7043::sonar_token::SONAR_TOKEN>(0x2::coin::supply_mut<0x21da5a7c7eaba5a757d7f8bdb06818d9cda19d734d469a052252bad5764e7043::sonar_token::SONAR_TOKEN>(arg4), 0x2::coin::into_balance<0x21da5a7c7eaba5a757d7f8bdb06818d9cda19d734d469a052252bad5764e7043::sonar_token::SONAR_TOKEN>(0x2::coin::split<0x21da5a7c7eaba5a757d7f8bdb06818d9cda19d734d469a052252bad5764e7043::sonar_token::SONAR_TOKEN>(&mut arg3, v2, arg6)));
        if (0x2::coin::value<0x21da5a7c7eaba5a757d7f8bdb06818d9cda19d734d469a052252bad5764e7043::sonar_token::SONAR_TOKEN>(&arg3) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x21da5a7c7eaba5a757d7f8bdb06818d9cda19d734d469a052252bad5764e7043::sonar_token::SONAR_TOKEN>>(arg3, v1);
        } else {
            0x2::coin::destroy_zero<0x21da5a7c7eaba5a757d7f8bdb06818d9cda19d734d469a052252bad5764e7043::sonar_token::SONAR_TOKEN>(arg3);
        };
