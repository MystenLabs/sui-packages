module 0x668adf754387ad257fa6d71e92af8c660b9d3b2160cea33cf0d46578ec0889ca::cnsnft6293 {
    struct CNSNFT6293 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6293, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6293>(arg0, arg1);
