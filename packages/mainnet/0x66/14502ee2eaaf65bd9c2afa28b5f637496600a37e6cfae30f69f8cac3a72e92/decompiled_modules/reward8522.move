module 0x6614502ee2eaaf65bd9c2afa28b5f637496600a37e6cfae30f69f8cac3a72e92::reward8522 {
    struct REWARD8522 has drop {
        dummy_field: bool,
    }

    struct TICKET_8522 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8522(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8522>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8522>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8522, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8522>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8522>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8522>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8522>>(v5, 0x2::tx_context::sender(arg1));
    }
