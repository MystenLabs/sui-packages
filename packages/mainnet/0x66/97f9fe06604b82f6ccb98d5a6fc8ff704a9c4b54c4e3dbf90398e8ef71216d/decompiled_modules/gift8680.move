module 0x6697f9fe06604b82f6ccb98d5a6fc8ff704a9c4b54c4e3dbf90398e8ef71216d::gift8680 {
    struct GIFT8680 has drop {
        dummy_field: bool,
    }

    struct TICKET_8680 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8680(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8680>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8680>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8680, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8680>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8680>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8680>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8680>>(v5, 0x2::tx_context::sender(arg1));
    }
