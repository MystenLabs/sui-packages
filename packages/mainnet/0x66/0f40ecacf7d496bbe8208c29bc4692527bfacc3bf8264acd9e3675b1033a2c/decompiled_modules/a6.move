module 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::a6 {
    ...
    fun apply<T0, T1>(arg0: &mut A<T0, T1>, arg1: &0x9591a869747770ffd0ae181baf2aea8a8092ed00f3cc7d309c86cc309096d1e4::vault::Vault<T1>, arg2: &0x9591a869747770ffd0ae181baf2aea8a8092ed00f3cc7d309c86cc309096d1e4::aftermath_perp_adapter::PerpAccount<T0, T1>, arg3: &0x9591a869747770ffd0ae181baf2aea8a8092ed00f3cc7d309c86cc309096d1e4::config::LotusConfig, arg4: u64, arg5: 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::ClearingHouse<T1>, arg6: &mut 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::account::Account<T1>, arg7: &0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed_storage::PriceFeedStorage, arg8: &0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed_storage::PriceFeedStorage, arg9: u64, arg10: u64, arg11: u64, arg12: u8, arg13: u64, arg14: u64, arg15: u64, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        0x9591a869747770ffd0ae181baf2aea8a8092ed00f3cc7d309c86cc309096d1e4::vault::assert_executor<T1>(arg1, arg0.d, 0x2::tx_context::sender(arg17));
        ...
        let (v13, v14) = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::ad(arg11, v5, arg0.drift);
        let v15 = valid_time<T0, T1>(arg0, arg10, v1);
        let v16 = if (0x9591a869747770ffd0ae181baf2aea8a8092ed00f3cc7d309c86cc309096d1e4::config::version(arg3) == arg4) {
        ...
        arg0.b.f = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m0::lx(arg0.b.f, v31, arg0.tox_in, arg0.tox_out);
        arg0.x.f = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m0::lx(arg0.x.f, v32, arg0.tox_in, arg0.tox_out);
        if (arg0.b.f) {
            v18 = v18 | 256;
        };
        if (arg0.x.f) {
        ...
        let v33 = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::tg(arg11, arg12, arg13, false);
        let v34 = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::tg(arg11, arg12, arg13, true);
        let v35 = if (v33 > 0) {
            v33
        } else {
            v34
        ...
        let v38 = if (v37) {
            let (v39, _) = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::mkpd(true, v33, arg0.cost, v6, v9, v3, v2, arg0.off, v24);
            v39
        } else {
            0
        };
        ...
        let v42 = if (v41) {
            let (v43, _) = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::mkpd(false, v34, arg0.cost, v6, v9, v3, v2, arg0.off, v24);
            v43
        } else {
            0
        };
        let (v45, v46) = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m0::cx(v38, v42, v3, v2, v24, arg12);
        let v47 = v46;
        let v48 = v45;
        let v49 = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::rqd(arg0.b.o != 0, arg0.b.p, v45, true, econ_bound(v33, arg0.cost, true), arg0.improve, v24, arg0.b.e, v1, arg0.refresh);
        let v50 = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::rqd(arg0.x.o != 0, arg0.x.p, v46, false, econ_bound(v34, arg0.cost, false), arg0.improve, v24, arg0.x.e, v1, arg0.refresh);
        ...
        let v53 = if (v49 == 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_replace()) {
            if (v45 > 0) {
                v28 > 0
            } else {
                false
        ...
        let v54 = if (v50 == 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_replace()) {
            if (v46 > 0) {
                v29 > 0
            } else {
                false
        ...
        let v59 = false;
        let v60 = false;
        if (v49 != 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_keep() && arg0.b.o != 0) {
            let v61 = &mut arg5;
            ...
            v59 = v63;
        } else if (v49 == 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_keep() && arg0.b.o != 0) {
            v18 = v18 | 1;
        };
        if (v50 != 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_keep() && arg0.x.o != 0) {
            let v64 = &mut arg5;
            ...
            v60 = v66;
        } else if (v50 == 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_keep() && arg0.x.o != 0) {
            v18 = v18 | 8;
        };
        let v67 = if (v49 == 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_replace()) {
            if (v48 > 0) {
                v28 > 0
            } else {
                false
        ...
        let v68 = if (v50 == 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_replace()) {
            if (v47 > 0) {
                v29 > 0
            } else {
                false
