module 0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::vault {
    ...
    public fun new<T0, T1>(arg0: &0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::Stingray, arg1: 0x2::coin::TreasuryCap<T1>, arg2: &0x2::coin::CoinMetadata<T1>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        if (!0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::is_allowed_base<T0>(arg0)) {
        ...
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::vault_event::new_vault_event<T0, T1>(*0x2::object::uid_as_inner(&v1.id), arg3, 0x2::coin::get_decimals<T1>(arg2), arg4, false, arg6, 0x2::tx_context::sender(arg7));
    ...
    fun borrow_collector_mut<T0, T1>(arg0: &mut Vault<T0, T1>) : &mut 0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::collector::Collector<T0> {
        let v0 = ManagementKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<ManagementKey, 0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::collector::Collector<T0>>(&mut arg0.id, v0)
    }
    ...
    public fun buy_share<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::Stingray, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        if (arg0.is_individual && 0x2::tx_context::sender(arg4) != arg0.manager) {
            err_individual_vault();
        };
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::assert_version_not_allowed(arg1);
        let v0 = 0x2::coin::value<T0>(&arg2);
        let v1 = 0x2::coin::into_balance<T0>(arg2);
        let v2 = vault_total_base_amount<T0, T1>(arg0, arg1, arg3);
        let v3 = v2;
        let v4 = if (v2 != 0) {
            let v5 = calculate_platform_fee<T0, T1>(arg0, v2, arg1, arg3);
            0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::add_record<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id), v5);
            0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::fill_record<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id), &mut v1);
            let v6 = &mut v1;
            let v7 = record_and_fill_manager_fee<T0, T1>(arg0, v2 - v5, arg3, v6);
            v3 = v7;
            0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::from_fraction(0x2::balance::supply_value<T1>(&arg0.supply), v7)
        } else {
            0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::from(1)
        };
        let v8 = 0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::floor(0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::mul(v4, 0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::from(v0)));
        let v9 = 0x2::balance::increase_supply<T1>(&mut arg0.supply, v8);
        add_to_reserve<T0, T1, T0>(arg0, v1);
        arg0.latest_updated_ts = 0x2::clock::timestamp_ms(arg3);
        arg0.latest_value = v3 + 0x2::balance::value<T0>(&v1);
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::vault_event::buy_share_event<T0, ShareMetadata>(*0x2::object::uid_as_inner(&arg0.id), v0, v8);
    ...
    fun calculate_platform_fee<T0, T1>(arg0: &Vault<T0, T1>, arg1: u64, arg2: &0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::Stingray, arg3: &0x2::clock::Clock) : u64 {
        0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::floor(0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::mul_u64(0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::mul_u64(0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::div_u64(0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::vault_platform_fee(arg2), 31536000), (0x2::clock::timestamp_ms(arg3) - arg0.latest_updated_ts) / 1000), arg1))
    }
    ...
    public fun claim_management_fee<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultCap) : 0x2::balance::Balance<T0> {
        ...
        0x2::balance::withdraw_all<T0>(0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::collector::borrow_balance_mut<T0>(borrow_collector_mut<T0, T1>(arg0)))
    }
    ...
    public fun create_sell_share_request<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::Stingray, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::clock::Clock) : SellShareRequest<T0> {
        ...
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::add_record<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id), v3);
    ...
    public fun create_sell_share_request_by_stingray<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::Stingray, arg2: &0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::AdminCap, arg3: &0x2::clock::Clock) : SellShareRequest<T0> {
        let v0 = SellShareRequest<T0>{
            vault_id                 : *0x2::object::uid_as_inner(&arg0.id),
            burned_share             : 0,
            weight                   : 0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::from(0),
        ...
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::add_record<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id), calculate_platform_fee<T0, T1>(arg0, v1, arg1, arg3));
        let v2 = record_manager_fee<T0, T1>(arg0, v1, arg3);
        arg0.latest_updated_ts = 0x2::clock::timestamp_ms(arg3);
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::set_unclaimed_amount_to_zero<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id));
        v0.weight = get_fee_float(0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::unclaimed_base_amount<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id)), v2);
        let v3 = 0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::unclaimed_base_amount<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id));
    ...
    public fun create_sell_share_request_for_claiming_management_fee<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::Stingray, arg2: &VaultCap, arg3: &0x2::clock::Clock) : SellShareRequest<T0> {
        ...
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::add_record<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id), v2);
        arg0.latest_updated_ts = 0x2::clock::timestamp_ms(arg3);
        let v3 = v1 - v2;
        let v4 = v3;
        if (is_verified<T0, T1>(arg0) && !is_individual<T0, T1>(arg0)) {
            ...
            0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::collector::add_unclaimed_amount<T0>(v6, v5);
            v4 = v3 - v5;
            ...
            if (v3 > arg0.latest_value) {
                ...
                0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::collector::add_unclaimed_amount<T0>(v8, v7);
                v4 = v3 - v7;
            };
        };
        let v9 = borrow_collector_mut<T0, T1>(arg0);
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::collector::set_unclaimed_amount_to_zero<T0>(v9);
        v0.weight = get_fee_float(0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::collector::unclaimed_amount<T0>(v9), v4);
        let v10 = 0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::unclaimed_base_amount<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id));
    ...
    fun new_generated_state_proof_message<T0, T1>(arg0: &Vault<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<MainVault, MainVault> {
        ...
        let v3 = stamp();
        0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::set_info<MainVault, MainVault, vector<u8>, bool>(&mut v1, &v3, b"is_state_generated", true);
        v1
    }
    ...
    public fun put_asset_back_<T0, T1, T2: drop, T3>(arg0: &mut Vault<T0, T1>, arg1: &0x5c9f74b696f816c5bb02ddec2cf413160a0cca99dd2d2004f56b2ea9ef50c896::whitelist::Whitelist, arg2: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<T2, MainVault, T3>) {
        ...
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::vault_event::put_balance_event<T0, T1, T2, T3>(*0x2::object::uid_as_inner(&arg0.id), 0x2::balance::value<T3>(&v0));
    ...
    fun record_and_fill_manager_fee<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::balance::Balance<T0>) : u64 {
        if (arg0.is_verified && !arg0.is_individual) {
            ...
            0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::collector::add_unclaimed_amount<T0>(v1, v0);
            arg1 = arg1 - v0;
        } else if (!arg0.is_verified && !arg0.is_individual) {
            if (arg1 > arg0.latest_value && arg0.latest_value != 0) {
                ...
                0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::collector::add_unclaimed_amount<T0>(v3, v2);
                arg1 = arg1 - v2;
            };
        };
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::collector::fill_balance<T0>(borrow_collector_mut<T0, T1>(arg0), arg3);
        arg1
    }
    ...
    fun record_manager_fee<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock) : u64 {
        if (arg0.is_verified && !arg0.is_individual) {
            let v0 = calculate_management_fee_for_verified_manager<T0, T1>(arg0, arg1, arg2);
            0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::collector::add_unclaimed_amount<T0>(borrow_collector_mut<T0, T1>(arg0), v0);
            arg1 = arg1 - v0;
        } else if (!arg0.is_verified && !arg0.is_individual) {
            if (arg1 > arg0.latest_value) {
                let v1 = calculate_management_fee_for_common_manager<T0, T1>(arg0, arg1 - arg0.latest_value);
                0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::collector::add_unclaimed_amount<T0>(borrow_collector_mut<T0, T1>(arg0), v1);
                arg1 = arg1 - v1;
            };
        };
        arg1
    ...
    public fun repay_sell_share<T0, T1>(arg0: &Vault<T0, T1>, arg1: SellShareRequest<T0>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, RedeemSuccessReceipt) {
        ...
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::vault_event::sell_share_event<T0, T1>(*0x2::object::uid_as_inner(&arg0.id), 0x2::balance::value<T0>(&v11), v1);
    ...
    public fun supply_amount<T0, T1>(arg0: &Vault<T0, T1>) : u64 {
        0x2::balance::supply_value<T1>(&arg0.supply)
    }
    ...
    fun take_asset_out_<T0, T1, T2: drop, T3>(arg0: &mut Vault<T0, T1>, arg1: &0x5c9f74b696f816c5bb02ddec2cf413160a0cca99dd2d2004f56b2ea9ef50c896::whitelist::Whitelist, arg2: u64) : 0x2::balance::Balance<T3> {
        ...
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::vault_event::take_balance_event<T0, T1, T2, T3>(*0x2::object::uid_as_inner(&arg0.id), 0x2::balance::value<T3>(&v3));
        v3
    }
    ...
    public fun transfer_vault_cap<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: VaultCap, arg2: address) {
        0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::vault_event::vault_cap_transfer_event(*0x2::object::uid_as_inner(&arg0.id), arg0.manager, arg2);
        arg0.manager = arg2;
    ...
    public fun vault_total_base_amount<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::Stingray, arg2: &0x2::clock::Clock) : u64 {
        let v0 = 0;
        ...
        while (0x1::vector::length<0x1::type_name::TypeName>(&v1) > 0) {
            ...
            if (0x2::clock::timestamp_ms(arg2) - v3.last_update_ts > 0x25a3f08c0345a20273c9195b776b5edb95bf0053a411ba40e746e4d649169ca3::stingray::tolerance_ts(arg1)) {
