module 0x66273cc6272e6144b12f5112d4e053d2ba67111a6e7fe597cdf8303c2fc7114b::reward9476 {
    struct REWARD9476 has drop {
        dummy_field: bool,
    }

    struct TICKET_9476 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9476(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9476>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9476>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9476, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9476>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9476>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9476>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9476>>(v5, 0x2::tx_context::sender(arg1));
    }
