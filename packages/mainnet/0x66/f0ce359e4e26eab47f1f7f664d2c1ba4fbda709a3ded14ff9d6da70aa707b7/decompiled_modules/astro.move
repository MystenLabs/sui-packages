module 0x66f0ce359e4e26eab47f1f7f664d2c1ba4fbda709a3ded14ff9d6da70aa707b7::astro {
    ...
    fun init(arg0: ASTRO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<ASTRO>(arg0, 9, b"ASTRO", b"Astro", b"Astro Liquid NFT Token", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), true, arg1);
        let v3 = Store{
