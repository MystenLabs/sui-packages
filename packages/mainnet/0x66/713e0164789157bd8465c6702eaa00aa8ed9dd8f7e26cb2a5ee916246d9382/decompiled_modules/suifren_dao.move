module 0x66713e0164789157bd8465c6702eaa00aa8ed9dd8f7e26cb2a5ee916246d9382::suifren_dao {
    ...
    entry fun create_dao<T0: store + key>(arg0: &0x66713e0164789157bd8465c6702eaa00aa8ed9dd8f7e26cb2a5ee916246d9382::staking::AdminCap, arg1: &mut DaoHub, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = Dao<T0>{
    ...
    fun init(arg0: SUIFREN_DAO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = DaoHub{
    ...
    entry fun vote<T0: store + key>(arg0: &mut Dao<T0>, arg1: &0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::suifrens::SuiFren<T0>, arg2: 0x2::object::ID, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
