module 0x662dfc383d7861510d706e17c5f02f62414ba9070b29561a49317cd72347205f::portal {
    ...
    public fun deposit<T0>(arg0: &mut StockRegistry, arg1: &mut 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert_not_paused(arg0);
        assert!(arg2 > 0, 4);
        assert!(0x2::coin::value<T0>(arg1) >= arg2, 18);
        assert!(arg3 < 0x1::vector::length<address>(&arg0.vault_addresses), 6);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = 0x1::string::utf8(*0x1::ascii::as_bytes(0x1::type_name::as_string(&v0)));
        assert!(is_token_whitelisted(arg0, &v1), 11);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg1, arg2, arg4), *0x1::vector::borrow<address>(&arg0.vault_addresses, arg3));
        let v2 = DepositReceived{
            coin_type : v1,
            amount    : arg2,
            from      : 0x2::tx_context::sender(arg4),
        };
        0x2::event::emit<DepositReceived>(v2);
    }
    ...
    public fun get_total_supply<T0>(arg0: &WrappedTreasuryCap<T0>) : u64 {
    ...
    fun init_internal(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = MPCCap{
            id          : 0x2::object::new(arg0),
            mpc_address : @0x1edc108fff0653430f322528e21046ddd1e4ee52638d4f0ebc7f1251bd5e14eb,
            version     : 1,
        };
        let v2 = StockRegistry{
            ...
            current_mpc        : @0x1edc108fff0653430f322528e21046ddd1e4ee52638d4f0ebc7f1251bd5e14eb,
            admin_version      : 1,
            mpc_version        : 1,
        };
        0x2::transfer::public_transfer<AdminCap>(v0, @0x1edc108fff0653430f322528e21046ddd1e4ee52638d4f0ebc7f1251bd5e14eb);
        0x2::transfer::public_transfer<MPCCap>(v1, @0x1edc108fff0653430f322528e21046ddd1e4ee52638d4f0ebc7f1251bd5e14eb);
