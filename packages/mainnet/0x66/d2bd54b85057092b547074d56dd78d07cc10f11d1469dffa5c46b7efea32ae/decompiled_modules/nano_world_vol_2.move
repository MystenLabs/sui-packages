module 0x66d2bd54b85057092b547074d56dd78d07cc10f11d1469dffa5c46b7efea32ae::nano_world_vol_2 {
    ...
    fun init(arg0: NANO_WORLD_VOL_2, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"There is 2222 items, and each of them group in sets. When you will lock set you will able te get the daily airdrops in $NWCX tokens. More rarity sests more higher rewords."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiebus3nx47m4asox55o7swqkh7hd6cy25xeb4doq3r6jypfr2f7ii"));
