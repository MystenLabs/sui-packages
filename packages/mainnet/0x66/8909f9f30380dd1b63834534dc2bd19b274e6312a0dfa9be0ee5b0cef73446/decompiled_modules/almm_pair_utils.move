module 0xcd23d8f0a6e8b67d25499a722a4c989c6d01b97dee10f8c354bfbd42a6b3ebd9::almm_pair_utils {
    ...
    public(friend) fun auto_fill_x_by_weight(arg0: u32, arg1: u16, arg2: u64, arg3: u64, arg4: u64, arg5: vector<u32>, arg6: vector<u256>) : u64 {
        ...
        if (0x1::option::is_some<u256>(&v1)) {
            ...
            let v4 = 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_price::get_price_from_storage_id(arg0, arg1);
            let v5 = 0;
            let v6 = 0;
            if (arg3 == 0 && arg4 == 0) {
                v5 = (v3 << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / v4 * 2;
                v6 = v3 / 2;
            } else {
                if (arg3 > 0) {
                    v5 = (v3 << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / (v4 + ((arg4 as u256) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / (arg3 as u256));
                };
                if (arg4 > 0) {
                    v6 = (v3 << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / (0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale() + v4 * (arg3 as u256) / (arg4 as u256));
                };
            };
            let v7 = v5;
            let v8 = v6;
            ...
            while (v9 < 0x1::vector::length<u32>(&arg5)) {
                if (*0x1::vector::borrow<u32>(&arg5, v9) < arg0) {
                    ...
                    v7 = v7 + (*0x1::vector::borrow<u256>(&arg6, v9) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_price::get_price_from_storage_id(*0x1::vector::borrow<u32>(&arg5, v9), arg1);
                };
                v9 = v9 + 1;
            };
            let v10 = if (v8 == 0) {
                0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale() / 1000000000
            } else {
                ((arg2 as u256) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / v8
            };
            0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64(v10 * v7 >> 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset())
        } else {
            let v11 = 0;
            let v12 = 0;
            let v13 = 0;
            while (v13 < 0x1::vector::length<u32>(&arg5)) {
                if (*0x1::vector::borrow<u32>(&arg5, v13) < arg0) {
                    ...
                    v11 = v11 + (*0x1::vector::borrow<u256>(&arg6, v13) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_price::get_price_from_storage_id(*0x1::vector::borrow<u32>(&arg5, v13), arg1);
                };
                v13 = v13 + 1;
            };
            let v14 = if (v12 == 0) {
                ...
                ((arg2 as u256) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / v12
            };
            0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64(v14 * v11 >> 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset())
        }
    }
    ...
    public(friend) fun auto_fill_y_by_weight(arg0: u32, arg1: u16, arg2: u64, arg3: u64, arg4: u64, arg5: vector<u32>, arg6: vector<u256>) : u64 {
        ...
        if (0x1::option::is_some<u256>(&v1)) {
            ...
            let v10 = if (v7 == 0) {
                ...
                ((arg2 as u256) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / v7
            };
            0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64(v10 * v8 >> 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset())
        } else {
            let v11 = 0;
            let v12 = 0;
            let v13 = 0;
            ...
            let v14 = if (v11 == 0) {
                0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale()
            } else {
                ((arg2 as u256) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / v11
            };
            0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64(v14 * v12 >> 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset())
        }
    }
    ...
    public(friend) fun to_amount_ask_side(arg0: u32, arg1: u16, arg2: u64, arg3: vector<u32>, arg4: vector<u256>) : vector<u64> {
        ...
        while (v1 < 0x1::vector::length<u32>(&arg3)) {
            let v2 = if (*0x1::vector::borrow<u32>(&arg3, v1) < arg0) {
                ...
                (*0x1::vector::borrow<u256>(&arg4, v1) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_price::get_price_from_storage_id(*0x1::vector::borrow<u32>(&arg3, v1), arg1)
            };
            v0 = v0 + v2;
            v1 = v1 + 1;
        };
        ...
        while (v4 < 0x1::vector::length<u32>(&arg3)) {
            if (*0x1::vector::borrow<u32>(&arg3, v4) < arg0) {
                ...
                0x1::vector::push_back<u64>(&mut v3, 0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64((arg2 as u256) * (*0x1::vector::borrow<u256>(&arg4, v4) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_price::get_price_from_storage_id(*0x1::vector::borrow<u32>(&arg3, v4), arg1) / v0));
            };
            v4 = v4 + 1;
        };
        v3
    ...
    public(friend) fun to_amount_both_side(arg0: u32, arg1: u16, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u32>, arg7: vector<u256>) : (vector<u64>, vector<u64>) {
        ...
        if (0x1::option::is_some<u256>(&v6)) {
            ...
            let v9 = 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_price::get_price_from_storage_id(arg0, arg1);
            let v10 = 0;
            let v11 = 0;
            if (arg4 == 0 && arg5 == 0) {
                v10 = (v8 << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / v9 * 2;
                v11 = v8 / 2;
            } else {
                if (arg4 > 0) {
                    v10 = (v8 << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / (v9 + ((arg5 as u256) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / (arg4 as u256));
                };
                if (arg5 > 0) {
                    v11 = (v8 << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / (0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale() + v9 * (arg4 as u256) / (arg5 as u256));
                };
            };
            let v12 = v10;
            let v13 = v11;
            ...
            while (v14 < 0x1::vector::length<u32>(&arg6)) {
                ...
                if (*0x1::vector::borrow<u32>(&arg6, v14) > arg0) {
                    v12 = v12 + (*0x1::vector::borrow<u256>(&arg7, v14) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_price::get_price_from_storage_id(*0x1::vector::borrow<u32>(&arg6, v14), arg1);
                };
                v14 = v14 + 1;
            };
            ...
            while (v18 < 0x1::vector::length<u32>(&arg6)) {
                if (*0x1::vector::borrow<u32>(&arg6, v18) < arg0) {
                    ...
                    0x1::vector::push_back<u64>(&mut v0, 0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64(v17 * (*0x1::vector::borrow<u256>(&arg7, v18) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_price::get_price_from_storage_id(*0x1::vector::borrow<u32>(&arg6, v18), arg1) / 1000000000));
                    0x1::vector::push_back<u64>(&mut v1, 0);
                } else {
        ...
        while (v21 < 0x1::vector::length<u32>(&arg6)) {
            if (*0x1::vector::borrow<u32>(&arg6, v21) < arg0) {
                ...
                v19 = v19 + (*0x1::vector::borrow<u256>(&arg7, v21) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_price::get_price_from_storage_id(*0x1::vector::borrow<u32>(&arg6, v21), arg1);
            };
            v21 = v21 + 1;
        };
        ...
        while (v25 < 0x1::vector::length<u32>(&arg6)) {
            if (*0x1::vector::borrow<u32>(&arg6, v25) < arg0) {
                ...
                0x1::vector::push_back<u64>(&mut v0, 0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64(v24 * (*0x1::vector::borrow<u256>(&arg7, v25) << 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_constants::scale_offset()) / 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_price::get_price_from_storage_id(*0x1::vector::borrow<u32>(&arg6, v25), arg1) / 1000000000));
                0x1::vector::push_back<u64>(&mut v1, 0);
            };
            v25 = v25 + 1;
        };
