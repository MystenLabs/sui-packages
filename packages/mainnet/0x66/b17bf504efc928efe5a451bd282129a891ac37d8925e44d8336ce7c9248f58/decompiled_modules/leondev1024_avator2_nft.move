module 0x66b17bf504efc928efe5a451bd282129a891ac37d8925e44d8336ce7c9248f58::leondev1024_avator2_nft {
    struct LEONDEV1024_AVATOR2_NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LEONDEV1024_AVATOR2_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::package::claim<LEONDEV1024_AVATOR2_NFT>(arg0, arg1);
