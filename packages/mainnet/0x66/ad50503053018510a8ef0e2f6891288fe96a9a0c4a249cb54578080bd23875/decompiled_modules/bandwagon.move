module 0x66ad50503053018510a8ef0e2f6891288fe96a9a0c4a249cb54578080bd23875::bandwagon {
    ...
    fun init(arg0: BANDWAGON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::transfer::public_transfer<0x2::coin::Coin<BANDWAGON>>(0x2::coin::mint<BANDWAGON>(&mut v2, 6969 * 1000000000, arg1), 0x2::tx_context::sender(arg1));
