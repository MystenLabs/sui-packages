module 0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::staking {
    struct StakePool<phantom T0> has key {
        ...
        stake_models: 0x2::table::Table<0x2::object::ID, 0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::StakeModel>,
    }
    ...
    struct StakeRewardDepositedEvent has copy, drop {
        pool_id: 0x2::object::ID,
        asset_type: 0x1::type_name::TypeName,
        deposit_amount: u64,
    }

    struct StakeRewardWithdrawnEvent has copy, drop {
        pool_id: 0x2::object::ID,
        asset_type: 0x1::type_name::TypeName,
        withdraw_amount: u64,
    }

    struct StakeMaxRewardAmountSetEvent has copy, drop {
        pool_id: 0x2::object::ID,
        asset_type: 0x1::type_name::TypeName,
        max_reward_amount: u64,
    }
    ...
    public fun add_stake_model<T0>(arg0: &StakePoolCap, arg1: &mut StakePool<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::new(arg2, arg3, arg4, arg5);
        let v1 = 0x2::object::id<0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::StakeModel>(&v0);
        0x2::table::add<0x2::object::ID, 0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::StakeModel>(&mut arg1.stake_models, v1, v0);
    ...
    public fun create_stake_pool<T0>(arg0: &mut 0x2::tx_context::TxContext) : (StakePool<T0>, StakePoolCap) {
        let v0 = StakePool<T0>{
            ...
            stake_models              : 0x2::table::new<0x2::object::ID, 0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::StakeModel>(arg0),
        };
        let v1 = StakePoolCap{
            id  : 0x2::object::new(arg0),
            for : 0x2::object::id<StakePool<T0>>(&v0),
        };
        let v2 = StakePoolCreatedEvent{
            pool_id    : 0x2::object::id<StakePool<T0>>(&v0),
            asset_type : 0x1::type_name::get<T0>(),
        };
        0x2::event::emit<StakePoolCreatedEvent>(v2);
        (v0, v1)
    }
    ...
    public fun set_max_reward_amount<T0>(arg0: &StakePoolCap, arg1: &mut StakePool<T0>, arg2: u64) {
        ...
        let v0 = StakeMaxRewardAmountSetEvent{
            pool_id           : 0x2::object::id<StakePool<T0>>(arg1),
            asset_type        : 0x1::type_name::get<T0>(),
            max_reward_amount : arg2,
        };
        0x2::event::emit<StakeMaxRewardAmountSetEvent>(v0);
    }

    public fun set_stake_model_active_status<T0>(arg0: &StakePoolCap, arg1: &mut StakePool<T0>, arg2: 0x2::object::ID, arg3: bool) {
        assert_stake_cap<T0>(arg0, arg1);
        0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::set_active_status(0x2::table::borrow_mut<0x2::object::ID, 0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::StakeModel>(&mut arg1.stake_models, arg2), arg3);
    ...
    public fun stake<T0>(arg0: &mut StakePool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Stake<T0> {
        let v0 = 0x2::table::borrow<0x2::object::ID, 0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::StakeModel>(&arg0.stake_models, arg2);
        let v1 = 0x2::coin::value<T0>(&arg1);
        0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::assert_is_active(v0);
        let v2 = 0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::calculate_reward(v0, v1);
        ...
        let v4 = StakeEvent{
            ...
            stake_model_id      : arg2,
            stake_amount        : v1,
            lock_period_in_days : 0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::lock_period_in_days(v0),
            apr_numerator       : 0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::apr_numerator(v0),
            apr_denominator     : 0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::apr_denominator(v0),
        };
    ...
    public fun unstake<T0>(arg0: &mut StakePool<T0>, arg1: Stake<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::assert_is_unlocked(0x2::table::borrow<0x2::object::ID, 0x5c8de7e9d27e679f9e51e1ed957434b273937910bbe8926ef3bc6916133babd0::stake_model::StakeModel>(&arg0.stake_models, arg1.stake_model_id), arg1.staked_at, arg2);
    ...
    public fun withdraw_reward<T0>(arg0: &StakePoolCap, arg1: &mut StakePool<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_stake_cap<T0>(arg0, arg1);
        let v0 = StakeRewardWithdrawnEvent{
            pool_id         : 0x2::object::id<StakePool<T0>>(arg1),
            asset_type      : 0x1::type_name::get<T0>(),
            withdraw_amount : arg2,
        };
        0x2::event::emit<StakeRewardWithdrawnEvent>(v0);
