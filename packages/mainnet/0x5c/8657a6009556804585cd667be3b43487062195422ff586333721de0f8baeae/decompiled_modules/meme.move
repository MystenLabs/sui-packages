module 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme {
    ...
    public fun accept_connector<T0>(arg0: &mut MemeConfig, arg1: 0x2::transfer::Receiving<0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector::Connector<T0>>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::transfer::public_receive<0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector::Connector<T0>>(&mut arg0.id, arg1);
        let v1 = 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector::get_creator<T0>(&v0);
        let v2 = 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector::get_temp_id<T0>(&v0);
        ...
        let v5 = v3;
        assert!(0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector::get_supply<T0>(&v0) == 0, 6);
        assert!(0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector::get_decimals<T0>(&v0) == 6, 3);
    ...
    fun create_bonding_curve<T0>(arg0: 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector::Connector<T0>, arg1: &MemeConfig, arg2: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        enforce_config_version(arg1);
        0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector::get_creator<T0>(&arg0);
        let (v0, v1, v2, v3, v4, v5, v6) = 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::connector::deconstruct<T0>(arg0);
        let v7 = v2;
        let v8 = v1;
        ...
        0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::events::emit_curve_create<T0>(get_id<T0>(&v9), v3, 0x2::coin::get_name<T0>(&v7), 0x2::coin::get_symbol<T0>(&v7), 0x2::coin::get_description<T0>(&v7), 0x2::coin::get_icon_url<T0>(&v7), v4, v5, v6);
        v9
    }
