module 0x5ca9bb33b87b8f3c602720b885a0909014c93b3729f9e4ef8d8fa66852d112e5::executor {
    ...
    public fun add_liquidity_position<T0, T1>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &0x2::clock::Clock, arg4: u32, arg5: u32, arg6: u64, arg7: bool, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position {
        ...
        let (_, v9, v10) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::clmm_math::get_liquidity_by_amount(v3, v4, v6, v5, cap_amount(arg6, v2), arg7);
        let v11 = v10;
        let v12 = v9;
        ...
        assert!(v12 <= v0 && v11 <= v1, 13906834659674816515);
        ...
        let v22 = v21;
        let v23 = v20;
        let v24 = LiquidityAdded{
            position_key : arg9,
            tick_lower   : arg4,
            tick_upper   : arg5,
            amount_a     : v12 - 0x2::balance::value<T0>(&v23),
            amount_b     : v11 - 0x2::balance::value<T1>(&v22),
        };
        0x2::event::emit<LiquidityAdded>(v24);
    ...
    public fun collect_rewards_usdsui_usdc(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x44f838219cf67b058f3b37907b655f226153c18e33dfcd0da559a844fea9b1c1::usdsui::USDSUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<0x44f838219cf67b058f3b37907b655f226153c18e33dfcd0da559a844fea9b1c1::usdsui::USDSUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>(arg0)) {
            ...
            emit_reward_collected_if_nonzero<0x2::sui::SUI>(arg4, v1);
            if (v1 > 0) {
    ...
    fun emit_reward_collected_if_nonzero<T0>(arg0: u64, arg1: u64) {
        if (arg1 > 0) {
            let v0 = RewardCollected{
                position_key : arg0,
                reward_type  : 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()),
                amount       : arg1,
            };
            0x2::event::emit<RewardCollected>(v0);
        };
    }

    public fun remove_liquidity_position<T0, T1>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v12 = LiquidityRemoved{
            position_key : arg4,
            liquidity_a  : 0x2::balance::value<T0>(&v5),
            liquidity_b  : 0x2::balance::value<T1>(&v4),
            fee_a        : 0x2::balance::value<T0>(&v11),
            fee_b        : 0x2::balance::value<T1>(&v10),
        };
