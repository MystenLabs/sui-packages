module 0x5c114c80342059ee99c156a6df4367f6aef0a057beed6341528de275aac79d51::pnut {
    ...
    fun init(arg0: PNUT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PNUT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Pnut    ")))), trim_right(b"Make Peanut Great Again         "), trim_right(b"Make Peanut Great Again                                                                                                                                                                                                                                                                                                         "), v2, arg1);
        let v5 = v3;
