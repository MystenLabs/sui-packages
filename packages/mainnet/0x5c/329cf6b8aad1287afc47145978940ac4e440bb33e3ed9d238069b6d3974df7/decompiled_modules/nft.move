module 0x5c329cf6b8aad1287afc47145978940ac4e440bb33e3ed9d238069b6d3974df7::nft {
    ...
    entry fun mint(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Nft{
            ...
            name        : 0x1::string::utf8(b"byte0713"),
            description : 0x1::string::utf8(b"byte0713 NFT"),
