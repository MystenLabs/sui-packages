module 0x5c403832d6bfe1d7962bc1cb790819f716a57f3aa3956bf1413f1313241ca85c::mangrove {
    ...
    public fun create_vault_bundle(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = new(arg2);
        let v1 = &mut v0;
        let v2 = mint_trade_cap(v1, arg2);
        0x2::transfer::public_transfer<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeCap>(v2, arg1);
        let v3 = &mut v0;
        deposit<0x2::sui::SUI>(v3, arg0, arg2);
        0x2::transfer::share_object<DeepBookVault>(v0);
    }
