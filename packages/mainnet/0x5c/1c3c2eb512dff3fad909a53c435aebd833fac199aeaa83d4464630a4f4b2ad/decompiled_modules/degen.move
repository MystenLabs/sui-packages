module 0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen {
    ...
    fun init(arg0: DEGEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<Degen<0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::collectible::Collectible>>(&v4, v0, v2, arg1);
        0x2::display::update_version<Degen<0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::collectible::Collectible>>(&mut v5);
        let v6 = AdminCap{id: 0x2::object::new(arg1)};
        0x2::transfer::public_transfer<AdminCap>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<Degen<0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::collectible::Collectible>>>(v5, 0x2::tx_context::sender(arg1));
    }
