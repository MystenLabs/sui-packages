module 0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::item {
    ...
    public fun add_item_to_degen<T0>(arg0: &mut 0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::Degen<T0>, arg1: Item) {
        let v0 = ItemKey{type: arg1.type};
        assert!(!0x2::dynamic_object_field::exists_<ItemKey>(0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::uid_mut<T0>(arg0), v0), 3);
        0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::add_item_type<T0>(arg0, arg1.type, arg1.attack);
        if (arg1.type == 0x1::string::utf8(b"head")) {
            0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::update_head<T0>(arg0, arg1.slug);
        };
        if (arg1.type == 0x1::string::utf8(b"body")) {
            0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::update_body<T0>(arg0, arg1.slug);
        };
        if (arg1.type == 0x1::string::utf8(b"weapon")) {
            0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::update_weapon<T0>(arg0, arg1.slug);
        };
        let v1 = ItemKey{type: arg1.type};
        0x2::dynamic_object_field::add<ItemKey, Item>(0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::uid_mut<T0>(arg0), v1, arg1);
    }
    ...
    public fun change_loadout<T0>(arg0: &mut 0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::Degen<T0>, arg1: vector<0x1::string::String>, arg2: vector<Item>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        ...
        while (v0 < 0x1::vector::length<0x1::string::String>(&arg1)) {
            ...
            if (0x2::dynamic_object_field::exists_<ItemKey>(0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::uid_mut<T0>(arg0), v3)) {
        ...
        let v13 = DegenReequipped{
            degen_id            : 0x2::object::id<0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::Degen<T0>>(arg0),
    ...
    public fun equip<T0>(arg0: &mut 0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::Degen<T0>, arg1: Item) {
    ...
    public fun equip_all<T0>(arg0: &mut 0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::Degen<T0>, arg1: vector<Item>) {
        let v0 = 0;
        let v1 = 0x1::vector::empty<0x2::object::ID>();
    ...
    public fun reequip<T0>(arg0: &mut 0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::Degen<T0>, arg1: vector<0x1::string::String>, arg2: vector<Item>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        let v1 = 0x1::vector::empty<0x2::object::ID>();
        while (v0 < 0x1::vector::length<0x1::string::String>(&arg1)) {
            let v2 = *0x1::vector::borrow<0x1::string::String>(&arg1, v0);
    ...
    public fun remove_item_from_degen<T0>(arg0: &mut 0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::Degen<T0>, arg1: 0x1::string::String) : Item {
        let v0 = ItemKey{type: arg1};
        assert!(0x2::dynamic_object_field::exists_<ItemKey>(0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::uid_mut<T0>(arg0), v0), 3);
        let v1 = ItemKey{type: arg1};
        let v2 = 0x2::dynamic_object_field::remove<ItemKey, Item>(0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::uid_mut<T0>(arg0), v1);
        0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::remove_item_type<T0>(arg0, arg1, v2.attack);
        let v3 = 0x1::string::utf8(b"BLANK");
        if (v2.type == 0x1::string::utf8(b"head")) {
            0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::update_head<T0>(arg0, v3);
        };
        if (v2.type == 0x1::string::utf8(b"body")) {
            0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::update_body<T0>(arg0, v3);
        };
        if (v2.type == 0x1::string::utf8(b"weapon")) {
            0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::update_weapon<T0>(arg0, v3);
        };
        v2
    }
    ...
    public fun strip_degen<T0>(arg0: &mut 0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::Degen<T0>, arg1: vector<0x1::string::String>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        let v1 = 0x1::vector::empty<0x2::object::ID>();
        while (v0 < 0x1::vector::length<0x1::string::String>(&arg1)) {
            let v2 = *0x1::vector::borrow<0x1::string::String>(&arg1, v0);
    ...
    public fun unequip<T0>(arg0: &mut 0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::Degen<T0>, arg1: 0x1::string::String) : Item {
    ...
    public fun unequip_all<T0>(arg0: &mut 0x5c1c3c2eb512dff3fad909a53c435aebd833fac199aeaa83d4464630a4f4b2ad::degen::Degen<T0>, arg1: vector<0x1::string::String>) : vector<Item> {
        let v0 = 0;
