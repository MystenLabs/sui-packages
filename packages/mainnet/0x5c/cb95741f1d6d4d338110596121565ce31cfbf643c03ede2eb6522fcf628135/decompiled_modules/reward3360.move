module 0x5ccb95741f1d6d4d338110596121565ce31cfbf643c03ede2eb6522fcf628135::reward3360 {
    struct REWARD3360 has drop {
        dummy_field: bool,
    }

    struct TICKET_3360 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3360(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3360>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3360>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3360, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3360>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3360>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3360>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3360>>(v5, 0x2::tx_context::sender(arg1));
    }
