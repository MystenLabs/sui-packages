module 0x5c210e128617190de88d205f3013941e7cb26c6f1ec4e3f369e49cbf259cd2a5::nft {
    ...
    public fun transfer(arg0: TalentumNFT, arg1: address, arg2: &TokenData, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.can_transfer, 1);
    ...
    public fun mint(arg0: &PubKey, arg1: vector<u8>, arg2: vector<u8>, arg3: u8, arg4: u64, arg5: &0x2::clock::Clock, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: &mut TokenData, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (!arg10.allow_multiple) {
            assert!(!0x2::table::contains<address, bool>(&arg10.minted_addresses, v0), 502);
        };
        ...
        0x1::vector::append<u8>(&mut arg6, 0x1::string::into_bytes(0x1::u64::to_string(v1)));
        ...
        if (!arg10.allow_multiple) {
            0x2::table::add<address, bool>(&mut arg10.minted_addresses, v0, true);
        };
        ...
        0x2::transfer::public_transfer<TalentumNFT>(v2, v0);
    }
    ...
    public fun set_allow_multiple(arg0: &AdminCap, arg1: &mut TokenData, arg2: bool) {
        arg1.allow_multiple = arg2;
    }

    public fun set_transfer_permission(arg0: &AdminCap, arg1: &mut TokenData, arg2: bool) {
        arg1.can_transfer = arg2;
    }
