module 0x5cfb3eb931a8466c6a12843fc5660f936ba09e2161604d25a4ea89ed46995d13::reward3560 {
    struct REWARD3560 has drop {
        dummy_field: bool,
    }

    struct TICKET_3560 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3560(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3560>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3560>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3560, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3560>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3560>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3560>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3560>>(v5, 0x2::tx_context::sender(arg1));
    }
