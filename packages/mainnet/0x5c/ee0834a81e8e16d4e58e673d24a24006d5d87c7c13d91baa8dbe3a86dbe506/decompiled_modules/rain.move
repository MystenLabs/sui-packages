module 0x5cee0834a81e8e16d4e58e673d24a24006d5d87c7c13d91baa8dbe3a86dbe506::rain {
    ...
    fun init(arg0: RAIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<RAIN>(arg0, 9, 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"RAIN    ")))), trim_right(b"Rainbow memecoin                "), trim_right(b"The Rainbow Memecoin is more than just a digital currency                                                                                                                                                                                                                                                                       "), v1, arg1);
        let v4 = v2;
