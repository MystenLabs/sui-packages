module 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::arbitrage_router {
    ...
    public fun analyze_bluefin() : VenueAnalysis {
        let (v0, v1) = 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::bluefin_adapter::get_disabled_price_data();
        VenueAnalysis{
            pool_type    : 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::bluefin_adapter::venue_id(),
            bid_price    : v0,
            ask_price    : v1,
            raw_price    : 0,
            fee_rate     : 0,
            is_available : 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::bluefin_adapter::is_enabled(),
        }
    }
    ...
    public fun analyze_cetus<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>) : VenueAnalysis {
        let v0 = 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::cetus_adapter::get_price_data<T0, T1>(arg0);
        VenueAnalysis{
            pool_type    : 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::cetus_adapter::venue_id(),
            bid_price    : 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::cetus_adapter::price_data_effective_bid(&v0),
            ask_price    : 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::cetus_adapter::price_data_effective_ask(&v0),
            raw_price    : 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::cetus_adapter::price_data_mid_price(&v0),
            fee_rate     : 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::cetus_adapter::price_data_fee_rate(&v0),
            is_available : true,
        }
    }

    public fun analyze_mmt() : VenueAnalysis {
        let (v0, v1) = 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::mmt_adapter::get_disabled_price_data();
        VenueAnalysis{
            pool_type    : 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::mmt_adapter::venue_id(),
            bid_price    : v0,
            ask_price    : v1,
            raw_price    : 0,
            fee_rate     : 0,
            is_available : 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::mmt_adapter::is_enabled(),
        }
    }
    ...
    public fun analyze_turbos() : VenueAnalysis {
        let (v0, v1) = 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::turbos_adapter::get_disabled_price_data();
        VenueAnalysis{
            pool_type    : 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::turbos_adapter::venue_id(),
            bid_price    : v0,
            ask_price    : v1,
            raw_price    : 0,
            fee_rate     : 0,
            is_available : 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::turbos_adapter::is_enabled(),
        }
    }

    public fun apply_fee(arg0: u64, arg1: u64, arg2: bool) : u64 {
        0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::cetus_adapter::apply_fee(arg0, arg1, arg2)
    }
    ...
    public fun execute_arbitrage_analysis<T0>(arg0: 0x2::object::ID, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock) : (bool, bool, u8, u64, u8, u64) {
        ...
        0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::events::emit_arbitrage_opportunity(arg0, v0, arg2, v1.bid_price, v1.ask_price, v2.bid_price, v2.ask_price, v3.bid_price, v3.ask_price, v4.bid_price, v4.ask_price, v5, v6, v7, v8, v9, v10, arg3, v11, v12);
        (v11, v12, v5, v6, v8, v9)
    }
    ...
    public fun place_ioc_buy<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: u64, arg4: u64, arg5: bool, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) : IOCOrderResult {
        ...
        0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::events::emit_ioc_order_result(0x2::object::id<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>>(arg0), v2, true, arg3, arg4, v3, 0, v0);
        IOCOrderResult{
            order_id          : v2,
            filled_quantity   : v3,
    ...
    public fun place_ioc_sell<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: u64, arg4: u64, arg5: bool, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) : IOCOrderResult {
        ...
        0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::events::emit_ioc_order_result(0x2::object::id<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>>(arg0), v2, false, arg3, arg4, v3, 0, v0);
        IOCOrderResult{
            order_id          : v2,
            filled_quantity   : v3,
            unfilled_quantity : v4,
    ...
    public fun read_cetus_price<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>) : (u64, u64) {
        let v0 = 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::cetus_adapter::get_price_data<T0, T1>(arg0);
        (0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::cetus_adapter::price_data_mid_price(&v0), 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::cetus_adapter::price_data_fee_rate(&v0))
    }

    public fun sqrt_price_to_price(arg0: u128) : u64 {
        0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::cetus_adapter::sqrt_price_to_price(arg0)
    }
