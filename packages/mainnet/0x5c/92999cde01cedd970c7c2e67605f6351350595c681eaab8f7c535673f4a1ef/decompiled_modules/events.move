module 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::events {
    ...
    struct TakerOrderEvent has copy, drop {
        pool_id: 0x2::object::ID,
        timestamp_ms: u64,
        is_bid: bool,
        taker_price: u64,
    ...
    public(friend) fun emit_pool_registered(arg0: 0x2::object::ID, arg1: 0x5c92999cde01cedd970c7c2e67605f6351350595c681eaab8f7c535673f4a1ef::config::MMConfig, arg2: u64) {
    ...
    public(friend) fun emit_taker_order(arg0: 0x2::object::ID, arg1: u64, arg2: bool, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64) {
        let v0 = TakerOrderEvent{
            pool_id                : arg0,
            timestamp_ms           : arg1,
            is_bid                 : arg2,
            taker_price            : arg3,
            ...
            anchor_price           : arg6,
            offset_decibps         : arg7,
            estimated_edge_decibps : arg8,
            fee_paid               : arg9,
        };
        0x2::event::emit<TakerOrderEvent>(v0);
    }
