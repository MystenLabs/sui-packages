module 0x5c5549cdf61942f8cba3ca12d3f87f88c3eb1c38b56b4eea44e35c68afac74ae::genesis_prize {
    public(friend) fun finalize_end_lotto<T0>(arg0: &mut 0x5c5549cdf61942f8cba3ca12d3f87f88c3eb1c38b56b4eea44e35c68afac74ae::types::Lotto<T0>, arg1: 0x2::vec_set::VecSet<address>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 == 0) {
            ...
            0x5c5549cdf61942f8cba3ca12d3f87f88c3eb1c38b56b4eea44e35c68afac74ae::events::emit_lotto_ended<T0>(v1, 0x5c5549cdf61942f8cba3ca12d3f87f88c3eb1c38b56b4eea44e35c68afac74ae::types::lotto_type_genesis(), 0x2::vec_set::empty<address>(), 0, v0, 0, v0, 0);
            return
        };
        ...
        while (v6 < 0x1::vector::length<address>(v5)) {
            0x5c5549cdf61942f8cba3ca12d3f87f88c3eb1c38b56b4eea44e35c68afac74ae::winner_selection::add_winner_claim<T0>(arg0, *0x1::vector::borrow<address>(v5, v6), v4);
            v6 = v6 + 1;
        };
        let v7 = v0 - v4 * v3;
        if (v7 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x5c5549cdf61942f8cba3ca12d3f87f88c3eb1c38b56b4eea44e35c68afac74ae::types::take_from_balance<T0>(arg0, v7), arg2), 0x2::tx_context::sender(arg2));
            0x5c5549cdf61942f8cba3ca12d3f87f88c3eb1c38b56b4eea44e35c68afac74ae::events::emit_dust_collected(v1, v7);
        };
        0x5c5549cdf61942f8cba3ca12d3f87f88c3eb1c38b56b4eea44e35c68afac74ae::events::emit_lotto_ended<T0>(v1, 0x5c5549cdf61942f8cba3ca12d3f87f88c3eb1c38b56b4eea44e35c68afac74ae::types::lotto_type_genesis(), arg1, v4, 0, 0, v0, v2);
    }
