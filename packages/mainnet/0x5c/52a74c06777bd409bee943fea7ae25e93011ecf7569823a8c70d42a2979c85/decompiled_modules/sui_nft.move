module 0x5c52a74c06777bd409bee943fea7ae25e93011ecf7569823a8c70d42a2979c85::sui_nft {
    ...
    public entry fun transfer(arg0: Hero, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: SUI_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Qiao"));
