module 0x5ca7ca676ae65d1c093045e97e7ccf3889a412bedce049f6745dec2d1fa7f8f0::dogesui {
    ...
    fun init(arg0: DOGESUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::mint_and_transfer<DOGESUI>(&mut v2, 100000000000000000, 0x2::tx_context::sender(arg1), arg1);
