module 0x5c05a4b9b3039f96d55d33163e8075e9b47666cdbf246c1c94f5dc220ef87cef::locker {
    ...
    public entry fun lock<T0: store + key>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = lock_and_return<T0>(arg0, arg1);
        0x2::transfer::public_transfer<Locked<T0>>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<Key>(v1, 0x2::tx_context::sender(arg1));
    }

    public fun lock_and_return<T0: store + key>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : (Locked<T0>, Key) {
