module 0x5cde86395a0d603507d9ea34128f9a60ff87c88dfacb8b270d6565ed91bf66bd::gift3370 {
    struct GIFT3370 has drop {
        dummy_field: bool,
    }

    struct TICKET_3370 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3370(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3370>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3370>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3370, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3370>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3370>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3370>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3370>>(v5, 0x2::tx_context::sender(arg1));
    }
