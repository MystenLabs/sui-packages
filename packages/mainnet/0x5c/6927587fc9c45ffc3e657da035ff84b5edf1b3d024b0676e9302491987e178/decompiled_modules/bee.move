module 0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::bee {
    struct BEE has drop {
        dummy_field: bool,
    }
    ...
    public fun get_total_bee_Supply() : u64 {
        0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::constants::total_bee_supply()
    }
    ...
    public fun set_rules<T0>(arg0: &mut 0x2::token::TokenPolicy<T0>, arg1: &0x2::token::TokenPolicyCap<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::constants::bee_burn_pct();
