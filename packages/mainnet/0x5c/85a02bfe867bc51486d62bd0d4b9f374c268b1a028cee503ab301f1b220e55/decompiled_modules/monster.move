module 0x5c85a02bfe867bc51486d62bd0d4b9f374c268b1a028cee503ab301f1b220e55::monster {
    ...
    public entry fun admin_cancel(arg0: &mut ArenaMatch, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 0 || arg0.status == 1, 204);
    ...
    fun apply_deterministic_damage(arg0: &mut Monster, arg1: u64) {
        if (arg0.scars < 255) {
    ...
    public entry fun breed(arg0: &mut Monster, arg1: &mut Monster, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.stage >= 2 && arg1.stage >= 2, 100);
    ...
    public entry fun deposit_monster(arg0: &mut ArenaMatch, arg1: Monster, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 0, 203);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(v0 == arg0.player_a || v0 == arg0.player_b, 200);
        arg0.last_update = 0x2::clock::timestamp_ms(arg2);
        let v1 = &mut arg1;
        sync_stage(v1, arg2);
        if (v0 == arg0.player_a) {
            assert!(!0x1::option::is_some<Monster>(&arg0.mon_a), 201);
            ...
            assert!(!0x1::option::is_some<Monster>(&arg0.mon_b), 201);
    ...
    fun init(arg0: MONSTER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Anavrin Monster | Stage {stage} | W:{wins} L:{losses} | XP:{xp} | Scars:{scars}"));
    ...
    public entry fun mint_paid(arg0: &mut Config, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.mint_enabled, 300);
        let v0 = arg0.mint_price_mist;
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= v0, 301);
        if (v0 > 0) {
    ...
    fun power_now(arg0: &Monster, arg1: &0x2::clock::Clock) : u64 {
    ...
    fun resolve_battle(arg0: &Monster, arg1: &Monster, arg2: &0x2::clock::Clock) : bool {
        let v0 = power_now(arg0, arg2);
        let v1 = power_now(arg1, arg2);
        v0 > v1 || v1 > v0 && false || tie_breaker(arg0, arg1)
    }

    public entry fun set_mint_enabled(arg0: &AdminCap, arg1: &mut Config, arg2: bool) {
        arg1.mint_enabled = arg2;
    }

    public entry fun set_mint_price(arg0: &AdminCap, arg1: &mut Config, arg2: u64) {
    ...
    public entry fun start_battle(arg0: &mut ArenaMatch, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 1, 202);
        assert!(0x1::option::is_some<Monster>(&arg0.mon_a) && 0x1::option::is_some<Monster>(&arg0.mon_b), 202);
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.player_a || v0 == arg0.player_b, 200);
        ...
        let v6 = &mut v4;
        sync_stage(v6, arg1);
        let v7 = power_now(&v3, arg1);
        let v8 = power_now(&v4, arg1);
        let v9 = if (v7 > v8) {
            v7 - v8
        } else {
            v8 - v7
        ...
        let v10 = v1 + v2;
        let (v11, v12, v13) = if (resolve_battle(&v3, &v4, arg1)) {
            v3.wins = v3.wins + 1;
            v3.xp = v3.xp + 10;
            v4.losses = v4.losses + 1;
            v4.xp = v4.xp + 2;
            let v14 = &mut v4;
            apply_deterministic_damage(v14, v9);
            ...
            v3.xp = v3.xp + 2;
            let v16 = &mut v3;
            apply_deterministic_damage(v16, v9);
        ...
        if (v10 > 0) {
            let v18 = 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.stake_a);
            0x2::balance::join<0x2::sui::SUI>(&mut v18, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.stake_b));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v18, arg2), v12);
        };
        arg0.status = 2;
        let v19 = MatchFinished{
            match_id          : 0x2::object::id<ArenaMatch>(arg0),
            winner            : v12,
        ...
        0x2::event::emit<MatchFinished>(v19);
    }
    ...
    public entry fun withdraw_all_treasury(arg0: &AdminCap, arg1: &mut Config, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg1.treasury), arg2), 0x2::tx_context::sender(arg2));
    }

    public entry fun withdraw_treasury(arg0: &AdminCap, arg1: &mut Config, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
