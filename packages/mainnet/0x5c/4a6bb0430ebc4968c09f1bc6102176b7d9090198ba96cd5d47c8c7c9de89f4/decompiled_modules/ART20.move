module 0x5c4a6bb0430ebc4968c09f1bc6102176b7d9090198ba96cd5d47c8c7c9de89f4::ART20 {
    ...
    public entry fun mint_additional_art20(arg0: &mut CollectionCap, arg1: u64, arg2: &mut TokenIdCounter, arg3: vector<UserBalance>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.is_mutable, 27);
        assert!(0x2::tx_context::sender(arg5) == arg0.creator, 2);
        assert!(arg0.max_supply == 0 || arg0.current_supply + arg1 <= arg0.max_supply, 19);
        let v0 = 0x2::object::uid_to_inner(&arg0.id);
        let v1 = 0x2::tx_context::sender(arg5);
        if (0x1::vector::is_empty<UserBalance>(&arg3)) {
            let v2 = UserBalance{
                id            : 0x2::object::new(arg5),
                collection_id : v0,
                balance       : arg1,
            };
            0x2::transfer::transfer<UserBalance>(v2, v1);
        } else {
            let v3 = false;
            let v4 = 0;
            while (v4 < 0x1::vector::length<UserBalance>(&arg3)) {
                let v5 = 0x1::vector::borrow_mut<UserBalance>(&mut arg3, v4);
                if (v5.collection_id == v0) {
                    v5.balance = v5.balance + arg1;
                    v3 = true;
                    break
                };
                v4 = v4 + 1;
            ...
            if (!v3) {
                ...
                0x2::transfer::transfer<UserBalance>(v6, v1);
            };
        };
        let v7 = 0;
        while (v7 < arg1) {
            ...
            let v8 = NFT{
                ...
                asset_id      : arg0.current_supply + v7 + 1,
                max_supply    : arg0.max_supply,
                collection_id : v0,
                category      : 0x1::string::utf8(b""),
            };
            let v9 = TransferEvent{
                from     : 0x2::tx_context::sender(arg5),
                to       : 0x2::tx_context::sender(arg5),
                id       : 0x2::object::uid_to_inner(&v8.id),
                royalty  : 0,
                asset_id : v8.asset_id,
            };
            0x2::event::emit<TransferEvent>(v9);
            let v10 = NFTMintedEvent{
                id          : 0x2::object::uid_to_inner(&v8.id),
                artinals_id : v8.artinals_id,
                creator     : v8.creator,
                name        : v8.name,
                asset_id    : v8.asset_id,
            };
            0x2::event::emit<NFTMintedEvent>(v10);
            0x2::transfer::transfer<NFT>(v8, 0x2::tx_context::sender(arg5));
            v7 = v7 + 1;
        };
        arg0.current_supply = arg0.current_supply + arg1;
        while (!0x1::vector::is_empty<UserBalance>(&arg3)) {
            let v11 = 0x1::vector::pop_back<UserBalance>(&mut arg3);
            if (v11.balance > 0) {
                0x2::transfer::transfer<UserBalance>(v11, v1);
                continue
            };
            cleanup_empty_balance(v11);
        };
        0x1::vector::destroy_empty<UserBalance>(arg3);
        let v12 = AdditionalMintEvent{
            collection_id : v0,
            amount        : arg1,
        ...
        0x2::event::emit<AdditionalMintEvent>(v12);
    }
