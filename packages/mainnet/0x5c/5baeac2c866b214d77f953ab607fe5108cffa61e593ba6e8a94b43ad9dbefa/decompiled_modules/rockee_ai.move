module 0x5c5baeac2c866b214d77f953ab607fe5108cffa61e593ba6e8a94b43ad9dbefa::rockee_ai {
    struct ROCKEE_AI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ROCKEE_AI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ROCKEE_AI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ROCKEE AI"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The AI Layer powering DeFi on Sui. Ultimate all-in-one platform for DeFAI."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiebhfwovnxssa26y3jbkn2fjclq46vhorfveogvueudge2zvjadga"));
