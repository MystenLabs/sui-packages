module 0x5c4d29b8f39206e9d250bfb6c0f573fc5d572aceb7cbf06a2e9324d62bf9acfa::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT1729579", b"BatchToken1 729579", b"First serial deployment", 0x1::option::none<0x2::url::Url>(), arg1);
