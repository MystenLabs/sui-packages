module 0x5c1a7e0e538823c2829fc692fd8ae08eccf58f59b6be64f2c411901fc6994ae9::sun_sun {
    struct SUN_SUN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUN_SUN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUN_SUN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"sun sun"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The second chapter of Poopie Face features a character called SUNSUN. A very cute character. An original character designed by Tajumaru."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiayahtjnlzgsv6gxfmwws2ze2uznkmbcvvl5sn5ctgmiuopw3wwdq"));
