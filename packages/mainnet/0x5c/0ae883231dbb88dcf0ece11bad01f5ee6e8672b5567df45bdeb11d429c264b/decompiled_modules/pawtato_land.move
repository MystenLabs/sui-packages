module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land {
    ...
    fun get_tool_boost(arg0: &StakingPool, arg1: &vector<ItemInfo>, arg2: u8, arg3: u64) : u128 {
        ...
        while (v1 < v0) {
            ...
            if (v2.item_type == arg2) {
                if (v2.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_idol_of_axomamma() || v2.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_shovel() || is_item_active(v2, arg3)) {
    ...
    public entry fun upgrade_version(arg0: &LandAdminCap, arg1: &mut StakingPool, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = arg1.version;
        assert!(v0 < 9, 13906836884467744767);
        arg1.version = 9;
