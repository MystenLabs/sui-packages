module 0x5c7059ea2cb3016ace3fb3c6e7ad1725897680151581ed7f42a139d6ea08a356::reward9673 {
    struct REWARD9673 has drop {
        dummy_field: bool,
    }

    struct TICKET_9673 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9673(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9673>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9673>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9673, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9673>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9673>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9673>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9673>>(v5, 0x2::tx_context::sender(arg1));
    }
