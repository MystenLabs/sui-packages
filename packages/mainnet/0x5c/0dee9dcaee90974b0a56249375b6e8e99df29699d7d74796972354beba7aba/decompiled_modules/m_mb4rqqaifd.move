module 0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_mb4rqqaifd {
    struct T_5vcoyqp5wy has key {
        id: 0x2::object::UID,
        admin_cap_id: 0x2::object::ID,
        profit_recipient: address,
    }

    struct T_7sgt6xap3x has store, key {
        id: 0x2::object::UID,
        registry_id: 0x2::object::ID,
    }

    struct T_e6ie6ajp5n<phantom T0, phantom T1, phantom T2> has store, key {
        id: 0x2::object::UID,
        registry_id: 0x2::object::ID,
    ...
    struct T_iab5prmgce<phantom T0, phantom T1, phantom T2> has store, key {
        id: 0x2::object::UID,
        registry_id: 0x2::object::ID,
    ...
    struct T_25av5cpaot<phantom T0, phantom T1, phantom T2, phantom T3, phantom T4, phantom T5> has store, key {
        id: 0x2::object::UID,
        registry_id: 0x2::object::ID,
    ...
    struct T_o3k2y7wbdg<phantom T0, phantom T1, phantom T2, phantom T3, phantom T4, phantom T5> {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_route_id: 0x2::object::ID,
        destination_route_id: 0x2::object::ID,
    ...
    struct T_7x5d3xtlne<phantom T0, phantom T1, phantom T2, phantom T3, phantom T4, phantom T5> {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_id: 0x2::object::ID,
        profit_recipient: address,
    ...
    struct T_ga64eppzvb has copy, drop {
        source_a: u64,
        source_b: u64,
    ...
    struct T_6hi465lxgv has copy, drop {
    ...
    struct T_cxmdw4gdi7<phantom T0, phantom T1, phantom T2, phantom T3, phantom T4, phantom T5> has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_route_id: 0x2::object::ID,
        destination_route_id: 0x2::object::ID,
        ...
        width_intervals: u32,
        income: T_e47lljnlek,
        principal: T_ga64eppzvb,
        retained: T_6hi465lxgv,
    }

    struct T_3o5jdrjrv3 has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_route_id: 0x2::object::ID,
        destination_route_id: 0x2::object::ID,
    ...
    struct T_j2rdcw6s4x has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
    ...
    struct T_56fx37tnrc has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_route_id: 0x2::object::ID,
        destination_route_id: 0x2::object::ID,
    ...
    struct T_jqcgaew6b7 has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_id: 0x2::object::ID,
        owner: address,
    ...
    struct T_vvljmcp6jk has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_cap_id: 0x2::object::ID,
    ...
    struct T_4aa57ztbeu<phantom T0, phantom T1, phantom T2> {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        bluefin_pool_id: 0x2::object::ID,
        owner: address,
    ...
    struct T_ojrxqiic33<phantom T0, phantom T1, phantom T2> {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_id: 0x2::object::ID,
        profit_recipient: address,
    ...
    struct T_u6ubxi4z47 has copy, drop {
        registry_id: 0x2::object::ID,
        admin_cap_id: 0x2::object::ID,
        profit_recipient: address,
    }

    struct T_pqvbyqowlc has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        bluefin_pool_id: 0x2::object::ID,
        owner: address,
    ...
    struct T_dgyczivohi has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        position_cap_id: 0x2::object::ID,
        bluefin_pool_id: 0x2::object::ID,
    ...
    struct T_foskwu6f2d has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_cap_id: 0x2::object::ID,
        bluefin_pool_id: 0x2::object::ID,
    ...
    struct T_ambe3l3lhv has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_id: 0x2::object::ID,
        current_tick: u32,
    ...
    struct T_e47lljnlek has copy, drop {
        profit_recipient: address,
        reward_as_sui: u64,
        fee_a_as_sui: u64,
        fee_b_as_sui: u64,
    ...
    struct T_agarfpq7az has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_id: 0x2::object::ID,
        owner: address,
    ...
    struct T_rbde6suae7 has copy, drop {
        before_a: u64,
        before_b: u64,
    ...
    struct T_4gk5ltzth2 has copy, drop {
        sui_to_a_input: u64,
        sui_to_a_output: u64,
        sui_to_b_input: u64,
        sui_to_b_output: u64,
    ...
    struct T_u6unlhsdzv has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_cap_id: 0x2::object::ID,
        replacement_position_cap_id: 0x2::object::ID,
        ...
        width_intervals: u32,
        income: T_e47lljnlek,
        principal: T_rbde6suae7,
        retained: T_4gk5ltzth2,
    }

    struct T_nhk4f5hrfk has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        owner: address,
        amount_a: u64,
    ...
    public fun f_24w5flkmbv<T0, T1, T2>(arg0: &T_5vcoyqp5wy, arg1: &mut T_e6ie6ajp5n<T0, T1, T2>, arg2: &T_4aa57ztbeu<T0, T1, T2>, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: 0x2::balance::Balance<0x2::sui::SUI>, arg5: 0x2::balance::Balance<0x2::sui::SUI>, arg6: u64, arg7: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg8: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<0x2::sui::SUI>, T_ojrxqiic33<T0, T1, T2>) {
        f_gmeh5nnszl<T0, T1, T2>(arg0, arg1, arg8);
        assert!(arg2.registry_id == 0x2::object::id<T_5vcoyqp5wy>(arg0), 1);
        assert!(arg2.route_id == 0x2::object::id<T_e6ie6ajp5n<T0, T1, T2>>(arg1), 3);
        ...
        let v3 = v0 + v1 + v2;
        assert!(0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_sx4g5ai6yn(arg2.reward_amount, arg2.fee_a, arg2.fee_b, v0, v1, v2, v3), 14);
        assert!(v3 >= arg6, 15);
        0x2::balance::join<0x2::sui::SUI>(&mut arg3, arg4);
        0x2::balance::join<0x2::sui::SUI>(&mut arg3, arg5);
        let (v4, v5, v6) = 0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_5jyj7eansw(v3);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg3) == v5, 14);
        f_d3eu3wweud<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg3, v4), arg0.profit_recipient);
        ...
        let v10 = T_ojrxqiic33<T0, T1, T2>{
            registry_id             : 0x2::object::id<T_5vcoyqp5wy>(arg0),
            route_id                : 0x2::object::id<T_e6ie6ajp5n<T0, T1, T2>>(arg1),
        ...
        let v11 = T_agarfpq7az{
            registry_id        : 0x2::object::id<T_5vcoyqp5wy>(arg0),
            route_id           : 0x2::object::id<T_e6ie6ajp5n<T0, T1, T2>>(arg1),
            source_position_id : arg2.source_position_id,
            owner              : arg1.owner,
            income             : f_cg4k4zcqrf<T0, T1, T2>(&v10),
        };
        0x2::event::emit<T_agarfpq7az>(v11);
        (0x2::balance::split<T0>(&mut arg1.retained_a, v7), 0x2::balance::split<T1>(&mut arg1.retained_b, v8), arg3, v10)
    }

    fun f_265visxlwn(arg0: u64, arg1: u64, arg2: u64) {
        if (arg0 == 0) {
    ...
    fun f_3sjxz7vgh3<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
    ...
    fun f_3vamg6dghl(arg0: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg1: u32, arg2: u32, arg3: u32) : (u32, u32) {
        f_n3tju77hzs(arg2);
        assert!(0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_yquqv2emyr(arg3), 7);
    ...
    public fun f_56kvwnmq7n<T0, T1, T2, T3, T4, T5>(arg0: &0x2::clock::Clock, arg1: &T_5vcoyqp5wy, arg2: &T_25av5cpaot<T0, T1, T2, T3, T4, T5>, arg3: T_iab5prmgce<T0, T1, T2>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg6: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg7: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg8: u128, arg9: u32, arg10: u32, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg17: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, T_o3k2y7wbdg<T0, T1, T2, T3, T4, T5>) {
        f_nnfqfeoagb<T0, T1, T2, T3, T4, T5>(arg1, arg2, arg5, arg6, arg17);
        let v0 = 0x2::object::id<T_5vcoyqp5wy>(arg1);
        let v1 = 0x2::object::id<T_25av5cpaot<T0, T1, T2, T3, T4, T5>>(arg2);
        ...
        f_jlvigpqty5(arg3.tick_lower, arg3.tick_upper);
        f_cwebbnqnfe(&arg7, v2, arg3.tick_lower, arg3.tick_upper);
        let v5 = 0x2::object::id<T_iab5prmgce<T0, T1, T2>>(&arg3);
        ...
        let (v11, v12, v13, v14) = f_bbcdkc23im<T0, T1>(arg0, arg4, arg5, arg7);
        let v15 = v14;
        let v16 = v13;
        let v17 = v12;
        let v18 = v11;
        ...
        0x2::event::emit<T_56fx37tnrc>(v23);
        let T_iab5prmgce {
            id                   : v24,
            registry_id          : _,
            route_id             : _,
        ...
        let v33 = T_o3k2y7wbdg<T0, T1, T2, T3, T4, T5>{
            registry_id            : v0,
            route_id               : v1,
            source_route_id        : arg2.source_route_id,
            destination_route_id   : arg2.destination_route_id,
    ...
    fun f_6vnoaoxbzo(arg0: 0x2::object::ID) {
        assert!(arg0 == 0x2::object::id_from_address(@0xa0153768c7ed857ffd8bad4708da873fb7825a6878e5f4c83f5df4c091933e56), 4);
    }

    fun f_afr3pkx2px(arg0: &T_5vcoyqp5wy) {
        assert!(arg0.profit_recipient == @0xa10aecd2e9e45698e8c36ccaf3c4ea51cdda87f3c098a71d1e77be3351000498, 2);
    }

    fun f_b4kwfpkvi6(arg0: &T_5vcoyqp5wy, arg1: &T_7sgt6xap3x) {
        f_afr3pkx2px(arg0);
        assert!(arg1.registry_id == 0x2::object::id<T_5vcoyqp5wy>(arg0), 0);
        assert!(0x2::object::id<T_7sgt6xap3x>(arg1) == arg0.admin_cap_id, 0);
    }
    ...
    fun f_bbcdkc23im<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        let v0 = &mut arg3;
        let (v1, v2) = f_3sjxz7vgh3<T0, T1>(arg0, arg1, arg2, v0);
        let v3 = v2;
        let v4 = v1;
        ...
        let v9 = &mut arg3;
        let (v10, v11) = f_3sjxz7vgh3<T0, T1>(arg0, arg1, arg2, v9);
    ...
    fun f_cg4k4zcqrf<T0, T1, T2>(arg0: &T_ojrxqiic33<T0, T1, T2>) : T_e47lljnlek {
        T_e47lljnlek{
            profit_recipient        : arg0.profit_recipient,
    ...
    fun f_cwebbnqnfe(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg1: 0x2::object::ID, arg2: u32, arg3: u32) {
    ...
    fun f_d3eu3wweud<T0>(arg0: 0x2::balance::Balance<T0>, arg1: address) {
    ...
    fun f_d7alzoym7j<T0, T1, T2>(arg0: &T_5vcoyqp5wy, arg1: &T_e6ie6ajp5n<T0, T1, T2>, arg2: &T_4aa57ztbeu<T0, T1, T2>, arg3: &T_ojrxqiic33<T0, T1, T2>) {
        assert!(arg3.registry_id == 0x2::object::id<T_5vcoyqp5wy>(arg0), 1);
        assert!(arg3.route_id == 0x2::object::id<T_e6ie6ajp5n<T0, T1, T2>>(arg1), 3);
        assert!(arg3.source_position_id == arg2.source_position_id, 6);
        assert!(arg3.profit_recipient == arg0.profit_recipient, 2);
        assert!(0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_sx4g5ai6yn(arg2.reward_amount, arg2.fee_a, arg2.fee_b, arg3.reward_as_sui, arg3.fee_a_as_sui, arg3.fee_b_as_sui, arg3.gross_income_sui), 14);
        let (v0, v1, v2) = 0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_5jyj7eansw(arg3.gross_income_sui);
    ...
    public fun f_dfopgbuyvf<T0, T1, T2>(arg0: &T_5vcoyqp5wy, arg1: &mut T_e6ie6ajp5n<T0, T1, T2>, arg2: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg3: &mut 0x2::tx_context::TxContext) {
        f_gmeh5nnszl<T0, T1, T2>(arg0, arg1, arg3);
        ...
        0x2::event::emit<T_nhk4f5hrfk>(v3);
        f_d3eu3wweud<T0>(0x2::balance::split<T0>(&mut arg1.retained_a, v0), arg1.owner);
        f_d3eu3wweud<T1>(0x2::balance::split<T1>(&mut arg1.retained_b, v1), arg1.owner);
        f_d3eu3wweud<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.retained_sui, v2), arg1.owner);
    }

    public fun f_e5tlqi4rhr<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &T_5vcoyqp5wy, arg2: &mut T_e6ie6ajp5n<T0, T1, T2>, arg3: T_4aa57ztbeu<T0, T1, T2>, arg4: T_ojrxqiic33<T0, T1, T2>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg7: 0x2::balance::Balance<T0>, arg8: 0x2::balance::Balance<T1>, arg9: 0x2::balance::Balance<T0>, arg10: 0x2::balance::Balance<T1>, arg11: 0x2::balance::Balance<0x2::sui::SUI>, arg12: u8, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u32, arg20: u64, arg21: bool, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: u64, arg27: bool, arg28: u64, arg29: u64, arg30: u64, arg31: u64, arg32: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg33: &mut 0x2::tx_context::TxContext) {
        f_xw44rummoe<T0, T1, T2>(arg1, arg2, arg6, arg33);
        f_hdiwokvtti<T0, T1, T2>(arg1, arg2, &arg3, arg6);
        assert!(arg3.oor_asserted, 13);
        f_d7alzoym7j<T0, T1, T2>(arg1, arg2, &arg3, &arg4);
        ...
        let v2 = f_fyzaashutr(arg3.source_principal_a, arg3.source_principal_b, v0, v1, arg12, arg13);
        assert!(0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_jcrti7oomy(arg3.source_principal_a, arg3.source_principal_b, v0, v1, arg12, arg13, v2), 14);
        assert!(v2 >= arg14, 15);
        ...
        f_265visxlwn(arg15, v6, arg16);
        f_265visxlwn(arg17, v7, arg18);
        assert!(0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_4dmlze34yd(arg4.prior_retained_a, arg4.prior_retained_b, arg4.prior_retained_sui, arg4.newly_retained_sui, v3, v4, v5, arg15, v6, arg17, v7), 14);
        let (v8, v9) = f_3vamg6dghl(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg6), 0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_dz37qrjq3c(arg2.tick_spacing, arg19), arg2.tick_spacing, arg19);
        ...
        assert!(v28 > 0, 8);
        f_cwebbnqnfe(&v10, 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg6), v8, v9);
        let v29 = T_iab5prmgce<T0, T1, T2>{
            id                   : 0x2::object::new(arg33),
            registry_id          : 0x2::object::id<T_5vcoyqp5wy>(arg1),
            route_id             : 0x2::object::id<T_e6ie6ajp5n<T0, T1, T2>>(arg2),
        ...
        let v32 = T_u6unlhsdzv{
            registry_id                 : 0x2::object::id<T_5vcoyqp5wy>(arg1),
            route_id                    : 0x2::object::id<T_e6ie6ajp5n<T0, T1, T2>>(arg2),
            source_position_cap_id      : arg3.source_position_cap_id,
            replacement_position_cap_id : 0x2::object::id<T_iab5prmgce<T0, T1, T2>>(&v29),
            bluefin_pool_id             : 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg6),
            ...
            income                      : f_cg4k4zcqrf<T0, T1, T2>(&arg4),
            principal                   : v30,
            retained                    : v31,
        };
        0x2::event::emit<T_u6unlhsdzv>(v32);
        let T_4aa57ztbeu {
            registry_id            : _,
            route_id               : _,
            bluefin_pool_id        : _,
        ...
        0x2::transfer::public_transfer<T_iab5prmgce<T0, T1, T2>>(v29, arg2.owner);
        f_d3eu3wweud<T0>(v17, arg2.owner);
        f_d3eu3wweud<T1>(v16, arg2.owner);
    }

    fun f_fyzaashutr(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u8, arg5: u64) : u64 {
        if (arg4 == 0) {
            assert!(arg5 == 0, 14);
            0
        } else if (arg4 == 1) {
    ...
    fun f_gmeh5nnszl<T0, T1, T2>(arg0: &T_5vcoyqp5wy, arg1: &T_e6ie6ajp5n<T0, T1, T2>, arg2: &0x2::tx_context::TxContext) {
        f_afr3pkx2px(arg0);
        assert!(arg1.registry_id == 0x2::object::id<T_5vcoyqp5wy>(arg0), 1);
        assert!(arg1.owner == 0x2::tx_context::sender(arg2), 5);
        f_n3tju77hzs(arg1.tick_spacing);
        assert!(arg1.income_policy_version == 1, 21);
    }

    public fun f_gvww5soiea<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &T_5vcoyqp5wy, arg2: &T_e6ie6ajp5n<T0, T1, T2>, arg3: T_iab5prmgce<T0, T1, T2>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg6: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg7: u128, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg14: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, T_4aa57ztbeu<T0, T1, T2>) {
        f_xw44rummoe<T0, T1, T2>(arg1, arg2, arg5, arg14);
        let v0 = 0x2::object::id<T_5vcoyqp5wy>(arg1);
        let v1 = 0x2::object::id<T_e6ie6ajp5n<T0, T1, T2>>(arg2);
        let v2 = 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg5);
        ...
        assert!(arg3.owner == arg2.owner, 5);
        f_jlvigpqty5(arg3.tick_lower, arg3.tick_upper);
        f_cwebbnqnfe(&arg6, v2, arg3.tick_lower, arg3.tick_upper);
        let v4 = 0x2::object::id<T_iab5prmgce<T0, T1, T2>>(&arg3);
        ...
        let (v10, v11, v12, v13) = f_bbcdkc23im<T0, T1>(arg0, arg4, arg5, arg6);
        let v14 = v13;
        let v15 = v12;
        let v16 = v11;
        let v17 = v10;
        ...
        0x2::event::emit<T_foskwu6f2d>(v23);
        let T_iab5prmgce {
            id                   : v24,
            registry_id          : _,
            route_id             : _,
    ...
    fun f_hdiwokvtti<T0, T1, T2>(arg0: &T_5vcoyqp5wy, arg1: &T_e6ie6ajp5n<T0, T1, T2>, arg2: &T_4aa57ztbeu<T0, T1, T2>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>) {
        assert!(arg2.registry_id == 0x2::object::id<T_5vcoyqp5wy>(arg0), 1);
        assert!(arg2.route_id == 0x2::object::id<T_e6ie6ajp5n<T0, T1, T2>>(arg1), 3);
        ...
        assert!(arg2.owner == arg1.owner, 5);
        f_jlvigpqty5(arg2.source_tick_lower, arg2.source_tick_upper);
    }

    public fun f_hiqevgcbit<T0, T1, T2, T3, T4, T5>(arg0: &T_5vcoyqp5wy, arg1: &T_7sgt6xap3x, arg2: &T_25av5cpaot<T0, T1, T2, T3, T4, T5>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg5: u32, arg6: u32, arg7: u128, arg8: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg9: &mut 0x2::tx_context::TxContext) {
        f_b4kwfpkvi6(arg0, arg1);
        f_yoofcch3vt<T0, T1, T2, T3, T4, T5>(arg0, arg2, arg3);
        f_jlvigpqty5(arg5, arg6);
        let v0 = 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg3);
        f_cwebbnqnfe(arg4, v0, arg5, arg6);
        let v1 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(arg4);
        assert!(v1 > 0 && v1 == arg7, 8);
        let v2 = T_iab5prmgce<T0, T1, T2>{
        ...
        let v3 = T_j2rdcw6s4x{
            registry_id        : 0x2::object::id<T_5vcoyqp5wy>(arg0),
            route_id           : 0x2::object::id<T_25av5cpaot<T0, T1, T2, T3, T4, T5>>(arg2),
            position_cap_id    : 0x2::object::id<T_iab5prmgce<T0, T1, T2>>(&v2),
            source_pool_id     : v0,
        ...
        0x2::event::emit<T_j2rdcw6s4x>(v3);
        0x2::transfer::public_transfer<T_iab5prmgce<T0, T1, T2>>(v2, arg2.owner);
    }

    public fun f_hphg6ec54i<T0, T1>(arg0: &T_5vcoyqp5wy, arg1: &T_7sgt6xap3x, arg2: &T_e6ie6ajp5n<0x2::sui::SUI, T1, 0x2::sui::SUI>, arg3: &T_e6ie6ajp5n<T0, 0x2::sui::SUI, T0>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T1>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, 0x2::sui::SUI>, arg6: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg7: &mut 0x2::tx_context::TxContext) {
        f_6vnoaoxbzo(0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T1>>(arg4));
        assert!(arg2.tick_spacing == 5, 7);
        assert!(arg3.tick_spacing == 1, 7);
        f_zt4snsmxzd<0x2::sui::SUI, T1, 0x2::sui::SUI, T0, 0x2::sui::SUI, T0>(arg0, arg1, arg2, arg3, arg4, arg5, 1, arg7);
    }

    public fun f_ip72plhhrt<T0, T1>(arg0: &T_5vcoyqp5wy, arg1: &T_7sgt6xap3x, arg2: &T_e6ie6ajp5n<T0, 0x2::sui::SUI, T0>, arg3: &T_e6ie6ajp5n<0x2::sui::SUI, T1, 0x2::sui::SUI>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, 0x2::sui::SUI>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T1>, arg6: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg7: &mut 0x2::tx_context::TxContext) {
        f_6vnoaoxbzo(0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T1>>(arg5));
        assert!(arg2.tick_spacing == 1, 7);
        assert!(arg3.tick_spacing == 5, 7);
        f_zt4snsmxzd<T0, 0x2::sui::SUI, T0, 0x2::sui::SUI, T1, 0x2::sui::SUI>(arg0, arg1, arg2, arg3, arg4, arg5, 1, arg7);
    }

    fun f_jlvigpqty5(arg0: u32, arg1: u32) {
    ...
    public fun f_jxzwztlvvu<T0>(arg0: &T_5vcoyqp5wy, arg1: &T_7sgt6xap3x, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T0>, arg3: address, arg4: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg5: &mut 0x2::tx_context::TxContext) {
        f_6vnoaoxbzo(0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T0>>(arg2));
        f_yjadg4fthh<0x2::sui::SUI, T0, 0x2::sui::SUI>(arg0, arg1, arg2, 5, true, arg3, arg5);
    }

    fun f_li6mexdm7v<T0, T1, T2, T3, T4, T5>(arg0: &T_5vcoyqp5wy, arg1: &T_25av5cpaot<T0, T1, T2, T3, T4, T5>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg3: &0x2::tx_context::TxContext) {
        f_nmtdxa57mq<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg3);
    ...
    public fun f_ljvvicekgp<T0>(arg0: &T_5vcoyqp5wy, arg1: &T_7sgt6xap3x, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, 0x2::sui::SUI>, arg3: address, arg4: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg5: &mut 0x2::tx_context::TxContext) {
        f_yjadg4fthh<T0, 0x2::sui::SUI, T0>(arg0, arg1, arg2, 1, false, arg3, arg5);
    }

    public fun f_lr5mmdj5si<T0, T1, T2>(arg0: &T_5vcoyqp5wy, arg1: &T_e6ie6ajp5n<T0, T1, T2>, arg2: T_4aa57ztbeu<T0, T1, T2>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg5: &0x2::tx_context::TxContext) : T_4aa57ztbeu<T0, T1, T2> {
        f_xw44rummoe<T0, T1, T2>(arg0, arg1, arg3, arg5);
        f_hdiwokvtti<T0, T1, T2>(arg0, arg1, &arg2, arg3);
        ...
        0x2::event::emit<T_ambe3l3lhv>(v1);
        arg2
    }

    fun f_m3lwln4xyf<T0, T1, T2, T3, T4, T5>(arg0: &T_5vcoyqp5wy, arg1: &T_25av5cpaot<T0, T1, T2, T3, T4, T5>, arg2: &T_o3k2y7wbdg<T0, T1, T2, T3, T4, T5>, arg3: &T_7x5d3xtlne<T0, T1, T2, T3, T4, T5>) {
        assert!(arg3.registry_id == 0x2::object::id<T_5vcoyqp5wy>(arg0), 1);
        assert!(arg3.route_id == 0x2::object::id<T_25av5cpaot<T0, T1, T2, T3, T4, T5>>(arg1), 3);
        assert!(arg3.source_position_id == arg2.source_position_id, 6);
        assert!(arg3.profit_recipient == arg0.profit_recipient, 2);
        assert!(0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_sx4g5ai6yn(arg2.reward_amount, arg2.fee_a, arg2.fee_b, arg3.reward_as_sui, arg3.fee_a_as_sui, arg3.fee_b_as_sui, arg3.gross_income_sui), 14);
        let (v0, v1, v2) = 0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_5jyj7eansw(arg3.gross_income_sui);
    ...
    fun f_m5zrur2fdp<T0, T1, T2, T3, T4, T5>(arg0: &T_7x5d3xtlne<T0, T1, T2, T3, T4, T5>) : T_e47lljnlek {
        T_e47lljnlek{
            profit_recipient        : arg0.profit_recipient,
            reward_as_sui           : arg0.reward_as_sui,
            fee_a_as_sui            : arg0.fee_a_as_sui,
    ...
    fun f_n3tju77hzs(arg0: u32) {
        assert!(arg0 > 0 && arg0 <= 1000000, 7);
    }

    fun f_nmtdxa57mq<T0, T1, T2, T3, T4, T5>(arg0: &T_5vcoyqp5wy, arg1: &T_25av5cpaot<T0, T1, T2, T3, T4, T5>, arg2: &0x2::tx_context::TxContext) {
        f_afr3pkx2px(arg0);
        assert!(arg1.registry_id == 0x2::object::id<T_5vcoyqp5wy>(arg0), 1);
        assert!(arg1.source_pool_id != arg1.destination_pool_id, 25);
        assert!(arg1.owner != @0x0, 5);
        assert!(arg1.owner == 0x2::tx_context::sender(arg2), 5);
        f_n3tju77hzs(arg1.source_tick_spacing);
        f_n3tju77hzs(arg1.destination_tick_spacing);
        assert!(0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_yquqv2emyr(arg1.destination_width_intervals), 7);
        assert!(arg1.income_policy_version == 1, 21);
    }

    fun f_nnfqfeoagb<T0, T1, T2, T3, T4, T5>(arg0: &T_5vcoyqp5wy, arg1: &T_25av5cpaot<T0, T1, T2, T3, T4, T5>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg4: &0x2::tx_context::TxContext) {
        f_yoofcch3vt<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg2);
    ...
    public fun f_pffwrh4vcl<T0, T1, T2, T3, T4, T5>(arg0: &T_5vcoyqp5wy, arg1: &mut T_25av5cpaot<T0, T1, T2, T3, T4, T5>, arg2: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg3: &mut 0x2::tx_context::TxContext) {
        f_nmtdxa57mq<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg3);
        f_d3eu3wweud<T3>(0x2::balance::split<T3>(&mut arg1.retained_destination_a, 0x2::balance::value<T3>(&arg1.retained_destination_a)), arg1.owner);
        f_d3eu3wweud<T4>(0x2::balance::split<T4>(&mut arg1.retained_destination_b, 0x2::balance::value<T4>(&arg1.retained_destination_b)), arg1.owner);
        f_d3eu3wweud<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.retained_sui, 0x2::balance::value<0x2::sui::SUI>(&arg1.retained_sui)), arg1.owner);
    }

    fun f_pmyd4hdd7w<T0, T1, T2>(arg0: &T_5vcoyqp5wy, arg1: &T_e6ie6ajp5n<T0, T1, T2>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>) {
        f_afr3pkx2px(arg0);
        assert!(arg1.registry_id == 0x2::object::id<T_5vcoyqp5wy>(arg0), 1);
    ...
    public fun f_pyhxmjehyw<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &T_5vcoyqp5wy, arg2: 0x2::object::ID, arg3: T_iab5prmgce<T0, T1, T2>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg6: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg7: u128, arg8: u32, arg9: u32, arg10: 0x2::balance::Balance<T0>, arg11: 0x2::balance::Balance<T1>, arg12: u64, arg13: u64, arg14: u64, arg15: bool, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg21: &mut 0x2::tx_context::TxContext) : (T_iab5prmgce<T0, T1, T2>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position) {
        f_afr3pkx2px(arg1);
        let v0 = 0x2::object::id<T_5vcoyqp5wy>(arg1);
        ...
        f_jlvigpqty5(arg3.tick_lower, arg3.tick_upper);
        f_cwebbnqnfe(&arg6, v1, arg3.tick_lower, arg3.tick_upper);
        ...
        let v16 = T_vvljmcp6jk{
            registry_id                 : v0,
            route_id                    : arg3.route_id,
            source_position_cap_id      : 0x2::object::id<T_iab5prmgce<T0, T1, T2>>(&arg3),
            replacement_position_cap_id : 0x2::object::id<T_iab5prmgce<T0, T1, T2>>(&v15),
            bluefin_pool_id             : v1,
            position_id                 : v2,
            owner                       : arg3.owner,
            liquidity_before            : v3,
        ...
        0x2::event::emit<T_vvljmcp6jk>(v16);
        let v17 = v15.owner;
        let T_iab5prmgce {
            id                   : v18,
            registry_id          : _,
        ...
        f_d3eu3wweud<T0>(v11, v17);
        f_d3eu3wweud<T1>(v10, v17);
        (v15, arg6)
    }

    fun f_sej7acvwuo<T0, T1, T2, T3, T4, T5>(arg0: &T_5vcoyqp5wy, arg1: &T_e6ie6ajp5n<T0, T1, T2>, arg2: &T_e6ie6ajp5n<T3, T4, T5>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>) {
        f_afr3pkx2px(arg0);
        let v0 = 0x2::object::id<T_5vcoyqp5wy>(arg0);
        ...
        f_n3tju77hzs(arg1.tick_spacing);
        f_n3tju77hzs(arg2.tick_spacing);
        assert!(arg1.income_policy_version == 1, 21);
        assert!(arg2.income_policy_version == 1, 21);
    }

    public fun f_unds3k6cqv<T0, T1, T2, T3, T4, T5>(arg0: &T_5vcoyqp5wy, arg1: &mut T_25av5cpaot<T0, T1, T2, T3, T4, T5>, arg2: &T_o3k2y7wbdg<T0, T1, T2, T3, T4, T5>, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: 0x2::balance::Balance<0x2::sui::SUI>, arg5: 0x2::balance::Balance<0x2::sui::SUI>, arg6: u64, arg7: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg8: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T3>, 0x2::balance::Balance<T4>, 0x2::balance::Balance<0x2::sui::SUI>, T_7x5d3xtlne<T0, T1, T2, T3, T4, T5>) {
        f_nmtdxa57mq<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg8);
        assert!(arg2.registry_id == 0x2::object::id<T_5vcoyqp5wy>(arg0), 1);
        assert!(arg2.route_id == 0x2::object::id<T_25av5cpaot<T0, T1, T2, T3, T4, T5>>(arg1), 3);
        ...
        arg1.cumulative_payout = arg1.cumulative_payout + (v4 as u128);
        arg1.cumulative_retained = arg1.cumulative_retained + (v5 as u128);
        let v10 = T_7x5d3xtlne<T0, T1, T2, T3, T4, T5>{
            registry_id                  : 0x2::object::id<T_5vcoyqp5wy>(arg0),
            route_id                     : 0x2::object::id<T_25av5cpaot<T0, T1, T2, T3, T4, T5>>(arg1),
            source_position_id           : arg2.source_position_id,
            profit_recipient             : arg0.profit_recipient,
            reward_as_sui                : v0,
            fee_a_as_sui                 : v1,
        ...
        let v11 = T_jqcgaew6b7{
            registry_id        : 0x2::object::id<T_5vcoyqp5wy>(arg0),
            route_id           : 0x2::object::id<T_25av5cpaot<T0, T1, T2, T3, T4, T5>>(arg1),
            source_position_id : arg2.source_position_id,
            owner              : arg1.owner,
            income             : f_m5zrur2fdp<T0, T1, T2, T3, T4, T5>(&v10),
        };
        0x2::event::emit<T_jqcgaew6b7>(v11);
        (0x2::balance::split<T3>(&mut arg1.retained_destination_a, v7), 0x2::balance::split<T4>(&mut arg1.retained_destination_b, v8), arg3, v10)
    }

    public fun f_vqcblny5my<T0, T1, T2, T3, T4, T5>(arg0: &0x2::clock::Clock, arg1: &T_5vcoyqp5wy, arg2: &mut T_25av5cpaot<T0, T1, T2, T3, T4, T5>, arg3: T_o3k2y7wbdg<T0, T1, T2, T3, T4, T5>, arg4: T_7x5d3xtlne<T0, T1, T2, T3, T4, T5>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg7: 0x2::balance::Balance<T3>, arg8: 0x2::balance::Balance<T4>, arg9: 0x2::balance::Balance<T3>, arg10: 0x2::balance::Balance<T4>, arg11: 0x2::balance::Balance<0x2::sui::SUI>, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: bool, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: u64, arg27: bool, arg28: u64, arg29: u64, arg30: u64, arg31: u64, arg32: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg33: &mut 0x2::tx_context::TxContext) {
        f_li6mexdm7v<T0, T1, T2, T3, T4, T5>(arg1, arg2, arg6, arg33);
        let v0 = 0x2::object::id<T_5vcoyqp5wy>(arg1);
        let v1 = 0x2::object::id<T_25av5cpaot<T0, T1, T2, T3, T4, T5>>(arg2);
        ...
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg2.retained_sui) == 0, 14);
        f_m3lwln4xyf<T0, T1, T2, T3, T4, T5>(arg1, arg2, &arg3, &arg4);
        let v3 = 0x2::balance::value<T3>(&arg7);
        let v4 = 0x2::balance::value<T4>(&arg8);
        assert!(0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_rbizdkkqn4(arg3.source_principal_a, arg3.source_principal_b, arg12, arg13, arg14, arg15, v3, v4), 26);
        assert!(arg20 > 0, 20);
        ...
        f_265visxlwn(arg16, arg17, arg17);
        f_265visxlwn(arg18, arg19, arg19);
        assert!(0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_4dmlze34yd(v5, v6, arg4.prior_retained_sui, arg4.newly_retained_sui, v7, v8, v9, arg16, arg17, arg18, arg19), 14);
        let (v10, v11) = f_3vamg6dghl(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T3, T4>(arg6), 0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_dz37qrjq3c(arg2.destination_tick_spacing, arg2.destination_width_intervals), arg2.destination_tick_spacing, arg2.destination_width_intervals);
        ...
        assert!(v30 > 0, 8);
        f_cwebbnqnfe(&v12, v2, v10, v11);
        let v31 = T_iab5prmgce<T3, T4, T5>{
            id                   : 0x2::object::new(arg33),
            registry_id          : v0,
        ...
        let v34 = T_cxmdw4gdi7<T0, T1, T2, T3, T4, T5>{
            registry_id                 : v0,
            route_id                    : v1,
            source_route_id             : arg2.source_route_id,
            destination_route_id        : arg2.destination_route_id,
            ...
            source_position_cap_id      : arg3.source_position_cap_id,
            source_position_id          : arg3.source_position_id,
            destination_position_cap_id : 0x2::object::id<T_iab5prmgce<T3, T4, T5>>(&v31),
            ...
            income                      : f_m5zrur2fdp<T0, T1, T2, T3, T4, T5>(&arg4),
            principal                   : v32,
            retained                    : v33,
        };
        0x2::event::emit<T_cxmdw4gdi7<T0, T1, T2, T3, T4, T5>>(v34);
        let T_o3k2y7wbdg {
            registry_id            : _,
            route_id               : _,
            source_route_id        : _,
        ...
        0x2::transfer::public_transfer<T_iab5prmgce<T3, T4, T5>>(v31, arg2.owner);
        f_d3eu3wweud<T3>(v19, arg2.owner);
        f_d3eu3wweud<T4>(v18, arg2.owner);
    }

    public fun f_xqqyoiu3el<T0, T1, T2>(arg0: &T_5vcoyqp5wy, arg1: &T_7sgt6xap3x, arg2: &T_e6ie6ajp5n<T0, T1, T2>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg5: u32, arg6: u32, arg7: u128, arg8: &0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_gnfmtwbcgq::T_7pojg43z2q, arg9: &mut 0x2::tx_context::TxContext) {
        f_b4kwfpkvi6(arg0, arg1);
        f_pmyd4hdd7w<T0, T1, T2>(arg0, arg2, arg3);
        f_jlvigpqty5(arg5, arg6);
        let v0 = 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg3);
        f_cwebbnqnfe(arg4, v0, arg5, arg6);
        let v1 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(arg4);
        ...
        0x2::event::emit<T_dgyczivohi>(v3);
        0x2::transfer::public_transfer<T_iab5prmgce<T0, T1, T2>>(v2, arg2.owner);
    }

    fun f_xw44rummoe<T0, T1, T2>(arg0: &T_5vcoyqp5wy, arg1: &T_e6ie6ajp5n<T0, T1, T2>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &0x2::tx_context::TxContext) {
        f_pmyd4hdd7w<T0, T1, T2>(arg0, arg1, arg2);
        assert!(arg1.owner == 0x2::tx_context::sender(arg3), 5);
    }

    public(friend) fun f_yjadg4fthh<T0, T1, T2>(arg0: &T_5vcoyqp5wy, arg1: &T_7sgt6xap3x, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: u32, arg4: bool, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        f_b4kwfpkvi6(arg0, arg1);
        assert!(arg5 != @0x0, 5);
        f_n3tju77hzs(arg3);
        let v0 = 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg2);
        let v1 = T_e6ie6ajp5n<T0, T1, T2>{
        ...
        let v2 = T_pqvbyqowlc{
            registry_id           : 0x2::object::id<T_5vcoyqp5wy>(arg0),
            route_id              : 0x2::object::id<T_e6ie6ajp5n<T0, T1, T2>>(&v1),
            bluefin_pool_id       : v0,
            owner                 : arg5,
            tick_spacing          : arg3,
            income_policy_version : 1,
        ...
        0x2::event::emit<T_pqvbyqowlc>(v2);
        0x2::transfer::public_transfer<T_e6ie6ajp5n<T0, T1, T2>>(v1, arg5);
    }

    fun f_yoofcch3vt<T0, T1, T2, T3, T4, T5>(arg0: &T_5vcoyqp5wy, arg1: &T_25av5cpaot<T0, T1, T2, T3, T4, T5>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>) {
        f_afr3pkx2px(arg0);
        assert!(arg1.registry_id == 0x2::object::id<T_5vcoyqp5wy>(arg0), 1);
    ...
    public(friend) fun f_zt4snsmxzd<T0, T1, T2, T3, T4, T5>(arg0: &T_5vcoyqp5wy, arg1: &T_7sgt6xap3x, arg2: &T_e6ie6ajp5n<T0, T1, T2>, arg3: &T_e6ie6ajp5n<T3, T4, T5>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg6: u32, arg7: &mut 0x2::tx_context::TxContext) {
        f_b4kwfpkvi6(arg0, arg1);
        f_sej7acvwuo<T0, T1, T2, T3, T4, T5>(arg0, arg2, arg3, arg4, arg5);
        assert!(0x5c0dee9dcaee90974b0a56249375b6e8e99df29699d7d74796972354beba7aba::m_wiqtjz2xao::f_yquqv2emyr(arg6), 7);
        ...
        let v2 = 0x2::object::id<T_e6ie6ajp5n<T0, T1, T2>>(arg2);
        let v3 = 0x2::object::id<T_e6ie6ajp5n<T3, T4, T5>>(arg3);
        let v4 = arg2.owner;
        let v5 = T_25av5cpaot<T0, T1, T2, T3, T4, T5>{
        ...
        let v6 = T_3o5jdrjrv3{
            registry_id                 : 0x2::object::id<T_5vcoyqp5wy>(arg0),
            route_id                    : 0x2::object::id<T_25av5cpaot<T0, T1, T2, T3, T4, T5>>(&v5),
            source_route_id             : v2,
            destination_route_id        : v3,
            source_pool_id              : v0,
            destination_pool_id         : v1,
        ...
        0x2::event::emit<T_3o5jdrjrv3>(v6);
        0x2::transfer::public_transfer<T_25av5cpaot<T0, T1, T2, T3, T4, T5>>(v5, v4);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::object::id<T_7sgt6xap3x>(&v2);
        let v4 = T_5vcoyqp5wy{
            id               : v0,
            admin_cap_id     : v3,
        ...
        0x2::event::emit<T_u6ubxi4z47>(v5);
        0x2::transfer::public_transfer<T_7sgt6xap3x>(v2, 0x2::tx_context::sender(arg0));
        0x2::transfer::share_object<T_5vcoyqp5wy>(v4);
    }
