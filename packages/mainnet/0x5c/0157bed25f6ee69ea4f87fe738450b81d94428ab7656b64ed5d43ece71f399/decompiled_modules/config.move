module 0x5c0157bed25f6ee69ea4f87fe738450b81d94428ab7656b64ed5d43ece71f399::config {
    ...
    struct EnterHiveCap has store, key {
        id: 0x2::object::UID,
        airdrop_open: bool,
    ...
    struct LockdropCapability has store, key {
        id: 0x2::object::UID,
    }
    ...
    public fun enter_hive_airdrop_open(arg0: &mut EnterHiveCap) {
        assert!(!arg0.airdrop_open, 3050);
        arg0.airdrop_open = true;
    }

    public fun enter_hive_airdrop_unlocked(arg0: &mut EnterHiveCap) {
        assert!(!arg0.airdrop_unlock_open, 3060);
        arg0.airdrop_unlock_open = true;
    }

    public fun enter_hive_auction_open(arg0: &mut EnterHiveCap) {
        assert!(!arg0.auction_open, 3090);
        arg0.auction_open = true;
    }

    public fun enter_hive_auction_withdraw_only(arg0: &mut EnterHiveCap) {
        assert!(!arg0.auction_withdraw_only, 3100);
        arg0.auction_withdraw_only = true;
    }

    public fun enter_hive_fusion_concluded(arg0: &mut EnterHiveCap) {
        assert!(!arg0.has_hive_fusion_concluded, 311);
        arg0.has_hive_fusion_concluded = true;
    }

    public fun enter_hive_lockdrop_open(arg0: &mut EnterHiveCap) {
        assert!(!arg0.lockdrop_open, 3070);
        arg0.lockdrop_open = true;
    }

    public fun enter_hive_lockdrop_withdraw_only(arg0: &mut EnterHiveCap) {
    ...
    public fun get_enter_hive_status(arg0: &EnterHiveCap) : (bool, bool, bool, bool, bool, bool, bool) {
    ...
    public entry fun get_fee_info<T0>(arg0: &Config) : (u64, u64) {
        if (0x5c0157bed25f6ee69ea4f87fe738450b81d94428ab7656b64ed5d43ece71f399::curves::is_stable<T0>()) {
            return (arg0.stable_pool_fee.total_fee_bps, arg0.stable_pool_fee.hive_fee_percent)
        };
        if (0x5c0157bed25f6ee69ea4f87fe738450b81d94428ab7656b64ed5d43ece71f399::curves::is_weighted<T0>()) {
            return (arg0.weighted_pool_fee.total_fee_bps, arg0.weighted_pool_fee.hive_fee_percent)
        };
        if (0x5c0157bed25f6ee69ea4f87fe738450b81d94428ab7656b64ed5d43ece71f399::curves::is_curved<T0>()) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<EnterHiveCap>(v4, 0x2::tx_context::sender(arg0));
        let v5 = AuctionCapability{
            id                   : 0x2::object::new(arg0),
            is_vault_initialized : false,
        };
        0x2::transfer::transfer<AuctionCapability>(v5, 0x2::tx_context::sender(arg0));
        let v6 = LockdropCapability{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<LockdropCapability>(v6, 0x2::tx_context::sender(arg0));
        let v7 = TwoAmmFeeCollectionCapability{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<TwoAmmFeeCollectionCapability>(v7, 0x2::tx_context::sender(arg0));
        let v8 = ThreeAmmFeeCollectionCapability{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<ThreeAmmFeeCollectionCapability>(v8, 0x2::tx_context::sender(arg0));
        let v9 = FeeInfo{
            total_fee_bps    : 35,
            hive_fee_percent : 34,
        };
        ...
        let v13 = Treasury<0x5c0157bed25f6ee69ea4f87fe738450b81d94428ab7656b64ed5d43ece71f399::hsui::HSUI>{
            id      : 0x2::object::new(arg0),
            balance : 0x2::balance::zero<0x5c0157bed25f6ee69ea4f87fe738450b81d94428ab7656b64ed5d43ece71f399::hsui::HSUI>(),
        };
        0x2::transfer::share_object<Treasury<0x5c0157bed25f6ee69ea4f87fe738450b81d94428ab7656b64ed5d43ece71f399::hsui::HSUI>>(v13);
    }

    public fun is_auction_initialized(arg0: &AuctionCapability) : bool {
    ...
    public fun update_default_fee_for_curve<T0>(arg0: &mut Config, arg1: &HiveDaoCapability, arg2: u64, arg3: u64) {
        0x5c0157bed25f6ee69ea4f87fe738450b81d94428ab7656b64ed5d43ece71f399::curves::assert_valid_curve<T0>();
        if (0x5c0157bed25f6ee69ea4f87fe738450b81d94428ab7656b64ed5d43ece71f399::curves::is_stable<T0>()) {
            let v0 = &mut arg0.stable_pool_fee;
            update_fee(v0, arg2, arg3);
        } else if (0x5c0157bed25f6ee69ea4f87fe738450b81d94428ab7656b64ed5d43ece71f399::curves::is_weighted<T0>()) {
            let v1 = &mut arg0.weighted_pool_fee;
            update_fee(v1, arg2, arg3);
        } else if (0x5c0157bed25f6ee69ea4f87fe738450b81d94428ab7656b64ed5d43ece71f399::curves::is_curved<T0>()) {
