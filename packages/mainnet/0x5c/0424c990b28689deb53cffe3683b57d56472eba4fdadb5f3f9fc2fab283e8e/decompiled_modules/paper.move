module 0x5c0424c990b28689deb53cffe3683b57d56472eba4fdadb5f3f9fc2fab283e8e::paper {
    ...
    fun init(arg0: PAPER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/b37NMA81bSgVmC6E5TXyrUndRzwdYycxoLFsG3gpump.png                                                                                                                                                                                                                                ");
