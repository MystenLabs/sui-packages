module 0x5ce090c907727b6f8dd6fe7804dffb42702ed754a50886708d33fb382c0ccb8f::bert {
    ...
    fun init(arg0: BERT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/HgBRWfYxEfvPhtqkaeymCQtHCrKE46qQ43pKe8HCpump.png                                                                                                                                                                                                                               ");
