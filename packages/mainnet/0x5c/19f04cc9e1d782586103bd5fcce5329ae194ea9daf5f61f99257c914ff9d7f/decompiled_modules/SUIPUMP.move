module 0x5c19f04cc9e1d782586103bd5fcce5329ae194ea9daf5f61f99257c914ff9d7f::SUIPUMP {
    struct SUIPUMP has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUIPUMP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<SUIPUMP>(arg0, 6, b"SUI PUMP", b"SUI PUMP", b"SUI PUMP", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/JemFWW4YZ3s7OW_OkCH4cx09BNmdDAL8upix877eLGw?ext=png")), arg1);
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<SUIPUMP>(&mut v3, 100000000000, 0x2::tx_context::sender(arg1), arg1);
