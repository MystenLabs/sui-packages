module 0x1139e423b2ecefaf1fe80629f74a23f21e59f03d1618acfc4899adf0fac5ff1f::dynamic_object_field {
    ...
    public fun borrow(arg0: &Parent) : &Child {
        ...
        0x2::dynamic_object_field::borrow<Key, Child>(&arg0.id, v0)
    }

    public fun borrow_mut(arg0: &mut Parent) : &mut Child {
        let v0 = Key{dummy_field: false};
        0x2::dynamic_object_field::borrow_mut<Key, Child>(&mut arg0.id, v0)
    }
    ...
    public fun add_complex_child(arg0: &mut Parent, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let Child {
            id    : v1,
            value : _,
        } = 0x2::dynamic_object_field::remove<Key, Child>(&mut arg0.id, v0);
        ...
        0x2::dynamic_object_field::add<Key, ComplexChild<LpCoin>>(&mut arg0.id, v7, v6);
    }
    ...
    public fun borrow_mut_n_times(arg0: &mut Parent, arg1: u64) {
        ...
        while (v0 < arg1) {
            ...
            0x2::dynamic_object_field::borrow_mut<Key, ComplexChild<LpCoin>>(&mut arg0.id, v1);
            v0 = v0 + 1;
        };
    }
    ...
    public fun borrow_n_times(arg0: &Parent, arg1: u64) {
        ...
        while (v0 < arg1) {
            let v1 = Key{dummy_field: false};
            0x2::dynamic_object_field::borrow<Key, ComplexChild<LpCoin>>(&arg0.id, v1);
            v0 = v0 + 1;
        };
    }
    ...
    public(friend) fun create_parent_and_share(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<Key, Child>(&mut v0.id, v2, v1);
