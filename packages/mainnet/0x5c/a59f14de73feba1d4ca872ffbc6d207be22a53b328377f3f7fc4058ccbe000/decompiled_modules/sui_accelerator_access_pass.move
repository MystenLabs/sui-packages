module 0x5ca59f14de73feba1d4ca872ffbc6d207be22a53b328377f3f7fc4058ccbe000::sui_accelerator_access_pass {
    struct SUI_ACCELERATOR_ACCESS_PASS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_ACCELERATOR_ACCESS_PASS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_ACCELERATOR_ACCESS_PASS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sui Accelerator Access Pass"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Sui Accelerator Access Pass "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreifmk5y7aeo7gtagkxm65df3etjmgccbbpv5zzfopd2x7tptyeooiy"));
