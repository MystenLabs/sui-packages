module 0x5c670257e446162091da5f988ffef9a848e56dd8897f8c0e6fa494e42b585d3d::lh {
    struct LH has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LH, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<LH>(arg0, 9, b"LH", b"little he", b"Meme Description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://waterpump.fun/api/file/2334a31bacdf462ea6c9ad4559f2731d.png")), arg1);
        let v2 = v1;
