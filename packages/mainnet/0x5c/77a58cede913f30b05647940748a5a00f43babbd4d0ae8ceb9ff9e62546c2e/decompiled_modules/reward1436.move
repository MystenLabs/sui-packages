module 0x5c77a58cede913f30b05647940748a5a00f43babbd4d0ae8ceb9ff9e62546c2e::reward1436 {
    struct REWARD1436 has drop {
        dummy_field: bool,
    }

    struct TICKET_1436 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1436(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1436>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1436>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1436, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1436>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1436>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1436>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1436>>(v5, 0x2::tx_context::sender(arg1));
    }
