module 0x5c449e42c97bc3aeea7dc8075e76e72d63c71ef4c48a275ee9a0b0185857ac2d::mystemon {
    ...
    fun init(arg0: MYSTEMON, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MYSTEMON>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Mystemon"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A collection of Mystemon living on the Sui blockchain, each one completely unique and generated from the trainer's social profile"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreicxbrrr23vd3dni3oodyykkmwbyswtihlknipyr3rf3hppk4yg6ve"));
