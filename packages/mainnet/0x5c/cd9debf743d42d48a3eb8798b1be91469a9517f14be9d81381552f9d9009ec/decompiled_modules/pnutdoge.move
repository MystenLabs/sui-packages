module 0x5ccd9debf743d42d48a3eb8798b1be91469a9517f14be9d81381552f9d9009ec::pnutdoge {
    ...
    fun init(arg0: PNUTDOGE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<PNUTDOGE>(arg0, 9, b"PnutDoge", b"PnutDoge", b"Pnut Doge Meme Coin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), false, arg1);
        let v3 = v0;
