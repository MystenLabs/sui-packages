module 0x5c8ef7a7e832456dd9a932a2ddb1cb9e8da84e8dfd918c925451efb87a46cd4f::conditional_coin_utils {
    ...
    public fun build_conditional_symbol(arg0: &0x114056e12dc74d45933f12b3e4ecbe797dad06610b42c9b1af46fd885c3e6f3::dao_config::ConditionalCoinConfig, arg1: u64, arg2: &0x1::string::String) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"");
        let v1 = 0x114056e12dc74d45933f12b3e4ecbe797dad06610b42c9b1af46fd885c3e6f3::dao_config::coin_name_prefix(arg0);
        ...
        if (0x114056e12dc74d45933f12b3e4ecbe797dad06610b42c9b1af46fd885c3e6f3::dao_config::use_outcome_index(arg0)) {
            0x1::string::append_utf8(&mut v0, u64_to_string(arg1));
    ...
    public fun build_conditional_symbol_ascii(arg0: &0x114056e12dc74d45933f12b3e4ecbe797dad06610b42c9b1af46fd885c3e6f3::dao_config::ConditionalCoinConfig, arg1: u64, arg2: &0x1::ascii::String) : 0x1::ascii::String {
