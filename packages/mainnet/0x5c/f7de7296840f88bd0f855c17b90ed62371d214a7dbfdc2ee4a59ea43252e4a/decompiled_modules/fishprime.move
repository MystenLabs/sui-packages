module 0x5cf7de7296840f88bd0f855c17b90ed62371d214a7dbfdc2ee4a59ea43252e4a::fishprime {
    struct FISHPRIME has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: FISHPRIME, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<FISHPRIME>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"FishPrime"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"$SFISH NFTs unique collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeihdnqiwnc6nns23q47btb65hlspc3obshaesw5srizyb432dmsws4"));
