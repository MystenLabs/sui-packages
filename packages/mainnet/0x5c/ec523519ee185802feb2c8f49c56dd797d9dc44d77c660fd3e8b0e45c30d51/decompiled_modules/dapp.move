module 0x5151e31f8bd3c79a4eb66d1dee093aefb8873aea51543c1f68e0ae4142039a05::dapp {
    ...
    public fun batch_update_area_stats<T0>(arg0: &mut Contract<T0>, arg1: vector<address>, arg2: vector<u64>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg1)) {
            let v1 = 0x2::table::borrow_mut<address, User>(&mut arg0.users, *0x1::vector::borrow<address>(&arg1, v0));
            v1.area_performance = *0x1::vector::borrow<u64>(&arg2, v0);
            v1.area_invest_amount = *0x1::vector::borrow<u64>(&arg3, v0);
            v0 = v0 + 1;
        };
    }
    ...
    public fun buyToken<T0, T1>(arg0: &mut Contract<T1>, arg1: &mut 0xf64c53c15b63226cff5e81f5dfcaa7d7f2743e93dfeded0a83b5f5db4f19ccff::implements::Global, arg2: &0x5151e31f8bd3c79a4eb66d1dee093aefb8873aea51543c1f68e0ae4142039a05::price_oracle::PriceOracle, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 13906838842972831743);
