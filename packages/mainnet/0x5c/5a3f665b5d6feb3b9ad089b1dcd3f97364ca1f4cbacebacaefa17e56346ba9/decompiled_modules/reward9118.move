module 0x5c5a3f665b5d6feb3b9ad089b1dcd3f97364ca1f4cbacebacaefa17e56346ba9::reward9118 {
    struct REWARD9118 has drop {
        dummy_field: bool,
    }

    struct TICKET_9118 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9118(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9118>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9118>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9118, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9118>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9118>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9118>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9118>>(v5, 0x2::tx_context::sender(arg1));
    }
