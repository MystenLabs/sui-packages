module 0x5c39da40a87b15eeef4ad0e5367d3e567025246e744fd242e9ebe0df9a1ff91c::cnsnft6957 {
    struct CNSNFT6957 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6957, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8285"));
        let v4 = 0x2::package::claim<CNSNFT6957>(arg0, arg1);
