module 0x5c4a7a4edc9ee785e4ab1390d7a07fd4ebe3600792ccf0d458cb0e1bc8448136::cnsnft8391 {
    struct CNSNFT8391 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8391, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8391>(arg0, arg1);
