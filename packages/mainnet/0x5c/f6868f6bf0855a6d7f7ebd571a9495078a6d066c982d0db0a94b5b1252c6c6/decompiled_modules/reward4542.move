module 0x5cf6868f6bf0855a6d7f7ebd571a9495078a6d066c982d0db0a94b5b1252c6c6::reward4542 {
    struct REWARD4542 has drop {
        dummy_field: bool,
    }

    struct TICKET_4542 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4542(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4542>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4542>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4542, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4542>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4542>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4542>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4542>>(v5, 0x2::tx_context::sender(arg1));
    }
