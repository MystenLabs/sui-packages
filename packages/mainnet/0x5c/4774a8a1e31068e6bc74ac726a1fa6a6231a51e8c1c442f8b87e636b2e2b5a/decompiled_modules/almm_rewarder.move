module 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder {
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: u256, arg2: u64) {
        ...
        while (v2 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v2).growth_global = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).growth_global + (v1 as u256) * 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).emissions_per_second / (arg1 >> 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::scale_offset());
            v2 = v2 + 1;
        };
        arg0.points_released = arg0.points_released + (v1 as u256) * 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::scale();
        arg0.points_growth_global = arg0.points_growth_global + (v1 as u256) * 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::scale() / (arg1 >> 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::scale_offset());
    }
    ...
    public(friend) fun update_emission<T0>(arg0: &mut RewarderManager, arg1: &RewarderGlobalVault, arg2: u256, arg3: u256, arg4: u64) {
        ...
        if (arg3 > 0) {
            ...
            assert!((0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg1.balances, v0)) as u256) << 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::scale_offset() >= (0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::day() as u256) * arg3, 4);
        };
