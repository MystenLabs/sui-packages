module 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_bin {
    ...
    public(friend) fun download_rewarders(arg0: &mut Bin, arg1: &0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::RewarderManager) {
        let v0 = 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::borrow_rewarders(arg1);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::Rewarder>(v0)) {
            let v2 = 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::reward_coin(0x1::vector::borrow<0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::Rewarder>(v0, v1));
            ...
            0x2::vec_map::insert<0x1::type_name::TypeName, u256>(&mut arg0.rewarder_growth, v2, 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::growth_global(0x1::vector::borrow<0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::Rewarder>(v0, v1)));
            v1 = v1 + 1;
        };
    }
    ...
    public fun get_amounts(arg0: u64, arg1: u64, arg2: u16, arg3: u64, arg4: bool, arg5: u32, arg6: u64) : (u64, u64, u64, u64, u64, u64) {
        let v0 = 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_price::get_price_from_storage_id(arg5, arg2);
        let v1 = if (arg4) {
            arg1
        } else {
            arg0
        ...
        let v5 = 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_fee::get_fee_amount(v2, arg3);
        let v6 = v2 + v5;
        let (v7, v8, v9) = if (arg6 >= v6) {
            (v5, v6, v1)
        } else {
            let v10 = 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_fee::get_fee_amount_from(arg6, arg3);
            let v11 = if (arg4) {
        ...
        let (v15, v16, v17, v18, v19, v20) = if (arg4) {
            assert!(get_liquidity(arg0 + v8, arg1 - v9, v0) <= 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::max_liquidity_per_bin(), 2);
            (v9, v7, 0, v8, 0, 0)
        } else {
            assert!(get_liquidity(arg0 - v9, arg1 + v8, v0) <= 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::max_liquidity_per_bin(), 2);
            (0, 0, v7, 0, v8, v9)
        };
    ...
    public fun get_composition_fees(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64) : (u64, u64) {
        ...
        if (v0 > arg2) {
            return (0, 0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::uint_safe::safe64((0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_fee::get_composition_fee(arg3 - v1, arg6) as u256)))
        };
        if (v1 > arg3) {
            return (0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::uint_safe::safe64((0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_fee::get_composition_fee(arg2 - v0, arg6) as u256)), 0)
        };
        (0, 0)
    }
    ...
    public fun get_liquidity(arg0: u64, arg1: u64, arg2: u256) : u256 {
        ...
        if (arg1 > 0) {
            let v2 = (arg1 as u256) << 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::scale_offset();
            let v3 = v0 + v2;
            v0 = v3;
            assert!(v3 >= v2, 1);
        };
    ...
    public fun get_shares_and_effective_amounts_in(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u256, arg5: u64) : (u64, u64, u64) {
        ...
        if (v1 == 0 || arg5 == 0) {
            return (0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::uint_safe::safe64(v0 / 2 >> 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::scale_offset()), arg2, arg3)
        };
        ...
        let (v4, v5) = if (v0 > v3) {
            let v6 = v0 - v3;
            let v7 = v6;
            let v8 = if (v6 > 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::scale()) {
                let v9 = v6 >> 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::scale_offset();
                let v10 = if (v9 > (arg3 as u256)) {
                    (arg3 as u256)
                } else {
                    v9
                };
                v7 = v6 - ((v10 as u256) << 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::scale_offset());
                (arg3 as u256) - v10
            } else {
                (arg3 as u256)
            };
        ...
        assert!(get_liquidity(arg0 + v4, arg1 + v5, arg4) <= 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_constants::max_liquidity_per_bin(), 2);
    ...
    public(friend) fun new(arg0: u32, arg1: u256, arg2: &vector<0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::Rewarder>) : Bin {
        let v0 = if (0x1::vector::length<0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::Rewarder>(arg2) == 0) {
            0x2::vec_map::empty<0x1::type_name::TypeName, u256>()
        } else {
            let v1 = 0x2::vec_map::empty<0x1::type_name::TypeName, u256>();
            let v2 = 0;
            while (v2 < 0x1::vector::length<0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::Rewarder>(arg2)) {
                0x2::vec_map::insert<0x1::type_name::TypeName, u256>(&mut v1, 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::reward_coin(0x1::vector::borrow<0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::Rewarder>(arg2, v2)), 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::growth_global(0x1::vector::borrow<0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::Rewarder>(arg2, v2)));
                v2 = v2 + 1;
            };
            v1
        };
    ...
    public(friend) fun upload_rewarders(arg0: &Bin, arg1: &mut 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::RewarderManager) {
        let v0 = 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::borrow_rewarders_mut(arg1);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::Rewarder>(v0)) {
            let v2 = 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::reward_coin(0x1::vector::borrow<0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::Rewarder>(v0, v1));
            if (0x2::vec_map::contains<0x1::type_name::TypeName, u256>(&arg0.rewarder_growth, &v2)) {
                0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::update_growth(0x1::vector::borrow_mut<0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::Rewarder>(v0, v1), *0x2::vec_map::get<0x1::type_name::TypeName, u256>(&arg0.rewarder_growth, &v2));
            } else {
                0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::update_growth(0x1::vector::borrow_mut<0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_rewarder::Rewarder>(v0, v1), 0);
            };
            v1 = v1 + 1;
        };
    }
