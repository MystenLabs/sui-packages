module 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_factory {
    ...
    public fun add_preset(arg0: &mut Factory, arg1: &AdminCap, arg2: u64, arg3: u16, arg4: u16, arg5: u16, arg6: u16, arg7: u16, arg8: u32, arg9: u16, arg10: u32, arg11: &mut 0x2::tx_context::TxContext) {
    ...
    public fun close_bin_step_preset(arg0: &mut Factory, arg1: &AdminCap, arg2: u64, arg3: u16) {
        check_admin(arg0, arg1);
        assert!(0x2::vec_map::contains<u64, 0x2::vec_set::VecSet<u16>>(&arg0.opened_bin_steps, &arg2) && 0x2::vec_set::contains<u16>(0x2::vec_map::get<u64, 0x2::vec_set::VecSet<u16>>(&arg0.opened_bin_steps, &arg2), &arg3), 13906835454243635199);
    ...
    public fun grant_admin(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<Factory>(arg1), 13906834977502265343);
    ...
    public fun revoke_admin(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: 0x2::object::ID) {
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_admin, &arg2), 13906835033336840191);
    ...
    public fun revoke_protocol_fee_cap(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: 0x2::object::ID) {
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_protocol_fee_cap, &arg2), 13906835248085204991);
        0x2::vec_set::remove<0x2::object::ID>(&mut arg0.allowed_admin, &arg2);
    ...
    public fun set_default_partner(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: &0x771249e154f5d1c8dc70738df3ce452afc979046bc89bd8d7d32c54254d1940c::partner::Partner) {
        assert!(0x2::package::from_package<Factory>(arg1), 13906835076286513151);
        if (0x1::option::is_some<0x2::object::ID>(&arg0.default_partner)) {
            0x1::option::extract<0x2::object::ID>(&mut arg0.default_partner);
        };
        0x1::option::fill<0x2::object::ID>(&mut arg0.default_partner, 0x2::object::id<0x771249e154f5d1c8dc70738df3ce452afc979046bc89bd8d7d32c54254d1940c::partner::Partner>(arg2));
    }

    public fun set_max_bins_in_position(arg0: &mut Factory, arg1: &AdminCap, arg2: u64) {
        let v0 = arg0.max_bins_in_position;
        assert!(v0 != arg2, 13906835145005989887);
