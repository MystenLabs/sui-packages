module 0x5c4774a8a1e31068e6bc74ac726a1fa6a6231a51e8c1c442f8b87e636b2e2b5a::almm_bin_tree {
    ...
    fun closest_bit_left(arg0: u256, arg1: u8) : (u8, bool) {
        0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::bit_math::closest_bit_left(arg0, arg1 + 1)
    }

    fun closest_bit_right(arg0: u256, arg1: u8) : (u8, bool) {
        0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::bit_math::closest_bit_right(arg0, arg1 - 1)
    }
    ...
    public fun find_first_left(arg0: &BinTree, arg1: u32) : (u32, bool) {
        ...
        if (v5 < 255) {
            ...
            if (v7) {
                ...
                let (v9, _) = 0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::bit_math::least_significant_bit(*0x2::vec_map::get<u256, u256>(&arg0.level2, &v8));
        ...
        if (v11 < 255) {
            ...
            if (v13) {
                ...
                let (v15, _) = 0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::bit_math::least_significant_bit(*0x2::vec_map::get<u256, u256>(&arg0.level1, &v14));
                let v17 = v14 << 8 | (v15 as u256);
                assert!(0x2::vec_map::contains<u256, u256>(&arg0.level2, &v17), 3);
                let (v18, _) = 0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::bit_math::least_significant_bit(*0x2::vec_map::get<u256, u256>(&arg0.level2, &v17));
    ...
    public fun find_first_right(arg0: &BinTree, arg1: u32) : (u32, bool) {
        ...
        if (v5 > 0) {
            ...
            if (v7) {
                let v8 = v4 << 8 | (v6 as u256);
                assert!(0x2::vec_map::contains<u256, u256>(&arg0.level2, &v8), 3);
                let (v9, _) = 0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::bit_math::most_significant_bit(*0x2::vec_map::get<u256, u256>(&arg0.level2, &v8));
                return (((v8 << 8 | (v9 as u256)) as u32), true)
            };
        };
        let v11 = ((v4 & (255 as u256)) as u8);
        if (v11 > 0) {
            ...
            if (v13) {
                let v14 = (v12 as u256);
                assert!(0x2::vec_map::contains<u256, u256>(&arg0.level1, &v14), 2);
                let (v15, _) = 0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::bit_math::most_significant_bit(*0x2::vec_map::get<u256, u256>(&arg0.level1, &v14));
                let v17 = v14 << 8 | (v15 as u256);
                assert!(0x2::vec_map::contains<u256, u256>(&arg0.level2, &v17), 3);
                let (v18, _) = 0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::bit_math::most_significant_bit(*0x2::vec_map::get<u256, u256>(&arg0.level2, &v17));
                return (((v17 << 8 | (v18 as u256)) as u32), true)
            };
        };
        (0, false)
