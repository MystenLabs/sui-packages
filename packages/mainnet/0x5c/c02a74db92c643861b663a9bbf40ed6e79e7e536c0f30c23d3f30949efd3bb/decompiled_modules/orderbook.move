module 0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::orderbook {
    struct Order has copy, drop, store {
        account_id: u64,
        size: u64,
        reduce_only: bool,
        expiration_timestamp_ms: 0x1::option::Option<u64>,
        integrator_info: 0x1::option::Option<0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::account::IntegratorInfo>,
    ...
    public fun as_parts(arg0: &Order) : (u64, u64, bool, 0x1::option::Option<u64>, 0x1::option::Option<u64>, 0x1::option::Option<0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::account::IntegratorInfo>) {
    ...
    public(friend) fun asks(arg0: &Orderbook) : &0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::ordered_map::Map<Order> {
        0x2::dynamic_object_field::borrow<0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::keys::AsksMapKey, 0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::ordered_map::Map<Order>>(&arg0.id, 0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::keys::asks_map())
    }
    ...
    public(friend) fun bids(arg0: &Orderbook) : &0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::ordered_map::Map<Order> {
        0x2::dynamic_object_field::borrow<0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::keys::BidsMapKey, 0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::ordered_map::Map<Order>>(&arg0.id, 0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::keys::bids_map())
    }
    ...
    public(friend) fun borrow_mut_asks(arg0: &mut Orderbook) : &mut 0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::ordered_map::Map<Order> {
        0x2::dynamic_object_field::borrow_mut<0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::keys::AsksMapKey, 0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::ordered_map::Map<Order>>(&mut arg0.id, 0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::keys::asks_map())
    }
    ...
    public(friend) fun borrow_mut_bids(arg0: &mut Orderbook) : &mut 0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::ordered_map::Map<Order> {
        0x2::dynamic_object_field::borrow_mut<0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::keys::BidsMapKey, 0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::ordered_map::Map<Order>>(&mut arg0.id, 0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::keys::bids_map())
    }
    ...
    public(friend) fun cancel_limit_order(arg0: &mut Orderbook, arg1: u64, arg2: u128) : (u64, 0x1::option::Option<u64>) {
        ...
        let (v2, v3) = if (v0) {
            ...
            let v3 = 0x2::dynamic_object_field::borrow_mut<0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::keys::AsksMapKey, 0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::ordered_map::Map<Order>>(&mut arg0.id, 0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::keys::asks_map());
            (v2, v3)
        } else {
    ...
    public(friend) fun create_orderbook(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : Orderbook {
        ...
        0x2::dynamic_object_field::add<0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::keys::AsksMapKey, 0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::ordered_map::Map<Order>>(&mut v0.id, 0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::keys::asks_map(), 0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::ordered_map::empty<Order>(arg0, arg1, arg2, arg3, arg4, arg5, arg6));
    ...
    public(friend) fun order_snapshot(arg0: &Order) : (u64, 0x1::option::Option<u64>, u64, bool, 0x1::option::Option<u64>, 0x1::option::Option<0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::account::IntegratorInfo>) {
        (arg0.account_id, arg0.client_order_id, arg0.size, arg0.reduce_only, arg0.expiration_timestamp_ms, arg0.integrator_info)
    }

    public(friend) fun post_order(arg0: &mut Orderbook, arg1: u64, arg2: bool, arg3: u64, arg4: u64, arg5: 0x1::option::Option<u64>, arg6: bool, arg7: 0x1::option::Option<u64>, arg8: 0x1::option::Option<0x5cc02a74db92c643861b663a9bbf40ed6e79e7e536c0f30c23d3f30949efd3bb::account::IntegratorInfo>) : u128 {
