module 0x5c9c5373a4bdec8517156840ba6af30234aa8df6ce6c1b3d9903350800f72c2c::mystemons {
    ...
    fun init(arg0: MYSTEMONS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<MystemonV2>(&mut v3, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Test Dex1"));
    ...
    public entry fun mint_to_kiosk(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: vector<0x1::string::String>, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: bool, arg7: vector<0x1::string::String>, arg8: vector<0x1::string::String>, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (!0x1::vector::is_empty<0x1::string::String>(&arg3)) {
            *0x1::vector::borrow<0x1::string::String>(&arg3, 0)
        } else {
            0x1::string::utf8(b"Unknown")
        };
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0, 0x1::string::utf8(b"Rarity"), arg4);
        ...
        while (v2 < 0x1::vector::length<0x1::string::String>(&arg7)) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0, *0x1::vector::borrow<0x1::string::String>(&arg7, v2), *0x1::vector::borrow<0x1::string::String>(&arg8, v2));
            v2 = v2 + 1;
        };
        let v3 = MystemonV2{
