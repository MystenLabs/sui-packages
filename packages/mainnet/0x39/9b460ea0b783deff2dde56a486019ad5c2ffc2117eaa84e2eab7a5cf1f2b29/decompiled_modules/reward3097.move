module 0x399b460ea0b783deff2dde56a486019ad5c2ffc2117eaa84e2eab7a5cf1f2b29::reward3097 {
    struct REWARD3097 has drop {
        dummy_field: bool,
    }

    struct TICKET_3097 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3097(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3097>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3097>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3097, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3097>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3097>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3097>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3097>>(v5, 0x2::tx_context::sender(arg1));
    }
