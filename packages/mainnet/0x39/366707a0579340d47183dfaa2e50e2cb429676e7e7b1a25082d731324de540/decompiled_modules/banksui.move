module 0x39366707a0579340d47183dfaa2e50e2cb429676e7e7b1a25082d731324de540::banksui {
    ...
    fun init(arg0: BANKSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BANKSUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Banksui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"BankSui is a creative movement that blends the rebellious spirit of Banksy-style street art with the innovative world of Sui blockchain technology. It represents a fusion of graffiti-inspired visuals, social commentary, and digital ownership, making it a unique addition to the NFT space."));
