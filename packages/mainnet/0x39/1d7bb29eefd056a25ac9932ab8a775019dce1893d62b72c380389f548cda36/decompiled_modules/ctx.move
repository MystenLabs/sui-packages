module 0x391d7bb29eefd056a25ac9932ab8a775019dce1893d62b72c380389f548cda36::ctx {
    struct CTX has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CTX, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CTX>(arg0, 9, b"TATE", b"TATE COIN", b"The TATE token secures the TATEBook protocol", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://orange-giant-owl-725.mypinata.cloud/ipfs/Qmb4dg3jWfVXh5KreK4kSKzpZnjHyagmS4C88z12TnN4Tk")), arg1);
