module 0x39cec668cd284070e55e828743380299e7fcab94951b653eaf608c57dd13411d::special_edition_mni_ {
    struct SPECIAL_EDITION_MNI_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SPECIAL_EDITION_MNI_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SPECIAL_EDITION_MNI_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Special Edition MnI "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Just one of the many disgruntled freshwater inhabitants of the Mizu no Ikari special collection, reppin' the freshest street looks on Sui."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeial5qj4dq2mnr5bosgl6rc3yrm6qjnyivxozwd4iqfzvhfbnef3cm"));
