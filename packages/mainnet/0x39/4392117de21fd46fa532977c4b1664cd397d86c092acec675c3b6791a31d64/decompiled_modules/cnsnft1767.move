module 0x394392117de21fd46fa532977c4b1664cd397d86c092acec675c3b6791a31d64::cnsnft1767 {
    struct CNSNFT1767 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1767, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1767>(arg0, arg1);
