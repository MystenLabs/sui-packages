module 0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::collection_escrow {
    struct Ext has drop {
        dummy_field: bool,
    }
    ...
    public fun confirm_offer_accepted<T0: store + key>(arg0: OfferWrapper<T0>, arg1: 0x2::transfer_policy::TransferRequest<T0>, arg2: &0x2::transfer_policy::TransferPolicy<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v15 = v9;
        0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::marketplace::create_receipt<T0>(v14, v13, arg3);
        let v16 = OfferAcceptedEvent<T0>{
        ...
        0x2::event::emit<OfferAcceptedEvent<T0>>(v16);
        let v17 = 0x2::coin::zero<0x2::sui::SUI>(arg3);
        0x2::balance::join<0x2::sui::SUI>(0x2::coin::balance_mut<0x2::sui::SUI>(&mut v17), v15);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v17, 0x2::tx_context::sender(arg3));
    ...
    public fun offer<T0: store + key>(arg0: &0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::marketplace::MarketPlace, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::into_balance<0x2::sui::SUI>(arg3);
        let v1 = 0x2::balance::value<0x2::sui::SUI>(&v0);
        let v2 = (((0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::marketplace::get_fee(arg0, 0x2::tx_context::sender(arg5)) as u128) * (v1 as u128) / 10000) as u64);
        ...
        let v5 = 0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::marketplace::create_offer_cap<T0>(0x2::object::uid_to_inner(&v4.id), arg5);
        ...
        let v7 = NewOfferEvent<T0>{
            ...
            royalty_fee : v3,
            market_fee  : v2,
            offer_cap   : 0x2::object::id<0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::marketplace::OfferCap>(&v5),
        ...
        0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::marketplace::transfer_offer_cap(v5, arg5);
    }

    public fun revoke_offer<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: 0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::marketplace::OfferCap, arg4: &mut 0x2::tx_context::TxContext) {
        0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::marketplace::assert_offer_match(&arg3, arg2);
        ...
        0x2::balance::join<0x2::sui::SUI>(0x2::coin::balance_mut<0x2::sui::SUI>(&mut v11), v5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v11, 0x2::tx_context::sender(arg4));
        let v12 = OfferRevokedEvent<T0>{
            offer : 0x2::object::id<CollectionOffer<T0>>(&v2),
            owner : 0x2::tx_context::sender(arg4),
        };
        0x2::event::emit<OfferRevokedEvent<T0>>(v12);
    }
