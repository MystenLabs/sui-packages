module 0x397ea8e0fb83e7b3adcc32034990fd67cf79163aa68856e36132085e25ef952d::cnsnft7433 {
    struct CNSNFT7433 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7433, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7433>(arg0, arg1);
