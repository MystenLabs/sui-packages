module 0x39f016e3758887a165d054d6569ca040e2c84dc3fe158aa3cef586614edb7861::cnsnft6794 {
    struct CNSNFT6794 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6794, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6794>(arg0, arg1);
