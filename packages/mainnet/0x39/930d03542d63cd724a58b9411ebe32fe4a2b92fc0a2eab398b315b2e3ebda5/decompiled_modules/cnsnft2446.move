module 0x39930d03542d63cd724a58b9411ebe32fe4a2b92fc0a2eab398b315b2e3ebda5::cnsnft2446 {
    struct CNSNFT2446 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2446, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2446>(arg0, arg1);
