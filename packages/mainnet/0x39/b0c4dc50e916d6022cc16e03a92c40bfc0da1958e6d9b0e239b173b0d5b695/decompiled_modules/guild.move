module 0x39b0c4dc50e916d6022cc16e03a92c40bfc0da1958e6d9b0e239b173b0d5b695::guild {
    ...
    public fun collect_fee<T0>(arg0: &Config, arg1: &mut FeePool<T0>, arg2: &mut UserArchive, arg3: vector<u8>, arg4: vector<u8>, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 6005);
        assert!(!arg0.paused, 6004);
        verify_signature(arg3, arg4, &arg0.validator);
        ...
        assert!(0x2::clock::timestamp_ms(arg6) < 0x2::bcs::peel_u64(&mut v1), 6003);
        assert!(0x2::object::id_address<FeePool<T0>>(arg1) == 0x2::bcs::peel_address(&mut v1), 6002);
        assert!(v2 > 0, 6001);
        assert!(0x2::coin::value<T0>(&arg5) == v2, 6001);
