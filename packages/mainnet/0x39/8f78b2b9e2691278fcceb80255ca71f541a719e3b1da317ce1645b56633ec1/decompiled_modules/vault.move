module 0x398f78b2b9e2691278fcceb80255ca71f541a719e3b1da317ce1645b56633ec1::vault {
    ...
    public entry fun create_vault<T0>(arg0: &mut 0x398f78b2b9e2691278fcceb80255ca71f541a719e3b1da317ce1645b56633ec1::registry::Registry, arg1: address, arg2: u64, arg3: u8, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 >= 60000, 4);
        ...
        0x398f78b2b9e2691278fcceb80255ca71f541a719e3b1da317ce1645b56633ec1::registry::register_vault(arg0, v3, 0x2::tx_context::sender(arg5), arg1);
    ...
    public entry fun update_heir(arg0: &mut 0x398f78b2b9e2691278fcceb80255ca71f541a719e3b1da317ce1645b56633ec1::registry::Registry, arg1: &mut Vault, arg2: &VaultOwnerCap, arg3: address, arg4: &0x2::tx_context::TxContext) {
        assert_owner(arg1, arg2, arg4);
        assert!(arg1.is_active, 1);
        assert!(arg3 != @0x0, 6);
        let v0 = arg1.heir;
        arg1.heir = arg3;
        0x398f78b2b9e2691278fcceb80255ca71f541a719e3b1da317ce1645b56633ec1::registry::reassign_heir(arg0, 0x2::object::id<Vault>(arg1), v0, arg3);
        let v1 = HeirUpdated{
