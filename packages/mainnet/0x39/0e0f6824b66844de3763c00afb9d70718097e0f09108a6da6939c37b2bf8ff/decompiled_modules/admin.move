module 0x390e0f6824b66844de3763c00afb9d70718097e0f09108a6da6939c37b2bf8ff::admin {
    ...
    entry fun add_authorized_user(arg0: &mut Version, arg1: address, arg2: &0x2::tx_context::TxContext) {
        verify(arg0, arg2);
        assert!(!0x2::vec_set::contains<address>(&arg0.authority, &arg1), 0x390e0f6824b66844de3763c00afb9d70718097e0f09108a6da6939c37b2bf8ff::error::authority_already_existed());
    ...
    entry fun remove_authorized_user(arg0: &mut Version, arg1: address, arg2: &0x2::tx_context::TxContext) {
        verify(arg0, arg2);
        assert!(0x2::vec_set::contains<address>(&arg0.authority, &arg1), 0x390e0f6824b66844de3763c00afb9d70718097e0f09108a6da6939c37b2bf8ff::error::authority_doest_not_exist());
        0x2::vec_set::remove<address>(&mut arg0.authority, &arg1);
        assert!(0x2::vec_set::size<address>(&arg0.authority) > 0, 0x390e0f6824b66844de3763c00afb9d70718097e0f09108a6da6939c37b2bf8ff::error::authority_empty());
    }
    ...
    public(friend) fun verify(arg0: &Version, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::contains<address>(&arg0.authority, &v0), 0x390e0f6824b66844de3763c00afb9d70718097e0f09108a6da6939c37b2bf8ff::error::unauthorized());
    }

    public(friend) fun version_check(arg0: &Version) {
        assert!(5 >= arg0.value, 0x390e0f6824b66844de3763c00afb9d70718097e0f09108a6da6939c37b2bf8ff::error::invalid_version());
    }
