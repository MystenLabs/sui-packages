module 0x39553ff52a70a814ee83509d7fa870e8f888432638286eac5e030d327b9c74a9::cnsnft2473 {
    struct CNSNFT2473 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2473, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2473>(arg0, arg1);
