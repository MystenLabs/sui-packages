module 0x39a39cb4524e4baf783f291fb2d5d00edcbf9741bc2d546e19b990de93c4c4b4::tale01 {
    ...
    fun init(arg0: TALE01, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"link"), 0x1::string::utf8(b"https://b.a.xyz"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(b"https://a.b.xyz"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"v"));
        ...
        let v7 = v6;
        let v8 = v5;
        0x39a39cb4524e4baf783f291fb2d5d00edcbf9741bc2d546e19b990de93c4c4b4::tale01_royalty::add<Nft>(&mut v8, &v7, 3000, v3, 0);
    ...
    public entry fun update_config(arg0: &AdminCap, arg1: &mut MintConfig, arg2: &mut 0x2::transfer_policy::TransferPolicy<Nft>, arg3: &0x2::transfer_policy::TransferPolicyCap<Nft>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u16, arg9: address, arg10: u64) {
        ...
        let v0 = if (arg1.royalty_bps != arg8) {
            ...
            0x39a39cb4524e4baf783f291fb2d5d00edcbf9741bc2d546e19b990de93c4c4b4::tale01_royalty::min_amount(0x39a39cb4524e4baf783f291fb2d5d00edcbf9741bc2d546e19b990de93c4c4b4::tale01_royalty::get_config<Nft>(arg2)) != arg10
        };
        if (v0) {
            0x39a39cb4524e4baf783f291fb2d5d00edcbf9741bc2d546e19b990de93c4c4b4::tale01_royalty::update<Nft>(arg2, arg3, arg8, arg9, arg10);
            arg1.royalty_bps = arg8;
            arg1.recipient = arg9;
        };
    }

    public entry fun update_display(arg0: &mut 0x2::display::Display<Nft>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>) {
        ...
        0x2::display::edit<Nft>(arg0, 0x1::string::utf8(b"link"), 0x1::string::utf8(arg4));
        0x2::display::edit<Nft>(arg0, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(arg5));
        0x2::display::edit<Nft>(arg0, 0x1::string::utf8(b"creator"), 0x1::string::utf8(arg6));
