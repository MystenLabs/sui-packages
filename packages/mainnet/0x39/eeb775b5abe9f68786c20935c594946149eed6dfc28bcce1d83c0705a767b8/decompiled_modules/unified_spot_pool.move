module 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::unified_spot_pool {
    ...
    struct UnifiedSpotPool<phantom T0, phantom T1, phantom T2> has store, key {
        ...
        fee_schedule: 0x1::option::Option<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::fee_scheduler::FeeSchedule>,
    ...
    struct AggregatorConfig<phantom T0, phantom T1> has store {
        active_escrow: 0x1::option::Option<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>,
        archived_escrows: 0x2::table::Table<0x2::object::ID, 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>,
        simple_twap: 0x1::option::Option<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>,
    ...
    public fun new<T0, T1, T2>(arg0: 0x2::coin::TreasuryCap<T2>, arg1: &0x2::coin_registry::Currency<T2>, arg2: u64, arg3: 0x1::option::Option<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::fee_scheduler::FeeSchedule>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (UnifiedSpotPool<T0, T1, T2>, MustShare) {
        assert!(arg2 <= 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::max_amm_fee_bps(), 24);
        assert!(arg5 < 100, 25);
        ...
        let v0 = AggregatorConfig<T0, T1>{
            active_escrow                       : 0x1::option::none<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(),
            archived_escrows                    : 0x2::table::new<0x2::object::ID, 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(arg7),
            simple_twap                         : 0x1::option::none<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(),
        ...
        let v1 = UnifiedSpotPool<T0, T1, T2>{
            ...
            fee_bps                      : arg2,
            minimum_liquidity            : 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::minimum_liquidity(),
    ...
    public fun add_liquidity<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let (v3, v4, v5, v6) = if (v2 == 0) {
            let v7 = 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::math::safe_u128_to_u64(0x1::u128::sqrt((v0 as u128) * (v1 as u128)));
            ...
            let v11 = (v10 as u64);
            (v11, 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::math::mul_div_up(v11, v8, v2), 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::math::mul_div_up(v11, v9, v2), false)
        };
        assert!(v3 > 0, 4);
        assert!(v3 >= arg3, 5);
        let v12 = if (v0 > v4) {
        ...
        if (v6) {
            ...
            let v16 = 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::math::mul_div_to_128(v5, 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::price_precision_scale(), v4);
            if (0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config)) {
                ...
                if (0x1::option::is_none<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&v17.simple_twap)) {
                    0x1::option::fill<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&mut v17.simple_twap, 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::new_default(v16, arg4));
                };
            };
    ...
    public fun archive_finalized_escrow<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>, arg2: 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth) {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(&arg2) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        assert!(!arg0.is_dissolved, 32);
        assert!(0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config), 11);
        assert!(0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::market_state::is_finalized(0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::get_market_state<T0, T1>(&arg1)), 35);
        let v0 = 0x1::option::borrow_mut<AggregatorConfig<T0, T1>>(&mut arg0.aggregator_config);
        let v1 = 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::market_state_id<T0, T1>(&arg1);
        assert!(!0x2::table::contains<0x2::object::ID, 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&v0.archived_escrows, v1), 31);
        0x2::table::add<0x2::object::ID, 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&mut v0.archived_escrows, v1, arg1);
    }
    ...
    public fun borrow_active_escrow_mut<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: &0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth) : &mut 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1> {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(arg1) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        assert!(0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config), 11);
        let v0 = 0x1::option::borrow_mut<AggregatorConfig<T0, T1>>(&mut arg0.aggregator_config);
        assert!(0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&v0.active_escrow), 7);
        0x1::option::borrow_mut<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&mut v0.active_escrow)
    }
    ...
    fun calculate_fee_info<T0, T1, T2>(arg0: &UnifiedSpotPool<T0, T1, T2>, arg1: &0x2::clock::Clock) : FeeInfo {
        let v0 = if (0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config)) {
            0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::protocol_fee_bps()
        } else {
            0
        };
        let v1 = arg0.fee_bps;
        let v2 = v0 + v1;
        let v3 = if (0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::fee_scheduler::FeeSchedule>(&arg0.fee_schedule)) {
            0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::fee_scheduler::get_current_fee(0x1::option::borrow<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::fee_scheduler::FeeSchedule>(&arg0.fee_schedule), v2, arg0.fee_schedule_activation_time, 0x2::clock::timestamp_ms(arg1))
        } else {
            v2
        };
        FeeInfo{
    ...
    public fun calculate_raw_gap_fee(arg0: u64) : u64 {
        if (arg0 >= 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::twelve_hours_ms()) {
            return 0
        };
        let v0 = arg0 / 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::thirty_minutes_ms();
        if (v0 >= 63) {
            return 0
        };
        let v1 = 18446744073709551615 >> (v0 as u8);
        v1 - ((((v1 - (18446744073709551615 >> ((v0 + 1) as u8))) as u128) * ((arg0 % 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::thirty_minutes_ms()) as u128) / (0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::thirty_minutes_ms() as u128)) as u64)
    }
    ...
    public fun can_create_proposals<T0, T1, T2>(arg0: &UnifiedSpotPool<T0, T1, T2>, arg1: &0x2::clock::Clock) : bool {
        ...
        if (0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::fee_scheduler::FeeSchedule>(&arg0.fee_schedule)) {
            let v1 = 0x1::option::borrow<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::fee_scheduler::FeeSchedule>(&arg0.fee_schedule);
            let v2 = 0x2::clock::timestamp_ms(arg1);
            let v3 = arg0.fee_schedule_activation_time;
            let v4 = v2 <= v3 || v2 - v3 < 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::fee_scheduler::duration_ms(v1);
            !v4
        } else {
            true
        }
    ...
    public fun deposit_protocol_fees_asset<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0x2::balance::Balance<T0>, arg2: 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth) {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(&arg2) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        assert!(0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config), 11);
        0x2::balance::join<T0>(&mut 0x1::option::borrow_mut<AggregatorConfig<T0, T1>>(&mut arg0.aggregator_config).protocol_fees_asset, arg1);
    }

    public fun deposit_protocol_fees_stable<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0x2::balance::Balance<T1>, arg2: 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth) {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(&arg2) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        assert!(0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config), 11);
    ...
    public fun emergency_withdraw_protocol_fees<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: u64, arg2: u64, arg3: &0x7b8b388d3e741cad40114dd0644959bbabb3d065a9a657e5d0d43e1445e4fb9f::emergency_cap::EmergencyCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        0x7b8b388d3e741cad40114dd0644959bbabb3d065a9a657e5d0d43e1445e4fb9f::emergency_cap::assert_ready(arg3, arg4);
    ...
    public fun emergency_withdraw_reserves<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: u64, arg2: u64, arg3: &0x7b8b388d3e741cad40114dd0644959bbabb3d065a9a657e5d0d43e1445e4fb9f::emergency_cap::EmergencyCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        0x7b8b388d3e741cad40114dd0644959bbabb3d065a9a657e5d0d43e1445e4fb9f::emergency_cap::assert_ready(arg3, arg4);
    ...
    public fun extract_active_escrow<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth) : 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1> {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(&arg1) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        assert!(0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config), 11);
        let v0 = 0x1::option::borrow_mut<AggregatorConfig<T0, T1>>(&mut arg0.aggregator_config);
        assert!(0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&v0.active_escrow), 7);
        0x1::option::extract<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&mut v0.active_escrow)
    }

    public fun extract_escrow_by_market_id<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0x2::object::ID, arg2: 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth) : (0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>, bool) {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(&arg2) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        assert!(0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config), 11);
        let v0 = 0x1::option::borrow_mut<AggregatorConfig<T0, T1>>(&mut arg0.aggregator_config);
        if (0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&v0.active_escrow)) {
            if (0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::market_state_id<T0, T1>(0x1::option::borrow<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&v0.active_escrow)) == arg1) {
                return (0x1::option::extract<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&mut v0.active_escrow), true)
            };
        };
        assert!(0x2::table::contains<0x2::object::ID, 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&v0.archived_escrows, arg1), 30);
        (0x2::table::remove<0x2::object::ID, 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&mut v0.archived_escrows, arg1), false)
    }
    ...
    public fun get_active_escrow_id<T0, T1, T2>(arg0: &UnifiedSpotPool<T0, T1, T2>) : 0x1::option::Option<0x2::object::ID> {
        ...
        if (0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&v0.active_escrow)) {
            0x1::option::some<0x2::object::ID>(0x2::object::id<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(0x1::option::borrow<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&v0.active_escrow)))
        } else {
    ...
    public fun get_geometric_twap<T0, T1, T2>(arg0: &UnifiedSpotPool<T0, T1, T2>, arg1: &0x2::clock::Clock) : u128 {
        assert!(0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config), 11);
        let v0 = 0x1::option::borrow<AggregatorConfig<T0, T1>>(&arg0.aggregator_config);
        assert!(0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&v0.simple_twap), 11);
        let v1 = 0x1::option::borrow<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&v0.simple_twap);
        unwrap_option_with_default(0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::get_ninety_day_twap(v1, arg1), 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::get_twap(v1))
    }
    ...
    public fun get_simple_twap<T0, T1, T2>(arg0: &UnifiedSpotPool<T0, T1, T2>) : &0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP {
        assert!(0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config), 11);
        let v0 = 0x1::option::borrow<AggregatorConfig<T0, T1>>(&arg0.aggregator_config);
        assert!(0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&v0.simple_twap), 11);
        0x1::option::borrow<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&v0.simple_twap)
    }
    ...
    public fun get_spot_price<T0, T1, T2>(arg0: &UnifiedSpotPool<T0, T1, T2>) : u128 {
        ...
        (v1 as u128) * 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::price_scale() / (v0 as u128)
    }
    ...
    public fun has_active_escrow<T0, T1, T2>(arg0: &UnifiedSpotPool<T0, T1, T2>) : bool {
        ...
        0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&0x1::option::borrow<AggregatorConfig<T0, T1>>(&arg0.aggregator_config).active_escrow)
    }
    ...
    public fun is_twap_ready<T0, T1, T2>(arg0: &UnifiedSpotPool<T0, T1, T2>, arg1: &0x2::clock::Clock) : bool {
        ...
        let v0 = 0x1::option::borrow<AggregatorConfig<T0, T1>>(&arg0.aggregator_config);
        if (0x1::option::is_none<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&v0.simple_twap)) {
            return false
        };
        0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::is_ready(0x1::option::borrow<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&v0.simple_twap), arg1)
    }
    ...
    public fun mark_liquidity_to_proposal<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: u64, arg2: &0x2::clock::Clock, arg3: 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth) {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(&arg3) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        assert!(!arg0.is_dissolved, 32);
        assert!(arg1 < 100, 25);
        if (0x1::option::is_none<AggregatorConfig<T0, T1>>(&arg0.aggregator_config)) {
            return
        ...
        let v0 = 0x1::option::borrow_mut<AggregatorConfig<T0, T1>>(&mut arg0.aggregator_config);
        if (0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&v0.simple_twap)) {
            0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::update(0x1::option::borrow_mut<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&mut v0.simple_twap), get_spot_price<T0, T1, T2>(arg0), arg2);
            v0.spot_cumulative_at_lock = 0x1::option::some<u256>(0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::cumulative_total(0x1::option::borrow<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&v0.simple_twap)));
        };
    ...
    public fun remove_liquidity<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0x2::coin::Coin<T2>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        assert!(v1 >= v0, 3);
        assert!(0x1::option::is_none<0x2::object::ID>(&arg0.active_proposal_id), 15);
        let v2 = 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::math::safe_u128_to_u64((0x2::balance::value<T0>(&arg0.asset_reserve) as u128) * (v0 as u128) / (v1 as u128));
        let v3 = 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::math::safe_u128_to_u64((0x2::balance::value<T1>(&arg0.stable_reserve) as u128) * (v0 as u128) / (v1 as u128));
        assert!(v2 >= arg2, 5);
        assert!(v3 >= arg3, 5);
    ...
    public fun remove_liquidity_for_dissolution<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0x2::coin::Coin<T2>, arg2: bool, arg3: 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(&arg3) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        let v0 = 0x2::coin::value<T2>(&arg1);
        let v1 = 0x2::coin::total_supply<T2>(&arg0.lp_treasury_cap);
        assert!(v0 > 0, 4);
    ...
    public fun set_fee_bps<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: u64, arg2: 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth) {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(&arg2) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        assert!(arg1 <= 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::max_amm_fee_bps(), 24);
        arg0.fee_bps = arg1;
    }
    ...
    public fun simulate_swap_asset_to_stable_accurate<T0, T1, T2>(arg0: &UnifiedSpotPool<T0, T1, T2>, arg1: u64, arg2: &0x2::clock::Clock) : u64 {
        ...
        let v3 = 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::math::mul_div_to_64(arg1, v2.current_total_bps, 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::total_fee_bps());
        if (arg1 <= v3) {
            return 0
        };
        let v4 = arg1 - v3;
    ...
    fun split_fee(arg0: u64, arg1: &FeeInfo, arg2: bool) : (u64, u64) {
        if (!arg2 || arg1.steady_total_bps == 0) {
            ...
            let v2 = 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::math::mul_div_to_64(arg0, arg1.steady_protocol_bps, arg1.steady_total_bps);
            (v2, arg0 - v2)
        }
    }
    ...
    public fun store_active_escrow<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>, arg2: 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth) {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(&arg2) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        assert!(!arg0.is_dissolved, 32);
        assert!(0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config), 11);
        let v0 = 0x1::option::borrow_mut<AggregatorConfig<T0, T1>>(&mut arg0.aggregator_config);
        if (0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&v0.active_escrow)) {
            let v1 = 0x1::option::extract<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&mut v0.active_escrow);
            if (!0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::market_state::is_finalized(0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::get_market_state<T0, T1>(&v1))) {
                0x1::option::fill<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&mut v0.active_escrow, v1);
                abort 15
            };
            let v2 = 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::market_state_id<T0, T1>(&v1);
            assert!(!0x2::table::contains<0x2::object::ID, 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&v0.archived_escrows, v2), 31);
            0x2::table::add<0x2::object::ID, 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&mut v0.archived_escrows, v2, v1);
        };
        0x1::option::fill<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&mut v0.active_escrow, arg1);
    }

    public fun store_extracted_escrow<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>, arg2: bool, arg3: 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth) {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(&arg3) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        assert!(0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config), 11);
        let v0 = 0x1::option::borrow_mut<AggregatorConfig<T0, T1>>(&mut arg0.aggregator_config);
        if (arg2) {
            assert!(0x1::option::is_none<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&v0.active_escrow), 15);
            0x1::option::fill<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::TokenEscrow<T0, T1>>(&mut v0.active_escrow, arg1);
        } else {
            assert!(0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::market_state::is_finalized(0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::get_market_state<T0, T1>(&arg1)), 35);
            let v1 = 0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::coin_escrow::market_state_id<T0, T1>(&arg1);
    ...
    public fun swap_asset_for_stable<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v3 = 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::math::mul_div_to_64(v0, v2.current_total_bps, 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::total_fee_bps());
        assert!(v0 > v3, 23);
        ...
        if (v4) {
            ...
            if (0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&v9.simple_twap)) {
                0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::update(0x1::option::borrow_mut<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&mut v9.simple_twap), get_spot_price<T0, T1, T2>(arg0), arg3);
            };
        };
    ...
    public(friend) fun update_twap_after_arbitrage<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: &0x2::clock::Clock) {
        if (0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config)) {
            let v0 = 0x1::option::borrow_mut<AggregatorConfig<T0, T1>>(&mut arg0.aggregator_config);
            if (0x1::option::is_some<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&v0.simple_twap)) {
                0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::update(0x1::option::borrow_mut<0xecce0ded56e58dc48a67c8e821886c1bb27b0a957908321c2ff0e0f467bab843::PCW_TWAP_oracle::SimpleTWAP>(&mut v0.simple_twap), get_spot_price<T0, T1, T2>(arg0), arg1);
            };
        };
    }

    public fun withdraw_protocol_fees_asset<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth) : 0x2::balance::Balance<T0> {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(&arg1) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        assert!(0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config), 11);
        let v0 = 0x1::option::borrow_mut<AggregatorConfig<T0, T1>>(&mut arg0.aggregator_config);
    ...
    public fun withdraw_protocol_fees_stable<T0, T1, T2>(arg0: &mut UnifiedSpotPool<T0, T1, T2>, arg1: 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationAuth) : 0x2::balance::Balance<T1> {
        assert!(0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::target_id(&arg1) == 0x2::object::id<UnifiedSpotPool<T0, T1, T2>>(arg0), 27);
        assert!(0x1::option::is_some<AggregatorConfig<T0, T1>>(&arg0.aggregator_config), 11);
        let v0 = 0x1::option::borrow_mut<AggregatorConfig<T0, T1>>(&mut arg0.aggregator_config);
