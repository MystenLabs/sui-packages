module 0x39d11938aed623b39d8ebc83d699ee641e838f0476bafa6ae582ea63cf198ac7::utility {
    ...
    fun init(arg0: UTILITY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<UTILITY>>(0x2::coin::from_balance<UTILITY>(0x2::balance::increase_supply<UTILITY>(&mut v2.total_supply, 100000000000000000), arg1), 0x2::tx_context::sender(arg1));
        0x2::transfer::share_object<Metadata<UTILITY>>(v2);
    }

    entry fun migrate(arg0: &mut Metadata<UTILITY>, arg1: &0x39d11938aed623b39d8ebc83d699ee641e838f0476bafa6ae582ea63cf198ac7::ownership::OwnerCap) {
        assert!(arg0.version < 1, 1);
