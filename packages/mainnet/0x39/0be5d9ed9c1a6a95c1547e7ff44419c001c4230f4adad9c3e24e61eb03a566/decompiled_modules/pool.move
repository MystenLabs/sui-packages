module 0x390be5d9ed9c1a6a95c1547e7ff44419c001c4230f4adad9c3e24e61eb03a566::pool {
    ...
    struct Vault<phantom T0> has store, key {
        ...
        coin_type_a: 0x1::type_name::TypeName,
        coin_type_b: 0x1::type_name::TypeName,
        buffer_assets: 0x390be5d9ed9c1a6a95c1547e7ff44419c001c4230f4adad9c3e24e61eb03a566::balance_bag::BalanceBag,
    ...
    struct IDEvent has copy, drop {
        vault_id: 0x2::object::ID,
    }

    public fun add_coin<T0: drop, T1>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T1>) {
        0x390be5d9ed9c1a6a95c1547e7ff44419c001c4230f4adad9c3e24e61eb03a566::balance_bag::join<T1>(&mut arg0.buffer_assets, 0x2::coin::into_balance<T1>(arg1));
    }
    ...
    public fun get_id(arg0: 0x2::object::ID) {
        let v0 = IDEvent{vault_id: arg0};
        0x2::event::emit<IDEvent>(v0);
    }

    public fun get_number(arg0: u64) {
        let v0 = NumberEvent{number: arg0};
    ...
    public fun new_vault<T0, T1>(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
            ...
            coin_type_a   : 0x1::type_name::with_defining_ids<T0>(),
            coin_type_b   : 0x1::type_name::with_defining_ids<T1>(),
            buffer_assets : 0x390be5d9ed9c1a6a95c1547e7ff44419c001c4230f4adad9c3e24e61eb03a566::balance_bag::new_balance_bag(arg0),
