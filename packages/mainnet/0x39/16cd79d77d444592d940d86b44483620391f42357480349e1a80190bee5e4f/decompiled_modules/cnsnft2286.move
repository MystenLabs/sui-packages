module 0x3916cd79d77d444592d940d86b44483620391f42357480349e1a80190bee5e4f::cnsnft2286 {
    struct CNSNFT2286 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2286, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2286>(arg0, arg1);
