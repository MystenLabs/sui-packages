module 0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::pair_parameter_helper {
    ...
    public fun get_base_fee(arg0: &PairParameters, arg1: u16) : u64 {
        0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::safe_math::mul_u64(0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::safe_math::mul_u64((arg0.base_factor as u64), (arg1 as u64)), 10)
    }
    ...
    public fun get_total_fee_rate(arg0: &PairParameters, arg1: u16) : u64 {
        0x1::u64::min(0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::safe_math::add_u64(get_base_fee(arg0, arg1), get_variable_fee(arg0, arg1)), 0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::constants::max_fee_rate())
    }

    public fun get_variable_fee(arg0: &PairParameters, arg1: u16) : u64 {
        let v0 = (arg0.variable_fee_control as u64);
        if (v0 != 0) {
            let v2 = 0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::safe_math::mul_u64((arg0.volatility_accumulator as u64), (arg1 as u64));
            (0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::safe_math::mul_u64(0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::safe_math::mul_u64(v2, v2), v0) + 99) / 100
        } else {
            0
        }
    }
    ...
    public(friend) fun set_static_fee_parameters(arg0: &mut PairParameters, arg1: u32, arg2: u16, arg3: u16, arg4: u16, arg5: u32, arg6: u16, arg7: u32) {
        let v0 = if (arg2 <= arg3) {
            if ((arg4 as u64) <= 0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::constants::basis_point_max()) {
                if (arg5 <= 0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::constants::max_variable_fee_control()) {
                    arg7 <= 1048575
                } else {
                    false
                }
        ...
        assert!(v0, 600);
        0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::fee_helper::verify_protocol_share(arg6);
    ...
    public fun update_volatility_accumulator(arg0: &mut PairParameters, arg1: u32) {
        arg0.volatility_accumulator = 0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::safe_math::u64_to_u32(0x1::u64::min(0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::safe_math::add_u64((arg0.volatility_reference as u64), 0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::safe_math::mul_u64((0x1::u32::diff(arg1, arg0.id_reference) as u64), 0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::constants::basis_point_max())), (arg0.max_volatility_accumulator as u64)));
    }
    ...
    public fun update_volatility_reference(arg0: &mut PairParameters) {
        arg0.volatility_reference = 0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::safe_math::u64_to_u32(0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::safe_math::mul_div_u64((arg0.volatility_accumulator as u64), (arg0.reduction_factor as u64), 0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::constants::basis_point_max()));
    }
