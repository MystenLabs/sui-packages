module 0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::safe_math {
    ...
    public fun sqrt_u128(arg0: u128) : u128 {
        ...
        let v0 = 1 << (0x39ffbb6b375ecb1df63d4a823b11443ec63d62fe4c05d4a4a333d39b24bac4b2::bit_math::most_significant_bit(arg0) + 1) / 2;
        let v1 = (arg0 / v0 + v0) / 2;
        while (v1 < v0) {
            let v2 = arg0 / v1 + v1;
            v1 = v2 / 2;
