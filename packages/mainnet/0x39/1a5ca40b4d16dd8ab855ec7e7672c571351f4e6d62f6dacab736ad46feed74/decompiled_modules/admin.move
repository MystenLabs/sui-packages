module 0x3b56af191976c2c7382531e47c05e9d542552e3adfd998334b0c2be2b1d90f74::admin {
    ...
    public fun authorize(arg0: &AdminCap, arg1: &mut 0x2::object::UID) {
        ...
        0x3b56af191976c2c7382531e47c05e9d542552e3adfd998334b0c2be2b1d90f74::events::emit_authorized_app_event(arg1);
    }

    public(friend) fun create_admin_cap<T0: drop>(arg0: &T0, arg1: &mut 0x2::tx_context::TxContext) : AdminCap {
        assert!(0x2::types::is_one_time_witness<T0>(arg0), 9223372268783009793);
    ...
    public fun deauthorize(arg0: &AdminCap, arg1: &mut 0x2::object::UID) {
        ...
        0x3b56af191976c2c7382531e47c05e9d542552e3adfd998334b0c2be2b1d90f74::events::emit_deauthorized_app_event(arg1);
    }
