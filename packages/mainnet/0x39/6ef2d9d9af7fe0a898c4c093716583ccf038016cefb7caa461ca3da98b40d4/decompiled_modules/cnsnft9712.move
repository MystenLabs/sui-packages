module 0x396ef2d9d9af7fe0a898c4c093716583ccf038016cefb7caa461ca3da98b40d4::cnsnft9712 {
    struct CNSNFT9712 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9712, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9712>(arg0, arg1);
