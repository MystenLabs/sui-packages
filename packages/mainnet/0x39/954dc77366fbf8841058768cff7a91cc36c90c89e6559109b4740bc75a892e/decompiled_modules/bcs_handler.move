module 0x39954dc77366fbf8841058768cff7a91cc36c90c89e6559109b4740bc75a892e::bcs_handler {
    ...
    public fun dec_order(arg0: vector<u8>) : (vector<u8>, address, address, 0x1::string::String, u64, u64, u64, bool, bool, u64, u64, u64) {
        let v0 = 0x2::bcs::new(arg0);
        (0x2::hash::blake2b256(&arg0), 0x2::bcs::peel_address(&mut v0), 0x2::bcs::peel_address(&mut v0), 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v0)), 0x2::bcs::peel_u64(&mut v0), 0x2::bcs::peel_u64(&mut v0), 0x2::bcs::peel_u64(&mut v0), 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v0)) == 0x39954dc77366fbf8841058768cff7a91cc36c90c89e6559109b4740bc75a892e::constants::position_long(), 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v0)) == 0x39954dc77366fbf8841058768cff7a91cc36c90c89e6559109b4740bc75a892e::constants::position_isolated(), 0x2::bcs::peel_u64(&mut v0), 0x2::bcs::peel_u64(&mut v0), 0x2::bcs::peel_u64(&mut v0))
    }
