module 0x396870f28abbc6cd57916b3d98aee3bd16f709a2ef1adb488c5c8097e1148aae::reward4171 {
    struct REWARD4171 has drop {
        dummy_field: bool,
    }

    struct TICKET_4171 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4171(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4171>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4171>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4171, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4171>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4171>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4171>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4171>>(v5, 0x2::tx_context::sender(arg1));
    }
