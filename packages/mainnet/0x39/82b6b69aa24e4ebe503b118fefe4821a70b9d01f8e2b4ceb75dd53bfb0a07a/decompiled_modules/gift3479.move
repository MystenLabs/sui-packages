module 0x3982b6b69aa24e4ebe503b118fefe4821a70b9d01f8e2b4ceb75dd53bfb0a07a::gift3479 {
    struct GIFT3479 has drop {
        dummy_field: bool,
    }

    struct TICKET_3479 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3479(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3479>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3479>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3479, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3479>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3479>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3479>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3479>>(v5, 0x2::tx_context::sender(arg1));
    }
