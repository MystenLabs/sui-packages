module 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::ido {
    ...
    public(friend) fun insert_core_vault(arg0: &mut Round) {
        0x2::vec_map::insert<0x1::string::String, 0x2::object::ID>(&mut arg0.core, 0x1::string::utf8(b"VAULT"), *0x2::object::uid_as_inner(0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::vault::uid(0x2::object_bag::borrow<0x1::string::String, 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::vault::Vaults>(&arg0.other, 0x1::string::utf8(b"VAULT")))));
    }
    ...
    public(friend) fun remove_core_vault(arg0: &mut Round) {
        let v0 = 0x1::string::utf8(b"VAULT");
        let (_, _) = 0x2::vec_map::remove<0x1::string::String, 0x2::object::ID>(&mut arg0.core, &v0);
    }
