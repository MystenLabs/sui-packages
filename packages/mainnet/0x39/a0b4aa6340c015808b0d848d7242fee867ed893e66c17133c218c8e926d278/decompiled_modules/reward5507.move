module 0x39a0b4aa6340c015808b0d848d7242fee867ed893e66c17133c218c8e926d278::reward5507 {
    struct REWARD5507 has drop {
        dummy_field: bool,
    }

    struct TICKET_5507 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5507(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5507>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5507>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5507, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5507>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5507>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5507>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5507>>(v5, 0x2::tx_context::sender(arg1));
    }
