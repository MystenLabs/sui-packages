module 0x39b09c838ad4bab5c64798ab7469ed4a92bf88653fa9545454dcade84c21387a::cnsnft6737 {
    struct CNSNFT6737 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6737, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6737>(arg0, arg1);
