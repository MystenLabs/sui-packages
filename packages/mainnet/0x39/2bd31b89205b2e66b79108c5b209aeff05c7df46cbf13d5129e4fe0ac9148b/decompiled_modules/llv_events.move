module 0x392bd31b89205b2e66b79108c5b209aeff05c7df46cbf13d5129e4fe0ac9148b::llv_events {
    ...
    struct Withdrawn has copy, drop {
        ...
        shares_burned: u128,
        amount_received: u64,
        recall: vector<0x392bd31b89205b2e66b79108c5b209aeff05c7df46cbf13d5129e4fe0ac9148b::llv_allocation_plan::ProtocolAmount>,
        timestamp_ms: u64,
    }

    struct BalancesSynced has copy, drop {
        pool_id: 0x2::object::ID,
        balances: vector<0x392bd31b89205b2e66b79108c5b209aeff05c7df46cbf13d5129e4fe0ac9148b::llv_allocation_plan::ProtocolAmount>,
        total_assets: u128,
    ...
    public(friend) fun emit_accrue_fees(arg0: 0x2::object::ID, arg1: u128, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u128, arg7: u128, arg8: u128, arg9: u64) {
        let v0 = AccrueFeesEvent{
            pool_id                : arg0,
        ...
        0x2::event::emit<AccrueFeesEvent>(v0);
    }
    ...
    public(friend) fun emit_balances_synced(arg0: 0x2::object::ID, arg1: vector<0x392bd31b89205b2e66b79108c5b209aeff05c7df46cbf13d5129e4fe0ac9148b::llv_allocation_plan::ProtocolAmount>, arg2: u128, arg3: u128, arg4: u64) {
    ...
    public(friend) fun emit_deposited(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: u128, arg5: vector<0x392bd31b89205b2e66b79108c5b209aeff05c7df46cbf13d5129e4fe0ac9148b::llv_allocation_plan::ProtocolAmount>, arg6: u64) {
        let v0 = Deposited{
            pool_id       : arg0,
            position_id   : arg1,
            user          : arg2,
    ...
    public(friend) fun emit_set_allocation(arg0: 0x2::object::ID, arg1: u8, arg2: u8, arg3: bool, arg4: u64, arg5: u128, arg6: u64) {
        let v0 = SetAllocationEvent{
            pool_id          : arg0,
            protocol_id      : arg1,
            action           : arg2,
            enabled          : arg3,
        ...
        0x2::event::emit<SetAllocationEvent>(v0);
    }
    ...
    public(friend) fun emit_vault_deposit(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: address, arg3: u128, arg4: u128, arg5: vector<0x392bd31b89205b2e66b79108c5b209aeff05c7df46cbf13d5129e4fe0ac9148b::llv_allocation_plan::ProtocolAmount>, arg6: u64) {
        let v0 = VaultDepositEvent{
            pool_id       : arg0,
            position_id   : arg1,
            user          : arg2,
            asset_amount  : arg3,
        ...
        0x2::event::emit<VaultDepositEvent>(v0);
    }

    public(friend) fun emit_vault_withdraw(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: address, arg3: u128, arg4: u128, arg5: vector<0x392bd31b89205b2e66b79108c5b209aeff05c7df46cbf13d5129e4fe0ac9148b::llv_allocation_plan::ProtocolAmount>, arg6: u64) {
        let v0 = VaultWithdrawEvent{
            pool_id       : arg0,
            position_id   : arg1,
            user          : arg2,
            asset_amount  : arg3,
        ...
        0x2::event::emit<VaultWithdrawEvent>(v0);
    }

    public(friend) fun emit_withdrawn(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: address, arg3: u128, arg4: u64, arg5: vector<0x392bd31b89205b2e66b79108c5b209aeff05c7df46cbf13d5129e4fe0ac9148b::llv_allocation_plan::ProtocolAmount>, arg6: u64) {
        let v0 = Withdrawn{
            pool_id         : arg0,
            position_id     : arg1,
            user            : arg2,
