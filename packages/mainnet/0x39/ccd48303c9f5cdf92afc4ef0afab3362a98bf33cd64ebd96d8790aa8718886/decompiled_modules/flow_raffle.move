module 0x39ccd48303c9f5cdf92afc4ef0afab3362a98bf33cd64ebd96d8790aa8718886::flow_raffle {
    ...
    struct KioskLock has key {
        id: 0x2::object::UID,
        kiosk_cap: 0x2::kiosk::KioskOwnerCap,
        raffle_id: 0x2::object::ID,
        locked_nft_id: 0x2::object::ID,
    }
    ...
    public entry fun cancel_raffle_escrow<T0: store + key>(arg0: &mut HybridRaffle, arg1: NFTEscrow<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3 == 0x2::object::id<HybridRaffle>(arg0), 23);
        0x2::transfer::public_transfer<T0>(v2, v0);
        arg0.active = false;
        let v5 = RaffleCancelled{
            raffle_id : 0x2::object::id<HybridRaffle>(arg0),
            creator   : v0,
            nft_id    : arg0.nft_id,
        };
        0x2::event::emit<RaffleCancelled>(v5);
    }

    public entry fun cancel_raffle_kiosk<T0: store + key>(arg0: &mut HybridRaffle, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.active = false;
        let v6 = RaffleCancelled{
            raffle_id : 0x2::object::id<HybridRaffle>(arg0),
            creator   : v0,
            nft_id    : arg0.nft_id,
        };
        0x2::event::emit<RaffleCancelled>(v6);
    }

    public entry fun claim_kiosk_ownership(arg0: &mut HybridRaffle, arg1: KioskLock, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.active, 2);
        assert!(0x2::clock::timestamp_ms(arg2) >= arg0.end_time, 15);
        let v0 = 0x2::tx_context::sender(arg3);
        ...
        assert!(arg1.locked_nft_id == arg0.nft_id, 12);
        let KioskLock {
            id            : v1,
            kiosk_cap     : v2,
            raffle_id     : _,
    ...
    public entry fun create_kiosk_lock_raffle<T0: store + key>(arg0: &GlobalConfig, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: u64, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<HybridRaffleCreated>(v6);
        0x2::transfer::share_object<KioskLock>(v4);
