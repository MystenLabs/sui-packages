module 0x3956cc83721a954057ac2ee162924667acc49361bba4dc063014adeb74d4faec::clutchynfts {
    ...
    fun init(arg0: CLUTCHYNFTS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::create_domain_and_add_strategy<ClutchyNft>(v9, &mut v3, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty::from_shares(0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::utils::from_vec_to_map<address, u16>(v10, vector[2000, 8000]), arg1), 500, arg1);
        let (v12, v13) = 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::init_policy<ClutchyNft>(&v4, arg1);
        let v14 = v13;
        let v15 = v12;
        let v16 = Witness{dummy_field: false};
        0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::orderbook::create_unprotected<ClutchyNft, 0x2::sui::SUI>(0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::from_witness<ClutchyNft, Witness>(v16), &v15, arg1);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::transfer_allowlist::enforce<ClutchyNft>(&mut v15, &v14);
        ...
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<ClutchyNft>>(v14, v0);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<ClutchyNft>>(v15);
