module 0x392582b5c9886da0a1aeb201a7a27a3014cac3f4c3159e6a20efc21d67c022b3::crowdfunding {
    ...
    struct DonationRecord has drop, store {
        donor: address,
        amount: u64,
    ...
    entry fun admin_delete_project(arg0: &AdminCap, arg1: Project, arg2: &Platform, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::balance::value<0x2::sui::SUI>(&arg1.sui_balance) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v14, arg4), v8);
        } else {
        ...
        if (0x2::balance::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&arg1.usdc_balance) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(0x2::coin::from_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(v15, arg4), v8);
        } else {
            0x2::balance::destroy_zero<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(v15);
        };
        0x2::object::delete(v1);
        let v17 = ProjectDeleted{
            project_id : 0x2::object::uid_to_address(&arg1.id),
            deleted_by : 0x2::tx_context::sender(arg4),
            reason     : arg3,
        };
        0x2::event::emit<ProjectDeleted>(v17);
    }
    ...
    entry fun donate_to_platform(arg0: &mut Platform, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg1);
        assert!(v0 > 0, 4);
        let v1 = 0x2::tx_context::sender(arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, arg0.fee_wallet_address);
        arg0.total_donations_received = arg0.total_donations_received + v0;
        let v2 = DonationRecord{
            donor      : v1,
            amount     : v0,
            message    : arg2,
            donated_at : 0x2::clock::timestamp_ms(arg3),
        };
    ...
    entry fun execute_withdrawal(arg0: AdminProposal, arg1: &mut Project, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_donation_record(arg0: &DonationRecord) : (address, u64, 0x1::string::String, u64) {
        (arg0.donor, arg0.amount, arg0.message, arg0.donated_at)
    }

    public fun get_donations(arg0: &Platform) : &vector<DonationRecord> {
        &arg0.donations
    }
    ...
    public fun get_total_donations_received(arg0: &Platform) : u64 {
        arg0.total_donations_received
    }
