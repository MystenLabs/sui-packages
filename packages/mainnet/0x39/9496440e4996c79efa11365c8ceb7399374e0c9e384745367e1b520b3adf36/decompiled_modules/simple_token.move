module 0x399496440e4996c79efa11365c8ceb7399374e0c9e384745367e1b520b3adf36::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"Eloo", b"Elooo coin", b"Simple Token showcases", 0x1::option::none<0x2::url::Url>(), arg1);
