module 0x39bc423e17ae6643f10424f297e88051074030e0e844130c37a6eeaa3e69b916::dex_cetus {
    ...
    public fun swap_cross<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = SwapExecuted{
            ...
            amount_out   : v0,
            trader       : arg1,
            pool_address : 0x39bc423e17ae6643f10424f297e88051074030e0e844130c37a6eeaa3e69b916::constants::get_cetus_sui_usdc_pool(),
        };
