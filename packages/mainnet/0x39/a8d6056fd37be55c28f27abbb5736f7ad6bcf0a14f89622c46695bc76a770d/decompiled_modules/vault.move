module 0xf2249d15f7ca64a117bad76da6fb305dfd8c2cabadc163049ef681deb1e98bf3::vault {
    ...
    struct TimeoutSet has copy, drop {
        vault_id: 0x2::object::ID,
        owner: address,
        old_timeout: u64,
        new_timeout: u64,
    ...
    public entry fun set_timeout(arg0: &mut Vault, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg2) / 1000;
        assert_authorized_sponsor(arg0, 0x2::tx_context::sender(arg3));
        assert!(!arg0.claimed, 2);
        assert!(arg1 > 0, 3);
        let v1 = arg1 * 24 * 60 * 60;
        assert!(v0 < arg0.last_checkin + v1, 2);
        arg0.timeout_period = v1;
        if (arg0.checkin_window_secs > 0 && arg0.checkin_window_secs > v1) {
            arg0.checkin_window_secs = v1;
        };
        let v2 = TimeoutSet{
            vault_id    : 0x2::object::uid_to_inner(&arg0.id),
