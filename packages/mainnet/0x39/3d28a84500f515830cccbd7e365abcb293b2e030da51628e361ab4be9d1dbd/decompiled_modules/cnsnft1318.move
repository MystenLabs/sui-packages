module 0x393d28a84500f515830cccbd7e365abcb293b2e030da51628e361ab4be9d1dbd::cnsnft1318 {
    struct CNSNFT1318 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1318, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1318>(arg0, arg1);
