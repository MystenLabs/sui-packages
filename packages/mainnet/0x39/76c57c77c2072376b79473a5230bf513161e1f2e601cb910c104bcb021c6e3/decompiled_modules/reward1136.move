module 0x3976c57c77c2072376b79473a5230bf513161e1f2e601cb910c104bcb021c6e3::reward1136 {
    struct REWARD1136 has drop {
        dummy_field: bool,
    }

    struct TICKET_1136 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1136(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1136>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1136>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1136, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1136>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1136>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1136>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1136>>(v5, 0x2::tx_context::sender(arg1));
    }
