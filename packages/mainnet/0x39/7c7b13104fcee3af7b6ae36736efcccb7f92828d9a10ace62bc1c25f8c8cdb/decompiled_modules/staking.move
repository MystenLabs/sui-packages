module 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::staking {
    ...
    fun add_rewards(arg0: &mut StakingPool, arg1: 0x2::coin::Coin<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun burn90_and_deposit10(arg0: &mut StakingPool, arg1: &mut 0x2::coin::TreasuryCap<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>, arg2: 0x2::coin::Coin<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = v0 * 9 / 10;
        0x2::coin::burn<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>(arg1, 0x2::coin::split<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>(&mut arg2, v1, arg3));
    ...
    public entry fun claim_staking_rewards(arg0: &mut StakingPool, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1, 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_NOTHING_TO_CLAIM());
    ...
    fun pay_and_update_single(arg0: &mut StakingPool, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>>(0x2::coin::split<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>(&mut arg0.rewards, v4, arg3), arg2);
        };
        v0.reward_snap = v3;
    }
    ...
    public entry fun stake(arg0: &mut StakingPool, arg1: 0x2::coin::Coin<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::coin::value<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>(&arg1);
        assert!(v2 > 0, 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_NOTHING_TO_CLAIM());
    ...
    public entry fun unstake(arg0: &mut StakingPool, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3.shares >= arg1, 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_NOTHING_TO_CLAIM());
