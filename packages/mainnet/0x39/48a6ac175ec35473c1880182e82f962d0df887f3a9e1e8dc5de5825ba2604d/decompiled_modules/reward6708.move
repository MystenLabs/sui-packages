module 0x3948a6ac175ec35473c1880182e82f962d0df887f3a9e1e8dc5de5825ba2604d::reward6708 {
    struct REWARD6708 has drop {
        dummy_field: bool,
    }

    struct TICKET_6708 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6708(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6708>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6708>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6708, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6708>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6708>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6708>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6708>>(v5, 0x2::tx_context::sender(arg1));
    }
