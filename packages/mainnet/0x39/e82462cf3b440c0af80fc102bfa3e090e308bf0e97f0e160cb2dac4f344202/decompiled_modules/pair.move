module 0x39e82462cf3b440c0af80fc102bfa3e090e308bf0e97f0e160cb2dac4f344202::pair {
    ...
    public fun swap<T0, T1>(arg0: &mut PairMetadata<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        assert!(((v6 as u256) * 1000 - (v2 as u256) * 3) * ((v7 as u256) * 1000 - (v3 as u256) * 3) >= (v0 as u256) * (v1 as u256) * 1000000, 5);
        let v8 = Swapped{
    ...
    public fun burn<T0, T1>(arg0: &mut PairMetadata<T0, T1>, arg1: &0x39e82462cf3b440c0af80fc102bfa3e090e308bf0e97f0e160cb2dac4f344202::treasury::Treasury, arg2: 0x2::coin::Coin<LP<T0, T1>>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let (v0, v1) = get_reserves<T0, T1>(arg0);
        let v2 = 0x2::coin::value<LP<T0, T1>>(&arg2);
        let v3 = mint_fee<T0, T1>(arg0, 0x39e82462cf3b440c0af80fc102bfa3e090e308bf0e97f0e160cb2dac4f344202::treasury::treasurer(arg1), arg3);
    ...
    public fun get_lp_name<T0, T1>() : 0x1::string::String {
        ...
        0x1::string::append(&mut v0, 0x39e82462cf3b440c0af80fc102bfa3e090e308bf0e97f0e160cb2dac4f344202::type_helper::get_type_name<T0>());
        0x1::string::append_utf8(&mut v0, b"-");
        0x1::string::append(&mut v0, 0x39e82462cf3b440c0af80fc102bfa3e090e308bf0e97f0e160cb2dac4f344202::type_helper::get_type_name<T1>());
        v0
    }
    ...
    public fun mint<T0, T1>(arg0: &mut PairMetadata<T0, T1>, arg1: &0x39e82462cf3b440c0af80fc102bfa3e090e308bf0e97f0e160cb2dac4f344202::treasury::Treasury, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LP<T0, T1>> {
        let (v0, v1) = get_reserves<T0, T1>(arg0);
        let v2 = 0x2::coin::value<T0>(&arg2);
        let v3 = 0x2::coin::value<T1>(&arg3);
        let v4 = mint_fee<T0, T1>(arg0, 0x39e82462cf3b440c0af80fc102bfa3e090e308bf0e97f0e160cb2dac4f344202::treasury::treasurer(arg1), arg4);
        let v5 = (total_lp_supply<T0, T1>(arg0) as u128);
        let v6 = if (v5 == 0) {
            let v7 = 0x39e82462cf3b440c0af80fc102bfa3e090e308bf0e97f0e160cb2dac4f344202::math::sqrt_u128((v2 as u128) * (v3 as u128));
            ...
            (0x39e82462cf3b440c0af80fc102bfa3e090e308bf0e97f0e160cb2dac4f344202::math::min_u128((v2 as u128) * v5 / (v0 as u128), (v3 as u128) * v5 / (v1 as u128)) as u64)
        };
        assert!(v6 > 0, 0);
    ...
    fun mint_fee<T0, T1>(arg0: &mut PairMetadata<T0, T1>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (arg1 != @0x0) {
            if (arg0.k_last != 0) {
                let v3 = 0x39e82462cf3b440c0af80fc102bfa3e090e308bf0e97f0e160cb2dac4f344202::math::sqrt_u128((v1 as u128) * (v2 as u128));
                let v4 = 0x39e82462cf3b440c0af80fc102bfa3e090e308bf0e97f0e160cb2dac4f344202::math::sqrt_u128(arg0.k_last);
                if (v3 > v4) {
