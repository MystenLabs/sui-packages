module 0x397803aeb2ec6b2bec73e9d561c36a6450f7903d91baa709b38a640632433f62::cnsnft5828 {
    struct CNSNFT5828 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5828, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5828>(arg0, arg1);
