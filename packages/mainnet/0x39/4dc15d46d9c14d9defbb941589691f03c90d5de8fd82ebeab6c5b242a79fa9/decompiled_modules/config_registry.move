module 0x394dc15d46d9c14d9defbb941589691f03c90d5de8fd82ebeab6c5b242a79fa9::config_registry {
    ...
    public entry fun create_and_share_default(arg0: &mut 0x2::tx_context::TxContext) {
        0x394dc15d46d9c14d9defbb941589691f03c90d5de8fd82ebeab6c5b242a79fa9::admin::create_and_transfer(arg0);
    ...
    public entry fun set_dev_addr(arg0: &0x394dc15d46d9c14d9defbb941589691f03c90d5de8fd82ebeab6c5b242a79fa9::admin::AdminCap, arg1: &mut Config, arg2: address) {
        arg1.dev_addr = arg2;
    }

    public entry fun set_dev_tvyn_ratio(arg0: &0x394dc15d46d9c14d9defbb941589691f03c90d5de8fd82ebeab6c5b242a79fa9::admin::AdminCap, arg1: &mut Config, arg2: u64) {
        arg1.dev_tvyn_ratio_bps = arg2;
    }

    public entry fun set_emergency_fixed_mode(arg0: &0x394dc15d46d9c14d9defbb941589691f03c90d5de8fd82ebeab6c5b242a79fa9::admin::AdminCap, arg1: &mut Config, arg2: bool) {
        arg1.emergency_fixed_mode = arg2;
    }

    public entry fun set_fees_and_ratios(arg0: &0x394dc15d46d9c14d9defbb941589691f03c90d5de8fd82ebeab6c5b242a79fa9::admin::AdminCap, arg1: &mut Config, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64) {
    ...
    public entry fun set_fixed_price_bps(arg0: &0x394dc15d46d9c14d9defbb941589691f03c90d5de8fd82ebeab6c5b242a79fa9::admin::AdminCap, arg1: &mut Config, arg2: u64) {
        arg1.fixed_sui_usd_price_bps = arg2;
    }

    public entry fun set_links(arg0: &0x394dc15d46d9c14d9defbb941589691f03c90d5de8fd82ebeab6c5b242a79fa9::admin::AdminCap, arg1: &mut Config, arg2: 0x2::object::ID, arg3: 0x2::object::ID) {
        arg1.pol_treasury_id = arg2;
        arg1.mint_vault_id = arg3;
    }

    public entry fun set_lp_operator(arg0: &0x394dc15d46d9c14d9defbb941589691f03c90d5de8fd82ebeab6c5b242a79fa9::admin::AdminCap, arg1: &mut Config, arg2: address) {
        arg1.lp_operator_addr = arg2;
    }

    public entry fun set_lp_params(arg0: &0x394dc15d46d9c14d9defbb941589691f03c90d5de8fd82ebeab6c5b242a79fa9::admin::AdminCap, arg1: &mut Config, arg2: u64, arg3: u64) {
    ...
    public entry fun set_pyth_objects(arg0: &0x394dc15d46d9c14d9defbb941589691f03c90d5de8fd82ebeab6c5b242a79fa9::admin::AdminCap, arg1: &mut Config, arg2: 0x2::object::ID, arg3: 0x2::object::ID) {
        arg1.pyth_state_id = arg2;
        arg1.pyth_sui_price_info_id = arg3;
    }

    public entry fun set_rewards(arg0: &0x394dc15d46d9c14d9defbb941589691f03c90d5de8fd82ebeab6c5b242a79fa9::admin::AdminCap, arg1: &mut Config, arg2: u64, arg3: u64, arg4: u64) {
