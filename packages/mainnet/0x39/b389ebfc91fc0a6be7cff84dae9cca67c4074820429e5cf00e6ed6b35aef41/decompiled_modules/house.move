module 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house {
    ...
    public fun get_house_config<T0>(arg0: &House<T0>) : (u64, u64, u64) {
        let v0 = HouseConfigTag{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow<HouseConfigTag, HouseConfig>(&arg0.id, v0);
        (v1.house_fee_rate, v1.max_risk, v1.house_deposit_fee)
    }
