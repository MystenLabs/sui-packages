module 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse {
    ...
    struct BetResultV2<phantom T0, phantom T1> has copy, drop {
        bet_id: 0x1::option::Option<0x2::object::ID>,
        player: address,
        bet_options: vector<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::Placement>,
        bet_size: u64,
        bet_returned: u64,
        outcome: vector<u64>,
    }

    struct MarbleRacingBetResult<phantom T0, phantom T1> has copy, drop {
        bet_id: 0x1::option::Option<0x2::object::ID>,
        player: address,
        bet_options: vector<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::MarbleRacingBetOption>,
        bet_type: u8,
        bet_size: u64,
        bet_returned: u64,
    ...
    struct BetResultsV2<phantom T0, phantom T1> has copy, drop {
        race_id: 0x1::option::Option<0x2::object::ID>,
        origin: 0x1::option::Option<0x1::string::String>,
        bets: vector<BetResultV2<T0, T1>>,
    }

    struct MarbleRacingBetResults<phantom T0, phantom T1> has copy, drop {
        race_id: 0x1::option::Option<0x2::object::ID>,
        origin: 0x1::option::Option<0x1::string::String>,
        bets: vector<MarbleRacingBetResult<T0, T1>>,
    }
    ...
    public fun deposit<T0>(arg0: &mut Unihouse, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::StakedHouseCoin<T0>> {
        ...
        let v1 = get_house_take_rate(arg0);
        let v2 = borrow_house_mut<T0>(arg0);
        let v3 = 0x2::balance::value<T0>(&v0) * 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::get_house_deposit_fee_or_default<T0>(v2, v1) / 10000;
        if (v3 > 0) {
            0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::deposit_house_pool<T0>(v2, 0x2::balance::split<T0>(&mut v0, v3));
            let v4 = HouseTakeEvent{
                house_take_amount : v3,
                coin_type         : 0x1::type_name::get<T0>(),
            };
            0x2::event::emit<HouseTakeEvent>(v4);
        };
    ...
    public fun get_house_config<T0>(arg0: &Unihouse) : (u64, u64, u64) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::dynamic_object_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 2);
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::get_house_config<T0>(0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::House<T0>>(&arg0.id, v0))
    }
    ...
    public fun max_risk<T0>(arg0: &Unihouse) : u64 {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::dynamic_object_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 2);
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::max_risk<T0>(0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::House<T0>>(&arg0.id, v0))
    }

    public fun set_house_config<T0>(arg0: &mut Unihouse, arg1: &AdminCap, arg2: u64, arg3: u64, arg4: u64) {
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::set_house_config<T0>(borrow_house_mut<T0>(arg0), arg2, arg3, arg4);
    }
    ...
    public fun assert_within_risk<T0, T1: drop>(arg0: &mut Unihouse, arg1: T1, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_rate(arg2, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::house_fee_rate_or_override<T0>(v1, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::fee_rate())) <= 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::total_house_balance<T0>(v1), 8);
    }
    ...
    public fun create_unihouse_bet_result_v3<T0, T1: drop>(arg0: &Unihouse, arg1: T1, arg2: 0x1::option::Option<0x2::object::ID>, arg3: address, arg4: vector<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::Placement>, arg5: u64, arg6: u64, arg7: vector<u64>) : BetResultV2<T0, T1> {
        abort 0
    }

    public fun create_unihouse_marble_racing_bet_result<T0, T1: drop>(arg0: &Unihouse, arg1: T1, arg2: 0x1::option::Option<0x2::object::ID>, arg3: address, arg4: vector<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::MarbleRacingBetOption>, arg5: u8, arg6: u64, arg7: u64, arg8: vector<u64>, arg9: bool) : MarbleRacingBetResult<T0, T1> {
        assert_valid_version(arg0);
        assert!(game_config_exists<T0, T1>(arg0), 4);
        MarbleRacingBetResult<T0, T1>{
            bet_id       : arg2,
            player       : arg3,
            bet_options  : arg4,
            bet_type     : arg5,
    ...
    public fun emit_bet_results_v2<T0, T1: drop>(arg0: &Unihouse, arg1: 0x1::option::Option<0x2::object::ID>, arg2: 0x1::option::Option<0x1::string::String>, arg3: vector<BetResultV2<T0, T1>>) {
        abort 0
    }
    ...
    public fun emit_marble_racing_bet_results<T0, T1: drop>(arg0: &Unihouse, arg1: 0x1::option::Option<0x2::object::ID>, arg2: 0x1::option::Option<0x1::string::String>, arg3: vector<MarbleRacingBetResult<T0, T1>>) {
        assert_valid_version(arg0);
        assert!(game_config_exists<T0, T1>(arg0), 4);
        let v0 = MarbleRacingBetResults<T0, T1>{
            race_id : arg1,
            origin  : arg2,
            bets    : arg3,
        };
        0x2::event::emit<MarbleRacingBetResults<T0, T1>>(v0);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Unihouse{
            ...
            version_set : 0x2::vec_set::singleton<u64>(20),
