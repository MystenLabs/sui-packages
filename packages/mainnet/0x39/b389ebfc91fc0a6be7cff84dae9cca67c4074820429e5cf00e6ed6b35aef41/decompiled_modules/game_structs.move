module 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs {
    ...
    struct MarbleRacingBetOption has copy, drop, store {
        target: u64,
        range: vector<u64>,
    }
    ...
    public fun create_marble_racing_bet_option(arg0: u64, arg1: vector<u64>) : MarbleRacingBetOption {
        MarbleRacingBetOption{
            target : arg0,
            range  : arg1,
        }
    }
