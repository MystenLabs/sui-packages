module 0x39567fcb2754491b227bda343d70588705929afb9f93e66b3638f2d5f3d9bda9::cnsnft4190 {
    struct CNSNFT4190 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4190, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4190>(arg0, arg1);
