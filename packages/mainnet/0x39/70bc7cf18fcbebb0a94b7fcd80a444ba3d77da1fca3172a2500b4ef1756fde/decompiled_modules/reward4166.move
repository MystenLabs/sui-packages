module 0x3970bc7cf18fcbebb0a94b7fcd80a444ba3d77da1fca3172a2500b4ef1756fde::reward4166 {
    struct REWARD4166 has drop {
        dummy_field: bool,
    }

    struct TICKET_4166 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4166(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4166>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4166>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4166, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4166>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4166>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4166>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4166>>(v5, 0x2::tx_context::sender(arg1));
    }
