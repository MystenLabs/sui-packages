module 0x3935c745e26867d9015c3c8fec9e8e97a2bb9632c9d747e9bfd26ec718315d8d::reward9240 {
    struct REWARD9240 has drop {
        dummy_field: bool,
    }

    struct TICKET_9240 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9240(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_9240>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9240, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9240>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9240>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9240>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9240>>(v5, 0x2::tx_context::sender(arg1));
    }
