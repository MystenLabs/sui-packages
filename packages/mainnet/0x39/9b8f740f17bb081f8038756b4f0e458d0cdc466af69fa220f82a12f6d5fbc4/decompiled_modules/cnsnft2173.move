module 0x399b8f740f17bb081f8038756b4f0e458d0cdc466af69fa220f82a12f6d5fbc4::cnsnft2173 {
    struct CNSNFT2173 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2173, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2173>(arg0, arg1);
