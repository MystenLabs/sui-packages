module 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements {
    ...
    public(friend) fun swapCoin<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (arg3) {
            ...
            if (v19) {
                let v26 = 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::math::mul_div(v23, (v18.free_ratio as u64), 100);
    ...
    public(friend) fun swap_out<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        if (arg3) {
            ...
            if (v21) {
                let v28 = 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::math::mul_div(v25, (v20.free_ratio as u64), 100);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v27, v28, arg4), v20.burn_address);
                v26 = v25 - v28;
            };
            ...
            if (!v21) {
                ...
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut v20.coin_x, v33, arg4), v20.burn_address);
                v32 = v31 - v33;
            };
            assert!(v32 >= arg2, 7);
