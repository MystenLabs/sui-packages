module 0x3e8ff08910c7f7d9d5cd37c9791a16cbfe33c9a248ecceb549d2f68d04d718a4::lx_pool_stake {
    ...
    public entry fun stake_l_coin<T0, T1>(arg0: &mut StakingPool<T0>, arg1: &mut 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements::Global, arg2: &mut PoolInfo<T0>, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 >= 0x3e8ff08910c7f7d9d5cd37c9791a16cbfe33c9a248ecceb549d2f68d04d718a4::coin_price::calculate_yswap_amount_out<T1, T0>(arg1, arg4), 11);
        let v2 = calculate_power(arg4, true);
        arg0.order_counter = arg0.order_counter + 1;
        let v3 = 0x2::object::id_from_address(0x2::tx_context::fresh_object_address(arg6));
        let v4 = StakingOrder{
            id               : v3,
            stake_amount     : arg4,
            coin_amount      : v1,
            ...
            stake_time       : 0x2::clock::timestamp_ms(arg5),
        ...
        arg2.total_staked = arg2.total_staked + arg4;
    ...
    public entry fun stake_sui_coin<T0, T1, T2>(arg0: &mut StakingPool<T0>, arg1: &mut PoolInfo<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T1>, arg3: &mut 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements::Global, arg4: 0x2::coin::Coin<T1>, arg5: 0x2::coin::Coin<T0>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let (_, v2) = 0x3e8ff08910c7f7d9d5cd37c9791a16cbfe33c9a248ecceb549d2f68d04d718a4::coin_price::calculate_swap_result<T2, T1>(arg2, arg6, true);
        let v3 = 0x2::coin::value<T1>(&arg4);
        assert!(v3 >= v2, 11);
        let v4 = calculate_burn_percentage<T0>(arg0, arg7);
        let v5 = 0x2::coin::value<T0>(&arg5);
        assert!(v5 >= 0x3e8ff08910c7f7d9d5cd37c9791a16cbfe33c9a248ecceb549d2f68d04d718a4::coin_price::calculate_yswap_amount_out<T2, T0>(arg3, arg6 * v4 / 100), 7);
        let v6 = calculate_power(arg6, false);
        arg0.order_counter = arg0.order_counter + 1;
        let v7 = 0x2::object::id_from_address(0x2::tx_context::fresh_object_address(arg8));
        let v8 = StakingOrder{
            id               : v7,
            stake_amount     : arg6,
            coin_amount      : v3,
        ...
        0x2::balance::join<T1>(&mut arg1.balance, 0x2::coin::into_balance<T1>(arg4));
    ...
    public entry fun stake_yusd_coin<T0, T1, T2>(arg0: &mut StakingPool<T2>, arg1: &mut PoolInfo<T0>, arg2: &mut 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements::Global, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T2>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::coin::value<T0>(&arg3);
        assert!(arg5 == v1, 11);
        let v2 = calculate_burn_percentage<T2>(arg0, arg6);
        let v3 = 0x2::coin::value<T2>(&arg4);
        assert!(v3 >= 0x3e8ff08910c7f7d9d5cd37c9791a16cbfe33c9a248ecceb549d2f68d04d718a4::coin_price::calculate_yswap_amount_out<T1, T2>(arg2, arg5 * v2 / 100), 7);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(arg4, @0x0);
    ...
    public entry fun stake_yy_coinV1<T0, T1, T2, T3>(arg0: &mut StakingPool<T1>, arg1: &mut PoolInfo<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T3, T2>, arg3: &mut 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements::Global, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T1>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let (_, v2) = 0x3e8ff08910c7f7d9d5cd37c9791a16cbfe33c9a248ecceb549d2f68d04d718a4::coin_price::calculate_usdc_to_yy_route<T3, T2, T0>(arg2, arg3, arg6);
        let v3 = 0x2::coin::value<T0>(&arg4);
        assert!(v3 >= v2, 11);
        let v4 = calculate_burn_percentage<T1>(arg0, arg7);
        let v5 = 0x2::coin::value<T1>(&arg5);
        assert!(v5 >= 0x3e8ff08910c7f7d9d5cd37c9791a16cbfe33c9a248ecceb549d2f68d04d718a4::coin_price::calculate_yswap_amount_out<T3, T1>(arg3, arg6 * v4 / 100), 7);
        let v6 = calculate_power(arg6, false);
        arg0.order_counter = arg0.order_counter + 1;
        let v7 = 0x2::object::id_from_address(0x2::tx_context::fresh_object_address(arg8));
        let v8 = StakingOrder{
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg5, @0x0);
        arg0.total_burned = arg0.total_burned + v5;
        let v12 = StakeEvent{
            user            : v0,
            order_id        : v7,
