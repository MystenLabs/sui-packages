module 0x39e56fc1b75b59bfa8e9043a26d77e158633a0aa2e8297d526721152ea03b1f1::platform {
    ...
    entry fun add_moderator(arg0: &PlatformConfig, arg1: &AdminCap, arg2: &mut ModeratorRegistry, arg3: address, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun deposit_sui(arg0: &mut PlatformTreasury, arg1: 0x2::coin::Coin<0x2::sui::SUI>) {
    ...
    entry fun remove_moderator(arg0: &PlatformConfig, arg1: &AdminCap, arg2: &mut ModeratorRegistry, arg3: address, arg4: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg4);
        if (0x2::table::contains<address, bool>(&arg2.moderators, arg3)) {
    ...
    entry fun set_paused(arg0: &mut PlatformConfig, arg1: &AdminCap, arg2: bool, arg3: &0x2::tx_context::TxContext) {
