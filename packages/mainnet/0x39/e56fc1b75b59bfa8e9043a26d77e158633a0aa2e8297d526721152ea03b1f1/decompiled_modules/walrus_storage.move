module 0x39e56fc1b75b59bfa8e9043a26d77e158633a0aa2e8297d526721152ea03b1f1::walrus_storage {
    ...
    entry fun delete_blob(arg0: &mut WalrusBlob, arg1: &0x2::tx_context::TxContext) {
    ...
    entry fun disable_auto_renew(arg0: &mut WalrusBlob, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg1), 1);
        arg0.auto_renew_enabled = false;
    }

    entry fun enable_auto_renew(arg0: &mut WalrusBlob, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg1), 1);
    ...
    entry fun register_blob(arg0: &0x39e56fc1b75b59bfa8e9043a26d77e158633a0aa2e8297d526721152ea03b1f1::platform::PlatformConfig, arg1: &mut 0x39e56fc1b75b59bfa8e9043a26d77e158633a0aa2e8297d526721152ea03b1f1::platform::PlatformTreasury, arg2: vector<u8>, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(!0x39e56fc1b75b59bfa8e9043a26d77e158633a0aa2e8297d526721152ea03b1f1::platform::is_paused(arg0), 999);
        ...
        0x39e56fc1b75b59bfa8e9043a26d77e158633a0aa2e8297d526721152ea03b1f1::platform::deposit_sui(arg1, 0x2::coin::split<0x2::sui::SUI>(&mut arg9, v1, arg11));
        ...
        let v4 = BlobRegistered{
            ...
            platform_fee_usdc : v1,
        };
        0x2::event::emit<BlobRegistered>(v4);
    }

    entry fun renew_blob(arg0: &0x39e56fc1b75b59bfa8e9043a26d77e158633a0aa2e8297d526721152ea03b1f1::platform::PlatformConfig, arg1: &mut 0x39e56fc1b75b59bfa8e9043a26d77e158633a0aa2e8297d526721152ea03b1f1::platform::PlatformTreasury, arg2: &mut WalrusBlob, arg3: u64, arg4: u64, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!0x39e56fc1b75b59bfa8e9043a26d77e158633a0aa2e8297d526721152ea03b1f1::platform::is_paused(arg0), 999);
        ...
        0x39e56fc1b75b59bfa8e9043a26d77e158633a0aa2e8297d526721152ea03b1f1::platform::deposit_sui(arg1, 0x2::coin::split<0x2::sui::SUI>(&mut arg5, v0, arg7));
        ...
        let v1 = BlobRenewed{
            ...
            new_expiry        : arg3,
            cost_sui          : arg4,
            platform_fee_usdc : v0,
        };
        0x2::event::emit<BlobRenewed>(v1);
    }

    entry fun set_renewal_threshold(arg0: &mut WalrusBlob, arg1: u64, arg2: &0x2::tx_context::TxContext) {
