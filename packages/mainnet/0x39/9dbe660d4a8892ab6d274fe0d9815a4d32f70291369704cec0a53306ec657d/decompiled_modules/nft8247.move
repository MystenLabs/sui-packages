module 0x399dbe660d4a8892ab6d274fe0d9815a4d32f70291369704cec0a53306ec657d::nft8247 {
    struct NFT8247 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NFT8247, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<NFT8247>(arg0, arg1);
