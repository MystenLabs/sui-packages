module 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::risk_manager {
    ...
    public(friend) fun add_risk(arg0: &mut RiskManager, arg1: 0x1::type_name::TypeName, arg2: vector<0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::Placement>, arg3: u64) {
        ...
        let v3 = 0;
        while (v3 < 0x1::vector::length<0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::Placement>(&arg2)) {
            let (v4, v5) = 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::get_placement_data(0x1::vector::borrow<0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::Placement>(&arg2, v3));
