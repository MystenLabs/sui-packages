module 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::marble_racing {
    ...
    struct AddBetEvent has copy, drop {
        ...
        bet_size: u64,
        payout: u64,
        option: vector<0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::Placement>,
    ...
    struct RaceConfig has store, key {
        ...
        page_size: u64,
        bet_manager: 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::BetManager,
        max_combo: u8,
    ...
    struct Race has store, key {
        ...
        bet_end_time: u64,
        status: u64,
        risk_manager: 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::risk_manager::RiskManager,
        bet_setting: 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::BetSetting,
    ...
    fun remove(arg0: &mut RaceConfig, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        ...
        0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::risk_manager::destroy_manager(v6);
    ...
    public fun set_house_edge(arg0: &mut RaceConfig, arg1: &AdminCap, arg2: u64) {
        ...
        0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::set_house_edge(&mut arg0.bet_manager, arg2);
    }
    ...
    public fun add_bet<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut RaceConfig, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<T0>, arg4: vector<u64>, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        assert!(0x2::clock::timestamp_ms(arg6) > v0.bet_start_time, 15);
        ...
        assert!(0x1::vector::length<0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::Placement>(&v1) <= (arg1.max_combo as u64), 6);
        let v2 = 0x2::tx_context::sender(arg7);
        let v3 = 0x2::coin::into_balance<T0>(arg3);
        let v4 = 0x2::balance::value<T0>(&v3);
        let (v5, v6) = 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::get_bet_payout(&arg1.bet_manager, &v0.bet_setting, v4, v1, 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::risk_manager::marble_ids(&v0.risk_manager));
        let v7 = 0x1::type_name::get<T0>();
        0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::risk_manager::add_risk(&mut v0.risk_manager, 0x1::type_name::get<T0>(), v1, v6);
        let v8 = MarbleRacing{dummy_field: false};
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::assert_within_risk<T0, MarbleRacing>(arg0, v8, 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::risk_manager::total_risk(&v0.risk_manager, v7), arg7);
    ...
    fun assert_no_duplicates_u8(arg0: &vector<u8>) {
        ...
        while (v1 < 0x1::vector::length<u8>(arg0)) {
            assert!(!0x2::vec_set::contains<u8>(&v0, 0x1::vector::borrow<u8>(arg0, v1)), 17);
    ...
    public fun create(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: &mut RaceConfig, arg4: vector<u64>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v0 = Race{
            ...
            bet_end_time   : arg2,
            status         : 0,
            risk_manager   : 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::risk_manager::new_manager(arg4, arg6),
            bet_setting    : 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::new_bet_setting(arg4),
    ...
    fun create_option(arg0: vector<u64>, arg1: vector<u8>) : vector<0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::Placement> {
        assert!(0x1::vector::length<u64>(&arg0) == 0x1::vector::length<u8>(&arg1), 10);
        let v0 = 0x1::vector::empty<0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::Placement>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<u64>(&arg0)) {
            0x1::vector::push_back<0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::Placement>(&mut v0, 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::new_placement(*0x1::vector::borrow<u64>(&arg0, v1), *0x1::vector::borrow<u8>(&arg1, v1)));
            v1 = v1 + 1;
        };
        v0
    }

    public fun get_risk_limit<T0>(arg0: &RaceConfig, arg1: &mut 0x2::tx_context::TxContext) : u64 {
        assert_valid_package_version(arg0);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = RaceConfig{
            ...
            page_size    : 200,
            bet_manager  : 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::new_bet_manager(),
            max_combo    : 3,
    ...
    public fun resolve<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: 0x2::object::ID, arg2: vector<u64>, arg3: &mut RaceConfig, arg4: 0x1::option::Option<u64>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::linked_table::length<address, vector<BetSlip>>(v1) == 0) {
            0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::emit_bet_results_v2<T0, MarbleRacing>(arg0, 0x1::option::some<0x2::object::ID>(arg1), 0x1::option::none<0x1::string::String>(), 0x1::vector::empty<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::BetResultV2<T0, MarbleRacing>>());
        ...
        while (v7 < v6 && 0x2::linked_table::length<address, vector<BetSlip>>(v1) > 0) {
            ...
            while (v7 < v6 && 0x1::vector::length<BetSlip>(&v10) != 0) {
                ...
                if (v11.coin_type == 0x1::type_name::get<T0>()) {
                    ...
                    let v18 = v16;
                    if (0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::won_bet(v11.option, arg2)) {
                        v3 = v3 + v15;
                    ...
                    while (v20 < 0x1::vector::length<0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::Placement>(&v18)) {
                        0x1::vector::push_back<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::Placement>(&mut v21, 0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::create_unihouse_placement(*0x1::vector::borrow<0x39a6a6f7cd8302574f1e24953afb1faea1d259adb1ef926ce982f84966708300::bet_manager::Placement>(&v18, v20)));
                        v20 = v20 + 1;
                    };
                    let v22 = MarbleRacing{dummy_field: false};
                    0x1::vector::push_back<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::BetResultV2<T0, MarbleRacing>>(&mut v5, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::create_unihouse_bet_result_v3<T0, MarbleRacing>(arg0, v22, 0x1::option::some<0x2::object::ID>(0x2::object::id<BetSlip>(&v11)), v8, v21, v14, v15, arg2));
                    0x2::object::delete(v12);
                } else {
        ...
        if (!0x1::vector::is_empty<PlayerWin<T0>>(&v2)) {
            ...
            let v24 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::split_with_reimbursement<T0, MarbleRacing>(arg0, v23, v3);
            while (!0x1::vector::is_empty<PlayerWin<T0>>(&v2)) {
                ...
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v24, v27), arg5), v25);
                let v28 = MarbleRacing{dummy_field: false};
                0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::put_with_fee<T0, MarbleRacing>(arg0, v28, 0x2::coin::from_balance<T0>(v26, arg5));
            };
            0x2::balance::destroy_zero<T0>(v24);
        };
        0x1::vector::destroy_empty<PlayerWin<T0>>(v2);
        if (0x2::balance::value<T0>(&v4) != 0) {
            let v29 = MarbleRacing{dummy_field: false};
            0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::put_with_fee<T0, MarbleRacing>(arg0, v29, 0x2::coin::from_balance<T0>(v4, arg5));
        } else {
