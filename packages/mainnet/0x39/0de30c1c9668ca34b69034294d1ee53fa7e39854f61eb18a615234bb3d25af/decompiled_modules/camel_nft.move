module 0x390de30c1c9668ca34b69034294d1ee53fa7e39854f61eb18a615234bb3d25af::camel_nft {
    ...
    public fun add_trait(arg0: &mut Camel, arg1: 0x1::string::String) {
        0x1::vector::push_back<0x1::string::String>(&mut arg0.traits, arg1);
    }

    public fun destroy(arg0: Camel) {
        let Camel {
            id     : v0,
            name   : _,
            traits : _,
    ...
    public fun mint(arg0: 0x1::string::String, arg1: vector<0x1::string::String>, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) : Camel {
    ...
    public fun set_url(arg0: &mut Camel, arg1: 0x1::string::String) {
        arg0.url = arg1;
    }
