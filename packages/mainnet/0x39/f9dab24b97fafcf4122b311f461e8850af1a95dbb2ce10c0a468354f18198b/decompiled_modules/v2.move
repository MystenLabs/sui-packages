module 0x39f9dab24b97fafcf4122b311f461e8850af1a95dbb2ce10c0a468354f18198b::v2 {
    ...
    fun init(arg0: V2, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<V2>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"v2"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"v2 "));
