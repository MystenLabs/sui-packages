module 0x39999278655bc2c2584668096e41099575b8b9a8ca52f4b4c6f1a4b35c2b3463::referral {
    ...
    public entry fun upsert_Referral<T0>(arg0: &AdminCap, arg1: &mut Referral<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 > 0) {
            ...
            if (0x2::table::contains<address, u64>(&arg1.rewards, v2)) {
                ...
                arg1.rewards_total = 0xba8f8fabcc241c95a90829e3a989edb80bf76e48cfa1eca38972285fd894f98::u256::add_u64(0xba8f8fabcc241c95a90829e3a989edb80bf76e48cfa1eca38972285fd894f98::u256::sub_u64(arg1.rewards_total, v4), v3);
                continue
            };
            0x2::table::add<address, u64>(&mut arg1.rewards, v2, v3);
            arg1.rewards_total = 0xba8f8fabcc241c95a90829e3a989edb80bf76e48cfa1eca38972285fd894f98::u256::add_u64(arg1.rewards_total, v3);
        };
