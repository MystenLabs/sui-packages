module 0x395033b12eb0d0ad2e649613498e46d9aaaae873f588c119ee3528fc27f21ae7::cnsnft5360 {
    struct CNSNFT5360 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5360, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5360>(arg0, arg1);
