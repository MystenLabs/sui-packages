module 0x397edb8207a6867a79db9187304f77221a3475639582f2bed03bb28e1d6d0b28::nft_demo {
    ...
    fun init(arg0: NFT_DEMO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://github.com/BethelDev"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"BethelDev"));
        ...
        let v6 = MyNFT{
            ...
            name      : 0x1::string::utf8(b"BethelDev nft"),
            image_url : 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/50044804?v=4"),
        };
