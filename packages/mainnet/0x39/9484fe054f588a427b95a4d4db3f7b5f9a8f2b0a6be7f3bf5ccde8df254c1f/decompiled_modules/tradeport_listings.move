module 0x399484fe054f588a427b95a4d4db3f7b5f9a8f2b0a6be7f3bf5ccde8df254c1f::tradeport_listings {
    ...
    entry fun add_sponsored_listing<T0: store + key>(arg0: &mut Store, arg1: &0x2::clock::Clock, arg2: 0x2::object::ID, arg3: u64, arg4: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&arg4) == arg3 * arg0.feature_price, 4);
        ...
        let v3 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, SimpleSponsoredCollection<T0>>(&mut arg0.id, v1).listings;
        let v4 = if (0x2::vec_map::contains<0x2::object::ID, u64>(&v3, &arg2)) {
            let (_, v6) = 0x2::vec_map::remove<0x2::object::ID, u64>(&mut v3, &arg2);
            let v7 = v6 + arg3 * 86400000;
            0x2::vec_map::insert<0x2::object::ID, u64>(&mut v3, arg2, v7);
            v7
        } else {
            assert!(0x2::vec_map::length<0x2::object::ID, u64>(&v3) < 3, 4);
            let v8 = 0x2::clock::timestamp_ms(arg1) + arg3 * 86400000;
            0x2::vec_map::insert<0x2::object::ID, u64>(&mut v3, arg2, v8);
            v8
        };
    ...
    fun remove_expired_featured_listings<T0: store + key>(arg0: &mut Store, arg1: &0x2::clock::Clock) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, SimpleSponsoredCollection<T0>>(&mut arg0.id, *0x1::type_name::as_string(&v0)).listings;
    ...
    fun remove_sponsored_listing_if_exists<T0: store + key>(arg0: &mut Store, arg1: 0x2::object::ID) {
        ...
        let v2 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, SimpleSponsoredCollection<T0>>(&mut arg0.id, v1).listings;
