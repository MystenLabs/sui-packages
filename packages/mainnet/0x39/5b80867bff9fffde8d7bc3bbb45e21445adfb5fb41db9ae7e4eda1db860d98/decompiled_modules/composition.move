module 0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::composition {
    ...
    struct CompositionReweighted has copy, drop {
        tokens: vector<0x1::type_name::TypeName>,
        weights: vector<u64>,
        snapshot_blob_id: vector<u8>,
        timestamp_ms: u64,
    ...
    public(friend) fun execute_pending(arg0: &mut Composition, arg1: &0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::OracleConfig, arg2: &0x2::clock::Clock) {
        assert!(!0x1::vector::is_empty<Pending>(&arg0.pending), 307);
    ...
    fun is_same_token_set(arg0: &Composition, arg1: &vector<0x1::type_name::TypeName>) : bool {
        let v0 = 0x1::vector::length<0x1::type_name::TypeName>(arg1);
        if (v0 != 0x1::vector::length<Target>(&arg0.targets)) {
            return false
        };
        let v1 = 0;
        while (v1 < v0) {
            if (!contains(arg0, *0x1::vector::borrow<0x1::type_name::TypeName>(arg1, v1))) {
                return false
            };
            v1 = v1 + 1;
        };
    ...
    public(friend) fun propose(arg0: &mut Composition, arg1: &0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::OracleConfig, arg2: vector<0x1::type_name::TypeName>, arg3: vector<u64>, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        assert!(0x1::vector::is_empty<Pending>(&arg0.pending), 309);
        validate(arg1, &arg2, &arg3);
        let v0 = 0x2::clock::timestamp_ms(arg5);
        if (is_same_token_set(arg0, &arg2)) {
            arg0.targets = build_targets(&arg2, &arg3);
            arg0.snapshot_blob_id = arg4;
            arg0.last_change_ms = v0;
            let v1 = CompositionReweighted{
                tokens           : arg2,
                weights          : arg3,
                snapshot_blob_id : arg0.snapshot_blob_id,
                timestamp_ms     : v0,
            };
            0x2::event::emit<CompositionReweighted>(v1);
            return
        };
    ...
    public(friend) fun set_genesis(arg0: &mut Composition, arg1: &0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::OracleConfig, arg2: vector<0x1::type_name::TypeName>, arg3: vector<u64>, arg4: vector<u8>, arg5: &0x2::clock::Clock) {
    ...
    fun validate(arg0: &0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::OracleConfig, arg1: &vector<0x1::type_name::TypeName>, arg2: &vector<u64>) {
        let v0 = 0x1::vector::length<0x1::type_name::TypeName>(arg1);
        ...
        while (v2 < v0) {
            ...
            assert!(v4 > 0, 300);
            assert!(v4 <= 4000, 301);
            assert!(0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::has_feed(arg0, v3), 306);
            assert!(!0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::is_breaker_tripped(arg0, v3), 312);
            let v5 = v2 + 1;
            while (v5 < v0) {
