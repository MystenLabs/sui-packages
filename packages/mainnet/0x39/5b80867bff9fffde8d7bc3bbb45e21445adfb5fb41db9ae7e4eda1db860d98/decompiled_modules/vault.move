module 0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::vault {
    struct AdminCap has store, key {
        id: 0x2::object::UID,
    }

    struct RebalanceConfig has store {
        drift_tolerance_bps: u64,
        min_trade_value_usdc: u64,
    }
    ...
    struct SuiX5Vault has key {
        ...
        usdc_reserve: u64,
        suix5_treasury: 0x2::coin::TreasuryCap<0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::suix5::SUIX5>,
        suix5_supply: u64,
        oracle: 0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::OracleConfig,
        composition: 0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::composition::Composition,
    ...
    struct DriftToleranceUpdated has copy, drop {
        drift_tolerance_bps: u64,
    }

    struct MinTradeValueUpdated has copy, drop {
        min_trade_value_usdc: u64,
    }
    ...
    entry fun register_feed<T0>(arg0: &mut SuiX5Vault, arg1: vector<u8>, arg2: u8, arg3: &0x2::tx_context::TxContext) {
        if (arg0.vault_config.require_admin_for_feeds) {
            assert_admin(arg0, arg3);
        } else {
            assert_authorized(arg0, arg3);
        };
        ensure_registered<T0>(arg0);
        0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::register_feed<T0>(&mut arg0.oracle, arg1, arg2);
    }
    ...
    entry fun remove_feed<T0>(arg0: &mut SuiX5Vault, arg1: &0x2::tx_context::TxContext) {
        ...
        0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::remove_feed<T0>(&mut arg0.oracle);
    }

    entry fun reset_breaker<T0>(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::reset_breaker<T0>(&mut arg0.oracle, arg2);
    }
    ...
    public(friend) fun assert_can_crank(arg0: &SuiX5Vault, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        ...
        let v1 = arg0.last_rebalance_ms + arg0.vault_config.rebalance_interval_ms;
        assert!(v0 >= v1, 100);
        if (v0 < v1 + arg0.vault_config.open_crank_grace_ms) {
    ...
    public(friend) fun assert_nav_fresh(arg0: &SuiX5Vault, arg1: &0x2::clock::Clock) {
        ...
        assert!(arg0.cached_nav_ms + arg0.vault_config.max_nav_age_ms >= 0x2::clock::timestamp_ms(arg1), 106);
    }
    ...
    public(friend) fun burn_suix5(arg0: &mut SuiX5Vault, arg1: 0x2::coin::Coin<0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::suix5::SUIX5>) : u64 {
        let v0 = 0x2::coin::value<0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::suix5::SUIX5>(&arg1);
        assert!(v0 > 0, 105);
        assert!(arg0.suix5_supply >= v0, 104);
        arg0.suix5_supply = arg0.suix5_supply - v0;
        0x2::coin::burn<0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::suix5::SUIX5>(&mut arg0.suix5_treasury, arg1);
        v0
    }
    ...
    public(friend) fun calc_deposit_fee(arg0: &SuiX5Vault, arg1: u64) : u64 {
        arg1 * arg0.vault_config.deposit_fee_bps / 10000
    }

    public(friend) fun calc_withdrawal_fee(arg0: &SuiX5Vault, arg1: u64) : u64 {
        arg1 * arg0.vault_config.withdrawal_fee_bps / 10000
    }
    ...
    entry fun cancel_composition(arg0: &mut SuiX5Vault, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        ...
        0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::composition::cancel_pending(&mut arg0.composition, arg1, arg2);
    }
    ...
    public(friend) fun composition_mut(arg0: &mut SuiX5Vault) : &mut 0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::composition::Composition {
        &mut arg0.composition
    }

    public(friend) fun composition_ref(arg0: &SuiX5Vault) : &0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::composition::Composition {
        &arg0.composition
    }

    entry fun create_vault(arg0: 0x2::coin::TreasuryCap<0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::suix5::SUIX5>, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = AdminCap{id: 0x2::object::new(arg2)};
        0x2::transfer::public_transfer<AdminCap>(v1, v0);
        let v2 = RebalanceConfig{
            drift_tolerance_bps  : 300,
            min_trade_value_usdc : 50000,
        };
        let v3 = VaultConfig{
        ...
        let v4 = SuiX5Vault{
            ...
            suix5_treasury            : arg0,
            suix5_supply              : 0,
            oracle                    : 0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::new(arg2),
            composition               : 0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::composition::new(arg2),
            ...
            paused                    : false,
            creation_ms               : 0,
            extensions                : 0x2::bag::new(arg2),
        };
        let v5 = VaultCreated{
            vault_id     : 0x2::object::id<SuiX5Vault>(&v4),
            admin        : v0,
            timestamp_ms : 0,
        };
    ...
    public fun drift_tolerance_bps(arg0: &SuiX5Vault) : u64 {
        arg0.rebalance_config.drift_tolerance_bps
    }
    ...
    entry fun execute_composition(arg0: &mut SuiX5Vault, arg1: &0x2::clock::Clock) {
        0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::composition::execute_pending(&mut arg0.composition, &arg0.oracle, arg1);
    }

    public(friend) fun fee_collector(arg0: &SuiX5Vault) : address {
        arg0.vault_config.fee_collector
    }

    public fun fees(arg0: &SuiX5Vault) : (u64, u64) {
        (arg0.vault_config.deposit_fee_bps, arg0.vault_config.withdrawal_fee_bps)
    }

    public fun gating(arg0: &SuiX5Vault) : (bool, bool) {
        (arg0.vault_config.require_admin_for_feeds, arg0.vault_config.require_admin_for_pools)
    }
    ...
    public fun min_trade_value_usdc(arg0: &SuiX5Vault) : u64 {
        arg0.rebalance_config.min_trade_value_usdc
    }

    public(friend) fun mint_suix5(arg0: &mut SuiX5Vault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::suix5::SUIX5> {
        assert!(arg1 > 0, 105);
        arg0.suix5_supply = arg0.suix5_supply + arg1;
        0x2::coin::mint<0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::suix5::SUIX5>(&mut arg0.suix5_treasury, arg1, arg2)
    }
    ...
    public(friend) fun oracle_mut(arg0: &mut SuiX5Vault) : &mut 0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::OracleConfig {
        &mut arg0.oracle
    }

    public(friend) fun oracle_ref(arg0: &SuiX5Vault) : &0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::OracleConfig {
        &arg0.oracle
    }
    ...
    public fun orphans(arg0: &SuiX5Vault) : vector<0x1::type_name::TypeName> {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&arg0.discovered_tokens)) {
            ...
            if (tracked_balance(arg0, v2) > 0 && !0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::composition::contains(&arg0.composition, v2)) {
    ...
    entry fun propose_adapter(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::clock::timestamp_ms(arg3) + arg0.vault_config.adapter_timelock_ms;
    ...
    entry fun propose_composition<T0, T1, T2, T3, T4>(arg0: &mut SuiX5Vault, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::composition::propose(&mut arg0.composition, &arg0.oracle, v1, v3, arg6, arg7, arg8);
    }
    ...
    public fun schedule(arg0: &SuiX5Vault) : (u64, u64, u64) {
        (arg0.last_rebalance_ms, arg0.vault_config.rebalance_interval_ms, arg0.vault_config.open_crank_grace_ms)
    }
    ...
    entry fun set_adapter_timelock(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        arg0.vault_config.adapter_timelock_ms = arg2;
    ...
    entry fun set_composition_timelock(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::composition::set_timelock(&mut arg0.composition, arg2);
    }

    entry fun set_drift_tolerance(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        assert!(arg2 >= 50 && arg2 <= 2000, 106);
        arg0.rebalance_config.drift_tolerance_bps = arg2;
        let v0 = DriftToleranceUpdated{drift_tolerance_bps: arg2};
        0x2::event::emit<DriftToleranceUpdated>(v0);
    }

    entry fun set_fee_collector(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: address, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        assert!(arg2 != @0x0, 103);
        arg0.vault_config.fee_collector = arg2;
    }
    ...
    entry fun set_fees(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        arg0.vault_config.deposit_fee_bps = arg2;
        arg0.vault_config.withdrawal_fee_bps = arg3;
        let v0 = FeesUpdated{
    ...
    entry fun set_gating(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: bool, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg4);
        arg0.vault_config.require_admin_for_feeds = arg2;
        arg0.vault_config.require_admin_for_pools = arg3;
    ...
    entry fun set_genesis_composition<T0, T1, T2, T3, T4>(arg0: &mut SuiX5Vault, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::composition::set_genesis(&mut arg0.composition, &arg0.oracle, v0, v2, arg6, arg7);
    }
    ...
    entry fun set_min_trade_value(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
        assert!(arg2 >= 10000 && arg2 <= 10000000, 106);
        arg0.rebalance_config.min_trade_value_usdc = arg2;
        let v0 = MinTradeValueUpdated{min_trade_value_usdc: arg2};
        0x2::event::emit<MinTradeValueUpdated>(v0);
    }
    ...
    entry fun set_oracle_config(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        0x5ef73d1fffde54e02978bb4866c7a21fd1e2e692e256019e167a4bbf777510ea::oracle::set_config(&mut arg0.oracle, arg2, arg3, arg4);
    }
    ...
    entry fun set_rebalance_interval(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        arg0.vault_config.rebalance_interval_ms = arg2;
    }
    ...
    entry fun set_target_reserve(arg0: &mut SuiX5Vault, arg1: &AdminCap, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        arg0.vault_config.target_reserve_bps = arg2;
    }
    ...
    public(friend) fun target_reserve_bps(arg0: &SuiX5Vault) : u64 {
        arg0.vault_config.target_reserve_bps
    }
