module 0x399204e10927d3c6990ea3790d7a347a0cab51b94130ad98971137b0edd590cd::manager {
    ...
    public entry fun get_balance(arg0: &GalxeTable, arg1: u64, arg2: address) : u64 {
        0x2::table::borrow<address, Point>(&0x2::table::borrow<u64, SpacePoint>(&arg0.spaces, arg1).balances, arg2).amount
    }

    public entry fun get_has_claimed(arg0: &GalxeTable, arg1: u64, arg2: u64) : bool {
