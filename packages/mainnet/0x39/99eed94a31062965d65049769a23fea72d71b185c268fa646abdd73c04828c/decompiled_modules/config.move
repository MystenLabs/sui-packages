module 0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config {
    ...
    public(friend) fun create_config(arg0: &CONFIG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Config{
            ...
            max_withdraw_per_day : 10000000000,
    ...
    public fun update_config(arg0: &0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::app::AdminCap, arg1: &mut Config, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64) {
