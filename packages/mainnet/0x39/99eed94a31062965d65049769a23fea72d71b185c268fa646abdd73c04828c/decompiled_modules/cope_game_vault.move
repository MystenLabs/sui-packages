module 0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::cope_game_vault {
    ...
    public fun create_vault<T0>(arg0: &0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::app::AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
    ...
    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config::Config, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 2);
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 >= 0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config::get_min_deposit(arg2), 3);
        assert!(v0 <= 0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config::get_max_deposit(arg2), 5);
    ...
    public fun emergency_withdraw_all<T0>(arg0: &0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::app::AdminCap, arg1: &0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config::Config, arg2: &mut Vault<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.is_paused, 2);
        arg2.total_withdrawn = arg2.total_withdrawn + 0x2::balance::value<T0>(&arg2.balance);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg2.balance), arg3), 0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config::get_admin_address(arg1));
    }

    public fun end_game<T0>(arg0: &0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::app::AdminCap, arg1: &mut Vault<T0>, arg2: &0x2::clock::Clock) {
    ...
    public fun get_net_house_profit<T0>(arg0: &Vault<T0>) : u64 {
        if (arg0.house_profit_lifetime >= arg0.house_loss_lifetime) {
            arg0.house_profit_lifetime - arg0.house_loss_lifetime
        } else {
            0
        }
    }
    ...
    public fun set_pause<T0>(arg0: &0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::app::AdminCap, arg1: &mut Vault<T0>, arg2: bool, arg3: &0x2::clock::Clock) {
        arg1.is_paused = arg2;
    ...
    public fun settle_game<T0>(arg0: &0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::app::AdminCap, arg1: &mut Vault<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::clock::Clock) {
    ...
    public fun start_game<T0>(arg0: &0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::app::AdminCap, arg1: &mut Vault<T0>, arg2: &0x2::clock::Clock) {
        assert!(!arg1.is_paused, 2);
    ...
    public fun withdraw<T0>(arg0: &mut Vault<T0>, arg1: u64, arg2: &0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config::Config, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 2);
        assert!(!arg0.active_game, 8);
        assert!(arg1 >= 0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config::get_min_withdraw(arg2), 4);
        assert!(arg1 <= 0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config::get_max_withdraw(arg2), 6);
        assert!(arg1 > 0, 7);
        ...
        if (!0x2::table::contains<address, DailyWithdrawal>(&arg0.user_daily_withdrawals, v0)) {
            ...
            assert!(arg1 <= 0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config::get_max_withdraw_per_day(arg2), 13);
        } else {
            let v4 = 0x2::table::borrow_mut<address, DailyWithdrawal>(&mut arg0.user_daily_withdrawals, v0);
            if (v4.day == v2) {
                let v5 = v4.amount + arg1;
                assert!(v5 <= 0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config::get_max_withdraw_per_day(arg2), 13);
                v4.amount = v5;
            } else {
                v4.amount = arg1;
                v4.day = v2;
        ...
        *v6 = *v6 - arg1;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance, arg1), arg4), v0);
    ...
    public fun withdraw_house_profits<T0>(arg0: &0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::app::AdminCap, arg1: &0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config::Config, arg2: &mut Vault<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg2.is_paused, 2);
        assert!(arg3 > 0, 7);
        ...
        let v1 = 0x3999eed94a31062965d65049769a23fea72d71b185c268fa646abdd73c04828c::config::get_admin_address(arg1);
