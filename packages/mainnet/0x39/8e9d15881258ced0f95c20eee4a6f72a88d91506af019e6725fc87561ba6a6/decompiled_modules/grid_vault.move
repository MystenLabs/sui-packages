module 0x398e9d15881258ced0f95c20eee4a6f72a88d91506af019e6725fc87561ba6a6::grid_vault {
    ...
    public fun admin_cancel_all_orders<T0, T1>(arg0: &mut GridVault<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun admin_extract_balance_manager<T0, T1>(arg0: GridVault<T0, T1>, arg1: &0x2::tx_context::TxContext) : (0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeCap, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::DepositCap, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::WithdrawCap) {
        assert!(0x2::tx_context::sender(arg1) == arg0.admin_address, 0);
        let GridVault {
            id                         : v0,
            balance_manager            : v1,
            trade_cap                  : v2,
            ...
            admin_address              : _,
            is_paused                  : _,
            total_volume_traded        : _,
            total_fees_collected_base  : _,
            total_fees_collected_quote : _,
            orders_filled_count        : _,
        } = arg0;
        0x2::table::drop<address, u64>(v7);
        0x2::table::drop<address, u64>(v8);
        0x2::table::drop<0x1::string::String, u64>(v9);
    ...
    public fun create_and_share_grid_vault<T0, T1>(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<GridVault<T0, T1>>(create_grid_vault<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6));
    }

    public fun create_and_share_grid_vault_v2<T0, T1>(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u8, arg7: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<GridVault<T0, T1>>(create_grid_vault_v2<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7));
    }

    public fun create_and_share_grid_vault_v3<T0, T1>(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u8, arg7: u8, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public fun set_bot_address<T0, T1>(arg0: &mut GridVault<T0, T1>, arg1: address, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun withdraw_all<T0, T1>(arg0: &mut GridVault<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun withdraw_all_with_cancel<T0, T1>(arg0: &mut GridVault<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::table::contains<address, u64>(&arg0.user_shares, v0), 0);
        let v1 = *0x2::table::borrow<address, u64>(&arg0.user_shares, v0);
        assert!(v1 > 0, 3);
    ...
    public fun withdraw_shares<T0, T1>(arg0: &mut GridVault<T0, T1>, arg1: u64, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
    ...
    public fun withdraw_shares_with_cancel<T0, T1>(arg0: &mut GridVault<T0, T1>, arg1: u64, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
