module 0x394fdf68573b5442c034b85ad0a91995cbbd14a30de8e632d3f4d17cd151af97::cnsnft9126 {
    struct CNSNFT9126 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9126, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9126>(arg0, arg1);
