module 0x6fe71f3d33120afdf502d0046ddf4d9cf0139f9a9b01acc2656414f7b0da448b::cnsnft4192 {
    struct CNSNFT4192 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4192, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4192>(arg0, arg1);
