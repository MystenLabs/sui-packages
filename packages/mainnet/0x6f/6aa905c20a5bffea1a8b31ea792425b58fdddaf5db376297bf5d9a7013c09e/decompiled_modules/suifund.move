module 0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::suifund {
    ...
    struct ProjectRecord has key {
        ...
        thread: 0x2::table_vec::TableVec<0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::comment::Comment>,
    }
    ...
    public entry fun like_comment(arg0: &mut ProjectRecord, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::comment::like_comment(0x2::table_vec::borrow_mut<0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::comment::Comment>(&mut arg0.thread, arg1), arg2);
    }

    public entry fun unlike_comment(arg0: &mut ProjectRecord, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::comment::unlike_comment(0x2::table_vec::borrow_mut<0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::comment::Comment>(&mut arg0.thread, arg1), arg2);
    }
    ...
    public entry fun add_comment(arg0: &mut ProjectRecord, arg1: 0x1::option::Option<0x2::object::ID>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x2::table_vec::push_back<0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::comment::Comment>(&mut arg0.thread, 0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::comment::new_comment(arg1, arg2, arg3, arg4, arg5));
    }
    ...
    fun add_df_with_attach<T0: store>(arg0: &mut SupporterReward, arg1: T0) {
        assert!(arg0.attach_df == 0, 9223376782793637887);
    ...
    public fun deploy_non_entry(arg0: &mut DeployRecord, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: vector<u8>, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg20: &0x2::clock::Clock, arg21: &mut 0x2::tx_context::TxContext) : ProjectAdminCap {
        ...
        let v5 = ProjectRecord{
            ...
            thread             : 0x2::table_vec::empty<0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::comment::Comment>(arg21),
        };
    ...
    public fun do_burn(arg0: &mut ProjectRecord, arg1: SupporterReward, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v1 = if (arg0.cancel || !arg0.begin) {
            ...
            0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::utils::get_remain_value(0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::utils::mul_div(arg0.current_supply, 1000000000, arg0.amount_per_sui), arg0.start_time_ms, arg0.end_time_ms, 0x2::clock::timestamp_ms(arg2)) * arg0.ratio / 100
        };
        let v2 = 0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::utils::mul_div(v1, arg1.amount, arg0.current_supply);
    ...
    public fun do_claim(arg0: &mut ProjectRecord, arg1: &ProjectAdminCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v0 = 0x2::balance::value<0x2::sui::SUI>(&arg0.balance) - 0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::utils::get_remain_value(0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::utils::mul_div(arg0.current_supply, 1000000000, arg0.amount_per_sui) * arg0.ratio / 100, arg0.start_time_ms, arg0.end_time_ms, 0x2::clock::timestamp_ms(arg2));
    ...
    public fun do_mint(arg0: &mut ProjectRecord, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : SupporterReward {
        ...
        let v4 = 0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::utils::mul_div(v2, arg0.amount_per_sui, 1000000000);
        let v5 = v4;
        if (v4 >= arg0.remain) {
            let v6 = arg0.remain;
            v5 = v6;
            v2 = 0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::utils::mul_div(v6, 1000000000, arg0.amount_per_sui);
        };
        ...
        if (!arg0.begin && arg0.current_supply >= 0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::utils::mul_div(arg0.total_supply, arg0.threshold_ratio, 100)) {
            arg0.begin = true;
        };
    ...
    public fun do_split(arg0: &mut SupporterReward, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : SupporterReward {
        ...
        let v0 = 0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::utils::mul_div(0x2::balance::value<0x2::sui::SUI>(&arg0.balance), arg1, arg0.amount);
        let v1 = v0;
        if (v0 == 0) {
            v1 = 1;
        };
    ...
    public fun project_thread(arg0: &ProjectRecord) : &0x2::table_vec::TableVec<0x6f6aa905c20a5bffea1a8b31ea792425b58fdddaf5db376297bf5d9a7013c09e::comment::Comment> {
        &arg0.thread
    }
