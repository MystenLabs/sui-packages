module 0x6f52bff2faa1174793be85ab2ee97c8e147753f681d909d1f8b6148496a850ca::reward9933 {
    struct REWARD9933 has drop {
        dummy_field: bool,
    }

    struct TICKET_9933 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9933(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9933>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9933>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9933, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9933>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9933>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9933>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9933>>(v5, 0x2::tx_context::sender(arg1));
    }
