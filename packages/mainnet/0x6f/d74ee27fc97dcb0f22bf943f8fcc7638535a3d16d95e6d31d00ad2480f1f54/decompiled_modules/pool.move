module 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::pool {
    ...
    struct GlobalConfig has key {
        id: 0x2::object::UID,
        config_cap: 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::admin::GlobalConfigCap,
    ...
    struct FlashSwapPromise<phantom T0, phantom T1> {
        pool_id: 0x2::object::ID,
        borrowed_amount: u64,
    ...
    struct FlashSwapEnabledSet<phantom T0> has copy, drop {
        pool_id: 0x2::object::ID,
        enabled: bool,
    }

    struct FlashBorrowEvent<phantom T0, phantom T1> has copy, drop {
        pool_id: 0x2::object::ID,
        borrower: address,
        borrowed_amount: u64,
        repayment_amount: u64,
    ...
    struct FlashRepayEvent<phantom T0, phantom T1> has copy, drop {
        pool_id: 0x2::object::ID,
        borrower: address,
        repaid: u64,
        fee: u64,
    ...
    struct FlashSwapProtocolFeeSet<phantom T0> has copy, drop {
        pool_id: 0x2::object::ID,
        fee: u64,
    }
    ...
    struct QuoteAssetAdded<phantom T0, phantom T1> has copy, drop {
        pool_id: 0x2::object::ID,
        ...
        fee_base: u64,
        fee_max: u64,
        limit_ratio_bps: 0x1::option::Option<u64>,
        limit_fixed: 0x1::option::Option<u64>,
        min_out: u64,
        added_by: address,
    }

    struct QuoteAssetUpdated<phantom T0, phantom T1> has copy, drop {
        pool_id: 0x2::object::ID,
        quote_asset: 0x1::ascii::String,
        ideal_reserve_pct: 0x1::option::Option<u64>,
        max_reserve_pct: 0x1::option::Option<u64>,
        fee_base: 0x1::option::Option<u64>,
        fee_max: 0x1::option::Option<u64>,
        limit_ratio_bps: 0x1::option::Option<u64>,
        limit_fixed: 0x1::option::Option<u64>,
        min_out: 0x1::option::Option<u64>,
        is_trading: 0x1::option::Option<bool>,
        updated_by: address,
    }
    ...
    struct BaseWithdrawn<phantom T0> has copy, drop {
        pool_id: 0x2::object::ID,
        admin: address,
        base_amount: u64,
    }

    struct QuoteWithdrawn<phantom T0, phantom T1> has copy, drop {
        pool_id: 0x2::object::ID,
        admin: address,
        quote_asset: 0x1::ascii::String,
        quote_amount: u64,
    ...
    struct ProtocolFeesWithdrawn<phantom T0> has copy, drop {
        pool_id: 0x2::object::ID,
        recipient: address,
        amount: u64,
    }
    ...
    struct SwapExecutedV2<phantom T0, phantom T1> has copy, drop {
        pool_id: 0x2::object::ID,
        trader: address,
        amount_in: u64,
        amount_out: u64,
    ...
    struct NetBaseFeeMultiplierKey has copy, drop, store {
        dummy_field: bool,
    }

    struct NetBaseFeeMultiplierKeyUpdated has copy, drop {
        pool_id: 0x2::object::ID,
        new_net_base_fee_multiplier: u64,
    }

    struct IdealBaseAnchorKey has copy, drop, store {
        dummy_field: bool,
    }

    struct IdealBaseAnchorUpdated has copy, drop {
        pool_id: 0x2::object::ID,
        new_anchor: u64,
    }

    struct FlashSwapEnabledKey has copy, drop, store {
        dummy_field: bool,
    }

    struct FlashSwapProtocolFeeKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun get_price<T0, T1>(arg0: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::Oracle, arg1: &0x2::clock::Clock) : (u128, bool) {
        let (v0, v1) = 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::get_valid_price<T0, T1>(arg0, arg1);
        let v2 = v0;
        let v3 = 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::price_data_price<T0, T1>(&v2);
        (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::internal_price::get_price<T0, T1>(&v3), v1)
    }

    public fun add_quote_asset<T0, T1>(arg0: &GlobalConfig, arg1: &mut LiquidityPool<T0>, arg2: &mut 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::Oracle, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: 0x1::option::Option<u64>, arg8: 0x1::option::Option<u64>, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        validate_pool_version<T0>(arg1);
        assert!(0x2::tx_context::sender(arg10) == arg1.admin, 4002);
        assert_valid_quote_asset_config(arg3, arg4, arg5, arg6);
        assert!(0x1::type_name::with_defining_ids<T0>() != 0x1::type_name::with_defining_ids<T1>(), 4024);
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>());
        assert!(!0x2::dynamic_field::exists<0x1::ascii::String>(&arg1.id, v0), 4023);
        ...
        assert!(0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::check_asset_pair_exists<T0, T1>(arg2) && 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::check_asset_pair_exists<T1, T0>(arg2), 4014);
        ...
        let v4 = QuoteAssetAdded<T0, T1>{
            ...
            limit_fixed       : v2,
            min_out           : arg9,
            added_by          : 0x2::tx_context::sender(arg10),
        };
        0x2::event::emit<QuoteAssetAdded<T0, T1>>(v4);
    }
    ...
    public fun add_to_whitelist<T0>(arg0: &mut LiquidityPool<T0>, arg1: vector<address>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LPWhitelisted<T0>{
            ...
            lp_addresses : arg0.whitelisted_lps,
        };
    ...
    fun assert_global_config(arg0: &GlobalConfig, arg1: 0x1::option::Option<u64>, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>) {
        assert!(0x1::option::get_with_default<u64>(&arg1, arg0.max_swap_fee_pct) + 0x1::option::get_with_default<u64>(&arg4, arg0.max_dynamic_fee) <= 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points(), 4010);
        assert!(0x1::option::get_with_default<u64>(&arg2, arg0.max_lp_withdrawal_fee_pct) <= 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points(), 4010);
    ...
    fun assert_pool_fees(arg0: &GlobalConfig, arg1: 0x1::option::Option<u64>, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>) {
        ...
        assert!(0x1::option::get_with_default<u64>(&arg5, 0) <= 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points(), 4010);
    }
    ...
    fun assert_quote_is_supported<T0, T1>(arg0: &LiquidityPool<T0>) {
        ...
        assert!(0x2::dynamic_field::exists<0x1::ascii::String>(&arg0.id, v0), 4003);
    }
    ...
    fun assert_valid_quote_asset_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg0 <= 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points(), 4010);
        assert!(arg1 <= 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points(), 4010);
        assert!(arg2 <= 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points(), 4010);
        assert!(arg3 <= 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points(), 4010);
        assert!(arg0 <= arg1, 4010);
        assert!(arg2 <= arg3, 4010);
    }
    ...
    public fun calc_claimable_rewards<T0>(arg0: &LiquidityPool<T0>, arg1: &LPPosition<T0>, arg2: u64) : ClaimableRewardsInfo {
        ...
        let v3 = (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128(v1 - v2, (arg1.shares as u128), (1000000000000000000 as u128)) as u64);
        let v4 = v3;
    ...
    fun calc_dynamic_fee<T0, T1>(arg0: &LiquidityPool<T0>, arg1: u64, arg2: u128, arg3: bool) : (u64, u128, u64, u64) {
        let (v0, _) = get_pool_liquidity_for_fee_calculation<T0>(arg0);
        let v2 = 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((v0 as u128), arg2, 1000000000000000000);
        ...
        let v4 = 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128(v2, (v3.ideal_reserve_pct as u128), 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points_128());
        let v5 = 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128(v2, (v3.max_reserve_pct as u128), 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points_128());
        ...
        let v9 = if (v4 == 0) {
            ...
            (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128(((v3.fee_base * 1000) as u128), v8, v4) as u64)
        } else if (v5 == 0) {
            v3.fee_base * 1000
        } else {
            v3.fee_base * 1000 + (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128(((v3.fee_max * 1000) as u128), v8, v5) as u64)
        };
        (v9, v4, v6, quote_limit<T0, T1>(arg0, arg2, v3))
    }

    fun calculate_fees<T0>(arg0: &LiquidityPool<T0>, arg1: u64, arg2: u64) : (u64, u64) {
        let v0 = dynamic_fee_basis_points();
        let v1 = arg1 - (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((arg1 as u128), v0 - ((arg2 + ((arg0.swap_fee_pct * 1000) as u64)) as u128), v0) as u64);
        let v2 = (0x1::u128::max(0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((v1 as u128), (arg0.lp_fee_pct as u128), 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points_128()), 1) as u64);
        (v2, (0x1::u64::max(v1 - v2, 1) as u64))
    }

    fun calculate_net_and_fee_amount(arg0: u64, arg1: u64) : (u64, u64) {
        let v0 = (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((arg0 as u128), ((0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points() - arg1) as u128), (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points() as u128)) as u64);
        (v0, arg0 - v0)
    }
    ...
    public fun claim_owned_coins<T0, T1: store + key>(arg0: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::admin::ProtocolAdminCap, arg1: &mut LiquidityPool<T0>, arg2: 0x2::transfer::Receiving<T1>, arg3: &mut 0x2::tx_context::TxContext) : T1 {
        validate_pool_version<T0>(arg1);
    ...
    public fun claim_rewards<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: &mut LPPosition<T0>, arg2: 0x1::option::Option<address>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 > 0) {
            ...
            let v3 = &mut arg1.claimable_rewards;
            table_upsert<u64>(v3, v1, 0);
        };
        let v4 = RewardsClaimed<T0, T1>{
            pool_id        : 0x2::object::uid_to_inner(&arg0.id),
            provider       : v0,
            reward_asset   : v1,
            claimed_amount : v2,
        };
        0x2::event::emit<RewardsClaimed<T0, T1>>(v4);
    }
    ...
    public fun create_pool<T0>(arg0: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::admin::ProtocolAdminCap, arg1: &mut GlobalConfig, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        validate_global_config_version(arg1);
        ...
        let v2 = LiquidityPool<T0>{
            ...
            version               : 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_version(),
        ...
        let v3 = IdealBaseAnchorKey{dummy_field: false};
        0x2::dynamic_field::add<IdealBaseAnchorKey, u64>(&mut v2.id, v3, 0);
        let v4 = FlashSwapEnabledKey{dummy_field: false};
        0x2::dynamic_field::add<FlashSwapEnabledKey, bool>(&mut v2.id, v4, true);
        let v5 = FlashSwapProtocolFeeKey{dummy_field: false};
        0x2::dynamic_field::add<FlashSwapProtocolFeeKey, u64>(&mut v2.id, v5, default_flash_swap_protocol_fee<T0>(&v2));
        let v6 = PoolCreated{
    ...
    fun default_flash_swap_protocol_fee<T0>(arg0: &LiquidityPool<T0>) : u64 {
        (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((arg0.swap_fee_pct as u128), ((0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points() - arg0.lp_fee_pct) as u128), 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points_128()) as u64)
    }
    ...
    public fun deposit_base<T0>(arg0: &mut LiquidityPool<T0>, arg1: &mut LPPosition<T0>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1.pool_id == 0x2::object::uid_to_inner(&arg0.id), 4012);
        update_claimable_rewards_inner<T0>(arg0, arg1);
        0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::helper::transfer_or_destroy_zero<T0>(arg2, 0x2::tx_context::sender(arg4));
        arg1.shares = arg1.shares + internal_deposit_base<T0>(arg0, 0x2::coin::split<T0>(&mut arg2, arg3, arg4), false, arg4);
    }

    fun dynamic_fee_basis_points() : u128 {
        0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points_128() * (1000 as u128)
    }

    public fun flash_borrow<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, FlashSwapPromise<T0, T1>) {
        validate_pool_version<T0>(arg0);
        assert!(!arg0.is_paused, 4005);
        assert!(is_flash_swap_enabled<T0>(arg0), 4025);
        assert_quote_is_supported<T0, T1>(arg0);
        assert_quote_is_trading<T0, T1>(arg0);
        assert!(arg3 > 0, 4020);
        assert!(get_quote_balance<T0, T1>(arg0) >= arg3, 4021);
        let (v0, _) = get_price<T0, T1>(arg1, arg2);
        let v2 = (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((arg3 as u128), 1000000000000000000, v0) as u64);
        assert!(v2 > 0, 4016);
        let v3 = v2 + (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((v2 as u128), (flash_swap_protocol_fee<T0>(arg0) as u128), 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points_128()) as u64);
        let v4 = 0x2::object::uid_to_inner(&arg0.id);
        let v5 = FlashSwapPromise<T0, T1>{
            pool_id          : v4,
            borrowed_amount  : arg3,
            repayment_amount : v3,
            price            : v0,
        };
        let v6 = FlashBorrowEvent<T0, T1>{
            pool_id          : v4,
        ...
        0x2::event::emit<FlashBorrowEvent<T0, T1>>(v6);
        (0x2::balance::split<T1>(&mut 0x2::dynamic_field::borrow_mut<0x1::ascii::String, QuoteAssetReserve<T1>>(&mut arg0.id, 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>())).balance, arg3), v5)
    }

    public fun flash_repay<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: FlashSwapPromise<T0, T1>, arg2: 0x2::balance::Balance<T0>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        validate_pool_version<T0>(arg0);
        let FlashSwapPromise {
            pool_id          : v0,
            borrowed_amount  : v1,
            repayment_amount : v2,
            price            : v3,
        } = arg1;
        assert!(0x2::object::uid_to_inner(&arg0.id) == v0, 4026);
        assert!(0x2::balance::value<T0>(&arg2) >= v2, 4027);
        let v4 = (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((v1 as u128), 1000000000000000000, v3) as u64);
        let v5 = v2 - v4;
        0x2::balance::join<T0>(&mut arg0.base_reserve, 0x2::balance::split<T0>(&mut arg2, v4));
        0x2::balance::join<T0>(&mut arg0.protocol_base_fees, 0x2::balance::split<T0>(&mut arg2, v5));
        let v6 = 0x2::tx_context::sender(arg3);
        let v7 = FlashRepayEvent<T0, T1>{
            pool_id  : v0,
            borrower : v6,
            repaid   : v2,
            fee      : v5,
            surplus  : 0x2::balance::value<T0>(&arg2),
        };
        0x2::event::emit<FlashRepayEvent<T0, T1>>(v7);
        let v8 = SwapExecutedV2<T0, T1>{
            pool_id              : v0,
            trader               : v6,
            amount_in            : v2,
            amount_out           : v1,
            ...
            dynamic_fee_pct      : 0,
            ideal_quote_amt      : 0,
            total_fee_pct        : flash_swap_protocol_fee<T0>(arg0),
            swap_fee             : 0,
            lp_fee               : 0,
            protocol_fee         : v5,
            price_used           : v3,
            base_liquidity       : 0x2::balance::value<T0>(&arg0.base_reserve),
            quote_reserve_amount : get_quote_balance<T0, T1>(arg0),
        };
        0x2::event::emit<SwapExecutedV2<T0, T1>>(v8);
        arg2
    }

    public(friend) fun flash_swap_protocol_fee<T0>(arg0: &LiquidityPool<T0>) : u64 {
        let v0 = FlashSwapProtocolFeeKey{dummy_field: false};
        *0x2::dynamic_field::borrow<FlashSwapProtocolFeeKey, u64>(&arg0.id, v0)
    }
    ...
    fun get_pool_ideal_base_anchor<T0>(arg0: &LiquidityPool<T0>) : u64 {
        let v0 = IdealBaseAnchorKey{dummy_field: false};
        *0x2::dynamic_field::borrow<IdealBaseAnchorKey, u64>(&arg0.id, v0)
    }
    ...
    fun get_pool_liquidity_for_fee_calculation<T0>(arg0: &LiquidityPool<T0>) : (u64, u64) {
        (get_pool_ideal_base_anchor<T0>(arg0), 0x2::balance::value<T0>(&arg0.base_reserve))
    }
    ...
    fun increment_reward_rps<T0>(arg0: &mut LiquidityPool<T0>, arg1: u64) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>());
        *0x2::table::borrow_mut<0x1::ascii::String, u128>(&mut arg0.reward_rps, v0) = *0x2::table::borrow<0x1::ascii::String, u128>(&arg0.reward_rps, v0) + 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((arg1 as u128), (1000000000000000000 as u128), (arg0.total_lp_shares as u128));
    }
    ...
    public fun initial_deposit_base<T0>(arg0: &mut LiquidityPool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::helper::transfer_or_destroy_zero<T0>(arg1, 0x2::tx_context::sender(arg3));
        0x2::transfer::public_transfer<LPPosition<T0>>(v5, 0x2::tx_context::sender(arg3));
    }

    public fun initialize_global_config(arg0: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::admin::ProtocolAdminCap, arg1: 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::admin::GlobalConfigCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    fun internal_deposit_base<T0>(arg0: &mut LiquidityPool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: bool, arg3: &0x2::tx_context::TxContext) : u64 {
        ...
        if (arg0.is_permissioned) {
            assert!(0x1::vector::contains<address>(&arg0.whitelisted_lps, &v0), 4008);
        };
        let v2 = v1 * 1000;
        assert!(v2 > 0, 4032);
    ...
    public(friend) fun is_flash_swap_enabled<T0>(arg0: &LiquidityPool<T0>) : bool {
        let v0 = FlashSwapEnabledKey{dummy_field: false};
        *0x2::dynamic_field::borrow<FlashSwapEnabledKey, bool>(&arg0.id, v0)
    }
    ...
    entry fun migrate_module_version(arg0: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::admin::ProtocolAdminCap, arg1: &mut GlobalConfig) {
        assert!(arg1.version < 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_version(), 4011);
        arg1.version = 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_version();
    }

    entry fun migrate_pool_version<T0>(arg0: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::admin::ProtocolAdminCap, arg1: &mut LiquidityPool<T0>) {
        assert!(arg1.version < 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_version(), 4011);
        arg1.version = 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_version();
        let v0 = FlashSwapEnabledKey{dummy_field: false};
        if (!0x2::dynamic_field::exists<FlashSwapEnabledKey>(&arg1.id, v0)) {
            let v1 = FlashSwapEnabledKey{dummy_field: false};
            0x2::dynamic_field::add<FlashSwapEnabledKey, bool>(&mut arg1.id, v1, false);
        };
        let v2 = FlashSwapProtocolFeeKey{dummy_field: false};
        if (!0x2::dynamic_field::exists<FlashSwapProtocolFeeKey>(&arg1.id, v2)) {
            let v3 = FlashSwapProtocolFeeKey{dummy_field: false};
            0x2::dynamic_field::add<FlashSwapProtocolFeeKey, u64>(&mut arg1.id, v3, default_flash_swap_protocol_fee<T0>(arg1));
        };
    }
    ...
    public fun promise_inner<T0, T1>(arg0: &FlashSwapPromise<T0, T1>) : (0x2::object::ID, u64, u64, u128) {
        (arg0.pool_id, arg0.borrowed_amount, arg0.repayment_amount, arg0.price)
    }
    ...
    fun quote_limit<T0, T1>(arg0: &LiquidityPool<T0>, arg1: u128, arg2: &QuoteAssetReserve<T1>) : u64 {
        0x1::u64::min((0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((get_pool_ideal_base_anchor<T0>(arg0) as u128), arg1, 1000000000000000000) as u128), (0x1::option::get_with_default<u64>(&arg2.limit_ratio, arg0.limit_ratio) as u128), 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_basis_points_128()) as u64), 0x1::option::get_with_default<u64>(&arg2.limit_fixed, 18446744073709551615))
    }
    ...
    public fun set_flash_swap_enabled<T0>(arg0: &mut LiquidityPool<T0>, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        validate_pool_version<T0>(arg0);
        assert!(arg0.admin == 0x2::tx_context::sender(arg2), 4002);
        let v0 = FlashSwapEnabledKey{dummy_field: false};
        *0x2::dynamic_field::borrow_mut<FlashSwapEnabledKey, bool>(&mut arg0.id, v0) = arg1;
        let v1 = FlashSwapEnabledSet<T0>{
            pool_id : 0x2::object::uid_to_inner(&arg0.id),
            enabled : arg1,
        };
        0x2::event::emit<FlashSwapEnabledSet<T0>>(v1);
    }

    entry fun set_flash_swap_protocol_fee<T0>(arg0: &mut LiquidityPool<T0>, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        validate_pool_version<T0>(arg0);
        assert!(arg0.admin == 0x2::tx_context::sender(arg2), 4002);
        let v0 = FlashSwapProtocolFeeKey{dummy_field: false};
        *0x2::dynamic_field::borrow_mut<FlashSwapProtocolFeeKey, u64>(&mut arg0.id, v0) = arg1;
        let v1 = FlashSwapProtocolFeeSet<T0>{
            pool_id : 0x2::object::uid_to_inner(&arg0.id),
            fee     : arg1,
        };
        0x2::event::emit<FlashSwapProtocolFeeSet<T0>>(v1);
    }
    ...
    public fun set_protocol_pause(arg0: &mut GlobalConfig, arg1: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::admin::ProtocolAdminCap, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        abort 4022
    }

    public fun simulate_buy_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        validate_pool_version<T0>(arg0);
        assert!(arg3 > 0, 4030);
        assert_quote_is_supported<T0, T1>(arg0);
        let (v0, _) = get_price<T0, T1>(arg1, arg2);
        let v2 = 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((arg3 as u128), 1000000000000000000, v0);
        assert!(v2 != 0, 4016);
        ...
        SwapSimulationResult{
            base_out        : (v7 as u64),
            quote_out       : (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((v7 as u128), v0, 1000000000000000000) as u64),
    ...
    public fun simulate_sell_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        validate_pool_version<T0>(arg0);
        assert!(arg3 > 0, 4031);
        assert_quote_is_supported<T0, T1>(arg0);
        let (v0, _) = get_price<T1, T0>(arg1, arg2);
        let (v2, v3, v4, _) = calc_dynamic_fee<T0, T1>(arg0, (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((arg3 as u128), 1000000000000000000, v0) as u64), 1000000000000000000 * 1000000000000000000 / v0, true);
        let (v6, v7, v8) = calculate_swap_fees<T0>(arg0, arg3, v2);
        let v9 = 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((v6 as u128), 1000000000000000000, v0);
    ...
    public fun simulate_sell_swap_reverse<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        validate_pool_version<T0>(arg0);
        assert!(arg3 > 0, 4020);
        assert_quote_is_supported<T0, T1>(arg0);
        let (v0, _) = get_price<T1, T0>(arg1, arg2);
        let (v2, _, _, _) = calc_dynamic_fee<T0, T1>(arg0, arg3, 1000000000000000000 * 1000000000000000000 / v0, true);
        let v6 = (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((arg3 as u128), v0, 1000000000000000000) as u64);
        let (v7, v8) = calculate_fees<T0>(arg0, v6, v2);
        let v9 = dynamic_fee_basis_points();
        let v10 = get_quote_balance<T0, T1>(arg0);
        assert!(arg3 <= v10, 4021);
        let v11 = (0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((v10 as u128), v0, 1000000000000000000) as u64);
        let v12 = 0x1::u64::max(0x1::u64::min((0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::math::mul_div_u128((v6 as u128), v9, v9 - ((v2 + ((arg0.swap_fee_pct * 1000) as u64)) as u128)) as u64), v11), v7 + v8 + arg0.min_base_out);
    ...
    public fun simulate_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64, arg4: bool) : SwapSimulationResult {
        if (arg4) {
    ...
    public fun swap_buy<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: 0x2::balance::Balance<T1>, arg4: 0x1::option::Option<u64>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert!(!arg0.is_paused, 4005);
        ...
        assert_quote_is_trading<T0, T1>(arg0);
        assert!(v2 >= arg0.min_base_out, 4028);
        ...
        let v12 = SwapExecutedV2<T0, T1>{
            ...
            price_used           : v10,
            base_liquidity       : 0x2::balance::value<T0>(&arg0.base_reserve),
            quote_reserve_amount : 0x2::balance::value<T1>(&v11.balance),
        };
        0x2::event::emit<SwapExecutedV2<T0, T1>>(v12);
        (0x2::balance::split<T0>(&mut arg0.base_reserve, v2), arg3)
    }

    public fun swap_sell<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: 0x2::balance::Balance<T0>, arg4: 0x1::option::Option<u64>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert!(!arg0.is_paused, 4005);
        ...
        let v11 = 0x2::dynamic_field::borrow_mut<0x1::ascii::String, QuoteAssetReserve<T1>>(&mut arg0.id, 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>()));
        assert!(v3 >= v11.min_out, 4029);
        let v12 = 0x2::balance::split<T1>(&mut v11.balance, v3);
        v11.ideal_reserve_calc = v6;
        let v13 = SwapExecutedV2<T0, T1>{
            pool_id              : 0x2::object::uid_to_inner(&arg0.id),
            trader               : 0x2::tx_context::sender(arg5),
            amount_in            : v0,
            amount_out           : v3,
        ...
        0x2::event::emit<SwapExecutedV2<T0, T1>>(v13);
        (arg3, v12)
    }

    fun table_upsert<T0: drop + store>(arg0: &mut 0x2::table::Table<0x1::ascii::String, T0>, arg1: 0x1::ascii::String, arg2: T0) {
        if (0x2::table::contains<0x1::ascii::String, T0>(arg0, arg1)) {
            *0x2::table::borrow_mut<0x1::ascii::String, T0>(arg0, arg1) = arg2;
        } else {
            0x2::table::add<0x1::ascii::String, T0>(arg0, arg1, arg2);
        };
    }
    ...
    fun update_claimable_rewards_inner<T0>(arg0: &LiquidityPool<T0>, arg1: &mut LPPosition<T0>) {
        ...
        while (v0 < 0x1::vector::length<0x1::ascii::String>(&arg0.supported_assets)) {
            ...
            let v2 = &mut arg1.claimable_rewards;
            table_upsert<u64>(v2, v1.asset, v1.amount);
            let v3 = &mut arg1.paid_rps;
            table_upsert<u128>(v3, v1.asset, v1.reward_rps);
            v0 = v0 + 1;
        };
    }
    ...
    public fun update_global_config(arg0: &mut GlobalConfig, arg1: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::admin::ProtocolAdminCap, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update_ideal_base_anchor<T0>(arg0: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::admin::ProtocolAdminCap, arg1: &mut LiquidityPool<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        validate_pool_version<T0>(arg1);
        let v0 = IdealBaseAnchorKey{dummy_field: false};
        if (0x2::dynamic_field::exists<IdealBaseAnchorKey>(&arg1.id, v0)) {
            let v1 = IdealBaseAnchorKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<IdealBaseAnchorKey, u64>(&mut arg1.id, v1) = arg2;
        } else {
            let v2 = IdealBaseAnchorKey{dummy_field: false};
            0x2::dynamic_field::add<IdealBaseAnchorKey, u64>(&mut arg1.id, v2, arg2);
        };
        let v3 = IdealBaseAnchorUpdated{
            pool_id    : 0x2::object::uid_to_inner(&arg1.id),
            new_anchor : arg2,
        };
        0x2::event::emit<IdealBaseAnchorUpdated>(v3);
    }
    ...
    public fun update_net_base_fee_multiplier<T0>(arg0: &0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::admin::ProtocolAdminCap, arg1: &mut LiquidityPool<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        abort 4022
    }
    ...
    public fun update_quote_asset<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: 0x1::option::Option<u64>, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: 0x1::option::Option<u64>, arg8: 0x1::option::Option<bool>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert_valid_quote_asset_config(v1.ideal_reserve_pct, v1.max_reserve_pct, v1.fee_base, v1.fee_max);
        let v2 = QuoteAssetUpdated<T0, T1>{
            pool_id           : 0x2::object::uid_to_inner(&arg0.id),
            quote_asset       : v0,
            ideal_reserve_pct : arg1,
            max_reserve_pct   : arg2,
            fee_base          : arg3,
            fee_max           : arg4,
            limit_ratio_bps   : arg5,
            limit_fixed       : arg6,
            min_out           : arg7,
            is_trading        : arg8,
            updated_by        : 0x2::tx_context::sender(arg9),
        };
        0x2::event::emit<QuoteAssetUpdated<T0, T1>>(v2);
    }

    public fun validate_global_config_version(arg0: &GlobalConfig) {
        assert!(arg0.version == 0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_version(), 4011);
    }
    ...
    public fun version() : u64 {
        0x6fd74ee27fc97dcb0f22bf943f8fcc7638535a3d16d95e6d31d00ad2480f1f54::constants::get_version()
    }

    public fun withdraw_all_base<T0>(arg0: &mut LiquidityPool<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 4002);
        validate_pool_version<T0>(arg0);
        let v0 = arg0.admin;
        let v1 = 0x2::balance::value<T0>(&arg0.base_reserve);
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg0.base_reserve), arg1), v0);
        };
        let v2 = BaseWithdrawn<T0>{
            pool_id     : 0x2::object::uid_to_inner(&arg0.id),
            admin       : v0,
            base_amount : v1,
        };
        0x2::event::emit<BaseWithdrawn<T0>>(v2);
    }

    public fun withdraw_all_quote<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 4002);
        validate_pool_version<T0>(arg0);
        assert_quote_is_supported<T0, T1>(arg0);
        let v0 = arg0.admin;
        let v1 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>());
        let v2 = 0x2::dynamic_field::borrow_mut<0x1::ascii::String, QuoteAssetReserve<T1>>(&mut arg0.id, v1);
        let v3 = 0x2::balance::withdraw_all<T1>(&mut v2.balance);
        0x2::balance::join<T1>(&mut v3, 0x2::balance::withdraw_all<T1>(&mut v2.collected_rewards));
        if (0x2::balance::value<T1>(&v3) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v3, arg1), v0);
        } else {
            0x2::balance::destroy_zero<T1>(v3);
        };
        let v4 = QuoteWithdrawn<T0, T1>{
            pool_id        : 0x2::object::uid_to_inner(&arg0.id),
            admin          : v0,
            quote_asset    : v1,
            quote_amount   : 0x2::balance::value<T1>(&v2.balance),
            rewards_amount : 0x2::balance::value<T1>(&v2.collected_rewards),
        };
        0x2::event::emit<QuoteWithdrawn<T0, T1>>(v4);
    }
    ...
    public fun withdraw_protocol_fees<T0>(arg0: &ProtocolFeeClaimCap, arg1: &mut LiquidityPool<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        validate_pool_version<T0>(arg1);
        let v0 = 0x2::balance::withdraw_all<T0>(&mut arg1.protocol_base_fees);
        let v1 = 0x2::tx_context::sender(arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg2), v1);
        let v2 = ProtocolFeesWithdrawn<T0>{
            pool_id   : 0x2::object::uid_to_inner(&arg1.id),
            recipient : v1,
            amount    : 0x2::balance::value<T0>(&v0),
        };
        0x2::event::emit<ProtocolFeesWithdrawn<T0>>(v2);
    }
