module 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::governance {
    ...
    struct Governance has store {
        ...
        next_trade_params: 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::TradeParams,
        voting_power: u64,
        quorum: u64,
    }
    ...
    public(friend) fun empty(arg0: bool, arg1: &0x2::tx_context::TxContext) : Governance {
        ...
        Governance{
            ...
            trade_params      : 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::new(v0, v1, 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::constants::default_stake_required()),
            next_trade_params : 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::new(v0, v1, 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::constants::default_stake_required()),
            voting_power      : 0,
            quorum            : 0,
        }
    }
    ...
    fun remove_lowest_proposal(arg0: &mut Governance, arg1: u64) {
        ...
        let v1 = 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::constants::max_u64();
    ...
    fun reset_trade_params(arg0: &mut Governance) {
        ...
        if (arg0.whitelisted) {
            arg0.trade_params = 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::new(0, 0, 0);
        } else if (arg0.stable) {
            arg0.trade_params = 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::new(100000, 50000, 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::stake_required(&arg0.trade_params));
        } else {
            arg0.trade_params = 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::new(1000000, 500000, 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::stake_required(&arg0.trade_params));
        };
        arg0.next_trade_params = arg0.trade_params;
    }
    ...
    fun stake_to_voting_power(arg0: u64) : u64 {
        ...
        if (arg0 > 100000000000) {
            v1 = v0 + 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::math::sqrt(arg0, 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::constants::deep_unit()) - 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::math::sqrt(100000000000, 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::constants::deep_unit());
        };
        v1
    }

    fun to_trade_params(arg0: &Proposal) : 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::TradeParams {
        0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::new(arg0.taker_fee, arg0.maker_fee, arg0.stake_required)
    }

    public(friend) fun trade_params(arg0: &Governance) : 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::TradeParams {
        arg0.trade_params
    }
    ...
    public(friend) fun update(arg0: &mut Governance, arg1: &0x2::tx_context::TxContext) {
        ...
        arg0.epoch = v0;
        arg0.quorum = 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::math::mul(arg0.voting_power, 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::constants::half());
        arg0.proposals = 0x2::vec_map::empty<0x2::object::ID, Proposal>();
        arg0.trade_params = arg0.next_trade_params;
        let v1 = TradeParamsUpdateEvent{
            taker_fee      : 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::taker_fee(&arg0.trade_params),
            maker_fee      : 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::maker_fee(&arg0.trade_params),
            stake_required : 0x6f2abaa15ea8f1935968310a196807272b37150878dc4072f2e0cbaa9eca894a::trade_params::stake_required(&arg0.trade_params),
        };
