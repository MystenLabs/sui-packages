module 0x6f7b8990fa5957f5038d6cbe5776b8b85c26554c49c4fe0149b3bd7e3c191993::vault_config {
    ...
    public(friend) fun borrow_withdraw_cap(arg0: &VaultConfig) : &0x53b73487591bc610ec201f10fcdfcc09c2aab2a74177112539afeb0706c78d1d::cloud_wallet_config::QuickWithdrawCap {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0x53b73487591bc610ec201f10fcdfcc09c2aab2a74177112539afeb0706c78d1d::cloud_wallet_config::QuickWithdrawCap>(&arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"))
    }
    ...
    public fun set_cloud_wallet_withdraw_cap(arg0: &VaultConfig, arg1: &mut VaultTokenHolder, arg2: 0x2::transfer::Receiving<0x53b73487591bc610ec201f10fcdfcc09c2aab2a74177112539afeb0706c78d1d::cloud_wallet_config::QuickWithdrawCap>, arg3: &mut 0x2::tx_context::TxContext) {
        only_admin(arg0, arg3);
        0x2::dynamic_field::add<0x1::ascii::String, 0x53b73487591bc610ec201f10fcdfcc09c2aab2a74177112539afeb0706c78d1d::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, 0x1::ascii::string(b"quick_withdraw_cap"), 0x2::transfer::public_receive<0x53b73487591bc610ec201f10fcdfcc09c2aab2a74177112539afeb0706c78d1d::cloud_wallet_config::QuickWithdrawCap>(&mut arg1.id, arg2));
    }
