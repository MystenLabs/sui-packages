module 0x6fab65d9cbe07f9114401fa92d964388472db88153bc1166135f2672061a6c74::deep {
    ...
    fun init(arg0: DEEP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<DEEP>(&mut v2, 10000000000000000, 0x2::tx_context::sender(arg1), arg1);
