module 0x6f4b77cf37b323b6fa185709e115ab7d3eaf3f24b19b5057d9d3d62beb4d4b13::game7996 {
    struct GAME7996 has drop {
        dummy_field: bool,
    }

    struct TICKET_7996 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7996(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7996>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7996>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME7996, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME7996>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7996>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7996>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7996>>(v5, 0x2::tx_context::sender(arg1));
    }
