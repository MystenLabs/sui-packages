module 0x4541394694a3d5fc74d9d60912a237c01294362b2822eafaff9b727a55d2d643::app {
    ...
    entry fun claim_and_distribute<T0>(arg0: &mut ClaimParams, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v3 < 0x1::vector::length<CoinDetail>(&v1.coin_details)) {
            ...
            if (v6.coin_type == normalise_coin_type(&v2) && v6.object_id == 0x2::object::id<0x2::coin::Coin<T0>>(&arg1)) {
                v4 = true;
                v5 = v6.amount;
                break
            };
    ...
    entry fun create_and_update_claim_params(arg0: &mut ClaimParams, arg1: address, arg2: address, arg3: address, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &0x2::tx_context::TxContext) {
        ...
        while (v2 < v0) {
            ...
            let v4 = CoinDetail{
                coin_type : normalise_coin_type(&v3),
    ...
    fun normalise_coin_type(arg0: &0x1::ascii::String) : 0x1::ascii::String {
        ...
        while (v3 + 1 < v1) {
            let v4 = 58;
            let v5 = if (0x1::vector::borrow<u8>(&v0, v3) == &v4) {
                let v6 = 58;
                0x1::vector::borrow<u8>(&v0, v3 + 1) == &v6
            } else {
                false
            };
            if (v5) {
        ...
        if (v2 == 0) {
            return 0x1::ascii::string(v0)
        };
        let v7 = 0;
        let v8 = if (v2 >= 2) {
            let v9 = 48;
            if (0x1::vector::borrow<u8>(&v0, 0) == &v9) {
                let v10 = 120;
                0x1::vector::borrow<u8>(&v0, 1) == &v10
            } else {
                false
            }
        } else {
        ...
        let v12 = 0;
        while (v12 < 64 - v2 - v7) {
            0x1::vector::push_back<u8>(&mut v11, 48);
            v12 = v12 + 1;
        };
        let v13 = v7;
        while (v13 < v2) {
        ...
        let v14 = v2;
        while (v14 < v1) {
            0x1::vector::push_back<u8>(&mut v11, *0x1::vector::borrow<u8>(&v0, v14));
            v14 = v14 + 1;
        };
        0x1::ascii::string(v11)
    }
