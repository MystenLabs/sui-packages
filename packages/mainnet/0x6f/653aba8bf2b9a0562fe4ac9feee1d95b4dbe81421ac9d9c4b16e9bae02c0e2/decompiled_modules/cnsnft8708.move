module 0x6f653aba8bf2b9a0562fe4ac9feee1d95b4dbe81421ac9d9c4b16e9bae02c0e2::cnsnft8708 {
    struct CNSNFT8708 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8708, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4629"));
        let v4 = 0x2::package::claim<CNSNFT8708>(arg0, arg1);
