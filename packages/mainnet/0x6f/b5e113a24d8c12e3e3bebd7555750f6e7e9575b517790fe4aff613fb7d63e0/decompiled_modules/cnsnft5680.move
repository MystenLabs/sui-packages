module 0x6fb5e113a24d8c12e3e3bebd7555750f6e7e9575b517790fe4aff613fb7d63e0::cnsnft5680 {
    struct CNSNFT5680 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5680, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6007"));
        let v4 = 0x2::package::claim<CNSNFT5680>(arg0, arg1);
