module 0x6fa183a4edf6e9b2f14ff2106f46a750a729fb307c3d0eeacd023f766039ef11::jacuzzi {
    ...
    public fun mint(arg0: &mut Config, arg1: u8, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 >= arg0.claim_time, 1008);
        ...
        let (v2, v3) = if (arg1 == 1) {
            ...
            let v5 = if (0x2::table::contains<u8, u128>(&arg0.gen_ids, 1)) {
                0x2::table::remove<u8, u128>(&mut arg0.gen_ids, 1)
            } else {
                0
            };
            0x2::table::add<u8, u128>(&mut arg0.gen_ids, 1, v5 + 1);
            (0x1::string::utf8(b"chunnin"), v5)
        } else if (arg1 == 2) {
            assert!(0x2::table::contains<u8, 0x2::vec_set::VecSet<address>>(&arg0.whitelisted, arg1), 1007);
            let v6 = 0x2::table::borrow_mut<u8, 0x2::vec_set::VecSet<address>>(&mut arg0.whitelisted, arg1);
            assert!(0x2::vec_set::contains<address>(v6, &v1), 1004);
            0x2::vec_set::remove<address>(v6, &v1);
            let v7 = if (0x2::table::contains<u8, u128>(&arg0.gen_ids, 2)) {
                0x2::table::remove<u8, u128>(&mut arg0.gen_ids, 2)
            } else {
                0
            };
            0x2::table::add<u8, u128>(&mut arg0.gen_ids, 2, v7 + 1);
            (0x1::string::utf8(b"jonin"), v7)
        } else {
            assert!(0x2::table::contains<u8, 0x2::vec_set::VecSet<address>>(&arg0.whitelisted, arg1), 1007);
            let v8 = 0x2::table::borrow_mut<u8, 0x2::vec_set::VecSet<address>>(&mut arg0.whitelisted, arg1);
            assert!(0x2::vec_set::contains<address>(v8, &v1), 1004);
            0x2::vec_set::remove<address>(v8, &v1);
            let v9 = if (0x2::table::contains<u8, u128>(&arg0.gen_ids, 3)) {
                0x2::table::remove<u8, u128>(&mut arg0.gen_ids, 3)
            } else {
                0
            };
            0x2::table::add<u8, u128>(&mut arg0.gen_ids, 3, v9 + 1);
            (0x1::string::utf8(b"kage"), v9)
        };
        let v10 = JacuzziNFT{
        ...
        let v11 = MintedEvent{
            user        : v1,
            campaign_id : 0x2::object::id<Config>(arg0),
            nft_id      : 0x2::object::id<JacuzziNFT>(&v10),
            gen_id      : v3,
        };
        0x2::event::emit<MintedEvent>(v11);
        0x2::transfer::transfer<JacuzziNFT>(v10, v1);
    }
    ...
    public fun set_claim_time(arg0: &AdminCap, arg1: &mut Config, arg2: u64) {
        assert!(arg1.version == 1, 1002);
