module 0x6ff8721caafd101b8f1d684de0bc7a77306ee628bbcb1c367b1805e78b26c058::cross_chain_airdrop {
    ...
    struct PerContractAirdropInfo has store {
        ...
        claimed_source_token_ids: vector<0x6ff8721caafd101b8f1d684de0bc7a77306ee628bbcb1c367b1805e78b26c058::erc721_metadata::TokenID>,
    }
    ...
    public entry fun claim(arg0: &mut CrossChainAirdropOracle, arg1: address, arg2: vector<u8>, arg3: u256, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x6ff8721caafd101b8f1d684de0bc7a77306ee628bbcb1c367b1805e78b26c058::erc721_metadata::new_token_id(arg3);
        assert!(!is_token_claimed(v0, &v1), 0);
        0x6ff8721caafd101b8f1d684de0bc7a77306ee628bbcb1c367b1805e78b26c058::stacc_nft::mint(arg4, arg7, arg6, arg8);
        0x1::vector::push_back<0x6ff8721caafd101b8f1d684de0bc7a77306ee628bbcb1c367b1805e78b26c058::erc721_metadata::TokenID>(&mut v0.claimed_source_token_ids, v1);
    }
    ...
    fun create_contract(arg0: &mut CrossChainAirdropOracle, arg1: &vector<u8>) : &mut PerContractAirdropInfo {
        ...
        let v1 = PerContractAirdropInfo{
            ...
            claimed_source_token_ids : 0x1::vector::empty<0x6ff8721caafd101b8f1d684de0bc7a77306ee628bbcb1c367b1805e78b26c058::erc721_metadata::TokenID>(),
        };
    ...
    fun is_token_claimed(arg0: &PerContractAirdropInfo, arg1: &0x6ff8721caafd101b8f1d684de0bc7a77306ee628bbcb1c367b1805e78b26c058::erc721_metadata::TokenID) : bool {
        let v0 = 0;
        while (v0 < 0x1::vector::length<0x6ff8721caafd101b8f1d684de0bc7a77306ee628bbcb1c367b1805e78b26c058::erc721_metadata::TokenID>(&arg0.claimed_source_token_ids)) {
            if (0x1::vector::borrow<0x6ff8721caafd101b8f1d684de0bc7a77306ee628bbcb1c367b1805e78b26c058::erc721_metadata::TokenID>(&arg0.claimed_source_token_ids, v0) == arg1) {
                return true
            };
            v0 = v0 + 1;
        };
