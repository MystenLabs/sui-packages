module 0x6fc3a0ee28837d759948fe408802738a8a70eb6a763222eac60f36ec7fd9a51d::capybara_lootbox {
    ...
    public fun exchange_fruits_to_kapybara(arg0: &mut DataStorage, arg1: NFTFruit, arg2: NFTFruit, arg3: NFTFruit, arg4: NFTFruit, arg5: NFTFruit, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v16 = KapybaraNFT{
            ...
            idx : arg0.total_kapybara,
        };
        let v17 = MintCapybara{
            from    : v0,
            nft_id  : 0x2::object::id<KapybaraNFT>(&v16),
            nft_idx : v16.idx,
        };
        0x2::event::emit<MintCapybara>(v17);
        0x2::transfer::public_transfer<KapybaraNFT>(v16, v0);
    }
    ...
    fun init(arg0: CAPYBARA_LOOTBOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v15 = 0x2::display::new_with_fields<KapybaraNFT>(&v0, v11, v13, arg1);
        0x2::display::update_version<KapybaraNFT>(&mut v15);
        ...
        0x2::transfer::public_transfer<0x2::display::Display<KapybaraNFT>>(v15, v16);
    }

    public fun mint_fruit_by_admin(arg0: &0x6fc3a0ee28837d759948fe408802738a8a70eb6a763222eac60f36ec7fd9a51d::capybara_game_card::AdminCap, arg1: &mut DataStorage, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<NFTFruit>(v0, 0x2::tx_context::sender(arg3));
    }
    ...
    public fun update_storage(arg0: &0x6fc3a0ee28837d759948fe408802738a8a70eb6a763222eac60f36ec7fd9a51d::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
