module 0x6fd4a410c50f91c570203e374dd1cfa884bfa5c02c31ec4e5c5b78d3f306af23::gift8289 {
    struct GIFT8289 has drop {
        dummy_field: bool,
    }

    struct TICKET_8289 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8289(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8289>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8289>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8289, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8289>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8289>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8289>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8289>>(v5, 0x2::tx_context::sender(arg1));
    }
