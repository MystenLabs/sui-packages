module 0xa1964d8d45e2cab45e4e675826ebba62a79e72fb740f519253dffa82d4fca785::nrv {
    ...
    public fun update_description(arg0: &AdminCap, arg1: &mut TokenConfig, arg2: &mut 0x2::coin::CoinMetadata<NRV>, arg3: vector<u8>) {
        0x2::coin::update_description<NRV>(&arg1.treasury, arg2, 0x1::string::utf8(arg3));
    }

    public fun update_icon_url(arg0: &AdminCap, arg1: &mut TokenConfig, arg2: &mut 0x2::coin::CoinMetadata<NRV>, arg3: vector<u8>) {
        0x2::coin::update_icon_url<NRV>(&arg1.treasury, arg2, 0x1::ascii::string(arg3));
    }

    public fun update_name(arg0: &AdminCap, arg1: &mut TokenConfig, arg2: &mut 0x2::coin::CoinMetadata<NRV>, arg3: vector<u8>) {
        0x2::coin::update_name<NRV>(&arg1.treasury, arg2, 0x1::string::utf8(arg3));
    }

    public fun update_symbol(arg0: &AdminCap, arg1: &mut TokenConfig, arg2: &mut 0x2::coin::CoinMetadata<NRV>, arg3: vector<u8>) {
        0x2::coin::update_symbol<NRV>(&arg1.treasury, arg2, 0x1::ascii::string(arg3));
    }
