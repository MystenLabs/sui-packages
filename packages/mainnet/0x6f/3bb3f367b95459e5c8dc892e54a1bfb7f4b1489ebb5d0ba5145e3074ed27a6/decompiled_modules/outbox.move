module 0x6f3bb3f367b95459e5c8dc892e54a1bfb7f4b1489ebb5d0ba5145e3074ed27a6::outbox {
    struct Outbox<T0: store> has store {
        entries: 0x2::table::Table<OutboxKey, OutboxItem<T0>>,
        rate_limit: 0x6f3bb3f367b95459e5c8dc892e54a1bfb7f4b1489ebb5d0ba5145e3074ed27a6::rate_limit::RateLimitState,
    }
    ...
    struct OutboxItem<T0> has store {
        ...
        released: 0xa6f73ee2c92af448e202d075f03506cf6e69ca288a8616f59252321451376246::bitmap::Bitmap,
        ...
        data: 0xa6f73ee2c92af448e202d075f03506cf6e69ca288a8616f59252321451376246::ntt_manager_message::NttManagerMessage<T0>,
    }
    ...
    public fun add<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxItem<T0>) : OutboxKey {
        let v0 = OutboxKey{id: 0xa6f73ee2c92af448e202d075f03506cf6e69ca288a8616f59252321451376246::ntt_manager_message::get_id<T0>(&arg1.data)};
    ...
    public(friend) fun new<T0: store>(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : Outbox<T0> {
        Outbox<T0>{
            ...
            rate_limit : 0x6f3bb3f367b95459e5c8dc892e54a1bfb7f4b1489ebb5d0ba5145e3074ed27a6::rate_limit::new(arg0),
        }
    }

    public fun borrow_data<T0: store>(arg0: &OutboxItem<T0>) : &0xa6f73ee2c92af448e202d075f03506cf6e69ca288a8616f59252321451376246::ntt_manager_message::NttManagerMessage<T0> {
        &arg0.data
    }

    public fun borrow_rate_limit_mut<T0: store>(arg0: &mut Outbox<T0>) : &mut 0x6f3bb3f367b95459e5c8dc892e54a1bfb7f4b1489ebb5d0ba5145e3074ed27a6::rate_limit::RateLimitState {
        &mut arg0.rate_limit
    }
    ...
    public fun new_outbox_item<T0>(arg0: u64, arg1: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg2: 0xa6f73ee2c92af448e202d075f03506cf6e69ca288a8616f59252321451376246::ntt_manager_message::NttManagerMessage<T0>) : OutboxItem<T0> {
        OutboxItem<T0>{
            release_timestamp     : arg0,
            released              : 0xa6f73ee2c92af448e202d075f03506cf6e69ca288a8616f59252321451376246::bitmap::empty(),
    ...
    public(friend) fun try_release<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxKey, arg2: u8, arg3: &0x2::clock::Clock) : bool {
        ...
        if (0xa6f73ee2c92af448e202d075f03506cf6e69ca288a8616f59252321451376246::bitmap::get(&v0.released, arg2)) {
            abort 13906834586660241409
        };
        0xa6f73ee2c92af448e202d075f03506cf6e69ca288a8616f59252321451376246::bitmap::enable(&mut v0.released, arg2);
        true
    }
