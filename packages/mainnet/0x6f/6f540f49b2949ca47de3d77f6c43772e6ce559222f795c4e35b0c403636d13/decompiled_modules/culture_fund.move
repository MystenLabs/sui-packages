module 0x6f6f540f49b2949ca47de3d77f6c43772e6ce559222f795c4e35b0c403636d13::culture_fund {
    ...
    public entry fun claim<T0>(arg0: &mut Gift, arg1: &PlatformConfig, arg2: &0x2::clock::Clock, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(*0x1::option::borrow<address>(&arg0.recipient_wallet) == arg3, 3);
    ...
    public entry fun deposit<T0>(arg0: &PlatformConfig, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_field::add<vector<u8>, 0x2::balance::Balance<T0>>(&mut v3.id, b"balance", 0x2::coin::into_balance<T0>(arg4));
        ...
        0x2::transfer::transfer<Gift>(v3, 0x2::tx_context::sender(arg5));
    }
