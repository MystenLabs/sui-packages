module 0xd20319be6c6e9fe0f7965244f176a8849ca64e6ae245caf4a50cfc6ad3b2d6a3::sui_vsui_strategy {
    ...
    public fun rebalance(arg0: &mut Strategy, arg1: &0x7094200c433f1485ecd622a0aa9e0ebf0cc2e334c2ce2e07aa7b047f40f55af0::vault::AdminCap<0xd88345d9fa0a9dccddd9a05fff8916c8182d4069e6f2ae52c0dfe0e97d962796::st_sui::ST_SUI>, arg2: &mut 0x7094200c433f1485ecd622a0aa9e0ebf0cc2e334c2ce2e07aa7b047f40f55af0::vault::Vault<0x2::sui::SUI, 0xd88345d9fa0a9dccddd9a05fff8916c8182d4069e6f2ae52c0dfe0e97d962796::st_sui::ST_SUI>, arg3: &0x7094200c433f1485ecd622a0aa9e0ebf0cc2e334c2ce2e07aa7b047f40f55af0::vault::RebalanceAmounts, arg4: &mut 0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::native_pool::NativePool, arg5: &mut 0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::cert::Metadata<0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::cert::CERT>, arg6: &mut 0x3::sui_system::SuiSystemState, arg7: &0x2::clock::Clock, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg9: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<0x2::sui::SUI>, arg10: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::cert::CERT>, arg11: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive::Incentive, arg12: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg13: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg14: &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::flash_loan::Config, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 > 0) {
            let v2 = 0x1::u64::min(v0, 0x2::balance::value<0x2::sui::SUI>(0x7094200c433f1485ecd622a0aa9e0ebf0cc2e334c2ce2e07aa7b047f40f55af0::vault::free_balance<0x2::sui::SUI, 0xd88345d9fa0a9dccddd9a05fff8916c8182d4069e6f2ae52c0dfe0e97d962796::st_sui::ST_SUI>(arg2)));
            let v3 = 0x2::coin::from_balance<0x2::sui::SUI>(0x7094200c433f1485ecd622a0aa9e0ebf0cc2e334c2ce2e07aa7b047f40f55af0::vault::strategy_borrow<0x2::sui::SUI, 0xd88345d9fa0a9dccddd9a05fff8916c8182d4069e6f2ae52c0dfe0e97d962796::st_sui::ST_SUI>(arg2, &arg0.vault_access, v2), arg15);
            let v4 = BorrowEvent{
            ...
            if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.collected_asset, 0x1::type_name::get<0x2::sui::SUI>())) {
                let v6 = borrow_collected_asset_mut<0x2::sui::SUI>(arg0);
                0x2::balance::join<0x2::sui::SUI>(&mut v5, 0x2::balance::withdraw_all<0x2::sui::SUI>(v6));
            };
            0x2::balance::join<0x2::sui::SUI>(&mut v5, 0x2::coin::into_balance<0x2::sui::SUI>(v3));
            revolving_loan(arg0, arg4, arg5, arg6, v5, arg7, arg8, arg10, arg9, arg11, arg12, arg13, arg15);
        } else {
            let v7 = 0x2::balance::zero<0x2::sui::SUI>();
            let v8 = borrow_collected_asset_mut<0x2::sui::SUI>(arg0);
            0x2::balance::join<0x2::sui::SUI>(&mut v7, 0x2::balance::withdraw_all<0x2::sui::SUI>(v8));
            revolving_loan(arg0, arg4, arg5, arg6, v7, arg7, arg8, arg10, arg9, arg11, arg12, arg13, arg15);
        };
    }
