module 0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::acl::ACL,
        package_version: u64,
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::acl::Member> {
        0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        checked_package_version(arg0);
        0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        checked_package_version(arg0);
        0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun add_in_coin_type<T0>(arg0: &mut GlobalConfig, arg1: &0x2::tx_context::TxContext) {
        assert!(0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg1), 1), 2);
    ...
    public fun checked_keeper(arg0: &GlobalConfig, arg1: address) {
        assert!(0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::acl::has_role(&arg0.acl, arg1, 0), 1);
    }

    public fun checked_oracle(arg0: &GlobalConfig, arg1: address) {
        assert!(0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::acl::has_role(&arg0.acl, arg1, 2), 3);
    }
    ...
    public fun claim_fee<T0>(arg0: &GlobalConfig, arg1: &mut ProtocolFeeVault, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        assert!(0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg2), 1), 2);
    ...
    public fun claim_fee_with_cap<T0>(arg0: &GlobalConfig, arg1: &mut ProtocolFeeVault, arg2: &OperatorCap) : 0x2::balance::Balance<T0> {
        checked_package_version(arg0);
        assert!(0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::acl::has_role(&arg0.acl, 0x2::object::id_address<OperatorCap>(arg2), 3), 5);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                   : 0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::acl::new(arg0),
            package_version       : 1,
        ...
        0x6f98ae8bbe495f1c91f820d4a184516a2e5aed674d530c2233519925d7f0af19::acl::set_roles(&mut v0.acl, v3, 0 | 1 << 1);
