module 0x6fe81c7b9632786368c9eba7fb66416153c0b3b9444bde101485a9c1138fec3f::cnsnft9220 {
    struct CNSNFT9220 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9220, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9220>(arg0, arg1);
