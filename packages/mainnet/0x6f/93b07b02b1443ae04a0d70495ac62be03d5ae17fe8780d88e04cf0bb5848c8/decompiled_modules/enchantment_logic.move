module 0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::enchantment_logic {
    ...
    fun budget_for_rarity(arg0: u8) : u64 {
        ...
        (((50 as u128) * (v0 as u128) / (0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::constants::bp_den() as u128)) as u64)
    }
    ...
    public(friend) fun enchant_inventory_slot(arg0: &mut 0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::character_data::Character, arg1: &0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::game_data::GameData, arg2: u64, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) : EnchantmentResult {
        let v0 = 0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::character_data::get_item_by_instance_id(arg0, arg2);
        let v1 = 0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::inventory_item::item_id(v0);
        let v2 = 0x2::random::new_generator(arg3, arg4);
        let v3 = if (0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::inventory_item::enchantment_rarity(v0) > 0) {
            true
        } else if (0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::inventory_item::agility_bonus(v0) > 0) {
            true
        } else if (0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::inventory_item::endurance_bonus(v0) > 0) {
            true
        } else if (0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::inventory_item::stealth_bonus(v0) > 0) {
            true
        } else {
            0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::inventory_item::luck_bonus(v0) > 0
        };
        let v4 = &mut v2;
        ...
        let v12 = 0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::character_data::get_item_by_instance_id_mut(arg0, arg2);
        0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::inventory_item::set_bonuses(v12, v8, v9, v10, v11, v5);
        if (0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::inventory_management::is_type_equipped(arg0, 0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::inventory_item::type_id(v12))) {
            0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::character_data::update_attributes(arg0, arg1);
            let v13 = 0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::total_stats::calculate_total_stats(arg0);
            0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::stamina_logic::update_max_stamina(0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::character_data::stamina_mut(arg0), 0x6f93b07b02b1443ae04a0d70495ac62be03d5ae17fe8780d88e04cf0bb5848c8::total_stats::total_endurance(&v13));
        };
        EnchantmentResult{
            item_id         : v1,
            rarity          : v5,
