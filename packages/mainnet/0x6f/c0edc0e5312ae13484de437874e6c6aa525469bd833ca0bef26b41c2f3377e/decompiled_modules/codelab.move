module 0xd9dff820cbf0534938d359ae6ddc22df66b43fb9af05262393152958d878a06::codelab {
    ...
    public fun test_flash_swap<T0>(arg0: &0x2::clock::Clock, arg1: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::flash_swap<0x2::sui::SUI, T0>(arg0, arg1, arg2, false, false, arg4, 79226673515401279992447579054);
        let v3 = v2;
        let v4 = v0;
        let v5 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap_pay_amount<0x2::sui::SUI, T0>(&v3);
        let v6 = 0x2::balance::value<0x2::sui::SUI>(&v4);
        let v7 = Debug{
            pay_sui_amount : v5,
            got_sui_amount : v6,
        };
        0x2::event::emit<Debug>(v7);
        0x2::balance::join<0x2::sui::SUI>(&mut v4, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, v5 - v6, arg5)));
