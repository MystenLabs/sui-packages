module 0x6fc73d00024ba476f2189164a581fea37bbcce0b6311e9e023b0e4926c1a32a6::curve {
    ...
    public fun list<T0>(arg0: &mut Configurator, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: 0x1::option::Option<0x1::ascii::String>, arg5: 0x1::option::Option<0x1::ascii::String>, arg6: 0x1::option::Option<0x1::ascii::String>, arg7: 0x1::option::Option<0x1::ascii::String>, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        ...
        0x6fc73d00024ba476f2189164a581fea37bbcce0b6311e9e023b0e4926c1a32a6::freezer::freeze_object<0x2::coin::TreasuryCap<T0>>(arg1, arg9);
    ...
    public fun migrate<T0>(arg0: &AdminCap, arg1: &mut BondingCurve<T0>, arg2: &mut Configurator, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let (v0, v1) = get_reserves<T0>(arg1);
        (0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.sui_balance, v0), arg3), 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.token_balance, (((v1 as u128) * (arg1.conversion_rate as u128) / 10000000000) as u64)), arg3))
    }
