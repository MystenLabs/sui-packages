module 0x6fefb7da3ecda0b30f5bc1ee5587ef8a18faba6b6ee925c2ba13f1c2f20a12a0::suifloki {
    struct SUIFLOKI has drop {
        dummy_field: bool,
    }

    public entry fun burn(arg0: &mut 0x2::coin::TreasuryCap<SUIFLOKI>, arg1: 0x2::coin::Coin<SUIFLOKI>) {
        0x2::coin::burn<SUIFLOKI>(arg0, arg1);
    }

    fun init(arg0: SUIFLOKI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUIFLOKI>(arg0, 2, b"SUINU", b"SUINU", b"", 0x1::option::none<0x2::url::Url>(), arg1);
