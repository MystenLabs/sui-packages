module 0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::credenza_meta_loyalty_v2 {
    struct LoyaltyConfig has store, key {
        id: 0x2::object::UID,
        ownership: 0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::ownership::CredenzaOwnership,
    ...
    public fun add_points_with_meta(arg0: &mut LoyaltyConfig, arg1: address, arg2: u64, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg5));
    ...
    public fun deposit<T0>(arg0: &mut LoyaltyConfig, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::tx_context::TxContext) {
        0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg2));
    ...
    public fun forfeit_points(arg0: &mut LoyaltyConfig, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
    ...
    public fun forfeit_points_for_event_id(arg0: &mut LoyaltyConfig, arg1: address, arg2: u64, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg4));
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LoyaltyConfig{
            id               : v0,
            ownership        : 0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg0),
        ...
        0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg0));
    ...
    public fun set_owner(arg0: &mut LoyaltyConfig, arg1: address, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::ownership::set_owner(&mut arg0.ownership, arg1, arg2);
    }
    ...
    public fun withdraw<T0>(arg0: &mut LoyaltyConfig, arg1: &mut 0x2::tx_context::TxContext) {
        0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg1));
