module 0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::sellable {
    ...
    public fun create_config<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : (T0, CredenzaSellableConfig<T0>) {
        ...
        let v1 = CredenzaSellableConfig<T0>{
            id                      : v0,
            ownership               : 0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
        ...
        0x6f16f71f2cc2195ae42c69a3fb030b807c4dd2585193898a219c1ee549229d23::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg1));
