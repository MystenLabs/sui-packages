module 0x6f7a5ae2a39baf2e7ae4b9c7ce964f5b6f1964719f59515b5417112071a959a7::cnsnft2159 {
    struct CNSNFT2159 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2159, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2159>(arg0, arg1);
