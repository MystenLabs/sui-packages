module 0x6f83f1aa5f3dfee773f14ebb847746e28c7d70fd467bd2779b19efaf4ff847b6::marketplace {
    ...
    struct Marketplace has store, key {
        ...
        version: u64,
        index: u256,
        wallet: 0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::Wallet,
    ...
    public fun balance<T0>(arg0: &Marketplace) : u64 {
        0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::balance<T0>(&arg0.wallet)
    }
    ...
    public fun balance_of_royalty<T0, T1>(arg0: &Marketplace) : u64 {
        ...
        if (0x2::dynamic_field::exists_<WalletKey<T0>>(&arg0.id, v0)) {
            ...
            0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::balance<T1>(0x2::dynamic_field::borrow<WalletKey<T0>, 0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::Wallet>(&arg0.id, v2))
        } else {
            0
        }
    }
    ...
    public entry fun buy_and_take<T0: store + key, T1>(arg0: &mut Marketplace, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v5 > 0) {
            0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::deposit<T1>(&mut arg0.wallet, 0x2::coin::split<T1>(&mut arg2, v5, arg3), arg3);
        };
    ...
    public entry fun create_marketplace(arg0: &mut 0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Marketplace{
            ...
            version : 1,
            index   : 0,
            wallet  : 0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::init_wallet(arg1),
            access  : 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::init_access(arg1),
        };
        ...
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::grant_roles_for_sender(&mut v0.access, 0x2::tx_context::sender(arg1), v1, arg1);
    ...
    fun deposit_royalty<T0, T1>(arg0: &mut Marketplace, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::dynamic_field::exists_<WalletKey<T0>>(&arg0.id, v0)) {
            ...
            0x2::dynamic_field::add<WalletKey<T0>, 0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::Wallet>(&mut arg0.id, v1, 0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::init_wallet(arg2));
        };
        let v2 = WalletKey<T0>{dummy_field: false};
        0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::deposit<T1>(0x2::dynamic_field::borrow_mut<WalletKey<T0>, 0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::Wallet>(&mut arg0.id, v2), arg1, arg2);
    }
    ...
    public entry fun grant_roles(arg0: &mut Marketplace, arg1: address, arg2: vector<0x2::object::ID>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(&arg0.access, 0x2::tx_context::sender(arg3), v0);
    ...
    public entry fun set_protocol_fee<T0, T1>(arg0: &mut Marketplace, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut v0;
        0x1::vector::push_back<0x2::object::ID>(v1, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"admin_role"));
        0x1::vector::push_back<0x2::object::ID>(v1, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"set_protocol_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(&arg0.access, 0x2::tx_context::sender(arg4), v0);
        let v2 = ProtocolFeeKey{nft_type: 0x1::type_name::get<T0>()};
    ...
    public entry fun set_royalty<T0, T1>(arg0: &mut Marketplace, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut v0;
        0x1::vector::push_back<0x2::object::ID>(v1, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"admin_role"));
        0x1::vector::push_back<0x2::object::ID>(v1, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"set_royalty_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(&arg0.access, 0x2::tx_context::sender(arg4), v0);
        let v2 = RoyaltyKey{nft_type: 0x1::type_name::get<T0>()};
    ...
    public entry fun withdraw<T0>(arg0: &mut Marketplace, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut v0;
        0x1::vector::push_back<0x2::object::ID>(v1, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"admin_role"));
        0x1::vector::push_back<0x2::object::ID>(v1, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"withdraw_protocol_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(&arg0.access, 0x2::tx_context::sender(arg3), v0);
        0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::withdraw<T0>(&mut arg0.wallet, arg1, arg2, arg3);
    ...
    public entry fun withdraw_royalty<T0, T1>(arg0: &mut Marketplace, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut v0;
        0x1::vector::push_back<0x2::object::ID>(v1, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"admin_role"));
        0x1::vector::push_back<0x2::object::ID>(v1, 0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::to_role(b"withdraw_royalty_role"));
        0x2e658ee2718568907a559739bb8da8ec35ff4ea16cfea79f402997f1a575751d::access::assert_anyone_match_for_sender(&arg0.access, 0x2::tx_context::sender(arg3), v0);
        let v2 = WalletKey<T0>{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<WalletKey<T0>>(&arg0.id, v2), 10007);
        let v3 = WalletKey<T0>{dummy_field: false};
        0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::withdraw<T1>(0x2::dynamic_field::borrow_mut<WalletKey<T0>, 0xae4bd74b5e345e6acd20f7dae334d72753ce3adb086925b92d0fb3fef93d2e4e::wallet::Wallet>(&mut arg0.id, v3), arg1, arg2, arg3);
