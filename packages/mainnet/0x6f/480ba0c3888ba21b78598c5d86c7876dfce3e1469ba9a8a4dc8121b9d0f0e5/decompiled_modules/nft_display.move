module 0x6f480ba0c3888ba21b78598c5d86c7876dfce3e1469ba9a8a4dc8121b9d0f0e5::nft_display {
    ...
    fun init(arg0: NFT_DISPLAY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0x6f480ba0c3888ba21b78598c5d86c7876dfce3e1469ba9a8a4dc8121b9d0f0e5::anniversary_vault::Today365>(&v0, v1, v3, arg1);
        0x2::display::update_version<0x6f480ba0c3888ba21b78598c5d86c7876dfce3e1469ba9a8a4dc8121b9d0f0e5::anniversary_vault::Today365>(&mut v5);
        0x2::transfer::public_share_object<0x2::display::Display<0x6f480ba0c3888ba21b78598c5d86c7876dfce3e1469ba9a8a4dc8121b9d0f0e5::anniversary_vault::Today365>>(v5);
        ...
        let v10 = 0x2::display::new_with_fields<0x6f480ba0c3888ba21b78598c5d86c7876dfce3e1469ba9a8a4dc8121b9d0f0e5::nostalgia_ticket::NostalgiaTicket>(&v0, v6, v8, arg1);
        0x2::display::update_version<0x6f480ba0c3888ba21b78598c5d86c7876dfce3e1469ba9a8a4dc8121b9d0f0e5::nostalgia_ticket::NostalgiaTicket>(&mut v10);
        0x2::transfer::public_share_object<0x2::display::Display<0x6f480ba0c3888ba21b78598c5d86c7876dfce3e1469ba9a8a4dc8121b9d0f0e5::nostalgia_ticket::NostalgiaTicket>>(v10);
