module 0x6f5e95b8e882675313df261c548e698b3b85d7cd301975ab8e643711c49425d0::dao {
    ...
    public fun claim_dao<T0, T1>(arg0: &mut DAO<T0, T1>, arg1: DAOVoucher<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.payment_balance, arg1.owned_amount * 0x2::balance::value<T1>(&arg0.payment_balance) / arg0.funded_amount), arg2), 0x2::tx_context::sender(arg2));
        let DAOVoucher {
            id           : v0,
            owned_amount : _,
        } = arg1;
