module 0x6f10bd8b2dd4ac8549c9ce2b7fbe64dae8e07e1ffab4dd46a23b651ea8a9d7b2::gift9006 {
    struct GIFT9006 has drop {
        dummy_field: bool,
    }

    struct TICKET_9006 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9006(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9006>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9006>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9006, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9006>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9006>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9006>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9006>>(v5, 0x2::tx_context::sender(arg1));
    }
