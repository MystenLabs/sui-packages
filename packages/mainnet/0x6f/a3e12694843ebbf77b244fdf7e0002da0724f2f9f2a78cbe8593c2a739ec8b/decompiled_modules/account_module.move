module 0x6fa3e12694843ebbf77b244fdf7e0002da0724f2f9f2a78cbe8593c2a739ec8b::account_module {
    ...
    public fun pool_data_1(arg0: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market) : u64 {
        let v0 = 0;
        let v1 = 4294967296;
        ...
        while (v6 < 0x1::vector::length<0x1::type_name::TypeName>(&v5)) {
            ...
            if (0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::interest_model::type_name(v9) == 0x1::type_name::get<0x2::sui::SUI>()) {
                v0 = 10000 * 0x1::fixed_point32::get_raw_value(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::borrow_dynamics::interest_rate(v8)) * v11 * (v1 - 0x1::fixed_point32::get_raw_value(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::interest_model::revenue_factor(v9))) / v1 / 1361925194 / (v10 + v11 - v12);
                continue
            };
        };
        v0
