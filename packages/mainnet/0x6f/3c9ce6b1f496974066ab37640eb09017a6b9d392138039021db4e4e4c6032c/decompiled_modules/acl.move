module 0x6f3c9ce6b1f496974066ab37640eb09017a6b9d392138039021db4e4e4c6032c::acl {
    ...
    public fun destroy<T0>(arg0: SuperAdmin<T0>) {
        ...
        let v3 = v0;
        0x6f3c9ce6b1f496974066ab37640eb09017a6b9d392138039021db4e4e4c6032c::sam_events::destroy_super_admin(0x2::object::uid_to_address(&v3));
    ...
    public fun destroy_admin<T0>(arg0: &mut ACL<T0>, arg1: Admin<T0>) {
        ...
        0x6f3c9ce6b1f496974066ab37640eb09017a6b9d392138039021db4e4e4c6032c::sam_events::destroy_admin(0x2::object::uid_to_address(&v0));
    ...
    public fun finish_transfer<T0>(arg0: SuperAdmin<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x6f3c9ce6b1f496974066ab37640eb09017a6b9d392138039021db4e4e4c6032c::sam_events::finish_super_admin_transfer(v0);
    }
    ...
    public fun new_admin<T0>(arg0: &mut ACL<T0>, arg1: &SuperAdmin<T0>, arg2: &mut 0x2::tx_context::TxContext) : Admin<T0> {
        ...
        0x6f3c9ce6b1f496974066ab37640eb09017a6b9d392138039021db4e4e4c6032c::sam_events::new_admin(0x2::object::uid_to_address(&v0.id));
        v0
    }
    ...
    public fun revoke<T0>(arg0: &mut ACL<T0>, arg1: &SuperAdmin<T0>, arg2: address) {
        ...
        0x6f3c9ce6b1f496974066ab37640eb09017a6b9d392138039021db4e4e4c6032c::sam_events::revoke_admin(arg2);
    }
    ...
    public fun revoke_with_cap<T0>(arg0: &mut ACL<T0>, arg1: &SuperAdmin<T0>, arg2: &Admin<T0>) {
        ...
        0x6f3c9ce6b1f496974066ab37640eb09017a6b9d392138039021db4e4e4c6032c::sam_events::revoke_admin(0x2::object::uid_to_address(&arg2.id));
    }
    ...
    public fun start_transfer<T0>(arg0: &mut SuperAdmin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.new_admin = arg1;
        0x6f3c9ce6b1f496974066ab37640eb09017a6b9d392138039021db4e4e4c6032c::sam_events::start_super_admin_transfer(arg1, arg0.start);
    }
