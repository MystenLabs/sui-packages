module 0x1cd08bcefa5373ed83787ed2a7058a443aaf234046b3807a6b9b0bb3d8acba6c::cnsnft7693 {
    struct CNSNFT7693 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7693, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7693>(arg0, arg1);
