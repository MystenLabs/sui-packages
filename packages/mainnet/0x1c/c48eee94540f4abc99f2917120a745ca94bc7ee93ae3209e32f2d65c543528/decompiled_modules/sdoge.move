module 0x1cc48eee94540f4abc99f2917120a745ca94bc7ee93ae3209e32f2d65c543528::sdoge {
    struct SDOGE has drop {
        dummy_field: bool,
    }

    fun init(arg0: SDOGE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SDOGE>(arg0, 9, b"SDOGE", b"doge on sui", b"SDOGE THE BEST TOKEN AND HIGH PROFIT", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = v0;
