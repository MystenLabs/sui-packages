module 0x1c6ffe8b28558e7850109ac3686d8a81e1bb4ee8586239b2318b0af765c2255d::reward6657 {
    struct REWARD6657 has drop {
        dummy_field: bool,
    }

    struct TICKET_6657 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6657(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6657>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6657>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6657, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6657>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6657>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6657>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6657>>(v5, 0x2::tx_context::sender(arg1));
    }
