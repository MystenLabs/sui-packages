module 0x1c24cf481c71d6c0cb5348ba8a807df1149e170c3b1293de09930774af4a7dde::dogsonsui {
    struct DOGSONSUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DOGSONSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DOGSONSUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"DogsOnSUI"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Just Dogs, no more !"));
