module 0x1ca7d4c55951271b5d188a3079f3144a5cdcd5b13073e048fb19e752dcff4da1::nft {
    ...
    entry fun mint(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Nft{
            ...
            name        : 0x1::string::utf8(b"byte07041"),
            description : 0x1::string::utf8(b"byte07041 NFT"),
            creator     : 0x2::tx_context::sender(arg1),
            url         : 0x2::url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/174679710?v=4"),
        };
