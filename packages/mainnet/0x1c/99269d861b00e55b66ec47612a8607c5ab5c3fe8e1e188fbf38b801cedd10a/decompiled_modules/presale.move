module 0x1c99269d861b00e55b66ec47612a8607c5ab5c3fe8e1e188fbf38b801cedd10a::presale {
    ...
    struct PresaleUpdateEvent has copy, drop {
        presale_id: 0x2::object::ID,
        old_limit_buy: u64,
        new_limit_buy: u64,
    }
    ...
    public entry fun create_presale(arg0: &mut PresaleMarketplace, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v2 = PresaleCreateEvent{
            presale_id : v1,
            market_id  : 0x2::object::id<PresaleMarketplace>(arg0),
            starts     : arg4,
            expires    : arg5,
    ...
    public entry fun update_presale(arg0: &mut PresaleMarketplace, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Presale>(&mut arg0.id, arg1);
        assert!(0x2::tx_context::sender(arg3) == v0.owner, 3);
        assert!(arg2 >= 1, 70);
        v0.limit_buy = arg2;
        let v1 = PresaleUpdateEvent{
            presale_id    : arg1,
            old_limit_buy : arg2,
            new_limit_buy : v0.limit_buy,
        };
        0x2::event::emit<PresaleUpdateEvent>(v1);
    }
