module 0x1cf2be0a23175cfe20ddbe62cfbb82b62bb2e2022e2e525586ed48c7cc754329::cnsnft1583 {
    struct CNSNFT1583 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1583, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1583>(arg0, arg1);
