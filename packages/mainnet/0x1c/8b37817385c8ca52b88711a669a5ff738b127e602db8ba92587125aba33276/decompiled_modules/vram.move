module 0x1c8b37817385c8ca52b88711a669a5ff738b127e602db8ba92587125aba33276::vram {
    ...
    fun new(arg0: u64, arg1: 0x1::string::String, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &mut 0x2::tx_context::TxContext) : VramNFT {
        ...
        VramNFT{
            ...
            image_url   : 0x1::string::utf8(b"https://aggregator.walrus-testnet.walrus.space/v1/blobs/MjRV_-u_6IsFR2d71k8Y3pAoU4MqBewC7xRF4nrZgyg"),
            description : arg1,
    ...
    fun init(arg0: VRAM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"https://aggregator.walrus-testnet.walrus.space/v1/blobs/MjRV_-u_6IsFR2d71k8Y3pAoU4MqBewC7xRF4nrZgyg"));
        ...
        let v4 = v3;
        let v5 = v2;
        0x1c8b37817385c8ca52b88711a669a5ff738b127e602db8ba92587125aba33276::kiosk_lock_rule::add<VramNFT>(&mut v5, &v4);
        0x1c8b37817385c8ca52b88711a669a5ff738b127e602db8ba92587125aba33276::royalty_rule::add<VramNFT>(&mut v5, &v4, 500, 0);
