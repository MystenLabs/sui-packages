module 0x1c75369933aeeb5db04275bca36935a819deba86eb5522ed8b98029367c842a7::rbr {
    ...
    public(friend) fun consume<T0, T1: drop>(arg0: RebalanceRequest<T0>, arg1: T1) : 0x2::balance::Balance<T0> {
        ...
        let v4 = v3;
        assert!(0x1::option::extract<0x1::type_name::TypeName>(&mut v4) == 0x1::type_name::with_defining_ids<T1>(), 7);
        v2
    }
    ...
    public(friend) fun fill<T0, T1: drop>(arg0: &mut RebalanceRequest<T0>, arg1: 0x2::balance::Balance<T0>, arg2: T1) {
        ...
        assert!(0x1::option::extract<0x1::type_name::TypeName>(&mut arg0.from_witness) == 0x1::type_name::with_defining_ids<T1>(), 7);
