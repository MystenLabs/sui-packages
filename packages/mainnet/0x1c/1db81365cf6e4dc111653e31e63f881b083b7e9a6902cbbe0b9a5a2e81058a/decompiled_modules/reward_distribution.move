        ...
        while (v2 < 0x1::vector::length<u32>(&arg1)) {
            ...
            if (!v9) {
                if (0x1::vector::contains<0x1::string::String>(v7, &v1) && 0x2::dynamic_field::exists_with_type<CoinTypeKey<T0>, CoinVault<T0>>(&arg0.id, v8)) {
                    ...
                    let v13 = v12;
                    if (v12 > 0) {
                        if (v12 >= 0xa566a1422c0529700a27e7d5e800d52d6b9ade2a57790f20ac0842a39cb02ce8::vault::vault_amount<T0>(&v11.vault)) {
                            v13 = 0xa566a1422c0529700a27e7d5e800d52d6b9ade2a57790f20ac0842a39cb02ce8::vault::vault_amount<T0>(&v11.vault);
                        };
                        v11.distributed_rewards = v11.distributed_rewards + v13;
                        0x2::balance::join<T0>(&mut v3, 0xa566a1422c0529700a27e7d5e800d52d6b9ade2a57790f20ac0842a39cb02ce8::vault::withdraw<T0>(&mut v11.vault, v13));
                    ...
                    if (0x2::table::contains<u32, vector<0x1::string::String>>(&arg0.period_vaults, v4)) {
                        ...
                        if (0x1::vector::contains<0x1::string::String>(0x2::table::borrow<u32, vector<0x1::string::String>>(&arg0.period_vaults, v4), &v1) && 0x2::dynamic_field::exists_with_type<CoinTypeKey<T0>, CoinVault<T0>>(&arg0.id, v7)) {
                            ...
                            if (!v8) {
                                ...
                                if (v11 > 0) {
                                    let v12 = 0xa566a1422c0529700a27e7d5e800d52d6b9ade2a57790f20ac0842a39cb02ce8::vault::vault_amount<T0>(&v10.vault);
                                    let v13 = if (v11 > v12) {
                                        v12
                                    } else {
                                        v11
