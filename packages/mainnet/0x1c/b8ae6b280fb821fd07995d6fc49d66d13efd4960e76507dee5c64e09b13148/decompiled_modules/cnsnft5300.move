module 0x1cb8ae6b280fb821fd07995d6fc49d66d13efd4960e76507dee5c64e09b13148::cnsnft5300 {
    struct CNSNFT5300 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5300, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5300>(arg0, arg1);
