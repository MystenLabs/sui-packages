module 0x1cc624d6bed41c9992f26b964c196d850b813a465d8b976de45fbc238c2677ad::passionnn {
    ...
    fun init(arg0: PASSIONNN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"skin"));
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"main"));
        let v2 = 0x1::vector::empty<0x1::string::String>();
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"aaaa"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"bbbb"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"cccc"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"dddd"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"basic"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"FCE370"));
