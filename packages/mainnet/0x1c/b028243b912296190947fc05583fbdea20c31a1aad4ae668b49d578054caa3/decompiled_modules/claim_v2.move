module 0x611b595b92ca94e5d49fb7486214571b817bb925efa2c3cf85612fa350de5ce5::claim_v2 {
    struct ClaimedLedgerV2 has store, key {
        id: 0x2::object::UID,
        current_round: u8,
    ...
    public entry fun claim(arg0: &mut ClaimedLedgerV2, arg1: address, arg2: u64, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun deposit(arg0: &mut ClaimedLedgerV2, arg1: 0x2::coin::Coin<0x611b595b92ca94e5d49fb7486214571b817bb925efa2c3cf85612fa350de5ce5::stars::STARS>) {
    ...
    public entry fun initialize(arg0: &mut 0x611b595b92ca94e5d49fb7486214571b817bb925efa2c3cf85612fa350de5ce5::claim::ClaimedLedger, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == @0xffae791c3b063c623f507d1339ba8e15796dc62f0d42765cfaa221c645a34aa4, 1);
        let v0 = ClaimedLedgerV2{
            id            : 0x2::object::new(arg1),
            current_round : 0,
            claimed       : 0x2::table::new<u8, 0x2::table::Table<address, u64>>(arg1),
            balance       : 0x611b595b92ca94e5d49fb7486214571b817bb925efa2c3cf85612fa350de5ce5::claim::withdraw_all(arg0),
        };
        0x2::table::add<u8, 0x2::table::Table<address, u64>>(&mut v0.claimed, 0, 0x2::table::new<address, u64>(arg1));
        0x2::transfer::public_share_object<ClaimedLedgerV2>(v0);
    }

    public fun is_claimed(arg0: &ClaimedLedgerV2, arg1: address) : bool {
        0x2::table::contains<address, u64>(0x2::table::borrow<u8, 0x2::table::Table<address, u64>>(&arg0.claimed, arg0.current_round), arg1)
    }

    public entry fun start_new_round(arg0: &mut ClaimedLedgerV2, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == @0xffae791c3b063c623f507d1339ba8e15796dc62f0d42765cfaa221c645a34aa4, 1);
    ...
    public entry fun withdraw(arg0: &mut ClaimedLedgerV2, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == @0xffae791c3b063c623f507d1339ba8e15796dc62f0d42765cfaa221c645a34aa4, 1);
