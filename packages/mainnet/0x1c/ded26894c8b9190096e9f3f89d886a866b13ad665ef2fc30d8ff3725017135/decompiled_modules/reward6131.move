module 0x1cded26894c8b9190096e9f3f89d886a866b13ad665ef2fc30d8ff3725017135::reward6131 {
    struct REWARD6131 has drop {
        dummy_field: bool,
    }

    struct TICKET_6131 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6131(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6131>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6131>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6131, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6131>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6131>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6131>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6131>>(v5, 0x2::tx_context::sender(arg1));
    }
