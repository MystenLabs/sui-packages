module 0x1cfee2ecb71392c8502e9228880de333240e42cc8ddbc4810678030f35e4c402::suilend_adapter {
    ...
    public fun withdraw_with_delevering<T0, T1: drop>(arg0: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg1: u64, arg2: u64, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T1>, arg7: &mut 0x3::sui_system::SuiSystemState, arg8: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        while (0x2::coin::value<0x2::sui::SUI>(&v2) < arg5 && v1 < 10) {
            ...
            if (v4 == 0) {
                ...
                if (v8 > v3) {
                    let v9 = 0x2::coin::split<0x2::sui::SUI>(&mut v7, v8 - v3, arg9);
                    deposit_to_suilend<T0, 0x2::sui::SUI>(arg0, arg1, arg4, v9, arg3, arg9);
                };
                0x2::coin::join<0x2::sui::SUI>(&mut v2, v7);
                break
            };
            let v10 = calculate_safe_withdraw_amount<T0, T1>(arg0, arg3, arg2, arg4);
            if (v10 < 10000) {
                break
            };
            if (!check_health_factor_safe<T0>(arg0, arg3, arg4)) {
            ...
            let v11 = withdraw_liquidity_from_suilend<T0, T1>(arg0, arg2, arg4, arg3, v10, arg7, arg9);
            let v12 = 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::redeem<T1>(arg6, v11, arg7, arg9);
            if (v4 > 0) {
                let v13 = &mut v12;
                repay_borrow<T0, 0x2::sui::SUI>(arg0, arg1, arg3, arg4, v13, arg9);
            };
            let v14 = 0x2::coin::value<0x2::sui::SUI>(&v12);
            if (v14 > v3) {
                let v15 = 0x2::coin::split<0x2::sui::SUI>(&mut v12, v14 - v3, arg9);
                deposit_to_suilend<T0, 0x2::sui::SUI>(arg0, arg1, arg4, v15, arg3, arg9);
            };
            0x2::coin::join<0x2::sui::SUI>(&mut v2, v12);
            v1 = v1 + 1;
        };
        v2
    }
