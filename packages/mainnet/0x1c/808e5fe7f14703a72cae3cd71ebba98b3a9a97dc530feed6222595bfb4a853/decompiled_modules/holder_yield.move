module 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::holder_yield {
    ...
    public(friend) fun create_and_share<T0, T1>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        create_vault_inner<T0, T1>(arg0, arg1, true, arg2)
    }
    ...
    fun create_vault_inner<T0, T1>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = HolderYieldVault<T0, T1>{
            id               : 0x2::object::new(arg3),
            lock_id          : arg0,
            bluefin_pool_id  : arg1,
            holders          : 0x2::table::new<address, YieldHolder>(arg3),
            total_registered : 0,
    ...
    public fun enable_push_distribute<T0, T1>(arg0: &mut HolderYieldVault<T0, T1>, arg1: &0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config::AdminCap) {
    ...
    public fun is_push_mode<T0, T1>(arg0: &HolderYieldVault<T0, T1>) : bool {
        let v0 = PushDistributeKey{dummy_field: false};
    ...
    public fun push_payout<T0, T1>(arg0: &mut HolderYieldVault<T0, T1>, arg1: &0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config::AdminCap, arg2: address, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<T1>(&arg0.reward_pot) >= arg3, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::nothing_to_push());
        0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::events::emit_holder_yield_push(arg0.lock_id, 0x2::object::id<HolderYieldVault<T0, T1>>(arg0), arg2, arg3, 0x1::type_name::with_defining_ids<T1>(), 0x2::clock::timestamp_ms(arg4));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.reward_pot, arg3), arg5), arg2);
    }
