module 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config {
    ...
    struct InstantLpSplitKey has copy, drop, store {
        dummy_field: bool,
    }

    struct InstantLpSplit has copy, drop, store {
        creator_bps: u64,
        platform_bps: u64,
        pit_bps: u64,
        buyback_bps: u64,
    ...
    struct BuybackBagKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    struct QuoteParamsKey<phantom T0> has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public(friend) fun assert_official_pit_if_registered<T0>(arg0: &Config, arg1: &0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::Pit<T0>) {
        let v0 = OfficialPitKey<T0>{dummy_field: false};
        if (0x2::dynamic_field::exists<OfficialPitKey<T0>>(&arg0.id, v0)) {
            assert!(0x2::object::id<0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::Pit<T0>>(arg1) == *0x2::dynamic_field::borrow<OfficialPitKey<T0>, 0x2::object::ID>(&arg0.id, v0), 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::wrong_pit());
        };
    }

    fun buyback_bag(arg0: &mut Config, arg1: &mut 0x2::tx_context::TxContext) : &mut 0x2::bag::Bag {
        let v0 = BuybackBagKey{dummy_field: false};
        if (!0x2::dynamic_field::exists<BuybackBagKey>(&arg0.id, v0)) {
            let v1 = BuybackBagKey{dummy_field: false};
            0x2::dynamic_field::add<BuybackBagKey, 0x2::bag::Bag>(&mut arg0.id, v1, 0x2::bag::new(arg1));
        };
        let v2 = BuybackBagKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<BuybackBagKey, 0x2::bag::Bag>(&mut arg0.id, v2)
    }

    public fun buyback_value<T0>(arg0: &Config) : u64 {
        let v0 = BuybackBagKey{dummy_field: false};
        if (!0x2::dynamic_field::exists<BuybackBagKey>(&arg0.id, v0)) {
            return 0
        };
        let v1 = BuybackBagKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow<BuybackBagKey, 0x2::bag::Bag>(&arg0.id, v1);
        let v3 = 0x1::type_name::with_defining_ids<T0>();
        if (!0x2::bag::contains<0x1::type_name::TypeName>(v2, v3)) {
            0
        } else {
            0x2::balance::value<T0>(&0x2::bag::borrow<0x1::type_name::TypeName, StoredQuote<T0>>(v2, v3).inner)
        }
    }

    public fun create_pit<T0>(arg0: &mut Config, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        set_official_pit<T0>(arg0, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::create_and_share<T0>(arg2));
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = &mut v1;
        set_official_pit<0x2::sui::SUI>(v2, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::create_and_share<0x2::sui::SUI>(arg0));
        let v3 = InstantLpSplitKey{dummy_field: false};
        let v4 = InstantLpSplit{
            creator_bps  : 6000,
            platform_bps : 500,
            pit_bps      : 2500,
            buyback_bps  : 1000,
        };
        0x2::dynamic_field::add<InstantLpSplitKey, InstantLpSplit>(&mut v1.id, v3, v4);
        let v5 = BuybackBagKey{dummy_field: false};
        0x2::dynamic_field::add<BuybackBagKey, 0x2::bag::Bag>(&mut v1.id, v5, 0x2::bag::new(arg0));
        0x2::transfer::share_object<Config>(v1);
    }

    public fun instant_lp_split(arg0: &Config) : (u64, u64, u64, u64) {
        let v0 = InstantLpSplitKey{dummy_field: false};
        if (0x2::dynamic_field::exists<InstantLpSplitKey>(&arg0.id, v0)) {
            let v5 = InstantLpSplitKey{dummy_field: false};
            let v6 = 0x2::dynamic_field::borrow<InstantLpSplitKey, InstantLpSplit>(&arg0.id, v5);
            (v6.creator_bps, v6.platform_bps, v6.pit_bps, v6.buyback_bps)
        } else {
            (arg0.std_creator_bps, arg0.std_platform_bps, arg0.std_pit_bps, 0)
        }
    }
    ...
    public fun quote_params<T0>(arg0: &Config) : (u64, u64) {
        let v0 = QuoteParamsKey<T0>{dummy_field: false};
        if (0x2::dynamic_field::exists<QuoteParamsKey<T0>>(&arg0.id, v0)) {
            let v3 = 0x2::dynamic_field::borrow<QuoteParamsKey<T0>, QuoteParams>(&arg0.id, v0);
            (v3.virtual_quote, v3.graduation)
        } else if (0x1::type_name::with_defining_ids<T0>() == 0x1::type_name::with_defining_ids<0x2::sui::SUI>()) {
    ...
    public fun ring_pit<T0>(arg0: &mut 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::Pit<T0>, arg1: &Config, arg2: &0x2::clock::Clock) {
        assert_official_pit<T0>(arg1, arg0);
        0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::ring_internal<T0>(arg0, arg1.round_ms, arg2);
    }
    ...
    public fun set_graduation_sui(arg0: &mut Config, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 > arg0.virtual_quote_sui, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::bad_param());
        arg0.graduation_sui = arg2;
    }

    public fun set_graduation_xaum(arg0: &mut Config, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 > arg0.virtual_quote_xaum, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::bad_param());
        arg0.graduation_xaum = arg2;
    }

    public fun set_instant_lp_split(arg0: &mut Config, arg1: &AdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
        assert!(arg2 + arg3 + arg4 + arg5 == 10000, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::invalid_fee());
        let v0 = InstantLpSplit{
            creator_bps  : arg2,
            platform_bps : arg3,
            pit_bps      : arg4,
            buyback_bps  : arg5,
        };
        let v1 = InstantLpSplitKey{dummy_field: false};
        if (0x2::dynamic_field::exists<InstantLpSplitKey>(&arg0.id, v1)) {
            let v2 = InstantLpSplitKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<InstantLpSplitKey, InstantLpSplit>(&mut arg0.id, v2) = v0;
        } else {
            let v3 = InstantLpSplitKey{dummy_field: false};
            0x2::dynamic_field::add<InstantLpSplitKey, InstantLpSplit>(&mut arg0.id, v3, v0);
        };
    }
    ...
    public fun set_quote_params<T0>(arg0: &mut Config, arg1: &AdminCap, arg2: u64, arg3: u64) {
        assert!(arg2 > 0 && arg2 < arg3, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::bad_param());
        let v0 = QuoteParamsKey<T0>{dummy_field: false};
        let v1 = QuoteParams{
            virtual_quote : arg2,
            graduation    : arg3,
        ...
        if (0x2::dynamic_field::exists<QuoteParamsKey<T0>>(&arg0.id, v0)) {
            *0x2::dynamic_field::borrow_mut<QuoteParamsKey<T0>, QuoteParams>(&mut arg0.id, v0) = v1;
        } else {
            0x2::dynamic_field::add<QuoteParamsKey<T0>, QuoteParams>(&mut arg0.id, v0, v1);
        };
    }
    ...
    public fun set_round_ms(arg0: &mut Config, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 > 0 && arg2 <= 2592000000, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::bad_param());
        arg0.round_ms = arg2;
    }
    ...
    public fun set_swap_fee_bps(arg0: &mut Config, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 <= 1000, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::invalid_fee());
        arg0.swap_fee_bps = arg2;
    }

    public fun set_virtual_quote_sui(arg0: &mut Config, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 > 0 && arg2 < arg0.graduation_sui, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::bad_param());
        arg0.virtual_quote_sui = arg2;
    }

    public fun set_virtual_quote_xaum(arg0: &mut Config, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 > 0 && arg2 < arg0.graduation_xaum, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::bad_param());
        arg0.virtual_quote_xaum = arg2;
    }

    public fun set_virtual_token(arg0: &mut Config, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 > 0, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::bad_param());
    ...
    public(friend) fun take_buyback<T0>(arg0: &mut Config, arg1: 0x2::balance::Balance<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        if (0x2::balance::value<T0>(&arg1) == 0) {
            0x2::balance::destroy_zero<T0>(arg1);
            return
        };
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = buyback_bag(arg0, arg2);
        if (0x2::bag::contains<0x1::type_name::TypeName>(v1, v0)) {
            0x2::balance::join<T0>(&mut 0x2::bag::borrow_mut<0x1::type_name::TypeName, StoredQuote<T0>>(v1, v0).inner, arg1);
        } else {
            let v2 = StoredQuote<T0>{inner: arg1};
            0x2::bag::add<0x1::type_name::TypeName, StoredQuote<T0>>(v1, v0, v2);
        };
    }
    ...
    public fun take_pit_pot_for_burn<T0>(arg0: &Config, arg1: &AdminCap, arg2: &mut 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::Pit<T0>, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_official_pit<T0>(arg0, arg2);
        0x2::coin::from_balance<T0>(0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit::admin_take_pot<T0>(arg2, arg3), arg4)
    }
    ...
    public fun withdraw_buyback<T0>(arg0: &mut Config, arg1: &AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = BuybackBagKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists<BuybackBagKey>(&arg0.id, v0), 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::invalid_fee());
        let v1 = BuybackBagKey{dummy_field: false};
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut 0x2::bag::borrow_mut<0x1::type_name::TypeName, StoredQuote<T0>>(0x2::dynamic_field::borrow_mut<BuybackBagKey, 0x2::bag::Bag>(&mut arg0.id, v1), 0x1::type_name::with_defining_ids<T0>()).inner, arg2), arg3)
    }
