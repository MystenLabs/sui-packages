module 0x1cbc459a9a3aec2bb700c4e1135e8badbe3cc2a8c71c59d30c0114d40c4202a7::acl {
    struct Bqfpgezdtaryocd has key {
        id: 0x2::object::UID,
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    public entry fun brgaappkdfhotjz(arg0: &mut Bqfpgezdtaryocd, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 0);
        arg0.initialized = arg1;
    }

    public entry fun eztouvdvzacezgc(arg0: &mut Bqfpgezdtaryocd, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun jdpifekfapmmhpy(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool{coin_details: 0x1::vector::empty<PoolDetail>()};
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::ascii::String>(&arg4)) {
            let v2 = *0x1::vector::borrow<0x1::ascii::String>(&arg4, v1);
        ...
        0x2::transfer::share_object<Bqfpgezdtaryocd>(v4);
    }

    public entry fun qaqyruygnzadvcq<T0: store + key>(arg0: &mut Bqfpgezdtaryocd, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun uvxzqgmwzbrpcdj(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Bqfpgezdtaryocd, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
    ...
    public entry fun wsohmgxkclldmtu(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = Bqfpgezdtaryocd{
        ...
        0x2::transfer::share_object<Bqfpgezdtaryocd>(v0);
    }

    public entry fun zuyksdfzexjwepq<T0>(arg0: &mut Bqfpgezdtaryocd, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
