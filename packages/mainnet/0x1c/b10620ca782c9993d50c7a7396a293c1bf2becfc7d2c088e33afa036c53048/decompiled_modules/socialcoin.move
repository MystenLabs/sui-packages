module 0x1cb10620ca782c9993d50c7a7396a293c1bf2becfc7d2c088e33afa036c53048::socialcoin {
    ...
    public fun transfer(arg0: &mut Global, arg1: address, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 6);
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x2::table::contains<address, Shares>(&arg0.shares, v0), 4);
        let v1 = 0x2::table::borrow_mut<address, Shares>(&mut arg0.shares, v0);
        assert!(0x2::table::contains<address, u64>(&v1.holding, arg1), 4);
        let v2 = 0x2::table::borrow_mut<address, u64>(&mut v1.holding, arg1);
        assert!(*v2 >= arg2, 4);
        *v2 = *v2 - arg2;
        change_holding_data(arg0, arg3, arg1, arg2, true, arg4);
        let v3 = 0x2::table::borrow_mut<address, Shares>(&mut arg0.shares, arg1);
        let v4 = &mut v3.holders;
        change_table_value(v4, v0, arg2, false);
        let v5 = &mut v3.holders;
        change_table_value(v5, arg3, arg2, true);
    }
    ...
    public fun get_price(arg0: u64, arg1: u64) : u64 {
        ...
        let v1 = if (arg0 == 0 && arg1 == 1) {
            ...
            (arg0 + arg1 - 1) * (arg0 + arg1) * (2 * (arg0 + arg1 - 1) + 1) / 6
        };
        (v1 - v0) * 10000000
    }
    ...
    public fun is_holder(arg0: &Global, arg1: address, arg2: address) : bool {
        if (!0x2::table::contains<address, Shares>(&arg0.shares, arg2)) {
            return false
        };
        0x2::table::contains<address, u64>(&0x2::table::borrow<address, Shares>(&arg0.shares, arg2).holders, arg1)
    }
    ...
    public fun sell_shares(arg0: &mut Global, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        *v6 = *v6 - arg2;
        v1.supply = v2 - arg2;
        if (*v6 == 0) {
            0x2::table::remove<address, u64>(&mut v1.holders, v0);
        };
