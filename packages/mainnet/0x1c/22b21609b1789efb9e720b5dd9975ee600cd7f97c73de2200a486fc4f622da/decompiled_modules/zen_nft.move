module 0x1c22b21609b1789efb9e720b5dd9975ee600cd7f97c73de2200a486fc4f622da::zen_nft {
    ...
    public fun mint_nft<T0: drop, T1>(arg0: &mut NFTStorage, arg1: &OptionsStorage, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        assert_is_zen_coin<T1>();
        let v0 = 0x2::tx_context::sender(arg3);
        if (arg1.only_airdrop_mint) {
            assert!(0x2::table::contains<address, bool>(&arg0.airdrop, v0), 1);
        };
        assert!(arg1.mint_enabled == true, 1);
        assert!(0x2::coin::value<T1>(&arg2) >= arg1.stage_price, 5);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg2, arg1.escrow_address);
