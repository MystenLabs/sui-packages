module 0x1c90ee34e43a9c4e5da85596c5ff6b75dae2eca1425153db71672e89b2cf61cb::reward7432 {
    struct REWARD7432 has drop {
        dummy_field: bool,
    }

    struct TICKET_7432 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7432(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7432>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7432>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7432, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7432>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7432>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7432>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7432>>(v5, 0x2::tx_context::sender(arg1));
    }
