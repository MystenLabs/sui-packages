module 0x1c8f9597b4f965d28e7c81a7869c48e08db39345a2e0e02203bf1a52e8a9cd6a::plinko {
    ...
    public entry fun play_plinko(arg0: &mut 0x1c8f9597b4f965d28e7c81a7869c48e08db39345a2e0e02203bf1a52e8a9cd6a::house_pool::HousePool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: u8, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 <= 2, 0);
        let v0 = if (arg4 == 8) {
            true
        } else if (arg4 == 12) {
        ...
        let v5 = v1 * v4 / 100;
        let v6 = v5 > v1;
        let v7 = 0x1c8f9597b4f965d28e7c81a7869c48e08db39345a2e0e02203bf1a52e8a9cd6a::house_pool::process_bet(arg0, arg1, v6, v5, b"plinko", arg5);
