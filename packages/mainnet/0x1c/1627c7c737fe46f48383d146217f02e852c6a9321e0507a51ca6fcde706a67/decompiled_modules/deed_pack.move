module 0x1c1627c7c737fe46f48383d146217f02e852c6a9321e0507a51ca6fcde706a67::deed_pack {
    ...
    public(friend) fun burn(arg0: DeedPack, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x1c1627c7c737fe46f48383d146217f02e852c6a9321e0507a51ca6fcde706a67::events::emit_deed_burned(0x2::object::uid_to_address(&v3), v1, v2, arg1, arg2);
    ...
    public(friend) fun mint(arg0: address, arg1: u8, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x1c1627c7c737fe46f48383d146217f02e852c6a9321e0507a51ca6fcde706a67::events::emit_minted(arg0, arg1, arg2);
    }
