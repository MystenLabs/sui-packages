module 0x1c677f88250180c9d087207225e44d5efd193a6c505ed7f9bc4ff8c0aa061855::scagift {
    ...
    public entry fun GiftBoxFromScallop(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SCALLOP_GIFTBOX{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftscacom_0810/giftscacom_0810_2.jpg"),
    ...
    fun init(arg0: SCAGIFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftscacom_0810/giftscacom_0810_2.jpg"));
