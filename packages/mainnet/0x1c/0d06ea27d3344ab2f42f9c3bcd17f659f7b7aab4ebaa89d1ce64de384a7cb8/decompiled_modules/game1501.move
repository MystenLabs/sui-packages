module 0x1c0d06ea27d3344ab2f42f9c3bcd17f659f7b7aab4ebaa89d1ce64de384a7cb8::game1501 {
    struct GAME1501 has drop {
        dummy_field: bool,
    }

    struct TICKET_1501 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1501(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1501>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1501>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME1501, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME1501>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1501>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1501>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1501>>(v5, 0x2::tx_context::sender(arg1));
    }
