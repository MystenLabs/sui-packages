module 0x1c749e8a396f7574cdda4da22623b45ee06782561ffc3847a2a1c63428c9267d::dex_kriya {
    ...
    public fun calculate_min_usdc_output(arg0: u64) : u64 {
        arg0 * 1045 / 1000 * 97 / 100 / 1000
    }

    public fun get_kriya_package() : address {
        0x1c749e8a396f7574cdda4da22623b45ee06782561ffc3847a2a1c63428c9267d::constants::kriya_package()
    }
    ...
    public entry fun prepare_sui_for_kriya_ptb(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg0) == arg1, 5001);
    ...
    public entry fun swap_sui_to_usdc(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = KriyaSwapExecuted{
            ...
            package        : 0x1c749e8a396f7574cdda4da22623b45ee06782561ffc3847a2a1c63428c9267d::constants::kriya_package(),
    ...
    public fun validate_kriya_ptb_params(arg0: u64, arg1: u64, arg2: address) : bool {
        if (arg0 > 0) {
            if (arg1 > 0) {
                arg2 != @0x0
            } else {
