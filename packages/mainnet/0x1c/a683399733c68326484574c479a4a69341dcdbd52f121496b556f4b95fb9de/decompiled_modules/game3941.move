module 0x1ca683399733c68326484574c479a4a69341dcdbd52f121496b556f4b95fb9de::game3941 {
    struct GAME3941 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeTicket3941(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GAME3941, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME3941>(arg0, arg1);
