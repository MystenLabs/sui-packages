module 0x1c9b2e072d7c9d6349a89099784254898b84c7b40a6091a3bc69be4e3c19e618::strategio_testo {
    ...
    fun init(arg0: STRATEGIO_TESTO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v12 = v11;
        let v13 = v10;
        let v14 = vector[b"Alpha", b"Bravo", b"Charlie", b"Delta", b"Echo", b"Foxtrot", b"Golf", b"Hotel", b"India", b"Juliet", b"Kilo", b"Lima", b"Mike", b"November", b"Oscar", b"Papa", b"Quebec", b"Romeo", b"Sierra", b"Tango"];
        ...
        0x2::transfer::public_transfer<0x2::display::Display<StrategioTesto>>(v5, 0x2::tx_context::sender(arg1));
