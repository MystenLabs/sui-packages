module 0x1c403c977daa28146f2d7d957ebe54a8522d0da132e39588d33fefbad1749b80::treecat {
    ...
    fun init(arg0: TREECAT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/Bkwv0_mxn45ZJn_i?width=150&height=150&fit=crop&quality=95&format=auto                                                                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<TREECAT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TREECAT ")))), trim_right(b"Tree stuck in cat               "), trim_right(b"Tree stuck in cat, spreading good vibes across the meta.                                                                                                                                                                                                                                                                        "), v2, arg1);
        let v5 = v3;
