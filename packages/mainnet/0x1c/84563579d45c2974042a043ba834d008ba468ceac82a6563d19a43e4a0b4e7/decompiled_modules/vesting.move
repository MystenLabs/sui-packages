module 0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::vesting {
    ...
    public entry fun acceptAdmin(arg0: &mut AdminCapVault, arg1: &mut 0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::checkVersion(arg1, 1);
        let v0 = *0x1::option::borrow<address>(&arg0.to);
        execTransferAdmin(arg0, v0, arg1, arg2);
    }

    public entry fun addFund<T0>(arg0: &AdminCap, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: &mut Project<T0>, arg4: &mut ProjectRegistry, arg5: &0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::Version) {
        0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::checkVersion(arg5, 1);
        ...
        if (0x2::table::contains<address, vector<address>>(&arg4.user_projects, arg1)) {
            ...
            0x1::vector::push_back<address>(&mut v3, 0x2::object::id_address<Project<T0>>(arg3));
            0x2::table::add<address, vector<address>>(&mut arg4.user_projects, arg1, v3);
        };
    ...
    public entry fun addFunds<T0>(arg0: &AdminCap, arg1: vector<address>, arg2: vector<u64>, arg3: 0x2::coin::Coin<T0>, arg4: &mut Project<T0>, arg5: &mut ProjectRegistry, arg6: &0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::Version, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun claim<T0>(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut Project<T0>, arg2: &0x2::clock::Clock, arg3: &0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::Version, arg4: &mut ProjectRegistry, arg5: &mut 0x2::tx_context::TxContext) {
        0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::checkVersion(arg3, 1);
        ...
        assert!(v2 > 0, 8004);
        let v3 = 0x2::object::id_address<Project<T0>>(arg1);
        let v4 = 0x2::table::borrow_mut<address, Fund<T0>>(&mut arg1.funds, v1);
        assert!(v1 == v4.owner, 8003);
        let v5 = v4.total * v2 / 10000 - v4.released;
        assert!(v5 > 0, 8004);
        arg1.deposited = arg1.deposited - v5;
        arg1.deposited_percent = arg1.deposited * 10000 / arg1.supply;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v4.locked, v5, arg5), v1);
        v4.released = v4.released + v5;
        v4.last_claim_ms = v0;
        if (v4.released == v4.total) {
            let v6 = 0x2::table::borrow_mut<address, vector<address>>(&mut arg4.user_projects, v1);
            let (_, v8) = 0x1::vector::index_of<address>(v6, &v3);
            0x1::vector::remove<address>(v6, v8);
            if (0x1::vector::is_empty<address>(v6)) {
                0x2::table::remove<address, vector<address>>(&mut arg4.user_projects, v1);
            };
        };
        ...
        let v9 = FundClaimEvent{
            owner    : v4.owner,
            project  : 0x2::object::id_address<Project<T0>>(arg1),
            total    : v4.total,
            released : v4.released,
            claim    : v5,
        };
        0x2::event::emit<FundClaimEvent>(v9);
    }
    ...
    public entry fun createProject<T0>(arg0: &AdminCap, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u8, arg6: u64, arg7: u64, arg8: u64, arg9: vector<u64>, arg10: vector<u64>, arg11: &0x2::clock::Clock, arg12: &mut 0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::Version, arg13: u64, arg14: &mut ProjectRegistry, arg15: &mut 0x2::tx_context::TxContext) {
        0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::checkVersion(arg12, 1);
    ...
    fun execTransferAdmin(arg0: &mut AdminCapVault, arg1: address, arg2: &mut 0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::checkVersion(arg2, 1);
    ...
    public entry fun removeFund<T0>(arg0: &AdminCap, arg1: address, arg2: &mut Project<T0>, arg3: &mut ProjectRegistry, arg4: &0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::Version) {
        0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::checkVersion(arg4, 1);
    ...
    public entry fun removeFunds<T0>(arg0: &AdminCap, arg1: vector<address>, arg2: &mut Project<T0>, arg3: &mut ProjectRegistry, arg4: &0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::Version) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg1)) {
            removeFund<T0>(arg0, *0x1::vector::borrow<address>(&arg1, v0), arg2, arg3, arg4);
            v0 = v0 + 1;
        };
    }

    public entry fun revokeAdmin(arg0: &mut AdminCapVault, arg1: &mut 0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::checkVersion(arg1, 1);
    ...
    public entry fun transferAdmin(arg0: AdminCap, arg1: address, arg2: &mut AdminCapVault, arg3: &mut 0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x1c84563579d45c2974042a043ba834d008ba468ceac82a6563d19a43e4a0b4e7::version::checkVersion(arg3, 1);
