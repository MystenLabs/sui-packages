module 0x1c8b46ff2b80e84777d90e194870f92d6c7d1147cb2e4f02636553a836576b38::ika_fork {
    ...
    fun init(arg0: IKA_FORK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<IKA_FORK>>(0x2::coin::mint<IKA_FORK>(&mut v2, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
