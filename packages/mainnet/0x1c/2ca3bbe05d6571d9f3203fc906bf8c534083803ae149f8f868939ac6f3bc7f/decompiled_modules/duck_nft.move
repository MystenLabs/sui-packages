module 0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::duck_nft {
    ...
    struct CooldownRecalculated has copy, drop {
        old_end_time: u64,
        new_end_time: u64,
        duration_used: u64,
    }
    ...
    public entry fun admin_create_v2_prices(arg0: &AdminCap, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = PackPricesV2{
            id                  : 0x2::object::new(arg7),
            basic_egg_sht_cost  : arg1,
            basic_egg_sui_cost  : arg2,
            rare_egg_sht_cost   : arg3,
            rare_egg_sui_cost   : arg4,
            golden_egg_sht_cost : arg5,
            golden_egg_sui_cost : arg6,
        };
        0x2::transfer::share_object<PackPricesV2>(v0);
    }

    public entry fun admin_recalculate_cooldown(arg0: &AdminCap, arg1: &mut PackSupply) {
        assert!(arg1.in_cooldown, 24);
        ...
        arg1.cooldown_end_time = arg1.last_sellout_time + v0;
        let v1 = CooldownRecalculated{
            old_end_time  : arg1.cooldown_end_time,
            new_end_time  : arg1.cooldown_end_time,
            duration_used : v0,
        };
        0x2::event::emit<CooldownRecalculated>(v1);
    }
    ...
    public entry fun admin_update_v2_basic_price(arg0: &AdminCap, arg1: &mut PackPricesV2, arg2: u64, arg3: u64) {
        arg1.basic_egg_sht_cost = arg2;
        arg1.basic_egg_sui_cost = arg3;
    }

    public entry fun admin_update_v2_golden_price(arg0: &AdminCap, arg1: &mut PackPricesV2, arg2: u64, arg3: u64) {
        arg1.golden_egg_sht_cost = arg2;
        arg1.golden_egg_sui_cost = arg3;
    }

    public entry fun admin_update_v2_rare_price(arg0: &AdminCap, arg1: &mut PackPricesV2, arg2: u64, arg3: u64) {
        arg1.rare_egg_sht_cost = arg2;
        arg1.rare_egg_sui_cost = arg3;
    }
    ...
    fun apply_genesis_purchase(arg0: &mut PackSupply, arg1: &Whitelist, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        if (arg0.whitelist_phase_active) {
            if (v0 >= arg0.genesis_batch_start_time + 21600000) {
    ...
    fun create_duck_nft(arg0: u8, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : DuckNFT {
        let v0 = 0x1::string::utf8(b"218ahwduh #");
    ...
    fun enforce_public_rate_limit(arg0: &mut PackSupply, arg1: bool, arg2: address, arg3: u64, arg4: u64) {
        if (!arg1) {
            ...
            if (0x2::table::contains<address, u64>(&arg0.user_last_purchase_time, arg2)) {
                assert!(arg4 - *0x2::table::borrow<address, u64>(&arg0.user_last_purchase_time, arg2) >= 5000, 17);
            };
            if (0x2::table::contains<address, u64>(&arg0.user_last_purchase_time, arg2)) {
    ...
    public fun get_image_url(arg0: &DuckNFT) : 0x1::string::String {
        arg0.image_url
    }
    ...
    public fun get_v2_prices(arg0: &PackPricesV2) : (u64, u64, u64, u64, u64, u64) {
        (arg0.basic_egg_sht_cost, arg0.basic_egg_sui_cost, arg0.rare_egg_sht_cost, arg0.rare_egg_sui_cost, arg0.golden_egg_sht_cost, arg0.golden_egg_sui_cost)
    }
    ...
    public entry fun hatch_basic_egg(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SharedTreasury, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg12: 0x2::coin::Coin<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>, arg13: 0x2::coin::Coin<0x2::sui::SUI>, arg14: u64, arg15: &0x2::random::Random, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v3 * arg14;
        let v6 = v4 * arg14;
        assert!(0x2::coin::value<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&arg12) >= v5, 1);
        ...
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&mut arg12, v5, arg17);
        0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::burn(arg8, 0x2::coin::split<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&mut v9, v7, arg17));
        ...
        if (0x1::option::is_some<address>(&v2)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>>(0x2::coin::split<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&mut v9, v8, arg17), v10);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>>(0x2::coin::split<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&mut v9, v8, arg17), arg4.treasury_wallet);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>>(v9, arg4.treasury_wallet);
        if (0x2::coin::value<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&arg12) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>>(arg12, 0x2::tx_context::sender(arg17));
        } else {
            0x2::coin::destroy_zero<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(arg12);
        };
    ...
    entry fun hatch_basic_egg_v2(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SharedTreasury, arg9: &PackPricesV2, arg10: &mut 0x2::kiosk::Kiosk, arg11: &0x2::kiosk::KioskOwnerCap, arg12: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg13: 0x2::coin::Coin<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>, arg14: 0x2::coin::Coin<0x2::sui::SUI>, arg15: u64, arg16: &0x2::random::Random, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg17);
        let v1 = 0x2::tx_context::sender(arg18);
        let v2 = get_referrer(arg5, v1);
        assert!(arg1.start_time > 0 && v0 >= arg1.start_time, 5);
        assert!(!arg1.is_genesis_batch, 12);
        check_and_start_new_batch_if_ready(arg1, arg2, arg17);
        assert!(!arg1.in_cooldown, 13);
        enforce_public_rate_limit(arg1, false, v1, arg15, v0);
        assert!(arg1.total_packs_remaining >= arg15, 3);
        if (arg2.max_basic_per_batch > 0) {
            assert!(arg2.basic_packs_remaining >= arg15, 18);
        };
        assert!(arg1.total_nfts_minted_globally + arg15 <= 5555, 14);
        let v3 = arg9.basic_egg_sht_cost;
        let v4 = arg9.basic_egg_sui_cost;
        let v5 = v3 * arg15;
        let v6 = v4 * arg15;
        assert!(0x2::coin::value<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&arg13) >= v5, 1);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg14) >= v6, 2);
        arg1.total_packs_remaining = arg1.total_packs_remaining - arg15;
        if (arg2.max_basic_per_batch > 0) {
            arg2.basic_packs_remaining = arg2.basic_packs_remaining - arg15;
        };
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&mut arg13, v5, arg18);
        0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::burn(arg8, 0x2::coin::split<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&mut v9, v7, arg18));
        update_burn_stats(arg6, v7, arg17);
        update_user_pack_stats(arg7, v1, v7, arg15, arg17);
        if (0x1::option::is_some<address>(&v2)) {
            let v10 = *0x1::option::borrow<address>(&v2);
            assert!(v10 != v1, 9);
            let v11 = ReferralReward{
            ...
            0x2::event::emit<ReferralReward>(v11);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>>(0x2::coin::split<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&mut v9, v8, arg18), v10);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>>(0x2::coin::split<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&mut v9, v8, arg18), arg4.treasury_wallet);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>>(v9, arg4.treasury_wallet);
        if (0x2::coin::value<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&arg13) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>>(arg13, 0x2::tx_context::sender(arg18));
        } else {
            0x2::coin::destroy_zero<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(arg13);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg14, v6, arg18), arg4.treasury_wallet);
        if (0x2::coin::value<0x2::sui::SUI>(&arg14) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg14, 0x2::tx_context::sender(arg18));
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(arg14);
        };
        let v12 = 0;
        while (v12 < arg15) {
            let v13 = roll_basic_egg_rarity(arg16, arg18);
            let v14 = create_duck_nft(v13, arg1.current_batch_number, arg1.total_nfts_minted_globally + v12 + 1, arg17, arg18);
            update_rarity_stats(arg6, v13);
            let v15 = PackPurchased{
                pack_type       : 0,
            ...
            0x2::event::emit<PackPurchased>(v15);
            0x2::kiosk::lock<DuckNFT>(arg10, arg11, arg12, v14);
            v12 = v12 + 1;
        };
        arg1.total_nfts_minted_globally = arg1.total_nfts_minted_globally + arg15;
        check_genesis_batch_completion(arg1, arg17);
        if (!arg1.is_genesis_batch) {
            start_cooldown_if_sold_out(arg1, arg2, arg17);
        };
    }
    ...
    entry fun hatch_golden_egg_v2(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SharedTreasury, arg9: &PackPricesV2, arg10: &mut 0x2::kiosk::Kiosk, arg11: &0x2::kiosk::KioskOwnerCap, arg12: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg13: 0x2::coin::Coin<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>, arg14: 0x2::coin::Coin<0x2::sui::SUI>, arg15: u64, arg16: &0x2::random::Random, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg17);
        let v1 = 0x2::tx_context::sender(arg18);
        let v2 = get_referrer(arg5, v1);
        assert!(arg1.start_time > 0 && v0 >= arg1.start_time, 5);
        ...
        assert!(arg1.total_packs_remaining >= arg15, 3);
        if (arg2.max_golden_per_batch > 0) {
            assert!(arg2.golden_packs_remaining >= arg15, 18);
        };
        assert!(arg1.total_nfts_minted_globally + arg15 <= 5555, 14);
        let v3 = arg9.golden_egg_sht_cost;
        let v4 = arg9.golden_egg_sui_cost;
        let v5 = v3 * arg15;
        let v6 = v4 * arg15;
        assert!(0x2::coin::value<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&arg13) >= v5, 1);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg14) >= v6, 2);
        arg1.total_packs_remaining = arg1.total_packs_remaining - arg15;
        if (arg2.max_golden_per_batch > 0) {
            arg2.golden_packs_remaining = arg2.golden_packs_remaining - arg15;
        };
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&mut arg13, v5, arg18);
        ...
        let v12 = 0;
        while (v12 < arg15) {
            let v13 = roll_golden_egg_rarity(arg16, arg18);
            let v14 = create_duck_nft(v13, arg1.current_batch_number, arg1.total_nfts_minted_globally + v12 + 1, arg17, arg18);
            update_rarity_stats(arg6, v13);
            let v15 = PackPurchased{
                pack_type       : 2,
    ...
    entry fun hatch_rare_egg_v2(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SharedTreasury, arg9: &PackPricesV2, arg10: &mut 0x2::kiosk::Kiosk, arg11: &0x2::kiosk::KioskOwnerCap, arg12: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg13: 0x2::coin::Coin<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>, arg14: 0x2::coin::Coin<0x2::sui::SUI>, arg15: u64, arg16: &0x2::random::Random, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg17);
        let v1 = 0x2::tx_context::sender(arg18);
        let v2 = get_referrer(arg5, v1);
        assert!(arg1.start_time > 0 && v0 >= arg1.start_time, 5);
        ...
        assert!(arg1.total_packs_remaining >= arg15, 3);
        if (arg2.max_rare_per_batch > 0) {
            assert!(arg2.rare_packs_remaining >= arg15, 18);
        };
        assert!(arg1.total_nfts_minted_globally + arg15 <= 5555, 14);
        let v3 = arg9.rare_egg_sht_cost;
        let v4 = arg9.rare_egg_sui_cost;
        let v5 = v3 * arg15;
        let v6 = v4 * arg15;
        assert!(0x2::coin::value<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&arg13) >= v5, 1);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg14) >= v6, 2);
        arg1.total_packs_remaining = arg1.total_packs_remaining - arg15;
        if (arg2.max_rare_per_batch > 0) {
            arg2.rare_packs_remaining = arg2.rare_packs_remaining - arg15;
        };
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0x3be342c3384de5abc4afe82af388eb5dd6c2b385a0b5f5cc5a6011f6e2431ae4::shttoken::SHTTOKEN>(&mut arg13, v5, arg18);
        ...
        let v12 = 0;
        while (v12 < arg15) {
            let v13 = roll_rare_egg_rarity(arg16, arg18);
            let v14 = create_duck_nft(v13, arg1.current_batch_number, arg1.total_nfts_minted_globally + v12 + 1, arg17, arg18);
            update_rarity_stats(arg6, v13);
            let v15 = PackPurchased{
                pack_type       : 1,
    ...
    fun init(arg0: DUCK_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = PackSupply{
            ...
            last_refresh_time                 : 0,
            start_time                        : 0,
            basic_egg_sht_cost                : 7000000000000,
            basic_egg_sui_cost                : 2000000000,
            rare_egg_sht_cost                 : 15000000000000,
            rare_egg_sui_cost                 : 6000000000,
            golden_egg_sht_cost               : 25000000000000,
            golden_egg_sui_cost               : 12000000000,
            genesis_whitelist_basic_sui_cost  : 2000000000,
            genesis_whitelist_rare_sui_cost   : 6000000000,
            genesis_whitelist_golden_sui_cost : 12000000000,
            genesis_public_basic_sui_cost     : 2000000000,
            genesis_public_rare_sui_cost      : 6000000000,
            genesis_public_golden_sui_cost    : 12000000000,
    ...
    public(friend) fun update_death_attributes(arg0: &mut DuckNFT, arg1: bool, arg2: u8) {
        let v0 = 0x1::string::utf8(b"Status");
        let v1 = if (arg1) {
            0x1::string::utf8(b"Dead")
        } else {
            0x1::string::utf8(b"Alive")
        };
        ...
        let v4 = 0x1::string::utf8(b"Bones");
        let v5 = if (arg2 == 0) {
            0x1::string::utf8(b"0")
        } else if (arg2 == 1) {
            0x1::string::utf8(b"1")
        ...
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&arg0.attributes, &v4)) {
            let (_, _) = 0x2::vec_map::remove<0x1::string::String, 0x1::string::String>(&mut arg0.attributes, &v4);
        };
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut arg0.attributes, v4, v5);
    }
    ...
    public(friend) fun update_image_url(arg0: &mut DuckNFT, arg1: 0x1::string::String) {
        arg0.image_url = arg1;
    }
    ...
    fun validate_genesis_purchase(arg0: &PackSupply, arg1: &Whitelist, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        if (arg0.whitelist_phase_active && !(0x2::clock::timestamp_ms(arg4) >= arg0.genesis_batch_start_time + 21600000)) {
    ...
    fun validate_public_rate_limit(arg0: &PackSupply, arg1: address, arg2: u64, arg3: u64) {
        assert!(arg2 <= 5, 16);
        if (0x2::table::contains<address, u64>(&arg0.user_last_purchase_time, arg1)) {
            assert!(arg3 - *0x2::table::borrow<address, u64>(&arg0.user_last_purchase_time, arg1) >= 5000, 17);
        };
    }
