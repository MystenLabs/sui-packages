module 0x1c6f6fe790ac9ff5a48a029ecf5793df5e4e3f4e91c01d4f65ca127a77bbd719::one {
    struct ONE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ONE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<ONE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"ONE     ")))), trim_right(b"ONE                             "), trim_right(b"ONEONEONEONE                                                                                                                                                                                                                                                                                                                    "), v2, arg1);
