module 0x1ce8e6d6b02b67e871cce3c0080bdda7d6f1f6394d438c1ab1f4e66d257c86dc::make_cdls_great_again {
    struct MAKE_CDLS_GREAT_AGAIN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MAKE_CDLS_GREAT_AGAIN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MAKE_CDLS_GREAT_AGAIN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Make CDLs Great Again"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Buy this NFT, do not be the guy doing U-turns on the Interstate. Lets send them home!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeia7evd4z6u6tj2vlyc42j6doi3ca2ircgd34n6esetav4eo5fft5q"));
