module 0x1c79e6f8d71e3b76065a4efd1f1159145fbae060db19af4bcf24bc19c31f5d00::reward3444 {
    struct REWARD3444 has drop {
        dummy_field: bool,
    }

    struct TICKET_3444 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3444(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3444>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3444>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3444, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3444>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3444>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3444>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3444>>(v5, 0x2::tx_context::sender(arg1));
    }
