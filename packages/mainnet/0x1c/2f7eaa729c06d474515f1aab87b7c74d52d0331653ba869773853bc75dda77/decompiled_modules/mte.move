module 0x1c2f7eaa729c06d474515f1aab87b7c74d52d0331653ba869773853bc75dda77::mte {
    struct EE has copy, drop {
        e: u64,
        l: u64,
    }

    fun opt<T0, T1>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: bool, arg2: u128, arg3: u128, arg4: u64, arg5: u64, arg6: u8, arg7: u8, arg8: u64) : u64 {
        assert!(arg4 > 0, 13906834603840307204);
        assert!(arg4 <= arg5, 13906834608135405574);
        assert!(arg8 < arg4, 13906834612430503944);
        let v0 = 0;
        let v1 = 0;
        let v2 = arg4;
        let v3 = 0;
        while (v3 < arg6) {
            ...
            let (v4, v5, v6) = sms<T0, T1>(arg0, v2, arg1, arg2);
            if (v6) {
                break
            };
            if (!pok(v5, arg3, arg1)) {
        ...
        while (v3 < arg7) {
            ...
            let v7 = (v1 + v2) / 2;
            let (v8, v9, v10) = sms<T0, T1>(arg0, v7, arg1, arg2);
    ...
    fun tt<T0, T1>(arg0: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: &mut 0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg4: &0x2::clock::Clock, arg5: u128, arg6: bool, arg7: u64, arg8: u64, arg9: u8, arg10: u8, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v5 = !arg6;
        let (v6, v7, v8) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::flash_swap<T0, T1>(arg0, v5, true, v4, arg5, arg4, arg3, arg12);
        let v9 = v8;
        let v10 = v7;
        let v11 = v6;
        ...
        assert!(v15 >= v16, 13906835368344354818);
        let (v17, v18) = if (v5) {
            (0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::wd<T0>(arg1, arg2, v12, arg12), 0x2::coin::zero<T1>(arg12))
        } else {
            (0x2::coin::zero<T0>(arg12), 0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::wd<T1>(arg1, arg2, v13, arg12))
        };
        let v19 = v18;
        let v20 = v17;
        let (v21, v22) = if (v5) {
            (0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v20, v12, arg12)), 0x2::balance::zero<T1>())
        } else {
            (0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v19, v13, arg12)))
        };
        0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::repay_flash_swap<T0, T1>(arg0, v9, v21, v22, arg3, arg12);
