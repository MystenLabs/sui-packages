module 0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::liquidity_lock_v1 {
    ...
    public fun lock_position<T0, T1>(arg0: &0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::config::GlobalConfig, arg1: &mut 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::rewarder::RewarderGlobalVault, arg2: &mut Locker, arg3: &mut 0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::pool_tranche::PoolTrancheManager, arg4: &mut 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::pool::Pool<T0, T1>, arg5: 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::position::Position, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : vector<LockedPosition<T0, T1>> {
        ...
        let v2 = 0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::time_manager::epoch_next(v1 + 0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::time_manager::epoch_to_seconds(*0x1::vector::borrow<u64>(&arg2.periods_blocking, arg6)));
        let v3 = 0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::pool_tranche::get_tranches(arg3, 0x2::object::id<0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::pool::Pool<T0, T1>>(arg4));
        assert!(0x1::vector::length<0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::pool_tranche::PoolTranche>(v3) > 0, 9823742374723842);
        let v4 = 0x1::vector::empty<LockedPosition<T0, T1>>();
        let v5 = v0;
        let v6 = 0;
        while (v6 < 0x1::vector::length<0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::pool_tranche::PoolTranche>(v3)) {
            let v7 = 0x1::vector::borrow_mut<0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::pool_tranche::PoolTranche>(v3, v6);
            ...
            let v11 = if (v10) {
                0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::locker_utils::calculate_position_liquidity_in_token_a<T0, T1>(arg4, v5)
            } else {
                0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::locker_utils::calculate_position_liquidity_in_token_b<T0, T1>(arg4, v5)
            };
            let (v12, v13, v14, v15, v16) = if (v11 > v9) {
                let v17 = &mut arg5;
                let (v18, v19, v20, v21, v22) = split_position_internal<T0, T1>(arg0, arg1, arg4, v17, (0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::full_math_u128::mul_div_floor(v9, (0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::consts::lock_liquidity_share_denom() as u128), v11) as u64), arg7, arg8);
                let v23 = v19;
                let v24 = v18;
                v5 = v23.position_id;
            ...
            let v26 = LockedPosition<T0, T1>{
                ...
                start_lock_time           : v1,
                expiration_time           : v2,
                full_unlocking_time       : v2 + 0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::time_manager::epoch_to_seconds(*0x1::vector::borrow<u64>(&arg2.periods_post_lockdown, arg6)),
            ...
            let v28 = v6 + 1;
            v6 = v28;
            assert!(v28 < 0x1::vector::length<0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::pool_tranche::PoolTranche>(v3) || v5 == v12, 92035925692467234);
        };
    ...
    public fun remove_lock_liquidity<T0, T1>(arg0: &0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::config::GlobalConfig, arg1: &mut 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::rewarder::RewarderGlobalVault, arg2: &mut Locker, arg3: &mut 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::pool::Pool<T0, T1>, arg4: LockedPosition<T0, T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let v2 = if (v1) {
            ...
            let v3 = 0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::time_manager::number_epochs_in_timestamp(v0 - arg4.lock_liquidity_info.last_remove_liquidity_time);
            assert!(v3 > 0, 91877547573637423);
            0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::full_math_u128::mul_div_floor(arg4.lock_liquidity_info.total_lock_liquidity, (v3 as u128), (0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::time_manager::number_epochs_in_timestamp(arg4.full_unlocking_time - arg4.expiration_time) as u128))
        };
        let v4 = v2;
        ...
        if (v1) {
            ...
            arg4.lock_liquidity_info.last_remove_liquidity_time = 0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::time_manager::epoch_start(v0);
    ...
    public fun split_position<T0, T1>(arg0: &0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::config::GlobalConfig, arg1: &mut 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::rewarder::RewarderGlobalVault, arg2: &mut Locker, arg3: &mut 0x13ee70242d830af3a16756a875f7333fa023382d48be503b2ad9b7358ed2b7ee::pool::Pool<T0, T1>, arg4: LockedPosition<T0, T1>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (LockedPosition<T0, T1>, LockedPosition<T0, T1>) {
        ...
        assert!(arg5 <= 0x6c94079ee8ef1e9b29c73c95b13083193a00cd819baa436812631b932cc18d9::consts::lock_liquidity_share_denom() && arg5 > 0, 902354235823942382);
