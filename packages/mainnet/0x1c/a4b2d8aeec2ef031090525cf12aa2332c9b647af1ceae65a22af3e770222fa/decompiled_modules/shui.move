module 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui {
    ...
    struct Inscription has key {
        ...
        avatar: 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::avatar::Avatar,
        race: 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::race::Race,
        level: 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::level::Level,
        gift: 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::gift::Gift,
    }
    ...
    public entry fun change_gift(arg0: &mut Inscription, arg1: 0x1::string::String) {
        arg0.gift = 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::gift::new_gift(arg1);
    }
    ...
    public(friend) fun extract_airdrop_balance(arg0: &mut Global, arg1: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<SHUI> {
        ...
        0x2::balance::split<SHUI>(&mut arg0.balance_SHUI, (207000000 + 240000000) * 1000000000)
    }
    ...
    public(friend) fun extract_mission_reserve_balance(arg0: &mut Global, arg1: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<SHUI> {
        assert!(0x2::tx_context::sender(arg1) == arg0.creator, 4);
        0x2::balance::split<SHUI>(&mut arg0.balance_SHUI, 82000000 * 1000000000)
    }

    public(friend) fun extract_swap_balance(arg0: &mut Global, arg1: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<SHUI> {
        assert!(0x2::tx_context::sender(arg1) == arg0.creator, 4);
        0x2::balance::split<SHUI>(&mut arg0.balance_SHUI, (100000000 + 200000000 + 200000000) * 1000000000)
    }
    ...
    public fun new_empty_charactor(arg0: &mut 0x2::tx_context::TxContext) : Inscription {
        Inscription{
            ...
            avatar : 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::avatar::none(),
            race   : 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::race::none(),
            level  : 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::level::new_level(),
            gift   : 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::gift::none(),
        }
    }
