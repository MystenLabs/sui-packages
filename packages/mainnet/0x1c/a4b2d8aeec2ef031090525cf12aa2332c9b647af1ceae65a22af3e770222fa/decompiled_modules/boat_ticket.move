module 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::boat_ticket {
    ...
    public entry fun buy_ticket(arg0: &mut BoatTicketGlobal, arg1: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 25;
        let v1 = 0x1::vector::pop_back<0x2::coin::Coin<0x2::sui::SUI>>(&mut arg1);
        assert!(arg0.num < 4000, 6);
        0x2::pay::join_vec<0x2::sui::SUI>(&mut v1, arg1);
        assert!(0x2::coin::value<0x2::sui::SUI>(&v1) >= v0 * 1000000000, 4);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance_SUI, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v1, v0 * 1000000000, arg2)));
    ...
    public fun get_is_ticket_claimed(arg0: &BoatTicket) : u64 {
        if (arg0.whitelist_claimed) {
            1
        } else {
            0
        }
    ...
    fun init(arg0: BOAT_TICKET, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://bafybeibym77qxeq724kkqnkq2mz2i63e423ppjxgwnfcnqmhbh65qbvueu.ipfs.nftstorage.link/ship_card.png"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://shui.game/"));
