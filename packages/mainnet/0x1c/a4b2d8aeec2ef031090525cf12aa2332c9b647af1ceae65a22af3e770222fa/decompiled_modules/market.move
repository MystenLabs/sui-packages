module 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::market {
    ...
    public entry fun list_game_item(arg0: &mut MarketGlobal, arg1: &mut 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::MetaIdentity, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::tree_of_life::extract_drop_items(arg1, arg2, arg4);
        let v0 = &mut arg0.game_sales;
        let v1 = 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::getMetaId(arg1);
    ...
    public entry fun list_nft_item<T0: store + key>(arg0: &mut MarketGlobal, arg1: &mut 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::MetaIdentity, arg2: 0x1::string::String, arg3: u64, arg4: 0x1::string::String, arg5: &0x2::clock::Clock, arg6: T0, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        let v0 = &mut arg0.game_sales;
        let v1 = 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::getMetaId(arg1);
        ...
        if (0x2::linked_table::contains<u64, vector<OnSale>>(v0, v1)) {
            let v2 = 0x2::linked_table::borrow_mut<u64, vector<OnSale>>(v0, v1);
            assert!(0x1::vector::length<OnSale>(v2) <= 10, 4);
            0x1::vector::push_back<OnSale>(v2, new_nft_sale<T0>(0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::getMetaId(arg1), arg2, arg3, arg4, arg5, 0x1::string::utf8(b"nft"), arg6, arg7));
        } else {
            let v3 = 0x1::vector::empty<OnSale>();
            0x1::vector::push_back<OnSale>(&mut v3, new_nft_sale<T0>(0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::getMetaId(arg1), arg2, arg3, arg4, arg5, 0x1::string::utf8(b"nft"), arg6, arg7));
            0x2::linked_table::push_back<u64, vector<OnSale>>(v0, v1, v3);
        };
    }
    ...
    public entry fun purchase_game_item_shui(arg0: &mut MarketGlobal, arg1: &mut 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::market_right::MarketRightGlobal, arg2: &mut 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::MetaIdentity, arg3: u64, arg4: 0x1::string::String, arg5: u64, arg6: vector<0x2::coin::Coin<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        let v0 = merge_coins<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(arg6, arg8);
        ...
        while (v2 < 0x1::vector::length<OnSale>(v1)) {
            ...
            if (v3.name == arg4 && v3.num == arg5 && v3.price <= 0x2::coin::value<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(&v0)) {
                let OnSale {
                    id          : v4,
                    name        : v5,
                    num         : v6,
                ...
                0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::market_right::into_gas_pool_game_SHUI(arg1, 0x2::coin::into_balance<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(0x2::coin::split<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(&mut v0, v7 / 1000, arg8)));
                0x2::transfer::public_transfer<0x2::coin::Coin<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>>(0x2::coin::split<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(&mut v0, v7 * 999 / 1000, arg8), v9);
                0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::tree_of_life::fill_items(arg2, v5, v6);
                break
            };
            v2 = v2 + 1;
        };
        if (0x2::coin::value<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(&v0) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>>(v0, 0x2::tx_context::sender(arg8));
        } else {
            0x2::coin::destroy_zero<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(v0);
        };
    }

    public entry fun purchase_game_item_sui(arg0: &mut MarketGlobal, arg1: &mut 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::market_right::MarketRightGlobal, arg2: &mut 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::MetaIdentity, arg3: u64, arg4: 0x1::string::String, arg5: u64, arg6: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        ...
        while (v2 < 0x1::vector::length<OnSale>(v1)) {
            ...
            if (v3.name == arg4 && v3.num == arg5 && v3.price <= 0x2::coin::value<0x2::sui::SUI>(&v0)) {
                ...
                0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::market_right::into_gas_pool_game_SUI(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v7 / 1000, arg8)));
    ...
    public entry fun purchase_nft_item_shui<T0: store + key>(arg0: &mut MarketGlobal, arg1: &mut 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::market_right::MarketRightGlobal, arg2: &mut 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::MetaIdentity, arg3: u64, arg4: 0x1::string::String, arg5: u64, arg6: vector<0x2::coin::Coin<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        assert!(arg3 != 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::getMetaId(arg2), 6);
        let v0 = merge_coins<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(arg6, arg8);
        assert!(0x2::linked_table::contains<u64, vector<OnSale>>(&arg0.game_sales, arg3), 2);
        let v1 = 0x2::linked_table::borrow_mut<u64, vector<OnSale>>(&mut arg0.game_sales, arg3);
        let v2 = 0;
        while (v2 < 0x1::vector::length<OnSale>(v1)) {
            ...
            if (v3.name == arg4 && v3.num == arg5 && v3.price <= 0x2::coin::value<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(&v0)) {
                ...
                0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::market_right::into_gas_pool_nft_SHUI(arg1, 0x2::coin::into_balance<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(0x2::coin::split<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(&mut v0, v7 * 5 / 1000, arg8)));
                0x2::transfer::public_transfer<0x2::coin::Coin<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>>(0x2::coin::split<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(&mut v0, v7 * 995 / 1000, arg8), v9);
                break
            };
            v2 = v2 + 1;
        };
    ...
    public entry fun purchase_nft_item_sui<T0: store + key>(arg0: &mut MarketGlobal, arg1: &mut 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::market_right::MarketRightGlobal, arg2: &mut 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::MetaIdentity, arg3: u64, arg4: 0x1::string::String, arg5: u64, arg6: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        assert!(arg3 != 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::getMetaId(arg2), 6);
        let v0 = merge_coins<0x2::sui::SUI>(arg6, arg8);
        assert!(0x2::linked_table::contains<u64, vector<OnSale>>(&arg0.game_sales, arg3), 2);
        ...
        while (v2 < 0x1::vector::length<OnSale>(v1)) {
            ...
            if (v3.name == arg4 && v3.num == arg5 && v3.price <= 0x2::coin::value<0x2::sui::SUI>(&v0)) {
                ...
                0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::market_right::into_gas_pool_nft_SUI(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v7 / 1000, arg8)));
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v7 * 999 / 1000, arg8), v9);
                break
            };
            v2 = v2 + 1;
    ...
    public entry fun unlist_game_item(arg0: &mut MarketGlobal, arg1: &mut 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::MetaIdentity, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        let v0 = 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::getMetaId(arg1);
        ...
        while (v2 < 0x1::vector::length<OnSale>(v1)) {
            ...
            if (v3.name == arg2 && v3.num == arg3 && v3.price == arg4) {
                ...
                0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::tree_of_life::fill_items(arg1, arg2, arg3);
                break
            };
            v2 = v2 + 1;
        };
    ...
    public entry fun unlist_nft_item<T0: store + key>(arg0: &mut MarketGlobal, arg1: &mut 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::MetaIdentity, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        let v0 = 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::metaIdentity::getMetaId(arg1);
        assert!(0x2::linked_table::contains<u64, vector<OnSale>>(&arg0.game_sales, v0), 2);
        let v1 = 0x2::linked_table::borrow_mut<u64, vector<OnSale>>(&mut arg0.game_sales, v0);
