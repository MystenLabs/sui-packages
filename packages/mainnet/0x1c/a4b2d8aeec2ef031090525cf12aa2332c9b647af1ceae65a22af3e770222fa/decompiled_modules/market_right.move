module 0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::market_right {
    ...
    struct MarketRightGlobal has key {
        ...
        balance_game_SHUI: 0x2::balance::Balance<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>,
        balance_game_SUI: 0x2::balance::Balance<0x2::sui::SUI>,
        balance_nft_SHUI: 0x2::balance::Balance<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>,
    ...
    fun init(arg0: MARKET_RIGHT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = MarketRightGlobal{
            ...
            culmulate_nft_SUI   : 0,
            balance_game_SHUI   : 0x2::balance::zero<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(),
            balance_game_SUI    : 0x2::balance::zero<0x2::sui::SUI>(),
            balance_nft_SHUI    : 0x2::balance::zero<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(),
        ...
        0x1::vector::push_back<0x1::string::String>(v26, 0x1::string::utf8(b"https://bafybeibym77qxeq724kkqnkq2mz2i63e423ppjxgwnfcnqmhbh65qbvueu.ipfs.nftstorage.link/nft-token.jpg"));
        0x1::vector::push_back<0x1::string::String>(v26, 0x1::string::utf8(b"https://shui.game/"));
    ...
    public(friend) fun into_gas_pool_game_SHUI(arg0: &mut MarketRightGlobal, arg1: 0x2::balance::Balance<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>) {
        arg0.culmulate_game_SHUI = arg0.culmulate_game_SHUI + 0x2::balance::value<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(&arg1);
        0x2::balance::join<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(&mut arg0.balance_game_SHUI, arg1);
    }
    ...
    public(friend) fun into_gas_pool_nft_SHUI(arg0: &mut MarketRightGlobal, arg1: 0x2::balance::Balance<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>) {
        arg0.culmulate_nft_SHUI = arg0.culmulate_nft_SHUI + 0x2::balance::value<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(&arg1);
        0x2::balance::join<0x1ca4b2d8aeec2ef031090525cf12aa2332c9b647af1ceae65a22af3e770222fa::shui::SHUI>(&mut arg0.balance_nft_SHUI, arg1);
    }
