module 0x1c84021fb031a4a0d00f9e49db2040325f9dc03764ec9d6c991c60bd14c6594b::_o_s_h_i__coin {
    struct _O_S_H_I__COIN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let v0 = if (b"https://dxzj0lxt4bkn6mwx.public.blob.vercel-storage.com/dailydicerollcoin-fX4jpJp1i8Vy5RqvUEhIUekajcxwWQ.png" == b"") {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://dxzj0lxt4bkn6mwx.public.blob.vercel-storage.com/dailydicerollcoin-fX4jpJp1i8Vy5RqvUEhIUekajcxwWQ.png"))
        };
