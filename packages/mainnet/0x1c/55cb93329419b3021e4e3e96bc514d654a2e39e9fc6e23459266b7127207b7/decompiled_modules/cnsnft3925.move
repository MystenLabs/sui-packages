module 0x1c55cb93329419b3021e4e3e96bc514d654a2e39e9fc6e23459266b7127207b7::cnsnft3925 {
    struct CNSNFT3925 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3925, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3925>(arg0, arg1);
