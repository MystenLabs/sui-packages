module 0x1cb3a1f2573ef130baf23053c872da0a73bcba1f3540599a1a806adc2b301bec::btctrump {
    ...
    fun init(arg0: BTCTRUMP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/2fUsWXftAQtqnKXartS2XXzYeFQYdiT1CRSdUgePJw7h.png?size=lg&key=456408                                                                                                                                                                                                            ");
