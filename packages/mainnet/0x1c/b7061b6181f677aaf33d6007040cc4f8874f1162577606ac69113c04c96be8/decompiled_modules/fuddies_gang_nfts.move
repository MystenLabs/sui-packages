module 0x1cb7061b6181f677aaf33d6007040cc4f8874f1162577606ac69113c04c96be8::fuddies_gang_nfts {
    ...
    fun mint_internal(arg0: &mut Config, arg1: address, arg2: Metadata, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1::string::utf8(b"Fuddies Gangster #");
        0x1::string::append(&mut v2, 0x1::u64::to_string(arg0.total_supply));
        let v3 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Rarity"), v1);
        let v4 = FuddiesGangster{
            id          : 0x2::object::new(arg3),
            name        : v2,
            image_url   : v0,
            description : 0x1::string::utf8(b"AI NFT Collection & Meme coin on $SUI"),
            attributes  : v3,
        };
