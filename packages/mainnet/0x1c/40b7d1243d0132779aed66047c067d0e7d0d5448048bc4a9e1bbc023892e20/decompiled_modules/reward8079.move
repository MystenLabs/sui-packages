module 0x1c40b7d1243d0132779aed66047c067d0e7d0d5448048bc4a9e1bbc023892e20::reward8079 {
    struct REWARD8079 has drop {
        dummy_field: bool,
    }

    struct TICKET_8079 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8079(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8079>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8079>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8079, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8079>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8079>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8079>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8079>>(v5, 0x2::tx_context::sender(arg1));
    }
