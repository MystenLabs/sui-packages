module 0x1d718f69a2065c2cbc4e5fd2d54328b3f49da814d3d6e6dbf30bc05428e449b8::flash_lender {
    ...
    public entry fun withdraw1<T0>(arg0: &mut FlashLender<T0>, arg1: &AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        check_admin<T0>(arg0, arg1);
        let v0 = &mut arg0.to_lend;
        assert!(0x2::balance::value<T0>(v0) >= arg2, 4);
