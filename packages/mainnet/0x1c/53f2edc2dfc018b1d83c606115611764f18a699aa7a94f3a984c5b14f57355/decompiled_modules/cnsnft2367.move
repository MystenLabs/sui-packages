module 0x1c53f2edc2dfc018b1d83c606115611764f18a699aa7a94f3a984c5b14f57355::cnsnft2367 {
    struct CNSNFT2367 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2367, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3219"));
        let v4 = 0x2::package::claim<CNSNFT2367>(arg0, arg1);
