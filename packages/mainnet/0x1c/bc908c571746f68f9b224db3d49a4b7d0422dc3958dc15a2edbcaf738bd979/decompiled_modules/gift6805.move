module 0x1cbc908c571746f68f9b224db3d49a4b7d0422dc3958dc15a2edbcaf738bd979::gift6805 {
    struct GIFT6805 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift6805(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT6805, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6805>(arg0, arg1);
