module 0x1c73e01f86c64c4ebaaf170e3330ac1961f22ea66cc3ae269131fcb89b9146e2::cnsnft4260 {
    struct CNSNFT4260 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4260, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4260>(arg0, arg1);
