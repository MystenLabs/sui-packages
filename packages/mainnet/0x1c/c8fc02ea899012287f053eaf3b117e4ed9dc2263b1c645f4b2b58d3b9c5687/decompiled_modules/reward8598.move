module 0x1cc8fc02ea899012287f053eaf3b117e4ed9dc2263b1c645f4b2b58d3b9c5687::reward8598 {
    struct REWARD8598 has drop {
        dummy_field: bool,
    }

    struct TICKET_8598 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8598(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8598>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8598>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8598, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8598>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8598>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8598>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8598>>(v5, 0x2::tx_context::sender(arg1));
    }
