module 0xcc6e2b3aa410a45e741a92a112bc30a7aabaa4d8ea33baf75174879137bb65fe::kiosk_listings {
    ...
    public fun buy<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>, u64) {
        ...
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::balance::split<0x2::sui::SUI>(&mut v10, v7));
        let (v11, v12) = 0x2::kiosk::purchase_with_cap<T0>(arg1, v5, 0x2::coin::from_balance<0x2::sui::SUI>(v10, arg5));
        let v13 = BuyEvent{
