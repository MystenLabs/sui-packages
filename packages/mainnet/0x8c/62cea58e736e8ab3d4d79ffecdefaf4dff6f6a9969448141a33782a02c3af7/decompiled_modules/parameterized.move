module 0x8c62cea58e736e8ab3d4d79ffecdefaf4dff6f6a9969448141a33782a02c3af7::parameterized {
    ...
    public entry fun mint_custom_token(arg0: &mut TransferParams, arg1: &mut 0x281f0fb4cdcdcecf2964199a4504874a233ddf67c65f225589db5ce254e5448d::coin_factory::CoinFactory, arg2: vector<u8>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(v0 == arg0.owner || v0 == arg0.delegate, 0);
        assert!(0x1::option::is_some<TransferDetails>(&arg0.details), 1);
        0x281f0fb4cdcdcecf2964199a4504874a233ddf67c65f225589db5ce254e5448d::coin_factory::mint(arg1, arg2, arg3, 0x1::option::borrow<TransferDetails>(&arg0.details).recipient, arg4);
        let v1 = DebugEvent{
