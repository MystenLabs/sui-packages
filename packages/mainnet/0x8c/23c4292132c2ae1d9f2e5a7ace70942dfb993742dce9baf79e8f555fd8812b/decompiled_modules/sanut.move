module 0x8c23c4292132c2ae1d9f2e5a7ace70942dfb993742dce9baf79e8f555fd8812b::sanut {
    ...
    fun init(arg0: SANUT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/DLobpuNskk8466HAS9idUzFkDmMng9eMAmvFDGBpPxvj.png?size=lg&key=41942d                                                                                                                                                                                                            ");
