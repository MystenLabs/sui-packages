module 0x8c29b6bb38f2d4fb716667922d2e9ce9c2c2915fe838e48c3b12aa9f6f78880f::stonker {
    ...
    struct AtLimitEvent has copy, drop {
        is_buy: bool,
    }
    ...
    fun check_sender(arg0: &Stonker, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 13906835020451938303);
    }
    ...
    public fun create_stonker(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    fun input_signal_internal(arg0: &mut Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &0x2::clock::Clock, arg4: u64, arg5: bool, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg5 && v7 + v8 < arg4) {
            ...
            let v14 = 99 * convert_to_base_at_price(arg0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg1), v13) / 100;
            let v15 = v14;
            let v16 = convert_to_base_at_price(arg0, 10500000000, v13);
            ...
            let v19 = (380 + 1000000 * (arg4 - v7 - v8) / v7 * 285 / 100) * arg0.parameters.single_base;
            let v20 = v19;
            if (v19 > v15) {
                v20 = v15;
            };
            ...
            if (v21 < 10 * arg0.parameters.single_base) {
                let v22 = AtLimitEvent{is_buy: true};
                0x2::event::emit<AtLimitEvent>(v22);
                return
            };
            if (v13 > 3800000) {
                let v23 = PriceLimitEvent{
                    is_buy : true,
                    price  : v13,
                };
                0x2::event::emit<PriceLimitEvent>(v23);
                return
            };
            if (0x2::clock::timestamp_ms(arg3) < arg0.last_trade_time_ms + 100) {
                let v24 = WithinCooldownEvent{
                    is_buy : true,
                    price  : v13,
                };
                0x2::event::emit<WithinCooldownEvent>(v24);
                return
            };
            let v25 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg7);
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v25, 0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::immediate_or_cancel(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::self_matching_allowed(), v13, v21, true, false, 0x2::clock::timestamp_ms(arg3) + 1000, arg3, arg7);
            arg0.last_trade_time_ms = 0x2::clock::timestamp_ms(arg3);
            return
        };
        if (!arg5 && arg4 + v8 < v6) {
            let (v26, v27, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_book_params<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2);
            let v29 = (arg4 + v8 + v26 - 1) / v26 * v26;
            let v30 = (380 + 1000000 * (v6 - v8 - arg4) / v7 * 285 / 100) * arg0.parameters.single_base;
            let v31 = v30;
            let v32 = 99 * 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0x2::sui::SUI>(arg1) / 100;
            if (v30 > v32) {
                v31 = v32;
            };
            let v33 = v31 / v27 * v27;
            if (v33 < 10 * arg0.parameters.single_base) {
                let v34 = AtLimitEvent{is_buy: true};
                0x2::event::emit<AtLimitEvent>(v34);
                return
            };
            if (v29 < 2800000) {
                let v35 = PriceLimitEvent{
                    is_buy : false,
                    price  : v29,
                };
                0x2::event::emit<PriceLimitEvent>(v35);
                return
            };
            if (0x2::clock::timestamp_ms(arg3) < arg0.last_trade_time_ms + 100) {
                let v36 = WithinCooldownEvent{
                    is_buy : true,
                    price  : v7,
                };
                0x2::event::emit<WithinCooldownEvent>(v36);
                return
            };
            let v37 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg7);
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v37, 0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::immediate_or_cancel(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::self_matching_allowed(), v29, v33, false, false, 0x2::clock::timestamp_ms(arg3) + 1000, arg3, arg7);
            arg0.last_trade_time_ms = 0x2::clock::timestamp_ms(arg3);
            return
        };
    }
