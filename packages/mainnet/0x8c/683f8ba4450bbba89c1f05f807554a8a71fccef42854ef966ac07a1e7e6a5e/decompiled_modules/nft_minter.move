module 0x8c683f8ba4450bbba89c1f05f807554a8a71fccef42854ef966ac07a1e7e6a5e::nft_minter {
    struct App has key {
        id: 0x2::object::UID,
    ...
    entry fun authorize_nft(arg0: &0x8c683f8ba4450bbba89c1f05f807554a8a71fccef42854ef966ac07a1e7e6a5e::wave_pad_nft::NftOwnerCap, arg1: &mut App) {
        0x8c683f8ba4450bbba89c1f05f807554a8a71fccef42854ef966ac07a1e7e6a5e::wave_pad_nft::authorize_app(arg0, &mut arg1.id, 0);
    }
    ...
    entry fun mint_nft(arg0: &mut App, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u16, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version <= 1, 1);
        let v0 = 0x2::tx_context::sender(arg8);
        validate_signature(arg0, v0, arg1, arg2, arg3, arg4, arg6, arg5, arg7);
        assert!(!0x2::dynamic_field::exists_<address>(&arg0.id, v0), 4);
        0x2::dynamic_field::add<address, bool>(&mut arg0.id, v0, true);
        let v1 = 0x8c683f8ba4450bbba89c1f05f807554a8a71fccef42854ef966ac07a1e7e6a5e::wave_pad_nft::mint(&mut arg0.id, arg1, arg2, arg3, arg4, arg8);
        0x2::transfer::public_transfer<0x8c683f8ba4450bbba89c1f05f807554a8a71fccef42854ef966ac07a1e7e6a5e::wave_pad_nft::NFT>(v1, v0);
        let v2 = NftMinted{
            receiver : v0,
            nft_id   : 0x8c683f8ba4450bbba89c1f05f807554a8a71fccef42854ef966ac07a1e7e6a5e::wave_pad_nft::get_id(&v1),
        };
