module 0x8c9ed54efee50e3817741554e5db7ba58700e1170ae33dced323344006c8daea::whispy {
    ...
    fun init(arg0: WHISPY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<WHISPY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"WHISPY  ")))), trim_right(b"WHISPY                          "), trim_right(b"Daram is a social experiment meme coin that combines the advantages of BRC20 tokens with those of traditional meme tokens, aiming to ensure this fair launch method is sufficiently fluid on Ethereum                                                                                                                           "), v2, arg1);
