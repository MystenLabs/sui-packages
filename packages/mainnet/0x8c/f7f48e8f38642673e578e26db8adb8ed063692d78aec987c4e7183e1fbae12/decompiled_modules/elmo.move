module 0x8cf7f48e8f38642673e578e26db8adb8ed063692d78aec987c4e7183e1fbae12::elmo {
    ...
    fun init(arg0: ELMO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/C2EyUcVqZVjpDAWFtx7LxFWrWfvzd5SaN7R5Y7UXpump.png?size=lg&key=205eed                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<ELMO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"ELMO    ")))), trim_right(b"Justice For Elmo                "), trim_right(b"Justice For Elmo                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
