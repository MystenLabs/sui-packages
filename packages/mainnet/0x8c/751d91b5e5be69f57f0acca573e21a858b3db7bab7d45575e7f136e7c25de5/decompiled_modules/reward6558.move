module 0x8c751d91b5e5be69f57f0acca573e21a858b3db7bab7d45575e7f136e7c25de5::reward6558 {
    struct REWARD6558 has drop {
        dummy_field: bool,
    }

    struct TICKET_6558 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6558(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6558>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6558>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6558, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6558>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6558>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6558>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6558>>(v5, 0x2::tx_context::sender(arg1));
    }
