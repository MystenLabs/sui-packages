module 0x8cc4ec648eb6fe3f36493f9fede85853d65d8910ce506e5981d8d0308d942d84::reward3207 {
    struct REWARD3207 has drop {
        dummy_field: bool,
    }

    struct TICKET_3207 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3207(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3207>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3207>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3207, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3207>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3207>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3207>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3207>>(v5, 0x2::tx_context::sender(arg1));
    }
