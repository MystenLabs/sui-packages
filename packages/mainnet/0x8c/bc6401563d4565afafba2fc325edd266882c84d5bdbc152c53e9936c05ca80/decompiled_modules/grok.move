module 0x8cbc6401563d4565afafba2fc325edd266882c84d5bdbc152c53e9936c05ca80::grok {
    ...
    fun init(arg0: GROK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/BwGLbuvQBgk5SVzMQgy8VbBLZqWg4xQfWSzboiaSpump.png?size=lg&key=c944cc                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<GROK>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Grok    ")))), trim_right(b"My Life As Grok                 "), trim_right(b"my_life_as_grok                                                                                                                                                                                                                                                                                                                 "), v2, arg1);
        let v5 = v3;
