module 0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::payment_policy {
    ...
    public fun createPolicy<T0: store + key, T1>(arg0: &0x2::package::Publisher, arg1: u64, arg2: u64, arg3: &0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::version::Version, arg4: &mut 0x2::tx_context::TxContext) : PolicyVaultCap {
    ...
    public(friend) fun payByClt<T0: store + key, T1>(arg0: &mut 0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::clt::CltVault<T1>, arg1: &mut PolicyVault<T0>, arg2: 0x2::transfer_policy::TransferRequest<T0>, arg3: &0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::public_kiosk::KOrder, arg4: &mut 0x2::balance::Balance<T1>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, u64, u64) {
        let (_, v1, v2, v3) = 0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::public_kiosk::orderInfo(arg3);
        ...
        let v8 = 0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::constants::max_fee();
        let v9 = 0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::math::div(0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::math::mul(v7, arg5), v8);
        let v10 = 0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::math::div(0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::math::mul(v7, *v6), v8);
        0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::clt::withdrawTo<T1>(0x2::balance::split<T1>(arg4, v7 - v9 - v10), v2, arg0, arg6);
    ...
    public(friend) fun payByCoin<T0: store + key, T1>(arg0: &mut PolicyVault<T0>, arg1: 0x2::transfer_policy::TransferRequest<T0>, arg2: &0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::public_kiosk::KOrder, arg3: &mut 0x2::balance::Balance<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, u64, u64) {
        let (_, v1, v2, v3) = 0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::public_kiosk::orderInfo(arg2);
        ...
        let v8 = 0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::constants::max_fee();
        let v9 = 0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::math::div(0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::math::mul(v7, arg4), v8);
        let v10 = 0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::math::div(0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::math::mul(v7, *v6), v8);
    ...
    public fun withdrawRoyalFeeToken<T0: store + key, T1>(arg0: &PolicyVaultCap, arg1: &mut PolicyVault<T0>, arg2: &mut 0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::clt::CltVault<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        0x79c477770f5035421d376a46706d41d3cbaa46712994ea81752d2fd04e3d6bed::clt::withdrawTo<T1>(withdrawRoyalFee<T0, T1>(arg0, arg1), 0x2::tx_context::sender(arg3), arg2, arg3);
    }
