module 0x8c48c369b6887de0c5c215d3c531a12037d14cf53b7bf5ac8da3e81075517a9e::cnsnft2226 {
    struct CNSNFT2226 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2226, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2226>(arg0, arg1);
