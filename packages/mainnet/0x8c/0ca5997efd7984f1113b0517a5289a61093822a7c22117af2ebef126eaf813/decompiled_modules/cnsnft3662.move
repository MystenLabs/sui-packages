module 0x8c0ca5997efd7984f1113b0517a5289a61093822a7c22117af2ebef126eaf813::cnsnft3662 {
    struct CNSNFT3662 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3662, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3662>(arg0, arg1);
