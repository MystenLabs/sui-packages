module 0x8c30bd66ae3c27f7b407ab5bee8b40a8694f387559b88f0382f05dd7f5a97756::reward8550 {
    struct REWARD8550 has drop {
        dummy_field: bool,
    }

    struct TICKET_8550 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8550(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8550>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8550>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8550, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8550>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8550>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8550>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8550>>(v5, 0x2::tx_context::sender(arg1));
    }
