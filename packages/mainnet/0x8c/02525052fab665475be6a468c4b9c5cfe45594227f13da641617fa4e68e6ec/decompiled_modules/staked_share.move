module 0x8c02525052fab665475be6a468c4b9c5cfe45594227f13da641617fa4e68e6ec::staked_share {
    ...
    public entry fun new_and_share_number_pool_and_share_supply<T0: store, T1: store + key>(arg0: &0x8c02525052fab665475be6a468c4b9c5cfe45594227f13da641617fa4e68e6ec::pool::AdminCap, arg1: &mut 0x8c02525052fab665475be6a468c4b9c5cfe45594227f13da641617fa4e68e6ec::pool::Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = NumberPool<T0, T1>{
            id               : 0x2::object::new(arg2),
            available_shares : 0x1::vector::empty<StakedPoolShare<T0, T1>>(),
        };
        0x8c02525052fab665475be6a468c4b9c5cfe45594227f13da641617fa4e68e6ec::pool::fill_number_pool<T0, T1>(arg1, 0x2::object::uid_to_inner(&v0.id));
