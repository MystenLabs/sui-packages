module 0x8ccc7451b7303d55ec66215991b2b056cb1cd62075a58397974f0e2725507bd6::relics {
    ...
    fun init(arg0: RELICS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Relic>(&mut v6, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
    ...
    public entry fun mint_to_address(arg0: &AdminCap, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::string::String>(&arg4)) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0, *0x1::vector::borrow<0x1::string::String>(&arg4, v1), *0x1::vector::borrow<0x1::string::String>(&arg5, v1));
        ...
        0x2::transfer::public_transfer<Relic>(v2, arg6);
    }

    public entry fun take_and_transfer(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: address) {
        0x2::transfer::public_transfer<Relic>(0x2::kiosk::take<Relic>(arg0, arg1, arg2), arg3);
    }
