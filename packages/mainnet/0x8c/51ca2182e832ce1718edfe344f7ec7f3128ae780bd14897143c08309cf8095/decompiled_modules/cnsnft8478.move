module 0x8c51ca2182e832ce1718edfe344f7ec7f3128ae780bd14897143c08309cf8095::cnsnft8478 {
    struct CNSNFT8478 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8478, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8478>(arg0, arg1);
