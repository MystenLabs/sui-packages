module 0x8ca4af756bb394e3496330b9319c0ad90e1f1f14be02f2baf853d6f93dfa6eb4::wizrd {
    struct WIZRD has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WIZRD, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WIZRD>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"wizrd"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"gdfgdfgdfg"));
