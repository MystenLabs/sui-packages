module 0x8c82fbfdecb2b977b5d2dd2bce4a0b7f6f6e3d89718e3357681dfa8c056180b9::reward8120 {
    struct REWARD8120 has drop {
        dummy_field: bool,
    }

    struct TICKET_8120 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8120(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8120>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8120>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8120, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8120>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8120>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8120>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8120>>(v5, 0x2::tx_context::sender(arg1));
    }
