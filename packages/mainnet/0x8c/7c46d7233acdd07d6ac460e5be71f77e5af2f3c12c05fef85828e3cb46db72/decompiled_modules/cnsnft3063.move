module 0x8c7c46d7233acdd07d6ac460e5be71f77e5af2f3c12c05fef85828e3cb46db72::cnsnft3063 {
    struct CNSNFT3063 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3063, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3063>(arg0, arg1);
