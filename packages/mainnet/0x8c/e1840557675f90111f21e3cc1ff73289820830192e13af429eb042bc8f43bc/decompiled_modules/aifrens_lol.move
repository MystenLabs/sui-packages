module 0x8ce1840557675f90111f21e3cc1ff73289820830192e13af429eb042bc8f43bc::aifrens_lol {
    ...
    public entry fun claim(arg0: &mut AifrensLolPool, arg1: &0x2::clock::Clock, arg2: vector<vector<u8>>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x8ce1840557675f90111f21e3cc1ff73289820830192e13af429eb042bc8f43bc::merkle_tree::verify_calldata(arg2, arg0.root_proof, 0x1::bcs::to_bytes<address>(&v1)), 3);
        mint_token(arg1, 0x2::table::length<address, bool>(&arg0.claimed), arg0.name, arg3);
    }

    public entry fun beta_claim(arg0: &mut BetaLolPool, arg1: &0x2::clock::Clock, arg2: &0x51419fbf704ff58cc2499d0c77d11e0dd551e48939dd87756755ed41dabaf90c::aifrens_footie_legends::AifrensGenesis, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg1);
        assert!(!arg0.has_paused, 4);
        assert!(v0 > arg0.launched_at_ms, 5);
        assert!(v0 < arg0.expired_at_ms, 6);
        let v1 = 0x2::object::id<0x51419fbf704ff58cc2499d0c77d11e0dd551e48939dd87756755ed41dabaf90c::aifrens_footie_legends::AifrensGenesis>(arg2);
    ...
    fun get_random(arg0: &0x2::clock::Clock, arg1: vector<u8>, arg2: address, arg3: u64) : vector<u8> {
    ...
    fun init(arg0: AIFRENS_LOL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = &mut v3;
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"AIFRENHUAT"));
        ...
        let v7 = AifrensLolPool{
            ...
            name           : b"alpha",
            has_paused     : false,
            launched_at_ms : 1683939600000,
            expired_at_ms  : 1683939600000 + 7 * 86400000,
    ...
    fun mint_token(arg0: &0x2::clock::Clock, arg1: u64, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
