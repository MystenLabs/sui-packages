module 0x8c36f834b0c0b9853d2bd047d9c49f4f9aa8d7a9244d7b36c17c74d765396142::staked_share {
    ...
    public entry fun new_and_share_number_pool_and_share_supply<T0, T1, T2>(arg0: &0x8c36f834b0c0b9853d2bd047d9c49f4f9aa8d7a9244d7b36c17c74d765396142::pool::GlobalConfig, arg1: &0x8c36f834b0c0b9853d2bd047d9c49f4f9aa8d7a9244d7b36c17c74d765396142::pool::AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun new_share<T0, T1, T2>(arg0: &0x8c36f834b0c0b9853d2bd047d9c49f4f9aa8d7a9244d7b36c17c74d765396142::pool::GlobalConfig, arg1: &mut ShareSupply<T0, T1, T2>, arg2: &mut NumberPool<T0, T1, T2>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : vector<StakedPoolShare<T0, T1, T2>> {
        assert!(0x8c36f834b0c0b9853d2bd047d9c49f4f9aa8d7a9244d7b36c17c74d765396142::pool::config_veriosn(arg0) == 1, 0);
        let v0 = arg3;
        let v1 = arg4;
        if (0x1::vector::length<StakedPoolShare<T0, T1, T2>>(&arg2.available_shares) == 0) {
            ...
            while (0x1::vector::length<StakedPoolShare<T0, T1, T2>>(&arg2.available_shares) != 0) {
                ...
                if (v7 == v0) {
                    ...
                    let v12 = 0;
                    v0 = v12;
                    arg1.active_supply = arg1.active_supply + v12;
                    break
                };
                let v13 = (((((v7 as u128) * 1000000000 / (v0 as u128)) as u128) * (v1 as u128) / 1000000000) as u64);
                v1 = v1 - v13;
                let v14 = 0x2::object::uid_to_inner(&v6.id);
                0x2::dynamic_field::remove<0x2::object::ID, u64>(&mut v6.id, v14);
                0x2::dynamic_field::add<0x2::object::ID, u64>(&mut v6.id, v14, v13);
                0x1::vector::push_back<StakedPoolShare<T0, T1, T2>>(&mut v5, v6);
                v0 = v0 - v7;
                arg1.active_supply = arg1.active_supply + v7;
            };
            if (v0 != 0) {
                let v15 = StakedPoolShare<T0, T1, T2>{
                    id        : 0x2::object::new(arg5),
                    start_num : arg1.total_supply + 1,
                    end_num   : arg1.total_supply + v0,
                };
                0x2::dynamic_field::add<0x2::object::ID, u64>(&mut v15.id, 0x2::object::uid_to_inner(&v15.id), v1);
                0x1::vector::push_back<StakedPoolShare<T0, T1, T2>>(&mut v5, v15);
