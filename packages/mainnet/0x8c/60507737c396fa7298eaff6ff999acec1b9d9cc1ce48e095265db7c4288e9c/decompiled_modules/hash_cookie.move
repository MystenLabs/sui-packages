module 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::hash_cookie {
    struct GlobalCookie has store, key {
        id: 0x2::object::UID,
        next_serial_number: u32,
        prize_bag: 0x2::bag::Bag,
        prize_amount: u64,
        user_tickets: 0x2::linked_table::LinkedTable<address, vector<u8>>,
        cookie_owner: 0x2::linked_table::LinkedTable<u32, address>,
    ...
    struct HashCookieTransferred has copy, drop {
        from: address,
        to: address,
        serial_number: u32,
    }

    struct HashCookieBurned has copy, drop {
        owner: address,
        serial_number: u32,
    }
    ...
    public entry fun transfer(arg0: &mut GlobalCookie, arg1: HashCookie, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::linked_table::borrow<u32, address>(&arg0.cookie_owner, v1) == &v0, 3);
        *0x2::linked_table::borrow_mut<u32, address>(&mut arg0.cookie_owner, v1) = arg2;
        let v2 = HashCookieTransferred{
            from          : v0,
            to            : arg2,
            serial_number : v1,
        };
        0x2::event::emit<HashCookieTransferred>(v2);
    ...
    public entry fun burn(arg0: &mut GlobalCookie, arg1: HashCookie, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = arg1.serial_number;
        assert!(0x2::linked_table::borrow<u32, address>(&arg0.cookie_owner, v1) == &v0, 3);
        *0x2::linked_table::borrow_mut<u32, address>(&mut arg0.cookie_owner, v1) = @0x0;
        let v2 = HashCookieBurned{
            owner         : v0,
            serial_number : v1,
        };
        0x2::event::emit<HashCookieBurned>(v2);
        let HashCookie {
            id                   : v3,
            serial_number        : _,
    ...
    public fun consume_ticket(arg0: &mut GlobalCookie, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) : bool {
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = false;
        if (0x2::linked_table::contains<address, vector<u8>>(&arg0.user_tickets, v0)) {
            let v2 = 0x2::linked_table::borrow_mut<address, vector<u8>>(&mut arg0.user_tickets, v0);
            let (v3, v4) = 0x1::vector::index_of<u8>(v2, &arg1);
            if (v3) {
                0x1::vector::remove<u8>(v2, v4);
                v1 = true;
    ...
    public entry fun create_global_cookie(arg0: &0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::vault_user::VaultUser, arg1: &mut 0x2::tx_context::TxContext) {
        0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::vault_user::assert_vault_admin(arg0, arg1);
        let v0 = GlobalCookie{
            id                 : 0x2::object::new(arg1),
            next_serial_number : 1,
            prize_bag          : 0x2::bag::new(arg1),
            prize_amount       : 0,
            user_tickets       : 0x2::linked_table::new<address, vector<u8>>(arg1),
            cookie_owner       : 0x2::linked_table::new<u32, address>(arg1),
    ...
    public(friend) fun generate_ticket(arg0: &mut GlobalCookie, arg1: address, arg2: u8) {
        if (!0x2::linked_table::contains<address, vector<u8>>(&arg0.user_tickets, arg1)) {
            0x2::linked_table::push_back<address, vector<u8>>(&mut arg0.user_tickets, arg1, 0x1::vector::empty<u8>());
        };
        0x1::vector::push_back<u8>(0x2::linked_table::borrow_mut<address, vector<u8>>(&mut arg0.user_tickets, arg1), arg2);
        let v0 = UserTicketsUpdated{
            user        : arg1,
            ticket_type : arg2,
            is_add      : true,
        };
        0x2::event::emit<UserTicketsUpdated>(v0);
    }

    public entry fun generate_ticket_for_user(arg0: &mut GlobalCookie, arg1: address, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.operator, 6);
    ...
    public entry fun get_user_tickets(arg0: &GlobalCookie, arg1: address) : vector<u8> {
        if (0x2::linked_table::contains<address, vector<u8>>(&arg0.user_tickets, arg1)) {
            *0x2::linked_table::borrow<address, vector<u8>>(&arg0.user_tickets, arg1)
        } else {
            0x1::vector::empty<u8>()
        }
    }
    ...
    public entry fun mint(arg0: &mut GlobalCookie, arg1: &mut 0x2::tx_context::TxContext) {
        if (arg0.next_serial_number > 999999) {
            return
        };
        assert!(consume_ticket(arg0, 0, arg1), 1);
        ...
        0x2::linked_table::push_back<u32, address>(&mut arg0.cookie_owner, v1, v0);
    ...
    public entry fun set_operator(arg0: &mut GlobalCookie, arg1: &0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::vault_user::VaultUser, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::vault_user::assert_vault_admin(arg1, arg3);
        arg0.operator = arg2;
    }

    public entry fun set_prize_amount(arg0: &mut GlobalCookie, arg1: &0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::vault_user::VaultUser, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::vault_user::assert_vault_admin(arg1, arg3);
