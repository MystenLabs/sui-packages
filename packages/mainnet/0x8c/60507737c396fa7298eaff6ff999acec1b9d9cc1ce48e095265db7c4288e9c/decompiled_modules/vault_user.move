module 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::vault_user {
    ...
    public entry fun safe_lock(arg0: &mut VaultUser, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: bool, arg5: bool, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v5, 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::errors::invalid_state());
        ...
        assert!(0x2::linked_table::contains<address, UserNode>(&arg0.users_info, v7), 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::errors::invalid_user());
        if (!0x2::linked_table::contains<address, UserData>(&arg0.users_data, v7)) {
            let v8 = UserData{
                password_hash    : 0x1::vector::empty<u8>(),
                principal_locked : false,
                account_locked   : false,
            };
            0x2::linked_table::push_back<address, UserData>(&mut arg0.users_data, v7, v8);
        };
        let v9 = 0x2::linked_table::borrow_mut<address, UserData>(&mut arg0.users_data, v7);
        if (0x1::vector::length<u8>(&v9.password_hash) != 0 && v9.password_hash != arg2) {
        ...
        let v10 = 0x2::groth16::bn254();
        let v11 = 0;
        let v12 = 1;
        let v13 = 2;
        let v14 = 3;
        let v15 = 0x2::groth16::pvk_from_bytes(*0x2::vec_map::get<u8, vector<u8>>(&arg0.vk, &v11), *0x2::vec_map::get<u8, vector<u8>>(&arg0.vk, &v12), *0x2::vec_map::get<u8, vector<u8>>(&arg0.vk, &v13), *0x2::vec_map::get<u8, vector<u8>>(&arg0.vk, &v14));
        let v16 = 0x2::groth16::public_proof_inputs_from_bytes(arg2);
        let v17 = 0x2::groth16::proof_points_from_bytes(arg1);
        assert!(0x2::groth16::verify_groth16_proof(&v10, &v15, &v16, &v17), 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::errors::invalid_proof());
        if (arg6 == 0 && 0x1::vector::length<u8>(&v9.password_hash) == 0) {
            v9.password_hash = arg2;
        } else {
            v9.principal_locked = arg4;
            v9.account_locked = arg5;
        };
        let v18 = PrincipalLocked{
            user             : v7,
            user_id          : arg6,
            principal_locked : arg4,
        };
        0x2::event::emit<PrincipalLocked>(v18);
    }
    ...
    public entry fun set_level_config(arg0: &mut VaultUser, arg1: u8, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg2 >= 0 && arg3 >= 500 && arg4 >= 50 && arg5 >= 10, 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::errors::invalid_value());
        ...
        if (arg1 > 1) {
            ...
            assert!(v2.min_score <= arg2 && v2.actual_percentage <= arg3 && v2.direct_percentage <= arg4 && v2.indirect_percentage <= arg5, 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::errors::invalid_value());
        };
        let v3 = if (arg1 == 0) {
            0
        } else {
    ...
    public(friend) fun update_user_score(arg0: &mut VaultUser, arg1: address, arg2: u64, arg3: u64, arg4: bool) : (u64, u64, u64, u64) {
        if (arg1 == @0x2012 || arg2 == 0 || arg3 == 0 || !0x2::linked_table::contains<address, UserNode>(&arg0.users_info, arg1)) {
            return (0, 0, 0, 0)
        };
        let v0 = 0x2::linked_table::borrow<address, UserNode>(&arg0.users_info, arg1).referrer;
        let v1 = arg2 / 1000000 * arg3;
        if (arg4) {
            let v2 = 0x2::linked_table::borrow_mut<address, UserNode>(&mut arg0.users_info, arg1);
            v2.score = v2.score + v1;
            if (v0 != @0x2012 && 0x2::linked_table::contains<address, UserNode>(&arg0.users_info, v0)) {
                let v3 = 0x2::linked_table::borrow_mut<address, UserNode>(&mut arg0.users_info, v0);
                v3.extra_score = v3.extra_score + v1;
            };
        } else {
            let v4 = 0x2::linked_table::borrow_mut<address, UserNode>(&mut arg0.users_info, arg1);
            ...
            v4.score = v5;
            if (v0 != @0x2012 && 0x2::linked_table::contains<address, UserNode>(&arg0.users_info, v0)) {
                let v6 = 0x2::linked_table::borrow_mut<address, UserNode>(&mut arg0.users_info, v0);
