module 0x8c92459b5c374957a9664e09d74846f8b80a9a42f1b92b748e99d3511ac6d8d5::ivanka {
    ...
    fun init(arg0: IVANKA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<IVANKA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"IVANKA  ")))), trim_right(b"OFFICIAL IVANKA TRUMP           "), trim_right(b"The Only Official Ivanka Trump Sui Meme. $IVANKA (Trump's daughter).                                                                                                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
