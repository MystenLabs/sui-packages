module 0x8c85cc6e2cecad2e0fad9e2d973889cf245aab35e5de0bfc8c4f3388be3d0acd::acl {
    ...
    public fun get_fund_receiver(arg0: &ACL) : address {
        assert!(0x1::option::is_some<address>(&arg0.fund_receiver), 8);
        *0x1::option::borrow<address>(&arg0.fund_receiver)
    }

    public fun get_reward_receiver(arg0: &ACL) : address {
        assert!(0x1::option::is_some<address>(&arg0.reward_receiver), 9);
