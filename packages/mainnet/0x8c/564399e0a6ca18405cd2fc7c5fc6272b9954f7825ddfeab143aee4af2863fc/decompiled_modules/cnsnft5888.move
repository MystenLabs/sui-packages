module 0x8c564399e0a6ca18405cd2fc7c5fc6272b9954f7825ddfeab143aee4af2863fc::cnsnft5888 {
    struct CNSNFT5888 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5888, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5888>(arg0, arg1);
