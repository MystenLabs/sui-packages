module 0xb84e63d22ea4822a0a333c250e790f69bf5c2ef0c63f4e120e05a6415991368f::v2 {
    ...
    public fun trader_swap_and_repay2<T0, T1>(arg0: &mut TradingPair<T0, T1>, arg1: u64, arg2: u64, arg3: Borrow<T0, T1>, arg4: u64, arg5: 0x1::option::Option<0x2::coin::Coin<T0>>, arg6: 0x1::option::Option<0x2::coin::Coin<T1>>, arg7: &0x2::clock::Clock) {
        ...
        if (!v0) {
            ...
            let (v4, v5) = quote_x_to_y<T0, T1>(arg0, v3);
            let v6 = v4 + v5;
            let v7 = FlashSwap{
                is_borrow_x      : v0,
                borrow_amt       : v1,
            ...
            assert!(v6 >= arg4, v6);
            0x2::balance::join<T0>(&mut arg0.reserve_x, 0x2::coin::into_balance<T0>(v2));
            let v8 = v4 * arg0.mult_y / 1000000;
            update_volume_record<T0, T1>(arg0, arg7, v8);
        } else {
            0x1::option::destroy_none<0x2::coin::Coin<T0>>(arg5);
            let v9 = 0x1::option::destroy_some<0x2::coin::Coin<T1>>(arg6);
            let v10 = 0x2::coin::value<T1>(&v9);
            let (v11, v12) = quote_y_to_x<T0, T1>(arg0, v10);
            let v13 = v11 + v12;
            let v14 = FlashSwap{
                is_borrow_x      : v0,
                borrow_amt       : v1,
                repay_amt        : v13,
                intermediate_amt : v10,
            };
            0x2::event::emit<FlashSwap>(v14);
            assert!(v13 >= v1, v13);
            assert!(v13 >= arg4, v13);
            0x2::balance::join<T1>(&mut arg0.reserve_y, 0x2::coin::into_balance<T1>(v9));
            let v15 = v11 * arg0.mult_x / 1000000;
            update_volume_record<T0, T1>(arg0, arg7, v15);
        };
    }
