module 0x8c161e0f9af98460fd1e3f59aeb4f0316f7852b8e99254b431a1784d2bfd54c8::universal_router {
    ...
    public fun build<T0, T1>(arg0: &mut 0x8c161e0f9af98460fd1e3f59aeb4f0316f7852b8e99254b431a1784d2bfd54c8::partner_manager::PartnerRegistry, arg1: 0x1::option::Option<0x1::string::String>, arg2: 0x2::coin::Coin<T0>, arg3: u256, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: &mut 0x2::tx_context::TxContext) : Trade<T0, T1> {
        if (arg5 > 1000000) {
            abort 2
        };
        ...
        while (0x1::vector::is_empty<u64>(&arg7)) {
            ...
            let v3 = Route{
                trade_id  : arg3,
                amount_in : 0x8c161e0f9af98460fd1e3f59aeb4f0316f7852b8e99254b431a1784d2bfd54c8::math::mul_div(0x2::coin::value<T0>(&arg2), v2, 100),
                current   : 0,
        ...
        if (0x1::option::is_some<0x1::string::String>(&arg1)) {
            0x8c161e0f9af98460fd1e3f59aeb4f0316f7852b8e99254b431a1784d2bfd54c8::partner_manager::collect_commission_if_necessary<T0>(arg0, *0x1::option::borrow<0x1::string::String>(&arg1), &mut v4.coin_in, true, arg8);
        };
        v4
    }
    ...
    public entry fun set_fee_on(arg0: &0x8c161e0f9af98460fd1e3f59aeb4f0316f7852b8e99254b431a1784d2bfd54c8::admin_cap::AdminCap, arg1: &mut Treasury, arg2: bool) {
        arg1.fee_on = arg2;
    }

    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: &mut 0x8c161e0f9af98460fd1e3f59aeb4f0316f7852b8e99254b431a1784d2bfd54c8::partner_manager::PartnerRegistry, arg2: Trade<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let Trade {
            trade_id            : v0,
            amount_in           : v1,
        ...
        if (0x2::coin::value<T1>(&v11) < 0x8c161e0f9af98460fd1e3f59aeb4f0316f7852b8e99254b431a1784d2bfd54c8::math::mul_div(1000000 - v3, v2, 1000000)) {
            abort 1
        };
        ...
        if (0x1::option::is_some<0x1::string::String>(&v9)) {
            0x8c161e0f9af98460fd1e3f59aeb4f0316f7852b8e99254b431a1784d2bfd54c8::partner_manager::collect_commission_if_necessary<T1>(arg1, 0x1::option::destroy_some<0x1::string::String>(v9), &mut v11, false, arg4);
        } else {
    ...
    public entry fun withdraw<T0>(arg0: &0x8c161e0f9af98460fd1e3f59aeb4f0316f7852b8e99254b431a1784d2bfd54c8::admin_cap::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
