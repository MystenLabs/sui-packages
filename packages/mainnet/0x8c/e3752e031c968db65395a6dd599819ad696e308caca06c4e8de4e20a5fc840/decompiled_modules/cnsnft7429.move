module 0x8ce3752e031c968db65395a6dd599819ad696e308caca06c4e8de4e20a5fc840::cnsnft7429 {
    struct CNSNFT7429 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7429, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7429>(arg0, arg1);
