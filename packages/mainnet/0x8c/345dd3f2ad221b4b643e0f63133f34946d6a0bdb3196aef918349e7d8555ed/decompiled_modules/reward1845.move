module 0x8c345dd3f2ad221b4b643e0f63133f34946d6a0bdb3196aef918349e7d8555ed::reward1845 {
    struct REWARD1845 has drop {
        dummy_field: bool,
    }

    struct TICKET_1845 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1845(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1845>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1845>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1845, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1845>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1845>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1845>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1845>>(v5, 0x2::tx_context::sender(arg1));
    }
