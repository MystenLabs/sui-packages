module 0x8c2764525150ba7ebfb7e969a69616ff4ac3e291dc90d1a1d5e1a69d69319813::neko {
    ...
    fun init(arg0: NEKO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/6f68ce05689423cbac1e997ebaf3baf6fff28a6e08e8e6cc1f1b8442076ffae4?width=128&height=128&fit=crop&quality=95&format=auto                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<NEKO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"NEKO    ")))), trim_right(b"NEKO MANGA                      "), trim_right(b"NEKO is a curious little manga cat who lives between panels and pages. She loves reading everything she finds, from unfinished chapters to random notes left behind on the internet                                                                                                                                             "), v2, arg1);
        let v5 = v3;
