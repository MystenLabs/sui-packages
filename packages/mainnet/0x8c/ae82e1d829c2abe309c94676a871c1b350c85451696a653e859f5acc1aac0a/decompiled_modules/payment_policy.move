module 0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::payment_policy {
    ...
    public fun createPolicy<T0: store + key, T1>(arg0: &0x2::package::Publisher, arg1: u64, arg2: u64, arg3: &0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::version::Version, arg4: &mut 0x2::tx_context::TxContext) : PolicyVaultCap {
        ...
        0x6057a9907486a8e2fc309ae6d66291b35595bf2c4359c4b857fcc54b290c7f2d::cap_vault::createVault<PolicyVaultCap>(arg4);
        v6
    }
    ...
    public(friend) fun payByClt<T0: store + key, T1>(arg0: &mut 0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::clt::CltVault<T1>, arg1: &mut PolicyVault<T0>, arg2: 0x2::transfer_policy::TransferRequest<T0>, arg3: &0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::public_kiosk::KOrder, arg4: &mut 0x2::balance::Balance<T1>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, u64, u64) {
        let (_, v1, v2, v3) = 0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::public_kiosk::orderInfo(arg3);
        ...
        let v8 = 0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::constants::max_fee();
        let v9 = 0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::math::div(0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::math::mul(v7, arg5), v8);
        let v10 = 0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::math::div(0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::math::mul(v7, *v6), v8);
        0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::clt::withdrawTo<T1>(0x2::balance::split<T1>(arg4, v7 - v9 - v10), v2, arg0, arg6);
    ...
    public(friend) fun payByCoin<T0: store + key, T1>(arg0: &mut PolicyVault<T0>, arg1: 0x2::transfer_policy::TransferRequest<T0>, arg2: &0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::public_kiosk::KOrder, arg3: &mut 0x2::balance::Balance<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, u64, u64) {
        let (_, v1, v2, v3) = 0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::public_kiosk::orderInfo(arg2);
        ...
        let v8 = 0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::constants::max_fee();
        let v9 = 0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::math::div(0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::math::mul(v7, arg4), v8);
        let v10 = 0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::math::div(0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::math::mul(v7, *v6), v8);
    ...
    public fun withdrawRoyalFeeToken<T0: store + key, T1>(arg0: &PolicyVaultCap, arg1: &mut PolicyVault<T0>, arg2: &mut 0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::clt::CltVault<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        0x8cae82e1d829c2abe309c94676a871c1b350c85451696a653e859f5acc1aac0a::clt::withdrawTo<T1>(withdrawRoyalFee<T0, T1>(arg0, arg1), 0x2::tx_context::sender(arg3), arg2, arg3);
    }
