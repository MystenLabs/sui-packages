module 0x8c7d376bfab6f7592d5280fa876e3e43ab19962d99de9dcb3da6168254cbdaff::reward7804 {
    struct REWARD7804 has drop {
        dummy_field: bool,
    }

    struct TICKET_7804 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7804(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7804>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7804>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7804, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7804>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7804>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7804>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7804>>(v5, 0x2::tx_context::sender(arg1));
    }
