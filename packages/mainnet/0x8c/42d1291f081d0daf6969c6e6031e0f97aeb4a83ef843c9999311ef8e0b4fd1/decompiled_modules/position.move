module 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::position {
    ...
    public(friend) fun open(arg0: 0x2::object::ID, arg1: u64, arg2: 0x1::type_name::TypeName, arg3: 0x1::type_name::TypeName, arg4: 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::i32::I32, arg5: 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::i32::I32, arg6: &mut 0x2::tx_context::TxContext) : Position {
        Position{
    ...
    public fun tick_lower_index(arg0: &Position) : 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::i32::I32 {
        arg0.tick_lower_index
    }

    public fun tick_upper_index(arg0: &Position) : 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::i32::I32 {
    ...
    public(friend) fun update(arg0: &mut Position, arg1: 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::i128::I128, arg2: u128, arg3: u128, arg4: vector<u128>) {
        let v0 = if (0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::i128::eq(arg1, 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::i128::zero())) {
            if (arg0.liquidity == 0) {
                abort 0
            };
            arg0.liquidity
        } else {
            0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::liquidity_math::add_delta(arg0.liquidity, arg1)
        };
        let v1 = 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::full_math_u128::mul_div_floor(0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::full_math_u128::wrapping_sub(arg2, arg0.fee_growth_inside_x_last), arg0.liquidity, 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::constants::get_q64());
        let v2 = 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::full_math_u128::mul_div_floor(0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::full_math_u128::wrapping_sub(arg3, arg0.fee_growth_inside_y_last), arg0.liquidity, 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::constants::get_q64());
        if (v1 > (0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::constants::get_max_u64() as u128) || v2 > (0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::constants::get_max_u64() as u128)) {
            abort 1
        };
        if (!0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::full_math_u64::add_check(arg0.coins_owed_x, (v1 as u64)) || !0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::full_math_u64::add_check(arg0.coins_owed_x, (v1 as u64))) {
            abort 1
        };
    ...
    fun update_reward_infos(arg0: &mut Position, arg1: vector<u128>) {
        ...
        while (v0 < 0x1::vector::length<u128>(&arg1)) {
            ...
            let v4 = 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::full_math_u128::mul_div_floor(0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::full_math_u128::wrapping_sub(v2, v3.reward_growth_inside_last), v1, 0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::constants::get_q64());
            if (v4 > (0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::constants::get_max_u64() as u128) || !0x8c42d1291f081d0daf6969c6e6031e0f97aeb4a83ef843c9999311ef8e0b4fd1::full_math_u64::add_check(v3.coins_owed_reward, (v4 as u64))) {
                abort 1
            };
