module 0x8c807feeab618ab637abaa07bc58ddc478a209ef354753038e391bf5a5a3f019::cnsnft2003 {
    struct CNSNFT2003 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2003, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2003>(arg0, arg1);
