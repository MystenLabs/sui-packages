module 0x8cd7089a9cb55ad54ae05ba8a8767cdffe7f710ca5009b11d106405287a50eac::membership {
    ...
    fun assert_yusd_type<T0>() {
        assert!(0x1::type_name::into_string(0x1::type_name::with_original_ids<T0>()) == 0x1::ascii::string(b"90248f250110df0a1ab1925b60eeb6a1aa73a859156cacffe45d3b85929bc7f1::yusd::YUSD"), 10);
    }
    ...
    public fun get_all_thresholds() : vector<u64> {
        let v0 = 0x1::vector::empty<u64>();
        let v1 = &mut v0;
        0x1::vector::push_back<u64>(v1, 10000000);
        0x1::vector::push_back<u64>(v1, 20000000);
        0x1::vector::push_back<u64>(v1, 50000000);
        0x1::vector::push_back<u64>(v1, 100000000);
        0x1::vector::push_back<u64>(v1, 200000000);
        v0
    }
