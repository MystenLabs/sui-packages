module 0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_machine {
    ...
    struct Store has store, key {
        ...
        vaults: 0x2::table::Table<0x1::string::String, 0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_vault::GachaVault<Card>>,
        pack_index: u128,
    ...
    entry fun burn_card_in_vault(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: 0x1::string::String, arg3: 0x2::object::ID, arg4: u64, arg5: vector<u8>, arg6: &0x2::tx_context::TxContext) {
        ...
        let Card {
            ...
            hash        : _,
            revealed    : _,
        } = 0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_vault::remove_by_id<Card>(0x2::table::borrow_mut<0x1::string::String, 0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_vault::GachaVault<Card>>(&mut arg1.vaults, arg2), arg3);
    ...
    fun buy_packs(arg0: &0x2::random::Random, arg1: &mut Store, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg4: 0x1::string::String, arg5: u64, arg6: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::table::borrow_mut<0x1::string::String, 0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_vault::GachaVault<Card>>(&mut arg1.vaults, arg4);
        while (arg5 > 0) {
            let v6 = 0;
            let v7 = arg1.pack_index + 1;
            let v8 = 0x1::vector::empty<0x2::object::ID>();
            while (v6 < v3.pack_size) {
                let v9 = 0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_vault::remove_by_index<Card>(v5, 0x2::random::generate_u64_in_range(v1, 0, 0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_vault::length<Card>(v5) - 1));
    ...
    fun init(arg0: GACHA_MACHINE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Card>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Fantasy TCG 008"));
        0x2::display::add<Card>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A fantasic TCG game"));
        0x2::display::add<Card>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidonvncombv26657nc2ejt3hyw6earrs4r3wk352klutglgby5cju"));
        ...
        let v4 = Config{
            ...
            pack_size               : 0,
            enabled                 : false,
            placeholder_name        : 0x1::string::utf8(b"Unrevealed item"),
            placeholder_description : 0x1::string::utf8(b"Reveal to discover your card"),
            placeholder_media_url   : 0x1::string::utf8(b"ipfs://bafybeig5ikzrtmlugdm5iku5ztjcfii64jywqspqfqf3r7zybupf56bf6y"),
        };
        let v5 = Store{
            ...
            vaults              : 0x2::table::new<0x1::string::String, 0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_vault::GachaVault<Card>>(arg1),
            pack_index          : 0,
            transfer_policy     : v2,
    ...
    entry fun mint_cards(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: vector<0x1::string::String>, arg3: vector<vector<u8>>, arg4: 0x1::string::String, arg5: u64, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = if (0x2::table::contains<0x1::string::String, Config>(&arg1.configs, arg4)) {
            0x2::table::borrow<0x1::string::String, Config>(&arg1.configs, arg4)
        } else {
            &arg1.default_config
        };
        let v3 = 0x1::vector::length<0x1::string::String>(&arg2);
        assert!(v3 == 0x1::vector::length<vector<u8>>(&arg3), 9);
        if (!0x2::table::contains<0x1::string::String, 0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_vault::GachaVault<Card>>(&arg1.vaults, arg4)) {
            0x2::table::add<0x1::string::String, 0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_vault::GachaVault<Card>>(&mut arg1.vaults, arg4, 0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_vault::new<Card>(arg7));
        };
        let v4 = 0x2::table::borrow_mut<0x1::string::String, 0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_vault::GachaVault<Card>>(&mut arg1.vaults, arg4);
        let v5 = 0;
        while (v5 < v3) {
            let v6 = Card{
                id          : 0x2::object::new(arg7),
                name        : v2.placeholder_name,
                description : v2.placeholder_description,
                media_url   : v2.placeholder_media_url,
                attributes  : 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>(),
                hash        : *0x1::vector::borrow<vector<u8>>(&arg3, v5),
                revealed    : false,
            };
            let v7 = CardMintedEvent{
                id         : *0x1::vector::borrow<0x1::string::String>(&arg2, v5),
                card_id    : 0x2::object::id<Card>(&v6),
                vault_name : arg4,
            };
            0x2::event::emit<CardMintedEvent>(v7);
            0x8cc6bda39fab4d3a1b7ce06581ee6dcfb164916abb6ad746944167fd8b7eddd2::gacha_vault::add<Card>(v4, v6);
            v5 = v5 + 1;
        };
    }
    ...
    entry fun set_default_config(arg0: &mut Store, arg1: u64, arg2: u64, arg3: bool, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: &0x2::tx_context::TxContext) {
        verify_version(arg0);
        ...
        let v0 = Config{
            ...
            pack_size               : arg2,
            enabled                 : arg3,
            placeholder_name        : arg4,
            placeholder_description : arg5,
            placeholder_media_url   : arg6,
        };
    ...
    entry fun set_vault_config(arg0: &mut Store, arg1: 0x1::string::String, arg2: u64, arg3: u64, arg4: bool, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: &0x2::tx_context::TxContext) {
        verify_version(arg0);
        ...
        let v0 = if (0x1::string::is_empty(&arg5)) {
            arg0.default_config.placeholder_name
        } else {
            arg5
        };
        let v1 = if (0x1::string::is_empty(&arg6)) {
            arg0.default_config.placeholder_description
        } else {
            arg6
        };
        let v2 = if (0x1::string::is_empty(&arg7)) {
            arg0.default_config.placeholder_media_url
        } else {
            arg7
        };
        let v3 = Config{
            ...
            enabled                 : arg4,
            placeholder_name        : v0,
            placeholder_description : v1,
            placeholder_media_url   : v2,
        };
        0x2::table::add<0x1::string::String, Config>(&mut arg0.configs, arg1, v3);
    }
