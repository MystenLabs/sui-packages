module 0x35b9763e287ddc098e58a4c04915ac039a23dfa9be62ff5778b658cb5c7837d3::vault {
    ...
    public fun pay_v2<T0>(arg0: &0x35b9763e287ddc098e58a4c04915ac039a23dfa9be62ff5778b658cb5c7837d3::control::Permits, arg1: &mut Vault, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        0x35b9763e287ddc098e58a4c04915ac039a23dfa9be62ff5778b658cb5c7837d3::control::valid(arg0, 0x2::tx_context::sender(arg5));
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg1.vaults, v0), 3);
        let v1 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.vaults, v0);
        let v2 = 0x2::coin::value<T0>(&arg2);
        assert!(v2 > arg3 && v2 - arg3 >= arg4, 909);
        let v3 = 0x2::tx_context::sender(arg5);
        let (v4, arg2) = if (0x35b9763e287ddc098e58a4c04915ac039a23dfa9be62ff5778b658cb5c7837d3::control::is_mate(arg0, v3)) {
            (0x2::coin::split<T0>(&mut arg2, v2 - arg3, arg5), arg2)
        } else {
            (0x2::coin::zero<T0>(arg5), arg2)
        };
        0x2::balance::join<T0>(v1, 0x2::coin::into_balance<T0>(arg2));
        0x35b9763e287ddc098e58a4c04915ac039a23dfa9be62ff5778b658cb5c7837d3::help::transfer<T0>(v4, v3);
        let v5 = R{
            a : arg3,
            b : v2,
        };
