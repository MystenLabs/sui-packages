module 0x8c1aa8715104de443f9de623ef6f64698cd8994d67adda11a2587a1b2d592fdb::sp {
    struct SP has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = vector[b"SP", b"SuiPump", b"Sui is coming ", b""];
        let v2 = vector[b"SP", b"SuiPump", b"Sui is coming ", b""];
        let v3 = vector[b"SP", b"SuiPump", b"Sui is coming ", b""];
        let v4 = vector[b"SP", b"SuiPump", b"Sui is coming ", b""];
        ...
        let (v11, v12) = 0x7ead93e49fe002193faec3d2e4a7b750e9e568b5d875cafe17fcb0dc672b075e::ipx_coin_standard::new<SP>(v7, arg1);
        let v13 = v12;
        let v14 = v11;
        ...
        0x7ead93e49fe002193faec3d2e4a7b750e9e568b5d875cafe17fcb0dc672b075e::ipx_coin_standard::destroy_witness<SP>(&mut v14, v13);
