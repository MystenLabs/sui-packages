module 0x8c51ab7346994589f4f50e71c81e5a2868eb6d9a1033f41afb58ed52dcec43dc::service {
    ...
    public(friend) fun add_feature<T0, T1: store + key>(arg0: &mut Service, arg1: T1) {
        let v0 = 0x8c51ab7346994589f4f50e71c81e5a2868eb6d9a1033f41afb58ed52dcec43dc::utils::get_key_by_struct<T0>();
    ...
    public(friend) fun get_feature<T0, T1: store + key>(arg0: &Service) : &T1 {
        0x2::dynamic_object_field::borrow<0x1::string::String, T1>(&arg0.id, 0x8c51ab7346994589f4f50e71c81e5a2868eb6d9a1033f41afb58ed52dcec43dc::utils::get_key_by_struct<T0>())
    }

    public(friend) fun get_feature_mut<T0, T1: store + key>(arg0: &mut Service) : &mut T1 {
        0x2::dynamic_object_field::borrow_mut<0x1::string::String, T1>(&mut arg0.id, 0x8c51ab7346994589f4f50e71c81e5a2868eb6d9a1033f41afb58ed52dcec43dc::utils::get_key_by_struct<T0>())
    }
