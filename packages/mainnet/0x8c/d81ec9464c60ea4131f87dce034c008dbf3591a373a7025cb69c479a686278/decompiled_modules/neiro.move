module 0x8cd81ec9464c60ea4131f87dce034c008dbf3591a373a7025cb69c479a686278::neiro {
    ...
    fun init(arg0: NEIRO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<NEIRO>(arg0, 9, b"Neiro", b"NEIRO", b"Neiro on SUI.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://orange-upper-booby-780.mypinata.cloud/ipfs/QmdEfNtUbhSWss8xwPhDpwLEjhafxbSwBYZbUdyfXJw9HS"))), false, arg1);
        let v3 = v0;
        ...
        0x2::coin::mint_and_transfer<NEIRO>(&mut v3, 1000000000000000000, @0x8f2918dd940e03674b7c3960d192de48d1aae22f12d1b79d75aeec6851705cfb, arg1);
