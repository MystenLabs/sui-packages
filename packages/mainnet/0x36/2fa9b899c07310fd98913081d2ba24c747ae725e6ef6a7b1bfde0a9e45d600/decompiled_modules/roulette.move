module 0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::roulette {
    ...
    struct Game<phantom T0> has store, key {
        ...
        max_risk: u64,
        risk_manager: 0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::risk_manager::RiskManager,
        min_bet_size: u64,
        result_roll: u64,
    ...
    public fun close_game<T0>(arg0: &mut RouletteConfig<T0>, arg1: &0x2::clock::Clock, arg2: vector<u8>) {
        ...
        v1.result_roll = v4;
        v1.status = 1;
        0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::events::emit_game_closed<T0>(v5, v2, v4);
        if (0x2::table_vec::is_empty<Bet<T0>>(&v1.bets)) {
            0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::events::emit_game_completed<T0>(v5, v2);
    ...
    public fun create_game<T0>(arg0: &mut 0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::unihouse::UniHouse, arg1: &mut RouletteConfig<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v4 = Game<T0>{
            ...
            max_risk           : v1,
            risk_manager       : 0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::risk_manager::new_manager(),
        ...
        0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::events::emit_game_created<T0>(v3, 0x2::object::id<Game<T0>>(&v4));
        v3
    }
    ...
    public fun place_bet<T0>(arg0: &mut 0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::unihouse::UniHouse, arg1: &mut RouletteConfig<T0>, arg2: &0x2::clock::Clock, arg3: 0x2::coin::Coin<T0>, arg4: u8, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<0x1::string::String>, arg7: 0x1::option::Option<0x2::object::ID>, arg8: 0x1::option::Option<0x1::string::String>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let (_, _) = 0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::risk_manager::add_risk(&mut v1.risk_manager, arg4, arg5, 0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::bet_manager::get_bet_payout(v0, arg4));
        let v4 = borrow_current_game_mut<T0>(arg1);
        assert!(0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::risk_manager::total_risk(&v4.risk_manager) <= v4.max_risk, 0);
        ...
        0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::events::emit_place_bet<T0>(v4.round, 0x2::object::id<Game<T0>>(v4), v8, v6.bet_type, v6.bet_number, v7, v6.player);
    ...
    public fun settle_bets<T0>(arg0: &mut 0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::unihouse::UniHouse, arg1: &mut RouletteConfig<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x1::vector::empty<0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::events::BetResult<T0>>();
        v0.status = 2;
        let v6 = v0.result_roll;
        while (v1 < v3) {
            let v7 = 0x2::table_vec::borrow_mut<Bet<T0>>(&mut v0.bets, v1);
            let v8 = 0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::bet_manager::won_bet(v7.bet_type, v6, v7.bet_number);
            if (arg5 != v8) {
                v1 = v1 + 1;
                continue
            };
            ...
            let v11 = 0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::bet_manager::get_bet_payout(v10, v7.bet_type);
            0x1::vector::push_back<0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::events::BetResult<T0>>(&mut v5, 0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::events::new_bet_result<T0>(*0x2::object::uid_as_inner(&v7.id), v8, v7.bet_type, v7.bet_number, v10, v7.player));
        ...
        0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::events::emit_game_settlement<T0>(arg2, v14, v6, v5);
        if (v0.settled_bets_count == v4) {
            ...
            0x362fa9b899c07310fd98913081d2ba24c747ae725e6ef6a7b1bfde0a9e45d600::events::emit_game_completed<T0>(v0.round, v14);
        };
    }

    public fun update_verifier_config<T0>(arg0: &AdminCap, arg1: &mut RouletteConfig<T0>, arg2: u64, arg3: u64, arg4: u64) {
