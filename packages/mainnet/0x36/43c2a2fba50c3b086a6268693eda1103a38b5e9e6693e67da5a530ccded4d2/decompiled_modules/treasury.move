module 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::treasury {
    ...
    public(friend) fun set_split_internal(arg0: &mut FeeSplit, arg1: u64, arg2: u64, arg3: u64, arg4: u64) {
        assert!(arg1 + arg2 + arg3 + arg4 == 10000, 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_BAD_SPLIT());
    ...
    public fun split_and_route_internal(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &FeeSplit, arg2: &mut Vaults, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = (((v0 as u256) * (arg1.faithgg_bps as u256) / 10000) as u64);
        let v2 = (((v0 as u256) * (arg1.manifest_bps as u256) / 10000) as u64);
        let v3 = (((v0 as u256) * (arg1.pilgrimage_bps as u256) / 10000) as u64);
        let v4 = v0 - v1 - v2 - v3;
        if (v1 > 0) {
    ...
    public(friend) fun withdraw_faithgg_internal(arg0: &mut Vaults, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
    ...
    public(friend) fun withdraw_manifest_buyback_internal(arg0: &mut Vaults, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
    ...
    public(friend) fun withdraw_ops_internal(arg0: &mut Vaults, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
    ...
    public(friend) fun withdraw_pilgrimage_internal(arg0: &mut Vaults, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
