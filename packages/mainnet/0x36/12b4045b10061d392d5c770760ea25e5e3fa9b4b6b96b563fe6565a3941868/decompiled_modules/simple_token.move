module 0x3612b4045b10061d392d5c770760ea25e5e3fa9b4b6b96b563fe6565a3941868::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"nunu", b"nunu", b"Simple Token showcases", 0x1::option::none<0x2::url::Url>(), arg1);
