module 0x36f19c2e6e24fd937e126b61477206bf0f8570089f5c101340905d8ca47199b1::reward5184 {
    struct REWARD5184 has drop {
        dummy_field: bool,
    }

    struct TICKET_5184 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5184(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5184>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5184>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5184, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5184>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5184>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5184>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5184>>(v5, 0x2::tx_context::sender(arg1));
    }
