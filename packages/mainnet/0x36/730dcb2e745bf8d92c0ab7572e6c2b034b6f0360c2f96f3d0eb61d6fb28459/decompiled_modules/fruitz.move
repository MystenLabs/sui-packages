module 0x36730dcb2e745bf8d92c0ab7572e6c2b034b6f0360c2f96f3d0eb61d6fb28459::fruitz {
    ...
    fun init(arg0: FRUITZ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Fruitz"));
