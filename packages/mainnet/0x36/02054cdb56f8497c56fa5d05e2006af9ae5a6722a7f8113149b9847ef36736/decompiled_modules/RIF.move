module 0x3602054cdb56f8497c56fa5d05e2006af9ae5a6722a7f8113149b9847ef36736::RIF {
    struct RIF has drop {
        dummy_field: bool,
    }

    fun init(arg0: RIF, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<RIF>(arg0, 2, b"RIF", b"Rifampicin", b"Rifampicin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/tI5plQVJ65zAvrAaDtBMp73DcfclXPsFnxjG49hWz7Q?ext=png")), arg1);
