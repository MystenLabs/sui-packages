module 0x369ebf559c4614dfbbc053b7f30b11906768e6246e4a5121a27fca200e1667c6::reward3041 {
    struct REWARD3041 has drop {
        dummy_field: bool,
    }

    struct TICKET_3041 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3041(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3041>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3041>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3041, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3041>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3041>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3041>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3041>>(v5, 0x2::tx_context::sender(arg1));
    }
