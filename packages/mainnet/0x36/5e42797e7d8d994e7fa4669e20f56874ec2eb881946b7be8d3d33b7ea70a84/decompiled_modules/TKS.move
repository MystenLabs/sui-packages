module 0x5f8154cb84adc17dc3fd36b766ef20d48649ef01b532c6ff181f5a974bef68c6::TKS {
    ...
    public entry fun transfer_bulk(arg0: 0x2::coin::Coin<TKS>, arg1: vector<address>, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<TKS>(&arg0) >= v1, 101);
        let v3 = 0;
        while (v3 < v0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<TKS>>(0x2::coin::split<TKS>(&mut arg0, *0x1::vector::borrow<u64>(&arg2, v3), arg3), *0x1::vector::borrow<address>(&arg1, v3));
            v3 = v3 + 1;
        };
        0x2::pay::keep<TKS>(arg0, arg3);
    }

    public entry fun transfer_inno_protocol_reserve(arg0: 0x2::coin::Coin<TKS>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<TKS>(&arg0) >= arg1, 1);
        0x2::pay::keep<TKS>(arg0, arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<TKS>>(0x2::coin::split<TKS>(&mut arg0, arg1, arg3), arg2);
    }
