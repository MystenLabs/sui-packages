module 0x3675de4dda0cd92e9f7c1a2c95e39dbe8a8ab513a391edf0a2ee957ca174f88f::universal_router {
    ...
    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: Route, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        check_amount_threshold<T1>(&v1, 0x3675de4dda0cd92e9f7c1a2c95e39dbe8a8ab513a391edf0a2ee957ca174f88f::math::mul_div(1000000 - v5, v4, 1000000));
        let v10 = &mut v1;
