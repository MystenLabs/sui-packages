module 0x36e53b63f6d1d1a18045aaefec87cd98af239344db40171ee37df16d3dd33450::arboretum {
    ...
    entry fun claim_reward(arg0: &mut Registry, arg1: &mut Seed, arg2: &mut Sapling, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 12);
        let v0 = 0x2::tx_context::sender(arg4);
        assert_seed_owner(arg1, arg4);
        assert_seed_current(arg0, arg1);
        assert!(0x2::object::id<Sapling>(arg2) == arg1.sapling_id, 3);
        ...
        let v7 = v4 * v6 / v5;
        remove_seed_growth_points(arg0, arg1, v0);
        arg2.total_sui_harvested = arg2.total_sui_harvested + v7;
        let v8 = RewardClaimed{
            owner       : v0,
            amount_mist : v7,
        };
        0x2::event::emit<RewardClaimed>(v8);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.reward_pool, v7), arg4), v0);
    }
