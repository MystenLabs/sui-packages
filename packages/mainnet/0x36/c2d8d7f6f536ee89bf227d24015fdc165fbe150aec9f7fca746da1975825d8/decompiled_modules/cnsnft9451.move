module 0x36c2d8d7f6f536ee89bf227d24015fdc165fbe150aec9f7fca746da1975825d8::cnsnft9451 {
    struct CNSNFT9451 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9451, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9451>(arg0, arg1);
