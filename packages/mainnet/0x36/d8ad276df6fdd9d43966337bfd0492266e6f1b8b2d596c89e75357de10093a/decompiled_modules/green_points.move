module 0x36d8ad276df6fdd9d43966337bfd0492266e6f1b8b2d596c89e75357de10093a::green_points {
    ...
    public fun create_board(arg0: &mut 0x2::tx_context::TxContext) : Board {
        Board{
    ...
    public fun create_catalog(arg0: &mut 0x2::tx_context::TxContext) : Catalog {
    ...
    public fun create_profile(arg0: &signer, arg1: &mut 0x2::tx_context::TxContext) : Profile {
        Profile{
    ...
    public fun do_activity(arg0: &mut Profile, arg1: &Catalog, arg2: &mut Board, arg3: u64) {
        let v0 = 0x2::table::borrow<u64, Activity>(&arg1.list, arg3);
        let v1 = arg0.points + v0.points;
        arg0.points = v1;
        arg0.rank = rank_for_points(v1);
        if (0x2::table::contains<address, u64>(&arg2.scores, arg0.owner)) {
            let v2 = 0x2::table::borrow_mut<address, u64>(&mut arg2.scores, arg0.owner);
            *v2 = *v2 + v0.points;
        } else {
            0x2::table::add<address, u64>(&mut arg2.scores, arg0.owner, v0.points);
        };
    }
