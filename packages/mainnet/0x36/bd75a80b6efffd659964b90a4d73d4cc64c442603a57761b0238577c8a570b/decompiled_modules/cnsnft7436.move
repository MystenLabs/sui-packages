module 0x36bd75a80b6efffd659964b90a4d73d4cc64c442603a57761b0238577c8a570b::cnsnft7436 {
    struct CNSNFT7436 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7436, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7436>(arg0, arg1);
