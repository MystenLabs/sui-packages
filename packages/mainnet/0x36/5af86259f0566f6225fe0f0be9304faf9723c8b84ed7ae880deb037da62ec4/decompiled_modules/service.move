module 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::service {
    ...
    public(friend) fun get_feature<T0, T1: store + key>(arg0: &Service) : &T1 {
        0x2::dynamic_object_field::borrow<0x1::string::String, T1>(&arg0.id, 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::get_key_by_struct<T0>())
    }

    public(friend) fun get_feature_mut<T0, T1: store + key>(arg0: &mut Service) : &mut T1 {
        0x2::dynamic_object_field::borrow_mut<0x1::string::String, T1>(&mut arg0.id, 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::get_key_by_struct<T0>())
    }
