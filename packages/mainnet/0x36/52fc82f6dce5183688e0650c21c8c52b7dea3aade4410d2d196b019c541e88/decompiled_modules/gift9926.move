module 0x3652fc82f6dce5183688e0650c21c8c52b7dea3aade4410d2d196b019c541e88::gift9926 {
    struct GIFT9926 has drop {
        dummy_field: bool,
    }

    struct TICKET_9926 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9926(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9926>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9926>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9926, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9926>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9926>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9926>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9926>>(v5, 0x2::tx_context::sender(arg1));
    }
