module 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_staker {
    ...
    public(friend) fun random_validator_address_high_apy(arg0: &mut SuidoubleLiquidStaker, arg1: &mut 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: vector<u8>) : address {
        ...
        if (v0 > 1) {
            let v1 = v0 - 1;
            while (v1 > 0) {
                let v2 = 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::validator_address_by_pool_id(arg1, 0x3::staking_pool::pool_id(0x1::vector::borrow<0x3::staking_pool::StakedSui>(&arg0.staked_pool, v1)));
                if (0x1::option::is_some<address>(&v2)) {
                    return 0x1::option::destroy_some<address>(v2)
                };
                v1 = v1 - 1;
            };
        };
    ...
    public(friend) fun stake_sui_v2(arg0: &mut SuidoubleLiquidStaker, arg1: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg2: &mut 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::SuidoubleLiquidStats, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (v1 > 0) {
            v2 = v0;
            let v3 = 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::get_and_consume_metadata_next_validator(arg2);
            if (0x1::option::is_some<address>(&v3)) {
                let v4 = 0x1::option::destroy_some<address>(v3);
                let v5 = 0x3::sui_system::request_add_stake_non_entry(arg3, 0x2::coin::take<0x2::sui::SUI>(arg1, v0, arg4), v4, arg4);
                0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::store_address(arg2, 0x3::staking_pool::pool_id(&v5), v4);
                0x1::vector::push_back<0x3::staking_pool::StakedSui>(&mut arg0.staked_pool, v5);
                arg0.staked_amount = arg0.staked_amount + v0;
            } else {
                if (v0 / 1000000000 > 5) {
                    let v6 = 0x2::object::new(arg4);
                    0x2::object::delete(v6);
                    let v7 = random_validator_address_high_apy(arg0, arg2, arg3, 0x2::object::uid_to_bytes(&v6));
                    let v8 = 0x2::coin::take<0x2::sui::SUI>(arg1, v0 * 4 / 5, arg4);
                    arg0.staked_amount = arg0.staked_amount + 0x2::coin::value<0x2::sui::SUI>(&v8);
                    0x1::vector::push_back<0x3::staking_pool::StakedSui>(&mut arg0.staked_pool, 0x3::sui_system::request_add_stake_non_entry(arg3, v8, v7, arg4));
                    v2 = 0x2::balance::value<0x2::sui::SUI>(arg1);
                };
                let v9 = 0x2::object::new(arg4);
                0x2::object::delete(v9);
                let v10 = random_validator_address(arg3, 0x2::object::uid_to_bytes(&v9));
                let v11 = 0x3::sui_system::request_add_stake_non_entry(arg3, 0x2::coin::take<0x2::sui::SUI>(arg1, v2, arg4), v10, arg4);
                0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats::store_address(arg2, 0x3::staking_pool::pool_id(&v11), v10);
                0x1::vector::push_back<0x3::staking_pool::StakedSui>(&mut arg0.staked_pool, v11);
