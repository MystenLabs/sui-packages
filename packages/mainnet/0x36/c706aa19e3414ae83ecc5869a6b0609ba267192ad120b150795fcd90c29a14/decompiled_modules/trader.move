module 0x36c706aa19e3414ae83ecc5869a6b0609ba267192ad120b150795fcd90c29a14::trader {
    ...
    public entry fun mint(arg0: &mut 0x36c706aa19e3414ae83ecc5869a6b0609ba267192ad120b150795fcd90c29a14::config::GlobalConfig, arg1: &mut HostController, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x36c706aa19e3414ae83ecc5869a6b0609ba267192ad120b150795fcd90c29a14::config::assert_if_version_not_matched(arg0, 1);
        assert_if_already_minted(arg1, arg6);
        ...
        let v4 = Mint{
            trader_id      : *0x2::object::uid_as_inner(&v3.id),
            new_first_name : v0,
            new_last_name  : v1,
        ...
        0x2::table::add<address, 0x2::object::ID>(&mut arg1.mint_record, 0x2::tx_context::sender(arg6), *0x2::object::uid_as_inner(&v3.id));
        0x2::transfer::transfer<Trader>(v3, 0x2::tx_context::sender(arg6));
    }
    ...
    public fun rename(arg0: &0x36c706aa19e3414ae83ecc5869a6b0609ba267192ad120b150795fcd90c29a14::config::GlobalConfig, arg1: 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg2: &mut Trader, arg3: &mut 0x2::tx_context::TxContext) {
        0x36c706aa19e3414ae83ecc5869a6b0609ba267192ad120b150795fcd90c29a14::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun updatePfp(arg0: &0x36c706aa19e3414ae83ecc5869a6b0609ba267192ad120b150795fcd90c29a14::config::GlobalConfig, arg1: &mut Trader, arg2: 0x1::string::String, arg3: 0x1::string::String) {
        0x36c706aa19e3414ae83ecc5869a6b0609ba267192ad120b150795fcd90c29a14::config::assert_if_version_not_matched(arg0, 1);
        arg1.pfp_img = arg2;
        arg1.card_img = arg3;
        let v0 = UpdatePFP{
    ...
    public fun withdraw(arg0: &0x36c706aa19e3414ae83ecc5869a6b0609ba267192ad120b150795fcd90c29a14::config::AdminCap, arg1: &mut HostController, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
