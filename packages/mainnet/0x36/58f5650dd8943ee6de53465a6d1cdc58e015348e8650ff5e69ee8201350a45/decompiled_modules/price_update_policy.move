module 0x3658f5650dd8943ee6de53465a6d1cdc58e015348e8650ff5e69ee8201350a45::price_update_policy {
    struct PriceUpdateRequest<phantom T0> {
        for: 0x2::object::ID,
        receipts: 0x2::vec_set::VecSet<0x1::type_name::TypeName>,
        price_feeds: vector<0x3658f5650dd8943ee6de53465a6d1cdc58e015348e8650ff5e69ee8201350a45::price_feed::PriceFeed>,
    }
    ...
    public fun add_price_feed<T0, T1: drop>(arg0: T1, arg1: &mut PriceUpdateRequest<T0>, arg2: 0x3658f5650dd8943ee6de53465a6d1cdc58e015348e8650ff5e69ee8201350a45::price_feed::PriceFeed) {
        0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg1.receipts, 0x1::type_name::get<T1>());
        0x1::vector::push_back<0x3658f5650dd8943ee6de53465a6d1cdc58e015348e8650ff5e69ee8201350a45::price_feed::PriceFeed>(&mut arg1.price_feeds, arg2);
    }
    ...
    public fun confirm_request<T0>(arg0: PriceUpdateRequest<T0>, arg1: &PriceUpdatePolicy) : vector<0x3658f5650dd8943ee6de53465a6d1cdc58e015348e8650ff5e69ee8201350a45::price_feed::PriceFeed> {
    ...
    public fun new_request<T0>(arg0: &PriceUpdatePolicy) : PriceUpdateRequest<T0> {
        PriceUpdateRequest<T0>{
            ...
            price_feeds : 0x1::vector::empty<0x3658f5650dd8943ee6de53465a6d1cdc58e015348e8650ff5e69ee8201350a45::price_feed::PriceFeed>(),
        }
    }
