module 0xdcf96cb6435abead12decb0867a03feabfaf9264308a335feb94b83f5b573282::center {
    ...
    public fun destroy<T0>(arg0: &AdminCap, arg1: BiglottoCenter<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let BiglottoCenter {
            id                  : v0,
            versions            : _,
            jackpot             : v2,
            ...
            draw_config         : _,
            payouts_config      : _,
            jackpot_combination : _,
            bls_pub_key         : _,
        } = arg1;
        let v10 = v3;
        0x2::object::delete(v0);
        0x2::balance::join<T0>(&mut v10, v2);
