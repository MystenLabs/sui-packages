module 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::treasury {
    ...
    struct EndowmentOwnerSynced has copy, drop {
        endowment_id: 0x2::object::ID,
        character_id: 0x2::object::ID,
    ...
    fun apply_top_up<T0>(arg0: &mut Endowment<T0>, arg1: 0x2::coin::Coin<T0>) {
        0x2::coin::put<T0>(&mut arg0.principal, arg1);
    }
    ...
    fun assert_endowment_owner_via_hub<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::CharacterHub, arg1: &Endowment<T0>, arg2: address) {
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_hub_owner(arg0, arg2);
        assert!(arg1.owner == arg2, 200);
        assert!(arg1.character_id == 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::hub_character_id(arg0), 201);
    }
    ...
    fun assert_withdrawable_principal<T0>(arg0: &Endowment<T0>, arg1: u64) : u64 {
        ...
        0x2::balance::value<T0>(&arg0.principal) - arg1
    }
    ...
    public fun balance_mist<T0>(arg0: &Endowment<T0>) : u64 {
    ...
    public(friend) fun build_endowment<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : Endowment<T0> {
        ...
        let v2 = Endowment<T0>{
            ...
            keep_alive_target_mist   : 0,
            storage_target_mist      : 0,
            interaction_target_mist  : 0,
            keep_alive_reserve_mist  : 0,
    ...
    public(friend) fun deposit_donation<T0>(arg0: &mut Endowment<T0>, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: vector<u8>, arg4: u64) : u64 {
        let v0 = apply_inflow_fee<T0>(arg0, arg1, arg2, 0, false);
        let v1 = 0x2::balance::value<T0>(&v0);
        join_deposit_to_balance<T0>(arg0, v0, arg4);
        arg0.nonce = arg0.nonce + 1;
        let v2 = Donated{
            anft_id    : arg0.character_id,
            net_amount : v1,
        };
        0x2::event::emit<Donated>(v2);
        let v3 = DepositRecognized{
            anft_id            : arg0.character_id,
            chain              : arg3,
            amount             : v1,
        ...
        0x2::event::emit<DepositRecognized>(v3);
        v1
    }
    ...
    fun do_pay_storage_renewal<T0>(arg0: 0x2::object::ID, arg1: &mut Endowment<T0>, arg2: &mut 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::storage_policy::StoragePolicy, arg3: &mut 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::storage_policy::StorageBlobRecord, arg4: u64, arg5: u64, arg6: u64, arg7: address, arg8: vector<u8>, arg9: vector<u8>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(arg6 > 0, 207);
        assert_hash(&arg8);
        assert_hash(&arg9);
        let v0 = mul_bps(arg6, 1000);
        assert!(0x2::balance::value<T0>(&arg1.principal) >= arg6 + v0, 224);
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::storage_policy::record_paid_renewal_from_endowment_by_id(arg0, arg2, arg3, arg4, arg5, arg6, arg8, arg9, arg10);
        if (v0 > 0) {
            0x2::balance::join<T0>(&mut arg1.fee_sink, 0x2::balance::split<T0>(&mut arg1.principal, v0));
        };
        arg1.nonce = arg1.nonce + 1;
        arg1.updated_at_ms = 0x2::clock::timestamp_ms(arg10);
        ...
        if (v0 > 0) {
            ...
            0x2::event::emit<AllocationFlow>(v2);
        };
        let v3 = StorageRenewalPaidFromEndowment{
            endowment_id              : 0x2::object::uid_to_inner(&arg1.id),
            character_id              : arg0,
            policy_id                 : 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::storage_policy::storage_policy_id(arg2),
            record_id                 : 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::storage_policy::storage_blob_record_id(arg3),
            payer                     : 0x2::tx_context::sender(arg11),
            renewal_provider          : arg7,
            amount_micros             : arg6,
            target_expiry_ms          : arg4,
            renewal_epochs            : arg5,
            receipt_hash              : arg8,
            walrus_tx_digest          : arg9,
            storage_allocation_micros : 0x2::balance::value<T0>(&arg1.principal),
            nonce                     : arg1.nonce,
            timestamp_ms              : arg1.updated_at_ms,
        };
        0x2::event::emit<StorageRenewalPaidFromEndowment>(v3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.principal, arg6, arg11), arg7);
    }

    fun do_withdraw_principal<T0>(arg0: &mut Endowment<T0>, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        arg0.nonce = arg0.nonce + 1;
        arg0.updated_at_ms = 0x2::clock::timestamp_ms(arg3);
        let v0 = EndowmentWithdrawalRecorded{
            endowment_id             : 0x2::object::uid_to_inner(&arg0.id),
            character_id             : arg0.character_id,
            owner                    : 0x2::tx_context::sender(arg4),
            recipient                : arg2,
            amount_mist              : arg1,
            remaining_principal_mist : assert_withdrawable_principal<T0>(arg0, arg1),
            keep_alive_reserve_mist  : 0,
            nonce                    : arg0.nonce,
            timestamp_ms             : arg0.updated_at_ms,
        };
        0x2::event::emit<EndowmentWithdrawalRecorded>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.principal, arg1, arg4), arg2);
    }

    fun do_withdraw_principal_with_hold<T0>(arg0: &mut Endowment<T0>, arg1: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::fiat_hold::FiatHoldLedger, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::fiat_hold::ledger_character_id(arg1) == arg0.character_id, 230);
        let v0 = assert_withdrawable_principal<T0>(arg0, arg2);
        let v1 = 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::fiat_hold::held_floor_mist(arg1, arg4);
        assert!(v0 >= v1, 229);
        arg0.nonce = arg0.nonce + 1;
        arg0.updated_at_ms = 0x2::clock::timestamp_ms(arg4);
        let v2 = EndowmentWithdrawalRecorded{
            endowment_id             : 0x2::object::uid_to_inner(&arg0.id),
            character_id             : arg0.character_id,
            owner                    : 0x2::tx_context::sender(arg5),
            recipient                : arg3,
            amount_mist              : arg2,
            remaining_principal_mist : v0,
            keep_alive_reserve_mist  : v1,
            nonce                    : arg0.nonce,
            timestamp_ms             : arg0.updated_at_ms,
        };
        0x2::event::emit<EndowmentWithdrawalRecorded>(v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.principal, arg2, arg5), arg3);
    }
    ...
    entry fun heartbeat<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut Endowment<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_endowment_matches<T0>(arg0, arg1);
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_not_paused(arg0);
        let (v0, v1, v2, v3) = run_heartbeat<T0>(arg1, arg2, arg3, arg4);
        if (v1) {
            let v4 = EndowmentHeartbeatRecorded{
                endowment_id               : 0x2::object::uid_to_inner(&arg1.id),
                character_id               : 0x2::object::id<0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter>(arg0),
                keeper                     : 0x2::tx_context::sender(arg4),
                net_yield_mist             : 0x2::coin::value<T0>(&arg2),
                keep_alive_allocated_mist  : 0,
                storage_allocated_mist     : 0,
                interaction_allocated_mist : 0,
                residual_compound_mist     : v2,
                bounty_mist                : v3,
            ...
            0x2::event::emit<EndowmentHeartbeatRecorded>(v4);
        };
    ...
    fun join_deposit_to_balance<T0>(arg0: &mut Endowment<T0>, arg1: 0x2::balance::Balance<T0>, arg2: u64) : u64 {
    ...
    entry fun pay_storage_renewal<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::authority::AgentCap, arg2: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::authority::RevocationRegistry, arg3: &mut Endowment<T0>, arg4: &mut 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::storage_policy::StoragePolicy, arg5: &mut 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::storage_policy::StorageBlobRecord, arg6: u64, arg7: u64, arg8: u64, arg9: address, arg10: vector<u8>, arg11: vector<u8>, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_not_paused(arg0);
        do_pay_storage_renewal<T0>(0x2::object::id<0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter>(arg0), arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13);
    }

    entry fun pay_storage_renewal_via_hub<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::CharacterHub, arg1: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::authority::AgentCap, arg2: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::authority::RevocationRegistry, arg3: &mut Endowment<T0>, arg4: &mut 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::storage_policy::StoragePolicy, arg5: &mut 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::storage_policy::StorageBlobRecord, arg6: u64, arg7: u64, arg8: u64, arg9: address, arg10: vector<u8>, arg11: vector<u8>, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::authority::assert_cap_scope_via_hub(arg0, arg1, arg2, arg9, 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::authority::scope_authorize_payment(), arg12, arg13);
        assert!(arg3.character_id == 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::hub_character_id(arg0), 201);
        do_pay_storage_renewal<T0>(0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::hub_character_id(arg0), arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13);
    }
    ...
    public fun preview_wind_down<T0>(arg0: &Endowment<T0>) : (u64, u64, u64) {
        (0x2::balance::value<T0>(&arg0.unspent_credit_liability), 0x2::balance::value<T0>(&arg0.principal), 0)
    }
    ...
    fun run_heartbeat<T0>(arg0: &mut Endowment<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, bool, u64, u64) {
        let v0 = 0x2::clock::timestamp_ms(arg2);
        let v1 = 0x2::coin::value<T0>(&arg1);
        if (v1 == 0) {
            return (arg1, false, 0, 0)
        };
        ...
        let v6 = arg0.heartbeat_bounty_mist;
        if (v6 > 0) {
        ...
        let v8 = mul_bps(0x2::balance::value<T0>(&v5), 1000);
        if (v8 > 0) {
            0x2::balance::join<T0>(&mut arg0.fee_sink, 0x2::balance::split<T0>(&mut v5, v8));
        ...
        (0x2::coin::take<T0>(&mut v5, v6, arg3), true, v10, v6)
    }
    ...
    entry fun settle_endowment_interaction_payment<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &TreasuryPolicy, arg2: &mut Endowment<T0>, arg3: vector<u8>, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: address, arg7: address, arg8: vector<u8>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<T0>(&mut arg2.principal, v1);
    ...
    entry fun sweep_fees_to_treasury<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut Endowment<T0>, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_endowment_owner<T0>(arg0, arg1, 0x2::tx_context::sender(arg4));
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_not_paused(arg0);
        let v0 = 0x2::balance::value<T0>(&arg1.fee_sink);
        assert!(v0 > 0, 207);
        arg1.nonce = arg1.nonce + 1;
        ...
        let v2 = FeesSwept{
            ...
            amount_mist             : v0,
            remaining_fee_sink_mist : 0x2::balance::value<T0>(&arg1.fee_sink),
            nonce                   : arg1.nonce,
            timestamp_ms            : arg1.updated_at_ms,
        };
        0x2::event::emit<FeesSwept>(v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.fee_sink, v0, arg4), arg2);
    }

    entry fun sync_endowment_owner_via_hub<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::CharacterHub, arg1: &mut Endowment<T0>, arg2: &0x2::clock::Clock) {
        assert!(arg1.character_id == 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::hub_character_id(arg0), 201);
        let v0 = 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::hub_owner(arg0);
        if (arg1.owner == v0) {
            return
        };
        arg1.owner = v0;
        ...
        0x2::event::emit<EndowmentOwnerSynced>(v1);
    }
    ...
    entry fun top_up_endowment<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut Endowment<T0>, arg2: u8, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 207);
        0x2::coin::put<T0>(&mut arg1.principal, arg3);
        arg1.nonce = arg1.nonce + 1;
        arg1.updated_at_ms = 0x2::clock::timestamp_ms(arg4);
    ...
    entry fun withdraw_endowment_principal<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut Endowment<T0>, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_endowment_owner<T0>(arg0, arg1, 0x2::tx_context::sender(arg5));
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_not_paused(arg0);
        do_withdraw_principal<T0>(arg1, arg2, arg3, arg4, arg5);
    }

    entry fun withdraw_endowment_principal_via_hub<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::CharacterHub, arg1: &mut Endowment<T0>, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_endowment_owner_via_hub<T0>(arg0, arg1, 0x2::tx_context::sender(arg5));
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_hub_not_paused(arg0);
        do_withdraw_principal<T0>(arg1, arg2, arg3, arg4, arg5);
    }

    entry fun withdraw_endowment_principal_with_hold<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut Endowment<T0>, arg2: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::fiat_hold::FiatHoldLedger, arg3: u64, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_endowment_owner<T0>(arg0, arg1, 0x2::tx_context::sender(arg6));
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_not_paused(arg0);
        do_withdraw_principal_with_hold<T0>(arg1, arg2, arg3, arg4, arg5, arg6);
    }

    entry fun withdraw_endowment_principal_with_hold_via_hub<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::CharacterHub, arg1: &mut Endowment<T0>, arg2: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::fiat_hold::FiatHoldLedger, arg3: u64, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_endowment_owner_via_hub<T0>(arg0, arg1, 0x2::tx_context::sender(arg6));
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_hub_not_paused(arg0);
        do_withdraw_principal_with_hold<T0>(arg1, arg2, arg3, arg4, arg5, arg6);
    }
