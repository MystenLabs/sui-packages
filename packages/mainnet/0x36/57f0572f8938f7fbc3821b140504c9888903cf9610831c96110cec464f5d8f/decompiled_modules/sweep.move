module 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::sweep {
    ...
    fun do_sweep_receive_wallet<T0>(arg0: &mut ReceiveWallet<T0>, arg1: &mut 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::treasury::Endowment<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.endowment_id == 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::treasury::endowment_object_id<T0>(arg1), 413);
        let v0 = 0x2::clock::timestamp_ms(arg2);
        if (arg0.last_sweep_ms > 0) {
            assert!(v0 >= arg0.last_sweep_ms + arg0.sweep_interval_ms, 411);
        };
        let v1 = 0x2::balance::value<T0>(&arg0.inbound);
        assert!(v1 >= arg0.sweep_threshold_mist, 410);
        let v2 = min_u64(v1, arg0.per_sweep_cap_mist);
        let v3 = arg0.sweep_bounty_mist;
        let v4 = 0x2::balance::split<T0>(&mut arg0.inbound, v2);
        arg0.last_sweep_ms = v0;
        arg0.nonce = arg0.nonce + 1;
        arg0.updated_at_ms = v0;
        let v5 = ReceiveWalletSwept{
            receive_wallet_id        : 0x2::object::uid_to_inner(&arg0.id),
            character_id             : arg0.character_id,
            endowment_id             : arg0.endowment_id,
            keeper                   : 0x2::tx_context::sender(arg3),
            swept_mist               : v2,
            bounty_mist              : v3,
            credited_mist            : 0x2::balance::value<T0>(&v4),
            remaining_inbound_mist   : 0x2::balance::value<T0>(&arg0.inbound),
            endowment_principal_mist : 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::treasury::deposit_swept_principal<T0>(arg1, v4, arg2),
            nonce                    : arg0.nonce,
            epoch_ms                 : v0,
        };
        0x2::event::emit<ReceiveWalletSwept>(v5);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v4, v3, arg3), 0x2::tx_context::sender(arg3));
    }
    ...
    entry fun sweep_receive_wallet<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut ReceiveWallet<T0>, arg2: &mut 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::treasury::Endowment<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_not_paused(arg0);
        do_sweep_receive_wallet<T0>(arg1, arg2, arg3, arg4);
    }

    entry fun sweep_receive_wallet_via_hub<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::CharacterHub, arg1: &mut ReceiveWallet<T0>, arg2: &mut 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::treasury::Endowment<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.character_id == 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::hub_character_id(arg0), 401);
        assert!(0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::treasury::endowment_character_id<T0>(arg2) == 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::hub_character_id(arg0), 401);
