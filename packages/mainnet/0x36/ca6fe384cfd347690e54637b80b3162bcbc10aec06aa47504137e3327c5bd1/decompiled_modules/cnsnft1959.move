module 0x36ca6fe384cfd347690e54637b80b3162bcbc10aec06aa47504137e3327c5bd1::cnsnft1959 {
    struct CNSNFT1959 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1959, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2656"));
        let v4 = 0x2::package::claim<CNSNFT1959>(arg0, arg1);
