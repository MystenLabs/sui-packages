module 0x3602db18a9fad3b46ebef9de35934b0f2ed0d72bd6fc59f6301d32d8a4da8e42::character {
    ...
    public fun create_character(arg0: &mut CharacterNameRegistry, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : Character {
    ...
    fun init(arg0: CHARACTER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://aresrpg.world/character/{type}"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://aresrpg.world/character/{type}.png"));
