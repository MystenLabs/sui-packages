module 0x36e0fceb2d14ee3926315a26508a4c1dd8518e7eb9f35d9cdc7109116624f581::gusd_usdc_vault {
    ...
    public fun mint_gusd(arg0: &0x36e0fceb2d14ee3926315a26508a4c1dd8518e7eb9f35d9cdc7109116624f581::version::Version, arg1: &mut USDCVault, arg2: &mut 0x36e0fceb2d14ee3926315a26508a4c1dd8518e7eb9f35d9cdc7109116624f581::market::Market, arg3: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x36e0fceb2d14ee3926315a26508a4c1dd8518e7eb9f35d9cdc7109116624f581::version::assert_current_version(arg0);
        assert!(!0x36e0fceb2d14ee3926315a26508a4c1dd8518e7eb9f35d9cdc7109116624f581::market::is_paused(arg2), 9);
        ...
        let v1 = v0 * 1000;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x9017953faf6b8ba1889fee20a49837b406d45f664097b0312c688fae536e2719::coin_gusd::COIN_GUSD>>(0x36e0fceb2d14ee3926315a26508a4c1dd8518e7eb9f35d9cdc7109116624f581::market::mint_gusd(arg2, v1, 0x2::clock::timestamp_ms(arg4) / 1000, arg5), 0x2::tx_context::sender(arg5));
        let v2 = MintEvent{
    ...
    public fun redeem_gusd(arg0: &0x36e0fceb2d14ee3926315a26508a4c1dd8518e7eb9f35d9cdc7109116624f581::version::Version, arg1: &mut USDCVault, arg2: &mut 0x36e0fceb2d14ee3926315a26508a4c1dd8518e7eb9f35d9cdc7109116624f581::market::Market, arg3: 0x2::coin::Coin<0x9017953faf6b8ba1889fee20a49837b406d45f664097b0312c688fae536e2719::coin_gusd::COIN_GUSD>, arg4: &mut 0x2::tx_context::TxContext) {
        0x36e0fceb2d14ee3926315a26508a4c1dd8518e7eb9f35d9cdc7109116624f581::version::assert_current_version(arg0);
        assert!(!0x36e0fceb2d14ee3926315a26508a4c1dd8518e7eb9f35d9cdc7109116624f581::market::is_paused(arg2), 9);
        let v0 = 0x2::coin::value<0x9017953faf6b8ba1889fee20a49837b406d45f664097b0312c688fae536e2719::coin_gusd::COIN_GUSD>(&arg3);
        assert!(v0 > 0, 2);
        let v1 = v0 / 1000;
        assert!(v1 > 0, 2);
        ...
        assert!(v3 < v1, 6);
        let v4 = v1 - v3;
        0x36e0fceb2d14ee3926315a26508a4c1dd8518e7eb9f35d9cdc7109116624f581::market::burn_gusd(arg2, arg3, arg4);
