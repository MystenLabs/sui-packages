module 0x36dc5b66d45ff525cca560fc9a7bda868e819c9db9ed526f0e9e318453c3148a::cnsnft2581 {
    struct CNSNFT2581 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2581, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2581>(arg0, arg1);
