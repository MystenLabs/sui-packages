module 0x36e7e206dd883421b912c2eea9758b6cd15e10fa54441ba0e692534ad3b04a8c::collector {
    ...
    public entry fun pay_service_fee(arg0: &mut FeeCollector, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u8, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = *0x2::table::borrow<u8, u64>(&arg0.fees, arg2) * arg3;
        ...
        if (arg2 == 1) {
            ...
            arg0.total_multisends = arg0.total_multisends + arg3;
        } else if (arg2 == 5) {
