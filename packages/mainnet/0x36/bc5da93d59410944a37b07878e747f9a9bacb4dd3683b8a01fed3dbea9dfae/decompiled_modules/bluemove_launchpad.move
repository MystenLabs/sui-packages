module 0x36bc5da93d59410944a37b07878e747f9a9bacb4dd3683b8a01fed3dbea9dfae::bluemove_launchpad {
    ...
    public entry fun burn_nft(arg0: EmojiXoX, arg1: &mut 0x2::tx_context::TxContext) {
        let EmojiXoX {
            id          : v0,
            name        : v1,
            description : _,
        ...
        let v5 = BurnEvent{
            object_id : 0x2::object::id<EmojiXoX>(&arg0),
    ...
    public entry fun claim_nfts(arg0: &mut LaunchpadData, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v11 > 0) {
            ...
            let v18 = MintNFTEvent{
                object_id : 0x2::object::id<EmojiXoX>(&v17),
                creator   : v0,
                name      : v14,
            };
            0x2::event::emit<MintNFTEvent>(v18);
            0x2::transfer::public_transfer<EmojiXoX>(v17, v0);
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LaunchpadData{
            ...
            minted         : 0,
            current_nft    : 0,
            base_name      : 0x1::string::utf8(b"Emoji XoX #"),
            base_url       : 0x1::string::utf8(b"https://emojixox.mypinata.cloud/ipfs/Qmc1CDF11cZB74dibmR4VGZvHmDkuG2v8Z9ChYNknRXSV6/"),
            base_image_url : 0x1::string::utf8(b"https://emojixox.mypinata.cloud/ipfs/QmaXVKNDdBDyFn941FtPxXLzy2L4j4ZeYEB7Zv3ir1xHua/"),
            description    : 0x1::string::utf8(b"Don't get tired of talking, let express yourself with emojis. "),
            ...
            fund_address   : @0x634e3be496e959af405cb2de86c45f4f46fd187bd7fc987591cf4ca00d762fcb,
            balance        : 0x2::balance::zero<0x2::sui::SUI>(),
            total_nft      : v0,
            pre_mint       : 0,
        };
        let v2 = 0x2::tx_context::sender(arg1);
        let (v3, v4) = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::create_with_mint_cap<BLUEMOVE_LAUNCHPAD, EmojiXoX>(&arg0, 0x1::option::some<u64>(v0), arg1);
        let v5 = v3;
        let v6 = Witness{dummy_field: false};
        let v7 = 0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::from_witness<EmojiXoX, Witness>(v6);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::add_domain<EmojiXoX, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::creators::Creators>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::creators::new(0x2::vec_set::singleton<address>(v2)));
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::add_domain<EmojiXoX, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::display_info::DisplayInfo>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::display_info::new(0x1::string::utf8(b"Emoji XoX"), 0x1::string::utf8(b"Don't get tired of talking, let express yourself with emojis.")));
        ...
        let v11 = 0x2::display::new<EmojiXoX>(&v8, arg1);
        0x2::display::add<EmojiXoX>(&mut v11, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<EmojiXoX>(&mut v11, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<EmojiXoX>(&mut v11, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{image_url}"));
        0x2::display::add<EmojiXoX>(&mut v11, 0x1::string::utf8(b"tags"), 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::display::from_vec(v9));
        0x2::display::update_version<EmojiXoX>(&mut v11);
        0x2::transfer::public_transfer<0x2::display::Display<EmojiXoX>>(v11, 0x2::tx_context::sender(arg1));
        let (v12, v13) = 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::init_policy<EmojiXoX>(&v8, arg1);
        let v14 = v13;
        let v15 = v12;
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::enforce<EmojiXoX>(&mut v15, &v14);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::transfer_allowlist::enforce<EmojiXoX>(&mut v15, &v14);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::create_domain_and_add_strategy<EmojiXoX>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty::from_address(@0x634e3be496e959af405cb2de86c45f4f46fd187bd7fc987591cf4ca00d762fcb, arg1), 1000, arg1);
        0x2::transfer::public_transfer<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<EmojiXoX>>(v4, v2);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v8, v2);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<EmojiXoX>>(v14, v2);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<EmojiXoX>>(v15);
        0x2::transfer::public_share_object<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<EmojiXoX>>(v5);
    ...
    public entry fun pre_nfts(arg0: &mut LaunchpadData, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg1 > 0) {
            ...
            0x2::transfer::public_transfer<EmojiXoX>(v5, arg2);
            arg0.current_nft = v1;
            arg1 = arg1 - 1;
        };
    }
