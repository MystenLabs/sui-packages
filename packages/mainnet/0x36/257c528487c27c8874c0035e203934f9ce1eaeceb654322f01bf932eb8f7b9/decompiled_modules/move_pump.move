module 0x92fecee99603c0628ced2fbd37f85c05f6c0049c183eb6b1b58db24764c6c7bc::move_pump {
    ...
    public entry fun buy<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0x92fecee99603c0628ced2fbd37f85c05f6c0049c183eb6b1b58db24764c6c7bc::curves::calculate_token_amount_received(v2.virtual_sui_reserves, v2.virtual_token_reserves, v5 - v6) + 1;
        assert!(v7 <= v4, 2);
        assert!(v7 >= arg3, 8);
        let v8 = 0x2::coin::split<0x2::sui::SUI>(&mut arg1, v6, arg5);
        let v9 = 0x2::coin::zero<T0>(arg5);
        let (v10, v11) = swap<T0>(v2, v9, arg1, v7, 0, arg5);
        let v12 = v10;
