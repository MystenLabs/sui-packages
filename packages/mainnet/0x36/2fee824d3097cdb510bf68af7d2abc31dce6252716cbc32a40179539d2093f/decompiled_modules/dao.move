module 0x362fee824d3097cdb510bf68af7d2abc31dce6252716cbc32a40179539d2093f::dao {
    ...
    public entry fun create_dao<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: vector<address>, arg4: 0x2::coin::Coin<T1>, arg5: bool, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<T1>(0x2::coin::balance<T1>(&arg4));
        let v1 = 0x2::tx_context::sender(arg7);
        let v2 = DAO<T0, T1>{
            id                    : 0x2::object::new(arg7),
            start_time            : arg0,
            end_time              : arg1,
            lp_lock_duration      : arg6,
            lp_unlock_time        : 0,
            cap                   : arg2,
            owner                 : v1,
            ...
            investment            : 0x2::bag::new(arg7),
            investment_index      : 1,
        };
        0x2::transfer::share_object<DAO<T0, T1>>(v2);
        let v3 = DAOCreated<T0, T1>{
        ...
        0x2::event::emit<DAOCreated<T0, T1>>(v3);
    }
    ...
    public fun dao_is_whitelist<T0, T1>(arg0: &DAO<T0, T1>) : bool {
        arg0.is_whitelist
    }
    ...
    public entry fun fund_dao<T0, T1>(arg0: &mut DAO<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2;
        if (arg0.funded_amount + v2 > arg0.cap) {
            v3 = arg0.cap - arg0.funded_amount;
        };
