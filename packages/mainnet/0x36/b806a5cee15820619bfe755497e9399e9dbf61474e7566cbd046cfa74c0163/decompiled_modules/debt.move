module 0x36b806a5cee15820619bfe755497e9399e9dbf61474e7566cbd046cfa74c0163::debt {
    ...
    public fun calc_debt<T0>(arg0: &Debt, arg1: &mut 0x36b806a5cee15820619bfe755497e9399e9dbf61474e7566cbd046cfa74c0163::trusted_prices::TrustedPriceData) : u64 {
        calc_debt_raw(arg0, 0x1::type_name::get<T0>(), arg1)
    }

    public fun calc_debt_raw(arg0: &Debt, arg1: 0x1::type_name::TypeName, arg2: &mut 0x36b806a5cee15820619bfe755497e9399e9dbf61474e7566cbd046cfa74c0163::trusted_prices::TrustedPriceData) : u64 {
        ...
        while (!0x1::vector::is_empty<0x1::type_name::TypeName>(&v0)) {
            ...
            let v3 = 0x36b806a5cee15820619bfe755497e9399e9dbf61474e7566cbd046cfa74c0163::trusted_prices::pull_raw_price(arg2, v2, arg1);
            v1 = v1 + 0x36b806a5cee15820619bfe755497e9399e9dbf61474e7566cbd046cfa74c0163::price::calc_quote_out(&v3, *0x2::table::borrow<0x1::type_name::TypeName, u64>(&arg0.open_debt, v2));
        };
        v1
    }
