module 0x36e80bb811bcdb075eb872101f5f14f6532fc6744dc156eef720dc3b968c3a5a::voting {
    struct VotingRegistry has key {
        id: 0x2::object::UID,
        reviews: 0x2::table::Table<0x2::object::ID, ReviewRequest>,
        submitted_objects: 0x2::table::Table<0x1::string::String, 0x2::object::ID>,
        total_reviews: u64,
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = VotingRegistry{
            ...
            submitted_objects : 0x2::table::new<0x1::string::String, 0x2::object::ID>(arg0),
            total_reviews     : 0,
        };
    ...
    public entry fun submit_for_review(arg0: &mut VotingRegistry, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!0x2::table::contains<0x1::string::String, 0x2::object::ID>(&arg0.submitted_objects, arg1), 4);
        ...
        0x2::table::add<0x1::string::String, 0x2::object::ID>(&mut arg0.submitted_objects, arg1, v1);
