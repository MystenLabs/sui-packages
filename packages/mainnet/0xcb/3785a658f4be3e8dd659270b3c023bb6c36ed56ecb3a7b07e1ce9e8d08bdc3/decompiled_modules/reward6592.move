module 0xcb3785a658f4be3e8dd659270b3c023bb6c36ed56ecb3a7b07e1ce9e8d08bdc3::reward6592 {
    struct REWARD6592 has drop {
        dummy_field: bool,
    }

    struct TICKET_6592 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6592(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6592>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6592>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6592, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6592>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6592>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6592>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6592>>(v5, 0x2::tx_context::sender(arg1));
    }
