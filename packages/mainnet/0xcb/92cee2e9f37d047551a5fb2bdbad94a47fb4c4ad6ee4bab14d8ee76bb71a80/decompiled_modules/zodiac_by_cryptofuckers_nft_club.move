module 0xcb92cee2e9f37d047551a5fb2bdbad94a47fb4c4ad6ee4bab14d8ee76bb71a80::zodiac_by_cryptofuckers_nft_club {
    struct ZODIAC_BY_CRYPTOFUCKERS_NFT_CLUB has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ZODIAC_BY_CRYPTOFUCKERS_NFT_CLUB, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ZODIAC_BY_CRYPTOFUCKERS_NFT_CLUB>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Zodiac by CrYpToFuCkErS-NFT-CLUB"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Zodiac signs! Pick up yours!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreickiofxkx2n34jimpsqfohgjhafdddzf5a75zwlanpebuh4jxuffa"));
