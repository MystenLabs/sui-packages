module 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house {
    ...
    public(friend) fun join_with_fee<T0>(arg0: &mut House<T0>, arg1: 0x2::balance::Balance<T0>) {
        let v0 = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::math::mul_rate(0x2::balance::value<T0>(&arg1), 300000);
    ...
    public fun pool_changes(arg0: u64) : (u64, u64) {
        let v0 = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::math::mul_rate(arg0, 300000);
        (arg0 - v0, v0)
    }
    ...
    public(friend) fun split_with_reimbursement<T0>(arg0: &mut House<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(arg1 <= max_risk<T0>(arg0), 0);
        let v0 = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::math::mul_rate(arg1, 300000);
