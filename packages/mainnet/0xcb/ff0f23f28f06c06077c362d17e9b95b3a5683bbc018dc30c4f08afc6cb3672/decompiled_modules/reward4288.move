module 0xcbff0f23f28f06c06077c362d17e9b95b3a5683bbc018dc30c4f08afc6cb3672::reward4288 {
    struct REWARD4288 has drop {
        dummy_field: bool,
    }

    struct TICKET_4288 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4288(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4288>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4288>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4288, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4288>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4288>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4288>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4288>>(v5, 0x2::tx_context::sender(arg1));
    }
