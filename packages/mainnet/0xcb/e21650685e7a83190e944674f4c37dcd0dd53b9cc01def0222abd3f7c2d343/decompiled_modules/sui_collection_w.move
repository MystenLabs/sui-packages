module 0xcbe21650685e7a83190e944674f4c37dcd0dd53b9cc01def0222abd3f7c2d343::sui_collection_w {
    ...
    public entry fun DistributeReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            ...
            0x2::transfer::public_transfer<SUI_COLLECTION>(v0, 0x1::vector::pop_back<address>(&mut arg0));
        };
    }
    ...
    public entry fun mint_nft(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<MintEvent>(v1);
        0x2::transfer::public_transfer<SUI_COLLECTION>(v0, 0x2::tx_context::sender(arg0));
    }
