module 0xcbce39ace10d148d7dee7fbcabab6da2467acc51bd1a39df1304f12d4f3ce35e::cnsnft2602 {
    struct CNSNFT2602 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2602, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2602>(arg0, arg1);
