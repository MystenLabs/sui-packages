module 0xcbf333daabf3984dd4be97e3c44a94c7de72bc450b8a8312d4ea155f695ee95d::collection {
    struct HouseCollectionNFT has store, key {
        id: 0x2::object::UID,
        url: 0x2::url::Url,
        level: u64,
        attributes: 0xcbf333daabf3984dd4be97e3c44a94c7de72bc450b8a8312d4ea155f695ee95d::attributes::Attributes,
    }
    ...
    fun init(arg0: COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3;
        let v5 = v2;
        0xcbf333daabf3984dd4be97e3c44a94c7de72bc450b8a8312d4ea155f695ee95d::royalty_rule::add<HouseCollectionNFT>(&mut v5, &v4, 600, 0);
        0xcbf333daabf3984dd4be97e3c44a94c7de72bc450b8a8312d4ea155f695ee95d::kiosk_lock_rule::add<HouseCollectionNFT>(&mut v5, &v4);
    ...
    public(friend) fun mint_(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : HouseCollectionNFT {
        ...
        HouseCollectionNFT{
            id         : 0x2::object::new(arg1),
            url        : 0x2::url::new_unsafe_from_bytes(0xcbf333daabf3984dd4be97e3c44a94c7de72bc450b8a8312d4ea155f695ee95d::constants::get_nft_image((arg0 as u64))),
            level      : (arg0 as u64),
            attributes : 0xcbf333daabf3984dd4be97e3c44a94c7de72bc450b8a8312d4ea155f695ee95d::attributes::from_vec(&mut v0, &mut v2),
        }
    }
