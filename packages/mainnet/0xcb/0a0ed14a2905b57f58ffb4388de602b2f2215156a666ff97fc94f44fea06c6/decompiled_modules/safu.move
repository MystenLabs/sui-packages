module 0x4a68c41bfa2b908ce449e411d0e16718839a62780df0fee568bc027ee2d14ebb::safu {
    ...
    public fun refresh(arg0: &0x4a68c41bfa2b908ce449e411d0e16718839a62780df0fee568bc027ee2d14ebb::version::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        *0x1::vector::borrow_mut<u64>(&mut v0.info, 6) = arg4;
        let v1 = if (*0x1::vector::borrow<u64>(&v0.config, 6) > 0) {
            0
        } else {
            1
        };
        *0x1::vector::borrow_mut<u64>(&mut v0.info, 7) = v1;
        let v2 = if (*0x1::vector::borrow<u64>(&v0.config, 7) > 0) {
            0
        } else {
            1
        };
        *0x1::vector::borrow_mut<u64>(&mut v0.info, 8) = v2;
