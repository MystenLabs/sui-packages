module 0xcb185b8d5658eb2bcc470940824430858b528d1bc4f5b51bc44f82ebfaf4a57c::cnsnft8411 {
    struct CNSNFT8411 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8411, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3397"));
        let v4 = 0x2::package::claim<CNSNFT8411>(arg0, arg1);
