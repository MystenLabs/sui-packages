module 0xcb4dee85f5e93cab3a34f549d59eab8524898d493295f1db3eea4fe387085591::proposal_quota_registry {
        ...
        while (v2 < 0x1::vector::length<address>(&arg2)) {
            ...
            if (v0) {
                ...
                if (v7) {
                    ...
                    assert!(0x1::vector::length<QuotaEntry>(&arg0.quotas) < 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::max_quota_entries(), 1);
                    let v19 = QuotaEntry{
                        user : v3,
                        info : v6,
                    };
