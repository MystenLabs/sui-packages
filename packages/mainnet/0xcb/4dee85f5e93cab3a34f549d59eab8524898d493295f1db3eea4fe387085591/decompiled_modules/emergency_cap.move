module 0xcb4dee85f5e93cab3a34f549d59eab8524898d493295f1db3eea4fe387085591::emergency_cap {
    ...
    public fun assert_ready(arg0: &EmergencyCap, arg1: &0x2::clock::Clock) {
        ...
        let v2 = if (arg0.created_at > 0 && v1 - arg0.created_at < 60 * 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::one_day_ms()) {
            0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::one_day_ms()
        } else {
            0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants::one_week_ms()
        };
