module 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::marketplace {
    ...
    struct Orderbook<phantom T0: store + key, phantom T1> has store, key {
        ...
        asks: 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::CritbitTree<vector<Ask<T0>>>,
        bids: 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::CritbitTree<vector<Bid<T1>>>,
        VERSION: u64,
    }
    ...
    struct TradeFilledEventV2 has copy, drop {
        buyer: address,
        nft: 0x2::object::ID,
        orderbook: 0x2::object::ID,
        price: u64,
    ...
    public entry fun buy_nft<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        match_bid_ask<T0, T1>(v2, v1, 0x2::object::id<Orderbook<T0, T1>>(arg0), &arg0.config, false, arg3);
    }
    ...
    public entry fun create_ask<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: T0, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = if (0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::is_empty<vector<Bid<T1>>>(&arg0.bids)) {
            (false, 0)
        } else {
            let (v4, _) = 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::max_leaf<vector<Bid<T1>>>(&arg0.bids);
            (v4 >= arg2, v4)
        };
        if (v2) {
            let v6 = 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::borrow_mut_leaf_by_key<vector<Bid<T1>>>(&mut arg0.bids, v3);
            match_bid_ask<T0, T1>(0x1::vector::remove<Bid<T1>>(v6, 0), v1, 0x2::object::id<Orderbook<T0, T1>>(arg0), &arg0.config, true, arg3);
            if (0x1::vector::length<Bid<T1>>(v6) == 0) {
                0x1::vector::destroy_empty<Bid<T1>>(0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::remove_leaf_by_key<vector<Bid<T1>>>(&mut arg0.bids, v3));
            };
        } else {
            let (v7, _) = 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::find_leaf<vector<Ask<T0>>>(&arg0.asks, arg2);
            if (v7) {
                0x1::vector::push_back<Ask<T0>>(0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::borrow_mut_leaf_by_key<vector<Ask<T0>>>(&mut arg0.asks, arg2), v1);
            } else {
                0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::insert_leaf<vector<Ask<T0>>>(&mut arg0.asks, arg2, 0x1::vector::singleton<Ask<T0>>(v1));
            };
    ...
    public entry fun create_bid<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = if (0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::is_empty<vector<Ask<T0>>>(&arg0.asks)) {
            (false, 0)
        } else {
            let (v4, _) = 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::min_leaf<vector<Ask<T0>>>(&arg0.asks);
            (v4 <= v0, v4)
        };
        if (v2) {
            let v6 = 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::borrow_mut_leaf_by_key<vector<Ask<T0>>>(&mut arg0.asks, v3);
            match_bid_ask<T0, T1>(v1, 0x1::vector::remove<Ask<T0>>(v6, 0), 0x2::object::id<Orderbook<T0, T1>>(arg0), &arg0.config, true, arg2);
            if (0x1::vector::length<Ask<T0>>(v6) == 0) {
                0x1::vector::destroy_empty<Ask<T0>>(0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::remove_leaf_by_key<vector<Ask<T0>>>(&mut arg0.asks, v3));
            };
        } else {
            let (v7, _) = 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::find_leaf<vector<Bid<T1>>>(&arg0.bids, v0);
            if (v7) {
                0x1::vector::push_back<Bid<T1>>(0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::borrow_mut_leaf_by_key<vector<Bid<T1>>>(&mut arg0.bids, v0), v1);
            } else {
                0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::insert_leaf<vector<Bid<T1>>>(&mut arg0.bids, v0, 0x1::vector::singleton<Bid<T1>>(v1));
            };
    ...
    public entry fun create_orderbook<T0: store + key, T1>(arg0: &mut AdminCap, arg1: u64, arg2: u64, arg3: vector<address>, arg4: vector<u64>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Orderbook<T0, T1>{
            ...
            config  : v0,
            asks    : 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::new<vector<Ask<T0>>>(arg5),
            bids    : 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::new<vector<Bid<T1>>>(arg5),
            VERSION : 1,
        };
    ...
    fun match_bid_ask<T0: store + key, T1>(arg0: Bid<T1>, arg1: Ask<T0>, arg2: 0x2::object::ID, arg3: &OrderbookConfig, arg4: bool, arg5: &mut 0x2::tx_context::TxContext) {
        let Bid {
            offer : v0,
            buyer : v1,
        } = arg0;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v2, v7), arg5), arg3.commission_beneficiary);
        distribute_royalty<T1>(0x2::balance::split<T1>(&mut v2, v8), arg3, arg5);
        0x2::transfer::public_transfer<T0>(0x2::dynamic_object_field::remove<0x1::ascii::String, T0>(&mut arg1.id, nft_key()), v1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v2, v4 - v7 - v8), arg5), v6);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v2, arg5), v1);
        let v9 = TradeFilledEventV2{
            buyer     : v1,
            nft       : v5,
            orderbook : arg2,
            price     : v4,
        ...
        0x2::event::emit<TradeFilledEventV2>(v9);
    }
    ...
    fun remove_ask<T0: store + key>(arg0: &mut 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::CritbitTree<vector<Ask<T0>>>, arg1: u64, arg2: 0x2::object::ID) : Ask<T0> {
        let (v0, _) = 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::find_leaf<vector<Ask<T0>>>(arg0, arg1);
        assert!(v0, 4);
        let v2 = 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::borrow_mut_leaf_by_key<vector<Ask<T0>>>(arg0, arg1);
        let v3 = 0;
        ...
        if (0x1::vector::length<Ask<T0>>(v2) == 0) {
            0x1::vector::destroy_empty<Ask<T0>>(0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::remove_leaf_by_key<vector<Ask<T0>>>(arg0, arg1));
        };
        0x1::vector::remove<Ask<T0>>(v2, v3)
    }

    fun remove_bid<T0>(arg0: &mut 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::CritbitTree<vector<Bid<T0>>>, arg1: u64, arg2: address) : Bid<T0> {
        let (v0, _) = 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::find_leaf<vector<Bid<T0>>>(arg0, arg1);
        assert!(v0, 5);
        let v2 = 0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::borrow_mut_leaf_by_key<vector<Bid<T0>>>(arg0, arg1);
        let v3 = 0;
        ...
        if (0x1::vector::length<Bid<T0>>(v2) == 0) {
            0x1::vector::destroy_empty<Bid<T0>>(0x12c633904b813bf7d28f7d7c9fa880e8e1552e8341f3f9d0a93ffe180fde96d8::crit_bit::remove_leaf_by_key<vector<Bid<T0>>>(arg0, arg1));
        };
