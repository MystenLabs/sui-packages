module 0xcb778bd3bf7e50f9c114285938dd7df90b93498400d6e6799ff75414bd199765::config {
    ...
    public(friend) fun assert_global_close_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_close_pause, 0xcb778bd3bf7e50f9c114285938dd7df90b93498400d6e6799ff75414bd199765::errors::err_global_close_paused());
    }

    public(friend) fun assert_global_open_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_open_pause, 0xcb778bd3bf7e50f9c114285938dd7df90b93498400d6e6799ff75414bd199765::errors::err_global_open_paused());
    }

    public(friend) fun assert_package_version(arg0: &GlobalConfig) {
        assert!(check_package_version(arg0), 0xcb778bd3bf7e50f9c114285938dd7df90b93498400d6e6799ff75414bd199765::errors::err_wrong_version());
    }
