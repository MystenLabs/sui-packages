module 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::i64 {
    ...
    public fun abs(arg0: I64) : I64 {
        if (sign(arg0) == 0) {
            ...
            assert!(arg0.bits > 9223372036854775808, 13835339989820375041);
    ...
    public fun add(arg0: I64, arg1: I64) : I64 {
        ...
        assert!((sign(arg0) & sign(arg1) & u8_neg(sign(v0))) + (u8_neg(sign(arg0)) & u8_neg(sign(arg1)) & sign(v0)) == 0, 13835339826611617793);
        v0
    }
    ...
    public fun from(arg0: u64) : I64 {
        assert!(arg0 <= 9223372036854775807, 13835339663402860545);
        I64{bits: arg0}
    }
    ...
    public fun neg_from(arg0: u64) : I64 {
        assert!(arg0 <= 9223372036854775808, 13835339693467631617);
        if (arg0 == 0) {
            I64{bits: arg0}
        } else {
    ...
    public fun sub(arg0: I64, arg1: I64) : I64 {
        ...
        assert!(!v1, 13835339886741159937);
        v0
    }
