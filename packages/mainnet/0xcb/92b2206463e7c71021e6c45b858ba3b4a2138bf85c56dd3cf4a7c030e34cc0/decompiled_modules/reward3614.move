module 0xcb92b2206463e7c71021e6c45b858ba3b4a2138bf85c56dd3cf4a7c030e34cc0::reward3614 {
    struct REWARD3614 has drop {
        dummy_field: bool,
    }

    struct TICKET_3614 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3614(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_3614>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3614, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3614>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3614>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3614>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3614>>(v5, 0x2::tx_context::sender(arg1));
    }
