module 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault {
    ...
    public fun activate<T0>(arg0: &mut DepositVault, arg1: bool, arg2: &0x2::tx_context::TxContext) : u64 {
        assert!(0x1::type_name::get<T0>() == arg0.deposit_token, invalid_token(arg0.index));
    ...
    public fun calculate_exercise_value<T0>(arg0: &BidVault, arg1: &TypusBidReceipt) : u64 {
        assert!(0x1::type_name::get<T0>() == arg0.deposit_token, invalid_token(arg0.index));
        assert!(0x1::option::is_none<0x1::type_name::TypeName>(&arg0.incentive_token), invalid_token(arg0.index));
    ...
    public fun delivery<T0, T1>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: 0x2::balance::Balance<T1>) {
        assert!(0x1::type_name::get<T0>() == arg0.deposit_token, invalid_token(arg0.index));
        assert!(0x1::type_name::get<T1>() == arg0.bid_token, invalid_token(arg0.index));
        assert!(0x1::type_name::get<T0>() == arg1.deposit_token, invalid_token(arg1.index));
        assert!(0x1::type_name::get<T1>() == arg1.bid_token, invalid_token(arg1.index));
    ...
    public fun delivery_i<T0, T1, T2>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: 0x2::balance::Balance<T1>, arg3: 0x2::balance::Balance<T2>, arg4: &0x2::tx_context::TxContext) {
        assert!(0x1::type_name::get<T0>() == arg0.deposit_token, invalid_token(arg0.index));
        assert!(0x1::type_name::get<T1>() == arg0.bid_token, invalid_token(arg0.index));
        assert!(0x1::option::some<0x1::type_name::TypeName>(0x1::type_name::get<T2>()) == arg0.incentive_token, invalid_token(arg0.index));
        assert!(0x1::type_name::get<T0>() == arg1.deposit_token, invalid_token(arg1.index));
        assert!(0x1::type_name::get<T1>() == arg1.bid_token, invalid_token(arg1.index));
        let v0 = 0x2::balance::value<T1>(&arg2);
        let v1 = v0;
    ...
    fun deposit_disabled(arg0: u64) : u64 {
        abort arg0
    }
    ...
    public fun deposit_from_lending<T0, T1>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: &mut 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: bool) : vector<u64> {
        ...
        if (v0 < v1 + v2) {
            assert!(v1 + v2 - v0 == 1, invalid_balance_value(arg1.index));
        ...
        if (v0 > v1 + v2 || 0x2::balance::value<T1>(&arg4) != 0) {
            ...
            let v24 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::length<DepositShare>(v23);
            let v25 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_size<DepositShare>(v23);
            let v26 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice_mut<DepositShare>(v23, 1);
            let v27 = 0;
            while (v27 < v24) {
                ...
                if (v27 + 1 < v24 && (v27 + 1) % v25 == 0) {
                    v26 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice_mut<DepositShare>(v23, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_id<DepositShare>(v23, v27 + 1));
                };
                v27 = v27 + 1;
            };
        };
    ...
    public fun get_deposit_share_inner(arg0: &DepositShare, arg1: u8) : u64 {
        if (arg1 == 0) {
            ...
            assert!(arg1 == 5, invalid_share_tag((arg1 as u64)));
    ...
    public fun incentivise_bidder<T0>(arg0: &mut BidVault, arg1: 0x2::balance::Balance<T0>, arg2: &0x2::tx_context::TxContext) {
        if (0x1::option::is_some<0x1::type_name::TypeName>(&arg0.incentive_token)) {
            assert!(*0x1::option::borrow<0x1::type_name::TypeName>(&arg0.incentive_token) == 0x1::type_name::get<T0>(), invalid_token(arg0.index));
    ...
    fun invalid_balance_value(arg0: u64) : u64 {
        abort arg0
    }

    fun invalid_deposit_receipt(arg0: u64) : u64 {
        abort arg0
    }

    fun invalid_share_tag(arg0: u64) : u64 {
        abort arg0
    }
    ...
    public fun public_rebate<T0>(arg0: &mut RefundVault, arg1: address) : (0x1::option::Option<0x2::balance::Balance<T0>>, vector<u64>) {
        assert!(0x1::type_name::get<T0>() == arg0.token, invalid_token(0));
    ...
    public fun raise_fund<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: 0x2::balance::Balance<T0>, arg4: bool, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : (TypusDepositReceipt, vector<u64>) {
        assert!(arg1.has_next, deposit_disabled(arg1.index));
        assert!(0x1::type_name::get<T0>() == arg1.deposit_token, invalid_token(arg1.index));
    ...
    public fun reduce_fund<T0, T1, T2>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: u64, arg4: u64, arg5: bool, arg6: bool, arg7: bool, arg8: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<TypusDepositReceipt>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, vector<u64>) {
        assert!(0x1::type_name::get<T0>() == arg1.deposit_token, invalid_token(arg1.index));
        assert!(0x1::type_name::get<T1>() == arg1.bid_token, invalid_token(arg1.index));
        assert!(!arg7 || 0x1::option::some<0x1::type_name::TypeName>(0x1::type_name::get<T2>()) == arg1.incentive_token, invalid_token(arg1.index));
        let (v0, v1, v2, v3, v4, v5, v6) = extract_deposit_shares(arg1, arg2);
        let v7 = v5;
        let v8 = v4;
        let v9 = v3;
    ...
    public fun settle<T0, T1>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, zero_value(arg0.index));
        assert!(0x1::type_name::get<T0>() == arg0.deposit_token, invalid_token(arg0.index));
        assert!(0x1::type_name::get<T1>() == arg0.bid_token, invalid_token(arg0.index));
        assert!(0x1::type_name::get<T0>() == arg1.deposit_token, invalid_token(arg0.index));
        assert!(0x1::type_name::get<T1>() == arg1.bid_token, invalid_token(arg0.index));
    ...
    fun verify_bid_receipt(arg0: &BidVault, arg1: &TypusBidReceipt) {
        assert!(0x2::object::id<BidVault>(arg0) == arg1.vid && arg0.index == arg1.index, invalid_deposit_receipt(arg0.index));
    }

    fun verify_deposit_receipt(arg0: &DepositVault, arg1: &TypusDepositReceipt) {
        assert!(0x2::object::id<DepositVault>(arg0) == arg1.vid && arg0.index == arg1.index, invalid_deposit_receipt(arg0.index));
    }
