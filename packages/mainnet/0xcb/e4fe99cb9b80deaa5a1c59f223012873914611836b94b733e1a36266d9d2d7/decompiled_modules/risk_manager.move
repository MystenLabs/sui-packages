module 0xcbe4fe99cb9b80deaa5a1c59f223012873914611836b94b733e1a36266d9d2d7::risk_manager {
    ...
    public(friend) fun add_risk(arg0: &mut RiskManager, arg1: 0x1::type_name::TypeName, arg2: vector<0xcbe4fe99cb9b80deaa5a1c59f223012873914611836b94b733e1a36266d9d2d7::bet_manager::Placement>, arg3: u64) {
        ...
        let v3 = 0;
        while (v3 < 0x1::vector::length<0xcbe4fe99cb9b80deaa5a1c59f223012873914611836b94b733e1a36266d9d2d7::bet_manager::Placement>(&arg2)) {
            let (v4, v5) = 0xcbe4fe99cb9b80deaa5a1c59f223012873914611836b94b733e1a36266d9d2d7::bet_manager::get_placement_data(0x1::vector::borrow<0xcbe4fe99cb9b80deaa5a1c59f223012873914611836b94b733e1a36266d9d2d7::bet_manager::Placement>(&arg2, v3));
