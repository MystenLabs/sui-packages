module 0xcb70763ee34b18c535021cd8b5a61c8db61a96f2140769f94f5bb18d3cfb44e6::reward8840 {
    struct REWARD8840 has drop {
        dummy_field: bool,
    }

    struct TICKET_8840 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8840(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8840>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8840>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8840, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8840>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8840>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8840>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8840>>(v5, 0x2::tx_context::sender(arg1));
    }
