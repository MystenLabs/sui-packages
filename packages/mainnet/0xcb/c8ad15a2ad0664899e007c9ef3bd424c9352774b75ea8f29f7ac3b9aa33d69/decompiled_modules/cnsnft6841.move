module 0xcbc8ad15a2ad0664899e007c9ef3bd424c9352774b75ea8f29f7ac3b9aa33d69::cnsnft6841 {
    struct CNSNFT6841 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6841, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3989"));
        let v4 = 0x2::package::claim<CNSNFT6841>(arg0, arg1);
