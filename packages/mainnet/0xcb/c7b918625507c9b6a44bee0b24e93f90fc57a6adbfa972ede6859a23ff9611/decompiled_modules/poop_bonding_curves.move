module 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::poop_bonding_curves {
    ...
    public entry fun buy<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::curves::calculate_add_liquidity_cost(v2.virtual_sui_reserves, v2.virtual_token_reserves, v5) + 1;
        let v7 = 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::as_u64(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::div(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::mul(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(v6), 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(arg0.platform_fee)), 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(10000)));
        assert!(v3 >= v6 + v7, 6);
        ...
        if (v4 == v5 || 0x2::coin::value<0x2::sui::SUI>(&v2.real_sui_reserves) >= 800000000000) {
    ...
    fun buy_direct<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut Pool<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::curves::calculate_add_liquidity_cost(arg2.virtual_sui_reserves, arg2.virtual_token_reserves, v3) + 1;
        let v5 = 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::as_u64(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::div(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::mul(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(v4), 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(arg0.platform_fee)), 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(10000)));
        assert!(v1 >= v4 + v5, 6);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.id_balance, 0x2::balance::split<0x2::sui::SUI>(0x2::coin::balance_mut<0x2::sui::SUI>(&mut arg1), v5));
        let v6 = 0x2::coin::zero<T0>(arg5);
        let (v7, v8) = swap<T0>(arg2, v6, arg1, v3, v1 - v4, arg5);
        let v9 = v7;
        ...
        if (v2 == v3 || 0x2::coin::value<0x2::sui::SUI>(&arg2.real_sui_reserves) >= 800000000000) {
            arg2.is_completed = true;
        };
    }

    public fun check_owner(arg0: &Configuration, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1) || 0x2::tx_context::sender(arg1) == @0x0, 1234);
    }
    ...
    public entry fun create_and_first_buy<T0>(arg0: &mut Configuration, arg1: 0x2::coin::TreasuryCap<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: 0x1::ascii::String, arg6: 0x1::ascii::String, arg7: 0x1::ascii::String, arg8: 0x1::ascii::String, arg9: 0x1::ascii::String, arg10: 0x1::ascii::String, arg11: 0x1::ascii::String, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<0x2::sui::SUI>(&arg2) > 0) {
            let v3 = &mut v0;
            buy_direct<T0>(arg0, arg2, v3, arg3, arg4, arg12);
        } else {
    ...
    public fun estimate_amount_out<T0>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        if (arg1 > 0 && arg2 == 0) {
            (0, 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::curves::calculate_token_amount_received(v1.virtual_sui_reserves, v1.virtual_token_reserves, arg1 - 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::as_u64(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::div(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::mul(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(arg1), 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(arg0.platform_fee)), 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(10000)))))
        } else if (arg1 == 0 && arg2 > 0) {
            let v4 = 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_sui_reserves, arg2);
            (v4 - 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::as_u64(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::div(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::mul(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(v4), 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(arg0.platform_fee)), 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(10000))), 0)
        } else {
            (0, 0)
        }
    }
    ...
    public entry fun sell<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3 > 0, 2);
        let v4 = 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::curves::calculate_remove_liquidity_return(v2.virtual_token_reserves, v2.virtual_sui_reserves, v3);
        let v5 = 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::as_u64(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::div(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::mul(0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(v4), 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(arg0.platform_fee)), 0xcbc7b918625507c9b6a44bee0b24e93f90fc57a6adbfa972ede6859a23ff9611::utils::from_u64(10000)));
        assert!(v4 - v5 >= arg2, 2);
    ...
    public entry fun update_config(arg0: &mut Configuration, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun vadidation(arg0: &mut Configuration, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
        check_owner(arg0, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.id_balance, arg1), arg2), 0x2::tx_context::sender(arg2));
    }
