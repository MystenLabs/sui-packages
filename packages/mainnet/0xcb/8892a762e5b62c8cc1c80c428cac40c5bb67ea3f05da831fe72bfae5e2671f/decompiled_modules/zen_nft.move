module 0xcb8892a762e5b62c8cc1c80c428cac40c5bb67ea3f05da831fe72bfae5e2671f::zen_nft {
    ...
    fun assert_is_zen_coin<T0>() {
        assert!(0x1::type_name::into_string(0x1::type_name::get<T0>()) == 0x1::ascii::string(b"2665dc784c7ff17fddba2442b36cb8b2bbc8adfa9fe08794fd941d80ef2758ec::zen::ZEN"), 4);
    }
