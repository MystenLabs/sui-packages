module 0xcbd90bca6510a60b26ef5b6a41b3bc141cebaca0d67eac0277b8f1b6da6c6311::reward8707 {
    struct REWARD8707 has drop {
        dummy_field: bool,
    }

    struct TICKET_8707 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8707(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8707>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8707>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8707, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8707>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8707>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8707>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8707>>(v5, 0x2::tx_context::sender(arg1));
    }
