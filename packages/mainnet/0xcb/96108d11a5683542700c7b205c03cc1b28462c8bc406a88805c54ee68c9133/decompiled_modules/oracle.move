module 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::oracle {
    ...
    public fun add_price_feed<T0, T1: drop>(arg0: &0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::listing::ListingCap, arg1: &mut Oracle, arg2: u8, arg3: u64) {
    ...
    public fun change_rule<T0, T1: drop>(arg0: &0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::listing::ListingCap, arg1: &mut Oracle) {
        if (!price_feed_exists<T0>(arg1)) {
            err_price_feed_not_exist();
        };
    ...
    fun handle_decimal_diff(arg0: u64, arg1: u8) : u64 {
        let v0 = 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::config::sui_decimals();
        if (v0 > arg1) {
            0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::math::mul_and_div(arg0, 1, 0x2::math::pow(10, v0 - arg1))
        } else if (v0 < arg1) {
            0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::math::mul_and_div(arg0, 0x2::math::pow(10, v0 - arg1), 1)
        } else {
            arg0
        }
    }
    ...
    public fun remove_price_feed<T0>(arg0: &0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::listing::ListingCap, arg1: &mut Oracle) {
        if (!price_feed_exists<T0>(arg1)) {
            err_price_feed_not_exist();
        };
        let PriceFeed {
    ...
    public fun ticket_price<T0>(arg0: &Oracle, arg1: &0x2::clock::Clock, arg2: u64) : u64 {
        ...
        let v1 = if (v0 > arg2) {
            (v0 - arg2) / 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::config::price_period() * 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::config::price_increment()
        } else {
            0
        };
        let v2 = 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::config::initial_price_in_sui() + v1;
        let v3 = v2;
        if (v2 > 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::config::max_price_in_sui()) {
            v3 = 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::config::max_price_in_sui();
        };
        if (0x1::type_name::get<T0>() == 0x1::type_name::get<0x2::sui::SUI>()) {
            ...
            handle_decimal_diff(0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::math::mul_and_div_u128(v3, 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::config::precision(), v5.price_against_sui), v5.decimals)
        }
    }
    ...
    public fun update_tolerance_ms<T0>(arg0: &0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::listing::ListingCap, arg1: &mut Oracle, arg2: u64) {
        if (!price_feed_exists<T0>(arg1)) {
            err_price_feed_not_exist();
        };
