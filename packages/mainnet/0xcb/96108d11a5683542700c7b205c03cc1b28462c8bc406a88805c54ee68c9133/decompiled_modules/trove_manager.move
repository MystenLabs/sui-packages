module 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::trove_manager {
    ...
    public fun take_coin_from_trove<T0>(arg0: &mut TroveManager, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        if (get_trove_value<T0>(arg0, v0) < arg1) {
            err_not_enough_in_trove();
        };
        let v1 = Withdraw<T0>{
            user   : v0,
            amount : arg1,
