module 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::game_status {
    ...
    public fun add_version(arg0: &0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::listing::ListingCap, arg1: &mut GameStatus, arg2: u8) {
    ...
    public(friend) fun increase_end_time(arg0: &mut GameStatus, arg1: &0x2::clock::Clock) {
        ...
        let v1 = arg0.end_time + 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::config::time_increment();
        let v2 = v1;
        let v3 = 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::config::end_time_hard_cap();
        if (v1 > v0 + v3) {
            v2 = v0 + v3;
        };
        if (arg0.end_time < v2) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GameStatus{
            ...
            start_time  : 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::math::max_u64(),
            end_time    : 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::math::max_u64(),
        };
    ...
    public fun raffle_epoch(arg0: &GameStatus, arg1: &0x2::clock::Clock) : u64 {
        ...
        if (v1 >= v0) {
            (v1 - v0) / 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::config::raffle_period()
        } else {
            0
        }
    }

    public fun remove_version(arg0: &0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::listing::ListingCap, arg1: &mut GameStatus, arg2: u8) {
        assert_valid_package_version(arg1);
    ...
    public fun start(arg0: &mut GameStatus, arg1: Starter, arg2: u64) {
        ...
        arg0.end_time = arg2 + 0xcb96108d11a5683542700c7b205c03cc1b28462c8bc406a88805c54ee68c9133::config::initial_countdown();
    }
