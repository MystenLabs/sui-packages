module 0xcbb557e5bea3a3d0403eae8dbcfd8791d6e989eb91e1a5519b395c68e38f4317::state {
    ...
    public fun assert_valid_version(arg0: &FeeManagerState) {
        ...
        assert!(0x2::vec_set::contains<u64>(&arg0.version, &v0), 2);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = FeeManagerState{
            ...
            version       : 0x2::vec_set::empty<u64>(),
        };
        0x2::vec_set::insert<u64>(&mut v1.version, 1);
    ...
    entry fun remove_old_state_version(arg0: &AdminCap, arg1: &mut FeeManagerState, arg2: u64) {
        ...
        0x2::vec_set::remove<u64>(&mut arg1.version, &arg2);
    }
