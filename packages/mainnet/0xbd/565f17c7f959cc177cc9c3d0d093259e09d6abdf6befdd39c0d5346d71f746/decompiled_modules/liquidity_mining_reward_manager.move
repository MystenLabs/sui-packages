module 0xbd565f17c7f959cc177cc9c3d0d093259e09d6abdf6befdd39c0d5346d71f746::liquidity_mining_reward_manager {
    ...
    public(friend) fun add_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg3 - v0 >= 3600000, 0xbd565f17c7f959cc177cc9c3d0d093259e09d6abdf6befdd39c0d5346d71f746::error::liquidity_mining_invalid_time());
        ...
        assert!(v4 < 50, 0xbd565f17c7f959cc177cc9c3d0d093259e09d6abdf6befdd39c0d5346d71f746::error::liquidity_mining_max_concurrent_pool_rewards_violated());
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut PoolRewardManager, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(v0.coin_type == 0x1::type_name::get<T0>(), 0xbd565f17c7f959cc177cc9c3d0d093259e09d6abdf6befdd39c0d5346d71f746::error::liquidity_mining_invalid_type());
    ...
    public(friend) fun close_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: u64, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        assert!(0x2::clock::timestamp_ms(arg2) >= v4, 0xbd565f17c7f959cc177cc9c3d0d093259e09d6abdf6befdd39c0d5346d71f746::error::liquidity_mining_pool_reward_period_not_over());
        assert!(v8 == 0, 0xbd565f17c7f959cc177cc9c3d0d093259e09d6abdf6befdd39c0d5346d71f746::error::liquidity_mining_not_all_rewards_claimed());
