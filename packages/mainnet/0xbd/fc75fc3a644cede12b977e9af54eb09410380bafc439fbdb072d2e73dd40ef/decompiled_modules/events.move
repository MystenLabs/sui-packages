module 0xbdfc75fc3a644cede12b977e9af54eb09410380bafc439fbdb072d2e73dd40ef::events {
    ...
    struct PauseCapMintedEvent has copy, drop {
        cap_id: address,
        recipient: address,
        sender: address,
    }

    struct PauseCapDestroyedEvent has copy, drop {
        cap_id: address,
        sender: address,
    }
    ...
    public(friend) fun emit_pause_cap_destroyed(arg0: address, arg1: address) {
        let v0 = PauseCapDestroyedEvent{
            cap_id : arg0,
            sender : arg1,
        };
        0x2::event::emit<PauseCapDestroyedEvent>(v0);
    }

    public(friend) fun emit_pause_cap_minted(arg0: address, arg1: address, arg2: address) {
        let v0 = PauseCapMintedEvent{
            cap_id    : arg0,
            recipient : arg1,
            sender    : arg2,
        };
        0x2::event::emit<PauseCapMintedEvent>(v0);
    }
