module 0xbd1b0b1d63931627b2772909a3d6f965ded8080bf6e019827860664ad0e70e5e::dca_order {
    ...
    public entry fun cancel_dca_order<T0, T1>(arg0: &mut DcaOrder<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.canceled_ts = v0;
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x2::balance::Balance<T0>>(&arg0.pay_balance)) {
        ...
        let v2 = DcaOrderCanceled{
            order_id : 0x2::object::id<DcaOrder<T0, T1>>(arg0),
            owner    : arg0.owner,
        };
        0x2::event::emit<DcaOrderCanceled>(v2);
    }
    ...
    public fun fill_dca_order<T0, T1>(arg0: &0xbd1b0b1d63931627b2772909a3d6f965ded8080bf6e019827860664ad0e70e5e::config::GlobalConfig, arg1: &mut DcaOrder<T0, T1>, arg2: DcaOrderPrefill, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == 0xbd1b0b1d63931627b2772909a3d6f965ded8080bf6e019827860664ad0e70e5e::config::admin(arg0), 0);
    ...
    public entry fun place_dca_order<T0, T1>(arg0: &mut 0xbd1b0b1d63931627b2772909a3d6f965ded8080bf6e019827860664ad0e70e5e::config::GlobalReserve, arg1: vector<0x2::coin::Coin<T0>>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        0xbd1b0b1d63931627b2772909a3d6f965ded8080bf6e019827860664ad0e70e5e::config::add_reserve(arg0, arg2);
        let v0 = 0;
        let v1 = 0x1::vector::empty<0x2::balance::Balance<T0>>();
        let v2 = vector[];
        let v3 = 0;
        while (v0 < 0x1::vector::length<0x2::coin::Coin<T0>>(&arg1)) {
            let v4 = 0x2::coin::into_balance<T0>(0x1::vector::pop_back<0x2::coin::Coin<T0>>(&mut arg1));
            v3 = v3 + 0x2::balance::value<T0>(&v4);
            0x1::vector::push_back<u64>(&mut v2, 0x2::balance::value<T0>(&v4));
            0x1::vector::push_back<0x2::balance::Balance<T0>>(&mut v1, v4);
            v0 = v0 + 1;
        };
        ...
        0x2::transfer::transfer<DcaOrder<T0, T1>>(v7, 0x2::tx_context::sender(arg6));
    }

    public fun prefill_dca_order<T0, T1>(arg0: &0xbd1b0b1d63931627b2772909a3d6f965ded8080bf6e019827860664ad0e70e5e::config::GlobalConfig, arg1: &mut DcaOrder<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, DcaOrderPrefill) {
        assert!(0x2::tx_context::sender(arg2) == 0xbd1b0b1d63931627b2772909a3d6f965ded8080bf6e019827860664ad0e70e5e::config::admin(arg0), 0);
