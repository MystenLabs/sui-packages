module 0xbd12fae543568d6db86692d75364d47cea2aded2b28cceec2495faf1a8f284ad::router {
    ...
    public fun finalize_swap<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u16, arg6: address, arg7: u16, arg8: u16, arg9: address, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (arg5 > 0) {
            if (arg4) {
                ...
                if (v1 > 0) {
                    0xd886531293d626724dbcc8d15dc453405454e32e0e63fac83395faac3fb7ee06::liquid_mesh_events::emit_commission(arg5, arg4, v1, arg6, 0x1::type_name::into_string(0x1::type_name::get<T0>()));
                };
            } else {
                ...
                if (v2 > 0) {
                    ...
                    0xd886531293d626724dbcc8d15dc453405454e32e0e63fac83395faac3fb7ee06::liquid_mesh_events::emit_commission(arg5, arg4, v2, arg6, 0x1::type_name::into_string(0x1::type_name::get<T1>()));
                };
            };
        };
        let v3 = if (v0 > arg2) {
        ...
        if (v3) {
            ...
            if (v5 > 0) {
                ...
                0xd886531293d626724dbcc8d15dc453405454e32e0e63fac83395faac3fb7ee06::liquid_mesh_events::emit_positive_slippage(arg10, 0x2::tx_context::sender(arg11), arg9, arg2, v0, v5, arg7, arg8, 0x1::type_name::into_string(0x1::type_name::get<T1>()));
                0x2::coin::value<T1>(&arg0);
            };
        };
        let v7 = 0x2::coin::value<T1>(&arg0);
        0xd886531293d626724dbcc8d15dc453405454e32e0e63fac83395faac3fb7ee06::liquid_mesh_events::emit_swap_log(arg10, 0x2::tx_context::sender(arg11), arg1, arg2, arg3, v7, 0x1::type_name::into_string(0x1::type_name::get<T0>()), 0x1::type_name::into_string(0x1::type_name::get<T1>()));
        assert!(v7 >= arg3, 0);
        arg0
    }
