module 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::b0 {
    ...
    fun bxp_internal<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::new_f_max(arg4, arg5, 1000000000, arg6);
        let v3 = calc_bx<T0>(arg1, v0, v1, arg4);
        if (0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::i128::gt(v3, 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::i128::zero())) {
            0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_init(&mut v2, arg4, v3);
            let v4 = 0;
            while (v4 < 10 && !0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_has_converged(&v2)) {
                let v5 = calc_bx<T0>(arg1, v0, v1, 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_next_step_prep_u(&mut v2));
                0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_next_step_complete(&mut v2, v5);
                v4 = v4 + 1;
            };
            let (v6, _) = 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_result(&v2);
            bx_internal<T0>(arg0, arg1, arg2, arg3, v6, arg10);
            return
        };
        let v8 = 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::new_f_max(arg7, arg8, 1000000, arg9);
        let v9 = calc_bxr<T0>(arg1, v0, v1, arg7);
        assert!(0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::i128::gt(v9, 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::i128::zero()), 25);
        0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_init(&mut v8, arg7, v9);
        let v10 = 0;
        while (v10 < 10 && !0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_has_converged(&v8)) {
            let v11 = calc_bxr<T0>(arg1, v0, v1, 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_next_step_prep_u(&mut v8));
            0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_next_step_complete(&mut v8, v11);
            v10 = v10 + 1;
        };
        let (v12, _) = 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_result(&v8);
    ...
    fun calc_bx<T0>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: u64) : 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::i128::I128 {
    ...
    fun calc_bxr<T0>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: u64) : 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::i128::I128 {
