module 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::s0 {
    fun calc_sx<T0>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::i128::I128 {
    ...
    fun calc_sxr<T0>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::i128::I128 {
    ...
    fun sxp_internal<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::pool::Pool<0x2::sui::SUI, T0>, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::new_f_max(arg4, arg5, 1000000000, arg6);
        let v5 = calc_sx<T0>(arg1, v0, v1, v3, arg4);
        if (0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::i128::gt(v5, 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::i128::zero())) {
            0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_init(&mut v4, arg4, v5);
            let v6 = 0;
            while (v6 < 10 && !0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_has_converged(&v4)) {
                let v7 = calc_sx<T0>(arg1, v0, v1, v3, 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_next_step_prep_u(&mut v4));
                0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_next_step_complete(&mut v4, v7);
                v6 = v6 + 1;
            };
            let (v8, _) = 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_result(&v4);
            sx_internal<T0>(arg0, arg1, arg2, arg3, v8, arg10);
            return
        };
        let v10 = 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::new_f_max(arg7, arg8, 1000000, arg9);
        let v11 = calc_sxr<T0>(arg1, v0, v1, v3, arg7);
        assert!(0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::i128::gt(v11, 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::i128::zero()), 25);
        0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_init(&mut v10, arg7, v11);
        let v12 = 0;
        while (v12 < 10 && !0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_has_converged(&v10)) {
            let v13 = calc_sxr<T0>(arg1, v0, v1, v3, 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_next_step_prep_u(&mut v10));
            0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_next_step_complete(&mut v10, v13);
            v12 = v12 + 1;
        };
        let (v14, _) = 0xbd2b1d0813859773bd77f84644c7f9e1bc48170ae7cb67e47f396636436dfc2a::f_max::f_max_result(&v10);
