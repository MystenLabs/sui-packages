module 0xbd73f4814f39a1f664b406458713a76ee22cc04e109c33c653be04ca90a552d5::versioned {
    ...
    public entry fun pause(arg0: &0xbd73f4814f39a1f664b406458713a76ee22cc04e109c33c653be04ca90a552d5::admin_cap::AdminCap, arg1: &mut Versioned, arg2: &0x2::tx_context::TxContext) {
        check_version(arg1);
        let v0 = GlobalPauseDfKey{dummy_field: false};
    ...
    public entry fun unpause(arg0: &0xbd73f4814f39a1f664b406458713a76ee22cc04e109c33c653be04ca90a552d5::admin_cap::AdminCap, arg1: &mut Versioned, arg2: &0x2::tx_context::TxContext) {
        check_version(arg1);
        let v0 = GlobalPauseDfKey{dummy_field: false};
    ...
    public fun upgrade(arg0: &0xbd73f4814f39a1f664b406458713a76ee22cc04e109c33c653be04ca90a552d5::admin_cap::AdminCap, arg1: &mut Versioned) {
