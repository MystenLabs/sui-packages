module 0xbdd089e8b69229be29a59853a4b1eb00a1751c9e9469be91a21d6af30a1df2f1::ndas {
    ...
    fun init(arg0: NDAS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/yCYSJATPJiFgtE1Up7LFGQEV8XLZ5Ma7Y53JnXKpump.png?size=lg&key=e66994                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<NDAS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"NDAS      ")))), trim_right(b"National Digital Asset Stockpile"), trim_right(b"National Digital Asset Stockpile (NDAS)                                                                                                                                                                                                                                                                                         "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
