module 0xbd082b2e7d0a2851fbf213da78eba4843fe774e7dcf27b6bbe5be335fe307730::market {
    ...
    public(friend) fun add_offer(arg0: &mut Market, arg1: 0x2::object::ID, arg2: bool, arg3: bool, arg4: u64, arg5: u64, arg6: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg7: &0x2::tx_context::TxContext) {
        update_tables(arg0, arg1, arg2, arg3, 0x2::tx_context::sender(arg7));
        update_stats(arg0, arg2, arg3, arg4, arg5);
        0x2::coin::put<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg0.balance, arg6);
    }
    ...
    public(friend) fun cancel_offer(arg0: &mut Market, arg1: 0x2::object::ID, arg2: bool, arg3: u64, arg4: u64) {
        reset_stats(arg0, arg2, arg3, arg4);
    }
    ...
    fun reset_stats(arg0: &mut Market, arg1: bool, arg2: u64, arg3: u64) {
        if (arg1) {
    ...
    public entry fun settlement<T0>(arg0: &mut Market, arg1: &0x2::package::Publisher, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x2::clock::Clock) {
        assert_admin(arg1);
        arg0.coin_symbol = 0x1::option::some<0x1::string::String>(0x1::string::from_ascii(0x2::coin::get_symbol<T0>(arg2)));
        arg0.coin_type = 0x1::option::some<0x1::string::String>(0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get_with_original_ids<T0>())));
    ...
    public entry fun withdraw(arg0: &mut Market, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg1);
        0xbd082b2e7d0a2851fbf213da78eba4843fe774e7dcf27b6bbe5be335fe307730::utils::withdraw_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg0.balance, arg2);
    }
