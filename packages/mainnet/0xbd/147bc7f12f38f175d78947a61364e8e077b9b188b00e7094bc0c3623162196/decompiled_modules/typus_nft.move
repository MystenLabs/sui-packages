module 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft {
    ...
    entry fun free_mint(arg0: &mut Pool, arg1: Whitelist, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = mint(arg0, arg1, arg2, arg3);
        let (v1, v2) = 0x2::kiosk::new(arg3);
        let v3 = v2;
        let v4 = v1;
        0x2::kiosk::place<Tails>(&mut v4, &v3, v0);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v4);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v3, 0x2::tx_context::sender(arg3));
    }

    entry fun free_mint_into_kiosk(arg0: &mut Pool, arg1: Whitelist, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x2::kiosk::place<Tails>(arg2, arg3, mint(arg0, arg1, arg4, arg5));
    }
    ...
    entry fun send_nfts(arg0: &ManagerCap, arg1: &mut Pool, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::kiosk::new(arg4);
        let v2 = v1;
        let v3 = v0;
        while (arg3 > 0) {
            0x2::kiosk::place<Tails>(&mut v3, &v2, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::table_vec::pop_back<Tails>(&mut arg1.tails));
            arg3 = arg3 - 1;
        };
