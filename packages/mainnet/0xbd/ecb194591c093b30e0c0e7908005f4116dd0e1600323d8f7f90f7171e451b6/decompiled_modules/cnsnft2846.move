module 0xbdecb194591c093b30e0c0e7908005f4116dd0e1600323d8f7f90f7171e451b6::cnsnft2846 {
    struct CNSNFT2846 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2846, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2846>(arg0, arg1);
