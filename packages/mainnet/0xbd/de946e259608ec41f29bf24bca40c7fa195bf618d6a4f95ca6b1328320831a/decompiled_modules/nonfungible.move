module 0xbdde946e259608ec41f29bf24bca40c7fa195bf618d6a4f95ca6b1328320831a::nonfungible {
    ...
    public fun add_attributes<T0>(arg0: &OperatorCap<T0>, arg1: &mut Nft<T0>, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun get_attributes<T0>(arg0: &Nft<T0>) : 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        arg0.attributes
    }
    ...
    public fun get_current_supply<T0>(arg0: &OperatorCap<T0>) : u32 {
        arg0.current_supply
    }
    ...
    public fun mint<T0>(arg0: &mut OperatorCap<T0>, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) : Nft<T0> {
        ...
        assert!(0x1::option::is_none<u32>(&arg0.max_supply) || *0x1::option::borrow<u32>(&arg0.max_supply) > arg0.current_supply, 3);
        arg0.current_supply = arg0.current_supply + 1;
        let v0 = Nft<T0>{
            id         : 0x2::object::new(arg2),
            name       : arg1,
    ...
    public fun remove_attributes<T0>(arg0: &OperatorCap<T0>, arg1: &mut Nft<T0>, arg2: vector<0x1::string::String>, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun update_attributes<T0>(arg0: &OperatorCap<T0>, arg1: &mut Nft<T0>, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &0x2::tx_context::TxContext) {
        assert!(can_mint<T0>(arg0, 0x2::tx_context::sender(arg4)), 0);
        assert!(0x1::vector::length<0x1::string::String>(&arg2) <= 100, 5);
        assert!(0x1::vector::length<0x1::string::String>(&arg2) == 0x1::vector::length<0x1::string::String>(&arg3), 4);
        let v0 = arg1.attributes;
