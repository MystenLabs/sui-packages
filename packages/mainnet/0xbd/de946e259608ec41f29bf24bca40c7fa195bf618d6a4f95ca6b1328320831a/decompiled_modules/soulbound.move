module 0xbdde946e259608ec41f29bf24bca40c7fa195bf618d6a4f95ca6b1328320831a::soulbound {
    ...
    public fun add_attributes<T0>(arg0: &OperatorCap<T0>, arg1: &mut Sbt<T0>, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun batch_mint_and_transfer<T0>(arg0: &mut OperatorCap<T0>, arg1: vector<address>, arg2: vector<0x1::string::String>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::option::is_none<u32>(&arg0.max_supply) || arg0.current_supply + v0 <= *0x1::option::borrow<u32>(&arg0.max_supply), 3);
        arg0.current_supply = arg0.current_supply + v0;
    ...
    public fun get_attributes<T0>(arg0: &Sbt<T0>) : 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        arg0.attributes
    }
    ...
    public fun remove_attributes<T0>(arg0: &OperatorCap<T0>, arg1: &mut Sbt<T0>, arg2: vector<0x1::string::String>, arg3: &0x2::tx_context::TxContext) {
        assert!(can_mint<T0>(arg0, 0x2::tx_context::sender(arg3)), 0);
        assert!(0x1::vector::length<0x1::string::String>(&arg2) <= 100, 6);
        let v0 = arg1.attributes;
        while (!0x1::vector::is_empty<0x1::string::String>(&arg2)) {
    ...
    public fun update_attributes<T0>(arg0: &OperatorCap<T0>, arg1: &mut Sbt<T0>, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &0x2::tx_context::TxContext) {
        assert!(can_mint<T0>(arg0, 0x2::tx_context::sender(arg4)), 0);
        assert!(0x1::vector::length<0x1::string::String>(&arg2) <= 100, 6);
        assert!(0x1::vector::length<0x1::string::String>(&arg2) == 0x1::vector::length<0x1::string::String>(&arg3), 5);
        let v0 = arg1.attributes;
