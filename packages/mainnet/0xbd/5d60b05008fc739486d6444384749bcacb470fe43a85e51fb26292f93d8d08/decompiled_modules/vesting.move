module 0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::vesting {
    ...
    struct FundRemoveEvent2 has copy, drop {
        owner: address,
        receiver: address,
        project: address,
        fund: u128,
    ...
    public entry fun addFundAfterRemoved<T0>(arg0: &AdminCap, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: u128, arg4: u128, arg5: &mut Project<T0>, arg6: &mut ProjectRegistry, arg7: &0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg7, 1);
        assert!(!arg5.deprecated, 8009);
        let v0 = (0x2::coin::value<T0>(&arg2) as u128);
        assert!(v0 > 0 && arg4 >= 0 && arg3 >= arg4 && arg3 - arg4 >= v0, 8001);
        assert!(!0x2::table::contains<address, Fund<T0>>(&mut arg5.funds, arg1), 8012);
        arg5.deposited = arg5.deposited + v0;
        assert!(arg5.deposited <= arg5.supply, 8007);
        arg5.deposited_percent = arg5.deposited * 10000 / arg5.supply;
        let v1 = Fund<T0>{
            owner         : arg1,
            total         : arg3,
            locked        : arg2,
        ...
        0x2::table::add<address, Fund<T0>>(&mut arg5.funds, arg1, v1);
        let v2 = 0x2::object::id_address<Project<T0>>(arg5);
        addProjectToRegistry(arg6, arg1, v2);
        let v3 = FundAddedEvent{
            owner   : arg1,
            project : v2,
            fund    : v0,
        };
        0x2::event::emit<FundAddedEvent>(v3);
    }
    ...
    public entry fun removeFund2<T0>(arg0: &AdminCap, arg1: address, arg2: address, arg3: &mut Project<T0>, arg4: &mut ProjectRegistry, arg5: &0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::checkVersion(arg5, 1);
        assert!(0x2::table::contains<address, Fund<T0>>(&mut arg3.funds, arg1), 8004);
        let Fund {
            owner         : v0,
            total         : _,
            locked        : v2,
            released      : _,
            last_claim_ms : _,
        } = 0x2::table::remove<address, Fund<T0>>(&mut arg3.funds, arg1);
        let v5 = v2;
        let v6 = (0x2::coin::value<T0>(&v5) as u128);
        assert!(arg3.deposited >= v6, 8011);
        arg3.deposited = arg3.deposited - v6;
        arg3.deposited_percent = arg3.deposited * 10000 / arg3.supply;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v5, arg2);
        removeProjectFromRegistry(arg4, v0, 0x2::object::id_address<Project<T0>>(arg3));
        let v7 = FundRemoveEvent{
            owner   : v0,
        ...
        0x2::event::emit<FundRemoveEvent>(v7);
        let v8 = FundRemoveEvent2{
            owner    : v0,
            receiver : arg2,
            project  : 0x2::object::id_address<Project<T0>>(arg3),
            fund     : v6,
        };
        0x2::event::emit<FundRemoveEvent2>(v8);
    }
    ...
    public entry fun removeFunds2<T0>(arg0: &AdminCap, arg1: vector<address>, arg2: address, arg3: &mut Project<T0>, arg4: &mut ProjectRegistry, arg5: &0xea30bcadc535bd75b72e64806194a37e28affab12188741d86c97bad2df5887c::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg1)) {
            removeFund2<T0>(arg0, *0x1::vector::borrow<address>(&arg1, v0), arg2, arg3, arg4, arg5, arg6);
            v0 = v0 + 1;
        };
    }
