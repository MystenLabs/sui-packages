module 0xbd19aec2801fbc92fb344a8a3ed8b1b6596191b692dd7815029d88e7aea21160::nft {
    ...
    entry fun mint(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Nft{
            ...
            name        : 0x1::string::utf8(b"limitcool"),
            description : 0x1::string::utf8(b"limitcool NFT"),
            creator     : 0x2::tx_context::sender(arg1),
            url         : 0x2::url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/88604249?v=4"),
        };
