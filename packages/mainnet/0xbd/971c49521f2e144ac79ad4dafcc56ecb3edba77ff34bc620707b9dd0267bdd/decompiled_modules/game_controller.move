module 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::game_controller {
    ...
    fun coin_flip<T0, T1, T2>(arg0: &mut 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::vault::Vault<T0, T1>, arg1: &mut 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::xluck_reward::NewReward<T2>, arg2: address, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let (v4, v5) = 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::xluck_reward::new_get_reward<T2>(arg1, arg5, arg3, arg2, arg6);
        let v6 = GamePlay{
            game_id       : 1,
            player        : arg2,
            amount        : arg3,
    ...
    public entry fun provide_with_nft<T0, T1, T2>(arg0: &mut 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::vault::Vault<T0, T1>, arg1: &mut Controller, arg2: &mut 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::xluck_reward::NewReward<T2>, arg3: &0x2::clock::Clock, arg4: vector<u8>, arg5: vector<u8>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    fun raffle<T0, T1, T2>(arg0: &mut 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::vault::Vault<T0, T1>, arg1: &mut 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::xluck_reward::NewReward<T2>, arg2: address, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::random::rand_u64_range_with_seed(arg5, 0, 99);
        let v1 = 0;
        let v2 = 0;
        if (arg4 == 0 && v0 < 49 || arg4 == 1 && v0 > 50) {
    ...
    fun range<T0, T1, T2>(arg0: &mut 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::vault::Vault<T0, T1>, arg1: &mut 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::xluck_reward::NewReward<T2>, arg2: address, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::random::rand_u64_range_with_seed(arg5, 0, 99);
        let v1 = v0;
        let v2 = 0;
        let v3 = 0;
        ...
        let (v5, v6) = 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::xluck_reward::new_get_reward<T2>(arg1, arg5, arg3, arg2, arg6);
        let v7 = GamePlay{
            game_id       : 3,
            player        : arg2,
            amount        : arg3,
    ...
    fun wheel<T0, T1, T2>(arg0: &mut 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::vault::Vault<T0, T1>, arg1: &mut 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::xluck_reward::NewReward<T2>, arg2: address, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        let v1 = 0;
        ...
        let (v7, v8) = 0x81f077d146435758456c9962dffc03425af3c47f0b442869af63bf898b6c3ecf::xluck_reward::new_get_reward<T2>(arg1, arg5, arg3, arg2, arg6);
        let v9 = GamePlay{
            game_id       : 4,
            player        : arg2,
            amount        : arg3,
