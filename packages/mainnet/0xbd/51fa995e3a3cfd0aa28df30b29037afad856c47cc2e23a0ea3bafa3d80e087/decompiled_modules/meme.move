module 0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::meme {
    ...
    public fun accept_connector<T0>(arg0: &mut MemeConfig, arg1: 0x2::transfer::Receiving<0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::connector::Connector<T0>>, arg2: &mut 0x2::tx_context::TxContext) {
        enforce_config_version(arg0);
    }

    public fun accept_connector_v2<T0>(arg0: &mut MemeConfig, arg1: 0x2::transfer::Receiving<0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::connector_v2::ConnectorV2<T0>>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        enforce_config_version(arg0);
    }

    public fun accept_connector_v3<T0>(arg0: &mut MemeConfig, arg1: 0x2::transfer::Receiving<0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::connector_v3::ConnectorV3<T0>>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        enforce_config_version(arg0);
        let v0 = 0x2::transfer::public_receive<0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::connector_v3::ConnectorV3<T0>>(&mut arg0.id, arg1);
        let v1 = 0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::connector_v3::get_temp_id<T0>(&v0);
        ...
        let v5 = v2;
        assert!(0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::connector_v3::get_creator<T0>(&v0) == v4, 11);
    ...
    fun buy_returns_internal<T0>(arg0: &mut BondingCurve<T0>, arg1: &MemeConfig, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: address, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let v3 = v2;
        let v4 = 0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::math::get_amount_in(v2, v1, v0);
        let v5 = v4;
        let v6 = 0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::math::get_fee_amount(v4, arg1.swap_fee_bps);
        let v7 = v6;
        if (0x2::coin::value<0x2::sui::SUI>(&arg2) < v4 + v6) {
            let v8 = 0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::math::get_fee_amount(0x2::coin::value<0x2::sui::SUI>(&arg2), arg1.swap_fee_bps);
            v7 = v8;
            let v9 = 0x2::coin::value<0x2::sui::SUI>(&arg2) - v8;
            v5 = v9;
            let v10 = 0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::math::get_amount_out(v9, v1, v0);
            v3 = v10;
            assert!(v10 >= arg4, 2);
        };
        ...
        if (arg0.available_token_reserves == 0) {
            arg0.status = 2;
            0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::events::emit_complete<T0>(get_id<T0>(arg0));
        };
        0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::events::emit_buy<T0>(get_id<T0>(arg0), v5 + v7, v3, get_price_per_token_scaled<T0>(arg0), get_price_per_token_scaled<T0>(arg0), arg5, arg6, arg0.virtual_sui_amount, 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance), 0x2::balance::value<T0>(&arg0.token_balance), arg0.available_token_reserves);
        (arg2, v11)
    }

    public fun complete_migrate<T0>(arg0: &AdminCap, arg1: MigrateReceipt, arg2: 0x2::object::ID) {
        let MigrateReceipt { curve_id: v0 } = arg1;
        0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::events::emit_migrate<T0>(v0, arg2);
    }

    fun create_bonding_curve_v3<T0>(arg0: &0x2::coin::CoinMetadata<T0>, arg1: 0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::connector_v3::ConnectorV3<T0>, arg2: &MemeConfig, arg3: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        enforce_config_version(arg2);
        let (v0, v1, v2, v3, v4, v5) = 0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::connector_v3::deconstruct<T0>(arg1);
        ...
        0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::events::emit_curve_create<T0>(get_id<T0>(&v6), v5, 0x2::coin::get_name<T0>(arg0), 0x2::coin::get_symbol<T0>(arg0), 0x2::coin::get_description<T0>(arg0), 0x2::coin::get_icon_url<T0>(arg0), v2, v3, v4);
        v6
    }
    ...
    public fun place_dev_order(arg0: &mut MemeConfig, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::math::get_amount_in(arg3, arg0.virtual_sui_amount, 1000000000000000);
        let v2 = 0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::math::get_fee_amount(v1, arg0.swap_fee_bps);
    ...
    public fun sell_returns<T0>(arg0: &mut BondingCurve<T0>, arg1: &MemeConfig, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v1 = 0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::math::get_amount_out(v0, 0x2::balance::value<T0>(&arg0.token_balance), arg0.virtual_sui_amount + 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance));
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v2, 0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::math::get_fee_amount(v1, arg1.swap_fee_bps), arg4), @0xe1027c3370081d8867e3a7c20d9e9e55105aa9a856bdf2820c94ecd150fa1a1f);
        assert!(0x2::coin::value<0x2::sui::SUI>(&v2) >= arg3, 2);
        0xbd51fa995e3a3cfd0aa28df30b29037afad856c47cc2e23a0ea3bafa3d80e087::events::emit_sell<T0>(get_id<T0>(arg0), 0x2::coin::value<0x2::sui::SUI>(&v2), v0, get_price_per_token_scaled<T0>(arg0), get_price_per_token_scaled<T0>(arg0), arg0.virtual_sui_amount, 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance), 0x2::balance::value<T0>(&arg0.token_balance), arg0.available_token_reserves);
        v2
    }
