module 0xbd538e52c9c70f1f512a0729a72b01cc94b2e0304c4bce63e01c3e43e6ab1dfb::dex_turbos {
    ...
    fun call_turbos_swap_a_b(arg0: &0x2::clock::Clock, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: u64, arg4: u128, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = TurbosSwapExecuted{
            ...
            amount_in      : arg2,
            min_amount_out : arg3,
            pool_id        : 0xbd538e52c9c70f1f512a0729a72b01cc94b2e0304c4bce63e01c3e43e6ab1dfb::constants::turbos_sui_usdc_pool(),
    ...
    public fun get_pool_config() : address {
        0xbd538e52c9c70f1f512a0729a72b01cc94b2e0304c4bce63e01c3e43e6ab1dfb::constants::turbos_sui_usdc_pool()
    }
