module 0xbdab79b7f5bf5d67559953652677186d6b2bae553fada72a14fddfaae268eeee::cnsnft8685 {
    struct CNSNFT8685 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8685, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8685>(arg0, arg1);
