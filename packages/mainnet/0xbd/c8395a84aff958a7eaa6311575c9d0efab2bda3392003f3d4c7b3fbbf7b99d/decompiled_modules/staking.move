module 0xbdc8395a84aff958a7eaa6311575c9d0efab2bda3392003f3d4c7b3fbbf7b99d::staking {
    ...
    struct StakingPool<phantom T0, phantom T1, phantom T2> has key {
        ...
        kyln_reward_pool: 0x2::balance::Balance<T0>,
        reward_per_share_kyln: u128,
        emissions_kyln: vector<Emission>,
    ...
    public entry fun add_kyln_reward<T0, T1, T2>(arg0: &mut StakingPool<T0, T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &AdminCap) {
        ...
        0x1::vector::push_back<Emission>(&mut arg0.emissions_kyln, v5);
        0x2::balance::join<T0>(&mut arg0.kyln_reward_pool, 0x2::coin::into_balance<T0>(arg1));
        let v6 = EpochAdded{
            token         : 0,
            amount        : v0,
            duration_days : arg2,
            rate          : v3,
            end_time      : v4,
            active_epochs : (0x1::vector::length<Emission>(&arg0.emissions_kyln) as u64),
        };
    ...
    fun calc_pending<T0, T1, T2>(arg0: &StakingPool<T0, T1, T2>, arg1: &StakePosition<T0, T1, T2>) : (u64, u64, u64, u64) {
        (pending_from_rps(arg1.weight, arg0.reward_per_share_kyln, arg1.reward_debt_kyln), pending_from_rps(arg1.weight, arg0.reward_per_share_sui, arg1.reward_debt_sui), pending_from_rps(arg1.weight, arg0.reward_per_share_pans, arg1.reward_debt_pans), pending_from_rps(arg1.weight, arg0.reward_per_share_usdc, arg1.reward_debt_usdc))
    }
    ...
    public entry fun claim_reward<T0, T1, T2>(arg0: &mut StakingPool<T0, T1, T2>, arg1: &mut StakePosition<T0, T1, T2>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v4, 5);
        arg1.reward_debt_kyln = arg1.weight * arg0.reward_per_share_kyln;
    ...
    public entry fun create_pool<T0, T1, T2>(arg0: &AdminCap, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = StakingPool<T0, T1, T2>{
            ...
            kyln_reward_pool      : 0x2::balance::zero<T0>(),
            reward_per_share_kyln : 0,
            emissions_kyln        : 0x1::vector::empty<Emission>(),
    ...
    fun payout<T0, T1, T2>(arg0: &mut StakingPool<T0, T1, T2>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        if (arg1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.kyln_reward_pool, arg1), arg6), arg5);
        };
        if (arg2 > 0) {
    ...
    public fun pending_rewards_now<T0, T1, T2>(arg0: &StakingPool<T0, T1, T2>, arg1: &StakePosition<T0, T1, T2>, arg2: &0x2::clock::Clock) : (u64, u64, u64, u64) {
        ...
        (pending_from_rps(arg1.weight, simulate_rps(&arg0.emissions_kyln, arg0.reward_per_share_kyln, arg0.total_weight, v1, v0), arg1.reward_debt_kyln), pending_from_rps(arg1.weight, simulate_rps(&arg0.emissions_sui, arg0.reward_per_share_sui, arg0.total_weight, v1, v0), arg1.reward_debt_sui), pending_from_rps(arg1.weight, simulate_rps(&arg0.emissions_pans, arg0.reward_per_share_pans, arg0.total_weight, v1, v0), arg1.reward_debt_pans), pending_from_rps(arg1.weight, simulate_rps(&arg0.emissions_usdc, arg0.reward_per_share_usdc, arg0.total_weight, v1, v0), arg1.reward_debt_usdc))
    }

    public fun pool_info<T0, T1, T2>(arg0: &StakingPool<T0, T1, T2>) : (u64, u64, u64, u64, u64, u128, u64, u64, u64, u64, u64, address) {
        (0x2::balance::value<T0>(&arg0.total_staked), 0x2::balance::value<T0>(&arg0.kyln_reward_pool), 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_reward_pool), 0x2::balance::value<T1>(&arg0.pans_reward_pool), 0x2::balance::value<T2>(&arg0.usdc_reward_pool), arg0.total_weight, (0x1::vector::length<Emission>(&arg0.emissions_kyln) as u64), (0x1::vector::length<Emission>(&arg0.emissions_sui) as u64), (0x1::vector::length<Emission>(&arg0.emissions_pans) as u64), (0x1::vector::length<Emission>(&arg0.emissions_usdc) as u64), arg0.max_penalty_bps, arg0.penalty_recipient)
    }
    ...
    public entry fun recover_kyln_rewards<T0, T1, T2>(arg0: &mut StakingPool<T0, T1, T2>, arg1: &0x2::clock::Clock, arg2: address, arg3: &AdminCap, arg4: &mut 0x2::tx_context::TxContext) {
        update_pool_inner<T0, T1, T2>(arg0, 0x2::clock::timestamp_ms(arg1));
        assert!(0x1::vector::is_empty<Emission>(&arg0.emissions_kyln), 9);
        let v0 = 0x2::balance::value<T0>(&arg0.kyln_reward_pool);
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.kyln_reward_pool, v0), arg4), arg2);
        };
    }
    ...
    public entry fun stake<T0, T1, T2>(arg0: &mut StakingPool<T0, T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::clock::timestamp_ms(arg3);
        update_pool_inner<T0, T1, T2>(arg0, v1);
        let v2 = (v0 as u128) * (arg2 as u128) * (arg2 as u128) / 10000;
        ...
        let v4 = StakePosition<T0, T1, T2>{
            ...
            unlock_time      : v3,
            weight           : v2,
            reward_debt_kyln : v2 * arg0.reward_per_share_kyln,
    ...
    fun update_pool_inner<T0, T1, T2>(arg0: &mut StakingPool<T0, T1, T2>, arg1: u64) {
        ...
        if (arg0.total_weight > 0) {
            let v1 = &mut arg0.emissions_kyln;
            arg0.reward_per_share_kyln = tick_rps(v1, arg0.reward_per_share_kyln, arg0.total_weight, v0, arg1);
            ...
            let v5 = &mut arg0.emissions_kyln;
