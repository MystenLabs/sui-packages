module 0xbd2a6ae2ada9c32a60077991b021772718ba9358d2face8bb6403bdb1d7e1351::cnsnft3132 {
    struct CNSNFT3132 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3132, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3132>(arg0, arg1);
