module 0xbd84b863a243c2c0a4d7044a7ae4a3b5e2724246c3247d1e54bcd56fe8c981ff::seal_pioneer {
    ...
    fun init(arg0: SEAL_PIONEER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A follow-up badge for true pioneers. For those who keep forging the path in Seal expedition."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreib3rezp2lcgy3ukmqn3u57dbqgfnbiqv33c6anj67yprtrys2jsoi"));
