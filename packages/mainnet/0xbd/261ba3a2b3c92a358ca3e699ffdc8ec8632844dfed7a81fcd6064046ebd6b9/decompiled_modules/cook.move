module 0xbd261ba3a2b3c92a358ca3e699ffdc8ec8632844dfed7a81fcd6064046ebd6b9::cook {
    ...
    fun init(arg0: COOK, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<COOK>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Cook"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Egg"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibdtm4rd6y7f6x5ukcz2e7codkupvu3wdwgi3lr2mujjyevs7aimu"));
