module 0xbd1b45833f406826977dacc7d68881e4931add49bbcb4384f3ef5d1d82914328::registry {
    ...
    public fun approve<T0: drop>(arg0: &0xbd1b45833f406826977dacc7d68881e4931add49bbcb4384f3ef5d1d82914328::admin::AdminCap, arg1: &mut AdapterRegistry, arg2: u64) {
    ...
    public fun revoke<T0: drop>(arg0: &0xbd1b45833f406826977dacc7d68881e4931add49bbcb4384f3ef5d1d82914328::admin::AdminCap, arg1: &mut AdapterRegistry) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        if (0x2::vec_map::contains<0x1::type_name::TypeName, AdapterInfo>(&arg1.approved, &v0)) {
