module 0xbdc40665100575c3bd5bed03936bd308b85fa225f3bc1e2ad6223d3f04ddad24::wave_lottery {
    ...
    entry fun complete(arg0: &App, arg1: &mut Game, arg2: &0x2::clock::Clock, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xbdc40665100575c3bd5bed03936bd308b85fa225f3bc1e2ad6223d3f04ddad24::drand_lib::verify_drand_signature(arg3, arg4, arg1.round);
        ...
        arg1.status = 1;
        let v2 = 0xbdc40665100575c3bd5bed03936bd308b85fa225f3bc1e2ad6223d3f04ddad24::drand_lib::derive_randomness(arg3);
        let v3 = 0;
        while (v3 < arg1.n_winner) {
            0x1::vector::push_back<u64>(&mut arg1.lucky_numbers, 0xbdc40665100575c3bd5bed03936bd308b85fa225f3bc1e2ad6223d3f04ddad24::drand_lib::safe_selection(arg1.ticket_sold, &v2) + 1);
            v2 = 0xbdc40665100575c3bd5bed03936bd308b85fa225f3bc1e2ad6223d3f04ddad24::drand_lib::derive_randomness(v2);
            v3 = v3 + 1;
        };
        if (arg1.game_type == 0) {
    ...
    entry fun create(arg0: &LotteryOwnerCap, arg1: &mut App, arg2: u64, arg3: u64, arg4: u16, arg5: u64, arg6: u8, arg7: u64, arg8: u64, arg9: u16, arg10: u16, arg11: u16, arg12: u32, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
        assert!(arg6 < 5, 6);
        assert!(arg9 <= 1000, 15);
    ...
    fun finalize_redeem(arg0: &mut Game, arg1: address, arg2: u16, arg3: u64) {
    ...
    fun next_sequence(arg0: &mut App, arg1: u8) : u64 {
        ...
        } else if (0x2::dynamic_field::exists_with_type<vector<u8>, u64>(&arg0.id, seq_key(arg1))) {
            let v1 = 0x2::dynamic_field::borrow_mut<vector<u8>, u64>(&mut arg0.id, seq_key(arg1));
            let v2 = *v1;
            v0 = v2;
            *v1 = v2 + 1;
        } else {
            0x2::dynamic_field::add<vector<u8>, u64>(&mut arg0.id, seq_key(arg1), 2);
        };
        v0
    }
    ...
    entry fun operator_update_game(arg0: &LotteryOwnerCap, arg1: &mut Game, arg2: u64, arg3: u16, arg4: u16, arg5: u16, arg6: u16, arg7: u32) {
    ...
    entry fun participate_sui_nft(arg0: &App, arg1: &mut Game, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        can_participate(arg0, arg1, arg3, arg5, 3, 0x2::tx_context::sender(arg6), arg4);
        let v0 = arg1.ticket_price * arg3;
        let v1 = take_exact_amount<0x2::sui::SUI>(arg2, v0, arg6);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v1, arg0.sui_receiver);
        add_ticket(arg1, arg3, v0, arg6);
    }

    entry fun participate_sui_nft_discount(arg0: &App, arg1: &mut Game, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0xbe9d578ed9e0b7dbd79555fe02b8058be262f4c534adbf816cd6c4606df9ead9::ocean_nft::NFT, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        can_participate(arg0, arg1, arg3, arg6, 3, 0x2::tx_context::sender(arg7), arg5);
        let v0 = required_amount_nft(arg1, arg3);
        let v1 = take_exact_amount<0x2::sui::SUI>(arg2, v0, arg7);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v1, arg0.sui_receiver);
        add_ticket(arg1, arg3, v0, arg7);
    ...
    entry fun participate_wav_nft(arg0: &App, arg1: &mut Game, arg2: 0x2::coin::Coin<0x82616322719cb327186d5b83a6d7783ce5cef4c5dbd4c6d1b5f3d6e5d288e2be::wav::WAV>, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        can_participate(arg0, arg1, arg3, arg5, 4, 0x2::tx_context::sender(arg6), arg4);
        let v0 = arg1.ticket_price * arg3;
        let v1 = take_exact_amount<0x82616322719cb327186d5b83a6d7783ce5cef4c5dbd4c6d1b5f3d6e5d288e2be::wav::WAV>(arg2, v0, arg6);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x82616322719cb327186d5b83a6d7783ce5cef4c5dbd4c6d1b5f3d6e5d288e2be::wav::WAV>>(v1, arg0.ocean_receiver);
        add_ticket(arg1, arg3, v0, arg6);
    }

    entry fun participate_wav_nft_discount(arg0: &App, arg1: &mut Game, arg2: 0x2::coin::Coin<0x82616322719cb327186d5b83a6d7783ce5cef4c5dbd4c6d1b5f3d6e5d288e2be::wav::WAV>, arg3: u64, arg4: &0xbe9d578ed9e0b7dbd79555fe02b8058be262f4c534adbf816cd6c4606df9ead9::ocean_nft::NFT, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        can_participate(arg0, arg1, arg3, arg6, 4, 0x2::tx_context::sender(arg7), arg5);
        let v0 = required_amount_nft(arg1, arg3);
        let v1 = take_exact_amount<0x82616322719cb327186d5b83a6d7783ce5cef4c5dbd4c6d1b5f3d6e5d288e2be::wav::WAV>(arg2, v0, arg7);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x82616322719cb327186d5b83a6d7783ce5cef4c5dbd4c6d1b5f3d6e5d288e2be::wav::WAV>>(v1, arg0.ocean_receiver);
        add_ticket(arg1, arg3, v0, arg7);
    }
    ...
    fun redeem_nft(arg0: &mut App, arg1: &mut Game, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: u16, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg1.game_type == 2) {
            true
        } else if (arg1.game_type == 3) {
            true
        } else {
            arg1.game_type == 4
        };
        ...
        let v1 = verify_winner(arg1, arg2);
        let v2 = 0x1::string::utf8(b"LOTTERY_REDEEM:");
        let v3 = 0x2::bcs::to_bytes<0x1::string::String>(&v2);
        0x1::vector::append<u8>(&mut v3, 0x2::bcs::to_bytes<address>(&arg2));
        let v4 = 0x1::string::utf8(b"-");
        0x1::vector::append<u8>(&mut v3, 0x2::bcs::to_bytes<0x1::string::String>(&v4));
        0x1::vector::append<u8>(&mut v3, 0x2::bcs::to_bytes<0x2::object::UID>(&arg1.id));
        ...
        0x1::vector::append<u8>(&mut v3, 0x2::bcs::to_bytes<vector<u8>>(&arg5));
        let v8 = 0x1::string::utf8(b"-");
        0x1::vector::append<u8>(&mut v3, 0x2::bcs::to_bytes<0x1::string::String>(&v8));
        0x1::vector::append<u8>(&mut v3, 0x2::bcs::to_bytes<u16>(&arg6));
        assert!(0x2::ed25519::ed25519_verify(&arg7, &arg0.operator_pk, &v3) == true, 9);
        let v9 = 0;
        while (v9 < v1) {
            inner_claim_nft(arg0, arg3, arg4, arg5, arg6, arg2, arg8);
            v9 = v9 + 1;
        };
        finalize_redeem(arg1, arg2, v1, (v1 as u64));
    }
    ...
    fun required_amount_nft(arg0: &Game, arg1: u64) : u64 {
        arg0.ticket_price * ((10000 - arg0.nft_discount_rate) as u64) / 10000 * arg1
    }
    ...
    fun seq_key(arg0: u8) : vector<u8> {
        let v0 = 0x1::string::utf8(b"seq:");
        let v1 = 0x2::bcs::to_bytes<0x1::string::String>(&v0);
        0x1::vector::append<u8>(&mut v1, 0x2::bcs::to_bytes<u8>(&arg0));
        v1
    }
    ...
    entry fun update_sequence(arg0: &LotteryOwnerCap, arg1: &mut App, arg2: u8, arg3: u64) {
        assert!(arg2 < 5, 6);
        if (arg2 == 0) {
            arg1.sui_seq = arg3;
        } else if (arg2 == 1) {
            ...
            arg1.nft_seq = arg3;
        } else if (0x2::dynamic_field::exists_with_type<vector<u8>, u64>(&arg1.id, seq_key(arg2))) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, u64>(&mut arg1.id, seq_key(arg2)) = arg3;
        } else {
            0x2::dynamic_field::add<vector<u8>, u64>(&mut arg1.id, seq_key(arg2), arg3);
        };
    }
    ...
    fun verify_winner(arg0: &Game, arg1: address) : u16 {
