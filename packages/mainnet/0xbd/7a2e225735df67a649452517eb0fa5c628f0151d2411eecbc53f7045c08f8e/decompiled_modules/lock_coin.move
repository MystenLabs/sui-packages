module 0xbd7a2e225735df67a649452517eb0fa5c628f0151d2411eecbc53f7045c08f8e::lock_coin {
    ...
    public fun unlock_coin<T0>(arg0: LockedCoin<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v4 = v1;
        let v5 = v0;
        assert!(v3 <= 0xbd7a2e225735df67a649452517eb0fa5c628f0151d2411eecbc53f7045c08f8e::utils::now_timestamp(arg1), 1);
