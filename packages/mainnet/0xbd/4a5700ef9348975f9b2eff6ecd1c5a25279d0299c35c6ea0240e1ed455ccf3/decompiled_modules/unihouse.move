module 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse {
    ...
    struct RedeemRequest<phantom T0> has store, key {
        id: 0x2::object::UID,
        s_coin: 0x2::coin::Coin<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::StakedHouseCoin<T0>>,
        created_at: u64,
        sender: address,
    }
    ...
    struct BlackjackGameResult<phantom T0, phantom T1> has copy, drop {
        ...
        bet_size: u64,
        bet_returned: u64,
        player_hands: vector<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::game_structs::BlackjackHand>,
    ...
    struct PlinkoGameResult<phantom T0, phantom T1> has copy, drop {
        ...
        bet_size: u64,
        bet_returned: u64,
        ball_outcomes: vector<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::game_structs::BallOutcome>,
        bet_results: vector<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::game_structs::BetResult<T0>>,
        origin: 0x1::string::String,
    }
    ...
    struct RangeGameResult<phantom T0, phantom T1> has copy, drop {
        player: address,
        origin: 0x1::string::String,
        bet_results: vector<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::game_structs::RangeGame>,
    }
    ...
    public fun deposit<T0>(arg0: &mut Unihouse, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::StakedHouseCoin<T0>> {
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::deposit<T0>(borrow_house_mut<T0>(arg0), 0x2::coin::into_balance<T0>(arg1), arg2)
    }

    public fun deposit_house_pool<T0>(arg0: &mut Unihouse, arg1: 0x2::coin::Coin<T0>) {
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::deposit_house_pool<T0>(borrow_house_mut<T0>(arg0), 0x2::coin::into_balance<T0>(arg1));
    }
    ...
    public fun house_metadata<T0>(arg0: &Unihouse) : (u64, u64, u64, u64, u64, u64) {
        ...
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::house_metadata<T0>(0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::House<T0>>(&arg0.id, v0))
    }
    ...
    public fun join<T0, T1: drop>(arg0: &mut Unihouse, arg1: T1, arg2: 0x2::balance::Balance<T0>) {
        ...
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::join<T0>(borrow_house_mut<T0>(arg0), arg2);
    }
    ...
    public fun join_with_fee<T0, T1: drop>(arg0: &mut Unihouse, arg1: T1, arg2: 0x2::balance::Balance<T0>) {
        ...
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::join_with_fee<T0>(borrow_house_mut<T0>(arg0), arg2);
    }

    public fun max_risk<T0>(arg0: &Unihouse) : u64 {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::dynamic_object_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 2);
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::max_risk<T0>(0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::House<T0>>(&arg0.id, v0))
    }
    ...
    public fun split<T0, T1: drop>(arg0: &mut Unihouse, arg1: T1, arg2: u64) : 0x2::balance::Balance<T0> {
        ...
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::split<T0>(borrow_house_mut<T0>(arg0), arg2)
    }
    ...
    public fun split_with_reimbursement<T0, T1: drop>(arg0: &mut Unihouse, arg1: T1, arg2: u64) : 0x2::balance::Balance<T0> {
        ...
        v0.current_epoch_risk_count = v0.current_epoch_risk_count + arg2;
        assert!(v0.current_epoch_risk_count <= v0.daily_risk_limit, 8);
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::split_with_reimbursement<T0>(borrow_house_mut<T0>(arg0), arg2)
    }
    ...
    public fun withdraw_house_pool<T0>(arg0: &AdminCap, arg1: &mut Unihouse, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x2::coin::from_balance<T0>(0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::withdraw_house_pool<T0>(borrow_house_mut<T0>(arg1), arg2), arg3)
    }

    public fun pipe<T0, T1: drop>(arg0: &Unihouse) : &0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::Pipe<T0, T1> {
        if (!pipe_exists<T0, T1>(arg0)) {
            err_pipe_not_exists();
        };
        0x2::dynamic_field::borrow<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::PipeType<T0, T1>, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::Pipe<T0, T1>>(&arg0.id, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::new_type<T0, T1>())
    }

    public fun house_debt_value<T0, T1: drop>(arg0: &Unihouse) : u64 {
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::house_debt_value<T0, T1>(pipe<T0, T1>(arg0))
    }

    public fun output<T0, T1: drop>(arg0: &mut Unihouse, arg1: u64) : 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::OutputCarrier<T0, T1> {
        let v0 = borrow_house_mut<T0>(arg0);
        let (v1, v2, v3, v4) = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::split_for_pipe<T0>(v0, arg1, 0);
        0x2::balance::destroy_zero<T0>(v3);
        0x2::balance::destroy_zero<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::HouseDebt<T0>>(v4);
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::output<T0, T1>(pipe_mut<T0, T1>(arg0), v1, v2)
    }

    public fun output_from_house<T0, T1: drop>(arg0: &mut Unihouse, arg1: u64) : 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::OutputCarrier<T0, T1> {
        let v0 = borrow_house_mut<T0>(arg0);
        let (v1, v2, v3, v4) = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::split_for_pipe<T0>(v0, 0, arg1);
        0x2::balance::destroy_zero<T0>(v1);
        0x2::balance::destroy_zero<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::PoolDebt<T0>>(v2);
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::output_from_house<T0, T1>(pipe_mut<T0, T1>(arg0), v3, v4)
    }

    public fun pool_debt_value<T0, T1: drop>(arg0: &Unihouse) : u64 {
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::pool_debt_value<T0, T1>(pipe<T0, T1>(arg0))
    }

    public fun total_debt_value<T0, T1: drop>(arg0: &Unihouse) : u64 {
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::total_debt_value<T0, T1>(pipe<T0, T1>(arg0))
    }
    ...
    fun assert_valid_voucher_value<T0, T1>(arg0: &Unihouse, arg1: &0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::voucher::UnihouseVoucher<T0, T1>) {
        let v0 = voucher_max_value<T0>(arg0);
        if (0x1::option::is_none<u64>(&v0)) {
            return
        };
        assert!(0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::voucher::value<T0, T1>(arg1) <= 0x1::option::destroy_some<u64>(v0), 5);
    }
    ...
    public fun assert_within_risk<T0, T1: drop>(arg0: &mut Unihouse, arg1: T1, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(arg2 <= 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::max_risk<T0>(v1), 3);
        assert!(0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::math::mul_rate(arg2, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::fee_rate()) <= 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::total_house_balance<T0>(v1), 9);
    }
    ...
    public fun borrow_house<T0>(arg0: &Unihouse) : &0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::House<T0> {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::dynamic_object_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 2);
        0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::House<T0>>(&arg0.id, v0)
    }

    fun borrow_house_mut<T0>(arg0: &mut Unihouse) : &mut 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::House<T0> {
        assert_valid_version(arg0);
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::dynamic_object_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 2);
        0x2::dynamic_object_field::borrow_mut<0x1::type_name::TypeName, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::House<T0>>(&mut arg0.id, v0)
    }
    ...
    public fun buy_voucher<T0, T1>(arg0: &mut Unihouse, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::voucher::UnihouseVoucher<T0, T1> {
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::voucher_deposit<T0>(borrow_house_mut<T0>(arg0), arg1);
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::voucher::mint<T0, T1>(0x2::coin::value<T0>(&arg1), 0x2::clock::timestamp_ms(arg2) + 7776000000, arg3)
    }
    ...
    public fun create_house<T0>(arg0: &AdminCap, arg1: &mut Unihouse, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<0x1::type_name::TypeName, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::House<T0>>(&mut arg1.id, v0, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::new<T0>(arg2));
    }

    public fun create_pipe<T0, T1: drop>(arg0: &AdminCap, arg1: &mut Unihouse) {
        0x2::dynamic_field::add<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::PipeType<T0, T1>, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::Pipe<T0, T1>>(&mut arg1.id, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::new_type<T0, T1>(), 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::new_pipe<T0, T1>());
    }

    public fun destroy_pipe<T0, T1: drop>(arg0: &AdminCap, arg1: &mut Unihouse) {
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::destroy<T0, T1>(0x2::dynamic_field::remove<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::PipeType<T0, T1>, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::Pipe<T0, T1>>(&mut arg1.id, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::new_type<T0, T1>()));
    }
    ...
    public fun emit_blackjack_game_result<T0, T1: drop>(arg0: &mut Unihouse, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64, arg5: vector<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::game_structs::BlackjackHand>, arg6: vector<u8>, arg7: address, arg8: 0x1::string::String) {
        assert!(game_config_exists<T0, T1>(arg0), 4);
    ...
    public fun emit_range_game_results<T0, T1: drop>(arg0: &Unihouse, arg1: address, arg2: 0x1::string::String, arg3: vector<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::game_structs::RangeGame>) {
        assert!(game_config_exists<T0, T1>(arg0), 4);
    ...
    public fun fulfill_redeem_request<T0>(arg0: &mut Unihouse, arg1: &AdminCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::redeem<T0>(borrow_house_mut<T0>(arg0), 0x2::coin::into_balance<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::StakedHouseCoin<T0>>(v1), v3), arg3), v3);
    }
    ...
    public fun input<T0, T1: drop>(arg0: &mut Unihouse, arg1: 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::InputCarrier<T0, T1>) {
        let v0 = pipe_mut<T0, T1>(arg0);
        let (v1, v2) = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::destroy_input_carrier<T0, T1>(v0, arg1);
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::join_from_pipe<T0>(borrow_house_mut<T0>(arg0), v1, v2, 0x2::balance::zero<T0>(), 0x2::balance::zero<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::HouseDebt<T0>>());
    }

    public fun input_to_house<T0, T1: drop>(arg0: &mut Unihouse, arg1: 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::InputCarrier<T0, T1>) {
        let v0 = pipe_mut<T0, T1>(arg0);
        let (v1, v2) = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::destroy_input_carrier_for_house<T0, T1>(v0, arg1);
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::join_from_pipe<T0>(borrow_house_mut<T0>(arg0), 0x2::balance::zero<T0>(), 0x2::balance::zero<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::PoolDebt<T0>>(), v1, v2);
    }
    ...
    public fun pipe_exists<T0, T1: drop>(arg0: &Unihouse) : bool {
        0x2::dynamic_field::exists_with_type<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::PipeType<T0, T1>, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::Pipe<T0, T1>>(&arg0.id, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::new_type<T0, T1>())
    }

    fun pipe_mut<T0, T1: drop>(arg0: &mut Unihouse) : &mut 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::Pipe<T0, T1> {
        if (!pipe_exists<T0, T1>(arg0)) {
            err_pipe_not_exists();
        };
        0x2::dynamic_field::borrow_mut<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::PipeType<T0, T1>, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::Pipe<T0, T1>>(&mut arg0.id, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::pipe::new_type<T0, T1>())
    }
    ...
    public fun reclaim_voucher_pool<T0>(arg0: &mut Unihouse, arg1: &mut AdminCap, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = borrow_house_mut<T0>(arg0);
        let (_, v2, _, _, _, _) = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::house_metadata<T0>(v0);
        0x2::coin::from_balance<T0>(0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::split_for_voucher<T0>(v0, v2), arg2)
    }

    public fun redeem_request<T0>(arg0: &mut Unihouse, arg1: 0x2::coin::Coin<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::StakedHouseCoin<T0>>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
    ...
    public fun redeem_voucher<T0, T1>(arg0: &mut Unihouse, arg1: &mut 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::voucher::UnihouseVoucher<T0, T1>, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_valid_voucher_value<T0, T1>(arg0, arg1);
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::voucher::deduct<T0, T1>(arg1, arg2, arg3);
        0x2::coin::from_balance<T0>(0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::split_for_voucher<T0>(borrow_house_mut<T0>(arg0), arg3), arg4)
    }
    ...
    public fun set_house_max_supply<T0>(arg0: &mut Unihouse, arg1: &AdminCap, arg2: u64) {
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::set_max_supply<T0>(borrow_house_mut<T0>(arg0), arg2);
    }
