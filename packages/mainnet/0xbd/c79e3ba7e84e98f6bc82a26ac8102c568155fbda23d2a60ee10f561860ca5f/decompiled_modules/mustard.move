module 0xbdc79e3ba7e84e98f6bc82a26ac8102c568155fbda23d2a60ee10f561860ca5f::mustard {
    ...
    fun init(arg0: MUSTARD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<MUSTARD>(&mut v3, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
