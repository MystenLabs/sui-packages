module 0xbde1e474f540b4c83202dde62c9690d833feb3b73845248c97e6e84aa0c720eb::suitempleton {
    ...
    fun init(arg0: SUITEMPLETON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::mint_and_transfer<SUITEMPLETON>(&mut v0, 10000000000000000000, 0x2::tx_context::sender(arg1), arg1);
