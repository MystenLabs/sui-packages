module 0xbddc4ecfd16683d1859500a5db1fb2cf00eeecb6719b76066bdc39c74dd03251::farming_events {
    ...
    struct FarmingOwnerTransferProposed has copy, drop {
        caller: address,
    ...
    struct FarmingOwnerTransferCanceled has copy, drop {
        caller: address,
        current_owner: address,
        canceled_owner: address,
        timestamp_ms: u64,
    }

    struct FarmingOwnerTransferred has copy, drop {
        caller: address,
        old_owner: address,
        new_owner: address,
        timestamp_ms: u64,
    ...
    public(friend) fun emit_owner_transfer_canceled(arg0: address, arg1: address, arg2: &0x2::tx_context::TxContext) {
        let (v0, v1) = timestamp(arg2);
        let v2 = FarmingOwnerTransferCanceled{
            caller         : v0,
            current_owner  : arg0,
            canceled_owner : arg1,
            timestamp_ms   : v1,
        };
        0x2::event::emit<FarmingOwnerTransferCanceled>(v2);
    }

    public(friend) fun emit_owner_transfer_proposed(arg0: address, arg1: address, arg2: &0x2::tx_context::TxContext) {
        let (v0, v1) = timestamp(arg2);
        let v2 = FarmingOwnerTransferProposed{
            caller        : v0,
            current_owner : arg0,
            pending_owner : arg1,
            timestamp_ms  : v1,
        };
        0x2::event::emit<FarmingOwnerTransferProposed>(v2);
    }

    public(friend) fun emit_owner_transferred(arg0: address, arg1: address, arg2: &0x2::tx_context::TxContext) {
        let (v0, v1) = timestamp(arg2);
        let v2 = FarmingOwnerTransferred{
            caller       : v0,
            old_owner    : arg0,
            new_owner    : arg1,
            timestamp_ms : v1,
        };
        0x2::event::emit<FarmingOwnerTransferred>(v2);
    }
