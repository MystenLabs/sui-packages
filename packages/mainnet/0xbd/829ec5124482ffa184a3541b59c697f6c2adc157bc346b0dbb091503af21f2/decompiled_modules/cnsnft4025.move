module 0xbd829ec5124482ffa184a3541b59c697f6c2adc157bc346b0dbb091503af21f2::cnsnft4025 {
    struct CNSNFT4025 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4025, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4025>(arg0, arg1);
