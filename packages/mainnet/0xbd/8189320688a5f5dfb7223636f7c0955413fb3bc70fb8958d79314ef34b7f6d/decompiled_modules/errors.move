module 0xab489625e5e6739c43340e24d5c9ca476a24194fac08c3cc09449df5c50da776::errors {
    ...
    public(friend) fun clearing_house_not_empty() : u64 {
        56
    }

    public(friend) fun deposit_rounding_loss_too_high() : u64 {
        57
    }
