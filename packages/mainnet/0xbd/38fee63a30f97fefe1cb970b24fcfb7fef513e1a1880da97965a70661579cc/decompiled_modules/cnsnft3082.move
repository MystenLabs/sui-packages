module 0xbd38fee63a30f97fefe1cb970b24fcfb7fef513e1a1880da97965a70661579cc::cnsnft3082 {
    struct CNSNFT3082 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3082, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3082>(arg0, arg1);
