module 0xbdf3b427e00e4736c4e3c8e07322a635fcb7aab667a16a68d27de48538902660::cnsnft2747 {
    struct CNSNFT2747 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2747, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2747>(arg0, arg1);
