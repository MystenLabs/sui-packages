        ...
        if (v0 >= v3) {
            ...
            while (0x2::balance::value<0x2::sui::SUI>(&arg11) < v1) {
                ...
                if (v0 >= v6) {
                    ...
                    abort get_withdraw_amt(arg0, arg1, arg2, arg5, 0x2::balance::value<0x2::sui::SUI>(&v9))
                };
            };
        };
        let v10 = 0x2::balance::value<0x2::sui::SUI>(&arg11);
        assert!(v10 >= v1, 104);
        add_to_collected_asset<0x2::sui::SUI>(arg0, 0x2::balance::split<0x2::sui::SUI>(&mut arg11, v10 - v1));
        arg11
    }
