module 0xbdcfd6b09c3ecacc6132539376980cb1d0e38f45a4cdf75339c63825a91a92ff::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    struct TreasurySupply {
        supply: u64,
    }
    ...
    public fun get_treasury_supply(arg0: &0x2::coin::TreasuryCap<SIMPLE_TOKEN>) : u64 {
        1000000
    }
