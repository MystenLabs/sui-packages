module 0xbd5a8768cb370f793219b1e8f35adc3bcd2adab385a07aa6ee4556a0d2ed869e::tick_query {
    ...
    fun gather_initialized_ticks(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::TickManager, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg2: u32, arg3: u32) : vector<0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32> {
        ...
        let v3 = 0;
        loop {
            let v4 = if (v1 < arg3 || v2 < arg3) {
                if (arg2 <= (5 * arg3 - 100) * arg2) {
                    v3 < 800
                } else {
                    false
                }
            ...
            if (v4) {
                if (v1 < arg3) {
                    let v5 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::sub(arg1, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from(arg2));
                    v3 = v3 + 1;
                ...
                if (v2 < arg3) {
                    let v6 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::add(arg1, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from(arg2));
                    v3 = v3 + 1;
    ...
    public entry fun get_ticks_around_marker<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: u32, arg2: u32) {
        assert!(arg2 > 1, 0);
        let v0 = TickLog{ticks: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::fetch_provided_ticks<T0, T1>(arg0, convert_i32_vector_to_u32(gather_initialized_ticks(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_tick_manager<T0, T1>(arg0), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg1), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_tick_spacing<T0, T1>(arg0), arg2)))};
        0x2::event::emit<TickLog>(v0);
        emit_simple_pool_info<T0, T1>(arg0);
    }
