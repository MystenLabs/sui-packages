module 0xbd4cf4b26ff60baa42a506dd3c5cb17807a3ba38ad2e9f7266705f9da3b31820::cnsnft9390 {
    struct CNSNFT9390 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9390, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9390>(arg0, arg1);
