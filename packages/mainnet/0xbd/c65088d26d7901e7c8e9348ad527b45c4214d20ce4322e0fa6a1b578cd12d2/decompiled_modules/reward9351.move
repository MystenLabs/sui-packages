module 0xbdc65088d26d7901e7c8e9348ad527b45c4214d20ce4322e0fa6a1b578cd12d2::reward9351 {
    struct REWARD9351 has drop {
        dummy_field: bool,
    }

    struct TICKET_9351 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9351(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9351>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9351>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9351, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9351>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9351>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9351>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9351>>(v5, 0x2::tx_context::sender(arg1));
    }
