module 0xbd7d71e234d3d6e9ce8ee215e1b4a01b340808708348c7844529cc974a19bdc0::glooms {
    ...
    fun init(arg0: GLOOMS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<GLOOMS>(arg0, 6, b"GLOOMS", b"GLOOMS", b"The most adorable cult to ever invade SUI.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://red-rainy-catfish-636.mypinata.cloud/ipfs/QmY8oLfuXAzE9c1LKgaFAEsVNaektL4W82pLRDX4ChY1KZ")), arg1);
        let v2 = v0;
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<GLOOMS>>(v1);
        0x2::transfer::public_transfer<0x2::coin::Coin<GLOOMS>>(0x2::coin::mint<GLOOMS>(&mut v2, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
        let v3 = GLOOMSCap{
