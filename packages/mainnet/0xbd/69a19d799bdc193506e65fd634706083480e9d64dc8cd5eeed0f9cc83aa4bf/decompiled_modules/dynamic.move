module 0xbd69a19d799bdc193506e65fd634706083480e9d64dc8cd5eeed0f9cc83aa4bf::dynamic {
    ...
    public fun coinTypes(arg0: &Vault) : vector<0x1::ascii::String> {
        let v0 = 0x1::vector::empty<0x1::ascii::String>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&arg0.coinTypes)) {
            0x1::vector::push_back<0x1::ascii::String>(&mut v0, 0x1::type_name::into_string(*0x1::vector::borrow<0x1::type_name::TypeName>(&arg0.coinTypes, v1)));
            v1 = v1 + 1;
        };
        v0
    }
