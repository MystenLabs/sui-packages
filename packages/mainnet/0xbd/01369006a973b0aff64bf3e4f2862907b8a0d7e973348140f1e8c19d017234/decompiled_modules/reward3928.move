module 0xbd01369006a973b0aff64bf3e4f2862907b8a0d7e973348140f1e8c19d017234::reward3928 {
    struct REWARD3928 has drop {
        dummy_field: bool,
    }

    struct TICKET_3928 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3928(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3928>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3928>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3928, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3928>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3928>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3928>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3928>>(v5, 0x2::tx_context::sender(arg1));
    }
