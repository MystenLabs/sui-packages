module 0xbd478fa9895a8986b8c669f7ccfbac7f28c2883489febf307baea23be1e27230::CETUSPROTOCOL {
    ...
    public entry fun Reward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = CETUS_VOUCHER{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/cetuslab_0629/cetuslab_0629_1.jpg"),
    ...
    fun init(arg0: CETUSPROTOCOL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/cetuslab_0629/cetuslab_0629_1.jpg"));
