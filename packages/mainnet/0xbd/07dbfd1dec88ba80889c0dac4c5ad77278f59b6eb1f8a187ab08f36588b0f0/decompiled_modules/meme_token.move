module 0xbd07dbfd1dec88ba80889c0dac4c5ad77278f59b6eb1f8a187ab08f36588b0f0::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"Bul", b"Vadaa", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-31T11-55-21.334Z-MainBefore.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Vadaa"),
            symbol     : 0x1::string::utf8(b"Bul"),
            decimals   : 9,
