module 0xbd898931a497a6829806c29fb483a4a9a68468e5fcaa4833a365505a72b1cceb::cnsnft8300 {
    struct CNSNFT8300 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8300, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8300>(arg0, arg1);
