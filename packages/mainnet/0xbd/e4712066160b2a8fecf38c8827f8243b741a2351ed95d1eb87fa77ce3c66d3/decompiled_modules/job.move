module 0xbde4712066160b2a8fecf38c8827f8243b741a2351ed95d1eb87fa77ce3c66d3::job {
    struct JOB has drop {
        dummy_field: bool,
    }

    fun init(arg0: JOB, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<JOB>(arg0, 9, b"JOB", b"Jean On Blast", b"This memes about Jean", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://files.catbox.moe/ghdf0d.jpeg")), arg1);
