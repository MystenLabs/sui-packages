module 0xbdd3e803199e9d599be97b55334f34dd25d8330a13e288ea7b332ba5dac9f89d::vram {
    ...
    fun new(arg0: u64, arg1: 0x1::string::String, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &mut 0x2::tx_context::TxContext) : VramNFT {
        ...
        VramNFT{
            id          : v0,
            name        : 0x1::string::utf8(b"VRAM Genesis Core"),
    ...
    fun init(arg0: VRAM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"VRAM GENESIS CORE"));
        ...
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"VRAM Genesis Core #{number_id}"));
        ...
        let v4 = v3;
        let v5 = v2;
        0xbdd3e803199e9d599be97b55334f34dd25d8330a13e288ea7b332ba5dac9f89d::kiosk_lock_rule::add<VramNFT>(&mut v5, &v4);
        0xbdd3e803199e9d599be97b55334f34dd25d8330a13e288ea7b332ba5dac9f89d::royalty_rule::add<VramNFT>(&mut v5, &v4, 500, 0);
