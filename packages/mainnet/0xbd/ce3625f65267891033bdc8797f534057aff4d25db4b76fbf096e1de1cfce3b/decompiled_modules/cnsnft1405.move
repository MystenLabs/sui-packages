module 0xbdce3625f65267891033bdc8797f534057aff4d25db4b76fbf096e1de1cfce3b::cnsnft1405 {
    struct CNSNFT1405 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1405, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1405>(arg0, arg1);
