module 0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::volcano {
    ...
    public entry fun decrease_eruption(arg0: &mut Volcano, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::position::decrease(v4, arg2, v2);
        let v5 = EruptionDecreased{
            user            : v1,
            amount          : arg2,
            new_level       : arg0.eruption_level,
            total_decreases : 0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::position::get_total_decreases(v4),
        };
    ...
    public fun get_or_create_position(arg0: &mut Volcano, arg1: address, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) : &mut 0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::position::Position {
        if (!0x2::dynamic_field::exists_<address>(&arg0.id, arg1)) {
            0x2::dynamic_field::add<address, 0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::position::Position>(&mut arg0.id, arg1, 0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::position::create_position_with_display(arg2, arg3));
        };
        0x2::dynamic_field::borrow_mut<address, 0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::position::Position>(&mut arg0.id, arg1)
    }
    ...
    public fun get_user_stats(arg0: &Volcano, arg1: address) : (u64, u64, u64) {
        ...
        let v0 = 0x2::dynamic_field::borrow<address, 0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::position::Position>(&arg0.id, arg1);
        (0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::position::get_total_increases(v0), 0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::position::get_total_decreases(v0), 0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::position::get_last_action(v0))
    }
    ...
    public entry fun increase_eruption(arg0: &mut Volcano, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        v3.last_action = v2;
        let v4 = get_or_create_position(arg0, v1, arg3, arg4);
        0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::position::increase(v4, arg2, v2);
        ...
        let v6 = EruptionIncreased{
            ...
            amount          : arg2,
            new_level       : arg0.eruption_level,
            total_increases : 0xbd24e6d5f037f6f2a211aa3c0217d18678782ba1102ea79787a485ec7d772b9b::position::get_total_increases(v4),
        };
