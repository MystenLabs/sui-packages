module 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::listing {
    ...
    struct WhitelistDfKey has copy, drop, store {
        venue_id: 0x2::object::ID,
    }

    struct StartSaleDfKey has copy, drop, store {
        venue_id: 0x2::object::ID,
    }
    ...
    public entry fun accept_listing_request(arg0: &0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::marketplace::Marketplace, arg1: &mut Listing, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::marketplace::assert_marketplace_admin_or_member(arg0, arg2);
    ...
    public entry fun add_fee<T0: store + key>(arg0: &0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::marketplace::Marketplace, arg1: &mut Listing, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::marketplace::assert_marketplace_admin_or_member(arg0, arg3);
    ...
    public(friend) fun add_whitelist_internal<T0: store + key>(arg0: &mut Listing, arg1: 0x2::object::ID, arg2: T0) {
        let v0 = WhitelistDfKey{venue_id: arg1};
        0x2::dynamic_field::add<WhitelistDfKey, T0>(&mut arg0.id, v0, arg2);
    }
    ...
    public(friend) fun borrow_whitelist_mut<T0: store + key>(arg0: &mut Listing, arg1: 0x2::object::ID) : &mut T0 {
        let v0 = WhitelistDfKey{venue_id: arg1};
        0x2::dynamic_field::borrow_mut<WhitelistDfKey, T0>(&mut arg0.id, v0)
    }
    ...
    public fun init_listing_with_marketplace(arg0: &0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::marketplace::Marketplace, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_share_object<Listing>(new_with_marketplace(arg0, arg1, arg2, arg3));
    }
    ...
    public fun new_with_marketplace(arg0: &0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::marketplace::Marketplace, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : Listing {
        0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::marketplace::assert_permissionless(arg0);
        ...
        Listing{
            id             : v0,
            version        : 3,
            marketplace_id : 0x1::option::some<0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::typed_id::TypedID<0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::marketplace::Marketplace>>(0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::typed_id::new<0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::marketplace::Marketplace>(arg0)),
            admin          : arg1,
            receiver       : arg2,
            proceeds       : 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::proceeds::empty(arg3),
            venues         : 0x2::object_table::new<0x2::object::ID, 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::venue::Venue>(arg3),
            inventories    : 0x2::object_bag::new(arg3),
            custom_fee     : 0xed6c6fe0732be937f4379bc0b471f0f6bfbe0e8741968009e0f01e6de3d59f32::object_box::empty(arg3),
        }
    }
    ...
    public entry fun remove_start_sale_time(arg0: &mut Listing, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        assert_version_and_upgrade(arg0);
        assert_listing_admin_or_member(arg0, arg2);
        let v0 = StartSaleDfKey{venue_id: arg1};
        0x2::dynamic_field::remove<StartSaleDfKey, u64>(&mut arg0.id, v0);
    }
    ...
    public entry fun set_start_sale_time(arg0: &mut Listing, arg1: u64, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version_and_upgrade(arg0);
        assert_listing_admin_or_member(arg0, arg3);
        let v0 = StartSaleDfKey{venue_id: arg2};
        0x2::dynamic_field::add<StartSaleDfKey, u64>(&mut arg0.id, v0, arg1);
    }

    public entry fun start_sale_with_time(arg0: &mut Listing, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock) {
        assert_version_and_upgrade(arg0);
        let v0 = StartSaleDfKey{venue_id: arg1};
        assert!(0x2::clock::timestamp_ms(arg2) >= *0x2::dynamic_field::borrow<StartSaleDfKey, u64>(&arg0.id, v0), 13);
        0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::venue::set_live(borrow_venue_mut(arg0, arg1), true);
    }
