module 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::marketplace {
    ...
    struct PermissionlessFlag has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public entry fun add_member(arg0: &mut Marketplace, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<MembersDfKey>(&arg0.id, v0)) {
    ...
    public fun assert_marketplace_admin_or_member(arg0: &Marketplace, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun assert_permissionless(arg0: &Marketplace) {
        let v0 = PermissionlessFlag{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<PermissionlessFlag>(&arg0.id, v0), 3);
    }
    ...
    public entry fun make_permissionless(arg0: &mut Marketplace, arg1: &mut 0x2::tx_context::TxContext) {
        assert_marketplace_admin_or_member(arg0, arg1);
        let v0 = PermissionlessFlag{dummy_field: false};
        0x2::dynamic_field::add<PermissionlessFlag, bool>(&mut arg0.id, v0, true);
    }
