module 0x7b2abe961ec8e7f9819ca22260465ee69714572df2bc4bf8debbdffcd47f092f::enlightenment {
    ...
    struct ENLIGHTENMENT_NFT has store, key {
        id: 0x2::object::UID,
    ...
    public entry fun burn_nft(arg0: ENLIGHTENMENT_NFT, arg1: &mut NFTCollection) {
        let ENLIGHTENMENT_NFT {
            id          : v0,
            name        : _,
            description : _,
            image_url   : _,
    ...
    fun create_nft(arg0: &NFTCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : ENLIGHTENMENT_NFT {
        let v0 = 0x1::string::utf8(b"Enlightenment #");
        ...
        ENLIGHTENMENT_NFT{
            ...
            name        : v0,
            description : 0x1::string::utf8(b"Enlightenment is the third major phase of The Order. A culmination of insight earned through dedication, ritual, and the passage of time. It represents a transformation from the veiled to the revealed. A symbolic token of achievement offered only to those who stayed on the path, committed to The Order's philosophy, and sought deeper clarity."),
            image_url   : v2,
            attributes  : v1,
            token_id    : arg1,
        }
    ...
    public fun get_token_id(arg0: &ENLIGHTENMENT_NFT) : u64 {
        arg0.token_id
    }
    ...
    fun init(arg0: ENLIGHTENMENT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ENLIGHTENMENT>(arg0, arg1);
        let v1 = NFTCollection{
            ...
            mint_start        : 1760198400000,
            phase_end         : 1760198400000 + 10800000,
            ...
            phase1_price      : 16000000000,
            phase2_price      : 19000000000,
            phase3_price      : 0,
            public_price      : 23000000000,
        };
        let v2 = 1;
        while (v2 <= 1000) {
        ...
        let v4 = 0x2::display::new<ENLIGHTENMENT_NFT>(&v0, arg1);
        0x2::display::add<ENLIGHTENMENT_NFT>(&mut v4, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<ENLIGHTENMENT_NFT>(&mut v4, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<ENLIGHTENMENT_NFT>(&mut v4, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://walrus.doonies.net/enlightenment/{token_id}.png"));
        0x2::display::add<ENLIGHTENMENT_NFT>(&mut v4, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
        0x2::display::update_version<ENLIGHTENMENT_NFT>(&mut v4);
        let (v5, v6) = 0x2::transfer_policy::new<ENLIGHTENMENT_NFT>(&v0, arg1);
        0x2::transfer::transfer<AdminCap>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<ENLIGHTENMENT_NFT>>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<ENLIGHTENMENT_NFT>>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<ENLIGHTENMENT_NFT>>(v5);
    ...
    public entry fun mint_all(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<ENLIGHTENMENT_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v8, 4);
        let v9 = if (v2) {
            if (arg0.phase1_minted >= 348) {
                0
            } else {
                348 - arg0.phase1_minted
            }
        } else {
            0
        };
        let v10 = if (v4) {
            if (arg0.phase2_minted >= 602) {
                0
            } else {
                602 - arg0.phase2_minted
            }
        } else {
            0
        };
        ...
        if (v2 && v13 > 0) {
            while (v20 < v13) {
                ...
                0x2::kiosk::lock<ENLIGHTENMENT_NFT>(arg5, arg6, arg2, v22);
                let v23 = NFTMinted{
                    nft_id   : 0x2::object::id<ENLIGHTENMENT_NFT>(&v22),
                    token_id : v21,
                    minter   : v0,
                    phase    : 1,
                };
        ...
        if (v4 && v15 > 0) {
            ...
            while (v25 < v15) {
                ...
                0x2::kiosk::lock<ENLIGHTENMENT_NFT>(arg5, arg6, arg2, v27);
                let v28 = NFTMinted{
                    nft_id   : 0x2::object::id<ENLIGHTENMENT_NFT>(&v27),
                    token_id : v26,
                    minter   : v0,
                    phase    : 2,
                };
        ...
        if (v6 && v17 > 0) {
            ...
            while (v30 < v17) {
                ...
                0x2::kiosk::lock<ENLIGHTENMENT_NFT>(arg5, arg6, arg2, v32);
                let v33 = NFTMinted{
                    nft_id   : 0x2::object::id<ENLIGHTENMENT_NFT>(&v32),
                    token_id : v31,
                    minter   : v0,
                    phase    : 3,
                };
    ...
    public entry fun mint_phase1(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<ENLIGHTENMENT_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.phase1_minted + arg7 <= 348, 9);
        assert!(arg0.minted + arg7 <= 1000, 1);
        ...
        while (v4 < arg7) {
            ...
            arg0.minted = arg0.minted + 1;
            arg0.phase1_minted = arg0.phase1_minted + 1;
            0x2::kiosk::lock<ENLIGHTENMENT_NFT>(arg5, arg6, arg2, v6);
            let v7 = NFTMinted{
                nft_id   : 0x2::object::id<ENLIGHTENMENT_NFT>(&v6),
                token_id : v5,
                minter   : v0,
                phase    : 1,
            };
    ...
    public entry fun mint_phase2(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<ENLIGHTENMENT_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        assert!(v1 <= arg0.phase_end, 3);
        ...
        assert!(v2 > 0 && arg7 <= v2, 5);
        assert!(arg0.phase2_minted + arg7 <= 602, 9);
        assert!(arg0.minted + arg7 <= 1000, 1);
    ...
    public entry fun mint_phase3(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<ENLIGHTENMENT_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        assert!(v1 <= arg0.phase_end, 3);
    ...
    public entry fun mint_public(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<ENLIGHTENMENT_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        ...
        while (v3 < arg7) {
            ...
            0x2::kiosk::lock<ENLIGHTENMENT_NFT>(arg5, arg6, arg2, v5);
            let v6 = NFTMinted{
                nft_id   : 0x2::object::id<ENLIGHTENMENT_NFT>(&v5),
                token_id : v4,
                minter   : v0,
                phase    : 100,
            };
    ...
    public entry fun start_minting(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.mint_start = arg2;
        arg1.phase_end = arg2 + 10800000;
        let v0 = PhaseStarted{timestamp: arg2};
        0x2::event::emit<PhaseStarted>(v0);
    }

    public entry fun team_mint_batch(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: &0x2::transfer_policy::TransferPolicy<ENLIGHTENMENT_NFT>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        while (arg5 <= arg6) {
            ...
            0x2::kiosk::lock<ENLIGHTENMENT_NFT>(arg3, arg4, arg2, v1);
            let v2 = NFTMinted{
                nft_id   : 0x2::object::id<ENLIGHTENMENT_NFT>(&v1),
                token_id : v0,
