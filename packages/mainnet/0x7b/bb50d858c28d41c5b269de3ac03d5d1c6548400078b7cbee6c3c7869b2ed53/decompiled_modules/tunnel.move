module 0x7bbb50d858c28d41c5b269de3ac03d5d1c6548400078b7cbee6c3c7869b2ed53::tunnel {
    ...
    public fun add_admin(arg0: &mut AdminRegistry, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(is_admin(arg0, v0), 11);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::vec_set::insert<address>(&mut v0, @0xa40ec206390843153d219411366a48c7e68ef962cbfc30d4598d82b86636b978);
        0x2::vec_set::insert<address>(&mut v0, @0x96d9a120058197fce04afcffa264f2f46747881ba78a91beb38f103c60e315ae);
        0x2::vec_set::insert<address>(&mut v0, @0x95be48aceb3e4bcd697314480b516b1c6a77db1503badf5946c7bb96a63f849b);
    ...
    public fun remove_admin(arg0: &mut AdminRegistry, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(is_admin(arg0, v0), 11);
    ...
    public fun update_creator_config_operator(arg0: &AdminRegistry, arg1: &mut CreatorConfig, arg2: address, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x1::vector::length<u8>(&arg3) == 32, 5);
        assert!(is_admin(arg0, v0) || v0 == arg1.operator, 4);
        arg1.operator = arg2;
        arg1.operator_public_key = arg3;
        let v1 = OperatorUpdated{
            config_id               : 0x2::object::id<CreatorConfig>(arg1),
            old_operator            : arg1.operator,
            new_operator            : arg2,
            new_operator_public_key : arg3,
            updated_by              : v0,
        };
