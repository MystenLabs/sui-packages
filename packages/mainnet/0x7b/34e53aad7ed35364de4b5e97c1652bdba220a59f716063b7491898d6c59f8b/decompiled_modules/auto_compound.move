module 0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::auto_compound {
    ...
    public fun bump_version(arg0: &0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::acl::AclRegistry, arg1: &mut AutoCompoundStrategy, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun new_auto_compound_strategy<T0: store>(arg0: &mut 0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::registry::PositionRegistry, arg1: vector<u8>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : AutoCompoundStrategy {
        let (v0, v1, v2) = decode_auto_compound_strategy_data(arg1);
        assert!(0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::registry::is_some<T0>(arg0, arg2), 0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::errors::error_position_registry_not_exists());
        assert!(0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::registry::owner<T0>(arg0, arg2) == 0x2::tx_context::sender(arg4), 0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::errors::error_invalid_owner());
    ...
    public fun prepare_compound_bot<T0: store>(arg0: &mut 0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::registry::PositionRegistry, arg1: &mut AutoCompoundStrategy, arg2: &0x4376812594277ddf4c5cf03c9e3d6ee78019defab822916e4bdb7b874f621951::enclave::Enclave<AutoCompoundStrategy>, arg3: u64, arg4: AutoCompoundRequest, arg5: &vector<u8>, arg6: &0x2::clock::Clock) : (T0, AutoCompoundReceipt) {
        assert!(0x4376812594277ddf4c5cf03c9e3d6ee78019defab822916e4bdb7b874f621951::enclave::verify_signature<AutoCompoundStrategy, AutoCompoundRequest>(arg2, 0, arg3, arg4, arg5), 0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::errors::error_invalid_signature());
    ...
    fun prepare_compound_internal<T0: store>(arg0: &mut 0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::registry::PositionRegistry, arg1: &mut AutoCompoundStrategy, arg2: u64, arg3: &0x2::clock::Clock) : (T0, AutoCompoundReceipt) {
        if (arg1.last_compound_timestamp > 0x2::clock::timestamp_ms(arg3)) {
            abort 0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::errors::error_last_compound_timestamp_in_future()
        };
        if (arg1.last_compound_timestamp + arg1.compound_interval_ms > 0x2::clock::timestamp_ms(arg3)) {
            abort 0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::errors::error_invalid_compound_interval()
        };
        ...
        (0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::registry::get_position_by_id<T0>(arg0, arg1.position_registry_id), v1)
    }

    public fun prepare_compound_owner<T0: store>(arg0: &mut 0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::registry::PositionRegistry, arg1: &mut AutoCompoundStrategy, arg2: AutoCompoundRequest, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (T0, AutoCompoundReceipt) {
        let AutoCompoundRequest {
            strategy_id           : v0,
            pending_rewards_value : v1,
        } = arg2;
    ...
    public fun repay_receipt(arg0: &mut AutoCompoundStrategy, arg1: AutoCompoundReceipt) {
        ...
        let v2 = v0;
        assert!(0x2::object::uid_as_inner(&arg0.id) == &v2, 0x7b34e53aad7ed35364de4b5e97c1652bdba220a59f716063b7491898d6c59f8b::errors::error_invalid_strategy_id());
    }
