module 0x7bc236288ae2d4c5e43c6961dfb01b7a9b768cde53e9c87ef8689395e604c100::suitraders {
    ...
    fun init(arg0: SUITRADERS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::fixed_price::init_venue<Suitrader, 0x2::sui::SUI>(&mut v19, 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::listing::create_warehouse<Suitrader>(&mut v19, arg1), false, 500, arg1);
    ...
    public entry fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<u8>, arg3: vector<0x1::ascii::String>, arg4: vector<0x1::ascii::String>, arg5: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Suitrader>, arg6: 0x2::object::ID, arg7: &mut 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::listing::Listing, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = Suitrader{
        ...
        0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::listing::add_nft<Suitrader>(arg7, arg6, v0, arg8);
    }
