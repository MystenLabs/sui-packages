module 0x7b1985e98c83b2405534fa0b4f0a8e43a0aff26daafa1f27c67a303b01081a9c::cnsnft1410 {
    struct CNSNFT1410 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1410, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1410>(arg0, arg1);
