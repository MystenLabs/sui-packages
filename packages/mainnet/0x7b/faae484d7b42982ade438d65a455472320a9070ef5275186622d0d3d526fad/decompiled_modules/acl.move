module 0x7bfaae484d7b42982ade438d65a455472320a9070ef5275186622d0d3d526fad::acl {
    ...
    public fun add_role(arg0: &mut ACL, arg1: address, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 < 128, 0x7bfaae484d7b42982ade438d65a455472320a9070ef5275186622d0d3d526fad::error::invalid_argument(0));
        assert!(has_role(arg0, 0x2::tx_context::sender(arg3), 127), 0x7bfaae484d7b42982ade438d65a455472320a9070ef5275186622d0d3d526fad::error::acl_invalid_permission());
        assert!(!has_role(arg0, arg1, arg2), 0x7bfaae484d7b42982ade438d65a455472320a9070ef5275186622d0d3d526fad::error::acl_role_already_exists());
    ...
    public fun remove_role(arg0: &mut ACL, arg1: address, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 < 128, 0x7bfaae484d7b42982ade438d65a455472320a9070ef5275186622d0d3d526fad::error::invalid_argument(0));
        assert!(has_role(arg0, 0x2::tx_context::sender(arg3), 127), 0x7bfaae484d7b42982ade438d65a455472320a9070ef5275186622d0d3d526fad::error::acl_invalid_permission());
        assert!(has_role(arg0, arg1, arg2), 0x7bfaae484d7b42982ade438d65a455472320a9070ef5275186622d0d3d526fad::error::acl_role_not_exists());
        if (0x2::vec_map::contains<address, u128>(&arg0.permissions, &arg1)) {
            let v0 = 0x2::vec_map::get_mut<address, u128>(&mut arg0.permissions, &arg1);
            *v0 = *v0 - (1 << arg2);
        };
