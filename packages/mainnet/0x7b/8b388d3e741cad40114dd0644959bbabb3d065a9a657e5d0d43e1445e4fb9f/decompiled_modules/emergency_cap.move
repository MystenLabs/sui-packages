module 0x7b8b388d3e741cad40114dd0644959bbabb3d065a9a657e5d0d43e1445e4fb9f::emergency_cap {
    ...
    public fun assert_ready(arg0: &EmergencyCap, arg1: &0x2::clock::Clock) {
        ...
        let v2 = if (arg0.created_at > 0 && v1 - arg0.created_at < 60 * 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::one_day_ms()) {
            0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::one_day_ms()
        } else {
            0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::one_week_ms()
        };
