module 0x7b8b388d3e741cad40114dd0644959bbabb3d065a9a657e5d0d43e1445e4fb9f::proposal_quota_registry {
        ...
        while (v2 < 0x1::vector::length<address>(&arg2)) {
            ...
            if (v0) {
                ...
                if (v7) {
                    ...
                    assert!(0x1::vector::length<QuotaEntry>(&arg0.quotas) < 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants::max_quota_entries(), 1);
                    let v19 = QuotaEntry{
                        user : v3,
                        info : v6,
                    };
