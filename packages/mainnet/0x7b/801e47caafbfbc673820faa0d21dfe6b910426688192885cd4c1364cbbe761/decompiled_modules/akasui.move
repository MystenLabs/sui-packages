module 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::akasui {
    ...
    public entry fun buy<T0, T1>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v10, 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::as_u64(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::div(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::mul(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(0x2::coin::value<T0>(&v10)), 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(arg0.platform_fee)), 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(10000))), arg3), arg0.fee_recepient);
    ...
    fun buy_direct<T0, T1>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T1>, arg2: &mut Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = v6;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v8, 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::as_u64(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::div(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::mul(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(0x2::coin::value<T0>(&v8)), 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(arg3)), 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(10000))), arg5), arg0.fee_recepient);
    ...
    public fun estimate_amount_out<T0, T1>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        if (arg1 > 0 && arg2 == 0) {
            let v3 = 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::curves::calculate_token_amount_received(v0.virtual_raise_coin_reserves, v0.virtual_token_reserves, arg1);
            (0, v3 - 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::as_u64(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::div(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::mul(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(v3), 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(arg0.platform_fee)), 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(10000))))
        } else if (arg1 == 0 && arg2 > 0) {
            let v4 = 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::curves::calculate_remove_liquidity_return(v0.virtual_token_reserves, v0.virtual_raise_coin_reserves, arg2);
            (v4 - 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::as_u64(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::div(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::mul(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(v4), 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(arg0.platform_fee)), 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(10000))), 0)
        } else {
            (0, 0)
        }
    }
    ...
    public fun estimate_amount_out_for_buy_direct(arg0: &mut Configuration, arg1: u64, arg2: u64, arg3: u64) : (u64, u64) {
        (0, 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::curves::calculate_token_amount_received(arg2, arg3, arg1))
    }
    ...
    public fun estimate_amount_out_without_fee<T0, T1>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        let v0 = 0x2::dynamic_object_field::borrow<0x1::ascii::String, Pool<T0, T1>>(&arg0.id, generate_pool_name<T0, T1>());
        if (arg1 > 0 && arg2 == 0) {
            (0, 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::curves::calculate_token_amount_received(v0.virtual_raise_coin_reserves, v0.virtual_token_reserves, arg1))
        } else if (arg1 == 0 && arg2 > 0) {
            (0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::curves::calculate_remove_liquidity_return(v0.virtual_token_reserves, v0.virtual_raise_coin_reserves, arg2), 0)
        } else {
            (0, 0)
        }
    }
    ...
    public entry fun sell<T0, T1>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 > 0, 102);
        let v3 = 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_raise_coin_reserves, v2);
        let v4 = 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::as_u64(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::div(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::mul(0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(v3), 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(arg0.platform_fee)), 0x7b801e47caafbfbc673820faa0d21dfe6b910426688192885cd4c1364cbbe761::utils::from_u64(10000)));
        assert!(v3 - v4 >= arg2, 2);
