module 0x7b2333fef1ea51d8c3ad0ee6ae8ea0940ec4421ef4eedb9cd9e5f1cf7bf5a908::reward7743 {
    struct REWARD7743 has drop {
        dummy_field: bool,
    }

    struct TICKET_7743 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7743(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7743>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7743>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7743, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7743>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7743>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7743>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7743>>(v5, 0x2::tx_context::sender(arg1));
    }
