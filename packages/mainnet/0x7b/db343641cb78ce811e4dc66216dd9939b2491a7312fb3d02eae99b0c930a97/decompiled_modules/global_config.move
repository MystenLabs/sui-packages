module 0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::global_config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::ACL,
        package_version: u64,
    ...
    public fun acl(arg0: &GlobalConfig) : &0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::ACL {
        &arg0.acl
    }

    public fun add_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        check_package_version(arg1);
        0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::Member> {
        0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        check_package_version(arg1);
        0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        check_package_version(arg1);
        0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u128) {
        check_package_version(arg1);
        0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public fun check_bank_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::has_role(&arg0.acl, arg1, 0), 1);
    }

    public fun check_fee_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::has_role(&arg0.acl, arg1, 2), 3);
    }

    public fun check_oracle_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::has_role(&arg0.acl, arg1, 3), 6);
    }
    ...
    public fun check_pause_pool_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::has_role(&arg0.acl, arg1, 1), 2);
    }

    public fun check_reward_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::has_role(&arg0.acl, arg1, 4), 7);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GlobalConfig{
            ...
            acl              : 0x7bdb343641cb78ce811e4dc66216dd9939b2491a7312fb3d02eae99b0c930a97::acl::new(arg0),
            package_version  : 1,
