module 0x7b78129725051c38f177b393d6193ec1cf33933fd96889feadb2b1e80bece5b8::reward4728 {
    struct REWARD4728 has drop {
        dummy_field: bool,
    }

    struct TICKET_4728 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4728(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4728>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4728>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4728, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4728>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4728>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4728>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4728>>(v5, 0x2::tx_context::sender(arg1));
    }
