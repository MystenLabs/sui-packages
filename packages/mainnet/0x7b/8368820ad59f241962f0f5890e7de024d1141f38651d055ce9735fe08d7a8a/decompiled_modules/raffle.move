module 0x7b8368820ad59f241962f0f5890e7de024d1141f38651d055ce9735fe08d7a8a::raffle {
    ...
    public entry fun create_raffle<T0>(arg0: vector<u8>, arg1: u64, arg2: vector<address>, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = Raffle<T0>{
    ...
    public entry fun settle_coin_raffle<T0>(arg0: &mut Raffle<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::swap<address>(&mut arg0.participants, 0x7b8368820ad59f241962f0f5890e7de024d1141f38651d055ce9735fe08d7a8a::drand_lib::safe_selection(v2, &v0, 0), v2 - 1);
