module 0x7bb94facd40d7425cbef82c4bbe5af4c5bbdc6aeead9b17c33eb4454d8d02d8c::pinata {
    ...
    fun init(arg0: PINATA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<PINATA>(&mut v2, 10000000000000000000, 0x2::tx_context::sender(arg1), arg1);
