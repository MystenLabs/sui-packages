module 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan {
    ...
    public fun PROTOCOL_CURRENT() : u8 {
        6
    }
    ...
    public(friend) fun idle_only(arg0: u128) : vector<ProtocolAmount> {
        let v0 = 0x1::vector::empty<ProtocolAmount>();
        0x1::vector::push_back<ProtocolAmount>(&mut v0, create(255, arg0));
        v0
    }
