module 0x7b0f420d06844de69a3fb257eefa1b898b86849494fb27bca4a0a1d669d95f94::nft_sale {
    ...
    fun init(arg0: NFT_SALE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://hamsterssui.com/"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Ham"));
        ...
        let v6 = Collection{
            ...
            name         : 0x1::string::utf8(b"Hamsters Sui"),
            description  : 0x1::string::utf8(b"Introducing the new NFT collection on the Sui platform, created by a team of hamster enthusiasts."),
