module 0x7bb9983aba982907fb5dccb35491a116bba3589bf82afc2c6fa46e397ca3786e::reward_nft_w8 {
    struct REWARD_NFT_W8 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = REWARD_NFT{
                ...
                image_url   : 0x1::string::utf8(b"ipfs://QmQgmQkVMLdou62zsghznicL4TdbpvvAuX15UKYEwemQn7"),
    ...
    fun init(arg0: REWARD_NFT_W8, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmQgmQkVMLdou62zsghznicL4TdbpvvAuX15UKYEwemQn7"));
        ...
        let v4 = 0x2::package::claim<REWARD_NFT_W8>(arg0, arg1);
