module 0x7b268447986e73ee61d4a148e4e3caf93e9e360afac486ea9e6b7585549372b8::events {
    struct OrderCreated has copy, drop {
        order_hash: vector<u8>,
        order: 0x7b268447986e73ee61d4a148e4e3caf93e9e360afac486ea9e6b7585549372b8::order::Order,
    }
    ...
    public(friend) fun order_created(arg0: vector<u8>, arg1: 0x7b268447986e73ee61d4a148e4e3caf93e9e360afac486ea9e6b7585549372b8::order::Order) {
        let v0 = OrderCreated{
            order_hash : arg0,
            order      : arg1,
        };
    ...
    public(friend) fun order_filled(arg0: vector<u8>, arg1: 0x7b268447986e73ee61d4a148e4e3caf93e9e360afac486ea9e6b7585549372b8::order::Order) {
        let v0 = OrderFilled{
            order_hash : arg0,
            order      : arg1,
        };
