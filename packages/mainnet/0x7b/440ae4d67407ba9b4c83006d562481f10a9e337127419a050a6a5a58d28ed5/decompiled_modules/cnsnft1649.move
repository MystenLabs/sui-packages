module 0x7b440ae4d67407ba9b4c83006d562481f10a9e337127419a050a6a5a58d28ed5::cnsnft1649 {
    struct CNSNFT1649 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1649, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3877"));
        let v4 = 0x2::package::claim<CNSNFT1649>(arg0, arg1);
