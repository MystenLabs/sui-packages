module 0x7b6ef7c83ec64d7d141cf7147028f3ee50d04c885d063c302547e0b901f4bc14::transceiver_message_data {
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : TransceiverMessageData<vector<u8>> {
        ...
        TransceiverMessageData<vector<u8>>{
            ...
            ntt_manager_payload           : 0x7b6ef7c83ec64d7d141cf7147028f3ee50d04c885d063c302547e0b901f4bc14::ntt_manager_message::take_bytes(arg0),
        }
    }
    ...
    public fun to_bytes(arg0: TransceiverMessageData<vector<u8>>) : vector<u8> {
        ...
        let v4 = 0x7b6ef7c83ec64d7d141cf7147028f3ee50d04c885d063c302547e0b901f4bc14::ntt_manager_message::to_bytes(v2);
        ...
        0x1::vector::append<u8>(&mut v3, 0x7b6ef7c83ec64d7d141cf7147028f3ee50d04c885d063c302547e0b901f4bc14::ntt_manager_message::to_bytes(v2));
        v3
    }
