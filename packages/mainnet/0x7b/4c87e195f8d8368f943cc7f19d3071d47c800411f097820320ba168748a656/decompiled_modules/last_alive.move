module 0x7b4c87e195f8d8368f943cc7f19d3071d47c800411f097820320ba168748a656::last_alive {
    ...
    struct RewardsPool has key {
        ...
        direct_coin_registry: 0x2::table::Table<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>,
        round_coin_ids: 0x2::table::Table<u64, vector<0x2::object::ID>>,
    ...
    struct GenericNFTWrapper<T0: store + key> has store, key {
        id: 0x2::object::UID,
        game_id: 0x2::object::ID,
        nft_id: 0x2::object::ID,
        content: T0,
    ...
    struct CoinRewardInfo has copy, drop, store {
        coin_id: 0x2::object::ID,
        coin_type: 0x1::string::String,
        amount: u64,
        recipient_nft_id: 0x2::object::ID,
        claimed: bool,
    }

    struct TokenRewardRegisteredEvent has copy, drop {
        round: u64,
        coin_id: 0x2::object::ID,
    ...
    struct CoinAssignedEvent has copy, drop {
        round: u64,
        coin_id: 0x2::object::ID,
        winner_nft_id: 0x2::object::ID,
        assigned_by: address,
    ...
    struct ClaimableCoinsEvent has copy, drop {
        nft_id: 0x2::object::ID,
        round: u64,
        claimable_coins: vector<0x2::object::ID>,
    }

    struct DirectCoinClaimEvent has copy, drop {
        nft_id: 0x2::object::ID,
        round: u64,
        coin_id: 0x2::object::ID,
        claimed_by: address,
    ...
    public entry fun add_external_nft_reward<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = NFTReward{
            reward_id   : v1,
            reward_type : 0x1::string::utf8(b"EXTERNAL_NFT"),
        ...
        0x1::vector::push_back<NFTReward>(0x2::table::borrow_mut<u64, vector<NFTReward>>(&mut arg1.pending_nft_rewards, v0), v2);
        let v3 = GenericNFTWrapper<T0>{
        ...
        0x1::vector::push_back<0x2::object::ID>(0x2::table::borrow_mut<u64, vector<0x2::object::ID>>(&mut arg1.pending_nft_wrappers, v0), 0x2::object::uid_to_inner(&v3.id));
        0x2::transfer::share_object<GenericNFTWrapper<T0>>(v3);
    }
    ...
    public entry fun assign_coin_to_winner(arg0: &mut RewardsPool, arg1: &TreasuryCapability, arg2: u64, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == arg1.owner, 4);
        assert!(arg1.rewards_pool_id == 0x2::object::uid_to_inner(&arg0.id), 4);
        assert!(0x2::table::contains<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(&arg0.direct_coin_registry, arg2), 19);
        let v0 = 0x2::table::borrow_mut<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(&mut arg0.direct_coin_registry, arg2);
        assert!(0x2::table::contains<0x2::object::ID, CoinRewardInfo>(v0, arg3), 19);
        let v1 = 0x2::table::borrow_mut<0x2::object::ID, CoinRewardInfo>(v0, arg3);
        assert!(!v1.claimed, 20);
        v1.recipient_nft_id = arg4;
        let v2 = CoinAssignedEvent{
            round         : arg2,
            coin_id       : arg3,
            winner_nft_id : arg4,
            assigned_by   : 0x2::tx_context::sender(arg5),
        };
        0x2::event::emit<CoinAssignedEvent>(v2);
    }
    ...
    public entry fun claim_and_discover_all_rewards(arg0: &mut RewardsPool, arg1: &GameState, arg2: &mut NFT, arg3: &mut 0x2::tx_context::TxContext) {
        claim_sui_rewards(arg0, arg1, arg2, arg3);
        discover_claimable_wrappers(arg0, arg2, arg3);
        discover_claimable_coins(arg0, arg2, arg3);
    }
    ...
    public entry fun claim_direct_coin_reward<T0: store + key>(arg0: &mut RewardsPool, arg1: &TreasuryCapability, arg2: &NFT, arg3: 0x2::object::ID, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::uid_to_inner(&arg2.id);
        let v1 = arg2.game_round;
        assert!(0x2::table::contains<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(&arg0.direct_coin_registry, v1), 19);
        let v2 = 0x2::table::borrow_mut<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(&mut arg0.direct_coin_registry, v1);
        assert!(0x2::table::contains<0x2::object::ID, CoinRewardInfo>(v2, arg3), 19);
        let v3 = 0x2::table::borrow_mut<0x2::object::ID, CoinRewardInfo>(v2, arg3);
        assert!(v3.recipient_nft_id == v0, 4);
        assert!(!v3.claimed, 20);
        assert!(0x2::object::id<0x2::coin::Coin<T0>>(&arg4) == arg3, 19);
        assert!(arg1.rewards_pool_id == 0x2::object::uid_to_inner(&arg0.id), 4);
        assert!(0x2::tx_context::sender(arg5) == arg1.owner, 4);
        v3.claimed = true;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg4, 0x2::tx_context::sender(arg5));
        let v4 = DirectCoinClaimEvent{
            nft_id     : v0,
            round      : v1,
            coin_id    : arg3,
            claimed_by : 0x2::tx_context::sender(arg5),
            amount     : v3.amount,
            token_type : v3.coin_type,
        };
        0x2::event::emit<DirectCoinClaimEvent>(v4);
    }

    public entry fun claim_direct_rewards(arg0: &mut RewardsPool, arg1: &NFT, arg2: &mut 0x2::tx_context::TxContext) {
        discover_claimable_coins(arg0, arg1, arg2);
    }
    ...
    public entry fun claim_generic_nft_wrapper<T0: store + key>(arg0: GenericNFTWrapper<T0>, arg1: &NFT, arg2: &GameState, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(is_round_ended(arg2, arg1.game_round), 11);
        assert!(arg0.game_id == 0x2::object::uid_to_inner(&arg2.id), 4);
        ...
        0x2::transfer::public_transfer<T0>(v4, v5);
        let v6 = NFTClaimEvent{
            nft_id         : 0x2::object::uid_to_inner(&arg1.id),
            wrapped_nft_id : 0x2::object::id<T0>(&v4),
            nft_type       : 0x1::string::utf8(b"EXTERNAL_NFT"),
            claimer        : v5,
        };
        0x2::event::emit<NFTClaimEvent>(v6);
        0x2::object::delete(v0);
    }
    ...
    public entry fun discover_claimable_coins(arg0: &RewardsPool, arg1: &NFT, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == 0x2::tx_context::sender(arg2), 0);
        let v0 = ClaimableCoinsEvent{
            nft_id          : 0x2::object::uid_to_inner(&arg1.id),
            round           : arg1.game_round,
            claimable_coins : get_claimable_direct_coins(arg0, arg1),
        };
        0x2::event::emit<ClaimableCoinsEvent>(v0);
    }
    ...
    public entry fun finish_game(arg0: &mut GameState, arg1: &mut RewardsPool, arg2: &0x2::clock::Clock, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v16 = 0x1::vector::empty<NFTReward>();
        if (0x2::table::contains<u64, vector<NFTReward>>(&arg1.pending_nft_rewards, v0)) {
            let v17 = 0x2::table::borrow_mut<u64, vector<NFTReward>>(&mut arg1.pending_nft_rewards, v0);
            if (!0x1::vector::is_empty<NFTReward>(v17)) {
                let v18 = 0x2::table::borrow_mut<u64, 0x2::table::Table<0x2::object::ID, vector<NFTReward>>>(&mut arg1.nft_rewards, v0);
                let v19 = 0x2::table::borrow_mut<u64, 0x2::table::Table<0x2::object::ID, vector<0x2::object::ID>>>(&mut arg1.nft_wrapper_registry, v0);
                if (!0x2::table::contains<0x2::object::ID, vector<0x2::object::ID>>(v19, v1)) {
                    0x2::table::add<0x2::object::ID, vector<0x2::object::ID>>(v19, v1, 0x1::vector::empty<0x2::object::ID>());
                };
                while (!0x1::vector::is_empty<NFTReward>(v17)) {
                    0x1::vector::push_back<NFTReward>(&mut v16, 0x1::vector::pop_back<NFTReward>(v17));
                };
                if (!0x1::vector::is_empty<NFTReward>(&v16)) {
                    0x2::table::add<0x2::object::ID, vector<NFTReward>>(v18, v1, v16);
                };
            };
        };
        let v20 = WinnerRecord{
            nft_id      : v1,
        ...
        0x1::vector::push_back<WinnerRecord>(0x2::table::borrow_mut<u64, vector<WinnerRecord>>(&mut arg0.winners, v0), v20);
        let v21 = GameEndEvent{
            winner_id     : v1,
            reward_amount : v12,
            final_day     : arg0.current_day,
            timestamp     : 0x2::clock::timestamp_ms(arg2),
        };
        0x2::event::emit<GameEndEvent>(v21);
        arg0.game_ended = true;
        if (0x2::table::contains<u64, vector<0x2::object::ID>>(&arg1.pending_nft_wrappers, v0)) {
            let v22 = 0x2::table::borrow<u64, vector<0x2::object::ID>>(&arg1.pending_nft_wrappers, v0);
            ...
            let v24 = 0x2::table::borrow_mut<0x2::object::ID, vector<0x2::object::ID>>(v23, v1);
            let v25 = 0;
            while (v25 < 0x1::vector::length<0x2::object::ID>(v22)) {
                let v26 = *0x1::vector::borrow<0x2::object::ID>(v22, v25);
                0x1::vector::push_back<0x2::object::ID>(v24, v26);
                let v27 = WrapperAssignmentEvent{
                    wrapper_id  : v26,
                    nft_id      : v1,
                    timestamp   : 0x2::clock::timestamp_ms(arg2),
                    assigned_by : 0x2::tx_context::sender(arg4),
                };
                0x2::event::emit<WrapperAssignmentEvent>(v27);
                v25 = v25 + 1;
            };
        };
        if (0x2::table::contains<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(&arg1.direct_coin_registry, v0)) {
            let v28 = 0x2::table::borrow_mut<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(&mut arg1.direct_coin_registry, v0);
            if (0x2::table::contains<u64, vector<0x2::object::ID>>(&arg1.round_coin_ids, v0)) {
                let v29 = 0x2::table::borrow<u64, vector<0x2::object::ID>>(&arg1.round_coin_ids, v0);
                let v30 = 0;
                while (v30 < 0x1::vector::length<0x2::object::ID>(v29)) {
                    let v31 = *0x1::vector::borrow<0x2::object::ID>(v29, v30);
                    if (0x2::table::contains<0x2::object::ID, CoinRewardInfo>(v28, v31)) {
                        let v32 = 0x2::table::borrow_mut<0x2::object::ID, CoinRewardInfo>(v28, v31);
                        if (v32.recipient_nft_id == 0x2::object::id_from_address(@0x0)) {
                            v32.recipient_nft_id = v1;
                            let v33 = CoinAssignedEvent{
                                round         : v0,
                                coin_id       : v31,
                                winner_nft_id : v1,
                                assigned_by   : 0x2::tx_context::sender(arg4),
                            };
                            0x2::event::emit<CoinAssignedEvent>(v33);
                        };
                    };
                    v30 = v30 + 1;
                };
    ...
    public fun get_claimable_direct_coins(arg0: &RewardsPool, arg1: &NFT) : vector<0x2::object::ID> {
        0x2::object::uid_to_inner(&arg1.id);
    ...
    public fun get_claimable_wrappers(arg0: &RewardsPool, arg1: 0x2::object::ID, arg2: u64) : (vector<0x2::object::ID>, vector<0x2::object::ID>) {
        ...
        (v0, 0x1::vector::empty<0x2::object::ID>())
    }

    fun get_coin_type_name<T0>() : 0x1::string::String {
        0x1::string::utf8(b"TOKEN")
    }
    ...
    fun init(arg0: LAST_ALIVE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = RewardsPool{
            ...
            direct_coin_registry : 0x2::table::new<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(arg1),
            round_coin_ids       : 0x2::table::new<u64, vector<0x2::object::ID>>(arg1),
            treasury_cap         : 0x2::object::id_from_address(@0x0),
        };
        ...
        0x2::table::add<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(&mut v8.direct_coin_registry, 0, 0x2::table::new<0x2::object::ID, CoinRewardInfo>(arg1));
        0x2::table::add<u64, vector<0x2::object::ID>>(&mut v8.round_coin_ids, 0, 0x1::vector::empty<0x2::object::ID>());
        let v9 = 0x2::object::uid_to_inner(&v8.id);
        let v10 = TreasuryCapability{
            id              : 0x2::object::new(arg1),
            rewards_pool_id : v9,
            owner           : 0x2::tx_context::sender(arg1),
        };
        v8.treasury_cap = 0x2::object::uid_to_inner(&v10.id);
        0x2::transfer::share_object<GameState>(v7);
        0x2::transfer::share_object<RewardsPool>(v8);
        0x2::transfer::transfer<TreasuryCapability>(v10, 0x2::tx_context::sender(arg1));
        let v11 = GameCounter{
            id               : 0x2::object::new(arg1),
            counter          : 0,
            game_state_ids   : 0x1::vector::singleton<0x2::object::ID>(0x2::object::uid_to_inner(&v7.id)),
            rewards_pool_ids : 0x1::vector::singleton<0x2::object::ID>(v9),
            start_rounds     : 0x1::vector::singleton<u64>(0),
        };
        let v12 = WalletMintLimit{
            id                  : 0x2::object::new(arg1),
            wallet_mints        : 0x2::table::new<u64, 0x2::table::Table<address, u64>>(arg1),
            max_mints_per_round : 0x2::table::new<u64, u64>(arg1),
            owner               : 0x2::tx_context::sender(arg1),
        };
        0x2::transfer::share_object<GameCounter>(v11);
        0x2::transfer::share_object<WalletMintLimit>(v12);
    }
    ...
    public entry fun launch_new_game(arg0: &mut GameCounter, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(&mut v3.direct_coin_registry, v0, 0x2::table::new<0x2::object::ID, CoinRewardInfo>(arg1));
        0x2::table::add<u64, vector<0x2::object::ID>>(&mut v3.round_coin_ids, v0, 0x1::vector::empty<0x2::object::ID>());
        let v4 = 0x2::object::uid_to_inner(&v3.id);
        let v5 = TreasuryCapability{
            id              : 0x2::object::new(arg1),
            rewards_pool_id : v4,
            owner           : 0x2::tx_context::sender(arg1),
        };
        v3.treasury_cap = 0x2::object::uid_to_inner(&v5.id);
        0x1::vector::push_back<0x2::object::ID>(&mut arg0.game_state_ids, 0x2::object::uid_to_inner(&v2.id));
        0x1::vector::push_back<0x2::object::ID>(&mut arg0.rewards_pool_ids, v4);
        ...
        0x2::transfer::transfer<TreasuryCapability>(v5, 0x2::tx_context::sender(arg1));
    }
    ...
    fun mint_nfts(arg0: &mut GameState, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < arg1) {
            ...
            0x2::table::add<0x2::object::ID, NFTRegistry>(&mut arg0.nft_registry, v4, v5);
            0x1::vector::push_back<0x2::object::ID>(&mut arg0.alive_nft_ids, v4);
    ...
    public entry fun register_token_reward<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: &TreasuryCapability, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == arg0.owner, 4);
        assert!(arg2.rewards_pool_id == 0x2::object::uid_to_inner(&arg1.id), 4);
        assert!(0x2::coin::value<T0>(&arg3) >= arg4, 0);
        let v0 = arg0.current_round;
        let v1 = 0x2::coin::split<T0>(&mut arg3, arg4, arg5);
        let v2 = 0x2::object::id<0x2::coin::Coin<T0>>(&v1);
        let v3 = get_coin_type_name<T0>();
        let v4 = CoinRewardInfo{
            coin_id          : v2,
            coin_type        : v3,
            amount           : arg4,
            recipient_nft_id : 0x2::object::id_from_address(@0x0),
            claimed          : false,
        };
        if (!0x2::table::contains<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(&arg1.direct_coin_registry, v0)) {
            0x2::table::add<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(&mut arg1.direct_coin_registry, v0, 0x2::table::new<0x2::object::ID, CoinRewardInfo>(arg5));
        };
        0x2::table::add<0x2::object::ID, CoinRewardInfo>(0x2::table::borrow_mut<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(&mut arg1.direct_coin_registry, v0), v2, v4);
        if (!0x2::table::contains<u64, vector<0x2::object::ID>>(&arg1.round_coin_ids, v0)) {
            0x2::table::add<u64, vector<0x2::object::ID>>(&mut arg1.round_coin_ids, v0, 0x1::vector::empty<0x2::object::ID>());
        };
        0x1::vector::push_back<0x2::object::ID>(0x2::table::borrow_mut<u64, vector<0x2::object::ID>>(&mut arg1.round_coin_ids, v0), v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v1, arg2.owner);
        if (0x2::coin::value<T0>(&arg3) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg3, 0x2::tx_context::sender(arg5));
        } else {
            0x2::coin::destroy_zero<T0>(arg3);
        };
        let v5 = TokenRewardRegisteredEvent{
            round         : v0,
            coin_id       : v2,
            token_type    : v3,
            amount        : arg4,
        ...
        0x2::event::emit<TokenRewardRegisteredEvent>(v5);
    }
    ...
    public entry fun reset_game(arg0: &mut GameState, arg1: &mut RewardsPool, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<u64, 0x2::table::Table<0x1::string::String, vector<0x2::object::ID>>>(&mut arg1.nft_objects, v1, 0x2::table::new<0x1::string::String, vector<0x2::object::ID>>(arg2));
        ...
        0x2::table::add<u64, 0x2::table::Table<0x2::object::ID, CoinRewardInfo>>(&mut arg1.direct_coin_registry, v1, 0x2::table::new<0x2::object::ID, CoinRewardInfo>(arg2));
        0x2::table::add<u64, vector<0x2::object::ID>>(&mut arg1.round_coin_ids, v1, 0x1::vector::empty<0x2::object::ID>());
        arg0.total_supply = 0;
        arg0.total_alive = 0;
        arg0.last_update = 0;
        arg0.current_day = 0;
    ...
    public entry fun set_nft_claimable_by(arg0: &GameState, arg1: &mut RewardsPool, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.owner, 4);
        let v0 = 0;
        if (!0x2::table::contains<u64, 0x2::table::Table<0x2::object::ID, vector<0x2::object::ID>>>(&arg1.nft_wrapper_registry, v0)) {
            0x2::table::add<u64, 0x2::table::Table<0x2::object::ID, vector<0x2::object::ID>>>(&mut arg1.nft_wrapper_registry, v0, 0x2::table::new<0x2::object::ID, vector<0x2::object::ID>>(arg4));
        ...
        let v2 = WrapperAssignmentEvent{
            wrapper_id  : arg2,
            nft_id      : arg3,
            timestamp   : 0,
            assigned_by : 0x2::tx_context::sender(arg4),
        };
        0x2::event::emit<WrapperAssignmentEvent>(v2);
    }
