module 0x7b4163d17ce18b386ee50929ba48fa0a2ecb60304df4b07e26835aa18617cda2::agent_session {
    ...
    fun assert_spend_allowed(arg0: &AgentSession, arg1: u64) {
        assert!(arg0.spent + arg1 <= arg0.spend_cap, 4);
        assert!(arg0.lifetime_spent + arg1 <= arg0.lifetime_cap, 13);
    }
    ...
    public fun buy_with_session<T0>(arg0: &mut AgentSession, arg1: &mut 0x7b4163d17ce18b386ee50929ba48fa0a2ecb60304df4b07e26835aa18617cda2::bonding_curve::Curve<T0>, arg2: u64, arg3: u64, arg4: &0x7b4163d17ce18b386ee50929ba48fa0a2ecb60304df4b07e26835aa18617cda2::bonding_curve::PriceConfig, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_session_version(arg0);
        assert_can_trade(arg0, arg5, arg6);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.escrow) >= arg2, 5);
        assert_spend_allowed(arg0, arg2);
        let (v0, v1) = 0x7b4163d17ce18b386ee50929ba48fa0a2ecb60304df4b07e26835aa18617cda2::bonding_curve::buy<T0>(arg1, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.escrow, arg2), arg6), arg3, 0x1::option::none<address>(), arg4, arg5, arg6);
        let v2 = v1;
    ...
    public fun open_and_share_attested(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: &0x7b4163d17ce18b386ee50929ba48fa0a2ecb60304df4b07e26835aa18617cda2::enclave_registry::EnclaveRegistry, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x7b4163d17ce18b386ee50929ba48fa0a2ecb60304df4b07e26835aa18617cda2::enclave_registry::is_registered(arg5, arg1), 12);
        ...
        let v1 = SessionAttested{
            ...
            registry_id     : 0x2::object::id<0x7b4163d17ce18b386ee50929ba48fa0a2ecb60304df4b07e26835aa18617cda2::enclave_registry::EnclaveRegistry>(arg5),
        };
    ...
    public fun sell_with_session<T0>(arg0: &mut AgentSession, arg1: &mut 0x7b4163d17ce18b386ee50929ba48fa0a2ecb60304df4b07e26835aa18617cda2::bonding_curve::Curve<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_session_version(arg0);
        assert_can_trade(arg0, arg4, arg5);
        let v0 = 0x7b4163d17ce18b386ee50929ba48fa0a2ecb60304df4b07e26835aa18617cda2::bonding_curve::sell<T0>(arg1, 0x2::coin::split<T0>(0x2::dynamic_object_field::borrow_mut<0x1::type_name::TypeName, 0x2::coin::Coin<T0>>(&mut arg0.id, 0x1::type_name::with_defining_ids<T0>()), arg2, arg5), arg3, 0x1::option::none<address>(), arg5);
    ...
    public fun settle_buy<T0>(arg0: &mut AgentSession, arg1: TradeTicket, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<SessionBuyV2>(v7);
    }
    ...
    public fun top_up_session(arg0: &mut AgentSession, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        assert_session_version(arg0);
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 6);
        assert!(!is_closed(arg0), 17);
