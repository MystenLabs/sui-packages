module 0x7b28fde8817a8abcc3a6958c5605900a4133eb67a46e65dc83ad5351da78cfa3::acl {
    ...
    public(friend) fun execute(arg0: &mut ACL, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        if (v1.proposal_type == 0) {
            assert!(v2 >= v1.executable_after, 103);
        };
        assert!(0x2::vec_set::size<address>(&v1.supporters) >= 0x2::vec_set::size<address>(&arg0.admins) / 2 + 1, 102);
