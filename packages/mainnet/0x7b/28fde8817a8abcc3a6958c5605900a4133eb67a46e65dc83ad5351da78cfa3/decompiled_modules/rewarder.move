module 0x7b28fde8817a8abcc3a6958c5605900a4133eb67a46e65dc83ad5351da78cfa3::rewarder {
    ...
    public fun deposit_reward<T0>(arg0: &0x7b28fde8817a8abcc3a6958c5605900a4133eb67a46e65dc83ad5351da78cfa3::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) : u64 {
    ...
    public fun emergent_withdraw<T0>(arg0: &0x7b28fde8817a8abcc3a6958c5605900a4133eb67a46e65dc83ad5351da78cfa3::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x7b28fde8817a8abcc3a6958c5605900a4133eb67a46e65dc83ad5351da78cfa3::config::checked_package_version(arg0);
        0x7b28fde8817a8abcc3a6958c5605900a4133eb67a46e65dc83ad5351da78cfa3::config::check_reward_role(arg0, 0x2::tx_context::sender(arg3));
        let v0 = withdraw_reward<T0>(arg1, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg3), 0x7b28fde8817a8abcc3a6958c5605900a4133eb67a46e65dc83ad5351da78cfa3::config::get_reward_receiver(arg0));
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: u128, arg2: u64) {
        ...
        let v1 = arg0.accumulated_ms + arg2 % 1000;
        let v2 = arg2 / 1000 + v1 / 1000;
        arg0.last_updated_time = v2;
        arg0.accumulated_ms = v1 % 1000;
        assert!(v0 <= v2, 503);
        if (arg1 == 0 || v2 == v0) {
            return
        };
        let v3 = v2 - v0;
        let v4 = 0;
        while (v4 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            let v5 = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v4).emissions_per_second;
            if (v5 == 0) {
                v4 = v4 + 1;
                continue
            };
            0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v4).growth_global = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v4).growth_global + 0x5f7a7744be085d6f92587f4a0aa5d6ff85a6c804196c5a1f1bb34b0cb2db6c54::full_math_u128::mul_div_floor((v3 as u128), v5, arg1);
            v4 = v4 + 1;
        };
        let v6 = 18446744073709551616000000;
        arg0.points_released = arg0.points_released + (v3 as u128) * v6;
        arg0.points_growth_global = arg0.points_growth_global + 0x5f7a7744be085d6f92587f4a0aa5d6ff85a6c804196c5a1f1bb34b0cb2db6c54::full_math_u128::mul_div_floor((v3 as u128), v6, arg1);
    }
    ...
    public(friend) fun update_emission<T0>(arg0: &RewarderGlobalVault, arg1: &mut RewarderManager, arg2: u128, arg3: u128, arg4: u64) {
        ...
        if (arg3 > 0 && arg3 > v0.emissions_per_second) {
            ...
            assert!((0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg0.balances, v1)) as u128) << 64 >= 86400 * arg3, 504);
        };
