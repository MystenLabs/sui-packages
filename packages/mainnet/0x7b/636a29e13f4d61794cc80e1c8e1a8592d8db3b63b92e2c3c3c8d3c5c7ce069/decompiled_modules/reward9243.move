module 0x7b636a29e13f4d61794cc80e1c8e1a8592d8db3b63b92e2c3c3c8d3c5c7ce069::reward9243 {
    struct REWARD9243 has drop {
        dummy_field: bool,
    }

    struct TICKET_9243 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9243(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9243>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9243>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9243, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9243>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9243>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9243>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9243>>(v5, 0x2::tx_context::sender(arg1));
    }
