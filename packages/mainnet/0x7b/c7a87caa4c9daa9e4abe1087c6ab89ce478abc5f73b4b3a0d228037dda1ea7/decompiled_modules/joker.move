module 0x7bc7a87caa4c9daa9e4abe1087c6ab89ce478abc5f73b4b3a0d228037dda1ea7::joker {
    ...
    fun init(arg0: JOKER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<JOKER>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"JOKER   ")))), trim_right(b"Joker Movie                     "), trim_right(b"Joker centers around the iconic arch-nemesis and is an original, standalone story not seen before on the big screen.                                                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
