module 0x7bff02f1bc4ff1b2f5a665a4ca4142e1eae98ab22dcae440f089b84cfb6e9be1::x {
    struct V has key {
        id: 0x2::object::UID,
        a: address,
    ...
    public entry fun wp<T0>(arg0: &mut V, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
