module 0x7b6de2dfe6bb80d78027e4d1209064e717c320f817190c79205f044f53a05be7::reward6304 {
    struct REWARD6304 has drop {
        dummy_field: bool,
    }

    struct TICKET_6304 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6304(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6304>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6304>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6304, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6304>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6304>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6304>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6304>>(v5, 0x2::tx_context::sender(arg1));
    }
