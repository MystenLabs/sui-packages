module 0x7baff0cb9e4cd7b759b80be700a0a2473b89d012b8d82c0d9b67976b37bb7f17::t3ai {
    ...
    fun init(arg0: T3AI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/SyMH8DuwqqkSY890?width=150&height=150&fit=crop&quality=95&format=auto                                                                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<T3AI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"T3AI    ")))), trim_right(b"TrustInWeb3                     "), trim_right(b" T3AI is the utility token for the T3 Agent.                                                                                                                                                                                                                                                                                    "), v2, arg1);
        let v5 = v3;
