module 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::farm {
    ...
    public fun borrow_mut_uid<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: &0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::owner::OwnerCap<FarmWitness>) : &mut 0x2::object::UID {
        0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::owner::assert_ownership<FarmWitness>(arg1, 0x2::object::id<Farm<T0, T1>>(arg0));
        &mut arg0.id
    }

    fun calculate_accrued_rewards_per_share(arg0: u64, arg1: u256, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : u256 {
        arg1 + 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::math256::min((arg3 as u256), (arg0 as u256) * (arg5 as u256)) * (arg4 as u256) / (arg2 as u256)
    }
    ...
    public fun destroy_zero_farm<T0, T1>(arg0: Farm<T0, T1>, arg1: &0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::owner::OwnerCap<FarmWitness>) {
        0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::owner::assert_ownership<FarmWitness>(arg1, 0x2::object::id<Farm<T0, T1>>(&arg0));
        let Farm {
            id                        : v0,
    ...
    public fun new_cap(arg0: &mut 0x2::tx_context::TxContext) : 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::owner::OwnerCap<FarmWitness> {
        let v0 = FarmWitness{dummy_field: false};
        0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::owner::new<FarmWitness>(v0, 0x1::vector::empty<0x2::object::ID>(), arg0)
    }

    public fun new_farm<T0, T1>(arg0: &mut 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::owner::OwnerCap<FarmWitness>, arg1: &0x2::coin::CoinMetadata<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : Farm<T0, T1> {
        assert!(arg4 > clock_timestamp_s(arg2), 3);
        let v0 = 0x2::object::id<0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::owner::OwnerCap<FarmWitness>>(arg0);
        let v1 = Farm<T0, T1>{
        ...
        0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::owner::add<FarmWitness>(arg0, v3, v2);
    ...
    public fun stake<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: &mut Account<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (arg1.amount != 0) {
            let v2 = 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::math64::min(calculate_pending_rewards<T0, T1>(arg1, arg0.stake_coin_decimal_factor, arg0.accrued_rewards_per_share), 0x2::balance::value<T1>(&arg0.balance_reward_coin));
            if (v2 != 0) {
    ...
    public fun unstake<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: &mut Account<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        if (v0 != 0) {
            0x2::coin::join<T1>(&mut v2, 0x2::coin::take<T1>(&mut arg0.balance_reward_coin, 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::math64::min(v0, 0x2::balance::value<T1>(&arg0.balance_reward_coin)), arg4));
        };
        arg1.reward_debt = calculate_reward_debt(arg1.amount, arg0.stake_coin_decimal_factor, arg0.accrued_rewards_per_share);
    ...
    public fun update_rewards_per_second<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: &0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::owner::OwnerCap<FarmWitness>, arg2: u64, arg3: &0x2::clock::Clock) {
        0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::owner::assert_ownership<FarmWitness>(arg1, 0x2::object::id<Farm<T0, T1>>(arg0));
        update<T0, T1>(arg0, clock_timestamp_s(arg3));
