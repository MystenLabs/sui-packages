module 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::dao_treasury {
    ...
    public fun flash_loan<T0: drop, T1>(arg0: &mut DaoTreasury<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, FlashLoan<T0, T1>) {
        ...
        let v2 = FlashLoan<T0, T1>{
            ...
            fee    : 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::fixed_point_roll::mul_up(arg1, 5000000),
            type   : v0,
        };
    ...
    public fun transfer<T0: drop, T1, T2>(arg0: &mut DaoTreasury<T0>, arg1: &0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::dao_admin::DaoAdmin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
    ...
    public fun transfer_linear_vesting_wallet<T0: drop, T1, T2>(arg0: &mut DaoTreasury<T0>, arg1: &0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::dao_admin::DaoAdmin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::linear_vesting_wallet::Wallet<T1> {
        let v0 = 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::linear_vesting_wallet::new<T1>(0x2::coin::take<T1>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.coins, 0x1::type_name::get<T2>()), arg3, arg6), arg2, arg4, arg5, arg6);
        let v1 = TransferLinearWallet<T0, T1>{
            value     : arg3,
            sender    : 0x2::tx_context::sender(arg6),
            wallet_id : 0x2::object::id<0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::linear_vesting_wallet::Wallet<T1>>(&v0),
            start     : arg4,
            duration  : arg5,
        };
