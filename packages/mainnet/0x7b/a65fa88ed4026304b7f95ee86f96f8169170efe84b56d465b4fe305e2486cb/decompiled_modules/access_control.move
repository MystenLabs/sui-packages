module 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::access_control {
    ...
    public fun new(arg0: &mut 0x2::tx_context::TxContext) : (AccessControl, Admin) {
        ...
        let v2 = &mut v0;
        new_role_singleton_impl(v2, b"SUPER_ADMIN_ROLE", 0x2::object::id_address<Admin>(&v1));
        (v0, v1)
    }
    ...
    public fun has_role(arg0: &Admin, arg1: &AccessControl, arg2: vector<u8>) : bool {
        assert!(0x2::object::id_address<AccessControl>(arg1) == arg0.access_control, 0);
        has_role_(0x2::object::id_address<Admin>(arg0), arg1, arg2)
    }
    ...
    public fun has_role_(arg0: address, arg1: &AccessControl, arg2: vector<u8>) : bool {
        ...
        0x2::vec_set::contains<address>(0x2::vec_map::get<vector<u8>, 0x2::vec_set::VecSet<address>>(&arg1.roles, &arg2), &arg0)
    }

    public fun new_admin(arg0: &AccessControl, arg1: &mut 0x2::tx_context::TxContext) : Admin {
        Admin{
            id             : 0x2::object::new(arg1),
            access_control : 0x2::object::id_address<AccessControl>(arg0),
        }
    }
    ...
    public fun renounce(arg0: &Admin, arg1: &mut AccessControl, arg2: vector<u8>) {
        assert!(0x2::object::id_address<AccessControl>(arg1) == arg0.access_control, 0);
        let v0 = 0x2::object::id_address<Admin>(arg0);
