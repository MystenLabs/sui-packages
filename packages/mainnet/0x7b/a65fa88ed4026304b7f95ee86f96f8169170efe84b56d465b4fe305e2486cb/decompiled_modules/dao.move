module 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::dao {
    ...
    public fun new<T0: drop, T1: drop>(arg0: T0, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (Dao<T0>, 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::dao_treasury::DaoTreasury<T0>) {
    ...
    fun new_impl<T0: drop, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (Dao<T0>, 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::dao_treasury::DaoTreasury<T0>) {
        assert!(1000000000 >= arg2 && arg2 != 0, 1);
        let v0 = 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::dao_admin::new<T0>(arg5);
        let v1 = 0x2::object::id<0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::dao_admin::DaoAdmin<T0>>(&v0);
        let v2 = 0x2::object::new(arg5);
        let v3 = 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::dao_treasury::new<T0>(*0x2::object::uid_as_inner(&v2), arg5);
        let v4 = Dao<T0>{
            id                 : v2,
            voting_delay       : arg0,
            voting_period      : arg1,
            ...
            treasury           : 0x2::object::id<0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::dao_treasury::DaoTreasury<T0>>(&v3),
        ...
        0x2::transfer::public_transfer<0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::dao_admin::DaoAdmin<T0>>(v0, 0x2::object::uid_to_address(&v4.id));
        (v4, v3)
    }
    ...
    fun proposal_state_impl<T0: drop>(arg0: &Proposal<T0>, arg1: u64) : u8 {
        if (arg1 < arg0.start_time) {
            ...
            2
        } else if (arg0.for_votes + arg0.against_votes == 0 || arg0.for_votes <= arg0.against_votes || arg0.for_votes + arg0.against_votes < arg0.quorum_votes || arg0.voting_quorum_rate > 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::fixed_point_roll::div_down(arg0.for_votes, arg0.for_votes + arg0.against_votes)) {
            3
        } else if (arg0.eta == 0) {
            4
    ...
    public fun update_dao_config<T0: drop>(arg0: &mut Dao<T0>, arg1: &0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::dao_admin::DaoAdmin<T0>, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>) {
