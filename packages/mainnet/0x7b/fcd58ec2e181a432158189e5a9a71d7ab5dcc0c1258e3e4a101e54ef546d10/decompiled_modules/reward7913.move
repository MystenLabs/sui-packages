module 0x7bfcd58ec2e181a432158189e5a9a71d7ab5dcc0c1258e3e4a101e54ef546d10::reward7913 {
    struct REWARD7913 has drop {
        dummy_field: bool,
    }

    struct TICKET_7913 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7913(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7913>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7913>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7913, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7913>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7913>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7913>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7913>>(v5, 0x2::tx_context::sender(arg1));
    }
