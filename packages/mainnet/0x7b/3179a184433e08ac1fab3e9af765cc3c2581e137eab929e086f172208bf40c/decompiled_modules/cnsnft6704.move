module 0x7b3179a184433e08ac1fab3e9af765cc3c2581e137eab929e086f172208bf40c::cnsnft6704 {
    struct CNSNFT6704 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6704, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8679"));
        let v4 = 0x2::package::claim<CNSNFT6704>(arg0, arg1);
