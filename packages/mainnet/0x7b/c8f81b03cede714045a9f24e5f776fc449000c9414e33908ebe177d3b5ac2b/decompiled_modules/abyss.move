module 0x23a10fe5bd4a7b78087d6e716a1e810168e0b3332ff022637606a02d001fc9f1::abyss {
    ...
    public fun fee_chest_burn() : u64 {
        20000
    }

    public fun fee_chest_extend() : u64 {
        20000
    }

    public fun fee_chest_open_large() : u64 {
        250000
    }

    public fun fee_chest_open_nano() : u64 {
        50000
    }

    public fun fee_chest_open_standard() : u64 {
        100000
    }
    ...
    public fun fee_return_flare() : u64 {
        50000
    }
    ...
    public fun receive_chest_access(arg0: &mut Abyss, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        deposit(arg0, arg1, 0, b"chest:access", arg2, arg3);
    }

    public fun receive_chest_burn(arg0: &mut Abyss, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        deposit(arg0, arg1, 20000, b"chest:burn", arg2, arg3);
    }

    public fun receive_chest_extend(arg0: &mut Abyss, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        deposit(arg0, arg1, 20000, b"chest:extend", arg2, arg3);
    }

    public fun receive_chest_open(arg0: &mut Abyss, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: u8, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        let v0 = if (arg2 == 0) {
            50000
        } else if (arg2 == 1) {
            100000
        ...
        deposit(arg0, arg1, v0, b"chest:open", arg3, arg4);
    }
    ...
    public fun receive_return_flare(arg0: &mut Abyss, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        deposit(arg0, arg1, 50000, b"return_flare:send", arg2, arg3);
    }
    ...
    public fun receive_stream_access(arg0: &mut Abyss, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        deposit(arg0, arg1, 0, b"stream:access", arg2, arg3);
    }

    public fun receive_stream_create(arg0: &mut Abyss, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        deposit(arg0, arg1, 50000, b"stream:create", arg2, arg3);
    }
