module 0x7b2159e438c8bb7d6bcadf704b8a1c018d044ca741ad850671e20cc477b2e1c0::sample_transfer {
    ...
    struct NFTWalletToKioskTransferred has copy, drop {
        nft_id: 0x2::object::ID,
        from: address,
        to: address,
    ...
    public entry fun transfer_from_wallet_to_personal_kiosk<T0: store + key>(arg0: T0, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(is_personal_kiosk(arg1), 5);
        assert!(0x2::kiosk::has_access(arg1, arg2), 3);
        0x2::kiosk::place<T0>(arg1, arg2, arg0);
        let v0 = NFTWalletToKioskTransferred{
            nft_id      : 0x2::object::id<T0>(&arg0),
            from        : 0x2::tx_context::sender(arg3),
            to          : 0x2::kiosk::owner(arg1),
            to_kiosk_id : 0x2::object::id<0x2::kiosk::Kiosk>(arg1),
        };
        0x2::event::emit<NFTWalletToKioskTransferred>(v0);
    }
