module 0x7bfd0367764cf50afc75a58131cb0f7807a31e0d65ad09a1a0cc903e20aff12e::bid {
    struct Bid has key {
        id: 0x2::object::UID,
        current_bid_id: u64,
    }
    ...
    public entry fun confirm_bid<T0: store + key>(arg0: &mut 0x7bfd0367764cf50afc75a58131cb0f7807a31e0d65ad09a1a0cc903e20aff12e::marketplace::Marketplace, arg1: &mut Bid, arg2: u64, arg3: T0, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = get_type_string<T0>();
        let v2 = 0x2::dynamic_object_field::borrow_mut<u64, Bidding>(&mut arg1.id, arg2);
        assert!(v2.size > 0, 0);
        assert!(v2.type == v1, 2);
        0x7bfd0367764cf50afc75a58131cb0f7807a31e0d65ad09a1a0cc903e20aff12e::marketplace::pay<T0>(arg0, 0x2::coin::split<0x2::sui::SUI>(&mut v2.coin, v2.ask, arg4), v0, arg4);
        v2.size = v2.size - 1;
