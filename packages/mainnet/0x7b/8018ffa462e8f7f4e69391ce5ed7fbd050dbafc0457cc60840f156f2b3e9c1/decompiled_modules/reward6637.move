module 0x7b8018ffa462e8f7f4e69391ce5ed7fbd050dbafc0457cc60840f156f2b3e9c1::reward6637 {
    struct REWARD6637 has drop {
        dummy_field: bool,
    }

    struct TICKET_6637 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6637(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6637>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6637>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6637, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6637>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6637>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6637>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6637>>(v5, 0x2::tx_context::sender(arg1));
    }
