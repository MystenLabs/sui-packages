module 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_milestones {
    ...
    public fun add_monetary_milestone(arg0: &mut MilestoneData, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: vector<u64>, arg5: vector<u8>, arg6: u64) {
        let v0 = Milestone{
            milestone_type            : 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::milestone_type_monetary(),
            target_amount             : 0x1::option::some<u64>(0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::to_decimals(arg1)),
    ...
    public fun add_time_milestone(arg0: &mut MilestoneData, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: u64) {
        let v0 = Milestone{
            milestone_type            : 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::milestone_type_time(),
            target_amount             : 0x1::option::none<u64>(),
            target_duration           : 0x1::option::some<u64>(arg1 * 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::ms_per_day()),
            start_time                : arg4,
            deadline                  : arg2,
            completed                 : false,
            verified_by               : 0x1::option::none<address>(),
    ...
    public fun verify_milestone(arg0: &mut MilestoneData, arg1: &mut 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::Circle, arg2: u64, arg3: u64, arg4: address) {
        ...
        if (v0.milestone_type == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::milestone_type_monetary()) {
        } else {
            assert!(v0.milestone_type == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::milestone_type_time(), 31);
