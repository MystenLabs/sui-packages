module 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_yield_integration {
    ...
    public fun collect_member_yield(arg0: &0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::Circle, arg1: &mut YieldConfig, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<0x2::sui::SUI>) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(v0 == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::get_admin(arg0) || v0 == arg2, 100);
    ...
    public fun collect_real_cetus_fees_entry(arg0: &0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::Circle, arg1: &mut YieldConfig, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(v0 == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::get_admin(arg0) || v0 == arg2, 100);
    ...
    public fun collect_yield(arg0: &0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::Circle, arg1: &mut 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_custody::CustodyWallet, arg2: &mut YieldConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        assert!(0x2::tx_context::sender(arg4) == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::get_admin(arg0), 100);
    ...
    public fun create_real_cetus_position_entry(arg0: &0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::Circle, arg1: &mut 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_custody::CustodyWallet, arg2: &mut YieldConfig, arg3: address, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(v0 == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::get_admin(arg0) || v0 == arg3, 100);
        assert!(arg2.is_active, 101);
    ...
    public fun create_yield_config(arg0: &0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::Circle, arg1: u8, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::get_admin(arg0), 100);
        let v0 = if (arg1 == 0) {
            true
        } else if (arg1 == 1) {
    ...
    public fun distribute_yield_on_completion(arg0: &0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::Circle, arg1: &mut 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_custody::CustodyWallet, arg2: &mut YieldConfig, arg3: address, arg4: YieldReceipt, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg6) == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::get_admin(arg0), 100);
        assert!(!0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::is_circle_active(arg0), 108);
        assert!(arg4.circle_id == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::get_id(arg0), 103);
    ...
    public fun emergency_withdraw_all(arg0: &0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::Circle, arg1: &mut 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_custody::CustodyWallet, arg2: &mut YieldConfig, arg3: 0x1::string::String, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::get_admin(arg0), 100);
    ...
    public fun generate_yield_on_security_deposit(arg0: &0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::Circle, arg1: &mut 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_custody::CustodyWallet, arg2: &mut YieldConfig, arg3: address, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : YieldReceipt {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(v0 == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::get_admin(arg0) || v0 == arg3, 100);
        assert!(arg2.is_active, 101);
        assert!(arg2.circle_id == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::get_id(arg0), 103);
        assert!(0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_custody::get_circle_id(arg1) == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_circles::get_id(arg0), 103);
        let v1 = 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_custody::withdraw_from_dynamic_fields(arg1, arg4, arg6);
