module 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_members {
    ...
    public fun member_status_active() : u8 {
        0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::member_status_active()
    }

    public fun member_status_pending() : u8 {
        0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::member_status_pending()
    }

    public fun member_status_suspended() : u8 {
        0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::member_status_suspended()
    }
    ...
    public fun get_contribution_history(arg0: &Member) : (u64, u64, u64, u64) {
        (0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::from_decimals(arg0.total_contributed), arg0.consecutive_on_time_payments, arg0.missed_payments, arg0.total_meetings_required)
    }
    ...
    public fun get_unpaid_penalties(arg0: &Member) : u64 {
        0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::from_decimals(arg0.unpaid_penalties)
    }
    ...
    public fun is_eligible_for_payout(arg0: &Member, arg1: u64, arg2: u64, arg3: u64) : bool {
        if (arg0.status == 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::member_status_active()) {
    ...
    public fun member_status_inactive() : u8 {
        0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::member_status_exited()
    }
    ...
    public fun process_member_exit(arg0: &mut Member, arg1: u64) : bool {
        ...
        arg0.status = 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::member_status_exited();
        true
    }
    ...
    public fun reactivate_member(arg0: &mut Member, arg1: &0x2::clock::Clock) : bool {
        ...
        arg0.status = 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::member_status_active();
    ...
    public fun suspend_member(arg0: &mut Member, arg1: &0x2::clock::Clock) {
        arg0.status = 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::member_status_suspended();
        arg0.suspension_end_time = 0x1::option::some<u64>(0x2::clock::timestamp_ms(arg1) + 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::ms_per_month());
    }
