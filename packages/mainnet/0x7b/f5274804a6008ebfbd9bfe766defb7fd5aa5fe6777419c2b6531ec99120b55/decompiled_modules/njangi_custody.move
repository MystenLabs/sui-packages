module 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_custody {
    ...
    public fun check_withdrawal_limit(arg0: &CustodyWallet, arg1: u64) : bool {
        ...
        v0 > arg0.last_withdrawal_time + 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::ms_per_day() && arg1 <= arg0.daily_withdrawal_limit || arg0.daily_withdrawal_total + arg1 <= arg0.daily_withdrawal_limit
    }
    ...
    public fun create_custody_wallet(arg0: 0x2::object::ID, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = CustodyWallet{
            ...
            is_active              : true,
            daily_withdrawal_limit : 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::to_decimals(10000),
    ...
    public fun deposit(arg0: &mut CustodyWallet, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<CustodyTransaction>(&mut arg0.transaction_history, create_transaction(0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::custody_op_deposit(), v0, v1, 0x2::tx_context::epoch_timestamp_ms(arg2)));
        let v2 = CustodyDeposited{
            circle_id      : arg0.circle_id,
            wallet_id      : 0x2::object::uid_to_inner(&arg0.id),
            member         : v0,
            amount         : v1,
            operation_type : 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::custody_op_deposit(),
        };
    ...
    public(friend) fun deposit_contribution_coin<T0>(arg0: &mut CustodyWallet, arg1: 0x2::coin::Coin<T0>, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<CustodyTransaction>(&mut arg0.transaction_history, create_transaction(0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::custody_op_deposit(), arg2, v0, v1));
    ...
    public fun get_balance(arg0: &CustodyWallet) : u64 {
        0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::from_decimals(0x2::balance::value<0x2::sui::SUI>(&arg0.balance))
    }
    ...
    public(friend) fun internal_store_security_deposit<T0>(arg0: &mut CustodyWallet, arg1: 0x2::coin::Coin<T0>, arg2: address, arg3: u64, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.is_active, 43);
        let v2 = 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_price_validator::validate_stablecoin_deposit(arg4, v0, arg3, 0x1::type_name::into_string(0x1::type_name::get<T0>()), arg5, arg6);
        assert!(v2 >= arg3, 55);
        ...
        0x1::vector::push_back<CustodyTransaction>(&mut arg0.transaction_history, create_transaction(0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::custody_op_stablecoin_deposit(), arg2, v0, v1));
        ...
        let v7 = CustodyDeposited{
            ...
            member         : arg2,
            amount         : v0,
            operation_type : 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::custody_op_stablecoin_deposit(),
        };
    ...
    public fun validate_deposit_amount<T0>(arg0: u64, arg1: u64, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_price_validator::validate_stablecoin_deposit(arg2, arg0, arg1, 0x1::type_name::into_string(0x1::type_name::get<T0>()), arg3, arg4)
    }
    ...
    public fun withdraw(arg0: &mut CustodyWallet, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        if (v1 > arg0.last_withdrawal_time + 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::ms_per_day()) {
        ...
        0x1::vector::push_back<CustodyTransaction>(&mut arg0.transaction_history, create_transaction(0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::custody_op_withdrawal(), v0, arg1, v1));
        let v3 = CustodyWithdrawn{
            circle_id      : arg0.circle_id,
            wallet_id      : 0x2::object::uid_to_inner(&arg0.id),
            recipient      : v0,
            amount         : arg1,
            operation_type : 0x7bf5274804a6008ebfbd9bfe766defb7fd5aa5fe6777419c2b6531ec99120b55::njangi_core::custody_op_withdrawal(),
        };
