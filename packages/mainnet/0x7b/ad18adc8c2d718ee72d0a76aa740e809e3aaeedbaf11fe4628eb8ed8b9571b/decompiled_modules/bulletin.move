module 0x1b602d575ddf1ced075f9d2986bfe53cd7d4e59967ec26a0d949009c7b2c9d6c::bulletin {
    ...
    struct RootAuthorityDidRotatedEvent has copy, drop {
        proposal_id: u64,
        previous_root_authority_did: vector<u8>,
        new_root_authority_did: vector<u8>,
        rotated_at_ms: u64,
    }
    ...
    fun apply_passed_proposal(arg0: &mut Bulletin, arg1: Proposal, arg2: u64) {
        ...
        } else if (arg1.action_type == 51) {
            let v8 = RootAuthorityDidRotatedEvent{
                proposal_id                 : arg1.proposal_id,
                previous_root_authority_did : arg0.root_authority_did,
                new_root_authority_did      : arg1.target_did,
                rotated_at_ms               : arg2,
            };
            0x2::event::emit<RootAuthorityDidRotatedEvent>(v8);
            ...
            if (v3) {
                ...
                if (v5) {
                    ...
                    if (v7) {
                        ...
                        assert!(arg1.action_type == 26 || arg1.action_type == 36, 11);
                        let v9 = &mut arg0.subjects;
                        revoke_subject(v9, find_subject_index_opt(&arg0.subjects, arg1.subject_type, &arg1.target_did), arg2, arg1.policy_hash, arg1.metadata_hash);
                    };
                };
            };
        };
        ...
        if (v1) {
            ...
            if (v3) {
                ...
                if (v4) {
                    ...
                    v5 && subject_is_active_or_suspended(&arg0.subjects, arg1.subject_type, &arg1.target_did) || (arg1.action_type == 26 || arg1.action_type == 36) && subject_is_active_or_suspended(&arg0.subjects, arg1.subject_type, &arg1.target_did)
                }
            }
        }
    }
