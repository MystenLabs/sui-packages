module 0x7bd1e2693124665a1daca56a4882ea00b7d2345b47a33757e68ff3d66a0c56f5::vapor {
    ...
    public fun create_mint_cap(arg0: &0x7bd1e2693124665a1daca56a4882ea00b7d2345b47a33757e68ff3d66a0c56f5::admin::OwnerCap<VAPOR_ADMIN>, arg1: &mut 0x2::tx_context::TxContext) : MintCap {
    ...
    fun init(arg0: VAPOR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x7bd1e2693124665a1daca56a4882ea00b7d2345b47a33757e68ff3d66a0c56f5::admin::transfer_owner_cap<VAPOR_ADMIN>(0x7bd1e2693124665a1daca56a4882ea00b7d2345b47a33757e68ff3d66a0c56f5::admin::create_owner_cap<VAPOR_ADMIN>(v0, arg1), 0x2::tx_context::sender(arg1));
        let (v1, v2) = 0x2::coin::create_currency<VAPOR>(arg0, 9, b"VAPOR", b"Vapor DAO", b"A treasury backed coin on Sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://bafybeibdttsqfi355hzrc4jecsn2pk2yip7kdxie52c7zf72eiq3pucvqq.ipfs.nftstorage.link/")), arg1);
        let v3 = v1;
        0x2::coin::mint_and_transfer<VAPOR>(&mut v3, 50000000000000, 0x2::tx_context::sender(arg1), arg1);
    ...
    public entry fun invalidate_mint_cap(arg0: &0x7bd1e2693124665a1daca56a4882ea00b7d2345b47a33757e68ff3d66a0c56f5::admin::OwnerCap<VAPOR_ADMIN>, arg1: &mut Treasury, arg2: 0x2::object::ID) {
