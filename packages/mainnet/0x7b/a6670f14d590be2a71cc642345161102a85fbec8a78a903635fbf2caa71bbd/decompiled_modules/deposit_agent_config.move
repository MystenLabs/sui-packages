module 0x7ba6670f14d590be2a71cc642345161102a85fbec8a78a903635fbf2caa71bbd::deposit_agent_config {
    ...
    public(friend) fun get_collect_to_sign_msg<T0>(arg0: 0x1::string::String, arg1: u256, arg2: u64, arg3: address, arg4: u64) : vector<u8> {
    ...
    public(friend) fun token_holder_receive<T0>(arg0: &mut DepositAgentConfig, arg1: &0x57c9cb0c610e1b23ae18eb8c85310ee45101740f042bae62775714db57132a30::cloud_wallet_config::CloudWalletConfig, arg2: &mut 0x57c9cb0c610e1b23ae18eb8c85310ee45101740f042bae62775714db57132a30::cloud_wallet_config::CloudWalletTokenHolder, arg3: u256, arg4: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg5: 0x1::string::String, arg6: address, arg7: u64, arg8: vector<u8>, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<u256, DepositAgentTokenHolder>(&arg0.token_holder_table, arg3), 40007);
        let v0 = 0x2::transfer::public_receive<0x2::coin::Coin<T0>>(&mut 0x2::table::borrow_mut<u256, DepositAgentTokenHolder>(&mut arg0.token_holder_table, arg3).id, arg4);
        check_signer(arg0, 0x7ba6670f14d590be2a71cc642345161102a85fbec8a78a903635fbf2caa71bbd::utils::ecrecover(arg8, 0x7ba6670f14d590be2a71cc642345161102a85fbec8a78a903635fbf2caa71bbd::utils::keccak_message(get_collect_to_sign_msg<T0>(arg5, arg3, 0x2::coin::value<T0>(&v0), arg6, arg7))));
        0x57c9cb0c610e1b23ae18eb8c85310ee45101740f042bae62775714db57132a30::cloud_wallet::mm_credit<T0>(arg1, arg2, v0, arg9);
    }
    ...
    public(friend) fun when_to_address_match(arg0: &0x57c9cb0c610e1b23ae18eb8c85310ee45101740f042bae62775714db57132a30::cloud_wallet_config::CloudWalletTokenHolder, arg1: address) {
        assert!(arg1 == 0x2::object::id_address<0x57c9cb0c610e1b23ae18eb8c85310ee45101740f042bae62775714db57132a30::cloud_wallet_config::CloudWalletTokenHolder>(arg0), 40012);
    }
