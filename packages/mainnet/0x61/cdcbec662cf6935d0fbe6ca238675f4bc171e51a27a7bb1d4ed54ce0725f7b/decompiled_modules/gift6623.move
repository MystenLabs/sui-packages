module 0x61cdcbec662cf6935d0fbe6ca238675f4bc171e51a27a7bb1d4ed54ce0725f7b::gift6623 {
    struct GIFT6623 has drop {
        dummy_field: bool,
    }

    struct TICKET_6623 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6623(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6623>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6623>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6623, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6623>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6623>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6623>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6623>>(v5, 0x2::tx_context::sender(arg1));
    }
