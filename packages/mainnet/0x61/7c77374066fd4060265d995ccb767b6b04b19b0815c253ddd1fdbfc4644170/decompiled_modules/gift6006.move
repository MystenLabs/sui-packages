module 0x617c77374066fd4060265d995ccb767b6b04b19b0815c253ddd1fdbfc4644170::gift6006 {
    struct GIFT6006 has drop {
        dummy_field: bool,
    }

    struct TICKET_6006 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6006(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6006>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6006>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6006, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6006>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6006>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6006>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6006>>(v5, 0x2::tx_context::sender(arg1));
    }
