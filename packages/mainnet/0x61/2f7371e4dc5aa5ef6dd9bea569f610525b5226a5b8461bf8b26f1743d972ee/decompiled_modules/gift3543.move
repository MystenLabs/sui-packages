module 0x612f7371e4dc5aa5ef6dd9bea569f610525b5226a5b8461bf8b26f1743d972ee::gift3543 {
    struct GIFT3543 has drop {
        dummy_field: bool,
    }

    struct TICKET_3543 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3543(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3543>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3543>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3543, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3543>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3543>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3543>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3543>>(v5, 0x2::tx_context::sender(arg1));
    }
