module 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::reserve_config {
    ...
    public fun borrow_fee(arg0: &ReserveConfig) : 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::Decimal {
        0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from_bps(arg0.borrow_fee_bps)
    }
    ...
    public fun borrow_weight(arg0: &ReserveConfig) : 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::Decimal {
        0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from_bps(arg0.borrow_weight_bps)
    }
    ...
    public fun calculate_apr(arg0: &ReserveConfig, arg1: 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::Decimal) : 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::Decimal {
        assert!(0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::le(arg1, 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from(1)), 1);
        let v0 = 1;
        while (v0 < 0x1::vector::length<u8>(&arg0.interest_rate_utils)) {
            let v1 = 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from_percent(*0x1::vector::borrow<u8>(&arg0.interest_rate_utils, v0 - 1));
            let v2 = 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from_percent(*0x1::vector::borrow<u8>(&arg0.interest_rate_utils, v0));
            if (0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::ge(arg1, v1) && 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::le(arg1, v2)) {
                let v3 = 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from_bps(*0x1::vector::borrow<u64>(&arg0.interest_rate_aprs, v0 - 1));
                return 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::add(v3, 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::mul(0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::div(0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::sub(arg1, v1), 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::sub(v2, v1)), 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::sub(0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from_bps(*0x1::vector::borrow<u64>(&arg0.interest_rate_aprs, v0)), v3)))
            };
            v0 = v0 + 1;
        };
        abort 0
    ...
    public fun calculate_supply_apr(arg0: &ReserveConfig, arg1: 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::Decimal, arg2: 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::Decimal) : 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::Decimal {
        0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::mul(0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::mul(0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::sub(0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from(1), spread_fee(arg0)), arg2), arg1)
    }

    public fun close_ltv(arg0: &ReserveConfig) : 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::Decimal {
        0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from_percent(arg0.close_ltv_pct)
    }
    ...
    public fun liquidation_bonus(arg0: &ReserveConfig) : 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::Decimal {
        0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from_bps(arg0.liquidation_bonus_bps)
    }

    public fun open_ltv(arg0: &ReserveConfig) : 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::Decimal {
        0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from_percent(arg0.open_ltv_pct)
    }

    public fun protocol_liquidation_fee(arg0: &ReserveConfig) : 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::Decimal {
        0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from_bps(arg0.protocol_liquidation_fee_bps)
    }
    ...
    public fun spread_fee(arg0: &ReserveConfig) : 0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::Decimal {
        0x614eef5768ca22065de4a55edbb85e7e178fc1a82a8e237084d66e9ebf46c5de::decimal::from_bps(arg0.spread_fee_bps)
    }
