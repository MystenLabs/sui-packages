module 0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_apa7one5cz {
    struct T_r7xsjfjo7j has key {
        id: 0x2::object::UID,
        admin_cap_id: 0x2::object::ID,
        profit_recipient: address,
    }

    struct T_fajiawphj2 has store, key {
        id: 0x2::object::UID,
        registry_id: 0x2::object::ID,
    }

    struct T_n53hzq2snr<phantom T0, phantom T1, phantom T2> has store, key {
        id: 0x2::object::UID,
        registry_id: 0x2::object::ID,
    ...
    struct T_olvztn7gnu<phantom T0, phantom T1, phantom T2> has store, key {
        id: 0x2::object::UID,
        registry_id: 0x2::object::ID,
    ...
    struct T_fy4tqi665r<phantom T0, phantom T1, phantom T2, phantom T3, phantom T4, phantom T5> has store, key {
        id: 0x2::object::UID,
        registry_id: 0x2::object::ID,
    ...
    struct T_djtbq5nnpj<phantom T0, phantom T1, phantom T2, phantom T3, phantom T4, phantom T5> {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_route_id: 0x2::object::ID,
        destination_route_id: 0x2::object::ID,
    ...
    struct T_vpc6zv4qbo<phantom T0, phantom T1, phantom T2, phantom T3, phantom T4, phantom T5> {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_id: 0x2::object::ID,
        profit_recipient: address,
    ...
    struct T_hen533j7gu has copy, drop {
        source_a: u64,
        source_b: u64,
    ...
    struct T_r75ddwor5k has copy, drop {
    ...
    struct T_eli2rx66sa<phantom T0, phantom T1, phantom T2, phantom T3, phantom T4, phantom T5> has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_route_id: 0x2::object::ID,
        destination_route_id: 0x2::object::ID,
        ...
        width_intervals: u32,
        income: T_jrqkr6beze,
        principal: T_hen533j7gu,
        retained: T_r75ddwor5k,
    }

    struct T_3ov44yoafp has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_route_id: 0x2::object::ID,
        destination_route_id: 0x2::object::ID,
    ...
    struct T_gtg4atiuid has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
    ...
    struct T_yp37lbfyya has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_route_id: 0x2::object::ID,
        destination_route_id: 0x2::object::ID,
    ...
    struct T_vvrkqzfsei has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_id: 0x2::object::ID,
        owner: address,
    ...
    struct T_ljnqzb3dkq has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_cap_id: 0x2::object::ID,
    ...
    struct T_pk2yptmdma<phantom T0, phantom T1, phantom T2> {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        bluefin_pool_id: 0x2::object::ID,
        owner: address,
    ...
    struct T_j4u6hwmnqc<phantom T0, phantom T1, phantom T2> {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_id: 0x2::object::ID,
        profit_recipient: address,
    ...
    struct T_7daxlus2ow has copy, drop {
        registry_id: 0x2::object::ID,
        admin_cap_id: 0x2::object::ID,
        profit_recipient: address,
    }

    struct T_i5szqv6oi4 has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        bluefin_pool_id: 0x2::object::ID,
        owner: address,
    ...
    struct T_oruabmw4ut has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        position_cap_id: 0x2::object::ID,
        bluefin_pool_id: 0x2::object::ID,
    ...
    struct T_f4lmedbeob has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_cap_id: 0x2::object::ID,
        bluefin_pool_id: 0x2::object::ID,
    ...
    struct T_wyfr3t3vbc has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_id: 0x2::object::ID,
        current_tick: u32,
    ...
    struct T_jrqkr6beze has copy, drop {
        profit_recipient: address,
        reward_as_sui: u64,
        fee_a_as_sui: u64,
        fee_b_as_sui: u64,
    ...
    struct T_uvl7arscwl has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_id: 0x2::object::ID,
        owner: address,
    ...
    struct T_2rjs2kas5q has copy, drop {
        before_a: u64,
        before_b: u64,
    ...
    struct T_joa4kqw4kk has copy, drop {
        sui_to_a_input: u64,
        sui_to_a_output: u64,
        sui_to_b_input: u64,
        sui_to_b_output: u64,
    ...
    struct T_wf3xckqe4j has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_position_cap_id: 0x2::object::ID,
        replacement_position_cap_id: 0x2::object::ID,
        ...
        width_intervals: u32,
        income: T_jrqkr6beze,
        principal: T_2rjs2kas5q,
        retained: T_joa4kqw4kk,
    }

    struct T_oadcteg6eg has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        owner: address,
        amount_a: u64,
    ...
    public fun f_27icknhu3q<T0, T1>(arg0: &T_r7xsjfjo7j, arg1: &T_fajiawphj2, arg2: &T_n53hzq2snr<T0, 0x2::sui::SUI, T0>, arg3: &T_n53hzq2snr<0x2::sui::SUI, T1, 0x2::sui::SUI>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, 0x2::sui::SUI>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T1>, arg6: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg7: &mut 0x2::tx_context::TxContext) {
        f_q6doftmw2j(0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T1>>(arg5));
        assert!(arg2.tick_spacing == 1, 7);
        assert!(arg3.tick_spacing == 5, 7);
        f_56qrmxvooi<T0, 0x2::sui::SUI, T0, 0x2::sui::SUI, T1, 0x2::sui::SUI>(arg0, arg1, arg2, arg3, arg4, arg5, 1, arg7);
    }

    public fun f_2qoyjs5zbg<T0, T1, T2, T3, T4, T5>(arg0: &0x2::clock::Clock, arg1: &T_r7xsjfjo7j, arg2: &mut T_fy4tqi665r<T0, T1, T2, T3, T4, T5>, arg3: T_djtbq5nnpj<T0, T1, T2, T3, T4, T5>, arg4: T_vpc6zv4qbo<T0, T1, T2, T3, T4, T5>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg7: 0x2::balance::Balance<T3>, arg8: 0x2::balance::Balance<T4>, arg9: 0x2::balance::Balance<T3>, arg10: 0x2::balance::Balance<T4>, arg11: 0x2::balance::Balance<0x2::sui::SUI>, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: bool, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: u64, arg27: bool, arg28: u64, arg29: u64, arg30: u64, arg31: u64, arg32: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg33: &mut 0x2::tx_context::TxContext) {
        f_ubqhbawi3m<T0, T1, T2, T3, T4, T5>(arg1, arg2, arg6, arg33);
        let v0 = 0x2::object::id<T_r7xsjfjo7j>(arg1);
        let v1 = 0x2::object::id<T_fy4tqi665r<T0, T1, T2, T3, T4, T5>>(arg2);
        ...
        f_rbqra43tzb<T0, T1, T2, T3, T4, T5>(arg1, arg2, &arg3, &arg4);
        let v3 = 0x2::balance::value<T3>(&arg7);
        let v4 = 0x2::balance::value<T4>(&arg8);
        assert!(0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_oxnwkj5yih(arg3.source_principal_a, arg3.source_principal_b, arg12, arg13, arg14, arg15, v3, v4), 26);
        assert!(arg20 > 0, 20);
        ...
        f_zp23b3rih2(arg16, arg17, arg17);
        f_zp23b3rih2(arg18, arg19, arg19);
        assert!(0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_nvtdbllbj7(v5, v6, arg4.prior_retained_sui, arg4.newly_retained_sui, v7, v8, v9, arg16, arg17, arg18, arg19), 14);
        let (v10, v11) = f_hz7yfysqnc(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T3, T4>(arg6), 0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_cx3gfgs4gq(arg2.destination_tick_spacing, arg2.destination_width_intervals), arg2.destination_tick_spacing, arg2.destination_width_intervals);
        ...
        assert!(v30 > 0, 8);
        f_kgcu745hf7(&v12, v2, v10, v11);
        let v31 = T_olvztn7gnu<T3, T4, T5>{
        ...
        let v34 = T_eli2rx66sa<T0, T1, T2, T3, T4, T5>{
            registry_id                 : v0,
            route_id                    : v1,
            ...
            destination_position_cap_id : 0x2::object::id<T_olvztn7gnu<T3, T4, T5>>(&v31),
            ...
            income                      : f_n26qicl7n2<T0, T1, T2, T3, T4, T5>(&arg4),
            principal                   : v32,
            retained                    : v33,
        };
        0x2::event::emit<T_eli2rx66sa<T0, T1, T2, T3, T4, T5>>(v34);
        let T_djtbq5nnpj {
            registry_id            : _,
            route_id               : _,
            source_route_id        : _,
        ...
        0x2::transfer::public_transfer<T_olvztn7gnu<T3, T4, T5>>(v31, arg2.owner);
        f_ozoffpgb3u<T3>(v19, arg2.owner);
        f_ozoffpgb3u<T4>(v18, arg2.owner);
    }

    fun f_2rn2cy6sx7<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        let v0 = &mut arg3;
        let (v1, v2) = f_cguqv5pfrx<T0, T1>(arg0, arg1, arg2, v0);
        let v3 = v2;
        let v4 = v1;
        ...
        let v9 = &mut arg3;
        let (v10, v11) = f_cguqv5pfrx<T0, T1>(arg0, arg1, arg2, v9);
    ...
    public(friend) fun f_56qrmxvooi<T0, T1, T2, T3, T4, T5>(arg0: &T_r7xsjfjo7j, arg1: &T_fajiawphj2, arg2: &T_n53hzq2snr<T0, T1, T2>, arg3: &T_n53hzq2snr<T3, T4, T5>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg6: u32, arg7: &mut 0x2::tx_context::TxContext) {
        f_dgyfjqoke2(arg0, arg1);
        f_lx4cj3teao<T0, T1, T2, T3, T4, T5>(arg0, arg2, arg3, arg4, arg5);
        assert!(0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_2ry2f2pmkp(arg6), 7);
        ...
        let v2 = 0x2::object::id<T_n53hzq2snr<T0, T1, T2>>(arg2);
        let v3 = 0x2::object::id<T_n53hzq2snr<T3, T4, T5>>(arg3);
        let v4 = arg2.owner;
        let v5 = T_fy4tqi665r<T0, T1, T2, T3, T4, T5>{
            id                          : 0x2::object::new(arg7),
            registry_id                 : 0x2::object::id<T_r7xsjfjo7j>(arg0),
            source_route_id             : v2,
        ...
        let v6 = T_3ov44yoafp{
            registry_id                 : 0x2::object::id<T_r7xsjfjo7j>(arg0),
            route_id                    : 0x2::object::id<T_fy4tqi665r<T0, T1, T2, T3, T4, T5>>(&v5),
            source_route_id             : v2,
            destination_route_id        : v3,
            source_pool_id              : v0,
            destination_pool_id         : v1,
        ...
        0x2::event::emit<T_3ov44yoafp>(v6);
        0x2::transfer::public_transfer<T_fy4tqi665r<T0, T1, T2, T3, T4, T5>>(v5, v4);
    }

    public fun f_7fnb4ibx7v<T0>(arg0: &T_r7xsjfjo7j, arg1: &T_fajiawphj2, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, 0x2::sui::SUI>, arg3: address, arg4: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg5: &mut 0x2::tx_context::TxContext) {
        f_cnpcfhp35u<T0, 0x2::sui::SUI, T0>(arg0, arg1, arg2, 1, false, arg3, arg5);
    }

    public fun f_7j6qvefull<T0, T1, T2, T3, T4, T5>(arg0: &0x2::clock::Clock, arg1: &T_r7xsjfjo7j, arg2: &T_fy4tqi665r<T0, T1, T2, T3, T4, T5>, arg3: T_olvztn7gnu<T0, T1, T2>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg6: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg7: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg8: u128, arg9: u32, arg10: u32, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg17: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, T_djtbq5nnpj<T0, T1, T2, T3, T4, T5>) {
        f_y3k3np3ot3<T0, T1, T2, T3, T4, T5>(arg1, arg2, arg5, arg6, arg17);
        let v0 = 0x2::object::id<T_r7xsjfjo7j>(arg1);
        let v1 = 0x2::object::id<T_fy4tqi665r<T0, T1, T2, T3, T4, T5>>(arg2);
        ...
        f_awielg3ttp(arg3.tick_lower, arg3.tick_upper);
        f_kgcu745hf7(&arg7, v2, arg3.tick_lower, arg3.tick_upper);
        let v5 = 0x2::object::id<T_olvztn7gnu<T0, T1, T2>>(&arg3);
        ...
        let (v11, v12, v13, v14) = f_2rn2cy6sx7<T0, T1>(arg0, arg4, arg5, arg7);
        let v15 = v14;
        let v16 = v13;
        let v17 = v12;
        let v18 = v11;
        ...
        0x2::event::emit<T_yp37lbfyya>(v23);
        let T_olvztn7gnu {
            id                   : v24,
            registry_id          : _,
            route_id             : _,
        ...
        let v33 = T_djtbq5nnpj<T0, T1, T2, T3, T4, T5>{
            registry_id            : v0,
            route_id               : v1,
            source_route_id        : arg2.source_route_id,
            destination_route_id   : arg2.destination_route_id,
    ...
    fun f_7xo5dwf4tr<T0, T1, T2>(arg0: &T_r7xsjfjo7j, arg1: &T_n53hzq2snr<T0, T1, T2>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>) {
        f_htp6r2bg6k(arg0);
        assert!(arg1.registry_id == 0x2::object::id<T_r7xsjfjo7j>(arg0), 1);
        ...
        f_sk3zlcqjyl(arg1.tick_spacing);
        assert!(arg1.income_policy_version == 1, 21);
    }

    fun f_a76jppnowv<T0, T1, T2, T3, T4, T5>(arg0: &T_r7xsjfjo7j, arg1: &T_fy4tqi665r<T0, T1, T2, T3, T4, T5>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>) {
        f_htp6r2bg6k(arg0);
        assert!(arg1.registry_id == 0x2::object::id<T_r7xsjfjo7j>(arg0), 1);
        ...
        assert!(arg1.owner != @0x0, 5);
        f_sk3zlcqjyl(arg1.source_tick_spacing);
        f_sk3zlcqjyl(arg1.destination_tick_spacing);
        assert!(0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_2ry2f2pmkp(arg1.destination_width_intervals), 7);
        assert!(arg1.income_policy_version == 1, 21);
    }

    fun f_awielg3ttp(arg0: u32, arg1: u32) {
    ...
    public fun f_b6zks6rxzl<T0>(arg0: &T_r7xsjfjo7j, arg1: &T_fajiawphj2, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T0>, arg3: address, arg4: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg5: &mut 0x2::tx_context::TxContext) {
        f_q6doftmw2j(0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T0>>(arg2));
        f_cnpcfhp35u<0x2::sui::SUI, T0, 0x2::sui::SUI>(arg0, arg1, arg2, 5, true, arg3, arg5);
    }
    ...
    public(friend) fun f_cnpcfhp35u<T0, T1, T2>(arg0: &T_r7xsjfjo7j, arg1: &T_fajiawphj2, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: u32, arg4: bool, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        f_dgyfjqoke2(arg0, arg1);
        assert!(arg5 != @0x0, 5);
        f_sk3zlcqjyl(arg3);
        let v0 = 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg2);
        let v1 = T_n53hzq2snr<T0, T1, T2>{
        ...
        let v2 = T_i5szqv6oi4{
            registry_id           : 0x2::object::id<T_r7xsjfjo7j>(arg0),
            route_id              : 0x2::object::id<T_n53hzq2snr<T0, T1, T2>>(&v1),
            bluefin_pool_id       : v0,
            owner                 : arg5,
            tick_spacing          : arg3,
            income_policy_version : 1,
        ...
        0x2::event::emit<T_i5szqv6oi4>(v2);
        0x2::transfer::public_transfer<T_n53hzq2snr<T0, T1, T2>>(v1, arg5);
    }

    fun f_dgyfjqoke2(arg0: &T_r7xsjfjo7j, arg1: &T_fajiawphj2) {
        f_htp6r2bg6k(arg0);
        assert!(arg1.registry_id == 0x2::object::id<T_r7xsjfjo7j>(arg0), 0);
        assert!(0x2::object::id<T_fajiawphj2>(arg1) == arg0.admin_cap_id, 0);
    }

    fun f_dx22ljdpkr<T0, T1, T2>(arg0: &T_r7xsjfjo7j, arg1: &T_n53hzq2snr<T0, T1, T2>, arg2: &0x2::tx_context::TxContext) {
        f_htp6r2bg6k(arg0);
        assert!(arg1.registry_id == 0x2::object::id<T_r7xsjfjo7j>(arg0), 1);
    ...
    public fun f_ezwtt2gmp7<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &T_r7xsjfjo7j, arg2: &T_n53hzq2snr<T0, T1, T2>, arg3: T_olvztn7gnu<T0, T1, T2>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg6: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg7: u128, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg14: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, T_pk2yptmdma<T0, T1, T2>) {
        f_jwwzirengs<T0, T1, T2>(arg1, arg2, arg5, arg14);
        let v0 = 0x2::object::id<T_r7xsjfjo7j>(arg1);
        let v1 = 0x2::object::id<T_n53hzq2snr<T0, T1, T2>>(arg2);
        let v2 = 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg5);
        ...
        assert!(arg3.owner == arg2.owner, 5);
        f_awielg3ttp(arg3.tick_lower, arg3.tick_upper);
        f_kgcu745hf7(&arg6, v2, arg3.tick_lower, arg3.tick_upper);
        let v4 = 0x2::object::id<T_olvztn7gnu<T0, T1, T2>>(&arg3);
        ...
        let (v10, v11, v12, v13) = f_2rn2cy6sx7<T0, T1>(arg0, arg4, arg5, arg6);
        let v14 = v13;
        let v15 = v12;
        let v16 = v11;
        let v17 = v10;
        ...
        0x2::event::emit<T_f4lmedbeob>(v23);
        let T_olvztn7gnu {
            id                   : v24,
            registry_id          : _,
            route_id             : _,
    ...
    public fun f_goaxlsfl5i<T0, T1, T2>(arg0: &T_r7xsjfjo7j, arg1: &mut T_n53hzq2snr<T0, T1, T2>, arg2: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg3: &mut 0x2::tx_context::TxContext) {
        f_dx22ljdpkr<T0, T1, T2>(arg0, arg1, arg3);
        ...
        let v3 = T_oadcteg6eg{
            registry_id             : 0x2::object::id<T_r7xsjfjo7j>(arg0),
            route_id                : 0x2::object::id<T_n53hzq2snr<T0, T1, T2>>(arg1),
            owner                   : arg1.owner,
            amount_a                : v0,
            amount_b                : v1,
            amount_sui              : v2,
        ...
        0x2::event::emit<T_oadcteg6eg>(v3);
        f_ozoffpgb3u<T0>(0x2::balance::split<T0>(&mut arg1.retained_a, v0), arg1.owner);
        f_ozoffpgb3u<T1>(0x2::balance::split<T1>(&mut arg1.retained_b, v1), arg1.owner);
        f_ozoffpgb3u<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.retained_sui, v2), arg1.owner);
    }

    fun f_h6wfrozwo5<T0, T1, T2>(arg0: &T_r7xsjfjo7j, arg1: &T_n53hzq2snr<T0, T1, T2>, arg2: &T_pk2yptmdma<T0, T1, T2>, arg3: &T_j4u6hwmnqc<T0, T1, T2>) {
        assert!(arg3.registry_id == 0x2::object::id<T_r7xsjfjo7j>(arg0), 1);
        assert!(arg3.route_id == 0x2::object::id<T_n53hzq2snr<T0, T1, T2>>(arg1), 3);
        assert!(arg3.source_position_id == arg2.source_position_id, 6);
        assert!(arg3.profit_recipient == arg0.profit_recipient, 2);
        assert!(0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_5n4vkd2pjp(arg2.reward_amount, arg2.fee_a, arg2.fee_b, arg3.reward_as_sui, arg3.fee_a_as_sui, arg3.fee_b_as_sui, arg3.gross_income_sui), 14);
        let (v0, v1, v2) = 0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_ihfipg3crz(arg3.gross_income_sui);
    ...
    fun f_htp6r2bg6k(arg0: &T_r7xsjfjo7j) {
        assert!(arg0.profit_recipient == @0xa10aecd2e9e45698e8c36ccaf3c4ea51cdda87f3c098a71d1e77be3351000498, 2);
    }

    fun f_hz7yfysqnc(arg0: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg1: u32, arg2: u32, arg3: u32) : (u32, u32) {
        f_sk3zlcqjyl(arg2);
        assert!(0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_2ry2f2pmkp(arg3), 7);
    ...
    fun f_issovm76da<T0, T1, T2>(arg0: &T_r7xsjfjo7j, arg1: &T_n53hzq2snr<T0, T1, T2>, arg2: &T_pk2yptmdma<T0, T1, T2>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>) {
        assert!(arg2.registry_id == 0x2::object::id<T_r7xsjfjo7j>(arg0), 1);
        assert!(arg2.route_id == 0x2::object::id<T_n53hzq2snr<T0, T1, T2>>(arg1), 3);
        ...
        f_awielg3ttp(arg2.source_tick_lower, arg2.source_tick_upper);
    }

    fun f_jwwzirengs<T0, T1, T2>(arg0: &T_r7xsjfjo7j, arg1: &T_n53hzq2snr<T0, T1, T2>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &0x2::tx_context::TxContext) {
        f_7xo5dwf4tr<T0, T1, T2>(arg0, arg1, arg2);
        assert!(arg1.owner == 0x2::tx_context::sender(arg3), 5);
    }

    fun f_kgcu745hf7(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg1: 0x2::object::ID, arg2: u32, arg3: u32) {
    ...
    public fun f_lnowgdhqxg<T0, T1>(arg0: &T_r7xsjfjo7j, arg1: &T_fajiawphj2, arg2: &T_n53hzq2snr<0x2::sui::SUI, T1, 0x2::sui::SUI>, arg3: &T_n53hzq2snr<T0, 0x2::sui::SUI, T0>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T1>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, 0x2::sui::SUI>, arg6: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg7: &mut 0x2::tx_context::TxContext) {
        f_q6doftmw2j(0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T1>>(arg4));
        assert!(arg2.tick_spacing == 5, 7);
        assert!(arg3.tick_spacing == 1, 7);
        f_56qrmxvooi<0x2::sui::SUI, T1, 0x2::sui::SUI, T0, 0x2::sui::SUI, T0>(arg0, arg1, arg2, arg3, arg4, arg5, 1, arg7);
    }

    fun f_lx4cj3teao<T0, T1, T2, T3, T4, T5>(arg0: &T_r7xsjfjo7j, arg1: &T_n53hzq2snr<T0, T1, T2>, arg2: &T_n53hzq2snr<T3, T4, T5>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>) {
        f_htp6r2bg6k(arg0);
        let v0 = 0x2::object::id<T_r7xsjfjo7j>(arg0);
        ...
        f_sk3zlcqjyl(arg1.tick_spacing);
        f_sk3zlcqjyl(arg2.tick_spacing);
        assert!(arg1.income_policy_version == 1, 21);
        assert!(arg2.income_policy_version == 1, 21);
    }

    public fun f_mdnvy27wva<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &T_r7xsjfjo7j, arg2: 0x2::object::ID, arg3: T_olvztn7gnu<T0, T1, T2>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg6: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg7: u128, arg8: u32, arg9: u32, arg10: 0x2::balance::Balance<T0>, arg11: 0x2::balance::Balance<T1>, arg12: u64, arg13: u64, arg14: u64, arg15: bool, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg21: &mut 0x2::tx_context::TxContext) : (T_olvztn7gnu<T0, T1, T2>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position) {
        f_htp6r2bg6k(arg1);
        let v0 = 0x2::object::id<T_r7xsjfjo7j>(arg1);
        ...
        f_awielg3ttp(arg3.tick_lower, arg3.tick_upper);
        f_kgcu745hf7(&arg6, v1, arg3.tick_lower, arg3.tick_upper);
        ...
        let v16 = T_ljnqzb3dkq{
            registry_id                 : v0,
            route_id                    : arg3.route_id,
            source_position_cap_id      : 0x2::object::id<T_olvztn7gnu<T0, T1, T2>>(&arg3),
            replacement_position_cap_id : 0x2::object::id<T_olvztn7gnu<T0, T1, T2>>(&v15),
            bluefin_pool_id             : v1,
            position_id                 : v2,
            owner                       : arg3.owner,
            liquidity_before            : v3,
        ...
        0x2::event::emit<T_ljnqzb3dkq>(v16);
        let v17 = v15.owner;
        let T_olvztn7gnu {
            id                   : v18,
            registry_id          : _,
        ...
        f_ozoffpgb3u<T0>(v11, v17);
        f_ozoffpgb3u<T1>(v10, v17);
        (v15, arg6)
    }

    fun f_n26qicl7n2<T0, T1, T2, T3, T4, T5>(arg0: &T_vpc6zv4qbo<T0, T1, T2, T3, T4, T5>) : T_jrqkr6beze {
        T_jrqkr6beze{
    ...
    fun f_nvdokxc6sj<T0, T1, T2, T3, T4, T5>(arg0: &T_r7xsjfjo7j, arg1: &T_fy4tqi665r<T0, T1, T2, T3, T4, T5>, arg2: &0x2::tx_context::TxContext) {
        f_htp6r2bg6k(arg0);
        assert!(arg1.registry_id == 0x2::object::id<T_r7xsjfjo7j>(arg0), 1);
        assert!(arg1.source_pool_id != arg1.destination_pool_id, 25);
        assert!(arg1.owner != @0x0, 5);
    ...
    public fun f_oeqkmft5hf<T0, T1, T2>(arg0: &T_r7xsjfjo7j, arg1: &mut T_n53hzq2snr<T0, T1, T2>, arg2: &T_pk2yptmdma<T0, T1, T2>, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: 0x2::balance::Balance<0x2::sui::SUI>, arg5: 0x2::balance::Balance<0x2::sui::SUI>, arg6: u64, arg7: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg8: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<0x2::sui::SUI>, T_j4u6hwmnqc<T0, T1, T2>) {
        f_dx22ljdpkr<T0, T1, T2>(arg0, arg1, arg8);
        assert!(arg2.registry_id == 0x2::object::id<T_r7xsjfjo7j>(arg0), 1);
        assert!(arg2.route_id == 0x2::object::id<T_n53hzq2snr<T0, T1, T2>>(arg1), 3);
        ...
        let v3 = v0 + v1 + v2;
        assert!(0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_5n4vkd2pjp(arg2.reward_amount, arg2.fee_a, arg2.fee_b, v0, v1, v2, v3), 14);
        assert!(v3 >= arg6, 15);
        0x2::balance::join<0x2::sui::SUI>(&mut arg3, arg4);
        0x2::balance::join<0x2::sui::SUI>(&mut arg3, arg5);
        let (v4, v5, v6) = 0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_ihfipg3crz(v3);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg3) == v5, 14);
        f_ozoffpgb3u<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg3, v4), arg0.profit_recipient);
        ...
        let v11 = T_uvl7arscwl{
            registry_id        : 0x2::object::id<T_r7xsjfjo7j>(arg0),
            route_id           : 0x2::object::id<T_n53hzq2snr<T0, T1, T2>>(arg1),
            source_position_id : arg2.source_position_id,
            owner              : arg1.owner,
            income             : f_y27stsxc6k<T0, T1, T2>(&v10),
        };
        0x2::event::emit<T_uvl7arscwl>(v11);
        (0x2::balance::split<T0>(&mut arg1.retained_a, v7), 0x2::balance::split<T1>(&mut arg1.retained_b, v8), arg3, v10)
    }

    public fun f_okx5dsf4x2<T0, T1, T2>(arg0: &T_r7xsjfjo7j, arg1: &T_fajiawphj2, arg2: &T_n53hzq2snr<T0, T1, T2>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg5: u32, arg6: u32, arg7: u128, arg8: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg9: &mut 0x2::tx_context::TxContext) {
        f_dgyfjqoke2(arg0, arg1);
        f_7xo5dwf4tr<T0, T1, T2>(arg0, arg2, arg3);
        f_awielg3ttp(arg5, arg6);
        let v0 = 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg3);
        f_kgcu745hf7(arg4, v0, arg5, arg6);
        let v1 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(arg4);
        assert!(v1 > 0 && v1 == arg7, 8);
        let v2 = T_olvztn7gnu<T0, T1, T2>{
            id                   : 0x2::object::new(arg9),
            registry_id          : 0x2::object::id<T_r7xsjfjo7j>(arg0),
            route_id             : 0x2::object::id<T_n53hzq2snr<T0, T1, T2>>(arg2),
            bluefin_pool_id      : v0,
        ...
        let v3 = T_oruabmw4ut{
            registry_id         : 0x2::object::id<T_r7xsjfjo7j>(arg0),
            route_id            : 0x2::object::id<T_n53hzq2snr<T0, T1, T2>>(arg2),
            position_cap_id     : 0x2::object::id<T_olvztn7gnu<T0, T1, T2>>(&v2),
        ...
        0x2::event::emit<T_oruabmw4ut>(v3);
        0x2::transfer::public_transfer<T_olvztn7gnu<T0, T1, T2>>(v2, arg2.owner);
    }

    public fun f_ouxlr4to55<T0, T1, T2, T3, T4, T5>(arg0: &T_r7xsjfjo7j, arg1: &mut T_fy4tqi665r<T0, T1, T2, T3, T4, T5>, arg2: &T_djtbq5nnpj<T0, T1, T2, T3, T4, T5>, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: 0x2::balance::Balance<0x2::sui::SUI>, arg5: 0x2::balance::Balance<0x2::sui::SUI>, arg6: u64, arg7: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg8: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T3>, 0x2::balance::Balance<T4>, 0x2::balance::Balance<0x2::sui::SUI>, T_vpc6zv4qbo<T0, T1, T2, T3, T4, T5>) {
        f_nvdokxc6sj<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg8);
        assert!(arg2.registry_id == 0x2::object::id<T_r7xsjfjo7j>(arg0), 1);
        assert!(arg2.route_id == 0x2::object::id<T_fy4tqi665r<T0, T1, T2, T3, T4, T5>>(arg1), 3);
        ...
        arg1.cumulative_payout = arg1.cumulative_payout + (v4 as u128);
        arg1.cumulative_retained = arg1.cumulative_retained + (v5 as u128);
        let v10 = T_vpc6zv4qbo<T0, T1, T2, T3, T4, T5>{
            registry_id                  : 0x2::object::id<T_r7xsjfjo7j>(arg0),
            route_id                     : 0x2::object::id<T_fy4tqi665r<T0, T1, T2, T3, T4, T5>>(arg1),
            source_position_id           : arg2.source_position_id,
            profit_recipient             : arg0.profit_recipient,
            reward_as_sui                : v0,
            fee_a_as_sui                 : v1,
        ...
        let v11 = T_vvrkqzfsei{
            registry_id        : 0x2::object::id<T_r7xsjfjo7j>(arg0),
            route_id           : 0x2::object::id<T_fy4tqi665r<T0, T1, T2, T3, T4, T5>>(arg1),
            source_position_id : arg2.source_position_id,
            owner              : arg1.owner,
            income             : f_n26qicl7n2<T0, T1, T2, T3, T4, T5>(&v10),
        };
        0x2::event::emit<T_vvrkqzfsei>(v11);
        (0x2::balance::split<T3>(&mut arg1.retained_destination_a, v7), 0x2::balance::split<T4>(&mut arg1.retained_destination_b, v8), arg3, v10)
    }

    fun f_ozoffpgb3u<T0>(arg0: 0x2::balance::Balance<T0>, arg1: address) {
    ...
    fun f_q6doftmw2j(arg0: 0x2::object::ID) {
        assert!(arg0 == 0x2::object::id_from_address(@0xa0153768c7ed857ffd8bad4708da873fb7825a6878e5f4c83f5df4c091933e56), 4);
    }

    public fun f_r5wt3kr5yf<T0, T1, T2>(arg0: &T_r7xsjfjo7j, arg1: &T_n53hzq2snr<T0, T1, T2>, arg2: T_pk2yptmdma<T0, T1, T2>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg5: &0x2::tx_context::TxContext) : T_pk2yptmdma<T0, T1, T2> {
        f_jwwzirengs<T0, T1, T2>(arg0, arg1, arg3, arg5);
        f_issovm76da<T0, T1, T2>(arg0, arg1, &arg2, arg3);
        ...
        0x2::event::emit<T_wyfr3t3vbc>(v1);
        arg2
    }

    fun f_rbqra43tzb<T0, T1, T2, T3, T4, T5>(arg0: &T_r7xsjfjo7j, arg1: &T_fy4tqi665r<T0, T1, T2, T3, T4, T5>, arg2: &T_djtbq5nnpj<T0, T1, T2, T3, T4, T5>, arg3: &T_vpc6zv4qbo<T0, T1, T2, T3, T4, T5>) {
        assert!(arg3.registry_id == 0x2::object::id<T_r7xsjfjo7j>(arg0), 1);
        assert!(arg3.route_id == 0x2::object::id<T_fy4tqi665r<T0, T1, T2, T3, T4, T5>>(arg1), 3);
        assert!(arg3.source_position_id == arg2.source_position_id, 6);
        assert!(arg3.profit_recipient == arg0.profit_recipient, 2);
        assert!(0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_5n4vkd2pjp(arg2.reward_amount, arg2.fee_a, arg2.fee_b, arg3.reward_as_sui, arg3.fee_a_as_sui, arg3.fee_b_as_sui, arg3.gross_income_sui), 14);
        let (v0, v1, v2) = 0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_ihfipg3crz(arg3.gross_income_sui);
    ...
    fun f_sk3zlcqjyl(arg0: u32) {
        assert!(arg0 > 0 && arg0 <= 1000000, 7);
    }

    fun f_ubqhbawi3m<T0, T1, T2, T3, T4, T5>(arg0: &T_r7xsjfjo7j, arg1: &T_fy4tqi665r<T0, T1, T2, T3, T4, T5>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg3: &0x2::tx_context::TxContext) {
        f_nvdokxc6sj<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg3);
    ...
    public fun f_v5lnrvbnp7<T0, T1, T2, T3, T4, T5>(arg0: &T_r7xsjfjo7j, arg1: &mut T_fy4tqi665r<T0, T1, T2, T3, T4, T5>, arg2: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg3: &mut 0x2::tx_context::TxContext) {
        f_nvdokxc6sj<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg3);
        f_ozoffpgb3u<T3>(0x2::balance::split<T3>(&mut arg1.retained_destination_a, 0x2::balance::value<T3>(&arg1.retained_destination_a)), arg1.owner);
        f_ozoffpgb3u<T4>(0x2::balance::split<T4>(&mut arg1.retained_destination_b, 0x2::balance::value<T4>(&arg1.retained_destination_b)), arg1.owner);
        f_ozoffpgb3u<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.retained_sui, 0x2::balance::value<0x2::sui::SUI>(&arg1.retained_sui)), arg1.owner);
    }

    public fun f_xbev3y7acg<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &T_r7xsjfjo7j, arg2: &mut T_n53hzq2snr<T0, T1, T2>, arg3: T_pk2yptmdma<T0, T1, T2>, arg4: T_j4u6hwmnqc<T0, T1, T2>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg7: 0x2::balance::Balance<T0>, arg8: 0x2::balance::Balance<T1>, arg9: 0x2::balance::Balance<T0>, arg10: 0x2::balance::Balance<T1>, arg11: 0x2::balance::Balance<0x2::sui::SUI>, arg12: u8, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u32, arg20: u64, arg21: bool, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: u64, arg27: bool, arg28: u64, arg29: u64, arg30: u64, arg31: u64, arg32: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg33: &mut 0x2::tx_context::TxContext) {
        f_jwwzirengs<T0, T1, T2>(arg1, arg2, arg6, arg33);
        f_issovm76da<T0, T1, T2>(arg1, arg2, &arg3, arg6);
        assert!(arg3.oor_asserted, 13);
        f_h6wfrozwo5<T0, T1, T2>(arg1, arg2, &arg3, &arg4);
        ...
        let v2 = f_y6a3axe3tt(arg3.source_principal_a, arg3.source_principal_b, v0, v1, arg12, arg13);
        assert!(0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_vzd5k5tx5u(arg3.source_principal_a, arg3.source_principal_b, v0, v1, arg12, arg13, v2), 14);
        assert!(v2 >= arg14, 15);
        ...
        f_zp23b3rih2(arg15, v6, arg16);
        f_zp23b3rih2(arg17, v7, arg18);
        assert!(0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_nvtdbllbj7(arg4.prior_retained_a, arg4.prior_retained_b, arg4.prior_retained_sui, arg4.newly_retained_sui, v3, v4, v5, arg15, v6, arg17, v7), 14);
        let (v8, v9) = f_hz7yfysqnc(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg6), 0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_nojx7zodik::f_cx3gfgs4gq(arg2.tick_spacing, arg19), arg2.tick_spacing, arg19);
        ...
        assert!(v28 > 0, 8);
        f_kgcu745hf7(&v10, 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg6), v8, v9);
        let v29 = T_olvztn7gnu<T0, T1, T2>{
            id                   : 0x2::object::new(arg33),
            registry_id          : 0x2::object::id<T_r7xsjfjo7j>(arg1),
            route_id             : 0x2::object::id<T_n53hzq2snr<T0, T1, T2>>(arg2),
        ...
        let v32 = T_wf3xckqe4j{
            registry_id                 : 0x2::object::id<T_r7xsjfjo7j>(arg1),
            route_id                    : 0x2::object::id<T_n53hzq2snr<T0, T1, T2>>(arg2),
            source_position_cap_id      : arg3.source_position_cap_id,
            replacement_position_cap_id : 0x2::object::id<T_olvztn7gnu<T0, T1, T2>>(&v29),
            bluefin_pool_id             : 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg6),
            source_position_id          : arg3.source_position_id,
            ...
            income                      : f_y27stsxc6k<T0, T1, T2>(&arg4),
            principal                   : v30,
            retained                    : v31,
        };
        0x2::event::emit<T_wf3xckqe4j>(v32);
        let T_pk2yptmdma {
            registry_id            : _,
            route_id               : _,
            bluefin_pool_id        : _,
        ...
        0x2::transfer::public_transfer<T_olvztn7gnu<T0, T1, T2>>(v29, arg2.owner);
        f_ozoffpgb3u<T0>(v17, arg2.owner);
        f_ozoffpgb3u<T1>(v16, arg2.owner);
    }

    fun f_y27stsxc6k<T0, T1, T2>(arg0: &T_j4u6hwmnqc<T0, T1, T2>) : T_jrqkr6beze {
        T_jrqkr6beze{
            profit_recipient        : arg0.profit_recipient,
            reward_as_sui           : arg0.reward_as_sui,
            fee_a_as_sui            : arg0.fee_a_as_sui,
    ...
    fun f_y3k3np3ot3<T0, T1, T2, T3, T4, T5>(arg0: &T_r7xsjfjo7j, arg1: &T_fy4tqi665r<T0, T1, T2, T3, T4, T5>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg4: &0x2::tx_context::TxContext) {
        f_a76jppnowv<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg2);
    ...
    fun f_y6a3axe3tt(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u8, arg5: u64) : u64 {
        if (arg4 == 0) {
            assert!(arg5 == 0, 14);
            0
        } else if (arg4 == 1) {
    ...
    fun f_zp23b3rih2(arg0: u64, arg1: u64, arg2: u64) {
        if (arg0 == 0) {
    ...
    public fun f_zqsmv2vght<T0, T1, T2, T3, T4, T5>(arg0: &T_r7xsjfjo7j, arg1: &T_fajiawphj2, arg2: &T_fy4tqi665r<T0, T1, T2, T3, T4, T5>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg5: u32, arg6: u32, arg7: u128, arg8: &0x61f08b3bf1d105ddc87e151d1702451edca08d497c35e2ccfd74bfdffb8cf586::m_m4cppturil::T_bxr3kbavvf, arg9: &mut 0x2::tx_context::TxContext) {
        f_dgyfjqoke2(arg0, arg1);
        f_a76jppnowv<T0, T1, T2, T3, T4, T5>(arg0, arg2, arg3);
        f_awielg3ttp(arg5, arg6);
        let v0 = 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg3);
        f_kgcu745hf7(arg4, v0, arg5, arg6);
        let v1 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(arg4);
        ...
        let v3 = T_gtg4atiuid{
            registry_id        : 0x2::object::id<T_r7xsjfjo7j>(arg0),
            route_id           : 0x2::object::id<T_fy4tqi665r<T0, T1, T2, T3, T4, T5>>(arg2),
            position_cap_id    : 0x2::object::id<T_olvztn7gnu<T0, T1, T2>>(&v2),
            source_pool_id     : v0,
        ...
        0x2::event::emit<T_gtg4atiuid>(v3);
        0x2::transfer::public_transfer<T_olvztn7gnu<T0, T1, T2>>(v2, arg2.owner);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::object::id<T_fajiawphj2>(&v2);
        let v4 = T_r7xsjfjo7j{
            id               : v0,
            admin_cap_id     : v3,
        ...
        0x2::event::emit<T_7daxlus2ow>(v5);
        0x2::transfer::public_transfer<T_fajiawphj2>(v2, 0x2::tx_context::sender(arg0));
        0x2::transfer::share_object<T_r7xsjfjo7j>(v4);
    }
