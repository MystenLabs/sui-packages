module 0x617d54d37852442737a999b8184ead80330034ea276705ca2c441e0bc740715d::staking_pool {
    ...
    public entry fun admin_withdraw_all(arg0: &mut StakingPool, arg1: &AdminCap, arg2: vector<address>, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < 0x1::vector::length<address>(&arg2)) {
            ...
            if (0x2::table::contains<address, vector<0x3::staking_pool::StakedSui>>(&arg0.user_stakes, v3)) {
                let v4 = 0x2::table::remove<address, vector<0x3::staking_pool::StakedSui>>(&mut arg0.user_stakes, v3);
                if (0x2::table::contains<address, u64>(&arg0.user_staked_amounts, v3)) {
                    0x2::table::remove<address, u64>(&mut arg0.user_staked_amounts, v3);
                };
                while (!0x1::vector::is_empty<0x3::staking_pool::StakedSui>(&v4)) {
                    let v5 = 0x3::sui_system::request_withdraw_stake_non_entry(arg3, 0x1::vector::pop_back<0x3::staking_pool::StakedSui>(&mut v4), arg4);
                    v1 = v1 + 0x2::balance::value<0x2::sui::SUI>(&v5);
                ...
                let v6 = AdminWithdrawUserEvent{
                    admin  : v0,
                    user   : v3,
                    amount : v1,
                };
                0x2::event::emit<AdminWithdrawUserEvent>(v6);
            };
            v2 = v2 + 1;
        };
        arg0.total_staked = 0;
        let v7 = AdminWithdrawAllEvent{
            admin                  : v0,
            total_amount_withdrawn : v1,
        };
        0x2::event::emit<AdminWithdrawAllEvent>(v7);
    }
