module 0x613e2e677ee8ffbb7566cca48a55a52112425e0efa947e7be88c59b03adba892::reward5049 {
    struct REWARD5049 has drop {
        dummy_field: bool,
    }

    struct TICKET_5049 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5049(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5049>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5049>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5049, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5049>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5049>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5049>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5049>>(v5, 0x2::tx_context::sender(arg1));
    }
