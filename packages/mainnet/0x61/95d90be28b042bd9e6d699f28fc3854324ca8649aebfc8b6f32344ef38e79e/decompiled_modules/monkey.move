module 0x6195d90be28b042bd9e6d699f28fc3854324ca8649aebfc8b6f32344ef38e79e::monkey {
    struct MONKEY has drop {
        dummy_field: bool,
    }

    fun init(arg0: MONKEY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MONKEY>(arg0, 6, b"MONKEY", b"Monkey on SUI", b"Join me, and lets throw it all on the line! Gamble your life savings against some shiny golden bananas! Who knows, maybe you'll swing out richer...", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/GAA_Qrk2_U_400x400_6d16c274b3.jpg")), arg1);
