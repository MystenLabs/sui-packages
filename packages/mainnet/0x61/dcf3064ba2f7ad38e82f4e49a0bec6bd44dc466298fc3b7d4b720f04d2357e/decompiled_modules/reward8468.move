module 0x61dcf3064ba2f7ad38e82f4e49a0bec6bd44dc466298fc3b7d4b720f04d2357e::reward8468 {
    struct REWARD8468 has drop {
        dummy_field: bool,
    }

    struct TICKET_8468 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8468(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8468>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8468>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8468, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8468>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8468>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8468>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8468>>(v5, 0x2::tx_context::sender(arg1));
    }
