module 0x612dec342d4986236a2f3f53eabc65462414ebd82d40ba29fb0590fa04a6e6d1::dex_turbos {
    ...
    public fun get_turbos_package() : address {
        0x612dec342d4986236a2f3f53eabc65462414ebd82d40ba29fb0590fa04a6e6d1::constants::turbos_package()
    }
    ...
    public fun is_turbos_operational() : bool {
        0x612dec342d4986236a2f3f53eabc65462414ebd82d40ba29fb0590fa04a6e6d1::constants::turbos_package() != @0x0
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = TurbosSwapExecuted{
            ...
            package        : 0x612dec342d4986236a2f3f53eabc65462414ebd82d40ba29fb0590fa04a6e6d1::constants::turbos_package(),
