module 0x611736b7a9634052527dbb17f047c0a3baa2e18406d52e7562285097504eb1b9::reward1635 {
    struct REWARD1635 has drop {
        dummy_field: bool,
    }

    struct TICKET_1635 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1635(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1635>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1635>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1635, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1635>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1635>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1635>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1635>>(v5, 0x2::tx_context::sender(arg1));
    }
