module 0x612ef5743c036c205ef71d0517447dd28162b1327664e8cb73e4ca5c1ffc12bd::reward2596 {
    struct REWARD2596 has drop {
        dummy_field: bool,
    }

    struct TICKET_2596 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2596(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2596>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2596>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2596, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2596>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2596>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2596>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2596>>(v5, 0x2::tx_context::sender(arg1));
    }
