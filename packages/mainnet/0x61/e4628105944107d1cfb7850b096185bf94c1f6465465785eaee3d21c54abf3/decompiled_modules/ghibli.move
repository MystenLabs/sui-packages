module 0x61e4628105944107d1cfb7850b096185bf94c1f6465465785eaee3d21c54abf3::ghibli {
    ...
    fun init(arg0: GHIBLI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/bsc/0x795d2710e383f33fbebe980a155b29757b6703f3.png?size=lg&key=84ad68                                                                                                                                                                                                                 ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<GHIBLI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Ghibli  ")))), trim_right(b"GhibliCZ                        "), trim_right(b"CZ in studio ghibli style                                                                                                                                                                                                                                                                                                       "), v2, arg1);
        let v5 = v3;
