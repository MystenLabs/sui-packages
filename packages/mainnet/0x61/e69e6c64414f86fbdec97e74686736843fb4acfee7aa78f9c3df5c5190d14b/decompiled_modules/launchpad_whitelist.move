module 0x61e69e6c64414f86fbdec97e74686736843fb4acfee7aa78f9c3df5c5190d14b::launchpad_whitelist {
    ...
    public entry fun check_whitelist(arg0: &Activity, arg1: vector<vector<u8>>, arg2: &0x2::tx_context::TxContext) : bool {
        0x61e69e6c64414f86fbdec97e74686736843fb4acfee7aa78f9c3df5c5190d14b::merkle_proof::verify(arg1, arg0.root, 0x1::hash::sha3_256(0x2::address::to_bytes(0x2::tx_context::sender(arg2))))
    }
    ...
    public(friend) fun create_activity(arg0: &mut ActivityList, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x61e69e6c64414f86fbdec97e74686736843fb4acfee7aa78f9c3df5c5190d14b::launchpad_event::activity_created_event(0x2::object::id<Activity>(&v1), arg1, arg2, v0);
