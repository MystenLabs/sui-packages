module 0x61b3ffea1f30bbe8d940d3c9462c0dc9e5013588d49ba184aeaf1ef7434d6e3f::utils {
    public fun get_description_nft() : vector<u8> {
        b"Unleash the Power of AlphahorseNFT: Race, Win, and Make Real-Time Money!"
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeidmgjxculdw4x6zcl3i2i6vlfoku643zlwy6e65fp4sj62a7nmoja/"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeiajebcdpxkx3pirgclxoqon5kw7pcpgkobipv2cmdhrkqzwb4ic5u/"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/alphahorsenft"
    }
