module 0x6148676cc36b2933ec8aa8f7bb81b6f56ff1f6c3292f23d93c5c1f5a16f593a1::reward9771 {
    struct REWARD9771 has drop {
        dummy_field: bool,
    }

    struct TICKET_9771 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9771(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9771>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9771>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9771, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9771>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9771>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9771>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9771>>(v5, 0x2::tx_context::sender(arg1));
    }
