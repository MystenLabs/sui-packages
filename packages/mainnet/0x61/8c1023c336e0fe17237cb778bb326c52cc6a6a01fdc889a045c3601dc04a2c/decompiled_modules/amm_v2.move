module 0x618c1023c336e0fe17237cb778bb326c52cc6a6a01fdc889a045c3601dc04a2c::amm_v2 {
    ...
    fun calculate_lp_mint_amount(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u128) : u64 {
        if (arg0 == 0) {
            let v1 = (0x1::u64::sqrt(arg1) as u128) * (0x1::u64::sqrt(arg2) as u128);
            if (v1 > 0) {
                let v2 = if (v1 < 1000) {
                    1000
                } else {
            ...
            let v4 = arg4 + arg6;
            let v5 = if (v3 > 0) {
                (arg1 as u128) * (arg0 as u128) / (v3 as u128)
            } else {
                0
            };
            let v6 = if (v4 > 0) {
                (arg2 as u128) * (arg0 as u128) / (v4 as u128)
            } else {
                0
            };
            let v7 = if (v5 < v6) {
