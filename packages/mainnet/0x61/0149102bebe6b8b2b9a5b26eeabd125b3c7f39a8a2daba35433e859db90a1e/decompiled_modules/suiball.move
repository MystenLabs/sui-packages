module 0x610149102bebe6b8b2b9a5b26eeabd125b3c7f39a8a2daba35433e859db90a1e::suiball {
    ...
    public(friend) fun mint(arg0: &mut 0x610149102bebe6b8b2b9a5b26eeabd125b3c7f39a8a2daba35433e859db90a1e::registry::Registry, arg1: &mut 0x2::tx_context::TxContext) : Suiball {
        let v0 = 0x610149102bebe6b8b2b9a5b26eeabd125b3c7f39a8a2daba35433e859db90a1e::registry::mint_data(arg0);
        let v1 = 0x610149102bebe6b8b2b9a5b26eeabd125b3c7f39a8a2daba35433e859db90a1e::registry::total_supply(arg0);
        let v2 = Suiball{
            id            : 0x2::object::new(arg1),
            serial_number : v1,
            description   : 0x610149102bebe6b8b2b9a5b26eeabd125b3c7f39a8a2daba35433e859db90a1e::registry::description(v0),
            image_url     : 0x610149102bebe6b8b2b9a5b26eeabd125b3c7f39a8a2daba35433e859db90a1e::registry::image_url(v0),
            video_url     : 0x610149102bebe6b8b2b9a5b26eeabd125b3c7f39a8a2daba35433e859db90a1e::registry::video_url(v0),
            creator       : 0x610149102bebe6b8b2b9a5b26eeabd125b3c7f39a8a2daba35433e859db90a1e::registry::creator(v0),
            attributes    : 0x610149102bebe6b8b2b9a5b26eeabd125b3c7f39a8a2daba35433e859db90a1e::registry::attributes(v0),
        };
        let v3 = Mint{
