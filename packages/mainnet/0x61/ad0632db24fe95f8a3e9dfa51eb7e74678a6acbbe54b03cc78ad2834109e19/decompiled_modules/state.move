module 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::state {
    ...
    public fun solve_one_for_zero(arg0: &SwapState) : u256 {
        ...
        let v3 = v2 - v1 * 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::constants::max_fee_pips_u256() / v0 * arg0.sqrt_ratio_upper;
        let v4 = 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::safe_math::mul_div_Q64(arg0.liquidity, arg0.sqrt_price * 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::constants::max_fee_pips_u256() / v0);
        let v5 = arg0.amount_y_desired + v4 - 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::safe_math::mul_div_Q64(arg0.liquidity, arg0.sqrt_ratio_lower);
        assert!(v5 > arg0.amount_y_desired, 0);
        let v6 = 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::safe_math::mul_div_Q64(v2, arg0.sqrt_ratio_lower) - arg0.fee_pips * arg0.liquidity / v0 - (v4 << 64) / arg0.sqrt_ratio_upper;
        0x1::u256::max((v6 + 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::safe_math::sqrt(v6 * v6 + 4 * v3 * v5) << 64) / 2 * v3, arg0.sqrt_price)
    }
    ...
    public fun solve_zero_for_one(arg0: &SwapState) : u256 {
        ...
        let v5 = 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::safe_math::mul_div_Q64(v2, arg0.sqrt_ratio_lower) + arg0.fee_pips * arg0.liquidity / v0 - (v4 << 64) / arg0.sqrt_ratio_upper;
