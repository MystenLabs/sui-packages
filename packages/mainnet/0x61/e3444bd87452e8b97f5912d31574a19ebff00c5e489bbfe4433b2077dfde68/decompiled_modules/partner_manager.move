module 0x731db3683fcd23f2dd1f45bf8ea4b6605b386391c9a378719aa52d82e46203c5::partner_manager {
    ...
    public(friend) fun collect_commission_if_necessary<T0>(arg0: &mut PartnerRegistry, arg1: &mut 0x2::coin::Coin<T0>, arg2: address, arg3: u8, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (arg3 == 0x731db3683fcd23f2dd1f45bf8ea4b6605b386391c9a378719aa52d82e46203c5::commission_type::flat()) {
            if (arg4 > 0x731db3683fcd23f2dd1f45bf8ea4b6605b386391c9a378719aa52d82e46203c5::math::mul_div(0x2::coin::value<T0>(arg1), arg0.max_comission_percentage, 1000000)) {
                abort 1
            };
            arg4
        } else {
            0x731db3683fcd23f2dd1f45bf8ea4b6605b386391c9a378719aa52d82e46203c5::math::mul_div(0x2::coin::value<T0>(arg1), arg4, 1000000)
        };
        collect<T0>(v0, 0x2::coin::split<T0>(arg1, v1, arg5), arg5);
    }

    public entry fun config_max_comission_percentage(arg0: &0x731db3683fcd23f2dd1f45bf8ea4b6605b386391c9a378719aa52d82e46203c5::admin_cap::AdminCap, arg1: &mut PartnerRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
