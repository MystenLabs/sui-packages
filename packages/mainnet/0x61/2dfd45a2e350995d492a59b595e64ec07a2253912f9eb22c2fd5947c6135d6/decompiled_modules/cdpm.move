module 0x612dfd45a2e350995d492a59b595e64ec07a2253912f9eb22c2fd5947c6135d6::cdpm {
    ...
    struct AgentPositionCreated has copy, drop {
        pm_id: 0x2::object::ID,
        pool_id: 0x2::object::ID,
        lower_bin_id: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32,
        upper_bin_id: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32,
    ...
    struct AgentPositionDestroyed has copy, drop {
        pm_id: 0x2::object::ID,
        pool_id: 0x2::object::ID,
    ...
    struct AdminAssetReturned has copy, drop {
        pm_id: 0x2::object::ID,
        coin_type: 0x1::ascii::String,
        amount: u64,
        to: address,
    ...
    struct AdminPositionReturned has copy, drop {
        pm_id: 0x2::object::ID,
        to: address,
    }

    struct RecordEntryRemoved has copy, drop {
        record_id: 0x2::object::ID,
        pm_id: 0x2::object::ID,
    }
    ...
    fun add_liquidity_private<T0, T1>(arg0: &mut PositionManager, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut 0x2::coin::Coin<T1>, arg4: vector<u32>, arg5: vector<u64>, arg6: vector<u64>, arg7: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg8: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        assert!(0x1::option::is_some<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&arg0.position), 1011);
        ...
        let v1 = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::add_liquidity<T0, T1>(arg1, v0, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
        let (v2, v3) = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::amounts<T0, T1>(&v1);
        0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::repay_add_liquidity<T0, T1>(arg1, v0, v1, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg2, v2, arg10)), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(arg3, v3, arg10)), arg8);
        (v2, v3)
    }
    ...
    public fun admin_force_close_pm(arg0: &AdminCap, arg1: PositionManager) {
        assert!(0x1::option::is_none<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&arg1.position), 1013);
        ...
        0x1::option::destroy_none<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(v4);
        0x2::bag::destroy_empty(v5);
        0x2::bag::destroy_empty(v6);
        0x2::bag::destroy_empty(v7);
        0x2::object::delete(v0);
        let v8 = PositionManagerClosed{
            pm_id : 0x2::object::id<PositionManager>(&arg1),
            owner : v1,
        };
        0x2::event::emit<PositionManagerClosed>(v8);
    }

    public fun admin_force_return_balance<T0>(arg0: &AdminCap, arg1: &mut PositionManager, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>());
        assert!(0x2::bag::contains_with_type<0x1::ascii::String, 0x2::balance::Balance<T0>>(&arg1.balance, v0), 1006);
        let v1 = 0x2::coin::from_balance<T0>(0x2::bag::remove<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut arg1.balance, v0), arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v1, arg1.owner);
        let v2 = AdminAssetReturned{
            pm_id     : 0x2::object::id<PositionManager>(arg1),
            coin_type : v0,
            amount    : 0x2::coin::value<T0>(&v1),
            to        : arg1.owner,
        };
        0x2::event::emit<AdminAssetReturned>(v2);
    }

    public fun admin_force_return_fee<T0>(arg0: &AdminCap, arg1: &mut PositionManager, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>());
        assert!(0x2::bag::contains_with_type<0x1::ascii::String, 0x2::balance::Balance<T0>>(&arg1.fee, v0), 1006);
        let v1 = 0x2::coin::from_balance<T0>(0x2::bag::remove<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut arg1.fee, v0), arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v1, arg1.owner);
        let v2 = AdminAssetReturned{
            pm_id     : 0x2::object::id<PositionManager>(arg1),
    ...
    public fun admin_force_return_kai<T0, T1, T2>(arg0: &AdminCap, arg1: &mut PositionManager, arg2: &mut FeeHouse, arg3: &mut 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::Vault<T0, T2>, arg4: &mut 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::kai_leverage_supply_pool::Strategy<T0, T1>, arg5: &mut 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool::SupplyPool<T0, T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T2>());
        assert!(0x2::bag::contains_with_type<0x1::ascii::String, KaiVault<T0, T2>>(&arg1.lending, v0), 1005);
        let KaiVault {
            yt_balance : v1,
            principal  : v2,
        } = 0x2::bag::remove<0x1::ascii::String, KaiVault<T0, T2>>(&mut arg1.lending, v0);
        let v3 = 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault::withdraw<T0, T2>(arg3, v1, arg6);
        0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::kai_leverage_supply_pool::withdraw<T0, T1, T2>(arg4, &mut v3, arg5, arg6);
        ...
        if (v5 > v2) {
            let v6 = ((((v5 - v2) as u128) * (arg2.fee_rate as u128) / 10000) as u64);
            if (v6 > 0) {
                deposit_into_fee_house<T0>(arg2, 0x2::balance::split<T0>(&mut v4, v6));
            };
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v4, arg7), arg1.owner);
        let v7 = AdminAssetReturned{
            pm_id     : 0x2::object::id<PositionManager>(arg1),
            coin_type : 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()),
            amount    : 0x2::balance::value<T0>(&v4),
            to        : arg1.owner,
        };
        0x2::event::emit<AdminAssetReturned>(v7);
    }

    public fun admin_force_return_position(arg0: &AdminCap, arg1: &mut PositionManager) {
        assert!(0x1::option::is_some<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&arg1.position), 1011);
        0x2::transfer::public_transfer<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(0x1::option::extract<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&mut arg1.position), arg1.owner);
        let v0 = AdminPositionReturned{
            pm_id : 0x2::object::id<PositionManager>(arg1),
            to    : arg1.owner,
        };
        0x2::event::emit<AdminPositionReturned>(v0);
    }

    public fun admin_force_return_scallop<T0>(arg0: &AdminCap, arg1: &mut PositionManager, arg2: &mut FeeHouse, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>());
        assert!(0x2::bag::contains_with_type<0x1::ascii::String, ScallopVault<T0>>(&arg1.lending, v0), 1005);
        let ScallopVault {
            scoin     : v1,
            principal : v2,
        } = 0x2::bag::remove<0x1::ascii::String, ScallopVault<T0>>(&mut arg1.lending, v0);
        let v3 = 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::redeem::redeem<T0>(arg3, arg4, 0x2::coin::from_balance<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(v1, arg6), arg5, arg6);
        let v4 = 0x2::coin::value<T0>(&v3);
        let v5 = 0x2::coin::into_balance<T0>(v3);
        if (v4 > v2) {
            let v6 = ((((v4 - v2) as u128) * (arg2.fee_rate as u128) / 10000) as u64);
            if (v6 > 0) {
                deposit_into_fee_house<T0>(arg2, 0x2::balance::split<T0>(&mut v5, v6));
            };
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v5, arg6), arg1.owner);
        let v7 = AdminAssetReturned{
            pm_id     : 0x2::object::id<PositionManager>(arg1),
            coin_type : v0,
    ...
    public fun agent_create_position<T0, T1>(arg0: &mut PositionManager, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: vector<u32>, arg3: vector<u64>, arg4: vector<u64>, arg5: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg6: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(0x2::vec_set::contains<address>(&arg0.agents, &v0), 1002);
        assert!(0x1::option::is_none<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&arg0.position), 1010);
        assert!(0x2::object::id<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>>(arg1) == arg0.pool_id, 1012);
        let v1 = 0;
        let v2 = 0;
        let v3 = 0;
        while (v3 < 0x1::vector::length<u64>(&arg3)) {
            v1 = v1 + *0x1::vector::borrow<u64>(&arg3, v3);
            v2 = v2 + *0x1::vector::borrow<u64>(&arg4, v3);
            v3 = v3 + 1;
        };
        let v4 = withdraw_from_balance<T0>(arg0, v1, arg8);
        let v5 = withdraw_from_balance<T1>(arg0, v2, arg8);
        let v6 = &mut v4;
        let v7 = &mut v5;
        let v8 = open_position_private<T0, T1>(arg1, v6, v7, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
        add_to_balance<T0>(arg0, v4);
        add_to_balance<T1>(arg0, v5);
        0x1::option::fill<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&mut arg0.position, v8);
        let v9 = AgentPositionCreated{
            pm_id            : 0x2::object::id<PositionManager>(arg0),
            pool_id          : arg0.pool_id,
            lower_bin_id     : 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::lower_bin_id(&v8),
            upper_bin_id     : 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::upper_bin_id(&v8),
            liquidity_shares : 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::liquidity_shares(&v8),
        };
        0x2::event::emit<AgentPositionCreated>(v9);
    }

    public fun agent_destroy_position<T0, T1>(arg0: &mut PositionManager, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg3: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(0x2::vec_set::contains<address>(&arg0.agents, &v0), 1002);
        assert!(0x1::option::is_some<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&arg0.position), 1011);
        let v1 = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::info_rewards(0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::borrow_position_info(0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::position_manager<T0, T1>(arg1), 0x2::object::id<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(0x1::option::borrow<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&arg0.position))));
        let v2 = 0;
        ...
        let v3 = arg0.pool_id;
        let (v4, v5, v6) = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::close_position<T0, T1>(arg1, 0x1::option::extract<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&mut arg0.position), arg2, arg3, arg4, arg5);
        let v7 = v6;
        let v8 = v5;
        0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::destroy_close_position_cert(v4, arg3);
        add_to_balance<T0>(arg0, 0x2::coin::from_balance<T0>(v8, arg5));
        add_to_balance<T1>(arg0, 0x2::coin::from_balance<T1>(v7, arg5));
        let v9 = AgentPositionDestroyed{
            pm_id       : 0x2::object::id<PositionManager>(arg0),
            pool_id     : v3,
            coin_type_a : 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()),
            coin_type_b : 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>()),
        ...
        0x2::event::emit<AgentPositionDestroyed>(v9);
    }
    ...
    fun open_position_private<T0, T1>(arg0: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg1: &mut 0x2::coin::Coin<T0>, arg2: &mut 0x2::coin::Coin<T1>, arg3: vector<u32>, arg4: vector<u64>, arg5: vector<u64>, arg6: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg7: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position {
    ...
    public fun protocol_collect_fee<T0, T1>(arg0: &AccessList, arg1: &mut FeeHouse, arg2: &mut PositionManager, arg3: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg4: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg5: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::option::is_some<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&arg2.position), 1011);
    ...
    public fun user_close_pm<T0, T1>(arg0: &mut Record, arg1: PositionManager, arg2: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg3: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg4: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&v9)) {
            let v10 = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::info_rewards(0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::borrow_position_info(0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::position_manager<T0, T1>(arg2), 0x2::object::id<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(0x1::option::borrow<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&v9))));
            let v11 = 0;
            while (v11 < 0x1::vector::length<u64>(v10)) {
                assert!(*0x1::vector::borrow<u64>(v10, v11) == 0, 1007);
                v11 = v11 + 1;
            };
            let (v12, v13, v14) = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::close_position<T0, T1>(arg2, 0x1::option::extract<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&mut v9), arg3, arg4, arg5, arg6);
            0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::destroy_close_position_cert(v12, arg4);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v13, arg6), 0x2::tx_context::sender(arg6));
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v14, arg6), 0x2::tx_context::sender(arg6));
        ...
        let v15 = PositionManagerClosed{
            pm_id : v0,
            owner : v2,
        };
        0x2::event::emit<PositionManagerClosed>(v15);
    }
    ...
    public fun user_deposit_liquidity<T0, T1>(arg0: &mut Record, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut 0x2::coin::Coin<T1>, arg4: vector<u32>, arg5: vector<u64>, arg6: vector<u64>, arg7: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg8: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = open_position_private<T0, T1>(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
        let v1 = 0x2::object::id<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>>(arg1);
        let v2 = PositionManager{
            id       : 0x2::object::new(arg10),
            owner    : 0x2::tx_context::sender(arg10),
            agents   : 0x2::vec_set::empty<address>(),
            pool_id  : v1,
            position : 0x1::option::some<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(v0),
            balance  : 0x2::bag::new(arg10),
            fee      : 0x2::bag::new(arg10),
            lending  : 0x2::bag::new(arg10),
        };
        let v3 = 0x2::object::id<PositionManager>(&v2);
        0x2::table::add<0x2::object::ID, bool>(&mut arg0.record, v3, true);
        0x2::transfer::share_object<PositionManager>(v2);
        let v4 = PositionManagerCreated{
            pm_id            : v3,
            owner            : 0x2::tx_context::sender(arg10),
            pool_id          : v1,
            lower_bin_id     : 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::lower_bin_id(&v0),
            upper_bin_id     : 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::upper_bin_id(&v0),
            liquidity_shares : 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::liquidity_shares(&v0),
        };
        0x2::event::emit<PositionManagerCreated>(v4);
    }
    ...
    public fun user_deposit_position(arg0: &mut Record, arg1: 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::object::id<PositionManager>(&v1);
        0x2::table::add<0x2::object::ID, bool>(&mut arg0.record, v2, true);
        0x2::transfer::share_object<PositionManager>(v1);
    ...
    public fun user_remove_record_entry(arg0: &mut Record, arg1: 0x2::object::ID) {
        assert!(0x2::table::contains<0x2::object::ID, bool>(&arg0.record, arg1), 1014);
        0x2::table::remove<0x2::object::ID, bool>(&mut arg0.record, arg1);
        let v0 = RecordEntryRemoved{
            record_id : 0x2::object::id<Record>(arg0),
            pm_id     : arg1,
        };
        0x2::event::emit<RecordEntryRemoved>(v0);
    }
