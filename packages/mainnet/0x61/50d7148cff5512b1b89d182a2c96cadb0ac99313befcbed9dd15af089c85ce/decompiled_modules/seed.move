module 0x6150d7148cff5512b1b89d182a2c96cadb0ac99313befcbed9dd15af089c85ce::seed {
    ...
    fun init(arg0: SEED, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SEED>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Seed"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is the seed of the devil"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreickkfkexmn42fp3ff3apir6brcyemeq6voqxyxvl5pvfzduq6swky"));
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Nft>(&mut v5, &v4, 150, 0);
