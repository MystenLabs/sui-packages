module 0x61295b65c831041f5988d78ca0186ec6d080e455cc6072facea11e8d9e848324::send {
    ...
    fun init(arg0: SEND, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<SEND>>(0x2::coin::mint<SEND>(&mut v2, 10000000000000000000, arg1), 0x2::tx_context::sender(arg1));
