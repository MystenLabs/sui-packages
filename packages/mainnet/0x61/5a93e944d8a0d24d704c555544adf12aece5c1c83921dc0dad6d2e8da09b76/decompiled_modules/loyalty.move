module 0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::loyalty {
    ...
    public fun admin_award_points(arg0: &0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::admin::AdminCap, arg1: &mut LoyaltyConfig, arg2: &mut 0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::UserAccount, arg3: u64, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::account_owner(arg2);
        mint_and_transfer(arg1, v2, arg3, arg5);
        0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::add_lifetime_points(arg2, arg3);
        let v3 = PointsEarned{
            user                 : v2,
            amount               : arg3,
            reason               : arg4,
    ...
    public(friend) fun award_upload_points(arg0: &mut LoyaltyConfig, arg1: &0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::admin::GlobalConfig, arg2: &mut 0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::UserAccount, arg3: &0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::Subscription, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        if (arg0.paused) {
            return
        };
        if (arg4 == 0) {
        ...
        if (!0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::is_active(arg3, 0x2::tx_context::epoch(arg6))) {
            return
        };
        let v0 = 0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::admin::points_per_gb(arg1);
        ...
        let v3 = (v2 as u64);
        let v4 = 0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::account_owner(arg2);
        mint_and_transfer(arg0, v4, v3, arg6);
        0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::add_lifetime_points(arg2, v3);
        let v5 = PointsEarned{
            user                 : v4,
            amount               : v3,
            reason               : b"upload",
    ...
    public fun clear_bonus_event(arg0: &0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::admin::AdminCap, arg1: &mut LoyaltyConfig, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun pause_loyalty(arg0: &0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::admin::AdminCap, arg1: &mut LoyaltyConfig, arg2: &0x2::tx_context::TxContext) {
        arg1.paused = true;
    ...
    public fun redeem_for_extension(arg0: &mut LoyaltyConfig, arg1: &0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::UserAccount, arg2: &mut 0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::Subscription, arg3: 0x2::token::Token<LOYALTY>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::token::Token<LOYALTY> {
        assert!(!arg0.paused, 500);
        assert!(arg4 > 0, 507);
        assert!(0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::account_owner(arg1) == 0x2::tx_context::sender(arg5), 508);
        assert!(0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::sub_owner(arg2) == 0x2::tx_context::sender(arg5), 508);
        ...
        0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::extend_expiry(arg2, arg4, arg5);
    ...
    public fun redeem_for_storage(arg0: &mut LoyaltyConfig, arg1: &mut 0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::UserAccount, arg2: 0x2::token::Token<LOYALTY>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::token::Token<LOYALTY> {
        assert!(!arg0.paused, 500);
        assert!(arg3 >= arg0.min_redemption_gb, 502);
        assert!(0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::account_owner(arg1) == 0x2::tx_context::sender(arg4), 508);
        ...
        0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::subscription::add_bonus_storage(arg1, arg3 * 1073741824);
        let v5 = PointsRedeemed{
    ...
    public fun set_bonus_event(arg0: &0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::admin::AdminCap, arg1: &mut LoyaltyConfig, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
    ...
    public fun unpause_loyalty(arg0: &0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::admin::AdminCap, arg1: &mut LoyaltyConfig, arg2: &0x2::tx_context::TxContext) {
        arg1.paused = false;
    ...
    public fun update_redemption_rates(arg0: &0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::admin::AdminCap, arg1: &mut LoyaltyConfig, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        let v0 = if (arg2 > 0) {
            if (arg3 > 0) {
                arg4 > 0
            } else {
        ...
        assert!(v0, 503);
        assert!(arg2 > 0x615a93e944d8a0d24d704c555544adf12aece5c1c83921dc0dad6d2e8da09b76::admin::max_base_points_per_gb() * 10 * 20000 / 10000, 510);
