module 0x61a1006cd7105ee45cfa53967617f98f0702a658fec07b937cf9c289723909d6::pandorian {
    ...
    struct Pandorian has store, key {
        ...
        description: 0x1::string::String,
        url: 0x2::url::Url,
        attributes: 0x61a1006cd7105ee45cfa53967617f98f0702a658fec07b937cf9c289723909d6::attributes::Attributes,
    }
    ...
    fun init(arg0: PANDORIAN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x61a1006cd7105ee45cfa53967617f98f0702a658fec07b937cf9c289723909d6::collection::display(&v0, arg1);
        ...
        0x2::transfer::public_share_object<0x61a1006cd7105ee45cfa53967617f98f0702a658fec07b937cf9c289723909d6::collection::Collection>(0x61a1006cd7105ee45cfa53967617f98f0702a658fec07b937cf9c289723909d6::collection::new(arg1));
    }
    ...
    public(friend) fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<u8>, arg3: vector<0x1::ascii::String>, arg4: vector<0x1::ascii::String>, arg5: &mut 0x2::tx_context::TxContext) : Pandorian {
        let v0 = Pandorian{
            ...
            attributes  : 0x61a1006cd7105ee45cfa53967617f98f0702a658fec07b937cf9c289723909d6::attributes::new_from_vec(arg3, arg4),
        };
