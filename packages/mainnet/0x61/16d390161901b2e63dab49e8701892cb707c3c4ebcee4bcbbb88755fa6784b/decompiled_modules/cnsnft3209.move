module 0x6116d390161901b2e63dab49e8701892cb707c3c4ebcee4bcbbb88755fa6784b::cnsnft3209 {
    struct CNSNFT3209 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3209, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3209>(arg0, arg1);
