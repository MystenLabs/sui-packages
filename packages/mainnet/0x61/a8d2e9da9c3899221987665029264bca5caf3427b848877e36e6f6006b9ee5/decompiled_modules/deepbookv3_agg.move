module 0x61a8d2e9da9c3899221987665029264bca5caf3427b848877e36e6f6006b9ee5::deepbookv3_agg {
    ...
    public fun swap<T0, T1, T2>(arg0: &0x8736237bae5af0583f17c6a49cae695e8f703da342193753bec4ea1937dd4df1::liquidator::Liquidator, arg1: &mut 0x8736237bae5af0583f17c6a49cae695e8f703da342193753bec4ea1937dd4df1::custom_liquidate::CustomLiquidateReceipt<T0>, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T1, T2>, arg3: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg4: bool, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = if (arg4) {
            ...
            swap_a2b<T1, T2>(arg2, 0x8736237bae5af0583f17c6a49cae695e8f703da342193753bec4ea1937dd4df1::custom_liquidate::take_balance<DeepbookV3Agg, T0, T1>(arg1, arg0, v3, arg5), arg3, arg6, arg7, arg8)
        } else {
            let v4 = DeepbookV3Agg{dummy_field: false};
            swap_b2a<T1, T2>(arg2, 0x8736237bae5af0583f17c6a49cae695e8f703da342193753bec4ea1937dd4df1::custom_liquidate::take_balance<DeepbookV3Agg, T0, T2>(arg1, arg0, v4, arg5), arg3, arg6, arg7, arg8)
        };
        let v5 = v2;
        let v6 = v1;
        let v7 = v0;
        if (0x2::balance::value<T1>(&v7) > 0) {
            ...
            0x8736237bae5af0583f17c6a49cae695e8f703da342193753bec4ea1937dd4df1::custom_liquidate::put_balance<DeepbookV3Agg, T0, T1>(arg1, arg0, v8, v7);
        } else {
            0x2::balance::destroy_zero<T1>(v7);
        };
        if (0x2::balance::value<T2>(&v6) > 0) {
            let v9 = DeepbookV3Agg{dummy_field: false};
            0x8736237bae5af0583f17c6a49cae695e8f703da342193753bec4ea1937dd4df1::custom_liquidate::put_balance<DeepbookV3Agg, T0, T2>(arg1, arg0, v9, v6);
        } else {
