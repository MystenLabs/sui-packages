module 0x28c462b64af6ecee09df4f86866c296813fe20d557238aae68fdca4d7cf61b38::acl {
    ...
    public(friend) fun set_upgrade_cap(arg0: &mut ACL, arg1: 0x2::package::UpgradeCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(is_admin(arg0, v0), 1);
        assert!(get_upgrade_cap_id(&arg1) == @0xc49997c3f080cd92c44f0e29468f40d3c7e2f5239ae2d798a8e05764471203fb, 16);
