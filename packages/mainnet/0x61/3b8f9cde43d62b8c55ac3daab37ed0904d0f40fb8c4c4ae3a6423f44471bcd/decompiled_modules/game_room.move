module 0x613b8f9cde43d62b8c55ac3daab37ed0904d0f40fb8c4c4ae3a6423f44471bcd::game_room {
    ...
    public fun complete_game(arg0: &mut GameRoomStore, arg1: address, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 == 0) {
            ...
            let v9 = v0.total_prize_pool * 7 / 100;
            v0.platform_fee_collected = v9;
            if (v9 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(0x2::coin::take<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg0.usdc_treasury, v9, arg5), @0x32572830354edf43effe74bb5f67e3fa6aa99bbc0133b9152fce5e30f45ca841);
            };
            let v10 = v0.total_prize_pool - v9;
            let v11 = 0x1::string::as_bytes(&v0.winner_split_rule);
            let v12 = b"winner_takes_all";
            if (v11 == &v12) {
                assert!(v2 == 1, 11);
            } else {
                let v13 = b"top_2";
            ...
            while (v18 < v2) {
                ...
                let v29 = *0x1::vector::borrow<address>(&arg2, v18);
                if (0x2::table::contains<address, GameRoomParticipant>(&v0.participants, v29)) {
                    let v30 = 0x2::table::borrow_mut<address, GameRoomParticipant>(&mut v0.participants, v29);
                    v30.is_winner = true;
                    v30.earnings = v28;
                    v30.score = *0x1::vector::borrow<u64>(&arg3, v18);
                };
                if (v28 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(0x2::coin::take<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg0.usdc_treasury, v28, arg5), v29);
                };
                v18 = v18 + 1;
            };
            v0.total_prize_pool = 0;
            let v31 = GameCompleted{
                room_id          : arg1,
                winners          : arg2,
                total_prize_pool : v0.total_prize_pool,
                platform_fee     : v9,
            };
            0x2::event::emit<GameCompleted>(v31);
        };
    }
