module 0x61c0738d6aff3ecc1fd714346ff9acea882085d386145a808d78c2c3fd5ee075::suilend_adapter {
    ...
    public fun get_underlying_balance<T0, T1>(arg0: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg1: u64) : u128 {
        let (v0, v1) = get_ctoken_ratio<T0, T1>(arg0);
        quote_underlying_from_ratio(arg1, v0, v1)
    }

    fun quote_underlying_from_ratio(arg0: u64, arg1: u128, arg2: u128) : u128 {
        if (arg2 == 0) {
            return (arg0 as u128)
        };
        (arg0 as u128) * arg1 / arg2
    }
