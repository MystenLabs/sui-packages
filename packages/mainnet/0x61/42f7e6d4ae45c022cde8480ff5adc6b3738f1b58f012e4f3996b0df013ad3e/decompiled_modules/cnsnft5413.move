module 0x6142f7e6d4ae45c022cde8480ff5adc6b3738f1b58f012e4f3996b0df013ad3e::cnsnft5413 {
    struct CNSNFT5413 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5413, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5680"));
        let v4 = 0x2::package::claim<CNSNFT5413>(arg0, arg1);
