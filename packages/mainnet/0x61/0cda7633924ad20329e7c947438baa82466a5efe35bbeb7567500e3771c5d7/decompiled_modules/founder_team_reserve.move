module 0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::founder_team_reserve {
    ...
    public entry fun claim_reserve(arg0: &mut FounderTeamGlobal, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1 == 500) {
            ...
            *v1 = *v1 - 1;
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>>(0x2::coin::from_balance<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>(0x2::balance::split<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>(&mut arg0.balance_SHUI, 150000 * 1000000000), arg2), v0);
            ...
            *v2 = *v2 - 1;
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>>(0x2::coin::from_balance<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>(0x2::balance::split<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>(&mut arg0.balance_SHUI, 100000 * 1000000000), arg2), v0);
            ...
            *v4 = *v4 - 1;
            0x2::transfer::public_transfer<0x2::coin::Coin<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>>(0x2::coin::from_balance<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>(0x2::balance::split<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>(&mut arg0.balance_SHUI, 50000 * 1000000000), arg2), v0);
        } else if (arg1 == 50) {
            ...
            *v5 = *v5 - 1;
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>>(0x2::coin::from_balance<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>(0x2::balance::split<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>(&mut arg0.balance_SHUI, 20000 * 1000000000), arg2), v0);
    ...
    public fun init_funds_from_main_contract(arg0: &mut FounderTeamGlobal, arg1: &mut 0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::Global, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.creator == 0x2::tx_context::sender(arg2), 1);
        0x2::balance::join<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>(&mut arg0.balance_SHUI, 0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::extract_founder_reserve_balance(arg1, arg2));
    }
