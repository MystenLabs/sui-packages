module 0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::swap {
    ...
    public fun init_funds_from_main_contract(arg0: &mut SwapGlobal, arg1: &mut 0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::Global, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.creator == 0x2::tx_context::sender(arg2), 1);
        0x2::balance::join<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>(&mut arg0.balance_SHUI, 0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::extract_swap_balance(arg1, arg2));
    }
    ...
    public fun set_whitelist(arg0: &mut SwapGlobal, arg1: &mut 0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::boat_ticket::BoatTicket, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::table::add<address, u64>(&mut arg0.whitelist_table, 0x2::tx_context::sender(arg2), 50000);
        assert!(0x2::table::contains<u64, bool>(&arg0.ticket_map, 0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::boat_ticket::get_index(arg1)), 8);
        0x2::table::add<u64, bool>(&mut arg0.ticket_map, 0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::boat_ticket::get_index(arg1), true);
    ...
    public entry fun white_list_swap(arg0: &mut SwapGlobal, arg1: u64, arg2: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>>(0x2::coin::from_balance<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>(0x2::balance::split<0x610cda7633924ad20329e7c947438baa82466a5efe35bbeb7567500e3771c5d7::shui::SHUI>(&mut arg0.balance_SHUI, v2 * 1000000000), arg3), v1);
