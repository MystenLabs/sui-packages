module 0x61f149c2278a98844d23129f2347ed20ca163e67e34614ff3195456231d5a87a::r {
    struct LL<T0> {
        r: T0,
        a: u64,
    }
    ...
    public fun flowx_v3_a2b<T0, T1>(arg0: &mut 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool_manager::PoolRegistry, arg1: u64, arg2: &0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::versioned::Versioned, arg3: 0x2::balance::Balance<T0>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        let (v2, v3, v4) = 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool::swap<T0, T1>(v1, true, true, v0, 4295048016, arg2, arg4, arg5);
        let v5 = v4;
        let v6 = v3;
        let (v7, _) = 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool::swap_receipt_debts(&v5);
        0x2::balance::destroy_zero<T0>(v2);
        0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool::pay<T0, T1>(v1, v5, 0x2::balance::split<T0>(&mut arg3, v7), 0x2::balance::zero<T1>(), arg2, arg5);
        0x2::balance::destroy_zero<T0>(arg3);
        emit_swap(25, true, v0, 0x2::balance::value<T1>(&v6));
        v6
    }
    ...
    public fun flowx_v3_b2a<T0, T1>(arg0: &mut 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool_manager::PoolRegistry, arg1: u64, arg2: &0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::versioned::Versioned, arg3: 0x2::balance::Balance<T1>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        let v1 = 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool_manager::borrow_mut_pool<T0, T1>(arg0, arg1);
        let (v2, v3, v4) = 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool::swap<T0, T1>(v1, false, true, v0, 79226673515401279992447579055, arg2, arg4, arg5);
        let v5 = v4;
        let v6 = v2;
        let (_, v8) = 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool::swap_receipt_debts(&v5);
        0x2::balance::destroy_zero<T1>(v3);
        0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool::pay<T0, T1>(v1, v5, 0x2::balance::zero<T0>(), 0x2::balance::split<T1>(&mut arg3, v8), arg2, arg5);
        0x2::balance::destroy_zero<T1>(arg3);
        emit_swap(25, false, v0, 0x2::balance::value<T0>(&v6));
        v6
    }
