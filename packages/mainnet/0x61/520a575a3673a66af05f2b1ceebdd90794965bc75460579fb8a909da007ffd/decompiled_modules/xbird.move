module 0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::xbird {
    ...
    public fun depositToken(arg0: vector<u8>, arg1: vector<u8>, arg2: &ValidatorVault, arg3: &mut BirdPegVault<XBIRD>, arg4: &mut 0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::archieve::UserArchieve, arg5: &0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 > 0, 1002);
        0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::archieve::verUpdateTokenPegNonce(v3, arg4);
    ...
    public fun setValidator(arg0: &BAdminCap, arg1: vector<u8>, arg2: &mut ValidatorVault, arg3: &0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::Version) {
    ...
    public fun withdrawToken(arg0: &mut BirdPegVault<XBIRD>, arg1: &mut 0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::archieve::UserArchieve, arg2: 0x2::token::Token<XBIRD>, arg3: &0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::checkVersion(arg3, 1);
        let v0 = WithdrawToken{
            owner  : 0x2::tx_context::sender(arg4),
            amount : 0x2::token::value<XBIRD>(&arg2),
            type   : 0x1::type_name::get<XBIRD>(),
            nonce  : 0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::archieve::increaseGetTokenDepegNonce(arg1),
        };
