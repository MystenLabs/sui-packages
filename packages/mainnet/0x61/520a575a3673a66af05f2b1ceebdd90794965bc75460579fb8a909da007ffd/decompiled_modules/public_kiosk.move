module 0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::public_kiosk {
    ...
    public(friend) fun delist<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: 0x2::object::ID, arg2: &0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun list<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: 0x2::object::ID, arg2: u64, arg3: &0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun place<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: T0, arg2: &0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::checkVersion(arg2, 1);
        validatePair<T0, T1>(arg0);
    ...
    public(friend) fun purchase<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: 0x2::object::ID, arg2: &0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::Version, arg3: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>, Order) {
        0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::checkVersion(arg2, 1);
        validatePair<T0, T1>(arg0);
    ...
    public(friend) fun take<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: 0x2::object::ID, arg2: &0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::Version, arg3: &mut 0x2::tx_context::TxContext) : u128 {
        0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::checkVersion(arg2, 1);
        validatePair<T0, T1>(arg0);
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = OrderID{id: arg1};
    ...
    public(friend) fun createPublicKiosk<T0: store + key, T1>(arg0: &0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::Version, arg1: &mut 0x2::tx_context::TxContext) : PublicKiosk {
        0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::checkVersion(arg0, 1);
    ...
    public(friend) fun delistAndTake<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: 0x2::object::ID, arg2: &0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::Version, arg3: &mut 0x2::tx_context::TxContext) : u128 {
        0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::checkVersion(arg2, 1);
    ...
    public(friend) fun placeAndList<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: T0, arg2: u64, arg3: &0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::checkVersion(arg3, 1);
        place<T0, T1>(arg0, arg1, arg3, arg4);
        list<T0, T1>(arg0, 0x2::object::id<T0>(&arg1), arg2, arg3, arg4);
    }

    public(friend) fun replace<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: 0x2::object::ID, arg2: u64, arg3: &0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x61520a575a3673a66af05f2b1ceebdd90794965bc75460579fb8a909da007ffd::version::checkVersion(arg3, 1);
        validatePair<T0, T1>(arg0);
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = OrderID{id: arg1};
