module 0x613a18d5f34ed7cdb4c8fb548fd2c58b21561e19e0d51119cc6ac3afb9e7006c::nyan {
    ...
    fun init(arg0: NYAN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/qzoRRH1HGzrb3KR0?width=128&height=128&fit=crop&quality=95&format=auto                                                                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<NYAN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"NYAN    ")))), trim_right(b"Nyan Cat                        "), trim_right(b"Nyanyanyanyanyanyanya                                                                                                                                                                                                                                                                                                           "), v2, arg1);
        let v5 = v3;
