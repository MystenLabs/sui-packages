module 0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::battle_royale {
    ...
    public(friend) fun register_participant_and_split_payment(arg0: &mut 0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::token_launcher::Launchpad, arg1: &mut BattleRoyale, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, bool) {
        ...
        if (arg1.platform_fee_bps > 0) {
            0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::token_launcher::add_to_treasury(arg0, 0x2::balance::split<0x2::sui::SUI>(&mut v5, 0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::utils::as_u64(0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::utils::percentage_of(0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::utils::from_u64(v2), arg1.platform_fee_bps))));
        };
