module 0x6198806740df58df70603e440b90d4d35b976e3cff3812054591b77b57105b51::reward6866 {
    struct REWARD6866 has drop {
        dummy_field: bool,
    }

    struct TICKET_6866 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6866(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6866>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6866>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6866, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6866>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6866>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6866>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6866>>(v5, 0x2::tx_context::sender(arg1));
    }
