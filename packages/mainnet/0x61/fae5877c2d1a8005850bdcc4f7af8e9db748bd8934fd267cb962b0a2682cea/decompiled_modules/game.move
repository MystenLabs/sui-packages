module 0x61fae5877c2d1a8005850bdcc4f7af8e9db748bd8934fd267cb962b0a2682cea::game {
    ...
    public fun confirm_safe(arg0: u64, arg1: u64, arg2: &vector<u8>) : bool {
        let v0 = arg0 * 10 + arg1;
        (*0x1::vector::borrow<u8>(arg2, v0 % 30 + 1) as u64) * (*0x1::vector::borrow<u8>(arg2, 0) as u64) * (*0x1::vector::borrow<u8>(arg2, 31) as u64) % (v0 + 2) % 2 == 0
    }
