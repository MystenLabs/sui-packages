module 0x61fae5877c2d1a8005850bdcc4f7af8e9db748bd8934fd267cb962b0a2682cea::task {
    ...
    public fun complete_task(arg0: &mut 0x61fae5877c2d1a8005850bdcc4f7af8e9db748bd8934fd267cb962b0a2682cea::admin::GameCap, arg1: 0x2::object::ID, arg2: &mut TaskList, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0x61fae5877c2d1a8005850bdcc4f7af8e9db748bd8934fd267cb962b0a2682cea::admin::borrow_balance_mut(arg0);
        ...
        if (0x2::balance::value<0x2::sui::SUI>(v9) >= 10000000000) {
            0x61fae5877c2d1a8005850bdcc4f7af8e9db748bd8934fd267cb962b0a2682cea::admin::withdraw_(arg0, arg3);
        };
