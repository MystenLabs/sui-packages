module 0x61f486c9d9143a156c06ee04b63d36964b4bcce6e8374cfe9abbd8a2e1f4ddde::aura_farming {
    ...
    fun init(arg0: AURA_FARMING, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<AURA_FARMING>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Aura Farming"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibfgqa27inkmx6jcrnf23qksldsuczdjjr7fng7ryrly63wz7kopu"));
