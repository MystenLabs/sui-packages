module 0x61df216a5ab3128865d234faeb1cb22d0baa35bf6c094a0940d697333ca4c460::helper {
    public(friend) fun apply_slippage(arg0: u64, arg1: u64) : u64 {
        if (arg0 == 0) {
            return 0
        };
        arg0 + 0x61df216a5ab3128865d234faeb1cb22d0baa35bf6c094a0940d697333ca4c460::math::mul(arg0, arg1)
    }
    ...
    public(friend) fun calculate_order_amount(arg0: u64, arg1: u64, arg2: bool) : u64 {
        if (arg2) {
            0x61df216a5ab3128865d234faeb1cb22d0baa35bf6c094a0940d697333ca4c460::math::mul(arg0, arg1)
        } else {
            arg0
        }
    }
    ...
    public(friend) fun get_pool_first_ask_price<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        ...
        let v4 = v2;
        assert!(!0x1::vector::is_empty<u64>(&v4), 13906835677582327815);
    ...
    public(friend) fun get_sui_per_deep_from_oracle(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : u64 {
        let (v0, v1) = 0x61df216a5ab3128865d234faeb1cb22d0baa35bf6c094a0940d697333ca4c460::oracle::get_pyth_price(arg0, arg2);
        let v2 = v1;
        let v3 = v0;
        let (v4, v5) = 0x61df216a5ab3128865d234faeb1cb22d0baa35bf6c094a0940d697333ca4c460::oracle::get_pyth_price(arg1, arg2);
        let v6 = v5;
        let v7 = v4;
        assert!(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v2) == 0x61df216a5ab3128865d234faeb1cb22d0baa35bf6c094a0940d697333ca4c460::oracle::get_deep_price_feed_id() && 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v6) == 0x61df216a5ab3128865d234faeb1cb22d0baa35bf6c094a0940d697333ca4c460::oracle::get_sui_price_feed_id(), 13906835226610630661);
        ...
        if (v14) {
            0x61df216a5ab3128865d234faeb1cb22d0baa35bf6c094a0940d697333ca4c460::math::div(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v12) * 0x61df216a5ab3128865d234faeb1cb22d0baa35bf6c094a0940d697333ca4c460::math::pow(10, v15), 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v13))
        } else {
            0x61df216a5ab3128865d234faeb1cb22d0baa35bf6c094a0940d697333ca4c460::math::div(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v12), 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v13) * 0x61df216a5ab3128865d234faeb1cb22d0baa35bf6c094a0940d697333ca4c460::math::pow(10, v15))
        }
    }
    ...
    public(friend) fun get_sui_per_deep_from_reference_pool<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        assert!(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::whitelisted<T0, T1>(arg0) && 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::registered_pool<T0, T1>(arg0), 13906834921667690497);
        ...
        assert!(v0 == v2 && v1 == v3 || v0 == v3 && v1 == v2, 13906834973207298049);
        if (v0 == v2) {
            get_pool_first_ask_price<T0, T1>(arg0, arg1)
        } else {
            0x61df216a5ab3128865d234faeb1cb22d0baa35bf6c094a0940d697333ca4c460::math::div(1000000000, get_pool_first_ask_price<T0, T1>(arg0, arg1))
        }
    }
    ...
    public(friend) fun validate_slippage(arg0: u64) {
        assert!(arg0 <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling(), 13906835591682719747);
    }
