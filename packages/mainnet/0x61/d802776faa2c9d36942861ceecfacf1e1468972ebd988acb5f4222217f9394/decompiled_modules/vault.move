module 0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::vault {
    ...
    struct Vault<phantom T0> has key {
        ...
        total_shares: u64,
        current_strategy: u8,
        treasury_cap: 0x2::coin::TreasuryCap<0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::aqusdc::AQUSDC>,
    }
    ...
    public fun borrow_treasury_cap<T0>(arg0: &AdminCap, arg1: &Vault<T0>) : &0x2::coin::TreasuryCap<0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::aqusdc::AQUSDC> {
        &arg1.treasury_cap
    }
    ...
    public fun create_vault<T0>(arg0: 0x2::coin::TreasuryCap<0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::aqusdc::AQUSDC>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
        ...
        0x2::transfer::transfer<KeeperCap>(v2, 0x2::tx_context::sender(arg1));
    }

    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::aqusdc::AQUSDC> {
        assert!(!is_paused(&arg0.id), 6);
        ...
        0x2::coin::mint<0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::aqusdc::AQUSDC>(&mut arg0.treasury_cap, v4, arg2)
    }
    ...
    public fun emergency_withdraw<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::aqusdc::AQUSDC>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(is_paused(&arg0.id), 7);
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = 0x2::coin::burn<0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::aqusdc::AQUSDC>(&mut arg0.treasury_cap, arg1);
        assert!(v1 > 0, 1);
    ...
    public fun instant_withdraw<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::aqusdc::AQUSDC>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(!is_paused(&arg0.id), 6);
    ...
    public fun request_withdrawal<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::aqusdc::AQUSDC>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = 0x2::coin::burn<0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::aqusdc::AQUSDC>(&mut arg0.treasury_cap, arg1);
        assert!(v1 > 0, 1);
        let v2 = 0x2::balance::value<T0>(&arg0.idle_balance) + arg0.total_invested;
