module 0x61045fce8b32437cac693b0e79c9ed1e4cb387332df864c0fe354ef6d5f84a69::cnsnft4326 {
    struct CNSNFT4326 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4326, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4326>(arg0, arg1);
