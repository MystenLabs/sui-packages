module 0x614e1583d7ff861abc21e460b579a760f469297701b029966c65cefe149380d2::cnsnft2294 {
    struct CNSNFT2294 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2294, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2294>(arg0, arg1);
