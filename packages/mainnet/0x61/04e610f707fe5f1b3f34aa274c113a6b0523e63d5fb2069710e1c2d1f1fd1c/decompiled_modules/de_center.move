module 0x6104e610f707fe5f1b3f34aa274c113a6b0523e63d5fb2069710e1c2d1f1fd1c::de_center {
    ...
    public fun current_penalty<T0, T1>(arg0: &DeCenter<T0, T1>, arg1: u64) : 0x1::option::Option<PenaltyInfo> {
        ...
        } else if (arg1 >= arg0.max_time) {
            0x1::option::none<PenaltyInfo>()
        } else {
            let (v1, v2) = penalty_info<T0, T1>(arg0);
            let v3 = v2;
            let v4 = v1;
            let v5 = 0;
            0x1::vector::reverse<u32>(&mut v4);
            0x1::vector::reverse<u32>(&mut v3);
            while (v5 < 0x1::vector::length<u32>(&v4)) {
                let v6 = *0x1::vector::borrow<u32>(&v4, v5);
                if (arg1 >= (v6 as u64) * max_time<T0, T1>(arg0) / 1000000) {
                    let v7 = PenaltyInfo{
                        elapsed_percentage : v6,
                        penalty_percentage : *0x1::vector::borrow<u32>(&v3, v5),
                    };
                    return 0x1::option::some<PenaltyInfo>(v7)
                };
                v5 = v5 + 1;
            };
            0x1::option::none<PenaltyInfo>()
    ...
    public fun escrow_penalty<T0, T1>(arg0: &0x6104e610f707fe5f1b3f34aa274c113a6b0523e63d5fb2069710e1c2d1f1fd1c::de_token::DeToken<T0, T1>, arg1: &DeCenter<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock) : 0x1::option::Option<u64> {
        ...
        let v1 = 0x6104e610f707fe5f1b3f34aa274c113a6b0523e63d5fb2069710e1c2d1f1fd1c::de_token::end<T0, T1>(arg0);
        ...
        let v2 = current_penalty<T0, T1>(arg1, arg1.max_time - v1 - v0);
        if (0x1::option::is_none<PenaltyInfo>(&v2)) {
            0x1::option::none<u64>()
        } else {
            let v4 = 0x1::option::extract<PenaltyInfo>(&mut v2);
            0x1::option::some<u64>((((v4.penalty_percentage as u128) * (arg2 as u128) / (1000000 as u128)) as u64))
        }
    }
    ...
    public fun force_unlock_with_penalty<T0, T1>(arg0: &mut DeCenter<T0, T1>, arg1: 0x6104e610f707fe5f1b3f34aa274c113a6b0523e63d5fb2069710e1c2d1f1fd1c::de_token::DeToken<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, DeTokenUpdateResponse<T0, T1>) {
        ...
        let (v2, v3) = unlock_<T0, T1>(arg0, arg1, arg2, arg3);
        let v4 = v2;
        let v5 = current_penalty<T0, T1>(arg0, arg0.max_time - v1 - v0);
        assert!(0x1::option::is_some<PenaltyInfo>(&v5), 107);
        let v6 = 0x1::option::extract<PenaltyInfo>(&mut v5);
        let v7 = (v6.penalty_percentage as u128) * (0x2::coin::value<T0>(&v4) as u128) / (1000000 as u128);
        let v8 = 0x2::coin::split<T0>(&mut v4, (v7 as u64), arg3);
        let v9 = v7 * (arg0.penalty_fee_bps as u128) / (1000000 as u128);
        0x2::balance::join<T0>(&mut arg0.penalty_fee_balance, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v8, (v9 as u64), arg3)));
        0x2::balance::join<T0>(&mut arg0.penalty_reserve, 0x2::coin::into_balance<T0>(v8));
        let v10 = PenaltyEvent{
            ...
            penalty_amount  : (v7 as u64),
            penalty_fee     : (v9 as u64),
            penalty_reserve : 0x2::coin::value<T0>(&v8),
        };
        0x2::event::emit<PenaltyEvent>(v10);
        (v4, v3)
    }
    ...
    public fun force_withdraw_with_penalty<T0, T1>(arg0: &mut DeCenter<T0, T1>, arg1: &mut 0x6104e610f707fe5f1b3f34aa274c113a6b0523e63d5fb2069710e1c2d1f1fd1c::de_token::DeToken<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, DeTokenUpdateResponse<T0, T1>) {
        ...
        assert!(v0 < v3, 105);
        assert!(v2 > 0, 104);
        let v4 = 0x6104e610f707fe5f1b3f34aa274c113a6b0523e63d5fb2069710e1c2d1f1fd1c::action::withdraw();
        let v5 = 0x6104e610f707fe5f1b3f34aa274c113a6b0523e63d5fb2069710e1c2d1f1fd1c::de_token::withdraw<T0, T1>(arg1, v4, arg2, arg3, arg4);
        let v6 = current_penalty<T0, T1>(arg0, arg0.max_time - v3 - v0);
        assert!(0x1::option::is_some<PenaltyInfo>(&v6), 107);
        ...
        arg0.locked_total = arg0.locked_total - 0x2::coin::value<T0>(&v5);
        let v7 = 0x1::option::extract<PenaltyInfo>(&mut v6);
        let v8 = (v7.penalty_percentage as u128) * (0x2::coin::value<T0>(&v5) as u128) / (1000000 as u128);
        let v9 = 0x2::coin::split<T0>(&mut v5, (v8 as u64), arg4);
        ...
        let v12 = WithdrawEvent{
            ...
            pool_id    : 0x2::object::id<DeCenter<T0, T1>>(arg0),
            coin_type  : 0x1::type_name::get<T0>(),
            withdrawl  : 0x2::coin::value<T0>(&v5),
            locked_end : v3,
            timestamp  : v0,
            whitelist  : 0x1::option::none<0x1::type_name::TypeName>(),
        };
        0x2::event::emit<WithdrawEvent>(v12);
        (v5, to_vesting_token_update_response<T0, T1>(arg1, v4, arg3))
    }
