module 0x6191449436f9800bd0cecda9af8d3e899cc99bbff6783fc90b1ea7744c191bed::reward2481 {
    struct REWARD2481 has drop {
        dummy_field: bool,
    }

    struct TICKET_2481 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2481(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2481>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2481>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2481, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2481>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2481>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2481>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2481>>(v5, 0x2::tx_context::sender(arg1));
    }
