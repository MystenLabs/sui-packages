module 0x6183da99443c98d4d1358cde0dd669930ccb4c5290476f79b1d434c477a85ea9::margin_registry {
    ...
    public(friend) fun add_margin_manager(arg0: &mut MarginRegistry, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::length<0x2::object::ID>(v2) <= 0x6183da99443c98d4d1358cde0dd669930ccb4c5290476f79b1d434c477a85ea9::margin_constants::max_margin_managers(), 13);
    }
    ...
    fun init(arg0: MARGIN_REGISTRY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = MarginRegistryInner{
            ...
            allowed_versions    : 0x2::vec_set::singleton<u64>(0x6183da99443c98d4d1358cde0dd669930ccb4c5290476f79b1d434c477a85ea9::margin_constants::margin_version()),
        ...
        let v2 = MarginRegistry{
            id    : v0,
            inner : 0x2::versioned::create<MarginRegistryInner>(0x6183da99443c98d4d1358cde0dd669930ccb4c5290476f79b1d434c477a85ea9::margin_constants::margin_version(), v1, arg1),
        };
    ...
    public(friend) fun load_inner(arg0: &MarginRegistry) : &MarginRegistryInner {
        ...
        let v1 = 0x6183da99443c98d4d1358cde0dd669930ccb4c5290476f79b1d434c477a85ea9::margin_constants::margin_version();
    ...
    public fun new_pool_config_with_leverage<T0, T1>(arg0: &MarginRegistry, arg1: u64) : PoolConfig {
        load_inner(arg0);
        assert!(arg1 > 0x6183da99443c98d4d1358cde0dd669930ccb4c5290476f79b1d434c477a85ea9::margin_constants::min_leverage(), 1);
        assert!(arg1 <= 0x6183da99443c98d4d1358cde0dd669930ccb4c5290476f79b1d434c477a85ea9::margin_constants::max_leverage(), 1);
        ...
        new_pool_config<T0, T1>(arg0, v0.min_withdraw_risk_ratio, v0.min_borrow_risk_ratio, v0.liquidation_risk_ratio, v0.target_liquidation_risk_ratio, 0x6183da99443c98d4d1358cde0dd669930ccb4c5290476f79b1d434c477a85ea9::margin_constants::default_user_liquidation_reward(), 0x6183da99443c98d4d1358cde0dd669930ccb4c5290476f79b1d434c477a85ea9::margin_constants::default_pool_liquidation_reward())
    }
