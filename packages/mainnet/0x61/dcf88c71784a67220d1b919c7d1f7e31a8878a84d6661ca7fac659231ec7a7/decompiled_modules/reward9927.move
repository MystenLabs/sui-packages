module 0x61dcf88c71784a67220d1b919c7d1f7e31a8878a84d6661ca7fac659231ec7a7::reward9927 {
    struct REWARD9927 has drop {
        dummy_field: bool,
    }

    struct TICKET_9927 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9927(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9927>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9927>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9927, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9927>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9927>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9927>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9927>>(v5, 0x2::tx_context::sender(arg1));
    }
