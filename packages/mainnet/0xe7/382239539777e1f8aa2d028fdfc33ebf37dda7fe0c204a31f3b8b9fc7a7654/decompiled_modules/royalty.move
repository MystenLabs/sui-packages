module 0xe7382239539777e1f8aa2d028fdfc33ebf37dda7fe0c204a31f3b8b9fc7a7654::royalty {
    struct ROYALTY_OTW has drop {
        dummy_field: bool,
    }
    ...
    public fun fork_royalty_amount(arg0: &0x2::transfer_policy::TransferPolicy<0x101cf4d03593c51a87e588f45fcb1ca0c86c1365c94f38fb772021bada7e76bf::fork::Fork>, arg1: u64) : u64 {
        let v0 = Rule{dummy_field: false};
        calculate_royalty(arg1, 0x2::transfer_policy::get_rule<0x101cf4d03593c51a87e588f45fcb1ca0c86c1365c94f38fb772021bada7e76bf::fork::Fork, Rule, RoyaltyConfig>(v0, arg0).royalty_bp)
    }
    ...
    public fun init_otw() : ROYALTY_OTW {
        ROYALTY_OTW{dummy_field: false}
    }

    public fun marvin_royalty_amount(arg0: &0x2::transfer_policy::TransferPolicy<0x179659777e20c117858cb884209819b46524f02edf4247f38f48ef34cf881797::marvin::Marvin>, arg1: u64) : u64 {
        let v0 = Rule{dummy_field: false};
        calculate_royalty(arg1, 0x2::transfer_policy::get_rule<0x179659777e20c117858cb884209819b46524f02edf4247f38f48ef34cf881797::marvin::Marvin, Rule, RoyaltyConfig>(v0, arg0).royalty_bp)
    }
