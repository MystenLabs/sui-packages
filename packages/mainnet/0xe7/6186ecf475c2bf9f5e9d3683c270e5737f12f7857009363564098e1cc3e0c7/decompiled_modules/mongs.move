module 0xe76186ecf475c2bf9f5e9d3683c270e5737f12f7857009363564098e1cc3e0c7::mongs {
    ...
    fun init(arg0: MONGS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MONGS>(arg0, 6, b"MS", b"MongSUI", b"https://t.me/MongSUI", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://i.imgur.com/h0omlTj.jpg"))), arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<MONGS>>(v1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<MONGS>>(v0, @0x6f2c8f236d13636292b8776f2fafbedddb29aea4547fd26ed585cf27a62c979f);
    }
