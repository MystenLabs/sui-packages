module 0xe720e182dde0f7203ff3607ac108ae388905df778b6a7c67d03694ebc3251678::reward1428 {
    struct REWARD1428 has drop {
        dummy_field: bool,
    }

    struct TICKET_1428 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1428(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1428>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1428>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1428, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1428>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1428>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1428>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1428>>(v5, 0x2::tx_context::sender(arg1));
    }
