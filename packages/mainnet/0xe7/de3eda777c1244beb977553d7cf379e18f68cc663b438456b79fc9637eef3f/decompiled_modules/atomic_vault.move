module 0xc7f7c2720fff9454db35fda838e432afb640c33a0c4b9ac1ea2cc36f1a293876::atomic_vault {
    ...
    public(friend) fun withdraw_for_liquidation<T0>(arg0: &mut LiquidationVault, arg1: u64) : 0x2::balance::Balance<T0> {
        withdraw_balance<T0>(arg0, arg1)
    }
