module 0xe7e06cfbe7b0aad520d70c72735a1aefc59cb1f8b4528c64b1fe220b50e5f6bf::campaign {
    ...
    public entry fun create_campaign(arg0: address, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (Campaign, CampaignCap) {
        assert!(arg1 > 0, 2);
        let v0 = Campaign{
        ...
        0xe7e06cfbe7b0aad520d70c72735a1aefc59cb1f8b4528c64b1fe220b50e5f6bf::events::emit_campaign_created(v1, arg0, arg1, arg2);
        (v0, v2)
    }
    ...
    public fun has_wlt_rewards(arg0: &Campaign) : bool {
    ...
    public fun update_status(arg0: &mut Campaign, arg1: u8, arg2: &CampaignCap, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2::object::id<Campaign>(arg0) == arg2.campaign_id, 4);
        assert!(arg0.creator == 0x2::tx_context::sender(arg3), 5);
        assert!(arg1 <= 2, 6);
        arg0.status = arg1;
        0xe7e06cfbe7b0aad520d70c72735a1aefc59cb1f8b4528c64b1fe220b50e5f6bf::events::emit_campaign_status_changed(0x2::object::id<Campaign>(arg0), arg0.status, arg1);
    }
