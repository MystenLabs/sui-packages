module 0xe771e2bb32a1fc86988a54afeb32fe568cfe2272af5eaa6d8aacd358837a745b::reward5862 {
    struct REWARD5862 has drop {
        dummy_field: bool,
    }

    struct TICKET_5862 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5862(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5862>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5862>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5862, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5862>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5862>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5862>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5862>>(v5, 0x2::tx_context::sender(arg1));
    }
