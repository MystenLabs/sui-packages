module 0xe726841c671fb6009bb532113886d9725fd22ef78d8a9adca60a3a189e239f47::bird {
    ...
    public fun action(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 <= 1, 8004);
        assert!(v2 > arg2.action_nonce, 8003);
        arg2.action_nonce = v2;
        if (v1 == 1) {
    ...
    public fun update_admin(arg0: BirdAdminCap, arg1: address, arg2: &mut 0xe726841c671fb6009bb532113886d9725fd22ef78d8a9adca60a3a189e239f47::version::Version) {
        0xe726841c671fb6009bb532113886d9725fd22ef78d8a9adca60a3a189e239f47::version::checkVersion(arg2, 1);
        0x2::transfer::public_transfer<BirdAdminCap>(arg0, arg1);
    }

    public fun update_validator(arg0: &BirdAdminCap, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut 0xe726841c671fb6009bb532113886d9725fd22ef78d8a9adca60a3a189e239f47::version::Version) {
        0xe726841c671fb6009bb532113886d9725fd22ef78d8a9adca60a3a189e239f47::version::checkVersion(arg3, 1);
