module 0xe7afb00dcf8a24ccd9152214da4ce9799336f6feaf7fb72a628eb195218b789d::kiosk_swap {
    ...
    public fun execute_swap(arg0: &mut SwapProposal, arg1: &mut SwapEscrow, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut ProtocolConfig, arg5: &mut ProtocolTreasury, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(0x1::option::extract<0x2::kiosk::KioskOwnerCap>(&mut arg1.proposer_kiosk_cap), v1);
        ...
        if (v3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.proposer_sui_balance, v3, arg7), v1);
        };
        if (v4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.counterparty_sui_balance, v4, arg7), arg0.proposer);
        };
        arg0.state = 3;
        let v5 = SwapExecuted{
            proposal_id             : 0x2::object::id<SwapProposal>(arg0),
