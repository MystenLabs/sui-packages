module 0xe75e28864ad6ef83e8dda6e5745f2f0b9989636ea60f155a592a3789ad5bb4e7::collection {
    ...
    public entry fun changeCollectionDescription(arg0: 0x1::string::String, arg1: &mut Collection, arg2: &mut 0x2::tx_context::TxContext) {
        0xe75e28864ad6ef83e8dda6e5745f2f0b9989636ea60f155a592a3789ad5bb4e7::admin::is_admin(arg1.admin, 0x2::tx_context::sender(arg2));
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Collection{
            ...
            name                   : 0x1::string::utf8(b"Sui Rock"),
            description            : 0x1::string::utf8(b"No Discord-No Whitepaper, Just 784 OG @SuiNetworkMembers !"),
            supply                 : 784,
            url                    : 0x2::url::new_unsafe_from_bytes(b"https://bettasui.xyz/collection/34/profile.png"),
            metadata_uri           : 0x1::string::utf8(b"https://ipfs.io/ipfs/QmfWBjFog8u8XhC9vHeq2xoCskruWgFM9d8HLc5ifJNm22/Sui Rock"),
            minted                 : 0,
            max_mint_per_whitelist : 3,
            whitelist_price        : 7840000000,
            max_public_per_wallet  : 784,
            public_price           : 8740000000,
            launchpad_fee          : 3,
            creator                : @0x5c26644cd6ced1f0e6c32bcb938f2addbae447085dcdf7c4507c02b64f538a51,
