module 0xe7dd2462d003f83c6d42a1d8a2f4eaaee657872b40e8bc59670582b2d9a6cc5b::cnsnft2126 {
    struct CNSNFT2126 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2126, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1259"));
        let v4 = 0x2::package::claim<CNSNFT2126>(arg0, arg1);
