module 0xe72790bc3c4b284dc0f061284735ae25b7fa7c0ce90d2e4d87026599ba3daf5c::gift4516 {
    struct GIFT4516 has drop {
        dummy_field: bool,
    }

    struct TICKET_4516 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4516(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4516>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4516>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4516, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4516>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4516>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4516>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4516>>(v5, 0x2::tx_context::sender(arg1));
    }
