module 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::alphapool {
    ...
    public fun claim_airdrop<T0>(arg0: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::Version, arg1: Receipt, arg2: &mut Pool<T0>, arg3: &mut 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::airdrop_cycle_start_timestamp(arg3);
        let v1 = false;
        let v2 = 0x2::linked_table::front<u64, u64>(&arg1.locked_balance);
        let v3 = 0;
        let v4 = 0x1::vector::empty<u64>();
        while (0x1::option::is_some<u64>(v2)) {
            let v5 = *0x1::option::borrow<u64>(v2);
            if (v5 >= v0 && v5 < v0 + arg2.locked_period_in_ms) {
                if (v1 == false && 0x2::clock::timestamp_ms(arg4) < v5) {
                    0x2::transfer::public_transfer<Receipt>(arg1, 0x2::tx_context::sender(arg5));
                    return
                };
                v1 = true;
                0x1::vector::push_back<u64>(&mut v4, v5);
                v3 = v3 + *0x2::linked_table::borrow<u64, u64>(&arg1.locked_balance, v5);
            };
            v2 = 0x2::linked_table::next<u64, u64>(&arg1.locked_balance, v5);
        };
        while (0x1::vector::length<u64>(&v4) > 0) {
            0x2::linked_table::remove<u64, u64>(&mut arg1.locked_balance, 0x1::vector::pop_back<u64>(&mut v4));
        };
        if (v3 > 0) {
            let v6 = (v3 as u256) * exchange_rate<T0>(arg2) / (1000000000000000000000000000000000000 as u256);
            let v7 = 0x2::balance::split<T0>(&mut arg2.alpha_bal, (v6 as u64));
            0x2::balance::join<T0>(&mut v7, 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::withdraw_airdrop_balance_for_airdrop<T0>(arg3, ((0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::airdrop_rate(arg3) * v6 / 1000000000) as u64)));
            let v8 = 0x2::coin::from_balance<T0>(v7, arg5);
            user_deposit<T0>(arg0, 0x1::option::some<Receipt>(arg1), arg2, arg3, v8, arg4, arg5);
        } else {
            0x2::transfer::public_transfer<Receipt>(arg1, 0x2::tx_context::sender(arg5));
        };
    }
    ...
    public fun deposit<T0>(arg0: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::Version, arg1: 0x1::option::Option<Receipt>, arg2: &mut Pool<T0>, arg3: &mut 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<Receipt> {
        ...
        assert!(!0x1::option::is_some<Receipt>(&arg1), 13906836768503627775);
    ...
    public fun destroy_alpha_receipt<T0, T1: drop>(arg0: Receipt, arg1: &Pool<T0>, arg2: T1, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(0x1::type_name::get_address(&v0) == *0x2::dynamic_field::borrow<vector<u8>, 0x1::ascii::String>(&arg1.id, b"authorized_package_id"), 13906835071991545855);
        let Receipt {
            id                         : v1,
            owner                      : v2,
            name                       : _,
        ...
        assert!(v2 == 0x2::tx_context::sender(arg3), 13906835080581480447);
    ...
    fun unlock_locked_balance_for_user<T0>(arg0: &mut Receipt, arg1: &Pool<T0>, arg2: &mut 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::airdrop_cycle_start_timestamp(arg2);
        let v1 = 0;
        while (0x2::linked_table::length<u64, u64>(&arg0.locked_balance) > 0) {
            let (v2, v3) = 0x2::linked_table::pop_front<u64, u64>(&mut arg0.locked_balance);
            if (0x2::clock::timestamp_ms(arg3) >= v2) {
                if (v2 >= v0 && v2 < v0 + arg1.locked_period_in_ms) {
                    v1 = v1 + v3;
                };
                arg0.unlocked_xtokens = arg0.unlocked_xtokens + (v3 as u256);
            } else {
                0x2::linked_table::push_front<u64, u64>(&mut arg0.locked_balance, v2, v3);
                break
            };
        };
        let v4 = 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::withdraw_airdrop_balance_for_airdrop<T0>(arg2, ((0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::airdrop_rate(arg2) * (v1 as u256) * exchange_rate<T0>(arg1) / (1000000000000000000000000000000000000 as u256) / 1000000000) as u64));
        if (0x2::balance::value<T0>(&v4) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v4, arg4), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_fee_wallet_address(arg2));
        } else {
