module 0x3e75d430e1493c40ad6998170f4ec5dd05e30c46db7a8050776990a239495c50::domain {
    ...
    public entry fun add_address(arg0: &mut Domain, arg1: 0x1::ascii::String, arg2: 0x1::ascii::String) {
        assert!(arg0.version == 1, 3);
        set_address_internal(arg0, arg1, arg2);
    }
    ...
    public entry fun remove_address(arg0: &mut Domain, arg1: 0x1::ascii::String) {
        assert!(arg0.version == 1, 3);
        remove_address_internal(arg0, arg1);
    }
