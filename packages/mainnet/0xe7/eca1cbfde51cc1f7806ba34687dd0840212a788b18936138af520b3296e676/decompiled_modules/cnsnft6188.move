module 0xe7eca1cbfde51cc1f7806ba34687dd0840212a788b18936138af520b3296e676::cnsnft6188 {
    struct CNSNFT6188 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6188, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6188>(arg0, arg1);
