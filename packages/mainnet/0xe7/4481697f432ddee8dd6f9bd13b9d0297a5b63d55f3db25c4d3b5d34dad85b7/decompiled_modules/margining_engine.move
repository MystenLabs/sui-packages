module 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::margining_engine {
    ...
    public(friend) fun apply_maths(arg0: &mut 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::data_store::InternalDataStore, arg1: 0x1::string::String, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: bool, arg7: bool, arg8: bool, arg9: u8, arg10: 0x1::option::Option<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::signed_number::Number>, arg11: 0x1::option::Option<bool>) : (u64, u64, 0x1::string::String, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::Position, vector<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::DepositedAsset>, u64, u64) {
        ...
        let v1 = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::data_store::get_immutable_assets_table_from_ids(arg0);
        let v2 = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::data_store::get_immutable_perpetual_from_ids(arg0, arg1);
        let v3 = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::data_store::get_immutable_account_from_ids(arg0, arg2);
        let v4 = if (arg7) {
            arg1
        } else {
            0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::empty_string()
        };
        let v5 = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::get_positions_vector(v3, v4);
        let v6 = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::get_assets_vector(v3, v4);
        let v7 = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::get_positions_vector(v3, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::empty_string());
        let v8 = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::get_assets_vector(v3, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::empty_string());
        let v9 = v6;
        let v10 = if (arg7) {
            &mut v8
        } else {
        ...
        let (v11, v12) = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::get_mutable_position_for_perpetual(&mut v5, arg1, arg7);
        if (0x1::vector::length<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::Position>(&v5) < v12 + 1) {
            0x1::vector::push_back<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::Position>(&mut v5, *v11);
        };
        let (_, v14, v15, v16, v17, v18, _, v20) = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::get_position_values(v11);
        assert!(!arg7 || arg5 > 0, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::errors::invalid_leverage());
        let v21 = if (!arg7) {
            true
        } else if (v14 == 0) {
            true
        ...
        assert!(v21, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::errors::invalid_leverage());
        ...
        0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::set_isolated_position_assets(&mut v6, v34);
        0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::update_position_values(v11, v23, v24, v34, v33, v22, 0);
        verify_health(v0, v1, &v6, &v5, &v9, &v5, v12, arg9, arg8);
        let v37 = if (arg7) {
            if (arg9 == 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::action_trade() || arg9 == 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::action_liquidate()) {
                !0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::utils::is_reducing_trade(v16, v14, arg6, arg4)
            } else {
                false
            }
        } else {
        ...
        if (v37) {
            verify_health(v0, v1, &v8, &v7, &v8, &v7, v12, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::action_isolated_trade(), arg8);
        };
        let v38 = if (arg7) {
            v8
        } else {
        ...
        v6 = v38;
        0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::update_account(0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::data_store::get_mutable_account_from_ids(arg0, arg2), &v6, &v5, v12, arg7);
    ...
    fun settle_gas_charges(arg0: &0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::data_store::InternalDataStore, arg1: &mut vector<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::DepositedAsset>, arg2: &0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::Account, arg3: 0x1::option::Option<bool>, arg4: bool, arg5: u8) : u64 {
        let v0 = 0;
        if (arg5 == 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::action_trade() && !arg4) {
            ...
            if (0x1::option::extract<bool>(&mut arg3) && !0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::is_institution(arg2)) {
                let v1 = 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::data_store::get_gas_fee_amount(arg0);
                v0 = v1;
    ...
    fun settle_margin(arg0: &mut vector<0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account::DepositedAsset>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: bool, arg7: bool, arg8: u8) : (u64, u64, u64) {
        let v0 = arg1;
        if (arg7) {
