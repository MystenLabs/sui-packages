module 0x2132f846be6b40cac03f581cebe58464c7b8d8e85e14822a69f15822447d82f0::oracle {
    ...
    public fun get_surrounding_observations(arg0: &ObservationManager, arg1: u64, arg2: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg3: u128) : (Observation, Observation) {
        ...
        assert!(v0.timestamp <= arg1, 0x2132f846be6b40cac03f581cebe58464c7b8d8e85e14822a69f15822447d82f0::errors::invalid_observation_timestamp());
    ...
    public fun transform(arg0: &Observation, arg1: u64, arg2: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg3: u128) : Observation {
        ...
        Observation{
            ...
            seconds_per_liquidity_cumulative : 0x2132f846be6b40cac03f581cebe58464c7b8d8e85e14822a69f15822447d82f0::utils::overflow_add(arg0.seconds_per_liquidity_cumulative, ((v1 as u256) << 128) / (v2 as u256)),
            initialized                      : true,
        }
    }
