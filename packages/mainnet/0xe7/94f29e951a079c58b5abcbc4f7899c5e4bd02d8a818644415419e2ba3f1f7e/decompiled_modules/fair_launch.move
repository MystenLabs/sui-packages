module 0xe794f29e951a079c58b5abcbc4f7899c5e4bd02d8a818644415419e2ba3f1f7e::fair_launch {
    ...
    public fun create_fair_launch<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: 0x2::coin::Coin<T0>, arg10: vector<address>, arg11: vector<u64>, arg12: bool, arg13: vector<u8>, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) {
        assert!(arg0 < arg2, 1);
        assert!(arg0 > 0x2::clock::timestamp_ms(arg14), 1);
        validate_params(arg3, arg4, arg5, arg7, arg8, 0x2::coin::value<T0>(&arg9), arg12);
        let v0 = FairLaunch<T0, T1>{
            id                    : 0x2::object::new(arg15),
            curator               : 0x2::tx_context::sender(arg15),
            start_time            : arg0,
            market_only_whitelist : arg1,
            end_time              : arg2,
            soft_cap              : arg3,
            max_contribution      : arg4,
            liquidity_percent     : arg5,
            lp_lock_period        : arg6,
            total_tokens          : arg7,
            ...
            is_finalized          : false,
            contributed           : 0,
            admin_public_key      : arg13,
            signatures            : 0x2::table::new<vector<u8>, bool>(arg15),
            timestamp_last_ms     : 0,
            priority_caps         : 0x2::table::new<address, u64>(arg15),
        };
        let v1 = &mut v0;
        add<T0, T1>(v1, arg10, arg11);
    ...
    public fun finalize_fair_launch<T0, T1>(arg0: &mut FairLaunch<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::coin::CoinMetadata<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (Locker<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v3 = v2 * (arg0.total_tokens - arg0.total_sell_token_x) / v1;
        ...
        (v13, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance_x, 0x2::balance::value<T0>(&arg0.balance_x) - arg0.total_sell_token_x), arg6), 0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(&mut arg0.balance_y), arg6))
    }
    ...
    fun validate_params(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: bool) {
        assert!(arg0 > 0, 1);
        assert!(arg1 > 0, 1);
        assert!(arg2 >= 5100, 10);
