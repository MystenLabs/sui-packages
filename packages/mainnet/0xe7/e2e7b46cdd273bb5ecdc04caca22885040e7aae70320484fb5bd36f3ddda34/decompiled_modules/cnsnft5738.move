module 0xe7e2e7b46cdd273bb5ecdc04caca22885040e7aae70320484fb5bd36f3ddda34::cnsnft5738 {
    struct CNSNFT5738 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5738, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5738>(arg0, arg1);
