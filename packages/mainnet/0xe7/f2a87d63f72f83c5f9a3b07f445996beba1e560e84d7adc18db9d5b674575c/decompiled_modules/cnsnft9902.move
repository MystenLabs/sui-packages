module 0xe7f2a87d63f72f83c5f9a3b07f445996beba1e560e84d7adc18db9d5b674575c::cnsnft9902 {
    struct CNSNFT9902 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9902, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9902>(arg0, arg1);
