module 0xe7b78ea5c50c3a024e3d443510fc6b1bd92f6c3112318f04fedb3ff1c04db068::github_nft {
    ...
    fun init(arg0: GITHUB_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{SEAL Hype on Sui} #{ID}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"This badge is given to those who helped create and build excitement around SealionSui on the Sui blockchain. "));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://plum-immediate-monkey-743.mypinata.cloud/ipfs/bafkreicri5abxqtfb76257llzzkv3p6x4xhcs5usgwyb6iczectcs2ima4"));
