module 0xe728b605d3a54b703893cf7356d0c868fb37e5f0e9ca41d292f6e5dfd4386738::vault {
    ...
    public fun get_optimal_swap_amount_for_single_sided_liquidity<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: u64, arg3: bool, arg4: u64) : (u64, bool) {
        ...
        let v6 = false;
        while (v4 < arg4) {
            let v7 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::calculate_swap_result<T0, T1>(arg1, arg3, true, v5);
            ...
            let v11 = (v9 as u128) * (v2 as u128) / (v10 as u128);
            if (v4 == 0) {
            } else if (v11 > v3) {
                if (arg3) {
                    let v12 = arg2 + v5;
