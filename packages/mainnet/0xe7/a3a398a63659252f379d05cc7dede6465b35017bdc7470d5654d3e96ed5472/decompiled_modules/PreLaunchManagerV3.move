module 0xe7a3a398a63659252f379d05cc7dede6465b35017bdc7470d5654d3e96ed5472::PreLaunchManagerV3 {
    ...
    public entry fun finish_round<T0>(arg0: &mut PreLaunchManagerV3, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x2::sui::SUI, T0>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::borrow_mut<Round>(&mut arg0.rounds, arg1);
        assert!(v0.creator == 0x2::tx_context::sender(arg5), 1);
        v0.is_finished = true;
        open_position_with_liquidity_with_all<0x2::sui::SUI, T0>(arg3, arg4, 1, 100, 10, 10, false, arg2, arg5);
    }
