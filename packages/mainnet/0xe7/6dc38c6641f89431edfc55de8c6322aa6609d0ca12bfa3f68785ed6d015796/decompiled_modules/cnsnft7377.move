module 0xe76dc38c6641f89431edfc55de8c6322aa6609d0ca12bfa3f68785ed6d015796::cnsnft7377 {
    struct CNSNFT7377 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7377, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6207"));
        let v4 = 0x2::package::claim<CNSNFT7377>(arg0, arg1);
