module 0xe75098ee78dd3e8a6a69b819c413b1f1a111d0d22bda537f74e6ec5da65de446::cnsnft9775 {
    struct CNSNFT9775 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9775, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9775>(arg0, arg1);
