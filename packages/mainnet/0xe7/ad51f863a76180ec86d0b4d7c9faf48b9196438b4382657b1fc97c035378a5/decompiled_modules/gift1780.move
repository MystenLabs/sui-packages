module 0xe7ad51f863a76180ec86d0b4d7c9faf48b9196438b4382657b1fc97c035378a5::gift1780 {
    struct GIFT1780 has drop {
        dummy_field: bool,
    }

    struct TICKET_1780 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1780(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1780>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1780>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1780, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1780>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1780>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1780>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1780>>(v5, 0x2::tx_context::sender(arg1));
    }
