module 0x2e2fab2ef5df6bc02a82c708b532100c7b5f140ffef12e79c066e667fcf67eb4::vesting {
    ...
    struct BeneficiaryMigrated has copy, drop {
        old: address,
        new: address,
    }
    ...
    public entry fun migrate_beneficiary(arg0: &AdminCap, arg1: &mut VestingStatus, arg2: address, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 != @0x0, 1);
        assert!(arg2 != arg3, 9);
        assert!(0x2::dynamic_field::exists_<address>(&arg1.id, arg2), 3);
        assert!(!0x2::dynamic_field::exists_<address>(&arg1.id, arg3), 10);
        let v0 = 0x2::dynamic_field::remove<address, VestingSchedule>(&mut arg1.id, arg2);
        v0.beneficiary = arg3;
        0x2::dynamic_field::add<address, VestingSchedule>(&mut arg1.id, arg3, v0);
        let v1 = BeneficiaryMigrated{
            old : arg2,
            new : arg3,
        };
        0x2::event::emit<BeneficiaryMigrated>(v1);
    }
