module 0xe7747f4471e43d80c353de3842de897b3cbfb0d2444b7f8749cd77536c66914c::reward7714 {
    struct REWARD7714 has drop {
        dummy_field: bool,
    }

    struct TICKET_7714 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7714(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7714>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7714>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7714, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7714>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7714>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7714>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7714>>(v5, 0x2::tx_context::sender(arg1));
    }
