module 0xe7e651e4974fe367aa2837712d68081efb299c470242a15e2b9c26ea326159ec::card {
    ...
    fun init(arg0: CARD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<SudoCard>(&mut v6, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://img.sudo.finance/{id}.wbep/"));
        0x2::display::update_version<SudoCard>(&mut v6);
        let v7 = 0x2::display::new<MintTicket>(&v0, arg1);
        0x2::display::add<MintTicket>(&mut v7, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"Sudo Membership Mint Ticket"));
        ...
        0x2::display::add<MintTicket>(&mut v7, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://img.sudo.finance/mint_ticket/{tier}.wbep/"));
