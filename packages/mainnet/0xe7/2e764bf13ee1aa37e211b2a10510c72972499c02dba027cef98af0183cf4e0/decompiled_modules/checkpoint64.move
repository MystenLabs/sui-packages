module 0xe72e764bf13ee1aa37e211b2a10510c72972499c02dba027cef98af0183cf4e0::checkpoint64 {
    ...
    fun lower_binary_lockup(arg0: &vector<Checkpoint64>, arg1: u64, arg2: u64, arg3: u64) : u64 {
        while (arg2 < arg3) {
            let v0 = 0xe72e764bf13ee1aa37e211b2a10510c72972499c02dba027cef98af0183cf4e0::math_utils::average_u64(arg2, arg3);
    ...
    public fun upper_lockup_recent(arg0: &Trace64, arg1: u64) : (u64, u64) {
        ...
        let v2 = v0;
        if (v0 > 5) {
            let v3 = v0 - 0xe72e764bf13ee1aa37e211b2a10510c72972499c02dba027cef98af0183cf4e0::math_utils::sqrt_u64(v0);
