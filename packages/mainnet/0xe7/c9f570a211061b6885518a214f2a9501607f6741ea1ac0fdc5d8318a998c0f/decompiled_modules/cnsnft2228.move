module 0xe7c9f570a211061b6885518a214f2a9501607f6741ea1ac0fdc5d8318a998c0f::cnsnft2228 {
    struct CNSNFT2228 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2228, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2228>(arg0, arg1);
