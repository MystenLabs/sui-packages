module 0xe74d0da58ef8a5019d04c36f5a6120aeadc29a3a5f298c9cc514a6cb3ee07afe::phantom_froze_over {
    struct PHANTOM_FROZE_OVER has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PHANTOM_FROZE_OVER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PHANTOM_FROZE_OVER>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Phantom Froze Over"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://af5nRsjX6RH_kitY5-BgtQofbvdCDdWKeF-lYFxqKJk"));
    ...
    public fun withdraw_balance<T0, T1>(arg0: &Store, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let v0 = 0x2::kiosk::borrow_mut<Nft>(arg2, arg3, arg1);
        let v1 = BalanceKey<T0>{dummy_field: false};
        let v2 = if (0x2::dynamic_object_field::exists_with_type<BalanceKey<T0>, 0x2::coin::Coin<T0>>(&v0.id, v1)) {
            ...
            0x2::dynamic_object_field::remove<BalanceKey<T0>, 0x2::coin::Coin<T0>>(&mut v0.id, v5)
        } else {
            0x2::coin::zero<T0>(arg4)
        };
        let v6 = BalanceKey<T1>{dummy_field: false};
        let v7 = if (0x2::dynamic_object_field::exists_with_type<BalanceKey<T1>, 0x2::coin::Coin<T1>>(&v0.id, v6)) {
            ...
            let v10 = BalanceKey<T1>{dummy_field: false};
            0x2::dynamic_object_field::remove<BalanceKey<T1>, 0x2::coin::Coin<T1>>(&mut v0.id, v10)
        } else {
