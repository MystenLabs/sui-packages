module 0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::studio {
    ...
    public fun new(arg0: &mut 0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::config::Config, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::derived_object::claim<address>(0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::config::uid_mut(arg0), v0);
        0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::storage::new(&mut v1, v0);
        let v2 = Period{
            pos0 : 0,
            pos1 : 0,
        };
        ...
        0x2::transfer::share_object<Studio>(v3);
    }

    public(friend) fun add_asset<T0: store + key>(arg0: &mut Studio, arg1: &0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::config::Config, arg2: T0, arg3: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg3), 101);
        0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::config::assert_allowed_works<T0>(arg1);
    ...
    fun check_policy(arg0: vector<u8>, arg1: &Studio, arg2: &0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::config::Config, arg3: address, arg4: &0x2::clock::Clock) : bool {
        0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::config::assert_version(arg2);
    ...
    entry fun seal_approve(arg0: &0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::config::Config, arg1: vector<u8>, arg2: &Studio, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun studio_exists(arg0: &0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::config::Config, arg1: address) : bool {
        0x2::derived_object::exists<address>(0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::config::uid_borrow(arg0), arg1)
    }

    public fun studio_of(arg0: &0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::config::Config, arg1: address) : 0x2::object::ID {
        0x2::object::id_from_address(0x2::derived_object::derive_address<address>(0x2::object::id<0xe7caee53bc69c3dcd19fb377206190adf20be0d6a1b3ddef8ecd5fa4ef1fb69d::config::Config>(arg0), arg1))
    }
