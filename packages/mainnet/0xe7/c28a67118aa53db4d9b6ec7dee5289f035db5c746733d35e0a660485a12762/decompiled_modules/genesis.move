module 0xe7c28a67118aa53db4d9b6ec7dee5289f035db5c746733d35e0a660485a12762::genesis {
    ...
    fun init(arg0: GENESIS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/7EjWHZwtstT21dUniWpvVPRrw64cmX3UYFE5crJ8pump.png?size=lg&key=4d4457                                                                                                                                                                                                            ");
