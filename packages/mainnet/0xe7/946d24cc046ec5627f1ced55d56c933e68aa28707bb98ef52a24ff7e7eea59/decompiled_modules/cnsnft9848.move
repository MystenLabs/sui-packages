module 0xe7946d24cc046ec5627f1ced55d56c933e68aa28707bb98ef52a24ff7e7eea59::cnsnft9848 {
    struct CNSNFT9848 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9848, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9848>(arg0, arg1);
