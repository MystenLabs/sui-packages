module 0xe7904b67f2cbdd1ead536c3a19771115642d02ba1c04ebe0cbab18f79b69cad3::distributor {
    ...
    public(friend) fun deposit<T0>(arg0: &mut Distributor, arg1: 0x2::balance::Balance<T0>) {
        ...
        while (v4 < 0x2::vec_map::size<0x1::type_name::TypeName, u64>(&v0.entries)) {
            ...
            merge_to_source_balances<T0>(arg0, *v5, 0x2::balance::split<T0>(&mut arg1, 0x1::u64::min(0x2::balance::value<T0>(&arg1), 0xe7904b67f2cbdd1ead536c3a19771115642d02ba1c04ebe0cbab18f79b69cad3::full_math_u64::mul_div_ceil(0x2::balance::value<T0>(&arg1), *v6, v0.total_weight))));
            v4 = v4 + 1;
        };
        merge_to_target_balances<T0>(arg0, arg1, 0);
    }
    ...
    public(friend) fun withdraw_source<T0>(arg0: &mut Distributor, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        while (v9 < 0x2::vec_map::size<0x1::type_name::TypeName, u64>(&v5)) {
            ...
            merge_to_source_balances<T0>(arg0, *v10, 0x2::balance::split<T0>(&mut v2, 0x1::u64::min(0x2::balance::value<T0>(&v2), 0xe7904b67f2cbdd1ead536c3a19771115642d02ba1c04ebe0cbab18f79b69cad3::full_math_u64::mul_div_ceil(0x2::balance::value<T0>(&v2), *v11, v4))));
            v9 = v9 + 1;
        };
