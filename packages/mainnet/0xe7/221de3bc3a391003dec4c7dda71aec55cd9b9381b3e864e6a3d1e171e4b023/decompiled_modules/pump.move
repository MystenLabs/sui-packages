module 0xe7221de3bc3a391003dec4c7dda71aec55cd9b9381b3e864e6a3d1e171e4b023::pump {
    ...
    fun init(arg0: PUMP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PUMP>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"pump      ")))), trim_right(b"imposter                        "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
