module 0xe7d93793f842e0ffbd5c914fee305eb3827bc25dc1f45f0f17e69f7b6e996db9::gift6181 {
    struct GIFT6181 has drop {
        dummy_field: bool,
    }

    struct TICKET_6181 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6181(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6181>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6181>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6181, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6181>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6181>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6181>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6181>>(v5, 0x2::tx_context::sender(arg1));
    }
