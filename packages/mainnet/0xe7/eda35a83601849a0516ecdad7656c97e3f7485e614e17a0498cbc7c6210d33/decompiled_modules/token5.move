module 0xe7eda35a83601849a0516ecdad7656c97e3f7485e614e17a0498cbc7c6210d33::token5 {
    ...
    fun init(arg0: TOKEN5, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN5>(arg0, 9, b"li.fi", b"li.fi", b"", 0x1::option::none<0x2::url::Url>(), arg1);
