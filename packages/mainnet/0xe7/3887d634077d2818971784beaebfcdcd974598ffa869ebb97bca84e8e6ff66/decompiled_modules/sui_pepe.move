module 0xe73887d634077d2818971784beaebfcdcd974598ffa869ebb97bca84e8e6ff66::sui_pepe {
    ...
    fun init(arg0: SUI_PEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUI_PEPE>(arg0, 4, b"SPEPE2", b"SUI PEPE2", b"The biggest memecoin on SUI blockchain.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://sui-pepe.xyz/_next/static/media/logo.6e0d8f53.png")), arg1);
        let v2 = v0;
