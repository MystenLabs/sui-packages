module 0xe716eb7bcf8ade2a79dc22254177b1b1295344ae08709f3bbe55f594810ad983::bob_the_reveal {
    struct BOB_THE_REVEAL has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BOB_THE_REVEAL, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BOB_THE_REVEAL>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Bob The Reveal"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Bob: A New Beginning. This is the first reveal of our character, Bob. He was once a fossil buried deep within the SUI, and now he has been brought back to life to claim the kingdom"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiabalx6f4n5n2otkasitrxkhfslsy4v3jttukc2fm2ctz2op47lb4"));
