module 0xe74d5f7578c3d032ab64aaf1b05a23ed41da79939f0083501ac2ed7d35c29298::reward5646 {
    struct REWARD5646 has drop {
        dummy_field: bool,
    }

    struct TICKET_5646 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5646(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5646>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5646>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5646, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5646>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5646>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5646>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5646>>(v5, 0x2::tx_context::sender(arg1));
    }
