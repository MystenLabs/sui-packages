module 0xe7b3bb8b76bf945e6276be035a163f8e7419f91886fa52acb6a8df70c06c2020::reward1577 {
    struct REWARD1577 has drop {
        dummy_field: bool,
    }

    struct TICKET_1577 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1577(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1577>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1577>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1577, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1577>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1577>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1577>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1577>>(v5, 0x2::tx_context::sender(arg1));
    }
