module 0xe78ed1f5ae4d7569c641a0cd647d443958095690524414fbdea1bb1a2b2540e1::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"LAZY", b"Test sui", b"TEST", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-23T12-10-56.731Z-ChatGPT Image Oct 17, 2025, 06_28_10 PM.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Test sui"),
            symbol     : 0x1::string::utf8(b"LAZY"),
            decimals   : 9,
