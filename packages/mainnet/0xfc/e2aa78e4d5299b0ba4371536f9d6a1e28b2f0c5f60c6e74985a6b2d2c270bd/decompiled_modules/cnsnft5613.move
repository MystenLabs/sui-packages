module 0xfce2aa78e4d5299b0ba4371536f9d6a1e28b2f0c5f60c6e74985a6b2d2c270bd::cnsnft5613 {
    struct CNSNFT5613 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5613, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4224"));
        let v4 = 0x2::package::claim<CNSNFT5613>(arg0, arg1);
