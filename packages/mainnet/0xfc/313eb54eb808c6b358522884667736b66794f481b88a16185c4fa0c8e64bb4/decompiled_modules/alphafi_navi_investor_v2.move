module 0xa095412a92ff0f063cbea962f2f88b1a93cbc85c72bebf5dd7d90a8e2d6375ae::alphafi_navi_investor_v2 {
    ...
    public(friend) fun autocompound<T0>(arg0: &mut Investor<T0>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg2: &0x2::clock::Clock, arg3: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg6: u8, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg9: &mut 0x3::sui_system::SuiSystemState, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::unnormal_amount<T0>(arg5, v1) > 0) {
            let v3 = withdraw_from_navi<T0>(arg0, arg2, arg3, arg4, arg5, arg6, v1, arg7, arg8, arg9, arg10);
            0x2::balance::join<T0>(&mut v2, v3);
        };
        let v4 = (0x2::balance::value<T0>(&v2) as u128) * (arg0.performance_fee as u128) / 10000;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v2, (v4 as u64)), arg10), 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::get_fee_wallet_address(arg1));
        ...
        if (0x2::balance::value<T0>(&v2) > 0) {
            deposit<T0>(arg0, arg2, arg4, arg5, arg6, 0x2::coin::from_balance<T0>(v2, arg10), arg7, arg8);
        } else {
    ...
    public(friend) fun autocompound_with_three_swaps<T0, T1, T2, T3>(arg0: &mut Investor<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: u8, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::IncentiveFundsPool<T3>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T3, T2>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg8: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg9: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T3>()) == true) {
            0x2::balance::join<T3>(&mut v1, 0x2::balance::withdraw_all<T3>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T3>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T3>())));
        };
        let v2 = 0x2::balance::zero<T0>();
        let v3 = 0x2::balance::value<T3>(&v1);
        if (v3 >= arg0.minimum_swap_amount) {
            let (v4, v5) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_a2b<T3, T2>(arg9, arg6, 0x2::coin::from_balance<T3>(v1, arg10), true, v3, arg1, arg10);
            let v6 = v5;
            ...
            if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T2>()) == true) {
                0x2::coin::join<T2>(&mut v6, 0x2::coin::from_balance<T2>(0x2::balance::withdraw_all<T2>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T2>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T2>())), arg10));
            };
            let v7 = 0x2::coin::value<T2>(&v6);
            if (v7 >= arg0.minimum_swap_amount) {
                let (v8, v9) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_b2a<T1, T2>(arg9, arg7, v6, true, v7, arg1, arg10);
                let v10 = v8;
                ...
                if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T1>()) == true) {
                    0x2::coin::join<T1>(&mut v10, 0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T1>())), arg10));
                };
                let v11 = 0x2::coin::value<T1>(&v10);
                if (v11 >= arg0.minimum_swap_amount) {
                    let (v12, v13) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_a2b<T1, T0>(arg9, arg8, v10, true, v11, arg1, arg10);
    ...
    public(friend) fun autocompound_with_two_swaps<T0, T1, T2>(arg0: &mut Investor<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: u8, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::IncentiveFundsPool<T2>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T1>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg8: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (v3 >= arg0.minimum_swap_amount) {
            let (v4, v5) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_a2b<T2, T1>(arg8, arg6, 0x2::coin::from_balance<T2>(v1, arg9), true, v3, arg1, arg9);
            let v6 = v5;
            0x2::coin::destroy_zero<T2>(v4);
            if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T1>()) == true) {
                0x2::coin::join<T1>(&mut v6, 0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T1>())), arg9));
            };
            let v7 = 0x2::coin::value<T1>(&v6);
            if (v7 >= arg0.minimum_swap_amount) {
                let (v8, v9) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_b2a<T0, T1>(arg8, arg7, v6, true, v7, arg1, arg9);
    ...
    public(friend) fun autocompound_with_two_swaps_v2<T0, T1, T2>(arg0: &mut Investor<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: u8, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::IncentiveFundsPool<T2>, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::IncentiveFundsPool<T0>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T1>, arg8: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg9: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::balance::value<T2>(&v1);
        if (v3 >= arg0.minimum_swap_amount) {
            let (v4, v5) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_a2b<T2, T1>(arg9, arg7, 0x2::coin::from_balance<T2>(v1, arg10), true, v3, arg1, arg10);
            let v6 = v5;
            0x2::coin::destroy_zero<T2>(v4);
            if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T1>()) == true) {
                0x2::coin::join<T1>(&mut v6, 0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T1>())), arg10));
            };
            let v7 = 0x2::coin::value<T1>(&v6);
            if (v7 >= arg0.minimum_swap_amount) {
                let (v8, v9) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_b2a<T0, T1>(arg9, arg8, v6, true, v7, arg1, arg10);
                0x2::coin::destroy_zero<T1>(v9);
                0x2::balance::join<T0>(&mut v2, 0x2::coin::into_balance<T0>(v8));
            } else {
                update_free_rewards<T0, T1>(arg0, 0x2::coin::into_balance<T1>(v6));
    ...
    public(friend) fun collect_reward_with_no_swap<T0>(arg0: &mut Investor<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: u8, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::RewardFund<T0>) {
        ...
        while (v10 < 0x1::vector::length<0x1::ascii::String>(&v7)) {
            if (*0x1::vector::borrow<0x1::ascii::String>(&v7, v10) == 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())) {
    ...
    public(friend) fun collect_reward_with_three_swaps<T0, T1, T2, T3>(arg0: &mut Investor<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: u8, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::RewardFund<T3>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T3, T2>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg8: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg9: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg10: &mut 0x2::tx_context::TxContext) {
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"is_autocompounding") == true && *0x2::dynamic_field::borrow<vector<u8>, bool>(&arg0.id, b"is_autocompounding") == false) {
            return
        };
        let v0 = get_total_invested<T0>(arg0, arg2, arg3, arg1);
        if (v0 == 0) {
        ...
        let v10 = 0;
        while (v10 < 0x1::vector::length<0x1::ascii::String>(&v7)) {
            if (*0x1::vector::borrow<0x1::ascii::String>(&v7, v10) == 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T3>())) {
                let v11 = 0x1::vector::empty<0x1::ascii::String>();
                0x1::vector::push_back<0x1::ascii::String>(&mut v11, *0x1::vector::borrow<0x1::ascii::String>(&v8, v10));
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T3>()) == true) {
            0x2::balance::join<T3>(&mut v9, 0x2::balance::withdraw_all<T3>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T3>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T3>())));
        };
        let v12 = 0x2::balance::zero<T0>();
        let v13 = 0x2::balance::value<T3>(&v9);
        if (v13 >= arg0.minimum_swap_amount) {
            let (v14, v15) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_a2b<T3, T2>(arg9, arg6, 0x2::coin::from_balance<T3>(v9, arg10), true, v13, arg1, arg10);
            let v16 = v15;
            0x2::coin::destroy_zero<T3>(v14);
            if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T2>()) == true) {
                0x2::coin::join<T2>(&mut v16, 0x2::coin::from_balance<T2>(0x2::balance::withdraw_all<T2>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T2>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T2>())), arg10));
            };
            let v17 = 0x2::coin::value<T2>(&v16);
            if (v17 >= arg0.minimum_swap_amount) {
                let (v18, v19) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_b2a<T1, T2>(arg9, arg7, v16, true, v17, arg1, arg10);
                let v20 = v18;
                0x2::coin::destroy_zero<T2>(v19);
                if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T1>()) == true) {
                    0x2::coin::join<T1>(&mut v20, 0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T1>())), arg10));
                };
                let v21 = 0x2::coin::value<T1>(&v20);
                if (v21 >= arg0.minimum_swap_amount) {
                    let (v22, v23) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_a2b<T1, T0>(arg9, arg8, v20, true, v21, arg1, arg10);
    ...
    public(friend) fun collect_reward_with_two_swaps<T0, T1, T2>(arg0: &mut Investor<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: u8, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::RewardFund<T2>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T1>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg8: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = 0;
        while (v10 < 0x1::vector::length<0x1::ascii::String>(&v7)) {
            if (*0x1::vector::borrow<0x1::ascii::String>(&v7, v10) == 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T2>())) {
                let v11 = 0x1::vector::empty<0x1::ascii::String>();
                0x1::vector::push_back<0x1::ascii::String>(&mut v11, *0x1::vector::borrow<0x1::ascii::String>(&v8, v10));
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T2>()) == true) {
            0x2::balance::join<T2>(&mut v9, 0x2::balance::withdraw_all<T2>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T2>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T2>())));
        };
        let v12 = 0x2::balance::zero<T0>();
        let v13 = 0x2::balance::value<T2>(&v9);
        if (v13 >= arg0.minimum_swap_amount) {
            let (v14, v15) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_a2b<T2, T1>(arg8, arg6, 0x2::coin::from_balance<T2>(v9, arg9), true, v13, arg1, arg9);
            let v16 = v15;
            0x2::coin::destroy_zero<T2>(v14);
            if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T1>()) == true) {
                0x2::coin::join<T1>(&mut v16, 0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T1>())), arg9));
            };
            let v17 = 0x2::coin::value<T1>(&v16);
            if (v17 >= arg0.minimum_swap_amount) {
                let (v18, v19) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_b2a<T0, T1>(arg8, arg7, v16, true, v17, arg1, arg9);
    ...
    public(friend) fun collect_reward_with_two_swaps_bluefin<T0, T1, T2>(arg0: &mut Investor<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: u8, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::RewardFund<T2>, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T1>, arg7: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg8: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig) {
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"is_autocompounding") == true && *0x2::dynamic_field::borrow<vector<u8>, bool>(&arg0.id, b"is_autocompounding") == false) {
            return
        };
        let v0 = get_total_invested<T0>(arg0, arg2, arg3, arg1);
        ...
        let v13 = 0x2::balance::value<T2>(&v9);
        if (v13 >= arg0.minimum_swap_amount) {
            let (v14, _) = get_bluefin_sqrt_price_limits<T2, T1>(arg6);
            let (v16, v17) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T2, T1>(arg1, arg8, arg6, v9, 0x2::balance::zero<T1>(), true, true, v13, 0, v14);
            let v18 = v17;
            0x2::balance::destroy_zero<T2>(v16);
            if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T1>()) == true) {
                0x2::balance::join<T1>(&mut v18, 0x2::balance::withdraw_all<T1>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T1>())));
            };
            let v19 = 0x2::balance::value<T1>(&v18);
            if (v19 >= arg0.minimum_swap_amount) {
                let (_, v21) = get_bluefin_sqrt_price_limits<T0, T1>(arg7);
                let (v22, v23) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, T1>(arg1, arg8, arg7, 0x2::balance::zero<T0>(), v18, false, true, (v19 as u64), 0, v21);
                0x2::balance::destroy_zero<T1>(v23);
                0x2::balance::join<T0>(&mut v12, v22);
            } else {
    ...
    public fun create_investor<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::DevCap, arg1: &0xa095412a92ff0f063cbea962f2f88b1a93cbc85c72bebf5dd7d90a8e2d6375ae::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun has_unclaimed_rewards<T0>(arg0: &Investor<T0>, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg3: &0x2::clock::Clock) : bool {
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"is_autocompounding") == false || *0x2::dynamic_field::borrow<vector<u8>, bool>(&arg0.id, b"is_autocompounding") == true) {
    ...
    entry fun is_autocompounding<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::AdminCap, arg1: &0xa095412a92ff0f063cbea962f2f88b1a93cbc85c72bebf5dd7d90a8e2d6375ae::version::Version, arg2: &mut Investor<T0>, arg3: bool) {
        0xa095412a92ff0f063cbea962f2f88b1a93cbc85c72bebf5dd7d90a8e2d6375ae::version::assert_current_version(arg1);
    ...
    entry fun set_minimum_swap_amount<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::DevCap, arg1: &0xa095412a92ff0f063cbea962f2f88b1a93cbc85c72bebf5dd7d90a8e2d6375ae::version::Version, arg2: &mut Investor<T0>, arg3: u64) {
        0xa095412a92ff0f063cbea962f2f88b1a93cbc85c72bebf5dd7d90a8e2d6375ae::version::assert_current_version(arg1);
        arg2.minimum_swap_amount = arg3;
    }

    entry fun set_performance_fee<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::DevCap, arg1: &0xa095412a92ff0f063cbea962f2f88b1a93cbc85c72bebf5dd7d90a8e2d6375ae::version::Version, arg2: &mut Investor<T0>, arg3: u64) {
        0xa095412a92ff0f063cbea962f2f88b1a93cbc85c72bebf5dd7d90a8e2d6375ae::version::assert_current_version(arg1);
