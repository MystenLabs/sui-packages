module 0xfc6c826ceafa58e712e93ff539ba94d97525b615ec85321eea38a076436b9943::cnsnft1000 {
    struct CNSNFT1000 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1000, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1000>(arg0, arg1);
