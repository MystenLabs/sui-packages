module 0xfcbef4a0da05755ab46d1463700c4d59ee096383577042acec075f6aaf5f13fa::config {
    ...
    public(friend) fun increase_version(arg0: &mut GlobalConfig) : (u64, u64) {
        assert!(arg0.version < 8, 0xfcbef4a0da05755ab46d1463700c4d59ee096383577042acec075f6aaf5f13fa::errors::verion_cant_be_increased());
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            min_tick        : 0xfcbef4a0da05755ab46d1463700c4d59ee096383577042acec075f6aaf5f13fa::tick_math::min_tick(),
            max_tick        : 0xfcbef4a0da05755ab46d1463700c4d59ee096383577042acec075f6aaf5f13fa::tick_math::max_tick(),
            version         : 8,
    ...
    public(friend) fun remove_reward_manager(arg0: &mut GlobalConfig, arg1: address) {
        assert!(verify_reward_manager(arg0, arg1), 0xfcbef4a0da05755ab46d1463700c4d59ee096383577042acec075f6aaf5f13fa::errors::reward_manager_not_found());
        let v0 = 0;
    ...
    public(friend) fun set_reward_manager(arg0: &mut GlobalConfig, arg1: address) {
        assert!(!verify_reward_manager(arg0, arg1), 0xfcbef4a0da05755ab46d1463700c4d59ee096383577042acec075f6aaf5f13fa::errors::already_a_reward_manger());
    ...
    public fun verify_version(arg0: &GlobalConfig) {
        assert!(arg0.version == 8, 0xfcbef4a0da05755ab46d1463700c4d59ee096383577042acec075f6aaf5f13fa::errors::version_mismatch());
    }
