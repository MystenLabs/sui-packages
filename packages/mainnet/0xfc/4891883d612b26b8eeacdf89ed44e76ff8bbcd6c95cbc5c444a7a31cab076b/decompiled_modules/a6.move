module 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::a6 {
    ...
    fun apply<T0, T1>(arg0: &mut A<T0, T1>, arg1: &0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::vault::Vault<T1>, arg2: &0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::aftermath_perp_adapter::PerpAccount<T0, T1>, arg3: &0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::config::LotusConfig, arg4: u64, arg5: 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::ClearingHouse<T1>, arg6: &mut 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::account::Account<T1>, arg7: &0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed_storage::PriceFeedStorage, arg8: &0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed_storage::PriceFeedStorage, arg9: u64, arg10: u64, arg11: u64, arg12: u8, arg13: u64, arg14: u64, arg15: u64, arg16: bool, arg17: bool, arg18: u8, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: u64, arg27: u64, arg28: u64, arg29: u64, arg30: u64, arg31: u64, arg32: u64, arg33: u64, arg34: &0x2::clock::Clock, arg35: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v52 = if (v51) {
            let (v53, _) = 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::mkpd(true, v47, arg0.cost, v6, v9, v3, v2, arg0.off, v26);
            v53
        } else {
            0
        };
        ...
        let v56 = if (v55) {
            let (v57, _) = 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::mkpd(false, v48, arg0.cost, v6, v9, v3, v2, arg0.off, v26);
            v57
        } else {
            0
        };
        let (v59, v60) = 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m0::cx(v52, v56, v3, v2, v26, arg12);
        let v61 = v60;
        let v62 = v59;
        if (arg16 && v43 > 0) {
            if (v32) {
                v62 = move_adverse_price_outward(v59, true, v43, v26);
            } else {
                v61 = move_adverse_price_outward(v60, false, v43, v26);
            };
        };
        let v63 = 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::rqd(arg0.b.o != 0, arg0.b.p, v62, true, econ_bound(v47, arg0.cost, true), arg0.improve, v26, arg0.b.e, v1, arg0.refresh);
        let v64 = 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::rqd(arg0.x.o != 0, arg0.x.p, v61, false, econ_bound(v48, arg0.cost, false), arg0.improve, v26, arg0.x.e, v1, arg0.refresh);
        if (arg0.b.o != 0 && (arg0.b.q > v38 || arg16 && (arg17 && material_size_change(arg0.b.q, v40) || arg0.b.q != v40))) {
            let v65 = if (v62 > 0 && v40 > 0) {
        ...
        let v67 = if (v63 == 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_replace()) {
            if (v62 > 0) {
                v40 > 0
            } else {
                false
        ...
        let v68 = if (v64 == 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_replace()) {
            if (v61 > 0) {
                v41 > 0
            } else {
                false
        ...
        if (v67 || v68) {
            let v69 = 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::mark_price<T1>(&arg5, arg7, arg34);
            let v70 = 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::market::min_order_usd_value(v25);
            if (v67 && !order_value_ok(v40, v69, v70)) {
                v62 = 0;
                v18 = v18 | 1024;
                let v71 = if (arg0.b.o != 0) {
                    0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_cancel()
                } else {
            ...
            if (v68 && !order_value_ok(v41, v69, v70)) {
                v61 = 0;
                v18 = v18 | 2048;
                let v72 = if (arg0.x.o != 0) {
                    0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_cancel()
                } else {
                    0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_keep()
                };
        ...
        let v73 = false;
        let v74 = false;
        if (v63 != 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_keep() && arg0.b.o != 0) {
            let v75 = &mut arg5;
            let (v76, v77) = cancel_one<T0, T1>(arg0, v75, arg6, true);
            if (v76) {
                v18 = v18 | 2;
            };
            v73 = v77;
        } else if (v63 == 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_keep() && arg0.b.o != 0) {
            v18 = v18 | 1;
        };
        if (v64 != 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_keep() && arg0.x.o != 0) {
            let v78 = &mut arg5;
            let (v79, v80) = cancel_one<T0, T1>(arg0, v78, arg6, false);
            if (v79) {
                v18 = v18 | 16;
            };
            v74 = v80;
        } else if (v64 == 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_keep() && arg0.x.o != 0) {
            v18 = v18 | 8;
        };
        let v81 = if (v63 == 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_replace()) {
            if (v62 > 0) {
                v40 > 0
            } else {
                false
        ...
        let v82 = if (v64 == 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_replace()) {
            if (v61 > 0) {
                v41 > 0
            } else {
                false
        ...
        if (v81 || v82) {
            let v83 = v1 + arg0.ttl;
            let v84 = 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::start_session<T1, 0x4e2df80a5e2fd0392878298c51ce15164222111ccea05504b9291b158f552677::authority::ASSISTANT>(arg5, &arg0.k, arg6, arg7, arg8, 0x1::option::none<0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::account::IntegratorInfo>(), arg34, arg35);
            if (v81) {
                let v85 = option_u128(0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::place_limit_order<T1>(&mut v84, false, v40, v62, 2, 0x1::option::some<u64>(client_id(arg9, false)), false, 0x1::option::some<u64>(v83)));
                if (v85 != 0) {
                    let v86 = L{
                        o : v85,
                        p : v62,
            ...
            if (v82) {
                let v87 = option_u128(0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::place_limit_order<T1>(&mut v84, true, v41, v61, 2, 0x1::option::some<u64>(client_id(arg9, true)), false, 0x1::option::some<u64>(v83)));
                if (v87 != 0) {
                    let v88 = L{
                        o : v87,
                        p : v61,
            ...
            let (v89, _) = 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::end_session<T1, 0x4e2df80a5e2fd0392878298c51ce15164222111ccea05504b9291b158f552677::authority::ASSISTANT>(v84, &arg0.k, arg6, false, false);
            0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::share<T1>(v89);
        } else {
            0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::share<T1>(arg5);
        };
        let v91 = if (!v15) {
        ...
        0x2::event::emit<DepthBbo>(v93);
        if (arg16) {
            let v94 = RebalanceSizing{
                desk                   : 0x2::object::uid_to_inner(&arg0.id),
                sequence               : arg9,
                position_size          : v21,
                position_long          : v22,
            ...
            0x2::event::emit<RebalanceSizing>(v94);
            let v95 = InventoryRiskState{
                desk                  : 0x2::object::uid_to_inner(&arg0.id),
                sequence              : arg9,
            ...
            0x2::event::emit<InventoryRiskState>(v95);
        };
        emit<T0, T1>(arg0, arg9, arg10, v91, v18, arg11, v3, v2, v14, v49, v73, v74, v21, v22);
        v18
    }
    ...
    fun apply_portfolio<T0, T1, T2>(arg0: &mut A<T0, T2>, arg1: &0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::vault::Vault<T2>, arg2: &0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::aftermath_perp_adapter::PerpAccount<T1, T2>, arg3: &0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::config::LotusConfig, arg4: u64, arg5: 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::ClearingHouse<T2>, arg6: &mut 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::account::Account<T2>, arg7: &0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed_storage::PriceFeedStorage, arg8: &0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed_storage::PriceFeedStorage, arg9: u64, arg10: u64, arg11: u64, arg12: u8, arg13: u64, arg14: u64, arg15: u64, arg16: bool, arg17: bool, arg18: u8, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: u64, arg27: u64, arg28: u64, arg29: u64, arg30: u64, arg31: u64, arg32: u64, arg33: u64, arg34: &A<T1, T2>, arg35: &0x2::clock::Clock, arg36: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let (v6, v7, v8) = depth_price(0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::orderbook<T2>(&arg5), false, v3, arg15);
        let (v9, v10, v11) = depth_price(0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::orderbook<T2>(&arg5), true, v2, arg15);
        let v12 = if (v8) {
            if (v11) {
                if (v6 > 0) {
                    v9 > v6
        ...
        if (v67 || v68) {
            let v69 = 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::mark_price<T2>(&arg5, arg7, arg35);
            let v70 = 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::market::min_order_usd_value(v25);
            if (v67 && !order_value_ok(v40, v69, v70)) {
                v62 = 0;
                v18 = v18 | 1024;
        ...
        if (v63 != 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_keep() && arg0.b.o != 0) {
            let v75 = &mut arg5;
            let (v76, v77) = cancel_one_with_cap<T0, T2>(arg0, v75, arg6, &arg34.k, true);
            if (v76) {
                v18 = v18 | 2;
            };
            v73 = v77;
        ...
        if (v64 != 0x24f8b13c74bfc9fb5401777608e8b811224437623124723ee78a6e52400f9085::m1::act_keep() && arg0.x.o != 0) {
            let v78 = &mut arg5;
            let (v79, v80) = cancel_one_with_cap<T0, T2>(arg0, v78, arg6, &arg34.k, false);
            if (v79) {
                v18 = v18 | 16;
            };
            v74 = v80;
        ...
        if (v81 || v82) {
            let v83 = v1 + arg0.ttl;
            let v84 = 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::start_session<T2, 0x4e2df80a5e2fd0392878298c51ce15164222111ccea05504b9291b158f552677::authority::ASSISTANT>(arg5, &arg34.k, arg6, arg7, arg8, 0x1::option::none<0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::account::IntegratorInfo>(), arg35, arg36);
            if (v81) {
                let v85 = option_u128(0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::place_limit_order<T2>(&mut v84, false, v40, v62, 2, 0x1::option::some<u64>(client_id(arg9, false)), false, 0x1::option::some<u64>(v83)));
                if (v85 != 0) {
                    let v86 = L{
                        o : v85,
                        p : v62,
            ...
            if (v82) {
                let v87 = option_u128(0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::place_limit_order<T2>(&mut v84, true, v41, v61, 2, 0x1::option::some<u64>(client_id(arg9, true)), false, 0x1::option::some<u64>(v83)));
                if (v87 != 0) {
                    let v88 = L{
                        o : v87,
                        p : v61,
            ...
            let (v89, _) = 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::end_session<T2, 0x4e2df80a5e2fd0392878298c51ce15164222111ccea05504b9291b158f552677::authority::ASSISTANT>(v84, &arg34.k, arg6, false, false);
            0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::share<T2>(v89);
        } else {
            0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::share<T2>(arg5);
        };
        let v91 = if (!v15) {
        ...
        emit<T0, T2>(arg0, arg9, arg10, v91, v18, arg11, v3, v2, v14, v49, v73, v74, v21, v22);
        v18
    }
