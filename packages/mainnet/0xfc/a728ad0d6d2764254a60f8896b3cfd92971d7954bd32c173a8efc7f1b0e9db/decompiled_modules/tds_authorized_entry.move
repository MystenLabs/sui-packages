module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::tds_authorized_entry {
    ...
    public(friend) entry fun activate<T0, T1, T2>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) entry fun disable_scallop<T0, T1>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        safety_check<T0, T1>(arg0, arg1, arg2);
    ...
    public(friend) entry fun disable_scallop_basic_lending<T0, T1>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        safety_check<T0, T1>(arg0, arg1, arg2);
        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::set_enable_scallop_basic_lending_flag_(arg0, arg1, false);
    ...
    public(friend) entry fun disable_suilend<T0, T1>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        safety_check<T0, T1>(arg0, arg1, arg2);
        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::set_enable_suilend_flag_(arg0, arg1, false);
        let v0 = DisableSuilend{
            signer : 0x2::tx_context::sender(arg2),
            index  : arg1,
        };
        0x2::event::emit<DisableSuilend>(v0);
    }
    ...
    public(friend) entry fun enable_scallop<T0, T1>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        safety_check<T0, T1>(arg0, arg1, arg2);
    ...
    public(friend) entry fun enable_scallop_basic_lending<T0, T1>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        safety_check<T0, T1>(arg0, arg1, arg2);
        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::set_enable_scallop_basic_lending_flag_(arg0, arg1, true);
    ...
    public(friend) entry fun enable_suilend<T0, T1>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        safety_check<T0, T1>(arg0, arg1, arg2);
        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::set_enable_suilend_flag_(arg0, arg1, true);
        let v0 = EnableSuilend{
            signer : 0x2::tx_context::sender(arg2),
            index  : arg1,
        };
        0x2::event::emit<EnableSuilend>(v0);
    }
    ...
    public fun safu_otc<T0, T1>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: u64, arg2: u64, arg3: 0x2::balance::Balance<T1>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>, 0x2::balance::Balance<T1>, vector<u64>) {
        safety_check<T0, T1>(arg0, arg1, arg5);
        let (v0, v1, v2) = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::public_safu_otc_<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5);
        let v3 = v2;
        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::emit_otc_event(arg0, arg1, *0x1::vector::borrow<u64>(&v3, 0), *0x1::vector::borrow<u64>(&v3, 1), *0x1::vector::borrow<u64>(&v3, 2), *0x1::vector::borrow<u64>(&v3, 3), 0, 0, 0, arg5);
        (v0, v1, v3)
    }
    ...
    entry fun update_active_vault_config(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::tx_context::TxContext) {
