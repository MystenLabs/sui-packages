module 0xfcce1098ab5161dcd3d9a13120c31b1e8396799361f1965f95efc7beb782f6d6::reward5297 {
    struct REWARD5297 has drop {
        dummy_field: bool,
    }

    struct TICKET_5297 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5297(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5297>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5297>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5297, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5297>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5297>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5297>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5297>>(v5, 0x2::tx_context::sender(arg1));
    }
