module 0xfc07961d23279fcfea081ae8c77c3b6a8da48bb07271a599676e4f54408afca2::ika_airdrop_nft {
    struct IKA_AIRDROP_NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IKA_AIRDROP_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<IKA_AIRDROP_NFT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Ika Airdrop NFT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Claim you tokens at claim.ika.xyz when IKA goes to Mainnet. Welcome to the IKA herd, believers in the power of high performance, programmable data storage. Yes, this NFT entitles you to claim IKA tokens upon Mainnet launch. But more importantly, it gives you the iceberg cred to say you were here at the beginning of unlocking what's next in Web3."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://ccQf_AZQSRb0I3x-ZYe-WIYfaIXx7MZAUYHq86GT5jI"));
