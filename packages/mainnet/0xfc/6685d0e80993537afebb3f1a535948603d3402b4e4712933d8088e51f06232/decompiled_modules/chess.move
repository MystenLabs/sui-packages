module 0x81028857c94206813c541ba305da607f1d7be2896392d9ea1e65f753e9e67687::chess {
    ...
    public fun airdrop_split(arg0: u64, arg1: &mut Global, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun fight(arg0: &mut Chess, arg1: &mut 0x82b36157bea705ea46329400615d2c4e3540e498643475d7c7fa7fe47a308deb::lineup::LineUp, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let (v17, v18) = if (0x8fdf34d38b32953109918d4d4e4aba60381961cb861645a5602c6cba25f1efc1::fight::some_alive(&v6, &v4)) {
            ...
            (false, 2)
        } else if (0x8fdf34d38b32953109918d4d4e4aba60381961cb861645a5602c6cba25f1efc1::fight::some_alive(&v5, &v3)) {
            if (arg2) {
                v14 = v13 + 1;
            } else {
                v10 = v9 + 1;
            ...
            (true, 1)
        } else if (0xd676f5b01f25ceace77b17fbbc91cbb2a5b43eea7695b99b32d15866f6a706d8::utils::get_random_num(1, 10, 17, arg3) < 8) {
            if (arg2) {
                v14 = v13 + 1;
            } else {
                v10 = v9 + 1;
    ...
    public fun mint_invite_arena_chess(arg0: &0x4ef7d22f731621fcde258cc376f716127caf61d8dfa4c3fb96074643300097e9::role::Global, arg1: &mut Global, arg2: &mut 0x81028857c94206813c541ba305da607f1d7be2896392d9ea1e65f753e9e67687::metaIdentity::RewardsGlobal, arg3: 0x1::string::String, arg4: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg5: &mut 0x81028857c94206813c541ba305da607f1d7be2896392d9ea1e65f753e9e67687::metaIdentity::MetaInfoGlobal, arg6: &mut 0x81028857c94206813c541ba305da607f1d7be2896392d9ea1e65f753e9e67687::metaIdentity::MetaIdentity, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 1, 22);
        ...
        let v4 = Chess{
            ...
            name           : arg3,
            lineup         : 0x82b36157bea705ea46329400615d2c4e3540e498643475d7c7fa7fe47a308deb::lineup::empty(arg7),
            cards_pool     : 0x82b36157bea705ea46329400615d2c4e3540e498643475d7c7fa7fe47a308deb::lineup::generate_random_cards(arg0, arg7),
            gold           : 10,
            win            : 0,
            lose           : 0,
            challenge_win  : 0,
        ...
        0x81028857c94206813c541ba305da607f1d7be2896392d9ea1e65f753e9e67687::metaIdentity::top_up_rewards_pool(arg2, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v1, v3, arg7)));
        if (0x2::coin::value<0x2::sui::SUI>(&v1) > 0) {
        ...
        0x81028857c94206813c541ba305da607f1d7be2896392d9ea1e65f753e9e67687::metaIdentity::record_invited_success(arg5, arg6);
    }
    ...
    public entry fun operate_and_battle(arg0: &mut Global, arg1: &0x4ef7d22f731621fcde258cc376f716127caf61d8dfa4c3fb96074643300097e9::role::Global, arg2: &mut 0x82b36157bea705ea46329400615d2c4e3540e498643475d7c7fa7fe47a308deb::lineup::Global, arg3: &mut 0x81028857c94206813c541ba305da607f1d7be2896392d9ea1e65f753e9e67687::challenge::Global, arg4: &mut Chess, arg5: vector<0x1::string::String>, arg6: u8, arg7: vector<0x1::string::String>, arg8: &mut 0x81028857c94206813c541ba305da607f1d7be2896392d9ea1e65f753e9e67687::metaIdentity::MetaIdentity, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = arg4.lineup;
        let v1 = 0x82b36157bea705ea46329400615d2c4e3540e498643475d7c7fa7fe47a308deb::lineup::get_mut_roles(&mut v0);
        let v2 = arg4.cards_pool;
        let v3 = 0x82b36157bea705ea46329400615d2c4e3540e498643475d7c7fa7fe47a308deb::lineup::get_mut_roles(&mut v2);
        if (0x1::string::length(&arg4.name) + 0x1::vector::length<0x1::string::String>(&arg5) != 12) {
            0x537b04d93d32682923cf748442866ee7b5428774ced2492ae042a0b6a4309db6::verify::verify_operation(arg1, v1, v3, arg5, arg6, arg7, arg4.name, (arg4.gold as u8), arg4.gold_cost, arg9);
        };
