module 0x81028857c94206813c541ba305da607f1d7be2896392d9ea1e65f753e9e67687::challenge {
    ...
    public fun get_reward_amount_by_rank(arg0: &Global, arg1: u64, arg2: u64, arg3: u64) : u64 {
        ...
        let v0 = 0x82b36157bea705ea46329400615d2c4e3540e498643475d7c7fa7fe47a308deb::lineup::get_gold_cost(0x1::vector::borrow<0x82b36157bea705ea46329400615d2c4e3540e498643475d7c7fa7fe47a308deb::lineup::LineUp>(&arg0.rank_20, arg3));
        if (arg1 * v0 / 1000000000 * get_base_weight_by_rank(arg3) / arg2 > 100000000) {
            arg1 * v0 / 1000000000 * get_base_weight_by_rank(arg3) / arg2 - 100000000
        } else {
            arg1 * v0 / 1000000000 * get_base_weight_by_rank(arg3) / arg2
        }
    }
