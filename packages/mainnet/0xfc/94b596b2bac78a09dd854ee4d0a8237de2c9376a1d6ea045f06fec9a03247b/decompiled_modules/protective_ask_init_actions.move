module 0xfc94b596b2bac78a09dd854ee4d0a8237de2c9376a1d6ea045f06fec9a03247b::protective_ask_init_actions {
    ...
    public fun add_create_protective_ask_spec<T0, T1>(arg0: &mut 0x8ad26c8279c79b4fc53466d6ae5a514830df1942f3b067d7d78458ca5fe94a64::action_spec_builder::Builder, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg1 > 0, 5);
        assert!(arg2 > 0, 2);
    ...
    public fun do_create_protective_ask<T0, T1, T2: store, T3: drop>(arg0: &mut 0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::executable::Executable<T2>, arg1: &mut 0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::account::Account, arg2: &0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::package_registry::PackageRegistry, arg3: &0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::spot_pool_mutation_auth::SpotPoolMutationRegistry, arg4: &0x2::clock::Clock, arg5: T3, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::action_validation::assert_action_type<CreateProtectiveAsk<T0, T1>>(v1);
        ...
        assert!(v4 > 0, 2);
        assert!(v3 > 0, 5);
        let v5 = 0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::account::config<0x7b8b388d3e741cad40114dd0644959bbabb3d065a9a657e5d0d43e1445e4fb9f::futarchy_config::FutarchyConfig>(arg1);
        let v6 = 0x7b8b388d3e741cad40114dd0644959bbabb3d065a9a657e5d0d43e1445e4fb9f::futarchy_config::stable_type(v5);
        ...
        assert!(0x7b8b388d3e741cad40114dd0644959bbabb3d065a9a657e5d0d43e1445e4fb9f::futarchy_config::asset_type(v5) == &v7, 4);
        assert!(v6 == &v8, 4);
        let v9 = 0x7b8b388d3e741cad40114dd0644959bbabb3d065a9a657e5d0d43e1445e4fb9f::futarchy_config::get_spot_pool_id(v5);
        assert!(0x1::option::is_some<0x2::object::ID>(&v9), 3);
        let v10 = *0x1::option::borrow<0x2::object::ID>(&v9);
        let v11 = 0x2::object::id<0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::account::Account>(arg1);
        let v12 = 0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::protective_ask::create<T0, T1>(v11, v10, v3, v4, 0x2::bcs::peel_u64(&mut v2), 0xfc94b596b2bac78a09dd854ee4d0a8237de2c9376a1d6ea045f06fec9a03247b::liquidity_actions::new_spot_pool_mutation_auth(arg3, v10), arg4, arg6);
        let v13 = 0x2::object::id<0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::protective_ask::ProtectiveAsk<T0, T1>>(&v12);
        ...
        0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::protective_ask_registry::set_from_execution<T2, ExecutionProgressWitness>(arg1, arg2, arg0, v15, v13, v10);
        0x2::transfer::public_share_object<0x39eeb775b5abe9f68786c20935c594946149eed6dfc28bcce1d83c0705a767b8::protective_ask::ProtectiveAsk<T0, T1>>(v12);
        let v16 = ExecutionProgressWitness{dummy_field: false};
        0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::executable::increment_action_idx<T2, CreateProtectiveAsk<T0, T1>, ExecutionProgressWitness>(arg0, arg2, v16);
        v13
    }
