module 0xfc8dd472c5d8ec414d7840052ebea446a52d6f411b362bbaefebb2d8412e1572::game {
    struct Game has key {
        id: 0x2::object::UID,
    ...
    public fun draw_game(arg0: &mut Game, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0;
        while (v2 < 25) {
            let v3 = 0x2::random::generate_u8(&mut v0) % 75 + 1;
        ...
        if (0x1::vector::length<address>(&v4) > 0) {
            ...
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.jackpot_pool, 0x2::balance::split<0x2::sui::SUI>(&mut arg0.prize_pool, 0x2::balance::value<0x2::sui::SUI>(&arg0.prize_pool) / 10));
        };
    ...
    public fun place_bet(arg0: &mut Game, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<u8>(&arg2) == 25, 3);
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = 0x2::coin::into_balance<0x2::sui::SUI>(arg1);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.prize_pool, v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v2, v0 * 300 / 10000), arg3), @0x92a32ac7fd525f8bd37ed359423b8d7d858cad26224854dfbff1914b75ee658b);
        let v3 = PlayerBet{
            selected_numbers : arg2,
            bet_amount       : v0,
            wallet           : v1,
        };
        0x2::table::add<address, PlayerBet>(&mut arg0.players, v1, v3);
