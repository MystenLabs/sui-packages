module 0xfcc8518559a0c8e33610fa6764958377dc25b84ee3ec6acb4cd48591dce77ae3::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public fun depositNft(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut NftPegVault, arg3: &mut 0xfcc8518559a0c8e33610fa6764958377dc25b84ee3ec6acb4cd48591dce77ae3::archieve::UserArchieve, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0xfcc8518559a0c8e33610fa6764958377dc25b84ee3ec6acb4cd48591dce77ae3::version::Version, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x2::bcs::peel_u128(&mut v0);
        ...
        0xfcc8518559a0c8e33610fa6764958377dc25b84ee3ec6acb4cd48591dce77ae3::archieve::verUpdateNftPegNonce(v6, arg3);
        ...
        while (v9 < 0x1::vector::length<u128>(&v7)) {
            let v10 = mint(*0x1::vector::borrow<u128>(&v7, v9), v2, v3, v4, v5, arg7);
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xfcc8518559a0c8e33610fa6764958377dc25b84ee3ec6acb4cd48591dce77ae3::cap_vault::createVault<NftAdminCap>(arg1);
    }
    ...
    public fun setValidator(arg0: &NftAdminCap, arg1: vector<u8>, arg2: &mut NftPegVault, arg3: &0xfcc8518559a0c8e33610fa6764958377dc25b84ee3ec6acb4cd48591dce77ae3::version::Version) {
    ...
    public fun withdrawFee(arg0: &NftAdminCap, arg1: &mut NftPegVault, arg2: &0xfcc8518559a0c8e33610fa6764958377dc25b84ee3ec6acb4cd48591dce77ae3::version::Version, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
    ...
    public fun withdrawNft(arg0: &mut 0xfcc8518559a0c8e33610fa6764958377dc25b84ee3ec6acb4cd48591dce77ae3::archieve::UserArchieve, arg1: BirdNFT, arg2: &0xfcc8518559a0c8e33610fa6764958377dc25b84ee3ec6acb4cd48591dce77ae3::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0xfcc8518559a0c8e33610fa6764958377dc25b84ee3ec6acb4cd48591dce77ae3::version::checkVersion(arg2, 1);
        ...
        let v6 = NFTWithdrawn{
            ...
            rare     : v4,
            value    : v5,
            nonce    : 0xfcc8518559a0c8e33610fa6764958377dc25b84ee3ec6acb4cd48591dce77ae3::archieve::increaseGetNftDepegNonce(arg0),
        };
