module 0xfcc8518559a0c8e33610fa6764958377dc25b84ee3ec6acb4cd48591dce77ae3::archieve {
    ...
    public(friend) fun decreaseToTalDeposit(arg0: u64, arg1: &mut UserArchieve) : u64 {
        assert!(arg1.total_deposit >= arg0, 8004);
        arg1.total_deposit = arg1.total_deposit - arg0;
        arg1.total_deposit
    }

    public(friend) fun decreaseToTalWithdraw(arg0: u64, arg1: &mut UserArchieve) : u64 {
    ...
    public(friend) fun increaseTotalDeposit(arg0: u64, arg1: &mut UserArchieve) : u64 {
        arg1.total_deposit = arg1.total_deposit + arg0;
        arg1.total_deposit
    }

    public(friend) fun increaseTotalWithdraw(arg0: u64, arg1: &mut UserArchieve) : u64 {
        arg1.total_withdraw = arg1.total_withdraw + arg0;
        arg1.total_withdraw
    }
