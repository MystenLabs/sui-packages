module 0xfc51e412952ff916cd9dc149ed6eb14633010670e1dff6593403d103ce9090f7::regcoin {
    ...
    fun init(arg0: REGCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<REGCOIN>(arg0, 6, b"RegTest", b"Reg Coin", b"go build SUI", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://moodengsui.com/images/logo.png")), false, arg1);
        let v3 = v0;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<REGCOIN>>(0x2::coin::mint<REGCOIN>(&mut v3, 100000000000000000, arg1), 0x2::tx_context::sender(arg1));
        0x2::transfer::public_freeze_object<0x2::coin::TreasuryCap<REGCOIN>>(v3);
    }
