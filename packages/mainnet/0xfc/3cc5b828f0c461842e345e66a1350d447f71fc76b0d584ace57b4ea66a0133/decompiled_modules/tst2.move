module 0xfc3cc5b828f0c461842e345e66a1350d447f71fc76b0d584ace57b4ea66a0133::tst2 {
    struct TST2 has drop {
        dummy_field: bool,
    }

    fun init(arg0: TST2, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TST2>(arg0, 6, b"TST2", b"Test Token 2", b"", 0x1::option::none<0x2::url::Url>(), arg1);
