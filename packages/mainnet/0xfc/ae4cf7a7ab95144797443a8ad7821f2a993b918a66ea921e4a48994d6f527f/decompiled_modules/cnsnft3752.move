module 0xfcae4cf7a7ab95144797443a8ad7821f2a993b918a66ea921e4a48994d6f527f::cnsnft3752 {
    struct CNSNFT3752 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3752, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3752>(arg0, arg1);
