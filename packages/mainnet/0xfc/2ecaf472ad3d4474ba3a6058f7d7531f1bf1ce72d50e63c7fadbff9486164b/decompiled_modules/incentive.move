module 0x266772afbc66047204d9b784884e40f29fbe05cef6f386f2d473e574e2c4c1c1::incentive {
    ...
    public entry fun add_pool<T0>(arg0: &mut Incentive, arg1: u8, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.creator == 0x2::tx_context::sender(arg6), 47001);
        assert!(arg3 > arg2, 47002);
        assert!(!0x2::table::contains<u8, PoolInfo>(&arg0.pools, arg1), 47004);
        let v0 = PoolInfo{
            id                     : arg1,
            last_update_time       : 0,
        ...
        0x2::table::add<u8, PoolInfo>(&mut arg0.pools, arg1, v0);
        let v1 = 0x2::table::borrow_mut<u8, PoolInfo>(&mut arg0.pools, arg1);
        0x1::vector::push_back<0x1::ascii::String>(&mut v1.coin_types, 0x1::type_name::into_string(0x1::type_name::get<T0>()));
        0x1::vector::push_back<u64>(&mut v1.start_times, arg2);
        0x1::vector::push_back<u64>(&mut v1.end_times, arg3);
        0x1::vector::push_back<u256>(&mut v1.total_supplys, (arg5 as u256));
        0x1::vector::push_back<u256>(&mut v1.rates, 0x8964495a5989638a5c6f5ece2badd55d78226b2d6b3398d7a3bf0d92a987e8d0::ray_math::ray_div((arg5 as u256), ((arg3 - arg2) as u256)));
        0x1::vector::push_back<u256>(&mut v1.index_rewards, 0);
        0x1::vector::push_back<0x2::table::Table<address, u256>>(&mut v1.index_rewards_paids, 0x2::table::new<address, u256>(arg6));
        0x1::vector::push_back<0x2::table::Table<address, u256>>(&mut v1.user_acc_rewards, 0x2::table::new<address, u256>(arg6));
        0x1::vector::push_back<0x2::table::Table<address, u256>>(&mut v1.user_acc_rewards_paids, 0x2::table::new<address, u256>(arg6));
        let v2 = IncentiveBal<T0>{
            id                 : 0x2::object::new(arg6),
            asset              : arg1,
            current_idx        : 0x1::vector::length<0x1::ascii::String>(&v1.coin_types),
            distributed_amount : 0,
            balance            : 0x36073435023aff97b3498507d3e9f7dac16b16cca565dd31f3e383d0cb8ab9b7::utils::split_coin_to_balance<T0>(arg4, arg5, arg6),
        };
        0x2::transfer::share_object<IncentiveBal<T0>>(v2);
    }

    fun calc_pool_update_rewards(arg0: &Incentive, arg1: &mut 0x266772afbc66047204d9b784884e40f29fbe05cef6f386f2d473e574e2c4c1c1::storage::Storage, arg2: u64, arg3: u8, arg4: address) : (vector<u256>, vector<u256>) {
        ...
        while (v1 < 0x1::vector::length<0x1::ascii::String>(&v0.coin_types)) {
            let v4 = v0.last_update_time;
            let v5 = v4;
            if (v4 == 0) {
                v5 = *0x1::vector::borrow<u64>(&v0.start_times, v1);
            };
            ...
            let v9 = v8;
            if (v5 < v7) {
                let (v10, _) = 0x266772afbc66047204d9b784884e40f29fbe05cef6f386f2d473e574e2c4c1c1::storage::get_total_supply(arg1, arg3);
                let v12 = 0;
                if (v10 > 0) {
                    v12 = 0x8964495a5989638a5c6f5ece2badd55d78226b2d6b3398d7a3bf0d92a987e8d0::safe_math::mul(*0x1::vector::borrow<u256>(&v0.rates, v1), ((v7 - v5) as u256)) / v10;
                };
                v9 = v8 + v12;
            };
            ...
            if (arg4 != @0x0) {
                ...
                let (v17, _) = 0x266772afbc66047204d9b784884e40f29fbe05cef6f386f2d473e574e2c4c1c1::storage::get_user_balance(arg1, arg3, arg4);
                v13 = v13 + (v9 - v15) * v17;
            };
    ...
    public entry fun claim_reward<T0>(arg0: &mut Incentive, arg1: &mut IncentiveBal<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x266772afbc66047204d9b784884e40f29fbe05cef6f386f2d473e574e2c4c1c1::storage::Storage, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = (v2 - v4) / 0x8964495a5989638a5c6f5ece2badd55d78226b2d6b3398d7a3bf0d92a987e8d0::ray_math::ray();
    ...
    public fun earned(arg0: &Incentive, arg1: &mut 0x266772afbc66047204d9b784884e40f29fbe05cef6f386f2d473e574e2c4c1c1::storage::Storage, arg2: &0x2::clock::Clock, arg3: u8, arg4: address) : (vector<0x1::ascii::String>, vector<u256>) {
        let v0 = 0x1::vector::empty<0x1::ascii::String>();
        let v1 = 0x1::vector::empty<u256>();
        if (0x2::table::contains<u8, PoolInfo>(&arg0.pools, arg3)) {
            let (_, v3) = calc_pool_update_rewards(arg0, arg1, 0x2::clock::timestamp_ms(arg2), arg3, arg4);
            let v4 = v3;
            let v5 = 0x2::table::borrow<u8, PoolInfo>(&arg0.pools, arg3);
            let v6 = 0;
            while (v6 < 0x1::vector::length<0x1::ascii::String>(&v5.coin_types)) {
                let v7 = 0x1::vector::borrow<0x2::table::Table<address, u256>>(&v5.user_acc_rewards_paids, v6);
                let v8 = 0;
                if (0x2::table::contains<address, u256>(v7, arg4)) {
                    v8 = *0x2::table::borrow<address, u256>(v7, arg4);
                };
                0x1::vector::push_back<0x1::ascii::String>(&mut v0, *0x1::vector::borrow<0x1::ascii::String>(&v5.coin_types, v6));
                0x1::vector::push_back<u256>(&mut v1, *0x1::vector::borrow<u256>(&v4, v6) - v8);
                v6 = v6 + 1;
            };
        };
        (v0, v1)
    ...
    public fun get_pool_count(arg0: &Incentive, arg1: u8) : u64 {
        ...
        0x1::vector::length<0x1::ascii::String>(&0x2::table::borrow<u8, PoolInfo>(&arg0.pools, arg1).coin_types)
    }

    public fun get_pool_info(arg0: &Incentive, arg1: u8, arg2: u64) : (u64, u64, u256) {
        assert!(0x2::table::contains<u8, PoolInfo>(&arg0.pools, arg1), 47003);
        let v0 = 0x2::table::borrow<u8, PoolInfo>(&arg0.pools, arg1);
        assert!(0x1::vector::length<0x1::ascii::String>(&v0.coin_types) > arg2, 47003);
        (*0x1::vector::borrow<u64>(&v0.start_times, arg2), *0x1::vector::borrow<u64>(&v0.end_times, arg2), *0x1::vector::borrow<u256>(&v0.rates, arg2))
    }
    ...
    public(friend) fun update_reward(arg0: &mut Incentive, arg1: &0x2::clock::Clock, arg2: &mut 0x266772afbc66047204d9b784884e40f29fbe05cef6f386f2d473e574e2c4c1c1::storage::Storage, arg3: u8, arg4: address) {
        if (0x2::table::contains<u8, PoolInfo>(&arg0.pools, arg3)) {
