module 0xfcd83ed778b511e9cfaade512b04d60f562869106a4c052660b803e66a4b723f::launchpad {
    ...
    public entry fun purchase<T0, T1>(arg0: &0x2::clock::Clock, arg1: &Config, arg2: &mut Launchpool<T0, T1>, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 > arg2.private_pool.open_at && v0 < arg2.private_pool.close_at) {
            assert!(!0x2::table::contains<address, UserInfo>(&arg2.users, 0x2::tx_context::sender(arg5)), 110);
            assert!(arg2.private_pool.max_amount == arg4, 114);
            arg2.private_pool.payments = arg2.private_pool.payments + arg4;
            assert!(arg2.private_pool.amount >= arg2.private_pool.payments, 111);
            let v1 = refund<T1>(arg3, arg4, arg5);
            ...
            0x2::table::add<address, UserInfo>(&mut arg2.users, 0x2::tx_context::sender(arg5), v2);
        } else {
            assert!(v0 > arg2.public_pool.open_at && v0 < arg2.public_pool.close_at, 113);
            assert!(arg2.public_pool.max_amount >= arg4, 114);
            arg2.public_pool.payments = arg2.public_pool.payments + arg4;
            assert!(arg2.public_pool.amount >= arg2.public_pool.payments, 111);
            let v3 = refund<T1>(arg3, arg4, arg5);
            0x2::coin::put<T1>(&mut arg2.public_pool.balance, v3);
            if (0x2::table::contains<address, UserInfo>(&arg2.users, 0x2::tx_context::sender(arg5))) {
                let v4 = 0x2::table::borrow_mut<address, UserInfo>(&mut arg2.users, 0x2::tx_context::sender(arg5));
                v4.public_amount = v4.public_amount + arg4;
                assert!(arg2.public_pool.max_amount >= v4.public_amount, 114);
            } else {
                let v5 = UserInfo{
                    private_amount : 0,
                    public_amount  : arg4,
                ...
                0x2::table::add<address, UserInfo>(&mut arg2.users, 0x2::tx_context::sender(arg5), v5);
            };
        };
