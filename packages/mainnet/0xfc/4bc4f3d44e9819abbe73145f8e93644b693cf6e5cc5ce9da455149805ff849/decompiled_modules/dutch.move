module 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::dutch {
    ...
    struct Auction has store, key {
        ...
        bids: 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<Bid>,
        bid_index: u64,
    }
    ...
    public fun new<T0>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: bool, arg12: &mut 0x2::tx_context::TxContext) : Auction {
        ...
        Auction{
            ...
            bids               : 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::new<Bid>(1000, arg12),
            bid_index          : 0,
        }
    }
    ...
    public fun bids(arg0: &Auction) : &0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<Bid> {
        &arg0.bids
    }

    public fun calculate_bid_value(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : (u64, u64) {
        let v0 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::utils::multiplier(arg1);
        let v1 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::utils::multiplier(arg2);
        let v2 = 10000;
    ...
    public fun delivery<T0>(arg0: &mut 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::balance_pool::BalancePool, arg1: &mut 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::vault::RefundVault, arg2: Auction, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>, u64, u64, u64, u64, u64, u64) {
        ...
        let v22 = if (v13 < v5) {
            ...
            0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow<Bid>(&v17, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<Bid>(&v17) - 1).price
        };
        let v23 = 0x2::dynamic_field::remove<vector<u8>, 0x2::balance::Balance<T0>>(&mut v18, b"bidder_balance");
        while (!0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::is_empty<Bid>(&v17)) {
            let Bid {
                index             : _,
                bidder            : v25,
                price             : _,
                ...
                fee_discount      : v30,
                ts_ms             : _,
            } = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::pop_back<Bid>(&mut v17);
            ...
            let v42 = v28 - v40;
            if (v41 < v42) {
                0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::vault::put_refund<T0>(arg1, 0x2::balance::split<T0>(&mut v23, v42 - v41), v25);
            };
        };
        ...
        0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::balance_pool::put<T0>(arg0, v44);
        0x2::balance::join<T0>(&mut v23, 0x2::balance::split<T0>(&mut v43, v19));
        0x2::object::delete(v18);
        0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::destroy_empty<Bid>(v17);
        let v46 = Delivery{
    ...
    public fun get_user_bid_info(arg0: &Auction, arg1: u64) : (u64, address, u64, u64, u64, u64, u64, u64) {
        let v0 = 0;
        while (v0 < 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<Bid>(&arg0.bids)) {
            let v1 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow<Bid>(&arg0.bids, v0);
            if (v1.index == arg1) {
    ...
    public fun new_bid<T0>(arg0: &mut Auction, arg1: u64, arg2: vector<0x2::coin::Coin<T0>>, arg3: 0x2::balance::Balance<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, address) {
        ...
        0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::push_back<Bid>(&mut arg0.bids, v10);
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg0.id, b"bidder_balance"), 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::utils::extract_balance<T0>(arg2, v9, arg6));
    ...
    public fun remove_bid<T0>(arg0: &mut Auction, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        let v2 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<Bid>(&arg0.bids);
        let v3 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<Bid>(&arg0.bids);
        let v4 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<Bid>(&arg0.bids, 1);
        let v5 = 0;
        while (v5 < v2) {
            ...
            if (v5 + 1 < v2 && (v5 + 1) % v3 == 0) {
                v4 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<Bid>(&arg0.bids, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<Bid>(&arg0.bids, v5 + 1));
            };
            v5 = v5 + 1;
        };
        if (v5 == v2) {
        ...
        let Bid {
            ...
            fee_discount      : v13,
            ts_ms             : v14,
        } = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::remove<Bid>(&mut arg0.bids, v5);
    ...
    public fun terminate<T0>(arg0: Auction, arg1: &mut 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::vault::RefundVault, arg2: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert!(arg0.token == 0x1::type_name::get<T0>(), 4);
        let Auction {
            id                 : v0,
            index              : v1,
        ...
        while (!0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::is_empty<Bid>(&v17)) {
            ...
            0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::vault::put_refund<T0>(arg1, 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::balance::Balance<T0>>(&mut v18, b"bidder_balance"), v23), v20);
        };
        0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::destroy_empty<Bid>(v17);
