module 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::vault {
    ...
    public fun activate<T0>(arg0: &mut DepositVault, arg1: bool, arg2: &0x2::tx_context::TxContext) : u64 {
        ...
        if (v0 > 0) {
            ...
            *v3 = *v3 + v2;
            ...
            let v8 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<DepositShare>(v7);
            let v9 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<DepositShare>(v7);
            let v10 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice_mut<DepositShare>(v7, 1);
            let v11 = 0;
            while (v11 < v8) {
                ...
                if (v11 + 1 < v8 && (v11 + 1) % v9 == 0) {
                    v10 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice_mut<DepositShare>(v7, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<DepositShare>(v7, v11 + 1));
                };
                v11 = v11 + 1;
            };
        };
    ...
    fun add_deposit_share(arg0: &mut DepositVault, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1 != 0 || arg2 != 0 || arg3 != 0 || arg4 != 0 || arg5 != 0 || arg6 != 0) {
            ...
            0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::push_back<DepositShare>(get_mut_deposit_shares(arg0), v2);
    ...
    public fun charge_fee<T0>(arg0: &mut 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::balance_pool::BalancePool, arg1: &DepositVault, arg2: &mut 0x2::balance::Balance<T0>) : (u64, u64) {
        ...
        if (v2 > 0 && 0x1::option::is_some<vector<u8>>(&arg1.shared_fee_pool)) {
            0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::balance_pool::put_shared<T0>(arg0, *0x1::option::borrow<vector<u8>>(&arg1.shared_fee_pool), 0x2::balance::split<T0>(&mut v1, v2));
        };
        0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::balance_pool::put<T0>(arg0, v1);
        (v0 - v2, v2)
    }
    ...
    public fun compound<T0>(arg0: &mut 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : u64 {
    ...
    public fun compound_v2<T0>(arg0: &mut 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, 0x1::option::Option<vector<u8>>) {
        assert!(arg1.has_next, 4);
        assert!(0x1::type_name::get<T0>() == arg1.deposit_token, 1);
        assert!(0x1::type_name::get<T0>() == arg1.bid_token, 1);
        let (v0, v1, v2, v3, v4, v5, v6) = extract_deposit_shares(arg1, arg2);
    ...
    public fun delivery_b<T0, T1>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: 0x2::balance::Balance<T1>, arg3: 0x2::balance::Balance<T1>, arg4: &0x2::tx_context::TxContext) {
        ...
        let v5 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<DepositShare>(v4);
        let v6 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<DepositShare>(v4);
        let v7 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice_mut<DepositShare>(v4, 1);
        let v8 = 0;
        while (v8 < v5) {
            ...
            if (v8 + 1 < v5 && (v8 + 1) % v6 == 0) {
                v7 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice_mut<DepositShare>(v4, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<DepositShare>(v4, v8 + 1));
            };
            v8 = v8 + 1;
        };
    }
    ...
    public fun deposit<T0>(arg0: &mut DepositVault, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: vector<TypusDepositReceipt>, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        0x2::balance::join<T0>(v0, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::utils::extract_balance<T0>(arg1, arg2, arg4));
    ...
    public fun drop_bid_vault<T0>(arg0: BidVault) {
        ...
        0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::destroy_empty<BidShare>(0x2::dynamic_field::remove<vector<u8>, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<BidShare>>(&mut v9, b"bid_shares"));
    ...
    public fun drop_deposit_vault<T0, T1>(arg0: DepositVault) {
        ...
        0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::destroy_empty<DepositShare>(0x2::dynamic_field::remove<vector<u8>, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<DepositShare>>(&mut v18, b"deposit_shares"));
    ...
    public fun extract_bid_shares(arg0: &mut BidVault, arg1: vector<TypusBidReceipt>) : (u64, vector<u64>) {
        ...
        while (!0x1::vector::is_empty<TypusBidReceipt>(&arg1)) {
            ...
            let v10 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<BidShare>(v9);
            let v11 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<BidShare>(v9);
            let v12 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<BidShare>(v9, 1);
            let v13 = 0;
            while (v13 < v10) {
                if (0x1::vector::borrow<BidShare>(v12, v13 % v11).receipt == 0x2::object::uid_to_address(&v8)) {
                    let BidShare {
                        ...
                        share       : v15,
                        u64_padding : v16,
                    } = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::swap_remove<BidShare>(v9, v13);
                    let v17 = v16;
                    v0 = v0 + v15;
                    ...
                    if (v13 + 1 < v10 && (v13 + 1) % v11 == 0) {
                        v12 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<BidShare>(v9, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<BidShare>(v9, v13 + 1));
                    };
                    v13 = v13 + 1;
                };
            };
    ...
    fun extract_deposit_shares(arg0: &mut DepositVault, arg1: vector<TypusDepositReceipt>) : (u64, u64, u64, u64, u64, u64, vector<u64>) {
        ...
        while (!0x1::vector::is_empty<TypusDepositReceipt>(&arg1)) {
            ...
            let v15 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<DepositShare>(v14);
            let v16 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<DepositShare>(v14);
            let v17 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<DepositShare>(v14, 1);
            let v18 = 0;
            while (v18 < v15) {
                if (0x1::vector::borrow<DepositShare>(v17, v18 % v16).receipt == 0x2::object::uid_to_address(&v13)) {
                    let DepositShare {
                        ...
                        incentive_share    : v25,
                        u64_padding        : v26,
                    } = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::swap_remove<DepositShare>(v14, v18);
                    let v27 = v26;
                    v0 = v0 + v20;
                    v1 = v1 + v21;
                    v2 = v2 + v22;
                    ...
                    if (v18 + 1 < v15 && (v18 + 1) % v16 == 0) {
                        v17 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<DepositShare>(v14, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<DepositShare>(v14, v18 + 1));
                    };
                    v18 = v18 + 1;
                };
            };
    ...
    public fun get_active_deposit_share(arg0: &DepositVault, arg1: address) : u64 {
        ...
        let v1 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<DepositShare>(v0);
        let v2 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<DepositShare>(v0);
        let v3 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<DepositShare>(v0, 1);
        let v4 = 0;
        while (v4 < v1) {
            ...
            if (v4 + 1 < v1 && (v4 + 1) % v2 == 0) {
                v3 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<DepositShare>(v0, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<DepositShare>(v0, v4 + 1));
            };
            v4 = v4 + 1;
        };
        0
    ...
    public fun get_bid_share(arg0: &BidVault, arg1: address) : u64 {
        ...
        let v1 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<BidShare>(v0);
        let v2 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<BidShare>(v0);
        let v3 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<BidShare>(v0, 1);
        let v4 = 0;
        while (v4 < v1) {
            ...
            if (v4 + 1 < v1 && (v4 + 1) % v2 == 0) {
                v3 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<BidShare>(v0, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<BidShare>(v0, v4 + 1));
            };
            v4 = v4 + 1;
        };
        0
    ...
    public fun get_bid_shares(arg0: &BidVault) : &0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<BidShare> {
        0x2::dynamic_field::borrow<vector<u8>, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<BidShare>>(&arg0.id, b"bid_shares")
    }
    ...
    public fun get_bid_vault_u64_padding_value(arg0: &BidVault, arg1: u64) : u64 {
        0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::utils::get_u64_padding_value(&arg0.u64_padding, arg1)
    }
    ...
    public fun get_deposit_share(arg0: &DepositVault, arg1: u64) : &DepositShare {
        0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow<DepositShare>(get_deposit_shares(arg0), arg1)
    }
    ...
    public fun get_deposit_shares(arg0: &DepositVault) : &0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<DepositShare> {
        0x2::dynamic_field::borrow<vector<u8>, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<DepositShare>>(&arg0.id, b"deposit_shares")
    }
    ...
    fun get_mut_bid_shares(arg0: &mut BidVault) : &mut 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<BidShare> {
        0x2::dynamic_field::borrow_mut<vector<u8>, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<BidShare>>(&mut arg0.id, b"bid_shares")
    }
    ...
    public fun get_mut_deposit_shares(arg0: &mut DepositVault) : &mut 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<DepositShare> {
        0x2::dynamic_field::borrow_mut<vector<u8>, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<DepositShare>>(&mut arg0.id, b"deposit_shares")
    }
    ...
    public fun get_refund_share(arg0: &RefundVault, arg1: address) : u64 {
        ...
        let v1 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<RefundShare>(v0);
        let v2 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<RefundShare>(v0);
        let v3 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<RefundShare>(v0, 1);
        let v4 = 0;
        while (v4 < v1) {
            ...
            if (v4 + 1 < v1 && (v4 + 1) % v2 == 0) {
                v3 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<RefundShare>(v0, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<RefundShare>(v0, v4 + 1));
            };
            v4 = v4 + 1;
        };
        0
    ...
    public fun get_refund_shares(arg0: &RefundVault) : &0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<RefundShare> {
        0x2::dynamic_field::borrow<vector<u8>, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<RefundShare>>(&arg0.id, b"refund_shares")
    }
    ...
    public fun harvest<T0>(arg0: &mut 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        assert!(0x1::type_name::get<T0>() == arg1.bid_token, 1);
        let (v0, v1, v2, v3, v4, v5, v6) = extract_deposit_shares(arg1, arg2);
        let v7 = v4;
        let v8 = v4;
    ...
    public fun harvest_v2<T0>(arg0: &mut 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, 0x1::option::Option<vector<u8>>) {
        assert!(0x1::type_name::get<T0>() == arg1.bid_token, 1);
        let (v0, v1, v2, v3, v4, v5, v6) = extract_deposit_shares(arg1, arg2);
        let v7 = v4;
        let v8 = v4;
    ...
    public fun new_bid(arg0: &mut BidVault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::push_back<BidShare>(get_mut_bid_shares(arg0), v2);
    ...
    public fun new_bid_vault<T0, T1>(arg0: u64, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) : BidVault {
        ...
        0x2::dynamic_field::add<vector<u8>, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<BidShare>>(&mut v0, b"bid_shares", 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::new<BidShare>(4500, arg2));
        BidVault{
            id              : v0,
    ...
    public fun new_deposit_vault<T0, T1>(arg0: u64, arg1: u64, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) : DepositVault {
        ...
        0x2::dynamic_field::add<vector<u8>, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<DepositShare>>(&mut v0, b"deposit_shares", 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::new<DepositShare>(1000, arg3));
        DepositVault{
            id                        : v0,
            deposit_token             : 0x1::type_name::get<T0>(),
            bid_token                 : 0x1::type_name::get<T1>(),
    ...
    public fun new_refund_vault<T0>(arg0: &mut 0x2::tx_context::TxContext) : RefundVault {
        ...
        0x2::dynamic_field::add<vector<u8>, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<RefundShare>>(&mut v0, b"refund_shares", 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::new<RefundShare>(4500, arg0));
        RefundVault{
            id           : v0,
    ...
    public fun put_refund<T0>(arg0: &mut RefundVault, arg1: 0x2::balance::Balance<T0>, arg2: address) {
        ...
        let v1 = 0x2::dynamic_field::borrow_mut<vector<u8>, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::BigVector<RefundShare>>(&mut arg0.id, b"refund_shares");
        let v2 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<RefundShare>(v1);
        let v3 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<RefundShare>(v1);
        let v4 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice_mut<RefundShare>(v1, 1);
        let v5 = 0;
        while (v5 < v2) {
            ...
            if (v5 + 1 < v2 && (v5 + 1) % v3 == 0) {
                v4 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice_mut<RefundShare>(v1, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<RefundShare>(v1, v5 + 1));
            };
            v5 = v5 + 1;
        };
        let v7 = RefundShare{
        ...
        0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::push_back<RefundShare>(v1, v7);
    }
    ...
    fun remove_bid_share(arg0: &mut BidVault, arg1: address) : BidShare {
        ...
        let v1 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<BidShare>(v0);
        let v2 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<BidShare>(v0);
        let v3 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice_mut<BidShare>(v0, 1);
        let v4 = 0;
        while (v4 < v1) {
            ...
            if (v4 + 1 < v1 && (v4 + 1) % v2 == 0) {
                v3 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice_mut<BidShare>(v0, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<BidShare>(v0, v4 + 1));
            };
            v4 = v4 + 1;
        };
        let v5 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::swap_remove<BidShare>(v0, v4);
    ...
    public fun set_bid_vault_u64_padding_value(arg0: &mut BidVault, arg1: u64, arg2: u64) {
        0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::utils::set_u64_padding_value(&mut arg0.u64_padding, arg1, arg2);
    }
    ...
    public fun settle<T0, T1>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::type_name::get<T0>() == arg1.deposit_token, 1);
        assert!(0x1::type_name::get<T1>() == arg1.bid_token, 1);
        let v0 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::utils::multiplier(arg3);
        if (active_balance<T0>(arg0) + deactivating_balance<T0>(arg0) != 0) {
            ...
            let v15 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<DepositShare>(v14);
            let v16 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<DepositShare>(v14);
            let v17 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice_mut<DepositShare>(v14, 1);
            let v18 = 0;
            while (v18 < v15) {
                ...
                if (v18 + 1 < v15 && (v18 + 1) % v16 == 0) {
                    v17 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice_mut<DepositShare>(v14, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<DepositShare>(v14, v18 + 1));
                };
                v18 = v18 + 1;
            };
            if (!v13) {
    ...
    public fun split_bid_receipt(arg0: &mut BidVault, arg1: vector<TypusBidReceipt>, arg2: 0x1::option::Option<u64>, arg3: &mut 0x2::tx_context::TxContext) : (u64, 0x1::option::Option<TypusBidReceipt>, 0x1::option::Option<TypusBidReceipt>) {
        ...
        let v5 = if (v3 > 0) {
            ...
            0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::push_back<BidShare>(v7, v8);
            v2 = v0 - v3;
        ...
        let v9 = if (v2 > 0) {
            ...
            0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::push_back<BidShare>(get_mut_bid_shares(arg0), v11);
    ...
    public fun summarize_bid_shares(arg0: &BidVault, arg1: vector<TypusBidReceipt>) : u64 {
        ...
        while (!0x1::vector::is_empty<TypusBidReceipt>(&arg1)) {
            ...
            let v9 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<BidShare>(v8);
            let v10 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<BidShare>(v8);
            let v11 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<BidShare>(v8, 1);
            let v12 = 0;
            while (v12 < v9) {
                ...
                if (v12 + 1 < v9 && (v12 + 1) % v10 == 0) {
                    v11 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<BidShare>(v8, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<BidShare>(v8, v12 + 1));
                };
                v12 = v12 + 1;
            };
        };
    ...
    public fun summarize_deposit_shares(arg0: &DepositVault, arg1: vector<TypusDepositReceipt>) : (u64, u64, u64, u64, u64, u64) {
        ...
        while (!0x1::vector::is_empty<TypusDepositReceipt>(&arg1)) {
            ...
            let v14 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<DepositShare>(v13);
            let v15 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<DepositShare>(v13);
            let v16 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<DepositShare>(v13, 1);
            let v17 = 0;
            while (v17 < v14) {
                ...
                if (v17 + 1 < v14 && (v17 + 1) % v15 == 0) {
                    v16 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<DepositShare>(v13, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<DepositShare>(v13, v17 + 1));
                };
                v17 = v17 + 1;
            };
        };
    ...
    public fun take_refund<T0>(arg0: &mut RefundVault, arg1: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v2 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<RefundShare>(v1);
        let v3 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<RefundShare>(v1);
        let v4 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<RefundShare>(v1, 1);
        let v5 = 0;
        while (v5 < v2) {
            ...
            if (v5 + 1 < v2 && (v5 + 1) % v3 == 0) {
                v4 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice<RefundShare>(v1, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<RefundShare>(v1, v5 + 1));
            };
            v5 = v5 + 1;
        };
        if (v5 == v2) {
        ...
        let RefundShare {
            ...
            share       : v7,
            u64_padding : _,
        } = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::swap_remove<RefundShare>(v1, v5);
    ...
    public fun terminate<T0>(arg0: &mut DepositVault, arg1: &0x2::tx_context::TxContext) {
        ...
        let v7 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::length<DepositShare>(v6);
        let v8 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_size<DepositShare>(v6);
        let v9 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice_mut<DepositShare>(v6, 1);
        let v10 = 0;
        while (v10 < v7) {
            ...
            if (v10 + 1 < v7 && (v10 + 1) % v8 == 0) {
                v9 = 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::borrow_slice_mut<DepositShare>(v6, 0xfc4bc4f3d44e9819abbe73145f8e93644b693cf6e5cc5ce9da455149805ff849::big_vector::slice_id<DepositShare>(v6, v10 + 1));
            };
            v10 = v10 + 1;
        };
        arg0.has_next = false;
