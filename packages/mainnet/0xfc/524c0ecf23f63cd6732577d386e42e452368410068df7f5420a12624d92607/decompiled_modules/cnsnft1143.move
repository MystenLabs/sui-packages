module 0xfc524c0ecf23f63cd6732577d386e42e452368410068df7f5420a12624d92607::cnsnft1143 {
    struct CNSNFT1143 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1143, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7374"));
        let v4 = 0x2::package::claim<CNSNFT1143>(arg0, arg1);
