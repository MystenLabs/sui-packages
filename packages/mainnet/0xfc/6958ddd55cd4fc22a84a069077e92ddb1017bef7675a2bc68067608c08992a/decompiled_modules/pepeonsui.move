module 0xfc6958ddd55cd4fc22a84a069077e92ddb1017bef7675a2bc68067608c08992a::pepeonsui {
    ...
    fun init(arg0: PEPEONSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PEPEONSUI>(arg0, 4, b"PepeOnSui", b"Pepe On Sui", b"PepeOnSui. The most memeable memecoin On Sui Blockchain. Telegram : t.me/Pepecoinsui , Twitter : https://twitter.com/pepecoin_sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ibb.co/PWV13mw")), arg1);
