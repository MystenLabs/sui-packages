module 0xe45eb4cb16f40be9c90c18327960011a8f069398029e195091d34ce4633948d7::aqua {
    ...
    public fun admin_cancel_withdrawal_v2<T0>(arg0: &KeeperCap, arg1: &mut Vault<T0>, arg2: WithdrawalRequest) {
        let WithdrawalRequest {
            id        : v0,
            user      : _,
            shares    : _,
    ...
    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<AQUA> {
        ...
        0x2::coin::mint<AQUA>(&mut arg0.treasury_cap, v4, arg2)
    }

    public fun emergency_withdraw<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<AQUA>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
    ...
    fun is_whitelisted(arg0: address) : bool {
        if (arg0 == @0x1ae73dabfa4b71abd21fead6a14c5861cea4b9dc1cfb456748751cff8baed61e) {
            true
        } else if (arg0 == @0xfe2467491448ba68ed8740b31262a8f41a1f8d5780ec27c12ec6577c57d1f788) {
            true
        } else {
            arg0 == @0x625d951a3f0f521e4d5e72781b1c48e3cb4e6841da482110b7dc61105bb6b19d
        }
    }
    ...
    public fun keeper_heartbeat<T0>(arg0: &KeeperCap, arg1: &mut Vault<T0>, arg2: &0x2::clock::Clock) {
        let v0 = 0x1::string::utf8(b"last_heartbeat_ms");
        if (0x2::dynamic_field::exists_<0x1::string::String>(&arg1.id, v0)) {
            *0x2::dynamic_field::borrow_mut<0x1::string::String, u64>(&mut arg1.id, v0) = 0x2::clock::timestamp_ms(arg2);
        } else {
            0x2::dynamic_field::add<0x1::string::String, u64>(&mut arg1.id, v0, 0x2::clock::timestamp_ms(arg2));
        };
        let v1 = 0x1::string::utf8(b"keeper_timeout_ms");
        if (!0x2::dynamic_field::exists_<0x1::string::String>(&arg1.id, v1)) {
            0x2::dynamic_field::add<0x1::string::String, u64>(&mut arg1.id, v1, 86400000);
        };
    }
