module 0xc9f61d715869a76a9e12a854d2836a289515f73989c0bffb79214edd39f31e0f::tradeport_auctions {
    ...
    entry fun place_bid<T0: store + key, T1>(arg0: &mut Store, arg1: 0x2::object::ID, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        let v2 = v1.increment;
        let v3 = type_key<T1>();
        let v4 = 0x2::object_table::borrow_mut<0x1::ascii::String, Auction>(&mut arg0.auctions, v0);
        assert!(0x1::option::is_some<u64>(&v4.maybe_started_at), 8);
        assert!(0x2::clock::timestamp_ms(arg5) < *0x1::option::borrow<u64>(&v4.maybe_ends_at), 9);
        assert!(*0x1::vector::borrow<0x2::object::ID>(&v4.queue, 0) == arg1, 15);
        let v5 = v4.top_price;
        let v6 = if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Rule>(arg4)) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<T0>(arg4, arg2)
        } else {
            0
        };
        let v7 = (((arg2 as u128) * (arg0.fee_bps as u128) / 10000) as u64);
        assert!(0x2::coin::value<T1>(&arg3) == arg2 + v6 + v7, 16);
        let v8 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Lot>(&mut v4.id, arg1);
        assert!(v8.coin_type == v3, 18);
        let v9 = 0x2::object::id<Lot>(v8);
        if (v5 == 0) {
            assert!(arg2 >= v8.starting_price, 7);
            0x2::dynamic_field::add<0x2::object::ID, 0x2::balance::Balance<T1>>(&mut v8.id, v9, 0x2::coin::into_balance<T1>(arg3));
        } else {
            assert!(arg2 >= v5 + v2, 7);
            let v10 = 0x2::dynamic_field::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T1>>(&mut v8.id, v9);
            0x2::balance::send_funds<T1>(0x2::balance::withdraw_all<T1>(v10), *0x1::option::borrow<address>(&v4.maybe_top_bidder));
            0x2::balance::join<T1>(v10, 0x2::coin::into_balance<T1>(arg3));
        };
        let v11 = 0x2::tx_context::sender(arg6);
        v4.top_price = arg2;
        v4.top_royalty = v6;
        v4.top_fee = v7;
        v4.maybe_top_bidder = 0x1::option::some<address>(v11);
        let v12 = PlaceTopBidEvent{
            nft_type   : v0,
            lot_id     : v9,
            nft_id     : arg1,
            coin_type  : v3,
        ...
        0x2::event::emit<PlaceTopBidEvent>(v12);
    }
    ...
    public fun submit<T0: store + key, T1>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        let v0 = type_key<T0>();
        assert!(0x2::table::contains<0x1::ascii::String, Config>(&arg0.configs, v0), 4);
        let v1 = *0x2::table::borrow<0x1::ascii::String, Config>(&arg0.configs, v0);
