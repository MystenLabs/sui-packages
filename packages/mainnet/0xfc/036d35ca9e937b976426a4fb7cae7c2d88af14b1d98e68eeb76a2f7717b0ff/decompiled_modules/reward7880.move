module 0xfc036d35ca9e937b976426a4fb7cae7c2d88af14b1d98e68eeb76a2f7717b0ff::reward7880 {
    struct REWARD7880 has drop {
        dummy_field: bool,
    }

    struct TICKET_7880 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7880(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7880>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7880>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7880, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7880>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7880>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7880>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7880>>(v5, 0x2::tx_context::sender(arg1));
    }
