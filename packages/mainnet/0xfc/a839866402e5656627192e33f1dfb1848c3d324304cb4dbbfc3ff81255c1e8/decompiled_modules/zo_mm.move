module 0xfca839866402e5656627192e33f1dfb1848c3d324304cb4dbbfc3ff81255c1e8::zo_mm {
    ...
    public fun c7d2e8<T0, T1, T2, T3>(arg0: &Config, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T1, T2>, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::Market<T0>, arg4: &0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::model::ReservingFeeModel, arg5: &0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::model::FundingFeeModel, arg6: &0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::WrappedPositionConfig<T3, 0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::LONG>, arg7: &0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::WrappedPositionConfig<T3, 0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::SHORT>, arg8: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg9: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg10: u8, arg11: u64, arg12: u64, arg13: u256, arg14: 0x2::coin::Coin<T2>, arg15: 0x2::coin::Coin<T2>, arg16: u64, arg17: u64, arg18: &0x2::clock::Clock, arg19: &mut 0x2::tx_context::TxContext) : TradeResult {
        assert!(arg0.enabled, 3);
        assert!(arg11 > 0, 7);
        let v0 = 0x2::clock::timestamp_ms(arg18);
        let v1 = 0x2::tx_context::sender(arg19);
        let v2 = get_pyth_price_e6(arg9, arg18);
        let (v3, v4, v5) = if (arg10 == 0) {
            let v6 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::withdraw_all<T2>(arg2, arg19);
            let (v7, v8) = h2j5k7<T1, T2>(arg1, v6, 0, arg18, arg19);
            let v9 = v8;
            let v10 = v7;
            let v11 = 0x2::coin::value<T1>(&v10);
            let v12 = 0x2::coin::value<T2>(&v6) - 0x2::coin::value<T2>(&v9);
            let v13 = if (v11 > 0) {
                (((v12 as u128) * 1000000000 / (v11 as u128)) as u64)
            } else {
                0
            };
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v10, v1);
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(v9, v1);
            0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::open_position<T0, T2, T3, 0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::SHORT, T2>(arg18, arg3, arg4, arg5, arg7, arg8, arg9, arg14, arg15, 2, arg11, arg12, arg13, 0, arg19);
            (v11, v13, v12)
        } else {
            assert!(arg10 == 1, 3);
            0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::open_position<T0, T2, T3, 0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::LONG, T2>(arg18, arg3, arg4, arg5, arg6, arg8, arg9, arg14, arg15, 2, arg11, arg12, arg13, 115792089237316195423570985008687907853269984665640564039457584007913129639935, arg19);
            let v14 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::withdraw_all<T1>(arg2, arg19);
            let (v15, v16) = l3m6n8<T1, T2>(arg1, v14, 0, arg18, arg19);
            let v17 = v16;
            let v18 = v15;
            let v19 = 0x2::coin::value<T2>(&v17);
            let v20 = 0x2::coin::value<T1>(&v14) - 0x2::coin::value<T1>(&v18);
            let v21 = if (v20 > 0) {
                (((v19 as u128) * 1000000000 / (v20 as u128)) as u64)
            } else {
                0
            };
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(v17, v1);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v18, v1);
            (v20, v21, v19)
        };
        let (v22, v23) = calculate_profit_from_prices(v4, v2, arg10, arg16, arg17);
        let v24 = TradeExecuted{
            direction : arg10,
            quantity  : v3,
            db_price  : v4,
            zo_price  : v2,
        ...
        0x2::event::emit<TradeExecuted>(v24);
        TradeResult{
            direction          : arg10,
            db_base_amount     : v3,
            db_quote_amount    : v5,
            db_execution_price : v4,
            zo_oracle_price    : v2,
            zo_amount          : arg11,
            profit_e6          : v22,
            is_profit_positive : v23,
            timestamp          : v0,
        }
    }
    ...
    public fun e9f4g7<T0, T1, T2, T3, T4>(arg0: &Config, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T1, T2>, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::Market<T0>, arg4: &0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::PositionCap<T2, T3, T4>, arg5: &0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::model::ReservingFeeModel, arg6: &0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::model::FundingFeeModel, arg7: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg8: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg9: bool, arg10: u64, arg11: u256, arg12: u256, arg13: 0x2::coin::Coin<T2>, arg14: u64, arg15: u64, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) : TradeResult {
        assert!(arg0.enabled, 3);
        assert!(arg10 > 0, 7);
        let v0 = 0x2::clock::timestamp_ms(arg16);
        let v1 = 0x2::tx_context::sender(arg17);
        let v2 = get_pyth_price_e6(arg8, arg16);
        let (v3, v4, v5, v6) = if (arg9) {
            0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::decrease_position<T0, T2, T3, T4, T2>(arg16, arg3, arg4, arg5, arg6, arg7, arg8, arg13, 2, true, arg10, arg11, arg12, arg17);
            let v7 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::withdraw_all<T1>(arg2, arg17);
            let (v8, v9) = l3m6n8<T1, T2>(arg1, v7, 0, arg16, arg17);
            let v10 = v9;
            let v11 = v8;
            let v12 = 0x2::coin::value<T2>(&v10);
            let v13 = 0x2::coin::value<T1>(&v7) - 0x2::coin::value<T1>(&v11);
            let v14 = if (v13 > 0) {
                (((v12 as u128) * 1000000000 / (v13 as u128)) as u64)
            } else {
                0
            };
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(v10, v1);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v11, v1);
            (v13, v14, v12, 1)
        } else {
            let v15 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::withdraw_all<T2>(arg2, arg17);
            let (v16, v17) = h2j5k7<T1, T2>(arg1, v15, 0, arg16, arg17);
            let v18 = v17;
            let v19 = v16;
            let v20 = 0x2::coin::value<T1>(&v19);
            let v21 = 0x2::coin::value<T2>(&v15) - 0x2::coin::value<T2>(&v18);
            let v22 = if (v20 > 0) {
                (((v21 as u128) * 1000000000 / (v20 as u128)) as u64)
            } else {
                0
            };
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v19, v1);
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(v18, v1);
            0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market::decrease_position<T0, T2, T3, T4, T2>(arg16, arg3, arg4, arg5, arg6, arg7, arg8, arg13, 2, true, arg10, arg11, arg12, arg17);
            (v20, v22, v21, 0)
        };
        let (v23, v24) = calculate_profit_from_prices(v4, v2, v6, arg14, arg15);
        let v25 = TradeExecuted{
            direction : v6,
            quantity  : v3,
            db_price  : v4,
            zo_price  : v2,
        ...
        0x2::event::emit<TradeExecuted>(v25);
        TradeResult{
            direction          : v6,
            db_base_amount     : v3,
            db_quote_amount    : v5,
