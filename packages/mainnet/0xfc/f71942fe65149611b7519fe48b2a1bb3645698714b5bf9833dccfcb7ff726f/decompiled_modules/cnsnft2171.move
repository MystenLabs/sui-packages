module 0xfcf71942fe65149611b7519fe48b2a1bb3645698714b5bf9833dccfcb7ff726f::cnsnft2171 {
    struct CNSNFT2171 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2171, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2171>(arg0, arg1);
