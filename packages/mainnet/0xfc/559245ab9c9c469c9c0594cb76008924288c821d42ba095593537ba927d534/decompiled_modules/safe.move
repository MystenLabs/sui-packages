module 0xfc559245ab9c9c469c9c0594cb76008924288c821d42ba095593537ba927d534::safe {
    ...
    fun init(arg0: SAFE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SAFE>(arg0, 18, b"SAFE", b"SAFE TO TRADE BRUH", b"We just here for the hype", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = 0x2::coin::treasury_into_supply<SAFE>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<SAFE>>(0x2::coin::from_balance<SAFE>(0x2::balance::increase_supply<SAFE>(&mut v2, 10000000000000000), arg1), 0x2::tx_context::sender(arg1));
