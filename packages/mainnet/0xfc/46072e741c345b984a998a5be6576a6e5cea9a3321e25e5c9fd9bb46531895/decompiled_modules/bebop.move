module 0xfc46072e741c345b984a998a5be6576a6e5cea9a3321e25e5c9fd9bb46531895::bebop {
    ...
    fun init(arg0: BEBOP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<BEBOP>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BEBOP   ")))), trim_right(b"BEBOP                           "), trim_right(b"Inspired by the iconic anime Cowboy Bebop, $BEBOP is more than just a token. It's a gateway to the gritty, jazz-filled, spacefaring world of bounty hunters, intergalactic intrigue, and high-tech adventure.                                                                                                                   "), v2, arg1);
        let v5 = v3;
