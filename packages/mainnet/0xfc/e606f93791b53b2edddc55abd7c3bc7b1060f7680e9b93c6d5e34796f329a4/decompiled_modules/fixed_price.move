module 0xfce606f93791b53b2edddc55abd7c3bc7b1060f7680e9b93c6d5e34796f329a4::fixed_price {
    ...
    public fun borrow_market<T0>(arg0: &0xfce606f93791b53b2edddc55abd7c3bc7b1060f7680e9b93c6d5e34796f329a4::venue::Venue) : &FixedPriceMarket<T0> {
        let v0 = MarketKey{dummy_field: false};
        0xfce606f93791b53b2edddc55abd7c3bc7b1060f7680e9b93c6d5e34796f329a4::venue::borrow_market<FixedPriceMarket<T0>, MarketKey>(v0, arg0)
    }
    ...
    fun buy_nft_<T0: store + key, T1>(arg0: &mut 0xfce606f93791b53b2edddc55abd7c3bc7b1060f7680e9b93c6d5e34796f329a4::listing::Listing, arg1: 0x2::object::ID, arg2: &mut 0x2::balance::Balance<T1>, arg3: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        let v0 = borrow_market<T1>(0xfce606f93791b53b2edddc55abd7c3bc7b1060f7680e9b93c6d5e34796f329a4::listing::borrow_venue(arg0, arg1));
        let v1 = MarketKey{dummy_field: false};
        0xfce606f93791b53b2edddc55abd7c3bc7b1060f7680e9b93c6d5e34796f329a4::listing::buy_pseudorandom_nft<T0, T1, FixedPriceMarket<T1>, MarketKey>(arg0, v1, v0.inventory_id, arg1, 0x2::tx_context::sender(arg3), 0x2::balance::split<T1>(arg2, v0.price), arg3)
    }
    ...
    public fun create_venue<T0, T1>(arg0: &mut 0xfce606f93791b53b2edddc55abd7c3bc7b1060f7680e9b93c6d5e34796f329a4::listing::Listing, arg1: 0x2::object::ID, arg2: bool, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v1 = MarketKey{dummy_field: false};
        0xfce606f93791b53b2edddc55abd7c3bc7b1060f7680e9b93c6d5e34796f329a4::listing::create_venue<FixedPriceMarket<T1>, MarketKey>(arg0, v1, v0, arg2, arg4)
    }
    ...
    public entry fun set_price<T0>(arg0: &mut 0xfce606f93791b53b2edddc55abd7c3bc7b1060f7680e9b93c6d5e34796f329a4::listing::Listing, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = MarketKey{dummy_field: false};
        0xfce606f93791b53b2edddc55abd7c3bc7b1060f7680e9b93c6d5e34796f329a4::listing::market_internal_mut<FixedPriceMarket<T0>, MarketKey>(arg0, v0, arg1).price = arg2;
    }
