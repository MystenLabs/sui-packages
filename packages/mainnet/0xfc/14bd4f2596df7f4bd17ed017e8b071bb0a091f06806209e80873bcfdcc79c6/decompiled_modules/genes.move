module 0xfc14bd4f2596df7f4bd17ed017e8b071bb0a091f06806209e80873bcfdcc79c6::genes {
    ...
    public fun get_attributes<T0>(arg0: &0x2::object::UID, arg1: &vector<u8>) : vector<0x1::string::String> {
        ...
        while (v2 < 0x1::vector::length<GeneDefinition>(v0)) {
            ...
            let v5 = 0;
            while (v5 < 0x1::vector::length<Value>(&v3.values)) {
                let v6 = 0x1::vector::borrow<Value>(&v3.values, v5);
                if (*v4 <= v6.selector) {
