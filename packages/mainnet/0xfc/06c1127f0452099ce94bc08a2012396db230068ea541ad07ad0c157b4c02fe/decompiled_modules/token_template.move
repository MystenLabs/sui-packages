module 0xfc06c1127f0452099ce94bc08a2012396db230068ea541ad07ad0c157b4c02fe::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"CT3763467", b"ConcurrentToken3 763467", b"Third concurrent deployment", 0x1::option::none<0x2::url::Url>(), arg1);
