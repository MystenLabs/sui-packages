module 0xfc6471d9d1734f1ee17f7cec64f1cc853b021dd3c074a56e1a566a75166c1d11::capybara_lootbox {
    ...
    fun init(arg0: CAPYBARA_LOOTBOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = &mut v3;
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Capybara NFT Lootbox number {idx}"));
    ...
    public fun update_storage(arg0: &0xfc6471d9d1734f1ee17f7cec64f1cc853b021dd3c074a56e1a566a75166c1d11::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
