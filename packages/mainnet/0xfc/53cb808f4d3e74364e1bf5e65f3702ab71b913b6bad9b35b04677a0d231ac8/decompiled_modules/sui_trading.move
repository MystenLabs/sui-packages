module 0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_trading {
    ...
    struct SuiTradingModule has key {
        ...
        vault_id: 0x2::object::ID,
        trading_vault_id: 0x2::object::ID,
        api_wallets: 0x2::table::Table<address, 0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_types::ApiWalletInfo>,
        order_nonce: u128,
    ...
    public fun add_api_wallet(arg0: &mut SuiTradingModule, arg1: &SuiLeaderTradeCap, arg2: address, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::table::contains<address, 0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_types::ApiWalletInfo>(&arg0.api_wallets, arg2), 7);
        let v0 = if (arg3 == 0) {
            0
        } else {
            assert!(arg3 >= 0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_types::min_api_wallet_duration() / 86400 && arg3 <= 0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_types::max_api_wallet_duration() / 86400, 5);
            0x2::clock::timestamp_ms(arg5) / 1000 + arg3 * 24 * 60 * 60
        };
        0x2::table::add<address, 0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_types::ApiWalletInfo>(&mut arg0.api_wallets, arg2, 0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_types::new_api_wallet_info(true, v0, arg4));
    ...
    public fun create_trading_vault<T0>(arg0: &0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_factory::SuiAdminCap, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    fun create_trading_vault_internal<T0>(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = SuiTradingModule{
            ...
            vault_id         : arg0,
            trading_vault_id : v1,
            api_wallets      : 0x2::table::new<address, 0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_types::ApiWalletInfo>(arg5),
            order_nonce      : 0,
    ...
    public fun create_trading_vault_unlimited<T0>(arg0: &0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_factory::SuiAdminCap, arg1: 0x2::object::ID, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun has_api_wallet(arg0: &SuiTradingModule, arg1: address) : bool {
        0x2::table::contains<address, 0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_types::ApiWalletInfo>(&arg0.api_wallets, arg1)
    }
    ...
    public fun remove_api_wallet(arg0: &mut SuiTradingModule, arg1: &SuiLeaderTradeCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == arg0.vault_id, 1);
        assert!(0x2::table::contains<address, 0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_types::ApiWalletInfo>(&arg0.api_wallets, arg2), 6);
        0x2::table::remove<address, 0xfc53cb808f4d3e74364e1bf5e65f3702ab71b913b6bad9b35b04677a0d231ac8::sui_types::ApiWalletInfo>(&mut arg0.api_wallets, arg2);
