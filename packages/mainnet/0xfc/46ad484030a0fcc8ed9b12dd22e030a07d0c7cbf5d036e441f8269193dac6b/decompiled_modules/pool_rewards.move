module 0x83d6f864a6b0f16898376b486699aa6321eb6466d1daf6a2e3764a51908fe99d::pool_rewards {
    ...
    public(friend) fun drain_all_rewards<T0>(arg0: &mut PoolRewards<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.rewards, 0x2::balance::value<T0>(&arg0.rewards)), arg1);
        0x2::coin::join<T0>(&mut v0, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.admin_fee, 0x2::balance::value<T0>(&arg0.admin_fee)), arg1));
        v0
    }
