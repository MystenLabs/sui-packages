module 0xfcd94e0d49b0dc8568761811ac0cf5ab0c1e9130a72241f9977ab2db4949101a::cnsnft8855 {
    struct CNSNFT8855 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8855, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://rwdsuinet-1126img-1273.vercel.app/rwdsuinet_1126.jpg"));
        ...
        let v4 = 0x2::package::claim<CNSNFT8855>(arg0, arg1);
