module 0xfc75a4e7ad8923d6fde06c806c3dfe0989a376385972d8086ac0d94f78ef47e5::cnsnft9286 {
    struct CNSNFT9286 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9286, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8951"));
        let v4 = 0x2::package::claim<CNSNFT9286>(arg0, arg1);
