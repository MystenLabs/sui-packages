module 0xfcb7b941c6f9efebd315793a500e205348a6e3c50fd67db53084fcd9c0d26e1a::cnsnft5661 {
    struct CNSNFT5661 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5661, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5661>(arg0, arg1);
