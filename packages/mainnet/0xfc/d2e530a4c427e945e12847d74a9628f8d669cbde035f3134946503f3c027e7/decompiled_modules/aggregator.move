module 0xfcd2e530a4c427e945e12847d74a9628f8d669cbde035f3134946503f3c027e7::aggregator {
    ...
    public entry fun execute_bluefin_swap<T0, T1>(arg0: &mut Aggregator, arg1: bool, arg2: u64, arg3: 0x2::object::ID, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg7: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg8: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 4;
        if (arg1) {
            let v2 = before_execute<T0>(arg0, v0, arg2, arg3, arg8);
            let v3 = 0xfcd2e530a4c427e945e12847d74a9628f8d669cbde035f3134946503f3c027e7::bluefin_wrapper::swap_a2b<T0, T1>(arg5, arg6, arg7, v2, arg8);
            after_execute<T1>(arg0, v0, v3, arg4, arg3, arg8);
            0x2::coin::value<T1>(&v3)
        } else {
            let v4 = before_execute<T1>(arg0, v0, arg2, arg3, arg8);
            let v5 = 0xfcd2e530a4c427e945e12847d74a9628f8d669cbde035f3134946503f3c027e7::bluefin_wrapper::swap_b2a<T0, T1>(arg5, arg6, arg7, v4, arg8);
            after_execute<T0>(arg0, v0, v5, arg4, arg3, arg8);
    ...
    public entry fun execute_cetus_swap<T0, T1>(arg0: &mut Aggregator, arg1: bool, arg2: u64, arg3: u64, arg4: 0x2::object::ID, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (arg1) {
            ...
            let v3 = 0xfcd2e530a4c427e945e12847d74a9628f8d669cbde035f3134946503f3c027e7::cetus_wrapper::swap_a2b<T0, T1>(arg5, arg6, arg7, v2, arg8, arg9);
            after_execute<T1>(arg0, v0, v3, arg3, arg4, arg9);
            0x2::coin::value<T1>(&v3)
        } else {
            let v4 = before_execute<T1>(arg0, v0, arg2, arg4, arg9);
            let v5 = 0xfcd2e530a4c427e945e12847d74a9628f8d669cbde035f3134946503f3c027e7::cetus_wrapper::swap_b2a<T0, T1>(arg5, arg6, arg7, v4, arg8, arg9);
            after_execute<T0>(arg0, v0, v5, arg3, arg4, arg9);
            0x2::coin::value<T0>(&v5)
        }
    }

    public entry fun execute_flowx_swap<T0, T1>(arg0: &mut Aggregator, arg1: bool, arg2: u64, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg6: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 3;
        if (arg1) {
            let v2 = before_execute<T0>(arg0, v0, arg2, arg3, arg6);
            let v3 = 0xfcd2e530a4c427e945e12847d74a9628f8d669cbde035f3134946503f3c027e7::flowx_wrapper::swap_a2b<T0, T1>(arg5, v2, arg6);
            after_execute<T1>(arg0, v0, v3, arg4, arg3, arg6);
            0x2::coin::value<T1>(&v3)
        } else {
            let v4 = before_execute<T1>(arg0, v0, arg2, arg3, arg6);
            let v5 = 0xfcd2e530a4c427e945e12847d74a9628f8d669cbde035f3134946503f3c027e7::flowx_wrapper::swap_b2a<T0, T1>(arg5, v4, arg6);
            after_execute<T0>(arg0, v0, v5, arg4, arg3, arg6);
            0x2::coin::value<T0>(&v5)
        }
    }
    ...
    public entry fun execute_turbos_swap<T0, T1, T2>(arg0: &mut Aggregator, arg1: bool, arg2: u64, arg3: u64, arg4: 0x2::object::ID, arg5: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg6: &0x2::clock::Clock, arg7: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg8: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (arg1) {
            ...
            let v3 = 0xfcd2e530a4c427e945e12847d74a9628f8d669cbde035f3134946503f3c027e7::turbos_wrapper::swap_a2b<T0, T1, T2>(arg5, v2, arg6, arg7, arg8);
            after_execute<T1>(arg0, v0, v3, arg3, arg4, arg8);
            0x2::coin::value<T1>(&v3)
        } else {
            let v4 = before_execute<T1>(arg0, v0, arg2, arg4, arg8);
            let v5 = 0xfcd2e530a4c427e945e12847d74a9628f8d669cbde035f3134946503f3c027e7::turbos_wrapper::swap_b2a<T0, T1, T2>(arg5, v4, arg6, arg7, arg8);
    ...
    public entry fun withdraw<T0>(arg0: &mut Aggregator, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = extract_intermediate_coin<T0>(arg0, v0.from_amount, arg2);
        let v2 = Traded{
            trade_id    : arg1,
            from        : v0.from,
