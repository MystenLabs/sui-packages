module 0xfc310f535c08f2c42beda3fcf638a0ef18292fc7cc1c1d1a3d3e68f318c2edbe::cnsnft2579 {
    struct CNSNFT2579 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2579, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2579>(arg0, arg1);
