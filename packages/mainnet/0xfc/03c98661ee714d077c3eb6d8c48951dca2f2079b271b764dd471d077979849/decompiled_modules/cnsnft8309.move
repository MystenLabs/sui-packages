module 0xfc03c98661ee714d077c3eb6d8c48951dca2f2079b271b764dd471d077979849::cnsnft8309 {
    struct CNSNFT8309 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8309, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8309>(arg0, arg1);
