module 0x9b2c9e1466239f81d4ec69b31907e700e62f7d84895da6133893b5e1b78bbf25::regcoin {
    ...
    fun init(arg0: REGCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<REGCOIN>(arg0, 6, b"flowx", b"flow coin", b"elooo", 0x1::option::none<0x2::url::Url>(), false, arg1);
