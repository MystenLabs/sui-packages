module 0x9807b3bb5358171cb9d3ca47b7061ade45d13637a4e9eb2bb4e59ed631b5551b::console {
    ...
    fun slot_group_open(arg0: u8) : 0x1::string::String {
        if (arg0 == 0) {
            0x1::string::utf8(b"<g transform='translate(15.4,280) scale(2.0)'>")
        } else if (arg0 == 1) {
            0x1::string::utf8(b"<g transform='translate(60.4,280) scale(2.0)'>")
        } else if (arg0 == 2) {
            0x1::string::utf8(b"<g transform='translate(105.4,280) scale(2.0)'>")
        } else {
            0x1::string::utf8(b"<g transform='translate(150.4,280) scale(2.0)'>")
        }
    }
