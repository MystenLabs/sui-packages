module 0x9be3918a0cf164c6222b333fb681248662c9074c12fcbb2f778035c68e36b205::cnsnft5896 {
    struct CNSNFT5896 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5896, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5896>(arg0, arg1);
