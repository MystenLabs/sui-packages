module 0x9b608ee3ae6415b4a9903fd7022e0a3e9110f125edc23cb64a03bb724f032db9::mogul_by_moviepass {
    ...
    fun init(arg0: MOGUL_BY_MOVIEPASS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Fantasy League For Hollywood"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiblbtng7t6zeus3ii2lvcjgb2wyzcbo5ylxrm6kqms6fpqnkqfmee"));
