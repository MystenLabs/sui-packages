module 0x9bdb935e30b58aa129a47a69086715c0d97958902016f017b8de10eba9e1f61b::cnsnft5687 {
    struct CNSNFT5687 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5687, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5687>(arg0, arg1);
