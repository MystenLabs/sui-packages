module 0x9b8e24bec957c8132ee501eef8f0fd1a67152795e1208ae7e00a47fba1d08683::but {
    struct BUT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BUT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<BUT>(&mut v2, 1000000000000000000, @0x8f0a295b4d4f1396a9d7fabf31cbc10d72942bb0616fa2327dce7b904ccb6072, arg1);
        0x2::transfer::public_transfer<0x2::coin::CoinMetadata<BUT>>(v1, @0x8f0a295b4d4f1396a9d7fabf31cbc10d72942bb0616fa2327dce7b904ccb6072);
        let v3 = ButBurner{
