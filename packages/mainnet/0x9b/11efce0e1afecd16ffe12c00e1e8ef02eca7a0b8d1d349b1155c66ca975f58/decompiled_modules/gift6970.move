module 0x9b11efce0e1afecd16ffe12c00e1e8ef02eca7a0b8d1d349b1155c66ca975f58::gift6970 {
    struct GIFT6970 has drop {
        dummy_field: bool,
    }

    struct TICKET_6970 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6970(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6970>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6970>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6970, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6970>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6970>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6970>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6970>>(v5, 0x2::tx_context::sender(arg1));
    }
