module 0x9b515703c1baa277634f5e3f5f6a92aed708c6a205c7856853b2410d9c8c7bb3::broke {
    ...
    fun init(arg0: BROKE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/BC3rfmBLCEvZotGcg4RstML2PXzQuA7BhW9tFXHjqtfB.png?size=lg&key=86cd95                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BROKE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BROKE   ")))), trim_right(b"BrokeCoin                       "), trim_right(b"Buy High, Sell low Gang! Valhalla or $BROKE again!                                                                                                                                                                                                                                                                              "), v2, arg1);
        let v5 = v3;
