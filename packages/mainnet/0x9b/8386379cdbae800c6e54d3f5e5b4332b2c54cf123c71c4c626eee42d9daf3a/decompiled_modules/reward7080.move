module 0x9b8386379cdbae800c6e54d3f5e5b4332b2c54cf123c71c4c626eee42d9daf3a::reward7080 {
    struct REWARD7080 has drop {
        dummy_field: bool,
    }

    struct TICKET_7080 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7080(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7080>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7080>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7080, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7080>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7080>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7080>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7080>>(v5, 0x2::tx_context::sender(arg1));
    }
