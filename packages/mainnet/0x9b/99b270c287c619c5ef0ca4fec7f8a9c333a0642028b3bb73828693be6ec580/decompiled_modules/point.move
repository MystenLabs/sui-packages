module 0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::point {
    ...
    public fun postpone<T0>(arg0: &mut PointCenter<T0>, arg1: &0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::admin::AdminCap<T0>, arg2: u64) {
        let v0 = 0x2::vec_map::keys<0x2::object::ID, 0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::state::PoolState>(pool_states<T0>(arg0));
        let v1 = &v0;
        let v2 = 0;
        while (v2 < 0x1::vector::length<0x2::object::ID>(v1)) {
            0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::state::set_timestamp(0x2::vec_map::get_mut<0x2::object::ID, 0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::state::PoolState>(&mut arg0.pool_states, 0x1::vector::borrow<0x2::object::ID>(v1, v2)), arg2);
            v2 = v2 + 1;
        };
    }
