module 0x9be81e44f7fa2594143231137ff1af49b185e99a682f02b4b07bc60590a2f695::demo {
    ...
    public entry fun add_payment_token_g<T0, T1>(arg0: &mut StakingPool<T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun unlock_slot_with_token<T0, T1>(arg0: &mut StakingPool<T1>, arg1: u8, arg2: 0x1::string::String, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_not_paused<T1>(arg0);
        assert!(arg1 >= 1 && arg1 <= 100, 30);
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = PaymentTokenRegistryKey{dummy_field: false};
        assert!(0x2::table::contains<0x1::string::String, bool>(&0x2::dynamic_object_field::borrow<PaymentTokenRegistryKey, PaymentTokenRegistry>(&arg0.id, v1).supported_tokens, arg2), 35);
        let v2 = SlotTokenPricingKey{slot_number: arg1};
        let v3 = if (0x2::dynamic_object_field::exists_<SlotTokenPricingKey>(&arg0.id, v2)) {
            let v4 = 0x2::dynamic_object_field::borrow<SlotTokenPricingKey, SlotTokenPricing>(&arg0.id, v2);
            if (0x2::table::contains<0x1::string::String, u64>(&v4.token_prices, arg2)) {
                *0x2::table::borrow<0x1::string::String, u64>(&v4.token_prices, arg2)
            } else {
                0
            }
        } else {
        ...
        if (v3 == 0) {
            ...
            assert!(0x2::coin::value<T0>(&arg3) == v3, 31);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg3, arg0.admin);
            let v5 = TokenRevenueKey{token_type: arg2};
            if (!0x2::dynamic_object_field::exists_<TokenRevenueKey>(&arg0.id, v5)) {
                let v6 = TokenRevenue{
                    id              : 0x2::object::new(arg5),
                    token_type      : arg2,
                    total_collected : 0,
                ...
                0x2::dynamic_object_field::add<TokenRevenueKey, TokenRevenue>(&mut arg0.id, v5, v6);
            };
            let v7 = 0x2::dynamic_object_field::borrow_mut<TokenRevenueKey, TokenRevenue>(&mut arg0.id, v5);
            v7.total_collected = safe_add(v7.total_collected, v3);
        };
        let v8 = UserSlotAllocationKey{user: v0};
        let v9 = PoolSlotLimitsKey{dummy_field: false};
        if (!0x2::dynamic_object_field::exists_<UserSlotAllocationKey>(&arg0.id, v8)) {
            let v10 = UserSlotAllocation{
                id                    : 0x2::object::new(arg5),
                owner                 : v0,
                max_slots_allowed     : 0x2::dynamic_object_field::borrow<PoolSlotLimitsKey, PoolSlotLimits>(&arg0.id, v9).default_max_slots_per_wallet,
                total_slots_unlocked  : 0,
                unlocked_slot_numbers : 0x1::vector::empty<u8>(),
            };
            0x2::dynamic_object_field::add<UserSlotAllocationKey, UserSlotAllocation>(&mut arg0.id, v8, v10);
            arg0.total_users_with_slots = safe_add(arg0.total_users_with_slots, 1);
        };
        assert!(!is_slot_unlocked<T1>(arg0, v0, arg1), 33);
        let v11 = 0x2::dynamic_object_field::borrow_mut<UserSlotAllocationKey, UserSlotAllocation>(&mut arg0.id, v8);
        assert!(arg1 <= v11.max_slots_allowed, 40);
        assert!(v11.total_slots_unlocked < v11.max_slots_allowed, 32);
        0x1::vector::push_back<u8>(&mut v11.unlocked_slot_numbers, arg1);
        v11.total_slots_unlocked = v11.total_slots_unlocked + 1;
        let v12 = v11.total_slots_unlocked;
        let v13 = get_or_create_slot_data<T1>(arg0, v0, arg1, arg5);
        v13.is_unlocked = true;
        let v14 = SlotUnlockedWithToken{
            pool_id              : 0x2::object::id<StakingPool<T1>>(arg0),
            user                 : v0,
            slot_number          : arg1,
            token_type           : arg2,
            payment_amount       : v3,
            unlock_time          : 0x2::clock::timestamp_ms(arg4),
            total_slots_unlocked : v12,
        };
        0x2::event::emit<SlotUnlockedWithToken>(v14);
    }
