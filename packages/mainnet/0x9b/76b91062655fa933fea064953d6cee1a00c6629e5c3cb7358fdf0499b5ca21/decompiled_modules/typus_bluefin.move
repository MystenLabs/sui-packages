module 0x3996731caa20b3369a761099489ed7e0d71bbe1123443e3db132ba603e6be77c::typus_bluefin {
    ...
    public fun swap<T0, T1, T2, T3>(arg0: &mut 0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T2>, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T3>, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T3>) {
        ...
        let (v2, v3) = if (0x1::type_name::get<T0>() == 0x1::type_name::get<T1>()) {
            ...
            if (0x2::balance::value<T2>(&v7) < arg5) {
                ...
                let (v9, v10) = swap_<T1, T2>(arg1, arg2, v5, 0x2::balance::zero<T2>(), true, false, v8, v8, arg6, arg7);
                0x2::balance::join<T2>(&mut v7, v10);
                (v9, v7)
            } else {
                let v11 = v5;
                let v12 = 0x2::balance::value<T2>(&v7);
                let (v13, v14) = swap_<T1, T2>(arg1, arg2, 0x2::balance::zero<T1>(), v7, false, true, v12, v12, arg6, arg7);
                let v15 = v14;
            ...
            if (0x2::balance::value<T1>(&v19) < arg5) {
                ...
                let (v21, v22) = swap_<T1, T2>(arg1, arg2, 0x2::balance::zero<T1>(), v18, false, false, v20, v20, arg6, arg7);
                0x2::balance::join<T1>(&mut v19, v21);
                (v19, v22)
            } else {
                let v23 = v18;
                let v24 = 0x2::balance::value<T1>(&v19);
                let (v25, v26) = swap_<T1, T2>(arg1, arg2, v19, 0x2::balance::zero<T2>(), true, true, v24, v24, arg6, arg7);
                let v27 = v25;
    ...
    public fun swap_all<T0, T1, T2, T3>(arg0: &mut 0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T2>, arg3: 0x2::balance::Balance<T0>, arg4: u128, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T3> {
        ...
        let v2 = calculate_swap_result<T1, T2>(arg2, v1, true, 0x2::balance::value<T0>(&arg3), arg4);
        if (v2 == 0) {
            ...
            0x2::dynamic_field::add<vector<u8>, 0x2::balance::Balance<T0>>(&mut v4, b"IN_TOKEN", arg3);
            let (v5, v6) = if (v1) {
                (0x2::dynamic_field::remove<vector<u8>, 0x2::balance::Balance<T1>>(&mut v4, b"IN_TOKEN"), 0x2::balance::zero<T2>())
            } else {
                (0x2::balance::zero<T1>(), 0x2::dynamic_field::remove<vector<u8>, 0x2::balance::Balance<T2>>(&mut v4, b"IN_TOKEN"))
            };
            let v7 = v6;
            let v8 = v5;
            let v9 = if (v1) {
                ...
                0x2::balance::value<T2>(&v7)
            };
            let (v10, v11) = swap_<T1, T2>(arg1, arg2, v8, v7, v1, true, v9, v2, arg4, arg5);
            if (v1) {
                0x2::dynamic_field::add<vector<u8>, 0x2::balance::Balance<T2>>(&mut v4, b"OUT_TOKEN", v11);
                0x2::balance::destroy_zero<T1>(v10);
            } else {
                0x2::dynamic_field::add<vector<u8>, 0x2::balance::Balance<T1>>(&mut v4, b"OUT_TOKEN", v10);
                0x2::balance::destroy_zero<T2>(v11);
            };
            0x2::object::delete(v4);
            0x2::dynamic_field::remove<vector<u8>, 0x2::balance::Balance<T3>>(&mut v4, b"OUT_TOKEN")
        }
    }
