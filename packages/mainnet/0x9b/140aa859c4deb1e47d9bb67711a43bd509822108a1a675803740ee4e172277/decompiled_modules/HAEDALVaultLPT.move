module 0x9b140aa859c4deb1e47d9bb67711a43bd509822108a1a675803740ee4e172277::HAEDALVaultLPT {
    struct HAEDALVAULTLPT has drop {
        dummy_field: bool,
    }

    fun init(arg0: HAEDALVAULTLPT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HAEDALVAULTLPT>(arg0, 9, b"HAEDAL Vault LPT", b"HAEDAL Vault LPT Coin", b"This token represents your deposited share in the Haedal Lending Vault. It automatically earns yield through optimized lending strategies across multiple protocols.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://lv-curator.haedal.xyz/Lendvault/lpt/haedalvaultlpt_a78a243d.png")), arg1);
