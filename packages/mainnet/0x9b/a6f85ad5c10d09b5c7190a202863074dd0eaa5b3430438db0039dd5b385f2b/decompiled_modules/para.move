module 0x9ba6f85ad5c10d09b5c7190a202863074dd0eaa5b3430438db0039dd5b385f2b::para {
    ...
    public fun handle_repayment_and_profit_split<T0>(arg0: &BotConfig, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::coin::Coin<T0>) {
        assert!(0x2::tx_context::sender(arg4) == arg0.bot, 1);
        let v0 = 0x2::balance::value<T0>(&arg1);
        let v1 = arg2 + arg3;
        assert!(v0 >= v1, 3);
        let v2 = v0 - v1;
        let v3 = if (v2 > 0) {
            0x2::balance::split<T0>(&mut arg1, v2)
        } else {
            0x2::balance::zero<T0>()
        };
        (arg1, 0x2::coin::from_balance<T0>(v3, arg4))
    }
