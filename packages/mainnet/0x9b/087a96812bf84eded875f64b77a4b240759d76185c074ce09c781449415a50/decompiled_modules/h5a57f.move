module 0x9b087a96812bf84eded875f64b77a4b240759d76185c074ce09c781449415a50::h5a57f {
    ...
    public(friend) fun h85f29<T0>(arg0: &0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::clearing_house::ClearingHouse<T0>) : (u64, u64, u256, u64) {
        let v0 = 0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::clearing_house::market_params<T0>(arg0);
        (0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::market::tick_size(v0), 0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::market::lot_size(v0), 0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::market::min_order_usd_value(v0), 0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::market::max_pending_orders(v0))
    }
    ...
    public(friend) fun hae3b3<T0>(arg0: &0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::clearing_house::ClearingHouse<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: bool) : vector<u64> {
        let (v0, v1) = if (arg4) {
            0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::orderbook::inspect_orders(0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::clearing_house::orderbook<T0>(arg0), false, 18446744073709551615, 0, arg2)
        } else {
            0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::orderbook::inspect_orders(0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::clearing_house::orderbook<T0>(arg0), true, 0, 18446744073709551615, arg2)
        };
        let v2 = v1;
        let v3 = v0;
        let v4 = vector[];
        let v5 = 0;
        while (v5 < 0x1::vector::length<0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::orderbook::Order>(&v2)) {
            let (v6, _, _, v9, _, _) = 0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::orderbook::as_parts(0x1::vector::borrow<0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::orderbook::Order>(&v2, v5));
            let v12 = v9;
    ...
    public(friend) fun hfa5fc<T0>(arg0: &0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::clearing_house::ClearingHouse<T0>) : (0x1::option::Option<u64>, 0x1::option::Option<u64>) {
        (0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::clearing_house::best_price_u64<T0>(arg0, false), 0xd6f84f3a6a0bcee7288f72af297a87ab6f5d1a60a5d467d8c44ef55d915d3fb3::clearing_house::best_price_u64<T0>(arg0, true))
    }
