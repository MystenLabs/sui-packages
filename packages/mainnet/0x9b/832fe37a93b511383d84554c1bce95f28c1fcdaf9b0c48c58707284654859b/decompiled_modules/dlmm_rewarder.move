module 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_rewarder {
    ...
    public fun deposit_reward<T0>(arg0: &0xbb1e485664a4d5099154f9c8f10a54d49e2e7dc02c8e358253f0cd5c14eaa1bd::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) : u64 {
    ...
    public fun emergent_withdraw<T0>(arg0: &0xbb1e485664a4d5099154f9c8f10a54d49e2e7dc02c8e358253f0cd5c14eaa1bd::config::AdminCap, arg1: &0xbb1e485664a4d5099154f9c8f10a54d49e2e7dc02c8e358253f0cd5c14eaa1bd::config::GlobalConfig, arg2: &mut RewarderGlobalVault, arg3: u64) : 0x2::balance::Balance<T0> {
    ...
    public(friend) fun get_growths_update_to_date(arg0: &RewarderManager, arg1: u256, arg2: &0x2::clock::Clock) : 0x2::vec_map::VecMap<0x1::type_name::TypeName, u256> {
        ...
        while (v3 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            0x2::vec_map::insert<0x1::type_name::TypeName, u256>(&mut v0, reward_coin(0x1::vector::borrow<Rewarder>(&arg0.rewarders, v3)), 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v3).growth_global + ((v2 - v1) as u256) * 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v3).emissions_per_second / (arg1 >> 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale_offset()));
            v3 = v3 + 1;
        };
        v0
    }
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: u256, arg2: u64) {
        ...
        while (v2 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v2).growth_global = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).growth_global + (v1 as u256) * 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).emissions_per_second / (arg1 >> 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale_offset());
            v2 = v2 + 1;
        };
        arg0.points_released = arg0.points_released + (v1 as u256) * 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale();
        arg0.points_growth_global = arg0.points_growth_global + (v1 as u256) * 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale() / (arg1 >> 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale_offset());
    }

    public(friend) fun update_emission<T0>(arg0: &mut RewarderManager, arg1: &RewarderGlobalVault, arg2: u256, arg3: u256, arg4: u64) {
        settle(arg0, arg2, arg4);
        if (arg3 > 0) {
            let v0 = 0x1::type_name::get<T0>();
            assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg1.balances, v0), 5);
            assert!((0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg1.balances, v0)) as u256) << 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale_offset() >= (0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::day() as u256) * arg3, 4);
        };
        borrow_mut_rewarder<T0>(arg0).emissions_per_second = arg3;
    }

    public(friend) fun update_emissions_per_second(arg0: &mut Rewarder, arg1: u256) {
