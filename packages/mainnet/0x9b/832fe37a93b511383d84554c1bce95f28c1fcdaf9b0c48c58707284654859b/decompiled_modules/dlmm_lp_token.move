module 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_lp_token {
    ...
    public fun burn(arg0: &mut DlmmLpToken, arg1: &MintCap, arg2: u32, arg3: address, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(arg1.lp_token == 0x2::object::id<DlmmLpToken>(arg0) && arg1.pair_id == arg0.pair_id, 9223372453466603519);
    ...
    public fun mint(arg0: &mut DlmmLpToken, arg1: &MintCap, arg2: u32, arg3: address, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(arg1.lp_token == 0x2::object::id<DlmmLpToken>(arg0) && arg1.pair_id == arg0.pair_id, 9223372337502486527);
        if (!0x2::table::contains<u32, 0x2::table::Table<address, u64>>(&arg0.balances, arg2)) {
        ...
        0x2::event::emit<EventTransfer>(v3);
        v2
    }
