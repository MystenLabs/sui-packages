module 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::finance {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Finance{
            ...
            users            : 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::invite::create_user_pool(v0, arg0),
        ...
        0x2::event::emit<BindInviter>(v9);
        let v10 = UnStakeConfig{
            id          : 0x2::object::new(arg0),
            hashrate_id : 0,
            hr_rate     : 2000,
        };
        0x2::transfer::public_share_object<UnStakeConfig>(v10);
        let v11 = EcoConfig{
            id           : 0x2::object::new(arg0),
            eco_sequence : 0,
            eco_receipt  : v0,
        ...
        0x2::transfer::public_share_object<EcoConfig>(v11);
        let v12 = SUIPool{
            id       : 0x2::object::new(arg0),
            sequence : 0,
            receipt  : v0,
        ...
        0x2::transfer::public_share_object<SUIPool>(v12);
    }
