module 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::market {
    ...
    entry fun add_keeper<T0>(arg0: &0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::admin::AdminCap, arg1: &mut Market<T0>, arg2: address) {
    ...
    fun assert_authorized_keeper<T0>(arg0: &Market<T0>, arg1: &0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<KeepersKey>(&arg0.id, v0)) {
            ...
            assert!(0x2::vec_set::contains<address>(0x2::dynamic_field::borrow<KeepersKey, 0x2::vec_set::VecSet<address>>(&arg0.id, v0), &v1), 44);
        };
    }
    ...
    public fun check_version<T0>(arg0: &Market<T0>) {
        assert!(get_market_version<T0>(arg0) <= 46, 29);
    }
    ...
    entry fun clear_keepers<T0>(arg0: &0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::admin::AdminCap, arg1: &mut Market<T0>) {
        let v0 = KeepersKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<KeepersKey>(&arg1.id, v0)) {
    ...
    entry fun remove_keeper<T0>(arg0: &0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::admin::AdminCap, arg1: &mut Market<T0>, arg2: address) {
        let v0 = KeepersKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<KeepersKey>(&arg1.id, v0)) {
            let v1 = 0x2::dynamic_field::borrow_mut<KeepersKey, 0x2::vec_set::VecSet<address>>(&mut arg1.id, v0);
            if (0x2::vec_set::contains<address>(v1, &arg2)) {
