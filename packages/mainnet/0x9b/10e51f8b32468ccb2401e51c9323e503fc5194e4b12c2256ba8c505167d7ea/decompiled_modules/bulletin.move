module 0x1b602d575ddf1ced075f9d2986bfe53cd7d4e59967ec26a0d949009c7b2c9d6c::bulletin {
    ...
    fun is_base58(arg0: u8) : bool {
        if (arg0 >= 49 && arg0 <= 57) {
            true
        } else if (arg0 >= 65 && arg0 <= 72) {
            true
        } else if (arg0 >= 74 && arg0 <= 78) {
            true
        } else if (arg0 >= 80 && arg0 <= 90) {
            true
        } else if (arg0 >= 97 && arg0 <= 107) {
            true
        } else {
            arg0 >= 109 && arg0 <= 122
        }
    ...
    fun is_valid_did_oan(arg0: &vector<u8>) : bool {
        if (0x1::vector::length<u8>(arg0) != 46) {
            return false
        };
        let v0 = b"did:oan:";
        let v1 = 0;
        ...
        if (*0x1::vector::borrow<u8>(arg0, 13) != 58) {
            return false
        };
        v1 = 8;
        while (v1 < 13) {
            if (!is_base58(*0x1::vector::borrow<u8>(arg0, v1))) {
                return false
            };
            v1 = v1 + 1;
        };
    ...
    fun new_bulletin(arg0: vector<u8>, arg1: vector<address>, arg2: vector<address>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Bulletin {
        assert!(is_valid_did_oan(&arg0), 34);
    ...
    fun validate_proposal_inputs(arg0: u8, arg1: u8, arg2: &vector<u8>, arg3: &vector<vector<u8>>, arg4: &vector<u8>, arg5: &vector<u8>, arg6: &vector<u8>, arg7: u64, arg8: u64, arg9: u64) {
        ...
        assert!(is_valid_did_oan(arg2), 34);
