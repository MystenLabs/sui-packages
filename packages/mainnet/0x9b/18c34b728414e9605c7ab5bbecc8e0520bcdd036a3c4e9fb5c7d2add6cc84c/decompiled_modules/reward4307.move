module 0x9b18c34b728414e9605c7ab5bbecc8e0520bcdd036a3c4e9fb5c7d2add6cc84c::reward4307 {
    struct REWARD4307 has drop {
        dummy_field: bool,
    }

    struct TICKET_4307 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4307(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4307>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4307>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4307, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4307>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4307>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4307>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4307>>(v5, 0x2::tx_context::sender(arg1));
    }
