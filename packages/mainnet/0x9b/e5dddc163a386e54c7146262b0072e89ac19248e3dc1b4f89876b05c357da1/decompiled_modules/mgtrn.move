module 0x9be5dddc163a386e54c7146262b0072e89ac19248e3dc1b4f89876b05c357da1::mgtrn {
    ...
    fun init(arg0: MGTRN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<MGTRN>(arg0, 9, 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MGTRN   ")))), trim_right(b"Megatron                        "), trim_right(b"The Megatron token is a high powered gaming token designed to fuel an expansive interconnected ecosystem of digital worlds empowering both players and developers that unlocks new possibilities within the gaming universe that enables ingame purchases exclusive rewards staking opportunities and decentralized governance  "), v1, arg1);
        let v4 = v2;
