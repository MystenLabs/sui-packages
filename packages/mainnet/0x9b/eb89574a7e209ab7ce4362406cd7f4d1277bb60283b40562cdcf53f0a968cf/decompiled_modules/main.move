module 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::main {
    ...
    public entry fun new<T0: store + key, T1>(arg0: T0, arg1: &mut 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::project_config::ProjectConfig, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        assert!(0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::project_config::contains_item(arg1, arg2, 0x2::object::id_address<T0>(&arg0)), 1);
        assert!(0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::project_config::is_enabled(arg1, arg2), 2);
        assert!(arg5 > 0x2::clock::timestamp_ms(arg7), 4);
        assert!(0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::project_config::is_admin(arg1), 7);
        let (v0, v1) = 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::project_config::deep_immutable(arg1);
        let v2 = Raffle<T0, T1>{
            ...
            tickets_sold  : 0,
            end_timestamp : arg5,
            round         : (arg5 - 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::drand_lib::get_genesis()) / 30,
            fee_collector : 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::admin::get_owner(v0),
            ticket_price  : arg6,
            prize         : 0x1::option::some<T0>(arg0),
            participants  : 0x2::table::new<address, 0x2::object::ID>(arg8),
            winner        : 0x1::option::none<u64>(),
            collection    : arg2,
            collections   : 0x2::object::id<0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::project_config::WhitelistedCollections>(v1),
            proceeds      : 0x2::balance::zero<T1>(),
        };
        let v3 = 0x2::object::id<Raffle<T0, T1>>(&v2);
        0x2::transfer::public_share_object<Raffle<T0, T1>>(v2);
        0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::project_config::add_raffle(arg1, v3);
        v3
    }
    ...
    public entry fun buy<T0: store + key, T1>(arg0: &mut Raffle<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &mut Participation, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.tickets_sold == arg0.tickets) {
            ...
            arg0.round = (arg0.end_timestamp - 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::drand_lib::get_genesis() + 30) / 30;
        };
    }
    ...
    public entry fun draw<T0: store + key, T1>(arg0: &mut Raffle<T0, T1>, arg1: &0x2::clock::Clock, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::drand_lib::verify_drand_signature(arg2, arg3, arg0.round);
        let v0 = 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::drand_lib::derive_randomness(arg2);
        arg0.winner = 0x1::option::some<u64>(0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::drand_lib::safe_selection(arg0.tickets_sold, &v0));
    ...
    public entry fun initialize(arg0: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::project_config::initialize(arg0)
    }
