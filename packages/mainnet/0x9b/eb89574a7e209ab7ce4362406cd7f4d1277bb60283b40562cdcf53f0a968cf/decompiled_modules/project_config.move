module 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::project_config {
    ...
    struct ProjectConfig has store, key {
        id: 0x2::object::UID,
        admin: 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::admin::AdminConfig,
    ...
    public entry fun add_collection(arg0: &mut ProjectConfig, arg1: 0x1::string::String, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) : address {
        let (v0, v1) = deep(arg0);
        assert!(0x2::tx_context::sender(arg3) == 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::admin::get_owner(v0), 1);
    ...
    public fun deep(arg0: &mut ProjectConfig) : (&mut 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::admin::AdminConfig, &mut WhitelistedCollections) {
        (&mut arg0.admin, &mut arg0.collections)
    }

    public fun deep_immutable(arg0: &ProjectConfig) : (&0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::admin::AdminConfig, &WhitelistedCollections) {
    ...
    public entry fun initialize(arg0: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::admin::init_(arg0);
        let v1 = WhitelistedCollections{
            id          : 0x2::object::new(arg0),
            admin_id    : 0x2::object::id<0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::admin::AdminConfig>(&v0),
    ...
    public entry fun is_admin(arg0: &ProjectConfig) : bool {
        ...
        v1.admin_id == 0x2::object::id<0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::admin::AdminConfig>(v0)
    }
    ...
    public entry fun remove_empty_collection(arg0: &mut ProjectConfig, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = deep(arg0);
        assert!(0x2::tx_context::sender(arg2) == 0x9beb89574a7e209ab7ce4362406cd7f4d1277bb60283b40562cdcf53f0a968cf::admin::get_owner(v0), 1);
