module 0x9b149fa785d17c7f7d94c6132c21649cc13e73f55e0e8d6bf957f4dc208d22b6::vault {
    ...
    public(friend) fun take_pending_rcusdp<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        verify_version<T0, T1>(arg0);
        only_operator<T0, T1>(arg0, arg1);
        0x9b149fa785d17c7f7d94c6132c21649cc13e73f55e0e8d6bf957f4dc208d22b6::vault_events::emit_pending_rcusdp_taken(0x2::tx_context::sender(arg1), 0x2::balance::value<T1>(&arg0.pending_redeem_rcusdp));
        0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(&mut arg0.pending_redeem_rcusdp), arg1)
    }

    public(friend) fun take_pending_usdc<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        verify_version<T0, T1>(arg0);
        only_operator<T0, T1>(arg0, arg1);
        0x9b149fa785d17c7f7d94c6132c21649cc13e73f55e0e8d6bf957f4dc208d22b6::vault_events::emit_pending_usdc_taken(0x2::tx_context::sender(arg1), 0x2::balance::value<T0>(&arg0.pending_deposit));
