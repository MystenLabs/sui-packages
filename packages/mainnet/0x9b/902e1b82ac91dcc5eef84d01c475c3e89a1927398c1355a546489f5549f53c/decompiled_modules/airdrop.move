module 0xd5c9c69ffc5a40e60bd59bd2719985c72a75e729444b4788dfd8b7451045890d::airdrop {
    ...
    struct EventAirdropCreated has copy, drop, store {
    ...
    public fun new<T0>(arg0: 0x2::coin::Coin<T0>, arg1: vector<u8>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Airdrop<T0> {
        ...
        0x2::event::emit<EventAirdropCreated>(v2);
        v1
    }
    ...
    public fun get_airdrop<T0>(arg0: &mut Airdrop<T0>, arg1: vector<vector<u8>>, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::math64::min(arg3, 0x2::balance::value<T0>(&arg0.balance));
        let v2 = EventAirdropClaimed{
            airdrop_id : 0x2::object::id<Airdrop<T0>>(arg0),
            amount     : v1,
            user       : 0x2::tx_context::sender(arg4),
        };
        0x2::event::emit<EventAirdropClaimed>(v2);
