module 0x9b29e06e096095cea26edef0d01b4a2c8d07fe43bf3033edb1013b23a2d4725d::gift3971 {
    struct GIFT3971 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift3971(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT3971, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3971>(arg0, arg1);
