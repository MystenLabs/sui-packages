module 0x9bef3053e086a602587e698a38f8a57ded5e531f43df8ca53e450cab0ea3b1fc::raffle {
    ...
    public entry fun create_raffle<T0: store + key, T1>(arg0: &mut MarketplaceRaffle<T1>, arg1: T0, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
    ...
    public fun declare_winner<T0: store + key, T1>(arg0: &mut MarketplaceRaffle<T1>, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0.ticket_sold == 0) {
            ...
            let v3 = 0x1::vector::pop_back<Player>(&mut v0.list_player);
            v1 = v3.addr;
            v0.winner = v3.addr;
            v0.winning_ticket = v2;
        } else {
            v2 = rand_u64_range(1, v0.ticket_sold, arg3);
            while (!0x1::vector::is_empty<Player>(&v0.list_player)) {
                let v4 = 0x1::vector::pop_back<Player>(&mut v0.list_player);
                if (0x1::vector::contains<u64>(&v4.tickets, &v2)) {
                    v1 = v4.addr;
                    v0.winner = v4.addr;
                    v0.winning_ticket = v2;
                    break
        ...
        let v5 = RaffleDeclareWinnerEvent{
            raffle_id      : arg1,
            owner          : 0x2::tx_context::sender(arg3),
            winner         : v1,
            winning_ticket : v2,
        };
        0x2::event::emit<RaffleDeclareWinnerEvent>(v5);
    }
