module 0x9b2b83b1643ac4dbd1dcc6912e61141aea4c2bbee9e4b5304c882cc85a2ef74f::cnsnft4902 {
    struct CNSNFT4902 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4902, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4902>(arg0, arg1);
