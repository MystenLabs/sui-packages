module 0x9bda2e935e2be307ed3a5d3e3d94799252ea1cf100df61e2b4d06751e3120e04::llv_admin {
    ...
    public(friend) fun migrate(arg0: &mut LLVGlobal, arg1: &0x2::tx_context::TxContext) {
        ...
        arg0.version = 1;
        0x9bda2e935e2be307ed3a5d3e3d94799252ea1cf100df61e2b4d06751e3120e04::llv_events::emit_global_migrated(arg0.version);
    }
    ...
    public(friend) fun set_global_paused(arg0: &mut LLVGlobal, arg1: bool, arg2: &0x2::tx_context::TxContext) {
        ...
        arg0.paused = arg1;
        0x9bda2e935e2be307ed3a5d3e3d94799252ea1cf100df61e2b4d06751e3120e04::llv_events::emit_global_paused(arg1);
    }
    ...
    public(friend) fun set_owner(arg0: &mut LLVGlobal, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 3);
        arg0.owner = arg1;
        0x9bda2e935e2be307ed3a5d3e3d94799252ea1cf100df61e2b4d06751e3120e04::llv_events::emit_owner_changed(arg0.owner, arg1);
    }
