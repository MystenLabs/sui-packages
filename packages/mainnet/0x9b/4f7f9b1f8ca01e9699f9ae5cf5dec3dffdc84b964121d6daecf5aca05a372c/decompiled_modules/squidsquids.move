module 0x9b4f7f9b1f8ca01e9699f9ae5cf5dec3dffdc84b964121d6daecf5aca05a372c::squidsquids {
    ...
    public entry fun transfer_with_tax(arg0: &mut 0x2::coin::Coin<SQUIDSQUIDS>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = arg1 * 3 / 100;
        let v1 = arg1 - v0;
        0x9b4f7f9b1f8ca01e9699f9ae5cf5dec3dffdc84b964121d6daecf5aca05a372c::events::emit_transfer_event(0x2::tx_context::sender(arg3), arg2, v1, v0, 0x2::tx_context::epoch(arg3));
