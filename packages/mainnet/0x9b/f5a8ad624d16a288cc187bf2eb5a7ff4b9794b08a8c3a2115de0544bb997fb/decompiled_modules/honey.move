module 0x9bf5a8ad624d16a288cc187bf2eb5a7ff4b9794b08a8c3a2115de0544bb997fb::honey {
    ...
    public fun get_total_honey_Supply() : u64 {
        0x9bf5a8ad624d16a288cc187bf2eb5a7ff4b9794b08a8c3a2115de0544bb997fb::constants::total_honey_supply()
    }
    ...
    public fun set_rules<T0>(arg0: &mut 0x2::token::TokenPolicy<T0>, arg1: &0x2::token::TokenPolicyCap<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x9bf5a8ad624d16a288cc187bf2eb5a7ff4b9794b08a8c3a2115de0544bb997fb::constants::honey_burn_pct();
