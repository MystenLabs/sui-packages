module 0x9bb93eb40711dce666508f64e5abd098de5b1117148d0a667a88b5e2de289762::probably_walrus {
    ...
    fun init(arg0: PROBABLY_WALRUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibj627ik4ledelb2n6koerzd4jvmt27qtyoyab5g3cl5zkbalvdtq"));
