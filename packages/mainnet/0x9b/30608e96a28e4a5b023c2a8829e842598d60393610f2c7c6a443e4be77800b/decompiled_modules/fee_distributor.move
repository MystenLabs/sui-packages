module 0x9b30608e96a28e4a5b023c2a8829e842598d60393610f2c7c6a443e4be77800b::fee_distributor {
    ...
    public entry fun add_fee_receiver<T0: drop>(arg0: &0x9b30608e96a28e4a5b023c2a8829e842598d60393610f2c7c6a443e4be77800b::registry::AdminCap, arg1: &mut FeeDistributor, arg2: vector<u8>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun claim_fees<T0>(arg0: &0x9b30608e96a28e4a5b023c2a8829e842598d60393610f2c7c6a443e4be77800b::registry::FeeCollectorCap, arg1: &mut FeeDistributor, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, FeeReceiver>(&mut arg1.receivers, 0x9b30608e96a28e4a5b023c2a8829e842598d60393610f2c7c6a443e4be77800b::registry::name(arg0));
        let v1 = get_coin_type_key<T0>();
        ...
        let v6 = FeeClaimed{
            name            : 0x9b30608e96a28e4a5b023c2a8829e842598d60393610f2c7c6a443e4be77800b::registry::name(arg0),
            vault_coin_type : v1,
            fee_coin_type   : v1,
            amount          : v3,
        };
    ...
    public entry fun update_receiver_percentage<T0: drop>(arg0: &0x9b30608e96a28e4a5b023c2a8829e842598d60393610f2c7c6a443e4be77800b::registry::AdminCap, arg1: vector<u8>, arg2: &mut FeeDistributor, arg3: u64) {
