module 0x9b463741cf62335f39c91a6e0f7670e50574c24848dc9f73ed0c1b085127dc05::beadface {
    ...
    struct NFT has store, key {
        ...
        collection_image_url: 0x2::url::Url,
        collection_media_url: 0x2::url::Url,
    ...
    public entry fun create_collection(arg0: &TreasuryCapability, arg1: &mut GlobalRegistry, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Collection{
            ...
            media_url   : 0x2::url::new_unsafe_from_bytes(arg6),
            project_url : 0x2::url::new_unsafe_from_bytes(b""),
    ...
    fun create_display(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) : 0x2::display::Display<NFT> {
        ...
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"collection_media_url"));
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{collection_description}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{collection_image_url}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{collection_image_url}"));
    ...
    public entry fun create_template(arg0: &TreasuryCapability, arg1: &mut GlobalRegistry, arg2: &mut Collection, arg3: vector<u8>, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: vector<u8>) {
        ...
        let v1 = NFTTemplate{
            ...
            media_url   : 0x2::url::new_unsafe_from_bytes(arg8),
            project_url : 0x2::url::new_unsafe_from_bytes(arg9),
            link        : 0x2::url::new_unsafe_from_bytes(arg10),
        };
    ...
    fun init(arg0: BEADFACE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = GlobalRegistry{
            ...
            media_url   : 0x2::url::new_unsafe_from_bytes(b""),
            project_url : 0x2::url::new_unsafe_from_bytes(b""),
    ...
    public entry fun mint(arg0: &TreasuryCapability, arg1: &mut GlobalRegistry, arg2: &mut Collection, arg3: 0x1::string::String, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: address, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg4 > 0, 101);
        ...
        while (v1 < arg4) {
            ...
            let v2 = NFT{
                id                     : 0x2::object::new(arg8),
                collection_name        : arg2.name,
                collection_description : arg2.description,
                collection_image_url   : arg2.image_url,
                collection_media_url   : arg2.media_url,
                ...
                media_url              : v0.media_url,
                project_url            : v0.project_url,
                link                   : v0.link,
                attributes             : 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>(),
                creator                : 0x2::tx_context::sender(arg8),
            };
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2.attributes, arg5, arg6);
            let v3 = NFTMinted{
            ...
            0x2::transfer::public_transfer<NFT>(v2, arg7);
            v1 = v1 + 1;
        };
