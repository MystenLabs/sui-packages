module 0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::marketplace {
    ...
    public fun accept_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Marketplace>, TradeInfo<T0>) {
        assert!(0x2::kiosk_extension::is_installed<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Extension>(arg0), 9223373793496530947);
        assert!(0x2::kiosk_extension::is_installed<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Extension>(arg1), 9223373797791498243);
        let v0 = ListItem{id: arg2};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v0), 9223373802086596613);
        let v1 = BidItem{id: arg2};
        assert!(0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg1), v1), 9223373806381957131);
        ...
        let Listing {
            ...
            purchase_cap : v5,
            timestamp    : v6,
        } = 0x2::bag::remove<ListItem, Listing<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v2);
        ...
        let Bidding {
            ...
            funds     : v11,
            timestamp : v12,
        } = 0x2::bag::remove<BidItem, Bidding<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg1), v7);
        ...
        0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::witness_rule_marketplace::confirm<T0, Purchase>(v18, arg3, &mut v17);
        0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::lock<T0>(arg1, v15, arg3);
        ...
        (v17, 0x2::transfer_policy::new_request<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Marketplace>(arg2, v10, 0x2::object::id<0x2::kiosk::Kiosk>(arg0)), v19)
    }

    public fun accept_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut Collection, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Marketplace>, TradeInfo<T0>) {
        assert!(0x2::kiosk_extension::is_installed<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Extension>(arg0), 9223373986770059267);
        assert!(0x2::kiosk_extension::is_installed<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Extension>(arg1), 9223373991065026563);
        let v0 = ListItem{id: arg2};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v0), 9223373995360124933);
        let v1 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg3.id)};
        assert!(0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg1), v1), 9223373999655485451);
        let v2 = ListItem{id: arg2};
        let Listing {
            seller       : v3,
            price        : _,
        ...
        let CollectionBid {
            ...
            funds     : v9,
            timestamp : v10,
        } = 0x2::bag::remove<CollectionBidItem, CollectionBid<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg1), v7);
        let v11 = v9;
        ...
        let v17 = v16;
        let v18 = Purchase{dummy_field: false};
        0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::witness_rule_marketplace::confirm<T0, Purchase>(v18, arg4, &mut v17);
        0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::lock<T0>(arg1, v15, arg4);
        let v19 = TradeInfo<T0>{
            item_id   : arg2,
            coin_type : v13,
            price     : v12,
        ...
        (v17, 0x2::transfer_policy::new_request<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Marketplace>(arg2, v12, 0x2::object::id<0x2::kiosk::Kiosk>(arg0)), v19)
    }
    ...
    public fun cancel_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Extension>(arg0), 9223373600223002627);
        let v0 = BidItem{id: arg2};
        assert!(0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v0), 9223373604518494219);
        let v1 = BidItem{id: arg2};
        let Bidding {
            buyer     : _,
            seller    : v3,
            ...
            funds     : v5,
            timestamp : _,
        } = 0x2::bag::remove<BidItem, Bidding<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v1);
    ...
    public fun cancel_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut Collection, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Extension>(arg0), 9223373690417315843);
        let v0 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg2.id)};
        assert!(0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v0), 9223373694712807435);
        let v1 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg2.id)};
        let CollectionBid {
            bidder    : _,
            funds     : v3,
            timestamp : _,
        } = 0x2::bag::remove<CollectionBidItem, CollectionBid<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v1);
    ...
    public fun delist<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::kiosk_extension::is_installed<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Extension>(arg0), 9223373037582286851);
        ...
        let Listing {
            ...
            purchase_cap : v3,
            timestamp    : _,
        } = 0x2::bag::remove<ListItem, Listing<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v0);
    ...
    public fun list<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Extension>(arg0), 9223372913028235267);
        ...
        0x2::bag::add<ListItem, Listing<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v0, v1);
        let v2 = ListingEvent{
            item_id   : arg2,
    ...
    public fun place_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Extension>(arg0), 9223373338229997571);
        let v0 = ListItem{id: arg3};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg2), v0), 9223373342525095941);
        let v1 = BidItem{id: arg3};
        assert!(!0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v1), 9223373346820325385);
        assert!(0x2::coin::value<T1>(&arg5) == arg4, 9223373351115161607);
        let v2 = ListItem{id: arg3};
        let v3 = 0x2::bag::borrow<ListItem, Listing<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg2), v2);
        let v4 = &v3.seller;
        ...
        0x2::bag::add<BidItem, Bidding<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v5, v6);
    ...
    public fun place_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut Collection, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Extension>(arg0), 9223373488553852931);
        let v0 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg2.id)};
        assert!(!0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v0), 9223373492849213449);
        ...
        0x2::bag::add<CollectionBidItem, CollectionBid<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v2, v3);
    ...
    public fun purchase<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Marketplace>, TradeInfo<T0>) {
        assert!(0x2::kiosk_extension::is_installed<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Extension>(arg0), 9223373153546403843);
        let v0 = ListItem{id: arg1};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v0), 9223373157841502213);
        ...
        let Listing {
            ...
            purchase_cap : v4,
            timestamp    : v5,
        } = 0x2::bag::remove<ListItem, Listing<T0, T1>>(0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::bag_mut(arg0), v1);
        ...
        0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::witness_rule_marketplace::confirm<T0, Purchase>(v12, arg3, &mut v11);
        ...
        (v9, v11, 0x2::transfer_policy::new_request<0x9bd7efb1363df044cbe1624cc63b2b10f4b4700a3a20f26bc6579bdfe70a9fba::extension::Marketplace>(arg1, v3, 0x2::object::id<0x2::kiosk::Kiosk>(arg0)), v13)
    }
