module 0x9ba5df6863895f031d54a58436f096f6a2d6c566e31595a8a2fdc1f33c7e8129::game7409 {
    struct GAME7409 has drop {
        dummy_field: bool,
    }

    struct TICKET_7409 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7409(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7409>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7409>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME7409, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME7409>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7409>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7409>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7409>>(v5, 0x2::tx_context::sender(arg1));
    }
