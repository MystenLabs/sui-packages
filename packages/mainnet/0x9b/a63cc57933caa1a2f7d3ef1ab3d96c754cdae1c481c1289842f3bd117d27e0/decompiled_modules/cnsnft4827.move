module 0x9ba63cc57933caa1a2f7d3ef1ab3d96c754cdae1c481c1289842f3bd117d27e0::cnsnft4827 {
    struct CNSNFT4827 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4827, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4827>(arg0, arg1);
