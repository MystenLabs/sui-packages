module 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::cetus_investor {
    ...
    public fun autocompound<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::distributor::Distributor, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, 0x2::sui::SUI>, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS, 0x2::sui::SUI>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v4, (((v5 as u128) * (arg0.performance_fee as u128) / 10000) as u64), arg8), 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::distributor::get_fee_wallet_address(arg1));
        let (v6, v7) = 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::converter::swap_b2a<T1, 0x2::sui::SUI>(arg2, arg4, v4, true, v5, arg7, arg8);
        ...
        let v10 = v9;
        let v11 = v8;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v11, (((0x2::balance::value<T0>(&v11) as u128) * (arg0.performance_fee as u128) / 10000) as u64)), arg8), 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::distributor::get_fee_wallet_address(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v10, (((0x2::balance::value<T1>(&v10) as u128) * (arg0.performance_fee as u128) / 10000) as u64)), arg8), 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::distributor::get_fee_wallet_address(arg1));
        ...
        let (_, v15, v16) = get_balances_in_ratio<T0, T1>(arg0, v12, v13, arg6, true);
        deposit<T0, T1>(arg0, arg2, arg6, v15, v16, arg7);
    }

    public fun create_investor<T0: store, T1: store>(arg0: &0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::distributor::AdminCap, arg1: &0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::version::Version, arg2: u32, arg3: u32, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun get_balances_in_ratio<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: bool) : (u128, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        if (0x2::balance::value<T0>(&arg1) == 0) {
            ...
            assert!(v6 <= v8, 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::error::insufficient_balance_to_add_liquidity());
            if (arg4 == false) {
                assert!(((v8 - v6) as u128) * 1000000000 / (v8 as u128) <= 1000000, 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::error::difference_too_high());
            };
            0x2::balance::join<T0>(&mut arg0.free_balance_a, arg1);
            (v5, 0x2::balance::split<T0>(&mut arg1, v6), arg2)
        } else {
            let (v9, _, v11) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::get_liquidity_from_amount(v0, v1, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_tick_index<T0, T1>(arg3), 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg3), 0x2::balance::value<T0>(&arg1), true);
            let v12 = 0x2::balance::value<T1>(&arg2);
            if (v11 <= v12) {
                if (arg4 == false) {
                    assert!(((v12 - v11) as u128) * 1000000000 / (v12 as u128) <= 1000000, 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::error::difference_too_high());
                };
                ...
                let v16 = 0x2::balance::value<T0>(&arg1);
                assert!(v14 <= v16, 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::error::insufficient_balance_to_add_liquidity());
                if (arg4 == false) {
                    assert!(((v16 - v14) as u128) * 1000000000 / (v16 as u128) <= 1000000, 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::error::difference_too_high());
                };
                0x2::balance::join<T0>(&mut arg0.free_balance_a, arg1);
                (v13, 0x2::balance::split<T0>(&mut arg1, v14), arg2)
            }
        }
    }

    fun get_total_balance_in_ratio<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::distributor::Distributor, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        let (_, v1, v2) = get_balances_in_ratio<T0, T1>(arg0, arg3, arg4, arg5, true);
        let v3 = v2;
        let v4 = v1;
        let v5 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.upper_tick);
        let v6 = (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_sqrt_price_at_tick(v5) as u256) - (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg5) as u256);
        let v7 = (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_sqrt_price_at_tick(v5) as u256) * (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg5) as u256) * ((0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg5) as u256) - (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_sqrt_price_at_tick(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.lower_tick)) as u256));
        let v8 = 0x2::balance::value<T0>(&arg0.free_balance_a);
        let v9 = 0x2::balance::value<T1>(&arg0.free_balance_b);
        if (v8 > 0) {
            let v10 = (v8 as u256) * v7 / (v6 + v7);
            let (v11, v12) = 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::converter::swap_a2b<T0, T1>(arg2, arg5, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.free_balance_a, (v10 as u64)), arg7), true, (v10 as u64), arg6, arg7);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v11, 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::distributor::get_dust_wallet_address(arg1));
            ...
            let v13 = (v9 as u256) * v6 / (v6 + v7);
            let (v14, v15) = 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::converter::swap_b2a<T0, T1>(arg2, arg5, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.free_balance_b, (v13 as u64)), arg7), true, (v13 as u64), arg6, arg7);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v15, 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::distributor::get_dust_wallet_address(arg1));
            0x2::balance::join<T0>(&mut v4, 0x2::coin::into_balance<T0>(v14));
    ...
    public fun rebalance<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::distributor::RebalanceCap, arg2: &0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::version::Version, arg3: &0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::distributor::Distributor, arg4: u32, arg5: u32, arg6: u32, arg7: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg8: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
    ...
    public fun reposition<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::distributor::AdminCap, arg2: &0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::version::Version, arg3: u32, arg4: u32, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::version::assert_current_version(arg2);
        let v0 = 0x2::dynamic_field::remove<vector<u8>, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut arg0.id, b"Position");
    ...
    entry fun set_performance_fee<T0, T1>(arg0: &0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::distributor::AdminCap, arg1: &0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::version::Version, arg2: &mut Investor<T0, T1>, arg3: u64) {
        0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::version::assert_current_version(arg1);
        assert!(arg3 <= arg2.performance_fee_max_cap, 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::error::fee_too_high_error());
