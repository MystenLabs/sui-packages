module 0x9bc0c3e4abecd8e9819cd21db54edfd1a187ede52e2c91eb4ed711f3cc1dc3b5::yt {
    ...
    public(friend) fun mint<T0>(arg0: &mut YTStruct<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<YTCoin<T0>> {
        let v0 = MintEvent<T0>{
            ytId   : 0x2::object::uid_to_inner(&arg0.id),
            amount : arg1,
        };
        0x2::event::emit<MintEvent<T0>>(v0);
        0x2::coin::from_balance<YTCoin<T0>>(0x2::balance::increase_supply<YTCoin<T0>>(&mut arg0.supply, arg1), arg2)
    }

    public fun total_supply<T0>(arg0: &YTStruct<T0>) : u64 {
