module 0x9bc0c3e4abecd8e9819cd21db54edfd1a187ede52e2c91eb4ed711f3cc1dc3b5::market_global {
    struct MarketFactoryConfig has key {
        id: 0x2::object::UID,
        treasury: address,
        reserve_fee_percent: 0x9bc0c3e4abecd8e9819cd21db54edfd1a187ede52e2c91eb4ed711f3cc1dc3b5::fixed_point64::FixedPoint64,
    ...
    public fun get_reserve_fee_percent(arg0: &MarketFactoryConfig) : 0x9bc0c3e4abecd8e9819cd21db54edfd1a187ede52e2c91eb4ed711f3cc1dc3b5::fixed_point64::FixedPoint64 {
    ...
    public fun init_config(arg0: u128, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x9bc0c3e4abecd8e9819cd21db54edfd1a187ede52e2c91eb4ed711f3cc1dc3b5::fixed_point64::less_or_equal(v0, 0x9bc0c3e4abecd8e9819cd21db54edfd1a187ede52e2c91eb4ed711f3cc1dc3b5::fixed_point64::create_from_rational(1, 1)), 0x9bc0c3e4abecd8e9819cd21db54edfd1a187ede52e2c91eb4ed711f3cc1dc3b5::error::market_factory_reserve_fee_too_high());
        let v1 = MarketFactoryConfig{
            id                   : 0x2::object::new(arg2),
            treasury             : arg1,
            reserve_fee_percent  : v0,
            override_fee_percent : 0x2::bag::new(arg2),
