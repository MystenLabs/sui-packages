module 0x9be7c568ee9e275a7e034e5e70691c513d11043491b4800c1d0114cfb5e25a49::alter {
    struct ALTER has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ALTER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ALTER>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Alter"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Altering the streetwear industry"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://JvF8so4W_3yrQWyTzuuLfjoCnXbgH7b8cgg79Crztxk"));
