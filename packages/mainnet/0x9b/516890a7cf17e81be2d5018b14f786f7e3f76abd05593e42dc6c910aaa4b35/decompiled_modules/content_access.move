module 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::content_access {
    ...
    public fun add_access(arg0: &mut ContentAccessList, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: address, arg3: u64, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg6) == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::current_owner(arg1), 1);
        assert!(arg0.soul_id == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::soul_id(arg1), 5);
        let v0 = 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::ownership_epoch(arg1);
    ...
    public(friend) fun create(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u64, arg4: 0x1::option::Option<u64>, arg5: &mut 0x2::tx_context::TxContext) : ContentAccessList {
        0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::grant::assert_valid_scope_mask(arg3);
    ...
    public fun has_access(arg0: &ContentAccessList, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) : bool {
        assert!(arg0.soul_id == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::soul_id(arg1), 5);
        if (!0x2::table::contains<address, ContentAccessEntry>(&arg0.entries, arg2)) {
            return false
        };
        ...
        if (v0.ownership_epoch_snapshot != 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::ownership_epoch(arg1)) {
            return false
        };
    ...
    public(friend) fun record_purchase(arg0: &mut ContentAccessList, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(arg0.soul_id == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::soul_id(arg1), 5);
        let v0 = 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::ownership_epoch(arg1);
        if (0x2::table::contains<address, ContentAccessEntry>(&arg0.entries, arg2)) {
            let v1 = 0x2::table::borrow<address, ContentAccessEntry>(&arg0.entries, arg2);
    ...
    public fun revoke_access(arg0: &mut ContentAccessList, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: address, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::current_owner(arg1), 1);
        assert!(arg0.soul_id == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::soul_id(arg1), 5);
    ...
    entry fun seal_approve_asset_allowlisted(arg0: vector<u8>, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: &ContentAccessList, arg3: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::assets::SoulAssets, arg4: 0x1::string::String, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        assert!(arg2.soul_id == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::soul_id(arg1), 5);
        0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::assets::assert_valid_asset_seal_request(arg0, arg1, arg3, arg4, arg5);
        assert!(has_access(arg2, arg1, 0x2::tx_context::sender(arg7), 8, arg6), 4);
    }

    entry fun seal_approve_skill_allowlisted(arg0: vector<u8>, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: &ContentAccessList, arg3: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::skills::SoulSkills, arg4: 0x1::string::String, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        assert!(arg2.soul_id == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::soul_id(arg1), 5);
        0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::skills::assert_valid_skill_seal_request(arg0, arg1, arg3, arg4, arg5);
        assert!(has_access(arg2, arg1, 0x2::tx_context::sender(arg7), 4, arg6), 4);
    }

    public fun set_content_access_duration(arg0: &mut ContentAccessList, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: 0x1::option::Option<u64>, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::current_owner(arg1), 1);
        assert!(arg0.soul_id == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::soul_id(arg1), 5);
    ...
    public fun set_content_price(arg0: &mut ContentAccessList, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::current_owner(arg1), 1);
        assert!(arg0.soul_id == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::soul_id(arg1), 5);
