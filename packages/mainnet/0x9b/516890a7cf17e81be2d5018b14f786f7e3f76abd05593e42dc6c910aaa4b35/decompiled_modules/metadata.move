module 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::metadata {
    ...
    public(friend) fun assert_matches_state(arg0: &SoulMetadata, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState) {
        assert!(arg0.soul_id == 0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::soul_id(arg1), 0);
        let v0 = 0x2::object::id<SoulMetadata>(arg0);
        assert!(0x1::option::contains<0x2::object::ID>(0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::metadata_id(arg1), &v0), 0);
    }
    ...
    public fun clear_active_sprite(arg0: &mut SoulMetadata, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: &0x2::tx_context::TxContext) {
        set_active_sprite(arg0, arg1, 0x1::option::none<AssetBinding>(), arg2);
    }

    public fun clear_active_voice(arg0: &mut SoulMetadata, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun delete_metadata_blob(arg0: &mut SoulMetadata, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: 0x1::string::String, arg3: &0x2::tx_context::TxContext) {
        0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::assert_owner(arg1, 0x2::tx_context::sender(arg3));
    ...
    public fun set_active_sprite(arg0: &mut SoulMetadata, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: 0x1::option::Option<AssetBinding>, arg3: &0x2::tx_context::TxContext) {
        0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::assert_owner(arg1, 0x2::tx_context::sender(arg3));
        assert_matches_state(arg0, arg1);
    ...
    public fun set_active_voice(arg0: &mut SoulMetadata, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: 0x1::option::Option<AssetBinding>, arg3: &0x2::tx_context::TxContext) {
        0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::assert_owner(arg1, 0x2::tx_context::sender(arg3));
        assert_matches_state(arg0, arg1);
        if (0x1::option::is_some<AssetBinding>(&arg2)) {
            assert_valid_download_policy(0x1::option::borrow<AssetBinding>(&arg2).download_policy);
    ...
    public fun upsert_metadata_blob(arg0: &mut SoulMetadata, arg1: &0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::SoulState, arg2: 0x1::string::String, arg3: vector<u8>, arg4: &0x2::tx_context::TxContext) {
        0x9b516890a7cf17e81be2d5018b14f786f7e3f76abd05593e42dc6c910aaa4b35::soul::assert_owner(arg1, 0x2::tx_context::sender(arg4));
        assert_matches_state(arg0, arg1);
        assert!(!0x1::string::is_empty(&arg2), 2);
