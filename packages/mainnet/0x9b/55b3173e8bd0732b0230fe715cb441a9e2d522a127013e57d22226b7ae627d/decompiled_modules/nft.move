module 0x9b55b3173e8bd0732b0230fe715cb441a9e2d522a127013e57d22226b7ae627d::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun depositNft(arg0: vector<u8>, arg1: vector<u8>, arg2: &NftPegVault, arg3: &mut 0x9b55b3173e8bd0732b0230fe715cb441a9e2d522a127013e57d22226b7ae627d::archieve::UserArchieve, arg4: &0x9b55b3173e8bd0732b0230fe715cb441a9e2d522a127013e57d22226b7ae627d::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        0x9b55b3173e8bd0732b0230fe715cb441a9e2d522a127013e57d22226b7ae627d::version::checkVersion(arg4, 1);
        0x9b55b3173e8bd0732b0230fe715cb441a9e2d522a127013e57d22226b7ae627d::archieve::verifySignature(arg0, arg1, &arg2.validator);
        ...
        0x9b55b3173e8bd0732b0230fe715cb441a9e2d522a127013e57d22226b7ae627d::archieve::verUpdateNftPegNonce(v7, arg3);
        let v8 = mint(v2, v3, v4, v5, v6, arg5);
        0x2::transfer::transfer<BirdNFT>(v8, 0x2::tx_context::sender(arg5));
        let v9 = NFTDeposited{
            ...
            value     : v6,
            nonce     : v7,
            type_name : 0x1::type_name::get<BirdNFT>(),
        };
    ...
    public entry fun setValidator(arg0: &NftAdminCap, arg1: vector<u8>, arg2: &mut NftPegVault, arg3: &0x9b55b3173e8bd0732b0230fe715cb441a9e2d522a127013e57d22226b7ae627d::version::Version) {
    ...
    public entry fun withdrawNft(arg0: &mut 0x9b55b3173e8bd0732b0230fe715cb441a9e2d522a127013e57d22226b7ae627d::archieve::UserArchieve, arg1: BirdNFT, arg2: &0x9b55b3173e8bd0732b0230fe715cb441a9e2d522a127013e57d22226b7ae627d::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = NFTWithdrawn{
            ...
            rare      : v4,
            value     : v5,
            nonce     : 0x9b55b3173e8bd0732b0230fe715cb441a9e2d522a127013e57d22226b7ae627d::archieve::increaseGetNftDepegNonce(arg0),
            type_name : 0x1::type_name::get<BirdNFT>(),
        };
