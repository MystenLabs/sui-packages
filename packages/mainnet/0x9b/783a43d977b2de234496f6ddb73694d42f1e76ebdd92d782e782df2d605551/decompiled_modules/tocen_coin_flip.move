module 0x9b783a43d977b2de234496f6ddb73694d42f1e76ebdd92d782e782df2d605551::tocen_coin_flip {
    ...
    struct CheckGame has key {
        id: 0x2::object::UID,
        user_hashed_beacon: vector<u8>,
        first_byte: u8,
    }

    public entry fun check(arg0: vector<u8>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::hash::blake2b256(&arg0);
        let v1 = CheckGame{
            id                 : 0x2::object::new(arg1),
            user_hashed_beacon : v0,
            first_byte         : *0x1::vector::borrow<u8>(&v0, 0),
        };
        0x2::transfer::share_object<CheckGame>(v1);
    }
