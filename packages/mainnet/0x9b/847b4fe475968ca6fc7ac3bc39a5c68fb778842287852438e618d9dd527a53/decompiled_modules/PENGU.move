module 0x9b847b4fe475968ca6fc7ac3bc39a5c68fb778842287852438e618d9dd527a53::PENGU {
    struct PENGU has drop {
        dummy_field: bool,
    }

    fun init(arg0: PENGU, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<PENGU>(arg0, 2, b"PENGU", b"Pudgy Penguins", b"Pudgy Penguins", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/pDOvfj4YKNQc5uljIRpzyeMDHxvSbiBuTtNIBSgBwnY?ext=png")), arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<PENGU>>(v2);
        0x2::transfer::public_transfer<0x2::coin::DenyCap<PENGU>>(v1, @0x7c3c58155b85c3ecf4864777fce255a7e405ffa3b6e443e736976588910f0e8d);
        let v3 = v0;
