module 0x9b9f9e13070024a61b19699f1f5bcf92b4eaff0c3498c07113dde0cfb137aeef::draw_manager {
    ...
    entry fun trigger_pulse(arg0: &mut DrawState, arg1: &mut 0x9b9f9e13070024a61b19699f1f5bcf92b4eaff0c3498c07113dde0cfb137aeef::reward_pool::RewardPool, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &AdminCap, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0;
        while (v2 < 4) {
            0x9b9f9e13070024a61b19699f1f5bcf92b4eaff0c3498c07113dde0cfb137aeef::reward_pool::award_pulse(arg1, 0x9b9f9e13070024a61b19699f1f5bcf92b4eaff0c3498c07113dde0cfb137aeef::reward_pool::pulse_balance(arg1) / 4, *0x1::vector::borrow<address>(&arg0.pulse_tickets, vrf_to_index(&arg2, v1)), arg5);
    ...
    entry fun trigger_spark(arg0: &mut DrawState, arg1: &mut 0x9b9f9e13070024a61b19699f1f5bcf92b4eaff0c3498c07113dde0cfb137aeef::reward_pool::RewardPool, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &AdminCap, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg3);
        ...
        let v2 = 0;
        while (v2 < 3) {
            0x9b9f9e13070024a61b19699f1f5bcf92b4eaff0c3498c07113dde0cfb137aeef::reward_pool::award_spark(arg1, 0x9b9f9e13070024a61b19699f1f5bcf92b4eaff0c3498c07113dde0cfb137aeef::reward_pool::spark_balance(arg1) / 3, *0x1::vector::borrow<address>(&arg0.spark_tickets, vrf_to_index(&arg2, v1)), arg5);
            arg2 = next_seed(arg2, v2);
            v2 = v2 + 1;
        };
    ...
    entry fun trigger_surge(arg0: &mut DrawState, arg1: &mut 0x9b9f9e13070024a61b19699f1f5bcf92b4eaff0c3498c07113dde0cfb137aeef::reward_pool::RewardPool, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &AdminCap, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(v0 >= arg0.next_surge_ms, 1);
        let v1 = 0x1::vector::length<address>(&arg0.surge_tickets);
        assert!(v1 > 0, 2);
        0x9b9f9e13070024a61b19699f1f5bcf92b4eaff0c3498c07113dde0cfb137aeef::reward_pool::award_surge(arg1, 0x9b9f9e13070024a61b19699f1f5bcf92b4eaff0c3498c07113dde0cfb137aeef::reward_pool::surge_balance(arg1), *0x1::vector::borrow<address>(&arg0.surge_tickets, vrf_to_index(&arg2, v1)), arg5);
