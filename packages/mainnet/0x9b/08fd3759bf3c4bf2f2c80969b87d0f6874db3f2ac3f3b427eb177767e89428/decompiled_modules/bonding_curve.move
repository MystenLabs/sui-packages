module 0x9b08fd3759bf3c4bf2f2c80969b87d0f6874db3f2ac3f3b427eb177767e89428::bonding_curve {
    ...
    public fun create_token(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u8, arg9: u8, arg10: address, arg11: u8, arg12: 0x2::coin::Coin<0x2::sui::SUI>, arg13: &mut 0x2::tx_context::TxContext) : TokenLaunch {
        assert!(arg8 + arg9 == 100, 4);
        assert!(arg5 > arg4, 4);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg12) >= 1000000000, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg12, 1000000000, arg13)), arg13), arg10);
        if (0x2::coin::value<0x2::sui::SUI>(&arg12) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg12, 0x2::tx_context::sender(arg13));
        } else {
        ...
        TokenLaunch{
            ...
            image_url          : arg3,
            creator            : 0x2::tx_context::sender(arg13),
            created_at         : 0x2::tx_context::epoch_timestamp_ms(arg13),
