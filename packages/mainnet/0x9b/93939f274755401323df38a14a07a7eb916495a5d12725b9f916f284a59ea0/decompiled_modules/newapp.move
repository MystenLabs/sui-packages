module 0x6dc234e9a85395da22e63aaa15ea9f1e14ae039a1ce5dfca30f1189558c7419e::newapp {
    ...
    public fun insertOrder<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<address, User>(v1, arg1), 9223373570158100479);
        ...
        0x6dc234e9a85395da22e63aaa15ea9f1e14ae039a1ce5dfca30f1189558c7419e::event::purchase_event(arg1, arg2, v3, v4, v5);
    }
    ...
    public entry fun withdraw<T0>(arg0: &mut Contract<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v2 - v3;
        let v5 = &mut arg0.global_network_statistics;
        v5.total_withdrawn_amount = v5.total_withdrawn_amount + arg1;
        let v6 = v1 / 2;
        let v7 = &mut arg0.prize_pool;
        v7.level5_gross = v7.level5_gross + v6 * 50 / 100;
        v7.level6_gross = v7.level6_gross + v6 * 30 / 100;
        v7.level7_gross = v7.level7_gross + v6 * 20 / 100;
        0x6dc234e9a85395da22e63aaa15ea9f1e14ae039a1ce5dfca30f1189558c7419e::event::withdraw_event(0x2::tx_context::sender(arg2), arg1, v6, v3, v4);
    }

    public fun yy_swap_out<T0, T1>(arg0: &mut 0xd8be9b19612c580e12fb327f39ebb8f3f6a7bc8bd6f19dc549e75a0a8bafc96d::implements::Global, arg1: u64) : u64 {
        if (arg1 <= 0) {
            0
        } else {
            let (v1, v2, _) = 0xd8be9b19612c580e12fb327f39ebb8f3f6a7bc8bd6f19dc549e75a0a8bafc96d::interface::getLpliquidity<T0, T1>(arg0);
            arg1 * v2 / v1
        }
    }
