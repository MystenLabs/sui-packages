module 0x9b67b2bace20ab5bef640427afb67ed421274f79520e1a6aa1dc781530ab737d::cnsnft4880 {
    struct CNSNFT4880 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4880, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9404"));
        let v4 = 0x2::package::claim<CNSNFT4880>(arg0, arg1);
