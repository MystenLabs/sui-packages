module 0x9bb5e268454a243be0aea4d91c543f47a746785070796e0ddc86667e87fab9f7::cnsnft3265 {
    struct CNSNFT3265 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3265, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3265>(arg0, arg1);
