module 0x62690206fc66e7b51cc657a8c1f4423ff5ebc614d59ac7db37625cb713b9123d::pool_manager {
    ...
    public(friend) fun disable_manage(arg0: &mut SuiPoolManager, arg1: u64) {
        assert!(arg0.enabled_manage == true, 0x62690206fc66e7b51cc657a8c1f4423ff5ebc614d59ac7db37625cb713b9123d::error::paused());
        assert!(arg1 >= arg0.original_sui_amount, 0x62690206fc66e7b51cc657a8c1f4423ff5ebc614d59ac7db37625cb713b9123d::error::insufficient_balance());
        arg0.enabled_manage = false;
    }

    public(friend) fun enable_manage(arg0: &mut SuiPoolManager) {
        assert!(arg0.enabled_manage == false, 0x62690206fc66e7b51cc657a8c1f4423ff5ebc614d59ac7db37625cb713b9123d::error::paused());
    ...
    public(friend) fun prepare_before_withdraw<T0>(arg0: &mut SuiPoolManager, arg1: u64, arg2: u64, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        0x62690206fc66e7b51cc657a8c1f4423ff5ebc614d59ac7db37625cb713b9123d::event::emit_fund_updated(arg0.original_sui_amount, arg2, 0x2::balance::value<0x634511c660964940915acb37dde75963e35f2d1b0a034b41e2da8f3e9d1491ae::cert::CERT>(&arg0.vsui_balance), arg0.target_sui_amount, 0x2::object::uid_to_address(&arg0.id));
    ...
    public(friend) fun refresh_stake(arg0: &mut SuiPoolManager, arg1: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x62690206fc66e7b51cc657a8c1f4423ff5ebc614d59ac7db37625cb713b9123d::event::emit_fund_updated(arg0.original_sui_amount, 0x2::balance::value<0x2::sui::SUI>(arg1), 0x2::balance::value<0x634511c660964940915acb37dde75963e35f2d1b0a034b41e2da8f3e9d1491ae::cert::CERT>(v1), arg0.target_sui_amount, 0x2::object::uid_to_address(&arg0.id));
    }
    ...
    public(friend) fun take_vsui_from_treasury(arg0: &mut SuiPoolManager, arg1: u64, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x634511c660964940915acb37dde75963e35f2d1b0a034b41e2da8f3e9d1491ae::cert::CERT> {
        ...
        assert!(0x2::balance::value<0x634511c660964940915acb37dde75963e35f2d1b0a034b41e2da8f3e9d1491ae::cert::CERT>(&arg0.vsui_balance) == 0 || 0x2::balance::value<0x634511c660964940915acb37dde75963e35f2d1b0a034b41e2da8f3e9d1491ae::cert::CERT>(&arg0.vsui_balance) > 1000000000, 0x62690206fc66e7b51cc657a8c1f4423ff5ebc614d59ac7db37625cb713b9123d::error::insufficient_balance());
        0x62690206fc66e7b51cc657a8c1f4423ff5ebc614d59ac7db37625cb713b9123d::event::emit_staking_treasury_withdrawn(0x2::balance::value<0x634511c660964940915acb37dde75963e35f2d1b0a034b41e2da8f3e9d1491ae::cert::CERT>(&v3), v0, 0x2::object::uid_to_address(&arg0.id));
        v3
    }
