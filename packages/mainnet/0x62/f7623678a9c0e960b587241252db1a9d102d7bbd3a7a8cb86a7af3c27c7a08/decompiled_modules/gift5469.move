module 0x62f7623678a9c0e960b587241252db1a9d102d7bbd3a7a8cb86a7af3c27c7a08::gift5469 {
    struct GIFT5469 has drop {
        dummy_field: bool,
    }

    struct TICKET_5469 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5469(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5469>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5469>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5469, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5469>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5469>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5469>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5469>>(v5, 0x2::tx_context::sender(arg1));
    }
