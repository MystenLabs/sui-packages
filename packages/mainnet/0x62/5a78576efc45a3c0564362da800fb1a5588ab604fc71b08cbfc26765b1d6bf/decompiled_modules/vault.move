module 0x625a78576efc45a3c0564362da800fb1a5588ab604fc71b08cbfc26765b1d6bf::vault {
    ...
    public(friend) fun deposit<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T1>, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive::Incentive, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg8: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg9: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::borrow_with_account_cap<T1>(arg9, arg8, arg3, arg5, arg0.a_index, arg2, arg7, &arg0.account_cap)
    }
    ...
    public(friend) fun initialize<T0, T1, T2>(arg0: 0x2::coin::TreasuryCap<T2>, arg1: 0x2::object::ID, arg2: u8, arg3: u8, arg4: u8, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = Vault<T0, T1, T2>{
            id              : 0x2::object::new(arg6),
            vt_treasury_cap : arg0,
            account_cap     : 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::create_account(arg6),
            pool_id         : arg1,
            target_leverage : arg2,
            a_index         : arg3,
            b_index         : arg4,
            withdrawal_fees : arg5,
            collected_fees  : 0x2::balance::zero<T0>(),
            swap_routes     : 0x2::table::new<0x1::type_name::TypeName, vector<0x360802cb106b004205cd67a706e314eaeadd8590d5f4d1cee46137566232a627::bag_value::Value>>(arg6),
        };
        ...
        0x2::transfer::transfer<VaultCap>(v2, 0x2::tx_context::sender(arg6));
        v1
    }

    public fun leverage<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : u8 {
