module 0x62f0f4184a6918b71f08e328297e660a5b8fd804a0bc4521d0b4f294d5208192::demo {
    ...
    public entry fun add_payment_custom_token<T0, T1>(arg0: &mut StakingPool<T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun remove_payment_custom_token<T0, T1>(arg0: &mut StakingPool<T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 2);
        assert_not_paused<T1>(arg0);
        let v0 = get_token_type_string_any<T0>();
        let v1 = PaymentTokenRegistryKey{dummy_field: false};
