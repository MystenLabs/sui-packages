module 0x62aabac1b926d183780446df708bef39f7f0812c63823dda402b7e10594db00b::vanity {
    struct VANITY has drop {
        dummy_field: bool,
    }

    fun init(arg0: VANITY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<VANITY>(arg0, 9, b"MAMOUN", b"MAMOUN", b"MAMOUN token deployed with vanity package ID", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = v0;
