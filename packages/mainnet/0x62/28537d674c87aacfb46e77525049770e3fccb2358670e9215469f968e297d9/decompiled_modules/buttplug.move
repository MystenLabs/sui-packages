module 0x6228537d674c87aacfb46e77525049770e3fccb2358670e9215469f968e297d9::buttplug {
    ...
    fun init(arg0: BUTTPLUG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/2ZqgkCpvXjzB4NstzBUPSrsYrrbziUv5mC9CsxSQZryG.png                                                                                                                                                                                                                               ");
