module 0x62a042a9b88b03e94b96cdac3e0ad0448e5c5dd712c48cb7c22bbcd5a7eab347::pepesui_nft {
    ...
    fun init(arg0: PEPESUI_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"json"));
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"image_url"));
        let v2 = 0x1::vector::empty<0x1::string::String>();
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{name}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"The king of the memes, now in its blue version. Pump it the PEPE SUI CEO!"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://www.pepesui.ceo"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{json}"));
    ...
    public entry fun mint_to_sender(arg0: &mut SharePepeSUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x1::string::utf8(b"https://www.pepesui.ceo/nfts/json/");
        0x1::string::append_utf8(&mut v3, v1);
        0x1::string::append(&mut v3, 0x1::string::utf8(b".json"));
        let v4 = 0x1::string::utf8(b"https://www.pepesui.ceo/nfts/images/");
        ...
        let v7 = MintNFTEvent{
            object_id : 0x2::object::id<PepeSuiNFT>(&v5),
            creator   : v6,
            name      : v5.name,
            nftID     : v0,
            is_mint   : true,
        ...
        0x2::transfer::public_transfer<PepeSuiNFT>(v5, v6);
        let v8 = UserInfo{
            id      : 0x2::object::new(arg1),
            is_mint : true,
        };
        0x2::dynamic_object_field::add<address, UserInfo>(&mut arg0.id, 0x2::tx_context::sender(arg1), v8);
