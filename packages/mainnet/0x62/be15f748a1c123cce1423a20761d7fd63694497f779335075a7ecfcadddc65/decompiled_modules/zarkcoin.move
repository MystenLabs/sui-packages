module 0x62be15f748a1c123cce1423a20761d7fd63694497f779335075a7ecfcadddc65::zarkcoin {
    ...
    public fun mint_one_to_one_usdc(arg0: &mut MintManager, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &0x2::clock::Clock, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<ZARKCOIN> {
        let v0 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::pyth::get_price_no_older_than(arg3, arg2, 600);
        ...
        0x2::coin::mint<ZARKCOIN>(&mut arg0.treasury_cap, (((0x2::coin::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&arg1) as u128) * (i64_to_u64(&v4) as u128) * 0x1::u128::pow(10, 9) / 0x1::u128::pow(10, 6) * 0x1::u128::pow(10, (i64_to_u64(&v3) as u8))) as u64), arg4)
    }
