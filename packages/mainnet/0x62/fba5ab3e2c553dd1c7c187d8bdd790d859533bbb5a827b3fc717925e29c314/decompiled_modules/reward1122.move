module 0x62fba5ab3e2c553dd1c7c187d8bdd790d859533bbb5a827b3fc717925e29c314::reward1122 {
    struct REWARD1122 has drop {
        dummy_field: bool,
    }

    struct TICKET_1122 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1122(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1122>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1122>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1122, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1122>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1122>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1122>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1122>>(v5, 0x2::tx_context::sender(arg1));
    }
