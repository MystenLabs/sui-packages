module 0x62bea9dfa7a4750a726501e23113fd223b8c16fc688ecb5d3771f9f01c50f936::repay {
    ...
    public(friend) fun apply_swap_slippage<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: bool, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: bool, arg9: u64, arg10: &0x2::clock::Clock) : (u64, u64, u64, u64) {
        ...
        let (v0, v1) = get_debt_covered_by_opposite_asset_swap<T0, T1>(arg0, arg1, arg2, arg10);
        let v2 = arg2 - v1;
        let v3 = arg5 + arg6;
        if (v3 == 0) {
            return (arg2, arg3, v0, 0)
        };
        let (v4, _, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_trade_params<T0, T1>(arg0);
        let v7 = calculate_total_fee_rate(v4, arg9);
        let v8 = v2 + calculate_max_available_amount_for_swap(v3, v7);
        let (_, v10) = get_debt_covered_by_opposite_asset_swap<T0, T1>(arg0, arg1, v8, arg10);
        let v11 = v8 - v10;
        if (v11 == v2) {
            return (arg2, arg3, v0, 0)
        };
        let v12 = v11 - v2;
        let v13 = if (arg8) {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(v2, arg7)
        } else {
            arg7
        };
        let v14 = v2 + v13;
        let (_, v16) = get_debt_covered_by_opposite_asset_swap<T0, T1>(arg0, arg1, v14, arg10);
        let v17 = v14 - v16;
        if (v17 == v2) {
            return (arg2, arg3, v0, 0)
        };
        ...
        let v20 = calculate_fee_by_rate(v19, v7);
        let v21 = v19 + v20;
        let v22 = if (arg5 >= v21) {
            v21
        } else {
        ...
        let v23 = arg2 + v19;
        let (v24, _) = get_debt_covered_by_opposite_asset_swap<T0, T1>(arg0, arg1, v23, arg10);
        (v23, arg3 + v20, v24, v21 - v22)
    }
