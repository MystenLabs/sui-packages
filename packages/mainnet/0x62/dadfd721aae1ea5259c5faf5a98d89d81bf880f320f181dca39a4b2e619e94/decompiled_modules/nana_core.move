module 0x62dadfd721aae1ea5259c5faf5a98d89d81bf880f320f181dca39a4b2e619e94::nana_core {
    struct NANA_CORE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NANA_CORE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NANA_CORE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"nana core"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"nana core "));
