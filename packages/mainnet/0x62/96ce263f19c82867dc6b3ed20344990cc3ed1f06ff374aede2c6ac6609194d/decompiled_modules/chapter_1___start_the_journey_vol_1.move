module 0x6296ce263f19c82867dc6b3ed20344990cc3ed1f06ff374aede2c6ac6609194d::chapter_1___start_the_journey_vol_1 {
    struct CHAPTER_1___START_THE_JOURNEY_VOL_1 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CHAPTER_1___START_THE_JOURNEY_VOL_1, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CHAPTER_1___START_THE_JOURNEY_VOL_1>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Chapter 1 - Start The Journey Vol 1"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"SuiDuckz Story is a tale about the characters from the SuiDuckz. This story presents a simple yet thrilling adventure featuring the SuiDuckz. The goal of SuiDuckz Story is to give the SuiDuckz their own narrative. SuiDuckz Story is integrated with the SuiDuckz dApps and Galxe, offering the chance to earn points and other benefits."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibvh5t3xunlbsg4y3fasz33bpcfc7vhhmu4ivarhz74nqrkacc53u"));
