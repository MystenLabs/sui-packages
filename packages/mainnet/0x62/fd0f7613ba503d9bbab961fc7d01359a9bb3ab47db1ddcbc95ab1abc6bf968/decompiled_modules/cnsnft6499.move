module 0x62fd0f7613ba503d9bbab961fc7d01359a9bb3ab47db1ddcbc95ab1abc6bf968::cnsnft6499 {
    struct CNSNFT6499 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6499, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6499>(arg0, arg1);
