module 0x626fe94fa96d7124dbe68ec8274b66b7128d801928c694d70d831aa2240afde2::cnsnft6276 {
    struct CNSNFT6276 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6276, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6276>(arg0, arg1);
