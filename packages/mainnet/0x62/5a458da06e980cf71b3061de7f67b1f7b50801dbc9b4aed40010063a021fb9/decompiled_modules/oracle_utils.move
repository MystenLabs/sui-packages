module 0x63862ceed047505130b7625184dc571e545b26e42a5b7033ddc56258315b1d0d::oracle_utils {
    ...
    public fun calculate_amplitude(arg0: u256, arg1: u256) : u64 {
        ...
        if (v0 > 0x2::address::max() / (0x63862ceed047505130b7625184dc571e545b26e42a5b7033ddc56258315b1d0d::oracle_constants::multiple() as u256)) {
            return 18446744073709551615
        };
        let v1 = v0 * (0x63862ceed047505130b7625184dc571e545b26e42a5b7033ddc56258315b1d0d::oracle_constants::multiple() as u256) / arg0;
