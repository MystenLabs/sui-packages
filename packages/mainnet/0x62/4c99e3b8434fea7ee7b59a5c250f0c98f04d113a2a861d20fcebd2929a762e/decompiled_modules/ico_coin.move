module 0x624c99e3b8434fea7ee7b59a5c250f0c98f04d113a2a861d20fcebd2929a762e::ico_coin {
    struct ICO has drop {
        dummy_field: bool,
    }
    ...
    public fun get_lightweight_info() : (0x1::string::String, 0x1::string::String, u8) {
        (0x1::string::utf8(b"Zeo"), 0x1::string::utf8(b"Zeo Protocol"), 9)
    }
    ...
    public fun get_token_display_info() : (0x1::string::String, 0x1::string::String, u8, 0x1::string::String, 0x1::string::String) {
        (0x1::string::utf8(b"Zeo Protocol"), 0x1::string::utf8(b"Zeo"), 9, 0x1::string::utf8(b"10000000"), 0x1::string::utf8(b"https://magenta-quickest-fly-406.mypinata.cloud/ipfs/bafkreiatacmygy63ulv6r5gzqs4ic6l7fucsavftuzwhrquak6mldfax7m"))
    }

    fun init(arg0: ICO_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ICO_COIN>(arg0, 9, b"Zeo", b"Zeo Protocol", b"Zeo is a utility token built on Sui blockchain with advanced features including batch transfers, burn mechanisms, and Web3 wallet compatibility. Zeo serves as the native utility token for the Zeo ecosystem.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://magenta-quickest-fly-406.mypinata.cloud/ipfs/bafkreiatacmygy63ulv6r5gzqs4ic6l7fucsavftuzwhrquak6mldfax7m")), arg1);
        let v2 = v0;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<ICO_COIN>>(0x2::coin::mint<ICO_COIN>(&mut v2, 5000000000000000, arg1), @0xb26f312156c464b327c1bb76775d20f8318227552689c0fcbc0f6e31a1389349);
        ...
        0x1::vector::push_back<address>(&mut v3, @0xb26f312156c464b327c1bb76775d20f8318227552689c0fcbc0f6e31a1389349);
        let v4 = TokenCreatedEvent{
            total_supply    : 10000000000000000,
            initial_holders : v3,
            decimals        : 9,
            symbol          : 0x1::string::utf8(b"Zeo"),
            name            : 0x1::string::utf8(b"Zeo Protocol"),
        };
