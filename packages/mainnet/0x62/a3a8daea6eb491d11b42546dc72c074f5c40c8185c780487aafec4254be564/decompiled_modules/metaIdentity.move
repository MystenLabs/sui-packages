module 0x62a3a8daea6eb491d11b42546dc72c074f5c40c8185c780487aafec4254be564::metaIdentity {
    ...
    public fun get_avatar_name(arg0: &MetaIdentity) : 0x1::string::String {
        arg0.avatar_name
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = MetaInfoGlobal{
            ...
            creator          : @0xbe379359ac6e9d0fc0b867f147f248f1c2d9fc019a9a708adfcbe15fc3130c18,
            total_players    : 0,
    ...
    public entry fun mint_meta(arg0: &mut MetaInfoGlobal, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = MetaIdentity{
            id               : v1,
            metaId           : 11000 + arg0.total_players,
            name             : arg1,
            wallet_addr      : v0,
            level            : 0,
            exp              : 0,
