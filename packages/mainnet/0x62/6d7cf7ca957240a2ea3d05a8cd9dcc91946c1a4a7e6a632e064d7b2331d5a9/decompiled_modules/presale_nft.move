module 0x626d7cf7ca957240a2ea3d05a8cd9dcc91946c1a4a7e6a632e064d7b2331d5a9::presale_nft {
    ...
    public fun get_total_revenue<T0>(arg0: &PresaleState<T0>) : u64 {
        arg0.total_revenue
    }
    ...
    fun mint_nft<T0>(arg0: &mut PresaleState<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u8, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, @0x55e3dbf2447de1fb8669fa67a9a5dcdce19ce64f3d241d00ed3c2ccbbb0a9c3f);
        arg0.total_minted = arg0.total_minted + 1;
        arg0.total_revenue = arg0.total_revenue + arg3;
