module 0x628b0fd187a1cc1a798e6299f2d1743bfac12894191847d63d57f0aa03bd5161::gift9105 {
    struct GIFT9105 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift9105(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT9105, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9105>(arg0, arg1);
