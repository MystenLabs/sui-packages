module 0x6279daf08256fbb3cfdf1cfbdf136fb0499b64cccb757330ae39dfd07e384eb0::reward1889 {
    struct REWARD1889 has drop {
        dummy_field: bool,
    }

    struct TICKET_1889 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1889(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1889>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1889>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1889, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1889>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1889>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1889>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1889>>(v5, 0x2::tx_context::sender(arg1));
    }
