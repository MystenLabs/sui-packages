module 0x62bab40d730d86d485b27683ae97def1b5839f8f8d47f9e9fad4d00da239a28b::utils {
    ...
    public fun split_coin_by_weights<T0>(arg0: vector<0x2::coin::Coin<T0>>, arg1: vector<u64>, arg2: &mut 0x2::tx_context::TxContext) : vector<0x2::coin::Coin<T0>> {
        ...
        while (!0x1::vector::is_empty<u64>(&arg1)) {
            ...
            assert!(v2 > 0 && v2 < 10000, 12);
            0x1::vector::push_back<0x2::coin::Coin<T0>>(&mut v1, 0x2::coin::split<T0>(&mut v0, 0x2::coin::value<T0>(&v0) * v2 / 10000, arg2));
        };
