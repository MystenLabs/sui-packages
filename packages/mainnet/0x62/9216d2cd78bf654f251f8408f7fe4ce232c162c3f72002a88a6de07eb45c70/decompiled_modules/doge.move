module 0x629216d2cd78bf654f251f8408f7fe4ce232c162c3f72002a88a6de07eb45c70::doge {
    ...
    fun init(arg0: DOGE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/SsKFgDPEqyzAM8nWPiiX7MGY7iNDTEX6DxRdxmkpump.png?size=lg&key=199138                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DOGE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DOGE    ")))), trim_right(b"@DOGE                           "), trim_right(b"The people voted for major reform.                                                                                                                                                                                                                                                                                              "), v2, arg1);
        let v5 = v3;
