module 0x62176a26b50a44433bc494c75b748099d573311bba544d3c9d3be1c2291c4fb9::reward6840 {
    struct REWARD6840 has drop {
        dummy_field: bool,
    }

    struct TICKET_6840 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6840(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6840>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6840>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6840, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6840>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6840>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6840>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6840>>(v5, 0x2::tx_context::sender(arg1));
    }
