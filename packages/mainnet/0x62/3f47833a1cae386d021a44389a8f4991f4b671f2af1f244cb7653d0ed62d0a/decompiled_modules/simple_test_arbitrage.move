module 0xb923c341a9eb34ef58b73e7781d42563bc1a194079750377f5b2e46a3939137e::simple_test_arbitrage {
    ...
    public fun execute_simple_test(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u8, arg2: u8, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        let v1 = TestArbitrageExecuted{
        ...
        0x2::event::emit<TestArbitrageExecuted>(v1);
        arg0
    }
