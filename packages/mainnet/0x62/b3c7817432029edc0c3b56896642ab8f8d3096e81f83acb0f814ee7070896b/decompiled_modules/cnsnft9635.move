module 0x62b3c7817432029edc0c3b56896642ab8f8d3096e81f83acb0f814ee7070896b::cnsnft9635 {
    struct CNSNFT9635 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9635, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8796"));
        let v4 = 0x2::package::claim<CNSNFT9635>(arg0, arg1);
