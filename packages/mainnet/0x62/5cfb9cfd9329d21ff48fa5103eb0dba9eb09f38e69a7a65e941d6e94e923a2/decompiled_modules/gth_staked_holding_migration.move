module 0x625cfb9cfd9329d21ff48fa5103eb0dba9eb09f38e69a7a65e941d6e94e923a2::gth_staked_holding_migration {
    struct GTH_STAKED_HOLDING_MIGRATION has drop {
        dummy_field: bool,
    }
    ...
    struct TestLocker has store, key {
        ...
        remaining_vestable_balance: u64,
        scheme: vector<u64>,
        is_migrated: bool,
    }
    ...
    public entry fun add_funds_to_treasury_vault(arg0: &Owner, arg1: 0x2::coin::Coin<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>, arg2: &mut TreasuryVault, arg3: &0x2::clock::Clock, arg4: &UpgradeVersion, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun add_users_sui_accounts(arg0: &MaintainerRole, arg1: &mut TestLocker, arg2: vector<0x1::string::String>, arg3: vector<address>, arg4: &UpgradeVersion, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(arg4.version == 0, 2);
        assert!(0x2::vec_set::contains<address>(&arg0.has_maintainer_access, &v0), 17);
        assert!(0x1::vector::length<0x1::string::String>(&arg2) != 0, 19);
        assert!(0x1::vector::length<address>(&arg3) != 0, 19);
        assert!(0x1::vector::length<0x1::string::String>(&arg2) == 0x1::vector::length<address>(&arg3), 21);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::string::String>(&arg2)) {
            assert!(42 == 0x1::string::length(0x1::vector::borrow<0x1::string::String>(&arg2, v1)), 20);
            assert!(@0x0 != *0x1::vector::borrow<address>(&arg3, v1), 8);
            assert!(0x2::vec_map::contains<0x1::string::String, Locker>(&arg1.lockers, 0x1::vector::borrow<0x1::string::String>(&arg2, v1)), 5);
            0x2::vec_map::insert<0x1::string::String, address>(&mut arg1.address_locker, *0x1::vector::borrow<0x1::string::String>(&arg2, v1), *0x1::vector::borrow<address>(&arg3, v1));
            v1 = v1 + 1;
        };
        let v2 = AddedSuiAccounts{
            evm_accounts : arg2,
            sui_accounts : arg3,
        };
        0x2::event::emit<AddedSuiAccounts>(v2);
    }

    public entry fun available_amount(arg0: &TestLocker, arg1: &StartVesting, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &UpgradeVersion, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg4.version == 0, 2);
    ...
    public entry fun claim_rewards(arg0: &mut TestLocker, arg1: &mut StartVesting, arg2: &mut TreasuryVault, arg3: &mut RewardKitty, arg4: 0x1::string::String, arg5: &0x2::clock::Clock, arg6: &RewardDetails, arg7: &UpgradeVersion, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        update_reward(0x1::option::none<u64>(), arg4, arg0, arg2, arg3, arg5, arg6, arg8);
        ...
        let v2 = 0x2::coin::split<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>(&mut arg3.total_kitty, v1.earned_reward, arg8);
    ...
    entry fun collect_reward(arg0: 0x2::transfer::Receiving<0x2::coin::Coin<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>>, arg1: &mut TreasuryVault, arg2: &MaintainerRole, arg3: &UpgradeVersion, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::join<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>(&mut arg1.treasury, 0x2::coin::split<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>(v4, 0x2::coin::value<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>(v4), arg4));
    ...
    fun get_available_amount(arg0: &TestLocker, arg1: 0x1::string::String, arg2: &StartVesting, arg3: &0x2::clock::Clock) : (u64, u64, u64) {
        ...
        let v0 = time_in_months(time_in_secs(arg3) - arg2.start_date);
        let v1 = 0x2::vec_map::get<0x1::string::String, Locker>(&arg0.lockers, &arg1);
        let v2 = arg0.scheme;
        let v3 = 0;
        let v4 = 0;
        if (v0 < 0x1::vector::length<u64>(&v2)) {
            while (v3 <= v0) {
                v4 = v4 + v1.total_limit * *0x1::vector::borrow<u64>(&v2, v3) / 100;
                v3 = v3 + 1;
            };
        } else {
            v4 = v1.total_limit;
        };
        (v4 - v1.total_unstake_balance, v4, v0)
    }
    ...
    fun init(arg0: GTH_STAKED_HOLDING_MIGRATION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<VestedTokens>(v5);
        let v6 = TreasuryVault{
            id             : 0x2::object::new(arg1),
            treasury       : 0x2::coin::zero<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>(arg1),
            timestamp      : 0,
            last_staked_at : 0,
        };
        0x2::transfer::share_object<TreasuryVault>(v6);
        let v7 = RewardKitty{
            id               : 0x2::object::new(arg1),
            total_kitty      : 0x2::coin::zero<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>(arg1),
            reward_per_token : 0,
        };
        0x2::transfer::share_object<RewardKitty>(v7);
        let v8 = RewardDetails{
            id                : 0x2::object::new(arg1),
            reward_percentage : 2100,
            reward_per_sec    : 1000000000,
        };
        0x2::transfer::share_object<RewardDetails>(v8);
        let v9 = MaintainerRole{
            id                    : 0x2::object::new(arg1),
            has_maintainer_access : 0x2::vec_set::empty<address>(),
        };
        0x2::vec_set::insert<address>(&mut v9.has_maintainer_access, v0);
        0x2::transfer::share_object<MaintainerRole>(v9);
    }

    public entry fun migrate_users_data(arg0: &MaintainerRole, arg1: &mut TestLocker, arg2: vector<0x1::string::String>, arg3: vector<u64>, arg4: vector<0x1::string::String>, arg5: vector<address>, arg6: &UpgradeVersion, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(arg6.version == 0, 2);
        assert!(0x2::vec_set::contains<address>(&arg0.has_maintainer_access, &v0), 17);
        assert!(!arg1.is_migrated, 22);
        assert!(0x1::vector::length<0x1::string::String>(&arg2) != 0, 19);
        assert!(0x1::vector::length<u64>(&arg3) != 0, 19);
        ...
        while (v1 < 0x1::vector::length<0x1::string::String>(&arg2)) {
            assert!(42 == 0x1::string::length(0x1::vector::borrow<0x1::string::String>(&arg2, v1)), 20);
            assert!(0 != *0x1::vector::borrow<u64>(&arg3, v1), 12);
            assert!(1 * 1000000000 <= *0x1::vector::borrow<u64>(&arg3, v1), 13);
            v2 = v2 + *0x1::vector::borrow<u64>(&arg3, v1);
            assert!(arg7 >= v2, 15);
            arg1.remaining_vestable_balance = arg7 - v2;
            let v3 = Locker{
                total_limit               : *0x1::vector::borrow<u64>(&arg3, v1),
                earned_reward             : 0,
                total_unstake_balance     : 0,
                remaining_balance         : *0x1::vector::borrow<u64>(&arg3, v1),
                user_reward_per_token     : 0,
                contract_reward_per_token : 0,
            };
            0x2::vec_map::insert<0x1::string::String, Locker>(&mut arg1.lockers, *0x1::vector::borrow<0x1::string::String>(&arg2, v1), v3);
            v1 = v1 + 1;
        };
        add_users_sui_accounts(arg0, arg1, arg4, arg5, arg6, arg8);
    ...
    public entry fun set_reward_details(arg0: &mut MaintainerRole, arg1: &mut RewardDetails, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: &mut TestLocker, arg5: &mut TreasuryVault, arg6: &mut RewardKitty, arg7: &0x2::clock::Clock, arg8: &UpgradeVersion, arg9: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun start_vesting(arg0: &mut Owner, arg1: &mut TestLocker, arg2: &mut VestedTokens, arg3: &mut 0x2::coin::Coin<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>, arg4: &mut StartVesting, arg5: &0x2::clock::Clock, arg6: &UpgradeVersion, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg6.version == 0, 2);
        ...
        vest_token(arg0, arg3, arg2, v0, arg7);
    ...
    public entry fun unstake(arg0: &mut TestLocker, arg1: &mut StartVesting, arg2: 0x1::string::String, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut VestedTokens, arg6: &mut TreasuryVault, arg7: &mut RewardKitty, arg8: &RewardDetails, arg9: &UpgradeVersion, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg10);
        assert!(arg9.version == 0, 2);
        assert!(arg3 != 0, 12);
        assert!(42 == 0x1::string::length(&arg2), 20);
        assert!(arg1.vesting_started == true, 7);
        assert!(0x2::vec_map::contains<0x1::string::String, Locker>(&arg0.lockers, &arg2), 5);
        assert!(v0 == *0x2::vec_map::get<0x1::string::String, address>(&arg0.address_locker, &arg2), 5);
        let (v1, _, v3) = get_available_amount(arg0, arg2, arg1, arg4);
        assert!(v1 > 0, 10);
        assert!(arg3 <= v1, 10);
        update_reward(0x1::option::none<u64>(), arg2, arg0, arg6, arg7, arg4, arg8, arg10);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>>(0x2::coin::split<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>(&mut arg5.coin, arg3, arg10), v0);
        let v4 = 0x2::vec_map::get_mut<0x1::string::String, Locker>(&mut arg0.lockers, &arg2);
        v4.remaining_balance = v4.remaining_balance - arg3;
        v4.total_unstake_balance = v4.total_unstake_balance + arg3;
    ...
    public entry fun update_hydro_locker_with_new_gth_holders_accounts(arg0: &MaintainerRole, arg1: &mut TestLocker, arg2: vector<0x1::string::String>, arg3: vector<u64>, arg4: vector<address>, arg5: &UpgradeVersion, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(arg5.version == 0, 2);
        assert!(0x2::vec_set::contains<address>(&arg0.has_maintainer_access, &v0), 17);
        assert!(arg1.is_migrated, 23);
        assert!(0x1::vector::length<0x1::string::String>(&arg2) != 0, 19);
        assert!(0x1::vector::length<u64>(&arg3) != 0, 19);
        assert!(0x1::vector::length<address>(&arg4) != 0, 19);
        assert!(0x1::vector::length<0x1::string::String>(&arg2) == 0x1::vector::length<u64>(&arg3), 3);
        let v1 = 0;
        let v2 = 0;
        while (v1 < 0x1::vector::length<0x1::string::String>(&arg2)) {
            ...
            assert!(0 != *0x1::vector::borrow<u64>(&arg3, v1), 12);
            assert!(1 * 1000000000 <= *0x1::vector::borrow<u64>(&arg3, v1), 13);
            let v3 = v2 + *0x1::vector::borrow<u64>(&arg3, v1);
            v2 = v3;
            assert!(arg1.remaining_vestable_balance >= v3, 15);
            let v4 = Locker{
                total_limit               : *0x1::vector::borrow<u64>(&arg3, v1),
                earned_reward             : 0,
                total_unstake_balance     : 0,
            ...
            0x2::vec_map::insert<0x1::string::String, Locker>(&mut arg1.lockers, *0x1::vector::borrow<0x1::string::String>(&arg2, v1), v4);
            v1 = v1 + 1;
        };
        add_users_sui_accounts(arg0, arg1, arg2, arg4, arg5, arg6);
        let v5 = UpdateMigratedData{
            evm_addresses : arg2,
            sui_accounts  : arg4,
            amounts       : arg3,
        };
        0x2::event::emit<UpdateMigratedData>(v5);
        arg1.remaining_vestable_balance = arg1.remaining_vestable_balance - v2;
    }
    ...
    fun update_reward(arg0: 0x1::option::Option<u64>, arg1: 0x1::string::String, arg2: &mut TestLocker, arg3: &mut TreasuryVault, arg4: &mut RewardKitty, arg5: &0x2::clock::Clock, arg6: &RewardDetails, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::vec_map::contains<0x1::string::String, Locker>(&arg2.lockers, &arg1), 11);
