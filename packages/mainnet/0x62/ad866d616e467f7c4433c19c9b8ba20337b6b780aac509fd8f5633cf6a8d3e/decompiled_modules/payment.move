module 0x62ad866d616e467f7c4433c19c9b8ba20337b6b780aac509fd8f5633cf6a8d3e::payment {
    ...
    public fun pay(arg0: &mut PaymentRegistry, arg1: 0x2::coin::Coin<0x506a6fc25f1c7d52ceb06ea44a3114c9380f8e2029b4356019822f248b49e411::memefi::MEMEFI>, arg2: u64, arg3: 0x1::string::String, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x506a6fc25f1c7d52ceb06ea44a3114c9380f8e2029b4356019822f248b49e411::memefi::MEMEFI>(&arg1);
        assert!(!0x2::table::contains<u64, bool>(&arg0.nonces, arg2), 11);
        0x2::table::add<u64, bool>(&mut arg0.nonces, arg2, true);
        let v1 = PaymentMessage{
            nonce  : arg2,
            userId : arg3,
            amount : v0,
        };
        let v2 = 0x2::bcs::to_bytes<PaymentMessage>(&v1);
        let v3 = b"f6870e5c94bc88d4b456879ea7626303674c1a0c7bae303a0462633279daaf86";
        assert!(0x2::ed25519::ed25519_verify(&arg4, &v3, &v2), 13);
        ...
        0x2::event::emit<PaymentEvent>(v4);
    }
