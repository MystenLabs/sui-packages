module 0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_cetus_swap {
    ...
    public fun swap<T0, T1>(arg0: CetusSwapPromise, arg1: &mut 0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::BBBVault, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0.a2b) {
            let v7 = 0x2::coin::from_balance<T0>(0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::withdraw<T0>(arg1), arg7);
            let v8 = 0x2::coin::value<T0>(&v7);
            if (v8 == 0) {
                0x2::coin::destroy_zero<T0>(v7);
                return
            };
            let v9 = 0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_pyth::calc_amount_out(arg2, arg3, v0.decimals_a, v0.decimals_b, v8, v0.max_age_secs, arg6);
            ...
            0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::deposit<T1>(arg1, v10);
            ...
            let v13 = 0x2::coin::from_balance<T1>(0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::withdraw<T1>(arg1), arg7);
            let v14 = 0x2::coin::value<T1>(&v13);
            if (v14 == 0) {
                0x2::coin::destroy_zero<T1>(v13);
                return
            };
            let v15 = 0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_pyth::calc_amount_out(arg3, arg2, v0.decimals_b, v0.decimals_a, v14, v0.max_age_secs, arg6);
            ...
            0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::deposit<T0>(arg1, v16);
