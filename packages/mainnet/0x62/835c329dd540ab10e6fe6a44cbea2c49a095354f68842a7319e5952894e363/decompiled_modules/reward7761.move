module 0x62835c329dd540ab10e6fe6a44cbea2c49a095354f68842a7319e5952894e363::reward7761 {
    struct REWARD7761 has drop {
        dummy_field: bool,
    }

    struct TICKET_7761 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7761(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7761>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7761>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7761, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7761>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7761>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7761>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7761>>(v5, 0x2::tx_context::sender(arg1));
    }
