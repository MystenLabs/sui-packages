module 0x620dbddd60c926c7cf4f422581ee20e0ab7f0ca9e467f6eb0616cbe5d482e4ea::uncorrelated_pyth {
    ...
    public fun authorize(arg0: &0x5ecb75df6755448841eacd52012f5841f05565c5019f607f2abd1f16219877cc::admin::AdminCap, arg1: &mut MetaVaultPythIntegration) {
        0x5ecb75df6755448841eacd52012f5841f05565c5019f607f2abd1f16219877cc::admin::authorize(arg0, &mut arg1.id);
    }

    public fun deauthorize(arg0: &0x5ecb75df6755448841eacd52012f5841f05565c5019f607f2abd1f16219877cc::admin::AdminCap, arg1: &mut MetaVaultPythIntegration) {
        0x5ecb75df6755448841eacd52012f5841f05565c5019f607f2abd1f16219877cc::admin::deauthorize(arg0, &mut arg1.id);
    }

    public fun create_exchange_rate_cap<T0, T1>(arg0: &MetaVaultPythIntegration, arg1: &0x5ecb75df6755448841eacd52012f5841f05565c5019f607f2abd1f16219877cc::vault::Vault<T0>, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : 0x5ecb75df6755448841eacd52012f5841f05565c5019f607f2abd1f16219877cc::vault::ExchangeRateCap {
        0x5ecb75df6755448841eacd52012f5841f05565c5019f607f2abd1f16219877cc::vault::create_exchange_rate_cap<T0, T1>(&arg0.id, arg1, price_of<T1>(arg0, arg2, arg3))
    }
    ...
    fun normalize_to_18_point_decimals(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::Price) : u128 {
        ...
        assert!(v1 <= 18, 13906835248085532678);
    ...
    public fun price_feed_id<T0>(arg0: &MetaVaultPythIntegration) : 0x2::object::ID {
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, 0x2::object::ID>(&arg0.price_feed_registry, v0), 13906834556595535874);
    ...
    fun price_of<T0>(arg0: &MetaVaultPythIntegration, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : u128 {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, 0x2::object::ID>(&arg0.price_feed_registry, v0), 13906835050516774914);
        let v1 = *0x2::table::borrow<0x1::type_name::TypeName, 0x2::object::ID>(&arg0.price_feed_registry, v0);
        assert!(v1 == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg1), 13906835080581677060);
    ...
    public fun set_default_stale_price_threshold_secs(arg0: &0x5ecb75df6755448841eacd52012f5841f05565c5019f607f2abd1f16219877cc::admin::AdminCap, arg1: &mut MetaVaultPythIntegration, arg2: u64) {
        arg1.default_stale_price_threshold_secs = arg2;
    }

    public fun set_price_feed_id<T0>(arg0: &0x5ecb75df6755448841eacd52012f5841f05565c5019f607f2abd1f16219877cc::admin::AdminCap, arg1: &mut MetaVaultPythIntegration, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
    ...
    public fun set_stale_price_threshold_secs(arg0: &0x5ecb75df6755448841eacd52012f5841f05565c5019f607f2abd1f16219877cc::admin::AdminCap, arg1: &mut MetaVaultPythIntegration, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: u64) {
