module 0x627e07da83c139c189c0b7d9e16bf305deb675df5b204798cb0152e94f0c4edc::reward6732 {
    struct REWARD6732 has drop {
        dummy_field: bool,
    }

    struct TICKET_6732 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6732(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6732>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6732>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6732, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6732>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6732>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6732>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6732>>(v5, 0x2::tx_context::sender(arg1));
    }
