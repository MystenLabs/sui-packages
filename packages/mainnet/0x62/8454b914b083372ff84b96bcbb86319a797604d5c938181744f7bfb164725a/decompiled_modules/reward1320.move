module 0x628454b914b083372ff84b96bcbb86319a797604d5c938181744f7bfb164725a::reward1320 {
    struct REWARD1320 has drop {
        dummy_field: bool,
    }

    struct TICKET_1320 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1320(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1320>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1320>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1320, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1320>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1320>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1320>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1320>>(v5, 0x2::tx_context::sender(arg1));
    }
