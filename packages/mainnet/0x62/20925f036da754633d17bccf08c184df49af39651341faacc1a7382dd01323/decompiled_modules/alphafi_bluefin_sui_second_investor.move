module 0xeea4b39278f417d8320a581b34af2f312c505f89d94a9e74a16c0964cc5ba0d1::alphafi_bluefin_sui_second_investor {
    ...
    public(friend) fun autocompound<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: bool, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = autocompound_internal<T0, T1, T2, T3>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
        let v3 = v1;
        let v4 = v0;
        if (0x2::balance::value<T0>(&v4) > 100 || 0x2::balance::value<T1>(&v3) > 100) {
            deposit<T0, T1>(arg0, arg2, arg4, v4, v3, v2, arg8);
        } else {
    ...
    fun autocompound_internal<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: bool, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, bool) {
        ...
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<T0, T1, T3>(arg4)) {
            0x2::coin::join<T3>(&mut v0, 0x2::coin::from_balance<T3>(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T3>(arg8, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position")), arg9));
        };
        ...
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<T0, T1, T2>(arg4)) {
            0x2::balance::join<T2>(&mut v3, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T2>(arg8, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position")));
        };
        let v4 = 0x2::balance::value<T2>(&v3);
        if (v4 >= arg0.minimum_swap_amount) {
            let (v5, v6) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T2, T3>(arg8, arg2, arg5, v3, 0x2::balance::zero<T3>(), true, true, v4, v4, 4295048016);
            0x2::balance::destroy_zero<T2>(v5);
            0x2::coin::join<T3>(&mut v0, 0x2::coin::from_balance<T3>(v6, arg9));
        } else {
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<T1>()) == true) {
            let v8 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.free_rewards, 0x1::type_name::get<T1>());
            v7 = (0x2::balance::value<T1>(v8) as u128) * (arg0.performance_fee as u128) / 10000;
            0x2::balance::join<T1>(&mut arg0.free_balance_b, 0x2::balance::withdraw_all<T1>(v8));
        };
        let (_, _, v11, v12) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg8, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"));
        let v13 = v12;
        let v14 = v11;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v14, (v15 as u64)), arg9), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_fee_wallet_address(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v13, (v16 as u64)), arg9), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_fee_wallet_address(arg1));
        let (v17, v18) = if (arg7 == false) {
            let v19 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::fee_rate<T0, T1>(arg6);
            let v20 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg6);
            let v21 = if (v19 == 100) {
                v20 * 999749968 / 1000000000
            } else if (v19 == 10000) {
                v20 * 992471662 / 1000000000
            } else {
                v20 * 994987437 / 1000000000
            };
            let v22 = if (v19 == 100) {
                v20 * 1000249968 / 1000000000
            } else if (v19 == 10000) {
                v20 * 1007472083 / 1000000000
            } else {
                v20 * 1004987562 / 1000000000
            };
            get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg2, arg3, v14, v13, arg4, arg6, v21, v22, arg7, arg8, arg9)
        } else {
            let v23 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_fee_rate<T0, T1>(arg4);
            let v24 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg4);
            let v25 = if (v23 >= 100 && v23 <= 500) {
                v24 * 999499874 / 1000000000
            } else if (v23 >= 1000 && v23 <= 2500) {
                v24 * 997496867 / 1000000000
            } else {
                v24 * 992471662 / 1000000000
            };
            let v26 = if (v23 >= 100 && v23 <= 500) {
                v24 * 1000499875 / 1000000000
            } else if (v23 >= 1000 && v23 <= 2500) {
                v24 * 1002496882 / 1000000000
            } else {
                v24 * 1007472083 / 1000000000
            };
            get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg2, arg3, v14, v13, arg4, arg6, v25, v26, arg7, arg8, arg9)
        };
        let (_, v28, v29, v30) = get_balances_in_ratio<T0, T1>(arg0, v17, v18, arg4, true, arg9);
        let v31 = v29;
        let v32 = v28;
        if (0x2::balance::value<T0>(&v32) <= 100 && 0x2::balance::value<T1>(&v31) <= 100) {
            0x2::balance::join<T0>(&mut arg0.free_balance_a, 0x2::balance::withdraw_all<T0>(&mut v32));
            0x2::balance::join<T1>(&mut arg0.free_balance_b, 0x2::balance::withdraw_all<T1>(&mut v31));
        };
        ...
        let v35 = AutoCompoundingEvent{
            investor_id       : 0x2::object::uid_to_inner(&arg0.id),
            compound_amount_a : 0x2::balance::value<T0>(&v32),
            compound_amount_b : 0x2::balance::value<T1>(&v31),
            total_amount_a    : v33,
            total_amount_b    : v34,
        ...
        0x2::event::emit<AutoCompoundingEvent>(v35);
        (v32, v31, v30)
    }
    ...
    public fun rebalance_v2<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::RebalanceCap, arg2: &0xeea4b39278f417d8320a581b34af2f312c505f89d94a9e74a16c0964cc5ba0d1::version::Version, arg3: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: u32, arg7: u32, arg8: u32, arg9: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg10: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg11: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg12: bool, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
        0xeea4b39278f417d8320a581b34af2f312c505f89d94a9e74a16c0964cc5ba0d1::version::assert_current_version(arg2);
        ...
        let v1 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg4, arg9, arg6, arg7, arg14);
        ...
        let (v8, v9) = if (arg12 == false) {
            let v10 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg10);
            let v11 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::fee_rate<T0, T1>(arg10);
            let v12 = if (v11 == 100) {
            ...
            let v14 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_fee_rate<T0, T1>(arg9);
            let v15 = if (v14 >= 100 && v14 <= 500) {
                v7 * 999499874 / 1000000000
            } else if (v14 >= 1000 && v14 <= 2500) {
                v7 * 997496867 / 1000000000
            } else {
                v7 * 992471662 / 1000000000
            };
            let v16 = if (v14 >= 100 && v14 <= 500) {
                v7 * 1000499875 / 1000000000
            } else if (v14 >= 1000 && v14 <= 2500) {
                v7 * 1002496882 / 1000000000
            } else {
                v7 * 1007472083 / 1000000000
            };
            (v15, v16)
        };
        let v17 = v2 / (arg8 as u128);
        let v18 = v2 % (arg8 as u128);
        let v19 = 0;
        while (v19 < arg8 + 1) {
            if (v19 == arg8) {
                if (v18 == 0) {
            ...
            let (_, _, v22, v23) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg4, arg9, &mut v0, v17, arg13);
            let v24 = v23;
            let v25 = v22;
            0x2::balance::join<T0>(&mut v25, 0x2::balance::withdraw_all<T0>(&mut arg0.free_balance_a));
            0x2::balance::join<T1>(&mut v24, 0x2::balance::withdraw_all<T1>(&mut arg0.free_balance_b));
            let (v26, v27) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg4, arg5, v25, v24, arg9, arg10, v8, v9, arg12, arg13, arg14);
            let (_, v29, v30, v31) = get_balances_in_ratio<T0, T1>(arg0, v26, v27, arg9, true, arg14);
            let v32 = v30;
            let v33 = v29;
            if (0x2::balance::value<T0>(&v33) > 100 || 0x2::balance::value<T1>(&v32) > 100) {
                let (v34, v35) = if (0x2::balance::value<T0>(&v33) == 0 || v31 == false) {
                    let (v36, v37, v38, v39) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg13, arg4, arg9, &mut v1, v33, v32, 0x2::balance::value<T1>(&v32), false);
                    let _ = v37;
                    let _ = v36;
                    (v38, v39)
                } else {
                    let (v42, v43, v44, v45) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg13, arg4, arg9, &mut v1, v33, v32, 0x2::balance::value<T0>(&v33), true);
                    let _ = v43;
                    let _ = v42;
                    (v44, v45)
                };
                0x2::balance::join<T0>(&mut arg0.free_balance_a, v34);
                0x2::balance::join<T1>(&mut arg0.free_balance_b, v35);
            } else {
                0x2::balance::join<T0>(&mut arg0.free_balance_a, v33);
                0x2::balance::join<T1>(&mut arg0.free_balance_b, v32);
            };
            v19 = v19 + 1;
        };
        ...
        let (v46, v47, v48) = autocompound_internal<T0, T1, T2, T3>(arg0, arg3, arg4, arg5, arg9, arg11, arg10, arg12, arg13, arg14);
        let v49 = v47;
        let v50 = v46;
        close_position<T0, T1>(arg9, 0x2::dynamic_field::remove<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"), arg4, arg13);
        ...
        if (0x2::balance::value<T0>(&v50) > 100 || 0x2::balance::value<T1>(&v49) > 100) {
            deposit<T0, T1>(arg0, arg4, arg9, v50, v49, v48, arg13);
        } else {
            0x2::balance::join<T0>(&mut arg0.free_balance_a, v50);
            0x2::balance::join<T1>(&mut arg0.free_balance_b, v49);
        };
        let v51 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(0x2::dynamic_field::borrow<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&arg0.id, b"Position"));
        let (v52, v53) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::get_amount_by_liquidity(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.lower_tick), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.upper_tick), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg9), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg9), v51, false);
        let v54 = RebalancePoolEvent{
            investor_id       : 0x2::object::uid_to_inner(&arg0.id),
            amount_a_before   : v3,
            amount_b_before   : v4,
            amount_a_after    : v52,
        ...
        0x2::event::emit<RebalancePoolEvent>(v54);
