module 0x621ba2ceaed98cf4e442b160cfa2a54d084ddc67d01b67627f16e73859136aa8::cnsnft8065 {
    struct CNSNFT8065 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8065, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8065>(arg0, arg1);
