module 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::xcall_utils {
    ...
    public fun get_message_hash(arg0: 0x1::string::String, arg1: u128, arg2: vector<u8>, arg3: 0x1::string::String) : vector<u8> {
        let v0 = 0x1::vector::empty<u8>();
        0x1::vector::append<u8>(&mut v0, 0x1::string::into_bytes(arg0));
        0x1::vector::append<u8>(&mut v0, 0x1::string::into_bytes(0x1::u128::to_string(arg1)));
        0x1::vector::append<u8>(&mut v0, arg2);
        0x1::vector::append<u8>(&mut v0, 0x1::string::into_bytes(arg3));
        v0
    }
