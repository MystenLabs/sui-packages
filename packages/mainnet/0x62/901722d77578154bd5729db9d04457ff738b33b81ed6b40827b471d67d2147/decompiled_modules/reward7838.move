module 0x62901722d77578154bd5729db9d04457ff738b33b81ed6b40827b471d67d2147::reward7838 {
    struct REWARD7838 has drop {
        dummy_field: bool,
    }

    struct TICKET_7838 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7838(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7838>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7838>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7838, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7838>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7838>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7838>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7838>>(v5, 0x2::tx_context::sender(arg1));
    }
