module 0x62a58bd8cb4cbaafb9be08f3bcd82e8e6ca622c5958e67adec1819e93eb62261::cnsnft7043 {
    struct CNSNFT7043 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7043, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7043>(arg0, arg1);
