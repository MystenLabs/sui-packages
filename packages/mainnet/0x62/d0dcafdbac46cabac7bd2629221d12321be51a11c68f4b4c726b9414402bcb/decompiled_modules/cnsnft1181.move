module 0x62d0dcafdbac46cabac7bd2629221d12321be51a11c68f4b4c726b9414402bcb::cnsnft1181 {
    struct CNSNFT1181 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1181, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1181>(arg0, arg1);
