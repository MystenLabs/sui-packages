module 0x62bed7338b97314e05ad034de55d6816f18950abbc9d474eaca09b314ac10123::gift9461 {
    struct GIFT9461 has drop {
        dummy_field: bool,
    }

    struct TICKET_9461 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9461(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9461>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9461>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9461, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9461>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9461>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9461>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9461>>(v5, 0x2::tx_context::sender(arg1));
    }
