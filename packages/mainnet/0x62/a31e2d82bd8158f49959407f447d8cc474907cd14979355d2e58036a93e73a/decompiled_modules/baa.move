module 0x62a31e2d82bd8158f49959407f447d8cc474907cd14979355d2e58036a93e73a::baa {
    struct BAA has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BAA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<BAA>(&mut v2, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
