module 0x2471e6ac4704d08ef4bd336f3df9bc51917dc8a2272fd1ef48535013a5efcf05::reward7449 {
    struct REWARD7449 has drop {
        dummy_field: bool,
    }

    struct TICKET_7449 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7449(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7449>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7449>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7449, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7449>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7449>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7449>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7449>>(v5, 0x2::tx_context::sender(arg1));
    }
