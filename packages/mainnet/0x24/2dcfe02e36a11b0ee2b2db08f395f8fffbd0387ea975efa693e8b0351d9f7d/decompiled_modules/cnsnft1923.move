module 0x242dcfe02e36a11b0ee2b2db08f395f8fffbd0387ea975efa693e8b0351d9f7d::cnsnft1923 {
    struct CNSNFT1923 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1923, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9690"));
        let v4 = 0x2::package::claim<CNSNFT1923>(arg0, arg1);
