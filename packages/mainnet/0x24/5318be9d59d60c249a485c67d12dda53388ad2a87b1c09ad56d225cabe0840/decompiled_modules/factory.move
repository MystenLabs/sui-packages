module 0x245318be9d59d60c249a485c67d12dda53388ad2a87b1c09ad56d225cabe0840::factory {
    struct LotteryPool has store, key {
        id: 0x2::object::UID,
    ...
    public fun buy<T0>(arg0: &mut Pool<T0>, arg1: &mut LotteryPool, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_share_object<LotteryPool>(v0);
    }
    ...
    public fun lottery_balance(arg0: &LotteryPool) : u64 {
        0x2::balance::value<0x2::sui::SUI>(&arg0.balance)
    }

    public fun lottery_total_received(arg0: &LotteryPool) : u64 {
        arg0.total_received
    }

    public fun sell<T0>(arg0: &mut Pool<T0>, arg1: &mut LotteryPool, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        assert!(arg0.active, 4);
    ...
    public fun withdraw_lottery(arg0: &mut LotteryPool, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
