module 0x24a48f084f09c37a10fee44966f7e57550fb1c5124c519d1d481e03a34d88e9e::BUILD {
    struct BUILD has drop {
        dummy_field: bool,
    }

    fun init(arg0: BUILD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<BUILD>(arg0, 2, b"BUILD", b"BUILD ON SUI", b"BUILD ON SUI", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/amv8PKsgOHssnUHAwkYFw9wZjoUHNnk0VfE_eENvE-c?ext=png")), arg1);
