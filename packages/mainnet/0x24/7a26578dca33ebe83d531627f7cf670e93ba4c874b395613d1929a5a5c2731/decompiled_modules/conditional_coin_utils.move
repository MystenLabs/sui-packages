module 0x247a26578dca33ebe83d531627f7cf670e93ba4c874b395613d1929a5a5c2731::conditional_coin_utils {
    ...
    public fun build_conditional_symbol(arg0: &0xcb4dee85f5e93cab3a34f549d59eab8524898d493295f1db3eea4fe387085591::dao_config::ConditionalCoinConfig, arg1: u64, arg2: &0x1::string::String) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"");
        let v1 = 0xcb4dee85f5e93cab3a34f549d59eab8524898d493295f1db3eea4fe387085591::dao_config::coin_name_prefix(arg0);
        ...
        if (0xcb4dee85f5e93cab3a34f549d59eab8524898d493295f1db3eea4fe387085591::dao_config::use_outcome_index(arg0)) {
            0x1::string::append_utf8(&mut v0, u64_to_string(arg1));
    ...
    public fun build_conditional_symbol_ascii(arg0: &0xcb4dee85f5e93cab3a34f549d59eab8524898d493295f1db3eea4fe387085591::dao_config::ConditionalCoinConfig, arg1: u64, arg2: &0x1::ascii::String) : 0x1::ascii::String {
