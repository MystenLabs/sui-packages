module 0x248528604cb5358681ccdd914a633aa7e5334025762166895a3b15e3cbc963c2::sun {
    struct SUN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUN>(arg0, 9, b"SUN", b"Sunny", b"hi there:)", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.postimg.cc/KYjqv0bp/sunny.png")), arg1);
