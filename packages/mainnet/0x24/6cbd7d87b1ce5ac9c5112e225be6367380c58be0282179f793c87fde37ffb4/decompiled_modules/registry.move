module 0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::registry {
    ...
    public(friend) fun add_balance_manager(arg0: &mut Registry, arg1: address, arg2: 0x2::object::ID) {
        ...
        assert!(0x2::vec_set::length<0x2::object::ID>(v2) <= 0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::constants::max_balance_managers(), 9);
    }
    ...
    public fun disable_version(arg0: &mut Registry, arg1: u64, arg2: &DeepbookAdminCap) {
        ...
        assert!(arg1 != 0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::constants::current_version(), 6);
    ...
    fun init(arg0: REGISTRY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = RegistryInner{
            allowed_versions : 0x2::vec_set::singleton<u64>(0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::constants::current_version()),
            pools            : 0x2::bag::new(arg1),
            treasury_address : 0x2::tx_context::sender(arg1),
        };
        let v1 = Registry{
            id    : 0x2::object::new(arg1),
            inner : 0x2::versioned::create<RegistryInner>(0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::constants::current_version(), v0, arg1),
        };
    ...
    public(friend) fun load_inner(arg0: &Registry) : &RegistryInner {
        ...
        let v1 = 0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::constants::current_version();
