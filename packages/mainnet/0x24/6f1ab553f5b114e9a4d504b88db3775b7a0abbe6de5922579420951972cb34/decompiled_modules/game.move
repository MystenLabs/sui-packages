module 0x246f1ab553f5b114e9a4d504b88db3775b7a0abbe6de5922579420951972cb34::game {
    ...
    public entry fun join(arg0: &mut GamePool, arg1: &mut Treasury, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 > 100000000) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, v1 - 100000000, arg4), 0x2::tx_context::sender(arg4));
        };
    ...
    public entry fun create_game(arg0: &AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = GamePool{
            id          : 0x2::object::new(arg2),
            prize_pool  : 0x2::balance::zero<0x2::sui::SUI>(),
            last_player : 0x2::tx_context::sender(arg2),
            end_time    : 0x2::clock::timestamp_ms(arg1) + 3600000,
            claimed     : false,
        };
        let v1 = GameCreated{
