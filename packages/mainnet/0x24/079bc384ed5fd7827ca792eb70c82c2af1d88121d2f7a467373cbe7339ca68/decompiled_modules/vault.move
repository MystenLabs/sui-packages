module 0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::vault {
    ...
    public fun add_liquidity<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun add_withdraw_request<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: VaultLpToken<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == *0x2::object::uid_as_inner(&arg0.id), 0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::error::invalidLPToken());
        assert!(lp_token_value<T0, T1>(&arg1) > 0, 0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::error::zeroAmount());
    ...
    fun mint_lp_token<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LSP<T0, T1>> {
        ...
        let v3 = if (v2 == 0) {
            ...
            assert!(v4 > 0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::constants::minimal_liquidity(), 0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::error::notEnoughInitialLiquidity());
            v4
        } else {
            0x2::math::min(0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::safe_math::safe_mul_div_u64(0x2::balance::value<T0>(&arg1), v2, v0), 0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::safe_math::safe_mul_div_u64(0x2::balance::value<T1>(&arg2), v2, v1))
        };
        assert!(v3 > 0, 0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::error::liquidityInsufficientMinted());
    ...
    public fun new_vault<T0, T1>(arg0: &0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::app::AdminCap, arg1: &mut 0x2::tx_context::TxContext) : (Vault<T0, T1>, VaultCap) {
    ...
    public fun process_withdrawals<T0, T1>(arg0: &0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::app::AdminCap, arg1: &mut Vault<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<WithdrawRequest<T0, T1>>(&arg1.withdraw_requests) > 0) {
            ...
            let v8 = 0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::safe_math::safe_mul_div_u64(v6, v4, v7);
            let v9 = 0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::safe_math::safe_mul_div_u64(v5, v4, v7);
            assert!(v8 > 0 && v9 > 0, 0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::error::zeroAmount());
    ...
    public fun withdraw_assets_for_trading_account<T0, T1>(arg0: &0x24079bc384ed5fd7827ca792eb70c82c2af1d88121d2f7a467373cbe7339ca68::app::AdminCap, arg1: &mut Vault<T0, T1>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
