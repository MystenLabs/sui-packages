module 0x2478e0f37e1319b07dfd566dd53acb6ce1d3c52c145f292dff091620adacf57e::cnsnft5806 {
    struct CNSNFT5806 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5806, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5806>(arg0, arg1);
