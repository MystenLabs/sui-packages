module 0xb5b6c91d3161c1fc27075339dbe8afafef5f85f6762157be484ed49583f7ef53::point {
    ...
    fun checkpoint(arg0: &mut Config, arg1: u64, arg2: u256, arg3: u64) : u256 {
    ...
    public fun get_user_info_point_by_action<T0>(arg0: &PointDashBoard<T0>, arg1: address, arg2: 0x1::ascii::String, arg3: &0x2::clock::Clock) : u256 {
        if (!0x2::table::contains<address, UserInfo>(&arg0.user_infos, arg1)) {
            0
        } else {
            let v1 = *0x2::table::borrow<address, UserInfo>(&arg0.user_infos, arg1);
            let v2 = if (0x2::vec_map::contains<0x1::ascii::String, u256>(&v1.points, &arg2)) {
                *0x2::vec_map::get<0x1::ascii::String, u256>(&v1.points, &arg2)
            } else {
                0
            };
            let v3 = if (0x2::vec_map::contains<0x1::ascii::String, Config>(&v1.configs, &arg2)) {
                calculate_config_points(0x2::vec_map::get<0x1::ascii::String, Config>(&v1.configs, &arg2), 0x2::clock::timestamp_ms(arg3))
            } else {
                0
            };
            v2 + v3
    ...
    public fun get_user_info_points<T0>(arg0: &PointDashBoard<T0>, arg1: address, arg2: &0x2::clock::Clock) : u256 {
        let v0 = 0;
    ...
    public fun send_add_point_req<T0: drop>(arg0: &T0, arg1: 0x1::ascii::String, arg2: u256, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        send_add_point_req_<T0>(0xb5b6c91d3161c1fc27075339dbe8afafef5f85f6762157be484ed49583f7ef53::constant::point_updater(), v0, arg1, arg2, arg3);
    }
    ...
    public fun send_add_point_req_with_owner<T0: drop>(arg0: &T0, arg1: address, arg2: 0x1::ascii::String, arg3: u256, arg4: &mut 0x2::tx_context::TxContext) {
        send_add_point_req_<T0>(0xb5b6c91d3161c1fc27075339dbe8afafef5f85f6762157be484ed49583f7ef53::constant::point_updater(), arg1, arg2, arg3, arg4);
    }
    ...
    public fun send_stake_point_req<T0: drop>(arg0: &T0, arg1: 0x1::ascii::String, arg2: u256, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        send_stake_point_req_<T0>(0xb5b6c91d3161c1fc27075339dbe8afafef5f85f6762157be484ed49583f7ef53::constant::point_updater(), v0, arg1, arg2, arg3, arg4, arg5);
    }
    ...
    public fun send_stake_point_req_with_owner<T0: drop>(arg0: &T0, arg1: address, arg2: 0x1::ascii::String, arg3: u256, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        send_stake_point_req_<T0>(0xb5b6c91d3161c1fc27075339dbe8afafef5f85f6762157be484ed49583f7ef53::constant::point_updater(), arg1, arg2, arg3, arg4, arg5, arg6);
    }

    public fun send_sub_point_req<T0: drop>(arg0: &T0, arg1: 0x1::ascii::String, arg2: u256, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        send_sub_point_req_<T0>(0xb5b6c91d3161c1fc27075339dbe8afafef5f85f6762157be484ed49583f7ef53::constant::point_updater(), v0, arg1, arg2, arg3);
    }
    ...
    public fun send_sub_point_req_with_owner<T0: drop>(arg0: &T0, arg1: address, arg2: 0x1::ascii::String, arg3: u256, arg4: &mut 0x2::tx_context::TxContext) {
        send_sub_point_req_<T0>(0xb5b6c91d3161c1fc27075339dbe8afafef5f85f6762157be484ed49583f7ef53::constant::point_updater(), arg1, arg2, arg3, arg4);
    }
    ...
    public fun send_unstake_point_req<T0: drop>(arg0: &T0, arg1: 0x1::ascii::String, arg2: u256, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        send_unstake_point_req_<T0>(0xb5b6c91d3161c1fc27075339dbe8afafef5f85f6762157be484ed49583f7ef53::constant::point_updater(), v0, arg1, arg2, arg3, arg4, arg5);
    }
    ...
    public fun send_unstake_point_req_with_owner<T0: drop>(arg0: &T0, arg1: address, arg2: 0x1::ascii::String, arg3: u256, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        send_unstake_point_req_<T0>(0xb5b6c91d3161c1fc27075339dbe8afafef5f85f6762157be484ed49583f7ef53::constant::point_updater(), arg1, arg2, arg3, arg4, arg5, arg6);
    }
    ...
    public(friend) fun stake_point<T0: drop>(arg0: &mut PointDashBoard<T0>, arg1: StakePointRequest<T0>) {
        ...
        if (!0x2::vec_map::contains<0x1::ascii::String, Config>(&v7.configs, &v6)) {
            ...
            let v10 = checkpoint(v9, v5, v3, v4);
    ...
    public(friend) fun sub_point<T0: drop>(arg0: &mut PointDashBoard<T0>, arg1: SubPointRequest<T0>) {
        let SubPointRequest {
            id     : v0,
            owner  : v1,
            action : v2,
