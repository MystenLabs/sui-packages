module 0x24cc8eb0f1bca6c0da0cfc390309b9b9ee9badf53a2194f86c4222cbcf4aff6a::repay {
    ...
    public(friend) fun check_swap_feasibility<T0, T1>(arg0: &0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::pool::Pool<T0, T1>, arg1: bool, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock) : u8 {
        let (_, v1, v2) = 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::pool::pool_book_params<T0, T1>(arg0);
        if (arg1) {
    ...
    public(friend) fun plan_swap_base_debt<T0, T1>(arg0: &0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::pool::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock) : (u64, u64, u64, bool, bool) {
        if (arg1 == 0 || arg2 == 0) {
        ...
        let (_, v6, v7) = 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::pool::pool_book_params<T0, T1>(arg0);
        let v8 = v7 + v6;
        let v9 = if (arg1 < v8) {
            v8
        } else {
    ...
    public(friend) fun plan_swap_quote_debt<T0, T1>(arg0: &0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::pool::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock) : (u64, u64, u64, bool, bool) {
        if (arg1 == 0 || arg2 == 0) {
            return (0, 0, arg1, false, false)
        };
        ...
        let (_, _, v7) = 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::pool::pool_book_params<T0, T1>(arg0);
        ...
        let (_, v15, _) = 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::pool::pool_book_params<T0, T1>(arg0);
    ...
    public(friend) fun validate_prior_swap<T0, T1>(arg0: &0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::pool::Pool<T0, T1>, arg1: bool, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        if (arg2 == 0 && arg3 == 0) {
            return
        };
