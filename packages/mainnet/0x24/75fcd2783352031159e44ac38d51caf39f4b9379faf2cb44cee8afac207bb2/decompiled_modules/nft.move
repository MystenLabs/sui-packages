module 0x2475fcd2783352031159e44ac38d51caf39f4b9379faf2cb44cee8afac207bb2::nft {
    ...
    entry fun mint(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Nft{
            ...
            name        : 0x1::string::utf8(b"a_673800357"),
            description : 0x1::string::utf8(b"a_673800357 NFT"),
            creator     : 0x2::tx_context::sender(arg1),
            url         : 0x2::url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/173026386?v=4"),
        };
