module 0x24053950ab245e6239d5fb90d299dd5d6702cdecc850c82473a60441357bd151::utils {
    public fun get_description_nft() : vector<u8> {
        b"A Pixelated Birdiez NFT collection flocking to the SUI blockchain! Future pixel game on Sui!"
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeidqu5p6yj7gsomtitd4sk6th56vgswo6lcsgmn62duxhh23siuvsu/"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeigg6oevnyarn32zm5h5ukr52nk3lj43beaawyrgmpeqoargbyiwny/"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/SuiBirdiez"
    }
