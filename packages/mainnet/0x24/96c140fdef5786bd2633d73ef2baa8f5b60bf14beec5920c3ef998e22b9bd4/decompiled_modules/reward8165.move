module 0x2496c140fdef5786bd2633d73ef2baa8f5b60bf14beec5920c3ef998e22b9bd4::reward8165 {
    struct REWARD8165 has drop {
        dummy_field: bool,
    }

    struct TICKET_8165 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8165(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8165>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8165>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8165, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8165>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8165>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8165>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8165>>(v5, 0x2::tx_context::sender(arg1));
    }
