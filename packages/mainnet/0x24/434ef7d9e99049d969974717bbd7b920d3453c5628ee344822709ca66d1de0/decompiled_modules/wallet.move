module 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet {
    ...
    public fun bind_external_account<T0>(arg0: &mut Wallet, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        if (!0x2::dynamic_field::exists_<ExternalAccountBindingKey<T0>>(&arg0.id, v0)) {
    ...
    public fun is_external_account_bound<T0>(arg0: &Wallet, arg1: address) : bool {
        0x2::dynamic_field::exists_<ExternalAccountBindingKey<T0>>(&arg0.id, external_account_binding_key<T0>(arg1))
    }
