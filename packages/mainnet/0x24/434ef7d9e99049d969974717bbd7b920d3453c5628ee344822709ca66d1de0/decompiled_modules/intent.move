module 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::intent {
    ...
    public fun validate_and_pay<T0, T1>(arg0: &mut 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::Wallet, arg1: ServiceSig<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, WalletWitness<T0, T1>) {
        assert!(0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::is_authorized<T0, T1>(arg0), 0);
        let ServiceSig {
            amount    : v0,
            recipient : v1,
        } = arg1;
        let v2 = 0x2::tx_context::sender(arg2);
        0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::delegate::debit_service_allowance<T0>(arg0, v2, v0);
        0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::delegate::debit_coin_allowance<T1>(arg0, v2, v0);
        ...
        (0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::pay_by_service<T0, T1>(arg0, v0, arg2), v3)
    }

    public fun validate_and_pay_for_payer<T0, T1>(arg0: &mut 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::Wallet, arg1: ServiceSigForPayer<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, WalletWitness<T0, T1>) {
        assert!(0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::is_authorized<T0, T1>(arg0), 0);
    ...
    public fun validate_and_pay_unmetered<T0, T1>(arg0: &mut 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::Wallet, arg1: ServiceSigUnmetered<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, WalletWitness<T0, T1>) {
        assert!(0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::is_authorized<T0, T1>(arg0), 0);
        ...
        (0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::pay_by_service<T0, T1>(arg0, v0, arg2), v2)
    }

    public fun validate_and_swap_out<T0, T1, T2>(arg0: &mut 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::Wallet, arg1: SwapSig<T0, T1, T2>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, WalletSwapWitness<T0, T1, T2>) {
        assert!(0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::is_authorized<T0, T1>(arg0), 0);
        let SwapSig {
            amount_in      : v0,
            min_amount_out : v1,
    ...
    public fun verify_swap_and_credit<T0, T1, T2>(arg0: &mut 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::Wallet, arg1: WalletSwapWitness<T0, T1, T2>, arg2: ServiceSwapReceipt<T0, T1, T2>, arg3: 0x2::coin::Coin<T2>) {
        ...
        assert!(v3 >= v1, 4);
        0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::receive_from_service_internal<T0, T2>(arg0, arg3);
        let v4 = SwapVerified{
            wallet_id  : 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::id(arg0),
            service    : 0x1::type_name::with_defining_ids<T0>(),
            coin_in    : 0x1::type_name::with_defining_ids<T1>(),
