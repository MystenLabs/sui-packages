module 0x24fff2b9b9e690601a57203c8bee416dda6144d27417fa8c0534d37d7e531878::roles {
    ...
    public fun check_queue_processor(arg0: &Safe, arg1: &QueueProcessorCap) {
        assert!(arg0.queue_processor_id == 0x2::object::uid_to_inner(&arg1.id), 0x24fff2b9b9e690601a57203c8bee416dda6144d27417fa8c0534d37d7e531878::errors::inactive_queue_processor());
    }

    public fun check_safe_version(arg0: &Safe) {
        assert!(arg0.version == 0x24fff2b9b9e690601a57203c8bee416dda6144d27417fa8c0534d37d7e531878::constants::get_version(), 0x24fff2b9b9e690601a57203c8bee416dda6144d27417fa8c0534d37d7e531878::errors::version_mismatch());
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Safe{
            ...
            queue_created      : false,
            version            : 0x24fff2b9b9e690601a57203c8bee416dda6144d27417fa8c0534d37d7e531878::constants::get_version(),
        };
