module 0x243c0f2b4c53e57d6109e07d217867262217418c391e8e8b00ed87f613cc56b6::nft_market {
    ...
    public fun buy_print(arg0: &mut UserRegistry, arg1: &mut NFT, arg2: u64, arg3: address, arg4: &Config, arg5: &mut 0x243c0f2b4c53e57d6109e07d217867262217418c391e8e8b00ed87f613cc56b6::nft_treasury::Treasury, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x243c0f2b4c53e57d6109e07d217867262217418c391e8e8b00ed87f613cc56b6::nft_treasury::set_allowance(arg5, arg1.owner, arg1.revenue);
        0x1::vector::push_back<vector<u8>>(&mut get_or_create_user(arg0, arg3, arg6).print_history, 0x2::object::uid_to_bytes(&arg1.id));
    }

    public fun claim_revenue(arg0: &mut NFT, arg1: &mut 0x243c0f2b4c53e57d6109e07d217867262217418c391e8e8b00ed87f613cc56b6::nft_treasury::Treasury, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 5);
        let v0 = arg0.revenue;
        assert!(v0 > 0, 4);
        0x243c0f2b4c53e57d6109e07d217867262217418c391e8e8b00ed87f613cc56b6::nft_treasury::withdraw_allowance(arg1, v0, arg2);
        arg0.revenue = 0;
    }
