module 0x24fef53c6f477faca9a33a2cfeb3cd0013e2fa5f3812196c423bf7814ce2ae32::cnsnft4578 {
    struct CNSNFT4578 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4578, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4578>(arg0, arg1);
