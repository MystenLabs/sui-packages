module 0x47a332f507af207f729ad2c4bd7af566632e5160c661fae539024eb1d63e1259::navi_section {
    ...
    public fun borrow_sui(arg0: &0x2::clock::Clock, arg1: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<0x2::sui::SUI>, arg4: u64, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &NaviConfig) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(check_total_borrow_cap(arg2, arg7, arg4), 3);
        let v0 = get_vault_health_factor(arg0, arg2, arg1, arg7);
        assert!(v0 > arg7.limit_hf, 2);
    ...
    public fun check_total_borrow_cap(arg0: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg1: &NaviConfig, arg2: u64) : bool {
        let (v0, v1) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_total_supply(arg0, arg1.asset_hasui);
        let v2 = v0 * 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_borrow_cap_ceiling_ratio(arg0, arg1.asset_hasui) / 100000000000000000000000 / 100;
        let v3 = false;
        if (v2 >= v1) {
            if (v2 - v1 >= (arg2 as u256)) {
                v3 = true;
            };
        };
        v3
    ...
    public fun check_total_supply_cap(arg0: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg1: &NaviConfig, arg2: u64) : bool {
        ...
        let (v1, _) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_total_supply(arg0, arg1.asset_hasui);
        let v3 = false;
        if (v0 > v1) {
    ...
    public fun get_lending_liquidation_factors(arg0: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg1: &NaviConfig) : u64 {
        ...
        ((v2 / 100000000000000000000000) as u64)
    }
    ...
    public fun get_vault_health_factor_raw(arg0: &0x2::clock::Clock, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg3: &NaviConfig) : u256 {
