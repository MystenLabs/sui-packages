module 0x24c303274a4d262f5a342d4d770a157b59e1f70fe73eabe3c911f50311563cd3::reward5181 {
    struct REWARD5181 has drop {
        dummy_field: bool,
    }

    struct TICKET_5181 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5181(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5181>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5181>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5181, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5181>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5181>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5181>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5181>>(v5, 0x2::tx_context::sender(arg1));
    }
