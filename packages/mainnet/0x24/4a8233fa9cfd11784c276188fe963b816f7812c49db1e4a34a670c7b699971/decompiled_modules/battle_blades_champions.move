module 0x244a8233fa9cfd11784c276188fe963b816f7812c49db1e4a34a670c7b699971::battle_blades_champions {
    struct BATTLE_BLADES_CHAMPIONS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BATTLE_BLADES_CHAMPIONS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BATTLE_BLADES_CHAMPIONS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Battle Blades Champions"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Discover the Champions of Battle Blades, each with unique fighting styles, strengths, and backgrounds that shape their approach to combat in the arena"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreif6mykewd666b5jlimhev6oq222mejuxlx6b6kjwq466afhzymbye"));
