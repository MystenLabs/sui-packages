module 0x24c00d12e864acf0f223a05b3ed3a89456232202cff49707cac35f3ab01d746f::Navi_Reward_W8 {
    struct NAVI_REWARD_W8 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun GiveReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = NAVI_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmUdms52y5sUVRTj8GRyMT2qLiq94cpgnpHE7MvCX9moYJ"),
            };
    ...
    fun init(arg0: NAVI_REWARD_W8, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmUdms52y5sUVRTj8GRyMT2qLiq94cpgnpHE7MvCX9moYJ"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        let v4 = 0x2::package::claim<NAVI_REWARD_W8>(arg0, arg1);
