module 0x2498ec964f028e5a1a76636fc5558234b2f1d0d570acb51c21478cd5850b7384::reward1587 {
    struct REWARD1587 has drop {
        dummy_field: bool,
    }

    struct TICKET_1587 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1587(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1587>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1587>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1587, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1587>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1587>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1587>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1587>>(v5, 0x2::tx_context::sender(arg1));
    }
