module 0x24960b818d5a4c678c1d68bfb7892f7aec23a9c6d026b2f01d6602fb1ed23e56::reward1418 {
    struct REWARD1418 has drop {
        dummy_field: bool,
    }

    struct TICKET_1418 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1418(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1418>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1418>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1418, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1418>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1418>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1418>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1418>>(v5, 0x2::tx_context::sender(arg1));
    }
