module 0x244a13cf99169eb479eded170a1ae37a7a56f97696ee4c67dfa1e368d99ae333::cnsnft2822 {
    struct CNSNFT2822 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2822, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2822>(arg0, arg1);
