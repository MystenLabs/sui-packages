module 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::critbit {
    ...
    public(friend) fun borrow_leaf_by_index<T0: store>(arg0: &CritbitTree<T0>, arg1: u64) : &T0 {
        &0x2::table::borrow<u64, Leaf<T0>>(&arg0.leaves, arg1).value
    }

    public(friend) fun borrow_leaf_by_key<T0: store>(arg0: &CritbitTree<T0>, arg1: u64) : &T0 {
    ...
    public(friend) fun borrow_mut_leaf_by_key<T0: store>(arg0: &mut CritbitTree<T0>, arg1: u64) : &mut T0 {
        let (v0, v1) = find_leaf<T0>(arg0, arg1);
        assert!(v0, 5);
    ...
    public(friend) fun find_leaf<T0: store>(arg0: &CritbitTree<T0>, arg1: u64) : (bool, u64) {
        if (is_empty<T0>(arg0)) {
    ...
    public(friend) fun max_leaf<T0: store>(arg0: &CritbitTree<T0>) : (u64, u64) {
        assert!(!is_empty<T0>(arg0), 5);
        (0x2::table::borrow<u64, Leaf<T0>>(&arg0.leaves, arg0.max_leaf).key, arg0.max_leaf)
    }

    public(friend) fun min_leaf<T0: store>(arg0: &CritbitTree<T0>) : (u64, u64) {
        assert!(!is_empty<T0>(arg0), 5);
    ...
    public(friend) fun remove_leaf_by_key<T0: store>(arg0: &mut CritbitTree<T0>, arg1: u64) : T0 {
        let (v0, v1) = find_leaf<T0>(arg0, arg1);
        assert!(v0, 5);
