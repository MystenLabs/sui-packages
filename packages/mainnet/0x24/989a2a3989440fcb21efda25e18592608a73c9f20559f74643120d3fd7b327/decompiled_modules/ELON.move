module 0x24989a2a3989440fcb21efda25e18592608a73c9f20559f74643120d3fd7b327::ELON {
    ...
    fun init(arg0: ELON, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<ELON>(arg0, 9, b"ETH", b"Etherium", b"Etherium on Satoshi Nagamoto", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
