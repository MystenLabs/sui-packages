module 0x240520c254661a0402f2282183e9a28537d3f580d7090c561ccae5e848d2b392::maniac_attribute {
    ...
    fun create_attribute(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) : ManiacAttributeNft {
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Type"), 0x1::string::utf8(arg0));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"Value"), 0x1::string::utf8(arg1));
        ManiacAttributeNft{
            id          : v0,
            name        : 0x1::string::utf8(arg1),
            image_url   : 0x1::string::utf8(v1),
    ...
    entry fun giveaway_to_sender(arg0: &MintingControl, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(is_admin(arg0, v0), 1);
        let v1 = 0;
        while (v1 < arg3) {
            0x2::transfer::public_transfer<ManiacAttributeNft>(create_attribute(arg1, arg2, arg4), v0);
            v1 = v1 + 1;
        };
    }

    public fun image_url(arg0: &ManiacAttributeNft) : &0x1::string::String {
        &arg0.image_url
    }
    ...
    public fun name(arg0: &ManiacAttributeNft) : &0x1::string::String {
        &arg0.name
    }
