module 0x241fa644666e25b56de625c169114d3f96b1e3e16a1901592170c847797af781::reward7629 {
    struct REWARD7629 has drop {
        dummy_field: bool,
    }

    struct TICKET_7629 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7629(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7629>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7629>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7629, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7629>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7629>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7629>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7629>>(v5, 0x2::tx_context::sender(arg1));
    }
