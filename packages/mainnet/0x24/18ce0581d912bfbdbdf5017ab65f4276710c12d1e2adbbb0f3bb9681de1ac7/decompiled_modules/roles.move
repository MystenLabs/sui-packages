module 0x2418ce0581d912bfbdbdf5017ab65f4276710c12d1e2adbbb0f3bb9681de1ac7::roles {
    ...
    public fun check_delevearging_operator_validity(arg0: &CapabilitiesSafe, arg1: &DeleveragingCap) {
        assert!(arg0.deleveraging == 0x2::object::uid_to_inner(&arg1.id), 0x2418ce0581d912bfbdbdf5017ab65f4276710c12d1e2adbbb0f3bb9681de1ac7::error::invalid_deleveraging_operator());
    }

    public fun check_funding_rate_operator_validity(arg0: &CapabilitiesSafe, arg1: &FundingRateCap) {
        assert!(arg0.fundingRateOperator == 0x2::object::uid_to_inner(&arg1.id), 0x2418ce0581d912bfbdbdf5017ab65f4276710c12d1e2adbbb0f3bb9681de1ac7::error::invalid_funding_rate_operator());
    }

    public fun check_guardian_validity(arg0: &CapabilitiesSafe, arg1: &ExchangeGuardianCap) {
        assert!(arg0.guardian == 0x2::object::uid_to_inner(&arg1.id), 0x2418ce0581d912bfbdbdf5017ab65f4276710c12d1e2adbbb0f3bb9681de1ac7::error::invalid_guardian());
    }

    public fun check_public_settlement_cap_validity(arg0: &CapabilitiesSafe, arg1: &SettlementCap) {
        assert!(arg0.publicSettlementCap == 0x2::object::uid_to_inner(&arg1.id), 0x2418ce0581d912bfbdbdf5017ab65f4276710c12d1e2adbbb0f3bb9681de1ac7::error::not_a_public_settlement_cap());
    }
    ...
    public fun check_settlement_operator_validity(arg0: &CapabilitiesSafe, arg1: &SettlementCap) {
        ...
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.settlementOperators, &v0), 0x2418ce0581d912bfbdbdf5017ab65f4276710c12d1e2adbbb0f3bb9681de1ac7::error::invalid_settlement_operator());
    }
    ...
    entry fun remove_settlement_operator(arg0: &ExchangeAdminCap, arg1: &mut CapabilitiesSafe, arg2: 0x2::object::ID) {
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg1.settlementOperators, &arg2), 0x2418ce0581d912bfbdbdf5017ab65f4276710c12d1e2adbbb0f3bb9681de1ac7::error::operator_already_removed());
    ...
    entry fun set_exchange_admin(arg0: ExchangeAdminCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 != 0x2::tx_context::sender(arg2), 0x2418ce0581d912bfbdbdf5017ab65f4276710c12d1e2adbbb0f3bb9681de1ac7::error::new_address_can_not_be_same_as_current_one());
