module 0x85de2bd2ebb04a4a6a859a571428af03252094907787a09475faa192bebfb87d::cnsnft2093 {
    struct CNSNFT2093 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2093, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2093>(arg0, arg1);
