module 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool {
    ...
    public(friend) fun are_all_protocols_fresh<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u64) : bool {
        let v0 = 0;
    ...
    fun cetus_clmm_config_values<T0, T1>(arg0: &LLVPool<T0, T1>) : (u64, u64, u64) {
        let v0 = get_protocol_config<T0, T1>(arg0, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_CETUS_CLMM());
    ...
    public(friend) fun charge_pool_loss_budget<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u128, arg3: u64) {
    ...
    fun charge_pool_loss_budget_with_total_assets<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u128, arg3: u64, arg4: u128, arg5: u128) {
        ...
        let v1 = if (v0 == 0) {
            ...
            0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_math::mul_div_ceil(arg4, (v0 as u128), (10000 as u128))
        };
        ...
        if (!0x2::dynamic_field::exists<PoolLossBudgetKey>(&arg0.id, v2)) {
            ...
            0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_events::emit_pool_loss_budget_updated(0x2::object::id<LLVPool<T0, T1>>(arg0), arg3, arg2, v1, v1 - arg2);
            return
        };
        ...
        0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_events::emit_pool_loss_budget_updated(0x2::object::id<LLVPool<T0, T1>>(arg0), v4.window_start_ms, v6, v5, v5 - v6);
    }

    fun charge_protocol_loss_budget<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u128, arg3: u64, arg4: u128) {
        let v0 = get_socialized_loss_limit_bps<T0, T1>(arg0);
        let v1 = if (v0 == 0) {
            0
        } else {
    ...
    public(friend) fun charge_rebalance_loss_budget<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u128, arg3: u64, arg4: u128, arg5: u128) {
    ...
    public fun effective_settlement_loss_bps<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8, arg2: u64) : u64 {
        min_u64(arg2, settlement_loss_ceiling_bps<T0, T1>(arg0, arg1))
    }

    public fun effective_user_withdraw_loss_bps<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8, arg2: u64) : u64 {
    ...
    fun ensure_socialized_loss_limit<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u128) {
    ...
    public fun get_cetus_clmm_accounted_gap_limit_bps<T0, T1>(arg0: &LLVPool<T0, T1>) : u64 {
    ...
    public fun get_cetus_clmm_params_for_types<T0, T1, T2>(arg0: &LLVPool<T0, T2>) : 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_cetus_clmm_params::RiskParams {
        let v0 = get_protocol_config<T0, T2>(arg0, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_CETUS_CLMM());
        ...
        assert!(0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_cetus_clmm_params::is_valid(v1, v2, v3), 158);
        assert!(0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_cetus_clmm_params::max_accounted_value_gap_bps(v1, v2, v3) <= get_cetus_clmm_accounted_gap_limit_bps<T0, T2>(arg0), 158);
        0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_cetus_clmm_params::from_values(v1, v2, v3)
    }
    ...
    public fun get_pool_loss_budget<T0, T1>(arg0: &LLVPool<T0, T1>) : (bool, u64, u128, u128) {
    ...
    public fun get_protocol_loss_budget<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8) : (bool, u64, u128, u128) {
    ...
    public fun get_socialized_loss_limit_bps<T0, T1>(arg0: &LLVPool<T0, T1>) : u64 {
    ...
    public fun has_cetus_clmm_accounted_gap_limit<T0, T1>(arg0: &LLVPool<T0, T1>) : bool {
        let v0 = CetusClmmAccountedGapLimitKey{dummy_field: false};
    ...
    public fun has_socialized_loss_limit<T0, T1>(arg0: &LLVPool<T0, T1>) : bool {
        let v0 = SocializedLossLimitKey{dummy_field: false};
    ...
    fun is_protocol_fresh<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8, arg2: u64) : bool {
        if (!0x2::vec_map::contains<u8, ProtocolAllocation>(&arg0.allocations, &arg1)) {
            return true
        };
    ...
    fun loss_limit_for_assets(arg0: u128, arg1: u64) : u128 {
        ...
        0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_math::mul_div_ceil(arg0, (arg1 as u128), (10000 as u128))
    }
    ...
    public fun max_accounted_value_gap_for_protocol_input<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8, arg2: u64) : u64 {
        let v0 = if (arg1 == 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_CETUS_CLMM()) {
            ...
            let v4 = 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_cetus_clmm_params::max_accounted_value_gap_bps(v1, v2, v3);
    ...
    public fun max_settlement_loss_bps() : u64 {
        10
    }
    ...
    fun rebase_protocol_loss_budget<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u64) {
        let v0 = ProtocolLossBudgetKey{protocol_id: arg1};
        if (!0x2::dynamic_field::exists<ProtocolLossBudgetKey>(&arg0.id, v0)) {
            return
        };
    ...
    public(friend) fun set_cetus_clmm_accounted_gap_limit_bps<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0x2::tx_context::TxContext, arg2: u64) {
        assert_pool_admin<T0, T1>(arg0, 0x2::tx_context::sender(arg1));
        assert_no_operation_in_progress<T0, T1>(arg0);
        ...
        assert!(0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_cetus_clmm_params::max_accounted_value_gap_bps(*0x1::vector::borrow<u64>(&v1.values, 0), *0x1::vector::borrow<u64>(&v1.values, 1), *0x1::vector::borrow<u64>(&v1.values, 2)) <= arg2, 145);
    ...
    public(friend) fun set_socialized_loss_limit_bps<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0x2::tx_context::TxContext, arg2: u64) {
        assert_pool_admin<T0, T1>(arg0, 0x2::tx_context::sender(arg1));
        assert_no_operation_in_progress<T0, T1>(arg0);
    ...
    public(friend) fun settlement_bounds<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8, arg2: u128, arg3: u128, arg4: u64) : (u64, u128, u128) {
        let v0 = socialized_settlement_loss_ceiling_bps<T0, T1>(arg0, arg1);
        let v1 = min_u64(arg4, v0);
        let v2 = if (arg2 == 0 || v0 == 0) {
            0
        } else {
            0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_math::mul_div_ceil(arg2, (v0 as u128), (10000 as u128))
        };
        (v1, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_math::mul_div(arg3, (10000 as u128) - (v1 as u128), (10000 as u128)), v2)
    }

    fun settlement_loss_ceiling_bps<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8) : u64 {
        let v0 = if (arg1 == 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_CETUS_CLMM()) {
            let (v1, v2, v3) = cetus_clmm_config_values<T0, T1>(arg0);
            0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_cetus_clmm_params::execution_loss_bps(v1, v2, v3)
        } else {
            arg0.max_accounted_value_gap_bps
        };
    ...
    fun socialized_settlement_loss_ceiling_bps<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8) : u64 {
        if (!0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::is_known_protocol(arg1) || 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::is_idle_protocol(arg1)) {
            return 0
        };
        if (arg1 == 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_CETUS_CLMM()) {
            let (v1, v2, v3) = cetus_clmm_config_values<T0, T1>(arg0);
            min_u64(get_socialized_loss_limit_bps<T0, T1>(arg0), 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_cetus_clmm_params::execution_loss_bps(v1, v2, v3))
        } else {
    ...
    fun store_socialized_loss_limit_and_rebase<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u64, arg2: u128) {
        let v0 = SocializedLossLimitKey{dummy_field: false};
        if (0x2::dynamic_field::exists<SocializedLossLimitKey>(&arg0.id, v0)) {
        ...
        rebase_protocol_loss_budget<T0, T1>(arg0, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_VAULT(), arg1);
        rebase_protocol_loss_budget<T0, T1>(arg0, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_CETUS(), arg1);
        rebase_protocol_loss_budget<T0, T1>(arg0, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_SUILEND(), arg1);
        rebase_protocol_loss_budget<T0, T1>(arg0, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_SCALLOP(), arg1);
        rebase_protocol_loss_budget<T0, T1>(arg0, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_NAVI(), arg1);
        rebase_protocol_loss_budget<T0, T1>(arg0, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_ALPHALEND(), arg1);
        rebase_protocol_loss_budget<T0, T1>(arg0, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_CURRENT(), arg1);
        rebase_protocol_loss_budget<T0, T1>(arg0, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::PROTOCOL_CETUS_CLMM(), arg1);
    }
    ...
    fun withdraw_settlement_loss_ceiling_bps(arg0: u8) : u64 {
        if (!0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::is_known_protocol(arg0) || 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::is_idle_protocol(arg0)) {
            return 0
        };
        10
    }
