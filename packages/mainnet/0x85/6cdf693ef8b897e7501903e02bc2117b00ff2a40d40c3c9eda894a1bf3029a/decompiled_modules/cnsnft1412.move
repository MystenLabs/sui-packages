module 0x856cdf693ef8b897e7501903e02bc2117b00ff2a40d40c3c9eda894a1bf3029a::cnsnft1412 {
    struct CNSNFT1412 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1412, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1412>(arg0, arg1);
