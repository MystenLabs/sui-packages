module 0x8567d38352401239892dae6dffaf464991488b7b9d4c6f9f9ba6f88789b597cb::reward6570 {
    struct REWARD6570 has drop {
        dummy_field: bool,
    }

    struct TICKET_6570 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6570(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6570>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6570>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6570, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6570>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6570>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6570>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6570>>(v5, 0x2::tx_context::sender(arg1));
    }
