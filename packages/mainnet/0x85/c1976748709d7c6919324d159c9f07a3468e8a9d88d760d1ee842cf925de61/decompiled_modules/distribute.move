module 0x85c1976748709d7c6919324d159c9f07a3468e8a9d88d760d1ee842cf925de61::distribute {
    struct DISTRIBUTE has drop {
        dummy_field: bool,
    }

    struct Distributor<T0: store + key> has store, key {
        id: 0x2::object::UID,
    ...
    public fun claim_all<T0: store + key>(arg0: &mut Distributor<T0>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun deposit<T0: store + key>(arg0: &mut Distributor<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut vector<address>, arg3: &mut vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<address>(arg2) == 0x1::vector::length<u64>(arg3), 4001);
        assert!(0x2::coin::value<T0>(&arg1) == 0x85c1976748709d7c6919324d159c9f07a3468e8a9d88d760d1ee842cf925de61::utils::sum(arg3), 4002);
    ...
    public fun new_distributor<T0: store + key>(arg0: &AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
