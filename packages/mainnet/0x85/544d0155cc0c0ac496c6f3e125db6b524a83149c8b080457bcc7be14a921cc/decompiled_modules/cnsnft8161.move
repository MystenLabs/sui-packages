module 0x85544d0155cc0c0ac496c6f3e125db6b524a83149c8b080457bcc7be14a921cc::cnsnft8161 {
    struct CNSNFT8161 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8161, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1357"));
        let v4 = 0x2::package::claim<CNSNFT8161>(arg0, arg1);
