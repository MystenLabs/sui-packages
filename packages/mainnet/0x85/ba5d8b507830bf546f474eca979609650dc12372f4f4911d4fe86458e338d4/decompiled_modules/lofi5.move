module 0x85ba5d8b507830bf546f474eca979609650dc12372f4f4911d4fe86458e338d4::lofi5 {
    struct LOFI5 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LOFI5, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<LOFI5>(arg0, 9, b"LOFI5", b"LOFI5", b"Embrace Your Inner Yeti", v2, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LOFI5>>(v4);
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<LOFI5>>(v3);
    ...
    public entry fun transfer_with_tax(arg0: &TaxStorage, arg1: &AdminCap, arg2: &mut 0x2::coin::Coin<LOFI5>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        ...
        let v3 = 0x2::balance::split<LOFI5>(0x2::coin::balance_mut<LOFI5>(arg2), arg3);
        if (v0 > 0) {
            let v4 = arg3 * v0 / 10000;
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI5>>(0x2::coin::from_balance<LOFI5>(0x2::balance::split<LOFI5>(&mut v3, v4), arg5), arg1.admin_address);
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI5>>(0x2::coin::from_balance<LOFI5>(0x2::balance::split<LOFI5>(&mut v3, arg3 - v4), arg5), arg4);
            0x2::balance::destroy_zero<LOFI5>(v3);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI5>>(0x2::coin::from_balance<LOFI5>(v3, arg5), arg4);
        };
    }
