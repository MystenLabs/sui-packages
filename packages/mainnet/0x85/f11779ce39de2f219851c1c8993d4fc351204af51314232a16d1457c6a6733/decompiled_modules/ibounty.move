module 0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::ibounty {
    ...
    public fun borrow_total_reward(arg0: &BattleSessionRegistry, arg1: 0x2::object::ID) : u128 {
        0x2::table::borrow<0x2::object::ID, BattleBountySession>(&arg0.bounty_assign_to_target, arg1).total_reward
    }
    ...
    public(friend) fun clean_zero_reward(arg0: &mut BattleSessionRegistry, arg1: 0x2::object::ID) {
        0x2::table::remove<0x2::object::ID, BattleBountySession>(&mut arg0.bounty_assign_to_target, arg1);
        let (_, v1) = 0x1::vector::index_of<0x2::object::ID>(&arg0.active_bounty_session, &arg1);
        0x1::vector::remove<0x2::object::ID>(&mut arg0.active_bounty_session, v1);
    }
