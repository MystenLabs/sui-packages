module 0x859638959e98957277ca41d38e6a1ee8dcf6780cc82affb1be0254d76f4c782f::cnsnft1433 {
    struct CNSNFT1433 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1433, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3041"));
        let v4 = 0x2::package::claim<CNSNFT1433>(arg0, arg1);
