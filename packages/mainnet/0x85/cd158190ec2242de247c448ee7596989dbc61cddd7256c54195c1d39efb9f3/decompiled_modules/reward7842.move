module 0x85cd158190ec2242de247c448ee7596989dbc61cddd7256c54195c1d39efb9f3::reward7842 {
    struct REWARD7842 has drop {
        dummy_field: bool,
    }

    struct TICKET_7842 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7842(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7842>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7842>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7842, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7842>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7842>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7842>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7842>>(v5, 0x2::tx_context::sender(arg1));
    }
