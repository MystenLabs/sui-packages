module 0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma {
    ...
    fun init(arg0: TOMA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOMA>(arg0, 9, b"ALPHA_TOMA", b"ALPHA_TOMA", b"Atoma network coin", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v1;
        let v3 = v0;
        let v4 = Faucet{
