module 0x8535c58bda08e0bfd51ae3762daef48808368639a489ecb4470a93069c114390::sudoz_artifacts {
    ...
    struct MintPassRegistry has key {
        id: 0x2::object::UID,
    ...
    entry fun init_mint_pass_registry(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = MintPassRegistry{
            id      : 0x2::object::new(arg0),
            claimed : 0x1::vector::empty<address>(),
        };
        0x2::transfer::share_object<MintPassRegistry>(v0);
    }
    ...
    public entry fun mint_with_pass(arg0: &mut MintPassRegistry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(!0x1::vector::contains<address>(&arg0.claimed, &v0), 6);
        0x1::vector::push_back<address>(&mut arg0.claimed, v0);
        let v1 = Nft{
        ...
        0x2::kiosk::place<Nft>(arg1, arg2, v1);
    }

    public entry fun mint_with_payment(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg0) >= 1000000000, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, @0xf1df42d3b603f6d22fc276c25dd1eee4c3f767d7a7e7ec36bf9c3d416a74e228);
        let v0 = Nft{
            id             : 0x2::object::new(arg3),
            name           : 0x1::string::utf8(b"Sudoz Artifact"),
            description    : 0x1::string::utf8(b"A mystical artifact with hidden powers waiting to be unlocked."),
