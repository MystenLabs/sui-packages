module 0x85d8dc5642a7a5b7226889dcc86c99d22ed0f19a53c433c807bf2c2ae59d21b8::game8489 {
    struct GAME8489 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeTicket8489(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GAME8489, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME8489>(arg0, arg1);
