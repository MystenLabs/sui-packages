module 0x6c442d664dffc25e3fda48f15370ffaecac1f94ecb6debb46cd41ac4b38bddfa::weighted_math {
    ...
    public fun add_liquidity_computation(arg0: &WeightedConfig, arg1: vector<u256>, arg2: vector<u256>, arg3: u64, arg4: u256) : (u256, vector<u256>) {
        ...
        let (v2, v3) = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::get_non_zero_count_and_index_u256(arg2);
        ...
        let v4 = if (v2 == 1) {
            ...
            *0x1::vector::borrow_mut<u256>(&mut v1, v3) = v6;
            ...
            let v11 = v10;
            let v12 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::create_zero_vector_u256(v0);
            let v13 = 0;
            while (v13 < v0) {
            ...
            v9 + 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::vector_sum_u256(v12)
        };
        (v4, v1)
    }
    ...
    public fun calc_minted_shares_given_single_asset_in(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: u64) : (u256, u256) {
        ...
        let v0 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(arg0, fee_ratio(arg1, (arg4 as u256)), (1000000000000000000 as u256));
    ...
    public fun calc_shares_given_single_asset_out(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: u64) : (u256, u256) {
        let v0 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(arg3, (1000000000000000000 as u256), fee_ratio(arg0, (arg4 as u256)));
    ...
    public fun computeScalingFactor(arg0: u8) : u256 {
        assert!(18 >= arg0, 5212);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::pow_10_u256(18 - arg0)
    }

    public fun compute_ask_amount(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: u256) : u256 {
        assert!(arg0 <= 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(arg1, 300000000000000000, (1000000000000000000 as u256)), 5210);
    ...
    public fun compute_offer_amount(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: u256, arg5: u64) : (u256, u256) {
        ...
        assert!(arg0 <= 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(arg1, 300000000000000000, (1000000000000000000 as u256)), 5210);
        let v1 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(arg0, (v0 as u256), ((v0 - arg5) as u256));
        (solve_for_invariant(arg1, arg1 - v1, arg2, arg3, arg4), v1 - arg0)
    }

    public fun fee_ratio(arg0: u256, arg1: u256) : u256 {
        (1000000000000000000 as u256) - 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((1000000000000000000 as u256) - arg0, 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(arg1, (1000000000000000000 as u256), (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::amm_fee_precision() as u256)), (1000000000000000000 as u256))
    }
    ...
    public fun get_weight_and_sf_at_index(arg0: &WeightedConfig, arg1: u64, arg2: bool) : (u64, u256) {
        let v0 = if (!arg2) {
            *0x1::vector::borrow<u64>(&arg0.weights, arg1)
            ...
            (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((*0x1::vector::borrow<u64>(&arg0.weights, arg1) as u256), (1000000000000000000 as u256), (arg0.total_weight as u256)) as u64)
        };
    ...
    public fun imbalanced_liquidity_withdraw(arg0: &WeightedConfig, arg1: vector<u256>, arg2: u256, arg3: vector<u256>, arg4: u64) : (u256, vector<u256>) {
        let v0 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::create_zero_vector_u256(0x1::vector::length<u256>(&arg1));
        let (v1, v2) = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::get_non_zero_count_and_index_u256(arg3);
        assert!(v1 == 1, 5214);
    ...
    public fun initialize_weighted_config(arg0: vector<u64>, arg1: vector<u64>, arg2: vector<u256>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : WeightedConfig {
        ...
        assert!(*0x1::vector::borrow<u64>(&arg0, 0) < 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::max_weighted_exit_fee(), 5220);
        let v0 = 0;
        let v1 = 0;
    ...
    public fun maximal_exact_ratio_join(arg0: vector<u256>, arg1: vector<u256>, arg2: u256) : (u256, vector<u256>) {
        ...
        let v5 = 0;
        while (v5 < v0) {
            let v6 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(*0x1::vector::borrow<u256>(&arg0, v5), (1000000000000000000 as u256), *0x1::vector::borrow<u256>(&arg1, v5));
            v2 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u256(v2, v6);
            v3 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u256(v3, v6);
        ...
        if (v2 != v3) {
            while (v5 < v0) {
                ...
                0x1::vector::push_back<u256>(&mut v4, *0x1::vector::borrow<u256>(&arg0, v5) - 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(v2, *0x1::vector::borrow<u256>(&arg1, v5), (1000000000000000000 as u256)));
                v5 = v5 + 1;
            };
        } else {
            while (v5 < v0) {
        ...
        (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(v2, arg2, (1000000000000000000 as u256)), v4)
    }
    ...
    public fun solve_for_invariant(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: u256) : u256 {
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(arg3, 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::subtract_mod_u256((1000000000000000000 as u256), calculate_pow(arg0, arg1, arg2, arg4)), (1000000000000000000 as u256))
    }
    ...
    public fun update_weighted_config(arg0: &mut WeightedConfig, arg1: vector<u64>, arg2: u64) {
        ...
        assert!(arg2 < 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::max_weighted_exit_fee(), 5220);
        let v0 = 0;
        let v1 = 0;
        while (v1 < 0x1::vector::length<u64>(&arg1)) {
            assert!(*0x1::vector::borrow<u64>(&arg1, v1) > 0, 5219);
