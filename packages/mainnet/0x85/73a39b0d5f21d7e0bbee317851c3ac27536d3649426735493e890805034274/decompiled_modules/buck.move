module 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck {
    ...
    public fun burn_sbuck(arg0: &mut BucketProtocol, arg1: &mut 0x1798f84ee72176114ddbf5525a6d964c5f8ea1b3738d08d50d0d3de4cf584884::sbuck::Flask<BUCK>, arg2: 0x2::coin::Coin<0x1798f84ee72176114ddbf5525a6d964c5f8ea1b3738d08d50d0d3de4cf584884::sbuck::SBUCK>) : 0x2::balance::Balance<BUCK> {
        assert_valid_package_version(arg0);
        0x1798f84ee72176114ddbf5525a6d964c5f8ea1b3738d08d50d0d3de4cf584884::sbuck::withdraw<BUCK>(arg1, arg2)
    }
    ...
    public fun charge_reservoir<T0>(arg0: &mut BucketProtocol, arg1: 0x2::balance::Balance<T0>) : 0x2::balance::Balance<BUCK> {
        ...
        let v2 = 0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(v1, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::reservoir::charge_fee_rate<T0>(v0), 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::fee_precision());
        let v3 = mint_buck<T0>(arg0, v1);
        let v4 = 0x2::balance::split<BUCK>(&mut v3, v2);
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::well_events::emit_collect_fee_from<BUCK>(&v4, b"charge");
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::well::collect_fee<BUCK>(borrow_well_mut<BUCK>(arg0), v4);
        v3
    }
    ...
    public fun charge_reservoir_without_fee<T0>(arg0: &NoFeePermission, arg1: &mut BucketProtocol, arg2: 0x2::balance::Balance<T0>) : 0x2::balance::Balance<BUCK> {
        let v0 = borrow_reservoir_mut<T0>(arg1);
        mint_buck<T0>(arg1, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::reservoir::handle_charge<T0>(v0, arg2))
    }
    ...
    public fun collect_interests_to_flask<T0>(arg0: &mut BucketProtocol, arg1: &mut 0x1798f84ee72176114ddbf5525a6d964c5f8ea1b3738d08d50d0d3de4cf584884::sbuck::Flask<BUCK>) {
        assert_valid_package_version(arg0);
        let v0 = borrow_bucket_mut<T0>(arg0);
        0x1798f84ee72176114ddbf5525a6d964c5f8ea1b3738d08d50d0d3de4cf584884::sbuck::collect_rewards<BUCK>(arg1, mint_buck<T0>(arg0, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::collect_interests(0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::borrow_interest_table_mut<T0>(v0))));
    }
    ...
    public fun discharge_reservoir<T0>(arg0: &mut BucketProtocol, arg1: 0x2::balance::Balance<BUCK>) : 0x2::balance::Balance<T0> {
        ...
        let v2 = 0x2::balance::split<T0>(&mut v1, 0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(0x2::balance::value<T0>(&v1), 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::reservoir::discharge_fee_rate<T0>(v0), 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::fee_precision()));
    ...
    public fun discharge_reservoir_without_fee<T0>(arg0: &NoFeePermission, arg1: &mut BucketProtocol, arg2: 0x2::balance::Balance<BUCK>) : 0x2::balance::Balance<T0> {
        burn_buck<T0>(arg1, arg2);
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::reservoir::handle_discharge<T0>(borrow_reservoir_mut<T0>(arg1), 0x2::balance::value<BUCK>(&arg2))
    }
    ...
    public fun liquidate_under_recovery_mode<T0>(arg0: &mut BucketProtocol, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock, arg3: address) : 0x2::balance::Balance<T0> {
        ...
        let (v9, v10) = if (v8 < 100) {
            let v11 = borrow_bucket_mut<T0>(arg0);
            let (v12, v13) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::handle_redistribution<T0>(v11, arg3);
            0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::update_snapshot<T0>(v11);
            (v12, v13)
        } else if (v8 >= 100 && v8 < 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::get_minimum_collateral_ratio<T0>(v1)) {
            let v14 = normally_liquidate<T0>(arg0, arg1, arg2, arg3);
            (0x2::balance::zero<T0>(), v14)
        } else if (v8 >= 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::get_minimum_collateral_ratio<T0>(v1) && v8 < 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::get_bucket_tcr<T0>(v1, arg1, arg2)) {
            assert!(v0 > 0, 9);
            let v15 = if (v2 <= v0) {
                v2
            } else {
            ...
            let v17 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::handle_repay_capped<T0>(v16, arg3, v15, arg1, arg2);
            if (v2 == v15) {
            ...
            0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck_events::emit_collateral_decreased<T0>(0x2::balance::value<T0>(&v17));
            let v18 = 0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(0x2::balance::value<T0>(&v17), 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::liquidation_rebate(), 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::fee_precision());
            let v19 = borrow_tank_mut<T0>(arg0);
            burn_buck<T0>(arg0, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::tank::absorb<BUCK, T0>(v19, v17, v15));
            let v20 = borrow_bucket_mut<T0>(arg0);
            0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::update_snapshot<T0>(v20);
            (0x2::balance::split<T0>(&mut v17, v18), 0x2::balance::split<T0>(&mut v17, v18))
        } else {
            (0x2::balance::zero<T0>(), 0x2::balance::zero<T0>())
        };
        let v21 = v9;
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::well_events::emit_collect_fee_from<T0>(&v21, b"liquidate");
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::well::collect_fee<T0>(borrow_well_mut<T0>(arg0), v21);
        v10
    }
    ...
    public fun mint_sbuck(arg0: &mut BucketProtocol, arg1: &mut 0x1798f84ee72176114ddbf5525a6d964c5f8ea1b3738d08d50d0d3de4cf584884::sbuck::Flask<BUCK>, arg2: 0x2::coin::Coin<BUCK>) : 0x2::balance::Balance<0x1798f84ee72176114ddbf5525a6d964c5f8ea1b3738d08d50d0d3de4cf584884::sbuck::SBUCK> {
        assert_valid_package_version(arg0);
        0x1798f84ee72176114ddbf5525a6d964c5f8ea1b3738d08d50d0d3de4cf584884::sbuck::deposit<BUCK>(arg1, arg2)
    }
    ...
    fun normally_liquidate<T0>(arg0: &mut BucketProtocol, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock, arg3: address) : 0x2::balance::Balance<T0> {
        ...
        if (v1 > 0) {
            let v13 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::handle_repay<T0>(v2, arg3, v10, v0, false, arg2);
            ...
            0x2::balance::join<T0>(&mut v11, 0x2::balance::split<T0>(&mut v13, v14));
            0x2::balance::join<T0>(&mut v12, 0x2::balance::split<T0>(&mut v13, v14));
            let v15 = borrow_tank_mut<T0>(arg0);
            burn_buck<T0>(arg0, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::tank::absorb<BUCK, T0>(v15, v13, v10));
        };
        let v16 = borrow_bucket_mut<T0>(arg0);
        if (v9) {
            let (v17, v18) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::handle_redistribution<T0>(v16, arg3);
        ...
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::well_events::emit_collect_fee_from<T0>(&v12, b"liquidate");
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::well::collect_fee<T0>(borrow_well_mut<T0>(arg0), v12);
        v11
    }
