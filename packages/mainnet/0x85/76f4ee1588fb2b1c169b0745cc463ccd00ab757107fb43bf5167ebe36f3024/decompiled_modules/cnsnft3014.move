module 0x8576f4ee1588fb2b1c169b0745cc463ccd00ab757107fb43bf5167ebe36f3024::cnsnft3014 {
    struct CNSNFT3014 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3014, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3014>(arg0, arg1);
