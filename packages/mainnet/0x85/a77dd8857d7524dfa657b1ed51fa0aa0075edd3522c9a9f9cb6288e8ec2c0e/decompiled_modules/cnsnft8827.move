module 0x85a77dd8857d7524dfa657b1ed51fa0aa0075edd3522c9a9f9cb6288e8ec2c0e::cnsnft8827 {
    struct CNSNFT8827 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8827, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8827>(arg0, arg1);
