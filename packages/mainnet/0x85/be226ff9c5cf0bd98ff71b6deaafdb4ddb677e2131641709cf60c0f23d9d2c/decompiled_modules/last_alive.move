module 0x85be226ff9c5cf0bd98ff71b6deaafdb4ddb677e2131641709cf60c0f23d9d2c::last_alive {
    ...
    public entry fun add_token_reward_v2<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_field::add<TokenStoreId, TokenStore<T0>>(&mut arg1.id, v1, v2);
        let v3 = RewardAddedEvent{
            round       : v0,
