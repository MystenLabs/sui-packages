module 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::lb_position {
    ...
    public(friend) fun borrow_mut_position_info(arg0: &mut LBPositionManager, arg1: &LBPosition) : &mut LBPositionInfo {
    ...
    public(friend) fun borrow_position_bins_table(arg0: &mut LBPositionInfo) : &mut 0x2::table::Table<u32, PackedBins> {
        &mut arg0.bins
    }
    ...
    public(friend) fun close_position(arg0: &mut LBPositionManager, arg1: LBPosition) {
        ...
        assert!(is_empty_lp(&v0) && is_empty_reward(&arg1), 7);
        destroy_position_info(v0);
        destroy(arg1);
    }

    public(friend) fun collect_fees(arg0: &mut LBBinPosition, arg1: u128, arg2: u128) : (u64, u64) {
        let v0 = arg0.amount;
        arg0.collected_fees_x = 0;
        arg0.collected_fees_y = 0;
        arg0.fee_growth_inside_last_x = arg1;
        arg0.fee_growth_inside_last_y = arg2;
        (0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::add_u64(arg0.collected_fees_x, ((0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::mul_u128(v0, 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::sub_u128(arg1, arg0.fee_growth_inside_last_x)) >> 64) as u64)), 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::add_u64(arg0.collected_fees_y, ((0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::mul_u128(v0, 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::sub_u128(arg2, arg0.fee_growth_inside_last_y)) >> 64) as u64)))
    }
    ...
    public(friend) fun get_and_save_pending_rewards(arg0: &mut LBBinPosition, arg1: u64, arg2: u128) : u64 {
        if (arg0.amount == 0) {
            return 0
        };
        ...
        *0x1::vector::borrow_mut<u128>(&mut arg0.reward_growth_inside_last, arg1) = arg2;
        0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::u128_to_u64(arg0.amount * (arg2 - v0) >> 64)
    }
    ...
    public(friend) fun get_pending_fees(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::add_u64(v0.collected_fees_x, ((v1 * (arg3 - v0.fee_growth_inside_last_x) >> 64) as u64)), 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::add_u64(v0.collected_fees_y, ((v1 * (arg4 - v0.fee_growth_inside_last_y) >> 64) as u64)))
    }

    public(friend) fun get_pending_rewards(arg0: &LBBinPosition, arg1: u64, arg2: u128) : u64 {
        let v0 = arg0.amount;
        if (v0 == 0) {
            return 0
        };
        let v1 = if (arg1 < 0x1::vector::length<u128>(&arg0.reward_growth_inside_last)) {
            *0x1::vector::borrow<u128>(&arg0.reward_growth_inside_last, arg1)
        } else {
            0
        };
        0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::u128_to_u64(v0 * (arg2 - v1) >> 64)
    }

    public(friend) fun get_position_bin_mut_from_pack(arg0: &mut PackedBins, arg1: u64) : &mut LBBinPosition {
        0x1::vector::borrow_mut<LBBinPosition>(&mut arg0.bin_data, arg1)
    }

    public(friend) fun get_saved_pending_rewards(arg0: &LBPosition, arg1: u64) : u64 {
        if (arg1 >= 0x1::vector::length<u64>(&arg0.pending_rewards)) {
            return 0
        };
        *0x1::vector::borrow<u64>(&arg0.pending_rewards, arg1)
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 3) {
            ...
            v3 = 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }
    ...
    public fun get_total_pending_fees_with_growth(arg0: &LBPositionManager, arg1: &LBPosition, arg2: &vector<u32>, arg3: &vector<u128>, arg4: &vector<u128>) : (u64, u64) {
        ...
        while (v2 < 0x1::vector::length<u32>(arg2)) {
            ...
            v0 = 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::add_u64(v0, v3);
            v1 = 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::add_u64(v1, v4);
            v2 = v2 + 1;
        };
        (v0, v1)
    }

    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &mut LBPosition, arg2: vector<u32>, arg3: vector<u128>, arg4: vector<u128>, arg5: vector<u128>, arg6: vector<vector<u128>>) {
        ...
        let v2 = 0;
        let v3 = 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::constants::max_u32();
        let v4 = PackedBins{
            active_bins_bitmap : 0,
            bin_data           : 0x1::vector::empty<LBBinPosition>(),
        };
        ...
        while (v2 < v0) {
            ...
            let v7 = *0x1::vector::borrow<u128>(&arg4, v2);
            let v8 = *0x1::vector::borrow<u128>(&arg5, v2);
            let v9 = *0x1::vector::borrow<vector<u128>>(&arg6, v2);
            let (v10, v11) = resolve_bin_group_index(v6);
            if (v10 != v3) {
                if (!0x2::table::contains<u32, PackedBins>(&v1.bins, v10)) {
                    let v12 = PackedBins{
                        active_bins_bitmap : 0,
                        bin_data           : 0x1::vector::empty<LBBinPosition>(),
                    };
                    0x2::table::add<u32, PackedBins>(&mut v1.bins, v10, v12);
                };
                v5 = 0x2::table::borrow_mut<u32, PackedBins>(&mut v1.bins, v10);
                v3 = v10;
            };
            if (is_bin_active_in_bitmap(v5.active_bins_bitmap, v11)) {
                let v13 = 0x1::vector::borrow_mut<LBBinPosition>(&mut v5.bin_data, (count_active_bins_before_position(v5.active_bins_bitmap, v11) as u64));
                if (v13.amount > 0) {
                    v13.collected_fees_x = 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::add_u64(v13.collected_fees_x, 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::u128_to_u64(v13.amount * 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::sub_u128(v7, v13.fee_growth_inside_last_x) >> 64));
                    v13.collected_fees_y = 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::add_u64(v13.collected_fees_y, 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::u128_to_u64(v13.amount * 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::sub_u128(v8, v13.fee_growth_inside_last_y) >> 64));
                    let v14 = 0;
                    let v15 = 0x1::vector::length<u128>(&v9);
                    let v16 = 0x1::vector::length<u128>(&v13.reward_growth_inside_last);
                    let v17 = if (v15 < v16) {
                        v15
                    } else {
                        v16
                    ...
                    while (v14 < v17) {
                        let v18 = *0x1::vector::borrow<u128>(&v9, v14);
                        let v19 = *0x1::vector::borrow<u128>(&v13.reward_growth_inside_last, v14);
                        if (v18 > v19) {
                            let v20 = 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::u128_to_u64(v13.amount * (v18 - v19) >> 64);
                            if (v20 > 0) {
                                while (0x1::vector::length<u64>(&arg1.pending_rewards) <= v14) {
                                    0x1::vector::push_back<u64>(&mut arg1.pending_rewards, 0);
                                };
                                *0x1::vector::borrow_mut<u64>(&mut arg1.pending_rewards, v14) = 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::add_u64(*0x1::vector::borrow<u64>(&arg1.pending_rewards, v14), v20);
                            };
                        };
                        v14 = v14 + 1;
                    };
                };
                v13.amount = 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::add_u128(v13.amount, *0x1::vector::borrow<u128>(&arg3, v2));
                v13.fee_growth_inside_last_x = v7;
                v13.fee_growth_inside_last_y = v8;
                v13.reward_growth_inside_last = v9;
            } else {
                let v21 = LBBinPosition{
                    bin_id                    : v6,
                    amount                    : *0x1::vector::borrow<u128>(&arg3, v2),
                    fee_growth_inside_last_x  : v7,
                    fee_growth_inside_last_y  : v8,
                    reward_growth_inside_last : v9,
                    collected_fees_x          : 0,
                    collected_fees_y          : 0,
                };
                0x1::vector::insert<LBBinPosition>(&mut v5.bin_data, v21, (count_active_bins_before_position(v5.active_bins_bitmap, v11) as u64));
                v5.active_bins_bitmap = set_bit_in_bitmap(v5.active_bins_bitmap, v11);
                arg1.total_bin = arg1.total_bin + 1;
            };
            v2 = v2 + 1;
        };
    }
    ...
    public fun is_empty_reward(arg0: &LBPosition) : bool {
        let v0 = 0;
        let v1 = 0;
        while (v1 < 0x1::vector::length<u64>(&arg0.pending_rewards)) {
            v0 = v0 + *0x1::vector::borrow<u64>(&arg0.pending_rewards, v1);
        };
        v0 == 0
    }
    ...
    public(friend) fun mark_remove_liquidity(arg0: &mut LBPosition, arg1: &mut LBBinPosition, arg2: u128) {
        assert!(arg1.amount == arg2, 3);
        arg1.amount = 0;
        arg0.total_bin = arg0.total_bin - 1;
    }
    ...
    public(friend) fun open_position<T0, T1>(arg0: &mut LBPositionManager, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : LBPosition {
        ...
        let v1 = LBPosition{
            ...
            total_bin       : 0,
            pending_rewards : 0x1::vector::empty<u64>(),
    ...
    public(friend) fun remove_bin(arg0: &mut LBPositionInfo, arg1: u32) : bool {
    ...
    public(friend) fun remove_liquidity(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.total_bin == 0, 7);
        let v0 = 0x2::table::remove<0x2::object::ID, LBPositionInfo>(&mut arg0.positions, arg1.my_id);
        let v1 = LBPositionInfo{
            position_id : v0.position_id,
            pair_id     : v0.pair_id,
            bins        : 0x2::table::new<u32, PackedBins>(arg2),
        };
        destroy_position_info(v0);
        0x2::table::add<0x2::object::ID, LBPositionInfo>(&mut arg0.positions, arg1.my_id, v1);
    }

    public(friend) fun reset_saved_pending_rewards(arg0: &mut LBPosition, arg1: u64) : u64 {
        if (arg1 >= 0x1::vector::length<u64>(&arg0.pending_rewards)) {
            return 0
        };
        *0x1::vector::borrow_mut<u64>(&mut arg0.pending_rewards, arg1) = 0;
        *0x1::vector::borrow<u64>(&arg0.pending_rewards, arg1)
    }
    ...
    public(friend) fun save_pending_rewards_pos(arg0: &mut LBPosition, arg1: u64, arg2: u64) {
        if (arg2 > 0) {
            while (0x1::vector::length<u64>(&arg0.pending_rewards) <= arg1) {
                0x1::vector::push_back<u64>(&mut arg0.pending_rewards, 0);
            };
            *0x1::vector::borrow_mut<u64>(&mut arg0.pending_rewards, arg1) = 0x850a6afa042072fc37c8d70bb5ddee98aab0a93bfe50ab024de2719d3f6e6ff5::safe_math::add_u64(*0x1::vector::borrow<u64>(&arg0.pending_rewards, arg1), arg2);
        };
    }
