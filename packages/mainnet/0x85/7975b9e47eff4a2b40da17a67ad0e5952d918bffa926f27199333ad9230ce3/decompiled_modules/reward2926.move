module 0x857975b9e47eff4a2b40da17a67ad0e5952d918bffa926f27199333ad9230ce3::reward2926 {
    struct REWARD2926 has drop {
        dummy_field: bool,
    }

    struct TICKET_2926 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2926(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2926>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2926>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2926, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2926>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2926>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2926>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2926>>(v5, 0x2::tx_context::sender(arg1));
    }
