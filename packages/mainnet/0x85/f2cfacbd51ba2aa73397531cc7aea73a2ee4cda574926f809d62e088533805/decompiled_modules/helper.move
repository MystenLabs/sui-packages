module 0x85f2cfacbd51ba2aa73397531cc7aea73a2ee4cda574926f809d62e088533805::helper {
    public(friend) fun apply_slippage(arg0: u64, arg1: u64) : u64 {
        if (arg0 == 0) {
            return 0
        };
        arg0 + 0x85f2cfacbd51ba2aa73397531cc7aea73a2ee4cda574926f809d62e088533805::math::mul(arg0, arg1)
    }
    ...
    public(friend) fun calculate_order_amount(arg0: u64, arg1: u64, arg2: bool) : u64 {
        if (arg2) {
            0x85f2cfacbd51ba2aa73397531cc7aea73a2ee4cda574926f809d62e088533805::math::mul(arg0, arg1)
        } else {
            arg0
        }
    }
    ...
    public(friend) fun get_sui_per_deep<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        assert!(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::whitelisted<T0, T1>(arg0) && 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::registered_pool<T0, T1>(arg0), 9223372590905622530);
        ...
        assert!(v0 == v2 && v1 == v3 || v0 == v3 && v1 == v2, 9223372642445230082);
        if (v0 == v2) {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::mid_price<T0, T1>(arg0, arg1)
        } else {
            0x85f2cfacbd51ba2aa73397531cc7aea73a2ee4cda574926f809d62e088533805::math::div(1000000000, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::mid_price<T0, T1>(arg0, arg1))
        }
    }
