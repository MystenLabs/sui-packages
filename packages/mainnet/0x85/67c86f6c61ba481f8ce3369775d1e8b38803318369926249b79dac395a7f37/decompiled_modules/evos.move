module 0x169664f0f62bec3d59bb621d84df69927b3377a1f32ff16c862d28c158480065::evos {
    ...
    public fun get_attribute(arg0: &Evos, arg1: vector<u8>) : 0x1::ascii::String {
        let v0 = 0x1::ascii::string(arg1);
        *0x2::vec_map::get<0x1::ascii::String, 0x1::ascii::String>(0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::attributes::get_attributes(&arg0.attributes), &v0)
    }
    ...
    fun new_kiosk_with_evos(arg0: 0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::Witness<Evos>, arg1: &mut Incubator, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v1;
        0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::deposit<Evos>(&mut v3, v0, arg3);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v3);
        register_new_evos(arg1, 0x2::object::id<Evos>(&v0));
    }
