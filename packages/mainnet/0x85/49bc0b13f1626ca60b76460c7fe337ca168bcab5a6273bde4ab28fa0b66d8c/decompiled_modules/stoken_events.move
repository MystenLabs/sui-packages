module 0x8549bc0b13f1626ca60b76460c7fe337ca168bcab5a6273bde4ab28fa0b66d8c::stoken_events {
    ...
    struct ProxyFundsReceived has copy, drop {
        proxy_id: 0x2::object::ID,
        amount: u64,
        timestamp_ms: u64,
    }
    ...
    struct ProxyManagerChangeCancelled has copy, drop {
        proxy_id: 0x2::object::ID,
        cancelled_manager: address,
        timestamp_ms: u64,
    }

    struct ProxyProcessorChangeCancelled has copy, drop {
        proxy_id: 0x2::object::ID,
        cancelled_processor: address,
        timestamp_ms: u64,
    }

    struct ProxyLimitsChangeCancelled has copy, drop {
        proxy_id: 0x2::object::ID,
        timestamp_ms: u64,
    }
    ...
    public fun emit_proxy_funds_received(arg0: 0x2::object::ID, arg1: u64, arg2: u64) {
        let v0 = ProxyFundsReceived{
            proxy_id     : arg0,
            amount       : arg1,
            timestamp_ms : arg2,
        };
        0x2::event::emit<ProxyFundsReceived>(v0);
    }
    ...
    public fun emit_proxy_limits_change_cancelled(arg0: 0x2::object::ID, arg1: u64) {
        let v0 = ProxyLimitsChangeCancelled{
            proxy_id     : arg0,
            timestamp_ms : arg1,
        };
        0x2::event::emit<ProxyLimitsChangeCancelled>(v0);
    }
    ...
    public fun emit_proxy_manager_change_cancelled(arg0: 0x2::object::ID, arg1: address, arg2: u64) {
        let v0 = ProxyManagerChangeCancelled{
            proxy_id          : arg0,
            cancelled_manager : arg1,
            timestamp_ms      : arg2,
        };
        0x2::event::emit<ProxyManagerChangeCancelled>(v0);
    }
    ...
    public fun emit_proxy_processor_change_cancelled(arg0: 0x2::object::ID, arg1: address, arg2: u64) {
        let v0 = ProxyProcessorChangeCancelled{
            proxy_id            : arg0,
            cancelled_processor : arg1,
            timestamp_ms        : arg2,
        };
        0x2::event::emit<ProxyProcessorChangeCancelled>(v0);
    }
