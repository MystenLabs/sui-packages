module 0x8549bc0b13f1626ca60b76460c7fe337ca168bcab5a6273bde4ab28fa0b66d8c::stoken_math {
    ...
    public fun apply_fee(arg0: u64, arg1: u64) : (u64, u64) {
        ...
        let v1 = v0 / (10000 as u128);
        let v2 = v0 % (10000 as u128);
        let v3 = (10000 as u128) / 2;
        let v4 = if (v2 > v3) {
            v1 + 1
        } else if (v2 < v3) {
            v1
    ...
    public fun min_fee_threshold() : u64 {
        1
    }
