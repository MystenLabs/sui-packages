module 0x85a0a46ca4aa3f5d11a59f8f0e0065d20d41c6a7dc615d975c52173738a87b2b::tonminer {
    ...
    fun init(arg0: TONMINER, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<TONMINER>(arg0, 9, b"TONMINER", b"Tonminer Token", b"Tonminer Token is a digital asset built on sui blockchain", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://tonminer.co/logo.png")), arg1);
