module 0x852b51cffa4f5ac5c95e13118c4f025cba1522f7922cca580f00574fd2e0ff45::ATM {
    struct ATM has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ATM, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ATM>(arg0, 4, b"ATM", b"ATM", b"ATM is the Core Engine of Autonomous Finance", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://lxtry1211.s3.us-west-1.amazonaws.com/dac_token.png")), arg1);
