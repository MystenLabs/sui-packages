module 0x8573251286b155b71a1b44ee4da43b9e342b24c19eef2a0434a19c22adab9c03::equity {
    ...
    public fun borrow_treasury_cap<T0>(arg0: &EquityTreasury<T0>) : &0x2::coin::TreasuryCap<T0> {
        &arg0.cap
    }

    public fun calc_balance_redeem_for_amount<T0>(arg0: &EquityRegistry<T0>, arg1: u64) : (u64, u64) {
        let v0 = (0x8573251286b155b71a1b44ee4da43b9e342b24c19eef2a0434a19c22adab9c03::util::muldiv_round_up_u128((arg1 as u128), arg0.supply_x64, arg0.underlying_value_x64) as u64);
    ...
    public fun calc_redeem_for_amount<T0>(arg0: &EquityRegistry<T0>, arg1: u64) : u128 {
        0x8573251286b155b71a1b44ee4da43b9e342b24c19eef2a0434a19c22adab9c03::util::muldiv_round_up_u128((arg1 as u128) * 18446744073709551616, arg0.supply_x64, arg0.underlying_value_x64)
    }

    public fun calc_redeem_for_amount_x64<T0>(arg0: &EquityRegistry<T0>, arg1: u128) : (u128, u128) {
        let v0 = 0x8573251286b155b71a1b44ee4da43b9e342b24c19eef2a0434a19c22adab9c03::util::muldiv_round_up_u128(arg1, arg0.supply_x64, arg0.underlying_value_x64);
    ...
    public fun calc_redeem_x64<T0>(arg0: &EquityRegistry<T0>, arg1: u128) : u128 {
        0x8573251286b155b71a1b44ee4da43b9e342b24c19eef2a0434a19c22adab9c03::util::muldiv_u128(arg0.underlying_value_x64, arg1, arg0.supply_x64)
    }
    ...
    public fun create_registry_with_cap<T0: drop>(arg0: &0x2::coin::TreasuryCap<T0>) : EquityRegistry<T0> {
        EquityRegistry<T0>{
            supply_x64           : 0,
            underlying_value_x64 : 0,
        }
    ...
    public fun increase_value_and_issue_x64<T0>(arg0: &mut EquityRegistry<T0>, arg1: u128) : EquityShareBalance<T0> {
        ...
        let v0 = 0x8573251286b155b71a1b44ee4da43b9e342b24c19eef2a0434a19c22adab9c03::util::muldiv_u128(arg0.supply_x64, arg1, arg0.underlying_value_x64);
        arg0.underlying_value_x64 = arg0.underlying_value_x64 + arg1;
    ...
    public fun redeem_x64<T0>(arg0: &mut EquityRegistry<T0>, arg1: EquityShareBalance<T0>) : u128 {
        let EquityShareBalance { value_x64: v0 } = arg1;
        let v1 = 0x8573251286b155b71a1b44ee4da43b9e342b24c19eef2a0434a19c22adab9c03::util::muldiv_u128(arg0.underlying_value_x64, v0, arg0.supply_x64);
