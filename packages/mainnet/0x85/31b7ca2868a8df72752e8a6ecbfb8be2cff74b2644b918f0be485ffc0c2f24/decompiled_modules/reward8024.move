module 0x8531b7ca2868a8df72752e8a6ecbfb8be2cff74b2644b918f0be485ffc0c2f24::reward8024 {
    struct REWARD8024 has drop {
        dummy_field: bool,
    }

    struct TICKET_8024 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8024(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8024>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8024>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8024, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8024>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8024>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8024>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8024>>(v5, 0x2::tx_context::sender(arg1));
    }
