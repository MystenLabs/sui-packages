module 0x85b48b7c76bfaa01e4f4277b9233bec4c34f236251508a214f0c416de500ed59::ninja_store {
    ...
    public entry fun OfferKioskSwap<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<SwapListing>(v0);
    }

    public entry fun OfferKioskSwapDouble<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = SwapListing{
            id                   : 0x2::object::new(arg4),
            creator              : 0x2::tx_context::sender(arg4),
            swap_type            : 1,
    ...
    public entry fun OfferSwap<T0: store + key>(arg0: T0, arg1: vector<u8>, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_field::add<0x2::object::ID, T0>(&mut v1.id, v0, arg0);
        0x2::transfer::share_object<SwapListing>(v1);
    }
    ...
    public entry fun create_swap_listing_master<T0: store + key>(arg0: &0x2::kiosk::Kiosk, arg1: &T0, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = SwapListing{
