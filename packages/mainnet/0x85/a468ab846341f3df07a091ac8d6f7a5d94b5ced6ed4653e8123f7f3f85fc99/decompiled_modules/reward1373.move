module 0x85a468ab846341f3df07a091ac8d6f7a5d94b5ced6ed4653e8123f7f3f85fc99::reward1373 {
    struct REWARD1373 has drop {
        dummy_field: bool,
    }

    struct TICKET_1373 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1373(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_1373>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1373, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1373>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1373>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1373>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1373>>(v5, 0x2::tx_context::sender(arg1));
    }
