module 0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::config {
    ...
    public fun update_mist_required_per_order(arg0: &0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::admin::AdminCap, arg1: &mut Config, arg2: u64) {
        assert_interacting_with_most_up_to_date_package(arg1);
        arg1.mist_required_per_order = arg2;
    }

    public fun update_total_protocol_fee_bps(arg0: &0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::admin::AdminCap, arg1: &mut Config, arg2: u128) {
        assert_interacting_with_most_up_to_date_package(arg1);
        assert!(arg2 <= 1000, 9223372784179478535);
        arg1.total_protocol_fee_bps = arg2;
    }

    public fun update_treasury_fee_bps(arg0: &0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::admin::AdminCap, arg1: &mut Config, arg2: u128) {
        assert_interacting_with_most_up_to_date_package(arg1);
        assert!(arg2 <= 10000, 9223372852899086345);
        arg1.treasury_fee_bps = arg2;
    }

    public fun upgrade_version(arg0: &0x4f3d909cef5abe4fd4a39d58293acbb250cb0700a23bed27e853be2e9cada7da::admin::AdminCap, arg1: &mut Config) {
