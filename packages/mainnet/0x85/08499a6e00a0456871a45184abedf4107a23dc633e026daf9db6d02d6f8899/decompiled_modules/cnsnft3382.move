module 0x8508499a6e00a0456871a45184abedf4107a23dc633e026daf9db6d02d6f8899::cnsnft3382 {
    struct CNSNFT3382 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3382, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4908"));
        let v4 = 0x2::package::claim<CNSNFT3382>(arg0, arg1);
