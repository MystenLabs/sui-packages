module 0x85a042c75abf5c0fd8049d0045c8aa03edc2de71ef93aa646a900427352cc479::guild {
    ...
    public fun subscribe<T0>(arg0: &Config, arg1: &mut UserArchive, arg2: &mut FeePool<T0>, arg3: u16, arg4: vector<u8>, arg5: vector<u8>, arg6: 0x2::coin::Coin<T0>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 6005);
        assert!(!arg0.paused, 6004);
        verify_signature(arg4, arg5, &arg0.validator);
        let v0 = 0x2::tx_context::sender(arg8);
        ...
        assert!(0x2::clock::timestamp_ms(arg7) < 0x2::bcs::peel_u64(&mut v1), 6003);
        0x2::balance::join<T0>(&mut arg2.balance, 0x2::coin::into_balance<T0>(arg6));
