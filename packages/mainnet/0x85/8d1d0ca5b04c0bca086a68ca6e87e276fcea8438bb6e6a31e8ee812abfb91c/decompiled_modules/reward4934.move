module 0x858d1d0ca5b04c0bca086a68ca6e87e276fcea8438bb6e6a31e8ee812abfb91c::reward4934 {
    struct REWARD4934 has drop {
        dummy_field: bool,
    }

    struct TICKET_4934 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4934(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4934>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4934>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4934, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4934>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4934>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4934>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4934>>(v5, 0x2::tx_context::sender(arg1));
    }
