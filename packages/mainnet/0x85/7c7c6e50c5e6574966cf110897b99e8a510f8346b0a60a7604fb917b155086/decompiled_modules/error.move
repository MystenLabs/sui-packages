module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error {
    ...
    public(friend) fun exceeds_follower_max_cap() : u64 {
        2046
    }
    ...
    public(friend) fun follower_max_cap_not_above_min_deposit() : u64 {
        2047
    }
    ...
    public(friend) fun invalid_price_feed_data() : u64 {
        909
    }

    public(friend) fun invalid_price_feed_signature() : u64 {
        908
    }

    public(friend) fun invalid_price_feeder() : u64 {
        910
    }
    ...
    public(friend) fun price_feed_registry_perp_mismatch() : u64 {
        914
    }

    public(friend) fun price_feed_timestamp_in_future() : u64 {
        912
    }

    public(friend) fun price_feed_timestamp_not_monotonic() : u64 {
        915
    }

    public(friend) fun price_feed_timestamp_too_stale() : u64 {
        913
    }
