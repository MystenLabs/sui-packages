module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::vault {
    ...
    fun create_vault_internal<T0>(arg0: &0x2::clock::Clock, arg1: &mut VaultConfig, arg2: &mut 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::sub_accounts::SubAccounts, arg3: &mut 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::bank::Bank<T0>, arg4: address, arg5: 0x1::string::String, arg6: address, arg7: u128, arg8: u128, arg9: u128, arg10: u128, arg11: u128, arg12: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        assert!(arg10 <= 500000000, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::invalid_ratio());
    ...
    fun deposit_internal<T0>(arg0: &mut 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::bank::Bank<T0>, arg1: &mut Vault<T0>, arg2: u128, arg3: u128, arg4: &0x2::tx_context::TxContext) : (u128, u128) {
        ...
        let v1 = v0 == arg1.creator;
        let v2 = arg1.total_shares == 0;
        if (v2) {
            assert!(v1, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::vault_creator_must_deposit_first());
        };
        if (!v1) {
        ...
        let v3 = arg1.last_share_price;
        let v4 = 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_div(arg3, v3);
        assert!(v4 > 0, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::can_not_be_zero());
        if (v2) {
            assert!(v4 >= 1000000000, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::vault_creator_locked_shares_insufficient());
        };
        let v5 = 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul(arg1.total_shares + v4, v3);
        assert!(v5 <= arg1.max_cap, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::exceeds_vault_max_cap());
        if (!v1) {
            let v6 = if (0x2::table::contains<address, Position>(&arg1.user_positions, v0)) {
                0x2::table::borrow<address, Position>(&arg1.user_positions, v0).shares
            } else {
                0
            };
            assert!(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul(v6 + v4, v3) <= effective_follower_max_cap<T0>(arg1), 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::exceeds_follower_max_cap());
        };
        arg1.total_shares = arg1.total_shares + v4;
    ...
    public fun set_follower_max_cap<T0>(arg0: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::ProtocolConfig, arg1: &VaultConfig, arg2: &mut Vault<T0>, arg3: u128, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::can_not_be_zero());
        assert!(v0 > arg2.min_deposit_amount, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::follower_max_cap_not_above_min_deposit());
        assert!(v0 <= arg2.max_cap, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::exceeds_vault_max_cap());
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg2.id, b"vault_extension")) {
            let v1 = 0x2::dynamic_field::borrow_mut<vector<u8>, VaultExtension>(&mut arg2.id, b"vault_extension");
            assert!(v0 != v1.follower_max_cap, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::invalid_status());
            v1.follower_max_cap = v0;
        } else {
            let v2 = VaultExtension{follower_max_cap: v0};
            0x2::dynamic_field::add<vector<u8>, VaultExtension>(&mut arg2.id, b"vault_extension", v2);
        };
        let v3 = VaultFollowerMaxCapUpdateEvent{
            vault_id         : 0x2::object::uid_to_inner(&arg2.id),
            follower_max_cap : v0,
        };
        0x2::event::emit<VaultFollowerMaxCapUpdateEvent>(v3);
    }
