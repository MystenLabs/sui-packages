module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128 {
    ...
    public(friend) fun div_u128(arg0: S128, arg1: u128) : S128 {
        from(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_div(arg0.value, arg1), arg0.sign)
    }
    ...
    public(friend) fun mul_u128(arg0: S128, arg1: u128) : S128 {
        from(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul(arg0.value, arg1), arg0.sign)
    }

    public(friend) fun mul_u128_up(arg0: S128, arg1: u128) : S128 {
        from(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul_up(arg0.value, arg1), arg0.sign)
    }

    public(friend) fun negate(arg0: S128) : S128 {
        from(arg0.value, !arg0.sign)
    }
    ...
    fun normalize_zero(arg0: &mut S128) {
        if (arg0.value == 0) {
            arg0.sign = true;
        };
    }
