module 0x7dab89563066afa000ee154738aac2cc8e7d3e26cd0b470183db63630ee9f965::funding_vault {
    ...
    public fun borrow_deepbook_balance_manager(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) : (0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeCap, BalanceManagerIdentity) {
        ...
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_version(arg0, 2);
    ...
    entry fun decrease_fund<T0>(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<u64>(v6, 0x2::coin::value<T0>(&v4));
        let v7 = DecreaseFundEvent{
            token : v0,
            log   : v5,
        };
        0x2::event::emit<DecreaseFundEvent>(v7);
    ...
    entry fun deposit_fund_to_deepbook_balance_manager<T0>(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.vault_registry, arg2);
        let v2 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, v0);
        ...
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_version(arg0, 2);
        assert!(v1.token == v0, invalid_token());
        if (0x2::balance::value<T0>(v2) <= *0x1::vector::borrow<u64>(&v1.info, 2) + *0x1::vector::borrow<u64>(&v1.config, 9)) {
            return
        };
        let v4 = 0x1::u64::min(0x1::option::destroy_with_default<u64>(arg3, 0x2::balance::value<T0>(v2)), 0x2::balance::value<T0>(v2) - *0x1::vector::borrow<u64>(&v1.info, 2) - *0x1::vector::borrow<u64>(&v1.config, 9));
        let v5 = 0x1::vector::empty<u64>();
        let v6 = &mut v5;
        0x1::vector::push_back<u64>(v6, arg2);
        0x1::vector::push_back<u64>(v6, v4);
        let v7 = DepositFundToDeepbookBalanceManagerEvent{
            token : v0,
            log   : v5,
        };
        0x2::event::emit<DepositFundToDeepbookBalanceManagerEvent>(v7);
        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::deposit<T0>(0x2::dynamic_object_field::borrow_mut<0x1::string::String, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager>(&mut v1.id, 0x1::string::utf8(b"deepbook_balance_manager")), 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v2, v4), arg4), arg4);
    }

    entry fun deposit_fund_to_scallop_basic_lending<T0>(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.vault_registry, arg2);
        let v2 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, v0);
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_authority(arg0, arg7);
        ...
        if (!0x2::dynamic_field::exists_<0x1::string::String>(&v1.id, 0x1::string::utf8(b"scallop_market_coin"))) {
            0x2::dynamic_field::add<0x1::string::String, 0x2::coin::Coin<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&mut v1.id, 0x1::string::utf8(b"scallop_market_coin"), 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::mint::mint<T0>(arg4, arg5, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v2, 0x1::u64::min(0x1::option::destroy_with_default<u64>(arg3, 0x2::balance::value<T0>(v2)), 0x2::balance::value<T0>(v2) - *0x1::vector::borrow<u64>(&v1.info, 2) - *0x1::vector::borrow<u64>(&v1.config, 9))), arg7), arg6, arg7));
        } else {
            0x2::coin::join<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::Coin<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&mut v1.id, 0x1::string::utf8(b"scallop_market_coin")), 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::mint::mint<T0>(arg4, arg5, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v2, 0x1::u64::min(0x1::option::destroy_with_default<u64>(arg3, 0x2::balance::value<T0>(v2)), 0x2::balance::value<T0>(v2) - *0x1::vector::borrow<u64>(&v1.info, 2) - *0x1::vector::borrow<u64>(&v1.config, 9))), arg7), arg6, arg7));
        };
    }
    ...
    entry fun deposit_to_deepbook_balance_manager<T0>(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<u64>(v4, 0x2::coin::value<T0>(&arg3));
        let v5 = DepositToDeepbookBalanceManagerEvent{
            token : v0,
            log   : v3,
        };
        0x2::event::emit<DepositToDeepbookBalanceManagerEvent>(v5);
    ...
    entry fun increase_fund<T0>(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<u64>(v4, arg2);
        0x1::vector::push_back<u64>(v4, 0x2::coin::value<T0>(&arg3));
        let v5 = IncreaseFundEvent{
            token : v0,
            log   : v3,
        };
        0x2::event::emit<IncreaseFundEvent>(v5);
    ...
    fun raise_fund_<T0>(arg0: &mut Registry, arg1: u64, arg2: address, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock) {
        ...
        let v5 = RaiseFundEvent{
            token : v0,
            user  : arg2,
            log   : v3,
        };
        0x2::event::emit<RaiseFundEvent>(v5);
        ...
        0x1::vector::push_back<Fund>(0x2::table::borrow_mut<address, vector<Fund>>(&mut v1.fund, arg2), v6);
    ...
    fun reduce_fund_<T0>(arg0: &mut 0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: address, arg4: u64, arg5: bool, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        if (v2 >= *0x1::vector::borrow<u64>(&v1.config, 1)) {
            ...
            let v18 = &mut v17;
            0x1::vector::push_back<u64>(v18, arg2);
        ...
        if (arg4 > 0 && *0x1::vector::borrow<u64>(&v1.config, 6) > 0) {
            if (0x2::table::contains<address, vector<Fund>>(&v1.fund, arg3)) {
        ...
        let v30 = &mut v29;
        0x1::vector::push_back<u64>(v30, arg2);
    ...
    entry fun withdraw_from_deepbook_balance_manager<T0>(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<u64>(v7, 0x2::coin::value<T0>(&v5));
        let v8 = WithdrawFromDeepbookBalanceManagerEvent{
            token : v0,
            log   : v6,
        };
        0x2::event::emit<WithdrawFromDeepbookBalanceManagerEvent>(v8);
    ...
    entry fun withdraw_fund_from_deepbook_balance_manager<T0>(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<u64>(v7, arg2);
        0x1::vector::push_back<u64>(v7, 0x2::coin::value<T0>(&v5));
        let v8 = WithdrawFundFromDeepbookBalanceManagerEvent{
            token : v0,
            log   : v6,
        };
        0x2::event::emit<WithdrawFundFromDeepbookBalanceManagerEvent>(v8);
    ...
    entry fun withdraw_fund_from_scallop_basic_lending<T0>(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.vault_registry, arg2);
        let v2 = 0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::Coin<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&mut v1.id, 0x1::string::utf8(b"scallop_market_coin"));
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_authority(arg0, arg7);
        let v3 = VERSION{dummy_field: false};
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_witness<VERSION>(arg0, v3);
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_version(arg0, 2);
        assert!(v1.token == v0, invalid_token());
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, v0), 0x2::coin::into_balance<T0>(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::redeem::redeem<T0>(arg4, arg5, 0x2::coin::split<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(v2, 0x1::option::destroy_with_default<u64>(arg3, 0x2::coin::value<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(v2)), arg7), arg6, arg7)));
    }
