module 0x856fe354ed8bada41be769e686af143d3fa07987294c91377b8afdda6e504546::package_utils {
    ...
    public fun authorize_upgrade(arg0: &mut 0x2::object::UID, arg1: &mut 0x2::package::UpgradeCap, arg2: 0x856fe354ed8bada41be769e686af143d3fa07987294c91377b8afdda6e504546::bytes32::Bytes32) : 0x2::package::UpgradeTicket {
        set_authorized_digest(arg0, arg2);
        0x2::package::authorize_upgrade(arg1, 0x2::package::upgrade_policy(arg1), 0x856fe354ed8bada41be769e686af143d3fa07987294c91377b8afdda6e504546::bytes32::to_bytes(arg2))
    }
    ...
    public fun assert_package_upgrade_cap<T0>(arg0: &0x2::package::UpgradeCap, arg1: u8, arg2: u64) {
        ...
        let v2 = if (0x2::object::id_to_address(&v1) == 0x2::address::from_bytes(0x2::hex::decode(0x1::ascii::into_bytes(0x1::type_name::get_address(&v0))))) {
            if (0x2::package::upgrade_policy(arg0) == arg1) {
                0x2::package::version(arg0) == arg2
            } else {
                false
            }
        } else {
    ...
    public fun authorized_digest(arg0: &0x2::object::UID) : 0x856fe354ed8bada41be769e686af143d3fa07987294c91377b8afdda6e504546::bytes32::Bytes32 {
    ...
    public fun current_digest(arg0: &0x2::object::UID) : 0x856fe354ed8bada41be769e686af143d3fa07987294c91377b8afdda6e504546::bytes32::Bytes32 {
    ...
    public fun init_package_info<T0: store>(arg0: &mut 0x2::object::UID, arg1: T0, arg2: &0x2::package::UpgradeCap) {
        ...
        let v2 = PackageInfo{
            package : v0,
            digest  : 0x856fe354ed8bada41be769e686af143d3fa07987294c91377b8afdda6e504546::bytes32::default(),
        };
    ...
    fun set_authorized_digest(arg0: &mut 0x2::object::UID, arg1: 0x856fe354ed8bada41be769e686af143d3fa07987294c91377b8afdda6e504546::bytes32::Bytes32) {
        let v0 = PendingPackage{dummy_field: false};
