module 0x85abba6ab1b54ffb4144dbf941b8c23d81d6384d19a45ffecfd1cf0538d4bdda::vault_stable {
    struct Vault has key {
        ...
        kusd_cap: 0x2::coin::TreasuryCap<0x85abba6ab1b54ffb4144dbf941b8c23d81d6384d19a45ffecfd1cf0538d4bdda::kusd::KUSD>,
    ...
    fun can_end_epoch(arg0: &Vault, arg1: &0x2::clock::Clock) : bool {
        arg0.current_epoch == 0 || 0x2::clock::timestamp_ms(arg1) >= 0x2::table::borrow<u64, EpochData>(&arg0.epoch_history, arg0.current_epoch - 1).timestamp + arg0.epoch_duration_ms
    }
    ...
    public entry fun claim_and_transfer_kusd(arg0: &mut Vault, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x85abba6ab1b54ffb4144dbf941b8c23d81d6384d19a45ffecfd1cf0538d4bdda::kusd::KUSD>>(v0, 0x2::tx_context::sender(arg1));
    }
    ...
    public fun claim_kusd(arg0: &mut Vault, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x85abba6ab1b54ffb4144dbf941b8c23d81d6384d19a45ffecfd1cf0538d4bdda::kusd::KUSD> {
        assert!(arg0.version == 1, 1010);
        ...
        0x2::coin::mint<0x85abba6ab1b54ffb4144dbf941b8c23d81d6384d19a45ffecfd1cf0538d4bdda::kusd::KUSD>(&mut arg0.kusd_cap, v1, arg1)
    }
    ...
    public fun end_epoch(arg0: &mut Vault, arg1: &OperatorCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC> {
        assert!(arg0.version == 1, 1010);
        assert!(!arg0.paused, 1006);
        assert!(can_end_epoch(arg0, arg2), 1016);
    ...
    fun init_vault(arg0: 0x2::coin::TreasuryCap<0x85abba6ab1b54ffb4144dbf941b8c23d81d6384d19a45ffecfd1cf0538d4bdda::kusd::KUSD>, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Vault {
        Vault{
            ...
            epoch_history               : 0x2::table::new<u64, EpochData>(arg4),
            deposit_requests            : 0x2::table::new<address, 0x2::linked_table::LinkedTable<u64, DepositRequest>>(arg4),
            withdraw_requests           : 0x2::table::new<address, 0x2::linked_table::LinkedTable<u64, WithdrawRequest>>(arg4),
            kusd_cap                    : arg0,
    ...
    public entry fun operator_init_vault(arg0: 0x2::coin::TreasuryCap<0x85abba6ab1b54ffb4144dbf941b8c23d81d6384d19a45ffecfd1cf0538d4bdda::kusd::KUSD>, arg1: &OperatorCap, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Vault>(init_vault(arg0, arg2, arg3, arg4, arg5));
    }
    ...
    public entry fun request_withdraw(arg0: &mut Vault, arg1: 0x2::coin::Coin<0x85abba6ab1b54ffb4144dbf941b8c23d81d6384d19a45ffecfd1cf0538d4bdda::kusd::KUSD>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 1010);
        assert!(!arg0.paused, 1006);
        let v0 = 0x2::coin::value<0x85abba6ab1b54ffb4144dbf941b8c23d81d6384d19a45ffecfd1cf0538d4bdda::kusd::KUSD>(&arg1);
        assert!(v0 > 0, 1004);
        assert!(arg0.total_kusd > 0, 1005);
        let v1 = 0x2::tx_context::sender(arg2);
        arg0.total_pending_burned_kusd = arg0.total_pending_burned_kusd + v0;
        0x2::coin::burn<0x85abba6ab1b54ffb4144dbf941b8c23d81d6384d19a45ffecfd1cf0538d4bdda::kusd::KUSD>(&mut arg0.kusd_cap, arg1);
    ...
    public entry fun update_epoch_duration_ms(arg0: &mut Vault, arg1: &OperatorCap, arg2: u64) {
        assert!(arg0.version == 1, 1010);
        arg0.epoch_duration_ms = arg2;
    }
