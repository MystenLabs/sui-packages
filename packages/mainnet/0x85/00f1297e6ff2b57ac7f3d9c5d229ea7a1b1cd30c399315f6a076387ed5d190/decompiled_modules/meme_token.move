module 0x8500f1297e6ff2b57ac7f3d9c5d229ea7a1b1cd30c399315f6a076387ed5d190::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"MG", b"MisterG", b"a real g", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-13T08-16-56.994Z-Scherm%C3%82%C2%ADafbeelding%202025-09-05%20om%2006.36.16.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"MisterG"),
            symbol     : 0x1::string::utf8(b"MG"),
            decimals   : 9,
