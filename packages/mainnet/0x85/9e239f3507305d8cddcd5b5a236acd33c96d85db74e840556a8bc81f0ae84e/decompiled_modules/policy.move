module 0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::policy {
    ...
    fun assert_agent_gates(arg0: &Policy, arg1: &0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::Vault, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.agent, 13906835849380626433);
        assert!(!arg0.suspended, 13906835853675724803);
        assert!(0x2::object::id<0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::Vault>(arg1) == arg0.vault_id, 13906835857970823173);
    }
    ...
    fun assert_binding(arg0: &Policy, arg1: &0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::OwnerCap) {
        assert!(0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::owner_cap_vault_id(arg1) == arg0.vault_id, 13906836072719319047);
    }
    ...
    fun assert_within_bps(arg0: u128, arg1: u128, arg2: u64) {
        ...
        assert!(v2 * 10000 <= v0 * (arg2 as u256), 13906836021179973643);
    }
