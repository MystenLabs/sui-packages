module 0x85f0afd0dffbcfc56b66808b0c713f4b6dc704402ac7e52bf538efb39c692a11::token21 {
    ...
    fun init(arg0: TOKEN21, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN21>(arg0, 9, b"li.fi", b"li.fi", b"", 0x1::option::none<0x2::url::Url>(), arg1);
