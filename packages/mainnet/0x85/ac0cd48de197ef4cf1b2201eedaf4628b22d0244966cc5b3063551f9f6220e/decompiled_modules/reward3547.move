module 0x85ac0cd48de197ef4cf1b2201eedaf4628b22d0244966cc5b3063551f9f6220e::reward3547 {
    struct REWARD3547 has drop {
        dummy_field: bool,
    }

    struct TICKET_3547 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3547(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3547>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3547>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3547, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3547>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3547>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3547>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3547>>(v5, 0x2::tx_context::sender(arg1));
    }
