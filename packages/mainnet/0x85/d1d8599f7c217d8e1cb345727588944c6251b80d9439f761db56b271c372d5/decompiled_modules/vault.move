module 0x85d1d8599f7c217d8e1cb345727588944c6251b80d9439f761db56b271c372d5::vault {
    ...
    public fun create_vault<T0>(arg0: &0x85d1d8599f7c217d8e1cb345727588944c6251b80d9439f761db56b271c372d5::admin::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
    ...
    public fun deposit<T0>(arg0: &0x85d1d8599f7c217d8e1cb345727588944c6251b80d9439f761db56b271c372d5::admin::AdminCap, arg1: &mut Vault<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun withdraw<T0>(arg0: &0x85d1d8599f7c217d8e1cb345727588944c6251b80d9439f761db56b271c372d5::admin::AdminCap, arg1: &mut Vault<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(coin_type<T0>(arg1) == 0x1::type_name::with_defining_ids<T0>(), 1);
