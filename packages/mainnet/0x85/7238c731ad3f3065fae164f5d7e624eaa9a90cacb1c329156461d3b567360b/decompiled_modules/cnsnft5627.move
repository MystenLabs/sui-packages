module 0x857238c731ad3f3065fae164f5d7e624eaa9a90cacb1c329156461d3b567360b::cnsnft5627 {
    struct CNSNFT5627 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5627, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5627>(arg0, arg1);
