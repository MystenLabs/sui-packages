module 0x858c5a5e26c108306b0b0c706145fde169f8895a101619ef2af2b107ebbea5d3::burnpepe {
    ...
    fun init(arg0: BURNPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BURNPEPE>(arg0, 9, b"BURNPEPE", b"Burn Pepe", b"join moonshot together x1000 is real https://t.me/burnpepeSUI", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/8gZC5e1.jpg")), arg1);
        let v2 = v0;
