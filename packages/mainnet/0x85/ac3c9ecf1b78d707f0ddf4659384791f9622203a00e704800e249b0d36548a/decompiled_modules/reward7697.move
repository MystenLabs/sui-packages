module 0x85ac3c9ecf1b78d707f0ddf4659384791f9622203a00e704800e249b0d36548a::reward7697 {
    struct REWARD7697 has drop {
        dummy_field: bool,
    }

    struct TICKET_7697 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7697(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7697>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7697>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7697, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7697>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7697>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7697>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7697>>(v5, 0x2::tx_context::sender(arg1));
    }
