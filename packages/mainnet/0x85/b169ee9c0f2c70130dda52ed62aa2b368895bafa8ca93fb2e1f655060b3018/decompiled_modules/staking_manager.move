module 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::staking_manager {
    struct StakingManager has key {
        ...
        stake_cap: u64,
        gr_supply: 0x2::balance::Supply<0x888f8588db58841c2f8e66b14f1dfb13609b41486ff85832818a29b7f8cf750e::coin_gr::COIN_GR>,
        gy_supply: 0x2::balance::Supply<0xd1722cef6092cfc9aaa2d5ea2aa402afde735786b3db93d9f051825a2abb8ee9::coin_gy::COIN_GY>,
    }
    ...
    public fun get_gr_total_supply(arg0: &StakingManager) : u64 {
        0x2::balance::supply_value<0x888f8588db58841c2f8e66b14f1dfb13609b41486ff85832818a29b7f8cf750e::coin_gr::COIN_GR>(&arg0.gr_supply)
    }

    public fun get_gy_total_supply(arg0: &StakingManager) : u64 {
        0x2::balance::supply_value<0xd1722cef6092cfc9aaa2d5ea2aa402afde735786b3db93d9f051825a2abb8ee9::coin_gy::COIN_GY>(&arg0.gy_supply)
    }
    ...
    public fun init_staking_manager(arg0: 0x2::coin::TreasuryCap<0x888f8588db58841c2f8e66b14f1dfb13609b41486ff85832818a29b7f8cf750e::coin_gr::COIN_GR>, arg1: 0x2::coin::TreasuryCap<0xd1722cef6092cfc9aaa2d5ea2aa402afde735786b3db93d9f051825a2abb8ee9::coin_gy::COIN_GY>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = StakingManager{
            ...
            stake_cap        : 0,
            gr_supply        : 0x888f8588db58841c2f8e66b14f1dfb13609b41486ff85832818a29b7f8cf750e::coin_gr::treasury_into_supply(arg0),
            gy_supply        : 0xd1722cef6092cfc9aaa2d5ea2aa402afde735786b3db93d9f051825a2abb8ee9::coin_gy::treasury_into_supply(arg1),
        };
    ...
    public(friend) fun owner_withdraw_xaum(arg0: &mut StakingManager, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x9d297676e7a4b771ab023291377b2adfaa4938fb9080b8d12430e4b108b836a9::xaum::XAUM> {
        assert!(0x2::balance::value<0x9d297676e7a4b771ab023291377b2adfaa4938fb9080b8d12430e4b108b836a9::xaum::XAUM>(&arg0.xaum_pool) >= arg1, 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::error::staking_pool_xaum_not_enough_error());
    ...
    public fun stake_xaum(arg0: &0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::version::Version, arg1: &mut StakingManager, arg2: 0x2::coin::Coin<0x9d297676e7a4b771ab023291377b2adfaa4938fb9080b8d12430e4b108b836a9::xaum::XAUM>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 >= 1000000, 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::error::staking_min_xaum_error());
        let v2 = 0x1::fixed_point32::multiply_u64(v1, arg1.stake_fee_rate);
        assert!(v1 > v2, 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::error::staking_fee_exceeds_amount_error());
        ...
        let v4 = v1 - v2;
        if (arg1.stake_cap > 0) {
            assert!(0x2::balance::value<0x9d297676e7a4b771ab023291377b2adfaa4938fb9080b8d12430e4b108b836a9::xaum::XAUM>(&arg1.xaum_pool) + v4 <= arg1.stake_cap, 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::error::staking_stake_cap_exceeded_error());
        };
        0x2::balance::join<0x9d297676e7a4b771ab023291377b2adfaa4938fb9080b8d12430e4b108b836a9::xaum::XAUM>(&mut arg1.xaum_pool, v3);
        let v5 = v4 * 100;
        let v6 = v4 * 100;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x888f8588db58841c2f8e66b14f1dfb13609b41486ff85832818a29b7f8cf750e::coin_gr::COIN_GR>>(0x888f8588db58841c2f8e66b14f1dfb13609b41486ff85832818a29b7f8cf750e::coin_gr::mint_from_supply(&mut arg1.gr_supply, v5, arg3), v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xd1722cef6092cfc9aaa2d5ea2aa402afde735786b3db93d9f051825a2abb8ee9::coin_gy::COIN_GY>>(0xd1722cef6092cfc9aaa2d5ea2aa402afde735786b3db93d9f051825a2abb8ee9::coin_gy::mint_from_supply(&mut arg1.gy_supply, v6, arg3), v0);
        let v7 = StakeEvent{
            user       : v0,
            xaum_gross : v1,
            xaum_fee   : v2,
    ...
    public fun unstake(arg0: &0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::version::Version, arg1: &mut StakingManager, arg2: 0x2::coin::Coin<0x888f8588db58841c2f8e66b14f1dfb13609b41486ff85832818a29b7f8cf750e::coin_gr::COIN_GR>, arg3: 0x2::coin::Coin<0xd1722cef6092cfc9aaa2d5ea2aa402afde735786b3db93d9f051825a2abb8ee9::coin_gy::COIN_GY>, arg4: &mut 0x2::tx_context::TxContext) {
        0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::version::assert_current_version(arg0);
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::coin::value<0x888f8588db58841c2f8e66b14f1dfb13609b41486ff85832818a29b7f8cf750e::coin_gr::COIN_GR>(&arg2);
        let v2 = 0x2::coin::value<0xd1722cef6092cfc9aaa2d5ea2aa402afde735786b3db93d9f051825a2abb8ee9::coin_gy::COIN_GY>(&arg3);
        assert!(v1 == v2, 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::error::staking_gr_gy_mismatch_error());
        assert!(v1 >= 1000000 * 100, 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::error::staking_insufficient_gr_gy_error());
        assert!(v1 % 100 == 0, 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::error::staking_gr_amount_not_divisible_error());
        let v3 = v1 / 100;
        assert!(0x2::balance::value<0x9d297676e7a4b771ab023291377b2adfaa4938fb9080b8d12430e4b108b836a9::xaum::XAUM>(&arg1.xaum_pool) >= v3, 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::error::staking_pool_xaum_not_enough_error());
        0x888f8588db58841c2f8e66b14f1dfb13609b41486ff85832818a29b7f8cf750e::coin_gr::burn_to_supply(&mut arg1.gr_supply, arg2);
        0xd1722cef6092cfc9aaa2d5ea2aa402afde735786b3db93d9f051825a2abb8ee9::coin_gy::burn_to_supply(&mut arg1.gy_supply, arg3);
        ...
        assert!(v3 > v5, 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::error::staking_fee_exceeds_amount_error());
        if (v5 > 0) {
    ...
    public(friend) fun update_stake_cap(arg0: &mut StakingManager, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::error::staking_not_admin_error());
        arg0.stake_cap = arg1;
    }

    public(friend) fun update_stake_fee(arg0: &mut StakingManager, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.admin, 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::error::staking_not_admin_error());
        assert!(arg2 > 0 && arg1 <= arg2, 0x85b169ee9c0f2c70130dda52ed62aa2b368895bafa8ca93fb2e1f655060b3018::error::staking_invalid_params_error());
