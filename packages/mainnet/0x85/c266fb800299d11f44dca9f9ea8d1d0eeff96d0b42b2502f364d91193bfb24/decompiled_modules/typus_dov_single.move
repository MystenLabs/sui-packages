module 0xa76499eda1d37751473de5f30e106f35943ada2f6ea764861243e7f5aa5bcc97::typus_dov_single {
    ...
    public(friend) entry fun claim<T0>(arg0: &mut Registry, arg1: &AdditionalConfigRegistry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        version_check(arg0);
        get_portfolio_step(arg1, arg2);
        let v0 = &mut arg0.deposit_vault_registry.id;
        let (v1, v2) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::claim<ManagerCap, T0>(&mut arg0.deposit_vault_registry.user_share_registry, get_mut_deposit_vault<T0>(v0, arg2), arg3);
        if (v1 == 0) {
            abort 22
        };
        let v3 = Claim<T0>{
    ...
    public(friend) fun compound<T0, T1>(arg0: &mut Registry, arg1: &AdditionalConfigRegistry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        get_portfolio_step(arg1, arg2);
        let v0 = &mut arg0.deposit_vault_registry.id;
        let v1 = get_mut_deposit_vault<T0>(v0, arg2);
        let v2 = &mut arg0.bid_vault_registry.id;
        let v3 = get_mut_bid_vault<T0>(v2, arg2);
        let v4 = &mut arg0.id;
        let v5 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::compound<ManagerCap, T0>(&mut arg0.deposit_vault_registry.user_share_registry, &mut arg0.bid_vault_registry.user_share_registry, v1, v3, get_mut_portfolio_vault<T0, T0, T1>(v4, arg2).config.lot_size, arg3);
        if (v5 == 0) {
            abort 22
        };
        ...
        calculate_in_usd<T0, T1>(arg1, arg2, get_portfolio_vault<T0, T0, T1>(&arg0.id, arg2).config.d_token_decimal, v5, false, arg3)
    }
    ...
    public(friend) entry fun harvest<T0>(arg0: &mut Registry, arg1: &AdditionalConfigRegistry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::harvest<ManagerCap, T0>(&mut arg0.bid_vault_registry.user_share_registry, get_mut_bid_vault<T0>(v0, arg2), arg3);
        if (v1 == 0) {
            abort 22
        };
        let v3 = Harvest<T0>{
    ...
    public(friend) fun unsubscribe<T0, T1, T2>(arg0: &mut Registry, arg1: &AdditionalConfigRegistry, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        get_portfolio_step(arg1, arg2);
        let v0 = &mut arg0.deposit_vault_registry.id;
        let v1 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::unsubscribe<ManagerCap, T0>(&mut arg0.deposit_vault_registry.user_share_registry, get_mut_deposit_vault<T0>(v0, arg2), arg3, arg4);
        if (v1 == 0) {
            abort 22
        };
