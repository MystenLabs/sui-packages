module 0xc46fdac1878aaac5e5b1e8dffee2d8f5357b398bec746036c7fd1b7100ad2f4c::trumpfam {
    ...
    fun init(arg0: TRUMPFAM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<TRUMPFAM>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TRUMPFAM")))), trim_right(b"Meet The Trump Family           "), trim_right(b"A family that takes a step into the future.                                                                                                                                                                                                                                                                                     "), v2, arg1);
        let v5 = v3;
