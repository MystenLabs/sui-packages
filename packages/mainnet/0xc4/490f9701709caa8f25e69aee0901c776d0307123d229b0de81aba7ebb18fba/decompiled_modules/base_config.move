module 0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::base_config {
    ...
    struct BaseConfig has store, key {
        id: 0x2::object::UID,
        acl: 0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::acl::ACL,
        package_version: u64,
    }
    ...
    public fun add_role(arg0: &AdminCap, arg1: &mut BaseConfig, arg2: address, arg3: u8) {
        ...
        0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &BaseConfig) : vector<0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::acl::Member> {
        0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::acl::get_members(&arg0.acl)
    }

    public fun get_permission(arg0: &BaseConfig, arg1: address) : u128 {
        0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::acl::get_permission(&arg0.acl, arg1)
    }

    public fun has_role(arg0: &BaseConfig, arg1: address, arg2: u8) : bool {
        0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::acl::has_role(&arg0.acl, arg1, arg2)
    }

    public fun remove_member(arg0: &AdminCap, arg1: &mut BaseConfig, arg2: address) {
        checked_package_version(arg1);
        0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut BaseConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &AdminCap, arg1: &mut BaseConfig, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = BaseConfig{
            ...
            acl             : 0xc4490f9701709caa8f25e69aee0901c776d0307123d229b0de81aba7ebb18fba::acl::new(arg0),
            package_version : 1,
        };
