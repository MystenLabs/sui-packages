module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land {
    ...
    public fun check_version(arg0: &StakingPool) {
        assert!(arg0.version == 9, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_version_mismatch());
    }
    ...
    fun consume_durability_for_production_tools(arg0: &mut StakingPool, arg1: address, arg2: u64) {
        ...
        while (v1 < 0x1::vector::length<ItemInfo>(&v0.items)) {
            ...
            if (is_item_active(v2, arg2) && 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::is_production_tool(v2.item_type)) {
    ...
    fun consume_durability_for_urr_raffle(arg0: &mut StakingPool, arg1: address, arg2: u8, arg3: u64) {
        ...
        while (v1 < 0x1::vector::length<ItemInfo>(&v0.items)) {
            ...
            if (v2.item_type == arg2 && is_item_active(v2, arg3)) {
    ...
    fun get_tool_boost(arg0: &StakingPool, arg1: &vector<ItemInfo>, arg2: u8, arg3: u64) : u128 {
        ...
        while (v1 < v0) {
            ...
            if (v2.item_type == arg2 && is_item_active(v2, arg3)) {
                if (v2.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_wheelbarrow()) {
                ...
                if (v2.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_idol_of_axomamma()) {
                ...
                if (v2.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_shovel()) {
                ...
                return (0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_prod_mul(0x2::kiosk::borrow<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>(&arg0.kiosk, &arg0.kiosk_owner_cap, v2.nft_id)) as u128)
            };
            v1 = v1 + 1;
        };
        10000
    ...
    fun mint_resource(arg0: &StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: u8, arg3: u128, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        } else if (arg2 == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_chrono_seed()) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x7162202dfdb30c8bb7c3d0dd81a1db9abdd8e22383db87e53210cb8a124f276a::pawtato_coin_chrono_seed::PAWTATO_COIN_CHRONO_SEED>>(0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::mint_chrono_seed(arg1, 0x2::object::id<StakingPool>(arg0), (arg3 as u64), arg4), 0x2::tx_context::sender(arg4));
        } else if (arg2 == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_fairy_dust()) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xc5c7416e7ae5c520527d9daca16136b198980b2b029f5e10fe5c27490a8754be::pawtato_coin_fairy_dust::PAWTATO_COIN_FAIRY_DUST>>(0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::mint_fairy_dust(arg1, 0x2::object::id<StakingPool>(arg0), (arg3 as u64), arg4), 0x2::tx_context::sender(arg4));
        } else if (arg2 == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_barrier_shard()) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x999246ca226b87802b5d190165c3989bcc0819855405ee695b4c38f55552e0f0::pawtato_coin_barrier_shard::PAWTATO_COIN_BARRIER_SHARD>>(0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::mint_barrier_shard(arg1, 0x2::object::id<StakingPool>(arg0), (arg3 as u64), arg4), 0x2::tx_context::sender(arg4));
        };
    }
    ...
    public entry fun upgrade_version(arg0: &LandAdminCap, arg1: &mut StakingPool, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = arg1.version;
        assert!(v0 < 9, 13906836888762712063);
        arg1.version = 9;
