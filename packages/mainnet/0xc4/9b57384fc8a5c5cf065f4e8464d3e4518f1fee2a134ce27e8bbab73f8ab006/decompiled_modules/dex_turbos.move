module 0xc49b57384fc8a5c5cf065f4e8464d3e4518f1fee2a134ce27e8bbab73f8ab006::dex_turbos {
    ...
    public fun get_dex_info() : 0xc49b57384fc8a5c5cf065f4e8464d3e4518f1fee2a134ce27e8bbab73f8ab006::dex_trait::DexInfo {
        0xc49b57384fc8a5c5cf065f4e8464d3e4518f1fee2a134ce27e8bbab73f8ab006::dex_trait::create_dex_info(b"Turbos", 25, @0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1)
    }
    ...
    public fun swap_cross<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = SwapExecuted{
            ...
            trader       : arg1,
            pool_address : 0xc49b57384fc8a5c5cf065f4e8464d3e4518f1fee2a134ce27e8bbab73f8ab006::constants::get_turbos_sui_usdc_pool(),
        };
