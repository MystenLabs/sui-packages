module 0xc402aa9e740a3e409a56c0718c3b34bb63e8836e4e478781af698ff4265ecc76::authority {
    struct PACKAGE {
        dummy_field: bool,
    }
    ...
    public fun add_authorization(arg0: &mut 0x2::object::UID, arg1: &AuthorityCap<PACKAGE, ADMIN>) {
        ...
        0xc402aa9e740a3e409a56c0718c3b34bb63e8836e4e478781af698ff4265ecc76::events::emit_added_authorization(0x2::object::uid_to_inner(arg0));
    }
    ...
    public fun remove_authorization(arg0: &mut 0x2::object::UID, arg1: &AuthorityCap<PACKAGE, ADMIN>) {
        ...
        0xc402aa9e740a3e409a56c0718c3b34bb63e8836e4e478781af698ff4265ecc76::events::emit_removed_authorization(0x2::object::uid_to_inner(arg0));
    }
