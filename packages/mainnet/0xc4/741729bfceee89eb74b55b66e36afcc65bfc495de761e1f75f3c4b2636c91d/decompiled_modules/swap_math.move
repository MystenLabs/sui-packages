module 0xc4741729bfceee89eb74b55b66e36afcc65bfc495de761e1f75f3c4b2636c91d::swap_math {
    ...
    public(friend) fun optimal_swap<T0, T1>(arg0: &0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::Pool<T0, T1>, arg1: u32, arg2: u32, arg3: u64, arg4: u64) : (u64, u64, bool, u128) {
        ...
        let v2 = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lt(v0, v1)) {
            if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::gte(v0, 0xc4741729bfceee89eb74b55b66e36afcc65bfc495de761e1f75f3c4b2636c91d::i32_utils::mate_to_lib(0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::tick_math::min_tick()))) {
                0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lte(v1, 0xc4741729bfceee89eb74b55b66e36afcc65bfc495de761e1f75f3c4b2636c91d::i32_utils::mate_to_lib(0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::tick_math::max_tick()))
            } else {
                false
            }
        } else {
        ...
        let v4 = 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::tick_math::get_sqrt_price_at_tick(0xc4741729bfceee89eb74b55b66e36afcc65bfc495de761e1f75f3c4b2636c91d::i32_utils::lib_to_mate(v0));
        let v5 = 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::tick_math::get_sqrt_price_at_tick(0xc4741729bfceee89eb74b55b66e36afcc65bfc495de761e1f75f3c4b2636c91d::i32_utils::lib_to_mate(v1));
        let v6 = 0xf86be58c3d946cff2bd8b081ea084edeae9ee5143c7a130913c0333eaa53c02f::state::init_swap_state(0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::liquidity<T0, T1>(arg0), v3, 0xc4741729bfceee89eb74b55b66e36afcc65bfc495de761e1f75f3c4b2636c91d::i32_utils::mate_to_lib(0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::current_tick_index<T0, T1>(arg0)), arg3, arg4, v4, v5, 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::fee_rate<T0, T1>(arg0));
