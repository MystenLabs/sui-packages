module 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic {
    ...
    public(friend) fun fix_bracers(arg0: &mut Cosmetic) {
        if (arg0.name == 0x1::string::utf8(b"Fang MK IV") && arg0.colour_way == 0x1::string::utf8(b"Digital Winter") && arg0.image_url == 0x1::string::utf8(b"QmYRL4Ws5DjjFywLzibgqLa3NSNDZinKNxn3xQZUywVrv3") && (arg0.type == 0x1::string::utf8(b"Right Bracer") || arg0.type == 0x1::string::utf8(b"Left Bracer"))) {
            arg0.colour_way = 0x1::string::utf8(b"Hikari");
            arg0.rarity = 0x1::string::utf8(b"Mythic");
            let (v0, v1, v2) = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::uris::get_other(b"Fang MK IV", 0x1::string::into_bytes(arg0.type), b"Hikari");
            arg0.image_url = 0x1::string::utf8(v0);
            arg0.model_url = 0x1::string::utf8(v1);
            arg0.texture_url = 0x1::string::utf8(v2);
            let v3 = b"";
            0x1::vector::append<u8>(&mut v3, b"Fang MK IV");
            0x1::vector::append<u8>(&mut v3, 0x1::string::into_bytes(arg0.type));
            0x1::vector::append<u8>(&mut v3, b"Hikari");
            arg0.hash = 0x2::hash::blake2b256(&v3);
        };
    }
    ...
    public(friend) fun fix_legs(arg0: &mut Cosmetic) {
        if (arg0.name == 0x1::string::utf8(b"Fang MK IV") && arg0.colour_way == 0x1::string::utf8(b"Hikari") && arg0.type == 0x1::string::utf8(b"Legs")) {
            arg0.colour_way = 0x1::string::utf8(b"Digital Winter");
            arg0.rarity = 0x1::string::utf8(b"Ultra Rare");
            let (v0, v1, v2) = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::uris::get_other(b"Fang MK IV", b"Legs", b"Digital Winter");
            arg0.image_url = 0x1::string::utf8(v0);
            arg0.model_url = 0x1::string::utf8(v1);
            arg0.texture_url = 0x1::string::utf8(v2);
            let v3 = b"";
            0x1::vector::append<u8>(&mut v3, b"Fang MK IV");
            0x1::vector::append<u8>(&mut v3, b"Legs");
            0x1::vector::append<u8>(&mut v3, b"Digital Winter");
            arg0.hash = 0x2::hash::blake2b256(&v3);
        };
    }
