module 0xc4738cce2df0b26466a47c5dc1e6563a6b95b852ece0816ef6d9ccb54efafa47::lofi3 {
    struct LOFI3 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LOFI3, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<LOFI3>(arg0, 9, b"LOFI3", b"LOFI3", b"Embrace Your Inner Yeti", v2, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LOFI3>>(v4);
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<LOFI3>>(v3);
    ...
    public entry fun transfer_with_tax(arg0: &TaxStorage, arg1: &AdminCap, arg2: &mut 0x2::coin::Coin<LOFI3>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        ...
        let v3 = 0x2::balance::split<LOFI3>(0x2::coin::balance_mut<LOFI3>(arg2), arg3);
        if (v0 > 0) {
            let v4 = arg3 * v0 / 10000;
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI3>>(0x2::coin::from_balance<LOFI3>(0x2::balance::split<LOFI3>(&mut v3, v4), arg5), arg1.admin_address);
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI3>>(0x2::coin::from_balance<LOFI3>(0x2::balance::split<LOFI3>(&mut v3, arg3 - v4), arg5), arg4);
            0x2::balance::destroy_zero<LOFI3>(v3);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI3>>(0x2::coin::from_balance<LOFI3>(v3, arg5), arg4);
        };
    }
