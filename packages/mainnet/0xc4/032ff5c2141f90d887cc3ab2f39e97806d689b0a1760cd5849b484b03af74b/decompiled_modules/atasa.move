module 0x6b382b96b6240012d0754f671e14d157411d5cd09bcc94386d306e98731f53f5::atasa {
    ...
    public fun atasa_pool(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: u32, arg3: u128, arg4: 0x2::coin::Coin<ATASA>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3, v4) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v3<ATASA, 0x2::sui::SUI>(arg0, arg1, arg2, arg3, 0x1::string::utf8(b"https://res.cloudinary.com/georgegoldman/image/upload/v1761138954/WhatsApp_Image_2025-10-21_at_1.18.20_PM_xuuhtm.jpg"), v0, v1, arg4, arg5, true, arg6, arg7);
        0x2::transfer::public_transfer<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(v2, 0x2::tx_context::sender(arg7));
        0x2::transfer::public_transfer<0x2::coin::Coin<ATASA>>(v3, 0x2::tx_context::sender(arg7));
