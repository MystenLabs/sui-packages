module 0xc44b3e7c6977cb0cfa05d90bf21a1ec2adcb11b971dce0d49465d3b9d20cb4fd::jwlsui {
    ...
    fun init(arg0: JWLSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<JWLSUI>(arg0, 9, b"JWLSUI", b"JWLSUI", b"JWLSUI is a stablecoin pegged to SUI and minted with SUI 1:1. Brought to you by JewelSwap.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://copper-desirable-gayal-466.mypinata.cloud/ipfs/QmQz8vs35q7L9CXzixxxdnU4DoWmT4nCVXQhzyQiAkFgW7")), arg1);
