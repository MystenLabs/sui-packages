module 0xc40d4458780a716ba9b65563a54e09e2caf003f27d0aa193daacc24b7e2b54a4::index {
    ...
    public fun assert_new_pool<T0, T1, T2>(arg0: &Registry) {
        assert!(!0x2::table::contains<0x1::type_name::TypeName, address>(&arg0.seed_pools, 0x1::type_name::get<RegistryKey<T0, T1, T2>>()), 0xc40d4458780a716ba9b65563a54e09e2caf003f27d0aa193daacc24b7e2b54a4::errors::pool_already_deployed());
    }
