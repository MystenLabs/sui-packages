module 0x713970501171e9d23d58857a59660bc6f91cc44919f313df581c3e83cca5d8c6::farm {
    ...
    public entry fun lock_stake<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        v4.ve_balance_of = 0x713970501171e9d23d58857a59660bc6f91cc44919f313df581c3e83cca5d8c6::math_extend::mul_div_to_u128(v4.locked_amount, v4.unlock_at - v0, 2592000);
        arg0.total_ve_amount = arg0.total_ve_amount + v4.ve_balance_of - v4.ve_balance_of;
