module 0xc4f009b6a7fd4cbafe22bb3892f7f1e7e01d393bbd3e492df1e5f1eb87bb2d43::stz {
    struct STZ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: STZ, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<STZ>(arg0, 2, b"STZ", b"Suitizen", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://i.imgur.com/rJnMzhr.png"))), arg1);
