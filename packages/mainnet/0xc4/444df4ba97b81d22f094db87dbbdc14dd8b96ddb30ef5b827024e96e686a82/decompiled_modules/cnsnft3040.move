module 0xc4444df4ba97b81d22f094db87dbbdc14dd8b96ddb30ef5b827024e96e686a82::cnsnft3040 {
    struct CNSNFT3040 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3040, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3040>(arg0, arg1);
