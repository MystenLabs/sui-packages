module 0xc4deb0a11a95cbc8d54d27b24df371e12982156bb4e513bdc21d6228c811d118::cnsnft2826 {
    struct CNSNFT2826 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2826, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2826>(arg0, arg1);
