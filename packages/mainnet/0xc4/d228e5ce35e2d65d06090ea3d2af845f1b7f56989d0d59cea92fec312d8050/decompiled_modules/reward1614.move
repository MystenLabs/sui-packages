module 0xc4d228e5ce35e2d65d06090ea3d2af845f1b7f56989d0d59cea92fec312d8050::reward1614 {
    struct REWARD1614 has drop {
        dummy_field: bool,
    }

    struct TICKET_1614 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1614(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1614>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1614>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1614, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1614>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1614>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1614>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1614>>(v5, 0x2::tx_context::sender(arg1));
    }
