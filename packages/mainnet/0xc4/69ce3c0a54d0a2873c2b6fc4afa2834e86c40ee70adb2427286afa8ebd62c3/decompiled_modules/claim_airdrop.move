module 0x59a98b77a932ab36303e4539e3efb8e88109703156591c36b45f47b955ca3938::claim_airdrop {
    ...
    public fun claim_airdrop_to_pre_staking_v2(arg0: &mut ClaimConfig, arg1: &mut UserAirdropPosition, arg2: vector<u8>, arg3: vector<u8>, arg4: &PreStakingV2Object, arg5: &mut 0x2b5b2081ce2428bdd67057ed6d62d1112173ded3588eab63ab93c2042a0b296a::staking::StakingPoolConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::option::is_some<vector<u8>>(&arg0.signer_pk), 11);
        check_signature(arg2, arg3, *0x1::option::borrow<vector<u8>>(&arg0.signer_pk));
        claim_airdrop_to_pre_staking_v2_internal(arg0, arg1, parse_claim_message(arg2), 0x2::hash::keccak256(&arg2), arg4, arg5, arg6, arg7);
    }

    fun claim_airdrop_to_pre_staking_v2_internal(arg0: &mut ClaimConfig, arg1: &mut UserAirdropPosition, arg2: ClaimMessage, arg3: vector<u8>, arg4: &PreStakingV2Object, arg5: &mut 0x2b5b2081ce2428bdd67057ed6d62d1112173ded3588eab63ab93c2042a0b296a::staking::StakingPoolConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 2, 1);
        assert!(!arg0.paused, 14);
        assert!(arg2.valid_until > 0x2::clock::timestamp_ms(arg6), 3);
        assert!(arg2.receiver == 0x2::tx_context::sender(arg7), 4);
        assert!(!0x2::table::contains<address, bool>(&arg0.blacks, arg2.receiver), 6);
        assert!(0x2::balance::value<0x76a49ebaf991fa2d4cb6a352af14425d453fe2ba6802b5ed2361b227150b6689::take::TAKE>(&arg0.claimable) >= arg2.amount, 8);
        assert!(arg2.airdrop_round <= arg0.latest_airdrop_round, 5);
        assert!(arg2.airdrop_round == 3, 5);
        assert!(arg2.chain_id == arg4.chain_id, 2);
        assert!(0x59a98b77a932ab36303e4539e3efb8e88109703156591c36b45f47b955ca3938::math::safe_add_u64(arg1.claimed, arg2.amount) <= arg1.total_allocation, 9);
        assert!(!0x2::vec_set::contains<vector<u8>>(&arg1.messages, &arg3), 12);
        0x2::vec_set::insert<vector<u8>>(&mut arg1.messages, arg3);
        assert!(!0x2::vec_set::contains<u64>(&arg1.airdrop_rounds, &arg2.airdrop_round), 13);
        0x2::vec_set::insert<u64>(&mut arg1.airdrop_rounds, arg2.airdrop_round);
        arg1.claimed = 0x59a98b77a932ab36303e4539e3efb8e88109703156591c36b45f47b955ca3938::math::safe_add_u64(arg1.claimed, arg2.amount);
        0x2b5b2081ce2428bdd67057ed6d62d1112173ded3588eab63ab93c2042a0b296a::staking::pre_staking_v2_deposit(arg5, &arg4.cap, 0x2::coin::from_balance<0x76a49ebaf991fa2d4cb6a352af14425d453fe2ba6802b5ed2361b227150b6689::take::TAKE>(0x2::balance::split<0x76a49ebaf991fa2d4cb6a352af14425d453fe2ba6802b5ed2361b227150b6689::take::TAKE>(&mut arg0.claimable, arg2.amount), arg7), arg6, arg7);
        let v0 = ClaimEvent{
            receiver       : arg2.receiver,
            claimed_amount : arg2.amount,
            total_claimed  : arg1.claimed,
            airdrop_round  : arg2.airdrop_round,
        };
        0x2::event::emit<ClaimEvent>(v0);
        let v1 = PreStakingClaimEvent{
            receiver     : arg2.receiver,
            amount       : arg2.amount,
            timestamp_ms : 0x2::clock::timestamp_ms(arg6),
        };
        0x2::event::emit<PreStakingClaimEvent>(v1);
        let ClaimMessage {
            airdrop_round    : _,
            receiver         : _,
            total_allocation : _,
    ...
    public fun init_airdrop(arg0: &mut ClaimConfig, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = parse_claim_message(arg1);
        assert!(0x1::option::is_some<vector<u8>>(&arg0.signer_pk), 11);
        check_signature(arg1, arg2, *0x1::option::borrow<vector<u8>>(&arg0.signer_pk));
        validate_common_conditions(arg0, &v0, arg4, arg3);
        assert!(v0.airdrop_round == 0, 5);
        assert!(!0x2::table::contains<address, bool>(&arg0.claimed, v0.receiver), 7);
        assert!(v0.amount <= v0.total_allocation, 9);
        transfer_claimable_tokens(arg0, v0.amount, v0.receiver, arg4);
        0x2::table::add<address, bool>(&mut arg0.claimed, v0.receiver, true);
        let v1 = UserAirdropPosition{
            id               : 0x2::object::new(arg4),
            total_allocation : v0.total_allocation,
            claimed          : v0.amount,
            airdrop_rounds   : 0x2::vec_set::empty<u64>(),
            messages         : 0x2::vec_set::empty<vector<u8>>(),
        };
        0x2::vec_set::insert<u64>(&mut v1.airdrop_rounds, v0.airdrop_round);
        0x2::vec_set::insert<vector<u8>>(&mut v1.messages, 0x2::hash::keccak256(&arg1));
        0x2::transfer::transfer<UserAirdropPosition>(v1, v0.receiver);
        let v2 = InitClaimEvent{
            receiver         : v0.receiver,
            total_allocation : v0.total_allocation,
            claimed_amount   : v0.amount,
            airdrop_round    : 0,
            user_position_id : 0x2::object::id<UserAirdropPosition>(&v1),
        };
        0x2::event::emit<InitClaimEvent>(v2);
        let ClaimMessage {
            airdrop_round    : _,
            receiver         : _,
            total_allocation : _,
