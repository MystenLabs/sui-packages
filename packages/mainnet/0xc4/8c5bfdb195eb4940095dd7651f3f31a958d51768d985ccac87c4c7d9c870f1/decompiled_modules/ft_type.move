module 0xc48c5bfdb195eb4940095dd7651f3f31a958d51768d985ccac87c4c7d9c870f1::ft_type {
    ...
    public fun register_bridge<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2235d7a739aae888ad6abb290924584a68dd7178a0ae0062237fba9be5666495::tradeport_bridge::Manager, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2235d7a739aae888ad6abb290924584a68dd7178a0ae0062237fba9be5666495::tradeport_bridge::register_bridge<T0, FT_TYPE>(arg1, 0x2::coin::mint<FT_TYPE>(0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, 0x2::coin::TreasuryCap<FT_TYPE>>(&mut arg0.id, 0x1::ascii::string(b"coin_treasury_cap")), 1000000000000000000, arg2), arg2);
    }
    ...
    fun init(arg0: FT_TYPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<FT_TYPE>(arg0, 9, b"{COIN_SYMBOL}", b"{COIN_NAME}", b"{COIN_DESCRIPTION}", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"{COIN_ICON_URL}")), true, arg1);
        let v3 = Store{
