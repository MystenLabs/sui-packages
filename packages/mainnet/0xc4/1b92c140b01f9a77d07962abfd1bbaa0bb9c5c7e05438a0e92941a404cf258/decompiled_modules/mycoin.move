module 0xc41b92c140b01f9a77d07962abfd1bbaa0bb9c5c7e05438a0e92941a404cf258::mycoin {
    ...
    fun init(arg0: MYCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MYCOIN>(arg0, 9, b"BOBO", b"BOBO", b"Official token on Sui.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://coin-images.coingecko.com/coins/images/35671/large/sui-sui-logo.png?1709487717")), arg1);
