module 0xc4f6432c6f9dda73e5a5d4d037593d0c2c3dd3ff2779e2b072da5e6a3d519d28::dogeus {
    ...
    fun init(arg0: DOGEUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/B5SWnMr_53RU5XsC?width=128&height=128&fit=crop&quality=95&format=auto                                                                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DOGEUS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DOGEUS  ")))), trim_right(b"Dogeus Maximus                  "), trim_right(b"The Dogefather Is Back.                                                                                                                                                                                                                                                                                                         "), v2, arg1);
        let v5 = v3;
