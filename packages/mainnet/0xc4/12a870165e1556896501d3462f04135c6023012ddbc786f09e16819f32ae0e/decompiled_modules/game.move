module 0xc412a870165e1556896501d3462f04135c6023012ddbc786f09e16819f32ae0e::game {
    ...
    entry fun claim_rewards<T0>(arg0: &mut GameState, arg1: &mut MintVault<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = calculate_pending_rewards(arg0, v2, v1) + v2.unclaimed_rewards;
        assert!(v3 > 0, 20);
        ...
        let v6 = v2.has_referrer;
        let v7 = if (v6) {
            750
        } else {
            1000
        };
        let v8 = (((v5 as u128) * (v7 as u128) / (10000 as u128)) as u64);
        let v9 = 0;
        if (v6) {
            v9 = (((v5 as u128) * (250 as u128) / (10000 as u128)) as u64);
        };
        let v10 = v5 - v8 - v9;
    ...
    fun get_bubbler_stats(arg0: u8) : (u64, u64, u64, vector<u8>, vector<u8>) {
        if (arg0 == 0) {
            ...
            (5000, 30, 31000000000, b"Pumper", b"https://bublz.fun/bubblers/pumper.png")
        } else if (arg0 == 5) {
            ...
            (200000, 600, 1000000000, b"Torrent", b"https://bublz.fun/bubblers/torrent.png")
        } else {
    ...
    entry fun stake_bubbler(arg0: &mut GameState, arg1: &BubbleGenerator, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        let v3 = calculate_pending_rewards(arg0, 0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, v0), v2);
        ...
        let v5 = 0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, v0);
        assert!(0x1::vector::length<u64>(&v5.staked_bubbler_ids) < get_tank_max_bubblers(v5.tier), 2);
        let v6 = apply_upgrade_bonus(v5, arg1.bubble_pressure);
        let v7 = apply_cooling_bonus(v5, arg1.tank_pressure);
        assert!(v5.total_tank_pressure + v7 <= get_tank_pressure_capacity(v5.tier), 3);
        let v8 = StakedBubblerInfo{
            owner           : v0,
            tier            : arg1.tier,
            bubble_pressure : v6,
            tank_pressure   : v7,
        };
        0x2::table::add<u64, StakedBubblerInfo>(&mut arg0.staked_bubblers, v1, v8);
        let v9 = 0x2::table::borrow_mut<address, PlayerTank>(&mut arg0.player_tanks, v0);
        0x1::vector::push_back<u64>(&mut v9.staked_bubbler_ids, v1);
        v9.total_pressure = v9.total_pressure + v6;
        v9.total_tank_pressure = v9.total_tank_pressure + v7;
        arg0.total_network_pressure = arg0.total_network_pressure + v6;
        let v10 = BubblerStaked{
            owner      : v0,
            bubbler_id : v1,
            tier       : arg1.tier,
        };
        0x2::event::emit<BubblerStaked>(v10);
    }

    entry fun unstake_all_bubblers(arg0: &mut GameState, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x2::table::contains<address, PlayerTank>(&arg0.player_tanks, v0), 10);
        let v1 = 0x2::clock::timestamp_ms(arg1);
        let v2 = calculate_pending_rewards(arg0, 0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, v0), v1);
        ...
        let v11 = 0x2::table::borrow_mut<address, PlayerTank>(&mut arg0.player_tanks, v0);
        v11.total_pressure = v11.total_pressure - v6;
        v11.total_tank_pressure = v11.total_tank_pressure - v7;
        arg0.total_network_pressure = arg0.total_network_pressure - v6;
    }

    entry fun unstake_bubbler(arg0: &mut GameState, arg1: &BubbleGenerator, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        let v4 = calculate_pending_rewards(arg0, 0x2::table::borrow<address, PlayerTank>(&arg0.player_tanks, v2), v3);
        ...
        let v7 = 0;
        let v8 = 0x1::vector::length<u64>(&v6.staked_bubbler_ids);
        while (v7 < v8) {
            if (*0x1::vector::borrow<u64>(&v6.staked_bubbler_ids, v7) == v0) {
                0x1::vector::swap_remove<u64>(&mut v6.staked_bubbler_ids, v7);
                v7 = v8;
            };
            v7 = v7 + 1;
        };
        v6.total_pressure = v6.total_pressure - v1.bubble_pressure;
        v6.total_tank_pressure = v6.total_tank_pressure - v1.tank_pressure;
        arg0.total_network_pressure = arg0.total_network_pressure - v1.bubble_pressure;
        let v9 = BubblerUnstaked{
            owner      : v2,
            bubbler_id : v0,
            tier       : v1.tier,
        };
        0x2::event::emit<BubblerUnstaked>(v9);
    }
    ...
    entry fun upgrade_stat<T0, T1>(arg0: &mut GameState, arg1: u8, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        process_sui_payment(arg4, 2000000000, arg0, arg5);
