module 0xc41a5abba184af9dc0ada069dc4c4981c83b6d1ce1f5e7beeff0dd45a675725e::farm {
    ...
    fun earned<T0, T1>(arg0: &Pool<T0, T1>, arg1: UserInfo, arg2: u64) : u64 {
        0xc41a5abba184af9dc0ada069dc4c4981c83b6d1ce1f5e7beeff0dd45a675725e::math_extend::mul_div(arg1.balance_of, reward_per_token<T0, T1>(arg0, arg2) - arg1.user_reward_per_token_paid, arg0.stake_coin_unit) + arg1.pending_reward
    }
    ...
    fun reward_per_token<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64) : u64 {
        ...
        if (v0 == 0 || arg1 <= arg0.start_at) {
            ...
            ((0xc41a5abba184af9dc0ada069dc4c4981c83b6d1ce1f5e7beeff0dd45a675725e::math_extend::mul_to_u128(arg0.reward_per_second, last_time_reward_applicable<T0, T1>(arg0, arg1) - arg0.updated_at) * (arg0.stake_coin_unit as u128) / (v0 as u128) + (arg0.reward_per_token_stored as u128)) as u64)
        }
    }
