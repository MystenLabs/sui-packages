module 0xc41a5abba184af9dc0ada069dc4c4981c83b6d1ce1f5e7beeff0dd45a675725e::launchpad {
    ...
    public entry fun claim<T0, T1>(arg0: &mut LaunchInfo<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0xc41a5abba184af9dc0ada069dc4c4981c83b6d1ce1f5e7beeff0dd45a675725e::math_extend::mul_div(arg0.claim_amount_per_coin_uint, v1.paid_amount, arg0.pay_coin_unit);
        assert!(v2 > 0, 1005);
