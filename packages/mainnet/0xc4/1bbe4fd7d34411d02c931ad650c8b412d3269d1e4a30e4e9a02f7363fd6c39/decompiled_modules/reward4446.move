module 0xc41bbe4fd7d34411d02c931ad650c8b412d3269d1e4a30e4e9a02f7363fd6c39::reward4446 {
    struct REWARD4446 has drop {
        dummy_field: bool,
    }

    struct TICKET_4446 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4446(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4446>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4446>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4446, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4446>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4446>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4446>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4446>>(v5, 0x2::tx_context::sender(arg1));
    }
