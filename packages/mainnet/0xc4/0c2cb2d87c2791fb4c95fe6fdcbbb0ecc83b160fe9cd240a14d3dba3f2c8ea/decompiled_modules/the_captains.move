module 0xc40c2cb2d87c2791fb4c95fe6fdcbbb0ecc83b160fe9cd240a14d3dba3f2c8ea::the_captains {
    ...
    struct PfpNFT has store, key {
        id: 0x2::object::UID,
        token_id: u64,
        attributes: 0x1::option::Option<CaptainAttributes>,
    ...
    public fun admin_create_display(arg0: &AdminCap, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) : 0x2::display::Display<PfpNFT> {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{attributes.class}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{attributes.weapon}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{attributes.outfit}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{attributes.background}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{attributes.special}"));
    ...
    public fun get_attributes(arg0: &PfpNFT) : &0x1::option::Option<CaptainAttributes> {
        &arg0.attributes
    }
    ...
    fun init(arg0: THE_CAPTAINS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"{attributes.class}"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"{attributes.weapon}"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"{attributes.outfit}"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"{attributes.background}"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"{attributes.special}"));
    ...
    fun mint_core(arg0: &PubKey, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: u8, arg7: u64, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: &mut Counter, arg12: &MintConfig, arg13: &mut MintStats, arg14: &Payout, arg15: 0x2::coin::Coin<0x2::sui::SUI>, arg16: &0x2::transfer_policy::TransferPolicy<PfpNFT>, arg17: &mut 0x2::kiosk::Kiosk, arg18: &0x2::kiosk::KioskOwnerCap, arg19: &0x2::clock::Clock, arg20: &mut 0x2::tx_context::TxContext) {
        ...
        while (v7 < arg3) {
            ...
            let v9 = PfpNFT{
                ...
                token_id    : v8,
                attributes  : 0x1::option::none<CaptainAttributes>(),
