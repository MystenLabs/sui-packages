module 0xc41cd4c01238fbfe6e3264237248170b7907bfa2d8d448c34503b84c04cd7879::reward9055 {
    struct REWARD9055 has drop {
        dummy_field: bool,
    }

    struct TICKET_9055 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9055(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9055>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9055>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9055, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9055>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9055>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9055>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9055>>(v5, 0x2::tx_context::sender(arg1));
    }
