module 0xc4b5bc631bb1de765009e133b119d84c033023aeb70c2dbc62f58137b92e9d10::reward1423 {
    struct REWARD1423 has drop {
        dummy_field: bool,
    }

    struct TICKET_1423 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1423(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1423>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1423>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1423, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1423>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1423>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1423>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1423>>(v5, 0x2::tx_context::sender(arg1));
    }
