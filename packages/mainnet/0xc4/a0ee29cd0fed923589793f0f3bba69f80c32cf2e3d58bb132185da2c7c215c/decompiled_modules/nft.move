module 0xc4a0ee29cd0fed923589793f0f3bba69f80c32cf2e3d58bb132185da2c7c215c::nft {
    ...
    entry fun mint(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Nft{
            ...
            name        : 0x1::string::utf8(b"shismart-cool"),
            description : 0x1::string::utf8(b"shismart-cool NFT"),
            creator     : 0x2::tx_context::sender(arg1),
            url         : 0x2::url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/173274545?s=400&u=4e6187991ed746f0da11916ebe055b22c924ef70&v=4"),
        };
