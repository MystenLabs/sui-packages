module 0xc47c030db6f1d7df7d49912f7807dcc96e6384a918afae098ee47f302786a83d::cnsnft6940 {
    struct CNSNFT6940 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6940, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6940>(arg0, arg1);
