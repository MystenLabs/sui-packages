module 0xc44fe56e9abde1d5fef43fde5019e5ad3034f3d6338c8dca5982adffd3668b2f::staking {
    ...
    public fun e4c_tokens_withdraw(arg0: &0xc44fe56e9abde1d5fef43fde5019e5ad3034f3d6338c8dca5982adffd3668b2f::config::AdminCap, arg1: &mut GameLiquidityPool, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x84b27ddadc6139c7e8837fef6759eba4670ba3fc0679acd118b4e9252f834e29::e4c::E4C> {
        assert!(arg2 > 0, 3);
        assert!(arg2 <= 0x2::balance::value<0x84b27ddadc6139c7e8837fef6759eba4670ba3fc0679acd118b4e9252f834e29::e4c::E4C>(&arg1.balance), 4);
        let v0 = PoolWithdrawn{
            sender : 0x2::tx_context::sender(arg3),
            amount : arg2,
        };
        0x2::event::emit<PoolWithdrawn>(v0);
        0x2::coin::take<0x84b27ddadc6139c7e8837fef6759eba4670ba3fc0679acd118b4e9252f834e29::e4c::E4C>(&mut arg1.balance, arg2, arg3)
    }
    ...
    public fun new_staking_receipt(arg0: 0x2::coin::Coin<0x84b27ddadc6139c7e8837fef6759eba4670ba3fc0679acd118b4e9252f834e29::e4c::E4C>, arg1: &mut GameLiquidityPool, arg2: &0x2::clock::Clock, arg3: &0xc44fe56e9abde1d5fef43fde5019e5ad3034f3d6338c8dca5982adffd3668b2f::config::StakingConfig, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : StakingReceipt {
        let v0 = 0xc44fe56e9abde1d5fef43fde5019e5ad3034f3d6338c8dca5982adffd3668b2f::config::get_staking_rule(arg3, arg4);
        let (v1, v2) = 0xc44fe56e9abde1d5fef43fde5019e5ad3034f3d6338c8dca5982adffd3668b2f::config::staking_quantity_range(v0);
        ...
        StakingReceipt{
            ...
            applied_interest_rate_bp : 0xc44fe56e9abde1d5fef43fde5019e5ad3034f3d6338c8dca5982adffd3668b2f::config::annualized_interest_rate_bp(v0),
            staking_end_at           : calculate_locking_time(v4, arg4),
            reward                   : 0x2::coin::into_balance<0x84b27ddadc6139c7e8837fef6759eba4670ba3fc0679acd118b4e9252f834e29::e4c::E4C>(e4c_tokens_request(arg1, 0xc44fe56e9abde1d5fef43fde5019e5ad3034f3d6338c8dca5982adffd3668b2f::config::staking_reward(arg3, arg4, v3), arg5)),
        }
    }
