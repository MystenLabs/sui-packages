module 0xc439843b4625dd884c08a45a38ca48df6091fe50d1b06ce784226b92328a0ee3::cnsnft8984 {
    struct CNSNFT8984 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8984, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8984>(arg0, arg1);
