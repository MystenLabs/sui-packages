module 0xc43c0fb48928fa1d279db4395e11c43a2b4a93d0430f287f2a040d32bf04b167::reward2710 {
    struct REWARD2710 has drop {
        dummy_field: bool,
    }

    struct TICKET_2710 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2710(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2710>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2710>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2710, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2710>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2710>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2710>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2710>>(v5, 0x2::tx_context::sender(arg1));
    }
