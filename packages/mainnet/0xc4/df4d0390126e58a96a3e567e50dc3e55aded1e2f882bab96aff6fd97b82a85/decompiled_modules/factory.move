module 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::factory {
    ...
    struct MintFactory has store {
        nfts: 0x2::table_vec::TableVec<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>,
    }
    ...
    struct UpgradeItem has drop, store {
        ...
        attributes: 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::attributes::Attributes,
    }
    ...
    public fun upgrade<T0>(arg0: &mut Factory, arg1: &mut 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::table::borrow_mut<u64, FactoryItem>(&mut arg0.upgrade_factory.nfts, 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::name(arg1));
        ...
        0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::upgrade(arg1, v1.link, v1.attributes);
        ...
        let v3 = UpgradeEvent{
            nft      : 0x2::object::id<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods>(arg1),
            level    : 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::level(arg1) - 1,
            to_level : 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::level(arg1),
        };
        0x2::event::emit<UpgradeEvent>(v3);
    }

    public fun admin_mint_nfts(arg0: &FactoryOwner, arg1: &mut Factory, arg2: &mut 0x2::tx_context::TxContext) : vector<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods> {
        let v0 = 0x1::vector::empty<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods>();
        while (0x2::table_vec::length<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(&arg1.mint_factory.nfts) > 0) {
            let v1 = 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::new_from_data(0x2::table_vec::pop_back<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(&mut arg1.mint_factory.nfts), arg2);
            let v2 = MintEvent{
                nft  : 0x2::object::id<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods>(&v1),
                name : 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::name(&v1),
            };
            0x2::event::emit<MintEvent>(v2);
            0x1::vector::push_back<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods>(&mut v0, v1);
        };
        v0
    }
    ...
    public fun batch_mint_premium_wl(arg0: &mut Factory, arg1: &mut MintTicket, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : vector<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods> {
        assert!(arg0.config.mint_open, 1);
        assert!(0x2::table_vec::length<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(&arg0.mint_factory.nfts) > 0, 2);
        assert_ticket_valid(arg1, arg2, arg0.config.premium_wl_date, arg3);
        let v0 = 0;
        let v1 = 0x1::vector::empty<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods>();
        while (v0 < arg3) {
            let v2 = 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::new_from_data(0x2::table_vec::pop_back<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(&mut arg0.mint_factory.nfts), arg4);
            let v3 = MintEvent{
                nft  : 0x2::object::id<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods>(&v2),
                name : 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::name(&v2),
            };
            0x2::event::emit<MintEvent>(v3);
            arg1.how_many = arg1.how_many - 1;
            0x1::vector::push_back<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods>(&mut v1, v2);
            v0 = v0 + 1;
        };
        v1
    }
    ...
    public fun create_nft(arg0: &FactoryAdmin, arg1: &mut Factory, arg2: u64, arg3: 0x1::string::String, arg4: &mut vector<0x1::string::String>, arg5: &mut vector<0x1::string::String>) {
        0x2::table_vec::push_back<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(&mut arg1.mint_factory.nfts, 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::new(arg2, arg3, 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::attributes::from_vec(arg4, arg5)));
    ...
    public fun how_many_nft_left(arg0: &Factory) : u64 {
        0x2::table_vec::length<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(&arg0.mint_factory.nfts)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = MintFactory{nfts: 0x2::table_vec::empty<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(arg0)};
    ...
    public fun is_nft_left(arg0: &Factory) : bool {
        0x2::table_vec::length<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(&arg0.mint_factory.nfts) > 0
    }
    ...
    public fun mint_with_degen_rabbit(arg0: &mut Factory, arg1: &mut 0x93195daadbc4f26c0c498f4ceac92593682d2325ce3a0f5ba9f2db3b6a9733dd::collection::DegenRabbit, arg2: &mut 0x93195daadbc4f26c0c498f4ceac92593682d2325ce3a0f5ba9f2db3b6a9733dd::collection::DegenRabbit, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods {
        assert!(arg0.config.mint_open, 1);
        assert!(0x2::table_vec::length<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(&arg0.mint_factory.nfts) > 0, 2);
        ...
        let v0 = 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::new_from_data(0x2::table_vec::pop_back<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(&mut arg0.mint_factory.nfts), arg4);
        let v1 = MintEvent{
            nft  : 0x2::object::id<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods>(&v0),
            name : 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::name(&v0),
        };
        0x2::event::emit<MintEvent>(v1);
        v0
    }

    public fun mint_with_generis(arg0: &mut Factory, arg1: 0x2::coin::Coin<0x2d6d59adaaa08b912e629dad9e60df7a83e849ccb28e78c4c536b72780ff67de::generis::GENERIS>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods, FactoryAccount) {
        assert!(arg0.config.mint_open, 1);
        assert!(0x2::table_vec::length<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(&arg0.mint_factory.nfts) > 0, 2);
        ...
        let v0 = 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::new_from_data(0x2::table_vec::pop_back<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(&mut arg0.mint_factory.nfts), arg3);
        let v1 = MintEvent{
            nft  : 0x2::object::id<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods>(&v0),
            name : 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::name(&v0),
        };
    ...
    public fun mint_with_generis_with_existent_account(arg0: &mut Factory, arg1: 0x2::coin::Coin<0x2d6d59adaaa08b912e629dad9e60df7a83e849ccb28e78c4c536b72780ff67de::generis::GENERIS>, arg2: &mut FactoryAccount, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGods {
        assert!(arg0.config.mint_open, 1);
        assert!(0x2::table_vec::length<0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::collection::FusionOfTheGodsData>(&arg0.mint_factory.nfts) > 0, 2);
    ...
    public fun upgrade_nft(arg0: &FactoryAdmin, arg1: &mut Factory, arg2: u64, arg3: 0x1::string::String, arg4: &mut vector<0x1::string::String>, arg5: &mut vector<0x1::string::String>) {
        let v0 = UpgradeItem{
            link       : arg3,
            attributes : 0xc4df4d0390126e58a96a3e567e50dc3e55aded1e2f882bab96aff6fd97b82a85::attributes::from_vec(arg4, arg5),
        };
