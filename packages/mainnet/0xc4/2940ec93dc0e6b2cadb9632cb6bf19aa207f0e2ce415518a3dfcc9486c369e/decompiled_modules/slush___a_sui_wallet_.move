module 0xc42940ec93dc0e6b2cadb9632cb6bf19aa207f0e2ce415518a3dfcc9486c369e::slush___a_sui_wallet_ {
    struct SLUSH___A_SUI_WALLET_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SLUSH___A_SUI_WALLET_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SLUSH___A_SUI_WALLET_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(x"536c75736820e280932061205375692057616c6c65742a"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Slush is a sleek, secure Sui-based wallet designed for seamless Web3 access. This NFT collection celebrates the power and design of decentralized finance."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifle6omako5jwvfg7jg65zusoidx35ueenb662ys7xarcucsrugcy"));
