module 0xc43eb4ced9028b5b4c1e1f119cc63111b24fd78ad8a07dc45729550f61d71c0d::rugzzzzzzzzzzzzzz {
    struct RUGZZZZZZZZZZZZZZ has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x2f8d60f4b08729c5cc9f4322eb18eca94e209ab8d72f4b398452118390f96fe7::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"10aa94e9-fb9e-4d2d-8b0f-eb275c5aa09a"),
        };
        0x2::event::emit<AddNftMetadataEvent>(v0);
    }

    fun init(arg0: RUGZZZZZZZZZZZZZZ, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<RUGZZZZZZZZZZZZZZ>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Rugzzzzzzzzzzzzzz"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"aef"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"https://byzantion.mypinata.cloud/ipfs/QmR52wHsCuiuASt2B8whdXUNAwFgZst6y9Bvdwgv1TcAyL"));
