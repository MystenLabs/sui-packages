module 0xc489ebcf5932664b9f1b5b905aca9cea5df1de7ac649181a08b26c2baf0e935b::reward1472 {
    struct REWARD1472 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward1472(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD1472, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1472>(arg0, arg1);
