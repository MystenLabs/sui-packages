module 0xc46ebe7bb19bd922b15752178ef3f29f90b50238df3fa6197fbcc608ed4e7e63::_sui_pixel_gnomes {
    struct _SUI_PIXEL_GNOMES has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _SUI_PIXEL_GNOMES, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_SUI_PIXEL_GNOMES>(arg0, arg1);
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiflhol53srpye7an2rrhr23iybv46mhwowq53cx3koo5so5k3ve7e"));
