module 0xc4d260fc3d9889ad3ac740356529590968f3f3855834837930c820c84acef5c6::cnsnft1922 {
    struct CNSNFT1922 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1922, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://nsclaim1123img-0233.vercel.app/api/{id}"));
        ...
        let v4 = 0x2::package::claim<CNSNFT1922>(arg0, arg1);
