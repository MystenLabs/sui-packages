module 0xc4496f8ba92b989a88de33da6679ca789b22dc344c53dcd65cfa4b5328bd2701::game8336 {
    struct GAME8336 has drop {
        dummy_field: bool,
    }

    struct TICKET_8336 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8336(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8336>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8336>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME8336, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME8336>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8336>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8336>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8336>>(v5, 0x2::tx_context::sender(arg1));
    }
