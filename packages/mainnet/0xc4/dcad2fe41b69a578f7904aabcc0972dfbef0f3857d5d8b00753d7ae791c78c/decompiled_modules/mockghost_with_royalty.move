module 0xc4dcad2fe41b69a578f7904aabcc0972dfbef0f3857d5d8b00753d7ae791c78c::mockghost_with_royalty {
    ...
    fun init(arg0: MOCKGHOST_WITH_ROYALTY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = &mut v9;
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"Ghost[R30wA]1"));
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"Ghost[R30wA]2"));
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"Ghost[R30wA]3"));
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"Ghost[R30wA]4"));
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"Ghost[R30wA]5"));
        ...
        let (v24, v25) = 0x70e34fcd390b767edbddaf7573450528698188c84c5395af8c4b12e3e37622fa::allowlist::new(arg1);
        let v26 = v25;
        let v27 = v24;
        0x70e34fcd390b767edbddaf7573450528698188c84c5395af8c4b12e3e37622fa::allowlist::insert_authority<0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::orderbook::Witness>(&v26, &mut v27);
        0x70e34fcd390b767edbddaf7573450528698188c84c5395af8c4b12e3e37622fa::allowlist::insert_collection<MockGhost>(&mut v27, &v4);
        ...
        0x2::transfer::public_transfer<0x70e34fcd390b767edbddaf7573450528698188c84c5395af8c4b12e3e37622fa::allowlist::AllowlistOwnerCap>(v26, v0);
        ...
        0x2::transfer::public_share_object<0x70e34fcd390b767edbddaf7573450528698188c84c5395af8c4b12e3e37622fa::allowlist::Allowlist>(v27);
    }
