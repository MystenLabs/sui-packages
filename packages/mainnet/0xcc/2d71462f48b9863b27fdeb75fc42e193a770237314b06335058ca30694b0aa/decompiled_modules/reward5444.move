module 0xcc2d71462f48b9863b27fdeb75fc42e193a770237314b06335058ca30694b0aa::reward5444 {
    struct REWARD5444 has drop {
        dummy_field: bool,
    }

    struct TICKET_5444 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5444(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5444>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5444>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5444, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5444>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5444>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5444>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5444>>(v5, 0x2::tx_context::sender(arg1));
    }
