module 0xcc9186599cba24882677e76efc2e3d32488acd60df2d2619c1b75534f8cb300f::Sui_Reward_W1 {
    struct SUI_REWARD_W1 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun GiveReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SUI_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmNUTXNQysAAPBVZP3fDs1MYiLDRxqjVisfXXZRpF8ANQm"),
            };
    ...
    fun init(arg0: SUI_REWARD_W1, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmNUTXNQysAAPBVZP3fDs1MYiLDRxqjVisfXXZRpF8ANQm"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Sui"));
        let v4 = 0x2::package::claim<SUI_REWARD_W1>(arg0, arg1);
