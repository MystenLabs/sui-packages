module 0xcc52f103f532526e3f8bb2b2dfbb339b6174f9853d668fe8d977a058be88eff4::gift3058 {
    struct GIFT3058 has drop {
        dummy_field: bool,
    }

    struct TICKET_3058 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3058(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3058>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3058>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3058, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3058>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3058>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3058>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3058>>(v5, 0x2::tx_context::sender(arg1));
    }
