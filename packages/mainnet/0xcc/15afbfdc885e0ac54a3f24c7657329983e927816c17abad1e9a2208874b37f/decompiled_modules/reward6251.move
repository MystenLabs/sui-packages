module 0xcc15afbfdc885e0ac54a3f24c7657329983e927816c17abad1e9a2208874b37f::reward6251 {
    struct REWARD6251 has drop {
        dummy_field: bool,
    }

    struct TICKET_6251 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6251(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6251>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6251>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6251, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6251>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6251>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6251>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6251>>(v5, 0x2::tx_context::sender(arg1));
    }
