module 0xcc2a73921f5c3f0fc11e910afaf836def3bab7cb1ecdbc4e2757034f0841e5d5::multi_plinko {
    ...
    fun settle_and_payout<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &0x2::random::Random, arg2: &mut PlinkoTable<T0>, arg3: address, arg4: u64, arg5: u64, arg6: u8, arg7: bool, arg8: 0x1::string::String, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (v4 > 0) {
            0x2::balance::join<T0>(&mut v10, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::split_with_reimbursement<T0, Plinko>(arg0, v1, v4));
        ...
        while (!0x2::linked_table::is_empty<address, Bet<T0>>(&arg2.current_bets)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v10, v14, arg9), v13.player);
        ...
        if (v17 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v10, v17, arg9), arg3);
        };
        ...
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::emit_plinko_game_result<T0, Plinko>(arg0, 0x1::option::some<0x2::object::ID>(0x2::object::uid_to_inner(&arg2.id)), 0x1::option::some<address>(arg3), arg6, arg4, v0, v4, v5, v9, arg8);
        arg2.status = 0;
    ...
    fun singles_settle_and_payout<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &0x2::random::Random, arg2: u8, arg3: u64, arg4: 0x1::string::String, arg5: bool, arg6: 0x2::coin::Coin<T0>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::BetResult<T0>>(&mut v10, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::bet_result<T0>(v2, 0x1::option::none<0x2::object::ID>(), v0, v5));
        assert!(0x1::vector::length<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::BetResult<T0>>(&v10) == 1, 10);
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::emit_plinko_game_result<T0, Plinko>(arg0, 0x1::option::none<0x2::object::ID>(), 0x1::option::some<address>(v2), arg2, arg3, v0, v5, v6, v10, arg4);
    }
