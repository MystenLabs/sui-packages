module 0xccbf8f677268fc459a9170c65c8916ae7a58bb870d2dd5284dc4330159465342::q64x64 {
    ...
    public fun log2(arg0: u128) : u128 {
        ...
        let v3 = 0xccbf8f677268fc459a9170c65c8916ae7a58bb870d2dd5284dc4330159465342::bit_math::most_significant_bit_u128(v1);
        let v4 = 64;
        let v5 = if (v3 >= v4) {
    ...
    public fun sqrt(arg0: u128) : u128 {
        ...
        let v0 = 0xccbf8f677268fc459a9170c65c8916ae7a58bb870d2dd5284dc4330159465342::bit_math::most_significant_bit_u128(arg0);
        let v1 = if (v0 >= 64) {
            1 << (v0 + 64) / 2
        } else {
            1 << (v0 + 64) / 2
