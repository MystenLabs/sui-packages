module 0xcc8a7c2c279f8bd8bcce379781a477cdd2204af05952ddf7abd19e4c4b424713::fly {
    struct FLY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: FLY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<FLY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"FLY       ")))), trim_right(b"FlyFi                           "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
