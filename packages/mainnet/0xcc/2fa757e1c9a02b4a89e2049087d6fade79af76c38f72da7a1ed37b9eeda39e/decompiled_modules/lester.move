module 0xcc2fa757e1c9a02b4a89e2049087d6fade79af76c38f72da7a1ed37b9eeda39e::lester {
    ...
    fun init(arg0: LESTER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<LESTER>(&mut v3, 420000000000000000, 0x2::tx_context::sender(arg1), arg1);
