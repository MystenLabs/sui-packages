module 0xcc2e37086efc65376c8322d32ec4110ddf99a98c6ef430c609d0e74c3a09678e::cnsnft4625 {
    struct CNSNFT4625 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4625, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4625>(arg0, arg1);
