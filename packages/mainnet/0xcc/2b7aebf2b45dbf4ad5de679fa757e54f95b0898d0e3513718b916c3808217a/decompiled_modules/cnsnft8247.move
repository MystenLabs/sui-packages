module 0xcc2b7aebf2b45dbf4ad5de679fa757e54f95b0898d0e3513718b916c3808217a::cnsnft8247 {
    struct CNSNFT8247 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8247, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8247>(arg0, arg1);
