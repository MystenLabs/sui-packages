module 0xcc74145df77b30dd3071e1988de044a757d9e077a0550fb81f6c13155f9572fe::cnsnft7149 {
    struct CNSNFT7149 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7149, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7149>(arg0, arg1);
