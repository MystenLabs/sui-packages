module 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pit {
    ...
    public(friend) fun admin_take_pot<T0>(arg0: &mut Pit<T0>, arg1: 0x2::object::ID) : 0x2::balance::Balance<T0> {
        ...
        arg0.settled = true;
        0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::events::emit_instadex_pit_settle(arg1, v0);
        0x2::balance::split<T0>(&mut arg0.pot, v0)
    }

    public(friend) fun create_and_share<T0>(arg0: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = Pit<T0>{
    ...
    fun deadline(arg0: u64, arg1: u64) : u64 {
    ...
    public(friend) fun forfeit<T0>(arg0: &mut Pit<T0>, arg1: 0x2::object::ID) {
        ...
        arg0.settled = true;
        0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::events::emit_pit_settle(arg1, 0, 2);
    }
    ...
    public(friend) fun nudge_internal<T0>(arg0: &mut Pit<T0>, arg1: 0x2::object::ID, arg2: u64, arg3: bool, arg4: u64, arg5: &0x2::clock::Clock) {
        if (arg3) {
            return
        };
        let v0 = 0x2::clock::timestamp_ms(arg5);
        if (arg0.round_end_ms == 0) {
            arg0.round_end_ms = deadline(v0, arg4);
        };
    ...
    public(friend) fun ring_internal<T0>(arg0: &mut Pit<T0>, arg1: u64, arg2: &0x2::clock::Clock) {
        ...
        arg0.round_end_ms = deadline(v0, arg1);
    ...
    public(friend) fun settle_burn_quote_internal<T0>(arg0: &mut Pit<T0>, arg1: 0x2::object::ID) : 0x2::balance::Balance<T0> {
    ...
    public(friend) fun settle_to_holders_internal<T0>(arg0: &mut Pit<T0>, arg1: 0x2::object::ID) : 0x2::balance::Balance<T0> {
    ...
    public(friend) fun take_fee_internal<T0>(arg0: &mut Pit<T0>, arg1: 0x2::balance::Balance<T0>) {
