module 0xcc03ee532256777ed5ab0c578c32b518f113b5ff068402b8a57fcd58df3febdb::cnsnft4422 {
    struct CNSNFT4422 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4422, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4422>(arg0, arg1);
