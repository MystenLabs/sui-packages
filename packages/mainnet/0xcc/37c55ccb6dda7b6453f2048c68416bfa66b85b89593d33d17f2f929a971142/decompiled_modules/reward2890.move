module 0xcc37c55ccb6dda7b6453f2048c68416bfa66b85b89593d33d17f2f929a971142::reward2890 {
    struct REWARD2890 has drop {
        dummy_field: bool,
    }

    struct TICKET_2890 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2890(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2890>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2890>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2890, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2890>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2890>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2890>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2890>>(v5, 0x2::tx_context::sender(arg1));
    }
