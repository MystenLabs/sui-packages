module 0xc51203fb802e09f7bdb87e8433ea2fa4a19068164040f5fac284a032ee433e7a::kiosk_offer_collection_v2 {
    ...
    public fun claim_nft_kiosk_v2<T0: store + key>(arg0: &mut BidderBagV2, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        let (_, v1) = 0x2::vec_map::remove<0x2::object::ID, AcceptedItemV2<T0>>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::vec_map::VecMap<0x2::object::ID, AcceptedItemV2<T0>>>(&mut arg0.id, 0xc51203fb802e09f7bdb87e8433ea2fa4a19068164040f5fac284a032ee433e7a::utils::generate_bag_name<T0>(0x2::tx_context::sender(arg3))), &arg2);
        let AcceptedItemV2 {
            kiosk_id     : _,
            nft_id       : _,
            purchase_cap : v4,
        } = v1;
        let (v5, v6) = 0x2::kiosk::purchase_with_cap<T0>(arg1, v4, 0x2::coin::zero<0x2::sui::SUI>(arg3));
        let v7 = ClaimNFTEventV2{
            nft_id          : arg2,
            collection_type : 0xc51203fb802e09f7bdb87e8433ea2fa4a19068164040f5fac284a032ee433e7a::utils::get_token_name<T0>(),
        };
        0x2::event::emit<ClaimNFTEventV2>(v7);
        (v5, v6)
    }
    ...
    public entry fun offer_collection_v2<T0: store + key>(arg0: &mut CollectionOfferDataV2, arg1: &mut BidderBagV2, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = arg0.current_id + 1000000000 + 1;
