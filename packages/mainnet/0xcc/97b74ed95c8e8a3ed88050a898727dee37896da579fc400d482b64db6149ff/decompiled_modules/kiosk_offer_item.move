module 0xc51203fb802e09f7bdb87e8433ea2fa4a19068164040f5fac284a032ee433e7a::kiosk_offer_item {
    ...
    public fun claim_nft_v2<T0: store + key>(arg0: &mut OfferData, arg1: u64, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        let v0 = 0xc51203fb802e09f7bdb87e8433ea2fa4a19068164040f5fac284a032ee433e7a::utils::get_token_name<T0>();
        let OfferItem {
            id             : v1,
            offerer        : v2,
        ...
        let v9 = v1;
        assert!(v0 == v4, 2);
        assert!(0x2::tx_context::sender(arg4) == v2, 3);
        0x1::option::extract<0x2::object::ID>(&mut v8);
        let (v10, v11) = 0x2::kiosk::purchase_with_cap<T0>(arg2, 0x2::dynamic_object_field::remove<0x2::object::ID, 0x2::kiosk::PurchaseCap<T0>>(&mut v9, arg3), 0x2::coin::zero<0x2::sui::SUI>(arg4));
        0x1::option::destroy_none<0x2::object::ID>(v8);
        0x2::coin::destroy_zero<0x2::sui::SUI>(v6);
        0x2::object::delete(v9);
        let v12 = ClaimNFTEvent{
            offer_id : v3,
            nft_id   : arg3,
            nft_type : v0,
        };
        0x2::event::emit<ClaimNFTEvent>(v12);
        (v10, v11)
    }
