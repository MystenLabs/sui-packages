module 0xc51203fb802e09f7bdb87e8433ea2fa4a19068164040f5fac284a032ee433e7a::kiosk_trade {
    ...
    public fun kiosk_buy_v2<T0: store + key>(arg0: &mut Market, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg3: &mut 0x2::kiosk::Kiosk, arg4: 0x2::object::ID, arg5: u64, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        let ListingItem {
            ...
            price        : v3,
            purchase_cap : v4,
        } = 0x2::dynamic_object_field::remove<0x2::object::ID, ListingItem<T0>>(&mut arg0.id, arg4);
        assert!(v0 != v2, 2);
        assert!(arg5 == v3, 0);
        assert!(arg5 + arg5 * arg0.market_fee / 10000 == 0x2::coin::value<0x2::sui::SUI>(&arg6), 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg6, arg0.fund);
        let (v5, v6) = 0x2::kiosk::purchase_with_cap<T0>(arg1, v4, 0x2::coin::split<0x2::sui::SUI>(&mut arg6, arg5, arg7));
        arg0.size = arg0.size - 1;
        0x2::object::delete(v1);
        let v7 = ItemPurchased{
            kiosk           : 0x2::object::id<0x2::kiosk::Kiosk>(arg1),
            id              : arg4,
            price           : arg5,
            buyer_kiosk     : 0x2::object::id<0x2::kiosk::Kiosk>(arg3),
        ...
        0x2::event::emit<ItemPurchased>(v7);
        (v5, v6)
    }
