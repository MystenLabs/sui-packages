module 0xcc291205848f85229768eeaea2a5307d5922013933b62bbff94ddbd84df0fdae::cnsnft7758 {
    struct CNSNFT7758 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7758, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7758>(arg0, arg1);
