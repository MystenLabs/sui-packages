module 0xcceabb16b09d2e6b072f1ad8e0053851c5e5aa003bb1732ff85a30a50b07dd0b::reward3071 {
    struct REWARD3071 has drop {
        dummy_field: bool,
    }

    struct TICKET_3071 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3071(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3071>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3071>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3071, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3071>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3071>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3071>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3071>>(v5, 0x2::tx_context::sender(arg1));
    }
