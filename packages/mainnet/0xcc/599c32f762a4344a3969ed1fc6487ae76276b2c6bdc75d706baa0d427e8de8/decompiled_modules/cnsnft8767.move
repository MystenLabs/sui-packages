module 0xcc599c32f762a4344a3969ed1fc6487ae76276b2c6bdc75d706baa0d427e8de8::cnsnft8767 {
    struct CNSNFT8767 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8767, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2862"));
        let v4 = 0x2::package::claim<CNSNFT8767>(arg0, arg1);
