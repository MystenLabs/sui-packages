module 0xcc7e6673be264e95ed840be03caef9689b2f29b90cba3fb0a71721ff0081bc87::swarm_network_token {
    struct SWARM_NETWORK_TOKEN has drop {
        dummy_field: bool,
    }

    fun init(arg0: SWARM_NETWORK_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SWARM_NETWORK_TOKEN>(arg0, 9, b"TRUTH", b"Swarm Network", b"Project: Swarm Network", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://truth-logo.swarmnetwork.ai/")), arg1);
        let v2 = v0;
