module 0xcc3aee9e75e182f3bb194fa4c6a4a319ad191a43a579829d964ff72de8a0f71e::nano_world_vol_2 {
    ...
    fun init(arg0: NANO_WORLD_VOL_2, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NANO_WORLD_VOL_2>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Nano World vol.2"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"In a city torn apart by corruption and injustice, three blonde crusaders stand united against the darkness that threatens to consume them all. With unwavering determination and unshakeable resolve, they march towards a brighter future, fueled by their unrelenting quest for truth and justice."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeicp6clw2ojvzqmfkoizt25banb7vylr7juxna7rfipk3epcysof44"));
