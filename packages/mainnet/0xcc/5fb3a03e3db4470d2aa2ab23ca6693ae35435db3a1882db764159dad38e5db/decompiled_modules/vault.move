module 0xcc5fb3a03e3db4470d2aa2ab23ca6693ae35435db3a1882db764159dad38e5db::vault {
    ...
    public fun flash_loan<T0>(arg0: &mut Vault, arg1: &AccessList, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanReceipt<T0>) {
        ...
        let v2 = 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v1, arg2), arg3);
        let v3 = FlashLoanReceipt<T0>{
            amount    : arg2,
    ...
    public fun repay_flash_loan<T0>(arg0: &mut Vault, arg1: 0x2::coin::Coin<T0>, arg2: FlashLoanReceipt<T0>, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(v3 >= v1, 2);
        0x2::balance::join<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.balance, 0x1::type_name::get<T0>()), v2);
        let v4 = FlashLoanRepaid{
            borrower     : 0x2::tx_context::sender(arg3),
            amount       : v0,
            repay_amount : v3,
            fee          : v3 - v0,
        };
        0x2::event::emit<FlashLoanRepaid>(v4);
    }
