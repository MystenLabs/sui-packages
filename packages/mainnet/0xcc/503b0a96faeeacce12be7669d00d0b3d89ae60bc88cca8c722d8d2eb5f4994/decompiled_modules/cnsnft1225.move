module 0xcc503b0a96faeeacce12be7669d00d0b3d89ae60bc88cca8c722d8d2eb5f4994::cnsnft1225 {
    struct CNSNFT1225 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1225, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1225>(arg0, arg1);
