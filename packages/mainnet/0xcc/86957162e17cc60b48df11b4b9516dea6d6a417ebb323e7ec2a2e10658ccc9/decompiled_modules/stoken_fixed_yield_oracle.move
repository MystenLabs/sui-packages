module 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_fixed_yield_oracle {
    ...
    public fun accept_cooldown<T0>(arg0: &mut FixedYieldOracle<T0>, arg1: &FixedYieldOracleManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert!(arg1.oracle_id == 0x2::object::id<FixedYieldOracle<T0>>(arg0), 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_errors::unauthorized());
    ...
    public fun accept_yield_parameters<T0>(arg0: &mut FixedYieldOracle<T0>, arg1: &FixedYieldOracleManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg3) == arg0.manager, 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_errors::unauthorized());
        assert!(0x1::option::is_some<PendingYieldParams>(&arg0.pending_yield_params), 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_errors::no_pending_fees_change());
        let v0 = 0x1::option::extract<PendingYieldParams>(&mut arg0.pending_yield_params);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.cooldown_secs, 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_errors::fee_change_timelock_active());
    ...
    public fun calculate_current_price<T0>(arg0: &FixedYieldOracle<T0>, arg1: u64) : u64 {
        ...
        arg0.initial_price + 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_math::mul_div((arg0.initial_price as u64) * arg0.annual_rate_bps, arg1 - arg0.start_timestamp, 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_math::seconds_per_year() * 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_math::bps_precision())
    }
    ...
    public fun create_fixed_yield_oracle<T0>(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (FixedYieldOracleAdminCap, FixedYieldOracleManagerCap) {
        assert!(arg1 != @0x0, 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_errors::invalid_argument());
        assert!(arg2 > 0, 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_errors::invalid_price());
        assert!(arg3 <= 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_math::bps_precision(), 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_errors::invalid_argument());
        assert!(arg4 >= 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_math::min_cooldown_secs() && arg4 <= 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_math::max_cooldown_secs(), 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_errors::invalid_argument());
    ...
    public fun update_vault_price_from_yield<T0, T1>(arg0: &mut FixedYieldOracle<T0>, arg1: &mut 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_vault::Vault<T0, T1>, arg2: &FixedYieldOracleManagerCap, arg3: &0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_vault::OracleCap, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_version<T0>(arg0);
        assert!(arg2.oracle_id == 0x2::object::id<FixedYieldOracle<T0>>(arg0), 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_errors::unauthorized());
        ...
        assert!(v0 > 0, 0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_errors::invalid_price());
        0xcc86957162e17cc60b48df11b4b9516dea6d6a417ebb323e7ec2a2e10658ccc9::stoken_vault::update_price<T0, T1>(arg1, arg3, v0, arg4, arg5);
