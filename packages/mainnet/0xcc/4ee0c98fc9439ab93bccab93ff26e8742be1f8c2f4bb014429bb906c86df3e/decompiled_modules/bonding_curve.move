module 0xcc4ee0c98fc9439ab93bccab93ff26e8742be1f8c2f4bb014429bb906c86df3e::bonding_curve {
    ...
    public fun sell<T0>(arg0: &mut Pool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v5 = mul_div(v4, 6000, 10000);
        let v6 = v3 - v4;
        assert!(v6 >= arg2, 4);
        0x2::balance::join<T0>(&mut arg0.token_reserve, 0x2::coin::into_balance<T0>(arg1));
        let v7 = 0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_reserve, v3);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.creator_fee_balance, 0x2::balance::split<0x2::sui::SUI>(&mut v7, v5));
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.platform_fee_balance, 0x2::balance::split<0x2::sui::SUI>(&mut v7, v4 - v5));
        arg0.total_volume_sui = arg0.total_volume_sui + v3;
        let v8 = TradeExecuted{
            pool_id           : 0x2::object::uid_to_address(&arg0.id),
            trader            : 0x2::tx_context::sender(arg3),
            is_buy            : false,
            sui_amount        : v6,
        ...
        0x2::event::emit<TradeExecuted>(v8);
