module 0xccb7c115d4fa0fa782f3e5239d5c888a95d5c505b68305d9a8475b33ae114ad6::reward8014 {
    struct REWARD8014 has drop {
        dummy_field: bool,
    }

    struct TICKET_8014 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8014(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8014>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8014>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8014, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8014>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8014>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8014>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8014>>(v5, 0x2::tx_context::sender(arg1));
    }
