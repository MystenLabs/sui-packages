module 0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::invest_platform {
    struct InvestmentPlatform has store, key {
        id: 0x2::object::UID,
        owner: address,
        total_invested: u64,
        sui_reserve: 0x2::balance::Balance<0x2::sui::SUI>,
        token_reserve: 0x2::balance::Balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>,
        is_closed: bool,
    ...
    public entry fun buy_tokens_from_amm(arg0: &mut InvestmentPlatform, arg1: &mut AMMPool, arg2: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = calculate_token_out(arg3, 0x2::balance::value<0x2::sui::SUI>(&arg1.sui_reserve), 0x2::balance::value<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&arg1.token_reserve));
        let v7 = v6 * 50 / 1000;
        let v8 = v6 - v7;
        assert!(v8 >= arg4, 9);
        assert!(0x2::balance::value<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&arg1.token_reserve) >= v6, 8);
        ...
        let v11 = 0x2::balance::split<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut arg1.token_reserve, v6);
        let v12 = v7 * 20 / 50;
        let v13 = v7 * 10 / 50;
        let v14 = v7 * 15 / 50;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(0x2::coin::from_balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(0x2::balance::split<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v11, v8), arg5), v0);
        if (v12 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(0x2::coin::from_balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(0x2::balance::split<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v11, v12), arg5), arg0.nft_wallet);
        };
        if (v13 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(0x2::coin::from_balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(0x2::balance::split<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v11, v13), arg5), arg0.lp_wallet);
        };
        if (v14 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(0x2::coin::from_balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(0x2::balance::split<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v11, v14), arg5), arg0.marketing_wallet);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(0x2::coin::from_balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(v11, arg5), @0x0);
        let v15 = AMMSwap{
            trader       : v0,
            sui_amount   : arg3,
            token_amount : v8,
    ...
    public entry fun initialize_amm_pool(arg0: &mut InvestmentPlatform, arg1: 0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(v0 == arg0.owner, 0);
        assert!(!arg0.is_closed, 2);
        assert!(!arg0.amm_initialized, 6);
        let v1 = 0x2::coin::value<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&arg1);
        ...
        let v3 = AMMPool{
            ...
            token_reserve : 0x2::balance::zero<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(),
        };
        0x2::balance::join<0x2::sui::SUI>(&mut v3.sui_reserve, 0x2::coin::into_balance<0x2::sui::SUI>(arg2));
        0x2::balance::join<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v3.token_reserve, 0x2::coin::into_balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(arg1));
    ...
    public entry fun sell_tokens_to_amm(arg0: &mut InvestmentPlatform, arg1: &mut AMMPool, arg2: vector<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = false;
        let v2 = 0;
        ...
        assert!(v1, 7);
        assert!(arg0.amm_initialized, 6);
        let v3 = 0x1::vector::pop_back<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(&mut arg2);
        while (!0x1::vector::is_empty<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(&arg2)) {
            0x2::coin::join<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v3, 0x1::vector::pop_back<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(&mut arg2));
        };
        0x1::vector::destroy_empty<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(arg2);
        let v4 = 0x2::coin::value<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&v3);
        assert!(v4 >= arg3, 11);
        if (v4 > arg3) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(0x2::coin::split<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v3, v4 - arg3, arg5), v0);
        };
        let v5 = 0x2::coin::into_balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(v3);
        let v6 = arg3 * 50 / 1000;
        let v7 = arg3 - v6;
        let v8 = v6 * 20 / 50;
        let v9 = v6 * 10 / 50;
        ...
        if (v8 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(0x2::coin::from_balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(0x2::balance::split<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v5, v8), arg5), arg0.nft_wallet);
        };
        if (v9 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(0x2::coin::from_balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(0x2::balance::split<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v5, v9), arg5), arg0.lp_wallet);
        };
        if (v10 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(0x2::coin::from_balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(0x2::balance::split<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v5, v10), arg5), arg0.marketing_wallet);
        };
        if (v11 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(0x2::coin::from_balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(0x2::balance::split<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v5, v11), arg5), @0x0);
        };
        let v12 = 0x2::balance::value<0x2::sui::SUI>(&arg1.sui_reserve);
        let v13 = (((v12 as u128) * (v7 as u128) / ((0x2::balance::value<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&arg1.token_reserve) as u128) + (v7 as u128))) as u64);
        assert!(v13 >= arg4, 9);
        assert!(v12 >= v13, 8);
        0x2::balance::join<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut arg1.token_reserve, v5);
    ...
    public entry fun update_spl_amount(arg0: &mut InvestmentPlatform, arg1: address, arg2: vector<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_closed, 1);
        assert!(arg3 > 0, 5);
        let v0 = 0x1::vector::pop_back<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(&mut arg2);
        while (!0x1::vector::is_empty<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(&arg2)) {
            0x2::coin::join<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v0, 0x1::vector::pop_back<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(&mut arg2));
        };
        0x1::vector::destroy_empty<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(arg2);
        let v1 = 0x2::coin::value<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&v0);
        assert!(v1 >= arg3, 11);
        if (v1 > arg3) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>>(0x2::coin::split<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut v0, v1 - arg3, arg4), 0x2::tx_context::sender(arg4));
        };
        0x2::balance::join<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&mut arg0.token_reserve, 0x2::coin::into_balance<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(v0));
    ...
    public entry fun withdraw_all_funds(arg0: &mut InvestmentPlatform, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::balance::value<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&arg0.token_reserve);
        if (v2 > 0) {
    ...
    public entry fun withdraw_amm_funds(arg0: &mut InvestmentPlatform, arg1: &mut AMMPool, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::balance::value<0x599d40c9d2737edc4cbce00af05a6d48c2d803d07f5ac0a0d835a5c55cd91480::spl::SPL>(&arg1.token_reserve);
        if (v1 > 0) {
