module 0xccd07589533cfe32637662227a66b889ca457a8f83f413793f589b5aef23d8d1::cnsnft8584 {
    struct CNSNFT8584 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8584, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8584>(arg0, arg1);
