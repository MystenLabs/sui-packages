module 0xccb5c64ee2b067b8e0c65175e5c358ef8bee11ceaf81b1035397c400dee2f1be::cnsnft6139 {
    struct CNSNFT6139 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6139, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6139>(arg0, arg1);
