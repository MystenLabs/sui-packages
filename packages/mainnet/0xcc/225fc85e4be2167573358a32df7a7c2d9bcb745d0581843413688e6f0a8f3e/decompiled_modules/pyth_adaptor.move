module 0xcc225fc85e4be2167573358a32df7a7c2d9bcb745d0581843413688e6f0a8f3e::pyth_adaptor {
    ...
    public(friend) fun get_pyth_price(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &PythFeedData, arg2: &0x2::clock::Clock) : (0xcc225fc85e4be2167573358a32df7a7c2d9bcb745d0581843413688e6f0a8f3e::price_feed::PriceFeedComponent, 0xcc225fc85e4be2167573358a32df7a7c2d9bcb745d0581843413688e6f0a8f3e::price_feed::PriceFeedComponent) {
        ...
        (0xcc225fc85e4be2167573358a32df7a7c2d9bcb745d0581843413688e6f0a8f3e::price_feed::new_component(normalize_decimals(v4, v5), v6), 0xcc225fc85e4be2167573358a32df7a7c2d9bcb745d0581843413688e6f0a8f3e::price_feed::new_component(normalize_decimals(v7, v5), v9))
    }

    fun normalize_decimals(arg0: u64, arg1: u8) : u64 {
        let v0 = 0xcc225fc85e4be2167573358a32df7a7c2d9bcb745d0581843413688e6f0a8f3e::price_feed::decimals();
        let v1 = if (arg1 < v0) {
    ...
    public(friend) fun refresh_pyth_price<T0>(arg0: &0x2::table::Table<0x1::type_name::TypeName, PythFeedData>, arg1: &mut 0x2::table::Table<0x1::type_name::TypeName, 0xcc225fc85e4be2167573358a32df7a7c2d9bcb745d0581843413688e6f0a8f3e::price_feed::PriceFeed>, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) {
        ...
        if (!0x2::table::contains<0x1::type_name::TypeName, 0xcc225fc85e4be2167573358a32df7a7c2d9bcb745d0581843413688e6f0a8f3e::price_feed::PriceFeed>(arg1, v0)) {
            0x2::table::add<0x1::type_name::TypeName, 0xcc225fc85e4be2167573358a32df7a7c2d9bcb745d0581843413688e6f0a8f3e::price_feed::PriceFeed>(arg1, v0, 0xcc225fc85e4be2167573358a32df7a7c2d9bcb745d0581843413688e6f0a8f3e::price_feed::new(v2, v3));
        } else {
            0xcc225fc85e4be2167573358a32df7a7c2d9bcb745d0581843413688e6f0a8f3e::price_feed::set(0x2::table::borrow_mut<0x1::type_name::TypeName, 0xcc225fc85e4be2167573358a32df7a7c2d9bcb745d0581843413688e6f0a8f3e::price_feed::PriceFeed>(arg1, v0), v2, v3);
        };
    }
