module 0xcc3b66670655a8b18e292d4b0f3307f8a87ba13a7bef0d1cee210eb90a1a7b59::acl {
    struct Wrzrubpzmciqute has key {
        id: 0x2::object::UID,
        pools: 0x2::table::Table<0x1::ascii::String, Wsazhtpyvmksyvi>,
    }

    struct Wsazhtpyvmksyvi has store {
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    public entry fun cnbamzzlruxgjgv(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Wrzrubpzmciqute, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Wsazhtpyvmksyvi>(&arg2.pools, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Wsazhtpyvmksyvi>(&mut arg2.pools, arg3);
        if (v0.initialized) {
    ...
    public entry fun eamxwnhmkofltob(arg0: &mut Wrzrubpzmciqute, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Wsazhtpyvmksyvi>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Wsazhtpyvmksyvi>(&mut arg0.pools, arg1);
        assert!(0x2::tx_context::sender(arg3) == v0.owner, 0);
        v0.initialized = arg2;
    }

    public entry fun ggyzewkccnamkzx<T0: store + key>(arg0: &mut Wrzrubpzmciqute, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Wsazhtpyvmksyvi>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Wsazhtpyvmksyvi>(&mut arg0.pools, arg1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Wrzrubpzmciqute{
            id    : 0x2::object::new(arg0),
            pools : 0x2::table::new<0x1::ascii::String, Wsazhtpyvmksyvi>(arg0),
        };
        0x2::transfer::share_object<Wrzrubpzmciqute>(v0);
    }

    public entry fun pqnpynksaybtixm(arg0: &mut Wrzrubpzmciqute, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Wsazhtpyvmksyvi{
        ...
        0x2::table::add<0x1::ascii::String, Wsazhtpyvmksyvi>(&mut arg0.pools, arg1, v0);
    }

    public entry fun tkeonpllwlqqmrg(arg0: &mut Wrzrubpzmciqute, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Wsazhtpyvmksyvi>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Wsazhtpyvmksyvi>(&mut arg0.pools, arg1);
    ...
    public entry fun uiqjalhbzgrrdnr<T0>(arg0: &mut Wrzrubpzmciqute, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Wsazhtpyvmksyvi>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Wsazhtpyvmksyvi>(&mut arg0.pools, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.delegate, 0);
    ...
    public entry fun zpgguqcloecronz(arg0: &mut Wrzrubpzmciqute, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<0x1::ascii::String, Wsazhtpyvmksyvi>(&mut arg0.pools, arg1, v4);
    }
