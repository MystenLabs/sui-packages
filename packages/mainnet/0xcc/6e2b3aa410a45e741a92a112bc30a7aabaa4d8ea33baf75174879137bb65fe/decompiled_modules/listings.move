module 0xcc6e2b3aa410a45e741a92a112bc30a7aabaa4d8ea33baf75174879137bb65fe::listings {
    ...
    public fun buy<T0: store + key>(arg0: &mut Store, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        buy_<T0>(arg0, arg1, arg2, 0, arg3);
    }

    fun buy_<T0: store + key>(arg0: &mut Store, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = 0x2::coin::into_balance<0x2::sui::SUI>(arg2);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::balance::split<0x2::sui::SUI>(&mut v10, v8));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v10, arg4), v6);
        let v11 = BuyEvent{
            listing_id  : arg1,
    ...
    public fun withdraw_commission(arg0: &mut Store, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
