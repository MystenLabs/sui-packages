module 0xcc38bb4633ed626c3278f6b1dd6ec34674aed30b9d087d49172644c234160aa9::suiba_nft {
    ...
    public entry fun add_more_tickets(arg0: &AdminCap, arg1: &mut SuibaCollection, arg2: u64, arg3: vector<address>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < arg2) {
            ...
            let v2 = SuibaTicket{
                ...
                expiration : 0x2::clock::timestamp_ms(arg4) + 259200000,
            };
    ...
    fun create_nft(arg0: &SuibaCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : SuibaNFT {
        ...
        let v1 = 0x1::string::utf8(b"https://suibacoin.com/nft/");
        ...
        let v3 = 0x1::string::utf8(b"Suiba #");
        0x1::string::append(&mut v3, u64_to_string(arg1));
        SuibaNFT{
            id          : 0x2::object::new(arg2),
            name        : v3,
            description : 0x1::string::utf8(b"The coolest blue dog on sui."),
            image_url   : v2,
            attributes  : v0,
            nft_id      : arg1,
        }
    ...
    public fun get_available_public_nfts(arg0: &SuibaCollection, arg1: &0x2::clock::Clock) : u64 {
        ...
        let v1 = v0;
        if (0x2::clock::timestamp_ms(arg1) > arg0.minting_start + 259200000) {
    ...
    public fun get_current_phase(arg0: &SuibaCollection, arg1: &0x2::clock::Clock) : u8 {
        ...
        if (v0 < arg0.minting_start) {
            0
        } else if (v0 <= arg0.minting_start + 259200000) {
            1
        } else {
            2
        }
    ...
    fun init(arg0: SUIBA_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<SuibaNFT>(&mut v4, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"Suibas"));
        0x2::display::add<SuibaNFT>(&mut v4, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"The coolest blue dog on sui."));
        0x2::display::add<SuibaNFT>(&mut v4, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://suibacoin.com/nft/collection.png"));
        0x2::display::add<SuibaNFT>(&mut v4, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b" "));
    ...
    entry fun mint_public(arg0: &mut SuibaCollection, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<SuibaNFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 > arg0.minting_start + 259200000) {
            v2 = v1 + 1000 - arg0.ticket_minted;
        };
        assert!(arg0.public_minted < v2, 1);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg1, 20000000000, arg7), @0xbf3f7889d1646a4d300bbd110c3bff9b6b3695677a9fb0b8ee0e72e9e529f900);
