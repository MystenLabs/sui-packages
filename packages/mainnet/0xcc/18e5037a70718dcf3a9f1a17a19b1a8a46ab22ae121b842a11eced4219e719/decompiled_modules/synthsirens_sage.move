module 0xcc18e5037a70718dcf3a9f1a17a19b1a8a46ab22ae121b842a11eced4219e719::synthsirens_sage {
    struct SYNTHSIRENS_SAGE has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"d17dd4fa-2a70-4ecc-9d2d-757377943982"),
        };
    ...
    fun init(arg0: SYNTHSIRENS_SAGE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SYNTHSIRENS_SAGE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SynthSirens Sage"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Enter the immersive world of the SynthSirens Saga, where cybernetic enchantresses reign."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmRnikmPJDGiDeP7MuLyZ1G1Dmm6Rkt59rxCmiQe4qCDU2"));
