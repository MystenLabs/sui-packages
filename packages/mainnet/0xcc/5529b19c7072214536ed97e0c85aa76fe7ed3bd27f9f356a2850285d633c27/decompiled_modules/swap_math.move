module 0xbdeaa7074a8c1ce8d3f714659325edaa3e26908ae2d9ffd30c883af9cbd537ba::swap_math {
    ...
    public(friend) fun optimal_swap<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: u32, arg2: u32, arg3: u64, arg4: u64) : (u64, u64, bool, u128) {
        ...
        let v3 = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lt(v1, v2)) {
            if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::gte(v1, 0xbdeaa7074a8c1ce8d3f714659325edaa3e26908ae2d9ffd30c883af9cbd537ba::i32_utils::mate_to_lib(0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_tick::get_min_tick(v0)))) {
                0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lte(v2, 0xbdeaa7074a8c1ce8d3f714659325edaa3e26908ae2d9ffd30c883af9cbd537ba::i32_utils::mate_to_lib(0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_tick::get_max_tick(v0)))
            } else {
                false
            }
        } else {
        ...
        let v5 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_tick::sqrt_price_from_tick_index(0xbdeaa7074a8c1ce8d3f714659325edaa3e26908ae2d9ffd30c883af9cbd537ba::i32_utils::lib_to_mate(v1));
        let v6 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_tick::sqrt_price_from_tick_index(0xbdeaa7074a8c1ce8d3f714659325edaa3e26908ae2d9ffd30c883af9cbd537ba::i32_utils::lib_to_mate(v2));
        let v7 = 0xf86be58c3d946cff2bd8b081ea084edeae9ee5143c7a130913c0333eaa53c02f::state::init_swap_state(0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_pool_liquidity<T0, T1, T2>(arg0), v4, 0xbdeaa7074a8c1ce8d3f714659325edaa3e26908ae2d9ffd30c883af9cbd537ba::i32_utils::mate_to_lib(0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_pool_current_index<T0, T1, T2>(arg0)), arg3, arg4, v5, v6, (0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_pool_fee<T0, T1, T2>(arg0) as u64));
