module 0xcc7b5b0c2953fb06d01682e1332074272ba9528359fddc3f54a5ede096d3a9bc::reward1187 {
    struct REWARD1187 has drop {
        dummy_field: bool,
    }

    struct TICKET_1187 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1187(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1187>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1187>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1187, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1187>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1187>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1187>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1187>>(v5, 0x2::tx_context::sender(arg1));
    }
