module 0xccf5721aa4fa10a6f5227bf72d11ea40b8d4ebd79ecea9f5e293b615bd226fc8::ron {
    struct RON has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: RON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://ipfs.io/ipfs/Qmekykrk3dSLbSBBBCMqm21XHDAKcQidNbo3ZqpTmxphEt                                                                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<RON>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Ron       ")))), trim_right(b"The flash cat                   "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
