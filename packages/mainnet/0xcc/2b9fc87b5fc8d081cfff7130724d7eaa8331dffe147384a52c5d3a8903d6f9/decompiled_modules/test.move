module 0xac953f68af7d7b494f9068f84fdfa81374084a2efcdb391ee215a6b1e5cac11a::test {
    ...
    public entry fun check(arg0: &mut Test, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Test3{
            id   : 0x2::object::new(arg1),
            test : *0x1::vector::borrow<0x1::string::String>(&arg0.test_strings, 1),
        };
        0x2::transfer::transfer<Test3>(v0, 0x2::tx_context::sender(arg1));
    }
