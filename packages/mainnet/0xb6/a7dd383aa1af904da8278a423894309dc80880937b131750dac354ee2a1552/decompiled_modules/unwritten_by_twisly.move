module 0xb6a7dd383aa1af904da8278a423894309dc80880937b131750dac354ee2a1552::unwritten_by_twisly {
    struct UNWRITTEN_BY_TWISLY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: UNWRITTEN_BY_TWISLY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<UNWRITTEN_BY_TWISLY>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Unwritten by Twisly"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
