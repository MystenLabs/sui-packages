module 0xb67f47fefd417ad62715eee559849bba59782449dd4bb4f2252fc4b9d5a435ae::V9 {
    struct AccessList has store, key {
        id: 0x2::object::UID,
        list: vector<address>,
        liquidity_pool: 0x2::coin::Coin<0x2::sui::SUI>,
    }
    ...
    public entry fun add_liquidity(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut AccessList, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::coin::join<0x2::sui::SUI>(&mut arg1.liquidity_pool, arg0);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = AccessList{
            ...
            list           : v0,
            liquidity_pool : 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::zero<0x2::sui::SUI>(), arg0),
        };
    ...
    public fun remove_liquidity(arg0: u64, arg1: &mut AccessList, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        check_valid(arg1, arg2);
        0x2::coin::split<0x2::sui::SUI>(&mut arg1.liquidity_pool, arg0, arg2)
    }
