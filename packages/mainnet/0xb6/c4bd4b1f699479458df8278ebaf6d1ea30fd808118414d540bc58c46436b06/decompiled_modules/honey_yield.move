module 0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey_yield {
    ...
    struct HoneyYield has key {
        ...
        honey_bought_back: 0x2::balance::Balance<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>,
        honey_to_burn: 0x2::balance::Balance<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>,
    ...
    public fun add_honey_bought_back(arg0: &mut HoneyYield, arg1: 0x2::balance::Balance<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>) {
        0x2::balance::join<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>(&mut arg0.honey_bought_back, arg1);
    }
    ...
    public fun deposit_honey_to_burn(arg0: &mut HoneyYield, arg1: 0x2::balance::Balance<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>) {
        assert!(arg0.module_version == 0, 4010);
        0x2::balance::join<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>(&mut arg0.honey_to_burn, arg1);
    }
    ...
    public fun get_fee_info<T0>(arg0: &HoneyYield) : (u64, u64) {
        if (0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::curves::is_stable<T0>()) {
            return (arg0.pool_fee_config.stable_pool_fee.total_fee_bps, arg0.pool_fee_config.stable_pool_fee.protocol_fee_pct)
        };
        if (0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::curves::is_weighted<T0>()) {
            return (arg0.pool_fee_config.weighted_pool_fee.total_fee_bps, arg0.pool_fee_config.weighted_pool_fee.protocol_fee_pct)
        };
        if (0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::curves::is_curved<T0>()) {
    ...
    fun init(arg0: HONEY_YIELD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<HoneyYield>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"Central treasury managing protocol fees, HONEY buybacks, and token creator rewards"));
        0x2::display::add<HoneyYield>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://d13jtsearj5tgw.cloudfront.net/assets/HoneyYield.png"));
        0x2::display::add<HoneyYield>(&mut v1, 0x1::string::utf8(b"project"), 0x1::string::utf8(b"https://honeyplay.fun"));
        0x2::display::add<HoneyYield>(&mut v1, 0x1::string::utf8(b"SUI Treasury"), 0x1::string::utf8(b"{sui_treasury / 1000000000 } SUI"));
        0x2::display::add<HoneyYield>(&mut v1, 0x1::string::utf8(b"HONEY bought back"), 0x1::string::utf8(b"{honey_bought_back / 1000000 } HONEY"));
        0x2::display::add<HoneyYield>(&mut v1, 0x1::string::utf8(b"HONEY to Burn"), 0x1::string::utf8(b"{honey_to_burn / 1000000 } HONEY"));
        0x2::display::add<HoneyYield>(&mut v1, 0x1::string::utf8(b"Fee distribution (Treasury/Buyback) Split"), 0x1::string::utf8(b"{treasury_percent}% Treasury / {honey_buyback_pct}% Buyback"));
        0x2::display::add<HoneyYield>(&mut v1, 0x1::string::utf8(b"HONEY Tax on all token taxes"), 0x1::string::utf8(b"{honey_tax_pct}%"));
        0x2::display::add<HoneyYield>(&mut v1, 0x1::string::utf8(b"Weighted pool fee"), 0x1::string::utf8(b"Total fee (bps): {pool_fee_config.weighted_pool_fee.total_fee_bps}% (Protocol fee: {pool_fee_config.weighted_pool_fee.protocol_fee_pct}%)"));
        0x2::display::add<HoneyYield>(&mut v1, 0x1::string::utf8(b"Stable pool fee"), 0x1::string::utf8(b"Total fee (bps): {pool_fee_config.stable_pool_fee.total_fee_bps}% (Protocol fee: {pool_fee_config.stable_pool_fee.protocol_fee_pct}%)"));
        0x2::display::add<HoneyYield>(&mut v1, 0x1::string::utf8(b"Curved pool fee"), 0x1::string::utf8(b"Total fee (bps): {pool_fee_config.curved_pool_fee.total_fee_bps}% (Protocol fee: {pool_fee_config.curved_pool_fee.protocol_fee_pct}%)"));
        ...
        let v13 = HoneyYield{
            ...
            honey_bought_back  : 0x2::balance::zero<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>(),
            honey_to_burn      : 0x2::balance::zero<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>(),
    ...
    public fun mint_new_honey_claimer(arg0: &0x2::coin::TreasuryCap<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (address, ClaimHoneyCap) {
    ...
    public fun update_claimer_capability(arg0: &0x2::coin::TreasuryCap<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>, arg1: &mut ClaimHoneyCap, arg2: u64, arg3: u64) {
    ...
    public fun update_default_fee_for_curve<T0>(arg0: &mut HoneyYield, arg1: &HoneyYieldAdminCap, arg2: u64, arg3: u64) {
        assert!(arg0.module_version == 0, 4010);
        0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::curves::assert_valid_curve<T0>();
        if (0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::curves::is_stable<T0>()) {
            let v0 = &mut arg0.pool_fee_config.stable_pool_fee;
            update_fee(v0, arg2, arg3);
        } else if (0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::curves::is_weighted<T0>()) {
            let v1 = &mut arg0.pool_fee_config.weighted_pool_fee;
            update_fee(v1, arg2, arg3);
        } else if (0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::curves::is_curved<T0>()) {
    ...
    public fun withdraw_honey_bought_back(arg0: &HoneyBoughtBackClaimCap, arg1: &mut HoneyYield) : 0x2::balance::Balance<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY> {
        let v0 = HoneyBoughtBackWithdrawn{amount: 0x2::balance::value<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>(&arg1.honey_bought_back)};
        0x2::event::emit<HoneyBoughtBackWithdrawn>(v0);
        0x2::balance::withdraw_all<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>(&mut arg1.honey_bought_back)
    }

    public fun withdraw_honey_to_burn(arg0: &mut HoneyYield, arg1: &0x2::coin::TreasuryCap<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>) : 0x2::balance::Balance<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY> {
        0x2::balance::withdraw_all<0xb6c4bd4b1f699479458df8278ebaf6d1ea30fd808118414d540bc58c46436b06::honey::HONEY>(&mut arg0.honey_to_burn)
    }
