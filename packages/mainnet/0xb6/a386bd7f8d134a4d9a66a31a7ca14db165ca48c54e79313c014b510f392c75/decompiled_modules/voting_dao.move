module 0x49a7dda98c6dfd2115cee9c00727cf493c01804e55c89b325b08397e414898eb::voting_dao {
    ...
    fun is_checkpoint_in_new_block(arg0: &VotingDAO, arg1: 0x2::object::ID, arg2: u64) : bool {
        ...
        let v1 = v0 > 0 && arg2 - 0x2::table::borrow<u64, Checkpoint>(0x2::table::borrow<0x2::object::ID, 0x2::table::Table<u64, Checkpoint>>(&arg0.checkpoints, arg1), v0 - 1).from_timestamp < 0x49a7dda98c6dfd2115cee9c00727cf493c01804e55c89b325b08397e414898eb::common::get_time_to_finality_ms();
        !v1
    }
