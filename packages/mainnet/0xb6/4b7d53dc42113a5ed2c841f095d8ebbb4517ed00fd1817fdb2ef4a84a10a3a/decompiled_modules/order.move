module 0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::order {
    ...
    public fun begin_tx<T0, T1>(arg0: &mut Order<T0, T1>, arg1: &0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::Config, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (OrderCap<T1>, 0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::assert_interacting_with_most_up_to_date_package(arg1);
        0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::assert_enough_time_has_passed_since_last_trade(arg1, arg0.last_trade_timestamp_ms, arg0.frequency_ms, arg2);
        ...
        0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::take_protocol_fee<T0>(arg1, &mut v2, arg5);
        (v0, v2, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.gas, arg4), arg5))
    }

    public fun close_order<T0, T1>(arg0: Order<T0, T1>, arg1: &0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::Config, arg2: &mut 0x2::tx_context::TxContext) {
        0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::assert_interacting_with_most_up_to_date_package(arg1);
        let Order {
            id                         : v0,
            user                       : v1,
        ...
        0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::events::emit_closed_order_event<T0, T1>(0x2::object::id<Order<T0, T1>>(&arg0), v1, v2, 0x2::balance::value<T0>(&v13), 0x2::balance::value<0x2::sui::SUI>(&v12), v4, v5, v6, v7, v8, v9, v10);
    }

    public fun create_order<T0, T1>(arg0: &0xbc33614900f37a4560cee4330963558bf7731b236a37a6a3c4c3064f9e89c4d::config::Config, arg1: &0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::Config, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: vector<u8>, arg6: address, arg7: u64, arg8: u64, arg9: u64, arg10: u16, arg11: u64, arg12: u64, arg13: u8, arg14: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg14);
        0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::assert_interacting_with_most_up_to_date_package(arg1);
        0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::assert_enough_gas_was_provided_to_cover_all_trades(arg1, &arg3, arg13);
        0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::assert_trading_frequency_is_above_minimum_frequency(arg1, arg7);
        ...
        0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::events::emit_created_order_event<T0, T1>(0x2::object::id<Order<T0, T1>>(&v1), v1.user, v1.recipient, arg5, 0x2::balance::value<T0>(&v1.balance), 0x2::balance::value<0x2::sui::SUI>(&v1.gas), v1.frequency_ms, v1.last_trade_timestamp_ms, v1.amount_per_trade, v1.max_allowable_slippage_bps, v1.min_amount_out, v1.max_amount_out, v1.remaining_trades);
        transfer<T0, T1>(v1, arg0, arg5);
    }

    public fun finish_tx<T0, T1>(arg0: &mut Order<T0, T1>, arg1: &0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::Config, arg2: OrderCap<T1>, arg3: 0x2::coin::Coin<T1>) {
        0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::assert_interacting_with_most_up_to_date_package(arg1);
        ...
        0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::events::emit_executed_trade_event<T0, T1>(0x2::object::id<Order<T0, T1>>(arg0), arg0.user, arg0.recipient, arg0.amount_per_trade, v0);
    }

    fun init(arg0: ORDER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::config::create_config<ORDER>(&arg0, arg1);
        0x2::transfer::public_transfer<0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::admin::AdminCap>(0xb64b7d53dc42113a5ed2c841f095d8ebbb4517ed00fd1817fdb2ef4a84a10a3a::admin::create_admin_cap<ORDER>(&arg0, arg1), v0);
