module 0xb62d618d6409a98b11d5f3723b70001109b0c7c00c3735006c2dab36517faace::token {
    ...
    fun init(arg0: TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<TOKEN>>(0x2::coin::mint<TOKEN>(&mut v2.cap, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
