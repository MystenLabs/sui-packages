module 0xb6e979e8d5908ec2ec5fef916d0e921db5815ec52210baf393dcc1e553ca47db::arbitrage {
    ...
    public fun execute_arbitrage_for_flash_loan(arg0: &mut Arbitrage, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: u64, arg4: u64, arg5: u8, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        if (v0 > arg3) {
            let v1 = v0 - arg3;
            if (v1 >= arg0.min_profit_threshold) {
    ...
    fun execute_cetus_swap_sequence(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        0x2::coin::value<0x2::sui::SUI>(&arg0);
        let v0 = swap_sui_to_usdc(arg0, arg1);
        swap_usdc_to_sui(v0, arg1)
    }
    ...
    fun execute_real_cetus_arbitrage(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        0x2::coin::value<0x2::sui::SUI>(&arg0);
        let v0 = execute_cetus_swap_sequence(arg0, arg3);
        assert!(0x2::coin::value<0x2::sui::SUI>(&v0) >= arg1, 4);
        v0
    }
    ...
    fun swap_sui_to_usdc(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        arg0
    }

    fun swap_usdc_to_sui(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        arg0
    }
