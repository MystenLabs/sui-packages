module 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index {
    ...
    struct Index has store, key {
        ...
        polygons: 0x2::table::Table<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>,
        cell_size: u64,
        max_depth: u8,
        count: u64,
        occupied_depths: u32,
    ...
    public(friend) fun destroy_empty(arg0: Index) {
        ...
        0x2::table::destroy_empty<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(v2);
    ...
    public fun remove(arg0: &LifecycleCap, arg1: &mut Index, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg1.polygons, arg2), 4005);
        assert!(0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::owner(0x2::table::borrow<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg1.polygons, arg2)) == 0x2::tx_context::sender(arg3), 4006);
        remove_unchecked(arg1, arg2);
    }

    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : Index {
        with_config(1000000, 20, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::max_vertices_per_part(), 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::max_parts(), 1024, 64, 2000000, arg0)
    }
    ...
    public(friend) fun broadphase_from_aabb(arg0: &Index, arg1: u32, arg2: u32, arg3: u32, arg4: u32) : vector<0x2::object::ID> {
        ...
        while (v3 <= arg0.max_depth) {
            ...
            while (v5 <= arg4 >> v4) {
                let v6 = arg1 >> v4;
                while (v6 <= arg3 >> v4) {
                    let v7 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::morton::depth_prefix(0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::morton::interleave_n(v6, v5, v3), v3);
    ...
    public fun candidates(arg0: &Index, arg1: 0x2::object::ID) : vector<0x2::object::ID> {
        assert!(0x2::table::contains<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, arg1), 4005);
        let v0 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::bounds(0x2::table::borrow<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, arg1));
    ...
    fun check_no_overlaps(arg0: &Index, arg1: &0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon, arg2: u32, arg3: u32, arg4: u32, arg5: u32) {
        let v0 = broadphase_from_aabb(arg0, arg2, arg3, arg4, arg5);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x2::object::ID>(&v0)) {
            if (0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::intersects(arg1, 0x2::table::borrow<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, *0x1::vector::borrow<0x2::object::ID>(&v0, v1)))) {
                abort 4012
            };
            v1 = v1 + 1;
        };
    ...
    public fun force_transfer(arg0: &TransferCap, arg1: &mut Index, arg2: 0x2::object::ID, arg3: address) {
        ...
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg1.authorized_caps, &v0), 4020);
        assert!(0x2::table::contains<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg1.polygons, arg2), 4005);
        0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::set_owner(0x2::table::borrow_mut<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&mut arg1.polygons, arg2), arg3);
        let v1 = Transferred{
            polygon_id : arg2,
            from       : 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::owner(0x2::table::borrow<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg1.polygons, arg2)),
            to         : arg3,
        };
        0x2::event::emit<Transferred>(v1);
    }

    public fun get(arg0: &Index, arg1: 0x2::object::ID) : &0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon {
        assert!(0x2::table::contains<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, arg1), 4005);
        0x2::table::borrow<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, arg1)
    }

    public(friend) fun grid_bounds_for_aabb(arg0: &Index, arg1: &0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::aabb::AABB) : (u32, u32, u32, u32) {
        let v0 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::aabb::min_x(arg1) / arg0.cell_size;
        let v1 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::aabb::min_y(arg1) / arg0.cell_size;
        let v2 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::aabb::max_x(arg1) / arg0.cell_size;
        let v3 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::aabb::max_y(arg1) / arg0.cell_size;
    ...
    public fun outer_contains_inner(arg0: &Index, arg1: 0x2::object::ID, arg2: &Index, arg3: 0x2::object::ID) : bool {
        0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::contains_polygon(get(arg0, arg1), get(arg2, arg3))
    }

    public fun overlapping(arg0: &Index, arg1: 0x2::object::ID) : vector<0x2::object::ID> {
        let v0 = candidates(arg0, arg1);
        let v1 = 0x2::table::borrow<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, arg1);
        let v2 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::bounds(v1);
        ...
        while (v4 < 0x1::vector::length<0x2::object::ID>(&v0)) {
            ...
            let v6 = 0x2::table::borrow<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, v5);
            let v7 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::bounds(v6);
            if (0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::aabb::intersects(&v2, &v7)) {
                if (0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::intersects(v1, v6)) {
    ...
    public fun overlaps(arg0: &Index, arg1: 0x2::object::ID, arg2: 0x2::object::ID) : bool {
        assert!(0x2::table::contains<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, arg1), 4005);
        assert!(0x2::table::contains<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, arg2), 4005);
        0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::intersects(0x2::table::borrow<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, arg1), 0x2::table::borrow<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, arg2))
    }
    ...
    public(friend) fun put_polygon(arg0: &mut Index, arg1: 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon) : 0x2::object::ID {
        let v0 = 0x2::object::id<0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg1);
        0x2::table::add<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&mut arg0.polygons, v0, arg1);
        v0
    }

    public fun query_viewport(arg0: &Index, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : vector<0x2::object::ID> {
        let v0 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::aabb::new(arg1, arg2, arg3, arg4);
        let (v1, v2, v3, v4) = grid_bounds_for_aabb(arg0, &v0);
    ...
    public fun register(arg0: &LifecycleCap, arg1: &mut Index, arg2: vector<vector<u64>>, arg3: vector<vector<u64>>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v2 = 0x1::vector::empty<0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Part>();
        let v3 = 0;
        let v4 = 0;
        while (v4 < v1) {
            ...
            assert!(v6 >= 3, 4001);
            v3 = v3 + v6;
            0x1::vector::push_back<0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Part>(&mut v2, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::part(v5, 0x1::vector::remove<vector<u64>>(&mut arg3, 0)));
            v4 = v4 + 1;
        };
        assert!(v3 <= arg1.config.max_vertices * v1, 4001);
        let v7 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::new(v2, arg4);
        assert!(0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::area(&v7) > 0, 4017);
        let v8 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::bounds(&v7);
        ...
        let v15 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::morton::depth_prefix(0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::morton::interleave_n(v9 >> v14, v10 >> v14, v13), v13);
        check_no_overlaps(arg1, &v7, v9, v10, v11, v12);
        let v16 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v16, v15);
        0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::set_cells(&mut v7, v16);
        let v17 = 0x2::object::id<0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&v7);
        register_in_cell(arg1, v17, v15, v13);
        0x2::table::add<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&mut arg1.polygons, v17, v7);
        arg1.count = arg1.count + 1;
        let v18 = Registered{
            polygon_id : v17,
            owner      : 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::owner(&v7),
            part_count : 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::parts(&v7),
            cell_count : 1,
            depth      : v13,
        };
    ...
    public(friend) fun remove_unchecked(arg0: &mut Index, arg1: 0x2::object::ID) {
        assert!(0x2::table::contains<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, arg1), 4005);
        let v0 = 0x2::table::borrow<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, arg1);
        let v1 = *0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::cells(v0);
        0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::metadata_store::force_remove_metadata(&mut arg0.id, arg1);
        unregister_from_cells(arg0, arg1, &v1);
        0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::destroy(0x2::table::remove<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&mut arg0.polygons, arg1));
        arg0.count = arg0.count - 1;
        let v2 = Removed{
            polygon_id : arg1,
            owner      : 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::owner(v0),
        };
    ...
    public(friend) fun set_polygon_geometry(arg0: &mut Index, arg1: 0x2::object::ID, arg2: vector<0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Part>, arg3: u64) : u64 {
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&mut arg0.polygons, arg1);
        0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::set_parts(v0, arg2);
        let v1 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v1, arg3);
        0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::set_cells(v0, v1);
        0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::area(v0)
    }
    ...
    public(friend) fun take_polygon(arg0: &mut Index, arg1: 0x2::object::ID) : 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon {
        assert!(0x2::table::contains<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg0.polygons, arg1), 4005);
        0x2::table::remove<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&mut arg0.polygons, arg1)
    }
    ...
    public fun transfer_ownership(arg0: &LifecycleCap, arg1: &mut Index, arg2: 0x2::object::ID, arg3: address, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg1.authorized_caps, &v0), 4020);
        assert!(0x2::table::contains<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg1.polygons, arg2), 4005);
        let v1 = 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::owner(0x2::table::borrow<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(&arg1.polygons, arg2));
    ...
    public(friend) fun with_config(arg0: u64, arg1: u8, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : Index {
        assert!(arg0 > 0, 4014);
        assert!(arg1 > 0 && arg1 <= 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::morton::max_depth(), 4009);
        Index{
            id                   : 0x2::object::new(arg7),
            cells                : 0x2::table::new<u64, vector<0x2::object::ID>>(arg7),
            polygons             : 0x2::table::new<0x2::object::ID, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::polygon::Polygon>(arg7),
            cell_size            : arg0,
            max_depth            : arg1,
            count                : 0,
            occupied_depths      : 0,
