module 0xb6018438c4c6eb4b0cf351deb666b3f0079ba871f72664941ff893f342a470e5::reward1382 {
    struct REWARD1382 has drop {
        dummy_field: bool,
    }

    struct TICKET_1382 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1382(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1382>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1382>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1382, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1382>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1382>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1382>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1382>>(v5, 0x2::tx_context::sender(arg1));
    }
