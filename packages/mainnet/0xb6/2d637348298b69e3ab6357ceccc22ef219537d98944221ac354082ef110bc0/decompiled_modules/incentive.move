module 0xb62d637348298b69e3ab6357ceccc22ef219537d98944221ac354082ef110bc0::incentive {
    ...
    public fun get_incentive_apy(arg0: &0x2::clock::Clock, arg1: &Incentive, arg2: &mut 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::Storage, arg3: &0x859de5e155d57462d3fe0aeb980b9a3f9cdccf76522d9499f372789183440aca::oracle::PriceOracle, arg4: u8) : vector<IncentiveAPYInfo> {
        ...
        while (v1 > 0) {
            ...
            while (v10 > 0) {
                ...
                let v14 = 0x2::table::borrow<address, IncentiveFundsPoolInfo>(&arg1.funds, v13.funds);
                let (_, v16, _) = 0x859de5e155d57462d3fe0aeb980b9a3f9cdccf76522d9499f372789183440aca::oracle::get_token_price(arg0, arg3, v14.oracle_id);
                v11 = v11 + v13.total_supply / (v13.end_at - v13.start_at) * (v16 as u64) * 31536000000 / (v5 as u64) * (v7 as u64);
                let v18 = 0x1::type_name::into_string(v14.coin_type);
                if (!0x1::vector::contains<0x1::ascii::String>(&v12, &v18)) {
                    0x1::vector::push_back<0x1::ascii::String>(&mut v12, 0x1::type_name::into_string(v14.coin_type));
                };
                v10 = v10 - 1;
            };
            let v19 = IncentiveAPYInfo{
                asset_id   : v2,
                apy        : v11,
                coin_types : v12,
            };
            0x1::vector::push_back<IncentiveAPYInfo>(&mut v0, v19);
            v1 = v1 - 1;
        };
        v0
    }
