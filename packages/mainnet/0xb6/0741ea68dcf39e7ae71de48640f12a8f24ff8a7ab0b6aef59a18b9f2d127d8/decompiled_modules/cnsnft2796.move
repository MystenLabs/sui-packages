module 0xb60741ea68dcf39e7ae71de48640f12a8f24ff8a7ab0b6aef59a18b9f2d127d8::cnsnft2796 {
    struct CNSNFT2796 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2796, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2342"));
        let v4 = 0x2::package::claim<CNSNFT2796>(arg0, arg1);
