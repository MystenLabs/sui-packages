module 0xb6084c2446f04d8aa28473536e199e6e2f3791a4870139e9489e34be6986d2fd::protective_ask_init_actions {
    ...
    public fun add_create_protective_ask_spec<T0, T1>(arg0: &mut 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::action_spec_builder::Builder, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg1 > 0, 5);
        assert!(arg2 > 0, 2);
    ...
    public fun do_create_protective_ask<T0, T1, T2: store, T3: drop>(arg0: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::executable::Executable<T2>, arg1: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg2: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry, arg3: &0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::spot_pool_mutation_auth::SpotPoolMutationRegistry, arg4: &0x2::clock::Clock, arg5: T3, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_validation::assert_action_type<CreateProtectiveAsk<T0, T1>>(v1);
        ...
        assert!(v4 > 0, 2);
        assert!(v3 > 0, 5);
        let v5 = 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::config<0xcb4dee85f5e93cab3a34f549d59eab8524898d493295f1db3eea4fe387085591::futarchy_config::FutarchyConfig>(arg1);
        let v6 = 0xcb4dee85f5e93cab3a34f549d59eab8524898d493295f1db3eea4fe387085591::futarchy_config::stable_type(v5);
        ...
        assert!(0xcb4dee85f5e93cab3a34f549d59eab8524898d493295f1db3eea4fe387085591::futarchy_config::asset_type(v5) == &v7, 4);
        assert!(v6 == &v8, 4);
        let v9 = 0xcb4dee85f5e93cab3a34f549d59eab8524898d493295f1db3eea4fe387085591::futarchy_config::get_spot_pool_id(v5);
        assert!(0x1::option::is_some<0x2::object::ID>(&v9), 3);
        let v10 = *0x1::option::borrow<0x2::object::ID>(&v9);
        let v11 = 0x2::object::id<0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account>(arg1);
        let v12 = 0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::protective_ask::create<T0, T1>(v11, v10, v3, v4, 0x2::bcs::peel_u64(&mut v2), 0xb6084c2446f04d8aa28473536e199e6e2f3791a4870139e9489e34be6986d2fd::liquidity_actions::new_spot_pool_mutation_auth(arg3, v10), arg4, arg6);
        let v13 = 0x2::object::id<0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::protective_ask::ProtectiveAsk<T0, T1>>(&v12);
        ...
        0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::protective_ask_registry::set_from_execution<T2, ExecutionProgressWitness>(arg1, arg2, arg0, v15, v13, v10);
        0x2::transfer::public_share_object<0x7391e15cb4b1254dfdd5926b58c849c31d10839ddc5f99d4ecc87f9823956db1::protective_ask::ProtectiveAsk<T0, T1>>(v12);
        let v16 = ExecutionProgressWitness{dummy_field: false};
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::executable::increment_action_idx<T2, CreateProtectiveAsk<T0, T1>, ExecutionProgressWitness>(arg0, arg2, v16);
        v13
    }
