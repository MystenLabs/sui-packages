module 0xb6bbb0e4c18fb92b2b7d851813391221463c6401b2f6a1dc2acd2e730fcc1503::sui_pepe {
    ...
    fun init(arg0: SUI_PEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUI_PEPE>(arg0, 5, b"SPEPE", b"SUI PEPE", b"The biggest memecoin on SUI blockchain.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://sui-pepe.xyz/_next/static/media/logo.6e0d8f53.png")), arg1);
        let v2 = v0;
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<SUI_PEPE>>(v1);
        let v3 = &mut v2;
        mint(v3, 10000000000000000000, @0xf44119724657477034e343c0287f1a8bddb0cf3db47e265225d336b57e9b42de, arg1);
