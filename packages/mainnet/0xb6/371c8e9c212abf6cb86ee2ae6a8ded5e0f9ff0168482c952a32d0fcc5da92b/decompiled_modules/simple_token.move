module 0xb6371c8e9c212abf6cb86ee2ae6a8ded5e0f9ff0168482c952a32d0fcc5da92b::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"SCAT", b"Sui Cat", b"First Cat Token on the sui network", 0x1::option::none<0x2::url::Url>(), arg1);
