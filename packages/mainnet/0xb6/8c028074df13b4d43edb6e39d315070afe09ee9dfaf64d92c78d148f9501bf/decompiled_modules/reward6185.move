module 0xb68c028074df13b4d43edb6e39d315070afe09ee9dfaf64d92c78d148f9501bf::reward6185 {
    struct REWARD6185 has drop {
        dummy_field: bool,
    }

    struct TICKET_6185 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6185(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6185>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6185>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6185, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6185>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6185>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6185>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6185>>(v5, 0x2::tx_context::sender(arg1));
    }
