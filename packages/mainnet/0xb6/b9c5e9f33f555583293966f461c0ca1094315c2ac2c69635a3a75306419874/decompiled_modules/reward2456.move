module 0xb6b9c5e9f33f555583293966f461c0ca1094315c2ac2c69635a3a75306419874::reward2456 {
    struct REWARD2456 has drop {
        dummy_field: bool,
    }

    struct TICKET_2456 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2456(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2456>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2456>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2456, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2456>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2456>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2456>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2456>>(v5, 0x2::tx_context::sender(arg1));
    }
