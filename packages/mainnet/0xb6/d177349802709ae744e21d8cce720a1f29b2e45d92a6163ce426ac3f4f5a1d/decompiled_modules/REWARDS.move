module 0xb6d177349802709ae744e21d8cce720a1f29b2e45d92a6163ce426ac3f4f5a1d::REWARDS {
    ...
    public entry fun remove_coin_from_field<T0, T1, T2>(arg0: &mut Pool<T1, T2>, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::Coin<T0>>(&mut arg0.id, arg1), 0x2::tx_context::sender(arg2));
    }
