module 0xb6a17b4e7da858f803beba6a42a27b982afa1f33906eea6a303d90fe558237b8::signature_withdraw {
    ...
    public fun withdraw_with_burn<T0>(arg0: &mut WithdrawState<T0>, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 > 0, 8);
        assert!(0x2::balance::value<T0>(&arg0.balance) >= arg1 + arg2, 4);
        let v1 = 0x2::clock::timestamp_ms(arg5) / 1000;
        verify_timestamp(arg4, v1, arg0.config.signature_expiration);
        let v2 = if (0x2::table::contains<address, UserWithdrawRecord>(&arg0.user_records, v0)) {
        ...
        let v3 = v2;
        check_cooldown<T0>(arg0, &v3, v1);
        let v4 = &mut v3;
        check_rate_limit<T0>(arg0, v4, v1, arg0.config.hourly_withdraw_limit);
        check_daily_limit<T0>(arg0, v0, arg1, v1);
        check_user_withdraw_limit<T0>(arg0, v0, arg1, v1, arg5);
        let v5 = create_withdraw_message_with_burn<T0>(arg1, v0, v3.nonce, arg4, arg2);
        assert!(0x2::ed25519::ed25519_verify(&arg3, &arg0.public_key, &v5), 1);
        ...
        v3.nonce = v3.nonce + 1;
        v3.total_withdrawn = v3.total_withdrawn + arg1;
        v3.last_withdraw_time = v1;
        if (0x2::table::contains<address, UserWithdrawRecord>(&arg0.user_records, v0)) {
            *0x2::table::borrow_mut<address, UserWithdrawRecord>(&mut arg0.user_records, v0) = v3;
        } else {
            0x2::table::add<address, UserWithdrawRecord>(&mut arg0.user_records, v0, v3);
        };
        ...
        let v6 = WithdrawBurnEvent{
            ...
            timestamp                  : v1,
            nonce                      : v3.nonce - 1,
            user_total_withdrawn       : v3.total_withdrawn,
        ...
        0x2::event::emit<WithdrawBurnEvent>(v6);
    }
