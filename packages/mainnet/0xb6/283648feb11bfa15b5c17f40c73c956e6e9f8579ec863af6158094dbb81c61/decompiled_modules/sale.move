module 0xb6283648feb11bfa15b5c17f40c73c956e6e9f8579ec863af6158094dbb81c61::sale {
    ...
    public entry fun add_sale_land_config<T0>(arg0: &AdminCapability, arg1: &mut SaleConfigLand<T0>, arg2: u8, arg3: u8, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<u64, SaleInfoLand>(&mut arg1.sale_infos, v0, v1);
        arg1.index = v0;
    }

    public entry fun add_sale_miner_config<T0>(arg0: &AdminCapability, arg1: &mut SaleConfigMiner<T0>, arg2: u8, arg3: u8, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        0x2::tx_context::sender(arg6);
        assert!(arg4 > 0, 2);
        let v0 = arg1.index + 1;
        let v1 = SaleInfoMiner{
            sale_id    : arg2,
            sale_type  : arg3,
            price      : arg4,
            is_enabled : arg5,
        };
        0x2::table::add<u64, SaleInfoMiner>(&mut arg1.sale_infos, v0, v1);
        arg1.index = v0;
    }
