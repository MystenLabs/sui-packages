module 0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::reward_distribution {
    ...
    struct CoinVault<phantom T0> has store {
        ...
        vault: 0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::Vault<T0>,
        total_rewards: u64,
    ...
    public entry fun admin_withdraw_unclaimed_rewards<T0>(arg0: &OperatorCap, arg1: &mut RewardDistributor, arg2: u32, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::vault_amount<T0>(&v2.vault);
        if (v3 > 0) {
            v2.distributed_rewards = v2.distributed_rewards + v3;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::withdraw<T0>(&mut v2.vault, v3), arg4), arg3);
        ...
        while (v2 < 0x1::vector::length<u32>(&arg1)) {
            ...
            if (!v9) {
                if (0x1::vector::contains<0x1::string::String>(v7, &v1) && 0x2::dynamic_field::exists_with_type<CoinTypeKey<T0>, CoinVault<T0>>(&arg0.id, v8)) {
                    ...
                    let v13 = v12;
                    if (v12 > 0) {
                        if (v12 >= 0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::vault_amount<T0>(&v11.vault)) {
                            v13 = 0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::vault_amount<T0>(&v11.vault);
                        };
                        v11.distributed_rewards = v11.distributed_rewards + v13;
                        0x2::balance::join<T0>(&mut v3, 0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::withdraw<T0>(&mut v11.vault, v13));
    ...
    public entry fun deposit_reward<T0>(arg0: &OperatorCap, arg1: &mut RewardDistributor, arg2: u32, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x1::vector::contains<0x1::string::String>(v2, &v0)) {
            let v4 = 0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::new<T0>(arg4);
            0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::deposit<T0>(&mut v4, 0x2::coin::into_balance<T0>(arg3));
            let v5 = CoinVault<T0>{
                coin_type           : v0,
                vault               : v4,
                total_rewards       : v1,
            ...
            0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::deposit<T0>(&mut v6.vault, 0x2::coin::into_balance<T0>(arg3));
    ...
    public fun get_period_reward_info<T0>(arg0: &RewardDistributor, arg1: u32, arg2: 0x1::string::String) : (u64, u64, u64) {
        ...
        if (arg2 == get_coin_type_name<T0>() && 0x2::dynamic_field::exists_with_type<CoinTypeKey<T0>, CoinVault<T0>>(&arg0.id, v0)) {
            ...
            return (v1.total_rewards, v1.distributed_rewards, 0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::vault_amount<T0>(&v1.vault))
        };
        (0, 0, 0)
    }
                    ...
                    if (0x2::table::contains<u32, vector<0x1::string::String>>(&arg0.period_vaults, v4)) {
                        ...
                        if (0x1::vector::contains<0x1::string::String>(0x2::table::borrow<u32, vector<0x1::string::String>>(&arg0.period_vaults, v4), &v1) && 0x2::dynamic_field::exists_with_type<CoinTypeKey<T0>, CoinVault<T0>>(&arg0.id, v7)) {
                            ...
                            if (!v8) {
                                ...
                                if (v11 > 0) {
                                    let v12 = 0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::vault_amount<T0>(&v10.vault);
                                    let v13 = if (v11 > v12) {
                                        v12
                                    } else {
                                        v11
