module 0xb61a44f816ded9db6d4d3e9325c47ee5622579080b8eb19cc1afc8cc29f9efe9::cnsnft4396 {
    struct CNSNFT4396 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4396, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4396>(arg0, arg1);
