module 0xb6cbf33cce580688d3b941b9bb4fdc27a3be7a9d4224a731ae5c4ee1157d81a4::cnsnft8152 {
    struct CNSNFT8152 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8152, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8152>(arg0, arg1);
