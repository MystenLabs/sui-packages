module 0xb68785fe12f8fd68602cc7e7a88c2ef7ee8c333ed5fd6018677a2ac66fceeabe::gap {
    ...
    public entry fun authorize_user(arg0: &AdminCap, arg1: &mut NFTInfo, arg2: address, arg3: u64) {
        0x2::vec_map::insert<address, u64>(&mut arg1.whitelist, arg2, arg3);
    }
    ...
    public entry fun burn(arg0: GAPNFT, arg1: &mut NFTInfo, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xb68785fe12f8fd68602cc7e7a88c2ef7ee8c333ed5fd6018677a2ac66fceeabe::base_nft::emit_burn_nft<GAPNFT>(v0);
    }
    ...
    public entry fun deauthorize_user(arg0: &AdminCap, arg1: &mut NFTInfo, arg2: address) {
        let (_, _) = 0x2::vec_map::remove<address, u64>(&mut arg1.whitelist, &arg2);
    }
    ...
    public entry fun transfer_nft(arg0: GAPNFT, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xb68785fe12f8fd68602cc7e7a88c2ef7ee8c333ed5fd6018677a2ac66fceeabe::base_nft::emit_transfer_object<GAPNFT>(0x2::object::id<GAPNFT>(&arg0), arg1);
    }
    ...
    public entry fun user_mint_nft_batch(arg0: &mut NFTInfo, arg1: vector<vector<u8>>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_map::contains<address, u64>(&arg0.whitelist, &v0), 4);
        let v1 = *0x2::vec_map::get<address, u64>(&arg0.whitelist, &v0);
        let v2 = v1;
        ...
        if (v2 > 0) {
            0x2::vec_map::insert<address, u64>(&mut arg0.whitelist, v0, v2);
        } else {
            let (_, _) = 0x2::vec_map::remove<address, u64>(&mut arg0.whitelist, &v0);
        };
        0xb68785fe12f8fd68602cc7e7a88c2ef7ee8c333ed5fd6018677a2ac66fceeabe::base_nft::emit_batch_mint_nft(v4, v3, 0x2::tx_context::sender(arg2), arg0.name);
    }
