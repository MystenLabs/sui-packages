module 0xb6027334d6b0a501083ee7ccb254d85dde16bf01ee0317f61646459f5d369f94::supersui {
    struct Registry has key {
        ...
        ssui_treasury: 0x2::balance::Balance<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>,
    ...
    public entry fun admin_deposit_ssui_treasury(arg0: &mut Registry, arg1: 0x2::coin::Coin<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 5);
        let v0 = 0x2::coin::value<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(&arg1);
        assert!(v0 > 0, 15);
        0x2::balance::join<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(&mut arg0.ssui_treasury, 0x2::coin::into_balance<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(arg1));
    ...
    public entry fun buy_supersui_with_sui(arg0: &mut Registry, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(&arg0.ssui_treasury) >= v2, 13);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>>(0x2::coin::take<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(&mut arg0.ssui_treasury, v2, arg2), v0);
    ...
    public entry fun distribute_leader_rewards(arg0: &mut Registry, arg1: &mut 0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::TokenRegistry, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v15 = 0x2::balance::value<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(&arg0.ssui_treasury);
        ...
        while (v26 < 0x1::vector::length<address>(&v17)) {
            ...
            let v29 = 0x2::balance::value<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(&arg0.ssui_treasury);
            let v30 = if (v28 > v29) {
                v29
            } else {
                v28
    ...
    fun distribute_registration_fee(arg0: &mut 0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::TokenRegistry, arg1: &mut Registry, arg2: address, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    fun distribute_supersui_tokens(arg0: &mut 0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::TokenRegistry, arg1: &mut Registry, arg2: address, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = arg3 * 3 / 100;
        let v1 = v0;
        let v2 = arg3 * 3 / 100;
        let v3 = v2;
        ...
        let v5 = v4;
        let v6 = v0 + v2 + v4;
        let v7 = 0x2::balance::value<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(&arg1.ssui_treasury);
        if (v7 == 0) {
            return
        };
        if (v6 > v7) {
    ...
    fun distribute_upgrade_fee(arg0: &mut 0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::TokenRegistry, arg1: &mut Registry, arg2: address, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: u8, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x2::sui::SUI>(&arg3);
        let v1 = v0 * 15 / 100;
        let v2 = 0x2::table::borrow_mut<address, UserInfo>(&mut arg1.users, arg2);
        v2.mining_balance = v2.mining_balance + v1;
    ...
    public entry fun exchange_supersui_to_sui(arg0: &mut Registry, arg1: 0x2::coin::Coin<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(!arg0.paused, 21);
        assert!(is_user_exists(arg0, v0), 3);
        let v1 = 0x2::coin::value<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(&arg1);
        assert!(v1 > 0, 15);
        assert!(v1 >= 1000000000, 25);
        assert!(v1 <= 100000000000, 26);
        if (v0 != arg0.owner) {
    ...
    public fun get_ssui_treasury_balance(arg0: &Registry) : u64 {
        0x2::balance::value<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(&arg0.ssui_treasury)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Registry{
            ...
            ssui_treasury               : 0x2::balance::zero<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(),
    ...
    public entry fun register(arg0: &mut Registry, arg1: &mut 0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::TokenRegistry, arg2: address, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    fun transfer_ssui_from_treasury(arg0: &mut Registry, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::balance::value<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(&arg0.ssui_treasury) < arg2) {
            return
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>>(0x2::coin::take<0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::SSUI>(&mut arg0.ssui_treasury, arg2, arg3), arg1);
    }
    ...
    public entry fun upgrade(arg0: &mut Registry, arg1: &mut 0xfb8f2ac27264d91d457cb39bf1905eb1808da4ee7b96acd41b72e49e8d715274::ssui::TokenRegistry, arg2: u8, arg3: u8, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(!arg0.paused, 21);
        assert!(is_user_exists(arg0, v0), 3);
        assert!(arg3 > 1 && arg3 <= 16, 6);
