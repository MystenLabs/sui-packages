module 0xb6ad26decea556323854fda0e08f4c2f7837cc00d2ca7ed411be6b3035574046::game {
    ...
    fun init(arg0: GAME, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::table::new<u64, Epoch>(arg1);
        0x2::table::add<u64, Epoch>(&mut v1, 0, v0);
        let v2 = GameData{
            id                      : 0x2::object::new(arg1),
    ...
    public fun resolve_epoch_and_create_next(arg0: &mut GameData, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.admin, 9);
        let v0 = arg0.current_epoch_id;
        let v1 = 0x2::table::borrow_mut<u64, Epoch>(&mut arg0.epochs, v0);
        assert!(0x2::clock::timestamp_ms(arg2) >= v1.end_time_ms, 2);
        assert!(!v1.is_resolved, 6);
        v1.is_resolved = true;
        v1.final_price = arg1;
        let v2 = arg1 > v1.betting_price;
        ...
        while (v11 < 0x1::vector::length<BetInfo>(&v1.bets)) {
            ...
            if (v12.is_high_bet == v2 && v4 > 0) {
                if (0x2::table::contains<u64, u64>(&v17.unclaimed_winnings, v0)) {
                    let v18 = 0x2::table::borrow_mut<u64, u64>(&mut v17.unclaimed_winnings, v0);
                    *v18 = *v18 + v12.tickets;
                } else {
        ...
        0x2::event::emit<EpochResolved>(v19);
        let v20 = v0 + 1;
        let v21 = 0x2::clock::timestamp_ms(arg2);
        let v22 = Epoch{
            id                        : 0x2::object::new(arg3),
            epoch_id                  : v20,
            start_time_ms             : v21,
            end_time_ms               : v21 + 86400000,
            betting_close_time_ms     : v21 + 43200000,
            betting_price             : arg1,
            high_pool_balance         : 0x2::balance::zero<0x2::sui::SUI>(),
            low_pool_balance          : 0x2::balance::zero<0x2::sui::SUI>(),
            total_high_tickets        : 0,
        ...
        0x2::table::add<u64, Epoch>(&mut arg0.epochs, v20, v22);
        arg0.current_epoch_id = v20;
    }

    public fun set_ticket_price(arg0: &mut GameData, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 9);
        arg0.ticket_price_in_mist = arg1;
        let v0 = TicketPriceChanged{new_price_in_mist: arg1};
        0x2::event::emit<TicketPriceChanged>(v0);
    }

    public fun withdraw_fees(arg0: &mut GameData, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.admin, 9);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.platform_fees) >= arg1, 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.platform_fees, arg1), arg2), v0);
