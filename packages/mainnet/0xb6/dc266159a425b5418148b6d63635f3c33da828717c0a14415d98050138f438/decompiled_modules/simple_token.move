module 0xb6dc266159a425b5418148b6d63635f3c33da828717c0a14415d98050138f438::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"BULLRUN2024", b"Bullrun 2024", b"Officia token", 0x1::option::none<0x2::url::Url>(), arg1);
