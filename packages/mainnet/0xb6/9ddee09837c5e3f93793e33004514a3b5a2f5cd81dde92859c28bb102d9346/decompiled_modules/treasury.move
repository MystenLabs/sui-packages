module 0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::treasury {
    ...
    struct Treasury<phantom T0> has store, key {
        id: 0x2::object::UID,
        roles: 0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::lk_roles::Roles<T0>,
    ...
    public fun new<T0>(arg0: 0x2::coin::TreasuryCap<T0>, arg1: 0x2::token::TokenPolicyCap<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : Treasury<T0> {
        let v0 = Treasury<T0>{
            ...
            roles                 : 0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::lk_roles::new<T0>(arg2, arg3),
            active_authorizations : 0x2::table::new<0x2::object::ID, bool>(arg3),
            compatible_versions   : 0x2::vec_set::singleton<u64>(0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::token_version_control::current_version()),
        };
    ...
    public fun abort_migration<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(v0 == 0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::token_version_control::current_version(), 6);
    ...
    public fun accept_ownership<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::lk_roles::pending_owner<T0>(&arg0.roles);
        ...
        assert!(v1, 1);
        0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::two_step_role::accept_role<0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::lk_roles::OwnerRole<T0>>(0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::lk_roles::owner_role_mut<T0>(&mut arg0.roles), arg1);
    }
    ...
    public(friend) fun assert_is_compatible<T0>(arg0: &Treasury<T0>) {
        0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::token_version_control::assert_object_version_is_compatible_with_package(arg0.compatible_versions);
    }
    ...
    public fun complete_migration<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(0x1::u64::max(v0, v1) == 0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::token_version_control::current_version(), 6);
    ...
    fun create_from_coin_cap<T0>(arg0: &mut Treasury<T0>, arg1: &mut 0x2::tx_context::TxContext) : FromCoinCap<T0> {
        assert!(0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::lk_roles::owner<T0>(&arg0.roles) == 0x2::tx_context::sender(arg1), 1);
    ...
    public fun mint_coin_to_receiver<T0>(arg0: &mut Treasury<T0>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert_is_compatible<T0>(arg0);
        assert!(0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::lk_roles::owner<T0>(&arg0.roles) == 0x2::tx_context::sender(arg3), 1);
    ...
    public fun revoke_authorization<T0>(arg0: &mut Treasury<T0>, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::lk_roles::owner<T0>(&arg0.roles) == 0x2::tx_context::sender(arg2), 1);
    ...
    public fun start_migration<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(*0x1::vector::borrow<u64>(0x2::vec_set::keys<u64>(&arg0.compatible_versions), 0) < 0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::token_version_control::current_version(), 5);
        0x2::vec_set::insert<u64>(&mut arg0.compatible_versions, 0xb69ddee09837c5e3f93793e33004514a3b5a2f5cd81dde92859c28bb102d9346::token_version_control::current_version());
