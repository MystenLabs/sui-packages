module 0xb677216bb9992c1576c1bd009fbce2e6dc58f004b92d2650156ebb88e43a08e3::lol {
    struct LOL has drop {
        dummy_field: bool,
    }
    ...
    struct Director has store, key {
        ...
        paused: bool,
        tx_count: u64,
        treasury: 0x2::coin::TreasuryCap<LOL>,
    ...
    public fun claim_user_counter(arg0: &mut Director, arg1: UserCounter, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LOL> {
        ...
        0x2::coin::mint<LOL>(&mut arg0.treasury, (((10000000000000 as u128) * (0x2::table::remove<address, u64>(&mut v0.user_counts, 0x2::tx_context::sender(arg2)) as u128) / (v0.tx_count as u128)) as u64), arg2)
    }
    ...
    fun init(arg0: LOL, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<LOL>(arg0, 4, b"LOL", b"LOL", b"", 0x1::option::none<0x2::url::Url>(), arg1);
    ...
    entry fun new_user_counter(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = UserCounter{
        ...
        0x2::transfer::transfer<UserCounter>(v0, 0x2::tx_context::sender(arg0));
    }
    ...
    public fun stats_for_specific_epochs(arg0: &Director, arg1: vector<u64>, arg2: &0x2::tx_context::TxContext) : Stats {
        ...
        Stats{
            ...
            supply   : 0x2::coin::total_supply<LOL>(&arg0.treasury),
            epochs   : v0,
        }
    }
