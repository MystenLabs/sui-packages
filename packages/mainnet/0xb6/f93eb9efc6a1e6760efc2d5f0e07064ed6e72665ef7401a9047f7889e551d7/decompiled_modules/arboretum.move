module 0x6f13fefeb11114a97c3177b7d4a8cfdacd5b40174ab3f80b07420b456d469a2b::arboretum {
    ...
    entry fun buy_crate(arg0: &mut Registry, arg1: u8, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        route_paid_action(arg0, v1, arg3);
        ...
        let v4 = CratePurchased{
            crate_id : 0x2::object::id<Crate>(&v3),
            buyer    : v2,
            tier     : arg1,
        };
        0x2::event::emit<CratePurchased>(v4);
        0x2::transfer::transfer<Crate>(v3, v2);
    }
    ...
    entry fun buy_supply_drop(arg0: &mut Registry, arg1: u8, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::coin::split<0x2::sui::SUI>(&mut arg2, v3, arg3);
        route_paid_action(arg0, v4, arg3);
        ...
        let v7 = SupplyDropPurchased{
            tool_id    : 0x2::object::id<Tool>(&v6),
            buyer      : v5,
            drop       : arg1,
            tool_kind  : 0x1::string::utf8(v0),
            price_mist : v3,
        };
        0x2::event::emit<SupplyDropPurchased>(v7);
        0x2::transfer::transfer<Tool>(v6, v5);
    }
    ...
    entry fun reset_season(arg0: &AdminCap, arg1: &mut Registry, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::clock::timestamp_ms(arg2) - arg1.season_start_ms >= 2592000000 + 604800000, 21);
