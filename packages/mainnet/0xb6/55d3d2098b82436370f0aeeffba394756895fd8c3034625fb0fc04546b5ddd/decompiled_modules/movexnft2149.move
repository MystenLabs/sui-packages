module 0xb655d3d2098b82436370f0aeeffba394756895fd8c3034625fb0fc04546b5ddd::movexnft2149 {
    struct MOVEXNFT2149 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT2149, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT2149>(arg0, arg1);
