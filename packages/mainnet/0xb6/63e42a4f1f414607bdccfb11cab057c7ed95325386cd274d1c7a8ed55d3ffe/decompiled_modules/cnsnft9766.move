module 0xb663e42a4f1f414607bdccfb11cab057c7ed95325386cd274d1c7a8ed55d3ffe::cnsnft9766 {
    struct CNSNFT9766 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9766, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9766>(arg0, arg1);
