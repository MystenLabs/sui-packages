module 0xb60fd32e5b3a0d263ac1d5b1132f45fca743c54c490ef84cc04209759200e3f5::cnsnft2770 {
    struct CNSNFT2770 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2770, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2770>(arg0, arg1);
