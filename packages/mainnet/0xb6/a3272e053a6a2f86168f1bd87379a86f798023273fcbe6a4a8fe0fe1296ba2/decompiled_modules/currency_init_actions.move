module 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::currency_init_actions {
    ...
    struct PrepareV2ToV3MigrationAction has copy, drop, store {
        executor: address,
        v2_account_id: 0x2::object::ID,
        v3_account_id: 0x2::object::ID,
        expected_treasury_cap_id: 0x2::object::ID,
        expected_metadata_cap_id: 0x2::object::ID,
        asset_resource_name: 0x1::string::String,
        stable_resource_name: 0x1::string::String,
        treasury_stable_resource_name: 0x1::string::String,
    ...
    public fun add_prepare_v2_to_v3_migration_spec<T0, T1>(arg0: &mut 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::action_spec_builder::Builder, arg1: address, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: u64, arg10: u64) {
        assert!(0x1::string::length(&arg6) > 0, 3);
        assert!(0x1::string::length(&arg7) > 0, 3);
        assert!(0x1::string::length(&arg8) > 0, 3);
        assert!(arg9 > 0, 2);
        assert!(arg10 > 0, 2);
        let v0 = PrepareV2ToV3MigrationAction{
            executor                      : arg1,
            v2_account_id                 : arg2,
            v3_account_id                 : arg3,
            expected_treasury_cap_id      : arg4,
            expected_metadata_cap_id      : arg5,
            asset_resource_name           : arg6,
            stable_resource_name          : arg7,
            treasury_stable_resource_name : arg8,
            min_asset_amount              : arg9,
            min_stable_amount             : arg10,
        };
        let v1 = 0x1::type_name::with_original_ids<0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::currency::PrepareV2ToV3Migration<T0, T1>>();
        0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::action_spec_builder::add(arg0, 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::intents::new_action_spec_with_typename(v1, 0x2::bcs::to_bytes<PrepareV2ToV3MigrationAction>(&v0), 1));
        let v2 = 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_events::new_builder();
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_events::add_address(&mut v2, b"executor", arg1);
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_events::add_id(&mut v2, b"v2_account_id", arg2);
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_events::add_id(&mut v2, b"v3_account_id", arg3);
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_events::add_id(&mut v2, b"expected_treasury_cap_id", arg4);
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_events::add_id(&mut v2, b"expected_metadata_cap_id", arg5);
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_events::add_string(&mut v2, b"asset_resource_name", v0.asset_resource_name);
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_events::add_string(&mut v2, b"stable_resource_name", v0.stable_resource_name);
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_events::add_string(&mut v2, b"treasury_stable_resource_name", v0.treasury_stable_resource_name);
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_events::add_u64(&mut v2, b"min_asset_amount", arg9);
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_events::add_u64(&mut v2, b"min_stable_amount", arg10);
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_events::emit_action_params(v2, 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::action_spec_builder::source_type(arg0), 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::action_spec_builder::source_id(arg0), 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::action_spec_builder::outcome_index(arg0), 0x1::string::from_ascii(0x1::type_name::into_string(v1)), 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::action_spec_builder::next_action_index(arg0));
    }
