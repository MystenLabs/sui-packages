module 0xb28fba02c9a3fcb8098a1fd5b9f1a9faaf5ccfe41d6f86847c07e6af873c34be::wallet {
    ...
    fun assert_gas_fee(arg0: &0x2::coin::Coin<0x2::sui::SUI>) {
        assert!(0x2::coin::value<0x2::sui::SUI>(arg0) >= 3000000, 3);
    }
    ...
    public fun deposit_v2<T0>(arg0: &mut HouseBank, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        assert_valid_version(arg0);
        if (!house_pool_exists<T0>(arg0)) {
            let v0 = HousePoolValue<T0>{
        ...
        assert_gas_fee(&arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg3, @0x56a9032cf70bbff65f6ba100d6ded84230e1089c79a23f9ee19fe08f704ec6ee);
