module 0x49db1f0c8e9da7ad6b3d9242434d8d87e975c7387542d8b0c930d7280c804467::cloud_wallet_config {
    ...
    public fun only_quick_withdrawer(arg0: &CloudWalletConfig, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<address, bool>(&arg0.quick_withdrawer_table, 0x2::tx_context::sender(arg1)) && *0x2::table::borrow<address, bool>(&arg0.quick_withdrawer_table, 0x2::tx_context::sender(arg1)), 20012);
    }
