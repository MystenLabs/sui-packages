module 0x495de18feac86973ee1f88d9ad2cc52592ec8f2afdf05e95a1aa3bf1ef312b84::dca {
    ...
    fun assert_minimum_funding_per_trade<T0>(arg0: &0x2::balance::Balance<T0>, arg1: u64) {
        assert!(0x2::balance::value<T0>(arg0) >= 0x495de18feac86973ee1f88d9ad2cc52592ec8f2afdf05e95a1aa3bf1ef312b84::math::mul(arg1, 100000), 14);
    }
    ...
    fun assert_time(arg0: u64, arg1: u64, arg2: u64, arg3: u8) {
        let v0 = if (arg3 == 0) {
            0x495de18feac86973ee1f88d9ad2cc52592ec8f2afdf05e95a1aa3bf1ef312b84::time::has_n_seconds_passed(arg0, arg1, arg2)
        } else if (arg3 == 1) {
            0x495de18feac86973ee1f88d9ad2cc52592ec8f2afdf05e95a1aa3bf1ef312b84::time::has_n_minutes_passed(arg0, arg1, arg2)
        } else if (arg3 == 2) {
            0x495de18feac86973ee1f88d9ad2cc52592ec8f2afdf05e95a1aa3bf1ef312b84::time::has_n_hours_passed(arg0, arg1, arg2)
        } else if (arg3 == 3) {
            0x495de18feac86973ee1f88d9ad2cc52592ec8f2afdf05e95a1aa3bf1ef312b84::time::has_n_days_passed(arg0, arg1, arg2)
        } else if (arg3 == 4) {
            0x495de18feac86973ee1f88d9ad2cc52592ec8f2afdf05e95a1aa3bf1ef312b84::time::has_n_weeks_passed(arg0, arg1, arg2)
        } else {
            assert!(arg3 == 5, 0);
            0x495de18feac86973ee1f88d9ad2cc52592ec8f2afdf05e95a1aa3bf1ef312b84::time::has_n_months_passed(arg0, arg1, arg2)
        };
        assert!(v0 == true, 7);
    }
    ...
    fun compute_min_price(arg0: u64, arg1: u64) : u64 {
        0x495de18feac86973ee1f88d9ad2cc52592ec8f2afdf05e95a1aa3bf1ef312b84::math::div(arg0, arg1)
    }
    ...
    public(friend) fun fee_amount(arg0: u64) : u64 {
        0x495de18feac86973ee1f88d9ad2cc52592ec8f2afdf05e95a1aa3bf1ef312b84::math::div(0x495de18feac86973ee1f88d9ad2cc52592ec8f2afdf05e95a1aa3bf1ef312b84::math::mul(arg0, 5), 10000)
    }
    ...
    fun gas_budget_estimate(arg0: u64) : u64 {
        0x495de18feac86973ee1f88d9ad2cc52592ec8f2afdf05e95a1aa3bf1ef312b84::math::mul(25000000, arg0)
    }
    ...
    public(friend) fun init_trade<T0, T1>(arg0: &mut DCA<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, TradePromise<T0, T1>) {
        ...
        (0x2::coin::from_balance<T0>(v1, arg2), v3)
    }
