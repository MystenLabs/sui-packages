module 0x496f35b2153a9e72bf6bd842f735877361b0f5bb58bc96e7fba731ff38778a1c::unlock_schedule {
    ...
    public(friend) fun add_future_unlock_amount(arg0: &mut VeScaUnlockSchedule, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(arg0.refreshed_at == 0x2::clock::timestamp_ms(arg3) / 1000, 0x496f35b2153a9e72bf6bd842f735877361b0f5bb58bc96e7fba731ff38778a1c::error_code::should_refresh_first());
        0x496f35b2153a9e72bf6bd842f735877361b0f5bb58bc96e7fba731ff38778a1c::ve_sca_rules::assert_unlock_at(arg2, arg3);
    ...
    fun calculate_lock_history_snapshots(arg0: &VeScaUnlockSchedule, arg1: &0x2::clock::Clock) : vector<LockHistorySnapshot> {
        ...
        while (v2 != v1) {
            v2 = 0x2::math::min(v2 + 0x496f35b2153a9e72bf6bd842f735877361b0f5bb58bc96e7fba731ff38778a1c::constants::unlock_round_duration() - v2 % 0x496f35b2153a9e72bf6bd842f735877361b0f5bb58bc96e7fba731ff38778a1c::constants::unlock_round_duration(), v1);
    ...
    public(friend) fun extend_lock_period(arg0: &mut VeScaUnlockSchedule, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        assert!(arg0.refreshed_at == v0, 0x496f35b2153a9e72bf6bd842f735877361b0f5bb58bc96e7fba731ff38778a1c::error_code::should_refresh_first());
        0x496f35b2153a9e72bf6bd842f735877361b0f5bb58bc96e7fba731ff38778a1c::ve_sca_rules::assert_unlock_at(arg3, arg4);
        if (arg2 > v0) {
    ...
    fun get_schedule_index(arg0: &VeScaUnlockSchedule, arg1: u64) : u64 {
        arg1 / 0x496f35b2153a9e72bf6bd842f735877361b0f5bb58bc96e7fba731ff38778a1c::constants::unlock_round_duration() - arg0.refreshed_at / 0x496f35b2153a9e72bf6bd842f735877361b0f5bb58bc96e7fba731ff38778a1c::constants::unlock_round_duration() - 1
    }

    public(friend) fun new() : VeScaUnlockSchedule {
        let v0 = 0x1::vector::empty<u64>();
        let v1 = 0;
        while (v1 < 0x496f35b2153a9e72bf6bd842f735877361b0f5bb58bc96e7fba731ff38778a1c::constants::max_lock_rounds()) {
    ...
    fun refresh_unlock_schedule(arg0: &mut VeScaUnlockSchedule, arg1: &0x2::clock::Clock) {
        ...
        let v1 = 0;
        while (v1 < v0 / 0x496f35b2153a9e72bf6bd842f735877361b0f5bb58bc96e7fba731ff38778a1c::constants::unlock_round_duration() - arg0.refreshed_at / 0x496f35b2153a9e72bf6bd842f735877361b0f5bb58bc96e7fba731ff38778a1c::constants::unlock_round_duration()) {
