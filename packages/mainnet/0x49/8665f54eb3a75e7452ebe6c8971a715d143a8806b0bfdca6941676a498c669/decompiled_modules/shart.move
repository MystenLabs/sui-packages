module 0x498665f54eb3a75e7452ebe6c8971a715d143a8806b0bfdca6941676a498c669::shart {
    ...
    fun init(arg0: SHART, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<SHART>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"SHART       ")))), trim_right(b"SHART                           "), trim_right(b"Simply Hold And Receive Tokens                                                                                                                                                                                                                                                                                                  "), v2, arg1);
