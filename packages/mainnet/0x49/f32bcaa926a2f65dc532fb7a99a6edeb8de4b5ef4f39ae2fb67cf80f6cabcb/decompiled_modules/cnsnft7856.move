module 0x49f32bcaa926a2f65dc532fb7a99a6edeb8de4b5ef4f39ae2fb67cf80f6cabcb::cnsnft7856 {
    struct CNSNFT7856 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7856, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7856>(arg0, arg1);
