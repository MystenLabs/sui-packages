module 0x49f1ef80b0cc54c05616f264547f897120effb760abeb7354e6053c188486d85::tradeport_bridge {
    ...
    public fun bridge_coin_to_nft<T0: store + key, T1>(arg0: &0x2::clock::Clock, arg1: &mut Manager, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::object::ID, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        assert!(0x2::coin::value<T1>(&arg2) == *0x2::table::borrow<0x2::object::ID, u64>(&v4.registry, arg3), 11);
        ...
        if (arg1.fee_out > 0) {
            ...
            let v8 = v7;
            0x2::balance::join<T1>(&mut v8, 0x2::balance::split<T1>(&mut v6, (((0x2::balance::value<T1>(&v6) as u128) * (arg1.fee_out as u128) / 10000) as u64)));
    ...
    fun init(arg0: TRADEPORT_BRIDGE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<TRADEPORT_BRIDGE>();
        0x1::debug::print<0x1::type_name::TypeName>(&v0);
        ...
        0x2::transfer::share_object<Manager>(v3);
    }
    ...
    public fun register_bridge_with_signature<T0: store + key, T1>(arg0: &mut Manager, arg1: vector<u8>, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        ...
        verify_signature<Request>(arg1, arg0.public_key, &v3);
        create_bridge<T0, T1>(arg0, arg2, arg3);
    }
    ...
    public fun reserve_nft<T0: store + key, T1>(arg0: &0x2::clock::Clock, arg1: &mut Manager, arg2: 0x2::object::ID, arg3: u64, arg4: 0x2::coin::Coin<T1>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::bag::add<0x1::ascii::String, 0x2::balance::Balance<T1>>(&mut arg1.fees, v3, 0x2::coin::into_balance<T1>(arg4));
        let v6 = Reservation{
            holder     : 0x2::tx_context::sender(arg5),
            expires_at : 0x2::clock::timestamp_ms(arg0) + arg3 * 24 * 3600 * 1000,
        };
        let v7 = ReserveNftEvent{
            bridge_id  : 0x2::object::id<Bridge>(v4),
            nft_type   : v1,
            ft_type    : v3,
            nft_id     : arg2,
            holder     : v6.holder,
            expires_at : v6.expires_at,
        };
        0x2::event::emit<ReserveNftEvent>(v7);
        0x2::table::add<0x2::object::ID, Reservation>(&mut v4.reservations, arg2, v6);
    }
    ...
    entry fun set_reservation_fees(arg0: &mut Manager, arg1: vector<u64>, arg2: vector<u64>, arg3: vector<u64>, arg4: &0x2::tx_context::TxContext) {
        ...
        while (!0x1::vector::is_empty<u64>(&arg2)) {
            0x2::table::add<u64, u64>(&mut arg0.reservation_fees, 0x1::vector::pop_back<u64>(&mut arg2), 0x1::vector::pop_back<u64>(&mut arg3));
        };
    }
