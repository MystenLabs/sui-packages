module 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::pool {
    ...
    struct PrivacyPool<phantom T0> has store, key {
        ...
        merkle_tree: 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::MerkleTree,
        nullifiers: 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::NullifierRegistry,
        vk_bytes: vector<u8>,
    ...
    public fun swap<T0, T1>(arg0: &mut PrivacyPool<T0>, arg1: &mut PrivacyPool<T1>, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<vector<u8>>, arg6: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg7: &0x2::clock::Clock, arg8: vector<u8>, arg9: vector<u8>, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::is_spent(&arg0.nullifiers, v13), 1);
        assert!(!0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::is_spent(&arg0.nullifiers, v14), 1);
        ...
        0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::mark_spent(&mut arg0.nullifiers, v13);
        0x1::vector::push_back<vector<u8>>(&mut v28, v13);
        if (!is_zero_commitment(&v14)) {
            0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::mark_spent(&mut arg0.nullifiers, v14);
            0x1::vector::push_back<vector<u8>>(&mut v28, v14);
        };
        save_historical_root<T1>(arg1);
        0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::insert(&mut arg1.merkle_tree, v1);
        if (!is_zero_commitment(&v11)) {
            save_historical_root<T0>(arg0);
            0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::insert(&mut arg0.merkle_tree, v11);
            let v29 = ShieldEvent{
                pool_id        : 0x2::object::id<PrivacyPool<T0>>(arg0),
                position       : 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::get_next_index(&arg0.merkle_tree),
                commitment     : v11,
                encrypted_note : arg9,
            };
        ...
        let v30 = SwapEvent{
            ...
            swap_position         : 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::get_next_index(&arg1.merkle_tree),
            swap_commitment       : v1,
    ...
    public fun transfer<T0>(arg0: &mut PrivacyPool<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<vector<u8>>, arg4: vector<vector<u8>>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::is_spent(&arg0.nullifiers, v7), 1);
        assert!(!0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::is_spent(&arg0.nullifiers, v8), 1);
        ...
        0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::mark_spent(&mut arg0.nullifiers, v7);
        0x1::vector::push_back<vector<u8>>(&mut v16, v7);
        if (!is_zero_commitment(&v8)) {
            0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::mark_spent(&mut arg0.nullifiers, v8);
        ...
        0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::insert(&mut arg0.merkle_tree, v1);
        0x1::vector::push_back<vector<u8>>(&mut v17, *0x1::vector::borrow<vector<u8>>(&arg4, 0));
        0x1::vector::push_back<u64>(&mut v18, 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::get_next_index(&arg0.merkle_tree));
        0x1::vector::push_back<vector<u8>>(&mut v19, v1);
        if (!is_zero_commitment(&v6)) {
            0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::insert(&mut arg0.merkle_tree, v6);
    ...
    fun create_pool<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : PrivacyPool<T0> {
        PrivacyPool<T0>{
            ...
            merkle_tree       : 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::new(arg3),
            nullifiers        : 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::new(arg3),
            vk_bytes          : arg0,
    ...
    public fun get_merkle_root<T0>(arg0: &PrivacyPool<T0>) : vector<u8> {
        0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::get_root(&arg0.merkle_tree)
    }

    public fun get_note_count<T0>(arg0: &PrivacyPool<T0>) : u64 {
        0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::get_next_index(&arg0.merkle_tree)
    }

    public fun is_nullifier_spent<T0>(arg0: &PrivacyPool<T0>, arg1: vector<u8>) : bool {
        0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::is_spent(&arg0.nullifiers, arg1)
    }

    fun is_valid_root<T0>(arg0: &PrivacyPool<T0>, arg1: &vector<u8>) : bool {
        if (*arg1 == 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::get_root(&arg0.merkle_tree)) {
            return true
        };
        let v0 = 0;
    ...
    fun save_historical_root<T0>(arg0: &mut PrivacyPool<T0>) {
        if (0x1::vector::length<vector<u8>>(&arg0.historical_roots) < 100) {
            0x1::vector::push_back<vector<u8>>(&mut arg0.historical_roots, 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::get_root(&arg0.merkle_tree));
        } else {
            *0x1::vector::borrow_mut<vector<u8>>(&mut arg0.historical_roots, arg0.root_head) = 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::get_root(&arg0.merkle_tree);
    ...
    public fun shield<T0>(arg0: &mut PrivacyPool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::insert(&mut arg0.merkle_tree, arg2);
        let v0 = ShieldEvent{
            pool_id        : 0x2::object::id<PrivacyPool<T0>>(arg0),
            position       : 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::get_next_index(&arg0.merkle_tree),
            commitment     : arg2,
    ...
    public fun unshield<T0>(arg0: &mut PrivacyPool<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<vector<u8>>, arg4: address, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::is_spent(&arg0.nullifiers, v9), 1);
        assert!(!0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::is_spent(&arg0.nullifiers, v10), 1);
        ...
        0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::mark_spent(&mut arg0.nullifiers, v9);
        if (!is_zero_commitment(&v10)) {
            0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::nullifier::mark_spent(&mut arg0.nullifiers, v10);
        };
        ...
        if (!is_zero_commitment(&v8)) {
            save_historical_root<T0>(arg0);
            0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::insert(&mut arg0.merkle_tree, v8);
            let v19 = ShieldEvent{
                pool_id        : 0x2::object::id<PrivacyPool<T0>>(arg0),
                position       : 0x496aec9674522499cbf83604625ccd79d03c1ff691ffebd3dbbbd2e92737d08f::merkle_tree::get_next_index(&arg0.merkle_tree),
                commitment     : v8,
