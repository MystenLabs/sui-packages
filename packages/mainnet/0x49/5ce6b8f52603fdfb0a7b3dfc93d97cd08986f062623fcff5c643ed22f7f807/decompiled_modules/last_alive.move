module 0x495ce6b8f52603fdfb0a7b3dfc93d97cd08986f062623fcff5c643ed22f7f807::last_alive {
    ...
    struct RewardsPool has key {
        ...
        kiosks: 0x2::table::Table<u64, 0x2::object::ID>,
        kiosk_caps: 0x2::table::Table<u64, 0x2::kiosk::KioskOwnerCap>,
        kiosk_claimable_by: 0x2::table::Table<u64, 0x2::object::ID>,
    }
    ...
    struct KioskAssignedEvent has copy, drop {
        nft_id: 0x2::object::ID,
        round: u64,
        timestamp: u64,
    }

    struct KioskClaimedEvent has copy, drop {
        nft_id: 0x2::object::ID,
        round: u64,
        claimer: address,
        timestamp: u64,
    ...
    public entry fun add_nft_reward_to_kiosk<T0: store + key>(arg0: &GameState, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: T0, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.owner, 4);
        0x2::kiosk::place<T0>(arg1, arg2, arg3);
        let v0 = RewardAddedEvent{
            round       : arg0.current_round,
            reward_type : 0x1::string::utf8(b"NFT_KIOSK"),
            amount      : 1,
            added_by    : 0x2::tx_context::sender(arg4),
        };
        0x2::event::emit<RewardAddedEvent>(v0);
    }
    ...
    public entry fun add_token_reward_to_kiosk<T0: store + key>(arg0: &GameState, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == arg0.owner, 4);
        assert!(0x2::coin::value<T0>(&arg3) >= arg4, 0);
        0x2::kiosk::place<0x2::coin::Coin<T0>>(arg1, arg2, 0x2::coin::split<T0>(&mut arg3, arg4, arg5));
        ...
        let v0 = RewardAddedEvent{
            round       : arg0.current_round,
            reward_type : 0x1::string::utf8(b"TOKEN_KIOSK"),
            amount      : arg4,
    ...
    public entry fun claim_kiosk(arg0: &mut RewardsPool, arg1: &GameState, arg2: &NFT, arg3: 0x2::kiosk::KioskOwnerCap, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::uid_to_inner(&arg2.id);
        let v1 = arg2.game_round;
        let v2 = 0x2::tx_context::sender(arg4);
        assert!(is_round_ended(arg1, v1), 11);
        assert!(arg2.trait == 0x1::string::utf8(b"Champion"), 4);
        assert!(0x2::table::contains<u64, 0x2::object::ID>(&arg0.kiosk_claimable_by, v1), 19);
        assert!(*0x2::table::borrow<u64, 0x2::object::ID>(&arg0.kiosk_claimable_by, v1) == v0, 4);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(arg3, v2);
        let v3 = KioskClaimedEvent{
            nft_id    : v0,
            round     : v1,
            claimer   : v2,
            timestamp : 0x2::tx_context::epoch(arg4),
        };
        0x2::event::emit<KioskClaimedEvent>(v3);
    }
    ...
    public entry fun finish_game(arg0: &mut GameState, arg1: &mut RewardsPool, arg2: &0x2::clock::Clock, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<u64, 0x2::object::ID>(&arg1.kiosk_claimable_by, v0)) {
            *0x2::table::borrow_mut<u64, 0x2::object::ID>(&mut arg1.kiosk_claimable_by, v0) = v1;
            let v38 = KioskAssignedEvent{
                nft_id    : v1,
                round     : v0,
                timestamp : 0x2::clock::timestamp_ms(arg2),
            };
            0x2::event::emit<KioskAssignedEvent>(v38);
        };
    }
    ...
    fun init(arg0: LAST_ALIVE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = RewardsPool{
            ...
            kiosks                 : 0x2::table::new<u64, 0x2::object::ID>(arg1),
            kiosk_caps             : 0x2::table::new<u64, 0x2::kiosk::KioskOwnerCap>(arg1),
            kiosk_claimable_by     : 0x2::table::new<u64, 0x2::object::ID>(arg1),
        };
        ...
        let (v9, v10) = 0x2::kiosk::new(arg1);
        let v11 = v9;
        0x2::table::add<u64, 0x2::object::ID>(&mut v8.kiosks, 0, 0x2::object::id<0x2::kiosk::Kiosk>(&v11));
        0x2::table::add<u64, 0x2::kiosk::KioskOwnerCap>(&mut v8.kiosk_caps, 0, v10);
        0x2::table::add<u64, 0x2::object::ID>(&mut v8.kiosk_claimable_by, 0, 0x2::object::id_from_address(@0x0));
    ...
    public entry fun launch_new_game(arg0: &mut GameCounter, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v4, v5) = 0x2::kiosk::new(arg1);
        let v6 = v4;
        0x2::table::add<u64, 0x2::object::ID>(&mut v3.kiosks, v0, 0x2::object::id<0x2::kiosk::Kiosk>(&v6));
        0x2::table::add<u64, 0x2::kiosk::KioskOwnerCap>(&mut v3.kiosk_caps, v0, v5);
        0x2::table::add<u64, 0x2::object::ID>(&mut v3.kiosk_claimable_by, v0, 0x2::object::id_from_address(@0x0));
    ...
    public entry fun reset_game(arg0: &mut GameState, arg1: &mut RewardsPool, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v2;
        0x2::table::add<u64, 0x2::object::ID>(&mut arg1.kiosks, v1, 0x2::object::id<0x2::kiosk::Kiosk>(&v4));
        0x2::table::add<u64, 0x2::kiosk::KioskOwnerCap>(&mut arg1.kiosk_caps, v1, v3);
        0x2::table::add<u64, 0x2::object::ID>(&mut arg1.kiosk_claimable_by, v1, 0x2::object::id_from_address(@0x0));
