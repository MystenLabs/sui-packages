module 0x49a1714c4ac0994c94490a3980ec7e0aabe85e7086ac26a77fcca2504697e21b::ticket {
    struct ExecTicket {
        order_id: address,
        amount_borrowed: u64,
        amount_in_max: u64,
    ...
    public(friend) fun destroy_exec_ticket(arg0: ExecTicket) : (address, u64, u64, u64, u64, u64, u64, u64) {
        let ExecTicket {
            order_id            : v0,
            amount_borrowed     : v1,
            amount_in_max       : v2,
