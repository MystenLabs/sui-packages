module 0x49e7ad6cc3df7aaf5cb6cc9d4f4886feed1eb3c64772660ded1bfdc494dda737::reward5288 {
    struct REWARD5288 has drop {
        dummy_field: bool,
    }

    struct TICKET_5288 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5288(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5288>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5288>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5288, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5288>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5288>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5288>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5288>>(v5, 0x2::tx_context::sender(arg1));
    }
