module 0x493b93df465b97d9d2cb3b76081716d46124d65ab7233952498ccccca6ab8cbb::pool {
    ...
    public fun calc_pending_rewards(arg0: &Pool, arg1: &0x493b93df465b97d9d2cb3b76081716d46124d65ab7233952498ccccca6ab8cbb::position::Position) : u64 {
        ((calc_rewards_for(arg0, arg1) - 0x493b93df465b97d9d2cb3b76081716d46124d65ab7233952498ccccca6ab8cbb::position::reward_debt(arg1)) as u64)
    }

    public fun calc_rewards_for(arg0: &Pool, arg1: &0x493b93df465b97d9d2cb3b76081716d46124d65ab7233952498ccccca6ab8cbb::position::Position) : u256 {
        (0x493b93df465b97d9d2cb3b76081716d46124d65ab7233952498ccccca6ab8cbb::position::value(arg1) as u256) * arg0.acc_reward_per_share / 1000000000000
    }

    public(friend) fun create_pool(arg0: u64, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Pool {
        let v0 = 0x493b93df465b97d9d2cb3b76081716d46124d65ab7233952498ccccca6ab8cbb::utils::to_seconds(0x2::clock::timestamp_ms(arg3));
        let v1 = new(arg4);
    ...
    public fun get_multiplier(arg0: &Pool, arg1: u64) : u64 {
        let v0 = arg1;
        let v1 = arg0.last_reward_at_sec;
        if (v1 >= arg0.ended_at_sec) {
            return 0
        };
        if (arg1 > arg0.ended_at_sec) {
            v0 = arg0.ended_at_sec;
        };
        v0 - v1
    }
    ...
    public fun pending_reward(arg0: &Pool, arg1: &0x493b93df465b97d9d2cb3b76081716d46124d65ab7233952498ccccca6ab8cbb::position::Position, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) : u64 {
        ...
        (((0x493b93df465b97d9d2cb3b76081716d46124d65ab7233952498ccccca6ab8cbb::position::value(arg1) as u256) * v2 / 1000000000000 - 0x493b93df465b97d9d2cb3b76081716d46124d65ab7233952498ccccca6ab8cbb::position::reward_debt(arg1)) as u64)
    }
    ...
    public(friend) fun set_ended_at_sec(arg0: &mut Pool, arg1: u64) {
