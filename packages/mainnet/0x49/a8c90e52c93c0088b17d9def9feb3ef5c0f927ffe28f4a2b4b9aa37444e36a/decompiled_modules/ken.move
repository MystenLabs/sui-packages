module 0x49a8c90e52c93c0088b17d9def9feb3ef5c0f927ffe28f4a2b4b9aa37444e36a::ken {
    struct KEN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: KEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/ethereum/0xf4c492cbc2e73b251042264faa953c8c7a53c1a2.png?claimId=1mKTENnxU88xBu0y                                                                                                                                                                                                      ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<KEN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"KEN       ")))), trim_right(b"Ken-chan                        "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
