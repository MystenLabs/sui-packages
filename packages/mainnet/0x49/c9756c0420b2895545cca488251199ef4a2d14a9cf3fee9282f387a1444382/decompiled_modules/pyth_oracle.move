module 0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::pyth_oracle {
    ...
    public fun add_feeder(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: address) {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_feeder_updated(arg2, true);
    }
    ...
    public fun add_market<T0, T1>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: 0x1::string::String, arg3: u64, arg4: u64) : u64 {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_agg_oracle_market_added(v2, arg2, v0, v1);
        v2
    }
    ...
    public fun add_pyth_feed_object<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject) {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_feed_objects_set(v0, v5, v6);
    }

    fun aggregate_price_wad(arg0: u128, arg1: u128) : u128 {
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_math::mul_div_down(arg0, 1000000000000000000, arg1)
    }
    ...
    fun default_weights() : 0x2::vec_map::VecMap<u8, u64> {
        ...
        0x2::vec_map::insert<u8, u64>(&mut v0, 1, (0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_math::mul_div_down((10000 as u128), 80, 100) as u64));
        0x2::vec_map::insert<u8, u64>(&mut v0, 2, (0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_math::mul_div_down((10000 as u128), 0, 100) as u64));
        0x2::vec_map::insert<u8, u64>(&mut v0, 3, (0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_math::mul_div_down((10000 as u128), 20, 100) as u64));
        v0
    }
    ...
    public fun del_feeder(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: address) {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_feeder_updated(arg2, false);
    }
    ...
    public fun set_conf_liquidate_threshold<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: u128) {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_asset_conf_liquidate_threshold_updated(v0, arg2);
    }
    ...
    public fun set_conf_threshold<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: u128) {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_asset_conf_threshold_updated(v0, arg2);
    }
    ...
    public fun set_degrade_threshold<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: u64) {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_asset_degrade_threshold_updated(v0, arg2);
    }
    ...
    public fun set_deviation_threshold<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: u128) {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_asset_deviation_threshold_updated(v0, arg2);
    }
    ...
    public fun set_max_staleness<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: u64) {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_asset_max_staleness_updated(v0, arg2);
    }
    ...
    public fun set_pyth_feed_object<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject) {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_feed_objects_set(v0, v4, v5);
    }
    ...
    public fun set_source(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: u8, arg3: 0x1::string::String) {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_source_updated(arg2, arg3);
    }
    ...
    public fun set_weights<T0>(arg0: &mut Oracle, arg1: &OracleAdminCap, arg2: vector<u8>, arg3: vector<u64>) {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_asset_weights_updated(v0, arg2, arg3);
    }
    ...
    public(friend) fun update_price_cex(arg0: &mut Oracle, arg1: 0x1::type_name::TypeName, arg2: u8, arg3: u128, arg4: u128, arg5: u64, arg6: &0x2::tx_context::TxContext) {
        ...
        0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_events::emit_price_updated(0x2::tx_context::sender(arg6), arg1, arg2, arg3, arg4, arg5);
    }
    ...
    fun weighted_price_from_feed(arg0: &PriceFeed, arg1: &FeedObjectsInfo, arg2: bool, arg3: u64) : (u128, bool) {
        ...
        while (v18 < v12) {
            ...
            if (v24 <= 0x1250f84b608c375b91783512c747fd6d9c0cb8722c5a8f792e97a3081108534b::oracle_math::mul_div_down(v15, arg1.deviation_threshold, 10000)) {
