module 0x493f422add53c7558b38eb8aecc6e2da1d2724abeea01126fb9dec3c2d1f99eb::DOGE {
    ...
    fun init(arg0: DOGE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<DOGE>(arg0, 9, b"TRUMP", b"TRUMP Dog", b"TRUMP Dog pump to millions", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
