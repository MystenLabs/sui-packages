module 0x49572a64f6e256294bd187ce644a5a80efca79bb22320e0e98dad5d31b4bde4e::outbox {
    struct Outbox<T0: store> has store {
        entries: 0x2::table::Table<OutboxKey, OutboxItem<T0>>,
        rate_limit: 0x49572a64f6e256294bd187ce644a5a80efca79bb22320e0e98dad5d31b4bde4e::rate_limit::RateLimitState,
    }
    ...
    struct OutboxItem<T0> has store {
        ...
        released: 0x98d403f4ee033130b2cdf4615bca5189d50de14514f9a09710462490a651d043::bitmap::Bitmap,
        ...
        data: 0x98d403f4ee033130b2cdf4615bca5189d50de14514f9a09710462490a651d043::ntt_manager_message::NttManagerMessage<T0>,
    }
    ...
    public fun add<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxItem<T0>) : OutboxKey {
        let v0 = OutboxKey{id: 0x98d403f4ee033130b2cdf4615bca5189d50de14514f9a09710462490a651d043::ntt_manager_message::get_id<T0>(&arg1.data)};
    ...
    public(friend) fun new<T0: store>(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : Outbox<T0> {
        Outbox<T0>{
            ...
            rate_limit : 0x49572a64f6e256294bd187ce644a5a80efca79bb22320e0e98dad5d31b4bde4e::rate_limit::new(arg0),
        }
    }

    public fun borrow_data<T0: store>(arg0: &OutboxItem<T0>) : &0x98d403f4ee033130b2cdf4615bca5189d50de14514f9a09710462490a651d043::ntt_manager_message::NttManagerMessage<T0> {
        &arg0.data
    }

    public fun borrow_rate_limit_mut<T0: store>(arg0: &mut Outbox<T0>) : &mut 0x49572a64f6e256294bd187ce644a5a80efca79bb22320e0e98dad5d31b4bde4e::rate_limit::RateLimitState {
        &mut arg0.rate_limit
    }
    ...
    public fun new_outbox_item<T0>(arg0: u64, arg1: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg2: 0x98d403f4ee033130b2cdf4615bca5189d50de14514f9a09710462490a651d043::ntt_manager_message::NttManagerMessage<T0>) : OutboxItem<T0> {
        OutboxItem<T0>{
            release_timestamp     : arg0,
            released              : 0x98d403f4ee033130b2cdf4615bca5189d50de14514f9a09710462490a651d043::bitmap::empty(),
    ...
    public(friend) fun try_release<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxKey, arg2: u8, arg3: &0x2::clock::Clock) : bool {
        ...
        if (0x98d403f4ee033130b2cdf4615bca5189d50de14514f9a09710462490a651d043::bitmap::get(&v0.released, arg2)) {
            abort 13906834586660241409
        };
        0x98d403f4ee033130b2cdf4615bca5189d50de14514f9a09710462490a651d043::bitmap::enable(&mut v0.released, arg2);
        true
    }
