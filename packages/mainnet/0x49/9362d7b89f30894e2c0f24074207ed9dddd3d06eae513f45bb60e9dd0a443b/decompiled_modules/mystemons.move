module 0x499362d7b89f30894e2c0f24074207ed9dddd3d06eae513f45bb60e9dd0a443b::mystemons {
    ...
    public entry fun mint_to_kiosk(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: vector<0x1::string::String>, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: bool, arg7: vector<0x1::string::String>, arg8: vector<0x1::string::String>, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x1::vector::is_empty<0x1::string::String>(&arg3)) {
            ...
            while (v2 < 0x1::vector::length<0x1::string::String>(&arg3)) {
                ...
                0x1::string::append(&mut v1, *0x1::vector::borrow<0x1::string::String>(&arg3, v2));
                v2 = v2 + 1;
            };
        ...
        while (v3 < 0x1::vector::length<0x1::string::String>(&arg7)) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0, *0x1::vector::borrow<0x1::string::String>(&arg7, v3), *0x1::vector::borrow<0x1::string::String>(&arg8, v3));
            v3 = v3 + 1;
        };
        let v4 = MystemonV2{
        ...
        0x2::kiosk::place<MystemonV2>(arg9, arg10, v4);
    }
