module 0x499c88c7ddd5edd9f3cdb1d44880fe0bd90af19380ab02a4a0109c1f1637d5c4::cnsnft7849 {
    struct CNSNFT7849 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7849, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9142"));
        let v4 = 0x2::package::claim<CNSNFT7849>(arg0, arg1);
