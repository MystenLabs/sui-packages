module 0x493130ff5430cbf23819324567c8389c34aa4d967d7b541b42cec102679481d1::sevenk_fun_router {
    ...
    public fun swap_a_to_b<T0>(arg0: &mut 0x8bcdc1dadd7ccbb67dcea82ee496044d8f54986de20cd7cd1e70c2b40086f1f5::aggregator::SwapSession, arg1: &mut 0xc42fd2cde04281a5d2659e5c96c89ba625ddeef9b622713c3d6aa1efd5ea21ab::fun_7k::Configuration, arg2: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg3: &0x2::clock::Clock, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg4 == 0x8bcdc1dadd7ccbb67dcea82ee496044d8f54986de20cd7cd1e70c2b40086f1f5::aggregator::max_amount_in()) {
            0x8bcdc1dadd7ccbb67dcea82ee496044d8f54986de20cd7cd1e70c2b40086f1f5::utils::transfer_balance<0x2::sui::SUI>(0x2::coin::into_balance<0x2::sui::SUI>(v2), 0x2::tx_context::sender(arg5), arg5);
        } else {
        ...
        0x8bcdc1dadd7ccbb67dcea82ee496044d8f54986de20cd7cd1e70c2b40086f1f5::aggregator::emit_swap_event<0x2::sui::SUI, T0>(arg0, b"sevenk-fun", 0x2::object::id<0xc42fd2cde04281a5d2659e5c96c89ba625ddeef9b622713c3d6aa1efd5ea21ab::fun_7k::Configuration>(arg1), v1 - v6, 0x2::coin::value<T0>(&v5), v6);
    }

    public fun swap_b_to_a<T0>(arg0: &mut 0x8bcdc1dadd7ccbb67dcea82ee496044d8f54986de20cd7cd1e70c2b40086f1f5::aggregator::SwapSession, arg1: &mut 0xc42fd2cde04281a5d2659e5c96c89ba625ddeef9b622713c3d6aa1efd5ea21ab::fun_7k::Configuration, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x8bcdc1dadd7ccbb67dcea82ee496044d8f54986de20cd7cd1e70c2b40086f1f5::aggregator::merge_balance<0x2::sui::SUI>(arg0, 0x2::coin::into_balance<0x2::sui::SUI>(v3));
        let v4 = 0x2::coin::value<T0>(&v2);
        if (arg2 == 0x8bcdc1dadd7ccbb67dcea82ee496044d8f54986de20cd7cd1e70c2b40086f1f5::aggregator::max_amount_in()) {
            0x8bcdc1dadd7ccbb67dcea82ee496044d8f54986de20cd7cd1e70c2b40086f1f5::utils::transfer_balance<T0>(0x2::coin::into_balance<T0>(v2), 0x2::tx_context::sender(arg3), arg3);
        } else {
        ...
        0x8bcdc1dadd7ccbb67dcea82ee496044d8f54986de20cd7cd1e70c2b40086f1f5::aggregator::emit_swap_event<T0, 0x2::sui::SUI>(arg0, b"sevenk-fun", 0x2::object::id<0xc42fd2cde04281a5d2659e5c96c89ba625ddeef9b622713c3d6aa1efd5ea21ab::fun_7k::Configuration>(arg1), v1 - v4, 0x2::coin::value<0x2::sui::SUI>(&v3), v4);
    }
