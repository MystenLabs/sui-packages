module 0x49d87b9af35c4fef28def2cd65884aa9c49bb4eedbcee647f4dafb5c8f36ba57::ipx {
    struct IPX has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IPX, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<IPX>(arg0, 9, b"IPX", b"Interest Protocol Token", b"The governance token of Interest Protocol", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://interestprotocol.infura-ipfs.io/ipfs/QmcNYZn1urSEXBiZi2SiFzyeQcfNmTfHDU4kZLxhpCTRUK")), arg1);
        let v2 = 0x2::coin::treasury_into_supply<IPX>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<IPX>>(0x2::coin::from_balance<IPX>(0x2::balance::increase_supply<IPX>(&mut v2, 600000000000000000), arg1), @0x3f2bbe286241f23ceba46d2a62a8c2ca6a75bb51c7d4991e6c568f6cee0cf910);
