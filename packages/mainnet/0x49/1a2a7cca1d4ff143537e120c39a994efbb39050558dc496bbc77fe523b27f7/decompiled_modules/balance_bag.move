module 0x491a2a7cca1d4ff143537e120c39a994efbb39050558dc496bbc77fe523b27f7::balance_bag {
    ...
    public(friend) fun join<T0>(arg0: &mut BalanceBag, arg1: 0x2::balance::Balance<T0>) {
        ...
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.balances, &v0)) {
            *0x2::vec_map::get_mut<0x1::type_name::TypeName, u64>(&mut arg0.balances, &v0) = 0x491a2a7cca1d4ff143537e120c39a994efbb39050558dc496bbc77fe523b27f7::utils::add_balance_to_bag<T0>(&mut arg0.bag, arg1);
        } else {
            0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut arg0.balances, v0, 0x491a2a7cca1d4ff143537e120c39a994efbb39050558dc496bbc77fe523b27f7::utils::add_balance_to_bag<T0>(&mut arg0.bag, arg1));
        };
    }

    public(friend) fun split<T0>(arg0: &mut BalanceBag, arg1: u64) : 0x2::balance::Balance<T0> {
        let (v0, v1) = 0x491a2a7cca1d4ff143537e120c39a994efbb39050558dc496bbc77fe523b27f7::utils::remove_balance_from_bag<T0>(&mut arg0.bag, arg1, false);
    ...
    public(friend) fun withdraw_all<T0>(arg0: &mut BalanceBag) : 0x2::balance::Balance<T0> {
        let (v0, _) = 0x491a2a7cca1d4ff143537e120c39a994efbb39050558dc496bbc77fe523b27f7::utils::remove_balance_from_bag<T0>(&mut arg0.bag, 0, true);
        let v2 = 0x1::type_name::get<T0>();
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.balances, &v2)) {
