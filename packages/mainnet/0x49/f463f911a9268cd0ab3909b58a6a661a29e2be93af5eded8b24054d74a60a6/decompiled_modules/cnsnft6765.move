module 0x49f463f911a9268cd0ab3909b58a6a661a29e2be93af5eded8b24054d74a60a6::cnsnft6765 {
    struct CNSNFT6765 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6765, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6765>(arg0, arg1);
