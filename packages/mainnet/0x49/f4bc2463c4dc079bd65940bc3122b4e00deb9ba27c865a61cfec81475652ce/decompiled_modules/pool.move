    ...
    public fun calculate_swap_results<T0, T1>(arg0: &Pool<T0, T1>, arg1: bool, arg2: bool, arg3: u64, arg4: u128) : SwapResult {
        ...
        while (v1.amount_specified_remaining > 0 && v1.end_sqrt_price != arg4) {
            ...
            if (v1.end_sqrt_price == v2.sqrt_price_next) {
                if (v2.initialized) {
                    let v11 = if (arg1) {
                        0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::i128H::neg_from(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::liquidity_net(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::get_tick_from_manager(&arg0.ticks_manager, v2.tick_index_next)))
                    } else {
        ...
        while (v2.amount_specified_remaining > 0 && v2.end_sqrt_price != arg5) {
            ...
            if (v2.end_sqrt_price == v3.sqrt_price_next) {
                ...
                if (v3.initialized) {
                    ...
                    let v17 = if (arg2) {
                        0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::i128H::neg_from(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::cross(&mut arg1.ticks_manager, v3.tick_index_next, v12, v13, v16, v14, v15, v0))
                    } else {
