module 0x49d0724d2575ce7b230ed2adc447ee6d9389a6bc031504f5c9210d213e48c451::kapogian {
    struct KAPOGIAN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: KAPOGIAN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<KAPOGIAN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Kapogian"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b" It's built on a simple, yet powerful, Filipino principle: everyone is Pogi (handsome, good-looking) in their own unique way. Our mission is to dismantle the narrow definitions of attractiveness and empower a global brotherhood of men to recognize, embrace, and project their own inner Pogi."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiadin632sszonrma7exjb57spskwzusl2fyivtcrzq3fampkxoori"));
