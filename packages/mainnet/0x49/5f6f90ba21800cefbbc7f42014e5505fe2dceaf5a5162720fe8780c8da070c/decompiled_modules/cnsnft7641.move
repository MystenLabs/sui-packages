module 0x495f6f90ba21800cefbbc7f42014e5505fe2dceaf5a5162720fe8780c8da070c::cnsnft7641 {
    struct CNSNFT7641 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7641, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7641>(arg0, arg1);
