module 0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed {
    ...
    struct PairDataUpdateEvent has copy, drop {
        pair: u32,
        value: u128,
        decimal: u16,
        timestamp: u128,
    ...
    public fun get_derived_price(arg0: &OracleHolder, arg1: u32, arg2: u32, arg3: u8) : (u128, u16, u64, u8) {
        oracle_holder_version_check(arg0);
        assert!(arg1 != arg2, 5);
        assert!(arg3 <= 1, 6);
    ...
    public(friend) fun get_oracle_holder_and_upsert_pair_data_v2(arg0: &mut OracleHolder, arg1: &0x2::clock::Clock, arg2: u32, arg3: u128, arg4: u16, arg5: u128, arg6: u64) {
        let v0 = Entry{
            value     : arg3,
            decimal   : arg4,
            timestamp : arg5,
        ...
        upsert_pair_data_v2(arg0, arg1, arg2, v0);
    }
    ...
    public fun get_prices(arg0: &OracleHolder, arg1: vector<u32>) : vector<Price> {
        oracle_holder_version_check(arg0);
        let v0 = 0x1::vector::empty<Price>();
        while (!0x1::vector::is_empty<u32>(&arg1)) {
            let v1 = 0x1::vector::pop_back<u32>(&mut arg1);
            if (is_pair_exist(arg0, v1)) {
                let v2 = 0x2::table::borrow<u32, Entry>(&arg0.feeds, v1);
                let v3 = Price{
                    pair      : v1,
                    value     : v2.value,
                    decimal   : v2.decimal,
                ...
                0x1::vector::push_back<Price>(&mut v0, v3);
            };
        };
        v0
    }
    ...
    entry fun migrate(arg0: &OwnerCap, arg1: &mut OracleHolder, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun oracle_holder_version_check(arg0: &OracleHolder) {
    ...
    entry fun process_cluster(arg0: &0x3a75968d0951fc99e7b336b26088d0f6888efd691b9cf2ac61c3958cfaa6d41b::validator::DkgState, arg1: &mut OracleHolder, arg2: vector<vector<u8>>, arg3: vector<vector<u8>>, arg4: vector<vector<u8>>, arg5: vector<vector<u8>>, arg6: vector<vector<vector<u8>>>, arg7: vector<u64>, arg8: vector<vector<u8>>, arg9: vector<vector<vector<u8>>>, arg10: vector<vector<vector<u8>>>, arg11: vector<vector<u8>>, arg12: vector<vector<u8>>, arg13: vector<u8>, arg14: vector<vector<u8>>, arg15: vector<vector<u32>>, arg16: vector<vector<u128>>, arg17: vector<vector<u128>>, arg18: vector<vector<u16>>, arg19: vector<vector<u8>>, arg20: vector<u64>, arg21: vector<vector<u8>>, arg22: vector<u64>, arg23: vector<u64>, arg24: vector<u64>, arg25: vector<u64>, arg26: vector<u64>, arg27: vector<vector<u8>>, arg28: &mut 0x2::tx_context::TxContext) {
        oracle_holder_version_check(arg1);
    ...
    fun upsert_pair_data_v2(arg0: &mut OracleHolder, arg1: &0x2::clock::Clock, arg2: u32, arg3: Entry) {
        assert!(arg3.round < 0x2::clock::timestamp_ms(arg1) + 500, 8);
        if (is_pair_exist(arg0, arg2)) {
            let v0 = 0x2::table::borrow_mut<u32, Entry>(&mut arg0.feeds, arg2);
            if (v0.round < arg3.round) {
                let v1 = PairDataUpdateEvent{
                    pair      : arg2,
                    value     : arg3.value,
                    decimal   : arg3.decimal,
                    timestamp : arg3.timestamp,
                    round     : arg3.round,
                };
                0x2::event::emit<PairDataUpdateEvent>(v1);
                *v0 = arg3;
            };
        } else {
            let v2 = PairDataUpdateEvent{
                pair      : arg2,
                value     : arg3.value,
                decimal   : arg3.decimal,
                timestamp : arg3.timestamp,
            ...
            0x2::event::emit<PairDataUpdateEvent>(v2);
            0x2::table::add<u32, Entry>(&mut arg0.feeds, arg2, arg3);
        };
    }
