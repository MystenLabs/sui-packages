module 0x4995f846f593a4a4902f22c1ea59d9122dc82a92f9a6fe7c3d7728773d127bf0::game {
    ...
    public entry fun hack(arg0: &mut PlayerState, arg1: &mut ValidatorNode, arg2: &0x2::clock::Clock, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 > 0) {
            if (0x2::random::generate_u8_in_range(&mut v1, 0, 100) < 75) {
                ...
                if (v2 > 0) {
                    let v8 = 0x1::vector::borrow_mut<Daemon>(&mut arg1.daemons, 0x2::random::generate_u64_in_range(&mut v1, 0, v2));
                    v7 = 0x1::option::some<0x2::object::ID>(0x2::object::id<Daemon>(v8));
                    let v9 = 0x2::random::generate_u64_in_range(&mut v1, 10, 21);
                    v6 = v9;
                    if (v8.hp > v9) {
                        v8.hp = v8.hp - v9;
                    } else {
                ...
                if (0x2::random::generate_u8_in_range(&mut v1, 0, 100) < 30 && !0x2::vec_set::contains<address>(&arg0.owned_keys, &arg1.validator_address)) {
                    ...
                    0x2::transfer::transfer<NodeKey>(v10, 0x2::tx_context::sender(arg4));
                    0x2::vec_set::insert<address>(&mut arg0.owned_keys, arg1.validator_address);
                };
            } else {
                v3 = 0x1::string::utf8(b"LOSS");
                v5 = false;
                let v11 = 0x2::random::generate_u64_in_range(&mut v1, 1, 5);
                v4 = v11;
                if (arg0.data_fragments >= v11) {
                    arg0.data_fragments = arg0.data_fragments - v11;
                } else {
            ...
            if (0x2::random::generate_u8_in_range(&mut v1, 0, 100) < 30 && !0x2::vec_set::contains<address>(&arg0.owned_keys, &arg1.validator_address)) {
                ...
                0x2::transfer::transfer<NodeKey>(v12, 0x2::tx_context::sender(arg4));
                0x2::vec_set::insert<address>(&mut arg0.owned_keys, arg1.validator_address);
            };
            let v13 = 0x2::random::generate_u64_in_range(&mut v1, 5, 11);
            arg0.data_fragments = arg0.data_fragments + v13;
            v4 = v13;
        };
        arg0.last_hack = v0;
        let v14 = CombatLog{
