module 0x499e320a6e936f3e8f9e242ead32e687970dde54110025c423f5029ab2a54e21::reward8299 {
    struct REWARD8299 has drop {
        dummy_field: bool,
    }

    struct TICKET_8299 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8299(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8299>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8299>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8299, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8299>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8299>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8299>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8299>>(v5, 0x2::tx_context::sender(arg1));
    }
