module 0x49576acd1fd2e3c59c08abab45e79040f88a4514f4f3116dd9aa46173e7d7d5a::swap_math {
    fun cross_ticks<T0, T1>(arg0: &mut 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::SwapState, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg2: bool) {
        loop {
            ...
            let (v4, v5, v6, v7) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::clmm_math::compute_swap_step(0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::sqrt_price(arg0), v2, 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::liquidity(arg0), v3, 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::fee_pips(arg0), arg2, true);
            let (v8, v9) = if (arg2) {
                (0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::amount_x_desired(arg0) - v4 - v7, 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::amount_y_desired(arg0) + v5)
            } else {
                (0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::amount_x_desired(arg0) + v5, 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::amount_y_desired(arg0) - v4 - v7)
            };
            if (v6 != v2) {
                break
            };
            if (0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::math::is_zero_for_one(v8, v9, v6, 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::sqrt_ratio_lower(arg0), 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::sqrt_ratio_upper(arg0)) != arg2) {
                break
            };
            ...
            0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::update_swap_state(arg0, v12, v6, 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::sub(0x49576acd1fd2e3c59c08abab45e79040f88a4514f4f3116dd9aa46173e7d7d5a::i32_utils::mate_to_lib(v0), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::from(v13)), v8, v9);
        };
    }
    ...
    public(friend) fun optimal_swap<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: u32, arg2: u32, arg3: u64, arg4: u64) : (u64, u64, bool, u128) {
        ...
        let v2 = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lt(v0, v1)) {
            if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::gte(v0, 0x49576acd1fd2e3c59c08abab45e79040f88a4514f4f3116dd9aa46173e7d7d5a::i32_utils::mate_to_lib(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::min_tick()))) {
                0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lte(v1, 0x49576acd1fd2e3c59c08abab45e79040f88a4514f4f3116dd9aa46173e7d7d5a::i32_utils::mate_to_lib(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::max_tick()))
            } else {
                false
            }
        } else {
        ...
        let v4 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::get_sqrt_price_at_tick(0x49576acd1fd2e3c59c08abab45e79040f88a4514f4f3116dd9aa46173e7d7d5a::i32_utils::lib_to_mate(v0));
        let v5 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::get_sqrt_price_at_tick(0x49576acd1fd2e3c59c08abab45e79040f88a4514f4f3116dd9aa46173e7d7d5a::i32_utils::lib_to_mate(v1));
        let v6 = 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::init_swap_state(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::liquidity<T0, T1>(arg0), v3, 0x49576acd1fd2e3c59c08abab45e79040f88a4514f4f3116dd9aa46173e7d7d5a::i32_utils::mate_to_lib(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg0)), arg3, arg4, v4, v5, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_fee_rate<T0, T1>(arg0));
        ...
        if (v7) {
            ...
            (v13, 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::amount_y_desired(&v6) + 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::clmm_math::get_delta_b(v12, 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::sqrt_price(&v6), 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::liquidity(&v6), false) - arg4, true, v12)
        } else {
            let (v15, v12) = if (0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::sqrt_price(&v6) >= v4) {
                ...
                (arg4 + 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::constants::amount_before_fee(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::clmm_math::get_delta_b(v16, 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::sqrt_price(&v6), 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::liquidity(&v6), true), 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::fee_pips(&v6)) - 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::amount_y_desired(&v6), v16)
            } else {
            ...
            (v15, 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::amount_x_desired(&v6) + 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::clmm_math::get_delta_a(v12, 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::sqrt_price(&v6), 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::state::liquidity(&v6), false) - arg3, false, v12)
        }
    }
