module 0x3b7651cb9af66977c4a0404bc1eb5f198432294d55c9f6114e71710d9db491a2::auth {
    ...
    public(friend) fun check_and_update_auth(arg0: &mut Authorization, arg1: u64, arg2: u64) {
        assert!(arg0.enabled, 3);
        assert!(arg2 <= arg0.expiry, 2);
        assert!(arg1 > 0, 4);
        assert!(arg1 <= arg0.per_tx_limit, 1);
        if ((arg2 - arg0.last_reset) / 86400 > 0) {
            arg0.used_today = 0;
            arg0.last_reset = arg2;
        };
        let v0 = arg0.used_today + arg1;
        assert!(v0 <= arg0.daily_limit, 1);
        arg0.used_today = v0;
    }
    ...
    public(friend) fun get_agent(arg0: &Authorization) : address {
        arg0.agent
    }
    ...
    public(friend) fun get_owner(arg0: &Authorization) : address {
        arg0.owner
    }

    public(friend) fun get_token_type(arg0: &Authorization) : 0x1::string::String {
        arg0.token_type
    }
    ...
    public(friend) fun verify_caller(arg0: &Authorization, arg1: address) {
        assert!(arg0.owner == arg1 || arg0.agent == arg1, 0);
    }
