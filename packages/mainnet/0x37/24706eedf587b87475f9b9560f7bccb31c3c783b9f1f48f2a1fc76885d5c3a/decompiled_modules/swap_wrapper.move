module 0x3b7651cb9af66977c4a0404bc1eb5f198432294d55c9f6114e71710d9db491a2::swap_wrapper {
    ...
    public fun create_test_authorization(arg0: address, arg1: 0x1::string::String, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun execute_swap_with_auth_v2(arg0: &mut 0x3b7651cb9af66977c4a0404bc1eb5f198432294d55c9f6114e71710d9db491a2::auth::Authorization, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::clock::timestamp_ms(arg3) / 1000;
        0x3b7651cb9af66977c4a0404bc1eb5f198432294d55c9f6114e71710d9db491a2::auth::verify_caller(arg0, v0);
        let v2 = 0x2::coin::value<0x2::sui::SUI>(&arg1);
        0x3b7651cb9af66977c4a0404bc1eb5f198432294d55c9f6114e71710d9db491a2::auth::check_and_update_auth(arg0, v2, v1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, v0);
        let v3 = SwapExecuted{
            owner         : 0x3b7651cb9af66977c4a0404bc1eb5f198432294d55c9f6114e71710d9db491a2::auth::get_owner(arg0),
            input_token   : 0x3b7651cb9af66977c4a0404bc1eb5f198432294d55c9f6114e71710d9db491a2::auth::get_token_type(arg0),
            output_token  : 0x1::string::utf8(b"SUI"),
            input_amount  : v2,
            output_amount : 0x2::coin::value<0x2::sui::SUI>(&arg1),
            timestamp     : v1,
