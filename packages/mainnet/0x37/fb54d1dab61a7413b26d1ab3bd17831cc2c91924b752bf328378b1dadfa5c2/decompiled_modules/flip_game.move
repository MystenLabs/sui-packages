module 0x37fb54d1dab61a7413b26d1ab3bd17831cc2c91924b752bf328378b1dadfa5c2::flip_game {
    ...
    public fun flip(arg0: &mut GameConfig, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 2);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) == 10000000, 1);
        assert!(arg0.total_distributed < 10000000, 3);
        ...
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.jackpot_balance, 0x2::balance::split<0x2::sui::SUI>(&mut v2, 10000000 * 20 / 100));
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.dev_balance, 0x2::balance::split<0x2::sui::SUI>(&mut v2, 10000000 * 30 / 100));
