module 0x37508d541eeb66fcc4bc1845b7014ab0afb9f756ddfcb73aba11e0ea3c802be2::nft_swap {
    ...
    public entry fun consolidate_kiosk<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &0x2::transfer_policy::TransferPolicy<T0>, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::kiosk::has_access(arg0, arg1), 1);
        assert!(0x2::kiosk::has_access(arg2, arg3), 1);
        assert!(0x2::kiosk::has_item_with_type<T0>(arg0, arg4), 4);
        if (0x2::kiosk::is_listed(arg0, arg4)) {
            0x2::kiosk::delist<T0>(arg0, arg1, arg4);
        };
