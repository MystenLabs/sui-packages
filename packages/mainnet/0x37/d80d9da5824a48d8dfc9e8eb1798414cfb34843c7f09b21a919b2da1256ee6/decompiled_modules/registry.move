module 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::registry {
    ...
    public fun assert_output(arg0: &Registry, arg1: u64, arg2: u64) {
        ...
        assert!(0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::safe_math::mul_div_u64(v0, 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::scaling_pips(), arg1) <= arg0.max_output_delta_pips, 4);
    }
    ...
    public fun assert_price(arg0: &Registry, arg1: u128, arg2: u128) {
        ...
        assert!((0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::safe_math::mul_div_u128(v0, 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::scaling_pips_u128(), arg1) as u64) <= arg0.max_price_delta_pips, 3);
    }

    public(friend) fun assert_witness<T0>(arg0: &Registry) {
        assert!(arg0.version <= 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::current_version(), 0);
        let v0 = type_name<T0>();
        assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.allowed_witnesses, &v0), 1);
    }

    public fun auto_claim_fee_pips(arg0: &Registry, arg1: u64) : u64 {
        *0x1::vector::borrow<u64>(&find_fee_config(arg0, arg1).fees_pips, 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::auto_claim_source())
    }

    public fun auto_compound_fee_pips(arg0: &Registry, arg1: u64) : u64 {
        *0x1::vector::borrow<u64>(&find_fee_config(arg0, arg1).fees_pips, 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::auto_compound_source())
    }

    public fun auto_exit_fee_pips(arg0: &Registry, arg1: u64) : u64 {
        *0x1::vector::borrow<u64>(&find_fee_config(arg0, arg1).fees_pips, 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::auto_exit_source())
    }

    public fun auto_rebalance_fee_pips(arg0: &Registry, arg1: u64) : u64 {
        *0x1::vector::borrow<u64>(&find_fee_config(arg0, arg1).fees_pips, 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::auto_rebalance_source())
    }

    public fun compound_fee_pips(arg0: &Registry, arg1: u64) : u64 {
        *0x1::vector::borrow<u64>(&find_fee_config(arg0, arg1).fees_pips, 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::compound_source())
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Registry{
            ...
            version               : 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::current_version(),
    ...
    public fun mint_proxy_cap<T0: drop>(arg0: &Registry, arg1: T0) : ProxyCap {
        ...
        ProxyCap{witness: type_name<T0>()}
    }

    public fun rebalance_fee_pips(arg0: &Registry, arg1: u64) : u64 {
        *0x1::vector::borrow<u64>(&find_fee_config(arg0, arg1).fees_pips, 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::rebalance_source())
    }

    public fun register_lp<T0: store + key>(arg0: &mut Registry, arg1: 0x2::object::ID, arg2: &AdminCap) {
        let v0 = type_name<T0>();
        assert!(!0x2::vec_map::contains<0x1::type_name::TypeName, 0x2::object::ID>(&arg0.lp_registries, &v0), 8);
    ...
    public fun update_fee_configs(arg0: &mut Registry, arg1: vector<vector<u64>>, arg2: vector<u64>, arg3: &AdminCap) {
        ...
        while (v1 < 0x1::vector::length<u64>(&arg2)) {
            ...
            while (v3 < 0x1::vector::length<u64>(v2)) {
                if (!(*0x1::vector::borrow<u64>(v2, v3) < 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::scaling_pips())) {
                    v4 = false;
                    /* label 9 */
                    assert!(v4, 2);
                    assert!(v0 < *0x1::vector::borrow<u64>(&arg2, v1) && *0x1::vector::borrow<u64>(&arg2, v1) < 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::scaling_pips(), 2);
    ...
    public fun update_max_output_delta_pips(arg0: &mut Registry, arg1: u64, arg2: &AdminCap) {
        assert!(arg1 < 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::scaling_pips(), 2);
    ...
    public fun yield_fee_pips(arg0: &Registry, arg1: u64, arg2: u64) : u64 {
        if (arg2 == 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::auto_rebalance_source() || arg2 == 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::auto_compound_source()) {
            0
        } else if (arg2 == 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::auto_claim_source()) {
            auto_claim_fee_pips(arg0, arg1)
        } else {
            assert!(arg2 == 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::auto_exit_source(), 7);
            auto_exit_fee_pips(arg0, arg1)
        }
    }

    public fun zap_fee_pips(arg0: &Registry, arg1: u64) : u64 {
        *0x1::vector::borrow<u64>(&find_fee_config(arg0, arg1).fees_pips, 0x37d80d9da5824a48d8dfc9e8eb1798414cfb34843c7f09b21a919b2da1256ee6::constants::zap_in_source())
    }
