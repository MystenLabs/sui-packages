module 0x3704f4fc053963860187131441fa058e72d2e75e36b14420f1fd022324b49f9b::the_suimon_vault {
    struct THE_SUIMON_VAULT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: THE_SUIMON_VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<THE_SUIMON_VAULT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"The Suimon Vault"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Your one stop for unhinged Suimon-styled trading cards. Join the family today!"));
