module 0x37f4b50740bebdda9cbcb9a2319517f276a8d209ee8eb648909b8f31c83f779f::cnsnft2762 {
    struct CNSNFT2762 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2762, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2762>(arg0, arg1);
