module 0x6a29b3b80de2bd69ee94b2a2f11e5bf2e3614d1cc08f1cb16eefa290bc859cb0::nft {
    ...
    public(friend) fun mint(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut Infomation, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = 0x1::string::utf8(b"");
        if (arg0 == b"og") {
            v1 = arg2.description_og;
        };
        if (arg0 == b"pfp") {
            v1 = arg2.description_pfp;
        };
        if (arg0 == b"1") {
            v1 = arg2.description_tier1;
        };
        if (arg0 == b"2") {
            v1 = arg2.description_tier2;
        };
        if (arg0 == b"3") {
            v1 = arg2.description_tier3;
        };
        if (arg0 == b"4") {
            v1 = arg2.description_tier4;
        };
        if (arg0 == b"5") {
            v1 = arg2.description_tier5;
        };
        let v2 = YOUSUINFT{
            ...
            project_url : arg2.project_url,
        };
        let v3 = NFTMinted{
            object_id : 0x2::object::id<YOUSUINFT>(&v2),
            creator   : v0,
            name      : v2.name,
        };
        0x2::event::emit<NFTMinted>(v3);
        arg2.mint_index = arg2.mint_index + 1;
        0x2::transfer::public_transfer<YOUSUINFT>(v2, v0);
    }
