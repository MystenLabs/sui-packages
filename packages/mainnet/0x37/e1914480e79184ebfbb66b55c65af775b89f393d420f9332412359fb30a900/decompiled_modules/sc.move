module 0x37e1914480e79184ebfbb66b55c65af775b89f393d420f9332412359fb30a900::sc {
    struct LL<T0> {
        r: T0,
        a: u64,
    }
    ...
    public fun ct(arg0: u64, arg1: &0x2::clock::Clock) {
        let v0 = CT{timestamp: 0x2::clock::timestamp_ms(arg1) - arg0};
        0x2::event::emit<CT>(v0);
    }
