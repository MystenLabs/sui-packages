module 0x37a7cdec6b07234a7835db8e7f727ceddc8990dbda5b0767fc40974e91b1f0a8::types {
    struct AdminCap has store, key {
        id: 0x2::object::UID,
    }

    struct StorkConfig has store, key {
        id: 0x2::object::UID,
        stork_state_address: address,
    ...
    public fun new_stork_config(arg0: address, arg1: vector<u8>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : StorkConfig {
        StorkConfig{
            id                    : 0x2::object::new(arg3),
            stork_state_address   : arg0,
            sui_usd_feed_id       : arg1,
            max_price_age_seconds : arg2,
        }
    }
    ...
    public fun stork_config_id(arg0: &StorkConfig) : &0x2::object::UID {
        &arg0.id
    }

    public fun stork_config_max_price_age_seconds(arg0: &StorkConfig) : u64 {
        arg0.max_price_age_seconds
    }

    public fun stork_config_state_address(arg0: &StorkConfig) : address {
        arg0.stork_state_address
    }

    public fun stork_config_sui_usd_feed_id(arg0: &StorkConfig) : vector<u8> {
