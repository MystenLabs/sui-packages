module 0x37ef25698ed19d7abebf347809a55a5f7fd88d0aa89d89a42d3983b80e3e78de::stonker {
    ...
    public fun run_cetus_arb(arg0: &mut Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg3: &0x2::clock::Clock) : (u64, u64, u64, u64, u64, u64) {
        let (v0, v1, v2, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::get_level2_ticks_from_mid<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg1, 1, arg3);
        let v4 = v2;
        let v5 = v1;
        let v6 = v0;
        let v7 = (*0x1::vector::borrow<u64>(&v6, 0) as u128);
        let v8 = (min(arg0.parameters.order_size_base, *0x1::vector::borrow<u64>(&v5, 0)) as u128);
        let v9 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::calculate_swap_result<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>(arg2, true, true, ((v8 * v7 / (arg0.parameters.single_base as u128)) as u64));
        ((v8 as u64), (0 as u64), ((0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::calculated_swap_result_amount_out(&v9) as u128) as u64), ((0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::calculated_swap_result_amount_in(&v9) as u128) as u64), (v7 as u64), *0x1::vector::borrow<u64>(&v4, 0))
    }
