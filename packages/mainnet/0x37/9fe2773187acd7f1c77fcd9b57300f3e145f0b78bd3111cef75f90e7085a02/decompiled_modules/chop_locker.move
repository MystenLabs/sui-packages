module 0x379fe2773187acd7f1c77fcd9b57300f3e145f0b78bd3111cef75f90e7085a02::chop_locker {
    ...
    public fun calculate_apy<T0>(arg0: &0x2::balance::Balance<T0>, arg1: u64, arg2: &0x2::balance::Balance<T0>, arg3: u64) : u64 {
        ...
        let v0 = 365;
        let v1 = (0x2::balance::value<T0>(arg0) as u128) * (1000000 as u128) / (arg1 as u128) * ((0x2::balance::value<T0>(arg2) / v0) as u128) * (1000000 as u128) / (v0 as u128) * (((100 * arg3 / 90 + 50) * 1000) as u128) * (365 as u128) * (1000000 as u128) * 100 / 1;
