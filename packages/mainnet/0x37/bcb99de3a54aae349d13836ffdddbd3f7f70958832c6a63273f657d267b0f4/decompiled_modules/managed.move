module 0x37bcb99de3a54aae349d13836ffdddbd3f7f70958832c6a63273f657d267b0f4::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"Cosmos", b"COSMOS", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://iili.io/2DwdjZG.jpg")), arg1);
