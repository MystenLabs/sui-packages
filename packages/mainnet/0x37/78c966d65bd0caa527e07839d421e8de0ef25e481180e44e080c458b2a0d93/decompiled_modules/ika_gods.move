module 0x3778c966d65bd0caa527e07839d421e8de0ef25e481180e44e080c458b2a0d93::ika_gods {
    struct IKA_GODS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IKA_GODS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<IKA_GODS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Ika Gods"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Ika Gods rise to rule the whole world"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://THzVH8LYCOJraciKtoOkBFyxf9QrgHnQvRWL9sm3luM"));
