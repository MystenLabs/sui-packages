module 0x37fdde41657d5bac16a7651622eee9a30599dd58b0dcf6e000f3e5713a81ff19::cnsnft4189 {
    struct CNSNFT4189 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4189, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4189>(arg0, arg1);
