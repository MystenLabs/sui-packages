module 0x3721da809d0dc38ab1b0a8fd2fe919931d04d6332e72ab609b2936bf0bcde514::dapp_score {
    ...
    public fun check_is_dapp_admin(arg0: &Dapp, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::contains<address>(&arg0.admins, &v0) || 0x1::vector::length<address>(&arg0.admins) == 0, 0x3721da809d0dc38ab1b0a8fd2fe919931d04d6332e72ab609b2936bf0bcde514::error::not_authorized_error());
    }

    fun check_is_super_admin(arg0: &DappScoreManager, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x1::vector::contains<address>(&arg0.admins, &v0) || arg0.creator == 0x2::tx_context::sender(arg1), 0x3721da809d0dc38ab1b0a8fd2fe919931d04d6332e72ab609b2936bf0bcde514::error::not_authorized_error());
    }

    public fun check_is_updater(arg0: &DappScoreManager, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.updater == 0x2::tx_context::sender(arg1), 0x3721da809d0dc38ab1b0a8fd2fe919931d04d6332e72ab609b2936bf0bcde514::error::not_authorized_error());
    }
    ...
    public fun decrease_score_by_admin_cap(arg0: &mut DappScoreManager, arg1: DappAdminCap, arg2: address, arg3: 0x1::option::Option<address>, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        let v3 = DecreaseScoreByAdminCapEvent{
            ...
            new_score      : v2.deduction_by_admin_cap,
            score_decrease : arg4,
            by             : 0x2::tx_context::sender(arg5),
        };
        0x2::event::emit<DecreaseScoreByAdminCapEvent>(v3);
        emit_user_dapp_score_change_event(arg2, arg1.dapp_index, v2);
    }
    ...
    public fun decrease_user_score_by_admin(arg0: &mut DappScoreManager, arg1: u64, arg2: address, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        let v3 = DecreaseUserScoreByAdminEvent{
            ...
            new_score      : v2.deduction_by_admin,
            score_decrease : arg3,
            by             : 0x2::tx_context::sender(arg4),
        };
        0x2::event::emit<DecreaseUserScoreByAdminEvent>(v3);
        emit_user_dapp_score_change_event(arg2, arg1, v2);
    }
    ...
    fun emit_user_dapp_score_change_event(arg0: address, arg1: u64, arg2: &DappUser) {
        let v0 = UserDappScoreChangedEvent{
            user                   : arg0,
            dapp_index             : arg1,
            offchain_score         : arg2.offchain_score,
            addition_by_admin      : arg2.addition_by_admin,
            deduction_by_admin     : arg2.deduction_by_admin,
            addition_by_admin_cap  : arg2.addition_by_admin_cap,
            deduction_by_admin_cap : arg2.deduction_by_admin_cap,
        };
        0x2::event::emit<UserDappScoreChangedEvent>(v0);
    }
    ...
    public fun get_user_score(arg0: &DappScoreManager, arg1: u64, arg2: address) : u64 {
        internal_get_user_score(0x2::table::borrow<address, DappUser>(&0x2::table::borrow<u64, Dapp>(&arg0.dapps, arg1).users, arg2))
    }
    ...
    public fun increase_score_by_admin_cap(arg0: &mut DappScoreManager, arg1: DappAdminCap, arg2: address, arg3: 0x1::option::Option<address>, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        let v3 = IncreaseScoreByAdminCapEvent{
            ...
            new_score      : v2.addition_by_admin_cap,
            score_increase : arg4,
            by             : 0x2::tx_context::sender(arg5),
        };
    ...
    public fun increase_user_score_by_admin(arg0: &mut DappScoreManager, arg1: u64, arg2: address, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        let v3 = IncreaseUserScoreByAdminEvent{
            ...
            new_score      : v2.addition_by_admin,
            score_increase : arg3,
            by             : 0x2::tx_context::sender(arg4),
        };
    ...
    fun internal_add_dapp_admin(arg0: &mut DappScoreManager, arg1: u64, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(!0x1::vector::contains<address>(&v0.admins, &arg2), 0x3721da809d0dc38ab1b0a8fd2fe919931d04d6332e72ab609b2936bf0bcde514::error::duplicated_error());
    ...
    fun internal_get_user_score(arg0: &DappUser) : u64 {
        if (arg0.deduction_by_admin + arg0.deduction_by_admin_cap > arg0.offchain_score + arg0.addition_by_admin + arg0.addition_by_admin_cap) {
            return 0
        };
        arg0.offchain_score + arg0.addition_by_admin + arg0.addition_by_admin_cap - arg0.deduction_by_admin - arg0.deduction_by_admin_cap
    }
    ...
    fun internal_remove_dapp_admin(arg0: &mut DappScoreManager, arg1: u64, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(v2 && v4, 0x3721da809d0dc38ab1b0a8fd2fe919931d04d6332e72ab609b2936bf0bcde514::error::not_authorized_error());
        0x1::vector::remove<address>(&mut v0.admins, v3);
        assert!(0x1::vector::length<address>(&v0.admins) > 0, 0x3721da809d0dc38ab1b0a8fd2fe919931d04d6332e72ab609b2936bf0bcde514::error::not_authorized_error());
    ...
    fun internal_remove_super_admin(arg0: &mut DappScoreManager, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<address>(&arg0.admins) > 0, 0x3721da809d0dc38ab1b0a8fd2fe919931d04d6332e72ab609b2936bf0bcde514::error::not_authorized_error());
    ...
    public fun update_user_offchain_score(arg0: &mut DappScoreManager, arg1: u64, arg2: address, arg3: 0x1::option::Option<address>, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::table::borrow_mut<address, DappUser>(&mut v1.users, arg2);
        let v3 = false;
        let v4 = if (arg4 < v2.offchain_score) {
            v3 = true;
            v2.offchain_score - arg4
        } else {
            arg4 - v2.offchain_score
        };
        v2.offchain_score = arg4;
        let v5 = UpdateUserOffchainScoreByUpdater{
            dapp_index   : arg1,
            user         : arg2,
        ...
        0x2::event::emit<UpdateUserOffchainScoreByUpdater>(v5);
        emit_user_dapp_score_change_event(arg2, arg1, v2);
    }
