module 0x37b4dc9f68520534ddc5ea4683de292bfd49d6b87a6320e5816ca7eda7538028::vault_config {
    ...
    struct VaultConfig has store, key {
        ...
        version: u64,
        paused: bool,
        withdraw_allow_list: 0x2::table::Table<address, bool>,
    ...
    public fun check_trade_token<T0>(arg0: &VaultConfig, arg1: u64) {
    ...
    public(friend) fun credit_coin<T0>(arg0: &mut VaultTokenHolder, arg1: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
    ...
    public(friend) fun emergency_withdraw<T0>(arg0: &VaultConfig, arg1: &mut VaultTokenHolder, arg2: u64, arg3: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        only_admin(arg0, arg3);
        let v0 = 0x1::type_name::get<T0>();
        when_vault_created(arg1, v0);
        0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.vault_bag, v0), arg2)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = VaultConfig{
            ...
            version                 : 0,
            paused                  : false,
            withdraw_allow_list     : 0x2::table::new<address, bool>(arg0),
    ...
    public fun is_swap_a2b<T0, T1>(arg0: &VaultConfig) : bool {
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun only_admin(arg0: &VaultConfig, arg1: &0x2::tx_context::TxContext) {
    ...
    public fun only_allow_version(arg0: &VaultConfig) {
        assert!(arg0.version <= 0, 10007);
    }

    public fun only_operator(arg0: &VaultConfig, arg1: &0x2::tx_context::TxContext) {
    ...
    public fun only_trusted_bot(arg0: &VaultConfig, arg1: &0x2::tx_context::TxContext) {
    ...
    public fun pause(arg0: &mut VaultConfig, arg1: &0x2::tx_context::TxContext) {
    ...
    public(friend) fun rebalance_out<T0>(arg0: &VaultConfig, arg1: &mut VaultTokenHolder, arg2: address, arg3: u64) : 0x2::balance::Balance<T0> {
        assert!(arg0.rebalance_to == arg2, 10006);
        let v0 = 0x1::type_name::get<T0>();
        when_vault_created(arg1, v0);
        0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.vault_bag, v0), arg3)
    }

    public fun revoke(arg0: &mut VaultConfig, arg1: u64, arg2: address, arg3: &0x2::tx_context::TxContext) {
        only_admin(arg0, arg3);
        let v0 = if (arg1 == 1) {
            true
        } else if (arg1 == 2) {
    ...
    public fun set_conf_version(arg0: &mut VaultConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        only_admin(arg0, arg2);
        arg0.version = arg1;
    }
    ...
    public fun set_trade_token<T0>(arg0: &mut VaultConfig, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        only_admin(arg0, arg2);
        0x2::table::add<0x1::type_name::TypeName, u64>(&mut arg0.trade_tokens_max_amount, 0x1::type_name::get<T0>(), arg1);
    }

    public fun unpause(arg0: &mut VaultConfig, arg1: &0x2::tx_context::TxContext) {
    ...
    public fun when_not_paused(arg0: &VaultConfig) {
