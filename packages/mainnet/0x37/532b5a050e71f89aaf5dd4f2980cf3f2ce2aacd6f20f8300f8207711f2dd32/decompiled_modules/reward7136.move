module 0x37532b5a050e71f89aaf5dd4f2980cf3f2ce2aacd6f20f8300f8207711f2dd32::reward7136 {
    struct REWARD7136 has drop {
        dummy_field: bool,
    }

    struct TICKET_7136 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7136(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7136>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7136>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7136, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7136>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7136>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7136>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7136>>(v5, 0x2::tx_context::sender(arg1));
    }
