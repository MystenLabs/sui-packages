module 0x3752eb57130eb125b3b16969201dcfa60a71d6f07c2ac053ed15ae4d797b430b::bee {
    struct BEE has drop {
        dummy_field: bool,
    }
    ...
    public fun bees_tokens_to_coin<T0>(arg0: &mut 0x2::token::Token<T0>, arg1: &BeeCap<T0>, arg2: &mut 0x2::token::TokenPolicy<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v3 = 0xd8ed63c34bd16ba6b2e84a40f4d34fcbd182b5ad99588e2026e2ec02814a9788::math::mul_div_u128((arg3 as u128), (*0x2::vec_map::get<0x1::string::String, u64>(&0x2::token::rule_config<T0, Burn, BurnCondition>(v1, arg2).percent, &v2) as u128), (100 as u128));
        let (v4, v5) = 0x2::token::to_coin<T0>(v0, arg4);
        let (_, _, _, _) = 0x2::token::confirm_with_policy_cap<T0>(&arg1.policy_cap, v5, arg4);
