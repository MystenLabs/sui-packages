module 0x7e010db7e2fea3719e8756112b7b27e8a57d5744e82b57e3bb6823a64c9323df::LOTUSV1 {
    ...
    struct WithdrawBalanceA has copy, drop {
        pool_id: 0x2::object::ID,
        amount: u64,
        timestamp: u64,
    }

    struct WithdrawBalanceB has copy, drop {
        pool_id: 0x2::object::ID,
        amount: u64,
        timestamp: u64,
    }

    struct WithdrawRewards has copy, drop {
        pool_id: 0x2::object::ID,
        amount: u64,
        timestamp: u64,
    }

    struct WithdrawLpDeposit has copy, drop {
        pool_id: 0x2::object::ID,
        amount: u64,
        timestamp: u64,
    }

    struct WithdrawTradeFees has copy, drop {
        pool_id: 0x2::object::ID,
        amount: u64,
        timestamp: u64,
    }
    ...
    fun assert_can_withdraw<T0, T1>(arg0: &Pool<T0, T1>, arg1: &0x2::clock::Clock) {
        assert!(!arg0.buyback_open, 13);
        assert!(arg0.sold_out || get_timestamp(arg1) >= *0x1::option::borrow<u64>(&arg0.close_deadline), 12);
    }
    ...
    public entry fun buy_block<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::option::is_some<u64>(&arg0.close_deadline) && get_timestamp(arg3) >= *0x1::option::borrow<u64>(&arg0.close_deadline);
        assert!(!v0, 22);
        let (_, v2) = compute_total_input(arg0.block_price, arg1.trade_fee);
        assert!(0x2::coin::value<T0>(&arg2) >= v2, 20);
        let v3 = 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, v2, arg4));
        let v4 = trade_a_for_b<T0, T1>(arg0, arg1, v3, arg3, arg4);
        let v5 = 0x2::tx_context::sender(arg4);
        destroy_zero_or_transfer_balance<T0>(0x2::coin::into_balance<T0>(arg2), v5, arg4);
        destroy_zero_or_transfer_balance<T1>(v4, v5, arg4);
    }
    ...
    public fun create_lotus_pool<T0, T1>(arg0: &mut Factory, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: 0x2::balance::Balance<T1>, arg4: 0x2::balance::Balance<T1>, arg5: address, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: address, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg14 != @0x0, 9);
        assert!(arg9 <= arg8, 14);
        assert!(0x2::balance::value<T1>(&arg2) == arg7 * arg8, 21);
    ...
    public entry fun emergency_withdraw<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg1.launch_manager, 4);
        let v0 = arg1.launch_manager;
        arg0.pool_closed = true;
        let v1 = 0x2::balance::value<T0>(&arg0.balance_a);
        destroy_zero_or_transfer_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance_a, v1), v0, arg3);
        let v2 = 0x2::balance::value<T1>(&arg0.balance_b);
        destroy_zero_or_transfer_balance<T1>(0x2::balance::split<T1>(&mut arg0.balance_b, v2), v0, arg3);
        let v3 = 0x2::balance::value<T1>(&arg0.reward_balance_b);
        destroy_zero_or_transfer_balance<T1>(0x2::balance::split<T1>(&mut arg0.reward_balance_b, v3), v0, arg3);
        let v4 = 0x2::balance::value<T1>(&arg0.lp_deposit);
        destroy_zero_or_transfer_balance<T1>(0x2::balance::split<T1>(&mut arg0.lp_deposit, v4), v0, arg3);
        let v5 = 0x2::balance::value<T0>(&arg0.trade_balance_a);
        destroy_zero_or_transfer_balance<T0>(0x2::balance::split<T0>(&mut arg0.trade_balance_a, v5), v0, arg3);
        let v6 = EmergencyWithdraw{
            pool_id       : 0x2::object::id<Pool<T0, T1>>(arg0),
            amount_a      : v1,
            amount_b      : v2,
            amount_reward : v3,
        ...
        0x2::event::emit<EmergencyWithdraw>(v6);
    }
    ...
    public entry fun new_lotus_pool<T0, T1>(arg0: &CreatePoolLock, arg1: &mut Factory, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: address, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: address, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg5 == arg8 * arg9 * 10 / 4, 21);
        let v1 = arg5 * 4 / 10;
        let v2 = arg5 * 3 / 10;
        assert!(v1 * 10 == arg5 * 4, 21);
        assert!(v2 * 10 == arg5 * 3, 21);
        assert!((arg5 - v1 - v2) * 10 == arg5 * 3, 21);
        let v3 = 0x2::coin::split<T1>(&mut arg4, arg5, arg17);
        let v4 = 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, arg3, arg17));
        let v5 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v3, v1, arg17));
        let v6 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v3, v2, arg17));
        create_lotus_pool<T0, T1>(arg1, v4, v5, v6, 0x2::coin::into_balance<T1>(v3), arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17);
    ...
    public entry fun set_pool_closed<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert_can_withdraw<T0, T1>(arg0, arg3);
        let v0 = get_timestamp(arg3);
        if (!arg2) {
            assert!(!arg0.sold_out && !(v0 >= *0x1::option::borrow<u64>(&arg0.close_deadline)), 23);
        };
        arg0.pool_closed = arg2;
        let v1 = if (arg0.sold_out) {
            b"sold_out"
        } else {
            b"deadline_passed"
        };
    ...
    public fun trade_a_for_b<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        assert!(0x2::balance::value<T0>(&arg2) == v6, 18);
        assert!(0x2::balance::value<T1>(&arg0.balance_b) >= arg0.block_quantity, 19);
    ...
    public entry fun withdraw_balance_a<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg1.launch_manager, 4);
        assert_can_withdraw<T0, T1>(arg0, arg2);
        let v0 = 0x2::balance::value<T0>(&arg0.balance_a);
        destroy_zero_or_transfer_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance_a, v0), arg1.launch_manager, arg3);
        let v1 = WithdrawBalanceA{
            pool_id   : 0x2::object::id<Pool<T0, T1>>(arg0),
            amount    : v0,
            timestamp : get_timestamp(arg2),
        };
        0x2::event::emit<WithdrawBalanceA>(v1);
    }

    public entry fun withdraw_balance_b<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg1.launch_manager, 4);
        assert_can_withdraw<T0, T1>(arg0, arg2);
        let v0 = 0x2::balance::value<T1>(&arg0.balance_b);
        destroy_zero_or_transfer_balance<T1>(0x2::balance::split<T1>(&mut arg0.balance_b, v0), arg1.launch_manager, arg3);
        let v1 = WithdrawBalanceB{
            pool_id   : 0x2::object::id<Pool<T0, T1>>(arg0),
            amount    : v0,
            timestamp : get_timestamp(arg2),
        };
        0x2::event::emit<WithdrawBalanceB>(v1);
    }

    public entry fun withdraw_lp_deposit<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg1.launch_manager, 4);
        assert_can_withdraw<T0, T1>(arg0, arg2);
        let v0 = 0x2::balance::value<T1>(&arg0.lp_deposit);
        destroy_zero_or_transfer_balance<T1>(0x2::balance::split<T1>(&mut arg0.lp_deposit, v0), arg1.launch_manager, arg3);
        let v1 = WithdrawLpDeposit{
            pool_id   : 0x2::object::id<Pool<T0, T1>>(arg0),
            amount    : v0,
            timestamp : get_timestamp(arg2),
        };
        0x2::event::emit<WithdrawLpDeposit>(v1);
    }

    public entry fun withdraw_rewards<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg1.launch_manager, 4);
        assert_can_withdraw<T0, T1>(arg0, arg2);
        let v0 = 0x2::balance::value<T1>(&arg0.reward_balance_b);
        destroy_zero_or_transfer_balance<T1>(0x2::balance::split<T1>(&mut arg0.reward_balance_b, v0), arg1.launch_manager, arg3);
        let v1 = WithdrawRewards{
            pool_id   : 0x2::object::id<Pool<T0, T1>>(arg0),
            amount    : v0,
            timestamp : get_timestamp(arg2),
        };
        0x2::event::emit<WithdrawRewards>(v1);
    }

    public entry fun withdraw_trade_fees<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg1.admin, 4);
        assert!(0x2::balance::value<T0>(&arg0.trade_balance_a) > 0, 6);
        let v0 = 0x2::balance::value<T0>(&arg0.trade_balance_a);
        destroy_zero_or_transfer_balance<T0>(0x2::balance::split<T0>(&mut arg0.trade_balance_a, v0), arg1.trade_fee_wallet, arg3);
        let v1 = WithdrawTradeFees{
            pool_id   : 0x2::object::id<Pool<T0, T1>>(arg0),
            amount    : v0,
            timestamp : get_timestamp(arg2),
        };
        0x2::event::emit<WithdrawTradeFees>(v1);
    }
