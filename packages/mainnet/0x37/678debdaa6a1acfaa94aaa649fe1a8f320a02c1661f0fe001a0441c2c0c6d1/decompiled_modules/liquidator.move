module 0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::liquidator {
    ...
    public(friend) fun ensure_caller_whitelisted(arg0: &Liquidator, arg1: address) {
        assert!(0x2::vec_set::contains<address>(&arg0.whitelist, &arg1), 0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::error::not_whitelisted());
    }
    ...
    public fun update_slippage_tolerance(arg0: &LiquidatorAdminCap, arg1: &mut Liquidator, arg2: u32) {
        assert!(arg2 <= 10000, 0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::error::invalid_slippage());
