module 0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::cetus_agg {
    public fun swap<T0, T1, T2>(arg0: &mut 0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::custom_liquidate::CustomLiquidateReceipt<T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg3: bool, arg4: u64, arg5: &0x2::clock::Clock) {
        let (v0, v1) = if (arg3) {
            swap_a2b<T1, T2>(arg1, arg2, 0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::custom_liquidate::take_balance<T0, T1>(arg0, arg4), arg5)
        } else {
            swap_b2a<T1, T2>(arg1, arg2, 0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::custom_liquidate::take_balance<T0, T2>(arg0, arg4), arg5)
        };
        let v2 = v1;
        let v3 = v0;
        if (0x2::balance::value<T1>(&v3) > 0) {
            0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::custom_liquidate::put_balance<T0, T1>(arg0, v3);
        } else {
            0x2::balance::destroy_zero<T1>(v3);
        };
        if (0x2::balance::value<T2>(&v2) > 0) {
            0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::custom_liquidate::put_balance<T0, T2>(arg0, v2);
        } else {
    ...
    public fun flash_swap_fixed_output<T0, T1, T2>(arg0: &mut 0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::custom_liquidate::CustomLiquidateReceipt<T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg3: u64, arg4: bool, arg5: &0x2::clock::Clock) : (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::FlashSwapReceipt<T1, T2>, u64) {
        ...
        if (0x2::balance::value<T1>(&v6) > 0) {
            0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::custom_liquidate::put_balance<T0, T1>(arg0, v6);
        } else {
            0x2::balance::destroy_zero<T1>(v6);
        };
        if (0x2::balance::value<T2>(&v5) > 0) {
            0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::custom_liquidate::put_balance<T0, T2>(arg0, v5);
        } else {
    ...
    public fun repay_flash_swap_fixed_output<T0, T1, T2>(arg0: &mut 0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::custom_liquidate::CustomLiquidateReceipt<T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg3: bool, arg4: 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::FlashSwapReceipt<T1, T2>) {
        let (v0, v1) = if (arg3) {
            (0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::custom_liquidate::take_balance<T0, T1>(arg0, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T1, T2>(&arg4)), 0x2::balance::zero<T2>())
        } else {
            (0x2::balance::zero<T1>(), 0x37678debdaa6a1acfaa94aaa649fe1a8f320a02c1661f0fe001a0441c2c0c6d1::custom_liquidate::take_balance<T0, T2>(arg0, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T1, T2>(&arg4)))
        };
