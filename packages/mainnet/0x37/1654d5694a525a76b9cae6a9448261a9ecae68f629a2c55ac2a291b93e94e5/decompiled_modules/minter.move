module 0x371654d5694a525a76b9cae6a9448261a9ecae68f629a2c55ac2a291b93e94e5::minter {
    ...
    public fun request_to_mint<T0, T1>(arg0: &State, arg1: &mut 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        check_non_zero(arg2);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, bool>(&arg0.accepted_by_a, v0), 200);
        assert!(0x2::clock::timestamp_ms(arg7) / 1000 <= arg5 + 59, 203);
        assert!(0x2::coin::value<T0>(arg1) >= arg2, 202);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg1, arg2, arg8), arg0.pool_account_a);
        let v1 = MintRequest{
            transferred_token : v0,
            for_token         : 0x1::type_name::with_defining_ids<T1>(),
            requestor         : 0x2::tx_context::sender(arg8),
    ...
    public fun request_to_redeem<T0, T1>(arg0: &State, arg1: &mut 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        check_non_zero(arg2);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        ...
        assert!(0x2::clock::timestamp_ms(arg7) / 1000 <= arg5 + 59, 203);
        assert!(0x2::coin::value<T0>(arg1) >= arg2, 202);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg1, arg2, arg8), arg0.pool_account_b);
