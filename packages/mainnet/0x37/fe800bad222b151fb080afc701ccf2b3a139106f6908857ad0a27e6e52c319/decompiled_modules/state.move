module 0x37fe800bad222b151fb080afc701ccf2b3a139106f6908857ad0a27e6e52c319::state {
    ...
    public(friend) fun destroy(arg0: ExtensionStateV1, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage) {
        ...
        while (v1 < 0x1::vector::length<u8>(v0)) {
            let (v3, _) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_balance(arg1, *0x1::vector::borrow<u8>(v0, v1), 0x2::object::id_address<0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap>(&arg0.account_cap));
            if (!(v3 == 0)) {
                v2 = false;
                /* label 6 */
                assert!(v2, 0);
                ...
                0x2::transfer::public_transfer<0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap>(v6, @0x0);
        ...
        while (v2 < 0x1::vector::length<0x1::type_name::TypeName>(v1)) {
            if (0x1::vector::borrow<0x1::type_name::TypeName>(v1, v2) == &v0) {
                ...
                return if (0x1::option::is_none<u64>(&v3)) {
                    ...
                    let (v5, _) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_balance(arg1, *0x1::vector::borrow<u8>(&arg0.asset_ids, 0x1::option::extract<u64>(&mut v3)), 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::account_owner(&arg0.account_cap));
                    (v5 as u64)
                }
            };
            v2 = v2 + 1;
