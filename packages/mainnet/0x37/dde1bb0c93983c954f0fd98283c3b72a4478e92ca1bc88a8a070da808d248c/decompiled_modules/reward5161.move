module 0x37dde1bb0c93983c954f0fd98283c3b72a4478e92ca1bc88a8a070da808d248c::reward5161 {
    struct REWARD5161 has drop {
        dummy_field: bool,
    }

    struct TICKET_5161 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5161(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5161>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5161>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5161, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5161>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5161>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5161>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5161>>(v5, 0x2::tx_context::sender(arg1));
    }
