module 0x37ad7c15d301fd63106abadbc6b9d31ee7e80da5cfa0795e2179a0ec2a6db4e4::utils {
    ...
    public fun get_cur_leverage<T0, T1, T2>(arg0: &0x37ad7c15d301fd63106abadbc6b9d31ee7e80da5cfa0795e2179a0ec2a6db4e4::vault::Vault<T0, T1, T2>, arg1: &0xce7e9b076229e914dc87900323fa122fb6869f39fda82b85770d1aa27f61ad8e::oracle::KriyaOracle, arg2: &0xdf3da4bcc7939caf6486ecc104e1cbd69f97f2025195d270649566301d15eb96::registry::CoinDecimalsRegistry, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg4: &0x2::clock::Clock) : u64 {
        let (v0, v1, _) = calc_aum<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4);
        (((v1 as u256) * (0x37ad7c15d301fd63106abadbc6b9d31ee7e80da5cfa0795e2179a0ec2a6db4e4::vault::leverage_scaling() as u256) / (v0 as u256)) as u64)
    }
    ...
    fun scale(arg0: u128, arg1: u128) : u128 {
        (((arg0 as u256) * (arg1 as u256) / (0x37ad7c15d301fd63106abadbc6b9d31ee7e80da5cfa0795e2179a0ec2a6db4e4::vault::slippage_scaling() as u256)) as u128)
    }
