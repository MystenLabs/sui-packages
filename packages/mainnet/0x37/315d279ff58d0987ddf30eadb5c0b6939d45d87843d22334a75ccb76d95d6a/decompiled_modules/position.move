module 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::position {
    ...
    public(friend) fun order_filled<T0>(arg0: &0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::Version, arg1: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::TypusLeaderboardRegistry, arg3: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::tails_staking::TailsStakingRegistry, arg4: &0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::competition::CompetitionConfig, arg5: TradingOrder, arg6: 0x1::option::Option<Position>, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: bool, arg14: u64, arg15: u64, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) : (Position, u64, u64, u64) {
        ...
        let (v24, v25, v26, v27, v28) = if (0x1::option::is_some<Position>(&arg6)) {
            ...
            let v39 = &mut v29;
            update_position_borrow_rate_and_funding_rate(v39, arg8, arg9, arg10, arg11, arg12, arg13, arg14);
            let v40 = 0x2::balance::value<T0>(0x2::dynamic_field::borrow<0x1::string::String, 0x2::balance::Balance<T0>>(&v29.id, 0x1::string::utf8(b"collateral"))) + v23;
            let v41 = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::usd_to_amount(0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(v35, v29.size_decimal, arg10, arg11), v29.collateral_token_decimal, arg8, arg9);
            let v42 = if (v40 >= v41) {
                0
            } else {
                v41 - v40
            ...
            v29.reserve_amount = v42;
            v29.unrealized_trading_fee = v29.unrealized_trading_fee + v21;
            (v29, v31, v32, v33, v38)
        } else {
            let v43 = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::usd_to_amount(0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(v12, v13, arg10, arg11), v6, arg8, arg9);
            let v44 = if (v23 >= v43) {
                0
            } else {
                v43 - v23
            ...
            0x2::dynamic_field::add<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v45.id, 0x1::string::utf8(b"collateral"), 0x2::balance::zero<T0>());
            (v45, false, false, 0, v12)
        };
        let v46 = v24;
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v46.id, 0x1::string::utf8(b"collateral")), v20);
        let v47 = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::usd_to_amount(v27, v46.collateral_token_decimal, arg8, arg9);
        let v48 = if (!v26) {
            v47
        } else {
            0
        ...
        v46.collateral_amount = 0x2::balance::value<T0>(0x2::dynamic_field::borrow<0x1::string::String, 0x2::balance::Balance<T0>>(&v46.id, 0x1::string::utf8(b"collateral")));
        ...
        let v50 = if (v46.size != 0) {
            0x1::option::some<u64>(v46.position_id)
        } else {
            0x1::option::none<u64>()
        };
        let v51 = OrderFilledEvent{
            ...
            filled_size            : v28,
            filled_price           : arg10,
            position_side          : v46.is_long,
            position_size          : v46.size,
            position_average_price : v46.average_price,
            realized_trading_fee   : v21,
            realized_borrow_fee    : v46.unrealized_borrow_fee,
            realized_fee_in_usd    : 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(v21 + v46.unrealized_borrow_fee, v46.collateral_token_decimal, arg8, arg9),
            realized_amount        : v47,
