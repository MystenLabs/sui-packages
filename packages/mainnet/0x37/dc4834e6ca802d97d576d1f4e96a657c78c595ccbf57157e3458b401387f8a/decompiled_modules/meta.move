module 0x37dc4834e6ca802d97d576d1f4e96a657c78c595ccbf57157e3458b401387f8a::meta {
    ...
    fun init(arg0: META, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<META>(arg0, 9, b"META", b"META", b"META", 0x1::option::some<0x2::url::Url>(0x37dc4834e6ca802d97d576d1f4e96a657c78c595ccbf57157e3458b401387f8a::icon::get_icon_url()), arg1);
        let v2 = v1;
        let v3 = v0;
