module 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::testcoin {
    ...
    fun pool_dispatcher(arg0: &mut Vault) : &mut 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::pool_dispatcher::PoolDispatcher {
        0x2::object_bag::borrow_mut<0x1::string::String, 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::pool_dispatcher::PoolDispatcher>(&mut arg0.registry, 0x1::string::utf8(b"pool_dispatcher"))
    }
    ...
    public fun set_address_pool(arg0: &ScheduleAdminCap, arg1: &mut Vault, arg2: 0x1::string::String, arg3: address) {
        ...
        assert!(0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::pool_dispatcher::contains(v0, arg2), 3);
        0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::pool_dispatcher::set_address_pool(v0, arg2, arg3);
    }
    ...
    fun init(arg0: TESTCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::object_bag::add<0x1::string::String, 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::pool_dispatcher::PoolDispatcher>(&mut v2.registry, 0x1::string::utf8(b"pool_dispatcher"), 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::pool_dispatcher::default(arg1));
        0x2::object_bag::add<0x1::string::String, 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::treasury::Treasury<TESTCOIN>>(&mut v2.registry, 0x1::string::utf8(b"treasury"), 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::treasury::create<TESTCOIN>(v0, 3000000000000000000, 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::schedule::default<TESTCOIN>(), arg1));
        ...
        let v3 = ScheduleAdminCap{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<ScheduleAdminCap>(v3, 0x2::tx_context::sender(arg1));
    ...
    public fun insert_entry(arg0: &ScheduleAdminCap, arg1: &mut Vault, arg2: u64, arg3: vector<0x1::string::String>, arg4: vector<u64>, arg5: u64, arg6: u64, arg7: u64) {
        ...
        while (v2 < 0x1::vector::length<0x1::string::String>(&arg3)) {
            assert!(0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::pool_dispatcher::contains(v1, *0x1::vector::borrow<0x1::string::String>(&arg3, v2)), 3);
            v2 = v2 + 1;
        };
        0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::treasury::insert_entry<TESTCOIN>(treasury(arg1), arg2, 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::treasury::create_entry<TESTCOIN>(arg3, arg4, arg5, arg6, arg7));
    }

    public fun mint(arg0: &mut Vault, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 2);
        let v0 = treasury(arg0);
        let (v1, v2) = 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::treasury::mint<TESTCOIN>(v0, arg1, arg2);
        let v3 = v2;
        let v4 = v1;
        let v5 = pool_dispatcher(arg0);
        while (!0x1::vector::is_empty<0x1::string::String>(&v4)) {
            0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::pool_dispatcher::transfer<TESTCOIN>(v5, 0x1::vector::pop_back<0x1::string::String>(&mut v4), 0x1::vector::pop_back<0x2::coin::Coin<TESTCOIN>>(&mut v3));
        };
    ...
    public fun remove_entry(arg0: &ScheduleAdminCap, arg1: &mut Vault, arg2: u64) {
        assert!(arg1.version == 1, 2);
        0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::treasury::remove_entry<TESTCOIN>(treasury(arg1), arg2);
    }
    ...
    public fun set_entry(arg0: &ScheduleAdminCap, arg1: &mut Vault, arg2: u64, arg3: vector<0x1::string::String>, arg4: vector<u64>, arg5: u64, arg6: u64, arg7: u64) {
        ...
        0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::treasury::set_entry<TESTCOIN>(treasury(arg1), arg2, 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::treasury::create_entry<TESTCOIN>(arg3, arg4, arg5, arg6, arg7));
    }

    fun treasury(arg0: &mut Vault) : &mut 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::treasury::Treasury<TESTCOIN> {
        0x2::object_bag::borrow_mut<0x1::string::String, 0x3770a157e5c077945cbb5544d48229567f45ef17945d1320a47b117619f4d8ff::treasury::Treasury<TESTCOIN>>(&mut arg0.registry, 0x1::string::utf8(b"treasury"))
    }
