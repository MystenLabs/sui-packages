module 0x37eafa384f55622864685096aa6d7071acccf030a34bb0edec0c8ff865deada1::cnsnft8090 {
    struct CNSNFT8090 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8090, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8090>(arg0, arg1);
