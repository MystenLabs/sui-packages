module 0x3765fb08315853c2affc6259b8cbbd7d85aeaecdb69508e380feb45bbbcc5fbc::poetry_contest {
    ...
    public entry fun vote<T0: store + key>(arg0: address, arg1: &T0, arg2: &mut Contest<T0>, arg3: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg3);
