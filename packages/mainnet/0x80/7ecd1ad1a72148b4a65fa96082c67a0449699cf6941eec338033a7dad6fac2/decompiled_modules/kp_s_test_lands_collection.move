module 0x807ecd1ad1a72148b4a65fa96082c67a0449699cf6941eec338033a7dad6fac2::kp_s_test_lands_collection {
    struct KP_S_TEST_LANDS_COLLECTION has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: KP_S_TEST_LANDS_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<KP_S_TEST_LANDS_COLLECTION>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"KP's Test Lands Collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidjdgni2lwjbxhaxyxts4jv4hjgq7bkwqnp6uf2ltptvbicw4g4xm"));
