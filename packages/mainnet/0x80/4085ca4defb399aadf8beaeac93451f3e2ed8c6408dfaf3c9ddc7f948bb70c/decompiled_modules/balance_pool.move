module 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool {
    ...
    public fun add_shared_authorized_user(arg0: &mut BalancePool, arg1: vector<u8>, arg2: address) {
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::authority::add_authorized_user(&mut 0x2::dynamic_field::borrow_mut<vector<u8>, SharedBalancePool>(&mut arg0.id, arg1).authority, arg2);
    }
    ...
    public fun drop_shared_balance_pool(arg0: &mut BalancePool, arg1: vector<u8>, arg2: &0x2::tx_context::TxContext) {
        ...
        0x2::object::delete(v0);
        0x1::vector::destroy_empty<BalanceInfo>(v1);
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::authority::destroy(v2, arg2);
    }
    ...
    public fun new_shared_balance_pool(arg0: &mut BalancePool, arg1: vector<u8>, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = SharedBalancePool{
            ...
            balance_infos : 0x1::vector::empty<BalanceInfo>(),
            authority     : 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::authority::new(arg2, arg3),
        };
    ...
    public fun remove_shared_authorized_user(arg0: &mut BalancePool, arg1: vector<u8>, arg2: address) {
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::authority::remove_authorized_user(&mut 0x2::dynamic_field::borrow_mut<vector<u8>, SharedBalancePool>(&mut arg0.id, arg1).authority, arg2);
    }
    ...
    public fun send_shared<T0>(arg0: &mut BalancePool, arg1: vector<u8>, arg2: 0x1::option::Option<u64>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, SharedBalancePool>(&mut arg0.id, arg1);
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::authority::verify(&v0.authority, arg4);
        let v1 = 0;
        while (v1 < 0x1::vector::length<BalanceInfo>(&v0.balance_infos)) {
            let v2 = 0x1::vector::borrow_mut<BalanceInfo>(&mut v0.balance_infos, v1);
            if (v2.token == 0x1::type_name::get<T0>()) {
    ...
    public fun take_shared<T0>(arg0: &mut BalancePool, arg1: vector<u8>, arg2: 0x1::option::Option<u64>, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, SharedBalancePool>(&mut arg0.id, arg1);
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::authority::verify(&v0.authority, arg3);
        let v1 = 0;
        while (v1 < 0x1::vector::length<BalanceInfo>(&v0.balance_infos)) {
            let v2 = 0x1::vector::borrow_mut<BalanceInfo>(&mut v0.balance_infos, v1);
            if (v2.token == 0x1::type_name::get<T0>()) {
