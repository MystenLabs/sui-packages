module 0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_margin {
    ...
    public fun authorize_margin_deposit<T0>(arg0: &0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiVault<T0>, arg1: &0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiLeaderCap, arg2: &mut MarginAccount, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : MarginDepositAuth {
        let v0 = 0x2::object::id<0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiVault<T0>>(arg0);
        assert!(0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::leader_cap_vault_id(arg1) == v0, 100);
        assert!(arg2.vault_id == v0, 100);
        assert!(arg2.enabled, 100);
        assert!(arg3 > 0, 101);
        assert!(((arg2.total_allocated + arg3) as u128) <= (0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::available_usdc_for_trading<T0>(arg0) as u128) * (arg2.max_allocation_bps as u128) / (10000 as u128), 102);
    ...
    public fun authorize_margin_return<T0>(arg0: &0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiVault<T0>, arg1: &0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiLeaderCap, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : MarginReturnAuth {
        let v0 = 0x2::object::id<0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiVault<T0>>(arg0);
        assert!(0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::leader_cap_vault_id(arg1) == v0, 100);
        MarginReturnAuth{
    ...
    public fun consume_margin_deposit<T0>(arg0: MarginDepositAuth, arg1: &mut 0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiVault<T0>, arg2: &mut MarginAccount, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(v1 == 0x2::object::id<0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiVault<T0>>(arg1), 100);
        ...
        0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::extract_usdc_for_trading<T0>(arg1, v2, arg4)
    }

    public fun create_margin_account<T0>(arg0: &0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiVault<T0>, arg1: &0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiLeaderCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::leader_cap_vault_id(arg1) == 0x2::object::id<0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiVault<T0>>(arg0), 100);
        let v0 = 0x2::object::id<0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiVault<T0>>(arg0);
    ...
    public fun return_margin_funds<T0>(arg0: MarginReturnAuth, arg1: &mut 0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiVault<T0>, arg2: &mut MarginAccount, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock) {
        ...
        0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::deposit_usdc_from_trading<T0>(arg1, arg3);
    }
    ...
    public fun update_margin_settings<T0>(arg0: &0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiVault<T0>, arg1: &0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiLeaderCap, arg2: &mut MarginAccount, arg3: u64, arg4: u64, arg5: bool) {
        let v0 = 0x2::object::id<0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::SuiVault<T0>>(arg0);
        assert!(0x80a68a9612cf23a6d8c6a90980b2c4973110e1e0986bc6af9e93708376049bf9::sui_vault::leader_cap_vault_id(arg1) == v0, 100);
        assert!(arg2.vault_id == v0, 100);
