module 0x800bb5073160a644acf8c362b2fb795828a296623dd05b75bad52b362ec201a3::config {
    ...
    public fun assert_address_allocation(arg0: &Configuration, arg1: address, arg2: u64) {
        assert!(get_whitelist_allocation(arg0, arg1) >= arg2, 11);
    }

    public fun assert_box_allocation(arg0: &Configuration, arg1: 0x1::string::String, arg2: u64) {
        assert!(0x2::table::borrow<0x1::string::String, BoxConfig>(&arg0.box_config, arg1).whitelist_allocation >= arg2, 10);
    }
    ...
    public fun get_whitelist_allocation(arg0: &Configuration, arg1: address) : u64 {
        if (0x2::table::contains<address, u64>(&arg0.whitelist_config.whitelist, arg1)) {
            *0x2::table::borrow<address, u64>(&arg0.whitelist_config.whitelist, arg1)
        } else {
            0
        }
    }
    ...
    public(friend) fun update_after_sale(arg0: &mut Configuration, arg1: 0x1::string::String, arg2: u64, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        ...
        if (arg3) {
            let v1 = get_whitelist_allocation(arg0, 0x2::tx_context::sender(arg4)) - arg2;
            update_whitelist_allocation_int(arg0, 0x2::tx_context::sender(arg4), v1);
        };
    ...
    fun update_whitelist_allocation_int(arg0: &mut Configuration, arg1: address, arg2: u64) {
        ...
        if (0x2::table::contains<address, u64>(v0, arg1)) {
            if (arg2 == 0) {
                0x2::table::remove<address, u64>(v0, arg1);
            } else {
                *0x2::table::borrow_mut<address, u64>(v0, arg1) = arg2;
            };
        } else {
            if (arg2 == 0) {
                return
