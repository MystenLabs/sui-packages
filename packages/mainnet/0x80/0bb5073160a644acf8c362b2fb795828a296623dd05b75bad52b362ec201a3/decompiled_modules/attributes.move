module 0x800bb5073160a644acf8c362b2fb795828a296623dd05b75bad52b362ec201a3::attributes {
    ...
    public fun add_attributes(arg0: &mut AttributesRegistry, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>, arg5: &0x800bb5073160a644acf8c362b2fb795828a296623dd05b75bad52b362ec201a3::config::AdminCap, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun remove_attributes(arg0: &mut AttributesRegistry, arg1: 0x1::string::String, arg2: u64, arg3: &0x800bb5073160a644acf8c362b2fb795828a296623dd05b75bad52b362ec201a3::config::AdminCap) {
