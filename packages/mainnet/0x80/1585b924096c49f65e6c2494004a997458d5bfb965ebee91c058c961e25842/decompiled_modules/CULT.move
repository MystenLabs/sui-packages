module 0x801585b924096c49f65e6c2494004a997458d5bfb965ebee91c058c961e25842::CULT {
    struct CULT has drop {
        dummy_field: bool,
    }

    fun init(arg0: CULT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<CULT>(arg0, 2, b"CULT", b"CULT", b"CULT", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/iv__dcg-CZ_0C27lnoc2SFHYkMgE3600oh7yjzxQB6E?ext=png")), arg1);
