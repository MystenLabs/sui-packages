module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::tails_staking {
    ...
    entry fun allocate_profit_sharing<T0>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: vector<address>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<address>(&arg1) > 0) {
            ...
            let v4 = *0x1::vector::borrow<u64>(&v1.level_profits, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::tails_level(v3) - 1);
            if (!0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::contains_u64_padding(&v0.nft_manager_cap, v3, 0x1::string::utf8(b"dice_profit"))) {
                0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::insert_u64_padding(&v0.nft_manager_cap, v3, 0x1::string::utf8(b"dice_profit"), v4);
            } else {
                0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::update_u64_padding(&v0.nft_manager_cap, v3, 0x1::string::utf8(b"dice_profit"), v4);
            };
            v2 = v2 + v4;
        };
    ...
    entry fun set_profit_sharing<T0>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: vector<u64>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = ProfitSharing<T0>{
            level_profits : arg1,
            level_users   : 0x1::vector::empty<u64>(),
            total         : 0,
            remaining     : 0,
