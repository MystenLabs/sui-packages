module 0x800a2421642282bdb302c7c76411512fad16d70e05045fa83a586aa52bacd9f9::game {
        ...
        if (v2 > 0) {
            if (0x2::random::generate_u8_in_range(&mut v1, 0, 100) < 75) {
                ...
                if (0x1::option::is_some<0x2::object::ID>(&arg2)) {
                    let v10 = 0;
                    while (v10 < v2) {
                        if (0x2::object::id<Daemon>(0x1::vector::borrow<Daemon>(&arg1.daemons, v10)) == *0x1::option::borrow<0x2::object::ID>(&arg2)) {
                            v8 = v10;
                            v9 = true;
                            break
                        };
                ...
                if (!v9) {
                    v8 = 0x2::random::generate_u64_in_range(&mut v1, 0, v2);
                };
                let v11 = 0x1::vector::borrow_mut<Daemon>(&mut arg1.daemons, v8);
                v7 = 0x1::option::some<0x2::object::ID>(0x2::object::id<Daemon>(v11));
                let v12 = if (arg0.attack_power > 0) {
                    arg0.attack_power
                } else {
                    0x2::random::generate_u64_in_range(&mut v1, 10, 21)
                };
                v6 = v12;
                let v13 = if (v11.hp > v12) {
                    v11.hp = v11.hp - v12;
                    false
                } else {
                    v11.hp = 0;
                ...
                if (0x2::random::generate_u8_in_range(&mut v1, 0, 100) < 30 && !0x2::vec_set::contains<address>(&arg0.owned_keys, &arg1.validator_address)) {
                    ...
                    0x2::transfer::transfer<NodeKey>(v20, 0x2::tx_context::sender(arg5));
                    0x2::vec_set::insert<address>(&mut arg0.owned_keys, arg1.validator_address);
                };
            } else {
                v3 = 0x1::string::utf8(b"LOSS");
                v5 = false;
                let v21 = 0x2::random::generate_u64_in_range(&mut v1, 1, 5);
                v4 = v21;
                if (arg0.data_fragments >= v21) {
            ...
            if (0x2::random::generate_u8_in_range(&mut v1, 0, 100) < 30 && !0x2::vec_set::contains<address>(&arg0.owned_keys, &arg1.validator_address)) {
                ...
                0x2::transfer::transfer<NodeKey>(v22, 0x2::tx_context::sender(arg5));
                0x2::vec_set::insert<address>(&mut arg0.owned_keys, arg1.validator_address);
            };
            let v23 = 0x2::random::generate_u64_in_range(&mut v1, 5, 11);
            arg0.data_fragments = arg0.data_fragments + v23;
            v4 = v23;
        };
        arg0.last_hack = v0;
        let v24 = CombatLog{
