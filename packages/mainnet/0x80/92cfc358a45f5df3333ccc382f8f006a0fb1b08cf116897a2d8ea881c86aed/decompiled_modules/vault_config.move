module 0x4246f09b949f50f39162cfe2c25f8920a9b8f1b0e32f51c5c87e2941ecd700f1::vault_config {
    ...
    public(friend) fun credit_coin_v2<T0>(arg0: &mut VaultTokenHolder, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::bag::contains<0x1::type_name::TypeName>(&arg0.vault_bag, v0)) {
            create_vault<T0>(arg0, arg2);
        };
        0x2::balance::join<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.vault_bag, v0), 0x2::balance::redeem_funds<T0>(0x2::balance::withdraw_funds_from_object<T0>(&mut arg0.id, arg1)));
    }
