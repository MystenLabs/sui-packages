module 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::order_manager {
    ...
    public(friend) fun adjust_maker_orders(arg0: &mut OrderManager, arg1: &0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::Parameters, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &0x2::clock::Clock, arg6: u64, arg7: u64, arg8: &0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::order_book::OrderBook, arg9: &0x2::tx_context::TxContext) {
        if (!0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_trades_enabled(arg1)) {
            return
        };
        if (arg7 >= 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_max_volatility_for_multiple_times_1k(arg1)) {
        ...
        let (v3, v4, _) = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::get_asset_balances(arg2, arg4);
        if (0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::convert_to_quote_at_price(arg1, v3, arg6) + v4 < 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_minimum_portfolio(arg1)) {
            return
        };
        let v6 = arg6 / 10000;
        let v7 = v6 * 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_shallow_place_bps_times_1k(arg1) / 1000;
        let v8 = v7;
        let v9 = v6 * 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_deep_place_bps_times_1k(arg1) / 1000;
        let v10 = v9;
        if (arg7 > 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_min_volatility_for_multiple_times_1k(arg1)) {
            let v11 = 10000 + 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_volatility_multiplier_factor_times_10(arg1) * (arg7 - 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_min_volatility_for_multiple_times_1k(arg1));
            v8 = v7 * v11 / 10000;
            v10 = v9 * v11 / 10000;
        };
        let v12 = 0;
        let v13 = v10 / 4;
        ensure_maker_order_is_correct(arg0, arg1, arg2, arg4, arg3, 0, arg6 - v8, v12, true, 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_minimum_shallow_quantity_base(arg1), 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_step_shallow_quantity_base(arg1), arg8, true, true, arg5, arg9);
        ensure_maker_order_is_correct(arg0, arg1, arg2, arg4, arg3, 1, arg6 + v8, v12, false, 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_minimum_shallow_quantity_base(arg1), 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_step_shallow_quantity_base(arg1), arg8, true, true, arg5, arg9);
        if (0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_deep_trades_enabled(arg1)) {
            ensure_maker_order_is_correct(arg0, arg1, arg2, arg4, arg3, 2, arg6 - v10, v13, true, 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_max_deep_buy_quantity_base(arg1), 0, arg8, true, false, arg5, arg9);
            ensure_maker_order_is_correct(arg0, arg1, arg2, arg4, arg3, 3, arg6 + v10, v13, false, 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_max_deep_sell_quantity_base(arg1), 0, arg8, true, false, arg5, arg9);
        };
    }
    ...
    fun ensure_maker_order_is_correct(arg0: &mut OrderManager, arg1: &0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::Parameters, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg5: u64, arg6: u64, arg7: u64, arg8: bool, arg9: u64, arg10: u64, arg11: &0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::order_book::OrderBook, arg12: bool, arg13: bool, arg14: &0x2::clock::Clock, arg15: &0x2::tx_context::TxContext) {
        ...
        let v3 = arg6;
        if (arg12) {
            v3 = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::order_book::get_dimed_price(arg11, arg1, arg6, arg8, v0);
        };
        ...
        if (0x1::option::is_some<BasicOrder>(v4)) {
            ...
            if (v5.price >= v3 - arg7 && v5.price <= v3 + arg7) {
                ...
                if (v6 > 0x2::clock::timestamp_ms(arg14) && v6 - 0x2::clock::timestamp_ms(arg14) > 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_order_ttl_ms(arg1) / 2) {
                    return
                };
            };
        ...
        let v7 = arg9 + 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::abs_diff(arg6, v3) * 1000 / v3 / 10000 * arg10 / 1000;
        let v8 = v7;
        if (arg8) {
            if (arg13) {
                try_ensure_available_quote_balance(arg0, arg1, arg2, arg4, arg3, 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::convert_to_quote_at_price(arg1, v7, v3), arg14, arg15);
            };
            let v9 = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::convert_to_base_at_price(arg1, 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::get_available_quote_balance(arg1, arg2), v3);
            if (v7 > v9) {
                v8 = v9;
            };
            let v10 = v3 / v0 * v0;
            let v11 = v10;
            let v12 = v8 / v1 * v1;
            let v13 = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::get_best_ask(arg3, arg14);
            if (v10 >= v13) {
                v11 = v13 - v0;
            };
            if (v12 < v2) {
            ...
            let v15 = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::get_available_base_balance(arg1, arg2);
            if (v7 > v15) {
                v8 = v15;
            };
            ...
            let v17 = v16;
            let v18 = v8 / v1 * v1;
            let v19 = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::get_best_bid(arg3, arg14);
            if (v16 <= v19) {
                v17 = v19 + v0;
            };
            if (v18 < v2) {
            ...
            if (v17 < 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::minimum_sell_price_quote(arg1)) {
                return
            };
            let v20 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg3, arg2, arg4, arg5, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::post_only(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::cancel_maker(), v17, v18, false, false, 0x2::clock::timestamp_ms(arg14) + 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::maker_order_ttl_ms(arg1), arg14, arg15);
    ...
    fun reduce_or_cancel_order(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &mut 0x1::option::Option<BasicOrder>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        if (v1 > arg4 + v4 + v3) {
            let v5 = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::ensure_multiple_round_down(v1 - arg4, v3);
    ...
    public(friend) fun try_ensure_available_base_balance(arg0: &mut OrderManager, arg1: &0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::Parameters, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        let v0 = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::get_available_base_balance(arg1, arg2);
        if (arg5 <= v0) {
            return
        };
        let v1 = arg5 - v0;
        ...
        if (0x1::option::is_some<BasicOrder>(0x1::vector::borrow<0x1::option::Option<BasicOrder>>(&arg0.orders, 3))) {
            ...
            let v3 = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::get_available_base_balance(arg1, arg2);
            if (v1 <= v3) {
                return
            };
            arg5 = v1 - v3;
    ...
    public(friend) fun try_ensure_available_quote_balance(arg0: &mut OrderManager, arg1: &0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::parameters::Parameters, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        let v0 = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::get_available_quote_balance(arg1, arg2);
        if (arg5 <= v0) {
            return
        };
        let v1 = arg5 - v0;
        ...
        if (0x1::option::is_some<BasicOrder>(0x1::vector::borrow<0x1::option::Option<BasicOrder>>(&arg0.orders, 2))) {
            ...
            let v3 = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::convert_to_base_at_price(arg1, v1, 0x1::option::borrow<BasicOrder>(v2).price);
            reduce_or_cancel_order(arg2, arg3, arg4, v2, v3, arg6, arg7);
            let v4 = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::get_available_quote_balance(arg1, arg2);
            if (v1 <= v4) {
                return
            };
            arg5 = v1 - v4;
        ...
        if (0x1::option::is_some<BasicOrder>(0x1::vector::borrow<0x1::option::Option<BasicOrder>>(&arg0.orders, 0))) {
            ...
            let v6 = 0x8059c0d2daf7d1c461037ec06d22c7375387a2ad0a122b3709d7888ee97d8bbe::common::convert_to_base_at_price(arg1, arg5, 0x1::option::borrow<BasicOrder>(v5).price);
