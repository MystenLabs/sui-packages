module 0x80395d4e6b92c8757107e7b198b8af5d888524f8c58120201cd2ec86737c84d4::wolfie {
    ...
    fun init(arg0: WOLFIE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/ethereum/0x34190f79a4051e603d43451a6b21dfc55bbe0b1d.png                                                                                                                                                                                                                               ");
