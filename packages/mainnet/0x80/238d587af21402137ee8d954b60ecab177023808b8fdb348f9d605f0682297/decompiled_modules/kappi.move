module 0x80238d587af21402137ee8d954b60ecab177023808b8fdb348f9d605f0682297::kappi {
    struct KAPPI has drop {
        dummy_field: bool,
    }

    fun init(arg0: KAPPI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<KAPPI>(arg0, 9, b"KAPPI", b"KAPPI On Sui", b"KAPPI On Sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://www.kappi.fun/_next/image?url=%2Flogo.jpg&w=2048&q=75")), arg1);
        let v2 = v0;
