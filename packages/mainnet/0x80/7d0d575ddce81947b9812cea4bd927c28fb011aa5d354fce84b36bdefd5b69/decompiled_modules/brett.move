module 0x807d0d575ddce81947b9812cea4bd927c28fb011aa5d354fce84b36bdefd5b69::brett {
    ...
    fun init(arg0: BRETT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BRETT>(arg0, 6, b"BRETTTEST", b"BRETTTEST", b"BRETT Token - Based on a Boy's Best Friend", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
