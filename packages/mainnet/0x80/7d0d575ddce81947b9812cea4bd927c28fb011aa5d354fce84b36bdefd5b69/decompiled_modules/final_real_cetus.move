module 0x807d0d575ddce81947b9812cea4bd927c28fb011aa5d354fce84b36bdefd5b69::final_real_cetus {
    ...
    public entry fun collect_and_distribute_real_fees<T0, T1>(arg0: &FeeCollectorConfig, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.burn_percentage + arg0.marketing_percentage + arg0.reflection_percentage == 100, 0);
        let (v0, v1) = make_real_cetus_collect_call<T0, T1>(arg1, arg2, arg3, false, arg4);
    ...
    public entry fun collect_fees_transaction_pattern<T0, T1>(arg0: &FeeCollectorConfig, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) {
        collect_and_distribute_real_fees<T0, T1>(arg0, arg1, arg2, arg3, arg4);
    }

    public fun distribute_cetus_balances<T0, T1>(arg0: &FeeCollectorConfig, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        distribute_collected_balances<T0, T1>(arg0, arg1, arg2, arg3);
    }
    ...
    public entry fun distribute_fee_coins<T0, T1>(arg0: &FeeCollectorConfig, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun execute_real_cetus_call<T0, T1>(arg0: address, arg1: vector<u8>, arg2: vector<u8>, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
    ...
    public fun make_real_cetus_collect_call<T0, T1>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        execute_real_cetus_call<T0, T1>(@0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb, b"pool", b"collect_fee", arg0, arg1, arg2, arg3, arg4)
    }
