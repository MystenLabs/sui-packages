module 0x80d70197b5ab4f5cf406e7edd25e1d5fdcfe427c291fbc3b0be244081dd90302::distributor {
    ...
    public entry fun claim<T0>(arg0: &mut Distributor<T0>, arg1: u64, arg2: vector<vector<u8>>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 > v2, 4);
        let v3 = 0x80d70197b5ab4f5cf406e7edd25e1d5fdcfe427c291fbc3b0be244081dd90302::merkle::leaf(v1, arg1);
        assert!(0x80d70197b5ab4f5cf406e7edd25e1d5fdcfe427c291fbc3b0be244081dd90302::merkle::verify(&arg0.merkle_root, &v3, &arg2), 5);
        let v4 = arg1 - v2;
