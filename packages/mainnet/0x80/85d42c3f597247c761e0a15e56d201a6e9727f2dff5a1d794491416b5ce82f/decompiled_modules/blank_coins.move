module 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::blank_coins {
    ...
    public fun deposit_coin_set<T0>(arg0: &mut BlankCoinsRegistry, arg1: &mut 0x2::coin_registry::Currency<T0>, arg2: 0x2::coin::TreasuryCap<T0>, arg3: 0x2::coin_registry::MetadataCap<T0>, arg4: u8, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.total_sets < 100000, 7);
        assert!(arg4 <= 18, 13);
        validate_coin_set_for_registry<T0>(arg1, &arg2, &arg3, arg6);
    ...
    public entry fun deposit_coin_set_entry<T0>(arg0: &mut BlankCoinsRegistry, arg1: &mut 0x2::coin_registry::Currency<T0>, arg2: 0x2::coin::TreasuryCap<T0>, arg3: 0x2::coin_registry::MetadataCap<T0>, arg4: u8, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    fun validate_coin_set_for_registry<T0>(arg0: &mut 0x2::coin_registry::Currency<T0>, arg1: &0x2::coin::TreasuryCap<T0>, arg2: &0x2::coin_registry::MetadataCap<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        validate_coin_set<T0>(arg1);
        assert_new_unregulated_currency<T0>(arg0, arg3);
        let v0 = 0x2::coin_registry::treasury_cap_id<T0>(arg0);
        assert!(0x1::option::is_some<0x2::object::ID>(&v0), 15);
        assert!(*0x1::option::borrow<0x2::object::ID>(&v0) == 0x2::object::id<0x2::coin::TreasuryCap<T0>>(arg1), 15);
        let v1 = 0x2::coin_registry::metadata_cap_id<T0>(arg0);
        assert!(0x1::option::is_some<0x2::object::ID>(&v1), 15);
        assert!(*0x1::option::borrow<0x2::object::ID>(&v1) == 0x2::object::id<0x2::coin_registry::MetadataCap<T0>>(arg2), 15);
        assert!(0x2::coin_registry::symbol<T0>(arg0) == 0x1::string::utf8(b"Govex Conditional"), 14);
        let v2 = 0x2::coin_registry::name<T0>(arg0);
        assert!(0x1::string::is_empty(&v2), 10);
        let v3 = 0x2::coin_registry::description<T0>(arg0);
        assert!(0x1::string::is_empty(&v3), 10);
        let v4 = 0x2::coin_registry::icon_url<T0>(arg0);
        assert!(0x1::string::is_empty(&v4), 10);
        let v5 = 0x1::type_name::with_original_ids<T0>();
        let v6 = 0x1::ascii::into_bytes(0x1::type_name::get_module(&v5));
        let v7 = b"conditional_";
        let v8 = 0x1::vector::length<u8>(&v7);
        assert!(0x1::vector::length<u8>(&v6) > v8, 10);
        let v9 = 0;
        while (v9 < v8) {
            assert!(*0x1::vector::borrow<u8>(&v6, v9) == *0x1::vector::borrow<u8>(&v7, v9), 10);
            v9 = v9 + 1;
        };
        while (v9 < 0x1::vector::length<u8>(&v6)) {
            let v10 = *0x1::vector::borrow<u8>(&v6, v9);
            assert!(v10 >= 48 && v10 <= 57, 10);
            v9 = v9 + 1;
        };
    }
