module 0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::pool {
    ...
    public(friend) fun new<T0>(arg0: CreatePoolCap<T0>, arg1: &mut 0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::pool_registry::PoolRegistry, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<0x1::ascii::String>, arg8: vector<u64>, arg9: u64, arg10: vector<u64>, arg11: vector<u64>, arg12: vector<u64>, arg13: vector<u64>, arg14: 0x1::option::Option<vector<u8>>, arg15: bool, arg16: 0x1::option::Option<u8>, arg17: &mut 0x2::tx_context::TxContext) : Pool<T0> {
        ...
        0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::pool_registry::register_pool<T0>(arg1, &v10, arg7, arg8, arg9, arg10, arg11, arg12, arg13);
    ...
    fun borrow_balance<T0, T1>(arg0: &Pool<T0>) : &0x2::balance::Balance<T1> {
        0x2::dynamic_field::borrow<0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::keys::BalanceKey<T1>, 0x2::balance::Balance<T1>>(&arg0.id, 0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::keys::type_to_balance_key<T1>())
    }

    fun borrow_mut_balance<T0, T1>(arg0: &mut Pool<T0>) : &mut 0x2::balance::Balance<T1> {
        0x2::dynamic_field::borrow_mut<0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::keys::BalanceKey<T1>, 0x2::balance::Balance<T1>>(&mut arg0.id, 0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::keys::type_to_balance_key<T1>())
    }
    ...
    public fun contains_type<T0, T1>(arg0: &Pool<T0>) : bool {
        let v0 = 0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::keys::type_to_string<T1>();
    ...
    public(friend) fun initialize_liquidity<T0, T1>(arg0: &mut 0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::pool_registry::PoolRegistry, arg1: &mut Pool<T0>, arg2: 0x2::coin::Coin<T1>) {
        0x2::dynamic_field::add<0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::keys::BalanceKey<T1>, 0x2::balance::Balance<T1>>(&mut arg1.id, 0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::keys::type_to_balance_key<T1>(), 0x2::balance::zero<T1>());
        join<T0, T1>(arg1, arg2);
        0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::pool_registry::add_coin<T1>(arg0);
    }
    ...
    public fun lp_type<T0>(arg0: &Pool<T0>) : 0x1::ascii::String {
        0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::keys::type_to_string<T0>()
    }
    ...
    public(friend) fun type_to_index<T0, T1>(arg0: &Pool<T0>) : u64 {
        type_name_to_index<T0>(arg0, 0x80e12980ac74e31421ff0029a5a2caf22826484fb5194ab6de9cbc58524d3e63::keys::type_to_string<T1>())
    }
