module 0x800156d585dde895367022a316b848547944ca4eb13faa840c51ed421c7545fe::special_collection_nft {
    ...
    struct TomCollection has store, key {
        id: 0x2::object::UID,
        name: 0x1::string::String,
        description: 0x1::string::String,
    ...
    public entry fun create_collection(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = TomCollection{
            id          : 0x2::object::new(arg2),
            name        : 0x1::string::utf8(arg0),
            description : 0x1::string::utf8(arg1),
            nfts        : 0x2::vec_set::empty<0x2::object::ID>(),
        };
        0x2::transfer::public_transfer<TomCollection>(v0, 0x2::tx_context::sender(arg2));
    }
    ...
    fun init(arg0: SPECIAL_COLLECTION_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"Tom"));
        0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"TOM"));
        let v10 = 0x2::display::new_with_fields<TomCollection>(&v4, v6, v8, arg1);
        0x2::display::update_version<TomCollection>(&mut v10);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TomNFT>>(v5, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TomCollection>>(v10, 0x2::tx_context::sender(arg1));
    }
    ...
    public entry fun mint_to_collection(arg0: &mut TomCollection, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun remove_from_collection(arg0: &mut TomCollection, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
