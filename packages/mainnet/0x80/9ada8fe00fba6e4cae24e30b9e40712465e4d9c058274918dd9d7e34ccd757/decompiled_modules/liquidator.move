module 0x809ada8fe00fba6e4cae24e30b9e40712465e4d9c058274918dd9d7e34ccd757::liquidator {
    ...
    public(friend) fun ensure_caller_whitelisted(arg0: &Liquidator, arg1: address) {
        assert!(0x2::vec_set::contains<address>(&arg0.whitelist, &arg1), 0x809ada8fe00fba6e4cae24e30b9e40712465e4d9c058274918dd9d7e34ccd757::error::not_whitelisted());
    }
    ...
    public fun update_slippage_tolerance(arg0: &LiquidatorAdminCap, arg1: &mut Liquidator, arg2: u32) {
        assert!(arg2 <= 10000, 0x809ada8fe00fba6e4cae24e30b9e40712465e4d9c058274918dd9d7e34ccd757::error::invalid_slippage());
