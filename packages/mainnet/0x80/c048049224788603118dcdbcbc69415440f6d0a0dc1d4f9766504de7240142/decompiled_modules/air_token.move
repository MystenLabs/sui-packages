module 0x80c048049224788603118dcdbcbc69415440f6d0a0dc1d4f9766504de7240142::air_token {
    ...
    public fun mint_and_transfer(arg0: &mut 0x2::coin::TreasuryCap<AIR_TOKEN>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<AIR_TOKEN>>(0x2::coin::mint<AIR_TOKEN>(arg0, arg1, arg3), arg2);
    }

    public fun mint_to_sender(arg0: &mut 0x2::coin::TreasuryCap<AIR_TOKEN>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<AIR_TOKEN>>(0x2::coin::mint<AIR_TOKEN>(arg0, arg1, arg2), 0x2::tx_context::sender(arg2));
    }
