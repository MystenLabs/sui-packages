module 0x80972ee47acfe56a8bbed06db62ac88cc4a86244e4117c0d2201fc14586e5b97::cnsnft6355 {
    struct CNSNFT6355 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6355, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6355>(arg0, arg1);
