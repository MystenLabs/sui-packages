module 0x80d51d854340625b6d177b6c6a6de3dc6a0c3d27a13533143ccdd2bf5f9aa052::reward_nft_w2 {
    struct REWARD_NFT_W2 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = REWARD_NFT{
                ...
                image_url   : 0x1::string::utf8(b"ipfs://QmeJwBNxRXvGcfKD1T2XRbcNbL29mAd7rX8cF7Crag5reQ"),
    ...
    fun init(arg0: REWARD_NFT_W2, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmeJwBNxRXvGcfKD1T2XRbcNbL29mAd7rX8cF7Crag5reQ"));
        ...
        let v4 = 0x2::package::claim<REWARD_NFT_W2>(arg0, arg1);
