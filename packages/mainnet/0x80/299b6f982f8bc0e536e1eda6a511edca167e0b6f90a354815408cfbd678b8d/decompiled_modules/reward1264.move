module 0x80299b6f982f8bc0e536e1eda6a511edca167e0b6f90a354815408cfbd678b8d::reward1264 {
    struct REWARD1264 has drop {
        dummy_field: bool,
    }

    struct TICKET_1264 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1264(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1264>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1264>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1264, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1264>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1264>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1264>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1264>>(v5, 0x2::tx_context::sender(arg1));
    }
