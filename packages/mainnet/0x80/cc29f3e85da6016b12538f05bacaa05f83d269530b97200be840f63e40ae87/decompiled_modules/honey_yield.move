module 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield {
    struct HoneyYield has key {
        id: 0x2::object::UID,
        sui_treasury: 0x2::balance::Balance<0x2::sui::SUI>,
        honey_bought_back: 0x2::balance::Balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>,
        honey_to_burn: 0x2::balance::Balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>,
    ...
    public fun add_honey_bought_back(arg0: &mut HoneyYield, arg1: 0x2::balance::Balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>) {
        0x2::balance::join<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>(&mut arg0.honey_bought_back, arg1);
    }
    ...
    public fun deposit_honey_to_burn(arg0: &mut HoneyYield, arg1: 0x2::balance::Balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>) {
        assert!(arg0.module_version == 0, 4010);
        0x2::balance::join<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>(&mut arg0.honey_to_burn, arg1);
    }
    ...
    public fun get_fee_info<T0>(arg0: &HoneyYield) : (u64, u64) {
        if (0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::curves::is_stable<T0>()) {
            return (arg0.pool_fee_config.stable_pool_fee.total_fee_bps, arg0.pool_fee_config.stable_pool_fee.protocol_fee_pct)
        };
        if (0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::curves::is_weighted<T0>()) {
            return (arg0.pool_fee_config.weighted_pool_fee.total_fee_bps, arg0.pool_fee_config.weighted_pool_fee.protocol_fee_pct)
        };
        if (0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::curves::is_curved<T0>()) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = CreatorRewardsClaimCap{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<CreatorRewardsClaimCap>(v4, 0x2::tx_context::sender(arg0));
        let v5 = NectarCap{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<NectarCap>(v5, 0x2::tx_context::sender(arg0));
        let v6 = FeeInfo{
            total_fee_bps    : 100,
            protocol_fee_pct : 50,
        };
        ...
        let v9 = DefaultFeeInfo{
            weighted_pool_fee : v6,
            stable_pool_fee   : v7,
            curved_pool_fee   : v8,
        };
        let v10 = HoneyYield{
            ...
            honey_bought_back  : 0x2::balance::zero<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>(),
            honey_to_burn      : 0x2::balance::zero<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>(),
        ...
        let v11 = &mut v10;
        create_fee_collector<0x2::sui::SUI>(&v2, v11, arg0);
        0x2::transfer::transfer<TwoAmmAccess>(v2, 0x2::tx_context::sender(arg0));
        0x2::transfer::share_object<HoneyYield>(v10);
    }
    ...
    public fun mint_new_honey_claimer(arg0: &0x2::coin::TreasuryCap<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (address, ClaimHoneyCap) {
    ...
    public fun update_claimer_capability(arg0: &0x2::coin::TreasuryCap<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>, arg1: &mut ClaimHoneyCap, arg2: u64, arg3: u64) {
    ...
    public fun update_default_fee_for_curve<T0>(arg0: &mut HoneyYield, arg1: &HoneyYieldAdminCap, arg2: u64, arg3: u64) {
        assert!(arg0.module_version == 0, 4010);
        0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::curves::assert_valid_curve<T0>();
        if (0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::curves::is_stable<T0>()) {
            let v0 = &mut arg0.pool_fee_config.stable_pool_fee;
            update_fee(v0, arg2, arg3);
        } else if (0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::curves::is_weighted<T0>()) {
            let v1 = &mut arg0.pool_fee_config.weighted_pool_fee;
            update_fee(v1, arg2, arg3);
        } else if (0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::curves::is_curved<T0>()) {
    ...
    public fun withdraw_honey_bought_back(arg0: &HoneyBoughtBackClaimCap, arg1: &mut HoneyYield) : 0x2::balance::Balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY> {
        let v0 = HoneyBoughtBackWithdrawn{amount: 0x2::balance::value<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>(&arg1.honey_bought_back)};
        0x2::event::emit<HoneyBoughtBackWithdrawn>(v0);
        0x2::balance::withdraw_all<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>(&mut arg1.honey_bought_back)
    }

    public fun withdraw_honey_to_burn(arg0: &mut HoneyYield, arg1: &0x2::coin::TreasuryCap<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>) : 0x2::balance::Balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY> {
        0x2::balance::withdraw_all<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey::HONEY>(&mut arg0.honey_to_burn)
    }
