module 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::token_rules {
    ...
    struct TokenRules has store, key {
        id: 0x2::object::UID,
        rewards_claim_cap: 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::CreatorRewardsClaimCap,
    ...
    public fun claim_creator_rewards<T0>(arg0: &mut TokenRules, arg1: &0x2::token::TokenPolicyCap<T0>, arg2: &mut 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::FeeCollector<T0>, arg3: &0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::HoneyYield, arg4: &mut 0x2::token::TokenPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::from_balance<T0>(0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::claim_creator_rewards<T0>(&arg0.rewards_claim_cap, arg1, arg2), arg5);
    ...
    public fun buy_tokens_with_tax<T0>(arg0: &TokenTradeCap, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::FeeCollector<T0>, arg3: &0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::HoneyYield, arg4: &mut 0x2::token::TokenPolicy<T0>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) : 0x2::token::ActionRequest<T0> {
    ...
    public fun calculate_add_liquidity_tax_amounts<T0>(arg0: &0x2::token::TokenPolicy<T0>, arg1: &0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::HoneyYield, arg2: u64, arg3: address) : (u64, u64, u64, u64) {
        calculate_tax_amounts<T0>(arg0, arg1, arg2, 6, arg3)
    }

    public fun calculate_buy_tax_amounts<T0>(arg0: &0x2::token::TokenPolicy<T0>, arg1: &0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::HoneyYield, arg2: u64, arg3: address) : (u64, u64, u64, u64) {
        calculate_tax_amounts<T0>(arg0, arg1, arg2, 4, arg3)
    }

    public fun calculate_remove_liquidity_tax_amounts<T0>(arg0: &0x2::token::TokenPolicy<T0>, arg1: &0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::HoneyYield, arg2: u64, arg3: address) : (u64, u64, u64, u64) {
        calculate_tax_amounts<T0>(arg0, arg1, arg2, 7, arg3)
    }

    public fun calculate_sell_tax_amounts<T0>(arg0: &0x2::token::TokenPolicy<T0>, arg1: &0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::HoneyYield, arg2: u64, arg3: address) : (u64, u64, u64, u64) {
        calculate_tax_amounts<T0>(arg0, arg1, arg2, 5, arg3)
    }

    public fun calculate_tax_amounts<T0>(arg0: &0x2::token::TokenPolicy<T0>, arg1: &0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::HoneyYield, arg2: u64, arg3: u8, arg4: address) : (u64, u64, u64, u64) {
        ...
        (arg2 - v1, v1, v1 * 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::get_honey_tax_pct(arg1) / 100, v1 * 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::get_creator_tax_pct<T0>(arg1) / 100)
    }

    fun charge_taxes_on_burn_tax<T0>(arg0: &mut 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::FeeCollector<T0>, arg1: &0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::HoneyYield, arg2: &0x2::token::TokenPolicy<T0>, arg3: &mut 0x2::token::Token<T0>, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        let v0 = 0x2::token::value<T0>(arg3);
        let v1 = 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::get_honey_tax_pct(arg1);
        let v2 = 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::get_creator_tax_pct<T0>(arg1);
        if (v1 == 0 && v2 == 0) {
            return (0, 0)
        };
        let v3 = v0 * v1 / 100;
        ...
        if (v3 > 0) {
            ...
            0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::collect_fee_for_coin<T0>(arg0, 0x2::coin::into_balance<T0>(v6));
        };
        if (v4 > 0) {
            ...
            0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::add_rewards_for_coin<T0>(arg0, 0x2::coin::into_balance<T0>(v14));
        } else {
    ...
    public fun from_coin_for_remove_liquidity_with_tax<T0>(arg0: &TokenTradeCap, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::FeeCollector<T0>, arg3: &0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::HoneyYield, arg4: &mut 0x2::token::TokenPolicy<T0>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) : 0x2::token::ActionRequest<T0> {
        let v0 = 0x2::tx_context::sender(arg6);
        let v1 = 0;
        let v2 = 0;
        let v3 = 0;
    ...
    public fun initialize_token_rules(arg0: 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::CreatorRewardsClaimCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = TokenRules{
    ...
    public fun set_token_taxes<T0>(arg0: &0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::TwoAmmAccess, arg1: &mut TokenRules, arg2: &mut 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::HoneyYield, arg3: &mut 0x2::token::TokenPolicy<T0>, arg4: &0x2::token::TokenPolicyCap<T0>, arg5: HoneyTaxConfig, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::create_fee_collector<T0>(arg0, arg2, arg7);
        0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::set_creator_tax_pct_for_token<T0>(arg2, arg4, arg6);
    ...
    public fun to_coin_for_add_liquidity_with_tax<T0>(arg0: &TokenTradeCap, arg1: &mut 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::FeeCollector<T0>, arg2: &0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::HoneyYield, arg3: 0x2::token::Token<T0>, arg4: &mut 0x2::token::TokenPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::token::ActionRequest<T0>) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::token::value<T0>(&arg3);
        let v2 = 0;
        let v3 = 0;
