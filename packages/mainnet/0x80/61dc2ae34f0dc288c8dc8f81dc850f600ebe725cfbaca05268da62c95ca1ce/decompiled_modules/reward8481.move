module 0x8061dc2ae34f0dc288c8dc8f81dc850f600ebe725cfbaca05268da62c95ca1ce::reward8481 {
    struct REWARD8481 has drop {
        dummy_field: bool,
    }

    struct TICKET_8481 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8481(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_8481>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8481, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8481>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8481>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8481>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8481>>(v5, 0x2::tx_context::sender(arg1));
    }
