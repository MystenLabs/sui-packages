module 0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::farm {
    ...
    public(friend) fun harvest<T0>(arg0: &mut Farm<T0>, arg1: &0x2::clock::Clock) {
        ...
        while (v3 < 0x1::vector::length<0x1::type_name::TypeName>(v2)) {
            let v4 = 0x2::table::borrow_mut<0x1::type_name::TypeName, RewardInfo>(&mut arg0.reward_infos, *0x1::vector::borrow<0x1::type_name::TypeName>(v2, v3));
            if (*v1 > v4.end_timestamp) {
                v3 = v3 + 1;
                continue
            };
            let v5 = if (v0 > v4.end_timestamp) {
                v4.end_timestamp - *v1
            } else {
                v0 - *v1
            };
            let v6 = v4.end_timestamp - *v1;
            if (v6 == 0) {
                v3 = v3 + 1;
                continue
            };
            let v7 = 0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::utils::mul_factor(v5, v4.total_rewards, v6);
            if (v4.total_rewards > v7) {
                v4.total_rewards = v4.total_rewards - v7;
            } else {
                v4.total_rewards = 0;
            };
            v4.harvested_rewards = v4.harvested_rewards + v7;
            v4.cumulative_index = v4.cumulative_index + 0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::utils::mul_factor_u128((v7 as u128), 18446744073709551616, (arg0.total_weight as u128));
            v3 = v3 + 1;
        };
        *v1 = v0;
    }
