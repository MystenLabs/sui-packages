module 0x809538cd160a2ce508c29f401fd13f508e9d67fede04d786681417d4d72010bf::cnsnft4594 {
    struct CNSNFT4594 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4594, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4594>(arg0, arg1);
