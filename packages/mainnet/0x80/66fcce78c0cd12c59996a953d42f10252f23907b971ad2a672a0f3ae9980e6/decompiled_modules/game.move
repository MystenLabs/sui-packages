module 0x8066fcce78c0cd12c59996a953d42f10252f23907b971ad2a672a0f3ae9980e6::game {
    ...
    public fun place_bet(arg0: &mut GameData, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::table::borrow_mut<u64, Epoch>(&mut arg0.epochs, arg0.current_epoch_id);
        assert!(0x2::clock::timestamp_ms(arg3) < v1.betting_close_time_ms, 1);
        let v2 = 0x2::coin::value<0x2::sui::SUI>(&arg1);
        assert!(v2 >= 1000000000, 5);
        let v3 = BetInfo{
            player_address : v0,
            amount         : v2,
            is_high_bet    : arg2,
        };
        0x1::vector::push_back<BetInfo>(&mut v1.bets, v3);
        if (arg2) {
            0x2::balance::join<0x2::sui::SUI>(&mut v1.high_pool_balance, 0x2::coin::into_balance<0x2::sui::SUI>(arg1));
            v1.total_high_tickets = v1.total_high_tickets + v2;
        } else {
            0x2::balance::join<0x2::sui::SUI>(&mut v1.low_pool_balance, 0x2::coin::into_balance<0x2::sui::SUI>(arg1));
            v1.total_low_tickets = v1.total_low_tickets + v2;
        };
        let v4 = 0x2::table::borrow_mut<address, PlayerData>(&mut arg0.player_profiles, v0);
        v4.lifetime_tickets = v4.lifetime_tickets + v2;
        arg0.lifetime_tickets_bought = arg0.lifetime_tickets_bought + v2;
    }
    ...
    public fun resolve_epoch_and_create_next(arg0: &mut GameData, arg1: &GameAdmin, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v15 = 0x2::balance::value<0x2::sui::SUI>(v5);
        if (v15 > 0) {
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.platform_fees, 0x2::balance::split<0x2::sui::SUI>(v5, v15));
        };
        let v16 = v0 + 1;
        let v17 = 0x2::clock::timestamp_ms(arg3);
        let v18 = Epoch{
            id                    : 0x2::object::new(arg4),
            epoch_id              : v16,
            start_time_ms         : v17,
            end_time_ms           : v17 + 86400000,
            betting_close_time_ms : v17 + 43200000,
            betting_price         : arg2,
            high_pool_balance     : 0x2::balance::zero<0x2::sui::SUI>(),
            low_pool_balance      : 0x2::balance::zero<0x2::sui::SUI>(),
            total_high_tickets    : 0,
        ...
        0x2::table::add<u64, Epoch>(&mut arg0.epochs, v16, v18);
        arg0.current_epoch_id = v16;
    }
