module 0x80ddcea9b12fabcd11f99b7752b508fc86617198dbf31d498633cf8a40a92147::cnsnft5456 {
    struct CNSNFT5456 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5456, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8315"));
        let v4 = 0x2::package::claim<CNSNFT5456>(arg0, arg1);
