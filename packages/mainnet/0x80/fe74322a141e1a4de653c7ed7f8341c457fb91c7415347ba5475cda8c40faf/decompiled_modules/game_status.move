module 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::game_status {
    ...
    public fun add_version(arg0: &0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::listing::ListingCap, arg1: &mut GameStatus, arg2: u8) {
    ...
    public fun cliff_time(arg0: &GameStatus) : u64 {
        let v0 = arg0.start_time;
        let v1 = 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::config::initial_countdown();
        if (v0 <= 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::math::max_u64() - v1) {
            v0 + v1
        } else {
            v0
        }
    ...
    public(friend) fun increase_end_time(arg0: &mut GameStatus, arg1: &0x2::clock::Clock) {
        ...
        let v1 = arg0.end_time + 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::config::time_increment();
        let v2 = v1;
        let v3 = 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::config::end_time_hard_cap();
        if (v1 > v0 + v3) {
            v2 = v0 + v3;
        };
        if (arg0.end_time < v2) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GameStatus{
            ...
            start_time  : 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::math::max_u64(),
            end_time    : 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::math::max_u64(),
        };
    ...
    public fun raffle_epoch(arg0: &GameStatus, arg1: &0x2::clock::Clock) : u64 {
        ...
        if (v1 >= v0) {
            (v1 - v0) / 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::config::raffle_period()
        } else {
            0
        }
    }

    public fun remove_version(arg0: &0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::listing::ListingCap, arg1: &mut GameStatus, arg2: u8) {
        assert_valid_package_version(arg1);
    ...
    public fun start(arg0: &mut GameStatus, arg1: Starter, arg2: u64) {
        ...
        arg0.end_time = arg2 + 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::config::initial_countdown();
    }
