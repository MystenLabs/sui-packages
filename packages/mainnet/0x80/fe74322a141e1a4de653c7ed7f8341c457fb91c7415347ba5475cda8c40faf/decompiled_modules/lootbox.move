module 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::lootbox {
    ...
    public(friend) fun add_buyer(arg0: &mut LootboxPool, arg1: &0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::game_status::GameStatus, arg2: &0x2::clock::Clock, arg3: address, arg4: u64) {
        let v0 = 0x2::object_table::borrow_mut<u64, RafflePeriod>(&mut arg0.periods, 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::game_status::raffle_epoch(arg1, arg2));
        let v1 = 0;
        while (v1 < arg4) {
    ...
    public fun deposit<T0>(arg0: &0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::listing::CoinTypeWhitelist, arg1: &mut LootboxPool, arg2: &0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::game_status::GameStatus, arg3: &0x2::clock::Clock, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::game_status::raffle_epoch(arg2, arg3);
    ...
    public fun raffle(arg0: &mut LootboxPool, arg1: &0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::game_status::GameStatus, arg2: &0x2::clock::Clock, arg3: u64, arg4: vector<u8>) {
        ...
        if (arg3 >= 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::game_status::raffle_epoch(arg1, arg2)) {
            err_epoch_not_ended();
        };
        ...
        let v3 = 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::math::verify_bls_sig_and_give_results(&mut arg4, &v0, &v2, 0xad70e60e8631f45b6c528bdf054a733c57d6e979bc601b2b8d1c10ce12d39866::big_vector::length<address>(&v1.buyers), 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::config::raffle_winner_count());
        let v4 = vector[];
    ...
    public fun settle<T0>(arg0: &mut LootboxPool, arg1: &mut 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::trove_manager::TroveManager, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v4 > 0) {
            while (v5 < v4) {
                0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::trove_manager::put_coin_into_user_trove<T0>(arg1, *0x1::vector::borrow<address>(&v0.winners, v5), 0x2::coin::take<T0>(&mut v2, v3 / v4, arg3), b"raffle", 0x1::option::none<address>(), arg3);
                v5 = v5 + 1;
            };
        };
        0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::trove_manager::put_coin_into_user_trove<T0>(arg1, arg0.dev, 0x2::coin::from_balance<T0>(v2, arg3), b"raffle", 0x1::option::none<address>(), arg3);
        let v6 = RafflePrize{
