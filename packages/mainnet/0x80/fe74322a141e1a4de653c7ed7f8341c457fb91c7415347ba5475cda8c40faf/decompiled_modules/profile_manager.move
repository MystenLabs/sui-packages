module 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::profile_manager {
    ...
    public(friend) fun create_profile<T0>(arg0: &mut ProfileManager, arg1: address, arg2: 0x1::option::Option<address>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (0x1::option::is_some<address>(&arg2)) {
            ...
            add_score_recursively(v0, arg2, 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::config::max_referral_depth());
            v4 + 1
        } else {
            let v6 = Profile{
                senior    : arg2,
    ...
    public(friend) fun extend_team_size(arg0: &mut ProfileManager, arg1: address, arg2: u64) {
        if (0x2::table::contains<address, Profile>(&arg0.map, arg1)) {
            ...
            if (v0.team_size == 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::math::max_u64()) {
                return
            };
            v0.team_size = v0.team_size + 3 * arg2;
            if (v0.team_size >= 30) {
                v0.team_size = 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::math::max_u64();
            };
        };
    }
    ...
    public fun get_seniors(arg0: &ProfileManager, arg1: address) : (0x1::option::Option<address>, vector<address>) {
        ...
        while (0x1::option::is_some<address>(&v4) && v3 < 0x80fe74322a141e1a4de653c7ed7f8341c457fb91c7415347ba5475cda8c40faf::config::max_referral_depth()) {
