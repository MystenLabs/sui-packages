module 0x80bfd5e912aba6053218945529cecb38836427c010bdd4ba4eaf64aa969fdddb::cnsnft9771 {
    struct CNSNFT9771 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9771, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9771>(arg0, arg1);
