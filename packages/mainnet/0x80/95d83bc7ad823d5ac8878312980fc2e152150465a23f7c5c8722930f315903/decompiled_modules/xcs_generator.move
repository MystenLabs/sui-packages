module 0x948b0ee11f52e78b42a08380bed1162e9185095e147d0f93ab7e0ffe9666a408::xcs_generator {
    ...
    entry fun draw(arg0: &XcsRaffle, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) : 0x1::string::String {
        ...
        if (0x1::vector::length<0x1::string::String>(&v0) == 1) {
            return 0x1::vector::remove<0x1::string::String>(&mut v0, 0)
        };
        let v5 = ((100 / 0x1::vector::length<0x1::string::String>(&v0)) as u8);
        ...
        while (v1 < 0x1::vector::length<0x1::string::String>(&v0)) {
            let v8 = v7 + v5;
            v7 = v8;
            if (v5 == 33 && 0x2::random::generate_u8_in_range(&mut v6, 0, 2) == (v1 as u8)) {
                v7 = v8 + 1;
            };
            if (arithmetic_is_less_than(0x2::random::generate_u8_in_range(&mut v6, 0, 99), v7, 100) == 1) {
                v4 = 0x1::vector::remove<0x1::string::String>(&mut v0, v1);
                break
            };
            v1 = v1 + 1;
        };
