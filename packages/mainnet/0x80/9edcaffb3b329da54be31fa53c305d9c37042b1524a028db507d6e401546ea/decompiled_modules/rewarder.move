module 0x809edcaffb3b329da54be31fa53c305d9c37042b1524a028db507d6e401546ea::rewarder {
    ...
    public(friend) fun calculate_reward_amount(arg0: u128, arg1: u128) : u64 {
        ...
        0x809edcaffb3b329da54be31fa53c305d9c37042b1524a028db507d6e401546ea::safe_math::u128_to_u64(0x809edcaffb3b329da54be31fa53c305d9c37042b1524a028db507d6e401546ea::safe_math::mul_div_u128(arg0, arg1, (10000 as u128)))
    }

    public fun deposit_reward<T0>(arg0: &0x809edcaffb3b329da54be31fa53c305d9c37042b1524a028db507d6e401546ea::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) {
    ...
    public fun emergent_withdraw<T0>(arg0: &0x809edcaffb3b329da54be31fa53c305d9c37042b1524a028db507d6e401546ea::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x809edcaffb3b329da54be31fa53c305d9c37042b1524a028db507d6e401546ea::config::checked_package_version(arg0);
        0x809edcaffb3b329da54be31fa53c305d9c37042b1524a028db507d6e401546ea::config::check_reward_role(arg0, 0x2::tx_context::sender(arg3));
        let v0 = withdraw_reward<T0>(arg1, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg3), 0x809edcaffb3b329da54be31fa53c305d9c37042b1524a028db507d6e401546ea::config::get_reward_receiver(arg0));
