module 0x80cf6e11b49a7667dd929609bcc76e4a79273bfc91257328dd0320d2e3bd1a2e::navi {
    struct NaviAccountCapKey has copy, drop, store {
        dummy_field: bool,
    }

    public(friend) fun balance(arg0: &0x80cf6e11b49a7667dd929609bcc76e4a79273bfc91257328dd0320d2e3bd1a2e::vault::Vault, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: u8) : (u256, u256) {
    ...
    fun get_account_cap(arg0: &0x80cf6e11b49a7667dd929609bcc76e4a79273bfc91257328dd0320d2e3bd1a2e::vault::Vault) : &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap {
        let v0 = NaviAccountCapKey{dummy_field: false};
        0x80cf6e11b49a7667dd929609bcc76e4a79273bfc91257328dd0320d2e3bd1a2e::vault::borrow_object<NaviAccountCapKey, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap>(arg0, v0)
    }

    public(friend) fun setup(arg0: &mut 0x80cf6e11b49a7667dd929609bcc76e4a79273bfc91257328dd0320d2e3bd1a2e::vault::Vault, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = NaviAccountCapKey{dummy_field: false};
        0x80cf6e11b49a7667dd929609bcc76e4a79273bfc91257328dd0320d2e3bd1a2e::vault::put_object<NaviAccountCapKey, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap>(arg0, v0, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::create_account(arg1));
    }

    public(friend) fun withdraw<T0>(arg0: &0x80cf6e11b49a7667dd929609bcc76e4a79273bfc91257328dd0320d2e3bd1a2e::vault::Vault, arg1: &0x2::clock::Clock, arg2: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: u8, arg6: u64, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive::Incentive, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive) : 0x2::balance::Balance<T0> {
