module 0x80a710472adc37cc6deced075780f2ac44a0e8cad534f4edc1c1e2f994878c7b::suilens_community {
    ...
    public fun approve_join_request(arg0: &mut CommunityRegistry, arg1: &mut 0x80a710472adc37cc6deced075780f2ac44a0e8cad534f4edc1c1e2f994878c7b::suilens_core::GlobalRegistry, arg2: 0x2::object::ID, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x80a710472adc37cc6deced075780f2ac44a0e8cad534f4edc1c1e2f994878c7b::suilens_core::add_user_community(arg1, arg3, arg2);
        let v2 = MemberJoined{
            community_id : arg2,
            member       : arg3,
    ...
    public fun create_community(arg0: &mut CommunityRegistry, arg1: &0x80a710472adc37cc6deced075780f2ac44a0e8cad534f4edc1c1e2f994878c7b::suilens_core::GlobalRegistry, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: bool, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg9);
        assert!(0x80a710472adc37cc6deced075780f2ac44a0e8cad534f4edc1c1e2f994878c7b::suilens_core::has_user_profile(arg1, v0), 6);
    ...
    public fun join_community(arg0: &mut CommunityRegistry, arg1: &mut 0x80a710472adc37cc6deced075780f2ac44a0e8cad534f4edc1c1e2f994878c7b::suilens_core::GlobalRegistry, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x80a710472adc37cc6deced075780f2ac44a0e8cad534f4edc1c1e2f994878c7b::suilens_core::has_user_profile(arg1, v0), 6);
        assert!(0x2::table::contains<0x2::object::ID, Community>(&arg0.communities, arg2), 1);
        let v1 = 0x2::table::borrow_mut<0x2::object::ID, Community>(&mut arg0.communities, arg2);
        ...
        if (v1.is_private) {
            ...
            0x80a710472adc37cc6deced075780f2ac44a0e8cad534f4edc1c1e2f994878c7b::suilens_core::add_user_community(arg1, v0, arg2);
            let v2 = MemberJoined{
                community_id : arg2,
                member       : v0,
                member_count : 0x2::vec_set::size<address>(&v1.members),
    ...
    public fun leave_community(arg0: &mut CommunityRegistry, arg1: &mut 0x80a710472adc37cc6deced075780f2ac44a0e8cad534f4edc1c1e2f994878c7b::suilens_core::GlobalRegistry, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::table::contains<0x2::object::ID, Community>(&arg0.communities, arg2), 1);
        let v1 = 0x2::table::borrow_mut<0x2::object::ID, Community>(&mut arg0.communities, arg2);
        ...
        0x80a710472adc37cc6deced075780f2ac44a0e8cad534f4edc1c1e2f994878c7b::suilens_core::remove_user_community(arg1, v0, arg2);
        let v2 = MemberLeft{
            community_id : arg2,
            member       : v0,
            member_count : 0x2::vec_set::size<address>(&v1.members),
