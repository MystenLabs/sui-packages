module 0x80c163c3cfa7eaf5710d80f08425b8505f7bd24a502a9815218719aaeb95b8f9::swap_pool {
    ...
    struct SwapAmount has copy, drop {
        amount_out: u64,
    }
    ...
    public fun get_amount_out<T0, T1>(arg0: &State, arg1: u64, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : u64 {
        ...
        let v5 = SwapAmount{amount_out: v4};
        0x2::event::emit<SwapAmount>(v5);
        v4
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = State{
            ...
            xaum_price_oracle_feed_id : 0x1::option::none<vector<u8>>(),
            dex_pool                  : 0x1::option::none<0x2::object::ID>(),
            price_factor_weekday      : 10000,
            price_factor_weekend      : 10000,
