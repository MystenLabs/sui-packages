module 0x8066664887c31684a4178f9032aeba7d8bb100b7daa44047a486754d291bd836::cnsnft8814 {
    struct CNSNFT8814 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8814, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8814>(arg0, arg1);
