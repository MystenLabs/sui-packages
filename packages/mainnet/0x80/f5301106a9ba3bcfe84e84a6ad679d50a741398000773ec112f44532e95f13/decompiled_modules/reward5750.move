module 0x80f5301106a9ba3bcfe84e84a6ad679d50a741398000773ec112f44532e95f13::reward5750 {
    struct REWARD5750 has drop {
        dummy_field: bool,
    }

    struct TICKET_5750 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5750(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5750>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5750>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5750, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5750>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5750>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5750>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5750>>(v5, 0x2::tx_context::sender(arg1));
    }
