module 0x80eeba0023bf4cc382a8fb1ae0e365fca4e53a098cbf7dabcb1691a086bddbf0::cnsnft6016 {
    struct CNSNFT6016 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6016, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6016>(arg0, arg1);
