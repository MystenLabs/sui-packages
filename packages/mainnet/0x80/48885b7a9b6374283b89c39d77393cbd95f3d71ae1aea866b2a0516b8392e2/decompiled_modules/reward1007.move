module 0x8048885b7a9b6374283b89c39d77393cbd95f3d71ae1aea866b2a0516b8392e2::reward1007 {
    struct REWARD1007 has drop {
        dummy_field: bool,
    }

    struct TICKET_1007 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1007(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1007>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1007>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1007, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1007>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1007>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1007>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1007>>(v5, 0x2::tx_context::sender(arg1));
    }
