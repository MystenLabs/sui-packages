module 0x80ade4d17a845245cc9640b751b3d196ad7316e36308345bb669a0080f54337d::cnsnft3897 {
    struct CNSNFT3897 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3897, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3897>(arg0, arg1);
