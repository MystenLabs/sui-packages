module 0x80ec667230e7bd997a8fde180dc73a49d7c389333dfe290ee18ed8c74383a760::reward7489 {
    struct REWARD7489 has drop {
        dummy_field: bool,
    }

    struct TICKET_7489 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7489(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7489>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7489>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7489, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7489>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7489>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7489>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7489>>(v5, 0x2::tx_context::sender(arg1));
    }
