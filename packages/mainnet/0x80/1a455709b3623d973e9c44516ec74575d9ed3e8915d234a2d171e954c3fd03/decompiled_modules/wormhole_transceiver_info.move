module 0x801a455709b3623d973e9c44516ec74575d9ed3e8915d234a2d171e954c3fd03::wormhole_transceiver_info {
    struct WormholeTransceiverInfo has drop {
        ...
        manager_mode: 0xd83022d8936137fbf741cdceefecf1668b3080afc4cc4a36c970666475184343::mode::Mode,
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : WormholeTransceiverInfo {
        assert!(0xb8e871ad35f140ef6943def7ed89eb6b1b66095e39f7a748f35779e6f8ce3118::bytes4::to_bytes(0xb8e871ad35f140ef6943def7ed89eb6b1b66095e39f7a748f35779e6f8ce3118::bytes4::take(arg0)) == x"9c23bd3b", 13906834367616974850);
        WormholeTransceiverInfo{
            ...
            manager_mode    : 0xd83022d8936137fbf741cdceefecf1668b3080afc4cc4a36c970666475184343::mode::parse(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_bytes(arg0, 1)),
    ...
    public(friend) fun new(arg0: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg1: 0xd83022d8936137fbf741cdceefecf1668b3080afc4cc4a36c970666475184343::mode::Mode, arg2: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg3: u8) : WormholeTransceiverInfo {
        WormholeTransceiverInfo{
    ...
    public fun to_bytes(arg0: &WormholeTransceiverInfo) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0xd83022d8936137fbf741cdceefecf1668b3080afc4cc4a36c970666475184343::mode::serialize(arg0.manager_mode));
