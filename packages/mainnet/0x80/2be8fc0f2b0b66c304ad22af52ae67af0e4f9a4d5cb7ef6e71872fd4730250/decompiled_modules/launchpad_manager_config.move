module 0x802be8fc0f2b0b66c304ad22af52ae67af0e4f9a4d5cb7ef6e71872fd4730250::launchpad_manager_config {
    ...
    struct LaunchAdminUpdatedEvent has copy, drop {
        new_admin: address,
    }
    ...
    public fun set_launch_admin(arg0: &LaunchManagerAdmin, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LaunchAdminUpdatedEvent{new_admin: arg1};
        0x2::event::emit<LaunchAdminUpdatedEvent>(v1);
    }
