module 0x13aee5d4290df4e9d532191952269617e96be75f6c709f2551d9773943a1e319::reward6342 {
    struct REWARD6342 has drop {
        dummy_field: bool,
    }

    struct TICKET_6342 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6342(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6342>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6342>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6342, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6342>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6342>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6342>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6342>>(v5, 0x2::tx_context::sender(arg1));
    }
