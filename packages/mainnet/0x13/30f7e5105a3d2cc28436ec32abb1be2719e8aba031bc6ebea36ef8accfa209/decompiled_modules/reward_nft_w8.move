module 0x1330f7e5105a3d2cc28436ec32abb1be2719e8aba031bc6ebea36ef8accfa209::reward_nft_w8 {
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = REWARD_NFT{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmQkptZsLMMLCYaCwLMonpzuKtgL41dWyPnDnw8USD2yC3"),
            };
            let v1 = MintEvent{
    ...
    fun init(arg0: REWARD_NFT_W8, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmQkptZsLMMLCYaCwLMonpzuKtgL41dWyPnDnw8USD2yC3"));
