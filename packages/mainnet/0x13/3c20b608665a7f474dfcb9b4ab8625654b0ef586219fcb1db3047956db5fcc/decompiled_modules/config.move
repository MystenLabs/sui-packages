module 0x133c20b608665a7f474dfcb9b4ab8625654b0ef586219fcb1db3047956db5fcc::config {
    ...
    public(friend) fun assert_allow_staking(arg0: &ProtocolConfig) {
        assert!(arg0.open_staking, 0x133c20b608665a7f474dfcb9b4ab8625654b0ef586219fcb1db3047956db5fcc::errors::error_not_allow_stake());
    }

    public(friend) fun assert_current_version_invalid(arg0: &ProtocolConfig) {
        assert!(arg0.version >= 1, 0x133c20b608665a7f474dfcb9b4ab8625654b0ef586219fcb1db3047956db5fcc::errors::error_invalid_protocol_version());
    }

    public(friend) fun assert_max_staked_amount(arg0: &ProtocolConfig, arg1: u64) {
        assert!(arg0.max_staking_amount >= arg1, 0x133c20b608665a7f474dfcb9b4ab8625654b0ef586219fcb1db3047956db5fcc::errors::error_max_staked_amount());
    }

    public(friend) fun assert_reward_info_registered(arg0: &ProtocolConfig, arg1: &0x1::type_name::TypeName) {
        assert!(0x2::vec_map::contains<0x1::type_name::TypeName, RewardConfig>(&arg0.reward_configs, arg1), 0x133c20b608665a7f474dfcb9b4ab8625654b0ef586219fcb1db3047956db5fcc::errors::error_not_exist_reward_config());
    }

    public(friend) fun assert_suspicious_position(arg0: &ProtocolConfig, arg1: address) {
        assert!(!0x2::table::contains<address, bool>(&arg0.suspicious_position_table, arg1), 0x133c20b608665a7f474dfcb9b4ab8625654b0ef586219fcb1db3047956db5fcc::errors::error_suspicious_position());
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x133c20b608665a7f474dfcb9b4ab8625654b0ef586219fcb1db3047956db5fcc::events::emit_init_config(0x2::object::id<AdminCap>(&v1), 0x2::object::id<ProtocolConfig>(&v0));
    ...
    public(friend) fun set_reward_config<T0>(arg0: &AdminCap, arg1: &mut ProtocolConfig, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x133c20b608665a7f474dfcb9b4ab8625654b0ef586219fcb1db3047956db5fcc::events::emit_update_reward_config(arg2, arg3, arg4);
    }
    ...
    public fun start_staking(arg0: &AdminCap, arg1: &mut ProtocolConfig) {
        ...
        0x133c20b608665a7f474dfcb9b4ab8625654b0ef586219fcb1db3047956db5fcc::events::emit_update_staking_status(arg1.open_staking);
    }
    ...
    public fun update_package_version(arg0: &AdminCap, arg1: &mut ProtocolConfig, arg2: u64) {
        ...
        0x133c20b608665a7f474dfcb9b4ab8625654b0ef586219fcb1db3047956db5fcc::events::emit_update_package_version(arg2);
    }
