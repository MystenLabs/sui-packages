module 0x1311ac89d04d7fa2ab3d1b00a2b16bab09896efd05365646ac8d33345b6c7bf5::cnsnft5239 {
    struct CNSNFT5239 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5239, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5239>(arg0, arg1);
