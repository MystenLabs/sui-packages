module 0x13ad0c5ebab6a63b0494457010eac78637edb2d8b93156eea61e1e0eef1da14f::dex_deepbook {
    ...
    public fun get_deepbook_deep_usdc_pool() : address {
        0x13ad0c5ebab6a63b0494457010eac78637edb2d8b93156eea61e1e0eef1da14f::constants::deepbook_deep_usdc_pool()
    }

    public fun get_deepbook_package() : address {
        0x13ad0c5ebab6a63b0494457010eac78637edb2d8b93156eea61e1e0eef1da14f::constants::deepbook_package()
    }

    public fun get_deepbook_registry() : address {
        0x13ad0c5ebab6a63b0494457010eac78637edb2d8b93156eea61e1e0eef1da14f::constants::deepbook_registry()
    }
    ...
    public entry fun swap_sui_to_usdc(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = DeepBookSwapExecuted{
            ...
            package        : 0x13ad0c5ebab6a63b0494457010eac78637edb2d8b93156eea61e1e0eef1da14f::constants::deepbook_package(),
