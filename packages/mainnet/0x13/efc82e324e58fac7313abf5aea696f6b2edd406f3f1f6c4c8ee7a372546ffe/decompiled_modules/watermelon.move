module 0x13efc82e324e58fac7313abf5aea696f6b2edd406f3f1f6c4c8ee7a372546ffe::watermelon {
    ...
    fun init(arg0: WATERMELON, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WATERMELON>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"WaterMelon"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"WaterMelon "));
