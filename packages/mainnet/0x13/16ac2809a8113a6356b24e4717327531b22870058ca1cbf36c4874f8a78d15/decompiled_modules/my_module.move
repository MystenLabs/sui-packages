module 0x1316ac2809a8113a6356b24e4717327531b22870058ca1cbf36c4874f8a78d15::my_module {
    ...
    public entry fun swap_3_2<T0, T1, T2, T3>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x88d362329ede856f5f67867929ed570bba06c975abec2fab7f0601c56f6a8cb1::animeswap::LiquidityPools, arg5: u64, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T1>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T3>, arg8: u8, arg9: u8, arg10: u8, arg11: 0x2::coin::Coin<T0>, arg12: &mut 0x2::tx_context::TxContext) {
        let v0 = false;
        let v1 = false;
        let v2 = get_amount_out_<T1, T0>(arg2, arg8, v0, arg1, arg4);
        let v3 = get_amount_out_<T2, T1>(v2, arg9, v1, arg6, arg4);
        let v4 = get_amount_out_<T2, T3>(v3, arg10, true, arg7, arg4);
        let v5 = SwapEvent3{
            amount_y_out1 : v2,
            amount_y_out2 : v3,
            amount_y_out3 : v4,
        };
        0x2::event::emit<SwapEvent3>(v5);
        assert!(v4 >= arg5, 111);
        let v6 = 0x2::coin::zero<T1>(arg12);
        let (v7, v8) = swap_return_coin<T1, T0>(v6, arg11, arg0, arg2, arg8, v0, arg1, arg4, arg3, arg12);
        let v9 = 0x2::coin::zero<T2>(arg12);
        let (v10, v11) = swap_return_coin<T2, T1>(v9, v7, arg0, arg2, arg9, v1, arg6, arg4, arg3, arg12);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v8, 0x2::tx_context::sender(arg12));
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(v10, 0x2::tx_context::sender(arg12));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v11, 0x2::tx_context::sender(arg12));
    }
