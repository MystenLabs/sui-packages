module 0x1375a75253aee383780eec93a313f653e7884dead74151a4c04bbea73dbfc7b0::navi_adapter {
    ...
    public fun new<T0, T1>(arg0: u8, arg1: 0x2::object::ID, arg2: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::acl::AdminWitness<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam::SAM>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun drop_reward_config<T0, T1, T2>(arg0: &mut NaviAdapter<T0, T1>, arg1: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::acl::AdminWitness<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam::SAM>) {
        let v0 = 0x1::type_name::with_defining_ids<T2>();
    ...
    public fun end_approve<T0, T1>(arg0: &mut 0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::state::SAMState<T0, T1>, arg1: &mut 0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::ptr::ProtocolRequest<T0>, arg2: RewardHarvest<T0>, arg3: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam_allowed_versions::AllowedVersions, arg4: &mut 0x2::tx_context::TxContext) {
        let RewardHarvest {
            earnings  : v0,
            available : v1,
            apr       : v2,
        ...
        0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::state::approve_protocol_request<T0, T1, NaviWitness<T1>>(arg0, arg1, v1, v2, v0, v4, arg3, arg4);
        let v5 = NaviWitness<T1>{dummy_field: false};
        0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::state::record_point<T0, T1, NaviWitness<T1>>(arg0, v2, v3, v5, arg3);
    }
    ...
    public fun inject_reward<T0, T1, T2>(arg0: &mut NaviAdapter<T0, T1>, arg1: 0x2::coin::Coin<T2>, arg2: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::acl::AdminWitness<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam::SAM>) {
        let v0 = &mut arg0.id;
    ...
    public fun set_mid_pool<T0, T1>(arg0: &mut NaviAdapter<T0, T1>, arg1: 0x2::object::ID, arg2: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::acl::AdminWitness<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam::SAM>) {
        arg0.mid_pool = arg1;
    }

    public fun set_min_reward_redeem<T0, T1>(arg0: &mut NaviAdapter<T0, T1>, arg1: u64, arg2: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::acl::AdminWitness<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam::SAM>) {
        arg0.min_reward_redeem = arg1;
    }

    public fun set_reward_config<T0, T1, T2>(arg0: &mut NaviAdapter<T0, T1>, arg1: 0x2::object::ID, arg2: vector<0x1::ascii::String>, arg3: vector<address>, arg4: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::acl::AdminWitness<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam::SAM>) {
        let v0 = 0x1::type_name::with_defining_ids<T2>();
    ...
    fun snapshot<T0, T1>(arg0: &NaviAdapter<T0, T1>, arg1: &0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::state::SAMState<T0, T1>, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: 0x2::balance::Balance<T0>) : RewardHarvest<T0> {
