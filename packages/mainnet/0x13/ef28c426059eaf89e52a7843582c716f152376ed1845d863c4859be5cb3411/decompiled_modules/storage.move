module 0x13ef28c426059eaf89e52a7843582c716f152376ed1845d863c4859be5cb3411::storage {
    ...
    public fun decrease_borrow_balance(arg0: &mut Storage, arg1: u8, arg2: address, arg3: u256) {
    ...
    public entry fun init_reserve<T0>(arg0: &0x2::clock::Clock, arg1: &mut Storage, arg2: bool, arg3: u256, arg4: u256, arg5: u256, arg6: u256, arg7: u256, arg8: u256, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: u256, arg14: u256, arg15: &mut 0x2::tx_context::TxContext) {
        only_configurator(arg1, arg15);
        let v0 = arg1.reserves_count;
        assert!(v0 < 255, 43003);
        reserve_validation<T0>(arg1);
        let v1 = TokenBalance{
            user_state   : 0x2::table::new<address, u256>(arg15),
            total_supply : 0,
        };
        let v2 = TokenBalance{
            user_state   : 0x2::table::new<address, u256>(arg15),
        ...
        let v5 = ReserveData{
            ...
            current_supply_index  : 0xb15405910efec3c68adc7ddf708a021960467dd1974449fcd4b568a121ad053b::ray_math::ray(),
            current_borrow_index  : 0xb15405910efec3c68adc7ddf708a021960467dd1974449fcd4b568a121ad053b::ray_math::ray(),
            supply_balance        : v1,
            borrow_balance        : v2,
