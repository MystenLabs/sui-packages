module 0x1310edb4db3ed14e0fa86eb5a8469295f58cdaa347649c5275620f9118313b4f::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"VT791840", b"ValidToken 791840", b"This should succeed", 0x1::option::none<0x2::url::Url>(), arg1);
