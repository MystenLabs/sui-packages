module 0x136c3cf0b8c359ba714d6f26588672b98bdd8b14f9262b0c7b01cf8d971d4813::encrypted_nfts {
    ...
    public fun decrypt(arg0: TimeCapsule, arg1: &0x2::clock::Clock, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : LuckyCard {
        ...
        0x136c3cf0b8c359ba714d6f26588672b98bdd8b14f9262b0c7b01cf8d971d4813::drand_lib::verify_drand_signature(arg2, v2);
        let v4 = 0x2::bls12381::g1_from_bytes(&arg2);
        let v5 = 0x136c3cf0b8c359ba714d6f26588672b98bdd8b14f9262b0c7b01cf8d971d4813::ec_ops::ibe_decrypt(0x136c3cf0b8c359ba714d6f26588672b98bdd8b14f9262b0c7b01cf8d971d4813::ec_ops::ibe_encryption_from_bytes(&v3), &v4);
    ...
    public fun mint_encrypted(arg0: &0x136c3cf0b8c359ba714d6f26588672b98bdd8b14f9262b0c7b01cf8d971d4813::access::AdminCap, arg1: vector<u8>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : TimeCapsule {
        TimeCapsule{
            id             : 0x2::object::new(arg3),
            encrypted_data : arg1,
            round          : arg2,
