module 0x13d249e4640e695f0b1fc7a214c265df65d3e581de6a6b4b5053d8da9666b4ec::tide_amm {
    ...
    public fun new<T0, T1>(arg0: &mut Registry, arg1: &0x2::coin::CoinMetadata<T0>, arg2: &0x2::coin::CoinMetadata<T1>, arg3: u256, arg4: &0xb877fe150db8e9af55c399b4e49ba8afe658bd05317cb378c940344851125e9a::access_control::AdminWitness<TIDE_AMM>, arg5: &mut 0x2::tx_context::TxContext) : TidePool {
        ...
        let v1 = &mut v0;
        add_balances<T0, T1>(v1);
        0x1::vector::push_back<address>(&mut arg0.pools, 0x2::object::uid_to_address(&v0.id));
        0x13d249e4640e695f0b1fc7a214c265df65d3e581de6a6b4b5053d8da9666b4ec::tide_events::emit_new_pool(0x2::object::uid_to_address(&v0.id), v0.x, v0.y);
        v0
    }

    fun add_balances<T0, T1>(arg0: &mut TidePool) {
        let v0 = BalanceKey<T0>{dummy_field: false};
    ...
    fun assert_types<T0, T1>(arg0: &TidePool) {
        assert!(0x1::type_name::get<T0>() == arg0.x && 0x1::type_name::get<T1>() == arg0.y, 13906835441358733311);
    }
    ...
    public fun pause(arg0: &mut TidePool, arg1: &0xb877fe150db8e9af55c399b4e49ba8afe658bd05317cb378c940344851125e9a::access_control::AdminWitness<TIDE_AMM>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    fun quote_x_to_y<T0, T1>(arg0: &TidePool, arg1: u64) : (u64, u64, u64) {
        ...
        let v3 = v2 * arg0.price_x.value / 1000000000000000000;
    ...
    fun swap_x_to_y<T0, T1>(arg0: &mut TidePool, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        0x13d249e4640e695f0b1fc7a214c265df65d3e581de6a6b4b5053d8da9666b4ec::tide_events::emit_swap(0x2::object::uid_to_address(&arg0.id), 0x1::type_name::get<T0>(), 0x1::type_name::get<T1>(), v3, v4, v5, 0x2::balance::value<T0>(balance<T0>(arg0)), 0x2::balance::value<T1>(balance<T1>(arg0)));
    ...
    fun swap_y_to_x<T0, T1>(arg0: &mut TidePool, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::coin::Coin<T0>) {
        ...
        assert!(invariant<T0, T1>(arg0) >= v0, 5);
        0x13d249e4640e695f0b1fc7a214c265df65d3e581de6a6b4b5053d8da9666b4ec::tide_events::emit_swap(0x2::object::uid_to_address(&arg0.id), 0x1::type_name::get<T1>(), 0x1::type_name::get<T0>(), v3, v4, v5, 0x2::balance::value<T0>(balance<T0>(arg0)), 0x2::balance::value<T1>(balance<T1>(arg0)));
        (arg2, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v7, v4), arg3))
    }

    public fun unpause(arg0: &mut TidePool, arg1: &0xb877fe150db8e9af55c399b4e49ba8afe658bd05317cb378c940344851125e9a::access_control::AdminWitness<TIDE_AMM>, arg2: &mut 0x2::tx_context::TxContext) {
        0xb877fe150db8e9af55c399b4e49ba8afe658bd05317cb378c940344851125e9a::access_control::assert_has_role<TIDE_AMM>(arg1, 1);
        arg0.paused = false;
    }
