module 0x1389f80d4bbe4d32670bc29ca19e842e75a664ac41f030d052ca93b635156c47::pnut {
    ...
    fun init(arg0: PNUT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<PNUT>(&mut v3, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
