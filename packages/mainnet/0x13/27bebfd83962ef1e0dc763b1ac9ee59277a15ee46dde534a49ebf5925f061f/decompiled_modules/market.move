module 0x2b03e989f9080ba7cd179fbf576371bf9f3c811ca75d679cdc6d6dd478519ab::market {
    ...
    public fun bailout_market<T0>(arg0: &mut Market<T0>, arg1: &0x2b03e989f9080ba7cd179fbf576371bf9f3c811ca75d679cdc6d6dd478519ab::config::ProtocolCap, arg2: 0x2::coin::Coin<T0>) {
        let v0 = load_data_mut<T0>(arg0);
        assert!(0x2b03e989f9080ba7cd179fbf576371bf9f3c811ca75d679cdc6d6dd478519ab::market_data::is_paused<T0>(v0), 16);
        0x2::balance::join<T0>(0x2b03e989f9080ba7cd179fbf576371bf9f3c811ca75d679cdc6d6dd478519ab::market_data::pool_balance_mut<T0>(v0), 0x2::coin::into_balance<T0>(arg2));
    }
    ...
    public fun set_trading_fee_bps<T0>(arg0: &mut Market<T0>, arg1: &0x2b03e989f9080ba7cd179fbf576371bf9f3c811ca75d679cdc6d6dd478519ab::config::ProtocolCap, arg2: u64) {
        let v0 = load_data_mut<T0>(arg0);
        assert!(!0x2b03e989f9080ba7cd179fbf576371bf9f3c811ca75d679cdc6d6dd478519ab::market_data::is_paused<T0>(v0), 15);
        0x2b03e989f9080ba7cd179fbf576371bf9f3c811ca75d679cdc6d6dd478519ab::market_data::set_trading_fee_bps<T0>(v0, arg2);
    }
