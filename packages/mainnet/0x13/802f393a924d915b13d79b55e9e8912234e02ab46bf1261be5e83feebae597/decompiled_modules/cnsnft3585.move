module 0x13802f393a924d915b13d79b55e9e8912234e02ab46bf1261be5e83feebae597::cnsnft3585 {
    struct CNSNFT3585 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3585, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3585>(arg0, arg1);
