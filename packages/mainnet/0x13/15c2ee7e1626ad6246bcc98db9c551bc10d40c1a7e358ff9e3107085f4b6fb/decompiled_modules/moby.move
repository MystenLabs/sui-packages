module 0x1315c2ee7e1626ad6246bcc98db9c551bc10d40c1a7e358ff9e3107085f4b6fb::moby {
    struct MOBY has drop {
        dummy_field: bool,
    }

    fun init(arg0: MOBY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MOBY>(arg0, 6, b"MOBY", b"Sui Moby", b"Moby isnt just any character out of a book. Hes way more than that. He's the ultimate icon everyone dreams of becoming and the next mascot of SUI!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/Karya_Seni_Tanpa_Judul_41_e93632e043.png")), arg1);
