module 0x1362e9205332d5fd8132772683da18be735b456b97ac86a7115eacb3726c30ad::crank {
    ...
    public fun validate_heartbeat<T0>(arg0: &mut CrankConfig, arg1: &mut 0x75ecf86d06f900ceaa979339965b5f9fa4e8a43a60816e58cbbfa37762bba5b7::vault::Vault<T0>, arg2: &0x2::clock::Clock) {
        ...
        if (0x75ecf86d06f900ceaa979339965b5f9fa4e8a43a60816e58cbbfa37762bba5b7::vault::is_auto_paused<T0>(arg1)) {
            ...
            let v1 = AutoUnpauseEvent{timestamp_ms: v0};
            0x2::event::emit<AutoUnpauseEvent>(v1);
        };
        let v2 = HeartbeatEvent{timestamp_ms: v0};
        0x2::event::emit<HeartbeatEvent>(v2);
    }

    public fun validate_reroute(arg0: &mut CrankConfig, arg1: &0x1362e9205332d5fd8132772683da18be735b456b97ac86a7115eacb3726c30ad::apy::ApyRegistry, arg2: &0x1362e9205332d5fd8132772683da18be735b456b97ac86a7115eacb3726c30ad::strategy::StrategyRegistry, arg3: u8, arg4: u8, arg5: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg5);
        assert!(0x1362e9205332d5fd8132772683da18be735b456b97ac86a7115eacb3726c30ad::strategy::count_available(arg2) >= 2, 600);
        assert!(0x1362e9205332d5fd8132772683da18be735b456b97ac86a7115eacb3726c30ad::strategy::is_available(arg2, arg4), 601);
        assert!(arg3 != arg4, 602);
        let v1 = 0x1362e9205332d5fd8132772683da18be735b456b97ac86a7115eacb3726c30ad::apy::get_total_apy(arg1, arg3);
        let v2 = 0x1362e9205332d5fd8132772683da18be735b456b97ac86a7115eacb3726c30ad::apy::get_total_apy(arg1, arg4);
        assert!(v2 > v1, 607);
        let v3 = if (v1 == 0) {
            10000
        } else {
