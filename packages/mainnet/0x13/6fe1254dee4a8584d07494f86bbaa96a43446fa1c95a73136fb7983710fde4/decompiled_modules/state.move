module 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::state {
    struct State has store {
        accounts: 0x2::table::Table<0x2::object::ID, 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::account::Account>,
        epoch: u64,
        is_active: bool,
        inactive_stake: u64,
        active_stake: u64,
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : State {
        State{
            accounts            : 0x2::table::new<0x2::object::ID, 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::account::Account>(arg0),
    ...
    public(friend) fun process_end_of_day(arg0: &mut State, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        if (arg2 > 0) {
            ...
            if (v0 >= arg3) {
                ...
                assert!(arg3 - v0 <= 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::constants::precision_error_allowance(), 7);
                v1 = 0;
            };
        };
    ...
    fun calculate_fee(arg0: &vector<0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::Transaction>, arg1: 0x1::uq32_32::UQ32_32) : u64 {
        let v0 = 0;
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::Transaction>(arg0)) {
            let v2 = 0x1::vector::borrow<0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::Transaction>(arg0, v1);
            if (0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::is_debit(v2)) {
                v0 = v0 + 0x1::uq32_32::int_mul(0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::amount(v2), arg1);
            };
            v1 = v1 + 1;
        };
        v0
    ...
    public(friend) fun process_transactions(arg0: &mut State, arg1: &vector<0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::Transaction>, arg2: 0x2::object::ID, arg3: 0x1::uq32_32::UQ32_32, arg4: 0x1::uq32_32::UQ32_32, arg5: 0x1::option::Option<0x1::uq32_32::UQ32_32>, arg6: &0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        let (v1, v2) = 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::account::settle(0x2::table::borrow_mut<0x2::object::ID, 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::account::Account>(&mut arg0.accounts, arg2));
        (v1, v2, calculate_fee(arg1, arg3), calculate_fee(arg1, arg4), v0)
    }

    fun process_transactions_for_account(arg0: &mut State, arg1: 0x2::object::ID, arg2: &vector<0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::Transaction>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::Transaction>(arg2)) {
            let v1 = 0x1::vector::borrow<0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::Transaction>(arg2, v0);
            if (0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::is_credit(v1)) {
                0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::account::credit(0x2::table::borrow_mut<0x2::object::ID, 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::account::Account>(&mut arg0.accounts, arg1), 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::amount(v1));
            } else {
                assert!(0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::is_debit(v1), 1);
                0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::account::debit(0x2::table::borrow_mut<0x2::object::ID, 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::account::Account>(&mut arg0.accounts, arg1), 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::amount(v1));
            };
            v0 = v0 + 1;
        };
    }
    ...
    fun process_volumes(arg0: &mut State, arg1: &vector<0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::Transaction>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::Transaction>(arg1)) {
            let v1 = 0x1::vector::borrow<0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::Transaction>(arg1, v0);
            if (0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::is_credit(v1)) {
                process_win(arg0, 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::amount(v1));
            } else {
                assert!(0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::is_debit(v1), 1);
                process_bet(arg0, 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::transaction::amount(v1));
            };
            v0 = v0 + 1;
        };
    }
    ...
    public(friend) fun refresh(arg0: &State, arg1: &mut 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::participation::Participation, arg2: &0x2::tx_context::TxContext) {
    ...
    fun remove_inactive_stake(arg0: &mut State, arg1: u64) {
        if (arg0.inactive_stake >= arg1) {
            ...
            assert!(arg1 - arg0.inactive_stake <= 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::constants::precision_error_allowance(), 3);
            arg0.inactive_stake = 0;
        };
    }
    ...
    fun update_account(arg0: &mut State, arg1: 0x2::object::ID) {
        if (!0x2::table::contains<0x2::object::ID, 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::account::Account>(&arg0.accounts, arg1)) {
            0x2::table::add<0x2::object::ID, 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::account::Account>(&mut arg0.accounts, arg1, 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::account::empty());
        };
    }

    fun update_participation(arg0: &State, arg1: &mut 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::participation::Participation, arg2: &0x2::tx_context::TxContext) {
        let (v0, v1, _) = 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::participation::current_state(arg1);
        let v3 = v1;
        let v4 = v0;
        while (v4 < 0x2::tx_context::epoch(arg2)) {
            let (v5, v6) = calculate_ggr_share(arg0, v4, v3);
            0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::participation::process_end_of_day(arg1, v4, v5, v6, arg2);
            let (v7, v8, _) = 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::participation::current_state(arg1);
            v3 = v8;
            v4 = v7;
        };
    }
