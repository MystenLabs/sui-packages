module 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::vault {
    ...
    public(friend) fun settle_balance_manager(arg0: &mut Vault, arg1: u64, arg2: u64, arg3: &mut 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::balance_manager::BalanceManager, arg4: &0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::balance_manager::PlayProof) {
        0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::balance_manager::ensure_sufficient_funds(arg3, arg2);
        if (arg1 > arg2) {
            let v0 = if (0x2::balance::value<0x2::sui::SUI>(&arg0.play_balance) >= arg1 - arg2) {
                ...
                assert!(arg1 - arg2 - 0x2::balance::value<0x2::sui::SUI>(&arg0.play_balance) <= 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::constants::precision_error_allowance(), 1);
                0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.play_balance)
            };
            0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::balance_manager::deposit_with_proof(arg3, arg4, v0);
        } else if (arg2 > arg1) {
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.play_balance, 0x136fe1254dee4a8584d07494f86bbaa96a43446fa1c95a73136fb7983710fde4::balance_manager::withdraw_with_proof(arg3, arg4, arg2 - arg1));
        };
    }
