module 0x1323cd659754788180c710af1218b71f4f8246d64170816f9dc0c29095e98a0a::bloblifelabs__walrus_companion {
    ...
    fun init(arg0: BLOBLIFELABS__WALRUS_COMPANION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Walrus Companion"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiav2klqmeibrfk2jc5dzinjceas6pyvyvvpefx6viobarsh5e72wy"));
