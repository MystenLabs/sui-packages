module 0x13bf486069f8cc11d636d666612ac2180dd6e86bbea593f429505bddd6b1bc97::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    fun impl_mint(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: &mut 0x2::tx_context::TxContext) : Nft {
        ...
        assert!(0x1::vector::length<0x1::string::String>(&arg4) == 0x1::vector::length<0x1::string::String>(&arg5), 13906834758458933247);
    ...
    public fun launchpad_mint(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &0x2::transfer_policy::TransferPolicy<Nft>, arg8: &mut 0x7d0dd35bbfbac5218f8ad6183b3a73816b19d732d5399e4ad4d67f3d082fd57f::launch_manager::Launch, arg9: &mut 0x7d0dd35bbfbac5218f8ad6183b3a73816b19d732d5399e4ad4d67f3d082fd57f::launchpad::Launchpad, arg10: u64, arg11: &mut Config, arg12: &mut 0x2::tx_context::TxContext) {
        assert_mintable(arg11);
        let v0 = impl_mint(arg0, arg2, arg1, arg10, arg3, arg4, arg12);
        let v1 = MintNftEvent{nft_id: 0x2::object::uid_to_inner(&v0.id)};
        0x2::event::emit<MintNftEvent>(v1);
        arg11.mint_count = arg11.mint_count + 1;
        0x7d0dd35bbfbac5218f8ad6183b3a73816b19d732d5399e4ad4d67f3d082fd57f::launch_manager::mint_with_kiosk<Nft>(arg8, v0, arg5, arg7, arg6, arg9, arg12);
    }
    ...
    fun setup_display(arg0: 0x2::display::Display<Nft>, arg1: address) {
        ...
        0x2::display::add<Nft>(&mut arg0, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(b"https://betbarkers.com"));
        0x2::display::add<Nft>(&mut arg0, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"Nft Team"));
        0x2::display::add<Nft>(&mut arg0, 0x1::string::utf8(b"banner_image"), 0x1::string::utf8(b"https://betbarkers.com/banner.png"));
        0x2::display::add<Nft>(&mut arg0, 0x1::string::utf8(b"cover_url"), 0x1::string::utf8(b"https://betbarkers.com/cover.png"));
