module 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::alphapool {
    ...
    public fun create<T0>(arg0: &0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::alpha::Admin_cap, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: &0x2::clock::Clock, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool<T0>{
    ...
    public fun deposit<T0>(arg0: 0x1::option::Option<Receipt>, arg1: &mut Pool<T0>, arg2: &mut 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::distributor::Distributor, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : Receipt {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v0, 0x2::balance::value<T0>(&v0) * arg1.deposit_fee / 100), arg5), 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::distributor::get_fee_wallet_address(arg2));
    ...
    public fun destroy_receipt_and_transfer_rewards<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg0;
    ...
    fun get_rewards<T0, T1>(arg0: &mut Pool<T0>, arg1: &mut 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::distributor::Distributor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::string::index_of(&v1, &v2) < 0x1::string::length(&v1)) {
            0x2::balance::join<T0>(&mut arg0.alpha_bal, 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::distributor::get_rewards<T0>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3));
        } else {
            let v3 = 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::distributor::get_rewards<T1>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3);
    ...
    public fun get_user_rewards_all<T0>(arg0: &mut Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun set_lock_period<T0>(arg0: &0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::alpha::Admin_cap, arg1: &mut Pool<T0>, arg2: u64) {
    ...
    public fun user_deposit<T0>(arg0: 0x1::option::Option<Receipt>, arg1: &mut Pool<T0>, arg2: &mut 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::distributor::Distributor, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = deposit<T0>(arg0, arg1, arg2, arg3, arg4, arg5);
        0x2::transfer::public_transfer<Receipt>(v0, 0x2::tx_context::sender(arg5));
    }

    public fun user_withdraw<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::distributor::Distributor, arg3: u64, arg4: &0x2::clock::Clock, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun withdraw<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::distributor::Distributor, arg3: u64, arg4: &0x2::clock::Clock, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : Receipt {
        update_pool<T0>(arg1, arg4);
        ...
        if (arg5 == true) {
            assert!(arg3 <= (((arg0.xTokenBalance as u256) * (1000000000 as u256) / v1) as u64), 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::error::insufficient_balance_error());
        } else {
            assert!(arg3 <= (arg0.balance as u64), 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::error::insufficient_balance_error());
        };
        let v3 = 0;
        let v4 = v3;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.alpha_bal, v8), arg6), 0x13191fc4caec04c691d11107700be2fffbcb9fa0f4e70f37af7512f9463e7924::distributor::get_fee_wallet_address(arg2));
