module 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::hand_anchor {
    ...
    fun execute_settle<T0>(arg0: &mut 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: vector<u64>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == 1, 501);
        assert!(arg1.table_id == 0x2::object::id<0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::TableAnchor<T0>>(arg0), 502);
        ...
        while (v3 < v0) {
            ...
            0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::apply_seat_outcome<T0>(arg0, v4.seat_idx, v4.seat_epoch, v4.address, *0x1::vector::borrow<u64>(&arg2, v3));
            v3 = v3 + 1;
        };
        if (arg3 > 0) {
            let v5 = 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::stakes_rake_cap(0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::stakes_config<T0>(arg0));
            assert!(v5 == 0 || arg3 <= v5, 523);
            assert!(arg3 * 10 <= v1, 523);
            assert!(arg3 <= 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::escrow_value<T0>(arg0), 511);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::take_from_escrow<T0>(arg0, arg3), arg5), @0x117c5e19bc1884228f68ecaab30767dd016daaf3976bf2e3e0018e66fd45be71);
        };
        arg1.status = 2;
        0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::clear_active_hand<T0>(arg0, 0x2::object::id<HandAnchor>(arg1));
        let v6 = HandSettled{
    ...
    fun execute_void<T0>(arg0: &mut 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(arg1.status == 1, 501);
        assert!(arg1.table_id == 0x2::object::id<0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::TableAnchor<T0>>(arg0), 502);
        let v0 = 0;
        while (v0 < 0x1::vector::length<HandPlayer>(&arg1.player_list)) {
            let v1 = 0x1::vector::borrow<HandPlayer>(&arg1.player_list, v0);
            0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::apply_seat_outcome<T0>(arg0, v1.seat_idx, v1.seat_epoch, v1.address, v1.start_stack);
            v0 = v0 + 1;
        };
        arg1.status = 3;
        0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::clear_active_hand<T0>(arg0, 0x2::object::id<HandAnchor>(arg1));
    ...
    public fun open_board_card(arg0: &mut HandAnchor, arg1: &0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::CoordinatorRegistry, arg2: u8, arg3: &0x2::tx_context::TxContext) {
        0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::assert_coordinator(arg1, arg3);
        assert!(arg0.registry_id == 0x2::object::id<0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::CoordinatorRegistry>(arg1), 521);
    ...
    public fun settle_hand<T0>(arg0: &mut 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: &0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::CoordinatorRegistry, arg3: vector<u64>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::assert_coordinator(arg2, arg6);
        assert!(arg1.registry_id == 0x2::object::id<0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::CoordinatorRegistry>(arg2), 521);
        execute_settle<T0>(arg0, arg1, arg3, arg4, arg5, arg6);
    }

    public fun settle_hand_with_quorum<T0>(arg0: &mut 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: &0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::CoordinatorRegistry, arg3: vector<u64>, arg4: u64, arg5: u64, arg6: vector<vector<u8>>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::is_frozen(arg2), 524);
        assert!(0x2::object::id<0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::CoordinatorRegistry>(arg2) == arg1.registry_id, 521);
        assert!(arg1.status == 1, 501);
        let v0 = 0x1::vector::length<HandPlayer>(&arg1.player_list);
        assert!(0x1::vector::length<u64>(&arg3) == v0, 508);
        let v1 = 0x1::vector::length<vector<u8>>(&arg6);
        assert!(v1 == popcount_u64(arg5), 519);
        assert!(v1 >= (v0 * 2 + 2) / 3, 518);
        let v2 = 0x2::object::id<HandAnchor>(arg1);
        let v3 = build_settle_message_v1(&v2, &arg3, arg4);
        let v4 = 0;
        let v5 = 0;
        while (v5 < v0) {
            if (arg5 & 1 << (v5 as u8) != 0) {
                let v6 = 0x1::vector::borrow<HandPlayer>(&arg1.player_list, v5);
                assert!(0x1::vector::length<u8>(&v6.session_pubkey) == 32, 517);
                assert!(0x2::ed25519::ed25519_verify(0x1::vector::borrow<vector<u8>>(&arg6, v4), &v6.session_pubkey, &v3), 520);
                v4 = v4 + 1;
            };
            v5 = v5 + 1;
        };
        arg1.trust_model = 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::version::trust_player_quorum();
        execute_settle<T0>(arg0, arg1, arg3, arg4, arg7, arg8);
    }
    ...
    public fun start_hand<T0>(arg0: &mut 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::TableAnchor<T0>, arg1: &0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::CoordinatorRegistry, arg2: u64, arg3: vector<HandPlayer>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<address>, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::assert_coordinator(arg1, arg9);
        0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::assert_registry<T0>(arg0, arg1);
        ...
        while (v3 < v0) {
            ...
            0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::assert_seat_matches<T0>(arg0, v4.seat_idx, v4.seat_epoch, v4.address, v4.account_id);
            assert!(v4.start_stack == 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::seat_current_stack<T0>(arg0, v4.seat_idx), 512);
            let v5 = 0x1::vector::length<u8>(&v4.session_pubkey);
            assert!(v5 == 0 || v5 == 32, 516);
            v3 = v3 + 1;
        };
        let v6 = 0x2::object::id<0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::TableAnchor<T0>>(arg0);
        let v7 = HandAnchor{
            id                  : 0x2::object::new(arg9),
            table_id            : v6,
            registry_id         : 0x2::object::id<0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::CoordinatorRegistry>(arg1),
            hand_seq            : arg2,
            player_list         : arg3,
            deck_root           : arg4,
            ...
            committee_list      : arg6,
            status              : 1,
            trust_model         : 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::version::trust_prototype(),
        ...
        0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::mark_active_hand<T0>(arg0, v8);
        let v9 = HandStarted{
            hand_id           : v8,
            table_id          : v6,
    ...
    public fun void_hand<T0>(arg0: &mut 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: &0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::CoordinatorRegistry, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::assert_coordinator(arg2, arg5);
        assert!(arg1.registry_id == 0x2::object::id<0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::coordinator_registry::CoordinatorRegistry>(arg2), 521);
        execute_void<T0>(arg0, arg1, arg3, arg4);
    }

    public fun void_hand_after_deadline<T0>(arg0: &mut 0x138de32047c175c735290e663ec7861a2c1ef9fef1fc90f8d70387a64e43e6e0::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == 1, 501);
