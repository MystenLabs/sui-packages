module 0x136f02ff814bb100b4d39d0dae658272183d1c9ca1142368a7c3ce0f0386a365::mycoin {
    struct MYCOIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: MYCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MYCOIN>(arg0, 8, b"xydkdcoin", b"xydkdcoin", b"xydkdcoin", 0x1::option::none<0x2::url::Url>(), arg1);
