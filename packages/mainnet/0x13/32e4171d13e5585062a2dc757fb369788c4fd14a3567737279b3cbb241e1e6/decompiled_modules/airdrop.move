module 0x1332e4171d13e5585062a2dc757fb369788c4fd14a3567737279b3cbb241e1e6::airdrop {
    ...
    public entry fun claim_hive_airdrop(arg0: &0x2::clock::Clock, arg1: &mut AirdropVault, arg2: u64, arg3: vector<vector<u8>>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1332e4171d13e5585062a2dc757fb369788c4fd14a3567737279b3cbb241e1e6::merkle_proof::verify(&arg3, *0x1::vector::borrow<vector<u8>>(&arg1.merkle_tree_roots, arg4), create_leaf(v0, arg2)), 4203);
    ...
    public fun is_proof_valid(arg0: &AirdropVault, arg1: address, arg2: u64, arg3: vector<vector<u8>>, arg4: u64) : bool {
        0x1332e4171d13e5585062a2dc757fb369788c4fd14a3567737279b3cbb241e1e6::merkle_proof::verify(&arg3, *0x1::vector::borrow<vector<u8>>(&arg0.merkle_tree_roots, arg4), create_leaf(arg1, arg2))
    }
