module 0x134170c716d79692b6e489f8fb6ee7fde4299c5ed92ffa5e820ae5c2d0c2d275::reward9321 {
    struct REWARD9321 has drop {
        dummy_field: bool,
    }

    struct TICKET_9321 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9321(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9321>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9321>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9321, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9321>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9321>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9321>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9321>>(v5, 0x2::tx_context::sender(arg1));
    }
