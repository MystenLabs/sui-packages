module 0x136ab2b1b8e8458ce415a6ebac0649e3a7d841e29e607ba97117271b09b20b8c::abi {
    ...
    public fun read_vector_fixed_length_type(arg0: &mut AbiReader, arg1: u64) : vector<vector<u256>> {
        let v0 = arg0.pos;
        let v1 = read_u256(arg0);
        arg0.pos = arg0.head + (v1 as u64);
        let v2 = read_u256(arg0);
        ...
        while (v4 < (v2 as u64)) {
            ...
            let v6 = 0;
            while (v6 < arg1) {
                let v7 = read_u256(arg0);
                0x1::vector::push_back<u256>(&mut v5, v7);
                v6 = v6 + 1;
            };
            0x1::vector::push_back<vector<u256>>(&mut v3, v5);
            v4 = v4 + 1;
        };
        arg0.pos = v0 + 32;
        v3
