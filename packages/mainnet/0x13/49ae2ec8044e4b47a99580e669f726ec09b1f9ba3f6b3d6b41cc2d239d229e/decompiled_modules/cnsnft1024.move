module 0x1349ae2ec8044e4b47a99580e669f726ec09b1f9ba3f6b3d6b41cc2d239d229e::cnsnft1024 {
    struct CNSNFT1024 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1024, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1024>(arg0, arg1);
