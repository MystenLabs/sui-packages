module 0x131382706c9cb276e098a2bca456b63a6db58b718e03f67e4ec9c7f51ce7c58c::goat {
    ...
    fun init(arg0: GOAT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<GOAT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"GOAT    ")))), trim_right(b"Goatseus Maximus                "), trim_right(b"After an attempt on President Trump's life during his last speech, he told everyone to FIGHT, encouraging us to continue fighting to Make America Great Again                                                                                                                                                                   "), v2, arg1);
