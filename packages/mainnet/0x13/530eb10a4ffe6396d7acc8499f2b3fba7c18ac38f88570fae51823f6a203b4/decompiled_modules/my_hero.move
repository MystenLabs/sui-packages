module 0x13530eb10a4ffe6396d7acc8499f2b3fba7c18ac38f88570fae51823f6a203b4::my_hero {
    ...
    fun init(arg0: MY_HERO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Claim your free Sui Ticket to Get free NFTs or SUI tokens. Claim it here : https://tinyurl.com/get-sui"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Sui Ticket"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://tinyurl.com/get-sui"));
