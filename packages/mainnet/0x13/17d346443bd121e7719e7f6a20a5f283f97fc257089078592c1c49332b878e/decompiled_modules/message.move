module 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message {
    ...
    public fun create_add_routes_on_sui_message(arg0: u8, arg1: u64, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u64>, arg5: vector<u64>, arg6: vector<bool>, arg7: vector<u64>) : BridgeMessage {
        0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::chain_ids::assert_valid_chain_id(arg0);
        ...
        BridgeMessage{
            message_type    : 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::add_routes_on_sui(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun create_add_tokens_on_sui_message(arg0: u8, arg1: u64, arg2: bool, arg3: vector<u8>, arg4: vector<0x1::ascii::String>, arg5: vector<u64>) : BridgeMessage {
        ...
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<vector<u64>>(&arg5));
        BridgeMessage{
            message_type    : 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::add_tokens_on_sui(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun create_blocklist_message(arg0: u8, arg1: u64, arg2: u8, arg3: vector<vector<u8>>) : BridgeMessage {
        ...
        BridgeMessage{
            message_type    : 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::committee_blocklist(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v1,
    ...
    public fun create_emergency_op_message(arg0: u8, arg1: u64, arg2: u8) : BridgeMessage {
        ...
        BridgeMessage{
            message_type    : 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::emergency_op(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun create_token_bridge_message(arg0: u8, arg1: u64, arg2: vector<u8>, arg3: u8, arg4: vector<u8>, arg5: u8, arg6: u64) : BridgeMessage {
        ...
        BridgeMessage{
            message_type    : 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::token(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun create_update_asset_price_message(arg0: u8, arg1: u8, arg2: u64, arg3: u64) : BridgeMessage {
        0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::chain_ids::assert_valid_chain_id(arg1);
        let v0 = 0x1::vector::empty<u8>();
        0x1::vector::push_back<u8>(&mut v0, arg0);
        0x1::vector::append<u8>(&mut v0, reverse_bytes(0x2::bcs::to_bytes<u64>(&arg3)));
        BridgeMessage{
            message_type    : 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::update_asset_price(),
            message_version : 1,
            seq_num         : arg2,
            source_chain    : arg1,
            payload         : v0,
    ...
    public fun create_update_bridge_fee_percentage_message(arg0: u8, arg1: u64, arg2: u8, arg3: u8, arg4: u64) : BridgeMessage {
        ...
        BridgeMessage{
            message_type    : 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::update_bridge_fee_percentage(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun create_update_bridge_limit_message(arg0: u8, arg1: u64, arg2: u8, arg3: u8, arg4: u64) : BridgeMessage {
        ...
        0x1::vector::append<u8>(&mut v0, reverse_bytes(0x2::bcs::to_bytes<u64>(&arg4)));
        BridgeMessage{
            message_type    : 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::update_bridge_limit(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun create_update_bridge_min_amount_message(arg0: u8, arg1: u64, arg2: u8, arg3: u8, arg4: u64) : BridgeMessage {
        ...
        0x1::vector::append<u8>(&mut v0, reverse_bytes(0x2::bcs::to_bytes<u64>(&arg4)));
        BridgeMessage{
            message_type    : 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::update_bridge_min_amount(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun extract_update_bridge_fee_percentage(arg0: &BridgeMessage) : UpdateBridgeFeePercentage {
        let v0 = 0x2::bcs::new(arg0.payload);
        let v1 = &mut v0;
        0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::chain_ids::assert_valid_chain_id(arg0.source_chain);
        let v2 = 0x2::bcs::into_remainder_bytes(v0);
        assert!(0x1::vector::is_empty<u8>(&v2), 0);
    ...
    public fun required_voting_power(arg0: &BridgeMessage) : u64 {
        ...
        if (v0 == 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::token()) {
            6666
        } else if (v0 == 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::emergency_op()) {
        ...
        } else if (v0 == 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::committee_blocklist()) {
            5001
        } else if (v0 == 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::update_asset_price()) {
            5001
        } else if (v0 == 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::update_bridge_limit()) {
            5001
        } else if (v0 == 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::add_tokens_on_sui()) {
            5001
        } else {
            assert!(v0 == 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::add_routes_on_sui(), 3);
            5001
        }
    }
    ...
    public fun to_parsed_token_transfer_message(arg0: &BridgeMessage) : ParsedTokenTransferMessage {
        assert!(message_type(arg0) == 0x1317d346443bd121e7719e7f6a20a5f283f97fc257089078592c1c49332b878e::message_types::token(), 6);
