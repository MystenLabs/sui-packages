module 0x13fe75a37f1bf1c7776133e2bd478436cc2b3a5cbf0404ac8e30b32fdb5970af::hydro_pump {
    ...
    fun buy_<T0>(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut Pool<T0>, arg2: u64, arg3: u64, arg4: address, arg5: address, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        let v2 = 0x13fe75a37f1bf1c7776133e2bd478436cc2b3a5cbf0404ac8e30b32fdb5970af::curves::calculate_add_liquidity_cost(arg1.virtual_sui_reserves, arg1.virtual_token_reserves, v1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Config{
            ...
            target_sui_reserves            : 3000000000,
            token_decimals                 : 6,
        };
    ...
    public entry fun quick_buy<T0>(arg0: &mut Config, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x13fe75a37f1bf1c7776133e2bd478436cc2b3a5cbf0404ac8e30b32fdb5970af::curves::calculate_token_amount_received(v4.virtual_sui_reserves, v4.virtual_token_reserves, v5 - v5 * v1 / 10000);
    ...
    public fun sell_returns<T0>(arg0: &mut Config, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        assert!(v4 > 0, 1);
        let v5 = 0x13fe75a37f1bf1c7776133e2bd478436cc2b3a5cbf0404ac8e30b32fdb5970af::curves::calculate_remove_liquidity_return(v3.virtual_token_reserves, v3.virtual_sui_reserves, v4);
