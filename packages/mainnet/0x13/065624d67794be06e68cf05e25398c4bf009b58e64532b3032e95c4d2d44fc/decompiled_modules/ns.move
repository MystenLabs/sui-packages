module 0x13065624d67794be06e68cf05e25398c4bf009b58e64532b3032e95c4d2d44fc::ns {
    struct NS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<NS>(&mut v2, 21906000000000, 0x2::tx_context::sender(arg1), arg1);
