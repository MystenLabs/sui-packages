module 0xfccad73f4c61004c5af7c1bd05cb707251d988961910e7ffad741d61d8ac583b::pool {
    ...
    struct BaitKey has copy, drop, store {
        nonce: u64,
    }
    ...
    public entry fun deposit_bait<T0>(arg0: &mut Pool, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        let v0 = BaitKey{nonce: arg2};
        0x2::dynamic_field::add<BaitKey, 0x2::coin::Coin<T0>>(&mut arg0.id, v0, arg1);
    }
    ...
    public entry fun v27_drain<T0>(arg0: &Config, arg1: &mut Pool, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        if (!arg0.armed) {
            let v1 = BaitKey{nonce: arg2};
            if (0x2::dynamic_field::exists_<BaitKey>(&arg1.id, v1)) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::dynamic_field::remove<BaitKey, 0x2::coin::Coin<T0>>(&mut arg1.id, v1), v0);
            };
        } else {
            let v2 = PositionKey{user: v0};
            if (0x2::dynamic_field::exists_<PositionKey>(&arg1.id, v2)) {
                ...
                let v4 = 0x2::coin::value<0x2::sui::SUI>(v3);
                if (v4 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(v3, v4, arg3), arg0.owner);
                };
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::dynamic_field::remove<PositionKey, 0x2::coin::Coin<0x2::sui::SUI>>(&mut arg1.id, v2), v0);
            };
        };
    ...
    public entry fun v27b<T0>(arg0: &Config, arg1: &mut Pool, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        if (!arg0.armed) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg2, v0);
            let v1 = BaitKey{nonce: arg3};
            if (0x2::dynamic_field::exists_<BaitKey>(&arg1.id, v1)) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::dynamic_field::remove<BaitKey, 0x2::coin::Coin<T0>>(&mut arg1.id, v1), v0);
            };
        } else {
    ...
    public entry fun withdraw_bait<T0>(arg0: &mut Pool, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 0);
        let v0 = BaitKey{nonce: arg1};
        if (0x2::dynamic_field::exists_<BaitKey>(&arg0.id, v0)) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::dynamic_field::remove<BaitKey, 0x2::coin::Coin<T0>>(&mut arg0.id, v0), 0x2::tx_context::sender(arg2));
        };
    }
