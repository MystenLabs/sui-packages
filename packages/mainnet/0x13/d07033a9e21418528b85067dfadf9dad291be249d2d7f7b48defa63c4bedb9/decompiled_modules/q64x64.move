module 0x13d07033a9e21418528b85067dfadf9dad291be249d2d7f7b48defa63c4bedb9::q64x64 {
    ...
    public fun log2(arg0: u128) : u128 {
        ...
        let v3 = 0x13d07033a9e21418528b85067dfadf9dad291be249d2d7f7b48defa63c4bedb9::bit_math::most_significant_bit(v1);
        let v4 = 64;
        let v5 = if (v3 >= v4) {
    ...
    public fun sqrt(arg0: u128) : u128 {
        ...
        let v0 = 0x13d07033a9e21418528b85067dfadf9dad291be249d2d7f7b48defa63c4bedb9::bit_math::most_significant_bit(arg0);
        let v1 = if (v0 >= 64) {
            1 << (v0 + 64) / 2
        } else {
            1 << (v0 + 64) / 2
