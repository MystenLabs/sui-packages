module 0x13d07033a9e21418528b85067dfadf9dad291be249d2d7f7b48defa63c4bedb9::rewarder {
    ...
    public fun deposit_reward<T0>(arg0: &0x13d07033a9e21418528b85067dfadf9dad291be249d2d7f7b48defa63c4bedb9::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) {
    ...
    public fun emergent_withdraw<T0>(arg0: &0x13d07033a9e21418528b85067dfadf9dad291be249d2d7f7b48defa63c4bedb9::config::AdminCap, arg1: &0x13d07033a9e21418528b85067dfadf9dad291be249d2d7f7b48defa63c4bedb9::config::GlobalConfig, arg2: &mut RewarderGlobalVault, arg3: u64) : 0x2::balance::Balance<T0> {
        0x13d07033a9e21418528b85067dfadf9dad291be249d2d7f7b48defa63c4bedb9::config::checked_package_version(arg1);
    ...
    public(friend) fun update_emission<T0>(arg0: &RewarderGlobalVault, arg1: &mut RewarderManager, arg2: 0x2::object::ID, arg3: u128) {
        ...
        if (arg3 > v2 && arg3 > 0) {
            assert!(balance_of<T0>(arg0) >= 0x13d07033a9e21418528b85067dfadf9dad291be249d2d7f7b48defa63c4bedb9::safe_math::u128_to_u64(0x13d07033a9e21418528b85067dfadf9dad291be249d2d7f7b48defa63c4bedb9::safe_math::mul_u128(arg3, (86400 as u128))), 3003);
        };
