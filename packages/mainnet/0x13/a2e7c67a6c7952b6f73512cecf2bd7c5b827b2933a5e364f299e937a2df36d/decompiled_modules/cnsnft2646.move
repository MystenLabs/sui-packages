module 0x13a2e7c67a6c7952b6f73512cecf2bd7c5b827b2933a5e364f299e937a2df36d::cnsnft2646 {
    struct CNSNFT2646 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2646, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2646>(arg0, arg1);
