module 0x13b68ff402072eeb4b8b39b8b57d65fabd06258c53830952ad3289a9fffdad24::market_position {
    ...
    public(friend) fun update_lp_display<T0: drop>(arg0: &mut MarketPosition, arg1: &0x13b68ff402072eeb4b8b39b8b57d65fabd06258c53830952ad3289a9fffdad24::py::PyState<T0>) {
        let v0 = 9;
        if (0x2::dynamic_field::exists_<0x1::type_name::TypeName>(0x13b68ff402072eeb4b8b39b8b57d65fabd06258c53830952ad3289a9fffdad24::py::get_state_id<T0>(arg1), 0x1::type_name::get<T0>())) {
            v0 = *0x2::dynamic_field::borrow<0x1::type_name::TypeName, u8>(0x13b68ff402072eeb4b8b39b8b57d65fabd06258c53830952ad3289a9fffdad24::py::get_state_id<T0>(arg1), 0x1::type_name::get<T0>());
        };
