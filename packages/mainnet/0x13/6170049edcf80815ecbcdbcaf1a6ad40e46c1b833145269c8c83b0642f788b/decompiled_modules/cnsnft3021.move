module 0x136170049edcf80815ecbcdbcaf1a6ad40e46c1b833145269c8c83b0642f788b::cnsnft3021 {
    struct CNSNFT3021 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3021, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1843"));
        let v4 = 0x2::package::claim<CNSNFT3021>(arg0, arg1);
