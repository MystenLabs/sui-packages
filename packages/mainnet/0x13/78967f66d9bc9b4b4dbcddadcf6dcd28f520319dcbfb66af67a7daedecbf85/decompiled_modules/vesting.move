module 0x1378967f66d9bc9b4b4dbcddadcf6dcd28f520319dcbfb66af67a7daedecbf85::vesting {
    ...
    public entry fun unlock_with_utato(arg0: &mut AirdropPool, arg1: 0x2::coin::Coin<0x7b0075309f3faf6caa38a9fffd896673d93fcddad8d0513ce185e2d8eaf14e71::utato::UTATO>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v1.total_amount - v3;
        let v5 = if (arg2 > v4) {
            v4
        } else {
            arg2
        };
        let v6 = v3 - v1.claimed_amount + v5;
        let v7 = 0x2::coin::value<0x7b0075309f3faf6caa38a9fffd896673d93fcddad8d0513ce185e2d8eaf14e71::utato::UTATO>(&arg1);
        assert!(v7 >= v5, 9);
        assert!(0x2::balance::value<0x4deb377c33bfced1ab81cde96918e2538fe78735777150b0064ccf7df5e1c81::tato::TATO>(&arg0.coin_bag) >= v6, 7);
        v1.claimed_amount = v1.claimed_amount + v6;
        if (v7 > v5) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x7b0075309f3faf6caa38a9fffd896673d93fcddad8d0513ce185e2d8eaf14e71::utato::UTATO>>(0x2::coin::split<0x7b0075309f3faf6caa38a9fffd896673d93fcddad8d0513ce185e2d8eaf14e71::utato::UTATO>(&mut arg1, v7 - v5, arg4), v0);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x4deb377c33bfced1ab81cde96918e2538fe78735777150b0064ccf7df5e1c81::tato::TATO>>(0x2::coin::from_balance<0x4deb377c33bfced1ab81cde96918e2538fe78735777150b0064ccf7df5e1c81::tato::TATO>(0x2::balance::split<0x4deb377c33bfced1ab81cde96918e2538fe78735777150b0064ccf7df5e1c81::tato::TATO>(&mut arg0.coin_bag, v6), arg4), v0);
