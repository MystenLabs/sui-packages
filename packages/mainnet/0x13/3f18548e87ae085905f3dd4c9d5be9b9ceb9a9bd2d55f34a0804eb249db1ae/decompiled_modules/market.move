module 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::market {
    ...
    public fun check_version<T0>(arg0: &Market<T0>) {
        assert!(get_market_version<T0>(arg0) <= 39, 29);
    }
    ...
    fun open_position_common_v2<T0, T1, T2, T3, T4>(arg0: &0x2::clock::Clock, arg1: &mut Market<T0>, arg2: &WrappedPositionConfig<T2, T3>, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: 0x2::coin::Coin<T1>, arg6: 0x2::coin::Coin<T4>, arg7: u8, arg8: u64, arg9: u64, arg10: u256, arg11: u256, arg12: u256, arg13: 0x1::option::Option<0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::rate::Rate>, arg14: 0x1::option::Option<0x2::object::ID>, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        if (v24) {
            ...
            let v29 = 0x2::coin::into_balance<T4>(arg6);
            let v30 = 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::agg_price::coins_to_value(&v28, 0x2::balance::value<T4>(&v29));
            let v31 = 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::decimal::div_by_u64(0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::decimal::from_u64(order_min_fee<T0>(arg1)), 1000000000);
            assert!(0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::decimal::ge(&v30, &v31), 16);
            let v32 = 0x2::object::new(arg15);
            let v33 = OrderName<T1, T2, T3, T4>{
                id          : 0x2::object::uid_to_inner(&v32),
                owner       : v1,
                position_id : 0x1::option::none<0x2::object::ID>(),
            };
            let (v34, v35) = 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::new_open_position_order_v2<T1, T4>(v0, arg8, arg9, v15, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::decimal::from_raw(arg10), arg2.inner, 0x2::coin::into_balance<T1>(arg5), v29, arg14, arg13, v17);
            0x2::bag::add<OrderName<T1, T2, T3, T4>, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::OpenPositionOrderV2<T1, T4>>(&mut arg1.orders, v33, v34);
            let v36 = OrderCap<T1, T2, T3, T4>{
                id          : v32,
                position_id : v33.position_id,
            };
            0x2::transfer::transfer<OrderCap<T1, T2, T3, T4>>(v36, v1);
            let v37 = OrderCreated<OrderName<T1, T2, T3, T4>, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::CreateOpenPositionOrderV2Event>{
                order_name : v33,
                event      : v35,
            };
            0x2::event::emit<OrderCreated<OrderName<T1, T2, T3, T4>, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::CreateOpenPositionOrderV2Event>>(v37);
        } else {
            assert!(arg7 > 0, 6);
            let v38 = VaultName<T1>{dummy_field: false};
            let v39 = 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::agg_price::parse_pyth_feeder_v1_1(0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::pool::vault_price_config<T1>(0x2::bag::borrow_mut<VaultName<T1>, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::pool::Vault<T1>>(&mut arg1.vaults, v38)), arg3, v0);
            let v40 = 0x2::coin::into_balance<T4>(arg6);
            let v41 = 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::agg_price::coins_to_value(&v39, 0x2::balance::value<T4>(&v40));
            let v42 = 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::decimal::div_by_u64(0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::decimal::from_u64(order_min_fee<T0>(arg1)), 1000000000);
            assert!(0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::decimal::ge(&v41, &v42), 16);
            let v43 = get_execution_price<T2>(&arg1.id, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::pool::symbol_price_config(v6), &v14, v3, v4, arg8, v2, v2, true);
            let v44 = 0x2::object::new(arg15);
            let v45 = OrderName<T1, T2, T3, T4>{
                id          : 0x2::object::uid_to_inner(&v44),
                owner       : v1,
                position_id : 0x1::option::none<0x2::object::ID>(),
            };
            let (v46, v47) = 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::new_open_market_order<T1, T4>(v0, arg8, arg9, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::agg_price::price_of(&v43), 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::decimal::from_raw(arg12), 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::decimal::from_raw(arg10), arg2.inner, 0x2::coin::into_balance<T1>(arg5), v40, arg14, arg13, v17);
            0x2::bag::add<OrderName<T1, T2, T3, T4>, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::OpenMarketOrder<T1, T4>>(&mut arg1.orders, v45, v46);
            let v48 = OrderCap<T1, T2, T3, T4>{
                id          : v44,
                position_id : v45.position_id,
            };
            0x2::transfer::transfer<OrderCap<T1, T2, T3, T4>>(v48, v1);
            let v49 = OrderCreated<OrderName<T1, T2, T3, T4>, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::CreateOpenMarketOrderEvent>{
                order_name : v45,
                event      : v47,
            };
            0x2::event::emit<OrderCreated<OrderName<T1, T2, T3, T4>, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::CreateOpenMarketOrderEvent>>(v49);
        };
    }
