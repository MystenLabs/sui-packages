module 0xdcae8145725b35fd95f4e8dc5ec8d23411219428b550b049253d044032219c34::meme {
    ...
    fun init(arg0: MEME, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME>(arg0, 9, b"Diddy", b"Diddy Token", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://media-cdn-v2.laodong.vn/storage/newsportal/2024/10/11/1406466/Diddy-2.jpeg")), arg1);
        let v2 = v0;
