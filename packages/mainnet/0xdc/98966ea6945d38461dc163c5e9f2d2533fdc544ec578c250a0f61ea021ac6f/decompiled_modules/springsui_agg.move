module 0xdc98966ea6945d38461dc163c5e9f2d2533fdc544ec578c250a0f61ea021ac6f::springsui_agg {
    struct SpringSuiAgg has drop {
        dummy_field: bool,
    }

    public fun swap<T0: drop>(arg0: &0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::router::Router, arg1: &mut 0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::swap::SwapContext, arg2: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T0>, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: bool, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        if (arg4) {
            let v0 = SpringSuiAgg{dummy_field: false};
            let v1 = swap_a2b<T0>(arg2, arg3, 0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::swap::take_balance<SpringSuiAgg, 0x2::sui::SUI>(arg1, arg0, v0, arg5), arg6);
            if (0x2::balance::value<T0>(&v1) > 0) {
                0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::swap::put_balance<T0>(arg1, v1);
            } else {
                0x2::balance::destroy_zero<T0>(v1);
            };
        } else {
            let v2 = SpringSuiAgg{dummy_field: false};
            let v3 = swap_b2a<T0>(arg2, arg3, 0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::swap::take_balance<SpringSuiAgg, T0>(arg1, arg0, v2, arg5), arg6);
