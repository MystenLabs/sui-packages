module 0xdc2f1ff472250d9688c7c5f50f3c170d9189b3c96c907f3f743d6a65e1d9b06f::recording_language {
    ...
    public fun has_languages<T0, T1>(arg0: &0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::Recording<T0, T1>) : bool {
    ...
    public fun is_instrumental<T0, T1>(arg0: &0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::Recording<T0, T1>) : bool {
        if (has_languages<T0, T1>(arg0)) {
            let v1 = ExtensionKey{dummy_field: false};
            0x1::vector::is_empty<0x416a57aeaf005563dbe29eb913683154058e84648a78e9bd55543fc5990ea9a9::language_code::LanguageCode>(0x2::dynamic_field::borrow<ExtensionKey, vector<0x416a57aeaf005563dbe29eb913683154058e84648a78e9bd55543fc5990ea9a9::language_code::LanguageCode>>(0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::uid<T0, T1>(arg0), v1))
        } else {
            false
        }
    }

    public fun languages<T0, T1>(arg0: &0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::Recording<T0, T1>) : vector<0x416a57aeaf005563dbe29eb913683154058e84648a78e9bd55543fc5990ea9a9::language_code::LanguageCode> {
        assert!(has_languages<T0, T1>(arg0), 1);
        let v0 = ExtensionKey{dummy_field: false};
        *0x2::dynamic_field::borrow<ExtensionKey, vector<0x416a57aeaf005563dbe29eb913683154058e84648a78e9bd55543fc5990ea9a9::language_code::LanguageCode>>(0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::uid<T0, T1>(arg0), v0)
    }

    public fun set_instrumental<T0, T1>(arg0: &mut 0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::Recording<T0, T1>, arg1: &0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::RecordingAdminCap<T0>) {
    ...
    public fun set_languages<T0, T1>(arg0: &mut 0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::Recording<T0, T1>, arg1: &0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::RecordingAdminCap<T0>, arg2: vector<0x416a57aeaf005563dbe29eb913683154058e84648a78e9bd55543fc5990ea9a9::language_code::LanguageCode>) {
        validate(&arg2);
        ...
        let v5 = LanguagesSetEvent{
            recording_id : 0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::id<T0, T1>(arg0),
            languages    : *0x2::dynamic_field::borrow<ExtensionKey, vector<0x416a57aeaf005563dbe29eb913683154058e84648a78e9bd55543fc5990ea9a9::language_code::LanguageCode>>(0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::uid<T0, T1>(arg0), v4),
        };
        0x2::event::emit<LanguagesSetEvent>(v5);
    }

    public fun unset_languages<T0, T1>(arg0: &mut 0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::Recording<T0, T1>, arg1: &0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::RecordingAdminCap<T0>) {
        let v0 = 0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::uid_mut<T0, T1>(arg0, arg1);
        let v1 = ExtensionKey{dummy_field: false};
        if (0x2::dynamic_field::exists<ExtensionKey>(v0, v1)) {
            let v2 = ExtensionKey{dummy_field: false};
            ...
            let v3 = LanguagesUnsetEvent{recording_id: 0xe8e53f3f794b048172080f2a655b24b7ee5abfeeadcfe1c1de856a9a98282847::recording::id<T0, T1>(arg0)};
