module 0xdc5345a53b0999e6a9fe162e73852d240d94957c506cc1c9d9061d5caa436057::nft_sale {
    ...
    fun init(arg0: NFT_SALE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://hamsterssui.com/"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Boxes"));
        ...
        let v6 = Collection{
            ...
            name         : 0x1::string::utf8(b"Hamsters Item Box"),
            description  : 0x1::string::utf8(b"Magic Hamster Box."),
            base_url     : 0x1::string::utf8(b"ipfs://Qmb9EwWTgTFbsorEDnD34p6ZH8NgpTVcdiqEr6wGffB7xF/"),
            total        : 500,
            current      : 0,
    ...
    public entry fun mint_nft(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: vector<u8>, arg3: &mut Collection, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        loop {
            ...
            let v7 = arg3.base_url;
            0x1::string::append(&mut v7, 0x1::string::utf8(num_to_str(arg3.current + 1)));
            0x1::string::append(&mut v7, 0x1::string::utf8(b".png"));
            0x1::string::append_utf8(&mut v5, b" #");
            0x1::string::append(&mut v5, 0x1::string::utf8(num_to_str(arg3.current + 1)));
            mint_single_nft(v5, arg3.description, v7, arg4);
