module 0xdc877fbc90f0f25d97f33e41c8426d9f2716fc93e0ebf02122ac5036a3e88d2b::kite {
    ...
    fun init(arg0: KITE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"He Jing Yi's birthday!"));
        ...
        let v4 = 0x2::package::claim<KITE>(arg0, arg1);
    ...
    public entry fun transfer_nft(arg0: Hero, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
