module 0xdcc0b7eed21dc4ff8f2bd660fc02d25c6ce886e814aef81acd49700bea1ca145::nft_sale {
    ...
    fun init(arg0: NFT_SALE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://www.alpha-bears.com/"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{img_url}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Alpha Bears are ready to show themselves to the SuiWorld"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://www.alpha-bears.com/"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Bears"));
        ...
        let v6 = Collection{
            ...
            name         : 0x1::string::utf8(b"Alpha Bears NFT"),
            description  : 0x1::string::utf8(b"Alpha Bears are ready to show themselves to the SuiWorld"),
            base_url     : 0x1::string::utf8(b"ipfs://bafybeigcfnvc4kzcefkp46hbxpebmanjeop24tkby2c55ni4nrtaibisue/"),
            total        : 1111,
            current      : 0,
