module 0xdc9ab71a1ebeaf7548e3e8919bbb01ef2a42124b6902fbcc9c520b7d7321ef85::my_nft {
    ...
    fun init(arg0: MY_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://github.com/HKing147"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{image_url}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"A true Hero of the Sui ecosystem!"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://github.com/HKing147"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"HKing147"));
        ...
        let v6 = MyNFT{
            ...
            name      : 0x1::string::utf8(b"HKing147-NFT"),
            image_url : 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/63294617?v=4"),
        };
