module 0xdc5cd1c5423e7c16d48081b0f3b8e51a0e9dcf337ce24f73c2f8bfceee2dd20a::reward5686 {
    struct REWARD5686 has drop {
        dummy_field: bool,
    }

    struct TICKET_5686 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5686(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5686>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5686>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5686, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5686>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5686>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5686>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5686>>(v5, 0x2::tx_context::sender(arg1));
    }
