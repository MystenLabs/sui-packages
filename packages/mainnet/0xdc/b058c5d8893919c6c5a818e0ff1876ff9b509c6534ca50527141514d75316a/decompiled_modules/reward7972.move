module 0xdcb058c5d8893919c6c5a818e0ff1876ff9b509c6534ca50527141514d75316a::reward7972 {
    struct REWARD7972 has drop {
        dummy_field: bool,
    }

    struct TICKET_7972 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7972(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7972>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7972>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7972, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7972>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7972>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7972>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7972>>(v5, 0x2::tx_context::sender(arg1));
    }
