module 0xdc50e6c7d205306a0badaae515b328c36b554ab9f87efcb76e2055f8a0ca7423::cnsnft4663 {
    struct CNSNFT4663 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4663, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4663>(arg0, arg1);
