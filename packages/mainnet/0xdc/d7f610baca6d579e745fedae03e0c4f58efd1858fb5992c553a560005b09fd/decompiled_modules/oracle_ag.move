module 0xdcd7f610baca6d579e745fedae03e0c4f58efd1858fb5992c553a560005b09fd::oracle_ag {
    ...
    fun new(arg0: &mut 0x2::tx_context::TxContext) : (OracleAggregator, OracleAggregatorCap) {
        let v0 = OracleAggregator{
            ...
            max_age               : 0xdcd7f610baca6d579e745fedae03e0c4f58efd1858fb5992c553a560005b09fd::consts::GET_PYTH_MAX_AGE(),
    ...
    public fun get_price<T0>(arg0: &OracleAggregator, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : (u64, u64, u64) {
        ...
        let (v6, v7) = if (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_is_negative(&v5) == true) {
            ...
            assert!(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_conf(&v0) < v8 * 0xdcd7f610baca6d579e745fedae03e0c4f58efd1858fb5992c553a560005b09fd::consts::GET_MAX_PRICE_CONF_BPS() / 10000, 2);
            ...
            assert!(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_conf(&v0) < v9 * 0xdcd7f610baca6d579e745fedae03e0c4f58efd1858fb5992c553a560005b09fd::consts::GET_MAX_PRICE_CONF_BPS() / 10000, 2);
            (v9, 0)
        };
    ...
    public fun assert_oracle_aggregator_cap(arg0: &OracleAggregator, arg1: &OracleAggregatorCap) {
        assert!(0x2::object::id<OracleAggregator>(arg0) == arg1.oracle_aggregator, 13906834389091745791);
    }
    ...
    public fun calc_usd_value<T0>(arg0: &OracleAggregator, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        ...
        0xdcd7f610baca6d579e745fedae03e0c4f58efd1858fb5992c553a560005b09fd::lotus_math::scale_from_float(0xdcd7f610baca6d579e745fedae03e0c4f58efd1858fb5992c553a560005b09fd::lotus_math::mul_u128(0xdcd7f610baca6d579e745fedae03e0c4f58efd1858fb5992c553a560005b09fd::lotus_math::scale_to_float(arg2, (get_coin_decimal<T0>(arg0) as u64)), 0xdcd7f610baca6d579e745fedae03e0c4f58efd1858fb5992c553a560005b09fd::lotus_math::scale_to_float(v0, v1)), 0xdcd7f610baca6d579e745fedae03e0c4f58efd1858fb5992c553a560005b09fd::consts::GET_USDC_DECIMALS())
    }
    ...
    public fun update_max_age(arg0: &mut OracleAggregator, arg1: &OracleAggregatorCap, arg2: u64) {
        assert_oracle_aggregator_cap(arg0, arg1);
        assert!(arg2 >= 1 && arg2 <= 60, 13906834835768344575);
        arg0.max_age = arg2;
    }
