module 0xdcad1c0ba5d5ca592dd293d3c6cd35aeff5bdbd905db6bbcbf1c5fd2aa9d6185::game {
    ...
    public fun create_game_witness() : 0xdcad1c0ba5d5ca592dd293d3c6cd35aeff5bdbd905db6bbcbf1c5fd2aa9d6185::leaderboard::GameWitness {
        0xdcad1c0ba5d5ca592dd293d3c6cd35aeff5bdbd905db6bbcbf1c5fd2aa9d6185::leaderboard::new_game_witness()
    }
    ...
    public entry fun create_session(arg0: &AdminCap, arg1: &mut GameConfig, arg2: vector<u8>, arg3: u8, arg4: vector<u8>, arg5: vector<u8>, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Session{
            ...
            minted      : false,
            expires_at  : arg7,
            allowlist   : 0x2::table::new<address, bool>(arg9),
        };
    ...
    public entry fun mint_nft(arg0: &mut Session, arg1: AllowlistCap, arg2: &GameConfig, arg3: vector<u8>, arg4: &mut 0xdcad1c0ba5d5ca592dd293d3c6cd35aeff5bdbd905db6bbcbf1c5fd2aa9d6185::leaderboard::Leaderboard, arg5: 0xdcad1c0ba5d5ca592dd293d3c6cd35aeff5bdbd905db6bbcbf1c5fd2aa9d6185::leaderboard::GameWitness, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0xdcad1c0ba5d5ca592dd293d3c6cd35aeff5bdbd905db6bbcbf1c5fd2aa9d6185::leaderboard::add_score(arg4, arg5, v1, v2, arg6, arg7);
        let AllowlistCap {
            id          : v7,
            session_id  : _,
            session_obj : _,
