module 0xdc75987a78a564817ac8c4388d65d84491808af8a30b474b5418a359c26b2a3e::plinko {
    ...
    public entry fun play_plinko(arg0: &mut 0xdc75987a78a564817ac8c4388d65d84491808af8a30b474b5418a359c26b2a3e::house_pool::HousePool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: u8, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 <= 2, 0);
        let v0 = if (arg4 == 8) {
            true
        } else if (arg4 == 12) {
        ...
        let v5 = v1 * v4 / 100;
        let v6 = v5 > v1;
        let v7 = 0xdc75987a78a564817ac8c4388d65d84491808af8a30b474b5418a359c26b2a3e::house_pool::process_bet(arg0, arg1, v6, v5, b"plinko", arg5);
