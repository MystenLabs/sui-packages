module 0xdc79f6044fbf1306baa24f01ea75649db9d368ad294e5d750b65ac4cfa07ee8f::cnsnft4488 {
    struct CNSNFT4488 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4488, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4488>(arg0, arg1);
