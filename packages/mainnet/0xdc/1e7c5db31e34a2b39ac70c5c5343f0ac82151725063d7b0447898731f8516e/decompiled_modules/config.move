module 0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::config {
    ...
    public fun add_stable_identifier_by_type<T0>(arg0: &mut Config, arg1: &HiveDaoCapability) {
        add_stable_identifier(arg0, arg1, 0x1::type_name::into_string(0x1::type_name::get<T0>()));
    }
    ...
    public entry fun get_fee_info<T0>(arg0: &Config) : (u64, u64) {
        if (0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::curves::is_stable<T0>()) {
            return (arg0.stable_pool_fee.total_fee_bps, arg0.stable_pool_fee.hive_fee_percent)
        };
        if (0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::curves::is_weighted<T0>()) {
            return (arg0.weighted_pool_fee.total_fee_bps, arg0.weighted_pool_fee.hive_fee_percent)
        };
        if (0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::curves::is_curved<T0>()) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = Config{
            ...
            weighted_pool_fee  : v7,
            stable_pool_fee    : v8,
            curved_pool_fee    : v9,
            treasury_percent   : 10,
        };
        0x2::transfer::share_object<Config>(v10);
        let v11 = Treasury<0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::hsui::HSUI>{
            id      : 0x2::object::new(arg0),
            balance : 0x2::balance::zero<0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::hsui::HSUI>(),
        };
        0x2::transfer::share_object<Treasury<0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::hsui::HSUI>>(v11);
    }
    ...
    public fun remove_stable_identifier(arg0: &mut Config, arg1: &HiveDaoCapability, arg2: 0x1::type_name::TypeName) {
    ...
    public fun update_default_fee_for_curve<T0>(arg0: &mut Config, arg1: &HiveDaoCapability, arg2: u64, arg3: u64) {
        0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::curves::assert_valid_curve<T0>();
        if (0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::curves::is_stable<T0>()) {
            let v0 = &mut arg0.stable_pool_fee;
            update_fee(v0, arg2, arg3);
        } else if (0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::curves::is_weighted<T0>()) {
            let v1 = &mut arg0.weighted_pool_fee;
            update_fee(v1, arg2, arg3);
        } else if (0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::curves::is_curved<T0>()) {
