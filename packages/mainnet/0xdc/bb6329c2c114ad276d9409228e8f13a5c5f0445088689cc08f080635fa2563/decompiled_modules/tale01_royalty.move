module 0xdcbb6329c2c114ad276d9409228e8f13a5c5f0445088689cc08f080635fa2563::tale01_royalty {
    ...
    public(friend) fun add<T0: store + key>(arg0: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg1: &0x2::transfer_policy::TransferPolicyCap<T0>, arg2: u16, arg3: u64) {
        assert!(arg2 <= 10000, 1);
    ...
    public fun fee_amount<T0: store + key>(arg0: &0x2::transfer_policy::TransferPolicy<T0>, arg1: u64) : u64 {
        ...
        let v2 = arg1 * (v1.amount_bp as u64) / (10000 as u64);
        if (v2 < v1.min_amount) {
            v1.min_amount
        } else {
            v2
    ...
    public fun pay<T0: store + key>(arg0: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg1: &mut 0x2::transfer_policy::TransferRequest<T0>, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Rule{dummy_field: false};
        let v1 = 0x2::transfer_policy::get_rule<T0, Rule, Config>(v0, arg0);
        let v2 = 0x2::transfer_policy::paid<T0>(arg1) * (v1.amount_bp as u64) / (10000 as u64);
        let v3 = v2;
        if (v2 < v1.min_amount) {
            v3 = v1.min_amount;
        };
        if (v3 > 0 && 0x2::coin::value<0x2::sui::SUI>(arg2) >= v3) {
