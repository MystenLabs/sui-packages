module 0xdc45e55d44e7d50e19cfb35f44703e921a84c62425cc40b36a18fb925b1cb9ba::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"VT560470", b"ValidToken 560470", b"This should succeed", 0x1::option::none<0x2::url::Url>(), arg1);
