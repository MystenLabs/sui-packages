module 0xdc39aac2401625b6b34893457d96db477faf80f2d9cbb72aae9fda604fe787e4::momentum_agg {
    struct MomentumAgg has drop {
        dummy_field: bool,
    }

    public fun swap<T0, T1, T2>(arg0: &0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::liquidator::Liquidator, arg1: &mut 0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::CustomLiquidateReceipt<T0>, arg2: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>, arg3: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg4: bool, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        let (v0, v1) = if (arg4) {
            let v2 = MomentumAgg{dummy_field: false};
            swap_a2b<T1, T2>(arg2, arg3, 0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::take_balance<MomentumAgg, T0, T1>(arg1, arg0, v2, arg5), arg6, arg7)
        } else {
            let v3 = MomentumAgg{dummy_field: false};
            swap_b2a<T1, T2>(arg2, arg3, 0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::take_balance<MomentumAgg, T0, T2>(arg1, arg0, v3, arg5), arg6, arg7)
        };
        let v4 = v1;
        let v5 = v0;
        if (0x2::balance::value<T1>(&v5) > 0) {
            let v6 = MomentumAgg{dummy_field: false};
            0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::put_balance<MomentumAgg, T0, T1>(arg1, arg0, v6, v5);
        } else {
            0x2::balance::destroy_zero<T1>(v5);
        };
        if (0x2::balance::value<T2>(&v4) > 0) {
            let v7 = MomentumAgg{dummy_field: false};
            0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::put_balance<MomentumAgg, T0, T2>(arg1, arg0, v7, v4);
        } else {
