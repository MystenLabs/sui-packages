module 0xdc404e8b1ac2161f56011174eadebebafb8635c132997b65d3b4d90ab3315566::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"SU!", b"SU!", b"Official token. Banner and boost on dexscreener paid.Buy now", 0x1::option::none<0x2::url::Url>(), arg1);
