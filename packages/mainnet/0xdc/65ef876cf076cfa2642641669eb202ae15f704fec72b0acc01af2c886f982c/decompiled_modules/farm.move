module 0x4c9bf061d3fb029d673b6f71e5993027a61cfe963ab0abe2cb97f8595093497d::farm {
    ...
    public fun emergency_new_account<T0: store + key, T1>(arg0: &mut Farm<T0, T1>, arg1: Account<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : Account<T0, T1> {
        assert!(0x2::object::id<Farm<T0, T1>>(arg0) == arg1.farm_id, 2);
        let v0 = new_account<T0, T1>(arg0, arg2);
        while (0x2::table_vec::length<0x2::object::ID>(&arg1.nft_ids) > 0) {
            0x2::table_vec::push_back<0x2::object::ID>(&mut v0.nft_ids, 0x2::table_vec::pop_back<0x2::object::ID>(&mut arg1.nft_ids));
        };
        destroy_zero_account<T0, T1>(arg1);
        v0
    }
