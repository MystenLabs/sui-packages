module 0xdc2103a12b692486c71abc58b4de48a850f0599fa1f60e6a7cf79fac8125b4f2::marketplace_ext {
    ...
    public fun purchase<T0: store + key, T1: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x2::sui::SUI>) : (T0, 0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<T1>) {
        let v0 = storage_mut<T1>(arg0);
