module 0xdcddfb144105a42ff23844474a560836f4c16c883464fe77bfb761ca855d1810::DOUBLEUP {
    ...
    public entry fun GivePrize(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = PRIZE_TICKET{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/suiprize/suiprize_0628/prizeticket_0628_2.jpg"),
    ...
    fun init(arg0: DOUBLEUP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/suiprize/suiprize_0628/prizeticket_0628_2.jpg"));
