module 0xdc38a0eaed421a8b334046ddeafe99d12d3922afc80772fadf5218cad8a95750::evosgenesisegg {
    ...
    public entry fun public_mint(arg0: &mut MintTracker, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::put<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::take<0x2::sui::SUI>(0x2::coin::balance_mut<0x2::sui::SUI>(&mut arg1), arg0.sui_full_price, arg4));
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) == 0x2::balance::value<0x2::sui::SUI>(&arg0.balance) + v0, 8);
