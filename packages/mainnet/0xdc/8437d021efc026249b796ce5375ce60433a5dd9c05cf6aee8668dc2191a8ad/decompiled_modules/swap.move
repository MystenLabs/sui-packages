module 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap {
    ...
    public entry fun withdraw_fee<T0, T1>(arg0: &mut Dex_Info, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::utils::sort_token_type<T0, T1>()) {
            ...
            let v3 = 0x2::balance::value<LSP<T0, T1>>(&v2.fee_amount);
            if (v3 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<LSP<T0, T1>>>(0x2::coin::from_balance<LSP<T0, T1>>(0x2::balance::split<LSP<T0, T1>>(&mut v2.fee_amount, v3), arg1), v1);
            };
            let v4 = 0x2::balance::value<T0>(&v2.fee_x);
            if (v4 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v2.fee_x, v4), arg1), v1);
            };
            let v5 = 0x2::balance::value<T1>(&v2.fee_y);
            if (v5 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v2.fee_y, v5), arg1), v1);
            };
        } else {
            let v6 = get_pool<T1, T0>(arg0);
            let v7 = 0x2::balance::value<LSP<T1, T0>>(&v6.fee_amount);
            if (v7 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<LSP<T1, T0>>>(0x2::coin::from_balance<LSP<T1, T0>>(0x2::balance::split<LSP<T1, T0>>(&mut v6.fee_amount, v7), arg1), v1);
            };
            let v8 = 0x2::balance::value<T1>(&v6.fee_x);
            if (v8 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v6.fee_x, v8), arg1), v1);
            };
            let v9 = 0x2::balance::value<T0>(&v6.fee_y);
            if (v9 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v6.fee_y, v9), arg1), v1);
            };
        };
    }

    public entry fun withdraw_fee_<T0, T1>(arg0: u64, arg1: &mut Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == @0x9c8c8293866415a0b631a87e7b2ff960c65c9a497945df83827dfacb69627123 || v0 == @0x97a745334d470988140336826a83ec47a44714635e376ca705bbf10381223213 || v0 == @0x5e99f037c9dc2158925d8db3f5331d8d16024ec650ee2b870cc432af5e2231bd || v0 == @0x95d659964cdf8f4740d1c3be1404b789543fb69629e53ec63c97cbab394325c1 || v0 == @0xa67511f039c3f45a1c716460a2f496f113bdb896ac2b10d007245d8ab6b5930b, 999);
        let v1 = 0x2::balance::supply_value<LSP<T0, T1>>(&arg1.lsp_supply);
        let v2 = (((0x2::balance::value<T0>(&arg1.token_x) as u128) * (arg0 as u128) / (v1 as u128)) as u64);
        let v3 = (((0x2::balance::value<T1>(&arg1.token_y) as u128) * (arg0 as u128) / (v1 as u128)) as u64);
        assert!(v2 > 0 && v3 > 0, 10);
        let v4 = 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.token_x, v2), arg2);
        let v5 = 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.token_y, v3), arg2);
        let v6 = 0x2::balance::value<T0>(&arg1.token_x);
        let v7 = 0x2::balance::value<T1>(&arg1.token_y);
        update<T0, T1>(v6, v7, arg1);
        arg1.k_last = (arg1.reserve_x as u128) * (arg1.reserve_y as u128);
