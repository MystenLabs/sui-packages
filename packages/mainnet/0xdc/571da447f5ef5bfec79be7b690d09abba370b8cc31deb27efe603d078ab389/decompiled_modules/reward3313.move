module 0xdc571da447f5ef5bfec79be7b690d09abba370b8cc31deb27efe603d078ab389::reward3313 {
    struct REWARD3313 has drop {
        dummy_field: bool,
    }

    struct TICKET_3313 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3313(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3313>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3313>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3313, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3313>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3313>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3313>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3313>>(v5, 0x2::tx_context::sender(arg1));
    }
