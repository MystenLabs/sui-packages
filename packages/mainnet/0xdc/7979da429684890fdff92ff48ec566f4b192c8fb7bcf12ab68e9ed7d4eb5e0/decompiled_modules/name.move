module 0xdc7979da429684890fdff92ff48ec566f4b192c8fb7bcf12ab68e9ed7d4eb5e0::name {
    ...
    public fun app(arg0: &Name) : &0x1::string::String {
        assert!(0x1::vector::length<0x1::string::String>(&arg0.app) == 1, 2);
    ...
    fun symbol_to_tld(arg0: &0x1::string::String) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"@");
        assert!(arg0 == &v0, 3);
        0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::constants::sui_tld()
    }
    ...
    public fun to_string(arg0: &Name) : 0x1::string::String {
        ...
        while (!0x1::vector::is_empty<0x1::string::String>(&v3)) {
            v4 = v4 - 1;
            0x1::string::append(&mut v0, 0x1::vector::pop_back<0x1::string::String>(&mut v3));
            if (v4 > 0) {
                0x1::string::append(&mut v0, 0x1::string::utf8(b"."));
            };
        };
