module 0xdc53100c108052a8c6547b93c806b4e3b9c489a7b90dc43d05360a8fa1bbc8b4::reward1897 {
    struct REWARD1897 has drop {
        dummy_field: bool,
    }

    struct TICKET_1897 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1897(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1897>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1897>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1897, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1897>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1897>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1897>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1897>>(v5, 0x2::tx_context::sender(arg1));
    }
