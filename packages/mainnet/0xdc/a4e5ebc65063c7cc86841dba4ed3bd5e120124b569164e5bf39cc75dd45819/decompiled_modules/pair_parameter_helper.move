module 0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::pair_parameter_helper {
    ...
    public fun get_base_fee(arg0: &PairParameters, arg1: u64) : u64 {
        ...
        let v1 = 0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::mul_u64((arg0.fee_scheduler_reduction_factor as u64), v0);
        if (v1 >= arg0.cliff_fee_numerator) {
            return 0
        };
        0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::sub_u64(arg0.cliff_fee_numerator, v1)
    }
    ...
    public fun get_current_number_period(arg0: &PairParameters, arg1: u64) : u64 {
        ...
        0x1::u64::min(0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::sub_u64(arg1, arg0.activation_timestamp) / arg0.period_frequency, (arg0.number_of_period as u64))
    }
    ...
    public fun get_total_fee_rate(arg0: &PairParameters, arg1: u16, arg2: u64) : u64 {
        0x1::u64::min(0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::add_u64(get_base_fee(arg0, arg2), get_variable_fee(arg0, arg1)), 0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::constants::max_fee_rate())
    }

    public fun get_total_fee_rate_legacy(arg0: &PairParameters, arg1: u16) : u64 {
        0x1::u64::min(0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::add_u64(0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::mul_u64((arg0.base_factor as u64), (arg1 as u64)), get_variable_fee(arg0, arg1)), 0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::constants::max_fee_rate())
    }
    ...
    public fun get_variable_fee(arg0: &PairParameters, arg1: u16) : u64 {
        ...
        if (v0 != 0) {
            let v2 = 0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::mul_u64((arg0.volatility_accumulator as u64), (arg1 as u64));
            (0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::mul_u64(0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::mul_u64(v2, v2), v0) + 99) / 100
        } else {
            0
        }
    }
    ...
    public(friend) fun update_volatility_accumulator(arg0: &mut PairParameters, arg1: u32) {
        arg0.volatility_accumulator = 0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::u64_to_u32(0x1::u64::min(0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::add_u64((arg0.volatility_reference as u64), 0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::mul_u64((0x1::u32::diff(arg1, arg0.id_reference) as u64), 10)), (arg0.max_volatility_accumulator as u64)));
    }
    ...
    public(friend) fun update_volatility_reference(arg0: &mut PairParameters) {
        arg0.volatility_reference = 0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::u64_to_u32(0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::safe_math::mul_div_u64((arg0.volatility_accumulator as u64), (arg0.reduction_factor as u64), 0xdca4e5ebc65063c7cc86841dba4ed3bd5e120124b569164e5bf39cc75dd45819::constants::basis_point_max()));
    }
