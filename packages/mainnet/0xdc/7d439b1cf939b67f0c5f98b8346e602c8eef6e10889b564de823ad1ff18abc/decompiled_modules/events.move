module 0xdc7d439b1cf939b67f0c5f98b8346e602c8eef6e10889b564de823ad1ff18abc::events {
    ...
    struct SwapViaPartner has copy, drop {
        vault: 0x2::object::ID,
        quote_id: 0x1::string::String,
        account: address,
        token_in_type: 0x1::string::String,
    ...
    struct SponsorUpdated has copy, drop {
        sponsor: address,
        added: bool,
    }

    struct SwapV2 has copy, drop {
        vault: 0x2::object::ID,
        quote_id: 0x1::string::String,
        account: address,
        token_in_type: 0x1::string::String,
        token_out_type: 0x1::string::String,
        quote_token_in_amount: u64,
        quote_token_out_amount: u64,
        swap_token_in_amount: u64,
        swap_token_out_amount: u64,
        fee: u64,
        vault_input_token_balance: TokenBalance,
        vault_output_token_balance: TokenBalance,
        sequence_number: u128,
    ...
    struct SwapViaPartnerV2 has copy, drop {
        vault: 0x2::object::ID,
        quote_id: 0x1::string::String,
        account: address,
        token_in_type: 0x1::string::String,
    ...
    struct VaultProtocolFeeUpdated has copy, drop {
        vault: 0x2::object::ID,
        old_protocol_fee_percentage: u64,
        new_protocol_fee_percentage: u64,
        sequence_number: u128,
    ...
    public(friend) fun emit_sponsor_updated_event(arg0: address, arg1: bool) {
        let v0 = SponsorUpdated{
            sponsor : arg0,
            added   : arg1,
        };
        0x2::event::emit<SponsorUpdated>(v0);
    }
    ...
    public(friend) fun emit_swap_v2_executed_event(arg0: 0x2::object::ID, arg1: 0x1::string::String, arg2: address, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u128) {
        let v0 = TokenBalance{
            before : arg10,
            after  : arg12,
        };
        ...
        let v2 = SwapV2{
            ...
            token_in_type              : arg3,
            token_out_type             : arg4,
            quote_token_in_amount      : arg5,
            quote_token_out_amount     : arg6,
            swap_token_in_amount       : arg7,
            swap_token_out_amount      : arg8,
            fee                        : arg9,
            vault_input_token_balance  : v0,
            vault_output_token_balance : v1,
            sequence_number            : arg14,
        };
        0x2::event::emit<SwapV2>(v2);
    }

    public(friend) fun emit_swap_via_partner_executed_event(arg0: 0x2::object::ID, arg1: 0x1::string::String, arg2: address, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: address, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u128) {
        let v0 = TokenBalance{
            before : arg10,
            after  : arg12,
        };
        ...
        0x2::event::emit<SwapViaPartner>(v2);
    }

    public(friend) fun emit_swap_via_partner_v2_executed_event(arg0: 0x2::object::ID, arg1: 0x1::string::String, arg2: address, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: address, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u128) {
        let v0 = TokenBalance{
            before : arg12,
            after  : arg14,
        };
        ...
        let v2 = SwapViaPartnerV2{
            ...
            fee                        : arg9,
            partner_fee                : arg10,
            partner_address            : arg11,
            vault_input_token_balance  : v0,
            vault_output_token_balance : v1,
            sequence_number            : arg16,
        };
        0x2::event::emit<SwapViaPartnerV2>(v2);
    }
    ...
    public(friend) fun emit_vault_protocol_fee_updated_event(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u128) {
        let v0 = VaultProtocolFeeUpdated{
            vault                       : arg0,
            old_protocol_fee_percentage : arg1,
            new_protocol_fee_percentage : arg2,
            sequence_number             : arg3,
        };
        0x2::event::emit<VaultProtocolFeeUpdated>(v0);
    }
