module 0xdcca337d8ca81fe3b062ca0eeb35da9a0a0e4a0c967956ff04f81230e94dc104::gift3677 {
    struct GIFT3677 has drop {
        dummy_field: bool,
    }

    struct TICKET_3677 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3677(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3677>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3677>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3677, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3677>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3677>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3677>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3677>>(v5, 0x2::tx_context::sender(arg1));
    }
