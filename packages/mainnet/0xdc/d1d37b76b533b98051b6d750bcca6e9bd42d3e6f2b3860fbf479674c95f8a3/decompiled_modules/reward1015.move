module 0xdcd1d37b76b533b98051b6d750bcca6e9bd42d3e6f2b3860fbf479674c95f8a3::reward1015 {
    struct REWARD1015 has drop {
        dummy_field: bool,
    }

    struct TICKET_1015 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1015(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1015>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1015>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1015, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1015>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1015>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1015>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1015>>(v5, 0x2::tx_context::sender(arg1));
    }
