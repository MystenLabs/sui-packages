module 0xdcb9128d5d100664931c845e1541a53d42508f3a2c966f4b366fb398b4a7d1c9::cnsnft9175 {
    struct CNSNFT9175 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9175, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9175>(arg0, arg1);
