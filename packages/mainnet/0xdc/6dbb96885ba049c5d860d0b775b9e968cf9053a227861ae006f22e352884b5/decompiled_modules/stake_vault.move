module 0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::stake_vault {
    ...
    struct RebateAccountingAnomaly has copy, drop {
        vault: 0x2::object::ID,
        depositor: address,
        shortfall: u128,
    }
    ...
    fun accrue_on(arg0: &mut Position, arg1: u128, arg2: u64) : u128 {
        let v0 = (arg2 as u128) * arg1 / 1000000000000;
        let v1 = if (v0 < arg0.rebate_debt) {
            arg0.rebate_debt - v0
        } else {
            0
        };
        ...
        arg0.pending = arg0.pending + (v2 as u64);
        arg0.rebate_debt = v0;
        v1
    }
    ...
    public fun claim_rebate(arg0: &mut StakeVault, arg1: &0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::account::SocialAccount, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v3 = accrue_on(v2, v1, eligible_of(arg0, v0));
        let v4 = v2.pending;
        v2.pending = 0;
        report_anomaly(arg0, v0, v3);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.rebate_pool) >= v4, 8);
        let v5 = RebateClaimed{
            vault     : 0x2::object::id<StakeVault>(arg0),
            depositor : v0,
            amount    : v4,
        };
        0x2::event::emit<RebateClaimed>(v5);
        0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.rebate_pool, v4), arg2)
    }
    ...
    public fun deposit(arg0: &0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::platform::Platform, arg1: &mut StakeVault, arg2: &0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::account::SocialAccount, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = accrue_on(v4, v2, eligible_of(arg1, v0));
        v4.principal = v4.principal + v1;
        report_anomaly(arg1, v0, v5);
        note_fresh(arg1, v0, v1, v2);
        let v6 = 0x2::table::borrow_mut<address, Position>(&mut arg1.positions, v0);
        resync_debt_on(v6, v2, eligible_of(arg1, v0));
    ...
    public fun harvest(arg0: &mut StakeVault, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x2::balance::value<0x2::sui::SUI>(&arg0.creator_yield) - v0 + 0x2::balance::value<0x2::sui::SUI>(&arg0.platform_yield) - v1 + 0x2::balance::value<0x2::sui::SUI>(&arg0.rebate_pool) - v2;
        if (v6 > 0 || v5 > 0) {
    ...
    fun report_anomaly(arg0: &StakeVault, arg1: address, arg2: u128) {
        if (arg2 == 0) {
            return
        };
        let v0 = RebateAccountingAnomaly{
            vault     : 0x2::object::id<StakeVault>(arg0),
            depositor : arg1,
            shortfall : arg2,
        };
        0x2::event::emit<RebateAccountingAnomaly>(v0);
    }
    ...
    fun shrink_fresh(arg0: &mut StakeVault, arg1: address, arg2: u64) {
        let v0 = Fresh{who: arg1};
        if (!0x2::dynamic_field::exists<Fresh>(&arg0.id, v0)) {
            return
        };
        ...
        let v4 = FreshEntry{
            at_harvest : v2.at_harvest,
            amount     : arg2,
            debt_delta : v2.debt_delta * (arg2 as u128) / (v2.amount as u128),
        };
        let v5 = Fresh{who: arg1};
        *0x2::dynamic_field::borrow_mut<Fresh, FreshEntry>(&mut arg0.id, v5) = v4;
        let v6 = FreshTotal{dummy_field: false};
        if (!0x2::dynamic_field::exists<FreshTotal>(&arg0.id, v6)) {
            return
        };
        let v7 = FreshTotal{dummy_field: false};
        let v8 = *0x2::dynamic_field::borrow<FreshTotal, FreshEntry>(&arg0.id, v7);
        if (v8.at_harvest != arg0.harvests) {
            return
        };
        let v9 = if (v8.amount > v3) {
            v8.amount - v3
        } else {
            0
        };
        let v10 = FreshEntry{
            at_harvest : v8.at_harvest,
            amount     : v9,
            debt_delta : 0,
        };
        let v11 = FreshTotal{dummy_field: false};
        *0x2::dynamic_field::borrow_mut<FreshTotal, FreshEntry>(&mut arg0.id, v11) = v10;
    }
    ...
    public fun withdraw(arg0: &mut StakeVault, arg1: &0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::account::SocialAccount, arg2: u64, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v1 = arg0.acc_rebate_per_unit;
        settle_fresh(arg0, v0);
        let v2 = eligible_of(arg0, v0);
        let v3 = 0x2::table::borrow_mut<address, Position>(&mut arg0.positions, v0);
        let v4 = accrue_on(v3, v1, v2);
        assert!(v3.principal >= arg2, 7);
        report_anomaly(arg0, v0, v4);
        let v5 = 0;
        while (0x2::balance::value<0x2::sui::SUI>(&arg0.liquid) < arg2) {
            ...
            let (v6, v7) = 0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::stake_ladder::unwind_newest(&mut arg0.tranches, arg3, arg4);
            v5 = v5 + 1;
            credit_proceeds(arg0, v6, v7);
        };
        let v8 = arg0.acc_rebate_per_unit;
        let v9 = 0x2::table::borrow_mut<address, Position>(&mut arg0.positions, v0);
        report_anomaly(arg0, v0, accrue_on(v9, v8, v2));
        let v10 = 0x2::table::borrow_mut<address, Position>(&mut arg0.positions, v0);
        v10.principal = v10.principal - arg2;
        shrink_fresh(arg0, v0, v10.principal);
        let v11 = 0x2::table::borrow_mut<address, Position>(&mut arg0.positions, v0);
        resync_debt_on(v11, v8, eligible_of(arg0, v0));
