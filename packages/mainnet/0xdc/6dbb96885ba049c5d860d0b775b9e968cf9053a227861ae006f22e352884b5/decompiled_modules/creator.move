module 0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::creator {
    ...
    public fun add_tier<T0>(arg0: &mut CreatorVault<T0>, arg1: &CreatorCap, arg2: 0x1::string::String, arg3: u64, arg4: u64) {
        ...
        let v0 = 0x1::vector::length<Tier>(&arg0.tiers);
        if (v0 > 0) {
            assert!(arg3 > 0x1::vector::borrow<Tier>(&arg0.tiers, v0 - 1).price, 19);
        };
        let v1 = Tier{
            name      : arg2,
            price     : arg3,
        ...
        0x1::vector::push_back<Tier>(&mut arg0.tiers, v1);
        let v2 = TiersUpdated{
            vault      : 0x2::object::id<CreatorVault<T0>>(arg0),
            tier_count : 0x1::vector::length<Tier>(&arg0.tiers),
        };
        0x2::event::emit<TiersUpdated>(v2);
    }
    ...
    public fun migrate_as_platform<T0>(arg0: &mut CreatorVault<T0>, arg1: &0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::platform::Platform, arg2: &0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::platform::PlatformCap) {
    ...
    public fun renew<T0>(arg0: &0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::platform::Platform, arg1: &mut CreatorVault<T0>, arg2: &0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::account::SocialAccount, arg3: &mut 0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::entitlement::Subscription, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::entitlement::subscriber(arg3) == v0, 20);
    ...
    entry fun seal_approve_subscription<T0>(arg0: vector<u8>, arg1: u64, arg2: u64, arg3: &CreatorVault<T0>, arg4: &0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::entitlement::Subscription, arg5: &0x2::tx_context::TxContext) {
        assert!(0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::entitlement::subscriber(arg4) == 0x2::tx_context::sender(arg5), 20);
        assert!(0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::entitlement::subscription_vault(arg4) == 0x2::object::id<CreatorVault<T0>>(arg3), 15);
        assert!(arg0 == 0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::entitlement::period_identity(0x2::object::id<CreatorVault<T0>>(arg3), arg1, arg2), 21);
        assert!(arg1 < 0x1::vector::length<Tier>(&arg3.tiers), 6);
        assert!(0x1::vector::borrow<Tier>(&arg3.tiers, arg1).price <= 0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::entitlement::subscription_price_paid(arg4), 22);
        assert!(0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::entitlement::covers_period(arg4, arg2), 23);
    }
    ...
    public fun update_tier<T0>(arg0: &mut CreatorVault<T0>, arg1: &CreatorCap, arg2: u64, arg3: u64, arg4: u64, arg5: bool) {
        ...
        assert!(arg4 % 0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::entitlement::seal_period_ms() == 0, 18);
        if (arg2 > 0) {
            assert!(arg3 > 0x1::vector::borrow<Tier>(&arg0.tiers, arg2 - 1).price, 19);
        };
        if (arg2 + 1 < v0) {
            assert!(arg3 < 0x1::vector::borrow<Tier>(&arg0.tiers, arg2 + 1).price, 19);
        };
        let v1 = 0x1::vector::borrow_mut<Tier>(&mut arg0.tiers, arg2);
        v1.price = arg3;
        v1.period_ms = arg4;
        v1.active = arg5;
        let v2 = TiersUpdated{
