module 0xdcf099a9b041c33eee0d9e4aa263271bb95801687f9a53464e3d15a114e6bf7b::cnsnft5164 {
    struct CNSNFT5164 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5164, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1800"));
        let v4 = 0x2::package::claim<CNSNFT5164>(arg0, arg1);
