module 0xdcf28b5e5be82d16c0b5b6a2cbb9afd6b4f2428bffc243b04d2b68e2c592833c::STORE {
    ...
    public entry fun buy_nft_entry<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg4: 0x2::object::ID, arg5: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg7: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = v5;
        0x2::kiosk::place<T0>(arg2, &v7, v0);
        let v8 = 0x2::transfer_policy::new_request<T0>(arg4, 0, 0x2::object::id<0x2::kiosk::Kiosk>(arg2));
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T0>(&mut v8, arg2);
        let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg6, v8);
        let v12 = 0;
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Rule>(arg6)) {
            let v13 = 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<T0>(arg6, v2);
            assert!(0x2::coin::value<0x2::sui::SUI>(arg7) >= v13, 4);
            if (v13 > 0) {
                0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg6, &mut v4, 0x2::coin::split<0x2::sui::SUI>(arg7, v13, arg8));
                v12 = v13;
            };
        };
        ...
        0x2::event::emit<NFTPurchased>(v17);
    }
