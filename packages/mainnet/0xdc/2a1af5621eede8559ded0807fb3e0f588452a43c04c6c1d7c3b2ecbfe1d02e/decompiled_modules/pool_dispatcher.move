module 0xdc2a1af5621eede8559ded0807fb3e0f588452a43c04c6c1d7c3b2ecbfe1d02e::pool_dispatcher {
    ...
    public(friend) fun default(arg0: &mut 0x2::tx_context::TxContext) : PoolDispatcher {
        ...
        0x2::bag::add<0x1::string::String, address>(&mut v0.pools, 0x1::string::utf8(b"liquidity"), @0xd647cadb203e0aa3edbf6143b17d6ac0d9e27ec2a1c284e79eef1917b0e8e318);
        v0
    }
