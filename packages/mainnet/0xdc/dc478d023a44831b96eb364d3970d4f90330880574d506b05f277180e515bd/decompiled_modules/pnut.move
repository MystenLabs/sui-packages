module 0xdcdc478d023a44831b96eb364d3970d4f90330880574d506b05f277180e515bd::pnut {
    ...
    fun init(arg0: PNUT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/2qEHjDLDLbuBgRYvsxhc5D6uDWAivNFZGan56P1tpump.png?size=lg&key=534813                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<PNUT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Pnut    ")))), trim_right(b"Peanut the Squirrel             "), trim_right(b"Peanut the Squirrel - AKA PNut - captured the hearts of millions on social media before he was wrongfully taken and euthanised by the NYDEC.                                                                                                                                                                                    "), v2, arg1);
        let v5 = v3;
