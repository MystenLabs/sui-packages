module 0xdcd191465c256b584e493dd27d80b472bc8de4a46bb8e11418df4c6063ee5eaa::verify_ir {
    public(friend) fun verify_and_extract_payload(arg0: vector<u8>, arg1: vector<u8>, arg2: u8) : vector<u8> {
        ...
        let v6 = x"000000000000000000000000fae2e1621a859896adec29d4d00bb3b5fde2dbd5";
        let v7 = 12;
        while (v7 < 32) {
