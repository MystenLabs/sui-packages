module 0xdca282f30ff2acc0083c5c90969ae97c59a638a6a50ab9112f7ea17507cdd2b7::voxx__inc_ {
    ...
    fun init(arg0: VOXX__INC_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<VOXX__INC_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Voxx, inc."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://Cw1zoXklvpjqj6SzsUB7ld_slj9CVVwicxXQ1won7jE"));
