module 0xdc4b575922328dd50289f0a1c66e62fb09a3f799b3a0cd809312bbe538ce196e::cnsnft9206 {
    struct CNSNFT9206 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9206, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9206>(arg0, arg1);
