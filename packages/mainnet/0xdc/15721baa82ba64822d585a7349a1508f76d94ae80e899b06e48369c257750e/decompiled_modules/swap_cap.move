module 0xdc15721baa82ba64822d585a7349a1508f76d94ae80e899b06e48369c257750e::swap_cap {
    ...
    fun transfer_router_fee<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: RouterFeeMetadata, arg2: &mut 0x2::tx_context::TxContext) {
        if (arg1.recipient != @0x0 && arg1.fee != 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg0, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_by_fraction(0x2::coin::value<T0>(arg0), arg1.fee), arg2), arg1.recipient);
        };
    }
