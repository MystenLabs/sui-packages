module 0xdc1555ea82a826b268fc3f662f0ffff684a1fc3746c49b7e5193056593b4bbc2::reward8104 {
    struct REWARD8104 has drop {
        dummy_field: bool,
    }

    struct TICKET_8104 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8104(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8104>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8104>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8104, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8104>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8104>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8104>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8104>>(v5, 0x2::tx_context::sender(arg1));
    }
