module 0xdcddb40f038e7446fab8def3f874e7f37b35f9a5f81a5e77ce88b6759d93dfed::cnsnft2145 {
    struct CNSNFT2145 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2145, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2145>(arg0, arg1);
