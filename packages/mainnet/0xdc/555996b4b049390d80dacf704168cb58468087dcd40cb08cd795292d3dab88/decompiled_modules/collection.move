module 0xdc555996b4b049390d80dacf704168cb58468087dcd40cb08cd795292d3dab88::collection {
    struct BabyBlubNft has store, key {
        id: 0x2::object::UID,
        name: 0x1::string::String,
        url: 0x1::string::String,
        attributes: 0xdc555996b4b049390d80dacf704168cb58468087dcd40cb08cd795292d3dab88::attributes::Attributes,
    ...
    public fun attributes(arg0: &BabyBlubNft) : 0xdc555996b4b049390d80dacf704168cb58468087dcd40cb08cd795292d3dab88::attributes::Attributes {
        arg0.attributes
    }
    ...
    public(friend) fun create(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: &mut vector<0x1::string::String>, arg3: &mut vector<0x1::string::String>) : BabyBlubNftData {
        BabyBlubNftData{
            name       : arg0,
            url        : arg1,
            attributes : 0xdc555996b4b049390d80dacf704168cb58468087dcd40cb08cd795292d3dab88::attributes::from_vec(arg2, arg3),
        }
    }
