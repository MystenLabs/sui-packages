module 0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault {
    ...
    public fun add_reward<T0, T1, T2, T3>(arg0: &mut Vault<T0, T1, T2>, arg1: 0x2::balance::Balance<T3>) {
        ...
        add_reward_internal<T0, T1, T2, T3>(arg0, arg1);
    }

    public(friend) fun add_reward_internal<T0, T1, T2, T3>(arg0: &mut Vault<T0, T1, T2>, arg1: 0x2::balance::Balance<T3>) {
    ...
    public fun assert_active<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) {
        assert!(is_active<T0, T1, T2>(arg0), 11);
    }

    public fun assert_finalized<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) {
        assert!(is_finalized<T0, T1, T2>(arg0), 13);
    }
    ...
    public fun assert_unwinding<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) {
        assert!(is_unwinding<T0, T1, T2>(arg0), 12);
    }

    public(friend) fun begin_wind_down<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>) {
        assert_active<T0, T1, T2>(arg0);
        *0x2::dynamic_field::borrow_mut<vector<u8>, bool>(&mut arg0.id, b"deposit_enabled") = false;
    ...
    public fun check_vault_cap_compatibility<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &VaultCap) {
        ...
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"vault_cap")) {
            assert!(*0x2::dynamic_field::borrow<vector<u8>, 0x2::object::ID>(&arg0.id, b"vault_cap") == 0x2::object::id<VaultCap>(arg1), 6);
        };
    }
    ...
    public(friend) fun clear_zero_reward<T0, T1, T2, T3>(arg0: &mut Vault<T0, T1, T2>) {
        0x2::balance::destroy_zero<T3>(get_reward_balance<T0, T1, T2, T3>(arg0));
    }
    ...
    public(friend) fun finalize_wind_down<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>) {
        ...
        assert!(!has_position<T0, T1, T2>(arg0), 14);
        assert!(rewards_empty<T0, T1, T2>(arg0), 15);
    ...
    public(friend) fun get_reward_balance<T0, T1, T2, T3>(arg0: &mut Vault<T0, T1, T2>) : 0x2::balance::Balance<T3> {
        0x2::bag::remove<0x1::ascii::String, 0x2::balance::Balance<T3>>(&mut arg0.rewards_bag, 0x1::type_name::into_string(0x1::type_name::get<T3>()))
    }
    ...
    public fun has_position<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : bool {
        0x2::dynamic_field::exists_with_type<vector<u8>, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&arg0.id, b"position")
    }

    public fun has_reward_balance<T0, T1, T2, T3>(arg0: &Vault<T0, T1, T2>) : bool {
        0x2::bag::contains_with_type<0x1::ascii::String, 0x2::balance::Balance<T3>>(&arg0.rewards_bag, 0x1::type_name::into_string(0x1::type_name::get<T3>()))
    }
    ...
    public fun is_active<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : bool {
        lifecycle_state<T0, T1, T2>(arg0) == 0
    }
    ...
    public fun is_finalized<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : bool {
        lifecycle_state<T0, T1, T2>(arg0) == 2
    }

    public fun is_unwinding<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : bool {
        lifecycle_state<T0, T1, T2>(arg0) == 1
    }
    ...
    public fun issue_vault_cap<T0, T1, T2>(arg0: &AdminCap, arg1: &Vault<T0, T1, T2>, arg2: &mut 0x2::tx_context::TxContext) {
        assert_active<T0, T1, T2>(arg1);
        let v0 = VaultCap{
    ...
    public fun lifecycle_state<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : u8 {
    ...
    public(friend) fun preview_finalized_share<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: u64) : (u64, u64) {
        assert_finalized<T0, T1, T2>(arg0);
        let v0 = total_supply<T0, T1, T2>(arg0);
        assert!(arg1 > 0 && arg1 <= v0, 16);
        (proportional_share(free_balance_a_val<T0, T1, T2>(arg0), arg1, v0), proportional_share(free_balance_b_val<T0, T1, T2>(arg0), arg1, v0))
    }
    ...
    public fun reward_balance_value<T0, T1, T2, T3>(arg0: &Vault<T0, T1, T2>) : u64 {
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T3>());
        if (0x2::bag::contains_with_type<0x1::ascii::String, 0x2::balance::Balance<T3>>(&arg0.rewards_bag, v0)) {
            0x2::balance::value<T3>(0x2::bag::borrow<0x1::ascii::String, 0x2::balance::Balance<T3>>(&arg0.rewards_bag, v0))
        } else {
            0
        }
    }

    public fun rewards_empty<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : bool {
        0x2::bag::is_empty(&arg0.rewards_bag)
    }
    ...
    public fun set_active_vault_cap<T0, T1, T2>(arg0: &AdminCap, arg1: &mut Vault<T0, T1, T2>, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert_active<T0, T1, T2>(arg1);
    ...
    public(friend) fun set_swap_route<T0, T1, T2, T3>(arg0: &mut Vault<T0, T1, T2>, arg1: vector<0x360802cb106b004205cd67a706e314eaeadd8590d5f4d1cee46137566232a627::bag_value::Value>, arg2: bool) {
        if (0x2::bag::contains<0x1::ascii::String>(&arg0.swap_routes, 0x1::type_name::into_string(0x1::type_name::get<T3>()))) {
            remove_swap_route<T0, T1, T2, T3>(arg0);
        };
        add_swap_route<T0, T1, T2, T3>(arg0, arg1, arg2);
    }
    ...
    public(friend) fun take_finalized_share<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: 0x2::coin::Coin<T2>) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, u64) {
        assert_finalized<T0, T1, T2>(arg0);
        let v0 = 0x2::coin::value<T2>(&arg1);
        let v1 = total_supply<T0, T1, T2>(arg0);
        assert!(v0 > 0 && v0 <= v1, 16);
        let v2 = proportional_share(free_balance_a_val<T0, T1, T2>(arg0), v0, v1);
        let v3 = proportional_share(free_balance_b_val<T0, T1, T2>(arg0), v0, v1);
        burn_vault_coin<T0, T1, T2>(arg0, arg1);
    ...
    public fun withdraw_fee_a<T0, T1, T2>(arg0: &AdminCap, arg1: &mut Vault<T0, T1, T2>, arg2: u64) : 0x2::balance::Balance<T0> {
        assert_active<T0, T1, T2>(arg1);
        0x2::balance::split<T0>(&mut arg1.fee_a, arg2)
    }

    public fun withdraw_fee_b<T0, T1, T2>(arg0: &AdminCap, arg1: &mut Vault<T0, T1, T2>, arg2: u64) : 0x2::balance::Balance<T1> {
        assert_active<T0, T1, T2>(arg1);
        0x2::balance::split<T1>(&mut arg1.fee_b, arg2)
    }
