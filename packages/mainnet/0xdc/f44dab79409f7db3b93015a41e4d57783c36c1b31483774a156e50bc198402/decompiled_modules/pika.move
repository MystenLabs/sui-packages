module 0xdcf44dab79409f7db3b93015a41e4d57783c36c1b31483774a156e50bc198402::pika {
    struct PIKA has drop {
        dummy_field: bool,
    }

    fun init(arg0: PIKA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PIKA>(arg0, 2, b"PIKA", b"PIKA", b"PIKA ON SUI", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/profile_images/1745737178116718592/pZpYFIUp_400x400.jpg")), arg1);
        let v2 = v0;
        let v3 = &mut v2;
