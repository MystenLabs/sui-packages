module 0xdcab0a22e7f96b4d709f49d7febc8d004ed1d5697ddb8a6265c8e29ba685f17e::cnsnft4939 {
    struct CNSNFT4939 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4939, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4939>(arg0, arg1);
