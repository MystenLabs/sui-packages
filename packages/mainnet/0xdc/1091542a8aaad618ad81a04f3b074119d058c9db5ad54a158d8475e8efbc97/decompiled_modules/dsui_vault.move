module 0xdc1091542a8aaad618ad81a04f3b074119d058c9db5ad54a158d8475e8efbc97::dsui_vault {
    struct DSuiVault has key {
        id: 0x2::object::UID,
        config_params: ConfigParams,
        dsui_kraft_cap: 0x2::coin::TreasuryCap<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI>,
    ...
    public fun admin_emergency_pause_update(arg0: &0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::yield_flow::DeployerCap, arg1: &mut DSuiVault, arg2: bool) {
    ...
    fun calculate_staked_sui_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &0x3::staking_pool::StakedSui, arg2: u64) : u64 {
        0xdc1091542a8aaad618ad81a04f3b074119d058c9db5ad54a158d8475e8efbc97::helper::calculate_rewards(arg0, 0x3::staking_pool::pool_id(arg1), 0x3::staking_pool::staked_sui_amount(arg1), 0x3::staking_pool::stake_activation_epoch(arg1), arg2)
    }
    ...
    public entry fun claim_collected_lsd_fee(arg0: &mut DSuiVault, arg1: &mut 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::yield_flow::YieldFlow, arg2: &mut 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::yield_flow::FeeCollector<0x2::sui::SUI>, arg3: &0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 9002);
        let v0 = 0x2::balance::value<0x2::sui::SUI>(&arg0.hive_fee_vault);
        let v1 = 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::math::mul_div_u128((v0 as u128), (arg0.config_params.treasury_percent as u128), (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::percent_precision() as u128));
        if (v1 > 0) {
            0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::yield_flow::add_to_treasury(arg1, 0x2::balance::split<0x2::sui::SUI>(&mut arg0.hive_fee_vault, v1));
        };
        0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::yield_flow::collect_fee_for_coin<0x2::sui::SUI>(arg2, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.hive_fee_vault));
    ...
    public fun emergency_pause_update(arg0: &0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::yield_flow::DragonDaoCapability, arg1: &mut DSuiVault, arg2: bool) {
        assert!(arg1.version == 0, 9002);
        arg1.config_params.pause_stake = arg2;
        let v0 = EmergencyPauseUpdate{pause_stake: arg1.config_params.pause_stake};
        0x2::event::emit<EmergencyPauseUpdate>(v0);
    ...
    public fun get_dsui_by_sui(arg0: &DSuiVault, arg1: u64) : u64 {
        ...
        (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::math::mul_div_u256((arg1 as u256), (arg0.dsui_supply as u256), (v0 as u256)) as u64)
    }
    ...
    fun get_split_amount(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &0x3::staking_pool::StakedSui, arg2: u64, arg3: u64) : (u64, u64, u64, u64) {
        ...
        let v1 = 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::lsd_exchange_rate_precision();
        ...
        let v4 = ((0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::math::mul_div_u256((v1 as u256) * (arg2 as u256), (v0 as u256), (v3 as u256)) / (v1 as u256)) as u64) + 1;
        let v5 = v0 - v4;
        if (v4 < 1000000000) {
    ...
    public fun get_sui_by_dsui(arg0: &DSuiVault, arg1: u64) : u64 {
        ...
        (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::math::mul_div_u256((v0 as u256), (arg1 as u256), (arg0.dsui_supply as u256)) as u64)
    }
    ...
    public fun get_sui_claimable_per_dsui(arg0: &DSuiVault) : u128 {
        ...
        if (v0 == 0 || v1 == 0) {
            return (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::lsd_exchange_rate_precision() as u128)
        };
        (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::math::mul_div_u256((v0 as u256), (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::lsd_exchange_rate_precision() as u256), (v1 as u256)) as u128)
    }
    ...
    public fun init_dsui_vault(arg0: 0x2::coin::TreasuryCap<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = ConfigParams{
            pause_stake           : false,
            protocol_fee_percent  : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::lsd_init_protocol_fee_percent(),
            service_fee_percent   : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::lsd_init_service_fee_percent(),
            unstake_delay_epoches : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::lsd_init_delay_epoches(),
            treasury_percent      : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::lsd_init_treasury_fee_percent(),
        };
        let v1 = DSuiVault{
            ...
            sui_claimable_per_dsui     : (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::lsd_exchange_rate_precision() as u128),
            version                    : 0,
        };
    ...
    public fun query_all_staked_sui_objs_for_pool(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &DSuiVault, arg2: address, arg3: 0x1::option::Option<u64>, arg4: u64, arg5: &0x2::tx_context::TxContext) : (vector<u64>, vector<u64>, vector<u64>, vector<u64>, u64) {
        ...
        while (0x1::option::is_some<u64>(&v6) && v7 < arg4) {
            ...
            0x1::vector::push_back<u64>(&mut v4, 0xdc1091542a8aaad618ad81a04f3b074119d058c9db5ad54a158d8475e8efbc97::helper::calculate_rewards(arg0, 0x3::staking_pool::pool_id(v9), v11, v10, 0x2::tx_context::epoch(arg5)));
    ...
    public fun query_request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut DSuiVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        let v1 = 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::percent_precision();
        let v2 = 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::math::mul_div_u128((v0 as u128), (arg1.config_params.service_fee_percent as u128), (v1 as u128));
        (v0 - v2, v2, 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::math::mul_div(v2, arg1.config_params.protocol_fee_percent, v1))
    }
    ...
    public fun query_staked_sui_obj_for_pool(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &DSuiVault, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        (v1, v2, 0xdc1091542a8aaad618ad81a04f3b074119d058c9db5ad54a158d8475e8efbc97::helper::calculate_rewards(arg0, 0x3::staking_pool::pool_id(v0), v2, v1, 0x2::tx_context::epoch(arg4)))
    }
    ...
    public fun request_delayed_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut DSuiVault, arg2: 0x2::balance::Balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI>, arg3: &mut 0x2::tx_context::TxContext) : UnstakeRequest {
        assert!(arg1.version == 0, 9002);
        let v0 = 0x2::tx_context::epoch(arg3);
        update_calculated_accrued_rewards(arg0, arg1, arg3);
        let v1 = get_sui_by_dsui(arg1, 0x2::balance::value<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI>(&arg2));
        ...
        let v4 = UnstakeRequest{
            ...
            dsui_amount        : 0x2::balance::value<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI>(&arg2),
            sui_amount         : v1,
            requested_at_epoch : v0,
        };
        0x2::coin::burn<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI>(&mut arg1.dsui_kraft_cap, 0x2::coin::from_balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI>(arg2, arg3));
        arg1.dsui_supply = 0x2::coin::total_supply<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI>(&arg1.dsui_kraft_cap);
    ...
    public fun request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut DSuiVault, arg2: 0x2::balance::Balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(arg1.version == 0, 9002);
        update_calculated_accrued_rewards(arg0, arg1, arg3);
        let v0 = get_sui_by_dsui(arg1, 0x2::balance::value<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI>(&arg2));
        ...
        let v2 = 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::percent_precision();
        let v3 = 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::math::mul_div_u128((v0 as u128), (arg1.config_params.service_fee_percent as u128), (v2 as u128));
        let v4 = 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::math::mul_div(v3, arg1.config_params.protocol_fee_percent, v2);
        ...
        let v7 = UserUnstakedInstantly{
            ...
            dsui_burnt             : 0x2::balance::value<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI>(&arg2),
    ...
    public fun stake_sui_request(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut DSuiVault, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI> {
        assert!(arg1.version == 0, 9002);
        ...
        0x2::coin::mint_balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::dsui::DSUI>(&mut arg1.dsui_kraft_cap, v1)
    }
    ...
    public fun update_calculated_accrued_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut DSuiVault, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::math::mul_div_u256((v2 as u256), (arg1.config_params.protocol_fee_percent as u256), (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::percent_precision() as u256)) as u64);
    ...
    public fun update_dsui_fee_config(arg0: &0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::yield_flow::DragonDaoCapability, arg1: &mut DSuiVault, arg2: u64, arg3: u64, arg4: u64) {
        assert!(arg1.version == 0, 9002);
        let v0 = if (arg2 < 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::lsd_max_protocol_fee_percent()) {
            if (arg3 < 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::lsd_max_service_fee_percent()) {
                arg4 < 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::lsd_max_treasury_fee_percent()
            } else {
                false
            }
        } else {
    ...
    public fun update_validator_list(arg0: &0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::yield_flow::DragonDaoCapability, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut DSuiVault, arg3: vector<address>, arg4: bool) {
        ...
        assert!(0x1::vector::length<address>(&arg2.whitelisted_validators) < 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::max_whitelisted_validators_allowed(), 9009);
