module 0x93b620b0a4b80f0c366f74a5de620e0d89a92e9dff87a4c109b4d1f3bcd51b63::susn {
    ...
    fun init(arg0: SUSN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v1;
        0x2::coin::mint_and_transfer<SUSN>(&mut v3, 5000000 * 0x1::u64::pow(10, v0), 0x2::tx_context::sender(arg1), arg1);
        let v4 = Treasury{
