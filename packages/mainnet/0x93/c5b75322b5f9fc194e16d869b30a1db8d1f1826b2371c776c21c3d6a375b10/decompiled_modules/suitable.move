module 0x93c5b75322b5f9fc194e16d869b30a1db8d1f1826b2371c776c21c3d6a375b10::suitable {
    ...
    fun init(arg0: SUITABLE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUITABLE>(arg0, 9, b"TABLE", b"SUITABLE", b"The most suiTable Table on SUI TG: https://t.me/tablesui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://pbs.twimg.com/profile_images/1745560370759032832/1jSbZLwY_400x400.jpg"))), arg1);
