module 0x9345f12e2ba844004323ea8c3adb1697228cc3a8c60dcb9e19765f085adc3e40::the_real_mack_family_collection_ {
    struct THE_REAL_MACK_FAMILY_COLLECTION_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: THE_REAL_MACK_FAMILY_COLLECTION_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<THE_REAL_MACK_FAMILY_COLLECTION_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"The Real Mack Family Collection "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is all the Mack Family's Digital Art Collection."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeih35e3ac5fnfy752oixippzliwthy5bwpbpuyfz3aa2uauc6hp67u"));
