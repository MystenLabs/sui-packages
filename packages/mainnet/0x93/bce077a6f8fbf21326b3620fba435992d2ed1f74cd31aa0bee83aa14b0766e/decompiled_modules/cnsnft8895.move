module 0x93bce077a6f8fbf21326b3620fba435992d2ed1f74cd31aa0bee83aa14b0766e::cnsnft8895 {
    struct CNSNFT8895 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8895, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8895>(arg0, arg1);
