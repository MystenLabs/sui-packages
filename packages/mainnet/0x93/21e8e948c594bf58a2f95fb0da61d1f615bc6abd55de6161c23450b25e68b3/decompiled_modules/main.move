module 0x9321e8e948c594bf58a2f95fb0da61d1f615bc6abd55de6161c23450b25e68b3::main {
    ...
    public(friend) fun remove_position<T0, T1>(arg0: &Farm<T0, T1>, arg1: 0x9321e8e948c594bf58a2f95fb0da61d1f615bc6abd55de6161c23450b25e68b3::position::Position, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg3: &0x2::tx_context::TxContext) {
        let (_, v1, v2, v3) = 0x9321e8e948c594bf58a2f95fb0da61d1f615bc6abd55de6161c23450b25e68b3::position::info(&arg1);
        assert!(v1 == 0, 117);
        assert!(v2 == 0, 118);
        assert!(v3 == 0, 119);
        assert!(0x9321e8e948c594bf58a2f95fb0da61d1f615bc6abd55de6161c23450b25e68b3::utils::safe_get_collateral_amount<T0>(arg2) == 0, 120);
        assert!(0x9321e8e948c594bf58a2f95fb0da61d1f615bc6abd55de6161c23450b25e68b3::utils::safe_get_debt_amount<T1>(arg2) == 0, 121);
