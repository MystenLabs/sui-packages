module 0x93cb9fe57be66c4e988df10f97c27f7eb4667cbbb4e24239e5cbee1d22055f31::m {
    ...
    fun stt<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &mut 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg4: &0x2::clock::Clock, arg5: u64, arg6: u128, arg7: bool, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let v2 = arg8 != arg7;
        let v3 = csr<T0, T1, T2>(arg0, v2, true, arg5, arg6, arg8);
        ...
        assert!(v21 >= v22, 13906837258129965058);
        let (v23, v24) = if (v2) {
        ...
        0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::dp<T0>(arg1, arg2, v26, arg9);
        0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::dp<T1>(arg1, arg2, v25, arg9);
        (v20, v21)
    }

    public fun sttb<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: &mut 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg4: &0x2::clock::Clock, arg5: vector<u64>, arg6: vector<u128>, arg7: vector<u64>, arg8: vector<u128>, arg9: bool, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg9) {
        ...
        while (v4 < 0x1::vector::length<u64>(&arg5)) {
            ...
            let (v7, v8) = stt<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, v6, *0x1::vector::borrow<u128>(&arg6, v4), true, arg9, arg10);
            if (v7 == 0 || v8 == 0) {
                break
            };
            v1 = v1 - v7;
        ...
        while (v4 < 0x1::vector::length<u64>(&arg7)) {
            ...
            let (v11, v12) = stt<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, v10, *0x1::vector::borrow<u128>(&arg8, v4), false, arg9, arg10);
            if (v11 == 0 || v12 == 0) {
                break
            };
            v3 = v3 - v11;
