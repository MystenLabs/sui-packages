module 0x938fc2394df9bb6468d68a9a44a439b9898c019c4616ef6926ab51b65f31440e::cnsnft7438 {
    struct CNSNFT7438 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7438, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3607"));
        let v4 = 0x2::package::claim<CNSNFT7438>(arg0, arg1);
