module 0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::go_live {
    struct AddLiquidityHook has drop {
        dummy_field: bool,
    }

    public fun go_live<T0, T1>(arg0: &mut 0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::index::Registry, arg1: &0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::admin::Admin, arg2: 0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::seed_pool::SeedPool<0x2::sui::SUI, T0>, arg3: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: 0x2::coin::TreasuryCap<T1>, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg9);
        go_live_<0x2::sui::SUI, T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::vesting::new_config(v0, v0 + arg7, v0 + arg7 + arg8), arg9, arg10);
    }

    public fun go_live_<T0, T1, T2>(arg0: &mut 0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::index::Registry, arg1: &0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::admin::Admin, arg2: 0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::seed_pool::SeedPool<T0, T1>, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::coin::CoinMetadata<T1>, arg5: &0x2::coin::CoinMetadata<T2>, arg6: 0x2::coin::TreasuryCap<T2>, arg7: 0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::vesting::VestingConfig, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3, v4, v5, v6, v7, _, v9, v10) = 0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::seed_pool::destroy_pool<T0, T1>(arg2);
        let v11 = v9;
        let v12 = v4;
        let v13 = v1;
        let v14 = v0;
        ...
        assert!(v15 == 0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::utils::mist(0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::seed_pool::gamma_s(&v11)), 2);
        ...
        let v33 = 0x2::object::id<0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::staking_pool::StakingPool<T0, T1, T2>>(&v30);
        let v34 = 0x2::object::id_to_address(&v33);
        0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::index::add_interest_pool<T0, T1>(arg0, v32);
        0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::index::add_staking_pool<T0, T1>(arg0, v34);
        0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::events::go_live<T0, T1, T2>(v32, v34);
        ...
        0x2::transfer::public_share_object<0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::staking_pool::StakingPool<T0, T1, T2>>(v30);
    ...
    public fun go_live_default<T0, T1>(arg0: &mut 0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::index::Registry, arg1: &0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::admin::Admin, arg2: 0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::seed_pool::SeedPool<0x2::sui::SUI, T0>, arg3: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: 0x2::coin::TreasuryCap<T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        go_live_<0x2::sui::SUI, T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0x93537cb97c2fb2d355e7c948675be1edafdfcf56ec961bebfd0afb246e19c730::vesting::default_config(arg7), arg7, arg8);
    }
