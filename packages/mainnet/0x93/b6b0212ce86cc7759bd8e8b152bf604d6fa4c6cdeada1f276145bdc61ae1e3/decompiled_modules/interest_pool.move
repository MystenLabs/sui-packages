module 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::interest_pool {
    ...
    public(friend) fun new<T0>(arg0: 0x2::vec_set::VecSet<0x1::type_name::TypeName>, arg1: 0x2::versioned::Versioned, arg2: &mut 0x2::tx_context::TxContext) : (InterestPool<T0>, 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::pool_admin::PoolAdmin) {
        0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::curves::assert_curve<T0>();
        let v0 = 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::pool_admin::new(arg2);
        let v1 = InterestPool<T0>{
            id                 : 0x2::object::new(arg2),
            coins              : arg0,
            state              : arg1,
            pool_admin_address : 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::pool_admin::addy(&v0),
            hooks              : 0x1::option::none<Hooks>(),
        };
        (v1, v0)
    }

    public fun add_liquidity_hook<T0>(arg0: &InterestPool<T0>) : (vector<0x1::type_name::TypeName>, vector<0x1::type_name::TypeName>) {
    ...
    public fun are_coins_ordered<T0>(arg0: &InterestPool<T0>, arg1: vector<0x1::type_name::TypeName>) : bool {
        ...
        let v1 = 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::comparator::compare<vector<0x1::type_name::TypeName>>(&v0, &arg1);
        0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::comparator::eq(&v1)
    }

    public fun assert_pool_admin<T0>(arg0: &InterestPool<T0>, arg1: &0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::pool_admin::PoolAdmin) {
        assert!(arg0.pool_admin_address == 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::pool_admin::addy(arg1), 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::errors::invalid_pool_admin());
    }
    ...
    public(friend) fun confirm<T0>(arg0: &InterestPool<T0>, arg1: Request) {
        ...
        let v4 = v3;
        let v5 = v1;
        assert!(0x2::vec_map::contains<0x1::string::String, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>(&v0.rules, &v5), 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::errors::invalid_rule_name());
        assert!(addy<T0>(arg0) == v2, 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::errors::wrong_request_pool_address());
        ...
        while (0x1::vector::length<0x1::type_name::TypeName>(&v6) > v7) {
            assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&v4, 0x1::vector::borrow<0x1::type_name::TypeName>(&v6, v7)), 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::errors::rule_not_approved());
            v7 = v7 + 1;
        };
    }
    ...
    public fun has_add_liquidity_hook<T0>(arg0: &InterestPool<T0>) : bool {
    ...
    public fun has_remove_liquidity_hook<T0>(arg0: &InterestPool<T0>) : bool {
    ...
    public fun has_swap_hook<T0>(arg0: &InterestPool<T0>) : bool {
    ...
    public(friend) fun new_with_hooks<T0>(arg0: 0x2::vec_set::VecSet<0x1::type_name::TypeName>, arg1: 0x2::versioned::Versioned, arg2: HooksBuilder, arg3: &mut 0x2::tx_context::TxContext) : (InterestPool<T0>, 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::pool_admin::PoolAdmin) {
        0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::curves::assert_curve<T0>();
        let HooksBuilder {
            rules  : v0,
            config : v1,
        } = arg2;
        let v2 = 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::pool_admin::new(arg3);
        let v3 = Hooks{
            rules  : v0,
            config : v1,
        };
        let v4 = InterestPool<T0>{
            ...
            coins              : arg0,
            state              : arg1,
            pool_admin_address : 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::pool_admin::addy(&v2),
    ...
    public fun remove_liquidity_hook<T0>(arg0: &InterestPool<T0>) : (vector<0x1::type_name::TypeName>, vector<0x1::type_name::TypeName>) {
    ...
    public fun swap_hook<T0>(arg0: &InterestPool<T0>) : (vector<0x1::type_name::TypeName>, vector<0x1::type_name::TypeName>) {
        hook<T0>(arg0, b"START_SWAP", b"FINISH_SWAP")
    }

    public fun uid_mut<T0>(arg0: &mut InterestPool<T0>, arg1: &0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::pool_admin::PoolAdmin) : &mut 0x2::object::UID {
