module 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::stable_math {
    ...
    public fun invariant_(arg0: u256, arg1: vector<u256>) : u256 {
        ...
        let v2 = 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::utils::to_u256(v1);
        let v3 = v0;
        let v4 = arg0 * v2;
        let v5 = 0;
        while (255 > v5) {
    ...
    public fun y(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: vector<u256>) : u256 {
        assert!(arg1 != arg2, 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::errors::same_coin_index());
        let v0 = invariant_(arg0, arg4);
        let v1 = v0;
        let v2 = 0;
        let v3 = 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::utils::to_u256(0x1::vector::length<u256>(&arg4));
        let v4 = arg0 * v3;
        let v5 = 0;
        while (v3 > v5) {
            if (v5 == arg1) {
                ...
                let v7 = *0x1::vector::borrow<u256>(&arg4, 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::utils::to_u64(v5));
                v2 = v2 + v7;
                let v8 = v1 * v0;
                v1 = v8 / v7 * v3;
            };
    ...
    public fun y_d(arg0: u256, arg1: u256, arg2: vector<u256>, arg3: u256) : u256 {
        let v0 = arg3;
        let v1 = 0;
        let v2 = 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::utils::to_u256(0x1::vector::length<u256>(&arg2));
        let v3 = arg0 * v2;
        let v4 = 0;
        while (v2 > v4) {
            if (v4 != arg1) {
                let v5 = *0x1::vector::borrow<u256>(&arg2, 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::utils::to_u64(v4));
                v1 = v1 + v5;
                let v6 = v0 * arg3;
                v0 = v6 / v5 * v2;
            };
