module 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::stable_fees {
    ...
    fun calculate_fee_amount(arg0: u64, arg1: u256) : u64 {
        (0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::fixed_point_wad::mul_up((arg0 as u256), arg1) as u64)
    }
    ...
    public fun update_admin_fee_percent(arg0: &mut StableFees, arg1: 0x1::option::Option<u256>) {
        ...
        assert!(200000000000000000 >= v0, 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::errors::invalid_fee());
    ...
    public fun update_fee_in_percent(arg0: &mut StableFees, arg1: 0x1::option::Option<u256>) {
        ...
        let v0 = 0x1::option::extract<u256>(&mut arg1);
        assert!(20000000000000000 >= v0, 0x93b6b0212ce86cc7759bd8e8b152bf604d6fa4c6cdeada1f276145bdc61ae1e3::errors::invalid_fee());
