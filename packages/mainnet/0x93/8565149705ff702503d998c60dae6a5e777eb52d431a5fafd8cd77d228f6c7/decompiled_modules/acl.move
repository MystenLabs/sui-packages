module 0x938565149705ff702503d998c60dae6a5e777eb52d431a5fafd8cd77d228f6c7::acl {
    struct Dvxllhrweoronto has key {
        id: 0x2::object::UID,
        coombuckets: 0x2::table::Table<0x1::ascii::String, Eowwxkebkeolpmg>,
    }

    struct Eowwxkebkeolpmg has store {
        coomer: address,
        zoomer: address,
        cooming: bool,
    ...
    public entry fun dnrlzcwyiiawzbq<T0: store + key>(arg0: &mut Dvxllhrweoronto, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Eowwxkebkeolpmg>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Eowwxkebkeolpmg>(&mut arg0.coombuckets, arg1);
    ...
    public entry fun ijutuxpbftcmfux(arg0: &mut Dvxllhrweoronto, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Eowwxkebkeolpmg>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Eowwxkebkeolpmg>(&mut arg0.coombuckets, arg1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Dvxllhrweoronto{
            id          : 0x2::object::new(arg0),
            coombuckets : 0x2::table::new<0x1::ascii::String, Eowwxkebkeolpmg>(arg0),
        };
        0x2::transfer::share_object<Dvxllhrweoronto>(v0);
    }

    public entry fun ivloubvuyktekwj(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Dvxllhrweoronto, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Eowwxkebkeolpmg>(&arg2.coombuckets, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Eowwxkebkeolpmg>(&mut arg2.coombuckets, arg3);
        if (v0.cooming) {
    ...
    public entry fun jerplekelfbfagh(arg0: &mut Dvxllhrweoronto, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Eowwxkebkeolpmg{
        ...
        0x2::table::add<0x1::ascii::String, Eowwxkebkeolpmg>(&mut arg0.coombuckets, arg1, v0);
    }

    public entry fun nyaujjdioazpnaw(arg0: &mut Dvxllhrweoronto, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Eowwxkebkeolpmg>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Eowwxkebkeolpmg>(&mut arg0.coombuckets, arg1);
    ...
    public entry fun qmatxgegdrnlzoc(arg0: &mut Dvxllhrweoronto, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<0x1::ascii::String, Eowwxkebkeolpmg>(&arg0.coombuckets, arg1)) {
            let v4 = 0x2::table::borrow_mut<0x1::ascii::String, Eowwxkebkeolpmg>(&mut arg0.coombuckets, arg1);
            ...
            0x2::table::add<0x1::ascii::String, Eowwxkebkeolpmg>(&mut arg0.coombuckets, arg1, v5);
        };
    }

    public entry fun seijkyacqunwuyt<T0>(arg0: &mut Dvxllhrweoronto, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Eowwxkebkeolpmg>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Eowwxkebkeolpmg>(&mut arg0.coombuckets, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.zoomer, 0);
