module 0x93b4ba11c41f53b177a9d6bb6c326cb4b3302413ce313343a92ba43da3dd76cb::cnsnft9596 {
    struct CNSNFT9596 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9596, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9596>(arg0, arg1);
