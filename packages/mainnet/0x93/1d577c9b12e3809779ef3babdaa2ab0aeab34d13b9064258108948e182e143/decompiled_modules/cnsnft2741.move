module 0x931d577c9b12e3809779ef3babdaa2ab0aeab34d13b9064258108948e182e143::cnsnft2741 {
    struct CNSNFT2741 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2741, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2741>(arg0, arg1);
