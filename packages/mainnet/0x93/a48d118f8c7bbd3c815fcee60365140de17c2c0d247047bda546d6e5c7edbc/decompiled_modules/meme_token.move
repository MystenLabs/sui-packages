module 0x93a48d118f8c7bbd3c815fcee60365140de17c2c0d247047bda546d6e5c7edbc::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"PRE", b"SUI PRE", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-16T08-40-23.606Z-images (6).jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"SUI PRE"),
            symbol     : 0x1::string::utf8(b"PRE"),
            decimals   : 9,
