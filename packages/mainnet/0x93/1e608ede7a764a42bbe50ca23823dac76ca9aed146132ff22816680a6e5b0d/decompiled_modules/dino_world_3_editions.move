module 0x931e608ede7a764a42bbe50ca23823dac76ca9aed146132ff22816680a6e5b0d::dino_world_3_editions {
    struct DINO_WORLD_3_EDITIONS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DINO_WORLD_3_EDITIONS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DINO_WORLD_3_EDITIONS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Dino World 3 Editions"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Dino World 3!"));
