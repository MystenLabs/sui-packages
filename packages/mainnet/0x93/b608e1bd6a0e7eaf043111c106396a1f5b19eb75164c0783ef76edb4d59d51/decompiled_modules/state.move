module 0x93b608e1bd6a0e7eaf043111c106396a1f5b19eb75164c0783ef76edb4d59d51::state {
    struct State has key {
        ...
        paused: bool,
        roles: 0x93b608e1bd6a0e7eaf043111c106396a1f5b19eb75164c0783ef76edb4d59d51::roles::Roles,
    ...
    public(friend) fun new(arg0: u32, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : State {
        State{
            ...
            paused                        : false,
            roles                         : 0x93b608e1bd6a0e7eaf043111c106396a1f5b19eb75164c0783ef76edb4d59d51::roles::new(arg1, arg1, arg1, arg2),
            compatible_versions           : 0x2::vec_set::singleton<u64>(0x93b608e1bd6a0e7eaf043111c106396a1f5b19eb75164c0783ef76edb4d59d51::version_control::current_version()),
        }
    }

    public fun roles(arg0: &State) : &0x93b608e1bd6a0e7eaf043111c106396a1f5b19eb75164c0783ef76edb4d59d51::roles::Roles {
        &arg0.roles
    }
    ...
    public(friend) fun roles_mut(arg0: &mut State) : &mut 0x93b608e1bd6a0e7eaf043111c106396a1f5b19eb75164c0783ef76edb4d59d51::roles::Roles {
        &mut arg0.roles
    }
