module 0x298847bb52e222b4ea1ec671ab575f81341828228feb282bff0bb16010acc553::moonbags_token_lock {
    ...
    struct LockExtendedEvent has copy, drop {
        contract_id: address,
        sender: address,
        old_end_time: u64,
        new_end_time: u64,
    ...
    public entry fun extend_lock<T0>(arg0: &mut LockContract<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == arg0.locker, 3);
        assert!(!arg0.closed, 1);
        let v1 = 0x2::clock::timestamp_ms(arg2);
        let v2 = arg0.end_time;
        if (v1 >= v2) {
            arg0.end_time = v1 + arg1;
        } else {
            arg0.end_time = v2 + arg1;
        };
        let v3 = LockExtendedEvent{
            contract_id  : 0x2::object::uid_to_address(&arg0.id),
            sender       : v0,
            old_end_time : v2,
            new_end_time : arg0.end_time,
        };
        0x2::event::emit<LockExtendedEvent>(v3);
    }
