module 0x93a20a6567d43e183f280d121a3a441822e8705d28fda51809cf0a7ded42a103::bob_the_reveal_ {
    struct BOB_THE_REVEAL_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BOB_THE_REVEAL_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BOB_THE_REVEAL_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Bob The Reveal "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiatbiju3atkf6uqq2h2wyes2kad5sdageudwmsnm5bwx6apvvinxy"));
