module 0x93ca38d2f66f0bd817524f2050c53ccbf546cd46171456be340213cb083f2942::challenge {
    ...
    public entry fun get_flag(arg0: u64, arg1: vector<u8>, arg2: vector<u8>, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: &mut Challenge, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg0 == (*0x1::vector::borrow<u8>(&arg6.round_hash, 0) as u64) << 24 | (*0x1::vector::borrow<u8>(&arg6.round_hash, 1) as u64) << 16 | (*0x1::vector::borrow<u8>(&arg6.round_hash, 2) as u64) << 8 | (*0x1::vector::borrow<u8>(&arg6.round_hash, 3) as u64), 4);
        arg6.current_score = arg0;
        0x1::vector::append<u8>(&mut arg1, *0x1::string::as_bytes(&arg6.secret));
        let v0 = 0x1::hash::sha3_256(arg1);
        assert!(compare_hash_prefix(&v0, &arg6.round_hash, 2), 0);
        let v1 = 0x1::bcs::to_bytes<0x1::string::String>(&arg6.secret);
        0x1::vector::append<u8>(&mut v1, *0x1::string::as_bytes(&arg3));
        assert!(arg2 == 0x1::hash::sha3_256(v1), 1);
        assert!(arg4 == arg6.current_score % 1000 + arg5, 2);
        let v2 = *0x1::string::as_bytes(&arg6.secret);
        assert!(arg5 == 0x1::vector::length<u8>(&v2) * 2, 3);
        let v3 = getRandomString(arg7, arg8);
        arg6.secret = v3;
