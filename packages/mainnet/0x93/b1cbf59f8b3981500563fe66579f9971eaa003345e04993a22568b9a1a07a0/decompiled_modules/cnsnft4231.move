module 0x93b1cbf59f8b3981500563fe66579f9971eaa003345e04993a22568b9a1a07a0::cnsnft4231 {
    struct CNSNFT4231 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4231, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4231>(arg0, arg1);
