module 0x9375630f3095f2217994c9ae791ad73244e1bf72bd537c9f715cba0de1de51da::inner {
    ...
    public(friend) fun link_evm(arg0: &mut StateV1, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::tx_context::TxContext) {
        ...
        0x9375630f3095f2217994c9ae791ad73244e1bf72bd537c9f715cba0de1de51da::events::emit_evm_linked(v0, arg1);
    }
    ...
    public(friend) fun link_solana(arg0: &mut StateV1, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::tx_context::TxContext) {
        ...
        0x9375630f3095f2217994c9ae791ad73244e1bf72bd537c9f715cba0de1de51da::events::emit_solana_linked(v0, arg1);
    }
    ...
    public(friend) fun unlink_evm(arg0: &mut StateV1, arg1: vector<u8>, arg2: &0x2::tx_context::TxContext) {
        ...
        0x9375630f3095f2217994c9ae791ad73244e1bf72bd537c9f715cba0de1de51da::events::emit_evm_unlinked(v0, arg1);
    }
    ...
    public(friend) fun unlink_solana(arg0: &mut StateV1, arg1: vector<u8>, arg2: &0x2::tx_context::TxContext) {
        ...
        0x9375630f3095f2217994c9ae791ad73244e1bf72bd537c9f715cba0de1de51da::events::emit_solana_unlinked(v0, arg1);
    }
