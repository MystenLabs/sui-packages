module 0x938d4f10c74b10d70a287e4dcc0b36ba283a8853e9cc67d8e857cd6a3e1e25d2::cnsnft2772 {
    struct CNSNFT2772 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2772, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2772>(arg0, arg1);
