module 0x93399b3dda8c66afa77885352ba46d3bbe53be4f4ce4559ed7ea3f0fb4ed2469::factory_single_type {
    ...
    fun init(arg0: FACTORY_SINGLE_TYPE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::coin::create_currency<FACTORY_SINGLE_TYPE>(arg0, 9, b"MARKER", b"Token Marker", b"Treasury capability for meme token factory", 0x1::option::none<0x2::url::Url>(), arg1);
        let v3 = CapStore{
            id    : 0x2::object::new(arg1),
            cap   : v1,
            admin : 0x2::tx_context::sender(arg1),
