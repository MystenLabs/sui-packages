module 0x937c3c69bf38d8e8fd231dd564f46ebd78671edb3c13722bab980742d706d603::hop {
    struct HOP has drop {
        dummy_field: bool,
    }

    fun init(arg0: HOP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HOP>(arg0, 6, b"HOP", b"HOP.fun TOKEN", b"Governance token for Hop.fun", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://x.com/HopAggregator/photo")), arg1);
