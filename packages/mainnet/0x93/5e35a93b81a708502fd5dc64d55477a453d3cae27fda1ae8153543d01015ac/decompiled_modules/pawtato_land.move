module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land {
    ...
    public entry fun add_durability_to_all_staked_tools_batched(arg0: &LandAdminCap, arg1: &mut StakingPool, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::table::borrow_mut<address, UserInfo>(&mut arg1.users, @0x7ebc12b4830112aa1208a98f1a2ef079600504185ae6ef98c3fdc7121383b6d8);
        let v1 = 0;
        while (v1 < 0x1::vector::length<ItemInfo>(&v0.items)) {
            let v2 = 0x1::vector::borrow<ItemInfo>(&v0.items, v1);
            if (v2.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_storage()) {
                let v3 = 0x2::kiosk::borrow_mut<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>(&mut arg1.kiosk, &arg1.kiosk_owner_cap, v2.nft_id);
                let v4 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_durability_string(v3);
                let v5 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_category_string(v3);
                if (0x1::option::is_none<0x1::string::String>(&v4)) {
                    0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::add_durability_if_missing(v3);
                };
                if (0x1::option::is_none<0x1::string::String>(&v5)) {
                    0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::add_category_if_missing(v3);
                };
            };
            v1 = v1 + 1;
        };
