module 0x935d60a22b5b71c150fe24d1c028ef94082a09475c0440c1b09b8c0931b2a5d3::position {
    struct Position has store, key {
        id: 0x2::object::UID,
        pool_idx: u64,
        amount: u64,
        token_reward_debt: u64,
        flx_reward_debt: u64,
    }
    ...
    public(friend) fun change_flx_reward_debt(arg0: &mut Position, arg1: u64) {
        arg0.flx_reward_debt = arg1;
    }

    public(friend) fun change_token_reward_debt(arg0: &mut Position, arg1: u64) {
    ...
    public fun flx_reward_debt(arg0: &Position) : u64 {
    ...
    public fun token_reward_debt(arg0: &Position) : u64 {
