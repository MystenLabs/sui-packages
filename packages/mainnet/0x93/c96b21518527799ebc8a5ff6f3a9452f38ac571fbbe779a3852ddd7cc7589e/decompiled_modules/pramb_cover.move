module 0x55271cd50c8ca509273ae533bc38a23ff5712c4e8fb8a102fdeb6fd4c00bcb88::pramb_cover {
    ...
    public entry fun withdraw_all_treasure<T0>(arg0: &mut Config, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, EscrowCoins<T0>>(&mut arg0.id, v1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v2.coins, 0x2::coin::value<T0>(&v2.coins), arg1), v0);
    }
