module 0x93233598f442a1446fa5fb0cc8a4ad294711d7b9a96c18777fac0c07d05e86f9::cnsnft8269 {
    struct CNSNFT8269 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8269, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8269>(arg0, arg1);
