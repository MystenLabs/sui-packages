module 0x93ecc5b0647d488da8b9479ca40ac017cc26cb4598aab628519fc76ccb423a32::bbb_cetus_swap {
    ...
    public fun swap<T0, T1>(arg0: CetusSwapPromise, arg1: &mut 0x93ecc5b0647d488da8b9479ca40ac017cc26cb4598aab628519fc76ccb423a32::bbb_vault::BBBVault, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg5) == v0.pool_id, 1000);
        let v5 = 0x1::type_name::get<T0>();
        let v6 = 0x1::type_name::get<T1>();
        assert!(v5 == v0.type_a, 1003);
        assert!(v6 == v0.type_b, 1004);
        if (v0.a2b) {
            let v7 = 0x2::coin::from_balance<T0>(0x93ecc5b0647d488da8b9479ca40ac017cc26cb4598aab628519fc76ccb423a32::bbb_vault::withdraw<T0>(arg1), arg7);
            let v8 = 0x2::coin::value<T0>(&v7);
            if (v8 == 0) {
                0x2::coin::destroy_zero<T0>(v7);
                return
            };
            let v9 = 0x93ecc5b0647d488da8b9479ca40ac017cc26cb4598aab628519fc76ccb423a32::bbb_pyth::calc_amount_out(arg2, arg3, v0.decimals_a, v0.decimals_b, v8, v0.max_age_secs, arg6);
            let v10 = swap_a2b<T0, T1>(arg4, arg5, v7, arg6, arg7);
            let v11 = 0x2::coin::value<T1>(&v10);
            assert!(v11 >= (((v9 as u256) * (v0.slippage as u256) / 1000000000000000000) as u64), 1005);
            0x93ecc5b0647d488da8b9479ca40ac017cc26cb4598aab628519fc76ccb423a32::bbb_vault::deposit<T1>(arg1, v10);
            let v12 = CetusSwapEvent{
            ...
            0x2::event::emit<CetusSwapEvent>(v12);
        } else {
            let v13 = 0x2::coin::from_balance<T1>(0x93ecc5b0647d488da8b9479ca40ac017cc26cb4598aab628519fc76ccb423a32::bbb_vault::withdraw<T1>(arg1), arg7);
            let v14 = 0x2::coin::value<T1>(&v13);
            if (v14 == 0) {
                0x2::coin::destroy_zero<T1>(v13);
                return
            };
            let v15 = 0x93ecc5b0647d488da8b9479ca40ac017cc26cb4598aab628519fc76ccb423a32::bbb_pyth::calc_amount_out(arg3, arg2, v0.decimals_b, v0.decimals_a, v14, v0.max_age_secs, arg6);
            let v16 = swap_b2a<T0, T1>(arg4, arg5, v13, arg6, arg7);
            let v17 = 0x2::coin::value<T0>(&v16);
            assert!(v17 >= (((v15 as u256) * (v0.slippage as u256) / 1000000000000000000) as u64), 1005);
            0x93ecc5b0647d488da8b9479ca40ac017cc26cb4598aab628519fc76ccb423a32::bbb_vault::deposit<T0>(arg1, v16);
            let v18 = CetusSwapEvent{
            ...
            0x2::event::emit<CetusSwapEvent>(v18);
        };
    }
    ...
    public fun new<T0, T1>(arg0: &0x93ecc5b0647d488da8b9479ca40ac017cc26cb4598aab628519fc76ccb423a32::bbb_admin::BBBAdminCap, arg1: bool, arg2: u8, arg3: u8, arg4: vector<u8>, arg5: vector<u8>, arg6: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: u64, arg8: u64) : CetusSwap {
