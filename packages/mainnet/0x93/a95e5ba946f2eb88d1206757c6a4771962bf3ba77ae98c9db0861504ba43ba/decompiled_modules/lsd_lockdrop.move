module 0x93a95e5ba946f2eb88d1206757c6a4771962bf3ba77ae98c9db0861504ba43ba::lsd_lockdrop {
    struct LsdLockdropVault has key {
        ...
        hive_incentives_balance: 0x2::balance::Balance<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>,
    }
    ...
    public fun add_hive_incentives(arg0: &0x2::clock::Clock, arg1: &mut LsdLockdropVault, arg2: 0x2::coin::Coin<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(0x2::clock::timestamp_ms(arg0) <= arg1.init_timestamp + arg1.deposit_window, 5100);
        let v0 = 0x2::coin::into_balance<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(arg2);
        0x2::balance::join<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(&mut arg1.hive_incentives_balance, 0x2::balance::split<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(&mut v0, arg3));
        arg1.total_hive_incentives = arg1.total_hive_incentives + arg3;
        0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::coin_helper::destroy_or_transfer_balance<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(v0, 0x2::tx_context::sender(arg4), arg4);
    ...
    public fun add_to_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::HiveProfile, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = if (0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::exists_for_profile(arg3, 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap))) {
            0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg7)
        } else {
        ...
        0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::entry_add_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v5, arg7);
        0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v6, 0x2::tx_context::sender(arg7), arg7);
    }
    ...
    public fun destroy_user_position(arg0: &0x2::clock::Clock, arg1: &0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::config::HiveEntryCap, arg2: &LsdLockdropVault, arg3: &mut 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::HiveProfile, arg4: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u64>, u128, u128) {
        ...
        if (!0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::exists_for_profile(arg3, 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap))) {
        ...
        } = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg4);
        0x2::object::delete(v0);
        0x2::table::drop<u64, bool>(v5);
        (v1, v2, v3, v4, (v6 as u128), v7)
    }

    public fun does_user_have_position(arg0: &0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : bool {
    ...
    public fun get_user_position(arg0: &0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u64, u64) {
        ...
        let v1 = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg0, v0);
    ...
    public fun infuse_sui_hsui_pool(arg0: &0x2::clock::Clock, arg1: &0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0xd8b531618214d62ea8d6b21e939a9af09e569b87d870d97d251cc74cb0d49e4b::hsui_vault::HSuiVault, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::hsui::HSUI>, 0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>, u64, u128) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        ...
        let v2 = 0xd8b531618214d62ea8d6b21e939a9af09e569b87d870d97d251cc74cb0d49e4b::hsui_vault::stake_sui_request(arg3, arg4, 0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, v1), 0x1::option::none<address>(), arg5);
        let v3 = SuiStakedForHiveSui{
            cur_timestamp      : v0,
            total_sui_locked   : arg2.total_sui_locked,
            sui_to_stake       : v1,
            total_hsui_krafted : 0x2::balance::value<0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::hsui::HSUI>(&v2),
        };
        0x2::event::emit<SuiStakedForHiveSui>(v3);
        (v2, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg2.sui_locked_balance), 0x2::balance::withdraw_all<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(&mut arg2.hive_incentives_balance), arg2.total_sui_locked, arg2.total_sui_weighted_units)
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
    }

    public entry fun initialize_global_lsd_lockdrop(arg0: &0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::config::HiveEntryCap, arg1: 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::ProfileDofOwnershipCapability, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : address {
        let v0 = LsdLockdropVault{
            ...
            hive_incentives_balance  : 0x2::balance::zero<0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive::HIVE>(),
        };
    ...
    public fun simulate_withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &LsdLockdropVault, arg2: &0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::HiveProfile, arg3: u64, arg4: u64) : (u64, u64, bool) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        if (v0 < arg1.init_timestamp || v0 > arg1.init_timestamp + arg1.deposit_window + arg1.withdrawal_window) {
            return (0, 0, false)
        };
        let v1 = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::get_profile_dof_capability_identifier(&arg1.user_profile_access_cap);
        if (!0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::exists_for_profile(arg2, v1)) {
            return (0, 0, false)
        };
        let v2 = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg2, v1);
    ...
    public fun withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::HiveProfile, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::exists_for_profile(arg3, 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap)), 5104);
        let v5 = 0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg6);
        ...
        0xb94d464b263a6179272fd74060279768b290764f500f7480d5880dc66e19ddc4::hive_profile::entry_add_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v5, arg6);
        0xdb3d8021ae45cc4ec3a13c55de2293fbad1ff2a0a179e766838e8e33fd41a08f::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, arg4), v4, arg6);
    }
