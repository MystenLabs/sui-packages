module 0x93aa6b456d1857d42d3859865bcd4f9693b891417a54948c1f04effc6cf20066::gift4678 {
    struct GIFT4678 has drop {
        dummy_field: bool,
    }

    struct TICKET_4678 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4678(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4678>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4678>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4678, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4678>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4678>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4678>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4678>>(v5, 0x2::tx_context::sender(arg1));
    }
