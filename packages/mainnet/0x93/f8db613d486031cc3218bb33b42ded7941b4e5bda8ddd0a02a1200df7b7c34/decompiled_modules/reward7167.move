module 0x93f8db613d486031cc3218bb33b42ded7941b4e5bda8ddd0a02a1200df7b7c34::reward7167 {
    struct REWARD7167 has drop {
        dummy_field: bool,
    }

    struct TICKET_7167 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7167(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7167>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7167>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7167, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7167>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7167>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7167>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7167>>(v5, 0x2::tx_context::sender(arg1));
    }
