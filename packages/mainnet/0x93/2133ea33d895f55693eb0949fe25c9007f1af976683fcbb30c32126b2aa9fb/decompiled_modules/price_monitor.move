module 0x932133ea33d895f55693eb0949fe25c9007f1af976683fcbb30c32126b2aa9fb::price_monitor {
    ...
    public fun add_aggregator(arg0: &mut PriceMonitor, arg1: 0x2::object::ID, arg2: vector<0x2::object::ID>, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < v0) {
            ...
            if (0x2::table::contains<0x2::object::ID, u128>(&arg0.pool_price_decimal_multipliers, v3)) {
                assert!(0x2::table::borrow<0x2::object::ID, u128>(&arg0.pool_price_decimal_multipliers, v3) == &v4, 93979479033027843);
            } else {
                0x2::table::add<0x2::object::ID, u128>(&mut arg0.pool_price_decimal_multipliers, v3, v4);
            };
    ...
    public fun add_pool_to_aggregator(arg0: &mut PriceMonitor, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: u8, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<0x2::object::ID, u128>(&mut arg0.pool_price_decimal_multipliers, arg2, calculate_decimal_multiplier(arg3, arg4));
    }
    ...
    public fun get_pool_price_decimal_multiplier(arg0: &PriceMonitor, arg1: 0x2::object::ID) : u128 {
        if (0x2::table::contains<0x2::object::ID, u128>(&arg0.pool_price_decimal_multipliers, arg1)) {
            *0x2::table::borrow<0x2::object::ID, u128>(&arg0.pool_price_decimal_multipliers, arg1)
        } else {
            0
        }
    }
    ...
    public fun get_time_checked_price_q64(arg0: &PriceMonitor, arg1: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator, arg2: &0x2::clock::Clock) : u128 {
        ...
        assert!(0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::timestamp_ms(v0) + arg0.config.max_price_age_ms > 0x2::clock::timestamp_ms(arg2), 93470312203956742);
    ...
    public fun remove_aggregator(arg0: &mut PriceMonitor, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x2::object::ID>(&v0)) {
            0x2::table::remove<0x2::object::ID, u128>(&mut arg0.pool_price_decimal_multipliers, *0x1::vector::borrow<0x2::object::ID>(&v0, v1));
            v1 = v1 + 1;
        };
    }
    ...
    public fun remove_pool_from_aggregator(arg0: &mut PriceMonitor, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::remove<0x2::object::ID, u128>(&mut arg0.pool_price_decimal_multipliers, arg2);
    }
    ...
    public fun update_pool_price_decimal_multiplier(arg0: &mut PriceMonitor, arg1: 0x2::object::ID, arg2: u8, arg3: u8) {
        if (!0x2::table::contains<0x2::object::ID, u128>(&arg0.pool_price_decimal_multipliers, arg1)) {
            abort 13906835553027883007
        };
        0x2::table::add<0x2::object::ID, u128>(&mut arg0.pool_price_decimal_multipliers, arg1, calculate_decimal_multiplier(arg2, arg3));
    }
    ...
    public fun validate_price<T0, T1, T2>(arg0: &mut PriceMonitor, arg1: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator, arg2: &0xaa3ae572fb09f157d7368ce22c6b7f33fde0fe74cba75ae9679af52088b57bb0::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) : PriceValidationResult {
        ...
        let v3 = if (0x2::table::contains<0x2::object::ID, u128>(&arg0.pool_price_decimal_multipliers, v0)) {
            *0x2::table::borrow<0x2::object::ID, u128>(&arg0.pool_price_decimal_multipliers, v0)
        } else {
            0
        };
        let v4 = get_pool_price_q64<T0, T1, T2>(arg2, v3);
        clean_old_prices_from_history(arg0, v1);
        let v5 = if (arg0.config.enable_oracle_pool_validation) {
            validate_oracle_pool_deviation(arg0, v2, v4)
        } else {
        ...
        let v6 = v5;
        let v7 = if (arg0.config.enable_oracle_history_validation) {
            validate_oracle_history_deviation(arg0, v2)
        } else {
            DeviationValidationResult{deviation_bps: 0, anomaly_level: 0x932133ea33d895f55693eb0949fe25c9007f1af976683fcbb30c32126b2aa9fb::price_monitor_consts::get_anomaly_level_normal(), anomaly_flags: 0x932133ea33d895f55693eb0949fe25c9007f1af976683fcbb30c32126b2aa9fb::price_monitor_consts::get_anomaly_flag_none()}
        };
        let v8 = v7;
        let v9 = if (arg0.config.enable_statistical_validation) {
        ...
        let v10 = v9;
        add_price_to_history(arg0, create_price_point(v2, v4, v6.deviation_bps, v10.z_score, v1, (0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::math_u128::max((v6.anomaly_level as u128), (v8.anomaly_level as u128)) as u8), (0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::math_u128::max((v6.anomaly_flags as u128), (v8.anomaly_flags as u128)) as u8)));
        let v11 = evaluate_circuit_breaker(arg0, &v6, &v8, &v10, v1);
        emit_validation_events(arg0, &v6, &v10, &v8, &v11, v2, v4, v1);
        update_monitor_state(arg0, &v11, v1);
        PriceValidationResult{
            escalation_activation : v11.should_escalate,
            is_valid              : v11.level == 0x932133ea33d895f55693eb0949fe25c9007f1af976683fcbb30c32126b2aa9fb::price_monitor_consts::get_anomaly_level_normal(),
            price_q64             : v2,
        }
    }
