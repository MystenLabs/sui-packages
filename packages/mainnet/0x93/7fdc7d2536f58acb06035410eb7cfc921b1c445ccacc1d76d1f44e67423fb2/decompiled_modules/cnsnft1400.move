module 0x937fdc7d2536f58acb06035410eb7cfc921b1c445ccacc1d76d1f44e67423fb2::cnsnft1400 {
    struct CNSNFT1400 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1400, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1400>(arg0, arg1);
