module 0x9f835c21d21f8ce519fec17d679cd38243ef2643ad879e7048ba77374be4036e::response {
    ...
    public fun add_witness<T0, T1: drop>(arg0: &mut UpdateResponse<T0>, arg1: T1) {
        ...
        0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg0.witnesses, 0x1::type_name::with_defining_ids<T1>());
    }
