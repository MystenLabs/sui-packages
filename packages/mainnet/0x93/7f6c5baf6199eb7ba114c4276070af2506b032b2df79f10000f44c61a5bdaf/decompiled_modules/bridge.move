module 0x9a4ba3338384d36033065f9cf0c58078033a718a92f091f12a551f6984c290c5::bridge {
    ...
    public fun claim_metadata_cap<T0>(arg0: &BridgeVault<T0>, arg1: &MinterCap, arg2: &mut 0x2::coin_registry::Currency<T0>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin_registry::MetadataCap<T0> {
        assert!(0x2::object::id<BridgeVault<T0>>(arg0) == arg1.vault_id, 1);
        0x2::coin_registry::claim_metadata_cap<T0>(arg2, &arg0.treasury, arg3)
    }
