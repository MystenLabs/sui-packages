module 0x937b96a573944b427a7c8ac6f208dbed0f00f398d131316ccd4a587ad7c535c1::cards {
    ...
    fun fuse_cards_inner(arg0: &mut MintCounter, arg1: Card, arg2: Card, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<CardBurnedEvent>(v25);
        ...
        0x2::event::emit<CardBurnedEvent>(v46);
        0x2::object::delete(v26);
        let v47 = next_serial(arg0, &v24, &v23);
        let v48 = Card{
        ...
        let v49 = 0x1::vector::empty<0x2::object::ID>();
        let v50 = &mut v49;
        0x1::vector::push_back<0x2::object::ID>(v50, v1);
        0x1::vector::push_back<0x2::object::ID>(v50, v2);
        let v51 = CardFusedEvent{
            new_card_id     : 0x2::object::uid_to_inner(&v48.id),
            burned_card_ids : v49,
            recipient       : v0,
            player          : v24,
            league_code     : v17,
        ...
        0x2::event::emit<CardFusedEvent>(v51);
        0x2::transfer::public_transfer<Card>(v48, v0);
    }
