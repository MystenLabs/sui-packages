module 0x5a0c92438d96c7ef53b5d617faa691da7a0ccf9acf7dcd1b9d543030abb784b0::loans {
    ...
    struct LoanExtended has copy, drop {
        saint_id: 0x2::object::ID,
        borrower: address,
        periods: u64,
        fee_atoms: u64,
    ...
    public fun extend_loan(arg0: &mut LoanBook, arg1: 0x2::object::ID, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        assert!(arg2 >= 1 && arg2 <= arg0.max_periods, 2);
        assert!(0x2::table::contains<0x2::object::ID, Loan>(&arg0.loans, arg1), 7);
        let v0 = arg2 * arg0.fee_per_period_mist;
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) == v0, 3);
        let v1 = 0x2::table::borrow_mut<0x2::object::ID, Loan>(&mut arg0.loans, arg1);
        assert!(v1.borrower == 0x2::tx_context::sender(arg5), 12);
        let v2 = 0x2::clock::timestamp_ms(arg4);
        let v3 = if (v1.due_ms > v2) {
            v1.due_ms
        } else {
            v2
        };
        let v4 = v3 + arg2 * 604800000;
        v1.due_ms = v4;
        v1.fee_paid = v1.fee_paid + v0;
        ...
        0x2::event::emit<LoanExtended>(v5);
    }
