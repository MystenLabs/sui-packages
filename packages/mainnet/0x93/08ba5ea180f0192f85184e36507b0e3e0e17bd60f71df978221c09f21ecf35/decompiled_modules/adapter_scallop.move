module 0x9308ba5ea180f0192f85184e36507b0e3e0e17bd60f71df978221c09f21ecf35::adapter_scallop {
    struct ScallopVault<phantom T0, phantom T1> has key {
        id: 0x2::object::UID,
    ...
    public fun receipt_balance<T0, T1>(arg0: &ScallopVault<T0, T1>) : u64 {
        0x2::balance::value<T1>(&arg0.receipts)
    }

    public fun supplied_principal<T0, T1>(arg0: &ScallopVault<T0, T1>) : u64 {
