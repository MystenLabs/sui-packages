module 0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::lock_coin {
    ...
    struct Lock has key {
        ...
        total_lock: u64,
        total_unlock: u64,
        lock_coin: 0x2::coin::Coin<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>,
        start_time: u64,
    }
    ...
    public entry fun claim(arg0: &mut Lock, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 305);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>>(0x2::coin::split<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>(&mut arg0.lock_coin, v0, arg2), 0x2::tx_context::sender(arg2));
    ...
    fun create_lock(arg0: 0x2::coin::Coin<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>, arg1: vector<u8>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : Lock {
        let v0 = 0x2::coin::value<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>(&arg0);
    ...
    public entry fun init_tokenomic(arg0: &mut TokenomicCap, arg1: &mut 0x2::coin::Coin<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>, arg2: &0x2::coin::CoinMetadata<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.initialize == false, 403);
        let v0 = 0x2::coin::get_decimals<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>(arg2);
        let v1 = 0x2::coin::split<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>(arg1, 78000000 * 0x2::math::pow(10, v0), arg3);
        ...
        let v4 = 0x2::coin::split<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>(arg1, 126000000 * 0x2::math::pow(10, v0), arg3);
        ...
        let v9 = 0x2::coin::split<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>(arg1, 144000000 * 0x2::math::pow(10, v0), arg3);
        ...
        let v13 = 0x2::coin::split<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>(arg1, 66000000 * 0x2::math::pow(10, v0), arg3);
        ...
        let v17 = 0x2::coin::split<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>(arg1, 42000000 * 0x2::math::pow(10, v0), arg3);
        ...
        let v20 = 0x2::coin::split<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>(arg1, 48000000 * 0x2::math::pow(10, v0), arg3);
        ...
        let v24 = 0x2::coin::split<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>(arg1, 36000000 * 0x2::math::pow(10, v0), arg3);
        ...
        let v27 = 0x2::coin::split<0x939c3790ba8065ac882683056edd818076d4cccc58cfb2ea2b281401add37d11::gruu::GRUU>(arg1, 60000000 * 0x2::math::pow(10, v0), arg3);
