module 0x93b1e00939bf8591ec81fed6ea143643d07e58c4a2645308f82b6f71dee1220b::malakai {
    ...
    fun init(arg0: MALAKAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<MALAKAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Malakai ")))), trim_right(b"Malakai                         "), trim_right(b"The most viral and memeable passport photo ever taken meets the 'human infinity' meme.                                                                                                                                                                                                                                          "), v2, arg1);
