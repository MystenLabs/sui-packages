module 0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::skill {
    ...
    public fun deprecate(arg0: &mut Skill, arg1: &0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::owner(arg1) == 0x2::tx_context::sender(arg2), 0);
        assert!(0x2::object::id<0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent>(arg1) == arg0.agent_id, 1);
    ...
    public fun publish(arg0: &0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u8, arg6: u64, arg7: u64, arg8: u64, arg9: vector<u64>, arg10: 0x1::string::String, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::owner(arg0) == 0x2::tx_context::sender(arg11), 0);
        assert!(arg5 <= 2, 21);
    ...
    public fun reactivate(arg0: &mut Skill, arg1: &0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::owner(arg1) == 0x2::tx_context::sender(arg2), 0);
        assert!(0x2::object::id<0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent>(arg1) == arg0.agent_id, 1);
    ...
    public fun update_metadata(arg0: &mut Skill, arg1: &0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update_pricing(arg0: &mut Skill, arg1: &0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update_timeout(arg0: &mut Skill, arg1: &0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::owner(arg1) == 0x2::tx_context::sender(arg3), 0);
        assert!(0x2::object::id<0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent>(arg1) == arg0.agent_id, 1);
