module 0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::composite {
    ...
    public fun add_step(arg0: &mut Composite, arg1: &0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent, arg2: 0x2::object::ID, arg3: u64, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun cancel(arg0: &mut Composite, arg1: &0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun create(arg0: &0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) : Composite {
        assert!(0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::owner(arg0) == 0x2::tx_context::sender(arg3), 0);
        Composite{
            id            : 0x2::object::new(arg3),
            creator_agent : 0x2::object::id<0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent>(arg0),
            name          : arg1,
            description   : arg2,
    ...
    public fun create_and_share(arg0: &0xbb66f6e571d08af11153ba9562644e7f634ab96efab3c1c11bf9cbc4d11cc036::agent::Agent, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
