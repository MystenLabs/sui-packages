module 0xbb48354945a36b7c8232ce429832498259f798a11d4e6e8a185f0c3ba32edbac::POP {
    struct POP has drop {
        dummy_field: bool,
    }

    fun init(arg0: POP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<POP>(arg0, 9, b"BLACK", b"Black Meme", b"Black Meme boost", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
