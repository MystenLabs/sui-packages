module 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::vault {
    ...
    public(friend) fun add_deposit_request<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: 0x2::balance::Balance<T1>, arg2: address, arg3: u8) {
        assert!(0x2::balance::value<T2>(&arg0.seed_balance) > 0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::vault_not_seeded());
        let v0 = 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::constants::strategy_active();
        assert!(&arg0.state == &v0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::strategy_not_active());
        let v1 = 0x2::balance::value<T1>(&arg1);
        let v2 = &mut arg0.deposit_queue;
        v2.unprocessed_amount = v2.unprocessed_amount + v1;
    ...
    public(friend) fun add_swap_route<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: vector<0x360802cb106b004205cd67a706e314eaeadd8590d5f4d1cee46137566232a627::bag_value::Value>) {
        ...
        assert!(!0x2::bag::contains<0x1::ascii::String>(&arg0.swap_routes, v0), 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::invalid_route());
    ...
    public fun calculate_lp_token_share<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &0xdee9::clob_v2::Pool<T0, T1>, arg2: u64) : (u64, u64) {
        ...
        assert!(v4 > 0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::invalidLPToken());
        (v0 * arg2 / v4, v2 * arg2 / v4)
    }

    public(friend) fun check_vault_cap_compatibility<T0, T1, T2>(arg0: &VaultCap, arg1: &Vault<T0, T1, T2>) {
        assert!(get_vault_id_from_vault_cap(arg0) == get_vault_id_from_vault<T0, T1, T2>(arg1), 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::invalid_vault_cap());
    }
    ...
    public(friend) fun claim_withdrawal<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::table::contains<address, ClaimableWithdrawals<T0, T1>>(&arg0.claimable_withdrawals, arg1), 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::claim_does_not_exist());
    ...
    public(friend) fun consume_receipt_and_deposit_assets<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: 0xfe579a58d32d38e154a8c0d4aa646238851f340258d10c7482cef9bea165b823::receipt::PermissionedReceipt, arg3: &0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::vault_acl::VaultAcl, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = &arg0.deepbook_account_cap;
        let v1 = 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::process_deposit_helper::consume_swap_receipt<T0>(arg2, arg3);
    ...
    public fun get_unprocessed_deposits<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : u64 {
        arg0.deposit_queue.unprocessed_amount
    }
    ...
    public(friend) fun mark_state_as_ready_for_withdrawal_processing<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &0x2::tx_context::TxContext) {
        assert!(is_address_whitelisted_for_trading<T0, T1, T2>(arg0, 0x2::tx_context::sender(arg1)), 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::address_not_whitelisted());
        let v0 = &arg0.deposit_queue;
        let v1 = 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::constants::strategy_paused_and_ready_for_deposit_processing();
        assert!(&arg0.state == &v1 && v0.pending_requests == 0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::strategy_not_ready_for_withdrawal_processing());
        arg0.state = 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::constants::strategy_paused_and_ready_for_withdrawal_processing();
    }
    ...
    fun mint_lp_token<T0>(arg0: &mut 0x2::coin::TreasuryCap<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = if (v0 == 0) {
            ...
            assert!(v2 > 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::constants::minimal_liquidity(), 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::notEnoughInitialLiquidity());
            v2
        } else {
            0x2::math::min(0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::safe_math::safe_mul_div_u64(arg3, v0, arg1), 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::safe_math::safe_mul_div_u64(arg4, v0, arg2))
        };
        assert!(v1 > 0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::liquidityInsufficientMinted());
        0x2::coin::mint<T0>(arg0, v1, arg5)
    }

    public(friend) fun new_vault<T0, T1, T2>(arg0: &0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::app::AdminCap, arg1: 0x2::coin::TreasuryCap<T2>, arg2: &0xdee9::clob_v2::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, VaultCap) {
        ...
        let v2 = Vault<T0, T1, T2>{
            ...
            epoch_counter         : 0,
            state                 : 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::constants::strategy_active(),
    ...
    public(friend) fun pause_strategy_and_mark_ready_for_deposit_processing<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: &0x2::tx_context::TxContext) {
        assert!(is_address_whitelisted_for_trading<T0, T1, T2>(arg0, 0x2::tx_context::sender(arg2)), 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::address_not_whitelisted());
        let v0 = 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::constants::strategy_active();
        assert!(&arg0.state == &v0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::strategy_not_active());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::invalid_pool());
        ...
        arg0.state = 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::constants::strategy_paused_and_ready_for_deposit_processing();
    }

    public fun process_deposited_balance<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: &0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::vault_acl::VaultAcl, arg3: &0x360802cb106b004205cd67a706e314eaeadd8590d5f4d1cee46137566232a627::acl::RouterAcl, arg4: &mut 0x2::tx_context::TxContext) : 0xfe579a58d32d38e154a8c0d4aa646238851f340258d10c7482cef9bea165b823::receipt::PermissionedReceipt {
        let v0 = 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::constants::strategy_paused_and_ready_for_deposit_processing();
        assert!(&arg0.state == &v0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::strategy_not_ready_for_deposit_processing());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::invalid_pool());
        let (v1, v2, v3, v4) = get_deepbook_account_assets<T0, T1, T2>(arg0, arg1);
        assert!(v2 == 0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::locked_base_asset_found());
        assert!(v4 == 0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::locked_quote_asset_found());
        let (_, _, v7) = get_deepbook_price<T0, T1>(arg1);
        let v8 = &mut arg0.deposit_queue;
        0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::process_deposit_helper::issue_swap_receipt<T1>(arg2, arg3, get_swap_route<T0, T1, T2>(arg0), 0x2::balance::split<T1>(&mut v8.total_balance, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::process_deposit_helper::get_amount_to_swap(v8.unprocessed_amount, v1, v3, v7)), arg4)
    }

    public(friend) fun process_undistributed_lp_tokens<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::vault_acl::VaultAcl, arg2: &0x360802cb106b004205cd67a706e314eaeadd8590d5f4d1cee46137566232a627::acl::RouterAcl, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::constants::strategy_paused_and_ready_for_deposit_processing();
        assert!(&arg0.state == &v0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::strategy_not_ready_for_deposit_processing());
        let v1 = 0;
        let v2 = &mut arg0.deposit_queue;
        ...
        while (v1 < arg3 && 0x2::linked_table::length<address, DepositRequest>(&v2.requests) > 0) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::balance::split<T2>(v3, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::safe_math::safe_mul_div_u64(v4, v10, v2.total_deposit_tokens)), arg4), v8);
            v2.unprocessed_amount = v2.unprocessed_amount - v7;
            v2.pending_requests = v2.pending_requests - 1;
            v1 = v1 + 1;
        };
    ...
    public(friend) fun process_withdrawals<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::constants::strategy_paused_and_ready_for_withdrawal_processing();
        assert!(&arg0.state == &v0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::strategy_not_ready_for_withdrawal_processing());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::invalid_pool());
    ...
    public(friend) fun revoke_trading_permission<T0, T1, T2>(arg0: &VaultCap, arg1: &mut Vault<T0, T1, T2>, arg2: address) {
        ...
        assert!(v0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::address_not_whitelisted());
    ...
    public(friend) fun seed_vault<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T2>(&arg0.seed_balance) == 0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::vault_already_seeded());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::invalid_pool());
        assert!(arg4 > 0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::invalid_lp_tokens_to_mint());
        assert!(0x2::balance::value<T0>(&arg2) > 0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::too_less_deposit_to_seed());
        assert!(0x2::balance::value<T1>(&arg3) > 0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::too_less_deposit_to_seed());
        let v0 = &arg0.deepbook_account_cap;
    ...
    public(friend) fun start_strategy<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        assert!(is_address_whitelisted_for_trading<T0, T1, T2>(arg0, 0x2::tx_context::sender(arg2)), 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::address_not_whitelisted());
        let v0 = &arg0.withdraw_queue;
        let v1 = 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::constants::strategy_paused_and_ready_for_withdrawal_processing();
        assert!(&arg0.state == &v1 && v0.pending_requests == 0, 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::error::strategy_not_ready_to_make_active());
        arg0.state = 0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::constants::strategy_active();
    ...
    public entry fun withdraw_all_funds<T0, T1, T2>(arg0: &0xbbf273670b913be0c7d3de2358f4a293f2d9e12e8a5beb74ba7d4dd19a461d1a::app::AdminCap, arg1: &mut Vault<T0, T1, T2>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) {
