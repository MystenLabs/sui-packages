module 0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::lx_pool_stake {
    ...
    public entry fun pay_miner_fuelV4<T0, T1, T2>(arg0: &mut StakingPool<T2>, arg1: &mut StakingPool<T0>, arg2: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::GlobalConfigMap, arg3: 0x2::object::ID, arg4: u64, arg5: 0x2::coin::Coin<T2>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v11 >= 0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::usdc_to_token(arg2, arg1.platform_coin, arg4), 11);
    ...
    public entry fun stake_ai_order_coin<T0, T1, T2>(arg0: &mut StakingPool<T2>, arg1: &mut PoolInfo<T0>, arg2: &mut 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements::Global, arg3: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::config::GlobalConfigMap, arg4: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::GlobalConfigMap, arg5: 0x2::coin::Coin<T0>, arg6: 0x2::coin::Coin<T2>, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 8);
        let v0 = 0x2::tx_context::sender(arg10);
        assert!(arg7 >= 100, 1);
        assert!(is_eco_coin<T2>(arg0, &arg1.coin_type), 2);
        let v1 = 0x2::coin::value<T0>(&arg5);
        assert!(v1 >= 0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::usdc_to_token(arg4, arg1.coin_type, arg7), 11);
        let v2 = calculate_burn_percentageV1(arg3, arg1.coin_type);
        let v3 = 0x2::coin::value<T2>(&arg6);
        assert!(v3 >= 0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::usdc_to_token(arg4, arg0.platform_coin, arg7 * v2 / 100), 7);
        let v4 = calculate_powerV1(arg7, arg3, arg1.coin_type);
        arg0.order_counter = arg0.order_counter + 1;
        let v5 = 0x2::object::id_from_address(0x2::tx_context::fresh_object_address(arg10));
        let v6 = StakingOrder{
            id               : v5,
            stake_amount     : arg7,
            coin_amount      : v1,
    ...
    public entry fun stake_ai_yusd_coin<T0, T1, T2>(arg0: &mut StakingPool<T2>, arg1: &mut PoolInfo<T0>, arg2: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::GlobalConfigMap, arg3: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::config::GlobalConfigMap, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T2>, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 8);
        ...
        assert!(v3 >= 0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::usdc_to_token(arg2, arg0.platform_coin, arg6 * v2 / 100), 7);
    ...
    public entry fun stake_ai_yy_coin<T0, T1, T2, T3>(arg0: &mut StakingPool<T1>, arg1: &mut PoolInfo<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T3, T2>, arg3: &mut 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements::Global, arg4: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::GlobalConfigMap, arg5: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::config::GlobalConfigMap, arg6: 0x2::coin::Coin<T0>, arg7: 0x2::coin::Coin<T1>, arg8: u64, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 8);
        let v0 = 0x2::tx_context::sender(arg11);
        assert!(arg8 >= 100, 1);
        assert!(is_eco_coin<T1>(arg0, &arg1.coin_type), 2);
        let (_, v2) = 0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::coin_price::calculate_usdc_to_yy_route<T3, T2, T0>(arg2, arg3, arg8);
        let v3 = 0x2::coin::value<T0>(&arg6);
        assert!(v3 >= v2, 11);
        let v4 = calculate_burn_percentageV1(arg5, arg1.coin_type);
        let v5 = 0x2::coin::value<T1>(&arg7);
        assert!(v5 >= 0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::usdc_to_token(arg4, arg0.platform_coin, arg8 * v4 / 100), 7);
        let v6 = calculate_powerV1(arg8, arg5, arg1.coin_type);
        arg0.order_counter = arg0.order_counter + 1;
        let v7 = 0x2::object::id_from_address(0x2::tx_context::fresh_object_address(arg11));
        let v8 = StakingOrder{
            id               : v7,
            stake_amount     : arg8,
            coin_amount      : v3,
            ...
            redeemed_amount  : 0,
            coin_type        : arg1.coin_type,
            stake_time       : 0x2::clock::timestamp_ms(arg10),
            is_platform_coin : false,
            is_active        : true,
        };
        if (!0x2::table::contains<address, UserStaking>(&arg0.users, v0)) {
    ...
    public entry fun stake_destroy_yusd_coin<T0, T1>(arg0: &mut StakingPool<T1>, arg1: &mut PoolInfo<T0>, arg2: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::config::GlobalConfigMap, arg3: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::GlobalConfigMap, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 8);
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(arg5 >= 100, 1);
        assert!(is_eco_coin<T1>(arg0, &arg1.coin_type), 2);
        let v1 = 0x2::coin::value<T0>(&arg4);
        assert!(v1 >= 0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::usdc_to_token(arg3, arg1.coin_type, arg5), 11);
    ...
    public entry fun stake_l_coinV2<T0, T1>(arg0: &mut StakingPool<T0>, arg1: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::GlobalConfigMap, arg2: &mut PoolInfo<T0>, arg3: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::config::GlobalConfigMap, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 8);
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(arg5 >= 100, 1);
        let v1 = 0x2::coin::value<T0>(&arg4);
        assert!(v1 >= 0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::usdc_to_token(arg1, arg0.platform_coin, arg5), 11);
    ...
    public entry fun stake_l_coin_burnV1<T0, T1>(arg0: &mut StakingPool<T0>, arg1: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::GlobalConfigMap, arg2: &mut PoolInfo<T0>, arg3: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::config::GlobalConfigMap, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 8);
        ...
        let v3 = calculate_powerV1(arg5, arg3, v2);
        arg0.order_counter = arg0.order_counter + 1;
        let v4 = 0x2::object::id_from_address(0x2::tx_context::fresh_object_address(arg8));
        let v5 = StakingOrder{
            id               : v4,
            stake_amount     : arg5,
            coin_amount      : 0,
    ...
    public entry fun stake_l_vipV2<T0, T1, T2>(arg0: &mut StakingPool<T1>, arg1: &mut VipPoolInfo<T1>, arg2: &mut StakingPool<T0>, arg3: &mut VipPoolInfo<T0>, arg4: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::GlobalConfigMap, arg5: 0x2::coin::Coin<T0>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!arg2.is_paused, 8);
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(arg6 >= 100, 1);
        let v1 = 0x2::coin::value<T0>(&arg5);
        assert!(v1 >= 0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::usdc_to_token(arg4, arg2.platform_coin, arg6), 11);
    ...
    public entry fun stake_sui_coinV2<T0, T1, T2>(arg0: &mut StakingPool<T0>, arg1: &mut PoolInfo<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T1>, arg3: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::GlobalConfigMap, arg4: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::config::GlobalConfigMap, arg5: 0x2::coin::Coin<T1>, arg6: 0x2::coin::Coin<T0>, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 8);
        let v0 = 0x2::tx_context::sender(arg9);
        assert!(arg7 >= 100, 1);
        ...
        assert!(v5 >= 0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::usdc_to_token(arg3, arg0.platform_coin, arg7 * v4 / 100), 7);
    ...
    public entry fun stake_yusd_coinV2<T0, T1, T2>(arg0: &mut StakingPool<T2>, arg1: &mut PoolInfo<T0>, arg2: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::price_oracle::GlobalConfigMap, arg3: &0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::config::GlobalConfigMap, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T2>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 8);
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(arg6 >= 100, 1);
        assert!(is_eco_coin<T2>(arg0, &arg1.coin_type), 2);
