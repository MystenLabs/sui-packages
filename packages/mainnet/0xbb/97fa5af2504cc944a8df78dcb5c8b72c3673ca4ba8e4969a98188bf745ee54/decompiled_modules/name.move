module 0x62c1f5b1cb9e3bfc3dd1f73c95066487b662048a6358eabdbf67f6cdeca6db4b::name {
    ...
    public fun app(arg0: &Name) : &0x1::string::String {
        assert!(0x1::vector::length<0x1::string::String>(&arg0.app) == 1, 9223372273078108163);
    ...
    fun get_tld_symbol(arg0: &0x1::string::String) : 0x1::string::String {
        ...
        assert!(arg0 == &v0, 9223372655330328581);
        0x1::string::utf8(b"@")
    }
    ...
    public(friend) fun validate_labels(arg0: &vector<0x1::string::String>) {
        assert!(!0x1::vector::is_empty<0x1::string::String>(arg0), 9223372517891112961);
        let v0 = 0;
        while (v0 < 0x1::vector::length<0x1::string::String>(arg0)) {
            assert!(is_valid_label(0x1::vector::borrow<0x1::string::String>(arg0, v0)), 9223372526481047553);
            v0 = v0 + 1;
        };
    }
