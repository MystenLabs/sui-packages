module 0xbb46fdb9bfb71af0c7626bc3d2247f90dfa3896b59a35ede0fea1e9648fa76da::vault_core {
    struct VaultInfo has store {
        delegate: address,
        intent_ref_hash: address,
        amount: u64,
        expiry: u64,
        frozen: bool,
    }
    ...
    public(friend) fun create_delegation<T0>(arg0: &mut ResourceVault<T0>, arg1: address, arg2: address, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = generate_resource_vault_id<T0>(arg1);
        if (0x2::table::contains<vector<u8>, VaultInfo>(&arg0.vaults, v1)) {
            ...
            v2.expiry = v0;
            v2.frozen = false;
            v2.intent_ref_hash = arg2;
            v2.delegate = arg1;
            let v3 = Delegated{
                vault_id        : v1,
                delegate        : arg1,
                intent_ref_hash : arg2,
                amount          : arg3,
                expiry          : v0,
            };
            0x2::event::emit<Delegated>(v3);
        } else {
            let v4 = VaultInfo{
                delegate        : arg1,
                intent_ref_hash : arg2,
            ...
            0x2::table::add<vector<u8>, VaultInfo>(&mut arg0.vaults, v1, v4);
            let v5 = Delegated{
                vault_id        : v1,
                delegate        : arg1,
                intent_ref_hash : arg2,
