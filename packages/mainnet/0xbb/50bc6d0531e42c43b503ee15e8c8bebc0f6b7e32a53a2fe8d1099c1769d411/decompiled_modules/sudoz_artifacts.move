module 0xbb50bc6d0531e42c43b503ee15e8c8bebc0f6b7e32a53a2fe8d1099c1769d411::sudoz_artifacts {
    ...
    public entry fun bulk_level_up(arg0: 0x2::object::ID, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::kiosk::borrow_mut<Nft>(arg2, arg3, arg0);
        assert!(v0.level == 0, 3);
        let v1 = 55 * 1000000000;
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= v1, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v1, arg5), @0xf1df42d3b603f6d22fc276c25dd1eee4c3f767d7a7e7ec36bf9c3d416a74e228);
        ...
        let v3 = 0x2::random::generate_u8(&mut v2) % 7 + 1;
        v0.path = v3;
        v0.level = 10;
        v0.points = 2 + (10 as u64);
        v0.total_invested = v1;
        ...
        0x2::event::emit<LevelUpEvent>(v4);
    }
    ...
    fun init(arg0: SUDOZ_ARTIFACTS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://tVHvHhsxTrqh4jMdJCkB8tlXy4IS0_I-onA7QKgIuH4"));
    ...
    public entry fun level_up(arg0: 0x2::object::ID, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::kiosk::borrow_mut<Nft>(arg2, arg3, arg0);
        assert!(v0.level < 10, 2);
        let v1 = v0.level + 1;
        let v2 = 1000000000 * (v1 as u64);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= v2, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v2, arg5), @0xf1df42d3b603f6d22fc276c25dd1eee4c3f767d7a7e7ec36bf9c3d416a74e228);
        if (0x2::coin::value<0x2::sui::SUI>(&arg1) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, 0x2::tx_context::sender(arg5));
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(arg1);
        ...
        if (v0.level == 0) {
            ...
            let v5 = 0x2::random::generate_u8(&mut v4) % 7 + 1;
            v3 = v5;
            v0.path = v5;
        };
        v0.level = v1;
        v0.points = v0.points + 1;
        v0.total_invested = v0.total_invested + v2;
