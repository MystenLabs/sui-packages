module 0xbb727b70cdf6f62a82447d41eff7224ee9ea02bf18f587e7c0369900d9036ad6::reward7865 {
    struct REWARD7865 has drop {
        dummy_field: bool,
    }

    struct TICKET_7865 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7865(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7865>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7865>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7865, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7865>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7865>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7865>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7865>>(v5, 0x2::tx_context::sender(arg1));
    }
