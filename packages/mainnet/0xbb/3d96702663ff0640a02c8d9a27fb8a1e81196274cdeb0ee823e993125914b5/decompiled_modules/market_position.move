module 0xbb3d96702663ff0640a02c8d9a27fb8a1e81196274cdeb0ee823e993125914b5::market_position {
    ...
    public(friend) fun decrease_lp_amount(arg0: &mut MarketPosition, arg1: u64, arg2: &0x2::clock::Clock) {
        ...
        arg0.lp_amount_display = u64_to_float_string(arg0.lp_amount);
    ...
    public fun join(arg0: &mut MarketPosition, arg1: MarketPosition, arg2: &0x2::clock::Clock) {
        assert!(market_state_id(arg0) == market_state_id(&arg1), 0x696345bc36a218f6d37c2ef8396ae0f5fc64fa341ec7a2858f8884e07cf5e781::error::market_invalid_market_position());
    ...
    public(friend) fun set_lp_amount(arg0: &mut MarketPosition, arg1: u64, arg2: &0x2::clock::Clock) {
        arg0.lp_amount = arg1;
        arg0.lp_amount_display = u64_to_float_string(arg1);
        set_expiry_days(arg0, arg2);
    }
