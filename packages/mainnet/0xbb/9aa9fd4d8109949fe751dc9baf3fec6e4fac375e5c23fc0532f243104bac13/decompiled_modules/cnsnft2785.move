module 0xbb9aa9fd4d8109949fe751dc9baf3fec6e4fac375e5c23fc0532f243104bac13::cnsnft2785 {
    struct CNSNFT2785 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2785, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2785>(arg0, arg1);
