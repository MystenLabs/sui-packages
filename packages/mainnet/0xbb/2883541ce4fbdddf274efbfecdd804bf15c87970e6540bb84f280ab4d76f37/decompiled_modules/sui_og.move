module 0xbb2883541ce4fbdddf274efbfecdd804bf15c87970e6540bb84f280ab4d76f37::sui_og {
    ...
    fun init(arg0: SUI_OG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"How OG are you?"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://KSOBqXocuG6HWxKyUPE7LUaVTu803wn6PvZT1mgmdSU"));
