module 0xbbd5cab7ffcffe99cce1fcc72de34a2bb7e03013c29f40b6dd5e05a3cfb540f0::oracle {
    ...
    entry fun update_with_pyth(arg0: &mut Oracle, arg1: &0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::state::State, arg2: &0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::price_info::PriceInfoObject, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0xbbd5cab7ffcffe99cce1fcc72de34a2bb7e03013c29f40b6dd5e05a3cfb540f0::pyth_parser::get_price(arg1, arg2, arg3);
        assert!(v1 > 0, 2);
        ...
        let (v5, v6, v7) = 0xbbd5cab7ffcffe99cce1fcc72de34a2bb7e03013c29f40b6dd5e05a3cfb540f0::pyth_parser::get_ema_price(arg2);
        assert!(v5 > 0, 2);
    ...
    entry fun update_with_switchboard(arg0: &mut Oracle, arg1: &0x8d79f4d920b03d88faca1e421af023a87fbb1e4a6fd200248e6e9998d09e470::aggregator::Aggregator, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0xbbd5cab7ffcffe99cce1fcc72de34a2bb7e03013c29f40b6dd5e05a3cfb540f0::switchboard_feed_parser::log_aggregator_info(arg1);
        assert!(v2 > 0, 2);
        let v4 = (v3 as u64);
