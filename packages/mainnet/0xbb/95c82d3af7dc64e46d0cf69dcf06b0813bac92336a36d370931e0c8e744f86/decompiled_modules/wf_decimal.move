module 0xc5e95051a7fb49b09c0b545e08c0da16cb19fff9ac9be844b6ee46fdfc487639::wf_decimal {
    ...
    public fun from_native_token(arg0: u64, arg1: u8) : Decimal {
        let v0 = pow(from(10), ((18 - arg1) as u64));
        Decimal{value: (arg0 as u256) * v0.value}
    }
    ...
    public fun to_native_token(arg0: Decimal, arg1: u8) : u64 {
        let v0 = pow(from(10), ((18 - arg1) as u64));
        ((arg0.value / v0.value) as u64)
    }
