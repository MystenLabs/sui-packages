module 0xbbcf52c5f79f54953f3d8ea60c7f24f49d0f34353c2ab3ad9b647bcc774029ca::reward2094 {
    struct REWARD2094 has drop {
        dummy_field: bool,
    }

    struct TICKET_2094 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2094(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2094>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2094>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2094, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2094>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2094>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2094>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2094>>(v5, 0x2::tx_context::sender(arg1));
    }
