module 0xbb97b707e0b7856cb5b911eb7374aa142628f292b31a95d825b0bfd9660ff59c::reward1892 {
    struct REWARD1892 has drop {
        dummy_field: bool,
    }

    struct TICKET_1892 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1892(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1892>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1892>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1892, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1892>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1892>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1892>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1892>>(v5, 0x2::tx_context::sender(arg1));
    }
