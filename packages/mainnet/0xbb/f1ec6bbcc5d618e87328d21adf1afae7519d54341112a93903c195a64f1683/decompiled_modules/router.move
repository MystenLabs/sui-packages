module 0xbbf1ec6bbcc5d618e87328d21adf1afae7519d54341112a93903c195a64f1683::router {
    ...
    public entry fun add_signer(arg0: &PauseConfig, arg1: &AdminCap, arg2: &mut ValidSigner, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<vector<u8>>(&arg2.addresses)) {
            assert!(0x1::vector::borrow<vector<u8>>(&arg2.addresses, v0) != &arg3, 13);
            v0 = v0 + 1;
        };
    ...
    public fun finalize_sigverify<T0>(arg0: &PauseConfig, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: address, arg5: u64, arg6: u8, arg7: &ValidSigner, arg8: u64, arg9: vector<u8>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        check_pause(arg0);
        let v0 = &mut arg9;
        assert!(verify(arg7, 0x2::tx_context::sender(arg11), arg8, v0, arg10), 14);
    ...
    fun verify(arg0: &ValidSigner, arg1: address, arg2: u64, arg3: &mut vector<u8>, arg4: &0x2::clock::Clock) : bool {
        assert!(0x2::clock::timestamp_ms(arg4) < arg2, 11);
        assert!(0x1::vector::length<u8>(arg3) == 65, 15);
        let v0 = 0x1::vector::empty<u8>();
