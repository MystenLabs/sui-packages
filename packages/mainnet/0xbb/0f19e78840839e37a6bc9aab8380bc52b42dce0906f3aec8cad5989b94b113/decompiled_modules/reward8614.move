module 0xbb0f19e78840839e37a6bc9aab8380bc52b42dce0906f3aec8cad5989b94b113::reward8614 {
    struct REWARD8614 has drop {
        dummy_field: bool,
    }

    struct TICKET_8614 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8614(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8614>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8614>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8614, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8614>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8614>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8614>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8614>>(v5, 0x2::tx_context::sender(arg1));
    }
