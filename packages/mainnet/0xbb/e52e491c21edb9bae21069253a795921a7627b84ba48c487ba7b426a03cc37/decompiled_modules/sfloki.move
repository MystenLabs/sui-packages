module 0xbbe52e491c21edb9bae21069253a795921a7627b84ba48c487ba7b426a03cc37::sfloki {
    ...
    fun init(arg0: SFLOKI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SFLOKI>(arg0, 9, b"SFLOKI", b"SuiFloki-Inu", b"The first meme token on Sui Blockchain", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://imagetolink.com/ib/rkpC1XLgPz.png")), arg1);
