module 0xab98a0a7e0c9550e7aa721e6ada11b24f4301fc8d8de9a84cbef9eea4a7e8574::alphalend_liq {
    ...
    public fun flash_liq_alphalend_2hop_bfA_mA<T0, T1, T2>(arg0: &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::flash_loan::Config, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T2>, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg7: &mut 0x3::sui_system::SuiSystemState, arg8: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg9: 0x2::object::ID, arg10: u64, arg11: u64, arg12: u64, arg13: u128, arg14: u128, arg15: u64, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::flash_loan_with_ctx_v2<T0>(arg0, arg6, arg12, arg7, arg17);
        let (v2, v3) = 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::liquidate<T0, T1>(arg8, arg9, arg10, arg11, 0x2::coin::from_balance<T0>(v0, arg17), arg16, arg17);
        let v4 = 0x2::coin::into_balance<T0>(v3);
        let v5 = 0x2::coin::into_balance<T1>(0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise<T1>(arg8, v2, arg16, arg17));
        let v6 = 0x2::balance::value<T1>(&v5);
        assert!(v6 > 0, 1);
        let (v7, v8) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T1, T2>(arg16, arg2, arg3, v5, 0x2::balance::zero<T2>(), true, true, v6, 0, arg13);
        let v9 = v8;
        0x2::balance::destroy_zero<T1>(v7);
        let v10 = swap_all_a_for_b<T2, T0>(arg1, arg4, v9, arg14, arg16);
        0x2::balance::join<T0>(&mut v4, v10);
        let v11 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::flash_repay_with_ctx<T0>(arg16, arg5, arg6, v1, v4, arg17);
        let v12 = 0x2::balance::value<T0>(&v11);
        let v13 = AlphaCross2HopDiag{
            flash_amount   : arg12,
            leftover_debt  : 0x2::balance::value<T0>(&v4),
            coll_seized    : v6,
            mid_received   : 0x2::balance::value<T2>(&v9),
            debt_from_coll : 0x2::balance::value<T0>(&v10),
            final_profit   : v12,
            variant        : 4,
        };
        0x2::event::emit<AlphaCross2HopDiag>(v13);
        assert!(v12 >= arg15, 0);
