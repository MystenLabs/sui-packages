module 0xbb0b66817016512b374f1b9d3db307f91ecb3743fa340dad4c3eb15e073625f3::reward6867 {
    struct REWARD6867 has drop {
        dummy_field: bool,
    }

    struct TICKET_6867 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6867(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6867>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6867>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6867, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6867>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6867>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6867>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6867>>(v5, 0x2::tx_context::sender(arg1));
    }
