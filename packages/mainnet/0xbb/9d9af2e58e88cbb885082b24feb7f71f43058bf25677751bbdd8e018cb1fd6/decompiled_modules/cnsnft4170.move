module 0xbb9d9af2e58e88cbb885082b24feb7f71f43058bf25677751bbdd8e018cb1fd6::cnsnft4170 {
    struct CNSNFT4170 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4170, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4170>(arg0, arg1);
