module 0xdaa3f8b4f88d04695ec91161b4a2c1dfe1fbea6c9268eeb1801b0e12e642441d::referral {
    ...
    fun assert_valid_commission_multiplier(arg0: u64) {
        assert!(arg0 >= 200000000 && arg0 <= 1000000000, 13841815009504067626);
    }

    fun assert_valid_version(arg0: &ReferralRegistry) {
        let v0 = package_version();
        assert!(0x2::vec_set::contains<u64>(&arg0.version_set, &v0), 13841251673003327526);
    }
    ...
    public fun claim_commission_balance<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(0x2::dynamic_object_field::exists_<ReferrerKey>(&v2.id, v3), 13835342888923758600);
        let v4 = 0x2::dynamic_object_field::borrow_mut<ReferrerKey, ReferrerData>(&mut v2.id, v3);
        let v5 = ReferrerBalanceKey{pos0: v1};
        assert!(0x2::dynamic_object_field::exists_<ReferrerBalanceKey>(&v4.id, v5), 13835342931873431560);
    ...
    public fun claim_partner_balance<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v2 = borrow_referral_registry_mut(arg0);
        let v3 = ReferrerKey{referrer: v0};
        assert!(0x2::dynamic_object_field::exists_<ReferrerKey>(&v2.id, v3), 13835343138031861768);
        let v4 = 0x2::dynamic_object_field::borrow_mut<ReferrerKey, ReferrerData>(&mut v2.id, v3);
        assert!(v4.is_partner, 13840128242702155806);
        let v5 = PartnerBalanceKey{pos0: v1};
        assert!(0x2::dynamic_object_field::exists_<PartnerBalanceKey>(&v4.id, v5), 13835343185276502024);
    ...
    public fun claim_referrer_level_up_usd_rewards<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let (v0, v1, v2) = prepare_referrer_level_up_usd_claim<T0>(arg0, arg3);
        let (v3, v4, _) = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::get_checked_usd_price(arg0, v0, arg1, arg2);
        settle_referrer_level_up_usd_claim<T0>(arg0, v1, v2, v3, v4, arg3)
    }

    public fun claim_referrer_level_up_usd_rewards_v2<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let (v0, v1, v2) = prepare_referrer_level_up_usd_claim<T0>(arg0, arg3);
        let (v3, v4, _) = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::get_checked_usd_price_v2(arg0, v0, arg1, arg2);
        settle_referrer_level_up_usd_claim<T0>(arg0, v1, v2, v3, v4, arg3)
    }
    ...
    fun edit_referral_registry_internal(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: bool, arg2: u64, arg3: u64, arg4: u64, arg5: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg6: 0x2::vec_map::VecMap<u64, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>) {
        ...
        assert!(arg2 <= 10000000, 13837594151867449366);
        assert!(arg3 <= 10000000, 13838438593977581592);
        assert_valid_commission_multiplier(arg4);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_negative(&arg5), 13840971890243600420);
        ...
        while (v5 < 0x1::vector::length<0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>(&v3)) {
            assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_positive_or_zero(0x1::vector::borrow<0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>(&v3, v5)), 13839283070447452186);
            assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::le(0x1::vector::borrow<0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>(&v3, v5), &v4), 13839564549719261212);
            v5 = v5 + 1;
        };
        v0.is_enabled = arg1;
    ...
    fun edit_referrer_data_internal(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: address, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<bool>) {
        ...
        assert!(0x2::dynamic_object_field::exists_<ReferrerKey>(&v0.id, v1), 13835341965505789960);
        let v2 = 0x2::dynamic_object_field::borrow_mut<ReferrerKey, ReferrerData>(&mut v0.id, v1);
        if (0x1::option::is_some<u64>(&arg2)) {
            assert!(*0x1::option::borrow<u64>(&arg2) <= 10000000, 13836749361864835090);
        };
        if (0x1::option::is_some<u64>(&arg3)) {
            assert!(*0x1::option::borrow<u64>(&arg3) <= 10000000, 13837312328998256660);
        };
        v2.special_commission_rate = arg2;
        v2.special_partner_commission_rate = arg3;
        if (0x1::option::is_some<u64>(&arg4)) {
            let v3 = *0x1::option::borrow<u64>(&arg4);
            assert!(v3 <= 1000000000, 13840408583807631392);
    ...
    fun link_referrer_referee(arg0: &mut ReferralRegistry, arg1: address, arg2: address, arg3: 0x1::option::Option<address>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.is_enabled, 13835904395768430604);
        assert!(arg1 != arg2, 13836467350017081360);
        assert!(!is_reciprocal_referral(arg0, arg1, arg2), 13842096862438031404);
        let v0 = RefereeKey{referee: arg1};
        assert!(!0x2::dynamic_object_field::exists_<RefereeKey>(&arg0.id, v0), 13836185900810043406);
        let v1 = RefereeData{
    ...
    fun prepare_referrer_level_up_usd_claim<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: &0x2::tx_context::TxContext) : (0x1::type_name::TypeName, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, u8) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::get_dollar_coin_type(arg0) == v0, 13835624990965825546);
        let v1 = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::get_coin_decimals<T0>(arg0);
        let v2 = borrow_referral_registry_mut(arg0);
        let v3 = ReferrerKey{referrer: 0x2::tx_context::sender(arg1)};
        assert!(0x2::dynamic_object_field::exists_<ReferrerKey>(&v2.id, v3), 13835343571823558664);
        (v0, 0x2::dynamic_object_field::borrow_mut<ReferrerKey, ReferrerData>(&mut v2.id, v3).usd_rewards_balance, v1)
    }

    fun remove_version_internal(arg0: &mut ReferralRegistry, arg1: u64) {
        assert!(0x2::vec_set::contains<u64>(&arg0.version_set, &arg1), 13841533367023501352);
    ...
    entry fun set_my_referrer(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1.is_enabled, 13835906856784691212);
        assert!(can_set_referrer(v1, v0), 13840691944275116066);
        let v2 = RefereeKey{referee: v0};
        if (0x2::dynamic_object_field::exists_<RefereeKey>(&v1.id, v2)) {
            return
        };
        assert!(!is_reciprocal_referral(v1, v0, arg1), 13842099349224095788);
    ...
    public fun settle_referral_rewards<T0, T1: drop>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: &0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::core::StakeTicket<T0, T1>, arg2: 0x1::option::Option<address>, arg3: 0x1::option::Option<address>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        settle_referral_rewards_internal<T0, T1>(arg0, arg1, arg2, arg3, arg5, arg6);
    }

    fun settle_referral_rewards_internal<T0, T1: drop>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: &0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::core::StakeTicket<T0, T1>, arg2: 0x1::option::Option<address>, arg3: 0x1::option::Option<address>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v4) {
            ...
            try_link_referrer_from_option(v5, v0, &arg2, &arg3, arg4, arg5);
        };
        let v6 = borrow_referral_registry_mut(arg0);
        accrue_total_wagered_usd(v6, v0, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::core::get_total_stake_usd_value_if_exists<T0, T1>(arg1), arg5);
        if (!v4) {
            return
        };
        settle_vip_level_up_usd_rewards(arg0, v0, arg5);
        let v7 = false;
        let v8 = @0x0;
        ...
        if (0x1::option::is_some<address>(&arg3)) {
            ...
            assert!(0x2::dynamic_object_field::exists_<ReferrerKey>(&v16.id, v17), 13840129986458877982);
            let v18 = 0x2::dynamic_object_field::borrow<ReferrerKey, ReferrerData>(&v16.id, v17);
            assert!(v18.is_partner, 13840130003638747166);
    ...
    public fun settle_referral_rewards_v2<T0, T1: drop>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: &0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::core::StakeTicket<T0, T1>, arg2: 0x1::option::Option<address>, arg3: 0x1::option::Option<address>, arg4: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        settle_referral_rewards_internal<T0, T1>(arg0, arg1, arg2, arg3, arg5, arg6);
    }

    public fun settle_referral_rewards_with_quote<T0, T1: drop>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: &0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::core::StakeTicket<T0, T1>, arg2: 0x1::option::Option<address>, arg3: 0x1::option::Option<address>, arg4: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::PriceQuote, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        settle_referral_rewards_internal<T0, T1>(arg0, arg1, arg2, arg3, arg5, arg6);
    }

    fun settle_referrer_level_up_usd_claim<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg2: u8, arg3: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg4: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::price_upper_bound(arg3, arg4);
        let v2 = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::floor_to_u64(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::div(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::mul(arg1, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::from_u64(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::math::pow_u64(10, (arg2 as u64)))), v1));
        let v3 = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::div(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::mul(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::from_u64(v2), v1), 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::from_u64(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::math::pow_u64(10, (arg2 as u64))));
        let v4 = borrow_referral_registry_mut(arg0);
        let v5 = ReferrerKey{referrer: v0};
        0x2::dynamic_object_field::borrow_mut<ReferrerKey, ReferrerData>(&mut v4.id, v5).usd_rewards_balance = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::positive_part(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::sub(arg1, v3));
        let v6 = Referral{dummy_field: false};
        let v7 = ReferrerClaimLevelUpUsdRewardsEvent{
            referrer              : v0,
            usd_amount            : v3,
            dollar_coin_type      : 0x1::type_name::with_defining_ids<T0>(),
            dollar_amount         : v2,
            dollar_coin_decimals  : arg2,
            stablecoin_price      : arg3,
            stablecoin_confidence : arg4,
            payout_price          : v1,
        };
        0x2::event::emit<ReferrerClaimLevelUpUsdRewardsEvent>(v7);
        0x2::coin::from_balance<T0>(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::operator_take_from_rakeback_pool<T0, Referral>(arg0, v6, v2), arg5)
    }
