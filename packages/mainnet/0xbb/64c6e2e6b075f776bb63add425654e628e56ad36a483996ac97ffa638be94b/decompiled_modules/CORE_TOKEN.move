module 0xbb64c6e2e6b075f776bb63add425654e628e56ad36a483996ac97ffa638be94b::CORE_TOKEN {
    ...
    fun init(arg0: CORE_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CORE_TOKEN>(arg0, 6, b"CORE", b"CORE Token", b"Token with 1M supply", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://verse-tokens.b-cdn.net/battle.png")), arg1);
        let v2 = v0;
        let v3 = TokenConfig{
