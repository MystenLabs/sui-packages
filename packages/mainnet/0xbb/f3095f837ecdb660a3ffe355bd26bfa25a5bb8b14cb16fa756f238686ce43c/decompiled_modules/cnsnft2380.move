module 0xbbf3095f837ecdb660a3ffe355bd26bfa25a5bb8b14cb16fa756f238686ce43c::cnsnft2380 {
    struct CNSNFT2380 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2380, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2380>(arg0, arg1);
