module 0xbb1aa87d0f0add3d2a06eb0e94f9ca481e1396d38ad6e2bd67b65eea6cc064cb::reward9775 {
    struct REWARD9775 has drop {
        dummy_field: bool,
    }

    struct TICKET_9775 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9775(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9775>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9775>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9775, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9775>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9775>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9775>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9775>>(v5, 0x2::tx_context::sender(arg1));
    }
