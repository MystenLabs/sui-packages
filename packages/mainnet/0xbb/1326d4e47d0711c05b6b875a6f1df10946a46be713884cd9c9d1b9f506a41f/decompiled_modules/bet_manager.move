module 0x825b0b75efc9e37ce6268890e78e078591d8826dd9fcdde1adee6201399df182::bet_manager {
    ...
    public fun get_bet_result_and_payout(arg0: u64, arg1: 0x1::option::Option<u64>, arg2: u64, arg3: &0x2::vec_set::VecSet<u64>, arg4: u64, arg5: u64, arg6: u64) : (bool, bool, u64) {
        ...
        if (arg0 == 11) {
            ...
            if (v45 == arg5) {
                let (v46, v47) = 0x825b0b75efc9e37ce6268890e78e078591d8826dd9fcdde1adee6201399df182::dice_interpreter::get_dice(arg4);
                if (v46 == v47) {
                    if (v45 == 4 || v45 == 10) {
                        return (true, false, mul(arg2, 7000000000))
                    };
