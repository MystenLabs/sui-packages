module 0xbb64210dc8913b1dee09434ad45f4920e661cf85e6406b4ce7f9e9a596f552b4::wrapper {
    ...
    public fun admin_withdraw_deep_reserves_coverage_fee<T0>(arg0: &mut Wrapper, arg1: &0xbb64210dc8913b1dee09434ad45f4920e661cf85e6406b4ce7f9e9a596f552b4::admin::AdminCap, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        withdraw_deep_reserves_coverage_fee_internal<T0>(arg0, arg2)
    }

    public fun admin_withdraw_protocol_fee<T0>(arg0: &mut Wrapper, arg1: &0xbb64210dc8913b1dee09434ad45f4920e661cf85e6406b4ce7f9e9a596f552b4::admin::AdminCap, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
    ...
    public fun create_fund_cap(arg0: &Wrapper, arg1: &0xbb64210dc8913b1dee09434ad45f4920e661cf85e6406b4ce7f9e9a596f552b4::admin::AdminCap, arg2: &mut 0x2::tx_context::TxContext) : FundCap {
        FundCap{
    ...
    public fun withdraw_deep_reserves(arg0: &mut Wrapper, arg1: &0xbb64210dc8913b1dee09434ad45f4920e661cf85e6406b4ce7f9e9a596f552b4::admin::AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP> {
    ...
    public fun withdraw_deep_reserves_coverage_fee<T0>(arg0: &mut Wrapper, arg1: &FundCap, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg1.wrapper_id == 0x2::object::uid_to_inner(&arg0.id), 13906834406271614977);
        withdraw_deep_reserves_coverage_fee_internal<T0>(arg0, arg2)
    }
