module 0x971d70b4e40312c953adf5f773f326844a03708b0f0dfdb38cc006fc180a48dd::rotation_adapters {
    ...
    public fun open_bluefin_deep_sui_and_deep_usdc<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &Registry, arg2: &BluefinDeepUsdcPortfolioCap<T0, T1, T2>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T2>, arg7: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg8: u64, arg9: u64, arg10: u32, arg11: u32, arg12: u64, arg13: bool, arg14: u64, arg15: bool, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: &mut 0x2::tx_context::TxContext) {
        ...
        let v14 = swap_bluefin_a_to_b<T1, T2>(arg0, arg3, arg6, 0x2::balance::split<T1>(&mut v7, arg9));
        let v15 = v14;
        let (v16, v17) = centered_range(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg4), arg10, 1);
        let v18 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg3, arg4, v16, v17, arg26);
        let (v19, v20, v21, v22) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg0, arg3, arg4, &mut v18, v8, v7, arg12, arg13);
        v8 = v21;
        v7 = v22;
        ...
        let v25 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T2>(arg3, arg5, v23, v24, arg26);
        let (v26, v27, v28, v29) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T2>(arg0, arg3, arg5, &mut v25, v13, v15, arg14, arg15);
        v15 = v29;
        0x2::balance::join<T0>(&mut v8, v28);
        let v30 = 0x2::balance::value<T0>(&v8);
        let v31 = 0x2::balance::value<T1>(&v7);
        let v32 = 0x2::balance::value<T2>(&v15);
        assert!(v19 >= arg19, 8);
        assert!(v20 >= arg20, 9);
        assert!(v26 >= arg21, 8);
        assert!(v27 >= arg22, 9);
        ...
        assert!(v31 <= arg24, 11);
        assert!(v32 <= arg25, 11);
        let v33 = BluefinDeepUsdcPortfolioOpened{
            route_id               : 0x2::object::id<BluefinDeepUsdcPortfolioCap<T0, T1, T2>>(arg2),
            source_position_id     : 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&arg7),
            primary_position_id    : 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&v18),
            farm_position_id       : 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&v25),
            reward_deep            : 0x2::balance::value<T0>(&v0),
            fee_deep               : 0x2::balance::value<T0>(&v6),
            fee_sui                : 0x2::balance::value<T1>(&v5),
            profit_sui             : v12,
            ...
            farm_usdc_out          : 0x2::balance::value<T2>(&v14),
            primary_deposited_deep : v19,
            primary_deposited_sui  : v20,
            farm_deposited_deep    : v26,
            farm_deposited_usdc    : v27,
            primary_tick_lower     : v16,
            primary_tick_upper     : v17,
            farm_tick_lower        : v23,
            farm_tick_upper        : v24,
            residual_deep          : v30,
            residual_sui           : v31,
        ...
        0x2::event::emit<BluefinDeepUsdcPortfolioOpened>(v33);
        0x2::transfer::public_transfer<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(v18, 0x2::tx_context::sender(arg26));
        0x2::transfer::public_transfer<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(v25, 0x2::tx_context::sender(arg26));
        let v34 = 0x2::tx_context::sender(arg26);
        transfer_nonzero<T0>(v8, v34, arg26);
        let v35 = 0x2::tx_context::sender(arg26);
        transfer_nonzero<T1>(v7, v35, arg26);
        let v36 = 0x2::tx_context::sender(arg26);
        transfer_nonzero<T2>(v15, v36, arg26);
    }
