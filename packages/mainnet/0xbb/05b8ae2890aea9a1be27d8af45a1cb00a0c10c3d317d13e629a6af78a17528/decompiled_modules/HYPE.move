module 0xbb05b8ae2890aea9a1be27d8af45a1cb00a0c10c3d317d13e629a6af78a17528::HYPE {
    ...
    fun init(arg0: HYPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<HYPE>(arg0, 9, b"HARRIS", b"Harris President", b"Harris President powered by Musk", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
