module 0xbbb932a45050c50c51208c327d404aafbbf29137779e13934501fe07e9df88d8::reward2255 {
    struct REWARD2255 has drop {
        dummy_field: bool,
    }

    struct TICKET_2255 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2255(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2255>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2255>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2255, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2255>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2255>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2255>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2255>>(v5, 0x2::tx_context::sender(arg1));
    }
