module 0xbb3286aa607d2bc05be3b15fa97784f5c534daae197a9dcd7bf7962e249ed297::reward4945 {
    struct REWARD4945 has drop {
        dummy_field: bool,
    }

    struct TICKET_4945 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4945(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4945>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4945>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4945, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4945>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4945>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4945>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4945>>(v5, 0x2::tx_context::sender(arg1));
    }
