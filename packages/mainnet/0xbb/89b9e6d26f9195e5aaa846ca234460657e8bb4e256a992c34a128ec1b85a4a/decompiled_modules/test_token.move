module 0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token {
    ...
    public entry fun update_symbol(arg0: &TreasuryLock, arg1: &mut 0x2::coin::CoinMetadata<TEST_TOKEN>, arg2: 0x1::ascii::String, arg3: 0x1::string::String, arg4: 0x1::string::String) {
        0x2::coin::update_symbol<TEST_TOKEN>(&arg0.treasury_cap, arg1, arg2);
        0x2::coin::update_name<TEST_TOKEN>(&arg0.treasury_cap, arg1, arg3);
        0x2::coin::update_description<TEST_TOKEN>(&arg0.treasury_cap, arg1, arg4);
    }
    ...
    fun init(arg0: TEST_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<TEST_TOKEN>(arg0, 9, b"TT", b"TEST_TOKEN", b"Utility Coin for TEST", 0x1::option::none<0x2::url::Url>(), arg1);
