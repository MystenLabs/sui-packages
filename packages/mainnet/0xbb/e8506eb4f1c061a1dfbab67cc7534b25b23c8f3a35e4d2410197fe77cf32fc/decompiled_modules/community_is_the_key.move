module 0xbbe8506eb4f1c061a1dfbab67cc7534b25b23c8f3a35e4d2410197fe77cf32fc::community_is_the_key {
    struct COMMUNITY_IS_THE_KEY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: COMMUNITY_IS_THE_KEY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<COMMUNITY_IS_THE_KEY>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Community is the key"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Community is the key. Deep together. "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://CZJavCO6QcWC7xdx1ZTaE_CexNQ2v6bMivOEKYaFqwA"));
