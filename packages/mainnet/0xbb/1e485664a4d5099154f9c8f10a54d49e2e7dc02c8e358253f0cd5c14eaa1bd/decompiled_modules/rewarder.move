module 0xbb1e485664a4d5099154f9c8f10a54d49e2e7dc02c8e358253f0cd5c14eaa1bd::rewarder {
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: u128, arg2: u64) {
        ...
        while (v2 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v2).growth_global = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).growth_global + 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::full_math_u128::mul_div_floor((v1 as u128), 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).emissions_per_second, arg1);
            v2 = v2 + 1;
        };
        arg0.points_released = arg0.points_released + (v1 as u128) * 18446744073709551616000000;
        arg0.points_growth_global = arg0.points_growth_global + 0x4e706dcaab822e4b2e753b855ffcaa0916989868fd5429b58e47591dfb3be::full_math_u128::mul_div_floor((v1 as u128), 18446744073709551616000000, arg1);
    }
    ...
    public(friend) fun update_emission<T0>(arg0: &RewarderGlobalVault, arg1: &mut RewarderManager, arg2: u128, arg3: u128, arg4: u64) {
        ...
        if (arg3 > 0) {
            ...
            assert!((0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg0.balances, v0)) as u128) << 64 >= 86400 * arg3, 4);
        };
