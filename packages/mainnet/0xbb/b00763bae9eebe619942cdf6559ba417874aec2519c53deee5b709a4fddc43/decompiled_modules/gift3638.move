module 0xbbb00763bae9eebe619942cdf6559ba417874aec2519c53deee5b709a4fddc43::gift3638 {
    struct GIFT3638 has drop {
        dummy_field: bool,
    }

    struct TICKET_3638 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3638(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3638>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3638>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3638, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3638>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3638>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3638>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3638>>(v5, 0x2::tx_context::sender(arg1));
    }
