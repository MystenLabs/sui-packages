module 0xbb431b2257bc66c3a106095e8d6110d791ac4393be980e7a448a0d2f9ce1b815::cnsnft9052 {
    struct CNSNFT9052 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9052, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9052>(arg0, arg1);
