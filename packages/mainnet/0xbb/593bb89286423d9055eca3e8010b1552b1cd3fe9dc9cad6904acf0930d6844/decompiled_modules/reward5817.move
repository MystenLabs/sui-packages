module 0xbb593bb89286423d9055eca3e8010b1552b1cd3fe9dc9cad6904acf0930d6844::reward5817 {
    struct REWARD5817 has drop {
        dummy_field: bool,
    }

    struct TICKET_5817 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5817(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5817>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5817>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5817, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5817>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5817>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5817>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5817>>(v5, 0x2::tx_context::sender(arg1));
    }
