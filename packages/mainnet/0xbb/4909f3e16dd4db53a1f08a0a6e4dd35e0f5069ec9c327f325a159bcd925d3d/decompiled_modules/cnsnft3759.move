module 0xbb4909f3e16dd4db53a1f08a0a6e4dd35e0f5069ec9c327f325a159bcd925d3d::cnsnft3759 {
    struct CNSNFT3759 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3759, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3759>(arg0, arg1);
