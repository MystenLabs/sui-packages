module 0xbb70eb0350dce545f25d482da25f04bd58f117bed3cb2b3f9efbc23446db6bf3::cnsnft7336 {
    struct CNSNFT7336 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7336, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7336>(arg0, arg1);
