module 0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid {
    ...
    struct Mermaid has store, key {
        ...
        number: u64,
        attributes: 0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::attributes::Attributes,
    }
    ...
    fun init(arg0: MERMAID, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::collection::display(&v4, arg1);
        ...
        0x2::transfer::public_share_object<0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::collection::Collection>(0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::collection::new(arg1));
    }
    ...
    public(friend) fun mint_nft(arg0: u64, arg1: vector<0x1::ascii::String>, arg2: vector<0x1::ascii::String>, arg3: &mut 0x2::tx_context::TxContext) : Mermaid {
        let v0 = Mermaid{
            ...
            number      : arg0,
            attributes  : 0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::attributes::new_from_vec(arg1, arg2),
        };
