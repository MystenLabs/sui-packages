module 0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mint {
    ...
    public entry fun claim_and_create_kiosk(arg0: 0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::AtlansuiLab, arg1: &0x2::transfer_policy::TransferPolicy<0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid::Mermaid>, arg2: &mut MintState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::get_slot_no(&arg0);
        let MintMetadata {
            attribute_keys   : v7,
            attribute_values : v8,
        } = get_metadata_by_id(arg2, v6);
        let v9 = 0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid::mint_nft(v6, v7, v8, arg3);
        0x1::vector::push_back<0x2::object::ID>(&mut v5, 0x2::object::id<0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid::Mermaid>(&v9));
        0x2::kiosk::lock<0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid::Mermaid>(&mut v2, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(&v3), arg1, v9);
    ...
    public entry fun claim_nfts_and_create_kiosk(arg0: vector<0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::AtlansuiLab>, arg1: &0x2::transfer_policy::TransferPolicy<0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid::Mermaid>, arg2: &mut MintState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::AtlansuiLab>(&arg0) > 0) {
            ...
            let v8 = 0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::get_slot_no(&v7);
            let MintMetadata {
                attribute_keys   : v9,
                attribute_values : v10,
            } = get_metadata_by_id(arg2, v8);
            let v11 = 0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid::mint_nft(v8, v9, v10, arg3);
            0x1::vector::push_back<0x2::object::ID>(&mut v6, 0x2::object::id<0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid::Mermaid>(&v11));
            0x2::kiosk::lock<0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid::Mermaid>(&mut v2, v4, arg1, v11);
    ...
    public entry fun claim_to_kiosk(arg0: 0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::AtlansuiLab, arg1: &mut MintState, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg4: &0x2::transfer_policy::TransferPolicy<0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid::Mermaid>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::get_slot_no(&arg0);
        let MintMetadata {
            attribute_keys   : v3,
            attribute_values : v4,
        } = get_metadata_by_id(arg1, v2);
        let v5 = 0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid::mint_nft(v2, v3, v4, arg5);
        0x1::vector::push_back<0x2::object::ID>(&mut v1, 0x2::object::id<0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid::Mermaid>(&v5));
        0x2::kiosk::lock<0xbb890909305629d1e4da77b58af172bcad7db1e7812e67c58972ee3ce9219458::mermaid::Mermaid>(arg2, v0, arg4, v5);
        0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::burn(arg0);
        let v6 = ClaimEvent{
