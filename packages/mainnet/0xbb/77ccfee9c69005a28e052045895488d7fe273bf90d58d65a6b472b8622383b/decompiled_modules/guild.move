module 0x270c5da0f0466be42e37ae9f88b48f00ec62f26e5705b19d05b3e66b77b3fff9::guild {
    ...
    public fun create_guild<T0>(arg0: &Config, arg1: &mut FeePool<T0>, arg2: &mut UserArchive, arg3: u128, arg4: vector<u8>, arg5: vector<u8>, arg6: 0x2::coin::Coin<T0>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::bcs::peel_u128(&mut v1) == arg3, 6013);
        assert!(v2 > 0 && 0x2::coin::value<T0>(&arg6) == v2, 6001);
        let v3 = update_user_nonce(arg2, 0x2::bcs::peel_u8(&mut v1), 0x2::bcs::peel_u128(&mut v1));
        arg2.last_updated_name = 0;
    ...
    public fun rename_guild<T0>(arg0: &Config, arg1: &mut FeePool<T0>, arg2: &mut UserArchive, arg3: u128, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: 0x2::coin::Coin<T0>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 6005);
        assert!(!arg0.paused, 6004);
        verify_signature(arg5, arg6, &arg0.validator);
        ...
        assert!(v1 > arg2.last_updated_name + 604800000, 6018);
        ...
        assert!(0x1::string::utf8(arg4) == 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v2)), 6019);
    ...
    public fun update_guild<T0>(arg0: &Config, arg1: &mut FeePool<T0>, arg2: &mut UserArchive, arg3: u128, arg4: u8, arg5: vector<u8>, arg6: vector<u8>, arg7: 0x2::coin::Coin<T0>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 6005);
        assert!(!arg0.paused, 6004);
        verify_signature(arg5, arg6, &arg0.validator);
        let v0 = 0x2::tx_context::sender(arg9);
        ...
        assert!(0x2::bcs::peel_address(&mut v1) == 0x2::object::id_address<FeePool<T0>>(arg1), 6002);
        assert!(0x2::bcs::peel_u128(&mut v1) == arg3, 6013);
        assert!(arg4 == 0x2::bcs::peel_u8(&mut v1), 6014);
