module 0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::multisig_escrow {
    ...
    struct Listing has store, key {
        ...
        min_price: u64,
        item: 0x1::option::Option<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::item::Item>,
    }
    ...
    struct Escrow<phantom T0> has store, key {
        ...
        fee_recipient: address,
        fee_amount: u64,
        buyer_warranty: 0x1::option::Option<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::Warranty>,
        warranty_price_recipient: address,
    }
    ...
    public entry fun cancel_escrow<T0>(arg0: &mut Listings, arg1: Escrow<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::Warranty>(&v10)) {
            0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::delete(0x1::option::extract<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::Warranty>(&mut v10));
        };
        0x1::option::destroy_none<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::Warranty>(v10);
    ...
    public entry fun cancel_listing(arg0: &mut Listings, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        ...
        let v6 = v5;
        let v7 = 0x1::option::extract<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::item::Item>(&mut v6);
        0x2::object::delete(v1);
        0x2::transfer::public_transfer<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::item::Item>(v7, 0x2::tx_context::sender(arg2));
        0x1::option::destroy_none<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::item::Item>(v6);
        let v8 = ListingCanceled{
            listing_id : 0x2::object::id<Listing>(&v0),
            seller     : 0x2::tx_context::sender(arg2),
            item_id    : 0x2::object::id<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::item::Item>(&v7),
        };
    ...
    public entry fun create_escrow_review<T0>(arg0: &mut Escrow<T0>, arg1: u64, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = if (arg0.listing.seller == v0) {
            0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::review::review_side_seller()
        } else {
            0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::review::review_side_buyer()
        };
        let v3 = 0x1::option::borrow<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::item::Item>(&arg0.listing.item);
        0x2::dynamic_field::add<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::review::ReviewKey, 0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::review::Review>(&mut arg0.id, v2, 0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::review::create_review(v0, 0x2::object::id<Escrow<T0>>(arg0), v1, 0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::item::get_asset_id(v3), 0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::item::get_asset_type(v3), 0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::item::get_asset_group_id(v3), arg1, arg2, arg3));
    }
    ...
    public entry fun fulfill_escrow<T0>(arg0: &mut Escrow<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<0x2::coin::Coin<T0>>(&arg0.payment)) {
            ...
            if (0x1::option::is_some<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::Warranty>(&arg0.buyer_warranty)) {
                let v1 = 0x1::option::extract<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::Warranty>(&mut arg0.buyer_warranty);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v0, 0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::price(&v1), arg2), arg0.warranty_price_recipient);
                0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::transfer_to_beneficiary(v1, 0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::activate_warranty(&mut v1, arg1));
            };
    ...
    public entry fun list(arg0: &mut Listings, arg1: 0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::item::Item, arg2: u64, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Listing{
            ...
            coin_type_name : arg3,
            min_price      : arg2,
            item           : 0x1::option::some<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::item::Item>(arg1),
        };
        ...
        let v2 = ListingCreated{
            ...
            coin_type_name : arg3,
            min_price      : arg2,
            item_id        : 0x2::object::id<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::item::Item>(&arg1),
        };
    ...
    public entry fun new_escrow<T0>(arg0: &mut Listings, arg1: 0x2::object::ID, arg2: address, arg3: 0x2::coin::Coin<T0>, arg4: vector<vector<u8>>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x1::option::none<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::Warranty>();
        if (0x1::vector::length<vector<u8>>(&arg4) > 0) {
            0x1::option::fill<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::Warranty>(&mut v3, 0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::new_warranty(v2, arg4, arg0.signer_public_key, arg5));
        };
        let v4 = v0.coin_type_name;
        let v5 = v0.min_price;
        check_coin_type_match<T0>(v4);
        let v6 = if (0x1::option::is_some<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::Warranty>(&v3)) {
            0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::price(0x1::option::borrow<0xbb5540954ff5ab47216707e9bdc68d0fe9696c9b167778fccfb51b4eeec00204::warranty::Warranty>(&v3))
        } else {
            0
        };
