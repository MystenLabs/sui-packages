module 0xbb206736ea8060ea548bfef58b6ff95f9aea746987348469da01124aaf1b0d7a::a {
    struct A has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: A, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<A>(arg0, 9, trim_right(b"a"), trim_right(b"a "), trim_right(b"a  "), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(trim_right(b"https://ipfs.io/ipfs/bafkreihvgcj5vdzqyvpk6w2xgfqyklcioosehzkcrkyrqwpwvl5oynct3q"))), arg1);
        let v2 = v0;
