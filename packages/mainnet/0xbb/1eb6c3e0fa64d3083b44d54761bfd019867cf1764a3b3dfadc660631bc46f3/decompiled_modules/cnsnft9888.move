module 0xbb1eb6c3e0fa64d3083b44d54761bfd019867cf1764a3b3dfadc660631bc46f3::cnsnft9888 {
    struct CNSNFT9888 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9888, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9888>(arg0, arg1);
