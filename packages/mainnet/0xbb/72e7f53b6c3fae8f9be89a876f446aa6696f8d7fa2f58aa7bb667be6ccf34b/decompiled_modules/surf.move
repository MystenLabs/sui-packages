module 0xbb72e7f53b6c3fae8f9be89a876f446aa6696f8d7fa2f58aa7bb667be6ccf34b::surf {
    ...
    public fun mint(arg0: &mut MintConfig, arg1: &mut 0xbb72e7f53b6c3fae8f9be89a876f446aa6696f8d7fa2f58aa7bb667be6ccf34b::recorder::Recorder, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : SurfNFT {
        assert!(arg0.version == 1, 0xbb72e7f53b6c3fae8f9be89a876f446aa6696f8d7fa2f58aa7bb667be6ccf34b::errors::wrong_version());
        let v0 = if (arg0.live) {
            if (arg0.season >= 1) {
                arg0.mint_cost > 0
        ...
        assert!(v0, 0xbb72e7f53b6c3fae8f9be89a876f446aa6696f8d7fa2f58aa7bb667be6ccf34b::errors::not_configured());
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = current_week(arg0, arg2);
        assert!(0xbb72e7f53b6c3fae8f9be89a876f446aa6696f8d7fa2f58aa7bb667be6ccf34b::recorder::points_of(arg1, v1) >= arg0.threshold, 0xbb72e7f53b6c3fae8f9be89a876f446aa6696f8d7fa2f58aa7bb667be6ccf34b::errors::below_threshold());
        if (v2 >= 2 && arg0.weekly_cap > 0) {
            assert!(weekly_minted(arg0, v1, v2) < arg0.weekly_cap, 0xbb72e7f53b6c3fae8f9be89a876f446aa6696f8d7fa2f58aa7bb667be6ccf34b::errors::weekly_cap_reached());
        };
        0xbb72e7f53b6c3fae8f9be89a876f446aa6696f8d7fa2f58aa7bb667be6ccf34b::recorder::add_spent(arg1, v1, arg0.mint_cost);
