module 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::staking {
    ...
    public fun calculate_rewards<T0: drop>(arg0: &mut Staking, arg1: &mut Staked<T0>, arg2: &0x2::clock::Clock) : u64 {
        ...
        0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::math::mul_div_down((0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::math::sub_u128(v1.reward_index, arg1.reward_index) as u64), arg1.value, 1000000000)
    }

    public fun claim<T0: drop>(arg0: &mut 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::mazu::Vault, arg1: &mut Staking, arg2: &mut Staked<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::mazu::MAZU> {
        assert_active(arg1);
        ...
        0x2::coin::mint<0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::mazu::MAZU>(0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::mazu::cap_mut(arg0), ((0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::math::sub_u128(v1.reward_index, arg2.reward_index) * (arg2.value as u128) / (1000000000 as u128)) as u64), arg4)
    }
    ...
    public fun complete_start(arg0: &0x2::clock::Clock, arg1: &mut Staking, arg2: StartRequest) {
        ...
        arg1.start = v0;
        let v1 = PoolKey<0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::mazu::MAZU>{dummy_field: false};
        0x2::dynamic_field::borrow_mut<PoolKey<0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::mazu::MAZU>, Pool>(&mut arg1.id, v1).last_updated = v0;
        let v2 = PoolKey<0xcc2fdcce83acdc63a607bea2d5a04511ec7a252d7bbe4087f9fd8f9eb3c1a9fa::af_lp::AF_LP>{dummy_field: false};
        0x2::dynamic_field::borrow_mut<PoolKey<0xcc2fdcce83acdc63a607bea2d5a04511ec7a252d7bbe4087f9fd8f9eb3c1a9fa::af_lp::AF_LP>, Pool>(&mut arg1.id, v2).last_updated = v0;
    }
    ...
    fun get_emitted(arg0: &Pool, arg1: u64, arg2: u64) : u64 {
        let v0 = 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::math::min((arg0.last_updated - arg1) / 604800000, 71);
        let v1 = 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::math::min((arg2 - arg1) / 604800000, 71);
        let v2 = 0;
        while (v0 < v1 + 1) {
            ...
            if (v0 == v1) {
                v2 = v2 + 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::math::mul_div_down(v3, 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::math::min(arg2 - arg1 - v1 * 604800000, 604800000), 604800000);
            };
            if (v0 == v0) {
                v2 = v2 - 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::math::mul_div_down(v3, 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::math::min(arg0.last_updated - arg1 - v0 * 604800000, 604800000), 604800000);
            };
            v0 = v0 + 1;
        };
        v2
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_field::add<PoolKey<0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::mazu::MAZU>, Pool>(&mut v0.id, v1, v2);
        let v3 = PoolKey<0xcc2fdcce83acdc63a607bea2d5a04511ec7a252d7bbe4087f9fd8f9eb3c1a9fa::af_lp::AF_LP>{dummy_field: false};
        let v4 = Pool{
            total_value  : 0,
            total_staked : 0,
        ...
        0x2::dynamic_field::add<PoolKey<0xcc2fdcce83acdc63a607bea2d5a04511ec7a252d7bbe4087f9fd8f9eb3c1a9fa::af_lp::AF_LP>, Pool>(&mut v0.id, v3, v4);
    ...
    public fun propose_start(arg0: &mut 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::multisig::Multisig, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = StartRequest{dummy_field: false};
        0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::multisig::create_proposal<StartRequest>(arg0, arg1, v0, arg2);
    }
    ...
    public fun stake<T0: drop>(arg0: &mut Staking, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Staked<T0> {
        ...
        let v4 = 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::math::mul_div_down(0x2::coin::value<T0>(&arg1), get_boost(arg3), 1000000000);
    ...
    public fun start_start(arg0: 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::multisig::Proposal) : StartRequest {
        0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::multisig::get_request<StartRequest>(arg0)
    }

    public fun unstake<T0: drop>(arg0: &mut 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::mazu::Vault, arg1: &mut Staking, arg2: Staked<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::mazu::MAZU>) {
        assert_active(arg1);
        assert_last_version(arg1);
        ...
        v8.total_value = 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::math::sub(v8.total_value, v3);
        v8.total_staked = 0x9122346e9c20f8d52a343c1d66e5092cf5192d0bacd8082adaf5cc136f9dd6ff::math::sub(v8.total_staked, 0x2::balance::value<T0>(&v6));
