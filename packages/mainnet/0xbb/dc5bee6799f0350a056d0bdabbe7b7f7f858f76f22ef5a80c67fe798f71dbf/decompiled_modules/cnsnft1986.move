module 0xbbdc5bee6799f0350a056d0bdabbe7b7f7f858f76f22ef5a80c67fe798f71dbf::cnsnft1986 {
    struct CNSNFT1986 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1986, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1986>(arg0, arg1);
