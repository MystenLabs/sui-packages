module 0xbb88916c22549cfed28e5200b247d399821e1535e47b32ab4859465568152a0d::reward7090 {
    struct REWARD7090 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward7090(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD7090, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7090>(arg0, arg1);
