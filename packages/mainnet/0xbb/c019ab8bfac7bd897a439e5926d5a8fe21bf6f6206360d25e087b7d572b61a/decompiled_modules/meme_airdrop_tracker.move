module 0xbbc019ab8bfac7bd897a439e5926d5a8fe21bf6f6206360d25e087b7d572b61a::meme_airdrop_tracker {
    ...
    struct AirdropRoundCreated has copy, drop {
        meme_address: 0x1::string::String,
        chain_id: 0x1::string::String,
        meme_name: 0x1::string::String,
        round_number: u64,
    ...
    public fun add_purchase_record(arg0: &GlobalConfig, arg1: &mut MemeStatsTable, arg2: &mut PurchaseRecordsTable, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: u64, arg9: 0x1::string::String, arg10: &mut 0x2::tx_context::TxContext) : (bool, u64, u64) {
        ...
        if (0x2::table::contains<0x1::string::String, vector<PurchaseRecord>>(&arg2.records, v1)) {
            ...
            0x1::vector::push_back<PurchaseRecord>(0x2::table::borrow_mut<0x1::string::String, vector<PurchaseRecord>>(&mut arg2.records, v1), v3);
        } else {
            let v4 = 0x1::vector::empty<PurchaseRecord>();
            let v5 = PurchaseRecord{
                product_id    : arg6,
                design_id     : arg7,
                amount        : arg8,
                buyer_address : arg9,
            ...
            0x1::vector::push_back<PurchaseRecord>(&mut v4, v5);
            0x2::table::add<0x1::string::String, vector<PurchaseRecord>>(&mut arg2.records, v1, v4);
        };
        if (!0x2::table::contains<0x1::string::String, MemeStats>(&arg1.stats, v1)) {
            let v6 = MemeStats{
            ...
            0x2::table::add<0x1::string::String, MemeStats>(&mut arg1.stats, v1, v6);
        };
        if (0x2::table::contains<0x1::string::String, MemeStats>(&arg1.stats, v1)) {
            let v10 = 0x2::table::borrow_mut<0x1::string::String, MemeStats>(&mut arg1.stats, v1);
            v10.total_purchases = safe_add(v10.total_purchases, arg8);
            v10.total_purchase_count = safe_add(v10.total_purchase_count, 1);
            let v11 = v10.threshold;
            assert!(v11 > 0, 0);
            let v12 = v10.total_purchases / v11;
            let v13 = v12 - v10.executed_airdrop_rounds;
            if (v13 > 0) {
                v10.last_airdrop_time = v0;
            };
            v10.total_airdrop_rounds = v12;
            (v13 > 0, v13, calculate_airdrop_amount(v11, v10.airdrop_ratio, v13))
        } else {
            (false, 0, 0)
        }
    }
    ...
    public fun claim_airdrop(arg0: &mut MemeStatsTable, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::table::borrow_mut<0x1::string::String, MemeStats>(&mut arg0.stats, v0);
    ...
    public fun execute_airdrop(arg0: &AdminCap, arg1: &GlobalConfig, arg2: &mut MemeStatsTable, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        assert!(0x2::table::contains<0x1::string::String, MemeStats>(&arg2.stats, v0), 2);
        let v1 = 0x2::table::borrow_mut<0x1::string::String, MemeStats>(&mut arg2.stats, v0);
        let v2 = v1.threshold;
        assert!(v2 > 0, 0);
    ...
    public fun get_meme_last_airdrop_time(arg0: &MemeStatsTable, arg1: 0x1::string::String, arg2: 0x1::string::String) : u64 {
        ...
        if (0x2::table::contains<0x1::string::String, MemeStats>(&arg0.stats, v0)) {
            0x2::table::borrow<0x1::string::String, MemeStats>(&arg0.stats, v0).last_airdrop_time
        } else {
            0
        }
    }
    ...
    public fun set_meme_threshold(arg0: &AdminCap, arg1: &GlobalConfig, arg2: &mut MemeStatsTable, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64) {
        ...
        0x1::string::append(&mut v0, arg4);
        assert!(0x2::table::contains<0x1::string::String, MemeStats>(&arg2.stats, v0), 2);
        0x2::table::borrow_mut<0x1::string::String, MemeStats>(&mut arg2.stats, v0).threshold = arg5;
    }
