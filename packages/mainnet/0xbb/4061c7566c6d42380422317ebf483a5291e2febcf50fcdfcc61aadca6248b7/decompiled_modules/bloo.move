module 0xbb4061c7566c6d42380422317ebf483a5291e2febcf50fcdfcc61aadca6248b7::bloo {
    ...
    fun init(arg0: BLOO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<BLOO>>(v0, v3);
        0x2::transfer::public_transfer<0x2::coin::DenyCapV2<BLOO>>(v1, v3);
    }
