module 0xbb8727de0959d8c1feb4d6737d2ab9f7ebfdc36b612e9c19a40582807882390d::game3064 {
    struct GAME3064 has drop {
        dummy_field: bool,
    }

    struct TICKET_3064 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3064(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3064>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3064>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME3064, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME3064>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3064>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3064>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3064>>(v5, 0x2::tx_context::sender(arg1));
    }
