    ...
    fun update_size<T0: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u8) {
        ...
        if (arg4 == 2) {
            ...
            while (v5 < 0x1::vector::length<u64>(&v0.vals)) {
                if (0x2::dynamic_field::exists_with_type<u64, Slice<u64>>(&arg0.id, *0x1::vector::borrow<u64>(&v0.vals, v5))) {
                    v1 = v1 + 0x2::dynamic_field::borrow<u64, Slice<u64>>(&arg0.id, *0x1::vector::borrow<u64>(&v0.vals, v5)).size;
                } else if (0x2::dynamic_field::exists_with_type<u64, Slice<T0>>(&arg0.id, *0x1::vector::borrow<u64>(&v0.vals, v5))) {
            ...
            while (v5 < 0x1::vector::length<u64>(&v6.vals)) {
                if (0x2::dynamic_field::exists_with_type<u64, Slice<u64>>(&arg0.id, *0x1::vector::borrow<u64>(&v6.vals, v5))) {
                    v7 = v7 + 0x2::dynamic_field::borrow<u64, Slice<u64>>(&arg0.id, *0x1::vector::borrow<u64>(&v6.vals, v5)).size;
                } else if (0x2::dynamic_field::exists_with_type<u64, Slice<T0>>(&arg0.id, *0x1::vector::borrow<u64>(&v6.vals, v5))) {
