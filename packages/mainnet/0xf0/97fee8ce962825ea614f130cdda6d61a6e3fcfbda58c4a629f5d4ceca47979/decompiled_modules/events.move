module 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::events {
    ...
    struct RewardPoolFundsWithdrawn has copy, drop {
        pool_id: 0x2::object::ID,
        amount: u64,
        remaining_pool_balance: u64,
        destination: address,
    }
    ...
    public(friend) fun emit_rewards_pool_funds_withdrawn(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: address) {
        let v0 = RewardPoolFundsWithdrawn{
            pool_id                : arg0,
            amount                 : arg1,
            remaining_pool_balance : arg2,
            destination            : arg3,
        };
        0x2::event::emit<RewardPoolFundsWithdrawn>(v0);
    }
