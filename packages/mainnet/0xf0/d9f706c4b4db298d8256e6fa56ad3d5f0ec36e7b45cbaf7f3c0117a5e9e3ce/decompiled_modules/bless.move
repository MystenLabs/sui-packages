module 0xf0d9f706c4b4db298d8256e6fa56ad3d5f0ec36e7b45cbaf7f3c0117a5e9e3ce::bless {
    ...
    fun init(arg0: BLESS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/36FWitiFoUybrW9ois4EzMjfBYNhW38Vxsv2Pdwfpump.png?size=lg&key=5cb5c6                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BLESS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BLESS     ")))), trim_right(b"god bless you                   "), trim_right(b"god bless you with mountains of gold and silver                                                                                                                                                                                                                                                                                 "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
