module 0xf0b0c30f79aad9fd6bb84af5ec4fe2622aa0f431dfd4ee623a5047538a618beb::reward8743 {
    struct REWARD8743 has drop {
        dummy_field: bool,
    }

    struct TICKET_8743 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8743(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8743>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8743>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8743, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8743>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8743>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8743>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8743>>(v5, 0x2::tx_context::sender(arg1));
    }
