module 0xf00ba72ba3e180ccde2318b077b48e572f923542dfa8fda17d312c02c040351a::alvin_swap {
    ...
    public fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LP<T0, T1>>, vector<u64>) {
        ...
        0x2::coin::put<T0>(&mut arg0.coin_a, arg1);
        0x2::coin::put<T1>(&mut arg0.coin_b, arg2);
        let v2 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v2, v0);
        0x1::vector::push_back<u64>(&mut v2, v1);
        (0x2::coin::from_balance<LP<T0, T1>>(0x2::balance::increase_supply<LP<T0, T1>>(&mut arg0.lp_supply, v1 + v0), arg3), v2)
    }
    ...
    public fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v0 = *0x1::vector::borrow_mut<u64>(&mut arg2, 0);
        let v1 = *0x1::vector::borrow_mut<u64>(&mut arg2, 1);
        assert!(0x2::coin::value<LP<T0, T1>>(&arg1) == v0 + v1, 1003);
        assert!(0x2::balance::value<T0>(&arg0.coin_a) > v0, 1004);
        assert!(0x2::balance::value<T1>(&arg0.coin_b) > v1, 1005);
        0x2::balance::decrease_supply<LP<T0, T1>>(&mut arg0.lp_supply, 0x2::coin::into_balance<LP<T0, T1>>(arg1));
        (0x2::coin::take<T0>(&mut arg0.coin_a, v0, arg3), 0x2::coin::take<T1>(&mut arg0.coin_b, v1, arg3))
    }
    ...
    public entry fun remove_liquidity_totally<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: &mut Pocket, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = remove_liquidity<T0, T1>(arg0, arg1, *0x2::table::borrow<0x2::object::ID, vector<u64>>(&arg2.table, v0), arg3);
        let v3 = v2;
        let v4 = v1;
    ...
    public fun swap_a_outto_b<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let v0 = 0x2::coin::value<T0>(&arg1);
        0x2::coin::put<T0>(&mut arg0.coin_a, arg1);
        assert!(v0 < 0x2::balance::value<T1>(&arg0.coin_b), 1005);
        0x2::coin::take<T1>(&mut arg0.coin_b, v0, arg2)
    }

    public entry fun swap_a_to_b<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::zero<T0>(arg3);
        0x2::pay::join_vec<T0>(&mut v0, arg1);
        let v1 = 0x2::coin::split<T0>(&mut v0, arg2, arg3);
        let v2 = swap_a_outto_b<T0, T1>(arg0, v1, arg3);
    ...
    public fun swap_b_into_a<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x2::coin::value<T1>(&arg1);
        0x2::coin::put<T1>(&mut arg0.coin_b, arg1);
        assert!(v0 < 0x2::balance::value<T0>(&arg0.coin_a), 1004);
        0x2::coin::take<T0>(&mut arg0.coin_a, v0, arg2)
    }

    public entry fun swap_b_to_a<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<0x2::coin::Coin<T1>>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::zero<T1>(arg3);
        0x2::pay::join_vec<T1>(&mut v0, arg1);
        let v1 = 0x2::coin::split<T1>(&mut v0, arg2, arg3);
        let v2 = swap_b_into_a<T0, T1>(arg0, v1, arg3);
        let v3 = 0x2::tx_context::sender(arg3);
    ...
    public fun withdraw<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2::coin::Coin<LP<T0, T1>>, arg2: &mut vector<u64>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::balance::value<T0>(&arg0.coin_a) > arg3, 1004);
        assert!(0x2::balance::value<T1>(&arg0.coin_b) > arg4, 1005);
        ...
        *v1 = *v1 - arg3;
        ...
        (0x2::coin::take<T0>(&mut arg0.coin_a, arg3, arg5), 0x2::coin::take<T1>(&mut arg0.coin_b, arg4, arg5))
    }
