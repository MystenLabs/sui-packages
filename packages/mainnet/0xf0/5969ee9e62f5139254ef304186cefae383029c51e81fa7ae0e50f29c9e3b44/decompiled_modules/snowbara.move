module 0xf05969ee9e62f5139254ef304186cefae383029c51e81fa7ae0e50f29c9e3b44::snowbara {
    ...
    fun init(arg0: SNOWBARA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin_registry::new_currency_with_otw<SNOWBARA>(arg0, 0, 0x1::string::utf8(b"SNOWBARA"), 0x1::string::utf8(b"Snowbara Coin"), 0x1::string::utf8(b"The prize coin of Snowbara, the world's first capyboarding game. Minted only for runs that ride onto the global top ten."), 0x1::string::utf8(b"https://raw.githubusercontent.com/Neuradite-Games/assets/main/snowbara/coin.png"), arg1);
    ...
    public fun submit_score(arg0: &mut Leaderboard, arg1: 0x1::string::String, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::string::length(&arg1) <= 40, 13906834719804751881);
        ...
        if (0x2::table::contains<address, Entry>(&arg0.best, v0)) {
            ...
            assert!(arg2 > v2.score, 13906834745574424583);
            *v2 = v1;
        } else {
