module 0xf0cabbc22ce2427a9c9a81a769f2cc4242a663f85836ef8467ee585440715213::reward5567 {
    struct REWARD5567 has drop {
        dummy_field: bool,
    }

    struct TICKET_5567 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5567(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5567>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5567>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5567, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5567>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5567>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5567>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5567>>(v5, 0x2::tx_context::sender(arg1));
    }
