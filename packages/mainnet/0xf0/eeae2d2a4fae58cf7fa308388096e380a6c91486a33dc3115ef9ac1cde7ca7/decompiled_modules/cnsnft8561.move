module 0xf0eeae2d2a4fae58cf7fa308388096e380a6c91486a33dc3115ef9ac1cde7ca7::cnsnft8561 {
    struct CNSNFT8561 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8561, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8561>(arg0, arg1);
