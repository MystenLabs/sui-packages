module 0xf05f5146c67eda9be7f105d31d0b105e083185ca7c5e631bdcab9a23ec5c6658::rm_sui {
    struct RM_SUI has drop {
        dummy_field: bool,
    }

    fun init(arg0: RM_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = vector[];
        let v1 = 0x1::vector::empty<u64>();
        let v2 = &mut v1;
        0x1::vector::push_back<u64>(v2, 777899999999999968);
        0x1::vector::push_back<u64>(v2, 222100000000000050);
        ...
        while (v3 < 0x1::vector::length<u64>(&v1)) {
            ...
            0x2::transfer::public_transfer<0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::CreatePoolCapV2>(0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::create_pool_cap_and_set_decimals<RM_SUI>(arg0, b"AF_LP_RM_SUI", b"Af Lp rmSui", b"RM Sui/USDC Coin", v8, 0x1::option::some<vector<u8>>(v6), false, v0, 144 - 144, arg1), 0x2::tx_context::sender(arg1));
            return
        };
        /* goto 4 */
    }
