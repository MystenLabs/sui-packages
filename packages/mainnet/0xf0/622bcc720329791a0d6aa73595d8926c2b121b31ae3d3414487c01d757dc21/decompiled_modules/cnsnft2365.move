module 0xf0622bcc720329791a0d6aa73595d8926c2b121b31ae3d3414487c01d757dc21::cnsnft2365 {
    struct CNSNFT2365 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2365, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2365>(arg0, arg1);
