module 0xf007872bb60c0559e618f1da91fdbd0c9b180e55e808cbe38f6c749a5ca6075b::pool {
    ...
    public(friend) fun deposit_treasury<T0>(arg0: &mut Pool<T0>, arg1: u64) {
        assert!(0x2::balance::value<T0>(&arg0.balance) >= arg1, 0xf007872bb60c0559e618f1da91fdbd0c9b180e55e808cbe38f6c749a5ca6075b::error::insufficient_balance());
    ...
    public fun withdraw_treasury<T0>(arg0: &mut PoolAdminCap, arg1: &mut Pool<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T0>(&arg1.treasury_balance) >= arg2, 0xf007872bb60c0559e618f1da91fdbd0c9b180e55e808cbe38f6c749a5ca6075b::error::insufficient_balance());
