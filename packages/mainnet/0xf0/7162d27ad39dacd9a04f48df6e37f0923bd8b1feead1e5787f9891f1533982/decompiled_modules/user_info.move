module 0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::user_info {
    ...
    public fun new(arg0: &0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::app::AdminCap, arg1: &mut 0x2::tx_context::TxContext) : UserInfoStore {
        UserInfoStore{
    ...
    public fun address_by_username(arg0: &0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::app::GilderApp, arg1: vector<u8>) : 0x1::option::Option<address> {
        let v0 = 0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::app::object<UserInfoStore>(arg0);
    ...
    public fun claim_sign_up_reward(arg0: &mut 0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::app::GilderApp, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        let v1 = 0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::app::app_object_mut<0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::version::UserInfoV1, UserInfoStore>(arg0);
                    ...
                    if (!!0x1::string::is_empty(0x1::vector::borrow<0x1::string::String>(v19, v20))) {
                        ...
                        while (v26 < 0x1::vector::length<0x1::string::String>(v25)) {
                            ...
                            if (!v29) {
                                ...
                                0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::point::mint_points_for_user_completing_sign_up(arg0, v0, arg1);
                                return
                            };
                            v26 = v26 + 1;
                        };
    ...
    public fun new_info(arg0: &mut 0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::app::GilderApp, arg1: vector<u8>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : UserInfo {
        assert!(!0x1::vector::is_empty<u8>(&arg1), 900);
        let v0 = clean_username(arg1);
        0x2::table::add<0x1::ascii::String, address>(&mut 0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::app::app_object_mut<0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::version::UserInfoV1, UserInfoStore>(arg0).usernames, v0, 0x2::tx_context::sender(arg3));
        UserInfo{
    ...
    public fun save(arg0: &mut 0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::app::GilderApp, arg1: UserInfo, arg2: &0x2::tx_context::TxContext) {
        ...
        0x2::table::add<address, UserInfo>(&mut 0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::app::app_object_mut<0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::version::UserInfoV1, UserInfoStore>(arg0).users_info, v0, arg1);
    }

    public fun take(arg0: &mut 0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::app::GilderApp, arg1: &0x2::tx_context::TxContext) : UserInfo {
        0x2::table::remove<address, UserInfo>(&mut 0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::app::app_object_mut<0xf07162d27ad39dacd9a04f48df6e37f0923bd8b1feead1e5787f9891f1533982::version::UserInfoV1, UserInfoStore>(arg0).users_info, 0x2::tx_context::sender(arg1))
    }
