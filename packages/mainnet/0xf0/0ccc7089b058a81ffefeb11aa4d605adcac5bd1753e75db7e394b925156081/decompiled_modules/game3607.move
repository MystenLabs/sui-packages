module 0xf00ccc7089b058a81ffefeb11aa4d605adcac5bd1753e75db7e394b925156081::game3607 {
    struct GAME3607 has drop {
        dummy_field: bool,
    }

    struct TICKET_3607 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3607(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3607>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3607>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME3607, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME3607>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3607>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3607>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3607>>(v5, 0x2::tx_context::sender(arg1));
    }
