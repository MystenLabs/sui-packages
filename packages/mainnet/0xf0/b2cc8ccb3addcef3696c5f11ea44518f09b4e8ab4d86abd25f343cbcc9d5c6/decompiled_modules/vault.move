module 0x6eed7ba483e3940a9c7b36e5e117c84f6a39c49d84d29946565b85f21c0b85f4::vault {
    ...
    public fun deposit_partial<T0>(arg0: &mut Vault<T0>, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64, arg4: &AdminCap, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1, arg3), arg5), 0x2::tx_context::sender(arg5));
        0x2::balance::join<T0>(&mut arg0.reserve, arg1);
    }
