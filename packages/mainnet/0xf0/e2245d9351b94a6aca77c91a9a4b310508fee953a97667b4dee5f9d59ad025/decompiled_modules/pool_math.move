module 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::pool_math {
    ...
    fun tokens_to_deposit(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : (u64, u64) {
        ...
        if (arg0 == 0 && arg1 == 0) {
            ...
            let v2 = 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::math::safe_mul_div_up(arg2, arg1, arg0);
            if (v2 <= arg3) {
                (arg2, v2)
            } else {
                let v3 = 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::math::safe_mul_div_up(arg3, arg0, arg1);
                assert!(v3 > 0, 5);
                assert!(v3 <= arg2, 0);
                (v3, arg3)
            }
