module 0xf0f26da6f8125afa5aea75c23b2ce1b70a346aecad3618869375247faa53da1c::seal_approve {
    ...
    entry fun seal_approve(arg0: vector<u8>, arg1: &SealPolicy, arg2: &0xf0f26da6f8125afa5aea75c23b2ce1b70a346aecad3618869375247faa53da1c::agent::Agent) {
        assert!(arg1.version == 1, 101);
        assert_identity_matches_agent(&arg0, arg2);
        assert!(0x2::object::id<0xf0f26da6f8125afa5aea75c23b2ce1b70a346aecad3618869375247faa53da1c::agent::Agent>(arg2) == arg1.agent_id, 100);
    }

    fun assert_identity_matches_agent(arg0: &vector<u8>, arg1: &0xf0f26da6f8125afa5aea75c23b2ce1b70a346aecad3618869375247faa53da1c::agent::Agent) {
        let v0 = 0x2::object::id<0xf0f26da6f8125afa5aea75c23b2ce1b70a346aecad3618869375247faa53da1c::agent::Agent>(arg1);
    ...
    public fun create_policy(arg0: &0xf0f26da6f8125afa5aea75c23b2ce1b70a346aecad3618869375247faa53da1c::agent::Agent, arg1: &mut 0x2::tx_context::TxContext) : (SealPolicy, SealPolicyCap) {
        let v0 = 0x2::object::id<0xf0f26da6f8125afa5aea75c23b2ce1b70a346aecad3618869375247faa53da1c::agent::Agent>(arg0);
        let v1 = SealPolicy{
    ...
    entry fun create_policy_entry(arg0: &0xf0f26da6f8125afa5aea75c23b2ce1b70a346aecad3618869375247faa53da1c::agent::Agent, arg1: &mut 0x2::tx_context::TxContext) {
