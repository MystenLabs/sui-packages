module 0xf0526ca9f2b5cd24fbfdd6a9121d0fc72e611aae8ecb9f5e3bb82e541a5a8049::gift1473 {
    struct GIFT1473 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift1473(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT1473, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1473>(arg0, arg1);
