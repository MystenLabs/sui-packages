module 0xf054a2adb8e903afdc186cd6d5a3873373db872fbc37ccc7cd873dc2a313fd61::a783956f993d811bc {
    ...
    public fun a1d4036cdf86e784c(arg0: &A0ea878587b719a64, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.a1cf5727aac3dee05 == 0x2::tx_context::sender(arg1), 13906834994682134527);
    }
    ...
    public fun a8ca7876854a16d35(arg0: &mut 0x2::tx_context::TxContext) : A0ea878587b719a64 {
        ...
        let v1 = A38f12468332ef716{
            ...
            ac342a6a5cd6c420e : 1,
            ab0a69a408e88c1bf : 2000 * 1000000,
            a2cd365a1174f0589 : 1000 * 1000000000,
        };
        A0ea878587b719a64{
