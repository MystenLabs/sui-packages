module 0xf019e9064a07f52cca027d0caa562b5631340d58ef9251b7b22838f16d0e0646::gift1852 {
    struct GIFT1852 has drop {
        dummy_field: bool,
    }

    struct TICKET_1852 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1852(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1852>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1852>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1852, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1852>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1852>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1852>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1852>>(v5, 0x2::tx_context::sender(arg1));
    }
