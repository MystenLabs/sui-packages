module 0xf036f6dbc51890486b88955f08441b45b28a6ed34405201a11c863bb51eb49bf::dex_deepbook {
    ...
    public fun get_deepbook_package() : address {
        0xf036f6dbc51890486b88955f08441b45b28a6ed34405201a11c863bb51eb49bf::constants::deepbook_package()
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = DeepBookRealSwapExecuted{
            ...
            pool_id         : arg2,
            package         : 0xf036f6dbc51890486b88955f08441b45b28a6ed34405201a11c863bb51eb49bf::constants::deepbook_package(),
