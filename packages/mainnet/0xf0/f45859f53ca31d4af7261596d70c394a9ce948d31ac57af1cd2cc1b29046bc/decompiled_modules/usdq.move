module 0xf0f45859f53ca31d4af7261596d70c394a9ce948d31ac57af1cd2cc1b29046bc::usdq {
    ...
    fun init(arg0: USDQ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (1000000000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<USDQ>>(0x2::coin::mint<USDQ>(&mut v5, 1000000000000000000, arg1), v6);
        };
