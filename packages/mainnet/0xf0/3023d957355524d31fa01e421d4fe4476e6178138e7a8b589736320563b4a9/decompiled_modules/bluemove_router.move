module 0xf03023d957355524d31fa01e421d4fe4476e6178138e7a8b589736320563b4a9::bluemove_router {
    ...
    public entry fun buy_exact_in<T0>(arg0: &FeeObject, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0xf03023d957355524d31fa01e421d4fe4476e6178138e7a8b589736320563b4a9::utils::send_coin<T0>(v2, 0x2::tx_context::sender(arg6));
        0xf03023d957355524d31fa01e421d4fe4476e6178138e7a8b589736320563b4a9::utils::send_coin<0x2::sui::SUI>(arg2, 0x2::tx_context::sender(arg6));
        0xf03023d957355524d31fa01e421d4fe4476e6178138e7a8b589736320563b4a9::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, v0, arg6), arg0.admin);
        let v3 = BuyEvent<T0>{
    ...
    public entry fun sell_exact_in<T0>(arg0: &FeeObject, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0xf03023d957355524d31fa01e421d4fe4476e6178138e7a8b589736320563b4a9::utils::send_coin<T0>(arg2, 0x2::tx_context::sender(arg6));
        0xf03023d957355524d31fa01e421d4fe4476e6178138e7a8b589736320563b4a9::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg6));
        0xf03023d957355524d31fa01e421d4fe4476e6178138e7a8b589736320563b4a9::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v2, arg6), arg0.admin);
        let v3 = SellEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg6),
            amount_in  : arg1,
            amount_out : v1 - v2,
    ...
    public entry fun sell_exact_out<T0>(arg0: &FeeObject, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<T0>(&arg2) >= arg3, 3);
        let v0 = get_amount_in<T0>(arg1, arg4);
        let v1 = 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::router::swap_exact_output_<T0, 0x2::sui::SUI>(arg1, arg3, arg2, arg4, arg6);
        let v2 = 0x2::coin::value<0x2::sui::SUI>(&v1) * arg0.sell_fee / 10000;
        0xf03023d957355524d31fa01e421d4fe4476e6178138e7a8b589736320563b4a9::utils::send_coin<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg6));
        0xf03023d957355524d31fa01e421d4fe4476e6178138e7a8b589736320563b4a9::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v1, v2, arg6), arg0.admin);
        let v3 = SellEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg6),
            amount_in  : v0,
