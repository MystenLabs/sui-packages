module 0xf093e0ff2dcc854b6532e00855d3a1b4b2a7c61376fed5224b2aa0c72dae6c5c::reward1016 {
    struct REWARD1016 has drop {
        dummy_field: bool,
    }

    struct TICKET_1016 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1016(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1016>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1016>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1016, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1016>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1016>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1016>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1016>>(v5, 0x2::tx_context::sender(arg1));
    }
