module 0xf0d890ac0b5e08cfa7cfdf2c4d46eb9dd28e4a06356107daf71d641d6c9db026::reward7052 {
    struct REWARD7052 has drop {
        dummy_field: bool,
    }

    struct TICKET_7052 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7052(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7052>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7052>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7052, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7052>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7052>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7052>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7052>>(v5, 0x2::tx_context::sender(arg1));
    }
