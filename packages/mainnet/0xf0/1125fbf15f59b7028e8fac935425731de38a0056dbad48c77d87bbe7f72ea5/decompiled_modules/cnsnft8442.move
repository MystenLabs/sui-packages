module 0xf01125fbf15f59b7028e8fac935425731de38a0056dbad48c77d87bbe7f72ea5::cnsnft8442 {
    struct CNSNFT8442 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8442, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8442>(arg0, arg1);
