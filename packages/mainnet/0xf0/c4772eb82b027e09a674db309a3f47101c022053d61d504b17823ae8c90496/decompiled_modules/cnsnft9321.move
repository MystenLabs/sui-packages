module 0xf0c4772eb82b027e09a674db309a3f47101c022053d61d504b17823ae8c90496::cnsnft9321 {
    struct CNSNFT9321 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9321, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1951"));
        let v4 = 0x2::package::claim<CNSNFT9321>(arg0, arg1);
