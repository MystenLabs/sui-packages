module 0xf04b41a0e1de414f3c433288e0ab5f73c241d914f9fbb906b774eac33d0112ea::vampire_attack {
    ...
    public entry fun extract_liquidity_from_af<T0, T1>(arg0: &0x2::clock::Clock, arg1: &FlowxAttackConfig, arg2: &mut FlowxLockdropForPool<T0, T1>, arg3: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::balance::value<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::LP<T0, T1>>(&arg2.flowx_lps_locked);
        arg2.total_lp_locked = (v0 as u128);
        let (v1, v2) = 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::borrow_mut_pair_and_treasury<T0, T1>(arg3);
        ...
        arg2.total_x_withdrawn = 0x2::balance::value<T0>(&v5);
        arg2.total_y_withdrawn = 0x2::balance::value<T1>(&v6);
        0x2::balance::join<T0>(&mut arg2.withdrawn_x_balance, v5);
        0x2::balance::join<T1>(&mut arg2.withdrawn_y_balance, v6);
        let v7 = LiquidityExtractedFromFlowx<T0, T1>{
            total_lp_deposited   : (v0 as u128),
            x_balance_extracted  : arg2.total_x_withdrawn,
            y_balance_extracted  : arg2.total_y_withdrawn,
            total_weighted_units : arg2.total_weighted_units,
        };
