module 0xf0bdc6e114ce875fe53ad80917cf0d25286a7e0207f86e247b8991ae5d58a865::cnsnft4482 {
    struct CNSNFT4482 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4482, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4482>(arg0, arg1);
