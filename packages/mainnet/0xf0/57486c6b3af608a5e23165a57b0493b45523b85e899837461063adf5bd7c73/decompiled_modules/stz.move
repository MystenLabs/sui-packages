module 0xf057486c6b3af608a5e23165a57b0493b45523b85e899837461063adf5bd7c73::stz {
    struct STZ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: STZ, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<STZ>(arg0, 2, b"STZ", b"Suitizen", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/rJnMzhr.png")), arg1);
