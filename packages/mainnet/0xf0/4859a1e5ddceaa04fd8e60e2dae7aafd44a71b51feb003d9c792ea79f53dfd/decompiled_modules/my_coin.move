module 0xf04859a1e5ddceaa04fd8e60e2dae7aafd44a71b51feb003d9c792ea79f53dfd::my_coin {
    ...
    fun init(arg0: MY_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MY_COIN>(arg0, 6, b"Ni1L", b"Ni1L", b"", 0x1::option::none<0x2::url::Url>(), arg1);
