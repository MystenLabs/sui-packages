module 0xf0e541b201517fa3bff3d40c9105431c8301fa1d674960e48eab495cab9b2dbf::cnsnft5873 {
    struct CNSNFT5873 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5873, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5873>(arg0, arg1);
