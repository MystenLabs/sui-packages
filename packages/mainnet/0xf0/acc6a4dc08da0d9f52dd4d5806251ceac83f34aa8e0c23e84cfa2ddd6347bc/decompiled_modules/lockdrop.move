module 0xf0acc6a4dc08da0d9f52dd4d5806251ceac83f34aa8e0c23e84cfa2ddd6347bc::lockdrop {
    ...
    struct LockdropCetusState<phantom T0, phantom T1> has store {
        cetus_total_positions_liquidity: u128,
        cetus_total_weighted_units: u128,
        cetus_total_x_withdrawn: u64,
        cetus_total_y_withdrawn: u64,
        cetus_x_fee_withdrawn: 0x2::balance::Balance<T0>,
        cetus_y_fee_withdrawn: 0x2::balance::Balance<T1>,
        cetus_total_sui_earned: u64,
        cetus_total_cetus_earned: u64,
        cetus_sui_earned_bal: 0x2::balance::Balance<0x2::sui::SUI>,
        cetus_cetus_earned_bal: 0x2::balance::Balance<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>,
        cetus_total_hive_incentives: u64,
        cetus_total_dlps_amount: u64,
    }

    struct LockdropKriyaState has store {
        kriya_total_lp_locked: u128,
        kriya_total_weighted_units: u128,
        kriya_total_x_withdrawn: u64,
        kriya_total_y_withdrawn: u64,
        kriya_total_hive_incentives: u64,
        kriya_total_dlps_amount: u64,
    }

    struct LockdropFlowxState has store {
        flowx_total_lp_locked: u128,
        flowx_total_weighted_units: u128,
        flowx_total_x_withdrawn: u64,
        flowx_total_y_withdrawn: u64,
        flowx_total_hive_incentives: u64,
    ...
    struct UserKriyaLockdropState has store {
        kriya_lockup_weeks: vector<u64>,
        kriya_lp_tokens_locked: 0x2::table::Table<u64, u64>,
        kriya_lockup_weighted_units: 0x2::table::Table<u64, u128>,
        kriya_hive_rewards_per_lockup: 0x2::table::Table<u64, u64>,
        kriya_unlock_timestamps: 0x2::table::Table<u64, u64>,
        kriya_dlp_per_lockup: 0x2::table::Table<u64, u64>,
        kriya_dlp_claim_flag: 0x2::table::Table<u64, bool>,
    }

    struct UserFlowxLockdropState has store {
        flowx_lockup_weeks: vector<u64>,
        flowx_lp_tokens_locked: 0x2::table::Table<u64, u64>,
        flowx_lockup_weighted_units: 0x2::table::Table<u64, u128>,
        flowx_hive_rewards_per_lockup: 0x2::table::Table<u64, u64>,
        flowx_unlock_timestamps: 0x2::table::Table<u64, u64>,
        flowx_dlp_per_lockup: 0x2::table::Table<u64, u64>,
        flowx_dlp_claim_flag: 0x2::table::Table<u64, bool>,
    }
