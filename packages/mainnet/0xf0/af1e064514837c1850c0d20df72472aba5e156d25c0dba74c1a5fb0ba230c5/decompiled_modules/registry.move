module 0x6fa140257b64ce019f1665230807d98042270b464ee04f961bb29431d090ce28::registry {
    ...
    struct Registry has store, key {
        id: 0x2::object::UID,
        pfps: 0x2::table::Table<u64, 0x2::object::ID>,
        is_initialized: bool,
        is_frozen: bool,
    }

    public(friend) fun add(arg0: u64, arg1: 0x2::object::ID, arg2: &mut Registry) {
        0x2::table::add<u64, 0x2::object::ID>(&mut arg2.pfps, arg0, arg1);
        if ((0x2::table::length<u64, 0x2::object::ID>(&arg2.pfps) as u64) > 0) {
            arg2.is_initialized = true;
        };
    }

    public fun admin_freeze_registry(arg0: &0x6fa140257b64ce019f1665230807d98042270b464ee04f961bb29431d090ce28::admin::AdminCap, arg1: Registry, arg2: &0x2::tx_context::TxContext) {
    ...
    public(friend) fun count(arg0: &Registry) : u64 {
        (0x2::table::length<u64, 0x2::object::ID>(&arg0.pfps) as u64)
    }
    ...
    fun init(arg0: REGISTRY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Registry{
            ...
            pfps           : 0x2::table::new<u64, 0x2::object::ID>(arg1),
    ...
    public fun pfp_id_from_number(arg0: u64, arg1: &Registry) : 0x2::object::ID {
        assert!(arg0 >= 1, 1);
        assert!(arg1.is_frozen == true, 4);
        *0x2::table::borrow<u64, 0x2::object::ID>(&arg1.pfps, arg0)
    }
