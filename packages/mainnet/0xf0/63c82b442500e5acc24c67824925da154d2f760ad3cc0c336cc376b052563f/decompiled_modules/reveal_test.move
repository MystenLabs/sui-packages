module 0xf063c82b442500e5acc24c67824925da154d2f760ad3cc0c336cc376b052563f::reveal_test {
    struct REVEAL_TEST has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: REVEAL_TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<REVEAL_TEST>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Reveal Test"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"lets go"));
