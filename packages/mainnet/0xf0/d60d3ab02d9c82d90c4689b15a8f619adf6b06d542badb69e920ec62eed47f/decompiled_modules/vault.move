module 0xf0d60d3ab02d9c82d90c4689b15a8f619adf6b06d542badb69e920ec62eed47f::vault {
    ...
    public fun buy_share<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0xf0d60d3ab02d9c82d90c4689b15a8f619adf6b06d542badb69e920ec62eed47f::stingray::Stingray, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v3 = if (v2 != 0) {
            ...
            0xf0d60d3ab02d9c82d90c4689b15a8f619adf6b06d542badb69e920ec62eed47f::stingray::add_record<T0>(arg1, *0x2::object::uid_as_inner(&arg0.id), v4);
            ...
            let v5 = &mut v1;
            let v6 = record_and_fill_manager_fee<T0, T1>(arg0, v2 - v4, arg3, v5);
            0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::from_fraction(0x2::balance::supply_value<T1>(&arg0.supply), v6)
        } else {
        ...
        0xf0d60d3ab02d9c82d90c4689b15a8f619adf6b06d542badb69e920ec62eed47f::vault_event::buy_share_event<T0, ShareMetadata>(*0x2::object::uid_as_inner(&arg0.id), v0, v7);
