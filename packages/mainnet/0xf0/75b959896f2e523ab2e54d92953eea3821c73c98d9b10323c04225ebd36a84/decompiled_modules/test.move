module 0xf075b959896f2e523ab2e54d92953eea3821c73c98d9b10323c04225ebd36a84::test {
    ...
    public entry fun add_addr_from_deny_list(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCapV2<TEST>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun remove_addr_from_deny_list(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCapV2<TEST>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
