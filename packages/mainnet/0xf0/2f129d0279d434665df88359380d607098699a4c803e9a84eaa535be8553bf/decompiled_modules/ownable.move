module 0xf02f129d0279d434665df88359380d607098699a4c803e9a84eaa535be8553bf::ownable {
    ...
    public fun accept_ownership(arg0: &mut OwnableState, arg1: &mut 0x2::tx_context::TxContext) {
        accept_ownership_internal(arg0, 0x2::tx_context::sender(arg1));
    }

    public fun accept_ownership_from_object(arg0: &mut OwnableState, arg1: &mut 0x2::object::UID, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun execute_ownership_transfer(arg0: OwnerCap, arg1: &mut OwnableState, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun mcms_accept_ownership(arg0: &mut OwnableState, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun transfer_ownership(arg0: &OwnerCap, arg1: &mut OwnableState, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<OwnerCap>(arg0) == arg1.owner_cap_id, 1);
