module 0xf0ceda2b50eb2785e3913b2b0f75088fcd4b8605abc12b240bf9dac0e70501a6::cnsnft6501 {
    struct CNSNFT6501 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6501, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6501>(arg0, arg1);
