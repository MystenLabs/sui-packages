module 0xf5df296fa916e3c2678a5936c83178a9d0b16c8ea9fb258256f1466d64384295::cnsnft9242 {
    struct CNSNFT9242 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9242, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9242>(arg0, arg1);
