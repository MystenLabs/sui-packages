module 0xf5e813a72619c0272b59545a54a2e5ce2ed41e3cf96b755035e8d8e41f86203e::reward8855 {
    struct REWARD8855 has drop {
        dummy_field: bool,
    }

    struct TICKET_8855 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8855(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8855>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8855>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8855, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8855>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8855>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8855>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8855>>(v5, 0x2::tx_context::sender(arg1));
    }
