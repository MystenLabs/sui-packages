module 0xf54c6457490fcd3a74c3b3fa04f2837e2a69eb72642f3537c87f2f53d616f168::digital_dreams__mystical_realms {
    struct DIGITAL_DREAMS__MYSTICAL_REALMS has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"0a0c4cee-e944-4c17-8fed-0f3c5aa8c624"),
        };
    ...
    fun init(arg0: DIGITAL_DREAMS__MYSTICAL_REALMS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DIGITAL_DREAMS__MYSTICAL_REALMS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Digital Dreams: Mystical Realms"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x"5374657020696e746f2061207265616c6d206f662066616e7461737920616e6420776f6e646572207769746820e2809c4469676974616c20447265616d733a204d7973746963616c205265616c6d732ee2809d20"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmTEAkgQdppdQuEiRHS3KXekYYz5ZeRKSSRV2bchkUTT15"));
    ...
    public entry fun mint_nft(arg0: &0x2::clock::Clock, arg1: &mut Manager, arg2: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg3: 0x1::string::String, arg4: u64, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: u64, arg9: u64, arg10: u64, arg11: vector<u8>, arg12: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg13: &mut 0x2::kiosk::Kiosk, arg14: &0x2::kiosk::KioskOwnerCap, arg15: &0x2::transfer_policy::TransferPolicy<Nft>, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = MintNftEvent{
            ...
            price                     : arg9 + arg10,
            collection_id             : 0x1::string::utf8(b"0a0c4cee-e944-4c17-8fed-0f3c5aa8c624"),
            collection_creator_wallet : @0xeae73631aaecdc3912bd285f0b2c69779a834806129983f72ea2988d9da54e55,
