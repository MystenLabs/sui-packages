module 0xf5072c196ffabc6f38d650736df169998cbaf6a49a471d4c2d1662428845e55a::cnsnft7287 {
    struct CNSNFT7287 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7287, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6907"));
        let v4 = 0x2::package::claim<CNSNFT7287>(arg0, arg1);
