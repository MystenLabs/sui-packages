module 0xf57afc9e167795075a5708d1aeda6355ee8d47ee8f029e07aeeb500fa11f82a2::math {
    public fun bps() : u64 {
        10000
    }
    ...
    public fun calculate_percentage(arg0: u64, arg1: u64) : u64 {
        assert!(arg1 <= 10000, 0xf57afc9e167795075a5708d1aeda6355ee8d47ee8f029e07aeeb500fa11f82a2::errors::e_invalid_bps());
        (((arg0 as u128) * (arg1 as u128) / (10000 as u128)) as u64)
    }
    ...
    public fun calculate_total_pot(arg0: u64, arg1: u64) : u64 {
        ...
        assert!(v0 <= 18446744073709551615, 0xf57afc9e167795075a5708d1aeda6355ee8d47ee8f029e07aeeb500fa11f82a2::errors::e_overflow());
        (v0 as u64)
    }

    public fun calculate_winner_payout(arg0: u64, arg1: u64) : (u64, u64) {
        assert!(arg1 > 0, 0xf57afc9e167795075a5708d1aeda6355ee8d47ee8f029e07aeeb500fa11f82a2::errors::e_division_by_zero());
        (arg0 / arg1, arg0 % arg1)
    }
