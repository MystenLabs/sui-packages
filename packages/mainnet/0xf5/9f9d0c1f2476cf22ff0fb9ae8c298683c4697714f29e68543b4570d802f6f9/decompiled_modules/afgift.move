module 0xf59f9d0c1f2476cf22ff0fb9ae8c298683c4697714f29e68543b4570d802f6f9::afgift {
    ...
    public entry fun GiftFromAftermath(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = AFTERMATH_GIFTBOX{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftafcom_0812/giftafcom_0812_0.jpg"),
    ...
    fun init(arg0: AFGIFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftafcom_0812/giftafcom_0812_0.jpg"));
