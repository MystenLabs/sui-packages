module 0xf572b306877c2234a8db4def42f75d884fb4179966c200bf9de9d2eb9f9ad533::bonded_nft_dex {
    ...
    public fun mint_nft<T0>(arg0: &PlatformConfig, arg1: &mut Collection, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = 0x1::string::utf8(b"BondedNFT DEX - ");
        0x1::string::append(&mut v8, address_to_string(arg1.creator));
        let v9 = BoundNft{
        ...
        let v10 = NftMinted{
            collection_id : 0x2::object::id<Collection>(arg1),
            nft_id        : 0x2::object::id<BoundNft>(&v9),
            buyer         : v3,
            price_paid    : v1,
            token_type    : 0x1::string::utf8(*0x1::ascii::as_bytes(&v2)),
        ...
        0x2::transfer::public_transfer<BoundNft>(v9, v3);
    }
