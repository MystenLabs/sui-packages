module 0xf51c7c012715fee77300f5f9287e4c31872335f4cbd436151278762ed5efdf58::reward5283 {
    struct REWARD5283 has drop {
        dummy_field: bool,
    }

    struct TICKET_5283 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5283(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5283>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5283>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5283, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5283>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5283>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5283>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5283>>(v5, 0x2::tx_context::sender(arg1));
    }
