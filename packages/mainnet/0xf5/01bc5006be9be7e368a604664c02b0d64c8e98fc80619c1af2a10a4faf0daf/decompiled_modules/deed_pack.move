module 0xf501bc5006be9be7e368a604664c02b0d64c8e98fc80619c1af2a10a4faf0daf::deed_pack {
    ...
    public(friend) fun burn(arg0: DeedPack, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0xf501bc5006be9be7e368a604664c02b0d64c8e98fc80619c1af2a10a4faf0daf::events::emit_deed_burned(0x2::object::uid_to_address(&v3), v1, v2, arg1, arg2);
    ...
    public(friend) fun mint(arg0: address, arg1: u8, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xf501bc5006be9be7e368a604664c02b0d64c8e98fc80619c1af2a10a4faf0daf::events::emit_minted(arg0, arg1, arg2);
    }
