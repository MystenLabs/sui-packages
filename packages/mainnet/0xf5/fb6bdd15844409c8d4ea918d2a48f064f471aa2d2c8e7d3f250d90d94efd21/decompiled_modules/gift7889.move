module 0xf5fb6bdd15844409c8d4ea918d2a48f064f471aa2d2c8e7d3f250d90d94efd21::gift7889 {
    struct GIFT7889 has drop {
        dummy_field: bool,
    }

    struct TICKET_7889 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift7889(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7889>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7889>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT7889, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7889>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7889>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7889>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7889>>(v5, 0x2::tx_context::sender(arg1));
    }
