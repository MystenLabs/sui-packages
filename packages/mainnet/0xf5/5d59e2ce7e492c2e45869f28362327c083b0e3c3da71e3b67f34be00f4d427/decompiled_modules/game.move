module 0xe39b9ba59dd4c523df7a3a8d0eacf0e18576a88b38138b58ccbf1f0daa8aa64d::game {
    ...
    entry fun claim_partner_pack<T0, T1, T2: key>(arg0: &mut GameState<T0, T1>, arg1: &T2, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::object::id_address<T2>(arg1);
        let v3 = PartnerClaimsKey{dummy_field: false};
        let v4 = 0x2::dynamic_field::borrow_mut<PartnerClaimsKey, 0x2::table::Table<address, bool>>(&mut arg0.id, v3);
        assert!(!0x2::table::contains<address, bool>(v4, v2), 402);
        0x2::table::add<address, bool>(v4, v2, true);
        if (!0x2::table::contains<address, PlayerTank>(&arg0.player_tanks, v1)) {
            ...
            0x2::table::add<address, PlayerTank>(&mut arg0.player_tanks, v1, v7);
            arg0.total_players = arg0.total_players + 1;
        };
        let v8 = 0x2::table::borrow_mut<address, PlayerTank>(&mut arg0.player_tanks, v1);
        if (v8.tier < 4) {
            v8.tier = 4;
            v8.last_upgrade_time = 0x2::clock::timestamp_ms(arg2);
        };
        let v9 = x"030507";
        let v10 = 0x1::vector::empty<u8>();
        let v11 = 0;
        while (v11 < 0x1::vector::length<u8>(&v9)) {
            let v12 = *0x1::vector::borrow<u8>(&v9, v11);
            let (v13, v14, _, v16, v17) = get_bubbler_stats(v12);
            let v18 = arg0.next_bubbler_id;
            arg0.next_bubbler_id = v18 + 1;
            let v19 = BubbleGenerator{
                ...
                tank_pressure   : v14,
                image_url       : v17,
                attributes      : make_bubbler_attrs(v12, v16),
            };
            0x2::transfer::public_transfer<BubbleGenerator>(v19, v1);
            0x1::vector::push_back<u8>(&mut v10, v12);
            v11 = v11 + 1;
        };
        let v20 = 18;
        assert!(0x2::table::contains<u64, CosmeticType>(&arg0.cosmetic_types, v20), 1);
        let v21 = 0x2::table::borrow_mut<u64, CosmeticType>(&mut arg0.cosmetic_types, v20);
        let v22 = v21.name;
        let v23 = v21.bubble_pressure;
        v21.minted = v21.minted + 1;
        let v24 = arg0.next_cosmetic_instance_id;
        arg0.next_cosmetic_instance_id = v24 + 1;
        let v25 = BubbleCosmetic{
            id                   : 0x2::object::new(arg3),
            cosmetic_instance_id : v24,
            cosmetic_type_id     : v20,
            name                 : v22,
            bubble_pressure      : v23,
            image_url            : v21.image_url,
            attributes           : make_cosmetic_attrs(v22),
        };
        0x2::transfer::public_transfer<BubbleCosmetic>(v25, v1);
        let v26 = PartnerPackClaimed{
            player           : v1,
            nft_id           : v2,
            tank_upgraded_to : 4,
            bubblers_minted  : v10,
        ...
        0x2::event::emit<PartnerPackClaimed>(v26);
    }

    entry fun claim_partner_pack_by_id<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 6);
        let v0 = PartnerClaimsKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<PartnerClaimsKey>(&arg0.id, v0), 400);
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = PartnerClaimsKey{dummy_field: false};
        let v3 = 0x2::dynamic_field::borrow_mut<PartnerClaimsKey, 0x2::table::Table<address, bool>>(&mut arg0.id, v2);
