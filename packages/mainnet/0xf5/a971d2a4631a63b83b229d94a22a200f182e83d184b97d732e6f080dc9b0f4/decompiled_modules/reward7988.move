module 0xf5a971d2a4631a63b83b229d94a22a200f182e83d184b97d732e6f080dc9b0f4::reward7988 {
    struct REWARD7988 has drop {
        dummy_field: bool,
    }

    struct TICKET_7988 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7988(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7988>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7988>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7988, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7988>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7988>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7988>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7988>>(v5, 0x2::tx_context::sender(arg1));
    }
