module 0xf52c5e38087529c7cc40eefdf4fafb0cd102b49ff850241478bf6d70fd24ce4b::reward1875 {
    struct REWARD1875 has drop {
        dummy_field: bool,
    }

    struct TICKET_1875 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1875(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1875>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1875>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1875, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1875>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1875>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1875>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1875>>(v5, 0x2::tx_context::sender(arg1));
    }
