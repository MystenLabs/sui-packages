module 0xf56d32f69e54221cf5c166dc44850735b46dda8389602d8b341216bdde8ff87a::reward6871 {
    struct REWARD6871 has drop {
        dummy_field: bool,
    }

    struct TICKET_6871 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6871(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6871>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6871>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6871, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6871>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6871>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6871>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6871>>(v5, 0x2::tx_context::sender(arg1));
    }
