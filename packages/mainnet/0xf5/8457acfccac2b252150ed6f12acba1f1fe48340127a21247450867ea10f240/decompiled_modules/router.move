module 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::router {
    ...
    public fun calculate_router_swap_result<T0, T1, T2, T3>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T3>, arg2: bool, arg3: bool, arg4: bool, arg5: u64) {
        if (arg4) {
            let v0 = 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap<T0, T1>(arg0, arg2, arg4, arg5);
            let v1 = 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_amount_out(&v0);
            if (0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_is_exceed(&v0) || v1 > 18446744073709551615) {
                ...
                let v4 = (v1 as u64);
                let v5 = 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap<T2, T3>(arg1, arg3, arg4, v4);
                let v6 = 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_amount_out(&v5);
                if (v6 > 18446744073709551615) {
                    ...
                    let v9 = CalculatedRouterSwapResult{
                        ...
                        is_exceed             : 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_is_exceed(&v0) || 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_is_exceed(&v5),
                        ...
                        target_sqrt_price_ab  : 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_after_sqrt_price(&v0),
                        target_sqrt_price_cd  : 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_after_sqrt_price(&v5),
                    };
            ...
            let v11 = 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap<T2, T3>(arg1, arg3, arg4, arg5);
            let v12 = 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_is_exceed(&v11);
            let v13 = 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_amount_in(&v11);
            if (v12 || v13 > 18446744073709551615) {
                ...
                let v16 = (v13 as u64);
                let v17 = (0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_fee_amount(&v11) as u64);
                let v18 = 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap<T0, T1>(arg0, arg2, arg4, v16 + v17);
                let v19 = 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_amount_in(&v18);
                if (v19 > 18446744073709551615) {
                    ...
                    let v22 = CalculatedRouterSwapResult{
                        amount_in             : (v19 as u64) + (0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_fee_amount(&v18) as u64),
                        amount_medium         : v16 + v17,
                        amount_out            : arg5,
                        is_exceed             : 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_is_exceed(&v18) || v12,
                        current_sqrt_price_ab : 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg0),
                        current_sqrt_price_cd : 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T2, T3>(arg1),
                        target_sqrt_price_ab  : 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_after_sqrt_price(&v18),
                        target_sqrt_price_cd  : 0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::expect_swap::expect_swap_result_after_sqrt_price(&v11),
                    };
    ...
    public entry fun swap_ab_bc<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T2>, arg5: bool, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u128, arg11: u128, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        if (arg5) {
            ...
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T0>(v1, 0x2::tx_context::sender(arg13));
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T1>(v5, 0x2::tx_context::sender(arg13));
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T2>(v6, 0x2::tx_context::sender(arg13));
        } else {
            ...
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T0>(v12, 0x2::tx_context::sender(arg13));
            0x2::coin::join<T2>(&mut arg4, 0x2::coin::from_balance<T2>(v8, arg13));
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T2>(arg4, 0x2::tx_context::sender(arg13));
        };
    }
    ...
    public entry fun swap_ab_cb<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T2>, arg5: bool, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u128, arg11: u128, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        if (arg5) {
            ...
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T0>(v1, 0x2::tx_context::sender(arg13));
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T1>(v6, 0x2::tx_context::sender(arg13));
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T2>(v5, 0x2::tx_context::sender(arg13));
        } else {
    ...
    public entry fun swap_ba_bc<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T2>, arg5: bool, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u128, arg11: u128, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        if (arg5) {
            ...
            assert!(v4 >= arg7, 0);
            let (v5, v6) = swap<T1, T2>(arg0, arg2, v3, arg4, true, true, v4, arg9, arg11, arg12, arg13);
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T0>(v2, 0x2::tx_context::sender(arg13));
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T1>(v5, 0x2::tx_context::sender(arg13));
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T2>(v6, 0x2::tx_context::sender(arg13));
        } else {
            let (v7, v8, v9) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T1, T2>(arg0, arg2, true, false, arg7, arg11, arg12);
            ...
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T0>(v13, 0x2::tx_context::sender(arg13));
            0x2::coin::join<T2>(&mut arg4, 0x2::coin::from_balance<T2>(v8, arg13));
            0xf58457acfccac2b252150ed6f12acba1f1fe48340127a21247450867ea10f240::utils::send_coin<T2>(arg4, 0x2::tx_context::sender(arg13));
        };
    }
    ...
    public fun swap_without_amount<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: bool, arg5: bool, arg6: u64, arg7: u128, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let v0 = if (arg4) {
            0x2::coin::value<T0>(&arg2)
        } else {
            0x2::coin::value<T1>(&arg3)
        };
        let (v1, v2, v3) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg0, arg1, arg4, arg5, v0, arg7, arg8);
        let v4 = v3;
        let v5 = v2;
        let v6 = v1;
        ...
        let (v9, v10) = if (arg4) {
            (0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, v7, arg9)), 0x2::balance::zero<T1>())
        } else {
            (0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg3, v7, arg9)))
        };
