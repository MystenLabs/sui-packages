module 0xf50321f85fa463de4c183d45a255ab6dceb6e6f683651703594e2e551702f2a9::factory {
    ...
    public entry fun add_allowed_claimer<T0>(arg0: &mut PoolSimpleInfo, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun add_allowed_pair_configs<T0: store + key>(arg0: &mut PoolSimpleInfo, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
    ...
    public entry fun register_permission_pairs(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut PoolSimpleInfo, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
