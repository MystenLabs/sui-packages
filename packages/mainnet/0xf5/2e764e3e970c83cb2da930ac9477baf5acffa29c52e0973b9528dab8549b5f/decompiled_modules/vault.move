module 0x399abdf475acdfbc50ebd6b609ed7fc22dfac34bf7b8633738c53b62ddb3c57::vault {
    struct DeployedCapitalKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    fun add_deployed(arg0: &mut 0x2::object::UID, arg1: u64) {
        let v0 = DeployedCapitalKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<DeployedCapitalKey>(arg0, v0)) {
            let v1 = DeployedCapitalKey{dummy_field: false};
            let v2 = 0x2::dynamic_field::borrow_mut<DeployedCapitalKey, u64>(arg0, v1);
            *v2 = *v2 + arg1;
        } else {
            let v3 = DeployedCapitalKey{dummy_field: false};
            0x2::dynamic_field::add<DeployedCapitalKey, u64>(arg0, v3, arg1);
        };
    }
    ...
    fun calc_nav_per_share<T0>(arg0: &Vault<T0>) : u64 {
        ...
        ((((0x2::balance::value<T0>(&arg0.balance) + get_deployed(&arg0.id)) as u128) * (1000000 as u128) / (arg0.total_shares as u128)) as u64)
    }
    ...
    public fun create_and_share<T0>(arg0: &0x399abdf475acdfbc50ebd6b609ed7fc22dfac34bf7b8633738c53b62ddb3c57::admin::AdminCap, arg1: 0x2::coin::Coin<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = DeployedCapitalKey{dummy_field: false};
        0x2::dynamic_field::add<DeployedCapitalKey, u64>(&mut v1.id, v2, 0);
        let v3 = VaultCreated{
    ...
    public fun deployed_capital<T0>(arg0: &Vault<T0>) : u64 {
        get_deployed(&arg0.id)
    }
    ...
    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (arg0.total_shares == 0) {
            ...
            let v2 = 0x2::balance::value<T0>(&arg0.balance) + get_deployed(&arg0.id);
            assert!(v2 > 0, 29);
    ...
    fun get_deployed(arg0: &0x2::object::UID) : u64 {
        let v0 = DeployedCapitalKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<DeployedCapitalKey>(arg0, v0)) {
            let v2 = DeployedCapitalKey{dummy_field: false};
            *0x2::dynamic_field::borrow<DeployedCapitalKey, u64>(arg0, v2)
        } else {
            0
        }
    }
    ...
    public fun return_funds<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: bool, arg3: &0x399abdf475acdfbc50ebd6b609ed7fc22dfac34bf7b8633738c53b62ddb3c57::admin::AdminCap, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<T0>(&mut arg0.balance, 0x2::coin::into_balance<T0>(arg1));
        let v1 = &mut arg0.id;
        sub_deployed(v1, arg0.seed_per_side * 2);
        let v2 = FundsReturned{
            amount    : v0,
            is_refund : arg2,
        };
        0x2::event::emit<FundsReturned>(v2);
    }
    ...
    public fun seed_market<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x399abdf475acdfbc50ebd6b609ed7fc22dfac34bf7b8633738c53b62ddb3c57::market::Market<T0>, arg2: &0x399abdf475acdfbc50ebd6b609ed7fc22dfac34bf7b8633738c53b62ddb3c57::admin::AdminCap, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<MarketSeeded>(v7);
    }
    ...
    fun sub_deployed(arg0: &mut 0x2::object::UID, arg1: u64) {
        let v0 = DeployedCapitalKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<DeployedCapitalKey>(arg0, v0)) {
            let v1 = DeployedCapitalKey{dummy_field: false};
            let v2 = 0x2::dynamic_field::borrow_mut<DeployedCapitalKey, u64>(arg0, v1);
    ...
    public fun total_value<T0>(arg0: &Vault<T0>) : u64 {
        0x2::balance::value<T0>(&arg0.balance) + get_deployed(&arg0.id)
    }
    ...
    public fun withdraw<T0>(arg0: &mut Vault<T0>, arg1: VaultReceipt, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v4 = (((v1 as u128) * ((0x2::balance::value<T0>(&arg0.balance) + get_deployed(&arg0.id)) as u128) / (arg0.total_shares as u128)) as u64);
        ...
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance, v6), arg3)
    }
