module 0x399abdf475acdfbc50ebd6b609ed7fc22dfac34bf7b8633738c53b62ddb3c57::events {
    ...
    struct DepositFeeCharged has copy, drop {
        market_id: 0x2::object::ID,
        depositor: address,
        gross_amount: u64,
        net_amount: u64,
    ...
    struct DepositFeeUpdated has copy, drop {
        deposit_fee_bps: u16,
    }
    ...
    struct CutoffUpdated has copy, drop {
        duration: u8,
        cutoff_ms: u64,
    }
    ...
    public(friend) fun emit_cutoff_updated(arg0: u8, arg1: u64) {
        let v0 = CutoffUpdated{
            duration  : arg0,
            cutoff_ms : arg1,
        };
        0x2::event::emit<CutoffUpdated>(v0);
    }

    public(friend) fun emit_deposit_fee_updated(arg0: u16) {
        let v0 = DepositFeeUpdated{deposit_fee_bps: arg0};
        0x2::event::emit<DepositFeeUpdated>(v0);
    }

    public(friend) fun emit_deposited(arg0: 0x2::object::ID, arg1: address, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64) {
        let v0 = Deposited{
            market_id     : arg0,
            depositor     : arg1,
            side          : arg2,
        ...
        if (arg5 > 0) {
            ...
            0x2::event::emit<DepositFeeCharged>(v1);
        };
    }
