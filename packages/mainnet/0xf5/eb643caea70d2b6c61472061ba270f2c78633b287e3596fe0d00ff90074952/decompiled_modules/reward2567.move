module 0xf5eb643caea70d2b6c61472061ba270f2c78633b287e3596fe0d00ff90074952::reward2567 {
    struct REWARD2567 has drop {
        dummy_field: bool,
    }

    struct TICKET_2567 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2567(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2567>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2567>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2567, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2567>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2567>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2567>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2567>>(v5, 0x2::tx_context::sender(arg1));
    }
