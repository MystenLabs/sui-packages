module 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::market {
    ...
    struct Hearn has key {
        ...
        next_market_id: u64,
        irm: 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::adaptive_curve_irm::AdaptiveCurveIrm,
        is_paused: bool,
        user_market_ids: 0x2::table::Table<address, vector<u64>>,
    }

    public(friend) fun borrow<T0, T1>(arg0: &mut Hearn, arg1: u64, arg2: address, arg3: address, arg4: u128, arg5: u128, arg6: &0x2::clock::Clock, arg7: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg8: 0x1::option::Option<address>, arg9: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u128, u128) {
    ...
    fun accrue_borrow_totals_read_only(arg0: &Hearn, arg1: &Market, arg2: u64, arg3: &0x2::clock::Clock) : (u128, u128) {
        ...
        if (v0 == arg1.last_update) {
            ...
            (arg1.total_borrow_assets + 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_mul_down(arg1.total_borrow_assets, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_taylor_compounded(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::adaptive_curve_irm::borrow_rate_view(&arg0.irm, arg2, arg1.total_supply_assets, arg1.total_borrow_assets, arg1.last_update, arg3), (((v0 - arg1.last_update) / 1000) as u128))), arg1.total_borrow_shares)
        }
    }
    ...
    fun accrue_interest_internal(arg0: &mut Market, arg1: &mut 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::adaptive_curve_irm::AdaptiveCurveIrm, arg2: u64, arg3: &0x2::clock::Clock, arg4: address, arg5: &mut 0x2::table::Table<PositionKey, Position>, arg6: &mut 0x2::table::Table<address, u64>, arg7: &mut 0x2::table::Table<u64, Market>, arg8: &mut 0x2::table::Table<address, vector<u64>>) {
        let v0 = 0x2::clock::timestamp_ms(arg3);
        if (v0 == arg0.last_update) {
            return
        };
        let v1 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::adaptive_curve_irm::borrow_rate(arg1, arg2, arg0.total_supply_assets, arg0.total_borrow_assets, arg0.last_update, arg3);
        let v2 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_mul_down(arg0.total_borrow_assets, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_taylor_compounded(v1, (((v0 - arg0.last_update) / 1000) as u128)));
        ...
        let v3 = if (arg0.fee != 0 && v2 > 0) {
            let v4 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_mul_down(v2, arg0.fee);
            let v5 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_shares_down(v4, arg0.total_supply_assets - v4, arg0.total_supply_shares);
            if (v5 > 0) {
                let v6 = PositionKey{
                    market_id : arg2,
                    owner     : arg4,
        ...
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_accrue_interest(arg2, arg0.config.loan_token_type, arg0.config.collateral_token_type, v1, v2, v3);
        arg0.last_update = v0;
    }
    ...
    fun borrow_with_price<T0, T1>(arg0: &mut Hearn, arg1: u64, arg2: address, arg3: address, arg4: u128, arg5: u128, arg6: &0x2::clock::Clock, arg7: u128, arg8: 0x1::option::Option<address>, arg9: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u128, u128) {
        ...
        let (v11, v12) = if (arg4 > 0) {
            (arg4, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_shares_up(arg4, v0.total_borrow_assets, v0.total_borrow_shares))
        } else {
            (0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_down(arg5, v0.total_borrow_assets, v0.total_borrow_shares), arg5)
        };
        ...
        let v23 = if (v11 > 0) {
            0x2::coin::split<T0>(&mut v10, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_u64(v11), arg9)
        } else {
        ...
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_borrow(arg1, 0x2::tx_context::sender(arg9), arg2, arg3, v11, v12, v0.config.loan_token_type, v0.config.collateral_token_type);
        (v23, v11, v12)
    }

    fun calculate_health_values(arg0: u64, arg1: u64, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u128, arg7: u64) : (u128, u128) {
        (0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(arg2, arg3, arg4), 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad(), decimal_scale(arg1)), 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(arg5, arg6, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad()), (arg7 as u128), decimal_scale(arg0)))
    }
    ...
    public(friend) fun create_market(arg0: &mut Hearn, arg1: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg2: MarketParams, arg3: u128, arg4: u128, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : u64 {
        assert_version(arg0);
        ...
        let (v0, v1) = 0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::market_decimals(arg1, arg2.oracle_id);
        ...
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_create_market(v2, arg2.loan_token_type, arg2.collateral_token_type, arg2.oracle_id, arg2.ltv, arg2.lltv, arg3, arg4, 0x2::table::borrow<u64, Market>(&arg0.markets, v2).title, v0, v1);
        v2
    }

    public(friend) fun create_market_typed<T0, T1>(arg0: &mut Hearn, arg1: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u128, arg7: u128, arg8: vector<u8>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : u64 {
    ...
    public(friend) fun enable_lltv(arg0: &mut Hearn, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        ...
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_enable_lltv(arg1);
    }
    ...
    public(friend) fun flash_loan<T0>(arg0: &mut Hearn, arg1: u64, arg2: u64, arg3: u128, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanReceipt<T0>) {
        ...
        store_market(arg0, arg1, v0);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_flash_loan(0x2::tx_context::sender(arg4), 0x1::type_name::with_defining_ids<T0>(), arg3);
        let v7 = FlashLoanReceipt<T0>{
            market_id  : arg1,
            amount     : arg3,
            token_slot : arg2,
        };
        (0x2::coin::split<T0>(&mut v4, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_u64(arg3), arg4), v7)
    }
    ...
    public(friend) fun flash_loan_repay<T0>(arg0: &mut Hearn, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: FlashLoanReceipt<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if ((0x2::coin::value<T0>(&arg2) as u128) < v1 + 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_mul_down(v1, v3.flashloan_fee)) {
    ...
    fun get_user_position_info_with_price(arg0: &Hearn, arg1: &Market, arg2: u64, arg3: address, arg4: u128) : UserPositionInfo {
        ...
        let v5 = if (!0x2::table::contains<PositionKey, Position>(&arg0.positions, v0) || v2 == 0) {
            ...
            if (v6 == 0) {
                ...
                0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_div_down(v7, v6)
            }
        };
        UserPositionInfo{
            market_id                   : arg2,
    ...
    public(friend) fun liquidate<T0, T1>(arg0: &mut Hearn, arg1: u64, arg2: address, arg3: u128, arg4: u128, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, u128, u128, u128, 0x2::coin::Coin<T0>) {
    ...
    public fun liquidate_plan<T0, T1>(arg0: &Hearn, arg1: u64, arg2: address, arg3: u128, arg4: u128, arg5: &0x2::clock::Clock, arg6: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle) : (u128, u128, u128, bool) {
        assert_version(arg0);
    ...
    fun liquidate_plan_with_price(arg0: &Market, arg1: &Position, arg2: u128, arg3: u128, arg4: u128) : (u128, u128, u128, bool) {
        ...
        let v0 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad() - 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_mul_down(300000000000000000, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad() - (arg0.config.lltv as u128));
        let v1 = if (v0 > 0) {
            let v2 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_div_down(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad(), v0);
            let v3 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad() + 150000000000000000;
            if (v2 < v3) {
                v2
            } else {
                v3
            ...
            0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad() + 150000000000000000
        };
        let (v4, v5) = if (arg2 > 0) {
            (0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_shares_up(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_div_up(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(arg2, arg4, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad()), v1), arg0.total_borrow_assets, arg0.total_borrow_shares), arg2)
        } else {
            (arg3, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_mul_down(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_down(arg3, arg0.total_borrow_assets, arg0.total_borrow_shares), v1), 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad(), arg4))
        };
        ...
        while (v8 < 2) {
            if (v4 > v6) {
                v4 = v6;
                v5 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_mul_down(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_down(v6, arg0.total_borrow_assets, arg0.total_borrow_shares), v1), 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad(), arg4);
            };
            if (v5 > v7) {
                v5 = v7;
                v4 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_shares_up(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_div_up(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(v7, arg4, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad()), v1), arg0.total_borrow_assets, arg0.total_borrow_shares);
            };
            v8 = v8 + 1;
        };
        if (v4 > v6) {
    ...
    fun liquidate_with_price<T0, T1>(arg0: &mut Hearn, arg1: u64, arg2: address, arg3: u128, arg4: u128, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: u128, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, u128, u128, u128, 0x2::coin::Coin<T0>) {
        ...
        let (v19, v20) = if (v18 > v14) {
            if (v14 == 0) {
                ...
                (0x2::coin::split<T0>(&mut arg5, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_u64(v14), arg8), arg5)
            }
        } else {
        ...
        v0.total_borrow_assets = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::zero_floor_sub(v0.total_borrow_assets, v14);
        v12.collateral = v12.collateral - v15;
        let (v21, v22) = if (v12.collateral == 0 && v12.borrow_shares > 0) {
            let v23 = v12.borrow_shares;
            let v24 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(v23, v0.total_borrow_assets, v0.total_borrow_shares);
        ...
        store_market(arg0, arg1, v0);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_liquidate(arg1, 0x2::tx_context::sender(arg8), arg2, v14, v16, v15, v21, v22, v0.config.loan_token_type, v0.config.collateral_token_type);
        (0x2::coin::split<T1>(&mut v34, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_u64(v15), arg8), v15, v16, v14, v20)
    }
    ...
    public fun market_borrow_rate(arg0: &Hearn, arg1: u64, arg2: &0x2::clock::Clock) : u128 {
        assert!(0x2::table::contains<u64, Market>(&arg0.markets, arg1), 2);
        let v0 = 0x2::table::borrow<u64, Market>(&arg0.markets, arg1);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::adaptive_curve_irm::borrow_rate_view(&arg0.irm, arg1, v0.total_supply_assets, v0.total_borrow_assets, v0.last_update, arg2)
    }
    ...
    public fun market_info(arg0: &Hearn, arg1: u64, arg2: &0x2::clock::Clock) : MarketInfo {
        assert!(0x2::table::contains<u64, Market>(&arg0.markets, arg1), 2);
        let v0 = 0x2::table::borrow<u64, Market>(&arg0.markets, arg1);
        let v1 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::adaptive_curve_irm::borrow_rate_view(&arg0.irm, arg1, v0.total_supply_assets, v0.total_borrow_assets, v0.last_update, arg2);
        let v2 = if (v0.total_supply_assets > 0) {
            0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_div_down(v0.total_borrow_assets, v0.total_supply_assets)
        } else {
            0
        };
        MarketInfo{
            ...
            supply_rate                  : 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_mul_down(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_mul_down(v1, v2), 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad() - v0.fee),
            borrow_rate                  : v1,
            utilization_rate             : v2,
    ...
    public fun market_rate_at_target(arg0: &Hearn, arg1: u64) : u128 {
        assert!(0x2::table::contains<u64, Market>(&arg0.markets, arg1), 2);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::adaptive_curve_irm::rate_at_target_view(&arg0.irm, arg1)
    }
    ...
    public fun market_supply_rate(arg0: &Hearn, arg1: u64, arg2: &0x2::clock::Clock) : u128 {
        ...
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_mul_down(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_mul_down(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::adaptive_curve_irm::borrow_rate_view(&arg0.irm, arg1, v0.total_supply_assets, v0.total_borrow_assets, v0.last_update, arg2), v1), 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad() - v0.fee)
    }
    ...
    fun max_borrowable_with_price_wad(arg0: &Hearn, arg1: &Market, arg2: u64, arg3: address, arg4: u128) : u128 {
        ...
        let v3 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(v2.collateral, arg4, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad());
        if (v3 == 0) {
            return 0
        };
        let v4 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(v3, (arg1.config.ltv as u128), decimal_scale(arg1.base_token_decimals));
        if (v4 == 0) {
            return 0
        };
        let v5 = if (v2.borrow_shares == 0) {
            ...
            0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(v2.borrow_shares, arg1.total_borrow_assets, arg1.total_borrow_shares), 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad(), v0)
        };
        let v6 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::zero_floor_sub(v4, v5);
        if (v6 == 0) {
            return 0
        };
        let v7 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(v6, v0, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad());
        if (v7 == 0) {
            return 0
        };
    ...
    fun max_withdrawable_collateral_with_price_wad(arg0: &Hearn, arg1: &Market, arg2: u64, arg3: address, arg4: u128) : u128 {
        ...
        let v2 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(v1.borrow_shares, arg1.total_borrow_assets, arg1.total_borrow_shares);
        if (v2 == 0) {
            return v1.collateral
        };
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::zero_floor_sub(v1.collateral, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div_up(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div_up(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(v2, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad(), decimal_scale(arg1.quote_token_decimals)), decimal_scale(arg1.base_token_decimals), (arg1.config.lltv as u128)), 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad(), arg4))
    }

    public(friend) fun migrate(arg0: &mut Hearn, arg1: &0x2::tx_context::TxContext) {
        ensure_owner(arg0, 0x2::tx_context::sender(arg1));
        arg0.version = 1;
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_migrate(arg0.version);
    }
    ...
    fun new_hearn(arg0: address, arg1: &mut 0x2::tx_context::TxContext) : Hearn {
        Hearn{
            ...
            next_market_id  : 1,
            irm             : 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::adaptive_curve_irm::create(arg1),
            is_paused       : false,
    ...
    fun project_borrow_shares_after_change(arg0: u128, arg1: u128, arg2: bool, arg3: u128, arg4: u128) : u128 {
        let v0 = if (arg1 == 0) {
            ...
            0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_shares_up(arg1, arg3, arg4)
        } else {
            0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_shares_down(arg1, arg3, arg4)
        };
        if (arg2) {
            arg0 + v0
        } else if (arg0 >= v0) {
    ...
    fun read_oracle_liquidate_price(arg0: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg1: u64, arg2: &0x2::clock::Clock) : u128 {
        let (v0, _) = 0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::query_price(arg0, arg1, true, arg2);
        v0
    }

    fun read_oracle_price(arg0: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg1: u64, arg2: &0x2::clock::Clock) : u128 {
        0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::price(arg0, arg1, arg2)
    }
    ...
    public(friend) fun repay<T0, T1>(arg0: &mut Hearn, arg1: u64, arg2: address, arg3: u128, arg4: u128, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (u128, u128, 0x2::coin::Coin<T0>) {
        ...
        accrue_interest_internal(v1, v2, arg1, arg6, arg0.fee_recipient, v3, v4, v5, v6);
        let (v7, v8) = if (arg3 > 0) {
            (arg3, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_shares_up(arg3, v0.total_borrow_assets, v0.total_borrow_shares))
        } else {
            (0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(arg4, v0.total_borrow_assets, v0.total_borrow_shares), arg4)
        };
        let v9 = v8;
        let v10 = v7;
        ...
        if (v9 > v16.borrow_shares) {
            ...
            v9 = v18;
            v10 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(v18, v0.total_borrow_assets, v0.total_borrow_shares);
        };
        ...
        let (v24, v25) = if (v19 > v10) {
            if (v10 == 0) {
                ...
                (0x2::coin::split<T0>(&mut arg5, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_u64(v10), arg7), arg5)
            }
        } else {
        ...
        v0.total_borrow_assets = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::zero_floor_sub(v0.total_borrow_assets, v10);
        store_market(arg0, arg1, v0);
        ...
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_repay(arg1, 0x2::tx_context::sender(arg7), arg2, v10, v9, v0.config.loan_token_type, v0.config.collateral_token_type);
        (v10, v9, v25)
    }
    ...
    public(friend) fun set_authorization(arg0: &mut Hearn, arg1: address, arg2: bool, arg3: &0x2::tx_context::TxContext) {
        ...
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_authorization(v0, v0, arg1, arg2, 0x1::option::none<u64>());
    }
    ...
    public(friend) fun set_fee(arg0: &mut Hearn, arg1: u64, arg2: u128, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        v0.fee = arg2;
        store_market(arg0, arg1, v0);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_fee(arg1, arg2);
    }
    ...
    public(friend) fun set_fee_recipient(arg0: &mut Hearn, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_fee_recipient(arg0.fee_recipient, arg1);
    }
    ...
    public(friend) fun set_flashloan_fee(arg0: &mut Hearn, arg1: u64, arg2: u128, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        store_market(arg0, arg1, v0);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_flashloan_fee(arg1, arg2);
    }
    ...
    public(friend) fun set_global_pause(arg0: &mut Hearn, arg1: bool, arg2: &0x2::tx_context::TxContext) {
        ...
        ensure_owner(arg0, 0x2::tx_context::sender(arg2));
        arg0.is_paused = arg1;
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_global_pause(arg1);
    }
    ...
    public(friend) fun set_market_borrow_pause(arg0: &mut Hearn, arg1: u64, arg2: bool, arg3: &0x2::tx_context::TxContext) {
        ...
        store_market(arg0, arg1, v0);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_market_borrow_pause(arg1, arg2);
    }
    ...
    public(friend) fun set_market_pause(arg0: &mut Hearn, arg1: u64, arg2: bool, arg3: &0x2::tx_context::TxContext) {
        ...
        v0.is_paused = arg2;
        store_market(arg0, arg1, v0);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_market_pause(arg1, arg2);
    }
    ...
    public(friend) fun set_market_repay_pause(arg0: &mut Hearn, arg1: u64, arg2: bool, arg3: &0x2::tx_context::TxContext) {
        ...
        store_market(arg0, arg1, v0);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_market_repay_pause(arg1, arg2);
    }
    ...
    public(friend) fun set_market_supply_collateral_pause(arg0: &mut Hearn, arg1: u64, arg2: bool, arg3: &0x2::tx_context::TxContext) {
        ...
        store_market(arg0, arg1, v0);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_market_supply_collateral_pause(arg1, arg2);
    }
    ...
    public(friend) fun set_market_supply_pause(arg0: &mut Hearn, arg1: u64, arg2: bool, arg3: &0x2::tx_context::TxContext) {
        ...
        store_market(arg0, arg1, v0);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_market_supply_pause(arg1, arg2);
    }
    ...
    public(friend) fun set_market_withdraw_collateral_pause(arg0: &mut Hearn, arg1: u64, arg2: bool, arg3: &0x2::tx_context::TxContext) {
        ...
        store_market(arg0, arg1, v0);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_market_withdraw_collateral_pause(arg1, arg2);
    }
    ...
    public(friend) fun set_market_withdraw_pause(arg0: &mut Hearn, arg1: u64, arg2: bool, arg3: &0x2::tx_context::TxContext) {
        ...
        store_market(arg0, arg1, v0);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_market_withdraw_pause(arg1, arg2);
    }
    ...
    public(friend) fun set_owner(arg0: &mut Hearn, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        ensure_owner(arg0, 0x2::tx_context::sender(arg2));
        arg0.owner = arg1;
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_set_owner(arg0.owner, arg1);
    }
    ...
    public(friend) fun supply<T0>(arg0: &mut Hearn, arg1: u64, arg2: address, arg3: u128, arg4: u128, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (u128, u128, 0x2::coin::Coin<T0>) {
        ...
        let (v8, v9) = if (arg3 > 0) {
            (arg3, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_shares_down(arg3, v0.total_supply_assets, v0.total_supply_shares))
        } else {
            (0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(arg4, v0.total_supply_assets, v0.total_supply_shares), arg4)
        };
        if (v7 < v8) {
            store_market(arg0, arg1, v0);
            abort 7
        ...
        let (v10, v11) = if (v7 > v8) {
            if (v8 == 0) {
                ...
                (0x2::coin::split<T0>(&mut arg5, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_u64(v8), arg7), arg5)
            }
        } else {
            (arg5, 0x2::coin::zero<T0>(arg7))
        };
        ...
        store_market(arg0, arg1, v0);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_supply(arg1, 0x2::tx_context::sender(arg7), arg2, v8, v9, v0.config.loan_token_type, v0.config.collateral_token_type);
        (v8, v9, v11)
    }
    ...
    public(friend) fun supply_collateral<T0>(arg0: &mut Hearn, arg1: u64, arg2: address, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) : (u128, 0x2::coin::Coin<T0>) {
        ...
        let (v10, v11) = if (v9 == 0) {
            ...
            add_to_reserve<T0>(v13, 1, 0x2::coin::split<T0>(&mut arg3, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_u64(v9), arg4));
            (arg3, true)
        };
        if (v11) {
        ...
        if (v11) {
            0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_supply_collateral(arg1, 0x2::tx_context::sender(arg4), arg2, v9, v1.config.loan_token_type, v1.config.collateral_token_type);
        };
        (v9, v10)
    }
    ...
    public fun user_health_factor(arg0: &Hearn, arg1: u64, arg2: address, arg3: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg4: &0x2::clock::Clock) : u128 {
        let v0 = PositionKey{
            market_id : arg1,
            owner     : arg2,
        };
        ...
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_div_down(v4, v3)
    }

    public fun user_health_factor_after_change(arg0: &Hearn, arg1: u64, arg2: address, arg3: u128, arg4: bool, arg5: u128, arg6: bool, arg7: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg8: &0x2::clock::Clock) : u128 {
        let v0 = PositionKey{
            market_id : arg1,
            owner     : arg2,
        };
        ...
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_div_down(v10, v9)
    }
    ...
    public fun user_max_borrow_assets_for_health_factor(arg0: &Hearn, arg1: u64, arg2: address, arg3: u128, arg4: bool, arg5: u128, arg6: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg7: &0x2::clock::Clock) : (u128, u128) {
        assert!(0x2::table::contains<u64, Market>(&arg0.markets, arg1), 2);
        let v0 = PositionKey{
            market_id : arg1,
            owner     : arg2,
        ...
        let v11 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(v7, v8, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad());
        if (v11 == 0) {
            return (0, user_health_factor_after_change(arg0, arg1, arg2, 0, true, arg3, arg4, arg6, arg7))
        };
        let v12 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(v11, (v1.config.lltv as u128), v2);
        if (v12 == 0) {
            return (0, user_health_factor_after_change(arg0, arg1, arg2, 0, true, arg3, arg4, arg6, arg7))
        };
        let v13 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_div_down(v12, arg5);
        if (v13 == 0) {
            return (0, user_health_factor_after_change(arg0, arg1, arg2, 0, true, arg3, arg4, arg6, arg7))
        };
        let v14 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div_down(v13, v3, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad());
        if (v14 == 0) {
            return (0, user_health_factor_after_change(arg0, arg1, arg2, 0, true, arg3, arg4, arg6, arg7))
        };
        if (0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(v4, v9, v10) >= v14) {
            return (0, user_health_factor_after_change(arg0, arg1, arg2, 0, true, arg3, arg4, arg6, arg7))
        };
        let v15 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_shares_down(v14, v9, v10);
        if (v15 <= v4) {
            return (0, user_health_factor_after_change(arg0, arg1, arg2, 0, true, arg3, arg4, arg6, arg7))
        };
        let v16 = v15 - v4;
        let v17 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(v16, v9, v10);
        let v18 = v17;
        if (v17 == 0) {
            return (0, user_health_factor_after_change(arg0, arg1, arg2, 0, true, arg3, arg4, arg6, arg7))
        };
        ...
        let v20 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_shares_up(v18, v9, v10);
        let v21 = v20;
        if (v20 > v16) {
            v21 = v16;
            v18 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(v16, v9, v10);
        };
        if (user_health_factor_after_change(arg0, arg1, arg2, v18, true, arg3, arg4, arg6, arg7) < arg5 && v21 > 0) {
            v18 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(v21 - 1, v9, v10);
        };
        (v18, user_health_factor_after_change(arg0, arg1, arg2, v18, true, arg3, arg4, arg6, arg7))
    }

    public fun user_max_borrowable(arg0: &Hearn, arg1: u64, arg2: address, arg3: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg4: &0x2::clock::Clock) : u128 {
        assert!(0x2::table::contains<u64, Market>(&arg0.markets, arg1), 2);
        let v0 = 0x2::table::borrow<u64, Market>(&arg0.markets, arg1);
        max_borrowable_with_price_wad(arg0, v0, arg1, arg2, read_oracle_price(arg3, v0.config.oracle_id, arg4))
    }

    public fun user_max_withdrawable_collateral(arg0: &Hearn, arg1: u64, arg2: address, arg3: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg4: &0x2::clock::Clock) : u128 {
        assert!(0x2::table::contains<u64, Market>(&arg0.markets, arg1), 2);
        let v0 = 0x2::table::borrow<u64, Market>(&arg0.markets, arg1);
        max_withdrawable_collateral_with_price_wad(arg0, v0, arg1, arg2, read_oracle_price(arg3, v0.config.oracle_id, arg4))
    }

    public fun user_min_collateral_for_health_factor(arg0: &Hearn, arg1: u64, arg2: address, arg3: u128, arg4: bool, arg5: u128, arg6: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg7: &0x2::clock::Clock) : (u128, u128) {
        assert!(0x2::table::contains<u64, Market>(&arg0.markets, arg1), 2);
        let v0 = PositionKey{
            market_id : arg1,
            owner     : arg2,
        ...
        let v10 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div(0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(v9, v7, v8), 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad(), v3);
        let v11 = 0;
        if (v10 != 0 && arg5 != 0) {
            let v12 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::w_mul_up(v10, arg5);
            if (v12 != 0) {
                let v13 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div_up(v12, v2, (v1.config.lltv as u128));
                if (v13 != 0) {
                    let v14 = 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::mul_div_up(v13, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad(), read_oracle_price(arg6, v1.config.oracle_id, arg7));
                    if (v14 > v5) {
                        v11 = v14 - v5;
                    };
                };
    ...
    public fun user_position_borrow_assets(arg0: &Hearn, arg1: u64, arg2: address) : u128 {
        ...
        let v1 = 0x2::table::borrow<u64, Market>(&arg0.markets, arg1);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_up(v0, v1.total_borrow_assets, v1.total_borrow_shares)
    }
    ...
    public fun user_position_info(arg0: &Hearn, arg1: u64, arg2: address, arg3: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg4: &0x2::clock::Clock) : UserPositionInfo {
        assert!(0x2::table::contains<u64, Market>(&arg0.markets, arg1), 2);
        get_user_position_info_with_price(arg0, 0x2::table::borrow<u64, Market>(&arg0.markets, arg1), arg1, arg2, 0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::price(arg3, market_oracle_config_id(arg0, arg1), arg4))
    }
    ...
    public fun user_position_supply_assets(arg0: &Hearn, arg1: u64, arg2: address) : u128 {
        ...
        let v1 = 0x2::table::borrow<u64, Market>(&arg0.markets, arg1);
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_down(v0, v1.total_supply_assets, v1.total_supply_shares)
    }
    ...
    public fun user_positions_batch(arg0: &Hearn, arg1: address) : vector<UserPositionInfo> {
        ...
        while (v2 < 0x1::vector::length<u64>(&v0)) {
            ...
            let v9 = UserPositionInfo{
                ...
                health_factor               : 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::wad(),
    ...
    public(friend) fun withdraw<T0>(arg0: &mut Hearn, arg1: u64, arg2: address, arg3: address, arg4: u128, arg5: u128, arg6: &0x2::clock::Clock, arg7: 0x1::option::Option<address>, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u128, u128) {
        ...
        accrue_interest_internal(v1, v2, arg1, arg6, arg0.fee_recipient, v3, v4, v5, v6);
        let (v7, v8) = if (arg4 > 0) {
            (arg4, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_shares_up(arg4, v0.total_supply_assets, v0.total_supply_shares))
        } else {
            (0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_assets_down(arg5, v0.total_supply_assets, v0.total_supply_shares), arg5)
        };
        ...
        let v15 = if (v7 > 0) {
            ...
            0x2::coin::split<T0>(&mut v13, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_u64(v7), arg8)
        } else {
        ...
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_withdraw(arg1, 0x2::tx_context::sender(arg8), arg2, arg3, v7, v8, v0.config.loan_token_type, v0.config.collateral_token_type);
        (v15, v7, v8)
    }

    public(friend) fun withdraw_collateral<T0, T1>(arg0: &mut Hearn, arg1: u64, arg2: address, arg3: address, arg4: u128, arg5: &0x2::clock::Clock, arg6: address, arg7: &0xc7be60e19a1313724e11f339b0b49a34926905d1d09da89e99932882fc62066e::pyth_oracle::Oracle, arg8: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
    ...
    fun withdraw_collateral_with_price<T0, T1>(arg0: &mut Hearn, arg1: u64, arg2: address, arg3: address, arg4: u128, arg5: &0x2::clock::Clock, arg6: address, arg7: u128, arg8: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::events::emit_withdraw_collateral(arg1, arg6, arg2, arg3, arg4, v0.config.loan_token_type, v0.config.collateral_token_type);
        0x2::coin::split<T1>(&mut v17, 0xf57b4317fff813316297725694d50b04bf8ca46123424107686723298b35b96c::math::to_u64(arg4), arg8)
    }
