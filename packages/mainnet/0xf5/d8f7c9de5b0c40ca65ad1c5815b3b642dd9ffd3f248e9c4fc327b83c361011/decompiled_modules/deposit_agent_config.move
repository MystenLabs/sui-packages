module 0x4ad10988a24d5123197a799c8ebf8932aa24e9be382e786eb11e86c166787120::deposit_agent_config {
    ...
    public(friend) fun token_holder_receive<T0>(arg0: &mut DepositAgentConfig, arg1: &0xc08acf679e0c4e3c1328e3dc3b349e4b24428a12d3830471bd8b1f9e4201585e::cloud_wallet_config::CloudWalletConfig, arg2: &mut 0xc08acf679e0c4e3c1328e3dc3b349e4b24428a12d3830471bd8b1f9e4201585e::cloud_wallet_config::CloudWalletTokenHolder, arg3: u256, arg4: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg5: address, arg6: u64, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        check_signer(arg0, 0x4ad10988a24d5123197a799c8ebf8932aa24e9be382e786eb11e86c166787120::utils::ecrecover(arg7, get_collect_to_sign_msg<T0>(0x2::object::id_address<DepositAgentTokenHolder>(v0), arg3, 0x2::coin::value<T0>(&v1), arg5, arg6)));
        0xc08acf679e0c4e3c1328e3dc3b349e4b24428a12d3830471bd8b1f9e4201585e::cloud_wallet::mm_credit<T0>(arg1, arg2, v1, arg8);
    }

    public(friend) fun token_holder_receive_v2<T0>(arg0: &mut DepositAgentConfig, arg1: &0xc08acf679e0c4e3c1328e3dc3b349e4b24428a12d3830471bd8b1f9e4201585e::cloud_wallet_config::CloudWalletConfig, arg2: &mut 0xc08acf679e0c4e3c1328e3dc3b349e4b24428a12d3830471bd8b1f9e4201585e::cloud_wallet_config::CloudWalletTokenHolder, arg3: u256, arg4: u64, arg5: address, arg6: u64, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<u256, DepositAgentTokenHolder>(&arg0.token_holder_table, arg3), 40007);
        let v0 = 0x2::table::borrow_mut<u256, DepositAgentTokenHolder>(&mut arg0.token_holder_table, arg3);
        check_signer(arg0, 0x4ad10988a24d5123197a799c8ebf8932aa24e9be382e786eb11e86c166787120::utils::ecrecover(arg7, get_collect_to_sign_msg<T0>(0x2::object::id_address<DepositAgentTokenHolder>(v0), arg3, arg4, arg5, arg6)));
        0xc08acf679e0c4e3c1328e3dc3b349e4b24428a12d3830471bd8b1f9e4201585e::cloud_wallet::mm_credit<T0>(arg1, arg2, 0x2::coin::from_balance<T0>(0x2::balance::redeem_funds<T0>(0x2::balance::withdraw_funds_from_object<T0>(&mut v0.id, arg4)), arg8), arg8);
    }
    ...
    public(friend) fun when_to_address_match(arg0: &0xc08acf679e0c4e3c1328e3dc3b349e4b24428a12d3830471bd8b1f9e4201585e::cloud_wallet_config::CloudWalletTokenHolder, arg1: address) {
        assert!(arg1 == 0x2::object::id_address<0xc08acf679e0c4e3c1328e3dc3b349e4b24428a12d3830471bd8b1f9e4201585e::cloud_wallet_config::CloudWalletTokenHolder>(arg0), 40012);
    }
