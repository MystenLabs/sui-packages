module 0xf53ed035e14907d586925acc6491258dfc107cc1fa2dd2c831ae054c993556a8::cnsnft8976 {
    struct CNSNFT8976 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8976, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8976>(arg0, arg1);
