module 0xf5fe3700a4761512c7310bcb19ee93a39320b7afc8e53995e21e38bdd8fa8a2f::gift7966 {
    struct GIFT7966 has drop {
        dummy_field: bool,
    }

    struct TICKET_7966 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift7966(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7966>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7966>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT7966, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7966>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7966>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7966>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7966>>(v5, 0x2::tx_context::sender(arg1));
    }
