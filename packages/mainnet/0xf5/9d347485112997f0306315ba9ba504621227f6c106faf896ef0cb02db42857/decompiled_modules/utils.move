module 0xf59d347485112997f0306315ba9ba504621227f6c106faf896ef0cb02db42857::utils {
    ...
    fun compare_struct<T0, T1>() : u8 {
        ...
        let v2 = 0xf59d347485112997f0306315ba9ba504621227f6c106faf896ef0cb02db42857::comparator::compare_u8_vector(v0, v1);
        if (0xf59d347485112997f0306315ba9ba504621227f6c106faf896ef0cb02db42857::comparator::is_greater_than(&v2)) {
            2
        } else {
            let v4 = 0xf59d347485112997f0306315ba9ba504621227f6c106faf896ef0cb02db42857::comparator::compare_u8_vector(v0, v1);
            if (0xf59d347485112997f0306315ba9ba504621227f6c106faf896ef0cb02db42857::comparator::is_equal(&v4)) {
                0
            } else {
                1
            }
