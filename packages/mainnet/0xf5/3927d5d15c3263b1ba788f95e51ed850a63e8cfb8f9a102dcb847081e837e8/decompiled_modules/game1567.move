module 0xf53927d5d15c3263b1ba788f95e51ed850a63e8cfb8f9a102dcb847081e837e8::game1567 {
    struct GAME1567 has drop {
        dummy_field: bool,
    }

    struct TICKET_1567 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1567(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1567>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1567>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME1567, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME1567>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1567>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1567>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1567>>(v5, 0x2::tx_context::sender(arg1));
    }
