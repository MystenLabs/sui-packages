module 0xf503e57021afab298c4d077001d896241bed160af44b3df8e498ea7ce1b3d32f::vault_core_v2 {
    ...
    public(friend) fun check_delegation<T0>(arg0: &ResourceVault<T0>, arg1: vector<u8>, arg2: address, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) : bool {
        let (v0, v1) = is_delegated(&arg0.delegations, arg1);
        if (!v0) {
            return false
        };
        let v2 = 0x1::vector::borrow<DelegationInfo>(&arg0.delegations, v1);
        if (0x2::clock::timestamp_ms(arg4) / 1000 < v2.expiry) {
            if (arg2 == v2.delegate) {
                arg3 <= v2.amount
            } else {
                false
    ...
    public(friend) fun create_delegation<T0>(arg0: &mut ResourceVault<T0>, arg1: vector<u8>, arg2: address, arg3: address, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg7) == arg0.owner, 0);
        assert!(0x2::balance::value<T0>(&arg0.balance) >= arg4, 5);
        let v0 = 0x2::clock::timestamp_ms(arg6) / 1000 + arg5;
        let v1 = DelegationInfo{
            delegate          : arg2,
            intent_ref_hash   : arg1,
            targeted_reciever : arg3,
            amount            : arg4,
            expiry            : v0,
            frozen            : false,
        };
