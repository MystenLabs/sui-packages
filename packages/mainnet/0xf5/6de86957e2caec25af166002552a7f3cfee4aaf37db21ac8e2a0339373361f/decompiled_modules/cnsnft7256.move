module 0xf56de86957e2caec25af166002552a7f3cfee4aaf37db21ac8e2a0339373361f::cnsnft7256 {
    struct CNSNFT7256 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7256, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7256>(arg0, arg1);
