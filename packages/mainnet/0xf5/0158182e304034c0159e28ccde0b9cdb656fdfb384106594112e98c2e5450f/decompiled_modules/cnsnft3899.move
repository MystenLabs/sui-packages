module 0xf50158182e304034c0159e28ccde0b9cdb656fdfb384106594112e98c2e5450f::cnsnft3899 {
    struct CNSNFT3899 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3899, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2959"));
        let v4 = 0x2::package::claim<CNSNFT3899>(arg0, arg1);
