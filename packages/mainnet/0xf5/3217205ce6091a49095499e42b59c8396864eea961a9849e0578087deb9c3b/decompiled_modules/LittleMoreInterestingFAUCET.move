module 0xf53217205ce6091a49095499e42b59c8396864eea961a9849e0578087deb9c3b::LittleMoreInterestingFAUCET {
    ...
    fun init(arg0: LITTLEMOREINTERESTINGFAUCET, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Wallet{
            ...
            coin : 0x2::balance::zero<LITTLEMOREINTERESTINGFAUCET>(),
        };
