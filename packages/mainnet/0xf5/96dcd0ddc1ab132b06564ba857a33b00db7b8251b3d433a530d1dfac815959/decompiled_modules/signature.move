module 0xf596dcd0ddc1ab132b06564ba857a33b00db7b8251b3d433a530d1dfac815959::signature {
    ...
    public fun create_dao(arg0: vector<u8>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = DAO{
    ...
    public fun verify_signature(arg0: &mut DAO, arg1: &vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
