module 0x72f2e0d7d1355ddac47f37175d3e7f0267cc0b2e287511f5c830bda8f88d74f4::clt {
    ...
    public fun depositTokenForOrderV2<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: u64, arg3: &mut CltVault<T0>, arg4: &mut 0xb183d6f389f0208902e953c842e54620e903090f40bc441dfb54a77c0943c92b::archieve::UserArchieve, arg5: &0xb183d6f389f0208902e953c842e54620e903090f40bc441dfb54a77c0943c92b::version::Version, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, DepositProof, u128) {
        ...
        0xb183d6f389f0208902e953c842e54620e903090f40bc441dfb54a77c0943c92b::archieve::verUpdateTokenPegNonce(v3, arg4);
        let v4 = DepositProof{
            owner   : v0,
            balance : v2,
        };
        let v5 = CltDeposited{
            ...
            nonce         : v3,
            balance       : v2,
            total_deposit : 0xb183d6f389f0208902e953c842e54620e903090f40bc441dfb54a77c0943c92b::archieve::increaseTotalDeposit(v2, arg4),
        };
        0x2::event::emit<CltDeposited>(v5);
