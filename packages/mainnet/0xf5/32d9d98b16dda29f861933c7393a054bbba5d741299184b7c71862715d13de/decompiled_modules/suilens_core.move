module 0xf532d9d98b16dda29f861933c7393a054bbba5d741299184b7c71862715d13de::suilens_core {
    ...
    public fun approve_registration(arg0: &mut GlobalRegistry, arg1: 0x2::object::ID, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        v1.updated_at = 0x2::clock::timestamp_ms(arg3);
    ...
    public fun batch_approve_registrations(arg0: &mut GlobalRegistry, arg1: 0x2::object::ID, arg2: vector<address>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x2::table::contains<0x2::object::ID, Event>(&arg0.events, arg1), 1);
        let v1 = 0x2::table::borrow_mut<0x2::object::ID, Event>(&mut arg0.events, arg1);
        assert!(v1.creator == v0, 0);
    ...
    public fun cancel_registration(arg0: &mut GlobalRegistry, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::table::contains<0x2::object::ID, Event>(&arg0.events, arg1), 1);
        let v1 = 0x2::table::borrow_mut<0x2::object::ID, Event>(&mut arg0.events, arg1);
    ...
    public fun create_event(arg0: &mut GlobalRegistry, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: u64, arg7: u64, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::option::Option<u64>, arg11: u64, arg12: bool, arg13: bool, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, UserProfile>(&arg0.user_profiles, v0)) {
    ...
    fun init(arg0: SUILENS_CORE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"SuiLens"));
        ...
        0x2::transfer::share_object<GlobalRegistry>(v12);
    }
    ...
    public fun mint_event_poap(arg0: &mut GlobalRegistry, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = 0x2::clock::timestamp_ms(arg2);
        assert!(has_attended_event(arg0, arg1, v0), 23);
        assert!(v1 >= get_event_start_date(arg0, arg1), 14);
        let v2 = 0x2::table::borrow<0x2::object::ID, Event>(&arg0.events, arg1);
        let v3 = 0x2::object::new(arg3);
        let v4 = EventPOAP{
            id                : v3,
            event_id          : arg1,
            event_name        : v2.title,
            event_description : v2.description,
            event_image       : v2.poap_image_url,
            event_date        : v2.start_date,
            event_location    : v2.location,
            claimed_by        : v0,
            claimed_at        : v1,
        };
        let v5 = EventPOAPMinted{
            poap_id  : 0x2::object::uid_to_inner(&v3),
            event_id : arg1,
            claimer  : v0,
        };
        0x2::event::emit<EventPOAPMinted>(v5);
        0x2::transfer::public_transfer<EventPOAP>(v4, v0);
    }
    ...
    public fun reject_registration(arg0: &mut GlobalRegistry, arg1: 0x2::object::ID, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x2::table::contains<0x2::object::ID, Event>(&arg0.events, arg1), 1);
        let v1 = 0x2::table::borrow_mut<0x2::object::ID, Event>(&mut arg0.events, arg1);
        assert!(v1.creator == v0, 0);
        ...
        0x2::vec_set::remove<address>(&mut v1.pending_approvals, &arg2);
        v1.updated_at = 0x2::clock::timestamp_ms(arg3);
        let v2 = RegistrationRejected{
            event_id    : arg1,
            attendee    : arg2,
            rejected_by : v0,
        };
        0x2::event::emit<RegistrationRejected>(v2);
    }
