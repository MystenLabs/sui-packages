module 0xf5f623d5911030719b9fc69d10f91a20771b21beda26b832dfd9d085d6b7c6b0::reward8134 {
    struct REWARD8134 has drop {
        dummy_field: bool,
    }

    struct TICKET_8134 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8134(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8134>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8134>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8134, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8134>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8134>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8134>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8134>>(v5, 0x2::tx_context::sender(arg1));
    }
