module 0xf575fb5f6f2413ddc364d3fa798cc0285d701d3ddccbc61128d86d03f94c2954::reward2207 {
    struct REWARD2207 has drop {
        dummy_field: bool,
    }

    struct TICKET_2207 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2207(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2207>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2207>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2207, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2207>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2207>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2207>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2207>>(v5, 0x2::tx_context::sender(arg1));
    }
