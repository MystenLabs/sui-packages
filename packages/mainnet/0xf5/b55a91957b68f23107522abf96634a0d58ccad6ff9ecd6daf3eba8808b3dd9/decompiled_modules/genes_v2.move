module 0xf5b55a91957b68f23107522abf96634a0d58ccad6ff9ecd6daf3eba8808b3dd9::genes_v2 {
    ...
    public fun get_attributes<T0>(arg0: &0x2::object::UID, arg1: &vector<u8>) : vector<0x1::string::String> {
        ...
        while (v2 < 0x1::vector::length<GeneDefinition>(v0)) {
            let v3 = 0x1::vector::borrow<GeneDefinition>(v0, v2);
            let v4 = 0;
            while (v4 < 0x1::vector::length<Value>(&v3.values)) {
                let v5 = 0x1::vector::borrow<Value>(&v3.values, v4);
                if ((*0x1::vector::borrow<u8>(arg1, v2 * 2) as u16) << 8 | (*0x1::vector::borrow<u8>(arg1, v2 * 2 + 1) as u16) <= v5.selector) {
                    0x1::vector::push_back<0x1::string::String>(&mut v1, v5.name);
                    break
                };
                v4 = v4 + 1;
            };
