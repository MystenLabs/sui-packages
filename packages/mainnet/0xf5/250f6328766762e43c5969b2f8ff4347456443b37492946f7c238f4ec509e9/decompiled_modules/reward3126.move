module 0xf5250f6328766762e43c5969b2f8ff4347456443b37492946f7c238f4ec509e9::reward3126 {
    struct REWARD3126 has drop {
        dummy_field: bool,
    }

    struct TICKET_3126 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3126(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3126>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3126>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3126, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3126>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3126>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3126>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3126>>(v5, 0x2::tx_context::sender(arg1));
    }
