module 0x90a75f641859f4d77a4349d67e518e1dd9ecb4fac079e220fa46b7a7f164e0a5::vault_registry {
    ...
    public fun disable_version(arg0: &mut VaultRegistry, arg1: u64, arg2: &AbyssAdminCap) {
        ...
        assert!(arg1 != 0x90a75f641859f4d77a4349d67e518e1dd9ecb4fac079e220fa46b7a7f164e0a5::abyss_constants::version(), 6);
    ...
    fun init(arg0: VAULT_REGISTRY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = VaultRegistryInner{
            ...
            allowed_versions : 0x2::vec_set::singleton<u64>(0x90a75f641859f4d77a4349d67e518e1dd9ecb4fac079e220fa46b7a7f164e0a5::abyss_constants::version()),
            vaults           : 0x2::table::new<0x1::type_name::TypeName, 0x2::object::ID>(arg1),
        };
        let v2 = VaultRegistry{
            id    : v0,
            inner : 0x2::versioned::create<VaultRegistryInner>(0x90a75f641859f4d77a4349d67e518e1dd9ecb4fac079e220fa46b7a7f164e0a5::abyss_constants::version(), v1, arg1),
        };
    ...
    public(friend) fun load_inner(arg0: &VaultRegistry) : &VaultRegistryInner {
        ...
        let v1 = 0x90a75f641859f4d77a4349d67e518e1dd9ecb4fac079e220fa46b7a7f164e0a5::abyss_constants::version();
