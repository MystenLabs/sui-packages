module 0xf5ba403d72c3c527d632627f19d60b59675c9ef3bfe4feeb2229f738bcbf545a::asset {
    struct Collateral has copy, drop, store {
        ...
        liquidation_revenue_factor: 0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::Decimal,
    }
    ...
    struct BorrowConfig has copy, drop, store {
        ...
        repay_fee_rate: 0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::Decimal,
    ...
    public(friend) fun new<T0>(arg0: 0xf5ba403d72c3c527d632627f19d60b59675c9ef3bfe4feeb2229f738bcbf545a::interest::InterestModel, arg1: BorrowConfig, arg2: &mut 0x2::tx_context::TxContext) : Asset<T0> {
        let v0 = Asset<T0>{
        ...
        let v6 = LiquidationPaused{dummy_field: false};
        0x2::dynamic_field::add<LiquidationPaused, bool>(&mut v0.id, v6, false);
        let v7 = FlashLoanPaused{dummy_field: false};
        0x2::dynamic_field::add<FlashLoanPaused, bool>(&mut v0.id, v7, false);
        v0
    }
    ...
    public fun borrow_weight(arg0: &BorrowConfig) : 0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::Decimal {
        arg0.borrow_weight
    }
    ...
    public(friend) fun change_operation_status<T0>(arg0: &mut Asset<T0>, arg1: u8, arg2: bool) {
        assert!(arg1 < 5, 13906835102056316927);
        if (arg1 == 0) {
            let v0 = BorrowPaused{dummy_field: false};
    ...
    fun check_collateral(arg0: &Collateral) {
        assert!(!0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::is_zero(&arg0.collateral_factor), 13906835080581480447);
        assert!(0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::ge(arg0.liquidation_factor, arg0.collateral_factor), 13906835084876447743);
    }

    public fun collateral_factor(arg0: &Collateral) : 0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::Decimal {
    ...
    public fun collateral_setting<T0>(arg0: &Asset<T0>) : &Collateral {
        ...
        assert!(0x1::option::is_some<Collateral>(v1), 0xf5ba403d72c3c527d632627f19d60b59675c9ef3bfe4feeb2229f738bcbf545a::error::asset_not_collateral());
    ...
    public(friend) fun enable_as_collateral<T0>(arg0: &mut Asset<T0>, arg1: Collateral) {
        let v0 = DFKey<Collateral>{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<DFKey<Collateral>, 0x1::option::Option<Collateral>>(&mut arg0.id, v0);
        assert!(0x1::option::is_none<Collateral>(v1), 0xf5ba403d72c3c527d632627f19d60b59675c9ef3bfe4feeb2229f738bcbf545a::error::asset_already_collateral());
        check_collateral(&arg1);
        *v1 = 0x1::option::some<Collateral>(arg1);
    }

    public fun flash_loan_fee_rate(arg0: &BorrowConfig) : 0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::Decimal {
    ...
    public fun interest_model<T0>(arg0: &Asset<T0>) : &0xf5ba403d72c3c527d632627f19d60b59675c9ef3bfe4feeb2229f738bcbf545a::interest::InterestModel {
        &arg0.interest_model
    }

    public fun liq_revenue_factor(arg0: &Collateral) : 0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::Decimal {
        arg0.liquidation_revenue_factor
    }

    public fun liquidation_factor(arg0: &Collateral) : 0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::Decimal {
        arg0.liquidation_factor
    }

    public fun liquidation_incentive(arg0: &Collateral) : 0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::Decimal {
    ...
    public(friend) fun new_borrow_config(arg0: u64, arg1: u64, arg2: 0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::Decimal, arg3: 0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::Decimal, arg4: u64, arg5: 0x7f885241ae708ff7407c1eba20d6fabaf08c7ce817b8302490aff997635d722::float::Decimal) : BorrowConfig {
        BorrowConfig{
    ...
    public(friend) fun update_interest_model<T0>(arg0: &mut Asset<T0>, arg1: 0xf5ba403d72c3c527d632627f19d60b59675c9ef3bfe4feeb2229f738bcbf545a::interest::InterestModel) {
