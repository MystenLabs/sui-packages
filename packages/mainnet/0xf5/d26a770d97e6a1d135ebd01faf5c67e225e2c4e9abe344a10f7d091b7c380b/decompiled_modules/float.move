module 0xf5d26a770d97e6a1d135ebd01faf5c67e225e2c4e9abe344a10f7d091b7c380b::float {
    ...
    public fun ceil(arg0: Decimal) : u64 {
        (safe_from_u256((arg0.value + 1000000000000000000 - 1) / 1000000000000000000) as u64)
    }
    ...
    fun ensure_decimal_value_safe(arg0: u256) : u256 {
        assert!(arg0 <= 18446744073709551615000000000000000000, 0xf5d26a770d97e6a1d135ebd01faf5c67e225e2c4e9abe344a10f7d091b7c380b::math_error::decimal_value_overflow());
        arg0
    }
    ...
    public fun floor(arg0: Decimal) : u64 {
        (safe_from_u256(arg0.value / 1000000000000000000) as u64)
    }
    ...
    fun safe_from_u256(arg0: u256) : u64 {
        assert!(arg0 <= 18446744073709551615, 0xf5d26a770d97e6a1d135ebd01faf5c67e225e2c4e9abe344a10f7d091b7c380b::math_error::overflow());
        (arg0 as u64)
    }
