module 0xf5005490843c34c4b22f8256bc85aa17f6dfcb0646c9338d10d60075a9e491e7::gift4210 {
    struct GIFT4210 has drop {
        dummy_field: bool,
    }

    struct TICKET_4210 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4210(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4210>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4210>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4210, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4210>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4210>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4210>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4210>>(v5, 0x2::tx_context::sender(arg1));
    }
