module 0x385a98463c0ec72939a25ebb5baa140465bfffd27135977f2cee7349a998d03c::ebola {
    ...
    public fun add_price_feeders<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::package::Publisher, arg2: vector<address>) {
        assert!(0x2::package::from_module<EBOLA>(arg1), 13906835265265074175);
        let v0 = 0;
    ...
    public fun remove_price_feeders<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::package::Publisher, arg2: vector<address>) {
        assert!(0x2::package::from_module<EBOLA>(arg1), 13906835312509714431);
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
    ...
    public fun stop<T0, T1>(arg0: &0x2::package::Publisher, arg1: &mut Pool<T0, T1>) {
        assert!(0x2::package::from_module<EBOLA>(arg0), 13906835346869452799);
        arg1.stopped = true;
    }
    ...
    public fun swap_x_to_y_with_proof<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: vector<u64>, arg4: vector<u64>, arg5: vector<u64>, arg6: vector<vector<vector<u8>>>, arg7: vector<vector<u8>>, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        assert!(v1 == 0x1::vector::length<u64>(&arg4) && v1 == 0x1::vector::length<u64>(&arg5), 13906836424906244095);
        assert!(v1 == 0x1::vector::length<vector<vector<u8>>>(&arg6) && v1 == 0x1::vector::length<vector<u8>>(&arg7), 13906836429201211391);
        let v2 = 0;
        let v3 = 0;
        let v4 = 0;
        while (v4 < v1) {
            let v5 = *0x1::vector::borrow<u64>(&arg3, v4);
            assert!(v5 < arg0.commit.levels_len, 13906836454971015167);
            let v6 = *0x1::vector::borrow<u64>(&arg5, v4);
            let v7 = *0x1::vector::borrow<u64>(&arg4, v4);
            assert!(rebuild_root_from_proof(leaf_hash(1, v5, v6), 0x1::vector::borrow<vector<vector<u8>>>(&arg6, v4), 0x1::vector::borrow<vector<u8>>(&arg7, v4)) == arg0.commit.bids_root, 13906836485035786239);
        ...
        assert!(arg2 >= v2, 13906836532280426495);
    ...
    public fun swap_y_to_x_with_proof<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<T1>, arg2: u64, arg3: vector<u64>, arg4: vector<u64>, arg5: vector<u64>, arg6: vector<vector<vector<u8>>>, arg7: vector<vector<u8>>, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        assert!(v0 < arg10 && v0 < arg0.commit.expires_at, 3);
        let v1 = 0x1::vector::length<u64>(&arg3);
        assert!(v1 == 0x1::vector::length<u64>(&arg4) && v1 == 0x1::vector::length<u64>(&arg5), 13906836923122450431);
        assert!(v1 == 0x1::vector::length<vector<vector<u8>>>(&arg6) && v1 == 0x1::vector::length<vector<u8>>(&arg7), 13906836927417417727);
        let v2 = 0;
        let v3 = 0;
        let v4 = 0;
        while (v4 < v1) {
            let v5 = *0x1::vector::borrow<u64>(&arg3, v4);
            assert!(v5 < arg0.commit.levels_len, 13906836953187221503);
            let v6 = *0x1::vector::borrow<u64>(&arg5, v4);
            let v7 = *0x1::vector::borrow<u64>(&arg4, v4);
            assert!(rebuild_root_from_proof(leaf_hash(0, v5, v6), 0x1::vector::borrow<vector<vector<u8>>>(&arg6, v4), 0x1::vector::borrow<vector<u8>>(&arg7, v4)) == arg0.commit.asks_root, 13906836983251992575);
        ...
        let v11 = v2 + 1;
        assert!(arg2 >= v11, 13906837047676502015);
    ...
    public fun unstop<T0, T1>(arg0: &0x2::package::Publisher, arg1: &mut Pool<T0, T1>) {
        assert!(0x2::package::from_module<EBOLA>(arg0), 13906835368344289279);
        arg1.stopped = false;
    }
    ...
    public fun update_roots<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg3 > arg0.commit.version, 13906835445653700607);
        let v1 = CommitHeader{
            version        : arg3,
            expires_at     : arg4,
            asks_root      : arg1,
