module 0xf5bcc026cac025c982cb180c15c372212541dee3c9824a2cea334831d41b1adf::vault_config {
    ...
    public(friend) fun borrow_withdraw_cap(arg0: &VaultTokenHolder) : &0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet_config::QuickWithdrawCap {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet_config::QuickWithdrawCap>(&arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"))
    }
    ...
    public fun set_cloud_wallet_withdraw_cap(arg0: &mut 0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet_config::CloudWalletConfig, arg1: &VaultConfig, arg2: &mut VaultTokenHolder, arg3: 0x2::transfer::Receiving<0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet_config::QuickWithdrawCap>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg2.id, 0x1::ascii::string(b"quick_withdraw_cap"))) {
            0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet_config::delete_quick_withdraw_cap(arg0, 0x2::dynamic_field::remove<0x1::ascii::String, 0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, 0x1::ascii::string(b"quick_withdraw_cap")));
        };
        0x2::dynamic_field::add<0x1::ascii::String, 0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, 0x1::ascii::string(b"quick_withdraw_cap"), 0x2::transfer::public_receive<0xb664e5f1e85cec77d0da9097e18fa602cfefa7a0e16f28d7396e806dc90e74f0::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, arg3));
    }
