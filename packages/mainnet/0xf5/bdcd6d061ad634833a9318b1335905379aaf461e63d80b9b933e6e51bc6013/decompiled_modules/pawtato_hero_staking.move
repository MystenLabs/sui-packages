module 0xe0fa7b75a3dc8137b38bceb0c0c21c10e0f57c408fe9068694f58fd21e071925::pawtato_hero_staking {
    ...
    fun attempt_fragment_finding<T0, T1, T2, T3, T4, T5, T6, T7, T8>(arg0: &mut HeroStakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land::StakingPool, arg2: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let (_, v15) = get_patrolling_heroes_multiplier_sum(&0x2::table::borrow<address, HeroUserInfo>(&arg0.users, v0).heroes);
        let v16 = 0x2::random::new_generator(arg4, arg5);
        let v17 = 0x2::random::generate_u128(&mut v16) % 1000000;
        if (v17 < 100 * v15 * (v13 as u128) / 10000) {
            let v18 = 1000000000;
            let v19 = 0x2::random::generate_u64(&mut v16) % v13;
            if (v19 == 0) {
                mint_and_transfer_coin<T0>(arg0, arg2, v18, v0, arg5);
                let v20 = FragmentFound{
                    user          : v0,
                    fragment_type : v1,
                    amount        : v18,
                    roll          : v17,
                };
                0x2::event::emit<FragmentFound>(v20);
            } else if (v19 == 1) {
                mint_and_transfer_coin<T1>(arg0, arg2, v18, v0, arg5);
                let v21 = FragmentFound{
                    user          : v0,
                    fragment_type : v2,
                    amount        : v18,
                    roll          : v17,
                };
                0x2::event::emit<FragmentFound>(v21);
            } else if (v19 == 2) {
                mint_and_transfer_coin<T2>(arg0, arg2, v18, v0, arg5);
                let v22 = FragmentFound{
                    user          : v0,
                    fragment_type : v3,
                    amount        : v18,
                    roll          : v17,
                };
                0x2::event::emit<FragmentFound>(v22);
            } else if (v19 == 3) {
                mint_and_transfer_coin<T3>(arg0, arg2, v18, v0, arg5);
                let v23 = FragmentFound{
                    user          : v0,
                    fragment_type : v4,
                    amount        : v18,
                    roll          : v17,
                };
                0x2::event::emit<FragmentFound>(v23);
            } else if (v19 == 4) {
                mint_and_transfer_coin<T4>(arg0, arg2, v18, v0, arg5);
                let v24 = FragmentFound{
                    user          : v0,
                    fragment_type : v5,
                    amount        : v18,
                    roll          : v17,
                };
                0x2::event::emit<FragmentFound>(v24);
            } else if (v19 == 5) {
                mint_and_transfer_coin<T5>(arg0, arg2, v18, v0, arg5);
                let v25 = FragmentFound{
                    user          : v0,
                    fragment_type : v6,
                    amount        : v18,
                    roll          : v17,
                };
                0x2::event::emit<FragmentFound>(v25);
            } else if (v19 == 6) {
                mint_and_transfer_coin<T6>(arg0, arg2, v18, v0, arg5);
                let v26 = FragmentFound{
                    user          : v0,
                    fragment_type : v7,
                    amount        : v18,
                    roll          : v17,
                };
                0x2::event::emit<FragmentFound>(v26);
            } else if (v19 == 7) {
                mint_and_transfer_coin<T7>(arg0, arg2, v18, v0, arg5);
                let v27 = FragmentFound{
                    user          : v0,
                    fragment_type : v8,
                    amount        : v18,
                    roll          : v17,
                };
                0x2::event::emit<FragmentFound>(v27);
            } else if (v19 == 8) {
                mint_and_transfer_coin<T8>(arg0, arg2, v18, v0, arg5);
                let v28 = FragmentFound{
                    user          : v0,
                    fragment_type : v9,
                    amount        : v18,
                    roll          : v17,
                };
                0x2::event::emit<FragmentFound>(v28);
            };
        };
    }
    ...
    fun attempt_urr_finding<T0, T1, T2>(arg0: &mut HeroStakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land::StakingPool, arg2: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v13 = 5 * v7 * v11 / 10000 * 10000;
        let v14 = 0x2::random::new_generator(arg4, arg5);
        let v15 = 0x2::random::generate_u128(&mut v14) % 1000000;
        let v16 = 1000000000;
        if (v15 < v13) {
            mint_and_transfer_coin<T2>(arg0, arg2, v16, v0, arg5);
            let v17 = UrrFound{
                user          : v0,
                resource_type : v3,
                amount        : v16,
            ...
            0x2::event::emit<UrrFound>(v17);
            return true
        };
        if (v15 < v13 + v12) {
            mint_and_transfer_coin<T0>(arg0, arg2, v16, v0, arg5);
            let v18 = UrrFound{
                user          : v0,
                resource_type : v1,
                amount        : v16,
            ...
            0x2::event::emit<UrrFound>(v18);
            return true
        };
        if (v15 < v13 + v12 + 50 * v7 * v11 / 10000 * 10000) {
            mint_and_transfer_coin<T1>(arg0, arg2, v16, v0, arg5);
            let v19 = UrrFound{
                user          : v0,
                resource_type : v2,
                amount        : v16,
    ...
    public entry fun reset_rep_player(arg0: &mut HeroStakingPool, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = RepresentingPlayerSet{
            user       : v0,
            rep_player : v0,
        };
        0x2::event::emit<RepresentingPlayerSet>(v2);
    }
    ...
    public entry fun set_rep_player(arg0: &mut HeroStakingPool, arg1: &0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land::StakingPool, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = RepresentingPlayerSet{
            user       : v0,
            rep_player : arg2,
        };
        0x2::event::emit<RepresentingPlayerSet>(v4);
    }
    ...
    public entry fun upgrade_version(arg0: &0xe0fa7b75a3dc8137b38bceb0c0c21c10e0f57c408fe9068694f58fd21e071925::pawtato_heroes::HeroAdminCap, arg1: &mut HeroStakingPool, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version < 1, 13906840573844652031);
        arg1.version = 1;
    }
