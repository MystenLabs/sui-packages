module 0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::fuzz_harness {
    public fun optimize_cetus_triangle_scalars<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T2>, arg3: u128, arg4: u64) : 0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::OptimizeResult {
        let v0 = 0x1::vector::empty<0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::TickBoundary>();
        0x1::vector::push_back<0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::TickBoundary>(&mut v0, 0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::tick_boundary(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::min_sqrt_price(), 0, false));
        ...
        let v3 = 0x1::vector::empty<0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::Hop>();
        let v4 = &mut v3;
        0x1::vector::push_back<0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::Hop>(v4, 0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::v3_hop(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg0), 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::liquidity<T0, T1>(arg0), 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::fee_rate<T0, T1>(arg0), 1000000, true, v0));
        ...
        0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::optimize(v3, arg3, arg4)
    }

    public fun optimize_synthetic(arg0: vector<u8>, arg1: vector<u128>, arg2: vector<u128>, arg3: vector<u128>, arg4: vector<u128>, arg5: vector<u64>, arg6: vector<u64>, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<bool>, arg10: vector<u128>, arg11: u128, arg12: u64) : 0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::OptimizeResult {
        ...
        let v1 = 0x1::vector::empty<0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::Hop>();
        let v2 = 0;
        while (v2 < v0) {
            let v3 = *0x1::vector::borrow<u8>(&arg0, v2);
            if (v3 == 0) {
                0x1::vector::push_back<0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::Hop>(&mut v1, 0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::v2_hop_split_fee(*0x1::vector::borrow<u128>(&arg1, v2), *0x1::vector::borrow<u128>(&arg2, v2), *0x1::vector::borrow<u64>(&arg5, v2), *0x1::vector::borrow<u64>(&arg6, v2), *0x1::vector::borrow<u64>(&arg7, v2), *0x1::vector::borrow<u64>(&arg8, v2)));
            } else {
                assert!(v3 == 1, 201);
                let v4 = 0x1::vector::empty<0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::TickBoundary>();
                0x1::vector::push_back<0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::TickBoundary>(&mut v4, 0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::tick_boundary(*0x1::vector::borrow<u128>(&arg10, v2), 0, false));
    ...
    public fun optimize_synthetic_multitick(arg0: u8, arg1: vector<u8>, arg2: vector<u128>, arg3: vector<u128>, arg4: vector<u128>, arg5: vector<u128>, arg6: vector<u64>, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<bool>, arg11: vector<vector<u128>>, arg12: vector<vector<u128>>, arg13: vector<vector<bool>>, arg14: u128, arg15: u64) : 0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::OptimizeResult {
        ...
        while (v2 < v0) {
            ...
            if (v3 == 0) {
                ...
                while (v8 < 0x1::vector::length<u128>(v4)) {
                    0x1::vector::push_back<0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::TickBoundary>(&mut v7, 0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::tick_boundary(*0x1::vector::borrow<u128>(v4, v8), *0x1::vector::borrow<u128>(v5, v8), *0x1::vector::borrow<bool>(v6, v8)));
                    v8 = v8 + 1;
                };
        ...
        if (arg0 == 0) {
            0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::optimize_baseline(v1, arg14, arg15)
        } else if (arg0 == 1) {
            0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::optimize_lazy_sqrt(v1, arg14, arg15)
        } else if (arg0 == 2) {
            0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::optimize_forward_events(v1, arg14, arg15)
        } else {
            assert!(arg0 == 3, 202);
            0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::optimize_coefficients(v1, arg14, arg15)
        }
    }
