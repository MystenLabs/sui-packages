module 0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::execution {
    ...
    fun checked_amount(arg0: &0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::OptimizeResult) : u64 {
        let v0 = 0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::amount_in(arg0);
        assert!(v0 > 0 && v0 <= 18446744073709551615, 401);
        (v0 as u64)
    }

    public fun executable_profit(arg0: &0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::OptimizeResult, arg1: u128) : u128 {
        if (is_executable(arg0, arg1)) {
            0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::gross_profit(arg0)
        } else {
            0
        }
    }

    public fun is_complete_executable(arg0: &0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::OptimizeResult, arg1: u128) : bool {
        0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::complete(arg0) && is_executable(arg0, arg1)
    }

    public fun is_executable(arg0: &0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::OptimizeResult, arg1: u128) : bool {
        if (0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::found(arg0)) {
            if (0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::amount_in(arg0) > 0) {
                if (0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::amount_in(arg0) <= 18446744073709551615) {
                    0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::gross_profit(arg0) >= arg1
                } else {
                    false
                }
            } else {
    ...
    public fun prepare_optional<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: &0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::OptimizeResult, arg2: u128, arg3: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<0x2::coin::Coin<T0>>, u64) {
    ...
    public fun prepare_selected_optional<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: &0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::OptimizeResult, arg2: bool, arg3: u128, arg4: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<0x2::coin::Coin<T0>>, u64) {
        if (!arg2) {
            return (0x1::option::none<0x2::coin::Coin<T0>>(), 0)
        };
    ...
    public fun require_amount(arg0: &0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::OptimizeResult, arg1: u128) : u64 {
    ...
    public fun selected_amount(arg0: &0xf5c7dae97437e7e4fc65bcfd71f9a25f759a0325e8cf0928d8373193c10eb18c::optimizer::OptimizeResult, arg1: bool, arg2: u128) : u64 {
