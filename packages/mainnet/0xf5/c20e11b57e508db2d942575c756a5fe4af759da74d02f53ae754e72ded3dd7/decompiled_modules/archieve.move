module 0xf5c20e11b57e508db2d942575c756a5fe4af759da74d02f53ae754e72ded3dd7::archieve {
    ...
    public fun register(arg0: &mut UserReg, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::table::contains<address, bool>(&arg0.users, v0), 1003);
        let v1 = UserArchieve{
            id                : 0x2::object::new(arg1),
            peg_token_nonce   : 0,
            depeg_token_nonce : 0,
    ...
    public(friend) fun verifySignature(arg0: vector<u8>, arg1: vector<u8>, arg2: &0x1::option::Option<vector<u8>>) {
        assert!(0x1::option::is_some<vector<u8>>(arg2), 1001);
        assert!(0x2::ed25519::ed25519_verify(&arg0, 0x1::option::borrow<vector<u8>>(arg2), &arg1), 1000);
    }
