module 0xae74b7557ac6b9dea4517641ac936e216e6cbd23d8542e9a837dfce35c995102::USDT {
    ...
    fun init(arg0: USDT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<USDT>(arg0, 9, b"USDT", b"USDT", b"USDT Default", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://icon.vipssy163.com/public250.png")), arg1);
