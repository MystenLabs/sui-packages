module 0xae65ae68423dbf08dc397962e61b6a4760158405477b613c85688a2b0bccebf9::tile {
    ...
    struct Round has store, key {
        ...
        participant_entry: 0x2::table::Table<address, u64>,
        drawable_time: u64,
        draw_time: u64,
    }
    ...
    fun cancel_current_round(arg0: &mut Game, arg1: &mut 0x15f9a9074a801634490cd688f66b2235d0eca971556d1e43a7ffa48c3ded2df8::play_manager::PlayManager, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x15f9a9074a801634490cd688f66b2235d0eca971556d1e43a7ffa48c3ded2df8::play_manager::cancel_play<Witness>(arg1, get_participant_amount(v1, 0x2::tx_context::sender(arg3)), 0x2::tx_context::sender(arg3), &v5, arg2, arg3);
    ...
    fun create_new_round_if_not_exists(arg0: &mut Game, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Round{
            ...
            participant_entry   : 0x2::table::new<address, u64>(arg2),
            drawable_time       : 0,
            draw_time           : 0,
        };
    ...
    entry fun deposit(arg0: &mut Game, arg1: vector<u64>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x15f9a9074a801634490cd688f66b2235d0eca971556d1e43a7ffa48c3ded2df8::play_manager::PlayManager, arg4: &0x7bf0bd74001fdfaaa2796af8dbc6f9bf129a8098fe298a1cd497ca726d7c52d0::version::VersionTable, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<u64>(&arg1) > 0 && 0x1::vector::length<u64>(&arg1) <= arg0.max_future_round, 9223372556546801680);
        let v0 = arg0.current_round_key;
        check_round_status(arg0, v0, 1);
        update_drawable_time_if_needed(arg0, v0, arg5);
        let v1 = 0x2::coin::into_balance<0x2::sui::SUI>(arg2);
        let v2 = vector[];
        let v3 = vector[];
        let v4 = 0;
        while (v4 < 0x1::vector::length<u64>(&arg1)) {
            create_new_round_if_not_exists(arg0, v0, arg6);
            let v5 = 0x2::object_table::borrow_mut<u64, Round>(&mut arg0.rounds, v0);
            if (!0x2::table::contains<address, u64>(&v5.participant_entry, 0x2::tx_context::sender(arg6))) {
                0x2::table::add<address, u64>(&mut v5.participant_entry, 0x2::tx_context::sender(arg6), 0);
            };
            let v6 = *0x1::vector::borrow<u64>(&arg1, v4);
            assert!(v6 > 0 && v6 + *0x2::table::borrow<address, u64>(&v5.participant_entry, 0x2::tx_context::sender(arg6)) <= arg0.max_user_entry, 9223372646741377044);
            assert!(v6 + v5.current_entry_index <= arg0.max_round_entry, 9223372651036213266);
            let v7 = v6 * v5.value_per_entry;
            assert!(0x2::balance::value<0x2::sui::SUI>(&v1) >= v7, 9223372659626410006);
            let v8 = v5.current_entry_index + v6;
            let v9 = Deposit{
            ...
            0x1::vector::push_back<Deposit>(&mut v5.deposits, v9);
            v5.current_entry_index = v8;
            0x2::balance::join<0x2::sui::SUI>(&mut v5.balance, 0x2::balance::split<0x2::sui::SUI>(&mut v1, v7));
            let v10 = 0x2::table::borrow_mut<address, u64>(&mut v5.participant_entry, 0x2::tx_context::sender(arg6));
            *v10 = *v10 + v6;
            0x1::vector::push_back<u64>(&mut v2, v8);
            0x1::vector::push_back<u64>(&mut v3, 0x2::balance::value<0x2::sui::SUI>(&v5.balance));
            v0 = v0 + 1;
            v4 = v4 + 1;
        };
        assert!(0x2::balance::value<0x2::sui::SUI>(&v1) == 0, 9223372758410657814);
        let v11 = Deposited{
            start_round_key : v0,
            entries         : arg1,
            balances        : v3,
        ...
        0x15f9a9074a801634490cd688f66b2235d0eca971556d1e43a7ffa48c3ded2df8::play_manager::record_play<Witness>(arg3, 0x2::balance::value<0x2::sui::SUI>(&v1), 0x2::tx_context::sender(arg6), &v12, arg5, arg6);
    ...
    entry fun draw(arg0: &mut Game, arg1: &mut 0x15f9a9074a801634490cd688f66b2235d0eca971556d1e43a7ffa48c3ded2df8::play_manager::PlayManager, arg2: &mut 0xef199024460c12d9880f7b6bb9712de2a56b3761fd5a480f297dadb60f956c03::referral::ReferralRegistry, arg3: &0x7bf0bd74001fdfaaa2796af8dbc6f9bf129a8098fe298a1cd497ca726d7c52d0::version::VersionTable, arg4: &0x2::random::Random, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = arg0.current_round_key;
        let v1 = 0x2::object_table::borrow_mut<u64, Round>(&mut arg0.rounds, v0);
        assert!(0x1::vector::length<Deposit>(&v1.deposits) > 0 && 0x2::table::length<address, u64>(&v1.participant_entry) > 0, 9223372900143792138);
        assert!(0x2::table::contains<address, u64>(&v1.participant_entry, 0x2::tx_context::sender(arg6)), 9223372904439021582);
        assert!(v1.drawable_time > 0 && v1.drawable_time < 0x2::clock::timestamp_ms(arg5), 9223372908733595656);
        if (0x2::table::length<address, u64>(&v1.participant_entry) < 2) {
        ...
        0x15f9a9074a801634490cd688f66b2235d0eca971556d1e43a7ffa48c3ded2df8::play_manager::increment_point<Witness>(arg1, get_participant_amount(v1, 0x2::tx_context::sender(arg6)), 0x2::tx_context::sender(arg6), 0x1::type_name::get<0xf8ee6671c195bb61ee5effbccb2c4fdf6492c7395d16f498c142468d38ad9e54::point::Witness>(), &v7, arg5, arg6);
        let v8 = v1.value_per_entry * v1.current_entry_index;
        let v9 = v8 * (arg0.fee_in_bp as u64) / 10000;
        let v10 = v8 - v9;
        assert!(v9 + v10 == 0x2::balance::value<0x2::sui::SUI>(&v1.balance), 9223373093417451532);
        ...
        0x15f9a9074a801634490cd688f66b2235d0eca971556d1e43a7ffa48c3ded2df8::play_manager::emit_win_play_history<Witness>(arg1, v6, get_participant_amount(v1, v6), v8, &v13);
        v1.status = 2;
    ...
    fun get_participant_amount(arg0: &Round, arg1: address) : u64 {
        *0x2::table::borrow<address, u64>(&arg0.participant_entry, arg1) * arg0.value_per_entry
    }
    ...
    entry fun update_game(arg0: &AdminCap, arg1: &mut Game, arg2: u16, arg3: u64, arg4: u64, arg5: address, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        arg1.fee_in_bp = arg2;
        arg1.round_duration = arg3;
        arg1.value_per_entry = arg4;
        arg1.fee_manager = arg5;
        arg1.max_future_round = arg6;
        arg1.max_round_entry = arg7;
        arg1.max_user_entry = arg8;
    }
