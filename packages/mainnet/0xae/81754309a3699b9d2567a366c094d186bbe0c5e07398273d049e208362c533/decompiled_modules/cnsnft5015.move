module 0xae81754309a3699b9d2567a366c094d186bbe0c5e07398273d049e208362c533::cnsnft5015 {
    struct CNSNFT5015 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5015, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5015>(arg0, arg1);
