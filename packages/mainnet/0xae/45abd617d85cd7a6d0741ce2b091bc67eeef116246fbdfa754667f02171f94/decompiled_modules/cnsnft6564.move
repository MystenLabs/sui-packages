module 0xae45abd617d85cd7a6d0741ce2b091bc67eeef116246fbdfa754667f02171f94::cnsnft6564 {
    struct CNSNFT6564 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6564, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6564>(arg0, arg1);
