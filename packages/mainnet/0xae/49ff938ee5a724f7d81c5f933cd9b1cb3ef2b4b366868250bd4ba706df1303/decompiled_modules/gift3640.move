module 0xae49ff938ee5a724f7d81c5f933cd9b1cb3ef2b4b366868250bd4ba706df1303::gift3640 {
    struct GIFT3640 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift3640(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT3640, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3640>(arg0, arg1);
