module 0xae94a2e1b9e1755a3f84d4b2165462aee138a1385489c5b5b0a49a3011dc9eee::c_6maker_art {
    ...
    fun init(arg0: C_6MAKER_ART, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"6maker artwork"));
