module 0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::dapp {
    ...
    public fun buyToken<T0, T1>(arg0: &mut Contract<T1>, arg1: &mut 0xf64c53c15b63226cff5e81f5dfcaa7d7f2743e93dfeded0a83b5f5db4f19ccff::implements::Global, arg2: &0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::price_oracle::PriceOracle, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 13906838250267344895);
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 100) {
            ...
            if (v5 > 0) {
                ...
                if (v4.invest_amount > 0) {
                    ...
                    0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::addTeamReward(arg0, v8);
                    0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::add_total_user_balance(arg0, v8);
                };
            };
            v0 = v4.inviter;
            v1 = v1 + 1;
    ...
    fun handler_out(arg0: &mut 0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::GlobalNetworkData, arg1: address, arg2: &mut 0x2::table::Table<address, User>) {
        let v0 = 0;
        ...
        if (v0 > 0) {
            ...
            0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::sub_total_asset_invested(arg0, v0);
        };
    }
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 20) {
            ...
            if (v9.invest_amount > 0 && v8 > 0) {
                ...
                if (v1 == 1 && arg4) {
                    ...
                    0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::add_total_dynamic_power_distributed(arg0, v10 - v13);
                    0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::add_total_share_reward(arg0, v13);
                    0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::add_total_user_balance(arg0, v13);
                } else {
                    v9.dynamic_power = v9.dynamic_power + v10;
                    0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::add_total_dynamic_power_distributed(arg0, v10);
                };
                if (v1 == 1) {
                    v9.quota = v9.quota + v10;
                    0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::add_total_pre_buy_quota(arg0, v10);
                };
            };
            v0 = v9.inviter;
            v1 = v1 + 1;
