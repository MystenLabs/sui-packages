module 0x2d9316f1f1a95f6d7c85a4e690ef7c359e6649773ef2c37ad7d9857adb6bef06::vault {
    ...
    public entry fun change_fee_percentages(arg0: &mut ChangeFeeCap, arg1: &mut ProtocolFeeVault, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<u64>(&arg2)) {
            arg1.fee_percentages.total_protocol_fee = 0x1::option::extract<u64>(&mut arg2);
        };
        if (0x1::option::is_some<u64>(&arg3)) {
            arg1.fee_percentages.treasury = 0x1::option::extract<u64>(&mut arg3);
        };
        if (0x1::option::is_some<u64>(&arg4)) {
            arg1.fee_percentages.insurance_fund = 0x1::option::extract<u64>(&mut arg4);
        };
        if (0x1::option::is_some<u64>(&arg5)) {
            arg1.fee_percentages.dev_wallet = 0x1::option::extract<u64>(&mut arg5);
        };
        ...
        if (0x1::option::is_some<u64>(&arg6)) {
            arg1.fee_percentages.referee_discount = 0x1::option::extract<u64>(&mut arg6);
        };
    }
