module 0xae3f5ce39e8709820ad43a5a00590276d568d2cd8ccaee2c240fa4ac35ca3b16::cnsnft4785 {
    struct CNSNFT4785 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4785, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4785>(arg0, arg1);
