module 0xae9003d308bc8a88069b389e6518d383ef3355ac38661eb5f40b4ef6be287f22::reward4459 {
    struct REWARD4459 has drop {
        dummy_field: bool,
    }

    struct TICKET_4459 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4459(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4459>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4459>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4459, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4459>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4459>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4459>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4459>>(v5, 0x2::tx_context::sender(arg1));
    }
