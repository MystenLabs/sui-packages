module 0xaedb8c9a905a778e831aeb4928f660210a7a645925348a7c4ec1cb4a6a3fd16e::position {
    ...
    public(friend) fun join<T0>(arg0: &mut Position<T0>, arg1: Position<T0>) {
        assert!(arg0.pool == arg1.pool && 0xaedb8c9a905a778e831aeb4928f660210a7a645925348a7c4ec1cb4a6a3fd16e::locks::same(&arg0.lock, &arg1.lock), 1);
    ...
    public(friend) fun new<T0>(arg0: 0x2::object::ID, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : Position<T0> {
        ...
        Position<T0>{
            ...
            tokens : arg1,
            lots   : v2,
            lock   : 0xaedb8c9a905a778e831aeb4928f660210a7a645925348a7c4ec1cb4a6a3fd16e::locks::flexible(),
        }
    }

    public(friend) fun upgrade<T0>(arg0: &mut Position<T0>, arg1: u8, arg2: u64, arg3: &0xaedb8c9a905a778e831aeb4928f660210a7a645925348a7c4ec1cb4a6a3fd16e::config::Params) {
        0xaedb8c9a905a778e831aeb4928f660210a7a645925348a7c4ec1cb4a6a3fd16e::locks::upgrade(&mut arg0.lock, arg1, arg2, arg3);
    }
    ...
    public(friend) fun clear_lock<T0>(arg0: &mut Position<T0>) {
        0xaedb8c9a905a778e831aeb4928f660210a7a645925348a7c4ec1cb4a6a3fd16e::locks::clear(&mut arg0.lock);
    }
    ...
    public(friend) fun fee<T0>(arg0: &Position<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ...
        while (v2 < 0x1::vector::length<Lot>(v1)) {
            let v3 = 0x1::vector::borrow<Lot>(v1, v2);
            v0 = v0 + (v3.amount as u256) * (0xaedb8c9a905a778e831aeb4928f660210a7a645925348a7c4ec1cb4a6a3fd16e::math::decay(arg1 - v3.entry_ms, arg2, arg3, arg4) as u256);
            v2 = v2 + 1;
        };
        (((v0 + 9999) / 10000) as u64)
    }

    public fun lock<T0>(arg0: &Position<T0>) : &0xaedb8c9a905a778e831aeb4928f660210a7a645925348a7c4ec1cb4a6a3fd16e::locks::Lock {
        &arg0.lock
    }
