module 0xae9d0a79257bb9926a99088b385e99ccbda3d3e58aefc74568c58ef54c7212f4::nodo_price_feed {
    ...
    public fun get_price_no_older_than(arg0: &NodoPriceFeedInfo, arg1: u64, arg2: &0x2::clock::Clock) : (vector<u8>, 0x1::ascii::String, u64, u8, u64) {
        assert!(0x2::clock::timestamp_ms(arg2) - arg0.last_update_ts <= arg1, 6);
        (0x2::object::id_bytes<NodoPriceFeedInfo>(arg0), arg0.token_type, arg0.price, arg0.decimals, arg0.last_update_ts)
    }
    ...
    public fun push_price(arg0: &0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::PriceFeedConfig, arg1: &mut NodoPriceFeedInfo, arg2: u64, arg3: u64, arg4: vector<vector<u8>>, arg5: vector<vector<u8>>, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg6);
        assert!(arg3 <= v0, 5);
        if (arg1.last_update_ts < arg3 && v0 - arg3 <= 0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::get_max_staleness(arg0)) {
            let v1 = 0x2::object::id<0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::PriceFeedConfig>(arg0);
    ...
    fun verify_signature(arg0: &0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::PriceFeedConfig, arg1: vector<u8>, arg2: vector<vector<u8>>, arg3: vector<vector<u8>>) : bool {
        let v0 = 0x1::vector::length<vector<u8>>(&arg2);
        assert!(v0 >= (0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::get_quorum(arg0) as u64), 2);
        assert!(!has_duplicates(&arg2), 1);
        let v1 = 0;
        while (v1 < v0) {
            assert!(0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::is_pusher(arg0, 0x1::vector::borrow<vector<u8>>(&arg2, v1)), 3);
