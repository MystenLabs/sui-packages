module 0xaeaafcd4fe2fcfbf932271e5997ee713578858cc4f884314695faac7edac9861::sigma {
    ...
    fun init(arg0: SIGMA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/GFcEXBFqng9MXkSCojwYhnnCksQyDxPigd3Vz9y2pump.png                                                                                                                                                                                                                               ");
