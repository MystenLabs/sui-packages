module 0xae54049165b6981c5802e22ac0d1bd001d0b3aefc67ccce43a3d5ebc7d2e29c8::test_demonopol {
    struct TEST_DEMONOPOL has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TEST_DEMONOPOL, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TEST_DEMONOPOL>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Test DeMonopol"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is a test of airdrop demonopol.com"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiebadppbpnfdqq3ouzqhuvvc3tkabovh55qixmalfn37b3kdz6ksa"));
