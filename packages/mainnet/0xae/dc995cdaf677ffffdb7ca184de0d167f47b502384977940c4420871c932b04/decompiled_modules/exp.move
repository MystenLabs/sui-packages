module 0xaedc995cdaf677ffffdb7ca184de0d167f47b502384977940c4420871c932b04::exp {
    struct EXP has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: EXP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<EXP>(arg0, 9, b"SEXP", b"Sui WolfGame SEXP", b"Sui WolfGame SEXP", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://suixen.xyz/sheep.svg"))), arg1);
        let v2 = ExpGlobal{
