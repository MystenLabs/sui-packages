module 0xaed4140fd13121ffff872aaa7743783445297e0355c315b6a30a08646c0c990b::cnsnft9684 {
    struct CNSNFT9684 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9684, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9684>(arg0, arg1);
