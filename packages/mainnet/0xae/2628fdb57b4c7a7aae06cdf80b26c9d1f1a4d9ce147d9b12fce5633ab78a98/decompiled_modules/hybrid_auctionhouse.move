module 0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::hybrid_auctionhouse {
    ...
    public fun accept_direct_for_kiosk_offer<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &mut 0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: &0x2::transfer_policy::TransferPolicy<T1>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg7));
    ...
    public fun accept_kiosk_for_direct_offer<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &mut 0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: T1, arg7: &0x2::transfer_policy::TransferPolicy<T0>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg8));
    ...
    public fun crate_hybrid_auctionhouse(arg0: &0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Hybrid_Auctionhouse_Store {
        assert!(0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::is_admin(arg0, 0x2::tx_context::sender(arg1)), 11);
        Hybrid_Auctionhouse_Store{
            id            : 0x2::object::new(arg1),
            marketplace   : 0x2::object::id<0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::AuctionHouse>(arg0),
            orphaned_caps : 0x2::object::new(arg1),
        }
    }

    public entry fun create_and_share_hybrid_auctionhouse_store(arg0: &0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun emergency_reset_direct_for_kiosk_offer<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 11);
    ...
    public entry fun emergency_reset_kiosk_for_direct_offer<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 11);
    ...
    public entry fun recover_orphaned_cap<T0: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &0xae2628fdb57b4c7a7aae06cdf80b26c9d1f1a4d9ce147d9b12fce5633ab78a98::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
