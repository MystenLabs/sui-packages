module 0xae9a18f87d91f9a71a925c9e6afd535f33d8141d152806046a9f2da5e5474031::staking_pool {
    struct StakingPool has key {
        id: 0x2::object::UID,
        owner: address,
        total_staked: 0x2::balance::Balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>,
        reward_pool: 0x2::balance::Balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>,
    ...
    fun auto_sweep_dust_if_needed(arg0: &mut StakingPool, arg1: u64) {
        if (arg0.unclaimed_reward_dust >= 100000000) {
            let v0 = (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.total_staked) as u128);
            if (v0 > 0) {
    ...
    public entry fun claim_rewards(arg0: &mut StakingPool, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::balance::split<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg0.reward_pool, v4);
        release_rewards(arg0, v2, v0, v1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>>(0x2::coin::from_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(v5, arg2), v0);
    ...
    public entry fun deposit_rewards(arg0: &mut StakingPool, arg1: 0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>, arg2: &0x2::clock::Clock) {
        let v0 = (0x2::coin::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg1) as u128);
        assert!(v0 > 0, 9);
        assert!(v0 <= 333000000000000, 13);
        let v1 = (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.total_staked) as u128);
        if (v1 > 0) {
            assert!(v0 >= v1 / 1000000, 24);
        };
        let v2 = 0;
        let v3 = 0;
        if (v1 > 0) {
        ...
        0x2::balance::join<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg0.reward_pool, 0x2::coin::into_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(arg1));
        let v11 = RewardsDeposited{
            amount                    : v0,
        ...
        0x2::event::emit<RewardsDeposited>(v11);
    }
    ...
    public entry fun emergency_withdraw_rewards(arg0: &AdminCap, arg1: &mut StakingPool, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg2 > 0, 9);
        let v1 = 0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg1.reward_pool);
        assert!(v1 >= arg2, 6);
        assert!(arg2 <= (((v1 as u128) * 10 / 100) as u64), 13);
        arg1.last_emergency_withdrawal = v0;
        let v2 = 0x2::tx_context::sender(arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>>(0x2::coin::from_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(0x2::balance::split<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg1.reward_pool, arg2), arg4), v2);
    ...
    public fun get_available_rewards(arg0: &StakingPool) : u128 {
        let v0 = (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.reward_pool) as u128);
    ...
    public fun get_health_dashboard(arg0: &StakingPool) : (u128, u128, u64, u128, u128, u128, u128, bool, u128) {
        ...
        ((0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.total_staked) as u128), (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.reward_pool) as u128), arg0.total_stakers, arg0.reward_per_token_stored, arg0.unclaimed_reward_dust, arg0.reward_shortfall, arg0.reserved_rewards, v0, v1)
    }

    public fun get_pool_stats(arg0: &StakingPool) : (u128, u128, u64, u128, u128, bool, u64, u128, u128, u128) {
        ((0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.total_staked) as u128), (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.reward_pool) as u128), arg0.total_stakers, arg0.total_rewards_distributed, arg0.total_rewards_added, arg0.is_paused, arg0.min_stake_duration_ms, arg0.unclaimed_reward_dust, arg0.reward_shortfall, arg0.reserved_rewards)
    }

    public fun get_reward_pool_balance(arg0: &StakingPool) : u128 {
        (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.reward_pool) as u128)
    }
    ...
    public fun get_total_staked(arg0: &StakingPool) : u128 {
        (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.total_staked) as u128)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = StakingPool{
            ...
            owner                     : v0,
            total_staked              : 0x2::balance::zero<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(),
            reward_pool               : 0x2::balance::zero<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(),
    ...
    public entry fun reset_critical_state(arg0: &AdminCap, arg1: &mut StakingPool, arg2: &0x2::clock::Clock) {
        ...
        let v0 = (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg1.reward_pool) as u128);
    ...
    public entry fun stake(arg0: &mut StakingPool, arg1: 0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg0.total_staked, 0x2::coin::into_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(arg1));
        let v5 = (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.total_staked) as u128);
    ...
    public entry fun sweep_dust_to_reward_pool(arg0: &AdminCap, arg1: &mut StakingPool, arg2: u64, arg3: 0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>, arg4: &0x2::clock::Clock) {
        assert!(arg2 > 0, 9);
        assert!(0x2::coin::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg3) == arg2, 9);
        assert!(arg1.unclaimed_reward_dust >= (arg2 as u128), 6);
        0x2::balance::join<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg1.reward_pool, 0x2::coin::into_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(arg3));
    ...
    public entry fun unstake(arg0: &mut StakingPool, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0x2::balance::split<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg0.total_staked, arg1);
        let v8 = (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.total_staked) as u128);
        if (v5 > 0) {
            let v9 = 0x2::balance::split<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg0.reward_pool, v5);
            release_rewards(arg0, v4, v1, v2);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>>(0x2::coin::from_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(v7, arg3), v1);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>>(0x2::coin::from_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(v9, arg3), v1);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>>(0x2::coin::from_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(v7, arg3), v1);
        };
        let v10 = Unstaked{
    ...
    public fun verify_pool_integrity(arg0: &StakingPool) : (bool, u128) {
        let v0 = (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.total_staked) as u128) + (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.reward_pool) as u128) + arg0.total_rewards_distributed + arg0.reward_shortfall;
