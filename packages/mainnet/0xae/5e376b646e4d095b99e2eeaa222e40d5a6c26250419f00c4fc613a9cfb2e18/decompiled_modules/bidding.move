module 0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::bidding {
    ...
    fun close_bid_<T0>(arg0: &mut Bid<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T0>>(&arg0.commission)) {
            let (v3, _) = 0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::destroy_bid_commission<T0>(0x1::option::extract<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T0>>(&mut arg0.commission));
    ...
    public fun create_bid<T0>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = new_bid<T0>(arg0, arg1, arg2, 0x1::option::none<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T0>>(), arg3, arg4);
    ...
    public fun create_bid_with_commission<T0>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u64, arg3: address, arg4: u64, arg5: &mut 0x2::coin::Coin<T0>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x1::option::some<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T0>>(0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::new_bid_commission<T0>(arg3, 0x2::balance::split<T0>(0x2::coin::balance_mut<T0>(arg5), arg4)));
        let v1 = new_bid<T0>(arg0, arg1, arg2, v0, arg5, arg6);
        0x2::transfer::share_object<Bid<T0>>(v1);
        0x2::object::id<Bid<T0>>(&v1)
    }

    public fun new_bid<T0>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u64, arg3: 0x1::option::Option<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T0>>, arg4: &mut 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) : Bid<T0> {
        assert!(arg2 != 0, 2);
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = if (0x1::option::is_some<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T0>>(&arg3)) {
            0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::bid_commission_amount<T0>(0x1::option::borrow<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T0>>(&arg3))
        } else {
            0
        };
        let v2 = Bid<T0>{
    ...
    fun sell_nft_common<T0: store + key, T1>(arg0: &mut Bid<T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::TransferRequest<T0>, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) : 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::TransferRequest<T0> {
        ...
        0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::transfer_bid_commission<T1>(&mut arg0.commission, arg4);
