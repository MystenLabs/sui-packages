module 0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::orderbook {
    ...
    struct Orderbook<phantom T0: store + key, phantom T1> has key {
        ...
        asks: 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::CritbitTree<vector<Ask>>,
        bids: 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::CritbitTree<vector<Bid<T1>>>,
    }
    ...
    struct Bid<phantom T0> has store {
        ...
        owner: address,
        kiosk: 0x2::object::ID,
        commission: 0x1::option::Option<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T0>>,
    }
    ...
    struct Ask has store {
        ...
        owner: address,
        commission: 0x1::option::Option<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::AskCommission>,
    }
    ...
    public fun borrow_asks<T0: store + key, T1>(arg0: &Orderbook<T0, T1>) : &0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::CritbitTree<vector<Ask>> {
        &arg0.asks
    }

    public fun borrow_bids<T0: store + key, T1>(arg0: &Orderbook<T0, T1>) : &0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::CritbitTree<vector<Bid<T1>>> {
        &arg0.bids
    }
    ...
    fun buy_nft_<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0x2::coin::Coin<T1>, arg6: &mut 0x2::tx_context::TxContext) : 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::TransferRequest<T0> {
        ...
        0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::transfer_ask_commission<T1>(&mut v6, &mut v8, arg6);
        0x1::option::destroy_none<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::AskCommission>(v6);
    ...
    fun cancel_ask_<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: u64, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::AskCommission> {
        assert_version<T0, T1>(arg0);
    ...
    fun cancel_bid_<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: u64, arg2: &mut 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T1>>(&v0)) {
            let (v1, _) = 0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::destroy_bid_commission<T1>(0x1::option::extract<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T1>>(&mut v0));
            0x2::balance::join<T1>(0x2::coin::balance_mut<T1>(arg2), v1);
        };
        0x1::option::destroy_none<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T1>>(v0);
    }

    fun cancel_bid_except_commission<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: u64, arg2: &mut 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T1>> {
        assert_version<T0, T1>(arg0);
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = &mut arg0.bids;
        let (v2, _) = 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::find_leaf<vector<Bid<T1>>>(v1, arg1);
        assert!(v2, 6);
        let v4 = 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::borrow_mut_leaf_by_key<vector<Bid<T1>>>(v1, arg1);
        let v5 = 0;
        ...
        if (0x1::vector::length<Bid<T1>>(v4) == 0) {
            0x1::vector::destroy_empty<Bid<T1>>(0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::remove_leaf_by_key<vector<Bid<T1>>>(v1, arg1));
        };
    ...
    public fun create_ask<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: u64, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<TradeInfo> {
        ...
        create_ask_<T0, T1>(arg0, arg1, arg2, 0x1::option::none<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::AskCommission>(), arg3, arg4)
    }

    fun create_ask_<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: u64, arg3: 0x1::option::Option<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::AskCommission>, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<TradeInfo> {
        assert_version<T0, T1>(arg0);
        ...
        let (v3, v4) = if (0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::is_empty<vector<Bid<T1>>>(v2)) {
            (false, 0)
        } else {
            let (v5, _) = 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::max_leaf<vector<Bid<T1>>>(v2);
            (v5 >= arg2, v5)
        };
        if (v3) {
            let v8 = TradeInfo{
            ...
            let (v11, _) = 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::find_leaf<vector<Ask>>(&arg0.asks, arg2);
            if (v11) {
                0x1::vector::push_back<Ask>(0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::borrow_mut_leaf_by_key<vector<Ask>>(&mut arg0.asks, arg2), v10);
            } else {
                0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::insert_leaf<vector<Ask>>(&mut arg0.asks, arg2, 0x1::vector::singleton<Ask>(v10));
            };
    ...
    public fun create_ask_protected<T0: store + key, T1>(arg0: 0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::Witness<T0>, arg1: &mut Orderbook<T0, T1>, arg2: &mut 0x2::kiosk::Kiosk, arg3: u64, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<TradeInfo> {
        create_ask_<T0, T1>(arg1, arg2, arg3, 0x1::option::none<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::AskCommission>(), arg4, arg5)
    }
    ...
    public fun create_ask_with_commission<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: u64, arg3: 0x2::object::ID, arg4: address, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<TradeInfo> {
        assert!(!arg0.protected_actions.create_ask, 1);
        assert!(arg5 < arg2, 2);
        create_ask_<T0, T1>(arg0, arg1, arg2, 0x1::option::some<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::AskCommission>(0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::new_ask_commission(arg4, arg5)), arg3, arg6)
    }
    ...
    public fun create_ask_with_commission_protected<T0: store + key, T1>(arg0: 0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::Witness<T0>, arg1: &mut Orderbook<T0, T1>, arg2: &mut 0x2::kiosk::Kiosk, arg3: u64, arg4: 0x2::object::ID, arg5: address, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<TradeInfo> {
        assert!(arg6 < arg3, 2);
        create_ask_<T0, T1>(arg1, arg2, arg3, 0x1::option::some<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::AskCommission>(0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::new_ask_commission(arg5, arg6)), arg4, arg7)
    }
    ...
    public fun create_bid<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: u64, arg3: &mut 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<TradeInfo> {
        ...
        create_bid_<T0, T1>(arg0, arg1, arg2, 0x1::option::none<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T1>>(), arg3, arg4)
    }

    fun create_bid_<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: u64, arg3: 0x1::option::Option<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T1>>, arg4: &mut 0x2::coin::Coin<T1>, arg5: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<TradeInfo> {
        assert_version<T0, T1>(arg0);
        assert_tick_level(arg2, arg0.tick_size);
        ...
        let (v3, v4) = if (0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::is_empty<vector<Ask>>(v2)) {
            (false, 0)
        } else {
            let (v5, _) = 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::min_leaf<vector<Ask>>(v2);
            (v5 <= arg2, v5)
        };
        if (v3) {
            let v8 = TradeInfo{
            ...
            let (v11, _) = 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::find_leaf<vector<Bid<T1>>>(&arg0.bids, arg2);
            if (v11) {
                0x1::vector::push_back<Bid<T1>>(0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::borrow_mut_leaf_by_key<vector<Bid<T1>>>(&mut arg0.bids, arg2), v10);
            } else {
                0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::insert_leaf<vector<Bid<T1>>>(&mut arg0.bids, arg2, 0x1::vector::singleton<Bid<T1>>(v10));
            };
            0x1::option::none<TradeInfo>()
        }
    }
    ...
    public fun create_bid_protected<T0: store + key, T1>(arg0: 0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::Witness<T0>, arg1: &mut Orderbook<T0, T1>, arg2: &mut 0x2::kiosk::Kiosk, arg3: u64, arg4: &mut 0x2::coin::Coin<T1>, arg5: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<TradeInfo> {
        create_bid_<T0, T1>(arg1, arg2, arg3, 0x1::option::none<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T1>>(), arg4, arg5)
    }
    ...
    public fun create_bid_with_commission<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: u64, arg3: address, arg4: u64, arg5: &mut 0x2::coin::Coin<T1>, arg6: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<TradeInfo> {
        assert!(!arg0.protected_actions.create_bid, 1);
        let v0 = 0x1::option::some<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T1>>(0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::new_bid_commission<T1>(arg3, 0x2::balance::split<T1>(0x2::coin::balance_mut<T1>(arg5), arg4)));
    ...
    public fun create_bid_with_commission_protected<T0: store + key, T1>(arg0: 0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::Witness<T0>, arg1: &mut Orderbook<T0, T1>, arg2: &mut 0x2::kiosk::Kiosk, arg3: u64, arg4: address, arg5: u64, arg6: &mut 0x2::coin::Coin<T1>, arg7: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<TradeInfo> {
        let v0 = 0x1::option::some<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T1>>(0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::new_bid_commission<T1>(arg4, 0x2::balance::split<T1>(0x2::coin::balance_mut<T1>(arg6), arg5)));
    ...
    fun finish_trade_<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::tx_context::TxContext) : 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::TransferRequest<T0> {
        ...
        0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::transfer_ask_commission<T1>(&mut v9, &mut v10, arg4);
    ...
    fun match_buy_with_ask_<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: u64, arg2: 0x2::object::ID, arg3: 0x1::option::Option<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T1>>, arg4: &mut 0x2::coin::Coin<T1>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = &mut arg0.asks;
        let v1 = 0x2::tx_context::sender(arg5);
        let v2 = 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::borrow_mut_leaf_by_key<vector<Ask>>(v0, arg1);
        if (0x1::vector::length<Ask>(v2) == 0) {
            0x1::vector::destroy_empty<Ask>(0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::remove_leaf_by_key<vector<Ask>>(v0, arg1));
        };
        let Ask {
            price      : _,
            nft_id     : v4,
        ...
        0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::transfer_bid_commission<T1>(&mut arg3, arg5);
        0x1::option::destroy_none<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T1>>(arg3);
        v9
    }

    fun match_sell_with_bid_<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: u64, arg2: 0x2::object::ID, arg3: 0x1::option::Option<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::AskCommission>, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = &mut arg0.bids;
        let v1 = 0x2::tx_context::sender(arg5);
        let v2 = 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::borrow_mut_leaf_by_key<vector<Bid<T1>>>(v0, arg1);
        if (0x1::vector::length<Bid<T1>>(v2) == 0) {
            0x1::vector::destroy_empty<Bid<T1>>(0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::remove_leaf_by_key<vector<Bid<T1>>>(v0, arg1));
        };
        let Bid {
            offer      : v3,
            owner      : v4,
        ...
        0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::transfer_bid_commission<T1>(&mut v7, arg5);
        0x1::option::destroy_none<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::trading::BidCommission<T1>>(v7);
        v10
    }
    ...
    entry fun migrate_as_pub<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &0x2::package::Publisher) {
        assert!(0x2::package::from_package<0xae5e376b646e4d095b99e2eeaa222e40d5a6c26250419f00c4fc613a9cfb2e18::liquidity_layer::LIQUIDITY_LAYER>(arg1), 0);
        arg0.version = 1;
    }
    ...
    fun new_<T0: store + key, T1>(arg0: WitnessProtectedActions, arg1: &mut 0x2::tx_context::TxContext) : Orderbook<T0, T1> {
        ...
        Orderbook<T0, T1>{
            ...
            asks              : 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::new<vector<Ask>>(arg1),
            bids              : 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::new<vector<Bid<T1>>>(arg1),
        }
    }
    ...
    fun remove_ask(arg0: &mut 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::CritbitTree<vector<Ask>>, arg1: u64, arg2: 0x2::object::ID) : Ask {
        let (v0, _) = 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::find_leaf<vector<Ask>>(arg0, arg1);
        assert!(v0, 6);
        let v2 = 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::borrow_mut_leaf_by_key<vector<Ask>>(arg0, arg1);
        let v3 = 0;
        ...
        assert!(v3 < v4, 6);
        if (0x1::vector::length<Ask>(v2) == 0) {
            0x1::vector::destroy_empty<Ask>(0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::crit_bit::remove_leaf_by_key<vector<Ask>>(arg0, arg1));
        };
