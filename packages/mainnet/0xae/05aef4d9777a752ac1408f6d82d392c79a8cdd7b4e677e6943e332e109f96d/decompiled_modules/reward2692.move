module 0xae05aef4d9777a752ac1408f6d82d392c79a8cdd7b4e677e6943e332e109f96d::reward2692 {
    struct REWARD2692 has drop {
        dummy_field: bool,
    }

    struct TICKET_2692 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2692(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2692>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2692>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2692, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2692>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2692>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2692>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2692>>(v5, 0x2::tx_context::sender(arg1));
    }
