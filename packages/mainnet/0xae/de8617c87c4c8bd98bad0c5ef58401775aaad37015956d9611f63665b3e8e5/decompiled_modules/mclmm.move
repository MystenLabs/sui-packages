module 0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::mclmm {
    ...
    public fun elf<T0, T1>(arg0: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: &mut 0xe04b8f264c8a29e103e71980987d76a475c8565094b6646e368659a30a9c70ed::bm::CBM, arg2: &0x2::clock::Clock, arg3: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg4: u64, arg5: u64, arg6: u64, arg7: vector<bool>, arg8: vector<bool>, arg9: vector<u64>, arg10: vector<u64>, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        while (v8 < 0x1::vector::length<bool>(&arg7)) {
            ...
            let v12 = if (v10) {
                0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::cmnsp() + 1
            } else {
                0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::cmxsp() - 1
            };
            let (v13, v14) = vbac<T0, T1>(arg0, v5, v7, v9, v10, *0x1::vector::borrow<u64>(&arg9, v8), v11, v12);
            if (v13 != 0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::e_no_error()) {
                let v15 = EE{
                    e : v13,
                    l : 268,
                };
            ...
            if (v16 != 0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::e_no_error()) {
                let v21 = EE{
                    e : v16,
                    l : 306,
                };
    ...
    fun sei<T0, T1>(arg0: &mut 0xe04b8f264c8a29e103e71980987d76a475c8565094b6646e368659a30a9c70ed::bm::CBM, arg1: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg2: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg3: bool, arg4: u64, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        assert!(v8 >= arg5, 0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::e_amount_out_too_low());
        ...
        let (v11, v12) = if (arg3) {
            ...
            (0x2::coin::zero<T0>(arg8), 0xe04b8f264c8a29e103e71980987d76a475c8565094b6646e368659a30a9c70ed::bm::wd<T1>(arg0, v10, arg8))
        };
        let v13 = v12;
        let v14 = v11;
        let (v15, v16) = if (arg3) {
        ...
        0xe04b8f264c8a29e103e71980987d76a475c8565094b6646e368659a30a9c70ed::bm::dp<T0>(arg0, v14, arg8);
        0xe04b8f264c8a29e103e71980987d76a475c8565094b6646e368659a30a9c70ed::bm::dp<T1>(arg0, v13, arg8);
        (0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::e_no_error(), v9, v10, v6, v7)
    }
    ...
    fun seo<T0, T1>(arg0: &mut 0xe04b8f264c8a29e103e71980987d76a475c8565094b6646e368659a30a9c70ed::bm::CBM, arg1: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg2: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg3: bool, arg4: u64, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        assert!(v8 <= arg5, 0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::e_amount_in_too_high());
        let (v9, v10) = if (arg3) {
        ...
        (0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::e_no_error(), v6, v7, 0x2::balance::value<T0>(&v5), 0x2::balance::value<T1>(&v4))
    }
    ...
    fun vbac<T0, T1>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: bool, arg4: bool, arg5: u64, arg6: u64, arg7: u128) : (u64, u64) {
        ...
        let (v2, v3) = if (arg3) {
            (v1, 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::get_state_amount_calculated(&v0))
        } else {
            (0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::get_state_amount_calculated(&v0), v1)
        };
        if (arg3) {
            if (v3 < arg6) {
                return (0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::e_amount_out_too_low(), 0)
            };
        } else if (v2 > arg6) {
            return (0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::e_amount_in_too_high(), 0)
        };
        if (arg4) {
            if (v2 > arg1) {
                return (0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::e_insufficient_input_balance(), 0)
            };
        } else if (v2 > arg2) {
            return (0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::e_insufficient_input_balance(), 0)
        };
        (0xaede8617c87c4c8bd98bad0c5ef58401775aaad37015956d9611f63665b3e8e5::ct::e_no_error(), v1)
    }
