module 0xaeedd86901e9c6a1881583ee8a00e64a8dacd40a6875cb01ba98c4c9be6a3775::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"CON1810753", b"Concurrent1 810753", b"Concurrent 1", 0x1::option::none<0x2::url::Url>(), arg1);
