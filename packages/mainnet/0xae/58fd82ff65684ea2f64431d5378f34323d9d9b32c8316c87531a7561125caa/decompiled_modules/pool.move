module 0xae58fd82ff65684ea2f64431d5378f34323d9d9b32c8316c87531a7561125caa::pool {
    ...
    public entry fun add_pool(arg0: &mut 0xae58fd82ff65684ea2f64431d5378f34323d9d9b32c8316c87531a7561125caa::launchpadINO::LaunchpadINO, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: u8, arg11: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg11);
        assert!(v0 == 0xae58fd82ff65684ea2f64431d5378f34323d9d9b32c8316c87531a7561125caa::launchpadINO::get_owner(arg0), 135289670003);
        ...
        0xae58fd82ff65684ea2f64431d5378f34323d9d9b32c8316c87531a7561125caa::launchpadINO::add_more_pools(arg0, v3);
    ...
    public entry fun claim(arg0: &mut Pool, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.isLocked == 0, 135289670008);
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Buy>(&mut arg0.id, arg1);
        assert!(v1.amount > 0, 135289670000);
        assert!(v0 == v1.account, 135289670003);
        let v2 = ClaimCreatedEvent{
            claim_id : 0x2::object::uid_to_inner(&v1.id),
            amount   : v1.amount,
            owner    : v0,
        };
        0x2::event::emit<ClaimCreatedEvent>(v2);
    }
