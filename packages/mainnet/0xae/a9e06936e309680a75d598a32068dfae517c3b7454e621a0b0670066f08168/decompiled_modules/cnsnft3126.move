module 0xaea9e06936e309680a75d598a32068dfae517c3b7454e621a0b0670066f08168::cnsnft3126 {
    struct CNSNFT3126 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3126, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3126>(arg0, arg1);
