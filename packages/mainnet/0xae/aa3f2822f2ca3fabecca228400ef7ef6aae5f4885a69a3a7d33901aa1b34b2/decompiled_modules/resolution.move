module 0xaeaa3f2822f2ca3fabecca228400ef7ef6aae5f4885a69a3a7d33901aa1b34b2::resolution {
    ...
    fun finalize_internal<T0>(arg0: &mut Resolution<T0>, arg1: &mut 0xaeaa3f2822f2ca3fabecca228400ef7ef6aae5f4885a69a3a7d33901aa1b34b2::market::Market<T0>, arg2: u8, arg3: u8) {
        arg0.finalized = true;
        arg0.final_outcome = arg2;
        if (arg2 == 2) {
            0xaeaa3f2822f2ca3fabecca228400ef7ef6aae5f4885a69a3a7d33901aa1b34b2::market::set_invalid<T0>(arg1);
        } else {
            0xaeaa3f2822f2ca3fabecca228400ef7ef6aae5f4885a69a3a7d33901aa1b34b2::market::set_resolved<T0>(arg1, arg2);
        };
        let v0 = Finalized{
            market_id : arg0.market_id,
            outcome   : arg2,
    ...
    public fun finalize_optimistic<T0>(arg0: &mut Resolution<T0>, arg1: &mut 0xaeaa3f2822f2ca3fabecca228400ef7ef6aae5f4885a69a3a7d33901aa1b34b2::market::Market<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.finalized, 0);
        assert!(arg0.proposed, 5);
        assert!(!arg0.disputed, 11);
        assert!(0x2::object::id<0xaeaa3f2822f2ca3fabecca228400ef7ef6aae5f4885a69a3a7d33901aa1b34b2::market::Market<T0>>(arg1) == arg0.market_id, 8);
    ...
    fun settle_bonds<T0>(arg0: &mut Resolution<T0>, arg1: u8, arg2: &mut 0xaeaa3f2822f2ca3fabecca228400ef7ef6aae5f4885a69a3a7d33901aa1b34b2::treasury::Treasury<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg0.proposed) {
            if (arg0.disputed) {
    ...
    public fun start<T0>(arg0: &0xaeaa3f2822f2ca3fabecca228400ef7ef6aae5f4885a69a3a7d33901aa1b34b2::market::Market<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        0xaeaa3f2822f2ca3fabecca228400ef7ef6aae5f4885a69a3a7d33901aa1b34b2::market::assert_closed<T0>(arg0);
    ...
    public fun vote<T0>(arg0: &Council, arg1: &mut Resolution<T0>, arg2: &mut 0xaeaa3f2822f2ca3fabecca228400ef7ef6aae5f4885a69a3a7d33901aa1b34b2::market::Market<T0>, arg3: &mut 0xaeaa3f2822f2ca3fabecca228400ef7ef6aae5f4885a69a3a7d33901aa1b34b2::treasury::Treasury<T0>, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.finalized, 0);
        assert!(0x2::object::id<0xaeaa3f2822f2ca3fabecca228400ef7ef6aae5f4885a69a3a7d33901aa1b34b2::market::Market<T0>>(arg2) == arg1.market_id, 8);
