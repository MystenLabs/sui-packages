module 0xae02b95af0724b2cb67c5dc4b4af9b2884349ec78ac2b0d79cebd525614a2bd5::reward4750 {
    struct REWARD4750 has drop {
        dummy_field: bool,
    }

    struct TICKET_4750 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4750(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4750>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4750>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4750, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4750>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4750>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4750>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4750>>(v5, 0x2::tx_context::sender(arg1));
    }
