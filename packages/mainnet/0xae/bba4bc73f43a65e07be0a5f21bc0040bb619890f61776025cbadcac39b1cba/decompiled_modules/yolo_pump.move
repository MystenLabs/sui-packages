module 0x6079a109382facb4767a25ad52b3f69536e82ce38fe6553899432a4fa83b2414::yolo_pump {
    ...
    struct PoolCompletedEvent2 has copy, drop, store {
        token_address: 0x1::ascii::String,
        lp: 0x1::ascii::String,
        ts: u64,
        sui_amount: u64,
    ...
    fun transfer_pool<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &mut Pool<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = (v3 as u128) * 0x1::u128::pow(10, 3) / (v2 as u128);
        let v5 = 0x1::u128::sqrt(v4);
        let v6 = v5 * 0x1::u128::pow(2, 64);
        let v7 = 60;
        let v8 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::abs_u32(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_tick_at_sqrt_price(v6));
        let v9 = v8 - v8 % v7 - v7;
        let v10 = v8 - v8 % v7 + v7;
        let (v11, v12, v13) = init_cetus_pool<0x2::sui::SUI, T0>(arg0, arg1, v7, v6, 0x1::string::from_ascii(arg5.uri), v9, v10, v1, v0, arg3, arg4, true, arg6, arg7);
        0x2::transfer::public_transfer<0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::CetusLPBurnProof>(0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::burn_lp_v2(arg2, v11, arg7), @0xf3cf5493e58e308861e4c8649cdcb44a24c4f6ecce3db46ee9d99ba96daaca1f);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v12, @0xf3cf5493e58e308861e4c8649cdcb44a24c4f6ecce3db46ee9d99ba96daaca1f);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v13, @0xf3cf5493e58e308861e4c8649cdcb44a24c4f6ecce3db46ee9d99ba96daaca1f);
        let v14 = PoolCompletedEvent2{
            ...
            sqrt_price         : v5,
            initialize_price   : v6,
            current_tick_index : v8,
            tick_lower_idx     : v9,
            tick_upper_idx     : v10,
        };
        0x2::event::emit<PoolCompletedEvent2>(v14);
    }
