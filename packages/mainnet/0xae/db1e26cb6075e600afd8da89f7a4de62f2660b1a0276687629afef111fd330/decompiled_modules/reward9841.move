module 0xaedb1e26cb6075e600afd8da89f7a4de62f2660b1a0276687629afef111fd330::reward9841 {
    struct REWARD9841 has drop {
        dummy_field: bool,
    }

    struct TICKET_9841 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9841(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9841>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9841>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9841, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9841>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9841>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9841>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9841>>(v5, 0x2::tx_context::sender(arg1));
    }
