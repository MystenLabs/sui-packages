module 0xaee779885a4c8ad26f780a03cc0d10648803c95d1241d572c376bd2f18e34cec::wlfi {
    ...
    fun init(arg0: WLFI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<WLFI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"WLFI      ")))), trim_right(b"World Liberty Financial         "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
