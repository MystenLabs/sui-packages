module 0xbb24680526bd0d6d36e83f77904e6b233a111fa13dbebadfe5e9e44fbd66fb51::cloud_wallet_config {
    ...
    public(friend) fun check_swapping_id_match(arg0: 0x2::object::ID, arg1: &0xe951c91ad0b9432350273472209741ec23eb3111a08979145af13199bfe57c1a::swap::Swapping) {
        assert!(arg0 == 0xe951c91ad0b9432350273472209741ec23eb3111a08979145af13199bfe57c1a::swap::get_swapping_id(arg1), 20019);
    }
    ...
    public(friend) fun credit_coin_v2<T0>(arg0: &mut CloudWalletTokenHolder, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        create_vault_if_not_exist<T0>(arg0, arg2);
        let v0 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, CloudWalletVault<T0>>(&mut arg0.vault_bag, 0x1::type_name::get<T0>());
        0x2::balance::join<T0>(&mut v0.balance, 0x2::balance::redeem_funds<T0>(0x2::balance::withdraw_funds_from_object<T0>(&mut arg0.id, arg1)));
        0x2::balance::value<T0>(&v0.balance) - 0x2::balance::value<T0>(&v0.balance)
    }
    ...
    public fun remove_signer(arg0: &mut CloudWalletConfig, arg1: vector<u8>, arg2: u8, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(v0, 20005);
        if (arg2 == 1) {
            let (v1, v2) = 0x1::vector::index_of<vector<u8>>(&arg0.lpb_signers, &arg1);
            assert!(v1, 20006);
            0x1::vector::remove<vector<u8>>(&mut arg0.lpb_signers, v2);
            let v3 = SignerRemove{
                signer_pubkey : arg1,
                version       : 1,
            };
            0x2::event::emit<SignerRemove>(v3);
        } else if (arg2 == 2) {
            let (v4, v5) = 0x1::vector::index_of<vector<u8>>(&arg0.mm_signers, &arg1);
            assert!(v4, 20006);
            0x1::vector::remove<vector<u8>>(&mut arg0.mm_signers, v5);
            let v6 = SignerRemove{
                signer_pubkey : arg1,
                version       : 2,
            };
            0x2::event::emit<SignerRemove>(v6);
        } else if (0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"user_deposit_signers"))) {
            let v7 = 0x2::dynamic_field::borrow_mut<0x1::string::String, vector<vector<u8>>>(&mut arg0.id, 0x1::string::utf8(b"user_deposit_signers"));
            let (v8, v9) = 0x1::vector::index_of<vector<u8>>(v7, &arg1);
            assert!(v8, 20006);
            0x1::vector::remove<vector<u8>>(v7, v9);
            let v10 = SignerRemove{
                signer_pubkey : arg1,
                version       : 3,
            };
            0x2::event::emit<SignerRemove>(v10);
        };
    }
