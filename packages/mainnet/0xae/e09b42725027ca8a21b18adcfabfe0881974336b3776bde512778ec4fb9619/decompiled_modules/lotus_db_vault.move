module 0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::lotus_db_vault {
    ...
    public(friend) fun is_strategy_in_range<T0, T1, T2>(arg0: &LotusDBVault<T0>, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T1, T2>, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::oracle_ag::OracleAggregator, arg5: &0x2::clock::Clock) : bool {
        ...
        let v0 = 1;
        assert!(0x2::table::borrow<0x1::string::String, u64>(&arg0.strategy_params, 0x1::string::utf8(b"strategy_type")) == &v0, 13906841218089746431);
    ...
    public fun place_batch_limit_orders_pure<T0, T1, T2>(arg0: &mut LotusDBVault<T0>, arg1: &LotusDBVaultCap, arg2: &0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::lotus_config::LotusConfig, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T1, T2>, arg4: vector<u64>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<bool>, arg10: vector<bool>, arg11: vector<u64>, arg12: bool, arg13: &0x2::clock::Clock, arg14: &0x2::tx_context::TxContext) {
        ...
        let v2 = 0;
        while (v2 < v0) {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T1, T2>(arg3, &mut arg0.balance_manager, &v1, *0x1::vector::borrow<u64>(&arg4, v2), *0x1::vector::borrow<u8>(&arg5, v2), *0x1::vector::borrow<u8>(&arg6, v2), *0x1::vector::borrow<u64>(&arg7, v2), *0x1::vector::borrow<u64>(&arg8, v2), *0x1::vector::borrow<bool>(&arg9, v2), *0x1::vector::borrow<bool>(&arg10, v2), *0x1::vector::borrow<u64>(&arg11, v2), arg13, arg14);
            v2 = v2 + 1;
        };
        let v3 = BatchLimitOrderEvent{
            vault_id         : 0x2::object::id<LotusDBVault<T0>>(arg0),
    ...
    public fun place_bbo_limit_order<T0, T1, T2>(arg0: &mut LotusDBVault<T0>, arg1: &LotusDBVaultCap, arg2: &0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::lotus_config::LotusConfig, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T1, T2>, arg4: u64, arg5: u8, arg6: u8, arg7: u64, arg8: u64, arg9: bool, arg10: bool, arg11: u64, arg12: &0x2::clock::Clock, arg13: &0x2::tx_context::TxContext) {
        ...
        assert_db_pool<T0, T1, T2>(arg0, arg3);
        assert_vault_cap_access<T0>(arg0, arg1, 8);
        let v0 = arg7 * 0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::consts::GET_BBO_MAX_RANGE_BPS() / 10000;
        let v1 = if (arg7 > v0) {
            arg7 - v0
        } else {
            1
        };
        let (v2, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::get_level2_range<T1, T2>(arg3, v1, arg7 + v0, arg9, arg12);
        let v4 = v2;
        let v5 = if (0x1::vector::length<u64>(&v4) > 0) {
            let v6 = *0x1::vector::borrow<u64>(&v4, 0);
            if (arg9) {
                if (v6 <= arg7) {
                    v6
                } else {
        ...
        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T1, T2>(arg3, &mut arg0.balance_manager, &v7, arg4, arg5, arg6, v5, arg8, arg9, arg10, arg11, arg12, arg13);
