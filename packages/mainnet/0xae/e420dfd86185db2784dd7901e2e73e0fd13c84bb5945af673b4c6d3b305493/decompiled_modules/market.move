module 0xecd5c66a9a922ce3632fece9abeab3bbbfaa1a56651dbcfeffc2defb8964092d::market {
    ...
    struct QueryAccEvent has copy, drop {
        user_listed_acc: vector<u64>,
        total_listed_acc: vector<u64>,
    }
    ...
    public fun delist(arg0: &mut Global, arg1: 0x1::ascii::String, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = v2;
        assert!(v6 == v0, 1003);
        assert!(arg1 == 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::tick(&v11), 1008);
        if (v1.head == v8) {
            v1.head = v10;
        };
        if (v1.tail == v8) {
    ...
    public fun get_market_data_v2(arg0: &Global, arg1: &0x2::clock::Clock, arg2: 0x1::ascii::String, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::tx_context::TxContext) {
        ...
        if (0x2::bag::contains<address>(&v1.user_infos, v0)) {
            let v10 = 0x2::bag::borrow<address, UserInfo>(&v1.user_infos, v0).listed_index;
            let v11 = 0;
            while (v11 < 0x1::vector::length<u64>(&v10)) {
                let v12 = *0x1::vector::borrow<u64>(&v10, v11);
                if (0x2::bag::contains<u64>(&v1.orders, v12)) {
                    let v13 = 0x2::bag::borrow<u64, Order>(&v1.orders, v12);
                    let v14 = ListedItem{
                        order_index : v12,
                        id          : 0x2::object::id<0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::Movescription>(&v13.obj),
                        amount      : 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::amount(&v13.obj),
                        price       : v13.price,
                        owner       : v13.owner,
                        order_info  : get_order_info(&v1.orders, v12),
                    };
                    0x1::vector::push_back<ListedItem>(&mut v8, v14);
                    0x1::vector::push_back<u64>(&mut v9, 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::acc(&v13.obj));
                };
                v11 = v11 + 1;
            };
        };
        let v15 = 0x1::vector::empty<ListedItem>();
        let v16 = vector[];
        let v17 = v1.head;
        let v18 = arg3 * arg4;
        let v19 = 0;
        if (v1.size > v18) {
            while (0x2::bag::contains<u64>(&v1.orders, v17)) {
                let v20 = 0x2::bag::borrow<u64, Order>(&v1.orders, v17);
                if (v19 < v18) {
                    v19 = v19 + 1;
                    v17 = v20.next_index;
                    continue
                ...
                let v21 = ListedItem{
                    order_index : v17,
                    id          : 0x2::object::id<0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::Movescription>(&v20.obj),
                    amount      : 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::amount(&v20.obj),
                    price       : v20.price,
                    owner       : v20.owner,
                    order_info  : get_order_info(&v1.orders, v17),
                };
                0x1::vector::push_back<ListedItem>(&mut v15, v21);
                0x1::vector::push_back<u64>(&mut v16, 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::acc(&v20.obj));
                if (0x1::vector::length<ListedItem>(&v15) >= arg5) {
                    break
                };
                v19 = v19 + 1;
                v17 = v20.next_index;
        ...
        let v22 = 0;
        if (v1.head > 0) {
            let v23 = get_order_info(&v1.orders, v1.head);
            v22 = v23.price_per_amount;
        };
        let v24 = QueryMarketDataEvent{
            tick                 : arg2,
            traders              : v1.traders,
            txs                  : v1.txs,
            volume_24h           : v5,
        ...
        0x2::event::emit<QueryMarketDataEvent>(v24);
        let v25 = QueryAccEvent{
            user_listed_acc  : v9,
            total_listed_acc : v16,
        };
        0x2::event::emit<QueryAccEvent>(v25);
    }
    ...
    fun only_allowed_version(arg0: &Global) {
        assert!(arg0.current_version <= 10, 1000);
    }
