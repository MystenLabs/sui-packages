module 0xaef95162ecfbc3e7dc5169bf9bca3111d9edfa023be4f254375907ca81128a04::cnsnft6341 {
    struct CNSNFT6341 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6341, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6341>(arg0, arg1);
