module 0xae75c488c0d92e63da042c54284930effcdfd457b4b7ecc45af447a9351c22cb::game4186 {
    struct GAME4186 has drop {
        dummy_field: bool,
    }

    struct TICKET_4186 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4186(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4186>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4186>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME4186, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME4186>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4186>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4186>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4186>>(v5, 0x2::tx_context::sender(arg1));
    }
