module 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32 {
    ...
    public fun from_u32_neg(arg0: u32, arg1: bool) : I32 {
        if (arg1) {
            neg_from(arg0)
        } else {
            from(arg0)
    ...
    public fun mod_euclidean(arg0: I32, arg1: u32) : I32 {
        let v0 = from(arg1);
        let v1 = mod(arg0, v0);
        if (sign(v1) == 1) {
            add(v1, v0)
