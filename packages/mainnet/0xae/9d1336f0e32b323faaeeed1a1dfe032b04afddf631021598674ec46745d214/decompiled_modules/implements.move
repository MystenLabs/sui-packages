module 0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::implements {
    ...
    public(friend) fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LP<T0, T1>>, vector<u64>) {
        ...
        let v9 = if (0 == v6) {
            let v10 = 0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::math::sqrt(0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::math::mul_to_u128(v7, v8));
            assert!(v10 > 1000, 8);
    ...
    public fun calc_optimal_coin_values(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : (u64, u64) {
        ...
        let v0 = 0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::math::mul_div(arg0, arg5, arg4);
        if (v0 <= arg1) {
            assert!(v0 >= arg3, 4);
            return (arg0, v0)
        };
        let v1 = 0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::math::mul_div(arg1, arg4, arg5);
        assert!(v1 <= arg0, 6);
        assert!(v1 >= arg2, 3);
        (v1, arg1)
    }
    ...
    public fun get_amount_out(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::math::mul_div_u128(v0, (arg2 as u128), (arg1 as u128) * (10000 as u128) + v0)
    }
    ...
    public fun get_fee_to_fundation(arg0: u64, arg1: u64) : u64 {
        0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::math::mul_div(arg0, arg1, 10000)
    }
    ...
    public fun is_order<T0, T1>() : bool {
        ...
        let v2 = 0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::comparator::compare<0x1::type_name::TypeName>(&v0, &v1);
        assert!(!0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::comparator::is_equal(&v2), 9);
        0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::comparator::is_smaller_than(&v2)
    }
    ...
    public fun is_sui<T0>() : bool {
        ...
        let v2 = 0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::comparator::compare<0x1::ascii::String>(&v1, &v0);
        0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::comparator::is_equal(&v2)
    }
    ...
    public(friend) fun removeX_scale_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(v0 > 0, 0);
        let v3 = 0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::math::mul_div(v0, arg1, 100);
        assert!(v3 > 0, 0);
    ...
    public(friend) fun removeY_scale_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(v1 > 0, 0);
        let v3 = 0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::math::mul_div(v1, arg1, 100);
        assert!(v3 > 0, 0);
    ...
    public(friend) fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        (0x2::coin::take<T0>(&mut arg0.coin_x, 0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::math::mul_div(v1, v0, v3), arg3), 0x2::coin::take<T1>(&mut arg0.coin_y, 0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::math::mul_div(v2, v0, v3), arg3))
    }
    ...
    public(friend) fun swap_out<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        if (arg3) {
            ...
            let v11 = get_amount_out(v8, v4, v5);
            let v12 = v11;
            if (!v3) {
                let v13 = v11 * (v2.free_ratio as u64) / 100;
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut v2.coin_y, v13, arg4), v2.market_address);
                v12 = v11 - v13;
            };
            assert!(v12 >= arg2, 7);
            0x2::balance::join<T0>(&mut v2.fee_coin_x, 0x2::balance::split<T0>(&mut v9, get_fee_to_fundation(v8, v0)));
            0x2::balance::join<T0>(&mut v2.coin_x, v9);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut v2.coin_y, v12, arg4), 0x2::tx_context::sender(arg4));
            let (v14, v15, _) = get_reserves_size<T0, T1>(v2);
            assert_lp_value_is_increased(v4, v5, v14, v15);
            let v17 = 0x1::vector::empty<u64>();
            0x1::vector::push_back<u64>(&mut v17, v8);
            0x1::vector::push_back<u64>(&mut v17, 0);
            0x1::vector::push_back<u64>(&mut v17, 0);
            0x1::vector::push_back<u64>(&mut v17, v12);
            v17
        } else {
            let v18 = get_mut_pool<T1, T0>(arg0, !arg3);
            if (!is_tax_coin<T0>(0x1::ascii::into_bytes(v18.tax_coin)) && v18.has_paused) {
                abort 16
            };
            ...
            if (v19) {
                let v26 = 0xae9d1336f0e32b323faaeeed1a1dfe032b04afddf631021598674ec46745d214::math::mul_div(v23, (v18.free_ratio as u64), 100);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v25, v26, arg4), v18.market_address);
                v24 = v23 - v26;
            };
            let v27 = get_amount_out(v24, v21, v20);
            let v28 = v27;
            if (!v19) {
                let v29 = v27 * (v18.free_ratio as u64) / 100;
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut v18.coin_x, v29, arg4), v18.market_address);
                v28 = v27 - v29;
            };
            assert!(v28 >= arg2, 7);
            0x2::balance::join<T0>(&mut v18.fee_coin_y, 0x2::balance::split<T0>(&mut v25, get_fee_to_fundation(v24, v0)));
            0x2::balance::join<T0>(&mut v18.coin_y, v25);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut v18.coin_x, v28, arg4), 0x2::tx_context::sender(arg4));
            let (v30, v31, _) = get_reserves_size<T1, T0>(v18);
            assert_lp_value_is_increased(v20, v21, v30, v31);
            let v33 = 0x1::vector::empty<u64>();
            0x1::vector::push_back<u64>(&mut v33, 0);
            0x1::vector::push_back<u64>(&mut v33, v28);
            0x1::vector::push_back<u64>(&mut v33, v24);
            0x1::vector::push_back<u64>(&mut v33, 0);
            v33
        }
    }
