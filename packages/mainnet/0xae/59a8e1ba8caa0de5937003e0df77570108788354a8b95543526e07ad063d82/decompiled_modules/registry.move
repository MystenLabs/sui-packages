module 0xae59a8e1ba8caa0de5937003e0df77570108788354a8b95543526e07ad063d82::registry {
    ...
    public fun disable_version(arg0: &mut Registry, arg1: u64, arg2: &AdminCap) {
        assert!(arg1 != 0xae59a8e1ba8caa0de5937003e0df77570108788354a8b95543526e07ad063d82::constants::current_version(), 3);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Registry{
            ...
            allowed_versions : 0x2::vec_set::singleton<u64>(0xae59a8e1ba8caa0de5937003e0df77570108788354a8b95543526e07ad063d82::constants::current_version()),
