module 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::ownable {
    ...
    struct RobotCap<phantom T0, phantom T1> has key {
        id: 0x2::object::UID,
    }

    public fun assert_version(arg0: &AdminCap) {
        assert!(arg0.version == 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::version::get_program_version(), 3);
    }
    ...
    public entry fun destroy_robot_cap<T0, T1>(arg0: RobotCap<T0, T1>) {
        let RobotCap { id: v0 } = arg0;
        0x2::object::delete(v0);
    }
    ...
    public(friend) fun grant_admin_cap(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = AdminCap{
            ...
            version : 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::version::get_program_version(),
        };
    ...
    public(friend) fun grant_robot_cap<T0, T1>(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = RobotCap<T0, T1>{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<RobotCap<T0, T1>>(v0, arg0);
    }

    public(friend) fun migrate(arg0: &mut AdminCap, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::version::get_program_version();
        assert!(arg0.version < v0, 3);
