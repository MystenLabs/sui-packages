module 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::oracle_driven_pool {
    ...
    fun calculate_trade_slippage<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64, arg2: bool, arg3: u64) : u64 {
        ...
        while (v14 < 0x1::vector::length<u64>(&v12)) {
            ...
            if (v16 > 0) {
                ...
                if (v14 == 0) {
                    v15 = v15 + 0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::mul(v17, arg0.core_data.k_without_deviation);
                } else {
    ...
    public fun check_parameters<T0, T1>(arg0: &Pool<T0, T1>) {
        assert!(0xae9d731d014c9c8ddee00be64097a55dfb47e6d3d1cbb1b0385aaf08eec17a03::safe_math::lt_one(get_k_without_deviation<T0, T1>(arg0)), 1);
        assert!(get_k_without_deviation<T0, T1>(arg0) > 0, 1);
    }
