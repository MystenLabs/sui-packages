module 0xaedb9a4330883c91769c99e7d2a7ea573b686504daf11d13353141260736a902::config {
    ...
    public fun add_plan(arg0: &mut Config, arg1: &0xaedb9a4330883c91769c99e7d2a7ea573b686504daf11d13353141260736a902::admin::AdminCap, arg2: u64, arg3: u8, arg4: u8, arg5: u64) {
    ...
    public fun remove_plan(arg0: &mut Config, arg1: &0xaedb9a4330883c91769c99e7d2a7ea573b686504daf11d13353141260736a902::admin::AdminCap, arg2: u64) {
    ...
    public fun set_accepted_payment_type<T0>(arg0: &mut Config, arg1: &0xaedb9a4330883c91769c99e7d2a7ea573b686504daf11d13353141260736a902::admin::AdminCap) {
        arg0.accepted_payment_type = 0x1::type_name::into_string(0x1::type_name::with_original_ids<T0>());
    }

    public fun set_paused(arg0: &mut Config, arg1: &0xaedb9a4330883c91769c99e7d2a7ea573b686504daf11d13353141260736a902::admin::AdminCap, arg2: bool) {
        arg0.paused = arg2;
    }

    public fun update_fee_receiver(arg0: &mut Config, arg1: &0xaedb9a4330883c91769c99e7d2a7ea573b686504daf11d13353141260736a902::admin::AdminCap, arg2: address) {
        arg0.fee_receiver = arg2;
    }

    public fun update_plan(arg0: &mut Config, arg1: &0xaedb9a4330883c91769c99e7d2a7ea573b686504daf11d13353141260736a902::admin::AdminCap, arg2: u64, arg3: u8, arg4: u8, arg5: u64) {
        assert!(0x2::vec_map::contains<u64, SubscriptionPlan>(&arg0.plans, &arg2), 102);
        let (_, _) = 0x2::vec_map::remove<u64, SubscriptionPlan>(&mut arg0.plans, &arg2);
