module 0x5a6ab91581604273c78ef5bf421f0f57868ac40e519d39e2b80f39e9ddaef12e::utils {
    ...
    public fun from_bytes_u256(arg0: &vector<u8>) : u256 {
        let v0 = truncate_zeros(arg0);
        0x1::vector::reverse<u8>(&mut v0);
        let v1 = 32 - 0x1::vector::length<u8>(&v0);
        while (v1 > 0) {
            0x1::vector::push_back<u8>(&mut v0, 0);
            v1 = v1 - 1;
        };
    ...
    public fun to_bytes_u256_sign(arg0: u256, arg1: bool) : vector<u8> {
        to_signed_bytes(0x1::bcs::to_bytes<u256>(&arg0), arg1)
    }
