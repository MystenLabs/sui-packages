module 0xae057a525dd3d29902540244a2a24120c256341c5ef94de4cf2db8892aa1c452::pnut {
    ...
    fun init(arg0: PNUT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/2qEHjDLDLbuBgRYvsxhc5D6uDWAivNFZGan56P1tpump.png?size=lg&key=d29800                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<PNUT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Pnut    ")))), trim_right(b"Peanut the Squirrel on SUI      "), trim_right(b"Peanut the Squirrel - AKA PNut - captured the hearts of millions on social media before he was wrongfully taken and euthanised by the NYDEC. Now, he stands immortalised on the blockchain forever, spearheading a movement that demands reform to current Governmental overreach. Long live PNut                               "), v2, arg1);
        let v5 = v3;
