module 0x82d026197b2fba7c8fa1a2959a4d5c99df4ad0db7d3d596bf88faa2067e2e5bf::TOKENIZER {
    ...
    fun init(arg0: TOKENIZER, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKENIZER>(arg0, 9, b"CICCUSD", b"Council of International Chambers of Commerce", b"Tokenized representation of real world assets backed by ART20 NFTs and Pegged to USD", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://salmon-accused-puma-149.mypinata.cloud/ipfs/bafkreigzx742zitzr54giv7ptyxleju4wr55s2iu5vc7uzf3gp32efmenu?pinataGatewayToken=Nc4R8TH9sXtjJQUiqvn_ZXvRnNYOlp6eH8lT7JTr0zEUEZV2BjEMU-81HiF2dy5x")), arg1);
        let v2 = v0;
