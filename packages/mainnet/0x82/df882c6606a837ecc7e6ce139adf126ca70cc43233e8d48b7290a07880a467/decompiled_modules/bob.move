module 0x82df882c6606a837ecc7e6ce139adf126ca70cc43233e8d48b7290a07880a467::bob {
    struct BOB has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BOB, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<BOB>(&mut v3, 100000000000000000, 0x2::tx_context::sender(arg1), arg1);
