module 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config {
    ...
    public(friend) fun assert_global_close_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_close_pause, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_global_close_paused());
    }

    public(friend) fun assert_global_open_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_open_pause, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_global_open_paused());
    }

    public(friend) fun assert_package_version(arg0: &GlobalConfig) {
        assert!(check_package_version(arg0), 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_wrong_version());
    }
