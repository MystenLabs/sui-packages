module 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::position {
    ...
    public fun calculate_fee(arg0: u64, arg1: u64, arg2: u64) : u64 {
        assert!(arg0 < arg1, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_fee_rate());
        (((arg2 as u128) * (arg0 as u128) / (arg1 as u128)) as u64)
    }

    public fun close_position<T0>(arg0: &0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::GlobalConfig, arg1: &mut 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::Market, arg2: Position<T0>, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::obligation::Obligation<T0>, arg4: &0x2::clock::Clock) {
        0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::assert_package_version(arg0);
        0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::assert_global_close_not_paused(arg0);
        0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::assert_close_not_paused(arg1);
        assert!(obligation_id<T0>(&arg2) == 0x2::object::id<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::obligation::Obligation<T0>>(arg3), 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_position_not_found());
        assert!(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::obligation::allowed_borrow_value_usd<T0>(arg3) == 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::from(0), 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_position_balance_not_zero());
        assert!(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::obligation::deposited_value_usd<T0>(arg3) == 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::from(0), 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_position_balance_not_zero());
        ...
        let v8 = ClosePositionEvent{
            position_id : v0,
            market_id   : 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::market_id(arg1),
            owner       : v6,
            timestamp   : 0x2::clock::timestamp_ms(arg4),
        };
        ...
        0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::remove_position_info(arg1, v0);
    }

    public fun deposit<T0, T1>(arg0: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg1: &mut 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::Market, arg2: &mut Position<T0>, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::into_balance<T1>(arg3);
        0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::join_fee<T1>(arg1, 0x2::balance::split<T1>(&mut v0, calculate_fee(0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::open_fee_rate(arg1), 1000000, 0x2::coin::value<T1>(&arg3))), is_long<T0>(arg2));
    ...
    public fun open_position<T0, T1>(arg0: &0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::GlobalConfig, arg1: &mut 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::Market, arg2: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : Position<T0> {
        0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::assert_package_version(arg0);
        0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::assert_global_open_not_paused(arg0);
        0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::assert_open_not_paused(arg1);
        0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::assert_leverage_valid(arg1, arg4, true);
        let v0 = 0x1::type_name::get<T1>();
        let v1 = 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::base_token(arg1);
        let v2 = 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::quote_token(arg1);
        assert!(v0 == v1 || v0 == v2, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_deposit_type());
    ...
    public fun withdraw_not_sui<T0, T1>(arg0: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg1: &mut 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::Market, arg2: &Position<T0>, arg3: 0x1::option::Option<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::RateLimiterExemption<T0, T1>>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::join_fee<T1>(arg1, 0x2::balance::split<T1>(&mut v1, calculate_fee(0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::close_fee_rate(arg1), 1000000, 0x2::coin::value<T1>(&v0))), is_long<T0>(arg2));
    ...
    public fun withdraw_sui<T0>(arg0: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg1: &mut 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::Market, arg2: &Position<T0>, arg3: 0x1::option::Option<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::RateLimiterExemption<T0, 0x2::sui::SUI>>, arg4: u64, arg5: u64, arg6: &mut 0x3::sui_system::SuiSystemState, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::join_fee<0x2::sui::SUI>(arg1, 0x2::balance::split<0x2::sui::SUI>(&mut v2, calculate_fee(0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market::close_fee_rate(arg1), 1000000, 0x2::coin::value<0x2::sui::SUI>(&v1))), is_long<T0>(arg2));
