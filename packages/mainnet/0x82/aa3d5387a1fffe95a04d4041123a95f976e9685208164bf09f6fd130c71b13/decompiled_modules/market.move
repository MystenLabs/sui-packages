module 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::market {
    ...
    public(friend) fun add_position_info(arg0: &mut Market, arg1: PositionInfo) {
        if (0x2::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1.position_id)) {
            abort 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_position_already_exists()
        };
    ...
    public(friend) fun assert_close_not_paused(arg0: &Market) {
        assert!(!arg0.is_close_pause, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_market_close_paused());
    }

    public(friend) fun assert_leverage_valid(arg0: &Market, arg1: u64, arg2: bool) {
        if (arg2) {
            assert!(arg1 >= 1 && arg1 <= arg0.max_long_leverage, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_leverage_too_high());
        } else {
            assert!(arg1 >= 1 && arg1 <= arg0.max_short_leverage, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_leverage_too_high());
        };
    }

    public(friend) fun assert_open_not_paused(arg0: &Market) {
        assert!(!arg0.is_open_pause, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_market_open_paused());
    }
    ...
    public fun claim_fees<T0, T1>(arg0: &0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::AdminCap, arg1: &mut Market, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
    ...
    public fun create_Market<T0, T1>(arg0: &0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::AdminCap, arg1: &0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::GlobalConfig, arg2: &mut Markets, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::assert_package_version(arg1);
        assert!(arg5 <= 100000, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_fee_rate());
        assert!(arg6 <= 100000, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_fee_rate());
        assert!(arg3 > 0, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_leverage_equal_to_zero());
        assert!(arg4 > 0, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_leverage_equal_to_zero());
        assert!(arg3 <= 500000, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_leverage_too_high());
        assert!(arg4 <= 500000, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_leverage_too_high());
        ...
        if (0x2::table::contains<0x2::object::ID, MarketSimpleInfo>(&arg2.list, v5)) {
            abort 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_market_already_exists()
        };
    ...
    public fun set_fee_rate(arg0: &0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::AdminCap, arg1: &mut Market, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(arg2 <= 100000, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_fee_rate());
        assert!(arg3 <= 100000, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_fee_rate());
    ...
    public fun set_market_close_pause(arg0: &0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::AdminCap, arg1: &mut Market, arg2: bool, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun set_market_open_pause(arg0: &0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::AdminCap, arg1: &mut Market, arg2: bool, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun set_max_leverage(arg0: &0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::config::AdminCap, arg1: &mut Market, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(arg2 > 0, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_leverage_equal_to_zero());
        assert!(arg3 > 0, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_leverage_equal_to_zero());
        assert!(arg2 <= 500000, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_leverage_too_high());
        assert!(arg3 <= 500000, 0x82aa3d5387a1fffe95a04d4041123a95f976e9685208164bf09f6fd130c71b13::errors::err_invalid_leverage_too_high());
