module 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::akasui {
    ...
    public entry fun add_liquidity<T0, T1>(arg0: &mut Configuration, arg1: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 == v0.creator_address || 0x1::vector::contains<address>(&arg0.operators, &v1), 111);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v0.real_raise_coin_reserves, 0x2::coin::value<T1>(&v0.real_raise_coin_reserves) * arg0.graduated_fee / 10000, arg3), arg0.admin);
        let v3 = 0x2::coin::value<T1>(&v0.real_raise_coin_reserves);
        0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::router::add_liquidity<T0, T1>(0x2::coin::value<T0>(&v2), v2, v3, 0x2::coin::split<T1>(&mut v0.real_raise_coin_reserves, v3, arg3), 0, 0, arg1, arg3);
        let v4 = AddedLiquidityToDexEvent{
        ...
        0x2::event::emit<AddedLiquidityToDexEvent>(v4);
    }
    ...
    public entry fun buy<T0, T1>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v10, 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::as_u64(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::div(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::mul(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(0x2::coin::value<T0>(&v10)), 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(arg0.platform_fee)), 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(10000))), arg3), arg0.admin);
    ...
    fun buy_direct<T0, T1>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T1>, arg2: &mut Pool<T0, T1>, arg3: u64, arg4: address, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let (v6, v7) = swap<T0, T1>(arg2, v5, arg1, v4, 0, arg7);
        let v8 = v6;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v8, 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::as_u64(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::div(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::mul(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(0x2::coin::value<T0>(&v8)), 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(arg3)), 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(10000))), arg7), arg4);
        arg2.virtual_token_reserves = arg2.virtual_token_reserves - 0x2::coin::value<T0>(&v8);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v7, arg0.admin);
    ...
    public entry fun buy_v2<T0, T1>(arg0: &mut Configuration, arg1: &mut ThresholdConfig, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v4.virtual_token_reserves - 0x2::coin::value<T0>(&v4.remain_token_reserves);
        let v6 = 0x2::math::min(v3, v5);
        let v7 = 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::curves::calculate_add_liquidity_cost(v4.virtual_raise_coin_reserves, v4.virtual_token_reserves, v6 * 999 / 1000) + 1;
        assert!(v1 >= v7, 106);
        let v8 = 0x2::coin::zero<T0>(arg4);
        let (v9, v10) = swap<T0, T1>(v4, v8, arg2, v6, v1 - v7, arg4);
        let v11 = v9;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v11, 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::as_u64(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::div(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::mul(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(0x2::coin::value<T0>(&v11)), 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(arg0.platform_fee)), 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(10000))), arg4), arg0.admin);
        v4.virtual_token_reserves = v4.virtual_token_reserves - 0x2::coin::value<T0>(&v11);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v10, arg0.admin);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v11, v0);
        if (v5 == v6 || 0x2::coin::value<T1>(&v4.real_raise_coin_reserves) >= arg1.threshold) {
            v4.is_completed = true;
            let v12 = PoolCompletedEvent{
                token_address      : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
                lp                 : 0x1::ascii::string(b"0x0"),
        ...
        let v13 = TradedEvent{
            ...
            token_address               : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            raise_coin_amount           : v1,
            token_amount                : 0x2::coin::value<T0>(&v11),
            virtual_raise_coin_reserves : v4.virtual_raise_coin_reserves,
            virtual_token_reserves      : v4.virtual_token_reserves,
            real_raise_coin_reserves    : 0x2::coin::value<T1>(&v4.real_raise_coin_reserves),
            real_token_reserves         : 0x2::coin::value<T0>(&v4.real_token_reserves),
    ...
    public entry fun create_and_first_buy<T0, T1>(arg0: &mut Configuration, arg1: 0x2::coin::TreasuryCap<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::clock::Clock, arg4: 0x1::ascii::String, arg5: 0x1::ascii::String, arg6: 0x1::ascii::String, arg7: 0x1::ascii::String, arg8: 0x1::ascii::String, arg9: 0x1::ascii::String, arg10: 0x1::ascii::String, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<T1>(&arg2) > 0) {
            ...
            let v5 = arg0.admin;
            let v6 = arg0.graduated_fee;
            let v7 = &mut v1;
            buy_direct<T0, T1>(arg0, arg2, v7, v4, v5, v6, arg3, arg11);
        } else {
    ...
    public entry fun create_threshold_config(arg0: &Configuration, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun estimate_amount_out<T0, T1>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        if (arg1 > 0 && arg2 == 0) {
            let v3 = 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::curves::calculate_token_amount_received(v0.virtual_raise_coin_reserves, v0.virtual_token_reserves, arg1);
            (0, v3 - 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::as_u64(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::div(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::mul(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(v3), 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(arg0.platform_fee)), 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(10000))))
        } else if (arg1 == 0 && arg2 > 0) {
            let v4 = 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::curves::calculate_remove_liquidity_return(v0.virtual_token_reserves, v0.virtual_raise_coin_reserves, arg2);
            (v4 - 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::as_u64(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::div(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::mul(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(v4), 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(arg0.platform_fee)), 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(10000))), 0)
        } else {
            (0, 0)
        }
    }
    ...
    public fun estimate_amount_out_for_buy_direct(arg0: &mut Configuration, arg1: u64, arg2: u64, arg3: u64) : (u64, u64) {
        (0, 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::curves::calculate_token_amount_received(arg2, arg3, arg1))
    }
    ...
    public fun estimate_amount_out_without_fee<T0, T1>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        let v0 = 0x2::dynamic_object_field::borrow<0x1::ascii::String, Pool<T0, T1>>(&arg0.id, generate_pool_name<T0, T1>());
        if (arg1 > 0 && arg2 == 0) {
            (0, 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::curves::calculate_token_amount_received(v0.virtual_raise_coin_reserves, v0.virtual_token_reserves, arg1))
        } else if (arg1 == 0 && arg2 > 0) {
            (0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::curves::calculate_remove_liquidity_return(v0.virtual_token_reserves, v0.virtual_raise_coin_reserves, arg2), 0)
        } else {
            (0, 0)
        }
    }
    ...
    public fun get_threshold(arg0: &ThresholdConfig) : u64 {
        arg0.threshold
    }
    ...
    public entry fun sell<T0, T1>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 > 0, 102);
        let v3 = 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_raise_coin_reserves, v2);
        let v4 = 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::as_u64(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::div(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::mul(0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(v3), 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(arg0.platform_fee)), 0x82d355be7a13eb8df60670b21bed6694de6817a29048d8288a8b3c2a4bf09d02::utils::from_u64(10000)));
        assert!(v3 - v4 >= arg2, 2);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v8, v4, arg4), arg0.admin);
    ...
    public entry fun update_config(arg0: &mut Configuration, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u8, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg8), 101);
        arg0.platform_fee = arg1;
        arg0.graduated_fee = arg2;
        arg0.initial_virtual_raise_coin_reserves = arg3;
        ...
        let v0 = ConfigChangedEvent{
            ...
            new_initial_virtual_raise_coin_reserves : arg3,
    ...
    public entry fun update_threshold_config(arg0: &Configuration, arg1: &mut ThresholdConfig, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
