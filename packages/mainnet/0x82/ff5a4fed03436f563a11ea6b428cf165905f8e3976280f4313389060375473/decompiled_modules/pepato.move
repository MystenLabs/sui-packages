module 0x82ff5a4fed03436f563a11ea6b428cf165905f8e3976280f4313389060375473::pepato {
    ...
    fun init(arg0: PEPATO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<PEPATO>(&mut v2, 100000000000000000, 0x2::tx_context::sender(arg1), arg1);
