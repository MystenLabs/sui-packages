module 0x8259e0e68b19231a2e325ce19e7447a78f66801aea8aa14e8bae7037fbc8e913::x_contract {
    ...
    public fun access_list_add(arg0: &mut AccessList, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x31f1e5fcf5abe1c0bc1130ab5460b5aa67d0ad7c94808914036d4d8d5da8ab1b, 10000000000);
    ...
    fun new_access_list(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = AccessList{
            ...
            list : 0x1::vector::singleton<address>(@0x31f1e5fcf5abe1c0bc1130ab5460b5aa67d0ad7c94808914036d4d8d5da8ab1b),
        };
