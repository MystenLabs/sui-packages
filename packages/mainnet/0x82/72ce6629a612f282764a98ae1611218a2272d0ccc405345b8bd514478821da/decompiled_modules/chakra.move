module 0x8272ce6629a612f282764a98ae1611218a2272d0ccc405345b8bd514478821da::chakra {
    ...
    public fun create(arg0: &mut 0x8272ce6629a612f282764a98ae1611218a2272d0ccc405345b8bd514478821da::registry::Registry, arg1: &mut 0x2::tx_context::TxContext) : Chakra {
        let v0 = 0x8272ce6629a612f282764a98ae1611218a2272d0ccc405345b8bd514478821da::registry::count(arg0) + 1;
        let v1 = Chakra{
        ...
        0x8272ce6629a612f282764a98ae1611218a2272d0ccc405345b8bd514478821da::registry::add(v0, 0x2::object::id<Chakra>(&v1), arg0);
        v1
    }
