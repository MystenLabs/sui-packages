module 0x824033fa59472db93642f4cdb42b679779e2bdd1c18e4c968a7b6a1d1fab05cd::honey_oracle {
    struct HoneyOracle has store, key {
        id: 0x2::object::UID,
        nectar_cap: 0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::honey_yield::NectarCap,
    ...
    public fun admin_update_emission_rate(arg0: &0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::honey_yield::HoneyYieldAdminCap, arg1: &mut HoneyOracle, arg2: &mut 0xa10d6f7dab4d1c83c5f17a5d23394c2a83b40ff6a6bdf244d591d0ef01c54028::honey_manager::HoneyManager, arg3: &0x2::clock::Clock, arg4: u64) {
        assert!(arg1.module_version == 1, 1975);
        assert!(arg4 > 0, 1980);
        arg1.emission_state.current_emission_rate = arg4;
        0xa10d6f7dab4d1c83c5f17a5d23394c2a83b40ff6a6bdf244d591d0ef01c54028::honey_manager::update_distribution_rate_via_nectar(&arg1.nectar_cap, arg2, arg3, arg1.emission_state.current_emission_rate);
    ...
    fun calculate_twap(arg0: u256, arg1: u256, arg2: u64) : u256 {
        let v0 = if (arg0 >= arg1) {
            ...
            0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::overflow_add_u256(arg0, 0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::sub_from_max_u256(arg1))
        };
        if (v0 == 0) {
            return 0
        };
        0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div_u256(v0 / (arg2 as u256), (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::pow_10(6) as u256), (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::pow_10(9) as u256))
    }
    ...
    public fun setup_honey_oracle(arg0: &0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::honey_yield::HoneyYieldAdminCap, arg1: 0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::honey_yield::NectarCap, arg2: &mut 0xa10d6f7dab4d1c83c5f17a5d23394c2a83b40ff6a6bdf244d591d0ef01c54028::honey_manager::HoneyManager, arg3: &0x2::clock::Clock, arg4: address, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg5 > 0, 1980);
        ...
        0xa10d6f7dab4d1c83c5f17a5d23394c2a83b40ff6a6bdf244d591d0ef01c54028::honey_manager::update_distribution_rate_via_nectar(&v3.nectar_cap, arg2, arg3, v3.emission_state.current_emission_rate);
    ...
    public fun trigger_epoch_update_if_due(arg0: &mut HoneyOracle, arg1: &mut 0xa10d6f7dab4d1c83c5f17a5d23394c2a83b40ff6a6bdf244d591d0ef01c54028::honey_manager::HoneyManager, arg2: &0x2::clock::Clock) {
        assert!(arg0.module_version == 1, 1975);
    ...
    fun update_emission_distribution(arg0: &mut HoneyOracle, arg1: &mut 0xa10d6f7dab4d1c83c5f17a5d23394c2a83b40ff6a6bdf244d591d0ef01c54028::honey_manager::HoneyManager, arg2: &0x2::clock::Clock, arg3: u256, arg4: u64) {
        ...
        let v4 = if (arg3 >= arg0.emission_state.anchor_price) {
            (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div_u128(((arg3 - arg0.emission_state.anchor_price) as u128), (10000 as u128), (arg0.emission_state.anchor_price as u128)) as u64)
        } else {
            (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div_u128(((arg0.emission_state.anchor_price - arg3) as u128), (10000 as u128), (arg0.emission_state.anchor_price as u128)) as u64)
        };
        ...
        let v7 = if (arg3 >= v6) {
            (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div_u128(((arg3 - v6) as u128), (10000 as u128), (v6 as u128)) as u64)
        } else {
            (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div_u128(((v6 - arg3) as u128), (10000 as u128), (v6 as u128)) as u64)
        };
        let v8 = 3;
        if (arg3 < v6 && v7 >= v0) {
            ...
            arg0.emission_state.current_emission_rate = (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div_u128((arg0.emission_state.current_emission_rate as u128), ((10000 - v10) as u128), (10000 as u128)) as u64);
            ...
            if (arg0.emission_state.consec_up_epochs >= arg0.emission_config.raise_confirm_epochs) {
                if (arg0.emission_state.weekly_raises_sum + v2 <= arg0.emission_config.max_weekly_raise_bps) {
                    arg0.emission_state.current_emission_rate = (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div_u128((arg0.emission_state.current_emission_rate as u128), ((10000 + v2) as u128), (10000 as u128)) as u64);
        ...
        arg0.emission_state.last_price = arg3;
        arg0.emission_state.last_epoch_update = arg4;
        0xa10d6f7dab4d1c83c5f17a5d23394c2a83b40ff6a6bdf244d591d0ef01c54028::honey_manager::update_distribution_rate_via_nectar(&arg0.nectar_cap, arg1, arg2, arg0.emission_state.current_emission_rate);
    ...
    public fun update_honey_oracle(arg0: &0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::honey_yield::HoneyYieldAdminCap, arg1: &mut HoneyOracle, arg2: 0x1::option::Option<address>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 1, 1975);
    ...
    public fun update_honey_oracle_price<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &mut HoneyOracle, arg2: &mut 0xa10d6f7dab4d1c83c5f17a5d23394c2a83b40ff6a6bdf244d591d0ef01c54028::honey_manager::HoneyManager, arg3: &0xa10d6f7dab4d1c83c5f17a5d23394c2a83b40ff6a6bdf244d591d0ef01c54028::two_pool::LiquidityPool<T0, T1, T2>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0xa10d6f7dab4d1c83c5f17a5d23394c2a83b40ff6a6bdf244d591d0ef01c54028::two_pool::get_liquidity_pool_id<T0, T1, T2>(arg3);
        assert!(0x2::object::id_to_address(&v2) == *0x1::option::borrow<address>(&arg1.sui_honey_pool_addr), 1974);
        let (_, v4, v5) = 0xa10d6f7dab4d1c83c5f17a5d23394c2a83b40ff6a6bdf244d591d0ef01c54028::two_pool::get_pool_cumulative_prices<T0, T1, T2>(arg3);
