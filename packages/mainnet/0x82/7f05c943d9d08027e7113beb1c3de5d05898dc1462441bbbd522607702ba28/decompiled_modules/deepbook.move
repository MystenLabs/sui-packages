module 0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::deepbook {
    ...
    public(friend) fun quote<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: u64, arg2: bool, arg3: bool, arg4: u64, arg5: &0x2::clock::Clock) : (u64, u64) {
        ...
        let v6 = 0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::checked_sum(0x1::u64::max(v0, v3), arg4);
        let v7 = if (arg3) {
            arg1
        } else {
            0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::floor_mul_div(arg1, 1000000000 + 0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::floor_mul_div(v0, 5, 4), 1000000000 + 0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::ceil_mul_div(v6, 5, 4))
        };
        if (v7 == 0) {
            return (0, 0)
        };
        ...
        (v22, 0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::ceil_mul_div(0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::ceil_mul_div(v26, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::deep_price::deep_per_asset(&v25), 1000000000), v6, 1000000000))
    }
    ...
    public(friend) fun rate_bound<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>) : u64 {
        let (v0, _, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_trade_params<T0, T1>(arg0);
        let (v3, _, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_trade_params_next<T0, T1>(arg0);
        0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::checked_sum(0x1::u64::max(v0, v3), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::max_additional_taker_fee())
    }
    ...
    public(friend) fun value_deep(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        ...
        while (v12 > 0 && v14 < 0x1::vector::length<u64>(&v6)) {
            ...
            v13 = 0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::checked_sum(v13, 0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::ceil_mul_div(v15, *0x1::vector::borrow<u64>(&v6, v14), 1000000000));
            v12 = v12 - v15;
            v14 = v14 + 1;
        };
        assert!(v12 == 0, 1);
        let v16 = 0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::checked_sum(v13, 0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::ceil_mul_div(0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::ceil_mul_div(v13, 5, 4), rate_bound<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP, 0x2::sui::SUI>(arg0), 1000000000));
        0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::checked_sum(v16, 0x827f05c943d9d08027e7113beb1c3de5d05898dc1462441bbbd522607702ba28::search::ceil_mul_div(v16, arg2, 10000))
    }
