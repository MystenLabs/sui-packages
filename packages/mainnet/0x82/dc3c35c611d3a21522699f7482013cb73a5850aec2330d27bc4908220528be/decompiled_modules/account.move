module 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::account {
    ...
    public(friend) fun create_child_account_cap(arg0: &AccountCap, arg1: &mut 0x2::tx_context::TxContext) : AccountCap {
        let v0 = arg0.owner;
        assert!(0x2::object::uid_to_address(&arg0.id) == v0, 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::error::required_parent_account_cap());
        AccountCap{
