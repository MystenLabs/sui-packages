module 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::pool {
    ...
    public(friend) fun deposit_treasury<T0>(arg0: &mut Pool<T0>, arg1: u64) {
        assert!(0x2::balance::value<T0>(&arg0.balance) >= arg1, 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::error::insufficient_balance());
    ...
    public fun withdraw_treasury<T0>(arg0: &mut PoolAdminCap, arg1: &mut Pool<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T0>(&arg1.treasury_balance) >= arg2, 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::error::insufficient_balance());
