module 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::incentive_v2 {
    ...
    public fun add_funds<T0>(arg0: &OwnerCap, arg1: &mut IncentiveFundsPool<T0>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = IncreasedFunds{
            ...
            balance_after  : 0x2::balance::join<T0>(&mut arg1.balance, 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::utils::split_coin_to_balance<T0>(arg2, arg3, arg4)),
        };
        0x2::event::emit<IncreasedFunds>(v0);
    }

    fun base_claim_reward<T0>(arg0: &0x2::clock::Clock, arg1: &mut Incentive, arg2: &mut IncentiveFundsPool<T0>, arg3: &mut 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::storage::Storage, arg4: u8, arg5: u8, arg6: address) : 0x2::balance::Balance<T0> {
        ...
        while (v1 > 0) {
            ...
            let v7 = (((v5 - v6) / 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::ray_math::ray()) as u64);
            let v8 = v7;
    ...
    fun calculate_one(arg0: &IncentivePool, arg1: u64, arg2: u256, arg3: address, arg4: u256) : (u256, u256) {
        ...
        if (v1 < v3) {
            let v6 = 0;
            if (arg2 > 0) {
                v6 = 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::safe_math::mul(calculate_release_rate(arg0), ((v3 - v1) as u256)) / arg2;
            };
            v5 = v4 + v6;
        };
        let v7 = 0;
    ...
    public fun calculate_release_rate(arg0: &IncentivePool) : u256 {
        0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::ray_math::ray_div((arg0.total_supply as u256), ((arg0.end_at - arg0.start_at) as u256))
    }

    public fun calculate_user_effective_amount(arg0: u8, arg1: u256, arg2: u256, arg3: u256) : u256 {
        let v0 = arg1;
        if (arg0 == 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::constants::option_type_borrow()) {
            arg1 = arg2;
            arg2 = v0;
        };
        let v1 = 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::ray_math::ray_mul(arg3, arg2);
        if (arg1 > v1) {
            return arg1 - v1
        };
        0
    ...
    public entry fun claim_reward<T0>(arg0: &0x2::clock::Clock, arg1: &mut Incentive, arg2: &mut IncentiveFundsPool<T0>, arg3: &mut 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::storage::Storage, arg4: u8, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun claim_reward_non_entry<T0>(arg0: &0x2::clock::Clock, arg1: &mut Incentive, arg2: &mut IncentiveFundsPool<T0>, arg3: &mut 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::storage::Storage, arg4: u8, arg5: u8, arg6: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        base_claim_reward<T0>(arg0, arg1, arg2, arg3, arg4, arg5, 0x2::tx_context::sender(arg6))
    }

    public fun claim_reward_with_account_cap<T0>(arg0: &0x2::clock::Clock, arg1: &mut Incentive, arg2: &mut IncentiveFundsPool<T0>, arg3: &mut 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::storage::Storage, arg4: u8, arg5: u8, arg6: &0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::account::AccountCap) : 0x2::balance::Balance<T0> {
        base_claim_reward<T0>(arg0, arg1, arg2, arg3, arg4, arg5, 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::account::account_owner(arg6))
    }

    public fun create_and_transfer_owner(arg0: &0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::storage::OwnerCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_incentive_pool<T0>(arg0: &OwnerCap, arg1: &mut Incentive, arg2: &IncentiveFundsPool<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u8, arg9: u8, arg10: u256, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(arg4 < arg5, 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::error::invalid_duration_time());
        assert!(arg6 == 0 || arg6 > arg5, 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::error::invalid_duration_time());
    ...
    public fun option_borrow() : u8 {
        0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::constants::option_type_borrow()
    }

    public fun option_repay() : u8 {
        0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::constants::option_type_repay()
    }

    public fun option_supply() : u8 {
        0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::constants::option_type_supply()
    }

    public fun option_withdraw() : u8 {
        0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::constants::option_type_withdraw()
    }
    ...
    public fun repay_with_account_cap<T0>(arg0: &0x2::clock::Clock, arg1: &0x3a58e14973fc7bd17e5c477da8dcf56ea22d287447817591280093f2f2f23e04::oracle::PriceOracle, arg2: &mut 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::storage::Storage, arg3: &mut 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::pool::Pool<T0>, arg4: u8, arg5: 0x2::coin::Coin<T0>, arg6: &mut Incentive, arg7: &0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::account::AccountCap) : 0x2::balance::Balance<T0> {
        abort 0
    }

    fun update_reward(arg0: &0x2::clock::Clock, arg1: &mut Incentive, arg2: &mut 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::storage::Storage, arg3: u8, arg4: u8, arg5: address) {
        version_verification(arg1);
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (_, _, v3) = get_pool_from_asset_and_option(arg1, arg3, arg4);
        let v4 = v3;
        let v5 = 0x1::vector::length<address>(&v4);
        let (v6, v7) = 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::storage::get_user_balance(arg2, arg3, arg5);
        let (v8, v9) = 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::storage::get_total_supply(arg2, arg3);
        let v10 = v8;
        if (arg4 == 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::constants::option_type_borrow()) {
            v10 = v9;
        };
        while (v5 > 0) {
    ...
    public(friend) fun update_reward_all(arg0: &0x2::clock::Clock, arg1: &mut Incentive, arg2: &mut 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::storage::Storage, arg3: u8, arg4: address) {
        update_reward(arg0, arg1, arg2, arg3, 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::constants::option_type_supply(), arg4);
        update_reward(arg0, arg1, arg2, arg3, 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::constants::option_type_withdraw(), arg4);
        update_reward(arg0, arg1, arg2, arg3, 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::constants::option_type_repay(), arg4);
        update_reward(arg0, arg1, arg2, arg3, 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::constants::option_type_borrow(), arg4);
    }
    ...
    public fun withdraw_funds<T0>(arg0: &OwnerCap, arg1: &mut IncentiveFundsPool<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T0>(&arg1.balance) >= arg2, 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::error::insufficient_balance());
    ...
    public fun withdraw_with_account_cap<T0>(arg0: &0x2::clock::Clock, arg1: &0x3a58e14973fc7bd17e5c477da8dcf56ea22d287447817591280093f2f2f23e04::oracle::PriceOracle, arg2: &mut 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::storage::Storage, arg3: &mut 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::pool::Pool<T0>, arg4: u8, arg5: u64, arg6: &mut 0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::incentive::Incentive, arg7: &mut Incentive, arg8: &0x82dc3c35c611d3a21522699f7482013cb73a5850aec2330d27bc4908220528be::account::AccountCap) : 0x2::balance::Balance<T0> {
        abort 0
    }
