module 0x82d0fb3ce438a27c26579db342678861dd8a3c73ace3b9ba81335da2513033d8::utils {
    public fun get_description_nft() : vector<u8> {
        b"WEB 3.0 TOOLS HUB ON SUI NETWORK !!!"
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://suigrinders.nyc3.digitaloceanspaces.com/images/"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://suigrinders.nyc3.digitaloceanspaces.com/metadata/"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/suigrinders"
    }
