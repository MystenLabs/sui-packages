module 0x827f92392c08e8107f3eb17bd066130b0240598e3a960b23436217a97f97ffa2::typus_momentum {
    ...
    public fun swap<T0, T1, T2, T3>(arg0: &mut 0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg2: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T3>, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T3>) {
        ...
        let (v2, v3) = if (0x1::type_name::get<T0>() == 0x1::type_name::get<T1>()) {
            ...
            if (0x2::balance::value<T2>(&v7) < arg5) {
                let (v8, v9) = swap_<T1, T2>(arg1, arg2, v5, 0x2::balance::zero<T2>(), true, false, arg5 - 0x2::balance::value<T2>(&v7), arg6, arg7, arg8);
                0x2::balance::join<T2>(&mut v7, v9);
                (v8, v7)
            } else {
                let v10 = v5;
                let (v11, v12) = swap_<T1, T2>(arg1, arg2, 0x2::balance::zero<T1>(), v7, false, true, 0x2::balance::value<T2>(&v7), arg6, arg7, arg8);
                let v13 = v12;
            ...
            if (0x2::balance::value<T1>(&v17) < arg5) {
                let (v18, v19) = swap_<T1, T2>(arg1, arg2, 0x2::balance::zero<T1>(), v16, false, false, arg5 - 0x2::balance::value<T1>(&v17), arg6, arg7, arg8);
                0x2::balance::join<T1>(&mut v17, v18);
                (v17, v19)
            } else {
                let v20 = v16;
                let (v21, v22) = swap_<T1, T2>(arg1, arg2, v17, 0x2::balance::zero<T2>(), true, true, 0x2::balance::value<T1>(&v17), arg6, arg7, arg8);
                let v23 = v21;
    ...
    public fun calculate_combined_swap_result<T0, T1, T2, T3>(arg0: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>, arg1: &0x2::balance::Balance<T0>, arg2: &0x2::balance::Balance<T3>, arg3: u128) : u64 {
        let v0 = 0x1::type_name::get<T0>() == 0x1::type_name::get<T1>();
        let v1 = if (v0) {
            0x2::balance::value<T0>(arg1)
        } else {
            0x2::balance::value<T3>(arg2)
        };
        let v2 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::compute_swap_result<T1, T2>(arg0, v0, true, arg3, v1);
        if (v0) {
            0x2::balance::value<T3>(arg2) + 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::get_state_amount_calculated(&v2)
        } else {
            0x2::balance::value<T0>(arg1) + 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::get_state_amount_calculated(&v2)
        }
    }
