module 0x8201e51fb5ac701dd57e8a45b03ccd6b2a188dfb3739c88292a6a0122d1ffad8::suispark_contract {
    ...
    struct Platform has store, key {
        ...
        token_reserve: 0x2::balance::Balance<0x8201e51fb5ac701dd57e8a45b03ccd6b2a188dfb3739c88292a6a0122d1ffad8::suispark_token::SUISPARK_TOKEN>,
    ...
    public fun create_event(arg0: &AdminCap, arg1: &mut Platform, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: &mut 0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Platform{
            ...
            token_reserve        : 0x2::balance::zero<0x8201e51fb5ac701dd57e8a45b03ccd6b2a188dfb3739c88292a6a0122d1ffad8::suispark_token::SUISPARK_TOKEN>(),
    ...
    public fun reward_winner(arg0: &mut 0x8201e51fb5ac701dd57e8a45b03ccd6b2a188dfb3739c88292a6a0122d1ffad8::suispark_token::TreasuryCapHolder, arg1: &mut Platform, arg2: address, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        0x8201e51fb5ac701dd57e8a45b03ccd6b2a188dfb3739c88292a6a0122d1ffad8::suispark_token::reward_user(arg0, arg4, 0x2::tx_context::sender(arg5), arg5);
    ...
    public fun submit_project_with_loyalty_tokens(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: 0x1::string::String, arg3: 0x2::coin::Coin<0x8201e51fb5ac701dd57e8a45b03ccd6b2a188dfb3739c88292a6a0122d1ffad8::suispark_token::SUISPARK_TOKEN>, arg4: bool, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x8201e51fb5ac701dd57e8a45b03ccd6b2a188dfb3739c88292a6a0122d1ffad8::suispark_token::SUISPARK_TOKEN>(&arg3) == (200 as u64), 0);
        let v0 = Project{
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x8201e51fb5ac701dd57e8a45b03ccd6b2a188dfb3739c88292a6a0122d1ffad8::suispark_token::SUISPARK_TOKEN>>(arg3, @0xb19ea168be3908ceb7e98753833d54f76a431337f16de4fa5b9b24429e164c5);
    }
    ...
    public fun vote_for_project(arg0: &0x8201e51fb5ac701dd57e8a45b03ccd6b2a188dfb3739c88292a6a0122d1ffad8::suispark_nft::NFT, arg1: &mut 0x8201e51fb5ac701dd57e8a45b03ccd6b2a188dfb3739c88292a6a0122d1ffad8::suispark_token::TreasuryCapHolder, arg2: &mut Platform, arg3: &Project, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<Project>(arg3);
        let v1 = 0x1::string::utf8(0x2::object::id_to_bytes(&v0));
        let v2 = 0x2::object::id<0x8201e51fb5ac701dd57e8a45b03ccd6b2a188dfb3739c88292a6a0122d1ffad8::suispark_nft::NFT>(arg0);
        ...
        *v4 = *v4 + 1;
        *v3 = *v3 + 1;
        0x8201e51fb5ac701dd57e8a45b03ccd6b2a188dfb3739c88292a6a0122d1ffad8::suispark_token::reward_user(arg1, 10, 0x2::tx_context::sender(arg4), arg4);
    }
