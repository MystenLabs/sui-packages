module 0x82a26fb60c9f072b786ef195b697833716992e8f78f79d0dc1657b01ae89d8b1::base {
    struct BASE has drop {
        dummy_field: bool,
    }

    public fun create(arg0: &mut 0x2::coin::TreasuryCap<BASE>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<BASE> {
        0x2::coin::mint<BASE>(arg0, arg1, arg2)
    }

    public entry fun create_to(arg0: &mut 0x2::coin::TreasuryCap<BASE>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
