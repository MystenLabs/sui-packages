module 0x82ae637ef18e61ea894da2854256331e2ab8c22c8d7b3b36be88f105760870b4::reward1331 {
    struct REWARD1331 has drop {
        dummy_field: bool,
    }

    struct TICKET_1331 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1331(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1331>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1331>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1331, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1331>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1331>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1331>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1331>>(v5, 0x2::tx_context::sender(arg1));
    }
