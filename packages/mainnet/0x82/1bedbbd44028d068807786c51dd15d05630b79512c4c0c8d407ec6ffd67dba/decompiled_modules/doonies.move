module 0x821bedbbd44028d068807786c51dd15d05630b79512c4c0c8d407ec6ffd67dba::doonies {
    ...
    fun create_nft(arg0: &NFTCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : NFT {
        ...
        let v2 = if (0x2::table::contains<u64, 0x2::url::Url>(&arg0.preset_urls, arg1)) {
            *0x2::table::borrow<u64, 0x2::url::Url>(&arg0.preset_urls, arg1)
            ...
            let v3 = 0x1::string::utf8(b"https://doonies.io/nft/");
    ...
    fun init(arg0: DOONIES, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = NFTCollection{
            ...
            phase_end         : 1800000,
            admin_address     : @0xe3bdd06764678ee1f1684311226cc6644d7f2a26492c4feba25ea381c6876cd1,
        };
        let v2 = 1;
        while (v2 <= 4444) {
    ...
    public entry fun mint_all(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 || v4, 6);
        let v6 = v3 * 5000000000 + v5 * 7000000000;
        assert!(v3 + v5 > 0, 7);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= v6, 8);
        let v7 = 0;
        if (v2 && v3 > 0) {
            while (v7 < v3) {
                let v8 = select_random_id(arg0, arg4, arg7);
                let v9 = create_nft(arg0, v8, arg7);
                arg0.minted = arg0.minted + 1;
                arg0.phase1_minted = arg0.phase1_minted + 1;
                0x2::kiosk::lock<NFT>(arg5, arg6, arg2, v9);
                let v10 = NFTMinted{
                    nft_id   : 0x2::object::id<NFT>(&v9),
                    token_id : v8,
                    minter   : v0,
                    phase    : 1,
                };
        ...
        if (v4 && v5 > 0) {
            let v11 = 0;
            while (v11 < v5) {
                let v12 = select_random_id(arg0, arg4, arg7);
                let v13 = create_nft(arg0, v12, arg7);
                arg0.minted = arg0.minted + 1;
                arg0.phase2_minted = arg0.phase2_minted + 1;
                0x2::kiosk::lock<NFT>(arg5, arg6, arg2, v13);
                let v14 = NFTMinted{
                    nft_id   : 0x2::object::id<NFT>(&v13),
                    token_id : v12,
                    minter   : v0,
                    phase    : 2,
                };
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v6, arg7), arg0.admin_address);
    ...
    public entry fun mint_phase1(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v3, arg8), arg0.admin_address);
        if (0x2::coin::value<0x2::sui::SUI>(&arg1) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, v0);
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(arg1);
    ...
    public entry fun mint_public(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v2, arg8), arg0.admin_address);
        if (0x2::coin::value<0x2::sui::SUI>(&arg1) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, v0);
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(arg1);
