module 0x82ba2735f4587159a9a653a6950c073d96df0a9ebf9b17d91e617f2fe7e6cdbe::reward5845 {
    struct REWARD5845 has drop {
        dummy_field: bool,
    }

    struct TICKET_5845 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5845(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5845>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5845>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5845, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5845>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5845>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5845>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5845>>(v5, 0x2::tx_context::sender(arg1));
    }
