module 0x82bd3e2b599b723d05e3139b0ee02eb67d40238b9326b43dddc410353068bbc7::cases {
    ...
    fun init(arg0: CASES, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CASES>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"cases"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"cases "));
