module 0x8254e70448742a2642bbeb2dac42668a3877bd247a8256b33a588eefe9e95f2d::giftcetus {
    ...
    public entry fun GiftFromCetus(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = CETUS_GIFT_BOX{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftcetuscom_0809/giftcetuscom_0809_1.jpg"),
    ...
    fun init(arg0: GIFTCETUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftcetuscom_0809/giftcetuscom_0809_1.jpg"));
