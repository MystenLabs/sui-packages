module 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::reward {
    ...
    public(friend) fun add_reward<T0>(arg0: &mut RewardManager, arg1: vector<u64>, arg2: u64, arg3: 0x2::balance::Balance<T0>, arg4: &0x2::clock::Clock) {
        ...
        let v1 = if (0x1::vector::is_empty<u64>(&arg1)) {
            ...
            assert!((v2 - 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::constants::reward_period_start_at()) % 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::constants::reward_period() == 0, 13906835119236972557);
            v2
        };
    ...
    public(friend) fun borrow_mut_reward_by_type<T0>(arg0: &mut RewardManager) : &mut Reward {
        ...
        assert!(0x1::option::is_some<u64>(&v0), 13906836046949384197);
    ...
    public fun borrow_reward_by_type<T0>(arg0: &RewardManager) : &Reward {
        let v0 = reward_index<T0>(arg0);
        assert!(0x1::option::is_some<u64>(&v0), 13906836098488991749);
    ...
    fun current_period_end_time(arg0: u64) : u64 {
        assert!(arg0 >= 0x82f60caeceab94d35f00a4de11ef0941577e9e62558d7ce236ef8a62a145e494::constants::reward_period_start_at(), 13906837275311079445);
    ...
    public fun get_index<T0>(arg0: &RewardManager) : u64 {
        let v0 = reward_index<T0>(arg0);
        assert!(0x1::option::is_some<u64>(&v0), 13906836643949838341);
    ...
    public(friend) fun refund_rewards(arg0: &mut RewardManager, arg1: vector<u128>) {
        ...
        while (v0 < 0x1::vector::length<Reward>(&arg0.rewards)) {
            ...
            assert!(v1.reward_refunded + (*0x1::vector::borrow<u128>(&arg1, v0) as u256) < 115792089237316195423570985008687907853269984665640564039457584007913129639935, 13906835849381806099);
    ...
    public(friend) fun rollover_refunds_into_remaining_time(arg0: &mut RewardManager, arg1: vector<u128>, arg2: &0x2::clock::Clock) {
        ...
        while (v0 < 0x1::vector::length<Reward>(&arg0.rewards)) {
            ...
            assert!(340282366920938463463374607431768211455 - v2.current_emission_rate >= v4, 13906835754892001291);
    ...
    public(friend) fun withdraw<T0>(arg0: &mut RewardManager, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.vault, v1), 13906836248813109257);
        let v2 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.vault, v1);
        assert!(0x2::balance::value<T0>(v2) >= arg1, 13906836257403043849);
