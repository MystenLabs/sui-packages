module 0x821c2a3d8ad14f61f590250dea5eecbc449e4987066d0f13ca03bdb57c35e467::cnsnft5721 {
    struct CNSNFT5721 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5721, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6287"));
        let v4 = 0x2::package::claim<CNSNFT5721>(arg0, arg1);
