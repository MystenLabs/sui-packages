module 0x8266191bbc6e8d42395683a80564729b8b9e6666706b53f29eef32a7c2b981a4::my_coin {
    ...
    fun init(arg0: MY_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MY_COIN>(arg0, 2, b"lqptriggerCOIN", b"lqptriggerCOIN", b"learning letsmove by lqptrigger", 0x1::option::none<0x2::url::Url>(), arg1);
