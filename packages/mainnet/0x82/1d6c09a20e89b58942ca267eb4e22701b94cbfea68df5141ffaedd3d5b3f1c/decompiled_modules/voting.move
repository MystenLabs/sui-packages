module 0x821d6c09a20e89b58942ca267eb4e22701b94cbfea68df5141ffaedd3d5b3f1c::voting {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v14 = Project{
            ...
            video_blob_id   : 0x1::string::utf8(b"2-G8l585sbB_JLMCQlhZWysHyM9b5DVqmGdwf_EgiBg"),
            walrus_site_url : 0x2::url::new_unsafe_from_bytes(b""),
            github_url      : 0x2::url::new_unsafe_from_bytes(b"https://github.com/NetSepio/erebrus"),
            votes           : 0,
        };
        let v15 = Project{
            id              : 15,
        ...
        let v16 = 0x1::vector::empty<Project>();
        let v17 = &mut v16;
        0x1::vector::push_back<Project>(v17, v0);
        0x1::vector::push_back<Project>(v17, v1);
        0x1::vector::push_back<Project>(v17, v2);
        0x1::vector::push_back<Project>(v17, v3);
        0x1::vector::push_back<Project>(v17, v4);
        0x1::vector::push_back<Project>(v17, v5);
        0x1::vector::push_back<Project>(v17, v6);
        0x1::vector::push_back<Project>(v17, v7);
        0x1::vector::push_back<Project>(v17, v8);
        0x1::vector::push_back<Project>(v17, v9);
        0x1::vector::push_back<Project>(v17, v10);
        0x1::vector::push_back<Project>(v17, v11);
        0x1::vector::push_back<Project>(v17, v12);
        0x1::vector::push_back<Project>(v17, v13);
        0x1::vector::push_back<Project>(v17, v14);
        0x1::vector::push_back<Project>(v17, v15);
        let v18 = Votes{
        ...
        0x2::transfer::share_object<Votes>(v18);
        let v19 = AdminCap{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<AdminCap>(v19, 0x2::tx_context::sender(arg0));
    }
