module 0x820f85dc5a35c9243f0542f676bd6e652877f228052e36ad6d1d68d81d000a30::alt_bn128 {
    public fun hash_to_g1(arg0: vector<u8>) : (vector<u8>, u8) {
        let v0 = 0;
        while (v0 < 255) {
            0x1::vector::push_back<u8>(&mut arg0, v0);
            let v1 = 0x820f85dc5a35c9243f0542f676bd6e652877f228052e36ad6d1d68d81d000a30::utils::be_bytes_to_u256(0x1::hash::sha2_256(arg0));
            if (v1 < 109441214359196376111232028726286375443481555786489118313445189473226131042915) {
                ...
                if (is_valid_compressed_g1(v2)) {
                    return (0x820f85dc5a35c9243f0542f676bd6e652877f228052e36ad6d1d68d81d000a30::utils::u256_to_be_bytes(v2), v0)
                };
            };
            v0 = v0 + 1;
        };
    ...
    fun is_quadratic_residue_euler(arg0: u256, arg1: u256) : bool {
        ...
        while (v2 > 0) {
            if (v2 & 1 == 1) {
                v1 = 0x820f85dc5a35c9243f0542f676bd6e652877f228052e36ad6d1d68d81d000a30::utils::mul_mod(v1, v0, arg1);
            };
            v2 = v2 >> 1;
            if (v2 > 0) {
                v0 = 0x820f85dc5a35c9243f0542f676bd6e652877f228052e36ad6d1d68d81d000a30::utils::mul_mod(v0, v0, arg1);
            };
        };
        v1 == 1
    }
