module 0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave {
    ...
    fun admit_pcrs_internal<T0>(arg0: &mut EnclaveConfig<T0>, arg1: Pcrs) {
        if (0x1::vector::length<Pcrs>(&arg0.pcrs) == 1 && 0x1::vector::borrow<Pcrs>(&arg0.pcrs, 0) == &arg1) {
            return
        };
        while (0x1::vector::length<Pcrs>(&arg0.pcrs) > 0) {
            0x1::vector::remove<Pcrs>(&mut arg0.pcrs, 0);
        };
    ...
    public fun config_version<T0>(arg0: &Enclave<T0>) : u64 {
        arg0.config_version
    }
    ...
    public fun fleet_key_not_set_error() : u64 {
        9
    }
    ...
    public(friend) fun set_master_seed_blob<T0>(arg0: &mut EnclaveConfig<T0>, arg1: vector<u8>) {
        assert!(0x1::option::is_none<vector<u8>>(&arg0.master_seed_blob), 6);
        0x1::option::fill<vector<u8>>(&mut arg0.master_seed_blob, arg1);
    }

    public(friend) fun set_master_seed_blob_and_enclave_pk<T0>(arg0: &mut EnclaveConfig<T0>, arg1: vector<u8>, arg2: vector<u8>) {
        assert!(0x1::vector::length<u8>(&arg2) == 32, 4);
        if (0x1::option::is_none<vector<u8>>(&arg0.master_seed_blob)) {
            0x1::option::fill<vector<u8>>(&mut arg0.master_seed_blob, arg1);
            0x1::option::fill<vector<u8>>(&mut arg0.enclave_pk, arg2);
            return
        };
        assert!(*0x1::option::borrow<vector<u8>>(&arg0.master_seed_blob) == arg1, 10);
        if (0x1::option::is_none<vector<u8>>(&arg0.enclave_pk)) {
            0x1::option::fill<vector<u8>>(&mut arg0.enclave_pk, arg2);
            return
        };
        assert!(*0x1::option::borrow<vector<u8>>(&arg0.enclave_pk) == arg2, 11);
    }
    ...
    fun to_pcrs(arg0: &0x2::nitro_attestation::NitroAttestationDocument) : Pcrs {
        ...
        let v4 = 0;
        while (v4 < 0x1::vector::length<0x2::nitro_attestation::PCREntry>(v0)) {
            let v5 = 0x1::vector::borrow<0x2::nitro_attestation::PCREntry>(v0, v4);
            let v6 = 0x2::nitro_attestation::index(v5);
            if (v6 == 0) {
                v1 = *0x2::nitro_attestation::value(v5);
            } else if (v6 == 1) {
                v2 = *0x2::nitro_attestation::value(v5);
            } else if (v6 == 2) {
                v3 = *0x2::nitro_attestation::value(v5);
            };
            v4 = v4 + 1;
        };
        Pcrs{
    ...
    fun update_from_attestation_internal<T0>(arg0: &mut EnclaveConfig<T0>, arg1: &mut Enclave<T0>, arg2: 0x2::nitro_attestation::NitroAttestationDocument) {
        admit_pcrs_internal<T0>(arg0, to_pcrs(&arg2));
    ...
    public fun verify_fleet_raw_signature<T0>(arg0: &EnclaveConfig<T0>, arg1: &vector<u8>, arg2: &vector<u8>) : bool {
        if (0x1::option::is_none<vector<u8>>(&arg0.enclave_pk)) {
            return false
        };
        0x2::ed25519::ed25519_verify(arg1, 0x1::option::borrow<vector<u8>>(&arg0.enclave_pk), arg2)
    }
    ...
    public fun verify_signature_fleet<T0, T1: drop>(arg0: &EnclaveConfig<T0>, arg1: u8, arg2: u64, arg3: T1, arg4: &vector<u8>) : bool {
        abort 102
    }

    public fun version<T0>(arg0: &EnclaveConfig<T0>) : u64 {
        arg0.version
    }
