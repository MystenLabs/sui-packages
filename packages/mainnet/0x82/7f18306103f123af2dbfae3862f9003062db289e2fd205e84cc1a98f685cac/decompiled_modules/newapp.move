module 0x827f18306103f123af2dbfae3862f9003062db289e2fd205e84cc1a98f685cac::newapp {
    ...
    fun clac_level_diff(arg0: &mut 0x2::table::Table<address, User>, arg1: address, arg2: u64) {
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 20) {
            let v4 = 0x2::table::borrow_mut<address, User>(arg0, 0x1::option::extract<address>(&mut v0));
            if (v4.level == 0) {
                v0 = v4.inviter;
                v1 = v1 + 1;
                continue
            ...
            if (v4.level > v2) {
                if (v4.underway_power > 0) {
                    v4.balance = v4.balance + arg2 * (get_reward_percentage(v4.level) - 0) / 100;
                };
                v2 = v4.level;
                v3 = v4.inviter;
            };
        ...
        if (0x1::option::is_some<address>(&v0) && 0x1::option::is_some<address>(&v3)) {
            let v5 = 0x2::table::borrow_mut<address, User>(arg0, 0x1::option::extract<address>(&mut v3));
            if (v5.underway_power > 0) {
                v5.balance = v5.balance + arg2 * 2 / 100;
            };
        };
    }
    ...
    public fun get_stake_orders<T0>(arg0: &Contract<T0>, arg1: &mut 0x2::tx_context::TxContext) : vector<StakeOrderTemp> {
        ...
        while (v2 < 0x1::vector::length<StakeOrder>(&v0.stake_orders)) {
            ...
            let v4 = if (v3.status == 0) {
                let v5 = (0x2::tx_context::epoch_timestamp_ms(arg1) - v3.start_time) / 600000;
    ...
    public entry fun purchase<T0, T1>(arg0: &mut Contract<T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u8, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x827f18306103f123af2dbfae3862f9003062db289e2fd205e84cc1a98f685cac::event::purchase_event(v0, arg3, v3, v4, v5);
    }
