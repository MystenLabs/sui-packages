module 0xcbf93776bb5f15a997e4c10025a194f3f87b554ffb856b2a13132e276cd8ecd7::oracle {
    ...
    public fun get_pyth_price_v2(arg0: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg1: &0x2::clock::Clock) : (0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::Price, 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_identifier::PriceIdentifier) {
        ...
        let v2 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_feed::get_price(v1);
        ...
        assert!(v4 > 0, 3);
        assert!(0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_conf(&v2) * 20 <= v4, 1);
        let v5 = 0x2::clock::timestamp_ms(arg1) / 1000;
        let v6 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_timestamp(&v2);
        assert!(v5 <= v6 || v5 - v6 <= 60, 2);
        (v2, 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_feed::get_price_identifier(v1))
    }
