module 0x92ad7e9eb483ba31772e76baf02e8634b5ebffbf58a93367ebf838d8c51fe780::tato_revenue_share {
    ...
    struct BridgeTransfer has copy, drop {
        amount: u64,
        timestamp: u64,
    }
    ...
    public entry fun publish_week(arg0: &0x92ad7e9eb483ba31772e76baf02e8634b5ebffbf58a93367ebf838d8c51fe780::tato_staking::TatoStakingAdminCap, arg1: &mut RevenueDistributor, arg2: u64, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock) {
        check_version(arg1);
        let v0 = 0x2::table::contains<u64, WeekDistribution>(&arg1.weeks, arg2);
        if (v0) {
            let v1 = 0x2::table::borrow<u64, WeekDistribution>(&arg1.weeks, arg2);
            assert!(v1.claimed_amount == 0, 10);
            assert!(v1.claimed_users_count == 0, 10);
            assert!(!v1.swept, 10);
        };
        ...
        if (v0) {
            *0x2::table::borrow_mut<u64, WeekDistribution>(&mut arg1.weeks, arg2) = v2;
        } else {
            0x2::table::add<u64, WeekDistribution>(&mut arg1.weeks, arg2, v2);
        };
        let v3 = WeekPublished{
            week_id              : arg2,
            merkle_root          : arg3,
            total_amount         : arg4,
            total_eligible_users : arg5,
        ...
        0x2::event::emit<WeekPublished>(v3);
    }

    public entry fun send_to_bridge(arg0: &0x92ad7e9eb483ba31772e76baf02e8634b5ebffbf58a93367ebf838d8c51fe780::tato_staking::TatoStakingAdminCap, arg1: &mut RevenueDistributor, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        check_version(arg1);
        assert!(arg2 > 0, 21);
        assert!(0x2::balance::value<0x4deb377c33bfced1ab81cde96918e2538fe78735777150b0064ccf7df5e1c81::tato::TATO>(&arg1.tato_balance) >= arg2, 15);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x4deb377c33bfced1ab81cde96918e2538fe78735777150b0064ccf7df5e1c81::tato::TATO>>(0x2::coin::from_balance<0x4deb377c33bfced1ab81cde96918e2538fe78735777150b0064ccf7df5e1c81::tato::TATO>(0x2::balance::split<0x4deb377c33bfced1ab81cde96918e2538fe78735777150b0064ccf7df5e1c81::tato::TATO>(&mut arg1.tato_balance, arg2), arg4), @0x18d574893220c648166a9ef4bae9c8db9ac0aecb821fa56f3ad47f4c219a2de2);
        let v0 = BridgeTransfer{
            amount    : arg2,
            timestamp : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<BridgeTransfer>(v0);
    }
