module 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::vaults {
    ...
    struct VaultsManager has store, key {
        ...
        acl: 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::ACL,
    }
    ...
    struct VaultStatus has store {
        allow_deposit: bool,
        allow_remove: bool,
        is_exit: bool,
        exited_assets: 0x2::bag::Bag,
    }
    ...
    public fun remove<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::rewarder::RewarderManager, arg3: &0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::config::GlobalConfig, arg4: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::Pool, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: &mut 0x2::coin::Coin<T2>, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        if (0x2::dynamic_field::exists_with_type<vector<u8>, VaultStatus>(&arg1.id, b"exit_state")) {
            assert!(0x2::dynamic_field::borrow<vector<u8>, VaultStatus>(&arg1.id, b"exit_state").allow_remove, 40);
        };
        assert!(arg8 > 0, 5);
        ...
        let v3 = get_share_liquidity_by_amount(arg8, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::info_liquidity(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::borrow_position_info<T0, T1>(arg6, 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::borrow_clmm_position(v2)))), total_token_amount<T2>(arg1));
    ...
    public fun add_role(arg0: &AdminCap, arg1: &mut VaultsManager, arg2: address, arg3: u8) {
        ...
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun remove_member(arg0: &AdminCap, arg1: &mut VaultsManager, arg2: address) {
        checked_package_version(arg1);
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut VaultsManager, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &AdminCap, arg1: &mut VaultsManager, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public fun add_coin_info<T0>(arg0: &VaultsManager, arg1: &mut 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::OracleRegistry, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: &0x2::coin::CoinMetadata<T0>, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_oracle_manager_role(arg0, 0x2::tx_context::sender(arg7));
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::add_coin_info<T0>(arg1, arg2, arg3, arg4, arg5, arg6);
    }

    public fun add_coin_info_use_currency<T0>(arg0: &VaultsManager, arg1: &mut 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::OracleRegistry, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: &0x2::coin_registry::Currency<T0>, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_oracle_manager_role(arg0, 0x2::tx_context::sender(arg7));
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::add_coin_info_use_currency<T0>(arg1, arg2, arg3, arg4, arg5, arg6);
    }

    public fun init_oracle_registry(arg0: &VaultsManager, arg1: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_oracle_manager_role(arg0, 0x2::tx_context::sender(arg1));
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::init_oracle_registry(arg1);
    }

    public fun remove_coin_info<T0>(arg0: &VaultsManager, arg1: &mut 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::OracleRegistry, arg2: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_oracle_manager_role(arg0, 0x2::tx_context::sender(arg2));
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::remove_coin_info<T0>(arg1);
    }

    public fun update_coin_slippage<T0>(arg0: &VaultsManager, arg1: &mut 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::OracleRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_oracle_manager_role(arg0, 0x2::tx_context::sender(arg3));
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::update_coin_slippage<T0>(arg1, arg2);
    }

    public fun update_price<T0>(arg0: &VaultsManager, arg1: &mut 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::OracleRegistry, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::update_price<T0>(arg1, arg2, arg3);
    }

    public fun update_price_age<T0>(arg0: &VaultsManager, arg1: &mut 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::OracleRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_oracle_manager_role(arg0, 0x2::tx_context::sender(arg3));
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::update_price_age<T0>(arg1, arg2);
    }
    ...
    fun calculate_updated_quota<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: 0x1::type_name::TypeName, arg2: u128, arg3: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg4: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32) : u128 {
        ...
        let (v1, v2) = 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::utils::get_amount_by_liquidity(arg3, arg4, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_tick_index<T0, T1>(arg0), v0, arg2, true);
    ...
    public fun check_emergency_pause_role(arg0: &VaultsManager, arg1: address) {
        assert!(0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::has_role(&arg0.acl, arg1, 4), 32);
    }
    ...
    public fun check_operation_role(arg0: &VaultsManager, arg1: address) {
        assert!(0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::has_role(&arg0.acl, arg1, 1) || 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::has_role(&arg0.acl, arg1, 2), 12);
    }

    public fun check_oracle_manager_role(arg0: &VaultsManager, arg1: address) {
        assert!(0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::has_role(&arg0.acl, arg1, 5), 13);
    }

    public fun check_pool_manager_role(arg0: &VaultsManager, arg1: address) {
        assert!(0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::has_role(&arg0.acl, arg1, 3), 13);
    }

    public fun check_protocol_fee_claim_role(arg0: &VaultsManager, arg1: address) {
        assert!(0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::has_role(&arg0.acl, arg1, 0), 11);
    }

    public fun check_rebalance_role(arg0: &VaultsManager, arg1: address) {
        assert!(0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::has_role(&arg0.acl, arg1, 2), 12);
    }

    public fun check_reinvest_role(arg0: &VaultsManager, arg1: address) {
        assert!(0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::has_role(&arg0.acl, arg1, 1), 12);
    }
    ...
    public fun create_vault<T0, T1, T2>(arg0: &mut VaultsManager, arg1: 0x2::coin::TreasuryCap<T2>, arg2: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::rewarder::RewarderManager, arg3: &0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::config::GlobalConfig, arg4: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::Pool, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: u32, arg8: u32, arg9: bool, arg10: u128, arg11: u64, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::deposit_v2<T0, T1>(arg3, arg2, arg4, arg6, v0, arg12, arg13);
        let v2 = if (arg9) {
        ...
        let v5 = VaultStatus{
            ...
            allow_remove  : true,
            is_exit       : false,
            exited_assets : 0x2::bag::new(arg13),
        };
        0x2::dynamic_field::add<vector<u8>, VaultStatus>(&mut v4.id, b"exit_state", v5);
        let v6 = CreateEvent{
    ...
    public fun deposit<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::rewarder::RewarderManager, arg3: &0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::config::GlobalConfig, arg4: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::Pool, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: 0x2::coin::Coin<T0>, arg8: 0x2::coin::Coin<T1>, arg9: u64, arg10: u64, arg11: bool, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        let (_, _) = collect_clmm_fee<T0, T1, T2>(arg1, arg3, arg5, arg6);
        if (0x2::dynamic_field::exists_with_type<vector<u8>, VaultStatus>(&arg1.id, b"exit_state")) {
            assert!(0x2::dynamic_field::borrow<vector<u8>, VaultStatus>(&arg1.id, b"exit_state").allow_deposit, 39);
        };
        ...
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::utils::send_coin<T0>(0x2::coin::from_balance<T0>(v6, arg13), 0x2::tx_context::sender(arg13));
        0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::utils::send_coin<T1>(0x2::coin::from_balance<T1>(v7, arg13), 0x2::tx_context::sender(arg13));
    ...
    public fun exit_vault<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T2>, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        assert!(0x2::dynamic_field::exists_with_type<vector<u8>, VaultStatus>(&arg1.id, b"exit_state"), 37);
        let v1 = 0x2::dynamic_field::borrow_mut<vector<u8>, VaultStatus>(&mut arg1.id, b"exit_state");
        assert!(v1.is_exit, 38);
        let v2 = 0x2::coin::value<T2>(&arg3);
        assert!(v2 > 0, 5);
        let v3 = 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()));
        let v4 = 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>()));
        let v5 = 0x2::balance::zero<T0>();
        let v6 = 0x2::balance::zero<T1>();
        if (0x2::bag::contains<0x1::string::String>(&v1.exited_assets, v3)) {
            0x2::balance::join<T0>(&mut v5, 0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v1.exited_assets, v3), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_floor(0x2::balance::value<T0>(0x2::bag::borrow<0x1::string::String, 0x2::balance::Balance<T0>>(&v1.exited_assets, v3)), v2, v0)));
        };
        if (0x2::bag::contains<0x1::string::String>(&v1.exited_assets, v4)) {
            0x2::balance::join<T1>(&mut v6, 0x2::balance::split<T1>(0x2::bag::borrow_mut<0x1::string::String, 0x2::balance::Balance<T1>>(&mut v1.exited_assets, v4), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_floor(0x2::balance::value<T1>(0x2::bag::borrow<0x1::string::String, 0x2::balance::Balance<T1>>(&v1.exited_assets, v4)), v2, v0)));
        };
        let v7 = ExitVaultEvent{
            vault_id        : 0x2::object::id<Vault<T2>>(arg1),
            lp_amount       : v2,
            total_lp_amount : v0,
        ...
        0x2::event::emit<ExitVaultEvent>(v7);
        0x2::coin::burn<T2>(&mut arg1.lp_token_treasury, arg3);
        (0x2::coin::from_balance<T0>(v5, arg4), 0x2::coin::from_balance<T1>(v6, arg4))
    }
    ...
    public fun finalize_exit<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg2) == arg1.pool, 41);
        assert!(0x2::dynamic_field::exists_with_type<vector<u8>, VaultStatus>(&arg1.id, b"exit_state"), 37);
        assert!(!0x2::dynamic_field::borrow<vector<u8>, VaultStatus>(&arg1.id, b"exit_state").is_exit, 43);
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::info_liquidity(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::borrow_position_info<T0, T1>(arg2, 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::borrow_clmm_position(0x1::vector::borrow_mut<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&mut arg1.positions, 0))))) == 0, 42);
        let v0 = 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()));
        let v1 = 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>()));
        let v2 = 0x2::balance::zero<T0>();
        let v3 = 0x2::balance::zero<T1>();
        if (0x2::bag::contains<0x1::string::String>(&arg1.harvest_assets, v0)) {
            let v4 = take_harvest_asset<T0, T2>(arg1);
            0x2::balance::join<T0>(&mut v2, v4);
        };
        if (0x2::bag::contains<0x1::string::String>(&arg1.harvest_assets, v1)) {
            let v5 = take_harvest_asset<T1, T2>(arg1);
            0x2::balance::join<T1>(&mut v3, v5);
        };
        assert!(0x2::bag::length(&arg1.harvest_assets) == 0, 44);
        let v6 = 0x2::dynamic_field::borrow_mut<vector<u8>, VaultStatus>(&mut arg1.id, b"exit_state");
        v6.is_exit = true;
        assert!(!v6.allow_remove, 44);
        assert!(!v6.allow_deposit, 44);
        0x2::bag::add<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v6.exited_assets, v0, v2);
        0x2::bag::add<0x1::string::String, 0x2::balance::Balance<T1>>(&mut v6.exited_assets, v1, v3);
        let v7 = FinalizeExitEvent{
            vault_id : 0x2::object::id<Vault<T2>>(arg1),
            amount_a : 0x2::balance::value<T0>(&v2),
            amount_b : 0x2::balance::value<T1>(&v3),
        };
        0x2::event::emit<FinalizeExitEvent>(v7);
    }
    ...
    public fun flash_loan_v2<T0, T1, T2>(arg0: &VaultsManager, arg1: &0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::OracleRegistry, arg2: &mut Vault<T2>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanReceipt) {
        checked_package_version(arg0);
        check_operation_role(arg0, 0x2::tx_context::sender(arg5));
        ...
        let v2 = 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::get_price<T0>(arg1, arg4);
        let v3 = 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::get_price<T1>(arg1, arg4);
        let (v4, _) = 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::calculate_prices(&v2, &v3);
        ...
        let v8 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_ceil((v7 as u64), 10000 - (0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::slippage(0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::coin_info<T0>(arg1)) + 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::slippage(0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::oracle_registry::coin_info<T1>(arg1))) / 2, 10000);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = VaultsManager{
            ...
            acl                : 0x8209d332805f151bfafee018538b66a949716a3cabb665f6a190ad5ecd468888::acl::new(arg0),
        };
        let v2 = InitEvent{
    ...
    public fun init_vault_status<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(!0x2::dynamic_field::exists_with_type<vector<u8>, VaultStatus>(&arg0.id, b"exit_state"), 45);
        let v0 = VaultStatus{
            allow_deposit : true,
            allow_remove  : true,
            is_exit       : false,
            exited_assets : 0x2::bag::new(arg1),
        };
        0x2::dynamic_field::add<vector<u8>, VaultStatus>(&mut arg0.id, b"exit_state", v0);
    }
    ...
    public fun migrate_liquidity<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::rewarder::RewarderManager, arg3: &0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::config::GlobalConfig, arg4: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::Pool, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: u64, arg8: u64, arg9: u32, arg10: u32, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v12 = 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::deposit_v2<T0, T1>(arg3, arg2, arg4, arg6, v10, arg11, arg12);
        let (v13, v14) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::tick_range(0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::borrow_clmm_position(&v12));
        let v15 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg6);
        let (v16, v17, v18) = check_is_fix_coin_a(v13, v14, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_tick_index<T0, T1>(arg6), v15, v8, v9);
        let (v19, v20) = if (v16) {
            (v8, v18 + v18 * (0x2::table::borrow<0x2::object::ID, OracleInfo>(&arg0.price_oracles, new_pool_key<T0, T1>()).slippage as u64) / 2000)
        } else {
            (v17 + v17 * (0x2::table::borrow<0x2::object::ID, OracleInfo>(&arg0.price_oracles, new_pool_key<T0, T1>()).slippage as u64) / 2000, v9)
        };
        let (v21, v22) = if (v19 != 0 && v20 != 0) {
            0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::add_liquidity_fix_coin<T0, T1>(arg3, arg5, arg2, arg4, arg6, &mut v12, 0x2::coin::from_balance<T0>(v7, arg12), 0x2::coin::from_balance<T1>(v6, arg12), v19, v20, v16, arg11, arg12)
        } else {
            (v7, v6)
        };
        let v23 = v22;
        ...
        arg1.liquidity = v25;
        let v26 = if (v16) {
            assert!(0x2::balance::value<T0>(&v24) == 0, 8);
            0x2::balance::value<T1>(&v23)
        } else {
            assert!(0x2::balance::value<T1>(&v23) == 0, 8);
        ...
        let v27 = MigrateLiquidityEvent{
            ...
            new_wrapped_position : 0x2::object::id<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&v12),
            ...
            new_liquidity        : v25,
            current_sqrt_price   : v15,
            tick_lower           : v13,
            tick_upper           : v14,
        };
        0x2::event::emit<MigrateLiquidityEvent>(v27);
        merge_harvest_asset<T0, T2>(arg1, v24);
        merge_harvest_asset<T1, T2>(arg1, v23);
        0x1::vector::push_back<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&mut arg1.positions, v12);
    }
    ...
    public fun remove_all_liquidity<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::rewarder::RewarderManager, arg3: &0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::config::GlobalConfig, arg4: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::Pool, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_pool_manager_role(arg0, 0x2::tx_context::sender(arg8));
        assert!(!arg1.is_pause, 6);
        assert!(arg1.status == 1, 17);
        assert!(0x1::vector::length<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&arg1.positions) == 1, 2);
        assert!(0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg6) == arg1.pool, 41);
        assert!(0x2::dynamic_field::exists_with_type<vector<u8>, VaultStatus>(&arg1.id, b"exit_state"), 37);
        let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, VaultStatus>(&mut arg1.id, b"exit_state");
        v0.allow_deposit = false;
        v0.allow_remove = false;
        v0.is_exit = false;
        let v1 = 0x1::vector::borrow_mut<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&mut arg1.positions, 0);
        let (v2, v3) = 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::remove_liquidity<T0, T1>(arg3, arg5, arg2, arg4, arg6, v1, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::info_liquidity(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::borrow_position_info<T0, T1>(arg6, 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::borrow_clmm_position(v1)))), 0, 0, arg7);
