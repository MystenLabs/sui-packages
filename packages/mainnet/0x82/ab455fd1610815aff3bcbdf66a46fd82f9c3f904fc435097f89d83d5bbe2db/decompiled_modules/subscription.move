module 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::subscription {
    ...
    fun collect_finalize_market_fee<T0, T1>(arg0: &0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun finalize_market<T0, T1>(arg0: &0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::LpVault<T0, T1> {
        let v0 = 0x2::clock::timestamp_ms(arg6);
        assert!(0x2::balance::value<T1>(&arg1.balance_y) >= arg1.soft_cap && v0 > arg1.market_close, 9);
        if (v0 < arg1.market_close + 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::curator_finalizing_cooldown(arg0)) {
        ...
        let v1 = @0x0;
        let v2 = 0;
        let v3 = 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::new_lp_vault<T0, T1>(0x2::bag::new(arg7), arg1.curator, arg1.admin_public_key, arg7);
        if (arg1.is_auto_add_liquidity) {
            ...
            if (v11) {
                ...
                0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::add_position<T0, T1>(&mut v3, v18);
                let v21 = 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::id<T0, T1>(&v3);
                let v22 = LpVaultCreated<T0, T1>{
                    market_address   : 0x2::object::id_address<Market<T0, T1>>(arg1),
                    lp_vault_address : 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::id_to_address(&v21),
                ...
                0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::add_position<T0, T1>(&mut v3, v27);
                let v30 = 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::id<T0, T1>(&v3);
                let v31 = LpVaultCreated<T0, T1>{
                    market_address   : 0x2::object::id_address<Market<T0, T1>>(arg1),
                    lp_vault_address : 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::id_to_address(&v30),
                    curator          : arg1.curator,
                    pool_address     : v29,
        ...
        let v32 = arg1.soft_cap - arg1.soft_cap * 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::finalize_market_fee_bps(arg0) / 10000;
        let v33 = v32;
        if (arg1.is_auto_add_liquidity) {
    ...
    fun validate_params(arg0: &0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::MainConfig, arg1: u64, arg2: u128, arg3: u64, arg4: u64, arg5: bool, arg6: u64) {
        assert!(arg3 + 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::finalize_market_fee_bps(arg0) <= 10000, 1);
        let v0 = 0;
        if (arg5) {
