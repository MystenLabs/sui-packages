module 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault {
    ...
    public fun claim<T0, T1>(arg0: &mut LpVault<T0, T1>, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::events::emit_fee_claimed<T0, T1>(0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::events::get_id(&v1.id), v0, 0, arg2, arg2, *v2);
    ...
    public fun collect_lp_fee<T0, T1>(arg0: &mut LpVault<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::events::emit_fee_collected<T0, T1>(0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::events::get_id(&arg0.id), v6, v7, v0, arg3);
    }
    ...
    public fun id<T0, T1>(arg0: &LpVault<T0, T1>) : 0x2::object::ID {
        0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::events::get_id(&arg0.id)
    }
