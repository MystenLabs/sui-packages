module 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::fair_launch {
    ...
    fun collect_finalize_market_fee<T0, T1>(arg0: &0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::MainConfig, arg1: &mut FairLaunch<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.balance_y, arg1.contributed * 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::finalize_market_fee_bps(arg0) / 10000), arg2), 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::fee_recipient(arg0));
    }

    fun collect_open_market_fee<T0>(arg0: &0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::MainConfig, arg1: 0x2::coin::Coin<T0>) {
        assert!(0x2::coin::value<T0>(&arg1) == 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::open_market_fee(arg0), 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::fee_recipient(arg0));
    }
    ...
    public fun create_fair_launch<T0, T1>(arg0: &0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::MainConfig, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: 0x2::coin::Coin<T0>, arg10: 0x2::coin::Coin<T1>, arg11: vector<address>, arg12: vector<u64>, arg13: bool, arg14: vector<u8>, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 < arg3, 1);
    ...
    public fun finalize_fair_launch<T0, T1>(arg0: &0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::MainConfig, arg1: &mut FairLaunch<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::LpVault<T0, T1> {
        let v0 = 0x2::clock::timestamp_ms(arg6);
        let v1 = 0x2::balance::value<T1>(&arg1.balance_y);
        assert!(v1 >= arg1.soft_cap && v0 > arg1.end_time, 8);
        if (v0 < arg1.timestamp_last_ms + 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::curator_finalizing_cooldown(arg0) || v0 < arg1.end_time + 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::main::curator_finalizing_cooldown(arg0)) {
        ...
        let v2 = @0x0;
        let v3 = 0;
        let v4 = 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::new_lp_vault<T0, T1>(0x2::bag::new(arg7), arg1.curator, arg1.admin_public_key, arg7);
        if (arg1.is_auto_add_liquidity) {
            ...
            if (v12) {
                ...
                0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::add_position<T0, T1>(&mut v4, v19);
                0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::events::emit_lp_vault_created<T0, T1>(0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::events::get_id(&arg1.id), 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::id<T0, T1>(&v4), arg1.curator, v21, v15, v5, v6, 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v19));
            } else {
                let v22 = sqrt(340282366920938463463374607431768211456 * (v6 as u256) / (v5 as u256));
                v3 = v22;
                let (v23, v24, v25) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v2<T1, T0>(arg2, arg3, 60, v22, 0x1::string::utf8(b""), 4294523716, 443580, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.balance_y, v5), arg7), 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.balance_x, v6), arg7), arg5, arg4, false, arg6, arg7);
                let v26 = v23;
                let v27 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::pool_id(&v26);
                let v28 = 0x2::object::id_to_address(&v27);
                v2 = v28;
                0x2::balance::join<T1>(&mut arg1.balance_y, 0x2::coin::into_balance<T1>(v24));
                0x2::balance::join<T0>(&mut arg1.balance_x, 0x2::coin::into_balance<T0>(v25));
                0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::add_position<T0, T1>(&mut v4, v26);
                0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::events::emit_lp_vault_created<T0, T1>(0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::events::get_id(&arg1.id), 0x82ab455fd1610815aff3bcbdf66a46fd82f9c3f904fc435097f89d83d5bbe2db::vault::id<T0, T1>(&v4), arg1.curator, v28, v22, v5, v6, 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v26));
            };
        };
        ...
        let v29 = FairLaunchFinalized<T0, T1>{
        ...
        0x2::event::emit<FairLaunchFinalized<T0, T1>>(v29);
        v4
    }
