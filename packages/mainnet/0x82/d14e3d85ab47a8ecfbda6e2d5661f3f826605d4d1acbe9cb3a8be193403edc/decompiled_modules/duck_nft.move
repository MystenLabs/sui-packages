module 0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::duck_nft {
    ...
    fun create_duck_nft(arg0: u8, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : DuckNFT {
        ...
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Staked"));
        ...
        0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"No"));
        DuckNFT{
    ...
    public entry fun hatch_basic_egg(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SharedTreasury, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg12: 0x2::coin::Coin<0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SHTTOKEN>, arg13: 0x2::coin::Coin<0x2::sui::SUI>, arg14: u64, arg15: &0x2::random::Random, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v3 * arg14;
        let v6 = v4 * arg14;
        assert!(0x2::coin::value<0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SHTTOKEN>(&arg12) >= v5, 1);
        ...
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SHTTOKEN>(&mut arg12, v5, arg17);
        0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::burn(arg8, 0x2::coin::split<0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SHTTOKEN>(&mut v9, v7, arg17));
        ...
        if (0x1::option::is_some<address>(&v2)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SHTTOKEN>>(0x2::coin::split<0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SHTTOKEN>(&mut v9, v8, arg17), v10);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SHTTOKEN>>(0x2::coin::split<0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SHTTOKEN>(&mut v9, v8, arg17), arg4.treasury_wallet);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SHTTOKEN>>(v9, arg4.treasury_wallet);
        if (0x2::coin::value<0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SHTTOKEN>(&arg12) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SHTTOKEN>>(arg12, 0x2::tx_context::sender(arg17));
        } else {
            0x2::coin::destroy_zero<0x82d14e3d85ab47a8ecfbda6e2d5661f3f826605d4d1acbe9cb3a8be193403edc::shttoken::SHTTOKEN>(arg12);
        };
    ...
    fun init(arg0: DUCK_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = HatchCap{id: 0x2::object::new(arg1)};
        0x2::transfer::share_object<HatchCap>(v11);
        let v12 = AdminCap{
            id                    : 0x2::object::new(arg1),
            team_mint_initialized : false,
        };
        0x2::transfer::transfer<AdminCap>(v12, v0);
        let v13 = PackSupply{
            id                                : 0x2::object::new(arg1),
        ...
        0x2::transfer::share_object<PackSupply>(v13);
        let v14 = PerTypeSupply{
            id                     : 0x2::object::new(arg1),
        ...
        0x2::transfer::share_object<PerTypeSupply>(v14);
        let v15 = TreasuryConfig{
            id              : 0x2::object::new(arg1),
            treasury_wallet : v0,
        };
        0x2::transfer::share_object<TreasuryConfig>(v15);
        let v16 = Whitelist{
            id        : 0x2::object::new(arg1),
            addresses : 0x2::vec_set::empty<address>(),
        };
        0x2::transfer::share_object<Whitelist>(v16);
        let v17 = ReferralRegistry{
            id        : 0x2::object::new(arg1),
            referrers : 0x2::table::new<address, address>(arg1),
        };
        0x2::transfer::share_object<ReferralRegistry>(v17);
        let v18 = GlobalStats{
            id                  : 0x2::object::new(arg1),
            common_minted       : 0,
            queen_minted        : 0,
        ...
        0x2::transfer::share_object<GlobalStats>(v18);
        let v19 = UserStatsRegistry{id: 0x2::object::new(arg1)};
        0x2::transfer::share_object<UserStatsRegistry>(v19);
    }
    ...
    fun update_staked_attribute(arg0: &mut DuckNFT, arg1: bool) {
        ...
        let v2 = 0;
        while (v2 < 0x1::vector::length<0x1::string::String>(&arg0.attribute_keys)) {
            if (*0x1::vector::borrow<0x1::string::String>(&arg0.attribute_keys, v2) == v0) {
                *0x1::vector::borrow_mut<0x1::string::String>(&mut arg0.attribute_values, v2) = v1;
                return
            };
            v2 = v2 + 1;
        };
        0x1::vector::push_back<0x1::string::String>(&mut arg0.attribute_keys, v0);
        0x1::vector::push_back<0x1::string::String>(&mut arg0.attribute_values, v1);
    }
