module 0x473c220d79b49b847ddac4ec7e237f15f50720ab28d7e895079530697c16b35f::farm {
    ...
    public(friend) fun rebalance_end<T0, T1, T2>(arg0: &mut Farm, arg1: u32, arg2: bool, arg3: u32, arg4: bool, arg5: 0x2::coin::Coin<T0>, arg6: 0x2::coin::Coin<T1>, arg7: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg8: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg9: &0x2::clock::Clock, arg10: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg11: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg5);
        let v1 = 0x2::coin::value<T1>(&arg6);
        let (v2, v3, v4) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::mint_with_return_<T0, T1, T2>(arg7, arg8, 0x473c220d79b49b847ddac4ec7e237f15f50720ab28d7e895079530697c16b35f::utils::coin_to_vec<T0>(arg5), 0x473c220d79b49b847ddac4ec7e237f15f50720ab28d7e895079530697c16b35f::utils::coin_to_vec<T1>(arg6), arg1, arg2, arg3, arg4, v0, v1, 0, 0, 0x2::clock::timestamp_ms(arg9) + 60000, arg9, arg10, arg11);
        0x1::option::fill<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(&mut arg0.turbos_position_nft, v2);
        add_balance_to_compounding_asset<T0>(arg0, 0x2::coin::into_balance<T0>(v3));
        add_balance_to_compounding_asset<T1>(arg0, 0x2::coin::into_balance<T1>(v4));
        let (v5, v6, v7) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg8, get_turbos_position_nft_address(arg0));
        let v8 = RebalanceEndEvent{
            ...
            total_coin_amount_a       : v0,
            total_coin_amount_b       : v1,
        };
        0x2::event::emit<RebalanceEndEvent>(v8);
    }

    public(friend) fun rebalance_start<T0, T1, T2>(arg0: &mut Farm, arg1: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg3: &0x2::clock::Clock, arg4: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v10 = do_take_compounding_asset_balance<T0>(arg0);
        0x2::coin::join<T0>(&mut v9, 0x2::coin::from_balance<T0>(v10, arg5));
        let v11 = do_take_compounding_asset_balance<T1>(arg0);
        0x2::coin::join<T1>(&mut v8, 0x2::coin::from_balance<T1>(v11, arg5));
        let v12 = RebalanceStartEvent{
            sender                    : 0x2::tx_context::sender(arg5),
            farm_id                   : 0x2::object::id<Farm>(arg0),
            tick_lower_index          : v0,
            tick_upper_index          : v1,
            ...
            total_coin_amount_a       : 0x2::coin::value<T0>(&v9),
            total_coin_amount_b       : 0x2::coin::value<T1>(&v8),
        };
        0x2::event::emit<RebalanceStartEvent>(v12);
        (v9, v8)
    }
