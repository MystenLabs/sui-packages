module 0xed53ed0e43e8b2ed48012e6b8b6a3d9018eefa0b15fa5a7347dd01144c403551::reward5193 {
    struct REWARD5193 has drop {
        dummy_field: bool,
    }

    struct TICKET_5193 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5193(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5193>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5193>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5193, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5193>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5193>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5193>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5193>>(v5, 0x2::tx_context::sender(arg1));
    }
