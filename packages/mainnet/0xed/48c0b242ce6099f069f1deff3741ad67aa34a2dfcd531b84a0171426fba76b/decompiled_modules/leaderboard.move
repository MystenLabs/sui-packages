module 0x298440be321c1c6f1644f5c8f718ba5265fe5a62722bb4859221416d3caa1b0f::leaderboard {
    ...
    public fun get_chakra_tier_distribution(arg0: &Leaderboard) : vector<ChakraTierRange> {
        let v0 = 0x1::vector::empty<ChakraTierRange>();
        let v1 = &arg0.config;
        let v2 = 0x1::vector::empty<u8>();
        let v3 = &mut v2;
        0x1::vector::push_back<u8>(v3, v1.chakra_7);
        0x1::vector::push_back<u8>(v3, v1.chakra_6);
        0x1::vector::push_back<u8>(v3, v1.chakra_5);
        0x1::vector::push_back<u8>(v3, v1.chakra_4);
        0x1::vector::push_back<u8>(v3, v1.chakra_3);
        0x1::vector::push_back<u8>(v3, v1.chakra_2);
        0x1::vector::push_back<u8>(v3, v1.chakra_1);
        let v4 = x"07060504030201";
        let v5 = 18446744073709551615;
        let v6 = v5;
        let v7 = 0;
        while (!0x1::vector::is_empty<u8>(&v2)) {
            let v8 = 0x298440be321c1c6f1644f5c8f718ba5265fe5a62722bb4859221416d3caa1b0f::big_vector::length<ChakraItem>(&arg0.chakras) * (0x1::vector::pop_back<u8>(&mut v2) as u64) / 100;
            if (v8 > v7) {
                let (v9, v10) = find_points_at_rank(arg0, v8);
                if (v9 < v5) {
                    let v11 = ChakraTierRange{
                        lower_bound : v9 + 1,
                        upper_bound : v5,
                        chakra_tier : 0x1::vector::pop_back<u8>(&mut v4),
                    };
                    0x1::vector::push_back<ChakraTierRange>(&mut v0, v11);
                    v6 = v9;
                    v7 = v10;
                };
            };
        ...
        if (v6 > 0) {
            ...
            0x1::vector::push_back<ChakraTierRange>(&mut v0, v12);
        };
        v0
    }
