module 0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault {
    ...
    public(friend) fun withdraw_partial<T0>(arg0: &mut BBBVault, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = &mut arg0.balances;
        let v1 = 0x1::type_name::with_defining_ids<T0>();
        if (!0x2::bag::contains<0x1::type_name::TypeName>(v0, v1)) {
            0x2::balance::zero<T0>()
        } else {
            let v3 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(v0, v1);
            if (0x2::balance::value<T0>(v3) <= arg1) {
                0x2::balance::withdraw_all<T0>(v3)
            } else {
                0x2::balance::split<T0>(v3, arg1)
            }
        }
    }
