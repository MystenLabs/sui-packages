module 0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::bonding_curve {
    ...
    struct BondingCurve<phantom T0, phantom T1> has store, key {
        ...
        vault: 0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::vault::Vault<T0>,
        vault_bps: u16,
    }
    ...
    public(friend) fun new<T0, T1>(arg0: &0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::Config, arg1: 0x2::coin::TreasuryCap<T0>, arg2: address, arg3: u128, arg4: u32, arg5: vector<u32>, arg6: vector<u32>, arg7: vector<u16>, arg8: vector<address>, arg9: vector<u16>, arg10: vector<address>, arg11: u16, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : BondingCurve<T0, T1> {
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x2::tx_context::sender(arg13);
        assert!(arg11 <= 0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::max_vault_bps(), 205);
        let v2 = &mut arg1;
        let (v3, v4) = mint_and_split<T0>(v2, arg0, arg11, &arg7, arg13);
        let (v5, v6) = 0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::get_vault_config(arg0);
        let v7 = 0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::vault::new<T0>(v4, arg2, v5, v6, arg12, arg13);
        let v8 = build_positions<T0>(arg5, arg6, arg7, v3);
        let v9 = 0x1::vector::length<PositionConfig<T0>>(&v8);
        0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::assert_positions_count(v9);
        ...
        0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::assert_fee_receivers_count(v11);
    ...
    public fun collect_fee<T0, T1>(arg0: &0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::Config, arg1: &mut BondingCurve<T0, T1>, arg2: &mut 0xde469e3fc61037aef6394bc9e61b6785e0541f2f4f82dc06ca339fc9266602c5::pool::Pool<T0, T1>, arg3: &0xde469e3fc61037aef6394bc9e61b6785e0541f2f4f82dc06ca339fc9266602c5::config::GlobalConfig, arg4: &mut 0x2::tx_context::TxContext) {
        0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::assert_not_paused(arg0);
        0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::assert_current_version(arg0);
        ...
        let v7 = 0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::calculate_protocol_fee(arg0, 0x2::balance::value<T0>(&v1));
        let v8 = 0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::calculate_protocol_fee(arg0, 0x2::balance::value<T1>(&v2));
        if (v7 > 0) {
        ...
        while (v9 < v10) {
            ...
            let v12 = if (v9 == v10 - 1) {
                ...
                0x2::balance::value<T0>(&v1) * (v11.percent_bps as u64) / (10000 as u64)
            };
            let v13 = if (v9 == v10 - 1) {
                0x2::balance::value<T1>(&v2)
            } else {
                0x2::balance::value<T1>(&v2) * (v11.percent_bps as u64) / (10000 as u64)
            };
            if (v11.recipient == v0) {
                if (v12 > 0) {
    ...
    public fun collect_reward<T0, T1, T2>(arg0: &0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::Config, arg1: &mut BondingCurve<T0, T1>, arg2: &mut 0xde469e3fc61037aef6394bc9e61b6785e0541f2f4f82dc06ca339fc9266602c5::pool::Pool<T0, T1>, arg3: &0xde469e3fc61037aef6394bc9e61b6785e0541f2f4f82dc06ca339fc9266602c5::config::GlobalConfig, arg4: &mut 0xde469e3fc61037aef6394bc9e61b6785e0541f2f4f82dc06ca339fc9266602c5::rewarder::RewarderGlobalVault, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::assert_not_paused(arg0);
        0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::assert_current_version(arg0);
        ...
        while (v5 < v6) {
            ...
            let v8 = if (v5 == v6 - 1) {
                ...
                0x2::balance::value<T2>(&v1) * (v7.percent_bps as u64) / (10000 as u64)
            };
            if (v8 > 0) {
    ...
    fun add_liquidity_position<T0, T1>(arg0: &0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::Config, arg1: &0xde469e3fc61037aef6394bc9e61b6785e0541f2f4f82dc06ca339fc9266602c5::config::GlobalConfig, arg2: &mut BondingCurve<T0, T1>, arg3: &mut 0xde469e3fc61037aef6394bc9e61b6785e0541f2f4f82dc06ca339fc9266602c5::pool::Pool<T0, T1>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<0xde469e3fc61037aef6394bc9e61b6785e0541f2f4f82dc06ca339fc9266602c5::position::Position>(&v0.position) && 0x2::balance::value<T0>(&v0.coin) == 0) {
            return
        };
    ...
    fun build_fee_receivers<T0, T1>(arg0: vector<address>, arg1: vector<u16>, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) : vector<FeeReceiverConfig<T0, T1>> {
        let v0 = 0;
        let v1 = 0x1::vector::empty<FeeReceiverConfig<T0, T1>>();
        while (v0 < 0x1::vector::length<address>(&arg0)) {
            let v2 = *0x1::vector::borrow<u16>(&arg1, v0);
            assert!(v2 <= 10000, 200);
    ...
    public fun collect_protocol_fee<T0, T1>(arg0: &0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::Config, arg1: &mut BondingCurve<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::assert_not_paused(arg0);
        0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::assert_current_version(arg0);
        let v0 = 0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::fee_receiver(arg0);
    ...
    public(friend) fun deposit_leftover<T0, T1>(arg0: &mut BondingCurve<T0, T1>, arg1: 0x2::coin::Coin<T0>) {
        0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::vault::deposit<T0>(&mut arg0.vault, arg1);
    }
    ...
    fun mint_and_split<T0>(arg0: &mut 0x2::coin::TreasuryCap<T0>, arg1: &0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::Config, arg2: u16, arg3: &vector<u16>, arg4: &mut 0x2::tx_context::TxContext) : (vector<0x2::coin::Coin<T0>>, 0x2::coin::Coin<T0>) {
        assert!(0x2::coin::total_supply<T0>(arg0) == 0, 204);
        let v0 = 0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::total_token_supply(arg1);
        ...
        while (v3 < v4) {
            let v5 = if (v3 == v4 - 1) {
                ...
                0x2::balance::value<T0>(&v1) * (*0x1::vector::borrow<u16>(arg3, v3) as u64) / (10000 as u64)
            };
            0x1::vector::push_back<0x2::coin::Coin<T0>>(&mut v2, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v1, v5), arg4));
            v3 = v3 + 1;
        };
        0x2::balance::destroy_zero<T0>(v1);
        (v2, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v1, v0 * (arg2 as u64) / (10000 as u64)), arg4))
    }
    ...
    public fun update_fee_receiver<T0, T1>(arg0: &0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::Config, arg1: &mut BondingCurve<T0, T1>, arg2: address, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::assert_not_paused(arg0);
        0xed4348bae518b47576b4d274d1ad7066c91923244fcaa26a8d4f0d9e3c9441f3::config::assert_current_version(arg0);
        let v0 = 0;
    ...
    fun validate_positions<T0>(arg0: &vector<PositionConfig<T0>>) {
        ...
        while (v1 < 0x1::vector::length<PositionConfig<T0>>(arg0)) {
            v0 = v0 + 0x1::vector::borrow<PositionConfig<T0>>(arg0, v1).percent_bps;
            v1 = v1 + 1;
        };
        assert!(v0 <= 10000, 202);
    }
