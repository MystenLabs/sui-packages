module 0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::free_managed_reward {
    ...
    public fun borrow_reward(arg0: &FreeManagedReward) : &0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward::Reward {
        &arg0.reward
    }
    ...
    public(friend) fun create(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x1::type_name::TypeName, arg3: &mut 0x2::tx_context::TxContext) : FreeManagedReward {
        ...
        FreeManagedReward{
            ...
            reward : 0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward::create(arg0, 0x1::option::some<0x2::object::ID>(arg1), arg1, v0, false, arg3),
            bag    : 0x2::bag::new(arg3),
        }
    }

    public fun deposit(arg0: &mut FreeManagedReward, arg1: &0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward_authorized_cap::RewardAuthorizedCap, arg2: u64, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_reward<T0>(arg0: &mut FreeManagedReward, arg1: 0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::lock_owner::OwnerProof, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::lock_owner::consume(arg1);
        assert!(0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward::ve(&arg0.reward) == v0, 9223372337502486527);
        let v3 = 0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward::get_reward_internal<T0>(&mut arg0.reward, 0x2::tx_context::sender(arg3), v1, arg2, arg3);
    ...
    public fun notify_reward_amount<T0>(arg0: &mut FreeManagedReward, arg1: 0x1::option::Option<0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::whitelisted_tokens::WhitelistedToken>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        if (!0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward::rewards_contains(&arg0.reward, v0)) {
            assert!(0x1::option::is_some<0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::whitelisted_tokens::WhitelistedToken>(&arg1), 9223372389042094079);
    ...
    public fun rewards_list(arg0: &FreeManagedReward) : vector<0x1::type_name::TypeName> {
        0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward::rewards_list(&arg0.reward)
    }
    ...
    public fun withdraw(arg0: &mut FreeManagedReward, arg1: &0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward_authorized_cap::RewardAuthorizedCap, arg2: u64, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
