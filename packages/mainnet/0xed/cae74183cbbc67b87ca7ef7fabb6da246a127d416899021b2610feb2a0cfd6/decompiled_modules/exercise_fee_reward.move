module 0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::exercise_fee_reward {
    ...
    public fun borrow_reward(arg0: &ExerciseFeeReward) : &0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward::Reward {
        &arg0.reward
    }
    ...
    public(friend) fun create(arg0: 0x2::object::ID, arg1: vector<0x1::type_name::TypeName>, arg2: &mut 0x2::tx_context::TxContext) : ExerciseFeeReward {
        ...
        ExerciseFeeReward{
            id     : v0,
            reward : 0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward::create(arg0, 0x1::option::none<0x2::object::ID>(), arg0, arg1, false, arg2),
        }
    }

    public fun deposit(arg0: &mut ExerciseFeeReward, arg1: &0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward_authorized_cap::RewardAuthorizedCap, arg2: u64, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun notify_reward_amount<T0>(arg0: &mut ExerciseFeeReward, arg1: &0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward_authorized_cap::RewardAuthorizedCap, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun voter_get_reward<T0, T1>(arg0: &mut ExerciseFeeReward, arg1: &0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::voter_cap::VoterCap, arg2: &0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::voting_escrow::VotingEscrow<T0>, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        assert!(0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::voter_cap::get_voter_id(arg1) == 0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward::voter(&arg0.reward), 9352227584057178000);
    ...
    public fun withdraw(arg0: &mut ExerciseFeeReward, arg1: &0xedcae74183cbbc67b87ca7ef7fabb6da246a127d416899021b2610feb2a0cfd6::reward_authorized_cap::RewardAuthorizedCap, arg2: u64, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
