module 0xedd2606dc6dc2020de15ded4c5b7fcac139b743c34a5a8121ee7b696eaddf5ae::reward5081 {
    struct REWARD5081 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward5081(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD5081, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5081>(arg0, arg1);
