module 0xed7f4ec6af614efe30b957bcde8e961300538bba80749bd15da44b41fdfac60e::cnsnft3100 {
    struct CNSNFT3100 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3100, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3100>(arg0, arg1);
