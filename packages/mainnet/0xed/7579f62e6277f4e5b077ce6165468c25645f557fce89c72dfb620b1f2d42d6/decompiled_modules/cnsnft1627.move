module 0xed7579f62e6277f4e5b077ce6165468c25645f557fce89c72dfb620b1f2d42d6::cnsnft1627 {
    struct CNSNFT1627 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1627, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1627>(arg0, arg1);
