module 0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::vault {
    ...
    public fun add_withdraw_request<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: VaultLpToken<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == *0x2::object::uid_as_inner(&arg0.id), 0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::error::invalidLPToken());
        assert!(lp_token_value<T0, T1>(&arg1) > 0, 0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::error::zeroAmount());
    ...
    public fun calculate_total_withdrawal_amount<T0, T1>(arg0: &mut Vault<T0, T1>) : u64 {
        ...
        while (v1 < 0x1::vector::length<WithdrawRequest<T0, T1>>(&arg0.withdraw_requests)) {
            ...
            v0 = v0 + 0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::safe_math::safe_mul_div_u64(v2, lp_token_value<T0, T1>(&0x1::vector::borrow<WithdrawRequest<T0, T1>>(&arg0.withdraw_requests, v1).lp_token), v3);
            v1 = v1 + 1;
        };
        v0
    }
    ...
    fun mint_lp_token<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T1>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LSP<T0, T1>> {
        ...
        if (v2 == 0) {
            v4 = v3;
            assert!(v3 > 0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::constants::minimal_liquidity(), 0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::error::notEnoughInitialLiquidity());
        } else {
            0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::safe_math::safe_mul_div_u64(v3, v2, v1);
        };
        assert!(v4 > 0, 0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::error::liquidityInsufficientMinted());
    ...
    public fun new_vault<T0, T1>(arg0: &0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::app::AdminCap, arg1: &mut 0x2::tx_context::TxContext) : (Vault<T0, T1>, VaultCap) {
    ...
    public fun process_withdrawals<T0, T1>(arg0: &0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::app::AdminCap, arg1: &mut Vault<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<WithdrawRequest<T0, T1>>(&arg1.withdraw_requests) > 0) {
            ...
            let (v5, v6, _) = get_reserves<T0, T1>(arg1);
            let v8 = 0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::safe_math::safe_mul_div_u64(v5, v4, v6);
            assert!(v8 > 0, 0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::error::zeroAmount());
            ...
            let v12 = v8 * 0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::constants::withdraw_fee_percent();
    ...
    public fun withdraw_assets_for_trading_account<T0, T1>(arg0: &0xed309c3f86b94308a4accd1502861251b12ef1778601c1d88e2dad764913af47::app::AdminCap, arg1: &mut Vault<T0, T1>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
