module 0x99d3caafe2e4a26d6f8da03773a672190c13da099c1715aac789254046db99f4::casino {
    ...
    struct JasonBlackjackTableV2Seat has store {
        occupied: bool,
        ready: bool,
        player: address,
        stake: 0x2::balance::Balance<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>,
    ...
    struct JasonBlackjackTableV2 has key {
        id: 0x2::object::UID,
        schema_version: u64,
        host: address,
        phase: u8,
        ...
        dealer_cards: vector<u8>,
        dealer_resolved: bool,
        seats: vector<JasonBlackjackTableV2Seat>,
    }
    ...
    struct JasonBlackjackTableV2CreatedEvent has copy, drop {
        table_id: 0x2::object::ID,
        schema_version: u64,
        host: address,
        lobby_deadline_ms: u64,
    ...
    struct JasonBlackjackTableV2JoinedEvent has copy, drop {
        table_id: 0x2::object::ID,
        schema_version: u64,
        round: u64,
        action_seq: u64,
    ...
    struct JasonBlackjackTableV2ReadyEvent has copy, drop {
        table_id: 0x2::object::ID,
        schema_version: u64,
        round: u64,
        action_seq: u64,
    ...
    struct JasonBlackjackTableV2StartedEvent has copy, drop {
        table_id: 0x2::object::ID,
        schema_version: u64,
        round: u64,
        action_seq: u64,
    ...
    struct JasonBlackjackTableV2ActionEvent has copy, drop {
        table_id: 0x2::object::ID,
        schema_version: u64,
        round: u64,
        action_seq: u64,
    ...
    struct JasonBlackjackTableV2SettledEvent has copy, drop {
        table_id: 0x2::object::ID,
        schema_version: u64,
        round: u64,
        action_seq: u64,
    ...
    struct JasonBlackjackTableV2CancelledEvent has copy, drop {
        table_id: 0x2::object::ID,
        schema_version: u64,
        round: u64,
        action_seq: u64,
    ...
    struct JasonBlackjackTableV2HostTransferredEvent has copy, drop {
        table_id: 0x2::object::ID,
        schema_version: u64,
        round: u64,
        action_seq: u64,
    ...
    struct JasonBlackjackTableV2RematchEvent has copy, drop {
        table_id: 0x2::object::ID,
        schema_version: u64,
        round: u64,
        action_seq: u64,
    ...
    fun advance_v2_turn(arg0: &mut JasonBlackjackTableV2, arg1: u64) {
        let v0 = next_v2_active_seat(arg0, arg0.turn_seat);
        arg0.turn_seat = v0;
        let v1 = if (v0 == 255) {
            0
        } else {
        ...
        arg0.turn_deadline_ms = v1;
    }

    fun all_v2_seats_settled(arg0: &JasonBlackjackTableV2) : bool {
        let v0 = 0;
        let v1 = 0;
        while (v0 < 6) {
            let v2 = 0x1::vector::borrow<JasonBlackjackTableV2Seat>(&arg0.seats, v0);
            if (v2.occupied) {
                v1 = v1 + 1;
                if (v2.status != 1) {
                    return false
    ...
    public entry fun cancel_expired_jason_blackjack_table_v2(arg0: &mut JasonBlackjackTableV2, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(arg0.schema_version == 2, 8);
        assert!(arg0.phase == 0, 8);
        assert!(0x2::clock::timestamp_ms(arg1) >= arg0.lobby_deadline_ms, 11);
        refund_v2_lobby(arg0, arg2);
        arg0.phase = 3;
        arg0.action_seq = arg0.action_seq + 1;
        let v1 = JasonBlackjackTableV2CancelledEvent{
        ...
        0x2::event::emit<JasonBlackjackTableV2CancelledEvent>(v1);
    }
    ...
    public entry fun cancel_jason_blackjack_table_v2(arg0: &mut JasonBlackjackTableV2, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(arg0.schema_version == 2, 8);
        assert!(arg0.phase == 0, 8);
        assert!(v0 == arg0.host, 9);
        refund_v2_lobby(arg0, arg1);
        arg0.phase = 3;
        arg0.action_seq = arg0.action_seq + 1;
        let v1 = JasonBlackjackTableV2CancelledEvent{
            table_id       : 0x2::object::uid_to_inner(&arg0.id),
    ...
    public entry fun create_jason_blackjack_table_v2(arg0: &0x2::clock::Clock, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        let v1 = 0x1::vector::empty<JasonBlackjackTableV2Seat>();
        let v2 = 0;
        while (v2 < 6) {
            0x1::vector::push_back<JasonBlackjackTableV2Seat>(&mut v1, empty_jason_blackjack_table_v2_seat());
            v2 = v2 + 1;
        };
        let v3 = JasonBlackjackTableV2{
            ...
            turn_seat         : 255,
            turn_deadline_ms  : 0,
            lobby_deadline_ms : 0x2::clock::timestamp_ms(arg0) + 300000,
            dealer_cards      : 0x1::vector::empty<u8>(),
            dealer_resolved   : false,
            seats             : v1,
        };
        let v4 = JasonBlackjackTableV2CreatedEvent{
            table_id          : 0x2::object::uid_to_inner(&v3.id),
            schema_version    : 2,
            host              : v0,
            lobby_deadline_ms : v3.lobby_deadline_ms,
        };
        0x2::event::emit<JasonBlackjackTableV2CreatedEvent>(v4);
        0x2::transfer::share_object<JasonBlackjackTableV2>(v3);
    }
    ...
    fun empty_jason_blackjack_table_v2_seat() : JasonBlackjackTableV2Seat {
        JasonBlackjackTableV2Seat{
            occupied     : false,
            ready        : false,
            player       : @0x0,
            stake        : 0x2::balance::zero<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(),
            wager        : 0,
    ...
    fun first_v2_active_seat(arg0: &JasonBlackjackTableV2) : u8 {
        let v0 = 0;
        while (v0 < 6) {
            let v1 = 0x1::vector::borrow<JasonBlackjackTableV2Seat>(&arg0.seats, v0);
            if (v1.occupied && v1.status == 0) {
                return (v0 as u8)
            };
            v0 = v0 + 1;
        };
    ...
    public entry fun forfeit_jason_blackjack_table_v2(arg0: &mut JasonBlackjackTableV2, arg1: &mut JasonHouse, arg2: &RevenueConfig, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: u8, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        forfeit_jason_blackjack_table_v2_internal(arg0, arg1, arg2, arg3, arg4, arg5, arg6, false, arg7);
    }

    fun forfeit_jason_blackjack_table_v2_internal(arg0: &mut JasonBlackjackTableV2, arg1: &mut JasonHouse, arg2: &RevenueConfig, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: u8, arg6: u64, arg7: bool, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = (arg5 as u64);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        assert!(arg0.schema_version == 2, 8);
        assert!(arg0.phase == 1, 8);
        assert!(arg6 == arg0.action_seq, 11);
        assert!(arg5 == arg0.turn_seat, 11);
        assert!(v0 < 6, 10);
        if (arg7) {
            assert!(v1 >= arg0.turn_deadline_ms, 11);
        };
        let v2 = 0x1::vector::borrow<JasonBlackjackTableV2Seat>(&arg0.seats, v0);
        assert!(v2.occupied, 10);
        if (!arg7) {
            assert!(v2.player == 0x2::tx_context::sender(arg8), 10);
        };
        assert!(v2.status == 0, 11);
        let v3 = v2.player;
        ...
        let v4 = 0x2::random::new_generator(arg3, arg8);
        let v5 = 0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v0);
        v5.status = 1;
        v5.result = 4;
        v5.timed_out = arg7;
        let v6 = blackjack_hand_total(&v5.player_cards);
        arg0.action_seq = arg0.action_seq + 1;
        0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v0).action_seq = arg0.action_seq;
        let v7 = all_v2_seats_settled(arg0);
        if (v7) {
            arg0.turn_seat = 255;
            arg0.turn_deadline_ms = 0;
        } else {
            advance_v2_turn(arg0, v1);
        };
        let v8 = JasonBlackjackTableV2ActionEvent{
            table_id         : 0x2::object::uid_to_inner(&arg0.id),
            schema_version   : arg0.schema_version,
            round            : arg0.round,
            action_seq       : arg0.action_seq,
            ...
            card             : 0,
            player_total     : v6,
            turn_seat        : arg0.turn_seat,
            turn_deadline_ms : arg0.turn_deadline_ms,
            timed_out        : arg7,
        };
        0x2::event::emit<JasonBlackjackTableV2ActionEvent>(v8);
        if (v7) {
            let v9 = &mut v4;
            settle_jason_blackjack_table_v2(arg0, arg1, arg2, v9, arg8);
        };
    }
    ...
    public entry fun hit_jason_blackjack_table_v2(arg0: &mut JasonBlackjackTableV2, arg1: &mut JasonHouse, arg2: &RevenueConfig, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: u8, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = (arg5 as u64);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        ...
        assert!(v1 < arg0.turn_deadline_ms, 11);
        assert!(v0 < 6, 10);
        let v3 = 0x1::vector::borrow<JasonBlackjackTableV2Seat>(&arg0.seats, v0);
        assert!(v3.occupied && v3.player == v2, 10);
        assert!(v3.status == 0, 11);
        assert!(!arg1.paused, 2);
        assert!(arg2.recipient == @0xd2cebe8666352e1ddb3dc7f271340432c983fc81017b3d6f7873dd66881433a4 && arg2.fee_bps == 250, 7);
        let v4 = 0x2::random::new_generator(arg3, arg7);
        let v5 = &mut v4;
        let v6 = blackjack_draw(v5);
        let v7 = 0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v0);
        0x1::vector::push_back<u8>(&mut v7.player_cards, v6);
        let v8 = blackjack_hand_total(&v7.player_cards);
        let v9 = v8 > 21;
        if (v9) {
            let v10 = 0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v0);
            v10.status = 1;
            v10.result = 0;
        };
        arg0.action_seq = arg0.action_seq + 1;
        0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v0).action_seq = arg0.action_seq;
        let v11 = all_v2_seats_settled(arg0);
        if (v11) {
            arg0.turn_seat = 255;
            arg0.turn_deadline_ms = 0;
        } else {
        ...
        let v13 = JasonBlackjackTableV2ActionEvent{
            table_id         : 0x2::object::uid_to_inner(&arg0.id),
            schema_version   : arg0.schema_version,
            round            : arg0.round,
            action_seq       : arg0.action_seq,
        ...
        0x2::event::emit<JasonBlackjackTableV2ActionEvent>(v13);
        if (v11) {
            let v14 = &mut v4;
            settle_jason_blackjack_table_v2(arg0, arg1, arg2, v14, arg7);
        };
    }
    ...
    public entry fun join_jason_blackjack_table_v2(arg0: &mut JasonBlackjackTableV2, arg1: &JasonHouse, arg2: &RevenueConfig, arg3: 0x2::coin::Coin<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(arg0.schema_version == 2, 8);
        assert!(arg0.phase == 0, 8);
        assert!(!arg1.paused, 2);
        ...
        let v2 = 0;
        while (v2 < 6) {
            let v3 = 0x1::vector::borrow<JasonBlackjackTableV2Seat>(&arg0.seats, v2);
            if (!v3.occupied) {
            };
            if (v3.occupied) {
                assert!(v3.player != v0, 8);
            };
            v2 = v2 + 1;
        };
        assert!(v1 < 6, 8);
        let v4 = 0x2::coin::value<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&arg3);
        assert!(v4 >= arg1.min_bet && v4 <= arg1.max_bet, 1);
        let v5 = v4 * arg2.fee_bps / 10000;
        assert!(v5 > 0, 1);
        assert!(0x2::balance::value<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&arg1.vault) >= v4 * 250 / 100 + v5, 4);
        let v6 = 0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v1);
        v6.occupied = true;
        v6.ready = false;
        v6.player = v0;
        0x2::balance::join<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&mut v6.stake, 0x2::coin::into_balance<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(arg3));
        v6.wager = v4;
        v6.status = 0;
        v6.result = 0;
        v6.payout = 0;
        ...
        v6.timed_out = false;
        arg0.action_seq = arg0.action_seq + 1;
        0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v1).action_seq = arg0.action_seq;
        let v7 = JasonBlackjackTableV2JoinedEvent{
            table_id       : 0x2::object::uid_to_inner(&arg0.id),
            schema_version : arg0.schema_version,
            round          : arg0.round,
            action_seq     : arg0.action_seq,
        ...
        0x2::event::emit<JasonBlackjackTableV2JoinedEvent>(v7);
    }

    fun next_v2_active_seat(arg0: &JasonBlackjackTableV2, arg1: u8) : u8 {
        let v0 = 1;
        while (v0 <= 6) {
            let v1 = ((arg1 as u64) + v0) % 6;
            let v2 = 0x1::vector::borrow<JasonBlackjackTableV2Seat>(&arg0.seats, v1);
            if (v2.occupied && v2.status == 0) {
                return (v1 as u8)
            };
            v0 = v0 + 1;
        };
    ...
    fun refund_v2_lobby(arg0: &mut JasonBlackjackTableV2, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        while (v0 < 6) {
            let v1 = 0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v0);
            if (v1.occupied) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>>(0x2::coin::from_balance<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(0x2::balance::withdraw_all<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&mut v1.stake), arg1), v1.player);
                v1.occupied = false;
                v1.ready = false;
                v1.player = @0x0;
                v1.wager = 0;
    ...
    public entry fun rematch_jason_blackjack_table_v2(arg0: &mut JasonBlackjackTableV2, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.schema_version == 2, 8);
        assert!(arg0.phase == 2, 8);
        assert!(0x2::tx_context::sender(arg2) == arg0.host, 9);
        let v0 = 0;
        while (v0 < 6) {
            let v1 = 0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v0);
            v1.occupied = false;
            ...
            v1.player = @0x0;
            v1.wager = 0;
            v1.player_cards = 0x1::vector::empty<u8>();
            v1.status = 1;
            v1.result = 0;
            v1.payout = 0;
            v1.fee = 0;
        ...
        arg0.dealer_cards = 0x1::vector::empty<u8>();
        arg0.dealer_resolved = false;
        arg0.phase = 0;
        arg0.turn_seat = 255;
        arg0.turn_deadline_ms = 0;
        arg0.lobby_deadline_ms = 0x2::clock::timestamp_ms(arg1) + 300000;
        arg0.action_seq = arg0.action_seq + 1;
        let v2 = JasonBlackjackTableV2RematchEvent{
            table_id       : 0x2::object::uid_to_inner(&arg0.id),
            schema_version : arg0.schema_version,
            round          : arg0.round,
            action_seq     : arg0.action_seq,
        };
        0x2::event::emit<JasonBlackjackTableV2RematchEvent>(v2);
    }
    ...
    public entry fun set_jason_blackjack_table_v2_ready(arg0: &mut JasonBlackjackTableV2, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(arg0.schema_version == 2, 8);
        assert!(arg0.phase == 0, 8);
        let v1 = 0;
        let v2 = false;
        while (v1 < 6) {
            let v3 = 0x1::vector::borrow<JasonBlackjackTableV2Seat>(&arg0.seats, v1);
            if (v3.occupied && v3.player == v0) {
                v2 = true;
            };
            v1 = v1 + 1;
        };
        ...
        v1 = 0;
        while (v1 < 6) {
            let v4 = 0x1::vector::borrow<JasonBlackjackTableV2Seat>(&arg0.seats, v1);
            if (v4.occupied && v4.player == v0) {
                0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v1).ready = arg1;
                arg0.action_seq = arg0.action_seq + 1;
                let v5 = JasonBlackjackTableV2ReadyEvent{
                    table_id       : 0x2::object::uid_to_inner(&arg0.id),
                    schema_version : arg0.schema_version,
                    round          : arg0.round,
                    action_seq     : arg0.action_seq,
                ...
                0x2::event::emit<JasonBlackjackTableV2ReadyEvent>(v5);
                return
            };
            v1 = v1 + 1;
        };
    ...
    fun settle_jason_blackjack_table_v2(arg0: &mut JasonBlackjackTableV2, arg1: &mut JasonHouse, arg2: &RevenueConfig, arg3: &mut 0x2::random::RandomGenerator, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = blackjack_hand_total(&arg0.dealer_cards);
        while (v0 < 17) {
            0x1::vector::push_back<u8>(&mut arg0.dealer_cards, blackjack_draw(arg3));
            v0 = blackjack_hand_total(&arg0.dealer_cards);
        };
        arg0.dealer_resolved = true;
        arg1.round = arg1.round + 1;
        let v1 = 0;
        while (v1 < 6) {
            if (0x1::vector::borrow<JasonBlackjackTableV2Seat>(&arg0.seats, v1).occupied) {
                let v2 = 0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v1);
                let v3 = v2.player;
                let v4 = v2.wager;
                let v5 = blackjack_hand_total(&v2.player_cards);
                let v6 = v2.result;
                let v7 = if (v6 == 4 || v5 > 21) {
                    v6
                } else {
                    blackjack_result(&0x1::vector::borrow<JasonBlackjackTableV2Seat>(&arg0.seats, v1).player_cards, v5, &arg0.dealer_cards, v0)
                };
                let v8 = if (v7 == 4) {
                    0
                } else {
                    v4 * arg2.fee_bps / 10000
                };
                let v9 = if (v7 == 3) {
                    250
                } else if (v7 == 1) {
                ...
                assert!(v10 <= v11 && v8 <= v11 - v10, 4);
                if (v10 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>>(0x2::coin::from_balance<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(0x2::balance::split<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&mut arg1.vault, v10), arg4), v3);
                };
                if (v8 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>>(0x2::coin::from_balance<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(0x2::balance::split<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&mut arg1.vault, v8), arg4), arg2.recipient);
                };
                let v12 = 0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v1);
                v12.status = 1;
                v12.result = v7;
                v12.payout = v10;
                v12.fee = v8;
                let v13 = JasonBlackjackTableV2SettledEvent{
                    table_id       : 0x2::object::uid_to_inner(&arg0.id),
                    schema_version : arg0.schema_version,
                    round          : arg0.round,
                    action_seq     : arg0.action_seq,
                ...
                0x2::event::emit<JasonBlackjackTableV2SettledEvent>(v13);
                if (v8 > 0) {
                    let v14 = RevenueEvent{
                        player    : v3,
                        recipient : arg2.recipient,
                        game      : 3,
                        stake     : v4,
                    ...
                    0x2::event::emit<RevenueEvent>(v14);
                };
            };
            v1 = v1 + 1;
        };
    ...
    public entry fun stand_jason_blackjack_table_v2(arg0: &mut JasonBlackjackTableV2, arg1: &mut JasonHouse, arg2: &RevenueConfig, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: u8, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = (arg5 as u64);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        let v2 = 0x2::tx_context::sender(arg7);
        assert!(arg0.schema_version == 2, 8);
        ...
        if (v7) {
            let v9 = &mut v4;
            settle_jason_blackjack_table_v2(arg0, arg1, arg2, v9, arg7);
        };
    }
    ...
    public entry fun start_jason_blackjack_table_v2(arg0: &mut JasonBlackjackTableV2, arg1: &JasonHouse, arg2: &RevenueConfig, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.schema_version == 2, 8);
        assert!(arg0.phase == 0, 8);
        assert!(0x2::tx_context::sender(arg5) == arg0.host, 9);
        assert!(!arg1.paused, 2);
        assert!(arg2.recipient == @0xd2cebe8666352e1ddb3dc7f271340432c983fc81017b3d6f7873dd66881433a4 && arg2.fee_bps == 250, 7);
        let v0 = 0;
        let v1 = 0;
        ...
        while (v2 < 6) {
            ...
            if (v3.occupied) {
                v0 = v0 + 1;
                assert!(v3.ready, 11);
                let v4 = v1 + v3.wager * 250 / 100;
                v1 = v4 + v3.wager * arg2.fee_bps / 10000;
            };
            v2 = v2 + 1;
        };
        assert!(v0 >= 2, 11);
        assert!(0x2::balance::value<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&arg1.vault) >= v1, 4);
        let v5 = 0x2::random::new_generator(arg3, arg5);
        let v6 = &mut v5;
        0x1::vector::push_back<u8>(&mut arg0.dealer_cards, blackjack_draw(v6));
        let v7 = &mut v5;
        0x1::vector::push_back<u8>(&mut arg0.dealer_cards, blackjack_draw(v7));
        v2 = 0;
        while (v2 < 6) {
            let v8 = 0x1::vector::borrow_mut<JasonBlackjackTableV2Seat>(&mut arg0.seats, v2);
            if (v8.occupied) {
                let v9 = &mut v5;
                0x1::vector::push_back<u8>(&mut v8.player_cards, blackjack_draw(v9));
                let v10 = &mut v5;
        ...
        arg0.round = arg0.round + 1;
        arg0.action_seq = arg0.action_seq + 1;
        arg0.turn_seat = first_v2_active_seat(arg0);
        arg0.turn_deadline_ms = 0x2::clock::timestamp_ms(arg4) + 60000;
        let v11 = JasonBlackjackTableV2StartedEvent{
            table_id         : 0x2::object::uid_to_inner(&arg0.id),
            schema_version   : arg0.schema_version,
            round            : arg0.round,
            action_seq       : arg0.action_seq,
        ...
        0x2::event::emit<JasonBlackjackTableV2StartedEvent>(v11);
    }

    public entry fun timeout_jason_blackjack_table_v2(arg0: &mut JasonBlackjackTableV2, arg1: &mut JasonHouse, arg2: &RevenueConfig, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.turn_seat != 255, 11);
        let v0 = arg0.turn_seat;
        forfeit_jason_blackjack_table_v2_internal(arg0, arg1, arg2, arg3, arg4, v0, arg5, true, arg6);
    }

    public entry fun transfer_jason_blackjack_table_v2_host(arg0: &mut JasonBlackjackTableV2, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(arg0.schema_version == 2, 8);
        assert!(arg0.phase == 0, 8);
        assert!(v0 == arg0.host, 9);
        ...
        arg0.host = arg1;
        arg0.action_seq = arg0.action_seq + 1;
        let v4 = JasonBlackjackTableV2HostTransferredEvent{
            table_id       : 0x2::object::uid_to_inner(&arg0.id),
            schema_version : arg0.schema_version,
            round          : arg0.round,
            action_seq     : arg0.action_seq,
        ...
        0x2::event::emit<JasonBlackjackTableV2HostTransferredEvent>(v4);
    }
