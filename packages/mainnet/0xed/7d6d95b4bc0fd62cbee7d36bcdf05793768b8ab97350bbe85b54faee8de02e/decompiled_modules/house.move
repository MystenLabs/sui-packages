module 0xed7d6d95b4bc0fd62cbee7d36bcdf05793768b8ab97350bbe85b54faee8de02e::house {
    ...
    public(friend) fun get_fee_from_payment<T0>(arg0: &mut House, arg1: &mut 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.fee_balance, v0), 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg1, 0xed7d6d95b4bc0fd62cbee7d36bcdf05793768b8ab97350bbe85b54faee8de02e::utils::mul_div_u64(0x2::coin::value<T0>(arg1), arg0.fee_percentage, 10000), arg2)));
    }
