module 0xedce87372f10bd329114b8ab8092620bc16a89fa6f3890eb813ec28ed043d08b::reward7322 {
    struct REWARD7322 has drop {
        dummy_field: bool,
    }

    struct TICKET_7322 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7322(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7322>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7322>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7322, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7322>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7322>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7322>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7322>>(v5, 0x2::tx_context::sender(arg1));
    }
