module 0xedfc10662248331a4092024d984ae9657a7b80eb6d4919183c188202e3471890::reward1012 {
    struct REWARD1012 has drop {
        dummy_field: bool,
    }

    struct TICKET_1012 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1012(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1012>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1012>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1012, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1012>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1012>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1012>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1012>>(v5, 0x2::tx_context::sender(arg1));
    }
