module 0xedd5a716fc7a7cdd829af4e0af9151705831453a031fe83d83e52cbe0b3dbe8b::ob_kiosk {
    ...
    public fun borrow_nft_mut<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: 0x1::option::Option<0x1::type_name::TypeName>, arg3: &mut 0x2::tx_context::TxContext) : 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::borrow_request::BorrowRequest<Witness, T0> {
        assert_version(0x2::kiosk::uid_mut(arg0));
        ...
        0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::borrow_request::new<Witness, T0>(v3, v1, 0x2::tx_context::sender(arg3), arg2, v2, arg3)
    }
    ...
    public fun get_transfer_request_auth<T0>(arg0: &0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::transfer_request::TransferRequest<T0>) : &0x1::type_name::TypeName {
        let v0 = AuthTransferRequestDfKey{dummy_field: false};
        0x2::dynamic_field::borrow<AuthTransferRequestDfKey, 0x1::type_name::TypeName>(0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::transfer_request::metadata<T0>(arg0), v0)
    }

    public fun get_transfer_request_auth_<T0, T1>(arg0: &0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::request::RequestBody<0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::request::WithNft<T0, T1>>) : &0x1::type_name::TypeName {
        let v0 = AuthTransferRequestDfKey{dummy_field: false};
        0x2::dynamic_field::borrow<AuthTransferRequestDfKey, 0x1::type_name::TypeName>(0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::request::metadata<0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::request::WithNft<T0, T1>>(arg0), v0)
    }
    ...
    entry fun migrate_as_pub(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::package::Publisher) {
        assert!(0x2::package::from_package<0xedd5a716fc7a7cdd829af4e0af9151705831453a031fe83d83e52cbe0b3dbe8b::kiosk::KIOSK>(arg1), 0);
        let v0 = VersionDfKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<VersionDfKey, u64>(0x2::kiosk::uid_mut(arg0), v0);
        assert!(*v1 < 1, 999);
        *v1 = 1;
    ...
    public fun return_nft<T0: drop, T1: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::borrow_request::BorrowRequest<Witness, T1>, arg2: &0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::request::Policy<0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::request::WithNft<T1, 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::borrow_request::BORROW_REQ>>) {
        assert_version(0x2::kiosk::uid_mut(arg0));
        let v0 = Witness{dummy_field: false};
        let (v1, v2) = 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::borrow_request::confirm<Witness, T1>(v0, arg1, arg2);
        let v3 = pop_cap(arg0);
    ...
    public fun set_transfer_request_auth<T0, T1>(arg0: &mut 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::transfer_request::TransferRequest<T0>, arg1: &T1) {
        let v0 = AuthTransferRequestDfKey{dummy_field: false};
        0x2::dynamic_field::add<AuthTransferRequestDfKey, 0x1::type_name::TypeName>(0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::transfer_request::metadata_mut<T0>(arg0), v0, 0x1::type_name::get<T1>());
    }

    public fun set_transfer_request_auth_<T0, T1, T2>(arg0: &mut 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::request::RequestBody<0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::request::WithNft<T0, T1>>, arg1: &T2) {
        let v0 = AuthTransferRequestDfKey{dummy_field: false};
        0x2::dynamic_field::add<AuthTransferRequestDfKey, 0x1::type_name::TypeName>(0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::request::metadata_mut<0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::request::WithNft<T0, T1>>(arg0), v0, 0x1::type_name::get<T2>());
    }
    ...
    public fun transfer_delegated<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &0x2::object::UID, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::transfer_request::TransferRequest<T0> {
        assert_version(0x2::kiosk::uid_mut(arg0));
    ...
    public fun transfer_locked_nft<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &0x2::object::UID, arg4: &mut 0x2::tx_context::TxContext) : 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::transfer_request::TransferRequest<T0> {
        assert_version(0x2::kiosk::uid_mut(arg0));
        ...
        0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::transfer_request::from_sui<T0>(v2, arg2, 0x2::object::uid_to_address(arg3), arg4)
    }

    fun transfer_nft_<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (T0, 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::transfer_request::TransferRequest<T0>) {
        let v0 = get_nft<T0>(arg0, arg1, arg2, arg4);
        (v0, 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::transfer_request::new<T0>(arg1, arg2, 0x2::object::id<0x2::kiosk::Kiosk>(arg0), arg3, arg4))
    }

    public fun transfer_signed<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::transfer_request::TransferRequest<T0> {
        assert_version(0x2::kiosk::uid_mut(arg0));
    ...
    public fun withdraw_nft<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: &0x2::object::UID, arg3: &mut 0x2::tx_context::TxContext) : (T0, 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::withdraw_request::WithdrawRequest<T0>) {
        assert_version(0x2::kiosk::uid_mut(arg0));
        withdraw_nft_<T0>(arg0, arg1, 0x2::object::uid_to_address(arg2), arg3)
    }

    fun withdraw_nft_<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : (T0, 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::withdraw_request::WithdrawRequest<T0>) {
        let v0 = get_nft<T0>(arg0, arg1, arg2, arg3);
        (v0, 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::withdraw_request::new<T0>(arg2, arg3))
    }

    public fun withdraw_nft_signed<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) : (T0, 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::withdraw_request::WithdrawRequest<T0>) {
        assert_version(0x2::kiosk::uid_mut(arg0));
