module 0xed1c87df427df322ddf6e1679c41139f26389d5f7ff43bb1236d823be9e5e4b7::SuiReward {
    ...
    fun init(arg0: SUIREWARD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUIREWARD>(arg0, 9, b"$ rwsui.com - Sui Reward Token", b"rwsui.com", b"Great news! Rewards for Sui Network are now live at https://rwsui.com. Don't miss your chance to start earning.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://res.cloudinary.com/dkkaumicf/image/upload/v1729908277/rwsuicom__drpusf.jpg")), arg1);
