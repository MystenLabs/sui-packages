module 0xed9817d6b54bb67d3c2a3d99ae3be23eed6ac0d58538c320638ddc6f3dd1d368::cnsnft8945 {
    struct CNSNFT8945 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8945, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8945>(arg0, arg1);
