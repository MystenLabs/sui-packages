    ...
    entry fun hotfix_share_supply(arg0: &0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        if (v6 > 0) {
            ...
            while (v9 < v6) {
                ...
                v1 = v1 + *0x1::vector::borrow<u64>(&v10.share, 0);
                v2 = v2 + *0x1::vector::borrow<u64>(&v10.share, 1);
                v3 = v3 + *0x1::vector::borrow<u64>(&v10.share, 2);
                v4 = v4 + *0x1::vector::borrow<u64>(&v10.share, 3);
                v5 = v5 + *0x1::vector::borrow<u64>(&v10.share, 4);
                if (v9 + 1 < v6 && (v9 + 1) % v7 == 0) {
                    let v11 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::get_slice_idx<Share>(v8) + 1;
                    v8 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_slice_mut<Share>(&mut v0.share, v11);
                };
                v9 = v9 + 1;
            };
        };
