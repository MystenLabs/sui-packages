module 0xedc08aef0861209e9f7d22e0ed01ca1d1af2fa7f3e55321dbff4207d6121f5ab::cnsnft1758 {
    struct CNSNFT1758 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1758, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3398"));
        let v4 = 0x2::package::claim<CNSNFT1758>(arg0, arg1);
