module 0xedde829b4b34571e2044e95c46de9b319727057e0f113a2945fb22f273634ea8::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"fatty", b"fatman", b"fat", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-13T02-11-01.315Z-Scherm%C3%82%C2%ADafbeelding%202025-09-11%20om%2018.41.48.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"fatman"),
            symbol     : 0x1::string::utf8(b"fatty"),
            decimals   : 9,
