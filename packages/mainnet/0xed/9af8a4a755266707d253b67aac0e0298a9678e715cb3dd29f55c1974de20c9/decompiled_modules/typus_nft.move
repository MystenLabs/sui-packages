module 0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::typus_nft {
    ...
    struct Pool has key {
        id: 0x2::object::UID,
        tails: 0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::TableVec<Tails>,
        num: u64,
        is_live: bool,
        start_ms: u64,
    }
    ...
    entry fun close_pool(arg0: &ManagerCap, arg1: Pool) {
        ...
        0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::destroy_empty<Tails>(v1);
    ...
    entry fun deposit_nft(arg0: &ManagerCap, arg1: &mut Pool, arg2: 0x1::string::String, arg3: u64, arg4: vector<u8>, arg5: vector<0x1::string::String>, arg6: vector<0x1::string::String>, arg7: &mut 0x2::tx_context::TxContext) {
        0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::push_back<Tails>(&mut arg1.tails, new_nft(arg2, arg3, 0x2::url::new_unsafe_from_bytes(arg4), 0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::utils::from_vec_to_map<0x1::string::String, 0x1::string::String>(arg5, arg6), arg7));
        arg1.num = arg1.num + 1;
    }
    ...
    fun init(arg0: TYPUS_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v4;
        let v6 = v3;
        0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::royalty_rule::add<Tails>(&mut v6, &v5, 1000, 1000000000);
    ...
    fun mint(arg0: &mut Pool, arg1: Whitelist, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : Tails {
        ...
        let v0 = 0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::length<Tails>(&arg0.tails);
        assert!(v0 > 0, 3);
        let Whitelist {
            id  : v1,
            for : v2,
        ...
        let v3 = if (v0 == 1) {
            0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::pop_back<Tails>(&mut arg0.tails)
        } else {
            0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::swap<Tails>(&mut arg0.tails, ((0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::utils::rand(arg3) % ((v0 - 1) as u256)) as u64), v0 - 1);
            0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::pop_back<Tails>(&mut arg0.tails)
        };
        let v4 = v3;
        let v5 = MintEvent{
    ...
    entry fun new_pool(arg0: &ManagerCap, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool{
            ...
            tails    : 0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::empty<Tails>(arg2),
            num      : 0,
            is_live  : false,
            start_ms : arg1,
        };
    ...
    entry fun pool_set_n_level(arg0: &ManagerCap, arg1: &mut Pool, arg2: u64, arg3: u64) {
        assert!(0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::length<Tails>(&arg1.tails) >= arg2, 2);
        let v0 = 0;
        while (v0 < arg2) {
            let v1 = 0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::borrow_mut<Tails>(&mut arg1.tails, v0);
    ...
    entry fun resend_nfts_event(arg0: &ManagerCap, arg1: address, arg2: 0x1::string::String, arg3: u64, arg4: vector<u8>, arg5: vector<0x1::string::String>, arg6: vector<0x1::string::String>, arg7: &0x2::tx_context::TxContext) {
        ...
        let v1 = MintEvent{
            ...
            attributes  : 0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::utils::from_vec_to_map<0x1::string::String, 0x1::string::String>(arg5, arg6),
    ...
    entry fun send_nfts(arg0: &ManagerCap, arg1: &mut Pool, arg2: &0x2::transfer_policy::TransferPolicy<Tails>, arg3: address, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        while (arg4 > 0) {
            let v4 = 0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::pop_back<Tails>(&mut arg1.tails);
            let v5 = MintEvent{
                id          : 0x2::object::id<Tails>(&v4),
                name        : v4.name,
                description : v4.description,
    ...
    entry fun update_policy_rules(arg0: &ManagerCap, arg1: &mut 0x2::transfer_policy::TransferPolicy<Tails>, arg2: &Royalty) {
        0x2::transfer_policy::remove_rule<Tails, 0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::royalty_rule::Rule, 0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::royalty_rule::Config>(arg1, &arg2.policy_cap);
        0x28837139f6231975a7982c70b02f30e849e0fac570d8cda928d1931ea4f1a7a8::royalty_rule::add<Tails>(arg1, &arg2.policy_cap, 1000, 1000000000);
        0x28837139f6231975a7982c70b02f30e849e0fac570d8cda928d1931ea4f1a7a8::kiosk_lock_rule::add<Tails>(arg1, &arg2.policy_cap);
    }

    entry fun update_pool_nft(arg0: &ManagerCap, arg1: &mut Pool, arg2: u64, arg3: 0x2::object::ID, arg4: u64, arg5: vector<u8>) {
        let v0 = 0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::borrow_mut<Tails>(&mut arg1.tails, arg2);
    ...
    public(friend) fun withdraw_nfts(arg0: &ManagerCap, arg1: &mut Pool, arg2: u64) : vector<Tails> {
        ...
        while (arg2 > 0) {
            0x1::vector::push_back<Tails>(&mut v0, 0xed9af8a4a755266707d253b67aac0e0298a9678e715cb3dd29f55c1974de20c9::table_vec::pop_back<Tails>(&mut arg1.tails));
            arg2 = arg2 - 1;
        };
        v0
    }
