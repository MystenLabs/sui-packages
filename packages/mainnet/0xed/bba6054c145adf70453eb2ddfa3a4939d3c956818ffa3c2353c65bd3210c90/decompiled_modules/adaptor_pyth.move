module 0xedbba6054c145adf70453eb2ddfa3a4939d3c956818ffa3c2353c65bd3210c90::adaptor_pyth {
    ...
    fun normalize_to_wad(arg0: u64, arg1: bool, arg2: u32) : u128 {
        assert!(arg2 <= 38, 3);
        let v0 = (arg0 as u128);
        let v1 = 0xedbba6054c145adf70453eb2ddfa3a4939d3c956818ffa3c2353c65bd3210c90::oracle_math::pow10(arg2);
        if (arg1) {
            0xedbba6054c145adf70453eb2ddfa3a4939d3c956818ffa3c2353c65bd3210c90::oracle_math::mul_div_down(v0, 1000000000000000000, v1)
        } else {
            assert!(v1 <= 340282366920938463463 / v0, 3);
            0xedbba6054c145adf70453eb2ddfa3a4939d3c956818ffa3c2353c65bd3210c90::oracle_math::mul_checked(0xedbba6054c145adf70453eb2ddfa3a4939d3c956818ffa3c2353c65bd3210c90::oracle_math::mul_checked(v0, v1), 1000000000000000000)
        }
    }

    public fun update_price<T0>(arg0: &mut 0xedbba6054c145adf70453eb2ddfa3a4939d3c956818ffa3c2353c65bd3210c90::pyth_oracle::Oracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
