module 0xed3ed55603c350549b1c4be6867d28b835a264f0a38b9a883aaeb5ce5c5754a6::toby {
    ...
    fun init(arg0: TOBY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<TOBY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TOBY    ")))), trim_right(b"toby the turtle                 "), trim_right(b"Meet Toby the Turtle. Invented by prompting chat GBT 4 the same way as turbo toad, made to compete and become friends with Turbo Toad. Toby is here to make waves in the crypto space, make a great community and show that steady always wins the race!                                                                        "), v2, arg1);
