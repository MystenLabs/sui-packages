module 0xed5e43a2003a3520bdb5246ef1c917a80ccec21b65a13fde286a2b670a58720a::idbitsui_bridge {
    ...
    fun bytes32_eq(arg0: &vector<u8>, arg1: &vector<u8>) : bool {
        if (0x1::vector::length<u8>(arg0) != 32 || 0x1::vector::length<u8>(arg1) != 32) {
            return false
        };
        let v0 = 0;
        while (v0 < 32) {
    ...
    entry fun redeem_from_evm(arg0: &AdminCap, arg1: &Bridge, arg2: &mut 0x2::coin::TreasuryCap<0xb9e474078268920490b9da435bb6d68ae1a0d96f81664d188fa3a821f3ed4f43::idbitsui::IDBITSUI>, arg3: u16, arg4: vector<u8>, arg5: u128, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::option::extract<Peer>(&mut v0);
        if (0x1::vector::length<u8>(&arg4) != 32) {
            abort 3
        };
        if (!bytes32_eq(&arg4, &v1.emitter32)) {
            abort 5
        };
        let v2 = scale_amount(arg5, v1.remote_decimals, arg1.local_decimals);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xb9e474078268920490b9da435bb6d68ae1a0d96f81664d188fa3a821f3ed4f43::idbitsui::IDBITSUI>>(0x2::coin::mint<0xb9e474078268920490b9da435bb6d68ae1a0d96f81664d188fa3a821f3ed4f43::idbitsui::IDBITSUI>(arg2, (v2 as u64), arg7), 0x2::address::from_bytes(arg6));
    }

    fun scale_amount(arg0: u128, arg1: u8, arg2: u8) : u128 {
        if (arg1 == arg2) {
            arg0
        } else if (arg1 > arg2) {
            arg0 / pow10(arg1 - arg2)
        } else {
            arg0 * pow10(arg2 - arg1)
        }
    }
