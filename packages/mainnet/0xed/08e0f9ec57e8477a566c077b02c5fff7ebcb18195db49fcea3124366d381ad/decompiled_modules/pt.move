module 0xed08e0f9ec57e8477a566c077b02c5fff7ebcb18195db49fcea3124366d381ad::pt {
    ...
    public(friend) fun create<T0: drop>(arg0: vector<u8>, arg1: vector<u8>, arg2: u8, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = PTCoin<0xed08e0f9ec57e8477a566c077b02c5fff7ebcb18195db49fcea3124366d381ad::sy::SYCoin<T0>>{dummy_field: false};
        let v1 = PTStruct<0xed08e0f9ec57e8477a566c077b02c5fff7ebcb18195db49fcea3124366d381ad::sy::SYCoin<T0>>{
            id       : 0x2::object::new(arg4),
            expiry   : arg3,
            decimals : arg2,
            symbol   : arg1,
            name     : arg0,
            supply   : 0x2::balance::create_supply<PTCoin<0xed08e0f9ec57e8477a566c077b02c5fff7ebcb18195db49fcea3124366d381ad::sy::SYCoin<T0>>>(v0),
        };
        let v2 = CreationEvent<0xed08e0f9ec57e8477a566c077b02c5fff7ebcb18195db49fcea3124366d381ad::sy::SYCoin<T0>>{
        ...
        0x2::event::emit<CreationEvent<0xed08e0f9ec57e8477a566c077b02c5fff7ebcb18195db49fcea3124366d381ad::sy::SYCoin<T0>>>(v2);
        0x2::transfer::share_object<PTStruct<0xed08e0f9ec57e8477a566c077b02c5fff7ebcb18195db49fcea3124366d381ad::sy::SYCoin<T0>>>(v1);
    }
