module 0xc935f0ab11a24b32b6f8796bc78d93ce6f2d2969f5d4b4f6657b24352b61408a::launchpad {
    ...
    struct HolderRewardsAdded has copy, drop {
        launch_id: 0x2::object::ID,
        coin_type: 0x1::string::String,
        quote_type: 0x1::string::String,
        coin_sold: u64,
    ...
    struct HolderRewardsPaid has copy, drop {
        launch_id: 0x2::object::ID,
        quote_type: 0x1::string::String,
    ...
    struct HolderRewardsKey has copy, drop, store {
        dummy_field: bool,
    }

    struct PendingRewardsKey has copy, drop, store {
        dummy_field: bool,
    }

    struct RewardsPotKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    fun add_holder_rewards<T0, T1>(arg0: &mut Launch<T0, T1>, arg1: 0x2::balance::Balance<T1>, arg2: u64, arg3: 0x2::balance::Balance<T1>, arg4: &mut 0x2::coin_registry::Currency<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        0x2::balance::join<T1>(&mut arg1, arg3);
        0x2::balance::join<T1>(&mut arg1, 0x2::balance::withdraw_all<T1>(&mut arg0.pending_buyback));
        let v0 = 0x2::balance::value<T1>(&arg1);
        if (v0 > 0) {
            let v1 = RewardsPotKey{dummy_field: false};
            if (0x2::dynamic_field::exists<RewardsPotKey>(&arg0.id, v1)) {
                let v2 = RewardsPotKey{dummy_field: false};
                0x2::balance::join<T1>(0x2::dynamic_field::borrow_mut<RewardsPotKey, 0x2::balance::Balance<T1>>(&mut arg0.id, v2), arg1);
            } else {
                let v3 = RewardsPotKey{dummy_field: false};
                0x2::dynamic_field::add<RewardsPotKey, 0x2::balance::Balance<T1>>(&mut arg0.id, v3, arg1);
            };
            let v4 = HolderRewardsAdded{
                launch_id  : 0x2::object::id<Launch<T0, T1>>(arg0),
                coin_type  : type_string<T0>(),
                quote_type : type_string<T1>(),
                coin_sold  : arg2,
                sold_for   : 0x2::balance::value<T1>(&arg3),
                added      : v0,
                pot        : rewards_pot<T0, T1>(arg0),
            };
            0x2::event::emit<HolderRewardsAdded>(v4);
        } else {
            0x2::balance::destroy_zero<T1>(arg1);
        };
        let v5 = 0x2::balance::withdraw_all<T0>(&mut arg0.dust);
        burn_all<T0, T1>(arg0, arg4, v5, 0x2::balance::zero<T0>(), arg5);
    }
    ...
    fun check_fee_route(arg0: &Launchpad, arg1: u8) {
        let v0 = if (arg1 == 0) {
            true
        } else if (arg1 == 1) {
            true
        ...
        assert!(v0, 13906839216636428311);
        if (arg1 == 2) {
            let v1 = holder_rewards_distributor(arg0);
            assert!(0x1::option::is_some<address>(&v1), 13906839225227804717);
        };
    }

    fun check_launchable<T0, T1>(arg0: &Launchpad, arg1: u32, arg2: u64, arg3: u8, arg4: &0x1::string::String) {
        check_version(arg0);
        assert!(!arg0.paused, 13906839293944528899);
        assert!(is_quote_allowed<T1>(arg0), 13906839298239758343);
        assert!(0x2::vec_set::contains<u32>(&arg0.tick_spacings, &arg1), 13906839302534987787);
        assert!(arg2 <= 2000, 13906839306830479379);
        check_fee_route(arg0, arg3);
        assert!(0x1::string::length(arg4) <= 1024, 13906839315420545045);
        assert!(!0x2::table::contains<0x1::type_name::TypeName, 0x2::object::ID>(&arg0.by_coin, 0x1::type_name::with_defining_ids<T0>()), 13906839319716167711);
    }

    fun check_version(arg0: &Launchpad) {
        assert!(arg0.version == 2, 13906839186570215425);
    }
    ...
    public fun collect_as_a<T0, T1>(arg0: &Launchpad, arg1: &mut Launch<T0, T1>, arg2: &mut 0x2::coin_registry::Currency<T0>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        assert!(arg1.coin_is_a && 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg4) == arg1.pool_id, 13906836966074351651);
        ...
        if (arg1.fee_route == 1) {
            ...
            let (v6, v7) = swap_b_for_a<T0, T1>(arg3, arg4, v5, arg5);
            let v8 = v7;
            let v9 = v6;
        ...
        } else if (arg1.fee_route == 2) {
            let v12 = with_pending_rewards<T0, T1>(arg1, v3);
            let (v13, v14) = swap_a_for_b<T0, T1>(arg3, arg4, v12, arg5);
            let v15 = v14;
            keep_pending_rewards<T0, T1>(arg1, v15);
            add_holder_rewards<T0, T1>(arg1, v4, 0x2::balance::value<T0>(&v12) - 0x2::balance::value<T0>(&v15), v13, arg2, arg6);
        } else {
            let v16 = v4;
            0x2::balance::join<T1>(&mut v16, 0x2::balance::withdraw_all<T1>(&mut arg1.pending_buyback));
            pay_recipient<T0, T1>(arg1, v3, v16, arg2, arg6);
        };
    }
    ...
    public fun collect_as_b<T0, T1>(arg0: &Launchpad, arg1: &mut Launch<T0, T1>, arg2: &mut 0x2::coin_registry::Currency<T0>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        assert!(!arg1.coin_is_a && 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>>(arg4) == arg1.pool_id, 13906837172232781859);
        let v0 = LockAuth{dummy_field: false};
        ...
        if (arg1.fee_route == 1) {
            let v5 = v4;
            0x2::balance::join<T1>(&mut v5, 0x2::balance::withdraw_all<T1>(&mut arg1.pending_buyback));
            let (v6, v7) = swap_a_for_b<T1, T0>(arg3, arg4, v5, arg5);
            let v8 = v7;
            let v9 = v6;
            0x2::balance::join<T1>(&mut arg1.pending_buyback, v8);
            let v10 = burn_all<T0, T1>(arg1, arg2, v3, v9, arg6);
            ...
            let v12 = with_pending_rewards<T0, T1>(arg1, v3);
            let (v13, v14) = swap_b_for_a<T1, T0>(arg3, arg4, v12, arg5);
            let v15 = v14;
            keep_pending_rewards<T0, T1>(arg1, v15);
            add_holder_rewards<T0, T1>(arg1, v4, 0x2::balance::value<T0>(&v12) - 0x2::balance::value<T0>(&v15), v13, arg2, arg6);
        } else {
    ...
    fun distributor(arg0: &Launchpad) : address {
        let v0 = HolderRewardsKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists<HolderRewardsKey>(&arg0.id, v0), 13906839242407673901);
        let v1 = HolderRewardsKey{dummy_field: false};
        *0x2::dynamic_field::borrow<HolderRewardsKey, address>(&arg0.id, v1)
    }
    ...
    public fun holder_rewards_distributor(arg0: &Launchpad) : 0x1::option::Option<address> {
        let v0 = HolderRewardsKey{dummy_field: false};
        if (0x2::dynamic_field::exists<HolderRewardsKey>(&arg0.id, v0)) {
            let v2 = HolderRewardsKey{dummy_field: false};
            0x1::option::some<address>(*0x2::dynamic_field::borrow<HolderRewardsKey, address>(&arg0.id, v2))
        } else {
    ...
    fun keep_pending_rewards<T0, T1>(arg0: &mut Launch<T0, T1>, arg1: 0x2::balance::Balance<T0>) {
        if (0x2::balance::value<T0>(&arg1) == 0) {
            0x2::balance::destroy_zero<T0>(arg1);
        } else {
            let v0 = PendingRewardsKey{dummy_field: false};
            0x2::dynamic_field::add<PendingRewardsKey, 0x2::balance::Balance<T0>>(&mut arg0.id, v0, arg1);
        };
    }
    ...
    public fun launch_as_a<T0, T1>(arg0: &mut Launchpad, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u32, arg7: u32, arg8: u64, arg9: u8, arg10: address, arg11: u64, arg12: 0x1::string::String, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::is_right_order<T0, T1>(), 13906835806431477769);
    ...
    public fun launch_as_b<T0, T1>(arg0: &mut Launchpad, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u32, arg7: u32, arg8: u64, arg9: u8, arg10: address, arg11: u64, arg12: 0x1::string::String, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
        check_launchable<T0, T1>(arg0, arg6, arg8, arg9, &arg12);
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::is_right_order<T1, T0>(), 13906836210158403593);
        take_launch_fee(arg0, arg5, arg14);
        let v0 = max_aligned_tick(arg6);
        let v1 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg7);
        assert_aligned(arg7, arg6);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::gt(v1, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::neg_from(v0)) && 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lt(v1, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from(v0)), 13906836235928600591);
        let v2 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::neg_from(v0);
        let v3 = 0x2::coin::value<T0>(&arg3);
        assert!(v3 > 0, 13906836253108600849);
    ...
    public fun migrate(arg0: &mut Launchpad, arg1: &AdminCap) {
        assert!(arg0.version < 2, 13906838855860355113);
        arg0.version = 2;
        emit_settings(arg0);
    }
    ...
    public fun pay_holder_rewards<T0, T1>(arg0: &Launchpad, arg1: &mut Launch<T0, T1>, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        assert!(0x2::tx_context::sender(arg4) == distributor(arg0), 13906838271745327153);
        assert!(0x1::vector::length<address>(&arg2) == 0x1::vector::length<u64>(&arg3), 13906838276040425523);
        let v0 = 0;
        let v1 = &arg3;
        let v2 = 0;
        ...
        assert!(v0 <= rewards_pot<T0, T1>(arg1), 13906838293220425781);
        if (v0 == 0) {
            return
        };
        let v3 = RewardsPotKey{dummy_field: false};
        let v4 = 0x2::dynamic_field::borrow_mut<RewardsPotKey, 0x2::balance::Balance<T1>>(&mut arg1.id, v3);
        let v5 = 0;
        while (v5 < 0x1::vector::length<address>(&arg2)) {
            send<T1>(0x2::balance::split<T1>(v4, *0x1::vector::borrow<u64>(&arg3, v5)), *0x1::vector::borrow<address>(&arg2, v5), arg4);
            v5 = v5 + 1;
        };
        let v6 = 0x2::balance::value<T1>(v4);
        if (v6 == 0) {
            let v7 = RewardsPotKey{dummy_field: false};
            0x2::balance::destroy_zero<T1>(0x2::dynamic_field::remove<RewardsPotKey, 0x2::balance::Balance<T1>>(&mut arg1.id, v7));
        };
        let v8 = HolderRewardsPaid{
            launch_id  : 0x2::object::id<Launch<T0, T1>>(arg1),
            quote_type : type_string<T1>(),
            recipients : arg2,
            amounts    : arg3,
        ...
        0x2::event::emit<HolderRewardsPaid>(v8);
    }
    ...
    public fun pending_rewards<T0, T1>(arg0: &Launch<T0, T1>) : u64 {
        let v0 = PendingRewardsKey{dummy_field: false};
        if (0x2::dynamic_field::exists<PendingRewardsKey>(&arg0.id, v0)) {
            let v2 = PendingRewardsKey{dummy_field: false};
            0x2::balance::value<T0>(0x2::dynamic_field::borrow<PendingRewardsKey, 0x2::balance::Balance<T0>>(&arg0.id, v2))
        } else {
            0
        }
    }
    ...
    fun record<T0, T1>(arg0: &mut Launchpad, arg1: Opening, arg2: 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(!0x2::table::contains<0x1::type_name::TypeName, 0x2::object::ID>(&arg0.by_coin, v0), 13906836635361607711);
    ...
    public fun rewards_pot<T0, T1>(arg0: &Launch<T0, T1>) : u64 {
        let v0 = RewardsPotKey{dummy_field: false};
        if (0x2::dynamic_field::exists<RewardsPotKey>(&arg0.id, v0)) {
            let v2 = RewardsPotKey{dummy_field: false};
            0x2::balance::value<T1>(0x2::dynamic_field::borrow<RewardsPotKey, 0x2::balance::Balance<T1>>(&arg0.id, v2))
        } else {
            0
        }
    }
    ...
    public fun set_buyback_bps(arg0: &mut Launchpad, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 <= 10000, 13906838692651335717);
    ...
    public fun set_creator_fee_bps(arg0: &mut Launchpad, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 <= 10000, 13906838666881531941);
    ...
    public fun set_fee_recipient<T0, T1>(arg0: &Launchpad, arg1: &mut Launch<T0, T1>, arg2: address, arg3: &0x2::tx_context::TxContext) {
        check_version(arg0);
        assert!(0x2::tx_context::sender(arg3) == arg1.creator, 13906838482197676065);
        let v0 = if (arg2 == @0x0) {
            arg1.creator
        } else {
            arg2
    ...
    public fun set_fee_route<T0, T1>(arg0: &Launchpad, arg1: &mut Launch<T0, T1>, arg2: u8, arg3: &0x2::tx_context::TxContext) {
        check_version(arg0);
        assert!(0x2::tx_context::sender(arg3) == arg1.creator, 13906838439248003105);
        assert!(arg1.fee_route != 2, 13906838443543625771);
        check_fee_route(arg0, arg2);
        arg1.fee_route = arg2;
    ...
    public fun set_holder_rewards_distributor(arg0: &mut Launchpad, arg1: &AdminCap, arg2: address) {
        assert!(arg2 != @0x0, 13906838593867743279);
        let v0 = HolderRewardsKey{dummy_field: false};
        if (0x2::dynamic_field::exists<HolderRewardsKey>(&arg0.id, v0)) {
            let v1 = HolderRewardsKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<HolderRewardsKey, address>(&mut arg0.id, v1) = arg2;
        } else {
            let v2 = HolderRewardsKey{dummy_field: false};
            0x2::dynamic_field::add<HolderRewardsKey, address>(&mut arg0.id, v2, arg2);
        };
        emit_settings(arg0);
    }

    public fun set_launch_fee(arg0: &mut Launchpad, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 <= 100000000000, 13906838636816891943);
    ...
    fun spendable(arg0: u64) : u64 {
        let v0 = arg0 / 1000 + 10;
        assert!(arg0 > v0, 13906839444269826073);
        arg0 - v0
    }
    ...
    fun swap_a_for_b<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>) {
        let v0 = 0x2::balance::value<T0>(&arg2);
        if (v0 == 0 || !0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::is_allow_swap<T0, T1>(arg1)) {
            return (0x2::balance::zero<T1>(), arg2)
        };
        let v1 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg1);
        let v2 = swap_limit(v1, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::fee_rate<T0, T1>(arg1), false);
        if (v2 >= v1) {
            return (0x2::balance::zero<T1>(), arg2)
        };
        let (_, v4, _, _) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::compute_swap_step(v1, v2, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::liquidity<T0, T1>(arg1), v0, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::fee_rate<T0, T1>(arg1), true, true);
        if (v4 == 0) {
            return (0x2::balance::zero<T1>(), arg2)
        };
        let (v7, v8, v9) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg0, arg1, true, true, v0, v2, arg3);
        let v10 = v9;
        0x2::balance::destroy_zero<T0>(v7);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg0, arg1, 0x2::balance::split<T0>(&mut arg2, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T1>(&v10)), 0x2::balance::zero<T1>(), v10);
        (v8, arg2)
    }

    fun swap_b_for_a<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::balance::Balance<T1>, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        let v0 = 0x2::balance::value<T1>(&arg2);
        if (v0 == 0 || !0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::is_allow_swap<T0, T1>(arg1)) {
            return (0x2::balance::zero<T0>(), arg2)
        };
        let v1 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg1);
        let v2 = swap_limit(v1, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::fee_rate<T0, T1>(arg1), true);
        if (v2 <= v1) {
            return (0x2::balance::zero<T0>(), arg2)
        };
    ...
    fun swap_limit(arg0: u128, arg1: u64, arg2: bool) : u128 {
    ...
    fun take_launch_fee(arg0: &Launchpad, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= arg0.launch_fee, 13906839341189300229);
    ...
    fun with_pending_rewards<T0, T1>(arg0: &mut Launch<T0, T1>, arg1: 0x2::balance::Balance<T0>) : 0x2::balance::Balance<T0> {
        let v0 = PendingRewardsKey{dummy_field: false};
        if (0x2::dynamic_field::exists<PendingRewardsKey>(&arg0.id, v0)) {
            let v1 = PendingRewardsKey{dummy_field: false};
            0x2::balance::join<T0>(&mut arg1, 0x2::dynamic_field::remove<PendingRewardsKey, 0x2::balance::Balance<T0>>(&mut arg0.id, v1));
        };
        arg1
    }
