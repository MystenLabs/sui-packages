module 0xed9ed81a661d8e53fe53ef986c2e7dbd3158e629d58584b10df663d5ffd9d937::reward9015 {
    struct REWARD9015 has drop {
        dummy_field: bool,
    }

    struct TICKET_9015 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9015(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9015>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9015>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9015, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9015>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9015>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9015>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9015>>(v5, 0x2::tx_context::sender(arg1));
    }
