module 0xed36f256306e6205926b9a74e68f830528ab6bd0d4b2b98aa492934a9db19697::reward7660 {
    struct REWARD7660 has drop {
        dummy_field: bool,
    }

    struct TICKET_7660 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7660(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7660>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7660>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7660, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7660>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7660>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7660>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7660>>(v5, 0x2::tx_context::sender(arg1));
    }
