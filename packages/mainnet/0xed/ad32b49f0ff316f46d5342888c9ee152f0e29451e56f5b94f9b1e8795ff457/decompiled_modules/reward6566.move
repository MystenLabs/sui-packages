module 0xedad32b49f0ff316f46d5342888c9ee152f0e29451e56f5b94f9b1e8795ff457::reward6566 {
    struct REWARD6566 has drop {
        dummy_field: bool,
    }

    struct TICKET_6566 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6566(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6566>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6566>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6566, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6566>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6566>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6566>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6566>>(v5, 0x2::tx_context::sender(arg1));
    }
