module 0xed87b967a383e7064f2de5bbb82e2b3f2c06a99ed241ca31808c1d3a969aeb67::c_mmt_title_deed_nft {
    struct C_MMT_TITLE_DEED_NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: C_MMT_TITLE_DEED_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<C_MMT_TITLE_DEED_NFT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b" MMT Title Deed NFT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"MMT Title Deed NFTs are designed to recognize, reward, and empower the most active builders and contributors shaping the Sui ecosystem."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibeqf5lnr5lmykfuw3qdvudgnx2wev245xb2vqteh654zqlesmfpu"));
