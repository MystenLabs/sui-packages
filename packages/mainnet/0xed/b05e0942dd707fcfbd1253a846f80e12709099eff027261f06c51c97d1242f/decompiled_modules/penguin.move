module 0xedb05e0942dd707fcfbd1253a846f80e12709099eff027261f06c51c97d1242f::penguin {
    ...
    fun init(arg0: PENGUIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PENGUIN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PENGUIN   ")))), trim_right(b"Nietzschean Penguin             "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
