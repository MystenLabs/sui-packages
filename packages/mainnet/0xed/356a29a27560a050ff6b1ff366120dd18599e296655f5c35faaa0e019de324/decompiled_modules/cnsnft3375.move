module 0xed356a29a27560a050ff6b1ff366120dd18599e296655f5c35faaa0e019de324::cnsnft3375 {
    struct CNSNFT3375 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3375, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3375>(arg0, arg1);
