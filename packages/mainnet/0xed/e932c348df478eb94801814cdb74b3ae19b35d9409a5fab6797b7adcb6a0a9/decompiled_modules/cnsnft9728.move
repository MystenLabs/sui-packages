module 0xede932c348df478eb94801814cdb74b3ae19b35d9409a5fab6797b7adcb6a0a9::cnsnft9728 {
    struct CNSNFT9728 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9728, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9728>(arg0, arg1);
