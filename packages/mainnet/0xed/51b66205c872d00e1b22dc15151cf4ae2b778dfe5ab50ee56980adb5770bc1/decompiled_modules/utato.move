module 0xed51b66205c872d00e1b22dc15151cf4ae2b778dfe5ab50ee56980adb5770bc1::utato {
    ...
    fun init(arg0: UTATO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<UTATO>>(0x2::coin::mint<UTATO>(&mut v2, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
