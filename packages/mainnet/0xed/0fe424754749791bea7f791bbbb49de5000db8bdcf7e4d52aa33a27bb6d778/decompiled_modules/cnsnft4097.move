module 0xed0fe424754749791bea7f791bbbb49de5000db8bdcf7e4d52aa33a27bb6d778::cnsnft4097 {
    struct CNSNFT4097 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4097, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4097>(arg0, arg1);
