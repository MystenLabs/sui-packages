module 0xed0822773c155cc3873eb7063495244bfde2820acd3615b047e1780e4b3ed246::TESTCOIN {
    struct TESTCOIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: TESTCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TESTCOIN>(arg0, 6, b"TESTCOIN", b"TC", b"Test Coin", 0x1::option::none<0x2::url::Url>(), arg1);
