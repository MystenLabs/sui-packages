module 0xedfe12fcaa1ae8a87c41475a3798e7e9b4ced8abaa16e28236a202b439dc1108::cnsnft2577 {
    struct CNSNFT2577 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2577, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2577>(arg0, arg1);
