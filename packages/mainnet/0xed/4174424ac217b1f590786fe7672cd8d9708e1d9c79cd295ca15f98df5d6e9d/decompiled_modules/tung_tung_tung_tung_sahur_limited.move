module 0x4feea4e64837ed2ac51bb0a0efe859b4b855a6cb0d6afce8943a5f932a145c0a::tung_tung_tung_tung_sahur_limited {
    struct TUNG_TUNG_TUNG_TUNG_SAHUR_LIMITED has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TUNG_TUNG_TUNG_TUNG_SAHUR_LIMITED, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TUNG_TUNG_TUNG_TUNG_SAHUR_LIMITED>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Tung Tung Tung Tung Sahur Limited"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Test branroot launch"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreihmlug54sdi3nhmhdcsihnhs2r6siczssozodffeiwx3w5bf6r2ge"));
