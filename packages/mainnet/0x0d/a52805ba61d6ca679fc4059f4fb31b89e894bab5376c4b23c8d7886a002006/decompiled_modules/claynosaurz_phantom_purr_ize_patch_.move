module 0xda52805ba61d6ca679fc4059f4fb31b89e894bab5376c4b23c8d7886a002006::claynosaurz_phantom_purr_ize_patch_ {
    struct CLAYNOSAURZ_PHANTOM_PURR_IZE_PATCH_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CLAYNOSAURZ_PHANTOM_PURR_IZE_PATCH_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CLAYNOSAURZ_PHANTOM_PURR_IZE_PATCH_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Claynosaurz Phantom Purr-ize Patch."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Your ticket to winning a prize in the Chasing Ghosts event. Each patch is a chance to enter and win an exclusive reward during the event timeframe."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiccjbo523insqavws3q4rijowszgcra2yoglbuzprrmfhmmo2acwi"));
