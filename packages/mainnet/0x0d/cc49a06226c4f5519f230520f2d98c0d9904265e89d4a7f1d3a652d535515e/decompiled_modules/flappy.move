module 0xdcc49a06226c4f5519f230520f2d98c0d9904265e89d4a7f1d3a652d535515e::flappy {
    ...
    fun init(arg0: FLAPPY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<FLAPPY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"FLAPPY  ")))), trim_right(b"FLAPPY                          "), trim_right(b"The Flappy Dog                                                                                                                                                                                                                                                                                                                  "), v2, arg1);
