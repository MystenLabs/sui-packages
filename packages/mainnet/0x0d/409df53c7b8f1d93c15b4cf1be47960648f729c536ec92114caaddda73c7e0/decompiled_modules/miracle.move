module 0xd409df53c7b8f1d93c15b4cf1be47960648f729c536ec92114caaddda73c7e0::miracle {
    ...
    public fun create(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Miracle {
        assert!(arg0 > 0, 0xd409df53c7b8f1d93c15b4cf1be47960648f729c536ec92114caaddda73c7e0::errors::E_BAD_SPLIT());
        Miracle{
    ...
    public fun maybe_trigger(arg0: &mut Miracle, arg1: u64) : (bool, u64, u64, u64, u64) {
        ...
        assert!(v0 > 0, 0xd409df53c7b8f1d93c15b4cf1be47960648f729c536ec92114caaddda73c7e0::errors::E_BAD_SPLIT());
        if (arg1 % v0 == 0) {
    ...
    public fun set_params(arg0: &mut Miracle, arg1: u64, arg2: u64) {
        assert!(arg1 > 0, 0xd409df53c7b8f1d93c15b4cf1be47960648f729c536ec92114caaddda73c7e0::errors::E_BAD_SPLIT());
        arg0.base_odds = arg1;
