module 0xd96a4c431e27d7a3e46335574bfd026c6d93be845759c1a167c4ab166555761::cnsnft8014 {
    struct CNSNFT8014 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8014, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8014>(arg0, arg1);
