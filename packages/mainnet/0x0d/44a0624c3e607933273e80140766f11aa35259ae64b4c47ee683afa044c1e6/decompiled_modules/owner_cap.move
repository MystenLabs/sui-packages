module 0xd44a0624c3e607933273e80140766f11aa35259ae64b4c47ee683afa044c1e6::owner_cap {
    ...
    public fun new_cloneable_key<T0: key>(arg0: &T0, arg1: &0x2::object::UID, arg2: &mut 0x2::tx_context::TxContext) : CloneableOwnerCap<T0> {
        assert!(0x2::object::id<T0>(arg0) == 0x2::object::uid_to_inner(arg1), 13906834556595470337);
        let v0 = 0x2::object::new(arg2);
        CloneableOwnerCap<T0>{
            id       : v0,
