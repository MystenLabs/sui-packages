module 0xd16a42453589e1fd6f96ccf34c75d2ff8ad9897b8d2a172d9a18b20c90393ca::founding_predictor {
    ...
    struct FoundingPredictor has store, key {
        id: 0x2::object::UID,
        number: u64,
        name: 0x1::string::String,
        image_url: 0x1::string::String,
    ...
    public fun mint(arg0: &mut Registry, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) : FoundingPredictor {
    ...
    public fun mint_to_sender(arg0: &mut Registry, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<FoundingPredictor>(v0, 0x2::tx_context::sender(arg2));
    }
