module 0xdf076d27780c2fffc7fa6d58b97499a5fe45f0754757e010843a61fe94717de::reward6048 {
    struct REWARD6048 has drop {
        dummy_field: bool,
    }

    struct TICKET_6048 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6048(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6048>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6048>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6048, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6048>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6048>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6048>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6048>>(v5, 0x2::tx_context::sender(arg1));
    }
