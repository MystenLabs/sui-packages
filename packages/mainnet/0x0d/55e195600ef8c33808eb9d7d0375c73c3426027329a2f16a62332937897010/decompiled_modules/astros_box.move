module 0xd55e195600ef8c33808eb9d7d0375c73c3426027329a2f16a62332937897010::astros_box {
    ...
    public fun get_display_info(arg0: u64, arg1: u8) : (0x1::string::String, 0x1::string::String, 0x2::url::Url) {
        ...
        0x1::string::append(&mut v1, u64_to_string((arg1 as u64)));
    ...
    public fun mint(arg0: &mut AstrosBoxConfig, arg1: &MintCap, arg2: address, arg3: 0x1::string::String, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2, v3) = get_display_info(v0, arg4);
        let v4 = AstrosBox{
