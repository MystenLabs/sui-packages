module 0xdd9bafff45b019d5fe0e2b4dfabf2f98058fea2efcf595dae894a6288a285cb::BucketReward {
    ...
    fun init(arg0: BUCKETREWARD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BUCKETREWARD>(arg0, 9, b"$ buckfi.cc - Bucket Reward Token", b"buckfi.cc", b"You're rewarded $10,000 Bucks for empowering Bucket Finance.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suicamp.b-cdn.net/bucket/bucket_nft_item.jpg")), arg1);
