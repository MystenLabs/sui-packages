module 0xdf778682c83daf1a55c4309b47d79a1b89d2ae782e54d267d98b0aff8ec287c::ikachad {
    struct IKACHAD has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IKACHAD, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<IKACHAD>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"IKACHAD"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Make a step in future as IKAs are everywhere enjoy the free mint and be ready for next big green Candle"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://NCoGCMU4NtrEZUUtOXTf1bjn2wGAYQGfLjlhbUAOtKg"));
