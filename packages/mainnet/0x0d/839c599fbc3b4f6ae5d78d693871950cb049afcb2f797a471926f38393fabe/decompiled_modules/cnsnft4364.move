module 0xd839c599fbc3b4f6ae5d78d693871950cb049afcb2f797a471926f38393fabe::cnsnft4364 {
    struct CNSNFT4364 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4364, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4364>(arg0, arg1);
