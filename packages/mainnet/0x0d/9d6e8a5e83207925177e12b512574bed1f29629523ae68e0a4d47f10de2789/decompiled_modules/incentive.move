module 0x4ccb970858a83b7790ed42c745971182d4a6413be17d14926c7a0d655b16ef66::incentive {
    ...
    public entry fun add_pool<T0>(arg0: &mut Incentive, arg1: &0x2::clock::Clock, arg2: u8, arg3: u64, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: u64, arg7: u8, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<u256>(&mut v1.rates, 0x4ccb970858a83b7790ed42c745971182d4a6413be17d14926c7a0d655b16ef66::ray_math::ray_div((arg6 as u256), ((arg4 - arg3) as u256)));
        ...
        let v2 = IncentiveBal<T0>{
            ...
            balance            : 0x4ccb970858a83b7790ed42c745971182d4a6413be17d14926c7a0d655b16ef66::utils::split_coin_to_balance<T0>(arg5, arg6, arg8),
        };
        0x2::transfer::share_object<IncentiveBal<T0>>(v2);
    }

    fun calc_pool_update_rewards(arg0: &Incentive, arg1: &mut 0x4ccb970858a83b7790ed42c745971182d4a6413be17d14926c7a0d655b16ef66::storage::Storage, arg2: u64, arg3: u8, arg4: address) : (vector<u256>, vector<u256>) {
        ...
        while (v1 < 0x1::vector::length<0x1::ascii::String>(&v0.coin_types)) {
            ...
            let v9 = v8;
            if (v5 < v7) {
                let (v10, _) = 0x4ccb970858a83b7790ed42c745971182d4a6413be17d14926c7a0d655b16ef66::storage::get_total_supply(arg1, arg3);
                let v12 = 0;
                if (v10 > 0) {
                    v12 = 0x4ccb970858a83b7790ed42c745971182d4a6413be17d14926c7a0d655b16ef66::safe_math::mul(*0x1::vector::borrow<u256>(&v0.rates, v1), ((v7 - v5) as u256)) / v10;
                };
                v9 = v8 + v12;
            };
            ...
            if (arg4 != @0x0) {
                ...
                let (v17, _) = 0x4ccb970858a83b7790ed42c745971182d4a6413be17d14926c7a0d655b16ef66::storage::get_user_balance(arg1, arg3, arg4);
                v13 = v13 + (v9 - v15) * v17;
            };
    ...
    public entry fun claim_reward<T0>(arg0: &mut Incentive, arg1: &mut IncentiveBal<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x4ccb970858a83b7790ed42c745971182d4a6413be17d14926c7a0d655b16ef66::storage::Storage, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = (v2 - v4) / 0x4ccb970858a83b7790ed42c745971182d4a6413be17d14926c7a0d655b16ef66::ray_math::ray();
    ...
    public fun earned(arg0: &Incentive, arg1: &mut 0x4ccb970858a83b7790ed42c745971182d4a6413be17d14926c7a0d655b16ef66::storage::Storage, arg2: &0x2::clock::Clock, arg3: u8, arg4: address) : (vector<0x1::ascii::String>, vector<u256>, vector<u8>) {
    ...
    public(friend) fun update_reward(arg0: &mut Incentive, arg1: &0x2::clock::Clock, arg2: &mut 0x4ccb970858a83b7790ed42c745971182d4a6413be17d14926c7a0d655b16ef66::storage::Storage, arg3: u8, arg4: address) {
        if (0x2::table::contains<u8, PoolInfo>(&arg0.pools, arg3)) {
