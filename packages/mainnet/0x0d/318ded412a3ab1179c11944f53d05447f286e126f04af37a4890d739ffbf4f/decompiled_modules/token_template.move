module 0xd318ded412a3ab1179c11944f53d05447f286e126f04af37a4890d739ffbf4f::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"VT467199", b"ValidToken 467199", b"This should succeed", 0x1::option::none<0x2::url::Url>(), arg1);
