module 0xd7c3639b900b721a7b1072601d41794c7242a48c5b98b61a7bd6f21246c70cf::cnsnft2636 {
    struct CNSNFT2636 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2636, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2636>(arg0, arg1);
