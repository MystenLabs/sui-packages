module 0xd0ed83132b41fdce548efbbc53d991d9bbd47c7da8c4fbb8bbc05b93a7a9f59::stage_plays {
    struct STAGE_PLAYS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: STAGE_PLAYS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<STAGE_PLAYS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Stage Plays"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Stage Plays by Dennis Posadas"));
