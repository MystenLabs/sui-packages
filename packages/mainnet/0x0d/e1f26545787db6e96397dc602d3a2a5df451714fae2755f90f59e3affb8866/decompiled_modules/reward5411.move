module 0xde1f26545787db6e96397dc602d3a2a5df451714fae2755f90f59e3affb8866::reward5411 {
    struct REWARD5411 has drop {
        dummy_field: bool,
    }

    struct TICKET_5411 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5411(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5411>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5411>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5411, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5411>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5411>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5411>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5411>>(v5, 0x2::tx_context::sender(arg1));
    }
