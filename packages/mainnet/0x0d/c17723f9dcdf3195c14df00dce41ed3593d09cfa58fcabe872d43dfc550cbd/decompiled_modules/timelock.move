module 0xdc17723f9dcdf3195c14df00dce41ed3593d09cfa58fcabe872d43dfc550cbd::timelock {
    ...
    public fun cancel(arg0: &mut TimelockRegistry, arg1: &0xdc17723f9dcdf3195c14df00dce41ed3593d09cfa58fcabe872d43dfc550cbd::vault::AdminCap, arg2: u64, arg3: &0x2::clock::Clock) {
    ...
    public fun destroy_action(arg0: ExecutedAction, arg1: &0xdc17723f9dcdf3195c14df00dce41ed3593d09cfa58fcabe872d43dfc550cbd::vault::ProtocolAccessCap) : (u8, vector<u8>) {
        let ExecutedAction {
            action_type : v0,
            payload     : v1,
        } = arg0;
    ...
    public fun execute(arg0: &mut TimelockRegistry, arg1: u64, arg2: &0x2::clock::Clock) : ExecutedAction {
        ...
        0xdc17723f9dcdf3195c14df00dce41ed3593d09cfa58fcabe872d43dfc550cbd::floors::assert_timelock_delay(v1 - v0.proposed_at_ms);
    ...
    public fun propose(arg0: &mut TimelockRegistry, arg1: &0xdc17723f9dcdf3195c14df00dce41ed3593d09cfa58fcabe872d43dfc550cbd::vault::AdminCap, arg2: u8, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) : u64 {
