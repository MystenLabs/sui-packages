module 0xdd4f18caf5c37b58cddd092a72bcc4d2420b4c30e2b7f3910628cb1ad4b6fd6::game5977 {
    struct GAME5977 has drop {
        dummy_field: bool,
    }

    struct TICKET_5977 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5977(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5977>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5977>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME5977, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME5977>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5977>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5977>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5977>>(v5, 0x2::tx_context::sender(arg1));
    }
