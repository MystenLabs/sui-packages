module 0xd5d71ef0e6a3438fc3b8276ac1ef336e93105fe5328c9755b98d04c8b952469::nft_market {
    ...
    public fun buy_print(arg0: &mut UserRegistry, arg1: &mut NFT, arg2: u64, arg3: address, arg4: &Config, arg5: &mut 0xd5d71ef0e6a3438fc3b8276ac1ef336e93105fe5328c9755b98d04c8b952469::nft_treasury::Treasury, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.on_market, 3);
        let v0 = arg2 * arg4.commission_rate / 100;
        arg1.revenue = arg1.revenue + v0;
        arg1.total_revenue = arg1.total_revenue + v0;
        0xd5d71ef0e6a3438fc3b8276ac1ef336e93105fe5328c9755b98d04c8b952469::nft_treasury::set_allowance(arg5, arg1.owner, arg1.revenue);
        0x1::vector::push_back<vector<u8>>(&mut get_or_create_user(arg0, arg3, arg6).print_history, 0x2::object::uid_to_bytes(&arg1.id));
    }

    public fun claim_revenue(arg0: &mut NFT, arg1: &mut 0xd5d71ef0e6a3438fc3b8276ac1ef336e93105fe5328c9755b98d04c8b952469::nft_treasury::Treasury, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 5);
        let v0 = arg0.revenue;
        assert!(v0 > 0, 4);
        0xd5d71ef0e6a3438fc3b8276ac1ef336e93105fe5328c9755b98d04c8b952469::nft_treasury::withdraw_allowance(arg1, v0, arg2);
        arg0.revenue = 0;
    }
    ...
    public fun get_all_users_nfts(arg0: &UserRegistry) : (vector<address>, vector<vector<vector<u8>>>) {
        ...
        let v2 = 0;
        while (v2 < arg0.nft_count) {
            if (0x2::dynamic_field::exists_<u64>(&arg0.id, v2)) {
                let v3 = 0x2::dynamic_object_field::borrow<address, User>(&arg0.id, *0x2::dynamic_field::borrow<u64, address>(&arg0.id, v2));
    ...
    fun get_or_create_user(arg0: &mut UserRegistry, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : &mut User {
        if (!0x2::dynamic_object_field::exists_<address>(&arg0.id, arg1)) {
            ...
            0x2::dynamic_object_field::add<address, User>(&mut arg0.id, arg1, v0);
            arg0.user_count = arg0.user_count + 1;
        };
        0x2::dynamic_object_field::borrow_mut<address, User>(&mut arg0.id, arg1)
    }
    ...
    public fun register_wormhole_nft(arg0: &mut UserRegistry, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: vector<u8>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = get_or_create_user(arg0, v0, arg6);
        let v3 = NFT{
            id                   : v1,
            owner                : v0,
            votes                : 0,
        ...
        0x1::vector::push_back<vector<u8>>(&mut v2.authorized_nfts, 0x2::object::uid_to_bytes(&v3.id));
        0x2::dynamic_field::add<u64, address>(&mut arg0.id, arg0.nft_count, v0);
        arg0.nft_count = arg0.nft_count + 1;
        0x2::transfer::share_object<NFT>(v3);
    }
