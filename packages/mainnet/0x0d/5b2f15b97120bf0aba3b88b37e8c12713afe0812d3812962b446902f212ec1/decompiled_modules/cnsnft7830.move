module 0xd5b2f15b97120bf0aba3b88b37e8c12713afe0812d3812962b446902f212ec1::cnsnft7830 {
    struct CNSNFT7830 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7830, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6410"));
        let v4 = 0x2::package::claim<CNSNFT7830>(arg0, arg1);
