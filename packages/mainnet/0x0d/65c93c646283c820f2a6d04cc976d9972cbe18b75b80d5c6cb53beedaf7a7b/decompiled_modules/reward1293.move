module 0xd65c93c646283c820f2a6d04cc976d9972cbe18b75b80d5c6cb53beedaf7a7b::reward1293 {
    struct REWARD1293 has drop {
        dummy_field: bool,
    }

    struct TICKET_1293 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1293(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1293>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1293>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1293, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1293>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1293>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1293>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1293>>(v5, 0x2::tx_context::sender(arg1));
    }
