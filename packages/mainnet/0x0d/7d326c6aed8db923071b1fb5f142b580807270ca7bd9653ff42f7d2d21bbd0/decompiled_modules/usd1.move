module 0xd7d326c6aed8db923071b1fb5f142b580807270ca7bd9653ff42f7d2d21bbd0::usd1 {
    ...
    fun init(arg0: USD1, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<USD1>(arg0, 9, b"USD1", b"USD1", b"This is USD1. ", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/E8XHVPt.png")), arg1);
