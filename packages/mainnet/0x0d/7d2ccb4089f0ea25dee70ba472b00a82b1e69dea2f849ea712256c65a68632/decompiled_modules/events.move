module 0xd7d2ccb4089f0ea25dee70ba472b00a82b1e69dea2f849ea712256c65a68632::events {
    ...
    struct PoolRegisteredEvent has copy, drop {
        pool_id: 0x2::object::ID,
        config: 0xd7d2ccb4089f0ea25dee70ba472b00a82b1e69dea2f849ea712256c65a68632::config::MMConfig,
        timestamp_ms: u64,
    }
    ...
    public(friend) fun emit_pool_registered(arg0: 0x2::object::ID, arg1: 0xd7d2ccb4089f0ea25dee70ba472b00a82b1e69dea2f849ea712256c65a68632::config::MMConfig, arg2: u64) {
