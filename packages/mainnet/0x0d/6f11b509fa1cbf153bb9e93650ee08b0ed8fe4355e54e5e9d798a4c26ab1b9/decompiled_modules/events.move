module 0x9d6a20f9c4a038d95733a148864412c50927609ead7d6657ec8709932fa88e78::events {
    ...
    struct GasExtractedEvent has copy, drop {
        user: address,
        amount: u64,
        extracted_24h: u64,
        timestamp: u64,
    ...
    public(friend) fun emit_gas_extracted(arg0: address, arg1: u64, arg2: u64, arg3: u64) {
        let v0 = GasExtractedEvent{
            user          : arg0,
            amount        : arg1,
            extracted_24h : arg2,
            timestamp     : arg3,
        };
        0x2::event::emit<GasExtractedEvent>(v0);
    }
