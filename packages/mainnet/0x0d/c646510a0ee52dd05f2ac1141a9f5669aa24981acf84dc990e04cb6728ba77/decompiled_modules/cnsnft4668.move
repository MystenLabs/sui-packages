module 0xdc646510a0ee52dd05f2ac1141a9f5669aa24981acf84dc990e04cb6728ba77::cnsnft4668 {
    struct CNSNFT4668 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4668, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4668>(arg0, arg1);
