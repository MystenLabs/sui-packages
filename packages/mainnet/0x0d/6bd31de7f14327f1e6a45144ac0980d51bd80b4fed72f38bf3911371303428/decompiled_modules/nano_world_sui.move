module 0xd6bd31de7f14327f1e6a45144ac0980d51bd80b4fed72f38bf3911371303428::nano_world_sui {
    struct NANO_WORLD_SUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NANO_WORLD_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NANO_WORLD_SUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Nano World SUI"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The original idea of the collection is to invest the funds raised from the collection into the Nano World Comix DAO. This collection has the potential for utility: each holder will be able to claim DAO tokens while holding an item from the collection. The utility will be activated after the entire NFT collection is sold out."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidrag4eakqedvwomee2qea6lrp6pyx6igapas7wa4p5v2xdwcgfou"));
