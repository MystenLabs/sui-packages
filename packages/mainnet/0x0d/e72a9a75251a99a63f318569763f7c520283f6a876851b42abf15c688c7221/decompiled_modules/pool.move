module 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::pool {
    ...
    struct GlobalConfig has key {
        id: 0x2::object::UID,
        config_cap: 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::admin::GlobalConfigCap,
    ...
    public fun get_price<T0, T1>(arg0: &0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::price_oracle::Oracle, arg1: &0x2::clock::Clock) : (u128, bool) {
        let (v0, v1) = 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::price_oracle::get_valid_price<T0, T1>(arg0, arg1);
        let v2 = v0;
        let v3 = 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::price_oracle::price_data_price<T0, T1>(&v2);
        (0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::internal_price::get_price<T0, T1>(&v3), v1)
    }

    public fun add_quote_asset<T0, T1>(arg0: &GlobalConfig, arg1: &mut LiquidityPool<T0>, arg2: &mut 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::price_oracle::Oracle, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: 0x1::option::Option<u64>, arg8: 0x1::option::Option<u64>, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::price_oracle::check_asset_pair_exists<T0, T1>(arg2) || 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::price_oracle::check_asset_pair_exists<T1, T0>(arg2), 4014);
    ...
    fun assert_quote_is_supported<T0, T1>(arg0: &LiquidityPool<T0>) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>());
    ...
    public fun calc_claimable_rewards<T0>(arg0: &LiquidityPool<T0>, arg1: &LPPosition<T0>, arg2: u64) : ClaimableRewardsInfo {
        ...
        let v3 = (0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128(v1 - v2, (arg1.shares as u128), (1000000000000000000 as u128)) as u64);
        let v4 = v3;
    ...
    fun calc_dynamic_fee<T0, T1>(arg0: &LiquidityPool<T0>, arg1: u64, arg2: u128, arg3: bool) : (u64, u128, u64, u64) {
        let (v0, _) = get_pool_liquidity<T0>(arg0);
        let v2 = 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((v0 as u128), 1000000000000000000, arg2);
        ...
        let v4 = 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128(v2, (v3.ideal_reserve_pct as u128), 10000);
        let v5 = 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128(v2, (v3.max_reserve_pct as u128), 10000);
        let v6 = 0x2::balance::value<T1>(&v3.balance);
        let v7 = if (arg3) {
            if (v6 >= arg1) {
                v6 - arg1
            } else {
        ...
        let v9 = if (v4 == 0) {
            ...
            (0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128(((v3.fee_base * 1000) as u128), v8, v4) as u64)
        } else if (v5 == 0) {
            v3.fee_base * 1000
        } else {
            v3.fee_base * 1000 + (0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128(((v3.fee_max * 1000) as u128), v8, v5) as u64)
        };
        (v9, v4, v6, quote_limit<T0, T1>(arg0, arg2, v3))
    }

    fun calculate_fees<T0>(arg0: &LiquidityPool<T0>, arg1: u64, arg2: u64) : (u64, u64) {
        let v0 = ((10000 * 1000) as u128);
        let v1 = arg1 - (0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((arg1 as u128), v0 - ((arg2 + ((arg0.swap_fee_pct * 1000) as u64)) as u128), v0) as u64);
        let v2 = (0x1::u128::max(0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((v1 as u128), (arg0.lp_fee_pct as u128), 10000), 1) as u64);
        (v2, (0x1::u64::max(v1 - v2, 1) as u64))
    }

    fun calculate_net_and_fee_amount(arg0: u64, arg1: u64) : (u64, u64) {
        let v0 = (0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((arg0 as u128), ((10000 - arg1) as u128), (10000 as u128)) as u64);
        (v0, arg0 - v0)
    }

    fun calculate_swap_fees<T0>(arg0: &LiquidityPool<T0>, arg1: u64, arg2: u64) : (u64, u64, u64) {
        let (v0, v1) = calculate_fees<T0>(arg0, arg1, arg2);
        (arg1 - v0 - v1, v1, v0)
    }

    public fun claim_owned_coins<T0, T1: store + key>(arg0: &0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::admin::ProtocolAdminCap, arg1: &mut LiquidityPool<T0>, arg2: 0x2::transfer::Receiving<T1>, arg3: &mut 0x2::tx_context::TxContext) : T1 {
        validate_pool_version<T0>(arg1);
        assert!(arg1.admin == 0x2::tx_context::sender(arg3), 4002);
        0x2::transfer::public_receive<T1>(&mut arg1.id, arg2)
    }
    ...
    public fun claim_rewards<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: &mut LPPosition<T0>, arg2: 0x1::option::Option<address>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        update_claimable_rewards_inner<T0>(arg0, arg1);
    ...
    public fun create_pool<T0>(arg0: &0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::admin::ProtocolAdminCap, arg1: &mut GlobalConfig, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
    ...
    public fun get_quote_balance<T0, T1>(arg0: &LiquidityPool<T0>) : u64 {
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>());
        assert!(0x2::dynamic_field::exists_<0x1::ascii::String>(&arg0.id, v0), 4003);
        0x2::balance::value<T1>(&0x2::dynamic_field::borrow<0x1::ascii::String, QuoteAssetReserve<T1>>(&arg0.id, v0).balance)
    }
    ...
    fun increment_reward_rps<T0>(arg0: &mut LiquidityPool<T0>, arg1: u64) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>());
        *0x2::table::borrow_mut<0x1::ascii::String, u128>(&mut arg0.reward_rps, v0) = *0x2::table::borrow<0x1::ascii::String, u128>(&arg0.reward_rps, v0) + 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((arg1 as u128), (1000000000000000000 as u128), (arg0.total_lp_shares as u128));
    }
    ...
    public fun initialize_global_config(arg0: &0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::admin::ProtocolAdminCap, arg1: 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::admin::GlobalConfigCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    fun quote_limit<T0, T1>(arg0: &LiquidityPool<T0>, arg1: u128, arg2: &QuoteAssetReserve<T1>) : u64 {
        let (v0, _) = get_pool_liquidity<T0>(arg0);
        0x1::u64::min((0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((v0 as u128), 1000000000000000000, arg1) as u128), (0x1::option::get_with_default<u64>(&arg2.limit_ratio, arg0.limit_ratio) as u128), 100) as u64), 0x1::option::get_with_default<u64>(&arg2.limit_fixed, 18446744073709551615))
    }
    ...
    public fun set_protocol_pause(arg0: &mut GlobalConfig, arg1: &0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::admin::ProtocolAdminCap, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun simulate_buy_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        validate_pool_version<T0>(arg0);
        assert!(arg3 > 0, 4001);
        assert_quote_is_supported<T0, T1>(arg0);
        let (v0, _) = get_price<T1, T0>(arg1, arg2);
        let v2 = 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((arg3 as u128), v0, 1000000000000000000);
        assert!(v2 != 0, 4016);
        let (v3, v4, v5, v6) = calc_dynamic_fee<T0, T1>(arg0, arg3, v0, false);
        assert!(v5 + arg3 <= v6, 4009);
        let (v7, v8, v9) = calculate_swap_fees<T0>(arg0, (v2 as u64), v3);
        SwapSimulationResult{
            base_out        : (v7 as u64),
            quote_out       : (0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((v7 as u128), 1000000000000000000, v0) as u64),
            swap_fee_pct    : arg0.swap_fee_pct * 1000,
            dynamic_fee_pct : v3,
            ideal_quote_amt : v4,
            swap_fee        : ((v9 + v8) as u64),
            lp_fee          : (v9 as u64),
            protocol_fee    : (v8 as u64),
            price_used      : v0,
        }
    }

    public fun simulate_sell_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        validate_pool_version<T0>(arg0);
        assert!(arg3 > 0, 4001);
        assert_quote_is_supported<T0, T1>(arg0);
        let (v0, _) = get_price<T1, T0>(arg1, arg2);
        let (v2, v3, v4, _) = calc_dynamic_fee<T0, T1>(arg0, (0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((arg3 as u128), 1000000000000000000, v0) as u64), v0, true);
        let (v6, v7, v8) = calculate_swap_fees<T0>(arg0, arg3, v2);
        let v9 = 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((v6 as u128), 1000000000000000000, v0);
        assert!(v4 >= (v9 as u64), 4021);
        SwapSimulationResult{
            base_out        : (v6 as u64),
            quote_out       : (v9 as u64),
            swap_fee_pct    : arg0.swap_fee_pct * 1000,
    ...
    public fun simulate_sell_swap_reverse<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        validate_pool_version<T0>(arg0);
        assert!(arg3 > 0, 4020);
        assert_quote_is_supported<T0, T1>(arg0);
        let (v0, _) = get_price<T1, T0>(arg1, arg2);
        let (v2, _, _, _) = calc_dynamic_fee<T0, T1>(arg0, arg3, v0, true);
        let v6 = (0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((arg3 as u128), v0, 1000000000000000000) as u64);
        let (v7, v8) = calculate_fees<T0>(arg0, v6, v2);
        let v9 = ((10000 * 1000) as u128);
        let v10 = get_quote_balance<T0, T1>(arg0);
        assert!(arg3 <= v10, 4021);
        let v11 = (0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((v10 as u128), v0, 1000000000000000000) as u64);
        let v12 = 0x1::u64::max(0x1::u64::min((0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::math::mul_div_u128((v6 as u128), v9, v9 - ((v2 + ((arg0.swap_fee_pct * 1000) as u64)) as u128)) as u64), v11), v7 + v8 + arg0.min_base_out);
        let v13 = simulate_sell_swap<T0, T1>(arg0, arg1, arg2, v12);
        if (v13.quote_out < arg3 && v12 < v11) {
            v13 = simulate_sell_swap<T0, T1>(arg0, arg1, arg2, v12 + 1);
        };
        v13
    }

    public fun simulate_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64, arg4: bool) : SwapSimulationResult {
        if (arg4) {
    ...
    public fun swap_buy<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: &0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: 0x2::balance::Balance<T1>, arg4: 0x1::option::Option<u64>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert!(!arg0.is_paused, 4005);
    ...
    public fun swap_sell<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: &0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: 0x2::balance::Balance<T0>, arg4: 0x1::option::Option<u64>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert!(!arg0.is_paused, 4005);
    ...
    fun update_claimable_rewards_inner<T0>(arg0: &LiquidityPool<T0>, arg1: &mut LPPosition<T0>) {
        let v0 = 0;
    ...
    public fun update_global_config(arg0: &mut GlobalConfig, arg1: &0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::admin::ProtocolAdminCap, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update_module_version(arg0: &mut GlobalConfig) {
        assert!(arg0.version < 0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::constants::get_version(), 4011);
    ...
    public fun version() : u64 {
        0xde72a9a75251a99a63f318569763f7c520283f6a876851b42abf15c688c7221::constants::get_version()
    }
    ...
    public fun withdraw_shares<T0>(arg0: &mut LiquidityPool<T0>, arg1: &mut LPPosition<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = withdraw_shares_balance<T0>(arg0, arg1, arg2, arg3, arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg4), arg3);
    }

    public fun withdraw_shares_balance<T0>(arg0: &mut LiquidityPool<T0>, arg1: &mut LPPosition<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert!(!arg0.is_paused, 4005);
        validate_pool_version<T0>(arg0);
        ...
        0x2::balance::split<T0>(&mut arg0.base_reserve, v0.base_out)
    }
