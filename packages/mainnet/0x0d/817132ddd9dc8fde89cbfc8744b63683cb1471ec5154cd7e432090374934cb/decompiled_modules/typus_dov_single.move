module 0x4e845c2c18602edd9f7f0251b467a301ad653e38d9fdbfc06cbc670a4d79166e::typus_dov_single {
    ...
    public(friend) fun calculate_deposit_point(arg0: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::TypusUserRegistry, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::TypusLeaderboardRegistry, arg3: &mut Registry, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = (((v4.total_deposit as u128) * (((v0 - v4.snapshot_ts_ms) / 60000) as u128) / 12000) as u64);
        v4.snapshot_ts_ms = v0;
        add_leaderboard_score(&arg3.id, arg0, arg2, 0x1::ascii::string(b"depositor_program"), arg4, v5, arg5, arg6);
    ...
    public(friend) fun calculate_max_loss_per_unit(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: vector<PayoffConfig>, arg6: u64) : u64 {
        ...
        assert!(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::is_neg(&v6), 14);
    ...
    public(friend) fun deposit_additional_lending_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : vector<u64> {
        let v0 = get_portfolio_vault(&arg0.portfolio_vault_registry, arg1);
        assert!(v0.info.status != 4 && v0.info.status != 5, 3);
        assert!(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v0.config.u64_padding, 5) == 1, 40);
        assert!(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v0.config.u64_padding, 1) == 0 && 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v0.config.u64_padding, 4) == 0, 41);
        let v1 = &mut arg0.deposit_vault_registry;
    ...
    public(friend) fun deposit_scallop_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : vector<u64> {
        let v0 = get_portfolio_vault(&arg0.portfolio_vault_registry, arg1);
        assert!(v0.info.status != 4 && v0.info.status != 5, 3);
        assert!(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v0.config.u64_padding, 1) == 1, 36);
        let v1 = &mut arg0.deposit_vault_registry;
        let v2 = get_mut_deposit_vault(v1, arg1);
        let v3 = &mut arg0.additional_config_registry;
        let v4 = get_mut_additional_config(v3, arg1);
    ...
    public(friend) fun deposit_scallop_basic_lending_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : vector<u64> {
        let v0 = get_portfolio_vault(&arg0.portfolio_vault_registry, arg1);
        assert!(v0.info.status != 4 && v0.info.status != 5, 3);
        assert!(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v0.config.u64_padding, 4) == 1, 39);
        let v1 = &mut arg0.deposit_vault_registry;
        let v2 = get_mut_deposit_vault(v1, arg1);
        let v3 = &mut arg0.additional_config_registry;
    ...
    entry fun fix_issue_typus_manager_cap(arg0: &mut Registry) {
        0x2::dynamic_field::add<vector<u8>, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::ManagerCap>(&mut arg0.id, b"typus_ecosystem", 0x2::dynamic_field::remove<0x1::ascii::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::ManagerCap>(&mut arg0.id, 0x1::ascii::string(b"typus_ecosystem")));
    }
    ...
    public(friend) fun recoup_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) : (u64, u64) {
        ...
        assert!(get_scallop_basic_lending_deposit_amount<T0>(arg0, arg1) == 0, 37);
        let v0 = &mut arg0.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg1);
        let v2 = &mut arg0.deposit_vault_registry;
        let v3 = get_mut_deposit_vault(v2, arg1);
    ...
    public(friend) fun settle_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        if (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::bid_share_supply(&v22) == 0) {
    ...
    public(friend) fun validate_bid(arg0: &PortfolioVault, arg1: &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::Auction, arg2: u64) {
        ...
        assert!(arg0.config.max_bid_entry == 0 || 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::bid_index(arg1) < arg0.config.max_bid_entry, 24);
    }

    public(friend) fun validate_bid_amount(arg0: &PortfolioVault, arg1: u64) {
        assert!(arg1 >= arg0.config.bid_lot_size && arg1 % arg0.config.bid_lot_size == 0, 23);
        assert!(arg1 >= arg0.config.min_bid_size, 27);
    }

    public(friend) fun validate_capacity(arg0: &Registry, arg1: u64) {
        let v0 = get_portfolio_vault(&arg0.portfolio_vault_registry, arg1);
        let v1 = get_deposit_vault(&arg0.deposit_vault_registry, arg1);
        assert!(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::active_share_supply(v1) + 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::warmup_share_supply(v1) <= v0.config.capacity, 26);
        let v2 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::get_deposit_shares(v1);
        assert!(v0.config.max_deposit_entry == 0 || 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::length<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::DepositShare>(v2) <= v0.config.max_deposit_entry, 25);
    }
    ...
    public(friend) fun withdraw_scallop_basic_lending_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        if (0x2::dynamic_field::exists_<vector<u8>>(&v5.id, b"scallop_market_coin")) {
            let v6 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::scallop::withdraw_basic_lending<T0>(&mut arg0.fee_pool, v3, v0, arg2, arg3, 0x2::dynamic_field::remove<vector<u8>, 0x2::coin::Coin<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&mut v5.id, b"scallop_market_coin"), arg4, arg5);
