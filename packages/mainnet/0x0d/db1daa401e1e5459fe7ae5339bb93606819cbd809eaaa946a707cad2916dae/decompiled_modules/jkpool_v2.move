module 0xddb1daa401e1e5459fe7ae5339bb93606819cbd809eaaa946a707cad2916dae::jkpool_v2 {
    ...
    public fun access_list_add(arg0: &mut AccessList, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x2942f90f48a7be41d4dbbc83ff687816b2c3eae73322ce167c632062e3e5c348, 10000000000);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = AccessList{
            ...
            list : 0x1::vector::singleton<address>(@0x2942f90f48a7be41d4dbbc83ff687816b2c3eae73322ce167c632062e3e5c348),
        };
