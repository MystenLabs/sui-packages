module 0xdcef2c42a19c722a6ca20e919c66d792fd5611b71512ce9d4fd0e7e6c52d967::math_u128 {
    public fun add(arg0: u128, arg1: u128) : u128 {
        let (v0, v1) = 0x51aa0d097ac18d369e9af9b91c38f90265ff1441fcb0ab04e21d9cae63ece70b::math_u128::overflowing_add(arg0, arg1);
        assert!(v1, 0);
        v0
    }
    ...
    public fun mul(arg0: u128, arg1: u128) : u128 {
        let (v0, v1) = 0x51aa0d097ac18d369e9af9b91c38f90265ff1441fcb0ab04e21d9cae63ece70b::math_u128::overflowing_mul(arg0, arg1);
        assert!(v1, 0);
        v0
    }
    ...
    public fun sub(arg0: u128, arg1: u128) : u128 {
        let (v0, v1) = 0x51aa0d097ac18d369e9af9b91c38f90265ff1441fcb0ab04e21d9cae63ece70b::math_u128::overflowing_sub(arg0, arg1);
        assert!(v1, 0);
        v0
    }
