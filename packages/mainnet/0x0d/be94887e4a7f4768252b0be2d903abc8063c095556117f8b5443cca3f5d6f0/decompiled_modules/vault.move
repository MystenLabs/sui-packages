module 0x45355b07146d699e6a8c405bcc2f60ef5d062a15183c6012ac55d5734d8add21::vault {
    ...
    entry fun move_token<T0, T1, T2>(arg0: &AdminCap, arg1: &VaultConfig, arg2: &mut Vault<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<T0>(v1) == 0) {
            ...
            let (v3, v4) = 0x1::vector::index_of<0x1::ascii::String>(&arg2.withdraw_asset_keys, &v0);
            if (v3) {
                0x1::vector::swap_remove<0x1::ascii::String>(&mut arg2.withdraw_asset_keys, v4);
            };
        };
        if (0x1::type_name::into_string(0x1::type_name::with_defining_ids<T2>()) == 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())) {
            if (0x1::option::is_some<0x2::coin::Coin<T0>>(&arg2.coin_store.coin)) {
                0x2::coin::join<T0>(0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg2.coin_store.coin), 0x2::coin::split<T0>(v1, v2, arg3));
            } else {
                0x1::option::fill<0x2::coin::Coin<T0>>(&mut arg2.coin_store.coin, 0x2::coin::split<T0>(v1, v2, arg3));
            };
            ...
            add_table_vault_asset<T0, T1>(arg2, 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), v5, arg3);
        } else {
            ...
            if (0x2::bag::contains<0x1::ascii::String>(&arg2.harvest_assets, v0)) {
                0x2::coin::join<T0>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg2.harvest_assets, v0), 0x2::coin::split<T0>(v1, v2, arg3));
            } else {
                0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg2.harvest_assets, v0, 0x2::coin::split<T0>(v1, v2, arg3));
