module 0xb9084515f905248b5c61d3aad2b71fd58444880a77e80d394c524cca9e9ccdb9::soulseed_hero_nft {
    ...
    fun init(arg0: SOULSEED_HERO_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Powerful Heroes to play in the TestBananaHeads Gaming Platform!"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"TestBananaHeads Heroes"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"TestBananaHeads Heroes"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"TestBananaHeads: {name} Hero# {hero_id}"));
