module 0xb98d3888c4b0d798a85eba2342abde1360d64822d838ab2df1712056458956ee::cnsnft5885 {
    struct CNSNFT5885 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5885, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8226"));
        let v4 = 0x2::package::claim<CNSNFT5885>(arg0, arg1);
