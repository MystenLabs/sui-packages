module 0xb9be6b13ab8630a5d4d0464a9d032879f046e0c85066b405d0f45e64b6f87f8b::my_sui_collection2 {
    struct MY_SUI_COLLECTION2 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MY_SUI_COLLECTION2, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MY_SUI_COLLECTION2>(arg0, arg1);
