module 0xb91e0718a8e1d10faf3b95b48adccfc585783892bacdb00051b4a3b91dbdc75b::cnsnft1728 {
    struct CNSNFT1728 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1728, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1728>(arg0, arg1);
