module 0xb936ae8317c279f0ca442ee89a9036ca90a6d45833dfe134210ab3bc1c09e613::tradeport_launchpad {
    ...
    public fun get_nft_metadata(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: 0x1::string::String, arg3: u64, arg4: 0x1::string::String, arg5: u64, arg6: 0x1::string::String, arg7: u64, arg8: u64, arg9: u64, arg10: vector<u8>, arg11: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg12: &mut 0x2::tx_context::TxContext) : (0x2::bag::Bag, 0x1::option::Option<0x2::bag::Bag>) {
        ...
        assert!(arg3 == 1, 4);
        get_nft_metadata_1(v2, v7, arg12)
    }
    ...
    fun get_nft_metadata_0(arg0: &0x2::clock::Clock, arg1: &mut Group, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : (0x2::bag::Bag, 0x1::option::Option<0x2::bag::Bag>) {
        ...
        if (arg2 && !0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::is_empty<0x2::bag::Bag>(v0)) {
            return (0xb936ae8317c279f0ca442ee89a9036ca90a6d45833dfe134210ab3bc1c09e613::warehouse_utils::redeem_random_nft<0x2::bag::Bag>(arg0, v0, arg3), 0x1::option::some<0x2::bag::Bag>(0xb936ae8317c279f0ca442ee89a9036ca90a6d45833dfe134210ab3bc1c09e613::warehouse_utils::redeem_random_nft<0x2::bag::Bag>(arg0, v0, arg3)))
        };
        (0xb936ae8317c279f0ca442ee89a9036ca90a6d45833dfe134210ab3bc1c09e613::warehouse_utils::redeem_random_nft<0x2::bag::Bag>(arg0, v0, arg3), 0x1::option::none<0x2::bag::Bag>())
    }
