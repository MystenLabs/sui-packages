module 0xb9fe4d78d216e98b6229e97f93972cb7c3493d8d9f123880f781ab920c66db50::stealth_address_registry {
    ...
    public(friend) entry fun announce(arg0: &0x2::tx_context::TxContext, arg1: &mut Registry, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: &0x2::clock::Clock) {
        ...
        if (!0x2::table::contains<vector<u8>, u64>(&arg1.by_view_tag, arg3)) {
            0x2::table::add<vector<u8>, u64>(&mut arg1.by_view_tag, arg3, v0);
        };
        let v3 = Announcement{
        ...
        0x2::table::add<u64, Announcement>(&mut arg1.announcements, v0, v3);
