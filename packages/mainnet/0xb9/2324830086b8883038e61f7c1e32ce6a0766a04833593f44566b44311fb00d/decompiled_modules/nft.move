module 0xb92324830086b8883038e61f7c1e32ce6a0766a04833593f44566b44311fb00d::nft {
    ...
    public entry fun push_attributes(arg0: &Admin, arg1: &mut 0xb92324830086b8883038e61f7c1e32ce6a0766a04833593f44566b44311fb00d::attribute_module::AttributeContainer, arg2: vector<vector<0x1::string::String>>, arg3: vector<vector<0x1::string::String>>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.address, 0);
        0xb92324830086b8883038e61f7c1e32ce6a0766a04833593f44566b44311fb00d::attribute_module::push_attributes(arg1, arg2, arg3, arg4);
    }
    ...
    public entry fun deposit_to_launchpad(arg0: &mut Admin, arg1: &mut 0x4162792d4a3fe4c86b0e20980eb76ca39f2ab7fe6ca30d28bd4aa58ce20b2ab5::launchpad_module::Launchpad, arg2: &mut Container, arg3: u64, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < arg3) {
            ...
            v1 = v1 + 1;
            v0 = v0 + 1;
            0x4162792d4a3fe4c86b0e20980eb76ca39f2ab7fe6ca30d28bd4aa58ce20b2ab5::launchpad_module::deposit<Nft>(arg1, v2, arg9);
        };
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Container{
            ...
            attribute_container_id : 0xb92324830086b8883038e61f7c1e32ce6a0766a04833593f44566b44311fb00d::attribute_module::create_attribute_container(arg1),
            total_minted           : 0,
            total_magic            : 0,
        };
    ...
    public entry fun magic(arg0: &mut Container, arg1: &mut 0xb92324830086b8883038e61f7c1e32ce6a0766a04833593f44566b44311fb00d::attribute_module::AttributeContainer, arg2: &mut Nft, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.is_magic_enable == true, 2);
        let v0 = 0xb92324830086b8883038e61f7c1e32ce6a0766a04833593f44566b44311fb00d::attribute_module::pop_attributes(arg1);
    ...
    public entry fun mint(arg0: &mut Admin, arg1: &mut Container, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < arg3) {
            let v6 = Nft{
                ...
                url         : 0x2::url::new_unsafe(0x1::string::to_ascii(0x1::string::utf8(b"https://i.pinimg.com/564x/2a/b1/9c/2ab19c65df33ce0bdd1b8e94cdcd361f.jpg"))),
                ...
                description : 0x1::string::utf8(b"Nezuko Chan"),
                name        : 0x1::string::utf8(b"Nezuko Chan"),
                attributes  : 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>(),
                index       : v5,
            };
            v5 = v5 + 1;
    ...
    public entry fun transfer_admin(arg0: &mut Admin, arg1: &mut 0xb92324830086b8883038e61f7c1e32ce6a0766a04833593f44566b44311fb00d::attribute_module::AttributeContainer, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.address, 0);
        arg0.address = arg2;
        0xb92324830086b8883038e61f7c1e32ce6a0766a04833593f44566b44311fb00d::attribute_module::change_admin_address(arg1, arg2, arg3);
    }
