module 0xb947e7f5e8d902ee9da4ba2ec7fd08372f0b93851d7de7b2d76527fdbaa07c36::cnsnft6175 {
    struct CNSNFT6175 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6175, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6175>(arg0, arg1);
