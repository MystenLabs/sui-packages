module 0xb95a7a281cdf3ef466efb00a0593569c25eb59a3611ce1b81e5892d4eff16c9a::FWOG {
    struct FWOG has drop {
        dummy_field: bool,
    }

    fun init(arg0: FWOG, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<FWOG>(arg0, 2, b"FWOG", b"FWOG", b"FWOG", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/daXo3QsRnsE-ZsrSgREgOvCjJ3qorpajcBEnsD6i4OU?ext=png")), arg1);
