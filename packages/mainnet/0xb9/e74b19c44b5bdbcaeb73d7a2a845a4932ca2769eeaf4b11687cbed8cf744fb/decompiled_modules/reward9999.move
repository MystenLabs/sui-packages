module 0xb9e74b19c44b5bdbcaeb73d7a2a845a4932ca2769eeaf4b11687cbed8cf744fb::reward9999 {
    struct REWARD9999 has drop {
        dummy_field: bool,
    }

    struct TICKET_9999 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9999(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9999>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9999>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9999, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9999>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9999>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9999>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9999>>(v5, 0x2::tx_context::sender(arg1));
    }
