module 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::main {
    ...
    public fun cancel_order<T0, T1>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
    ...
    public fun claim_all_output<T0>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: &Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        withdraw_output<T0>(arg0, arg1, arg2, arg3, arg4)
    }

    public fun claim_all_refundable_input<T0>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: &Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        validate_global_config(arg0);
        ...
        while (v0.current_cycle < v0.order_num) {
            let v3 = v0.current_cycle + 1;
            let (_, v5) = calculate_window_for_cycle(v0, v3);
            if (!(v1 > v5 + 0)) {
                break
            };
            let v6 = v0.original_amount_per_cycle;
            let v7 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v0.in_balance, 0x1::type_name::with_defining_ids<T0>());
            assert!(0x2::balance::value<T0>(v7) >= v6, 35);
            0x2::balance::join<T0>(&mut v2, 0x2::balance::split<T0>(v7, v6));
            v0.current_cycle = v3;
            ...
            0x2::event::emit<CycleRefunded>(v8);
        };
        v2
    }

    public fun claim_order<T0, T1>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        validate_global_config(arg0);
        let Receipt {
            id       : v0,
            order_id : v1,
    ...
    public fun create_batch_orders<T0>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: vector<BatchOrderParams<T0>>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, vector<Receipt>) {
        validate_global_config(arg0);
        ...
        while (v6 < v7) {
            ...
            let v18 = Order{
                ...
                fulfilled_time_ms         : 0x1::vector::empty<u64>(),
                next_execution_time_ms    : v4 + v11,
                current_cycle             : 0,
                created_at_ms             : v4,
    ...
    public fun create_order<T0, T1>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : Receipt {
        validate_global_config(arg0);
        assert!(arg4 > 0, 10);
        assert!(arg3 > 0, 11);
        ...
        let v4 = Order{
            ...
            fulfilled_time_ms         : 0x1::vector::empty<u64>(),
            next_execution_time_ms    : v1 + arg5,
            current_cycle             : 0,
            created_at_ms             : v1,
    ...
    public fun end_execute_order<T0, T1>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::ExecTicket, arg3: 0x2::coin::Coin<T1>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        validate_global_config(arg0);
        let v0 = 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::get_order_id(&arg2);
        ...
        let v2 = 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::get_cycle_number(&arg2);
        ...
        let v5 = 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::get_execution_time(&arg2);
        0x1::vector::push_back<u64>(&mut v1.fulfilled_time_ms, v5);
        v1.current_cycle = v2;
        if (v1.current_cycle >= v1.order_num) {
            v1.status = 1;
            v1.next_execution_time_ms = 0;
        } else {
            v1.next_execution_time_ms = calculate_next_exec_time_after(v1, v1.current_cycle);
        };
        v1.executing_flag = false;
        let v6 = OrderFilled{
            recipe_id            : v0,
            cycle_number         : 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::get_cycle_number(&arg2),
            fulfilled_time_ms    : v5,
            from_coin_type       : 0x1::type_name::with_defining_ids<T0>(),
            to_coin_type         : 0x1::type_name::with_defining_ids<T1>(),
            amount_in_borrowed   : 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::get_amount_borrowed(&arg2),
            amount_in_spent      : 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::get_amount_in_max(&arg2),
            amount_out           : v3,
            protocol_fee_charged : 0,
        };
        0x2::event::emit<OrderFilled>(v6);
        let (_, _, _, _, _, _, _, _) = 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::destroy_exec_ticket(arg2);
    }
    ...
    public fun operator_end_execute_and_payout<T0, T1>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::OperatorCap, arg1: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg2: &mut OrderRegistry, arg3: 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::ExecTicket, arg4: 0x2::coin::Coin<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        validate_global_config(arg1);
        let v0 = 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::get_order_id(&arg3);
        assert!(0x2::table::contains<address, Order>(&arg2.orders, v0), 37);
        let v1 = 0x2::table::borrow_mut<address, Order>(&mut arg2.orders, v0);
        validate_order_types<T0, T1>(v1);
        assert!(v1.executing_flag, 27);
        let v2 = 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::get_cycle_number(&arg3);
        assert!(v2 > v1.current_cycle, 27);
        let v3 = 0x2::coin::value<T1>(&arg4);
        assert!(v3 >= v1.min_amount_out, 25);
        assert!(v3 <= v1.max_amount_out, 25);
        let v4 = 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::get_execution_time(&arg3);
        0x1::vector::push_back<u64>(&mut v1.fulfilled_time_ms, v4);
        v1.current_cycle = v2;
        if (v1.current_cycle >= v1.order_num) {
            v1.status = 1;
            v1.next_execution_time_ms = 0;
        ...
        let v5 = OrderFilled{
            recipe_id            : v0,
            cycle_number         : v2,
            fulfilled_time_ms    : v4,
            from_coin_type       : 0x1::type_name::with_defining_ids<T0>(),
            to_coin_type         : 0x1::type_name::with_defining_ids<T1>(),
            amount_in_borrowed   : 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::get_amount_borrowed(&arg3),
            amount_in_spent      : 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::get_amount_in_max(&arg3),
            amount_out           : v3,
            protocol_fee_charged : 0,
        };
        ...
        let (_, _, _, _, _, _, _, _) = 0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::destroy_exec_ticket(arg3);
    }

    public fun operator_finalize_completed<T0, T1>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::OperatorCap, arg1: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg2: &mut OrderRegistry, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        validate_global_config(arg1);
        ...
        v0.out_withdrawn = v0.out_withdrawn + v5;
        v0.executing_flag = false;
        ...
        let v6 = OrderFinished{
            recipe_id           : arg3,
            amount_in_returned  : 0x2::balance::value<T0>(&v2),
            amount_out_returned : v5,
            from_coin_type      : 0x1::type_name::with_defining_ids<T0>(),
            to_coin_type        : 0x1::type_name::with_defining_ids<T1>(),
            is_early_terminated : false,
        };
        0x2::event::emit<OrderFinished>(v6);
    }

    public fun operator_refund_missed_cycle_input<T0>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::OperatorCap, arg1: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg2: &mut OrderRegistry, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        validate_global_config(arg1);
        assert!(0x2::table::contains<address, Order>(&arg2.orders, arg3), 37);
        let v0 = 0x2::table::borrow_mut<address, Order>(&mut arg2.orders, arg3);
        assert!(v0.status == 0, 33);
    ...
    public fun start_execute_order<T0>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::OperatorCap, arg1: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg2: &mut OrderRegistry, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::ExecTicket, 0x2::coin::Coin<T0>) {
        validate_global_config(arg1);
        assert!(0x2::table::contains<address, Order>(&arg2.orders, arg3), 37);
        let v0 = 0x2::table::borrow_mut<address, Order>(&mut arg2.orders, arg3);
        ...
        (0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::types::new_exec_ticket(arg3, v5, v5, v1, v2, v3, v4, v1), 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v6, v5), arg5))
    }
    ...
    fun validate_global_config(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig) {
        assert!(!0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::is_paused(arg0), 1);
        assert!(0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::get_version(arg0) == 2, 2);
    }
    ...
    public fun withdraw_output<T0>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: &Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        validate_global_config(arg0);
        assert!(0x2::table::contains<address, Order>(&arg1.orders, arg2.order_id), 37);
        let v0 = 0x2::table::borrow_mut<address, Order>(&mut arg1.orders, arg2.order_id);
        validate_order_ownership(v0, arg4);
    ...
    public fun withdraw_output_amount<T0>(arg0: &0xb90cd30ffb95d4aaf66cc62b4048d2183c3a592c23b583c463d06a052bb75ec0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: &Receipt, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        validate_global_config(arg0);
        assert!(0x2::table::contains<address, Order>(&arg1.orders, arg2.order_id), 37);
        let v0 = 0x2::table::borrow_mut<address, Order>(&mut arg1.orders, arg2.order_id);
