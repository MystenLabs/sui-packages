module 0xb98d7620a77127f410c81b1ba0f2393082a81a51301887b71a4e09e87704fadd::cnsnft9273 {
    struct CNSNFT9273 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9273, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4528"));
        let v4 = 0x2::package::claim<CNSNFT9273>(arg0, arg1);
