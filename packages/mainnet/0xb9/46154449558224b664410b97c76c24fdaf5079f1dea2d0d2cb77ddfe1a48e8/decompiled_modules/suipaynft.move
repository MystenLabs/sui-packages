module 0xb946154449558224b664410b97c76c24fdaf5079f1dea2d0d2cb77ddfe1a48e8::suipaynft {
    ...
    fun mintInternal(arg0: &mut ContractInfo, arg1: u8, arg2: u16, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        if (arg2 == 0) {
            arg2 = ((0xb946154449558224b664410b97c76c24fdaf5079f1dea2d0d2cb77ddfe1a48e8::pseudorandom::rand_u32(arg7) % 65535) as u16);
        };
