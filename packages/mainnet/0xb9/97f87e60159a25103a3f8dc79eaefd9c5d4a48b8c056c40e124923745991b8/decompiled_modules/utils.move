module 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils {
    ...
    public fun get_left_string_right_number(arg0: &0x1::string::String) : (0x1::string::String, u64) {
        let v0 = 0x1::string::utf8(b"-");
        let v1 = 0x1::string::index_of(arg0, &v0);
        if (v1 == 0x1::string::length(arg0)) {
            return (0x1::string::sub_string(arg0, 0, v1), 0)
        };
        (0x1::string::sub_string(arg0, 0, v1), utf8_to_u64(0x1::string::sub_string(arg0, v1 + 1, 0x1::string::length(arg0))))
    }
