module 0xb9c30d3dcc861341b80f9f1eb13d5309be8871d4eb27e49a539bf3bd673d9eb8::tugo {
    ...
    fun init(arg0: TUGO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<TUGO>(&mut v2, 100000000000, 0x2::tx_context::sender(arg1), arg1);
