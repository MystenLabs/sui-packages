module 0xb98337c942becf280ee267a9e548b07dd08833bbff1bcf18420da63b35243dc5::cak {
    struct CAK has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CAK, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 1000000000;
        let (v1, v2) = 0x2::coin::create_currency<CAK>(arg0, 6, b"Raise 16", b"Also Raise 16", b"__Description here__", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"__Url here__")), arg1);
        let v3 = v1;
