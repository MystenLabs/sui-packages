module 0xb920ff2cd5b78aaadb26c818b2074c2b5e7d8201d0c1f649f1e1cd8b29d84713::cnsnft3206 {
    struct CNSNFT3206 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3206, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3206>(arg0, arg1);
