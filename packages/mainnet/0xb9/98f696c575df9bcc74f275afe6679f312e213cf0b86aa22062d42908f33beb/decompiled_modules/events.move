module 0xb998f696c575df9bcc74f275afe6679f312e213cf0b86aa22062d42908f33beb::events {
    struct OrderCreated has copy, drop {
        order_hash: vector<u8>,
        order: 0xb998f696c575df9bcc74f275afe6679f312e213cf0b86aa22062d42908f33beb::order::Order,
    }
    ...
    public(friend) fun order_created(arg0: vector<u8>, arg1: 0xb998f696c575df9bcc74f275afe6679f312e213cf0b86aa22062d42908f33beb::order::Order) {
        let v0 = OrderCreated{
            order_hash : arg0,
            order      : arg1,
        };
    ...
    public(friend) fun order_filled(arg0: vector<u8>, arg1: 0xb998f696c575df9bcc74f275afe6679f312e213cf0b86aa22062d42908f33beb::order::Order) {
        let v0 = OrderFilled{
            order_hash : arg0,
            order      : arg1,
        };
