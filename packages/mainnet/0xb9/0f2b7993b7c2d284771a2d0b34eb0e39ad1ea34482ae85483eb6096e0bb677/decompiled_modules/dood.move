module 0xb90f2b7993b7c2d284771a2d0b34eb0e39ad1ea34482ae85483eb6096e0bb677::dood {
    ...
    fun init(arg0: DOOD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<DOOD>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DOOD    ")))), trim_right(b"doodles                         "), trim_right(b"the creative revolution is here.                                                                                                                                                                                                                                                                                                "), v2, arg1);
