module 0xb956580f82b2b14f25eca79b48c5ec80a221fdf060071034af6fc05475b51922::penguin {
    ...
    fun init(arg0: PENGUIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/22FQFZJourCceAxqMQ1mkf83LBHaMp4js3pkGHxjrvMV.png?size=lg&key=76b5c5                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<PENGUIN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Penguin   ")))), trim_right(b"Club Penguin                    "), trim_right(b"Based on the current Penguin hypes. We all remember the OG Club Penguin and that's where it all started                                                                                                                                                                                                                         "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
