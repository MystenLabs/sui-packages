module 0xb9aef71be0f79c0a111763087f3d835028b8d0c0ccadb93f03a35f2093f55937::reward4725 {
    struct REWARD4725 has drop {
        dummy_field: bool,
    }

    struct TICKET_4725 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4725(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4725>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4725>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4725, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4725>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4725>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4725>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4725>>(v5, 0x2::tx_context::sender(arg1));
    }
