module 0xb9a654e3c39cc13c1e2b145b68db6399604843e948402f203e11bd9df5a5f8b6::reward7827 {
    struct REWARD7827 has drop {
        dummy_field: bool,
    }

    struct TICKET_7827 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7827(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7827>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7827>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7827, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7827>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7827>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7827>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7827>>(v5, 0x2::tx_context::sender(arg1));
    }
