module 0xb9cb33ec10384413680e8327a1bd2c09704852b4132afa42075b90cdceac4b6c::ocr3_base {
    ...
    fun assign_signer_oracles(arg0: &mut 0x2::table::Table<u8, vector<UnvalidatedPublicKey>>, arg1: u8, arg2: &vector<vector<u8>>) {
        ...
        while (v0 < 0x1::vector::length<vector<u8>>(arg2)) {
            0xe70da5ac8e13225f8b4c12b6060dda15c2036612d476b0f76431fdc271d82ae::address::assert_non_zero_address_vector(0x1::vector::borrow<vector<u8>>(arg2, v0));
            v0 = v0 + 1;
        };
    ...
    fun assign_transmitter_oracles(arg0: &mut 0x2::table::Table<u8, vector<address>>, arg1: u8, arg2: &vector<address>) {
        ...
        while (v0 < 0x1::vector::length<address>(arg2)) {
            0xe70da5ac8e13225f8b4c12b6060dda15c2036612d476b0f76431fdc271d82ae::address::assert_non_zero_address(*0x1::vector::borrow<address>(arg2, v0));
            v0 = v0 + 1;
        };
    ...
    public(friend) fun set_ocr3_config(arg0: &0xe70da5ac8e13225f8b4c12b6060dda15c2036612d476b0f76431fdc271d82ae::state_object::CCIPObjectRef, arg1: &mut OCR3BaseState, arg2: vector<u8>, arg3: u8, arg4: u8, arg5: bool, arg6: vector<vector<u8>>, arg7: vector<address>) {
        0xe70da5ac8e13225f8b4c12b6060dda15c2036612d476b0f76431fdc271d82ae::upgrade_registry::verify_function_allowed(arg0, 0x1::string::utf8(b"ocr3_base"), 0x1::string::utf8(b"set_ocr3_config"), 1);
        assert!(arg4 != 0, 2);
