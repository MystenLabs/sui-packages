module 0xb9cb33ec10384413680e8327a1bd2c09704852b4132afa42075b90cdceac4b6c::ownable {
    ...
    public(friend) fun new(arg0: &mut 0x2::object::UID, arg1: &0x2::tx_context::TxContext) : (OwnableState, OwnerCap) {
        let v0 = OwnerCap{id: 0x2::derived_object::claim<vector<u8>>(arg0, b"CCIP_OFFRAMP_OWNABLE")};
