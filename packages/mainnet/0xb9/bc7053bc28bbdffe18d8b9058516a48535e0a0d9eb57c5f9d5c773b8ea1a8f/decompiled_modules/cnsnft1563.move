module 0xb9bc7053bc28bbdffe18d8b9058516a48535e0a0d9eb57c5f9d5c773b8ea1a8f::cnsnft1563 {
    struct CNSNFT1563 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1563, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1563>(arg0, arg1);
