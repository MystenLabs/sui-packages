module 0xb91b618aba9fcc1d0bf62209b3fb58e0b168a2dddf3fb86cb0ab752a4d5794d6::cnsnft3312 {
    struct CNSNFT3312 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3312, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3312>(arg0, arg1);
