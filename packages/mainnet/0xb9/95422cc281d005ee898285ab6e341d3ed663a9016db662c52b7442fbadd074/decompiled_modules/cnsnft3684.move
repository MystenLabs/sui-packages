module 0xb995422cc281d005ee898285ab6e341d3ed663a9016db662c52b7442fbadd074::cnsnft3684 {
    struct CNSNFT3684 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3684, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7228"));
        let v4 = 0x2::package::claim<CNSNFT3684>(arg0, arg1);
