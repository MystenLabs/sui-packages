module 0xb9588bfeaec922d7eff0d231a3cab59d6942962df4db4598d38c545b0ed24c47::cast {
    ...
    public fun read(arg0: &mut Cast, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &mut 0xb9588bfeaec922d7eff0d231a3cab59d6942962df4db4598d38c545b0ed24c47::abyss::Abyss, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.fee_paid == 0) {
            0xb9588bfeaec922d7eff0d231a3cab59d6942962df4db4598d38c545b0ed24c47::abyss::receive_read(arg2, arg1, arg4, arg5);
        } else {
            assert!(v3 >= 100000, 4);
    ...
    public fun sound(arg0: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg1: &mut 0xb9588bfeaec922d7eff0d231a3cab59d6942962df4db4598d38c545b0ed24c47::abyss::Abyss, arg2: 0x2::object::ID, arg3: u8, arg4: vector<u8>, arg5: vector<u8>, arg6: 0x1::option::Option<vector<u8>>, arg7: u8, arg8: address, arg9: u8, arg10: u64, arg11: u64, arg12: vector<u8>, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
        assert!(arg11 >= 1 && arg11 <= 10000, 6);
        let v0 = (arg11 - 1) * 10000;
        assert!(0x2::coin::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&arg0) >= v0, 7);
        ...
        0xb9588bfeaec922d7eff0d231a3cab59d6942962df4db4598d38c545b0ed24c47::abyss::receive_cast(arg1, arg0, arg13, arg14);
        let v3 = Cast{
        ...
        if (arg11 > 1) {
            ...
            0x2::event::emit<DockOpened>(v7);
        };
        0x2::transfer::share_object<Cast>(v3);
    }
