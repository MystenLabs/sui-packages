module 0xb9a15e8f67eaf713f354584ee526ac39b4d5071f13d5b401cceb513f02b634c8::meta {
    ...
    fun init(arg0: META, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<META>(arg0, 9, b"META", b"META", b"META", 0x1::option::some<0x2::url::Url>(0xb9a15e8f67eaf713f354584ee526ac39b4d5071f13d5b401cceb513f02b634c8::icon::get_icon_url()), arg1);
        let v2 = v1;
        let v3 = v0;
