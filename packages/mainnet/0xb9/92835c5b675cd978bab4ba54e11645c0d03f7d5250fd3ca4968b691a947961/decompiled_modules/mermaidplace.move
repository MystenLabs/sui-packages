module 0xb992835c5b675cd978bab4ba54e11645c0d03f7d5250fd3ca4968b691a947961::mermaidplace {
    struct MermaidplaceConfig has store, key {
        ...
        table_sponsor: 0x2::table::Table<address, address>,
    }
    ...
    public entry fun add_sponsor(arg0: &mut MermaidplaceConfig, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<address, address>(&mut arg0.table_sponsor, arg1) == true, 1);
        0x2::table::add<address, address>(&mut arg0.table_sponsor, 0x2::tx_context::sender(arg2), arg1);
    }

    public entry fun buy<T0: store + key>(arg0: &mut MermaidplaceConfig, arg1: &mut 0xb992835c5b675cd978bab4ba54e11645c0d03f7d5250fd3ca4968b691a947961::royalty_fee::RoyaltyBag, arg2: 0x2::object::ID, arg3: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0xb992835c5b675cd978bab4ba54e11645c0d03f7d5250fd3ca4968b691a947961::royalty_fee::charge_royalty<T0>(arg1, v3, &mut v1, arg4);
        assert!(v8 + v9 < v3, 5);
        let v10 = v3 - v8 - v9;
    ...
    public entry fun get_sponsor(arg0: &mut MermaidplaceConfig, arg1: address) : address {
        *0x2::table::borrow<address, address>(&mut arg0.table_sponsor, arg1)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = MermaidplaceConfig{
            ...
            table_sponsor : 0x2::table::new<address, address>(arg0),
        };
        0x2::transfer::public_share_object<MermaidplaceConfig>(v0);
        0xb992835c5b675cd978bab4ba54e11645c0d03f7d5250fd3ca4968b691a947961::royalty_fee::init_royalty_bag(arg0);
    }
    ...
    public entry fun set_mermaidplace_sponsor(arg0: &mut MermaidplaceConfig, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg3), 1);
        0x2::table::add<address, address>(&mut arg0.table_sponsor, arg1, arg2);
    }
