module 0xb9f3f35e9da4d31c15ff80246078a7c9eb2b5cd4e7b2bf7cc7ca222a33dddf33::cnsnft1910 {
    struct CNSNFT1910 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1910, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4066"));
        let v4 = 0x2::package::claim<CNSNFT1910>(arg0, arg1);
