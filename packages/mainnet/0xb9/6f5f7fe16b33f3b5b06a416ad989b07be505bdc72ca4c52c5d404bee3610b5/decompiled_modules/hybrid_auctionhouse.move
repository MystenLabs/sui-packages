module 0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::hybrid_auctionhouse {
    ...
    public fun accept_direct_for_kiosk_offer<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &mut 0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (T0, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        let v13 = if (v8 > 0) {
            ...
            if (0x2::coin::value<0x2::sui::SUI>(&arg6) > v8) {
                0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg6, v8, arg8)));
                arg6
            } else {
                0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg6));
    ...
    public fun accept_kiosk_for_direct_offer<T0: store + key, T1: store + key>(arg0: &mut Hybrid_Auctionhouse_Store, arg1: &mut 0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: T1, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &0x2::transfer_policy::TransferPolicy<T0>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        let v12 = if (v8 > 0) {
            ...
            if (0x2::coin::value<0x2::sui::SUI>(&arg8) > v8) {
                0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg8, v8, arg10)));
                arg8
            } else {
                0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg8));
    ...
    public entry fun create_and_share_hybrid_auctionhouse_store(arg0: &0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_hybrid_auctionhouse(arg0: &0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Hybrid_Auctionhouse_Store {
