module 0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::multi_kiosk_bidding_house {
    ...
    public fun buy_bundle<T0>(arg0: &mut Multi_Kiosk_Auctionhouse, arg1: &mut 0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg3, v3, arg5), 0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::get_owner(arg1));
    ...
    public fun claim_nft<T0: store + key, T1>(arg0: &mut Multi_Kiosk_Auctionhouse, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        let v9 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Bundle<T1>>(&mut arg0.id, arg1);
        let (v10, v11) = 0x1::vector::index_of<0x2::object::ID>(&v9.bundled_nfts, &v2);
        assert!(v10, 24);
        0x1::vector::remove<0x2::object::ID>(&mut v9.bundled_nfts, v11);
        0x2::object::delete(v3);
        let (v12, v13) = 0x2::kiosk::purchase_with_cap<T0>(arg3, v7, 0x2::coin::zero<0x2::sui::SUI>(arg5));
        let v14 = NftClaimed{
            bundle_id      : arg1,
            nft_id         : arg2,
            bundled_nft_id : v2,
    ...
    public entry fun create_shared_store(arg0: &0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Multi_Kiosk_Auctionhouse>(create_store(arg0, arg1));
    }

    public fun create_store(arg0: &0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Multi_Kiosk_Auctionhouse {
        assert!(0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::is_admin(arg0, 0x2::tx_context::sender(arg1)), 999);
        Multi_Kiosk_Auctionhouse{
            id                    : 0x2::object::new(arg1),
            auction_house         : 0x2::object::id<0xb96f5f7fe16b33f3b5b06a416ad989b07be505bdc72ca4c52c5d404bee3610b5::auctionhouse::AuctionHouse>(arg0),
    ...
    public fun remove_nft_from_bundle<T0: store + key, T1>(arg0: &mut Multi_Kiosk_Auctionhouse, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::remove<0x2::object::ID, 0x2::object::ID>(&mut arg0.nft_to_bundled_nft, arg2);
        0x2::table::remove<0x2::object::ID, 0x2::object::ID>(&mut arg0.bundled_nft_to_bundle, v2);
        let v10 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Bundle<T1>>(&mut arg0.id, arg1);
        let (v11, v12) = 0x1::vector::index_of<0x2::object::ID>(&v10.bundled_nfts, &v2);
        assert!(v11, 24);
        0x1::vector::remove<0x2::object::ID>(&mut v10.bundled_nfts, v12);
        0x2::kiosk::return_purchase_cap<T0>(arg3, v8);
        0x2::object::delete(v4);
        let v13 = NftReturnedToSeller{
            bundle_id      : arg1,
            nft_id         : arg2,
            bundled_nft_id : v2,
            seller         : v0,
        ...
        0x2::event::emit<NftReturnedToSeller>(v13);
    ...
    fun validate_bundle_state<T0>(arg0: &Multi_Kiosk_Auctionhouse, arg1: 0x2::object::ID, arg2: u64) {
        let v0 = 0x2::dynamic_object_field::borrow<0x2::object::ID, Bundle<T0>>(&arg0.id, arg1);
        let v1 = 0;
        let v2 = 0x1::vector::length<0x2::object::ID>(&v0.bundled_nfts);
        while (v1 < v2) {
            let v3 = *0x1::vector::borrow<0x2::object::ID>(&v0.bundled_nfts, v1);
            assert!(0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg0.id, v3), 24);
            assert!(0x2::table::contains<0x2::object::ID, 0x2::object::ID>(&arg0.bundled_nft_to_bundle, v3), 24);
            assert!(*0x2::table::borrow<0x2::object::ID, 0x2::object::ID>(&arg0.bundled_nft_to_bundle, v3) == arg1, 24);
            v1 = v1 + 1;
        };
