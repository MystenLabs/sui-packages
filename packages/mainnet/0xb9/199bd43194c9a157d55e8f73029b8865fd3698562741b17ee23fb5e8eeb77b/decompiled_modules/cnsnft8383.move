module 0xb9199bd43194c9a157d55e8f73029b8865fd3698562741b17ee23fb5e8eeb77b::cnsnft8383 {
    struct CNSNFT8383 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8383, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8383>(arg0, arg1);
