module 0x1055e572d8fd7880b69c8f89fcddbb8303422dbb60651d348f2b0ee061132626::rollify_tickets {
    ...
    fun init(arg0: ROLLIFY_TICKETS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Claim USDT by opening a support ticket on Rollify.com"));
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Rollify"));
