module 0x10a181b53198c46f4cdf198c9f561e0d116705c827c0b756ab8bd3377db2efa2::swap_fees {
    ...
    entry fun fee_on_in(arg0: &mut Fees, arg1: u64, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::put<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::split<0x2::sui::SUI>(arg2, (arg1 - 0x2::coin::value<0x2::sui::SUI>(arg2)) * 100 / 10000, arg3));
    }
