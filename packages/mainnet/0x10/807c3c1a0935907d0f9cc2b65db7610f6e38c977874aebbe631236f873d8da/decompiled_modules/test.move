module 0x10807c3c1a0935907d0f9cc2b65db7610f6e38c977874aebbe631236f873d8da::test {
    ...
    fun init(arg0: TEST, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = vector[b"TEST", b"TEST", b"", b"https://api.interestlabs.io/files/61e311815059ee4c70fbd7d72da6ff7cd7409594330e0b43.jpeg"];
        let v2 = vector[b"TEST", b"TEST", b"", b"https://api.interestlabs.io/files/61e311815059ee4c70fbd7d72da6ff7cd7409594330e0b43.jpeg"];
        let v3 = vector[b"TEST", b"TEST", b"", b"https://api.interestlabs.io/files/61e311815059ee4c70fbd7d72da6ff7cd7409594330e0b43.jpeg"];
        let v4 = vector[b"TEST", b"TEST", b"", b"https://api.interestlabs.io/files/61e311815059ee4c70fbd7d72da6ff7cd7409594330e0b43.jpeg"];
