module 0x10afa003048bcb73eaf0d9f03d2fc5aac7d6794aa32c7d2d94701c7dce369e8a::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"CUCK", b"CUCK", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-13T09-38-16.251Z-600x600.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"CUCK"),
            symbol     : 0x1::string::utf8(b"CUCK"),
            decimals   : 9,
