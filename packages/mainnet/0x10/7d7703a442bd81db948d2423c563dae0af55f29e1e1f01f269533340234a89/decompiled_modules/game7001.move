module 0x107d7703a442bd81db948d2423c563dae0af55f29e1e1f01f269533340234a89::game7001 {
    struct GAME7001 has drop {
        dummy_field: bool,
    }

    struct TICKET_7001 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7001(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7001>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7001>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME7001, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME7001>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7001>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7001>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7001>>(v5, 0x2::tx_context::sender(arg1));
    }
