module 0x106a68789b98bcd7cb168c873919d75ede6db34206d881a0b32bd1ac206568fd::cnsnft6220 {
    struct CNSNFT6220 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6220, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6220>(arg0, arg1);
