module 0x10a63997d40245251a71801a7f13776be1fcb52026dfd50799dbafa09d1d4cb1::cnsnft9869 {
    struct CNSNFT9869 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9869, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9869>(arg0, arg1);
