module 0x10603b3372c61b5b63568da5839f417db21d9a0490c7f82e81af463c5ac990e4::cnsnft3075 {
    struct CNSNFT3075 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3075, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8874"));
        let v4 = 0x2::package::claim<CNSNFT3075>(arg0, arg1);
