module 0xac55259d62fd8c30dd638f46afab109bc6a1066c4e92093b791d60e6bad266e7::session {
    ...
    fun grid_at(arg0: &Session, arg1: u8) : u64 {
        *0x1::vector::borrow<u64>(&arg0.expected, (arg1 as u64) + (3 as u64))
    }
    ...
    public fun min_out_for_rung(arg0: u64, arg1: u8) : u64 {
        (((arg0 as u128) * (ladder_bps(arg1) as u128) / (10000 as u128)) as u64)
    }
    ...
    public fun put<T0>(arg0: &mut Session, arg1: u8, arg2: 0x2::balance::Balance<T0>, arg3: u64) {
        ...
        let v0 = if (is_grid(arg0)) {
            let v1 = scale_to_principal(arg0, arg3);
            if (arg1 + 1 == arg0.hops) {
                let v2 = arg0.principal + scale_to_principal(arg0, arg0.flash_fee) + arg0.min_profit;
                if (v2 > v1) {
                    v2
                } else {
                    v1
            ...
            min_out_for_rung(arg3, arg0.rung)
        };
        assert!(0x2::balance::value<T0>(&arg2) >= v0, 108);
    ...
    fun scale_to_principal(arg0: &Session, arg1: u64) : u64 {
        (((arg1 as u128) * (arg0.principal as u128) / (arg0.notional as u128)) as u64)
    }

    public fun search(arg0: &mut Session, arg1: &0x2::clock::Clock) {
        assert!(arg0.phase == 0, 103);
        assert!(is_grid(arg0), 115);
        assert!(0x2::clock::timestamp_ms(arg1) <= arg0.deadline_ms, 106);
        let v0 = 0;
        while (v0 < 3) {
            assert!(*0x1::vector::borrow<u8>(&arg0.quoted, (v0 as u64)) == arg0.hops, 105);
        ...
        v0 = 0;
        while (v0 < 3) {
            let v5 = grid_at(arg0, v0);
            let v6 = (((arg0.flash_fee as u128) * (v5 as u128) / (arg0.notional as u128)) as u64);
            let v7 = v5 + v6 + arg0.min_profit;
            let v8 = *0x1::vector::borrow<u64>(&arg0.expected, (v0 as u64));
            if (v8 >= v7) {
                if (!v1 || v8 - v5 - v6 > 0) {
                    v1 = true;
                    v3 = v8;
        ...
        if (v1) {
            arg0.rung = v2;
            arg0.principal = grid_at(arg0, v2);
        };
        let v9 = SearchDecision{
            tag          : arg0.tag,
            sender       : arg0.sender,
            armed        : v1,
            slot         : v2,
        ...
        0x2::event::emit<SearchDecision>(v9);
    }
    ...
    public fun start_grid<T0>(arg0: u128, arg1: vector<u64>, arg2: u64, arg3: u64, arg4: u8, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : Session {
        assert!(arg4 > 0 && arg4 <= 8, 102);
        assert!(0x1::vector::length<u64>(&arg1) == (3 as u64), 114);
        let v0 = 0x2::bag::new(arg6);
        0x2::bag::add<u8, 0x2::balance::Balance<T0>>(&mut v0, 255, 0x2::balance::zero<T0>());
        let v1 = 0x1::vector::empty<u8>();
        let v2 = 0x1::vector::empty<u64>();
        ...
        let v5 = v4;
        while (v3 < (3 as u64)) {
            let v6 = *0x1::vector::borrow<u64>(&arg1, v3);
            assert!(v6 > v4, 114);
            v5 = v6;
