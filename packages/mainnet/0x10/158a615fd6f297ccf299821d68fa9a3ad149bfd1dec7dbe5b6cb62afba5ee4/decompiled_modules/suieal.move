module 0x10158a615fd6f297ccf299821d68fa9a3ad149bfd1dec7dbe5b6cb62afba5ee4::suieal {
    struct SUIEAL has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUIEAL, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUIEAL>(arg0, 6, b"SUIEAL", b"SealSeal", b"We heard you like Seals! So we put a seal on your seal and wrapped it in a seal chain! Here to enjoy the party with all our ocean friends! ", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/1000015704_3a78f0850e.jpg")), arg1);
