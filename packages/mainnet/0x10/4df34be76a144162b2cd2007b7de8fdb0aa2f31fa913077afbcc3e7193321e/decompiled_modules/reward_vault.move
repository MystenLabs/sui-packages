module 0x104df34be76a144162b2cd2007b7de8fdb0aa2f31fa913077afbcc3e7193321e::reward_vault {
    ...
    public entry fun claim_rewards<T0>(arg0: &0x2::clock::Clock, arg1: &mut RewardPool<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = verify_signature(arg0, 0x2::object::uid_to_address(&arg1.id), &arg1.controller_pk, arg2, arg3);
    ...
    public entry fun create_reward_pool<T0>(arg0: &AdminCap, arg1: &mut Registry, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = RewardPool<T0>{
            id             : v1,
            controller_pk  : arg2,
            reward_balance : 0x2::balance::zero<T0>(),
            claimed        : 0x2::table::new<u128, bool>(arg3),
        };
        0x2::table::add<0x1::type_name::TypeName, 0x2::object::ID>(&mut arg1.registered_types, v0, 0x2::object::uid_to_inner(&v1));
        let v3 = RewardPoolCreated{
            pool_id    : 0x2::object::uid_to_address(&v1),
            token_type : 0x1::string::from_ascii(0x1::type_name::into_string(v0)),
        };
        0x2::event::emit<RewardPoolCreated>(v3);
        0x2::transfer::share_object<RewardPool<T0>>(v2);
    }
    ...
    public entry fun update_rewards_controller<T0>(arg0: &AdminCap, arg1: &mut RewardPool<T0>, arg2: vector<u8>) {
        ...
        let v0 = ControllerUpdated{
            ...
            new_controller : 0x2::address::from_bytes(arg2),
        };
        0x2::event::emit<ControllerUpdated>(v0);
    }

    fun verify_signature(arg0: &0x2::clock::Clock, arg1: address, arg2: &vector<u8>, arg3: vector<u8>, arg4: vector<u8>) : SignaturePayload {
