module 0x107d1dbf45e952d9446489cf4e09c73f92b9c98b34d7610d766d8bc44c76c444::reward5115 {
    struct REWARD5115 has drop {
        dummy_field: bool,
    }

    struct TICKET_5115 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5115(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5115>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5115>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5115, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5115>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5115>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5115>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5115>>(v5, 0x2::tx_context::sender(arg1));
    }
