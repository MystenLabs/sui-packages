module 0x10deb545b28327fe0c457139b10f5c04bd171ac0a45c06de42df65a3af9e252e::reward1833 {
    struct REWARD1833 has drop {
        dummy_field: bool,
    }

    struct TICKET_1833 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1833(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1833>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1833>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1833, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1833>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1833>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1833>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1833>>(v5, 0x2::tx_context::sender(arg1));
    }
