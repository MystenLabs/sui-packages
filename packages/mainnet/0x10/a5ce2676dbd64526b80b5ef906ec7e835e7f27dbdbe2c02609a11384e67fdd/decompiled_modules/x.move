module 0x10a5ce2676dbd64526b80b5ef906ec7e835e7f27dbdbe2c02609a11384e67fdd::x {
    struct X has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: X, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<X>(arg0, 2, b"x", b"x", b"", v1, arg1);
        let v4 = v2;
        0x2::coin::mint_and_transfer<X>(&mut v4, 222200, v0, arg1);
