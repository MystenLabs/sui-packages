module 0x10e55a9d360cfeca9284788e50f9b915083df2a5b215d28103c3e45d75d22e3d::boost_payement {
    ...
    struct MessageEventV2 has copy, drop, store {
        user: address,
        coin_type: 0x1::ascii::String,
        message: 0x1::ascii::String,
        start_time: u64,
    ...
    struct MessageEventV3 has copy, drop, store {
        user: address,
        coin_type: 0x1::ascii::String,
        message: 0x1::ascii::String,
        start_time: u64,
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = BoostOption{
            ...
            amount_pop : 189000000000000,
        };
        0x2::vec_map::insert<u64, BoostOption>(&mut v0, 4, v5);
        let v6 = Config{
            id           : 0x2::object::new(arg0),
            setter       : @0x51f95cd060f4bd4841e271b78d2aa3af45afe3493c2ea2057833ee2a1038f9b,
            pay_to       : @0x51f95cd060f4bd4841e271b78d2aa3af45afe3493c2ea2057833ee2a1038f9b,
            boost_option : v0,
        };
    ...
    public entry fun pay_with_pop<T0>(arg0: &mut Config, arg1: 0x2::coin::Coin<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::vec_map::get<u64, BoostOption>(&arg0.boost_option, &arg2);
        assert!(v0.amount_sui <= 0x2::coin::value<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>(&arg1), 3);
        let v1 = 0x2::clock::timestamp_ms(arg3) / 1000;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>>(arg1, arg0.pay_to);
        let v2 = PaymentEvent{
            user       : 0x2::tx_context::sender(arg4),
            coin_type  : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            start_time : v1,
    ...
    public entry fun replace_boost_options(arg0: &mut Config, arg1: vector<u64>, arg2: vector<u64>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == arg0.setter || v0 == @0x51f95cd060f4bd4841e271b78d2aa3af45afe3493c2ea2057833ee2a1038f9b, 1);
    ...
    public entry fun set_pay_to(arg0: &mut Config, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == @0x51f95cd060f4bd4841e271b78d2aa3af45afe3493c2ea2057833ee2a1038f9b || v0 == arg0.setter, 1);
        arg0.pay_to = arg1;
    }
    ...
    public entry fun update_manage_config(arg0: &mut ManageConfig, arg1: address, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == @0x51f95cd060f4bd4841e271b78d2aa3af45afe3493c2ea2057833ee2a1038f9b, 1);
        arg0.is_live = arg3;
        arg0.pay_to = arg1;
        arg0.fee = arg2;
    }
