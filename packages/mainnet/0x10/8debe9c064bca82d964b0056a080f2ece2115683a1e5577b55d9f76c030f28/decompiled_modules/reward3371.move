module 0x108debe9c064bca82d964b0056a080f2ece2115683a1e5577b55d9f76c030f28::reward3371 {
    struct REWARD3371 has drop {
        dummy_field: bool,
    }

    struct TICKET_3371 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3371(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3371>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3371>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3371, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3371>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3371>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3371>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3371>>(v5, 0x2::tx_context::sender(arg1));
    }
