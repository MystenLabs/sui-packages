module 0x10f50138069cdfdae29666dcd9a7d5cd6bab048e3f9afcbfcddf32596ee286b9::cnsnft9149 {
    struct CNSNFT9149 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9149, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8812"));
        let v4 = 0x2::package::claim<CNSNFT9149>(arg0, arg1);
