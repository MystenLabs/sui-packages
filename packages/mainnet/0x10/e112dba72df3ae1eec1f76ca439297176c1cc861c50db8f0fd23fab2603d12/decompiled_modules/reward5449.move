module 0x10e112dba72df3ae1eec1f76ca439297176c1cc861c50db8f0fd23fab2603d12::reward5449 {
    struct REWARD5449 has drop {
        dummy_field: bool,
    }

    struct TICKET_5449 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5449(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_5449>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5449, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5449>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5449>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5449>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5449>>(v5, 0x2::tx_context::sender(arg1));
    }
