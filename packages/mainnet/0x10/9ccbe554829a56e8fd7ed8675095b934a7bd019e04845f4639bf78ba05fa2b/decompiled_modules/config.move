module 0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::config {
    ...
    struct GlobalConfig has store, key {
        ...
        acl: 0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::ACL,
        package_version: u64,
    }

    struct Count has store, key {
        id: 0x2::object::UID,
        value: u64,
    }
    ...
    public fun acl(arg0: &GlobalConfig) : &0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::ACL {
        &arg0.acl
    }

    public fun add_role(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u8) {
        checked_package_version(arg0);
        0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::add_role(&mut arg0.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::Member> {
        0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        checked_package_version(arg0);
        0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun remove_role(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u8) {
        checked_package_version(arg0);
        0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::remove_role(&mut arg0.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        checked_package_version(arg0);
        0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun check_bin_step_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::has_role(&arg0.acl, arg1, 1), 1);
    }

    public fun check_pair_creator_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::has_role(&arg0.acl, arg1, 5), 6);
    }

    public fun check_pair_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::has_role(&arg0.acl, arg1, 0), 5);
    }

    public fun check_protocol_fee_claim_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::has_role(&arg0.acl, arg1, 2), 2);
    }

    public fun check_quote_whitelist_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::has_role(&arg0.acl, arg1, 4), 11);
    }

    public fun check_rewarder_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::has_role(&arg0.acl, arg1, 3), 3);
    }
    ...
    public fun increase_count(arg0: &mut Count, arg1: u64) {
        arg0.value = arg1;
    }

    public fun increase_count_check(arg0: &mut Count, arg1: u64) {
        if (arg1 > 0) {
            arg0.value = arg1;
        };
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                   : 0x109ccbe554829a56e8fd7ed8675095b934a7bd019e04845f4639bf78ba05fa2b::acl::new(arg0),
            package_version       : 1,
        };
        let v1 = Count{
            id    : 0x2::object::new(arg0),
        ...
        let v4 = &mut v0;
        set_roles(v4, &v2, v3, 0 | 1 << 0 | 1 << 1 | 1 << 2 | 1 << 3 | 1 << 4 | 1 << 5);
        let v5 = InitConfigEvent{
            admin_cap_id     : 0x2::object::id<AdminCap>(&v2),
            global_config_id : 0x2::object::id<GlobalConfig>(&v0),
        };
        0x2::transfer::transfer<AdminCap>(v2, v3);
        0x2::transfer::share_object<GlobalConfig>(v0);
        0x2::transfer::share_object<Count>(v1);
