module 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription {
    ...
    public fun clean_finished_tick_record(arg0: &mut TickRecord, arg1: u64) {
        let v0 = 0x2::math::min(arg1, 0x2::table::length<u64, EpochRecord>(&arg0.epoch_records)) - 1;
        while (v0 > 0) {
            let (_, _, _, v4) = unwrap_epoch_record(0x2::table::remove<u64, EpochRecord>(&mut arg0.epoch_records, v0));
            0x2::table::destroy_empty<address, 0x2::balance::Balance<0x2::sui::SUI>>(v4);
            v0 = v0 - 1;
        };
    }
