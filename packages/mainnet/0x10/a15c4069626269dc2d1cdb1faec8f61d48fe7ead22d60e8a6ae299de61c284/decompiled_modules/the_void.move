module 0x10a15c4069626269dc2d1cdb1faec8f61d48fe7ead22d60e8a6ae299de61c284::the_void {
    struct THE_VOID has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: THE_VOID, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<THE_VOID>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"The Void"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Void Collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://OwK__VH7Xw4guBNYQYtzRFkOE2tsbsQwMC_OnNOJvJg"));
