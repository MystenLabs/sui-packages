module 0x10ca95a01ac950a69a8e797388a359b49d8cf157ec8213f3622496c9c8a88ea9::personal_kiosk {
    struct PersonalKioskCap has store, key {
        id: 0x2::object::UID,
        cap: 0x1::option::Option<0x2::kiosk::KioskOwnerCap>,
    }

    struct PersonalKioskInfo has copy, drop, store {
    ...
    public entry fun create_and_return_ids(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::tx_context::TxContext) : PersonalKioskInfo {
        let v0 = new(arg0, arg1, arg2);
        let v1 = PersonalKioskInfo{
            kiosk_id : 0x2::object::id<0x2::kiosk::Kiosk>(arg0),
            cap_id   : 0x2::object::id<PersonalKioskCap>(&v0),
        };
        0x2::transfer::transfer<PersonalKioskCap>(v0, 0x2::tx_context::sender(arg2));
        v1
    }
    ...
    public entry fun default(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = new(arg0, arg1, arg2);
