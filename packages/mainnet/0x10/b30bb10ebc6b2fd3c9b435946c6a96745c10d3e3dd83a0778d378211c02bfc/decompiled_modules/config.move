module 0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::config {
    ...
    public fun change_xstock_config(arg0: &0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::admin::AdminCap, arg1: &mut Config, arg2: &mut 0x1::option::Option<u64>, arg3: &mut 0x1::option::Option<u64>, arg4: &mut 0x1::option::Option<u64>, arg5: &mut 0x1::option::Option<u64>, arg6: &mut 0x1::option::Option<u64>, arg7: &mut 0x1::option::Option<u128>) {
    ...
    public fun check_version(arg0: &Config) {
        0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::version::check_version(arg0.version);
    }
    ...
    public(friend) fun create_config<T0: drop>(arg0: &T0, arg1: &mut 0x2::tx_context::TxContext) : Config {
        ...
        Config{
            id             : v0,
            version        : 0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::version::current_version(),
            max_age        : 86400,
    ...
    fun init(arg0: CONFIG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_share_object<0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::treasury::Treasury>(0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::treasury::create_treasury(arg1));
        0x2::transfer::public_transfer<0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::admin::AdminCap>(0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::admin::create_admin_cap(arg1), v0);
    ...
    public fun registry_add<T0>(arg0: &0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::admin::AdminCap, arg1: &mut Config, arg2: vector<u8>, arg3: &0x2::tx_context::TxContext) {
        assert!(!registry_contains<T0>(arg1), 2);
        0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::events::emit_add_registry_event(0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::utils::type_to_bytes<T0>(), arg2, arg3);
    ...
    public fun registry_remove<T0>(arg0: &0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::admin::AdminCap, arg1: &mut Config, arg2: vector<u8>, arg3: &0x2::tx_context::TxContext) {
        assert!(registry_contains<T0>(arg1), 3);
        0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::events::emit_remove_registry_event(0x10b30bb10ebc6b2fd3c9b435946c6a96745c10d3e3dd83a0778d378211c02bfc::utils::type_to_bytes<T0>(), arg2, arg3);
