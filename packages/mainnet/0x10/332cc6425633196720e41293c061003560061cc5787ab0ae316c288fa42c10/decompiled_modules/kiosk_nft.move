module 0x10332cc6425633196720e41293c061003560061cc5787ab0ae316c288fa42c10::kiosk_nft {
    ...
    public fun get_royalty_fee_amount(arg0: &0x2::transfer_policy::TransferPolicy<Nft>, arg1: u64) : u64 {
        0x10332cc6425633196720e41293c061003560061cc5787ab0ae316c288fa42c10::royalty_rule::fee_amount<Nft>(arg0, arg1)
    }
    ...
    fun init(arg0: KIOSK_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3;
        let v5 = v2;
        0x10332cc6425633196720e41293c061003560061cc5787ab0ae316c288fa42c10::personal_kiosk_rule::add<Nft>(&mut v5, &v4);
        0x10332cc6425633196720e41293c061003560061cc5787ab0ae316c288fa42c10::kiosk_lock_rule::add<Nft>(&mut v5, &v4);
        0x10332cc6425633196720e41293c061003560061cc5787ab0ae316c288fa42c10::royalty_rule::add<Nft>(&mut v5, &v4, 1000, 1000);
        0x10332cc6425633196720e41293c061003560061cc5787ab0ae316c288fa42c10::witness_rule::add<Nft, Witness>(&mut v5, &v4);
    ...
    public fun pay_royalty_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<Nft>, arg1: &mut 0x2::transfer_policy::TransferRequest<Nft>, arg2: 0x2::coin::Coin<0x2::sui::SUI>) {
        0x10332cc6425633196720e41293c061003560061cc5787ab0ae316c288fa42c10::royalty_rule::pay<Nft>(arg0, arg1, arg2);
    }
    ...
    public fun prove_kiosk_lock_rule(arg0: &0x2::kiosk::Kiosk, arg1: &mut 0x2::transfer_policy::TransferPolicy<Nft>, arg2: &mut 0x2::transfer_policy::TransferRequest<Nft>) {
        0x10332cc6425633196720e41293c061003560061cc5787ab0ae316c288fa42c10::kiosk_lock_rule::prove<Nft>(arg2, arg0);
    }
    ...
    public fun prove_personal_kiosk_rule(arg0: &0x2::kiosk::Kiosk, arg1: &mut 0x2::transfer_policy::TransferPolicy<Nft>, arg2: &mut 0x2::transfer_policy::TransferRequest<Nft>) {
        0x10332cc6425633196720e41293c061003560061cc5787ab0ae316c288fa42c10::personal_kiosk_rule::prove<Nft>(arg0, arg2);
    }
    ...
    public fun prove_witness_rule(arg0: &0x2::transfer_policy::TransferPolicy<Nft>, arg1: &mut 0x2::transfer_policy::TransferRequest<Nft>) {
        ...
        0x10332cc6425633196720e41293c061003560061cc5787ab0ae316c288fa42c10::witness_rule::prove<Nft, Witness>(v0, arg0, arg1);
    }
