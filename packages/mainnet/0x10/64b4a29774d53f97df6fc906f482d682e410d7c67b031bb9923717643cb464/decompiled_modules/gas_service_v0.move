module 0x1064b4a29774d53f97df6fc906f482d682e410d7c67b031bb9923717643cb464::gas_service_v0 {
    ...
    public(friend) fun add_gas<T0>(arg0: &mut GasService_v0, arg1: 0x2::coin::Coin<T0>, arg2: 0x1::ascii::String, arg3: address, arg4: vector<u8>) {
        put<T0>(arg0, arg1);
        0x1064b4a29774d53f97df6fc906f482d682e410d7c67b031bb9923717643cb464::events::gas_added<T0>(arg2, 0x2::coin::value<T0>(&arg1), arg3, arg4);
    }
    ...
    public(friend) fun collect_gas<T0>(arg0: &mut GasService_v0, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x1064b4a29774d53f97df6fc906f482d682e410d7c67b031bb9923717643cb464::events::gas_collected<T0>(arg1, arg2);
    }
    ...
    public(friend) fun refund<T0>(arg0: &mut GasService_v0, arg1: 0x1::ascii::String, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x1064b4a29774d53f97df6fc906f482d682e410d7c67b031bb9923717643cb464::events::refunded<T0>(arg1, arg3, arg2);
    }
