module 0x10ee26f23e771019e1adf281c67af4fc93061631e339c01d4219abaa1e07ee68::fish {
    struct FISH has drop {
        dummy_field: bool,
    }

    fun init(arg0: FISH, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FISH>(arg0, 6, b"FISH", b"Fishio", b"Fishio just swam onto the Sui network!  'How much is the fish?' Enough to make waves! Dive in, have a laugh, and ride the tide of the funniest memecoin aroud", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/hm_M4_FHT_400x400_f59a025018.jpg")), arg1);
