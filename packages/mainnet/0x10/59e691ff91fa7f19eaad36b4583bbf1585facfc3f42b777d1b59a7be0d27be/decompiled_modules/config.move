module 0x1059e691ff91fa7f19eaad36b4583bbf1585facfc3f42b777d1b59a7be0d27be::config {
    ...
    public(friend) fun deduct_fee<T0>(arg0: &mut Config, arg1: &mut 0x2::balance::Balance<T0>) : u64 {
        let v0 = calculate_fee(0x2::balance::value<T0>(arg1), arg0.protocol_fee_bps);
        if (v0 > 0) {
