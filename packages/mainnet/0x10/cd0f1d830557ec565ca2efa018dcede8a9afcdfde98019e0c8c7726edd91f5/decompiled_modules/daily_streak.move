module 0x10cd0f1d830557ec565ca2efa018dcede8a9afcdfde98019e0c8c7726edd91f5::daily_streak {
    ...
    fun assert_valid_version(arg0: &DailyStreakRegistry) {
        ...
        assert!(0x2::vec_set::contains<u64>(&arg0.version_set, &v0), 13838718252183060503);
    }
    ...
    public fun borrow_user_daily_streak_data(arg0: &DailyStreakRegistry, arg1: address) : &UserDailyStreakData {
        ...
        assert!(0x2::dynamic_object_field::exists_<UserDailyStreakKey>(&arg0.id, v0), 13837592489714647055);
    ...
    fun borrow_user_daily_streak_data_mut(arg0: &mut DailyStreakRegistry, arg1: address) : &mut UserDailyStreakData {
        let v0 = UserDailyStreakKey{pos0: arg1};
        assert!(0x2::dynamic_object_field::exists_<UserDailyStreakKey>(&arg0.id, v0), 13837592700168044559);
        let v1 = UserDailyStreakKey{pos0: arg1};
    ...
    public fun buy_streak_freezes<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: &mut 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::get_dollar_coin_type(arg0) == v2, 13837032310014869515);
    ...
    fun buy_streak_freezes_internal(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64) {
        assert!(arg2 > 0, 13838157110410608659);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        let v1 = borrow_daily_streak_registry_mut(arg0);
        if (!v1.is_enabled) {
            abort 13835342446541668353
        };
        ...
        if (v10 > 0) {
            assert!(v11 + v6 < v0, 13837876009095921681);
            ...
            if (v18 > v9) {
                ...
                assert!(v19 + v6 < v0, 13837876241024155665);
        ...
        if (v25 > 0) {
            ...
            if (v33 > 0) {
                ...
                if (v33 > v26) {
                    abort 13837876464362455057
                };
            };
        };
        let v34 = v26 - v31;
        let v35 = v34 + arg2;
        assert!(v35 <= v23.max_number_of_freezes_per_player, 13835906169589465093);
    ...
    fun edit_daily_streak_registry_internal(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: bool, arg2: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg3: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg4: u64, arg5: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg6: u64) {
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_negative(&arg2), 13838437984092028949);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_negative(&arg3), 13838437988386996245);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_negative(&arg5), 13838437992681963541);
    ...
    fun quote_dollar_coin_amount_for_usd_cost(arg0: &0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: 0x1::type_name::TypeName, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock, arg4: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg5: u8) : (0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, u64) {
        let (v0, v1, _) = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::get_checked_usd_price(arg0, arg1, arg2, arg3);
        let v3 = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::price_lower_bound(v0, v1);
        let v4 = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::div(arg4, v3);
        let v5 = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::floor_to_u64(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::mul(v4, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::from_u64(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::math::pow_u64(10, (arg5 as u64)))));
        if (0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_positive(&v4) && v5 == 0) {
            abort 13835622937970999299
        };
        (v0, v1, v3, v5)
    }
    ...
    fun remove_version_internal(arg0: &mut DailyStreakRegistry, arg1: u64) {
        assert!(0x2::vec_set::contains<u64>(&arg0.version_set, &arg1), 13838999976268005401);
    ...
    public fun repair_daily_streak<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: &mut 0x2::coin::Coin<T0>, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::get_dollar_coin_type(arg0) == v2, 13837033731649044491);
    ...
    fun repair_daily_streak_internal(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, u64, u64, u64, bool, u64, u64, u64, u64, u64, u64, u64) {
        ...
        if (v8 == 0) {
            abort 13836188984596103175
        };
        if (v7 + v1.max_delay_to_repair_streak_ms < v0) {
            abort 13836470463867912201
        };
        if (v7 > v0) {
            abort 13837314893093273613
        };
