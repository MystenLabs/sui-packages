module 0x1025cff14b2ac3bfa92f4b1ccb6c6d6e30203453a106fff94c76eeab623378c8::meu_nft {
    ...
    entry fun create_display(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::display::Display<NFT>>(0x2::display::new_with_fields<NFT>(arg0, v0, v2, arg1), 0x2::tx_context::sender(arg1));
    }
