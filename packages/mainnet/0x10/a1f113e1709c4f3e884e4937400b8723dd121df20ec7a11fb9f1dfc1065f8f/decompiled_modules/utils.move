module 0x10a1f113e1709c4f3e884e4937400b8723dd121df20ec7a11fb9f1dfc1065f8f::utils {
    ...
    fun compare_struct<T0, T1>() : u8 {
        ...
        let v2 = 0x10a1f113e1709c4f3e884e4937400b8723dd121df20ec7a11fb9f1dfc1065f8f::comparator::compare_u8_vector(v0, v1);
        if (0x10a1f113e1709c4f3e884e4937400b8723dd121df20ec7a11fb9f1dfc1065f8f::comparator::is_greater_than(&v2)) {
            2
        } else {
            let v4 = 0x10a1f113e1709c4f3e884e4937400b8723dd121df20ec7a11fb9f1dfc1065f8f::comparator::compare_u8_vector(v0, v1);
            if (0x10a1f113e1709c4f3e884e4937400b8723dd121df20ec7a11fb9f1dfc1065f8f::comparator::is_equal(&v4)) {
                0
            } else {
                1
            }
    ...
    public fun quote_liquidity(arg0: u64, arg1: u64, arg2: u64) : u64 {
        0x10a1f113e1709c4f3e884e4937400b8723dd121df20ec7a11fb9f1dfc1065f8f::math::mul_div(arg0, arg2, arg1)
    }
