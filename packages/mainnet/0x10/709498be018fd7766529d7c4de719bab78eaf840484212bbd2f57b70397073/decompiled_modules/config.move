module 0x6694aad3ac83111da7d9d249560ad655f36c525e595bb7104e74832643dab91b::config {
    ...
    struct AmbassadorConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x6694aad3ac83111da7d9d249560ad655f36c525e595bb7104e74832643dab91b::acl::ACL,
    ...
    public fun add_role(arg0: &AdminCap, arg1: &mut AmbassadorConfig, arg2: address, arg3: u8) {
        0x6694aad3ac83111da7d9d249560ad655f36c525e595bb7104e74832643dab91b::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut AmbassadorConfig, arg2: address, arg3: u8) {
        0x6694aad3ac83111da7d9d249560ad655f36c525e595bb7104e74832643dab91b::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public(friend) fun check_staff(arg0: &AmbassadorConfig, arg1: address) {
        assert!(0x6694aad3ac83111da7d9d249560ad655f36c525e595bb7104e74832643dab91b::acl::has_role(&arg0.acl, arg1, 0), 0);
    }
    ...
    public(friend) fun get_ambassador_pause(arg0: &AmbassadorConfig, arg1: 0x2::object::ID) : bool {
        !0x2::table::contains<0x2::object::ID, bool>(&arg0.pause_table, arg1) || *0x2::table::borrow<0x2::object::ID, bool>(&arg0.pause_table, arg1)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = AmbassadorConfig{
            ...
            acl                     : 0x6694aad3ac83111da7d9d249560ad655f36c525e595bb7104e74832643dab91b::acl::new(arg0),
    ...
    public(friend) fun set_ambassador_pause(arg0: &mut AmbassadorConfig, arg1: 0x2::object::ID, arg2: bool, arg3: &0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<0x2::object::ID, bool>(&arg0.pause_table, arg1)) {
            0x2::table::remove<0x2::object::ID, bool>(&mut arg0.pause_table, arg1);
        };
    ...
    public(friend) fun set_ambassador_requested_time(arg0: &mut AmbassadorConfig, arg1: 0x2::object::ID, arg2: u64) {
        if (0x2::table::contains<0x2::object::ID, u64>(&arg0.requested_time_table, arg1)) {
            0x2::table::remove<0x2::object::ID, u64>(&mut arg0.requested_time_table, arg1);
        };
