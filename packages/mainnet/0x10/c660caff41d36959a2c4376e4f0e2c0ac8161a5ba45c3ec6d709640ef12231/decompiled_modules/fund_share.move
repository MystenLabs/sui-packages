module 0x10c660caff41d36959a2c4376e4f0e2c0ac8161a5ba45c3ec6d709640ef12231::fund_share {
    ...
    public fun burn<T0>(arg0: &0x10c660caff41d36959a2c4376e4f0e2c0ac8161a5ba45c3ec6d709640ef12231::config::GlobalConfig, arg1: BurnRequest<T0>, arg2: FundShare) {
    ...
    public(friend) fun create_burn_request<T0>(arg0: &0x10c660caff41d36959a2c4376e4f0e2c0ac8161a5ba45c3ec6d709640ef12231::config::GlobalConfig, arg1: 0x2::object::ID, arg2: u64) : BurnRequest<T0> {
        0x10c660caff41d36959a2c4376e4f0e2c0ac8161a5ba45c3ec6d709640ef12231::config::assert_if_version_not_matched(arg0, 1);
        BurnRequest<T0>{
            fund_id  : arg1,
            end_time : arg2,
    ...
    public(friend) fun create_mint_request<T0>(arg0: &0x10c660caff41d36959a2c4376e4f0e2c0ac8161a5ba45c3ec6d709640ef12231::config::GlobalConfig, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x1::string::String, arg4: u64, arg5: u64) : MintRequest<T0> {
        0x10c660caff41d36959a2c4376e4f0e2c0ac8161a5ba45c3ec6d709640ef12231::config::assert_if_version_not_matched(arg0, 1);
        MintRequest<T0>{
            fund_id       : arg1,
            trader        : arg2,
    ...
    public fun mint<T0>(arg0: &mut 0x10c660caff41d36959a2c4376e4f0e2c0ac8161a5ba45c3ec6d709640ef12231::config::GlobalConfig, arg1: MintRequest<T0>, arg2: &mut 0x2::tx_context::TxContext) : FundShare {
        0x10c660caff41d36959a2c4376e4f0e2c0ac8161a5ba45c3ec6d709640ef12231::config::assert_if_version_not_matched(arg0, 1);
        let MintRequest {
            fund_id       : v0,
            trader        : v1,
