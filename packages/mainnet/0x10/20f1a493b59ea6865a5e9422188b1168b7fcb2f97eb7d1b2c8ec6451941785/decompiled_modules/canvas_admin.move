module 0x1020f1a493b59ea6865a5e9422188b1168b7fcb2f97eb7d1b2c8ec6451941785::canvas_admin {
    struct CanvasAdminCap has store, key {
        id: 0x2::object::UID,
    }

    struct CanvasRules has drop, store {
        base_paint_fee: u64,
    ...
    public fun new_rules(arg0: u64, arg1: u64, arg2: address, arg3: u64) : CanvasRules {
        CanvasRules{
            base_paint_fee                  : arg0,
