module 0x10dbff33383bdb68d0bbf6aadeed5e2d3911c45b03664130ebb16437954a2f40::auction {
    ...
    public fun create<T0: store + key>(arg0: T0, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : DecayListing<T0> {
        create_with_start_time<T0>(arg0, arg1, 0x2::clock::timestamp_ms(arg3), arg2, arg3, arg4)
    }
    ...
    public entry fun create_and_share_with_start_time<T0: store + key>(arg0: T0, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<DecayListing<T0>>(create_with_start_time<T0>(arg0, arg1, arg2, arg3, arg4, arg5));
    }

    public fun create_with_start_time<T0: store + key>(arg0: T0, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : DecayListing<T0> {
        assert!(arg3 >= 3600000 && arg3 <= 2592000000, 0);
        assert!(arg1 >= 100000000000000000, 1);
        let v0 = arg2 + arg3;
        assert!(v0 > 0x2::clock::timestamp_ms(arg4), 8);
        DecayListing<T0>{
    ...
    fun current_price_internal<T0: store + key>(arg0: &DecayListing<T0>, arg1: u64) : u64 {
        (((arg0.start_price_mist as u256) * ratio_pow_ppm(((arg0.end_time_ms - arg1) as u256) * 1000000 / ((arg0.end_time_ms - arg0.start_time_ms) as u256), 69) / 1000000) as u64)
    }
    ...
    fun ratio_pow_ppm(arg0: u256, arg1: u64) : u256 {
        let v0 = 0;
        let v1 = 1000000;
        while (v0 < arg1) {
            let v2 = v1 * arg0;
