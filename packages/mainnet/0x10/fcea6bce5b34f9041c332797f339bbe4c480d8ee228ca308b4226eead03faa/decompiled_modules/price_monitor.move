module 0x82fd97f4ab360844693e9bfe655765a7bd1351f18e2a89b2a1eaf694b4390778::price_monitor {
    ...
    public fun update_pool_price_decimal_multiplier_v2(arg0: &mut PriceMonitor, arg1: 0x2::object::ID, arg2: u8, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<0x2::object::ID, u128>(v0, arg1)) {
            0x2::table::remove<0x2::object::ID, u128>(v0, arg1);
        };
    ...
    public fun validate_price<T0, T1, T2>(arg0: &mut PriceMonitor, arg1: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator, arg2: &0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) : PriceValidationResult {
        ...
        PriceValidationResult{
            ...
            is_valid              : v12.level == 0x82fd97f4ab360844693e9bfe655765a7bd1351f18e2a89b2a1eaf694b4390778::price_monitor_consts::get_anomaly_level_normal(),
            price_q64             : v2,
        }
    }
