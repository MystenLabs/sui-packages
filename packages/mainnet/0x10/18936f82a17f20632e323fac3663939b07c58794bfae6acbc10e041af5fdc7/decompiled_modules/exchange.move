module 0xc23a402549e5a825567c0eb741d2668ef1d499c67edae8ea43db5cf861290b1b::exchange {
    ...
    public(friend) fun settle_position<T0>(arg0: &AdminCap, arg1: &mut Exchange<T0>, arg2: address, arg3: u64, arg4: bool, arg5: 0xc23a402549e5a825567c0eb741d2668ef1d499c67edae8ea43db5cf861290b1b::oracle::Price, arg6: CollateralPrice, arg7: u64) : 0x2::balance::Balance<T0> {
        assert_admin<T0>(arg0, arg1);
        assert_version<T0>(arg1);
        assert!(arg1.paused, 40);
        assert!(arg3 < 0x1::vector::length<Market>(&arg1.markets), 28);
        check_close_price<T0>(arg1, &arg5, 0, arg7, false);
        let v0 = PositionKey{
            owner     : arg2,
            market_id : arg3,
            is_long   : arg4,
        };
        assert!(0x2::table::contains<PositionKey, Position<T0>>(&arg1.positions, v0), 8);
        let v1 = 0x2::table::borrow<PositionKey, Position<T0>>(&arg1.positions, v0).size_usd;
        decrease<T0>(arg1, v0, v1, execution_price(&arg5, arg4, false), arg6, arg7, 18446744073709551615)
    }
