module 0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::config {
    ...
    public fun cancel_funding(arg0: &mut Config, arg1: &AdminCap) {
        authorize(arg0, arg1);
        0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::funding_rules::cancel(&mut arg0.id);
    }

    public fun cancel_hibernation(arg0: &mut Config, arg1: &AdminCap) {
        authorize(arg0, arg1);
        0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::hibernation_rules::cancel(&mut arg0.id);
    }
    ...
    public fun execute_funding(arg0: &mut Config, arg1: &0x2::clock::Clock) {
        0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::funding_rules::execute(&mut arg0.id, arg1);
    }

    public fun execute_hibernation(arg0: &mut Config, arg1: &0x2::clock::Clock) {
        0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::hibernation_rules::execute(&mut arg0.id, arg1);
    }
    ...
    public fun funding(arg0: &Config) : 0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::funding_rules::Rules {
        0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::funding_rules::get(&arg0.id)
    }

    public fun funding_proposal(arg0: &Config) : (bool, 0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::funding_rules::Rules, u64) {
        0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::funding_rules::pending(&arg0.id)
    }

    public fun hibernation(arg0: &Config) : 0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::hibernation_rules::Rules {
        0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::hibernation_rules::get(&arg0.id)
    }

    public fun hibernation_proposal(arg0: &Config) : (bool, 0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::hibernation_rules::Rules, u64) {
        0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::hibernation_rules::pending(&arg0.id)
    }
    ...
    public fun propose_funding(arg0: &mut Config, arg1: &AdminCap, arg2: 0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::funding_rules::Rules, arg3: &0x2::clock::Clock) {
        authorize(arg0, arg1);
        0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::funding_rules::propose(&mut arg0.id, arg2, arg0.params.timelock_ms, arg3);
    }

    public fun propose_hibernation(arg0: &mut Config, arg1: &AdminCap, arg2: 0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::hibernation_rules::Rules, arg3: &0x2::clock::Clock) {
        authorize(arg0, arg1);
        0x10e6186356a5588e8a06e368809b0d08bfeaa4d067c252082c9d7785c911295d::hibernation_rules::propose(&mut arg0.id, arg2, arg0.params.timelock_ms, arg3);
    }
    ...
    public fun validate(arg0: &Params) {
        ...
        let v1 = if (arg0.max_trade_bps > 0) {
            if (arg0.max_trade_bps <= 1000) {
