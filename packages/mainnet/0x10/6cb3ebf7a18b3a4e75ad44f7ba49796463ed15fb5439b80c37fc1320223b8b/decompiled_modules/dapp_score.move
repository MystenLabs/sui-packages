module 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::dapp_score {
    ...
    struct AddUpdatorEvent has copy, drop {
        object_id: 0x2::object::ID,
        updator: address,
        by: address,
    }

    struct RemoveUpdatorEvent has copy, drop {
        object_id: 0x2::object::ID,
        updator: address,
        by: address,
    }
    ...
    struct UpdateDappDescriptionEvent has copy, drop {
        dapp: 0x1::string::String,
        description: 0x1::string::String,
        by: address,
    }
    ...
    struct EditTargetDescriptionEvent has copy, drop {
        dapp: 0x1::string::String,
        target: 0x1::string::String,
        description: 0x1::string::String,
        by: address,
    ...
    struct DappScoreManager has store, key {
        ...
        updator_configs: vector<0x2::object::ID>,
    ...
    public fun add_dapp_admin(arg0: &mut DappScoreManager, arg1: &mut DappConfig, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x1::vector::contains<address>(&arg1.admins, &arg2), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::duplicated_error());
    ...
    fun add_referral_score(arg0: &mut UserDappScore, arg1: 0x1::string::String) {
        internal_update_user_dapp_score_object(arg0, arg1, 0x1::string::utf8(b"referral"), 1, false, false, false);
    }
    ...
    public fun add_super_admin(arg0: &mut DappScoreManager, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x1::vector::contains<address>(&arg0.admins, &arg1), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::duplicated_error());
    ...
    public fun add_updator(arg0: &mut DappScoreManager, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        check_dapp_score_manager_version(arg0);
        assert_is_super_admin(arg0, 0x2::tx_context::sender(arg2));
        let v0 = UpdatorConfig{
            id      : 0x2::object::new(arg2),
            updator : arg1,
            valid   : true,
        };
        0x1::vector::push_back<0x2::object::ID>(&mut arg0.updator_configs, 0x2::object::id<UpdatorConfig>(&v0));
        let v1 = AddUpdatorEvent{
            object_id : 0x2::object::id<UpdatorConfig>(&v0),
            updator   : arg1,
            by        : 0x2::tx_context::sender(arg2),
        };
        0x2::event::emit<AddUpdatorEvent>(v1);
        0x2::transfer::public_share_object<UpdatorConfig>(v0);
    }

    public fun assert_is_dapp_admin(arg0: &DappConfig, arg1: address) {
        assert!(is_dapp_admin(arg0, arg1), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_authorized_error());
    }

    public fun assert_is_super_admin(arg0: &DappScoreManager, arg1: address) {
        assert!(is_super_admin(arg0, &arg1), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_authorized_error());
    }

    public fun assert_target_exist(arg0: &DappConfig, arg1: 0x1::string::String) {
        assert!(target_exist(arg0, arg1), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::target_not_exist_error());
    }

    public fun assert_target_not_exist(arg0: &DappConfig, arg1: 0x1::string::String) {
        assert!(!target_exist(arg0, arg1), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::duplicated_error());
    }

    public fun assert_user_dapp_score_object_exist(arg0: &DappScoreManager, arg1: address, arg2: 0x1::string::String) {
        assert!(is_user_dapp_score_object_exist(arg0, arg1, arg2), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_exist_error());
    }

    public fun assert_user_dapp_score_object_not_exist(arg0: &DappScoreManager, arg1: address, arg2: 0x1::string::String) {
        assert!(!is_user_dapp_score_object_exist(arg0, arg1, arg2), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::has_exist_error());
    }

    public fun assert_valid_updator(arg0: &UpdatorConfig, arg1: address) {
        assert!(arg0.valid, 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::updator_expired_error());
        assert!(is_updator(arg0, arg1), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_authorized_error());
    }

    fun assert_weight_is_not_immutable(arg0: &DappConfig, arg1: 0x1::string::String) {
        assert!(!weight_is_immutable(arg0, arg1), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_authorized_error());
    }
    ...
    public fun change_updator(arg0: &DappScoreManager, arg1: &mut UpdatorConfig, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        check_dapp_score_manager_version(arg0);
        assert_is_super_admin(arg0, 0x2::tx_context::sender(arg3));
        arg1.updator = arg2;
        let v0 = RemoveUpdatorEvent{
            object_id : 0x2::object::id<UpdatorConfig>(arg1),
            updator   : arg1.updator,
            by        : 0x2::tx_context::sender(arg3),
        };
        0x2::event::emit<RemoveUpdatorEvent>(v0);
        let v1 = AddUpdatorEvent{
            object_id : 0x2::object::id<UpdatorConfig>(arg1),
            updator   : arg2,
            by        : 0x2::tx_context::sender(arg3),
    ...
    fun check_dapp_score_manager_version(arg0: &DappScoreManager) {
        assert!(arg0.version == 1, 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::wrong_version_error());
    }
    ...
    public fun create_dapp_score_update_request(arg0: &UpdatorConfig, arg1: 0x1::string::String, arg2: 0x1::option::Option<address>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.valid, 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::updator_expired_error());
        let v0 = 0x2::tx_context::sender(arg4);
        internal_create_dapp_score_update_request(arg0, v0, arg1, arg2, arg3, arg4);
    }

    public fun create_dapp_score_update_request_for_user_by_admin(arg0: &DappConfig, arg1: &UpdatorConfig, arg2: address, arg3: 0x1::option::Option<address>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_user_dapp_score_object_by_updator(arg0: &UpdatorConfig, arg1: &mut DappScoreManager, arg2: &DappScoreUpadteRequest, arg3: &mut 0x2::tx_context::TxContext) : UserDappScore {
        assert_valid_updator(arg0, 0x2::tx_context::sender(arg3));
        assert!(arg2.referrer == 0x1::option::none<address>(), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_authorized_error());
    ...
    public fun create_user_dapp_score_object_with_referrer_by_admin_cap(arg0: &DappAdminCap, arg1: &mut DappScoreManager, arg2: address, arg3: &mut UserDappScore, arg4: &mut 0x2::tx_context::TxContext) : UserDappScore {
        add_referral_score(arg3, arg0.dapp);
        internal_create_user_dapp_score_object(arg1, arg2, arg0.dapp, 0x1::option::some<address>(arg3.user), arg4)
    }

    public fun create_user_dapp_score_object_with_referrer_by_updator(arg0: &UpdatorConfig, arg1: &mut DappScoreManager, arg2: &DappScoreUpadteRequest, arg3: &mut UserDappScore, arg4: &mut 0x2::tx_context::TxContext) : UserDappScore {
        assert_valid_updator(arg0, 0x2::tx_context::sender(arg4));
        assert!(arg2.referrer == 0x1::option::some<address>(arg3.user), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_authorized_error());
        add_referral_score(arg3, arg2.dapp);
    ...
    public fun delete_dapp_score_update_request_by_updator(arg0: &UpdatorConfig, arg1: DappScoreUpadteRequest, arg2: &mut 0x2::tx_context::TxContext) {
        assert_valid_updator(arg0, 0x2::tx_context::sender(arg2));
        ...
        let v5 = UpdateRequestDeletedEvent{
            ...
            user                                : v1,
            dapp                                : v3,
            updator                             : arg0.updator,
        };
        0x2::event::emit<UpdateRequestDeletedEvent>(v5);
        0x2::object::delete(v0);
    }

    public fun edit_dapp_score_target_description(arg0: &mut DappConfig, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        assert_is_dapp_admin(arg0, 0x2::tx_context::sender(arg3));
        assert_target_exist(arg0, arg1);
        0x2::table::borrow_mut<0x1::string::String, TargetConfig>(&mut arg0.targets_config, arg1).description = arg2;
        let v0 = EditTargetDescriptionEvent{
            dapp        : arg0.dapp,
            target      : arg1,
            description : arg2,
            by          : 0x2::tx_context::sender(arg3),
        };
        0x2::event::emit<EditTargetDescriptionEvent>(v0);
    }
    ...
    public fun get_dapp_description(arg0: &DappConfig) : 0x1::string::String {
        arg0.description
    }
    ...
    public fun increase_user_dapp_score_by_updator(arg0: &UpdatorConfig, arg1: &mut UserDappScore, arg2: &DappScoreUpadteRequest, arg3: 0x1::string::String, arg4: u256, arg5: &mut 0x2::tx_context::TxContext) {
        assert_valid_updator(arg0, 0x2::tx_context::sender(arg5));
        assert!(arg1.user == arg2.user, 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_authorized_error());
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = DappScoreManager{
            ...
            updator_configs            : 0x1::vector::empty<0x2::object::ID>(),
    ...
    fun internal_add_admin_dapp_map(arg0: &mut DappScoreManager, arg1: address, arg2: 0x1::string::String) {
        if (0x2::table::contains<address, AdminDappMapWrapper>(&arg0.admin_dapp_map, arg1)) {
            ...
            assert!(!0x1::vector::contains<0x1::string::String>(&v0.dapps, &arg2), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::duplicated_error());
    ...
    fun internal_create_dapp_config(arg0: &mut DappScoreManager, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) : DappConfig {
        ...
        let v2 = &mut v1;
        internal_init_dapp_referrel_target(v2);
        let v3 = &mut v1;
        internal_init_dapp_pure_increase_target(v3);
        let v4 = &mut v1;
        internal_init_dapp_pure_decrease_target(v4);
        assert!(!0x2::table::contains<0x1::string::String, 0x2::object::ID>(&arg0.dapp_config_map, arg1), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::duplicated_error());
    ...
    fun internal_create_dapp_score_update_request(arg0: &UpdatorConfig, arg1: address, arg2: 0x1::string::String, arg3: 0x1::option::Option<address>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    fun internal_create_user_dapp_score_object(arg0: &mut DappScoreManager, arg1: address, arg2: 0x1::string::String, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) : UserDappScore {
        check_dapp_score_manager_version(arg0);
        assert!(!is_user_dapp_score_object_exist(arg0, arg1, arg2), 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::duplicated_user_dapp_score_object_error());
    ...
    fun internal_init_dapp_pure_decrease_target(arg0: &mut DappConfig) {
        let v0 = 0x1::string::utf8(b"pure_decrease");
        let v1 = TargetConfig{
            weight              : 1,
            weight_is_negative  : true,
            weight_is_immutable : true,
            description         : 0x1::string::utf8(b""),
        };
        0x2::table::add<0x1::string::String, TargetConfig>(&mut arg0.targets_config, v0, v1);
        0x2::table_vec::push_back<0x1::string::String>(&mut arg0.targets, v0);
    }

    fun internal_init_dapp_pure_increase_target(arg0: &mut DappConfig) {
        let v0 = 0x1::string::utf8(b"pure_increase");
        let v1 = TargetConfig{
            weight              : 1,
            weight_is_negative  : false,
            weight_is_immutable : true,
            description         : 0x1::string::utf8(b""),
        };
        0x2::table::add<0x1::string::String, TargetConfig>(&mut arg0.targets_config, v0, v1);
    ...
    fun internal_init_dapp_referrel_target(arg0: &mut DappConfig) {
        let v0 = 0x1::string::utf8(b"referral");
        let v1 = TargetConfig{
            weight              : 0,
            weight_is_negative  : false,
            weight_is_immutable : false,
            description         : 0x1::string::utf8(b""),
        };
        0x2::table::add<0x1::string::String, TargetConfig>(&mut arg0.targets_config, v0, v1);
        0x2::table_vec::push_back<0x1::string::String>(&mut arg0.targets, v0);
    ...
    fun internal_remove_admin_dapp_map(arg0: &mut DappScoreManager, arg1: address, arg2: 0x1::string::String) {
        ...
        assert!(v1, 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_exist_error());
    ...
    fun internal_update_user_dapp_score_object(arg0: &mut UserDappScore, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u256, arg4: bool, arg5: bool, arg6: bool) {
        assert!(arg0.dapp == arg1, 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_authorized_error());
        if (!0x2::table::contains<0x1::string::String, ScoreTableItem>(&arg0.score_table, arg2)) {
            assert!(!arg4, 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::target_not_exist_error());
            let v0 = ScoreTableItem{score: arg3};
            0x2::table::add<0x1::string::String, ScoreTableItem>(&mut arg0.score_table, arg2, v0);
        } else {
            let v1 = 0x2::table::borrow_mut<0x1::string::String, ScoreTableItem>(&mut arg0.score_table, arg2);
            if (arg4) {
                assert!(v1.score >= arg3, 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::score_under_zero_error());
                v1.score = v1.score - arg3;
            } else {
                v1.score = v1.score + arg3;
            };
        };
        let v2 = UpdateDappScoreObjectEvent{
            user            : arg0.user,
            dapp            : arg0.dapp,
            target          : arg2,
            score_change    : arg3,
        ...
        0x2::event::emit<UpdateDappScoreObjectEvent>(v2);
    }
    ...
    public fun is_updator(arg0: &UpdatorConfig, arg1: address) : bool {
        arg0.updator == arg1
    }
    ...
    public fun new_user_dapp_score_object_by_admin(arg0: &mut DappScoreManager, arg1: &DappConfig, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : UserDappScore {
        assert_is_dapp_admin(arg1, 0x2::tx_context::sender(arg3));
    ...
    public fun remove_dapp_admin(arg0: &mut DappScoreManager, arg1: &mut DappConfig, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert_is_dapp_admin(arg1, 0x2::tx_context::sender(arg3));
        assert!(0x1::vector::length<address>(&arg1.admins) > 1 && v0, 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_authorized_error());
    ...
    public fun remove_super_admin(arg0: &mut DappScoreManager, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 && 0x1::vector::length<address>(&arg0.admins) > 1, 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_authorized_error());
    ...
    public fun remove_updator(arg0: &mut DappScoreManager, arg1: &mut UpdatorConfig, arg2: &mut 0x2::tx_context::TxContext) {
        check_dapp_score_manager_version(arg0);
        assert_is_super_admin(arg0, 0x2::tx_context::sender(arg2));
        let v0 = 0x2::object::id<UpdatorConfig>(arg1);
        let (v1, v2) = 0x1::vector::index_of<0x2::object::ID>(&arg0.updator_configs, &v0);
        assert!(v1, 0x106cb3ebf7a18b3a4e75ad44f7ba49796463ed15fb5439b80c37fc1320223b8b::error::not_exist_error());
        0x1::vector::swap_remove<0x2::object::ID>(&mut arg0.updator_configs, v2);
        arg1.valid = false;
        let v3 = RemoveUpdatorEvent{
            object_id : 0x2::object::id<UpdatorConfig>(arg1),
            updator   : arg1.updator,
            by        : 0x2::tx_context::sender(arg2),
        };
        0x2::event::emit<RemoveUpdatorEvent>(v3);
    }

    public fun reset_user_dapp_score_object_by_admin(arg0: &DappConfig, arg1: &mut UserDappScore, arg2: 0x1::string::String, arg3: u256, arg4: &mut 0x2::tx_context::TxContext) {
        assert_is_dapp_admin(arg0, 0x2::tx_context::sender(arg4));
        assert_target_exist(arg0, arg2);
        let v0 = 0x2::table::borrow_mut<0x1::string::String, ScoreTableItem>(&mut arg1.score_table, arg2);
        let v1 = v0.score > arg3;
        let v2 = if (v1) {
            v0.score - arg3
        } else {
            arg3 - v0.score
        };
        internal_update_user_dapp_score_object(arg1, arg0.dapp, arg2, v2, v1, true, false);
    }
    ...
    public fun update_dapp_description(arg0: &mut DappConfig, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        assert_is_dapp_admin(arg0, 0x2::tx_context::sender(arg2));
        arg0.description = arg1;
        let v0 = UpdateDappDescriptionEvent{
            dapp        : arg0.dapp,
            description : arg1,
            by          : 0x2::tx_context::sender(arg2),
        };
        0x2::event::emit<UpdateDappDescriptionEvent>(v0);
    }
    ...
    public fun update_user_dapp_score_object_by_admin(arg0: &DappConfig, arg1: &mut UserDappScore, arg2: 0x1::string::String, arg3: u256, arg4: bool, arg5: &mut 0x2::tx_context::TxContext) {
        assert_is_dapp_admin(arg0, 0x2::tx_context::sender(arg5));
        assert_target_exist(arg0, arg2);
        internal_update_user_dapp_score_object(arg1, arg0.dapp, arg2, arg3, arg4, true, false);
    }
