module 0x10652cda202512209b01de6dea807e12c5bee9b61cd88a53180e99191a6a11da::coin_locker {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = CoinLocker{
            ...
            next_lock_id  : 1,
            admin         : @0x962b4a5212727aaf9ad796ad7cd0d606809418f6a74fca2f1ea2e4e3e46f6d3e,
            pending_admin : 0x1::option::none<address>(),
            fee_receiver  : @0x962b4a5212727aaf9ad796ad7cd0d606809418f6a74fca2f1ea2e4e3e46f6d3e,
            vaults        : v0,
        ...
        let v2 = &mut v1.fees;
        add_or_update_fee_internal(v2, 0x1::ascii::string(b"DEFAULT"), 15000000, 0x1::type_name::into_string(0x1::type_name::get<0x2::sui::SUI>()));
