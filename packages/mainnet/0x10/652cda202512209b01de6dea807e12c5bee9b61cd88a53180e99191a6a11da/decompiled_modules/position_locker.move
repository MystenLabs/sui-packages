module 0x10652cda202512209b01de6dea807e12c5bee9b61cd88a53180e99191a6a11da::position_locker {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::type_name::into_string(0x1::type_name::get<0x2::sui::SUI>());
        let v2 = &mut v0.fees;
        add_or_update_fee_internal(v2, 0x1::ascii::string(b"DEFAULT"), 40, 160, 0, v1);
        let v3 = &mut v0.fees;
        add_or_update_fee_internal(v3, 0x1::ascii::string(b"LVP"), 64, 80, 0, v1);
        let v4 = &mut v0.fees;
        add_or_update_fee_internal(v4, 0x1::ascii::string(b"LLP"), 24, 280, 0, v1);
