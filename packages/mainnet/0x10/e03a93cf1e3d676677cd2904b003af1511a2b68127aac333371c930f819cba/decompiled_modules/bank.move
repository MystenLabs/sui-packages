module 0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::bank {
    ...
    public(friend) fun assert_btoken_type<T0, T1>() {
        ...
        0x1::string::append(&mut v0, 0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::utils::get_type_reflection<T0>());
        assert!(0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::utils::get_type_reflection<T1>() == v0, 0);
    }
    ...
    public fun burn_btokens<T0, T1, T2>(arg0: &mut Bank<T0, T1, T2>, arg1: &mut 0x1f54a9a2d71799553197e9ea24557797c6398d6a65f2d4d3818c9304b75d5e21::lending_market::LendingMarket<T0>, arg2: &mut 0x2::coin::Coin<T2>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::events::emit_event<BurnBTokenEvent>(v4);
    ...
    public fun create_bank<T0, T1, T2: drop>(arg0: &mut 0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::registry::Registry, arg1: &0x2::coin::CoinMetadata<T1>, arg2: &mut 0x2::coin::CoinMetadata<T2>, arg3: 0x2::coin::TreasuryCap<T2>, arg4: &0x1f54a9a2d71799553197e9ea24557797c6398d6a65f2d4d3818c9304b75d5e21::lending_market::LendingMarket<T0>, arg5: &mut 0x2::tx_context::TxContext) : Bank<T0, T1, T2> {
        ...
        0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::registry::register_bank(arg0, v1.bank_id, v1.coin_type, v1.btoken_type, v1.lending_market_id, v1.lending_market_type);
        0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::events::emit_event<NewBankEvent>(v1);
        v0
    }

    public entry fun create_bank_and_share<T0, T1, T2: drop>(arg0: &mut 0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::registry::Registry, arg1: &0x2::coin::CoinMetadata<T1>, arg2: &mut 0x2::coin::CoinMetadata<T2>, arg3: 0x2::coin::TreasuryCap<T2>, arg4: &0x1f54a9a2d71799553197e9ea24557797c6398d6a65f2d4d3818c9304b75d5e21::lending_market::LendingMarket<T0>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
    ...
    fun deploy<T0, T1, T2>(arg0: &mut Bank<T0, T1, T2>, arg1: &mut 0x1f54a9a2d71799553197e9ea24557797c6398d6a65f2d4d3818c9304b75d5e21::lending_market::LendingMarket<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::events::emit_event<DeployEvent>(v4);
    }
    ...
    public(friend) fun effective_utilisation_bps<T0, T1, T2>(arg0: &Bank<T0, T1, T2>, arg1: &0x1f54a9a2d71799553197e9ea24557797c6398d6a65f2d4d3818c9304b75d5e21::lending_market::LendingMarket<T0>, arg2: &0x2::clock::Clock) : u64 {
        0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::bank_math::compute_utilisation_bps(0x2::balance::value<T1>(&arg0.funds_available), 0x1f54a9a2d71799553197e9ea24557797c6398d6a65f2d4d3818c9304b75d5e21::decimal::floor(funds_deployed<T0, T1, T2>(arg0, arg1, arg2)))
    }
    ...
    public fun init_lending<T0, T1, T2>(arg0: &mut Bank<T0, T1, T2>, arg1: &0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::global_admin::GlobalAdmin, arg2: &mut 0x1f54a9a2d71799553197e9ea24557797c6398d6a65f2d4d3818c9304b75d5e21::lending_market::LendingMarket<T0>, arg3: u16, arg4: u16, arg5: &mut 0x2::tx_context::TxContext) {
        0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::version::assert_version_and_upgrade(&mut arg0.version, 1);
    ...
    entry fun migrate<T0, T1, T2>(arg0: &mut Bank<T0, T1, T2>, arg1: &0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::global_admin::GlobalAdmin) {
    ...
    public fun mint_btokens<T0, T1, T2>(arg0: &mut Bank<T0, T1, T2>, arg1: &mut 0x1f54a9a2d71799553197e9ea24557797c6398d6a65f2d4d3818c9304b75d5e21::lending_market::LendingMarket<T0>, arg2: &mut 0x2::coin::Coin<T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::events::emit_event<MintBTokenEvent>(v1);
    ...
    public fun rebalance<T0, T1, T2>(arg0: &mut Bank<T0, T1, T2>, arg1: &mut 0x1f54a9a2d71799553197e9ea24557797c6398d6a65f2d4d3818c9304b75d5e21::lending_market::LendingMarket<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::bank_math::compute_utilisation_bps(0x2::balance::value<T1>(&arg0.funds_available), v0);
        let v2 = target_utilisation_bps_unchecked<T0, T1, T2>(arg0);
        let v3 = utilisation_buffer_bps<T0, T1, T2>(arg0);
        if (v1 < v2 - v3) {
            let v4 = 0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::bank_math::compute_amount_to_deploy(0x2::balance::value<T1>(&arg0.funds_available), v0, v2);
            deploy<T0, T1, T2>(arg0, arg1, v4, arg2, arg3);
        } else if (v1 > v2 + v3) {
            let v5 = 0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::bank_math::compute_amount_to_recall(0x2::balance::value<T1>(&arg0.funds_available), 0, v0, v2);
    ...
    fun recall<T0, T1, T2>(arg0: &mut Bank<T0, T1, T2>, arg1: &mut 0x1f54a9a2d71799553197e9ea24557797c6398d6a65f2d4d3818c9304b75d5e21::lending_market::LendingMarket<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::events::emit_event<RecallEvent>(v5);
    }
    ...
    public fun set_utilisation_bps<T0, T1, T2>(arg0: &mut Bank<T0, T1, T2>, arg1: &0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::global_admin::GlobalAdmin, arg2: u16, arg3: u16) {
        0x10e03a93cf1e3d676677cd2904b003af1511a2b68127aac333371c930f819cba::version::assert_version_and_upgrade(&mut arg0.version, 1);
