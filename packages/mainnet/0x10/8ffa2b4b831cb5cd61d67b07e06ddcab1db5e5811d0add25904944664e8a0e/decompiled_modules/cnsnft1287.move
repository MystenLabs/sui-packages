module 0x108ffa2b4b831cb5cd61d67b07e06ddcab1db5e5811d0add25904944664e8a0e::cnsnft1287 {
    struct CNSNFT1287 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1287, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1287>(arg0, arg1);
