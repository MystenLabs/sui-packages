module 0x1036ec4cc59171bee0effb404d6a7b7d8fb16a521f47bbe91fbc80d4278a2536::storage {
    ...
    struct StorageSpace has store, key {
        id: 0x2::object::UID,
        owner: address,
    ...
    public(friend) fun new(arg0: &mut 0x2::object::UID, arg1: address) {
        let v0 = StorageSpace{
        ...
        0x2::transfer::share_object<StorageSpace>(v0);
    }
    ...
    public fun fund_wal_treasury(arg0: &mut StorageTreasury, arg1: &0x1036ec4cc59171bee0effb404d6a7b7d8fb16a521f47bbe91fbc80d4278a2536::config::Config, arg2: 0x2::coin::Coin<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>) {
        0x1036ec4cc59171bee0effb404d6a7b7d8fb16a521f47bbe91fbc80d4278a2536::config::assert_version(arg1);
    ...
    public fun tier_duration(arg0: StorageTier) : u64 {
        (arg0.duration_days as u64) * 0x1036ec4cc59171bee0effb404d6a7b7d8fb16a521f47bbe91fbc80d4278a2536::config::day_in_milliesecond()
    }
