module 0x97a9560a34766d4556f98881672e81f33c1c0c35188728813595cd05fb160a8::stream {
    ...
    public fun cancel_and_withdraw_v2<T0>(arg0: &mut Stream<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::tx_context::sender(arg2) == arg0.sender, 208);
        assert!(!arg0.cancelled, 205);
        settle_due<T0>(arg0, arg1, arg2);
        arg0.cancelled = true;
        let v0 = 0x2::balance::withdraw_all<T0>(&mut arg0.escrow);
        let v1 = StreamCancelled{
            stream_id : 0x2::object::id<Stream<T0>>(arg0),
    ...
    public fun create<T0>(arg0: &mut StreamRegistry, arg1: 0x2::balance::Balance<T0>, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        open_stream<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg8)
    }

    public fun create_v2<T0>(arg0: &mut StreamRegistry, arg1: 0x2::balance::Balance<T0>, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        assert!(!arg0.paused, 203);
        assert!(arg4 > 0, 201);
        assert!(arg4 <= 1000, 212);
        assert!(arg6 > 0, 201);
        assert!(arg5 + arg6 >= 0x2::clock::timestamp_ms(arg7), 211);
        open_stream<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg8)
    }
    ...
    fun open_stream<T0>(arg0: &mut StreamRegistry, arg1: 0x2::balance::Balance<T0>, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        assert!(!arg0.paused, 203);
        assert!(arg2 != @0x0, 213);
    ...
    public fun set_paused(arg0: &mut StreamRegistry, arg1: &StreamAdminCap, arg2: bool) {
        assert!(arg2 != arg0.paused, 214);
        arg0.paused = arg2;
        let v0 = RegistryPauseChanged{paused: arg2};
        0x2::event::emit<RegistryPauseChanged>(v0);
    }

    fun settle_due<T0>(arg0: &mut Stream<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
