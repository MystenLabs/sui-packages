module 0x10a15097bbd42d2b9b45f200c8a07fb4a6c847c036511c5d1b978d98b6f207e7::cnsnft4558 {
    struct CNSNFT4558 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4558, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4558>(arg0, arg1);
