module 0x106ddbb74880c71f2be0f6a7d8e53c889d04e768ed664ccfb8be8ed245c455d5::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"threrealsui", b"The Real Sui", b"cr7 was right all along, SUIIIIII", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-08T18-41-35.594Z-Man-Utd-news-Cristiano-Ronaldo-SIU-celebration-Brighton-goal-3918291.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"The Real Sui"),
            symbol     : 0x1::string::utf8(b"threrealsui"),
            decimals   : 9,
