module 0x8f2534a77f1f0baf8c2bc44cf1cc5ada72ffd6be515f54f8f073dc434e1a3ca2::zk_verifier {
    ...
    public entry fun admin_set_prover_pubkey(arg0: &AdminCap, arg1: &mut ZKVerifierState, arg2: vector<u8>) {
        let v0 = 0x1::vector::length<u8>(&arg2);
        assert!(v0 == 32 || v0 == 0, 1);
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg1.id, b"zkv_prover_pubkey_v1")) {
            0x2::dynamic_field::remove<vector<u8>, vector<u8>>(&mut arg1.id, b"zkv_prover_pubkey_v1");
        };
        if (v0 == 32) {
            0x2::dynamic_field::add<vector<u8>, vector<u8>>(&mut arg1.id, b"zkv_prover_pubkey_v1", arg2);
        };
    }
    ...
    public entry fun execute_commitment(arg0: &VerifierCap, arg1: &ZKVerifierState, arg2: &mut ZKCommitment, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(verify_with_prover(arg1, &arg3, &arg2.commitment_hash), 1);
        arg2.executed = true;
    ...
    public fun has_prover_pubkey(arg0: &ZKVerifierState) : bool {
        0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"zkv_prover_pubkey_v1")
    }
    ...
    public entry fun verify_proof(arg0: &mut ZKVerifierState, arg1: vector<u8>, arg2: vector<u8>, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(verify_with_prover(arg0, &arg1, &arg2), 1);
        let v2 = if (has_prover_pubkey(arg0)) {
            extract_signature(&arg1)
        } else {
        ...
        let v3 = 0x2::hash::keccak256(&arg1);
        let v4 = ProofRecord{
        ...
        0x2::transfer::transfer<ProofRecord>(v4, v0);
    }
    ...
    fun verify_with_prover(arg0: &ZKVerifierState, arg1: &vector<u8>, arg2: &vector<u8>) : bool {
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"zkv_prover_pubkey_v1")) {
            return 0x1::vector::length<u8>(arg1) > 0
        };
        if (0x1::vector::length<u8>(arg1) < 64) {
            return false
        };
        let v0 = extract_signature(arg1);
        0x2::ed25519::ed25519_verify(&v0, 0x2::dynamic_field::borrow<vector<u8>, vector<u8>>(&arg0.id, b"zkv_prover_pubkey_v1"), arg2)
    }
