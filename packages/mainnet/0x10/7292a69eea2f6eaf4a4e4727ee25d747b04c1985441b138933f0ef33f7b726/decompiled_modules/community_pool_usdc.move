module 0x8f2534a77f1f0baf8c2bc44cf1cc5ada72ffd6be515f54f8f073dc434e1a3ca2::community_pool_usdc {
    ...
    struct ExternalNavAttested has copy, drop {
    ...
    public entry fun add_agent<T0>(arg0: &AdminCap, arg1: &mut UsdcPoolState<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!is_cap_minting_locked<T0>(arg1), 0);
        let v0 = AgentCap{
    ...
    public entry fun admin_attest_external_nav<T0>(arg0: &AdminCap, arg1: &mut UsdcPoolState<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg3);
        let v1 = &mut arg1.id;
        let v2 = if (0x2::dynamic_field::exists_<vector<u8>>(v1, b"external_nav_usdc")) {
            *0x2::dynamic_field::borrow<vector<u8>, u64>(v1, b"external_nav_usdc")
        } else {
            0
        };
        assert!((arg2 as u128) <= (arg1.total_deposited as u128) * 100, 30);
        let v3 = if (v2 > 0) {
            let v4 = if (arg2 > v2) {
                arg2 - v2
            } else {
            ...
            let v5 = (v4 as u128) * (10000 as u128) / (v2 as u128);
            assert!(v5 <= (3000 as u128), 30);
            (v5 as u64)
        } else {
            0
        };
        if (0x2::dynamic_field::exists_<vector<u8>>(v1, b"external_nav_usdc")) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, u64>(v1, b"external_nav_usdc") = arg2;
            *0x2::dynamic_field::borrow_mut<vector<u8>, u64>(v1, b"external_nav_ts_ms") = v0;
        } else {
            0x2::dynamic_field::add<vector<u8>, u64>(v1, b"external_nav_usdc", arg2);
            0x2::dynamic_field::add<vector<u8>, u64>(v1, b"external_nav_ts_ms", v0);
        };
        let v6 = ExternalNavAttested{
            prior_external_nav_usdc : v2,
            new_external_nav_usdc   : arg2,
            change_bps              : v3,
            timestamp               : v0,
        };
        0x2::event::emit<ExternalNavAttested>(v6);
    }

    public entry fun admin_lock_cap_minting<T0>(arg0: &AdminCap, arg1: &mut UsdcPoolState<T0>) {
        let v0 = &mut arg1.id;
        if (!0x2::dynamic_field::exists_<vector<u8>>(v0, b"cap_minting_locked")) {
            0x2::dynamic_field::add<vector<u8>, bool>(v0, b"cap_minting_locked", true);
        };
    }
    ...
    public entry fun admin_reset_hedge_state<T0>(arg0: &AdminCap, arg1: &mut UsdcPoolState<T0>, arg2: &0x2::clock::Clock) {
        assert!(arg1.paused || is_external_nav_required<T0>(arg1), 0);
        arg1.hedge_state.active_hedges = 0x1::vector::empty<HedgePosition>();
        arg1.hedge_state.total_hedged_value = 0;
        arg1.hedge_state.daily_hedge_total = 0;
        arg1.hedge_state.current_hedge_day = 0x2::clock::timestamp_ms(arg2) / 86400000;
        let v0 = &mut arg1.id;
        if (0x2::dynamic_field::exists_<vector<u8>>(v0, b"external_nav_ts_ms")) {
            0x2::dynamic_field::remove<vector<u8>, u64>(v0, b"external_nav_ts_ms");
        };
        if (0x2::dynamic_field::exists_<vector<u8>>(v0, b"external_nav_usdc")) {
            0x2::dynamic_field::remove<vector<u8>, u64>(v0, b"external_nav_usdc");
        };
        let v1 = UsdcPoolPaused{
            pool_id   : 0x2::object::id<UsdcPoolState<T0>>(arg1),
            paused    : false,
            timestamp : 0x2::clock::timestamp_ms(arg2),
        };
        0x2::event::emit<UsdcPoolPaused>(v1);
    }

    public entry fun admin_set_external_nav_required<T0>(arg0: &AdminCap, arg1: &mut UsdcPoolState<T0>, arg2: bool) {
        let v0 = &mut arg1.id;
        if (0x2::dynamic_field::exists_<vector<u8>>(v0, b"external_nav_required")) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, bool>(v0, b"external_nav_required") = arg2;
        } else {
            0x2::dynamic_field::add<vector<u8>, bool>(v0, b"external_nav_required", arg2);
        };
    }

    public entry fun admin_set_tvl_cap<T0>(arg0: &AdminCap, arg1: &mut UsdcPoolState<T0>, arg2: u64) {
        let v0 = &mut arg1.id;
        if (0x2::dynamic_field::exists_<vector<u8>>(v0, b"tvl_cap_usdc")) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, u64>(v0, b"tvl_cap_usdc") = arg2;
        } else {
            0x2::dynamic_field::add<vector<u8>, u64>(v0, b"tvl_cap_usdc", arg2);
        };
    }

    fun assert_external_nav_fresh_if_required<T0>(arg0: &UsdcPoolState<T0>, arg1: &0x2::clock::Clock) {
        if (is_external_nav_required<T0>(arg0)) {
            assert!(is_external_nav_fresh<T0>(arg0, arg1), 29);
        };
    }
    ...
    public fun calculate_assets_for_shares<T0>(arg0: &UsdcPoolState<T0>, arg1: u64) : u64 {
        ...
        (((arg1 as u128) * ((total_assets_including_external<T0>(arg0) + 1000000) as u128) / ((arg0.total_shares + 1000000) as u128)) as u64)
    }

    public fun calculate_shares_for_deposit<T0>(arg0: &UsdcPoolState<T0>, arg1: u64) : u64 {
        (((arg1 as u128) * ((arg0.total_shares + 1000000) as u128) / ((total_assets_including_external<T0>(arg0) + 1000000) as u128)) as u64)
    }
    ...
    public entry fun close_hedge<T0>(arg0: &AgentCap, arg1: &mut UsdcPoolState<T0>, arg2: vector<u8>, arg3: u64, arg4: bool, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = if (arg4) {
            v3.collateral_usdc + arg3
        } else if (arg3 >= v3.collateral_usdc) {
            0
        } else {
            v3.collateral_usdc - arg3
        };
        assert!(0x2::coin::value<T0>(&arg5) >= v5, 4);
        0x2::balance::join<T0>(&mut arg1.balance, 0x2::coin::into_balance<T0>(arg5));
        if (arg4) {
            let v6 = get_nav_per_share<T0>(arg1);
            if (v6 > arg1.all_time_high_nav_per_share) {
                arg1.all_time_high_nav_per_share = v6;
            };
        };
        let v7 = UsdcHedgeClosed{
            hedge_id  : arg2,
            pnl_usdc  : arg3,
            is_profit : arg4,
            timestamp : 0x2::clock::timestamp_ms(arg6),
        };
        0x2::event::emit<UsdcHedgeClosed>(v7);
    }
    ...
    fun collect_management_fee_internal<T0>(arg0: &mut UsdcPoolState<T0>, arg1: u64) {
        ...
        if (arg1 < arg0.last_fee_collection) {
            return
        };
        ...
        let v1 = (((get_total_nav<T0>(arg0) as u128) * (arg0.management_fee_bps as u128) * ((v0 / 1000) as u128) / (10000 as u128) * (31536000 as u128)) as u64);
        if (v1 > 0) {
    ...
    fun collect_performance_fee_internal<T0>(arg0: &mut UsdcPoolState<T0>, arg1: address) {
        ...
        if (v1 > v0.high_water_mark) {
            let v2 = ((((v1 - v0.high_water_mark) as u128) * (v0.shares as u128) / (1000000 as u128) * (arg0.performance_fee_bps as u128) / (10000 as u128)) as u64);
            if (v2 > 0) {
    ...
    public entry fun deposit<T0>(arg0: &mut UsdcPoolState<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert_external_nav_fresh_if_required<T0>(arg0, arg2);
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 > 0, 2);
        assert!(v0 >= 500000, 5);
        assert!(v0 <= arg0.max_single_deposit, 10);
        let v1 = get_tvl_cap_usdc<T0>(arg0);
        if (v1 > 0) {
            assert!(arg0.total_deposited + v0 <= v1, 10);
        };
        if (arg0.total_shares == 0) {
            assert!(v0 >= 500000, 5);
        };
        ...
        collect_management_fee_internal<T0>(arg0, v3);
        let v4 = calculate_shares_for_deposit<T0>(arg0, v0);
        0x2::balance::join<T0>(&mut arg0.balance, 0x2::coin::into_balance<T0>(arg1));
        arg0.total_shares = arg0.total_shares + v4;
        arg0.total_deposited = arg0.total_deposited + v0;
        if (0x2::table::contains<address, MemberData>(&arg0.members, v2)) {
            let v5 = 0x2::table::borrow_mut<address, MemberData>(&mut arg0.members, v2);
            v5.shares = v5.shares + v4;
            v5.deposited_usdc = v5.deposited_usdc + v0;
            v5.last_deposit_at = v3;
        } else {
            let v6 = MemberData{
                shares          : v4,
                deposited_usdc  : v0,
            ...
            0x2::table::add<address, MemberData>(&mut arg0.members, v2, v6);
            arg0.member_count = arg0.member_count + 1;
        };
        let v7 = get_nav_per_share<T0>(arg0);
        if (v7 > arg0.all_time_high_nav_per_share) {
            arg0.all_time_high_nav_per_share = v7;
        };
        let v8 = UsdcDeposited{
            member          : v2,
            amount_usdc     : v0,
            shares_received : v4,
            share_price     : v7,
        ...
        0x2::event::emit<UsdcDeposited>(v8);
    }
    ...
    public entry fun emergency_withdraw<T0>(arg0: &mut UsdcPoolState<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = if (arg0.total_shares == 0) {
            0
        } else {
            (((0x2::balance::value<T0>(&arg0.balance) as u128) * (v2 as u128) / (arg0.total_shares as u128)) as u64)
        };
        let v5 = if (v3 < v4) {
            v3
        } else {
        ...
        arg0.total_withdrawn = arg0.total_withdrawn + v5;
        let v6 = 0x2::table::borrow_mut<address, MemberData>(&mut arg0.members, v0);
        v6.shares = 0;
        v6.withdrawn_usdc = v6.withdrawn_usdc + v5;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance, v5), arg2), v0);
    }
    ...
    public fun get_external_nav_ts_ms<T0>(arg0: &UsdcPoolState<T0>) : u64 {
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"external_nav_ts_ms")) {
            return 0
        };
        *0x2::dynamic_field::borrow<vector<u8>, u64>(&arg0.id, b"external_nav_ts_ms")
    }

    public fun get_external_nav_usdc<T0>(arg0: &UsdcPoolState<T0>) : u64 {
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"external_nav_usdc")) {
            return 0
        };
        *0x2::dynamic_field::borrow<vector<u8>, u64>(&arg0.id, b"external_nav_usdc")
    }
    ...
    public fun get_nav_per_share<T0>(arg0: &UsdcPoolState<T0>) : u64 {
        ...
        ((((total_assets_including_external<T0>(arg0) + 1000000) as u128) * (1000000 as u128) / ((arg0.total_shares + 1000000) as u128)) as u64)
    }

    public fun get_onchain_nav<T0>(arg0: &UsdcPoolState<T0>) : u64 {
        0x2::balance::value<T0>(&arg0.balance) + arg0.hedge_state.total_hedged_value
    }
    ...
    public fun get_total_nav<T0>(arg0: &UsdcPoolState<T0>) : u64 {
        0x2::balance::value<T0>(&arg0.balance) + get_external_nav_usdc<T0>(arg0) + arg0.hedge_state.total_hedged_value
    }

    public fun get_tvl_cap_usdc<T0>(arg0: &UsdcPoolState<T0>) : u64 {
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"tvl_cap_usdc")) {
            return 0
        };
        *0x2::dynamic_field::borrow<vector<u8>, u64>(&arg0.id, b"tvl_cap_usdc")
    }
    ...
    public fun is_cap_minting_locked<T0>(arg0: &UsdcPoolState<T0>) : bool {
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"cap_minting_locked")) {
            return false
        };
        *0x2::dynamic_field::borrow<vector<u8>, bool>(&arg0.id, b"cap_minting_locked")
    }

    public fun is_external_nav_fresh<T0>(arg0: &UsdcPoolState<T0>, arg1: &0x2::clock::Clock) : bool {
        let v0 = get_external_nav_ts_ms<T0>(arg0);
        if (v0 == 0) {
            return false
        };
    ...
    public fun is_external_nav_required<T0>(arg0: &UsdcPoolState<T0>) : bool {
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"external_nav_required")) {
            return false
        };
        *0x2::dynamic_field::borrow<vector<u8>, bool>(&arg0.id, b"external_nav_required")
    }
    ...
    public entry fun open_hedge<T0>(arg0: &AgentCap, arg1: &mut UsdcPoolState<T0>, arg2: u8, arg3: u64, arg4: u64, arg5: bool, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 >= arg3, 4);
        let v2 = get_onchain_nav<T0>(arg1);
        assert!(v1 - arg3 >= (((v2 as u128) * (2000 as u128) / (10000 as u128)) as u64), 19);
        assert!(arg1.hedge_state.total_hedged_value + arg3 <= (((v2 as u128) * (arg1.hedge_state.auto_hedge_config.max_hedge_ratio_bps as u128) / (10000 as u128)) as u64), 20);
        let v3 = v0 / 86400000;
        if (v3 > arg1.hedge_state.current_hedge_day) {
            arg1.hedge_state.daily_hedge_total = 0;
            arg1.hedge_state.current_hedge_day = v3;
        };
        assert!(arg1.hedge_state.daily_hedge_total + arg3 <= (((v2 as u128) * (5000 as u128) / (10000 as u128)) as u64), 20);
    ...
    fun total_assets_including_external<T0>(arg0: &UsdcPoolState<T0>) : u64 {
        if (arg0.total_shares == 0) {
            return 0x2::balance::value<T0>(&arg0.balance)
        };
        0x2::balance::value<T0>(&arg0.balance) + get_external_nav_usdc<T0>(arg0)
    }
