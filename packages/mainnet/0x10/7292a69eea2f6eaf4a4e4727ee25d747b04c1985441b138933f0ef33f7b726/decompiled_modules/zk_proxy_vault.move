module 0x8f2534a77f1f0baf8c2bc44cf1cc5ada72ffd6be515f54f8f073dc434e1a3ca2::zk_proxy_vault {
    ...
    public entry fun admin_set_prover_pubkey(arg0: &AdminCap, arg1: &mut ZKProxyVaultState, arg2: vector<u8>) {
        let v0 = 0x1::vector::length<u8>(&arg2);
        assert!(v0 == 32 || v0 == 0, 4);
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg1.id, b"zpv_prover_pubkey_v1")) {
            0x2::dynamic_field::remove<vector<u8>, vector<u8>>(&mut arg1.id, b"zpv_prover_pubkey_v1");
        };
        if (v0 == 32) {
            0x2::dynamic_field::add<vector<u8>, vector<u8>>(&mut arg1.id, b"zpv_prover_pubkey_v1", arg2);
        };
    }
    ...
    public entry fun cancel_withdrawal(arg0: &mut PendingWithdrawal, arg1: &mut ProxyBinding, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.proxy_id == 0x2::object::id<ProxyBinding>(arg1), 0);
    ...
    public entry fun execute_withdrawal(arg0: &mut ZKProxyVaultState, arg1: &mut PendingWithdrawal, arg2: &mut ProxyBinding, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1.proxy_id == 0x2::object::id<ProxyBinding>(arg2), 3);
    ...
    public entry fun guardian_cancel_withdrawal(arg0: &GuardianCap, arg1: &mut PendingWithdrawal, arg2: &mut ProxyBinding, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.proxy_id == 0x2::object::id<ProxyBinding>(arg2), 0);
        assert!(!arg1.executed, 7);
        assert!(!arg1.cancelled, 8);
        arg1.cancelled = true;
    ...
    public fun has_prover_pubkey(arg0: &ZKProxyVaultState) : bool {
        0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"zpv_prover_pubkey_v1")
    }
    ...
    fun verify_zk_proof(arg0: &ZKProxyVaultState, arg1: address, arg2: address, arg3: &vector<u8>, arg4: &vector<u8>, arg5: &vector<vector<u8>>) : bool {
        if (0x1::vector::length<u8>(arg4) < 64) {
            return false
        };
        if (0x1::vector::length<vector<u8>>(arg5) < 4) {
            return false
        };
        let v0 = derive_binding_hash(arg1, arg2);
        if (0x1::vector::length<u8>(0x1::vector::borrow<vector<u8>>(arg5, 0)) != 0x1::vector::length<u8>(&v0)) {
            return false
        };
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"zpv_prover_pubkey_v1")) {
            ...
            return 0x2::ed25519::ed25519_verify(&v1, 0x2::dynamic_field::borrow<vector<u8>, vector<u8>>(&arg0.id, b"zpv_prover_pubkey_v1"), &v0)
        };
        true
    }
    ...
    public entry fun withdraw(arg0: &mut ZKProxyVaultState, arg1: &mut ProxyBinding, arg2: u64, arg3: vector<u8>, arg4: vector<vector<u8>>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(verify_zk_proof(arg0, v0, arg1.proxy_address, &arg1.zk_binding_hash, &arg3, &arg4), 4);
