module 0x8f2534a77f1f0baf8c2bc44cf1cc5ada72ffd6be515f54f8f073dc434e1a3ca2::zk_hedge_commitment {
    ...
    public entry fun admin_set_prover_pubkey(arg0: &AdminCap, arg1: &mut ZKHedgeCommitmentState, arg2: vector<u8>) {
        let v0 = 0x1::vector::length<u8>(&arg2);
        assert!(v0 == 32 || v0 == 0, 4);
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg1.id, b"zhc_prover_pubkey_v1")) {
            0x2::dynamic_field::remove<vector<u8>, vector<u8>>(&mut arg1.id, b"zhc_prover_pubkey_v1");
        };
        if (v0 == 32) {
            0x2::dynamic_field::add<vector<u8>, vector<u8>>(&mut arg1.id, b"zhc_prover_pubkey_v1", arg2);
        };
    }
    ...
    public fun has_prover_pubkey(arg0: &ZKHedgeCommitmentState) : bool {
        0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"zhc_prover_pubkey_v1")
    }
    ...
    public entry fun settle_commitment(arg0: &RelayerCap, arg1: &mut ZKHedgeCommitmentState, arg2: &mut HedgeCommitment, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(verify_settlement_proof(arg1, &arg3, &arg2.commitment_hash), 4);
        arg2.settled = true;
    ...
    fun verify_settlement_proof(arg0: &ZKHedgeCommitmentState, arg1: &vector<u8>, arg2: &vector<u8>) : bool {
        ...
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"zhc_prover_pubkey_v1")) {
            let v0 = 0x1::vector::empty<u8>();
            let v1 = 0;
            while (v1 < 64) {
            ...
            return 0x2::ed25519::ed25519_verify(&v0, 0x2::dynamic_field::borrow<vector<u8>, vector<u8>>(&arg0.id, b"zhc_prover_pubkey_v1"), arg2)
        };
        true
    }
