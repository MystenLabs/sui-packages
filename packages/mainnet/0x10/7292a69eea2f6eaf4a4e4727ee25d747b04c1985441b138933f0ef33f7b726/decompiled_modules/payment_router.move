module 0x8f2534a77f1f0baf8c2bc44cf1cc5ada72ffd6be515f54f8f073dc434e1a3ca2::payment_router {
    ...
    public entry fun pay_sponsor_gas(arg0: &mut SponsorCap, arg1: &mut PaymentRouterState, arg2: address, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.paused, 3);
        assert!(arg3 > 0, 2);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg1.sponsor_fund) >= arg3, 1);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.sponsor_fund, arg3), arg5), arg2);
    ...
    public entry fun withdraw_sponsor_fund_to(arg0: &AdminCap, arg1: &mut PaymentRouterState, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg1.sponsor_fund) >= arg2, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.sponsor_fund, arg2), arg4), arg3);
    }
