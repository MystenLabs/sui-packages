module 0x10348e77d1c5809593685fdf3d186ee4b07ad0d4099535fc05a880e1bb542d65::suitraders {
    ...
    fun init(arg0: SUITRADERS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::create_with_mint_cap<SUITRADERS, Suitrader>(&arg0, 0x1::option::none<u64>(), arg1);
        let v3 = v1;
        ...
        0x2::display::add<Suitrader>(&mut v9, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://{url}"));
        ...
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::create_domain_and_add_strategy<Suitrader>(v6, &mut v3, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty::from_shares(0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::utils::from_vec_to_map<address, u16>(v10, vector[2000, 2000, 2000, 2000, 2000]), arg1), 100, arg1);
        ...
        let v13 = v12;
        let v14 = v11;
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::enforce<Suitrader>(&mut v14, &v13);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::transfer_allowlist::enforce<Suitrader>(&mut v14, &v13);
        let (v15, v16) = 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::init_policy<Suitrader>(&v4, arg1);
        let v17 = v16;
        let v18 = v15;
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::p2p_list::enforce<Suitrader>(&mut v18, &v17);
        ...
        let v20 = 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::listing::create_warehouse<Suitrader>(&mut v19, arg1);
        0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::fixed_price::init_venue<Suitrader, 0x2::sui::SUI>(&mut v19, v20, false, 500, arg1);
        0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::dutch_auction::init_venue<Suitrader, 0x2::sui::SUI>(&mut v19, v20, false, 100, arg1);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, v0);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<Suitrader>>(v17, v0);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<Suitrader>>(v13, v0);
        ...
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<Suitrader>>(v18);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<Suitrader>>(v14);
    }

    public entry fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<u8>, arg3: vector<0x1::ascii::String>, arg4: vector<0x1::ascii::String>, arg5: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Suitrader>, arg6: &mut 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::Warehouse<Suitrader>, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Suitrader{
        ...
        0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::deposit_nft<Suitrader>(arg6, v0);
    }
