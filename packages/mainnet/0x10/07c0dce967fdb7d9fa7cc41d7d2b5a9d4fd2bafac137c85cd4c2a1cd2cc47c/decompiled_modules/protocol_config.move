module 0x1007c0dce967fdb7d9fa7cc41d7d2b5a9d4fd2bafac137c85cd4c2a1cd2cc47c::protocol_config {
    ...
    public(friend) fun calculate_interest_with_borrow(arg0: &ProtocolConfig, arg1: u64, arg2: u64, arg3: u64) : u64 {
        0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::math::mul(0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::math::mul(arg3, interest_rate(arg0, arg1)), 0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::math::div(arg2, 0x1007c0dce967fdb7d9fa7cc41d7d2b5a9d4fd2bafac137c85cd4c2a1cd2cc47c::margin_constants::year_ms()))
    }
    ...
    public(friend) fun interest_rate(arg0: &ProtocolConfig, arg1: u64) : u64 {
        ...
        if (arg1 < v0) {
            0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::math::mul(arg1, arg0.interest_config.base_slope) + arg0.interest_config.base_rate
        } else {
            arg0.interest_config.base_rate + 0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::math::mul(v0, arg0.interest_config.base_slope) + 0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::math::mul(arg1 - v0, arg0.interest_config.excess_slope)
        }
    }
    ...
    public fun new_interest_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : InterestConfig {
        assert!(arg2 <= 0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::constants::float_scaling(), 1);
        InterestConfig{
            base_rate           : arg0,
            base_slope          : arg1,
    ...
    public fun new_margin_pool_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : MarginPoolConfig {
        assert!(arg1 <= 0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::constants::float_scaling(), 1);
        assert!(arg3 >= 0x1007c0dce967fdb7d9fa7cc41d7d2b5a9d4fd2bafac137c85cd4c2a1cd2cc47c::margin_constants::min_min_borrow(), 1);
        assert!(arg2 <= 0x1007c0dce967fdb7d9fa7cc41d7d2b5a9d4fd2bafac137c85cd4c2a1cd2cc47c::margin_constants::max_protocol_spread(), 1);
        let v0 = arg0 / 10;
        MarginPoolConfig{
            supply_cap                    : arg0,
            ...
            rate_limit_refill_rate_per_ms : v0 / 0x1007c0dce967fdb7d9fa7cc41d7d2b5a9d4fd2bafac137c85cd4c2a1cd2cc47c::margin_constants::day_ms(),
