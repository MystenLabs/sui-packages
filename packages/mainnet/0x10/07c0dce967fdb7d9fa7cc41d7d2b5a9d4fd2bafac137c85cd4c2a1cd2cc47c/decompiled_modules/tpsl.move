module 0x1007c0dce967fdb7d9fa7cc41d7d2b5a9d4fd2bafac137c85cd4c2a1cd2cc47c::tpsl {
    ...
    public(friend) fun add_conditional_order<T0, T1>(arg0: &mut TakeProfitStopLoss, arg1: &0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::pool::Pool<T0, T1>, arg2: 0x2::object::ID, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x1007c0dce967fdb7d9fa7cc41d7d2b5a9d4fd2bafac137c85cd4c2a1cd2cc47c::margin_registry::MarginRegistry, arg6: u64, arg7: Condition, arg8: PendingOrder, arg9: &0x2::clock::Clock) {
        if (is_limit_order(&arg8)) {
            assert!(0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::pool::check_limit_order_params<T0, T1>(arg1, *0x1::option::borrow<u64>(&arg8.price), arg8.quantity, *0x1::option::borrow<u64>(&arg8.expire_timestamp), arg9), 6);
        } else {
            assert!(0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::pool::check_market_order_params<T0, T1>(arg1, arg8.quantity), 6);
        };
        let v0 = 0x1007c0dce967fdb7d9fa7cc41d7d2b5a9d4fd2bafac137c85cd4c2a1cd2cc47c::oracle::calculate_price<T0, T1>(arg5, arg3, arg4, arg9);
        let v1 = arg7.trigger_below_price;
        let v2 = arg7.trigger_price;
        assert!(v1 && v2 <= v0 || !v1 && v2 >= v0, 1);
        assert!(num_conditional_orders(arg0) < 0x1007c0dce967fdb7d9fa7cc41d7d2b5a9d4fd2bafac137c85cd4c2a1cd2cc47c::margin_constants::max_conditional_orders(), 3);
    ...
    public fun new_pending_limit_order(arg0: u64, arg1: u8, arg2: u8, arg3: u64, arg4: u64, arg5: bool, arg6: bool, arg7: u64) : PendingOrder {
        assert!(arg1 == 0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::constants::no_restriction() || arg1 == 0xe75d1a9d9ad283462899f78613947b7a159b9415ba23ba37c8f0dbc3264aea6d::constants::immediate_or_cancel(), 4);
        PendingOrder{
            is_limit_order       : true,
