module 0x101869f312af7bb53d416e789860483b7707e289f56ccb73f6c13aa322d40b16::reward4154 {
    struct REWARD4154 has drop {
        dummy_field: bool,
    }

    struct TICKET_4154 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4154(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4154>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4154>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4154, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4154>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4154>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4154>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4154>>(v5, 0x2::tx_context::sender(arg1));
    }
