module 0x10c3340894360458f4f5cbde2b3f8c4459dcf318362340067705a477986c23d7::rnft {
    ...
    fun init(arg0: RNFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://static.wixstatic.com/media/33e670_0d4417bb618f49bcbea45012d83e186f~mv2.jpg"));
    ...
    public fun mint(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            let v0 = TICKET_NFT{
                ...
                description : 0x1::string::utf8(b"Support and Earn in our Sui Network."),
            };
