module 0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::manager {
    ...
    public fun authorize_and_withdraw_if_needed<T0, T1: drop, T2>(arg0: &mut 0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::boring_vault::Vault<T2>, arg1: &GuardManager<T2>, arg2: T1, arg3: u64, arg4: &0x1::option::Option<vector<u8>>, arg5: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0x2::coin::Coin<T0>> {
    ...
    public fun grant_action<T0, T1>(arg0: &0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::auth::Auth<T0>, arg1: &mut GuardManager<T0>, arg2: address, arg3: &mut 0x1::option::Option<vector<u8>>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 0, 6);
        assert!(0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::auth::has_cap<T0, 0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::auth::OwnerCap>(arg0, 0x2::tx_context::sender(arg4)), 0);
        let v0 = 0x1::type_name::get<T1>();
    ...
    fun pull_assets<T0, T1>(arg0: &mut 0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::boring_vault::Vault<T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg1 <= 0x2::balance::value<T0>(0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::boring_vault::get_balance<T0, T1>(arg0)), 1);
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::boring_vault::get_balance_mut<T0, T1>(arg0), arg1), arg2)
    }

    public fun remove_action<T0, T1>(arg0: &0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::auth::Auth<T0>, arg1: &mut GuardManager<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 0, 6);
        assert!(0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::auth::has_cap<T0, 0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::auth::OwnerCap>(arg0, 0x2::tx_context::sender(arg3)), 0);
    ...
    public fun remove_args_from_action<T0, T1>(arg0: &0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::auth::Auth<T0>, arg1: &mut GuardManager<T0>, arg2: address, arg3: &vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 0, 6);
        assert!(0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::auth::has_cap<T0, 0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::auth::OwnerCap>(arg0, 0x2::tx_context::sender(arg4)), 0);
        assert!(0x2::table::contains<address, 0x2::vec_map::VecMap<0x1::type_name::TypeName, Args>>(&arg1.actions, arg2), 2);
        let v0 = 0x1::type_name::get<T1>();
    ...
    public fun remove_strategist<T0>(arg0: &0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::auth::Auth<T0>, arg1: &mut GuardManager<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 0, 6);
        assert!(0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::auth::has_cap<T0, 0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::auth::OwnerCap>(arg0, 0x2::tx_context::sender(arg3)), 0);
        assert!(0x2::table::contains<address, 0x2::vec_map::VecMap<0x1::type_name::TypeName, Args>>(&arg1.actions, arg2), 2);
        0x2::table::remove<address, 0x2::vec_map::VecMap<0x1::type_name::TypeName, Args>>(&mut arg1.actions, arg2);
    ...
    public fun return_asset<T0, T1>(arg0: &mut 0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::boring_vault::Vault<T1>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::into_balance<T0>(arg1);
        0x2::balance::join<T0>(0xfd2fe3272aba1827bf13ff8b7207f05a6b7201a9bbe3ad166686318de6f90c2c::boring_vault::get_balance_mut<T0, T1>(arg0), v0);
