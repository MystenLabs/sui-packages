module 0xfd6127762fdefdf489d24036378212b5ea03a7aea0fc701af0a7b563a4b99ee3::reward6166 {
    struct REWARD6166 has drop {
        dummy_field: bool,
    }

    struct TICKET_6166 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6166(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6166>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6166>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6166, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6166>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6166>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6166>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6166>>(v5, 0x2::tx_context::sender(arg1));
    }
