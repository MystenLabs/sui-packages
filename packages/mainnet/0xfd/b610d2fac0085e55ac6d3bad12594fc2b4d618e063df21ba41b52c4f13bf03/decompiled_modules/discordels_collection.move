module 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::discordels_collection {
    struct Discordels has store, key {
        id: 0x2::object::UID,
    ...
    struct DISCORDELS_COLLECTION has drop {
        dummy_field: bool,
    }

    public entry fun claim(arg0: &mut InfoCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::witness::check_owner(arg2), 1);
    ...
    public entry fun burnNFT(arg0: &mut InfoCollection, arg1: Discordels, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::witness::check_owner(arg2), 1);
        let v0 = NFTBurn{
            object_id : 0x2::object::id<Discordels>(&arg1),
    ...
    fun checkOwnerSign(arg0: vector<u8>, arg1: &mut 0x2::tx_context::TxContext) : bool {
        ...
        0x1::string::sub_string(&v1, 0, 66) == v0 && 0x1::string::sub_string(&v1, 67, 0x1::string::length(&v1)) == 0x1::string::utf8(0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_project())
    }
    ...
    fun init(arg0: DISCORDELS_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_description_nft()));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_website()));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://tocen.co/"));
        let v4 = 0x2::package::claim<DISCORDELS_COLLECTION>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<Discordels>(&v4, v0, v2, arg1);
        0x2::display::update_version<Discordels>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<Discordels>>(v5, 0x2::tx_context::sender(arg1));
    }

    fun init_infocollection(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = PoolMint{
            sum_nft         : 0,
            price_mint      : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_price_mint_whitelist(),
            timestamp_start : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_time_start_whitelist(),
            timestamp_end   : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_time_end_whitelist(),
            user_mint_max   : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_user_mint_max_whitelist(),
            supply          : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_hard_cap_whitelist(),
        };
        let v1 = PoolMint{
            sum_nft         : 0,
            price_mint      : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_price_mint_holder(),
            timestamp_start : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_time_start_holder(),
            timestamp_end   : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_time_end_holder(),
            user_mint_max   : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_user_mint_max_holder(),
            supply          : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_hard_cap_holder(),
        };
        let v2 = PoolMint{
            sum_nft         : 0,
            price_mint      : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_price_mint_public(),
            timestamp_start : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_time_start_public(),
            timestamp_end   : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_time_end_public(),
            user_mint_max   : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_user_mint_max_public(),
            supply          : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_hard_cap_public(),
        };
        let v3 = PoolMint{
            sum_nft         : 0,
            price_mint      : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_price_mint_private(),
            timestamp_start : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_time_start_private(),
            timestamp_end   : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_time_end_private(),
            user_mint_max   : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_user_mint_max_private(),
            supply          : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_hard_cap_private(),
        };
        let v4 = InfoCollection{
            id                    : 0x2::object::new(arg0),
            name_nft              : 0x1::string::utf8(0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_name_nft()),
            description_nft       : 0x1::string::utf8(0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_description_nft()),
            ourl                  : 0x1::string::utf8(0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_image_url()),
            metadata              : 0x1::string::utf8(0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_metadata_url()),
            sum_nft               : 0,
            ...
            supply                : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_hard_cap_total(),
            white_list_address    : 0x2::table::new<address, bool>(arg0),
            white_list_private    : 0x2::table::new<address, bool>(arg0),
            version               : 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_version(),
        };
    ...
    fun mint(arg0: &mut InfoCollection, arg1: &mut 0x2::tx_context::TxContext) : Discordels {
        arg0.sum_nft = arg0.sum_nft + 1;
        Discordels{
            id      : 0x2::object::new(arg1),
            name    : arg0.name_nft,
            img_url : 0x2::url::new_unsafe_from_bytes(*0x1::string::bytes(&arg0.ourl)),
            link    : img_url(*0x1::string::bytes(&arg0.metadata), arg0.sum_nft, 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_type_metadata()),
        }
    }
    ...
    public entry fun mint_nft_with_airdrop(arg0: &mut InfoCollection, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::witness::check_owner(arg3), 1);
        let v0 = 0;
        while (v0 < arg1) {
            let v1 = mint(arg0, arg3);
            let v2 = NFTMinted{
                object_id : 0x2::object::id<Discordels>(&v1),
                creator   : arg2,
                name      : v1.name,
                image_url : v1.img_url,
            };
            0x2::event::emit<NFTMinted>(v2);
            0x2::transfer::public_transfer<Discordels>(v1, arg2);
            v0 = v0 + 1;
        };
    }
    ...
    public entry fun mint_nft_with_holder(arg0: &mut InfoCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = NFTMinted{
            object_id : 0x2::object::id<Discordels>(&v3),
            creator   : 0x2::tx_context::sender(arg5),
            name      : v3.name,
            image_url : v3.img_url,
        };
        0x2::event::emit<NFTMinted>(v4);
        0x2::transfer::public_transfer<Discordels>(v3, 0x2::tx_context::sender(arg5));
    }
    ...
    public entry fun mint_nft_with_private(arg0: &mut InfoCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_key_private();
        assert!(0x2::ed25519::ed25519_verify(&arg2, &v0, &arg3), 12);
        assert!(arg0.sum_nft < arg0.supply - 2, 5);
        ...
        let v5 = NFTMinted{
            object_id : 0x2::object::id<Discordels>(&v4),
            creator   : 0x2::tx_context::sender(arg5),
            name      : v4.name,
            image_url : v4.img_url,
        };
        0x2::event::emit<NFTMinted>(v5);
        0x2::transfer::public_transfer<Discordels>(v4, 0x2::tx_context::sender(arg5));
    }
    ...
    public entry fun mint_nft_with_whitelist(arg0: &mut InfoCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils::get_key_whitelist();
        assert!(0x2::ed25519::ed25519_verify(&arg2, &v0, &arg3), 12);
