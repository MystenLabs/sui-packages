module 0xfdb610d2fac0085e55ac6d3bad12594fc2b4d618e063df21ba41b52c4f13bf03::utils {
    public fun get_description_nft() : vector<u8> {
        b"Own an awesome NFT pass with Free mint, OG, and $DDL Airdrop benefits! Collect and earn rewards with Discordels Passes!"
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/QmWVkmnyXaJ5eAVZ7hVv6sfTSJTm1yzo3SjBjTQ4gVmVTD"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeiaetpsh23jdrvnfjm7hcihstqytw7xugn46dwoj7qggu7mvqmmozq/"
    }

    public fun get_name_nft() : vector<u8> {
        b"Discordels passes Series #3"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/Discordels_NFT"
    }
