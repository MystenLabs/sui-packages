module 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::custom_liquidate {
    ...
    public fun custom_liquidate<T0, T1, T2>(arg0: &mut CustomLiquidateReceipt<T1>, arg1: &0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::Liquidator, arg2: u64, arg3: &0x871ed8559523f2762d279cafe38ac8cf9b1f136d925a60abf5319c667ee6507b::app::ProtocolApp, arg4: 0x2::object::ID, arg5: &mut 0x871ed8559523f2762d279cafe38ac8cf9b1f136d925a60abf5319c667ee6507b::market::Market<T0>, arg6: &0x871ed8559523f2762d279cafe38ac8cf9b1f136d925a60abf5319c667ee6507b::coin_decimals_registry::CoinDecimalsRegistry, arg7: &0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::x_oracle::XOracle, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = take_balance_internal<T1, T2>(arg0, arg2);
        let (v1, v2) = 0x871ed8559523f2762d279cafe38ac8cf9b1f136d925a60abf5319c667ee6507b::liquidate::liquidate_as_coin<T0, T2, T1>(arg3, 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::borrow_package_caller_cap(arg1), arg4, arg5, 0x2::coin::from_balance<T2>(v0, arg9), arg6, arg7, arg8, arg9);
        let v3 = v2;
    ...
    public fun add_flash_loan_debts<T0: drop, T1, T2>(arg0: &mut CustomLiquidateReceipt<T1>, arg1: &0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::Liquidator, arg2: T0, arg3: u8, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::is_package_whitelisted<T0>(arg1), 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::error::package_not_whitelisted());
    ...
    public fun create_receipt<T0>(arg0: &0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::Liquidator, arg1: &mut 0x2::tx_context::TxContext) : CustomLiquidateReceipt<T0> {
        0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::ensure_caller_whitelisted(arg0, 0x2::tx_context::sender(arg1));
    ...
    public fun put_balance<T0: drop, T1, T2>(arg0: &mut CustomLiquidateReceipt<T1>, arg1: &0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::Liquidator, arg2: T0, arg3: 0x2::balance::Balance<T2>) {
        assert!(0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::is_package_whitelisted<T0>(arg1), 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::error::package_not_whitelisted());
    ...
    public fun sub_flash_loan_debts<T0: drop, T1, T2>(arg0: &mut CustomLiquidateReceipt<T1>, arg1: &0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::Liquidator, arg2: T0, arg3: u8, arg4: u64) {
        assert!(0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::is_package_whitelisted<T0>(arg1), 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::error::package_not_whitelisted());
    ...
    fun sub_flash_loan_debts_internal<T0, T1>(arg0: &mut CustomLiquidateReceipt<T0>, arg1: u8, arg2: u64) {
        let v0 = 0x1::type_name::with_defining_ids<T1>();
        assert!(0x2::table::contains<u8, 0x2::table::Table<0x1::type_name::TypeName, u64>>(&arg0.flash_loan_debts, arg1), 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::error::invalid_protocol_id());
        let v1 = 0x2::table::borrow_mut<u8, 0x2::table::Table<0x1::type_name::TypeName, u64>>(&mut arg0.flash_loan_debts, arg1);
        assert!(0x2::table::contains<0x1::type_name::TypeName, u64>(v1, v0), 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::error::invalid_coin_type());
        let v2 = *0x2::table::borrow<0x1::type_name::TypeName, u64>(v1, v0);
        assert!(v2 >= arg2, 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::error::invalid_repay_amount());
        let v3 = v2 - arg2;
        let v4 = if (v3 == 0) {
    ...
    public fun take_balance<T0: drop, T1, T2>(arg0: &mut CustomLiquidateReceipt<T1>, arg1: &0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::Liquidator, arg2: T0, arg3: u64) : 0x2::balance::Balance<T2> {
        assert!(0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::is_package_whitelisted<T0>(arg1), 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::error::package_not_whitelisted());
    ...
    fun take_balance_internal<T0, T1>(arg0: &mut CustomLiquidateReceipt<T0>, arg1: u64) : 0x2::balance::Balance<T1> {
        let v0 = 0x1::type_name::with_defining_ids<T1>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v0), 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::error::invalid_coin_type());
        let v1 = 0x2::balance::value<T1>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&arg0.balances, v0));
        assert!(v1 >= arg1, 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::error::insufficient_balance());
        if (arg1 == v1) {
    ...
    public fun verify_custom_liquidate<T0>(arg0: CustomLiquidateReceipt<T0>, arg1: &0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::Liquidator, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2;
        let v4 = v0;
        assert!(0x2::table::is_empty<u8, 0x2::table::Table<0x1::type_name::TypeName, u64>>(&v3), 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::error::flash_loan_debts_not_empty());
        ...
        assert!(0x2::bag::is_empty(&v4), 0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::error::balances_not_empty());
        0x2::bag::destroy_empty(v4);
        0xfd24188d3b2d1aff05829d2bf19ccb331844aefddd969dd4638f04feff715062::liquidator::transfer_to_recipient<T0>(arg1, 0x2::coin::from_balance<T0>(v6, arg2));
    }
