module 0xfd84f883d3f329c2f6000ee378a924ed0c116822918bf78f0d0acdd28d8408d5::mycoin {
    ...
    fun init(arg0: MYCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MYCOIN>(arg0, 6, b"zmc", b"zmc coin", b"zmc coin", 0x1::option::none<0x2::url::Url>(), arg1);
