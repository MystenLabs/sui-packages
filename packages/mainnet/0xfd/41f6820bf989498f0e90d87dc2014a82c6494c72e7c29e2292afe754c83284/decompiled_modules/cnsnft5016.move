module 0xfd41f6820bf989498f0e90d87dc2014a82c6494c72e7c29e2292afe754c83284::cnsnft5016 {
    struct CNSNFT5016 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5016, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3689"));
        let v4 = 0x2::package::claim<CNSNFT5016>(arg0, arg1);
