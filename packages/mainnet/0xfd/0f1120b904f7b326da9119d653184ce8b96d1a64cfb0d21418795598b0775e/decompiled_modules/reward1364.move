module 0xfd0f1120b904f7b326da9119d653184ce8b96d1a64cfb0d21418795598b0775e::reward1364 {
    struct REWARD1364 has drop {
        dummy_field: bool,
    }

    struct TICKET_1364 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1364(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1364>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1364>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1364, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1364>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1364>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1364>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1364>>(v5, 0x2::tx_context::sender(arg1));
    }
