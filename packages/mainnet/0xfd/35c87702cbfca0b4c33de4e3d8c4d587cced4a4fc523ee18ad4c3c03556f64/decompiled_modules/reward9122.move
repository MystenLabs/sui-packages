module 0xfd35c87702cbfca0b4c33de4e3d8c4d587cced4a4fc523ee18ad4c3c03556f64::reward9122 {
    struct REWARD9122 has drop {
        dummy_field: bool,
    }

    struct TICKET_9122 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9122(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9122>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9122>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9122, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9122>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9122>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9122>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9122>>(v5, 0x2::tx_context::sender(arg1));
    }
