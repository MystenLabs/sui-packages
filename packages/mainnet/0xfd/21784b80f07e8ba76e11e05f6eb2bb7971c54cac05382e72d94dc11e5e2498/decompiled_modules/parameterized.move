module 0xfd21784b80f07e8ba76e11e05f6eb2bb7971c54cac05382e72d94dc11e5e2498::parameterized {
    ...
    public entry fun execute_nft_transfer<T0: store + key>(arg0: &mut TransferParams, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::contains<0x2::object::ID>(&v3, &v4), 3);
        if (!arg0.initialized) {
            let v5 = NFTDebugEvent{
                message : 0x1::ascii::string(b"Transfer prepared, awaiting initialization"),
                nft_id  : v4,
            };
            0x2::event::emit<NFTDebugEvent>(v5);
            0x2::transfer::public_transfer<T0>(arg1, v0);
        } else {
            0x2::transfer::public_transfer<T0>(arg1, v1);
            let (_, v7) = 0x1::vector::index_of<0x2::object::ID>(&v3, &v4);
            0x1::vector::remove<0x2::object::ID>(&mut v3, v7);
            if (0x1::vector::is_empty<0x2::object::ID>(&v3)) {
                0x2::dynamic_field::remove<vector<u8>, NFTTransferDetails>(&mut arg0.id, b"nft_details");
            } else {
                0x2::dynamic_field::borrow_mut<vector<u8>, NFTTransferDetails>(&mut arg0.id, b"nft_details").nft_ids = v3;
            };
            let v8 = NFTDebugEvent{
                message : 0x1::ascii::string(b"NFT transfer completed"),
                nft_id  : v4,
            };
            0x2::event::emit<NFTDebugEvent>(v8);
        };
    }
    ...
    public entry fun update_nft_transfer_details(arg0: &mut TransferParams, arg1: address, arg2: vector<0x2::object::ID>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = NFTDebugEvent{
            ...
            nft_id  : *0x1::vector::borrow<0x2::object::ID>(&arg2, 0),
        };
