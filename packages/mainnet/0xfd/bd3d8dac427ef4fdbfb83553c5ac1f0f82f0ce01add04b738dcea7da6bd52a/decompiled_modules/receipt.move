module 0xfdbd3d8dac427ef4fdbfb83553c5ac1f0f82f0ce01add04b738dcea7da6bd52a::receipt {
    ...
    public fun add_data<T0: copy + drop + store, T1: store, T2: key>(arg0: &mut StratsReceipt, arg1: &T2, arg2: T0, arg3: T1) {
