module 0xfd1afcd40a2e141f9d976217b2a14be834208c237d75844e3d59b68b634f66c8::ft_type {
    ...
    public fun register_bridge<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2235d7a739aae888ad6abb290924584a68dd7178a0ae0062237fba9be5666495::tradeport_bridge::Manager, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2235d7a739aae888ad6abb290924584a68dd7178a0ae0062237fba9be5666495::tradeport_bridge::register_bridge<T0, FT_TYPE>(arg1, 0x2::coin::mint<FT_TYPE>(0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, 0x2::coin::TreasuryCap<FT_TYPE>>(&mut arg0.id, 0x1::ascii::string(b"coin_treasury_cap")), 1000000000, arg2), arg2);
    }
