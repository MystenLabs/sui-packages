module 0xfd5d94af944d1384a2f7dbda84c4480509c5ddab99b1b9fec1f2768ae7baaa3c::the_captains_delete {
    struct THE_CAPTAINS_DELETE has drop {
        dummy_field: bool,
    }
    ...
    public fun admin_destroy_basic_objects(arg0: AdminCap, arg1: Counter, arg2: Payout, arg3: MintConfig, arg4: TraitsRegistry, arg5: PubKey, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg6) == @0x552c4e45ef071c3c14e75a5247a9c5dd4e7430e3783e217b663aab1d926d8fa5, 6);
        let Counter {
            id      : v0,
            next_id : _,
        } = arg1;
        ...
        let MintConfig {
            id                  : v4,
            paused              : _,
            default_stage_limit : _,
            total_mint_limit    : _,
            per_stage_limits    : v8,
        } = arg3;
        0x2::table::drop<u64, u64>(v8);
        0x2::object::delete(v4);
        let TraitsRegistry {
            id     : v9,
            traits : v10,
        } = arg4;
        0x2::table::drop<u64, CaptainAttributes>(v10);
        ...
        let AdminCap { id: v14 } = arg0;
        0x2::object::delete(v14);
    }

    public fun admin_destroy_collection_completely(arg0: AdminCap, arg1: Counter, arg2: Payout, arg3: MintConfig, arg4: TraitsRegistry, arg5: PubKey, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg6) == @0x552c4e45ef071c3c14e75a5247a9c5dd4e7430e3783e217b663aab1d926d8fa5, 6);
        let Counter {
            id      : v0,
            next_id : _,
    ...
    public fun delete_object_by_uid(arg0: 0x2::object::UID, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == @0x552c4e45ef071c3c14e75a5247a9c5dd4e7430e3783e217b663aab1d926d8fa5, 6);
    ...
    fun init(arg0: THE_CAPTAINS_DELETE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = 0x2::package::claim<THE_CAPTAINS_DELETE>(arg0, arg1);
