module 0xfd06d58543ee7fa5fc3c144476c14cf31e15255a524aa3069325fa56f7b5f26c::pyth_cover_pool {
    ...
    fun assert_valid_param_value<T0>(arg0: &DepegCoverPool<T0>, arg1: u8, arg2: u64) {
        if (arg1 == 0) {
            ...
            assert!(arg2 > 0 && arg2 <= arg0.max_policy_duration_secs, 24);
        } else if (arg1 == 6) {
            assert!(arg2 < arg0.max_policy_duration_secs, 24);
        } else if (arg1 == 7) {
            let v0 = if (arg2 == 0) {
                true
    ...
    public fun buy_cover<T0>(arg0: &mut DepegCoverPool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : Policy<T0> {
        ...
        assert!(v4 >= v3, 1);
        let v5 = (((v4 as u128) * (arg0.treasury_fee_bps as u128) / 10000) as u64);
        let v6 = 0x2::coin::into_balance<T0>(arg1);
        if (v5 > 0) {
            0x2::balance::join<T0>(&mut arg0.treasury, 0x2::balance::split<T0>(&mut v6, v5));
        };
        0x2::balance::join<T0>(&mut arg0.funds, v6);
        ...
        0x2::table::add<0x2::object::ID, PolicyState>(&mut arg0.policies, 0x2::object::uid_to_inner(&v7), v8);
        let v9 = CoverBought{
    ...
    fun do_latch<T0>(arg0: &mut DepegCoverPool<T0>, arg1: &mut Policy<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (!arg1.armed) {
            ...
            let v2 = 0x2::object::id<Policy<T0>>(arg1);
            assert!(0x2::table::contains<0x2::object::ID, PolicyState>(&arg0.policies, v2), 25);
            0x2::table::borrow_mut<0x2::object::ID, PolicyState>(&mut arg0.policies, v2).breached = true;
            arg1.breach_price = arg2;
            arg1.breached = true;
            let v3 = arg0.keeper_bounty;
            if (v3 > 0 && 0x2::balance::value<T0>(&arg0.treasury) >= v3) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.treasury, v3, arg5), 0x2::tx_context::sender(arg5));
            };
    ...
    public fun expire_policy<T0>(arg0: &mut DepegCoverPool<T0>, arg1: Policy<T0>, arg2: &0x2::clock::Clock) {
        ...
        if (0x2::table::contains<0x2::object::ID, PolicyState>(&arg0.policies, v11)) {
            release_expired_policy<T0>(arg0, v11, arg2);
        } else {
    ...
    fun settle<T0>(arg0: &mut DepegCoverPool<T0>, arg1: Policy<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(v1 == 0x2::object::id<DepegCoverPool<T0>>(arg0), 3);
        let v11 = 0x2::object::uid_to_inner(&v10);
        assert!(0x2::table::contains<0x2::object::ID, PolicyState>(&arg0.policies, v11), 25);
        let v12 = 0x2::table::remove<0x2::object::ID, PolicyState>(&mut arg0.policies, v11);
        assert!(v12.cover == v2, 3);
        assert!(v12.breached, 11);
        0x2::object::delete(v10);
