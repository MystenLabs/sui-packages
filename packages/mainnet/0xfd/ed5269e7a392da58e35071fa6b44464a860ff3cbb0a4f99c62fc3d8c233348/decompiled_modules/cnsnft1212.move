module 0xfded5269e7a392da58e35071fa6b44464a860ff3cbb0a4f99c62fc3d8c233348::cnsnft1212 {
    struct CNSNFT1212 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1212, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9575"));
        let v4 = 0x2::package::claim<CNSNFT1212>(arg0, arg1);
