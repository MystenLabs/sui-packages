module 0xfdd16e6b20cdb9d546064244abef48672de931b165d718fd0de35556d0c4ac6a::nft {
    ...
    public entry fun mint(arg0: &mut Collection, arg1: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = merge_and_split(arg1, 1500000000, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v4, v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v3, @0x968fa1041658d0ab16a38bb00cf3a24284d94c679cd42c171ac4f6da1ac2a363);
        let v5 = MintNFTEvent{
