module 0xfd11beecf23ee5c88f2ab2755aa56c49a13dad33ccffccfc52aefaac6bdde8f8::mynft {
    ...
    fun init(arg0: MYNFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"unclemoto"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"A sample NFT for unclemoto"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://github.com/unclemoto.png"));
