module 0xfdd77ed1bf945a242d982cf303f7887028ddec471799a5bc685ddd181b376d6a::cnsnft2823 {
    struct CNSNFT2823 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2823, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2823>(arg0, arg1);
