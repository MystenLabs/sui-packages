module 0xfd286e2550c652b83dc6f3f4b428fda2f7bfd41e2e97ea3e8218007fd1e63206::reward1948 {
    struct REWARD1948 has drop {
        dummy_field: bool,
    }

    struct TICKET_1948 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1948(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1948>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1948>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1948, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1948>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1948>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1948>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1948>>(v5, 0x2::tx_context::sender(arg1));
    }
