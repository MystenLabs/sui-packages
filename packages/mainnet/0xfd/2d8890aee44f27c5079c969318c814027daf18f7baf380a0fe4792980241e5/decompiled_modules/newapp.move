module 0x6dc234e9a85395da22e63aaa15ea9f1e14ae039a1ce5dfca30f1189558c7419e::newapp {
    ...
    public entry fun distribution<T0>(arg0: &mut Contract<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < 0x1::vector::length<address>(v1)) {
            let v6 = 0x2::table::borrow_mut<address, User>(v0, *0x1::vector::borrow<address>(v1, v2));
            if (v6.underway_power <= 0) {
                v2 = v2 + 1;
                continue
            };
            let v7 = v6.underway_power / 500;
            let v8 = v6.dynamic_power / 500;
            if (v8 > 0) {
                v6.dynamic_power = v6.dynamic_power - v8;
            };
            let v9 = v7 + v8;
            let v10 = v6.total_static_power - v6.total_revenue;
            let v11 = if (v10 > v9) {
                v9
            } else {
                v10
            ...
            v4 = v4 + v7;
            v5 = v5 + v8;
            v6.release_static_power = v6.release_static_power + v7;
            v6.release_dynamic_power = v6.release_dynamic_power + v8;
            v6.balance = v6.balance + v11;
            v6.total_revenue = v6.total_revenue + v11;
            v6.daily_static_revenue = v6.daily_static_revenue + v11;
            handler_out(v3, v6);
            v2 = v2 + 1;
        };
    ...
    public entry fun withdraw<T0>(arg0: &mut Contract<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        v4.level6_gross = v4.level6_gross + v3 * 30 / 100;
        v4.level7_gross = v4.level7_gross + v3 * 20 / 100;
    }
