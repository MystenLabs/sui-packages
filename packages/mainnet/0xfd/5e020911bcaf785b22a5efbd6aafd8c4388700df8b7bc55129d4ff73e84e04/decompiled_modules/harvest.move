module 0x1222e054f9dff4d12dabbfd3b61103e5439ea56d390f49d813b163c20ebddd9a::harvest {
    ...
    public fun complete_harvest<T0>(arg0: &mut 0xb15e15f9541a3eb12989d950a319e037c71e3d422065221687372e7c36c70897::vault::Vault<T0>, arg1: &mut HarvestConfig, arg2: &0x1222e054f9dff4d12dabbfd3b61103e5439ea56d390f49d813b163c20ebddd9a::strategy::StrategyRegistry, arg3: HarvestPromise<T0>, arg4: 0x2::coin::Coin<T0>, arg5: vector<u8>, arg6: vector<u8>, arg7: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::object::id<0xb15e15f9541a3eb12989d950a319e037c71e3d422065221687372e7c36c70897::vault::Vault<T0>>(arg0) == v0, 702);
        ...
        0x2::bcs::peel_u64(&mut v4);
        0x2::bcs::peel_u64(&mut v4);
        let v6 = 0x2::object::id<0xb15e15f9541a3eb12989d950a319e037c71e3d422065221687372e7c36c70897::vault::Vault<T0>>(arg0);
        ...
        assert!(v8 > 0, 703);
        let v9 = 0xb15e15f9541a3eb12989d950a319e037c71e3d422065221687372e7c36c70897::vault::performance_fee_bps<T0>(arg0);
        let v10 = 0;
        if (v9 > 0) {
            let v11 = v8 * v9 / 10000;
            v10 = v11;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg4, v11, arg9), 0xb15e15f9541a3eb12989d950a319e037c71e3d422065221687372e7c36c70897::vault::fee_recipient<T0>(arg0));
        };
        0xb15e15f9541a3eb12989d950a319e037c71e3d422065221687372e7c36c70897::vault::deposit_balance_to_idle<T0>(arg0, 0x1222e054f9dff4d12dabbfd3b61103e5439ea56d390f49d813b163c20ebddd9a::strategy::borrow_protocol_access_cap(arg2), 0x2::coin::into_balance<T0>(arg4));
    ...
    public fun issue_harvest_promise<T0, T1>(arg0: &0xb15e15f9541a3eb12989d950a319e037c71e3d422065221687372e7c36c70897::vault::Vault<T0>, arg1: &HarvestConfig, arg2: &0xb15e15f9541a3eb12989d950a319e037c71e3d422065221687372e7c36c70897::vault::ProtocolAccessCap, arg3: u8, arg4: u64, arg5: &0x2::clock::Clock) : HarvestPromise<T0> {
        let (v0, _) = should_harvest(arg1, arg3, arg5);
        assert!(v0, 700);
        HarvestPromise<T0>{
            vault_id        : 0x2::object::id<0xb15e15f9541a3eb12989d950a319e037c71e3d422065221687372e7c36c70897::vault::Vault<T0>>(arg0),
            strategy_id     : arg3,
    ...
    public fun issue_harvest_promise_direct<T0, T1>(arg0: &0xb15e15f9541a3eb12989d950a319e037c71e3d422065221687372e7c36c70897::vault::Vault<T0>, arg1: &HarvestConfig, arg2: &0x1222e054f9dff4d12dabbfd3b61103e5439ea56d390f49d813b163c20ebddd9a::strategy::StrategyRegistry, arg3: u8, arg4: u64, arg5: &0x2::clock::Clock) : HarvestPromise<T0> {
        issue_harvest_promise<T0, T1>(arg0, arg1, 0x1222e054f9dff4d12dabbfd3b61103e5439ea56d390f49d813b163c20ebddd9a::strategy::borrow_protocol_access_cap(arg2), arg3, arg4, arg5)
    }
    ...
    public(friend) fun set_harvest_slippage_bps(arg0: &mut HarvestConfig, arg1: u64) {
        0xb15e15f9541a3eb12989d950a319e037c71e3d422065221687372e7c36c70897::floors::assert_slippage(arg1, false);
