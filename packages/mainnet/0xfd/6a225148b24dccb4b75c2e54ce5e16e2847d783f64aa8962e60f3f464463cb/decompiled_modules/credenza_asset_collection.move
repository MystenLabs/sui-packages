module 0xfd6a225148b24dccb4b75c2e54ce5e16e2847d783f64aa8962e60f3f464463cb::credenza_asset_collection {
    struct CollectionCap has store, key {
        ...
        ownership: 0xfd6a225148b24dccb4b75c2e54ce5e16e2847d783f64aa8962e60f3f464463cb::ownership::CredenzaOwnership,
    }
    ...
    public fun add_asset(arg0: &mut CollectionCap, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        0xfd6a225148b24dccb4b75c2e54ce5e16e2847d783f64aa8962e60f3f464463cb::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg4));
    ...
    public fun buy_asset<T0>(arg0: &mut CollectionCap, arg1: &0xfd6a225148b24dccb4b75c2e54ce5e16e2847d783f64aa8962e60f3f464463cb::sellable::CredenzaSellableConfig<CREDENZA_ASSET_COLLECTION>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        0xfd6a225148b24dccb4b75c2e54ce5e16e2847d783f64aa8962e60f3f464463cb::sellable::accept_asset_payment_coin<CREDENZA_ASSET_COLLECTION, T0>(arg1, arg3, arg2, arg5);
    ...
    fun init(arg0: CREDENZA_ASSET_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = CollectionCap{
            ...
            ownership   : 0xfd6a225148b24dccb4b75c2e54ce5e16e2847d783f64aa8962e60f3f464463cb::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
        };
        0xfd6a225148b24dccb4b75c2e54ce5e16e2847d783f64aa8962e60f3f464463cb::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg1));
        let v2 = CollectionCapCreated{id: 0x2::object::id<CollectionCap>(&v1)};
        0x2::event::emit<CollectionCapCreated>(v2);
        let (_, v4) = 0xfd6a225148b24dccb4b75c2e54ce5e16e2847d783f64aa8962e60f3f464463cb::sellable::create_config<CREDENZA_ASSET_COLLECTION>(arg0, arg1);
        0x2::transfer::public_share_object<CollectionCap>(v1);
        0x2::transfer::public_share_object<0xfd6a225148b24dccb4b75c2e54ce5e16e2847d783f64aa8962e60f3f464463cb::sellable::CredenzaSellableConfig<CREDENZA_ASSET_COLLECTION>>(v4);
    }
    ...
    public fun set_owner(arg0: &mut CollectionCap, arg1: address, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        0xfd6a225148b24dccb4b75c2e54ce5e16e2847d783f64aa8962e60f3f464463cb::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        0xfd6a225148b24dccb4b75c2e54ce5e16e2847d783f64aa8962e60f3f464463cb::ownership::set_owner(&mut arg0.ownership, arg1, arg2);
    }
    ...
    public fun update_metadata(arg0: &mut CollectionCap, arg1: u64, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        0xfd6a225148b24dccb4b75c2e54ce5e16e2847d783f64aa8962e60f3f464463cb::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg5));
