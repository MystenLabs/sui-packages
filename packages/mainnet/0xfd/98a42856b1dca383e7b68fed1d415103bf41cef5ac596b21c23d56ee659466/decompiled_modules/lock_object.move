module 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::lock_object {
    ...
    public fun claim<T0: store + key>(arg0: LockedObject<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 >= arg0.unlock_time, 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::error::eobject_still_locked());
        ...
        0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::events::emit_object_unlocked(0x2::object::id<LockedObject<T0>>(&arg0), 0x2::object::id<T0>(&arg0.object), v1, v0);
    }
    ...
    public(friend) fun new_locked_object<T0: store + key>(arg0: address, arg1: T0, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : LockedObject<T0> {
        assert!(arg2 > arg3, 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::error::einvalid_unlock_time());
        LockedObject<T0>{
