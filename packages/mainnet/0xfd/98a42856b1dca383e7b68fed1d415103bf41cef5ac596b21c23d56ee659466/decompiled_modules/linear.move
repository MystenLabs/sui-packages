module 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::linear {
    ...
    public fun claim<T0>(arg0: &mut LinearStream<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 >= arg0.start, 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::error::estream_not_started());
        ...
        0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::events::emit_tokens_claimed(0x2::object::id<LinearStream<T0>>(arg0), v3, arg0.recipient, arg0.released);
        ...
        if (arg0.released >= arg0.total_deposit) {
            0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::events::emit_stream_completed(0x2::object::id<LinearStream<T0>>(arg0), arg0.released, v0);
        };
    }

    public fun cancel<T0>(arg0: &mut LinearStream<T0>, arg1: 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::cancel_cap::CancelCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::cancel_cap::get_stream_id(&arg1) == 0x2::object::id<LinearStream<T0>>(arg0), 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::error::einvalid_cancel_cap());
        ...
        0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::events::emit_stream_canceled(0x2::object::id<LinearStream<T0>>(arg0), v1, arg0.recipient, v5, v6, v0);
    }
    ...
    public fun get_vested_amount<T0>(arg0: &LinearStream<T0>, arg1: u64) : u64 {
        if (0x1::option::is_some<u64>(&arg0.cliff)) {
            0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::math::calculate_vested_amount_with_cliff(arg0.total_deposit, arg0.start, *0x1::option::borrow<u64>(&arg0.cliff), arg0.end, arg1)
        } else {
            0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::math::calculate_vested_amount(arg0.total_deposit, arg0.start, arg0.end, arg1)
        }
    }
    ...
    public(friend) fun new_stream<T0>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: 0x1::option::Option<u64>, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : LinearStream<T0> {
        ...
        assert!(arg3 > arg2, 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::error::einvalid_time_range());
        ...
        if (0x1::option::is_some<u64>(&arg4)) {
            ...
            assert!(v1 >= arg2, 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::error::einvalid_cliff());
            assert!(v1 <= arg3, 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::error::einvalid_cliff());
        };
        LinearStream<T0>{
