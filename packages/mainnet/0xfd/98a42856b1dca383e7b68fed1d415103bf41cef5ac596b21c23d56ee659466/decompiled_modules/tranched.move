module 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::tranched {
    ...
    struct TranchedStream<phantom T0> has store, key {
        ...
        released: u64,
        tranches: vector<0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::types::Tranche>,
        cancelable: bool,
        is_canceled: bool,
    }
    ...
    public fun claim<T0>(arg0: &mut TranchedStream<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::events::emit_tokens_claimed(0x2::object::id<TranchedStream<T0>>(arg0), v3, arg0.recipient, arg0.released);
        ...
        if (arg0.released >= arg0.total_deposit) {
            0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::events::emit_stream_completed(0x2::object::id<TranchedStream<T0>>(arg0), arg0.released, v0);
        };
    }

    public fun cancel<T0>(arg0: &mut TranchedStream<T0>, arg1: 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::cancel_cap::CancelCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::cancel_cap::get_stream_id(&arg1) == 0x2::object::id<TranchedStream<T0>>(arg0), 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::error::einvalid_cancel_cap());
        ...
        0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::events::emit_stream_canceled(0x2::object::id<TranchedStream<T0>>(arg0), v1, arg0.recipient, v5, v6, v0);
    }
    ...
    public fun get_vested_amount<T0>(arg0: &TranchedStream<T0>, arg1: u64) : u64 {
        let v0 = 0;
        let v1 = 0;
        while (v1 < 0x1::vector::length<0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::types::Tranche>(&arg0.tranches)) {
            let v2 = 0x1::vector::borrow<0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::types::Tranche>(&arg0.tranches, v1);
            if (arg1 >= 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::types::tranche_timestamp(v2)) {
                v0 = v0 + 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::types::tranche_amount(v2);
                v1 = v1 + 1;
            } else {
                break
            };
    ...
    public(friend) fun new_stream<T0>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: vector<0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::types::Tranche>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : TranchedStream<T0> {
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 > 0, 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::error::einvalid_amount());
        assert!(!0x1::vector::is_empty<0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::types::Tranche>(&arg2), 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::error::eempty_tranches());
        let v1 = 0;
        let v2 = 0;
        while (v1 < 0x1::vector::length<0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::types::Tranche>(&arg2)) {
            let v3 = 0x1::vector::borrow<0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::types::Tranche>(&arg2, v1);
            assert!(0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::types::tranche_timestamp(v3) >= 0, 0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::error::etimestamps_not_sorted());
            v2 = v2 + (0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::types::tranche_amount(v3) as u128);
            v1 = v1 + 1;
        };
    ...
    public fun tranches<T0>(arg0: &TranchedStream<T0>) : &vector<0xfd98a42856b1dca383e7b68fed1d415103bf41cef5ac596b21c23d56ee659466::types::Tranche> {
        &arg0.tranches
    }
