module 0xfdf45c1d83a302a36799295d26199dc26da0eae6fa2852f38b1829e3cc581edd::test_token {
    ...
    fun init(arg0: TEST_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<TEST_TOKEN>(arg0, 9, b"HYO", b"HYDRO", b"Utility Coin for HYDRO", 0x1::option::none<0x2::url::Url>(), arg1);
