module 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::oracle_driven_pool {
    ...
    fun calculate_trade_slippage<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64, arg2: bool, arg3: u64) : u64 {
        ...
        while (v14 < 0x1::vector::length<u64>(&v12)) {
            ...
            if (v16 > 0) {
                ...
                if (v14 == 0) {
                    v15 = v15 + 0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::mul(v17, arg0.core_data.k_without_deviation);
                } else {
    ...
    public fun check_parameters<T0, T1>(arg0: &Pool<T0, T1>) {
        assert!(0xfd6098ae62cbfc3803d8a6fc560e05c412840bf2a2afffa41c0acf2db4434bbd::safe_math::lt_one(get_k_without_deviation<T0, T1>(arg0)), 1);
