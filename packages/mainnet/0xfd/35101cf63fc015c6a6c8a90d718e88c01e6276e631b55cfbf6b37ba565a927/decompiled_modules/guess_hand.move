module 0xfd35101cf63fc015c6a6c8a90d718e88c01e6276e631b55cfbf6b37ba565a927::guess_hand {
    ...
    fun init(arg0: GUESS_HAND, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::coin::create_currency<GUESS_HAND>(arg0, 9, b"june5753", b"Bruce", b"Game coin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://avatars.githubusercontent.com/u/12596742?v=4"))), arg1);
        let v3 = v1;
