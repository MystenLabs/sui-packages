module 0xfd72161ccfd613fb4c51a473dc13a5f5eb4e54633bf8e0a28d52ed0095720f73::alloy {
    ...
    struct MarketInstance has store {
        market_name: 0x1::string::String,
        guesses: 0xfd72161ccfd613fb4c51a473dc13a5f5eb4e54633bf8e0a28d52ed0095720f73::big_queue::BigQueue<Guess>,
        round_number: u64,
        ai_prediction: 0x1::option::Option<u64>,
    ...
    public fun create_market_instance<T0>(arg0: &MarketAdminCap, arg1: &mut MarketConfig, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = MarketInstance{
            market_name         : arg3,
            guesses             : 0xfd72161ccfd613fb4c51a473dc13a5f5eb4e54633bf8e0a28d52ed0095720f73::big_queue::new<Guess>(5000, arg7),
    ...
    public fun place_guess<T0>(arg0: &mut MarketConfig, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: address, arg5: u64, arg6: 0x2::coin::Coin<T0>, arg7: 0x1::string::String, arg8: &0x2::clock::Clock) {
        ...
        0xfd72161ccfd613fb4c51a473dc13a5f5eb4e54633bf8e0a28d52ed0095720f73::big_queue::push_back<Guess>(&mut v4.guesses, v5);
    }
    ...
    public fun release_unsettled_market<T0>(arg0: &MarketAdminCap, arg1: &mut MarketConfig, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: &0x2::clock::Clock, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<u64>(&arg6)) {
            v3 = 0xfd72161ccfd613fb4c51a473dc13a5f5eb4e54633bf8e0a28d52ed0095720f73::big_queue::length<Guess>(&v2.guesses) - *0x1::option::borrow<u64>(&arg6);
        };
        while (0xfd72161ccfd613fb4c51a473dc13a5f5eb4e54633bf8e0a28d52ed0095720f73::big_queue::length<Guess>(&v2.guesses) > v3) {
            let v4 = 0xfd72161ccfd613fb4c51a473dc13a5f5eb4e54633bf8e0a28d52ed0095720f73::big_queue::pop_front<Guess>(&mut v2.guesses);
        ...
        if (0xfd72161ccfd613fb4c51a473dc13a5f5eb4e54633bf8e0a28d52ed0095720f73::big_queue::length<Guess>(&v2.guesses) == 0) {
            v2.released = true;
    ...
    public fun settle_or_continue<T0>(arg0: &MarketAdminCap, arg1: &mut MarketConfig, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: 0x1::option::Option<u64>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = borrow_mut_marketplace<T0>(arg1, arg2);
        let v1 = 0x2::table::borrow_mut<0x1::string::String, Market>(&mut v0.markets, arg3);
        let v2 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::pyth::get_price_no_older_than(arg5, arg7, 10);
        assert!(is_same_price_id_as_market(v1, arg5), 13);
        let v3 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_price(&v2);
        let v4 = 0x2::table::borrow_mut<u64, MarketInstance>(&mut v1.games, arg4);
        assert!(v4.locked, 3);
        assert!(!v4.settled, 4);
        assert!(!v4.released, 6);
        assert!(0x2::clock::timestamp_ms(arg7) > v4.end_timestamp, 9);
        v4.result = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v3) * 10;
        let v5 = 0;
        if (0x1::option::is_some<u64>(&arg6)) {
            v5 = 0xfd72161ccfd613fb4c51a473dc13a5f5eb4e54633bf8e0a28d52ed0095720f73::big_queue::length<Guess>(&v4.guesses) - *0x1::option::borrow<u64>(&arg6);
        };
        while (0xfd72161ccfd613fb4c51a473dc13a5f5eb4e54633bf8e0a28d52ed0095720f73::big_queue::length<Guess>(&v4.guesses) > v5) {
            let v6 = 0xfd72161ccfd613fb4c51a473dc13a5f5eb4e54633bf8e0a28d52ed0095720f73::big_queue::pop_front<Guess>(&mut v4.guesses);
            let v7 = get_result(v4.result, *0x1::option::borrow<u64>(&v4.ai_prediction), v6.guess);
            v0.locked_balance = v0.locked_balance - v6.bet_size;
            if (v7 == 1) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v0.balance, v6.bet_size * 2), arg8), v6.player);
            };
            if (v7 == 2) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v0.balance, v6.bet_size), arg8), v6.player);
            };
        };
        if (0xfd72161ccfd613fb4c51a473dc13a5f5eb4e54633bf8e0a28d52ed0095720f73::big_queue::length<Guess>(&v4.guesses) == 0) {
            v4.settled = true;
            let v8 = RoundResult<T0>{
                market_id     : 0x2::object::uid_to_inner(&v0.id),
                market_name   : arg3,
                result        : v4.result,
                ai_prediction : 0x1::option::some<u64>(*0x1::option::borrow<u64>(&v4.ai_prediction)),
                round_number  : v1.round_number,
            };
            0x2::event::emit<RoundResult<T0>>(v8);
        };
    }
