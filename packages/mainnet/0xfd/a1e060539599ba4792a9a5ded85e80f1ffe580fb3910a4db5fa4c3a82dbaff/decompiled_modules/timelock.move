module 0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::timelock {
    ...
    public fun cancel(arg0: &mut TimelockRegistry, arg1: &0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::vault::AdminCap, arg2: u64, arg3: &0x2::clock::Clock) {
    ...
    public fun destroy_action(arg0: ExecutedAction, arg1: &0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::vault::ProtocolAccessCap) : (u8, vector<u8>) {
        let ExecutedAction {
            action_type : v0,
            payload     : v1,
        } = arg0;
    ...
    public fun execute(arg0: &mut TimelockRegistry, arg1: u64, arg2: &0x2::clock::Clock) : ExecutedAction {
        ...
        0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::floors::assert_timelock_delay(v1 - v0.proposed_at_ms);
    ...
    public fun propose(arg0: &mut TimelockRegistry, arg1: &0xfda1e060539599ba4792a9a5ded85e80f1ffe580fb3910a4db5fa4c3a82dbaff::vault::AdminCap, arg2: u8, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) : u64 {
