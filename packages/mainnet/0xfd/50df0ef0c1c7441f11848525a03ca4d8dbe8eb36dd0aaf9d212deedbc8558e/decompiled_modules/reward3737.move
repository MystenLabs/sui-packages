module 0xfd50df0ef0c1c7441f11848525a03ca4d8dbe8eb36dd0aaf9d212deedbc8558e::reward3737 {
    struct REWARD3737 has drop {
        dummy_field: bool,
    }

    struct TICKET_3737 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3737(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3737>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3737>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3737, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3737>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3737>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3737>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3737>>(v5, 0x2::tx_context::sender(arg1));
    }
