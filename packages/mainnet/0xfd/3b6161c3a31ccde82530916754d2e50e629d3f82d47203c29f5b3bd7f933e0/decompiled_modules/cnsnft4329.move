module 0xfd3b6161c3a31ccde82530916754d2e50e629d3f82d47203c29f5b3bd7f933e0::cnsnft4329 {
    struct CNSNFT4329 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4329, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4329>(arg0, arg1);
