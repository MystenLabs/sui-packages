module 0xfd80df117419d2f04761f7c9dd1cdad9c7c71c554d8f16591e7be0a8d2435b12::reward4871 {
    struct REWARD4871 has drop {
        dummy_field: bool,
    }

    struct TICKET_4871 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4871(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4871>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4871>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4871, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4871>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4871>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4871>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4871>>(v5, 0x2::tx_context::sender(arg1));
    }
