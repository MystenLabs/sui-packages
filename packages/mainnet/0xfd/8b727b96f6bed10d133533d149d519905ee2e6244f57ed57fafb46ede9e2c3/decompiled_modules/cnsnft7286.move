module 0xfd8b727b96f6bed10d133533d149d519905ee2e6244f57ed57fafb46ede9e2c3::cnsnft7286 {
    struct CNSNFT7286 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7286, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7286>(arg0, arg1);
