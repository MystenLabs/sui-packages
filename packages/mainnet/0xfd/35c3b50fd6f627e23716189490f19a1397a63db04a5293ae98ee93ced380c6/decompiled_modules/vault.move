module 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::vault {
    ...
    struct Vault<phantom T0, phantom T1> has key {
        ...
        time_locked_profit: 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::TimeLockedBalance<T0>,
    ...
    public(friend) fun new<T0, T1>(arg0: 0x2::coin::TreasuryCap<T1>, arg1: &mut 0x2::tx_context::TxContext) : AdminCap<T1> {
        let v0 = Vault<T0, T1>{
            ...
            time_locked_profit               : 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::create<T0>(0x2::balance::zero<T0>(), 0, 0),
            lp_treasury                      : arg0,
    ...
    public fun calc_rebalance_amounts<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0x2::clock::Clock) : RebalanceAmounts {
        ...
        let v4 = 0 + 0x2::balance::value<T0>(&arg0.free_balance) + 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::max_withdrawable<T0>(&arg0.time_locked_profit, arg1);
        let v5 = 0;
        ...
        while (v11) {
            ...
            while (v12 < 0x1::vector::length<u64>(&v2)) {
                ...
                let v20 = 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::util::muldiv(v9, v16.target_alloc_weight_bps, v10);
        ...
        while (v21 < 0x1::vector::length<u64>(&v2)) {
            ...
            let v27 = 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::util::muldiv(v9, v24.target_alloc_weight_bps, v10);
            if (v27 >= v24.borrowed) {
        ...
        while (v28 < 0x1::vector::length<u64>(&v3)) {
            ...
            let v34 = 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::util::muldiv(v9, v31.target_alloc_weight_bps, v10);
            if (v34 >= v31.borrowed) {
    ...
    public fun deposit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        if (0x2::coin::total_supply<T1>(&arg0.lp_treasury) == 0) {
            0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.time_locked_profit, 0, arg2);
            0x2::balance::join<T0>(&mut arg0.free_balance, 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::skim_extraneous_balance<T0>(&mut arg0.time_locked_profit));
            0x2::balance::join<T0>(&mut arg0.free_balance, 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::withdraw_all<T0>(&mut arg0.time_locked_profit, arg2));
        ...
        let v2 = if (v1 == 0) {
            ...
            0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::util::muldiv(0x2::coin::total_supply<T1>(&arg0.lp_treasury), 0x2::balance::value<T0>(&arg1), v1)
        };
    ...
    fun event_get_time_locked_profit_state<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0x2::clock::Clock) : EventTimeLockedProfitState {
        EventTimeLockedProfitState{
            max_withdrawable         : 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::max_withdrawable<T0>(&arg0.time_locked_profit, arg1),
            remaining_unlock         : 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::remaining_unlock<T0>(&arg0.time_locked_profit, arg1),
            extraneous_locked_amount : 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::extraneous_locked_amount<T0>(&arg0.time_locked_profit),
            unlock_per_second        : 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::unlock_per_second<T0>(&arg0.time_locked_profit),
        }
    }
    ...
    public(friend) fun strategy_hand_over_profit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultAccess, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        ...
        let v1 = 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::util::muldiv(0x2::balance::value<T0>(&arg2), arg0.performance_fee_bps, 10000);
        if (v1 > 0) {
            0x2::balance::join<T1>(&mut arg0.performance_fee_balance, 0x2::coin::mint_balance<T1>(&mut arg0.lp_treasury, 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::util::muldiv(0x2::coin::total_supply<T1>(&arg0.lp_treasury), v1, total_available_balance<T0, T1>(arg0, arg3) - v1)));
        };
        0x2::balance::join<T0>(&mut arg0.free_balance, 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::withdraw_all<T0>(&mut arg0.time_locked_profit, arg3));
        0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.time_locked_profit, 0, arg3);
        let v2 = 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::skim_extraneous_balance<T0>(&mut arg0.time_locked_profit);
        0x2::balance::join<T0>(&mut v2, arg2);
        0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::change_unlock_start_ts_sec<T0>(&mut arg0.time_locked_profit, 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::util::timestamp_sec(arg3), arg3);
        0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.time_locked_profit, 0x2::math::divide_and_round_up(0x2::balance::value<T0>(&v2), arg0.profit_unlock_duration_sec), arg3);
        0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::top_up<T0>(&mut arg0.time_locked_profit, v2, arg3);
    ...
    public fun total_available_balance<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        let v0 = 0 + 0x2::balance::value<T0>(&arg0.free_balance) + 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::max_withdrawable<T0>(&arg0.time_locked_profit, arg1);
        let v1 = 0;
        while (v1 < 0x2::vec_map::size<0x2::object::ID, StrategyState>(&arg0.strategies)) {
    ...
    public fun withdraw<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T1>, arg2: &0x2::clock::Clock) : WithdrawTicket<T0, T1> {
        ...
        0x2::balance::join<T0>(&mut arg0.free_balance, 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::time_locked_balance::withdraw_all<T0>(&mut arg0.time_locked_profit, arg2));
        let v2 = 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::util::muldiv(0x2::balance::value<T1>(&v1.lp_to_burn), total_available_balance<T0, T1>(arg0, arg2), 0x2::coin::total_supply<T1>(&arg0.lp_treasury));
        ...
        while (v13 < 0x1::vector::length<0x2::object::ID>(&arg0.strategy_withdraw_priority_order)) {
            ...
            let v16 = 0xfd35c3b50fd6f627e23716189490f19a1397a63db04a5293ae98ee93ced380c6::util::muldiv(0x2::vec_map::get<0x2::object::ID, StrategyState>(&arg0.strategies, v14).borrowed - v15.to_withdraw, v4, v5);
