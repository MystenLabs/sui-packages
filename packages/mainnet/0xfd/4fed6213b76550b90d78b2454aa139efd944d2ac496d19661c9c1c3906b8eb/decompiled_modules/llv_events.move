module 0x40746fcb81cdb8933f3c6101a0ed53f93e27a8d628c23dbaceb264a97c48e1c4::llv_events {
    ...
    struct Withdrawn has copy, drop {
        ...
        shares_burned: u128,
        amount_received: u64,
        recall: vector<0x40746fcb81cdb8933f3c6101a0ed53f93e27a8d628c23dbaceb264a97c48e1c4::llv_allocation_plan::ProtocolAmount>,
        timestamp_ms: u64,
    }

    struct BalancesSynced has copy, drop {
        pool_id: 0x2::object::ID,
        balances: vector<0x40746fcb81cdb8933f3c6101a0ed53f93e27a8d628c23dbaceb264a97c48e1c4::llv_allocation_plan::ProtocolAmount>,
        total_assets: u128,
        timestamp_ms: u64,
    }
    ...
    struct Rebalanced has copy, drop {
        ...
        withdraw_details: vector<0x40746fcb81cdb8933f3c6101a0ed53f93e27a8d628c23dbaceb264a97c48e1c4::llv_allocation_plan::ProtocolAmount>,
        deposit_details: vector<0x40746fcb81cdb8933f3c6101a0ed53f93e27a8d628c23dbaceb264a97c48e1c4::llv_allocation_plan::ProtocolAmount>,
        timestamp_ms: u64,
    }
    ...
    public(friend) fun emit_balances_synced(arg0: 0x2::object::ID, arg1: vector<0x40746fcb81cdb8933f3c6101a0ed53f93e27a8d628c23dbaceb264a97c48e1c4::llv_allocation_plan::ProtocolAmount>, arg2: u128, arg3: u64) {
    ...
    public(friend) fun emit_deposited(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u128, arg4: vector<0x40746fcb81cdb8933f3c6101a0ed53f93e27a8d628c23dbaceb264a97c48e1c4::llv_allocation_plan::ProtocolAmount>, arg5: u64) {
        let v0 = Deposited{
            pool_id       : arg0,
            user          : arg1,
            amount        : arg2,
    ...
    public(friend) fun emit_rebalanced(arg0: 0x2::object::ID, arg1: address, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u128, arg7: u128, arg8: vector<0x40746fcb81cdb8933f3c6101a0ed53f93e27a8d628c23dbaceb264a97c48e1c4::llv_allocation_plan::ProtocolAmount>, arg9: vector<0x40746fcb81cdb8933f3c6101a0ed53f93e27a8d628c23dbaceb264a97c48e1c4::llv_allocation_plan::ProtocolAmount>, arg10: u64) {
        let v0 = Rebalanced{
            pool_id             : arg0,
            caller              : arg1,
    ...
    public(friend) fun emit_withdrawn(arg0: 0x2::object::ID, arg1: address, arg2: u128, arg3: u64, arg4: vector<0x40746fcb81cdb8933f3c6101a0ed53f93e27a8d628c23dbaceb264a97c48e1c4::llv_allocation_plan::ProtocolAmount>, arg5: u64) {
        let v0 = Withdrawn{
            pool_id         : arg0,
            user            : arg1,
            shares_burned   : arg2,
