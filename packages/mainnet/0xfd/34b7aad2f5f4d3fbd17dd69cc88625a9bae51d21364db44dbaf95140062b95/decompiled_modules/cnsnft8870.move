module 0xfd34b7aad2f5f4d3fbd17dd69cc88625a9bae51d21364db44dbaf95140062b95::cnsnft8870 {
    struct CNSNFT8870 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8870, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8870>(arg0, arg1);
