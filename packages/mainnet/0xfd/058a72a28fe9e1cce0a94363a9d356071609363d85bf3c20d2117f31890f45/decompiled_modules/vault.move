module 0xfd058a72a28fe9e1cce0a94363a9d356071609363d85bf3c20d2117f31890f45::vault {
    ...
    struct GgSuiVault has key {
        id: 0x2::object::UID,
        ggsui_kraft_cap: 0x2::coin::TreasuryCap<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>,
    ...
    public fun claim_collected_lsd_fee(arg0: &mut GgSuiVault, arg1: &mut 0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::honey_yield::FeeCollector<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 9002);
        let v0 = LsdFeeCollected{amt: 0x2::balance::value<0x2::sui::SUI>(&arg0.protocol_fee_vault)};
        0x2::event::emit<LsdFeeCollected>(v0);
        0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::honey_yield::collect_fee_for_coin<0x2::sui::SUI>(arg1, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.protocol_fee_vault));
    }
    ...
    public fun emergency_pause_update(arg0: &GgSuiAdminCap, arg1: &mut GgSuiVault, arg2: bool) {
    ...
    public fun get_ggsui_by_sui(arg0: &GgSuiVault, arg1: u64) : u64 {
        ...
        (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div_u256((arg1 as u256), (arg0.ggsui_supply as u256), (v0 as u256)) as u64)
    }
    ...
    fun get_sui_amount(arg0: &0x3::staking_pool::PoolTokenExchangeRate, arg1: u64) : u64 {
        ...
        (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div_u256((v0 as u256), (arg1 as u256), (v1 as u256)) as u64)
    }
    ...
    public fun get_sui_by_ggsui(arg0: &GgSuiVault, arg1: u64) : u64 {
        ...
        (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div_u256((v0 as u256), (arg1 as u256), (arg0.ggsui_supply as u256)) as u64)
    }
    ...
    public fun get_sui_claimable_per_ggsui(arg0: &GgSuiVault) : u128 {
        ...
        (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div_u256((v0 as u256), (1000000000 as u256), (v1 as u256)) as u128)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GgSuiAdminCap{id: 0x2::object::new(arg0)};
        0x2::transfer::public_transfer<GgSuiAdminCap>(v0, 0x2::tx_context::sender(arg0));
        let v1 = RedeemFeeDiscCap{id: 0x2::object::new(arg0)};
        0x2::transfer::public_transfer<RedeemFeeDiscCap>(v1, 0x2::tx_context::sender(arg0));
    }

    public fun init_vault(arg0: 0x2::coin::TreasuryCap<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = ConfigParams{
            pause_stake           : false,
    ...
    fun internal_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut GgSuiVault, arg2: 0x2::balance::Balance<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(arg1.version == 1, 9002);
        assert!(!arg1.config_params.pause_stake, 9003);
        update_accrued_rewards(arg1, arg0, arg4);
        let v0 = get_sui_by_ggsui(arg1, 0x2::balance::value<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>(&arg2));
        let v1 = 0x2::balance::value<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>(&arg2);
        let v2 = 0x2::balance::zero<0x2::sui::SUI>();
        let v3 = 0x1::string::utf8(b"sui_to_return_val");
        0x1::debug::print<0x1::string::String>(&v3);
        0x1::debug::print<u64>(&v0);
        let v4 = 0x1::string::utf8(b"ggsui_to_burn");
        0x1::debug::print<0x1::string::String>(&v4);
        0x1::debug::print<u64>(&v1);
        let v5 = 0x1::string::utf8(b"vault.sui_to_stake");
        0x1::debug::print<0x1::string::String>(&v5);
        let v6 = 0x2::balance::value<0x2::sui::SUI>(&arg1.sui_to_stake);
        0x1::debug::print<u64>(&v6);
        let v7 = 0x1::string::utf8(b"sui_to_return (before getting SUI from vault.sui_to_stake)");
        0x1::debug::print<0x1::string::String>(&v7);
        let v8 = 0x2::balance::value<0x2::sui::SUI>(&v2);
        0x1::debug::print<u64>(&v8);
        if (0x2::balance::value<0x2::sui::SUI>(&arg1.sui_to_stake) > v0) {
            0x2::balance::join<0x2::sui::SUI>(&mut v2, 0x2::balance::split<0x2::sui::SUI>(&mut arg1.sui_to_stake, v0));
        } else {
            0x2::balance::join<0x2::sui::SUI>(&mut v2, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg1.sui_to_stake));
        };
        let v9 = 0x1::string::utf8(b"sui_to_return (after getting SUI from vault.sui_to_stake)");
        0x1::debug::print<0x1::string::String>(&v9);
        let v10 = 0x2::balance::value<0x2::sui::SUI>(&v2);
        0x1::debug::print<u64>(&v10);
        let v11 = v0 - 0x2::balance::value<0x2::sui::SUI>(&v2);
        let v12 = 0x1::string::utf8(b"rem_sui_to_unstake");
        0x1::debug::print<0x1::string::String>(&v12);
        0x1::debug::print<u64>(&v11);
        if (v11 > 0) {
            assert!(arg1.config_params.unstake_delay_epoches == 0, 9014);
            let v13 = unstake_sui_from_validators(arg1, arg0, v11, arg4);
            0x2::balance::join<0x2::sui::SUI>(&mut v2, v13);
        };
        let v14 = 0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div(v0, arg3, 10000);
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.addon_staking_rewards, 0x2::balance::split<0x2::sui::SUI>(&mut v2, v14));
        0x2::coin::burn<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>(&mut arg1.ggsui_kraft_cap, 0x2::coin::from_balance<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>(arg2, arg4));
        arg1.ggsui_supply = 0x2::coin::total_supply<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>(&arg1.ggsui_kraft_cap);
        let v15 = get_sui_claimable_per_ggsui(arg1);
        arg1.sui_claimable_per_ggsui = v15;
        let v16 = UserUnstakedInstantly{
            owner                   : 0x2::tx_context::sender(arg4),
            sui_withdrawn           : v0,
            ggsui_burnt             : v1,
            redemption_fees         : v14,
            sui_claimable_per_ggsui : v15,
            cur_epoch               : 0x2::tx_context::epoch(arg4),
        };
        0x2::event::emit<UserUnstakedInstantly>(v16);
        v2
    }
    ...
    public fun process_stake_sui_requests(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut GgSuiVault, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1::string::utf8(b"active_validators");
        0x1::debug::print<0x1::string::String>(&v2);
        0x1::debug::print<vector<address>>(&v1);
        let (v3, v4) = stake_user_selected_validators(arg0, arg1, v1, arg2);
        let v5 = v4;
        let v6 = v3;
        let v7 = 0x1::string::utf8(b"total_sui_staked");
        0x1::debug::print<0x1::string::String>(&v7);
        0x1::debug::print<u64>(&v6);
        let v8 = 0x1::string::utf8(b"remaining_sui");
        ...
        let (v10, v11) = process_unstaking_requests(arg1, arg2);
        let v12 = v10 + v11;
        let v13 = 0x2::balance::zero<0x2::sui::SUI>();
        let v14 = if (v12 <= 0x2::balance::value<0x2::sui::SUI>(&arg1.sui_to_stake)) {
            0x2::balance::join<0x2::sui::SUI>(&mut v13, 0x2::balance::split<0x2::sui::SUI>(&mut arg1.sui_to_stake, v12));
            0
        } else {
            let v14 = v12 - 0x2::balance::value<0x2::sui::SUI>(&arg1.sui_to_stake);
            0x2::balance::join<0x2::sui::SUI>(&mut v13, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg1.sui_to_stake));
            v14
        };
        if (v14 > 0) {
            let v15 = unstake_sui_from_validators(arg1, arg0, v14, arg2);
            0x2::balance::join<0x2::sui::SUI>(&mut v13, v15);
        };
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.unstaked_sui_reserve, 0x2::balance::split<0x2::sui::SUI>(&mut v13, v10));
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.protocol_fee_vault, 0x2::balance::split<0x2::sui::SUI>(&mut v13, v11));
        arg1.uncollected_protocol_fees = 0;
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.sui_to_stake, v13);
        let v16 = 0x1::string::utf8(b"staking SUI to all validators");
        0x1::debug::print<0x1::string::String>(&v16);
        let v17 = 0x1::string::utf8(b"vault.whitelisted_validators");
        0x1::debug::print<0x1::string::String>(&v17);
        let v18 = 0x1::vector::length<address>(&arg1.whitelisted_validators);
        ...
        if (0x2::balance::value<0x2::sui::SUI>(&arg1.sui_to_stake) > 0x1::vector::length<address>(&arg1.whitelisted_validators) * 1000000000) {
            let v19 = 0;
            let v20 = 0;
            while (v20 < 0x1::vector::length<address>(&arg1.whitelisted_validators)) {
                let v21 = *0x1::vector::borrow<address>(&arg1.whitelisted_validators, v20);
                let v22 = 0x1::string::utf8(b"validator_addr");
                0x1::debug::print<0x1::string::String>(&v22);
                0x1::debug::print<address>(&v21);
                if (0x1::vector::contains<address>(&v1, &v21)) {
                    v19 = v19 + 1;
                };
                v20 = v20 + 1;
            };
            assert!(v19 > 0, 9009);
            let v23 = 0x2::balance::value<0x2::sui::SUI>(&arg1.sui_to_stake) / v19;
            let v24 = 0x1::string::utf8(b"sui_to_stake_per_val_amt");
            0x1::debug::print<0x1::string::String>(&v24);
            0x1::debug::print<u64>(&v23);
            if (v23 > 1000000000) {
                let v25 = 0;
                while (v25 < 0x1::vector::length<address>(&arg1.whitelisted_validators) - 1) {
                    let v26 = *0x1::vector::borrow<address>(&arg1.whitelisted_validators, v25);
                    if (0x1::vector::contains<address>(&v1, &v26)) {
                        let v27 = 0x2::balance::split<0x2::sui::SUI>(&mut arg1.sui_to_stake, v23);
                        let v28 = v6;
                        v6 = v28 + v23;
                        stake_with_validator(arg0, arg1, v26, v27, arg2);
                    };
                    v25 = v25 + 1;
                };
                let v29 = *0x1::vector::borrow<address>(&arg1.whitelisted_validators, v25);
                if (0x1::vector::contains<address>(&v1, &v29)) {
                    let v30 = 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg1.sui_to_stake);
                    let v31 = v6;
                    v6 = v31 + 0x2::balance::value<0x2::sui::SUI>(&v30);
                    stake_with_validator(arg0, arg1, v29, v30, arg2);
                };
            };
        };
        arg1.sui_claimable_per_ggsui = get_sui_claimable_per_ggsui(arg1);
        let v32 = StakeSuiRequestsProcessed{
            cur_epoch                    : v0,
            total_sui_staked             : v6,
            sui_to_unstaked_for_requests : v10,
            protocol_fee_collected       : v11,
            sui_claimable_per_ggsui      : get_sui_claimable_per_ggsui(arg1),
        };
        0x2::event::emit<StakeSuiRequestsProcessed>(v32);
    }
    ...
    public fun query_all_selected_validator_mapping(arg0: &GgSuiVault, arg1: 0x1::option::Option<address>, arg2: u64) : SelectedValidatorMappingInfo {
    ...
    public fun query_request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut GgSuiVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        (v0, 0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div(v0, arg1.config_params.redeem_fee_bps, 10000))
    }
    ...
    public fun query_unstake_request_for_epoch(arg0: &GgSuiVault, arg1: u64) : UnstakeRequestInfo {
    ...
    public fun query_unstake_request_for_epochs(arg0: &GgSuiVault, arg1: 0x1::option::Option<u64>, arg2: u64) : UnstakeRequestsInfo {
    ...
    public fun query_validator_pool(arg0: &GgSuiVault, arg1: address) : ValidatorPoolInfo {
    ...
    public fun query_validator_pools(arg0: &GgSuiVault, arg1: 0x1::option::Option<address>, arg2: u64) : ValidatorPoolInfoList {
    ...
    public fun query_vault_config(arg0: &GgSuiVault) : VaultConfig {
        VaultConfig{
    ...
    public fun query_vault_overview(arg0: &GgSuiVault) : VaultOverview {
        VaultOverview{
    ...
    public fun request_delayed_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut GgSuiVault, arg2: 0x2::balance::Balance<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>, arg3: &mut 0x2::tx_context::TxContext) : UnstakeRequest {
        assert!(arg1.version == 1, 9002);
        assert!(!arg1.config_params.pause_stake, 9003);
        let v0 = 0x2::tx_context::epoch(arg3);
        update_accrued_rewards(arg1, arg0, arg3);
        let v1 = get_sui_by_ggsui(arg1, 0x2::balance::value<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>(&arg2));
        ...
        let v4 = UnstakeRequest{
            ...
            ggsui_amount       : 0x2::balance::value<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>(&arg2),
            sui_amount         : v1,
            requested_at_epoch : v0,
        };
        0x2::coin::burn<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>(&mut arg1.ggsui_kraft_cap, 0x2::coin::from_balance<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>(arg2, arg3));
        arg1.ggsui_supply = 0x2::coin::total_supply<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>(&arg1.ggsui_kraft_cap);
    ...
    public fun request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut GgSuiVault, arg2: 0x2::balance::Balance<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = arg1.config_params.redeem_fee_bps;
        internal_instant_unstake(arg0, arg1, arg2, v0, arg3)
    }

    public fun request_instant_unstake_disc(arg0: &RedeemFeeDiscCap, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut GgSuiVault, arg3: 0x2::balance::Balance<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
    ...
    fun sort_vals_in_decreasing_order(arg0: &GgSuiVault) : vector<address> {
        ...
        while (0x1::option::is_some<address>(&v2)) {
            let v3 = *0x1::option::borrow<address>(&v2);
            let v4 = 0x1::string::utf8(b"validator_addr");
            0x1::debug::print<0x1::string::String>(&v4);
        ...
        let v5 = 0x1::vector::length<address>(&v0);
        let v6 = 0;
        while (v6 < v5) {
            let v7 = v6 + 1;
            while (v7 < v5) {
                if (*0x1::vector::borrow<u64>(&v1, v7) > *0x1::vector::borrow<u64>(&v1, v6)) {
                    0x1::vector::swap<u64>(&mut v1, v6, v7);
                    0x1::vector::swap<address>(&mut v0, v6, v7);
                };
                v7 = v7 + 1;
            };
            v6 = v6 + 1;
    ...
    public fun stake_sui_request(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut GgSuiVault, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI> {
        assert!(arg1.version == 1, 9002);
        assert!(!arg1.config_params.pause_stake, 9003);
        update_accrued_rewards(arg1, arg0, arg4);
        ...
        0x2::coin::mint_balance<0xad6250f65de431428516f8e0d2e28dcf1a2e6da5681b39fe2e99215c46a2becf::ggsui::GGSUI>(&mut arg1.ggsui_kraft_cap, v1)
    }
    ...
    fun stake_with_validator(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut GgSuiVault, arg2: address, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::string::utf8(b"stake_with_validator");
        0x1::debug::print<0x1::string::String>(&v0);
        0x1::debug::print<address>(&arg2);
        let v1 = 0x1::string::utf8(b"sui_to_stake_amt");
        0x1::debug::print<0x1::string::String>(&v1);
        let v2 = 0x2::balance::value<0x2::sui::SUI>(&arg3);
        0x1::debug::print<u64>(&v2);
        let v3 = 0x2::balance::value<0x2::sui::SUI>(&arg3);
        let v4 = 0x2::tx_context::epoch(arg4);
        let v5 = 0x3::sui_system::request_add_stake_non_entry(arg0, 0x2::coin::from_balance<0x2::sui::SUI>(arg3, arg4), arg2, arg4);
        if (!0x2::linked_table::contains<address, ValidatorPool>(&arg1.validator_pools, arg2)) {
            let v6 = 0x3::staking_pool::pool_id(&v5);
            let v7 = ValidatorPool{
                staking_pool_id   : v6,
                ...
                exchange_rate     : *0x2::table::borrow<u64, 0x3::staking_pool::PoolTokenExchangeRate>(0x3::sui_system::pool_exchange_rates(arg0, &v6), v4),
                total_sui_amount  : 0,
                extra_fields      : 0x2::bag::new(arg4),
            };
            0x2::linked_table::push_back<address, ValidatorPool>(&mut arg1.validator_pools, arg2, v7);
        };
        let v8 = 0x2::linked_table::borrow_mut<address, ValidatorPool>(&mut arg1.validator_pools, arg2);
        v8.total_sui_amount = v8.total_sui_amount + v3;
        arg1.total_sui_supply = arg1.total_sui_supply + v3;
        if (0x3::staking_pool::stake_activation_epoch(&v5) <= v4) {
            join_fungible_staked_sui_to_validator(arg1, arg2, 0x3::sui_system::convert_to_fungible_staked_sui(arg0, v5, arg4));
        } else if (0x1::option::is_some<0x3::staking_pool::StakedSui>(&v8.inactive_stake)) {
            0x3::staking_pool::join_staked_sui(0x1::option::borrow_mut<0x3::staking_pool::StakedSui>(&mut v8.inactive_stake), v5);
        } else {
            0x1::option::fill<0x3::staking_pool::StakedSui>(&mut v8.inactive_stake, v5);
        };
        refresh_validator_info(arg1, arg2);
        let v9 = StakeOperationProcessed{
            validator_addr   : arg2,
            sui_to_stake_amt : v3,
            cur_epoch        : 0x2::tx_context::epoch(arg4),
        };
        0x2::event::emit<StakeOperationProcessed>(v9);
    }
    ...
    fun unstake_from_inactive_stake(arg0: &mut GgSuiVault, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v1 = 0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::max_u64(arg3, 1000000000);
    ...
    fun unstake_sui_from_validators(arg0: &mut GgSuiVault, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        let v2 = 0x1::string::utf8(b"validator_addr_list");
        0x1::debug::print<0x1::string::String>(&v2);
        0x1::debug::print<vector<address>>(&v0);
        let v3 = 0x1::string::utf8(b"active_pools_count");
        0x1::debug::print<0x1::string::String>(&v3);
        0x1::debug::print<u64>(&v1);
        let v4 = 0;
        while (v4 < v1 && 0x2::balance::value<0x2::sui::SUI>(&arg0.unstaked_sui_reserve) < arg2) {
            let v5 = *0x1::vector::borrow<address>(&v0, v4);
            let v6 = 0x2::balance::value<0x2::sui::SUI>(&arg0.unstaked_sui_reserve);
            let v7 = 0x1::string::utf8(b"validator_addr");
            0x1::debug::print<0x1::string::String>(&v7);
            0x1::debug::print<address>(&v5);
            let v8 = 0x1::string::utf8(b"unstaked_sui_reserve_amt");
            0x1::debug::print<0x1::string::String>(&v8);
            0x1::debug::print<u64>(&v6);
            let v9 = 0x1::string::utf8(b"sui_to_unstake");
            0x1::debug::print<0x1::string::String>(&v9);
            0x1::debug::print<u64>(&arg2);
            let v10 = arg2 - v6 + 1;
            let v11 = 0x1::string::utf8(b"sui_to_unstake - unstaked_sui_reserve_amt + 1");
            0x1::debug::print<0x1::string::String>(&v11);
            0x1::debug::print<u64>(&v10);
            unstake_from_inactive_stake(arg0, arg1, v5, v10, arg3);
            v4 = v4 + 1;
        };
        v4 = 0;
        while (v4 < v1 && 0x2::balance::value<0x2::sui::SUI>(&arg0.unstaked_sui_reserve) < arg2) {
            let v12 = arg2 - 0x2::balance::value<0x2::sui::SUI>(&arg0.unstaked_sui_reserve) + 1;
            unstake_from_active_stake(arg0, arg1, *0x1::vector::borrow<address>(&v0, v4), v12, arg3);
            v4 = v4 + 1;
        };
        let v13 = *0x2::linked_table::front<address, 0x2::balance::Balance<0x2::sui::SUI>>(&arg0.selected_validator_mapping);
        while (0x1::option::is_some<address>(&v13) && 0x2::balance::value<0x2::sui::SUI>(&arg0.unstaked_sui_reserve) < arg2) {
            let v14 = *0x1::option::borrow<address>(&v13);
            let v15 = 0x2::linked_table::borrow_mut<address, 0x2::balance::Balance<0x2::sui::SUI>>(&mut arg0.selected_validator_mapping, v14);
            if (0x2::balance::value<0x2::sui::SUI>(v15) > arg2) {
                0x2::balance::join<0x2::sui::SUI>(&mut arg0.unstaked_sui_reserve, 0x2::balance::split<0x2::sui::SUI>(v15, arg2));
            } else {
                0x2::balance::join<0x2::sui::SUI>(&mut arg0.unstaked_sui_reserve, 0x2::balance::withdraw_all<0x2::sui::SUI>(v15));
            };
            v13 = *0x2::linked_table::next<address, 0x2::balance::Balance<0x2::sui::SUI>>(&arg0.selected_validator_mapping, v14);
        };
    ...
    public fun update_accrued_rewards(arg0: &mut GgSuiVault, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 9002);
        ...
        if (refresh_validator_pools(arg0, arg1, arg2)) {
            ...
            let v2 = 0;
            if (v1 > v0) {
                v2 = (0x646d212029e205b6aa17b7e85e57a127515f92d8efd1ff881df95e93365fd527::math::mul_div_u256(((v1 - v0) as u256), (arg0.config_params.protocol_fee_percent as u256), (10000 as u256)) as u64);
            };
    ...
    public fun update_ggsui_fee_config(arg0: &GgSuiAdminCap, arg1: &mut GgSuiVault, arg2: u64, arg3: u64, arg4: u64) {
        assert!(arg1.version == 1, 9002);
        if (arg2 > 0 && arg2 < 2500) {
    ...
    public fun update_validator_list(arg0: &GgSuiAdminCap, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut GgSuiVault, arg3: vector<address>, arg4: bool) {
