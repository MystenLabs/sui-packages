module 0xfddad9f6f826feff76d330d4b74c917e75e8a7979ff0d54886e6fd0fb71c6965::_seal_early_contributor {
    struct _SEAL_EARLY_CONTRIBUTOR has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _SEAL_EARLY_CONTRIBUTOR, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_SEAL_EARLY_CONTRIBUTOR>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b" Seal Early Contributor"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This exclusive Seal Early Contributor badge is part of a limited collection..."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibtslreaag7gs5ntjwohdeffhx2vxcaxfec3iengu24drdb65criu"));
