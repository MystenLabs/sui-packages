module 0xfd4a8ff146e621c610fe2f8b808bc41765793bf451d940e92c4a4392cd5f57e5::cnsnft1988 {
    struct CNSNFT1988 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1988, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7848"));
        let v4 = 0x2::package::claim<CNSNFT1988>(arg0, arg1);
