module 0xfd062387bc05371163cb305b64843c6dfd304ba16b299954213176fe48087332::game {
    ...
    struct GameInfo has key {
        id: 0x2::object::UID,
        version: u8,
        balance: 0x2::balance::Balance<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>,
        init_reward: u64,
    ...
    entry fun add_treasury_cap(arg0: &OwnerCap, arg1: &mut GameInfo, arg2: 0x2::coin::TreasuryCap<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>) {
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::TreasuryCap<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>>(&mut arg1.id, 0x1::string::utf8(b"treasury"), arg2);
    }
    ...
    entry fun create_village(arg0: &mut GameInfo, arg1: 0x1::string::String, arg2: address, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = Village{
            ...
            village_id     : arg1,
            balance        : 0x2::balance::zero<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(),
            owner          : arg2,
            num_of_members : 1,
        };
    ...
    entry fun join_village(arg0: &mut GameInfo, arg1: 0x1::string::String, arg2: address, arg3: 0x2::coin::Coin<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 2);
        let v0 = 0x2::coin::value<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&arg3);
        assert!(v0 >= arg0.v_join_fee, 8);
        let v1 = if (v0 > arg0.v_join_fee) {
            0x2::pay::keep<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(arg3, arg4);
            0x2::coin::split<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut arg3, arg0.v_join_fee, arg4)
        } else {
            arg3
        };
        0x2::balance::join<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut arg0.balance, 0x2::coin::into_balance<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(v1));
        inner_join_village(arg0, arg1, 0x2::tx_context::sender(arg4), arg2);
    }

    entry fun leave_village(arg0: &mut GameInfo, arg1: 0x2::coin::Coin<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 2);
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x2::dynamic_object_field::exists_<address>(&arg0.id, v0), 5);
        let v1 = 0x2::coin::value<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&arg1);
        assert!(v1 >= arg0.v_leave_fee, 8);
        let v2 = if (v1 > arg0.v_leave_fee) {
            0x2::pay::keep<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(arg1, arg2);
            0x2::coin::split<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut arg1, arg0.v_leave_fee, arg2)
        } else {
            arg1
        };
        0x2::balance::join<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut arg0.balance, 0x2::coin::into_balance<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(v2));
    ...
    entry fun remove_treasury_cap(arg0: &OwnerCap, arg1: &mut GameInfo, arg2: &0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::TreasuryCap<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>>(&mut arg1.id, 0x1::string::utf8(b"treasury")), 0x2::tx_context::sender(arg2));
    }

    fun send_to_village(arg0: &mut GameInfo, arg1: 0x1::string::String, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::dynamic_object_field::exists_<0x1::string::String>(&arg0.id, arg1), 13);
        let v0 = 0x2::balance::value<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&arg0.balance);
        let v1 = 0;
        if (v0 >= arg2) {
            0x2::balance::join<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut 0x2::dynamic_object_field::borrow_mut<0x1::string::String, Village>(&mut arg0.id, arg1).balance, 0x2::balance::split<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut arg0.balance, arg2));
        } else if (v0 > 0) {
            0x2::balance::join<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut 0x2::dynamic_object_field::borrow_mut<0x1::string::String, Village>(&mut arg0.id, arg1).balance, 0x2::balance::withdraw_all<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut arg0.balance));
            v1 = arg2 - v0;
        } else {
            v1 = arg2;
        };
        if (v1 > 0) {
            0x2::balance::join<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut 0x2::dynamic_object_field::borrow_mut<0x1::string::String, Village>(&mut arg0.id, arg1).balance, 0x2::coin::into_balance<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(0x2::coin::mint<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::TreasuryCap<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), v1, arg3)));
        };
    }
    ...
    fun send_tokens(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0;
        if (v0 >= arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>>(0x2::coin::from_balance<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(0x2::balance::split<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut arg0.balance, arg2), arg3), arg1);
        } else if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>>(0x2::coin::from_balance<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(0x2::balance::withdraw_all<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut arg0.balance), arg3), arg1);
            v1 = arg2 - v0;
        } else {
            v1 = arg2;
        };
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>>(0x2::coin::mint<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::TreasuryCap<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), v1, arg3), arg1);
        };
    }
    ...
    entry fun send_village_token(arg0: &OwnerCap, arg1: &mut GameInfo, arg2: 0x1::string::String, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::balance::value<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&v0.balance);
        assert!(v1 >= arg3, 16);
        if (v1 > arg3) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>>(0x2::coin::from_balance<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(0x2::balance::split<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut v0.balance, arg3), arg5), arg4);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>>(0x2::coin::from_balance<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(0x2::balance::withdraw_all<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut v0.balance), arg5), arg4);
        };
    }
    ...
    entry fun upgrade_boat(arg0: &mut GameInfo, arg1: 0x2::coin::Coin<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 2);
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x2::dynamic_object_field::exists_<address>(&arg0.id, v0), 5);
        ...
        let v4 = 0x2::coin::value<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&arg1);
        assert!(v4 >= v3.price_upgrade, 8);
        let v5 = if (v4 > v3.price_upgrade) {
            0x2::pay::keep<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(arg1, arg2);
            0x2::coin::split<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut arg1, v3.price_upgrade, arg2)
        } else {
            arg1
        };
        0x2::balance::join<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(&mut arg0.balance, 0x2::coin::into_balance<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>(v5));
        v1.boat = v2;
        let v6 = UpgradeLevel{
            type         : 0,
            user_address : v0,
    ...
    entry fun upgrade_mesh(arg0: &mut GameInfo, arg1: 0x2::coin::Coin<0xabfd7466f53d30a7648f72a1084d91b46f2d4e4da80e254c9bcf9efddedcdb5c::ocean::OCEAN>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 2);
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x2::dynamic_object_field::exists_<address>(&arg0.id, v0), 5);
        let v1 = 0x2::dynamic_object_field::borrow_mut<address, User>(&mut arg0.id, v0);
