module 0xfdbbdee4db90e592c7266d08ff7b3248f7d00463a151b76d3dc40e241463095e::simple_nft {
    ...
    public entry fun create_simple_nft(arg0: 0x1::string::String, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = SimpleNFT{
            ...
            image_url   : 0x1::string::utf8(b"https://ccwpidms8429p4fi.public.blob.vercel-storage.com/icora/user/1760614225718_uyy8io.png"),
        };
