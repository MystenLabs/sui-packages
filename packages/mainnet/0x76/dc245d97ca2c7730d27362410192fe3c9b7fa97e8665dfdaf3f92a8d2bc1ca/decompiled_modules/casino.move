module 0x99d3caafe2e4a26d6f8da03773a672190c13da099c1715aac789254046db99f4::casino {
    ...
    struct RoundCommitment<phantom T0> has key {
        id: 0x2::object::UID,
        player: address,
    ...
    struct RoundCommittedEvent has copy, drop {
    ...
    struct RoundRevealedEvent has copy, drop {
        commitment_id: 0x2::object::ID,
        player: address,
        game: u8,
        outcome: u64,
    ...
    struct RoundExpiredEvent has copy, drop {
        commitment_id: 0x2::object::ID,
        player: address,
        game: u8,
        stake: u64,
    ...
    struct BlackjackSettlementCardsEvent has copy, drop {
        session_id: 0x2::object::ID,
        player: address,
        player_cards: vector<u8>,
        dealer_cards: vector<u8>,
    ...
    public entry fun commit_jason_round(arg0: &mut JasonHouse, arg1: &RevenueConfig, arg2: u8, arg3: u8, arg4: bool, arg5: 0x2::coin::Coin<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 2);
        assert!(arg1.recipient == @0xd2cebe8666352e1ddb3dc7f271340432c983fc81017b3d6f7873dd66881433a4 && arg1.fee_bps == 250, 7);
        let v0 = 0x2::coin::value<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&arg5);
        assert!(v0 >= arg0.min_bet && v0 <= arg0.max_bet, 1);
        validate_round(arg2, arg3, arg4);
        let v1 = v0 * arg1.fee_bps / 10000;
        assert!(v1 > 0, 1);
        assert!(0x2::balance::value<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&arg0.vault) >= v0 * worst_case_payout_bps(arg2, arg3, arg4, arg0.max_payout_bps) / 100 + v1, 4);
        let v2 = 0x2::tx_context::sender(arg7);
        let v3 = RoundCommitment<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>{
            id                 : 0x2::object::new(arg7),
            player             : v2,
            stake              : 0x2::coin::into_balance<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(arg5),
            wager              : v0,
            game               : arg2,
            target             : arg3,
            above              : arg4,
            max_payout_bps     : arg0.max_payout_bps,
            reveal_deadline_ms : 0x2::clock::timestamp_ms(arg6) + 300000,
        };
        let v4 = RoundCommittedEvent{
            commitment_id      : 0x2::object::uid_to_inner(&v3.id),
            player             : v2,
            game               : arg2,
            stake              : v0,
            reveal_deadline_ms : v3.reveal_deadline_ms,
        };
        0x2::event::emit<RoundCommittedEvent>(v4);
        0x2::transfer::transfer<RoundCommitment<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>>(v3, v2);
    }

    public entry fun commit_sui_round(arg0: &mut House, arg1: &RevenueConfig, arg2: u8, arg3: u8, arg4: bool, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 2);
        assert!(arg1.recipient == @0xd2cebe8666352e1ddb3dc7f271340432c983fc81017b3d6f7873dd66881433a4 && arg1.fee_bps == 250, 7);
        ...
        let v1 = v0 * arg1.fee_bps / 10000;
        assert!(v1 > 0, 1);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.vault) >= v0 * worst_case_payout_bps(arg2, arg3, arg4, arg0.max_payout_bps) / 100 + v1, 4);
        let v2 = 0x2::tx_context::sender(arg7);
        let v3 = RoundCommitment<0x2::sui::SUI>{
            id                 : 0x2::object::new(arg7),
            player             : v2,
            stake              : 0x2::coin::into_balance<0x2::sui::SUI>(arg5),
            wager              : v0,
            game               : arg2,
            target             : arg3,
            above              : arg4,
        ...
        0x2::event::emit<RoundCommittedEvent>(v4);
        0x2::transfer::transfer<RoundCommitment<0x2::sui::SUI>>(v3, v2);
    }
    ...
    public entry fun expire_jason_round(arg0: RoundCommitment<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>, arg1: &mut JasonHouse, arg2: &RevenueConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg3) > arg0.reveal_deadline_ms, 1);
    ...
    public entry fun expire_sui_round(arg0: RoundCommitment<0x2::sui::SUI>, arg1: &mut House, arg2: &RevenueConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg3) > arg0.reveal_deadline_ms, 1);
        assert!(arg2.recipient == @0xd2cebe8666352e1ddb3dc7f271340432c983fc81017b3d6f7873dd66881433a4 && arg2.fee_bps == 250, 7);
        let RoundCommitment {
            id                 : v0,
        ...
        assert!(v10 <= 0x2::balance::value<0x2::sui::SUI>(&arg1.vault), 4);
        arg1.round = arg1.round + 1;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.vault, v10), arg4), arg2.recipient);
        0x2::object::delete(v9);
        let v11 = RoundExpiredEvent{
            commitment_id : 0x2::object::uid_to_inner(&v9),
            player        : v1,
    ...
    fun forfeit_blackjack_sui(arg0: BlackjackSession, arg1: &mut House, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<BlackjackSettledEvent>(v9);
        let v10 = BlackjackSettlementCardsEvent{
            session_id   : v8,
            player       : v1,
            player_cards : v4,
            dealer_cards : v5,
        };
        0x2::event::emit<BlackjackSettlementCardsEvent>(v10);
    }
    ...
    public entry fun forfeit_jason_blackjack(arg0: JasonBlackjackSession, arg1: &mut JasonHouse, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<BlackjackSettledEvent>(v11);
        let v12 = BlackjackSettlementCardsEvent{
            session_id   : v10,
            player       : v1,
            player_cards : v8,
            dealer_cards : v7,
        };
        0x2::event::emit<BlackjackSettlementCardsEvent>(v12);
    }
    ...
    fun mines_max_payout_bps(arg0: u8) : u64 {
        if (arg0 == 0) {
            150
        } else if (arg0 == 1) {
            300
    ...
    entry fun play_jason_with_revenue(arg0: &mut JasonHouse, arg1: &RevenueConfig, arg2: &0x2::random::Random, arg3: u8, arg4: u8, arg5: bool, arg6: 0x2::coin::Coin<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg3 == 2) {
            ...
            if (v1) {
                ...
                assert!(arg4 <= 2, 3);
            } else if (arg3 == 7 || arg3 == 11) {
                assert!(arg4 >= 2 && arg4 <= 50, 3);
            } else if (arg3 == 8 || arg3 == 12) {
                assert!(arg4 <= 2, 3);
            } else if (arg3 == 9) {
                assert!(arg4 <= 9, 3);
            } else if (arg3 == 14) {
                assert!(arg4 >= 2 && arg4 <= 20, 3);
            };
        };
        let v2 = v0 * arg1.fee_bps / 10000;
        assert!(v2 > 0, 1);
        assert!(0x2::balance::value<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&arg0.vault) >= v0 * worst_case_payout_bps(arg3, arg4, arg5, arg0.max_payout_bps) / 100 + v2, 4);
        ...
        let v4 = &mut v3;
        let (v5, v6, v7) = resolve_round(v4, arg3, arg4, arg5);
        let v8 = if (v7 > arg0.max_payout_bps) {
            arg0.max_payout_bps
        } else {
            v7
        };
        ...
        let v10 = 0x2::balance::value<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&arg0.vault);
        assert!(v9 <= v10, 4);
        assert!(v2 <= v10 - v9, 4);
        arg0.round = arg0.round + 1;
        if (v9 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>>(0x2::coin::from_balance<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(0x2::balance::split<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&mut arg0.vault, v9), arg7), 0x2::tx_context::sender(arg7));
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>>(0x2::coin::from_balance<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(0x2::balance::split<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&mut arg0.vault, v2), arg7), arg1.recipient);
        let v11 = PlayEvent{
        ...
        0x2::event::emit<PlayEvent>(v11);
        let v12 = RevenueEvent{
            player    : 0x2::tx_context::sender(arg7),
        ...
        0x2::event::emit<RevenueEvent>(v12);
    }
    ...
    entry fun play_with_revenue(arg0: &mut House, arg1: &RevenueConfig, arg2: &0x2::random::Random, arg3: u8, arg4: u8, arg5: bool, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0 * arg1.fee_bps / 10000;
        assert!(v2 > 0, 1);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.vault) >= v0 * worst_case_payout_bps(arg3, arg4, arg5, arg0.max_payout_bps) / 100 + v2, 4);
        ...
        let v10 = 0x2::balance::value<0x2::sui::SUI>(&arg0.vault);
        assert!(v9 <= v10, 4);
        assert!(v2 <= v10 - v9, 4);
        arg0.round = arg0.round + 1;
        if (v9 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.vault, v9), arg7), 0x2::tx_context::sender(arg7));
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.vault, v2), arg7), arg1.recipient);
        let v11 = PlayEvent{
            player  : 0x2::tx_context::sender(arg7),
            game    : arg3,
            outcome : v5,
    ...
    fun resolve_baccarat(arg0: &mut 0x2::random::RandomGenerator, arg1: u8) : (u64, bool, u64) {
        let v0 = 0x2::random::generate_u8_in_range(arg0, 0, 9);
        let v1 = 0x2::random::generate_u8_in_range(arg0, 0, 9);
        let v2 = if (v0 > v1) {
            0
        } else if (v1 > v0) {
            1
    ...
    fun resolve_coinflip(arg0: &mut 0x2::random::RandomGenerator, arg1: u8) : (u64, bool, u64) {
        let v0 = 0x2::random::generate_u8_in_range(arg0, 0, 1);
        let v1 = v0 == arg1;
        let v2 = if (v1) {
            196
        } else {
    ...
    fun resolve_crash(arg0: &mut 0x2::random::RandomGenerator, arg1: u8) : (u64, bool, u64) {
        let v0 = 0x2::random::generate_u8_in_range(arg0, 1, 100);
        let v1 = v0 >= arg1;
        let v2 = if (v1) {
            (arg1 as u64) * 100
        } else {
    ...
    fun resolve_hilo(arg0: &mut 0x2::random::RandomGenerator, arg1: u8) : (u64, bool, u64) {
        let v0 = 0x2::random::generate_u8_in_range(arg0, 1, 13);
        let v1 = arg1 == 0 && v0 <= 6 || v0 >= 8;
        let v2 = if (v1) {
            196
        } else {
            0
    ...
    fun resolve_keno(arg0: &mut 0x2::random::RandomGenerator, arg1: u8) : (u64, bool, u64) {
        let v0 = 0x2::random::generate_u8_in_range(arg0, 0, 9);
        let v1 = v0 == arg1;
        let v2 = if (v1) {
            500
    ...
    fun resolve_limbo(arg0: &mut 0x2::random::RandomGenerator, arg1: u8) : (u64, bool, u64) {
        let v0 = 0x2::random::generate_u8_in_range(arg0, 1, 100);
        let v1 = v0 <= arg1;
        let v2 = if (v1) {
            9800 / (arg1 as u64)
    ...
    fun resolve_mines(arg0: &mut 0x2::random::RandomGenerator, arg1: u8) : (u64, bool, u64) {
        let v0 = 0x2::random::generate_u8_in_range(arg0, 0, 99);
        let v1 = arg1 == 0 && v0 >= 25 || arg1 == 1 && v0 >= 50 || v0 >= 75;
        let v2 = if (v1) {
            mines_max_payout_bps(arg1)
        } else {
            0
        };
        ((v0 as u64), v1, v2)
    ...
    fun resolve_range(arg0: &mut 0x2::random::RandomGenerator, arg1: u8) : (u64, bool, u64) {
        let v0 = 0x2::random::generate_u8_in_range(arg0, 0, 100);
        let v1 = v0 >= 50 - arg1 / 2 && v0 <= 50 + arg1 / 2;
        let v2 = if (v1) {
            9800 / (arg1 as u64)
        } else {
            0
    ...
    fun resolve_round(arg0: &mut 0x2::random::RandomGenerator, arg1: u8, arg2: u8, arg3: bool) : (u64, bool, u64) {
        if (arg1 == 0) {
            ...
            let v7 = 0x2::random::generate_u8_in_range(arg0, 0, 11);
            let v8 = wheel_payout(v7);
            ((v7 as u64), v8 > 0, v8)
        } else if (arg1 == 2) {
            let v9 = 0x2::random::generate_u8_in_range(arg0, 1, 100);
            let v10 = arg3 && v9 > arg2 || v9 <= arg2;
            ((v9 as u64), v10, dice_payout(arg2, arg3))
        } else if (arg1 == 3) {
            resolve_blackjack(arg0)
        } else if (arg1 == 4) {
            resolve_plinko(arg0, arg2)
        } else if (arg1 == 5) {
            resolve_coinflip(arg0, arg2)
        } else if (arg1 == 6) {
            resolve_rps(arg0, arg2)
        } else if (arg1 == 7) {
            resolve_limbo(arg0, arg2)
        } else if (arg1 == 8) {
            resolve_mines(arg0, arg2)
        } else if (arg1 == 9) {
            resolve_keno(arg0, arg2)
        } else if (arg1 == 10) {
            resolve_hilo(arg0, arg2)
        } else {
            let (v11, v12, v13) = if (arg1 == 11) {
                let (v14, v15, v16) = resolve_range(arg0, arg2);
                (v16, v14, v15)
            } else {
                let (v17, v18, v19) = if (arg1 == 12) {
                    resolve_tower(arg0, arg2)
                } else if (arg1 == 13) {
                    resolve_baccarat(arg0, arg2)
                } else {
                    resolve_crash(arg0, arg2)
                };
                (v19, v17, v18)
            };
            (v12, v13, v11)
    ...
    fun resolve_rps(arg0: &mut 0x2::random::RandomGenerator, arg1: u8) : (u64, bool, u64) {
        let v0 = 0x2::random::generate_u8_in_range(arg0, 0, 2);
        let v1 = v0 == arg1 || v0 == (arg1 + 2) % 3;
        let v2 = if (v0 == arg1) {
            100
        } else if (v1) {
            294
    ...
    fun resolve_tower(arg0: &mut 0x2::random::RandomGenerator, arg1: u8) : (u64, bool, u64) {
        let v0 = 0x2::random::generate_u8_in_range(arg0, 0, 2);
        let v1 = v0 == arg1;
        let v2 = if (v1) {
            300 + (arg1 as u64) * 100
    ...
    public entry fun reveal_jason_round(arg0: RoundCommitment<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>, arg1: &mut JasonHouse, arg2: &RevenueConfig, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.player == 0x2::tx_context::sender(arg5), 1);
        assert!(0x2::clock::timestamp_ms(arg4) <= arg0.reveal_deadline_ms, 1);
        assert!(arg2.recipient == @0xd2cebe8666352e1ddb3dc7f271340432c983fc81017b3d6f7873dd66881433a4 && arg2.fee_bps == 250, 7);
        settle_jason_commitment(arg0, arg1, arg2, arg3, arg5);
    }

    public entry fun reveal_sui_round(arg0: RoundCommitment<0x2::sui::SUI>, arg1: &mut House, arg2: &RevenueConfig, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.player == 0x2::tx_context::sender(arg5), 1);
        assert!(0x2::clock::timestamp_ms(arg4) <= arg0.reveal_deadline_ms, 1);
        assert!(arg2.recipient == @0xd2cebe8666352e1ddb3dc7f271340432c983fc81017b3d6f7873dd66881433a4 && arg2.fee_bps == 250, 7);
        settle_sui_commitment(arg0, arg1, arg2, arg3, arg5);
    }
    ...
    fun settle_blackjack_jason(arg0: JasonBlackjackSession, arg1: &mut JasonHouse, arg2: &RevenueConfig, arg3: u64, arg4: u64, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = v3 * v10 / 100;
        0x2::balance::join<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&mut arg1.vault, v2);
        let v12 = 0x2::balance::value<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&arg1.vault);
        assert!(v11 <= v12 && v9 <= v12 - v11, 4);
        arg1.round = arg1.round + 1;
        if (v11 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>>(0x2::coin::from_balance<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(0x2::balance::split<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&mut arg1.vault, v11), arg6), v1);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>>(0x2::coin::from_balance<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(0x2::balance::split<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&mut arg1.vault, v9), arg6), arg2.recipient);
        0x2::object::delete(v7);
        let v13 = BlackjackSettledEvent{
            session_id   : v8,
            player       : v1,
            stake        : v3,
            player_total : arg3,
        ...
        0x2::event::emit<BlackjackSettledEvent>(v13);
        let v14 = BlackjackSettlementCardsEvent{
            session_id   : v8,
            player       : v1,
            player_cards : v4,
            dealer_cards : v5,
        };
        0x2::event::emit<BlackjackSettlementCardsEvent>(v14);
        let v15 = RevenueEvent{
            player    : v1,
            recipient : arg2.recipient,
            game      : 3,
            stake     : v3,
        ...
        0x2::event::emit<RevenueEvent>(v15);
    }
    ...
    fun settle_blackjack_sui(arg0: BlackjackSession, arg1: &mut House, arg2: &RevenueConfig, arg3: u64, arg4: u64, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = v3 * v10 / 100;
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.vault, v2);
        let v12 = 0x2::balance::value<0x2::sui::SUI>(&arg1.vault);
        assert!(v11 <= v12 && v9 <= v12 - v11, 4);
        arg1.round = arg1.round + 1;
        if (v11 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.vault, v11), arg6), v1);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.vault, v9), arg6), arg2.recipient);
        0x2::object::delete(v7);
        let v13 = BlackjackSettledEvent{
            session_id   : v8,
            player       : v1,
    ...
    fun settle_jason_commitment(arg0: RoundCommitment<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>, arg1: &mut JasonHouse, arg2: &RevenueConfig, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        let RoundCommitment {
            id                 : v0,
            player             : v1,
            stake              : v2,
        ...
        let v11 = &mut v10;
        let (v12, v13, v14) = resolve_round(v11, v4, v5, v6);
        let v15 = if (v14 > v7) {
            v7
        } else {
            v14
        ...
        let v17 = v3 * arg2.fee_bps / 10000;
        0x2::balance::join<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&mut arg1.vault, v2);
        let v18 = 0x2::balance::value<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&arg1.vault);
        assert!(v16 <= v18 && v17 <= v18 - v16, 4);
        arg1.round = arg1.round + 1;
        if (v16 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>>(0x2::coin::from_balance<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(0x2::balance::split<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&mut arg1.vault, v16), arg4), v1);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>>(0x2::coin::from_balance<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(0x2::balance::split<0x4ddca40b10ff92ccaa1b1797b14dc63ad15e0c87cb7b5669af9bdc49e11e8dab::suipump::SUIPUMP>(&mut arg1.vault, v17), arg4), arg2.recipient);
        0x2::object::delete(v9);
        let v19 = PlayEvent{
            player  : v1,
            game    : v4,
        ...
        0x2::event::emit<RevenueEvent>(v20);
        let v21 = RoundRevealedEvent{
            commitment_id : 0x2::object::uid_to_inner(&v9),
            player        : v1,
            game          : v4,
            outcome       : v12,
        ...
        0x2::event::emit<RoundRevealedEvent>(v21);
    }

    fun settle_sui_commitment(arg0: RoundCommitment<0x2::sui::SUI>, arg1: &mut House, arg2: &RevenueConfig, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        let RoundCommitment {
            id                 : v0,
            player             : v1,
            stake              : v2,
        ...
        let v17 = v3 * arg2.fee_bps / 10000;
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.vault, v2);
        let v18 = 0x2::balance::value<0x2::sui::SUI>(&arg1.vault);
        assert!(v16 <= v18 && v17 <= v18 - v16, 4);
        arg1.round = arg1.round + 1;
        if (v16 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.vault, v16), arg4), v1);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.vault, v17), arg4), arg2.recipient);
        0x2::object::delete(v9);
        let v19 = PlayEvent{
            player  : v1,
            game    : v4,
    ...
    fun validate_round(arg0: u8, arg1: u8, arg2: bool) {
        assert!(arg0 <= 14, 0);
        if (arg0 == 2) {
            assert!(arg1 >= 5 && arg1 <= 95, 3);
        } else if (arg0 == 4) {
            assert!(arg1 <= 2, 3);
        } else {
            let v0 = if (arg0 == 5) {
            ...
            if (v0) {
                ...
                assert!(arg1 <= 2, 3);
            } else if (arg0 == 7 || arg0 == 11) {
                assert!(arg1 >= 2 && arg1 <= 50, 3);
            } else if (arg0 == 8 || arg0 == 12) {
                assert!(arg1 <= 2, 3);
            } else if (arg0 == 9) {
                assert!(arg1 <= 9, 3);
            } else if (arg0 == 14) {
                assert!(arg1 >= 2 && arg1 <= 20, 3);
            };
        };
    }
