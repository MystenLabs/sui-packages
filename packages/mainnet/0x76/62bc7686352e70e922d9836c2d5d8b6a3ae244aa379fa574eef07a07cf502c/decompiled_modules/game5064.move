module 0x7662bc7686352e70e922d9836c2d5d8b6a3ae244aa379fa574eef07a07cf502c::game5064 {
    struct GAME5064 has drop {
        dummy_field: bool,
    }

    struct TICKET_5064 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5064(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5064>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5064>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME5064, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME5064>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5064>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5064>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5064>>(v5, 0x2::tx_context::sender(arg1));
    }
