module 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math {
    ...
    public fun sqrt_u128(arg0: u128) : u128 {
        ...
        let v0 = 1 << (0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::bit_math::most_significant_bit(arg0) + 1) / 2;
        let v1 = (arg0 / v0 + v0) / 2;
        while (v1 < v0) {
            let v2 = arg0 / v1 + v1;
            v1 = v2 / 2;
