module 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::lb_position {
    ...
    public(friend) fun collect_fees(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::add_u64(v1.collected_fees_x, ((0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::mul_u128(v2, 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::sub_u128(arg3, v1.fee_growth_inside_last_x)) >> 64) as u64)), 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::add_u64(v1.collected_fees_y, ((0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::mul_u128(v2, 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::sub_u128(arg4, v1.fee_growth_inside_last_y)) >> 64) as u64)))
    }
    ...
    public fun get_pending_fees(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::add_u64(v1.collected_fees_x, ((v2 * (arg3 - v1.fee_growth_inside_last_x) >> 64) as u64)), 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::add_u64(v1.collected_fees_y, ((v2 * (arg4 - v1.fee_growth_inside_last_y) >> 64) as u64)))
    }
    ...
    public(friend) fun get_pending_rewards(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u64, arg4: u128) : u64 {
        ...
        0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::u128_to_u64(v2 * (arg4 - v3) >> 64)
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 6) {
            ...
            v3 = 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }
    ...
    public fun get_total_pending_fees_with_growth(arg0: &LBPositionManager, arg1: &LBPosition, arg2: &vector<u32>, arg3: &vector<u128>, arg4: &vector<u128>) : (u64, u64) {
        ...
        while (v2 < 0x1::vector::length<u32>(arg2)) {
            ...
            v0 = 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::add_u64(v0, v3);
            v1 = 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::add_u64(v1, v4);
            v2 = v2 + 1;
        };
        (v0, v1)
    }
    ...
    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128, arg5: u128, arg6: u128, arg7: vector<u128>) {
        let v0 = borrow_mut_position_info(arg0, arg2);
        if (contains_bin(v0, arg3)) {
            let v1 = borrow_bin_mut(v0, arg3);
            let v2 = v1.amount;
            if (v2 > 0) {
                v1.collected_fees_x = 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::add_u64(v1.collected_fees_x, 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::u128_to_u64(v2 * (arg5 - v1.fee_growth_inside_last_x) >> 64));
                v1.collected_fees_y = 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::add_u64(v1.collected_fees_y, 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::u128_to_u64(v2 * (arg6 - v1.fee_growth_inside_last_y) >> 64));
                let v3 = 0;
                ...
                while (v3 < v6) {
                    ...
                    if (v7 > v8) {
                        let v9 = 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::u128_to_u64(v2 * (v7 - v8) >> 64);
                        if (v9 > 0) {
                            while (0x1::vector::length<u64>(&v1.pending_rewards) <= v3) {
                                0x1::vector::push_back<u64>(&mut v1.pending_rewards, 0);
                            };
                            *0x1::vector::borrow_mut<u64>(&mut v1.pending_rewards, v3) = 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::add_u64(*0x1::vector::borrow<u64>(&v1.pending_rewards, v3), v9);
                        };
                    };
                    v3 = v3 + 1;
                };
            };
            v1.amount = 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::add_u128(v1.amount, arg4);
        ...
        0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::bin_manager::increment_total_supply(arg1, arg3, arg4);
    }
    ...
    public(friend) fun save_pending_rewards(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u64, arg4: u64) {
        ...
        *0x1::vector::borrow_mut<u64>(&mut v1.pending_rewards, arg3) = 0x764cb9d8605c4554a486effe7f08eec4431195ce1a30c571180bf89fb8ab7d65::safe_math::add_u64(*0x1::vector::borrow<u64>(&v1.pending_rewards, arg3), arg4);
    }
