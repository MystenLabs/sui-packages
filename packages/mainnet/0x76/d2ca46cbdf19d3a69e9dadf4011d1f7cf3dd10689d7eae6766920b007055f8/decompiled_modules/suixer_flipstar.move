module 0x76d2ca46cbdf19d3a69e9dadf4011d1f7cf3dd10689d7eae6766920b007055f8::suixer_flipstar {
    ...
    public entry fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<u8>, arg3: vector<0x1::ascii::String>, arg4: vector<0x1::ascii::String>, arg5: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<SuixerFlipstar>, arg6: &mut 0x96e49e7f672f3084028e11224a3616c18ab1805db62e6d0037fe56bf2792a1c9::warehouse::Warehouse<SuixerFlipstar>, arg7: bool, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg7) {
            0x96e49e7f672f3084028e11224a3616c18ab1805db62e6d0037fe56bf2792a1c9::warehouse::deposit_nft<SuixerFlipstar>(arg6, v0);
        } else {
