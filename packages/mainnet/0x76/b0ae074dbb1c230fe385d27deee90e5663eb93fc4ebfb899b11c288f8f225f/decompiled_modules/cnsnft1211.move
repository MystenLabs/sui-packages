module 0x76b0ae074dbb1c230fe385d27deee90e5663eb93fc4ebfb899b11c288f8f225f::cnsnft1211 {
    struct CNSNFT1211 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1211, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7247"));
        let v4 = 0x2::package::claim<CNSNFT1211>(arg0, arg1);
