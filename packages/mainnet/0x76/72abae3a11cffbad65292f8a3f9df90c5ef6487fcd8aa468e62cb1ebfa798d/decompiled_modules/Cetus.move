module 0x7672abae3a11cffbad65292f8a3f9df90c5ef6487fcd8aa468e62cb1ebfa798d::Cetus {
    ...
    fun init(arg0: CETUS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CETUS>(arg0, 6, b"cetusairdrop com Airdrop token", b"CetusAirdrop_com", b"Token drop to active users of the CETUS platform", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.ibb.co/Kz9yq3k/photo-2024-10-25-20-04-32.jpg")), arg1);
