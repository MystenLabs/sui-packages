module 0x76cf5594a5de61c7efbb0d17d843c1ccd301ef201eac1c1acd33a51955594c1d::dsg_pass__exclusive_early_privelege_key {
    ...
    fun init(arg0: DSG_PASS__EXCLUSIVE_EARLY_PRIVELEGE_KEY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"DSG PASS unlocks exclusive 30% upgrades on the main NFT collection and grants holders the right to mint two NFT sets in each network exclusively for DC PASS owners."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeie344fows63y3fxubd43lxv36cqbb2c6hh5yn6gpsi2kyumkakeoa"));
