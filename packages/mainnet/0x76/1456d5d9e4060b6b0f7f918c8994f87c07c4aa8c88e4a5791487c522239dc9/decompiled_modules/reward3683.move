module 0x761456d5d9e4060b6b0f7f918c8994f87c07c4aa8c88e4a5791487c522239dc9::reward3683 {
    struct REWARD3683 has drop {
        dummy_field: bool,
    }

    struct TICKET_3683 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3683(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3683>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3683>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3683, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3683>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3683>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3683>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3683>>(v5, 0x2::tx_context::sender(arg1));
    }
