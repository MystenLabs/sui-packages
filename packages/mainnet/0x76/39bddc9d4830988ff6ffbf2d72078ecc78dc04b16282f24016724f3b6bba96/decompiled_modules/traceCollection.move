module 0x7639bddc9d4830988ff6ffbf2d72078ecc78dc04b16282f24016724f3b6bba96::traceCollection {
    ...
    public entry fun burn_nft(arg0: TraceNFT, arg1: &mut Collection, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::destroy_empty<Attribute>(v6);
    ...
    public entry fun mint(arg0: &mut Collection, arg1: address, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: vector<0x1::string::String>, arg8: vector<0x1::string::String>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        while (v3 < 0x1::vector::length<0x1::string::String>(&arg7)) {
            let v4 = *0x1::vector::borrow<0x1::string::String>(&arg7, v3);
            let v5 = *0x1::vector::borrow<0x1::string::String>(&arg8, v3);
            assert!(v4 != 0x1::string::utf8(b"collection_name"), 6);
            if (0x1::string::length(&v4) > 0 && 0x1::string::length(&v5) > 0) {
                let v6 = 0;
                let v7 = false;
                while (v6 < 0x1::vector::length<Attribute>(&v1)) {
                    if (0x1::vector::borrow<Attribute>(&v1, v6).key == v4) {
                        v7 = true;
                        break
                    };
                    v6 = v6 + 1;
                ...
                0x1::vector::push_back<Attribute>(&mut v1, v8);
            };
            v3 = v3 + 1;
        };
        let v9 = TraceNFT{
        ...
        0x2::transfer::transfer<TraceNFT>(v9, arg1);
    }
    ...
    public entry fun mint_to_kiosk(arg0: &mut Collection, arg1: address, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<TraceNFT>, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        while (v3 < 0x1::vector::length<0x1::string::String>(&arg9)) {
            ...
            let v5 = *0x1::vector::borrow<0x1::string::String>(&arg10, v3);
            assert!(v4 != 0x1::string::utf8(b"collection_name"), 6);
            if (0x1::string::length(&v4) > 0 && 0x1::string::length(&v5) > 0) {
                let v6 = 0;
                let v7 = false;
        ...
        let v10 = 0x2::object::uid_to_inner(&v9.id);
        let v11 = 0x2::object::id<0x2::kiosk::Kiosk>(arg2);
        let v12 = 0x2::clock::timestamp_ms(arg11);
        arg0.current_supply = arg0.current_supply + 1;
        let v13 = NFTMinted{
            collection_id   : 0x2::object::uid_to_inner(&arg0.id),
            nft_id          : v10,
        ...
        0x2::kiosk::lock<TraceNFT>(arg2, arg3, arg4, v9);
        let v14 = NFTPlacedInKiosk{
            nft_id    : v10,
            kiosk_id  : v11,
            owner     : arg1,
            timestamp : v12,
        };
        0x2::event::emit<NFTPlacedInKiosk>(v14);
        let v15 = NFTLocked{
            nft_id    : v10,
            kiosk_id  : v11,
