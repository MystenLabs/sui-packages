module 0x769a59cfc8a981d80942081cd119efd133b299d8ced8d569b5d01cb5ca8b7c85::voiceai {
    struct VOICEAI has drop {
        dummy_field: bool,
    }

    public entry fun burn(arg0: &mut 0x2::coin::TreasuryCap<VOICEAI>, arg1: 0x2::coin::Coin<VOICEAI>) {
        0x2::coin::burn<VOICEAI>(arg0, arg1);
    }

    fun mint_and_transfer(arg0: &mut 0x2::coin::TreasuryCap<VOICEAI>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::mint_and_transfer<VOICEAI>(arg0, arg1, arg2, arg3);
    }
