module 0x767ae8ec0c2c5ff3abe50c8d7833259fe0c187c2555e172fc8ff99960eb1ce10::cnsnft4294 {
    struct CNSNFT4294 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4294, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4294>(arg0, arg1);
