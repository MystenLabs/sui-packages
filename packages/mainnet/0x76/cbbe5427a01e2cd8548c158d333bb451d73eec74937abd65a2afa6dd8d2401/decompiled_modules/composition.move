module 0x76cbbe5427a01e2cd8548c158d333bb451d73eec74937abd65a2afa6dd8d2401::composition {
    ...
    public fun add_composition<T0>(arg0: &mut 0x2::object::UID, arg1: Composition<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::put<Composition<T0>>(arg0, arg1, arg2);
        let v0 = AddCompositionEvent{
            collection  : 0x2::object::uid_to_inner(arg0),
            nft_type    : 0x1::type_name::get<T0>(),
            composition : 0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::get_object_id<Composition<T0>>(arg0, 0),
        };
    ...
    fun assert_composition<T0>(arg0: &0x2::object::UID) {
        assert!(0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::size<Composition<T0>>(arg0) > 0, 10003);
    }
    ...
    fun assert_no_composition<T0>(arg0: &0x2::object::UID) {
        if (0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::exists_bucket<Composition<T0>>(arg0)) {
            assert!(0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::size<Composition<T0>>(arg0) == 0, 10004);
        };
    }
    ...
    public fun compose<T0, T1: store + key>(arg0: &Composition<T0>, arg1: &mut 0x2::object::UID, arg2: T1, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0;
        if (0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::exists_bucket<T1>(arg1)) {
            v1 = 0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::size<T1>(arg1);
        };
        assert_insertable<T0, T1>(arg0, v1);
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::put<T1>(arg1, arg2, arg3);
        let v2 = ComposeEvent{
            composition : 0x2::object::uid_to_inner(&arg0.id),
            parent_nft  : 0x2::object::uid_to_inner(arg1),
            child_nft   : 0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::get_object_id<T1>(arg1, 0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::size<T1>(arg1) - 1),
        };
    ...
    public fun decompose<T0, T1: store + key>(arg0: &Composition<T0>, arg1: &mut 0x2::object::UID, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : T1 {
        ...
        let v0 = 0x1::type_name::get<T1>();
        assert_composable<T0>(arg0, &v0);
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::assert_exists_bucket<T1>(arg1);
        if (0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::is_empty<T1>(arg1)) {
            0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::drop<T1>(arg1);
        };
        ...
        0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::take<T1>(arg1, arg2, arg3)
    }
    ...
    public fun remove_composition<T0>(arg0: &mut 0x2::object::UID, arg1: &mut 0x2::tx_context::TxContext) : Composition<T0> {
        ...
        let v0 = 0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::take<Composition<T0>>(arg0, 0xab9edab4fccba0c1411f477aac6d5a82ddf2f3b53f99e7db439a3bade426b85f::bucket::get_object_id<Composition<T0>>(arg0, 0), arg1);
