module 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::reserve {
    ...
    public(friend) fun handle_borrow<T0>(arg0: &mut Reserve, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(v1.cash >= arg1, 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::error::reserve_not_enough_error());
        v1.cash = v1.cash - arg1;
        v1.debt = v1.debt + arg1;
        assert!(v1.cash >= v1.revenue, 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::error::pool_liquidity_not_enough_error());
    ...
    public(friend) fun mint_market_coin<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<T0>) : 0x2::balance::Balance<MarketCoin<T0>> {
        ...
        assert!(v3 > 0, 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::error::mint_market_coin_too_small_error());
        v2.cash = v2.cash + v0;
    ...
    public(friend) fun redeem_underlying_coin<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<MarketCoin<T0>>) : 0x2::balance::Balance<T0> {
        ...
        assert!(v3 > 0, 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::error::redeem_market_coin_too_small_error());
        assert!(v2.cash >= v3, 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::error::reserve_not_enough_error());
        v2.cash = v2.cash - v3;
        v2.market_coin_supply = v2.market_coin_supply - v0;
        assert!(v2.cash >= v2.revenue, 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::error::pool_liquidity_not_enough_error());
    ...
    public(friend) fun repay_flash_loan<T0>(arg0: &mut Reserve, arg1: 0x2::coin::Coin<T0>, arg2: FlashLoan<T0>) {
        ...
        assert!(v2 >= v0 + v1, 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::error::flash_loan_repay_not_enough_error());
        let v3 = v2 - v0;
