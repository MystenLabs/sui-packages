module 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::limiter {
    ...
    public(friend) fun add_outflow(arg0: &mut 0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::wit_table::WitTable<Limiters, 0x1::type_name::TypeName, Limiter>, arg1: 0x1::type_name::TypeName, arg2: u64, arg3: u64) {
        ...
        assert!(count_current_outflow(arg0, arg1, arg2) + arg3 <= v1.outflow_limit, 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::error::outflow_reach_limit_error());
