module 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::market {
    ...
    public(friend) fun assert_close_not_paused<T0, T1>(arg0: &Market<T0, T1>) {
        assert!(!arg0.is_close_pause, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_market_close_paused());
    }

    public(friend) fun assert_leverage_valid<T0, T1>(arg0: &Market<T0, T1>, arg1: u64, arg2: bool) {
        if (arg2) {
            assert!(arg1 >= 1 && arg1 <= arg0.max_long_leverage, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_leverage_too_high());
        } else {
            assert!(arg1 >= 1 && arg1 <= arg0.max_short_leverage, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_leverage_too_high());
        };
    }

    public(friend) fun assert_open_not_paused<T0, T1>(arg0: &Market<T0, T1>) {
        assert!(!arg0.is_open_pause, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_market_open_paused());
    }
    ...
    public fun claim_fees<T0, T1>(arg0: &0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::config::AdminCap, arg1: &mut Market<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
    ...
    public fun create_market<T0, T1>(arg0: &0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::config::AdminCap, arg1: &mut Markets, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg4 <= 100000, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_invalid_fee_rate());
        assert!(arg5 <= 100000, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_invalid_fee_rate());
        assert!(arg2 > 0, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_invalid_leverage());
        assert!(arg3 > 0, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_invalid_leverage());
    ...
    public fun set_fee_rate<T0, T1>(arg0: &0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::config::AdminCap, arg1: &mut Market<T0, T1>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(arg2 <= 100000, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_invalid_fee_rate());
        assert!(arg3 <= 100000, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_invalid_fee_rate());
    ...
    public fun set_market_close_pause<T0, T1>(arg0: &0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::config::AdminCap, arg1: &mut Market<T0, T1>, arg2: bool, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun set_market_open_pause<T0, T1>(arg0: &0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::config::AdminCap, arg1: &mut Market<T0, T1>, arg2: bool, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun set_max_leverage<T0, T1>(arg0: &0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::config::AdminCap, arg1: &mut Market<T0, T1>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(arg2 > 0, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_invalid_leverage());
        assert!(arg3 > 0, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_invalid_leverage());
