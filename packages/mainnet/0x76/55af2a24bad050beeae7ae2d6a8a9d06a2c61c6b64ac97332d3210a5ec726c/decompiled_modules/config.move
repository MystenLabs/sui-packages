module 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::config {
    ...
    public(friend) fun assert_global_close_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_close_pause, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_global_close_paused());
    }

    public(friend) fun assert_global_open_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_open_pause, 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_global_open_paused());
    }

    public(friend) fun assert_package_version(arg0: &GlobalConfig) {
        assert!(check_package_version(arg0), 0x7655af2a24bad050beeae7ae2d6a8a9d06a2c61c6b64ac97332d3210a5ec726c::errors::err_wrong_version());
    }
