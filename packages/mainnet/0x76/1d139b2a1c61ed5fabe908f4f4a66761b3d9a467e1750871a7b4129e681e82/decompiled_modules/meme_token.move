module 0x761d139b2a1c61ed5fabe908f4f4a66761b3d9a467e1750871a7b4129e681e82::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"TCD", b"Test-coubn", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2026-01-13T04-56-13.511Z-2025-07-19T07-46-52.253Z-images (2).jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Test-coubn"),
            symbol     : 0x1::string::utf8(b"TCD"),
            decimals   : 9,
