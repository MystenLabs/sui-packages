module 0x76ce17d867868db655ccedc3a7f61e1bc79f8e52146db49ee3a9db8da971e54d::distributor {
    ...
    public(friend) fun new<T0>(arg0: u64, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : VestingSchedule {
        ...
        0x2::dynamic_field::add<0x76ce17d867868db655ccedc3a7f61e1bc79f8e52146db49ee3a9db8da971e54d::utils::Marker<T0>, 0x2::balance::Balance<T0>>(&mut v0.id, 0x76ce17d867868db655ccedc3a7f61e1bc79f8e52146db49ee3a9db8da971e54d::utils::marker<T0>(), 0x2::coin::into_balance<T0>(arg2));
        v0
    }
    ...
    public(friend) fun recover<T0>(arg0: &mut VestingSchedule, arg1: u64) : 0x2::balance::Balance<T0> {
        0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x76ce17d867868db655ccedc3a7f61e1bc79f8e52146db49ee3a9db8da971e54d::utils::Marker<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x76ce17d867868db655ccedc3a7f61e1bc79f8e52146db49ee3a9db8da971e54d::utils::marker<T0>()), arg1)
    }
    ...
    public entry fun release<T0: drop>(arg0: &mut VestingSchedule, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 > 0, 2);
        released(arg0, v0, v1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x76ce17d867868db655ccedc3a7f61e1bc79f8e52146db49ee3a9db8da971e54d::utils::Marker<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x76ce17d867868db655ccedc3a7f61e1bc79f8e52146db49ee3a9db8da971e54d::utils::marker<T0>()), v1), arg2), v0);
    }
