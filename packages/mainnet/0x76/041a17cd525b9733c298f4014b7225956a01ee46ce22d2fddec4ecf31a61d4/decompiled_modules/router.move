module 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::router {
    struct SwapContext {
    ...
    public fun confirm_swap<T0>(arg0: SwapContext, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(0x2::balance::value<T0>(&v10) >= v5, 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_amount_out_slippage_check_failed());
        assert!(0x2::bag::is_empty(&v9), 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_remains_balance());
    ...
    public fun confirm_swap_v3<T0>(arg0: SwapContext, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(0x2::bag::contains_with_type<QuoteGuardKey, QuoteGuardV3>(&arg0.balances, v0), 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_missing_quote_guard());
        let SwapContext {
            quote_id          : v1,
            from              : v2,
            target            : v3,
        ...
        assert!(v15 > 0, 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_amount_out_limit_is_zero());
        let v16 = 0x2::bag::remove<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v10, v3);
        let v17 = &mut v16;
        let v18 = collect_fee<T0>(v17, v7, v8, arg1);
        assert!(0x2::balance::value<T0>(&v16) >= v15, 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_amount_out_slippage_check_failed());
        assert!(0x2::bag::is_empty(&v10), 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_remains_balance());
    ...
    fun mul_div(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        assert!(v0 <= (18446744073709551615 as u128), 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_expect_amount_out_overflow());
        (v0 as u64)
    }
    ...
    public fun new_swap_context<T0, T1>(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: u32, arg5: address, arg6: &mut 0x2::tx_context::TxContext) : SwapContext {
        assert!(0x2::coin::value<T0>(&arg3) > 0, 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_amount_in_is_zero());
        if (arg4 > 0) {
            assert!(arg5 != @0x0, 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_invalid_fee_recipient());
        };
        assert!(arg4 <= 100000, 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_too_large_fee_rate());
    ...
    public fun new_swap_context_v2<T0, T1>(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: u32, arg6: address, arg7: &mut 0x2::tx_context::TxContext) : SwapContext {
        assert!(0x2::coin::value<T0>(&arg4) <= arg1, 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_exceed_max_amount_in());
    ...
    public fun new_swap_context_v3<T0, T1>(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: u32, arg7: address, arg8: &mut 0x2::tx_context::TxContext) : SwapContext {
        assert!(0x2::coin::value<T0>(&arg5) <= arg1, 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_exceed_max_amount_in());
        assert!(arg2 > 0, 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_amount_in_is_zero());
        assert!(arg3 > 0, 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_amount_out_is_zero());
        assert!(arg4 < 1000000, 0x76041a17cd525b9733c298f4014b7225956a01ee46ce22d2fddec4ecf31a61d4::errors::err_invalid_slippage());
