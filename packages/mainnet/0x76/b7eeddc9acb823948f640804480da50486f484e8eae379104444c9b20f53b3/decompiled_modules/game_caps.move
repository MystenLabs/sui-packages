module 0x76b7eeddc9acb823948f640804480da50486f484e8eae379104444c9b20f53b3::game_caps {
    ...
    public(friend) fun assert_execution(arg0: &GameCapStore, arg1: address, arg2: 0x1::option::Option<0x2::object::ID>) {
        if (0x1::option::is_some<0x2::object::ID>(&arg2)) {
            ...
            0x1::option::destroy_none<0x2::object::ID>(arg2);
        };
    }

    public(friend) fun borrow_cap(arg0: &GameCapStore, arg1: address) : &0x76b7eeddc9acb823948f640804480da50486f484e8eae379104444c9b20f53b3::game::GameCap {
        0x2::dynamic_object_field::borrow<address, 0x76b7eeddc9acb823948f640804480da50486f484e8eae379104444c9b20f53b3::game::GameCap>(&arg0.id, arg1)
    }
    ...
    public(friend) fun store_cap(arg0: &mut GameCapStore, arg1: 0x76b7eeddc9acb823948f640804480da50486f484e8eae379104444c9b20f53b3::game::GameCap, arg2: address, arg3: 0x1::option::Option<0x2::object::ID>) {
        0x2::dynamic_object_field::add<address, 0x76b7eeddc9acb823948f640804480da50486f484e8eae379104444c9b20f53b3::game::GameCap>(&mut arg0.id, arg2, arg1);
        if (0x1::option::is_some<0x2::object::ID>(&arg3)) {
            let v0 = ExecutionBindingKey{pos0: arg2};
            0x2::dynamic_field::add<ExecutionBindingKey, 0x2::object::ID>(&mut arg0.id, v0, 0x1::option::destroy_some<0x2::object::ID>(arg3));
        } else {
            0x1::option::destroy_none<0x2::object::ID>(arg3);
        };
    }
