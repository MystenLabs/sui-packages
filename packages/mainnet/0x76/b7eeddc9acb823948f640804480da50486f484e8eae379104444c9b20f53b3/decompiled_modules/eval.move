module 0x76b7eeddc9acb823948f640804480da50486f484e8eae379104444c9b20f53b3::eval {
    ...
    public fun best_of_seven(arg0: &vector<u8>) : HandRank {
        assert!(0x1::vector::length<u8>(arg0) == 7, 13906834384796778495);
        let v0 = 0;
        while (v0 < 7) {
    ...
    public fun evaluate_five(arg0: &vector<u8>) : HandRank {
        assert!(0x1::vector::length<u8>(arg0) == 5, 13906834526530699263);
        ...
        while (v3 < 5) {
            ...
            assert!(v4 < 52, 1);
            let v5 = 0x76b7eeddc9acb823948f640804480da50486f484e8eae379104444c9b20f53b3::types::card_rank(v4);
            0x1::vector::push_back<u8>(&mut v1, v5);
            0x1::vector::push_back<u8>(&mut v2, 0x76b7eeddc9acb823948f640804480da50486f484e8eae379104444c9b20f53b3::types::card_suit(v4));
