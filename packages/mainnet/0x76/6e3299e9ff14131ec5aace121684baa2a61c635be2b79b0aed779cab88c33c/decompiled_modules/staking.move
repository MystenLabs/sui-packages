module 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::staking {
    ...
    public entry fun claim<T0>(arg0: &0x2::clock::Clock, arg1: &mut StakingStorage, arg2: &mut 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::certificate::InvestmentCertificate, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::certificate::get_mut_df_info<ProofOfStake>(arg2);
        ...
        0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::vault::withdraw<T0>(0x2::object_bag::borrow_mut<0x1::string::String, 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::vault::Vaults>(&mut arg1.other, 0x1::string::utf8(b"VAULT")), v6, v1, arg3);
        let v7 = Claim{
            sender           : v1,
            epoch_time       : v0,
    ...
    fun cal_profit_per_day(arg0: u64, arg1: u64) : u64 {
        0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::utils::mul_u64_div_u64(arg0, parse_percent(arg1), 365 * 0x2::math::pow(10, 9))
    }
    ...
    public(friend) fun get_mut_vault(arg0: &mut StakingStorage) : &mut 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::vault::Vaults {
        0x2::object_bag::borrow_mut<0x1::string::String, 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::vault::Vaults>(&mut arg0.other, 0x1::string::utf8(b"VAULT"))
    }
    ...
    fun new_vault(arg0: &mut 0x2::vec_map::VecMap<0x1::string::String, 0x2::object::ID>, arg1: &mut 0x2::object_bag::ObjectBag, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::vault::new(arg2);
        0x2::vec_map::insert<0x1::string::String, 0x2::object::ID>(arg0, v0, v2);
        0x2::object_bag::add<0x1::string::String, 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::vault::Vaults>(arg1, v0, v1);
    }
    ...
    public entry fun stake<T0>(arg0: &0x2::clock::Clock, arg1: &mut StakingStorage, arg2: 0x1::string::String, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::utils::get_full_type<T0>();
        let v3 = 0x2::dynamic_field::borrow<0x1::string::String, StakingPackage<T0>>(&arg1.id, arg2);
        let v4 = 0x2::object_bag::borrow_mut<0x1::string::String, 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::vault::Vaults>(&mut arg1.other, 0x1::string::utf8(b"VAULT"));
        ...
        0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::vault::deposit<T0>(v4, arg3, arg4);
        let v11 = ProofOfStake{
            staker                : 0x2::tx_context::sender(arg4),
            stake_token           : 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::utils::get_full_type<T0>(),
            stake_amount          : v5,
            stake_date            : v0,
        ...
        0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::certificate::issue_investment_certificate<ProofOfStake>(arg0, v3.name, v3.image, v3.website, v3.link, v3.description, v11, arg4);
        let v12 = Stake{
            sender       : v1,
            epoch_time   : v0,
            package_key  : arg2,
    ...
    public entry fun unstake<T0>(arg0: &0x2::clock::Clock, arg1: &mut StakingStorage, arg2: &mut 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::certificate::InvestmentCertificate, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::utils::get_full_type<T0>();
        let v3 = 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::certificate::get_mut_df_info<ProofOfStake>(arg2);
        ...
        if (v8 < v3.days_at_moment) {
            v11 = v10 - 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::utils::mul_u64_div_decimal(v3.stake_amount, parse_percent(v4.unstake_soon_fee), 9);
        };
        ...
        *v12 = *v12 - v3.stake_amount;
        ...
        0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::vault::withdraw<T0>(0x2::object_bag::borrow_mut<0x1::string::String, 0x766e3299e9ff14131ec5aace121684baa2a61c635be2b79b0aed779cab88c33c::vault::Vaults>(&mut arg1.other, 0x1::string::utf8(b"VAULT")), v11, v1, arg3);
        let v15 = Unstake{
            sender           : v1,
            epoch_time       : v0,
