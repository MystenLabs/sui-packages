module 0x764dad1bf6168a08840578e6478ecd10aa080670592a0ffd158d92f61d7d7174::constants {
    public fun default_dao_creation_fee() : u64 {
        0x3d8af66299c5bdad712f5252a7e2f184c6cfd48c79e19d5f1e8d32dae71bc58f::constants::default_dao_creation_fee()
    }

    public fun default_launchpad_creation_fee() : u64 {
        0x3d8af66299c5bdad712f5252a7e2f184c6cfd48c79e19d5f1e8d32dae71bc58f::constants::default_launchpad_creation_fee()
    }

    public fun default_proposal_creation_fee() : u64 {
        0x3d8af66299c5bdad712f5252a7e2f184c6cfd48c79e19d5f1e8d32dae71bc58f::constants::default_proposal_creation_fee()
    }

    public fun default_proposal_fee_per_outcome() : u64 {
        0x3d8af66299c5bdad712f5252a7e2f184c6cfd48c79e19d5f1e8d32dae71bc58f::constants::default_proposal_fee_per_outcome()
    }

    public fun launchpad_bid_fee_per_contribution() : u64 {
        0x3d8af66299c5bdad712f5252a7e2f184c6cfd48c79e19d5f1e8d32dae71bc58f::constants::launchpad_bid_fee_per_contribution()
    }

    public fun launchpad_min_duration_ms() : u64 {
        0x3d8af66299c5bdad712f5252a7e2f184c6cfd48c79e19d5f1e8d32dae71bc58f::constants::launchpad_min_duration_ms()
    }

    public fun min_execution_window_ms() : u64 {
        0x3d8af66299c5bdad712f5252a7e2f184c6cfd48c79e19d5f1e8d32dae71bc58f::constants::min_execution_window_ms()
    }

    public fun min_proposal_intent_expiry_ms() : u64 {
        0x3d8af66299c5bdad712f5252a7e2f184c6cfd48c79e19d5f1e8d32dae71bc58f::constants::min_proposal_intent_expiry_ms()
    }

    public fun min_review_period_ms() : u64 {
        0x3d8af66299c5bdad712f5252a7e2f184c6cfd48c79e19d5f1e8d32dae71bc58f::constants::min_review_period_ms()
    }

    public fun min_trading_period_ms() : u64 {
        0x3d8af66299c5bdad712f5252a7e2f184c6cfd48c79e19d5f1e8d32dae71bc58f::constants::min_trading_period_ms()
    }

    public fun protocol_min_liquidity_amount() : u64 {
        0x3d8af66299c5bdad712f5252a7e2f184c6cfd48c79e19d5f1e8d32dae71bc58f::constants::protocol_min_liquidity_amount()
    }
    ...
    public fun execution_window_ms() : u64 {
        let v0 = 1800000;
        let v1 = 0x3d8af66299c5bdad712f5252a7e2f184c6cfd48c79e19d5f1e8d32dae71bc58f::constants::min_execution_window_ms();
        if (v0 > v1) {
            v0
        } else {
            v1
