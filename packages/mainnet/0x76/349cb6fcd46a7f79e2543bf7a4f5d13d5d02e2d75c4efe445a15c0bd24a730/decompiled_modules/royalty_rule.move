module 0x664d58be00187e024697aae7b004990e4bb2f655955813b560ed2650a3c7f47a::royalty_rule {
    ...
    public fun add<T0>(arg0: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg1: &0x2::transfer_policy::TransferPolicyCap<T0>, arg2: u64, arg3: u64) {
    ...
    public fun pay<T0>(arg0: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg1: &mut 0x2::transfer_policy::TransferRequest<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) == required_amount<T0>(arg0, arg1), 0);
        let v0 = Rule{dummy_field: false};
    ...
    public fun required_amount<T0>(arg0: &0x2::transfer_policy::TransferPolicy<T0>, arg1: &0x2::transfer_policy::TransferRequest<T0>) : u64 {
        let v0 = Rule{dummy_field: false};
