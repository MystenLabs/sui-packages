module 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::multi_layer {
    ...
    fun get_orders_by_layer<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2::clock::Clock) : vector<LayerOrderInfo> {
        ...
        while (v2 < 0x1::vector::length<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(&v0)) {
            ...
            let (v6, v7, _) = 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::orderbook_analyzer::parse_order_id(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::order_id(v3));
    ...
    public(friend) fun process_layers<T0, T1, T2, T3>(arg0: &mut 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::mm_state::MMState, arg1: &0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::mm_registry::MMRegistry, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T2, T3>, arg5: &0x2::clock::Clock, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &vector<u64>, arg12: &vector<u64>, arg13: &vector<u64>, arg14: &vector<u64>, arg15: &vector<u64>, arg16: u64, arg17: u64, arg18: u64, arg19: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg20: &0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::config::MMConfig, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::config::is_dry_run(arg20);
        let v3 = 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::config::enable_deep_payment(arg20);
        let v4 = get_orders_by_layer<T0, T1>(arg3, arg2, arg5);
        if (!v2 && 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::config::enable_deep_refill(arg20)) {
            let v5 = 0;
            let v6 = 0;
            while (v6 < v1) {
            ...
            let (_, _) = 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::deep_manager::ensure_deep_balance<T0, T1, T2, T3>(arg3, arg4, arg2, arg19, v5, arg6, arg20, arg5, arg25);
        };
        let v10 = 0;
        while (v10 < v1) {
            let v11 = (v10 as u8);
            let v12 = 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::inv_sizing::apply_multiplier(*0x1::vector::borrow<u64>(arg13, v10), arg17, arg21, arg22);
            let v13 = 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::inv_sizing::apply_multiplier(*0x1::vector::borrow<u64>(arg14, v10), arg18, arg21, arg22);
            ...
            let v21 = 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::orders::round_bid_price(v19, arg21);
            let v22 = 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::orders::round_ask_price(v20, arg21);
            let v23 = if (v12 >= arg22) {
                if (v12 >= 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::config::min_order_size(arg20)) {
                    v21 >= 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::config::min_price(arg20)
                } else {
                    false
                }
            } else {
            ...
            let v24 = if (v13 >= arg22) {
                if (v13 >= 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::config::min_order_size(arg20)) {
                    v22 <= 0x76e699bdaba86c0a467b976383f954c1bf8929f5368dd74fb3f9e20ac88e8a73::config::max_price(arg20)
                } else {
                    false
                }
            } else {
