module 0x76689340aca26a7445816592bbea944b04b386bb3c1ae911d2c746f51ffcb829::query {
    ...
    struct GetCurrentDepthEvent has copy, drop, store {
        ask: vector<0x76689340aca26a7445816592bbea944b04b386bb3c1ae911d2c746f51ffcb829::arbitrager::Level>,
        bid: vector<0x76689340aca26a7445816592bbea944b04b386bb3c1ae911d2c746f51ffcb829::arbitrager::Level>,
        timestamp_ms: u64,
    }

    public fun all_balances(arg0: &0x76689340aca26a7445816592bbea944b04b386bb3c1ae911d2c746f51ffcb829::arbitrager::Bot, arg1: &0x2::clock::Clock) {
        let (v0, v1) = 0x76689340aca26a7445816592bbea944b04b386bb3c1ae911d2c746f51ffcb829::arbitrager::all_balances(arg0);
    ...
    public fun available_balance<T0>(arg0: &0x76689340aca26a7445816592bbea944b04b386bb3c1ae911d2c746f51ffcb829::arbitrager::Bot, arg1: &0x2::clock::Clock) {
        let v0 = 0x1::vector::empty<0x1::type_name::TypeName>();
        0x1::vector::push_back<0x1::type_name::TypeName>(&mut v0, 0x1::type_name::with_defining_ids<T0>());
        let v1 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v1, 0x76689340aca26a7445816592bbea944b04b386bb3c1ae911d2c746f51ffcb829::arbitrager::available_balance<T0>(arg0));
        let v2 = AvailableBalancesEvent{
            coins        : v0,
            balances     : v1,
            timestamp_ms : 0x2::clock::timestamp_ms(arg1),
    ...
    public fun available_balances<T0, T1>(arg0: &0x76689340aca26a7445816592bbea944b04b386bb3c1ae911d2c746f51ffcb829::arbitrager::Bot, arg1: &0x2::clock::Clock) {
        let (v0, v1) = 0x76689340aca26a7445816592bbea944b04b386bb3c1ae911d2c746f51ffcb829::arbitrager::available_balances<T0, T1>(arg0);
    ...
    public fun get_pool_current_depth<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: u32, arg2: u32, arg3: &0x2::clock::Clock) {
        let (v0, v1) = 0x76689340aca26a7445816592bbea944b04b386bb3c1ae911d2c746f51ffcb829::arbitrager::get_pool_current_depth<T0, T1>(arg0, arg1, arg2);
