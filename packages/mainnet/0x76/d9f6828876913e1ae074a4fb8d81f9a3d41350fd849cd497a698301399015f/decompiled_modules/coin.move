module 0x76d9f6828876913e1ae074a4fb8d81f9a3d41350fd849cd497a698301399015f::coin {
    struct COIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<COIN>(arg0, 6, b"TTKN", b"TEST TOKEN", b"Don't ask why", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
