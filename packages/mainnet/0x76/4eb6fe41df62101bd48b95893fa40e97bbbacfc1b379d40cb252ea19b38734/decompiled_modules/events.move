module 0x764eb6fe41df62101bd48b95893fa40e97bbbacfc1b379d40cb252ea19b38734::events {
    ...
    public(friend) fun emit_raffle_created(arg0: 0x2::object::ID) {
        ...
        0x764eb6fe41df62101bd48b95893fa40e97bbbacfc1b379d40cb252ea19b38734::event_wrapper::emit_event<RaffleCreated>(v0);
    }

    public(friend) fun emit_raffle_finished(arg0: 0x2::object::ID) {
        let v0 = RaffleFinished{raffle_id: arg0};
        0x764eb6fe41df62101bd48b95893fa40e97bbbacfc1b379d40cb252ea19b38734::event_wrapper::emit_event<RaffleFinished>(v0);
    }
    ...
    public(friend) fun emit_raffle_participant_joined(arg0: 0x2::object::ID, arg1: address) {
        ...
        0x764eb6fe41df62101bd48b95893fa40e97bbbacfc1b379d40cb252ea19b38734::event_wrapper::emit_event<RaffleParticipantJoined>(v0);
    }
    ...
    public(friend) fun emit_raffle_winner_selected(arg0: 0x2::object::ID, arg1: address) {
        ...
        0x764eb6fe41df62101bd48b95893fa40e97bbbacfc1b379d40cb252ea19b38734::event_wrapper::emit_event<RaffleWinnerSelected>(v0);
    }
