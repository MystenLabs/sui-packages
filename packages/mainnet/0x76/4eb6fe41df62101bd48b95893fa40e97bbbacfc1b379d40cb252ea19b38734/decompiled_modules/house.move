module 0x764eb6fe41df62101bd48b95893fa40e97bbbacfc1b379d40cb252ea19b38734::house {
    ...
    public(friend) fun get_fee_from_payment<T0>(arg0: &mut House, arg1: &mut 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.fee_balance, v0), 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg1, 0x764eb6fe41df62101bd48b95893fa40e97bbbacfc1b379d40cb252ea19b38734::utils::mul_div_u64(0x2::coin::value<T0>(arg1), arg0.fee_percentage, 10000), arg2)));
    }
