module 0x76b4723e426d3b55189c0b99f0c59aa6ca5303cda4bc57d402b7c9e0615d92db::cnsnft2103 {
    struct CNSNFT2103 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2103, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2103>(arg0, arg1);
