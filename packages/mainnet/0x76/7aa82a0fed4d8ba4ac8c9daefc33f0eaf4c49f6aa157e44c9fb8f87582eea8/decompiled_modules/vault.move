module 0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::vault {
    ...
    public fun begin_deposit_tx<T0, T1>(arg0: &RebateVault, arg1: &0x139b50f0b6b549674ab79a0e1f3cb1be6aefa100c30f02f802770c73a753e51f::authority::AuthorityCap<0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::authority::PACKAGE, T0>, arg2: &0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::Config) : DepositCap<T1> {
        0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::assert_correct_version(arg2);
        0x139b50f0b6b549674ab79a0e1f3cb1be6aefa100c30f02f802770c73a753e51f::authority::assert_is_admin_or_assistant<T0>();
        0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::assert_authority_cap_is_valid<T0>(arg2, arg1);
        DepositCap<T1>{
    ...
    public fun begin_withdraw_tx(arg0: &RebateVault, arg1: &0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::Config) : WithdrawCap {
        0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::assert_correct_version(arg1);
        WithdrawCap{
            vault_id : 0x2::object::uid_to_inner(&arg0.id),
    ...
    public(friend) fun create_vault_and_share<T0: drop>(arg0: &T0, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::types::is_one_time_witness<T0>(arg0), 13835902883939614727);
        let v0 = RebateVault{
        ...
        0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::events::emit_create_vault_event(0x2::object::uid_to_inner(&v0.id));
        0x2::transfer::share_object<RebateVault>(v0);
    }

    public fun end_deposit_tx<T0>(arg0: &mut RebateVault, arg1: DepositCap<T0>, arg2: &0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::Config, arg3: 0x2::coin::Coin<T0>, arg4: 0x1::ascii::String, arg5: u64, arg6: u64) {
        0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::assert_correct_version(arg2);
        assert!(arg1.vault_id == 0x2::object::uid_to_inner(&arg0.id), 13835622323790807045);
        let DepositCap {
            vault_id         : v0,
            added_rebates    : v1,
            num_of_addresses : v2,
        ...
        assert!(v3 == v1, 13835340896058605571);
        join<T0>(arg0, arg3);
        0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::events::emit_deposit_session_event<T0>(v0, arg4, v3, v2, arg5, arg6);
    }

    public fun end_withdraw_tx(arg0: WithdrawCap, arg1: &0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::Config, arg2: &0x2::tx_context::TxContext) {
        0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::assert_correct_version(arg1);
        let WithdrawCap {
            vault_id : v0,
            types    : v1,
        ...
        0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::events::emit_withdraw_rebate_event(v0, 0x2::tx_context::sender(arg2), v1, v2);
    }
    ...
    public fun update_allocations<T0>(arg0: &mut RebateVault, arg1: &mut DepositCap<T0>, arg2: &0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::Config, arg3: vector<address>, arg4: vector<u64>, arg5: &mut 0x2::tx_context::TxContext) {
        0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::assert_correct_version(arg2);
        assert!(arg1.vault_id == 0x2::object::uid_to_inner(&arg0.id), 13835622048912900101);
        let v0 = 0x1::vector::length<address>(&arg3);
        assert!(v0 == 0x1::vector::length<u64>(&arg4), 13835059116139085825);
        ...
        while (v2 < v0) {
            ...
            0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::events::emit_deposit_event<T0>(v1, v3, v4);
            v2 = v2 + 1;
        };
    }

    public fun withdraw_rebate<T0>(arg0: &mut RebateVault, arg1: &mut WithdrawCap, arg2: &0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::Config, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x767aa82a0fed4d8ba4ac8c9daefc33f0eaf4c49f6aa157e44c9fb8f87582eea8::config::assert_correct_version(arg2);
        assert!(arg1.vault_id == 0x2::object::uid_to_inner(&arg0.id), 13835622663093223429);
