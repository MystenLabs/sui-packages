module 0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::deep_price {
    ...
    public(friend) fun deep_quantity_u128(arg0: &OrderDeepPrice, arg1: u128, arg2: u128) : u128 {
        if (arg0.asset_is_base) {
            0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::math::mul_u128(arg1, (arg0.deep_per_asset as u128))
        } else {
            0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::math::mul_u128(arg2, (arg0.deep_per_asset as u128))
        }
    }
    ...
    public(friend) fun fee_quantity(arg0: &OrderDeepPrice, arg1: u64, arg2: u64, arg3: bool) : 0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::balances::Balances {
        let v0 = if (arg0.asset_is_base) {
            0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::math::mul(arg1, arg0.deep_per_asset)
        } else {
            0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::math::mul(arg2, arg0.deep_per_asset)
        };
        if (arg0.deep_per_asset > 0) {
            0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::balances::new(0, 0, v0)
        } else if (arg3) {
            0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::balances::new(0, 0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::math::mul(arg2, 0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::constants::fee_penalty_multiplier()), 0)
        } else {
            0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::balances::new(0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::math::mul(arg1, 0x76bc8a6bb84ee94a8d83ddcbb519bf923ba338d1430e24e531704d23e4cfbe0d::constants::fee_penalty_multiplier()), 0, 0)
        }
    }
