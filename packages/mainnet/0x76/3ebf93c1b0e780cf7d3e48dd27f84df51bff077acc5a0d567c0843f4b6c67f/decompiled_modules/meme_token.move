module 0x763ebf93c1b0e780cf7d3e48dd27f84df51bff077acc5a0d567c0843f4b6c67f::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"CTT", b"cointest2", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-18T06-37-08.998Z-images.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"cointest2"),
            symbol     : 0x1::string::utf8(b"CTT"),
            decimals   : 9,
