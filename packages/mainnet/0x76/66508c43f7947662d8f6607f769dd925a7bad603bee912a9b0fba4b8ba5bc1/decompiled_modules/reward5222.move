module 0x7666508c43f7947662d8f6607f769dd925a7bad603bee912a9b0fba4b8ba5bc1::reward5222 {
    struct REWARD5222 has drop {
        dummy_field: bool,
    }

    struct TICKET_5222 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5222(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5222>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5222>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5222, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5222>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5222>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5222>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5222>>(v5, 0x2::tx_context::sender(arg1));
    }
