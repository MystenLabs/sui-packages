module 0x7699493a09d824c4a601e18eef5c62b2a5176de8310170e7c1ccbd1fb515b02d::atlansui {
    ...
    public fun claim_offer_originbyte_kiosk<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::TransferRequest<T1> {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg0.id, arg1), 2);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Collection<T0, T1>>(&mut arg0.id, arg1);
        let v2 = 0x2::vec_map::get_mut<address, Offers>(&mut v1.offers, &v0);
        ...
        assert!(!v3.is_repayment, 600);
        assert!(!v3.is_claimed, 601);
        assert!(v3.start_time + v1.loan_duration < 0x2::clock::timestamp_ms(arg5), 106);
        ...
        let v5 = 0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::transfer_delegated<T1>(arg3, arg4, v4, &v1.id, 0, arg6);
        0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::set_nothing_paid<T1>(&mut v5);
        let v6 = Witness{dummy_field: false};
        0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::set_transfer_request_auth<T1, Witness>(&mut v5, &v6);
        v3.is_claimed = true;
        let v7 = ClaimOfferEvent{
            offer_id       : 0x2::object::id<Offer>(v3),
            creator        : v3.creator,
            interest_value : mul_div(mul_div(v1.loan_duration, mul_div(v1.interest, 10000000, 365) / 86400, 1000), v3.value, 1000000000),
            time           : 0x2::clock::timestamp_ms(arg5),
        };
        0x2::event::emit<ClaimOfferEvent>(v7);
        v5
    }
