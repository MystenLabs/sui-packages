module 0x76f0b96994fbe6f02926176fd57662ee725b7e55226a3195db6ed273bba8a4e6::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"SUI^2", b"SUI^2", b"", 0x1::option::none<0x2::url::Url>(), arg1);
