module 0x761244a58b09a71098ffc0cc6108456df1b3d9ad77c1a3d817163b30b965a2f0::reward8147 {
    struct REWARD8147 has drop {
        dummy_field: bool,
    }

    struct TICKET_8147 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8147(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8147>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8147>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8147, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8147>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8147>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8147>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8147>>(v5, 0x2::tx_context::sender(arg1));
    }
