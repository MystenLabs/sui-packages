module 0xd4f574d9e701bd815fc7b4af25eeb4a41548ca9ffd10e454b25d5bd66f7b21c5::mint_box {
    ...
    public(friend) fun get(arg0: &mut MintBox, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) : u256 {
        ...
        let v2 = 0x2::random::generate_u64_in_range(&mut v0, 0, 0x1::vector::length<0x2::object::ID>(v1) - 1);
        ...
        0x1::vector::swap_remove<u256>(v3, 0x2::random::generate_u64_in_range(&mut v0, 0, 0x1::vector::length<u256>(v3) - 1))
    }
