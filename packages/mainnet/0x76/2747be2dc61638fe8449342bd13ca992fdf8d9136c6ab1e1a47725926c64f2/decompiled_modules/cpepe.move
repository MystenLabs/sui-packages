module 0x762747be2dc61638fe8449342bd13ca992fdf8d9136c6ab1e1a47725926c64f2::cpepe {
    struct CPEPE has drop {
        dummy_field: bool,
    }

    fun init(arg0: CPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CPEPE>(arg0, 6, b"CPEPE", b"Lastcall: 5mins left", b"Twitter: https://twitter.com/Sui_clownpepe, Telegram: https://t.me/Sui_ClownPepe", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://i.imgur.com/fQTA2Ih.png"))), arg1);
        let v2 = v0;
