module 0x764ebe41230dab491a54d1a1f6c23d21a616ae428a7ddd2c4900935551515219::reward1523 {
    struct REWARD1523 has drop {
        dummy_field: bool,
    }

    struct TICKET_1523 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1523(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1523>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1523>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1523, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1523>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1523>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1523>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1523>>(v5, 0x2::tx_context::sender(arg1));
    }
