module 0x19fa5d3bc461e86d8fe5062853aec27ffdcb530c94b6c314b3c9d6c91c94cad4::vault_stable {
    struct Vault has key {
        ...
        pending_fund: u64,
        current_epoch: u64,
        total_pending_burned_xusdc: u64,
        ...
        xusdc_cap: 0x2::coin::TreasuryCap<0x19fa5d3bc461e86d8fe5062853aec27ffdcb530c94b6c314b3c9d6c91c94cad4::xusdc::XUSDC>,
    ...
    fun calculate_vault_info(arg0: &mut Vault) : (u128, u128, u128, u64) {
        let v0 = if (arg0.total_xusdc == 0 || arg0.total_usdc == 0) {
            1000000000000000000
        } else {
            (arg0.total_usdc as u128) * 1000000000000000000 / (arg0.total_xusdc as u128)
        };
        let v1 = if (arg0.total_xusdc == 0 || arg0.total_usdc == 0) {
            1000000000000000000
        } else {
            (arg0.total_usdc as u128) * 1000000000000000000 / (arg0.total_xusdc as u128)
        };
        let v2 = (arg0.total_pending_burned_xusdc as u128) * v0 / 1000000000000000000;
        arg0.total_xusdc = arg0.total_xusdc - arg0.total_pending_burned_xusdc;
        arg0.total_usdc = arg0.total_usdc - (v2 as u64);
        arg0.total_pending_burned_xusdc = 0;
        arg0.total_xusdc = arg0.total_xusdc + (((arg0.pending_fund as u128) * 1000000000000000000 / v1) as u64);
    ...
    public entry fun claim_and_transfer_xusdc(arg0: &mut Vault, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 1010);
        let v0 = claim_xusdc(arg0, arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x19fa5d3bc461e86d8fe5062853aec27ffdcb530c94b6c314b3c9d6c91c94cad4::xusdc::XUSDC>>(v0, 0x2::tx_context::sender(arg1));
    }
    ...
    public fun claim_usdc(arg0: &mut Vault, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC> {
        ...
        while (v1 < 0x2::linked_table::length<u64, WithdrawRequest>(v2)) {
            ...
            if (v4 < arg0.current_epoch && 0x2::clock::timestamp_ms(arg1) - v7.timestamp > arg0.withdraw_lock_time) {
                v3 = v3 + (((v6.xusdc_amount as u128) * v7.exchange_wd_rate / 1000000000000000000) as u64);
            } else {
    ...
    public fun claim_xusdc(arg0: &mut Vault, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x19fa5d3bc461e86d8fe5062853aec27ffdcb530c94b6c314b3c9d6c91c94cad4::xusdc::XUSDC> {
        assert!(arg0.version == 1, 1010);
        assert!(!arg0.paused, 1006);
        ...
        0x2::coin::mint<0x19fa5d3bc461e86d8fe5062853aec27ffdcb530c94b6c314b3c9d6c91c94cad4::xusdc::XUSDC>(&mut arg0.xusdc_cap, v1, arg1)
    }
    ...
    public(friend) fun get_total_burned_xusdc(arg0: &Vault) : u64 {
        arg0.total_pending_burned_xusdc
    }
    ...
    public(friend) fun get_total_xusdc(arg0: &Vault) : u64 {
        arg0.total_xusdc
    }
    ...
    fun init_vault(arg0: 0x2::coin::TreasuryCap<0x19fa5d3bc461e86d8fe5062853aec27ffdcb530c94b6c314b3c9d6c91c94cad4::xusdc::XUSDC>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Vault {
        Vault{
    ...
    public entry fun operator_init_vault(arg0: 0x2::coin::TreasuryCap<0x19fa5d3bc461e86d8fe5062853aec27ffdcb530c94b6c314b3c9d6c91c94cad4::xusdc::XUSDC>, arg1: &OperatorCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun request_withdraw(arg0: &mut Vault, arg1: 0x2::coin::Coin<0x19fa5d3bc461e86d8fe5062853aec27ffdcb530c94b6c314b3c9d6c91c94cad4::xusdc::XUSDC>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 1010);
        assert!(!arg0.paused, 1006);
        let v0 = 0x2::coin::value<0x19fa5d3bc461e86d8fe5062853aec27ffdcb530c94b6c314b3c9d6c91c94cad4::xusdc::XUSDC>(&arg1);
        assert!(v0 > 0, 1004);
        assert!(arg0.total_xusdc > 0, 1005);
        let v1 = 0x2::tx_context::sender(arg2);
        arg0.total_pending_burned_xusdc = arg0.total_pending_burned_xusdc + v0;
        0x2::coin::burn<0x19fa5d3bc461e86d8fe5062853aec27ffdcb530c94b6c314b3c9d6c91c94cad4::xusdc::XUSDC>(&mut arg0.xusdc_cap, arg1);
        ...
        if (0x2::linked_table::contains<u64, WithdrawRequest>(v2, v3)) {
            ...
            v4.xusdc_amount = v4.xusdc_amount + v0;
        } else {
