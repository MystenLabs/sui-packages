module 0x19d7709ee9b8706f2c4c4bf80648d2d6aefdfe310324d82b9c9b861f29bf4a1f::reward3803 {
    struct REWARD3803 has drop {
        dummy_field: bool,
    }

    struct TICKET_3803 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3803(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3803>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3803>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3803, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3803>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3803>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3803>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3803>>(v5, 0x2::tx_context::sender(arg1));
    }
