module 0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::vesting {
    ...
    public fun claim<T0>(arg0: &mut VestingLock<T0>, arg1: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::Config, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create<T0>(arg0: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::Config, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun top_up<T0>(arg0: &mut VestingLock<T0>, arg1: &0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::Config, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::config::assert_version(arg1);
    ...
    public fun vested_unreleased<T0>(arg0: &VestingLock<T0>, arg1: &0x2::clock::Clock) : u64 {
        ...
        let v1 = if (v0 >= arg0.duration_ms) {
            ...
            0x192d2cfb3266e5fd434c038d800f63059c74068f621027157772488675ce52c5::math::mul_div(arg0.schedule_total, v0, arg0.duration_ms)
        };
        v1 - arg0.released
    }
