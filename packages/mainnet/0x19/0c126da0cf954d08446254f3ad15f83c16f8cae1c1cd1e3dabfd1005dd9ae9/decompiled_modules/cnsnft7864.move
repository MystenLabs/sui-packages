module 0x190c126da0cf954d08446254f3ad15f83c16f8cae1c1cd1e3dabfd1005dd9ae9::cnsnft7864 {
    struct CNSNFT7864 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7864, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8029"));
        let v4 = 0x2::package::claim<CNSNFT7864>(arg0, arg1);
