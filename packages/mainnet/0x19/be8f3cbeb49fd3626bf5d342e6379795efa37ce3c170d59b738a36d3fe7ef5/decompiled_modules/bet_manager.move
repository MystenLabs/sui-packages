module 0x19be8f3cbeb49fd3626bf5d342e6379795efa37ce3c170d59b738a36d3fe7ef5::bet_manager {
    ...
    public(friend) fun get_bet_payout(arg0: &BetManager, arg1: &BetSetting, arg2: u64, arg3: u8, arg4: u8, arg5: vector<BetOption>, arg6: vector<u64>) : (u64, u64) {
        let v0 = 0x1::vector::length<BetOption>(&arg5);
        let v1 = get_edge(arg0, arg3, *0x1::vector::borrow<BetOption>(&arg5, 0), 0);
        assert!(v0 <= (arg4 as u64), 3);
        let v2 = arg2;
        let v3 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::precision();
        let v4 = 0x1::vector::length<u64>(&arg6);
        let v5 = if (arg3 == 1 || arg3 == 2) {
            0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(5, 1000, v4)
        } else {
            let (_, v7) = get_bet_option_data(0x1::vector::borrow<BetOption>(&arg5, 0));
            let v8 = v7;
            0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(0x1::vector::length<u64>(&v8), 1000, v4)
        };
        let v9 = 0;
        let v10 = 0x2::vec_set::empty<u64>();
        let v11 = v5;
        while (v9 < v0) {
            let (v12, v13) = get_bet_option_data(0x1::vector::borrow<BetOption>(&arg5, v9));
            let v14 = v13;
            let v15 = v12;
            if (arg3 == 4) {
                let v16 = 0;
                assert!(v15 < v4, 2);
                while (v16 < 0x1::vector::length<u64>(&v14)) {
                    assert!(0x1::vector::contains<u64>(&arg6, 0x1::vector::borrow<u64>(&v14, v16)), 1);
                    v16 = v16 + 1;
                };
            } else {
                assert!(0x1::vector::contains<u64>(&arg6, &v15), 1);
                if (arg3 == 0) {
                    assert!(0x1::vector::length<u64>(&v14) == 1, 2);
                    assert!(*0x1::vector::borrow<u64>(&v14, 0) < v4, 2);
                    assert!(!0x2::vec_set::contains<u64>(&v10, 0x1::vector::borrow<u64>(&v14, 0)), 7);
                    0x2::vec_set::insert<u64>(&mut v10, *0x1::vector::borrow<u64>(&v14, 0));
                } else if (arg3 == 1) {
                    assert!((*0x1::vector::borrow<u64>(&v14, 0) as u64) < 2, 2);
                } else if (arg3 == 2) {
                    assert!(0x1::vector::length<u64>(&v14) == 1, 2);
                    assert!(0x1::vector::contains<u64>(&arg6, 0x1::vector::borrow<u64>(&v14, 0)), 1);
                } else {
                    let v17 = 0;
                    while (v17 < 0x1::vector::length<u64>(&v14)) {
                        assert!(*0x1::vector::borrow<u64>(&v14, v17) < v4, 2);
                        v17 = v17 + 1;
                    };
                };
            };
            if (v9 != 1) {
                v11 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(v11, v5, 1000);
            };
            if (arg3 != 4) {
                v2 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(v2, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(v3 - v1 - v9 * get_edge(arg0, arg3, *0x1::vector::borrow<BetOption>(&arg5, 0), 1), 1, v11), *0x2::vec_map::get<u64, u64>(&arg1.odd_weights, &v15), 1), 1000);
            } else {
                v2 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(v2, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(v3 - v1 - v9 * get_edge(arg0, arg3, *0x1::vector::borrow<BetOption>(&arg5, 0), 1), 1, v11), 1000);
            };
            v9 = v9 + 1;
        };
        (v2, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(arg2, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::math::mul_and_div(v3 - v1, 1, v5), 1000))
    }
