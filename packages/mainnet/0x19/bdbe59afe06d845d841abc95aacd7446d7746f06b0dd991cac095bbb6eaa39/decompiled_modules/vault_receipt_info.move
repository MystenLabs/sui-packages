module 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_receipt_info {
    ...
    public(friend) fun update_reward(arg0: &mut VaultReceiptInfo, arg1: 0x1::type_name::TypeName, arg2: u256) : u256 {
        ...
        if (arg2 > *v1) {
            let v3 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::mul_with_oracle_price(arg2 - *v1, arg0.shares);
            *v1 = arg2;
            *v2 = *v2 + v3;
