module 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::curator_position {
    ...
    public fun create_curator_cap(arg0: &mut CuratorConfig, arg1: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::AdminCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : CuratorCap {
        check_version(arg0);
    ...
    public fun create_curator_position<T0>(arg0: &mut CuratorConfig, arg1: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::AdminCap, arg2: CuratorCap, arg3: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg4: &mut 0x2::tx_context::TxContext) : CuratorPosition {
        check_version(arg0);
        ...
        0x2::table::add<address, address>(&mut arg0.curator_position_to_vault, v1, 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_id<T0>(arg3));
    ...
    public fun loop_in_curator_position<T0>(arg0: &mut CuratorConfig, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Operation, arg3: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::OperatorCap, arg4: address, arg5: u8, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_operator_not_freezed(arg2, arg3);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_single_vault_operator_paired(arg2, 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_id<T0>(arg1), arg3);
        let v0 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::parse_key<CuratorPosition>(arg5);
        let v1 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::borrow_defi_asset<T0, CuratorPosition>(arg1, v0);
        let v2 = 0x2::object::uid_to_address(&v1.id);
        assert_valid_curator_cap(arg0, v2, arg4);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::return_defi_asset<T0, CuratorPosition>(arg1, v0, v1);
        let v3 = if (arg6 > 0) {
            0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::borrow_free_principal<T0>(arg1, arg6)
        } else {
            0x2::balance::zero<T0>()
        };
        ...
        let v5 = CuratorPositionLoopedIn{
            ...
            total_usd_value     : 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::get_total_usd_value_without_update<T0>(arg1),
            total_shares        : 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::total_shares<T0>(arg1),
        };
        0x2::event::emit<CuratorPositionLoopedIn>(v5);
    }

    public fun loop_in_curator_position_with_claimable_balance<T0>(arg0: &mut CuratorConfig, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Operation, arg3: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::OperatorCap, arg4: address, arg5: u8, arg6: u64) {
        check_version(arg0);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_operator_not_freezed(arg2, arg3);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_single_vault_operator_paired(arg2, 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_id<T0>(arg1), arg3);
        let v0 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::parse_key<CuratorPosition>(arg5);
    ...
    public fun loop_out_curator_position<T0>(arg0: &mut CuratorConfig, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: u8, arg3: 0x2::coin::Coin<T0>, arg4: &CuratorCap) {
        check_version(arg0);
        loop_out_curator_position_internal<T0>(arg0, arg1, arg2, curator_cap_id(arg4), arg3);
    }

    public fun loop_out_curator_position_by_operator<T0>(arg0: &mut CuratorConfig, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Operation, arg3: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::OperatorCap, arg4: u8, arg5: address, arg6: 0x2::coin::Coin<T0>) {
        check_version(arg0);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_operator_not_freezed(arg2, arg3);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_single_vault_operator_paired(arg2, 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_id<T0>(arg1), arg3);
    ...
    public(friend) fun loop_out_curator_position_internal<T0>(arg0: &CuratorConfig, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: u8, arg3: address, arg4: 0x2::coin::Coin<T0>) {
        let v0 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::parse_key<CuratorPosition>(arg2);
        let v1 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::borrow_defi_asset<T0, CuratorPosition>(arg1, v0);
        let v2 = 0x2::object::uid_to_address(&v1.id);
        assert_valid_curator_cap(arg0, v2, arg3);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::return_defi_asset<T0, CuratorPosition>(arg1, v0, v1);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::return_free_principal<T0>(arg1, 0x2::coin::into_balance<T0>(arg4));
    ...
    public fun update_curator_position_value<T0>(arg0: &mut CuratorConfig, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: 0x1::ascii::String, arg3: address, arg4: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_oracle::OracleConfig, arg5: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg5);
        assert!(*0x2::table::borrow<address, address>(&arg0.curator_position_to_vault, arg3) == 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_id<T0>(arg1), 8011);
        assert!(arg2 == 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::parse_key<CuratorPosition>(0), 8013);
        assert_valid_curator_position_value(arg0, arg3, v0);
        let v1 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::mul_with_oracle_price(position_value(arg0, arg3), 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_oracle::get_normalized_asset_price(arg4, arg5, 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())));
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::finish_update_asset_value<T0>(arg1, arg2, v1, v0);
    ...
    public fun validate_curator_position_value(arg0: &mut CuratorConfig, arg1: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Operation, arg2: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::OperatorCap, arg3: address, arg4: bool, arg5: &0x2::clock::Clock) {
        check_version(arg0);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_operator_not_freezed(arg1, arg2);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_single_vault_operator_paired(arg1, *0x2::table::borrow<address, address>(&arg0.curator_position_to_vault, arg3), arg2);
