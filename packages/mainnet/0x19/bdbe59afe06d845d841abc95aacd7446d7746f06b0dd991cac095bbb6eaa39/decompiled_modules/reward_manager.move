module 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::reward_manager {
    ...
    public fun add_new_reward_type<T0, T1>(arg0: &mut RewardManager<T0>, arg1: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Operation, arg2: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::OperatorCap, arg3: &0x2::clock::Clock, arg4: bool) {
        check_version<T0>(arg0);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_operator_not_freezed(arg1, arg2);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_single_vault_operator_paired(arg1, arg0.vault_id, arg2);
    ...
    public fun add_reward_balance<T0, T1>(arg0: &mut RewardManager<T0>, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Operation, arg3: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::OperatorCap, arg4: 0x2::balance::Balance<T1>) {
        check_version<T0>(arg0);
        assert!(arg0.vault_id == 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_id<T0>(arg1), 3001);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_operator_not_freezed(arg2, arg3);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_single_vault_operator_paired(arg2, arg0.vault_id, arg3);
        let v0 = 0x1::type_name::get<T1>();
        let v1 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::to_decimals((0x2::balance::value<T1>(&arg4) as u256));
        assert!(v1 >= 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::mul_with_oracle_price(0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::total_shares<T0>(arg1), 1), 3012);
    ...
    public fun add_reward_to_buffer<T0, T1>(arg0: &mut RewardManager<T0>, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Operation, arg3: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::OperatorCap, arg4: &0x2::clock::Clock, arg5: 0x2::balance::Balance<T1>) {
        ...
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_single_vault_operator_paired(arg2, arg0.vault_id, arg3);
        let v0 = 0x1::type_name::get<T1>();
        let v1 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::to_decimals((0x2::balance::value<T1>(&arg5) as u256));
    ...
    public fun claim_reward<T0, T1>(arg0: &mut RewardManager<T0>, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::receipt::Receipt) : 0x2::balance::Balance<T1> {
        check_version<T0>(arg0);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_enabled<T0>(arg1);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_vault_receipt_matched<T0>(arg1, arg3);
        assert!(arg0.vault_id == 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_id<T0>(arg1), 3001);
        let v0 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::receipt::receipt_id(arg3);
        assert!(0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_receipt_info::status(0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_receipt_info<T0>(arg1, v0)) == 0, 3006);
        update_reward_buffers<T0>(arg0, arg1, arg2);
        update_receipt_reward<T0>(arg0, arg1, v0);
        let v1 = 0x1::type_name::get<T1>();
        let v2 = (0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::from_decimals((0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_receipt_info::reset_unclaimed_rewards<T1>(0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_receipt_info_mut<T0>(arg1, v0)) as u256)) as u64);
        ...
        let v4 = RewardClaimed{
            reward_manager_id : 0x2::object::uid_to_address(&arg0.id),
            vault_id          : 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::receipt::vault_id(arg3),
            receipt_id        : 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::receipt::receipt_id(arg3),
            coin_type         : v1,
            reward_amount     : v2,
        };
    ...
    public fun create_reward_buffer_distribution<T0, T1>(arg0: &mut RewardManager<T0>, arg1: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Operation, arg2: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::OperatorCap, arg3: &0x2::clock::Clock) {
        check_version<T0>(arg0);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_operator_not_freezed(arg1, arg2);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::assert_single_vault_operator_paired(arg1, arg0.vault_id, arg2);
    ...
    public(friend) fun create_reward_manager<T0>(arg0: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_id<T0>(arg0);
        let v1 = RewardBuffer{
        ...
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::set_reward_manager<T0>(arg0, 0x2::object::uid_to_address(&v2.id));
    ...
    public(friend) fun issue_receipt<T0>(arg0: &RewardManager<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::receipt::Receipt {
        check_version<T0>(arg0);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::receipt::create_receipt(arg0.vault_id, arg1)
    }

    public(friend) fun issue_vault_receipt_info<T0>(arg0: &RewardManager<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_receipt_info::VaultReceiptInfo {
        check_version<T0>(arg0);
        let v0 = reward_indices<T0>(arg0);
        0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_receipt_info::new_vault_receipt_info(0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::clone_vecmap_table<0x1::type_name::TypeName, u256>(&v0, arg1), 0x2::table::new<0x1::type_name::TypeName, u256>(arg1))
    }
    ...
    public fun retrieve_undistributed_reward<T0, T1>(arg0: &mut RewardManager<T0>, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Operation, arg3: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::OperatorCap, arg4: u64, arg5: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        let v2 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::to_decimals((arg4 as u256));
        assert!(v1 >= v2, 3008);
    ...
    public(friend) fun update_receipt_reward<T0>(arg0: &RewardManager<T0>, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: address) {
        check_version<T0>(arg0);
        let v0 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_receipt_info_mut<T0>(arg1, arg2);
        ...
        while (v3 < 0x1::vector::length<0x1::type_name::TypeName>(v2)) {
            ...
            0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_receipt_info::update_reward(v0, *v4, *0x2::vec_map::get<0x1::type_name::TypeName, u256>(&arg0.reward_indices, v4));
            v3 = v3 + 1;
        };
    }

    public fun update_reward_buffer<T0>(arg0: &mut RewardManager<T0>, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: &0x2::clock::Clock, arg3: 0x1::type_name::TypeName) {
        check_version<T0>(arg0);
        assert!(arg0.vault_id == 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_id<T0>(arg1), 3001);
        ...
        if (v0 > v1.last_updated) {
            if (v1.rate == 0) {
                ...
                let v3 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::total_shares<T0>(arg1);
                ...
                if (v5 == 0) {
                    ...
                    let v8 = if (v7 >= 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::mul_with_oracle_price(v3, 1)) {
                        v7
                    } else {
                        0
                    };
    ...
    public fun update_reward_buffers<T0>(arg0: &mut RewardManager<T0>, arg1: &mut 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: &0x2::clock::Clock) {
        check_version<T0>(arg0);
        assert!(arg0.vault_id == 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::vault_id<T0>(arg1), 3001);
    ...
    public(friend) fun update_reward_indices<T0>(arg0: &mut RewardManager<T0>, arg1: &0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::Vault<T0>, arg2: 0x1::type_name::TypeName, arg3: u256) {
        check_version<T0>(arg0);
        assert!(0x2::table::contains<0x1::type_name::TypeName, u256>(&arg0.reward_amounts, arg2), 3011);
        let v0 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault::total_shares<T0>(arg1);
        assert!(v0 > 0, 3010);
        let v1 = 0x19bdbe59afe06d845d841abc95aacd7446d7746f06b0dd991cac095bbb6eaa39::vault_utils::div_with_oracle_price(arg3, v0);
