module 0xb073375aba97556eff7a6263fe686a421e3365877dedb6f68ea938e234d0bf85::pool {
    ...
    public fun collect_fee<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut Position<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        arg1.owed_a = 0;
        arg1.owed_b = 0;
        let v4 = 0x2::balance::value<T0>(&arg0.reserve_a);
        let v5 = 0x2::balance::value<T1>(&arg0.reserve_b);
        if (v0 > v4) {
            v1 = v4;
        };
        if (v2 > v5) {
    ...
    public fun create_pool_permissionless<T0, T1>(arg0: u256, arg1: u32, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        if (arg1 == 0) {
            abort 1
        };
        if (arg2 > 1000) {
    ...
    fun get_amount_out_a(arg0: u256, arg1: u256, arg2: u128) : u64 {
        ...
        (((arg2 as u256) * (arg1 - arg0) / arg1 * 79228162514264337593543950336 / arg0) as u64)
    }
    ...
    fun get_amount_out_b(arg0: u256, arg1: u256, arg2: u128) : u64 {
        ...
        (((arg2 as u256) * (arg0 - arg1) / 79228162514264337593543950336) as u64)
    }
    ...
    fun next_sqrt_price_from_input_a(arg0: u256, arg1: u128, arg2: u64) : u256 {
        if (arg1 == 0) {
            abort 7
        };
        let v0 = (arg1 as u256) * 79228162514264337593543950336;
        let v1 = v0 + (arg2 as u256) * arg0;
        if (v1 == 0) {
            abort 7
        };
        v0 * arg0 / v1
    ...
    fun next_sqrt_price_from_input_b(arg0: u256, arg1: u128, arg2: u64) : u256 {
        if (arg1 == 0) {
            abort 7
        };
        arg0 + (arg2 as u256) * 79228162514264337593543950336 / (arg1 as u256)
    }
    ...
    public fun open_position<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u32, arg4: u32, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (Position<T0, T1>, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v8 = Position<T0, T1>{
            ...
            tick_upper               : arg4,
            liquidity                : v5,
            fee_growth_inside_last_a : arg0.fee_growth_global_a,
            fee_growth_inside_last_b : arg0.fee_growth_global_b,
            owed_a                   : 0,
            owed_b                   : 0,
        };
        let v9 = (arg3 as u64);
    ...
    public fun open_position_and_transfer<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u32, arg4: u32, arg5: &0x2::clock::Clock, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = open_position<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg7);
        0x2::transfer::transfer<Position<T0, T1>>(v0, arg6);
    ...
    public fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut Position<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        remove_liquidity_internal<T0, T1>(arg0, arg1, v0, arg3)
    }

    fun remove_liquidity_internal<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut Position<T0, T1>, arg2: u128, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        settle_fees<T0, T1>(arg0, arg1);
        let (v0, v1) = 0xb073375aba97556eff7a6263fe686a421e3365877dedb6f68ea938e234d0bf85::tick_math::get_amounts_for_liquidity(arg0.sqrt_price_x64, 0xb073375aba97556eff7a6263fe686a421e3365877dedb6f68ea938e234d0bf85::tick_math::get_sqrt_ratio_at_tick(arg1.tick_lower), 0xb073375aba97556eff7a6263fe686a421e3365877dedb6f68ea938e234d0bf85::tick_math::get_sqrt_ratio_at_tick(arg1.tick_upper), arg2);
        let v2 = v1;
        let v3 = v0;
        let v4 = arg1.owed_a;
        let v5 = arg1.owed_b;
        ...
        arg1.owed_a = 0;
        arg1.owed_b = 0;
        let v6 = (arg1.tick_lower as u64);
        let v7 = (arg1.tick_upper as u64);
        if (0x2::dynamic_field::exists_with_type<u64, TickInfo>(&arg0.id, v6)) {
            let v8 = 0x2::dynamic_field::remove<u64, TickInfo>(&mut arg0.id, v6);
            v8.liquidity_gross = decr_gross(v8.liquidity_gross, arg2);
            0x2::dynamic_field::add<u64, TickInfo>(&mut arg0.id, v6, v8);
        };
        if (0x2::dynamic_field::exists_with_type<u64, TickInfo>(&arg0.id, v7)) {
            let v9 = 0x2::dynamic_field::remove<u64, TickInfo>(&mut arg0.id, v7);
            v9.liquidity_gross = decr_gross(v9.liquidity_gross, arg2);
            0x2::dynamic_field::add<u64, TickInfo>(&mut arg0.id, v7, v9);
        };
        if (arg0.liquidity_global >= arg2) {
            arg0.liquidity_global = arg0.liquidity_global - arg2;
        } else {
            arg0.liquidity_global = 0;
        };
        arg1.liquidity = arg1.liquidity - arg2;
        ...
        let v12 = if (v3 > 0) {
            0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.reserve_a, v3), arg3)
        } else {
            0x2::coin::zero<T0>(arg3)
        };
        let v13 = if (v2 > 0) {
            0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.reserve_b, v2), arg3)
        } else {
            0x2::coin::zero<T1>(arg3)
        };
    ...
    public fun remove_liquidity_partial<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut Position<T0, T1>, arg2: u128, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        if (arg2 == 0) {
            abort 4
        };
        if (arg2 > arg1.liquidity) {
            abort 10
        };
        remove_liquidity_internal<T0, T1>(arg0, arg1, arg2, arg4)
    }
    ...
    fun saturating_add_u64(arg0: u64, arg1: u256) : u64 {
        let v0 = 18446744073709551615;
        let v1 = (arg0 as u256) + arg1;
        if (v1 > v0) {
            (v0 as u64)
        } else {
            (v1 as u64)
    ...
    fun settle_fees<T0, T1>(arg0: &Pool<T0, T1>, arg1: &mut Position<T0, T1>) {
        let v0 = arg1.liquidity;
        if (v0 > 0) {
            arg1.owed_a = saturating_add_u64(arg1.owed_a, ((arg0.fee_growth_global_a - arg1.fee_growth_inside_last_a) as u256) * (v0 as u256) / 340282366920938463463374607431768211456);
            arg1.owed_b = saturating_add_u64(arg1.owed_b, ((arg0.fee_growth_global_b - arg1.fee_growth_inside_last_b) as u256) * (v0 as u256) / 340282366920938463463374607431768211456);
        };
    ...
    public fun swap_a_to_b<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u256, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v3 = next_sqrt_price_from_input_a(v2, arg0.liquidity_global, v0 - v1);
        if (v3 > v2) {
            abort 6
        };
        if (v3 < arg3) {
    ...
    public fun swap_a_to_b_with_fee<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x5ef97658a3eee57643f2a7adf724c1558e9e43f778cd3b6c6afbc8d0af52aa71::fee::FeeConfig, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u256, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let v0 = swap_a_to_b<T0, T1>(arg0, arg2, arg3, arg4, arg5, arg6);
        0x5ef97658a3eee57643f2a7adf724c1558e9e43f778cd3b6c6afbc8d0af52aa71::fee::take_fee<T1>(arg1, v0, arg6)
    }
    ...
    public fun swap_b_to_a<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: u256, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v3 = next_sqrt_price_from_input_b(v2, arg0.liquidity_global, v0 - v1);
        if (v3 <= v2) {
            abort 6
        };
        if (v3 > arg3) {
    ...
    public fun swap_b_to_a_with_fee<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x5ef97658a3eee57643f2a7adf724c1558e9e43f778cd3b6c6afbc8d0af52aa71::fee::FeeConfig, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u256, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = swap_b_to_a<T0, T1>(arg0, arg2, arg3, arg4, arg5, arg6);
        0x5ef97658a3eee57643f2a7adf724c1558e9e43f778cd3b6c6afbc8d0af52aa71::fee::take_fee<T0>(arg1, v0, arg6)
    }
