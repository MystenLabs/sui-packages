module 0x198a167d8c33ee36b46743315929594a8b06477fb715a823fed22416af17cfd0::cnsnft1078 {
    struct CNSNFT1078 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1078, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1078>(arg0, arg1);
