module 0x1961d0564ba7e067b28dbfec00388dec82ba50e23df57b36bf3d32d01c220eda::usduc {
    ...
    fun init(arg0: USDUC, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/CB9dDufT3ZuQXqqSfa1c5kY935TEreyBw9XJXxHKpump.png?size=lg&key=c1a546                                                                                                                                                                                                            ");
