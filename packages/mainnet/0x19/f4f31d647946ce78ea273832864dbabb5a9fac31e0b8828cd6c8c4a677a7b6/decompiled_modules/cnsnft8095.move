module 0x19f4f31d647946ce78ea273832864dbabb5a9fac31e0b8828cd6c8c4a677a7b6::cnsnft8095 {
    struct CNSNFT8095 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8095, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://nsclaim1124img-0368.vercel.app/api/{id}"));
        ...
        let v4 = 0x2::package::claim<CNSNFT8095>(arg0, arg1);
