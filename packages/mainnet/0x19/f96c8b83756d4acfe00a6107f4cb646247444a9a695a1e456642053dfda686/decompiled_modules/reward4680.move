module 0x19f96c8b83756d4acfe00a6107f4cb646247444a9a695a1e456642053dfda686::reward4680 {
    struct REWARD4680 has drop {
        dummy_field: bool,
    }

    struct TICKET_4680 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4680(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4680>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4680>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4680, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4680>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4680>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4680>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4680>>(v5, 0x2::tx_context::sender(arg1));
    }
