module 0x19fc70b85be657c469fa9a7d139f6e735d440a850946386da43bc1d479bf7f66::slbt {
    ...
    fun init(arg0: SLBT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SLBT>(arg0, 9, b"SLBT", b"SUILab TESTING", b"No description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.pinata.cloud/ipfs/QmdKJ3xTbo4wkXNsVDmALo5EKCvGXbLcnGHTPN76gDiTXJ")), arg1);
        let v2 = v0;
