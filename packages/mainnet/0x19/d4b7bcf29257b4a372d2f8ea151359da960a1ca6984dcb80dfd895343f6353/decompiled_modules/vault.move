module 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::vault {
    ...
    public(friend) fun add_swap_route<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: vector<0x360802cb106b004205cd67a706e314eaeadd8590d5f4d1cee46137566232a627::bag_value::Value>) {
        ...
        assert!(!0x2::bag::contains<0x1::ascii::String>(&arg0.swap_routes, v0), 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::invalid_route());
    ...
    public(friend) fun add_withdraw_request<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: 0x2::coin::Coin<T2>, arg2: address, arg3: u8) {
        let v0 = 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::constants::strategy_active();
        assert!(&arg0.state == &v0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::strategy_not_active());
    ...
    public(friend) fun assert_address_whitelisted<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &0x2::tx_context::TxContext) {
        assert!(is_address_whitelisted_for_trading<T0, T1, T2>(arg0, 0x2::tx_context::sender(arg1)), 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::address_not_whitelisted());
    }
    ...
    public fun calculate_lp_token_share<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &0xdee9::clob_v2::Pool<T0, T1>, arg2: u64) : (u64, u64) {
        ...
        assert!(v4 > 0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::invalidLPToken());
        ((v0 + v1) * arg2 / v4, (v2 + v3) * arg2 / v4)
    }

    public(friend) fun check_vault_cap_compatibility<T0, T1, T2>(arg0: &VaultCap, arg1: &Vault<T0, T1, T2>) {
        assert!(get_vault_id_from_vault_cap(arg0) == get_vault_id_from_vault<T0, T1, T2>(arg1), 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::invalid_vault_cap());
    }
    ...
    public(friend) fun claim_withdrawal<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::table::contains<address, ClaimableWithdrawals<T0, T1>>(&arg0.claimable_withdrawals, arg1), 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::claim_does_not_exist());
    ...
    public(friend) fun is_pool_and_vault_compatible<T0, T1, T2>(arg0: &0xdee9::clob_v2::Pool<T0, T1>, arg1: &Vault<T0, T1, T2>) {
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg0) == arg1.pool_id, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::invalid_pool());
    }
    ...
    public(friend) fun mark_state_as_ready_for_withdrawal_processing<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &0x2::tx_context::TxContext) {
        ...
        let v0 = 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::constants::strategy_active();
        assert!(&arg0.state == &v0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::strategy_not_ready_for_withdrawal_processing());
        arg0.state = 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::constants::strategy_paused_and_ready_for_withdrawal_processing();
    }
    ...
    fun mint_lp_token<T0>(arg0: &mut 0x2::coin::TreasuryCap<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = if (v0 == 0) {
            ...
            assert!(v2 > 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::constants::minimal_liquidity(), 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::notEnoughInitialLiquidity());
            v2
        } else if (arg1 == 0) {
            0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::safe_math::safe_mul_div_u64(arg4, v0, arg2)
        } else if (arg2 == 0) {
            0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::safe_math::safe_mul_div_u64(arg3, v0, arg1)
        } else {
            0x2::math::min(0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::safe_math::safe_mul_div_u64(arg3, v0, arg1), 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::safe_math::safe_mul_div_u64(arg4, v0, arg2))
        };
        assert!(v1 > 0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::liquidityInsufficientMinted());
        0x2::coin::mint<T0>(arg0, v1, arg5)
    }

    public(friend) fun new_vault<T0, T1, T2>(arg0: &0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::app::AdminCap, arg1: 0x2::coin::TreasuryCap<T2>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, VaultCap) {
        assert!(0x2::coin::total_supply<T2>(&arg1) == 0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::vault_coin_supply_not_zero());
        ...
        let v1 = Vault<T0, T1, T2>{
            ...
            epoch_counter         : 0,
            state                 : 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::constants::strategy_active(),
    ...
    public(friend) fun process_withdrawals<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::constants::strategy_paused_and_ready_for_withdrawal_processing();
        assert!(&arg0.state == &v0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::strategy_not_ready_for_withdrawal_processing());
        let v1 = 0xdee9::clob_v2::list_open_orders<T0, T1>(arg1, get_account_cap<T0, T1, T2>(arg0));
        assert!(0x1::vector::length<0xdee9::clob_v2::Order>(&v1) == 0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::open_order_exists());
        is_pool_and_vault_compatible<T0, T1, T2>(arg1, arg0);
        ...
        while (v4 < arg2 && 0x2::linked_table::length<address, WithdrawRequest<T2>>(&v5.requests) > 0) {
            ...
            0x2::balance::join<T0>(&mut arg0.fees_x, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v18, 0x2::coin::value<T0>(&v18) * v2 / 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::constants::withdraw_fee_scaling_factor(), arg4)));
            0x2::balance::join<T1>(&mut arg0.fees_y, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v19, 0x2::coin::value<T1>(&v19) * v2 / 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::constants::withdraw_fee_scaling_factor(), arg4)));
    ...
    public(friend) fun revoke_trading_permission<T0, T1, T2>(arg0: &VaultCap, arg1: &mut Vault<T0, T1, T2>, arg2: address) {
        ...
        assert!(v0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::address_not_whitelisted());
    ...
    public(friend) fun seed_vault<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T2>(&arg0.seed_balance) == 0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::vault_already_seeded());
        is_pool_and_vault_compatible<T0, T1, T2>(arg1, arg0);
        assert!(arg4 > 0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::invalid_lp_tokens_to_mint());
        assert!(0x2::balance::value<T0>(&arg2) > 0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::too_less_deposit_to_seed());
        assert!(0x2::balance::value<T1>(&arg3) > 0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::too_less_deposit_to_seed());
        let v0 = &arg0.deepbook_account_cap;
    ...
    public(friend) fun start_strategy<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        ...
        let v0 = &arg0.withdraw_queue;
        let v1 = 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::constants::strategy_paused_and_ready_for_withdrawal_processing();
        assert!(&arg0.state == &v1 && v0.pending_requests == 0, 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::error::strategy_not_ready_to_make_active());
        arg0.state = 0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::constants::strategy_active();
    ...
    public entry fun withdraw_all_funds<T0, T1, T2>(arg0: &0x19d4b7bcf29257b4a372d2f8ea151359da960a1ca6984dcb80dfd895343f6353::app::AdminCap, arg1: &mut Vault<T0, T1, T2>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) {
