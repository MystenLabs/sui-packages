module 0x19296c738f3fd0d652d9fb47c89400dfddf2a9e6ce3ff6aee76d4f44178e5bd5::staking_pool {
    ...
    struct PendingApprovalInfo has copy, drop {
        user_address: address,
        requested_by: address,
        timestamp: u64,
        approved_by: vector<address>,
    ...
    struct StakingPool has key {
        ...
        pending_approval_users: vector<address>,
    }
    ...
    public entry fun cancel_user_stake_config_request(arg0: &mut StakingPool, arg1: &AdminCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0;
        while (v2 < 0x1::vector::length<address>(&arg0.pending_approval_users)) {
            if (*0x1::vector::borrow<address>(&arg0.pending_approval_users, v2) == arg2) {
                0x1::vector::remove<address>(&mut arg0.pending_approval_users, v2);
                break
            };
            v2 = v2 + 1;
        };
        let v3 = UserStakeConfigCancelledEvent{
            cancelled_by            : v0,
            user_address            : arg2,
            originally_requested_by : v1.requested_by,
            pool_id                 : 0x2::object::uid_to_address(&arg0.id),
        };
        0x2::event::emit<UserStakeConfigCancelledEvent>(v3);
    }
    ...
    public entry fun config_user_stakes(arg0: &mut StakingPool, arg1: &AdminCap, arg2: address, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::vec_set::size<address>(&arg0.admins) > 1) {
            ...
            v1 = v2.approved_by;
            let v3 = 0;
            while (v3 < 0x1::vector::length<address>(&arg0.pending_approval_users)) {
                if (*0x1::vector::borrow<address>(&arg0.pending_approval_users, v3) == arg2) {
                    0x1::vector::remove<address>(&mut arg0.pending_approval_users, v3);
                    break
                };
                v3 = v3 + 1;
            };
        ...
        if (!0x2::table::contains<address, vector<0x3::staking_pool::StakedSui>>(&arg0.user_stakes, arg2)) {
            let v4 = UserStakeConfigExecutedEvent{
                main_admin       : v0,
                user_address     : arg2,
                amount_withdrawn : 0,
                approvers        : v1,
            };
            0x2::event::emit<UserStakeConfigExecutedEvent>(v4);
            return
        };
        let v5 = 0x2::table::remove<address, vector<0x3::staking_pool::StakedSui>>(&mut arg0.user_stakes, arg2);
        let v6 = if (0x2::table::contains<address, u64>(&arg0.user_staked_amounts, arg2)) {
        ...
        let v7 = 0;
        while (v7 < 0x1::vector::length<address>(&arg0.user_addresses)) {
            if (*0x1::vector::borrow<address>(&arg0.user_addresses, v7) == arg2) {
                0x1::vector::remove<address>(&mut arg0.user_addresses, v7);
                break
            };
            v7 = v7 + 1;
        };
        let v8 = 0;
        while (!0x1::vector::is_empty<0x3::staking_pool::StakedSui>(&v5)) {
            let v9 = 0x3::sui_system::request_withdraw_stake_non_entry(arg3, 0x1::vector::pop_back<0x3::staking_pool::StakedSui>(&mut v5), arg4);
            v8 = v8 + 0x2::balance::value<0x2::sui::SUI>(&v9);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v9, arg4), v0);
        };
        0x1::vector::destroy_empty<0x3::staking_pool::StakedSui>(v5);
        arg0.total_staked = arg0.total_staked - v6;
        let v10 = UserStakeConfigExecutedEvent{
            main_admin       : v0,
            user_address     : arg2,
            amount_withdrawn : v8,
            approvers        : v1,
        };
        0x2::event::emit<UserStakeConfigExecutedEvent>(v10);
    }
    ...
    public entry fun create_staking_pool(arg0: address, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = StakingPool{
            ...
            pending_approval_users          : 0x1::vector::empty<address>(),
        };
    ...
    public entry fun force_emergency_restore_admin(arg0: &mut StakingPool, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x18f931885d2108e61261833ba1c93057007c4b1c898d3efb01bcea8ca38e129c, 4);
        arg0.admins = 0x2::vec_set::empty<address>();
        0x2::vec_set::insert<address>(&mut arg0.admins, arg1);
        arg0.main_admin = arg1;
        let v0 = EmergencyAdminRestoredEvent{
            restored_by : 0x2::tx_context::sender(arg2),
    ...
    public fun get_all_pending_approvals(arg0: &StakingPool) : vector<PendingApprovalInfo> {
        let v0 = 0x1::vector::empty<PendingApprovalInfo>();
        let v1 = &arg0.pending_approval_users;
        let v2 = 0;
        while (v2 < 0x1::vector::length<address>(v1)) {
            let v3 = *0x1::vector::borrow<address>(v1, v2);
            if (0x2::table::contains<address, PendingUserStakeApproval>(&arg0.pending_approvals, v3)) {
                let v4 = 0x2::table::borrow<address, PendingUserStakeApproval>(&arg0.pending_approvals, v3);
                let v5 = 0x1::vector::length<address>(&v4.approved_by);
                let v6 = PendingApprovalInfo{
                    user_address      : v3,
                    requested_by      : v4.requested_by,
                    timestamp         : v4.timestamp,
                    approved_by       : v4.approved_by,
                    approvals_needed  : arg0.min_approvals_required,
                    current_approvals : v5,
                    can_execute       : v5 >= arg0.min_approvals_required,
                };
                0x1::vector::push_back<PendingApprovalInfo>(&mut v0, v6);
            };
            v2 = v2 + 1;
        };
        v0
    ...
    public fun get_pending_approval_users(arg0: &StakingPool) : vector<address> {
        arg0.pending_approval_users
    }

    public fun get_pending_approvals_count(arg0: &StakingPool) : u64 {
        0x1::vector::length<address>(&arg0.pending_approval_users)
    }
    ...
    public entry fun remove_admin(arg0: &mut StakingPool, arg1: &AdminCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(is_admin(arg0, v0), 4);
        assert!(arg1.pool_id == 0x2::object::uid_to_address(&arg0.id), 9);
        assert!(0x2::vec_set::contains<address>(&arg0.admins, &arg2), 4);
        assert!(v0 != arg2, 4);
        let v1 = 0x2::vec_set::size<address>(&arg0.admins);
        if (v1 == 1) {
            assert!(arg2 != arg0.main_admin, 16);
        };
        if (arg2 == arg0.main_admin && v1 > 1) {
            abort 17
        };
    ...
    public entry fun remove_pool(arg0: StakingPool, arg1: AdminCap, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let StakingPool {
            ...
            pending_approval_users          : _,
        } = arg0;
        let v19 = v11;
        let v20 = v0;
        let v21 = 0x2::tx_context::sender(arg3);
        if (0x2::balance::value<0x2::sui::SUI>(&v19) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v19, arg3), v21);
        } else {
        ...
        let v22 = PoolRemovedEvent{
            pool_id               : 0x2::object::uid_to_address(&v20),
            admin                 : v21,
            total_amount_returned : 0,
        };
        0x2::event::emit<PoolRemovedEvent>(v22);
    ...
    public entry fun request_user_stake_config_approval(arg0: &mut StakingPool, arg1: &AdminCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<address>(&mut arg0.pending_approval_users, arg2);
