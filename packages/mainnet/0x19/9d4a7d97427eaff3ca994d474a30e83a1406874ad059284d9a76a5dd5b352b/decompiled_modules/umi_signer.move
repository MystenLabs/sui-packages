module 0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::umi_signer {
    ...
    public fun borrow_for_signing<T0: store + key>(arg0: &mut UmiSigner, arg1: ChainId, arg2: &0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::SigningPolicy, arg3: 0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::SigningRequest, arg4: &mut 0x2::tx_context::TxContext) : (T0, BorrowReceipt<T0>) {
        assert!(has_wallet(arg0, arg1), 3);
        assert!(0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::signer_id(&arg3) == 0x2::object::id<UmiSigner>(arg0), 8);
        assert!(0x2::object::id<0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::SigningPolicy>(arg2) == arg0.policy_id, 9);
        0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::verify_request<UmiSigner>(&arg3, arg2, arg0, arg4);
        0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::destroy_request(arg3);
        ...
        let v7 = SigningOccurred{
            ...
            chain_id    : arg1.name,
            wallet_id   : v2,
            intent_hash : 0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::intent_hash(&arg3),
        };
    ...
    entry fun default(arg0: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3) = new_with_policy(arg0);
        0x2::transfer::share_object<UmiSigner>(v0);
        0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::share(v2);
        0x2::transfer::transfer<UmiSignerOwnerCap>(v1, 0x2::tx_context::sender(arg0));
        0x2::transfer::public_transfer<0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::SigningPolicyCap>(v3, 0x2::tx_context::sender(arg0));
    }
    ...
    public fun lock<T0: store + key>(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: &0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::SigningPolicy, arg4: T0, arg5: &0x2::tx_context::TxContext) {
    ...
    fun new_internal(arg0: &mut 0x2::tx_context::TxContext, arg1: 0x2::object::ID) : (UmiSigner, UmiSignerOwnerCap) {
        let v0 = UmiSigner{
    ...
    public fun new_with_policy(arg0: &mut 0x2::tx_context::TxContext) : (UmiSigner, UmiSignerOwnerCap, 0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::SigningPolicy, 0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::SigningPolicyCap) {
        let (v0, v1) = 0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::new(arg0);
        let v2 = v1;
        let v3 = v0;
        let (v4, v5) = new_internal(arg0, 0x2::object::id<0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::signing_policy::SigningPolicy>(&v3));
        let v6 = 0x1::vector::empty<address>();
        0x1::vector::push_back<address>(&mut v6, 0x2::tx_context::sender(arg0));
        0x199d4a7d97427eaff3ca994d474a30e83a1406874ad059284d9a76a5dd5b352b::authorization_rule::add(&mut v3, &v2, v6);
        (v4, v5, v3, v2)
    }
