module 0xc13b4af41b57a80410a30c802f9b772f41c220382e5cb8fa48011085d91e9184::templates {
    ...
    public fun add_review(arg0: &License, arg1: u8, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg1 >= 1 && arg1 <= 5, 20);
        assert!(0x1::string::length(&arg2) <= 600, 16);
        let v0 = ReviewPosted{
            template    : arg0.template,
            template_id : arg0.template_id,
            license     : 0x2::object::id<License>(arg0),
            author      : 0x2::tx_context::sender(arg4),
            stars       : arg1,
            text        : arg2,
            at_ms       : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<ReviewPosted>(v0);
    }
