module 0x1939ccd079197c5cf698c8e633e9000d7e1d70633b4380bfe7a83ab2cdb1cc3a::reward6612 {
    struct REWARD6612 has drop {
        dummy_field: bool,
    }

    struct TICKET_6612 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6612(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6612>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6612>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6612, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6612>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6612>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6612>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6612>>(v5, 0x2::tx_context::sender(arg1));
    }
