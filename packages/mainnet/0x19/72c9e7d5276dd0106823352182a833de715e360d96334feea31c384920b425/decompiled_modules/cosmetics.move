module 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::cosmetics {
    ...
    struct RewardVault has store, key {
        ...
        bones_sale_balance: 0x2::coin::Coin<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>,
        bones_sale_unit: u64,
    ...
    public entry fun admin_fund_bones(arg0: &CosmeticAdminCap, arg1: &CosmeticCollection, arg2: &mut RewardVault, arg3: 0x2::coin::Coin<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg1.admin_address, 1);
        0x2::coin::join<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>(&mut arg2.bones_sale_balance, arg3);
    }
    ...
    public entry fun admin_initialize(arg0: &CosmeticAdminCap, arg1: &mut CosmeticCollection, arg2: &mut RewardVault, arg3: &mut GodNFTList, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        arg1.admin_address = arg4;
        if (0x1::vector::length<0x1::string::String>(&arg1.trait_categories) == 0) {
            ...
            arg1.trait_categories = v0;
        };
        arg1.available_index = 0x1::vector::empty<0x2::object::ID>();
        let v2 = 0;
        while (v2 < 0x1::vector::length<0x2::object::ID>(&arg1.catalog_index)) {
            let v3 = *0x1::vector::borrow<0x2::object::ID>(&arg1.catalog_index, v2);
            if (0x2::table::contains<0x2::object::ID, CosmeticTemplate>(&arg1.cosmetic_catalog, v3)) {
                if (0x2::table::borrow<0x2::object::ID, CosmeticTemplate>(&arg1.cosmetic_catalog, v3).available) {
                    0x1::vector::push_back<0x2::object::ID>(&mut arg1.available_index, v3);
                };
            };
            v2 = v2 + 1;
        };
        if (arg2.god_prize_bps == 0) {
            arg2.god_prize_bps = 40;
        };
        if (arg2.token_prize_bps == 0) {
            arg2.token_prize_bps = 500;
        };
        if (arg2.nft_prize_bps == 0) {
            arg2.nft_prize_bps = 200;
        };
        if (arg2.free_pass_bps == 0) {
            arg2.free_pass_bps = 1000;
        };
    }
    ...
    public entry fun admin_mint_cosmetic_for_doonie(arg0: &CosmeticAdminCap, arg1: &mut CosmeticCollection, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg1.admin_address, 1);
        ...
        let v1 = create_cosmetic_instance(v0, arg2, arg4);
        if (0x1::option::is_some<u64>(&v0.stock)) {
            assert!(*0x1::option::borrow<u64>(&v0.stock) > 0, 10);
            let v2 = 0x1::option::borrow_mut<u64>(&mut v0.stock);
            *v2 = *v2 - 1;
            if (*v2 == 0) {
                v0.available = false;
        ...
        apply_cosmetic(arg1, v1, arg3, arg4);
    }
    ...
    public entry fun admin_reroll_to_god(arg0: &CosmeticAdminCap, arg1: &CosmeticCollection, arg2: &mut GodNFTList, arg3: &mut 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFTCollection, arg4: 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT, arg5: &mut 0x2::transfer_policy::TransferPolicy<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &0x2::random::Random, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg9) == arg1.admin_address, 1);
        assert!(!0x1::vector::is_empty<u64>(&arg2.available_god_ids), 10);
        let v0 = 0x2::tx_context::sender(arg9);
        let v1 = 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::get_token_id(&arg4);
        ...
        0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::burn_nft_internal(arg4, arg3);
        let v5 = 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::create_nft_with_attributes(arg3, v1, *0x2::table::borrow<u64, 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>(&arg2.god_nfts, v4), arg9);
        let v6 = 0x2::object::id<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>(&v5);
        0x2::kiosk::lock<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>(arg6, arg7, arg5, v5);
    ...
    public entry fun admin_reroll_to_specific_god(arg0: &CosmeticAdminCap, arg1: &CosmeticCollection, arg2: &mut GodNFTList, arg3: &mut 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFTCollection, arg4: 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT, arg5: &mut 0x2::transfer_policy::TransferPolicy<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg9) == arg1.admin_address, 1);
        assert!(0x2::table::contains<u64, 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>(&arg2.god_nfts, arg8), 5);
        let (v0, v1) = 0x1::vector::index_of<u64>(&arg2.available_god_ids, &arg8);
        assert!(v0, 10);
        0x1::vector::remove<u64>(&mut arg2.available_god_ids, v1);
        let v2 = 0x2::tx_context::sender(arg9);
        let v3 = 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::get_token_id(&arg4);
        0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::burn_nft_internal(arg4, arg3);
        let v4 = 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::create_nft_with_attributes(arg3, v3, *0x2::table::borrow<u64, 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>(&arg2.god_nfts, arg8), arg9);
        let v5 = 0x2::object::id<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>(&v4);
        0x2::kiosk::lock<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>(arg6, arg7, arg5, v4);
        let v6 = GodNFTReminted{
            old_token_id : v3,
            new_token_id : v3,
            new_nft_id   : v5,
            god_token_id : arg8,
        ...
        0x2::event::emit<GodNFTReminted>(v6);
        let v7 = VaultPrizeRolled{
            sender     : v2,
            prize_type : 0x1::string::utf8(b"god"),
            prize_id   : v5,
        };
        0x2::event::emit<VaultPrizeRolled>(v7);
    }
    ...
    public entry fun buy_bones(arg0: &mut RewardVault, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>(&arg0.bones_sale_balance) >= v1, 10);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>>(0x2::coin::split<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>(&mut arg0.bones_sale_balance, v1, arg3), 0x2::tx_context::sender(arg3));
    ...
    public entry fun claim_token<T0>(arg0: &mut CosmeticCollection, arg1: &mut RewardVault, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = get_or_create_pending(arg0, v0, arg3);
    ...
    fun perform_roll(arg0: &mut CosmeticCollection, arg1: &mut RewardVault, arg2: &mut GodNFTList, arg3: &mut 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFTCollection, arg4: 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT, arg5: &mut 0x2::transfer_policy::TransferPolicy<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &0x2::random::Random, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::random::generate_u64_in_range(&mut v2, 0, 10000) < arg1.god_prize_bps) {
            assert!(!0x1::vector::is_empty<u64>(&arg2.available_god_ids), 10);
            let v3 = 0x1::vector::length<u64>(&arg2.available_god_ids);
            let v4 = 0x2::random::generate_u64_in_range(&mut v2, 0, v3);
            let v5 = if (v4 == v3) {
                v3 - 1
            } else {
                v4
            };
            let v6 = *0x1::vector::borrow<u64>(&arg2.available_god_ids, v5);
            0x1::vector::remove<u64>(&mut arg2.available_god_ids, v5);
            assert!(0x2::table::contains<u64, 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>(&arg2.god_nfts, v6), 5);
            0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::burn_nft_internal(arg4, arg3);
            let v7 = 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::create_nft_with_attributes(arg3, v1, *0x2::table::borrow<u64, 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>(&arg2.god_nfts, v6), arg9);
            let v8 = 0x2::object::id<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>(&v7);
            0x2::kiosk::lock<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>(arg6, arg7, arg5, v7);
            let v9 = GodNFTReminted{
                old_token_id : v1,
                new_token_id : v1,
                new_nft_id   : v8,
                god_token_id : v6,
            ...
            0x2::event::emit<GodNFTReminted>(v9);
            let v10 = VaultPrizeRolled{
                sender     : v0,
                prize_type : 0x1::string::utf8(b"god"),
                prize_id   : v8,
            };
            0x2::event::emit<VaultPrizeRolled>(v10);
        } else {
            let v11 = 0x2::random::generate_u64_in_range(&mut v2, 0, 10000);
            if (v11 < arg1.token_prize_bps && !0x1::vector::is_empty<0x2::object::ID>(&arg1.token_prize_ids)) {
                let v12 = 0x1::vector::length<0x2::object::ID>(&arg1.token_prize_ids);
                let v13 = 0x2::random::generate_u64_in_range(&mut v2, 0, v12);
                let v14 = if (v13 == v12) {
                    v12 - 1
                } else {
                    v13
                };
                let v15 = *0x1::vector::borrow<0x2::object::ID>(&arg1.token_prize_ids, v14);
                0x1::vector::push_back<0x2::object::ID>(&mut get_or_create_pending(arg0, v0, arg9).token_prize_ids, v15);
                0x1::vector::swap_remove<0x2::object::ID>(&mut arg1.token_prize_ids, v14);
                let v16 = VaultPrizeRolled{
                    sender     : v0,
                    prize_type : 0x1::string::utf8(b"token"),
                    prize_id   : v15,
                };
                0x2::event::emit<VaultPrizeRolled>(v16);
            } else if (v11 < arg1.token_prize_bps + arg1.nft_prize_bps) {
                if (!0x1::vector::is_empty<0x2::object::ID>(&arg1.nft_direct_prize_ids)) {
                    let v17 = 0x1::vector::length<0x2::object::ID>(&arg1.nft_direct_prize_ids);
                    let v18 = 0x2::random::generate_u64_in_range(&mut v2, 0, v17);
                    let v19 = if (v18 == v17) {
                        v17 - 1
                    } else {
                        v18
                    };
                    let v20 = *0x1::vector::borrow<0x2::object::ID>(&arg1.nft_direct_prize_ids, v19);
                    0x1::vector::push_back<0x2::object::ID>(&mut get_or_create_pending(arg0, v0, arg9).nft_direct_prize_ids, v20);
                    0x1::vector::swap_remove<0x2::object::ID>(&mut arg1.nft_direct_prize_ids, v19);
                    ...
                    let v22 = 0x1::vector::length<0x2::object::ID>(&arg1.nft_kiosk_prize_ids);
                    let v23 = 0x2::random::generate_u64_in_range(&mut v2, 0, v22);
                    let v24 = if (v23 == v22) {
                        v22 - 1
                    } else {
                        v23
                    };
                    let v25 = *0x1::vector::borrow<0x2::object::ID>(&arg1.nft_kiosk_prize_ids, v24);
                    0x1::vector::push_back<0x2::object::ID>(&mut get_or_create_pending(arg0, v0, arg9).nft_kiosk_prize_ids, v25);
                    0x1::vector::swap_remove<0x2::object::ID>(&mut arg1.nft_kiosk_prize_ids, v24);
                    let v26 = VaultPrizeRolled{
                        sender     : v0,
                        prize_type : 0x1::string::utf8(b"nft"),
                        prize_id   : v25,
                    };
                    0x2::event::emit<VaultPrizeRolled>(v26);
                } else {
                    let v27 = VaultPrizeRolled{
                        sender     : v0,
                        prize_type : 0x1::string::utf8(b"none"),
                        prize_id   : 0x2::object::id<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>(&arg4),
                    };
                    0x2::event::emit<VaultPrizeRolled>(v27);
                };
            } else if (v11 < arg1.token_prize_bps + arg1.nft_prize_bps + arg1.free_pass_bps) {
                if (arg1.free_pass_price_sui > 0) {
                    ...
                    0x2::transfer::public_transfer<FreePassNFT>(v28, v0);
                    let v29 = VaultPrizeRolled{
                        sender     : v0,
                        prize_type : 0x1::string::utf8(b"pass"),
                        prize_id   : 0x2::object::id<FreePassNFT>(&v28),
                    };
                    0x2::event::emit<VaultPrizeRolled>(v29);
                } else {
                    let v30 = VaultPrizeRolled{
                        sender     : v0,
                        prize_type : 0x1::string::utf8(b"none"),
                        prize_id   : 0x2::object::id<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>(&arg4),
                    };
                    0x2::event::emit<VaultPrizeRolled>(v30);
                };
            } else {
                let v31 = VaultPrizeRolled{
                    sender     : v0,
                    prize_type : 0x1::string::utf8(b"none"),
                    prize_id   : 0x2::object::id<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>(&arg4),
                };
                0x2::event::emit<VaultPrizeRolled>(v31);
            };
            0x2::kiosk::lock<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>(arg6, arg7, arg5, arg4);
        };
    }

    public entry fun publisher_bootstrap_cosmetics(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new<CosmeticNFT>(arg0, arg1);
        ...
        let v6 = 0x2::display::new<FreePassNFT>(arg0, arg1);
        ...
        let (v7, v8) = 0x2::transfer_policy::new<CosmeticNFT>(arg0, arg1);
        let v9 = GodNFTList{
            id                : 0x2::object::new(arg1),
        ...
        let v10 = RewardVault{
            ...
            nft_direct_prize_ids : 0x1::vector::empty<0x2::object::ID>(),
            nft_kiosk_prize_ids  : 0x1::vector::empty<0x2::object::ID>(),
            bones_sale_balance   : 0x2::coin::zero<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>(arg1),
        ...
        0x2::transfer::transfer<CosmeticAdminCap>(v4, v0);
        0x2::transfer::public_transfer<0x2::display::Display<CosmeticNFT>>(v5, v0);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<CosmeticNFT>>(v8, v0);
        0x2::transfer::public_transfer<0x2::display::Display<FreePassNFT>>(v6, v0);
    ...
    public entry fun purchase_cosmetic(arg0: &mut CosmeticCollection, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::table::contains<0x2::object::ID, CosmeticTemplate>(&arg0.cosmetic_catalog, arg1), 10);
        ...
        assert!(0x2::coin::value<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>(&arg2) >= v2, 12);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>>(0x2::coin::split<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>(&mut arg2, v2, arg3), arg0.admin_address);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>>(arg2, v0);
    ...
    public entry fun roll_vault_prize(arg0: &mut CosmeticCollection, arg1: &mut RewardVault, arg2: &mut GodNFTList, arg3: &mut 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFTCollection, arg4: 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT, arg5: &mut 0x2::transfer_policy::TransferPolicy<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies::NFT>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &0x2::random::Random, arg9: 0x2::coin::Coin<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.paused, 13);
        assert!(0x2::coin::value<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>(&arg9) >= 1000, 12);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>>(0x2::coin::split<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>(&mut arg9, 1000, arg10), arg0.admin_address);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::bones::BONES>>(arg9, 0x2::tx_context::sender(arg10));
