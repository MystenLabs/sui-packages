module 0x199c103974c5f85182796190f42ea06c23d0a232622d1bbeb3cbe5b8e83b6707::hydro_pump {
    ...
    fun buy_<T0>(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut Pool<T0>, arg2: u64, arg3: u64, arg4: address, arg5: address, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        let v2 = 0x199c103974c5f85182796190f42ea06c23d0a232622d1bbeb3cbe5b8e83b6707::curves::calculate_add_liquidity_cost(arg1.virtual_sui_reserves, arg1.virtual_token_reserves, v1);
    ...
    public entry fun quick_buy<T0>(arg0: &mut Config, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v5 * v1 / 10000;
        let v7 = v4.virtual_token_reserves - 0x2::coin::value<T0>(&v4.remain_token_reserves);
        let v8 = 0x199c103974c5f85182796190f42ea06c23d0a232622d1bbeb3cbe5b8e83b6707::curves::calculate_token_amount_received(v4.virtual_sui_reserves, v4.virtual_token_reserves, v5 - v6);
        let v9 = 0x1::u64::min(0x1::option::extract<u64>(&mut v8), v7);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v6, arg3), v0);
        let v10 = 0x2::coin::zero<T0>(arg3);
        let (v11, v12) = swap<T0>(v4, v10, arg1, v9, v5 - v6, arg3);
        let v13 = v12;
        let v14 = v11;
        v4.virtual_token_reserves = v4.virtual_token_reserves - 0x2::coin::value<T0>(&v14);
        if (v7 == v9 || 0x2::coin::value<0x2::sui::SUI>(&v4.real_sui_reserves) >= v3) {
            migrate_pool<T0>(v4, v2, arg2, arg3);
        };
        ...
        let v16 = TradedEvent{
            ...
            user                   : v15,
            token_address          : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            sui_amount             : 0x2::coin::value<0x2::sui::SUI>(&v13),
            token_amount           : v9,
            virtual_sui_reserves   : v4.virtual_sui_reserves,
            virtual_token_reserves : v4.virtual_token_reserves,
            ts                     : 0x2::clock::timestamp_ms(arg2),
        };
        0x2::event::emit<TradedEvent>(v16);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v13, v15);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v14, v15);
    }
    ...
    public fun sell_returns<T0>(arg0: &mut Config, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        assert!(v3 > 0, 1);
        let v4 = 0x199c103974c5f85182796190f42ea06c23d0a232622d1bbeb3cbe5b8e83b6707::curves::calculate_remove_liquidity_return(v2.virtual_token_reserves, v2.virtual_sui_reserves, v3);
