module 0x19bdcb7c71b02744b2d89906aacafeb1687901e7a3ea0502ba06f9646a9de31a::vault {
    ...
    struct Vault has key {
        ...
        approved_managers: 0x2::table::Table<address, bool>,
    ...
    struct ManagerApprovedEvent has copy, drop {
        manager: address,
    }

    struct ManagerRemovedEvent has copy, drop {
        manager: address,
    }

    public entry fun add_approved_manager(arg0: &mut Vault, arg1: address, arg2: &AdminCap) {
        if (!0x2::table::contains<address, bool>(&arg0.approved_managers, arg1)) {
            0x2::table::add<address, bool>(&mut arg0.approved_managers, arg1, true);
            let v0 = ManagerApprovedEvent{manager: arg1};
            0x2::event::emit<ManagerApprovedEvent>(v0);
        };
    }
    ...
    public fun deposit(arg0: &mut Vault, arg1: address, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<VAULT>, 0x1::string::String) {
        ...
        assert!(v0, 1);
        assert!(is_manager_approved(arg0, arg1), 11);
    ...
    fun init(arg0: VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = Vault{
            ...
            deposit_counter         : 0,
            treasury_cap            : v0,
            approved_managers       : 0x2::table::new<address, bool>(arg1),
            total_rewards_committed : 0,
        };
        0x2::transfer::share_object<Vault>(v3);
    }

    public fun is_approved_manager(arg0: &Vault, arg1: address) : bool {
        is_manager_approved(arg0, arg1)
    }

    fun is_manager_approved(arg0: &Vault, arg1: address) : bool {
        0x2::table::contains<address, bool>(&arg0.approved_managers, arg1) && *0x2::table::borrow<address, bool>(&arg0.approved_managers, arg1)
    }
    ...
    public entry fun remove_approved_manager(arg0: &mut Vault, arg1: address, arg2: &AdminCap) {
        if (0x2::table::contains<address, bool>(&arg0.approved_managers, arg1)) {
            0x2::table::remove<address, bool>(&mut arg0.approved_managers, arg1);
            let v0 = ManagerRemovedEvent{manager: arg1};
            0x2::event::emit<ManagerRemovedEvent>(v0);
        };
    }
