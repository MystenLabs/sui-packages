module 0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::reservoir {
    ...
    public(friend) fun handle_charge<T0>(arg0: &mut Reservoir<T0>, arg1: 0x2::balance::Balance<T0>) : u64 {
        ...
        let v1 = 0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::math::mul_div(v0, arg0.conversion_rate, 1000000000);
        0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::reservoir_events::emit_charge_reservoir<T0>(v0, v1);
        0x2::balance::join<T0>(&mut arg0.pool, arg1);
        arg0.usdl_minted_amount = arg0.usdl_minted_amount + v1;
        v1
    }

    public(friend) fun handle_discharge<T0>(arg0: &mut Reservoir<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::math::mul_div(arg1, 1000000000, arg0.conversion_rate);
        assert!(v0 <= pool_balance<T0>(arg0), 0);
        0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::reservoir_events::emit_discharge_reservoir<T0>(v0, arg1);
        arg0.usdl_minted_amount = arg0.usdl_minted_amount - arg1;
