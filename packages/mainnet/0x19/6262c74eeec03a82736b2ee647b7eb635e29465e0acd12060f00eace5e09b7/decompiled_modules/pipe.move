module 0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::pipe {
    ...
    public(friend) fun destroy_usdl_pipe<T0, T1: drop>(arg0: Pipe<T0, T1>) {
        let Pipe {
            id            : v0,
            output_volume : _,
        } = arg0;
    ...
    public fun input<T0, T1: drop>(arg0: T1, arg1: 0x2::balance::Balance<T0>) : InputCarrier<T0, T1> {
        0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::pipe_events::emit_input<T0, T1>(&arg1);
    ...
    public(friend) fun output<T0, T1: drop>(arg0: &mut Pipe<T0, T1>, arg1: 0x2::balance::Balance<T0>) : OutputCarrier<T0, T1> {
        ...
        0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::pipe_events::emit_output<T0, T1>(v0);
