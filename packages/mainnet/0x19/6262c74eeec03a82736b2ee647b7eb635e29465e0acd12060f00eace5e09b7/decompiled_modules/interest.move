module 0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::interest {
    ...
    public(friend) fun accrue_active_interests(arg0: &mut InterestTable, arg1: u64, arg2: &0x2::clock::Clock) : (u256, u256) {
        ...
        let v2 = 0;
        if (v1 > 0) {
            let v3 = 0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::math::mul_factor_u256((arg1 as u256), v1, 0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::constants::interest_precision());
            v2 = v3;
    ...
    public(friend) fun calculate_interest_index(arg0: &InterestTable, arg1: &0x2::clock::Clock) : (u256, u256) {
        ...
        if (v1 > 0) {
            ...
            v4 = v5;
            v3 = v2 + 0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::math::mul_factor_u256(v2, v5, 0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::constants::interest_precision());
        };
        (v3, v4)
    }
    ...
    public(friend) fun collect_interests(arg0: &mut InterestTable) : u64 {
        ...
        assert!(v0 <= (0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::constants::max_u64() as u256), 0);
        (v0 as u64)
    }
    ...
    public(friend) fun new_interest_table(arg0: &0x2::clock::Clock, arg1: &mut 0x2::tx_context::TxContext) : InterestTable {
        InterestTable{
            id                       : 0x2::object::new(arg1),
            interest_rate            : 0,
            active_interest_index    : 0x196262c74eeec03a82736b2ee647b7eb635e29465e0acd12060f00eace5e09b7::constants::interest_precision(),
