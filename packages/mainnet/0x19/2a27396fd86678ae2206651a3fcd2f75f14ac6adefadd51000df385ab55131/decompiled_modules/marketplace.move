module 0x192a27396fd86678ae2206651a3fcd2f75f14ac6adefadd51000df385ab55131::marketplace {
    ...
    public entry fun deposit_nft_to_admin<T0: store + key>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<T0>(arg0, @0x3a74d8e94bf49bb738a3f1dedcc962ed01c89f78d21c01d87ee5e6980f0750e9);
        let v0 = NFTDeposited{
            nft_id : 0x2::object::id<T0>(&arg0),
            seller : 0x2::tx_context::sender(arg1),
            admin  : @0x3a74d8e94bf49bb738a3f1dedcc962ed01c89f78d21c01d87ee5e6980f0750e9,
        };
