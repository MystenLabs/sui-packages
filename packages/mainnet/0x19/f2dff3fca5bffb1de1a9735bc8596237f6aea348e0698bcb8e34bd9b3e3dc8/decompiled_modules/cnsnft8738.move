module 0x19f2dff3fca5bffb1de1a9735bc8596237f6aea348e0698bcb8e34bd9b3e3dc8::cnsnft8738 {
    struct CNSNFT8738 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8738, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1437"));
        let v4 = 0x2::package::claim<CNSNFT8738>(arg0, arg1);
