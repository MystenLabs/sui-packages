module 0x1995d8f26fb1028c974da24eed917c868dd17074f70403beef6d2efeddc2efff::ido_claim_public {
    ...
    public entry fun create_pool_claim(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x1995d8f26fb1028c974da24eed917c868dd17074f70403beef6d2efeddc2efff::witness::check_owner(arg5), 1);
        let v0 = PoolClaim{
            ...
            percent         : arg3,
            total_percent   : arg4,
            key             : 0x1995d8f26fb1028c974da24eed917c868dd17074f70403beef6d2efeddc2efff::utils::get_key_claim(),
        };
    ...
    public fun init_ido(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = TocenIdoDataClaim{
            ...
            total_token_sale         : 0x1995d8f26fb1028c974da24eed917c868dd17074f70403beef6d2efeddc2efff::utils::get_total_token_sale(),
            percent_rate_price_sale  : 0x1995d8f26fb1028c974da24eed917c868dd17074f70403beef6d2efeddc2efff::utils::get_percent_rate_price_sale(),
            rate_price_sale          : 0x1995d8f26fb1028c974da24eed917c868dd17074f70403beef6d2efeddc2efff::utils::get_rate_price_sale(),
            total_claimed            : 0,
            timestamp_start_not_sale : 0x1995d8f26fb1028c974da24eed917c868dd17074f70403beef6d2efeddc2efff::utils::get_time_not_sale(),
            not_sale                 : 0x2::balance::zero<0x2::sui::SUI>(),
            key_not_sale             : 0x1995d8f26fb1028c974da24eed917c868dd17074f70403beef6d2efeddc2efff::utils::get_key_not_sale(),
        };
    ...
    public entry fun pool_claim_not_sale(arg0: &mut TocenIdoDataClaim, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x1995d8f26fb1028c974da24eed917c868dd17074f70403beef6d2efeddc2efff::witness::check_owner(arg3), 1);
    ...
    public entry fun token_pool_claim(arg0: &mut PoolClaim, arg1: u64, arg2: 0x2::coin::Coin<0xd2013e206f7983f06132d5b61f7c577638ff63171221f4f600a98863febdfb47::toce::TOCE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x1995d8f26fb1028c974da24eed917c868dd17074f70403beef6d2efeddc2efff::witness::check_owner(arg4), 1);
    ...
    public entry fun up_pool_claim(arg0: &mut PoolClaim, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x1995d8f26fb1028c974da24eed917c868dd17074f70403beef6d2efeddc2efff::witness::check_owner(arg6), 1);
        assert!(arg1 == arg0.turn, 7);
    ...
    public entry fun update_time_claim_not_sale(arg0: &mut TocenIdoDataClaim, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x1995d8f26fb1028c974da24eed917c868dd17074f70403beef6d2efeddc2efff::witness::check_owner(arg2), 1);
