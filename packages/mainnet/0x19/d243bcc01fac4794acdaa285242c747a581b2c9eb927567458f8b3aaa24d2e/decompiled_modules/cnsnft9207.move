module 0x19d243bcc01fac4794acdaa285242c747a581b2c9eb927567458f8b3aaa24d2e::cnsnft9207 {
    struct CNSNFT9207 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9207, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9207>(arg0, arg1);
