module 0x19451b0e8bbd6ba4b08e604d51d1c50b50c7118be460e11835ba73646003c194::cnsnft5950 {
    struct CNSNFT5950 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5950, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5950>(arg0, arg1);
