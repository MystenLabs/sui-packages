module 0x1923b452d5459d845d745634e3b602ab79170ca6f7c45130c7f647d86d12f46e::cnsnft3502 {
    struct CNSNFT3502 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3502, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3502>(arg0, arg1);
