module 0x199ca556b7fc5f9eb4f00ceb202c03cb1d146d48b81b6342677d0d8b63b3a383::game_2048 {
    ...
    fun convert_weather_to_seed(arg0: u32, arg1: u32, arg2: u32, arg3: &0x2::clock::Clock) : u64 {
        ((arg0 * arg1 + arg2) as u64) * 0x2::clock::timestamp_ms(arg3)
    }

    public fun create_tiles_panel(arg0: &mut 0x2::tx_context::TxContext, arg1: &0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::WeatherOracle, arg2: &0x2::clock::Clock) : Game2048 {
        let v0 = Game2048{
        ...
        let v1 = &mut v0;
        generateTile(v1, arg1, arg2);
        let v2 = &mut v0;
        generateTile(v2, arg1, arg2);
        v0
    }

    public fun generateTile(arg0: &mut Game2048, arg1: &0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::WeatherOracle, arg2: &0x2::clock::Clock) : bool {
        ...
        let v6 = 0x1::vector::borrow<u64>(0x2::vec_set::keys<u64>(&v0), get_random(arg1, arg2) % 0x2::vec_set::size<u64>(&v0));
        let v7 = if (get_random(arg1, arg2) % 6 > 2) {
            4
        } else {
            2
        };
    ...
    fun get_random(arg0: &0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::WeatherOracle, arg1: &0x2::clock::Clock) : u64 {
        let v0 = 2988507;
        let v1 = 2290956;
        generate_random(convert_weather_to_seed(0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::city_weather_oracle_temp(arg0, v0) + 0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::city_weather_oracle_temp(arg0, v1), 0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::city_weather_oracle_pressure(arg0, v0) + 0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::city_weather_oracle_pressure(arg0, v1), (0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::city_weather_oracle_humidity(arg0, v1) as u32) + (0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::city_weather_oracle_humidity(arg0, v0) as u32), arg1))
    }
    ...
    fun get_state(arg0: &Game2048) : vector<u64> {
        if (!arg0.isgameOver) {
    ...
    fun judge(arg0: &0x2::vec_map::VecMap<u64, Tile>) : bool {
    ...
    public entry fun move_tile(arg0: &mut Game2048, arg1: &0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::WeatherOracle, arg2: u8, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v21 = false;
        if (v6) {
            v21 = generateTile(arg0, arg1, arg3);
    ...
    public entry fun new_game(arg0: &0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::WeatherOracle, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = create_tiles_panel(arg2, arg0, arg1);
        0x2::transfer::public_transfer<Game2048>(v0, 0x2::tx_context::sender(arg2));
    }
