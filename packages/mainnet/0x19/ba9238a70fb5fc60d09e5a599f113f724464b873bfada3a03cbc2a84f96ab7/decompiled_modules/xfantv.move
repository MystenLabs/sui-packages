module 0x19ba9238a70fb5fc60d09e5a599f113f724464b873bfada3a03cbc2a84f96ab7::xfantv {
    ...
    fun init(arg0: XFANTV, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<address>(&mut v8, 0x2::tx_context::sender(arg1));
        let v9 = AdminCap{
        ...
        0x2::transfer::share_object<AdminCap>(v9);
        0x2::transfer::share_object<MaxCredit>(v10);
        let v11 = CoinStore{
            id            : 0x2::object::new(arg1),
            coin_treasury : v2,
        };
        0x2::transfer::share_object<CoinStore>(v11);
    }

    public fun init_wallet(arg0: &AdminCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(is_admin(arg0, 0x2::tx_context::sender(arg2)), 2);
        let v0 = Wallet{
