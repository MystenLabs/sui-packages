module 0x1957b6915fd2bd8a0151733f9f5bce3a40d3e1f34e71efcf4f331e7c97403f7a::bee {
    struct BEE has drop {
        dummy_field: bool,
    }
    ...
    public fun bees_tokens_to_coin<T0>(arg0: &mut 0x2::token::Token<T0>, arg1: &BeeCap<T0>, arg2: &mut 0x2::token::TokenPolicy<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v3 = 0xa7415ee362665ccad536de5d540b671fcb7752f40e66a5505e8427111ce50eb::math::mul_div_u128((arg3 as u128), (*0x2::vec_map::get<0x1::string::String, u64>(&0x2::token::rule_config<T0, Burn, BurnCondition>(v1, arg2).percent, &v2) as u128), (100 as u128));
