module 0x19926ca098c25c253c196a81b650bb931d234c13ebc5f933b6fa6d8b0030b27d::nfts {
    ...
    fun init(arg0: NFTS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://sui-heroes.io/hero/{id}"));
    ...
    public fun init_collection<T0>(arg0: &Config, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<Fee<T0>>(v0, 0x2::tx_context::sender(arg1));
    }
