module 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::multi_layer {
    ...
    fun get_orders_by_layer<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2::clock::Clock) : vector<LayerOrderInfo> {
        ...
        while (v2 < 0x1::vector::length<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(&v0)) {
            ...
            let (v6, v7, _) = 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::orderbook_analyzer::parse_order_id(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::order_id(v3));
    ...
    public(friend) fun process_layers<T0, T1, T2, T3>(arg0: &mut 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::mm_state::MMState, arg1: &0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::mm_registry::MMRegistry, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T2, T3>, arg5: &0x2::clock::Clock, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &vector<u64>, arg12: &vector<u64>, arg13: &vector<u64>, arg14: &vector<u64>, arg15: &vector<u64>, arg16: u64, arg17: u64, arg18: u64, arg19: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg20: &0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::config::MMConfig, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::config::is_dry_run(arg20);
        let v3 = 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::config::enable_deep_payment(arg20);
        let v4 = get_orders_by_layer<T0, T1>(arg3, arg2, arg5);
        if (!v2 && 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::config::enable_deep_refill(arg20)) {
            let v5 = 0;
            let v6 = 0;
            while (v6 < v1) {
            ...
            let (_, _) = 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::deep_manager::ensure_deep_balance<T0, T1, T2, T3>(arg3, arg4, arg2, arg19, v5, arg6, arg20, arg5, arg26);
        };
        let v10 = 0;
        while (v10 < v1) {
            let v11 = (v10 as u8);
            let v12 = 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::inv_sizing::apply_multiplier(*0x1::vector::borrow<u64>(arg13, v10), arg17, arg22, arg23);
            let v13 = 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::inv_sizing::apply_multiplier(*0x1::vector::borrow<u64>(arg14, v10), arg18, arg22, arg23);
            ...
            let v19 = v17;
            let v20 = v18;
            if (arg25 > 0 && v17 >= arg25) {
                v19 = arg25 * (100000 - arg7) / 100000;
            };
            if (arg24 > 0 && v18 <= arg24) {
                v20 = arg24 * (100000 + arg8) / 100000;
            };
            let v21 = 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::orders::round_bid_price(v19, arg21);
            let v22 = 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::orders::round_ask_price(v20, arg21);
            let v23 = if (v12 >= arg23) {
                if (v12 >= 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::config::min_order_size(arg20)) {
                    v21 >= 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::config::min_price(arg20)
                } else {
                    false
                }
            } else {
            ...
            let v24 = if (v13 >= arg23) {
                if (v13 >= 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::config::min_order_size(arg20)) {
                    v22 <= 0x199b1201704f05dad94a431f605d515eca8af4930875127e5106aab59ec35b68::config::max_price(arg20)
                } else {
                    false
                }
            } else {
            ...
            if (!v2) {
                if (v15) {
                    if (0x1::option::is_some<LayerOrderInfo>(&v25)) {
                        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::cancel_order<T0, T1>(arg3, arg2, arg19, 0x1::option::borrow<LayerOrderInfo>(&v25).order_id, arg5, arg26);
                    };
                ...
                if (v15) {
                    if (0x1::option::is_some<LayerOrderInfo>(&v26)) {
                        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::cancel_order<T0, T1>(arg3, arg2, arg19, 0x1::option::borrow<LayerOrderInfo>(&v26).order_id, arg5, arg26);
                    };
                    ...
                    if (should_requote_price(v28.price, v22, v14) || should_refresh_order(v28.expire_timestamp, v0)) {
                        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::cancel_order<T0, T1>(arg3, arg2, arg19, v28.order_id, arg5, arg26);
                        if (v24) {
                            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg3, arg2, arg19, v16, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::post_only(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::cancel_maker(), v22, v13, false, v3, arg10, arg5, arg26);
                        };
                    };
                } else if (v24) {
                    0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg3, arg2, arg19, v16, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::post_only(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::cancel_maker(), v22, v13, false, v3, arg10, arg5, arg26);
