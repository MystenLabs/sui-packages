module 0x19d57872db130a5bc1930c623eb786d766b8628baf4150e9e13902a90c856436::pepeai {
    ...
    fun init(arg0: PEPEAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/FRDW2E5s9sTVbZ6YEBKbmJUoemyUuqs8wFbx5YRV8kzs.png?size=lg&key=9789a9                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<PEPEAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PEPEAI    ")))), trim_right(b"PEPE AI                         "), trim_right(b"PEPEAI is more than just a cryptocurrency; it's the embodiment of the synergy between memes and cutting-edge artificial intelligence technology. PEPEAI is the AI-driven evolution of the legendary Pepe meme, reimagined for the digital age.                                                                                  "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
