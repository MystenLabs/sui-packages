module 0x1910cd8a27f1d1422d0edf94365c488b8c9cb485fd97d1517c79d41f3f882979::router {
    ...
    entry fun bluemove_stable_swap_exact_input<T0, T1>(arg0: vector<0x2::coin::Coin<T0>>, arg1: u64, arg2: u64, arg3: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::stable_swap::Dex_Stable_Info, arg4: &0x2::clock::Clock, arg5: u64, arg6: u8, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = merge_coins<T0>(arg0, arg7);
        0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::stable_router::swap_exact_input<T0, T1>(v0, arg1, arg2, arg3, arg4, arg7);
        let v1 = OrderRecord{
            order_id : arg5,
            decimal  : arg6,
        };
    ...
    entry fun bluemove_swap_exact_input<T0, T1>(arg0: u64, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg4: u64, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = merge_coins<T0>(arg1, arg6);
        0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::router::swap_exact_input<T0, T1>(arg0, v0, arg2, arg3, arg6);
        let v1 = OrderRecord{
            order_id : arg4,
            decimal  : arg5,
        };
    ...
    entry fun cetus_swap_a2b<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: vector<0x2::coin::Coin<T0>>, arg3: bool, arg4: u64, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) {
        0x1910cd8a27f1d1422d0edf94365c488b8c9cb485fd97d1517c79d41f3f882979::cetus_adapter::swap<T0, T1>(arg0, arg1, arg2, 0x1::vector::empty<0x2::coin::Coin<T1>>(), true, arg3, arg4, arg5, arg6, arg7, arg10);
        let v0 = OrderRecord{
            order_id : arg8,
            decimal  : arg9,
        };
    ...
    entry fun cetus_swap_b2a<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: vector<0x2::coin::Coin<T1>>, arg3: bool, arg4: u64, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) {
        0x1910cd8a27f1d1422d0edf94365c488b8c9cb485fd97d1517c79d41f3f882979::cetus_adapter::swap<T0, T1>(arg0, arg1, 0x1::vector::empty<0x2::coin::Coin<T0>>(), arg2, false, arg3, arg4, arg5, arg6, arg7, arg10);
        let v0 = OrderRecord{
            order_id : arg8,
            decimal  : arg9,
        };
