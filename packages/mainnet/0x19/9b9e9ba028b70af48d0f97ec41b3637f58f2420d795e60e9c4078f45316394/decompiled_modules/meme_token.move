module 0x199b9e9ba028b70af48d0f97ec41b3637f58f2420d795e60e9c4078f45316394::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"CT", b"Catie coin", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-31T14-07-54.763Z-images (7).jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Catie coin"),
            symbol     : 0x1::string::utf8(b"CT"),
            decimals   : 9,
