module 0x19c8cc0521059d9066c3c68224578dd1f889a68c2d5707ac98b924b33beb58e4::capybara_lootbox {
    ...
    public fun mint_and_share_empty_transfer_policy(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update_storage(arg0: &0x19c8cc0521059d9066c3c68224578dd1f889a68c2d5707ac98b924b33beb58e4::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
