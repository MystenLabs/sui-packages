module 0x1902a49d051c443749ea7899808fcb11ee98c7fddea9dedb43800e060b5fbe7a::cnsnft4768 {
    struct CNSNFT4768 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4768, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4768>(arg0, arg1);
