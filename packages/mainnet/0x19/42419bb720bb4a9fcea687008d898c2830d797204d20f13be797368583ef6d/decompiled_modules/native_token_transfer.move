module 0x1942419bb720bb4a9fcea687008d898c2830d797204d20f13be797368583ef6d::native_token_transfer {
    struct NativeTokenTransfer has copy, drop, store {
        amount: 0x1942419bb720bb4a9fcea687008d898c2830d797204d20f13be797368583ef6d::trimmed_amount::TrimmedAmount,
    ...
    public fun to_bytes(arg0: NativeTokenTransfer) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v7, 0x1942419bb720bb4a9fcea687008d898c2830d797204d20f13be797368583ef6d::trimmed_amount::to_bytes(&v6));
    ...
    public fun destruct(arg0: NativeTokenTransfer) : (0x1942419bb720bb4a9fcea687008d898c2830d797204d20f13be797368583ef6d::trimmed_amount::TrimmedAmount, 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, u16, 0x1::option::Option<vector<u8>>) {
        let NativeTokenTransfer {
            amount       : v0,
            source_token : v1,
            to           : v2,
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : NativeTokenTransfer {
        assert!(0x1942419bb720bb4a9fcea687008d898c2830d797204d20f13be797368583ef6d::bytes4::to_bytes(0x1942419bb720bb4a9fcea687008d898c2830d797204d20f13be797368583ef6d::bytes4::take(arg0)) == x"994e5454", 13906834603840176130);
        ...
        NativeTokenTransfer{
            amount       : 0x1942419bb720bb4a9fcea687008d898c2830d797204d20f13be797368583ef6d::trimmed_amount::new(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_u64_be(arg0), 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_u8(arg0)),
