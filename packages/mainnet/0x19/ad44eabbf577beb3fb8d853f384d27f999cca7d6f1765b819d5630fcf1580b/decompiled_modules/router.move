module 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::router {
    ...
    public entry fun create_and_prebuy<T0>(arg0: &RouterConfig, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::dex_integration::validate_name(arg7, arg0.FlowX, arg0.Aftermath, arg0.Kriya, arg0.Magma), 11);
        ...
        let v3 = 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::create_pool<T0>(0x2::coin::mint<T0>(&mut arg1, arg0.token_supply * 0x1::u64::pow(10, v2), arg8), arg0.ghost_sui_reserves, v2, arg7, arg8);
        let v4 = PoolCreatedEvent{
            pool_id            : 0x2::object::id<0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::Pool<T0>>(&v3),
        ...
        if (0x2::coin::value<0x2::sui::SUI>(&arg3) > 0) {
            let (v5, v6) = 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::swap_manager::swap_a_to_b<T0>(arg0.trade_fee, arg0.min_trade_fee, &mut v3, arg3, b"", arg8);
        ...
        0x2::transfer::public_share_object<0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::Pool<T0>>(v3);
    }

    fun handle_liquidity_migration<T0>(arg0: &mut 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::Pool<T0>, arg1: &RouterConfig, arg2: &mut 0x2::tx_context::TxContext) {
        if (0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::balance_a<T0>(arg0) >= arg1.dex_migration_threshold) {
            0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::complete_pool<T0>(arg0);
            let v0 = 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::borrow_mut_coin_a<T0>(arg0)), arg2);
            let v1 = 0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::borrow_mut_coin_b<T0>(arg0)), arg2);
            let v2 = DexMigrationEvent{
                pool_id          : 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::get_pool_id<T0>(arg0),
                token_type       : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
                token_migrated   : 0x2::coin::value<T0>(&v1),
                sui_migrated     : arg1.dex_migration_value,
                dex_target       : 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::get_dex_target<T0>(arg0),
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v0, arg1.creator_reward, arg2), 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::get_creator<T0>(arg0));
        };
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = RouterConfig{
            ...
            dex_migration_threshold : 1100000000,
            dex_migration_value     : 1000000000,
    ...
    public entry fun swap_a_to_b<T0>(arg0: &RouterConfig, arg1: &mut 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::Pool<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= arg0.min_trade_value, 7);
        assert!(!0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::is_completed<T0>(arg1), 10);
        let v0 = calculate_max_input(arg0.dex_migration_threshold - 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::balance_a<T0>(arg1), arg0.trade_fee, arg0.min_trade_fee);
        ...
        let (v1, v2) = 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::swap_manager::swap_a_to_b<T0>(arg0.trade_fee, arg0.min_trade_fee, arg1, arg2, arg3, arg4);
    ...
    public entry fun swap_b_to_a<T0>(arg0: &RouterConfig, arg1: &mut 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::Pool<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<T0>(&arg2) >= arg0.min_trade_value, 7);
        assert!(!0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::is_completed<T0>(arg1), 10);
        let (v0, v1) = 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::swap_manager::swap_b_to_a<T0>(arg0.trade_fee, arg0.min_trade_fee, arg1, arg2, arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v1, arg0.admin);
    ...
    public entry fun update_migrated<T0>(arg0: &mut RouterConfig, arg1: &mut 0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::Pool<T0>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.admin, 4);
        0x19ad44eabbf577beb3fb8d853f384d27f999cca7d6f1765b819d5630fcf1580b::pool_factory::set_dex_pool_id<T0>(arg1, arg2);
    }
