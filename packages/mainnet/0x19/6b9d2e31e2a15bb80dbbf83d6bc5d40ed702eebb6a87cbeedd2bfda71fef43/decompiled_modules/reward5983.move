module 0x196b9d2e31e2a15bb80dbbf83d6bc5d40ed702eebb6a87cbeedd2bfda71fef43::reward5983 {
    struct REWARD5983 has drop {
        dummy_field: bool,
    }

    struct TICKET_5983 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5983(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5983>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5983>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5983, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5983>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5983>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5983>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5983>>(v5, 0x2::tx_context::sender(arg1));
    }
