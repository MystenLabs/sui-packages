module 0x19a39e3f30140fac6dc15824a1ffd4bbad2ac379fb306132fb630eea0b31f21d::cnsnft9916 {
    struct CNSNFT9916 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9916, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9916>(arg0, arg1);
