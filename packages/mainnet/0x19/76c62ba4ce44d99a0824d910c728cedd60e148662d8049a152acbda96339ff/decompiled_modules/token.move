module 0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::token {
    ...
    struct Token has store, key {
        ...
        uri: 0x2::url::Url,
        edition_number: u32,
        moment: 0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::moment::Moment,
    }
    ...
    public fun moment(arg0: &Token) : &0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::moment::Moment {
        &arg0.moment
    }

    public fun burn(arg0: Token, arg1: &0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::caps::AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        burn_impl(arg0, arg2);
    }
    ...
    public fun get_mut_moment(arg0: &mut Token, arg1: &0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::caps::AdminCap, arg2: &mut 0x2::tx_context::TxContext) : &mut 0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::moment::Moment {
        &mut arg0.moment
    }
    ...
    fun init(arg0: TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::uniqueidset::UniqueIdSet>(0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::uniqueidset::new_set(arg1), 0x2::tx_context::sender(arg1));
    }

    public fun mint(arg0: vector<vector<u8>>, arg1: vector<u32>, arg2: &0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::caps::MinterCap, arg3: &mut 0x2::tx_context::TxContext) : Token {
        assert!(*0x1::vector::borrow<u32>(&arg1, 0) > 0, 513);
        mint_impl(*0x1::vector::borrow<vector<u8>>(&arg0, 0), *0x1::vector::borrow<vector<u8>>(&arg0, 1), *0x1::vector::borrow<vector<u8>>(&arg0, 2), *0x1::vector::borrow<vector<u8>>(&arg0, 3), *0x1::vector::borrow<u32>(&arg1, 0), 0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::moment::new_moment(*0x1::vector::borrow<vector<u8>>(&arg0, 4), *0x1::vector::borrow<vector<u8>>(&arg0, 5), *0x1::vector::borrow<vector<u8>>(&arg0, 6), *0x1::vector::borrow<vector<u8>>(&arg0, 7), *0x1::vector::borrow<vector<u8>>(&arg0, 8), *0x1::vector::borrow<vector<u8>>(&arg0, 9), *0x1::vector::borrow<vector<u8>>(&arg0, 10), *0x1::vector::borrow<vector<u8>>(&arg0, 11), *0x1::vector::borrow<u32>(&arg1, 1)), arg3)
    }

    fun mint_impl(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u32, arg5: 0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::moment::Moment, arg6: &mut 0x2::tx_context::TxContext) : Token {
        let v0 = Token{
    ...
    public fun update_description(arg0: &mut Token, arg1: vector<u8>, arg2: &0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::caps::AdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        arg0.description = 0x1::string::utf8(arg1);
    }

    public fun update_edition_number(arg0: &mut Token, arg1: u32, arg2: &0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::caps::AdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        arg0.edition_number = arg1;
    }

    public fun update_name(arg0: &mut Token, arg1: vector<u8>, arg2: &0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::caps::AdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        arg0.name = 0x1::string::utf8(arg1);
    }

    public fun update_preview_image(arg0: &mut Token, arg1: vector<u8>, arg2: &0x1976c62ba4ce44d99a0824d910c728cedd60e148662d8049a152acbda96339ff::caps::AdminCap, arg3: &mut 0x2::tx_context::TxContext) {
