module 0x1989c4f5f22e0843497b81f2cf05c264c40c501d1da37da49b66d43e61fc3fc4::core {
    ...
    public entry fun rebase(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCapV2<CORE>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::deny_list_v2_add<CORE>(arg0, arg1, arg2, arg3);
    }

    public entry fun un_rebase(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCapV2<CORE>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
