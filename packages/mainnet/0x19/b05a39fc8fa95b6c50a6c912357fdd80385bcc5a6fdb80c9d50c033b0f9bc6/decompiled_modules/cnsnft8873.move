module 0x19b05a39fc8fa95b6c50a6c912357fdd80385bcc5a6fdb80c9d50c033b0f9bc6::cnsnft8873 {
    struct CNSNFT8873 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8873, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8873>(arg0, arg1);
