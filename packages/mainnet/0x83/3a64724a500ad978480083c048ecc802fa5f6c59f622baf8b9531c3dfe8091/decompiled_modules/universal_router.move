module 0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::universal_router {
    ...
    struct Trade<phantom T0, phantom T1> {
        ...
        routes: vector<Route>,
        commission: 0x1::option::Option<0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::commission::Commission>,
    }
    ...
    public fun build<T0, T1>(arg0: &mut 0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::trade_id_tracker::TradeIdTracker, arg1: &mut 0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::partner_manager::PartnerRegistry, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u64>, arg7: 0x1::option::Option<0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::commission::Commission>, arg8: &mut 0x2::tx_context::TxContext) : Trade<T0, T1> {
        if (arg4 > 1000000) {
            abort 2
        };
        0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::trade_id_tracker::increment(arg0);
        let v0 = 0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::trade_id_tracker::current(arg0);
        let v1 = Trade<T0, T1>{
            trade_id            : v0,
        ...
        if (0x1::option::is_some<0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::commission::Commission>(&arg7)) {
            let v2 = 0x1::option::borrow<0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::commission::Commission>(&arg7);
            if (0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::commission::on_input(v2)) {
                0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::partner_manager::register_partner_if_necessary(arg1, 0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::commission::partner(v2), arg8);
                0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::partner_manager::collect_commission_if_necessary<T0>(arg1, &mut v1.coin_in, v2, arg8);
            };
        };
        let v3 = 0;
    ...
    public entry fun set_fee_on(arg0: &0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::admin_cap::AdminCap, arg1: &mut Treasury, arg2: bool) {
        arg1.fee_on = arg2;
    }

    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: &mut 0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::partner_manager::PartnerRegistry, arg2: Trade<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let Trade {
            trade_id            : v0,
            amount_in           : v1,
        ...
        if (0x2::coin::value<T1>(&v11) < 0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::math::mul_div(1000000 - v3, v2, 1000000)) {
            abort 1
        };
        ...
        let v13 = if (0x1::option::is_some<0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::commission::Commission>(&v9)) {
            let v14 = 0x1::option::destroy_some<0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::commission::Commission>(v9);
            if (!0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::commission::on_input(&v14)) {
                0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::partner_manager::collect_commission_if_necessary<T1>(arg1, &mut v11, &v14, arg4);
            };
            0x1::option::some<address>(0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::commission::partner(&v14))
        } else {
    ...
    public entry fun withdraw<T0>(arg0: &0x833a64724a500ad978480083c048ecc802fa5f6c59f622baf8b9531c3dfe8091::admin_cap::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
