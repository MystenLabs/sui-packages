module 0x8330d6b6004ca267f18306f574f7fe58d37b764c1b7797ebab0476c0987eb7e9::reward5239 {
    struct REWARD5239 has drop {
        dummy_field: bool,
    }

    struct TICKET_5239 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5239(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5239>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5239>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5239, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5239>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5239>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5239>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5239>>(v5, 0x2::tx_context::sender(arg1));
    }
