module 0x831d5788845b393177eb31b1cfe66b94c3014723d3551fcacab5c04c7a0d1f4f::vram {
    ...
    fun new(arg0: u64, arg1: 0x1::string::String, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &mut 0x2::tx_context::TxContext) : VramNFT {
        ...
        VramNFT{
            id          : v0,
            name        : 0x1::string::utf8(b"VRAM Genesis Fragment"),
    ...
    public entry fun add_attrkeys_list(arg0: address, arg1: vector<0x1::string::String>, arg2: &mut Treasury, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(@0x7fde570941e6e1205c846af5eb1c000cd0dce4debf2671904671ccd91755363 == 0x2::tx_context::sender(arg3), 0);
    ...
    public entry fun add_whitelist(arg0: address, arg1: &mut Treasury, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(@0x7fde570941e6e1205c846af5eb1c000cd0dce4debf2671904671ccd91755363 == 0x2::tx_context::sender(arg2), 0);
    ...
    public entry fun admin_withdraw(arg0: &mut Treasury, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(@0x7fde570941e6e1205c846af5eb1c000cd0dce4debf2671904671ccd91755363 == 0x2::tx_context::sender(arg1), 0);
    ...
    fun init(arg0: VRAM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"VRAM Genesis NFT Collection"));
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Genesis VRAM NFT Collection represents the first implementation of the Axolotl Protocol on the Sui blockchain, enabling true on-chain evolution of digital assets."));
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/WtgIqQ3NBOixUUedXI-YL1jgMjKxfSrJMGNUyHiuZ1Q"));
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"VRAM.AI"));
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(b"https://vramai.wal.app"));
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"external_url"), 0x1::string::utf8(b"https://vramai.wal.app/?nft={b36addr}"));
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"link"), 0x1::string::utf8(b"https://vramai.wal.app/?nft={b36addr}"));
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"VRAM Genesis Fragment #{number_id}"));
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        ...
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"walrus site address"), 0x2::address::to_string(@0xb747da318c311052b21eddbd46d43a6f04c6689add62f76d58bdd9866a60f3be));
        0x2::display::update_version<VramNFT>(&mut v1);
        let (v2, v3) = 0x2::transfer_policy::new<VramNFT>(&v0, arg1);
        let v4 = v3;
        let v5 = v2;
        0x831d5788845b393177eb31b1cfe66b94c3014723d3551fcacab5c04c7a0d1f4f::kiosk_lock_rule::add<VramNFT>(&mut v5, &v4);
        0x831d5788845b393177eb31b1cfe66b94c3014723d3551fcacab5c04c7a0d1f4f::royalty_rule::add<VramNFT>(&mut v5, &v4, 500, 0);
    ...
    entry fun mint(arg0: u64, arg1: 0x1::string::String, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(@0x7fde570941e6e1205c846af5eb1c000cd0dce4debf2671904671ccd91755363 == 0x2::tx_context::sender(arg4), 0);
    ...
    public entry fun public_mint(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>, arg5: &0x2::transfer_policy::TransferPolicy<VramNFT>, arg6: &mut Treasury, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::vec_map::contains<address, u64>(&arg6.mintedlistOf, &v1)) {
            0x2::vec_map::insert<address, u64>(&mut arg6.mintedlistOf, v1, 1);
        } else {
            let v2 = 0x2::vec_map::get_mut<address, u64>(&mut arg6.mintedlistOf, &v1);
            assert!(*v2 <= 10, 4);
            *v2 = *v2 + 1;
        };
        0x2::balance::join<0x2::sui::SUI>(&mut arg6.suiCoinsTreasury, 0x2::coin::into_balance<0x2::sui::SUI>(arg2));
        arg6.supply = arg6.supply + 1;
        let v3 = new(arg6.supply, arg1, arg3, arg4, arg7);
        let (v4, v5) = 0x2::kiosk::new(arg7);
        let v6 = v5;
        let v7 = v4;
        0x2::kiosk::lock<VramNFT>(&mut v7, &v6, arg5, v3);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v6, v1);
    ...
    public entry fun reveal_display(arg0: &mut VramNFT, arg1: &mut Treasury, arg2: bool, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg2) {
            arg4
        } else {
            arg3
    ...
    public entry fun reveal_update_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: 0x2::object::ID, arg8: &mut Treasury, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::vec_map::contains<address, vector<0x1::string::String>>(&arg8.attrKeysListOf, &v0) && 0x2::vec_map::contains<address, vector<0x1::string::String>>(&arg8.attrValuesListOf, &v0)) {
            0x2::kiosk::borrow_mut<VramNFT>(arg5, arg6, arg7).attributes = 0x2::vec_map::from_keys_values<0x1::string::String, 0x1::string::String>(*0x2::vec_map::get_mut<address, vector<0x1::string::String>>(&mut arg8.attrKeysListOf, &v0), *0x2::vec_map::get_mut<address, vector<0x1::string::String>>(&mut arg8.attrValuesListOf, &v0));
        };
    }
    ...
    public entry fun update_nft_admin(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: 0x2::object::ID, arg8: &mut Treasury, arg9: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun whitelist_mint(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &0x2::transfer_policy::TransferPolicy<VramNFT>, arg5: &mut Treasury, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::vec_map::contains<address, u64>(&arg5.whitelistOf, &v0)) {
            ...
            if (*v1 == 1) {
                ...
                *v1 = 2;
                if (!0x2::vec_map::contains<address, u64>(&arg5.mintedlistOf, &v0)) {
                    0x2::vec_map::insert<address, u64>(&mut arg5.mintedlistOf, v0, 1);
                } else {
                    let v7 = 0x2::vec_map::get_mut<address, u64>(&mut arg5.mintedlistOf, &v0);
                    *v7 = *v7 + 1;
                };
                let v8 = WhitelistMint{user: 0x2::tx_context::sender(arg6)};
                0x2::event::emit<WhitelistMint>(v8);
            };
        };
    }
