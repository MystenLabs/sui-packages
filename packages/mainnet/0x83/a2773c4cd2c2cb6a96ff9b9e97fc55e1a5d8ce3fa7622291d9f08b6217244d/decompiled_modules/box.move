module 0xfce10ec7b4e2fe18658db2f7fa94a8d6b7b1fdb5d42151298413151c1b450f61::box {
    ...
    struct MissionClaimed has copy, drop, store {
        receiver: address,
        mission_id: u64,
        level: u8,
    }
    ...
    entry fun claim_boost(arg0: &mut App, arg1: &mut 0x1efaf509c9b7e986ee724596f526a22b474b15c376136772c00b8452f204d2d1::game::GameInfo, arg2: u64, arg3: vector<u8>, arg4: &0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::string::utf8(b"CLAIM_BOOST:");
        ...
        assert!(!0x2::dynamic_field::exists_<u64>(&arg0.id, arg2), 5);
        0x2::dynamic_field::add<u64, bool>(&mut arg0.id, arg2, true);
        let v4 = BoostClaimed{
            receiver : v0,
            id       : arg2,
            level    : 0x1efaf509c9b7e986ee724596f526a22b474b15c376136772c00b8452f204d2d1::game::auth_upgrade_seafood(&mut arg0.id, arg1, 1, v0),
        };
        0x2::event::emit<BoostClaimed>(v4);
    }

    entry fun claim_mission(arg0: &mut App, arg1: &mut 0x1efaf509c9b7e986ee724596f526a22b474b15c376136772c00b8452f204d2d1::game::GameInfo, arg2: u64, arg3: vector<u8>, arg4: &0x2::tx_context::TxContext) {
        assert!(arg0.version <= 1, 9);
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x1::string::utf8(b"CLAIM_MISSION:");
        let v2 = 0x2::bcs::to_bytes<0x1::string::String>(&v1);
        0x1::vector::append<u8>(&mut v2, 0x2::bcs::to_bytes<address>(&v0));
        let v3 = 0x1::string::utf8(b"-");
        0x1::vector::append<u8>(&mut v2, 0x2::bcs::to_bytes<0x1::string::String>(&v3));
        0x1::vector::append<u8>(&mut v2, 0x2::bcs::to_bytes<u64>(&arg2));
        assert!(0x2::ed25519::ed25519_verify(&arg3, &arg0.operator_pk, &v2) == true, 6);
        assert!(!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, v2), 5);
        0x2::dynamic_field::add<vector<u8>, bool>(&mut arg0.id, v2, true);
        let v4 = MissionClaimed{
            receiver   : v0,
            mission_id : arg2,
            level      : 0x1efaf509c9b7e986ee724596f526a22b474b15c376136772c00b8452f204d2d1::game::auth_upgrade_seafood(&mut arg0.id, arg1, 1, v0),
        };
        0x2::event::emit<MissionClaimed>(v4);
    }
    ...
    entry fun claim_sui(arg0: &mut App, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::dynamic_field::exists_<u64>(&arg0.id, arg1), 5);
        0x2::dynamic_field::add<u64, bool>(&mut arg0.id, arg1, true);
        let v5 = 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance);
        assert!(v5 >= arg2, 7);
        if (v5 > arg2) {
