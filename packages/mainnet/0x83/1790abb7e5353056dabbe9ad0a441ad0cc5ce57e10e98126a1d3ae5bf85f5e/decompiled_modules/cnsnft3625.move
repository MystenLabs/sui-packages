module 0x831790abb7e5353056dabbe9ad0a441ad0cc5ce57e10e98126a1d3ae5bf85f5e::cnsnft3625 {
    struct CNSNFT3625 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3625, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3625>(arg0, arg1);
