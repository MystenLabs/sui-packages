module 0x5b340df606f1c48f60d32e8a26dcfde443d619f3d8e0980f7bbf553cc24e1b83::commission {
    ...
    struct VerifySlippageEvent has copy, drop {
        received_amount: u64,
        expected_amount: u64,
        min_expected_amount: u64,
    }

    struct VerifiedSlippageEvent has copy, drop {
        coin: 0x1::ascii::String,
        received_amount: u64,
        expected_amount: u64,
        min_expected_amount: u64,
    ...
    struct VerifiedSwapEvent has copy, drop {
        coin_in: 0x1::ascii::String,
        coin_out: 0x1::ascii::String,
        amount_in: u64,
        amount_out: u64,
        expected_amount_out: u64,
        min_expected_amount_out: u64,
    }
    ...
    public fun verify_slippage<T0>(arg0: &mut Manager, arg1: u64, arg2: u64, arg3: &mut 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        let v0 = 0x2::coin::value<T0>(arg3);
        assert!(v0 >= arg2, 42);
        let v1 = 0x1::type_name::with_defining_ids<T0>();
        let v2 = VerifiedSlippageEvent{
            coin                : *0x1::type_name::as_string(&v1),
            received_amount     : v0,
            expected_amount     : arg1,
            min_expected_amount : arg2,
        };
        0x2::event::emit<VerifiedSlippageEvent>(v2);
        if (v0 > arg1 && arg1 >= arg2) {
            0x2::balance::join<T0>(get_manager_balance<T0>(arg0), 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg3, v0 - arg1, arg4)));
        };
    }

    public fun verify_swap<T0, T1>(arg0: &mut Manager, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::coin::Coin<T1>, arg5: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        let v0 = 0x2::coin::value<T1>(arg4);
        assert!(v0 >= arg3, 42);
        let v1 = 0x1::type_name::with_defining_ids<T0>();
        let v2 = 0x1::type_name::with_defining_ids<T1>();
        let v3 = VerifiedSwapEvent{
            coin_in                 : *0x1::type_name::as_string(&v1),
            coin_out                : *0x1::type_name::as_string(&v2),
            amount_in               : arg1,
            amount_out              : v0,
            expected_amount_out     : arg2,
            min_expected_amount_out : arg3,
        };
        0x2::event::emit<VerifiedSwapEvent>(v3);
        if (v0 > arg2 && arg2 >= arg3) {
            0x2::balance::join<T1>(get_manager_balance<T1>(arg0), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(arg4, v0 - arg2, arg5)));
        };
    }
