module 0x83359e16240660a7aa5dc315994d5682594f641ce7b10c3a5040ba784de99028::cnsnft2702 {
    struct CNSNFT2702 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2702, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2702>(arg0, arg1);
