module 0x837bb9907b7388a8b306ab24b659055d1b71aa00d3862ebb8dab9ab365d2505e::registry {
    ...
    struct PositionInfo<T0> has store {
        ...
        owner: address,
        balance_bag: 0x837bb9907b7388a8b306ab24b659055d1b71aa00d3862ebb8dab9ab365d2505e::balance_bag::BalanceBag,
    }

    public fun add_coin<T0: store, T1>(arg0: &mut PositionRegistry, arg1: &GetCoinReceipt, arg2: 0x2::coin::Coin<T1>) {
        0x837bb9907b7388a8b306ab24b659055d1b71aa00d3862ebb8dab9ab365d2505e::balance_bag::join<T1>(&mut 0x2::bag::borrow_mut<u64, PositionInfo<T0>>(&mut arg0.bag, arg1.position_registry_id).balance_bag, 0x2::coin::into_balance<T1>(arg2));
    }
    ...
    public fun add_position<T0: store>(arg0: &mut PositionRegistry, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = PositionInfo<T0>{
            ...
            balance_bag : 0x837bb9907b7388a8b306ab24b659055d1b71aa00d3862ebb8dab9ab365d2505e::balance_bag::new(arg2),
        };
    ...
    public(friend) fun get_coin<T0: store, T1>(arg0: &mut PositionRegistry, arg1: &GetCoinReceipt, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        0x2::coin::from_balance<T1>(0x837bb9907b7388a8b306ab24b659055d1b71aa00d3862ebb8dab9ab365d2505e::balance_bag::withdraw_all<T1>(&mut 0x2::bag::borrow_mut<u64, PositionInfo<T0>>(&mut arg0.bag, arg1.position_registry_id).balance_bag), arg2)
    }
    ...
    public fun remove_coin<T0: store, T1>(arg0: &mut PositionRegistry, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x2::coin::from_balance<T1>(0x837bb9907b7388a8b306ab24b659055d1b71aa00d3862ebb8dab9ab365d2505e::balance_bag::withdraw_all<T1>(&mut v0.balance_bag), arg2)
    }
