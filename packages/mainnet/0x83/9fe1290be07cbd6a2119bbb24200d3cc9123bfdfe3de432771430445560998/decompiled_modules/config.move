module 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LaunchpadConfig{
            ...
            virtual_sui_reserve      : 30000000000000,
            initial_token_reserve    : 800000000000000,
            lp_token_reserve         : 200000000000000,
            graduation_sui_threshold : 85000000000000,
            creation_fee_mist        : 0,
            trade_fee_bps            : 100,
            creator_fee_pct          : 40,
            protocol_fee_pct         : 50,
