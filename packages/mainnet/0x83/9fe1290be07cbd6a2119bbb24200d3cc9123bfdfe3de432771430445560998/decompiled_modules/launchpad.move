module 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::launchpad {
    ...
    public fun buy(arg0: &mut BondingCurve, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : PoolToken {
        ...
        let v2 = 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::bonding_curve::tokens_out(arg0.k, arg0.virtual_sui + 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_reserve), arg0.token_reserve, v0 - v1);
        assert!(v2 > 0, 4);
        assert!(v2 >= arg2, 3);
        ...
        let v12 = TokensBought{
            ...
            new_real_sui      : v8,
            spot_price_mist   : 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::bonding_curve::spot_price_mist(arg0.virtual_sui + v8, arg0.token_reserve, 1000000),
    ...
    public fun buy_exact(arg0: &mut BondingCurve, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (PoolToken, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        let v0 = 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::bonding_curve::sui_in_for_tokens(arg0.k, arg0.virtual_sui + 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_reserve), arg0.token_reserve, arg2) * 10000 / (10000 - arg0.trade_fee_bps) + 1;
    ...
    public fun execute_buyback(arg0: &mut BondingCurve) {
        ...
        assert!(v0 > 0, 4);
        let v1 = 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::bonding_curve::tokens_out(arg0.k, arg0.virtual_sui + 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_reserve), arg0.token_reserve, v0);
        assert!(v1 > 0, 4);
        ...
        arg0.k = 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::bonding_curve::compute_k(arg0.virtual_sui + 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_reserve), arg0.token_reserve);
    ...
    public fun launch(arg0: &mut Registry, arg1: &0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config::LaunchpadConfig, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: u8, arg10: u8, arg11: u64, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        assert!(!0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config::launch_paused(arg1), 0);
        assert!(arg10 <= 1, 10);
        assert!(arg11 <= 500, 11);
        let v0 = 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config::creation_fee_mist(arg1);
        let v1 = 0x2::coin::into_balance<0x2::sui::SUI>(arg2);
        assert!(0x2::balance::value<0x2::sui::SUI>(&v1) >= v0, 1);
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v1, v0), arg13), 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config::treasury(arg1));
        };
        ...
        let v2 = 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config::virtual_sui_reserve(arg1);
        let v3 = 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config::initial_token_reserve(arg1);
        ...
        let v10 = BondingCurve{
            ...
            project_type              : arg9,
            virtual_sui               : v2,
            graduation_threshold      : 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config::graduation_sui_threshold(arg1),
            trade_fee_bps             : 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config::trade_fee_bps(arg1),
            creator_fee_pct           : 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config::creator_fee_pct(arg1),
            protocol_fee_pct          : 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config::protocol_fee_pct(arg1),
            protocol_treasury         : 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config::treasury(arg1),
            k                         : 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::bonding_curve::compute_k(v2, v3),
            token_reserve             : v3,
            grad_token_reserve        : 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::config::lp_token_reserve(arg1),
            total_minted              : 0,
    ...
    public fun sell(arg0: &mut BondingCurve, arg1: PoolToken, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v4 = 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::bonding_curve::sui_out_gross(arg0.k, arg0.virtual_sui + 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_reserve), arg0.token_reserve, v0);
        ...
        let v14 = TokensSold{
            ...
            new_token_reserve : arg0.token_reserve,
            new_real_sui      : v11,
            spot_price_mist   : 0x839fe1290be07cbd6a2119bbb24200d3cc9123bfdfe3de432771430445560998::bonding_curve::spot_price_mist(arg0.virtual_sui + v11, arg0.token_reserve, 1000000),
        };
