module 0x83df3d55120b4f09cdc9b542a75f1b7e79153acd318caa25b8a0e157c2db5ff2::reward4958 {
    struct REWARD4958 has drop {
        dummy_field: bool,
    }

    struct TICKET_4958 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4958(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4958>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4958>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4958, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4958>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4958>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4958>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4958>>(v5, 0x2::tx_context::sender(arg1));
    }
