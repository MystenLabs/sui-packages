module 0x83b32444d084293004624da5b0f1ca58223f3cfec9e3b937ace5d3e015432972::commission {
    ...
    entry fun load_reward_manager(arg0: &mut Manager, arg1: 0x1::ascii::String, arg2: vector<0x2::object::ID>, arg3: vector<u64>, arg4: &0x2::tx_context::TxContext) {
        ...
        let v1 = 0;
        let v2 = 0x2::linked_table::front<0x2::object::ID, u64>(&v0.registry);
        while (0x1::option::is_some<0x2::object::ID>(v2)) {
            let v3 = *0x1::option::borrow<0x2::object::ID>(v2);
            v1 = v1 + *0x2::linked_table::borrow<0x2::object::ID, u64>(&v0.registry, v3);
            v2 = 0x2::linked_table::next<0x2::object::ID, u64>(&v0.registry, v3);
        };
        while (!0x1::vector::is_empty<0x2::object::ID>(&arg2)) {
            let v4 = 0x1::vector::pop_back<u64>(&mut arg3);
            0x2::linked_table::push_back<0x2::object::ID, u64>(&mut v0.registry, 0x1::vector::pop_back<0x2::object::ID>(&mut arg2), v4);
            v1 = v1 + v4;
        };
        assert!(v0.supply <= v1, 5);
        if (v0.supply == v1) {
            v0.status = 1;
        };
    }
