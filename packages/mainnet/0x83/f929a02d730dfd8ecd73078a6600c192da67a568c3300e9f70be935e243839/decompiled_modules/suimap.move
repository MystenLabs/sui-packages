module 0x68fe89062f852cc4c481ac94050c698aec3d7ed27a7d931bae11776fc0b8f01b::suimap {
    ...
    public fun fill_minted_block(arg0: &mut Config, arg1: vector<u64>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0);
        while (!0x1::vector::is_empty<u64>(&arg1)) {
            let v0 = 0x1::vector::pop_back<u64>(&mut arg1);
            if (!0x2::table::contains<u64, bool>(&arg0.block_minted, v0)) {
                0x2::table::add<u64, bool>(&mut arg0.block_minted, v0, true);
            };
        };
    }
    ...
    public entry fun mint_suimap(arg0: &0x2::clock::Clock, arg1: &mut Config, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) >= 500000000, 4);
        ...
        0x2::table::add<u64, bool>(&mut arg1.block_minted, arg2, true);
        let v2 = num_str(arg2);
        ...
        let v3 = 0x1::string::utf8(b"https://ipfs.bluemove.net/suimap/");
