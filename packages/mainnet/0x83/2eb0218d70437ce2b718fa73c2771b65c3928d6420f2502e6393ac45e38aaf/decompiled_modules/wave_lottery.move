module 0x832eb0218d70437ce2b718fa73c2771b65c3928d6420f2502e6393ac45e38aaf::wave_lottery {
    ...
    entry fun complete(arg0: &App, arg1: &mut Game, arg2: &0x2::clock::Clock, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x832eb0218d70437ce2b718fa73c2771b65c3928d6420f2502e6393ac45e38aaf::drand_lib::verify_drand_signature(arg3, arg4, arg1.round);
        ...
        arg1.status = 1;
        let v2 = 0x832eb0218d70437ce2b718fa73c2771b65c3928d6420f2502e6393ac45e38aaf::drand_lib::derive_randomness(arg3);
        let v3 = 0;
        while (v3 < arg1.n_winner) {
            0x1::vector::push_back<u64>(&mut arg1.lucky_numbers, 0x832eb0218d70437ce2b718fa73c2771b65c3928d6420f2502e6393ac45e38aaf::drand_lib::safe_selection(arg1.ticket_sold, &v2) + 1);
            v2 = 0x832eb0218d70437ce2b718fa73c2771b65c3928d6420f2502e6393ac45e38aaf::drand_lib::derive_randomness(v2);
            v3 = v3 + 1;
        };
        if (arg1.game_type == 0) {
    ...
    fun redeem_nft(arg0: &mut App, arg1: &mut Game, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: u16, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.game_type == 2 || arg1.game_type == 3, 6);
