module 0x8335f5e87d3ce1213375bbd841068536edfce20959d91de957bcc920e8fa2cc5::gift4788 {
    struct GIFT4788 has drop {
        dummy_field: bool,
    }

    struct TICKET_4788 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4788(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4788>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4788>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4788, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4788>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4788>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4788>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4788>>(v5, 0x2::tx_context::sender(arg1));
    }
