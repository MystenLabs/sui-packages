module 0x83c7a55b5b0cc2b7bde3447db93de840cc52428278f4a332439b4c5372e31adb::my_minter {
    ...
    public entry fun create(arg0: u64, arg1: u64, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: CreatorCapability, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = Collection{
        ...
        let v2 = Minter{
            ...
            user_buys       : 0x2::table::new<address, u64>(arg9),
            sale_phase_buys : 0x2::table::new<0x1::string::String, u64>(arg9),
            url             : arg7,
        };
        0x2::transfer::transfer<CreatorCapability>(arg8, 0x2::tx_context::sender(arg9));
    ...
    fun init(arg0: MY_MINTER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = CreatorCapability{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<CreatorCapability>(v6, 0x2::tx_context::sender(arg1));
    }
