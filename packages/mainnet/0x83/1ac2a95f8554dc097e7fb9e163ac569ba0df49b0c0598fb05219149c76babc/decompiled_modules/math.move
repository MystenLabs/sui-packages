module 0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math {
    ...
    public(friend) fun pow_d(arg0: u256, arg1: u256, arg2: u256, arg3: u8, arg4: u8) : u256 {
        ...
        assert!(67 * v0 <= arg0 && arg0 <= 150 * v0, 6);
        assert!(arg1 < arg2, 7);
        let v1 = arg2;
        let v2 = 0;
        let v3 = arg2;
    ...
    public(friend) fun pow_u256(arg0: u256, arg1: u8) : u256 {
        let v0 = 1;
        while (arg1 >= 1) {
            if (arg1 % 2 == 0) {
                arg0 = arg0 * arg0;
    ...
    public fun sbd_to_price_info(arg0: 0x8d79f4d920b03d88faca1e421af023a87fbb1e4a6fd200248e6e9998d09e470::math::SwitchboardDecimal, arg1: u8) : (u256, u256) {
        ...
        assert!(!v2, 0);
        ((v0 as u256), pow_u256(10, arg1 - v1))
    }
