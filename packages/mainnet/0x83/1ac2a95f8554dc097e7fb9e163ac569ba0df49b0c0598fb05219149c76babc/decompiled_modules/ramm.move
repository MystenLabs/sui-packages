module 0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::ramm {
    ...
    struct RAMM has key {
        ...
        new_asset_cap_id: 0x1::option::Option<0x2::object::ID>,
    ...
    public(friend) fun adjust(arg0: u256) : u256 {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::adjust(arg0, 12, 25)
    }
    ...
    fun check_imbalance_ratios(arg0: &RAMM, arg1: &0x2::vec_map::VecMap<u8, u256>, arg2: u8, arg3: u8, arg4: u256, arg5: u256, arg6: u256, arg7: &0x2::vec_map::VecMap<u8, u256>) : bool {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::check_imbalance_ratios(&arg0.balances, &arg0.lp_tokens_issued, arg1, arg2, arg3, arg4, arg5, arg6, &arg0.factors_for_balances, 1000, arg7, 12, 25, 1000000000000, 250000000000)
    }

    fun compute_B_and_L(arg0: &RAMM, arg1: &0x2::vec_map::VecMap<u8, u256>, arg2: &0x2::vec_map::VecMap<u8, u256>) : (u256, u256) {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::compute_B_and_L(&arg0.balances, &arg0.lp_tokens_issued, arg1, &arg0.factors_for_balances, 1000, arg2, 12, 25)
    }

    public(friend) fun compute_volatility_fee(arg0: &RAMM, arg1: u8, arg2: u256, arg3: u64) : u256 {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::compute_volatility_fee(get_prev_prc(arg0, arg1), get_prev_prc_tmstmp(arg0, arg1), arg2, arg3, *0x2::vec_map::get<u8, u256>(&arg0.volatility_indices, &arg1), *0x2::vec_map::get<u8, u64>(&arg0.volatility_timestamps, &arg1), 12, 25, 1000000000000, 50000000000, 1000000000, 300)
    }

    public fun div(arg0: u256, arg1: u256) : u256 {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::div(arg0, arg1, 12, 25)
    }

    fun imbalance_ratios(arg0: &RAMM, arg1: &0x2::vec_map::VecMap<u8, u256>, arg2: &0x2::vec_map::VecMap<u8, u256>) : 0x2::vec_map::VecMap<u8, u256> {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::imbalance_ratios(&arg0.balances, &arg0.lp_tokens_issued, arg1, &arg0.factors_for_balances, 1000, arg2, 12, 25)
    }

    public fun mul(arg0: u256, arg1: u256) : u256 {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::mul(arg0, arg1, 12, 25)
    }

    public fun mul3(arg0: u256, arg1: u256, arg2: u256) : u256 {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::mul3(arg0, arg1, arg2, 12, 25)
    }

    public fun pow_d(arg0: u256, arg1: u256) : u256 {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::pow_d(arg0, arg1, 1000000000000, 12, 25)
    }

    public fun pow_n(arg0: u256, arg1: u256) : u256 {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::pow_n(arg0, arg1, 1000000000000, 12, 25)
    }

    public fun power(arg0: u256, arg1: u256) : u256 {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::power(arg0, arg1, 1000000000000, 12, 25)
    }
    ...
    fun scaled_fee_and_leverage(arg0: &RAMM, arg1: &0x2::vec_map::VecMap<u8, u256>, arg2: u8, arg3: u8, arg4: &0x2::vec_map::VecMap<u8, u256>) : (u256, u256) {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::scaled_fee_and_leverage(&arg0.balances, &arg0.lp_tokens_issued, arg1, arg2, arg3, &arg0.factors_for_balances, 1000, arg4, 1000000000, 100000000000000, 12, 25)
    }

    public(friend) fun update_volatility_data(arg0: &mut RAMM, arg1: u8, arg2: u256, arg3: u64, arg4: u256, arg5: u64, arg6: u256) {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::update_volatility_data(arg2, arg3, arg4, arg5, 0x2::vec_map::get_mut<u8, u256>(&mut arg0.volatility_indices, &arg1), 0x2::vec_map::get_mut<u8, u64>(&mut arg0.volatility_timestamps, &arg1), arg6, 1000000000000, 300);
    }

    fun weights(arg0: &RAMM, arg1: &0x2::vec_map::VecMap<u8, u256>, arg2: &0x2::vec_map::VecMap<u8, u256>) : 0x2::vec_map::VecMap<u8, u256> {
        0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::weights(&arg0.balances, arg1, &arg0.factors_for_balances, arg2, 12, 25)
    }
    ...
    public fun add_asset_to_ramm<T0>(arg0: &mut RAMM, arg1: &0x8d79f4d920b03d88faca1e421af023a87fbb1e4a6fd200248e6e9998d09e470::aggregator::Aggregator, arg2: u64, arg3: u8, arg4: &RAMMAdminCap, arg5: &RAMMNewAssetCap) {
        ...
        assert!(arg0.new_asset_cap_id == 0x1::option::some<0x2::object::ID>(0x2::object::id<RAMMNewAssetCap>(arg5)), 6);
        ...
        0x2::vec_map::insert<u8, u256>(&mut arg0.factors_for_balances, v0, 0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::pow(10, 12 - arg3));
    ...
    public(friend) fun check_feed_address(arg0: &RAMM, arg1: u8, arg2: &0x8d79f4d920b03d88faca1e421af023a87fbb1e4a6fd200248e6e9998d09e470::aggregator::Aggregator) : bool {
    ...
    public(friend) fun check_feed_and_get_price_data(arg0: &RAMM, arg1: u8, arg2: &0x8d79f4d920b03d88faca1e421af023a87fbb1e4a6fd200248e6e9998d09e470::aggregator::Aggregator, arg3: &mut 0x2::vec_map::VecMap<u8, u256>, arg4: &mut 0x2::vec_map::VecMap<u8, u256>, arg5: &mut 0x2::vec_map::VecMap<u8, u64>) {
        assert!(check_feed_address(arg0, arg1, arg2), 1);
        let (v0, v1, v2) = get_price_from_oracle(arg2);
        0x2::vec_map::insert<u8, u256>(arg3, arg1, v0);
        0x2::vec_map::insert<u8, u256>(arg4, arg1, v1);
        0x2::vec_map::insert<u8, u64>(arg5, arg1, v2);
    }

    fun check_imbalance_ratios_message(arg0: bool) : 0x1::string::String {
        if (arg0) {
            0x1::string::utf8(b"Trade executed.")
        } else {
            0x1::string::utf8(b"The trade was not executed because of pool imbalance.")
        }
    }
    ...
    public(friend) fun execute(arg0: &TradeOutput) : bool {
        arg0.execute_trade
    }
    ...
    public fun get_new_asset_cap_id(arg0: &RAMM) : 0x1::option::Option<0x2::object::ID> {
    ...
    public fun get_price_from_oracle(arg0: &0x8d79f4d920b03d88faca1e421af023a87fbb1e4a6fd200248e6e9998d09e470::aggregator::Aggregator) : (u256, u256, u64) {
        let (v0, v1) = 0x8d79f4d920b03d88faca1e421af023a87fbb1e4a6fd200248e6e9998d09e470::aggregator::latest_value(arg0);
        let (v2, v3) = 0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::sbd_to_price_info(v0, 12);
        (v2, v3, v1)
    }
    ...
    public entry fun initialize_ramm(arg0: &mut RAMM, arg1: &RAMMAdminCap, arg2: RAMMNewAssetCap) {
        ...
        0x1::option::extract<0x2::object::ID>(&mut arg0.new_asset_cap_id);
    }

    public fun is_initialized(arg0: &RAMM) : bool {
        0x1::option::is_none<0x2::object::ID>(&arg0.new_asset_cap_id)
    }
    ...
    public(friend) fun liq_dep<T0>(arg0: &mut RAMM, arg1: u8, arg2: u64, arg3: 0x2::vec_map::VecMap<u8, u256>, arg4: 0x2::vec_map::VecMap<u8, u256>) : u64 {
    ...
    public(friend) fun liq_wthdrw<T0>(arg0: &mut RAMM, arg1: u8, arg2: u64, arg3: 0x2::vec_map::VecMap<u8, u256>, arg4: 0x2::vec_map::VecMap<u8, u256>, arg5: 0x2::vec_map::VecMap<u8, u256>) : WithdrawalOutput {
        let v0 = (arg2 as u256);
    ...
    fun low_imb_ratio_trade_failure_msg() : 0x1::string::String {
        0x1::string::utf8(b"The trade was not executed because the imbalance ratio of the out-token is too low.")
    }
    ...
    public(friend) fun message(arg0: &TradeOutput) : 0x1::string::String {
        arg0.message
    }
    ...
    public entry fun new_ramm(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = RAMMAdminCap{id: 0x2::object::new(arg1)};
        let v1 = RAMMNewAssetCap{id: 0x2::object::new(arg1)};
        let v2 = RAMM{
            id                        : 0x2::object::new(arg1),
            admin_cap_id              : 0x2::object::id<RAMMAdminCap>(&v0),
            new_asset_cap_id          : 0x1::option::some<0x2::object::ID>(0x2::object::id<RAMMNewAssetCap>(&v1)),
        ...
        0x2::transfer::transfer<RAMMAdminCap>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::transfer<RAMMNewAssetCap>(v1, 0x2::tx_context::sender(arg1));
        0x2::transfer::share_object<RAMM>(v2);
    }
    ...
    fun split_withdrawal_fee(arg0: &mut u256, arg1: &mut u256, arg2: u256) {
        *arg1 = mul(*arg0, 0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::clamp(4000000000 + arg2, 1000000000000));
        *arg0 = *arg0 - *arg1;
    }
    ...
    public(friend) fun trade_i<T0, T1>(arg0: &RAMM, arg1: u8, arg2: u8, arg3: u256, arg4: 0x2::vec_map::VecMap<u8, u256>, arg5: 0x2::vec_map::VecMap<u8, u256>, arg6: u256) : TradeOutput {
        ...
        if (get_typed_bal<T0>(arg0, arg1) == 0) {
            ...
            let v4 = check_imbalance_ratios(arg0, &arg4, arg1, arg2, arg3, v2, v3, &arg5);
            return TradeOutput{
                amount        : v2,
                protocol_fee  : v3,
                execute_trade : v4,
                message       : check_imbalance_ratios_message(v4),
            }
        };
        let v5 = weights(arg0, &arg4, &arg5);
        let v6 = 100000000000000;
        let v7 = &mut v6;
        let v8 = 1000000000;
        let v9 = &mut v8;
        ...
        let v13 = mul(get_typed_bal<T0>(arg0, arg1) * v0, *v7);
        *v9 = 0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::clamp(*v9 + arg6, 1000000000000);
        let v14 = mul(mul(get_typed_bal<T1>(arg0, arg2) * v1, *v7), 1000000000000 - power(div(v13, v13 + mul(1000000000000 - *v9, arg3 * v0)), div(*0x2::vec_map::get<u8, u256>(&v5, &arg1), *0x2::vec_map::get<u8, u256>(&v5, &arg2)))) / v1;
        let v15 = mul3(300000000000, *v9, arg3 * v0) / v0;
        if (v14 > get_typed_bal<T1>(arg0, arg2) || v14 == get_typed_bal<T1>(arg0, arg2) && get_typed_lptok_issued<T1>(arg0, arg2) != 0) {
            return TradeOutput{
                amount        : 0,
                protocol_fee  : 0,
                execute_trade : false,
                message       : 0x1::string::utf8(b"The trade was not executed because there is not enough balance of the out-token."),
            }
        };
        let v16 = check_imbalance_ratios(arg0, &arg4, arg1, arg2, arg3, v14, v15, &arg5);
        TradeOutput{
            amount        : v14,
            protocol_fee  : v15,
            execute_trade : v16,
            message       : check_imbalance_ratios_message(v16),
        }
    }

    public(friend) fun trade_o<T0, T1>(arg0: &mut RAMM, arg1: u8, arg2: u8, arg3: u64, arg4: 0x2::vec_map::VecMap<u8, u256>, arg5: 0x2::vec_map::VecMap<u8, u256>, arg6: u256) : TradeOutput {
        let v0 = get_fact_for_bal(arg0, arg1);
        let v1 = get_fact_for_bal(arg0, arg2);
        let v2 = (arg3 as u256);
        if (get_typed_bal<T0>(arg0, arg1) == 0) {
            ...
            let v5 = check_imbalance_ratios(arg0, &arg4, arg1, arg2, v3, v2, v4, &arg5);
            return TradeOutput{
                amount        : v3,
                protocol_fee  : v4,
                execute_trade : v5,
                message       : check_imbalance_ratios_message(v5),
            }
        };
        let v6 = weights(arg0, &arg4, &arg5);
        let v7 = 100000000000000;
        let v8 = &mut v7;
        let v9 = 1000000000;
        let v10 = &mut v9;
        if (get_typed_lptok_issued<T1>(arg0, arg2) != 0 && get_typed_bal<T0>(arg0, arg1) != 0) {
            let v11 = imbalance_ratios(arg0, &arg4, &arg5);
            if (*0x2::vec_map::get<u8, u256>(&v11, &arg2) < 1000000000000 - 250000000000) {
                return TradeOutput{
                    amount        : 0,
                    protocol_fee  : 0,
                    execute_trade : false,
            ...
            let (v12, v13) = scaled_fee_and_leverage(arg0, &arg4, arg1, arg2, &arg5);
            *v10 = v12;
            *v8 = v13;
        };
        let v14 = mul(get_typed_bal<T1>(arg0, arg2) * v1, *v8);
        *v10 = 0x831ac2a95f8554dc097e7fb9e163ac569ba0df49b0c0598fb05219149c76babc::math::clamp(*v10 + arg6, 1000000000000);
        let v15 = div(mul(mul(get_typed_bal<T0>(arg0, arg1) * v0, *v8), power(div(v14, v14 - v2 * v1), div(*0x2::vec_map::get<u8, u256>(&v6, &arg2), *0x2::vec_map::get<u8, u256>(&v6, &arg1))) - 1000000000000), 1000000000000 - *v10) / v0;
        let v16 = mul3(300000000000, *v10, v15 * v0) / v0;
        let v17 = check_imbalance_ratios(arg0, &arg4, arg1, arg2, v15, v2, v16, &arg5);
        TradeOutput{
            amount        : v15,
            protocol_fee  : v16,
            execute_trade : v17,
            message       : check_imbalance_ratios_message(v17),
        }
    }
