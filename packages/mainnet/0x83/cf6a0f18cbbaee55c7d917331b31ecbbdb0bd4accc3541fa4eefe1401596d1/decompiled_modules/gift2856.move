module 0x83cf6a0f18cbbaee55c7d917331b31ecbbdb0bd4accc3541fa4eefe1401596d1::gift2856 {
    struct GIFT2856 has drop {
        dummy_field: bool,
    }

    struct TICKET_2856 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2856(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2856>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2856>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2856, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2856>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2856>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2856>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2856>>(v5, 0x2::tx_context::sender(arg1));
    }
