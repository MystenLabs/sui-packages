module 0x838fe965ba2c11b940d7363f27b167823d18e34a05478d6e1fede45beeb52190::capybara_lootbox {
    ...
    public fun mint_fruit_by_admin(arg0: &0x838fe965ba2c11b940d7363f27b167823d18e34a05478d6e1fede45beeb52190::capybara_game_card::AdminCap, arg1: &mut DataStorage, arg2: vector<0x1::string::String>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
    ...
    public fun update_storage(arg0: &0x838fe965ba2c11b940d7363f27b167823d18e34a05478d6e1fede45beeb52190::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
