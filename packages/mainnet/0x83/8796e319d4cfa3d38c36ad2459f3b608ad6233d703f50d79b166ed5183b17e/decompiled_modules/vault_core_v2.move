module 0x838796e319d4cfa3d38c36ad2459f3b608ad6233d703f50d79b166ed5183b17e::vault_core_v2 {
    ...
    fun is_delegated(arg0: &vector<DelegationInfo>, arg1: vector<u8>) : (bool, u64) {
        ...
        let v2 = false;
        while (v1 < v0) {
            if (0x1::vector::borrow<DelegationInfo>(arg0, v1).intent_ref_hash == arg1) {
                v2 = true;
            };
            v1 = v1 + 1;
        };
