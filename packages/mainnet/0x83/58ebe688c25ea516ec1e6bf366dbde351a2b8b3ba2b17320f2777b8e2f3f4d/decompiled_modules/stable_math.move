module 0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::stable_math {
    ...
    public fun add_liquidity_computation(arg0: u64, arg1: vector<u256>, arg2: vector<u256>, arg3: u64, arg4: u256) : (u256, vector<u256>) {
        ...
        let v3 = 0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::math::add_vectors_u256(arg1, arg2);
        ...
        let v5 = if (arg4 == 0) {
            ...
            0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::math::mul_div_u256(arg4, compute_d(arg0, 0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::math::subtract_vectors_u256(v3, v1)) - v2, v2)
        };
        (v5, v1)
    }
    ...
    fun calc_y(arg0: u64, arg1: u64, arg2: u256, arg3: vector<u256>, arg4: u64) : u256 {
        ...
        while (v9 < 256) {
            let v10 = v8;
            let v11 = (v8 * v8 + v2 * v1 / (0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::math::mul_to_u128(v4, v0) as u256)) / (v8 + v8 + v3 + v1 / (v4 as u256) - v1);
            v8 = v11;
    ...
    public fun compute_current_amp(arg0: &0x2::clock::Clock, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ...
        if (v0 > arg2 && v0 < arg4) {
            ...
            if (arg3 > arg1) {
                arg1 + 0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::math::mul_div(v2, v0 - arg2, arg4 - arg2)
            } else {
                arg1 - 0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::math::mul_div(v2, v0 - arg2, arg4 - arg2)
            }
        } else {
    ...
    public fun compute_d(arg0: u64, arg1: vector<u256>) : u256 {
        ...
        while (v8 < 256) {
            ...
            v5 = 0;
            while (v5 < v0) {
                v9 = 0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::math::mul_div_u256(v9, v6, *0x1::vector::borrow<u256>(&arg1, v5) * (v0 as u256));
                v5 = v5 + 1;
            };
            let v10 = v6;
    ...
    public fun imbalanced_liquidity_withdraw(arg0: u64, arg1: vector<u256>, arg2: u256, arg3: vector<u256>, arg4: u64) : (u256, vector<u256>) {
        ...
        let v1 = 0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::math::create_zero_vector_u256(v0);
        let v2 = compute_d(arg0, arg1);
        let v3 = 0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::math::subtract_vectors_u256(arg1, arg3);
        let v4 = 0;
        while (v4 < v0) {
        ...
        (0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::math::mul_div_u256(arg2, v2 - compute_d(arg0, 0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::math::subtract_vectors_u256(v3, v1)), v2), v1)
    }
