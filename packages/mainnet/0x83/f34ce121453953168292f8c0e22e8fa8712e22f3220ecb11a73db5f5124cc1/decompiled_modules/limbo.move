module 0x89db6a55ad4e650cad641b6f9fd90b391b22b1d9adbb2cabbfeb94a9eeda7026::limbo {
    ...
    public fun borrow_limbo_settings(arg0: &0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse) : &LimboSettings {
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::dof_exists_with_type<Limbo, LimboSettingsKey, LimboSettings>(arg0, v1, v0), 13835340041360113667);
    ...
    fun borrow_limbo_settings_mut(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse) : &mut LimboSettings {
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::dof_exists_with_type<Limbo, LimboSettingsKey, LimboSettings>(arg0, v0, v1), 13835340101489655811);
    ...
    fun borrow_mut_parameters<T0>(arg0: &mut LimboSettings) : &mut Parameters<T0> {
        assert!(parameters_exist<T0>(arg0), 13835621653775908869);
    ...
    fun play_internal<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: vector<0x1::string::String>, arg7: vector<vector<u8>>, arg8: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::PriceQuote, arg9: &0x2::clock::Clock, arg10: &0x2::random::Random, arg11: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = Limbo{dummy_field: false};
        assert!(arg5 > 0, 13835903927616667655);
        ...
        assert!(arg3 > 0 && arg3 <= v2.max_number_of_games, 13836185514262659081);
        assert!(arg3 <= 100, 13836185518557626377);
        ...
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::lt(&v10, &v9), 13837311448529764369);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::gt(&v10, &v8), 13837592927801573395);
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_positive(&v12), 13835904095120392199);
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_positive_or_zero(&v13), 13838155937884798999);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::gt(&v13, &v6), 13838155942179766295);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::lt(&v13, &v7), 13838155946474733591);
        ...
        assert!(0x2::balance::value<T0>(&v15) == arg1, 13837030136761679887);
        ...
        0x13a877d974d59f54d8affa4d345bf794cf8e9e936d9d22100c801c95b415930f::loyalty::process_stake_ticket_with_quote<T0, Limbo>(&mut v18, arg0, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::utils::build_metadata<0x1::string::String, vector<u8>>(arg6, arg7), arg8, arg9, arg10, arg11);
        ...
        while (v21 < arg3) {
            ...
            assert!(v22 >= v3, 13836467367196622859);
            assert!(v22 <= v4, 13836748846468431885);
            ...
            assert!(v23 <= v5, 13837874763555667989);
    ...
    fun set_parameters<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: u64, arg3: u64, arg4: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg5: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg6: u64, arg7: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg8: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 <= arg2, 13835903322026278919);
        assert!(arg3 > 0, 13835903326321246215);
        assert!(arg6 > 0 && arg6 <= 100, 13835903330616213511);
        let v0 = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::from_u64(1);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::lt(&arg4, &v0), 13835903347796082695);
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::gt(&arg5, &v0), 13835903352091049991);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::gt(&arg4, &arg5), 13835903356386017287);
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_positive_or_zero(&arg7), 13835903364975951879);
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_positive_or_zero(&arg8), 13835903369270919175);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::gt(&arg7, &arg8), 13835903373565886471);
        let v1 = max_allowed_rtp();
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::gt(&arg8, &v1), 13835903382155821063);
        ...
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::gt(&arg5, &v2), 13838436674127265817);
