module 0x8360004f3c1c2b2a5d32746403f51472949c91cb356bbb77df00cf2b7481881b::sdoge {
    ...
    fun init(arg0: SDOGE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<SDOGE>>(0x2::coin::from_balance<SDOGE>(0x2::balance::increase_supply<SDOGE>(&mut v2, 1000000000000000), arg1), 0x2::tx_context::sender(arg1));
