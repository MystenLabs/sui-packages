module 0x836e8aad08972097d1077bf70d40a0d99e20edba1483554d09a44fcc5a4db023::cnsnft3767 {
    struct CNSNFT3767 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3767, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3767>(arg0, arg1);
