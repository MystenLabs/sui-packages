module 0x81ad8f5410ed889dd406d5918c6b8b2ff67284e6a345c76ab15b41144c2a5615::bulletin {
    ...
    fun apply_passed_proposal(arg0: &mut Bulletin, arg1: Proposal, arg2: u64) {
        if (arg1.action_type == 1) {
            ...
            if (arg1.action_type == 51) {
                let v8 = arg0.root_authority_did;
                arg0.root_authority_did = arg1.target_did;
                emit_root_rotation_event(arg0, &arg1, v8, arg2);
                return
            };
    ...
    public fun create_proposal(arg0: &mut Bulletin, arg1: u8, arg2: u8, arg3: address, arg4: vector<u8>, arg5: u8, arg6: vector<vector<u8>>, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: u64, arg11: u64, arg12: u64, arg13: &0x2::clock::Clock, arg14: &0x2::tx_context::TxContext) {
        ...
        if (arg2 == 51) {
            assert!(arg4 != arg0.root_authority_did, 34);
        };
    ...
    fun emit_root_rotation_event(arg0: &mut Bulletin, arg1: &Proposal, arg2: vector<u8>, arg3: u64) {
        let v0 = arg0.next_event_sequence + 1;
        let v1 = arg0.last_event_digest;
        let v2 = compute_event_digest(v0, arg2, arg1.action_type, arg1.proposal_id, arg1.committee_type, arg1.target_address, 0, arg1.target_did, 0, vector[], 0, 0, arg1.policy_hash, arg1.metadata_hash, v1, arg3);
        let v3 = GovernanceExecutionEvent{
            event_type            : arg1.action_type,
            sequence              : v0,
            root_authority_did    : arg2,
            proposal_id           : arg1.proposal_id,
            committee_type        : arg1.committee_type,
            target_address        : arg1.target_address,
            subject_did           : arg1.target_did,
            ...
            effective_from_ms     : 0,
            expires_at_ms         : 0,
            policy_hash           : arg1.policy_hash,
            metadata_hash         : arg1.metadata_hash,
            previous_event_digest : v1,
            event_digest          : v2,
            emitted_at_ms         : arg3,
        };
        0x2::event::emit<GovernanceExecutionEvent>(v3);
        arg0.next_event_sequence = v0;
        arg0.last_event_digest = v2;
    }
    ...
    public fun subject_did(arg0: &Bulletin, arg1: u8, arg2: vector<u8>) : vector<u8> {
        let v0 = find_subject_index_opt(&arg0.subjects, arg1, &arg2);
        if (0x1::option::is_none<u64>(&v0)) {
            return b""
        };
        0x1::vector::borrow<SubjectState>(&arg0.subjects, 0x1::option::destroy_some<u64>(v0)).subject_did
    }
    ...
    fun validate_proposal_inputs(arg0: u8, arg1: u8, arg2: &vector<u8>, arg3: &vector<vector<u8>>, arg4: &vector<u8>, arg5: &vector<u8>, arg6: &vector<u8>, arg7: u64, arg8: u64, arg9: u64) {
        ...
        if (arg1 == 0) {
            if (arg0 == 51) {
                ...
                assert!(0x1::vector::length<u8>(arg2) <= 128, 22);
            } else {
