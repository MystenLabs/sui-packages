module 0x83eb242270ce9c42b7e9a455180bd276b9773dd51f9227a31bebe50dec5d9a81::utils {
    public fun get_description_nft() : vector<u8> {
        b"Utility based NFT collection | Building Web3 Community"
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeiflpupv2arohqff4cfotzygpbcambxpiknidncssiiph55mlkm6e4/"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeieqyqbifq6wpy2grju6fmlxo6csjwqyab4ft7eh2vnqk5xka6orb4/"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/Trainers_Nfts"
    }
