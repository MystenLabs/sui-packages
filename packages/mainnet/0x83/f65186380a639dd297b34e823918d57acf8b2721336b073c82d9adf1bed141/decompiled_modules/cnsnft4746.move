module 0x83f65186380a639dd297b34e823918d57acf8b2721336b073c82d9adf1bed141::cnsnft4746 {
    struct CNSNFT4746 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4746, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4746>(arg0, arg1);
