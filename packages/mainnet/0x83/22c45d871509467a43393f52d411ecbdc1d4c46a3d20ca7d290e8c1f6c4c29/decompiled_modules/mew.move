module 0x8322c45d871509467a43393f52d411ecbdc1d4c46a3d20ca7d290e8c1f6c4c29::mew {
    struct MEW has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MEW, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<MEW>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MEW     ")))), trim_right(b"MEWING SNOWMAN                  "), trim_right(b"we swing and do a warm-up for the face. we're doing it right. +10000000 aura for you and everyone. come on, chads, we're doing it, we're doing it.                                                                                                                                                                              "), v2, arg1);
        let v5 = v3;
