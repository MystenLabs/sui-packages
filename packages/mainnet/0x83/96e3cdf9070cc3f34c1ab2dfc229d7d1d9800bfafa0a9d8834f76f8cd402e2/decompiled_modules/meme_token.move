module 0x8396e3cdf9070cc3f34c1ab2dfc229d7d1d9800bfafa0a9d8834f76f8cd402e2::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"GRAD", b"SUI GRAD", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-07T13-41-53.595Z-download (4).jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"SUI GRAD"),
            symbol     : 0x1::string::utf8(b"GRAD"),
            decimals   : 9,
