module 0x83e114cf9bf576722f5fa3367536f36c1cce5c889d4c7aabc2b9c538fdabf724::cnsnft8692 {
    struct CNSNFT8692 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8692, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8692>(arg0, arg1);
