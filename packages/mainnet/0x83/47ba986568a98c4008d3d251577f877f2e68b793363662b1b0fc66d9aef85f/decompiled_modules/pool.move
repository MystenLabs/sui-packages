module 0x9e935de41f29d842ced69c9e7c751cc565f7080274ffaa1223d98886bb9b9a07::pool {
    ...
    public(friend) fun consume_for_v4_migration<T0>(arg0: AdminCap, arg1: Pool<T0>) : (address, address, 0x2::balance::Balance<T0>, 0x2::groth16::PreparedVerifyingKey, 0x2::table::Table<vector<u8>, u64>, u64, u64, u64) {
        let AdminCap {
            id      : v0,
            pool_id : v1,
        } = arg0;
        ...
        let v15 = v2;
        assert!(v1 == 0x2::object::uid_to_inner(&v15), 7);
        0x2::object::delete(v0);
        0x2::object::delete(v15);
        (0x2::object::uid_to_address(&v15), v4, v6, v7, v10, v11, v12, v13)
    }
    ...
    public fun nullifier_count<T0>(arg0: &Pool<T0>) : u64 {
