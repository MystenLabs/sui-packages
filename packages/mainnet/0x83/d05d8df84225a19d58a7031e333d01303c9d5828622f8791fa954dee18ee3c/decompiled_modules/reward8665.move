module 0x83d05d8df84225a19d58a7031e333d01303c9d5828622f8791fa954dee18ee3c::reward8665 {
    struct REWARD8665 has drop {
        dummy_field: bool,
    }

    struct TICKET_8665 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8665(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8665>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8665>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8665, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8665>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8665>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8665>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8665>>(v5, 0x2::tx_context::sender(arg1));
    }
