module 0x831896aaef7a33ef4dde19c068744ba8a6a8f60f375a1ea12b64b6d4d75260c3::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"MADAI", b"MADAI", b"Official token. Banner, ads and boost on dexscreener already paid.", 0x1::option::none<0x2::url::Url>(), arg1);
