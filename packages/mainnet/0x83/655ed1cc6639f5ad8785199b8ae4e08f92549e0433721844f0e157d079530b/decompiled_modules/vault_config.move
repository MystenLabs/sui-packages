module 0x83655ed1cc6639f5ad8785199b8ae4e08f92549e0433721844f0e157d079530b::vault_config {
    ...
    public(friend) fun borrow_withdraw_cap(arg0: &VaultTokenHolder) : &0xa5650bf92e263523024270a55c7e2375b0a1331229fb5f68dd2449a5109bf778::cloud_wallet_config::QuickWithdrawCap {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0xa5650bf92e263523024270a55c7e2375b0a1331229fb5f68dd2449a5109bf778::cloud_wallet_config::QuickWithdrawCap>(&arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"))
    }
    ...
    public fun set_cloud_wallet_withdraw_cap(arg0: &mut 0xa5650bf92e263523024270a55c7e2375b0a1331229fb5f68dd2449a5109bf778::cloud_wallet_config::CloudWalletConfig, arg1: &VaultConfig, arg2: &mut VaultTokenHolder, arg3: 0x2::transfer::Receiving<0xa5650bf92e263523024270a55c7e2375b0a1331229fb5f68dd2449a5109bf778::cloud_wallet_config::QuickWithdrawCap>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg2.id, 0x1::ascii::string(b"quick_withdraw_cap"))) {
            0xa5650bf92e263523024270a55c7e2375b0a1331229fb5f68dd2449a5109bf778::cloud_wallet_config::delete_quick_withdraw_cap(arg0, 0x2::dynamic_field::remove<0x1::ascii::String, 0xa5650bf92e263523024270a55c7e2375b0a1331229fb5f68dd2449a5109bf778::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, 0x1::ascii::string(b"quick_withdraw_cap")));
        };
        0x2::dynamic_field::add<0x1::ascii::String, 0xa5650bf92e263523024270a55c7e2375b0a1331229fb5f68dd2449a5109bf778::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, 0x1::ascii::string(b"quick_withdraw_cap"), 0x2::transfer::public_receive<0xa5650bf92e263523024270a55c7e2375b0a1331229fb5f68dd2449a5109bf778::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, arg3));
    }
