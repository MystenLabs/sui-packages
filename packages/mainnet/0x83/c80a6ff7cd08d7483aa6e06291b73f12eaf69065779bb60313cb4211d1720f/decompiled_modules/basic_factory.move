module 0x83c80a6ff7cd08d7483aa6e06291b73f12eaf69065779bb60313cb4211d1720f::basic_factory {
    ...
    public entry fun buy_tokens<T0>(arg0: &mut Pool<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<FactoryCoin<T0>>(&arg0.token_balance) >= arg3, 103);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<FactoryCoin<T0>>>(0x2::coin::take<FactoryCoin<T0>>(&mut arg0.token_balance, arg3, arg4), v2);
    }
