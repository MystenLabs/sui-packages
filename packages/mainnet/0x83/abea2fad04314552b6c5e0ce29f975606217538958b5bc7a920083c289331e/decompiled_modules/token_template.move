module 0x83abea2fad04314552b6c5e0ce29f975606217538958b5bc7a920083c289331e::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"FIN385805", b"FixedInit 385805", b"Fixed with initial supply verification", 0x1::option::none<0x2::url::Url>(), arg1);
