module 0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::delegation_rule {
    ...
    public fun delegate(arg0: &mut 0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::AccessPolicy, arg1: &0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::AccessPolicyCap, arg2: address, arg3: u8, arg4: u64, arg5: vector<u8>, arg6: vector<u8>) {
        let v0 = Rule{dummy_field: false};
        ...
        0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::events::delegation_created(v1.vault_id, 0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::policy_id(arg0), arg2, arg3, arg4);
    }

    public fun get_delegation(arg0: &0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::AccessPolicy, arg1: address) : (u8, u64, vector<u8>, vector<u8>) {
        let v0 = Rule{dummy_field: false};
    ...
    public fun has_delegation(arg0: &0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::AccessPolicy, arg1: address) : bool {
        let v0 = Rule{dummy_field: false};
        0x2::table::contains<address, Delegation>(&0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::get_rule<Rule, Config>(v0, arg0).delegations, arg1)
    }
    ...
    public fun prove(arg0: &mut 0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::AccessRequest, arg1: &0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::AccessPolicy, arg2: &0x2::tx_context::TxContext) {
        let v0 = Rule{dummy_field: false};
        ...
        if (!0x1::vector::is_empty<u8>(&v3.allowed_memory_types)) {
            ...
            while (v7 < 0x1::vector::length<u8>(&v3.allowed_memory_types)) {
                if (*0x1::vector::borrow<u8>(&v3.allowed_memory_types, v7) == 0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::memory_type(arg0)) {
                    v6 = true;
                    break
                };
                v7 = v7 + 1;
        ...
        0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::add_receipt<Rule>(v8, arg0);
    }

    public fun revoke(arg0: &mut 0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::AccessPolicy, arg1: &0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::AccessPolicyCap, arg2: address) {
        let v0 = Rule{dummy_field: false};
        let v1 = 0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::get_rule_mut<Rule, Config>(v0, arg0, arg1);
        ...
        0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::events::delegation_revoked(v1.vault_id, 0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::policy_id(arg0), arg2);
    }

    public fun update_delegation(arg0: &mut 0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::AccessPolicy, arg1: &0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::AccessPolicyCap, arg2: address, arg3: u8, arg4: u64, arg5: vector<u8>, arg6: vector<u8>) {
        let v0 = Rule{dummy_field: false};
        let v1 = 0x83ca4672934d7133dc7190c7934f9b8ce2cf1868b5645262c6cd4a424acf3241::access_policy::get_rule_mut<Rule, Config>(v0, arg0, arg1);
        assert!(0x2::table::contains<address, Delegation>(&v1.delegations, arg2), 0);
