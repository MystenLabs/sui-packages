module 0x83241b495c822d269fd0e5b6e1a3864ea5014049c968e9a6ee0ce9f9368f3f55::SUILEND {
    ...
    public entry fun RewardVoucher(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SUILEND_VOUCHER{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/suilend_0702/suilend_0702_0.jpg"),
    ...
    fun init(arg0: SUILEND, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/suilend_0702/suilend_0702_0.jpg"));
