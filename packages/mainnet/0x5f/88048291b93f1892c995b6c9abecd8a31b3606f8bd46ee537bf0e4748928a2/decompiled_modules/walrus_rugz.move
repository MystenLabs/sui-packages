module 0x5f88048291b93f1892c995b6c9abecd8a31b3606f8bd46ee537bf0e4748928a2::walrus_rugz {
    ...
    fun init(arg0: WALRUS_RUGZ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Rugz"));
