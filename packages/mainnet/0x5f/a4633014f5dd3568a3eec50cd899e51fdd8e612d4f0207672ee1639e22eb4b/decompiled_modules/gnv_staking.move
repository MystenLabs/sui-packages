module 0x1e055ea18d894fe815280a65d3fe51581186c5a7b8293e153dc31324d4ca1adc::gnv_staking {
    ...
    struct ReservedBonusPaid has copy, drop {
        recipient: address,
        amount: u64,
        new_balance: u64,
    }
    ...
    public fun pay_reserved(arg0: &AdminCap, arg1: &mut StakingPool, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0xddf9eb12eab3f3c7107977b389d604eda4b589ec5811c2266da0d8afabfbaee::gnv_token::GNV_TOKEN>(&arg1.reward_balance);
        let v1 = if (v0 > arg1.committed_rewards) {
            v0 - arg1.committed_rewards
        } else {
        ...
        assert!(arg3 > 0, 3);
        assert!(arg3 <= v1, 6);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xddf9eb12eab3f3c7107977b389d604eda4b589ec5811c2266da0d8afabfbaee::gnv_token::GNV_TOKEN>>(0x2::coin::from_balance<0xddf9eb12eab3f3c7107977b389d604eda4b589ec5811c2266da0d8afabfbaee::gnv_token::GNV_TOKEN>(0x2::balance::split<0xddf9eb12eab3f3c7107977b389d604eda4b589ec5811c2266da0d8afabfbaee::gnv_token::GNV_TOKEN>(&mut arg1.reward_balance, arg3), arg4), arg2);
        arg1.total_rewards_paid = arg1.total_rewards_paid + arg3;
        let v2 = ReservedBonusPaid{
            recipient   : arg2,
            amount      : arg3,
            new_balance : 0x2::balance::value<0xddf9eb12eab3f3c7107977b389d604eda4b589ec5811c2266da0d8afabfbaee::gnv_token::GNV_TOKEN>(&arg1.reward_balance),
        };
        0x2::event::emit<ReservedBonusPaid>(v2);
    }

    public fun pay_reserved_batch(arg0: &AdminCap, arg1: &mut StakingPool, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < v0) {
            ...
            let v4 = 0x2::balance::value<0xddf9eb12eab3f3c7107977b389d604eda4b589ec5811c2266da0d8afabfbaee::gnv_token::GNV_TOKEN>(&arg1.reward_balance);
            let v5 = if (v4 > arg1.committed_rewards) {
                v4 - arg1.committed_rewards
            } else {
                0
            };
            assert!(v3 > 0, 3);
            assert!(v3 <= v5, 6);
            0x2::transfer::public_transfer<0x2::coin::Coin<0xddf9eb12eab3f3c7107977b389d604eda4b589ec5811c2266da0d8afabfbaee::gnv_token::GNV_TOKEN>>(0x2::coin::from_balance<0xddf9eb12eab3f3c7107977b389d604eda4b589ec5811c2266da0d8afabfbaee::gnv_token::GNV_TOKEN>(0x2::balance::split<0xddf9eb12eab3f3c7107977b389d604eda4b589ec5811c2266da0d8afabfbaee::gnv_token::GNV_TOKEN>(&mut arg1.reward_balance, v3), arg4), v2);
            arg1.total_rewards_paid = arg1.total_rewards_paid + v3;
            let v6 = ReservedBonusPaid{
                recipient   : v2,
                amount      : v3,
                new_balance : 0x2::balance::value<0xddf9eb12eab3f3c7107977b389d604eda4b589ec5811c2266da0d8afabfbaee::gnv_token::GNV_TOKEN>(&arg1.reward_balance),
            };
            0x2::event::emit<ReservedBonusPaid>(v6);
            v1 = v1 + 1;
        };
    }
