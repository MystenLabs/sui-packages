module 0x5fcfe31c479b3d83db28dd5e5d40ddfe01b1451b30677aad9f273e5322c0ee15::rewarder {
    ...
    fun accumulate_pool_reward(arg0: &mut Rewarder, arg1: 0x2::object::ID, arg2: u128, arg3: u64) : u256 {
        ...
        if (arg3 <= v1 || v0.allocate_point == 0 || arg2 == 0 || arg0.emission_per_second == 0) {
            return v0.acc_per_share
        };
        let v2 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u128::full_mul(arg0.emission_per_second, ((arg3 - v1) as u128)) * (v0.allocate_point as u256) / (arg0.total_allocate_point as u256);
        v0.reward_released = v0.reward_released + (v2 as u128);
        v0.acc_per_share = v0.acc_per_share + v2 * 1000000000000000000000000000000000000 / (arg2 as u256);
        v0.acc_per_share
    }

    fun accumulate_pools_reward<T0>(arg0: &mut RewarderManager, arg1: u64) {
        let v0 = 0x2::linked_table::borrow_mut<0x1::type_name::TypeName, Rewarder>(&mut arg0.rewarders, 0x1::type_name::with_defining_ids<T0>());
    ...
    fun accumulate_rewarder_released(arg0: &mut Rewarder, arg1: u64) {
        ...
        arg0.total_reward_released = arg0.total_reward_released + (0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u128::full_mul(arg0.emission_per_second, ((arg1 - arg0.last_reward_time) as u128)) as u128);
    }
    ...
    public(friend) fun add_pool<T0>(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::clock::Clock) {
        ...
        assert!(!is_pool_in_rewarder(arg0, 0x1::type_name::with_defining_ids<T0>(), arg1), 9);
        let v0 = now_seconds(arg3);
        accumulate_pools_reward<T0>(arg0, v0);
        let v1 = 0x2::linked_table::borrow_mut<0x1::type_name::TypeName, Rewarder>(&mut arg0.rewarders, 0x1::type_name::with_defining_ids<T0>());
    ...
    public fun borrow_pool_allocate_point(arg0: &RewarderManager, arg1: 0x1::type_name::TypeName, arg2: 0x2::object::ID) : u64 {
        ...
        0x2::linked_table::borrow<0x2::object::ID, PoolRewarderInfo>(&0x2::linked_table::borrow<0x1::type_name::TypeName, Rewarder>(&arg0.rewarders, arg1).pools, arg2).allocate_point
    }
    ...
    public fun borrow_rewarder<T0>(arg0: &RewarderManager) : &Rewarder {
        0x2::linked_table::borrow<0x1::type_name::TypeName, Rewarder>(&arg0.rewarders, 0x1::type_name::with_defining_ids<T0>())
    }

    public fun create_rewarder<T0>(arg0: &0x5fcfe31c479b3d83db28dd5e5d40ddfe01b1451b30677aad9f273e5322c0ee15::config::GlobalConfig, arg1: &mut RewarderManager, arg2: u128, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x5fcfe31c479b3d83db28dd5e5d40ddfe01b1451b30677aad9f273e5322c0ee15::config::checked_package_version(arg0);
        0x5fcfe31c479b3d83db28dd5e5d40ddfe01b1451b30677aad9f273e5322c0ee15::config::check_rewarder_manager_role(arg0, 0x2::tx_context::sender(arg4));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = Rewarder{
            reward_coin            : v0,
            total_allocate_point   : 0,
            emission_per_second    : arg2,
            last_reward_time       : now_seconds(arg3),
            total_reward_released  : 0,
            total_reward_harvested : 0,
            pools                  : 0x2::linked_table::new<0x2::object::ID, PoolRewarderInfo>(arg4),
        };
        assert!(!0x2::linked_table::contains<0x1::type_name::TypeName, Rewarder>(&arg1.rewarders, v0), 1);
    ...
    public fun deposit_rewarder<T0>(arg0: &0x5fcfe31c479b3d83db28dd5e5d40ddfe01b1451b30677aad9f273e5322c0ee15::config::GlobalConfig, arg1: &mut RewarderManager, arg2: 0x2::balance::Balance<T0>) {
        0x5fcfe31c479b3d83db28dd5e5d40ddfe01b1451b30677aad9f273e5322c0ee15::config::checked_package_version(arg0);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        ...
        let v1 = DepositEvent{
            ...
            after_amount   : 0x2::balance::join<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.vault, v0), arg2),
        };
        0x2::event::emit<DepositEvent>(v1);
    }

    public fun emergent_withdraw<T0>(arg0: &0x5fcfe31c479b3d83db28dd5e5d40ddfe01b1451b30677aad9f273e5322c0ee15::config::AdminCap, arg1: &0x5fcfe31c479b3d83db28dd5e5d40ddfe01b1451b30677aad9f273e5322c0ee15::config::GlobalConfig, arg2: &mut RewarderManager, arg3: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        ...
        let v2 = EmergentWithdrawEvent{
            ...
            after_amount    : 0x2::balance::value<T0>(v1) - arg3,
        };
    ...
    public fun pool_acc_per_share(arg0: &PoolRewarderInfo) : u256 {
        arg0.acc_per_share
    }
    ...
    public(friend) fun pool_rewards_settle(arg0: &mut RewarderManager, arg1: vector<0x1::type_name::TypeName>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) : 0x2::vec_map::VecMap<0x1::type_name::TypeName, u256> {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&arg1)) {
            ...
            0x2::vec_map::insert<0x1::type_name::TypeName, u256>(&mut v2, v3, v5);
            v1 = v1 + 1;
        };
        v2
    }
    ...
    public(friend) fun set_pool<T0>(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::clock::Clock) : u256 {
        assert!(is_pool_registered(arg0, arg1), 6);
        assert!(is_pool_in_rewarder(arg0, 0x1::type_name::with_defining_ids<T0>(), arg1), 8);
        let v0 = now_seconds(arg3);
        accumulate_pools_reward<T0>(arg0, v0);
        let v1 = 0x2::linked_table::borrow_mut<0x1::type_name::TypeName, Rewarder>(&mut arg0.rewarders, 0x1::type_name::with_defining_ids<T0>());
        accumulate_rewarder_released(v1, v0);
    ...
    public fun update_rewarder<T0>(arg0: &0x5fcfe31c479b3d83db28dd5e5d40ddfe01b1451b30677aad9f273e5322c0ee15::config::GlobalConfig, arg1: &mut RewarderManager, arg2: u128, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        0x5fcfe31c479b3d83db28dd5e5d40ddfe01b1451b30677aad9f273e5322c0ee15::config::checked_package_version(arg0);
        0x5fcfe31c479b3d83db28dd5e5d40ddfe01b1451b30677aad9f273e5322c0ee15::config::check_rewarder_manager_role(arg0, 0x2::tx_context::sender(arg4));
        assert!(0x2::linked_table::contains<0x1::type_name::TypeName, Rewarder>(&arg1.rewarders, 0x1::type_name::with_defining_ids<T0>()), 2);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = now_seconds(arg3);
        accumulate_pools_reward<T0>(arg1, v1);
    ...
    public fun vault_balance<T0>(arg0: &RewarderManager) : u64 {
        0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg0.vault, 0x1::type_name::with_defining_ids<T0>()))
    }

    public(friend) fun withdraw_reward<T0>(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(is_pool_registered(arg0, arg1), 6);
        assert!(is_pool_in_rewarder(arg0, v0, arg1), 8);
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.vault, v0), 5);
        ...
        let v3 = 0x2::linked_table::borrow_mut<0x2::object::ID, PoolRewarderInfo>(&mut v2.pools, arg1);
        v3.reward_harvested = v3.reward_harvested + arg2;
        assert!(v3.reward_released >= (v3.reward_harvested as u128), 0);
        assert!(v2.total_reward_released >= (v2.total_reward_harvested as u128), 0);
