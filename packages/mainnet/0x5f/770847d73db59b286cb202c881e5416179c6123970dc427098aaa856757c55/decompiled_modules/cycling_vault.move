module 0x5f770847d73db59b286cb202c881e5416179c6123970dc427098aaa856757c55::cycling_vault {
    ...
    public fun get_rebalance_settings<T0, T1>(arg0: &Vault<T0, T1>) : (bool, bool, bool, u64, u64, address, u64) {
        (arg0.auto_rebalance, arg0.use_zap, arg0.auto_compound, arg0.rebalance_delay_ms, arg0.rebalance_count, arg0.fee_recipient, arg0.max_zap_slippage_bps)
    }
    ...
    public fun max_zap_slippage_bps<T0, T1>(arg0: &Vault<T0, T1>) : u64 {
        arg0.max_zap_slippage_bps
    }
    ...
    public entry fun update_rebalance_settings<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: bool, arg2: bool, arg3: bool, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.max_zap_slippage_bps = arg5;
    ...
    public fun withdraw<T0, T1>(arg0: &mut VaultConfig, arg1: Vault<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v32 = v3;
        let v33 = v4;
        0x2::balance::join<T0>(&mut v32, v5);
        0x2::balance::join<T1>(&mut v33, v6);
        let v34 = VaultWithdrawn{
            vault_id : 0x2::object::uid_to_address(&v31),
            owner    : v1,
            total_x  : 0x2::balance::value<T0>(&v32),
            total_y  : 0x2::balance::value<T1>(&v33),
        };
        0x2::event::emit<VaultWithdrawn>(v34);
        0x2::object::delete(v31);
        (0x2::coin::from_balance<T0>(v32, arg2), 0x2::coin::from_balance<T1>(v33, arg2))
    }
