module 0x5f0b9a4c4c1d3648d7e87e4f673c046f5f5ef8dee503cb1b86558c8069a66b1d::agent {
    ...
    fun init(arg0: AGENT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = setupNft(&v1, arg1);
        0x2::transfer::public_transfer<0x2::display::Display<AGENT_NFT>>(v2, v0);
        ...
        0x2::transfer::public_share_object<VaultConfig>(v5);
    }
    ...
    fun setupNft(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) : 0x2::display::Display<AGENT_NFT> {
        ...
        let v4 = 0x2::display::new_with_fields<AGENT_NFT>(arg0, v0, v2, arg1);
        0x2::display::update_version<AGENT_NFT>(&mut v4);
        v4
    }
