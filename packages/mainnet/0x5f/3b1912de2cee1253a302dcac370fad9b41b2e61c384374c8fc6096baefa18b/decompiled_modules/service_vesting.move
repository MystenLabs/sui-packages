module 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::service_vesting {
            ...
            if (v0 + 1 > v1) {
                if (0x1::vector::length<Period>(arg0) > v1) {
                    ...
                    if (v1 == 0) {
                        ...
                        v2.unlock_amount = 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::cal_amount_with_percent(arg2, arg1.tge_unlock_percent);
                    } else {
                        let v3 = (0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::max_percent() - arg1.tge_unlock_percent) / v0;
                        v2.release_time = arg1.tge_time + (arg1.number_of_cliff_months + v1 * arg1.number_of_linear) * 300000;
                        v2.percentage = v3;
                        v2.unlock_amount = 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::cal_amount_with_percent(arg2, v3);
                    };
                } else {
                    let v4 = if (v1 == 0) {
                        Period{period_id: v1, release_time: arg1.tge_time, percentage: arg1.tge_unlock_percent, unlock_amount: 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::cal_amount_with_percent(arg2, arg1.tge_unlock_percent), is_withdrawal: false}
                    } else {
                        let v5 = (0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::max_percent() - arg1.tge_unlock_percent) / v0;
                        Period{period_id: v1, release_time: arg1.tge_time + (arg1.number_of_cliff_months + v1 * arg1.number_of_linear) * 300000, percentage: v5, unlock_amount: 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::cal_amount_with_percent(arg2, v5), is_withdrawal: false}
                    };
    ...
    public(friend) fun execute_migrate_vesting(arg0: &mut 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::service::Service, arg1: address) {
        let v0 = 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::get_key_by_struct<Feature>();
        if (0x2::vec_set::contains<0x1::string::String>(0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::service::features(arg0), &v0)) {
    ...
    fun migrate_vesting(arg0: &mut 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::service::Service, arg1: address) {
        let v0 = 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::service::get_feature_mut<Feature, Config>(arg0);
        if (0x2::dynamic_field::exists_<address>(&v0.id, arg1)) {
            let v1 = 0x2::dynamic_field::borrow_mut<address, VestingDetail>(&mut v0.id, arg1);
            if (v1.total_unlock_amount == 0) {
