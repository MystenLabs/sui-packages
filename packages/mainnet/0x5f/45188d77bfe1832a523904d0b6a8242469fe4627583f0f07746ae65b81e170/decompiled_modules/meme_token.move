module 0x5f45188d77bfe1832a523904d0b6a8242469fe4627583f0f07746ae65b81e170::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"2", b"Two Face", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-19T09-10-40.117Z-600x600 (7).jpeg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Two Face"),
            symbol     : 0x1::string::utf8(b"2"),
            decimals   : 9,
