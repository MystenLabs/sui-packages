module 0x5f97b4bcbf0db3530c940b95695e0fbb7480458620d0ba2b7b67383a9960eb15::cnsnft9905 {
    struct CNSNFT9905 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9905, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9905>(arg0, arg1);
