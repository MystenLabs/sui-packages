module 0x5fb8c1bb695568b97e1b343528a661ec4806b776f1743ed400d1bb753b6a67a4::acl {
    struct Vyktxoqayccydeq has key {
        id: 0x2::object::UID,
        pools: 0x2::table::Table<0x1::ascii::String, Tnteowvnivmvriy>,
    }

    struct Tnteowvnivmvriy has store {
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Vyktxoqayccydeq{
            id    : 0x2::object::new(arg0),
            pools : 0x2::table::new<0x1::ascii::String, Tnteowvnivmvriy>(arg0),
        };
        0x2::transfer::share_object<Vyktxoqayccydeq>(v0);
    }

    public entry fun jqabnagqummurao(arg0: &mut Vyktxoqayccydeq, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Tnteowvnivmvriy>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Tnteowvnivmvriy>(&mut arg0.pools, arg1);
        assert!(0x2::tx_context::sender(arg3) == v0.owner, 0);
        v0.initialized = arg2;
    }

    public entry fun mgccqoqisqhbesj(arg0: &mut Vyktxoqayccydeq, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Tnteowvnivmvriy{
        ...
        0x2::table::add<0x1::ascii::String, Tnteowvnivmvriy>(&mut arg0.pools, arg1, v0);
    }

    public entry fun moigwwtjpgkzwwk(arg0: &mut Vyktxoqayccydeq, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<0x1::ascii::String, Tnteowvnivmvriy>(&mut arg0.pools, arg1, v4);
    }

    public entry fun ngepyqmhlhxhmul(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Vyktxoqayccydeq, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Tnteowvnivmvriy>(&arg2.pools, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Tnteowvnivmvriy>(&mut arg2.pools, arg3);
        if (v0.initialized) {
    ...
    public entry fun prpznytcsahrran<T0>(arg0: &mut Vyktxoqayccydeq, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Tnteowvnivmvriy>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Tnteowvnivmvriy>(&mut arg0.pools, arg1);
    ...
    public entry fun rgsvpxtnciyauic(arg0: &mut Vyktxoqayccydeq, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Tnteowvnivmvriy>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Tnteowvnivmvriy>(&mut arg0.pools, arg1);
    ...
    public entry fun uubnrpdtzvzrczc<T0: store + key>(arg0: &mut Vyktxoqayccydeq, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Tnteowvnivmvriy>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Tnteowvnivmvriy>(&mut arg0.pools, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.delegate, 0);
