module 0x5ffec7c2e5a8e46d805ba800988553e25e6f1e0fd7dd5343ccd72d3346e7ba54::chop_locker {
    ...
    public fun calculate_apy<T0>(arg0: &0x2::balance::Balance<T0>, arg1: u64, arg2: &0x2::balance::Balance<T0>, arg3: u64) : u64 {
        ...
        let v0 = 365;
        let v1 = 1;
        let v2 = (0x2::balance::value<T0>(arg0) as u128) / (arg1 as u128);
        assert!(v2 <= 340282366920938463463374607431768211455, 6);
        let v3 = ((0x2::balance::value<T0>(arg2) / v0) as u128) / (v0 as u128);
        assert!(v3 <= 340282366920938463463374607431768211455, 6);
        let v4 = v2 * v3 / (1000000000 as u128);
        assert!(v4 <= 340282366920938463463374607431768211455, 6);
        let v5 = v4 * (((100 * arg3 / 90 + 50) * 1000) as u128);
        assert!(v5 <= 340282366920938463463374607431768211455, 6);
        let v6 = v5 * (365 as u128);
        assert!(v6 <= 340282366920938463463374607431768211455 / v1 * 100, 6);
        let v7 = v6 / v1;
        assert!(v7 <= 340282366920938463463374607431768211455 / 100, 6);
        let v8 = v7 * 100;
        if (v8 > (50000000 as u128)) {
            50000000
        } else {
            (v8 as u64)
        }
    ...
    public entry fun lock_tokens<T0>(arg0: &mut PoolConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = Lock<T0>{
            ...
            start_time     : v2,
            end_time       : v2 + arg3,
            locked_in_apy  : calculate_apy<T0>(0x2::coin::balance<T0>(&arg1), v1, &arg0.reward_balance, arg3 / 86400000 + 1),
            token_type     : arg4,
            rewards_locked : v5,
        };
