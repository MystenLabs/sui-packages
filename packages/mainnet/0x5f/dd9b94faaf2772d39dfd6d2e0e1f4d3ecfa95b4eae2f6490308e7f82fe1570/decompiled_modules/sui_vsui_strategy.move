        ...
        if (v0 > 0) {
            ...
            if (0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::native_pool::from_shares(arg3, arg4, v2) < 1000000000) {
                if (v0 < 1000000000 && v3 >= (1000000000 as u256)) {
                    ...
                    if (v7 >= v4) {
                        let v8 = revolving_repay_and_withdraw(arg0, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, 0x2::balance::split<0x2::sui::SUI>(&mut v6, v4), v0, arg14);
                        ...
                        if (v7 >= (v14 as u64)) {
                            0x2::balance::join<0x2::sui::SUI>(&mut v13, 0x2::balance::split<0x2::sui::SUI>(&mut v6, (v14 as u64)));
                        } else {
                            0x2::balance::join<0x2::sui::SUI>(&mut v13, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut v6));
                        };
                        let v15 = revolving_repay_and_withdraw(arg0, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, v13, v0 + v10, arg14);
                        0x2::balance::join<0x2::sui::SUI>(&mut v6, v15);
                        0x2::balance::join<0x2::sui::SUI>(&mut v6, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::flash_repay_with_account_cap<0x2::sui::SUI>(arg6, arg7, arg8, v12, 0x2::balance::split<0x2::sui::SUI>(&mut v6, v9 + v10), &arg0.navi_cap));
                        0x64b80daba2e1975c9f9ff0e9d82b6e08499bcbcee642fa8e6db7ebcbd1b9665c::vault::strategy_withdraw_to_ticket<0x2::sui::SUI, 0x733f575e7f21ed71e2a9633d99f7bf5657d9bbbd424c2b328c522cac010e326c::st_sui::ST_SUI>(arg2, &arg0.vault_access, 0x2::balance::split<0x2::sui::SUI>(&mut v6, v0));
                        add_to_collected_asset<0x2::sui::SUI>(arg0, v6);
                    };
                } else {
                    assert!(v0 <= (v3 as u64), 77777);
                    abort 11111111
                };
            } else {
                let (v16, v17) = 0x64b80daba2e1975c9f9ff0e9d82b6e08499bcbcee642fa8e6db7ebcbd1b9665c::vault::flash_loan<0x2::sui::SUI, 0x733f575e7f21ed71e2a9633d99f7bf5657d9bbbd424c2b328c522cac010e326c::st_sui::ST_SUI>(arg1, &arg0.vault_access, v1);
                let v18 = revolving_repay_and_withdraw(arg0, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, v16, v0, arg14);
                0x64b80daba2e1975c9f9ff0e9d82b6e08499bcbcee642fa8e6db7ebcbd1b9665c::vault::repay_flash_loan<0x2::sui::SUI, 0x733f575e7f21ed71e2a9633d99f7bf5657d9bbbd424c2b328c522cac010e326c::st_sui::ST_SUI>(arg1, &arg0.vault_access, v17, 0x2::balance::split<0x2::sui::SUI>(&mut v18, v1));
                ...
                add_to_collected_asset<0x2::sui::SUI>(arg0, v18);
            };
        };
