module 0x5fb5910ed74bd34ecb9e3aa4ac49f2d8bc9647ec4c9bad1ccda0c92957303df0::reward6793 {
    struct REWARD6793 has drop {
        dummy_field: bool,
    }

    struct TICKET_6793 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6793(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6793>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6793>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6793, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6793>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6793>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6793>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6793>>(v5, 0x2::tx_context::sender(arg1));
    }
