module 0x5fd1759032f04495bcd53de8844461ceecf9196458b27f4cf84e7fde436fb9ae::cnsnft9909 {
    struct CNSNFT9909 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9909, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9909>(arg0, arg1);
