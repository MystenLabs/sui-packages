module 0x5f1d00b445ffb062843b24e2cce2af900bab2a2128854235bfb81a0df9e964ea::cuddles {
    ...
    fun init(arg0: CUDDLES, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/ethereum/0x1073f7d2ac9c9c7094fe7b1f326ee8bda2cc3fe2.png                                                                                                                                                                                                                               ");
