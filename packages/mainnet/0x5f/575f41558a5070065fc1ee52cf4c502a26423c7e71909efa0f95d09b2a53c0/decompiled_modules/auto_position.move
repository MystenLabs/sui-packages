module 0x5f575f41558a5070065fc1ee52cf4c502a26423c7e71909efa0f95d09b2a53c0::auto_position {
    ...
    public fun new<T0: store + key>(arg0: T0, arg1: 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, arg2: address, arg3: u64, arg4: &0x5f575f41558a5070065fc1ee52cf4c502a26423c7e71909efa0f95d09b2a53c0::registry::ProxyCap) : AutoPosition<T0> {
        assert!(arg3 < 0x5f575f41558a5070065fc1ee52cf4c502a26423c7e71909efa0f95d09b2a53c0::constants::scaling_pips(), 2);
        AutoPosition<T0>{
            owner         : arg2,
    ...
    public fun unwrap<T0: store + key>(arg0: AutoPosition<T0>, arg1: &0x5f575f41558a5070065fc1ee52cf4c502a26423c7e71909efa0f95d09b2a53c0::registry::ProxyCap) : (address, T0, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, u64) {
        let AutoPosition {
            owner         : v0,
            inner         : v1,
            vault         : v2,
