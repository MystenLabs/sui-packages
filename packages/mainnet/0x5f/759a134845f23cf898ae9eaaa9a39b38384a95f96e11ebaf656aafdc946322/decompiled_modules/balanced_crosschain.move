module 0x2bda1780dc59243386d205f1855cde689dbbb87003d71a2518832638589d48cf::balanced_crosschain {
    ...
    public(friend) fun cross_transfer<T0>(arg0: &mut Config<T0>, arg1: &mut 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::xcall_state::Storage, arg2: &0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::xcall_manager::Config, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: 0x2::coin::Coin<T0>, arg5: 0x1::string::String, arg6: 0x1::option::Option<vector<u8>>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        cross_transfer_internal<T0>(arg0, arg1, arg2, arg3, arg4, translate_outgoing_amount(v0), v0, arg5, arg6, arg7);
    }

    public(friend) fun cross_transfer_exact<T0>(arg0: &mut Config<T0>, arg1: &mut 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::xcall_state::Storage, arg2: &0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::xcall_manager::Config, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: 0x2::coin::Coin<T0>, arg5: u128, arg6: 0x1::string::String, arg7: 0x1::option::Option<vector<u8>>, arg8: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = if (arg5 > 0) {
            let v2 = ((arg5 / 1000000000) as u64);
            let v3 = v2;
            if (arg5 % 1000000000 > 0) {
                v3 = v2 + 1;
            };
            assert!(v3 == 0x2::coin::value<T0>(&arg4), 9);
            (v3, arg5)
        } else {
            let v4 = 0x2::coin::value<T0>(&arg4);
            (v4, translate_outgoing_amount(v4))
        };
        cross_transfer_internal<T0>(arg0, arg1, arg2, arg3, arg4, v1, v0, arg6, arg7, arg8);
    }

    fun cross_transfer_internal<T0>(arg0: &mut Config<T0>, arg1: &mut 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::xcall_state::Storage, arg2: &0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::xcall_manager::Config, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: 0x2::coin::Coin<T0>, arg5: u128, arg6: u64, arg7: 0x1::string::String, arg8: 0x1::option::Option<vector<u8>>, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg6 > 0, 1);
        let v0 = get_treasury_cap_mut<T0>(arg0);
        0x2::coin::burn<T0>(v0, arg4);
        let v1 = 0x2::tx_context::sender(arg9);
        let v2 = 0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::cross_transfer::wrap_cross_transfer(0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::balanced_utils::address_to_hex_string(&v1), arg7, arg5, 0x1::option::get_with_default<vector<u8>>(&arg8, b""));
        let v3 = 0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::cross_transfer_revert::wrap_cross_transfer_revert(v1, arg6);
        let (v4, v5) = 0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::xcall_manager::get_protocals(arg2);
        let v6 = 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::envelope::wrap_call_message_rollback(0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::cross_transfer::encode(&v2, b"xCrossTransfer"), 0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::cross_transfer_revert::encode(&v3, b"xCrossTransferRevert"), v4, v5);
        0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::main::send_call(arg1, arg3, get_idcap<T0>(arg0), arg0.icon_token_address, 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::envelope::encode(&v6), arg9);
    }
