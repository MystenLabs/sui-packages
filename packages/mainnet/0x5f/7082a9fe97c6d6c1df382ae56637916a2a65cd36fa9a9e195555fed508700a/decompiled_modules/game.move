module 0x5f7082a9fe97c6d6c1df382ae56637916a2a65cd36fa9a9e195555fed508700a::game {
    ...
    public entry fun process_payouts(arg0: &mut EscrowPool, arg1: &mut Leaderboard, arg2: u8, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 >= 3 && v1 > 0) {
            let v3 = find_top_index(v0, v2, vector[]);
            let v4 = 0x1::vector::empty<u64>();
            0x1::vector::push_back<u64>(&mut v4, v3);
            let v5 = find_top_index(v0, v2, v4);
            ...
            let v8 = v1 * 30 / 100;
            let v9 = v1 * 20 / 100;
            let v10 = 0x1::vector::borrow<LeaderboardEntry>(v0, v3);
            let v11 = 0x1::vector::borrow<LeaderboardEntry>(v0, v5);
            let v12 = 0x1::vector::borrow<LeaderboardEntry>(v0, find_top_index(v0, v2, v6));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg0.balance, v7, arg4), v10.player);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg0.balance, v8, arg4), v11.player);
            ...
            0x2::event::emit<PayoutProcessed>(v13);
            ...
            0x2::event::emit<PayoutProcessed>(v15);
        };
    }
    ...
    public entry fun start_game(arg0: &mut EscrowPool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u8, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<GameSession>(v2, v0);
        let v3 = GameStarted{
            player    : v0,
            tier      : arg2,
            period    : arg3,
