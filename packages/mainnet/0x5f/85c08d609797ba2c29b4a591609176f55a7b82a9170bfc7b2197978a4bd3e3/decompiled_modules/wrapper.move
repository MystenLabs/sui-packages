module 0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::wrapper {
    ...
    public fun disable_version(arg0: &mut Wrapper, arg1: &0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::admin::AdminCap, arg2: u16, arg3: vector<vector<u8>>, arg4: vector<u8>, arg5: u16, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::multisig::check_if_sender_is_multisig_address(arg3, arg4, arg5, arg6), 6);
        assert!(arg2 != 0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::helper::current_version(), 3);
        assert!(0x2::vec_set::contains<u16>(&arg0.allowed_versions, &arg2), 4);
        0x2::vec_set::remove<u16>(&mut arg0.allowed_versions, &arg2);
    }

    public fun enable_version(arg0: &mut Wrapper, arg1: &0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::admin::AdminCap, arg2: u16, arg3: vector<vector<u8>>, arg4: vector<u8>, arg5: u16, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::multisig::check_if_sender_is_multisig_address(arg3, arg4, arg5, arg6), 6);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Wrapper{
            ...
            allowed_versions            : 0x2::vec_set::singleton<u16>(0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::helper::current_version()),
    ...
    public(friend) fun settle_user_fees<T0, T1, T2>(arg0: &mut Wrapper, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: u128, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        let v7 = if (v6 == 0) {
            ...
            0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::math::div(0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::math::mul(v3, v4 - v6), v5)
        };
        ...
        if (v9 > 0) {
            ...
            0x2::event::emit<UserFeesSettled<T2>>(v10);
        };
    ...
    public(friend) fun verify_version(arg0: &Wrapper) {
        let v0 = 0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::helper::current_version();
        assert!(0x2::vec_set::contains<u16>(&arg0.allowed_versions, &v0), 5);
    }

    public fun withdraw_deep_reserves(arg0: &mut Wrapper, arg1: 0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket::AdminTicket, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP> {
        verify_version(arg0);
        0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket::validate_ticket(&arg1, 0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket::withdraw_deep_reserves_ticket_type(), arg3, arg4);
        0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket::destroy_ticket(arg1);
    ...
    public fun withdraw_deep_reserves_coverage_fee<T0>(arg0: &mut Wrapper, arg1: 0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket::AdminTicket, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        verify_version(arg0);
        0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket::validate_ticket(&arg1, 0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket::withdraw_coverage_fee_ticket_type(), arg2, arg3);
        0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket::destroy_ticket(arg1);
        let v0 = ChargedFeeKey<T0>{dummy_field: false};
        if (0x2::bag::contains<ChargedFeeKey<T0>>(&arg0.deep_reserves_coverage_fees, v0)) {
    ...
    public fun withdraw_protocol_fee<T0>(arg0: &mut Wrapper, arg1: 0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket::AdminTicket, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        verify_version(arg0);
        0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket::validate_ticket(&arg1, 0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket::withdraw_protocol_fee_ticket_type(), arg2, arg3);
        0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket::destroy_ticket(arg1);
        let v0 = ChargedFeeKey<T0>{dummy_field: false};
        if (0x2::bag::contains<ChargedFeeKey<T0>>(&arg0.protocol_fees, v0)) {
