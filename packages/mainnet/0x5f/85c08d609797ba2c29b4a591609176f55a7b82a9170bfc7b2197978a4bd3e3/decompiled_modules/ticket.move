module 0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::ticket {
    ...
    public fun create_ticket(arg0: &0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::admin::AdminCap, arg1: u8, arg2: vector<vector<u8>>, arg3: vector<u8>, arg4: u16, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x5f85c08d609797ba2c29b4a591609176f55a7b82a9170bfc7b2197978a4bd3e3::multisig::check_if_sender_is_multisig_address(arg2, arg3, arg4, arg6), 5);
        let v0 = AdminTicket{
    ...
    public fun is_ticket_expired(arg0: &AdminTicket, arg1: &0x2::clock::Clock) : bool {
        0x2::clock::timestamp_ms(arg1) / 1000 >= arg0.created_at + 60 + 120
    }

    public fun is_ticket_ready(arg0: &AdminTicket, arg1: &0x2::clock::Clock) : bool {
        0x2::clock::timestamp_ms(arg1) / 1000 >= arg0.created_at + 60
    }
