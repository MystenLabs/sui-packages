module 0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::safu {
    ...
    public fun reward_navi<T0>(arg0: &0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::IncentiveFundsPool<T0>, arg5: u8, arg6: u8, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        let v1 = if (0x2::dynamic_object_field::exists_<0x1::ascii::String>(&v0.id, 0x1::ascii::string(b"navi_account_cap"))) {
            0x2::dynamic_object_field::remove<0x1::ascii::String, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap>(&mut v0.id, 0x1::ascii::string(b"navi_account_cap"))
        } else {
            0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::create_account(arg9)
        };
        let v2 = v1;
        let v3 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::claim_reward_with_account_cap<T0>(arg8, arg7, arg4, arg3, arg5, arg6, &v2);
        0x2::dynamic_object_field::add<0x1::ascii::String, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap>(&mut v0.id, 0x1::ascii::string(b"suilend_obligation_owner_cap"), v2);
        let v4 = 0x1::vector::empty<u64>();
        let v5 = &mut v4;
        0x1::vector::push_back<u64>(v5, arg2);
        0x1::vector::push_back<u64>(v5, *0x1::vector::borrow<u64>(&v0.info, 1));
    ...
    public fun reward_suilend<T0>(arg0: &0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        let v1 = if (0x2::dynamic_object_field::exists_<0x1::ascii::String>(&v0.id, 0x1::ascii::string(b"suilend_obligation_owner_cap"))) {
            ...
            0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::create_obligation<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>(arg3, arg7)
        };
        let v2 = v1;
        let v3 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::claim_rewards<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL, T0>(arg3, &v2, arg6, arg4, arg5, true, arg7);
        ...
        0x1::vector::push_back<u64>(v5, arg2);
        0x1::vector::push_back<u64>(v5, *0x1::vector::borrow<u64>(&v0.info, 1));
        0x1::vector::push_back<u64>(v5, 0x2::coin::value<T0>(&v3));
        let v6 = ManagerEvent{
