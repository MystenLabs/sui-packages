module 0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::safu {
    ...
    public fun hotfix_transfer_receipt<T0: store + key>(arg0: &0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) : T0 {
        0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::verify(arg0, arg3);
        0x2::dynamic_object_field::remove<0x1::ascii::String, T0>(&mut 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.id, arg2).id, 0x1::ascii::string(b"typus_bid_receipt"))
    }
    ...
    entry fun new_vault<T0>(arg0: &0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: bool, arg5: u64, arg6: u64, arg7: u64, arg8: vector<u64>, arg9: 0x2::coin::Coin<T0>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::verify(arg0, arg11);
        ...
        0x2::dynamic_field::add<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v0, 0x1::ascii::string(b"mist_balance"), 0x2::coin::into_balance<T0>(arg9));
        ...
        *0x1::vector::borrow_mut<u64>(&mut v1, 11) = 0x2::clock::timestamp_ms(arg10);
        assert!(0x1::vector::length<u64>(&arg8) == 12, invalid_input(*0x1::vector::borrow<u64>(&v1, 0)));
        let v3 = Vault{
            id            : v0,
    ...
    public fun post_exercise_v2<T0>(arg0: &mut 0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::verify(arg0, arg4);
        let v0 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.id, arg2);
        assert!(*0x1::vector::borrow<u64>(&v0.info, 4) == 0, invalid_status(arg2));
    ...
    public fun reduce_fund_v2<T0>(arg0: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::TypusLeaderboardRegistry, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::TypusUserRegistry, arg3: &mut 0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::Version, arg4: &mut Registry, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::version_check(arg3);
        assert!(!arg4.transaction_suspended, transaction_suspended(arg5));
        let v0 = 0x2::clock::timestamp_ms(arg10);
        let v1 = 0x2::dynamic_field::remove<0x1::ascii::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::ManagerCap>(&mut arg4.id, 0x1::ascii::string(b"typus_manager_cap"));
        ...
        0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::charge_fee<0x2::sui::SUI>(arg3, 0x2::coin::into_balance<0x2::sui::SUI>(arg9));
        let v3 = 0x2::tx_context::sender(arg11);
        ...
        assert!(v5 < v6, user_share_not_found(arg5));
        ...
        *0x1::vector::borrow_mut<u64>(&mut v10.u64_padding, 1) = v0;
        ...
        0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::score(&v1, arg0, arg1, 0x1::ascii::string(b"depositor_program"), v3, v12, arg10, arg11);
        ...
        *0x1::vector::borrow_mut<u64>(&mut v10.u64_padding, 0) = ((((*0x1::vector::borrow<u64>(&v10.share, 0) + *0x1::vector::borrow<u64>(&v10.share, 3)) as u128) * (*0x1::vector::borrow<u64>(&v2.info, 6) as u128) / (10000000 as u128) / (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::utility::multiplier(*0x1::vector::borrow<u64>(&v2.info, 9)) as u128)) as u64);
        assert!(v13 + v14 + v15 > 0, zero_value(arg5));
        if (is_empty(v10)) {
            0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::swap_remove<Share>(&mut v2.share, v5);
        };
        let v16 = (((0x2::balance::value<T0>(&v4) as u128) * (*0x1::vector::borrow<u64>(&v2.config, 10) as u128) / (10000 as u128)) as u64);
        0xd6819663ea3d4ad463993e6e0e33332955deeeb63969b3f16aeba392a24096da::version::charge_fee<T0>(arg3, 0x2::balance::split<T0>(&mut v4, v16));
        let v17 = 0x1::vector::empty<u64>();
        let v18 = &mut v17;
        0x1::vector::push_back<u64>(v18, arg5);
        0x1::vector::push_back<u64>(v18, *0x1::vector::borrow<u64>(&v2.info, 1));
        0x1::vector::push_back<u64>(v18, v13);
        0x1::vector::push_back<u64>(v18, v14);
        0x1::vector::push_back<u64>(v18, v15);
        0x1::vector::push_back<u64>(v18, v12);
        0x1::vector::push_back<u64>(v18, v16);
        0x1::vector::push_back<u64>(v18, *0x1::vector::borrow<u64>(&v2.config, 11));
        let v19 = 0x1::type_name::get<T0>();
        let v20 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v20, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v19));
        let v21 = UserEvent{
            action      : 0x1::ascii::string(b"reduce_fund"),
            log         : v17,
            bcs_padding : v20,
        };
        0x2::event::emit<UserEvent>(v21);
        0x2::dynamic_field::add<0x1::ascii::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::ManagerCap>(&mut arg4.id, 0x1::ascii::string(b"typus_manager_cap"), v1);
        v4
    }
