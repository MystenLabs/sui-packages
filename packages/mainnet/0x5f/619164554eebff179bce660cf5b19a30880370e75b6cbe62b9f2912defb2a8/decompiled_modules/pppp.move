module 0x5f619164554eebff179bce660cf5b19a30880370e75b6cbe62b9f2912defb2a8::pppp {
    ...
    public fun mint_max_supply(arg0: &mut 0x2::coin::TreasuryCap<PPPP>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<PPPP> {
        assert!(0x2::coin::total_supply<PPPP>(arg0) + 1000000000 <= 1000000000, 0);
        0x2::coin::mint<PPPP>(arg0, 1000000000, arg1)
    }
