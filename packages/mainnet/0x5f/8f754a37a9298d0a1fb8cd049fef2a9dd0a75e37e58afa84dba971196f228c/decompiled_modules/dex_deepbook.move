module 0x5f8f754a37a9298d0a1fb8cd049fef2a9dd0a75e37e58afa84dba971196f228c::dex_deepbook {
    ...
    public fun get_deep_token_package() : address {
        0x5f8f754a37a9298d0a1fb8cd049fef2a9dd0a75e37e58afa84dba971196f228c::constants::deep_token_package()
    }

    public fun get_deepbook_config() : (address, address, address) {
        (0x5f8f754a37a9298d0a1fb8cd049fef2a9dd0a75e37e58afa84dba971196f228c::constants::deepbook_package(), 0x5f8f754a37a9298d0a1fb8cd049fef2a9dd0a75e37e58afa84dba971196f228c::constants::deepbook_registry(), 0x5f8f754a37a9298d0a1fb8cd049fef2a9dd0a75e37e58afa84dba971196f228c::constants::deepbook_treasury())
    }
    ...
    public fun swap_sui_to_usdc<T0, T1>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v0 > 0, 3401);
        assert!(arg0 == 0x5f8f754a37a9298d0a1fb8cd049fef2a9dd0a75e37e58afa84dba971196f228c::constants::deepbook_sui_usdc_pool(), 3403);
