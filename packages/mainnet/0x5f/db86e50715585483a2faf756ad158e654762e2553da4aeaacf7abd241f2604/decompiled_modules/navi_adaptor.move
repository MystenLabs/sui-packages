module 0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::navi_adaptor {
    ...
    public fun calculate_navi_position_value(arg0: address, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: &0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::vault_oracle::OracleConfig, arg3: &0x2::clock::Clock) : u256 {
        ...
        if (v0 > 0) {
            let (v1, v2) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_balance(arg1, v0 - 1, arg0);
            let (v3, v4) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_index(arg1, v0 - 1);
            0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::ray_math::ray_mul(v1, v3);
            0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::ray_math::ray_mul(v2, v4);
            let v5 = TestNum3{test: 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_coin_type(arg1, v0 - 1)};
            0x2::event::emit<TestNum3>(v5);
            return 0
        };
        0
    }
