module 0x5f3f1eebeb09c8cb16a2eb190e72a20cca883783ac9c45f8a7ea70ebcd0a0f48::reward9340 {
    struct REWARD9340 has drop {
        dummy_field: bool,
    }

    struct TICKET_9340 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9340(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9340>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9340>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9340, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9340>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9340>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9340>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9340>>(v5, 0x2::tx_context::sender(arg1));
    }
