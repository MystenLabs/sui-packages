module 0x5f98c8a5497de8e714eec0c5edced9ddb31611292839f924b10972f1626eefc9::duf {
    struct DUF has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DUF, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<DUF>(&mut v2, 100000000000000000, 0x2::tx_context::sender(arg1), arg1);
