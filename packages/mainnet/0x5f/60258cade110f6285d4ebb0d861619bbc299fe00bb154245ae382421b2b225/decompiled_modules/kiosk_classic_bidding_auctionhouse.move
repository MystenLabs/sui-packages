module 0x5f60258cade110f6285d4ebb0d861619bbc299fe00bb154245ae382421b2b225::kiosk_classic_bidding_auctionhouse {
    ...
    public fun complete_auction<T0: store + key, T1>(arg0: &mut SimpleAuctionStore, arg1: &mut 0x5f60258cade110f6285d4ebb0d861619bbc299fe00bb154245ae382421b2b225::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v29, v30), arg4), 0x5f60258cade110f6285d4ebb0d861619bbc299fe00bb154245ae382421b2b225::auctionhouse::get_owner(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v29, arg4), v2);
    }

    public entry fun complete_auction_entry<T0: store + key, T1>(arg0: &mut SimpleAuctionStore, arg1: &mut 0x5f60258cade110f6285d4ebb0d861619bbc299fe00bb154245ae382421b2b225::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        complete_auction<T0, T1>(arg0, arg1, arg2, arg3, arg4);
    }

    public entry fun create_and_share_simple_auction_store(arg0: &0x5f60258cade110f6285d4ebb0d861619bbc299fe00bb154245ae382421b2b225::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_simple_auction_store(arg0: &0x5f60258cade110f6285d4ebb0d861619bbc299fe00bb154245ae382421b2b225::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : SimpleAuctionStore {
