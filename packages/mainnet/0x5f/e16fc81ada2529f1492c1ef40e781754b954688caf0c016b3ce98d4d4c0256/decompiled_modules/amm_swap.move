module 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_swap {
    ...
    fun assert_lp_value_incr(arg0: u64, arg1: u64, arg2: u64, arg3: u64) {
        assert!(0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_compare_mul_u64(arg2, arg3, arg0, arg1), 1);
    }
    ...
    fun burn<T0, T1>(arg0: &mut Pool, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let v0 = pool_state_mut<T0, T1>(arg0);
        assert!(0x2::clock::timestamp_ms(arg2) - v0.created_at >= 30000, 7077);
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = &mut v0.lp_mapping;
        decrease_lp_balance_table(v2, v1, arg1);
        let (v3, v4) = get_reserves_pool<T0, T1>(v0);
        let v5 = v0.lp_supply;
        let v6 = 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(arg1, v3, v5);
        let v7 = 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(arg1, v4, v5);
        assert!(v6 > 0 && v7 > 0, 3);
    ...
    public fun claim_reward<T0, T1>(arg0: &mut Pool, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(v2.lp, v0.last_euler - v2.euler0, 100000000000);
        assert!(v3 > 0, 4002);
        update_provider_pool<T0, T1>(v0, v1);
        if (is_sui_coin<T0>()) {
    ...
    public fun get_buy_fees_in<T0, T1>(arg0: &Pool, arg1: u64) : (u64, u64, u64, u64) {
        let v0 = pool_state<T0, T1>(arg0);
        let v1 = 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(arg1, 10, 10000);
        let v2 = 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(arg1, v0.protocol_fee_buy, 10000);
        let v3 = 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(arg1, v0.trade_fee_buy, 10000);
        (v1, v2, v3, arg1 - v1 - v2 - v3)
    }

    public fun get_buy_fees_out<T0, T1>(arg0: &Pool, arg1: u64) : (u64, u64, u64, u64) {
        let v0 = pool_state<T0, T1>(arg0);
        let v1 = 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(arg1, 10000, 10000 - 10 + v0.protocol_fee_buy + v0.trade_fee_buy);
        (0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(v1, 10, 10000), 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(v1, v0.protocol_fee_buy, 10000), 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(v1, v0.trade_fee_buy, 10000), v1)
    }
    ...
    public fun get_claimable_reward<T0, T1>(arg0: &Pool, arg1: address) : u64 {
        ...
        if (v0.last_euler == 0) {
            ...
            0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(v2.lp, v0.last_euler - v2.euler0, 100000000000)
        }
    }
    ...
    public fun get_sell_fees_in<T0, T1>(arg0: &Pool, arg1: u64) : (u64, u64, u64, u64) {
        let v0 = pool_state<T0, T1>(arg0);
        let v1 = 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(arg1, 10, 10000);
        let v2 = 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(arg1, v0.protocol_fee_sell, 10000);
        let v3 = 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(arg1, v0.trade_fee_sell, 10000);
        (v1, v2, v3, arg1 - v1 - v2 - v3)
    }

    public fun get_sell_fees_out<T0, T1>(arg0: &Pool, arg1: u64) : (u64, u64, u64, u64) {
        let v0 = pool_state<T0, T1>(arg0);
        let v1 = 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(arg1, 10000, 10000 - 10 + v0.protocol_fee_sell + v0.trade_fee_sell);
        (0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(v1, 10, 10000), 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(v1, v0.protocol_fee_sell, 10000), 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(v1, v0.trade_fee_sell, 10000), v1)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = InitEvent{
            ...
            global_paulse_status_id : 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_config::new_global_pause_status_and_shared(arg0),
        };
    ...
    fun mint<T0, T1>(arg0: &mut Pool, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &0x2::clock::Clock) : u64 {
        ...
        let v4 = if (v3 == 0) {
            ...
            0x2::math::min(0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(0x2::balance::value<T0>(&arg1), v3, v1), 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(0x2::balance::value<T1>(&arg2), v3, v2))
        };
        assert!(v4 > 0, 2);
        0x2::balance::join<T0>(&mut v0.coin_a, arg1);
    ...
    public(friend) fun transfer_fees_balance<T0>(arg0: 0x2::balance::Balance<T0>, arg1: 0x2::balance::Balance<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        transfer_or_destroy_balance<T0>(arg0, @0xeb6e3855fb6cfa2369934d3e30dd5198b64e1ddc9a04b763a8ae369bde0e39eb, arg3);
    ...
    fun update_euler<T0, T1>(arg0: &mut PoolState<T0, T1>, arg1: u64) {
        ...
        arg0.last_euler = arg0.last_euler + 0x5fe16fc81ada2529f1492c1ef40e781754b954688caf0c016b3ce98d4d4c0256::amm_math::safe_mul_div_u64(arg1, 100000000000, arg0.lp_supply);
    }
