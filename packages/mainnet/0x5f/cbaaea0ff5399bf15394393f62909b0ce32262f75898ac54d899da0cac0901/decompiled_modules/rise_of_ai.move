module 0x5fcbaaea0ff5399bf15394393f62909b0ce32262f75898ac54d899da0cac0901::rise_of_ai {
    ...
    fun init(arg0: RISE_OF_AI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<RISE_OF_AI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Rise of AI"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"10,000 meticulously crafted portraits, two years in the making. Not just NFTs, but a world of unique characters where each piece tells a story."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreic5y6nnhozc4dtusz26idcfhxhcalyumcdmtwnpjkdo3cysko34zq"));
