module 0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::factory {
    ...
    public fun create_pool<T0, T1>(arg0: &0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::config::GlobalConfig, arg1: &mut Pools, arg2: u32, arg3: u128, arg4: 0x1::string::String, arg5: u32, arg6: u32, arg7: 0x2::coin::Coin<T0>, arg8: 0x2::coin::Coin<T1>, arg9: bool, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::position::Position, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::config::checked_package_version(arg0);
        assert!(0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::config::is_in_whitelist<T0>(arg0) || 0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::config::is_in_whitelist<T1>(arg0), 1);
        let v0 = create_pool_internal<T0, T1>(arg1, arg0, arg2, arg3, arg4, arg10, arg11);
        let v1 = 0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::pool::open_position<T0, T1>(arg0, &mut v0, arg5, arg6, arg11);
        ...
        let v5 = 0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::pool::add_liquidity_fix_coin<T0, T1>(arg0, &mut v0, &mut v1, v4, arg9, arg10);
        let (v6, v7) = 0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::pool::add_liquidity_pay_amount<T0, T1>(&v5);
        assert!(v6 > 0, 16);
        assert!(v7 > 0, 16);
        assert!(0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::pool::liquidity<T0, T1>(&v0) > 0, 16);
        if (arg9) {
            assert!(v7 <= v3, 4);
        } else {
            assert!(v6 <= v2, 5);
        };
        0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::pool::repay_add_liquidity<T0, T1>(arg0, &mut v0, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg7, v6, arg11)), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg8, v7, arg11)), v5);
        0x2::transfer::public_share_object<0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::pool::Pool<T0, T1>>(v0);
        (v1, arg7, arg8)
    }

    fun create_pool_internal<T0, T1>(arg0: &mut Pools, arg1: &0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::config::GlobalConfig, arg2: u32, arg3: u128, arg4: 0x1::string::String, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::pool::Pool<T0, T1> {
        assert!(arg3 > 0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::tick_math::min_sqrt_price() && arg3 < 0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::tick_math::max_sqrt_price(), 2);
        ...
        let v4 = 0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::pool::new<T0, T1>(arg2, arg3, 0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::config::get_fee_rate(arg2, arg1), v3, arg0.index, arg5, arg6);
        arg0.index = arg0.index + 1;
        let v5 = 0x2::object::id<0x5f0dcfe9d749b678bf2c2d97be70d25b407310957530eef82816889a4f5eff06::pool::Pool<T0, T1>>(&v4);
