module 0x5f95d6c6d22bea562dc4ce168848d1d782a1d352409fe6cf1e53a1dc722cbd24::governance {
    struct GovernanceVault<phantom T0> has key {
        ...
        quorum_bps: u64,
        proposal_count: u64,
        dao_admin_cap: 0x1::option::Option<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::DaoAdminCap>,
    }
    ...
    public fun burn_admin_cap_via_governance<T0>(arg0: &Proposal<T0>, arg1: &GovernanceVault<T0>, arg2: 0x6f8d1d25f7a66d967e92fed17d6a362055d3544b6218dc606c1cbc70bfc55f5f::vault::AdminCap) {
        ...
        0x6f8d1d25f7a66d967e92fed17d6a362055d3544b6218dc606c1cbc70bfc55f5f::vault::burn_admin_cap(arg2);
    ...
    public fun create_governance_vault<T0>(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GovernanceVault<T0>{
            ...
            quorum_bps          : 3300,
            proposal_count      : 0,
            dao_admin_cap       : 0x1::option::none<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::DaoAdminCap>(),
        };
        0x2::transfer::share_object<GovernanceVault<T0>>(v0);
    }

    public fun create_proposal<T0>(arg0: &mut GovernanceVault<T0>, arg1: &0x6f8d1d25f7a66d967e92fed17d6a362055d3544b6218dc606c1cbc70bfc55f5f::vault::Vault<T0>, arg2: &0x1eab7ce4af411de5a2d99832a6158b67ca3eb7b3efce70bf2525817e18ed140::receipt::AqReceipt, arg3: u8, arg4: vector<u8>, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(0x1eab7ce4af411de5a2d99832a6158b67ca3eb7b3efce70bf2525817e18ed140::receipt::receipt_amount(arg2) >= arg0.min_propose_balance, 1000);
        ...
        let v2 = Proposal<T0>{
            ...
            action_type    : arg3,
            payload        : arg4,
            total_eligible : 0x6f8d1d25f7a66d967e92fed17d6a362055d3544b6218dc606c1cbc70bfc55f5f::vault::total_receipts<T0>(arg1),
    ...
    fun dispatch_action<T0>(arg0: &Proposal<T0>, arg1: &mut GovernanceVault<T0>, arg2: &mut 0x6f8d1d25f7a66d967e92fed17d6a362055d3544b6218dc606c1cbc70bfc55f5f::vault::Vault<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::GovernanceActionPayload> {
        let v0 = arg0.action_type;
        let v1 = arg0.payload;
        if (v0 == 3) {
            let v2 = 0x2::bcs::new(v1);
            0x6f8d1d25f7a66d967e92fed17d6a362055d3544b6218dc606c1cbc70bfc55f5f::floors::assert_rewards_fee(0x2::bcs::peel_u64(&mut v2));
            return 0x1::option::some<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::GovernanceActionPayload>(0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::create_gov_action_payload(0x1::option::borrow<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::DaoAdminCap>(&arg1.dao_admin_cap), 0x6f8d1d25f7a66d967e92fed17d6a362055d3544b6218dc606c1cbc70bfc55f5f::timelock::action_update_fee(), v1))
        };
        if (v0 == 4) {
            let v3 = 0x2::bcs::new(v1);
            assert!(0x2::bcs::peel_u64(&mut v3) >= 0x6f8d1d25f7a66d967e92fed17d6a362055d3544b6218dc606c1cbc70bfc55f5f::vault::max_tvl_cap<T0>(arg2), 1008);
            return 0x1::option::some<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::GovernanceActionPayload>(0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::create_gov_action_payload(0x1::option::borrow<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::DaoAdminCap>(&arg1.dao_admin_cap), 0x6f8d1d25f7a66d967e92fed17d6a362055d3544b6218dc606c1cbc70bfc55f5f::timelock::action_update_tvl_cap(), v1))
        };
        if (v0 == 5) {
            ...
            if (v0 == 8) {
                return 0x1::option::some<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::GovernanceActionPayload>(0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::create_gov_action_payload(0x1::option::borrow<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::DaoAdminCap>(&arg1.dao_admin_cap), 0x6f8d1d25f7a66d967e92fed17d6a362055d3544b6218dc606c1cbc70bfc55f5f::timelock::action_set_fee_recipient(), v1))
            };
            if (v0 == 7) {
            } else {
                if (v0 == 1) {
                    return 0x1::option::some<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::GovernanceActionPayload>(0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::create_gov_action_payload(0x1::option::borrow<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::DaoAdminCap>(&arg1.dao_admin_cap), 0x6f8d1d25f7a66d967e92fed17d6a362055d3544b6218dc606c1cbc70bfc55f5f::timelock::action_register_protocol(), v1))
                };
                if (v0 == 2) {
                    return 0x1::option::some<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::GovernanceActionPayload>(0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::create_gov_action_payload(0x1::option::borrow<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::DaoAdminCap>(&arg1.dao_admin_cap), 0x6f8d1d25f7a66d967e92fed17d6a362055d3544b6218dc606c1cbc70bfc55f5f::timelock::action_update_crank_config(), v1))
                };
                if (v0 == 6) {
                    return 0x1::option::some<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::GovernanceActionPayload>(0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::create_gov_action_payload(0x1::option::borrow<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::DaoAdminCap>(&arg1.dao_admin_cap), 20, v1))
                };
            };
        };
        0x1::option::none<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::GovernanceActionPayload>()
    }

    public fun equip_dao_admin_cap<T0>(arg0: &mut GovernanceVault<T0>, arg1: 0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::DaoAdminCap) {
        assert!(0x1::option::is_none<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::DaoAdminCap>(&arg0.dao_admin_cap), 1099);
        0x1::option::fill<0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::admin::DaoAdminCap>(&mut arg0.dao_admin_cap, arg1);
    }
    ...
    public fun vote<T0>(arg0: &mut Proposal<T0>, arg1: &mut 0x1eab7ce4af411de5a2d99832a6158b67ca3eb7b3efce70bf2525817e18ed140::receipt::AqReceipt, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(arg0.snapshot_epoch > 0x1eab7ce4af411de5a2d99832a6158b67ca3eb7b3efce70bf2525817e18ed140::receipt::deposit_epoch(arg1), 1012);
        assert!(0x2::clock::timestamp_ms(arg3) <= arg0.voting_end_ms, 1003);
        assert!(!arg0.executed, 1005);
        assert!(!0x2::table::contains<address, bool>(&arg0.voters, v0), 1004);
        let v1 = 0x1eab7ce4af411de5a2d99832a6158b67ca3eb7b3efce70bf2525817e18ed140::receipt::receipt_amount(arg1);
        assert!(v1 > 0, 1006);
        0x1eab7ce4af411de5a2d99832a6158b67ca3eb7b3efce70bf2525817e18ed140::receipt::lock_receipt(arg1, arg0.end_epoch, arg4);
        if (arg2) {
