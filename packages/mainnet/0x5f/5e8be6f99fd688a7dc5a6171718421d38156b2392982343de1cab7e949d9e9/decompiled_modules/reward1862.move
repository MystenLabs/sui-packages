module 0x5f5e8be6f99fd688a7dc5a6171718421d38156b2392982343de1cab7e949d9e9::reward1862 {
    struct REWARD1862 has drop {
        dummy_field: bool,
    }

    struct TICKET_1862 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1862(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1862>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1862>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1862, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1862>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1862>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1862>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1862>>(v5, 0x2::tx_context::sender(arg1));
    }
