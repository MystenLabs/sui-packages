module 0x5fd94d351c96b64ab0634799b20ba87de1c2649149c197fd4e6115e4d17d1ea3::signing_policy {
    ...
    public fun remove_rule<T0: drop, T1: drop + store>(arg0: &mut SigningPolicy, arg1: &SigningPolicyCap) {
        assert!(0x2::object::id<SigningPolicy>(arg0) == arg1.policy_id, 4);
        let v0 = RuleKey<T0>{dummy_field: false};
        0x2::dynamic_field::remove<RuleKey<T0>, T1>(&mut arg0.id, v0);
        let v1 = 0x1::type_name::get<T0>();
        0x2::vec_set::remove<0x1::type_name::TypeName>(&mut arg0.rules, &v1);
    }

    public fun rules(arg0: &SigningPolicy) : &0x2::vec_set::VecSet<0x1::type_name::TypeName> {
        &arg0.rules
    }
    ...
    public fun signer_id(arg0: &SigningRequest) : 0x2::object::ID {
        arg0.signer_id
    }

    public fun uid(arg0: &SigningPolicy) : &0x2::object::UID {
        &arg0.id
    }

    public fun uid_mut_as_owner(arg0: &mut SigningPolicy, arg1: &SigningPolicyCap) : &mut 0x2::object::UID {
        assert!(0x2::object::id<SigningPolicy>(arg0) == arg1.policy_id, 4);
        &mut arg0.id
    }
