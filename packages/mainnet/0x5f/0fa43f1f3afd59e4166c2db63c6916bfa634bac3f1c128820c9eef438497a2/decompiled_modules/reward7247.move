module 0x5f0fa43f1f3afd59e4166c2db63c6916bfa634bac3f1c128820c9eef438497a2::reward7247 {
    struct REWARD7247 has drop {
        dummy_field: bool,
    }

    struct TICKET_7247 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7247(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7247>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7247>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7247, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7247>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7247>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7247>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7247>>(v5, 0x2::tx_context::sender(arg1));
    }
