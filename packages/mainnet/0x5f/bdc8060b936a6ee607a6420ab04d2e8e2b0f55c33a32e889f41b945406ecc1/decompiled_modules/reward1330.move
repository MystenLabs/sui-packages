module 0x5fbdc8060b936a6ee607a6420ab04d2e8e2b0f55c33a32e889f41b945406ecc1::reward1330 {
    struct REWARD1330 has drop {
        dummy_field: bool,
    }

    struct TICKET_1330 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1330(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1330>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1330>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1330, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1330>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1330>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1330>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1330>>(v5, 0x2::tx_context::sender(arg1));
    }
