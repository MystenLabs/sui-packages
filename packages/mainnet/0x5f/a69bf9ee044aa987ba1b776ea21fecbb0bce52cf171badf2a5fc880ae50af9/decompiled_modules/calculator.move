module 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::calculator {
    public fun caculate_utilization(arg0: &mut 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::storage::Storage, arg1: u8) : u256 {
    ...
    public fun calculate_amount(arg0: &0x2::clock::Clock, arg1: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg2: u256, arg3: u8) : u256 {
        ...
        assert!(v0, 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::error::invalid_price());
        arg2 * (0x2::math::pow(10, v2) as u256) / v1
    }

    public fun calculate_borrow_rate(arg0: &mut 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::storage::Storage, arg1: u8) : u256 {
        let (v0, v1, v2, _, v4) = 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::storage::get_borrow_rate_factors(arg0, arg1);
    ...
    public fun calculate_compounded_interest(arg0: u256, arg1: u256) : u256 {
        ...
        let v2 = arg1 / 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::constants::seconds_per_year();
    ...
    public fun calculate_linear_interest(arg0: u256, arg1: u256) : u256 {
        0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::ray_math::ray() + arg1 * arg0 / 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::constants::seconds_per_year()
    }

    public fun calculate_supply_rate(arg0: &mut 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::storage::Storage, arg1: u8, arg2: u256) : u256 {
        let (_, _, _, v3, _) = 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::storage::get_borrow_rate_factors(arg0, arg1);
