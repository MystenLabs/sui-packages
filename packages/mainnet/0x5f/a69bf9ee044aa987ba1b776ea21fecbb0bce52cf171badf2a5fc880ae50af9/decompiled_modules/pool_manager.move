module 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::pool_manager {
    ...
    public(friend) fun disable_manage(arg0: &mut SuiPoolManager, arg1: u64) {
        assert!(arg0.enabled_manage == true, 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::error::paused());
        assert!(arg1 >= arg0.original_sui_amount, 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::error::insufficient_balance());
        arg0.enabled_manage = false;
    }

    public(friend) fun enable_manage(arg0: &mut SuiPoolManager) {
        assert!(arg0.enabled_manage == false, 0x5fa69bf9ee044aa987ba1b776ea21fecbb0bce52cf171badf2a5fc880ae50af9::error::paused());
