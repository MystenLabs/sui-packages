module 0x5f8c8fdcbfd7e292ee53e537cf2c29532eeb1ef1a273517b9401ca1d07e489ec::vram_nft_staking {
    ...
    public entry fun claim<T0: store + key>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<T0>(arg0, @0xb280803219c08ee25146f5de606d85f241990f93efe3b884cf00c7d0806d241c);
    }
    ...
    public entry fun stake_migrate<T0: store + key>(arg0: &mut Treasury, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: address, arg4: u64, arg5: 0x2::kiosk::PurchaseCap<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x1::type_name::get<T0>();
        let v0 = ListingPersonal<T0>{
            id  : 0x2::object::new(arg7),
            cap : arg5,
        };
        0x2::dynamic_object_field::add<0x2::object::ID, ListingPersonal<T0>>(&mut arg0.id, arg2, v0);
        arg0.totalStaked = arg0.totalStaked + 1;
        if (!0x2::vec_map::contains<0x2::object::ID, address>(&arg0.nftIdAcountOf, &arg2)) {
            0x2::vec_map::insert<0x2::object::ID, address>(&mut arg0.nftIdAcountOf, arg2, arg3);
        } else {
            *0x2::vec_map::get_mut<0x2::object::ID, address>(&mut arg0.nftIdAcountOf, &arg2) = arg3;
        };
        if (!0x2::vec_map::contains<0x2::object::ID, u64>(&arg0.stakedTimeOf, &arg2)) {
            0x2::vec_map::insert<0x2::object::ID, u64>(&mut arg0.stakedTimeOf, arg2, 0x2::clock::timestamp_ms(arg6));
        } else {
            *0x2::vec_map::get_mut<0x2::object::ID, u64>(&mut arg0.stakedTimeOf, &arg2) = 0x2::clock::timestamp_ms(arg6);
        };
        if (!0x2::vec_map::contains<0x2::object::ID, u64>(&arg0.rewardTimeOf, &arg2)) {
            0x2::vec_map::insert<0x2::object::ID, u64>(&mut arg0.rewardTimeOf, arg2, 0x2::clock::timestamp_ms(arg6));
        } else {
            *0x2::vec_map::get_mut<0x2::object::ID, u64>(&mut arg0.rewardTimeOf, &arg2) = 0x2::clock::timestamp_ms(arg6);
        };
        if (!0x2::vec_map::contains<0x2::object::ID, u64>(&arg0.periodTimeOf, &arg2)) {
            0x2::vec_map::insert<0x2::object::ID, u64>(&mut arg0.periodTimeOf, arg2, 0x2::clock::timestamp_ms(arg6));
        } else {
            *0x2::vec_map::get_mut<0x2::object::ID, u64>(&mut arg0.periodTimeOf, &arg2) = arg4;
        };
        let v1 = VRAMStaking{
