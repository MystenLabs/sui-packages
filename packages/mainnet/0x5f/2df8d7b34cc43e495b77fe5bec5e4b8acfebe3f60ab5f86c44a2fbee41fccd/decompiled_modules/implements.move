module 0xd758acbec0ce2e7752c811a28f998fbad4a6916fb1133cf28747104d1370c67e::implements {
    ...
    public(friend) fun create_and_share<T0>(arg0: &OwnerCap, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault{
        ...
        let v1 = Global<T0>{
            ...
            admin                      : @0xcfa0df1d8becd030ba5a8da61da5ea08f19168d9fdc1e41925ff4a74b79d1b26,
            vault                      : v0,
            cumulative_staked          : 0,
    ...
    public(friend) fun set_emergency<T0>(arg0: &OwnerCap, arg1: &mut Global<T0>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.has_paused = arg2;
    }
    ...
    public(friend) fun transfer_admin<T0>(arg0: &OwnerCap, arg1: &mut Global<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.admin = arg2;
    }
    ...
    public fun unstake<T0>(arg0: &mut Global<T0>, arg1: u64, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg6: &0x2::clock::Clock, arg7: &mut 0x3::sui_system::SuiSystemState, arg8: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg9: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u64, u64) {
        ...
        let v4 = v3.amount;
        0x1::vector::borrow_mut<StakeOrder>(&mut v1.orders, v2).status = 2;
        ...
        let v7 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::withdraw_with_account_cap_v2<T0>(arg6, arg8, arg2, arg3, arg0.vault.pool_index, v6, arg4, arg5, &arg0.vault.account_cap, arg7, arg9);
        assert!(0x2::balance::value<T0>(&v7) >= v6, 6);
        (0x2::coin::from_balance<T0>(v7, arg9), v4, v5)
    }
