module 0x5fa04b3f62996d3fc5ac3a7efb473bc9d7b12d20fa5bb4a0185e8db5090417f7::ath {
    struct ATH has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ATH, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/2yhtb5jMe8CPXE8NW9UYWVVZm2dyKVLqJCaYtgqMAVa5.png?size=lg&key=a11e3b                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<ATH>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"ATH     ")))), trim_right(b"All Trump High                  "), trim_right(b"All Trump High                                                                                                                                                                                                                                                                                                                  "), v2, arg1);
        let v5 = v3;
