module 0x5fa2c468c2fdb3899e9e638242320e0f9aadd8da21960fb3b1cb780f351a2ba6::my_sui_collection {
    ...
    fun init(arg0: MY_SUI_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"My SUI collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is my SUI collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeieh6pd7kbpipsa3uqmsbcuj6ln344oqidmdlvvbydldlk3m4d4yqq"));
