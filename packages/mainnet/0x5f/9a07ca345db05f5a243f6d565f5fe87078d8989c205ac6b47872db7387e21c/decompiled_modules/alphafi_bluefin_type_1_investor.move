module 0x5f9a07ca345db05f5a243f6d565f5fe87078d8989c205ac6b47872db7387e21c::alphafi_bluefin_type_1_investor {
    ...
    fun autocompound_internal<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, 0x2::sui::SUI>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, bool) {
        ...
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<T0, T1, T2>(arg4)) {
            0x2::balance::join<T2>(&mut v2, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T2>(arg8, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position")));
        };
        let v3 = 0x2::balance::value<T2>(&v2);
        if (v3 >= arg0.minimum_swap_amount) {
            let (v4, v5) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T2, T3>(arg8, arg2, arg5, v2, 0x2::balance::zero<T3>(), true, true, v3, v3, 4295048016);
            0x2::balance::destroy_zero<T2>(v4);
            0x2::coin::join<T3>(&mut v0, 0x2::coin::from_balance<T3>(v5, arg9));
        } else {
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<0x2::sui::SUI>()) == true) {
            let v7 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<0x2::sui::SUI>>(&mut arg0.free_rewards, 0x1::type_name::get<0x2::sui::SUI>());
            let v8 = 0x2::balance::value<0x2::sui::SUI>(v7);
            if (v8 >= arg0.minimum_swap_amount) {
                let (v9, v10) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_b2a<T1, 0x2::sui::SUI>(arg3, arg7, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(v7), arg9), true, v8, arg8, arg9);
                let v11 = v9;
                0x2::coin::destroy_zero<0x2::sui::SUI>(v10);
                v6 = (0x2::coin::value<T1>(&v11) as u128) * (arg0.performance_fee as u128) / 10000;
                0x2::balance::join<T1>(&mut arg0.free_balance_b, 0x2::coin::into_balance<T1>(v11));
            };
        };
        let (_, _, v14, v15) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg8, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"));
        let v16 = v15;
        let v17 = v14;
        let v18 = (0x2::balance::value<T0>(&v17) as u128) * (arg0.performance_fee as u128) / 10000;
        let v19 = v6 + (0x2::balance::value<T1>(&v16) as u128) * (arg0.performance_fee as u128) / 10000;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v17, (v18 as u64)), arg9), 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::get_fee_wallet_address(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v16, (v19 as u64)), arg9), 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::get_fee_wallet_address(arg1));
        let v20 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::fee_rate<T1, T0>(arg6);
        let v21 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T1, T0>(arg6);
        let v22 = if (v20 == 100) {
            v21 * 999749968 / 1000000000
        } else if (v20 == 10000) {
            v21 * 992471662 / 1000000000
        } else {
            v21 * 994987437 / 1000000000
        };
        let v23 = if (v20 == 100) {
            v21 * 1000249968 / 1000000000
        } else if (v20 == 10000) {
            v21 * 1007472083 / 1000000000
        } else {
            v21 * 1004987562 / 1000000000
        };
        let (v24, v25) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg2, arg3, v17, v16, arg4, arg6, v22, v23, arg8, arg9);
