module 0x5fcb8f1d420e1b7f5dba9389af1f22a21c61b323294a2da17a34c99b81349e55::reward1608 {
    struct REWARD1608 has drop {
        dummy_field: bool,
    }

    struct TICKET_1608 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1608(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1608>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1608>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1608, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1608>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1608>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1608>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1608>>(v5, 0x2::tx_context::sender(arg1));
    }
