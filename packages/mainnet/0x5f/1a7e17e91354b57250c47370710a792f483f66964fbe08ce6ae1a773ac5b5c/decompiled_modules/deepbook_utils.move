module 0x5f1a7e17e91354b57250c47370710a792f483f66964fbe08ce6ae1a773ac5b5c::deepbook_utils {
    ...
    public fun place_limit_order_ask<T0, T1>(arg0: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::coin::Coin<T0>, arg6: &mut 0xdee9::custodian_v2::AccountCap, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 >= v0) {
            ...
            0xdee9::clob_v2::deposit_base<T0, T1>(arg0, 0x2::coin::split<T0>(arg5, v0 - v1, arg8), arg6);
    ...
    public fun place_market_order_bid<T0, T1>(arg0: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::coin::Coin<T1>, arg8: &mut 0xdee9::custodian_v2::AccountCap, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let v0 = (arg1 - arg1 % arg3) * arg5 / arg4 * get_market_price_bid<T0, T1>(arg0) / arg6;
        assert!(v0 > 0, 0);
        let (_, _, v3, _) = 0xdee9::clob_v2::account_balance<T0, T1>(arg0, arg8);
        assert!(v3 + 0x2::coin::value<T1>(arg7) >= v0, 1);
        if (v3 >= v0) {
            let (v5, v6, _) = 0xdee9::clob_v2::swap_exact_quote_for_base<T0, T1>(arg0, 20082022, arg8, v0, arg9, 0xdee9::clob_v2::withdraw_quote<T0, T1>(arg0, v0, arg8, arg10), arg10);
            return (v5, v6)
        };
        if (v3 > 0) {
            0x2::coin::join<T1>(arg7, 0xdee9::clob_v2::withdraw_quote<T0, T1>(arg0, v3, arg8, arg10));
        };
        let (v8, v9, _) = 0xdee9::clob_v2::swap_exact_quote_for_base<T0, T1>(arg0, 20082022, arg8, v0, arg9, 0x2::coin::split<T1>(arg7, v0, arg10), arg10);
        (v8, v9)
    }
