module 0x5f6387d503e1a798c80c1ce162c3836f433b77f326daed1675935ff6c1562a4d::faucet_coin {
    ...
    fun init(arg0: FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCET_COIN>(arg0, 2, b"FAUCET_COIN", b"MC", b"learning for letsmove, power by alva-lin", 0x1::option::none<0x2::url::Url>(), arg1);
