module 0x5f19b8630831f500ef72037a385a81c20fdeccf9c2972c4790a141c865216131::cnsnft2608 {
    struct CNSNFT2608 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2608, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1413"));
        let v4 = 0x2::package::claim<CNSNFT2608>(arg0, arg1);
