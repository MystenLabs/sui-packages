module 0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten_pool_vault {
    ...
    public entry fun vault_sui_to_bten_to_sui(arg0: &ProtocolPoolVault, arg1: &mut 0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::EmissionState, arg2: &0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::PoolRegistry, arg3: &0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::OpsInteractionFeeConfig, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::BTEN, 0x2::sui::SUI>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: u64, arg9: u128, arg10: u128, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 > 0, 7);
        0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::collect_ops_interaction_fee_notional(arg3, arg4, v2, arg12);
        let v3 = 0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::open_composable_route(arg12);
        let (v4, v5) = 0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::cetus_swap_to_bten_b2a_return<0x2::sui::SUI>(arg2, arg5, arg6, arg7, 1, arg9, arg11, &mut v3, arg12);
        let (v6, v7) = 0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::cetus_swap_from_bten_a2b_return<0x2::sui::SUI>(arg2, arg5, arg6, v5, arg8, arg10, arg11, &mut v3, arg12);
        let v8 = v7;
        assert!(0x2::coin::value<0x2::sui::SUI>(&v8) >= arg8, 1);
        0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::seal_composable_route(arg1, v3, arg11, arg12);
        emit_routed(arg0, v1, 0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::composable_route_paid_points_view(&v3), arg12);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v4, 0x2::tx_context::sender(arg12));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::BTEN>>(v6, 0x2::tx_context::sender(arg12));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v8, 0x2::tx_context::sender(arg12));
    }
