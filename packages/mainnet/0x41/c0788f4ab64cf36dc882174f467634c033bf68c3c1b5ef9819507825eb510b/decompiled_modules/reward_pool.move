module 0x41c0788f4ab64cf36dc882174f467634c033bf68c3c1b5ef9819507825eb510b::reward_pool {
    ...
    public(friend) fun new<T0>(arg0: u64, arg1: u64) : RewardPool<T0> {
        assert!(arg1 > 0, 0x41c0788f4ab64cf36dc882174f467634c033bf68c3c1b5ef9819507825eb510b::app_error::reward_exchange_rate_numerator_zero());
        RewardPool<T0>{
    ...
    public(friend) fun update_reward_pool<T0>(arg0: &mut RewardPool<T0>, arg1: u64, arg2: u64) {
        assert!(arg2 > 0, 0x41c0788f4ab64cf36dc882174f467634c033bf68c3c1b5ef9819507825eb510b::app_error::reward_exchange_rate_numerator_zero());
