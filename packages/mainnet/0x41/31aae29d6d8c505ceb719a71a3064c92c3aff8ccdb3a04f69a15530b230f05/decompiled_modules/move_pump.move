module 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::move_pump {
    ...
    fun buy_direct<T0>(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut Pool<T0>, arg2: u64, arg3: u64, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::curves::calculate_add_liquidity_cost(arg1.virtual_sui_reserves, arg1.virtual_token_reserves, v2) + 1;
        let v4 = 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::as_u64(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::div(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::mul(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(v3), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(arg3)), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(10000)));
        assert!(v0 >= v3 + v4, 6);
    ...
    public entry fun buy_exact_in<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::as_u64(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::div(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::mul(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(v0), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(arg0.platform_fee)), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(10000)));
        ...
        let v6 = 0x1::u64::min(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::curves::calculate_remove_liquidity_return(v2.virtual_sui_reserves, v2.virtual_token_reserves, v4), v5);
        let v7 = 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::curves::calculate_add_liquidity_cost(v2.virtual_sui_reserves, v2.virtual_token_reserves, v6) + 1;
        assert!(v0 >= v4 + v3, 6);
    ...
    public fun buy_exact_in_returns_v2<T0>(arg0: &mut Configuration, arg1: &mut ThresholdConfig, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let v8 = v0 - 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::curves::calculate_add_liquidity_cost(v2.virtual_sui_reserves, v2.virtual_token_reserves, v6) + 1 - v3;
    ...
    public entry fun buy_exact_out<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::curves::calculate_add_liquidity_cost(v1.virtual_sui_reserves, v1.virtual_token_reserves, v4) + 1;
        let v6 = 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::as_u64(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::div(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::mul(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(v5), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(arg0.platform_fee)), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(10000)));
    ...
    public fun buy_exact_out_returns<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let v5 = 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::curves::calculate_add_liquidity_cost(v1.virtual_sui_reserves, v1.virtual_token_reserves, v3) + 1;
        let v6 = 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::as_u64(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::div(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::mul(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(v5), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(arg0.platform_fee)), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(10000)));
        assert!(v4 >= v5 + v6, 6);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v6, arg4), arg0.admin);
        let v7 = 0x2::coin::zero<T0>(arg4);
    ...
    public fun estimate_amount_out<T0>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, Pool<T0>>(&mut arg0.id, 0x1::type_name::get_address(&v0));
        if (arg1 > 0 && arg2 == 0) {
            (0, 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::curves::calculate_token_amount_received(v1.virtual_sui_reserves, v1.virtual_token_reserves, arg1 - 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::as_u64(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::div(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::mul(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(arg1), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(arg0.platform_fee)), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(10000)))))
        } else if (arg1 == 0 && arg2 > 0) {
            let v4 = 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_sui_reserves, arg2);
            (v4 - 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::as_u64(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::div(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::mul(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(v4), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(arg0.platform_fee)), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(10000))), 0)
        } else {
            (0, 0)
        }
    }
    ...
    public entry fun sell<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 > 0, 2);
        let v3 = 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_sui_reserves, v2);
        let v4 = 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::as_u64(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::div(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::mul(0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(v3), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(arg0.platform_fee)), 0x4131aae29d6d8c505ceb719a71a3064c92c3aff8ccdb3a04f69a15530b230f05::utils::from_u64(10000)));
        assert!(v3 - v4 >= arg2, 2);
