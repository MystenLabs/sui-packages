module 0x41c29fff90d9148a70a2fa50379b07ed1d6664345c9f394f2a86cb19130041ce::farm {
    ...
    public fun set_user_rewards<T0>(arg0: &mut RewardPool, arg1: vector<address>, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<address>(&arg1) > 0) {
            ...
            let v2 = 0x2::table::borrow<address, 0x2::table::Table<0x1::ascii::String, u64>>(&mut arg0.user_rewards_table, v0);
            let v3 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
            let v4 = if (0x2::table::contains<0x1::ascii::String, u64>(v2, v3)) {
                let v5 = 0x2::table::borrow<0x1::ascii::String, u64>(v2, v3);
                if (*v5 > v1) {
                ...
                0x2::table::add<0x1::ascii::String, u64>(&mut v6, v3, v1);
