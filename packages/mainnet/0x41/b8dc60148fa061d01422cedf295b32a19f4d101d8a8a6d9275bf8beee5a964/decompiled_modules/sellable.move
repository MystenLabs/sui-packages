module 0x41b8dc60148fa061d01422cedf295b32a19f4d101d8a8a6d9275bf8beee5a964::sellable {
    ...
    public fun create_config<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : (T0, CredenzaSellableConfig<T0>) {
        ...
        let v1 = CredenzaSellableConfig<T0>{
            id                      : v0,
            ownership               : 0x41b8dc60148fa061d01422cedf295b32a19f4d101d8a8a6d9275bf8beee5a964::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
        ...
        0x41b8dc60148fa061d01422cedf295b32a19f4d101d8a8a6d9275bf8beee5a964::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg1));
