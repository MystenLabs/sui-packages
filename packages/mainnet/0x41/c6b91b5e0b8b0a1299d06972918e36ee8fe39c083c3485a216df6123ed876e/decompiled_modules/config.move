module 0x41c6b91b5e0b8b0a1299d06972918e36ee8fe39c083c3485a216df6123ed876e::config {
    ...
    public fun remove_collection<T0: store + key>(arg0: &mut Config, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.admin, 0x41c6b91b5e0b8b0a1299d06972918e36ee8fe39c083c3485a216df6123ed876e::errors::e_admin_only());
        let v0 = 0x1::type_name::with_original_ids<T0>();
    ...
    public fun set_economics(arg0: &mut Config, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.admin, 0x41c6b91b5e0b8b0a1299d06972918e36ee8fe39c083c3485a216df6123ed876e::errors::e_admin_only());
        assert!(arg2 + arg3 <= 2 * arg1, 0x41c6b91b5e0b8b0a1299d06972918e36ee8fe39c083c3485a216df6123ed876e::errors::e_invalid_economics());
        arg0.entry_fee = arg1;
    ...
    public fun set_paused(arg0: &mut Config, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0x41c6b91b5e0b8b0a1299d06972918e36ee8fe39c083c3485a216df6123ed876e::errors::e_admin_only());
        arg0.paused = arg1;
    }

    public fun set_treasury(arg0: &mut Config, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0x41c6b91b5e0b8b0a1299d06972918e36ee8fe39c083c3485a216df6123ed876e::errors::e_admin_only());
        assert!(arg1 != @0x0, 0x41c6b91b5e0b8b0a1299d06972918e36ee8fe39c083c3485a216df6123ed876e::errors::e_invalid_address());
        arg0.treasury = arg1;
