module 0x41256a751eb94a5b9a05ee1a0c888b7b6dc1d22ac139a4b82f4da9ff7726a974::cnsnft6166 {
    struct CNSNFT6166 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6166, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4676"));
        let v4 = 0x2::package::claim<CNSNFT6166>(arg0, arg1);
