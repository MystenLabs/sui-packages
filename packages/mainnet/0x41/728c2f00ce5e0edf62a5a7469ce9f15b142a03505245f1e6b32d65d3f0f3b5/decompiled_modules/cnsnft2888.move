module 0x41728c2f00ce5e0edf62a5a7469ce9f15b142a03505245f1e6b32d65d3f0f3b5::cnsnft2888 {
    struct CNSNFT2888 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2888, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2888>(arg0, arg1);
