module 0x41e10413607aa2ab5a40f9f4ab978572b028a356de0f616a860a43af6ecd2bc3::cnsnft3769 {
    struct CNSNFT3769 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3769, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3769>(arg0, arg1);
