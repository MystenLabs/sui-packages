module 0x41aadd426ac392cbc5961566b185b6ec62f704a9f5e1c2b122e0c8f99af964ef::reward3898 {
    struct REWARD3898 has drop {
        dummy_field: bool,
    }

    struct TICKET_3898 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3898(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3898>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3898>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3898, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3898>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3898>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3898>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3898>>(v5, 0x2::tx_context::sender(arg1));
    }
