module 0x418613f3e3fb43e666989463eb17a34727d9e28f2b0048ca51e4e5dc36ed8bec::cnsnft7874 {
    struct CNSNFT7874 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7874, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7874>(arg0, arg1);
