module 0x41af7927c3fed231c756ecacd0ec4d58164bd7feed00283c36287f5d540e630f::cnsnft3822 {
    struct CNSNFT3822 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3822, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3822>(arg0, arg1);
