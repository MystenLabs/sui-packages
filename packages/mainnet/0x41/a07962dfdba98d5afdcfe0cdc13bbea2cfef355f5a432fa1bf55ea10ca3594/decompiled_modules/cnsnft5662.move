module 0x41a07962dfdba98d5afdcfe0cdc13bbea2cfef355f5a432fa1bf55ea10ca3594::cnsnft5662 {
    struct CNSNFT5662 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5662, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5662>(arg0, arg1);
