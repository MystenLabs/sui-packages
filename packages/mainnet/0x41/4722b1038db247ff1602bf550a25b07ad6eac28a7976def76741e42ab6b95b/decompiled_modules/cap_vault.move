module 0x414722b1038db247ff1602bf550a25b07ad6eac28a7976def76741e42ab6b95b::cap_vault {
    ...
    public fun claim_cap<T0: store + key>(arg0: &mut CapVault<T0>, arg1: &0x2::tx_context::TxContext) : T0 {
        assert!(0x1::option::is_some<address>(&arg0.new_owner) && *0x1::option::borrow<address>(&arg0.new_owner) == 0x2::tx_context::sender(arg1), 2000);
    ...
    public fun revoke_cap<T0: store + key>(arg0: &mut CapVault<T0>, arg1: &0x2::tx_context::TxContext) : T0 {
        assert!(0x1::option::is_some<address>(&arg0.og_owner) && *0x1::option::borrow<address>(&arg0.og_owner) == 0x2::tx_context::sender(arg1), 2000);
        0x1::option::extract<address>(&mut arg0.og_owner);
        0x1::option::extract<address>(&mut arg0.new_owner);
        0x1::option::extract<T0>(&mut arg0.admin_cap)
    }
