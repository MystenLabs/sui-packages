module 0x4155eb6aaac5575163f372a09e8731d240923ad49948fd7f12f6ed98e74595a7::pool {
    ...
    public fun check_arrived_reward_time<T0, T1: store + key>(arg0: &Pool<T0, T1>, arg1: &0x2::clock::Clock) {
        assert!(arg0.time_info.start_time + arg0.time_info.reward_duration <= 0x2::clock::timestamp_ms(arg1), 7);
    }
    ...
    public fun create_pool<T0: copy + drop + store, T1: store + key>(arg0: &0x2::clock::Clock, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : Pool<T0, T1> {
        ...
        let v0 = StakeInfo{
            user_list    : vector[],
            user_index   : 0x2::table::new<address, u64>(arg6),
            total_amount : 0,
        };
        let v1 = TimeInfo{
    ...
    public(friend) fun fill_number_pool<T0, T1: store + key>(arg0: &mut Pool<T0, T1>, arg1: 0x2::object::ID) {
        assert!(0x1::option::is_none<0x2::object::ID>(&arg0.number_pool), 12);
    ...
    public fun include_pool_list_check<T0, T1: store + key>(arg0: &GlobalConfig, arg1: &Pool<T0, T1>) {
        ...
        assert!(0x1::vector::contains<0x2::object::ID>(&arg0.pool_list, &v0), 4);
    }
    ...
    public fun total_amount<T0, T1: store + key>(arg0: &Pool<T0, T1>) : u64 {
    ...
    public(friend) fun update_stake_info<T0, T1: store + key>(arg0: &mut Pool<T0, T1>, arg1: address, arg2: u64, arg3: bool) {
        if (arg3) {
            arg0.stake_info.total_amount = arg0.stake_info.total_amount + arg2;
            if (!0x2::table::contains<address, u64>(&arg0.stake_info.user_index, arg1)) {
    ...
    public(friend) fun update_validator_table_data_on_pool<T0, T1: store + key>(arg0: &mut Pool<T0, T1>, arg1: address, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_object_field::exists_<StakedValidatorKey>(&arg0.id, v0)) {
            ...
            if (arg3) {
                ...
                assert!(0x2::table::contains<address, u64>(v2, arg1), 6);
