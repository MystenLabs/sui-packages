module 0x410f7d84cb2823b6ebe0a16fa021af33b3c5d4c426f8951a89b21f84eb356353::degen {
    ...
    fun init(arg0: DEGEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<Degen<0x410f7d84cb2823b6ebe0a16fa021af33b3c5d4c426f8951a89b21f84eb356353::collectible::Collectible>>(&v4, v0, v2, arg1);
        0x2::display::update_version<Degen<0x410f7d84cb2823b6ebe0a16fa021af33b3c5d4c426f8951a89b21f84eb356353::collectible::Collectible>>(&mut v5);
        let v6 = AdminCap{id: 0x2::object::new(arg1)};
        0x2::transfer::public_transfer<AdminCap>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<Degen<0x410f7d84cb2823b6ebe0a16fa021af33b3c5d4c426f8951a89b21f84eb356353::collectible::Collectible>>>(v5, 0x2::tx_context::sender(arg1));
    }
    ...
    public fun mint<T0>(arg0: &mut 0x2::object::UID, arg1: 0x1::string::String, arg2: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Degen<T0> {
        ...
        assert!(0x2::clock::timestamp_ms(arg3) <= v0.time_limit, 1);
        let v1 = 0x2::object::new(arg4);
        let v2 = 0x410f7d84cb2823b6ebe0a16fa021af33b3c5d4c426f8951a89b21f84eb356353::random::get_random_number(v0.generations, arg4);
        let v3 = DegenMinted{
