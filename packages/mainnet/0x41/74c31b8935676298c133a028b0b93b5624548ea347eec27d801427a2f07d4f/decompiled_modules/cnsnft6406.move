module 0x4174c31b8935676298c133a028b0b93b5624548ea347eec27d801427a2f07d4f::cnsnft6406 {
    struct CNSNFT6406 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6406, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6406>(arg0, arg1);
