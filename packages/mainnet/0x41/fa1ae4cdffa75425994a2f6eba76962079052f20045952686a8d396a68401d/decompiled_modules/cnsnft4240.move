module 0x41fa1ae4cdffa75425994a2f6eba76962079052f20045952686a8d396a68401d::cnsnft4240 {
    struct CNSNFT4240 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4240, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4240>(arg0, arg1);
