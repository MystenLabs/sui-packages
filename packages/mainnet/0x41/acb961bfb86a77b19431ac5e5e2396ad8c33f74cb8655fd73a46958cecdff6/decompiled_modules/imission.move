module 0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::imission {
    ...
    public fun new_mission_info(arg0: &0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::crimes_authority::CrimesCap, arg1: &MissionRegistry, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
    ...
    public(friend) fun process_current_success_chance(arg0: &mut MissionInfo, arg1: &MissionRegistry, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v11 = 0x8ab76651051de583d065d70e71b23d51a860bf70867e5226c82b38077a62fafd::utils_crime::flip_coin(arg4, *v10, arg5);
        let v12 = if (v11) {
            v0.success_increase
        } else {
            v0.failed_increase
    ...
    public(friend) fun update_mission_config(arg0: &mut MissionRegistry, arg1: u64, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u128, arg10: u128, arg11: u64, arg12: u64, arg13: u64) {
        assert!(0x2::vec_map::contains<u64, MissionConfig>(&arg0.mission_configs, &arg1), 1);
        let v0 = 0x2::vec_map::get_mut<u64, MissionConfig>(&mut arg0.mission_configs, &arg1);
        v0.location_name = arg2;
        v0.unlocked_level = arg3;
        v0.cooldown_timer = arg4;
        v0.max_success = arg5;
        v0.base_success = arg6;
        v0.success_increase = arg7;
        v0.failed_increase = arg8;
        v0.cash_gain = arg9;
        v0.weapon_gain = arg10;
        v0.success_lp_gained = arg11;
        v0.failed_lp_gained = arg12;
        v0.decay_rate = arg13;
    }
