module 0x41438a149588637fbf56b7a40ae09092aa76aa1e891180258577233add7a6df2::cnsnft1916 {
    struct CNSNFT1916 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1916, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1916>(arg0, arg1);
