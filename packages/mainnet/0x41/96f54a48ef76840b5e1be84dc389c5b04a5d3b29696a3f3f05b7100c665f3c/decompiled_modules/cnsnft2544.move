module 0x4196f54a48ef76840b5e1be84dc389c5b04a5d3b29696a3f3f05b7100c665f3c::cnsnft2544 {
    struct CNSNFT2544 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2544, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2544>(arg0, arg1);
