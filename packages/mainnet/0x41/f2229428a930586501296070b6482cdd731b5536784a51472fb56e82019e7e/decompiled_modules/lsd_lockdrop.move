module 0x41f2229428a930586501296070b6482cdd731b5536784a51472fb56e82019e7e::lsd_lockdrop {
    struct LsdLockdropVault has key {
        ...
        hive_incentives_balance: 0x2::balance::Balance<0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive::HIVE>,
    }
    ...
    public fun add_hive_incentives(arg0: &0x2::clock::Clock, arg1: &mut LsdLockdropVault, arg2: 0x2::coin::Coin<0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive::HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(0x2::clock::timestamp_ms(arg0) <= arg1.init_timestamp + arg1.deposit_window, 5100);
        let v0 = 0x2::coin::into_balance<0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive::HIVE>(arg2);
        0x2::balance::join<0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive::HIVE>(&mut arg1.hive_incentives_balance, 0x2::balance::split<0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive::HIVE>(&mut v0, arg3));
        arg1.total_hive_incentives = arg1.total_hive_incentives + arg3;
        0xdf1c75d8d389d064d8cc0a3c2578aac4441b3bcd9da63751cb581ccbd3b6d27::coin_helper::destroy_or_transfer_balance<0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive::HIVE>(v0, 0x2::tx_context::sender(arg4), arg4);
    ...
    public fun add_to_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0xdf1c75d8d389d064d8cc0a3c2578aac4441b3bcd9da63751cb581ccbd3b6d27::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::HiveProfile, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = if (0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::exists_for_profile(arg3, 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap))) {
            0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg7)
        } else {
        ...
        0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::entry_add_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v5, arg7);
        0xdf1c75d8d389d064d8cc0a3c2578aac4441b3bcd9da63751cb581ccbd3b6d27::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v6, 0x2::tx_context::sender(arg7), arg7);
    }
    ...
    fun allowed_withdrawal_amount(arg0: &LsdLockdropVault, arg1: u64, arg2: u64) : u64 {
        ...
        if (arg1 < v2) {
            (0xdf1c75d8d389d064d8cc0a3c2578aac4441b3bcd9da63751cb581ccbd3b6d27::math::mul_div_u256((arg2 as u256), ((v2 - arg1) as u256), ((v2 - v1) as u256)) as u64)
        } else {
            0
        }
    }
    ...
    fun calculate_weighted_units(arg0: u64, arg1: u64, arg2: &LsdLockdropVault) : u128 {
        (((arg0 as u256) * ((1000000000 as u256) + 0xdf1c75d8d389d064d8cc0a3c2578aac4441b3bcd9da63751cb581ccbd3b6d27::math::mul_div_u256(((arg1 - 1) as u256) * (arg2.weekly_multiplier as u256), (1000000000 as u256), (arg2.weekly_divider as u256)))) as u128)
    }

    public fun destroy_user_position(arg0: &0x2::clock::Clock, arg1: &0xdf1c75d8d389d064d8cc0a3c2578aac4441b3bcd9da63751cb581ccbd3b6d27::config::HiveEntryCap, arg2: &LsdLockdropVault, arg3: &mut 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::HiveProfile, arg4: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u64>, u128, u128) {
        ...
        if (!0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::exists_for_profile(arg3, 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap))) {
        ...
        } = 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg4);
        0x2::object::delete(v0);
        0x2::table::drop<u64, bool>(v5);
        (v1, v2, v3, v4, (v6 as u128), v7)
    }

    public fun does_user_have_position(arg0: &0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : bool {
    ...
    public fun get_user_position(arg0: &0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u64, u64) {
        ...
        let v1 = 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg0, v0);
    ...
    public fun infuse_sui_hsui_pool(arg0: &0x2::clock::Clock, arg1: &0xdf1c75d8d389d064d8cc0a3c2578aac4441b3bcd9da63751cb581ccbd3b6d27::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0xb64dfb9fda533f2db8feeeb67dd2fd95ce188c20efca9322e64c106218e2efad::hsui_vault::HSuiVault, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0xdf1c75d8d389d064d8cc0a3c2578aac4441b3bcd9da63751cb581ccbd3b6d27::hsui::HSUI>, 0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive::HIVE>, u64, u128) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        ...
        let v2 = 0xb64dfb9fda533f2db8feeeb67dd2fd95ce188c20efca9322e64c106218e2efad::hsui_vault::stake_sui_request(arg3, arg4, 0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, v1), 0x1::option::none<address>(), arg5);
        let v3 = SuiStakedForHiveSui{
            cur_timestamp      : v0,
            total_sui_locked   : arg2.total_sui_locked,
            sui_to_stake       : v1,
            total_hsui_krafted : 0x2::balance::value<0xdf1c75d8d389d064d8cc0a3c2578aac4441b3bcd9da63751cb581ccbd3b6d27::hsui::HSUI>(&v2),
        };
        0x2::event::emit<SuiStakedForHiveSui>(v3);
        (v2, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg2.sui_locked_balance), 0x2::balance::withdraw_all<0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive::HIVE>(&mut arg2.hive_incentives_balance), arg2.total_sui_locked, arg2.total_sui_weighted_units)
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
    }

    public entry fun initialize_global_lsd_lockdrop(arg0: &0xdf1c75d8d389d064d8cc0a3c2578aac4441b3bcd9da63751cb581ccbd3b6d27::config::HiveEntryCap, arg1: 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::ProfileDofOwnershipCapability, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : address {
        let v0 = LsdLockdropVault{
            ...
            hive_incentives_balance  : 0x2::balance::zero<0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive::HIVE>(),
        };
    ...
    public fun simulate_withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &LsdLockdropVault, arg2: &0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::HiveProfile, arg3: u64, arg4: u64) : (u64, u64, bool) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        if (v0 < arg1.init_timestamp || v0 > arg1.init_timestamp + arg1.deposit_window + arg1.withdrawal_window) {
            return (0, 0, false)
        };
        let v1 = 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::get_profile_dof_capability_identifier(&arg1.user_profile_access_cap);
        if (!0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::exists_for_profile(arg2, v1)) {
            return (0, 0, false)
        };
        let v2 = 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg2, v1);
    ...
    public fun withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0xdf1c75d8d389d064d8cc0a3c2578aac4441b3bcd9da63751cb581ccbd3b6d27::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::HiveProfile, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (v1, v2, _, v4) = 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::get_profile_meta_info(arg3);
        assert!(v0 >= arg2.init_timestamp, 5101);
        assert!(v0 < arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window, 5103);
        assert!(0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::exists_for_profile(arg3, 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap)), 5104);
        let v5 = 0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg6);
        ...
        0x8fe8110530c0e58b0003276f4fc026ca3f58c0285e90a6994092b983231581ee::hive_profile::entry_add_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v5, arg6);
        0xdf1c75d8d389d064d8cc0a3c2578aac4441b3bcd9da63751cb581ccbd3b6d27::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, arg4), v4, arg6);
    }
