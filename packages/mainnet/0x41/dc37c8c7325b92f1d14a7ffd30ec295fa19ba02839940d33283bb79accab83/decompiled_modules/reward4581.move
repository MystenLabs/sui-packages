module 0x41dc37c8c7325b92f1d14a7ffd30ec295fa19ba02839940d33283bb79accab83::reward4581 {
    struct REWARD4581 has drop {
        dummy_field: bool,
    }

    struct TICKET_4581 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4581(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4581>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4581>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4581, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4581>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4581>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4581>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4581>>(v5, 0x2::tx_context::sender(arg1));
    }
