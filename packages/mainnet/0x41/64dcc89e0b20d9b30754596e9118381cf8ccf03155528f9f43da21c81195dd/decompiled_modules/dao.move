module 0x3412f5d7819fddb9d504a422177e3cc62c029f08002a0d51c0f7cfd93cfdfbcc::dao {
    struct DAO has drop {
        dummy_field: bool,
    }
    ...
    entry fun cancel_proposal<T0: store + key>(arg0: &mut Dao<T0>, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun create_dao_hub(arg0: &0x3412f5d7819fddb9d504a422177e3cc62c029f08002a0d51c0f7cfd93cfdfbcc::staking::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = DaoHub{
    ...
    public fun create_proposal<T0: store + key>(arg0: &mut Dao<T0>, arg1: &T0, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: 0x1::option::Option<address>, arg6: 0x1::option::Option<u64>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun deposit_to_treasury<T0: store + key>(arg0: &mut Dao<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>) {
        0x2::coin::put<0x2::sui::SUI>(&mut arg0.treasury, arg1);
    }

    entry fun execute_proposal<T0: store + key>(arg0: &mut Dao<T0>, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object_table::borrow_mut<0x2::object::ID, Proposal>(&mut arg0.proposals, arg1);
        assert!(v0.status == 0, 7);
    ...
    entry fun vote<T0: store + key>(arg0: &mut Dao<T0>, arg1: &T0, arg2: 0x2::object::ID, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
