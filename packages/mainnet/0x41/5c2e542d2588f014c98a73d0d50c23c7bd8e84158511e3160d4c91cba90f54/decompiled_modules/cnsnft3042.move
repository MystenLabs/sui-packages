module 0x415c2e542d2588f014c98a73d0d50c23c7bd8e84158511e3160d4c91cba90f54::cnsnft3042 {
    struct CNSNFT3042 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3042, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3042>(arg0, arg1);
