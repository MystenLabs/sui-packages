module 0x419ddda0d115885575ad2ee9ad556e22df9106c6c6988ad7224ba376d0e2529a::basecamp {
    struct BASECAMP has drop {
        dummy_field: bool,
    }

    fun init(arg0: BASECAMP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BASECAMP>(arg0, 9, b"Basecamp", b"Everyone Want to go to Sui Basecamp", b"Yes! LFG!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/0s0Oyem.png")), arg1);
        let v2 = v0;
