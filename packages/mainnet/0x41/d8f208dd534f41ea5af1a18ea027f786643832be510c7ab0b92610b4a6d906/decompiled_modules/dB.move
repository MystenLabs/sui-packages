module 0x41d8f208dd534f41ea5af1a18ea027f786643832be510c7ab0b92610b4a6d906::dB {
    ...
    public fun eA<T0>(arg0: &mut AP, arg1: 0x2::balance::Balance<T0>) {
        ...
        let v1 = CI{
            amount_in : 0x2::balance::value<T0>(&arg1),
            coin_type : v0,
        };
    ...
    public fun fG<T0>(arg0: &mut AP, arg1: 0x2::coin::Coin<T0>) {
