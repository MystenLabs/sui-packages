module 0x418c0d3f57c7fa2029ee69537015975819e26859bc58bbad2f98a363d73af887::trusted_pull_oracle {
    ...
    struct TrustedPullOracle has key {
        id: 0x2::object::UID,
        trusted_price_data_cap: 0x418c0d3f57c7fa2029ee69537015975819e26859bc58bbad2f98a363d73af887::trusted_prices::TrustedPriceDataCap,
    ...
    public fun new(arg0: 0x418c0d3f57c7fa2029ee69537015975819e26859bc58bbad2f98a363d73af887::trusted_prices::TrustedPriceDataCap, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) : TrustedPullOracleCap {
    ...
    public fun make_trusted_prices_data(arg0: &TrustedPullOracle, arg1: vector<SignedPrice>, arg2: u64, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x418c0d3f57c7fa2029ee69537015975819e26859bc58bbad2f98a363d73af887::trusted_prices::TrustedPriceData {
        ...
        let v2 = 0x418c0d3f57c7fa2029ee69537015975819e26859bc58bbad2f98a363d73af887::trusted_prices::create_empty_trusted_price_data(&arg0.trusted_price_data_cap, arg5);
        ...
        while (v3 < 0x1::vector::length<SignedPrice>(&arg1)) {
            ...
            0x418c0d3f57c7fa2029ee69537015975819e26859bc58bbad2f98a363d73af887::trusted_prices::set_price_raw(&mut v2, v4.base, v4.quote, v4.price, &arg0.trusted_price_data_cap);
            v3 = v3 + 1;
        };
