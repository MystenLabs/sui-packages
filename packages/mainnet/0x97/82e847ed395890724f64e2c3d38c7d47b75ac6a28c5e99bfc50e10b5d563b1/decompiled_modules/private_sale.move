module 0x9782e847ed395890724f64e2c3d38c7d47b75ac6a28c5e99bfc50e10b5d563b1::private_sale {
    ...
    public entry fun claim_whitelist<T0>(arg0: &mut PrivateSale<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, u128>(&mut arg0.account_claimed_table, v1)) {
            ...
            let v3 = *v2 * (1000 - 800) * 25000 * 1000000000 / 1000 * 1000 * 1000000000;
            *v2 = 0;
            ...
            *v4 = *v4 + v3;
            ...
            let v6 = *0x2::table::borrow_mut<address, u128>(&mut arg0.account_deposited_table, 0x2::tx_context::sender(arg2)) * 800 * 25000 * 1000000000 / 1000 * 1000 * 1000000000;
    ...
    public fun committed_amount<T0>(arg0: &PrivateSale<T0>, arg1: address) : u128 {
