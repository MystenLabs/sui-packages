module 0x973680148bb501bed50e1265a83064ddfc3ee318b22b71a670a248d7792d5bc3::reward9687 {
    struct REWARD9687 has drop {
        dummy_field: bool,
    }

    struct TICKET_9687 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9687(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9687>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9687>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9687, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9687>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9687>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9687>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9687>>(v5, 0x2::tx_context::sender(arg1));
    }
