module 0x9770f391e82370d06c368c058fd9d6fad5ab036b29b2efd823a8de2c84317e0c::constants {
    ...
    public fun default_dao_creation_fee() : u64 {
        0xda99f380391192862c17d45e11a76f9dd69e240a42f1a12da2cc1a18bf37c672::constants::default_dao_creation_fee()
    }

    public fun default_launchpad_creation_fee() : u64 {
        0xda99f380391192862c17d45e11a76f9dd69e240a42f1a12da2cc1a18bf37c672::constants::default_launchpad_creation_fee()
    }
    ...
    public fun default_proposal_creation_fee() : u64 {
        0xda99f380391192862c17d45e11a76f9dd69e240a42f1a12da2cc1a18bf37c672::constants::default_proposal_creation_fee()
    }

    public fun default_proposal_fee_per_outcome() : u64 {
        0xda99f380391192862c17d45e11a76f9dd69e240a42f1a12da2cc1a18bf37c672::constants::default_proposal_fee_per_outcome()
    }
    ...
    public fun execution_window_ms() : u64 {
        let v0 = 1800000;
        let v1 = 0xda99f380391192862c17d45e11a76f9dd69e240a42f1a12da2cc1a18bf37c672::constants::min_execution_window_ms();
        if (v0 > v1) {
            v0
        } else {
            v1
    ...
    public fun launchpad_bid_fee_per_contribution() : u64 {
        0xda99f380391192862c17d45e11a76f9dd69e240a42f1a12da2cc1a18bf37c672::constants::launchpad_bid_fee_per_contribution()
    }
    ...
    public fun launchpad_min_duration_ms() : u64 {
        0xda99f380391192862c17d45e11a76f9dd69e240a42f1a12da2cc1a18bf37c672::constants::launchpad_min_duration_ms()
    }
    ...
    public fun min_execution_window_ms() : u64 {
        0xda99f380391192862c17d45e11a76f9dd69e240a42f1a12da2cc1a18bf37c672::constants::min_execution_window_ms()
    }
    ...
    public fun min_proposal_intent_expiry_ms() : u64 {
        0xda99f380391192862c17d45e11a76f9dd69e240a42f1a12da2cc1a18bf37c672::constants::min_proposal_intent_expiry_ms()
    }

    public fun min_review_period_ms() : u64 {
        0xda99f380391192862c17d45e11a76f9dd69e240a42f1a12da2cc1a18bf37c672::constants::min_review_period_ms()
    }

    public fun min_trading_period_ms() : u64 {
        0xda99f380391192862c17d45e11a76f9dd69e240a42f1a12da2cc1a18bf37c672::constants::min_trading_period_ms()
    }
    ...
    public fun protocol_min_liquidity_amount() : u64 {
        0xda99f380391192862c17d45e11a76f9dd69e240a42f1a12da2cc1a18bf37c672::constants::protocol_min_liquidity_amount()
    }
