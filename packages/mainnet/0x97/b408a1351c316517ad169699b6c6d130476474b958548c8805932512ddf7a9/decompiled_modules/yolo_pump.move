module 0x607c04cb1dbc5a9375ae6021947cfe62cea54df2d6395999809b1a64219f9285::yolo_pump {
    ...
    public entry fun buy_v2<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (v11, v12) = swap<T0>(v2, v10, arg1, v7, v3 - v9 - v5, arg3);
        let v13 = v12;
        let v14 = v11;
        v2.virtual_token_reserves = v2.virtual_token_reserves - 0x2::coin::value<T0>(&v14);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v13, v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v14, v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v13, v5, arg3), arg0.admin);
