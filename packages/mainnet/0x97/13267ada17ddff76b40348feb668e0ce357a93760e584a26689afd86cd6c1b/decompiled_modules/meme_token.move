module 0x9713267ada17ddff76b40348feb668e0ce357a93760e584a26689afd86cd6c1b::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"CAT", b"CATSY", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-08-29T09-25-13.845Z-pfp.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"CATSY"),
            symbol     : 0x1::string::utf8(b"CAT"),
            decimals   : 9,
