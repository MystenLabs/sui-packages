module 0x97663857326045760f770d1f6ea0d9038414b3d2e38dfb4e454efa24b331a100::aura_orb {
    struct AURA_ORB has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: AURA_ORB, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<AURA_ORB>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"AURA ORB"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Aura Orb is an innovative NFT project built on the SUI blockchain, designed to integrate with an exciting upcoming multiplayer betting game. This game introduces a competitive, play-to-earn experience where players can leverage their $AURA token holdings to participate and win substantial rewards. The Aura Orb NFT serves as a gateway to this dynamic ecosystem, offering players access to exclusive gameplay mechanics and a chance to compete for significant prizes."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://CVfWNGk1wvkAoFf9oVWNINm_3NGj7eQZbd6hRU4wGmU"));
