module 0x97fea95545c04dc73f8174c6195013b100a26e3fa978e7cf8b100a51dfaf8354::funding_reserve {
    ...
    public(friend) fun update(arg0: &mut 0x2::object::UID, arg1: &0x97fea95545c04dc73f8174c6195013b100a26e3fa978e7cf8b100a51dfaf8354::funding_rules::Rules, arg2: u256, arg3: u64, arg4: u64, arg5: u256, arg6: u64, arg7: u64, arg8: u256, arg9: u256, arg10: u64, arg11: u64, arg12: &0x2::clock::Clock) : Status {
        let v0 = if (arg4 > 0) {
            if (arg4 <= 86400000) {
        ...
        assert!(v0, 1);
        let (_, _, v3, v4, v5) = 0x97fea95545c04dc73f8174c6195013b100a26e3fa978e7cf8b100a51dfaf8354::funding_rules::values(arg1);
        ...
        if (arg6 == 0 || arg5 == 0) {
            ...
            let (v23, v24, _, _, _) = 0x97fea95545c04dc73f8174c6195013b100a26e3fa978e7cf8b100a51dfaf8354::funding_rules::values(arg1);
