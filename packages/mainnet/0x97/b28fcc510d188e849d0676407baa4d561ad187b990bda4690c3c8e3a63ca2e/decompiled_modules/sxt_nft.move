module 0x7883f18a9764824858f831615df9269dcbe6c6158a4b7e426eaba96a04cd0e89::sxt_nft {
    ...
    fun init(arg0: SXT_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::display::new<MembershipSBT>(&v0, arg1);
        0x2::display::add<MembershipSBT>(&mut v2, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<MembershipSBT>(&mut v2, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://wal-aggregator-mainnet.staketab.org/v1/blobs/{image_cid}"));
        0x2::display::add<MembershipSBT>(&mut v2, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::update_version<MembershipSBT>(&mut v2);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::display::Display<EventNFT>>(v1);
        0x2::transfer::public_share_object<0x2::display::Display<MembershipSBT>>(v2);
    }

    public entry fun mint_sbt_to(arg0: address, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = MembershipSBT{
            id          : 0x2::object::new(arg5),
            name        : arg1,
            description : arg2,
            image_cid   : arg3,
        ...
        0x2::transfer::transfer<MembershipSBT>(v0, arg0);
    }
