module 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_vault {
    ...
    public fun accept_price<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        ...
        let v3 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::calculate_price_deviation(arg0.pricing.price, v2.price);
        let v4 = v0 == arg0.roles.manager;
        if (v3 > 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::max_manager_bypass_deviation_bps() && !v4) {
            abort 1
        };
        let v5 = v4 && v3 <= 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::max_manager_bypass_deviation_bps();
    ...
    public fun accrue_management_fee<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x2::clock::Clock) {
        ...
        let v6 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::calculate_management_fee(arg0.total_shares, v5, v4);
        let v7 = if (arg0.limits.max_total_shares == 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::no_limit()) {
            v6
        ...
        if (v7 > 0) {
            let v9 = if (v7 == v6) {
                ...
                0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::calculate_management_fee_paid_secs(arg0.total_shares, v5, v7)
            };
            if (v9 <= v3) {
    ...
    public fun allowlist_mint<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: address, arg2: address, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(arg3 > 0, 4);
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::check_max_total_shares(arg0.total_shares, arg3, arg0.limits.max_total_shares);
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::check_max_shares_per_user(get_user_shares<T0, T1>(arg0, arg2), arg3, arg0.limits.max_shares_per_user);
    ...
    public fun cancel_withdrawal_after_ttl<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ProcessorCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v2 + v3;
        let v7 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::apply_basis_points(v2, arg0.wparams.system_penalty_bps);
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::check_max_total_shares(arg0.total_shares, v7, arg0.limits.max_total_shares);
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::check_max_shares_per_user(get_user_shares<T0, T1>(arg0, v5), v6 + v7, arg0.limits.max_shares_per_user);
    ...
    public fun create_vault<T0, T1>(arg0: &mut 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_factory::FactoryRegistry, arg1: &0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_factory::FactoryAdminCap, arg2: 0x2::coin::TreasuryCap<T1>, arg3: u8, arg4: u8, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: address, arg10: address, arg11: address, arg12: address, arg13: address, arg14: address, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_factory::assert_registry_matches_cap(arg0, arg1);
        create_vault_impl<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16);
    }

    fun create_vault_impl<T0, T1>(arg0: &mut 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_factory::FactoryRegistry, arg1: &0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_factory::FactoryAdminCap, arg2: 0x2::coin::TreasuryCap<T1>, arg3: u8, arg4: u8, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: address, arg10: address, arg11: address, arg12: address, arg13: address, arg14: address, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::validate_fees(arg5, arg6, arg7);
        assert!(arg8 > 0, 3);
        assert!(arg4 != 0, 5);
        assert!(arg4 >= arg3, 5);
        ...
        let v1 = VaultPricing{
            ...
            max_price_staleness_secs : 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::default_max_price_staleness_secs(),
            max_deviation_bps        : 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::default_max_deviation_bps(),
        };
        let v2 = VaultFees{
            deposit_fee_bps             : arg5,
            withdraw_fee_bps            : arg6,
            management_fee_bps_per_year : arg7,
            swap_fee_bps                : 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::default_swap_fee_bps(),
            last_mgmt_fee_ts            : v0,
        };
        let v3 = VaultLimits{
            max_total_shares    : 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::no_limit(),
            max_shares_per_user : 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::no_limit(),
            max_total_idle      : 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::no_limit(),
            min_shares_to_mint  : 0,
        };
        let v4 = VaultWithdrawalParams{
            downside_cap_bps    : 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::default_downside_cap_bps(),
            withdrawal_ttl_secs : 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::min_withdrawal_ttl_secs(),
            system_penalty_bps  : 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::default_system_penalty_bps(),
        };
        ...
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_factory::register_vault(arg0, arg1, v11, arg15);
    ...
    fun deposit_inner<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 > 0, 4);
        let v1 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::amount_to_shares(v0, arg0.pricing.price, arg0.underlying_decimals, arg0.share_decimals);
        let v2 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::apply_basis_points(v1, arg0.fees.deposit_fee_bps);
        let v3 = v1 - v2;
        assert!(v3 > 0, 26);
        if (arg3 > 0) {
            assert!(v3 >= arg3, 42);
        ...
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::check_max_shares_per_user(v4, v3, arg0.limits.max_shares_per_user);
        let v6 = v3 + v2;
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::check_max_total_shares(arg0.total_shares, v6, arg0.limits.max_total_shares);
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::check_max_total_idle(arg0.total_idle, v0, arg0.limits.max_total_idle);
        0x2::balance::join<T0>(&mut arg0.underlying, 0x2::coin::into_balance<T0>(arg1));
        arg0.total_idle = arg0.total_idle + v0;
    ...
    public fun fulfill_withdrawal<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ProcessorCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v0.user;
        let v7 = v0.receiver;
        let v8 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::shares_to_amount(v1, arg0.pricing.price, arg0.underlying_decimals, arg0.share_decimals);
        let v9 = if (v8 < v4) {
            v4
    ...
    public fun propose_cooldowns<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &0x2::tx_context::TxContext) {
        ...
        let v0 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::min_cooldown_secs();
        let v1 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::max_cooldown_secs();
    ...
    public fun propose_fees<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0, T1>(arg0);
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::validate_fees(arg2, arg3, arg4);
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::validate_swap_fee(arg5);
    ...
    public fun propose_limits<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0, T1>(arg0);
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::validate_new_limits(arg2, arg3, arg4, arg6);
        assert!(arg5 > 0 && arg5 <= 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::max_allowed_deviation_bps(), 5);
    ...
    public fun propose_withdrawal_params<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0, T1>(arg0);
        assert!(arg3 >= 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::min_withdrawal_ttl_secs() && arg3 <= 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::max_withdrawal_ttl_secs(), 5);
        assert!(arg2 <= 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::bps_precision(), 5);
        assert!(arg4 <= 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::max_system_penalty_bps(), 5);
    ...
    public fun swap_tokens<T0, T1, T2>(arg0: &mut Vault<T0, T1>, arg1: &mut Vault<T0, T2>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        let v4 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::shares_to_amount(arg2, arg0.pricing.price, arg0.underlying_decimals, arg0.share_decimals);
        let v5 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::select_swap_fee_bps(arg0.fees.swap_fee_bps, arg1.fees.swap_fee_bps);
        let v6 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::apply_basis_points(v4, v5);
        let v7 = v6 / 2;
        let v8 = v6 - v7;
        let v9 = v4 - v6;
        let v10 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::amount_to_shares(v9, arg1.pricing.price, arg1.underlying_decimals, arg1.share_decimals);
        assert!(v10 > 0, 26);
        assert!(v10 >= arg3, 42);
        let v11 = if (v8 > 0) {
            0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::amount_to_shares(v8, arg1.pricing.price, arg1.underlying_decimals, arg1.share_decimals)
        } else {
            0
        };
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::check_max_total_shares(arg1.total_shares, v10 + v11, arg1.limits.max_total_shares);
        ...
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::check_max_shares_per_user(v12, v10, arg1.limits.max_shares_per_user);
        add_user_shares<T0, T2>(arg1, v0, v10);
        arg1.total_shares = arg1.total_shares + v10;
        if (v7 > 0) {
            let v14 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::amount_to_shares(v7, arg0.pricing.price, arg0.underlying_decimals, arg0.share_decimals);
            if (v14 > 0) {
        ...
        let v17 = if (v7 > 0) {
            0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::amount_to_shares(v7, arg0.pricing.price, arg0.underlying_decimals, arg0.share_decimals)
        } else {
            0
        };
    ...
    fun update_price_internal<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock) {
        ...
        if (0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::calculate_price_deviation(arg0.pricing.price, arg1) <= arg0.pricing.max_deviation_bps) {
    ...
    fun withdraw_request_inner<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::apply_fee(arg1, arg0.fees.withdraw_fee_bps);
        let v5 = 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::shares_to_amount(v3, arg0.pricing.price, arg0.underlying_decimals, arg0.share_decimals);
        assert!(arg2 <= v5, 5);
        if (arg2 > 0) {
            assert!(arg2 <= 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::mul_div(v5, 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::bps_precision() - arg0.wparams.downside_cap_bps, 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::bps_precision()), 5);
        };
