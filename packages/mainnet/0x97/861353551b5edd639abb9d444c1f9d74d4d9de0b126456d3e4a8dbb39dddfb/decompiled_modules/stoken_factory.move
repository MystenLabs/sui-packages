module 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_factory {
    ...
    public fun create_factory(arg0: u64, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : FactoryAdminCap {
        assert!(arg0 >= 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::min_cooldown_secs() && arg0 <= 0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_math::max_cooldown_secs(), 5);
    ...
    public fun register_vault(arg0: &mut FactoryRegistry, arg1: &FactoryAdminCap, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) {
        ...
        0x97861353551b5edd639abb9d444c1f9d74d4d9de0b126456d3e4a8dbb39dddfb::stoken_events::emit_factory_vault_created(0x2::object::id<FactoryRegistry>(arg0), arg2, v0, 0x2::clock::timestamp_ms(arg3));
    }
