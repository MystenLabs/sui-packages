module 0x97c04e90ff13ee61176662b4a0e5a18dd80656be6be408e2b7833669ce85b993::distributor {
    ...
    public entry fun claim<T0>(arg0: &mut Distributor<T0>, arg1: u64, arg2: vector<vector<u8>>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 > v2, 4);
        let v3 = 0x97c04e90ff13ee61176662b4a0e5a18dd80656be6be408e2b7833669ce85b993::merkle::leaf(v1, arg1);
        assert!(0x97c04e90ff13ee61176662b4a0e5a18dd80656be6be408e2b7833669ce85b993::merkle::verify(&arg0.merkle_root, &v3, &arg2), 5);
        let v4 = arg1 - v2;
    ...
    public entry fun fund<T0>(arg0: &mut Distributor<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun withdraw<T0>(arg0: &mut Distributor<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.start_time_s == 0 || 0x2::clock::timestamp_ms(arg1) / 1000 > arg0.end_time_s, 6);
