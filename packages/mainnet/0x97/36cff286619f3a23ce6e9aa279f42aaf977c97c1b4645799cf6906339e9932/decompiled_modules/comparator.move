module 0x9736cff286619f3a23ce6e9aa279f42aaf977c97c1b4645799cf6906339e9932::comparator {
    struct Result has drop {
        inner: u8,
    }

    public fun to_bytes<T0>(arg0: &T0, arg1: &T0) : (vector<u8>, vector<u8>) {
        (0x1::bcs::to_bytes<T0>(arg0), 0x1::bcs::to_bytes<T0>(arg1))
    }
