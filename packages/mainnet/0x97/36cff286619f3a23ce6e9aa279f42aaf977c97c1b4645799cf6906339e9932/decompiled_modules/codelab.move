module 0x9736cff286619f3a23ce6e9aa279f42aaf977c97c1b4645799cf6906339e9932::codelab {
    ...
    public entry fun getTypeNames<T0, T1>() {
        ...
        let (v2, v3) = 0x9736cff286619f3a23ce6e9aa279f42aaf977c97c1b4645799cf6906339e9932::comparator::to_bytes<0x1::type_name::TypeName>(&v0, &v1);
        let v4 = NamesEvent{
    ...
    public fun is_order<T0, T1>() : bool {
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x1::type_name::get<T1>();
        let v2 = 0x9736cff286619f3a23ce6e9aa279f42aaf977c97c1b4645799cf6906339e9932::comparator::compare<0x1::type_name::TypeName>(&v0, &v1);
        assert!(!0x9736cff286619f3a23ce6e9aa279f42aaf977c97c1b4645799cf6906339e9932::comparator::is_equal(&v2), 1001);
        0x9736cff286619f3a23ce6e9aa279f42aaf977c97c1b4645799cf6906339e9932::comparator::is_smaller_than(&v2)
    }
