module 0x9771ff2f47356b1384eda914d3391a7554e015edf299c25a43e2db57c60f37fc::token_bridge_resolver {
    ...
    public fun resolve_vaa(arg0: &0x9771ff2f47356b1384eda914d3391a7554e015edf299c25a43e2db57c60f37fc::state::State, arg1: vector<u8>, arg2: vector<u8>) {
        ...
        let v2 = v1;
        let v3 = 0x9771ff2f47356b1384eda914d3391a7554e015edf299c25a43e2db57c60f37fc::state::core_bridge_state(arg0);
        let v4 = 0x9771ff2f47356b1384eda914d3391a7554e015edf299c25a43e2db57c60f37fc::state::token_bridge_state(arg0);
        ...
        if (!0xa4d99ac27bd855ea514b767e02e6e28f98d8a1e65ccd3fd687e99cc0580219d1::ptb_types::has_discovered_key(&v2, &v7)) {
            if (0xa4d99ac27bd855ea514b767e02e6e28f98d8a1e65ccd3fd687e99cc0580219d1::ptb_types::has_discovered_key(&v2, &v6)) {
                ...
                0x1::string::append(&mut v9, 0x1::string::utf8(b"::token_registry::CoinTypeKey"));
