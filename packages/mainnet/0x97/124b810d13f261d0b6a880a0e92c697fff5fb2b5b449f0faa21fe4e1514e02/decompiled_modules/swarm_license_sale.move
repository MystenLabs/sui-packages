module 0x97124b810d13f261d0b6a880a0e92c697fff5fb2b5b449f0faa21fe4e1514e02::swarm_license_sale {
    ...
    public entry fun airdrop_license(arg0: &AdminPower, arg1: &AdminWhitelist, arg2: &mut Treasury, arg3: address, arg4: 0x1::string::String, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        arg2.total_distribution = arg2.total_distribution + arg2.airdrops;
    }
    ...
    public entry fun assign_custom_referral_code(arg0: &AdminPower, arg1: &AdminWhitelist, arg2: &mut Treasury, arg3: address, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, 0x1::string::String>(&arg2.custom_referral_codes, arg3)) {
            0x2::table::remove<address, 0x1::string::String>(&mut arg2.custom_referral_codes, arg3);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Treasury{
            id                           : 0x2::object::new(arg0),
            wallet                       : @0xbb4c78703cc8121b36611603509b94e2294cd77a07b6e1341e5bf808f8224349,
            sales                        : 0,
            airdrops                     : 0,
    ...
    fun internal_calculate_price(arg0: u64) : u64 {
        ...
        if (arg0 <= 16) {
            return 1099000 + (arg0 - 12) / 100 * 10000
        };
        if (arg0 <= 21) {
            return 1559000 + (arg0 - 16) / 100 * 20000
        };
        if (arg0 <= 25) {
            return 2469000 + (arg0 - 21) / 100 * 30000
        };
        if (arg0 <= 30) {
            return 3829000 + (arg0 - 25) / 100 * 40000
        };
        3829000 + (30 - 25) / 100 * 40000
    }
    ...
    fun internal_create_and_transfer_license(arg0: &mut Treasury, arg1: Price, arg2: address, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = CreateLicenseEvent{
            license_id    : 0x2::object::id<License>(&v0),
            referral_code : arg3,
            owner         : arg2,
        };
        0x2::event::emit<CreateLicenseEvent>(v1);
    ...
    fun internal_create_referee(arg0: &mut Treasury, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object_table::contains<0x1::string::String, Referrer>(&arg0.referral_code_to_referrer, arg1), 9223374257352867839);
    ...
    fun internal_process_payment(arg0: &mut Treasury, arg1: &mut 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: u64, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object_table::contains<0x1::string::String, Referrer>(&arg0.referral_code_to_referrer, arg3), 9223373845036007423);
        ...
        arg0.total_distribution = arg0.total_distribution + arg0.sales;
