module 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::typus_hedge {
    ...
    public fun capabilities_mut<T0: drop>(arg0: T0, arg1: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg2: &mut Registry, arg3: u64, arg4: &0x2::tx_context::TxContext) : &mut 0x2::bag::Bag {
        ...
        assert!(0x1::vector::contains<vector<u8>>(&v0, &v2), 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::invalid_witness(arg3));
    ...
    public fun deposit_hedge_token<T0: drop, T1>(arg0: T0, arg1: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg2: &mut Registry, arg3: u64, arg4: 0x2::balance::Balance<T1>, arg5: &0x2::tx_context::TxContext) : vector<u64> {
        verify(arg1, arg5);
        let v0 = if (0x1::type_name::with_defining_ids<T0>() == 0x1::type_name::with_defining_ids<VERSION>()) {
            true
        } else {
        ...
        assert!(v0, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::invalid_witness(arg3));
        ...
        let v11 = 0x1::type_name::with_defining_ids<T1>();
        let v12 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v12, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v11));
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"deposit_hedge_token"), 0x2::vec_map::from_keys_values<0x1::string::String, u64>(v5, v8), 0x2::vec_map::from_keys_values<0x1::string::String, vector<u8>>(v10, v12));
    ...
    public fun deposit_main_token<T0: drop, T1>(arg0: T0, arg1: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg2: &mut Registry, arg3: u64, arg4: 0x2::balance::Balance<T1>, arg5: &0x2::tx_context::TxContext) : vector<u64> {
        ...
        let v12 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v12, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v11));
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"deposit_main_token"), 0x2::vec_map::from_keys_values<0x1::string::String, u64>(v5, v8), 0x2::vec_map::from_keys_values<0x1::string::String, vector<u8>>(v10, v12));
        let v13 = 0x1::string::utf8(b"round");
        let v14 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v14, *0x2::vec_map::get<0x1::string::String, u64>(&v4.info, &v13));
        v14
    ...
    public fun deposit_other_token<T0: drop, T1>(arg0: T0, arg1: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg2: &mut Registry, arg3: u64, arg4: 0x2::balance::Balance<T1>, arg5: &0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(v0, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::invalid_witness(arg3));
        let v4 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg2.id, arg3);
        if (0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&v4.id, 0x1::type_name::with_defining_ids<T1>())) {
            0x2::balance::join<T1>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut v4.id, 0x1::type_name::with_defining_ids<T1>()), arg4);
        } else {
            0x2::dynamic_field::add<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut v4.id, 0x1::type_name::with_defining_ids<T1>(), arg4);
        };
        let v5 = 0x1::vector::empty<0x1::string::String>();
        let v6 = &mut v5;
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"index"));
        ...
        let v12 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v12, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v11));
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"deposit_other_token"), 0x2::vec_map::from_keys_values<0x1::string::String, u64>(v5, v8), 0x2::vec_map::from_keys_values<0x1::string::String, vector<u8>>(v10, v12));
        let v13 = 0x1::string::utf8(b"round");
        let v14 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v14, *0x2::vec_map::get<0x1::string::String, u64>(&v4.info, &v13));
        v14
    ...
    entry fun new_vault<T0, T1>(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: &0x2::clock::Clock, arg23: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = Vault{
            ...
            main_token                : 0x1::type_name::with_defining_ids<T0>(),
            hedge_token               : 0x1::type_name::with_defining_ids<T1>(),
        ...
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"new_vault"), v0, 0x2::vec_map::empty<0x1::string::String, vector<u8>>());
    }
    ...
    public fun raise_fund<T0, T1>(arg0: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::TypusLeaderboardRegistry, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::TypusUserRegistry, arg3: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg4: &mut Registry, arg5: u64, arg6: 0x2::balance::Balance<T0>, arg7: 0x2::balance::Balance<T1>, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        version_check(arg3);
        assert!(!arg4.transaction_suspended, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::transaction_suspended(arg5));
        ...
        let v3 = 999;
        assert!(0x2::vec_map::get<0x1::string::String, u64>(&v1.info, &v2) != &v3, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::already_closed(arg5));
        let v4 = false;
        0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::account::create_account(arg0, arg13);
        let v5 = 0x2::object::id_address<0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::account::Account>(0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::account::borrow_user_account(arg0, arg13));
        if (!0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::contains<address>(&v1.user_share, v5)) {
            let v6 = vector[];
            let v7 = 0;
            while (v7 < 12) {
            ...
            0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::push_back<address, vector<u64>>(&mut v1.user_share, v5, v6);
        };
        if (!0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::contains<address>(&v1.reward_token_share, v5)) {
            let v8 = vector[];
            let v9 = 0;
            while (v9 < 0x1::vector::length<0x1::type_name::TypeName>(&v1.reward_tokens)) {
                0x1::vector::push_back<u64>(&mut v8, 0);
                v9 = v9 + 1;
            };
            0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::push_back<address, vector<u64>>(&mut v1.reward_token_share, v5, v8);
        };
        let (v10, v11) = update_typus_point(arg0, arg1, arg2, &v0, v1, v5, arg12, arg13);
        let v12 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::borrow_by_key_mut<address, vector<u64>>(&mut v1.user_share, v5);
        let v13 = if (*0x1::vector::borrow<u64>(v12, 6) == 0) {
            if (*0x1::vector::borrow<u64>(v12, 0) == 0) {
                if (*0x1::vector::borrow<u64>(v12, 7) == 0) {
                    *0x1::vector::borrow<u64>(v12, 1) == 0
                } else {
                    false
                }
            } else {
        ...
        let v14 = 0x2::balance::value<T0>(&arg6);
        let v15 = 0x2::balance::value<T1>(&arg7);
        *0x1::vector::borrow_mut<u64>(v12, 6) = *0x1::vector::borrow<u64>(v12, 6) + v14;
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 6) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 6) + v14;
        ...
        *0x1::vector::borrow_mut<u64>(v12, 7) = *0x1::vector::borrow<u64>(v12, 7) + v15;
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 7) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 7) + v15;
        ...
        let v16 = if (*0x1::vector::borrow<u64>(v12, 2) < arg8) {
            *0x1::vector::borrow<u64>(v12, 2)
        } else {
            arg8
        };
        *0x1::vector::borrow_mut<u64>(v12, 0) = *0x1::vector::borrow<u64>(v12, 0) + v16;
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 0) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 0) + v16;
        *0x1::vector::borrow_mut<u64>(v12, 2) = *0x1::vector::borrow<u64>(v12, 2) - v16;
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 2) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 2) - v16;
        let v17 = if (*0x1::vector::borrow<u64>(v12, 3) < arg9) {
            *0x1::vector::borrow<u64>(v12, 3)
        } else {
            arg9
        };
        *0x1::vector::borrow_mut<u64>(v12, 1) = *0x1::vector::borrow<u64>(v12, 1) + v17;
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 1) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 1) + v17;
        *0x1::vector::borrow_mut<u64>(v12, 3) = *0x1::vector::borrow<u64>(v12, 3) - v17;
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 3) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 3) - v17;
        let v18 = if (*0x1::vector::borrow<u64>(v12, 4) < arg10) {
            *0x1::vector::borrow<u64>(v12, 4)
        } else {
            arg10
        };
        *0x1::vector::borrow_mut<u64>(v12, 6) = *0x1::vector::borrow<u64>(v12, 6) + v18;
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 6) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 6) + v18;
        *0x1::vector::borrow_mut<u64>(v12, 4) = *0x1::vector::borrow<u64>(v12, 4) - v18;
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 4) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 4) - v18;
        let v19 = if (*0x1::vector::borrow<u64>(v12, 5) < arg11) {
            *0x1::vector::borrow<u64>(v12, 5)
        } else {
            arg11
        };
        *0x1::vector::borrow_mut<u64>(v12, 7) = *0x1::vector::borrow<u64>(v12, 7) + v19;
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 7) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 7) + v19;
        *0x1::vector::borrow_mut<u64>(v12, 5) = *0x1::vector::borrow<u64>(v12, 5) - v19;
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 5) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 5) - v19;
        *0x1::vector::borrow_mut<u64>(v12, 10) = *0x1::vector::borrow<u64>(v12, 10) + v14;
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 10) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 10) + v14;
        *0x1::vector::borrow_mut<u64>(v12, 11) = *0x1::vector::borrow<u64>(v12, 11) + v15;
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 11) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 11) + v15;
        update_snapshot_usd_value(v1, v5);
        if (v4) {
            let v20 = 0x1::string::utf8(b"main_token_lot_size");
            assert!(v14 + v18 >= *0x2::vec_map::get<0x1::string::String, u64>(&v1.config, &v20), 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::lot_size_violation(arg5));
            let v21 = 0x1::string::utf8(b"main_token_lot_size");
            assert!((v14 + v18) % *0x2::vec_map::get<0x1::string::String, u64>(&v1.config, &v21) == 0, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::lot_size_violation(arg5));
            let v22 = 0x1::string::utf8(b"hedge_token_lot_size");
            assert!(v15 + v19 >= *0x2::vec_map::get<0x1::string::String, u64>(&v1.config, &v22), 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::lot_size_violation(arg5));
            let v23 = 0x1::string::utf8(b"hedge_token_lot_size");
            assert!((v15 + v19) % *0x2::vec_map::get<0x1::string::String, u64>(&v1.config, &v23) == 0, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::lot_size_violation(arg5));
            let v24 = 0x1::string::utf8(b"main_token_min_size");
            assert!(v14 + v18 >= *0x2::vec_map::get<0x1::string::String, u64>(&v1.config, &v24), 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::min_size_violation(arg5));
            let v25 = 0x1::string::utf8(b"hedge_token_min_size");
            assert!(v15 + v19 >= *0x2::vec_map::get<0x1::string::String, u64>(&v1.config, &v25), 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::min_size_violation(arg5));
        };
        assert!(v14 + v16 + v18 + v15 + v17 + v19 > 0, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::zero_value(arg5));
        let v26 = 0x1::string::utf8(b"capacity");
        assert!(*0x1::vector::borrow<u64>(&v1.user_share_supply, 6) + *0x1::vector::borrow<u64>(&v1.user_share_supply, 0) <= *0x2::vec_map::get<0x1::string::String, u64>(&v1.config, &v26), 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::capacity_violation(arg5));
        let v27 = 0x1::vector::empty<0x1::string::String>();
        let v28 = &mut v27;
        0x1::vector::push_back<0x1::string::String>(v28, 0x1::string::utf8(b"index"));
        0x1::vector::push_back<0x1::string::String>(v28, 0x1::string::utf8(b"round"));
        0x1::vector::push_back<0x1::string::String>(v28, 0x1::string::utf8(b"main_balance_value"));
        0x1::vector::push_back<0x1::string::String>(v28, 0x1::string::utf8(b"hedge_balance_value"));
        0x1::vector::push_back<0x1::string::String>(v28, 0x1::string::utf8(b"main_deactivating_value"));
        0x1::vector::push_back<0x1::string::String>(v28, 0x1::string::utf8(b"hedge_deactivating_value"));
        0x1::vector::push_back<0x1::string::String>(v28, 0x1::string::utf8(b"main_inactive_value"));
        0x1::vector::push_back<0x1::string::String>(v28, 0x1::string::utf8(b"hedge_inactive_value"));
        0x1::vector::push_back<0x1::string::String>(v28, 0x1::string::utf8(b"exps"));
        0x1::vector::push_back<0x1::string::String>(v28, 0x1::string::utf8(b"points"));
        let v29 = 0x1::string::utf8(b"round");
        let v30 = 0x1::vector::empty<u64>();
        let v31 = &mut v30;
        0x1::vector::push_back<u64>(v31, arg5);
        0x1::vector::push_back<u64>(v31, *0x2::vec_map::get<0x1::string::String, u64>(&v1.info, &v29));
        0x1::vector::push_back<u64>(v31, v14);
        0x1::vector::push_back<u64>(v31, v15);
        0x1::vector::push_back<u64>(v31, v16);
        0x1::vector::push_back<u64>(v31, v17);
        0x1::vector::push_back<u64>(v31, v18);
        0x1::vector::push_back<u64>(v31, v19);
        0x1::vector::push_back<u64>(v31, v10);
        0x1::vector::push_back<u64>(v31, v11);
        let v32 = 0x1::vector::empty<0x1::string::String>();
        let v33 = &mut v32;
        0x1::vector::push_back<0x1::string::String>(v33, 0x1::string::utf8(b"main_token"));
        0x1::vector::push_back<0x1::string::String>(v33, 0x1::string::utf8(b"hedge_token"));
        let v34 = 0x1::type_name::with_defining_ids<T0>();
        let v35 = 0x1::type_name::with_defining_ids<T1>();
        let v36 = 0x1::vector::empty<vector<u8>>();
        let v37 = &mut v36;
        0x1::vector::push_back<vector<u8>>(v37, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v34));
        0x1::vector::push_back<vector<u8>>(v37, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v35));
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_user_event(0x1::string::utf8(b"raise_fund"), 0x2::vec_map::from_keys_values<0x1::string::String, u64>(v27, v30), 0x2::vec_map::from_keys_values<0x1::string::String, vector<u8>>(v32, v36));
    ...
    public fun reduce_fund<T0, T1>(arg0: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::TypusLeaderboardRegistry, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::TypusUserRegistry, arg3: &mut 0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg4: &mut Registry, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: bool, arg11: 0x2::balance::Balance<0x2::sui::SUI>, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let v1 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg4.id, arg5);
        token_type_check<T0, T1>(v1);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg11) == 0, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::invalid_fee_amount(arg5));
        ...
        *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 5) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 5) - v13;
        ...
        let v14 = if (*0x1::vector::borrow<u64>(v5, 10) < v8 + v12) {
            true
        } else if (*0x1::vector::borrow<u64>(v5, 0) == 0) {
            if (*0x1::vector::borrow<u64>(v5, 2) == 0) {
                if (*0x1::vector::borrow<u64>(v5, 4) == 0) {
                    *0x1::vector::borrow<u64>(v5, 6) == 0
                } else {
                    false
                }
            } else {
        ...
        if (v14) {
            *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 10) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 10) - *0x1::vector::borrow<u64>(v5, 10);
            *0x1::vector::borrow_mut<u64>(v5, 10) = 0;
        } else {
            *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 10) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 10) - v8 - v12;
            *0x1::vector::borrow_mut<u64>(v5, 10) = *0x1::vector::borrow<u64>(v5, 10) - v8 - v12;
        };
        let v15 = if (*0x1::vector::borrow<u64>(v5, 11) < v9 + v13) {
            true
        } else if (*0x1::vector::borrow<u64>(v5, 1) == 0) {
            if (*0x1::vector::borrow<u64>(v5, 3) == 0) {
                if (*0x1::vector::borrow<u64>(v5, 4) == 0) {
                    *0x1::vector::borrow<u64>(v5, 7) == 0
                } else {
                    false
                }
            } else {
        ...
        if (v15) {
            *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 11) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 11) - *0x1::vector::borrow<u64>(v5, 11);
            *0x1::vector::borrow_mut<u64>(v5, 11) = 0;
        } else {
            *0x1::vector::borrow_mut<u64>(&mut v1.user_share_supply, 11) = *0x1::vector::borrow<u64>(&v1.user_share_supply, 11) - v9 - v13;
            *0x1::vector::borrow_mut<u64>(v5, 11) = *0x1::vector::borrow<u64>(v5, 11) - v9 - v13;
        };
        update_snapshot_usd_value(v1, v2);
        assert!(v8 + v10 + v12 + v9 + v11 + v13 > 0, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::zero_value(arg5));
        let v16 = 0x1::vector::empty<0x1::string::String>();
        let v17 = &mut v16;
        0x1::vector::push_back<0x1::string::String>(v17, 0x1::string::utf8(b"index"));
        0x1::vector::push_back<0x1::string::String>(v17, 0x1::string::utf8(b"round"));
        0x1::vector::push_back<0x1::string::String>(v17, 0x1::string::utf8(b"main_warmup_value"));
        0x1::vector::push_back<0x1::string::String>(v17, 0x1::string::utf8(b"hedge_warmup_value"));
        0x1::vector::push_back<0x1::string::String>(v17, 0x1::string::utf8(b"main_active_value"));
        0x1::vector::push_back<0x1::string::String>(v17, 0x1::string::utf8(b"hedge_active_value"));
        0x1::vector::push_back<0x1::string::String>(v17, 0x1::string::utf8(b"main_inactive_value"));
        0x1::vector::push_back<0x1::string::String>(v17, 0x1::string::utf8(b"hedge_inactive_value"));
        0x1::vector::push_back<0x1::string::String>(v17, 0x1::string::utf8(b"exps"));
        0x1::vector::push_back<0x1::string::String>(v17, 0x1::string::utf8(b"points"));
        let v18 = 0x1::string::utf8(b"round");
        let v19 = 0x1::vector::empty<u64>();
        let v20 = &mut v19;
        0x1::vector::push_back<u64>(v20, arg5);
        0x1::vector::push_back<u64>(v20, *0x2::vec_map::get<0x1::string::String, u64>(&v1.info, &v18));
        0x1::vector::push_back<u64>(v20, v8);
        0x1::vector::push_back<u64>(v20, v9);
        0x1::vector::push_back<u64>(v20, v10);
        0x1::vector::push_back<u64>(v20, v11);
        0x1::vector::push_back<u64>(v20, v12);
        0x1::vector::push_back<u64>(v20, v13);
        0x1::vector::push_back<u64>(v20, v3);
        0x1::vector::push_back<u64>(v20, v4);
        let v21 = 0x1::vector::empty<0x1::string::String>();
        let v22 = &mut v21;
        0x1::vector::push_back<0x1::string::String>(v22, 0x1::string::utf8(b"main_token"));
        0x1::vector::push_back<0x1::string::String>(v22, 0x1::string::utf8(b"hedge_token"));
        let v23 = 0x1::type_name::with_defining_ids<T0>();
        let v24 = 0x1::type_name::with_defining_ids<T1>();
        let v25 = 0x1::vector::empty<vector<u8>>();
        let v26 = &mut v25;
        0x1::vector::push_back<vector<u8>>(v26, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v23));
        0x1::vector::push_back<vector<u8>>(v26, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v24));
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_user_event(0x1::string::utf8(b"reduce_fund"), 0x2::vec_map::from_keys_values<0x1::string::String, u64>(v16, v19), 0x2::vec_map::from_keys_values<0x1::string::String, vector<u8>>(v21, v25));
        0x2::dynamic_field::add<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::ManagerCap>(&mut arg4.id, 0x1::string::utf8(b"typus_manager_cap"), v0);
        (v6, v7)
    }
    ...
    public fun refresh<T0, T1>(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::clock::timestamp_ms(arg6) >= *0x2::vec_map::get<0x1::string::String, u64>(&v0.info, &v1), 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::not_time_yet(arg2));
        let v2 = 0x1::string::utf8(b"status");
        ...
        assert!(v3, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::already_closed(arg2));
        ...
        *0x1::vector::borrow_mut<u64>(&mut v0.user_share_supply, 7) = v24;
        ...
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"refresh"), 0x2::vec_map::from_keys_values<0x1::string::String, u64>(v51, v54), 0x2::vec_map::empty<0x1::string::String, vector<u8>>());
    }
    ...
    public fun remove_reward_token<T0>(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        assert!(v2, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::invalid_token(arg2));
        ...
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"remove_reward_token"), 0x2::vec_map::from_keys_values<0x1::string::String, u64>(v11, v14), 0x2::vec_map::from_keys_values<0x1::string::String, vector<u8>>(v16, v18));
        0x2::dynamic_field::remove<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::type_name::with_defining_ids<T0>())
    }
    ...
    entry fun resume_transaction(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: &0x2::tx_context::TxContext) {
        ...
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"resume_transaction"), 0x2::vec_map::empty<0x1::string::String, u64>(), 0x2::vec_map::empty<0x1::string::String, vector<u8>>());
    }
    ...
    entry fun set_reward_token<T0>(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(!v2, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::invalid_token(arg2));
        0x1::vector::push_back<0x1::type_name::TypeName>(&mut v0.reward_tokens, 0x1::type_name::with_defining_ids<T0>());
        ...
        0x2::dynamic_field::add<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::type_name::with_defining_ids<T0>(), 0x2::balance::zero<T0>());
        let v11 = 0x1::vector::empty<0x1::string::String>();
        let v12 = &mut v11;
        0x1::vector::push_back<0x1::string::String>(v12, 0x1::string::utf8(b"index"));
        0x1::vector::push_back<0x1::string::String>(v12, 0x1::string::utf8(b"round"));
        ...
        let v18 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v18, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v17));
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"set_reward_token"), 0x2::vec_map::from_keys_values<0x1::string::String, u64>(v11, v14), 0x2::vec_map::from_keys_values<0x1::string::String, vector<u8>>(v16, v18));
    }
    ...
    public fun snapshot(arg0: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::TypusLeaderboardRegistry, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::TypusUserRegistry, arg3: &mut 0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg4: &mut Registry, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_user_event(0x1::string::utf8(b"snapshot"), 0x2::vec_map::from_keys_values<0x1::string::String, u64>(v5, v8), 0x2::vec_map::empty<0x1::string::String, vector<u8>>());
        0x2::dynamic_field::add<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::ManagerCap>(&mut arg4.id, 0x1::string::utf8(b"typus_manager_cap"), v0);
    }
    ...
    entry fun suspend_transaction(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: &0x2::tx_context::TxContext) {
        ...
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"suspend_transaction"), 0x2::vec_map::empty<0x1::string::String, u64>(), 0x2::vec_map::empty<0x1::string::String, vector<u8>>());
    }

    fun token_type_check<T0, T1>(arg0: &Vault) {
        if (0x1::type_name::with_defining_ids<T0>() == arg0.main_token && 0x1::type_name::with_defining_ids<T1>() == arg0.hedge_token) {
            return
        } else {
            let v0 = 0x1::string::utf8(b"index");
            abort 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::invalid_token(*0x2::vec_map::get<0x1::string::String, u64>(&arg0.info, &v0))
        };
    }
    ...
    entry fun update_hedge_ratio(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        *0x2::vec_map::get_mut<0x1::string::String, u64>(&mut v1.config, &v5) = arg4;
        ...
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"update_hedge_ratio"), v0, 0x2::vec_map::empty<0x1::string::String, vector<u8>>());
    }
    ...
    entry fun update_vault_config(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x1::string::String, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        *0x2::vec_map::get_mut<0x1::string::String, u64>(&mut v1.config, &arg3) = arg4;
        ...
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"update_vault_config"), v0, 0x2::vec_map::empty<0x1::string::String, vector<u8>>());
    }
    ...
    entry fun update_vault_info(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x1::string::String, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        *0x2::vec_map::get_mut<0x1::string::String, u64>(&mut v1.info, &arg3) = arg4;
        ...
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"update_vault_info"), v0, 0x2::vec_map::empty<0x1::string::String, vector<u8>>());
    }
    ...
    public fun withdraw_hedge_token<T0: drop, T1>(arg0: T0, arg1: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg2: &mut Registry, arg3: u64, arg4: 0x1::option::Option<u64>, arg5: &0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, vector<u64>) {
        ...
        assert!(0x2::balance::value<T1>(v4) >= *0x1::vector::borrow<u64>(&v3.user_share_supply, 5) + *0x1::vector::borrow<u64>(&v3.user_share_supply, 7) + v5, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::invalid_amount(arg3));
        ...
        let v12 = 0x1::type_name::with_defining_ids<T1>();
        let v13 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v13, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v12));
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"withdraw_hedge_token"), 0x2::vec_map::from_keys_values<0x1::string::String, u64>(v6, v9), 0x2::vec_map::from_keys_values<0x1::string::String, vector<u8>>(v11, v13));
    ...
    public fun withdraw_main_token<T0: drop, T1>(arg0: T0, arg1: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg2: &mut Registry, arg3: u64, arg4: 0x1::option::Option<u64>, arg5: &0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, vector<u64>) {
        ...
        let v13 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v13, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v12));
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"withdraw_main_token"), 0x2::vec_map::from_keys_values<0x1::string::String, u64>(v6, v9), 0x2::vec_map::from_keys_values<0x1::string::String, vector<u8>>(v11, v13));
        let v14 = 0x1::string::utf8(b"round");
        let v15 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v15, *0x2::vec_map::get<0x1::string::String, u64>(&v3.info, &v14));
        (0x2::balance::split<T1>(v4, v5), v15)
    ...
    public fun withdraw_other_token<T0: drop, T1>(arg0: T0, arg1: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg2: &mut Registry, arg3: u64, arg4: 0x1::option::Option<u64>, arg5: &0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, vector<u64>) {
        ...
        assert!(0x1::vector::contains<vector<u8>>(&v0, &v2), 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::invalid_witness(arg3));
        let v3 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg2.id, arg3);
        let v4 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut v3.id, 0x1::type_name::with_defining_ids<T1>());
        let v5 = if (0x1::option::is_some<u64>(&arg4)) {
            0x1::option::destroy_some<u64>(arg4)
        } else {
            0x2::balance::value<T1>(v4)
        };
        assert!(0x2::balance::value<T1>(v4) >= v5, 0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::error::invalid_amount(arg3));
        let v6 = 0x1::vector::empty<0x1::string::String>();
        let v7 = &mut v6;
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"index"));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"round"));
        ...
        let v13 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v13, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v12));
        0x15f0d9c093179f38ec90b20ac336750f82921730c25fed63e951d37a1a542bf0::event::emit_manager_event(0x1::string::utf8(b"withdraw_other_token"), 0x2::vec_map::from_keys_values<0x1::string::String, u64>(v6, v9), 0x2::vec_map::from_keys_values<0x1::string::String, vector<u8>>(v11, v13));
        let v14 = 0x1::string::utf8(b"round");
        let v15 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v15, *0x2::vec_map::get<0x1::string::String, u64>(&v3.info, &v14));
        (0x2::balance::split<T1>(v4, v5), v15)
