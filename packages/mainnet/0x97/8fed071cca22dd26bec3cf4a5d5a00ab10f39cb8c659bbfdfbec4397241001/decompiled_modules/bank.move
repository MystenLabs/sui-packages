module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::bank {
    ...
    entry fun deposit<T0>(arg0: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::ProtocolConfig, arg1: &mut Bank<T0>, arg2: &mut 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::sub_accounts::TxIndexer, arg3: vector<u8>, arg4: address, arg5: u64, arg6: 0x2::coin::Coin<T0>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        deposit_internal<T0>(arg1, arg4, arg5, arg6, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::sub_accounts::validate_unique_tx(arg2, arg3), arg7);
    }
    ...
    public(friend) fun deposit_internal<T0>(arg0: &mut Bank<T0>, arg1: address, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: u128, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg2 > 0, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::deposit_amount_must_be_greater_than_zero());
        assert!(arg2 <= v2, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::coin_does_not_have_enough_amount());
        ...
        let v4 = 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::convert_usdc_to_base_decimals((arg2 as u128));
        *v3 = v4 + *v3;
        if (arg2 < v2) {
    ...
    entry fun withdraw<T0>(arg0: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::ProtocolConfig, arg1: &mut Bank<T0>, arg2: &mut 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::sub_accounts::TxIndexer, arg3: vector<u8>, arg4: address, arg5: u128, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::convert_usdc_to_base_decimals(arg5);
        let v3 = &mut 0x2::table::borrow_mut<address, BankAccount>(v1, v0).balance;
        assert!(*v3 >= v2, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::not_enough_balance_in_bank(3));
        *v3 = *v3 - v2;
