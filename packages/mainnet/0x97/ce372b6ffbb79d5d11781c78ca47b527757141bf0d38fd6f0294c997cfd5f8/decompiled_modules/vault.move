module 0x97ce372b6ffbb79d5d11781c78ca47b527757141bf0d38fd6f0294c997cfd5f8::vault {
    ...
    public fun add_objects<T0: store + key>(arg0: &mut Vault, arg1: u64, arg2: vector<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 < arg1 * arg0.max_receivers, 9223372784179478535);
    ...
    fun assert_sender_is_vault_creator(arg0: &0x2::tx_context::TxContext, arg1: &Vault) {
        assert!(sender_is_vault_creator(arg0, arg1), 9223372401927127043);
    }

    fun assert_sender_is_vault_manager(arg0: &0x2::tx_context::TxContext, arg1: &Vault) {
        assert!(sender_is_vault_manager(arg0, arg1), 9223372449171898373);
    }
    ...
    public fun destroy_empty_vault(arg0: Vault, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v3;
        let v7 = v0;
        assert!(0x2::object_bag::length(&v6) == 0, 9223373424129212417);
        assert!(v1 == v2, 9223373441309081601);
