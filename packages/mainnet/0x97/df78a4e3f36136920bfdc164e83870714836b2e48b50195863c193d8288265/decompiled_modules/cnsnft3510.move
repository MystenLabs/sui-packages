module 0x97df78a4e3f36136920bfdc164e83870714836b2e48b50195863c193d8288265::cnsnft3510 {
    struct CNSNFT3510 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3510, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3510>(arg0, arg1);
