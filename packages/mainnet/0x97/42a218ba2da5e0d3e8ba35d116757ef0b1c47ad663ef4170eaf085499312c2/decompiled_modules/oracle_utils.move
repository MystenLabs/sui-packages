module 0x9742a218ba2da5e0d3e8ba35d116757ef0b1c47ad663ef4170eaf085499312c2::oracle_utils {
    ...
    public fun calculate_amplitude(arg0: u256, arg1: u256) : u64 {
        ...
        if (v0 > 0x2::address::max() / (0x9742a218ba2da5e0d3e8ba35d116757ef0b1c47ad663ef4170eaf085499312c2::oracle_constants::multiple() as u256)) {
            return 18446744073709551615
        };
        let v1 = v0 * (0x9742a218ba2da5e0d3e8ba35d116757ef0b1c47ad663ef4170eaf085499312c2::oracle_constants::multiple() as u256) / arg0;
