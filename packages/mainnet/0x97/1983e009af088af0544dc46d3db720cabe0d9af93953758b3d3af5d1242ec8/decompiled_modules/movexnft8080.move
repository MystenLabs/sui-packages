module 0x971983e009af088af0544dc46d3db720cabe0d9af93953758b3d3af5d1242ec8::movexnft8080 {
    struct MOVEXNFT8080 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT8080, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT8080>(arg0, arg1);
