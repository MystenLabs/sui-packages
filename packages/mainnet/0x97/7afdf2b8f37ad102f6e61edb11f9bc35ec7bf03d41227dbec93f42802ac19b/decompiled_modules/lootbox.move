module 0x977afdf2b8f37ad102f6e61edb11f9bc35ec7bf03d41227dbec93f42802ac19b::lootbox {
    ...
    struct LootboxSettingForCoinRewardAdded has copy, drop {
        category_id: 0x2::object::ID,
        house_id: 0x2::object::ID,
        coin_amount: u64,
        portion: u64,
    ...
    struct LootboxOpenedWithCoinReward<phantom T0> has copy, drop {
        lootbox_id: 0x2::object::ID,
        opened_at: u64,
        coin_amount: u64,
    }
    ...
    struct LootboxSetting has drop, store {
        type: u8,
        portion: u64,
        coin_amount: 0x1::option::Option<u64>,
    ...
    public entry fun add_lootbox_setting_for_coin_reward<T0>(arg0: &AdminCap, arg1: &mut House<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LootboxSetting{
            type        : 0,
            portion     : arg4,
            coin_amount : 0x1::option::some<u64>(arg3),
            nft_group   : 0x1::option::none<0x1::string::String>(),
        };
        0x1::vector::push_back<LootboxSetting>(&mut v0.lootbox_settings, v1);
        let v2 = LootboxSettingForCoinRewardAdded{
            category_id : 0x2::object::uid_to_inner(&v0.id),
            house_id    : 0x2::object::uid_to_inner(&arg1.id),
            coin_amount : arg3,
            portion     : arg4,
        };
        0x2::event::emit<LootboxSettingForCoinRewardAdded>(v2);
    }

    public entry fun add_lootbox_setting_for_nft_reward<T0>(arg0: &AdminCap, arg1: &mut House<T0>, arg2: u64, arg3: 0x1::string::String, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::borrow_mut<LootboxCategory>(&mut arg1.lootbox_categories, arg2);
        assert!(get_all_portions(&v0.lootbox_settings, arg4) <= 10000, 0);
        let v1 = LootboxSetting{
            type        : 1,
            portion     : arg4,
            coin_amount : 0x1::option::none<u64>(),
    ...
    public entry fun assign_nft_to_group<T0: store + key, T1>(arg0: &AdminCap, arg1: &mut House<T1>, arg2: T0, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun buy_lootbox<T0>(arg0: &mut House<T0>, arg1: vector<u8>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = get_category_index_by_id<T0>(arg0, arg3);
        assert!(v0, 1);
        let v2 = get_category_by_index<T0>(arg0, v1);
        assert!(0x2::object::uid_to_inner(&v2.id) == arg3, 2);
        assert!(v2.price == 0x2::coin::value<T0>(&arg2), 4);
    ...
    public entry fun change_lootbox_category_price<T0>(arg0: &AdminCap, arg1: &mut House<T0>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::borrow_mut<LootboxCategory>(&mut arg1.lootbox_categories, arg2);
        v0.price = arg3;
    ...
    public entry fun create_house<T0>(arg0: &AdminCap, arg1: vector<u8>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = HouseCreated{
            ...
            pub_key          : arg1,
            init_fund_amount : 0x2::coin::value<T0>(&arg2),
        };
        0x2::event::emit<HouseCreated>(v2);
    }

    public entry fun create_lootbox_category<T0>(arg0: &AdminCap, arg1: &mut House<T0>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun delete_lootbox_category<T0>(arg0: &AdminCap, arg1: &mut House<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let LootboxCategory {
            id               : v0,
            name             : _,
            nft_type         : _,
    ...
    public entry fun get_back_nft<T0: store + key, T1>(arg0: &AdminCap, arg1: &mut House<T1>, arg2: 0x1::string::String, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<T0>(0x2::bag::remove<0x2::object::ID, T0>(&mut arg1.nft_containers, nft_id_for_group_at_index<T1>(arg1, arg2, arg3)), 0x2::tx_context::sender(arg4));
    ...
    public fun get_category_by_index<T0>(arg0: &House<T0>, arg1: u64) : &LootboxCategory {
        0x1::vector::borrow<LootboxCategory>(&arg0.lootbox_categories, arg1)
    }

    public fun get_category_id_by_index<T0>(arg0: &House<T0>, arg1: u64) : 0x2::object::ID {
        0x2::object::uid_to_inner(&0x1::vector::borrow<LootboxCategory>(&arg0.lootbox_categories, arg1).id)
    }

    public fun get_category_index_by_id<T0>(arg0: &House<T0>, arg1: 0x2::object::ID) : (bool, u64) {
        let v0 = 0;
    ...
    public fun lootbox_exists<T0>(arg0: &House<T0>, arg1: 0x2::object::ID) : bool {
        0x2::dynamic_object_field::exists_with_type<0x2::object::ID, Lootbox>(&arg0.id, arg1)
    }

    public fun nft_at_id<T0: store + key, T1>(arg0: &House<T1>, arg1: 0x2::object::ID) : &T0 {
        0x2::bag::borrow<0x2::object::ID, T0>(&arg0.nft_containers, arg1)
    }

    public fun nft_group<T0>(arg0: &House<T0>, arg1: 0x1::string::String) : &vector<0x2::object::ID> {
        0x2::table::borrow<0x1::string::String, vector<0x2::object::ID>>(&arg0.nft_groups, arg1)
    }

    public fun nft_id_for_group_at_index<T0>(arg0: &House<T0>, arg1: 0x1::string::String, arg2: u64) : 0x2::object::ID {
        *0x1::vector::borrow<0x2::object::ID>(nft_group<T0>(arg0, arg1), arg2)
    }

    public entry fun open_lootbox<T0: store + key, T1>(arg0: &mut House<T1>, arg1: &mut Lootbox, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = house_pub_key<T1>(arg0);
        assert!(0x2::ed25519::ed25519_verify(&arg2, &v1, &v0), 6);
        let v2 = 0x2::hash::blake2b256(&arg2);
        let (v3, v4) = get_category_index_by_id<T1>(arg0, arg1.lootbox_category_id);
        assert!(v3, 1);
        let v5 = get_category_by_index<T1>(arg0, v4);
        ...
        if (v7) {
            ...
            if (v9.type == 1) {
                ...
                let v12 = nft_id_for_group_at_index<T1>(arg0, *v11, 0);
                ...
                let v14 = v9.coin_amount;
                assert!(!0x1::option::is_none<u64>(&v14), 8);
                let v15 = 0x1::option::borrow<u64>(&v14);
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.pool, *v15), arg4), arg1.player);
                let v16 = LootboxOpenedWithCoinReward<T1>{
                    lootbox_id  : 0x2::object::uid_to_inner(&arg1.id),
                    opened_at   : 0x2::clock::timestamp_ms(arg3),
                    coin_amount : *v15,
                };
                0x2::event::emit<LootboxOpenedWithCoinReward<T1>>(v16);
            };
        } else {
    ...
    public entry fun remove_lootbox_setting_at_index<T0>(arg0: &AdminCap, arg1: &mut House<T0>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::borrow_mut<LootboxCategory>(&mut arg1.lootbox_categories, arg2);
    ...
    public entry fun top_up<T0>(arg0: &AdminCap, arg1: &mut House<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
