module 0x971f327bfce7e1ea4d2709fa2513fa1a9e569c282abaefdb9523c93ab4fc1928::reward1274 {
    struct REWARD1274 has drop {
        dummy_field: bool,
    }

    struct TICKET_1274 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1274(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1274>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1274>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1274, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1274>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1274>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1274>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1274>>(v5, 0x2::tx_context::sender(arg1));
    }
