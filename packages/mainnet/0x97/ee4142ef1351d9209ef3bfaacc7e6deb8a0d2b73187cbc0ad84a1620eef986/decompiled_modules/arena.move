module 0x97ee4142ef1351d9209ef3bfaacc7e6deb8a0d2b73187cbc0ad84a1620eef986::arena {
    ...
    struct ArenaPoolCreateEvent has copy, drop {
        arena_pool_id: 0x2::object::ID,
    ...
    struct ArenaPoolDeleteEvent has copy, drop {
        arena_pool_id: 0x2::object::ID,
        created_by: address,
        created_at: u64,
    }

    struct PoolDetailCreateEvent has copy, drop {
        pool_id: 0x2::object::ID,
        pool_index: u32,
        arena_pool_id: 0x2::object::ID,
        cost_in_usd: u32,
    ...
    struct PoolConfigUpdateEvent has copy, drop {
        owner: address,
        expired_ms: u64,
        fee_cut: u32,
        fund_addr: address,
    ...
    struct PauseSystemEvent has copy, drop {
        value: bool,
        updated_by: address,
        updated_at: u64,
    }

    struct PoolWinnerEvent has copy, drop {
        pool_id: 0x2::object::ID,
        pool_type: u16,
        winner: address,
        amount: u64,
    ...
    struct PoolOwnerCutEvent has copy, drop {
        pool_id: 0x2::object::ID,
        receiver: address,
        amount: u64,
        created_at: u64,
    ...
    public fun changeExpiredDaysConfig(arg0: &mut PoolConfig, arg1: u32, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(has_right(arg0, arg2), 3);
        assert!(arg1 > 1, 6);
        assert!(arg1 < 30, 5);
        arg0.expired_ms = (arg1 as u64) * 86400000;
    ...
    public fun changeFeeConfig(arg0: &mut PoolConfig, arg1: u32, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(has_right(arg0, arg2), 3);
        arg0.fee_cut = arg1;
        let v0 = PoolConfigUpdateEvent{
            owner      : arg0.owner,
    ...
    fun fee_owner_cut<T0>(arg0: &mut ArenaPool<T0>, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        let v0 = arg0.fund_addr;
        let v1 = 0x2::balance::value<T0>(&arg0.treasury);
        let v2 = ((v1 * (arg0.fee_cut as u64) / 100) as u64);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.treasury, v2, arg3), v0);
        let v3 = PoolOwnerCutEvent{
            pool_id    : arg1,
            receiver   : v0,
            amount     : v2,
            created_at : arg2,
        };
        0x2::event::emit<PoolOwnerCutEvent>(v3);
        (v2, v1 - v2)
    }
    ...
    public fun getPoolData<T0>(arg0: &ArenaPool<T0>, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) : (0x2::object::ID, u32, u32, u64, u32, u32, u64, bool) {
        get_pool_data<T0>(arg0, arg1)
    }

    public fun getPoolDataByIndex<T0>(arg0: &ArenaPool<T0>, arg1: u32, arg2: &0x2::tx_context::TxContext) : (0x2::object::ID, u32, u32, u64, u32, u32, u64, bool) {
    ...
    fun get_pool_data<T0>(arg0: &ArenaPool<T0>, arg1: 0x2::object::ID) : (0x2::object::ID, u32, u32, u64, u32, u32, u64, bool) {
        assert!(pool_exists<T0>(arg0, arg1), 15);
        let v0 = get_pool<T0>(arg0, arg1);
        (v0.arena_pool_id, v0.pool_index, v0.cost_in_usd, v0.raised_amount, v0.num_users, v0.winner, v0.expired_at, v0.is_claimed)
    }
    ...
    fun get_price_token_bps<T0, T1>(arg0: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg1: u16, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x2::coin::CoinMetadata<T1>) : u64 {
        if (arg1 == 0) {
            let (v0, v1) = 0x4dcb1a74837e2cb655c89155451242985020d9916b0a8374f0e1476500f7f105::prices::get_price<T0, T1>(arg0);
            return v1 * 0x2::math::pow(10, 0x2::coin::get_decimals<T1>(arg3)) * 1000 / v0 * 0x2::math::pow(10, 0x2::coin::get_decimals<T0>(arg2))
        };
        let (v2, v3) = 0x4dcb1a74837e2cb655c89155451242985020d9916b0a8374f0e1476500f7f105::prices::get_price<T1, T0>(arg0);
        v2 * 0x2::math::pow(10, 0x2::coin::get_decimals<T1>(arg3)) * 1000 / v3 * 0x2::math::pow(10, 0x2::coin::get_decimals<T0>(arg2))
    }
    ...
    entry fun joinPool<T0, T1>(arg0: &PoolConfig, arg1: &mut ArenaPool<T0>, arg2: u32, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &0x2::random::Random, arg6: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg7: u16, arg8: &0x2::coin::CoinMetadata<T0>, arg9: &0x2::coin::CoinMetadata<T1>, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 17);
        assert!(!arg1.is_deleted, 14);
        assert!(check_cost_support(arg0, arg2), 13);
        let v0 = check_and_create_pool<T0>(arg0, arg1, arg2, 0x2::clock::timestamp_ms(arg4), arg10);
        let v1 = 0;
        if (arg0.is_check_price == true) {
            v1 = get_price_token_bps<T0, T1>(arg6, arg7, arg8, arg9);
        };
        join_pool<T0>(arg1, v0, arg3, v1, 0x2::clock::timestamp_ms(arg4), arg5, arg10);
    }
    ...
    fun join_pool<T0>(arg0: &mut ArenaPool<T0>, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: &0x2::random::Random, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg3 > 0) {
            let v4 = (v3.cost_in_usd as u64) * 1000 / arg3;
            assert!(v2 + v4 * 1 / 100 >= v4, 6);
        };
        let v5 = v3.raised_amount + v2;
        let v6 = v3.num_users + 1;
        v3.num_users = v6;
        v3.raised_amount = v5;
        0x1::vector::push_back<address>(&mut v3.users_map, v0);
        0x2::table::add<address, u64>(&mut v3.user_amounts_map, v0, v2);
        let v7 = get_max_player(v1);
        let v8 = JoinEvent{
            pool_id       : arg1,
            raised_amount : v5,
            user          : v0,
    ...
    fun new_arena_pool<T0>(arg0: 0x2::object::ID, arg1: vector<u8>, arg2: address, arg3: u64, arg4: u16, arg5: u32, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = ArenaPool<T0>{
            ...
            pool_index_map : 0x2::table::new<u32, 0x2::object::ID>(arg6),
            is_deleted     : false,
        };
    ...
    fun random_winner<T0>(arg0: &0x2::random::Random, arg1: &mut ArenaPool<T0>, arg2: 0x2::object::ID, arg3: address, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x97ee4142ef1351d9209ef3bfaacc7e6deb8a0d2b73187cbc0ad84a1620eef986::random::get_lucky_number(arg0, 0, v0.num_users, arg5);
        let v2 = *0x1::vector::borrow<address>(&v0.users_map, (v1 as u64));
        v0.winner = v1 + 1;
        let (_, v4) = fee_owner_cut<T0>(arg1, arg2, arg4, arg5);
