module 0x979e9bbb7665364b21f940b5a6b87ab981129cc03ff4cb8b34ada613bb2e5989::slarfy {
    struct SLARFY has drop {
        dummy_field: bool,
    }

    public entry fun burn(arg0: &mut 0x2::coin::TreasuryCap<SLARFY>, arg1: 0x2::coin::Coin<SLARFY>) {
        0x2::coin::burn<SLARFY>(arg0, arg1);
    }

    fun mint_and_transfer(arg0: &mut 0x2::coin::TreasuryCap<SLARFY>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::mint_and_transfer<SLARFY>(arg0, arg1, arg2, arg3);
    }
