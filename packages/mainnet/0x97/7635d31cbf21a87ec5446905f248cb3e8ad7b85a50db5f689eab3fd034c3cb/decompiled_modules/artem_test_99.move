module 0x977635d31cbf21a87ec5446905f248cb3e8ad7b85a50db5f689eab3fd034c3cb::artem_test_99 {
    struct ARTEM_TEST_99 has drop {
        dummy_field: bool,
    }

    fun init(arg0: ARTEM_TEST_99, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ARTEM_TEST_99>(arg0, 6, b"ARTEM_TEST_99", b"ARTEM test coin", b"to the moon", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://lavender-gentle-primate-223.mypinata.cloud/ipfs/Qme31MiTozmuadZbegQNq4X1fThLtcw7mPKzePjvdEFcSJ?pinataGatewayToken=M45Jh03NicrVqTZJJhQIwDtl7G6fGS90bjJiIQrmyaQXC_xXj4BgRqjjBNyGV7q2")), arg1);
        let v2 = v0;
