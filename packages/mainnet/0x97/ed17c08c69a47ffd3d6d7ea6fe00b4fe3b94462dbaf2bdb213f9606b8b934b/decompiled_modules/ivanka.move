module 0x97ed17c08c69a47ffd3d6d7ea6fe00b4fe3b94462dbaf2bdb213f9606b8b934b::ivanka {
    ...
    fun init(arg0: IVANKA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<IVANKA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"IVANKA  ")))), trim_right(b"Ivanka TrumpMeme                "), trim_right(b"Trump daughter Ivanka Trump Women represent 46 percent of the totalU.S. labor force.                                                                                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
