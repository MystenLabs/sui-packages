module 0x97351363a2490bd81a43a15acfe33e17194f7f42e50ad03b987f73b1eef3935a::cnsnft5470 {
    struct CNSNFT5470 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5470, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8260"));
        let v4 = 0x2::package::claim<CNSNFT5470>(arg0, arg1);
