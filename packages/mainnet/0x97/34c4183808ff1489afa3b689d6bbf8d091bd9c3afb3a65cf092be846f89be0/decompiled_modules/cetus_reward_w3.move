module 0x9734c4183808ff1489afa3b689d6bbf8d091bd9c3afb3a65cf092be846f89be0::cetus_reward_w3 {
    struct CETUS_REWARD_W3 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = CETUS_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmPQPzFT5kh9A1uWsr3ZHfgRn7Mkg325dar3Zi9cco7yfW"),
            };
    ...
    fun init(arg0: CETUS_REWARD_W3, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmPQPzFT5kh9A1uWsr3ZHfgRn7Mkg325dar3Zi9cco7yfW"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        let v4 = 0x2::package::claim<CETUS_REWARD_W3>(arg0, arg1);
