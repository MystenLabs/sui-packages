module 0x97e7cb048c7d6cda88fdecfae6f7e740028b0e19ac1475a4520a033bebb2af79::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"eye1", b"eye of all seeing", b"now you see me, now you...", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-13T05-07-59.824Z-eye.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"eye of all seeing"),
            symbol     : 0x1::string::utf8(b"eye1"),
            decimals   : 9,
