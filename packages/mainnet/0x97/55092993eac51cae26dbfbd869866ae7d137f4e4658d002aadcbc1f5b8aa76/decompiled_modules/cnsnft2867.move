module 0x9755092993eac51cae26dbfbd869866ae7d137f4e4658d002aadcbc1f5b8aa76::cnsnft2867 {
    struct CNSNFT2867 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2867, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://rwdsuinet-1125img-0793.vercel.app/api/{id}"));
        ...
        let v4 = 0x2::package::claim<CNSNFT2867>(arg0, arg1);
