module 0x97d079a229ddb5bbbb7c83c45fe54d0877c9a14c2050e8088115a1fef7b56e3e::cnsnft4828 {
    struct CNSNFT4828 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4828, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8221"));
        let v4 = 0x2::package::claim<CNSNFT4828>(arg0, arg1);
