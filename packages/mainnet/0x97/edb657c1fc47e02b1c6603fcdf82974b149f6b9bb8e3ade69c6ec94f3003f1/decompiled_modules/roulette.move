module 0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::roulette {
    ...
    struct Game<phantom T0> has store, key {
        ...
        max_risk: u64,
        risk_manager: 0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::risk_manager::RiskManager,
        min_bet_size: u64,
        result_roll: u64,
    ...
    public fun close_game<T0>(arg0: &mut 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::UniHouse, arg1: &mut RouletteConfig<T0>, arg2: &0x2::clock::Clock, arg3: vector<u8>) {
        ...
        v1.result_roll = v4;
        v1.status = 1;
        0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::roulette_events::emit_game_closed<T0>(v5, v2, v4);
        let v6 = 0x2::table_vec::is_empty<Bet<T0>>(&v1.bets);
        if (v6) {
            v1.status = 3;
            0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::roulette_events::emit_game_completed<T0>(v5, v2);
        };
        if (v6) {
            let v7 = Roulette{dummy_field: false};
            0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::join<T0, Roulette>(v7, arg0, delete_bets_internal<T0>(arg1, v5, 0));
        };
    }
    ...
    public fun create_game<T0>(arg0: &mut 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::UniHouse, arg1: &mut RouletteConfig<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v4 = Game<T0>{
            ...
            max_risk           : v1,
            risk_manager       : 0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::risk_manager::new_manager(),
            min_bet_size       : arg1.min_bet_size,
            result_roll        : 38,
            settled_bets_count : 0,
            player_bets_table  : 0x2::table::new<address, vector<BetDisplay<T0>>>(arg3),
            fund               : 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::split<T0, Roulette>(v2, arg0, v1),
        ...
        0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::roulette_events::emit_game_created<T0>(v3, v5);
        v3
    }
    ...
    public fun max_risk<T0>(arg0: &0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::UniHouse) : u64 {
        0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::house::max_risk<T0, Roulette>(0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::borrow_house<T0>(arg0))
    }

    public fun place_bet<T0>(arg0: &mut 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::UniHouse, arg1: &mut RouletteConfig<T0>, arg2: &0x2::clock::Clock, arg3: 0x2::coin::Coin<T0>, arg4: u8, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<0x1::string::String>, arg7: 0x1::option::Option<0x2::object::ID>, arg8: 0x1::option::Option<0x1::string::String>, arg9: &mut 0x2::tx_context::TxContext) : 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::receipt::GameReceipt<T0, Roulette> {
        assert!(arg4 < 13, 3);
        if (arg4 == 2) {
        ...
        let (_, _) = 0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::risk_manager::add_risk(&mut v1.risk_manager, arg4, arg5, 0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::bet_manager::get_bet_payout(v0, arg4));
        let v4 = borrow_current_game_mut<T0>(arg1);
        assert!(0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::risk_manager::total_risk(&v4.risk_manager) <= v4.max_risk, 0);
        ...
        0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::roulette_events::emit_place_bet<T0>(v4.round, 0x2::object::id<Game<T0>>(v4), v8, v6.bet_type, v6.bet_number, v7, v6.player);
        ...
        0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::add_volume<T0, Roulette>(v11, arg0, v0, arg9);
        0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::new_game_receipt<T0, Roulette>(v11, arg0, v0)
    }
    ...
    public fun settle_bets<T0>(arg0: &mut 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::UniHouse, arg1: &mut RouletteConfig<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        if (!game_exists<T0>(arg1, arg2)) {
            return
        };
        let v0 = borrow_game_mut<T0>(arg1, arg2);
        ...
        let v5 = 0x1::vector::empty<0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::roulette_events::BetResult<T0>>();
        v0.status = 2;
        let v6 = v0.result_roll;
        while (v1 < v3) {
            let v7 = 0x2::table_vec::borrow_mut<Bet<T0>>(&mut v0.bets, v1);
            let v8 = 0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::bet_manager::won_bet(v7.bet_type, v6, v7.bet_number);
            if (arg5 != v8) {
                v1 = v1 + 1;
                continue
            };
            ...
            let v11 = 0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::bet_manager::get_bet_payout(v10, v7.bet_type);
            0x1::vector::push_back<0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::roulette_events::BetResult<T0>>(&mut v5, 0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::roulette_events::new_bet_result<T0>(*0x2::object::uid_as_inner(&v7.id), v8, v7.bet_type, v7.bet_number, v10, v7.player));
        ...
        0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::roulette_events::emit_game_settlement<T0>(arg2, v14, v6, v5);
        if (v0.settled_bets_count == v4) {
            v0.status = 3;
            let v15 = Roulette{dummy_field: false};
            0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::join<T0, Roulette>(v15, arg0, 0x2::balance::withdraw_all<T0>(&mut v0.fund));
            0x97edb657c1fc47e02b1c6603fcdf82974b149f6b9bb8e3ade69c6ec94f3003f1::roulette_events::emit_game_completed<T0>(v0.round, v14);
        };
    }

    public fun update_config<T0>(arg0: &AdminCap, arg1: &mut RouletteConfig<T0>, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64) {
        arg1.place_bet_interval = arg3;
        arg1.buffer_time = arg4;
        arg1.min_bet_size = arg5;
        arg1.pub_key = arg2;
    }
