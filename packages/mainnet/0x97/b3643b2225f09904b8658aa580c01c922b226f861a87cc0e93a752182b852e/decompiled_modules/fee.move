module 0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::fee {
    struct FEE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: FEE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = FeeManager{
            ...
            dao_creation_fee                      : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_dao_creation_fee(),
            proposal_creation_fee_per_outcome     : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_proposal_fee_per_outcome(),
            launchpad_creation_fee                : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_launchpad_creation_fee(),
            ...
            dao_fee_baseline                      : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_dao_creation_fee(),
            proposal_fee_baseline                 : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_proposal_fee_per_outcome(),
            launchpad_fee_baseline                : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_launchpad_creation_fee(),
    ...
    fun max_allowed_from_baseline(arg0: u64) : u64 {
        if (arg0 > 18446744073709551615 / 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_fee_multiplier()) {
            18446744073709551615
        } else {
            arg0 * 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_fee_multiplier()
        }
    }
    ...
    public fun update_coin_creation_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 >= v0.creation_baseline_reset_timestamp + 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::six_months_ms()) {
        ...
        if (arg3 <= v0.dao_creation_fee) {
            ...
            v0.pending_creation_fee_effective_timestamp = 0x1::option::some<u64>(v1 + 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::six_months_ms());
        };
    }
    ...
    public fun update_coin_proposal_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, CoinFeeConfig>(&mut arg0.id, arg2);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        if (v1 >= v0.proposal_baseline_reset_timestamp + 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::six_months_ms()) {
        ...
        if (arg3 <= v0.proposal_creation_fee_per_outcome) {
            ...
            v0.pending_proposal_fee_effective_timestamp = 0x1::option::some<u64>(v1 + 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::six_months_ms());
        };
    }
    ...
    public entry fun update_dao_creation_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 >= arg0.dao_baseline_reset_ts + 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::six_months_ms()) {
        ...
        if (arg2 <= v1) {
            ...
            let v3 = v0 + 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::six_months_ms();
    ...
    public entry fun update_launchpad_creation_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        apply_pending_global_fees(arg0, arg3);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        if (v0 >= arg0.launchpad_baseline_reset_ts + 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::six_months_ms()) {
    ...
    public entry fun update_proposal_creation_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        apply_pending_global_fees(arg0, arg3);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        if (v0 >= arg0.proposal_baseline_reset_ts + 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::six_months_ms()) {
