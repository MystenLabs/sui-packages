module 0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::protective_bid_registry {
    ...
    public fun bid_count(arg0: &0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::Account, arg1: &0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::package_registry::PackageRegistry) : u64 {
        if (!has_registry(arg0)) {
            return 0
        };
        let v0 = ProtectiveBidKey{dummy_field: false};
        0x1::vector::length<ProtectiveBidRecord>(&0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::borrow_managed_data_with_package_witness<ProtectiveBidKey, ProtectiveBidRegistry>(arg0, arg1, v0, 0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::markets_core_version::current()).records)
    }

    public fun bid_ids(arg0: &0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::Account, arg1: &0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::package_registry::PackageRegistry) : vector<0x2::object::ID> {
        if (!has_registry(arg0)) {
            return 0x1::vector::empty<0x2::object::ID>()
        };
        let v0 = ProtectiveBidKey{dummy_field: false};
        let v1 = 0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::borrow_managed_data_with_package_witness<ProtectiveBidKey, ProtectiveBidRegistry>(arg0, arg1, v0, 0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::markets_core_version::current());
    ...
    fun clear_internal(arg0: &mut 0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::Account, arg1: &0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::package_registry::PackageRegistry, arg2: 0x2::object::ID) {
        ...
        let v0 = ProtectiveBidKey{dummy_field: false};
        let v1 = 0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::borrow_managed_data_mut_with_package_witness<ProtectiveBidKey, ProtectiveBidRegistry>(arg0, arg1, v0, 0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::markets_core_version::current());
        let v2 = 0;
    ...
    public fun has_registry(arg0: &0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::Account) : bool {
        let v0 = ProtectiveBidKey{dummy_field: false};
        0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::has_managed_data<ProtectiveBidKey>(arg0, v0)
    }
    ...
    fun set_internal(arg0: &mut 0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::Account, arg1: &0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::package_registry::PackageRegistry, arg2: 0x2::object::ID, arg3: 0x2::object::ID) {
        if (!has_registry(arg0)) {
            ...
            0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::add_managed_data_with_package_witness<ProtectiveBidKey, ProtectiveBidRegistry>(arg0, arg1, v3, v2, 0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::markets_core_version::current());
        } else {
            let v4 = ProtectiveBidKey{dummy_field: false};
            let v5 = 0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::borrow_managed_data_mut_with_package_witness<ProtectiveBidKey, ProtectiveBidRegistry>(arg0, arg1, v4, 0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::markets_core_version::current());
            assert!(0x1::vector::length<ProtectiveBidRecord>(&v5.records) < 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_protective_bids_per_dao(), 1);
