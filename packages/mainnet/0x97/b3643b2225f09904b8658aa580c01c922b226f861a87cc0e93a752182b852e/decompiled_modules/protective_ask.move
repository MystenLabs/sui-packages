module 0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::protective_ask {
    ...
    public fun buy_from_ask<T0: store, T1, T2, T3>(arg0: &mut ProtectiveAsk<T1, T2>, arg1: &mut 0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::Account, arg2: &0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::package_registry::PackageRegistry, arg3: &0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::unified_spot_pool::UnifiedSpotPool<T1, T2, T3>, arg4: 0x2::coin::Coin<T2>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::coin::Coin<T2>) {
        ...
        assert!(0x2::object::id<0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::Account>(arg1) == arg0.account_id, 4);
        assert!(0x2::object::id<0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::unified_spot_pool::UnifiedSpotPool<T1, T2, T3>>(arg3) == arg0.pool_id, 9);
        assert!(!0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::unified_spot_pool::is_locked_for_proposal<T1, T2, T3>(arg3), 8);
        ...
        assert!(arg5 > 0, 3);
        assert!(arg5 <= v0, 6);
        let v1 = 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::math::mul_div_mixed_up((arg0.price_per_token as u128), arg5, (0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::price_precision_scale() as u128));
        assert!(v1 <= 18446744073709551615, 16);
        let v2 = (v1 as u64);
        assert!(0x2::coin::value<T2>(&arg4) >= v2, 14);
        let v3 = 0x2::coin::into_balance<T2>(arg4);
        0x30705bcf8eb9c97dfd72e5abc1dde6bfde560972a4f44b5cd1cef8da7cf168b1::vault::deposit_approved<T0, T2>(arg1, arg2, 0x1::string::utf8(b"treasury"), 0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut v3, v2), arg7));
        ...
        (0x30705bcf8eb9c97dfd72e5abc1dde6bfde560972a4f44b5cd1cef8da7cf168b1::currency::mint_with_package_witness<T1>(arg1, arg2, arg5, 0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::markets_core_version::current(), arg7), 0x2::coin::from_balance<T2>(v3, arg7))
    }

    public fun cancel<T0, T1>(arg0: &mut ProtectiveAsk<T0, T1>, arg1: &mut 0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::Account, arg2: &0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::package_registry::PackageRegistry, arg3: 0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::spot_pool_mutation_auth::SpotPoolMutationAuth, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert!(0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::spot_pool_mutation_auth::target_id(&arg3) == arg0.pool_id, 13);
        assert!(arg0.active, 1);
        assert!(0x2::object::id<0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::Account>(arg1) == arg0.account_id, 4);
        arg0.active = false;
        0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::protective_ask_registry::clear_with_package_witness(arg1, arg2, 0x2::object::id<ProtectiveAsk<T0, T1>>(arg0));
        let v0 = AskReleased{
    ...
    public fun close<T0, T1>(arg0: &mut ProtectiveAsk<T0, T1>, arg1: &mut 0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::Account, arg2: &0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::package_registry::PackageRegistry, arg3: &0x2::clock::Clock) {
        assert!(arg0.active, 1);
    ...
    public fun create<T0, T1>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64, arg5: 0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::spot_pool_mutation_auth::SpotPoolMutationAuth, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : ProtectiveAsk<T0, T1> {
        assert!(arg3 > 0, 3);
        assert!(arg2 > 0, 19);
        assert!(0x97b3643b2225f09904b8658aa580c01c922b226f861a87cc0e93a752182b852e::spot_pool_mutation_auth::target_id(&arg5) == arg1, 13);
        let v0 = if (arg4 == 0) {
            0
        } else {
    ...
    public fun emergency_withdraw_stable<T0, T1>(arg0: &mut ProtectiveAsk<T0, T1>, arg1: &0x114056e12dc74d45933f12b3e4ecbe797dad06610b42c9b1af46fd885c3e6f3::emergency_cap::EmergencyCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
    ...
    public fun quote_buy<T0, T1>(arg0: &ProtectiveAsk<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock) : u64 {
        ...
        let v1 = 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::math::mul_div_mixed_up((arg0.price_per_token as u128), arg1, (0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::price_precision_scale() as u128));
