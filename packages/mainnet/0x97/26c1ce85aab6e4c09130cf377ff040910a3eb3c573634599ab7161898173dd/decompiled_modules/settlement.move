module 0x30288d1a3b55d3f1ba0c8413136c4ea2458806e570a23f6105d1507c00a6fe9f::settlement {
    ...
    public fun complete_fulfill<T0: drop>(arg0: &mut SettlementState, arg1: FulfillReceipt, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::tx_context::TxContext) {
        ...
        let v4 = b"0x";
        0x1::vector::append<u8>(&mut v4, 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>())));
        ...
        0x30288d1a3b55d3f1ba0c8413136c4ea2458806e570a23f6105d1507c00a6fe9f::events::emit_order_fulfilled(v0, 0, v5, v1, v3, 0x2::tx_context::sender(arg3));
    }
    ...
    public fun get_order_src_eid(arg0: &SettlementState, arg1: u64) : u32 {
        0x2::table::borrow<u64, SwapOrder>(&arg0.orders, arg1).src_eid
    }
    ...
    public fun lz_receive(arg0: &mut SettlementState, arg1: &0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp, arg2: 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Call<0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::LzReceiveParam, 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Void>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::table::contains<u64, SwapOrder>(&arg0.orders, v10), 0);
        let v14 = SwapOrder{
            cctp_nonce   : v10,
            output_token : v11,
            min_output   : v12,
        ...
        0x2::table::add<u64, SwapOrder>(&mut arg0.orders, v10, v14);
        0x30288d1a3b55d3f1ba0c8413136c4ea2458806e570a23f6105d1507c00a6fe9f::events::emit_swap_order_received(v10, v11, v12, v13, v0);
    }
    ...
    public fun withdraw_fallback<T0: drop>(arg0: &mut SettlementState, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x30288d1a3b55d3f1ba0c8413136c4ea2458806e570a23f6105d1507c00a6fe9f::events::emit_fallback_withdrawn(arg1, 0x2::coin::value<T0>(&arg2), v1);
    }
