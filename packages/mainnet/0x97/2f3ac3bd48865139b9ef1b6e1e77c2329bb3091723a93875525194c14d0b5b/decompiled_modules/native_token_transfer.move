module 0x972f3ac3bd48865139b9ef1b6e1e77c2329bb3091723a93875525194c14d0b5b::native_token_transfer {
    struct NativeTokenTransfer has copy, drop, store {
        amount: 0x972f3ac3bd48865139b9ef1b6e1e77c2329bb3091723a93875525194c14d0b5b::trimmed_amount::TrimmedAmount,
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : NativeTokenTransfer {
        assert!(0x972f3ac3bd48865139b9ef1b6e1e77c2329bb3091723a93875525194c14d0b5b::bytes4::to_bytes(0x972f3ac3bd48865139b9ef1b6e1e77c2329bb3091723a93875525194c14d0b5b::bytes4::take(arg0)) == x"994e5454", 13906834603840176130);
        ...
        NativeTokenTransfer{
            amount       : 0x972f3ac3bd48865139b9ef1b6e1e77c2329bb3091723a93875525194c14d0b5b::trimmed_amount::new(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_u64_be(arg0), 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_u8(arg0)),
    ...
    public fun to_bytes(arg0: NativeTokenTransfer) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v7, 0x972f3ac3bd48865139b9ef1b6e1e77c2329bb3091723a93875525194c14d0b5b::trimmed_amount::to_bytes(&v6));
    ...
    public fun destruct(arg0: NativeTokenTransfer) : (0x972f3ac3bd48865139b9ef1b6e1e77c2329bb3091723a93875525194c14d0b5b::trimmed_amount::TrimmedAmount, 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, u16, 0x1::option::Option<vector<u8>>) {
        let NativeTokenTransfer {
            amount       : v0,
            source_token : v1,
            to           : v2,
