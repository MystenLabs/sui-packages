module 0x974af8e76ab7655b142ac344ce550cfdf9a288f2d2b0e3deff46983c4d255954::init_order {
    ...
    public fun initialize_order<T0>(arg0: &mut 0x974af8e76ab7655b142ac344ce550cfdf9a288f2d2b0e3deff46983c4d255954::state::State, arg1: &0x2::coin::CoinMetadata<T0>, arg2: InitOrderTicket<T0>, arg3: 0x52646a9931b961c292e202dd8cd36351a9ac74912e71cdd6694e3515546b63c5::calculate_swift_fee::SwiftInitParams, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v21 = 0x974af8e76ab7655b142ac344ce550cfdf9a288f2d2b0e3deff46983c4d255954::amount::normalize_amount(0x2::balance::value<T0>(&v19), 0x2::coin::get_decimals<T0>(arg1));
        assert!(v21 > v8 + v9, 3);
        ...
        let v25 = 0x52646a9931b961c292e202dd8cd36351a9ac74912e71cdd6694e3515546b63c5::calculate_swift_fee::fee_rate_mayan(&arg3);
        assert!(v13 <= 50, 5);
        assert!(v25 <= 50, 4);
        if (v12 == @0x0) {
            assert!(v13 == 0, 5);
        };
        let v26 = 0x974af8e76ab7655b142ac344ce550cfdf9a288f2d2b0e3deff46983c4d255954::order::new(v0, v1, v22, v24, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v25, v14, v15, v16, v17, v18);
        let v27 = 0x974af8e76ab7655b142ac344ce550cfdf9a288f2d2b0e3deff46983c4d255954::order::to_hash(&v26);
        assert!(!0x974af8e76ab7655b142ac344ce550cfdf9a288f2d2b0e3deff46983c4d255954::state::has_source_order(arg0, v27), 1);
        assert!(!0x974af8e76ab7655b142ac344ce550cfdf9a288f2d2b0e3deff46983c4d255954::state::has_dest_order(arg0, v27), 1);
        let (v28, v29) = 0x974af8e76ab7655b142ac344ce550cfdf9a288f2d2b0e3deff46983c4d255954::state::add_source_order<T0>(arg0, v19, v27, v1, v24, v4, v8, v9, arg4);
