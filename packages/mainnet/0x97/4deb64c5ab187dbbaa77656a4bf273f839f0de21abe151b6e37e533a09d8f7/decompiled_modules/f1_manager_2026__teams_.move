module 0x974deb64c5ab187dbbaa77656a4bf273f839f0de21abe151b6e37e533a09d8f7::f1_manager_2026__teams_ {
    struct F1_MANAGER_2026__TEAMS_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: F1_MANAGER_2026__TEAMS_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<F1_MANAGER_2026__TEAMS_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"F1 Manager 2026 (Teams)"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A classic fantasy game is being launched on blockchain. Choose your team and get ready for the competition."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreificoe2dukmaqotsreqowzqo7co7kis36k76r7qkq3w5arcv4lf3q"));
