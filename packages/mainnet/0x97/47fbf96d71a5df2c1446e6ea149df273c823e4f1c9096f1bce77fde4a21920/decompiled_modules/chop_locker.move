module 0x9747fbf96d71a5df2c1446e6ea149df273c823e4f1c9096f1bce77fde4a21920::chop_locker {
    ...
    public fun calculate_apy<T0>(arg0: &0x2::balance::Balance<T0>, arg1: u64, arg2: &0x2::balance::Balance<T0>, arg3: u64) : u64 {
        ...
        let v0 = (0x2::balance::value<T0>(arg0) as u128) * (1000000 as u128) / (arg1 as u128) * (365 as u128) * (1000000 as u128) * 100 / 1;
        if (v0 > (50000000 as u128)) {
            ((v0 / 100000000) as u64)
        } else {
            (v0 as u64)
        }
