module 0x9722ee7f6d5d931cfef00313147cb52f1345261a47aafcb42808bff543d6ce00::tradewar {
    ...
    fun init(arg0: TRADEWAR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/4n9hNAcKNWXaGMgaViECTVG5WYHd1658FEHg1Cxhpump.png                                                                                                                                                                                                                               ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<TRADEWAR>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TRADEWAR  ")))), trim_right(b"Tariff War                      "), trim_right(b"Since President Dona                                                                                                                                                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
