module 0x970aec9b5d34c2953fc3dd7656b5eeed04099c902fe1e6a6f314e0113facc1fe::composition {
    ...
    public(friend) fun execute_pending(arg0: &mut Composition, arg1: &0x970aec9b5d34c2953fc3dd7656b5eeed04099c902fe1e6a6f314e0113facc1fe::oracle::OracleConfig, arg2: &0x2::clock::Clock) {
        assert!(!0x1::vector::is_empty<Pending>(&arg0.pending), 307);
    ...
    public(friend) fun propose(arg0: &mut Composition, arg1: &0x970aec9b5d34c2953fc3dd7656b5eeed04099c902fe1e6a6f314e0113facc1fe::oracle::OracleConfig, arg2: vector<0x1::type_name::TypeName>, arg3: vector<u64>, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
    ...
    public(friend) fun set_genesis(arg0: &mut Composition, arg1: &0x970aec9b5d34c2953fc3dd7656b5eeed04099c902fe1e6a6f314e0113facc1fe::oracle::OracleConfig, arg2: vector<0x1::type_name::TypeName>, arg3: vector<u64>, arg4: vector<u8>, arg5: &0x2::clock::Clock) {
    ...
    fun validate(arg0: &0x970aec9b5d34c2953fc3dd7656b5eeed04099c902fe1e6a6f314e0113facc1fe::oracle::OracleConfig, arg1: &vector<0x1::type_name::TypeName>, arg2: &vector<u64>) {
        ...
        while (v2 < v0) {
            ...
            assert!(v4 > 0, 300);
            assert!(v4 <= 4000, 301);
            assert!(0x970aec9b5d34c2953fc3dd7656b5eeed04099c902fe1e6a6f314e0113facc1fe::oracle::has_feed(arg0, v3), 306);
            assert!(!0x970aec9b5d34c2953fc3dd7656b5eeed04099c902fe1e6a6f314e0113facc1fe::oracle::is_breaker_tripped(arg0, v3), 312);
            let v5 = v2 + 1;
            while (v5 < v0) {
