module 0x97d75ee5d54839be753bdffe84ce1a8630e5f26d5d92aef068314ba7516db432::cnsnft2204 {
    struct CNSNFT2204 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2204, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2204>(arg0, arg1);
