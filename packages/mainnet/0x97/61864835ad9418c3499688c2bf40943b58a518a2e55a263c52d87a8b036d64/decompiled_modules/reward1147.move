module 0x9761864835ad9418c3499688c2bf40943b58a518a2e55a263c52d87a8b036d64::reward1147 {
    struct REWARD1147 has drop {
        dummy_field: bool,
    }

    struct TICKET_1147 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1147(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1147>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1147>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1147, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1147>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1147>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1147>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1147>>(v5, 0x2::tx_context::sender(arg1));
    }
