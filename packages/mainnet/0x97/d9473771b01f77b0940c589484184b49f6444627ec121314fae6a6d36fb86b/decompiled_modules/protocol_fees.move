module 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::protocol_fees {
    ...
    public(friend) fun claim_default_referral_fees(arg0: &mut ProtocolFees) : u64 {
        let v0 = 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::default_referral();
    ...
    public(friend) fun decrease_shares(arg0: &mut ProtocolFees, arg1: 0x1::option::Option<0x2::object::ID>, arg2: u64) {
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, ReferralTracker>(&mut arg0.referrals, 0x1::option::destroy_with_default<0x2::object::ID>(arg1, 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::default_referral()));
        update_unclaimed_fees(v0, arg0.fees_per_share);
    ...
    public(friend) fun default_protocol_fees(arg0: &mut 0x2::tx_context::TxContext) : ProtocolFees {
        ...
        0x2::table::add<0x2::object::ID, ReferralTracker>(&mut v0.referrals, 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::default_referral(), v1);
        v0
    }
