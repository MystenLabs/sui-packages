    ...
    fun update_dynamic_power(arg0: &mut 0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64) {
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 30) {
            ...
            while (v5 < 0x1::vector::length<address>(v4)) {
                if (0x2::table::contains<address, User>(arg1, *0x1::vector::borrow<address>(v4, v5))) {
                    v3 = v3 + 1;
                };
                v5 = v5 + 1;
            };
            let v6 = get_share_reward_percent(v1, v3);
            let v7 = 0x2::table::borrow_mut<address, User>(arg1, v2);
            if (v7.invest_amount > 0 && v6 > 0) {
                let v8 = arg3 / 100 * v6;
                v7.dynamic_power = v7.dynamic_power + v8;
                0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::admin::add_total_dynamic_power_distributed(arg0, v8);
            };
            v0 = v7.inviter;
            v1 = v1 + 1;
        };
