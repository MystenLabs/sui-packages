module 0x60b2d436499019ffa0a9e029d488851bcc82dd745f9ff85c502f8be75145934b::sap {
    ...
    fun downline_level_bps(arg0: u64, arg1: u64) : u64 {
        if (arg0 == 1) {
            if (arg1 == 1) {
                500
            } else {
    ...
    fun pay_downline_referrals_if_qualified<T0>(arg0: &Protocol, arg1: &TreeDownline<T0>, arg2: address, arg3: u64, arg4: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v10 = pay_downline_level(arg2, v0, 1, downline_level_bps(v1, 1), arg3, arg4, arg6);
        let v11 = 0 + v10;
        let v12 = v11;
        if (v1 >= 2) {
            let v13 = pay_downline_level(arg2, v2, 2, downline_level_bps(v1, 2), arg3, arg4, arg6);
            v12 = v11 + v13;
        };
        if (v1 >= 3) {
            let v14 = pay_downline_level(arg2, v3, 3, downline_level_bps(v1, 3), arg3, arg4, arg6);
            v12 = v12 + v14;
        };
        if (v1 >= 4) {
            let v15 = pay_downline_level(arg2, v4, 4, downline_level_bps(v1, 4), arg3, arg4, arg6);
            v12 = v12 + v15;
        };
        if (v1 >= 5) {
            v12 = v12 + pay_downline_level(arg2, v5, 5, downline_level_bps(v1, 5), arg3, arg4, arg6);
        };
        v12
    }
