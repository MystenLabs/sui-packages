module 0x97980300e7f6b1627cc05bae390b58e9b0e1b237b9808de3dea2b0b327434fbe::payment_memefi {
    ...
    public fun pay(arg0: &mut PaymentMemefiRegistry, arg1: 0x2::coin::Coin<0x506a6fc25f1c7d52ceb06ea44a3114c9380f8e2029b4356019822f248b49e411::memefi::MEMEFI>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::coin::value<0x506a6fc25f1c7d52ceb06ea44a3114c9380f8e2029b4356019822f248b49e411::memefi::MEMEFI>(&arg1);
        assert!(v1 == 0x2::tx_context::sender(arg5), 14);
        assert!(v3 == 0x2::bcs::peel_u64(&mut v0), 15);
        assert!(!0x2::table::contains<u64, bool>(&arg0.nonces, v2), 11);
        0x2::table::add<u64, bool>(&mut arg0.nonces, v2, true);
