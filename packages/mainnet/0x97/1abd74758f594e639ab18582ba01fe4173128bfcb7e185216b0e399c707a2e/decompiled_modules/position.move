module 0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::position {
    ...
    public(friend) fun check_position_cap_matches<T0>(arg0: &Position<T0>, arg1: &PositionCap) {
        assert!(0x2::object::id<Position<T0>>(arg0) == arg1.position_id, 0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::errors::err_position_cap_not_match());
    }
    ...
    public(friend) fun destroy_position<T0>(arg0: Position<T0>, arg1: &0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::config::GlobalConfig) {
        let Position {
            id                   : v0,
            is_long              : _,
        ...
        0x2::transfer::public_transfer<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>>(v2, 0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::config::collect_obligation_owner_cap_address(arg1));
    }
    ...
    public(friend) fun emit_borrow_event<T0, T1>(arg0: &0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::context::MarginTradingContext, arg1: &Position<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        let v0 = BorrowEvent{
            trace_id      : 0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::context::trace_id(arg0),
    ...
    public(friend) fun emit_close_position_event<T0>(arg0: &0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::context::MarginTradingContext, arg1: &Position<T0>, arg2: &0x2::clock::Clock) {
    ...
    public(friend) fun emit_deposit_event<T0, T1>(arg0: &0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::context::MarginTradingContext, arg1: &Position<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        let v0 = DepositEvent{
            trace_id       : 0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::context::trace_id(arg0),
            position_id    : 0x2::object::id<Position<T0>>(arg1),
            owner          : arg1.owner,
    ...
    public(friend) fun emit_open_position_event<T0>(arg0: &0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::context::MarginTradingContext, arg1: &Position<T0>, arg2: u64, arg3: 0x1::type_name::TypeName, arg4: 0x1::type_name::TypeName, arg5: &0x2::clock::Clock) {
    ...
    public(friend) fun emit_repay_event<T0, T1>(arg0: &0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::context::MarginTradingContext, arg1: &Position<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        let v0 = RepayEvent{
            trace_id        : 0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::context::trace_id(arg0),
            position_id     : 0x2::object::id<Position<T0>>(arg1),
            owner           : arg1.owner,
    ...
    public(friend) fun emit_withdraw_event<T0, T1>(arg0: &0xeeec340c375ee11292cdcbc43549a28386c97e1a8fe82b6a6e2364938f7cefb7::context::MarginTradingContext, arg1: &Position<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
