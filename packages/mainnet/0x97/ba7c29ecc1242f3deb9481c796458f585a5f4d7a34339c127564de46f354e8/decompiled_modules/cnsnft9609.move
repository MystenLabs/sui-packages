module 0x97ba7c29ecc1242f3deb9481c796458f585a5f4d7a34339c127564de46f354e8::cnsnft9609 {
    struct CNSNFT9609 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9609, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9609>(arg0, arg1);
