module 0x971475a4ea128e8ae429b5ad7adc8c865da3fbfd975c4432423db46b49da0bb3::cnsnft3133 {
    struct CNSNFT3133 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3133, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3133>(arg0, arg1);
