module 0x2a9a18c9efbbd386f6cbe49aba1647ca03d4c6ad58b8eb4dd5fee62aff786989::torque_staking {
    ...
    public entry fun create_staking<T0>(arg0: u64, arg1: &mut 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = TorqueStaking<T0>{
            ...
            dpr            : arg0,
            sender         : v0,
            amount         : 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg1, arg2, arg6)),
            duration       : arg3,
    ...
    public entry fun stake_token<T0, T1>(arg0: &mut 0x2::coin::Coin<T0>, arg1: u64, arg2: &TorqueStaking<T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
