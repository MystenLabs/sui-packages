module 0x2a1dcf213ac9d71ee201c7947fa758bef2c97093673791f07d8da3dcc47d6c1c::boss_ring {
    struct BOSS_RING has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BOSS_RING, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BOSS_RING>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"BOSS RING"));
