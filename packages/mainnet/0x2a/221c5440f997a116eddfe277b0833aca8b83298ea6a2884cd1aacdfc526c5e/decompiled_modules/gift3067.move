module 0x2a221c5440f997a116eddfe277b0833aca8b83298ea6a2884cd1aacdfc526c5e::gift3067 {
    struct GIFT3067 has drop {
        dummy_field: bool,
    }

    struct TICKET_3067 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3067(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3067>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3067>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3067, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3067>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3067>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3067>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3067>>(v5, 0x2::tx_context::sender(arg1));
    }
