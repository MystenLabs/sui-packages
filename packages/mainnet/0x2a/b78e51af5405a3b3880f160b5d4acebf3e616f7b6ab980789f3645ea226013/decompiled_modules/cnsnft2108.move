module 0x2ab78e51af5405a3b3880f160b5d4acebf3e616f7b6ab980789f3645ea226013::cnsnft2108 {
    struct CNSNFT2108 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2108, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2108>(arg0, arg1);
