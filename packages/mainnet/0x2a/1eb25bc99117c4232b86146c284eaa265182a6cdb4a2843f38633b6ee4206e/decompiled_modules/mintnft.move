module 0x2a1eb25bc99117c4232b86146c284eaa265182a6cdb4a2843f38633b6ee4206e::mintnft {
    struct Fund has key {
        id: 0x2::object::UID,
        target: u64,
    ...
    public entry fun mintnft(arg0: &FundOwnerCap, arg1: &mut Fund, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun create_nft(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun mint(arg0: &mut Fund, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = MainNetNFT{
            ...
            img_url     : 0x1::string::utf8(arg4),
            url         : 0x2::url::new_unsafe_from_bytes(arg4),
        };
        0x2::transfer::transfer<MainNetNFT>(v2, 0x2::tx_context::sender(arg5));
    }
