module 0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::burn_message {
    ...
    public fun serialize(arg0: &BurnMessage) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::serialize::serialize_address(arg0.burn_token));
        0x1::vector::append<u8>(&mut v0, 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::serialize::serialize_address(arg0.mint_recipient));
        0x1::vector::append<u8>(&mut v0, 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::serialize::serialize_u256_be(arg0.amount));
        0x1::vector::append<u8>(&mut v0, 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::serialize::serialize_address(arg0.message_sender));
        v0
    }
    ...
    public(friend) fun new(arg0: u32, arg1: address, arg2: address, arg3: u256, arg4: address) : BurnMessage {
        BurnMessage{
            version        : arg0,
            burn_token     : arg1,
            mint_recipient : arg2,
