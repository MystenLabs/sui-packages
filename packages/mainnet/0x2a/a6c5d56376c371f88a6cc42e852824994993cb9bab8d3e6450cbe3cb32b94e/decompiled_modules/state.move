module 0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::state {
    struct State has key {
        ...
        paused: bool,
        roles: 0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::roles::Roles,
    ...
    public(friend) fun new(arg0: u32, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : State {
        State{
            ...
            paused                        : false,
            roles                         : 0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::roles::new(arg1, arg1, arg1, arg2),
            compatible_versions           : 0x2::vec_set::singleton<u64>(0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::version_control::current_version()),
        }
    }

    public fun roles(arg0: &State) : &0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::roles::Roles {
        &arg0.roles
    }
    ...
    public(friend) fun roles_mut(arg0: &mut State) : &mut 0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::roles::Roles {
        &mut arg0.roles
    }
