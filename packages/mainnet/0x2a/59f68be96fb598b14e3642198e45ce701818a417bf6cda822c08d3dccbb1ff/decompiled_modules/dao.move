module 0x2a59f68be96fb598b14e3642198e45ce701818a417bf6cda822c08d3dccbb1ff::dao {
    ...
    public entry fun bulk_add_vip_addresses<T0>(arg0: &AdminCap, arg1: &mut DAOFund<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.dao_fund_id == 0x2::object::id<DAOFund<T0>>(arg1), 1013);
        let v0 = 0x1::vector::length<address>(&arg2);
        assert!(v0 == 0x1::vector::length<u64>(&arg3), 1014);
        let v1 = 0;
        while (v1 < v0) {
            add_vip_address<T0>(arg0, *0x1::vector::borrow<address>(&arg2, v1), arg1, *0x1::vector::borrow<u64>(&arg3, v1), arg4, arg5);
            v1 = v1 + 1;
        };
    }
    ...
    public entry fun cancel_purchase<T0>(arg0: &mut DAOFund<T0>, arg1: &mut 0x2a59f68be96fb598b14e3642198e45ce701818a417bf6cda822c08d3dccbb1ff::dao_config::GlobalDaoFee, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (_, _, v11) = 0x2a59f68be96fb598b14e3642198e45ce701818a417bf6cda822c08d3dccbb1ff::dao_config::get_dao_fee_config(arg1);
    ...
    public entry fun commit<T0>(arg0: &mut DAOFund<T0>, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (!is_existed_user_dao<T0>(arg0, 0x2::tx_context::sender(arg4))) {
            ...
            assert!(v4.total_committed_amount + v2 <= v4.max_committable_amount, 1007);
        ...
        let v5 = CommittedEvent{
            ...
            amount       : v2,
            committed_at : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<CommittedEvent>(v5);
    }

    public entry fun create_dao_fund<T0>(arg0: &DAOSeller, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: 0x1::string::String, arg6: 0x2::coin::Coin<T0>, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        assert!(is_existed_seller_dao(arg0, 0x2::tx_context::sender(arg12)), 1021);
        assert!(0x2::coin::value<T0>(&arg6) == arg4, 1005);
        assert!(arg7 >= 0x2::clock::timestamp_ms(arg11), 1015);
        let v0 = calculate_price(arg4, arg8);
        let v1 = DAOFund<T0>{
    ...
    public fun finalize_dao<T0>(arg0: &AdminCap, arg1: &mut DAOFund<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1.dao_end_at > 0) {
            0x2a59f68be96fb598b14e3642198e45ce701818a417bf6cda822c08d3dccbb1ff::lock::lock_nft_to<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(v14, arg1.creator, 31536000000, arg6, arg7);
        } else {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2a59f68be96fb598b14e3642198e45ce701818a417bf6cda822c08d3dccbb1ff::dao_config::new_global_dao_fee_and_shared(arg0);
        let v1 = DAOSeller{
    ...
    public entry fun set_platform_fee(arg0: &OperatorCap, arg1: &mut 0x2a59f68be96fb598b14e3642198e45ce701818a417bf6cda822c08d3dccbb1ff::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: address, arg5: &0x2::tx_context::TxContext) {
        0x2a59f68be96fb598b14e3642198e45ce701818a417bf6cda822c08d3dccbb1ff::dao_config::set_platform_fee(arg1, arg2, arg3, arg4, arg5);
    }
