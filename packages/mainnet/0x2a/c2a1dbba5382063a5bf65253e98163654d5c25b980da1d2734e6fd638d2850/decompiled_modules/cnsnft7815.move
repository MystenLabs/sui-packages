module 0x2ac2a1dbba5382063a5bf65253e98163654d5c25b980da1d2734e6fd638d2850::cnsnft7815 {
    struct CNSNFT7815 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7815, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7815>(arg0, arg1);
