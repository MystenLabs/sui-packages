module 0x2a6e234302860bd1ead85deea18a3b5fd5ad9764574eec3efa3dd0eaea942a62::cnsnft8853 {
    struct CNSNFT8853 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8853, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9338"));
        let v4 = 0x2::package::claim<CNSNFT8853>(arg0, arg1);
