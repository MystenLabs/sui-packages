module 0x2a58708cdbad52288d9c1fd3c2ea443235ca2ecf299b1fde9d3a5ab0259898f7::reward4032 {
    struct REWARD4032 has drop {
        dummy_field: bool,
    }

    struct TICKET_4032 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4032(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4032>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4032>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4032, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4032>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4032>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4032>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4032>>(v5, 0x2::tx_context::sender(arg1));
    }
