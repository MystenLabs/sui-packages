module 0x2a26108a6f447122d569b9f3cc8fbf96871542c710dc3cb2f2d69f01402df747::aqua {
    ...
    fun init(arg0: AQUA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AQUA>(arg0, 6, b"aqUSDC", b"AquaYield USDC", b"Yield-bearing USDC receipt token. Deposit USDC, receive aqUSDC.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/e-5jZ0JJ1ZBjdPBXC2aGq0bmFErJzmNNAOkYJc_meW0")), arg1);
