module 0x2af188f9cc293640ced68e89a4c5773ee84702df3f10bcd080ccb894116398c3::payload_decoder {
    ...
    public fun decode_fee_payload(arg0: vector<u8>) : (u32, u256, address, u256, u256) {
        ...
        assert!(0x1::vector::length<u8>(&v5) == 0, 1);
        (decode_be_u32(v1), decode_left_padded_u256(v2), 0x2::bcs::peel_address(&mut v0), decode_left_padded_u256(v3), decode_left_padded_u256(v4))
    }
