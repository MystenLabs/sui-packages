module 0x2a7018b6f2fb1eb3f8f5b25e22de41f17214372a17198bcf48f4c41f2fdee80f::reward8705 {
    struct REWARD8705 has drop {
        dummy_field: bool,
    }

    struct TICKET_8705 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8705(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8705>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8705>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8705, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8705>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8705>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8705>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8705>>(v5, 0x2::tx_context::sender(arg1));
    }
