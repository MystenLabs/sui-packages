module 0x2aa195aa62e4e14c5980dce3061240cd7e4ec4c5383554207908e633d8910bd2::cnsnft4915 {
    struct CNSNFT4915 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4915, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4915>(arg0, arg1);
