module 0x2a08b42a786c996edf63519906676d3a0bf0a77efc84bcd2533a20baa3ce1dfb::ferret {
    ...
    public fun access_list_add(arg0: &mut AccessList, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0xf060418a475679985421b63daad483218c6de2c051abf60d40974c656a5655ba, 10000001);
    ...
    public fun new_access_list(arg0: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg0) == @0xf060418a475679985421b63daad483218c6de2c051abf60d40974c656a5655ba || 0x2::tx_context::sender(arg0) == @0x8feaaf3e14db29d341d5b03012f51e91855fd465b137203f36802951fe38f069 || 0x2::tx_context::sender(arg0) == @0x6a2fdf6ed9df04787cab1478d57c97755764da30afd41b0aeea9141fafa984ac || 0x2::tx_context::sender(arg0) == @0xd9456a92f160eafbfca830fa2520a22bd7fbb4bbf6207eea2d69f26414e72ef4, 10000001);
        let v0 = 0x1::vector::singleton<address>(@0xf060418a475679985421b63daad483218c6de2c051abf60d40974c656a5655ba);
        0x1::vector::push_back<address>(&mut v0, @0x8feaaf3e14db29d341d5b03012f51e91855fd465b137203f36802951fe38f069);
        0x1::vector::push_back<address>(&mut v0, @0x6a2fdf6ed9df04787cab1478d57c97755764da30afd41b0aeea9141fafa984ac);
        0x1::vector::push_back<address>(&mut v0, @0xd9456a92f160eafbfca830fa2520a22bd7fbb4bbf6207eea2d69f26414e72ef4);
        0x1::vector::push_back<address>(&mut v0, @0xaecdaa08f1b9f4469aa3abe357a0ec105152a9b72129245a2e3277c98e4f3914);
        let v1 = AccessList{
    ...
    public fun new_contract_data(arg0: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg0) == @0xf060418a475679985421b63daad483218c6de2c051abf60d40974c656a5655ba, 10000001);
    ...
    public fun transfer_coins_with_threshold_2<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<T0>(&arg0) >= arg1, 10000000);
    ...
    public fun unknownswap_0<T0, T1>(arg0: &mut AccessList, arg1: &mut 0xd842eddc81c64fb889aa1676068176f41b577b20c2d143c7b718f2ad1ebd56b2::swap::RyuSwap, arg2: &mut 0xd842eddc81c64fb889aa1676068176f41b577b20c2d143c7b718f2ad1ebd56b2::dao_fee::DaoFeeInfo, arg3: &0x2::clock::Clock, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert!(is_valid(arg0, arg5), 10000002);
        let (v0, v1) = 0xd842eddc81c64fb889aa1676068176f41b577b20c2d143c7b718f2ad1ebd56b2::router::get_reserves_size<T0, T1>(arg1);
        let (v2, v3) = 0xd842eddc81c64fb889aa1676068176f41b577b20c2d143c7b718f2ad1ebd56b2::router::get_fees_config<T0, T1>(arg1);
        let (v4, v5) = 0xd842eddc81c64fb889aa1676068176f41b577b20c2d143c7b718f2ad1ebd56b2::swap::swap<T0, T1>(arg1, arg2, arg3, arg4, 0, 0x2::coin::zero<T1>(arg5), 0xd842eddc81c64fb889aa1676068176f41b577b20c2d143c7b718f2ad1ebd56b2::router::get_amount_out<T0, T1>(v0, v1, v2, v3, 0x2::coin::value<T0>(&arg4)), arg5);
        0x2::coin::destroy_zero<T0>(v4);
        v5
    }

    public fun unknownswap_1<T0, T1>(arg0: &mut AccessList, arg1: &mut 0xd842eddc81c64fb889aa1676068176f41b577b20c2d143c7b718f2ad1ebd56b2::swap::RyuSwap, arg2: &mut 0xd842eddc81c64fb889aa1676068176f41b577b20c2d143c7b718f2ad1ebd56b2::dao_fee::DaoFeeInfo, arg3: &0x2::clock::Clock, arg4: 0x2::coin::Coin<T1>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(is_valid(arg0, arg5), 10000002);
        let (v0, v1) = 0xd842eddc81c64fb889aa1676068176f41b577b20c2d143c7b718f2ad1ebd56b2::router::get_reserves_size<T1, T0>(arg1);
        let (v2, v3) = 0xd842eddc81c64fb889aa1676068176f41b577b20c2d143c7b718f2ad1ebd56b2::router::get_fees_config<T1, T0>(arg1);
        let (v4, v5) = 0xd842eddc81c64fb889aa1676068176f41b577b20c2d143c7b718f2ad1ebd56b2::swap::swap<T0, T1>(arg1, arg2, arg3, 0x2::coin::zero<T0>(arg5), 0xd842eddc81c64fb889aa1676068176f41b577b20c2d143c7b718f2ad1ebd56b2::router::get_amount_out<T1, T0>(v0, v1, v2, v3, 0x2::coin::value<T1>(&arg4)), arg4, 0, arg5);
        0x2::coin::destroy_zero<T1>(v5);
        v4
    }
