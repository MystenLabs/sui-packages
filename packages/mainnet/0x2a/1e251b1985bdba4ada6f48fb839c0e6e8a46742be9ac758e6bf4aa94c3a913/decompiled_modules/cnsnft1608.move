module 0x2a1e251b1985bdba4ada6f48fb839c0e6e8a46742be9ac758e6bf4aa94c3a913::cnsnft1608 {
    struct CNSNFT1608 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1608, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5395"));
        let v4 = 0x2::package::claim<CNSNFT1608>(arg0, arg1);
