module 0x2a5cfcb897e7134b456ec76dd4098a0cc6d4cc2c16e65e5dae6f2206c20275b0::cnsnft2049 {
    struct CNSNFT2049 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2049, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2049>(arg0, arg1);
