module 0x25da999c4c090fa8415f40b3ad3c219b83215bf32c11d84945e9c17941bda8f0::jackpot {
    ...
    fun enter(arg0: &mut Vault, arg1: &mut Record, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        let v5 = fee_for(v0, effective_weight(v4, 100, v2, arg0.odds_denominator * 1000000000));
        let v6 = mul_div(v5, 7000, 10000);
        let v7 = mul_div(v5, 2000, 10000);
        let v8 = v5 - v6 - v7;
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.jackpot, 0x2::balance::split<0x2::sui::SUI>(&mut v1, v6));
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.burn_bucket, 0x2::balance::split<0x2::sui::SUI>(&mut v1, v7));
        if (v8 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v1, v8), arg4), arg0.ops);
        };
        ...
        if (v2 > 100) {
            ...
            0x2::dynamic_field::add<TicketBoostKey, u64>(&mut arg0.id, v11, v2);
            let v12 = BoostSpent{
