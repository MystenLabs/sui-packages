module 0x2ae2b21d5351f5281a5daf8d93e9c65d3be16fd45557304c7e5e96d85cfc18f2::cnsnft4689 {
    struct CNSNFT4689 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4689, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4689>(arg0, arg1);
