module 0x2add60eb5e3e2e0c3c989b5dbe2da590adfd2b69003c198b4490eb4df291a003::reward9537 {
    struct REWARD9537 has drop {
        dummy_field: bool,
    }

    struct TICKET_9537 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9537(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9537>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9537>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9537, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9537>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9537>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9537>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9537>>(v5, 0x2::tx_context::sender(arg1));
    }
