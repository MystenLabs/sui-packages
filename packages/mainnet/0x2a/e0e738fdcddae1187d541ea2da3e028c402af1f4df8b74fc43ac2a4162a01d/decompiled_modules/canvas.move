module 0x2ae0e738fdcddae1187d541ea2da3e028c402af1f4df8b74fc43ac2a4162a01d::canvas {
    ...
    entry fun paint_pixels_with_paint(arg0: &mut Canvas, arg1: vector<u64>, arg2: vector<u64>, arg3: vector<0x1::string::String>, arg4: &0x2::clock::Clock, arg5: 0x2::coin::Coin<0x8d572055ac7168a40878ca9f90dfec10c11f77da086f215277da52ab06a62952::paint_coin::PAINT_COIN>, arg6: &0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<u64>(&arg1) == 0x1::vector::length<u64>(&arg2) && 0x1::vector::length<u64>(&arg2) == 0x1::vector::length<0x1::string::String>(&arg3), 13906834964617428994);
        assert!(0x2::coin::value<0x8d572055ac7168a40878ca9f90dfec10c11f77da086f215277da52ab06a62952::paint_coin::PAINT_COIN>(&arg5) >= calculate_cost_in_paint(rules(arg0), 0x1::vector::length<u64>(&arg1)), 13906834986092396548);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x8d572055ac7168a40878ca9f90dfec10c11f77da086f215277da52ab06a62952::paint_coin::PAINT_COIN>>(arg5, 0x2ae0e738fdcddae1187d541ea2da3e028c402af1f4df8b74fc43ac2a4162a01d::canvas_admin::canvas_treasury(rules(arg0)));
        let v0 = arg0.rules;
        let v1 = 0;
        while (v1 < 0x1::vector::length<u64>(&arg1)) {
            let v2 = pixel_mut(arg0, *0x1::vector::borrow<u64>(&arg1, v1), *0x1::vector::borrow<u64>(&arg2, v1));
            paint(v2, &v0, *0x1::vector::borrow<0x1::string::String>(&arg3, v1), arg4, arg6);
            v1 = v1 + 1;
        };
        0x2ae0e738fdcddae1187d541ea2da3e028c402af1f4df8b74fc43ac2a4162a01d::events::emit_pixels_painted_event(arg1, arg2, arg3, 0x2::tx_context::sender(arg6), 0x2::coin::value<0x8d572055ac7168a40878ca9f90dfec10c11f77da086f215277da52ab06a62952::paint_coin::PAINT_COIN>(&arg5));
    }
