module 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags {
    ...
    fun buy_direct<T0>(arg0: address, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut Pool<T0>, arg3: u64, arg4: u64, arg5: &0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_token_lock::Configuration, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::curves::calculate_add_liquidity_cost(arg2.virtual_sui_reserves, arg2.virtual_token_reserves, v2) + 1;
        let v4 = 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::as_u64(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::div(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::mul(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(v3), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg4)), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(10000)));
        assert!(v0 >= v3 + v4, 5);
        ...
        if (arg6 == 0) {
            ...
            0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_token_lock::create_lock<T0>(arg5, v8, 0x2::tx_context::sender(arg8), 0x2::coin::value<T0>(&v8), 0x2::clock::timestamp_ms(arg7) + arg6, arg7, arg8);
        };
        if (v1 == v2) {
    ...
    public fun buy_exact_in_returns_with_lock<T0>(arg0: &mut Configuration, arg1: &0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_token_lock::Configuration, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let v3 = 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::curves::calculate_remove_liquidity_return(v2.virtual_sui_reserves, v2.virtual_token_reserves, arg3);
        let v4 = v2.virtual_token_reserves - get_virtual_remain_token_reserves<T0>(v2);
        let (v5, v6) = if (v3 > v4) {
            let v6 = 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::curves::calculate_add_liquidity_cost(v2.virtual_sui_reserves, v2.virtual_token_reserves, v4) + 1;
            (v4, v6)
        } else {
            (v3, arg3)
        };
        assert!(v5 >= arg4, 1);
        let v7 = 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::as_u64(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::div(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::mul(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(v6), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg0.platform_fee)), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(10000)));
        ...
        if (0x2::dynamic_field::exists_<vector<u8>>(&v2.id, b"pool_creation_timestamp")) {
            ...
            if (v13 - *0x2::dynamic_field::borrow<vector<u8>, u64>(&v2.id, b"pool_creation_timestamp") < *0x2::dynamic_field::borrow<vector<u8>, u64>(&arg0.id, b"buy_block_duration")) {
                let v14 = v11;
                0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_token_lock::create_lock<T0>(arg1, v14, 0x2::tx_context::sender(arg6), 0x2::coin::value<T0>(&v14), v13 + *0x2::dynamic_field::borrow<vector<u8>, u64>(&arg0.id, b"lock_buy_duration"), arg5, arg6);
    ...
    public entry fun buy_exact_in_with_lock<T0>(arg0: &mut Configuration, arg1: &0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_token_lock::Configuration, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    fun calculate_init_sui_reserves(arg0: &Configuration, arg1: u64) : u64 {
        ...
        assert!(v0 > v1, 1);
        0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::as_u64(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::div(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::mul(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg1), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(v1)), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(v0 - v1)))
    }
    ...
    public entry fun create_and_lock_first_buy_with_fee<T0>(arg0: &mut Configuration, arg1: &mut 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_stake::Configuration, arg2: &0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_token_lock::Configuration, arg3: 0x2::coin::TreasuryCap<T0>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: 0x1::ascii::String, arg11: 0x1::ascii::String, arg12: 0x1::ascii::String, arg13: 0x1::ascii::String, arg14: 0x1::ascii::String, arg15: 0x1::ascii::String, arg16: 0x1::ascii::String, arg17: 0x2::coin::CoinMetadata<T0>, arg18: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Pool<T0>{
            ...
            virtual_token_reserves      : 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::as_u64(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::div(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::mul(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg0.remain_token_reserves), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg0.remain_token_reserves)), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg0.remain_token_reserves - arg0.initial_virtual_token_reserves))),
        ...
        0x2::dynamic_field::add<vector<u8>, u64>(&mut v1.id, b"virtual_token_reserves", 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::as_u64(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::div(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::mul(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg0.remain_token_reserves), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg0.initial_virtual_token_reserves)), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg0.remain_token_reserves - arg0.initial_virtual_token_reserves))));
        ...
        0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_stake::initialize_staking_pool<T0>(arg1, arg9, arg18);
        0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_stake::initialize_creator_pool<T0>(arg1, 0x2::tx_context::sender(arg18), arg9, arg18);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg4, 10000000, arg18), arg0.fee_platform_recipient);
    ...
    public entry fun create_with_fee<T0>(arg0: &mut Configuration, arg1: &mut 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_stake::Configuration, arg2: 0x2::coin::TreasuryCap<T0>, arg3: 0x2::coin::CoinMetadata<T0>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: &0x2::clock::Clock, arg7: 0x1::ascii::String, arg8: 0x1::ascii::String, arg9: 0x1::ascii::String, arg10: 0x1::ascii::String, arg11: 0x1::ascii::String, arg12: 0x1::ascii::String, arg13: 0x1::ascii::String, arg14: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<0x1::ascii::String, Pool<T0>>(&mut arg0.id, 0x1::type_name::get_address(&v2), v1);
        0x2::event::emit<CreatedEventV2>(v4);
        0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_stake::initialize_staking_pool<T0>(arg1, arg6, arg14);
        0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_stake::initialize_creator_pool<T0>(arg1, 0x2::tx_context::sender(arg14), arg6, arg14);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg4, 10000000, arg14), arg0.fee_platform_recipient);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg4, 0x2::tx_context::sender(arg14));
    }

    fun distribute_fees<T0, T1>(arg0: &mut Pool<T0>, arg1: address, arg2: u16, arg3: u16, arg4: u16, arg5: u16, arg6: &mut 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_stake::Configuration, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::as_u64(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::div(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::mul(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(v0), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64((arg2 as u64))), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(10000)));
        let v2 = 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::as_u64(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::div(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::mul(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(v0), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64((arg3 as u64))), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(10000)));
        let v3 = 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::as_u64(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::div(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::mul(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(v0), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64((arg4 as u64))), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(10000)));
        let v4 = 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::as_u64(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::div(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::mul(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(v0), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64((arg5 as u64))), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(10000)));
        ...
        0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_stake::deposit_creator_pool<T0>(arg6, 0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v2, arg8), arg7, arg8);
        0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_stake::update_reward_index<T0>(arg6, 0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v3, arg8), arg7, arg8);
        0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_stake::update_reward_index<T1>(arg6, 0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v4, arg8), arg7, arg8);
    ...
    public fun estimate_amount_out<T0>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        if (arg1 > 0 && arg2 == 0) {
            (0, 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::curves::calculate_token_amount_received(v1.virtual_sui_reserves, v1.virtual_token_reserves, arg1 - 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::as_u64(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::div(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::mul(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg1), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg0.platform_fee)), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(10000)))))
        } else if (arg1 == 0 && arg2 > 0) {
            let v4 = 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_sui_reserves, arg2);
            (v4 - 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::as_u64(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::div(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::mul(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(v4), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg0.platform_fee)), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(10000))), 0)
        } else {
            (0, 0)
        }
    }
    ...
    public entry fun sell<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 > 0, 1);
        let v3 = 0x1::u64::min(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_sui_reserves, v2), 0x2::coin::value<0x2::sui::SUI>(&v1.real_sui_reserves));
        let v4 = 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::as_u64(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::div(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::mul(0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(v3), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(arg0.platform_fee)), 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::utils::from_u64(10000)));
        assert!(v3 - v4 >= arg2, 1);
    ...
    public fun withdraw_fee_bonding_curve<T0, T1>(arg0: &mut Configuration, arg1: &mut 0x2ab8f764b67991acaf37966af2274dcf7214ae0e8cea3ede214078f248dce3d2::moonbags_stake::Configuration, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
