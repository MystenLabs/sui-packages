module 0x2a8272b00040154efeb91eda750b4b2998f71a0f5d67169deee8d7e00e8acdfd::puggies {
    ...
    fun init(arg0: PUGGIES, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Puggies nft"));
