module 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::order_manager {
    ...
    public(friend) fun adjust_maker_orders(arg0: &mut OrderManager, arg1: &0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::Parameters, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &0x2::clock::Clock, arg6: u64, arg7: u64, arg8: &0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::order_book::OrderBook, arg9: &0x2::tx_context::TxContext) {
        if (!0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_trades_enabled(arg1)) {
            return
        };
        if (arg7 >= 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_max_volatility_for_multiple_times_1k(arg1)) {
            ...
            while (v1 < 0x1::vector::length<0x1::option::Option<BasicOrder>>(v0)) {
                0x1::option::extract<BasicOrder>(0x1::vector::borrow_mut<0x1::option::Option<BasicOrder>>(v0, v1));
                v1 = v1 + 1;
            };
            return
        };
        let (v2, v3) = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::get_asset_balances(arg2, arg4);
        if (0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::convert_to_quote_at_price(arg1, v2, arg6) + v3 < 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_minimum_portfolio(arg1)) {
            return
        };
        let v4 = arg6 / 10000;
        let v5 = v4 * 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_shallow_place_bps_times_1k(arg1) / 1000;
        let v6 = v5;
        let v7 = v4 * 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_deep_place_bps_times_1k(arg1) / 1000;
        let v8 = v7;
        if (arg7 > 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_min_volatility_for_multiple_times_1k(arg1)) {
            let v9 = 1000 + arg7 - 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_min_volatility_for_multiple_times_1k(arg1);
            v6 = v5 * v9 / 1000;
            v8 = v7 * v9 / 1000;
        };
        let v10 = 0;
        let v11 = v8 / 4;
        ensure_maker_order_is_correct(arg0, arg1, arg2, arg4, arg3, 0, arg6 - v6, v10, true, 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_max_shallow_quantity_base(arg1), arg8, true, true, arg5, arg9);
        ensure_maker_order_is_correct(arg0, arg1, arg2, arg4, arg3, 1, arg6 + v6, v10, false, 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_max_shallow_quantity_base(arg1), arg8, true, true, arg5, arg9);
        if (0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_deep_trades_enabled(arg1)) {
            ensure_maker_order_is_correct(arg0, arg1, arg2, arg4, arg3, 2, arg6 - v8, v11, true, 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_max_deep_buy_quantity_base(arg1), arg8, false, false, arg5, arg9);
            ensure_maker_order_is_correct(arg0, arg1, arg2, arg4, arg3, 3, arg6 + v8, v11, false, 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_max_deep_sell_quantity_base(arg1), arg8, false, false, arg5, arg9);
        };
    }
    ...
    fun ensure_maker_order_is_correct(arg0: &mut OrderManager, arg1: &0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::Parameters, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg5: u64, arg6: u64, arg7: u64, arg8: bool, arg9: u64, arg10: &0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::order_book::OrderBook, arg11: bool, arg12: bool, arg13: &0x2::clock::Clock, arg14: &0x2::tx_context::TxContext) {
        ...
        if (arg11) {
            arg6 = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::order_book::get_dimed_price(arg10, arg1, arg6, arg8, v0);
        };
        ...
        if (0x1::option::is_some<BasicOrder>(v3)) {
            ...
            if (v4.price >= arg6 - arg7 && v4.price <= arg6 + arg7) {
                ...
                if (v5 > 0x2::clock::timestamp_ms(arg13) && v5 - 0x2::clock::timestamp_ms(arg13) > 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_order_ttl_ms(arg1) / 2) {
                    return
                };
            };
        ...
        if (arg8) {
            let v6 = arg9;
            if (arg12) {
                try_ensure_available_quote_balance(arg0, arg1, arg2, arg4, arg3, 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::convert_to_quote_at_price(arg1, arg9, arg6), arg13, arg14);
            };
            let v7 = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::convert_to_base_at_price(arg1, 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::get_available_quote_balance(arg1, arg2), arg6);
            if (arg9 > v7) {
                v6 = v7;
            };
            let v8 = arg6 / v0 * v0;
            let v9 = v8;
            let v10 = v6 / v1 * v1;
            if (v8 >= 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::order_book::best_ask(arg10)) {
                v9 = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::order_book::best_ask(arg10) - v0;
            };
            if (v10 < v2) {
                return
            };
            if (v9 > 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maximum_buy_price_quote(arg1)) {
                return
            };
            let v11 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg3, arg2, arg4, arg5, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::post_only(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::cancel_maker(), v9, v10, true, false, 0x2::clock::timestamp_ms(arg13) + 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::maker_order_ttl_ms(arg1), arg13, arg14);
            ...
            let v13 = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::get_available_base_balance(arg1, arg2);
            if (arg9 > v13) {
                v12 = v13;
            };
            ...
            let v15 = v14;
            let v16 = v12 / v1 * v1;
            if (v14 <= 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::order_book::best_bid(arg10)) {
                v15 = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::order_book::best_bid(arg10) + v0;
            };
            if (v16 < v2) {
                return
            };
            if (v15 < 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::minimum_sell_price_quote(arg1)) {
                return
            };
    ...
    fun reduce_or_cancel_order(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &mut 0x1::option::Option<BasicOrder>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        if (v1 > arg4 + v4 + v3) {
            let v5 = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::ensure_multiple_round_down(v1 - arg4, v3);
    ...
    public(friend) fun try_ensure_available_base_balance(arg0: &mut OrderManager, arg1: &0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::Parameters, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        let v0 = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::get_available_base_balance(arg1, arg2);
        if (arg5 <= v0) {
            return
        };
        let v1 = arg5 - v0;
        ...
        if (0x1::option::is_some<BasicOrder>(0x1::vector::borrow<0x1::option::Option<BasicOrder>>(&arg0.orders, 3))) {
            ...
            let v3 = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::get_available_base_balance(arg1, arg2);
            if (v1 <= v3) {
                return
            };
            arg5 = v1 - v3;
    ...
    public(friend) fun try_ensure_available_quote_balance(arg0: &mut OrderManager, arg1: &0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::parameters::Parameters, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        let v0 = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::get_available_quote_balance(arg1, arg2);
        if (arg5 <= v0) {
            return
        };
        let v1 = arg5 - v0;
        ...
        if (0x1::option::is_some<BasicOrder>(0x1::vector::borrow<0x1::option::Option<BasicOrder>>(&arg0.orders, 2))) {
            ...
            let v3 = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::convert_to_base_at_price(arg1, v1, 0x1::option::borrow<BasicOrder>(v2).price);
            reduce_or_cancel_order(arg2, arg3, arg4, v2, v3, arg6, arg7);
            let v4 = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::get_available_quote_balance(arg1, arg2);
            if (v1 <= v4) {
                return
            };
            arg5 = v1 - v4;
        ...
        if (0x1::option::is_some<BasicOrder>(0x1::vector::borrow<0x1::option::Option<BasicOrder>>(&arg0.orders, 0))) {
            ...
            let v6 = 0x2ad1b67faf0e82032529d5bbbd7ddd6268df32769d7f23cdcf0a514cfcc64657::common::convert_to_base_at_price(arg1, arg5, 0x1::option::borrow<BasicOrder>(v5).price);
