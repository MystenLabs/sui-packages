module 0x2c48ac843f415aedb11ab2c7f9eda3faf205396642fe13b346acfcc5ca6373e3::oracle {
    struct HiveOracle has store, key {
        id: 0x2::object::UID,
        update_cap: 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::TwapUpdateCap,
    ...
    fun calculate_twap(arg0: u256, arg1: u256, arg2: u64) : u256 {
        let v0 = if (arg0 >= arg1) {
            ...
            0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::overflow_add_u256(arg0, 0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::sub_from_max_u256(arg1))
        };
        v0 / (arg2 as u256)
    }
    ...
    public fun setup_hive_oracle(arg0: 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::TwapUpdateCap, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = HiveOracle{
    ...
    public fun update_hive_oracle(arg0: &0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config::HiveDaoCapability, arg1: &mut HiveOracle, arg2: 0x1::option::Option<address>, arg3: 0x1::option::Option<address>, arg4: &0x2::tx_context::TxContext) {
    ...
    public entry fun update_hive_oracle_price<T0, T1, T2, T3, T4, T5>(arg0: &0x2::clock::Clock, arg1: &mut HiveOracle, arg2: &mut 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::HiveManager, arg3: &0x2c48ac843f415aedb11ab2c7f9eda3faf205396642fe13b346acfcc5ca6373e3::two_pool::LiquidityPool<T0, T1, T4>, arg4: &0x2c48ac843f415aedb11ab2c7f9eda3faf205396642fe13b346acfcc5ca6373e3::two_pool::LiquidityPool<T2, T3, T5>, arg5: &0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2c48ac843f415aedb11ab2c7f9eda3faf205396642fe13b346acfcc5ca6373e3::two_pool::get_liquidity_pool_id<T2, T3, T5>(arg4);
        assert!(0x2::object::id_to_address(&v2) == *0x1::option::borrow<address>(&arg1.sui_hive_pool_addr), 1974);
        let v3 = 0x2c48ac843f415aedb11ab2c7f9eda3faf205396642fe13b346acfcc5ca6373e3::two_pool::get_liquidity_pool_id<T0, T1, T4>(arg3);
        assert!(0x2::object::id_to_address(&v3) == *0x1::option::borrow<address>(&arg1.usdc_sui_pool_addr), 1974);
        let (_, v5, v6) = 0x2c48ac843f415aedb11ab2c7f9eda3faf205396642fe13b346acfcc5ca6373e3::two_pool::get_pool_cumulative_prices<T2, T3, T5>(arg4);
        let (_, v8, v9) = 0x2c48ac843f415aedb11ab2c7f9eda3faf205396642fe13b346acfcc5ca6373e3::two_pool::get_pool_cumulative_prices<T0, T1, T4>(arg3);
        ...
        if (0x1::option::is_some<HiveTwapSnapshot>(&v20)) {
            ...
            let v28 = 0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u256(v26, v27, (0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::pow(10, (9 as u128)) as u256));
            if (v28 > 0) {
                0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::update_hive_twap_info(&arg1.update_cap, arg0, arg2, v26, v27, v28);
            };
        };
