module 0x2a5da320211d58780d724d1c3407f8cf12c3ae73128eb4bbcb4cc3c388950ae7::reward3165 {
    struct REWARD3165 has drop {
        dummy_field: bool,
    }

    struct TICKET_3165 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3165(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3165>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3165>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3165, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3165>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3165>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3165>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3165>>(v5, 0x2::tx_context::sender(arg1));
    }
