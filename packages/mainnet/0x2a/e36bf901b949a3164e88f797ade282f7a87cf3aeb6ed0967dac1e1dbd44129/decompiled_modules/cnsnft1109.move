module 0x2ae36bf901b949a3164e88f797ade282f7a87cf3aeb6ed0967dac1e1dbd44129::cnsnft1109 {
    struct CNSNFT1109 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1109, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7084"));
        let v4 = 0x2::package::claim<CNSNFT1109>(arg0, arg1);
