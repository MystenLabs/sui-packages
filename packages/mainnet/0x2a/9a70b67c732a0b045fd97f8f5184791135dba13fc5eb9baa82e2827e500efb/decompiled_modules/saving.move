module 0x2a9a70b67c732a0b045fd97f8f5184791135dba13fc5eb9baa82e2827e500efb::saving {
    ...
    struct SavingWithdrawReceipt<phantom T0> {
        req: 0xe7b40890e0339465bf33f4deacaee69629359f22da8792676235f92bd68f3054::account::Request,
        pool: address,
    }
    ...
    public fun withdraw<T0>(arg0: &mut 0x2::object::UID, arg1: &mut 0x2::object::UID, arg2: 0xe7b40890e0339465bf33f4deacaee69629359f22da8792676235f92bd68f3054::account::Request, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::object::UID>, SavingWithdrawReceipt<T0>) {
        abort 0
    }
