module 0x2a239a754344a2b8cb0f9b92f75ddf3e31aa42c06c5c24da39e8eb24573d9caa::xbird {
    ...
    public fun depositToken(arg0: vector<u8>, arg1: vector<u8>, arg2: &ValidatorVault, arg3: &mut PegVault<XBIRD>, arg4: &mut 0x2a239a754344a2b8cb0f9b92f75ddf3e31aa42c06c5c24da39e8eb24573d9caa::archieve::UserArchieve, arg5: &0x2a239a754344a2b8cb0f9b92f75ddf3e31aa42c06c5c24da39e8eb24573d9caa::version::Version, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<XBIRD>, DepositProof) {
        ...
        assert!(v2 > 0, 1002);
        0x2a239a754344a2b8cb0f9b92f75ddf3e31aa42c06c5c24da39e8eb24573d9caa::archieve::verUpdateTokenPegNonce(v3, arg4);
        let v4 = DepositProof{
            owner   : v0,
            balance : v2,
        };
        let v5 = XBirdDeposited{
            ...
            nonce         : v3,
            balance       : v2,
            total_deposit : 0x2a239a754344a2b8cb0f9b92f75ddf3e31aa42c06c5c24da39e8eb24573d9caa::archieve::increaseTotalDeposit(v2, arg4),
        };
    ...
    fun init(arg0: XBIRD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2a239a754344a2b8cb0f9b92f75ddf3e31aa42c06c5c24da39e8eb24573d9caa::cap_vault::createVault<XBirdAdminCap>(arg1);
    }

    public fun setValidator(arg0: &XBirdAdminCap, arg1: vector<u8>, arg2: &mut ValidatorVault, arg3: &0x2a239a754344a2b8cb0f9b92f75ddf3e31aa42c06c5c24da39e8eb24573d9caa::version::Version) {
