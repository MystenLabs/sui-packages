module 0x842586504342bfc9550361ad5be6d62a53bf8953dca14107494e1903cd63d45d::puddle {
    ...
    public entry fun invest<T0: drop, T1: drop>(arg0: &mut PuddleCap<T0>, arg1: &mut 0x2::coin::TreasuryCap<T1>, arg2: &mut Puddles<T0>, arg3: &mut 0x842586504342bfc9550361ad5be6d62a53bf8953dca14107494e1903cd63d45d::invest::God<T0>, arg4: address, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::vector::contains<0x2::object::ID>(&arg2.investments.invests, &v0)) {
            ...
            0x2::balance::join<T1>(0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T1>>(&mut arg2.investments.balanec_bag, v0), 0x842586504342bfc9550361ad5be6d62a53bf8953dca14107494e1903cd63d45d::invest::buy_coin<T0, T1>(arg1, arg3, arg4, 0x2::balance::split<T0>(&mut arg2.balance, arg5), arg5, arg6));
        } else {
            ...
            0x2::bag::add<0x2::object::ID, 0x2::balance::Balance<T1>>(&mut arg2.investments.balanec_bag, v0, 0x842586504342bfc9550361ad5be6d62a53bf8953dca14107494e1903cd63d45d::invest::buy_coin<T0, T1>(arg1, arg3, arg4, 0x2::balance::split<T0>(&mut arg2.balance, arg5), arg5, arg6));
        };
    }

    public entry fun arbitrage<T0: drop, T1: drop>(arg0: &mut PuddleCap<T1>, arg1: &mut 0x2::coin::TreasuryCap<T0>, arg2: &mut Puddles<T1>, arg3: &mut 0x842586504342bfc9550361ad5be6d62a53bf8953dca14107494e1903cd63d45d::invest::God<T1>, arg4: address, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id_from_address(arg4);
        ...
        let v2 = 0x842586504342bfc9550361ad5be6d62a53bf8953dca14107494e1903cd63d45d::invest::sale_coin<T0, T1>(arg1, arg3, arg4, v1, arg5, arg6);
