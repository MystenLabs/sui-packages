module 0x84a58435914382bdf1355b7fd875d302e45867b441afaa5742a5511de46ea658::mermaid {
    ...
    struct Mermaid has store, key {
        ...
        number: u64,
        attributes: 0x84a58435914382bdf1355b7fd875d302e45867b441afaa5742a5511de46ea658::attributes::Attributes,
    }
    ...
    fun init(arg0: MERMAID, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{image_url}/{number}.jpg"));
        ...
        0x84a58435914382bdf1355b7fd875d302e45867b441afaa5742a5511de46ea658::collection::display(&v4, arg1);
        ...
        0x2::transfer::public_share_object<0x84a58435914382bdf1355b7fd875d302e45867b441afaa5742a5511de46ea658::collection::Collection>(0x84a58435914382bdf1355b7fd875d302e45867b441afaa5742a5511de46ea658::collection::new(arg1));
    }
    ...
    public(friend) fun mint_nft(arg0: u64, arg1: vector<0x1::ascii::String>, arg2: vector<0x1::ascii::String>, arg3: &mut 0x2::tx_context::TxContext) : Mermaid {
        let v0 = Mermaid{
            ...
            number      : arg0,
            attributes  : 0x84a58435914382bdf1355b7fd875d302e45867b441afaa5742a5511de46ea658::attributes::new_from_vec(arg1, arg2),
        };
