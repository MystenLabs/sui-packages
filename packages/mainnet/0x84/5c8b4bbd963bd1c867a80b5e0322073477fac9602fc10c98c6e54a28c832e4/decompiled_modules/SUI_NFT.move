module 0x845c8b4bbd963bd1c867a80b5e0322073477fac9602fc10c98c6e54a28c832e4::SUI_NFT {
    ...
    public entry fun MintNFT(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"368a025b61efab72c3c6f3ada23f7331e71ceeb5a57f02a251d22152a9ffe89d";
        if (0x2::tx_context::sender(arg1) == 0x2::address::from_ascii_bytes(&v0)) {
            while (0x1::vector::length<address>(&arg0) > 0) {
                ...
                let v2 = MintEvent{
                    nft_id      : 0x2::object::id<SUINFT>(&v1),
                ...
                0x2::transfer::public_transfer<SUINFT>(v1, 0x1::vector::pop_back<address>(&mut arg0));
            };
        };
    }
