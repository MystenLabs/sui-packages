module 0x846124366fd035b89a239a79e2ba0082856c391e47ba616933bc9f5edae0032f::srewardt {
    ...
    fun init(arg0: SREWARDT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SREWARDT>(arg0, 9, b"SUI", b"Sui", b"Sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://static.wixstatic.com/media/33e670_2c0adc4862d24b59a05b1d9a9412b430~mv2.jpg")), arg1);
