module 0x845ca4f3dbbe1f8256da61b4734f2bd85d1bcfe223cafc01b6ba4f8e2df484c2::reward7581 {
    struct REWARD7581 has drop {
        dummy_field: bool,
    }

    struct TICKET_7581 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7581(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7581>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7581>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7581, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7581>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7581>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7581>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7581>>(v5, 0x2::tx_context::sender(arg1));
    }
