module 0x846345855dc7a76946777f9cce8a67d3e485314eb621fc01f8ffdd5e21d6c85c::suilink {
    ...
    fun init(arg0: SUILINK, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUILINK>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SuiLink"));
