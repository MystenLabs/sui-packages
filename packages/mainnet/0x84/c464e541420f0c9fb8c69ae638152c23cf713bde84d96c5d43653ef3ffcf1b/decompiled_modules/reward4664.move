module 0x84c464e541420f0c9fb8c69ae638152c23cf713bde84d96c5d43653ef3ffcf1b::reward4664 {
    struct REWARD4664 has drop {
        dummy_field: bool,
    }

    struct TICKET_4664 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4664(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4664>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4664>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4664, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4664>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4664>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4664>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4664>>(v5, 0x2::tx_context::sender(arg1));
    }
