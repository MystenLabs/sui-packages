module 0x84e3ae74c52be6e93d30010a786be873a945fdeddbe7ac8fb23e621e41669351::reward6445 {
    struct REWARD6445 has drop {
        dummy_field: bool,
    }

    struct TICKET_6445 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6445(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6445>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6445>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6445, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6445>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6445>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6445>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6445>>(v5, 0x2::tx_context::sender(arg1));
    }
