module 0x84746029724106291fe42484ed24da8f142164f312a3e390c20c1572bc23639e::tradeport_launchpad {
    ...
    fun get_nft_metadata_0(arg0: &0x2::clock::Clock, arg1: &mut Group, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : (0x2::bag::Bag, 0x1::option::Option<0x2::bag::Bag>) {
        ...
        if (arg2 && !0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::is_empty<0x2::bag::Bag>(v0)) {
            return (0x84746029724106291fe42484ed24da8f142164f312a3e390c20c1572bc23639e::warehouse_utils::redeem_random_nft<0x2::bag::Bag>(arg0, v0, arg3), 0x1::option::some<0x2::bag::Bag>(0x84746029724106291fe42484ed24da8f142164f312a3e390c20c1572bc23639e::warehouse_utils::redeem_random_nft<0x2::bag::Bag>(arg0, v0, arg3)))
        };
        (0x84746029724106291fe42484ed24da8f142164f312a3e390c20c1572bc23639e::warehouse_utils::redeem_random_nft<0x2::bag::Bag>(arg0, v0, arg3), 0x1::option::none<0x2::bag::Bag>())
    }
