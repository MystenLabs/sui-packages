module 0x8459849f23d29186edf9b55edb8b4f8bfc2da8865a78d12e6daf1aa08f0b9f23::test_sui_drop_collection {
    struct TEST_SUI_DROP_COLLECTION has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TEST_SUI_DROP_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TEST_SUI_DROP_COLLECTION>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Test SUI Drop Collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Test SUI Drop Collection "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidj2g2svo7vfizbsrgg45j44abzmzsxqoi3nnwk2away625iy75ji"));
