module 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::bank {
    ...
    public(friend) fun deposit_to_asset_bank<T0>(arg0: &mut AssetBank, arg1: 0x1::string::String, arg2: address, arg3: u64, arg4: &mut 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) : (u128, u64) {
        assert!(is_asset_supported(arg0, arg1), 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::errors::asset_not_supported());
        let v0 = get_supported_asset(arg0, arg1);
        assert!(get_asset_type<T0>() == v0.type, 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::errors::asset_type_and_symbol_mismatch());
        let v1 = 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::utils::convert_to_protocol_decimals(arg3, v0.decimals);
        assert!(v1 >= v0.min_deposit && v1 <= v0.max_deposit, 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::errors::invalid_quantity());
        assert!(arg3 <= 0x2::coin::value<T0>(arg4), 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::errors::coin_does_not_have_enough_amount());
    ...
    public fun get_asset_with_provided_usd_value(arg0: &0x2::table::Table<0x1::string::String, Asset>, arg1: 0x1::string::String, arg2: u64) : u64 {
        if (0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::utils::is_empty_string(arg1)) {
            return arg2
        };
        assert!(asset_exists_in_table(arg0, arg1), 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::errors::asset_not_supported());
        let (_, _, _, v3, v4, _) = asset_values(*0x2::table::borrow<0x1::string::String, Asset>(arg0, arg1));
        0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::utils::base_div(arg2, 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::utils::base_mul(v4, v3))
    }

    public(friend) fun get_external_deposit(arg0: &mut AssetBank, arg1: u128) : (address, address, u64, 0x1::string::String) {
        assert!(0x2::table::contains<u128, Deposit>(&arg0.deposits, arg1), 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::errors::invalid_nonce());
    ...
    public(friend) fun support_asset<T0>(arg0: &mut AssetBank, arg1: 0x1::string::String, arg2: u8, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64) : Asset {
        assert!(!is_asset_supported(arg0, arg1), 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::errors::asset_already_supported());
        assert!(arg6 > 0 && arg6 < arg7, 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::errors::invalid_quantity());
    ...
    public(friend) fun withdraw_from_asset_bank<T0>(arg0: &mut AssetBank, arg1: 0x1::string::String, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = get_supported_asset(arg0, arg1);
        assert!(get_asset_type<T0>() == v0.type, 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::errors::asset_type_and_symbol_mismatch());
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut arg0.id, arg1), (0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::utils::convert_to_provided_decimals((arg3 as u64), v0.decimals) as u64), arg4), arg2);
    }
