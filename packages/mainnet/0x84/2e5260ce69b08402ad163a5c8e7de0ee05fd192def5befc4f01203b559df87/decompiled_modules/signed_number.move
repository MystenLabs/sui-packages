module 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::signed_number {
    ...
    public fun div_uint(arg0: Number, arg1: u64) : Number {
        let v0 = 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::utils::base_div(arg0.value, arg1);
    ...
    public fun mul_uint(arg0: Number, arg1: u64) : Number {
        let v0 = 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::utils::base_mul(arg0.value, arg1);
        let v1 = v0 == 0 || arg0.sign;
        Number{
            value : v0,
            sign  : v1,
    ...
    public fun one() : Number {
        Number{
            value : 0x842e5260ce69b08402ad163a5c8e7de0ee05fd192def5befc4f01203b559df87::constants::base_uint(),
            sign  : true,
        }
    }
