module 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault {
    ...
    public entry fun redeem_management_fee<T0, T1>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::object::id_address<ManagementFee>(&arg2.management_fee);
        assert!(0x2::table::contains<address, vector<PendingRedeem>>(&arg2.pending_redeems, v0), 7);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        let v2 = 0x2::table::remove<address, vector<PendingRedeem>>(&mut arg2.pending_redeems, v0);
        let v3 = 0x1::vector::empty<PendingRedeem>();
        let v4 = 0x1::vector::empty<PendingRedeem>();
        let v5 = 0;
        while (v5 < 0x1::vector::length<PendingRedeem>(&v2)) {
            let v6 = 0x1::vector::borrow<PendingRedeem>(&v2, v5);
            if (v6.withdraw_time <= v1 - arg2.lock_duration_ms) {
                0x1::vector::push_back<PendingRedeem>(&mut v3, *v6);
            } else {
                0x1::vector::push_back<PendingRedeem>(&mut v4, *v6);
            };
            v5 = v5 + 1;
        };
        if (0x1::vector::length<PendingRedeem>(&v4) > 0) {
            0x2::table::add<address, vector<PendingRedeem>>(&mut arg2.pending_redeems, v0, v4);
        };
        let v7 = 0x1::vector::length<PendingRedeem>(&v3);
        assert!(v7 > 0, 7);
        let v8 = 0;
        let v9 = 0;
        while (v9 < v7) {
            v8 = v8 + 0x1::vector::borrow<PendingRedeem>(&v3, v9).amount;
            v9 = v9 + 1;
        };
        assert!(arg2.available_liquidity >= (v8 as u128), 2);
        arg2.available_liquidity = arg2.available_liquidity - (v8 as u128);
        arg2.pending_redemptions = arg2.pending_redemptions - (v8 as u128);
        assert!(0x2::coin::value<T0>(0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg2.coin_store.coin)) >= v8, 2);
        arg2.management_fee.total_claimed_fee = arg2.management_fee.total_claimed_fee + v8;
        arg2.management_fee.total_pending_redeem_fee = arg2.management_fee.total_pending_redeem_fee - v8;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg2.coin_store.coin), v8, arg4), arg2.fee_receiver);
        let v10 = RedeemManagementFeeEvent{
            receiver : arg2.fee_receiver,
            amount   : v8,
            vault_id : 0x2::object::id<Vault<T0, T1>>(arg2),
            time     : v1,
        };
        0x2::event::emit<RedeemManagementFeeEvent>(v10);
    }
    ...
    public entry fun redeem_performance_fee<T0, T1>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 1, 5);
        assert!(check_operator(arg1, 0x2::tx_context::sender(arg4), 0x2::object::id<OperatorCap>(arg0)), 1);
        let v0 = 0x2::object::id_address<PerformanceFee>(&arg2.performance_fee);
        assert!(0x2::table::contains<address, vector<PendingRedeem>>(&arg2.pending_redeems, v0), 7);
        ...
        arg2.performance_fee.total_claimed_fee = arg2.performance_fee.total_claimed_fee + v7;
        arg2.performance_fee.total_pending_redeem_fee = arg2.performance_fee.total_pending_redeem_fee - v7;
        ...
        let v9 = RedeemPerformanceFeeEvent{
            receiver : arg2.fee_receiver,
            amount   : v7,
            vault_id : 0x2::object::id<Vault<T0, T1>>(arg2),
        };
        0x2::event::emit<RedeemPerformanceFeeEvent>(v9);
    }
    ...
    public entry fun withdraw_management_fee<T0, T1>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(check_operator(arg1, 0x2::tx_context::sender(arg4), 0x2::object::id<OperatorCap>(arg0)), 1);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(arg2.management_fee.latest_withdraw_time + arg2.management_fee.period_duration <= v0, 14);
        let v1 = calculate_fee((arg2.liquidity as u64), arg2.management_fee.fee_bps);
        assert!(v1 > 0, 13);
        let v2 = 0x2::object::id_address<ManagementFee>(&arg2.management_fee);
        let v3 = PendingRedeem{
            withdraw_time : v0,
            amount        : v1,
        };
        if (0x2::table::contains<address, vector<PendingRedeem>>(&arg2.pending_redeems, v2)) {
            0x1::vector::push_back<PendingRedeem>(0x2::table::borrow_mut<address, vector<PendingRedeem>>(&mut arg2.pending_redeems, v2), v3);
        } else {
            let v4 = 0x1::vector::empty<PendingRedeem>();
            0x1::vector::push_back<PendingRedeem>(&mut v4, v3);
            0x2::table::add<address, vector<PendingRedeem>>(&mut arg2.pending_redeems, v2, v4);
        };
        arg2.pending_redemptions = arg2.pending_redemptions + (v1 as u128);
        arg2.management_fee.total_fee = arg2.performance_fee.total_fee + v1;
        arg2.management_fee.total_pending_redeem_fee = arg2.management_fee.total_pending_redeem_fee + v1;
        arg2.management_fee.latest_withdraw_time = v0;
        arg2.liquidity = arg2.liquidity - (v1 as u128);
        arg2.last_update = v0;
        let v5 = 0x2::coin::total_supply<T1>(&arg2.treasury_cap);
        if (v5 > 1000000 && arg2.liquidity >= (v5 as u128)) {
            arg2.rate = ((arg2.liquidity * (1000000 as u128) / (v5 as u128)) as u64);
        };
        let v6 = WithdrawManagementFeeEvent{
            amount   : v1,
            vault_id : 0x2::object::id<Vault<T0, T1>>(arg2),
            time     : v0,
            rate     : arg2.rate,
        };
        0x2::event::emit<WithdrawManagementFeeEvent>(v6);
    }
    ...
    public entry fun withdraw_performance_fee<T0, T1>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(check_operator(arg1, 0x2::tx_context::sender(arg4), 0x2::object::id<OperatorCap>(arg0)), 1);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        let v1 = arg2.performance_fee.total_available_fee;
        assert!(v1 > 0, 12);
        let v2 = 0x2::object::id_address<PerformanceFee>(&arg2.performance_fee);
        let v3 = PendingRedeem{
            withdraw_time : v0,
            amount        : v1,
        };
        ...
        arg2.pending_redemptions = arg2.pending_redemptions + (v1 as u128);
        arg2.performance_fee.total_available_fee = arg2.performance_fee.total_available_fee - v1;
        arg2.performance_fee.total_pending_redeem_fee = arg2.performance_fee.total_pending_redeem_fee + v1;
        let v5 = WithdrawPerformanceFeeEvent{
            amount   : v1,
            vault_id : 0x2::object::id<Vault<T0, T1>>(arg2),
            time     : v0,
        };
        0x2::event::emit<WithdrawPerformanceFeeEvent>(v5);
    }
