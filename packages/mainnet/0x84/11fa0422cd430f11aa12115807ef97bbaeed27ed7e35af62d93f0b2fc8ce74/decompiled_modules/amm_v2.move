module 0x8411fa0422cd430f11aa12115807ef97bbaeed27ed7e35af62d93f0b2fc8ce74::amm_v2 {
    ...
    fun calculate_lp_mint_amount(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u128) : u64 {
        if (arg0 == 0) {
            ...
            let v7 = v6 * 1000000000000 / (1000000 + (arg0 as u128)) / 1000000;
            if (v7 < 1000) {
                1000
            } else {
                (v7 as u64)
    ...
    public fun create_pool_with_lp_tokens<T0, T1>(arg0: &mut Global, arg1: &mut PoolRegistry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: u64, arg6: u8, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: vector<u8>, arg11: u64, arg12: u64, arg13: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v3 = LPMetadata{
            ...
            decimals    : arg6,
            icon_url    : 0x1::string::utf8(arg10),
        };
        let v4 = Pool<T0, T1>{
        ...
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"pool_id"));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"token_x"));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"token_y"));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"decimals"));
        let v8 = 0x1::vector::empty<0x1::string::String>();
        let v9 = &mut v8;
        0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(arg7));
        0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(arg9));
        0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(arg8));
        0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(arg10));
        0x1::vector::push_back<0x1::string::String>(v9, 0x2::address::to_string(0x2::object::id_to_address(&v5)));
        0x1::vector::push_back<0x1::string::String>(v9, v4.lp_metadata.coin_x_type);
        0x1::vector::push_back<0x1::string::String>(v9, v4.lp_metadata.coin_y_type);
        0x1::vector::push_back<0x1::string::String>(v9, u64_to_string((arg6 as u64)));
        let v10 = 0x2::display::new_with_fields<LPToken<T0, T1>>(&arg0.publisher, v6, v8, arg13);
        0x2::display::add<LPToken<T0, T1>>(&mut v10, 0x1::string::utf8(b"amount"), 0x1::string::utf8(b"{amount}"));
        0x2::display::update_version<LPToken<T0, T1>>(&mut v10);
        0x2::transfer::public_transfer<0x2::display::Display<LPToken<T0, T1>>>(v10, 0x2::tx_context::sender(arg13));
        let v11 = 0x2::coin::value<T0>(&arg3);
        if (v11 > 0) {
            0x2::balance::join<T0>(&mut v4.reserve_x, 0x2::coin::into_balance<T0>(arg3));
            let v12 = calculate_lp_mint_amount(0, v11, 0, 0x2::balance::value<T0>(&v4.reserve_x), 0x2::balance::value<T1>(&v4.reserve_y), arg11, arg12, v2);
            if (v12 > 0) {
                v4.lp_supply = v12;
                0x2::table::add<address, u64>(&mut v4.lp_balances, 0x2::tx_context::sender(arg13), v12);
                let v13 = LPToken<T0, T1>{
                    id      : 0x2::object::new(arg13),
                    pool_id : v5,
                    amount  : v12,
                };
                0x2::transfer::transfer<LPToken<T0, T1>>(v13, 0x2::tx_context::sender(arg13));
            };
        } else {
        ...
        0x2::event::emit<PoolCreated>(v14);
    ...
    fun init(arg0: AMM_V2, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Global{
            ...
            pool_counter          : 0,
            publisher             : 0x2::package::claim<AMM_V2>(arg0, arg1),
        };
        let v1 = PoolRegistry{
            id            : 0x2::object::new(arg1),
