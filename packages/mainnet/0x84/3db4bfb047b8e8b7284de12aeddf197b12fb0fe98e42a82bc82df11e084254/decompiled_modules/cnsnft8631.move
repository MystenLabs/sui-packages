module 0x843db4bfb047b8e8b7284de12aeddf197b12fb0fe98e42a82bc82df11e084254::cnsnft8631 {
    struct CNSNFT8631 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8631, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8631>(arg0, arg1);
