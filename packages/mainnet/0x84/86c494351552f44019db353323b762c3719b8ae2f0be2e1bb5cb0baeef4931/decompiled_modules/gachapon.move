module 0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::gachapon {
    ...
    struct Gachapon<phantom T0> has key {
        id: 0x2::object::UID,
        lootbox: 0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::big_vector::BigVector<Egg>,
    ...
    public fun lock<T0, T1: store + key>(arg0: &mut Gachapon<T0>, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::transfer_policy::TransferPolicy<T1>, arg3: T1, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v1;
        0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::big_vector::push_back<Egg>(&mut arg0.lootbox, v3);
    ...
    public fun take<T0>(arg0: &mut Gachapon<T0>, arg1: &mut 0x2::kiosk::Kiosk, arg2: &KeeperCap, arg3: u64) : Egg {
        ...
        assert_valid_kiosk<T0>(arg0, arg1);
        let v0 = 0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::big_vector::swap_remove<Egg>(&mut arg0.lootbox, arg3);
        let v1 = EggOut{
            gachapon_id : 0x2::object::id<Gachapon<T0>>(arg0),
    ...
    public fun close<T0>(arg0: Gachapon<T0>, arg1: KeeperCap, arg2: 0x2::kiosk::Kiosk, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        if (!0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::big_vector::is_empty<Egg>(&v10)) {
            err_delete_non_empty_gachapon();
        };
        0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::big_vector::destroy_empty<Egg>(v10);
    ...
    public fun create<T0>(arg0: u64, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : KeeperCap {
        ...
        let v4 = Gachapon<T0>{
            ...
            lootbox   : 0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::big_vector::new<Egg>(slice_size(), arg2),
    ...
    entry fun draw<T0>(arg0: &mut Gachapon<T0>, arg1: &0x2::random::Random, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < arg2) {
            ...
            let v3 = 0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::big_vector::swap_remove<Egg>(&mut arg0.lootbox, v2);
            let v4 = EggOut{
                gachapon_id : 0x2::object::id<Gachapon<T0>>(arg0),
                egg_id      : 0x2::object::id<Egg>(&v3),
    ...
    entry fun draw_free_spin<T0, T1: store + key>(arg0: &mut Gachapon<T0>, arg1: &T1, arg2: &0x2::random::Random, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::big_vector::swap_remove<Egg>(&mut arg0.lootbox, v4);
        let v6 = EggOut{
            gachapon_id : 0x2::object::id<Gachapon<T0>>(arg0),
    ...
    entry fun draw_free_spin_with_kiosk<T0, T1: store + key>(arg0: &mut Gachapon<T0>, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: vector<0x2::object::ID>, arg4: &0x2::random::Random, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<0x2::object::ID>(&arg3) > 0) {
            ...
            let v9 = 0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::big_vector::swap_remove<Egg>(&mut arg0.lootbox, v8);
            let v10 = EggOut{
                gachapon_id : 0x2::object::id<Gachapon<T0>>(arg0),
    ...
    public fun egg_supply<T0>(arg0: &Gachapon<T0>) : u64 {
        0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::big_vector::length<Egg>(lootbox<T0>(arg0))
    }
    ...
    public fun lootbox<T0>(arg0: &Gachapon<T0>) : &0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::big_vector::BigVector<Egg> {
        &arg0.lootbox
    }
    ...
    public fun stuff<T0>(arg0: &mut Gachapon<T0>, arg1: &KeeperCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0;
        while (v0 < arg2) {
            0xe181e5d2f61a661cf2d61270dc5fb33a024ce21d32ef06786bc367f76fea541b::big_vector::push_back<Egg>(&mut arg0.lootbox, new_empty_egg(arg3));
            v0 = v0 + 1;
        };
