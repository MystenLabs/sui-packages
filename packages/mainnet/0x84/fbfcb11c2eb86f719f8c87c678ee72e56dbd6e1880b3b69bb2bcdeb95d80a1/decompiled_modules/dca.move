module 0x33d51e66410b5d98fdd013d16194ab35b43d5b8fc76523876cd5f971c52084dd::dca {
    ...
    public fun new<T0, T1, T2: drop>(arg0: &Settings, arg1: &TradePolicy, arg2: &0x2::clock::Clock, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: u64, arg6: u8, arg7: u64, arg8: u64, arg9: u64, arg10: address, arg11: &mut 0x2::tx_context::TxContext) : DCA<T0, T1> {
        assert!(30000000 > arg9, 6);
        let v0 = 0x1::type_name::get<T2>();
        assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg1.whitelist, &v0), 9);
        assert_every(arg4, arg6);
        let v1 = 0xb37fe85436cfb5f0a4106021cfa0990d6a9be9f09fd137796a90558698543aeb::math64::div_up(0x2::coin::value<T0>(&arg3), arg5);
        let v2 = if (arg5 != 0) {
            if (v1 != 0) {
                v1 * arg5 >= 0x2::coin::value<T0>(&arg3)
            } else {
                false
            }
        } else {
        ...
        let v3 = DCA<T0, T1>{
            ...
            start_timestamp        : timestamp_s(arg2),
            last_trade_timestamp   : 0,
            every                  : arg4,
            remaining_orders       : arg5,
            time_scale             : arg6,
            cooldown               : convert_to_timestamp(arg6) * arg4,
            input_balance          : 0x2::coin::into_balance<T0>(arg3),
            amount_per_trade       : v1,
            min                    : arg7,
            max                    : arg8,
            active                 : true,
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Settings{
            ...
            treasury : @0xdd224f2287f0b38693555c6077abe85fcb4aa13e355ad54bc167611896b007e6,
        };
        let v1 = TradePolicy{
            id        : 0x2::object::new(arg0),
            whitelist : 0x2::vec_set::empty<0x1::type_name::TypeName>(),
        };
        0x2::transfer::share_object<Settings>(v0);
        0x2::transfer::share_object<TradePolicy>(v1);
        let v2 = Admin{id: 0x2::object::new(arg0)};
        0x2::transfer::public_transfer<Admin>(v2, 0x2::tx_context::sender(arg0));
    }
    ...
    public fun request<T0, T1>(arg0: &mut DCA<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : (Request<T1>, 0x2::coin::Coin<T0>) {
        ...
        let v1 = take<T0, T1>(arg0, arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v1, 0xb37fe85436cfb5f0a4106021cfa0990d6a9be9f09fd137796a90558698543aeb::math64::mul_div_up(0x2::coin::value<T0>(&v1), arg0.fee_percent, 1000000000) / 2, arg1), arg0.treasury);
        (v0, v1)
    }
    ...
    fun resolve<T0, T1>(arg0: &mut DCA<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::balance::split<T1>(&mut v2, 0xb37fe85436cfb5f0a4106021cfa0990d6a9be9f09fd137796a90558698543aeb::math64::mul_div_up(v1, arg0.fee_percent, 1000000000) / 2);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v3, arg3), arg0.treasury);
    ...
    public fun set_treasury(arg0: &mut Settings, arg1: &Admin, arg2: address) {
        arg0.treasury = arg2;
    }
    ...
    fun take<T0, T1>(arg0: &mut DCA<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.input_balance, 0xb37fe85436cfb5f0a4106021cfa0990d6a9be9f09fd137796a90558698543aeb::math64::min(arg0.amount_per_trade, 0x2::balance::value<T0>(&arg0.input_balance))), arg1)
    }
    ...
    public fun treasury<T0, T1>(arg0: &DCA<T0, T1>) : address {
        arg0.treasury
    }
