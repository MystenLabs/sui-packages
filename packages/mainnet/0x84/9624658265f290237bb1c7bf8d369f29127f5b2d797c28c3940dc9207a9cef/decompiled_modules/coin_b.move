module 0x849624658265f290237bb1c7bf8d369f29127f5b2d797c28c3940dc9207a9cef::coin_b {
    ...
    fun init(arg0: COIN_B, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<COIN_B>(arg0, 6, b"MUB", b"COIN_B", b"MuyeC s Coin_B", 0x1::option::none<0x2::url::Url>(), arg1);
