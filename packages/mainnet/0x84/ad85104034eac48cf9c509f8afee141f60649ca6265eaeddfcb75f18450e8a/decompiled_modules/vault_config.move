module 0x84ad85104034eac48cf9c509f8afee141f60649ca6265eaeddfcb75f18450e8a::vault_config {
    ...
    public(friend) fun borrow_withdraw_cap(arg0: &mut VaultConfig) : &mut 0x33a62238f7d3dedbd2a38fd83af78ece54b5e005eac94915741b3f364b53230d::cloud_wallet_config::QuickWithdrawCap {
        0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x33a62238f7d3dedbd2a38fd83af78ece54b5e005eac94915741b3f364b53230d::cloud_wallet_config::QuickWithdrawCap>(&mut arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"))
    }
    ...
    public fun set_cloud_wallet_withdraw_cap(arg0: &mut VaultConfig, arg1: 0x2::transfer::Receiving<0x33a62238f7d3dedbd2a38fd83af78ece54b5e005eac94915741b3f364b53230d::cloud_wallet_config::QuickWithdrawCap>, arg2: &mut 0x2::tx_context::TxContext) {
        only_admin(arg0, arg2);
        0x2::dynamic_field::add<0x1::ascii::String, 0x33a62238f7d3dedbd2a38fd83af78ece54b5e005eac94915741b3f364b53230d::cloud_wallet_config::QuickWithdrawCap>(&mut arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"), 0x2::transfer::public_receive<0x33a62238f7d3dedbd2a38fd83af78ece54b5e005eac94915741b3f364b53230d::cloud_wallet_config::QuickWithdrawCap>(&mut arg0.id, arg1));
    }
