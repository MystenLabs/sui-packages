module 0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::coin_escrow {
    ...
    struct TokenEscrow<phantom T0, phantom T1> has store, key {
        id: 0x2::object::UID,
        market_state: 0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::market_state::MarketState,
    ...
    public fun new<T0, T1>(arg0: 0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::market_state::MarketState, arg1: &mut 0x2::tx_context::TxContext) : TokenEscrow<T0, T1> {
        TokenEscrow<T0, T1>{
    ...
    public fun assert_quantum_invariant<T0, T1>(arg0: &TokenEscrow<T0, T1>) {
        if (0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::market_state::is_finalized(&arg0.market_state)) {
            let v0 = 0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::market_state::get_winning_outcome(&arg0.market_state);
    ...
    public fun burn_conditional<T0, T1, T2>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: 0x2::coin::Coin<T2>, arg4: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun burn_conditional_asset_and_withdraw<T0, T1, T2>(arg0: &mut TokenEscrow<T0, T1>, arg1: 0x2::coin::Coin<T2>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::market_state::is_finalized(&arg0.market_state), 101);
        let v0 = 0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::market_state::get_winning_outcome(&arg0.market_state);
    ...
    public fun decrement_lp_backing<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun decrement_outcome_allocation<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun decrement_pool_claim<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun decrement_supply_for_outcome<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: u64, arg4: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
        assert!(arg1 < arg0.outcome_count, 5);
        if (arg2) {
            let v0 = 0x1::vector::borrow_mut<u64>(&mut arg0.asset_supplies, arg1);
            assert!(*v0 >= arg3, 103);
    ...
    public fun decrement_user_backing<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun decrement_wrapped_balance<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: u64, arg4: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun deposit_spot_liquidity<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun emergency_remove_asset_treasury_cap<T0, T1, T2>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::emergency_cap::EmergencyCap, arg3: &0x2::clock::Clock) : 0x2::coin::TreasuryCap<T2> {
        0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::emergency_cap::assert_ready(arg2, arg3);
        assert!(arg1 < arg0.outcome_count, 5);
        let v0 = AssetCapKey{outcome_index: arg1};
        0x2::dynamic_field::remove<AssetCapKey, 0x2::coin::TreasuryCap<T2>>(&mut arg0.id, v0)
    }

    public fun emergency_remove_stable_treasury_cap<T0, T1, T2>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::emergency_cap::EmergencyCap, arg3: &0x2::clock::Clock) : 0x2::coin::TreasuryCap<T2> {
        0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::emergency_cap::assert_ready(arg2, arg3);
        assert!(arg1 < arg0.outcome_count, 5);
    ...
    public fun emergency_withdraw_spot_balances<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::emergency_cap::EmergencyCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
    ...
    public fun get_market_state<T0, T1>(arg0: &TokenEscrow<T0, T1>) : &0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::market_state::MarketState {
        &arg0.market_state
    }

    public fun get_market_state_mut<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) : &mut 0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::market_state::MarketState {
    ...
    public fun increment_dust_created<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: u64, arg4: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
        if (arg2) {
            let v0 = 0x1::vector::borrow_mut<u64>(&mut arg0.dust_created_asset, arg1);
            let v1 = if (*v0 <= 18446744073709551615 - arg3) {
                *v0 + arg3
            } else {
            ...
            *v0 = v1;
            ...
            let v2 = 0x1::vector::borrow_mut<u64>(&mut arg0.dust_created_stable, arg1);
            let v3 = if (*v2 <= 18446744073709551615 - arg3) {
                *v2 + arg3
            } else {
                18446744073709551615
            };
    ...
    public fun increment_supplies_for_all_outcomes<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
        assert!(arg0.outcome_count > 0, 4);
        let v0 = 0;
        while (v0 < arg0.outcome_count) {
            if (arg1 > 0) {
                let v1 = 0x1::vector::borrow_mut<u64>(&mut arg0.asset_supplies, v0);
                assert!(*v1 <= 18446744073709551615 - arg1, 104);
                *v1 = *v1 + arg1;
                let v2 = 0x1::vector::borrow_mut<u64>(&mut arg0.outcome_escrowed_asset, v0);
                assert!(*v2 <= 18446744073709551615 - arg1, 104);
                *v2 = *v2 + arg1;
                let v3 = 0x1::vector::borrow_mut<u64>(&mut arg0.pool_claim_asset, v0);
                assert!(*v3 <= 18446744073709551615 - arg1, 104);
                *v3 = *v3 + arg1;
            };
            if (arg2 > 0) {
                let v4 = 0x1::vector::borrow_mut<u64>(&mut arg0.stable_supplies, v0);
                assert!(*v4 <= 18446744073709551615 - arg2, 104);
                *v4 = *v4 + arg2;
                let v5 = 0x1::vector::borrow_mut<u64>(&mut arg0.outcome_escrowed_stable, v0);
                assert!(*v5 <= 18446744073709551615 - arg2, 104);
                *v5 = *v5 + arg2;
                let v6 = 0x1::vector::borrow_mut<u64>(&mut arg0.pool_claim_stable, v0);
                assert!(*v6 <= 18446744073709551615 - arg2, 104);
                *v6 = *v6 + arg2;
            };
            v0 = v0 + 1;
        };
    ...
    public fun increment_wrapped_balance<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: u64, arg4: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public(friend) fun increment_wrapped_balance_pkg<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: u64) {
        if (arg2) {
            let v0 = 0x1::vector::borrow_mut<u64>(&mut arg0.wrapped_asset_balances, arg1);
            assert!(*v0 <= 18446744073709551615 - arg3, 104);
            *v0 = *v0 + arg3;
        } else {
            let v1 = 0x1::vector::borrow_mut<u64>(&mut arg0.wrapped_stable_balances, arg1);
    ...
    public fun lp_deposit_quantum<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) : (u64, u64) {
        assert!(arg0.outcome_count > 0, 4);
    ...
    public fun lp_withdraw_quantum<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::market_state::is_finalized(&arg0.market_state), 101);
        let v0 = 0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::market_state::get_winning_outcome(&arg0.market_state);
    ...
    public fun market_state_id<T0, T1>(arg0: &TokenEscrow<T0, T1>) : 0x2::object::ID {
        0x2::object::id<0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::market_state::MarketState>(&arg0.market_state)
    }

    public fun mint_conditional<T0, T1, T2>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: bool, arg3: u64, arg4: &mut 0x2::tx_context::TxContext, arg5: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) : 0x2::coin::Coin<T2> {
    ...
    public fun register_conditional_caps<T0, T1, T2, T3>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: 0x2::coin::TreasuryCap<T2>, arg3: 0x2::coin::TreasuryCap<T3>) {
        assert!(arg1 < 0x844fcce6ab4bbfb44b09431b0f07765d671d2aee3122f578b15b2402c2033781::market_state::outcome_count(&arg0.market_state), 5);
        assert!(arg1 == arg0.outcome_count, 1);
        assert!(0x2::coin::total_supply<T2>(&arg2) == 0, 105);
        assert!(0x2::coin::total_supply<T3>(&arg3) == 0, 105);
        let v0 = AssetCapKey{outcome_index: arg1};
        let v1 = StableCapKey{outcome_index: arg1};
    ...
    public fun track_collected_protocol_fees<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun track_swap_asset_to_stable<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
        let v0 = 0x1::vector::borrow_mut<u64>(&mut arg0.outcome_escrowed_asset, arg1);
        assert!(*v0 >= arg2, 103);
        let v1 = 0x1::vector::borrow_mut<u64>(&mut arg0.outcome_escrowed_stable, arg1);
        assert!(*v1 <= 18446744073709551615 - arg3, 104);
    ...
    public fun track_swap_stable_to_asset<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
    ...
    public fun track_system_swap_asset_to_stable<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
        let v0 = 0x1::vector::borrow_mut<u64>(&mut arg0.asset_supplies, arg1);
        assert!(*v0 >= arg2, 103);
        *v0 = *v0 - arg2;
        let v1 = 0x1::vector::borrow_mut<u64>(&mut arg0.stable_supplies, arg1);
        ...
        *v3 = *v3 + arg3;
        ...
        assert!(*v5 <= 18446744073709551615 - arg3, 104);
        *v5 = *v5 + arg3;
    }

    public fun track_system_swap_stable_to_asset<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) {
        let v0 = 0x1::vector::borrow_mut<u64>(&mut arg0.stable_supplies, arg1);
        assert!(*v0 >= arg2, 103);
        *v0 = *v0 - arg2;
        let v1 = 0x1::vector::borrow_mut<u64>(&mut arg0.asset_supplies, arg1);
    ...
    public fun withdraw_asset_balance<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext, arg3: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) : 0x2::coin::Coin<T0> {
    ...
    public fun withdraw_stable_balance<T0, T1>(arg0: &mut TokenEscrow<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext, arg3: &0xd515e9008496dd209ffb71caf0e5783073385cde00083c8a1437a32093aab95c::escrow_mutation_auth::EscrowMutationAuth) : 0x2::coin::Coin<T1> {
