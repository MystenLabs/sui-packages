module 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator {
    ...
    public(friend) fun new(arg0: 0x2::object::ID, arg1: 0x1::string::String, arg2: address, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: u64, arg7: u32, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v1 = CurrentResult{
            result           : 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::zero(),
            timestamp_ms     : 0,
            min_timestamp_ms : 0,
            max_timestamp_ms : 0,
            min_result       : 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::zero(),
            max_result       : 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::zero(),
            stdev            : 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::zero(),
            range            : 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::zero(),
            mean             : 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::zero(),
        };
        let v2 = UpdateState{
    ...
    fun add_i256(arg0: u256, arg1: bool, arg2: u256, arg3: bool) : (u256, bool) {
        if (arg1 && arg3) {
            return (arg0 + arg2, true)
        };
        if (!arg1 && arg3) {
    ...
    public(friend) fun add_result(arg0: &mut Aggregator, arg1: 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal, arg2: u64, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock) {
    ...
    fun compute_current_result(arg0: &Aggregator, arg1: u64) : 0x1::option::Option<CurrentResult> {
        ...
        let v7 = 0;
        let v8 = 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::max_value();
        let v9 = 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::zero();
        ...
        while (v18 < 0x1::vector::length<u64>(v17)) {
            ...
            let v20 = 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::value(&v19.result);
            let v21 = 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::neg(&v19.result);
            let v22 = v16 + 1;
            v16 = v22;
            ...
            let (v29, v30) = add_i256(v14, v15, (v23 as u256) * (v27 as u256), v24 != v28);
            v15 = v30;
            v14 = v29;
            v7 = v7 + v20;
            let v31 = &v8;
            v8 = 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::min(v31, &v19.result);
            let v32 = &v9;
            v9 = 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::max(v32, &v19.result);
        ...
        let v36 = CurrentResult{
            ...
            min_result       : v8,
            max_result       : v9,
            stdev            : 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::new(sqrt(v14 / ((v16 - 1) as u256)), false),
            range            : 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::sub(&v9, &v8),
            mean             : 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::new(v12, false),
        };
    ...
    public fun max_result(arg0: &CurrentResult) : &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal {
        &arg0.max_result
    }
    ...
    public fun mean(arg0: &CurrentResult) : &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal {
        &arg0.mean
    }

    fun median_result(arg0: &UpdateState, arg1: &mut vector<u64>) : (0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal, u64) {
        let v0 = &arg0.results;
        ...
        while (v3 < v4) {
            let v5 = v3;
            while (v3 < v4) {
                if (0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::lt(&0x1::vector::borrow<Update>(v0, *0x1::vector::borrow<u64>(arg1, v3)).result, &0x1::vector::borrow<Update>(v0, *0x1::vector::borrow<u64>(arg1, v4)).result)) {
    ...
    public fun min_result(arg0: &CurrentResult) : &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal {
        &arg0.min_result
    }
    ...
    public fun range(arg0: &CurrentResult) : &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal {
        &arg0.range
    }

    public fun result(arg0: &CurrentResult) : &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal {
        &arg0.result
    }
    ...
    fun set_update(arg0: &mut UpdateState, arg1: 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal, arg2: 0x2::object::ID, arg3: u64) {
    ...
    public fun sqrt(arg0: u256) : u128 {
        if (arg0 == 0) {
            return 0
        };
        let v0 = arg0;
    ...
    public fun stdev(arg0: &CurrentResult) : &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal {
        &arg0.stdev
    }
