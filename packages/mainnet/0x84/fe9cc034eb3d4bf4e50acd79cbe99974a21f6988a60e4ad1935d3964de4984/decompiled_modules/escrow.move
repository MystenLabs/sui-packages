module 0x84fe9cc034eb3d4bf4e50acd79cbe99974a21f6988a60e4ad1935d3964de4984::escrow {
    ...
    public fun confirm_offer_accepted<T0: store + key>(arg0: OfferWrapper<T0>, arg1: 0x2::transfer_policy::TransferRequest<T0>, arg2: &0x2::transfer_policy::TransferPolicy<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        emit_accept_offer_event(v3.kiosk, 0x2::object::id<Offer<T0>>(&v3), v3.item, v3.price, v3.royalty_fee, v3.market_fee, v3.offer_cap);
        let Offer {
            id          : v4,
            kiosk       : _,
            owner       : v6,
        ...
        emit_receipt_created_event(0x2::object::id<Receipt<T0>>(&v13), v12);
        0x2::transfer::transfer<Receipt<T0>>(v13, v6);
        let v14 = 0x2::coin::zero<0x2::sui::SUI>(arg3);
        0x2::balance::join<0x2::sui::SUI>(0x2::coin::balance_mut<0x2::sui::SUI>(&mut v14), v11);
    ...
    public fun decline_offer<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: &T0, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        emit_receipt_created_event(0x2::object::id<Receipt<T0>>(&v12), v11);
        0x2::transfer::transfer<Receipt<T0>>(v12, v5);
        let v13 = 0x2::coin::zero<0x2::sui::SUI>(arg3);
        emit_decline_offer_event(v4, 0x2::object::id<Offer<T0>>(&v2), v6, v7, v8, v9, v11);
    ...
    public fun destroy_offer_cap<T0: store + key>(arg0: OfferCap<T0>, arg1: Receipt<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v4;
        let v6 = v3;
        assert!(0x2::object::uid_as_inner(&v2) == &v5, 413);
        emit_receipt_destroyed_event(0x2::object::uid_to_inner(&v6), v5);
        0x2::object::delete(v2);
        0x2::object::delete(v6);
    }

    public(friend) fun emit_accept_offer_event(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: u64, arg6: 0x2::object::ID) {
    ...
    public(friend) fun emit_decline_offer_event(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: u64, arg6: 0x2::object::ID) {
    ...
    public(friend) fun emit_receipt_created_event(arg0: 0x2::object::ID, arg1: 0x2::object::ID) {
        let v0 = ReceiptCreatedEvent{
            receipt_id : arg0,
            offer_cap  : arg1,
        };
        0x2::event::emit<ReceiptCreatedEvent>(v0);
    }

    public(friend) fun emit_receipt_destroyed_event(arg0: 0x2::object::ID, arg1: 0x2::object::ID) {
        let v0 = ReceiptDestroyedEvent{
            receipt_id : arg0,
            offer_cap  : arg1,
        };
        0x2::event::emit<ReceiptDestroyedEvent>(v0);
    }
    ...
    fun new_offer<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &0x84fe9cc034eb3d4bf4e50acd79cbe99974a21f6988a60e4ad1935d3964de4984::marketplace::MarketPlace, arg6: &mut 0x2::tx_context::TxContext) : (Offer<T0>, OfferCap<T0>) {
        assert!(0x2::kiosk::has_access(arg0, arg1), 100);
        let v0 = 0x2::coin::into_balance<0x2::sui::SUI>(arg3);
        let v1 = 0x2::balance::value<0x2::sui::SUI>(&v0);
        let v2 = (((0x84fe9cc034eb3d4bf4e50acd79cbe99974a21f6988a60e4ad1935d3964de4984::marketplace::get_fee(arg5, 0x2::tx_context::sender(arg6)) as u128) * (v1 as u128) / 10000) as u64);
