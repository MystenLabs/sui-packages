module 0x84fe9cc034eb3d4bf4e50acd79cbe99974a21f6988a60e4ad1935d3964de4984::trade {
    ...
    public fun buy<T0: store + key>(arg0: &mut 0x84fe9cc034eb3d4bf4e50acd79cbe99974a21f6988a60e4ad1935d3964de4984::marketplace::MarketPlace, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::object::ID, arg6: SItemWithPurchaseCap<T0>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        assert!(v10 == arg5, 402);
        0x84fe9cc034eb3d4bf4e50acd79cbe99974a21f6988a60e4ad1935d3964de4984::marketplace::add_balance(arg0, 0x2::coin::take<0x2::sui::SUI>(&mut v9, v7, arg8));
    ...
    public fun list<T0: store + key>(arg0: &0x84fe9cc034eb3d4bf4e50acd79cbe99974a21f6988a60e4ad1935d3964de4984::marketplace::MarketPlace, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: T0, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = (((0x84fe9cc034eb3d4bf4e50acd79cbe99974a21f6988a60e4ad1935d3964de4984::marketplace::get_fee(arg0, 0x2::tx_context::sender(arg6)) as u128) * (arg5 as u128) / 10000) as u64);
    ...
    public fun list_kiosk_item<T0: store + key>(arg0: &0x84fe9cc034eb3d4bf4e50acd79cbe99974a21f6988a60e4ad1935d3964de4984::marketplace::MarketPlace, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: 0x2::object::ID, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = (((0x84fe9cc034eb3d4bf4e50acd79cbe99974a21f6988a60e4ad1935d3964de4984::marketplace::get_fee(arg0, 0x2::tx_context::sender(arg6)) as u128) * (arg5 as u128) / 10000) as u64);
    ...
    public fun update_listing<T0: store + key>(arg0: &0x84fe9cc034eb3d4bf4e50acd79cbe99974a21f6988a60e4ad1935d3964de4984::marketplace::MarketPlace, arg1: &mut SItemWithPurchaseCap<T0>, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::object::ID, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        arg1.marketplace_fee = (((0x84fe9cc034eb3d4bf4e50acd79cbe99974a21f6988a60e4ad1935d3964de4984::marketplace::get_fee(arg0, 0x2::tx_context::sender(arg7)) as u128) * (arg6 as u128) / 10000) as u64);
        arg1.min_price = arg6;
