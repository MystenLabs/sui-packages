module 0x84f9dbbf019859dd8ac84d509a753e572646b439229f22900aa809d24374177e::author_nft {
    ...
    public fun mint_to_author(arg0: &PublisherCap, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: u64, arg11: vector<u8>, arg12: vector<u8>, arg13: u64, arg14: u64, arg15: address, arg16: &mut 0x2::tx_context::TxContext) {
        let v0 = AuthorNFT{
            ...
            walrus_blob_id       : 0x1::string::utf8(arg7),
            story_excerpt        : 0x1::string::utf8(arg8),
            story_content_hash   : 0x1::string::utf8(arg9),
            word_count           : arg10,
            metadata_url         : 0x2::url::new_unsafe_from_bytes(arg11),
            description          : 0x1::string::utf8(arg12),
            edition              : arg13,
            total_supply         : arg14,
        };
        let v1 = NFTMinted{
    ...
    public fun mint_to_kiosk(arg0: &PublisherCap, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: u64, arg11: vector<u8>, arg12: vector<u8>, arg13: u64, arg14: u64, arg15: &mut 0x2::kiosk::Kiosk, arg16: &0x2::kiosk::KioskOwnerCap, arg17: &mut 0x2::tx_context::TxContext) {
        let v0 = AuthorNFT{
