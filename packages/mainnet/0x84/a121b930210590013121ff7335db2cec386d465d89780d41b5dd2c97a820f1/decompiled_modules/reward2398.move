module 0x84a121b930210590013121ff7335db2cec386d465d89780d41b5dd2c97a820f1::reward2398 {
    struct REWARD2398 has drop {
        dummy_field: bool,
    }

    struct TICKET_2398 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2398(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2398>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2398>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2398, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2398>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2398>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2398>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2398>>(v5, 0x2::tx_context::sender(arg1));
    }
