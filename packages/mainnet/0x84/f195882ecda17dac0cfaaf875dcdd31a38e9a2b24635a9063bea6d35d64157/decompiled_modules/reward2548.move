module 0x84f195882ecda17dac0cfaaf875dcdd31a38e9a2b24635a9063bea6d35d64157::reward2548 {
    struct REWARD2548 has drop {
        dummy_field: bool,
    }

    struct TICKET_2548 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2548(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2548>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2548>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2548, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2548>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2548>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2548>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2548>>(v5, 0x2::tx_context::sender(arg1));
    }
