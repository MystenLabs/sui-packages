module 0x84d971a78b6576fb21fb9f5d16809d1098d25938e70303b6c632e8663815259f::reward2497 {
    struct REWARD2497 has drop {
        dummy_field: bool,
    }

    struct TICKET_2497 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2497(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2497>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2497>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2497, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2497>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2497>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2497>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2497>>(v5, 0x2::tx_context::sender(arg1));
    }
