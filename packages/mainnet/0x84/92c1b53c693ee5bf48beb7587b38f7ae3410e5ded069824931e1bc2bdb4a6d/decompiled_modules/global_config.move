module 0xd0feb15e540824aee26e3a211bb4164b7f6e08057e743f0621ec11fc94c70242::global_config {
    ...
    public(friend) fun alternative_payment_deep(arg0: &mut GlobalConfig, arg1: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP> {
        ...
        add_sponsor_record(arg0, arg2, arg3);
    ...
    public fun checked_package_version(arg0: &GlobalConfig) {
        assert!(2 == arg0.package_version, 2);
    }
    ...
    fun user_sponsor_key(arg0: &0x2::tx_context::TxContext) : 0x1::string::String {
        ...
        let v1 = 0x1::string::from_ascii(0x1::ascii::string(0x1::bcs::to_bytes<address>(&v0)));
        0x1::string::append_utf8(&mut v1, b"-");
        0x1::string::append(&mut v1, u64_to_str(0x2::tx_context::epoch(arg0)));
        v1
    }
