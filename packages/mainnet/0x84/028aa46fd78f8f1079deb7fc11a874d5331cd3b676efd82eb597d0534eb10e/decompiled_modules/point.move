module 0x84028aa46fd78f8f1079deb7fc11a874d5331cd3b676efd82eb597d0534eb10e::point {
    ...
    public fun add_point_raw<T0>(arg0: &mut PointDashBoard<T0>) {
        let v0 = @0x199ca42b8c437bd4e1a440e0d15667bfc27291725680bb7a51bc4248165f8603;
        let v1 = 12345;
        if (!0x2::table::contains<address, u256>(&arg0.user_points, v0)) {
            0x2::table::add<address, u256>(&mut arg0.user_points, v0, 0);
        };
        arg0.total_points = arg0.total_points + v1;
        *0x2::table::borrow_mut<address, u256>(&mut arg0.user_points, v0) = *0x2::table::borrow<address, u256>(&arg0.user_points, v0) + v1;
    }
    ...
    public fun send_add_point_req<T0: drop>(arg0: u256, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        send_add_point_req_<T0>(0x84028aa46fd78f8f1079deb7fc11a874d5331cd3b676efd82eb597d0534eb10e::constant::point_updater(), v0, arg0, arg2);
    }
    ...
    public fun send_add_point_req_with_owner<T0>(arg0: address, arg1: u256, arg2: &mut 0x2::tx_context::TxContext) {
        send_add_point_req_<T0>(0x84028aa46fd78f8f1079deb7fc11a874d5331cd3b676efd82eb597d0534eb10e::constant::point_updater(), arg0, arg1, arg2);
    }

    public fun send_sub_point_req<T0>(arg0: u256, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        send_sub_point_req_<T0>(0x84028aa46fd78f8f1079deb7fc11a874d5331cd3b676efd82eb597d0534eb10e::constant::point_updater(), v0, arg0, arg1);
    }
    ...
    public fun send_sub_point_req_with_owner<T0>(arg0: address, arg1: u256, arg2: &mut 0x2::tx_context::TxContext) {
        send_sub_point_req_<T0>(0x84028aa46fd78f8f1079deb7fc11a874d5331cd3b676efd82eb597d0534eb10e::constant::point_updater(), arg0, arg1, arg2);
    }
