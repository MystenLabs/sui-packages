module 0x84a3b7161e525ad820fee1684bcb14294f2cc6da7ac5899808669ccc72dfbfce::market {
    ...
    public(friend) fun new(arg0: 0x1::string::String, arg1: address, arg2: address, arg3: 0x1::string::String, arg4: vector<u8>, arg5: u64, arg6: u8, arg7: u64, arg8: u64, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: bool, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) : Market {
        ...
        let v5 = 0;
        if (arg10) {
            0x2::balance::join<0x2::sui::SUI>(&mut v0, 0x2::coin::into_balance<0x2::sui::SUI>(arg9));
            v2 = 0x2::coin::value<0x2::sui::SUI>(&arg9);
            v4 = 1;
        } else {
            0x2::balance::join<0x2::sui::SUI>(&mut v1, 0x2::coin::into_balance<0x2::sui::SUI>(arg9));
            v3 = 0x2::coin::value<0x2::sui::SUI>(&arg9);
            v5 = 1;
        };
        Market{
