module 0x84ac518a4592aa40db5a7243ddda6211c60dc01c1165fa02ecbad862191f71d5::fuddies_gang_nfts {
    ...
    public fun admin_mint(arg0: &mut Configuration, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        if (0x2::tx_context::sender(arg2) != arg0.admin) {
            return
        };
        let v0 = 0x1::vector::swap_remove<Metadata>(&mut arg0.nft_metadata, arg1);
        let v1 = 0x2::tx_context::sender(arg2);
        mint_internal(arg0, v1, v0, arg2);
    }
