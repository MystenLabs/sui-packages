module 0x84d96c7252bd47dc197e5462f1becd15c4e91c903585acc16f575b158464f987::reward2308 {
    struct REWARD2308 has drop {
        dummy_field: bool,
    }

    struct TICKET_2308 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2308(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2308>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2308>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2308, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2308>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2308>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2308>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2308>>(v5, 0x2::tx_context::sender(arg1));
    }
