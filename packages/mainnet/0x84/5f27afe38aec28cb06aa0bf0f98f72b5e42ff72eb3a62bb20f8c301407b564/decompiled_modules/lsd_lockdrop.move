module 0x845f27afe38aec28cb06aa0bf0f98f72b5e42ff72eb3a62bb20f8c301407b564::lsd_lockdrop {
    struct LsdLockdropVault has key {
        ...
        hive_incentives_balance: 0x2::balance::Balance<0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive::HIVE>,
    }
    ...
    public fun add_hive_incentives(arg0: &0x2::clock::Clock, arg1: &mut LsdLockdropVault, arg2: 0x2::coin::Coin<0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive::HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        0x2::clock::timestamp_ms(arg0);
        let v0 = 0x2::coin::into_balance<0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive::HIVE>(arg2);
        0x2::balance::join<0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive::HIVE>(&mut arg1.hive_incentives_balance, 0x2::balance::split<0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive::HIVE>(&mut v0, arg3));
        arg1.total_hive_incentives = arg1.total_hive_incentives + arg3;
        0x7f8c3b268109860eb088bb67572f375ded430ab7510db7a80d09c4930260981f::coin_helper::destroy_or_transfer_balance<0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive::HIVE>(v0, 0x2::tx_context::sender(arg4), arg4);
    ...
    public fun add_to_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0x7f8c3b268109860eb088bb67572f375ded430ab7510db7a80d09c4930260981f::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::HiveProfile, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        0x2::clock::timestamp_ms(arg0);
        let (v0, v1, _, v3) = 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::get_profile_meta_info(arg3);
        assert!(arg6 >= arg2.min_lock_duration && arg6 <= arg2.max_lock_duration, 5102);
        let v4 = if (0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::exists_for_profile(arg3, 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap))) {
            0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg7)
        } else {
        ...
        let v7 = arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window + arg6 * 604800000;
        ...
        0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::entry_add_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v4, arg7);
        0x7f8c3b268109860eb088bb67572f375ded430ab7510db7a80d09c4930260981f::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v5, 0x2::tx_context::sender(arg7), arg7);
        (v8, v9)
    }
    ...
    public fun destroy_user_position(arg0: &0x2::clock::Clock, arg1: &0x7f8c3b268109860eb088bb67572f375ded430ab7510db7a80d09c4930260981f::config::HiveEntryCap, arg2: &LsdLockdropVault, arg3: &mut 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::HiveProfile, arg4: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u64>, u128, u128) {
        0x2::clock::timestamp_ms(arg0);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg2.sui_locked_balance) == 0, 5110);
        if (!0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::exists_for_profile(arg3, 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap))) {
        ...
        } = 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg4);
        0x2::object::delete(v0);
        0x2::table::drop<u64, bool>(v5);
        (v1, v2, v3, v4, (v6 as u128), v7)
    }

    public fun does_user_have_position(arg0: &0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : bool {
    ...
    public fun get_user_position(arg0: &0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u64, u64) {
        ...
        let v1 = 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg0, v0);
    ...
    public fun infuse_sui_hsui_pool(arg0: &0x2::clock::Clock, arg1: &0x7f8c3b268109860eb088bb67572f375ded430ab7510db7a80d09c4930260981f::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x33f61893fa6354f516175c126c51ad3b388f07703292d13d704f0b3dcf834783::hsui_vault::HSuiVault, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0x7f8c3b268109860eb088bb67572f375ded430ab7510db7a80d09c4930260981f::hsui::HSUI>, 0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive::HIVE>, u64, u128) {
        ...
        let v2 = 0x33f61893fa6354f516175c126c51ad3b388f07703292d13d704f0b3dcf834783::hsui_vault::stake_sui_request(arg3, arg4, 0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, v1), 0x1::option::none<address>(), arg5);
        let v3 = SuiStakedForHiveSui{
            cur_timestamp      : v0,
            total_sui_locked   : arg2.total_sui_locked,
            sui_to_stake       : v1,
            total_hsui_krafted : 0x2::balance::value<0x7f8c3b268109860eb088bb67572f375ded430ab7510db7a80d09c4930260981f::hsui::HSUI>(&v2),
        };
        0x2::event::emit<SuiStakedForHiveSui>(v3);
        (v2, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg2.sui_locked_balance), 0x2::balance::withdraw_all<0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive::HIVE>(&mut arg2.hive_incentives_balance), arg2.total_sui_locked, arg2.total_sui_weighted_units)
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
    }

    public entry fun initialize_global_lsd_lockdrop(arg0: &0x7f8c3b268109860eb088bb67572f375ded430ab7510db7a80d09c4930260981f::config::HiveEntryCap, arg1: 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::ProfileDofOwnershipCapability, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : address {
        let v0 = LsdLockdropVault{
            ...
            hive_incentives_balance  : 0x2::balance::zero<0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive::HIVE>(),
        };
    ...
    public fun simulate_withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &mut LsdLockdropVault, arg2: &0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::HiveProfile, arg3: u64, arg4: u64) : (u64, u64, bool) {
        let v0 = 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::get_profile_dof_capability_identifier(&arg1.user_profile_access_cap);
        if (!0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::exists_for_profile(arg2, v0)) {
            return (0, 0, false)
        };
        let v1 = 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg2, v0);
    ...
    public entry fun test_update_timestamps(arg0: &mut LsdLockdropVault, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0x7f8c3b268109860eb088bb67572f375ded430ab7510db7a80d09c4930260981f::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::HiveProfile, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        assert!(0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::exists_for_profile(arg3, 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::get_profile_dof_capability_identifier(&arg2.user_profile_access_cap)), 5104);
        let v5 = 0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg6);
        ...
        0x1dd8f0cc45f098302846deaaea0624005f23b131ffa042752e53a9f6006d3aee::hive_profile::entry_add_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v5, arg6);
        0x7f8c3b268109860eb088bb67572f375ded430ab7510db7a80d09c4930260981f::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, arg4), v4, arg6);
        (v11, v12)
    }
