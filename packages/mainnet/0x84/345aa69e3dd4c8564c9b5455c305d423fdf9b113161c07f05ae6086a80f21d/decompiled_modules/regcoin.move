module 0x84345aa69e3dd4c8564c9b5455c305d423fdf9b113161c07f05ae6086a80f21d::regcoin {
    ...
    fun init(arg0: REGCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<REGCOIN>(arg0, 6, b"blue", b"blue coin", b"elooo", 0x1::option::none<0x2::url::Url>(), false, arg1);
