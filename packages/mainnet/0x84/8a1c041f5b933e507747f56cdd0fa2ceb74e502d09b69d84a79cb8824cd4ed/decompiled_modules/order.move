module 0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::order {
    ...
    public fun cancle_order<T0, T1>(arg0: &0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::GlobalConfig, arg1: &mut Order<T0, T1>, arg2: &mut OrderIndexer, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::checked_package_version(arg0);
    ...
    public fun flash_loan_for_make_deal<T0, T1>(arg0: &0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::GlobalConfig, arg1: &mut 0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::ProtocolFeeVault, arg2: &mut Order<T0, T1>, arg3: u64, arg4: vector<0x1::string::String>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, MakeDealReceipt) {
        0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::checked_package_version(arg0);
        ...
        let v2 = if (arg2.fee_rate > 0) {
            ...
            0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::receive_fee<T0>(arg1, 0x2::balance::split<T0>(&mut v1, v3));
            v3
        } else {
            0
        };
    ...
    public fun repay_for_make_deal<T0, T1>(arg0: &0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::GlobalConfig, arg1: &mut Order<T0, T1>, arg2: &mut OrderIndexer, arg3: 0x2::coin::Coin<T1>, arg4: MakeDealReceipt, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::checked_package_version(arg0);
    ...
    fun validate_keepers<T0, T1>(arg0: &0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::GlobalConfig, arg1: &Order<T0, T1>, arg2: u64, arg3: vector<0x1::string::String>) : bool {
        if (0x1::vector::length<0x1::string::String>(&arg3) < 0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::keeper_threshold(arg0)) {
            return false
        };
        ...
        if (0x2::vec_set::size<address>(&v0) < 0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::keeper_threshold(arg0)) {
            return false
        };
        true
    }

    fun validate_order<T0, T1>(arg0: address, arg1: &0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::GlobalConfig, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: 0x1::string::String, arg9: &0x2::clock::Clock) {
        assert!(0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::is_coin_allow<T0, T1>(arg1), 15);
        assert!(arg5 >= 0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::min_cycle_count(arg1), 0);
        assert!(arg3 > 0, 7);
        assert!(arg2 >= arg3, 7);
        assert!(arg4 >= 0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::min_cycle_frequency(arg1), 1);
        ...
        assert!(v1 <= 0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::oracle_valid_duration(arg1), 11);
    ...
    fun verify_internal(arg0: &0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::GlobalConfig, arg1: vector<u8>, arg2: &0x1::string::String, arg3: u8) : (bool, address) {
        let (v0, v1, v2) = parse_signature(0x2::hex::decode(*0x1::string::as_bytes(arg2)));
        let v3 = v2;
        let v4 = v1;
        if (arg3 == 0) {
            0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::checked_oracle(arg0, v0);
        } else {
            0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::checked_keeper(arg0, v0);
        };
        (0x2::ed25519::ed25519_verify(&v3, &v4, &arg1), v0)
    }

    public fun withdraw<T0, T1>(arg0: &0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::GlobalConfig, arg1: &mut Order<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        0x848a1c041f5b933e507747f56cdd0fa2ceb74e502d09b69d84a79cb8824cd4ed::config::checked_package_version(arg0);
