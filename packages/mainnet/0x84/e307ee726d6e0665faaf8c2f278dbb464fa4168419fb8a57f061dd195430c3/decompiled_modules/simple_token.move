module 0x84e307ee726d6e0665faaf8c2f278dbb464fa4168419fb8a57f061dd195430c3::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"GOOCAT", b"GOOCAT", b"Official token. Banner on Dexscreener paid!", 0x1::option::none<0x2::url::Url>(), arg1);
