module 0x841671e9b68730c1c8695989bf05412a7af2fafe88e5fbf69393d9d53190e765::estark {
    ...
    fun init(arg0: ESTARK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<ESTARK>(&mut v2, 10000000000000000, 0x2::tx_context::sender(arg1), arg1);
