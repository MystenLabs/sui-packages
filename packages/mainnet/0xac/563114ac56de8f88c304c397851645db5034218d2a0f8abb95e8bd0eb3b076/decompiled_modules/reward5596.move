module 0xac563114ac56de8f88c304c397851645db5034218d2a0f8abb95e8bd0eb3b076::reward5596 {
    struct REWARD5596 has drop {
        dummy_field: bool,
    }

    struct TICKET_5596 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5596(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5596>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5596>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5596, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5596>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5596>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5596>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5596>>(v5, 0x2::tx_context::sender(arg1));
    }
