module 0xacbbcc17ab2905708efa2499c749c6b73d84e25cc173dadddf380bc0d72a685c::msui {
    ...
    fun create_initial_state(arg0: MSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MSUI>(arg0, 9, b"MSUI", b"Micro SUItegy", b"Deposit-only Micro SUItegy reserve token.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://mindfrog.xyz/msui.png")), arg1);
