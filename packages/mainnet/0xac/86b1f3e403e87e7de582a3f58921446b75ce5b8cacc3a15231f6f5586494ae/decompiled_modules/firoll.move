module 0xac86b1f3e403e87e7de582a3f58921446b75ce5b8cacc3a15231f6f5586494ae::firoll {
    ...
    fun init(arg0: FIROLL, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FIROLL>(arg0, 9, b"SUISCAN", b"SUISCAN", b"FiRoll Coin for bet gaming protocol", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://bafybeiecppfzpgx7xosf7h4a2zistip2d4lawqkwsp2dtp3ucmjpmnb6tq.ipfs.nftstorage.link/"))), arg1);
        let v2 = v0;
