module 0xac1474a7a25b291f4b693f77686fbc1a9a457af312353ac23a03da313d2e988c::utils {
    public fun get_description_nft() : vector<u8> {
        b"These keys will give you a chance for a guaranteed mint of our collection with discount! $CHEBU Airdrop for holders in future!"
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeibfeclyvnbwnkepnrnu464ae33e5hqhinr5kkwdnuvjd4hvwgzeh4/"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeiaflrgxkn527swiotxocpx3tm33ckmspqbvd4iawv2cyqwityxrqm/"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/SuiChebubears"
    }
