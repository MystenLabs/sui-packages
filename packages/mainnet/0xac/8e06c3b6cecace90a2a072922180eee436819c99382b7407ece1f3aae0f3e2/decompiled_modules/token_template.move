module 0xac8e06c3b6cecace90a2a072922180eee436819c99382b7407ece1f3aae0f3e2::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT2498462", b"BatchToken2 498462", b"Second serial deployment", 0x1::option::none<0x2::url::Url>(), arg1);
