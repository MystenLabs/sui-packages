module 0xacb067cb577c95eb2c8c850aaf45fc7f2e4e838f9762be0298d342c653985efb::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"HC", b"HitmanCoinTest", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-25T09-12-28.259Z-9eaaf7cdd6575d49abbc56a8547ecbb1.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"HitmanCoinTest"),
            symbol     : 0x1::string::utf8(b"HC"),
            decimals   : 9,
