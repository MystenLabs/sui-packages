module 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::liquid_staking {
    ...
    struct LiquidStakingInfo<phantom T0> has store, key {
        ...
        fee_config: 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::cell::Cell<0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig>,
        fees: 0x2::balance::Balance<0x2::sui::SUI>,
        accrued_spread_fees: u64,
        storage: 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::Storage,
        flash_stake_lst: u64,
        collection_fee_cap_id: 0x2::object::ID,
        is_paused: bool,
        version: 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::version::Version,
    ...
    public fun mint<T0: drop>(arg0: &mut LiquidStakingInfo<T0>, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v4 = 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::calculate_mint_fee(0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::cell::get<0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig>(&arg0.fee_config), 0x2::balance::value<0x2::sui::SUI>(&v3));
        ...
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::events::emit_event<MintEvent>(v6);
        ...
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::join_to_sui_pool(&mut arg0.storage, v3);
        v7
    }
    ...
    public fun collect_fees<T0>(arg0: &mut LiquidStakingInfo<T0>, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &CollectionFeeCap<T0>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        refresh_no_entry<T0>(arg0, arg1, arg3);
        let v0 = 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::split_n_sui(&mut arg0.storage, arg1, arg0.accrued_spread_fees, arg3);
        ...
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::events::emit_event<CollectFeesEvent>(v2);
        0x2::coin::from_balance<0x2::sui::SUI>(v1, arg3)
    }

    public fun create_lst<T0: drop>(arg0: 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &mut 0x2::tx_context::TxContext) : (AdminCap<T0>, CollectionFeeCap<T0>, LiquidStakingInfo<T0>) {
        assert!(0x2::coin::total_supply<T0>(&arg1) == 0, 0);
        let v0 = 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::new(arg2);
        create_lst_with_storage<T0>(arg0, arg1, v0, arg2)
    }

    fun create_lst_with_storage<T0: drop>(arg0: 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig, arg1: 0x2::coin::TreasuryCap<T0>, arg2: 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::Storage, arg3: &mut 0x2::tx_context::TxContext) : (AdminCap<T0>, CollectionFeeCap<T0>, LiquidStakingInfo<T0>) {
        let v0 = 0x2::object::new(arg3);
        let v1 = CreateEvent{
            typename               : 0x1::type_name::get<T0>(),
            liquid_staking_info_id : 0x2::object::uid_to_inner(&v0),
        };
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::events::emit_event<CreateEvent>(v1);
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::emit_fee_change_event<T0>(&arg0);
        ...
        let v4 = LiquidStakingInfo<T0>{
            ...
            fee_config            : 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::cell::new<0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig>(arg0),
            ...
            is_paused             : false,
            version               : 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::version::new(1),
            extra_fields          : 0x2::bag::new(arg3),
        };
        (v3, v2, v4)
    }

    public(friend) fun storage<T0>(arg0: &LiquidStakingInfo<T0>) : &0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::Storage {
        &arg0.storage
    }

    public fun fee_config<T0>(arg0: &LiquidStakingInfo<T0>) : &0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig {
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::cell::get<0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig>(&arg0.fee_config)
    }
    ...
    public fun flash_stake_conclude<T0: drop>(arg0: &mut LiquidStakingInfo<T0>, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: FlashStake<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        assert!(0x2::balance::value<0x2::sui::SUI>(0x2::coin::balance<0x2::sui::SUI>(&arg2)) >= v0 + v2, 9223373205085880319);
        let v3 = 0x2::coin::into_balance<0x2::sui::SUI>(arg2);
        ...
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::join_to_sui_pool(&mut arg0.storage, v4);
        ...
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::events::emit_event<FlashStakeEvent>(v5);
    ...
    public fun flash_stake_start<T0: drop>(arg0: &mut LiquidStakingInfo<T0>, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashStake<T0>) {
        ...
        let v2 = 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::calculate_flash_stake_fee(0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::cell::get<0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig>(&arg0.fee_config), v1);
    ...
    public fun redeem<T0: drop>(arg0: &mut LiquidStakingInfo<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v1 = 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::split_n_sui(&mut arg0.storage, arg2, lst_amount_to_sui_amount<T0>(arg0, 0x2::coin::value<T0>(&arg1)), arg3);
        let v2 = 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::calculate_redeem_fee(0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::cell::get<0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig>(&arg0.fee_config), 0x2::balance::value<0x2::sui::SUI>(&v1));
        let v3 = if (total_lst_supply<T0>(arg0) == 0x2::coin::value<T0>(&arg1)) {
            0
        } else {
            0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::calculate_distribution_component_fee(0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::cell::get<0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig>(&arg0.fee_config), v2)
        };
        let v4 = if (v2 > v3) {
            v2 - v3
        } else {
        ...
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::join_to_sui_pool(&mut arg0.storage, 0x2::balance::split<0x2::sui::SUI>(&mut v1, (v3 as u64)));
        let v5 = RedeemEvent{
            typename        : 0x1::type_name::get<T0>(),
        ...
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::events::emit_event<RedeemEvent>(v5);
    ...
    public entry fun refresh<T0>(arg0: &mut LiquidStakingInfo<T0>, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::stake_pending_sui<T0>(&mut arg0.storage, arg1, arg2);
    }
    ...
    public(friend) fun refresh_no_entry<T0>(arg0: &mut LiquidStakingInfo<T0>, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) : bool {
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::version::assert_version_and_upgrade(&mut arg0.version, 1);
        let v0 = total_sui_supply<T0>(arg0);
        if (0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::refresh<T0>(&mut arg0.storage, arg1, arg2)) {
            let v1 = total_sui_supply<T0>(arg0);
            let v2 = if (v1 > v0) {
                ((((v1 - v0) as u128) * (0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::spread_fee_bps(0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::cell::get<0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig>(&arg0.fee_config)) as u128) / 10000) as u64)
            } else {
                0
            };
            ...
            0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::events::emit_event<EpochChangedEvent>(v3);
            return true
        };
        false
    }
    ...
    public fun set_validator_addresses_and_weights<T0>(arg0: &mut LiquidStakingInfo<T0>, arg1: 0x2::vec_map::VecMap<address, u64>, arg2: &AdminCap<T0>) {
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::set_validator_addresses_and_weights(&mut arg0.storage, arg1);
    }
    ...
    public fun total_sui_supply<T0>(arg0: &LiquidStakingInfo<T0>) : u64 {
        if (0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::total_sui_supply(&arg0.storage) > arg0.accrued_spread_fees) {
            0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::storage::total_sui_supply(&arg0.storage) - arg0.accrued_spread_fees
        } else {
            0
        }
    }
    ...
    public fun update_fees<T0>(arg0: &mut LiquidStakingInfo<T0>, arg1: &AdminCap<T0>, arg2: 0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig) {
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::version::assert_version_and_upgrade(&mut arg0.version, 1);
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::emit_fee_change_event<T0>(&arg2);
        0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::destroy(0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::cell::set<0xac608850e8d93d379de3d87f98da6c07be907d163fbe33383a829aab47633dae::fees::FeeConfig>(&mut arg0.fee_config, arg2));
    }
