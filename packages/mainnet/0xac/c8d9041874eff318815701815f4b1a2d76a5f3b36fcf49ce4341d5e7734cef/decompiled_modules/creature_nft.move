module 0xacc8d9041874eff318815701815f4b1a2d76a5f3b36fcf49ce4341d5e7734cef::creature_nft {
    ...
    public fun get_stake_info(arg0: &StakeInfo) : (0x2::object::ID, address, u8, u64, u64) {
        (arg0.nft_id, arg0.owner, arg0.environment, arg0.stake_time, arg0.last_reward_time)
    }
    ...
    public fun stake_nft(arg0: &mut BrainrotCollection, arg1: CreatureNFT, arg2: u8, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : StakeInfo {
        validate_environment(arg2);
        let v0 = 0x2::object::id<CreatureNFT>(&arg1);
        ...
        let v3 = &mut arg0.staking_stats;
        update_staking_count(v3, arg2, true);
        let v4 = NFTStaked{
            nft_id      : v0,
            owner       : 0x2::tx_context::sender(arg4),
            environment : arg2,
    ...
    public entry fun unstake_creature_entry(arg0: &mut BrainrotCollection, arg1: StakeInfo, arg2: CreatureNFT, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<CreatureNFT>(unstake_nft(arg0, arg1, arg2, arg3, arg4), 0x2::tx_context::sender(arg4));
    }

    public fun unstake_nft(arg0: &mut BrainrotCollection, arg1: StakeInfo, arg2: CreatureNFT, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) : CreatureNFT {
        assert!(arg1.owner == 0x2::tx_context::sender(arg4), 2);
        assert!(0x2::object::id<CreatureNFT>(&arg2) == arg1.nft_id, 2);
