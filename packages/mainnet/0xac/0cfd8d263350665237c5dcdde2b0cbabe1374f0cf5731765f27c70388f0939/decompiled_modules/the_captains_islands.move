module 0xac0cfd8d263350665237c5dcdde2b0cbabe1374f0cf5731765f27c70388f0939::the_captains_islands {
    struct THE_CAPTAINS_ISLANDS has drop {
        dummy_field: bool,
    }
    ...
    public fun get_ship_attributes(arg0: &0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID) : (u64, u8, 0x1::string::String, 0x1::string::String, 0x1::string::String, 0x1::string::String, 0x1::string::String, u64, u64, u64, u64, 0x1::string::String, 0x1::string::String) {
        ...
        (v0.ship_id, v0.ship_rank, v0.name, v0.description, v0.image_url, v0.rarity, v0.ship_type, v0.size, v0.attack, v0.defence, v0.health, v0.upgrades, v0.specialisation)
    }

    fun init(arg0: THE_CAPTAINS_ISLANDS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x2::package::claim<THE_CAPTAINS_ISLANDS>(arg0, arg1);
    ...
    public fun upgrade(arg0: &UpgradeManager, arg1: vector<ShipNFT>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &Payout, arg4: &0x2::transfer_policy::TransferPolicy<ShipNFT>, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut Counter, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v30 = create_ship(arg7, v11.output_rank, v11.output_name, v11.output_description, v11.output_image_url, v11.output_rarity, v11.output_type, v11.output_size, v11.output_attack, v11.output_defence, v11.output_health, v11.output_upgrades, v11.output_specialisation, arg8);
        let v31 = v30.size;
        let v32 = v30.attack;
        let v33 = v30.defence;
        let v34 = v30.health;
        ...
        if (v31 != 0) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v30.attributes, 0x1::string::utf8(b"Size"), u64_to_string(v31));
        };
        if (v32 != 0) {
