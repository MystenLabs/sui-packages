        ...
        if (v1 > 0) {
            ...
            if (0x2::balance::value<0x2::sui::SUI>(&v3) >= v1) {
                ...
                if (v4 >= v5) {
                    ...
                    let (v13, _) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::flash_loan_with_account_cap<0x2::sui::SUI>(arg14, arg9, v12, &arg0.navi_cap);
                    let v15 = v13;
                    let v16 = 0x2::balance::value<0x2::sui::SUI>(&v15);
                    0x2::balance::join<0x2::sui::SUI>(&mut v3, v15);
                    let v17 = v1 + v16 + (0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::utils::u256_mul_div((v16 as u256), (6 as u256), (10000 as u256)) as u64);
                    let v18 = v17;
                    if (v17 < 1000000000) {
                        v18 = 1000000000;
                    };
            ...
            0x2::event::emit<RepayEvent>(v19);
        } else if (v0 > 0) {
            let v20 = 0x1::u64::min(v0, 0x2::balance::value<0x2::sui::SUI>(0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::vault::free_balance<0x2::sui::SUI, 0x867147a1682a9b3486a5dfb7bf828ab5e5ce3e43b62dd7d1a0c7a8711de5ba1a::st_sui::ST_SUI>(arg2)));
            let v21 = 0x2::coin::from_balance<0x2::sui::SUI>(0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::vault::strategy_borrow<0x2::sui::SUI, 0x867147a1682a9b3486a5dfb7bf828ab5e5ce3e43b62dd7d1a0c7a8711de5ba1a::st_sui::ST_SUI>(arg2, &arg0.vault_access, v20), arg15);
            let v22 = BorrowEvent{
                vault_id    : 0x2::object::id<0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::vault::Vault<0x2::sui::SUI, 0x867147a1682a9b3486a5dfb7bf828ab5e5ce3e43b62dd7d1a0c7a8711de5ba1a::st_sui::ST_SUI>>(arg2),
                strategy_id : *0x2::object::uid_as_inner(&arg0.id),
                borrow_amt  : v20,
            };
            0x2::event::emit<BorrowEvent>(v22);
            ...
            0x2::balance::join<0x2::sui::SUI>(&mut v23, 0x2::coin::into_balance<0x2::sui::SUI>(v21));
