module 0xac75aa2dd3c4fd03f869971dfc57cf43383d38d311fac189dbbd5dec6c0670a6::swap_context {
    struct SwapContext {
    ...
    public fun confirm_swap<T0>(arg0: SwapContext, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v2 = v1;
        assert!(0x2::bag::is_empty(&v2), 0xac75aa2dd3c4fd03f869971dfc57cf43383d38d311fac189dbbd5dec6c0670a6::errors::err_remains_balance());
    ...
    public fun new_swap_context<T0>(arg0: 0x2::coin::Coin<T0>, arg1: &mut 0x2::tx_context::TxContext) : SwapContext {
        assert!(0x2::coin::value<T0>(&arg0) > 0, 0xac75aa2dd3c4fd03f869971dfc57cf43383d38d311fac189dbbd5dec6c0670a6::errors::err_amount_in_is_zero());
