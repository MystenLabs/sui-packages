module 0xac48ad078e7b5b1602b17dc84b55376371f9f8c7ba8ab407e5e5f30cc5ec8248::cnsnft4489 {
    struct CNSNFT4489 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4489, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5044"));
        let v4 = 0x2::package::claim<CNSNFT4489>(arg0, arg1);
