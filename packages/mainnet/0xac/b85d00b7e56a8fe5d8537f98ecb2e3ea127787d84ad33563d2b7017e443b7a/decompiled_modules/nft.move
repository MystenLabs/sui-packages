module 0xacb85d00b7e56a8fe5d8537f98ecb2e3ea127787d84ad33563d2b7017e443b7a::nft {
    ...
    public entry fun get_url(arg0: &ContractInfo, arg1: &NFT) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"");
        0x1::string::append(&mut v0, arg0.base_url);
        0x1::string::append(&mut v0, arg1.name);
        v0
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = ContractInfo{
            ...
            description      : 0x1::string::utf8(b"Test Sui Pay NFT"),
