module 0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::circuit_breaker {
    ...
    public fun admin_activate_emergency(arg0: &0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::admin_config::AdminCap, arg1: &mut BreakerRegistry, arg2: vector<u8>) {
    ...
    public fun admin_deactivate_emergency(arg0: &0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::admin_config::AdminCap, arg1: &mut BreakerRegistry, arg2: vector<u8>, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(0x2::table::contains<vector<u8>, BreakerState>(&arg1.states, arg2), 3);
        assert!(arg3 > 0, 7);
        let v0 = 0x2::table::borrow_mut<vector<u8>, BreakerState>(&mut arg1.states, arg2);
    ...
    public fun admin_update_n_max(arg0: &0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::admin_config::AdminCap, arg1: &mut BreakerRegistry, arg2: vector<u8>, arg3: u64) {
        assert!(0x2::table::contains<vector<u8>, BreakerState>(&arg1.states, arg2), 3);
        assert!(arg3 > 0, 8);
    ...
    public fun register_breaker(arg0: &0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::admin_config::AdminCap, arg1: &mut BreakerRegistry, arg2: vector<u8>, arg3: u64, arg4: u64) {
