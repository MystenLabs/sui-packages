module 0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::position_store {
    ...
    public(friend) fun close_position<T0>(arg0: &mut PositionStore, arg1: &mut 0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::MarginBank<T0>, arg2: address, arg3: 0x2::object::ID, arg4: u64) : StoredPosition {
        ...
        assert!(arg4 <= v2, 4);
        if (arg4 > 0) {
            0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::unlock_collateral<T0>(arg1, arg2, arg4);
        };
        let v3 = v2 - arg4;
        if (v3 > 0) {
            0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::slash_locked<T0>(arg1, arg2, v3);
        };
    ...
    public(friend) fun close_position_for_liquidation<T0>(arg0: &mut PositionStore, arg1: &mut 0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::MarginBank<T0>, arg2: address, arg3: 0x2::object::ID, arg4: u64, arg5: LiquidationLock) : StoredPosition {
        let LiquidationLock {
            trader    : v0,
            market_id : v1,
        } = arg5;
    ...
    fun compute_round_delta_v4<T0>(arg0: &PositionStore, arg1: &0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::MarginBank<T0>, arg2: address, arg3: 0x2::object::ID, arg4: u64, arg5: u128, arg6: bool, arg7: u128) : FundingRoundDelta {
        let v0 = make_key(arg2, arg3);
        assert!(0x2::table::contains<vector<u8>, StoredPosition>(&arg0.positions, v0), 0);
        ...
        let v6 = if (v5) {
            min_u64(v4, min_u64(v1.collateral, 0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::get_locked_balance<T0>(arg1, arg2)))
        } else {
            0
        };
        let v7 = if (v5 && v4 > v6) {
    ...
    public fun create_position_store(arg0: &0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::admin_config::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun reduce_position<T0>(arg0: &mut PositionStore, arg1: &mut 0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::MarginBank<T0>, arg2: address, arg3: 0x2::object::ID, arg4: u64, arg5: u64, arg6: u64, arg7: u128, arg8: bool, arg9: u128, arg10: u64) {
        let v0 = make_key(arg2, arg3);
        assert!(0x2::table::contains<vector<u8>, StoredPosition>(&arg0.positions, v0), 0);
        assert!(arg4 > 0, 2);
        let v1 = 0x2::table::borrow<vector<u8>, StoredPosition>(&arg0.positions, v0);
        ...
        if (arg5 > 0) {
            0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::unlock_collateral<T0>(arg1, arg2, arg5);
        };
        if (arg6 > 0) {
            0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::slash_locked<T0>(arg1, arg2, arg6);
        };
    }
    ...
    public(friend) fun settle_market_funding_round_v4<T0>(arg0: &mut PositionStore, arg1: &mut 0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::MarginBank<T0>, arg2: 0x2::object::ID, arg3: u64, arg4: u128, arg5: bool, arg6: u128, arg7: &0x2::clock::Clock) : u64 {
        if (!0x2::linked_table::contains<0x2::object::ID, vector<address>>(&arg0.market_positions, arg2)) {
            return 0
        };
        ...
        while (v6 < v8) {
            ...
            while (v14 > 0) {
                ...
                0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::transfer_locked<T0>(arg1, v15.owner, v13.owner, v16);
        ...
        while (v6 < v8) {
            ...
            if (v19 > 0) {
                0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::slash_locked<T0>(arg1, v18.owner, v19);
            };
            v6 = v6 + 1;
        };
        let v20 = 0;
        ...
        while (v6 < v8) {
            ...
            v21.borrow_debit = min_u64(v21.borrow_amount, min_u64(v22, 0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::get_locked_balance<T0>(arg1, v21.owner)));
            v21.borrow_shortfall = v21.borrow_amount - v21.borrow_debit;
            v21.new_collateral = v22 - v21.borrow_debit;
            if (v21.borrow_debit > 0) {
                0xacb076e99b227bdb98685ee3537b9e89e79bff6cdaf8318e4afefdad7ba69c45::margin_bank::slash_locked<T0>(arg1, v21.owner, v21.borrow_debit);
            };
            v6 = v6 + 1;
        };
        v6 = 0;
