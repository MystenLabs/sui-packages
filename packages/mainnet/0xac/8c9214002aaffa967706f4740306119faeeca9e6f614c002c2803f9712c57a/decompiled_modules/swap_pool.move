module 0xac8c9214002aaffa967706f4740306119faeeca9e6f614c002c2803f9712c57a::swap_pool {
    ...
    fun get_swap_price<T0, T1>(arg0: &State, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) : (u64, u8) {
        ...
        if (arg0.price_check) {
            ...
            let v3 = (get_twap_price_from_dex<T0, T1>(arg2, v1, arg3) as u64);
            assert!(v3 * (10000 - arg0.price_deviation_ratio) / 10000 <= v0, 106);
            assert!(v3 * (10000 + arg0.price_deviation_ratio) / 10000 >= v0, 107);
        };
    ...
    fun swap_at_price<T0, T1>(arg0: &mut State, arg1: &SwapCap, arg2: &mut 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v3 = arg3 * 0x1::u64::pow(10, 9 + arg5 - v2) / arg4;
        assert!(v3 <= get_balance_amount<T1>(arg0), 108);
