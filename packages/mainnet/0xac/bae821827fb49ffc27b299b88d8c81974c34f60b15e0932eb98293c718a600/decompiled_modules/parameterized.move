module 0xacbae821827fb49ffc27b299b88d8c81974c34f60b15e0932eb98293c718a600::parameterized {
    ...
    public entry fun batch_execute_multi_coin_transfer<T0>(arg0: &mut TransferParams, arg1: vector<0x2::coin::Coin<T0>>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < 0x1::vector::length<0x2::coin::Coin<T0>>(&arg1)) {
            ...
            while (v8 < 0x1::vector::length<CoinDetail>(&v3)) {
                ...
                if (v9.object_id == 0x2::object::id<0x2::coin::Coin<T0>>(v5)) {
                    v6 = true;
                    v7 = v9.amount;
            ...
            if (!v6) {
                ...
                execute_single_transfer<T0>(v5, v7, v1, arg2);
            };
            v4 = v4 + 1;
        };
        while (!0x1::vector::is_empty<0x2::coin::Coin<T0>>(&arg1)) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x1::vector::pop_back<0x2::coin::Coin<T0>>(&mut arg1), v0);
        };
    ...
    fun execute_single_transfer<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
