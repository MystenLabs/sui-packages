module 0xac8370ebea7f39e752882bceb8bbead7d6502e42bf4954146558688c53d3fc4a::flipcoin {
    ...
    public entry fun play_guess_number(arg0: &mut FlipCoin, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xac8370ebea7f39e752882bceb8bbead7d6502e42bf4954146558688c53d3fc4a::random::get_last_number(0x2::clock::timestamp_ms(arg3));
        0x1::string::utf8(b"");
        let v1 = if (v0 == arg1) {
            let v2 = 0x2::dynamic_object_field::remove<bool, 0x2::coin::Coin<0x2::sui::SUI>>(&mut arg0.id, true);
