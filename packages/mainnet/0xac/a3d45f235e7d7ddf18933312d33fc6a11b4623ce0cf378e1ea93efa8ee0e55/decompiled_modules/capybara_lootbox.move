module 0xaca3d45f235e7d7ddf18933312d33fc6a11b4623ce0cf378e1ea93efa8ee0e55::capybara_lootbox {
    ...
    public fun mint_lootbox(arg0: &mut DataStorage, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg4 > 0) {
            ...
            let v4 = new_lootbox(arg7, arg0.total_lootbox);
            0x1::vector::push_back<0x2::object::ID>(&mut v2, 0x2::object::id<NFTLootbox>(&v4));
            0x1::vector::push_back<u64>(&mut v3, v4.idx);
            0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::deposit<NFTLootbox>(arg6, v4, arg7);
            arg4 = arg4 - 1;
        };
        let v5 = MintLootbox{
            from         : v0,
    ...
    public fun update_storage(arg0: &0xaca3d45f235e7d7ddf18933312d33fc6a11b4623ce0cf378e1ea93efa8ee0e55::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
