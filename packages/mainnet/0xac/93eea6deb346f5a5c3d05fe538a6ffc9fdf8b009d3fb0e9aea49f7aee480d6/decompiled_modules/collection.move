module 0xac93eea6deb346f5a5c3d05fe538a6ffc9fdf8b009d3fb0e9aea49f7aee480d6::collection {
    ...
    public entry fun changeCollectionDescription(arg0: 0x1::string::String, arg1: &mut Collection, arg2: &mut 0x2::tx_context::TxContext) {
        0xac93eea6deb346f5a5c3d05fe538a6ffc9fdf8b009d3fb0e9aea49f7aee480d6::admin::is_admin(arg1.admin, 0x2::tx_context::sender(arg2));
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Collection{
            ...
            name                   : 0x1::string::utf8(b"Betta Foundation"),
            description            : 0x1::string::utf8(x"426574746120466f756e646174696f6e206973206120636f6c6c656374696f6e206f66203131313120756e69717565204265747461204e465473202d20756e69717565206469676974616c20636f6c6c65637469626c6573206275696c74206f6e200a405375696e6574776f726b"),
            supply                 : 1111,
            url                    : 0x2::url::new_unsafe_from_bytes(b"https://bettasui.xyz/collection/1/profile/profile.gif"),
            metadata_uri           : 0x1::string::utf8(b"https://ipfs.io/ipfs/QmVmTA3nP2nhziuUHHKwuopfsSrLrwBuYHdrr2jyNtCcBt/betta foundation"),
            minted                 : 0,
            max_mint_per_whitelist : 3,
            whitelist_price        : 7690000000,
            max_public_per_wallet  : 1111,
            public_price           : 7690000000,
            launchpad_fee          : 3,
