module 0xaca0f7dab963f603fb5c3948728d5b6d32ab10b2d4668f1ae5f4ac2473bf52eb::cnsnft5759 {
    struct CNSNFT5759 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5759, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5759>(arg0, arg1);
