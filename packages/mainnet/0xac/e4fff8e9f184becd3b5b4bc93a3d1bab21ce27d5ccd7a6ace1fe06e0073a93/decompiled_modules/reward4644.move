module 0xace4fff8e9f184becd3b5b4bc93a3d1bab21ce27d5ccd7a6ace1fe06e0073a93::reward4644 {
    struct REWARD4644 has drop {
        dummy_field: bool,
    }

    struct TICKET_4644 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4644(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4644>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4644>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4644, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4644>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4644>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4644>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4644>>(v5, 0x2::tx_context::sender(arg1));
    }
