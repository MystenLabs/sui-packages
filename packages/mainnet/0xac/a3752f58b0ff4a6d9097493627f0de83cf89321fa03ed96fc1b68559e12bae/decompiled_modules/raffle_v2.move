module 0xaca3752f58b0ff4a6d9097493627f0de83cf89321fa03ed96fc1b68559e12bae::raffle_v2 {
    ...
    public entry fun claim_nft_prize_bypass(arg0: &RaffleManager, arg1: &mut Raffle, arg2: WinnerCertificate, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.raffle_id == 0x2::object::id<Raffle>(arg1), 7);
        assert!(arg2.winner == 0x2::tx_context::sender(arg3), 7);
        assert!(0x1::option::is_some<address>(&arg1.winner), 10);
        let v0 = *0x1::option::borrow<address>(&arg1.winner);
        ...
        let v1 = PrizeData{
            ...
            data : b"NFT prize claimed successfully. If you don't see it in your wallet, contact support with this receipt.",
        };
        distribute_proceeds(arg1, arg0, arg3);
        let v2 = PrizeClaimed{
            raffle_id  : 0x2::object::id<Raffle>(arg1),
        ...
        0x2::event::emit<PrizeClaimed>(v2);
        0x2::transfer::public_transfer<PrizeData>(v1, v0);
        let WinnerCertificate {
            id        : v3,
            raffle_id : _,
            winner    : _,
    ...
    public entry fun claim_prize(arg0: &RaffleManager, arg1: &mut Raffle, arg2: WinnerCertificate, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::string::utf8(b"TOKEN") == v1) {
        ...
        } else if (0x2::dynamic_field::exists_<vector<u8>>(&arg1.id, b"prize")) {
            let v2 = PrizeData{
                id   : 0x2::object::new(arg3),
                data : b"Actual NFT has been transferred to your wallet",
            };
            ...
            0x2::transfer::public_transfer<PrizeData>(v4, v0);
        };
        distribute_proceeds(arg1, arg0, arg3);
        let v5 = PrizeClaimed{
            raffle_id  : 0x2::object::id<Raffle>(arg1),
