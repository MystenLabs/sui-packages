module 0xacdde07c60129541b96cb94f010afda5a2d1de05d0ff2b22724aaf29ae761392::c_nano_world_vol_2 {
    struct C_NANO_WORLD_VOL_2 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: C_NANO_WORLD_VOL_2, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<C_NANO_WORLD_VOL_2>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b" Nano World vol.2"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Driven by a shared past shrouded in tragedy, these four vigilantes fight to protect the innocent from the corrupt forces that threaten their city. Their fiery determination masks a deep well of pain, fueling their relentless pursuit of justice."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibecwqgikerpqcro7gcnlxk6g3aebjjjnftejh4kd62ysrsqttsgi"));
