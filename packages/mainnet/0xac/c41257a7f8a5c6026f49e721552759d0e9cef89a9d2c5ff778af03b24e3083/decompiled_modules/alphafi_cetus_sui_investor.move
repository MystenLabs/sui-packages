module 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::alphafi_cetus_sui_investor {
    ...
    fun autocompound_internal<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS, T1>, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg6: 0x2::balance::Balance<T0>, arg7: 0x2::balance::Balance<T1>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let v13 = if (v12 == 100) {
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg5) * 999749968 / 1000000000
        } else if (v12 == 10000) {
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg5) * 992471662 / 1000000000
        } else {
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg5) * 997496867 / 1000000000
        };
        let (v14, v15) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg1, arg2, v11, v10, arg5, v13, arg8, arg9);
        let v16 = v15;
        let v17 = v14;
        let v18 = FreeBalanceEventNew{
        ...
        0x2::event::emit<FreeBalanceEventNew>(v18);
        0x2::balance::join<T0>(&mut v17, arg6);
        0x2::balance::join<T1>(&mut v16, arg7);
        let (_, v20, v21) = get_balances_in_ratio<T0, T1>(arg0, v17, v16, arg5, true);
        let v22 = v21;
        let v23 = v20;
        let v24 = FreeBalanceEventNew{
            free_balance_a : 0x2::balance::value<T0>(&arg0.free_balance_a),
            free_balance_b : 0x2::balance::value<T1>(&arg0.free_balance_b),
            balance_a      : 0x2::balance::value<T0>(&v23),
            balance_b      : 0x2::balance::value<T1>(&v22),
            location       : 11,
        };
        0x2::event::emit<FreeBalanceEventNew>(v24);
    ...
    public fun rebalance<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::RebalanceCap, arg2: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::version::Version, arg3: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS, T1>, arg7: u32, arg8: u32, arg9: u32, arg10: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = if (v7 == 100) {
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg10) * 999749968 / 1000000000
        } else if (v7 == 10000) {
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg10) * 992471662 / 1000000000
        } else {
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg10) * 997496867 / 1000000000
        };
        ...
        while (v11 < arg9 + 1) {
            ...
            let (v16, v17) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg3, arg4, v15, v14, arg10, v8, arg11, arg12);
            let (_, v19, v20) = get_balances_in_ratio<T0, T1>(arg0, v16, v17, arg10, true);
            let v21 = v20;
            let v22 = v19;
            if (0x2::balance::value<T0>(&v22) > 0 || 0x2::balance::value<T1>(&v21) > 0) {
                let v23 = if (0x2::balance::value<T0>(&v22) == 0) {
                    0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg4, arg10, &mut v1, 0x2::balance::value<T1>(&v21), false, arg11)
                } else {
                    0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg4, arg10, &mut v1, 0x2::balance::value<T0>(&v22), true, arg11)
                };
                let v24 = v23;
        ...
        let (v28, v29) = autocompound_internal<T0, T1>(arg0, arg3, arg4, arg5, arg6, arg10, 0x2::balance::zero<T0>(), 0x2::balance::zero<T1>(), arg11, arg12);
        let v30 = v29;
        let v31 = v28;
        ...
        if (0x2::balance::value<T0>(&v31) > 0 || 0x2::balance::value<T1>(&v30) > 0) {
            deposit<T0, T1>(arg0, arg4, arg10, v31, v30, arg11);
        } else {
