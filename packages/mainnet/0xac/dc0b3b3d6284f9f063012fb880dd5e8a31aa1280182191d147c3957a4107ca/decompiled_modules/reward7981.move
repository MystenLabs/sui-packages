module 0xacdc0b3b3d6284f9f063012fb880dd5e8a31aa1280182191d147c3957a4107ca::reward7981 {
    struct REWARD7981 has drop {
        dummy_field: bool,
    }

    struct TICKET_7981 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7981(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7981>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7981>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7981, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7981>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7981>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7981>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7981>>(v5, 0x2::tx_context::sender(arg1));
    }
