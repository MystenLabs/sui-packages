module 0x6916b60ae826f14b3e2d7aa9c7eaf491a489379e2357c2819f48dde75a45ab58::nft {
    ...
    public entry fun bet(arg0: &0x2::clock::Clock, arg1: &mut Registry, arg2: vector<CubicNft>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::table::contains<address, bool>(&v2.user_addrs, v4), 22);
        ...
        0x2::table::add<u64, Bet>(&mut v2.bets, 0x2::table::length<address, bool>(&mut v2.user_addrs), v12);
        0x2::table::add<address, bool>(&mut v2.user_addrs, v4, true);
        let v13 = BetEvent{
            user_addr : v4,
            nft_ids   : v6,
            guild_num : arg3,
