module 0xac98824de4aa0229154b2866b76e6200867a24954a12354c134e25c0ce6a2cc3::reward5827 {
    struct REWARD5827 has drop {
        dummy_field: bool,
    }

    struct TICKET_5827 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5827(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5827>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5827>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5827, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5827>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5827>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5827>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5827>>(v5, 0x2::tx_context::sender(arg1));
    }
