module 0xac41317094feb4233047a176f26c3e3b32cc5896ca1a5ec08127de8e29344e3d::my_token {
    ...
    struct TreasuryLock has key {
        id: 0x2::object::UID,
        treasury_cap: 0x2::coin::TreasuryCap<MY_TOKEN>,
    }
    ...
    public entry fun burn(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut TreasuryLock, arg2: &mut 0x2::coin::Coin<MY_TOKEN>, arg3: u64, arg4: &UpgradeVersion, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg4.version == 0, 9);
        assert!(arg3 != 0, 3);
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(!0x2::coin::deny_list_contains<MY_TOKEN>(arg0, v0), 7);
        0x2::coin::burn<MY_TOKEN>(&mut arg1.treasury_cap, 0x2::coin::take<MY_TOKEN>(0x2::coin::balance_mut<MY_TOKEN>(arg2), arg3, arg5));
        let v1 = BurnedTokens{
            burned_amount : arg3,
            recipient     : v0,
        };
    ...
    public entry fun total_supply(arg0: &TreasuryLock, arg1: &UpgradeVersion) : u64 {
        let v0 = 0x2::coin::total_supply<MY_TOKEN>(&arg0.treasury_cap);
    ...
    public entry fun add_addr_to_blacklist(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCap<MY_TOKEN>, arg2: &Owner, arg3: vector<address>, arg4: &UpgradeVersion, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg4.version == 0, 9);
        let v0 = 0;
        ...
        while (v0 < 0x1::vector::length<address>(&arg3)) {
            ...
            if (0x2::coin::deny_list_contains<MY_TOKEN>(arg0, v3)) {
                ...
                0x2::coin::deny_list_add<MY_TOKEN>(arg0, arg1, v3, arg5);
            };
            v0 = v0 + 1;
        };
    ...
    public entry fun change_owner(arg0: 0x2::coin::DenyCap<MY_TOKEN>, arg1: 0x2::package::UpgradeCap, arg2: &0x2::deny_list::DenyList, arg3: &mut MinterRole, arg4: Owner, arg5: address, arg6: &UpgradeVersion, arg7: &0x2::tx_context::TxContext) {
        let v0 = arg4.owner;
        assert!(arg6.version == 0, 9);
        assert!(@0x0 != arg5, 4);
        assert!(0x2::tx_context::sender(arg7) == v0, 1);
        assert!(arg5 != v0, 2);
        assert!(!0x2::coin::deny_list_contains<MY_TOKEN>(arg2, arg5), 6);
        arg4.owner = arg5;
        ...
        0x2::transfer::public_transfer<0x2::coin::DenyCap<MY_TOKEN>>(arg0, arg5);
    ...
    fun execute_minting_based_on_allowance(arg0: &mut MinterRole, arg1: address, arg2: &mut TreasuryLock, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        if (0x2::vec_set::contains<address>(&arg0.has_unlimited_mint_access, &arg1)) {
            0x2::coin::mint_and_transfer<MY_TOKEN>(&mut arg2.treasury_cap, arg3, arg4, arg5);
    ...
    public entry fun grant_minter_role(arg0: &0x2::deny_list::DenyList, arg1: &Owner, arg2: &mut MinterRole, arg3: &UpgradeVersion, arg4: address, arg5: 0x1::option::Option<u64>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(@0x0 != arg4, 4);
        assert!(!0x2::coin::deny_list_contains<MY_TOKEN>(arg0, arg4), 7);
    ...
    fun init(arg0: MY_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<MY_TOKEN>(arg0, 9, b"AMY", b"MY_TOKEN", b"MY Utility Coin ", 0x1::option::none<0x2::url::Url>(), arg1);
        let v3 = 0x2::tx_context::sender(arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<MY_TOKEN>>(v2);
        0x2::transfer::public_transfer<0x2::coin::DenyCap<MY_TOKEN>>(v1, v3);
        let v4 = TreasuryLock{
    ...
    public entry fun remove_addr_from_blacklist(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCap<MY_TOKEN>, arg2: vector<address>, arg3: &UpgradeVersion, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg3.version == 0, 9);
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            0x2::coin::deny_list_remove<MY_TOKEN>(arg0, arg1, 0x1::vector::pop_back<address>(&mut arg2), arg4);
            v0 = v0 + 1;
        };
    ...
    public entry fun update_mint_allowance(arg0: &0x2::deny_list::DenyList, arg1: &Owner, arg2: &mut MinterRole, arg3: address, arg4: 0x1::option::Option<u64>, arg5: &UpgradeVersion, arg6: &0x2::tx_context::TxContext) {
        assert!(arg5.version == 0, 9);
        let v0 = arg1.owner;
        assert!(!0x2::coin::deny_list_contains<MY_TOKEN>(arg0, arg3), 7);
