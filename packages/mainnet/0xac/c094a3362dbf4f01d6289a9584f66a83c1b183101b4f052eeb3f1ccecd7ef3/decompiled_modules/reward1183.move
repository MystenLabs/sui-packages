module 0xacc094a3362dbf4f01d6289a9584f66a83c1b183101b4f052eeb3f1ccecd7ef3::reward1183 {
    struct REWARD1183 has drop {
        dummy_field: bool,
    }

    struct TICKET_1183 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1183(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1183>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1183>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1183, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1183>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1183>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1183>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1183>>(v5, 0x2::tx_context::sender(arg1));
    }
