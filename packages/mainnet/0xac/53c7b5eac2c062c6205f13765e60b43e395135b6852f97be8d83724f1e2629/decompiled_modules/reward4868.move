module 0xac53c7b5eac2c062c6205f13765e60b43e395135b6852f97be8d83724f1e2629::reward4868 {
    struct REWARD4868 has drop {
        dummy_field: bool,
    }

    struct TICKET_4868 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4868(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4868>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4868>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4868, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4868>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4868>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4868>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4868>>(v5, 0x2::tx_context::sender(arg1));
    }
