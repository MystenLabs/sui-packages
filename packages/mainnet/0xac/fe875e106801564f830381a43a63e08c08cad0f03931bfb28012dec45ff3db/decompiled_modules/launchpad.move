module 0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::launchpad {
    ...
    public entry fun admin_mint_token<T0: drop + store>(arg0: &mut LaunchpadStore, arg1: &mut 0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::NftCap<T0>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: vector<0x1::string::String>, arg9: vector<0x1::string::String>, arg10: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun create_collection<T0: drop + store>(arg0: &mut LaunchpadStore, arg1: &0x2::package::Publisher, arg2: &0x2::package::Publisher, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: u64, arg8: u64, arg9: u16, arg10: u64, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::signature::verify_signature<CreateCollectionData>(&v1, arg11, arg0.public_key);
    ...
    fun create_collection_internal<T0: drop + store>(arg0: &mut LaunchpadStore, arg1: &0x2::package::Publisher, arg2: &0x2::package::Publisher, arg3: &CreateCollectionData, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let (v0, v1, v2) = 0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::register_nft_type<T0>(arg1, arg2, arg3.max_supply, arg3.royalty_numerator, arg3.min_amount, arg4);
        let v3 = v2;
        let v4 = v1;
        let v5 = v0;
        let v6 = Collection{
            ...
            address              : 0x2::object::id_address<0x2::transfer_policy::TransferPolicy<0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::Nft<T0>>>(&v3),
        ...
        let v7 = CreateCollectionEvent{
            ...
            name       : arg3.name,
            nft_cap_id : 0x2::object::id_address<0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::NftCap<T0>>(&v5),
            display_id : 0x2::object::id_address<0x2::display::Display<0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::Nft<T0>>>(&v4),
        };
        0x2::event::emit<CreateCollectionEvent>(v7);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::Nft<T0>>>(v3);
        0x2::transfer::public_transfer<0x2::display::Display<0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::Nft<T0>>>(v4, @0x862cbc9f1a76b0df55b4dcb4fbc170fc91ecdddaa0072941d4db6be1a2e5e5a9);
        0x2::transfer::public_transfer<0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::NftCap<T0>>(v5, @0x862cbc9f1a76b0df55b4dcb4fbc170fc91ecdddaa0072941d4db6be1a2e5e5a9);
    }
    ...
    public entry fun create_mint_token_order(arg0: &mut LaunchpadStore, arg1: &0x2::clock::Clock, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: u64, arg9: u64, arg10: u64, arg11: bool, arg12: vector<u8>, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::signature::verify_signature<CreateMintTokenOrderData>(&v1, arg12, arg0.public_key);
    ...
    fun mint_one_token<T0: drop + store>(arg0: &mut 0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::NftCap<T0>, arg1: address, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: vector<0x1::string::String>, arg6: vector<0x1::string::String>, arg7: &mut 0x2::tx_context::TxContext) : address {
        let v0 = 0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::mint<T0>(arg0, arg2, arg3, arg4, arg5, arg6, 0x1::option::none<T0>(), 0x1::option::some<address>(arg1), 0x1::vector::empty<vector<u8>>(), arg7);
        0x2::object::id_to_address(&v0)
    }

    fun mint_token_internal<T0: drop + store>(arg0: &mut LaunchpadStore, arg1: &mut 0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::NftCap<T0>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: address, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: &mut 0x2::tx_context::TxContext) {
        let v0 = @0x0;
    ...
    public entry fun update_token<T0: drop + store>(arg0: &mut LaunchpadStore, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::Nft<T0>, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: vector<0x1::string::String>, arg9: vector<0x1::string::String>, arg10: vector<u8>, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = UpdateTokenData{
            ...
            stage_id        : arg2,
            order_id        : arg3,
            token           : 0x2::object::id_bytes<0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::Nft<T0>>(arg4),
            name            : arg5,
            description     : arg6,
            image_url       : arg7,
            property_keys   : arg8,
        ...
        0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::signature::verify_signature<UpdateTokenData>(&v1, arg10, arg0.public_key);
        update_token_internal<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg11);
    }

    fun update_token_internal<T0: drop + store>(arg0: &mut LaunchpadStore, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::Nft<T0>, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: vector<0x1::string::String>, arg9: vector<0x1::string::String>, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = get_mint_token_order(arg0, arg1, arg2, arg3);
        assert!(v0.allow_update, 1);
        0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::update<T0>(0x1::option::destroy_some<0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::UpdateNftCap<T0>>(0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::create_update_ntf_cap<T0>(0x2::object::id<0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft::Nft<T0>>(arg4), arg10)), arg4, arg5, arg6, arg7, arg8, arg9);
