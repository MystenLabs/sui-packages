module 0xac216dbd978b0895d5ce2d9b2f6f4bd131e12a0b6e46d3ac4c5712d115e0c6a1::cnsnft2378 {
    struct CNSNFT2378 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2378, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2378>(arg0, arg1);
