module 0xac6efe8d03ac0403f08af6aba96099fab90f6c6ae7471698a1f650a79bc9e9ee::cnsnft4533 {
    struct CNSNFT4533 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4533, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4533>(arg0, arg1);
