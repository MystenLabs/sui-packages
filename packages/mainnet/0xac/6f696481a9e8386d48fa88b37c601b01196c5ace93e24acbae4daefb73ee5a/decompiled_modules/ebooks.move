module 0xac6f696481a9e8386d48fa88b37c601b01196c5ace93e24acbae4daefb73ee5a::ebooks {
    ...
    fun init(arg0: EBOOKS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<EBOOKS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"EBooks"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"EBook NFTs"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiaei7np25q5m3fwpe24uzvwynntfvsmy3b6fceviei2jpb2aoqhpy"));
