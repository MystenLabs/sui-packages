module 0xac9565fa27ef1ce973ae8fecd10755ea14cc6dcbb3d19c7bdd45886899c8382d::campaign {
    ...
    public entry fun add_whitelist(arg0: &AdminCap, arg1: address, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<UserWhitelist>(v0, arg1);
    }
    ...
    public entry fun remove_whitelist(arg0: &AdminCap, arg1: UserWhitelist) {
        let UserWhitelist {
            id             : v0,
            user           : _,
            permission     : _,
