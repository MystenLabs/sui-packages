module 0xacbd26600865654b872bcdfbb5d2d5d4ca17848ffb09c8ba638ac860c981e970::reward1230 {
    struct REWARD1230 has drop {
        dummy_field: bool,
    }

    struct TICKET_1230 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1230(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1230>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1230>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1230, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1230>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1230>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1230>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1230>>(v5, 0x2::tx_context::sender(arg1));
    }
