module 0xac6b30cef484d3de08c682d50d1578d0bd1ef7f30d5e4a4bfc4f9de88b3f16c8::cnsnft8128 {
    struct CNSNFT8128 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8128, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8128>(arg0, arg1);
