module 0xac244e4fe83a362e7edf2c704e56633fc7e64bff16c19cbcd976f249f32a43e4::transceiver_message_data {
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : TransceiverMessageData<vector<u8>> {
        ...
        TransceiverMessageData<vector<u8>>{
            ...
            ntt_manager_payload           : 0xac244e4fe83a362e7edf2c704e56633fc7e64bff16c19cbcd976f249f32a43e4::ntt_manager_message::take_bytes(arg0),
        }
    }
    ...
    public fun to_bytes(arg0: TransceiverMessageData<vector<u8>>) : vector<u8> {
        ...
        let v4 = 0xac244e4fe83a362e7edf2c704e56633fc7e64bff16c19cbcd976f249f32a43e4::ntt_manager_message::to_bytes(v2);
