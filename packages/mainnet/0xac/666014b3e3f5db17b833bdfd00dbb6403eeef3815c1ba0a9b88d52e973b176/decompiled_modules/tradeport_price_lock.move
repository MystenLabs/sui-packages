module 0xac666014b3e3f5db17b833bdfd00dbb6403eeef3815c1ba0a9b88d52e973b176::tradeport_price_lock {
    ...
    public fun cancel_lock<T0: store + key>(arg0: &mut Store, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, Lock<T0>>(&arg0.id, arg1), 2);
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Lock<T0>>(&mut arg0.id, arg1);
