module 0xe3f080e23d100cbcad862c143b94fe4a9bfb42a9bf128605411611815ad5adcd::bit_metaverse {
    struct BIT_METAVERSE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BIT_METAVERSE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BIT_METAVERSE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Bit Metaverse"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Bit Metaverse NFT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidg7taijji6qnzlijxikgf6dipqn2b5hg6jvdaraqykfj4z4addde"));
