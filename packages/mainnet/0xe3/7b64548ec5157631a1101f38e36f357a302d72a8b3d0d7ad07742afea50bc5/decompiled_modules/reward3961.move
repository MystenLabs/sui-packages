module 0xe37b64548ec5157631a1101f38e36f357a302d72a8b3d0d7ad07742afea50bc5::reward3961 {
    struct REWARD3961 has drop {
        dummy_field: bool,
    }

    struct TICKET_3961 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3961(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3961>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3961>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3961, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3961>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3961>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3961>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3961>>(v5, 0x2::tx_context::sender(arg1));
    }
