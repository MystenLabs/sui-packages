module 0xe36e8c3188d6dc07582cb831739dd3f74d02421d4852bd2842940daf9bd5e873::GREY {
    struct GREY has drop {
        dummy_field: bool,
    }

    fun init(arg0: GREY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<GREY>(arg0, 9, b"DOG", b"Grey Dog", b"Grey Dog Ruzzz", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://media.istockphoto.com/id/104355461/photo/front-view-of-british-shorthair-cat-7-months-old-sitting.jpg?s=612x612&w=0&k=20&c=OXg47eem5DnX2WkX_kcDaZcl5-ARAbaBt6Bu5kLY7LM=")), arg1);
        let v2 = v0;
