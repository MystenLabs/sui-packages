module 0xe3f13006145a10732450f1a8f4f4c73e6c26cbe235fdc5d85a559f65e53b3af7::faucet {
    ...
    public fun create<T0: drop>(arg0: &AdminCap, arg1: T0, arg2: &mut AgentFactory, arg3: u8, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        0x1::debug::print<vector<u8>>(&arg4);
        0x1::debug::print<vector<u8>>(&arg5);
        0x1::debug::print<vector<u8>>(&arg6);
        0x1::debug::print<vector<u8>>(&arg7);
        0x1::debug::print<T0>(&arg1);
        0x1::debug::print<u8>(&arg3);
        let v0 = 0x2::url::new_unsafe_from_bytes(arg7);
        0x1::debug::print<0x2::url::Url>(&v0);
        0x1::debug::print<0x2::tx_context::TxContext>(arg8);
        let (v1, v2) = 0x2::coin::create_currency<T0>(arg1, arg3, arg5, arg4, arg6, 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(arg7)), arg8);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<T0>>(v2);
        let v3 = &mut arg2.next_agent_str;
        increment_agent_str(v3);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<T0>>(v1, 0x2::tx_context::sender(arg8));
    }
