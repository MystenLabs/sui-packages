module 0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::account {
    ...
    public fun add_credential(arg0: &mut Account, arg1: 0x2::object::ID, arg2: 0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::NewCredential, arg3: vector<0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::Credential>, arg4: &0x2::tx_context::TxContext) {
        0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::assert_pubkey_length(&arg2);
        let v0 = borrow_shared_mut(arg0, arg1);
        assert!(0x2::vec_set::length<vector<u8>>(&v0.credentials) < 16, 2);
        assert!(!0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::is_already_registered(&arg2, &v0.credentials), 1);
        let v1 = 0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::new_credential_id_bytes(&arg2);
        let v2 = wrapper_uid_bytes(v0);
        let v3 = 0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::challenges::add_credential(&v2, v0.nonce, &v1);
        0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::verify_threshold(arg3, &v0.credentials, &v3, v0.threshold, arg4);
        0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::insert_credential(arg2, &mut v0.credentials);
        v0.nonce = v0.nonce + 1;
    }

    public(friend) fun authorize_shared_and_bump_nonce(arg0: &mut Account, arg1: 0x2::object::ID, arg2: vector<0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::Credential>, arg3: &vector<u8>, arg4: &0x2::tx_context::TxContext) {
        let v0 = borrow_shared_mut(arg0, arg1);
        0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::verify_threshold(arg2, &v0.credentials, arg3, v0.threshold, arg4);
        v0.nonce = v0.nonce + 1;
    }
    ...
    fun build_initial_roster(arg0: vector<0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::NewCredential>, arg1: u64) : 0x2::vec_set::VecSet<vector<u8>> {
        let v0 = 0x1::vector::length<0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::NewCredential>(&arg0);
        assert!(v0 > 0, 9);
        assert!(v0 <= 16, 2);
        assert!(arg1 >= 1, 4);
        assert!(arg1 <= v0, 6);
        let v1 = 0x2::vec_set::empty<vector<u8>>();
        while (!0x1::vector::is_empty<0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::NewCredential>(&arg0)) {
            let v2 = 0x1::vector::pop_back<0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::NewCredential>(&mut arg0);
            0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::assert_pubkey_length(&v2);
            assert!(!0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::is_already_registered(&v2, &v1), 1);
            0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::insert_credential(v2, &mut v1);
        };
        0x1::vector::destroy_empty<0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::NewCredential>(arg0);
        v1
    }
    ...
    public fun register_account(arg0: &0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::acl::OperatorCap, arg1: &mut 0x2::tx_context::TxContext) : Account {
        Account{id: 0x2::object::new(arg1)}
    }

    public fun remove_credential(arg0: &mut Account, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: vector<0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::Credential>, arg4: &0x2::tx_context::TxContext) {
        let v0 = borrow_shared_mut(arg0, arg1);
        ...
        let v2 = 0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::challenges::remove_credential(&v1, v0.nonce, &arg2);
        0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::verify_threshold(arg3, &v0.credentials, &v2, v0.threshold, arg4);
        0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::remove_credential(arg2, &mut v0.credentials);
        v0.nonce = v0.nonce + 1;
    }

    public fun set_threshold(arg0: &mut Account, arg1: 0x2::object::ID, arg2: u64, arg3: vector<0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::Credential>, arg4: &0x2::tx_context::TxContext) {
        let v0 = borrow_shared_mut(arg0, arg1);
        assert!(arg2 >= 1, 4);
        assert!(arg2 <= 0x2::vec_set::length<vector<u8>>(&v0.credentials), 6);
        let v1 = wrapper_uid_bytes(v0);
        let v2 = 0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::challenges::set_threshold(&v1, v0.nonce, arg2);
        0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::verify_threshold(arg3, &v0.credentials, &v2, v0.threshold, arg4);
        v0.threshold = arg2;
        v0.nonce = v0.nonce + 1;
    }
    ...
    public(friend) fun store_shared_dwallet_cap(arg0: &mut Account, arg1: 0x2::object::ID, arg2: 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap, arg3: vector<0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::auth::NewCredential>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = SharedDWalletKey{dwallet_id: arg1};
