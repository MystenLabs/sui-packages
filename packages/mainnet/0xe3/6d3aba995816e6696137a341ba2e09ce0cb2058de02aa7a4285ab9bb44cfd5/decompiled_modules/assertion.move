module 0xe36d3aba995816e6696137a341ba2e09ce0cb2058de02aa7a4285ab9bb44cfd5::assertion {
    ...
    public(friend) fun verify_signature(arg0: &WebAuthnAssertion, arg1: &vector<u8>) {
        ...
        let v1 = 0x1::vector::empty<u8>();
        0x1::vector::append<u8>(&mut v1, b"\"challenge\":\"");
        0x1::vector::append<u8>(&mut v1, base64url_encode_32(arg1));
        0x1::vector::push_back<u8>(&mut v1, 34);
        assert!(contains_subvec(&arg0.client_data_json, &v1), 3);
    }
