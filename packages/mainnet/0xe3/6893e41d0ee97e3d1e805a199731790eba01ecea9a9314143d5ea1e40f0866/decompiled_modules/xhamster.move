module 0xe36893e41d0ee97e3d1e805a199731790eba01ecea9a9314143d5ea1e40f0866::xhamster {
    ...
    fun init(arg0: XHAMSTER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<XHAMSTER>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"xhamster    ")))), trim_right(b"xhamster                        "), trim_right(b"xHamster is the official token of the xHamster website. xHamster is a popular adult entertainment platform offering a vast collection of user-generated and professional adult content, including videos, live streams, and photos. NFTs are sold out                                                                           "), v2, arg1);
