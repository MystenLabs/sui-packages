module 0xe35ad578758320ec882be38a96538cdd085eb5c09ffd41c1bfdf7e9d9113786b::cnsnft4760 {
    struct CNSNFT4760 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4760, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4760>(arg0, arg1);
