module 0xe3a44bf911f0960642a5af1865822242eb3e83babc920950a86d840b98a3c118::reward3857 {
    struct REWARD3857 has drop {
        dummy_field: bool,
    }

    struct TICKET_3857 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3857(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3857>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3857>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3857, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3857>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3857>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3857>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3857>>(v5, 0x2::tx_context::sender(arg1));
    }
