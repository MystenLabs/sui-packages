module 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message {
    ...
    struct UpdateBridgeMinAmount has drop {
        sending_chain: u8,
        sending_token: u8,
        min_amount: u64,
    }

    struct UpdateBridgeFeePercentage has drop {
        sending_chain: u8,
        sending_token: u8,
        fee_percentage: u64,
    }
    ...
    public fun bytes_to_hex(arg0: vector<u8>) : 0x1::string::String {
        ...
        while (v1 < 0x1::vector::length<u8>(&arg0)) {
            0x1::string::append(&mut v0, u8_to_hex(*0x1::vector::borrow<u8>(&arg0, v1)));
            v1 = v1 + 1;
        };
        v0
    }

    public fun create_add_routes_on_sui_message(arg0: u8, arg1: u64, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u64>, arg5: vector<u64>, arg6: vector<bool>, arg7: vector<u64>) : BridgeMessage {
        0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::chain_ids::assert_valid_chain_id(arg0);
        ...
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<vector<u64>>(&arg7));
        BridgeMessage{
            message_type    : 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::add_routes_on_sui(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun create_add_tokens_on_sui_message(arg0: u8, arg1: u64, arg2: bool, arg3: vector<u8>, arg4: vector<0x1::ascii::String>, arg5: vector<u64>) : BridgeMessage {
        ...
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<vector<u64>>(&arg5));
        BridgeMessage{
            message_type    : 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::add_tokens_on_sui(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun create_blocklist_message(arg0: u8, arg1: u64, arg2: u8, arg3: vector<vector<u8>>) : BridgeMessage {
        ...
        BridgeMessage{
            message_type    : 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::committee_blocklist(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v1,
    ...
    public fun create_emergency_op_message(arg0: u8, arg1: u64, arg2: u8) : BridgeMessage {
        ...
        BridgeMessage{
            message_type    : 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::emergency_op(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun create_token_bridge_message(arg0: u8, arg1: u64, arg2: vector<u8>, arg3: u8, arg4: vector<u8>, arg5: u8, arg6: u64) : BridgeMessage {
        ...
        BridgeMessage{
            message_type    : 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::token(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun create_update_asset_price_message(arg0: u8, arg1: u8, arg2: u64, arg3: u64) : BridgeMessage {
        0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::chain_ids::assert_valid_chain_id(arg1);
        let v0 = 0x1::vector::empty<u8>();
        0x1::vector::push_back<u8>(&mut v0, arg0);
        0x1::vector::append<u8>(&mut v0, reverse_bytes(0x2::bcs::to_bytes<u64>(&arg3)));
        BridgeMessage{
            message_type    : 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::update_asset_price(),
            message_version : 1,
            seq_num         : arg2,
            source_chain    : arg1,
            payload         : v0,
    ...
    public fun create_update_bridge_fee_percentage_message(arg0: u8, arg1: u64, arg2: u8, arg3: u8, arg4: u64) : BridgeMessage {
        0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::chain_ids::assert_valid_chain_id(arg0);
        let v0 = b"";
        0x1::vector::push_back<u8>(&mut v0, arg2);
        0x1::vector::push_back<u8>(&mut v0, arg3);
        ...
        BridgeMessage{
            message_type    : 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::update_bridge_fee_percentage(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun create_update_bridge_limit_message(arg0: u8, arg1: u64, arg2: u8, arg3: u8, arg4: u64) : BridgeMessage {
        ...
        0x1::vector::append<u8>(&mut v0, reverse_bytes(0x2::bcs::to_bytes<u64>(&arg4)));
        BridgeMessage{
            message_type    : 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::update_bridge_limit(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun create_update_bridge_min_amount_message(arg0: u8, arg1: u64, arg2: u8, arg3: u8, arg4: u64) : BridgeMessage {
        0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::chain_ids::assert_valid_chain_id(arg0);
        let v0 = b"";
        0x1::vector::push_back<u8>(&mut v0, arg2);
        0x1::vector::push_back<u8>(&mut v0, arg3);
        0x1::vector::append<u8>(&mut v0, reverse_bytes(0x2::bcs::to_bytes<u64>(&arg4)));
        BridgeMessage{
            message_type    : 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::update_bridge_min_amount(),
            message_version : 1,
            seq_num         : arg1,
            source_chain    : arg0,
            payload         : v0,
    ...
    public fun extract_add_routes_on_sui(arg0: &BridgeMessage) : AddRoutesOnSui {
        ...
        AddRoutesOnSui{
            ...
            min_amounts         : 0x2::bcs::peel_vec_u64(&mut v0),
        }
    }
    ...
    public fun extract_update_bridge_fee_percentage(arg0: &BridgeMessage) : UpdateBridgeFeePercentage {
        let v0 = 0x2::bcs::new(arg0.payload);
        let v1 = &mut v0;
        0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::chain_ids::assert_valid_chain_id(arg0.source_chain);
        let v2 = 0x2::bcs::into_remainder_bytes(v0);
        assert!(0x1::vector::is_empty<u8>(&v2), 0);
        UpdateBridgeFeePercentage{
            sending_chain  : 0x2::bcs::peel_u8(&mut v0),
            sending_token  : 0x2::bcs::peel_u8(&mut v0),
            fee_percentage : peel_u64_be(v1),
        }
    }
    ...
    public fun extract_update_bridge_min_amount(arg0: &BridgeMessage) : UpdateBridgeMinAmount {
        let v0 = 0x2::bcs::new(arg0.payload);
        let v1 = &mut v0;
        0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::chain_ids::assert_valid_chain_id(arg0.source_chain);
        let v2 = 0x2::bcs::into_remainder_bytes(v0);
    ...
    public fun min_amounts(arg0: &AddRoutesOnSui) : vector<u64> {
        arg0.min_amounts
    }
    ...
    public fun required_voting_power(arg0: &BridgeMessage) : u64 {
        ...
        if (v0 == 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::token()) {
            6666
        } else if (v0 == 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::emergency_op()) {
            ...
            assert!(v0 == 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::add_routes_on_sui(), 3);
            5001
        }
    }
    ...
    public fun serialize_message(arg0: BridgeMessage) : vector<u8> {
        ...
        let v8 = 0x1::string::into_bytes(bytes_to_hex(v6));
        let v9 = b"";
        0x1::vector::append<u8>(&mut v9, x"19457468657265756d205369676e6564204d6573736167653a0a");
        0x1::vector::append<u8>(&mut v9, 0x1::string::into_bytes(0x1::u64::to_string(0x1::vector::length<u8>(&v8))));
        0x1::vector::append<u8>(&mut v9, v8);
        v9
    }
    ...
    public fun to_parsed_token_transfer_message(arg0: &BridgeMessage) : ParsedTokenTransferMessage {
        assert!(message_type(arg0) == 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message_types::token(), 6);
    ...
    public fun u8_to_hex(arg0: u8) : 0x1::string::String {
    ...
    public fun update_bridge_fee_percentage_payload_fee_percentage(arg0: &UpdateBridgeFeePercentage) : u64 {
        arg0.fee_percentage
    }

    public fun update_bridge_fee_percentage_payload_sending_chain(arg0: &UpdateBridgeFeePercentage) : u8 {
        arg0.sending_chain
    }

    public fun update_bridge_fee_percentage_payload_sending_token(arg0: &UpdateBridgeFeePercentage) : u8 {
        arg0.sending_token
    }
    ...
    public fun update_bridge_min_amount_payload_min_amount(arg0: &UpdateBridgeMinAmount) : u64 {
        arg0.min_amount
    }

    public fun update_bridge_min_amount_payload_sending_chain(arg0: &UpdateBridgeMinAmount) : u8 {
        arg0.sending_chain
    }

    public fun update_bridge_min_amount_payload_sending_token(arg0: &UpdateBridgeMinAmount) : u8 {
        arg0.sending_token
    }
