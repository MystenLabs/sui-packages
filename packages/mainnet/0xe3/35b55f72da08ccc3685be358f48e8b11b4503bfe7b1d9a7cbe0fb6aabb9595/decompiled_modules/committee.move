module 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::committee {
    ...
    public(friend) fun execute_blocklist(arg0: &mut BridgeCommittee, arg1: 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message::Blocklist) {
        let v0 = 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message::blocklist_type(&arg1) != 1;
        let v1 = 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message::blocklist_committee_addresses(&arg1);
        let v2 = 0;
        let v3 = 0;
        let v4 = vector[];
    ...
    public fun recover_signer(arg0: 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message::BridgeMessage, arg1: vector<u8>) : vector<u8> {
        ...
        let v1 = 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message::serialize_message(arg0);
    ...
    public fun verify_signatures(arg0: &BridgeCommittee, arg1: 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message::BridgeMessage, arg2: vector<vector<u8>>) {
        let v0 = 0;
        ...
        assert!(v2 >= 0xe335b55f72da08ccc3685be358f48e8b11b4503bfe7b1d9a7cbe0fb6aabb9595::message::required_voting_power(&arg1), 0);
    }
