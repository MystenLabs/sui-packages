module 0x89ecd484c3694b14936ede1a21163f578daa5fb59c91a657616239064c81e642::kriya_amm {
    struct KriyaAmmSwapEvent has copy, drop {
    ...
    public fun swap_a2b<T0, T1>(arg0: &mut 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v2 = KriyaAmmSwapEvent{
            pool_id      : 0x2::object::id<0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::Pool<T0, T1>>(arg0),
            a2b          : true,
            amount_in    : v0,
