module 0xe30c6e16505bd2bccdd39528d3fe88f48f26a655d076623eed61910a93e33262::easy_swap {
    ...
    public fun easy_swap_A<T0, T1>(arg0: &mut EasySwapConfig, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: vector<u8>, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v1, 0x2::balance::value<T0>(&v1) * arg0.fee / 10000), arg8), arg0.fee_recipient);
        let v2 = 0x2::balance::zero<T1>();
        let v3 = &mut v1;
        let v4 = &mut v2;
        swap_cetus<T0, T1>(arg1, arg2, v3, v4, true, true, 0x2::balance::value<T0>(&v1), 4295048016, arg7);
        if (arg4 != 0) {
            assert!(0x2::balance::value<T1>(&v2) > arg4, 0);
        };
        let v5 = 0x2::balance::zero<T0>();
        let v6 = &mut v5;
        let v7 = &mut v2;
        swap_cetus<T0, T1>(arg1, arg2, v6, v7, false, true, 0x2::balance::value<T1>(&v2), 79226673515401279992447579055, arg7);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v1, arg8), v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v5, arg8), v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v2, arg8), v0);
    }
    ...
    public fun easy_swap_B<T0, T1>(arg0: &mut EasySwapConfig, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: vector<u8>, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v1, 0x2::balance::value<T1>(&v1) * arg0.fee / 10000), arg8), arg0.fee_recipient);
        let v2 = 0x2::balance::zero<T0>();
        let v3 = &mut v2;
        let v4 = &mut v1;
        swap_cetus<T0, T1>(arg1, arg2, v3, v4, false, true, 0x2::balance::value<T0>(&v2), 79226673515401279992447579055, arg7);
        if (arg4 != 0) {
