module 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::balance_manager {
    ...
    public(friend) fun assert_referral_owner(arg0: &DeepBookReferral, arg1: &0x2::tx_context::TxContext) {
    ...
    public fun get_referral_id(arg0: &BalanceManager) : 0x1::option::Option<0x2::object::ID> {
        let v0 = 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::referral_df_key();
    ...
    public(friend) fun mint_referral(arg0: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x2::object::new(arg0);
        let v1 = 0x2::object::uid_to_inner(&v0);
        let v2 = DeepBookReferral{
            id    : v0,
            owner : 0x2::tx_context::sender(arg0),
        };
        ...
        0x2::transfer::share_object<DeepBookReferral>(v2);
        v1
    }
    ...
    public fun new_with_custom_owner_caps<T0: drop>(arg0: &0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::registry::Registry, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : (BalanceManager, DepositCap, WithdrawCap, TradeCap) {
        0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::registry::assert_app_is_authorized<T0>(arg0);
    ...
    public fun register_balance_manager(arg0: &BalanceManager, arg1: &mut 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::registry::Registry, arg2: &mut 0x2::tx_context::TxContext) {
        validate_owner(arg0, arg2);
        0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::registry::add_balance_manager(arg1, owner(arg0), id(arg0));
    }

    public fun register_manager(arg0: &BalanceManager, arg1: &mut 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::registry::Registry) {
        abort 1337
    }
    ...
    public fun set_referral(arg0: &mut BalanceManager, arg1: &DeepBookReferral, arg2: &TradeCap) {
        ...
        0x2::dynamic_field::remove_if_exists<vector<u8>, 0x2::object::ID>(&mut arg0.id, 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::referral_df_key());
        0x2::dynamic_field::add<vector<u8>, 0x2::object::ID>(&mut arg0.id, 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::referral_df_key(), 0x2::object::uid_to_inner(&arg1.id));
        let v0 = DeepBookReferralSetEvent{
            referral_id        : 0x2::object::uid_to_inner(&arg1.id),
            balance_manager_id : 0x2::object::uid_to_inner(&arg0.id),
        };
        0x2::event::emit<DeepBookReferralSetEvent>(v0);
    }
