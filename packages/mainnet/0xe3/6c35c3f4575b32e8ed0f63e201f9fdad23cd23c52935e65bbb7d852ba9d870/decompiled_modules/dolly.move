module 0xe36c35c3f4575b32e8ed0f63e201f9fdad23cd23c52935e65bbb7d852ba9d870::dolly {
    ...
    fun init(arg0: DOLLY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<DOLLY>(&mut v2, 7000000000000000000, 0x2::tx_context::sender(arg1), arg1);
