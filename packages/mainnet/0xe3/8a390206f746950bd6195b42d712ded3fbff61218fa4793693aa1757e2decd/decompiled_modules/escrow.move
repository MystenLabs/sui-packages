module 0xe38a390206f746950bd6195b42d712ded3fbff61218fa4793693aa1757e2decd::escrow {
    ...
    public fun accept_offer<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: T0, arg3: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg4: &mut 0xe38a390206f746950bd6195b42d712ded3fbff61218fa4793693aa1757e2decd::marketplace::MarketPlace, arg5: &mut 0x2::tx_context::TxContext) : (OfferWrapper<T0>, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        let v4 = v2.price;
        0xe38a390206f746950bd6195b42d712ded3fbff61218fa4793693aa1757e2decd::marketplace::add_balance(arg4, 0x2::coin::take<0x2::sui::SUI>(&mut v2.balance, v3, arg5));
    ...
    fun new_offer<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: u64, arg4: 0x2::balance::Balance<0x2::sui::SUI>, arg5: &0x2::transfer_policy::TransferPolicy<T0>, arg6: &0xe38a390206f746950bd6195b42d712ded3fbff61218fa4793693aa1757e2decd::marketplace::MarketPlace, arg7: &mut 0x2::tx_context::TxContext) : (Offer<T0>, OfferCap<T0>) {
        0x2::kiosk::has_access(arg0, arg1);
        let v0 = (((0xe38a390206f746950bd6195b42d712ded3fbff61218fa4793693aa1757e2decd::marketplace::get_fee(arg6, 0x2::tx_context::sender(arg7)) as u128) * (arg3 as u128) / 10000) as u64);
        let v1 = 0;
    ...
    public fun offer<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: u64, arg4: 0x2::balance::Balance<0x2::sui::SUI>, arg5: &0x2::transfer_policy::TransferPolicy<T0>, arg6: &mut 0xe38a390206f746950bd6195b42d712ded3fbff61218fa4793693aa1757e2decd::marketplace::MarketPlace, arg7: &mut 0x2::tx_context::TxContext) {
