module 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::usdc_prize_factory {
    ...
    struct RafflePool<phantom T0> has key {
        ...
        weights: 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::fenwick::Fenwick,
    ...
    struct SwapTicket {
        ...
        minimum_out: u64,
        fair_value_out: u64,
        attestation: 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::circuit_breaker::PriceAttestation,
    }
    ...
    fun apply_harvest<T0>(arg0: &mut RafflePool<T0>, arg1: &mut AdminTreasury<T0>, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        let v1 = 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::math::bps_of(v0, arg0.config.staking_fee_bps);
        if (v1 > 0) {
    ...
    fun begin_withdrawal<T0>(arg0: &mut RafflePool<T0>, arg1: DepositReceipt, arg2: &0x2::clock::Clock) : WithdrawalIntent {
        ...
        assert!(v9.active, 21);
        v9.active = false;
        0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::fenwick::decrease(&mut arg0.weights, v2, (v3 as u128));
    ...
    public fun create_pool<T0>(arg0: &FactoryOwnerCap, arg1: u8, arg2: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: address, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) : (AdminCap, OperatorCap) {
        ...
        let v10 = RafflePool<T0>{
            ...
            stake_tail        : 0,
            staked_principal  : 0,
            weights           : 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::fenwick::new(1048576, arg16),
    ...
    public fun deposit<T0>(arg0: &mut RafflePool<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : DepositReceipt {
        ...
        0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::fenwick::increase(&mut arg0.weights, v2, (v0 as u128));
    ...
    fun finalize_withdrawal<T0>(arg0: &mut RafflePool<T0>, arg1: &mut AdminTreasury<T0>, arg2: WithdrawalIntent, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        if (v10) {
            let v11 = 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::math::bps_of(0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::math::mul_div_u64(v8, v2, v5), arg0.config.early_exit_fee_bps);
            v9 = v11;
            if (v11 > 0) {
    ...
    fun run_draw<T0>(arg0: &mut RafflePool<T0>, arg1: &0x2::random::Random, arg2: &0x2::clock::Clock, arg3: 0x1::option::Option<address>, arg4: bool, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::clock::timestamp_ms(arg2);
        let v2 = 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::fenwick::total(&arg0.weights);
        let v3 = 0x2::object::id<RafflePool<T0>>(arg0);
        let v4 = if (v0 == 0) {
            true
        ...
        let v5 = 0x2::random::new_generator(arg1, arg5);
        let v6 = 0;
        let v7 = 0x1::option::none<u64>();
        while (v6 < 12) {
            v6 = v6 + 1;
            let v8 = 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::fenwick::find(&arg0.weights, 0x2::random::generate_u128_in_range(&mut v5, 0, v2 - 1));
            let v9 = 0x2::table::borrow<u64, SlotInfo>(&arg0.slots, v8);
            if (!v9.active) {
                continue
            };
            if (v1 < v9.eligible_from_ms) {
                continue
            };
            if (0x1::option::is_some<address>(&arg3) && *0x1::option::borrow<address>(&arg3) == v9.beneficiary) {
            } else {
        ...
        let v10 = 0x1::option::destroy_some<u64>(v7);
        let v11 = 0x2::table::borrow<u64, SlotInfo>(&arg0.slots, v10).beneficiary;
        let v12 = PendingPrize{
            epoch_id    : arg0.epoch_id,
            winner      : v11,
            winner_slot : v10,
            sui_amount  : v0,
        };
        arg0.pending_prize = 0x1::option::some<PendingPrize>(v12);
        arg0.phase = 2;
        let v13 = WinnerSelected{
            ...
            winner         : v11,
            winner_slot    : v10,
            winner_weight  : 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::fenwick::weight_at(&arg0.weights, v10),
            total_weight   : v2,
            prize_sui      : v0,
            attempts       : v6,
            permissionless : arg4,
    ...
    public fun settle_prize<T0>(arg0: &mut RafflePool<T0>, arg1: &mut AdminTreasury<T0>, arg2: SwapTicket, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::circuit_breaker::assert_execution_quality(v8, v4);
        let v9 = 0x2::coin::into_balance<T0>(arg3);
        let v10 = 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::math::bps_of(v8, arg0.config.spread_bps);
        if (v10 > 0) {
        ...
        let v11 = PrizeSettled{
            ...
            winner                : v2,
            sui_converted         : v3,
            oracle_price_1e18     : 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::circuit_breaker::price_1e18(&v7),
            oracle_fair_value_out : v5,
            amm_gross_out         : v8,
            spread_bps            : arg0.config.spread_bps,
            stream_b_fee          : v10,
            winner_payout         : 0x2::balance::value<T0>(&v9),
            realised_slippage_bps : 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::circuit_breaker::realised_slippage_bps(v8, v5),
    ...
    fun stakeable_amount<T0>(arg0: &RafflePool<T0>) : u64 {
        let v0 = 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::math::bps_of(arg0.total_principal, arg0.config.liquidity_buffer_bps);
    ...
    public fun take_prize_sui<T0>(arg0: &mut RafflePool<T0>, arg1: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, SwapTicket) {
        ...
        let v0 = 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::circuit_breaker::attest(arg1, arg2, arg0.config.max_oracle_age_ms, arg0.config.max_oracle_variance_bps);
        0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::circuit_breaker::assert_feed(&v0, arg0.price_feed_id);
        ...
        let v3 = SwapTicket{
            ...
            winner         : v1.winner,
            sui_in         : v2,
            minimum_out    : 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::circuit_breaker::minimum_acceptable_out(&v0, v2, 9, arg0.prize_decimals, arg0.config.max_slippage_bps),
            fair_value_out : 0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::circuit_breaker::fair_value_out(&v0, v2, 9, arg0.prize_decimals),
            attestation    : v0,
        };
    ...
    public fun total_weight<T0>(arg0: &RafflePool<T0>) : u128 {
        0xe338cb78badd67607b64c62661534572248a23500503c7e65f56bdba68e71952::fenwick::total(&arg0.weights)
    }
