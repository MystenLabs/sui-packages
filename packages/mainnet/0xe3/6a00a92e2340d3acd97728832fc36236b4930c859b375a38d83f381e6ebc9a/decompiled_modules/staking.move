module 0x2104affc569e2f19776c5b55306d010b05a69ea5a470f59ef669d7b9991da7b1::staking {
    ...
    public entry fun claim(arg0: 0x2::object::ID, arg1: &mut StakingVault, arg2: &mut 0x2104affc569e2f19776c5b55306d010b05a69ea5a470f59ef669d7b9991da7b1::storktoken::ProtocolTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        claim_tokens(arg0, arg1, arg2, arg3);
    }
    ...
    public entry fun claim_all(arg0: vector<0x2::object::ID>, arg1: &mut StakingVault, arg2: &mut 0x2104affc569e2f19776c5b55306d010b05a69ea5a470f59ef669d7b9991da7b1::storktoken::ProtocolTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<0x2::object::ID>(&arg0)) {
            claim_tokens(*0x1::vector::borrow<0x2::object::ID>(&arg0, v0), arg1, arg2, arg3);
            v0 = v0 + 1;
        };
    }

    public fun claim_tokens(arg0: 0x2::object::ID, arg1: &mut StakingVault, arg2: &mut 0x2104affc569e2f19776c5b55306d010b05a69ea5a470f59ef669d7b9991da7b1::storktoken::ProtocolTreasury, arg3: &mut 0x2::tx_context::TxContext) {
