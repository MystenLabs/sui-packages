module 0xe35db8d851b723b0a97d6b1c181e3034b995bdd82c7ae840236d60f7dfc8ae12::storage {
    ...
    public entry fun update(arg0: &mut StorageV2, arg1: vector<address>, arg2: vector<u8>) {
        ...
        if (v0 == 0) {
            ...
            if (0x2::vec_set::size<address>(v4) >= 1000) {
                ...
                while (v7 < v1) {
                    ...
                    while (v9 < 0x1::vector::length<address>(&arg1)) {
                        0x2::vec_set::insert<address>(&mut v8, 0x1::vector::pop_back<address>(&mut arg1));
                        v9 = v9 + 1;
                    };
                    0x2::bag::add<u64, 0x2::vec_set::VecSet<address>>(&mut arg0.obligations, v0, v8);
                };
            };
        };
