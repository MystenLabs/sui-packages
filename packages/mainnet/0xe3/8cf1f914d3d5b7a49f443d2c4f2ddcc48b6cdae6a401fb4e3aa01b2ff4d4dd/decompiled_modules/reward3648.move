module 0xe38cf1f914d3d5b7a49f443d2c4f2ddcc48b6cdae6a401fb4e3aa01b2ff4d4dd::reward3648 {
    struct REWARD3648 has drop {
        dummy_field: bool,
    }

    struct TICKET_3648 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3648(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3648>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3648>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3648, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3648>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3648>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3648>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3648>>(v5, 0x2::tx_context::sender(arg1));
    }
