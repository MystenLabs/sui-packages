module 0xe33af4473bd13010760e494a4a2bf4c7acf139bcc27159641abbab3320d8c04c::agent_lattice {
    struct AGENT_LATTICE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: AGENT_LATTICE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<AGENT_LATTICE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"AGENT LATTICE"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Welcome to AGENT LATTICE - Agent Lattice is an innovative AI-powered platform built on the SONIC BLOCKCHAIN, designed to provide intelligent and interactive virtual assistance. Utilizing cutting-edge AI technology, it enables users to get accurate, real-time responses to any query, much like ChatGPT, while ensuring the security, transparency, and decentralization benefits of blockchain technology. The project leverages the capabilities of SUIBLOCKCHAIN to enhance scalability, speed, and overall efficiency, providing a seamless user experience in a decentralized ecosystem. Agent Lattice will be launched on the tradeport.xyzwith the native utility token Lattice (symbol:LATTICE) for governance, staking, and rewards."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreicxrfcfug2lzc3myjbibwzrgtpkvn3ublvzk3qyxelf5zqhxyfuuu"));
