module 0xe3310317a620f0e6f0057cf7d27a3209ec3b7632b1622e5d2521b1bfc7ea23c2::reward2172 {
    struct REWARD2172 has drop {
        dummy_field: bool,
    }

    struct TICKET_2172 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2172(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2172>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2172>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2172, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2172>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2172>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2172>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2172>>(v5, 0x2::tx_context::sender(arg1));
    }
