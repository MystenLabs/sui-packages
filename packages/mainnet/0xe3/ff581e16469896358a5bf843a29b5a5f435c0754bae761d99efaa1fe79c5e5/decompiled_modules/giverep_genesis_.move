module 0xe3ff581e16469896358a5bf843a29b5a5f435c0754bae761d99efaa1fe79c5e5::giverep_genesis_ {
    ...
    fun init(arg0: GIVEREP_GENESIS_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<GIVEREP_GENESIS_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"GiveRep Genesis "));
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://uEHYBxHSnGZERbM33DAASMv9MKBdcO2eZZEriHbq-LQ"));
