module 0xe327f2cbe8a81e91a501a20a8cd4c8cb598e259a14c0bb6ad72d53e1be821599::reward7174 {
    struct REWARD7174 has drop {
        dummy_field: bool,
    }

    struct TICKET_7174 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7174(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7174>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7174>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7174, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7174>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7174>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7174>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7174>>(v5, 0x2::tx_context::sender(arg1));
    }
