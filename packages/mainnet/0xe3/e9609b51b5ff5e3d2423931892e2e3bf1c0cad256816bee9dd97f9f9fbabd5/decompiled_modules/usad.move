module 0xe3e9609b51b5ff5e3d2423931892e2e3bf1c0cad256816bee9dd97f9f9fbabd5::usad {
    ...
    fun init(arg0: USAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3, v4) = 0x2::coin::create_regulated_currency_v2<USAD>(arg0, 9, trim_right(b"USAD"), trim_right(b"USAD  "), trim_right(b"Uio"), v1, true, arg1);
        let v5 = v2;
        let v6 = 0x2::tx_context::sender(arg1);
        if (10000000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<USAD>>(0x2::coin::mint<USAD>(&mut v5, 10000000000000000, arg1), v6);
        };
