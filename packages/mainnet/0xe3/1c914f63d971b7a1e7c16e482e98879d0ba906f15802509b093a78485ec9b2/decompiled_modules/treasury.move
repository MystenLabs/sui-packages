module 0x3e8e9423d80e1774a7ca128fccd8bf5f1f7753be658c5e645929037f7c819040::treasury {
    ...
    public fun mint<T0>(arg0: &mut ControlledTreasury<T0>, arg1: &mut 0x3e8e9423d80e1774a7ca128fccd8bf5f1f7753be658c5e645929037f7c819040::consortium::Consortium, arg2: &0x2::deny_list::DenyList, arg3: &mut 0x3e8e9423d80e1774a7ca128fccd8bf5f1f7753be658c5e645929037f7c819040::bascule::Bascule, arg4: vector<u8>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x3e8e9423d80e1774a7ca128fccd8bf5f1f7753be658c5e645929037f7c819040::consortium::validate_payload(arg1, arg4, arg5);
        let (v1, v2, v3, v4, v5, v6) = 0x3e8e9423d80e1774a7ca128fccd8bf5f1f7753be658c5e645929037f7c819040::payload_decoder::decode_mint_payload(arg4);
        ...
        let v10 = MintEvent<T0>{
            amount : v7,
            to     : v3,
            tx_id  : v8,
            index  : v9,
        };
        0x2::event::emit<MintEvent<T0>>(v10);
    ...
    fun assert_decoded_payload<T0>(arg0: u32, arg1: u256, arg2: address, arg3: u256, arg4: u256, arg5: u256, arg6: &ControlledTreasury<T0>, arg7: &mut 0x3e8e9423d80e1774a7ca128fccd8bf5f1f7753be658c5e645929037f7c819040::bascule::Bascule) : (u64, vector<u8>, u32) {
        ...
        if (is_bascule_check_enabled<T0>(arg6)) {
            ...
            0x3e8e9423d80e1774a7ca128fccd8bf5f1f7753be658c5e645929037f7c819040::bascule::validate_withdrawal<LBTCWitness>(v5, arg7, arg2, v1, v2, v4);
        };
        (v1, v2, v4)
    }
    ...
    public fun mint_with_fee<T0>(arg0: &mut ControlledTreasury<T0>, arg1: &mut 0x3e8e9423d80e1774a7ca128fccd8bf5f1f7753be658c5e645929037f7c819040::consortium::Consortium, arg2: &0x2::deny_list::DenyList, arg3: &mut 0x3e8e9423d80e1774a7ca128fccd8bf5f1f7753be658c5e645929037f7c819040::bascule::Bascule, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let (v10, v11, v12) = 0x3e8e9423d80e1774a7ca128fccd8bf5f1f7753be658c5e645929037f7c819040::payload_decoder::decode_fee_payload(arg6);
        let v13 = 0x1::u256::try_as_u64(v11);
        let v14 = 0x1::option::extract<u64>(&mut v13);
        let v15 = 0x1::u256::try_as_u64(v12);
        assert!(v10 == get_fee_action_bytes<T0>(arg0), 10);
        assert!(v14 < v7, 22);
        assert!(0x1::option::extract<u64>(&mut v15) > 0x2::clock::timestamp_ms(arg9) / 1000, 21);
        let v16 = get_mint_fee<T0>(arg0);
        let v17 = v16;
        if (v16 > v14) {
            v17 = v14;
        };
        let v18 = v7 - v17;
        0x2::table::add<vector<u8>, bool>(0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::table::Table<vector<u8>, bool>>(&mut arg0.id, b"used_payloads"), v0, true);
        let v19 = MintEvent<T0>{
            amount : v18,
            to     : v3,
            tx_id  : v8,
            index  : v9,
        };
        0x2::event::emit<MintEvent<T0>>(v19);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::mint<T0>(&mut arg0.treasury_cap, v18, arg10), v3);
    }
