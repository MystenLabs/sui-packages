module 0xe395cfbf7cf4003bd24288f84c3b02c76c4a60d2303d264307ad0505498fab48::common_coin {
    ...
    fun init(arg0: COMMON_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<COMMON_COIN>(arg0, 6, b"goomba", b"GOOMBA", b"Goomba is just a little guy", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://movepump.com/_next/image?url=https%3A%2F%2Fapi.movepump.com%2Fuploads%2F1222222_6a6dbea92d.jpg&w=640&q=75"))), arg1);
