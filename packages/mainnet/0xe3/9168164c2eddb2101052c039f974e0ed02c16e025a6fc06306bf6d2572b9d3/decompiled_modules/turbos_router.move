module 0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::turbos_router {
    ...
    public entry fun buy_exact_in<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u128, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg8: bool, arg9: 0x1::string::String, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg8) {
            ...
            0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::utils::send_coin<T0>(v3, 0x2::tx_context::sender(arg10));
            0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::utils::send_coin<T1>(v4, 0x2::tx_context::sender(arg10));
            0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::utils::send_coin<T1>(arg2, 0x2::tx_context::sender(arg10));
            assert!(v5 >= arg3, 4);
            let v6 = BuyEvent<T1>{
            ...
            assert!(v11 >= arg3, 4);
            0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::utils::send_coin<T1>(v9, 0x2::tx_context::sender(arg10));
            0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::utils::send_coin<T0>(v10, 0x2::tx_context::sender(arg10));
            0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::utils::send_coin<T0>(arg1, 0x2::tx_context::sender(arg10));
            let v12 = BuyEvent<T0>{
                recipient  : 0x2::tx_context::sender(arg10),
                amount_in  : v0,
                amount_out : v11,
    ...
    public entry fun sell_exact_in<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: u128, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg9: bool, arg10: 0x1::string::String, arg11: &mut 0x2::tx_context::TxContext) {
        if (arg9) {
            ...
            assert!(v4 >= arg4, 4);
            0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::utils::send_coin<T1>(v3, 0x2::tx_context::sender(arg11));
            0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::utils::send_coin<T0>(v2, 0x2::tx_context::sender(arg11));
            0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::utils::send_coin<T1>(arg2, 0x2::tx_context::sender(arg11));
            let v5 = SellEvent<T0>{
            ...
            assert!(v10 >= arg4, 4);
            0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::utils::send_coin<T0>(v9, 0x2::tx_context::sender(arg11));
            0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::utils::send_coin<T1>(v8, 0x2::tx_context::sender(arg11));
            0xe39168164c2eddb2101052c039f974e0ed02c16e025a6fc06306bf6d2572b9d3::utils::send_coin<T0>(arg1, 0x2::tx_context::sender(arg11));
