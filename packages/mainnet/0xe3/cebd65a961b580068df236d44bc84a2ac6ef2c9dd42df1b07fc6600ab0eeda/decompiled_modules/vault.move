module 0x2a721777dc1fcf7cda19492ad7c2272ee284214652bde3e9740e2f49c3bff457::vault {
    ...
    struct StrategyBaseProfitEvent<phantom T0> has copy, drop {
        strategy_id: 0x2::object::ID,
        profit: u64,
        base_fee: u64,
    }
    ...
    fun base_balance_mut<T0, T1>(arg0: &mut Vault<T0, T1>) : &mut 0x2::balance::Balance<T0> {
        let v0 = BalanceKey<T0>{dummy_field: false};
        0x2::dynamic_field::borrow_mut<BalanceKey<T0>, 0x2::balance::Balance<T0>>(&mut arg0.id, v0)
    }

    public fun base_fee_balance<T0, T1>(arg0: &Vault<T0, T1>) : &0x2::balance::Balance<T0> {
        let v0 = BalanceKey<T0>{dummy_field: false};
    ...
    entry fun setup_base_fee<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>) {
        assert_version<T0, T1>(arg1);
        let v0 = BalanceKey<T0>{dummy_field: false};
        0x2::dynamic_field::add<BalanceKey<T0>, 0x2::balance::Balance<T0>>(&mut arg1.id, v0, 0x2::balance::zero<T0>());
    }
    ...
    public(friend) fun strategy_hand_over_profit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultAccess, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        ...
        if (v0 > 0) {
            let v1 = base_balance_mut<T0, T1>(arg0);
            0x2::balance::join<T0>(v1, 0x2::balance::split<T0>(&mut arg2, v0));
        };
        let v2 = StrategyBaseProfitEvent<T1>{
            strategy_id : 0x2::object::uid_to_inner(&arg1.id),
            profit      : 0x2::balance::value<T0>(&arg2),
            base_fee    : v0,
        };
        0x2::event::emit<StrategyBaseProfitEvent<T1>>(v2);
        ...
        let v3 = 0x2a721777dc1fcf7cda19492ad7c2272ee284214652bde3e9740e2f49c3bff457::time_locked_balance::skim_extraneous_balance<T0>(&mut arg0.time_locked_profit);
        ...
        0x2a721777dc1fcf7cda19492ad7c2272ee284214652bde3e9740e2f49c3bff457::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.time_locked_profit, 0x2::math::divide_and_round_up(0x2::balance::value<T0>(&v3), arg0.profit_unlock_duration_sec), arg3);
        0x2a721777dc1fcf7cda19492ad7c2272ee284214652bde3e9740e2f49c3bff457::time_locked_balance::top_up<T0>(&mut arg0.time_locked_profit, v3, arg3);
    }
    ...
    public fun withdraw_base_fee<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>, arg2: u64) : 0x2::balance::Balance<T0> {
        assert_version<T0, T1>(arg1);
        0x2::balance::split<T0>(base_balance_mut<T0, T1>(arg1), arg2)
    }
