module 0xe3086d163422ce63569bcbaf50ebf340eee4718e59dd97eb8f470b37fdc2bd04::cnsnft4769 {
    struct CNSNFT4769 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4769, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6527"));
        let v4 = 0x2::package::claim<CNSNFT4769>(arg0, arg1);
