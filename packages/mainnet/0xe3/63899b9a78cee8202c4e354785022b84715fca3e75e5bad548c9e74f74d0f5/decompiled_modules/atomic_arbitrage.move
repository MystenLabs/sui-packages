module 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::atomic_arbitrage {
    ...
    public entry fun arb_cetus_bluefin(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_invalid_amount_error());
        assert!(v0 >= 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_min_sui_amount(), 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_invalid_amount_error());
        let v2 = v0 / 2;
        0x2::coin::join<0x2::sui::SUI>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap(0x2::coin::split<0x2::sui::SUI>(&mut arg0, v2, arg2), v1, arg2));
        0x2::coin::join<0x2::sui::SUI>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_bluefin::swap(0x2::coin::split<0x2::sui::SUI>(&mut arg0, v2, arg2), v1, arg2));
        ...
        assert!(v4 >= arg1, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_insufficient_profit_error());
    ...
    public entry fun arb_cetus_bluefin_generic<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_invalid_amount_error());
        let v2 = v0 / 2;
        0x2::coin::join<T0>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap_generic<T0>(0x2::coin::split<T0>(&mut arg0, v2, arg2), v1, arg2));
        0x2::coin::join<T0>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_bluefin::swap_generic<T0>(0x2::coin::split<T0>(&mut arg0, v2, arg2), v1, arg2));
    ...
    public entry fun arb_cetus_kriya(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0 / 2;
        0x2::coin::join<0x2::sui::SUI>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap(0x2::coin::split<0x2::sui::SUI>(&mut arg0, v2, arg2), v1, arg2));
        0x2::coin::join<0x2::sui::SUI>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_kriya::swap(0x2::coin::split<0x2::sui::SUI>(&mut arg0, v2, arg2), v1, arg2));
        let v3 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        let v4 = if (v3 > v0) {
            v3 - v0
        } else {
    ...
    public entry fun arb_cetus_suiswap(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0 / 2;
        0x2::coin::join<0x2::sui::SUI>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap(0x2::coin::split<0x2::sui::SUI>(&mut arg0, v2, arg2), v1, arg2));
        0x2::coin::join<0x2::sui::SUI>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_suiswap::swap(0x2::coin::split<0x2::sui::SUI>(&mut arg0, v2, arg2), v1, arg2));
        let v3 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        let v4 = if (v3 > v0) {
            v3 - v0
        } else {
    ...
    public entry fun arb_cetus_turbos(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0 / 2;
        0x2::coin::join<0x2::sui::SUI>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap(0x2::coin::split<0x2::sui::SUI>(&mut arg0, v2, arg2), v1, arg2));
        0x2::coin::join<0x2::sui::SUI>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_turbos::swap(0x2::coin::split<0x2::sui::SUI>(&mut arg0, v2, arg2), v1, arg2));
        let v3 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        let v4 = if (v3 > v0) {
            v3 - v0
        } else {
    ...
    public entry fun arb_cetus_turbos_generic<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0 / 2;
        0x2::coin::join<T0>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap_generic<T0>(0x2::coin::split<T0>(&mut arg0, v2, arg2), v1, arg2));
        0x2::coin::join<T0>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_turbos::swap_generic<T0>(0x2::coin::split<T0>(&mut arg0, v2, arg2), v1, arg2));
        let v3 = 0x2::coin::value<T0>(&arg0);
        let v4 = if (v3 > v0) {
            v3 - v0
        } else {
    ...
    public entry fun arb_cetus_uniswap(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0 / 2;
        0x2::coin::join<0x2::sui::SUI>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap(0x2::coin::split<0x2::sui::SUI>(&mut arg0, v2, arg2), v1, arg2));
        0x2::coin::join<0x2::sui::SUI>(&mut arg0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_uniswap::swap(0x2::coin::split<0x2::sui::SUI>(&mut arg0, v2, arg2), v1, arg2));
        let v3 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        let v4 = if (v3 > v0) {
            v3 - v0
        } else {
    ...
    public entry fun arb_cross_bluefin_cetus<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_invalid_amount_error());
        let v3 = 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap_cross<T1, T0>(arg0, arg1, arg2, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_bluefin::swap_cross<T0, T1>(arg3, v1, arg6), arg5, v1, arg6);
        ...
        assert!(v5 >= arg4, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_insufficient_profit_error());
    ...
    public entry fun arb_cross_cetus_bluefin<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::clock::timestamp_ms(arg5);
        assert!(v0 > 0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_invalid_amount_error());
        let v3 = 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_bluefin::swap_cross<T1, T0>(0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap_cross<T0, T1>(arg0, arg1, arg2, arg3, arg5, v1, arg6), v1, arg6);
        let v4 = 0x2::coin::value<T0>(&v3);
        let v5 = if (v4 > v0) {
            v4 - v0
        } else {
    ...
    public entry fun arb_cross_cetus_cetus<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_invalid_amount_error());
        let v3 = 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap_cross<T1, T0>(arg0, arg2, arg3, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap_cross<T0, T1>(arg0, arg1, arg3, arg4, arg6, v1, arg7), arg6, v1, arg7);
        let v4 = 0x2::coin::value<T0>(&v3);
        let v5 = if (v4 > v0) {
            v4 - v0
        } else {
        ...
        assert!(v5 >= arg5, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_insufficient_profit_error());
        let v6 = ArbitrageResult{
    ...
    public entry fun arb_cross_cetus_turbos<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::clock::timestamp_ms(arg5);
        assert!(v0 > 0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_invalid_amount_error());
        let v3 = 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_turbos::swap_cross<T1, T0>(0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap_cross<T0, T1>(arg0, arg1, arg2, arg3, arg5, v1, arg6), v1, arg6);
        let v4 = 0x2::coin::value<T0>(&v3);
        let v5 = if (v4 > v0) {
            v4 - v0
        } else {
    ...
    public entry fun arb_cross_turbos_bluefin<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::tx_context::sender(arg2);
        assert!(v0 > 0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_invalid_amount_error());
        let v2 = 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_bluefin::swap_cross<T1, T0>(0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_turbos::swap_cross<T0, T1>(arg0, v1, arg2), v1, arg2);
    ...
    public entry fun arb_cross_turbos_cetus<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::clock::timestamp_ms(arg5);
        assert!(v0 > 0, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_invalid_amount_error());
        let v3 = 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_cetus::swap_cross<T1, T0>(arg0, arg1, arg2, 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_turbos::swap_cross<T0, T1>(arg3, v1, arg6), arg5, v1, arg6);
        let v4 = 0x2::coin::value<T0>(&v3);
        let v5 = if (v4 > v0) {
            v4 - v0
        } else {
