module 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::dex_turbos {
    ...
    public fun swap_cross<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = SwapExecuted{
            ...
            trader       : arg1,
            pool_address : 0xe363899b9a78cee8202c4e354785022b84715fca3e75e5bad548c9e74f74d0f5::constants::get_turbos_sui_usdc_pool(),
        };
