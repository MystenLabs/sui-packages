module 0xe300162c97a4d6e93568d918529c4f7d806629c0bffafd898c59b12ce92be22f::cnsnft8525 {
    struct CNSNFT8525 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8525, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8525>(arg0, arg1);
