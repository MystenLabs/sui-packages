module 0xe3f489c078180dddba1bded4b2c722a1a40c35b280d46ee42f6c5681100c8049::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"cr", b"cr", b"cr", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-08T19-08-18.805Z-Screenshot 2025-10-08 at 23.03.01.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"cr"),
            symbol     : 0x1::string::utf8(b"cr"),
            decimals   : 9,
