module 0xe3515931635a3ee32aaf678fa95a8ed5c545337523c57523c2078e0318ac1e66::market_position {
    ...
    public(friend) fun update_lp_display<T0: drop>(arg0: &mut MarketPosition, arg1: &0xe3515931635a3ee32aaf678fa95a8ed5c545337523c57523c2078e0318ac1e66::py::PyState<T0>) {
        let v0 = 9;
        if (0x2::dynamic_field::exists_<0x1::type_name::TypeName>(0xe3515931635a3ee32aaf678fa95a8ed5c545337523c57523c2078e0318ac1e66::py::get_state_id<T0>(arg1), 0x1::type_name::get<T0>())) {
            v0 = *0x2::dynamic_field::borrow<0x1::type_name::TypeName, u8>(0xe3515931635a3ee32aaf678fa95a8ed5c545337523c57523c2078e0318ac1e66::py::get_state_id<T0>(arg1), 0x1::type_name::get<T0>());
        };
