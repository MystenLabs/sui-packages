module 0xe30b9f0c58cac12a341632af294af29cb33389fdfd241a5b631371fd5cfaeb60::project_manager {
    ...
    public fun add_whitelist<T0>(arg0: &0xe30b9f0c58cac12a341632af294af29cb33389fdfd241a5b631371fd5cfaeb60::launchpad_manager_config::LaunchAdmin, arg1: &mut ProjectManager<T0>, arg2: address, arg3: u64) {
    ...
    public fun batch_add_whitelist<T0>(arg0: &0xe30b9f0c58cac12a341632af294af29cb33389fdfd241a5b631371fd5cfaeb60::launchpad_manager_config::LaunchAdmin, arg1: &mut ProjectManager<T0>, arg2: vector<address>, arg3: vector<u64>) {
        let v0 = 0;
    ...
    public fun batch_remove_whitelist<T0>(arg0: &mut ProjectManager<T0>, arg1: &0xe30b9f0c58cac12a341632af294af29cb33389fdfd241a5b631371fd5cfaeb60::launchpad_manager_config::LaunchAdmin, arg2: vector<address>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
    ...
    public entry fun first_fund<T0>(arg0: 0x2::coin::Coin<T0>, arg1: &mut ProjectManager<T0>, arg2: &ProjectManagerConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = *0x2::table::borrow<address, u64>(&arg1.whitelist, 0x2::tx_context::sender(arg4));
        assert!(v1 >= v0, 10);
        ...
        *0x2::table::borrow_mut<address, u64>(&mut arg1.whitelist, 0x2::tx_context::sender(arg4)) = v1 - v0;
        ...
        if (arg1.remain_supply == 0) {
            arg1.status = 1;
            let v2 = ProjectShouldSucceedEvent{
                project_id : 0x2::object::id<ProjectManager<T0>>(arg1),
                owner      : arg1.owner,
                count      : arg1.count,
            };
            0x2::event::emit<ProjectShouldSucceedEvent>(v2);
        };
        let v3 = FundingProof{
        ...
        0x2::transfer::transfer<FundingProof>(v3, 0x2::tx_context::sender(arg4));
        let v4 = 0x2::object::id<ProjectManager<T0>>(arg1);
        let v5 = UserFundedEvent{
            project_manager : 0x2::object::id_to_address(&v4),
            token_amount    : v0,
            count           : arg1.count,
            user            : 0x2::tx_context::sender(arg4),
        };
        0x2::event::emit<UserFundedEvent>(v5);
    }
    ...
    public entry fun fund<T0>(arg0: &mut FundingProof, arg1: 0x2::coin::Coin<T0>, arg2: &mut ProjectManager<T0>, arg3: &ProjectManagerConfig, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = *0x2::table::borrow<address, u64>(&arg2.whitelist, 0x2::tx_context::sender(arg5));
        assert!(v1 >= v0, 10);
        *0x2::table::borrow_mut<address, u64>(&mut arg2.whitelist, 0x2::tx_context::sender(arg5)) = v1 - v0;
        ...
        let v3 = 0x2::object::id<ProjectManager<T0>>(arg2);
    ...
    public entry fun initialize_project_manager<T0>(arg0: &0xe30b9f0c58cac12a341632af294af29cb33389fdfd241a5b631371fd5cfaeb60::launchpad_manager_config::LaunchAdmin, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: &ProjectManagerConfig, arg6: &mut 0x2::tx_context::TxContext) {
        assert_version(arg5);
        ...
        let v4 = ProjectInitializedEvent{
            ...
            total_supply_amount : arg5.max_funding_amount,
            start_times         : arg3,
            end_times           : arg4,
            count               : arg2,
            fund_coin_type      : v0,
        ...
        let v5 = ProjectManager<T0>{
            ...
            pay_status     : 0,
            owner          : arg1,
            whitelist      : 0x2::table::new<address, u64>(arg6),
        };
        0x2::transfer::share_object<ProjectManager<T0>>(v5);
    }

    public fun make_project_failed<T0>(arg0: &mut ProjectManager<T0>, arg1: &0xe30b9f0c58cac12a341632af294af29cb33389fdfd241a5b631371fd5cfaeb60::launchpad_manager_config::LaunchAdmin) {
        arg0.status = 2;
    }
    ...
    public fun project_falied<T0>(arg0: &mut ProjectManager<T0>, arg1: &0xe30b9f0c58cac12a341632af294af29cb33389fdfd241a5b631371fd5cfaeb60::launchpad_manager_config::LaunchAdmin, arg2: &0x2::clock::Clock) {
    ...
    public fun remove_whitelist<T0>(arg0: &mut ProjectManager<T0>, arg1: &0xe30b9f0c58cac12a341632af294af29cb33389fdfd241a5b631371fd5cfaeb60::launchpad_manager_config::LaunchAdmin, arg2: address) {
