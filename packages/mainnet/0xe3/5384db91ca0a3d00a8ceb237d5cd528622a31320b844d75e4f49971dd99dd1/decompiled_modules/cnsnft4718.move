module 0xe35384db91ca0a3d00a8ceb237d5cd528622a31320b844d75e4f49971dd99dd1::cnsnft4718 {
    struct CNSNFT4718 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4718, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4718>(arg0, arg1);
