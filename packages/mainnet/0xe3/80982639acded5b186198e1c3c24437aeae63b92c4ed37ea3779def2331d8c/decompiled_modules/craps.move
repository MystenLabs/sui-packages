            ...
            if (v11) {
                ...
                if (v10) {
                    ...
                    *arg12 = *arg12 + v12 + v6;
                    ...
                    0x1::vector::push_back<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::BetResult<T0, Craps>>(arg9, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::create_unihouse_bet_result_v2<T0, Craps>(arg0, v17, 0x1::option::some<0x2::object::ID>(0x2::object::id<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>(&v3)), v0, v5, v9, v6, v12 + v6, arg1));
                } else {
                    let v18 = Craps{dummy_field: false};
                    0x1::vector::push_back<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::BetResult<T0, Craps>>(arg9, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::create_unihouse_bet_result_v2<T0, Craps>(arg0, v18, 0x1::option::some<0x2::object::ID>(0x2::object::id<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>(&v3)), v0, v5, v9, v6, v12, arg1));
                };
                let v19 = 0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::get_bet_max_payout(v6, v5, v9);
                if (v19 > arg4.current_risk) {
                    arg4.current_risk = 0;
                } else {
                    arg4.current_risk = arg4.current_risk - v19;
                };
