module 0xe38fcf239b2fc20debafe3731e56a32e13d1596ba90fa8a60f035f604c049c27::spt {
    struct SPT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SPT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SPT>(arg0, 9, b"SPT", b"SPT", b"Seapad launchpad foundation token", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://w7.pngwing.com/pngs/191/109/png-transparent-person-swimming-logo-open-water-swimming-marathon-swimming-sport-swimming-marine-mammal-logo-sports.png"))), arg1);
