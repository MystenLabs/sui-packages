module 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::control {
    ...
    entry fun withdraw<T0, T1>(arg0: &mut StoreOwner, arg1: &mut Store, arg2: &mut 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::pool::Pool<T0, T1>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        check_version(arg1);
        let (v0, v1) = 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::pool::withdraw_transaction_fee<T0, T1>(arg2, arg4);
        let v2 = v1;
        let v3 = v0;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v3, arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v2, arg3);
        0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::events::emit_transaction_fee_withdraw(0x2::object::id<0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::pool::Pool<T0, T1>>(arg2), 0x2::coin::value<T0>(&v3), 0x2::coin::value<T1>(&v2), arg3);
    }
