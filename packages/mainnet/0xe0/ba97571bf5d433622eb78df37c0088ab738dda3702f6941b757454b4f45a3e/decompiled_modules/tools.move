module 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::tools {
    public fun calc_optimal_values(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : (u64, u64) {
        if (arg4 == 0 && arg5 == 0) {
            return (arg0, arg1)
        };
        let v0 = 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::maths::mul_div(arg0, arg5, arg4);
        if (v0 <= arg1) {
            assert!(v0 >= arg3, 705);
            return (arg0, v0)
        };
        let v1 = 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::maths::mul_div(arg1, arg4, arg5);
        assert!(v1 <= arg0, 706);
        assert!(v1 >= arg2, 704);
        (v1, arg1)
    }
    ...
    public fun get_fee(arg0: u64, arg1: u32, arg2: u32) : u64 {
        0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::maths::mul_div(arg0, (arg1 as u64), (arg2 as u64))
    }
