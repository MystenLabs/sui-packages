module 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::pool {
    ...
    public fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LP<T0, T1>>, u64, u64, u64) {
        ...
        let (v7, v8) = 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::tools::calc_optimal_values(v4, v6, arg2, arg4, v0, v1);
        let v9 = if (v2 == 0) {
            let v10 = 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::maths::sqrt(0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::maths::mul_to_u128(v7, v8));
            assert!(v10 > 1000, 505);
    ...
    public fun remove_liqudity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: &mut 0x2::tx_context::TxContext) : (u64, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64) {
        ...
        let v4 = 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::maths::mul_div(v1, v0, v3);
        let v5 = 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::maths::mul_div(v2, v0, v3);
    ...
    public fun swap_x_to_y<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, u64) {
        ...
        let v4 = 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::tools::get_fee(v3, 20, 10000);
        let v5 = if (arg0.x_pool_rate > 0) {
            0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::tools::get_fee(v3, arg0.x_pool_rate, 10000)
        } else {
            0
        };
        let v6 = v5;
        ...
        let v7 = 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::tools::calculate_amount_out(v0, v1, v3 - v4 - v6);
        assert!(v7 >= arg3, 510);
        ...
        0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::tools::check_reserve_is_increased(v0, v1, v10, v11);
        if (arg0.trading_time == 0) {
    ...
    public fun swap_y_to_x<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u64) {
        ...
        let v7 = 0xe0ba97571bf5d433622eb78df37c0088ab738dda3702f6941b757454b4f45a3e::tools::calculate_amount_out(v1, v0, v3 - v4 - v6);
        assert!(v7 >= arg3, 510);
