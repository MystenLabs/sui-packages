module 0xe06f00853e863d7ea504ff2e6112f1bc720e942f65fd945cd2b2a127f25a4265::ludo_program__new__coin__prod {
    ...
    fun init(arg0: LUDO_PROGRAM__NEW__COIN__PROD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0xeea8da3ccfbf41ea8be72d36a7fb8171204694c80634fa503d72b66e2e1450a3::custom_token::new_policy<LUDO_PROGRAM__NEW__COIN__PROD>(&v0, arg1);
        let v3 = v2;
        let v4 = v1;
        0x14a13c8ff92114f3c3718042eb5937cccf76d9b5d67509d880a5df2a9f07bf90::core::set_rules<LUDO_PROGRAM__NEW__COIN__PROD>(&mut v4, &v3, arg1);
        0x14a13c8ff92114f3c3718042eb5937cccf76d9b5d67509d880a5df2a9f07bf90::core::create_registry<LUDO_PROGRAM__NEW__COIN__PROD>(v0, v3, false, arg1);
        0xeea8da3ccfbf41ea8be72d36a7fb8171204694c80634fa503d72b66e2e1450a3::custom_token::share_policy<LUDO_PROGRAM__NEW__COIN__PROD>(v4);
    }
