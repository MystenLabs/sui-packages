module 0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::partner {
    ...
    entry fun create_partner(arg0: &0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::admin::AdminCap, arg1: &0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::admin::AdminRegistry, arg2: vector<u8>, arg3: u16, arg4: address, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::admin::assert_registry_version(arg1);
        0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::admin::assert_nonzero_recipient(arg4);
        0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::admin::assert_nonzero_recipient(arg5);
    ...
    entry fun migrate(arg0: &0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::admin::AdminRegistry, arg1: &0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::admin::OperatorCap, arg2: &mut Partner) {
    ...
    entry fun rotate_partner_cap(arg0: &PartnerRecoveryCap, arg1: &mut Partner, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg1);
        0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::admin::assert_nonzero_recipient(arg2);
    ...
    entry fun rotate_partner_recovery_cap(arg0: &0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::admin::AdminCap, arg1: &mut Partner, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg1);
        0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::admin::assert_nonzero_recipient(arg2);
        let v0 = 0x2::object::new(arg3);
        let v1 = 0x2::object::uid_to_inner(&v0);
    ...
    entry fun set_partner_active(arg0: &0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::admin::AdminCap, arg1: &mut Partner, arg2: bool) {
        assert_version(arg1);
        arg1.is_active = arg2;
    ...
    entry fun set_ref_fee_bps(arg0: &0xe048584eec04c236455edd636cc24838883da2a5f4c5736f105a260c5dffb9d7::admin::AdminCap, arg1: &mut Partner, arg2: u16) {
        assert_version(arg1);
