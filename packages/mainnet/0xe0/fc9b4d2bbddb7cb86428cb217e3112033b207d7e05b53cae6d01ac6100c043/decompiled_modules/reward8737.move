module 0xe0fc9b4d2bbddb7cb86428cb217e3112033b207d7e05b53cae6d01ac6100c043::reward8737 {
    struct REWARD8737 has drop {
        dummy_field: bool,
    }

    struct TICKET_8737 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8737(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8737>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8737>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8737, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8737>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8737>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8737>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8737>>(v5, 0x2::tx_context::sender(arg1));
    }
