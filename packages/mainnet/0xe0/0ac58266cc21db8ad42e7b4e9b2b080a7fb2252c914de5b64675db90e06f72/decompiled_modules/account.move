module 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::account {
    ...
    public fun calculate_effective_leverage(arg0: &Position, arg1: 0x1::option::Option<u64>) : u64 {
        if (arg0.is_isolated) {
            if (arg0.size > 0 && arg0.margin > 0) {
                (((arg0.average_entry_price as u128) * (arg0.size as u128) / ((arg0.margin - arg0.pending_funding_payment) as u128)) as u64)
    ...
    fun compute_margin_required(arg0: &0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::perpetual::Perpetual, arg1: u64, arg2: u8) : u64 {
        if (arg2 == 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::constants::mmr_threshold()) {
            0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::utils::base_mul(arg1, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::perpetual::get_mmr(arg0))
        } else {
            0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::utils::base_mul(arg1, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::perpetual::get_imr(arg0))
        }
    }
    ...
    public(friend) fun get_total_margin_required(arg0: &vector<Position>, arg1: &0x2::table::Table<0x1::string::String, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::perpetual::Perpetual>, arg2: u8) : u64 {
        ...
        while (v0 < 0x1::vector::length<Position>(arg0)) {
            ...
            v1 = v1 + compute_margin_required(v3, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::utils::base_mul(v2.size, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::perpetual::get_oracle_price(v3)), arg2);
            v0 = v0 + 1;
        };
        v1
    }
    ...
    public fun has_most_negative_pnl(arg0: &vector<Position>, arg1: &0x2::table::Table<0x1::string::String, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::perpetual::Perpetual>, arg2: 0x1::string::String) : bool {
        ...
        while (v0 < 0x1::vector::length<Position>(arg0)) {
            ...
            if (0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::signed_number::lt(v2, v2)) {
                v1 = v3.perpetual;
            };
            v0 = v0 + 1;
        };
    ...
    public fun has_most_positive_pnl(arg0: &vector<Position>, arg1: &0x2::table::Table<0x1::string::String, 0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::perpetual::Perpetual>, arg2: 0x1::string::String) : bool {
        ...
        while (v0 < 0x1::vector::length<Position>(arg0)) {
            let v3 = 0x1::vector::borrow<Position>(arg0, v0);
            v2 = compute_position_pnl(arg1, v3);
            if (0xe74481697f432ddee8dd6f9bd13b9d0297a5b63d55f3db25c4d3b5d34dad85b7::signed_number::gt(v2, v2)) {
                v1 = v3.perpetual;
            };
            v0 = v0 + 1;
        };
