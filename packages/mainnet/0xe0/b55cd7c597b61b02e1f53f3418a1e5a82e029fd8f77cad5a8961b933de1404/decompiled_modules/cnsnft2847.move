module 0xe0b55cd7c597b61b02e1f53f3418a1e5a82e029fd8f77cad5a8961b933de1404::cnsnft2847 {
    struct CNSNFT2847 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2847, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2847>(arg0, arg1);
