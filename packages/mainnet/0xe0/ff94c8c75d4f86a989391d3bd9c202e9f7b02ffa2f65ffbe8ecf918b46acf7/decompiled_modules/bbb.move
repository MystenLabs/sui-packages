module 0xe0ff94c8c75d4f86a989391d3bd9c202e9f7b02ffa2f65ffbe8ecf918b46acf7::bbb {
    struct BBB has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BBB, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/AJisub9CmgjWE6e5YxYkyMs2xmj883iAutxPyPmGbonk.png                                                                                                                                                                                                                               ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BBB>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BBB       ")))), trim_right(b"BIG BEAUTIFUL BONKERS           "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
