module 0xe074606960441ab9274a98b96cf39bed6aee8ed07ea6578ca5afd8995b0fcf18::cnsnft8046 {
    struct CNSNFT8046 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8046, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8353"));
        let v4 = 0x2::package::claim<CNSNFT8046>(arg0, arg1);
