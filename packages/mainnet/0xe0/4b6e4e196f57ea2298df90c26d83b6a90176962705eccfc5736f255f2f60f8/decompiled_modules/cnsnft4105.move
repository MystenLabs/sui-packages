module 0xe04b6e4e196f57ea2298df90c26d83b6a90176962705eccfc5736f255f2f60f8::cnsnft4105 {
    struct CNSNFT4105 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4105, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4105>(arg0, arg1);
