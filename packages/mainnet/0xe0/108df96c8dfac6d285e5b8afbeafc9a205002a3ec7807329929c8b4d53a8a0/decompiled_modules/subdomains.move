module 0xe177697e191327901637f8d2c5ffbbde8b1aaac27ec1024c4b62d1ebd1cd7430::subdomains {
    ...
    fun is_leaf_record(arg0: &0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::Registry, arg1: 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::Domain) : bool {
        if (!0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::is_subdomain(&arg1)) {
            return false
        };
        let v0 = 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::lookup(arg0, arg1);
    ...
    public fun add_leaf_metadata(arg0: &mut 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins::SuiNS, arg1: &0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg2: &0x2::clock::Clock, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String) {
        let v0 = 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::new(arg3);
        assert!(is_leaf_record(registry(arg0), v0), 8);
        internal_validate_nft_can_manage_subdomain(arg0, arg1, arg2, v0, false);
        let v1 = registry_mut(arg0);
        let v2 = *0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::get_data(v1, v0);
        let v3 = *0x1::string::as_bytes(&arg4);
        let v4 = if (v3 == b"avatar") {
            true
        } else if (v3 == b"content_hash") {
            true
        } else {
            v3 == b"walrus_site_id"
        };
        assert!(v4, 7);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v2, arg4, arg5);
        0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::set_data(v1, v0, v2);
    }
    ...
    public fun remove_leaf_metadata(arg0: &mut 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins::SuiNS, arg1: &0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg2: &0x2::clock::Clock, arg3: 0x1::string::String, arg4: 0x1::string::String) {
        let v0 = 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::new(arg3);
        assert!(is_leaf_record(registry(arg0), v0), 8);
        internal_validate_nft_can_manage_subdomain(arg0, arg1, arg2, v0, false);
        let v1 = registry_mut(arg0);
        let v2 = *0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::get_data(v1, v0);
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v2, &arg4)) {
            let (_, _) = 0x2::vec_map::remove<0x1::string::String, 0x1::string::String>(&mut v2, &arg4);
        };
        0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::set_data(v1, v0, v2);
    }
