module 0x35e6143c189f71c96b450be75a177f9ee9e56b01c823295819c87481671608d9::collection {
    ...
    struct Aetherborne has store, key {
        id: 0x2::object::UID,
        number: u64,
        index: u64,
        attributes: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>,
    ...
    struct RoyaltySplitter has key {
        id: 0x2::object::UID,
        cap: 0x2::transfer_policy::TransferPolicyCap<Aetherborne>,
    ...
    entry fun admin_mint_to_kiosk(arg0: &AdminCap, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg5: u64, arg6: address, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
        assert_mint_ready(arg1);
    ...
    public fun attributes(arg0: &Aetherborne) : &0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        &arg0.attributes
    }
    ...
    entry fun claim_mint_from_kiosk_to_kiosk<T0: store + key>(arg0: &mut ClaimGate, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg5: 0x2::object::ID, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun claim_mint_from_personal_kiosk_to_kiosk<T0: store + key>(arg0: &mut ClaimGate, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg4: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg5: 0x2::object::ID, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.gate_type, 25);
    ...
    entry fun claim_mint_to_kiosk<T0: key>(arg0: &mut ClaimGate, arg1: &mut Collection, arg2: &T0, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.gate_type, 25);
        do_claim_to_kiosk(arg0, arg1, 0x2::object::id<T0>(arg2), arg3, arg4, arg5, arg6, arg7, arg8);
    }

    entry fun claim_mint_to_new_kiosk<T0: key>(arg0: &mut ClaimGate, arg1: &mut Collection, arg2: &T0, arg3: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::random::Random, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.gate_type, 25);
    ...
    public fun create_royalty_splitter(arg0: &AdminCap, arg1: 0x2::transfer_policy::TransferPolicyCap<Aetherborne>, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun distribute(arg0: &mut RoyaltySplitter, arg1: &mut 0x2::transfer_policy::TransferPolicy<Aetherborne>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::transfer_policy::withdraw<Aetherborne>(arg1, &arg0.cap, 0x1::option::none<u64>(), arg2);
    ...
    fun do_claim_to_kiosk(arg0: &mut ClaimGate, arg1: &mut Collection, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) : vector<0x2::object::ID> {
    ...
    fun draw_and_lock(arg0: &mut Collection, arg1: u64, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg5: address, arg6: &mut 0x2::random::RandomGenerator, arg7: &mut 0x2::tx_context::TxContext) : vector<0x2::object::ID> {
        ...
        while (v1 < arg1) {
            ...
            0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x2::object::id<Aetherborne>(&v3));
            0x2::kiosk::lock<Aetherborne>(arg2, arg3, arg4, v3);
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun fix_metadata(arg0: &Corrections, arg1: &mut Aetherborne, arg2: &0x2::tx_context::TxContext) {
        ...
        let v0 = ItemMetadataFixed{
            object_id        : 0x2::object::id<Aetherborne>(arg1),
            index            : arg1.index,
    ...
    fun forge_one(arg0: &mut Collection, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : Aetherborne {
        ...
        let v4 = ItemMinted{
            object_id : 0x2::object::id<Aetherborne>(&v3),
            number    : v1,
            index     : v2,
            recipient : arg2,
        };
    ...
    public fun index(arg0: &Aetherborne) : u64 {
        arg0.index
    }
    ...
    fun init(arg0: COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::display::new<Aetherborne>(&v1, arg1);
        0x2::display::add<Aetherborne>(&mut v2, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"Aetherborne #{index}"));
        0x2::display::add<Aetherborne>(&mut v2, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"Thousand posthuman custodians assembled from immutable AI masters and deterministic generative layers."));
        let v3 = 0x1::string::utf8(b"https://assets.alienz.tech/collections/66be25e7d2df0fd5c528fdb5495a398098639a25887c210fd0be79a9990c08d7/tokens/");
        0x1::string::append(&mut v3, 0x1::string::utf8(b"{index}."));
        0x1::string::append(&mut v3, 0x1::string::utf8(b"png"));
        0x2::display::add<Aetherborne>(&mut v2, 0x1::string::utf8(b"image_url"), v3);
        if (false) {
            let v4 = 0x1::string::utf8(b"https://assets.alienz.tech/collections/66be25e7d2df0fd5c528fdb5495a398098639a25887c210fd0be79a9990c08d7/tokens/");
            0x1::string::append(&mut v4, 0x1::string::utf8(b"{index}."));
            0x1::string::append(&mut v4, 0x1::string::utf8(b"mp4"));
            0x2::display::add<Aetherborne>(&mut v2, 0x1::string::utf8(b"animation_url"), v4);
        };
        0x2::display::add<Aetherborne>(&mut v2, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(b"https://hive.alienz.tech"));
        0x2::display::add<Aetherborne>(&mut v2, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"Hcetzneila"));
        0x2::display::update_version<Aetherborne>(&mut v2);
        let (v5, v6) = 0x2::transfer_policy::new<Aetherborne>(&v1, arg1);
        let v7 = v6;
        let v8 = v5;
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Aetherborne>(&mut v8, &v7, 300, 100000000);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::add<Aetherborne>(&mut v8, &v7);
        let v9 = Collection{
            id               : 0x2::object::new(arg1),
            name             : 0x1::string::utf8(b"Aetherborne"),
            size             : 1000,
            minted           : 0,
            drawn            : 0,
            seeded           : 0,
        ...
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<Aetherborne>>(v8);
        0x2::transfer::share_object<Collection>(v9);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<Aetherborne>>(v7, v0);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v1, v0);
        0x2::transfer::public_transfer<0x2::display::Display<Aetherborne>>(v2, v0);
    ...
    public fun is_revealed(arg0: &Aetherborne) : bool {
        arg0.index != 0
    }

    public fun metadata_version(arg0: &Aetherborne) : u64 {
        arg0.metadata_version
    }

    fun mint_boxes_into_kiosk(arg0: &mut MintConfig, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : vector<0x2::object::ID> {
        ...
        while (v2 < arg7) {
            ...
            let v5 = 0x2::object::id<Aetherborne>(&v4);
            let v6 = ItemMinted{
                object_id : v5,
                number    : v3,
                index     : 0,
            ...
            0x2::kiosk::lock<Aetherborne>(arg2, arg3, arg4, v4);
            v2 = v2 + 1;
        };
        v1
    }
    ...
    fun mint_one(arg0: &mut Collection, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x2::transfer::public_transfer<Aetherborne>(v0, arg2);
        0x2::object::id<Aetherborne>(&v0)
    }
    ...
    entry fun mint_pinned_to_kiosk(arg0: &mut ReservationBook, arg1: &mut Collection, arg2: &MintConfig, arg3: u64, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::kiosk::lock<Aetherborne>(arg4, arg5, arg6, v5);
        let v6 = PinnedMinted{
            book_id   : 0x2::object::id<ReservationBook>(arg0),
            index     : arg3,
            object_id : 0x2::object::id<Aetherborne>(&v5),
            recipient : v0,
            price     : v2,
        };
    ...
    public fun number(arg0: &Aetherborne) : u64 {
        arg0.number
    }
    ...
    entry fun public_mint_box_many_to_kiosk(arg0: &mut MintConfig, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun public_mint_many_to_kiosk(arg0: &mut MintConfig, arg1: &mut Collection, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: u64, arg8: u64, arg9: &0x2::random::Random, arg10: &mut 0x2::tx_context::TxContext) {
        assert_mint_ready(arg1);
        assert_supply(arg1, arg7);
    ...
    entry fun public_mint_many_to_new_kiosk(arg0: &mut MintConfig, arg1: &mut Collection, arg2: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
        assert_mint_ready(arg1);
        assert_supply(arg1, arg5);
    ...
    entry fun reveal(arg0: &mut Collection, arg1: &mut Aetherborne, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun reveal_in_kiosk(arg0: &mut Collection, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::random::new_generator(arg4, arg5);
        let v1 = 0x2::kiosk::borrow_mut<Aetherborne>(arg1, arg2, arg3);
        let v2 = &mut v0;
        reveal_inner(arg0, v1, v2, arg5);
    }

    fun reveal_inner(arg0: &mut Collection, arg1: &mut Aetherborne, arg2: &mut 0x2::random::RandomGenerator, arg3: &0x2::tx_context::TxContext) {
    ...
    entry fun reveal_many(arg0: &mut Collection, arg1: vector<Aetherborne>, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<Aetherborne>(&arg1);
        assert!(v0 > 0, 4);
        assert!(v0 <= 10, 6);
        let v1 = 0x2::random::new_generator(arg2, arg3);
        while (!0x1::vector::is_empty<Aetherborne>(&arg1)) {
            let v2 = 0x1::vector::pop_back<Aetherborne>(&mut arg1);
            let v3 = &mut v2;
            let v4 = &mut v1;
            reveal_inner(arg0, v3, v4, arg3);
            0x2::transfer::public_transfer<Aetherborne>(v2, 0x2::tx_context::sender(arg3));
        };
        0x1::vector::destroy_empty<Aetherborne>(arg1);
    }

    entry fun reveal_many_and_lock(arg0: &mut Collection, arg1: vector<Aetherborne>, arg2: &0x2::transfer_policy::TransferPolicy<Aetherborne>, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<Aetherborne>(&arg1);
        assert!(v0 > 0, 4);
        assert!(v0 <= 10, 6);
        ...
        let v5 = v2;
        while (!0x1::vector::is_empty<Aetherborne>(&arg1)) {
            let v6 = 0x1::vector::pop_back<Aetherborne>(&mut arg1);
            let v7 = &mut v6;
            let v8 = &mut v1;
            reveal_inner(arg0, v7, v8, arg4);
            0x2::kiosk::lock<Aetherborne>(&mut v5, &v4, arg2, v6);
        };
        0x1::vector::destroy_empty<Aetherborne>(arg1);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v5);
    ...
    entry fun reveal_many_in_kiosk(arg0: &mut Collection, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: vector<0x2::object::ID>, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0;
        while (v2 < v0) {
            let v3 = 0x2::kiosk::borrow_mut<Aetherborne>(arg1, arg2, *0x1::vector::borrow<0x2::object::ID>(&arg3, v2));
            let v4 = &mut v1;
    ...
    entry fun reveal_many_in_personal_kiosk(arg0: &mut Collection, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg3: vector<0x2::object::ID>, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        while (v3 < v0) {
            let v4 = 0x2::kiosk::borrow_mut<Aetherborne>(arg1, v1, *0x1::vector::borrow<0x2::object::ID>(&arg3, v3));
            let v5 = &mut v2;
