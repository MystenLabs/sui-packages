module 0xe08331629698bf3809e842b1efb9732db02c055bdf601861288c45f92c0bf715::pool {
    ...
    public fun create_permissionless_pool<T0, T1>(arg0: &mut 0xe08331629698bf3809e842b1efb9732db02c055bdf601861288c45f92c0bf715::treasury::Treasury, arg1: &PoolCreationConfig, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::registry::Registry, arg3: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>) {
    ...
    public fun update_pool_creation_protocol_fee(arg0: &mut PoolCreationConfig, arg1: 0xe08331629698bf3809e842b1efb9732db02c055bdf601861288c45f92c0bf715::ticket::AdminTicket, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 >= 0 && arg2 <= 500000000, 2);
        0xe08331629698bf3809e842b1efb9732db02c055bdf601861288c45f92c0bf715::ticket::validate_ticket(&arg1, 0xe08331629698bf3809e842b1efb9732db02c055bdf601861288c45f92c0bf715::ticket::update_pool_creation_protocol_fee_ticket_type(), arg3, arg4);
        0xe08331629698bf3809e842b1efb9732db02c055bdf601861288c45f92c0bf715::ticket::destroy_ticket(arg1, arg3);
