module 0xe0aceb49b21d2c02438968d94a2216425bf1421cb69faaea1cfbe992ce27313e::reward4835 {
    struct REWARD4835 has drop {
        dummy_field: bool,
    }

    struct TICKET_4835 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4835(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_4835>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4835, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4835>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4835>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4835>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4835>>(v5, 0x2::tx_context::sender(arg1));
    }
