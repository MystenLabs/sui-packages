module 0xe03a632cbe2826b6ab7c69d7a00633f7e42fb0876892cf606fdd52e74cabc8aa::reward2891 {
    struct REWARD2891 has drop {
        dummy_field: bool,
    }

    struct TICKET_2891 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2891(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2891>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2891>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2891, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2891>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2891>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2891>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2891>>(v5, 0x2::tx_context::sender(arg1));
    }
