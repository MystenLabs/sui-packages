module 0xe0521b3881f35259a0762abe716188d02c3c0a45d2f18b03ee2ee023e16385e1::tvyn {
    ...
    public entry fun create_and_share_mint_vault(arg0: 0x2::coin::TreasuryCap<TVYN>, arg1: &mut 0xe0521b3881f35259a0762abe716188d02c3c0a45d2f18b03ee2ee023e16385e1::config_registry::Config, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = MintVault{
            id  : 0x2::object::new(arg2),
            cap : arg0,
        };
        0xe0521b3881f35259a0762abe716188d02c3c0a45d2f18b03ee2ee023e16385e1::config_registry::set_mint_vault_id(arg1, 0x2::object::id<MintVault>(&v0));
