module 0xe0521b3881f35259a0762abe716188d02c3c0a45d2f18b03ee2ee023e16385e1::nft_display {
    ...
    fun init(arg0: NFT_DISPLAY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0xe0521b3881f35259a0762abe716188d02c3c0a45d2f18b03ee2ee023e16385e1::anniversary_vault::Today365>(&v0, v1, v3, arg1);
        0x2::display::update_version<0xe0521b3881f35259a0762abe716188d02c3c0a45d2f18b03ee2ee023e16385e1::anniversary_vault::Today365>(&mut v5);
        0x2::transfer::public_share_object<0x2::display::Display<0xe0521b3881f35259a0762abe716188d02c3c0a45d2f18b03ee2ee023e16385e1::anniversary_vault::Today365>>(v5);
        ...
        let v10 = 0x2::display::new_with_fields<0xe0521b3881f35259a0762abe716188d02c3c0a45d2f18b03ee2ee023e16385e1::nostalgia_ticket::NostalgiaTicket>(&v0, v6, v8, arg1);
        0x2::display::update_version<0xe0521b3881f35259a0762abe716188d02c3c0a45d2f18b03ee2ee023e16385e1::nostalgia_ticket::NostalgiaTicket>(&mut v10);
        0x2::transfer::public_share_object<0x2::display::Display<0xe0521b3881f35259a0762abe716188d02c3c0a45d2f18b03ee2ee023e16385e1::nostalgia_ticket::NostalgiaTicket>>(v10);
