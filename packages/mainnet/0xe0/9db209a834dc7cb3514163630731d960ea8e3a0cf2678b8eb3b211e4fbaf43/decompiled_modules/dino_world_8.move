module 0xe09db209a834dc7cb3514163630731d960ea8e3a0cf2678b8eb3b211e4fbaf43::dino_world_8 {
    struct DINO_WORLD_8 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DINO_WORLD_8, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DINO_WORLD_8>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Dino World 8"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Dino World 8 "));
