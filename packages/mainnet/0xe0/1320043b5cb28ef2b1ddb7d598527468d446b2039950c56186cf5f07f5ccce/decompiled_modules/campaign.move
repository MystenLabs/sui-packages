module 0x10786d3c5b9aa5ab3efb05dd7b349ad03e20c175d2995a8f895ad2145bf29a6e::campaign {
    ...
    fun fund<T0>(arg0: &mut Campaign<T0>, arg1: &mut 0x10786d3c5b9aa5ab3efb05dd7b349ad03e20c175d2995a8f895ad2145bf29a6e::insurance::Fund<T0>, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.only_whitelist && !v1) {
            ...
            pub_fund<T0>(arg0, arg1, arg3, arg4, arg6);
        };
    }
    ...
    fun pub_fund<T0>(arg0: &mut Campaign<T0>, arg1: &mut 0x10786d3c5b9aa5ab3efb05dd7b349ad03e20c175d2995a8f895ad2145bf29a6e::insurance::Fund<T0>, arg2: 0x2::coin::Coin<T0>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        ...
        if (arg3) {
            let v3 = 0x2::coin::split<T0>(&mut arg2, v1 * 15 / 100, arg4);
            v2 = v1 - 0x2::coin::value<T0>(&v3);
            0x10786d3c5b9aa5ab3efb05dd7b349ad03e20c175d2995a8f895ad2145bf29a6e::insurance::insure_campaign<T0>(arg1, 0x2::object::id<Campaign<T0>>(arg0), v3, arg4);
        };
