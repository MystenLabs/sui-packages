module 0xe0682904924abc3d7bae0534a236b1b4d8e2f1b0b27a8d3c9c7543d269d535f9::reward7606 {
    struct REWARD7606 has drop {
        dummy_field: bool,
    }

    struct TICKET_7606 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7606(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7606>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7606>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7606, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7606>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7606>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7606>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7606>>(v5, 0x2::tx_context::sender(arg1));
    }
