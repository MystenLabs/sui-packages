module 0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::stake_pool {
    ...
    entry fun activate_incentive_token<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg4);
        let v0 = &mut arg1.id;
    ...
    entry fun activate_stake_pool(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg3);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
    ...
    entry fun add_incentive_token<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg6);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
    ...
    public(friend) fun allocate_incentive(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::clock::Clock) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::version_check(arg0);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        let v2 = 0;
    ...
    entry fun auto_compound<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg4);
        ...
        let v6 = 0;
        let v7 = 0;
        let v8 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::length(v5);
        if (v8 > 0) {
            let v9 = (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::slice_size(v5) as u64);
            let v10 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::borrow_slice_mut<address, LpUserShare>(v5, 0);
            let v11 = 0;
            while (v11 < v8) {
                let (_, v13) = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::borrow_from_slice_mut<address, LpUserShare>(v10, v11 % v9);
                let (v14, _) = calculate_incentive(v4, &v2, v13);
                update_last_incentive_price_index(v13, v2, v4);
                log_harvested_amount(v13, v14);
                v6 = v6 + v14;
                v13.total_shares = v13.total_shares + v14;
                v13.active_shares = v13.active_shares + v14;
                v7 = v7 + 1;
                if (v11 + 1 < v8 && (v11 + 1) % v9 == 0) {
                    v10 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::borrow_slice_mut<address, LpUserShare>(v5, (((v11 + 1) / v9) as u16));
                };
                v11 = v11 + 1;
            };
        };
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v1.id, 0x1::string::utf8(b"staked_tlp")), 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, v2), v6));
        v1.pool_info.total_share = v1.pool_info.total_share + v6;
        let v16 = AutoCompoundEvent{
            sender                : 0x2::tx_context::sender(arg4),
            index                 : arg2,
            incentive_token       : v2,
            ...
            total_amount          : v6,
            compound_users        : v7,
            total_users           : 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::length(v5),
            u64_padding           : 0x1::vector::empty<u64>(),
        };
        0x2::event::emit<AutoCompoundEvent>(v16);
    }

    fun calculate_incentive(arg0: u64, arg1: &0x1::type_name::TypeName, arg2: &LpUserShare) : (u64, u64) {
        let v0 = if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg2.last_incentive_price_index, arg1)) {
        ...
        while (v2 < 0x1::vector::length<DeactivatingShares>(&arg2.deactivating_shares)) {
            ...
            if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&v3.unsubscribed_incentive_price_index, arg1)) {
                let v4 = *0x2::vec_map::get<0x1::type_name::TypeName, u64>(&v3.unsubscribed_incentive_price_index, arg1);
                let v5 = if (v4 > v0) {
                    v4 - v0
                } else {
                    0
    ...
    entry fun deactivate_incentive_token<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg4);
        allocate_incentive(arg0, arg1, arg2, arg3);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
    ...
    entry fun deactivate_stake_pool(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg3);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
    ...
    entry fun deposit_incentive<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg4);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        let v2 = 0x1::type_name::with_defining_ids<T0>();
    ...
    public(friend) fun get_user_shares(arg0: &StakePoolRegistry, arg1: u64, arg2: address) : vector<u8> {
        ...
        while (v6 < 0x1::vector::length<0x1::type_name::TypeName>(v5)) {
            ...
            let (v8, _) = calculate_incentive(get_incentive(v0, v7).info.incentive_price_index, v7, v2);
            0x1::vector::push_back<u64>(&mut v4, v8);
            v6 = v6 + 1;
        };
        let v10 = 0x2::bcs::to_bytes<LpUserShare>(v2);
        0x1::vector::append<u8>(&mut v10, 0x2::bcs::to_bytes<vector<u64>>(&v4));
        v10
    }
            ...
            while (v6 < v3) {
                ...
                if (v8.user_share_id == arg2) {
                    ...
                    while (v12 < 0x1::vector::length<0x1::type_name::TypeName>(v11)) {
                        ...
                        let (v14, _) = calculate_incentive(get_incentive(v0, v13).info.incentive_price_index, v13, v8);
                        0x1::vector::push_back<u64>(&mut v10, v14);
                        v12 = v12 + 1;
                    };
                    let v16 = 0x2::bcs::to_bytes<LpUserShare>(v8);
                    0x1::vector::append<u8>(&mut v16, 0x2::bcs::to_bytes<vector<u64>>(&v10));
                    v2 = v16;
                };
    ...
    public fun harvest_per_user_share<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::version_check(arg0);
        allocate_incentive(arg0, arg1, arg2, arg3);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        ...
        let (v6, v7) = calculate_incentive(get_incentive(v1, &v2).info.incentive_price_index, &v2, v4);
        update_last_incentive_price_index(v4, v2, v7);
        log_harvested_amount(v4, v6);
        if (v6 > 0x2::balance::value<T0>(0x2::dynamic_field::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&v1.id, v2))) {
            abort 9
        };
        let v8 = HarvestPerUserShareEvent{
            sender               : 0x2::tx_context::sender(arg4),
            index                : arg2,
            incentive_token_type : v2,
            harvest_amount       : v6,
        ...
        0x2::event::emit<HarvestPerUserShareEvent>(v8);
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, v2), v6), arg4)
    }

    fun harvest_progress_updated(arg0: 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, arg1: 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>) : bool {
        let v0 = true;
        let (v1, v2) = 0x2::vec_map::into_keys_values<0x1::type_name::TypeName, u64>(arg0);
        let v3 = v2;
        let v4 = v1;
        while (0x1::vector::length<0x1::type_name::TypeName>(&v4) > 0) {
            let v5 = 0x1::vector::pop_back<0x1::type_name::TypeName>(&mut v4);
            if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg1, &v5)) {
                if (*0x2::vec_map::get<0x1::type_name::TypeName, u64>(&arg1, &v5) != 0x1::vector::pop_back<u64>(&mut v3)) {
                    v0 = false;
                    continue
                } else {
                    continue
    ...
    entry fun hotfix_remove_stake_pool<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg3);
        let StakePool {
            id          : v0,
            pool_info   : v1,
            ...
            incentives  : _,
            u64_padding : _,
        } = 0x2::dynamic_object_field::remove<u64, StakePool>(&mut arg1.id, arg2);
        let StakePoolConfig {
            unlock_countdown_ts_ms : _,
            usd_per_exp            : _,
            u64_padding            : _,
        } = v2;
        let StakePoolInfo {
        ...
        let v16 = v0;
        0x2::balance::destroy_zero<T0>(0x2::dynamic_field::remove<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v16, 0x1::string::utf8(b"staked_tlp")));
        0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::destroy_empty(0x2::dynamic_field::remove<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::KeyedBigVector>(&mut v16, 0x1::string::utf8(b"lp_user_shares")));
    ...
    entry fun new_stake_pool<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg3);
    ...
    public fun remove_incentive_token<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg3);
        ...
        let v8 = v7;
        let v9 = 0x2::dynamic_field::remove<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v2.id, v0);
        assert!(v8.unallocated_amount == 0x2::balance::value<T0>(&v9), 15);
        let v10 = 0x2::dynamic_field::borrow_mut<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::KeyedBigVector>(&mut v2.id, 0x1::string::utf8(b"lp_user_shares"));
        let v11 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::length(v10);
        if (v11 > 0) {
            let v12 = (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::slice_size(v10) as u64);
            let v13 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::borrow_slice_mut<address, LpUserShare>(v10, 0);
            let v14 = 0;
            while (v14 < v11) {
                let (_, v16) = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::borrow_from_slice_mut<address, LpUserShare>(v13, v14 % v12);
                if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&v16.last_incentive_price_index, &v0)) {
                    let (_, _) = 0x2::vec_map::remove<0x1::type_name::TypeName, u64>(&mut v16.last_incentive_price_index, &v0);
                };
                let v19 = &mut v16.deactivating_shares;
                let v20 = 0;
                while (v20 < 0x1::vector::length<DeactivatingShares>(v19)) {
                    let v21 = 0x1::vector::borrow_mut<DeactivatingShares>(v19, v20);
                    if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&v21.unsubscribed_incentive_price_index, &v0)) {
                        let (_, _) = 0x2::vec_map::remove<0x1::type_name::TypeName, u64>(&mut v21.unsubscribed_incentive_price_index, &v0);
                    };
                    v20 = v20 + 1;
                };
                if (v14 + 1 < v11 && (v14 + 1) % v12 == 0) {
                    v13 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::borrow_slice_mut<address, LpUserShare>(v10, (((v14 + 1) / v12) as u16));
                };
                v14 = v14 + 1;
            };
        };
        let v24 = RemoveIncentiveTokenEvent{
            sender                  : 0x2::tx_context::sender(arg3),
            index                   : arg2,
            incentive_token         : v0,
            incentive_balance_value : 0x2::balance::value<T0>(&v9),
            u64_padding             : 0x1::vector::empty<u64>(),
        };
        0x2::event::emit<RemoveIncentiveTokenEvent>(v24);
        0x2::coin::from_balance<T0>(v9, arg3)
    }

    public fun snapshot(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg3: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::TypusUserRegistry, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::version_check(arg0);
        ...
        v4.tlp_price = v3;
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::add_tails_exp_amount(arg0, arg2, arg3, v0, v11);
    ...
    public fun stake<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::version_check(arg0);
    ...
    public fun unstake<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::version_check(arg0);
        allocate_incentive(arg0, arg1, arg2, arg3);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
    ...
    public fun unsubscribe<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::version_check(arg0);
        allocate_incentive(arg0, arg1, arg2, arg4);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
    ...
    entry fun update_incentive_config<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::clock::Clock, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<vector<u64>>, arg7: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg7);
        allocate_incentive(arg0, arg1, arg2, arg3);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        assert!(check_stake_pool_active(v1), 12);
    ...
    fun update_last_incentive_price_index(arg0: &mut LpUserShare, arg1: 0x1::type_name::TypeName, arg2: u64) {
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.last_incentive_price_index, &arg1)) {
            *0x2::vec_map::get_mut<0x1::type_name::TypeName, u64>(&mut arg0.last_incentive_price_index, &arg1) = arg2;
        } else {
            0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut arg0.last_incentive_price_index, arg1, arg2);
        };
    }

    entry fun update_pool_info_u64_padding(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg5);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        assert!(check_stake_pool_active(v1), 12);
    ...
    entry fun update_unlock_countdown_ts_ms(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg4);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        assert!(check_stake_pool_active(v1), 12);
    ...
    public fun withdraw_incentive<T0>(arg0: &0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x6cf6c6cc05316e238a338ba82c018d38a1af7e6da26b85fffa433df98e8f1bdb::admin::verify(arg0, arg5);
        allocate_incentive(arg0, arg1, arg2, arg4);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
