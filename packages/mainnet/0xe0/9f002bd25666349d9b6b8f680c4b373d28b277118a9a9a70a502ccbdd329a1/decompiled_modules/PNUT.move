module 0xe09f002bd25666349d9b6b8f680c4b373d28b277118a9a9a70a502ccbdd329a1::PNUT {
    struct PNUT has drop {
        dummy_field: bool,
    }

    fun init(arg0: PNUT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<PNUT>(arg0, 2, b"PNUT", b"Pnut", b"Pnut", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/8iP3Sirdq6gvdn9mHw7Bp5Ii78u7QyZIBaQCA9HxQi4?ext=png")), arg1);
