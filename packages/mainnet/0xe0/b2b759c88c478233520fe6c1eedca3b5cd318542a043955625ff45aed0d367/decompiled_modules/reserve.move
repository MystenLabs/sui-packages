module 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::reserve {
    struct Reserve<phantom T0> has store, key {
        ...
        cash: u64,
        total_supply: u64,
        borrow_index: 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::borrow_index::BorrowIndex,
    }
    ...
    struct ReserveBalance<phantom T0, phantom T1> has store {
        ...
        ctoken_supply: 0x2::balance::Supply<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>,
    }
    ...
    public(friend) fun new<T0, T1>(arg0: &mut 0x2::tx_context::TxContext, arg1: u64) : Reserve<T0> {
        let v0 = Reserve<T0>{
            ...
            cash         : 0,
            total_supply : 0,
            borrow_index : 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::borrow_index::new(arg1),
        };
        let v1 = ReserveBalanceKey{dummy_field: false};
        let v2 = ReserveBalance<T0, T1>{
            underlying_balance : 0x2::balance::zero<T1>(),
            ctoken_supply      : 0x2::balance::create_supply<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>(0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::new<T0, T1>()),
        };
        0x2::dynamic_field::add<ReserveBalanceKey, ReserveBalance<T0, T1>>(&mut v0.id, v1, v2);
        v0
    }

    public(friend) fun borrow_index<T0>(arg0: &Reserve<T0>) : &0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::borrow_index::BorrowIndex {
        &arg0.borrow_index
    }
    ...
    public(friend) fun accrue_interest<T0>(arg0: &mut Reserve<T0>, arg1: 0x4bc9fe7e053de46aa9789fdcb1ad031389cf4f710cde859ab40c7e9cc2dee7c3::float::Decimal, arg2: 0x4bc9fe7e053de46aa9789fdcb1ad031389cf4f710cde859ab40c7e9cc2dee7c3::float::Decimal, arg3: u64) {
        let v0 = 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::borrow_index::last_updated(&arg0.borrow_index);
        if (v0 == arg3) {
            return
        };
        let v1 = 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::borrow_index::value(&arg0.borrow_index);
        ...
        0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::borrow_index::set_value(&mut arg0.borrow_index, 0x4bc9fe7e053de46aa9789fdcb1ad031389cf4f710cde859ab40c7e9cc2dee7c3::float::add(0x4bc9fe7e053de46aa9789fdcb1ad031389cf4f710cde859ab40c7e9cc2dee7c3::float::mul(v2, v1), v1), arg3);
    }
    ...
    public(friend) fun borrow_amount<T0, T1>(arg0: &mut Reserve<T0>, arg1: u64) : 0x2::balance::Balance<T1> {
        assert!(arg0.cash - 0x4bc9fe7e053de46aa9789fdcb1ad031389cf4f710cde859ab40c7e9cc2dee7c3::float::ceil(arg0.cash_reserve) > arg1, 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::error::reserve_not_enough_error());
    ...
    public(friend) fun borrow_flash_loan<T0, T1>(arg0: &mut Reserve<T0>, arg1: u64) : (0x2::balance::Balance<T1>, ReserveFlashLoan<T0, T1>) {
        assert!(arg1 < arg0.cash, 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::error::reserve_flash_loan_more_than_cash());
    ...
    public(friend) fun burn_ctokens<T0, T1>(arg0: &mut Reserve<T0>, arg1: 0x2::coin::Coin<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>) : 0x2::balance::Balance<T1> {
        assert!(0x2::coin::value<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>(&arg1) > 0, 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::error::reserve_zero_coin_not_allowed());
        let v0 = 0x4bc9fe7e053de46aa9789fdcb1ad031389cf4f710cde859ab40c7e9cc2dee7c3::float::int_mul(exchange_rate<T0>(arg0), 0x2::coin::value<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>(&arg1));
        decrease_ctoken_supply<T0, T1>(arg0, 0x2::coin::into_balance<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>(arg1));
    ...
    public(friend) fun calculate_borrow_index<T0>(arg0: &Reserve<T0>, arg1: 0x4bc9fe7e053de46aa9789fdcb1ad031389cf4f710cde859ab40c7e9cc2dee7c3::float::Decimal, arg2: u64) : 0x4bc9fe7e053de46aa9789fdcb1ad031389cf4f710cde859ab40c7e9cc2dee7c3::float::Decimal {
        let v0 = 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::borrow_index::value(&arg0.borrow_index);
        let v1 = 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::borrow_index::last_updated(&arg0.borrow_index);
        if (v1 == arg2) {
            return v0
        };
    ...
    fun decrease_ctoken_supply<T0, T1>(arg0: &mut Reserve<T0>, arg1: 0x2::balance::Balance<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>) {
        let v0 = ReserveBalanceKey{dummy_field: false};
        arg0.total_supply = arg0.total_supply - 0x2::balance::value<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>(&arg1);
        0x2::balance::decrease_supply<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>(&mut 0x2::dynamic_field::borrow_mut<ReserveBalanceKey, ReserveBalance<T0, T1>>(&mut arg0.id, v0).ctoken_supply, arg1);
    }
    ...
    fun increase_ctoken_supply<T0, T1>(arg0: &mut Reserve<T0>, arg1: u64) : 0x2::balance::Balance<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>> {
        let v0 = ReserveBalanceKey{dummy_field: false};
        arg0.total_supply = arg0.total_supply + arg1;
        0x2::balance::increase_supply<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>(&mut 0x2::dynamic_field::borrow_mut<ReserveBalanceKey, ReserveBalance<T0, T1>>(&mut arg0.id, v0).ctoken_supply, arg1)
    }
    ...
    public(friend) fun liquidate_ctokens<T0, T1>(arg0: &mut Reserve<T0>, arg1: 0x2::coin::Coin<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>, arg2: 0x4bc9fe7e053de46aa9789fdcb1ad031389cf4f710cde859ab40c7e9cc2dee7c3::float::Decimal) : 0x2::balance::Balance<T1> {
        assert!(0x2::coin::value<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>(&arg1) > 0, 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::error::reserve_zero_coin_not_allowed());
        let v0 = 0x4bc9fe7e053de46aa9789fdcb1ad031389cf4f710cde859ab40c7e9cc2dee7c3::float::int_mul(exchange_rate<T0>(arg0), 0x2::coin::value<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>>(&arg1));
    ...
    public(friend) fun mint_ctokens<T0, T1>(arg0: &mut Reserve<T0>, arg1: 0x2::coin::Coin<T1>) : 0x2::balance::Balance<0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::ctoken::CToken<T0, T1>> {
        let v0 = 0x2::coin::value<T1>(&arg1);
        assert!(v0 > 0, 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::error::reserve_zero_coin_not_allowed());
    ...
    public(friend) fun repay_flash_loan<T0, T1>(arg0: &mut Reserve<T0>, arg1: ReserveFlashLoan<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T1>) {
        ...
        assert!(0x2::coin::value<T1>(&arg2) == v2, 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::error::reserve_flash_loan_not_paid_enough());
    ...
    fun withdraw_underlying<T0, T1>(arg0: &mut Reserve<T0>, arg1: u64) : 0x2::balance::Balance<T1> {
        ...
        assert!(arg0.cash >= 0x4bc9fe7e053de46aa9789fdcb1ad031389cf4f710cde859ab40c7e9cc2dee7c3::float::ceil(arg0.cash_reserve), 0xe0b2b759c88c478233520fe6c1eedca3b5cd318542a043955625ff45aed0d367::error::market_cash_reserve_not_enough());
