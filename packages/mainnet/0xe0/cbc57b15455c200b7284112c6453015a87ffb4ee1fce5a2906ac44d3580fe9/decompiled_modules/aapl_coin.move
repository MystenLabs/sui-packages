module 0xe0cbc57b15455c200b7284112c6453015a87ffb4ee1fce5a2906ac44d3580fe9::aapl_coin {
    ...
    public entry fun burn(arg0: &mut AAPLTreasury, arg1: &mut 0xe0cbc57b15455c200b7284112c6453015a87ffb4ee1fce5a2906ac44d3580fe9::registry::StockRegistry, arg2: 0x2::coin::Coin<AAPL_COIN>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xe0cbc57b15455c200b7284112c6453015a87ffb4ee1fce5a2906ac44d3580fe9::registry::emit_burn_event(0x1::string::utf8(b"AAPL"), v0, 0x2::tx_context::sender(arg3));
    }

    public entry fun mint(arg0: &0xe0cbc57b15455c200b7284112c6453015a87ffb4ee1fce5a2906ac44d3580fe9::registry::MinterCap, arg1: &mut AAPLTreasury, arg2: &mut 0xe0cbc57b15455c200b7284112c6453015a87ffb4ee1fce5a2906ac44d3580fe9::registry::StockRegistry, arg3: u64, arg4: vector<u8>, arg5: vector<u8>, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0xe0cbc57b15455c200b7284112c6453015a87ffb4ee1fce5a2906ac44d3580fe9::registry::emit_mint_event(0x1::string::utf8(b"AAPL"), arg3, arg6, v1);
    ...
    fun init(arg0: AAPL_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AAPL_COIN>(arg0, 8, b"AAPLx", b"Apple Synthetic Stock", b"Synthetic Apple stock backed 1:1 by Backed Finance AAPL tokens on Solana", 0x1::option::none<0x2::url::Url>(), arg1);
