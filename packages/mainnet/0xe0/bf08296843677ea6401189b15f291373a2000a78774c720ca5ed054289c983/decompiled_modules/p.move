module 0xe0bf08296843677ea6401189b15f291373a2000a78774c720ca5ed054289c983::p {
    struct P {
        ladder: vector<u64>,
        rung: u64,
        carry: u64,
    ...
    public fun av(arg0: &mut P) {
        ...
        let v1 = arg0.carry;
        if (arg0.best_in == 0 || 0xe0bf08296843677ea6401189b15f291373a2000a78774c720ca5ed054289c983::n::sc(v0, v1) > 0xe0bf08296843677ea6401189b15f291373a2000a78774c720ca5ed054289c983::n::sc(arg0.best_in, arg0.best_out)) {
            arg0.best_in = v0;
            arg0.best_out = v1;
    ...
    fun av_bracket(arg0: &mut P) {
        ...
        if (arg0.bfx == 0 && arg0.bx == v0) {
            arg0.bfx = v1;
        } else if (0xe0bf08296843677ea6401189b15f291373a2000a78774c720ca5ed054289c983::n::sc(v0, v1) > 0xe0bf08296843677ea6401189b15f291373a2000a78774c720ca5ed054289c983::n::sc(arg0.bx, arg0.bfx)) {
            if (v0 > arg0.bx) {
                arg0.blo = arg0.bx;
            } else {
                arg0.bhi = arg0.bx;
    ...
    public fun dc(arg0: &mut P, arg1: &0x2::clock::Clock) {
        assert!(!arg0.decided, 34);
        0xe0bf08296843677ea6401189b15f291373a2000a78774c720ca5ed054289c983::g::bf(arg1, arg0.deadline_ms);
        assert!(arg0.best_in > 0, 20);
        assert!(arg0.best_out > arg0.best_in, 20);
        0xe0bf08296843677ea6401189b15f291373a2000a78774c720ca5ed054289c983::g::mn(arg0.best_out - arg0.best_in, arg0.min_profit);
        arg0.decided = true;
        arg0.step = 0;
    }
    ...
    public fun fi<T0>(arg0: P, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        let v18 = v0;
        assert!(v7, 34);
        0xe0bf08296843677ea6401189b15f291373a2000a78774c720ca5ed054289c983::r::close<T0>(arg1, v4, v5, arg2, (0x1::vector::length<u64>(&v18) as u8), v10, v9, 0, arg3, arg4);
    }
    ...
    public fun fx<T0, T1>(arg0: P, arg1: 0x2::balance::Balance<T0>, arg2: &0x2::balance::Balance<T1>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::tx_context::TxContext) {
        ...
        let v18 = v0;
        assert!(v7, 34);
        0xe0bf08296843677ea6401189b15f291373a2000a78774c720ca5ed054289c983::r::close<T0>(arg1, v4, v5, arg5, (0x1::vector::length<u64>(&v18) as u8), v10, v9, 0xe0bf08296843677ea6401189b15f291373a2000a78774c720ca5ed054289c983::r::fee_spent<T1>(arg2, arg3, arg4), arg6, arg7);
    }
    ...
    public fun op(arg0: vector<u64>, arg1: u64, arg2: u64, arg3: u64, arg4: u8) : P {
        ...
        assert!(v0 > 0, 31);
        assert!(v0 <= (0xe0bf08296843677ea6401189b15f291373a2000a78774c720ca5ed054289c983::n::mx() as u64), 32);
        let v1 = 0;
        while (v1 < v0) {
