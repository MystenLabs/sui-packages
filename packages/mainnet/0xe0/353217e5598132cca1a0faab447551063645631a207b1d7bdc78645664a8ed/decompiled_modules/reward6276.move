module 0xe0353217e5598132cca1a0faab447551063645631a207b1d7bdc78645664a8ed::reward6276 {
    struct REWARD6276 has drop {
        dummy_field: bool,
    }

    struct TICKET_6276 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6276(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6276>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6276>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6276, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6276>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6276>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6276>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6276>>(v5, 0x2::tx_context::sender(arg1));
    }
