module 0xe0f91ef825980b17eb3a1b3d5d9953e311f4c683ba012b977178bc6687664804::floombus {
    ...
    fun init(arg0: FLOOMBUS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::url::new_unsafe_from_bytes(b"https://refbotdashboard.boocat.me/flumbus.png");
        let v1 = MyFLOOMBUS{
