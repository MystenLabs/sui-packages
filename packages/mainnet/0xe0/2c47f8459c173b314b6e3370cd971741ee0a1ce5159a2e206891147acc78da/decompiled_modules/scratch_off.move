module 0xe02c47f8459c173b314b6e3370cd971741ee0a1ce5159a2e206891147acc78da::scratch_off {
    ...
    public fun finish_evaluation<T0>(arg0: &mut 0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::unihouse::UniHouse, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: &mut ConvenienceStore<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0xe02c47f8459c173b314b6e3370cd971741ee0a1ce5159a2e206891147acc78da::math::get_random_u64_in_range(&v5, tickets_left<T0>(arg3));
        let v7 = 0;
        let v8 = 0;
        while (v7 < v6) {
