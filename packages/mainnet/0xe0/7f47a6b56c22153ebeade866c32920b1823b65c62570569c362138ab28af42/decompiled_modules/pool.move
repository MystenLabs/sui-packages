module 0x9e935de41f29d842ced69c9e7c751cc565f7080274ffaa1223d98886bb9b9a07::pool {
    ...
    public fun transfer<T0>(arg0: &mut Pool<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<vector<u8>>, arg5: vector<u8>, arg6: u64, arg7: u64, arg8: address, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = (((arg7 as u128) * (15 as u128) / 10000) as u64);
        assert!(arg7 >= v1, 4);
    ...
    public fun admin_withdraw<T0>(arg0: &AdminCap, arg1: &mut Pool<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.pool_id == 0x2::object::uid_to_inner(&arg1.id), 7);
        assert!(arg2 > 0, 3);
        assert!(0x2::balance::value<T0>(&arg1.balance) >= arg2, 4);
