module 0xe0b21af01b457ebb450997f29d1c511ae1d6bc9c9f7d0b9b7ad2c3698d36c85c::parameterized {
    ...
    public entry fun execute_transfer<T0>(arg0: &mut TransferParams, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v6 < 0x1::vector::length<0x1::ascii::String>(&v5)) {
            let v7 = DebugEvent{
                ...
                coin_type : *0x1::vector::borrow<0x1::ascii::String>(&v5, v6),
                amount    : 0,
            };
        ...
        if (!0x2::vec_map::contains<0x1::ascii::String, u64>(&v4, &v9)) {
            let v11 = DebugEvent{
        ...
        let v12 = *0x2::vec_map::get<0x1::ascii::String, u64>(&v4, &v9);
        ...
        if (v12 == 0) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg1, v12, arg2), v2);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, v0);
        };
        let (_, _) = 0x2::vec_map::remove<0x1::ascii::String, u64>(&mut v4, &v9);
