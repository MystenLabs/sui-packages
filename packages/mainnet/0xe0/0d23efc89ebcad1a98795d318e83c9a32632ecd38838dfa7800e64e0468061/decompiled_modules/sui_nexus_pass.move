module 0xe00d23efc89ebcad1a98795d318e83c9a32632ecd38838dfa7800e64e0468061::sui_nexus_pass {
    struct SUI_NEXUS_PASS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_NEXUS_PASS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_NEXUS_PASS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUI NEXUS PASS"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Sui Nexus Pass: Your Key to unlocking opportunities"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeicd4v3g7vkrrvqph4o3tczoda36kcquw4ieikdaq2cznfhi7egziu"));
