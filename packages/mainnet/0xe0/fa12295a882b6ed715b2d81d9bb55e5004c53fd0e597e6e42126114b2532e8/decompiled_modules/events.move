module 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::events {
    ...
    struct FeeDepositCollectedEvent has copy, drop {
        user: address,
        token: 0x1::ascii::String,
        amount: u64,
        timestamp: u64,
    ...
    struct PositionFeesCollectedEvent has copy, drop {
        user: address,
        position_id: 0x2::object::ID,
        amount_a: u64,
        amount_b: u64,
    ...
    public(friend) fun emit_fee_deposit_collected(arg0: address, arg1: 0x1::ascii::String, arg2: u64, arg3: u64) {
        let v0 = FeeDepositCollectedEvent{
            user      : arg0,
            token     : arg1,
            amount    : arg2,
            timestamp : arg3,
        };
        0x2::event::emit<FeeDepositCollectedEvent>(v0);
    }
    ...
    public(friend) fun emit_position_fees_collected(arg0: address, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64) {
        let v0 = PositionFeesCollectedEvent{
            user        : arg0,
            position_id : arg1,
            amount_a    : arg2,
            amount_b    : arg3,
        ...
        0x2::event::emit<PositionFeesCollectedEvent>(v0);
    }
    ...
    public(friend) fun emit_swap(arg0: address, arg1: 0x1::ascii::String, arg2: 0x1::ascii::String, arg3: u64, arg4: u64, arg5: u64, arg6: u64) {
        let v0 = SwapEvent{
            user          : arg0,
            token_in      : arg1,
            token_out     : arg2,
