module 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::vault_core {
    struct Vault has key {
        id: 0x2::object::UID,
        balances: 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::pools::UserPool,
        fee_balances: 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::pools::FeePool,
        operator_gas_pool: 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::pools::GasPool,
    ...
    public(friend) fun assert_not_paused(arg0: &Vault) {
        assert!(!arg0.paused, 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::errors::vault_paused());
    }

    public(friend) fun assert_paused(arg0: &Vault) {
        assert!(arg0.paused, 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::errors::vault_not_paused());
    }

    public(friend) fun assert_version(arg0: &Vault) {
        assert!(arg0.version == 10, 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::errors::version_mismatch());
    }

    public(friend) fun borrow_account(arg0: &Vault, arg1: address) : &UserAccount {
        assert!(0x2::table::contains<address, UserAccount>(&arg0.accounts, arg1), 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::errors::account_not_found());
    ...
    public(friend) fun borrow_fee_pool(arg0: &Vault) : &0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::pools::FeePool {
        &arg0.fee_balances
    }

    public(friend) fun borrow_fee_pool_mut(arg0: &mut Vault) : &mut 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::pools::FeePool {
        &mut arg0.fee_balances
    }

    public(friend) fun borrow_gas_pool(arg0: &Vault) : &0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::pools::GasPool {
        &arg0.operator_gas_pool
    }

    public(friend) fun borrow_gas_pool_mut(arg0: &mut Vault) : &mut 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::pools::GasPool {
    ...
    public(friend) fun borrow_position(arg0: &Vault, arg1: 0x2::object::ID) : &PositionRecord {
        assert!(0x2::table::contains<0x2::object::ID, PositionRecord>(&arg0.positions, arg1), 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::errors::position_not_found());
    ...
    public(friend) fun borrow_user_pool(arg0: &Vault) : &0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::pools::UserPool {
        &arg0.balances
    }

    public(friend) fun borrow_user_pool_mut(arg0: &mut Vault) : &mut 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::pools::UserPool {
        &mut arg0.balances
    }
    ...
    public fun create_vault(arg0: u64, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (Vault, AdminCap, TreasurerCap) {
        ...
        let v3 = Vault{
            id                     : v0,
            balances               : 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::pools::new_user_pool(arg3),
            fee_balances           : 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::pools::new_fee_pool(arg3),
            operator_gas_pool      : 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::pools::new_gas_pool(),
        ...
        0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::events::emit_vault_created(v1, 0x2::tx_context::sender(arg3), arg0, v2);
        (v3, v4, v5)
    }
    ...
    public fun migrate(arg0: &mut Vault, arg1: &AdminCap) {
        assert!(arg1.vault_id == 0x2::object::uid_to_inner(&arg0.id), 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::errors::not_admin());
        assert!(arg0.version < 10, 0x983f8e9ba4400ab0418e75bc8221d7b0c71d04fcb609632bf96410deeb61c60b::errors::version_mismatch());
        arg0.version = 10;
    }
