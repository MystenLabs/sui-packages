module 0xe022ce8d35f4cb864239bd1bcba69d20e84126d32303ffe0cf8b8c5f5d99bdc0::genesis {
    ...
    public(friend) fun add<T0>(arg0: &0xe022ce8d35f4cb864239bd1bcba69d20e84126d32303ffe0cf8b8c5f5d99bdc0::admin::AdminCap, arg1: &mut Genesis<T0>, arg2: vector<address>, arg3: vector<u64>) {
    ...
    public(friend) fun remove<T0>(arg0: &0xe022ce8d35f4cb864239bd1bcba69d20e84126d32303ffe0cf8b8c5f5d99bdc0::admin::AdminCap, arg1: &mut Genesis<T0>, arg2: vector<address>) {
        while (!0x1::vector::is_empty<address>(&arg2)) {
    ...
    fun calc_penalty(arg0: u64, arg1: u8) : u64 {
        if (arg1 == 1) {
            0xe022ce8d35f4cb864239bd1bcba69d20e84126d32303ffe0cf8b8c5f5d99bdc0::math::mul_factor(arg0, 66660000, 100000000)
        } else if (arg1 == 2) {
            0xe022ce8d35f4cb864239bd1bcba69d20e84126d32303ffe0cf8b8c5f5d99bdc0::math::mul_factor(arg0, 33330000, 100000000)
        } else {
    ...
    public(friend) fun claim<T0>(arg0: &mut Genesis<T0>, arg1: u64, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        let v3 = if (v2 > 0) {
            0xe022ce8d35f4cb864239bd1bcba69d20e84126d32303ffe0cf8b8c5f5d99bdc0::math::mul_factor(v2, 50000000, 100000000)
        } else {
            0
        };
    ...
    public(friend) fun initialize<T0>(arg0: &0xe022ce8d35f4cb864239bd1bcba69d20e84126d32303ffe0cf8b8c5f5d99bdc0::admin::AdminCap, arg1: 0x2::coin::TreasuryCap<T0>, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Genesis<T0>{
    ...
    public(friend) fun refill<T0>(arg0: &0xe022ce8d35f4cb864239bd1bcba69d20e84126d32303ffe0cf8b8c5f5d99bdc0::admin::AdminCap, arg1: &mut Genesis<T0>, arg2: 0x2::coin::Coin<T0>) {
        0x2::balance::join<T0>(&mut arg1.genesis_balance, 0x2::coin::into_balance<T0>(arg2));
    }

    public(friend) fun set_claiming_enabled<T0>(arg0: &0xe022ce8d35f4cb864239bd1bcba69d20e84126d32303ffe0cf8b8c5f5d99bdc0::admin::AdminCap, arg1: &mut Genesis<T0>, arg2: bool) {
        arg1.is_claiming_enabled = arg2;
    }

    public(friend) fun set_min_claim_amount<T0>(arg0: &0xe022ce8d35f4cb864239bd1bcba69d20e84126d32303ffe0cf8b8c5f5d99bdc0::admin::AdminCap, arg1: &mut Genesis<T0>, arg2: u64) {
        arg1.min_claim_amount = arg2;
    }

    public(friend) fun set_staking_pool_id<T0>(arg0: &0xe022ce8d35f4cb864239bd1bcba69d20e84126d32303ffe0cf8b8c5f5d99bdc0::admin::AdminCap, arg1: &mut Genesis<T0>, arg2: 0x2::object::ID) {
    ...
    public(friend) fun withdraw_collected_staking_bonus<T0>(arg0: &0xe022ce8d35f4cb864239bd1bcba69d20e84126d32303ffe0cf8b8c5f5d99bdc0::admin::AdminCap, arg1: &mut Genesis<T0>) : 0x2::balance::Balance<T0> {
