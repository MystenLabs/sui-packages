module 0xe02a310fa95284ac066cce83e4d34b9c9e26e2abe854d8e1855fdfd323e61934::dbke {
    ...
    fun emo<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<u64>, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: &0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        while (v13 < 0x1::vector::length<u64>(&arg8)) {
            ...
            if (v10 < arg13) {
                ...
                0x2::event::emit<DBG>(v26);
                break
            };
            let v27 = sp(&v7, &v6, arg14, *0x1::vector::borrow<u64>(&arg9, v23), false, v8, v9);
            if (v27 == 0) {
                let v28 = EE{
                    e : 101,
                    l : 600,
            ...
            let (v29, v30) = vbac<T0, T1>(arg0, v10, v11, v12, arg14, arg15, arg13, v27, *0x1::vector::borrow<u64>(&arg10, v23), false, true, true);
            if (v30 != 0) {
                if (v30 == 102 || v30 == 104) {
                    break
                };
            ...
            let v32 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg1, arg2, 0, v0, v1, v27, v29, false, true, v24, arg3, arg16);
            v10 = v10 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v32);
            v11 = v11 + (((0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v32) as u128) * (v27 as u128) / 1000000000) as u64);
    ...
    fun eto<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<u64>, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: &0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        while (v13 < 0x1::vector::length<u64>(&arg8)) {
            ...
            if (v10 < arg13) {
                ...
                0x2::event::emit<DBG>(v29);
                break
            };
            if (!vtop(v27, false, &v7, &v6, v8, v9)) {
                break
            };
            let (v30, v31) = vbac<T0, T1>(arg0, v10, v11, v12, arg14, arg15, arg13, v27, *0x1::vector::borrow<u64>(&arg10, v24), false, false, true);
            if (v31 != 0) {
                let v32 = EE{
                    e : v31,
                    l : 410,
            ...
            let v33 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg1, arg2, 18446744073709551615, v0, v1, v27, v30, false, true, v25, arg3, arg16);
            let v34 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v33);
            v10 = v10 - v34;
            v11 = v11 + (((v34 as u128) * (v27 as u128) / 1000000000) as u64);
            v12 = v12 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::paid_fees(&v33);
        };
        (v10, v11, v12)
    }
