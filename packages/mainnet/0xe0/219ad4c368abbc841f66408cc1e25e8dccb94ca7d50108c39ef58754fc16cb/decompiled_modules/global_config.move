module 0xe0219ad4c368abbc841f66408cc1e25e8dccb94ca7d50108c39ef58754fc16cb::global_config {
    ...
    public fun create_and_share_by_admin(arg0: &0xc59bf9a81ec34872a3c47e0e84a4fc65ab280f319e2df61db4f860e90b32572c::admin::AdminCap, arg1: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = create_by_admin(arg0, arg1);
        0x2::transfer::share_object<GlobalConfig>(v0);
        0x2::object::id<GlobalConfig>(&v0)
    }

    public fun create_by_admin(arg0: &0xc59bf9a81ec34872a3c47e0e84a4fc65ab280f319e2df61db4f860e90b32572c::admin::AdminCap, arg1: &mut 0x2::tx_context::TxContext) : GlobalConfig {
        let v0 = GlobalConfig{
        ...
        let v1 = GlobalConfigCreatedEvent{
            config_id : 0x2::object::id<GlobalConfig>(&v0),
            version   : 1,
        };
        0x2::event::emit<GlobalConfigCreatedEvent>(v1);
        v0
    }
    ...
    public fun set_version_by_admin(arg0: &mut GlobalConfig, arg1: &0xc59bf9a81ec34872a3c47e0e84a4fc65ab280f319e2df61db4f860e90b32572c::admin::AdminCap, arg2: u64) {
        arg0.version = arg2;
