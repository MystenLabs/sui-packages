module 0xe0052bc432f4ef0229d333aeb595f58fab24e858bc56ba703fe0fba60a5dbceb::ORANGE {
    ...
    fun init(arg0: ORANGE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<ORANGE>>(0x2::coin::mint<ORANGE>(&mut v2, 6500000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
