module 0xe0bb2503b61edb07344df67c372b61618ab1735db8a72813d7c4d978e0ea9cf1::cnsnft6258 {
    struct CNSNFT6258 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6258, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6258>(arg0, arg1);
