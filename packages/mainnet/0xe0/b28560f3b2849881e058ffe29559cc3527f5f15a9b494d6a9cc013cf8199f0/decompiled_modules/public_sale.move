module 0xe0b28560f3b2849881e058ffe29559cc3527f5f15a9b494d6a9cc013cf8199f0::public_sale {
    ...
    public entry fun add_multiple_whitelist_entries(arg0: &ICOOperatorCapability, arg1: &mut PresaleData, arg2: vector<address>) {
        ...
        let v0 = MultipleAddressAddedToWhitelist{wallets: arg2};
        0x2::event::emit<MultipleAddressAddedToWhitelist>(v0);
    }
    ...
    public entry fun calculate_elligible_rewards(arg0: &mut PresaleData, arg1: &mut UserData, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = calculate_reward(arg1.investedSui, arg0.totalTokensForSale, arg0.actualAmountRaisedSui);
        let v1 = calculate_refundable_reward(arg1.investedSui, arg0.suiPerToken, arg0.totalTokensForSale, arg0.actualAmountRaisedSui);
    ...
    fun calculate_refundable_reward(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        let v0 = calculate_reward(arg0, arg2, arg3) / 10000000 * arg1 / 1000000000 * 10000000;
        if (v0 > arg0) {
            0
        } else {
            arg0 - v0
    ...
    fun calculate_reward(arg0: u64, arg1: u64, arg2: u64) : u64 {
        arg0 * 10000000 / arg2 * arg1 / 1000000000 / 10000000 * 1000000000
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = PresaleData{
            ...
            icoStartTimestamp      : 0,
            icoEndTimestamp        : 1984276317000,
            suiPerToken            : 1000000,
            totalTokensForSale     : 1450000000 * 1000000000,
            totalSuiDeposited      : 0x2::balance::zero<0x2::sui::SUI>(),
            amountToBeRaisedSui    : 1450000 * 1000000000,
            actualAmountRaisedSui  : 0,
            minimumContributionSui : 800000000,
    ...
    public entry fun remove_whitelist_entry(arg0: &ICOOperatorCapability, arg1: &mut PresaleData, arg2: address) {
        ...
        let v2 = SingleAddressAddedToWhitelist{wallet: arg2};
        0x2::event::emit<SingleAddressAddedToWhitelist>(v2);
    }
