module 0xe0399738759cefcece94a4568f46ddf107abe84aa3a014957ce82adbadfbc785::surf {
    ...
    public fun current_week(arg0: &MintConfig, arg1: &0x2::clock::Clock) : u64 {
        ensure_started(arg0);
        let v0 = now_s(arg1);
        assert!(v0 >= arg0.season_start_ts, 0xe0399738759cefcece94a4568f46ddf107abe84aa3a014957ce82adbadfbc785::errors::not_started());
        (v0 - arg0.season_start_ts) / 604800 + 1
    }

    fun ensure_started(arg0: &MintConfig) {
        assert!(arg0.season_start_ts != 0, 0xe0399738759cefcece94a4568f46ddf107abe84aa3a014957ce82adbadfbc785::errors::not_started());
    }
    ...
    public fun mint(arg0: &mut MintConfig, arg1: &mut 0xe0399738759cefcece94a4568f46ddf107abe84aa3a014957ce82adbadfbc785::recorder::Recorder, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : SurfNFT {
        0xe0399738759cefcece94a4568f46ddf107abe84aa3a014957ce82adbadfbc785::recorder::ensure_version_matches(arg1);
        ensure_started(arg0);
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = current_week(arg0, arg2);
        assert!(0xe0399738759cefcece94a4568f46ddf107abe84aa3a014957ce82adbadfbc785::recorder::points_of(arg1, v0) >= arg0.threshold, 0xe0399738759cefcece94a4568f46ddf107abe84aa3a014957ce82adbadfbc785::errors::below_threshold());
        let v2 = arg0.weekly_cap;
        let v3 = refresh_or_create_user_weekly_data(arg0, v0, v1);
        v3.count = v3.count + 1;
        if (v1 >= 2) {
            assert!(v3.count <= v2, 0xe0399738759cefcece94a4568f46ddf107abe84aa3a014957ce82adbadfbc785::errors::weekly_cap_reached());
        };
        0xe0399738759cefcece94a4568f46ddf107abe84aa3a014957ce82adbadfbc785::recorder::add_spent(arg1, v0, arg0.mint_cost);
        let v4 = SurfNFT{
    ...
    public fun set_mint_cost(arg0: &mut MintConfig, arg1: &AdminCap, arg2: u64) {
        assert!(arg2 != 0, 0xe0399738759cefcece94a4568f46ddf107abe84aa3a014957ce82adbadfbc785::errors::invalid_config());
        arg0.mint_cost = arg2;
    }
    ...
    public fun start_season(arg0: &mut MintConfig, arg1: &AdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock) {
        assert!(arg0.season_start_ts == 0, 0xe0399738759cefcece94a4568f46ddf107abe84aa3a014957ce82adbadfbc785::errors::already_started());
