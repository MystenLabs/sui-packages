module 0xe0f97a2ea916788cc72479457a5ffb37b1853a7ffcaa2989e93678e09f947edf::cnsnft7095 {
    struct CNSNFT7095 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7095, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7095>(arg0, arg1);
