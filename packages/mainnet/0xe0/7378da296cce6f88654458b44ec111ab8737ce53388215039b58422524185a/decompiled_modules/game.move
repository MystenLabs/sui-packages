module 0xe39b9ba59dd4c523df7a3a8d0eacf0e18576a88b38138b58ccbf1f0daa8aa64d::game {
    ...
    entry fun display_cosmetic_v4<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &mut CosmeticVault, arg2: BubbleCosmetic, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        if (v23) {
            ...
            0x2::table::add<u64, u64>(0x2::dynamic_field::borrow_mut<CosmeticBonusAppliedKey, 0x2::table::Table<u64, u64>>(&mut arg0.id, v25), v5, v12);
        };
        0x2::table::add<u64, BubbleCosmetic>(&mut arg1.cosmetics, v5, arg2);
        let v26 = 0x2::table::borrow_mut<address, PlayerTank>(&mut arg0.player_tanks, v0);
        0x1::vector::push_back<u64>(&mut v26.displayed_cosmetic_ids, v5);
        v26.total_pressure = v26.total_pressure + v21;
