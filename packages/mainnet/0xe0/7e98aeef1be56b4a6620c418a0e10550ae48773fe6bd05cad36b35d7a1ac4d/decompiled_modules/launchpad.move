module 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::launchpad {
    ...
    fun new<T0: drop>(arg0: PreSaleConfig, arg1: PublicSaleConfig, arg2: &mut 0x2::tx_context::TxContext) : Launchpad<T0> {
        ...
        let v2 = WalletDfKey<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>{dummy_field: false};
        0x2::dynamic_field::add<WalletDfKey<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>, 0x2::balance::Balance<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>>(&mut v0.id, v2, 0x2::balance::zero<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>());
        v0
    }
    ...
    public entry fun claim_pre_sale<T0>(arg0: &mut Launchpad<T0>, arg1: &mut 0x8d852e2c514b8a661445556e279dd78ba19f042a27b951df6a855850597727e6::xflx::TreasuryManagement, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = if (arg0.pre_sale_config.total_deposit_amount <= arg0.pre_sale_config.soft_cap) {
            ...
            (0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v2, 100000000, arg0.pre_sale_config.fixed_price), 0)
        } else {
            let v5 = 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v2, arg0.pre_sale_config.max_sale_amount, arg0.pre_sale_config.total_deposit_amount);
            (v5, v2 - 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v5, arg0.pre_sale_config.fixed_price, 100000000) + 1)
        };
        ...
        if (v3 > 0) {
            let v9 = WalletDfKey<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>{dummy_field: false};
            let v10 = 0x2::dynamic_field::borrow_mut<WalletDfKey<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>, 0x2::balance::Balance<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>>(&mut arg0.id, v9);
            let v11 = safe_withdraw<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>(v10, v3);
            0x8d852e2c514b8a661445556e279dd78ba19f042a27b951df6a855850597727e6::xflx::mint_and_transfer(arg1, 0x2::coin::from_balance<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>(0x2::balance::split<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>(&mut v11, 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v3, arg0.pre_sale_config.xflx_ratio, 10000)), arg2), v1, arg2);
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>>(0x2::coin::from_balance<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>(v11, arg2), v1);
        };
    }

    public entry fun claim_public_sale<T0>(arg0: &mut Launchpad<T0>, arg1: &mut 0x8d852e2c514b8a661445556e279dd78ba19f042a27b951df6a855850597727e6::xflx::TreasuryManagement, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 9);
        assert_version_and_upgrade<T0>(arg0);
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(arg0.claimable, 6);
        ...
        let (v3, v4) = if (arg0.public_sale_config.total_deposit_amount <= arg0.public_sale_config.soft_cap) {
            (0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v2, 100000000, arg0.public_sale_config.min_price), 0)
        } else if (arg0.public_sale_config.total_deposit_amount <= arg0.public_sale_config.hard_cap) {
            (0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v2, 100000000, 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(arg0.public_sale_config.total_deposit_amount, 100000000, arg0.public_sale_config.fixed_sale_amount)), 0)
        } else {
            let v5 = 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v2, arg0.public_sale_config.fixed_sale_amount, arg0.public_sale_config.total_deposit_amount);
            (v5, v2 - 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v5, arg0.public_sale_config.max_price, 100000000) + 1)
        };
        ...
        if (v3 > 0) {
            ...
            let v10 = 0x2::dynamic_field::borrow_mut<WalletDfKey<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>, 0x2::balance::Balance<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>>(&mut arg0.id, v9);
            let v11 = safe_withdraw<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>(v10, v3);
            0x8d852e2c514b8a661445556e279dd78ba19f042a27b951df6a855850597727e6::xflx::mint_and_transfer(arg1, 0x2::coin::from_balance<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>(0x2::balance::split<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>(&mut v11, 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v3, arg0.public_sale_config.xflx_ratio, 10000)), arg2), v1, arg2);
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>>(0x2::coin::from_balance<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>(v11, arg2), v1);
        };
    }
    ...
    public entry fun initialize<T0: drop>(arg0: &AdminCap, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        v0.soft_cap = 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v0.fixed_price, v0.min_sale_amount, 100000000);
        v0.hard_cap = 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v0.fixed_price, v0.max_sale_amount, 100000000);
        ...
        v1.soft_cap = 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v1.fixed_sale_amount, v1.min_price, 100000000);
        v1.hard_cap = 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(v1.fixed_sale_amount, v1.max_price, 100000000);
    ...
    public entry fun withdraw_flx_as_admin<T0>(arg0: &AdminCap, arg1: &mut Launchpad<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = if (arg1.pre_sale_config.total_deposit_amount <= arg1.pre_sale_config.soft_cap) {
            ...
            arg1.pre_sale_config.max_sale_amount - 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(arg1.pre_sale_config.total_deposit_amount, 100000000, arg1.pre_sale_config.fixed_price)
        } else {
            0
        };
        let v1 = if (arg1.public_sale_config.total_deposit_amount <= arg1.public_sale_config.soft_cap) {
            arg1.public_sale_config.fixed_sale_amount - 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(arg1.public_sale_config.total_deposit_amount, 100000000, arg1.public_sale_config.min_price)
        } else if (arg1.public_sale_config.total_deposit_amount <= arg1.public_sale_config.hard_cap) {
            arg1.public_sale_config.fixed_sale_amount - 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(arg1.public_sale_config.total_deposit_amount, 100000000, 0xe07e98aeef1be56b4a6620c418a0e10550ae48773fe6bd05cad36b35d7a1ac4d::u64::mul_div(arg1.public_sale_config.total_deposit_amount, 100000000, arg1.public_sale_config.fixed_sale_amount))
        } else {
            0
        };
        let v2 = WalletDfKey<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>{dummy_field: false};
        let v3 = 0x2::dynamic_field::borrow_mut<WalletDfKey<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>, 0x2::balance::Balance<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>>(&mut arg1.id, v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>>(0x2::coin::from_balance<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>(safe_withdraw<0xdb3034eb52a5da620f4752604a6f54879562e547e554b34d26e2144ed9ab3246::flx::FLX>(v3, v0 + v1), arg3), 0x2::tx_context::sender(arg3));
    }
