module 0x3a5f6f414b66691587802709785361841dd3c55aef1959fae8301c00f3db16d0::cnsnft2445 {
    struct CNSNFT2445 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2445, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2445>(arg0, arg1);
