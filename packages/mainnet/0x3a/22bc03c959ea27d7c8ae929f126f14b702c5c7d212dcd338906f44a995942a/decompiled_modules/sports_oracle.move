module 0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_oracle {
    ...
    public entry fun cancel_and_void(arg0: &0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::AdminCap, arg1: &mut SportsGame, arg2: &mut 0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::SportsMarket, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.has_linked_market, 6004);
        assert!(0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::market_id(arg2) == arg1.linked_market_id, 6005);
        assert!(arg1.status != 3, 6001);
        assert!(arg1.status != 4, 6009);
        let v0 = now_ms(arg4);
        arg1.status = 4;
        arg1.updated_at_ms = v0;
        0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::cancel_market(arg0, arg2, arg3, arg4, arg5);
        let v1 = GameCancelledMarketVoided{
            game_id      : 0x2::object::uid_to_inner(&arg1.id),
            market_id    : 0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::market_id(arg2),
    ...
    public entry fun create_registry(arg0: &0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun finalize_and_resolve(arg0: &0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::AdminCap, arg1: &mut SportsGame, arg2: &mut 0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::SportsMarket, arg3: &mut 0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::Treasury, arg4: u8, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.has_linked_market, 6004);
        assert!(0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::market_id(arg2) == arg1.linked_market_id, 6005);
        assert!(arg1.status != 3, 6001);
        assert!(arg1.status != 4, 6009);
        ...
        0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::resolve_market(arg0, arg2, arg3, v1, arg5, arg6);
    ...
    public entry fun link_market(arg0: &0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::AdminCap, arg1: &mut SportsGame, arg2: &0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::SportsMarket, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.has_linked_market, 6003);
        let v0 = 0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::market_id(arg2);
    ...
    public entry fun update_game_state(arg0: &0x3a22bc03c959ea27d7c8ae929f126f14b702c5c7d212dcd338906f44a995942a::sports_market::AdminCap, arg1: &mut SportsGame, arg2: u8, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status != 3, 6001);
        assert!(arg1.status != 4, 6009);
