module 0x3a86ab156c19b1b36b6a1eaeb6c77553785b6aec3f9857d7098079dce6d75248::terric_game {
    ...
    fun get_spin_result(arg0: &0x2::random::Random, arg1: &mut 0x2::tx_context::TxContext) : SpinResult {
        let v0 = 0x2::random::new_generator(arg0, arg1);
        SpinResult{spin1: (0x2::random::generate_u64_in_range(&mut v0, 0, 3) as u8)}
    }
    ...
    public entry fun play<T0>(arg0: &mut Game<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = get_spin_result(arg2, arg3);
        let v1 = SpinResult{spin1: 2};
        ...
        let (v4, v5) = if (v0.spin1 == v1.spin1) {
