module 0x3aa6a0be39e3093b3ae6778854fcb1f68cc7555a182b10f5d3bde4c50e9a736d::usdc_vault {
    ...
    public fun update_receipt_after_strategy_withdrawal<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut WithdrawReceipt<T0, T1>, arg2: 0x2::object::ID, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == 0x2::vec_map::get<0x2::object::ID, WithdrawAllocation>(&arg1.strategy_allocations, &arg2).expected_amount, 24);
        0x2::coin::burn<T1>(&mut arg0.share_token_supply, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.shares_remaining, muldiv(v0, 10000, arg1.current_share_price)), arg4));
        arg0.total_assets = arg0.total_assets - v0;
        update_strategy_allocation_after_withdrawal<T0, T1>(arg0, arg2, v0);
    ...
    public fun validate_vault_invariants<T0, T1>(arg0: &Vault<T0, T1>) {
        assert!(calculate_total_allocated_assets<T0, T1>(arg0) + 0x2::balance::value<T0>(&arg0.idle_funds) == arg0.total_assets, 11);
        let v0 = 0x2::coin::total_supply<T1>(&arg0.share_token_supply);
        if (v0 > 0) {
            assert!(muldiv(v0, calculate_current_share_price<T0, T1>(arg0), 10000) == arg0.total_assets, 12);
        };
        let v1 = VaultInvariantValidated{
            vault_id          : 0x2::object::id<Vault<T0, T1>>(arg0),
            total_assets      : arg0.total_assets,
            calculated_assets : muldiv(v0, calculate_current_share_price<T0, T1>(arg0), 10000),
        };
        0x2::event::emit<VaultInvariantValidated>(v1);
    }
