module 0x3ae19c6d1eb3b30bd216fce62fc76806c3ff368240a8f44d3e49f4b2c80cf2be::reward7004 {
    struct REWARD7004 has drop {
        dummy_field: bool,
    }

    struct TICKET_7004 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7004(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7004>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7004>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7004, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7004>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7004>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7004>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7004>>(v5, 0x2::tx_context::sender(arg1));
    }
