module 0x3a93d96ca9f2cf20317667cdef73dbf74d4fbaf9cd6e09cba54bf8fbd6116455::state {
            ...
            if (0x1::vector::borrow<0x1::type_name::TypeName>(v1, v2) == &v0) {
                ...
                *0x1::vector::borrow_mut<u64>(&mut arg0.amounts, v4) = *0x1::vector::borrow<u64>(&arg0.amounts, v4) + arg2;
                if (0x9c688ea952547e8d3ebfe13e97668659dd3aebd6c5a854048655ba8f253e7a26::locked::is_unlocked<0x2::coin::Coin<T0>>(&arg1, arg3)) {
                    ...
                    0x3a93d96ca9f2cf20317667cdef73dbf74d4fbaf9cd6e09cba54bf8fbd6116455::locked_coins::join<T0>(0x2::object_bag::borrow_mut<LockedKey, 0x3a93d96ca9f2cf20317667cdef73dbf74d4fbaf9cd6e09cba54bf8fbd6116455::locked_coins::LockedCoins<T0>>(&mut arg0.lp_coins, v6), arg1);
                };
                return
            };
            v2 = v2 + 1;
    ...
    public(friend) fun add_sub_vault<T0>(arg0: &mut ExtensionMetadataV1, arg1: &0xdf50f53346c13cf97543268a9837c545c129153a4fbd7b0ad2d0c660e55920dc::vault::Vault<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0xdf50f53346c13cf97543268a9837c545c129153a4fbd7b0ad2d0c660e55920dc::vault::Vault<T0>>(arg1);
        ...
        0x2::object_bag::add<LockedKey, 0x3a93d96ca9f2cf20317667cdef73dbf74d4fbaf9cd6e09cba54bf8fbd6116455::locked_coins::LockedCoins<T0>>(&mut arg0.lp_coins, v2, 0x3a93d96ca9f2cf20317667cdef73dbf74d4fbaf9cd6e09cba54bf8fbd6116455::locked_coins::new<T0>(arg2));
    ...
    public(friend) fun crank_unlocks<T0>(arg0: &mut ExtensionMetadataV1, arg1: &0x2::clock::Clock) {
        ...
        0x2::pay::join_vec<T0>(0x2::object_bag::borrow_mut<UnlockedKey, 0x2::coin::Coin<T0>>(&mut arg0.lp_coins, v2), 0x3a93d96ca9f2cf20317667cdef73dbf74d4fbaf9cd6e09cba54bf8fbd6116455::locked_coins::unlock_unlockable<T0>(0x2::object_bag::borrow_mut<LockedKey, 0x3a93d96ca9f2cf20317667cdef73dbf74d4fbaf9cd6e09cba54bf8fbd6116455::locked_coins::LockedCoins<T0>>(&mut arg0.lp_coins, v1), arg1));
    }
