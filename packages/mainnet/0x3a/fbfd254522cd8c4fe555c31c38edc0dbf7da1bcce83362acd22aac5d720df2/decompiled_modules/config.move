module 0x353ee6e39e854c2fba0f3085fa613d0a055d754daea67ad799eeb042f48721e5::config {
    ...
    public(friend) fun init_config(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfigMap{
            id                      : 0x2::object::new(arg0),
            power_configs           : 0x2::table::new<0x1::string::String, u64>(arg0),
            burn_configs            : 0x2::table::new<0x1::string::String, u64>(arg0),
            default_power_rate      : 100,
            default_burn_percentage : 20,
            authorized_list         : 0x1::vector::empty<address>(),
        };
        0x2::transfer::share_object<GlobalConfigMap>(v0);
    }
