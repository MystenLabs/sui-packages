module 0x3a42b3c86815ba44d0c4038f0fb60175fae9865cf921abe8c52647cba2152259::gift5739 {
    struct GIFT5739 has drop {
        dummy_field: bool,
    }

    struct TICKET_5739 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5739(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5739>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5739>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5739, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5739>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5739>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5739>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5739>>(v5, 0x2::tx_context::sender(arg1));
    }
