module 0x10282d3d39d47373d69d01c643de30bb186a6f68119fb5793701e41aeaedb09e::game {
    ...
    public entry fun admin_complete_upgrade<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &mut Camp, arg2: &AdminCap, arg3: u8, arg4: &0x2::clock::Clock) {
        assert!((arg3 as u64) < 13, 15);
        assert!(*0x1::vector::borrow<u64>(&arg1.build_timers, (arg3 as u64)) > 0, 6);
        tick<T0, T1>(arg0, arg1, arg4);
        let v0 = *0x1::vector::borrow<u8>(&arg1.buildings, (arg3 as u64)) + 1;
        *0x1::vector::borrow_mut<u8>(&mut arg1.buildings, (arg3 as u64)) = v0;
        *0x1::vector::borrow_mut<u64>(&mut arg1.build_timers, (arg3 as u64)) = 0;
        if (arg3 == 2) {
            let v1 = get_production_power(v0);
            arg1.extractor_power = v1;
            arg0.total_extractor_power = arg0.total_extractor_power - arg1.extractor_power + v1;
        } else if (arg3 == 3) {
            let v2 = get_production_power(v0);
            arg1.drill_power = v2;
            arg0.total_drill_power = arg0.total_drill_power - arg1.drill_power + v2;
        };
        recalc_power(arg1);
        let v3 = BuildCompleted{
            owner       : arg1.owner,
            building_id : arg3,
            new_level   : v0,
        };
        0x2::event::emit<BuildCompleted>(v3);
    }
    ...
    public entry fun start_research<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &mut Camp, arg2: u8, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = *0x1::vector::borrow<u8>(&arg1.buildings, (11 as u64));
        assert!(v0 > 0, 21);
        assert!(arg1.lab.research_type == 255, 29);
        let v1 = *0x1::vector::borrow<u8>(&arg1.lab.research, (arg2 as u64));
        assert!(v1 < 5, 22);
        assert!((v1 as u64) < (((v0 + 1) / 2) as u64), 50);
        let v2 = v1 + 1;
        let (v3, v4, v5, v6) = get_research_cost(v2);
        assert!(arg1.shards >= v4, 7);
        assert!(arg1.crystals >= v5, 7);
        assert!(arg1.cores >= v6, 7);
        let v7 = v3 * arg0.bub_unit;
        assert!(0x2::coin::value<T0>(&arg3) >= v7, 7);
        arg1.shards = arg1.shards - v4;
        arg1.crystals = arg1.crystals - v5;
        arg1.cores = arg1.cores - v6;
        process_bub_payment<T0, T1>(arg3, v7, arg1.owner, arg0, arg5);
        arg1.lab.research_type = arg2;
        arg1.lab.research_done_ms = 0x2::clock::timestamp_ms(arg4) + get_research_time(v2);
    }
