module 0x9c3046b806f4b38f99e0d0419c2bc04eaaa632ca8a2117fc075debb2c5166abd::events {
    ...
    public(friend) fun emit_add_extension_event(arg0: 0x2::object::ID, arg1: 0x1::type_name::TypeName) {
        let v0 = AddExtensionEventV1{
            vault_id  : arg0,
            extension : 0x1::type_name::get_address(&arg1),
        };
    ...
    public(friend) fun emit_allow_deposits_of_type_event<T0, T1>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u64) {
        let v0 = AllowDepositsOfTypeEventV1{
            vault_id               : arg0,
            lp_coin_type           : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
    ...
    public(friend) fun emit_deposit_funds_into_extension_event<T0>(arg0: 0x2::object::ID, arg1: 0x1::type_name::TypeName, arg2: u64) {
    ...
    public(friend) fun emit_withdraw_funds_from_extension_event<T0>(arg0: 0x2::object::ID, arg1: 0x1::type_name::TypeName, arg2: u64) {
