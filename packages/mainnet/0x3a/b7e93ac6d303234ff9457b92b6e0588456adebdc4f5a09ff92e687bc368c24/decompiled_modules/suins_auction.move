module 0x3ab7e93ac6d303234ff9457b92b6e0588456adebdc4f5a09ff92e687bc368c24::suins_auction {
    ...
    public entry fun cancel_auction(arg0: &mut AuctionRegistry, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<AuctionCancelled>(v2);
        ...
        0x2::transfer::public_transfer<0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration>(0x1::option::destroy_some<0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration>(v3), v0);
        destroy_balances(v10, v11);
    }
    ...
    public entry fun claim_domain(arg0: &mut AuctionRegistry, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 && v0.highest_bidder != v0.seller) {
            let v5 = v0.current_bid;
            if (v0.currency_type == 1) {
                let v6 = 0x1::option::borrow_mut<0x2::balance::Balance<0x5145494a5f5100e645e4b0aa950fa6b68f614e8c59e17bc5ded3495123a79178::ns::NS>>(&mut v0.ns_balance);
                transfer_auction_proceeds<0x5145494a5f5100e645e4b0aa950fa6b68f614e8c59e17bc5ded3495123a79178::ns::NS>(v6, v5, v0.seller, arg0.admin_address, arg3);
            } else {
                let v7 = 0x1::option::borrow_mut<0x2::balance::Balance<0x2::sui::SUI>>(&mut v0.sui_balance);
                transfer_auction_proceeds<0x2::sui::SUI>(v7, v5, v0.seller, arg0.admin_address, arg3);
            };
            let v8 = AuctionEnded{
                auction_id    : arg1,
                domain_name   : v4,
        ...
        0x2::transfer::public_transfer<0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration>(0x1::option::destroy_some<0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration>(v11), v1);
        destroy_balances(v18, v19);
    }
    ...
    fun place_bid_internal(arg0: &mut AuctionData, arg1: 0x2::object::ID, arg2: u64, arg3: address, arg4: &0x2::clock::Clock) : (address, u64) {
        ...
        if (arg0.end_time - v0 < 300000) {
            arg0.end_time = v0 + 300000;
        };
    ...
    fun transfer_auction_proceeds<T0>(arg0: &mut 0x2::balance::Balance<T0>, arg1: u64, arg2: address, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = arg1 / 20;
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(arg0, v0, arg4), arg3);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(arg0, arg1 - v0, arg4), arg2);
    }
