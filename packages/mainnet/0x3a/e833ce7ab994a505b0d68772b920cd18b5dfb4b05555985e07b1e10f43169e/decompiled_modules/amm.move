module 0x3ae833ce7ab994a505b0d68772b920cd18b5dfb4b05555985e07b1e10f43169e::amm {
    ...
    public fun add_liquidity<T0, T1>(arg0: &mut Market<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LP<T0, T1>> {
        ...
        let (v6, v7, v8) = if (v2 == 0) {
            v5 = 1000;
            (0x3ae833ce7ab994a505b0d68772b920cd18b5dfb4b05555985e07b1e10f43169e::utils::mulsqrt_u64(v0, v1) - 1000, v0, v1)
        } else {
            let v9 = v0 * v2 / v3;
            let v10 = v1 * v2 / v4;
            if (v9 < v10) {
    ...
    fun calc_trade_sell_pt<T0, T1>(arg0: &Market<T0, T1>, arg1: PreComputeMarket, arg2: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg3: u64) : (u64, u64) {
        ...
        let v7 = 0x3ae833ce7ab994a505b0d68772b920cd18b5dfb4b05555985e07b1e10f43169e::utils::asset_to_sy(((0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::get_raw_value(v6) >> 64) as u64), arg2);
        let v8 = 0x3ae833ce7ab994a505b0d68772b920cd18b5dfb4b05555985e07b1e10f43169e::utils::asset_to_sy(((0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::get_raw_value(v5) >> 64) as u64), arg2);
    ...
    fun pre_compute_value<T0, T1>(arg0: &Market<T0, T1>, arg1: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg2: &0x2::clock::Clock) : PreComputeMarket {
        ...
        let v3 = 0x3ae833ce7ab994a505b0d68772b920cd18b5dfb4b05555985e07b1e10f43169e::utils::sy_to_asset(0x2::balance::value<T1>(&arg0.total_sy), arg1);
        assert!(v2 > 0 && v3 > 0, 5);
        PreComputeMarket{
            rate_scalar : v1,
            total_asset : v3,
    ...
    fun set_initial_ln_implied_rate<T0, T1>(arg0: &mut Market<T0, T1>, arg1: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg2: &0x2::clock::Clock) {
        ...
        let v0 = arg0.expiry - 0x2::clock::timestamp_ms(arg2);
        arg0.last_ln_implied_rate = get_ln_implied_rate(0x2::balance::value<T0>(&arg0.total_pt), 0x3ae833ce7ab994a505b0d68772b920cd18b5dfb4b05555985e07b1e10f43169e::utils::sy_to_asset(0x2::balance::value<T1>(&arg0.total_sy), arg1), get_rate_scalar<T0, T1>(arg0, v0), arg0.initial_anchor, v0);
    }
    ...
    fun set_new_market_market_trade<T0, T1>(arg0: &mut Market<T0, T1>, arg1: PreComputeMarket, arg2: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg3: &0x2::clock::Clock) {
        arg0.last_ln_implied_rate = get_ln_implied_rate(0x2::balance::value<T0>(&arg0.total_pt), 0x3ae833ce7ab994a505b0d68772b920cd18b5dfb4b05555985e07b1e10f43169e::utils::sy_to_asset(0x2::balance::value<T1>(&arg0.total_sy), arg2), arg1.rate_scalar, arg1.rate_anchor, arg0.expiry - 0x2::clock::timestamp_ms(arg3));
