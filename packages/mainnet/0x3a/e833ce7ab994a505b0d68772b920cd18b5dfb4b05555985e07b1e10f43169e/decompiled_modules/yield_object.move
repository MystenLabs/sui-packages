module 0x3ae833ce7ab994a505b0d68772b920cd18b5dfb4b05555985e07b1e10f43169e::yield_object {
    ...
    public fun earn<T0, T1>(arg0: &mut YieldObject<T0, T1>, arg1: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64) {
    ...
    public fun merge<T0, T1>(arg0: &mut YieldObject<T0, T1>, arg1: YieldObject<T0, T1>) {
    ...
    public fun split<T0, T1>(arg0: &mut YieldObject<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : YieldObject<T0, T1> {
