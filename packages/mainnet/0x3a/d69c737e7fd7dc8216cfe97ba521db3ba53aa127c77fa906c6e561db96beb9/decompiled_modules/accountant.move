module 0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::accountant {
    ...
    entry fun migrate_accountant<T0>(arg0: &mut Accountant<T0>, arg1: &0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::Auth<T0>, arg2: &0x2::tx_context::TxContext) {
        assert!(0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::has_cap<T0, 0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg2)), 5);
        arg0.version = 0;
    ...
    public fun pause<T0>(arg0: &mut Accountant<T0>, arg1: &0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::Auth<T0>, arg2: &0x2::tx_context::TxContext) {
        assert!(0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::has_cap<T0, 0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::PauserCap>(arg1, 0x2::tx_context::sender(arg2)), 5);
        arg0.is_paused = true;
    ...
    public fun reset_highwater_mark<T0>(arg0: &mut Accountant<T0>, arg1: &0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::Auth<T0>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 9);
        assert!(0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::has_cap<T0, 0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg3)), 5);
    ...
    public fun unpause<T0>(arg0: &mut Accountant<T0>, arg1: &0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::Auth<T0>, arg2: &0x2::tx_context::TxContext) {
        assert!(0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::has_cap<T0, 0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::PauserCap>(arg1, 0x2::tx_context::sender(arg2)), 5);
    ...
    public fun update_delay<T0>(arg0: &mut Accountant<T0>, arg1: &0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::Auth<T0>, arg2: u64, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun update_exchange_rate<T0>(arg0: &mut Accountant<T0>, arg1: &0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::Auth<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 9);
        assert!(0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::has_cap<T0, 0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::UpdateExchangeRateCap>(arg1, 0x2::tx_context::sender(arg4)), 5);
    ...
    public fun update_lower<T0>(arg0: &mut Accountant<T0>, arg1: &0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::Auth<T0>, arg2: u16, arg3: &0x2::tx_context::TxContext) {
        assert!(arg2 <= 10000, 3);
        assert!(0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::has_cap<T0, 0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg3)), 5);
    ...
    public fun update_payout_address<T0>(arg0: &mut Accountant<T0>, arg1: &0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::Auth<T0>, arg2: address, arg3: &0x2::tx_context::TxContext) {
        assert!(0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::has_cap<T0, 0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg3)), 5);
    ...
    public fun update_performance_fee<T0>(arg0: &mut Accountant<T0>, arg1: &0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::Auth<T0>, arg2: u16, arg3: &0x2::tx_context::TxContext) {
        assert!(arg2 <= 5000, 2);
        assert!(0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::has_cap<T0, 0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg3)), 5);
    ...
    public fun update_platform_fee<T0>(arg0: &mut Accountant<T0>, arg1: &0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::Auth<T0>, arg2: u16, arg3: &0x2::tx_context::TxContext) {
        assert!(arg2 <= 2000, 1);
        assert!(0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::has_cap<T0, 0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg3)), 5);
    ...
    public fun update_upper<T0>(arg0: &mut Accountant<T0>, arg1: &0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::Auth<T0>, arg2: u16, arg3: &0x2::tx_context::TxContext) {
        assert!(arg2 >= 10000, 4);
        assert!(0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::has_cap<T0, 0x3ad69c737e7fd7dc8216cfe97ba521db3ba53aa127c77fa906c6e561db96beb9::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg3)), 5);
