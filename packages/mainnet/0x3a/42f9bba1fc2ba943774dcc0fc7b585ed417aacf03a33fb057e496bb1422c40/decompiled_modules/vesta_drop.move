module 0x8f8a836023ec92ed568eeeed5f7f956db064ebebafaf06a3ef03db2b2fcba77d::vesta_drop {
    ...
    struct VestaDrop<phantom T0> has key {
        ...
        total_amount: u64,
        claimed_amount: u64,
        drop_fund: 0x2::balance::Balance<T0>,
    ...
    public fun allocate<T0>(arg0: &AdminCap, arg1: &mut VestaDrop<T0>, arg2: address, arg3: u64) {
        assert!(arg0.vesta_drop == 0x2::object::id<VestaDrop<T0>>(arg1), 5);
        if (0x2::table::contains<address, AirdropInfo>(&arg1.claims, arg2)) {
            0x2::table::borrow_mut<address, AirdropInfo>(&mut arg1.claims, arg2).amount = arg3;
            return
        };
        let v0 = AirdropInfo{
            amount  : arg3,
        ...
        let v1 = AllocateEvent{
            vesta_drop_id : 0x2::object::id<VestaDrop<T0>>(arg1),
            recipient     : arg2,
            amount        : arg3,
        };
        0x2::event::emit<AllocateEvent>(v1);
    }

    public fun claim<T0>(arg0: &mut VestaDrop<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<address, AirdropInfo>(&arg0.claims, 0x2::tx_context::sender(arg1)), 2);
        let v0 = 0x2::table::borrow_mut<address, AirdropInfo>(&mut arg0.claims, 0x2::tx_context::sender(arg1));
        assert!(!v0.claimed, 3);
        v0.claimed = true;
        assert!(0x2::balance::value<T0>(&arg0.drop_fund) >= v0.amount, 4);
        let v1 = v0.amount;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.drop_fund, v1), arg1), 0x2::tx_context::sender(arg1));
    }

    public fun create<T0>(arg0: u64, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg1) / 1000 < arg0, 1);
        let v0 = VestaDrop<T0>{
            id             : 0x2::object::new(arg2),
            start_time     : arg0,
            total_amount   : 0,
            claimed_amount : 0,
            drop_fund      : 0x2::balance::zero<T0>(),
    ...
    public fun deposit<T0>(arg0: &mut VestaDrop<T0>, arg1: &mut 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::balance::join<T0>(&mut arg0.drop_fund, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg1, arg2, arg3)));
        let v0 = DepositEvent{
            vesta_drop_id : 0x2::object::id<VestaDrop<T0>>(arg0),
            amount        : arg2,
        };
    ...
    public fun update_start_time<T0>(arg0: &AdminCap, arg1: &mut VestaDrop<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(0x2::clock::timestamp_ms(arg3) / 1000 < arg2, 1);
        assert!(arg0.vesta_drop == 0x2::object::id<VestaDrop<T0>>(arg1), 5);
