module 0x3ae1eeb393235ba49bcbad64b4c4ba9081af80b8fc46dea7d7ba75f21cf48805::cnsnft2515 {
    struct CNSNFT2515 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2515, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2515>(arg0, arg1);
