module 0x3a707cec55da6bcfa29cdfc972858c2beb5d37c437596df82276701ad9cb9cf7::cnsnft5257 {
    struct CNSNFT5257 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5257, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8102"));
        let v4 = 0x2::package::claim<CNSNFT5257>(arg0, arg1);
