module 0x3ac5d05edffefeaa7387c234de3a9f25a3a72f6d96b5efb560d81df77899cf74::sip {
    struct SIP has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SIP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<SIP>(&mut v2, 100000000000000000, 0x2::tx_context::sender(arg1), arg1);
