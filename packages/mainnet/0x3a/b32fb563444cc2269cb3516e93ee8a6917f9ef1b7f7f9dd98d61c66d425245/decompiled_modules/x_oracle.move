module 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::x_oracle {
    ...
    fun new(arg0: &mut 0x2::tx_context::TxContext) : XOracle {
        ...
        0x2::dynamic_field::add<PythPriceFeedKey, 0x2::table::Table<0x1::type_name::TypeName, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::pyth_adaptor::PythFeedData>>(&mut v0.id, v1, 0x2::table::new<0x1::type_name::TypeName, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::pyth_adaptor::PythFeedData>(arg0));
        v0
    }

    public fun base_token_from_u8(arg0: u8) : BaseToken {
        let v0 = 0;
        assert!(&arg0 == &v0, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::oracle_error::unknown_oracle_base_token());
        usd()
    }

    public(friend) fun ensure_version_matches(arg0: &XOracle) {
        assert!(arg0.version == 0, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::oracle_error::version_not_match());
    }
    ...
    public fun price(arg0: &XOracle, arg1: 0x1::type_name::TypeName, arg2: BaseToken) : &0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::price_feed::PriceFeed {
        ...
        let v1 = 0;
        assert!(&v0 == &v1, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::oracle_error::unknown_oracle_base_token());
        usd_price(arg0, arg1)
    }
    ...
    public(friend) fun pyth_price_feeds(arg0: &XOracle) : &0x2::table::Table<0x1::type_name::TypeName, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::pyth_adaptor::PythFeedData> {
        let v0 = PythPriceFeedKey{dummy_field: false};
        0x2::dynamic_field::borrow<PythPriceFeedKey, 0x2::table::Table<0x1::type_name::TypeName, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::pyth_adaptor::PythFeedData>>(&arg0.id, v0)
    }

    public(friend) fun pyth_price_feeds_mut(arg0: &mut XOracle) : &mut 0x2::table::Table<0x1::type_name::TypeName, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::pyth_adaptor::PythFeedData> {
        let v0 = PythPriceFeedKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<PythPriceFeedKey, 0x2::table::Table<0x1::type_name::TypeName, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::pyth_adaptor::PythFeedData>>(&mut arg0.id, v0)
    }
    ...
    public(friend) fun refresh_usd_price<T0>(arg0: &mut XOracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) {
        ...
        let v1 = 0x2::table::borrow<0x1::type_name::TypeName, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::pyth_adaptor::PythFeedData>(pyth_price_feeds(arg0), v0);
        0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::pyth_adaptor::assert_pyth_price_info_object(v1, arg1);
        let (v2, v3) = 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::pyth_adaptor::get_pyth_price(arg1, v1, arg2);
    ...
    fun update_price_feed(arg0: &mut XOracle, arg1: BaseToken, arg2: 0x1::type_name::TypeName, arg3: 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::price_feed::PriceFeedComponent, arg4: 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::price_feed::PriceFeedComponent) {
    ...
    fun usd_price(arg0: &XOracle, arg1: 0x1::type_name::TypeName) : &0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::price_feed::PriceFeed {
        let v0 = 0x2::table::borrow<BaseToken, 0x2::table::Table<0x1::type_name::TypeName, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::price_feed::PriceFeed>>(&arg0.prices, usd());
        assert!(0x2::table::contains<0x1::type_name::TypeName, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::price_feed::PriceFeed>(v0, arg1), 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::oracle_error::oracle_price_not_found_error());
        0x2::table::borrow<0x1::type_name::TypeName, 0x3ab32fb563444cc2269cb3516e93ee8a6917f9ef1b7f7f9dd98d61c66d425245::price_feed::PriceFeed>(v0, arg1)
    }
