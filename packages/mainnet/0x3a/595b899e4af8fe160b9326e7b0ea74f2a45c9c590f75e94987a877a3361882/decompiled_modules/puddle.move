module 0x3a595b899e4af8fe160b9326e7b0ea74f2a45c9c590f75e94987a877a3361882::puddle {
    ...
    public entry fun arbitrage<T0: drop, T1: drop>(arg0: &mut PuddleCap<T1>, arg1: &mut Puddles<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x3a595b899e4af8fe160b9326e7b0ea74f2a45c9c590f75e94987a877a3361882::admin::TeamFunds, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x3a595b899e4af8fe160b9326e7b0ea74f2a45c9c590f75e94987a877a3361882::cetus_invest::arbitrage<T0, T1>(arg2, arg3, v1, arg4, arg5, arg6);
        ...
        if (v3 < 0x2::balance::value<T1>(&v2)) {
            ...
            0x3a595b899e4af8fe160b9326e7b0ea74f2a45c9c590f75e94987a877a3361882::admin::deposit<T1>(0x2::balance::split<T1>(&mut v2, v4 * 5 / 1000), arg7, arg8);
    ...
    public entry fun invest<T0: drop, T1: drop>(arg0: &mut PuddleCap<T1>, arg1: &mut Puddles<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::vector::contains<0x2::object::ID>(&arg1.investments.invests, &v0)) {
            ...
            0x2::balance::join<T0>(0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balance_bag, v0), 0x3a595b899e4af8fe160b9326e7b0ea74f2a45c9c590f75e94987a877a3361882::cetus_invest::invest<T0, T1>(arg2, arg3, &mut arg1.balance, arg4, arg5, arg6));
            ...
            0x2::bag::add<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balance_bag, v0, 0x3a595b899e4af8fe160b9326e7b0ea74f2a45c9c590f75e94987a877a3361882::cetus_invest::invest<T0, T1>(arg2, arg3, &mut arg1.balance, arg4, arg5, arg6));
            0x1::debug::print<0x2::balance::Balance<T0>>(0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balance_bag, v0));
        };
    }
