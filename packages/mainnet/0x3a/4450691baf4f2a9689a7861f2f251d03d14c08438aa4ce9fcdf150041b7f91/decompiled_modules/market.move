module 0x3a4450691baf4f2a9689a7861f2f251d03d14c08438aa4ce9fcdf150041b7f91::market {
    ...
    public entry fun new(arg0: &0x2::package::Publisher, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0);
        let v0 = Market{
    ...
    public entry fun withdraw(arg0: &mut Market, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg1);
        0x3a4450691baf4f2a9689a7861f2f251d03d14c08438aa4ce9fcdf150041b7f91::utils::withdraw_balance<0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN>(&mut arg0.balance, arg2);
    }
