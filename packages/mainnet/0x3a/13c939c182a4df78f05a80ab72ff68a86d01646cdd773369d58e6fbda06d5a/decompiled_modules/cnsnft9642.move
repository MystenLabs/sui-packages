module 0x3a13c939c182a4df78f05a80ab72ff68a86d01646cdd773369d58e6fbda06d5a::cnsnft9642 {
    struct CNSNFT9642 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9642, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9642>(arg0, arg1);
