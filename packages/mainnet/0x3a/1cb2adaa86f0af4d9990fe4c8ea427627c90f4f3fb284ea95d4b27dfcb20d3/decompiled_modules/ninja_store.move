module 0x3a1cb2adaa86f0af4d9990fe4c8ea427627c90f4f3fb284ea95d4b27dfcb20d3::ninja_store {
    ...
    public entry fun OfferSwap<T0: store + key>(arg0: T0, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<T0>(&arg0);
        let v1 = get_type_name<T0>();
        0x1::string::utf8(b"0x55567541b0f8c1d68e33e03ddcdfd248adb7f43f9660d6f765b7088c87ac8b6d::ninja_store::Paper");
        let v2 = NFTTypeInfo{type_name: v1};
        let v3 = NFTTypeInfo{type_name: v1};
        let v4 = SwapListing{
