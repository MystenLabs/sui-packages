module 0x3a07fa9f8ac77345ca82466c998e24c12e09085ee2ce293c724e8549039e0c72::heythere {
    struct HEYTHERE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: HEYTHERE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<HEYTHERE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Heythere"));
