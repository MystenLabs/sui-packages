module 0x3a93f15c9822353647c311746640b4f231ad8c11c217ad77f4e831602e51419d::drop {
    ...
    fun init(arg0: DROP, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DROP>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"drop"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"test"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://o0zxHolaArJC4OqQtdQDBSfh5hgHv0KEYmzA6_9rZ4k"));
