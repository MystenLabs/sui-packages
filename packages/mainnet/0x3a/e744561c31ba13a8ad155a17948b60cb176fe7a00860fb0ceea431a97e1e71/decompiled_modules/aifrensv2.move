module 0xab921033291295781460a1355aada697847a6920bd7893917d855240b9c08ab8::aifrensv2 {
    ...
    public entry fun beta_claim(arg0: &mut BetaPool, arg1: &0x2::clock::Clock, arg2: &0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::AifrensGenesis, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        0xab921033291295781460a1355aada697847a6920bd7893917d855240b9c08ab8::eventv2::airdrop_event(v1, v2);
        v2
    }

    fun calc_claim_after_4_days(arg0: u64, arg1: u64, arg2: u64) : u64 {
        let v0 = if (arg1 + 3 * 86400000 < arg2) {
            0xab921033291295781460a1355aada697847a6920bd7893917d855240b9c08ab8::mathv2::mul_div(arg0, 95, 100)
        } else {
            arg0
        };
        let v1 = if (arg1 + 4 * 86400000 < arg2) {
            0xab921033291295781460a1355aada697847a6920bd7893917d855240b9c08ab8::mathv2::mul_div(v0, 94, 100)
        } else {
            v0
        };
        let v2 = if (arg1 + 5 * 86400000 < arg2) {
            0xab921033291295781460a1355aada697847a6920bd7893917d855240b9c08ab8::mathv2::mul_div(v1, 93, 100)
        } else {
            v1
        };
        if (arg1 + 6 * 86400000 < arg2) {
            0xab921033291295781460a1355aada697847a6920bd7893917d855240b9c08ab8::mathv2::mul_div(v2, 92, 100)
        } else {
            v2
        }
    }
    ...
    public fun can_claim_amount(arg0: &AifrensPool, arg1: &0x2::clock::Clock, arg2: address) : u64 {
        ...
        if (v0 >= arg0.max_addresses) {
            ...
            while (v3 < 0xab921033291295781460a1355aada697847a6920bd7893917d855240b9c08ab8::mathv2::mul_div(v0 + 1, 100 * 1000000000000, arg0.max_addresses)) {
                let v4 = v2 * 80;
                v2 = v4 / 100;
    ...
    fun claim_internal(arg0: &mut AifrensPool, arg1: &0x2::clock::Clock, arg2: vector<vector<u8>>, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(v0 < arg0.expired_at_ms, 6);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(0xab921033291295781460a1355aada697847a6920bd7893917d855240b9c08ab8::merkle_treev2::verify_calldata(arg2, arg0.root_proof, 0x1::bcs::to_bytes<address>(&v1)), 3);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = AifrensPool{
            ...
            airdrop_balance : 0x2::balance::zero<0x361fcb86803eea2403007250638f3c8427249168ac77fee74b7129bdc05b2586::aifrens::AIFRENS>(),
        };
        0x2::transfer::share_object<AifrensPool>(v0);
        let v1 = AifrensPool{
            id              : 0x2::object::new(arg0),
        ...
        0x2::transfer::share_object<AifrensPool>(v1);
        let v2 = BetaPool{
            id              : 0x2::object::new(arg0),
            ...
            claimed         : 0x2::table::new<0x2::object::ID, u64>(arg0),
            claimed_supply  : 0,
            airdrop_balance : 0x2::balance::zero<0x361fcb86803eea2403007250638f3c8427249168ac77fee74b7129bdc05b2586::aifrens::AIFRENS>(),
        };
        0x2::transfer::share_object<BetaPool>(v2);
    }
    ...
    public fun transfer_beta_pool(arg0: &0x2::coin::TreasuryCap<0x361fcb86803eea2403007250638f3c8427249168ac77fee74b7129bdc05b2586::aifrens::AIFRENS>, arg1: &mut 0x361fcb86803eea2403007250638f3c8427249168ac77fee74b7129bdc05b2586::aifrens::BetaPool, arg2: &mut BetaPool, arg3: u64) {
        ...
        while (v1 < 0x1::vector::length<0x2::object::ID>(&v0)) {
            ...
            if (!0x2::table::contains<0x2::object::ID, u64>(&arg2.claimed, *v2)) {
                0x2::table::add<0x2::object::ID, u64>(&mut arg2.claimed, *v2, 1);
                continue
            };
        };
    }
    ...
    public fun transfer_suifrens_pool(arg0: &0x2::coin::TreasuryCap<0x361fcb86803eea2403007250638f3c8427249168ac77fee74b7129bdc05b2586::aifrens::AIFRENS>, arg1: &mut 0x361fcb86803eea2403007250638f3c8427249168ac77fee74b7129bdc05b2586::aifrens::AifrensPool, arg2: &mut AifrensPool, arg3: u64) {
        ...
        while (v1 < 0x1::vector::length<address>(&v0)) {
            ...
            if (!0x2::table::contains<address, u64>(&arg2.claimed, *v2)) {
                0x2::table::add<address, u64>(&mut arg2.claimed, *v2, 1);
                continue
            };
        };
    }
