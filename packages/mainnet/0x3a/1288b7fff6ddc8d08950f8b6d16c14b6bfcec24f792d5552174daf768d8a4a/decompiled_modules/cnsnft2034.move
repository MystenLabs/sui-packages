module 0x3a1288b7fff6ddc8d08950f8b6d16c14b6bfcec24f792d5552174daf768d8a4a::cnsnft2034 {
    struct CNSNFT2034 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2034, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2034>(arg0, arg1);
