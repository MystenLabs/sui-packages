module 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::i0 {
    fun calc_ix<T0>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: u64) : 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::i128::I128 {
    ...
    fun calc_ixr<T0>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: u64) : 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::i128::I128 {
    ...
    fun ixp_internal<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &mut 0x5c45d10c26c5fb53bfaff819666da6bc7053d2190dfa29fec311cc666ff1f4b0::core::DEXStorage, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::i128::gt(v4, 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::i128::zero())) {
            ...
            while (v5 < 10 && !0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_has_converged(&v3)) {
                let v6 = calc_ix<T0>(arg1, v0, v1, 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_next_step_prep_u(&mut v3));
                0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_next_step_complete(&mut v3, v6);
                v5 = v5 + 1;
            };
            let (v7, _) = 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_result(&v3);
            ix_internal<T0>(arg0, arg1, arg2, arg3, v7, arg10);
            return
        };
        let v9 = 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::new_f_max(arg7, arg8, 1000000, arg9);
        ...
        0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_init(&mut v9, arg7, v10);
        let v11 = 0;
        while (v11 < 10 && !0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_has_converged(&v9)) {
            let v12 = calc_ixr<T0>(arg1, v0, v1, 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_next_step_prep_u(&mut v9));
            0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_next_step_complete(&mut v9, v12);
            v11 = v11 + 1;
        };
        let (v13, _) = 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_result(&v9);
