module 0x3ad00d82541cfd1fd13568f24b43bf9e36718611533a4853e722438b90ea61f3::cdpm {
    ...
    public fun user_close_pm<T0, T1>(arg0: &mut Record, arg1: PositionManager, arg2: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg3: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg4: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = v6;
        if (0x1::option::is_some<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&v10)) {
            let (v11, v12, v13) = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::close_position<T0, T1>(arg2, 0x1::option::destroy_some<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(v10), arg3, arg4, arg5, arg6);
            0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::destroy_close_position_cert(v11, arg4);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v12, arg6), 0x2::tx_context::sender(arg6));
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v13, arg6), 0x2::tx_context::sender(arg6));
        } else {
            0x1::option::destroy_none<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(v10);
        };
        0x2::bag::destroy_empty(v7);
        0x2::bag::destroy_empty(v8);
        0x2::bag::destroy_empty(v9);
        0x2::object::delete(v3);
        let v14 = PositionManagerClosed{
            pm_id : v0,
            owner : v4,
        };
        0x2::event::emit<PositionManagerClosed>(v14);
    }
