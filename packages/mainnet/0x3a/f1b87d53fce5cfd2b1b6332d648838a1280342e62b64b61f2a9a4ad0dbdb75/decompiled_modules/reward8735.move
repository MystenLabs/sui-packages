module 0x3af1b87d53fce5cfd2b1b6332d648838a1280342e62b64b61f2a9a4ad0dbdb75::reward8735 {
    struct REWARD8735 has drop {
        dummy_field: bool,
    }

    struct TICKET_8735 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8735(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8735>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8735>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8735, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8735>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8735>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8735>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8735>>(v5, 0x2::tx_context::sender(arg1));
    }
