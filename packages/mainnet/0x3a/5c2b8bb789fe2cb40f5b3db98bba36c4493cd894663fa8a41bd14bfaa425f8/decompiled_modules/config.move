module 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config {
    ...
    fun apply_fee_split(arg0: &mut Config, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events::fee_split_changed(arg1, arg2, arg3, 0x2::clock::timestamp_ms(arg4));
    }
    ...
    fun burned(arg0: &mut Config, arg1: 0x2::object::UID, arg2: vector<u8>, arg3: &0x2::clock::Clock) {
        ...
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events::role_revoked(0x1::ascii::string(arg2), v0, false, 0x2::clock::timestamp_ms(arg3));
    }
    ...
    fun grant(arg0: &mut Config, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: address, arg4: &0x2::clock::Clock) {
        ...
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events::role_granted(v0, arg1, arg3, 0x2::clock::timestamp_ms(arg4));
    }
    ...
    public fun mint_migration_cap(arg0: &AdminCap, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events::role_granted(0x1::ascii::string(b"migrator"), 0x2::object::uid_to_inner(&v0.id), arg1, 0x2::clock::timestamp_ms(arg2));
    ...
    public fun revoke_migration_cap(arg0: MigrationCap, arg1: &0x2::clock::Clock) {
        ...
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events::role_revoked(0x1::ascii::string(b"migrator"), 0x2::object::uid_to_inner(&v0), false, 0x2::clock::timestamp_ms(arg1));
    }
    ...
    public fun revoke_role(arg0: &AdminCap, arg1: &mut Config, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) {
        ...
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events::role_revoked(v1, arg2, true, 0x2::clock::timestamp_ms(arg3));
    }
