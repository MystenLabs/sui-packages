module 0x3a2497bd58bb858f1bd722ba20a649231ffddd6157e68f9aa9a4a16a30ee11b1::reward2736 {
    struct REWARD2736 has drop {
        dummy_field: bool,
    }

    struct TICKET_2736 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2736(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2736>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2736>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2736, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2736>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2736>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2736>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2736>>(v5, 0x2::tx_context::sender(arg1));
    }
