module 0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::deepbook {
    ...
    public fun claim_referral_fees<T0>(arg0: &0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::config::AdminCap, arg1: &DeepBookPool<T0>, arg2: &mut 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::MarginPool<T0>, arg3: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry::MarginRegistry, arg4: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::protocol_fees::SupplyReferral, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::events::emit_referral_fees_collected(0x1::string::utf8(b"deepbook"), 0x2::object::id<DeepBookPool<T0>>(arg1), 0x2::coin::value<T0>(&v0), 0x2::clock::timestamp_ms(arg5));
        v0
    }
    ...
    public fun create_pool<T0>(arg0: &0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::config::AdminCap, arg1: &0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::config::Config, arg2: &mut 0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::pool_registry::PoolRegistry, arg3: &mut 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::MarginPool<T0>, arg4: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry::MarginRegistry, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::pool_registry::register_pool<T0>(arg0, arg2, 0x1::string::utf8(b"deepbook"), 0x1::option::some<0x1::string::String>(id_to_string(&v1)));
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::events::emit_pool_created(0x1::string::utf8(b"deepbook"), 0x1::option::some<0x1::string::String>(id_to_string(&v1)), 0x1::type_name::with_defining_ids<T0>());
        0x2::transfer::share_object<DeepBookPool<T0>>(v0);
    }

    public fun create_position<T0>(arg0: &mut 0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::position_registry::PositionRegistry, arg1: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::MarginPool<T0>, arg2: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry::MarginRegistry, arg3: &DeepBookPool<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : DeepBookPosition {
        ...
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::events::emit_position_created(0x1::string::utf8(b"deepbook"), 0x2::object::id<DeepBookPosition>(&v1), 0x2::object::id<DeepBookPosition>(&v1), v0);
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::position_registry::register_position(arg0, 0x1::string::utf8(b"deepbook"), v0, 0x2::object::id<DeepBookPosition>(&v1));
        v1
    }

    public fun deposit<T0>(arg0: &0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::config::Config, arg1: &0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::pool_registry::PoolRegistry, arg2: &mut DeepBookPool<T0>, arg3: &mut 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::MarginPool<T0>, arg4: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry::MarginRegistry, arg5: &mut DeepBookPosition, arg6: 0x2::coin::Coin<T0>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::config::assert_not_paused(arg0);
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::config::assert_version(arg0);
        let v0 = 0x2::object::id<DeepBookPool<T0>>(arg2);
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::pool_registry::assert_pool_enabled<T0>(arg1, 0x1::string::utf8(b"deepbook"), 0x1::option::some<0x1::string::String>(id_to_string(&v0)));
        ...
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::events::emit_deposited(0x1::string::utf8(b"deepbook"), 0x1::option::some<0x1::string::String>(id_to_string(&v0)), v2, v1, 0x2::clock::timestamp_ms(arg7));
    }
    ...
    public fun withdraw<T0>(arg0: &mut 0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::config::Config, arg1: &0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::pool_registry::PoolRegistry, arg2: &mut DeepBookPool<T0>, arg3: &mut 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::MarginPool<T0>, arg4: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry::MarginRegistry, arg5: &mut DeepBookPosition, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::config::assert_not_paused(arg0);
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::config::assert_version(arg0);
        let v0 = 0x2::object::id<DeepBookPool<T0>>(arg2);
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::pool_registry::assert_pool_enabled<T0>(arg1, 0x1::string::utf8(b"deepbook"), 0x1::option::some<0x1::string::String>(id_to_string(&v0)));
        ...
        let v7 = 0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::config::deduct_fee_on_yield<T0>(arg0, 0x2::coin::balance_mut<T0>(&mut v4), v6);
        let v8 = arg6 - v7;
        assert!(v8 >= arg7, 5);
        *v2 = *v2 - v3;
        if (*v2 == 0) {
        ...
        if (v7 > 0) {
            0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::events::emit_protocol_fees_collected(0x1::string::utf8(b"deepbook"), 0x2::object::id<DeepBookPool<T0>>(arg2), v7, 0x2::clock::timestamp_ms(arg8));
        };
        0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::events::emit_withdrawn(0x1::string::utf8(b"deepbook"), 0x1::option::some<0x1::string::String>(id_to_string(&v0)), 0x2::tx_context::sender(arg9), v8, v7, 0x2::clock::timestamp_ms(arg8));
        v4
    }
