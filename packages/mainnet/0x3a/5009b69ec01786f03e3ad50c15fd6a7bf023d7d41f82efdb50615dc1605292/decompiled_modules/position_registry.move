module 0x3a5009b69ec01786f03e3ad50c15fd6a7bf023d7d41f82efdb50615dc1605292::position_registry {
    ...
    public(friend) fun register_position(arg0: &mut PositionRegistry, arg1: 0x1::string::String, arg2: address, arg3: 0x2::object::ID) {
        let v0 = PositionKey{
            protocol : arg1,
            owner    : arg2,
        };
