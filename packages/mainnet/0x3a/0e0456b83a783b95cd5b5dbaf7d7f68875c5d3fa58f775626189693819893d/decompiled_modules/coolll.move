module 0x3a0e0456b83a783b95cd5b5dbaf7d7f68875c5d3fa58f775626189693819893d::coolll {
    struct COOLLL has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: COOLLL, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<COOLLL>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"COOLLL"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"COOL NFTS"));
