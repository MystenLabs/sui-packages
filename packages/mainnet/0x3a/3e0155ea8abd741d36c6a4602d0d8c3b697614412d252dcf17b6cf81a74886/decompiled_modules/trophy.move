module 0x3a3e0155ea8abd741d36c6a4602d0d8c3b697614412d252dcf17b6cf81a74886::trophy {
    ...
    fun init(arg0: TROPHY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = &mut v5;
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(x"7b77696e655f7469746c657d20e28094204c6f74207b646973706c61795f6c6f747d"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Treasure secured on VinoBid HK"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"{image_url}"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"{metadata_url}"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"https://vino-bid.com"));
        let v7 = 0x2::display::new_with_fields<WinnerTrophy>(&v0, v3, v5, arg1);
        0x2::display::update_version<WinnerTrophy>(&mut v7);
        0x2::transfer::public_transfer<0x2::display::Display<WinnerTrophy>>(v7, 0x2::tx_context::sender(arg1));
    ...
    public fun mint_and_transfer(arg0: &MintCap, arg1: &mut Registry, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = TrophyMinted{
            sale_id   : v0.sale_id,
            trophy_id : 0x2::object::id<WinnerTrophy>(&v0),
            recipient : arg8,
        };
        0x2::event::emit<TrophyMinted>(v1);
        0x2::transfer::public_transfer<WinnerTrophy>(v0, arg8);
    }
