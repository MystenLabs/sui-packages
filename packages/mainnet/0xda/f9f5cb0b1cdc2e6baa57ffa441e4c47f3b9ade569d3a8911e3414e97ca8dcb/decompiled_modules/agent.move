module 0xdaf9f5cb0b1cdc2e6baa57ffa441e4c47f3b9ade569d3a8911e3414e97ca8dcb::agent {
    ...
    fun init(arg0: AGENT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGENT>(arg0, 9, b"GAI", b"Generative AI", b"We sent an AI agent to read the entire internet. Every release, every hot take, and every unreadable blog post from the past week. It's now standing by to build a presidential brief just for you.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/bafybeifvsqktih4jc4vdba3xqksj6lwf55qb2fgauh3gtoiybgxmgu3e34")), arg1);
