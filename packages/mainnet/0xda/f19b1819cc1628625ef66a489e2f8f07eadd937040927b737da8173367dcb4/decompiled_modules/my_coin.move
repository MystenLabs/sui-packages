module 0xdaf19b1819cc1628625ef66a489e2f8f07eadd937040927b737da8173367dcb4::my_coin {
    ...
    fun init(arg0: MY_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<MY_COIN>(arg0, 8, b"DRACULABO_COIN", b"draculabo coin", b"move coin", 0x1::option::none<0x2::url::Url>(), arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<MY_COIN>>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::coin::DenyCap<MY_COIN>>(v1, 0x2::tx_context::sender(arg1));
