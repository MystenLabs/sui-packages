module 0xda8ce0bb35bdbe14feb919d4572c0bd16ee6568a18b4237d6ad9204d86812f54::pepius {
    ...
    fun init(arg0: PEPIUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/DikthgsBpNgZ1VYh9d4cHPDC3qoVEuhf1Hw7Hug6pump.png?size=lg&key=7cba8f                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<PEPIUS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PEPIUS    ")))), trim_right(b"PEPIUS MAXIMUS                  "), trim_right(b"PEPIUS MAXIMUS                                                                                                                                                                                                                                                                                                                  "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
