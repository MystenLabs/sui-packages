module 0xb3464fbc74ac419954f968ff19e17bd3684e459d8db38cdcaa1a7ac8f812ede3::launchpad {
    ...
    public entry fun claim<T0, T1>(arg0: &mut LaunchInfo<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0xb3464fbc74ac419954f968ff19e17bd3684e459d8db38cdcaa1a7ac8f812ede3::math_extend::mul_div(arg0.claim_amount_per_coin_uint, v1.paid_amount, arg0.pay_coin_unit);
        assert!(v2 > 0, 1005);
