module 0xdaedaed7836af19cc0e8e23e6ca73cb8f4562a9772769251f6f9b3e1c04d84f4::cnsnft1630 {
    struct CNSNFT1630 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1630, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2096"));
        let v4 = 0x2::package::claim<CNSNFT1630>(arg0, arg1);
