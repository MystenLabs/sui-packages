module 0xda319f0491740046e788df1fb9ccc57620cca098cca9461b390724f649e4c84c::cnsnft7348 {
    struct CNSNFT7348 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7348, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4698"));
        let v4 = 0x2::package::claim<CNSNFT7348>(arg0, arg1);
