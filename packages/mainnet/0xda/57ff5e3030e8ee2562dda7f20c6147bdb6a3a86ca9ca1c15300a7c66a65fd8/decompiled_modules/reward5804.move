module 0xda57ff5e3030e8ee2562dda7f20c6147bdb6a3a86ca9ca1c15300a7c66a65fd8::reward5804 {
    struct REWARD5804 has drop {
        dummy_field: bool,
    }

    struct TICKET_5804 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5804(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5804>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5804>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5804, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5804>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5804>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5804>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5804>>(v5, 0x2::tx_context::sender(arg1));
    }
