module 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey {
    ...
    public fun get_total_honey_Supply() : u64 {
        0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::total_honey_supply()
    }
    ...
    public fun set_rules<T0>(arg0: &mut 0x2::token::TokenPolicy<T0>, arg1: &0x2::token::TokenPolicyCap<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::honey_burn_pct();
