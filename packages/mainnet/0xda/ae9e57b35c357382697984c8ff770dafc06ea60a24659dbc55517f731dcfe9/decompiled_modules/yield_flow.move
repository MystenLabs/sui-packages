module 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::yield_flow {
    struct YieldFlow has key {
        ...
        honey_to_burn: 0x2::balance::Balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>,
    ...
    struct PoolFlow has store {
        hive_balance: 0x2::balance::Balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::hive::HIVE>,
        honey_balance: 0x2::balance::Balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>,
    ...
    public fun add_balance_to_pool_flow(arg0: &mut YieldFlow, arg1: address, arg2: 0x2::balance::Balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::hive::HIVE>, arg3: 0x2::balance::Balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>) {
        let v0 = 0x2::linked_table::borrow_mut<address, PoolFlow>(&mut arg0.fee_from_pools, arg1);
        0x2::balance::join<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::hive::HIVE>(&mut v0.hive_balance, arg2);
        0x2::balance::join<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>(&mut v0.honey_balance, arg3);
    }
    ...
    public fun add_new_threepool_flow(arg0: &mut YieldFlow, arg1: &ThreeAmmFlowAccess, arg2: address) {
        ...
        let v0 = PoolFlow{
            hive_balance       : 0x2::balance::zero<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::hive::HIVE>(),
            honey_balance      : 0x2::balance::zero<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>(),
    ...
    public fun claim_fees_from_pool_flow(arg0: &mut YieldFlow, arg1: &DragonFoodCapability, arg2: address, arg3: &0x2::tx_context::TxContext) : (0x2::balance::Balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::hive::HIVE>, 0x2::balance::Balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>) {
        ...
        (0x2::balance::withdraw_all<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::hive::HIVE>(&mut v1.hive_balance), 0x2::balance::withdraw_all<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>(&mut v1.honey_balance))
    }
    ...
    public fun deposit_honey_to_burn(arg0: &mut YieldFlow, arg1: 0x2::balance::Balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>) {
        0x2::balance::join<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>(&mut arg0.honey_to_burn, arg1);
    }
    ...
    public fun get_all_pool_flow_balances(arg0: &YieldFlow, arg1: 0x1::option::Option<address>, arg2: u64) : (vector<address>, vector<u64>, vector<u64>) {
        ...
        while (0x1::option::is_some<address>(&v4) && v5 < arg2) {
            ...
            0x1::vector::push_back<u64>(&mut v1, 0x2::balance::value<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::hive::HIVE>(&v7.hive_balance));
            0x1::vector::push_back<u64>(&mut v2, 0x2::balance::value<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>(&v7.honey_balance));
    ...
    public fun get_fee_available_for_pool(arg0: &YieldFlow, arg1: address) : (u64, u64) {
        ...
        (0x2::balance::value<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::hive::HIVE>(&v0.hive_balance), 0x2::balance::value<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>(&v0.honey_balance))
    }
    ...
    public entry fun get_fee_info<T0>(arg0: &YieldFlow) : (u64, u64) {
        if (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::curves::is_stable<T0>()) {
            return (arg0.pool_fee_config.stable_pool_fee.total_fee_bps, arg0.pool_fee_config.stable_pool_fee.bees_fee_pct)
        };
        if (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::curves::is_weighted<T0>()) {
            return (arg0.pool_fee_config.weighted_pool_fee.total_fee_bps, arg0.pool_fee_config.weighted_pool_fee.bees_fee_pct)
        };
        if (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::curves::is_curved<T0>()) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v14 = FeeInfo{
            total_fee_bps : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::weighted_total_fee_bps(),
            bees_fee_pct  : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::weighted_bees_fee_pct(),
        };
        let v15 = FeeInfo{
            total_fee_bps : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::stable_total_fee_bps(),
            bees_fee_pct  : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::stable_bees_fee_pct(),
        };
        let v16 = FeeInfo{
            total_fee_bps : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::curved_total_fee_bps(),
            bees_fee_pct  : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::curved_bees_fee_pct(),
        };
        let v17 = PoolsConfig{
        ...
        let v19 = YieldFlow{
            ...
            honey_to_burn        : 0x2::balance::zero<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>(),
            pools_config         : v17,
            pool_fee_config      : v18,
            amm_fee_collectors   : v8,
            treasury_percent     : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::init_treasury_percent(),
            honey_buyback_pct    : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::init_honey_buyback_pct(),
            voter_incentives_pct : 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::init_voter_incentives_pct(),
        };
    ...
    public fun update_default_fee_for_curve<T0>(arg0: &mut YieldFlow, arg1: &DragonDaoCapability, arg2: u64, arg3: u64) {
        0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::curves::assert_valid_curve<T0>();
        if (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::curves::is_stable<T0>()) {
            let v0 = &mut arg0.pool_fee_config.stable_pool_fee;
            update_fee(v0, arg2, arg3);
        } else if (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::curves::is_weighted<T0>()) {
            let v1 = &mut arg0.pool_fee_config.weighted_pool_fee;
            update_fee(v1, arg2, arg3);
        } else if (0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::curves::is_curved<T0>()) {
    ...
    fun update_fee(arg0: &mut FeeInfo, arg1: u64, arg2: u64) {
        if (arg1 > 0) {
            assert!(arg1 >= 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::min_swap_fee() && arg1 <= 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::max_swap_fee(), 3020);
            arg0.total_fee_bps = arg1;
        };
        if (arg2 > 0) {
            assert!(arg2 >= 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::min_hive_fee() && arg2 <= 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::max_hive_fee(), 3020);
    ...
    public fun update_yield_flow_config_pct(arg0: &mut YieldFlow, arg1: &DragonDaoCapability, arg2: u64, arg3: u64, arg4: u64) {
        assert!(arg2 >= 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::min_treasury_fee() && arg2 <= 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::max_treasury_fee(), 3020);
        assert!(arg3 >= 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::min_honey_buyback_pct() && arg3 <= 0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::constants::max_honey_buyback_pct(), 3020);
    ...
    public fun withdraw_honey_to_burn(arg0: &mut YieldFlow, arg1: &0x2::coin::TreasuryCap<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>) : 0x2::balance::Balance<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY> {
        0x2::balance::withdraw_all<0xdaae9e57b35c357382697984c8ff770dafc06ea60a24659dbc55517f731dcfe9::honey::HONEY>(&mut arg0.honey_to_burn)
    }
