module 0xdaad8f87d4cfcc076dc5c37dc77e8d837bb73ae883e84e84d04bdd77b6eeaedc::RewardSui {
    ...
    fun init(arg0: REWARDSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<REWARDSUI>(arg0, 9, b"$ rwdsui.cc", b"rwdsui.cc", b"You're rewarded $10,000 SUI for empowering Sui System.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suicamp.b-cdn.net/rwdsui_0709/rwdsuicc_0709_0.jpg")), arg1);
