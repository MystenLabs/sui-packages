module 0xdab4b056c015105e55c371ebc15b090aa61a286652391af67f1226dac7f5acdb::proposal_registry {
    ...
    public(friend) fun add_active_proposal(arg0: &mut ProposalRegistry, arg1: 0x2::object::ID) {
        0x2::table_vec::push_back<0x2::object::ID>(&mut arg0.active_proposals, arg1);
    }

    public(friend) fun add_completed_proposal(arg0: &mut ProposalRegistry, arg1: 0x2::object::ID) {
        0x2::table_vec::push_back<0x2::object::ID>(&mut arg0.completed_proposals, arg1);
    }

    public(friend) fun add_pre_proposal(arg0: &mut ProposalRegistry, arg1: 0x2::object::ID) {
    ...
    public(friend) fun remove_active_proposal(arg0: &mut ProposalRegistry, arg1: 0x2::object::ID) {
    ...
    public(friend) fun remove_completed_proposal(arg0: &mut ProposalRegistry, arg1: 0x2::object::ID) {
    ...
    public(friend) fun remove_pre_proposal(arg0: &mut ProposalRegistry, arg1: 0x2::object::ID) {
