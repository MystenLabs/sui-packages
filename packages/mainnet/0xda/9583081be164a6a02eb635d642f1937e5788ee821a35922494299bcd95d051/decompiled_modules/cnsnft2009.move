module 0xda9583081be164a6a02eb635d642f1937e5788ee821a35922494299bcd95d051::cnsnft2009 {
    struct CNSNFT2009 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2009, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2009>(arg0, arg1);
