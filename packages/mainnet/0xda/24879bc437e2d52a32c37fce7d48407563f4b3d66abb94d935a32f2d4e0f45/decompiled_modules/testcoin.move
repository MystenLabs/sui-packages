module 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::testcoin {
    ...
    fun pool_dispatcher(arg0: &mut Vault) : &mut 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::pool_dispatcher::PoolDispatcher {
        0x2::object_bag::borrow_mut<0x1::string::String, 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::pool_dispatcher::PoolDispatcher>(&mut arg0.registry, 0x1::string::utf8(b"pool_dispatcher"))
    }
    ...
    public fun set_address_pool(arg0: &ScheduleAdminCap, arg1: &mut Vault, arg2: 0x1::string::String, arg3: address) {
        ...
        assert!(0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::pool_dispatcher::contains(v0, arg2), 3);
        0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::pool_dispatcher::set_address_pool(v0, arg2, arg3);
    }
    ...
    fun init(arg0: TESTCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::object_bag::add<0x1::string::String, 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::pool_dispatcher::PoolDispatcher>(&mut v2.registry, 0x1::string::utf8(b"pool_dispatcher"), 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::pool_dispatcher::default(arg1));
        0x2::object_bag::add<0x1::string::String, 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::treasury::Treasury<TESTCOIN>>(&mut v2.registry, 0x1::string::utf8(b"treasury"), 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::treasury::create<TESTCOIN>(v0, 3000000000000000000, 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::schedule::default<TESTCOIN>(), arg1));
    ...
    public fun insert_entry(arg0: &ScheduleAdminCap, arg1: &mut Vault, arg2: u64, arg3: vector<0x1::string::String>, arg4: vector<u64>, arg5: u64, arg6: u64, arg7: u64) {
        ...
        while (v2 < 0x1::vector::length<0x1::string::String>(&arg3)) {
            assert!(0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::pool_dispatcher::contains(v1, *0x1::vector::borrow<0x1::string::String>(&arg3, v2)), 3);
            v2 = v2 + 1;
        };
        0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::treasury::insert_entry<TESTCOIN>(treasury(arg1), arg2, 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::treasury::create_entry<TESTCOIN>(arg3, arg4, arg5, arg6, arg7));
    }

    public fun mint(arg0: &mut Vault, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 2);
        let v0 = treasury(arg0);
        let (v1, v2) = 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::treasury::mint<TESTCOIN>(v0, arg1, arg2);
        let v3 = v2;
        let v4 = v1;
        let v5 = pool_dispatcher(arg0);
        while (!0x1::vector::is_empty<0x1::string::String>(&v4)) {
            0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::pool_dispatcher::transfer<TESTCOIN>(v5, 0x1::vector::pop_back<0x1::string::String>(&mut v4), 0x1::vector::pop_back<0x2::coin::Coin<TESTCOIN>>(&mut v3));
        };
    ...
    fun premint(arg0: &mut Vault, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = treasury(arg0);
        0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::pool_dispatcher::transfer<TESTCOIN>(pool_dispatcher(arg0), 0x1::string::utf8(b"liquidity"), 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::treasury::premint<TESTCOIN>(v0, 150000000000000000, arg1));
    }

    public fun remove_entry(arg0: &ScheduleAdminCap, arg1: &mut Vault, arg2: u64) {
        assert!(arg1.version == 1, 2);
        0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::treasury::remove_entry<TESTCOIN>(treasury(arg1), arg2);
    }
    ...
    public fun set_entry(arg0: &ScheduleAdminCap, arg1: &mut Vault, arg2: u64, arg3: vector<0x1::string::String>, arg4: vector<u64>, arg5: u64, arg6: u64, arg7: u64) {
        ...
        0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::treasury::set_entry<TESTCOIN>(treasury(arg1), arg2, 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::treasury::create_entry<TESTCOIN>(arg3, arg4, arg5, arg6, arg7));
    }

    fun treasury(arg0: &mut Vault) : &mut 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::treasury::Treasury<TESTCOIN> {
        0x2::object_bag::borrow_mut<0x1::string::String, 0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::treasury::Treasury<TESTCOIN>>(&mut arg0.registry, 0x1::string::utf8(b"treasury"))
    }

    entry fun unblock_minting(arg0: &ScheduleAdminCap, arg1: &mut Vault) {
        assert!(arg1.version == 1, 2);
        0xda24879bc437e2d52a32c37fce7d48407563f4b3d66abb94d935a32f2d4e0f45::treasury::unblock_minting<TESTCOIN>(treasury(arg1));
    }
