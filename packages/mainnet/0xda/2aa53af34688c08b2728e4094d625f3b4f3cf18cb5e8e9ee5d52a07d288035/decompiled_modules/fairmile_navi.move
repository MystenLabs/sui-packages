module 0xda2aa53af34688c08b2728e4094d625f3b4f3cf18cb5e8e9ee5d52a07d288035::fairmile_navi {
    ...
    public fun withdrawUSDCUser<T0>(arg0: &mut UsdcFeeTreasury<T0>, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == @0xa5241d2ebbc9e93d5a9041dde288a6bfc46fccaf1c15ad0b85fd80806010e4c6, 100);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.usdc_fee_amount, arg2), arg3), arg1);
    }
