module 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault {
    ...
    struct Vault<phantom T0> has store, key {
        ...
        receipts: 0x2::table::Table<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>,
        op_value_update_record: OperationValueUpdateRecord,
    }

    struct RequestBuffer<phantom T0> has store {
        deposit_id_count: u64,
        deposit_requests: 0x2::table::Table<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::DepositRequest>,
        deposit_coin_buffer: 0x2::table::Table<u64, 0x2::coin::Coin<T0>>,
        withdraw_id_count: u64,
        withdraw_requests: 0x2::table::Table<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::WithdrawRequest>,
    }
    ...
    public fun deposit_request<T0>(arg0: &Vault<T0>, arg1: u64) : &0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::DepositRequest {
        let v0 = &arg0.request_buffer;
        assert!(0x2::table::contains<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::DepositRequest>(&v0.deposit_requests, arg1), 5010);
        0x2::table::borrow<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::DepositRequest>(&v0.deposit_requests, arg1)
    }
    ...
    public(friend) fun add_new_defi_asset<T0, T1: store + key>(arg0: &mut Vault<T0>, arg1: u8, arg2: T1) {
        ...
        let v0 = 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_utils::parse_key<T1>(arg1);
        set_new_asset_type<T0>(arg0, v0);
        0x2::bag::add<0x1::ascii::String, T1>(&mut arg0.assets, v0, arg2);
    }

    public(friend) fun add_vault_receipt_info<T0>(arg0: &mut Vault<T0>, arg1: address, arg2: 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo) {
        check_version<T0>(arg0);
        assert_normal<T0>(arg0);
        0x2::table::add<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(&mut arg0.receipts, arg1, arg2);
    }

    public fun vault_receipt_info<T0>(arg0: &Vault<T0>, arg1: address) : &0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo {
        0x2::table::borrow<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(&arg0.receipts, arg1)
    }
    ...
    public(friend) fun assert_vault_receipt_matched<T0>(arg0: &Vault<T0>, arg1: &0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::receipt::Receipt) {
        assert!(vault_id<T0>(arg0) == 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::receipt::vault_id(arg1), 5006);
    }
    ...
    public(friend) fun cancel_deposit<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock, arg2: u64, arg3: address, arg4: address) : 0x2::coin::Coin<T0> {
        ...
        assert!(0x2::table::contains<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::DepositRequest>(&arg0.request_buffer.deposit_requests, arg2), 5010);
        let v0 = 0x2::table::borrow_mut<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(&mut arg0.receipts, arg3);
        assert!(0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::status(v0) == 1, 5017);
        let v1 = 0x2::table::borrow_mut<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::DepositRequest>(&mut arg0.request_buffer.deposit_requests, arg2);
        assert!(arg3 == 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::receipt_id(v1), 5003);
        assert!(0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::request_time(v1) + arg0.locking_time_for_cancel_request <= 0x2::clock::timestamp_ms(arg1), 5018);
        assert!(0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::recipient(v1) == arg4, 5023);
        0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::update_after_cancel_deposit(v0, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::amount(v1));
        let v2 = 0x2::table::remove<u64, 0x2::coin::Coin<T0>>(&mut arg0.request_buffer.deposit_coin_buffer, arg2);
        let v3 = DepositCancelled{
            request_id : arg2,
            receipt_id : 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::receipt_id(v1),
            recipient  : arg4,
            vault_id   : 0x2::object::uid_to_address(&arg0.id),
            amount     : 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::amount(v1),
        };
    ...
    public(friend) fun cancel_withdraw<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock, arg2: u64, arg3: address, arg4: address) : u256 {
        ...
        assert_normal<T0>(arg0);
        assert!(contains_vault_receipt_info<T0>(arg0, arg3), 5020);
        assert!(0x2::table::contains<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::WithdrawRequest>(&arg0.request_buffer.withdraw_requests, arg2), 5010);
        let v0 = 0x2::table::borrow_mut<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(&mut arg0.receipts, arg3);
        let v1 = 0x2::table::borrow_mut<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::WithdrawRequest>(&mut arg0.request_buffer.withdraw_requests, arg2);
        assert!(arg3 == 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::receipt_id(v1), 5003);
        assert!(0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::request_time(v1) + arg0.locking_time_for_cancel_request <= 0x2::clock::timestamp_ms(arg1), 5018);
        assert!(0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::recipient(v1) == arg4 || 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::recipient(v1) == 0x2::address::from_u256(0), 5023);
        0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::update_after_cancel_withdraw(v0, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::shares(v1));
        let v2 = WithdrawCancelled{
            request_id : arg2,
            receipt_id : 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::receipt_id(v1),
            recipient  : arg4,
            vault_id   : 0x2::object::uid_to_address(&arg0.id),
            shares     : 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::shares(v1),
        };
        0x2::event::emit<WithdrawCancelled>(v2);
        delete_withdraw_request<T0>(arg0, arg2);
        0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::shares(v1)
    }

    public fun check_locking_time_for_cancel_request<T0>(arg0: &Vault<T0>, arg1: bool, arg2: u64, arg3: &0x2::clock::Clock) : bool {
        check_version<T0>(arg0);
        arg1 && 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::request_time(0x2::table::borrow<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::DepositRequest>(&arg0.request_buffer.deposit_requests, arg2)) + arg0.locking_time_for_cancel_request <= 0x2::clock::timestamp_ms(arg3) || 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::request_time(0x2::table::borrow<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::WithdrawRequest>(&arg0.request_buffer.withdraw_requests, arg2)) + arg0.locking_time_for_cancel_request <= 0x2::clock::timestamp_ms(arg3)
    }

    public fun check_locking_time_for_withdraw<T0>(arg0: &Vault<T0>, arg1: address, arg2: &0x2::clock::Clock) : bool {
        check_version<T0>(arg0);
        arg0.locking_time_for_withdraw + 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::last_deposit_time(0x2::table::borrow<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(&arg0.receipts, arg1)) <= 0x2::clock::timestamp_ms(arg2)
    }
    ...
    public(friend) fun claim_claimable_principal<T0>(arg0: &mut Vault<T0>, arg1: address, arg2: u64) : 0x2::balance::Balance<T0> {
        check_version<T0>(arg0);
        assert_normal<T0>(arg0);
        let v0 = 0x2::table::borrow_mut<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(&mut arg0.receipts, arg1);
        assert!(0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::claimable_principal(v0) >= arg2, 5021);
        assert!(0x2::balance::value<T0>(&arg0.claimable_principal) >= arg2, 5021);
        0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::update_after_claim_principal(v0, arg2);
    ...
    public(friend) fun contains_vault_receipt_info<T0>(arg0: &Vault<T0>, arg1: address) : bool {
        0x2::table::contains<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(&arg0.receipts, arg1)
    }
    ...
    public fun create_vault<T0>(arg0: &AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = RequestBuffer<T0>{
            deposit_id_count    : 0,
            deposit_requests    : 0x2::table::new<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::DepositRequest>(arg1),
            deposit_coin_buffer : 0x2::table::new<u64, 0x2::coin::Coin<T0>>(arg1),
            withdraw_id_count   : 0,
            withdraw_requests   : 0x2::table::new<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::WithdrawRequest>(arg1),
        };
        ...
        let v3 = Vault<T0>{
            ...
            receipts                        : 0x2::table::new<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(arg1),
    ...
    public(friend) fun delete_deposit_request<T0>(arg0: &mut Vault<T0>, arg1: u64) {
        check_version<T0>(arg0);
        0x2::table::remove<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::DepositRequest>(&mut arg0.request_buffer.deposit_requests, arg1);
    }

    public(friend) fun delete_withdraw_request<T0>(arg0: &mut Vault<T0>, arg1: u64) {
        check_version<T0>(arg0);
        0x2::table::remove<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::WithdrawRequest>(&mut arg0.request_buffer.withdraw_requests, arg1);
    }

    public(friend) fun deposit_by_operator<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock, arg2: &0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_oracle::OracleConfig, arg3: 0x2::coin::Coin<T0>) {
        check_version<T0>(arg0);
        assert_normal<T0>(arg0);
    ...
    public(friend) fun execute_deposit<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock, arg2: &0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_oracle::OracleConfig, arg3: u64, arg4: u256) {
        check_version<T0>(arg0);
        assert_normal<T0>(arg0);
        assert!(0x2::table::contains<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::DepositRequest>(&arg0.request_buffer.deposit_requests, arg3), 5010);
        let v0 = get_total_usd_value<T0>(arg0, arg1);
        let v1 = get_share_ratio<T0>(arg0, arg1);
        let v2 = *0x2::table::borrow<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::DepositRequest>(&arg0.request_buffer.deposit_requests, arg3);
        assert!(0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::vault_id(&v2) == 0x2::object::uid_to_address(&arg0.id), 5002);
        let v3 = 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::amount(&v2);
        ...
        update_free_principal_value<T0>(arg0, arg2, arg1);
        let v5 = 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_utils::div_d(get_total_usd_value<T0>(arg0, arg1) - v0, v1);
        assert!(v5 > 0, 5004);
        assert!(v5 >= 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::expected_shares(&v2), 5009);
        assert!(v5 <= arg4, 5009);
        arg0.total_shares = arg0.total_shares + v5;
        let v6 = DepositExecuted{
            request_id : arg3,
            receipt_id : 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::receipt_id(&v2),
            recipient  : 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::recipient(&v2),
            vault_id   : 0x2::object::uid_to_address(&arg0.id),
            amount     : v3,
            shares     : v5,
        };
        0x2::event::emit<DepositExecuted>(v6);
        0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::update_after_execute_deposit(0x2::table::borrow_mut<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(&mut arg0.receipts, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::receipt_id(&v2)), 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::amount(&v2), v5, 0x2::clock::timestamp_ms(arg1));
        delete_deposit_request<T0>(arg0, arg3);
    }

    public(friend) fun execute_withdraw<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock, arg2: &0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_oracle::OracleConfig, arg3: u64, arg4: u64) : (0x2::balance::Balance<T0>, address) {
        check_version<T0>(arg0);
        assert_normal<T0>(arg0);
        assert!(0x2::table::contains<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::WithdrawRequest>(&arg0.request_buffer.withdraw_requests, arg3), 5010);
        let v0 = *0x2::table::borrow<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::WithdrawRequest>(&arg0.request_buffer.withdraw_requests, arg3);
        let v1 = 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::shares(&v0);
        let v2 = (0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_utils::div_with_oracle_price(0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_utils::mul_d(v1, get_share_ratio<T0>(arg0, arg1)), 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_oracle::get_normalized_asset_price(arg2, arg1, 0x1::type_name::into_string(0x1::type_name::get<T0>()))) as u64);
        assert!(v2 >= 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::expected_amount(&v0), 5009);
        assert!(v2 <= arg4, 5009);
        ...
        let v5 = WithdrawExecuted{
            request_id : arg3,
            receipt_id : 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::receipt_id(&v0),
            recipient  : 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::recipient(&v0),
            vault_id   : 0x2::object::uid_to_address(&arg0.id),
            shares     : v1,
            amount     : v2 - v4,
        };
        ...
        update_free_principal_value<T0>(arg0, arg2, arg1);
        let v6 = 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::recipient(&v0);
        if (v6 != 0x2::address::from_u256(0)) {
            0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::update_after_execute_withdraw(0x2::table::borrow_mut<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(&mut arg0.receipts, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::receipt_id(&v0)), v1, 0);
        } else {
    ...
    public(friend) fun get_share_ratio<T0>(arg0: &Vault<T0>, arg1: &0x2::clock::Clock) : u256 {
        ...
        if (arg0.total_shares == 0) {
            return 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_utils::to_decimals(1)
        };
        let v0 = 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_utils::div_d(get_total_usd_value<T0>(arg0, arg1), arg0.total_shares);
    ...
    public fun get_share_ratio_without_update<T0>(arg0: &Vault<T0>) : u256 {
        ...
        0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_utils::div_d(get_total_usd_value_without_update<T0>(arg0), arg0.total_shares)
    }
    ...
    public(friend) fun request_deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u256, arg4: address, arg5: address) : u64 {
        ...
        let v0 = 0x2::table::borrow_mut<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(&mut arg0.receipts, arg4);
        assert!(0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::status(v0) == 0, 5017);
        let v1 = arg0.request_buffer.deposit_id_count;
        arg0.request_buffer.deposit_id_count = v1 + 1;
        let v2 = 0x2::coin::value<T0>(&arg1);
        0x2::table::add<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::DepositRequest>(&mut arg0.request_buffer.deposit_requests, v1, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::deposit_request::new(v1, arg4, arg5, 0x2::object::uid_to_address(&arg0.id), v2, arg3, 0x2::clock::timestamp_ms(arg2)));
        ...
        0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::update_after_request_deposit(v0, v2);
        v1
    }
    ...
    public(friend) fun request_withdraw<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock, arg2: address, arg3: u256, arg4: u64, arg5: address) : u64 {
        ...
        let v0 = 0x2::table::borrow_mut<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(&mut arg0.receipts, arg2);
        assert!(0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::status(v0) == 0, 5017);
        assert!(0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::shares(v0) >= arg3, 5019);
        let v1 = arg0.request_buffer.withdraw_id_count;
        arg0.request_buffer.withdraw_id_count = v1 + 1;
        0x2::table::add<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::WithdrawRequest>(&mut arg0.request_buffer.withdraw_requests, v1, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::new(v1, arg2, arg5, 0x2::object::uid_to_address(&arg0.id), arg3, arg4, 0x2::clock::timestamp_ms(arg1)));
        ...
        0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::update_after_request_withdraw(v0, arg3, arg5);
        v1
    }
    ...
    public fun update_coin_type_asset_value<T0, T1>(arg0: &mut Vault<T0>, arg1: &0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_oracle::OracleConfig, arg2: &0x2::clock::Clock) {
        check_version<T0>(arg0);
        assert_enabled<T0>(arg0);
        assert!(0x1::type_name::get<T1>() != 0x1::type_name::get<T0>(), 5026);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T1>());
        let v1 = 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_utils::mul_with_oracle_price((0x2::balance::value<T1>(0x2::bag::borrow<0x1::ascii::String, 0x2::balance::Balance<T1>>(&arg0.assets, v0)) as u256), 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_oracle::get_normalized_asset_price(arg1, arg2, v0));
        finish_update_asset_value<T0>(arg0, v0, v1, 0x2::clock::timestamp_ms(arg2));
    }

    public fun update_free_principal_value<T0>(arg0: &mut Vault<T0>, arg1: &0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_oracle::OracleConfig, arg2: &0x2::clock::Clock) {
        check_version<T0>(arg0);
        assert_enabled<T0>(arg0);
        let v0 = 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_utils::mul_with_oracle_price((0x2::balance::value<T0>(&arg0.free_principal) as u256), 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_oracle::get_normalized_asset_price(arg1, arg2, 0x1::type_name::into_string(0x1::type_name::get<T0>())));
    ...
    public(friend) fun vault_receipt_info_mut<T0>(arg0: &mut Vault<T0>, arg1: address) : &mut 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo {
        0x2::table::borrow_mut<address, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::vault_receipt_info::VaultReceiptInfo>(&mut arg0.receipts, arg1)
    }
    ...
    public fun withdraw_request<T0>(arg0: &Vault<T0>, arg1: u64) : &0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::WithdrawRequest {
        let v0 = &arg0.request_buffer;
        assert!(0x2::table::contains<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::WithdrawRequest>(&v0.withdraw_requests, arg1), 5010);
        0x2::table::borrow<u64, 0xdaf17a792e3e728fe901d2e2a5b7048868f9984547665b56059d347308c79b92::withdraw_request::WithdrawRequest>(&v0.withdraw_requests, arg1)
    }
