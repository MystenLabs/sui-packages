module 0xda99bccc952ed900ddf73f89a4558ea21b8d254a0253be0152902f472ac6f802::fee_tier {
    ...
    public fun set_default_fee_rate(arg0: &mut FeeTier, arg1: u32, arg2: &0xda99bccc952ed900ddf73f89a4558ea21b8d254a0253be0152902f472ac6f802::admin_cap::AdminCap) {
        assert!(arg1 <= 200000, 0xda99bccc952ed900ddf73f89a4558ea21b8d254a0253be0152902f472ac6f802::errors::err_max_fee_rate_limit());
    ...
    public fun set_fee_rate<T0, T1>(arg0: &mut FeeTier, arg1: u32, arg2: &0xda99bccc952ed900ddf73f89a4558ea21b8d254a0253be0152902f472ac6f802::admin_cap::AdminCap) {
        assert!(arg1 <= 200000, 0xda99bccc952ed900ddf73f89a4558ea21b8d254a0253be0152902f472ac6f802::errors::err_max_fee_rate_limit());
        let v0 = fee_rate_key<T0, T1>();
        let v1 = if (0x2::table::contains<0x1::ascii::String, u32>(&arg0.fee_rates, v0)) {
