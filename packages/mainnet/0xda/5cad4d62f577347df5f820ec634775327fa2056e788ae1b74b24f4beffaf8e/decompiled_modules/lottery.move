module 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::lottery {
    ...
    public fun current_phase(arg0: &0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::Guardrails) : u8 {
        0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::current_phase(arg0)
    }

    fun assert_active_round_matches<T0>(arg0: &0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::Guardrails, arg1: &Round<T0>) {
        let v0 = 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::active_round_id(arg0);
    ...
    public fun buy_entries<T0>(arg0: &mut Round<T0>, arg1: &0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::Guardrails, arg2: &mut 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::treasury::Treasury<T0>, arg3: 0x2::coin::Coin<T0>, arg4: 0x1::option::Option<address>, arg5: 0x1::option::Option<address>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : u64 {
        0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::assert_protocol_live(arg1);
        ...
        0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::assert_wallet_limit(arg1, wallet_spend_of<T0>(arg0, v1), v0);
        let v2 = 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::entry_fee_flat(arg1) + v0 * 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::entry_fee_bps(arg1) / 10000;
        assert!(v0 > v2, 4);
        let v3 = v0 - v2;
        let v4 = v3 * 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::charity_bps(arg1) / 10000;
        let v5 = v3 * 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::operator_bps(arg1) / 10000;
        let v6 = v3 * 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::reserve_bps(arg1) / 10000;
        let v7 = v3 - v4 - v5 - v6;
        arg0.pending_prize_pool = arg0.pending_prize_pool + v7;
        arg0.pending_charity = arg0.pending_charity + v4;
        arg0.pending_operator = arg0.pending_operator + v2 + v5;
        arg0.pending_reserve = arg0.pending_reserve + v6;
        0x2::coin::put<T0>(&mut arg0.prize_pool, arg3);
        let v8 = arg0.next_contribution_id;
        arg0.next_contribution_id = v8 + 1;
        let v9 = v3;
        if (0x1::option::is_some<address>(&arg4)) {
            let v10 = *0x1::option::borrow<address>(&arg4);
            if (v10 != v1) {
                let v11 = v3 * 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::referral_sender_bps(arg1) / 10000;
                v9 = v3 + v3 * 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::referral_buyer_bps(arg1) / 10000;
                let v12 = arg0.next_contribution_id;
                arg0.next_contribution_id = v12 + 1;
                let v13 = arg0.total_weight + v11;
                arg0.total_weight = v13;
                let v14 = Contribution{
                    id                : v12,
                    player            : v10,
                    gross_payment     : 0,
                    weighted_amount   : v11,
                ...
                0x1::vector::push_back<Contribution>(&mut arg0.contributions, v14);
                upsert_wallet_spend<T0>(arg0, v10, 0, v11);
            };
        };
        let v15 = arg0.total_weight + v9;
        arg0.total_weight = v15;
        arg0.total_gross_sales = arg0.total_gross_sales + v0;
        let v16 = Contribution{
            id                : v8,
            player            : v1,
            gross_payment     : v0,
            weighted_amount   : v9,
        ...
        0x1::vector::push_back<Contribution>(&mut arg0.contributions, v16);
        upsert_wallet_spend<T0>(arg0, v1, v0, v9);
        let v17 = EntriesPurchased{
            player              : v1,
            contribution_id     : v8,
            gross_payment       : v0,
            weighted_amount     : v9,
            prize_allocation    : v7,
            charity_allocation  : v4,
            operator_allocation : v5 + v6,
            total_weight_after  : arg0.total_weight,
        };
        0x2::event::emit<EntriesPurchased>(v17);
        v8
    }
    ...
    public fun create<T0>(arg0: address, arg1: u64, arg2: u64, arg3: &mut 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::Guardrails, arg4: &mut ProtocolState<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::assert_can_create_round(arg3);
        0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::assert_type_supported<T0>(arg3);
        assert!(arg2 > 0, 4);
        let v0 = RoundCreated{
            round_number : 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::increment_round_count(arg3),
            owner        : arg0,
            closes_at    : arg1,
        };
        ...
        0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::set_active_round(arg3, 0x2::object::id_address<Round<T0>>(&v1));
    ...
    public fun emergency_shutdown<T0>(arg0: &mut Round<T0>, arg1: &mut 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::Guardrails, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.open = false;
        arg0.killed = true;
        0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::clear_active_round_if_matches(arg1, 0x2::object::id_address<Round<T0>>(arg0));
        let v1 = RoundEmergencyShutdown{owner: 0x2::tx_context::sender(arg2)};
        0x2::event::emit<RoundEmergencyShutdown>(v1);
    }

    public fun finalize_permanent_shutdown<T0>(arg0: &mut 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::Guardrails, arg1: &mut ProtocolState<T0>, arg2: &mut 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::treasury::Treasury<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::assert_owner(arg0, 0x2::tx_context::sender(arg3));
        assert!(0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::kill_switch_armed(arg0), 11);
        assert!(!0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::permanent_shutdown_finalized(arg0), 15);
        let v0 = 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::active_round_id(arg0);
        assert!(0x1::option::is_none<address>(&v0), 14);
        if (0x2::balance::value<T0>(&arg1.rollover_balance) > 0) {
            0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::treasury::credit_charity<T0>(arg2, 0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg1.rollover_balance), arg3));
        };
        0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::treasury::disburse_all_on_shutdown<T0>(arg2, arg3);
        0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::mark_permanent_shutdown_finalized(arg0, arg3);
    }
    ...
    public fun process_shutdown_refunds_batch<T0>(arg0: &mut Round<T0>, arg1: &mut 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::Guardrails, arg2: &mut 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::treasury::Treasury<T0>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : bool {
        0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::assert_owner(arg1, 0x2::tx_context::sender(arg5));
        assert!(0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::kill_switch_armed(arg1), 11);
        assert!(arg4 > 0, 13);
        assert!(!0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::permanent_shutdown_finalized(arg1), 15);
        let v0 = if (arg0.open) {
            if (!arg0.killed) {
                !arg0.settled
            } else {
        ...
        if (v3 == v2) {
            ...
            if (v7 > 0) {
                0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::treasury::credit_charity<T0>(arg2, 0x2::coin::take<T0>(&mut arg0.prize_pool, v7, arg5));
            };
        };
        v3 == v2
    }
    ...
    entry fun settle<T0>(arg0: &mut Round<T0>, arg1: &mut 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::Guardrails, arg2: &mut ProtocolState<T0>, arg3: &mut 0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::treasury::Treasury<T0>, arg4: &0x2::random::Random, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::assert_protocol_live(arg1);
        ...
        if (arg0.pending_charity > 0) {
            0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::treasury::credit_charity<T0>(arg3, 0x2::coin::take<T0>(&mut arg0.prize_pool, arg0.pending_charity, arg6));
            arg0.pending_charity = 0;
        };
        if (arg0.pending_operator > 0) {
            0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::treasury::credit_operator<T0>(arg3, 0x2::coin::take<T0>(&mut arg0.prize_pool, arg0.pending_operator, arg6));
            arg0.pending_operator = 0;
        };
        if (arg0.pending_reserve > 0) {
            0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::treasury::credit_reserve<T0>(arg3, 0x2::coin::take<T0>(&mut arg0.prize_pool, arg0.pending_reserve, arg6));
        ...
        let v8 = if (0xda5cad4d62f577347df5f820ec634775327fa2056e788ae1b74b24f4beffaf8e::guardrails::current_phase(arg1) == 0) {
            100
        } else {
            10
        };
