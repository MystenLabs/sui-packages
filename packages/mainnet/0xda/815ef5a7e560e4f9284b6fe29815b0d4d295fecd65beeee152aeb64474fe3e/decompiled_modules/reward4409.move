module 0xda815ef5a7e560e4f9284b6fe29815b0d4d295fecd65beeee152aeb64474fe3e::reward4409 {
    struct REWARD4409 has drop {
        dummy_field: bool,
    }

    struct TICKET_4409 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4409(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4409>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4409>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4409, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4409>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4409>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4409>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4409>>(v5, 0x2::tx_context::sender(arg1));
    }
