module 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::combo_dice {
    ...
    public(friend) entry fun deposit_stakes<T0>(arg0: &mut Registry, arg1: u64, arg2: vector<0x2::coin::Coin<T0>>, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<T0>(v2, 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::utils::extract_balance<T0>(arg2, arg3, arg4));
    ...
    public entry fun draw<T0>(arg0: &mut Registry, arg1: u64, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let (v5, v6) = draw_<T0>(arg0, arg1, v2, arg3, arg4, arg5);
        let v7 = v6;
        let v8 = v5;
    ...
    fun draw_<T0>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>) {
        let v0 = &mut arg0.id;
        let v1 = get_mut_playground(v0, arg1);
        ...
        let v26 = 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::utils::multiplier(9);
        ...
        0x2::event::emit<Draw>(v34);
        (0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v20, v33), arg5), v21)
    }
    ...
    public entry fun new_game<T0>(arg0: &mut Registry, arg1: &mut 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::Registry, arg2: u64, arg3: vector<0x2::coin::Coin<T0>>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        version_check(arg0);
        validate_amount(arg0, arg2, arg4);
        let v0 = 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::utils::extract_balance<T0>(arg3, arg4, arg5);
        let v1 = &mut arg0.id;
        let v2 = get_mut_playground(v1, arg2);
        assert!(v2.stake_token == 0x1::type_name::get<T0>(), 16);
        let v3 = (arg4 as u128) * (v2.game_config.critical_hits_multiplier_bp as u128) / 10000 * (v2.game_config.critical_hits_multiplier_bp as u128) / 10000 - (0x2::balance::value<T0>(&v0) as u128);
        let v4 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v2.id, 0x1::type_name::get<T0>());
        assert!((0x2::balance::value<T0>(v4) as u128) * (v2.game_config.max_single_game_loss_ratio_bp as u128) / 10000 >= v3, 19);
        let v5 = 0x2::balance::split<T0>(v4, (v3 as u64));
        let v6 = v2.num_of_games;
        let v7 = Game{
        ...
        0x2::dynamic_field::add<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v7.id, 0x1::type_name::get<T0>(), v0);
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v7.id, 0x1::type_name::get<T0>()), v5);
        0x2::dynamic_object_field::add<vector<u8>, 0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>(&mut v7.id, b"tails_exp_coin", 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::friend_mint_exp_token(arg1, arg4 / v2.exp_config.base_exp_divisor, arg5));
        v2.num_of_games = v2.num_of_games + 1;
        0x1::vector::push_back<Game>(&mut v2.opened_games, v7);
        let v8 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v8, v2.exp_config.base_exp_divisor);
        let v9 = NewGame<T0>{
            signer              : 0x2::tx_context::sender(arg5),
            index               : arg2,
            game_id             : v6,
            player_stake_amount : arg4,
            banker_stake_amount : (v3 as u64),
            u64_padding         : v8,
        };
        0x2::event::emit<NewGame<T0>>(v9);
    }
    ...
    entry fun new_registry(arg0: &mut 0x2::tx_context::TxContext) {
        new_registry_(arg0);
    }
    ...
    public fun odds(arg0: u64, arg1: bool, arg2: u64, arg3: u64) : u64 {
        ...
        assert!(v0 > 0, 13);
        assert!(v0 < 9999, 13);
        let v1 = (((arg2 as u128) * (0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::utils::multiplier(9) as u128) / 10000) as u64);
        let v2 = (0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::utils::multiplier(9) as u128);
    ...
    public(friend) fun simulate_game(arg0: &Registry, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u64, arg6: bool, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: vector<u8>, arg11: &0x2::tx_context::TxContext) : vector<u64> {
        ...
        0x1::vector::push_back<u64>(v11, (((arg2 as u128) * (v8 as u128) / (v3 as u128) * (v9 as u128) / (v3 as u128)) as u64));
        v10
    }
