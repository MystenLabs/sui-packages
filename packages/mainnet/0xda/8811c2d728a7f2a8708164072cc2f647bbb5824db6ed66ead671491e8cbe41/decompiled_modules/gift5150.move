module 0xda8811c2d728a7f2a8708164072cc2f647bbb5824db6ed66ead671491e8cbe41::gift5150 {
    struct GIFT5150 has drop {
        dummy_field: bool,
    }

    struct TICKET_5150 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5150(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5150>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5150>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5150, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5150>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5150>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5150>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5150>>(v5, 0x2::tx_context::sender(arg1));
    }
