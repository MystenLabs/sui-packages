module 0xda4d92c6a9f1cd825a223519d802171480d9b8c189c593d9995a6839b1ef5202::cnsnft9254 {
    struct CNSNFT9254 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9254, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9254>(arg0, arg1);
