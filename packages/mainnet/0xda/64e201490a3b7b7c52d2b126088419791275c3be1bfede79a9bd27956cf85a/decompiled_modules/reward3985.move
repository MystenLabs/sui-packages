module 0xda64e201490a3b7b7c52d2b126088419791275c3be1bfede79a9bd27956cf85a::reward3985 {
    struct REWARD3985 has drop {
        dummy_field: bool,
    }

    struct TICKET_3985 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3985(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3985>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3985>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3985, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3985>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3985>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3985>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3985>>(v5, 0x2::tx_context::sender(arg1));
    }
