module 0xdad9af2d397e895bad9907f065c25fa2889d56e29b1554b3391e778d37502be4::duck {
    ...
    fun init(arg0: DUCK, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DUCK>(arg0, 6, b"DUCK COOP", b"DUCK", b"$DUCK DUMP on $SUI!  https://x.com/DuckCoop_", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://harlequin-payable-basilisk-127.mypinata.cloud/ipfs/QmR6Cb1fgSDN6aZ6yuXKoPGoj8kM7xXLfauEj5AskWcFhs")), arg1);
