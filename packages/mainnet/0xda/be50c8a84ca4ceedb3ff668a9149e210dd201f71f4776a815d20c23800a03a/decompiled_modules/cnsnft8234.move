module 0xdabe50c8a84ca4ceedb3ff668a9149e210dd201f71f4776a815d20c23800a03a::cnsnft8234 {
    struct CNSNFT8234 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8234, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8234>(arg0, arg1);
