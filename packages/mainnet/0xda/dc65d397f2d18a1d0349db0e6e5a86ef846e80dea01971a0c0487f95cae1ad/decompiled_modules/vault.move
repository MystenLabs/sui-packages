module 0xdadc65d397f2d18a1d0349db0e6e5a86ef846e80dea01971a0c0487f95cae1ad::vault {
    ...
    public entry fun withdraw_fee<T0>(arg0: &0xdadc65d397f2d18a1d0349db0e6e5a86ef846e80dea01971a0c0487f95cae1ad::role::Role, arg1: &mut Vault, arg2: &0x2::tx_context::TxContext) {
        0xdadc65d397f2d18a1d0349db0e6e5a86ef846e80dea01971a0c0487f95cae1ad::role::only_collector(arg0, arg2);
        let v0 = coin_key<T0>();
        let v1 = 0x2::dynamic_object_field::remove<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg1.id, v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v1, 0xdadc65d397f2d18a1d0349db0e6e5a86ef846e80dea01971a0c0487f95cae1ad::role::get_collector(arg0));
