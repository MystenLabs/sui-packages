module 0xda1697c23136d3965a1dbabd5b33ed621d2085cc8000172ae858c399031086a2::my_nft {
    ...
    fun init(arg0: MY_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"cuijiawei123"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://github.com/cuijiawei123/letsmove"));
