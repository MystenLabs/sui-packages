module 0x61d53088c7beede5b7f087ed950563b94722104f26f5f84ea5d51921b1b7bf4::waterx_staking {
    ...
    public fun new<T0>(arg0: &AdminCap, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : StakingPool<T0> {
    ...
    public fun add_manager<T0>(arg0: &mut StakingPool<T0>, arg1: &AdminCap, arg2: address) {
        assert_valid_package_version<T0>(arg0);
        0x2::vec_set::insert<address>(&mut arg0.managers, arg2);
    }

    public fun add_rewarder<T0, T1>(arg0: &mut StakingPool<T0>, arg1: &AdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert_valid_package_version<T0>(arg0);
        if (arg3 == 0) {
            abort 13906835153596907536
        };
        if (rewarder_exists<T0, T1>(arg0)) {
            abort 13906835166482071572
        };
    ...
    public fun add_version<T0>(arg0: &mut StakingPool<T0>, arg1: &AdminCap, arg2: u16) {
        0x2::vec_set::insert<u16>(&mut arg0.versions, arg2);
    }

    fun assert_no_pending_rewarder_sync<T0>(arg0: &StakingPool<T0>, arg1: address) {
        if (stake_exists<T0>(arg0, arg1) && stake_position<T0>(arg0, arg1).pending_rewarder_sync) {
            abort 13906837627498463254
        };
    }

    fun assert_sender_is_manager<T0>(arg0: &StakingPool<T0>, arg1: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest) {
        ...
        if (!0x2::vec_set::contains<address>(&arg0.managers, &v0)) {
            abort 13906838112828850184
        };
    }

    fun assert_valid_package_version<T0>(arg0: &StakingPool<T0>) {
        let v0 = package_version();
        if (!0x2::vec_set::contains<u16>(&arg0.versions, &v0)) {
            abort 13906838138598916108
        };
    }

    fun check_and_settle_rewarder<T0, T1>(arg0: &mut StakingPool<T0>, arg1: &mut 0x2::vec_set::VecSet<0x2::object::ID>, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
    ...
    public fun claim<T0, T1>(arg0: &mut StakingPool<T0>, arg1: &mut 0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::AccountRegistry, arg2: 0x2::object::ID, arg3: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest, arg4: &0x2::clock::Clock) {
        assert_valid_package_version<T0>(arg0);
        if (!0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::has_protocol_permission<0x61d53088c7beede5b7f087ed950563b94722104f26f5f84ea5d51921b1b7bf4::witness::WaterXStaking>(arg1, arg2, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::request_address(arg3), 4, 0x2::clock::timestamp_ms(arg4))) {
            abort 13906836721260494872
        };
        let v0 = 0x2::object::id_to_address(&arg2);
        assert_no_pending_rewarder_sync<T0>(arg0, v0);
        let v1 = stake_amount<T0>(arg0, v0);
        let v2 = id<T0>(arg0);
        let v3 = rewarder_mut<T0, T1>(arg0);
        if (0x2::clock::timestamp_ms(arg4) < v3.timestamp) {
            return
        };
        source_to_pool<T0, T1>(v3, arg4);
        ...
        0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::put<T1, 0x61d53088c7beede5b7f087ed950563b94722104f26f5f84ea5d51921b1b7bf4::witness::WaterXStaking>(arg1, arg2, 0x2::balance::withdraw_all<T1>(&mut v5.reward), 0x61d53088c7beede5b7f087ed950563b94722104f26f5f84ea5d51921b1b7bf4::witness::witness());
        if (v6 > 0) {
            let v7 = ClaimReward{
                vault_id                 : v2,
                rewarder_id              : v4,
    ...
    public fun default<T0>(arg0: &AdminCap, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<StakingPool<T0>>(new<T0>(arg0, arg1, arg2));
    }

    public fun deposit<T0>(arg0: &mut StakingPool<T0>, arg1: &mut 0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::AccountRegistry, arg2: 0x2::object::ID, arg3: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest, arg4: u64, arg5: &0x2::clock::Clock) : DepositChecker<T0> {
        assert_valid_package_version<T0>(arg0);
        if (!0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::has_protocol_permission<0x61d53088c7beede5b7f087ed950563b94722104f26f5f84ea5d51921b1b7bf4::witness::WaterXStaking>(arg1, arg2, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::request_address(arg3), 1, 0x2::clock::timestamp_ms(arg5))) {
            abort 13906835965346250776
        };
        let v0 = 0x2::object::id_to_address(&arg2);
        assert_no_pending_rewarder_sync<T0>(arg0, v0);
        let v1 = !0x2::vec_set::is_empty<0x2::object::ID>(&arg0.rewarder_ids);
        let v2 = stake_position_mut_or_insert<T0>(arg0, v0);
        v2.pending_rewarder_sync = v1;
        v2.stake_amount = v2.stake_amount + arg4;
        0x2::balance::join<T0>(&mut arg0.stake, 0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::take<T0, 0x61d53088c7beede5b7f087ed950563b94722104f26f5f84ea5d51921b1b7bf4::witness::WaterXStaking>(arg1, arg3, arg2, arg4, 0x61d53088c7beede5b7f087ed950563b94722104f26f5f84ea5d51921b1b7bf4::witness::witness(), arg5));
        if (0x2::balance::value<T0>(&arg0.stake) > arg0.stake_cap) {
            abort 13906836051244679178
        };
        if (arg4 > 0) {
            let v3 = Deposit{
                vault_id        : id<T0>(arg0),
        ...
        DepositChecker<T0>{
            account           : v0,
            prev_stake_amount : v2.stake_amount,
            rewarder_ids      : arg0.rewarder_ids,
        }
    }

    public fun deposit_to_pool<T0, T1>(arg0: &mut StakingPool<T0>, arg1: 0x2::coin::Coin<T1>) {
        assert_valid_package_version<T0>(arg0);
        0x2::balance::join<T1>(&mut rewarder_mut<T0, T1>(arg0).pool, 0x2::coin::into_balance<T1>(arg1));
    }

    public fun deposit_to_source<T0, T1>(arg0: &mut StakingPool<T0>, arg1: 0x2::coin::Coin<T1>) {
        assert_valid_package_version<T0>(arg0);
        let v0 = id<T0>(arg0);
        let v1 = rewarder_mut<T0, T1>(arg0);
        ...
        if (v2 > 0) {
            ...
            0x2::event::emit<RewardEarned>(v3);
        };
    }

    public fun deposit_to_source_by_manager<T0, T1>(arg0: &mut StakingPool<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest) {
        assert_valid_package_version<T0>(arg0);
        assert_sender_is_manager<T0>(arg0, arg4);
        if (arg3 == 0) {
            abort 13906835686172852240
        };
        let v0 = rewarder_mut<T0, T1>(arg0);
        source_to_pool<T0, T1>(v0, arg1);
        deposit_to_source<T0, T1>(arg0, arg2);
        let v1 = rewarder_source_amount<T0, T1>(arg0);
        update_flow_rate<T0, T1>(arg0, arg1, v1, arg3, arg4);
    }
    ...
    public fun destroy_withdraw_checker<T0>(arg0: WithdrawChecker<T0>) {
        ...
        let v3 = v2;
        if (!0x2::vec_set::is_empty<0x2::object::ID>(&v3)) {
            abort 13906836609590951954
        };
    }

    public fun get_rewarder<T0, T1>(arg0: &StakingPool<T0>) : &Rewarder<T0, T1> {
        if (!rewarder_exists<T0, T1>(arg0)) {
            abort 13906836953188204560
        };
        let v0 = RewarderKey<T1>{dummy_field: false};
        0x2::dynamic_field::borrow<RewarderKey<T1>, Rewarder<T0, T1>>(&arg0.id, v0)
    }

    public fun get_stake_data<T0, T1>(arg0: &StakingPool<T0>, arg1: address, arg2: &0x2::clock::Clock) : StakeDataDisplay {
    ...
    public fun perm_claim_reward() : u32 {
        4
    }

    public fun perm_deposit_stake() : u32 {
        1
    }

    public fun perm_redeem_stake() : u32 {
        2
    }

    public fun realtime_reward_amount<T0, T1>(arg0: &StakingPool<T0>, arg1: address, arg2: &0x2::clock::Clock) : u64 {
        if (!rewarder_exists<T0, T1>(arg0)) {
            return 0
        };
    ...
    fun realtime_reward_release_and_unit<T0, T1>(arg0: &Rewarder<T0, T1>, arg1: &0x2::clock::Clock) : (u64, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::Double) {
        ...
        if (v0 > v1 && arg0.total_stake_snapshot > 0) {
            let v4 = 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::floor(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::min(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::mul_u64(arg0.flow_rate, v0 - v1), 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::from(0x2::balance::value<T1>(&arg0.source))));
    ...
    public fun redeem<T0>(arg0: &mut StakingPool<T0>, arg1: &mut 0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::AccountRegistry, arg2: 0x2::object::ID, arg3: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest, arg4: u64, arg5: &0x2::clock::Clock) : WithdrawChecker<T0> {
        assert_valid_package_version<T0>(arg0);
        if (!0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::has_protocol_permission<0x61d53088c7beede5b7f087ed950563b94722104f26f5f84ea5d51921b1b7bf4::witness::WaterXStaking>(arg1, arg2, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::request_address(arg3), 2, 0x2::clock::timestamp_ms(arg5))) {
            abort 13906836330418470936
        };
        let v0 = 0x2::object::id_to_address(&arg2);
        assert_no_pending_rewarder_sync<T0>(arg0, v0);
        let v1 = withdrawable_amount<T0>(arg0, v0);
        if (arg4 == 0) {
            abort 13906836360482586638
        };
        if (arg4 < 1000 && arg4 != v1) {
            abort 13906836373367488526
        };
        if (v1 < arg4) {
            abort 13906836386251866118
        };
        ...
        v3.stake_amount = v3.stake_amount - arg4;
        0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::put<T0, 0x61d53088c7beede5b7f087ed950563b94722104f26f5f84ea5d51921b1b7bf4::witness::WaterXStaking>(arg1, arg2, 0x2::balance::split<T0>(&mut arg0.stake, arg4), 0x61d53088c7beede5b7f087ed950563b94722104f26f5f84ea5d51921b1b7bf4::witness::witness());
        ...
        let v5 = Redeem{
            ...
            asset_type        : 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()),
            account_address   : v0,
            withdrawal_amount : arg4,
        };
        0x2::event::emit<Redeem>(v5);
        v4
    }

    public fun remove_manager<T0>(arg0: &mut StakingPool<T0>, arg1: &AdminCap, arg2: address) {
        assert_valid_package_version<T0>(arg0);
        0x2::vec_set::remove<address>(&mut arg0.managers, &arg2);
    }

    public fun remove_version<T0>(arg0: &mut StakingPool<T0>, arg1: &AdminCap, arg2: u16) {
    ...
    public fun rewarder_exists<T0, T1>(arg0: &StakingPool<T0>) : bool {
        let v0 = RewarderKey<T1>{dummy_field: false};
        0x2::dynamic_field::exists_with_type<RewarderKey<T1>, Rewarder<T0, T1>>(&arg0.id, v0)
    }

    public fun rewarder_flow_rate<T0, T1>(arg0: &StakingPool<T0>) : 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::Double {
        if (!rewarder_exists<T0, T1>(arg0)) {
    ...
    public fun rewarder_id<T0, T1>(arg0: &StakingPool<T0>) : 0x2::object::ID {
        0x2::object::id<Rewarder<T0, T1>>(get_rewarder<T0, T1>(arg0))
    }

    public fun rewarder_ids<T0>(arg0: &StakingPool<T0>) : &0x2::vec_set::VecSet<0x2::object::ID> {
        &arg0.rewarder_ids
    }

    fun rewarder_mut<T0, T1>(arg0: &mut StakingPool<T0>) : &mut Rewarder<T0, T1> {
        let v0 = RewarderKey<T1>{dummy_field: false};
        if (!0x2::dynamic_field::exists_with_type<RewarderKey<T1>, Rewarder<T0, T1>>(&arg0.id, v0)) {
            abort 13906837498649051152
        };
        let v1 = RewarderKey<T1>{dummy_field: false};
        0x2::dynamic_field::borrow_mut<RewarderKey<T1>, Rewarder<T0, T1>>(&mut arg0.id, v1)
    }

    public fun rewarder_pool_amount<T0, T1>(arg0: &StakingPool<T0>) : u64 {
        if (!rewarder_exists<T0, T1>(arg0)) {
            return 0
        };
    ...
    public fun rewarder_source_amount<T0, T1>(arg0: &StakingPool<T0>) : u64 {
        if (!rewarder_exists<T0, T1>(arg0)) {
            return 0
        };
    ...
    public fun rewarder_timestamp<T0, T1>(arg0: &StakingPool<T0>) : u64 {
        if (!rewarder_exists<T0, T1>(arg0)) {
            return 0
        };
    ...
    public fun rewarder_total_stake_snapshot<T0, T1>(arg0: &StakingPool<T0>) : u64 {
        if (!rewarder_exists<T0, T1>(arg0)) {
            return 0
        };
    ...
    public fun set_stake_cap<T0>(arg0: &mut StakingPool<T0>, arg1: &AdminCap, arg2: u64) {
        assert_valid_package_version<T0>(arg0);
        arg0.stake_cap = arg2;
    }
    ...
    fun settle_reward<T0, T1>(arg0: &mut Rewarder<T0, T1>, arg1: address, arg2: u64) : u64 {
        ...
        let v1 = 0x1::u64::min(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::floor(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::mul_u64(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::sub(arg0.unit, v0), arg2)), 0x2::balance::value<T1>(&arg0.pool));
        let v2 = 0x2::balance::split<T1>(&mut arg0.pool, v1);
        let v3 = arg0.unit;
        let v4 = reward_data_mut_or_insert<T0, T1>(arg0, arg1);
        v4.unit = v3;
        0x2::balance::join<T1>(&mut v4.reward, v2);
        v1
    }

    public fun settle_rewarder_on_deposit<T0, T1>(arg0: &mut DepositChecker<T0>, arg1: &mut StakingPool<T0>, arg2: &0x2::clock::Clock) {
    ...
    public fun settle_rewarder_on_withdraw<T0, T1>(arg0: &mut WithdrawChecker<T0>, arg1: &mut StakingPool<T0>, arg2: &0x2::clock::Clock) {
        assert_valid_package_version<T0>(arg1);
        let v0 = &mut arg0.rewarder_ids;
        check_and_settle_rewarder<T0, T1>(arg1, v0, arg0.account, arg0.prev_stake_amount, arg2);
    }
    ...
    fun stake_amount<T0>(arg0: &StakingPool<T0>, arg1: address) : u64 {
    ...
    public fun stake_exists<T0>(arg0: &StakingPool<T0>, arg1: address) : bool {
        0x2::table::contains<address, StakePosition>(&arg0.stake_table, arg1)
    }

    fun stake_position<T0>(arg0: &StakingPool<T0>, arg1: address) : &StakePosition {
        0x2::table::borrow<address, StakePosition>(&arg0.stake_table, arg1)
    }

    fun stake_position_mut_or_insert<T0>(arg0: &mut StakingPool<T0>, arg1: address) : &mut StakePosition {
    ...
    public fun supply<T0, T1>(arg0: &mut StakingPool<T0>, arg1: 0x2::coin::Coin<T1>) {
        deposit_to_source<T0, T1>(arg0, arg1);
    }

    public fun total_stake_amount<T0>(arg0: &StakingPool<T0>) : u64 {
    ...
    public fun update_flow_rate<T0, T1>(arg0: &mut StakingPool<T0>, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest) {
        assert_valid_package_version<T0>(arg0);
        assert_sender_is_manager<T0>(arg0, arg4);
        if (arg3 == 0) {
            abort 13906835557323833360
        };
        let v0 = id<T0>(arg0);
        let v1 = rewarder_mut<T0, T1>(arg0);
    ...
    public fun withdraw_from_source<T0, T1>(arg0: &mut StakingPool<T0>, arg1: &AdminCap, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert_valid_package_version<T0>(arg0);
        let v0 = rewarder_mut<T0, T1>(arg0);
    ...
    public fun withdrawable_amount<T0>(arg0: &StakingPool<T0>, arg1: address) : u64 {
        if (stake_exists<T0>(arg0, arg1)) {
            stake_position<T0>(arg0, arg1).stake_amount
        } else {
            0
