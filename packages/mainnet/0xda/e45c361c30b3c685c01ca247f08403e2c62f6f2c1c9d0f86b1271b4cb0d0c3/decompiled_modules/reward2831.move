module 0xdae45c361c30b3c685c01ca247f08403e2c62f6f2c1c9d0f86b1271b4cb0d0c3::reward2831 {
    struct REWARD2831 has drop {
        dummy_field: bool,
    }

    struct TICKET_2831 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2831(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2831>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2831>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2831, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2831>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2831>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2831>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2831>>(v5, 0x2::tx_context::sender(arg1));
    }
