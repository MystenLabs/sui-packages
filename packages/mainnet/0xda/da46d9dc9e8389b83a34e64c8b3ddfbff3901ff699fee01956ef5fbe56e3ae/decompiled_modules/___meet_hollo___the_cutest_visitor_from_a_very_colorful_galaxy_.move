module 0xdada46d9dc9e8389b83a34e64c8b3ddfbff3901ff699fee01956ef5fbe56e3ae::___meet_hollo___the_cutest_visitor_from_a_very_colorful_galaxy_ {
    struct ___MEET_HOLLO___THE_CUTEST_VISITOR_FROM_A_VERY_COLORFUL_GALAXY_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ___MEET_HOLLO___THE_CUTEST_VISITOR_FROM_A_VERY_COLORFUL_GALAXY_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<___MEET_HOLLO___THE_CUTEST_VISITOR_FROM_A_VERY_COLORFUL_GALAXY_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(x"f09f91bd204d65657420486f6c6c6f20e2809320546865204375746573742056697369746f722046726f6d2061205665727920436f6c6f7266756c2047616c61787921"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://dnslONoHetP3oE8TfXKyK2LmjiDmFs3Xneb_PjmywfE"));
