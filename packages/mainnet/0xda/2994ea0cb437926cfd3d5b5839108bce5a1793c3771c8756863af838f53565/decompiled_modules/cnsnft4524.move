module 0xda2994ea0cb437926cfd3d5b5839108bce5a1793c3771c8756863af838f53565::cnsnft4524 {
    struct CNSNFT4524 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4524, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4524>(arg0, arg1);
