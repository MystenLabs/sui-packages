module 0xdae767165d0cc241c07bc8ae58f778065c9b868c657560c9efe1dab4d6af8cdf::bluemove_launchpad {
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LaunchpadData{
            ...
            minted         : 0,
            current_nft    : 0,
            base_name      : 0x1::string::utf8(b"Wagmi Whales #"),
            base_url       : 0x1::string::utf8(b"https://static.bluemove.net/wagmi-whales-1/"),
            base_image_url : 0x1::string::utf8(b"https://ipfs.bluemove.net/uploads2/wagmi-whales/images/"),
            description    : 0x1::string::utf8(b"Wagmi whales are building the first-ever Sui branding platform.This is not a normal branding, we want to connect the real world (Wagmi Whales shop) with the web3 (Wagmi Whales Nfts). The Wagmi Whales Nfts will be like company actions."),
            ...
            fund_address   : @0x3747108374d2460fd0cb086d911e7625e6f2c5ffe3083d7a3662789f7674ec3b,
        ...
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::add_domain<HOMINIDS, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::display_info::DisplayInfo>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::display_info::new(0x1::string::utf8(b"Wagmi Whales"), 0x1::string::utf8(b"Wagmi whales are building the first-ever Sui branding platform.This is not a normal branding, we want to connect the real world (Wagmi Whales shop) with the web3 (Wagmi Whales Nfts). The Wagmi Whales Nfts will be like company actions.")));
