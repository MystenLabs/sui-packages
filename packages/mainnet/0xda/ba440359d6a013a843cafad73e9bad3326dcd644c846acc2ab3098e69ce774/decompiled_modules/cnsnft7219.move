module 0xdaba440359d6a013a843cafad73e9bad3326dcd644c846acc2ab3098e69ce774::cnsnft7219 {
    struct CNSNFT7219 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7219, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7219>(arg0, arg1);
