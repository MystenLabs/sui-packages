module 0xda33315cb14049a455ae9f7b029314bf85839b5650843b8b818b76956c5d3b05::memorial {
    ...
    public entry fun mint(arg0: &mut Counter, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::string::utf8(b"Sui 1000 Days #");
        0x1::string::append(&mut v1, u64_to_string(arg0.value));
        let v2 = Memorial{
            id          : 0x2::object::new(arg1),
            name        : v1,
            description : 0x1::string::utf8(b"Sui 1000 Days anniversary"),
