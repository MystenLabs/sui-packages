module 0xda2f6ff34616e09e231c8d637380550a5e15b05666edcf061aaa2256f5a5332a::vault {
    ...
    public(friend) fun initialize<T0, T1, T2>(arg0: 0x2::coin::TreasuryCap<T2>, arg1: 0x2::object::ID, arg2: u64, arg3: u8, arg4: u8, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = Vault<T0, T1, T2>{
            id              : 0x2::object::new(arg7),
            vt_treasury_cap : arg0,
            account_cap     : 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::create_account(arg7),
            pool_id         : arg1,
            target_leverage : arg2,
            a_index         : arg3,
            b_index         : arg4,
            withdrawal_fees : arg6,
            slippage        : arg5,
            collected_fees  : 0x2::balance::zero<T0>(),
            swap_routes     : 0x2::table::new<0x1::type_name::TypeName, vector<0x360802cb106b004205cd67a706e314eaeadd8590d5f4d1cee46137566232a627::bag_value::Value>>(arg7),
        };
