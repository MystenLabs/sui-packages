module 0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::surf {
    ...
    public fun mint(arg0: &mut MintConfig, arg1: &mut 0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::recorder::Recorder, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : SurfNFT {
        assert!(arg0.version == 1, 0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::errors::wrong_version());
        let v0 = if (arg0.live) {
            if (arg0.season >= 1) {
                arg0.mint_cost > 0
        ...
        assert!(v0, 0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::errors::not_configured());
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = current_week(arg0, arg2);
        assert!(0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::recorder::points_of(arg1, v1) >= arg0.threshold, 0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::errors::below_threshold());
        if (v2 >= 2 && arg0.weekly_cap > 0) {
            assert!(weekly_minted(arg0, v1, v2) < arg0.weekly_cap, 0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::errors::weekly_cap_reached());
        };
        0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::recorder::add_spent(arg1, v1, arg0.mint_cost);
