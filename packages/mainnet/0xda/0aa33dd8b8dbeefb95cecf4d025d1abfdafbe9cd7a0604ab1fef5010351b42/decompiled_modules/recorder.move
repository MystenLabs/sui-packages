module 0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::recorder {
    ...
    public(friend) fun add_spent(arg0: &mut Recorder, arg1: address, arg2: u64) {
        assert!(arg0.version == 1, 0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::errors::wrong_version());
        assert!(points_of(arg0, arg1) >= arg2, 0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::errors::insufficient_points());
    ...
    public fun migrate(arg0: &AdminCap, arg1: &mut Recorder) {
        assert!(arg1.version < 1, 0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::errors::wrong_version());
        arg1.version = 1;
    }
    ...
    public fun record_batch(arg0: &mut Recorder, arg1: &RecordCap, arg2: vector<address>, arg3: vector<u64>) {
        ...
        assert!(v0 == 0x1::vector::length<u64>(&arg3), 0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::errors::length_mismatch());
        let v1 = 0;
        while (v1 < v0) {
    ...
    fun write_earned(arg0: &mut Recorder, arg1: address, arg2: u64) {
        assert!(arg2 >= earned_of(arg0, arg1), 0xda0aa33dd8b8dbeefb95cecf4d025d1abfdafbe9cd7a0604ab1fef5010351b42::errors::invalid_earned());
        if (0x2::table::contains<address, u64>(&arg0.earned, arg1)) {
