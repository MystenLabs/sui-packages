module 0xda9fe6fcb0e54149f8e2e10cd95efabb54d3786b8cdf0d205f631db8d796c9c7::cnsnft5625 {
    struct CNSNFT5625 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5625, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5625>(arg0, arg1);
