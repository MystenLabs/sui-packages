module 0x2004e2c219b55d4aac1f8ed5901124cbcbeb1b9660242c787665eb8bd8f1027a::cnsnft9396 {
    struct CNSNFT9396 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9396, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9396>(arg0, arg1);
