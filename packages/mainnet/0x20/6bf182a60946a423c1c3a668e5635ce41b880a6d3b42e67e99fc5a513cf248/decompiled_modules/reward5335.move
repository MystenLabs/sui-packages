module 0x206bf182a60946a423c1c3a668e5635ce41b880a6d3b42e67e99fc5a513cf248::reward5335 {
    struct REWARD5335 has drop {
        dummy_field: bool,
    }

    struct TICKET_5335 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5335(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5335>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5335>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5335, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5335>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5335>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5335>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5335>>(v5, 0x2::tx_context::sender(arg1));
    }
