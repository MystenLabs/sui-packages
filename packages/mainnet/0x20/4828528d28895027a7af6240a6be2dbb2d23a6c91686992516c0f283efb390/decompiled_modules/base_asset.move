module 0xd2197b1ce2096e96e726c29fa2c138c5c6748da169b81d34927c522b7499f1d7::base_asset {
    public(friend) fun init_state<T0: drop, T1: store + key>(arg0: T0, arg1: vector<0x1::string::String>, arg2: vector<0x1::string::String>, arg3: u16, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, @0x6c2378ae18657590ced4526843028337ebe96c0142230dd4ac8b7430b5526168);
        0x2::transfer::public_transfer<0x2::display::Display<T1>>(v1, @0x6c2378ae18657590ced4526843028337ebe96c0142230dd4ac8b7430b5526168);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<T1>>(v4, @0x6c2378ae18657590ced4526843028337ebe96c0142230dd4ac8b7430b5526168);
    }
