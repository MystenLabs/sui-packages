module 0xd2197b1ce2096e96e726c29fa2c138c5c6748da169b81d34927c522b7499f1d7::collector {
    ...
    fun init(arg0: COLLECTOR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<CollectorAdminCap>(v0, @0x6c2378ae18657590ced4526843028337ebe96c0142230dd4ac8b7430b5526168);
        0x2::transfer::public_transfer<0x2::package::Publisher>(0x2::package::claim<COLLECTOR>(arg0, arg1), @0x6c2378ae18657590ced4526843028337ebe96c0142230dd4ac8b7430b5526168);
        let v1 = Collector{
