module 0x20a91c1820075aa86fd1b63dc9fc9a5abf59701a0c7025316357dd5b64ce1392::cnsnft8619 {
    struct CNSNFT8619 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8619, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8619>(arg0, arg1);
