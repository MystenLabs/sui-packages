module 0x202f90d73ac7efd8de8cc809c875f48ba5a046cc41f4d93f20a13c3683955ad4::cnsnft4656 {
    struct CNSNFT4656 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4656, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4058"));
        let v4 = 0x2::package::claim<CNSNFT4656>(arg0, arg1);
