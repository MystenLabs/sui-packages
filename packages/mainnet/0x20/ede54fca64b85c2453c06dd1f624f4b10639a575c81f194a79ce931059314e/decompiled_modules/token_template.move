module 0x20ede54fca64b85c2453c06dd1f624f4b10639a575c81f194a79ce931059314e::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"FIN152560", b"FixedInit 152560", b"Fixed with initial supply verification", 0x1::option::none<0x2::url::Url>(), arg1);
