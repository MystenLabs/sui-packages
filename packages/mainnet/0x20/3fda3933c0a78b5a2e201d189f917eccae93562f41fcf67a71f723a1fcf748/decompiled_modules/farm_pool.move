module 0x203fda3933c0a78b5a2e201d189f917eccae93562f41fcf67a71f723a1fcf748::farm_pool {
    ...
    public fun remove_liquidity<T0, T1>(arg0: &mut FarmPool<T0, T1>, arg1: &mut 0x203fda3933c0a78b5a2e201d189f917eccae93562f41fcf67a71f723a1fcf748::position::Position, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: &0x2::clock::Clock, arg5: u128, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        0x203fda3933c0a78b5a2e201d189f917eccae93562f41fcf67a71f723a1fcf748::position::decrease_liquidity(arg1, arg5);
        ...
        let v5 = RemoveLiquidityEvent{
            ...
            base_position_id      : 0x2::object::id<0x203fda3933c0a78b5a2e201d189f917eccae93562f41fcf67a71f723a1fcf748::position::Position>(arg1),
    ...
    public fun add_coin_a_to_surplus<T0, T1>(arg0: &mut FarmPool<T0, T1>, arg1: 0x2::coin::Coin<T0>) {
        0x2::balance::join<T0>(&mut arg0.surplus_balance_a, 0x2::coin::into_balance<T0>(arg1));
    }

    public fun add_coin_b_to_surplus<T0, T1>(arg0: &mut FarmPool<T0, T1>, arg1: 0x2::coin::Coin<T1>) {
        0x2::balance::join<T1>(&mut arg0.surplus_balance_b, 0x2::coin::into_balance<T1>(arg1));
    }

    public fun add_initial_liquidity<T0, T1>(arg0: &mut FarmPool<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x203fda3933c0a78b5a2e201d189f917eccae93562f41fcf67a71f723a1fcf748::position::Position {
        let v0 = get_next_position_index<T0, T1>(arg0);
        let v1 = 0x203fda3933c0a78b5a2e201d189f917eccae93562f41fcf67a71f723a1fcf748::position::new(v0, 0x2::object::id<FarmPool<T0, T1>>(arg0), 0, arg7);
        let v2 = &mut v1;
        do_add_liquidity<T0, T1>(arg0, v2, arg1, arg2, 0x2::coin::into_balance<T0>(arg3), 0x2::coin::into_balance<T1>(arg4), arg5, arg6, arg7);
        v1
    }

    public fun add_rewards<T0, T1>(arg0: &mut FarmPool<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: u128, arg6: &0x2::clock::Clock) {
    ...
    public fun collect_fee_and_keep<T0, T1>(arg0: &mut AdminCap, arg1: &mut FarmPool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: &0x2::tx_context::TxContext) {
    ...
    fun do_add_liquidity<T0, T1>(arg0: &mut FarmPool<T0, T1>, arg1: &mut 0x203fda3933c0a78b5a2e201d189f917eccae93562f41fcf67a71f723a1fcf748::position::Position, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: 0x2::balance::Balance<T0>, arg5: 0x2::balance::Balance<T1>, arg6: u128, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        0x203fda3933c0a78b5a2e201d189f917eccae93562f41fcf67a71f723a1fcf748::position::increase_liquidity(arg1, v7);
