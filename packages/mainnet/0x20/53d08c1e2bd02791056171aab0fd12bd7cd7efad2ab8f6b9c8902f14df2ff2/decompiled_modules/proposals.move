module 0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::proposals {
    struct Proposal<phantom T0: drop, T1: drop + store> has store {
        key: 0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::roles::Role<T0>,
    ...
    public(friend) fun new<T0: drop, T1: drop + store>(arg0: 0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::roles::Role<T0>, arg1: 0x1::option::Option<T1>, arg2: address, arg3: u64) : Proposal<T0, T1> {
        Proposal<T0, T1>{
            key                   : arg0,
            value                 : arg1,
            proposer              : arg2,
    ...
    public(friend) fun destroy<T0: drop, T1: drop + store>(arg0: Proposal<T0, T1>) : (0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::roles::Role<T0>, 0x1::option::Option<T1>) {
        let Proposal {
            key                   : v0,
            value                 : v1,
            proposer              : _,
