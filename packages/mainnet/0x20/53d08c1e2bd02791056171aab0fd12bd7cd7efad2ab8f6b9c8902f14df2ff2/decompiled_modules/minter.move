module 0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::minter {
    ...
    public fun mint<T0>(arg0: &mut 0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::treasury::ManagedTreasury<T0>, arg1: &0x2::deny_list::DenyList, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::roles::assert_is_authorized<MinterRole>(0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::treasury::roles<T0>(arg0), 0x2::tx_context::sender(arg5));
        0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::roles::assert_is_not_paused<MinterRole>(0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::treasury::roles<T0>(arg0));
        assert!(!0x2::coin::deny_list_contains<T0>(arg1, arg3), 2);
        let v0 = 0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::roles::config_mut<MinterRole, MintConfig>(0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::treasury::roles_mut<T0>(arg0), 0x2::tx_context::sender(arg5));
        add_mint_transaction(v0, arg2, 0x2::clock::timestamp_ms(arg4));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::mint<T0>(0x2053d08c1e2bd02791056171aab0fd12bd7cd7efad2ab8f6b9c8902f14df2ff2::treasury::treasury_cap_mut<T0>(arg0), arg2, arg5), arg3);
        let v1 = MintEvent<T0>{
            amount    : arg2,
            recipient : arg3,
        };
