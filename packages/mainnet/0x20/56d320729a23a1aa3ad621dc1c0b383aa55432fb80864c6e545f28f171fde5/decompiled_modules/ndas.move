module 0x2056d320729a23a1aa3ad621dc1c0b383aa55432fb80864c6e545f28f171fde5::ndas {
    struct NDAS has drop {
        dummy_field: bool,
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<NDAS>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<NDAS>>(0x2::coin::mint<NDAS>(arg0, arg1, arg3), arg2);
    }
    ...
    fun init(arg0: NDAS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<NDAS>>(0x2::coin::mint<NDAS>(&mut v5, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
