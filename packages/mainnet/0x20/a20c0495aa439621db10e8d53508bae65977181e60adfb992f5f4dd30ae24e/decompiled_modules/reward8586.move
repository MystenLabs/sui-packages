module 0x20a20c0495aa439621db10e8d53508bae65977181e60adfb992f5f4dd30ae24e::reward8586 {
    struct REWARD8586 has drop {
        dummy_field: bool,
    }

    struct TICKET_8586 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8586(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8586>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8586>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8586, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8586>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8586>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8586>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8586>>(v5, 0x2::tx_context::sender(arg1));
    }
