module 0x2065862614bc8416840918edb085b96c400c19110b5d4451ca077e5356a0afec::utils {
    public fun get_description_nft() : vector<u8> {
        b"After the Genesis cats and toxic serum were launched, The Rats are the last animals that will be one of the 3 items that will help Genesis Chillcats bring Toxic Serum into Cat labs."
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeif5vpbxht6ty47tkgl4rrjn37kpn7p2cltoz5nocuvexuttuqiyqa/"
    }
    ...
    public fun get_key_public() : vector<u8> {
        x"59e79fdd7c6444de5b3c1fd7ee9e8b734321a69cb5b9d20600c1ea801f4fa6e5"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeihtlm5hamiq7yphnxljus3ou5n2jx2l644imlkq5jmhvoytbnf5re/"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/ChillCatsNft"
    }
