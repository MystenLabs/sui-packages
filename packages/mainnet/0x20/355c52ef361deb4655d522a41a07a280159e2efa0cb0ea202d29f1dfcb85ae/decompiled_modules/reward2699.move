module 0x20355c52ef361deb4655d522a41a07a280159e2efa0cb0ea202d29f1dfcb85ae::reward2699 {
    struct REWARD2699 has drop {
        dummy_field: bool,
    }

    struct TICKET_2699 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2699(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2699>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2699>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2699, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2699>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2699>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2699>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2699>>(v5, 0x2::tx_context::sender(arg1));
    }
