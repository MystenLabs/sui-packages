module 0x20c72989543389981b9f740630beba1f690d898a66c9e3045f41362a9bffc4b9::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<SNFT>(v6, @0xc0634ed9d194db97a50573ee62001a90ced5fb54b3dc953aa54def56c5ececa);
    }
