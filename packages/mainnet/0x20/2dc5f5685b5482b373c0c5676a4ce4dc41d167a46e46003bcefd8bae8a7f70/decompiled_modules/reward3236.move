module 0x202dc5f5685b5482b373c0c5676a4ce4dc41d167a46e46003bcefd8bae8a7f70::reward3236 {
    struct REWARD3236 has drop {
        dummy_field: bool,
    }

    struct TICKET_3236 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3236(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3236>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3236>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3236, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3236>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3236>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3236>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3236>>(v5, 0x2::tx_context::sender(arg1));
    }
