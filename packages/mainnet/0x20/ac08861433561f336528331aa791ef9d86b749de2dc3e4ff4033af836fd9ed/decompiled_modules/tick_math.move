module 0xb073375aba97556eff7a6263fe686a421e3365877dedb6f68ea938e234d0bf85::tick_math {
    ...
    public fun get_sqrt_ratio_at_tick(arg0: u32) : u256 {
        ...
        let v5 = v4;
        if (v0 & 2 != 0) {
            v5 = v4 * 340248342086729790484326174814286782776 >> 128;
        };
        if (v0 & 4 != 0) {
            let v6 = v5 * 340214320654664324051920982716015181256;
            v5 = v6 >> 128;
        };
        if (v0 & 8 != 0) {
            let v7 = v5 * 340146287995602323631171512101879684296;
            v5 = v7 >> 128;
        };
        if (v0 & 16 != 0) {
            let v8 = v5 * 340010263488231146823593991679159461427;
            v5 = v8 >> 128;
        };
        if (v0 & 32 != 0) {
            let v9 = v5 * 339738377640345403697157401104375501982;
            v5 = v9 >> 128;
        };
        if (v0 & 64 != 0) {
            let v10 = v5 * 339195258003219555707034227454543996957;
            v5 = v10 >> 128;
        };
        if (v0 & 128 != 0) {
            let v11 = v5 * 338111622100601834656805679988414885836;
            v5 = v11 >> 128;
        };
        if (v0 & 256 != 0) {
            let v12 = v5 * 335954724994790223023589805789778977431;
            v5 = v12 >> 128;
        };
        if (v0 & 512 != 0) {
            let v13 = v5 * 331682121138379247127172139078559816769;
            v5 = v13 >> 128;
        };
        if (v0 & 1024 != 0) {
            let v14 = v5 * 323299236684853023288211250268160617703;
            v5 = v14 >> 128;
        };
        if (v0 & 2048 != 0) {
            let v15 = v5 * 307163716377032989948697243942600081960;
            v5 = v15 >> 128;
        };
        if (v0 & 4096 != 0) {
            let v16 = v5 * 277268403626896220162999269216087591491;
            v5 = v16 >> 128;
        };
        if (v0 & 8192 != 0) {
            let v17 = v5 * 225923453940442621947126027127485385540;
            v5 = v17 >> 128;
        };
        if (v0 & 16384 != 0) {
            let v18 = v5 * 149997214084966997727330242082538198250;
            v5 = v18 >> 128;
        };
        if (v0 & 32768 != 0) {
            let v19 = v5 * 66119101136024775622716233608466511143;
            v5 = v19 >> 128;
        };
        if (v0 & 65536 != 0) {
            let v20 = v5 * 12847376061809297530290974190478135677;
            v5 = v20 >> 128;
        };
        if (v0 & 131072 != 0) {
            let v21 = v5 * 3774311387461140608698956196802507295;
            v5 = v21 >> 128;
        };
        if (v0 & 262144 != 0) {
