module 0x20862519f25f20ad3e3e0e10533f57782c87995b70bda7097238f151a7a32787::cnsnft6279 {
    struct CNSNFT6279 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6279, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6279>(arg0, arg1);
