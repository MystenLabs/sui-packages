module 0x2072d1dbbe6a9bcf6db131d0762a4ed1880c0c272b888ba54843628f27f71743::cnsnft8571 {
    struct CNSNFT8571 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8571, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8571>(arg0, arg1);
