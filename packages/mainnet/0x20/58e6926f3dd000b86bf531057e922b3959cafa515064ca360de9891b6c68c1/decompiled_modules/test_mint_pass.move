module 0x2058e6926f3dd000b86bf531057e922b3959cafa515064ca360de9891b6c68c1::test_mint_pass {
    struct TEST_MINT_PASS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TEST_MINT_PASS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TEST_MINT_PASS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Test Mint pass"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Do not buy"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreign26drwgefzo4wqnrn4ggwiobnb2m6gcfslnqc6vjmpwpx4jbmru"));
