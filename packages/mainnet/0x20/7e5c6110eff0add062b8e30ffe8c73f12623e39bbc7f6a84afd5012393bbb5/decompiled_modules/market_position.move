module 0x2b71664477755b90f9fb71c9c944d5d0d3832fec969260e3f18efc7d855f57c4::market_position {
    ...
    public(friend) fun update_lp_display<T0: drop>(arg0: &mut MarketPosition, arg1: &0x2b71664477755b90f9fb71c9c944d5d0d3832fec969260e3f18efc7d855f57c4::py::PyState<T0>) {
        let v0 = 9;
        if (0x2::dynamic_field::exists_<0x1::type_name::TypeName>(0x2b71664477755b90f9fb71c9c944d5d0d3832fec969260e3f18efc7d855f57c4::py::get_state_id<T0>(arg1), 0x1::type_name::get<T0>())) {
            v0 = *0x2::dynamic_field::borrow<0x1::type_name::TypeName, u8>(0x2b71664477755b90f9fb71c9c944d5d0d3832fec969260e3f18efc7d855f57c4::py::get_state_id<T0>(arg1), 0x1::type_name::get<T0>());
        };
