module 0x20610d4d1f037809b5ea9fd9fd6102fe9a649eb6d0f16903d8b14d5dfc9769c4::dripdrop {
    ...
    public(friend) entry fun join_game<T0>(arg0: &0x20610d4d1f037809b5ea9fd9fd6102fe9a649eb6d0f16903d8b14d5dfc9769c4::admins::Owner, arg1: &0x20610d4d1f037809b5ea9fd9fd6102fe9a649eb6d0f16903d8b14d5dfc9769c4::state::State, arg2: &mut DripDrop<T0>, arg3: &mut 0x20610d4d1f037809b5ea9fd9fd6102fe9a649eb6d0f16903d8b14d5dfc9769c4::nft_earnings::NftEarnings<T0>, arg4: address, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: 0x2::coin::Coin<T0>, arg9: &0x2::random::Random, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::object_table::contains<address, Game<T0>>(&arg2.games, arg4), 0);
        ...
        if (!0x2::object_table::contains<address, PlayerStatistics<T0>>(&arg2.player_statistics, v6)) {
            let v18 = if (v6 == v1.creator) {
                1
            } else {
                0
            };
            let v19 = if (v6 == v1.creator) {
                0
            } else {
                1
            };
            ...
            0x2::object_table::add<address, PlayerStatistics<T0>>(&mut arg2.player_statistics, v6, v20);
        };
        let v21 = 0x2::object_table::borrow_mut<address, PlayerStatistics<T0>>(&mut arg2.player_statistics, v6);
        if (v6 == v1.creator) {
            v21.games_as_creator = v21.games_as_creator + 1;
        } else {
            v21.games_as_joiner = v21.games_as_joiner + 1;
        };
        v21.games_won = v21.games_won + 1;
        v21.total_won = v21.total_won + v10 - v8;
        v21.current_win_streak = v21.current_win_streak + 1;
        if (v21.current_win_streak > v21.best_win_streak) {
            v21.best_win_streak = v21.current_win_streak;
        };
        v21.last_updated_at = v17;
        if (!0x2::object_table::contains<address, PlayerStatistics<T0>>(&arg2.player_statistics, v7)) {
            let v22 = if (v7 == v1.creator) {
                1
            } else {
                0
            };
            let v23 = if (v7 == v1.creator) {
                0
            } else {
                1
            };
            let v24 = PlayerStatistics<T0>{
                id                 : 0x2::object::new(arg11),
                player             : v7,
                games_as_creator   : v22,
                games_as_joiner    : v23,
                games_lost         : 1,
                games_won          : 0,
                total_lost         : v2,
            ...
            0x2::object_table::add<address, PlayerStatistics<T0>>(&mut arg2.player_statistics, v7, v24);
        };
        let v25 = 0x2::object_table::borrow_mut<address, PlayerStatistics<T0>>(&mut arg2.player_statistics, v7);
        if (v7 == v1.creator) {
            v25.games_as_creator = v25.games_as_creator + 1;
        } else {
            v25.games_as_joiner = v25.games_as_joiner + 1;
        };
        v25.games_lost = v25.games_lost + 1;
        v25.total_lost = v25.total_lost + v2;
        v25.current_win_streak = 0;
        v25.last_updated_at = v17;
        let v26 = GameResolvedEvent<T0>{
            game_id        : arg4,
            creator        : v1.creator,
        ...
        0x2::event::emit<GameResolvedEvent<T0>>(v26);
    }
