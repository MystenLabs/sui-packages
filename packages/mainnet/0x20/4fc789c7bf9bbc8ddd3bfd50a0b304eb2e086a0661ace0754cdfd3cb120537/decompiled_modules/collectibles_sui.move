module 0x204fc789c7bf9bbc8ddd3bfd50a0b304eb2e086a0661ace0754cdfd3cb120537::collectibles_sui {
    struct COLLECTIBLES_SUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: COLLECTIBLES_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<COLLECTIBLES_SUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Collectibles Sui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Collectibles Sui NFT Collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiehzxpw3ujwrzqjehcsaoud7wbk44z4vlw4tukn4iacgk3rdzelnu"));
