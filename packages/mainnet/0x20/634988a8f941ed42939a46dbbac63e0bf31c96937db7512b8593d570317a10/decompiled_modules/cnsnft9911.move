module 0x20634988a8f941ed42939a46dbbac63e0bf31c96937db7512b8593d570317a10::cnsnft9911 {
    struct CNSNFT9911 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9911, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9911>(arg0, arg1);
