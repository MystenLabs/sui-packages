module 0x20196c0736b4422cf758c462eb3da4f5537aad1012777ecd87353c89aaa8e234::trenches {
    ...
    fun init(arg0: TRENCHES, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/BeSMc2tNrosjDieMuCT9n8cBzq1NraLyp1A1WwBZQAPw.png                                                                                                                                                                                                                               ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<TRENCHES>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TRENCHES  ")))), trim_right(b"TRENCHESCOIN                    "), trim_right(b"The Original coin of Trenches.                                                                                                                                                                                                                                                                                                  "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
