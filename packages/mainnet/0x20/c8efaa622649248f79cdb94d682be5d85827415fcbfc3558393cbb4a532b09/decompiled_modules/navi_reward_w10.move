module 0x20c8efaa622649248f79cdb94d682be5d85827415fcbfc3558393cbb4a532b09::navi_reward_w10 {
    struct NAVI_REWARD_W10 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = NAVI_REWARD{
                ...
                image_url   : 0x1::string::utf8(b"ipfs://QmSbVfmGsYvGcekqomxkS5yULrVLMDGkFLHxMSG1GTQ1yR"),
    ...
    fun init(arg0: NAVI_REWARD_W10, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmSbVfmGsYvGcekqomxkS5yULrVLMDGkFLHxMSG1GTQ1yR"));
        ...
        let v4 = 0x2::package::claim<NAVI_REWARD_W10>(arg0, arg1);
