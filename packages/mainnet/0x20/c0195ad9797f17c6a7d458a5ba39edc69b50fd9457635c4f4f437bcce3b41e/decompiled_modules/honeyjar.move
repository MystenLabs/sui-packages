module 0x20c0195ad9797f17c6a7d458a5ba39edc69b50fd9457635c4f4f437bcce3b41e::honeyjar {
    ...
    struct MarketplaceChef has key {
        id: 0x2::object::UID,
        claim_honey_cap: 0xfaadf16158c8194de9a8eb306389bf3cd709f6bbfee1a8bef66892f36486f34e::honey_trade::ClaimHoneyCap,
        mint_fee: u64,
        balance: 0x2::balance::Balance<0x2::sui::SUI>,
        honeyjars: 0x2::linked_table::LinkedTable<address, address>,
        claim_locked: bool,
        honey_rewards: 0x2::balance::Balance<0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::honey::HONEY>,
        last_claim_ts: u64,
    ...
    public fun add_to_honeyjar(arg0: &HoneyJarPointsCap, arg1: &0x2::clock::Clock, arg2: &mut MarketplaceChef, arg3: &mut 0xfaadf16158c8194de9a8eb306389bf3cd709f6bbfee1a8bef66892f36486f34e::honey_trade::HoneyManager, arg4: &mut HoneyJar, arg5: u64) {
    ...
    public fun claim_honey(arg0: &0x2::clock::Clock, arg1: &mut MarketplaceChef, arg2: &mut 0xfaadf16158c8194de9a8eb306389bf3cd709f6bbfee1a8bef66892f36486f34e::honey_trade::HoneyManager, arg3: &mut HoneyJar, arg4: &mut 0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::honey_yield::HoneyYield, arg5: &mut 0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::honey_yield::FeeCollector<0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::honey::HONEY>, arg6: &mut 0x2::token::TokenPolicy<0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::honey::HONEY>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg3.claimable_rewards > 0) {
            0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::token_rules::from_coin_and_transfer<0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::honey::HONEY>(0x2::coin::from_balance<0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::honey::HONEY>(0x2::balance::split<0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::honey::HONEY>(&mut arg1.honey_rewards, arg3.claimable_rewards), arg7), arg5, arg4, arg6, 0x2::tx_context::sender(arg7), arg7);
    ...
    public fun claim_sui_collected(arg0: &mut MarketplaceChef, arg1: &HoneyJarFeeClaimCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.balance), arg2, arg3);
    }
    ...
    public fun get_marketplace_chef_info(arg0: &MarketplaceChef) : (u64, u64, u64, bool, u64, u64, u256, u64, u64) {
        (arg0.mint_fee, 0x2::balance::value<0x2::sui::SUI>(&arg0.balance), 0x2::linked_table::length<address, address>(&arg0.honeyjars), arg0.claim_locked, 0x2::balance::value<0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::honey::HONEY>(&arg0.honey_rewards), arg0.last_claim_ts, arg0.global_claim_index, arg0.total_distributed, arg0.active_points)
    }
    ...
    fun increment_global_index(arg0: &0x2::clock::Clock, arg1: &mut 0xfaadf16158c8194de9a8eb306389bf3cd709f6bbfee1a8bef66892f36486f34e::honey_trade::HoneyManager, arg2: &mut MarketplaceChef) {
        if (arg2.active_points == 0) {
            return
        };
        let v0 = 0xfaadf16158c8194de9a8eb306389bf3cd709f6bbfee1a8bef66892f36486f34e::honey_trade::claim_honey(&mut arg2.claim_honey_cap, arg1, arg0);
        let v1 = 0x2::balance::value<0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::honey::HONEY>(&v0);
        arg2.global_claim_index = arg2.global_claim_index + 0xc7f41f8852439daefb6ace539e999258e72ab6f3e97f7b08924d20f7e4ea7dc6::math::mul_div_u256((v1 as u256), (1000000000000 as u256), (arg2.active_points as u256));
        arg2.last_claim_ts = 0x2::clock::timestamp_ms(arg0);
        arg2.total_distributed = arg2.total_distributed + v1;
        0x2::balance::join<0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::honey::HONEY>(&mut arg2.honey_rewards, v0);
    }

    fun increment_honeyjar_rewards(arg0: &0x2::clock::Clock, arg1: &mut 0xfaadf16158c8194de9a8eb306389bf3cd709f6bbfee1a8bef66892f36486f34e::honey_trade::HoneyManager, arg2: &mut MarketplaceChef, arg3: &mut HoneyJar) {
        increment_global_index(arg0, arg1, arg2);
        arg3.claimable_rewards = arg3.claimable_rewards + (0xc7f41f8852439daefb6ace539e999258e72ab6f3e97f7b08924d20f7e4ea7dc6::math::mul_div_u256(arg2.global_claim_index - arg3.claim_index, (arg3.active_points as u256), (1000000000000 as u256)) as u64);
    ...
    public fun init_marketplace_chef(arg0: &mut HoneyJarAdminCap, arg1: 0xfaadf16158c8194de9a8eb306389bf3cd709f6bbfee1a8bef66892f36486f34e::honey_trade::ClaimHoneyCap, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = MarketplaceChef{
            ...
            claim_locked       : true,
            honey_rewards      : 0x2::balance::zero<0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::honey::HONEY>(),
    ...
    public fun mint_honeyjar(arg0: &0x2::clock::Clock, arg1: &mut MarketplaceChef, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xe40c3d6a24938abb6c01a8801b46b26cc449c78ae5e0a64b6c61a157498d0be::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg3), arg3);
        let v2 = HoneyJar{
    ...
    public fun remove_from_honeyjar(arg0: &HoneyJarPointsCap, arg1: &0x2::clock::Clock, arg2: &mut MarketplaceChef, arg3: &mut 0xfaadf16158c8194de9a8eb306389bf3cd709f6bbfee1a8bef66892f36486f34e::honey_trade::HoneyManager, arg4: &mut HoneyJar, arg5: u64) {
        validation_check(arg2);
        box_validation_check(arg4);
        increment_honeyjar_rewards(arg1, arg3, arg2, arg4);
        arg2.active_points = arg2.active_points - arg5;
