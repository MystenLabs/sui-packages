module 0x2066c1991846358bb0a0ca563023f47175ce36c06ab23328a6cb5eb6d3780242::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"MOODENG", b"Moo Deng On Sui", b"This is MooDeng On Sui Chain", 0x1::option::none<0x2::url::Url>(), arg1);
