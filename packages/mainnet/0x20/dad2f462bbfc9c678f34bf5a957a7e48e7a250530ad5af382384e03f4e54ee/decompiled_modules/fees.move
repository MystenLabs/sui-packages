module 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::fees {
    ...
    public(friend) fun accrue(arg0: &mut FeeVault, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x1::option::Option<address>) {
        accrue_split(arg0, arg1, arg2, arg3, 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::creator_bps(), 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::referrer_bps());
    }
    ...
    fun accrue_split(arg0: &mut FeeVault, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x1::option::Option<address>, arg4: u64, arg5: u64) {
        ...
        let v1 = 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::math::mul_bps(v0, arg4);
        let v2 = if (0x1::option::is_some<address>(&arg3)) {
            0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::math::mul_bps(v0, arg5)
        } else {
            0
        };
        let v3 = v0 - v1 - v2;
    ...
    public(friend) fun accrue_with_config(arg0: &mut FeeVault, arg1: &0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::Config, arg2: 0x2::object::ID, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: 0x1::option::Option<address>) {
        let (v0, v1, _) = 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::fee_split(arg1);
    ...
    public fun claim_creator_tokens<T0>(arg0: &mut FeeVault, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(v3 > 0, 1);
        0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::events::fees_claimed(v0, 0x1::ascii::string(b"creator-tokens"), 0x1::option::some<0x2::object::ID>(arg1), v3, 0x2::clock::timestamp_ms(arg2));
    ...
    public fun claim_protocol_by_fee_claimer(arg0: &0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::FeeClaimerCap, arg1: &0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::Config, arg2: &mut FeeVault, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::assert_fee_claimer(arg1, arg0);
    ...
    fun pay_protocol(arg0: &mut FeeVault, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::events::fees_claimed(arg1, 0x1::ascii::string(b"protocol"), 0x1::option::none<0x2::object::ID>(), v0, 0x2::clock::timestamp_ms(arg2));
