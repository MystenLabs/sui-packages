module 0x20211fdaccfcac7408e8ef60b3fee5d6a2550d4b2770c16d5fd5812810b7ea3a::reward4248 {
    struct REWARD4248 has drop {
        dummy_field: bool,
    }

    struct TICKET_4248 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4248(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4248>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4248>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4248, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4248>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4248>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4248>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4248>>(v5, 0x2::tx_context::sender(arg1));
    }
