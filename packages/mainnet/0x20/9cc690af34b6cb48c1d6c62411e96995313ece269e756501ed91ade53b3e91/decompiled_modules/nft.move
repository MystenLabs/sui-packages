module 0x209cc690af34b6cb48c1d6c62411e96995313ece269e756501ed91ade53b3e91::nft {
    ...
    public entry fun mint(arg0: &mut Collection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v3, 100000000, arg2), @0x968fa1041658d0ab16a38bb00cf3a24284d94c679cd42c171ac4f6da1ac2a363);
        let v4 = MintNFTEvent{
