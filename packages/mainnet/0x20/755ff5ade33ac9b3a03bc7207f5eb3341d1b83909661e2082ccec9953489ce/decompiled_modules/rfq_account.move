module 0x20755ff5ade33ac9b3a03bc7207f5eb3341d1b83909661e2082ccec9953489ce::rfq_account {
    ...
    struct Account has key {
        ...
        nonce_lanes: 0x20755ff5ade33ac9b3a03bc7207f5eb3341d1b83909661e2082ccec9953489ce::table_set::TableSet<0x2::object::ID>,
    }
    ...
    public fun add_nonce_lane(arg0: &mut Account, arg1: &AccountCap, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x20755ff5ade33ac9b3a03bc7207f5eb3341d1b83909661e2082ccec9953489ce::table_set::add<0x2::object::ID>(&mut arg0.nonce_lanes, 0x2::object::uid_to_inner(&v0.id));
    ...
    public fun create(arg0: vector<u8>, arg1: &mut 0x2::tx_context::TxContext) : AccountCap {
        let v0 = Account{
            ...
            public_key  : arg0,
            nonce_lanes : 0x20755ff5ade33ac9b3a03bc7207f5eb3341d1b83909661e2082ccec9953489ce::table_set::new<0x2::object::ID>(arg1),
        };
        let v1 = AccountCap{
            id         : 0x2::object::new(arg1),
    ...
    public fun destroy(arg0: Account, arg1: AccountCap) {
        ...
        0x20755ff5ade33ac9b3a03bc7207f5eb3341d1b83909661e2082ccec9953489ce::table_set::drop<0x2::object::ID>(v4);
    }
    ...
    public fun remove_nonce_lane(arg0: &mut Account, arg1: NonceLane, arg2: &AccountCap) {
        ...
        let v2 = v0;
        assert!(0x20755ff5ade33ac9b3a03bc7207f5eb3341d1b83909661e2082ccec9953489ce::table_set::contains<0x2::object::ID>(&arg0.nonce_lanes, 0x2::object::uid_to_inner(&v2)), 0);
        0x20755ff5ade33ac9b3a03bc7207f5eb3341d1b83909661e2082ccec9953489ce::table_set::remove<0x2::object::ID>(&mut arg0.nonce_lanes, 0x2::object::uid_to_inner(&v2));
        0x2::object::delete(v2);
    }
