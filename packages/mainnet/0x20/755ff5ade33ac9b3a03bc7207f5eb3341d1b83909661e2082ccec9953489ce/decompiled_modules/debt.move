module 0x20755ff5ade33ac9b3a03bc7207f5eb3341d1b83909661e2082ccec9953489ce::debt {
    ...
    public fun calc_debt(arg0: &Debt, arg1: &mut 0x20755ff5ade33ac9b3a03bc7207f5eb3341d1b83909661e2082ccec9953489ce::trusted_prices::TrustedPriceData) : u64 {
        ...
        while (!0x1::vector::is_empty<0x1::type_name::TypeName>(&v0)) {
            ...
            let v3 = 0x20755ff5ade33ac9b3a03bc7207f5eb3341d1b83909661e2082ccec9953489ce::trusted_prices::pull_raw_price(arg1, v2);
            v1 = v1 + 0x20755ff5ade33ac9b3a03bc7207f5eb3341d1b83909661e2082ccec9953489ce::price::calc_value(&v3, *0x2::table::borrow<0x1::type_name::TypeName, u64>(&arg0.open_debt, v2));
        };
        v1
    }
