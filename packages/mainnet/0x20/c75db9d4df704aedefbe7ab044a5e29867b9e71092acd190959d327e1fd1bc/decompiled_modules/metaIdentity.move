module 0x20c75db9d4df704aedefbe7ab044a5e29867b9e71092acd190959d327e1fd1bc::metaIdentity {
    struct MetaIdentity has key {
        ...
        bind_status: bool,
        items: 0x20c75db9d4df704aedefbe7ab044a5e29867b9e71092acd190959d327e1fd1bc::items::Items,
        wallet: address,
    }
    ...
    public fun get_items_info(arg0: &MetaIdentity, arg1: &0x20c75db9d4df704aedefbe7ab044a5e29867b9e71092acd190959d327e1fd1bc::items::ItemGlobal) : 0x1::string::String {
        0x20c75db9d4df704aedefbe7ab044a5e29867b9e71092acd190959d327e1fd1bc::items::get_items_info(arg1, &arg0.items)
    }

    public fun add_whitelist_by_type(arg0: &mut MetaInfoGlobal, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(@0x1cb722782ce2440afefff4062fd0bd98021c09b5ef720b7e584e7c071cd417 == 0x2::tx_context::sender(arg3), 4);
    ...
    public entry fun deleteMeta(arg0: MetaIdentity) {
        ...
        0x20c75db9d4df704aedefbe7ab044a5e29867b9e71092acd190959d327e1fd1bc::items::destroy_empty(v6);
    ...
    public fun get_items(arg0: &mut MetaIdentity) : &mut 0x20c75db9d4df704aedefbe7ab044a5e29867b9e71092acd190959d327e1fd1bc::items::Items {
        &mut arg0.items
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = MetaInfoGlobal{
            ...
            register_owner         : @0x1cb722782ce2440afefff4062fd0bd98021c09b5ef720b7e584e7c071cd417,
    ...
    public entry fun mintInviteMeta(arg0: &mut MetaInfoGlobal, arg1: u64, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = MetaIdentity{
            ...
            email       : arg4,
            bind_status : true,
            items       : 0x20c75db9d4df704aedefbe7ab044a5e29867b9e71092acd190959d327e1fd1bc::items::new(arg6),
    ...
    public entry fun mintMeta(arg0: &mut MetaInfoGlobal, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = MetaIdentity{
            ...
            email       : arg3,
            bind_status : true,
            items       : 0x20c75db9d4df704aedefbe7ab044a5e29867b9e71092acd190959d327e1fd1bc::items::new(arg5),
