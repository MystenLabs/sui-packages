module 0x208214b85d31fce0f9aab95ca3125ca182e16e679cd92540ef24ac3160568bd3::omg_protocol {
    ...
    fun update_campaign_rewards_(arg0: &mut WrapperState, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2 * v0.reward_rate * 0x2::balance::value<OMG_PROTOCOL>(&v0.omg_usd_reserves) / 1000000;
        if (v3 == 0) {
            return
        };
