module 0x20e24fdee895724896b8c23f97e528a32ed3480b959fb54c4963a53913a80868::walrus {
    ...
    fun init(arg0: WALRUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://-7qyuMrtvoRPGmvtgQDp7TTbVsblDRggCL6zE_m4BJg"));
