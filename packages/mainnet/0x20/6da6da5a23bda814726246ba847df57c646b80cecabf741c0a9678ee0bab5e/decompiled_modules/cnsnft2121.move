module 0x206da6da5a23bda814726246ba847df57c646b80cecabf741c0a9678ee0bab5e::cnsnft2121 {
    struct CNSNFT2121 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2121, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2121>(arg0, arg1);
