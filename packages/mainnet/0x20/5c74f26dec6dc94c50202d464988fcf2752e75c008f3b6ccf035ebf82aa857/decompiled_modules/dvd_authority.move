module 0x8eb9b79a821031294e6d4ab6ae1d0904a37b93f8d85da5bfc3666874d5feeceb::dvd_authority {
    ...
    public fun issue_dvd_cap(arg0: &GovernorCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = DVDCap{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<DVDCap>(v0, 0x2::tx_context::sender(arg1));
    }
