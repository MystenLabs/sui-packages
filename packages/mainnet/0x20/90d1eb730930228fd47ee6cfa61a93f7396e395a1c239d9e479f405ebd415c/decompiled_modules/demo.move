module 0x2090d1eb730930228fd47ee6cfa61a93f7396e395a1c239d9e479f405ebd415c::demo {
    ...
    public entry fun add_payment_token<T0, T1>(arg0: &mut StakingPool<T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 2);
        assert_not_paused<T1>(arg0);
        let v0 = get_token_type_string_any<T0>();
        let v1 = PaymentTokenRegistryKey{dummy_field: false};
        let v2 = 0x2::dynamic_object_field::borrow_mut<PaymentTokenRegistryKey, PaymentTokenRegistry>(&mut arg0.id, v1);
        assert!(!0x2::table::contains<0x1::string::String, bool>(&v2.supported_tokens, v0), 36);
        0x2::table::add<0x1::string::String, bool>(&mut v2.supported_tokens, v0, true);
        0x1::vector::push_back<0x1::string::String>(&mut v2.token_list, v0);
        let v3 = PaymentTokenAdded{
            pool_id    : 0x2::object::id<StakingPool<T1>>(arg0),
            token_type : v0,
            added_by   : 0x2::tx_context::sender(arg2),
            add_time   : 0x2::clock::timestamp_ms(arg1),
        };
        0x2::event::emit<PaymentTokenAdded>(v3);
    }

    public entry fun add_payment_token_old<T0>(arg0: &mut StakingPool<T0>, arg1: 0x1::string::String, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    fun get_token_type_string_any<T0>() : 0x1::string::String {
        ...
        if (0x1::vector::length<u8>(&v0) > 0) {
            if (*0x1::vector::borrow<u8>(&v0, 0) == 76) {
    ...
    public entry fun remove_payment_token<T0, T1>(arg0: &mut StakingPool<T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 2);
        assert_not_paused<T1>(arg0);
        let v0 = get_token_type_string_any<T0>();
        let v1 = PaymentTokenRegistryKey{dummy_field: false};
        let v2 = 0x2::dynamic_object_field::borrow_mut<PaymentTokenRegistryKey, PaymentTokenRegistry>(&mut arg0.id, v1);
        assert!(0x2::table::contains<0x1::string::String, bool>(&v2.supported_tokens, v0), 35);
        0x2::table::remove<0x1::string::String, bool>(&mut v2.supported_tokens, v0);
        let (v3, v4) = 0x1::vector::index_of<0x1::string::String>(&v2.token_list, &v0);
        if (v3) {
            0x1::vector::remove<0x1::string::String>(&mut v2.token_list, v4);
        };
        let v5 = PaymentTokenRemoved{
            pool_id     : 0x2::object::id<StakingPool<T1>>(arg0),
            token_type  : v0,
            removed_by  : 0x2::tx_context::sender(arg2),
            remove_time : 0x2::clock::timestamp_ms(arg1),
        };
        0x2::event::emit<PaymentTokenRemoved>(v5);
    }

    public entry fun remove_payment_token_old<T0>(arg0: &mut StakingPool<T0>, arg1: 0x1::string::String, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.admin, 2);
        assert_not_paused<T0>(arg0);
        assert!(0x1::string::length(&arg1) > 0, 21);
        let v0 = PaymentTokenRegistryKey{dummy_field: false};
