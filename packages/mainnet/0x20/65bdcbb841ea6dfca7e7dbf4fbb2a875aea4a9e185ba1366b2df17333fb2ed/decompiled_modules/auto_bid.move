module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::auto_bid {
    ...
    entry fun new_bid<T0, T1>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: &mut StrategyPoolV2, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::operation_check(arg0);
        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::portfolio_vault_token_check<T0, T1>(arg0, arg2);
        let (v1, _, _, _, v5, _, v7, v8, v9, _, _, _) = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_mut_registry_inner(arg0);
        ...
        while (v23 < 0x2::table_vec::length<StrategyV2>(v22)) {
            ...
            if ((0x1::vector::contains<u64>(&v24.target_rounds, &v17) || 0x1::vector::length<u64>(&v24.target_rounds) == 0) && v24.bid_times < v24.max_times && v24.bid_round < v17 && 100 - (0x2::clock::timestamp_ms(arg4) - v20) * 100 / v21 <= v24.price_percentage && v24.active) {
                let v25 = v24.user;
                let v26 = v24.size;
                ...
                let (v30, v31) = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_new_bid_incentive_balance_value<T1>(v1, v13, v15, v29, v18, arg4);
                if (0x2::balance::value<T1>(v27) >= v31) {
                    if (v29 > 0) {
                        let v32 = 0x1::vector::empty<0x2::coin::Coin<T1>>();
                        0x1::vector::push_back<0x2::coin::Coin<T1>>(&mut v32, 0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(v27), arg5));
                        let (v33, v34, v35, v36, v37, v38, _, v40) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::public_new_bid_v2<T1>(v16, v15, v25, v29, v32, 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_new_bid_incentive_balance<T1>(v1, v13, v30), v18, arg4, arg5);
                        0x2::balance::join<T1>(v27, 0x2::coin::into_balance<T1>(v40));
                        if (0x2::balance::value<T1>(v27) < v31) {
                            v24.active = false;
                        };
                        0x1::vector::push_back<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&mut v24.receipts, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::public_new_bid(v14, v35, arg5));
                        ...
                        let (v41, v42) = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::tails_staking::mut_nft_table(v1);
                        if (0x2::object_table::contains<address, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(v41, v24.user)) {
                            let v43 = 0x2::object_table::borrow_mut<address, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(v41, v24.user);
                            0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::first_bid(v42, v43);
                            0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::nft_exp_up(v42, v43, 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::calculate_in_usd<T1>(v13, v36, false) * 200);
                        };
