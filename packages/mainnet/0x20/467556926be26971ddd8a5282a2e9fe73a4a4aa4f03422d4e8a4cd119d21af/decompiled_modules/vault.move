module 0xa6ce917b3fea8d6b32e7811b555f7d00b4364d0d18ea3dcb2cc340420a220a76::vault {
    ...
    fun redeem_dual_token_internal<T0, T1, T2, T3>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<vector<0x1::ascii::String>>, arg4: vector<u64>, arg5: vector<vector<u64>>, arg6: vector<u64>, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x2::coin::Coin<T3>) {
        ...
        assert!(v11 > 0, 21);
        assert!(v12 > 0, 22);
        let v30 = spend_withdraw_asset<T0, T1, T2>(arg1, v11, arg11);
        let v31 = spend_withdraw_asset<T0, T1, T3>(arg1, v12, arg11);
        let v32 = calculate_fee(v11, arg1.withdraw.fee_bps);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut v30, v32, arg11), arg1.fee_receiver);
        0x2::transfer::public_transfer<0x2::coin::Coin<T3>>(0x2::coin::split<T3>(&mut v31, v33, arg11), arg1.fee_receiver);
