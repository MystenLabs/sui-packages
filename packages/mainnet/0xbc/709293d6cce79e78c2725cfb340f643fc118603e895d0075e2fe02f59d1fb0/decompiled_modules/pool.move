module 0xbc709293d6cce79e78c2725cfb340f643fc118603e895d0075e2fe02f59d1fb0::pool {
    ...
    public entry fun create_pool<T0, T1>(arg0: &0xbc709293d6cce79e78c2725cfb340f643fc118603e895d0075e2fe02f59d1fb0::admin::AdminCap, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun set_enabled<T0, T1>(arg0: &0xbc709293d6cce79e78c2725cfb340f643fc118603e895d0075e2fe02f59d1fb0::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: bool) {
        arg1.enabled = arg2;
        let v0 = SetEnabledEvent<T0, T1>{enabled: arg2};
        0x2::event::emit<SetEnabledEvent<T0, T1>>(v0);
    }

    public entry fun set_end_time<T0, T1>(arg0: &0xbc709293d6cce79e78c2725cfb340f643fc118603e895d0075e2fe02f59d1fb0::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: u64) {
    ...
    public entry fun set_lock_duration<T0, T1>(arg0: &0xbc709293d6cce79e78c2725cfb340f643fc118603e895d0075e2fe02f59d1fb0::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: u64) {
        arg1.lock_duration = arg2;
        let v0 = SetLockDurationEvent<T0, T1>{lock_duration: arg2};
        0x2::event::emit<SetLockDurationEvent<T0, T1>>(v0);
    }

    public entry fun set_start_time<T0, T1>(arg0: &0xbc709293d6cce79e78c2725cfb340f643fc118603e895d0075e2fe02f59d1fb0::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: u64) {
        let v0 = 0x2::clock::timestamp_ms(arg2) / 1000;
    ...
    public entry fun withdraw<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut Credential<T0, T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        refresh_pool<T0, T1>(arg0, v1);
        let v2 = (((arg0.acc_reward_per_share - arg2.acc_reward_per_share) * (v0 as u128) / 1000000000000000000) as u64);
        arg2.acc_reward_per_share = arg0.acc_reward_per_share;
        arg0.staked_amount = arg0.staked_amount - arg3;
        let v3 = 0x2::tx_context::sender(arg4);
        pay_from_balance<T1>(0x2::balance::split<T1>(&mut arg0.reward, v2), v3, arg4);
        pay_from_balance<T0>(0x2::balance::split<T0>(&mut arg2.stake, arg3), v3, arg4);
    ...
    public entry fun withdraw_reward<T0, T1>(arg0: &0xbc709293d6cce79e78c2725cfb340f643fc118603e895d0075e2fe02f59d1fb0::admin::AdminCap, arg1: &mut Pool<T0, T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
