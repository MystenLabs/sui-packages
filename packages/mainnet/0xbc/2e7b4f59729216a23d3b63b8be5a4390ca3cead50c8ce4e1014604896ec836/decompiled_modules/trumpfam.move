module 0xbc2e7b4f59729216a23d3b63b8be5a4390ca3cead50c8ce4e1014604896ec836::trumpfam {
    ...
    fun init(arg0: TRUMPFAM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<TRUMPFAM>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<TRUMPFAM>>(v4);
    }
