module 0xbca5acb2ad56cd8666bd406177661888f1e641efd105b1c73599d5ec8ac7ee9c::cnsnft7594 {
    struct CNSNFT7594 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7594, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7594>(arg0, arg1);
