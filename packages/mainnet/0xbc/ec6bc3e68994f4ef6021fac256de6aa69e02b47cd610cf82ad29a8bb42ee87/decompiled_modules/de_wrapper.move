module 0x959a7135a3e96868aac57bb2ae493db76714815797349384671a62d256b1f6d::de_wrapper {
    ...
    public fun burn<T0, T1>(arg0: DeWrapper<T0, T1>) {
        let DeWrapper {
            id     : v0,
            tokens : v1,
        } = arg0;
        0x2::object::delete(v0);
        0x1::vector::destroy_empty<0x6104e610f707fe5f1b3f34aa274c113a6b0523e63d5fb2069710e1c2d1f1fd1c::de_token::DeToken<T0, T1>>(v1);
    }
    ...
    public fun force_unlock_with_whitelist<T0, T1, T2: drop>(arg0: &mut DeWrapper<T0, T1>, arg1: &mut 0x6104e610f707fe5f1b3f34aa274c113a6b0523e63d5fb2069710e1c2d1f1fd1c::de_center::DeCenter<T0, T1>, arg2: T2, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x6104e610f707fe5f1b3f34aa274c113a6b0523e63d5fb2069710e1c2d1f1fd1c::de_center::DeTokenUpdateResponse<T0, T1>) {
        0x6104e610f707fe5f1b3f34aa274c113a6b0523e63d5fb2069710e1c2d1f1fd1c::de_center::force_unlock_with_whitelist<T0, T1, T2>(arg1, take<T0, T1>(arg0, arg3), arg2, arg4, arg5)
    }
