module 0xbc1b2ca8fd3d8f899cc9655c55b15ff39bdc94b71fff5300d6850a406625f77e::cnsnft4186 {
    struct CNSNFT4186 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4186, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4186>(arg0, arg1);
