module 0xbc00fabb2670c8416cbbac99dd5d496ec9505541d8c0ad15451fc8262c012bab::cnsnft3689 {
    struct CNSNFT3689 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3689, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3689>(arg0, arg1);
