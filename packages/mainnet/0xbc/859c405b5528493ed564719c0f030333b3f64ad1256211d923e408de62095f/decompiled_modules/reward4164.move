module 0xbc859c405b5528493ed564719c0f030333b3f64ad1256211d923e408de62095f::reward4164 {
    struct REWARD4164 has drop {
        dummy_field: bool,
    }

    struct TICKET_4164 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4164(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4164>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4164>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4164, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4164>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4164>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4164>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4164>>(v5, 0x2::tx_context::sender(arg1));
    }
