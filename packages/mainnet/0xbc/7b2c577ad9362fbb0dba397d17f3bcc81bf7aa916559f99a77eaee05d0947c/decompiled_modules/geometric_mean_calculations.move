module 0x712579292f80c11a0c9de4ff553d6e5c4757105e83a8a3129823d2b39e65d062::geometric_mean_calculations {
    ...
    public fun calc_deposit_fixed_amounts_direct(arg0: &vector<u128>, arg1: &vector<u64>, arg2: &vector<u64>, arg3: &vector<u64>, arg4: &vector<u128>) : u64 {
        ...
        while (v8 < v0) {
            ...
            v12 = 0;
            while (v12 < v0) {
                let v16 = (*0x1::vector::borrow<u128>(arg0, v12) as u256);
                let v17 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v15, v16 + (*0x1::vector::borrow<u128>(arg4, v12) as u256));
                let v18 = (*0x1::vector::borrow<u64>(arg1, v12) as u256);
                let v19 = if (v17 >= v16) {
                    0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::complement((*0x1::vector::borrow<u64>(arg2, v12) as u256)), v17 - v16) + v16
                } else {
                    let v20 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::div_down(v16 - v17, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::complement((*0x1::vector::borrow<u64>(arg3, v12) as u256)));
                    if (v16 < v20) {
                        v12 = v12 + 1;
                        continue
                    };
                ...
                v13 = v13 + 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v18, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::ln(v19));
                v12 = v12 + 1;
            };
            let v21 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::exp(v13);
            if (v21 >= v1) {
                if (v15 < v5) {
                    v6 = v15;
                    v7 = v21;
        ...
        v12 = 0;
        while (v12 < v0) {
            let v25 = (*0x1::vector::borrow<u128>(arg0, v12) as u256);
            let v26 = if (0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v22, v25 + (*0x1::vector::borrow<u128>(arg4, v12) as u256)) >= v25) {
                0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::complement((*0x1::vector::borrow<u64>(arg2, v12) as u256))
            } else {
                0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::div_down(1000000000000000000, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::complement((*0x1::vector::borrow<u64>(arg3, v12) as u256)))
            };
        ...
        while (v8 < 255) {
            ...
            let v28 = 0;
            while (v12 < v0) {
                let v29 = (*0x1::vector::borrow<u128>(arg0, v12) as u256);
                let v30 = (*0x1::vector::borrow<u64>(arg1, v12) as u256);
                let v31 = *0x1::vector::borrow<u256>(&v24, v12);
                let v32 = v29 + (*0x1::vector::borrow<u128>(arg4, v12) as u256);
                ...
                v13 = v13 + 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v30, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::ln(v34));
            ...
            let v36 = v23 + 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::div_down(v1, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v28, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::exp(v13)));
    ...
    public fun calc_withdraw_flp_amounts_out(arg0: &vector<u128>, arg1: &vector<u64>, arg2: &vector<u64>, arg3: &vector<u64>, arg4: &vector<u128>, arg5: u128) : u64 {
        ...
        while (v11 < v2) {
            ...
            v17 = 0;
            while (v19 < v2) {
                let v22 = (*0x1::vector::borrow<u128>(arg0, v19) as u256);
                let v23 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v22, v0);
                let v24 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_up(v21, (*0x1::vector::borrow<u128>(arg4, v19) as u256));
                if (v24 >= v22) {
                    v18 = false;
                    break
                };
                let v25 = v22 - v24;
                let v26 = (*0x1::vector::borrow<u64>(arg2, v19) as u256);
                let v27 = (*0x1::vector::borrow<u64>(arg3, v19) as u256);
                ...
                v17 = v17 + 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down((*0x1::vector::borrow<u64>(arg1, v19) as u256), 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::ln(v28));
                v19 = v19 + 1;
            };
            if (v18) {
        ...
        v19 = 0;
        while (v19 < v2) {
            let v33 = if ((*0x1::vector::borrow<u128>(arg0, v19) as u256) * v1 >= v30 * (*0x1::vector::borrow<u128>(arg4, v19) as u256)) {
                0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::complement((*0x1::vector::borrow<u64>(arg2, v19) as u256))
            } else {
                0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::div_up(1000000000000000000, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::complement((*0x1::vector::borrow<u64>(arg3, v19) as u256)))
            };
        ...
        while (v11 < 255) {
            ...
            v18 = true;
            while (v19 < v2) {
                let v35 = (*0x1::vector::borrow<u128>(arg0, v19) as u256);
                let v36 = (*0x1::vector::borrow<u64>(arg1, v19) as u256);
                let v37 = *0x1::vector::borrow<u256>(&v32, v19);
                let v38 = (*0x1::vector::borrow<u128>(arg4, v19) as u256);
        ...
        assert!(0x712579292f80c11a0c9de4ff553d6e5c4757105e83a8a3129823d2b39e65d062::stable_calculations::check_valid_withdraw_flp_amounts_out(arg0, arg1, arg2, arg3, arg4, (v31 as u128), (arg5 as u128), 0), 14);
        (v31 as u64)
    }
