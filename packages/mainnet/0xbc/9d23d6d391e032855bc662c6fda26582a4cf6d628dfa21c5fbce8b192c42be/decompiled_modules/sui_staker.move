module 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker {
    ...
    public(friend) fun remove_stake(arg0: &mut SuiStaker, arg1: u64, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        if (arg1 > 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_pool)) {
            if (0x1::option::is_some<0x3::staking_pool::FungibleStakedSui>(&arg0.active_stake)) {
                let v3 = get_fungible_amount(&arg0.exchange_rate, arg1 - 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_pool));
                let v4 = v3;
                if (v3 < 0x3::staking_pool::fungible_staked_sui_value(0x1::option::borrow<0x3::staking_pool::FungibleStakedSui>(&arg0.active_stake))) {
                    v4 = v3 + 1;
                };
                0x2::balance::join<0x2::sui::SUI>(&mut arg0.sui_pool, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::from_balance<0x2::sui::SUI>(0x3::sui_system::redeem_fungible_staked_sui(arg2, 0x3::staking_pool::split_fungible_staked_sui(0x1::option::borrow_mut<0x3::staking_pool::FungibleStakedSui>(&mut arg0.active_stake), v4, arg4), arg4), arg4)));
            };
        };
