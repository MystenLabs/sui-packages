module 0xbc31218d17e24336bfad59df1f3096da8e90a5e20bdb2c3a6f1d6352a0661e54::astros_box {
    ...
    public fun get_display_info(arg0: u64) : (0x1::string::String, 0x1::string::String, 0x2::url::Url) {
        ...
        let v1 = 0x1::string::utf8(b"https://astrosbox.com");
        0x1::string::append(&mut v1, u64_to_string(arg0));
        (v0, 0x1::string::utf8(b"A unique Astros Box collectible NFT"), 0x2::url::new_unsafe(0x1::string::to_ascii(v1)))
    }
