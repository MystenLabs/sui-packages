module 0xbc1656a7cfbe6b287909c4b34868d1909c01b057918701bf59cc94d40493c942::cnsnft9393 {
    struct CNSNFT9393 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9393, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9393>(arg0, arg1);
