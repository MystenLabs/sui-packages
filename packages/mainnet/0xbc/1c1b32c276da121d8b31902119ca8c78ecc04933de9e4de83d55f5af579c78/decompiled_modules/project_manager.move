module 0xbc1c1b32c276da121d8b31902119ca8c78ecc04933de9e4de83d55f5af579c78::project_manager {
    ...
    public fun add_whitelist<T0>(arg0: &0xbc1c1b32c276da121d8b31902119ca8c78ecc04933de9e4de83d55f5af579c78::launchpad_manager_config::LaunchAdmin, arg1: &mut ProjectManager<T0>, arg2: address, arg3: u64) {
    ...
    public fun batch_add_whitelist<T0>(arg0: &0xbc1c1b32c276da121d8b31902119ca8c78ecc04933de9e4de83d55f5af579c78::launchpad_manager_config::LaunchAdmin, arg1: &mut ProjectManager<T0>, arg2: vector<address>, arg3: vector<u64>) {
        let v0 = 0;
    ...
    public fun batch_remove_whitelist<T0>(arg0: &mut ProjectManager<T0>, arg1: &0xbc1c1b32c276da121d8b31902119ca8c78ecc04933de9e4de83d55f5af579c78::launchpad_manager_config::LaunchAdmin, arg2: vector<address>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
    ...
    public entry fun initialize_project_manager<T0>(arg0: &0xbc1c1b32c276da121d8b31902119ca8c78ecc04933de9e4de83d55f5af579c78::launchpad_manager_config::LaunchAdmin, arg1: &mut PayNft, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u8, arg7: &mut ProjectManagerConfig, arg8: &mut 0x2::tx_context::TxContext) {
        assert_version(arg7);
        let v0 = if (arg6 == 0) {
            true
        } else if (arg6 == 1) {
    ...
    public fun project_falied<T0>(arg0: &mut ProjectManager<T0>, arg1: &0xbc1c1b32c276da121d8b31902119ca8c78ecc04933de9e4de83d55f5af579c78::launchpad_manager_config::LaunchAdmin, arg2: &0x2::clock::Clock) {
    ...
    public fun remove_whitelist<T0>(arg0: &mut ProjectManager<T0>, arg1: &0xbc1c1b32c276da121d8b31902119ca8c78ecc04933de9e4de83d55f5af579c78::launchpad_manager_config::LaunchAdmin, arg2: address) {
    ...
    public fun set_project_config_hard(arg0: &0xbc1c1b32c276da121d8b31902119ca8c78ecc04933de9e4de83d55f5af579c78::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut ProjectManagerConfig, arg2: u64, arg3: u64, arg4: u64) {
    ...
    public fun set_project_config_simple(arg0: &0xbc1c1b32c276da121d8b31902119ca8c78ecc04933de9e4de83d55f5af579c78::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut ProjectManagerConfig, arg2: u64, arg3: u64, arg4: u64) {
        let v0 = ProjectConfig{
            level              : 0,
            max_funding_amount : arg2,
            token_price        : arg3,
    ...
    public fun set_project_config_standard(arg0: &0xbc1c1b32c276da121d8b31902119ca8c78ecc04933de9e4de83d55f5af579c78::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut ProjectManagerConfig, arg2: u64, arg3: u64, arg4: u64) {
        let v0 = ProjectConfig{
            level              : 1,
            max_funding_amount : arg2,
            token_price        : arg3,
