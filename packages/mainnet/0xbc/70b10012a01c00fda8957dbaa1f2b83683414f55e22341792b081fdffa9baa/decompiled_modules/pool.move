module 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool {
    ...
    public fun new<T0, T1>(arg0: &0x2::clock::Clock, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u8, arg5: vector<u8>, arg6: vector<u8>, arg7: u8, arg8: vector<u8>, arg9: u32, arg10: u64, arg11: u128, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = Pool<T0, T1>{
            ...
            ticks_manager            : 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::initialize_manager(arg9, arg12),
        ...
        0x2::dynamic_field::add<0x1::string::String, address>(&mut v4.id, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::constants::manager(), 0x2::tx_context::sender(arg12));
        0x2::transfer::share_object<Pool<T0, T1>>(v4);
        0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::events::emit_pool_created_event(0x2::object::uid_to_inner(&v0), v2, 0x1::string::utf8(arg3), arg4, 0x1::string::utf8(arg5), v3, 0x1::string::utf8(arg6), arg7, 0x1::string::utf8(arg8), arg11, v1, arg9, arg10, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::constants::protocol_fee_share());
    }
    ...
    public fun calculate_swap_results<T0, T1>(arg0: &Pool<T0, T1>, arg1: bool, arg2: bool, arg3: u64, arg4: u128) : SwapResult {
        if (arg1) {
            assert!(arg0.current_sqrt_price > arg4 && arg4 >= 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::min_sqrt_price(), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::errors::invalid_price_limit());
        } else {
            assert!(arg0.current_sqrt_price < arg4 && arg4 <= 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::max_sqrt_price(), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::errors::invalid_price_limit());
        };
        let v0 = if (arg1) {
        ...
        while (v1.amount_specified_remaining > 0 && v1.end_sqrt_price != arg4) {
            ...
            if (v1.end_sqrt_price == v2.sqrt_price_next) {
                if (v2.initialized) {
                    let v11 = if (arg1) {
                        0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::neg(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::liquidity_net(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::get_tick_from_manager(&arg0.ticks_manager, v2.tick_index_next)))
                    } else {
    ...
    public fun close_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let (v15, v16, v17, v18) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::del(arg3);
        0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::events::emit_position_close_event(v16, v15, v17, v18);
    ...
    public fun flash_swap<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut Pool<T0, T1>, arg3: bool, arg4: bool, arg5: u64, arg6: u128) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, FlashSwapReceipt<T0, T1>) {
        ...
        0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::events::emit_flash_swap_event(0x2::object::uid_to_inner(&arg2.id), arg3, v1, v2, v0.fee_amount, v0.starting_liquidity, v0.liquidity, v0.start_sqrt_price, v0.end_sqrt_price, arg2.current_tick_index, v0.is_exceed, arg2.sequence_number);
    ...
    fun swap_in_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut Pool<T0, T1>, arg2: bool, arg3: bool, arg4: u64, arg5: u128) : SwapResult {
        if (arg2) {
            assert!(arg1.current_sqrt_price > arg5 && arg5 >= 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::min_sqrt_price(), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::errors::invalid_price_limit());
        } else {
            assert!(arg1.current_sqrt_price < arg5 && arg5 <= 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::max_sqrt_price(), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::errors::invalid_price_limit());
        };
        ...
        while (v2.amount_specified_remaining > 0 && v2.end_sqrt_price != arg5) {
            ...
            if (v2.liquidity > 0) {
                v2.fee_growth_global = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_add(v2.fee_growth_global, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor((v3.fee_amount as u128), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::constants::q64(), v2.liquidity));
            };
            ...
            if (v2.end_sqrt_price == v3.sqrt_price_next) {
                ...
                if (v3.initialized) {
                    ...
                    let v17 = if (arg2) {
                        0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::neg(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::cross(&mut arg1.ticks_manager, v3.tick_index_next, v12, v13, v16, v14, v15, v0))
                    } else {
    ...
    fun update_data_for_delta_l<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut Pool<T0, T1>, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg3: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::I128) : (u64, u64) {
        ...
        if (v1 > 0) {
            let (v8, v9) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::oracle::observe_single(&arg1.observations_manager, v7, 0, arg1.current_tick_index, arg1.liquidity);
            let v10 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::update(&mut arg1.ticks_manager, v2, arg1.current_tick_index, arg3, arg1.fee_growth_global_coin_a, arg1.fee_growth_global_coin_b, v0, v8, v9, v7, false);
            v5 = v10;
            let v11 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::update(&mut arg1.ticks_manager, v3, arg1.current_tick_index, arg3, arg1.fee_growth_global_coin_a, arg1.fee_growth_global_coin_b, v0, v8, v9, v7, true);
            v4 = v11;
            if (v10) {
        ...
        let (v12, v13, v14) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::get_fee_and_reward_growths_inside(&arg1.ticks_manager, v2, v3, arg1.current_tick_index, arg1.fee_growth_global_coin_a, arg1.fee_growth_global_coin_b, v0);
        0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::update(arg2, arg3, v12, v13, v14);
        ...
        if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::gte(arg1.current_tick_index, v2) && 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lt(arg1.current_tick_index, v3)) {
            ...
            arg1.liquidity = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::utils::add_delta(arg1.liquidity, arg3);
        };
    ...
    public fun verify_pool_manager<T0, T1>(arg0: &Pool<T0, T1>, arg1: address) : bool {
        if (*0x2::dynamic_field::borrow<0x1::string::String, address>(&arg0.id, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::constants::manager()) == arg1) {
            return true
        };
        false
    }
