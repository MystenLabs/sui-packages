module 0xbcaf7e34efb7c51cdc429e6a81686998a7a7560f7dabe4a134ec4bcbd8488bcb::blub {
    ...
    fun init(arg0: BLUB, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<BLUB>(&mut v2, 100000000000000 * 0x1::u64::pow(10, 2), 0x2::tx_context::sender(arg1), arg1);
