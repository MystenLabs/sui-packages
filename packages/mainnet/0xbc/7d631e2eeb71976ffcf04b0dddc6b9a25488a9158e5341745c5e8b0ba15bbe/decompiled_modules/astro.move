module 0xbc7d631e2eeb71976ffcf04b0dddc6b9a25488a9158e5341745c5e8b0ba15bbe::astro {
    ...
    fun init(arg0: ASTRO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<ASTRO>(arg0, 9, b"ASTRO", b"Astro", b"Liquid NFT Token for AstroBats", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), true, arg1);
        let v3 = Store{
