module 0xbce519e77c23c0a2011ccaf7028439e35cfdd0c0d56b6591ef8b12300333a2d1::reward8470 {
    struct REWARD8470 has drop {
        dummy_field: bool,
    }

    struct TICKET_8470 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8470(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8470>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8470>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8470, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8470>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8470>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8470>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8470>>(v5, 0x2::tx_context::sender(arg1));
    }
