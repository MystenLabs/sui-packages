module 0xbcf9d906f1ee17c66d8840ca92546b19f719f960791fafa94dd5290947d11907::reward8619 {
    struct REWARD8619 has drop {
        dummy_field: bool,
    }

    struct TICKET_8619 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8619(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8619>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8619>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8619, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8619>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8619>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8619>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8619>>(v5, 0x2::tx_context::sender(arg1));
    }
