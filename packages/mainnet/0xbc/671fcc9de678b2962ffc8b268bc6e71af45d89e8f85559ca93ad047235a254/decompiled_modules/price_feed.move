module 0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed {
    ...
    public fun get_max_conf_by_token(arg0: &PriceFeedConfig, arg1: 0x1::ascii::String) : u64 {
        let v0 = b"max_conf_bps";
    ...
    public fun get_token_decimal(arg0: &PriceFeedConfig, arg1: 0x1::ascii::String) : u64 {
        assert!(0x2::dynamic_field::exists_with_type<0x1::ascii::String, u64>(&arg0.id, arg1), 3);
    ...
    public entry fun remove_token_decimal(arg0: &AdminCap, arg1: &mut PriceFeedConfig, arg2: 0x1::ascii::String, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::dynamic_field::exists_with_type<0x1::ascii::String, u64>(&arg1.id, arg2), 3);
    ...
    entry fun set_max_conf_by_token(arg0: &AdminCap, arg1: &mut PriceFeedConfig, arg2: 0x1::ascii::String, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 >= 0 && arg3 <= 10000, 4);
        let v0 = b"max_conf_bps";
        0x1::vector::append<u8>(&mut v0, 0x1::ascii::into_bytes(arg2));
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg1.id, v0)) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, u64>(&mut arg1.id, v0) = arg3;
        } else {
            0x2::dynamic_field::add<vector<u8>, u64>(&mut arg1.id, v0, arg3);
        };
    }
