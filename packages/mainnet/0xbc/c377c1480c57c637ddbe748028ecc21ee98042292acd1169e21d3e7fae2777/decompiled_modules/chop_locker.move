module 0xbcc377c1480c57c637ddbe748028ecc21ee98042292acd1169e21d3e7fae2777::chop_locker {
    ...
    public fun calculate_apy<T0>(arg0: &0x2::balance::Balance<T0>, arg1: u64, arg2: &0x2::balance::Balance<T0>, arg3: u64) : u64 {
        ...
        if (arg1 == 0) {
            ...
            let v3 = (0x2::balance::value<T0>(arg0) as u128) * (1000000 as u128) / (arg1 as u128) * ((0x2::balance::value<T0>(arg2) / v0) as u128) * (1000000 as u128) / (v0 as u128) * (((100 * arg3 / 90 + 50) * 1000) as u128) * (365 as u128) * (1000000 as u128) * 100 / 1;
