module 0xbcfe4e186919b3b1b0f81e5a7b637899c2b5ae4a9621be5348c0838903972c9e::reward7847 {
    struct REWARD7847 has drop {
        dummy_field: bool,
    }

    struct TICKET_7847 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7847(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7847>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7847>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7847, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7847>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7847>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7847>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7847>>(v5, 0x2::tx_context::sender(arg1));
    }
