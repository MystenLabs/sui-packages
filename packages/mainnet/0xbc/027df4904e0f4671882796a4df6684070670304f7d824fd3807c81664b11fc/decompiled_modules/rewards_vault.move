module 0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_vault {
    ...
    public fun claim<T0>(arg0: &mut RewardEpoch<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v2 = RewardClaimed{
            project          : 0x1::string::utf8(b"RiptDoge Rewards"),
    ...
    public fun create_epoch<T0, T1>(arg0: &0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::AdminCap, arg1: &mut 0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::RewardsConfig, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::assert_not_paused(arg1);
        0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::assert_holder_coin<T0>(arg1);
        assert!(arg3 > arg2, 109);
        let v0 = 0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::take_next_epoch_no(arg1);
        let v1 = 0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::default_reward_bps(arg1);
    ...
    public fun distribute<T0>(arg0: &0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::KeeperCap, arg1: &mut RewardEpoch<T0>, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == 2, 100);
        ...
        while (v1 < v0) {
            ...
            if (0x2::table::contains<address, u64>(&arg1.entitlements, v2)) {
                let v3 = 0x2::table::remove<address, u64>(&mut arg1.entitlements, v2);
                arg1.total_claimed = arg1.total_claimed + v3;
                arg1.claims_made = arg1.claims_made + 1;
                ...
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.pool, v3), arg3), v2);
            };
            v1 = v1 + 1;
        };
    }
    ...
    public fun finalize_epoch<T0>(arg0: &0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::AdminCap, arg1: &mut 0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::RewardsConfig, arg2: &mut RewardEpoch<T0>, arg3: vector<u8>, arg4: u128, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        arg2.status = 2;
        0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::record_finalized(arg1);
    ...
    public fun fund_epoch<T0>(arg0: &0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::TreasurerCap, arg1: &0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::RewardsConfig, arg2: &mut RewardEpoch<T0>, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::assert_not_paused(arg1);
    ...
    public fun set_entitlements<T0>(arg0: &0xbc027df4904e0f4671882796a4df6684070670304f7d824fd3807c81664b11fc::rewards_admin::KeeperCap, arg1: &mut RewardEpoch<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
