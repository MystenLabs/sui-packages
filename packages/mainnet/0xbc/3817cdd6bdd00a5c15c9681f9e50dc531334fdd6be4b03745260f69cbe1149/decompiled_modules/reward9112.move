module 0xbc3817cdd6bdd00a5c15c9681f9e50dc531334fdd6be4b03745260f69cbe1149::reward9112 {
    struct REWARD9112 has drop {
        dummy_field: bool,
    }

    struct TICKET_9112 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9112(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9112>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9112>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9112, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9112>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9112>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9112>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9112>>(v5, 0x2::tx_context::sender(arg1));
    }
