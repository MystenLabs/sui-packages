module 0xbc33fa18beaa19fd01108156a8e7b3558c4debc63e7ccd77c47cd52128cf7e10::reward1216 {
    struct REWARD1216 has drop {
        dummy_field: bool,
    }

    struct TICKET_1216 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1216(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_1216>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1216, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1216>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1216>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1216>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1216>>(v5, 0x2::tx_context::sender(arg1));
    }
