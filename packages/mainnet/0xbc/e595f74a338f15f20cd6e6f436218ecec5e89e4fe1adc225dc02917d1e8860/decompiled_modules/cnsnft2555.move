module 0xbce595f74a338f15f20cd6e6f436218ecec5e89e4fe1adc225dc02917d1e8860::cnsnft2555 {
    struct CNSNFT2555 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2555, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2555>(arg0, arg1);
