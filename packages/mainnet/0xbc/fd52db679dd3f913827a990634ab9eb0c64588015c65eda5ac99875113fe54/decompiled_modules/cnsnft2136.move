module 0xbcfd52db679dd3f913827a990634ab9eb0c64588015c65eda5ac99875113fe54::cnsnft2136 {
    struct CNSNFT2136 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2136, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2136>(arg0, arg1);
