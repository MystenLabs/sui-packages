module 0xbc9cab025e2b849cc6ee49eb3eb67949c9ee38de55dc69949504dd7b082ecb52::reward9080 {
    struct REWARD9080 has drop {
        dummy_field: bool,
    }

    struct TICKET_9080 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9080(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9080>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9080>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9080, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9080>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9080>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9080>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9080>>(v5, 0x2::tx_context::sender(arg1));
    }
