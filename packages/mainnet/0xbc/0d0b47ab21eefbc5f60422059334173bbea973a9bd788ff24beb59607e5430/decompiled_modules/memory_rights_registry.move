module 0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::memory_rights_registry {
    ...
    public entry fun buy_rights_sui(arg0: &mut MemoryRightsRegistry, arg1: &0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::config_registry::Config, arg2: vector<u8>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, v0 * 250 / 10000, arg4), 0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::config_registry::dev_addr(arg1));
    ...
    public entry fun buy_rights_tvyn(arg0: &mut MemoryRightsRegistry, arg1: &0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::config_registry::Config, arg2: vector<u8>, arg3: 0x2::coin::Coin<0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::tvyn::TVYN>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<u8>(&arg2) == 32, 5);
        ...
        let v1 = 0x2::coin::value<0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::tvyn::TVYN>(&arg3);
        assert!(v1 >= v0, 4);
        let v2 = *0x2::table::borrow<vector<u8>, address>(&arg0.owners, arg2);
        let v3 = 0x2::tx_context::sender(arg4);
        if (v1 > v0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::tvyn::TVYN>>(0x2::coin::split<0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::tvyn::TVYN>(&mut arg3, v1 - v0, arg4), v3);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::tvyn::TVYN>>(0x2::coin::split<0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::tvyn::TVYN>(&mut arg3, v0 * 250 / 10000, arg4), 0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::config_registry::dev_addr(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::tvyn::TVYN>>(arg3, v2);
        *0x2::table::borrow_mut<vector<u8>, address>(&mut arg0.owners, arg2) = v3;
    ...
    public entry fun create_and_share(arg0: &0xbc0d0b47ab21eefbc5f60422059334173bbea973a9bd788ff24beb59607e5430::admin::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
