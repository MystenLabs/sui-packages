module 0xbcbb44ff530f1cb6a929637b241171b68f4eddd6c6700a02e43eceb6214eabe8::movexnft3792 {
    struct MOVEXNFT3792 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT3792, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://gulery4461.icu/img/{id}"));
        ...
        let v4 = 0x2::package::claim<MOVEXNFT3792>(arg0, arg1);
