module 0xbc1191c11fe05ca17a9724b2c58b8a13292eb7483f3287202bedb5d73c8e1ad5::gift7239 {
    struct GIFT7239 has drop {
        dummy_field: bool,
    }

    struct TICKET_7239 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift7239(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7239>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7239>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT7239, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7239>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7239>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7239>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7239>>(v5, 0x2::tx_context::sender(arg1));
    }
