module 0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::gauge {
    ...
    fun check_voter_cap<T0, T1, T2>(arg0: &Gauge<T0, T1, T2>, arg1: &0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::voter_cap::VoterCap) {
        let v0 = 0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::voter_cap::get_voter_id(arg1);
        assert!(&v0 == 0x1::option::borrow<0x2::object::ID>(&arg0.voter), 9223373677533265936);
    }

    public fun claim_fees<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::notify_reward_cap::NotifyRewardCap, arg2: &mut 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
    ...
    public(friend) fun create<T0, T1, T2>(arg0: &0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::distribution_config::DistributionConfig, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) : Gauge<T0, T1, T2> {
        ...
        Gauge<T0, T1, T2>{
            ...
            distribution_config   : 0x2::object::id<0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::distribution_config::DistributionConfig>(arg0),
    ...
    public fun deposit_position<T0, T1, T2>(arg0: &0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::config::GlobalConfig, arg1: &0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::distribution_config::DistributionConfig, arg2: &mut Gauge<T0, T1, T2>, arg3: &mut 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg4: 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::position::Position, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::object::id<0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::distribution_config::DistributionConfig>(arg1) == arg2.distribution_config, 9223373183611043839);
        assert!(0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::distribution_config::is_gauge_alive(arg1, 0x2::object::id<Gauge<T0, T1, T2>>(arg2)), 9223373183612551192);
    ...
    public fun notify_reward<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::voter_cap::VoterCap, arg2: &mut 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T2>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
    ...
    public fun notify_reward_without_claim<T0, T1, T2>(arg0: &mut Gauge<T0, T1, T2>, arg1: &0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::voter_cap::VoterCap, arg2: &mut 0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T2>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        check_voter_cap<T0, T1, T2>(arg0, arg1);
        let v0 = 0x2::balance::value<T2>(&arg3);
