module 0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::voting_dao {
    ...
    fun is_checkpoint_in_new_block(arg0: &VotingDAO, arg1: 0x2::object::ID, arg2: u64) : bool {
        ...
        let v1 = v0 > 0 && arg2 - 0x2::table::borrow<u64, Checkpoint>(0x2::table::borrow<0x2::object::ID, 0x2::table::Table<u64, Checkpoint>>(&arg0.checkpoints, arg1), v0 - 1).from_timestamp < 0xbcf711836bc18d4284d9a515462279bb473bbddb5c27f85900ca797e76d82a9d::common::get_time_to_finality();
        !v1
    }
