module 0xbc93a98829b994d6135d9ef8004ae809282f84f02900e271165000be943822c5::cnsnft3144 {
    struct CNSNFT3144 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3144, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3144>(arg0, arg1);
