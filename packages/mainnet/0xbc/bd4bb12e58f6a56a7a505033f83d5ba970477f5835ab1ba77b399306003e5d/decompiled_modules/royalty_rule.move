module 0xbcbd4bb12e58f6a56a7a505033f83d5ba970477f5835ab1ba77b399306003e5d::royalty_rule {
    ...
    public fun get_basis_points<T0>(arg0: &0x2::transfer_policy::TransferPolicy<T0>) : u16 {
        let v0 = RoyaltyRule{dummy_field: false};
        0x2::transfer_policy::get_rule<T0, RoyaltyRule, RoyaltyConfig>(v0, arg0).basis_points
    }
