module 0xbcf63074736f916ca3dde060899fa2d8a91ee38d1aeb1705c22ce324bc0882ea::cnsnft4772 {
    struct CNSNFT4772 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4772, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4772>(arg0, arg1);
