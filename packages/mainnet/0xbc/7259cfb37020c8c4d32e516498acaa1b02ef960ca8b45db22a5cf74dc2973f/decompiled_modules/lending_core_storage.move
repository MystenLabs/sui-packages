module 0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::lending_core_storage {
    ...
    public fun get_app_id(arg0: &mut Storage) : u16 {
        0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::app_manager::get_app_id(&arg0.app_cap)
    }
    ...
    public(friend) fun get_app_cap(arg0: &mut Storage) : &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::app_manager::AppCap {
        &arg0.app_cap
    }
    ...
    public fun register_new_reserve(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut Storage, arg2: &0x2::clock::Clock, arg3: u16, arg4: bool, arg5: bool, arg6: u64, arg7: u256, arg8: u256, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: u256, arg14: u256, arg15: u256, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = ReserveData{
            ...
            current_borrow_index    : 0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::ray_math::ray(),
            current_liquidity_index : 0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::ray_math::ray(),
    ...
    public fun set_borrow_cap_ceiling(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut Storage, arg2: u16, arg3: u256) {
        0x2::table::borrow_mut<u16, ReserveData>(&mut arg1.reserves, arg2).borrow_cap_ceiling = arg3;
    }

    public fun set_borrow_coefficient(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut Storage, arg2: u16, arg3: u256) {
        0x2::table::borrow_mut<u16, ReserveData>(&mut arg1.reserves, arg2).borrow_coefficient = arg3;
    }

    public fun set_borrow_rate_factors(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut Storage, arg2: u16, arg3: u256, arg4: u256, arg5: u256, arg6: u256) {
    ...
    public fun set_borrowable_in_isolation(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut Storage, arg2: u16, arg3: bool) {
        0x2::table::borrow_mut<u16, ReserveData>(&mut arg1.reserves, arg2).borrowable_in_isolation = arg3;
    }

    public fun set_collateral_coefficient(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut Storage, arg2: u16, arg3: u256) {
        0x2::table::borrow_mut<u16, ReserveData>(&mut arg1.reserves, arg2).collateral_coefficient = arg3;
    }

    public fun set_is_isolated_asset(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut Storage, arg2: u16, arg3: bool) {
        0x2::table::borrow_mut<u16, ReserveData>(&mut arg1.reserves, arg2).is_isolated_asset = arg3;
    }

    public fun set_supply_cap_ceiling(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut Storage, arg2: u16, arg3: u256) {
        0x2::table::borrow_mut<u16, ReserveData>(&mut arg1.reserves, arg2).supply_cap_ceiling = arg3;
    }

    public fun set_treasury_factor(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut Storage, arg2: u16, arg3: u256) {
