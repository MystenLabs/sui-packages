module 0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::governance_v2 {
    struct GovernanceInfo has key {
        id: 0x2::object::UID,
        governance_manager_cap: 0x1::option::Option<0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceManagerCap>,
    ...
    public fun activate_governance(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut GovernanceInfo, arg2: 0x1::type_name::TypeName, arg3: 0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceManagerCap) {
        ...
        0x1::option::fill<0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceManagerCap>(&mut arg1.governance_manager_cap, arg3);
        arg1.active = true;
    }

    public fun add_guardians(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut GovernanceInfo, arg2: address) {
    ...
    public fun create_proposal<T0: drop + store, T1>(arg0: &GovernanceInfo, arg1: T0, arg2: vector<0x2::coin::Coin<T1>>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = Proposal<T0, T1>{
            ...
            certificate   : arg1,
            staked_coin   : 0x2::coin::into_balance<T1>(0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::merge_coins::merge_coin<T1>(arg2, arg3, arg4)),
            favor_num     : arg3,
            favor_votes   : v3,
            against_num   : 0,
    ...
    public fun destroy_governance_cap(arg0: 0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap) {
        0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::destroy(arg0);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GovernanceInfo{
            ...
            governance_manager_cap   : 0x1::option::none<0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceManagerCap>(),
    ...
    public fun remove_guardians(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut GovernanceInfo, arg2: address) {
    ...
    public fun update_delay(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut GovernanceInfo, arg2: u64, arg3: u64, arg4: u64) {
        assert!(arg3 > 0, 2);
    ...
    public fun update_minumum_staking(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut GovernanceInfo, arg2: u64, arg3: u64) {
        arg1.proposal_minimum_staking = arg2;
        arg1.voting_minimum_staking = arg3;
    }

    public fun upgrade(arg0: &0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap, arg1: &mut GovernanceInfo) : 0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceManagerCap {
        arg1.active = false;
        0x1::option::extract<0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceManagerCap>(&mut arg1.governance_manager_cap)
    }

    public fun vote_proposal<T0: drop + store, T1>(arg0: &GovernanceInfo, arg1: T0, arg2: &mut Proposal<T0, T1>, arg3: vector<0x2::coin::Coin<T1>>, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap> {
        ...
        if (v0 < arg2.end_vote) {
            0x2::balance::join<T1>(&mut arg2.staked_coin, 0x2::coin::into_balance<T1>(0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::merge_coins::merge_coin<T1>(arg3, arg4, arg6)));
            if (arg5) {
            ...
            0x1::option::none<0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap>()
        } else {
            0x2::coin::destroy_zero<T1>(0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::merge_coins::merge_coin<T1>(arg3, arg4, arg6));
            ...
            if (ensure_two_thirds(v10, arg2.favor_num) && v10 >= arg0.voting_minimum_staking) {
                ...
                0x1::option::some<0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceCap>(0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::create(0x1::option::borrow<0xbc7259cfb37020c8c4d32e516498acaa1b02ef960ca8b45db22a5cf74dc2973f::genesis::GovernanceManagerCap>(&arg0.governance_manager_cap)))
            } else {
                arg2.state = 4;
                let v12 = ChangeState{
                    proposal_id : 0x2::object::id<Proposal<T0, T1>>(arg2),
