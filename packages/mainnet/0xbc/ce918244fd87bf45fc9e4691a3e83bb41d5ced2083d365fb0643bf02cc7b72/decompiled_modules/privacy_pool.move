module 0xbcce918244fd87bf45fc9e4691a3e83bb41d5ced2083d365fb0643bf02cc7b72::privacy_pool {
    struct PrivacyPool has key {
        id: 0x2::object::UID,
        balance: 0x2::balance::Balance<0x2::sui::SUI>,
        merkle_tree: 0xbcce918244fd87bf45fc9e4691a3e83bb41d5ced2083d365fb0643bf02cc7b72::merkle_tree::MerkleTree,
        verifying_key: 0xbcce918244fd87bf45fc9e4691a3e83bb41d5ced2083d365fb0643bf02cc7b72::groth16_verifier::VerifyingKey,
        total_deposits: u64,
    ...
    public entry fun deposit(arg0: &mut PrivacyPool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, _) = 0xbcce918244fd87bf45fc9e4691a3e83bb41d5ced2083d365fb0643bf02cc7b72::merkle_tree::append(&mut arg0.merkle_tree, arg2);
        let v3 = Commitment{
        ...
        0x2::dynamic_field::add<vector<u8>, vector<u8>>(&mut arg0.id, arg2, arg3);
    ...
    public fun get_current_root(arg0: &PrivacyPool) : vector<u8> {
        0xbcce918244fd87bf45fc9e4691a3e83bb41d5ced2083d365fb0643bf02cc7b72::merkle_tree::get_root(&arg0.merkle_tree)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = PrivacyPool{
            ...
            merkle_tree       : 0xbcce918244fd87bf45fc9e4691a3e83bb41d5ced2083d365fb0643bf02cc7b72::merkle_tree::initialize(26, arg0),
            verifying_key     : 0xbcce918244fd87bf45fc9e4691a3e83bb41d5ced2083d365fb0643bf02cc7b72::groth16_verifier::get_default_verifying_key(),
            total_deposits    : 0,
            total_withdrawals : 0,
    ...
    public entry fun update_verifying_key(arg0: &AdminCap, arg1: &mut PrivacyPool, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<vector<u8>>) {
        arg1.verifying_key = 0xbcce918244fd87bf45fc9e4691a3e83bb41d5ced2083d365fb0643bf02cc7b72::groth16_verifier::new_verifying_key(arg2, arg3, arg4, arg5, arg6);
    }
    ...
    public entry fun withdraw(arg0: &mut PrivacyPool, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: address, arg6: u64, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xbcce918244fd87bf45fc9e4691a3e83bb41d5ced2083d365fb0643bf02cc7b72::merkle_tree::is_valid_root(&arg0.merkle_tree, arg7), 3);
        ...
        assert!(0xbcce918244fd87bf45fc9e4691a3e83bb41d5ced2083d365fb0643bf02cc7b72::groth16_verifier::verify_proof(arg1, arg2, arg3, v0, &arg0.verifying_key), 1);
        let v1 = Nullifier{
