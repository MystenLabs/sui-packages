module 0xbc5d394585149201c60b6cbec884d6d8e5b517ecc67beb4afa7b96723f0be6f4::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"BLUECAT", b"Blue Cat", b"Officia token", 0x1::option::none<0x2::url::Url>(), arg1);
