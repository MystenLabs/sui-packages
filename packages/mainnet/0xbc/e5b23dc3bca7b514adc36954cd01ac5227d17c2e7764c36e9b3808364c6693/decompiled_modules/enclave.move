module 0xbce5b23dc3bca7b514adc36954cd01ac5227d17c2e7764c36e9b3808364c6693::enclave {
    ...
    struct EnclaveRegisteredByAdmin<phantom T0> has copy, drop {
    ...
    public fun destroy_old_enclave<T0>(arg0: Enclave<T0>, arg1: &EnclaveConfig<T0>) {
        assert!(arg0.config_id == 0x2::object::id<EnclaveConfig<T0>>(arg1), 1);
    ...
    public fun register_enclave<T0>(arg0: &EnclaveConfig<T0>, arg1: 0x2::nitro_attestation::NitroAttestationDocument, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Enclave<T0>{
            ...
            config_id      : 0x2::object::id<EnclaveConfig<T0>>(arg0),
    ...
    public fun register_enclave_by_admin<T0>(arg0: &EnclaveConfig<T0>, arg1: &Cap<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = EnclaveRegisteredByAdmin<T0>{
            enclave_id     : 0x2::object::id<Enclave<T0>>(&v0),
            config_id      : 0x2::object::id<EnclaveConfig<T0>>(arg0),
            config_version : arg0.version,
            pk             : arg2,
            measurement    : arg3,
        };
        0x2::event::emit<EnclaveRegisteredByAdmin<T0>>(v1);
        0x2::transfer::share_object<Enclave<T0>>(v0);
    }
    ...
    public fun verify_signature<T0, T1: drop>(arg0: &Enclave<T0>, arg1: &EnclaveConfig<T0>, arg2: u8, arg3: u64, arg4: T1, arg5: &vector<u8>) : bool {
        assert!(arg0.config_id == 0x2::object::id<EnclaveConfig<T0>>(arg1), 1);
        assert!(arg0.config_version == arg1.version, 1);
        let v0 = create_intent_message<T1>(arg2, arg3, arg4);
        let v1 = 0x1::bcs::to_bytes<IntentMessage<T1>>(&v0);
        0x2::ed25519::ed25519_verify(arg5, &arg0.pk, &v1)
    }
