module 0xbcba9ab3a6f127c467602d3a74a63d18d19b71f4e8597330cad0af047a287f36::m0 {
    ...
    public fun g2(arg0: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg1: vector<address>) : vector<vector<UI>> {
        let v0 = 0x1::vector::empty<vector<UI>>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<address>(&arg1)) {
            let v2 = *0x1::vector::borrow<address>(&arg1, v1);
            let v3 = 0x1::vector::empty<UI>();
            let v4 = 0;
            while (v4 < 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_reserves_count(arg0)) {
                let v5 = UI{
                    d0 : v4,
                    d1 : 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_loan_balance(arg0, v4, v2),
                    d2 : 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_collateral_balance(arg0, v4, v2),
                };
                0x1::vector::push_back<UI>(&mut v3, v5);
                v4 = v4 + 1;
            };
            0x1::vector::push_back<vector<UI>>(&mut v0, v3);
        };
        v0
    }
