module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items {
    ...
    public fun get_item_category_by_type(arg0: u8) : u8 {
        if (arg0 == 1) {
            ...
            assert!(arg0 == 25, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_item_unknown_type());
            3
        }
    }
    ...
    public fun get_item_category_string(arg0: u8) : 0x1::string::String {
        if (arg0 == 1) {
            ...
            0x1::string::utf8(b"Master Woodworking")
        } else if (arg0 == 10) {
            0x1::string::utf8(b"Master Masonry")
        } else {
            assert!(arg0 == 11, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_item_unknown_type());
            0x1::string::utf8(b"Master Blacksmithing")
        }
    }
    ...
    public fun get_item_type_description(arg0: u8) : 0x1::string::String {
        if (arg0 == 1) {
            ...
            0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::utf8(b"Brutal striking tool built for heavy demolition.")
        } else if (arg0 == 21) {
            0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::utf8(b"A papermaker's frame for crafting refined sheets.")
        } else if (arg0 == 22) {
            0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::utf8(b"Precision cutting tools for shaping stone into flawless gems.")
        } else if (arg0 == 23) {
            0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::utf8(b"A finely balanced set of blades for detailed wood shaping and arcane preparation.")
        } else if (arg0 == 24) {
            0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::utf8(b"Precision instruments for shaping metal into refined wearable forms.")
        } else {
            assert!(arg0 == 25, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_item_unknown_type());
            0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::utf8(b"A heavy forging surface for shaping heated metal into usable forms.")
        }
    }
    ...
    public fun get_item_type_name(arg0: u8) : 0x1::string::String {
        if (arg0 == 1) {
            ...
            0x1::string::utf8(b"Sledgehammer")
        } else if (arg0 == 21) {
            0x1::string::utf8(b"Mould & Deckle")
        } else if (arg0 == 22) {
            0x1::string::utf8(b"Lapidary Kit")
        } else if (arg0 == 23) {
            0x1::string::utf8(b"Carving Kit")
        } else if (arg0 == 24) {
            0x1::string::utf8(b"Artificer's Kit")
        } else {
            assert!(arg0 == 25, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_item_unknown_type());
            0x1::string::utf8(b"Anvil")
        }
    }
    ...
    public fun item_category_master_blacksmithing() : u8 {
        11
    }

    public fun item_category_master_masonry() : u8 {
        10
    }

    public fun item_category_master_woodworking() : u8 {
        9
    }
    ...
    public fun item_type_anvil() : u8 {
        25
    }

    public fun item_type_artificers_kit() : u8 {
        24
    }
    ...
    public fun item_type_carving_kit() : u8 {
        23
    }
    ...
    public fun item_type_lapidary_kit() : u8 {
        22
    }
    ...
    public fun item_type_mould_deckle() : u8 {
        21
    }
    ...
    public fun item_type_sledgehammer() : u8 {
        20
    }
