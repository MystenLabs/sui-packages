module 0xbc122ff3fd0928926492864f55b7575f05c95208d6b8cd03a26b2e5ac1caf68a::ido_claim_public {
    ...
    public entry fun claim_coins_with_public(arg0: &0x2f6caff123c91121d4cc31f23a284d04a01efd19b09ece313fd172d697657228::tocen_event_ido::TocenIdoData, arg1: &mut TocenIdoDataClaim, arg2: &mut PoolClaim, arg3: u64, arg4: vector<u8>, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = &mut v3.total_public_claim;
        let v5 = &mut v3.total_claimed;
        let v6 = *v4 * arg2.percent / arg2.total_percent;
        assert!(*v5 + v6 <= *v4, 11);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xd2013e206f7983f06132d5b61f7c577638ff63171221f4f600a98863febdfb47::toce::TOCE>>(0x2::coin::from_balance<0xd2013e206f7983f06132d5b61f7c577638ff63171221f4f600a98863febdfb47::toce::TOCE>(0x2::balance::split<0xd2013e206f7983f06132d5b61f7c577638ff63171221f4f600a98863febdfb47::toce::TOCE>(&mut arg2.balance_claim, v6), arg7), 0x2::tx_context::sender(arg7));
        *v5 = *v5 + v6;
        arg1.total_claimed = arg1.total_claimed + v6;
        ...
        0x2::event::emit<EventClaim>(v7);
    }

    public entry fun create_pool_claim(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0xbc122ff3fd0928926492864f55b7575f05c95208d6b8cd03a26b2e5ac1caf68a::witness::check_owner(arg5), 1);
        let v0 = PoolClaim{
            ...
            percent         : arg3,
            total_percent   : arg4,
            key             : 0xbc122ff3fd0928926492864f55b7575f05c95208d6b8cd03a26b2e5ac1caf68a::utils::get_key_claim(),
        };
    ...
    public fun init_ido(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = TocenIdoDataClaim{
            ...
            total_token_sale         : 0xbc122ff3fd0928926492864f55b7575f05c95208d6b8cd03a26b2e5ac1caf68a::utils::get_total_token_sale(),
            percent_rate_price_sale  : 0xbc122ff3fd0928926492864f55b7575f05c95208d6b8cd03a26b2e5ac1caf68a::utils::get_percent_rate_price_sale(),
            rate_price_sale          : 0xbc122ff3fd0928926492864f55b7575f05c95208d6b8cd03a26b2e5ac1caf68a::utils::get_rate_price_sale(),
            total_claimed            : 0,
            timestamp_start_not_sale : 0xbc122ff3fd0928926492864f55b7575f05c95208d6b8cd03a26b2e5ac1caf68a::utils::get_time_not_sale(),
            not_sale                 : 0x2::balance::zero<0x2::sui::SUI>(),
            key_not_sale             : 0xbc122ff3fd0928926492864f55b7575f05c95208d6b8cd03a26b2e5ac1caf68a::utils::get_key_not_sale(),
        };
    ...
    public entry fun pool_claim_not_sale(arg0: &mut TocenIdoDataClaim, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xbc122ff3fd0928926492864f55b7575f05c95208d6b8cd03a26b2e5ac1caf68a::witness::check_owner(arg3), 1);
    ...
    public entry fun token_pool_claim(arg0: &mut PoolClaim, arg1: u64, arg2: 0x2::coin::Coin<0xd2013e206f7983f06132d5b61f7c577638ff63171221f4f600a98863febdfb47::toce::TOCE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0xbc122ff3fd0928926492864f55b7575f05c95208d6b8cd03a26b2e5ac1caf68a::witness::check_owner(arg4), 1);
    ...
    public entry fun up_pool_claim(arg0: &mut PoolClaim, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0xbc122ff3fd0928926492864f55b7575f05c95208d6b8cd03a26b2e5ac1caf68a::witness::check_owner(arg6), 1);
        assert!(arg1 == arg0.turn, 7);
    ...
    public entry fun withs(arg0: &mut TocenIdoDataClaim, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xbc122ff3fd0928926492864f55b7575f05c95208d6b8cd03a26b2e5ac1caf68a::witness::check_owner(arg2), 1);
