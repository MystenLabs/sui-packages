module 0xbc484f89bb441717705524895db9f49c21b5a872849f2e2dd4a73df7dd10d5b8::stake_frontier {
    ...
    public fun admin_stake(arg0: &mut StakingPool, arg1: &AdminCap, arg2: vector<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>, arg3: vector<address>, arg4: vector<u64>, arg5: &mut 0x2::tx_context::TxContext) {
        verify_multisig_sender(arg0, arg5);
        assert!(0x2::object::id<StakingPool>(arg0) == arg1.pool_id, 9);
        assert!(!arg0.is_paused, 3);
        let v0 = 0x1::vector::length<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(&arg2);
        assert!(v0 > 0, 5);
        ...
        while (!0x1::vector::is_empty<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(&arg2)) {
            do_stake(arg0, 0x1::vector::pop_back<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(&mut arg2), 0x1::vector::pop_back<address>(&mut arg3), 0x1::vector::pop_back<u64>(&mut arg4), arg5);
        };
        0x1::vector::destroy_empty<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(arg2);
        0x1::vector::destroy_empty<address>(arg3);
        0x1::vector::destroy_empty<u64>(arg4);
    }

    fun do_stake(arg0: &mut StakingPool, arg1: 0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(&arg1);
        assert!(!0x2::linked_table::contains<0x2::object::ID, StakedNft>(&arg0.staked_nfts, v0), 0);
        let v1 = 0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::get_token_id(&arg1);
        ...
        *v2 = *v2 + 1;
        ...
        0x2::dynamic_object_field::add<NftKey, 0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(&mut v3.id, v4, arg1);
    ...
    fun do_unstake(arg0: &mut StakingPool, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        *v8 = *v8 - 1;
        ...
        0x2::transfer::public_transfer<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(0x2::dynamic_object_field::remove<NftKey, 0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(&mut v5, v6), v3);
        let v9 = Unstaked{
            user      : v3,
            nft_id    : arg1,
            token_id  : v2,
    ...
    public fun get_multisig_address(arg0: &StakingPool) : address {
        ...
        0xbc484f89bb441717705524895db9f49c21b5a872849f2e2dd4a73df7dd10d5b8::multisig::derive_multisig_address_quiet(arg0.multisig_pks, arg0.multisig_weights, arg0.multisig_threshold)
    }
    ...
    public fun stake(arg0: &mut StakingPool, arg1: vector<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 3);
        assert!(0x1::vector::length<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(&arg1) > 0, 5);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(get_user_stake_count(arg0, v0) + 0x1::vector::length<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(&arg1) <= arg0.max_stake_per_user, 4);
        while (0x1::vector::length<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(&arg1) > 0) {
            do_stake(arg0, 0x1::vector::pop_back<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(&mut arg1), v0, 0x2::clock::timestamp_ms(arg2), arg3);
        };
        0x1::vector::destroy_empty<0x42c2cca562748d88490acb58109d4f8621ac3e170346aa60c6e52f7c50366546::xociety_frontier::XocietyFrontier>(arg1);
    }
    ...
    fun verify_multisig_sender(arg0: &StakingPool, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.multisig_configured, 8);
        assert!(0x2::tx_context::sender(arg1) == 0xbc484f89bb441717705524895db9f49c21b5a872849f2e2dd4a73df7dd10d5b8::multisig::derive_multisig_address_quiet(arg0.multisig_pks, arg0.multisig_weights, arg0.multisig_threshold), 7);
    }
