module 0x503e121622669ccffa57c5e39ceaab77f5aa365467a3f2f9b5febabb1f9d4785::cnsnft4273 {
    struct CNSNFT4273 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4273, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3836"));
        let v4 = 0x2::package::claim<CNSNFT4273>(arg0, arg1);
