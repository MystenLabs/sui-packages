module 0x50e897151fe7ed6d1c9bb18dfa8de4fcbcbd7f5f22456fa862eac234e430ee7a::auction_house {
    ...
    public fun create_user_kiosk(arg0: &mut 0x2::tx_context::TxContext) : (0x2::kiosk::Kiosk, 0x2::kiosk::KioskOwnerCap) {
        0x2::kiosk::new(arg0)
    }

    public entry fun create_user_kiosk_and_transfer(arg0: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun get_platform_kiosk_cap(arg0: &AuctionHouse) : &0x2::kiosk::KioskOwnerCap {
        &arg0.kiosk_owner_cap
    }
