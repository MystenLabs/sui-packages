module 0xd41e5cb31a5310f14d66f35cda3d2b3d0ab078959cbc015e63fff9829b83bf12::pool {
    ...
    public(friend) fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::I32, arg2: 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::I32, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: u128) {
        ...
        if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::gte(arg0.tick_index, arg1) && 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lt(arg0.tick_index, arg2)) {
    ...
    public(friend) fun clear_zero_liquidity_ticks<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::I32, arg2: 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::I32) {
        if (0xd41e5cb31a5310f14d66f35cda3d2b3d0ab078959cbc015e63fff9829b83bf12::tick::is_initialized(&arg0.ticks, arg1) && 0xd41e5cb31a5310f14d66f35cda3d2b3d0ab078959cbc015e63fff9829b83bf12::tick::get_liquidity_gross(&arg0.ticks, arg1) == 0) {
            0xd41e5cb31a5310f14d66f35cda3d2b3d0ab078959cbc015e63fff9829b83bf12::tick::clear(&mut arg0.ticks, arg1);
        };
        if (0xd41e5cb31a5310f14d66f35cda3d2b3d0ab078959cbc015e63fff9829b83bf12::tick::is_initialized(&arg0.ticks, arg2) && 0xd41e5cb31a5310f14d66f35cda3d2b3d0ab078959cbc015e63fff9829b83bf12::tick::get_liquidity_gross(&arg0.ticks, arg2) == 0) {
    ...
    public(friend) fun create<T0, T1>(arg0: u128, arg1: u32, arg2: u64, arg3: bool, arg4: 0x1::option::Option<address>, arg5: u8, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : Pool<T0, T1> {
        assert!(arg5 <= 18 && arg6 > 0, 0);
        assert!(arg2 < 0xd41e5cb31a5310f14d66f35cda3d2b3d0ab078959cbc015e63fff9829b83bf12::swap_math::fee_rate_denominator(), 1);
        if (arg3) {
            assert!(arg5 == 6 && arg6 == 1000000000, 0);
        };
        Pool<T0, T1>{
    ...
    public fun market_cap_sui<T0, T1>(arg0: &Pool<T0, T1>) : u64 {
        ...
        let v1 = if (arg0.coin_x_decimals >= 9) {
            (v0 as u256) * (v0 as u256) / 0xd41e5cb31a5310f14d66f35cda3d2b3d0ab078959cbc015e63fff9829b83bf12::constants::q128() * 0x1::u256::pow(10, arg0.coin_x_decimals - 9)
        } else {
            (v0 as u256) * (v0 as u256) / 0xd41e5cb31a5310f14d66f35cda3d2b3d0ab078959cbc015e63fff9829b83bf12::constants::q128() / 0x1::u256::pow(10, 9 - arg0.coin_x_decimals)
        };
        let v2 = v1 * (arg0.coin_x_supply as u256);
        if (v2 > (0xd41e5cb31a5310f14d66f35cda3d2b3d0ab078959cbc015e63fff9829b83bf12::constants::max_u64() as u256)) {
            0xd41e5cb31a5310f14d66f35cda3d2b3d0ab078959cbc015e63fff9829b83bf12::constants::max_u64()
        } else {
            (v2 as u64)
        }
    }
