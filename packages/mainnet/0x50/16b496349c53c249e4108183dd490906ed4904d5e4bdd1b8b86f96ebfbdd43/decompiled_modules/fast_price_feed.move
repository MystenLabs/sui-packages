module 0xee61158dda590976951425962b7486e121af4888eead3f5eba248738fe6d7b6e::fast_price_feed {
    ...
    public fun get_amount_cross_checked_with_oracle<T0>(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0xae9d0a79257bb9926a99088b385e99ccbda3d3e58aefc74568c58ef54c7212f4::nodo_price_feed::NodoPriceFeedInfo, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock) : (vector<u8>, u64, u64) {
        let (v0, v1) = get_price_cross_checked_with_oracle<T0>(arg0, arg1, arg2, arg4, arg5, arg7);
        let v2 = pow10((arg2 as u8));
        (v0, v1, safe_mul_div_u64(safe_mul_div_u64(v1, arg6, v2), pow10((arg3 as u8)), v2))
    }
    ...
    public fun get_price_cross_checked_with_oracle<T0>(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0xae9d0a79257bb9926a99088b385e99ccbda3d3e58aefc74568c58ef54c7212f4::nodo_price_feed::NodoPriceFeedInfo, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock) : (vector<u8>, u64) {
        let (v0, v1) = get_price_guarded(arg0, arg2, arg3, arg4, arg5);
        let (_, v3, v4, v5, _) = 0xae9d0a79257bb9926a99088b385e99ccbda3d3e58aefc74568c58ef54c7212f4::nodo_price_feed::get_price_no_older_than(arg1, arg3, arg5);
        assert!(0x1::type_name::into_string(0x1::type_name::get<T0>()) == v3, 6);
        let v7 = if (arg2 >= (v5 as u64)) {
            scale_price(v4, arg2 - (v5 as u64), true)
        } else {
            scale_price(v4, (v5 as u64) - arg2, false)
        };
        let v8 = if (v1 >= v7) {
            v1 - v7
        } else {
        ...
        assert!((v8 as u128) * (10000 as u128) <= (v1 as u128) * (arg4 as u128), 5);
        (v0, v1)
    }
