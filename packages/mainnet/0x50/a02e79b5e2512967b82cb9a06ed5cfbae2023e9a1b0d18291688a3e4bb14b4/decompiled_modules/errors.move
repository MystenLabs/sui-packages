module 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors {
    public fun bad_fee_bps() : u64 {
        3
    }

    public fun bad_fee_param() : u64 {
        102
    }
    ...
    public fun custody_not_empty() : u64 {
        254
    }
    ...
    public fun drip_exists() : u64 {
        74
    }

    public fun drip_missing() : u64 {
        73
    }

    public fun drip_stale() : u64 {
        72
    }
    ...
    public fun no_shares_outstanding() : u64 {
        69
    }
    ...
    public fun reward_not_allowed() : u64 {
        71
    }

    public fun same_transaction_exit() : u64 {
        75
    }
    ...
    public fun vault_cap_exceeded() : u64 {
        76
    }
