module 0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::orderbook {
    ...
    fun borrow_administrators_mut_or_create<T0: store + key, T1>(arg0: 0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::Witness<T0>, arg1: &mut Orderbook<T0, T1>) : &mut 0x2::vec_set::VecSet<address> {
        ...
        if (!0x2::dynamic_field::exists_<AdministratorsDfKey>(&arg1.id, v0)) {
    ...
    public fun edit_ask<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: u64, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.protected_actions.create_ask, 1);
        cancel_ask_<T0, T1>(arg0, arg1, arg2, arg3, arg5);
        create_ask_<T0, T1>(arg0, arg1, arg4, 0x1::option::none<0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::trading::AskCommission>(), arg3, arg5);
    }

    public fun edit_ask_with_commission<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: u64, arg3: 0x2::object::ID, arg4: u64, arg5: address, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.protected_actions.create_ask, 1);
        cancel_ask_<T0, T1>(arg0, arg1, arg2, arg3, arg7);
        create_ask_<T0, T1>(arg0, arg1, arg4, 0x1::option::some<0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::trading::AskCommission>(0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::trading::new_ask_commission(arg5, arg6)), arg3, arg7);
    }
    ...
    public fun edit_bid<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: u64, arg3: u64, arg4: &mut 0x2::coin::Coin<T1>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.protected_actions.create_bid, 1);
        cancel_bid_<T0, T1>(arg0, arg2, arg4, arg5);
        create_bid_<T0, T1>(arg0, arg1, arg3, 0x1::option::none<0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::trading::BidCommission<T1>>(), arg4, arg5);
    }

    public fun edit_bid_with_commission<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: u64, arg3: u64, arg4: address, arg5: u64, arg6: &mut 0x2::coin::Coin<T1>, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.protected_actions.create_bid, 1);
        cancel_bid_<T0, T1>(arg0, arg2, arg6, arg7);
        let v0 = 0x1::option::some<0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::trading::BidCommission<T1>>(0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::trading::new_bid_commission<T1>(arg4, 0x2::balance::split<T1>(0x2::coin::balance_mut<T1>(arg6), arg5)));
        create_bid_<T0, T1>(arg0, arg1, arg3, v0, arg6, arg7);
    }
    ...
    fun remove_start_time_<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>) {
        assert_version_and_upgrade<T0, T1>(arg0);
        let v0 = TimeLockDfKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<TimeLockDfKey>(&arg0.id, v0), 15);
    ...
    fun set_start_time_<T0: store + key, T1>(arg0: &mut Orderbook<T0, T1>, arg1: u64) {
        assert_version_and_upgrade<T0, T1>(arg0);
        let v0 = TimeLockDfKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<TimeLockDfKey>(&arg0.id, v0)) {
            let v1 = TimeLockDfKey{dummy_field: false};
