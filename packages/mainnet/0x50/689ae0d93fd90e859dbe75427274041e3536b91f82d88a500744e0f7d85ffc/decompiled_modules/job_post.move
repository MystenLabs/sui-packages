module 0x50689ae0d93fd90e859dbe75427274041e3536b91f82d88a500744e0f7d85ffc::job_post {
    ...
    public fun category(arg0: &JobPostNFT) : &0x1::string::String {
        &arg0.category
    }
    ...
    public entry fun mint_to_sender(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = JobPostNFT{
            ...
            category    : 0x1::string::utf8(arg5),
            description : 0x1::string::utf8(arg6),
            reward      : 0x1::string::utf8(arg7),
            image_url   : 0x2::url::new_unsafe_from_bytes(arg8),
        };
        let v1 = NFTMinted{
        ...
        0x2::transfer::transfer<JobPostNFT>(v0, 0x2::tx_context::sender(arg9));
    }
    ...
    public entry fun update_nft(arg0: &mut JobPostNFT, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.category = 0x1::string::utf8(arg5);
        arg0.description = 0x1::string::utf8(arg6);
        arg0.reward = 0x1::string::utf8(arg7);
        arg0.image_url = 0x2::url::new_unsafe_from_bytes(arg8);
    }
