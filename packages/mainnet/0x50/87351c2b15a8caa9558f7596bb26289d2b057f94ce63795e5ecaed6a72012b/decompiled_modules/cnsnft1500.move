module 0x5087351c2b15a8caa9558f7596bb26289d2b057f94ce63795e5ecaed6a72012b::cnsnft1500 {
    struct CNSNFT1500 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1500, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1500>(arg0, arg1);
