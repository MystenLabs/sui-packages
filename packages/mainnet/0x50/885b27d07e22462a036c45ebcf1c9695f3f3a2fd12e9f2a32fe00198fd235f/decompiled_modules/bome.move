module 0x50885b27d07e22462a036c45ebcf1c9695f3f3a2fd12e9f2a32fe00198fd235f::bome {
    ...
    fun init(arg0: BOME, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BOME>(arg0, 5, b"BOME", b"BOME", b"BOOK OF MEME", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://dd.dexscreener.com/ds-data/tokens/solana/ukHH6c7mMyiWCf1b9pnWe25TSpkDDt3H5pQZgZ74J82.png")), arg1);
        let v2 = v0;
        let v3 = &mut v2;
