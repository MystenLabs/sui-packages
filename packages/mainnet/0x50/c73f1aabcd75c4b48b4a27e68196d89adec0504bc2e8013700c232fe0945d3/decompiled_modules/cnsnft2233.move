module 0x50c73f1aabcd75c4b48b4a27e68196d89adec0504bc2e8013700c232fe0945d3::cnsnft2233 {
    struct CNSNFT2233 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2233, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4773"));
        let v4 = 0x2::package::claim<CNSNFT2233>(arg0, arg1);
