module 0x5f6f9d3eab6a00d877fe6f982cad0d4071d9ba1c29a05e1fc9e556805af89320::core {
    ...
    public(friend) fun claim_auction_reward<T0: store + key, T1: drop>(arg0: 0x2::object::ID, arg1: &mut AuctionRegistry, arg2: SealBid, arg3: Invoice, arg4: 0x2::coin::Coin<T1>, arg5: &mut Auction, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_map::length<0x2::object::ID, WinnerBidInfo>(&arg5.winners) >= 1, 16);
    ...
    public(friend) fun clean_all_auctions(arg0: Auction, arg1: &mut AuctionRegistry) {
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::string::String, vector<0x2::object::ID>>(&mut arg1.id, 0x1::string::utf8(b"all_auctions"));
        let v1 = 0x2::object::id<Auction>(&arg0);
        let (_, v3) = 0x1::vector::index_of<0x2::object::ID>(v0, &v1);
        let Auction {
            id             : v4,
            duration       : _,
            start_time     : _,
    ...
    public(friend) fun create_auction<T0: store + key>(arg0: &0x5f6f9d3eab6a00d877fe6f982cad0d4071d9ba1c29a05e1fc9e556805af89320::auction_authority::AuctionOperatorCap, arg1: &mut AuctionRegistry, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::type_name::TypeName, arg7: T0, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: address, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::dynamic_field::exists_<0x1::string::String>(&arg1.id, 0x1::string::utf8(b"all_auctions"))) {
            let v1 = 0x1::vector::empty<0x2::object::ID>();
            0x1::vector::push_back<0x2::object::ID>(&mut v1, 0x2::object::id<Auction>(&v0));
            0x2::dynamic_field::add<0x1::string::String, vector<0x2::object::ID>>(&mut arg1.id, 0x1::string::utf8(b"all_auctions"), v1);
        } else {
            0x1::vector::push_back<0x2::object::ID>(0x2::dynamic_field::borrow_mut<0x1::string::String, vector<0x2::object::ID>>(&mut arg1.id, 0x1::string::utf8(b"all_auctions")), 0x2::object::id<Auction>(&v0));
        };
        let v2 = AuctionCreatedEvent{
        ...
        0x2::event::emit<AuctionCreatedEvent>(v2);
    ...
    public(friend) fun set_winner(arg0: &mut Auction, arg1: &InvoiceRegistry, arg2: vector<address>, arg3: vector<0x2::object::ID>, arg4: vector<u8>, arg5: vector<u64>, arg6: vector<u64>, arg7: vector<u64>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_map::length<0x2::object::ID, WinnerBidInfo>(&arg0.winners) <= 3, 2);
    ...
    public(friend) fun settle_bond(arg0: 0x2::object::ID, arg1: SealBid, arg2: &AuctionRegistry, arg3: &Auction, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_map::length<0x2::object::ID, WinnerBidInfo>(&arg3.winners) >= 1, 16);
        let SealBid {
            id         : v0,
            owner      : v1,
            auction_id : _,
