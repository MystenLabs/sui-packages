module 0x50d13ebf6d73ad69ef5c15990e5aa3442ccefa30cde9c48c9bffdba6029926b8::dca {
    ...
    public fun new<T0, T1, T2: drop>(arg0: &TradePolicy, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u8, arg6: u64, arg7: u64, arg8: u64, arg9: address, arg10: &mut 0x2::tx_context::TxContext) : DCA<T0, T1> {
        ...
        let v1 = DCA<T0, T1>{
            ...
            amount_per_trade       : 0xd5cd31f4bf84a2c280c9ed20cbb20345cbe5c1ebe63014c406f97b20edd4ac63::math64::div_down(0x2::coin::value<T0>(&arg2), arg4),
            min                    : arg6,
            max                    : arg7,
            active                 : true,
            fee_percent            : arg8,
