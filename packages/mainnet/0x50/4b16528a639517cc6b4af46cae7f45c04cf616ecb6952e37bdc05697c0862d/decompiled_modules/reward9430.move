module 0x504b16528a639517cc6b4af46cae7f45c04cf616ecb6952e37bdc05697c0862d::reward9430 {
    struct REWARD9430 has drop {
        dummy_field: bool,
    }

    struct TICKET_9430 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9430(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9430>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9430>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9430, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9430>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9430>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9430>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9430>>(v5, 0x2::tx_context::sender(arg1));
    }
