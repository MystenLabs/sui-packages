module 0x502a901b59364de57f43786da65a1fd23880108c2232b81907ce993c0ba8d2b9::liquidate {
    ...
    fun get_liquidable_debtors_with_info_under_recovery_mode<T0>(arg0: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::Bucket<T0>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock) : (u64, u64, vector<address>) {
        ...
        let v8 = true;
        while (0x1::option::is_some<address>(&v2)) {
            let v9 = 0x1::option::destroy_some<address>(v2);
            if (0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::is_healthy_bottle_by_debtor<T0>(arg0, arg1, arg2, v9)) {
                break
            };
            if (v8) {
                let (v10, v11) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::get_bottle_info_with_interest_by_debtor<T0>(arg0, v9, arg2);
                v0 = v0 + v11;
                v1 = v1 + v10;
                v6 = v6 - v11;
                v7 = v7 - v10;
                v8 = is_in_recovery_mode_by_value(v6, v7, v4, v5);
            } else {
                let (v12, v13) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::get_bottle_info_with_interest_by_debtor<T0>(arg0, v9, arg2);
                if (is_under_collateralized_by_value(v13, v12, v4, v5)) {
                    v0 = v0 + v13;
                    v1 = v1 + v12;
                } else {
                    break
            ...
            v2 = *0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::next_debtor<T0>(arg0, v9);
        };
        0x1::vector::reverse<address>(&mut v3);
        (v0, v1, v3)
    }
