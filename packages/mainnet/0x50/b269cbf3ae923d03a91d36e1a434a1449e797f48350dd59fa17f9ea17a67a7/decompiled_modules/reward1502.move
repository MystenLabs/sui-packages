module 0x50b269cbf3ae923d03a91d36e1a434a1449e797f48350dd59fa17f9ea17a67a7::reward1502 {
    struct REWARD1502 has drop {
        dummy_field: bool,
    }

    struct TICKET_1502 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1502(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1502>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1502>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1502, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1502>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1502>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1502>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1502>>(v5, 0x2::tx_context::sender(arg1));
    }
