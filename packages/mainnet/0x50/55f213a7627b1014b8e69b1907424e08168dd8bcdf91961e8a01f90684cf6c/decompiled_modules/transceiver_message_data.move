module 0x5055f213a7627b1014b8e69b1907424e08168dd8bcdf91961e8a01f90684cf6c::transceiver_message_data {
    struct TransceiverMessageData<T0> has copy, drop {
        ...
        ntt_manager_payload: 0x5055f213a7627b1014b8e69b1907424e08168dd8bcdf91961e8a01f90684cf6c::ntt_manager_message::NttManagerMessage<T0>,
    }
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : TransceiverMessageData<vector<u8>> {
        ...
        TransceiverMessageData<vector<u8>>{
            ...
            ntt_manager_payload           : 0x5055f213a7627b1014b8e69b1907424e08168dd8bcdf91961e8a01f90684cf6c::ntt_manager_message::take_bytes(arg0),
        }
    }
    ...
    public fun to_bytes(arg0: TransceiverMessageData<vector<u8>>) : vector<u8> {
        ...
        let v4 = 0x5055f213a7627b1014b8e69b1907424e08168dd8bcdf91961e8a01f90684cf6c::ntt_manager_message::to_bytes(v2);
