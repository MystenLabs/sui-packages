module 0x50501775aa0101c5a6be861216143dd521e9e2f8fa27c41f040802bd5ddd0641::zzzz {
    ...
    fun init(arg0: ZZZZ, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ZZZZ>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"zzzz"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"zzzz "));
