module 0x50de3f1c277705e46d63cc0f561d895e6e67271c3752c0f2453ca19af1c67236::PENGU {
    struct PENGU has drop {
        dummy_field: bool,
    }

    fun init(arg0: PENGU, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<PENGU>(arg0, 2, b"PENGU", b"Pudgy Penguins", b"Pudgy Penguins", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/pZTRtyITScEM1SQTfmBdt2j9QnynLfhwayrnY8vqzns?ext=png")), arg1);
