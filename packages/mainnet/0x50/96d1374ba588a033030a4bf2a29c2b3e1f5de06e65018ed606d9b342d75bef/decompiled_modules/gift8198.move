module 0x5096d1374ba588a033030a4bf2a29c2b3e1f5de06e65018ed606d9b342d75bef::gift8198 {
    struct GIFT8198 has drop {
        dummy_field: bool,
    }

    struct TICKET_8198 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8198(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8198>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8198>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8198, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8198>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8198>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8198>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8198>>(v5, 0x2::tx_context::sender(arg1));
    }
