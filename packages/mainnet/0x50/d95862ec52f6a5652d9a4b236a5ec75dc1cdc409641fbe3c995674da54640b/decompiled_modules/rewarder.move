module 0x50d95862ec52f6a5652d9a4b236a5ec75dc1cdc409641fbe3c995674da54640b::rewarder {
    ...
    public(friend) fun calculate_reward_emission(arg0: &mut RewarderManager, arg1: &0x2::clock::Clock) : vector<u128> {
        let v0 = 0;
        ...
        while (v0 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            let v4 = 0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v0);
            let v5 = if (v4.emission_per_ms > 0 && v3 > v2) {
                0x50d95862ec52f6a5652d9a4b236a5ec75dc1cdc409641fbe3c995674da54640b::safe_math::mul_u128(v4.emission_per_ms, ((v3 - v2) as u128))
            } else {
                0
            };
    ...
    public fun deposit_reward<T0>(arg0: &0x50d95862ec52f6a5652d9a4b236a5ec75dc1cdc409641fbe3c995674da54640b::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) {
        0x50d95862ec52f6a5652d9a4b236a5ec75dc1cdc409641fbe3c995674da54640b::config::checked_package_version(arg0);
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun emergent_withdraw<T0>(arg0: &0x50d95862ec52f6a5652d9a4b236a5ec75dc1cdc409641fbe3c995674da54640b::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x50d95862ec52f6a5652d9a4b236a5ec75dc1cdc409641fbe3c995674da54640b::config::checked_package_version(arg0);
        0x50d95862ec52f6a5652d9a4b236a5ec75dc1cdc409641fbe3c995674da54640b::config::check_pool_manager_role(arg0, 0x2::tx_context::sender(arg3));
        let v0 = withdraw_reward<T0>(arg1, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg3), 0x50d95862ec52f6a5652d9a4b236a5ec75dc1cdc409641fbe3c995674da54640b::config::get_reward_receiver(arg0));
    ...
    public fun get_reward_emission<T0>(arg0: &RewarderManager, arg1: &0x2::clock::Clock) : u128 {
        ...
        let v1 = 0x1::option::borrow<Rewarder>(&v0).emission_per_ms;
        let v2 = 0x2::clock::timestamp_ms(arg1);
        let v3 = arg0.last_update_timestamp;
        if (v1 > 0 && v2 > v3) {
            return 0x50d95862ec52f6a5652d9a4b236a5ec75dc1cdc409641fbe3c995674da54640b::safe_math::mul_u128(v1, ((v2 - v3) as u128))
        };
        0
    }

    public fun get_rewarder_info(arg0: &Rewarder) : (u128, 0x1::type_name::TypeName) {
        (arg0.emission_per_ms, arg0.reward_coin)
    }
    ...
    public fun simulate_reward_emission(arg0: &RewarderManager, arg1: &0x2::clock::Clock) : vector<u128> {
        let v0 = 0;
        let v1 = 0x1::vector::empty<u128>();
        let v2 = 0x2::clock::timestamp_ms(arg1);
        while (v0 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            ...
            let v4 = if (v3.emission_per_ms > 0 && v2 > arg0.last_update_timestamp) {
                0x50d95862ec52f6a5652d9a4b236a5ec75dc1cdc409641fbe3c995674da54640b::safe_math::mul_u128(v3.emission_per_ms, ((v2 - arg0.last_update_timestamp) as u128))
            } else {
                0
            };
