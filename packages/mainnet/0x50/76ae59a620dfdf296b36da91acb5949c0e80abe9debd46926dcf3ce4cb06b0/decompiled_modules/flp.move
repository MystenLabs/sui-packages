module 0x5076ae59a620dfdf296b36da91acb5949c0e80abe9debd46926dcf3ce4cb06b0::flp {
    struct FLP has drop {
        dummy_field: bool,
    }
    ...
    public fun lock_flp(arg0: &AdminCap, arg1: &mut FLPApp, arg2: &0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::market::Market<0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::market_type::MainMarket>, arg3: vector<0x2::object::ID>) {
        ...
        while (v0 < 0x1::vector::length<0x2::object::ID>(&arg3)) {
            ...
            snapshot_obligation_flp_quota<0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::market_type::MainMarket>(v3, arg2, v1, v2);
            v0 = v0 + 1;
        };
    }
    ...
    fun snapshot_obligation_flp_quota<T0>(arg0: &mut FLPAmount, arg1: &0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::market::Market<T0>, arg2: 0x2::object::ID, arg3: &mut ObligationFLP) {
        ...
        while (v2 < 0x1::vector::length<0x1::type_name::TypeName>(&v1)) {
            ...
            if (v3 == &v4) {
                let v5 = FLPAmountUpdated{
                    ...
                    deposit_amount : deposit_amount<T0>(arg1, v0, *v3),
                };
