module 0x506cbb46de58b4f7a4e4213203fe4b4184ea1a087b36da62f79a32e7a9a0ece6::cnsnft4203 {
    struct CNSNFT4203 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4203, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4203>(arg0, arg1);
