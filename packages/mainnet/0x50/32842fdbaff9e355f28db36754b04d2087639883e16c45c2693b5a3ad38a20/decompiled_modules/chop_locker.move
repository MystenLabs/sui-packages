module 0x22047a701750d76b78d7d0f67fc3e5826087bed38a357c3de61a536ad75156f5::chop_locker {
    ...
    public entry fun change_max_apy<T0>(arg0: &PoolAdmin, arg1: &mut PoolConfig<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.poolAddy == 0x2::object::uid_to_address(&arg1.id), 6);
        arg1.maxAPY = arg2;
    }

    public entry fun change_max_apy2<T0>(arg0: &PoolAdmin2, arg1: &mut PoolConfig<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.poolAddy == 0x2::object::uid_to_address(&arg1.id), 6);
        arg1.maxAPY = arg2;
    }

    public entry fun create_pool_admin_override(arg0: &ChopLockerAdmin, arg1: 0x1::string::String, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = PoolAdmin2{
            id         : 0x2::object::new(arg3),
            poolAddy   : arg2,
            token_type : arg1,
        };
        0x2::transfer::transfer<PoolAdmin2>(v0, 0x2::tx_context::sender(arg3));
    }
    ...
    public entry fun fund_rewards2<T0>(arg0: &PoolAdmin2, arg1: &mut PoolConfig<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.poolAddy == 0x2::object::uid_to_address(&arg1.id), 6);
        arg1.total_rewards_added_by_admin = arg1.total_rewards_added_by_admin + 0x2::coin::value<T0>(&arg2);
        0x2::balance::join<T0>(&mut arg1.reward_balance, 0x2::coin::into_balance<T0>(arg2));
    }
    ...
    public entry fun lock_tokens<T0>(arg0: &mut PoolConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v13 = Lock<T0>{
            ...
            start_time            : v2,
            end_time              : v2 + arg3,
            locked_in_apy         : ((((365 / v1) as u128) * (0x2::balance::value<T0>(&v4) as u128) * 1000000 / (v0 as u128)) as u64),
            token_type            : arg4,
            rewards_locked        : v4,
    ...
    public fun new_pool_config<T0>(arg0: &mut PoolDirectory, arg1: 0x2::coin::Coin<T0>, arg2: 0x1::string::String, arg3: u64, arg4: &ChopLockerAdmin, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        create_pool_admin_override(arg4, arg2, v1, arg5);
        0x1::vector::insert<0x1::string::String>(&mut arg0.token_types, arg2, 0);
        0x2::transfer::transfer<PoolAdmin>(v3, 0x2::tx_context::sender(arg5));
        0x2::transfer::share_object<PoolConfig<T0>>(v2);
    }
