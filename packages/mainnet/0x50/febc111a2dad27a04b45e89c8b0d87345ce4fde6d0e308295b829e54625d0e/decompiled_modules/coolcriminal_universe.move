module 0x50febc111a2dad27a04b45e89c8b0d87345ce4fde6d0e308295b829e54625d0e::coolcriminal_universe {
    struct COOLCRIMINAL_UNIVERSE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: COOLCRIMINAL_UNIVERSE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<COOLCRIMINAL_UNIVERSE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"CoolCriminal Universe"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"An Awesome 100 Criminals Saga Collections From CoolCriminal Universe Based on SUI Chain."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeih7uolgrecbmkfljhl6ufmrtk4je6jkqoh6ccc7jmemhhqqleo7ba"));
