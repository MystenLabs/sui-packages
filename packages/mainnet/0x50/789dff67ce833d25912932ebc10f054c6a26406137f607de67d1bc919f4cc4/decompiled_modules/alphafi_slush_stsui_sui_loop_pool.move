module 0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphafi_slush_stsui_sui_loop_pool {
    ...
    struct EmergencyActivatedEvent has copy, drop {
        pool_id: 0x2::object::ID,
        collateral_moved: u64,
        x_token_supply: u64,
        tokens_invested: u64,
        sender: address,
    }

    struct EmergencyDeactivatedEvent has copy, drop {
        pool_id: 0x2::object::ID,
        amount_redeposited: u64,
        x_token_supply: u64,
        tokens_invested: u64,
        sender: address,
    }
    ...
    public fun is_emergency(arg0: &Pool) : bool {
        0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphafi_slush_stsui_sui_loop_investor::is_emergency(&arg0.investor)
    }
    ...
    public fun admin_activate_emergency(arg0: &0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphalend_slush_pool::AdminCap, arg1: &0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::version::Version, arg2: &mut Pool, arg3: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg4: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>, arg5: &mut 0x3::sui_system::SuiSystemState, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::version::assert_current_version(arg1);
        update_pool(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
        let v0 = 0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphafi_slush_stsui_sui_loop_investor::activate_emergency(&mut arg2.investor, arg3, arg6, arg7);
        update_pool(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
        let v1 = EmergencyActivatedEvent{
            pool_id          : 0x2::object::id<Pool>(arg2),
            collateral_moved : v0,
            x_token_supply   : 0x2::balance::supply_value<SupplyToken<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>>(&arg2.xTokenSupply),
            tokens_invested  : arg2.tokensInvested,
            sender           : 0x2::tx_context::sender(arg7),
        };
        0x2::event::emit<EmergencyActivatedEvent>(v1);
    }
    ...
    public fun admin_deactivate_emergency(arg0: &0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphalend_slush_pool::AdminCap, arg1: &0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::version::Version, arg2: &mut Pool, arg3: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg4: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>, arg5: &mut 0x3::sui_system::SuiSystemState, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::version::assert_current_version(arg1);
        update_pool(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
        let v0 = 0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphafi_slush_stsui_sui_loop_investor::deactivate_emergency(&mut arg2.investor, arg3, arg4, arg6, arg7);
        update_pool(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
        let v1 = EmergencyDeactivatedEvent{
            pool_id            : 0x2::object::id<Pool>(arg2),
            amount_redeposited : v0,
            x_token_supply     : 0x2::balance::supply_value<SupplyToken<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>>(&arg2.xTokenSupply),
            tokens_invested    : arg2.tokensInvested,
            sender             : 0x2::tx_context::sender(arg7),
        };
        0x2::event::emit<EmergencyDeactivatedEvent>(v1);
    }
    ...
    public fun emergency_balance(arg0: &Pool) : u64 {
        0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphafi_slush_stsui_sui_loop_investor::emergency_balance_value(&arg0.investor)
    }
