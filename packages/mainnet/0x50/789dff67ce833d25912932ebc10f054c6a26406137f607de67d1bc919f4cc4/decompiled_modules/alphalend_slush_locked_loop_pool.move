module 0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphalend_slush_locked_loop_pool {
    ...
    public fun is_emergency<T0>(arg0: &Pool<T0>) : bool {
        0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphalend_slush_locked_loop_investor::is_emergency<T0>(&arg0.investor)
    }
    ...
    public fun admin_activate_emergency<T0>(arg0: &0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphalend_slush_pool::AdminCap, arg1: &0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::version::Version, arg2: &mut Pool<T0>, arg3: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::version::assert_current_version(arg1);
        update_pool<T0>(arg1, arg2, arg3, arg4, arg5);
        let v0 = 0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphalend_slush_locked_loop_investor::activate_emergency<T0>(&mut arg2.investor, arg3, arg4, arg5);
        update_pool<T0>(arg1, arg2, arg3, arg4, arg5);
    ...
    public fun admin_deactivate_emergency<T0>(arg0: &0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphalend_slush_pool::AdminCap, arg1: &0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::version::Version, arg2: &mut Pool<T0>, arg3: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::version::assert_current_version(arg1);
        update_pool<T0>(arg1, arg2, arg3, arg4, arg5);
        let v0 = 0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphalend_slush_locked_loop_investor::deactivate_emergency<T0>(&mut arg2.investor, arg3, arg4, arg5);
        update_pool<T0>(arg1, arg2, arg3, arg4, arg5);
    ...
    fun charge_and_increase_pending_growth_based_fees<T0>(arg0: &mut Pool<T0>, arg1: u64) {
        ...
        if (0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::gt(v1, arg0.growth_based_fees.last_fee_collected_exchange_rate)) {
            ...
            let v4 = v3 - 0x1::u64::min(v3, 0x2::balance::supply_value<SupplyToken<T0>>(&arg0.xTokenSupply));
            if (v4 > 0) {
                0x2::balance::join<SupplyToken<T0>>(&mut v2.pending, 0x2::balance::increase_supply<SupplyToken<T0>>(&mut arg0.xTokenSupply, v4));
            };
        };
        arg0.tokensInvested = arg0.tokensInvested + v0;
        let v5 = exchange_rate<T0>(arg0);
    ...
    public fun emergency_balance<T0>(arg0: &Pool<T0>) : u64 {
        0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphalend_slush_locked_loop_investor::emergency_balance_value<T0>(&arg0.investor)
    }
