module 0x506998c265f9d523b55884587c2184772dd575620860547d758ea171f04843d0::fountain_core {
    ...
    public fun claim<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut Fountain<T0, T1>, arg2: &mut StakeProof<T0, T1>) : 0x2::balance::Balance<T1> {
        ...
        let v1 = (0x506998c265f9d523b55884587c2184772dd575620860547d758ea171f04843d0::math::mul_factor_u128((arg2.stake_weight as u128), arg1.cumulative_unit - arg2.start_s, 18446744073709551616) as u64);
        ...
        arg2.start_s = arg1.cumulative_unit;
    ...
    fun collect_resource<T0, T1>(arg0: &mut Fountain<T0, T1>, arg1: 0x2::balance::Balance<T1>) {
        ...
        arg0.cumulative_unit = arg0.cumulative_unit + 0x506998c265f9d523b55884587c2184772dd575620860547d758ea171f04843d0::math::mul_factor_u128((0x2::balance::value<T1>(&arg1) as u128), 18446744073709551616, (arg0.total_weight as u128));
    }
    ...
    public fun get_reward_amount<T0, T1>(arg0: &Fountain<T0, T1>, arg1: &StakeProof<T0, T1>) : u64 {
        (0x506998c265f9d523b55884587c2184772dd575620860547d758ea171f04843d0::math::mul_factor_u128((arg1.stake_weight as u128), arg0.cumulative_unit - arg1.start_s, 18446744073709551616) as u64)
    }
    ...
    fun release_resource<T0, T1>(arg0: &mut Fountain<T0, T1>, arg1: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        let v1 = 0x506998c265f9d523b55884587c2184772dd575620860547d758ea171f04843d0::math::mul_factor(arg0.flow_amount, v0 - arg0.latest_release_time, arg0.flow_interval);
        let v2 = v1;
    ...
    public fun stake<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut Fountain<T0, T1>, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : StakeProof<T0, T1> {
        ...
        let v1 = 0x506998c265f9d523b55884587c2184772dd575620860547d758ea171f04843d0::math::compute_weight(v0, arg3, arg1.min_lock_time, arg1.max_lock_time);
