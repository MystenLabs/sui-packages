module 0x50f1e9ac7c2f7952647a3e4a2fe9cbe923e25b3c53c8ba2641e2b6cfd42cc66d::cnsnft7806 {
    struct CNSNFT7806 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7806, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7806>(arg0, arg1);
