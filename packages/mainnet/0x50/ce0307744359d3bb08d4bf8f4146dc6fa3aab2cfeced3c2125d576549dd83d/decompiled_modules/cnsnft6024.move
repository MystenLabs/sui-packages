module 0x50ce0307744359d3bb08d4bf8f4146dc6fa3aab2cfeced3c2125d576549dd83d::cnsnft6024 {
    struct CNSNFT6024 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6024, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6024>(arg0, arg1);
