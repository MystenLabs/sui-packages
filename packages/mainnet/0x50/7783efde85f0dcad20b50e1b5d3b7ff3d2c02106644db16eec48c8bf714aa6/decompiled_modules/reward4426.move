module 0x507783efde85f0dcad20b50e1b5d3b7ff3d2c02106644db16eec48c8bf714aa6::reward4426 {
    struct REWARD4426 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward4426(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD4426, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4426>(arg0, arg1);
