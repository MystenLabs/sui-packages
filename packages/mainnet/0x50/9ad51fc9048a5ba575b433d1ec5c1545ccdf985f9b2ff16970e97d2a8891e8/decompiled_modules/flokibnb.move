module 0x509ad51fc9048a5ba575b433d1ec5c1545ccdf985f9b2ff16970e97d2a8891e8::flokibnb {
    struct FLOKIBNB has drop {
        dummy_field: bool,
    }

    fun init(arg0: FLOKIBNB, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FLOKIBNB>(arg0, 6, b"FLOKIBNB", b"Floki Binance Launch 18:00 UTC", b"Clean contract without minting.  Tele: https://t.me/Floki_Binance", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://i.imgur.com/n1RgNGw.png"))), arg1);
        let v2 = v0;
