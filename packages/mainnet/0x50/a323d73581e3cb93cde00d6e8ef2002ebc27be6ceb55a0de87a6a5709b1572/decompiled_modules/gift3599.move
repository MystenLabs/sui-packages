module 0x50a323d73581e3cb93cde00d6e8ef2002ebc27be6ceb55a0de87a6a5709b1572::gift3599 {
    struct GIFT3599 has drop {
        dummy_field: bool,
    }

    struct TICKET_3599 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3599(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3599>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3599>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3599, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3599>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3599>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3599>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3599>>(v5, 0x2::tx_context::sender(arg1));
    }
