module 0x50635683da607f7aa6e7a1a97986138c13e6f7c1f3b1e168f4781f143d369ed2::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"GRV", b"Gravity", b"Gravity project is avaliable now!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://iili.io/3HXwLMX.webp")), arg1);
