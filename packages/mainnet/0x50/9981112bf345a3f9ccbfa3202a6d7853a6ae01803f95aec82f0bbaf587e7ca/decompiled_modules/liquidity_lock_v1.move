module 0xe84a5a2159c893e3a4ee741205133bf08c210b06a2a2a7981c1feeaed399495::liquidity_lock_v1 {
    ...
    public fun remove_lock_liquidity_ignore_locking<T0, T1>(arg0: &0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::config::GlobalConfig, arg1: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::rewarder::RewarderGlobalVault, arg2: &mut Locker, arg3: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::Pool<T0, T1>, arg4: LockedPosition<T0, T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        checked_package_version(arg2);
        let v0 = 0x2::clock::timestamp_ms(arg5) / 1000;
        assert!(!arg2.pause, 916023534273428375);
        let v1 = true;
    ...
    public fun unlock_position_ignore_locking<T0, T1>(arg0: &mut Locker, arg1: LockedPosition<T0, T1>, arg2: &0x2::clock::Clock) : (0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::position::Position, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        checked_package_version(arg0);
        assert!(!arg0.pause, 916023534273428375);
        let v0 = UnlockPositionEvent{lock_position_id: 0x2::object::id<LockedPosition<T0, T1>>(&arg1)};
        let (v1, v2) = destroy<T0, T1>(arg1);
