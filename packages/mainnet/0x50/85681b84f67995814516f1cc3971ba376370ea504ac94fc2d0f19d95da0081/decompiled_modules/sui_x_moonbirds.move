module 0x5085681b84f67995814516f1cc3971ba376370ea504ac94fc2d0f19d95da0081::sui_x_moonbirds {
    struct SUI_X_MOONBIRDS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_X_MOONBIRDS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_X_MOONBIRDS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sui X Moonbirds"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is where Moonbirds meets the best of the Web 3. We're teaming up with creators, brands and builders to drop limited-edition digital collectibles. Every drop is part of an evolving, onchain series that let's you collects, connect, and rep your favorite projects."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeid4thsyjbnebhsxwytk56tni6vyncsqiaxb4y3ihgpt5mkcj7nnbm"));
