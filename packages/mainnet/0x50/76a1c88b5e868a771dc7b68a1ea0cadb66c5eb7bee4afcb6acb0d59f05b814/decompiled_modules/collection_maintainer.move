        ...
        while (v1 < 0x2::linked_table::length<address, vector<0x2::object::ID>>(v0)) {
            ...
            while (0x1::vector::length<0x2::object::ID>(&v4) > 0) {
                ...
                if (0x2::table::contains<address, 0x2::linked_table::LinkedTable<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>>(&arg0.supports, v2)) {
                    let v11 = 0x2::table::borrow_mut<address, 0x2::linked_table::LinkedTable<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>>(&mut arg0.supports, v2);
                    if (0x2::linked_table::contains<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>(v11, v5)) {
                        0x2::linked_table::remove<0x2::object::ID, 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_entry_type::CollectionEntrySupporterInfo>(v11, v5);
                        continue
                    };
                };
            };
