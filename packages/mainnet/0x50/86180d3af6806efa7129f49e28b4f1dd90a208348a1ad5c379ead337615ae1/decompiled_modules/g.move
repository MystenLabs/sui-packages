module 0x5086180d3af6806efa7129f49e28b4f1dd90a208348a1ad5c379ead337615ae1::g {
    struct G has key {
        id: 0x2::object::UID,
    ...
    public fun recycle(arg0: &mut G, arg1: 0x2::coin::Coin<0x2::sui::SUI>) {
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.gas_balance, 0x2::coin::into_balance<0x2::sui::SUI>(arg1));
        arg0.total_recycled_coins = arg0.total_recycled_coins + 1;
        arg0.total_recycled_amount = arg0.total_recycled_amount + 0x2::coin::value<0x2::sui::SUI>(&arg1);
    }
