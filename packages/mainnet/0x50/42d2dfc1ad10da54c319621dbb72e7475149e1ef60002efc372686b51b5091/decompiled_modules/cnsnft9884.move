module 0x5042d2dfc1ad10da54c319621dbb72e7475149e1ef60002efc372686b51b5091::cnsnft9884 {
    struct CNSNFT9884 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9884, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5299"));
        let v4 = 0x2::package::claim<CNSNFT9884>(arg0, arg1);
