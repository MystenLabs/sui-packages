module 0x5041dd5ba3e70208da7faaa415bfd371acd5256a25d5d5e4875eda0109c1f7ea::howardlau2000_swap {
    ...
    entry fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<T0>(&mut arg0.token_a, v3);
        0x2::balance::join<T1>(&mut arg0.token_b, v4);
        assert!(v0 < 1844674407370955 && v1 < 1844674407370955, 4);
        0x2::transfer::public_transfer<0x2::coin::Coin<LSP<T0, T1>>>(0x2::coin::from_balance<LSP<T0, T1>>(0x2::balance::increase_supply<LSP<T0, T1>>(&mut arg0.lsp_supply, 0x2::math::min(0x2::balance::value<T0>(&v3) * v2 / v0, 0x2::balance::value<T1>(&v4) * v2 / v1)), arg3), 0x2::tx_context::sender(arg3));
    }
    ...
    entry fun create_pool<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<LSP<T0, T1>>>(0x2::coin::from_balance<LSP<T0, T1>>(0x2::balance::increase_supply<LSP<T0, T1>>(&mut v3, 0x2::math::sqrt(v0) * 0x2::math::sqrt(v1)), arg2), 0x2::tx_context::sender(arg2));
    }
    ...
    entry fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LSP<T0, T1>>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.token_a, v1 * v0 / v3, arg2), 0x2::tx_context::sender(arg2));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut arg0.token_b, v2 * v0 / v3, arg2), 0x2::tx_context::sender(arg2));
    }
    ...
    entry fun swap_a_to_b<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut arg0.token_b, sell_token_a<T0, T1>(arg0, v0), arg2), 0x2::tx_context::sender(arg2));
    }
    ...
    entry fun swap_b_to_a<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.token_a, sell_token_b<T0, T1>(arg0, v1), arg2), 0x2::tx_context::sender(arg2));
    }
