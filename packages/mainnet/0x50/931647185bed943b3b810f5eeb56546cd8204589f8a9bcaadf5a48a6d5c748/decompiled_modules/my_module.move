module 0x50931647185bed943b3b810f5eeb56546cd8204589f8a9bcaadf5a48a6d5c748::my_module {
    ...
    public entry fun cetus_swap<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: bool, arg3: u64, arg4: u128, arg5: &0x2::clock::Clock, arg6: 0x2::coin::Coin<T0>, arg7: 0x2::coin::Coin<T1>, arg8: &mut 0x2::tx_context::TxContext) {
        if (arg2) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg6, 0x2::tx_context::sender(arg8));
            ...
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg0, arg1, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg6, arg3, arg8)), 0x2::balance::zero<T1>(), v2);
        } else {
            let (v3, v4, v5) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg0, arg1, arg2, true, arg3, arg4, arg5);
            0x2::coin::join<T0>(&mut arg6, 0x2::coin::from_balance<T0>(v3, arg8));
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg6, 0x2::tx_context::sender(arg8));
            0x2::coin::join<T1>(&mut arg7, 0x2::coin::from_balance<T1>(v4, arg8));
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg7, 0x2::tx_context::sender(arg8));
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg0, arg1, 0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg7, arg3, arg8)), v5);
        };
    }
