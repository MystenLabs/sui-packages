module 0x50b334714b643d131e9f860061ea5be268d4f4d700dd3c4a4cfca339cf40fdf4::main_contract {
    ...
    public fun buy_miner(arg0: &mut SUIMiner, arg1: &mut User, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 >= 1000000000, 1);
        assert!(0x2::coin::value<0x2::sui::SUI>(arg4) >= arg2, 0);
        let v0 = 0x2::coin::balance_mut<0x2::sui::SUI>(arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(v0, arg2 * 5 / 100, arg5), arg0.owner);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::balance::split<0x2::sui::SUI>(v0, arg2 * 95 / 100));
