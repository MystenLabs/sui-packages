module 0x50a22d4dc05a2522c31e64391011f01c0f5b319931dec6eccd56ab693508a393::cnsnft7455 {
    struct CNSNFT7455 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7455, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7455>(arg0, arg1);
