module 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey {
    ...
    public fun get_total_honey_Supply() : u64 {
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::total_honey_supply()
    }
    ...
    public fun set_rules<T0>(arg0: &mut 0x2::token::TokenPolicy<T0>, arg1: &0x2::token::TokenPolicyCap<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::honey_burn_pct();
    ...
    public fun transfer_honey<T0>(arg0: &mut 0x2::token::Token<T0>, arg1: &0x2::token::TokenPolicyCap<T0>, arg2: &mut 0x2::token::TokenPolicy<T0>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u128((arg3 as u128), (*0x2::vec_map::get<0x1::string::String, u64>(&0x2::token::rule_config<T0, Consumption, ConsumptionCondition>(v1, arg2).percent, &v2) as u128), (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::percent_precision() as u128));
