module 0x5010e615b6bdb72b6acb39e421442b624136dd2922df32a636563b8bcfcc676a::cnsnft4180 {
    struct CNSNFT4180 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4180, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4180>(arg0, arg1);
