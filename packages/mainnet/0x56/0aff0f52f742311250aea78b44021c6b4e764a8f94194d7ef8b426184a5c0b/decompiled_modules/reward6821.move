module 0x560aff0f52f742311250aea78b44021c6b4e764a8f94194d7ef8b426184a5c0b::reward6821 {
    struct REWARD6821 has drop {
        dummy_field: bool,
    }

    struct TICKET_6821 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6821(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6821>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6821>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6821, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6821>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6821>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6821>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6821>>(v5, 0x2::tx_context::sender(arg1));
    }
