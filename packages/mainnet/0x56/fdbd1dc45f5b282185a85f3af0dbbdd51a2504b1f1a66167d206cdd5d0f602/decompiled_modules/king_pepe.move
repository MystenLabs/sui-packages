module 0x56fdbd1dc45f5b282185a85f3af0dbbdd51a2504b1f1a66167d206cdd5d0f602::king_pepe {
    ...
    fun init(arg0: KING_PEPE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<KING_PEPE>(&mut v2, 100000000000000, 0x2::tx_context::sender(arg1), arg1);
