module 0x5606980a7d7b47713b3283ebb395190a96a8e56f5c17f8a28e955b25c3ab0c6f::reward2873 {
    struct REWARD2873 has drop {
        dummy_field: bool,
    }

    struct TICKET_2873 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2873(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2873>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2873>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2873, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2873>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2873>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2873>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2873>>(v5, 0x2::tx_context::sender(arg1));
    }
