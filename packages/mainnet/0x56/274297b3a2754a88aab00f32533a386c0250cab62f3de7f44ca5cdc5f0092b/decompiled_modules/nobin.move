module 0x56274297b3a2754a88aab00f32533a386c0250cab62f3de7f44ca5cdc5f0092b::nobin {
    ...
    fun init(arg0: NOBIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<NOBIN>(arg0, 6, b"BIN", b"nobin", b"Nobin is an experimental on-chain token exploring fair launch mechanics and community-driven liquidity.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/profile_images/1630359280867057664/nX9XPYYO_normal.png")), arg1);
