module 0x56d984c25d0816dc7bee34e6409423048d391af7fd6d2853f0ec9f1d95b34c98::suihero {
    ...
    fun init(arg0: SUIHERO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUIHERO>(arg0, 6, b"Sui Heroes", b"HERO", b"The First on-chain Casino Gaming on Sui  https://suiheroes.com/coinflip ", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://belaunchio.infura-ipfs.io/ipfs/QmRh4VTUarf9aE2JxKfbD3ZReeJGScw31yXac6t4x5v6HL")), arg1);
