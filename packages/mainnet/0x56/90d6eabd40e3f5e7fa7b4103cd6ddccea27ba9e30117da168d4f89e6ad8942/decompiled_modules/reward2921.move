module 0x5690d6eabd40e3f5e7fa7b4103cd6ddccea27ba9e30117da168d4f89e6ad8942::reward2921 {
    struct REWARD2921 has drop {
        dummy_field: bool,
    }

    struct TICKET_2921 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2921(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2921>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2921>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2921, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2921>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2921>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2921>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2921>>(v5, 0x2::tx_context::sender(arg1));
    }
