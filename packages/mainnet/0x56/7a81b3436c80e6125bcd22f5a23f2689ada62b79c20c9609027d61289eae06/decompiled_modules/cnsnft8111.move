module 0x567a81b3436c80e6125bcd22f5a23f2689ada62b79c20c9609027d61289eae06::cnsnft8111 {
    struct CNSNFT8111 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8111, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8111>(arg0, arg1);
