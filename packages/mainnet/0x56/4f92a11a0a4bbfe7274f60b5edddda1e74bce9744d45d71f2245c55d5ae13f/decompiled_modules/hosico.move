module 0x564f92a11a0a4bbfe7274f60b5edddda1e74bce9744d45d71f2245c55d5ae13f::hosico {
    ...
    fun init(arg0: HOSICO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/9wK8yN6iz1ie5kEJkvZCTxyN1x5sTdNfx8yeMY8Ebonk.png?size=lg&key=1cfc1c                                                                                                                                                                                                            ");
