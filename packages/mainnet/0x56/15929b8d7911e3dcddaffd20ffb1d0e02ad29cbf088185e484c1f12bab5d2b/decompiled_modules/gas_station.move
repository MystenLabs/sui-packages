module 0x5615929b8d7911e3dcddaffd20ffb1d0e02ad29cbf088185e484c1f12bab5d2b::gas_station {
    ...
    public fun refuel(arg0: &mut GasStation, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        if (!0x2::table::contains<0x2::object::ID, address>(&arg0.gas_whitelist, 0x2::object::id<0x2::coin::Coin<0x2::sui::SUI>>(arg1))) {
            0x5615929b8d7911e3dcddaffd20ffb1d0e02ad29cbf088185e484c1f12bab5d2b::error::gas_object_not_whitelisted();
        };
        if (0x2::coin::value<0x2::sui::SUI>(arg1) > arg0.max_gas_amount) {
            0x5615929b8d7911e3dcddaffd20ffb1d0e02ad29cbf088185e484c1f12bab5d2b::error::exceed_max_gas_amount();
        };
        if (0x2::balance::value<0x2::sui::SUI>(&arg0.balance) < arg0.once_refuel_amount) {
            0x5615929b8d7911e3dcddaffd20ffb1d0e02ad29cbf088185e484c1f12bab5d2b::error::insufficient_balance();
        };
        let v0 = 0x2::tx_context::sender(arg3);
        if (&v0 != 0x2::table::borrow<0x2::object::ID, address>(&arg0.gas_whitelist, 0x2::object::id<0x2::coin::Coin<0x2::sui::SUI>>(arg1))) {
            0x5615929b8d7911e3dcddaffd20ffb1d0e02ad29cbf088185e484c1f12bab5d2b::error::gas_owner_mismatch();
        };
        let v1 = check_and_update_daily_refuel(arg0, 0x2::object::id<0x2::coin::Coin<0x2::sui::SUI>>(arg1), arg2);
        if (!v1) {
            0x5615929b8d7911e3dcddaffd20ffb1d0e02ad29cbf088185e484c1f12bab5d2b::error::exceed_daily_refuel_limit();
        };
