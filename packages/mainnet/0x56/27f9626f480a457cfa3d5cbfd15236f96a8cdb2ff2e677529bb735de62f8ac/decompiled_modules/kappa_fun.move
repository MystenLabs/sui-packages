module 0x5627f9626f480a457cfa3d5cbfd15236f96a8cdb2ff2e677529bb735de62f8ac::kappa_fun {
    ...
    public fun buy_<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &mut Configuration, arg6: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg7: bool, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x5627f9626f480a457cfa3d5cbfd15236f96a8cdb2ff2e677529bb735de62f8ac::bonding_curve::buy_<T0>(arg0, arg1, arg2, arg3, arg4, v1, v2, arg6, arg7, arg8, v0, arg9, arg10);
    ...
    fun create_<T0>(arg0: &Configuration, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg3: 0x2::coin::TreasuryCap<T0>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: bool, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x5627f9626f480a457cfa3d5cbfd15236f96a8cdb2ff2e677529bb735de62f8ac::bonding_curve::BondingCurve<T0> {
        assert!(0x2::coin::total_supply<T0>(&arg3) == 0, 2);
        0x5627f9626f480a457cfa3d5cbfd15236f96a8cdb2ff2e677529bb735de62f8ac::bonding_curve::create_<T0>(arg1, arg2, arg3, arg4, arg0.total_supply, arg0.bonding_curve_amount, arg0.token_offset, arg0.sui_offset, arg5, arg0.fee_bps, arg6, arg7)
    }
    ...
    public fun first_buy_<T0>(arg0: &mut Configuration, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x5627f9626f480a457cfa3d5cbfd15236f96a8cdb2ff2e677529bb735de62f8ac::bonding_curve::first_buy_<T0>(v1, arg1, arg2, arg3, v0, arg4, arg5);
    ...
    public fun get_bonding_curve<T0>(arg0: &Configuration) : (u64, u64, u64, u64, u64, u64, bool) {
        0x5627f9626f480a457cfa3d5cbfd15236f96a8cdb2ff2e677529bb735de62f8ac::bonding_curve::get_bonding_curve<T0>(borrow_bonding_curve<T0>(arg0))
    }
    ...
    public fun sell_<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: bool, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v0 = arg0.fee_bps;
        let v1 = borrow_bonding_curve_mut<T0>(arg0);
        let (v2, v3) = 0x5627f9626f480a457cfa3d5cbfd15236f96a8cdb2ff2e677529bb735de62f8ac::bonding_curve::sell_<T0>(v1, arg1, arg2, arg3, v0, arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v3, arg0.treasury);
        v2
    }

    public fun borrow_bonding_curve<T0>(arg0: &Configuration) : &0x5627f9626f480a457cfa3d5cbfd15236f96a8cdb2ff2e677529bb735de62f8ac::bonding_curve::BondingCurve<T0> {
        0x2::dynamic_object_field::borrow<0x1::ascii::String, 0x5627f9626f480a457cfa3d5cbfd15236f96a8cdb2ff2e677529bb735de62f8ac::bonding_curve::BondingCurve<T0>>(&arg0.id, 0x1::type_name::into_string(0x1::type_name::get<T0>()))
    }

    fun borrow_bonding_curve_mut<T0>(arg0: &mut Configuration) : &mut 0x5627f9626f480a457cfa3d5cbfd15236f96a8cdb2ff2e677529bb735de62f8ac::bonding_curve::BondingCurve<T0> {
        0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, 0x5627f9626f480a457cfa3d5cbfd15236f96a8cdb2ff2e677529bb735de62f8ac::bonding_curve::BondingCurve<T0>>(&mut arg0.id, 0x1::type_name::into_string(0x1::type_name::get<T0>()))
    }
    ...
    public entry fun create<T0>(arg0: &mut Configuration, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg3: 0x2::coin::TreasuryCap<T0>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: bool, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == true, 111);
        0x2::dynamic_object_field::add<0x1::ascii::String, 0x5627f9626f480a457cfa3d5cbfd15236f96a8cdb2ff2e677529bb735de62f8ac::bonding_curve::BondingCurve<T0>>(&mut arg0.id, 0x1::type_name::into_string(0x1::type_name::get<T0>()), create_<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7));
    }
