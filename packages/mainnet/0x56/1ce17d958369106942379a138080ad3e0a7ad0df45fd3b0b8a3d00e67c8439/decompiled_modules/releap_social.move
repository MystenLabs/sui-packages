module 0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::releap_social {
    ...
    public entry fun collect_post(arg0: &mut 0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::post::Post, arg1: &0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::profile::ProfileOwnerCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::post::collect_post(arg0, arg2, arg3);
    }
    ...
    public entry fun create_comment(arg0: &mut 0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::post::Post, arg1: &0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::profile::Profile, arg2: &0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::profile::ProfileOwnerCap, arg3: &mut RecentPosts, arg4: 0x1::string::String, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        abort 0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::error::deprecated()
    }
    ...
    public entry fun new_profile(arg0: &mut Index, arg1: 0x1::string::String, arg2: &0x2::clock::Clock, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<0x2::sui::SUI>(v0) >= arg0.profile_price, 0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::error::not_enough_balance());
        ...
        let (v1, v2, v3) = 0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::profile::new(arg1, arg2, arg4);
        let v4 = v2;
        0x2::table::add<0x1::string::String, 0x2::object::ID>(&mut arg0.profiles, v1, 0x2::object::id<0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::profile::Profile>(&v4));
        0x2::transfer::public_transfer<0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::profile::ProfileOwnerCap>(v3, 0x2::tx_context::sender(arg4));
        0x2::transfer::public_share_object<0x848de07caf69dfa558ab7fd5a8dc013a0061d5712cf09417e5724d732c3fb1e8::profile::Profile>(v4);
    }
