module 0xeea4b39278f417d8320a581b34af2f312c505f89d94a9e74a16c0964cc5ba0d1::alphafi_bluefin_type_1_investor {
    ...
    fun autocompound_internal<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, 0x2::sui::SUI>, arg8: bool, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, bool) {
        ...
        if (v4 >= arg0.minimum_swap_amount) {
            let (v5, v6) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T2, T3>(arg9, arg2, arg5, v3, 0x2::balance::zero<T3>(), true, true, v4, 0, 4295048016);
        ...
        let (v21, v22) = if (arg8 == false) {
            let v23 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::fee_rate<T1, T0>(arg6);
            let v24 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T1, T0>(arg6);
            let v25 = if (v23 == 100) {
    ...
    public fun rebalance_v2<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::RebalanceCap, arg2: &0xeea4b39278f417d8320a581b34af2f312c505f89d94a9e74a16c0964cc5ba0d1::version::Version, arg3: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: u32, arg7: u32, arg8: u32, arg9: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg10: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg11: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg12: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, 0x2::sui::SUI>, arg13: bool, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        let (v8, v9) = if (arg13 == false) {
            let v10 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T1, T0>(arg10);
            let v11 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::fee_rate<T1, T0>(arg10);
            let v12 = if (v11 == 100) {
        ...
        while (v19 < arg8 + 1) {
            ...
            let (_, _, v22, v23) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg4, arg9, &mut v0, v17, arg14);
            let v24 = v23;
            let v25 = v22;
            ...
            let (v26, v27) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg4, arg5, v25, v24, arg9, arg10, v8, v9, arg13, arg14, arg15);
            let (_, v29, v30, v31) = get_balances_in_ratio<T0, T1>(arg0, v26, v27, arg9, true, arg15);
            let v32 = v30;
            let v33 = v29;
            if (0x2::balance::value<T0>(&v33) > 100 || 0x2::balance::value<T1>(&v32) > 100) {
                let (v34, v35) = if (0x2::balance::value<T0>(&v33) == 0 || v31 == false) {
                    let (v36, v37, v38, v39) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg14, arg4, arg9, &mut v1, v33, v32, 0x2::balance::value<T1>(&v32), false);
                    let _ = v37;
                    let _ = v36;
                    (v38, v39)
                } else {
                    let (v42, v43, v44, v45) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg14, arg4, arg9, &mut v1, v33, v32, 0x2::balance::value<T0>(&v33), true);
                    let _ = v43;
                    let _ = v42;
                    (v44, v45)
                };
        ...
        let (v46, v47, v48) = autocompound_internal<T0, T1, T2, T3>(arg0, arg3, arg4, arg5, arg9, arg11, arg10, arg12, arg13, arg14, arg15);
        let v49 = v47;
        let v50 = v46;
        ...
        if (0x2::balance::value<T0>(&v50) > 100 || 0x2::balance::value<T1>(&v49) > 100) {
            deposit<T0, T1>(arg0, arg4, arg9, v50, v49, v48, arg14);
        } else {
