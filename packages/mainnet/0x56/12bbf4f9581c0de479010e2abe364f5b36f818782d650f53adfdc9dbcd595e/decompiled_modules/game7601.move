module 0x5612bbf4f9581c0de479010e2abe364f5b36f818782d650f53adfdc9dbcd595e::game7601 {
    struct GAME7601 has drop {
        dummy_field: bool,
    }

    struct TICKET_7601 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7601(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7601>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7601>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME7601, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME7601>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7601>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7601>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7601>>(v5, 0x2::tx_context::sender(arg1));
    }
