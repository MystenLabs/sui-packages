module 0x56509399efdc548836d83e5c64d2276a0128ebfd2f727442e9bbb085a4ce6211::cnsnft5526 {
    struct CNSNFT5526 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5526, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9556"));
        let v4 = 0x2::package::claim<CNSNFT5526>(arg0, arg1);
