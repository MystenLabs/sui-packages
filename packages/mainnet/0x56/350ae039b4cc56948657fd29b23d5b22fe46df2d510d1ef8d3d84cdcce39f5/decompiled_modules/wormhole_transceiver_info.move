module 0x56350ae039b4cc56948657fd29b23d5b22fe46df2d510d1ef8d3d84cdcce39f5::wormhole_transceiver_info {
    struct WormholeTransceiverInfo has drop {
        ...
        manager_mode: 0xd6495378b83706e827197c0993ab13135b1e374a2e65d82a831fc2ee5834bb5b::mode::Mode,
    ...
    public fun to_bytes(arg0: &WormholeTransceiverInfo) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0xd6495378b83706e827197c0993ab13135b1e374a2e65d82a831fc2ee5834bb5b::mode::serialize(arg0.manager_mode));
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : WormholeTransceiverInfo {
        assert!(0x11ae7874d23a1a5bdfc60956778092096ef9786b3650f742bd12df16b59f0933::bytes4::to_bytes(0x11ae7874d23a1a5bdfc60956778092096ef9786b3650f742bd12df16b59f0933::bytes4::take(arg0)) == x"9c23bd3b", 13906834367616974850);
        WormholeTransceiverInfo{
            ...
            manager_mode    : 0xd6495378b83706e827197c0993ab13135b1e374a2e65d82a831fc2ee5834bb5b::mode::parse(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_bytes(arg0, 1)),
