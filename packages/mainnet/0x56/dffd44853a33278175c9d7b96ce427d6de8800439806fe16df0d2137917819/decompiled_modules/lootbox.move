module 0x8c6df493fb3caf76a69a40e33dc48fb732f10ef000926588bd667e60b451836::lootbox {
    ...
    public entry fun open_lootbox<T0: store + key>(arg0: &mut House, arg1: &mut Lootbox, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        house_pub_key(arg0);
        let v1 = 0x2::hash::blake2b256(&arg2);
        let (v2, v3) = get_category_index_by_id(arg0, arg1.lootbox_category_id);
        assert!(v2, 1);
        let v4 = get_category_by_index(arg0, v3);
        assert!(0x2::object::uid_to_inner(&v4.id) == arg1.lootbox_category_id, 2);
        let v5 = &v4.lootbox_settings;
        let (v6, v7) = get_lootbox_setting_index_from_remainder(v5, safe_selection(10000, &v1));
        if (v6) {
            let v8 = 0x1::vector::borrow<LootboxSetting>(v5, v7);
            if (v8.type == 1) {
                let v9 = v8.nft_group;
                assert!(!0x1::option::is_none<0x1::string::String>(&v9), 9);
                let v10 = 0x1::option::borrow<0x1::string::String>(&v9);
                let v11 = nft_wrapper_id_for_group_at_index(arg0, *v10, 0);
                0x2::transfer::public_transfer<T0>(0x2::dynamic_object_field::remove<0x2::object::ID, T0>(&mut arg0.id, v11), arg1.player);
                let NFTWrapper { id: v12 } = 0x1::vector::remove<NFTWrapper>(0x2::table::borrow_mut<0x1::string::String, vector<NFTWrapper>>(&mut arg0.nft_groups, *v10), 0);
