module 0x56d98bd7c21e490133318a4822e6ec55bbfbf7b447fbee0d3b0259fe1e2ccd1c::gusd {
    ...
    fun init(arg0: GUSD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin_registry::new_currency_with_otw<GUSD>(arg0, 9, 0x1::string::utf8(b"SUBGUSD"), 0x1::string::utf8(b"Sub Generalized USD"), 0x1::string::utf8(b"Sub GUSD vault token for recursive vault"), 0x1::string::utf8(b"https://aftermath.finance/gusd.png"), arg1);
