module 0x56dedd83bc9de0400a6e1cea07a4f1cca279f61e6f619f07d75947a048bf0fcd::deathcorp {
    ...
    public entry fun burn_nft(arg0: PIGGIES, arg1: &mut NFTCollection) {
        let PIGGIES {
            id          : v0,
            name        : _,
            description : _,
    ...
    fun create_nft(arg0: &NFTCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : PIGGIES {
        let v0 = 0x1::string::utf8(b"Death Corp Piggies #");
        ...
        let v2 = if (0x2::table::contains<u64, 0x2::url::Url>(&arg0.preset_urls, arg1)) {
            *0x2::table::borrow<u64, 0x2::url::Url>(&arg0.preset_urls, arg1)
            ...
            let v3 = 0x1::string::utf8(b"https://legacy.link/piggies/images/");
        ...
        PIGGIES{
            ...
            name        : v0,
            description : 0x1::string::utf8(b"3,333 unique clay busts serving as your key into the LegacyLink ecosystem; unlocking community, utility, and the foundation of a global inheritance infrastructure."),
            image_url   : v2,
            attributes  : v1,
            token_id    : arg1,
        }
    ...
    public fun get_token_id(arg0: &PIGGIES) : u64 {
        arg0.token_id
    }
    ...
    fun init(arg0: DEATHCORP, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DEATHCORP>(arg0, arg1);
        let v1 = NFTCollection{
            ...
            mint_start        : 1758027600000,
            phase_end         : 1758027600000 + 3600000,
            admin_address     : @0x9d185c615c929601a161ceaf7e00329d3679d45f85b434ebb74009e751fea4ff,
            treasury_address  : @0x9d185c615c929601a161ceaf7e00329d3679d45f85b434ebb74009e751fea4ff,
            phase1_price      : 9000000000,
            phase2_price      : 10000000000,
            phase3_price      : 100,
            public_price      : 12000000000,
        };
        let v2 = 1;
        while (v2 <= 3333) {
        ...
        let v4 = 0x2::display::new<PIGGIES>(&v0, arg1);
        0x2::display::add<PIGGIES>(&mut v4, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<PIGGIES>(&mut v4, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<PIGGIES>(&mut v4, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://walrus.tusky.io/{image_url}"));
        0x2::display::add<PIGGIES>(&mut v4, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
        0x2::display::update_version<PIGGIES>(&mut v4);
        let (v5, v6) = 0x2::transfer_policy::new<PIGGIES>(&v0, arg1);
        0x2::transfer::transfer<AdminCap>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<PIGGIES>>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<PIGGIES>>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<PIGGIES>>(v5);
    ...
    public entry fun mint_all(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PIGGIES>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = if (v4) {
            if (arg0.phase2_minted >= 1200) {
                0
            } else {
                1200 - arg0.phase2_minted
            }
        } else {
            0
        };
        let v11 = if (v6) {
            if (arg0.phase3_minted >= 33) {
                0
            } else {
                33 - arg0.phase3_minted
            }
        } else {
            0
        };
        ...
        if (v2 && v12 > 0) {
            while (v17 < v12) {
                ...
                0x2::kiosk::lock<PIGGIES>(arg5, arg6, arg2, v19);
                let v20 = NFTMinted{
                    nft_id   : 0x2::object::id<PIGGIES>(&v19),
                    token_id : v18,
                    minter   : v0,
                    phase    : 1,
                };
        ...
        if (v4 && v13 > 0) {
            ...
            while (v21 < v13) {
                ...
                0x2::kiosk::lock<PIGGIES>(arg5, arg6, arg2, v23);
                let v24 = NFTMinted{
                    nft_id   : 0x2::object::id<PIGGIES>(&v23),
                    token_id : v22,
                    minter   : v0,
                    phase    : 2,
                };
        ...
        if (v6 && v14 > 0) {
            ...
            while (v25 < v14) {
                ...
                0x2::kiosk::lock<PIGGIES>(arg5, arg6, arg2, v27);
                let v28 = NFTMinted{
                    nft_id   : 0x2::object::id<PIGGIES>(&v27),
                    token_id : v26,
                    minter   : v0,
                    phase    : 3,
                };
    ...
    public entry fun mint_phase1(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PIGGIES>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < arg7) {
            ...
            arg0.minted = arg0.minted + 1;
            arg0.phase1_minted = arg0.phase1_minted + 1;
            0x2::kiosk::lock<PIGGIES>(arg5, arg6, arg2, v6);
            let v7 = NFTMinted{
                nft_id   : 0x2::object::id<PIGGIES>(&v6),
                token_id : v5,
                minter   : v0,
                phase    : 1,
            };
    ...
    public entry fun mint_phase2(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PIGGIES>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        assert!(v1 <= arg0.phase_end, 3);
        ...
        assert!(v2 > 0 && arg7 <= v2, 7);
        assert!(arg0.phase2_minted + arg7 <= 1200, 15);
        assert!(arg0.minted + arg7 <= 3333, 1);
    ...
    public entry fun mint_phase3(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PIGGIES>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        assert!(v1 <= arg0.phase_end, 3);
        ...
        assert!(v2 > 0 && arg7 <= v2, 7);
        assert!(arg0.phase3_minted + arg7 <= 33, 15);
        assert!(arg0.minted + arg7 <= 3333, 1);
    ...
    public entry fun mint_public(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PIGGIES>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        ...
        while (v3 < arg7) {
            ...
            0x2::kiosk::lock<PIGGIES>(arg5, arg6, arg2, v5);
            let v6 = NFTMinted{
                nft_id   : 0x2::object::id<PIGGIES>(&v5),
                token_id : v4,
                minter   : v0,
                phase    : 100,
            };
    ...
    public entry fun team_mint(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: &0x2::transfer_policy::TransferPolicy<PIGGIES>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 1;
        while (v0 <= 200) {
            let v1 = remove_specific_id(arg1, v0);
            let v2 = create_nft(arg1, v1, arg5);
            arg1.minted = arg1.minted + 1;
            0x2::kiosk::lock<PIGGIES>(arg3, arg4, arg2, v2);
            let v3 = NFTMinted{
                nft_id   : 0x2::object::id<PIGGIES>(&v2),
                token_id : v1,
    ...
    public entry fun team_mint_batch(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: &0x2::transfer_policy::TransferPolicy<PIGGIES>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        while (arg5 <= arg6) {
            let v0 = remove_specific_id(arg1, arg5);
            let v1 = create_nft(arg1, v0, arg7);
            arg1.minted = arg1.minted + 1;
            0x2::kiosk::lock<PIGGIES>(arg3, arg4, arg2, v1);
            let v2 = NFTMinted{
                nft_id   : 0x2::object::id<PIGGIES>(&v1),
                token_id : v0,
