module 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iexperience {
    ...
    public(friend) fun add_to_blackmail_weekly_report(arg0: &mut WeeklyReport, arg1: &0x1d62a903bc635ba010f813694f98886459793e82c9edb18915c73068b4fd9d39::game_events::EventCap, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x1::string::String, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock) {
    ...
    public(friend) fun add_to_crack_safe_weekly_report(arg0: &mut WeeklyReport, arg1: &0x1d62a903bc635ba010f813694f98886459793e82c9edb18915c73068b4fd9d39::game_events::EventCap, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x1::string::String, arg5: u64, arg6: bool, arg7: &0x2::clock::Clock) {
        reset_player_weekly_report(arg0, arg1, arg2, arg3, arg4, arg7);
    ...
    public(friend) fun add_to_feed_people_weekly_report(arg0: &mut WeeklyReport, arg1: &0x1d62a903bc635ba010f813694f98886459793e82c9edb18915c73068b4fd9d39::game_events::EventCap, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x1::string::String, arg5: u64, arg6: &0x2::clock::Clock) {
    ...
    public(friend) fun add_to_gangster_elimination_weekly_report(arg0: &mut WeeklyReport, arg1: &0x1d62a903bc635ba010f813694f98886459793e82c9edb18915c73068b4fd9d39::game_events::EventCap, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x1::string::String, arg5: u64, arg6: &0x2::clock::Clock) {
        reset_player_weekly_report(arg0, arg1, arg2, arg3, arg4, arg6);
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::string::String, u64>(&mut arg0.id, 0x1::string::utf8(b"gangster_killed"));
        *v0 = *v0 + arg5;
    }

    public(friend) fun add_to_mission_weekly_report(arg0: &mut WeeklyReport, arg1: &0x1d62a903bc635ba010f813694f98886459793e82c9edb18915c73068b4fd9d39::game_events::EventCap, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x1::string::String, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock) {
        reset_player_weekly_report(arg0, arg1, arg2, arg3, arg4, arg7);
    ...
    public(friend) fun borrow_week_end_ts(arg0: &XPBonusConfig) : u64 {
        arg0.end_time
    }
    ...
    public(friend) fun get_xp(arg0: &XPBonusConfig, arg1: &mut WeeklyReport, arg2: &0x1d62a903bc635ba010f813694f98886459793e82c9edb18915c73068b4fd9d39::game_events::EventCap, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: 0x1::string::String, arg6: &0x2::clock::Clock) : u128 {
        let v0 = 0;
        let v1 = v0;
        ...
        if (v6.total_required != v6.total_completed) {
            v1 = 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::utils::percentage(v1, (arg0.slash_xp as u128));
        };
        v1
    }
    ...
    public(friend) fun init_player_report(arg0: &0x2::clock::Clock, arg1: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = WeeklyReport{
            ...
            end_time : 0x2::clock::timestamp_ms(arg0) + 604800000,
        };
    ...
    public(friend) fun reset_player_weekly_report(arg0: &mut WeeklyReport, arg1: &0x1d62a903bc635ba010f813694f98886459793e82c9edb18915c73068b4fd9d39::game_events::EventCap, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x1::string::String, arg5: &0x2::clock::Clock) {
        if (reset_report_ts(arg0, arg5)) {
            ...
            *0x2::dynamic_field::borrow_mut<0x1::string::String, u64>(&mut arg0.id, 0x1::string::utf8(b"turf_captured")) = 0;
            ...
            0x1d62a903bc635ba010f813694f98886459793e82c9edb18915c73068b4fd9d39::game_events::emit_weekly_report_reset_event(arg1, arg2, arg3, arg4);
        };
    }
    ...
    public(friend) fun update_report_ts(arg0: &mut WeeklyReport, arg1: &0x1d62a903bc635ba010f813694f98886459793e82c9edb18915c73068b4fd9d39::game_events::EventCap, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x1::string::String, arg5: &0x2::clock::Clock) {
        arg0.end_time = 0x2::clock::timestamp_ms(arg5) + 604800000;
        reset_player_weekly_report(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    public(friend) fun update_to_current_turf_count_weekly_report(arg0: &mut WeeklyReport, arg1: &0x1d62a903bc635ba010f813694f98886459793e82c9edb18915c73068b4fd9d39::game_events::EventCap, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x1::string::String, arg5: u64, arg6: bool, arg7: &0x2::clock::Clock) {
        reset_player_weekly_report(arg0, arg1, arg2, arg3, arg4, arg7);
