module 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iplayer {
    ...
    public(friend) fun check_key_exist_accolade(arg0: &Player, arg1: 0x1::string::String) : bool {
        let (v0, _) = 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::get_accolade(0x2::dynamic_field::borrow<0x1::string::String, 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::Accolade>(&arg0.id, 0x1::string::utf8(b"accolade")));
    ...
    public(friend) fun get_claimed_rewards(arg0: &Player) : &0x2::vec_map::VecMap<0x1::string::String, vector<u128>> {
        let (_, v1) = 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::get_accolade(0x2::dynamic_field::borrow<0x1::string::String, 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::Accolade>(&arg0.id, 0x1::string::utf8(b"accolade")));
        v1
    }
    ...
    public(friend) fun insert_claimed_rewards(arg0: &mut Player, arg1: 0x1::string::String, arg2: vector<u128>) {
        0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::insert_accolade_claimed_rewards(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::Accolade>(&mut arg0.id, 0x1::string::utf8(b"accolade")), arg1, arg2);
    }

    public(friend) fun push_back_claimed_rewards(arg0: &mut Player, arg1: 0x1::string::String, arg2: u128) {
        0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::push_back_accolade_claimed_rewards(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::Accolade>(&mut arg0.id, 0x1::string::utf8(b"accolade")), arg1, arg2);
    }
    ...
    public(friend) fun update_accolade_value(arg0: &mut Player, arg1: 0x1::string::String, arg2: u128, arg3: u8) {
        if (arg3 == 0) {
            0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::update_accolade_data(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::Accolade>(&mut arg0.id, 0x1::string::utf8(b"accolade")), arg1, arg2);
        } else {
            0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::insert_accolade_data(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::Accolade>(&mut arg0.id, 0x1::string::utf8(b"accolade")), arg1, arg2);
        };
    }

    public(friend) fun update_player_stats(arg0: &mut Player, arg1: 0x1::string::String, arg2: u128) {
        let (v0, _) = 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::get_accolade(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iaccolades::Accolade>(&mut arg0.id, 0x1::string::utf8(b"accolade")));
