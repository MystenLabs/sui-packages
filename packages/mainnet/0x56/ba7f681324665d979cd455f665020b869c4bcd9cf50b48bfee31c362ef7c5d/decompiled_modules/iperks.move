module 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::iperks {
    ...
    public(friend) fun add_perk_price(arg0: &mut PerksMetadataHolder, arg1: 0x1::string::String, arg2: u64) {
    ...
    public(friend) fun set_perk_expire_ts(arg0: &mut Perk, arg1: &0x2::clock::Clock, arg2: u64) {
        arg0.expire_ts = 0x2::clock::timestamp_ms(arg1) + arg2 * 60 * 60 * 1000;
    }
    ...
    public(friend) fun transfer_perk(arg0: Perk, arg1: &0x2::tx_context::TxContext) {
        0x2::transfer::transfer<Perk>(arg0, 0x2::tx_context::sender(arg1));
    }

    public(friend) fun update_perk_metadata_description(arg0: &mut PerksMetadata, arg1: 0x1::string::String) {
