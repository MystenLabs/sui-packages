module 0x56ba7f681324665d979cd455f665020b869c4bcd9cf50b48bfee31c362ef7c5d::ibuildings {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = BuildingRegistry{
            id                 : 0x2::object::new(arg0),
            building_max_level : 25,
            building_configs   : 0x2::vec_map::empty<0x1::string::String, 0x2::vec_map::VecMap<u64, 0x2::vec_map::VecMap<0x1::string::String, u128>>>(),
        };
        0x2::transfer::share_object<BuildingRegistry>(v0);
    }
