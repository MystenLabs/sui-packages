module 0x569da4cfa546d5a8ae5a63eb6a94965b391fa29307aaa429b0292fd80e9f345f::reward7217 {
    struct REWARD7217 has drop {
        dummy_field: bool,
    }

    struct TICKET_7217 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7217(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7217>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7217>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7217, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7217>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7217>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7217>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7217>>(v5, 0x2::tx_context::sender(arg1));
    }
