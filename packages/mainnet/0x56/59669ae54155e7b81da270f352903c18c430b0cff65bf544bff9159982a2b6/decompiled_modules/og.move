module 0x5659669ae54155e7b81da270f352903c18c430b0cff65bf544bff9159982a2b6::og {
    struct LL<T0> {
        r: T0,
        a: u64,
    }
    ...
    public fun qz<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: 0x2::balance::Balance<T0>, arg2: &mut 0x2::tx_context::TxContext) {
