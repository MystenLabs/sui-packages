module 0x5642f3cb38c8756041fe096bc3209cf8ca51138796491a8e702e2be695ee41df::cnsnft9931 {
    struct CNSNFT9931 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9931, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9931>(arg0, arg1);
