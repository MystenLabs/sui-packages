module 0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::nest {
    ...
    public entry fun harvest_duck(arg0: &mut Nest, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut HarvestStats, arg4: &0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::shttoken::NestMintCap, arg5: &mut 0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::shttoken::SharedTreasury, arg6: &0x2::random::Random, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::kiosk::borrow_mut<0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::duck_nft::DuckNFT>(arg1, arg2, v1);
        let v3 = 0x2::clock::timestamp_ms(arg7);
        let (v4, _, v6, _) = 0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::duck_nft::get_duck_staking_info(v2);
        assert!(v4, 2);
        ...
        let v10 = 0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::duck_nft::get_rarity_level(v2);
        ...
        if (v15 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::shttoken::SHTTOKEN>>(0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::shttoken::mint_for_nest(arg4, arg5, v15, arg8), v0);
        };
        update_harvest_stats(arg3, v0, v9, v21, v15, arg7);
        0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::duck_nft::update_harvest_time(v2, arg7);
        if (v9 > 1) {
    ...
    public entry fun stake_duck(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut Nest, arg4: &mut HarvestStats, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::duck_nft::stake_duck_virtual(0x2::kiosk::borrow_mut<0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::duck_nft::DuckNFT>(arg0, arg1, arg2), arg3.level, arg5, arg6);
    ...
    public entry fun unstake_duck(arg0: &mut Nest, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut HarvestStats, arg4: &0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::shttoken::NestMintCap, arg5: &mut 0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::shttoken::SharedTreasury, arg6: &0x2::random::Random, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::kiosk::borrow_mut<0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::duck_nft::DuckNFT>(arg1, arg2, v1);
        let (_, _, v6, _) = 0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::duck_nft::get_duck_staking_info(v3);
        ...
        if (v8 > 0) {
            ...
            let v10 = 0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::duck_nft::get_rarity_level(v3);
            let v11 = get_duck_base_luck(v10);
            let v12 = get_nest_luck_bonus(arg0.level);
            let v13 = if (v11 + v12 > 100) {
                100
        ...
        0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::duck_nft::unstake_duck_virtual(v3, arg7, arg8);
    ...
    public entry fun upgrade_nest(arg0: &mut Nest, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::coin::Coin<0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::shttoken::SHTTOKEN>, arg4: &mut 0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::shttoken::SharedTreasury, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::shttoken::SHTTOKEN>(arg3) >= v3, 5);
        0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::shttoken::burn(arg4, 0x2::coin::split<0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::shttoken::SHTTOKEN>(arg3, v3, arg5));
        arg0.level = v2;
        if (0x1::option::is_some<0x2::object::ID>(&arg0.staked_duck_id)) {
            0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::duck_nft::update_duck_nest_level(0x2::kiosk::borrow_mut<0x56818836bad97b7c2109952c29cd105e15151d5807e5c44dd2c0ee905afb5b98::duck_nft::DuckNFT>(arg1, arg2, *0x1::option::borrow<0x2::object::ID>(&arg0.staked_duck_id)), v2);
        };
        let v4 = SlotUpgraded{
            nest_id    : 0x2::object::id<Nest>(arg0),
            owner      : v0,
