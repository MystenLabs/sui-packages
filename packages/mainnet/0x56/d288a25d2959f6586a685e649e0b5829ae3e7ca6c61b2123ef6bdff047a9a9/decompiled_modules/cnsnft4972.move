module 0x56d288a25d2959f6586a685e649e0b5829ae3e7ca6c61b2123ef6bdff047a9a9::cnsnft4972 {
    struct CNSNFT4972 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4972, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4972>(arg0, arg1);
