module 0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::sunset {
    ...
    fun calc_level_diff(arg0: &mut 0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64) {
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 100) {
            let v4 = 0x1::option::extract<address>(&mut v0);
            let v5 = 0x2::table::borrow_mut<address, User>(arg1, v4);
            ...
            if (v6 > v2) {
                let v7 = arg3 * (get_reward_percentage(v6) - 0) / 100;
                if (v5.invest_amount > 0) {
                    let v8 = v5.static_power - v5.total_earning;
                    let v9 = if (v8 > v7) {
                        v7
                    } else {
                        v8
                    };
                    v5.balance = v5.balance + v9;
                    v5.total_earning = v5.total_earning + v9;
                    v5.today_earning = v5.today_earning + v9;
                    0x1::vector::push_back<address>(&mut v3, v4);
                    0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::admin::addTeamReward(arg0, v9);
                    0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::admin::add_total_user_balance(arg0, v9);
                };
            } else if (v6 == v2 && v2 > 0) {
                let v10 = arg3 * 2 / 100;
                if (v5.invest_amount > 0) {
                    let v11 = v5.static_power - v5.total_earning;
                    let v12 = if (v11 > v10) {
                        v10
                    } else {
                        v11
                    };
                    v5.balance = v5.balance + v12;
                    v5.total_earning = v5.total_earning + v12;
                    v5.today_earning = v5.today_earning + v12;
                    0x1::vector::push_back<address>(&mut v3, v4);
                    0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::admin::addTeamReward(arg0, v12);
                    0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::admin::add_total_user_balance(arg0, v12);
                };
            };
            v0 = v5.inviter;
            v1 = v1 + 1;
        ...
        while (v13 < 0x1::vector::length<address>(&v3)) {
            handler_out(arg0, *0x1::vector::borrow<address>(&v3, v13), arg1);
            v13 = v13 + 1;
        };
    }
    ...
    public fun claim_balance<T0, T1>(arg0: &mut Contract<T1>, arg1: &0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg10: &mut 0xbd318e196f39fadcf4f13e8a1f219596c4def96f6e22d5124d2d8ff64b93e449::implements::Global, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::price_oracle::get_sui_amount(arg1, arg2 * 40 / 100);
        let v3 = withdrawSui<T0>(&arg0.vault, v2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg11);
        0x2::coin::send_funds<T0>(v3, v0);
        withdraw_pre<T1>(arg0, v0, 0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::price_oracle::get_pre_amount(arg1, arg2 * 50 / 100), arg11);
        0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::admin::add_total_claimed_amount(&mut arg0.global_network_data, arg2, v2, arg2 * 10 / 100);
        if (0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::admin::get_current_rank_reward(&mut arg0.global_network_data) < 5000000000) {
    ...
    fun update_dynamic_power(arg0: &mut 0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64) {
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 30) {
            ...
            if (v8.invest_amount > 0 && v7 > 0) {
                ...
                0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::admin::add_total_dynamic_power_distributed(arg0, v9);
            };
            v0 = v8.inviter;
            v1 = v1 + 1;
        };
