module 0x908c65c9be54883fd28d1f3e65de06496d66ae579d66e174af2ad9c1d180076b::bridge {
    ...
    entry fun mergency_deposit<T0>(arg0: &mut Bridge<T0>, arg1: &0x908c65c9be54883fd28d1f3e65de06496d66ae579d66e174af2ad9c1d180076b::admin::AdminCap, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::balance::join<T0>(&mut arg0.balance, 0x2::coin::into_balance<T0>(arg2));
    }

    entry fun mergency_withdraw<T0>(arg0: &mut Bridge<T0>, arg1: &0x908c65c9be54883fd28d1f3e65de06496d66ae579d66e174af2ad9c1d180076b::admin::AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
