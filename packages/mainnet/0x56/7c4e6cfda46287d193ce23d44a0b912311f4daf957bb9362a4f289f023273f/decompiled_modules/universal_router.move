module 0x567c4e6cfda46287d193ce23d44a0b912311f4daf957bb9362a4f289f023273f::universal_router {
    ...
    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: Route, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        check_amount_threshold<T1>(&v1, 0x567c4e6cfda46287d193ce23d44a0b912311f4daf957bb9362a4f289f023273f::math::mul_div(1000000 - v5, v4, 1000000));
        let v10 = &mut v1;
