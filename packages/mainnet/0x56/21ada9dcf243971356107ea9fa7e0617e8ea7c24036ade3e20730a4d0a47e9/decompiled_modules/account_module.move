module 0x5621ada9dcf243971356107ea9fa7e0617e8ea7c24036ade3e20730a4d0a47e9::account_module {
    ...
    public fun check_rate(arg0: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market) : u64 {
        ...
        let v9 = APYEvent{apy: 0x1::vector::length<0x1::type_name::TypeName>(&v2)};
        0x2::event::emit<APYEvent>(v9);
        0
    }
