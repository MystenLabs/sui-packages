module 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::strategy {
    ...
    struct Strategy<phantom T0, phantom T1, phantom T2> has store, key {
        ...
        vault: 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::Vault<T0, T1, T2>,
    ...
    public fun collect_to_vault<T0: drop, T1: drop, T2: drop>(arg0: &mut State, arg1: &mut HarvetReceipt<T0, T1, T2>) {
        ...
        if (v2 > 0) {
            0x2::balance::join<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::LP<T0, T1>>(&mut v1.treasury, 0x2::balance::split<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::LP<T0, T1>>(&mut arg1.underlying_token, 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::u64::mul_div(v2, v1.performance_fee_rate, 10000)));
            0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::deposit<T0, T1, T2>(&mut v1.vault, 0x2::balance::withdraw_all<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::LP<T0, T1>>(&mut arg1.underlying_token));
        };
    ...
    public entry fun compound<T0: drop, T1: drop, T2: drop>(arg0: &mut State, arg1: HarvetReceipt<T0, T1, T2>, arg2: &mut 0x943535499ac300765aa930072470e0b515cfd7eebcaa5c43762665eaad9cc6f2::state::State, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::available<T0, T1, T2>(&v1.vault) > 0) {
    ...
    fun compound_<T0: drop, T1: drop, T2: drop>(arg0: &mut Strategy<T0, T1, T2>, arg1: &mut 0x943535499ac300765aa930072470e0b515cfd7eebcaa5c43762665eaad9cc6f2::state::State, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::available<T0, T1, T2>(&arg0.vault);
        0x943535499ac300765aa930072470e0b515cfd7eebcaa5c43762665eaad9cc6f2::operator::increase_position<T0, T1, T2>(arg1, 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::borrow_mut_position<T0, T1, T2>(&mut arg0.vault), 0x2::coin::from_balance<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::LP<T0, T1>>(0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::withdraw<T0, T1, T2>(&mut arg0.vault, v0), arg3), arg2, arg3);
        let v1 = Compound{
    ...
    public entry fun deposit<T0: drop, T1: drop, T2: drop>(arg0: &mut State, arg1: HarvetReceipt<T0, T1, T2>, arg2: 0x2::coin::Coin<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::LP<T0, T1>>, arg3: &mut 0x943535499ac300765aa930072470e0b515cfd7eebcaa5c43762665eaad9cc6f2::state::State, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::balance<T0, T1, T2>(&v3.vault);
        let v5 = 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::total_supply<T0, T1, T2>(&v3.vault);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::ProofCoin<T0, T1, T2>>>(0x2::coin::from_balance<0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::ProofCoin<T0, T1, T2>>(0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::mint_proof_coin<T0, T1, T2>(&mut v3.vault, 0x2::coin::into_balance<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::LP<T0, T1>>(arg2), arg5), arg5), v1);
        compound_<T0, T1, T2>(v3, arg3, arg4, arg5);
        let v6 = Deposit{
            strategy_id    : 0x2::object::id<Strategy<T0, T1, T2>>(v3),
            before_balance : v4,
            before_supply  : v5,
            after_balance  : 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::balance<T0, T1, T2>(&v3.vault),
            after_supply   : 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::total_supply<T0, T1, T2>(&v3.vault),
            amount         : v0,
            sender         : v1,
        };
    ...
    public fun harvest<T0: drop, T1: drop, T2: drop>(arg0: &mut State, arg1: &mut 0x943535499ac300765aa930072470e0b515cfd7eebcaa5c43762665eaad9cc6f2::state::State, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : HarvetReceipt<T0, T1, T2> {
        ...
        let (v4, v5) = 0x943535499ac300765aa930072470e0b515cfd7eebcaa5c43762665eaad9cc6f2::operator::harvest_<T0, T1, T2>(arg1, 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::borrow_mut_position<T0, T1, T2>(&mut v1.vault), arg2, arg3);
        let v6 = v5;
        let v7 = v4;
    ...
    public entry fun migrate<T0: drop, T1: drop, T2: drop>(arg0: &AdminCap, arg1: &mut State, arg2: &mut 0x943535499ac300765aa930072470e0b515cfd7eebcaa5c43762665eaad9cc6f2::state::State, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::migrate<T0, T1, T2>(&mut v1.vault, &mut v4.vault, arg5);
        if (0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::available<T0, T1, T2>(&v4.vault) > 0) {
    ...
    fun new_strategy<T0: drop, T1: drop, T2: drop>(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Strategy<T0, T1, T2> {
        Strategy<T0, T1, T2>{
            ...
            total_flx_earned     : 0,
            vault                : 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::new<T0, T1, T2>(0x943535499ac300765aa930072470e0b515cfd7eebcaa5c43762665eaad9cc6f2::position::new(arg0, arg2), arg2),
    ...
    public entry fun panic_withdraw<T0: drop, T1: drop, T2: drop>(arg0: &mut State, arg1: 0x2::coin::Coin<0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::ProofCoin<T0, T1, T2>>, arg2: &mut 0x943535499ac300765aa930072470e0b515cfd7eebcaa5c43762665eaad9cc6f2::state::State, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::borrow_mut_position<T0, T1, T2>(&mut v2.vault);
        ...
        let v4 = 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::redeem_underlying_coin<T0, T1, T2>(&mut v2.vault, 0x2::coin::into_balance<0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::ProofCoin<T0, T1, T2>>(arg1), arg4);
    ...
    public entry fun withdraw<T0: drop, T1: drop, T2: drop>(arg0: &mut State, arg1: HarvetReceipt<T0, T1, T2>, arg2: 0x2::coin::Coin<0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::ProofCoin<T0, T1, T2>>, arg3: &mut 0x943535499ac300765aa930072470e0b515cfd7eebcaa5c43762665eaad9cc6f2::state::State, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 4);
        assert_version_and_upgrade(arg0);
        assert!(0x2::coin::value<0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::ProofCoin<T0, T1, T2>>(&arg2) > 0, 0);
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = StrategyDfKey{pool_type: 0x1::type_name::get<0x943535499ac300765aa930072470e0b515cfd7eebcaa5c43762665eaad9cc6f2::pool::Pool<T0, T1, T2>>()};
        let v2 = 0x2::dynamic_field::borrow_mut<StrategyDfKey, Strategy<T0, T1, T2>>(&mut arg0.id, v1);
        complate_harvest<T0, T1, T2>(v2, arg1);
        let v3 = 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::balance<T0, T1, T2>(&v2.vault);
        let v4 = 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::total_supply<T0, T1, T2>(&v2.vault);
        let v5 = 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::borrow_mut_position<T0, T1, T2>(&mut v2.vault);
        ...
        let v6 = 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::redeem_underlying_coin<T0, T1, T2>(&mut v2.vault, 0x2::coin::into_balance<0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::ProofCoin<T0, T1, T2>>(arg2), arg5);
        ...
        if (0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::available<T0, T1, T2>(&v2.vault) > 0) {
        ...
        let v7 = Withdraw{
            ...
            before_balance : v3,
            before_supply  : v4,
            after_balance  : 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::balance<T0, T1, T2>(&v2.vault),
            after_supply   : 0x560c54de548931b34ae708eb17a9668ae699aae8906d8e9bd208fe07943ee3d6::vault::total_supply<T0, T1, T2>(&v2.vault),
