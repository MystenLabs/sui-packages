module 0x5649ee93e0c75ae79f90d2a1839433e5d99173077a62826a9679ac0dfe9a1ec7::protocol {
    ...
    public fun create_offer_from_kiosk<T0: store + key, T1: store + key>(arg0: &mut GlobalRegistry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: u64, arg6: 0x1::option::Option<address>, arg7: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        internal_create_offer<T0, T1>(arg0, 0x2::kiosk::take<T0>(arg1, arg2, arg3), arg4, arg5, arg6, arg7, arg8, arg9, arg10);
    }

    public fun execute_kiosk_swap<T0: store + key, T1: store + key>(arg0: &mut GlobalRegistry, arg1: SwapOffer, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: T1, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x5649ee93e0c75ae79f90d2a1839433e5d99173077a62826a9679ac0dfe9a1ec7::fee_manager::PlatformConfig, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = 0x5649ee93e0c75ae79f90d2a1839433e5d99173077a62826a9679ac0dfe9a1ec7::fee_manager::get_flat_fee(arg6, 0x1::type_name::get<T1>());
        if (v11 > 0) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg5) >= v7 + v11, 4);
            0x5649ee93e0c75ae79f90d2a1839433e5d99173077a62826a9679ac0dfe9a1ec7::fee_manager::collect_fee(arg6, 0x2::coin::split<0x2::sui::SUI>(&mut arg5, v11, arg8));
        };
        0x2::table::remove<0x2::object::ID, bool>(&mut arg0.active_offers, v4);
        let v12 = v1;
    ...
    public fun execute_swap<T0: store + key, T1: store + key>(arg0: &mut GlobalRegistry, arg1: SwapOffer, arg2: T1, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x5649ee93e0c75ae79f90d2a1839433e5d99173077a62826a9679ac0dfe9a1ec7::fee_manager::PlatformConfig, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = 0x5649ee93e0c75ae79f90d2a1839433e5d99173077a62826a9679ac0dfe9a1ec7::fee_manager::get_flat_fee(arg4, 0x1::type_name::get<T1>());
        if (v11 > 0) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) >= v7 + v11, 4);
            0x5649ee93e0c75ae79f90d2a1839433e5d99173077a62826a9679ac0dfe9a1ec7::fee_manager::collect_fee(arg4, 0x2::coin::split<0x2::sui::SUI>(&mut arg3, v11, arg6));
        };
        0x2::table::remove<0x2::object::ID, bool>(&mut arg0.active_offers, v4);
        let v12 = v1;
        let v13 = OfferedNftKey{dummy_field: false};
