module 0x563411959b7436ba5de4858d4a4753016e38278581093fbd89f33858fe92567d::cnsnft7367 {
    struct CNSNFT7367 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7367, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7367>(arg0, arg1);
