module 0x5610bf83e30f296116cd73e9921ec777e2665e5a3ec2a385c00a8c677341ca84::suirocks {
    struct SUIROCKS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUIROCKS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUIROCKS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SuiRocks"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"First rocks on SUI. We know SUI is a water chain, but when you mix water with rocks, you get the Grand Canyon. Let's carve out our future together!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibggdk5nsrmsz4xxxpwkhekechr7yoxvksookrnhpnbm6bdrnazwi"));
