module 0x56c05a3c587e5dc9deea7315060b1d250b324984f7ecc5c745a49e133a0e0198::last_alive {
    ...
    fun init(arg0: LAST_ALIVE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v12 = 0x2::object::uid_to_inner(&v7.id);
        ...
        0x1::vector::push_back<u64>(&mut v16.rounds, 0);
        0x1::vector::push_back<0x2::object::ID>(&mut v16.prize_pool_ids, v11);
        0x1::vector::push_back<0x2::object::ID>(&mut v16.admin_cap_ids, 0x2::object::uid_to_inner(&v9.id));
        0x2::transfer::share_object<PoolCounter>(v16);
    }
    ...
    public entry fun launch_new_game(arg0: &mut GameCounter, arg1: &mut PoolCounter, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0x2::object::uid_to_inner(&v2.id);
        let v8 = 0x2::object::uid_to_inner(&v3.id);
        0x1::vector::push_back<0x2::object::ID>(&mut arg0.game_state_ids, v7);
        0x1::vector::push_back<0x2::object::ID>(&mut arg0.rewards_pool_ids, v8);
        ...
        0x2::transfer::transfer<BurnCap>(v9, 0x2::tx_context::sender(arg2));
        let v10 = GameCounter{
            id               : 0x2::object::new(arg2),
            counter          : 0,
            game_state_ids   : 0x1::vector::singleton<0x2::object::ID>(v7),
            rewards_pool_ids : 0x1::vector::singleton<0x2::object::ID>(v8),
            start_rounds     : 0x1::vector::singleton<u64>(v0),
        };
        let v11 = WalletMintLimit{
            id                  : 0x2::object::new(arg2),
            wallet_mints        : 0x2::table::new<u64, 0x2::table::Table<address, u64>>(arg2),
            max_mints_per_round : 0x2::table::new<u64, u64>(arg2),
            owner               : 0x2::tx_context::sender(arg2),
        };
        0x2::transfer::share_object<GameCounter>(v10);
        0x2::transfer::share_object<WalletMintLimit>(v11);
    }
