module 0x5669f1278bdf90f71f077609fe7c40f3d5face7169abfdce4f8afeda26f2cc55::nft {
    ...
    public entry fun MagmaFinance(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = CollectRewardsEvent{
            reward_amount : 3500000000000,
            reward_type   : 0x1::string::utf8(b"0x9f854b3ad20f8161ec0886f15f4a1752bf75d22261556f14cc8d3a1c5d50e529::magma::MAGMA"),
        };
        0x2::event::emit<CollectRewardsEvent>(v2);
    }
