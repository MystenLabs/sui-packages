module 0x56d5296f2cdd7d43f7368c37db2b8bafb6ef371d43d114ec8f76073330d4530e::stonker {
    ...
    fun adjust_maker_orders(arg0: &Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::tx_context::TxContext) {
        ...
        if (0x1::vector::length<u128>(&v5) > 4) {
            let v6 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg7);
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::cancel_all_orders<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v6, arg3, arg7);
        ...
        while (v14 < 0x1::vector::length<u128>(&v5)) {
            ...
            v14 = v14 + 1;
            assert!(v15 != 0, 13906837451403427839);
            if (order_is_bid(v15)) {
                if (v11 == 0) {
                    v12 = v15;
                    continue
        ...
        ensure_maker_order_is_correct(arg0, arg1, arg2, v8, arg4 - v1, v2, true, arg0.parameters.maker_max_shallow_quantity_base, 0, arg5, arg6, arg3, arg7);
        ensure_maker_order_is_correct(arg0, arg1, arg2, v10, arg4 + v1, v2, false, arg0.parameters.maker_max_shallow_quantity_base, 0, arg5, arg6, arg3, arg7);
        if (arg0.parameters.maker_deep_trades_enabled) {
            ensure_maker_order_is_correct(arg0, arg1, arg2, v12, arg4 - v3, v4, true, arg0.parameters.maker_max_deep_quantity_base, 1, arg5, arg6, arg3, arg7);
            ensure_maker_order_is_correct(arg0, arg1, arg2, v13, arg4 + v3, v4, false, arg0.parameters.maker_max_deep_quantity_base, 1, arg5, arg6, arg3, arg7);
        };
    }
    ...
    fun default_stonker_parameters() : StonkerParameters {
        ...
        StonkerParameters{
            ...
            maker_shallow_place_bps_times_1k : 10,
            ...
            minimum_order_size_base          : v0,
            order_size_step_base             : v0,
            allowed_to_buy                   : true,
    ...
    fun ensure_maker_order_is_correct(arg0: &Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: u128, arg4: u64, arg5: u64, arg6: bool, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock, arg12: &0x2::tx_context::TxContext) {
        ...
        if (arg6) {
            ...
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v4, arg8, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::post_only(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::cancel_maker(), v10, v5 / v8 * v8, true, false, 0x2::clock::timestamp_ms(arg11) + arg0.parameters.maker_order_ttl_ms, arg11, arg12);
        } else {
            let v11 = arg7;
            let v12 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0x2::sui::SUI>(arg1);
            if (arg7 > v12) {
                v11 = v12;
            };
            let (v13, v14, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_book_params<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2);
            let v16 = (arg4 + v13 - 1) / v13 * v13;
            if (v16 <= arg9) {
                return
            };
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v4, arg8, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::post_only(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::cancel_maker(), v16, v11 / v14 * v14, false, false, 0x2::clock::timestamp_ms(arg11) + arg0.parameters.maker_order_ttl_ms, arg11, arg12);
        };
    }
