module 0x33d51e66410b5d98fdd013d16194ab35b43d5b8fc76523876cd5f971c52084dd::dca {
    ...
    public fun new_with_recipient<T0, T1, T2: drop>(arg0: &Settings, arg1: &TradePolicy, arg2: &0x2::clock::Clock, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: u64, arg6: u8, arg7: u64, arg8: u64, arg9: u64, arg10: address, arg11: address, arg12: &mut 0x2::tx_context::TxContext) : DCA<T0, T1> {
        assert!(arg11 != @0x0, 9223373024697253887);
        let v0 = new<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg12);
        let v1 = RecipientKey{dummy_field: false};
        0x2::dynamic_field::add<RecipientKey, address>(&mut v0.id, v1, arg11);
        v0
    }
    ...
    public fun recipient<T0, T1>(arg0: &DCA<T0, T1>) : address {
        let v0 = RecipientKey{dummy_field: false};
        if (0x2::dynamic_field::exists_with_type<RecipientKey, address>(&arg0.id, v0)) {
            *0x2::dynamic_field::borrow<RecipientKey, address>(&arg0.id, v0)
        } else {
            arg0.owner
        }
    }
    ...
    fun resolve<T0, T1>(arg0: &mut DCA<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v2, arg3), recipient<T0, T1>(arg0));
    }
