module 0x563889f69ff757a98fe57fbefe2a168769817074af545949ee7312daebf523cc::dao {
    ...
    public entry fun create_dao<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<address>, arg7: 0x2::coin::Coin<T1>, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg4 > arg3, 1);
        ...
        let v2 = DAO<T0, T1>{
            ...
            whitelisted_addresses : 0x2::table::new<address, bool>(arg9),
            raised_investors      : 0x2::table::new<address, u64>(arg9),
            is_finalized          : false,
            funded_amount         : 0,
            payment_amount        : v0,
            raised_balance        : 0x2::balance::zero<T0>(),
            payment_balance       : 0x2::coin::into_balance<T1>(arg7),
            investment            : 0x2::bag::new(arg9),
            investment_index      : 1,
        };
        let v3 = &mut v2;
        add<T0, T1>(v3, arg6);
    ...
    public entry fun finalize_dao<T0, T1>(arg0: &mut DAO<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg3: u64, arg4: u64, arg5: &0x2::coin::CoinMetadata<T0>, arg6: &0x2::coin::CoinMetadata<T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let (v8, v9) = if (v5) {
            ...
            let v16 = sqrt(340282366920938463463374607431768211456 * (arg4 as u256) / (arg3 as u256));
