module 0x565324a375f0e6fb63e20828d4b6081f8a2894b9ec89caf2996937d67289e90d::staked_share {
    ...
    public entry fun new_and_share_number_pool<T0: store, T1: store + key>(arg0: &0x565324a375f0e6fb63e20828d4b6081f8a2894b9ec89caf2996937d67289e90d::pool::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun new_share<T0, T1: store + key>(arg0: &0x565324a375f0e6fb63e20828d4b6081f8a2894b9ec89caf2996937d67289e90d::pool::Pool<T0, T1>, arg1: &mut NumberPool<T0, T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : vector<StakedPoolShare<T0, T1>> {
        let v0 = arg2;
        if (0x1::vector::length<StakedPoolShare<T0, T1>>(&arg1.available_shares) == 0) {
            let v2 = StakedPoolShare<T0, T1>{
                id        : 0x2::object::new(arg3),
                start_num : 0x565324a375f0e6fb63e20828d4b6081f8a2894b9ec89caf2996937d67289e90d::pool::total_amount<T0, T1>(arg0) - arg2 + 1,
                end_num   : 0x565324a375f0e6fb63e20828d4b6081f8a2894b9ec89caf2996937d67289e90d::pool::total_amount<T0, T1>(arg0),
            };
            ...
            if (v0 != 0) {
                let v9 = StakedPoolShare<T0, T1>{
                    id        : 0x2::object::new(arg3),
                    start_num : 0x565324a375f0e6fb63e20828d4b6081f8a2894b9ec89caf2996937d67289e90d::pool::total_amount<T0, T1>(arg0) - v0 + 1,
                    end_num   : 0x565324a375f0e6fb63e20828d4b6081f8a2894b9ec89caf2996937d67289e90d::pool::total_amount<T0, T1>(arg0),
                };
