module 0x5609acc8d1e8493b3741594e595b6e97b7e0eef65fd16e11488b316dfd7c8255::DOUBLEUP {
    ...
    public entry fun GivePrize(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = PRIZE_TICKET{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/suiprize/suiprize_0628/prizeticket_0628_1.jpg"),
    ...
    fun init(arg0: DOUBLEUP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/suiprize/suiprize_0628/prizeticket_0628_1.jpg"));
