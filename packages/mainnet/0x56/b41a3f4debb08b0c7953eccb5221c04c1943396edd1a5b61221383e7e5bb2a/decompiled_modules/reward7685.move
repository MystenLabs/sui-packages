module 0x56b41a3f4debb08b0c7953eccb5221c04c1943396edd1a5b61221383e7e5bb2a::reward7685 {
    struct REWARD7685 has drop {
        dummy_field: bool,
    }

    struct TICKET_7685 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7685(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7685>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7685>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7685, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7685>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7685>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7685>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7685>>(v5, 0x2::tx_context::sender(arg1));
    }
