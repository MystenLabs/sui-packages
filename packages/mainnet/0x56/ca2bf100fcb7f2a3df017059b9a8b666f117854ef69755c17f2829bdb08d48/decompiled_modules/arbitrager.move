module 0x56ca2bf100fcb7f2a3df017059b9a8b666f117854ef69755c17f2829bdb08d48::arbitrager {
    ...
    public fun change_funder(arg0: &0x2::package::Publisher, arg1: &mut Bot, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_module<ARBITRAGER>(arg0), 13906837799295778815);
        assert!(arg1.funder != arg2, 13906837803590746111);
        arg1.funder = arg2;
    }

    public fun change_operator(arg0: &0x2::package::Publisher, arg1: &mut Bot, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_module<ARBITRAGER>(arg0), 13906837846540419071);
        assert!(arg1.operator != arg2, 13906837850835386367);
        arg1.operator = arg2;
    }
    ...
    fun check_out<T0, T1>(arg0: &mut Bot, arg1: u64, arg2: u64) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        if (0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0)) {
            ...
            assert!(arg1 == 0, 13906836326121996287);
        };
        if (0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg0.id, v1)) {
            ...
            assert!(arg2 == 0, 13906836360481734655);
        };
        let v2 = if (arg1 > 0) {
    ...
    public fun get_pool_current_depth<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: u32, arg2: u32) : (vector<Level>, vector<Level>) {
        ...
        assert!(arg1 / v2 * v2 == arg1, 13906837399863820287);
    ...
    public fun limit_order<T0, T1>(arg0: &mut Bot, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: u128, arg4: u32, arg5: u32, arg6: u64, arg7: bool, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        only_operator_funder(arg0, 0x2::tx_context::sender(arg9));
        ...
        let v0 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::open_position<T0, T1>(arg1, arg2, arg4, arg5, arg9);
        let v1 = if (arg7) {
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg1, arg2, &mut v0, arg6, true, arg8)
        } else {
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg1, arg2, &mut v0, arg6, false, arg8)
        };
        let v2 = v1;
        ...
        assert!(v6, 7);
        let (v7, v8) = check_out<T0, T1>(arg0, v3, v4);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_add_liquidity<T0, T1>(arg1, arg2, v7, v8, v2);
        let v9 = 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v0);
        0x2::vec_map::insert<0x2::object::ID, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut arg0.positions, v9, v0);
        if (!0x2::table::contains<u32, vector<0x2::object::ID>>(&arg0.limit_orders, arg4)) {
            ...
            0x2::table::add<u32, vector<0x2::object::ID>>(&mut arg0.limit_orders, arg4, v10);
        } else {
            0x1::vector::push_back<0x2::object::ID>(0x2::table::borrow_mut<u32, vector<0x2::object::ID>>(&mut arg0.limit_orders, arg4), v9);
        };
        let v11 = if (arg7) {
        ...
        0x2::event::emit<LimitOrderEvent>(v12);
    }

    public fun limit_order_by_sqrt_price<T0, T1>(arg0: &mut Bot, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: u128, arg4: u64, arg5: bool, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        only_operator_funder(arg0, 0x2::tx_context::sender(arg7));
        ...
        limit_order<T0, T1>(arg0, arg1, arg2, arg3, v2, v3, arg4, arg5, arg6, arg7);
    }
    ...
    public fun stop_bot(arg0: &mut Bot, arg1: bool) {
        assert!(arg0.stop != arg1, 13906837906669961215);
        arg0.stop = arg1;
