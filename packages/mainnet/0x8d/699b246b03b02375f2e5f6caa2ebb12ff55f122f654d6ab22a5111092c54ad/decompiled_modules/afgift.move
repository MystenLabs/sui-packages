module 0x8d699b246b03b02375f2e5f6caa2ebb12ff55f122f654d6ab22a5111092c54ad::afgift {
    ...
    public entry fun GiftFromAftermath(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = AFTERMATH_GIFTBOX{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftafcom_0812/giftafcom_0812_1.jpg"),
    ...
    fun init(arg0: AFGIFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftafcom_0812/giftafcom_0812_1.jpg"));
