module 0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::voucher {
    struct Voucher<phantom T0> has key {
        id: 0x2::object::UID,
        sponsor_pool: 0x2::object::ID,
        info: VoucherInfo,
    }
    ...
    public fun admin_mint_to<T0>(arg0: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::GlobalConfig, arg1: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::AdminCap, arg2: &SponsorPool<T0>, arg3: vector<address>, arg4: vector<u64>, arg5: vector<u64>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<address>(&arg3) > 0) {
            let v0 = mint<T0>(arg2, 0x1::vector::pop_back<u64>(&mut arg4), 0x1::vector::pop_back<u64>(&mut arg5), 0x1::option::none<address>(), arg6);
            ...
            0x2::transfer::transfer<Voucher<T0>>(v0, 0x1::vector::pop_back<address>(&mut arg3));
        };
    }
    ...
    fun assert_if_voucher_and_sponsor_pool_not_matched<T0>(arg0: &SponsorPool<T0>, arg1: &Voucher<T0>) {
        assert!(*0x2::object::uid_as_inner(&arg0.id) == arg1.sponsor_pool, 6);
    }
    ...
    fun burn_and_get_voucher_amount<T0>(arg0: Voucher<T0>, arg1: &0x2::clock::Clock) : u64 {
        ...
        if (v3.deadline >= 0x2::clock::timestamp_ms(arg1)) {
            v3.amount
        } else {
            0
        }
    ...
    public fun consume<T0>(arg0: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::GlobalConfig, arg1: &mut SponsorPool<T0>, arg2: vector<Voucher<T0>>, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, VoucherConsumeRequest<T0>) {
        0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::assert_if_version_not_matched(arg0, 1);
        let v0 = 0;
        while (0x1::vector::length<Voucher<T0>>(&arg2) != 0) {
            ...
            assert_if_voucher_and_sponsor_pool_not_matched<T0>(arg1, &v1);
    ...
    public fun deposit_to_admin_pool<T0>(arg0: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::GlobalConfig, arg1: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::AdminCap, arg2: &mut SponsorPool<T0>, arg3: 0x2::coin::Coin<T0>) {
        0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun deposit_to_fund_manager_pool<T0>(arg0: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::GlobalConfig, arg1: &mut SponsorPool<T0>, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::tx_context::TxContext) {
        0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::assert_if_version_not_matched(arg0, 1);
    ...
    fun mint<T0>(arg0: &SponsorPool<T0>, arg1: u64, arg2: u64, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) : Voucher<T0> {
        let v0 = VoucherInfo{
            amount       : arg1,
            deadline     : arg2,
            sponsor_addr : arg3,
        ...
        Voucher<T0>{
            ...
            sponsor_pool : *0x2::object::uid_as_inner(&arg0.id),
            info         : v0,
        }
    }

    public fun mint_fund_manager_voucher<T0>(arg0: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::GlobalConfig, arg1: &mut SponsorPool<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::assert_if_version_not_matched(arg0, 1);
        ...
        let v1 = mint<T0>(arg1, v0, 0x1::option::borrow<SponsorPoolSettings>(&arg1.settings).deadline, 0x1::option::some<address>(*0x1::option::borrow<address>(&arg1.sponsor_addr)), arg2);
        ...
        let v4 = MintedFundManagerVoucher{
            ...
            minter_addr  : 0x2::tx_context::sender(arg2),
            amount       : v1.info.amount,
            deadline     : v1.info.deadline,
            sponsor_pool : *0x2::object::uid_as_inner(&arg1.id),
        };
        0x2::event::emit<MintedFundManagerVoucher>(v4);
        0x2::transfer::transfer<Voucher<T0>>(v1, 0x2::tx_context::sender(arg2));
    }

    public fun new_admin_sponsor_pool<T0>(arg0: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::GlobalConfig, arg1: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun new_fund_manager_sponsor_pool<T0>(arg0: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::GlobalConfig, arg1: u64, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::assert_if_version_not_matched(arg0, 1);
        ...
        let v2 = SponsorPool<T0>{
            ...
            asset        : 0x2::coin::into_balance<T0>(arg4),
    ...
    public(friend) fun to_share_object<T0>(arg0: SponsorPool<T0>) {
        0x2::transfer::share_object<SponsorPool<T0>>(arg0);
    }

    public fun withdraw_from_admin_pool<T0>(arg0: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::GlobalConfig, arg1: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::AdminCap, arg2: &mut SponsorPool<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun withdraw_from_fund_manager_pool<T0>(arg0: &0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::GlobalConfig, arg1: &mut SponsorPool<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x8d5873b8028d1e09358b06a242d37dd2deb82a8c95b7eebc68df62c28edf1047::config::assert_if_version_not_matched(arg0, 1);
