module 0x8db465fdf11aa874099d51bd42da66163b08246b6b50680a57ab599a7e8badbe::tutu {
    ...
    fun init(arg0: TUTU, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TUTU>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"tutu"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"tutu "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreigle5m4k3aeqv7fy4xyzbb2aruwfc5zzjjjr5nowekfplbpakrjje"));
