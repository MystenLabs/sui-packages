module 0x8d5297b5bd5cb87cbc21f1f3a4891af17ae588b80265154ddf54e953b835fc6c::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT1503598", b"BatchToken1 503598", b"First serial deployment", 0x1::option::none<0x2::url::Url>(), arg1);
