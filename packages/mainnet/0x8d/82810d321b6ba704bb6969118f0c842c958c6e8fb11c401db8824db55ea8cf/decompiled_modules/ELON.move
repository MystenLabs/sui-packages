module 0x8d82810d321b6ba704bb6969118f0c842c958c6e8fb11c401db8824db55ea8cf::ELON {
    ...
    fun init(arg0: ELON, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<ELON>(arg0, 9, b"FESTO", b"Festo AI", b"Festo genetive AI", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
