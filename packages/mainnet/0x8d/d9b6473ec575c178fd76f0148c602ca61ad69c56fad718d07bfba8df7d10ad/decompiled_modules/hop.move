module 0x8dd9b6473ec575c178fd76f0148c602ca61ad69c56fad718d07bfba8df7d10ad::hop {
    struct HOP has drop {
        dummy_field: bool,
    }

    fun init(arg0: HOP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HOP>(arg0, 6, b"HOP", b"Hopper the Rabbit", b"The mascot of hop.fun", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/LIELA7W.jpeg")), arg1);
