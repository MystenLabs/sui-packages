module 0x8d1a05ad17b3a92d448789a5d8faae83b6dea3cdb6379fa09a4616b4a9715a02::tardi {
    struct TARDI has drop {
        dummy_field: bool,
    }

    fun init(arg0: TARDI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TARDI>(arg0, 6, b"TARDI", b"Tardi the water bear", b"Hi, I'm Tardi :) Unbreakable by design! Elon sent me to the moon, but now its time we go interplanetary", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/photo_2024_12_06_13_08_24_49b6027527.jpg")), arg1);
