module 0x8d4737aebc1b2e5b6b4c080a5d11797cb21659bab630ff2a6356af8eded69ec0::reward8910 {
    struct REWARD8910 has drop {
        dummy_field: bool,
    }

    struct TICKET_8910 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8910(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8910>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8910>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8910, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8910>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8910>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8910>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8910>>(v5, 0x2::tx_context::sender(arg1));
    }
