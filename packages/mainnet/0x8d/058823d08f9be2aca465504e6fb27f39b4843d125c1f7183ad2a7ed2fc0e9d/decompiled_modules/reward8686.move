module 0x8d058823d08f9be2aca465504e6fb27f39b4843d125c1f7183ad2a7ed2fc0e9d::reward8686 {
    struct REWARD8686 has drop {
        dummy_field: bool,
    }

    struct TICKET_8686 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8686(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8686>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8686>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8686, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8686>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8686>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8686>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8686>>(v5, 0x2::tx_context::sender(arg1));
    }
