module 0x8d676a5cc5accec68d5874121d39e942db456d344e127d4e8b0a6ff15d78fc59::committed {
    ...
    public(friend) fun mint_and_emit(arg0: 0x2::object::ID, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Committed {
        let v0 = Committed{
            ...
            dao_fund_id : arg0,
            image_url   : 0x2::url::new_unsafe_from_bytes(b"https://suidaos.ai/logo/suidaos.png"),
            amount      : arg1,
        };
