module 0x8d676a5cc5accec68d5874121d39e942db456d344e127d4e8b0a6ff15d78fc59::dao_config {
    ...
    public fun check_package_version(arg0: &GlobalDaoConfig) {
        assert!(arg0.package_version == 1, 3000);
    }
    ...
    public fun set_verifier_pubkey(arg0: &0x8d676a5cc5accec68d5874121d39e942db456d344e127d4e8b0a6ff15d78fc59::operator::OperatorCap, arg1: &mut GlobalDaoConfig, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.verifier_pubkey = arg2;
    }

    public fun update_package_version(arg0: &0x8d676a5cc5accec68d5874121d39e942db456d344e127d4e8b0a6ff15d78fc59::operator::OperatorCap, arg1: &mut GlobalDaoConfig, arg2: u64) {
