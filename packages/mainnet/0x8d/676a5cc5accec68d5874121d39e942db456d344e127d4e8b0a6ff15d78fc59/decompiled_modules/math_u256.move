module 0x8d676a5cc5accec68d5874121d39e942db456d344e127d4e8b0a6ff15d78fc59::math_u256 {
    ...
    public fun as_u128(arg0: U256) : u128 {
        assert!(arg0.v2 == 0 && arg0.v3 == 0, 4000);
    ...
    public fun from_bytes(arg0: &vector<u8>) : U256 {
        assert!(0x1::vector::length<u8>(arg0) == 32, 4004);
        let v0 = zero();
        let v1 = &mut v0;
