module 0x8de4e99ba8a34d6eda6fe0e4b3e9349fee0abcfa14a6c1583e6be0301af78dc2::reward3340 {
    struct REWARD3340 has drop {
        dummy_field: bool,
    }

    struct TICKET_3340 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3340(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3340>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3340>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3340, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3340>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3340>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3340>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3340>>(v5, 0x2::tx_context::sender(arg1));
    }
