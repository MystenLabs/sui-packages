module 0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey_yield {
    struct HoneyYield has key {
        id: 0x2::object::UID,
        sui_treasury: 0x2::balance::Balance<0x2::sui::SUI>,
        honey_bought_back: 0x2::balance::Balance<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY>,
        honey_to_burn: 0x2::balance::Balance<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY>,
    ...
    public fun add_honey_bought_back(arg0: &mut HoneyYield, arg1: 0x2::balance::Balance<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY>) {
        0x2::balance::join<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY>(&mut arg0.honey_bought_back, arg1);
    }
    ...
    public fun deposit_honey_to_burn(arg0: &mut HoneyYield, arg1: 0x2::balance::Balance<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY>) {
        assert!(arg0.module_version == 0, 4010);
        0x2::balance::join<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY>(&mut arg0.honey_to_burn, arg1);
    }
    ...
    public fun get_curved_pool_fee_info(arg0: &HoneyYield) : (u64, u64) {
        (arg0.pool_fee_config.curved_pool_fee.total_fee_bps, arg0.pool_fee_config.curved_pool_fee.protocol_fee_pct)
    }
    ...
    public fun get_fee_info<T0>(arg0: &HoneyYield) : (u64, u64) {
        if (0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::curves::is_stable<T0>()) {
            return (arg0.pool_fee_config.stable_pool_fee.total_fee_bps, arg0.pool_fee_config.stable_pool_fee.protocol_fee_pct)
        };
        if (0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::curves::is_weighted<T0>()) {
            return (arg0.pool_fee_config.weighted_pool_fee.total_fee_bps, arg0.pool_fee_config.weighted_pool_fee.protocol_fee_pct)
        };
        if (0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::curves::is_curved<T0>()) {
    ...
    public fun get_stable_pool_fee_info(arg0: &HoneyYield) : (u64, u64) {
        (arg0.pool_fee_config.stable_pool_fee.total_fee_bps, arg0.pool_fee_config.stable_pool_fee.protocol_fee_pct)
    }
    ...
    public fun get_weighted_pool_fee_info(arg0: &HoneyYield) : (u64, u64) {
        (arg0.pool_fee_config.weighted_pool_fee.total_fee_bps, arg0.pool_fee_config.weighted_pool_fee.protocol_fee_pct)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = HoneyYield{
            ...
            honey_bought_back  : 0x2::balance::zero<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY>(),
            honey_to_burn      : 0x2::balance::zero<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY>(),
    ...
    public fun query_fee_collectors(arg0: &HoneyYield, arg1: 0x1::option::Option<0x1::ascii::String>, arg2: u64) : (vector<0x1::ascii::String>, vector<address>, u64) {
        ...
        (v0, v1, 0x2::linked_table::length<0x1::ascii::String, address>(&arg0.fee_collectors))
    }

    public fun query_precisions_for_coin_types(arg0: &HoneyYield, arg1: 0x1::option::Option<0x1::string::String>, arg2: u64) : (vector<0x1::string::String>, vector<u8>, u64) {
    ...
    public fun update_default_fee_for_curve<T0>(arg0: &mut HoneyYield, arg1: &HoneyYieldAdminCap, arg2: u64, arg3: u64) {
        assert!(arg0.module_version == 0, 4010);
        0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::curves::assert_valid_curve<T0>();
        if (0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::curves::is_stable<T0>()) {
            let v0 = &mut arg0.pool_fee_config.stable_pool_fee;
            update_fee(v0, arg2, arg3);
        } else if (0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::curves::is_weighted<T0>()) {
            let v1 = &mut arg0.pool_fee_config.weighted_pool_fee;
            update_fee(v1, arg2, arg3);
        } else if (0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::curves::is_curved<T0>()) {
    ...
    public fun withdraw_honey_bought_back(arg0: &HoneyBoughtBackClaimCap, arg1: &mut HoneyYield) : 0x2::balance::Balance<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY> {
        let v0 = HoneyBoughtBackWithdrawn{amount: 0x2::balance::value<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY>(&arg1.honey_bought_back)};
        0x2::event::emit<HoneyBoughtBackWithdrawn>(v0);
        0x2::balance::withdraw_all<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY>(&mut arg1.honey_bought_back)
    }

    public fun withdraw_honey_to_burn(arg0: &mut HoneyYield, arg1: &0x2::coin::TreasuryCap<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY>) : 0x2::balance::Balance<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY> {
        0x2::balance::withdraw_all<0x8d5e5cd3b629acb06a554609888f9acdc80698d5a9900f037ec38fb9da14a78e::honey::HONEY>(&mut arg0.honey_to_burn)
    }
