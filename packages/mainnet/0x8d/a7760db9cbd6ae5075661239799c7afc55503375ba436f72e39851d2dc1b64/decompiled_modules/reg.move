module 0x8da7760db9cbd6ae5075661239799c7afc55503375ba436f72e39851d2dc1b64::reg {
    struct REG has drop {
        dummy_field: bool,
    }
    ...
    entry fun spend(arg0: &mut 0x2::token::TokenPolicy<REG>, arg1: &mut 0x2::token::Token<REG>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x8da7760db9cbd6ae5075661239799c7afc55503375ba436f72e39851d2dc1b64::denylist_rule::verify<REG>(arg0, &mut v0, arg3);
    ...
    fun init(arg0: REG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::token::add_rule_for_action<REG, 0x8da7760db9cbd6ae5075661239799c7afc55503375ba436f72e39851d2dc1b64::denylist_rule::Denylist>(&mut v6, &v5, 0x2::token::transfer_action(), arg1);
        0x2::token::add_rule_for_action<REG, 0x8da7760db9cbd6ae5075661239799c7afc55503375ba436f72e39851d2dc1b64::denylist_rule::Denylist>(&mut v6, &v5, 0x2::token::spend_action(), arg1);
    ...
    entry fun split_and_transfer(arg0: &0x2::token::TokenPolicy<REG>, arg1: &mut 0x2::token::Token<REG>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x8da7760db9cbd6ae5075661239799c7afc55503375ba436f72e39851d2dc1b64::denylist_rule::verify<REG>(arg0, &mut v0, arg4);
