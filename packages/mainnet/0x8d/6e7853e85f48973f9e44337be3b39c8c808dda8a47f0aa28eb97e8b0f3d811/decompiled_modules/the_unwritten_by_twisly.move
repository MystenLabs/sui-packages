module 0x8d6e7853e85f48973f9e44337be3b39c8c808dda8a47f0aa28eb97e8b0f3d811::the_unwritten_by_twisly {
    struct THE_UNWRITTEN_BY_TWISLY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: THE_UNWRITTEN_BY_TWISLY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<THE_UNWRITTEN_BY_TWISLY>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"The Unwritten by Twisly"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibkzce4pp26umcz6wiafrgrbudd2spoxcesiuwsqtrxcye4dcnelu"));
