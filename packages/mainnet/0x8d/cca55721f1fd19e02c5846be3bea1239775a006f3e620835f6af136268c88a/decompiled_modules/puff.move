module 0x8dcca55721f1fd19e02c5846be3bea1239775a006f3e620835f6af136268c88a::puff {
    ...
    fun init(arg0: PUFF, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PUFF>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PUFF      ")))), trim_right(b"Lilttle Puff                    "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
