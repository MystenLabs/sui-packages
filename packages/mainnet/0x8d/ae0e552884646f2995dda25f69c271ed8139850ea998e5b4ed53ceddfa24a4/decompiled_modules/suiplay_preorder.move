module 0xd7b0a6b6832c2693ebafab2e71fb79ed12653c4073d39acbc9f712d0682fdd57::suiplay_preorder {
    ...
    public fun can_mint(arg0: &SuiPlayPreorderRegistry) : bool {
        ...
        let v3 = if (v1 == &v2) {
            ...
            let v4 = 2;
            v1 == &v4 && arg0.exalted_minted < arg0.current_tier.max_supply + 0xd7b0a6b6832c2693ebafab2e71fb79ed12653c4073d39acbc9f712d0682fdd57::suiplay_constants::convertable_exalted_units()
        };
        v3 && total_mints(arg0) < 0xd7b0a6b6832c2693ebafab2e71fb79ed12653c4073d39acbc9f712d0682fdd57::suiplay_constants::max_exalted_units() + 0xd7b0a6b6832c2693ebafab2e71fb79ed12653c4073d39acbc9f712d0682fdd57::suiplay_constants::max_mythics_units()
    }
    ...
    entry fun sync_current_tier_max_supply(arg0: &mut SuiPlayPreorderRegistry) {
        let v0 = arg0.current_tier.key;
        let v1 = &v0;
        let v2 = 1;
        if (v1 == &v2) {
            arg0.current_tier.max_supply = 0xd7b0a6b6832c2693ebafab2e71fb79ed12653c4073d39acbc9f712d0682fdd57::suiplay_constants::max_mythics_units();
        } else {
            let v3 = 2;
            if (v1 == &v3) {
                arg0.current_tier.max_supply = 0xd7b0a6b6832c2693ebafab2e71fb79ed12653c4073d39acbc9f712d0682fdd57::suiplay_constants::max_exalted_units();
            };
        };
    }
