module 0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::balanced_dollar_crosschain {
    ...
    entry fun cross_transfer_exact(arg0: &mut Config, arg1: &mut 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::xcall_state::Storage, arg2: &0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::xcall_manager::Config, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: 0x2::coin::Coin<0x3917a812fe4a6d6bc779c5ab53f8a80ba741f8af04121193fc44e0f662e2ceb::balanced_dollar::BALANCED_DOLLAR>, arg5: u128, arg6: 0x1::string::String, arg7: 0x1::option::Option<vector<u8>>, arg8: &mut 0x2::tx_context::TxContext) {
        enforce_version(arg0);
        let (v0, v1) = if (arg5 > 0) {
            ...
            assert!(v3 == 0x2::coin::value<0x3917a812fe4a6d6bc779c5ab53f8a80ba741f8af04121193fc44e0f662e2ceb::balanced_dollar::BALANCED_DOLLAR>(&arg4), 8);
            (v3, arg5)
        } else {
            let v4 = 0x2::coin::value<0x3917a812fe4a6d6bc779c5ab53f8a80ba741f8af04121193fc44e0f662e2ceb::balanced_dollar::BALANCED_DOLLAR>(&arg4);
            (v4, translate_outgoing_amount(v4))
        };
        assert!(v0 > 0, 1);
        let v5 = get_treasury_cap_mut(arg0);
        0x3917a812fe4a6d6bc779c5ab53f8a80ba741f8af04121193fc44e0f662e2ceb::balanced_dollar::burn(v5, arg4);
        let v6 = 0x2::tx_context::sender(arg8);
        let v7 = 0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::cross_transfer::wrap_cross_transfer(0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::balanced_utils::address_to_hex_string(&v6), arg6, v1, 0x1::option::get_with_default<vector<u8>>(&arg7, b""));
        let v8 = 0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::cross_transfer_revert::wrap_cross_transfer_revert(v6, v0);
        let (v9, v10) = 0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::xcall_manager::get_protocals(arg2);
        let v11 = 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::envelope::wrap_call_message_rollback(0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::cross_transfer::encode(&v7, b"xCrossTransfer"), 0x8e5eea2ec2d387432a423813107bd873dfb05c2ed22a9c8f61d55211b759560b::cross_transfer_revert::encode(&v8, b"xCrossTransferRevert"), v9, v10);
        0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::main::send_call(arg1, arg3, get_idcap(arg0), arg0.icon_bnusd, 0x1c53e2304b957a2dc6facccc53d2dd3c2e08066614ea05a5c0af14d72ac496e3::envelope::encode(&v11), arg8);
    }
