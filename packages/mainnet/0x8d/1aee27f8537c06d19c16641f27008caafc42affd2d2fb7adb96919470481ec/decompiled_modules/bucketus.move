module 0x8d1aee27f8537c06d19c16641f27008caafc42affd2d2fb7adb96919470481ec::bucketus {
    ...
    fun collect_fee<T0>(arg0: &mut BucketusTreasury, arg1: 0x2::balance::Balance<T0>) {
        0x2::balance::join<T0>(borrow_balance_mut<T0>(arg0), arg1);
        let v0 = CollectFee<T0>{amount: 0x2::balance::value<T0>(&arg1)};
        0x2::event::emit<CollectFee<T0>>(v0);
    }
