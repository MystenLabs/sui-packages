module 0x5fad208418200537f2785aefdca3c8e15e2843ebdffd524956e6d6d6aca845a9::lottery {
    ...
    public fun withdraw_all<T0>(arg0: &LotteryStoreAdminCap, arg1: &mut LotteryStore, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = lottery_prize_pool<T0>(arg1, arg2);
        let v1 = lottery_fees<T0>(arg1, arg2);
        let v2 = borrow_mut_lottery<T0>(arg1, arg2);
        let v3 = 0x2::balance::split<T0>(&mut v2.lottery_fees, v1);
        0x2::balance::join<T0>(&mut v3, 0x2::balance::split<T0>(&mut v2.lottery_prize_pool, v0));
