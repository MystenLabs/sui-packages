module 0x8d45a155b67b44fcd942d57207fd2e3352207d989a545f4c4218f5c4af1e1caa::utils {
    ...
    fun compare_struct<T0, T1>() : u8 {
        ...
        let v2 = 0x8d45a155b67b44fcd942d57207fd2e3352207d989a545f4c4218f5c4af1e1caa::comparator::compare_u8_vector(v0, v1);
        if (0x8d45a155b67b44fcd942d57207fd2e3352207d989a545f4c4218f5c4af1e1caa::comparator::is_greater_than(&v2)) {
            2
        } else {
            let v4 = 0x8d45a155b67b44fcd942d57207fd2e3352207d989a545f4c4218f5c4af1e1caa::comparator::compare_u8_vector(v0, v1);
            if (0x8d45a155b67b44fcd942d57207fd2e3352207d989a545f4c4218f5c4af1e1caa::comparator::is_equal(&v4)) {
                0
            } else {
                1
            }
    ...
    public fun quote_liquidity(arg0: u64, arg1: u64, arg2: u64) : u64 {
        0x8d45a155b67b44fcd942d57207fd2e3352207d989a545f4c4218f5c4af1e1caa::math::mul_div(arg0, arg2, arg1)
    }
