module 0x8d504d6cc74ee2ca93d5b1b0ec259433b8b819a1dc097701cefd42aefc237014::critbit {
    ...
    public(friend) fun insert_leaf<T0: store>(arg0: &mut CritbitTree<T0>, arg1: u64, arg2: T0) : u64 {
        ...
        assert!(v3 != arg1, 4);
        let v4 = 1 << 64 - 0x8d504d6cc74ee2ca93d5b1b0ec259433b8b819a1dc097701cefd42aefc237014::math::count_leading_zeros(((v3 ^ arg1) as u128)) - 64 - 1;
        let v5 = InternalNode{
            mask        : v4,
