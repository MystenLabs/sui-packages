    ...
    public fun rebalance<T0>(arg0: &mut WeightHook<T0>, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v15 < 0x1::vector::length<address>(&v6)) {
            if (*0x1::vector::borrow<u64>(&v11, v15) > *0x1::vector::borrow<u64>(&v7, v15)) {
                0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::decrease_validator_stake<T0>(arg2, &arg0.admin_cap, arg1, *0x1::vector::borrow<address>(&v6, v15), *0x1::vector::borrow<u64>(&v11, v15) - *0x1::vector::borrow<u64>(&v7, v15), arg3);
            };
            v15 = v15 + 1;
        };
        let v16 = 0;
        while (v16 < 0x1::vector::length<address>(&v6)) {
            if (*0x1::vector::borrow<u64>(&v11, v16) < *0x1::vector::borrow<u64>(&v7, v16)) {
                0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::increase_validator_stake<T0>(arg2, &arg0.admin_cap, arg1, *0x1::vector::borrow<address>(&v6, v16), *0x1::vector::borrow<u64>(&v7, v16) - *0x1::vector::borrow<u64>(&v11, v16), arg3);
            };
            v16 = v16 + 1;
        };
    }
