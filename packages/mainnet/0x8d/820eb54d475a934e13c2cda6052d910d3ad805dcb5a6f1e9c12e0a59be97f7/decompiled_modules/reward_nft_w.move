module 0x8d820eb54d475a934e13c2cda6052d910d3ad805dcb5a6f1e9c12e0a59be97f7::reward_nft_w {
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = REWARD_NFT{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmVfE4S7q1SDz6Tn7ACUVhvEkDyQzyFdNAwvkuSnC1up6D"),
            };
            let v1 = MintEvent{
    ...
    fun init(arg0: REWARD_NFT_W, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmVfE4S7q1SDz6Tn7ACUVhvEkDyQzyFdNAwvkuSnC1up6D"));
