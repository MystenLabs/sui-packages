module 0x8d57fc46bdc5711718606713c3b460698a8828c6aeed9fde6f72d7943f2d4188::baby_suiduckz_nft {
    struct BABY_SUIDUCKZ_NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BABY_SUIDUCKZ_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BABY_SUIDUCKZ_NFT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Baby SuiDuckz NFT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Baby SuiDuckz NFTs are the result of hatching SuiDuckz Eggs NFTs, with a total supply of 2700, expanding the collection with unique and vibrant additions. Exclusively designed for the Sui Ecosystem, these NFTs continue the mission of fostering sustainability, innovation, and decentralized engagement within WEB3 space of the Sui ecosystem."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibfhlqllt2fkw553vtmegprunxxcicefhs6n4qc55gf6biouj6gzu"));
