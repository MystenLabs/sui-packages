module 0x8d32f7b9eff5e438f84a7454b1be030b18b89d7e2d4990a9ca0629ae91b30a29::reward8273 {
    struct REWARD8273 has drop {
        dummy_field: bool,
    }

    struct TICKET_8273 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8273(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8273>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8273>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8273, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8273>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8273>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8273>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8273>>(v5, 0x2::tx_context::sender(arg1));
    }
