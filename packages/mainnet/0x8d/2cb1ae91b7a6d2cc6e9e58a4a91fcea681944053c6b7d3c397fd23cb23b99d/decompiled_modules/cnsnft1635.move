module 0x8d2cb1ae91b7a6d2cc6e9e58a4a91fcea681944053c6b7d3c397fd23cb23b99d::cnsnft1635 {
    struct CNSNFT1635 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1635, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1635>(arg0, arg1);
