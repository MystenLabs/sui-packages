module 0x8d8b178570d4b8cb23814447cd59d79b27d3145d83d9af9a567621fcabe33c77::cnsnft3184 {
    struct CNSNFT3184 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3184, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3184>(arg0, arg1);
