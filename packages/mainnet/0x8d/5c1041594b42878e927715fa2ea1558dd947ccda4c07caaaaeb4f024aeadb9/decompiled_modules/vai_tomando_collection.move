module 0x8d5c1041594b42878e927715fa2ea1558dd947ccda4c07caaaaeb4f024aeadb9::vai_tomando_collection {
    struct VAI_TOMANDO_COLLECTION has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: VAI_TOMANDO_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<VAI_TOMANDO_COLLECTION>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Vai Tomando Collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"is only a test"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://lhjtjP8Dc_jce8N2YO1-JZzIxLPZZxj0TByk8A5IHv0"));
