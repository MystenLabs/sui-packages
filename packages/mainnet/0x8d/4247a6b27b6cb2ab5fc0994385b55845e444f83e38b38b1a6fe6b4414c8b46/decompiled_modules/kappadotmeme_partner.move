module 0x8d4247a6b27b6cb2ab5fc0994385b55845e444f83e38b38b1a6fe6b4414c8b46::kappadotmeme_partner {
    ...
    public fun buy_<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &mut Configuration, arg4: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg5: bool, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let (v6, v7) = 0x8d4247a6b27b6cb2ab5fc0994385b55845e444f83e38b38b1a6fe6b4414c8b46::coin_factory::buy_<T0>(arg0, arg1, arg2, v3, v4, v5, arg4, arg5, arg6, v0, v1, v2, arg7, arg8);
        let v8 = v6;
    ...
    fun create_<T0>(arg0: &Configuration, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg3: 0x2::coin::TreasuryCap<T0>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: 0x1::ascii::String, arg6: bool, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x8d4247a6b27b6cb2ab5fc0994385b55845e444f83e38b38b1a6fe6b4414c8b46::coin_factory::BondingCurve<T0> {
        assert!(0x2::coin::total_supply<T0>(&arg3) == 0, 2);
        0x8d4247a6b27b6cb2ab5fc0994385b55845e444f83e38b38b1a6fe6b4414c8b46::coin_factory::create_<T0>(arg1, arg2, arg3, arg4, arg5, arg0.total_supply, arg0.bonding_curve_amount, arg0.token_offset, arg0.sui_offset, arg6, arg0.fee_bps, arg7, arg8)
    }
    ...
    public fun first_buy_<T0>(arg0: &mut Configuration, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let (v4, v5) = 0x8d4247a6b27b6cb2ab5fc0994385b55845e444f83e38b38b1a6fe6b4414c8b46::coin_factory::first_buy_<T0>(v3, arg1, arg2, arg3, v0, v1, v2, arg4, arg5);
        let v6 = v4;
    ...
    public fun get_bonding_curve<T0>(arg0: &Configuration) : (u64, u64, u64, u64, u64, u64, bool) {
        0x8d4247a6b27b6cb2ab5fc0994385b55845e444f83e38b38b1a6fe6b4414c8b46::coin_factory::get_bonding_curve<T0>(borrow_bonding_curve<T0>(arg0))
    }
    ...
    public fun sell_<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: bool, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v2 = arg0.token_offset;
        let v3 = borrow_bonding_curve_mut<T0>(arg0);
        let (v4, v5) = 0x8d4247a6b27b6cb2ab5fc0994385b55845e444f83e38b38b1a6fe6b4414c8b46::coin_factory::sell_<T0>(v3, arg1, arg2, arg3, v0, v1, v2, arg4, arg5);
        let v6 = v5;
        let v7 = 0x2::coin::value<0x2::sui::SUI>(&v6) * arg0.partner_fee / 10000;
        if (v7 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v6, v7, arg5), arg0.partner_address);
    ...
    public fun borrow_bonding_curve<T0>(arg0: &Configuration) : &0x8d4247a6b27b6cb2ab5fc0994385b55845e444f83e38b38b1a6fe6b4414c8b46::coin_factory::BondingCurve<T0> {
        0x2::dynamic_object_field::borrow<0x1::ascii::String, 0x8d4247a6b27b6cb2ab5fc0994385b55845e444f83e38b38b1a6fe6b4414c8b46::coin_factory::BondingCurve<T0>>(&arg0.id, 0x1::type_name::into_string(0x1::type_name::get<T0>()))
    }

    fun borrow_bonding_curve_mut<T0>(arg0: &mut Configuration) : &mut 0x8d4247a6b27b6cb2ab5fc0994385b55845e444f83e38b38b1a6fe6b4414c8b46::coin_factory::BondingCurve<T0> {
        0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, 0x8d4247a6b27b6cb2ab5fc0994385b55845e444f83e38b38b1a6fe6b4414c8b46::coin_factory::BondingCurve<T0>>(&mut arg0.id, 0x1::type_name::into_string(0x1::type_name::get<T0>()))
    }
    ...
    public entry fun create<T0>(arg0: &mut Configuration, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg3: 0x2::coin::TreasuryCap<T0>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: 0x1::ascii::String, arg6: bool, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<0x1::ascii::String, 0x8d4247a6b27b6cb2ab5fc0994385b55845e444f83e38b38b1a6fe6b4414c8b46::coin_factory::BondingCurve<T0>>(&mut arg0.id, 0x1::type_name::into_string(0x1::type_name::get<T0>()), create_<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8));
    }
