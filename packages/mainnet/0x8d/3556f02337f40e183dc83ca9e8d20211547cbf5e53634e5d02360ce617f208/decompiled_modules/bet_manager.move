module 0x3c96951e6911c4739d851292a98763aa39cf78b3258ecb73aec46a72dbac8b73::bet_manager {
    ...
    public fun get_bet_result_and_payout(arg0: u64, arg1: 0x1::option::Option<u64>, arg2: u64, arg3: &0x2::vec_set::VecSet<u64>, arg4: u64, arg5: u64, arg6: u64) : (bool, bool, u64) {
        ...
        if (arg0 == 11) {
            ...
            if (v31 == arg5) {
                let (v32, v33) = 0x3c96951e6911c4739d851292a98763aa39cf78b3258ecb73aec46a72dbac8b73::dice_interpreter::get_dice(arg4);
                if (v32 == v33) {
                    if (v31 == 4 || v31 == 10) {
                        return (true, false, mul(arg2, 7000000000))
                    };
