module 0x8da1a3214c8279bf3144ef4a70615c216097983d303f3ce55aa296d5510bfd19::position_manager {
    ...
    entry fun create_and_open_position<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: u32, arg3: u32, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = create_position_manager(arg5);
        let v2 = v1;
        let v3 = v0;
        let v4 = &mut v3;
        open_position<T0, T1>(v4, &v2, 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg1), arg2, arg3, arg5);
        0x2::transfer::public_transfer<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::open_position<T0, T1>(arg0, arg1, arg2, arg3, arg5), 0x2::tx_context::sender(arg5));
        0x2::transfer::public_transfer<OwnerCap>(v2, 0x2::tx_context::sender(arg5));
