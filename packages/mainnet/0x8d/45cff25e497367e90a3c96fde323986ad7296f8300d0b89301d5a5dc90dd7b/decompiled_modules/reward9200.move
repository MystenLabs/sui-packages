module 0x8d45cff25e497367e90a3c96fde323986ad7296f8300d0b89301d5a5dc90dd7b::reward9200 {
    struct REWARD9200 has drop {
        dummy_field: bool,
    }

    struct TICKET_9200 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9200(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9200>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9200>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9200, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9200>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9200>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9200>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9200>>(v5, 0x2::tx_context::sender(arg1));
    }
