module 0x8d87cb4c5fed46842cd4ec0481bc87ace5a00a00de0d39f261897d7eb709e28d::kiosk_bidding_house {
    ...
    public fun accept_bid<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x8d87cb4c5fed46842cd4ec0481bc87ace5a00a00de0d39f261897d7eb709e28d::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v18 = v16;
        0x8d87cb4c5fed46842cd4ec0481bc87ace5a00a00de0d39f261897d7eb709e28d::auctionhouse::add_fee(arg1, 0x2::balance::split<0x2::sui::SUI>(&mut v18, 0x2::balance::value<0x2::sui::SUI>(&v18) * (v9 as u64) / 10000));
    ...
    public entry fun accept_bid_entry<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x8d87cb4c5fed46842cd4ec0481bc87ace5a00a00de0d39f261897d7eb709e28d::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun buy_nft<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x8d87cb4c5fed46842cd4ec0481bc87ace5a00a00de0d39f261897d7eb709e28d::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun buy_nft_to_new_kiosk<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x8d87cb4c5fed46842cd4ec0481bc87ace5a00a00de0d39f261897d7eb709e28d::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public fun buy_nft_with_request<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x8d87cb4c5fed46842cd4ec0481bc87ace5a00a00de0d39f261897d7eb709e28d::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, NftListing<T0>>(&arg0.id, arg2), 25);
        let NftListing {
            id             : v0,
            seller         : v1,
        ...
        let v12 = v7;
        assert!(0x2::tx_context::sender(arg6) != v1, 50);
        assert!(v8 == 0, 21);
        assert!(0x2::tx_context::epoch(arg6) <= v11, 35);
        assert!(0x2::object::id<0x2::kiosk::Kiosk>(arg3) == v2, 30);
        let v13 = 0x2::coin::value<0x2::sui::SUI>(&arg5);
        assert!(v13 >= v5, 31);
        0x8d87cb4c5fed46842cd4ec0481bc87ace5a00a00de0d39f261897d7eb709e28d::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg5, v13 * (v9 as u64) / 10000, arg6)));
