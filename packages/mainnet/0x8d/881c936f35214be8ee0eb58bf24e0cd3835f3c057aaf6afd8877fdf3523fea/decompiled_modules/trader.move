module 0x8d881c936f35214be8ee0eb58bf24e0cd3835f3c057aaf6afd8877fdf3523fea::trader {
    ...
    public entry fun mint(arg0: &mut 0x8d881c936f35214be8ee0eb58bf24e0cd3835f3c057aaf6afd8877fdf3523fea::config::GlobalConfig, arg1: &mut HostController, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = Mint{
            trader_id      : *0x2::object::uid_as_inner(&v4.id),
            new_first_name : v1,
            new_last_name  : v2,
        ...
        0x2::table::add<address, 0x2::object::ID>(&mut arg1.mint_record, 0x2::tx_context::sender(arg7), *0x2::object::uid_as_inner(&v4.id));
        0x2::transfer::transfer<Trader>(v4, 0x2::tx_context::sender(arg7));
    }
    ...
    public fun rename(arg0: &0x8d881c936f35214be8ee0eb58bf24e0cd3835f3c057aaf6afd8877fdf3523fea::config::GlobalConfig, arg1: 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg2: &mut Trader, arg3: &mut 0x2::tx_context::TxContext) {
        0x8d881c936f35214be8ee0eb58bf24e0cd3835f3c057aaf6afd8877fdf3523fea::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun updatePfp(arg0: &0x8d881c936f35214be8ee0eb58bf24e0cd3835f3c057aaf6afd8877fdf3523fea::config::GlobalConfig, arg1: &mut Trader, arg2: 0x1::string::String, arg3: 0x1::string::String) {
        0x8d881c936f35214be8ee0eb58bf24e0cd3835f3c057aaf6afd8877fdf3523fea::config::assert_if_version_not_matched(arg0, 1);
        arg1.pfp_img = arg2;
        arg1.card_img = arg3;
        let v0 = UpdatePFP{
    ...
    public fun withdraw(arg0: &0x8d881c936f35214be8ee0eb58bf24e0cd3835f3c057aaf6afd8877fdf3523fea::config::AdminCap, arg1: &mut HostController, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
