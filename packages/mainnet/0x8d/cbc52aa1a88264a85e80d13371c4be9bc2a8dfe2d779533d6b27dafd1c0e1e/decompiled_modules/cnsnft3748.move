module 0x8dcbc52aa1a88264a85e80d13371c4be9bc2a8dfe2d779533d6b27dafd1c0e1e::cnsnft3748 {
    struct CNSNFT3748 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3748, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3748>(arg0, arg1);
