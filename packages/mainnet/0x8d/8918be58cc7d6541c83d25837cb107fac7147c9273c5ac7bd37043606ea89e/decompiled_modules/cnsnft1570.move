module 0x8d8918be58cc7d6541c83d25837cb107fac7147c9273c5ac7bd37043606ea89e::cnsnft1570 {
    struct CNSNFT1570 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1570, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8736"));
        let v4 = 0x2::package::claim<CNSNFT1570>(arg0, arg1);
