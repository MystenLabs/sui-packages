module 0x8dfa63424cfa553c68e0f127bac93e43f2827937106bc5f5c8dab1f3f5e8bd74::rpg_items__potions_ {
    struct RPG_ITEMS__POTIONS_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: RPG_ITEMS__POTIONS_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<RPG_ITEMS__POTIONS_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"RPG Items (Potions)"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Some RPG Items of different types. These are the potions."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidkuzvqaiqsw2owydkyjor7hs2ze4xl3d6cnmnp5y5mq2sxeszv4y"));
