module 0x8d0171d158b58ff2099d622f4f73318d44a29ab1ad1d840ac31fe81bfa4e22c3::blastwheelz {
    ...
    public fun mint<T0>(arg0: &mut Collection<T0>, arg1: &mut 0x2::transfer_policy::TransferPolicy<NFT<T0>>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: &mut 0x2::tx_context::TxContext) : (0x2::kiosk::Kiosk, 0x2::kiosk::KioskOwnerCap) {
    ...
    public fun setup_transfer_policy<T0>(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v1;
        let v3 = v0;
        0x8d0171d158b58ff2099d622f4f73318d44a29ab1ad1d840ac31fe81bfa4e22c3::rules::add_personal_kiosk_rule<NFT<T0>>(&mut v3, &v2);
        0x8d0171d158b58ff2099d622f4f73318d44a29ab1ad1d840ac31fe81bfa4e22c3::rules::add_kiosk_lock_rule<NFT<T0>>(&mut v3, &v2);
        0x8d0171d158b58ff2099d622f4f73318d44a29ab1ad1d840ac31fe81bfa4e22c3::rules::add_royalty_rule<NFT<T0>>(&mut v3, &v2, 0x8d0171d158b58ff2099d622f4f73318d44a29ab1ad1d840ac31fe81bfa4e22c3::rules::new_royalty_config(500, 0));
