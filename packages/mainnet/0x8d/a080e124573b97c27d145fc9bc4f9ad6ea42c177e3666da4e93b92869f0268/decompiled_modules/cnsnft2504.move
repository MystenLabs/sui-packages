module 0x8da080e124573b97c27d145fc9bc4f9ad6ea42c177e3666da4e93b92869f0268::cnsnft2504 {
    struct CNSNFT2504 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2504, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2504>(arg0, arg1);
