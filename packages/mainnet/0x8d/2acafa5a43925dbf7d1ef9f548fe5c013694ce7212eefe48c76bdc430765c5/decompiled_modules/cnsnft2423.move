module 0x8d2acafa5a43925dbf7d1ef9f548fe5c013694ce7212eefe48c76bdc430765c5::cnsnft2423 {
    struct CNSNFT2423 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2423, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2423>(arg0, arg1);
