module 0x8df3db2205ee393fc2765d22bbd306ff5f3dab74da33e564d0fe5f0bc8299b9b::cnsnft8656 {
    struct CNSNFT8656 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8656, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9599"));
        let v4 = 0x2::package::claim<CNSNFT8656>(arg0, arg1);
