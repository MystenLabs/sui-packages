module 0x8d7d531170381180e4e3dfd6341c8c0b931607ca93de89a2f5b5ea76306149ce::privatecoin {
    ...
    fun init(arg0: PRIVATECOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PRIVATECOIN>(arg0, 9, b"USD1 ", b"Tatr U", b"123", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/QmZTdTrRfQhYMZhywkKBZiKWe3XXgKXoupH7eN5vEjw1Mf ")), arg1);
        let v2 = v0;
