module 0x8d4a0fb597301a0ddb8180305169d0981300a48b410d9cf631f8e7c60cb13648::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"TRUMPIUS", b"TRUMPIUS", b"Official token. Banner on Dexscreener paid!", 0x1::option::none<0x2::url::Url>(), arg1);
