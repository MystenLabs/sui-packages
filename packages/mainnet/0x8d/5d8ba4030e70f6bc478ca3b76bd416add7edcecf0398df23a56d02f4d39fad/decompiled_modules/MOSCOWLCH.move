module 0x8d5d8ba4030e70f6bc478ca3b76bd416add7edcecf0398df23a56d02f4d39fad::MOSCOWLCH {
    ...
    fun init(arg0: MOSCOWLCH, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MOSCOWLCH>(arg0, 9, b"UNIT MOSCOW LAUNCH", b"MOSCOWLCH", b"UNIT MOSCOW LAUNCH - Community supporting Moscow, Tokenized. The Decentralized City Token by Unit Network.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raw.githubusercontent.com/unitecosystem/Unit-Ecosystem/main/MOSCOW/moscow512.png")), arg1);
