module 0xadb5d562984cde3cad2401b1067e7b52816d2e9f7a1e6ed4f4a6c94ddb50db51::distributor {
    ...
    public fun add_distribute<T0>(arg0: &mut DistributorEntry, arg1: u64) {
        ...
        assert!(!0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.entries, &v0), 13906834736984489991);
        0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut arg0.entries, v0, arg1);
        arg0.total_weight = arg0.total_weight + arg1;
    }

    public(friend) fun deposit<T0>(arg0: &mut Distributor, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<T0>) {
        let v0 = get_routes<T0>(arg0);
        assert!(0x2::vec_map::length<0x1::type_name::TypeName, u64>(&v0.entries) > 0, 13906834925962657793);
        ...
        if (0x2::vec_map::length<0x1::type_name::TypeName, u64>(&v0.entries) == 1) {
            ...
            if (v2 == &v1) {
                merge_to_target_balances<T0>(arg0, arg1, arg2, 0);
                return
            };
        };
        let v4 = 0;
        while (v4 < 0x2::vec_map::length<0x1::type_name::TypeName, u64>(&v0.entries)) {
            ...
            merge_to_source_balances<T0>(arg0, *v5, 0x2::balance::split<T0>(&mut arg2, 0x1::u64::min(0x2::balance::value<T0>(&arg2), 0xadb5d562984cde3cad2401b1067e7b52816d2e9f7a1e6ed4f4a6c94ddb50db51::full_math_u64::mul_div_ceil(0x2::balance::value<T0>(&arg2), *v6, v0.total_weight))));
            v4 = v4 + 1;
        };
        merge_to_target_balances<T0>(arg0, arg1, arg2, 0);
    }
    ...
    public(friend) fun merge_to_target_balances<T0>(arg0: &mut Distributor, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<T0>, arg3: u8) {
        if (0x2::balance::value<T0>(&arg2) == 0) {
            0x2::balance::destroy_zero<T0>(arg2);
            return
        };
    ...
    public(friend) fun take_source_for_swap<T0, T1>(arg0: &mut Distributor, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.source_balances, 0x1::type_name::with_defining_ids<T0>()), 13906835089171546115);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        ...
        let v5 = v4;
        assert!(0x2::balance::value<T0>(&v5) >= arg1, 13906835106351546373);
    ...
    public(friend) fun withdraw_source<T0>(arg0: &mut Distributor, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.source_balances, 0x1::type_name::with_defining_ids<T0>()), 13906835256675270659);
        ...
        while (v9 < 0x2::vec_map::length<0x1::type_name::TypeName, u64>(&v5)) {
            ...
            merge_to_source_balances<T0>(arg0, *v10, 0x2::balance::split<T0>(&mut v2, 0x1::u64::min(0x2::balance::value<T0>(&v2), 0xadb5d562984cde3cad2401b1067e7b52816d2e9f7a1e6ed4f4a6c94ddb50db51::full_math_u64::mul_div_ceil(0x2::balance::value<T0>(&v2), *v11, v4))));
            v9 = v9 + 1;
        };
    ...
    public(friend) fun withdraw_target<T0>(arg0: &mut Distributor, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.target_balances, 0x1::type_name::with_defining_ids<T0>()), 13906835187955793923);
