module 0xadb5d562984cde3cad2401b1067e7b52816d2e9f7a1e6ed4f4a6c94ddb50db51::quote_validator {
    ...
    public fun validate_quote<T0, T1>(arg0: &QuoteValidator, arg1: 0xbeeee18b540c3e825f85e43b6b8aff501f8e6467d89eefdd9d3c6f074b527eee::trust_quote::TrustQuote<T0, T1>, arg2: u64) : u64 {
        assert!(0xbeeee18b540c3e825f85e43b6b8aff501f8e6467d89eefdd9d3c6f074b527eee::trust_quote::amount_in<T0, T1>(&arg1) == arg2, 13906834496466124804);
        let v0 = get_quote_config<T0>(arg0);
        let v1 = 0xbeeee18b540c3e825f85e43b6b8aff501f8e6467d89eefdd9d3c6f074b527eee::trust_quote::provider<T0, T1>(&arg1);
        assert!(0x2::vec_map::contains<0x1::string::String, u64>(&v0, &v1), 13906834505056190470);
        let v2 = 0xbeeee18b540c3e825f85e43b6b8aff501f8e6467d89eefdd9d3c6f074b527eee::trust_quote::provider<T0, T1>(&arg1);
        0xbeeee18b540c3e825f85e43b6b8aff501f8e6467d89eefdd9d3c6f074b527eee::trust_quote::destroy_trust_quote<T0, T1>(arg1);
        0xadb5d562984cde3cad2401b1067e7b52816d2e9f7a1e6ed4f4a6c94ddb50db51::full_math_u64::mul_div_ceil(0xbeeee18b540c3e825f85e43b6b8aff501f8e6467d89eefdd9d3c6f074b527eee::trust_quote::amount_out<T0, T1>(&arg1), 10000 - *0x2::vec_map::get<0x1::string::String, u64>(&v0, &v2), 10000)
    }
