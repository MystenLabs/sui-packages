module 0xada87fe870c0005a0727722a32e6c92191755753cd107719baa396febb534548::cnsnft7320 {
    struct CNSNFT7320 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7320, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7320>(arg0, arg1);
