module 0xadbed6896c0f021df802ea8aea241a1c8efad61bfd78068319e24fc914b95bd6::cnsnft2508 {
    struct CNSNFT2508 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2508, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2508>(arg0, arg1);
