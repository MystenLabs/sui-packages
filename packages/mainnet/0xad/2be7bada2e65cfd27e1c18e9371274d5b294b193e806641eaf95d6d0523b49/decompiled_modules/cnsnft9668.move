module 0xad2be7bada2e65cfd27e1c18e9371274d5b294b193e806641eaf95d6d0523b49::cnsnft9668 {
    struct CNSNFT9668 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9668, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4683"));
        let v4 = 0x2::package::claim<CNSNFT9668>(arg0, arg1);
