module 0xad1d1efa72caf929e8a2dc4f31cc67c2695d6238d6a76b19a7b3da83af8fbf61::cnsnft2183 {
    struct CNSNFT2183 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2183, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2183>(arg0, arg1);
