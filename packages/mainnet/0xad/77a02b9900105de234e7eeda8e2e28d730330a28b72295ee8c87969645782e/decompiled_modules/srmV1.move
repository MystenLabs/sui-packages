module 0xad77a02b9900105de234e7eeda8e2e28d730330a28b72295ee8c87969645782e::srmV1 {
    ...
    public fun create_pool_with_coins<T0, T1>(arg0: &CreatePoolLock, arg1: &mut Factory, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: address, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, 0x2::coin::Coin<LP<T0, T1>>) {
        let v0 = 0x2::tx_context::sender(arg11);
        assert!(!arg0.locked || 0x1::vector::contains<address>(&arg0.allowlist, &v0), 6);
        let v1 = 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, arg3, arg11));
        let v2 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg4, arg5, arg11));
        let v3 = create_pool<T0, T1>(arg1, v1, v2, arg6, arg7, arg8, arg9, arg10, arg11);
        (arg2, arg4, 0x2::coin::from_balance<LP<T0, T1>>(v3, arg11))
    }
    ...
    fun find_pool_key<T0, T1>(arg0: &Factory) : PoolItem {
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x1::type_name::get<T1>();
        assert!(v0 != v1, 1);
        let v2 = PoolItem{
        ...
        if (0x2::table::contains<PoolItem, 0x2::object::ID>(&arg0.pools, v2)) {
            return v2
        };
        let v3 = PoolItem{
            a : v1,
        ...
        assert!(0x2::table::contains<PoolItem, 0x2::object::ID>(&arg0.pools, v3), 4);
        v3
    }
    ...
    public fun get_pool_id<T0, T1>(arg0: &Factory) : 0x2::object::ID {
        *0x2::table::borrow<PoolItem, 0x2::object::ID>(&arg0.pools, find_pool_key<T0, T1>(arg0))
    }
