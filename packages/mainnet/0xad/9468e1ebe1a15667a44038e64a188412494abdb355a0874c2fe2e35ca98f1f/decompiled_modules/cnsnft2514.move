module 0xad9468e1ebe1a15667a44038e64a188412494abdb355a0874c2fe2e35ca98f1f::cnsnft2514 {
    struct CNSNFT2514 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2514, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2514>(arg0, arg1);
