    ...
    entry fun new_bid<T0, T1>(arg0: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::TypusUserRegistry, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::tgld::TgldRegistry, arg3: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::TypusLeaderboardRegistry, arg4: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg5: &mut StrategyPoolV2, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        while (v23 < 0x2::table_vec::length<StrategyV2>(v22)) {
            ...
            if ((0x1::vector::contains<u64>(&v24.target_rounds, &v17) || 0x1::vector::length<u64>(&v24.target_rounds) == 0) && v24.bid_times < v24.max_times && v24.bid_round < v17 && 100 - (0x2::clock::timestamp_ms(arg8) - v20) * 100 / v21 <= v24.price_percentage && v24.active) {
                ...
                let (v30, v31) = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_new_bid_incentive_balance_value<T1>(v1, v13, v15, v29, v18, arg8);
                if (0x2::balance::value<T1>(v27) >= v31) {
                    if (v29 > 0) {
                        ...
                        let (v33, v34, v35, v36, v37, v38, _, v40) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::public_new_bid_v2<T1>(v16, v15, v25, v29, v32, 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_new_bid_incentive_balance<T1>(v1, v13, v30), v18, arg8, arg9);
                        0x2::balance::join<T1>(v27, 0x2::coin::into_balance<T1>(v40));
                        if (0x2::balance::value<T1>(v27) < v31) {
                            v24.active = false;
                        };
                        0x1::vector::push_back<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&mut v24.receipts, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::public_new_bid(v14, v35, arg9));
                        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::emit_new_bid_event(v13, v33, v34, v35, v36, v37, v38, v25);
                        let v41 = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::calculate_in_usd<T1>(v13, v36, false) * 200;
                        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::add_accumulated_tgld_amount(v1, arg0, arg1, arg2, v24.user, v41, arg9);
                        ...
                        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::add_user_tails_exp_amount(v1, arg0, arg1, v24.user, v41);
