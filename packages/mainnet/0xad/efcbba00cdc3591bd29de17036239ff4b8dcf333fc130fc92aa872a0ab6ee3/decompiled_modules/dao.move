module 0xadefcbba00cdc3591bd29de17036239ff4b8dcf333fc130fc92aa872a0ab6ee3::dao {
    ...
    public fun add_whitelist<T0, T1>(arg0: &mut DAO<T0, T1>, arg1: vector<address>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun create_dao<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<address>, arg7: 0x2::coin::Coin<T1>, arg8: u64, arg9: u64, arg10: u64, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 >= arg9, 13);
        if (arg5 > arg0) {
            assert!(arg4 >= arg3, 13);
        };
        ...
        let v2 = DAO<T0, T1>{
            ...
            whitelisted_addresses        : 0x2::table::new<address, bool>(arg12),
            raised_investors             : 0x2::table::new<address, u64>(arg12),
            is_finalized                 : false,
            funded_amount                : 0,
            payment_amount               : v0,
            ...
            investment                   : 0x2::bag::new(arg12),
            investment_index             : 1,
            admin_public_key             : arg11,
            signatures                   : 0x2::table::new<vector<u8>, bool>(arg12),
        };
        let v3 = &mut v2;
        add<T0, T1>(v3, arg6);
    ...
    public entry fun fund_dao<T0, T1>(arg0: &mut DAO<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 < arg0.only_whitelist_time && arg0.funded_amount < arg0.whitelist_cap) {
            ...
            assert!(!0x2::table::contains<vector<u8>, bool>(&arg0.signatures, arg4), 14);
            assert!(0x2::bls12381::bls12381_min_pk_verify(&arg4, &arg0.admin_public_key, &arg3) == true, 15);
        ...
        0x2::balance::join<T0>(&mut arg0.raised_balance, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg1, v3, arg5)));
