module 0xade8873e8c89120961acfc9dddb221bd9b919eefd17e9675b3b1f2d111e85272::cnsnft3393 {
    struct CNSNFT3393 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3393, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3393>(arg0, arg1);
