module 0xada246663fc65f466da08e53623134189412909d7ce7fba8d3dcb9618f544a2b::reward7463 {
    struct REWARD7463 has drop {
        dummy_field: bool,
    }

    struct TICKET_7463 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7463(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7463>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7463>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7463, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7463>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7463>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7463>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7463>>(v5, 0x2::tx_context::sender(arg1));
    }
