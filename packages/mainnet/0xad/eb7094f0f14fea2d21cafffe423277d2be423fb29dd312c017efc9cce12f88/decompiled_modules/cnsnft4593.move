module 0xadeb7094f0f14fea2d21cafffe423277d2be423fb29dd312c017efc9cce12f88::cnsnft4593 {
    struct CNSNFT4593 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4593, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4593>(arg0, arg1);
