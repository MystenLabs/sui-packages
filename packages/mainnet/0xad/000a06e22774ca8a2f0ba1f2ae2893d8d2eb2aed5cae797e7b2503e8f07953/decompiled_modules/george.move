module 0xad000a06e22774ca8a2f0ba1f2ae2893d8d2eb2aed5cae797e7b2503e8f07953::george {
    ...
    fun init(arg0: GEORGE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<GEORGE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"GEORGE    ")))), trim_right(b"George's Coin                   "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
