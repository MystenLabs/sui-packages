module 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::governance {
    ...
    fun propose_inner<T0, T1>(arg0: &mut 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::index::Index<T0>, arg1: &mut Position<T0>, arg2: u8, arg3: u64, arg4: 0x1::option::Option<0x1::string::String>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = Proposal<T0>{
            ...
            yes             : 0,
            no              : 0,
            ballots         : 0x2::table::new<0x2::object::ID, Ballot>(arg6),
            opened_ms       : v0,
            closed_ms       : 0,
            applies_ms      : 0,
            applied_ms      : 0,
        ...
        if (0x1::option::is_some<0x1::string::String>(&arg4)) {
            let v10 = 0x1::option::destroy_some<0x1::string::String>(arg4);
            if (!0x1::string::is_empty(&v10)) {
                let v11 = ProposalNoted{
                    proposal : v8,
                    note     : v10,
                };
                0x2::event::emit<ProposalNoted>(v11);
                0x2::dynamic_field::add<u8, 0x1::string::String>(&mut v7.id, 0, v10);
            };
        };
        let v12 = &mut v7;
        cast<T0>(v12, arg1, true);
        let v13 = &mut v7;
        try_close_early<T0>(arg0, v13, v0);
    ...
    public fun vote_with_note<T0>(arg0: &mut 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::index::Index<T0>, arg1: &mut Position<T0>, arg2: &mut Proposal<T0>, arg3: bool, arg4: 0x1::string::String, arg5: &0x2::clock::Clock) {
        ...
        assert!((v0 as u128) * 10000 >= (0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::index::supply<T0>(arg0) as u128) * (100 as u128), 104);
