module 0xadbcb24c353137da6b0671d0393d91e0449acc43d7bca3b27bbe8d7b2934b8ef::canvas {
    ...
    fun init(arg0: CANVAS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"[{\"trait_type\": \"Ink Level\", \"value\": \"{ink_level}\"}, {\"trait_type\": \"Palette Tier\", \"value\": \"{palette_tier}\"}]"));
