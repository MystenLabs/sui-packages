module 0xad98a05ff79b8bb844d11a2fa0bd10cbe28eb036f2cb6926a3d9223347aa73ff::test_sui {
    struct TEST_SUI has drop {
        dummy_field: bool,
    }

    fun init(arg0: TEST_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST_SUI>(arg0, 9, b"tSUI", b"Test SUI", 0x1::vector::empty<u8>(), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://strapi-dev.scand.app/uploads/sui_c07df05f00.png")), arg1);
        let v2 = v0;
