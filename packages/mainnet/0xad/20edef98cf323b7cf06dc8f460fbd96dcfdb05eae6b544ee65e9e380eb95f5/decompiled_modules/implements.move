module 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements {
    ...
    public fun get_swap_out<T0, T1>(arg0: &mut Global, arg1: u64, arg2: bool) : u64 {
        ...
        if (arg2) {
            ...
            is_tax_coin<T0>(0x1::ascii::into_bytes(v10.tax_coin));
            let (v11, v12, _) = get_reserves_size<T1, T0>(v10);
            get_amount_out(arg1 - get_fee_to_fundation(arg1, v0), v12, v11)
        }
    }
    ...
    public(friend) fun swap_out<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        if (arg3) {
            ...
            if (!v3) {
                ...
                let v11 = v10 / 2;
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v9, v11, arg4), v2.burn_address);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v9, v11, arg4), @0x278692984f06781bad83e0e652f02a0cbf2fe4dcc59a943af1464b31ffd847f1);
                v8 = v7 - v10;
            };
            let v12 = get_fee_to_fundation(v8, v0);
            let v13 = v8 - v12;
            ...
            if (v3) {
                ...
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut v2.coin_y, v16, arg4), @0x278692984f06781bad83e0e652f02a0cbf2fe4dcc59a943af1464b31ffd847f1);
                v15 = v14 - v16;
            };
            assert!(v15 >= arg2, 7);
            0x2::balance::join<T0>(&mut v2.fee_coin_x, 0x2::balance::split<T0>(&mut v9, v12));
