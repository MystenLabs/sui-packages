module 0xadf607b40e648c732ddf3698d4ba7c9adc9723c0605940b01b0f17fd57a949aa::gift2399 {
    struct GIFT2399 has drop {
        dummy_field: bool,
    }

    struct TICKET_2399 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2399(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2399>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2399>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2399, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2399>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2399>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2399>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2399>>(v5, 0x2::tx_context::sender(arg1));
    }
