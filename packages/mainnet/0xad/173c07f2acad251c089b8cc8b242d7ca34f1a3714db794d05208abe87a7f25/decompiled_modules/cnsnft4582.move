module 0xad173c07f2acad251c089b8cc8b242d7ca34f1a3714db794d05208abe87a7f25::cnsnft4582 {
    struct CNSNFT4582 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4582, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4582>(arg0, arg1);
