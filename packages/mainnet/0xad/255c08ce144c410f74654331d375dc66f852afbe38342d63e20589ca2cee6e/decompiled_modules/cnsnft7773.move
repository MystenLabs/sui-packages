module 0xad255c08ce144c410f74654331d375dc66f852afbe38342d63e20589ca2cee6e::cnsnft7773 {
    struct CNSNFT7773 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7773, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7002"));
        let v4 = 0x2::package::claim<CNSNFT7773>(arg0, arg1);
