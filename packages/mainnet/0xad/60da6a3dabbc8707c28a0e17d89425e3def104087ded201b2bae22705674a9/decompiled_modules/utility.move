module 0xad60da6a3dabbc8707c28a0e17d89425e3def104087ded201b2bae22705674a9::utility {
    ...
    public(friend) fun mark_nonce_used(arg0: &mut Config, arg1: u64) {
        0x2::table_vec::push_back<u64>(&mut arg0.used_nonces, arg1);
    }
    ...
    public fun nonce_used(arg0: &Config, arg1: &u64) : bool {
        let v0 = find_nonce_from_table_vec(&arg0.used_nonces, arg1);
