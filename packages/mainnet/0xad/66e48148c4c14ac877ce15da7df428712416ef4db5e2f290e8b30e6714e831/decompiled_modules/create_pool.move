module 0xad66e48148c4c14ac877ce15da7df428712416ef4db5e2f290e8b30e6714e831::create_pool {
    ...
    public fun init_cetus_pool<T0>(arg0: address, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg6: &0x2::coin::CoinMetadata<T0>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : bool {
        let v0 = 200;
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= 1000000000, 2);
        assert!(0x2::coin::value<T0>(&arg2) >= 40000000000000, 2);
        let v1 = if (v0 == 100) {
            true
        } else if (v0 == 200) {
            true
        ...
        if (0x2::coin::value<T0>(&arg2) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, arg0);
        } else {
