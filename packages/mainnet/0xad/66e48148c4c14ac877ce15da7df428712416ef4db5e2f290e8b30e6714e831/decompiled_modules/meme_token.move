module 0xad66e48148c4c14ac877ce15da7df428712416ef4db5e2f290e8b30e6714e831::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"Dol", b"Doller", b"Doller", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-19T06-05-38.062Z-download.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Doller"),
            symbol     : 0x1::string::utf8(b"Dol"),
            decimals   : 9,
