module 0xad8fb3eeb67e4d35d8dfe030e64bd7ffa3979cf3d0a77ff428481970ef14ce89::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"ad", b"TestRaiden", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-06T10-03-35.694Z-social-media-image-sizes.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"TestRaiden"),
            symbol     : 0x1::string::utf8(b"ad"),
            decimals   : 9,
