module 0xadf215db6cf305663de079e937da8e1609b77839a8ae24a3f2fe4ef3661a115a::reward9347 {
    struct REWARD9347 has drop {
        dummy_field: bool,
    }

    struct TICKET_9347 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9347(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9347>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9347>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9347, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9347>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9347>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9347>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9347>>(v5, 0x2::tx_context::sender(arg1));
    }
