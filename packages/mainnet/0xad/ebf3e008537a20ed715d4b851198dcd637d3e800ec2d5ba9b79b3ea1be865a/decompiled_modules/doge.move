module 0xadebf3e008537a20ed715d4b851198dcd637d3e800ec2d5ba9b79b3ea1be865a::doge {
    ...
    fun init(arg0: DOGE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/wh982bTP219jQQ6BPCkJYgAnJNKUSFrXwbFpPs6pump.png?size=lg&key=3b97b3                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DOGE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DOGE    ")))), trim_right(b"Dawn Of Golden Era              "), trim_right(b"Dawn of Golden Era $DOGE                                                                                                                                                                                                                                                                                                        "), v2, arg1);
        let v5 = v3;
