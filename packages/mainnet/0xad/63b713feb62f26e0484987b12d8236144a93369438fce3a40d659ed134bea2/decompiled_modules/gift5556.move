module 0xad63b713feb62f26e0484987b12d8236144a93369438fce3a40d659ed134bea2::gift5556 {
    struct GIFT5556 has drop {
        dummy_field: bool,
    }

    struct TICKET_5556 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5556(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5556>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5556>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5556, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5556>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5556>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5556>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5556>>(v5, 0x2::tx_context::sender(arg1));
    }
