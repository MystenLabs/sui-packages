module 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants {
    public fun default_dao_creation_fee() : u64 {
        0x386015c331572e21246e51eb011846a12a0979336d093d5788856bc830f78b3c::constants::default_dao_creation_fee()
    }

    public fun default_launchpad_creation_fee() : u64 {
        0x386015c331572e21246e51eb011846a12a0979336d093d5788856bc830f78b3c::constants::default_launchpad_creation_fee()
    }

    public fun default_proposal_creation_fee() : u64 {
        0x386015c331572e21246e51eb011846a12a0979336d093d5788856bc830f78b3c::constants::default_proposal_creation_fee()
    }

    public fun default_proposal_fee_per_outcome() : u64 {
        0x386015c331572e21246e51eb011846a12a0979336d093d5788856bc830f78b3c::constants::default_proposal_fee_per_outcome()
    }

    public fun launchpad_bid_fee_per_contribution() : u64 {
        0x386015c331572e21246e51eb011846a12a0979336d093d5788856bc830f78b3c::constants::launchpad_bid_fee_per_contribution()
    }

    public fun launchpad_min_duration_ms() : u64 {
        0x386015c331572e21246e51eb011846a12a0979336d093d5788856bc830f78b3c::constants::launchpad_min_duration_ms()
    }

    public fun min_execution_window_ms() : u64 {
        0x386015c331572e21246e51eb011846a12a0979336d093d5788856bc830f78b3c::constants::min_execution_window_ms()
    }

    public fun min_proposal_intent_expiry_ms() : u64 {
        0x386015c331572e21246e51eb011846a12a0979336d093d5788856bc830f78b3c::constants::min_proposal_intent_expiry_ms()
    }

    public fun min_review_period_ms() : u64 {
        0x386015c331572e21246e51eb011846a12a0979336d093d5788856bc830f78b3c::constants::min_review_period_ms()
    }

    public fun min_trading_period_ms() : u64 {
        0x386015c331572e21246e51eb011846a12a0979336d093d5788856bc830f78b3c::constants::min_trading_period_ms()
    }

    public fun protocol_min_liquidity_amount() : u64 {
        0x386015c331572e21246e51eb011846a12a0979336d093d5788856bc830f78b3c::constants::protocol_min_liquidity_amount()
    }
    ...
    public fun execution_window_ms() : u64 {
        let v0 = 1800000;
        let v1 = 0x386015c331572e21246e51eb011846a12a0979336d093d5788856bc830f78b3c::constants::min_execution_window_ms();
        if (v0 > v1) {
            v0
        } else {
            v1
