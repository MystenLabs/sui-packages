module 0xad1e003fa28fde2b1f8d69e714d99d0f2c1d0fd5787071910072556dcf217012::probability_something_ {
    struct PROBABILITY_SOMETHING_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PROBABILITY_SOMETHING_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PROBABILITY_SOMETHING_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Probability Something "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"something coming "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://8hFplO-fLSzequwRxjtEFWx3z62XXT_-pB4lZPcI3Uw"));
