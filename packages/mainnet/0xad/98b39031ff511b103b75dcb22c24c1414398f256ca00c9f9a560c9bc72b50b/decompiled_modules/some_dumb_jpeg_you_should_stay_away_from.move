module 0xad98b39031ff511b103b75dcb22c24c1414398f256ca00c9f9a560c9bc72b50b::some_dumb_jpeg_you_should_stay_away_from {
    struct SOME_DUMB_JPEG_YOU_SHOULD_STAY_AWAY_FROM has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SOME_DUMB_JPEG_YOU_SHOULD_STAY_AWAY_FROM, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SOME_DUMB_JPEG_YOU_SHOULD_STAY_AWAY_FROM>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"some dumb jpeg you should stay away from"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"testing purposes"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreierdfzwd3furpvonhkqyk54xjzptdhufguyfh3t5ii7ns6sropwsu"));
