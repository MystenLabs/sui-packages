module 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration {
    ...
    public fun confirm<T0>(arg0: &mut MigrationVault<T0>, arg1: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::MigrationCap, arg2: 0x2::object::ID, arg3: 0x1::option::Option<0x2::object::ID>, arg4: &0x2::clock::Clock) {
        assert!(arg0.redeemed, 1);
        assert!(!arg0.confirmed, 2);
        arg0.confirmed = true;
        arg0.pool_id = 0x1::option::some<0x2::object::ID>(arg2);
        arg0.lp_burn_proof = arg3;
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events::migrated(arg0.curve_id, arg0.coin_type, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3, arg0.sui_at_graduation, arg0.tokens_at_graduation, 0x2::clock::timestamp_ms(arg4));
    }
    ...
    public fun redeem<T0>(arg0: &mut MigrationVault<T0>, arg1: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::MigrationCap) : (0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<T0>) {
        assert!(!arg0.redeemed, 0);
        arg0.redeemed = true;
        (0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.sui), 0x2::balance::withdraw_all<T0>(&mut arg0.tokens))
    }

    public fun redeem_coins<T0>(arg0: &mut MigrationVault<T0>, arg1: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::MigrationCap, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
    ...
    public fun sweep_dust<T0>(arg0: &mut MigrationVault<T0>, arg1: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::MigrationCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
