module 0xad25e9a5c774a76dfe6ca859d58f9413921e3ccd6642f4fbd874097e69346354::game8315 {
    struct GAME8315 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeTicket8315(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GAME8315, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME8315>(arg0, arg1);
