module 0xc436a8ccc36e649e0fd8c7cec88ca89747b69ba5bdefb15be2f93ae1ae632800::events_v1 {
    ...
    public fun emit_guard_savings_deposit_rate_snapshot_event(arg0: u64, arg1: u64, arg2: u64) {
        let v0 = GuardSavingsDepositRateSnapshotEvent{
            total_staked  : arg0,
            gdori_supply  : arg1,
            exchange_rate : arg2,
        };
        0x2::event::emit<GuardSavingsDepositRateSnapshotEvent>(v0);
    }
    ...
    public fun emit_guard_savings_dori_restaked_enriched_event(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: u64) {
        let v0 = GuardSavingsDoriRestakedEnrichedEvent{
            pool_id       : arg0,
            amount        : arg1,
            total_staked  : arg2,
            gdori_supply  : arg3,
        ...
        0x2::event::emit<GuardSavingsDoriRestakedEnrichedEvent>(v0);
    }
    ...
    public fun emit_guard_savings_withdraw_rate_snapshot_event(arg0: u64, arg1: u64, arg2: u64) {
        let v0 = GuardSavingsWithdrawRateSnapshotEvent{
            total_staked  : arg0,
            gdori_supply  : arg1,
            exchange_rate : arg2,
        };
        0x2::event::emit<GuardSavingsWithdrawRateSnapshotEvent>(v0);
    }
