module 0x8751d82e4a6c0eb08d09db745f0b73d6d7c7876a40ffbead791ed8b64c5e2bc8::vault {
    ...
    public fun add_to_position<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultOwnerCap, arg2: &Registry, arg3: &0xd439d1dd0ba68aea0b616c13af682a3f6281db5fc38f582b016655556b31335f::controller::Controller, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg6: 0x2::coin::Coin<T0>, arg7: 0x2::coin::Coin<T1>, arg8: &0x2::clock::Clock) {
        ...
        assert!(0x2::vec_map::contains<0x2::object::ID, PoolConfig>(&arg2.allowed_pools, &arg0.pool_id), 3);
        ...
        0x2::balance::join<T0>(&mut arg0.balance_a, 0x2::coin::into_balance<T0>(arg6));
        0x2::balance::join<T1>(&mut arg0.balance_b, 0x2::coin::into_balance<T1>(arg7));
        ...
        assert!(is_in_range<T0, T1>(arg5, &v0), 32);
        let (v1, v2) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::tick_range(&v0);
        let v3 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_tick_index<T0, T1>(arg5);
        let v4 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg5);
        let v5 = 0x2::balance::value<T0>(&arg0.balance_a);
        let v6 = 0x2::balance::value<T1>(&arg0.balance_b);
        let (v7, _, v9) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::get_liquidity_by_amount(v1, v2, v3, v4, v5, true);
        let v10 = if (v5 > 0 && v9 <= v6) {
            v7
        } else {
            let (v11, _, _) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::get_liquidity_by_amount(v1, v2, v3, v4, v6, false);
            v11
        };
        assert!(v10 > 0, 34);
        let v14 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity<T0, T1>(arg4, arg5, &mut v0, v10, arg8);
        let (v15, v16) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_pay_amount<T0, T1>(&v14);
        assert!(v15 <= 0x2::balance::value<T0>(&arg0.balance_a) && v16 <= 0x2::balance::value<T1>(&arg0.balance_b), 35);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_add_liquidity<T0, T1>(arg4, arg5, 0x2::balance::split<T0>(&mut arg0.balance_a, v15), 0x2::balance::split<T1>(&mut arg0.balance_b, v16), v14);
        ...
        0x2::event::emit<LiquidityAdded>(v17);
    }
    ...
    public fun withdraw_partial<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultOwnerCap, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert_cap<T0, T1>(arg0, arg1);
        assert!(0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg3) == arg0.pool_id, 4);
        assert!(0x1::option::is_some<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&arg0.position), 6);
        assert!(arg4 > 0 && arg4 < 0xd439d1dd0ba68aea0b616c13af682a3f6281db5fc38f582b016655556b31335f::controller::bps(), 33);
        let v0 = 0x1::option::extract<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut arg0.position);
        let v1 = share_of_liquidity(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(&v0), arg4);
        let (v2, v3) = if (v1 > 0) {
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::remove_liquidity<T0, T1>(arg2, arg3, &mut v0, v1, arg5)
        } else {
        ...
        let v5 = v2;
        0x1::option::fill<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut arg0.position, v0);
        let v6 = mul_div(0x2::balance::value<T0>(&arg0.balance_a), arg4, 0xd439d1dd0ba68aea0b616c13af682a3f6281db5fc38f582b016655556b31335f::controller::bps());
        let v7 = mul_div(0x2::balance::value<T1>(&arg0.balance_b), arg4, 0xd439d1dd0ba68aea0b616c13af682a3f6281db5fc38f582b016655556b31335f::controller::bps());
        if (v6 > 0) {
            0x2::balance::join<T0>(&mut v5, 0x2::balance::split<T0>(&mut arg0.balance_a, v6));
        };
        if (v7 > 0) {
            0x2::balance::join<T1>(&mut v4, 0x2::balance::split<T1>(&mut arg0.balance_b, v7));
        };
