module 0xadaf8024056724bfade257c3dd351c226580999fe35baece0ab4bfa9688513a8::suimon_rookie_card {
    struct SUIMON_ROOKIE_CARD has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUIMON_ROOKIE_CARD, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUIMON_ROOKIE_CARD>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Suimon Rookie Card"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The first Suimon Liquid NFT to hit the market. Drowning in Hopium."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiezvslc2uwb7dchjbcp7pi7d7kudph3ndokwj5lr53y3lqqh4pjaq"));
