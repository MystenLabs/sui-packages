module 0xad14a95f6ae41ec977ffba97c08d73bf114c1d6d127a24774bc3f5a5f877cdc3::reward6045 {
    struct REWARD6045 has drop {
        dummy_field: bool,
    }

    struct TICKET_6045 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6045(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6045>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6045>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6045, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6045>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6045>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6045>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6045>>(v5, 0x2::tx_context::sender(arg1));
    }
