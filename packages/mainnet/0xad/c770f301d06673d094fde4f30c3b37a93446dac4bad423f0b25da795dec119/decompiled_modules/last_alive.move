module 0xadc770f301d06673d094fde4f30c3b37a93446dac4bad423f0b25da795dec119::last_alive {
    ...
    struct TokenWrapper<phantom T0: store + key> has store, key {
        id: 0x2::object::UID,
    ...
    public entry fun add_token_reward<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x2::object::ID>(0x2::table::borrow_mut<u64, vector<0x2::object::ID>>(&mut arg1.pending_token_wrappers, v0), 0x2::object::uid_to_inner(&v3.id));
        if (0x2::coin::value<T0>(&arg2) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, 0x2::tx_context::sender(arg4));
        } else {
            0x2::coin::destroy_zero<T0>(arg2);
        };
        0x2::transfer::share_object<TokenWrapper<T0>>(v3);
