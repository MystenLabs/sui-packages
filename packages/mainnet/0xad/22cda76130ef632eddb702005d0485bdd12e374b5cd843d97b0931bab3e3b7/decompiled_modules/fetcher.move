module 0xad22cda76130ef632eddb702005d0485bdd12e374b5cd843d97b0931bab3e3b7::fetcher {
    ...
    public entry fun fetch_deepbook_status_ask_side<T0, T1>(arg0: &0xdee9::clob_v2::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock) {
        ...
        let v8 = v7;
        loop {
            let v9 = 0xdee9::order_query::iter_asks<T0, T1>(arg0, arg3, arg4, 0x1::option::none<u64>(), 0x1::option::none<u64>(), true);
            ...
            while (v12 < v11) {
                ...
                if (v12 == 0) {
                    if (0x1::vector::length<PriceRange>(&v0) == 0) {
                        v2 = calc_ask_check_point(v13, arg2);
                        let v14 = &mut v0;
                        add_price_range_to_vec(v14, v13, 0);
                        v8 = v13;
                        v12 = v12 + 1;
                        continue
                    };
                ...
                if (v13 > v2) {
                    0x1::vector::borrow_mut<PriceRange>(&mut v0, v3).price_high = v7;
                    let v15 = v3 + 1;
                    v3 = v15;
                    if (v15 >= arg1) {
                        if (v12 != v11 - 1) {
                    ...
                    let v17 = &mut v0;
                    add_price_range_to_vec(v17, v13, 0);
                    v2 = calc_ask_check_point(v13, arg2);
                };
                v8 = v13;
                v12 = v12 + 1;
            ...
            if (!0xdee9::order_query::has_next_page(&v9)) {
                0x1::vector::borrow_mut<PriceRange>(&mut v0, v3).price_high = v8;
                break
            };
        ...
        while (v18 < 0x1::vector::length<PriceRange>(&v0)) {
            ...
            let (_, v21) = 0xdee9::clob_v2::get_level2_book_status_ask_side<T0, T1>(arg0, v19.price_low, v19.price_high, arg5);
            let v22 = v21;
            if (0x1::vector::length<u64>(&v22) != 0) {
                let v23 = &mut v1;
                add_price_data_to_vec(v23, calc_ask_check_point(v19.price_low, arg2), sum_depth(&v22));
            };
            v18 = v18 + 1;
        };
