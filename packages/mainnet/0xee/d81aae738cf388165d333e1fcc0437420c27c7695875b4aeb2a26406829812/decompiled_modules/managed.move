module 0xeed81aae738cf388165d333e1fcc0437420c27c7695875b4aeb2a26406829812::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 9, b"SCSUI", b"SCASUI LP", b"SCASUI LP", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.ibb.co/7rNZvsk/logo-192.png")), arg1);
