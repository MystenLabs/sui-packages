module 0xeee89d0396765b943bc55396b4c3b99fc11abc82acccd63d0f11690b01880866::tocen_coin_flip {
    ...
    struct GameCheck has key {
        id: 0x2::object::UID,
        stringrandomness: vector<u8>,
        messageVector: vector<u8>,
    }

    public entry fun check(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::bls12381::bls12381_min_pk_verify(&arg0, &arg1, &arg2), 3);
    }
