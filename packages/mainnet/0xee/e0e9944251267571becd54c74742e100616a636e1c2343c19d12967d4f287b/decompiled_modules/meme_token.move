module 0xeee0e9944251267571becd54c74742e100616a636e1c2343c19d12967d4f287b::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"ZEUS", b"MetaZeus", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-02T11-16-15.478Z-RDPtnTZR_400x400.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"MetaZeus"),
            symbol     : 0x1::string::utf8(b"ZEUS"),
            decimals   : 9,
