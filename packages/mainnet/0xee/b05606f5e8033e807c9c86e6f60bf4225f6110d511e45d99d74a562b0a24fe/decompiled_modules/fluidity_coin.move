module 0xeeb05606f5e8033e807c9c86e6f60bf4225f6110d511e45d99d74a562b0a24fe::fluidity_coin {
    ...
    public fun burn(arg0: &mut 0x2::coin::TreasuryCap<FLUIDITY_COIN>, arg1: &Global, arg2: &mut CoinReserve, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.vaults_initialized == true, 0);
        assert!(0x2::balance::value<FLUIDITY_COIN>(&arg2.balance) >= arg3, 2);
        0x2::coin::burn<FLUIDITY_COIN>(arg0, 0x2::coin::from_balance<FLUIDITY_COIN>(0x2::balance::split<FLUIDITY_COIN>(&mut arg2.balance, arg3), arg4));
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<FLUIDITY_COIN>, arg1: &Global, arg2: &mut CoinReserve, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.vaults_initialized == true, 3);
        0x2::balance::join<FLUIDITY_COIN>(&mut arg2.balance, 0x2::coin::into_balance<FLUIDITY_COIN>(0x2::coin::mint<FLUIDITY_COIN>(arg0, arg3, arg4)));
    }
