module 0xeecbb0b6df316cfddb7ae0285ff774abd7547b0d87647a404aa55758f5ff6d1a::crash {
    ...
    public entry fun play_crash(arg0: &mut 0xeecbb0b6df316cfddb7ae0285ff774abd7547b0d87647a404aa55758f5ff6d1a::house_pool::HousePool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0xeecbb0b6df316cfddb7ae0285ff774abd7547b0d87647a404aa55758f5ff6d1a::house_pool::process_bet(arg0, arg1, v5, v8, b"crash", arg4);
        let v10 = CrashResult{
            player        : v0,
            bet_amount    : v1,
            won           : v5,
