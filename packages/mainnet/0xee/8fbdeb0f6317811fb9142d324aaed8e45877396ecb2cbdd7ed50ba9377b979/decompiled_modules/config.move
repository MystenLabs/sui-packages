module 0xee8fbdeb0f6317811fb9142d324aaed8e45877396ecb2cbdd7ed50ba9377b979::config {
    ...
    public fun add_plan(arg0: &mut Config, arg1: &0xee8fbdeb0f6317811fb9142d324aaed8e45877396ecb2cbdd7ed50ba9377b979::admin::AdminCap, arg2: u64, arg3: u64) {
    ...
    public fun remove_plan(arg0: &mut Config, arg1: &0xee8fbdeb0f6317811fb9142d324aaed8e45877396ecb2cbdd7ed50ba9377b979::admin::AdminCap, arg2: u64) {
    ...
    public fun set_paused(arg0: &mut Config, arg1: &0xee8fbdeb0f6317811fb9142d324aaed8e45877396ecb2cbdd7ed50ba9377b979::admin::AdminCap, arg2: bool) {
        arg0.paused = arg2;
    }

    public fun update_admin_wallet(arg0: &mut Config, arg1: &0xee8fbdeb0f6317811fb9142d324aaed8e45877396ecb2cbdd7ed50ba9377b979::admin::AdminCap, arg2: address) {
        arg0.admin_wallet = arg2;
    }

    public fun update_plan(arg0: &mut Config, arg1: &0xee8fbdeb0f6317811fb9142d324aaed8e45877396ecb2cbdd7ed50ba9377b979::admin::AdminCap, arg2: u64, arg3: u64) {
        assert!(0x2::vec_map::contains<u64, SubscriptionPlan>(&arg0.plans, &arg2), 102);
        assert!(arg3 > 0, 105);
        let (_, _) = 0x2::vec_map::remove<u64, SubscriptionPlan>(&mut arg0.plans, &arg2);
