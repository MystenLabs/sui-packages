module 0xee165881117f32e6942ffecb031c41c4a1d05ae341a8126702f3014347c67564::movexnft4438 {
    struct MOVEXNFT4438 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT4438, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://fyryzi3023.vercel.app/api/{id}"));
        ...
        let v4 = 0x2::package::claim<MOVEXNFT4438>(arg0, arg1);
