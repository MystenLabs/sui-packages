module 0xee22940c7ae13261598ce94d31d499cc58cc0025f35c4580612dcc26e457466d::cnsnft3579 {
    struct CNSNFT3579 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3579, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7489"));
        let v4 = 0x2::package::claim<CNSNFT3579>(arg0, arg1);
