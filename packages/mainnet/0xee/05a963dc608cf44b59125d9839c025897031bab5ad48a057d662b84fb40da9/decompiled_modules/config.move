module 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::config {
    ...
    struct GlobalConfig has store, key {
        ...
        acl: 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::ACL,
        package_version: u64,
    }
    ...
    public fun acl(arg0: &GlobalConfig) : &0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::ACL {
        &arg0.acl
    }

    public fun add_role(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u8) {
        checked_package_version(arg0);
        0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::add_role(&mut arg0.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::Member> {
        0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        checked_package_version(arg0);
        0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun remove_role(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u8) {
        checked_package_version(arg0);
        0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::remove_role(&mut arg0.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        checked_package_version(arg0);
        0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun add_update_bin_step(arg0: &mut GlobalConfig, arg1: u16, arg2: u16, arg3: u16, arg4: u16, arg5: u16, arg6: u32, arg7: u16, arg8: u32, arg9: &0x2::tx_context::TxContext) {
        assert!(arg1 >= 1, 1);
        checked_package_version(arg0);
    ...
    public fun check_bin_step_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::has_role(&arg0.acl, arg1, 1), 1);
    }

    public fun check_pair_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::has_role(&arg0.acl, arg1, 0), 5);
    }

    public fun check_protocol_fee_claim_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::has_role(&arg0.acl, arg1, 2), 2);
    }

    public fun check_quote_whitelist_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::has_role(&arg0.acl, arg1, 4), 11);
    }

    public fun check_rewarder_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::has_role(&arg0.acl, arg1, 3), 3);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                   : 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::acl::new(arg0),
            package_version       : 1,
        };
