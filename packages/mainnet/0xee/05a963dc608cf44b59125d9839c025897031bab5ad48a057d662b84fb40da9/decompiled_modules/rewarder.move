module 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::rewarder {
    ...
    fun accumulate_pending_rewards(arg0: &mut RewarderManager, arg1: u64) {
        ...
        while (v0 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            ...
            if (v1.emissions_per_second > 0) {
                let v2 = 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::mul_u128(v1.emissions_per_second, ((arg1 - arg0.last_update_time) as u128));
                let v3 = 0x1::vector::borrow_mut<u128>(&mut arg0.pending_rewards, v0);
                *v3 = 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::add_u128(*v3, v2);
            };
            v0 = v0 + 1;
        };
    ...
    fun calculate_bin_reward_share(arg0: &FeeAmounts, arg1: &FeeAmounts, arg2: u128) : u128 {
        ...
        arg2 * 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::max_u128(v0, v1) >> 64
    }
            ...
            if (v9 > 0) {
                ...
                while (v11 < 0x1::vector::length<u32>(&v3)) {
                    ...
                    if (v13 > 0) {
                        ...
                        v10 = 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::add_u64(v10, 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::u128_to_u64(v13));
                    };
                    v11 = v11 + 1;
                };
    ...
    public fun calculate_rewards_owed(arg0: u128, arg1: u128, arg2: u128) : u64 {
        ...
        let v0 = if (arg2 >= arg1) {
            ...
            0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::add_u128(0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::add_u128(0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::sub_u128(340282366920938463463374607431768211455, arg1), arg2), 1)
        };
        let v1 = arg0 * v0 >> 64;
    ...
    public(friend) fun track_bin_fees(arg0: &mut FeeTracking, arg1: u32, arg2: u64, arg3: u64) {
        ...
        v1.fee_x = 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::add_u64(v1.fee_x, arg2);
        v1.fee_y = 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::add_u64(v1.fee_y, arg3);
        arg0.total_fees.fee_x = 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::add_u64(arg0.total_fees.fee_x, arg2);
        arg0.total_fees.fee_y = 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::add_u64(arg0.total_fees.fee_y, arg3);
    }
    ...
    public(friend) fun update_emission<T0>(arg0: &RewarderGlobalVault, arg1: &mut RewarderManager, arg2: 0x2::object::ID, arg3: u128, arg4: u64) {
        ...
        if (arg3 > v2 && arg3 > 0) {
            assert!(balance_of<T0>(arg0) >= 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::u128_to_u64(0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::safe_math::mul_u128(arg3, (86400 as u128))), 3003);
        };
