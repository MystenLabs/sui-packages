module 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::q64x64 {
    ...
    public fun log2(arg0: u128) : u128 {
        ...
        let v3 = 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::bit_math::most_significant_bit_u128(v1);
        let v4 = 64;
        let v5 = if (v3 >= v4) {
    ...
    public fun sqrt(arg0: u128) : u128 {
        ...
        let v0 = 0xee05a963dc608cf44b59125d9839c025897031bab5ad48a057d662b84fb40da9::bit_math::most_significant_bit_u128(arg0);
        let v1 = if (v0 >= 64) {
            1 << (v0 + 64) / 2
        } else {
            1 << (v0 + 64) / 2
