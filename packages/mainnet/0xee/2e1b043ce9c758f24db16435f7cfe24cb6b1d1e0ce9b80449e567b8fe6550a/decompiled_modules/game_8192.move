module 0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_8192 {
    ...
    struct Game8192 has store, key {
        ...
        game: u64,
        player: address,
        active_board: 0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::GameBoard8192,
        move_count: u64,
        score: u64,
        top_tile: u64,
        game_over: bool,
    ...
    public fun active_board(arg0: &Game8192) : &0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::GameBoard8192 {
        &arg0.active_board
    }
    ...
    public entry fun create(arg0: &mut Game8192Maintainer, arg1: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::default(0x2::object::uid_to_bytes(&v3));
        let v5 = *0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::score(&v4);
        let v6 = Game8192{
            id           : v3,
            ...
            move_count   : 0,
            score        : v5,
            top_tile     : *0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::top_tile(&v4),
            game_over    : false,
        };
        let v7 = NewGameEvent8192{
            ...
            player        : v2,
            score         : v5,
            packed_spaces : *0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::packed_spaces(&v4),
        };
    ...
    public entry fun make_move(arg0: &mut Game8192, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::move_direction(&mut v0, arg1, 0x2::object::uid_to_bytes(&v1));
        let v2 = arg0.move_count + 1;
        let v3 = *0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::top_tile(&v0);
        let v4 = *0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::score(&v0);
        let v5 = *0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::game_over(&v0);
        let v6 = GameMoveEvent8192{
            game_id       : 0x2::object::uid_to_inner(&arg0.id),
            direction     : arg1,
            move_count    : v2,
            packed_spaces : *0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::packed_spaces(&v0),
            last_tile     : *0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::last_tile(&v0),
            top_tile      : v3,
            score         : v4,
            game_over     : v5,
        };
    ...
    public fun score(arg0: &Game8192) : &u64 {
        0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::score(active_board(arg0))
    }

    public fun top_tile(arg0: &Game8192) : &u64 {
        0xee2e1b043ce9c758f24db16435f7cfe24cb6b1d1e0ce9b80449e567b8fe6550a::game_board_8192::top_tile(active_board(arg0))
    }
