module 0xbccd998a04063ba11378af805a9c36f3ccc376cafe9a381f56f36cb3046e9c4b::errors {
    ...
    public fun force_withdraw_collateral_leftover() : u64 {
        47
    }
    ...
    public fun invalid_vault_assistant_cap() : u64 {
        48
    }
    ...
    public fun owner_locked_amount_too_big() : u64 {
        51
    }

    public fun owner_locked_amount_too_low_after_withdraw() : u64 {
        49
    }
    ...
    public fun pause_vault_for_force_withdraw_too_frequent() : u64 {
        46
    }
