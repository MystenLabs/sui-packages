module 0xee251474acf86e0abf8fa08ab5791ddc168da2a8de3790d7f7d2614a429318ee::cnsnft2537 {
    struct CNSNFT2537 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2537, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2537>(arg0, arg1);
