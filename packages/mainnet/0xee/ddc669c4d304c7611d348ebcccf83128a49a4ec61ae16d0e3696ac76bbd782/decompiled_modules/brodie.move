module 0xeeddc669c4d304c7611d348ebcccf83128a49a4ec61ae16d0e3696ac76bbd782::brodie {
    ...
    fun init(arg0: BRODIE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/8v9PinzsdN1BtEQynj8URPo2U5gFXgGLzFhcgWEguvRs.png?size=lg&key=81e5d4                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BRODIE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Brodie    ")))), trim_right(b"brodiethatdood                  "), trim_right(b"That one goldendoodle  $BRODIE                                                                                                                                                                                                                                                                                                  "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
