module 0xeefca3b59bb2a6d1218b9d294bce85430b5a9826dc4ce5abd8148a49f9cdef4f::my_coin {
    ...
    fun init(arg0: MY_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MY_COIN>(arg0, 2, b"YUNJUDE", b"YUNJUDE's coin", b"YUNJUDE's coin", 0x1::option::none<0x2::url::Url>(), arg1);
