module 0xeefca3b59bb2a6d1218b9d294bce85430b5a9826dc4ce5abd8148a49f9cdef4f::faucet_coin {
    ...
    fun init(arg0: FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCET_COIN>(arg0, 2, b"YUNJUDE", b"YUNJUDE's faucet coin", b"YUNJUDE's faucet coin", 0x1::option::none<0x2::url::Url>(), arg1);
