module 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::oracle_ag {
    ...
    fun new(arg0: &mut 0x2::tx_context::TxContext) : (OracleAggregator, OracleAggregatorCap) {
        let v0 = OracleAggregator{
            ...
            max_age               : 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::consts::GET_PYTH_MAX_AGE(),
    ...
    public fun get_price<T0>(arg0: &OracleAggregator, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : (u64, u64, u64) {
        ...
        let (v6, v7) = if (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_is_negative(&v5) == true) {
            ...
            assert!(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_conf(&v0) < v8 * 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::consts::GET_MAX_PRICE_CONF_BPS() / 10000, 2);
            ...
            assert!(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_conf(&v0) < v9 * 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::consts::GET_MAX_PRICE_CONF_BPS() / 10000, 2);
            (v9, 0)
        };
    ...
    public fun calc_usd_value<T0>(arg0: &OracleAggregator, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        ...
        (0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_math::scale_from_float(0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_math::mul_u128(0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_math::scale_to_float((arg2 as u128), (get_coin_decimal<T0>(arg0) as u64)), 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_math::scale_to_float((v0 as u128), v1)), 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::consts::GET_USDC_DECIMALS()) as u64)
    }
