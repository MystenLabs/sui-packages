module 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_lp_farm {
    ...
    public fun remove_farm_key_from_td_farm<T0, T1>(arg0: &mut LotusLPFarm<T0>, arg1: &mut 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>, arg2: &mut LotusLPFarmCloseVaultTicket, arg3: &0x2::clock::Clock) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T1>());
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::remove_farm_key_from_td_farm<T0, T1>(arg1, 0x2::bag::borrow_mut<0x1::ascii::String, 0x24cb7217bd01527c82e452e1ac8357774618ed1576029ee2b35f7b78d413c700::farm::Farm<T1>>(&mut arg0.td_farms, v0), arg3);
    ...
    public fun add_banned_vault<T0>(arg0: &mut LotusLPFarm<T0>, arg1: &LotusLPFarmCap, arg2: &0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>) {
        let v0 = 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(arg2);
        assert_farm_cap<T0>(arg0, arg1);
    ...
    public fun add_incentivized_db_vault_to_td_farm_with_ticket<T0, T1>(arg0: &mut LotusLPFarm<T0>, arg1: &mut 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>, arg2: &mut LotusLPFarmCreateVaultTicket, arg3: &0x2::clock::Clock) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T1>());
        assert!(!0x2::vec_set::contains<0x1::ascii::String>(&arg2.td_farm_keys, &v0), 1);
        0x2::vec_set::insert<0x1::ascii::String>(&mut arg2.td_farm_keys, v0);
        0x1::debug::print<u64>(&arg2.usd_value);
        let v1 = ((arg2.usd_value / 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::consts::GET_TD_WEIGHT_SCALE()) as u32);
        let v2 = v1;
        if (v1 == 0) {
            v2 = 1;
        };
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::add_to_td_farm<T0, T1>(arg1, 0x2::bag::borrow_mut<0x1::ascii::String, 0x24cb7217bd01527c82e452e1ac8357774618ed1576029ee2b35f7b78d413c700::farm::Farm<T1>>(&mut arg0.td_farms, v0), 0x2::bag::borrow<0x1::ascii::String, 0x24cb7217bd01527c82e452e1ac8357774618ed1576029ee2b35f7b78d413c700::farm::AdminCap>(&arg0.td_farm_admin_caps, v0), v2, arg3);
    }
    ...
    fun assert_farm_cap<T0>(arg0: &LotusLPFarm<T0>, arg1: &LotusLPFarmCap) {
        assert!(0x2::object::id<LotusLPFarm<T0>>(arg0) == arg1.farm_id, 9223374437741494271);
    }

    public fun close_vault<T0>(arg0: &mut LotusLPFarm<T0>, arg1: &0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>, arg2: &0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVaultCap) : LotusLPFarmCloseVaultTicket {
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::assert_vault_cap_access<T0>(arg1, arg2, 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::GET_P_MASTER_ACCESS());
        let v0 = 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::get_shareholder_address_vec<T0>(arg1);
        assert!(0x1::vector::length<address>(&v0) == 0, 9);
        new_close_vault_ticket<T0>(arg0)
    }

    public fun create_incentivized_db_vault<T0, T1, T2>(arg0: &mut LotusLPFarm<T0>, arg1: &0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_config::LotusConfig, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T1, T2>, arg3: 0x2::coin::Coin<T1>, arg4: 0x2::coin::Coin<T2>, arg5: &0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::oracle_ag::OracleAggregator, arg6: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg7: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>, 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVaultCap, LotusLPFarmCreateVaultTicket) {
        ...
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::oracle_ag::assert_price_object_type<T1>(arg5, arg6);
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::oracle_ag::assert_price_object_type<T2>(arg5, arg7);
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_config::assert_protocol_status_ok(arg1);
        let v1 = 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::oracle_ag::calc_usd_value<T1>(arg5, arg6, 0x2::coin::value<T1>(&arg3), arg8) + 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::oracle_ag::calc_usd_value<T2>(arg5, arg7, 0x2::coin::value<T2>(&arg4), arg8);
        let (v2, v3) = 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::new_for_pooling<T0>(v0, v1, arg8, arg9);
        let v4 = v3;
        let v5 = v2;
        0x2::vec_set::insert<0x2::object::ID>(&mut arg0.vault_ids, 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(&v5));
        0x2::vec_map::insert<0x2::object::ID, 0x2::object::ID>(&mut arg0.vault_td_farm_member_ids, 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(&v5), 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::get_td_farm_member_key_id<T0>(&v5));
        assert!(v1 >= arg0.min_vault_usd_value, 7);
        let v6 = 0x1::string::utf8(b"Create Incentivized DB Vault at initial value: ");
        0x1::debug::print<0x1::string::String>(&v6);
        0x1::debug::print<u64>(&v1);
        assert_deposit_asset_type<T0, T1>(arg0);
        assert_deposit_asset_type<T0, T2>(arg0);
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::deposit<T1, T0>(&mut v5, arg3, arg9);
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::deposit<T2, T0>(&mut v5, arg4, arg9);
        assert!(get_vault_tvls_sum<T0>(arg0) + v1 <= arg0.max_tvl, 6);
        0x2::vec_map::insert<0x2::object::ID, u64>(&mut arg0.vault_tvls, 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(&v5), v1);
        let v7 = CreateIncentivizedDBVaultEvent{
            farm_id             : 0x2::object::id<LotusLPFarm<T0>>(arg0),
            balance_manager_id  : 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::balance_manager_id<T0>(&v5),
            ...
            vault_id            : 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(&v5),
            vault_cap_id        : 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVaultCap>(&v4),
        };
        0x2::event::emit<CreateIncentivizedDBVaultEvent>(v7);
        (v5, v4, new_create_pool_ticket<T0>(arg0, v1))
    }
    ...
    public fun remove_banned_vault<T0>(arg0: &mut LotusLPFarm<T0>, arg1: &LotusLPFarmCap, arg2: &0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>) {
        let v0 = 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(arg2);
        assert_farm_cap<T0>(arg0, arg1);
    ...
    public fun top_up_to_td_pool<T0, T1>(arg0: &mut LotusLPFarm<T0>, arg1: &mut 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>, arg2: &mut 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::TopUpTicket, arg3: &0x2::clock::Clock) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T1>());
        ...
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::td_pool_top_up<T0, T1>(0x2::bag::borrow_mut<0x1::ascii::String, 0x24cb7217bd01527c82e452e1ac8357774618ed1576029ee2b35f7b78d413c700::farm::Farm<T1>>(&mut arg0.td_farms, v0), arg1, arg2, arg3);
    }
    ...
    public fun update_vault_weight_with_ticket<T0, T1, T2, T3>(arg0: &mut LotusLPFarm<T0>, arg1: &0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T2, T3>, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: &0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::oracle_ag::OracleAggregator, arg7: &mut LotusLPFarmUpdatePoolWeightTicket, arg8: &0x2::clock::Clock) {
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::assert_db_pool<T0, T2, T3>(arg1, arg2);
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::oracle_ag::assert_price_object_type<T2>(arg6, arg3);
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::oracle_ag::assert_price_object_type<T3>(arg6, arg4);
        0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::oracle_ag::assert_price_object_type<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(arg6, arg5);
        assert!(arg7.key_id == 0x2::object::id<LotusLPFarm<T0>>(arg0), 10);
        let v0 = 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(arg1);
        let (v1, v2) = if (0x2::vec_set::contains<0x2::object::ID>(&arg0.banned_vault_ids, &v0)) {
            (0, 1)
        } else {
            let v3 = 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::get_total_usd_value<T0, T2, T3>(arg1, arg2, arg3, arg4, arg5, arg6, arg8);
            (v3, ((v3 / 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::consts::GET_TD_WEIGHT_SCALE()) as u32))
        };
        if (v2 == 0) {
            v2 = 1;
        };
        let v4 = 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(arg1);
        ...
        let v8 = 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(arg1);
        if (0x2::vec_map::contains<0x2::object::ID, u64>(&arg0.vault_tvls, &v8)) {
            let v9 = 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(arg1);
            *0x2::vec_map::get_mut<0x2::object::ID, u64>(&mut arg0.vault_tvls, &v9) = v1;
        } else {
            0x2::vec_map::insert<0x2::object::ID, u64>(&mut arg0.vault_tvls, 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(arg1), v1);
        };
        0x2::vec_set::insert<0x2::object::ID>(&mut arg7.vault_ids, 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(arg1));
        let v10 = UpdateVaultWeightEvent{
            farm_id   : 0x2::object::id<LotusLPFarm<T0>>(arg0),
            vault_id  : 0x2::object::id<0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_db_vault::LotusDBVault<T0>>(arg1),
            usd_value : v1,
        };
