module 0xeee3cc80a95b3085149154c79d7aca4101ce9706869117a992884cd8ede59ba1::lotus_math {
    ...
    public(friend) fun scale_from_float(arg0: u128, arg1: u64) : u128 {
        (((arg0 as u128) * (0x2::math::pow(10, (arg1 as u8)) as u128) / 1000000000) as u128)
    }

    public(friend) fun scale_to_float(arg0: u128, arg1: u64) : u128 {
