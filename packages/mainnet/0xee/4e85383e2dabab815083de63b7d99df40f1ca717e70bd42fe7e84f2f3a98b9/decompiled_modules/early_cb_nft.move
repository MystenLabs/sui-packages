module 0xee4e85383e2dabab815083de63b7d99df40f1ca717e70bd42fe7e84f2f3a98b9::early_cb_nft {
    ...
    public entry fun mint_and_send(arg0: &AdminCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = EarlyCBNFT{
        ...
        0x2::transfer::public_transfer<EarlyCBNFT>(v0, arg1);
    }
