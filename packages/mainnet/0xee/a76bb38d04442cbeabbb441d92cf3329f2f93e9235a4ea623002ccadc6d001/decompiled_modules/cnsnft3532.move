module 0xeea76bb38d04442cbeabbb441d92cf3329f2f93e9235a4ea623002ccadc6d001::cnsnft3532 {
    struct CNSNFT3532 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3532, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3532>(arg0, arg1);
