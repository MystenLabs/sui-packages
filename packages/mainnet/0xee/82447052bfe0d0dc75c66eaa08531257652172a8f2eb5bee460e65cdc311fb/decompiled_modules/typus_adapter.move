module 0x97b18226a610c8670fe402582f3f9c1de673e3b50520cb92b6e29a4c0c16a2::typus_adapter {
    ...
    struct TypusVault has key {
        ...
        lp: 0x2::balance::Balance<0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::tlp::TLP>,
        record: TypusRecord,
        is_redeeming: bool,
    }
    ...
    public fun new<T0: drop>(arg0: &mut TypusAdapterRegistry, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Typus>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = TypusVault{
            ...
            lp            : 0x2::balance::zero<0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::tlp::TLP>(),
            record        : v4,
            is_redeeming  : false,
        };
        0x2::vec_map::insert<0x2::object::ID, 0x2::object::ID>(&mut arg0.map, v3, *0x2::object::uid_as_inner(&v5.id));
        0x97b18226a610c8670fe402582f3f9c1de673e3b50520cb92b6e29a4c0c16a2::typus_adapter_event::new_typus_vault_event(*0x2::object::uid_as_inner(&v5.id), v3);
    ...
    public fun withdraw<T0, T1>(arg0: &mut 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::Version, arg1: &mut 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::lp_pool::Registry, arg2: &mut 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::treasury_caps::TreasuryCaps, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::lp_pool::redeem<T1>(arg0, arg1, arg4, 0x2::coin::into_balance<T1>(arg5), arg6, arg7);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::lp_pool::claim<T1, T0>(arg0, arg1, arg4, arg2, arg3, arg6, arg7), 0x2::tx_context::sender(arg7));
    }
