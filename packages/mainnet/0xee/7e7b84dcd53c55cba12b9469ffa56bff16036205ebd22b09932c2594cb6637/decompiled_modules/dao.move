module 0xee7e7b84dcd53c55cba12b9469ffa56bff16036205ebd22b09932c2594cb6637::dao {
    ...
    public entry fun change_fund_status<T0>(arg0: &mut DAOFund<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 < arg0.fundraise_end_at && 0x2::balance::value<0x2::sui::SUI>(&arg0.balance) >= v1) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg0.dao_token_balance), arg2), arg0.creator);
    ...
    public entry fun commit<T0>(arg0: &mut DAOFund<T0>, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.dao_token_balance, arg0.price * v2), arg4), 0x2::tx_context::sender(arg4));
        ...
        let v8 = CommittedEvent{
            dao_fund_id  : 0x2::object::id<DAOFund<T0>>(arg0),
            sender       : 0x2::tx_context::sender(arg4),
            amount       : v2,
            committed_at : v3,
        };
        0x2::event::emit<CommittedEvent>(v8);
    }

    public entry fun create_dao_fund<T0>(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: 0x1::string::String, arg5: 0x2::coin::Coin<T0>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<T0>(&arg5) == arg3, 1014);
        let v0 = 0x2::clock::timestamp_ms(arg7);
        let v1 = ((((arg3 / 110 * 100) as u64) / arg6 * 110 / 100) as u64);
        let v2 = DAOFund<T0>{
            ...
            tracked_addresses          : 0x2::table::new<address, UserDAO>(arg8),
            is_seeded                  : false,
            ...
            dao_token_balance          : 0x2::coin::into_balance<T0>(arg5),
        };
        ...
        0x2::transfer::transfer<AdminCap>(v5, 0x2::tx_context::sender(arg8));
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0xee7e7b84dcd53c55cba12b9469ffa56bff16036205ebd22b09932c2594cb6637::dao_config::new_global_dao_fee_and_shared(arg0);
    }
    ...
    public entry fun set_platform_fee(arg0: &OperatorCap, arg1: &mut 0xee7e7b84dcd53c55cba12b9469ffa56bff16036205ebd22b09932c2594cb6637::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0xee7e7b84dcd53c55cba12b9469ffa56bff16036205ebd22b09932c2594cb6637::dao_config::set_platform_fee(arg1, arg2, arg3, arg4);
    }
    ...
    public entry fun withdraw<T0>(arg0: &mut DAOFund<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = arg0.price * arg2;
        assert!(0x2::coin::value<T0>(&arg1) >= v0, 1005);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg1, v0, arg4), @0x0);
