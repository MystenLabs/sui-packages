module 0xee5c9793a072ae08b7fd0f14fb4b79299cfa7e15977a1616664b4e1a0e1db0cc::makergpt_retro_bot_agents {
    struct MAKERGPT_RETRO_BOT_AGENTS has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"8dbcd0da-220c-4205-b855-75e99bb70aae"),
        };
    ...
    fun init(arg0: MAKERGPT_RETRO_BOT_AGENTS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MAKERGPT_RETRO_BOT_AGENTS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"MakerGPT Retro Bot Agents"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x"446973636f766572204d616b657247505420526574726f20426f747320e28093207574696c6974792d7061636b6564204e465473207769746820756e6971756520726f6c65732c20414920696e746567726174696f6e2c20616e64207265776172647321"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmQ3fSN7Nsjo6oDZsi8rj9kwW8xWJouRN3z2vPXWFtDyxG"));
    ...
    public entry fun mint_nft(arg0: &0x2::clock::Clock, arg1: &mut Manager, arg2: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg3: 0x1::string::String, arg4: u64, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: u64, arg9: u64, arg10: u64, arg11: vector<u8>, arg12: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg13: &mut 0x2::kiosk::Kiosk, arg14: &0x2::kiosk::KioskOwnerCap, arg15: &0x2::transfer_policy::TransferPolicy<Nft>, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = MintNftEvent{
            ...
            price                     : arg9 + arg10,
            collection_id             : 0x1::string::utf8(b"8dbcd0da-220c-4205-b855-75e99bb70aae"),
            collection_creator_wallet : @0x4998db08a3db332d5e9b5826bc8237e300d9b72ef93c81ef4c7366d0f18b25b,
