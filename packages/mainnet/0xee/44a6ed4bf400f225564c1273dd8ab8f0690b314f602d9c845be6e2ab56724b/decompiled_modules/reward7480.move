module 0xee44a6ed4bf400f225564c1273dd8ab8f0690b314f602d9c845be6e2ab56724b::reward7480 {
    struct REWARD7480 has drop {
        dummy_field: bool,
    }

    struct TICKET_7480 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7480(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7480>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7480>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7480, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7480>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7480>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7480>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7480>>(v5, 0x2::tx_context::sender(arg1));
    }
