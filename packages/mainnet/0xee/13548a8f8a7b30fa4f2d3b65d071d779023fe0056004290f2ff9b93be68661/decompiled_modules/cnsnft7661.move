module 0xee13548a8f8a7b30fa4f2d3b65d071d779023fe0056004290f2ff9b93be68661::cnsnft7661 {
    struct CNSNFT7661 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7661, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7661>(arg0, arg1);
