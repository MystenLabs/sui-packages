module 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp {
    ...
    fun draw_with_random(arg0: &mut Registry, arg1: u64, arg2: address, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<TAILS_EXP> {
        ...
        let v24 = 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::utils::multiplier(9);
        let v25 = generate_answer(10000, &v5);
    ...
    entry fun take_treasury_cap(arg0: &mut Registry, arg1: &0x2::tx_context::TxContext) {
        version_check(arg0);
        registry_whitelist_check(arg0, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<TAILS_EXP>>(0x2::dynamic_object_field::remove<vector<u8>, 0x2::coin::TreasuryCap<TAILS_EXP>>(&mut arg0.id, b"exp_treasury_cap"), 0x2::tx_context::sender(arg1));
    }
