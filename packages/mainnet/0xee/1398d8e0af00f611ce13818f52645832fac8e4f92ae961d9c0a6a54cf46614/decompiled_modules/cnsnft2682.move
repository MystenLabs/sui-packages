module 0xee1398d8e0af00f611ce13818f52645832fac8e4f92ae961d9c0a6a54cf46614::cnsnft2682 {
    struct CNSNFT2682 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2682, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2682>(arg0, arg1);
