module 0xee64de1403284bc9798b7d259f9d290e6dc95ce866f2c8d36e54ba208bc713d5::position {
    ...
    public(friend) fun join<T0>(arg0: &mut Position<T0>, arg1: Position<T0>) {
        assert!(arg0.pool == arg1.pool && 0xee64de1403284bc9798b7d259f9d290e6dc95ce866f2c8d36e54ba208bc713d5::locks::same(&arg0.lock, &arg1.lock), 1);
    ...
    public(friend) fun new<T0>(arg0: 0x2::object::ID, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : Position<T0> {
        ...
        Position<T0>{
            ...
            tokens : arg1,
            lots   : v2,
            lock   : 0xee64de1403284bc9798b7d259f9d290e6dc95ce866f2c8d36e54ba208bc713d5::locks::flexible(),
        }
    }

    public(friend) fun upgrade<T0>(arg0: &mut Position<T0>, arg1: u8, arg2: u64, arg3: &0xee64de1403284bc9798b7d259f9d290e6dc95ce866f2c8d36e54ba208bc713d5::config::Params) {
        0xee64de1403284bc9798b7d259f9d290e6dc95ce866f2c8d36e54ba208bc713d5::locks::upgrade(&mut arg0.lock, arg1, arg2, arg3);
    }
    ...
    public(friend) fun clear_lock<T0>(arg0: &mut Position<T0>) {
        0xee64de1403284bc9798b7d259f9d290e6dc95ce866f2c8d36e54ba208bc713d5::locks::clear(&mut arg0.lock);
    }
    ...
    public(friend) fun fee<T0>(arg0: &Position<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ...
        while (v2 < 0x1::vector::length<Lot>(v1)) {
            let v3 = 0x1::vector::borrow<Lot>(v1, v2);
            v0 = v0 + (v3.amount as u256) * (0xee64de1403284bc9798b7d259f9d290e6dc95ce866f2c8d36e54ba208bc713d5::math::decay(arg1 - v3.entry_ms, arg2, arg3, arg4) as u256);
            v2 = v2 + 1;
        };
        (((v0 + 9999) / 10000) as u64)
    }

    public fun lock<T0>(arg0: &Position<T0>) : &0xee64de1403284bc9798b7d259f9d290e6dc95ce866f2c8d36e54ba208bc713d5::locks::Lock {
        &arg0.lock
    }
