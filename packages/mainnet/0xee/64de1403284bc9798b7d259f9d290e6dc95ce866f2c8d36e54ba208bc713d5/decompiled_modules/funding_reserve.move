module 0xee64de1403284bc9798b7d259f9d290e6dc95ce866f2c8d36e54ba208bc713d5::funding_reserve {
    ...
    public(friend) fun update(arg0: &mut 0x2::object::UID, arg1: &0xee64de1403284bc9798b7d259f9d290e6dc95ce866f2c8d36e54ba208bc713d5::funding_rules::Rules, arg2: u256, arg3: u64, arg4: u64, arg5: u256, arg6: u64, arg7: u64, arg8: u256, arg9: u256, arg10: u64, arg11: u64, arg12: &0x2::clock::Clock) : Status {
        let v0 = if (arg4 > 0) {
            if (arg4 <= 86400000) {
        ...
        assert!(v0, 1);
        let (_, _, v3, v4, v5) = 0xee64de1403284bc9798b7d259f9d290e6dc95ce866f2c8d36e54ba208bc713d5::funding_rules::values(arg1);
        ...
        if (arg6 == 0 || arg5 == 0) {
            ...
            let (v23, v24, _, _, _) = 0xee64de1403284bc9798b7d259f9d290e6dc95ce866f2c8d36e54ba208bc713d5::funding_rules::values(arg1);
