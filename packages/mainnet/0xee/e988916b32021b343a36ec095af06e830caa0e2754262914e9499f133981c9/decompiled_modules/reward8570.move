module 0xeee988916b32021b343a36ec095af06e830caa0e2754262914e9499f133981c9::reward8570 {
    struct REWARD8570 has drop {
        dummy_field: bool,
    }

    struct TICKET_8570 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8570(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8570>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8570>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8570, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8570>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8570>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8570>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8570>>(v5, 0x2::tx_context::sender(arg1));
    }
