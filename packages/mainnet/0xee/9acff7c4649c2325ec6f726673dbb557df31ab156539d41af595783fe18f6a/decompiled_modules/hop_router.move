module 0xee9acff7c4649c2325ec6f726673dbb557df31ab156539d41af595783fe18f6a::hop_router {
    ...
    public entry fun buy_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme::BondingCurve<T0>, arg2: &0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme::MemeConfig, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2;
        0xee9acff7c4649c2325ec6f726673dbb557df31ab156539d41af595783fe18f6a::utils::send_coin<T0>(v3, 0x2::tx_context::sender(arg7));
        0xee9acff7c4649c2325ec6f726673dbb557df31ab156539d41af595783fe18f6a::utils::send_coin<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg7));
        0xee9acff7c4649c2325ec6f726673dbb557df31ab156539d41af595783fe18f6a::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, v0, arg7), arg0.admin);
        0xee9acff7c4649c2325ec6f726673dbb557df31ab156539d41af595783fe18f6a::utils::send_coin<0x2::sui::SUI>(arg3, 0x2::tx_context::sender(arg7));
        let v4 = BuyEvent<T0>{
    ...
    public entry fun sell_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme::BondingCurve<T0>, arg2: &0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme::MemeConfig, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 - v2 >= arg5, 1);
        0xee9acff7c4649c2325ec6f726673dbb557df31ab156539d41af595783fe18f6a::utils::send_coin<T0>(arg3, 0x2::tx_context::sender(arg7));
        0xee9acff7c4649c2325ec6f726673dbb557df31ab156539d41af595783fe18f6a::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg7));
        0xee9acff7c4649c2325ec6f726673dbb557df31ab156539d41af595783fe18f6a::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v2, arg7), arg0.admin);
        let v3 = SellEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg7),
            amount_in  : arg4,
            amount_out : v1 - v2,
