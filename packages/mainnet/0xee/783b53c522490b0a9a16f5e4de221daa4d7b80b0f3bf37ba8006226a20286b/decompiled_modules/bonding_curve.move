module 0xee783b53c522490b0a9a16f5e4de221daa4d7b80b0f3bf37ba8006226a20286b::bonding_curve {
    ...
    public fun buy_tokens<T0, T1>(arg0: &mut BondingCurvePool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v2 = v0 - v1;
        let v3 = calculate_output_tokens<T0, T1>(arg0, v2);
        assert!(v3 >= arg2, 1);
        let v4 = if (0x2::balance::value<T0>(&arg0.real_token_balance) - v3 < 200000000000000000) {
            let v5 = 0x2::balance::value<T0>(&arg0.real_token_balance) - 200000000000000000;
            assert!(v5 >= arg2, 1);
            let v6 = (((212118000000000 as u128) * (1100000000000000000 as u128) / ((arg0.virtual_token_supply as u128) - (v5 as u128)) - (arg0.virtual_reserve as u128)) as u64);
            let v7 = v6 * arg0.fee_percentage / 10000;
            0x2::balance::join<T1>(&mut arg0.fee_balance, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg1, v7, arg3)));
            let v8 = v0 - v6 + v7;
            if (v8 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg1, v8, arg3), 0x2::tx_context::sender(arg3));
            };
            arg0.virtual_reserve = arg0.virtual_reserve + v6;
            arg0.virtual_token_supply = arg0.virtual_token_supply - v5;
            arg0.lp_creation_started = true;
            let v9 = BondingCurveFinished{pool_id: 0x2::object::id<BondingCurvePool<T0, T1>>(arg0)};
            0x2::event::emit<BondingCurveFinished>(v9);
            v5
        } else {
            arg0.virtual_reserve = arg0.virtual_reserve + v2;
            arg0.virtual_token_supply = arg0.virtual_token_supply - v3;
        ...
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.real_token_balance, v4), arg3)
    }
