module 0xee67018a5becd171ace8a8684f6333c1e6c504bf84776b1e85287f953bc830a4::cnsnft3392 {
    struct CNSNFT3392 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3392, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3392>(arg0, arg1);
