module 0xee355e3514f3680e07723687ea69060662f64b56601340158eb600d1186047a6::agent_nft {
    ...
    public fun burn(arg0: AGENT, arg1: &VaultConfig, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: AGENT_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://storage.local/assets/{xid}/.png"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://storage.local/detail/{xid}"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://x.com/5son"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"5SON"));
        let v5 = 0x2::package::claim<AGENT_NFT>(arg0, arg1);
        let v6 = 0x2::display::new_with_fields<AGENT>(&v5, v1, v3, arg1);
        0x2::display::update_version<AGENT>(&mut v6);
        0x2::transfer::public_transfer<0x2::display::Display<AGENT>>(v6, v0);
    ...
    public fun mint(arg0: &mut VaultConfig, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut UserArchive, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : AGENT {
