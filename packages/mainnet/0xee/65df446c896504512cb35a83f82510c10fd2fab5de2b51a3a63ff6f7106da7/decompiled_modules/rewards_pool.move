module 0xee65df446c896504512cb35a83f82510c10fd2fab5de2b51a3a63ff6f7106da7::rewards_pool {
    ...
    public(friend) fun query_claimed<T0>(arg0: &RewardsPool<T0>, arg1: address, arg2: u64) : u64 {
        let v0 = 0xee65df446c896504512cb35a83f82510c10fd2fab5de2b51a3a63ff6f7106da7::signature::get_bytes41_key_direct(arg1, arg2);
        let v1 = 0;
    ...
    public(friend) fun redeem_rewards<T0>(arg0: &mut RewardsPool<T0>, arg1: vector<u8>, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v0 = 0xee65df446c896504512cb35a83f82510c10fd2fab5de2b51a3a63ff6f7106da7::signature::new(10, 0x2::object::id<RewardsPool<T0>>(arg0), arg1, arg2, arg3, arg4, arg5);
        assert!(0xee65df446c896504512cb35a83f82510c10fd2fab5de2b51a3a63ff6f7106da7::signature::verify_signature_ed25519(&v0, arg0.pubkey), 1);
        let v1 = 0xee65df446c896504512cb35a83f82510c10fd2fab5de2b51a3a63ff6f7106da7::signature::get_bytes41_key(&v0);
