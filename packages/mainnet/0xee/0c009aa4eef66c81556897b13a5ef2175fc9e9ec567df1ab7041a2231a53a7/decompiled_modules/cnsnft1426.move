module 0xee0c009aa4eef66c81556897b13a5ef2175fc9e9ec567df1ab7041a2231a53a7::cnsnft1426 {
    struct CNSNFT1426 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1426, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1426>(arg0, arg1);
