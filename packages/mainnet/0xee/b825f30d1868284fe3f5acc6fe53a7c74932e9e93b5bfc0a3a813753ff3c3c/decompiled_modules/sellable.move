module 0xeeb825f30d1868284fe3f5acc6fe53a7c74932e9e93b5bfc0a3a813753ff3c3c::sellable {
    ...
    struct CredenzaSellableConfig<phantom T0> has store, key {
        id: 0x2::object::UID,
        ownership: 0xeeb825f30d1868284fe3f5acc6fe53a7c74932e9e93b5bfc0a3a813753ff3c3c::ownership::CredenzaOwnership,
    ...
    public fun set_owner<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: address, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        0xeeb825f30d1868284fe3f5acc6fe53a7c74932e9e93b5bfc0a3a813753ff3c3c::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        0xeeb825f30d1868284fe3f5acc6fe53a7c74932e9e93b5bfc0a3a813753ff3c3c::ownership::set_owner(&mut arg0.ownership, arg1, arg2);
    }
    ...
    public fun create_config<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : (T0, CredenzaSellableConfig<T0>) {
        ...
        let v1 = CredenzaSellableConfig<T0>{
            id                  : v0,
            ownership           : 0xeeb825f30d1868284fe3f5acc6fe53a7c74932e9e93b5bfc0a3a813753ff3c3c::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
        ...
        0xeeb825f30d1868284fe3f5acc6fe53a7c74932e9e93b5bfc0a3a813753ff3c3c::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg1));
    ...
    public fun set_beneficiary_adress<T0>(arg0: &mut CredenzaSellableConfig<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0xeeb825f30d1868284fe3f5acc6fe53a7c74932e9e93b5bfc0a3a813753ff3c3c::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg2));
