module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items {
    ...
    public fun get_item_category_by_type(arg0: u8) : u8 {
        if (arg0 == 1) {
            ...
            assert!(arg0 == 17, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_item_unknown_type());
            8
        }
    }
    ...
    public fun get_item_type_description(arg0: u8) : 0x1::string::String {
        if (arg0 == 1) {
            ...
            0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"A woodworking tool for advanced craftsman.")
        } else if (arg0 == 16) {
            0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"A masonry tool for advanced craftsman.")
        } else {
            assert!(arg0 == 17, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_item_unknown_type());
            0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"A blacksmithing tool for advanced craftsman.")
        }
    }
