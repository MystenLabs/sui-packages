module 0xeee4c213c1f930408b8521179b7eabf7684b1b002ba6e3021240dd352e8b8ff6::dogecast {
    ...
    fun init(arg0: DOGECAST, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/Fsz87Y2WGzjizP57jZ6QUnSsExLL5dxFo2ezejRSXLXc.png?size=lg&key=05f0c0                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DOGECAST>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DOGECAST")))), trim_right(b"Dogecast                        "), trim_right(b"EST PODCAST ON X HOSTED BY ELON MUSK AND VIVEK R.                                                                                                                                                                                                                                                                               "), v2, arg1);
        let v5 = v3;
