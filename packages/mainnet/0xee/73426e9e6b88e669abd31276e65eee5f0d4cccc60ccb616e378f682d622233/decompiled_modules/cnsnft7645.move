module 0xee73426e9e6b88e669abd31276e65eee5f0d4cccc60ccb616e378f682d622233::cnsnft7645 {
    struct CNSNFT7645 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7645, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7645>(arg0, arg1);
