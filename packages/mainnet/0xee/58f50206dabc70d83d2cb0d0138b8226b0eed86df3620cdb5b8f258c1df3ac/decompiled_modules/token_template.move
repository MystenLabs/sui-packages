module 0xee58f50206dabc70d83d2cb0d0138b8226b0eed86df3620cdb5b8f258c1df3ac::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT2365629", b"BatchToken2 365629", b"Second serial deployment", 0x1::option::none<0x2::url::Url>(), arg1);
