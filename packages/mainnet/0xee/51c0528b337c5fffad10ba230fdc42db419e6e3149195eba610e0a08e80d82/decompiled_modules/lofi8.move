module 0xee51c0528b337c5fffad10ba230fdc42db419e6e3149195eba610e0a08e80d82::lofi8 {
    struct LOFI8 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LOFI8, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<LOFI8>(arg0, 9, b"LOFI8", b"LOFI8", b"LOFI8", v2, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LOFI8>>(v4);
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<LOFI8>>(v3);
    ...
    public entry fun transfer_with_tax(arg0: &TaxStorage, arg1: &AdminCap, arg2: &mut 0x2::coin::Coin<LOFI8>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        ...
        let v3 = 0x2::balance::split<LOFI8>(0x2::coin::balance_mut<LOFI8>(arg2), arg3);
        if (v0 > 0) {
            let v4 = arg3 * v0 / 10000;
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI8>>(0x2::coin::from_balance<LOFI8>(0x2::balance::split<LOFI8>(&mut v3, v4), arg5), arg1.admin_address);
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI8>>(0x2::coin::from_balance<LOFI8>(0x2::balance::split<LOFI8>(&mut v3, arg3 - v4), arg5), arg4);
            0x2::balance::destroy_zero<LOFI8>(v3);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI8>>(0x2::coin::from_balance<LOFI8>(v3, arg5), arg4);
        };
    }
