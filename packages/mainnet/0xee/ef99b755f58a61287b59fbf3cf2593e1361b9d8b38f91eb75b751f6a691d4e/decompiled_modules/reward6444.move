module 0xeeef99b755f58a61287b59fbf3cf2593e1361b9d8b38f91eb75b751f6a691d4e::reward6444 {
    struct REWARD6444 has drop {
        dummy_field: bool,
    }

    struct TICKET_6444 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6444(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6444>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6444>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6444, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6444>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6444>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6444>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6444>>(v5, 0x2::tx_context::sender(arg1));
    }
