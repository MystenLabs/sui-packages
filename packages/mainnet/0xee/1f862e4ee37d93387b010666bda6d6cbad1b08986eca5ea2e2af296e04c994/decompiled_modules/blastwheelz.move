module 0xee1f862e4ee37d93387b010666bda6d6cbad1b08986eca5ea2e2af296e04c994::blastwheelz {
    ...
    fun setup_transfer_policy<T0>(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v1;
        let v3 = v0;
        0xee1f862e4ee37d93387b010666bda6d6cbad1b08986eca5ea2e2af296e04c994::rules::add_personal_kiosk_rule<NFT<T0>>(&mut v3, &v2);
        0xee1f862e4ee37d93387b010666bda6d6cbad1b08986eca5ea2e2af296e04c994::rules::add_kiosk_lock_rule<NFT<T0>>(&mut v3, &v2);
        0xee1f862e4ee37d93387b010666bda6d6cbad1b08986eca5ea2e2af296e04c994::rules::add_royalty_rule<NFT<T0>>(&mut v3, &v2, 0xee1f862e4ee37d93387b010666bda6d6cbad1b08986eca5ea2e2af296e04c994::rules::new_royalty_config(500, 0));
