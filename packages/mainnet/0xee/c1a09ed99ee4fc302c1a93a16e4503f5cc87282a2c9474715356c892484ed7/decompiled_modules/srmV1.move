module 0xeec1a09ed99ee4fc302c1a93a16e4503f5cc87282a2c9474715356c892484ed7::srmV1 {
    ...
    public entry fun add_liquidity_with_coins_and_transfer_to_sender<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(arg2 > 0, 7);
        assert!(arg4 > 0, 7);
        let (v1, v2, v3) = add_liquidity<T0, T1>(arg0, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg1, arg2, arg6)), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg3, arg4, arg6)), arg5);
        destroy_zero_or_transfer_balance<LP<T0, T1>>(v3, v0, arg6);
        let v4 = 0x2::coin::from_balance<T0>(v1, arg6);
        let v5 = 0x2::coin::from_balance<T1>(v2, arg6);
        destroy_zero_or_transfer_balance<T0>(0x2::coin::into_balance<T0>(arg1), v0, arg6);
        destroy_zero_or_transfer_balance<T1>(0x2::coin::into_balance<T1>(arg3), v0, arg6);
        destroy_zero_or_transfer_balance<T0>(0x2::coin::into_balance<T0>(v4), v0, arg6);
        destroy_zero_or_transfer_balance<T1>(0x2::coin::into_balance<T1>(v5), v0, arg6);
    }
    ...
    fun add_pool<T0, T1>(arg0: &mut Factory, arg1: 0x2::object::ID) {
        ...
        assert!(0x2::table::contains<PoolItem, 0x2::object::ID>(&arg0.pools, v2) == false, 2);
        0x2::table::add<PoolItem, 0x2::object::ID>(&mut arg0.pools, v2, arg1);
    }
    ...
    public fun create_pool<T0, T1>(arg0: &mut Factory, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: address, arg8: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<LP<T0, T1>> {
        assert!(0x2::balance::value<T0>(&arg1) > 0 && 0x2::balance::value<T1>(&arg2) > 0, 0);
        assert!(arg3 <= 300, 5);
        assert!(arg4 <= 500, 5);
        assert!(arg5 <= 100, 5);
    ...
    public fun create_pool_and_lock_lp<T0, T1>(arg0: &mut Factory, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: address, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T0>(&arg1) > 0 && 0x2::balance::value<T1>(&arg2) > 0, 0);
        assert!(arg3 <= 300, 5);
        assert!(arg4 <= 500, 5);
        assert!(arg5 <= 100, 5);
        ...
        add_pool<T0, T1>(arg0, v2);
        let v3 = mulsqrt(0x2::balance::value<T0>(&v1.balance_a), 0x2::balance::value<T1>(&v1.balance_b));
        0x2::balance::join<LP<T0, T1>>(&mut v1.locked_lp_balance, 0x2::balance::increase_supply<LP<T0, T1>>(&mut v1.lp_supply, v3));
        let v4 = PoolCreated{
            pool_id                : v2,
            a                      : 0x1::type_name::get<T0>(),
            b                      : 0x1::type_name::get<T1>(),
    ...
    public entry fun create_pool_and_lock_lp_in_pool<T0, T1>(arg0: &CreatePoolLock, arg1: &mut Factory, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: address, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > 0, 7);
        assert!(arg5 > 0, 7);
        let v0 = 0x2::tx_context::sender(arg11);
        assert!(!arg0.locked || 0x1::vector::contains<address>(&arg0.allowlist, &v0), 6);
        let v1 = 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, arg3, arg11));
        let v2 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg4, arg5, arg11));
        create_pool_and_lock_lp<T0, T1>(arg1, v1, v2, arg6, arg7, arg8, arg9, arg10, arg11);
        destroy_zero_or_transfer_balance<T0>(0x2::coin::into_balance<T0>(arg2), v0, arg11);
        destroy_zero_or_transfer_balance<T1>(0x2::coin::into_balance<T1>(arg4), v0, arg11);
    }

    public fun create_pool_with_coins<T0, T1>(arg0: &mut Factory, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: address, arg10: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, 0x2::coin::Coin<LP<T0, T1>>) {
        let v0 = 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg1, arg2, arg10));
        let v1 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg3, arg4, arg10));
        let v2 = create_pool<T0, T1>(arg0, v0, v1, arg5, arg6, arg7, arg8, arg9, arg10);
        (arg1, arg3, 0x2::coin::from_balance<LP<T0, T1>>(v2, arg10))
    }

    public entry fun create_pool_with_coins_and_transfer_lp_to_sender<T0, T1>(arg0: &CreatePoolLock, arg1: &mut Factory, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: address, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > 0, 7);
        assert!(arg5 > 0, 7);
        let v0 = 0x2::tx_context::sender(arg11);
        assert!(!arg0.locked || 0x1::vector::contains<address>(&arg0.allowlist, &v0), 6);
        let v1 = 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, arg3, arg11));
        let v2 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg4, arg5, arg11));
        let v3 = create_pool<T0, T1>(arg1, v1, v2, arg6, arg7, arg8, arg9, arg10, arg11);
        destroy_zero_or_transfer_balance<T0>(0x2::coin::into_balance<T0>(arg2), v0, arg11);
        destroy_zero_or_transfer_balance<T1>(0x2::coin::into_balance<T1>(arg4), v0, arg11);
        destroy_zero_or_transfer_balance<LP<T0, T1>>(v3, v0, arg11);
    }
    ...
    public fun distribute_swap_fee<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<T0>(&arg0.swap_balance_a);
        if (v0 >= 100000000) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.swap_balance_a, v0), arg2), arg1.swap_fee_wallet);
        };
    }

    public fun get_pool<T0, T1>(arg0: &Pool<T0, T1>) : &Pool<T0, T1> {
        arg0
    }
    ...
    public fun get_pool_id<T0, T1>(arg0: &Factory) : 0x2::object::ID {
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x1::type_name::get<T1>();
        assert!(cmp_type_names(&v0, &v1) == 0, 1);
        let v2 = PoolItem{
        ...
        assert!(0x2::table::contains<PoolItem, 0x2::object::ID>(&arg0.pools, v2), 4);
        *0x2::table::borrow<PoolItem, 0x2::object::ID>(&arg0.pools, v2)
    }
    ...
    public entry fun remove_liquidity_with_coins_and_transfer_to_sender<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 7);
        let v0 = 0x2::tx_context::sender(arg5);
        let (v1, v2) = remove_liquidity<T0, T1>(arg0, 0x2::coin::into_balance<LP<T0, T1>>(0x2::coin::split<LP<T0, T1>>(&mut arg1, arg2, arg5)), arg3, arg4);
        destroy_zero_or_transfer_balance<T0>(v1, v0, arg5);
        destroy_zero_or_transfer_balance<T1>(v2, v0, arg5);
        destroy_zero_or_transfer_balance<LP<T0, T1>>(0x2::coin::into_balance<LP<T0, T1>>(arg1), v0, arg5);
    }
    ...
    public fun swap_a_for_b<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        let (v5, _, _, v8, v9, v10, v11) = calc_swap_out_b(v0, 0x2::balance::value<T0>(&arg0.balance_a), 0x2::balance::value<T1>(&arg0.balance_b), arg1.swap_fee, v1, v2, v3, v4);
        assert!(v5 >= arg3, 3);
        ...
        distribute_swap_fee<T0, T1>(arg0, arg1, arg5);
        let v12 = Swapped{
            pool_id   : 0x2::object::id<Pool<T0, T1>>(arg0),
    ...
    public fun swap_b_for_a<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: 0x2::balance::Balance<T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        let (v1, v2, v3, v4) = get_pool_fees<T0, T1>(arg0);
        let (v5, _, _, v8, v9, v10, v11) = calc_swap_out_a(v0, 0x2::balance::value<T1>(&arg0.balance_b), 0x2::balance::value<T0>(&arg0.balance_a), arg1.swap_fee, v1, v2, v3, v4);
        assert!(v5 >= arg3, 3);
