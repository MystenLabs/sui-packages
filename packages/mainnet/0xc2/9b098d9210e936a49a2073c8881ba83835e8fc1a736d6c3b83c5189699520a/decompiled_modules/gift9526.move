module 0xc29b098d9210e936a49a2073c8881ba83835e8fc1a736d6c3b83c5189699520a::gift9526 {
    struct GIFT9526 has drop {
        dummy_field: bool,
    }

    struct TICKET_9526 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9526(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9526>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9526>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9526, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9526>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9526>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9526>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9526>>(v5, 0x2::tx_context::sender(arg1));
    }
