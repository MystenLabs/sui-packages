module 0xc2dc9b9754c8ee577184bbfe5f17c9e3b81cc71efad362c3f4aaf6c38b664057::xaum_indicator_core {
    ...
    public fun bind_admin_cap(arg0: &mut PriceStorage, arg1: &AdminCap, arg2: 0x8a50c55c1208cc2ef7741b8dd7656bf6acc25ae6f2ce99a298f9a5c83e08e285::x_oracle::XOracleAdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1);
        let v0 = AdminCapKey{dummy_field: false};
        0x2::dynamic_object_field::add<AdminCapKey, 0x8a50c55c1208cc2ef7741b8dd7656bf6acc25ae6f2ce99a298f9a5c83e08e285::x_oracle::XOracleAdminCap>(&mut arg0.id, v0, arg2);
    }
    ...
    public fun push_gr_indicators_to_x_oracle(arg0: &PriceStorage, arg1: &AdminCap, arg2: &mut 0x8a50c55c1208cc2ef7741b8dd7656bf6acc25ae6f2ce99a298f9a5c83e08e285::x_oracle::XOracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1);
        let v0 = AdminCapKey{dummy_field: false};
        0x8a50c55c1208cc2ef7741b8dd7656bf6acc25ae6f2ce99a298f9a5c83e08e285::x_oracle::set_gr_indicators(arg2, 0x2::dynamic_object_field::borrow<AdminCapKey, 0x8a50c55c1208cc2ef7741b8dd7656bf6acc25ae6f2ce99a298f9a5c83e08e285::x_oracle::XOracleAdminCap>(&arg0.id, v0), ((arg0.ema120_current / 1000000000) as u64), ((arg0.ema90_current / 1000000000) as u64), ((arg0.latest_price / 1000000000) as u64), 0x2::clock::timestamp_ms(arg3) / 1000, arg4);
    }
    ...
    public fun set_price_9dec(arg0: &AdminCap, arg1: &mut PriceStorage, arg2: u64, arg3: &mut 0x8a50c55c1208cc2ef7741b8dd7656bf6acc25ae6f2ce99a298f9a5c83e08e285::x_oracle::XOracle, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg1, arg0);
        assert!(arg2 > 0, 0);
