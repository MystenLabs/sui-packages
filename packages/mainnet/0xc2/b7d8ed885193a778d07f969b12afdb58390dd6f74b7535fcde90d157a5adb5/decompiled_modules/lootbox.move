module 0x611e724cbd74e740ab0ae4fbbf1b57f44d9e75be7d0135704ad86eab7e518a12::lootbox {
    ...
    entry fun place_bet_and_reveal_lootbox_onchain_randomness<T0>(arg0: &mut LootboxGame<T0>, arg1: &mut 0x611e724cbd74e740ab0ae4fbbf1b57f44d9e75be7d0135704ad86eab7e518a12::house::House<T0>, arg2: 0x2::object::ID, arg3: &mut 0x2::coin::Coin<T0>, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x611e724cbd74e740ab0ae4fbbf1b57f44d9e75be7d0135704ad86eab7e518a12::house::deposit<T0>(arg1, v3);
        let v5 = 0x2::object::new(arg5);
        let v6 = 0x611e724cbd74e740ab0ae4fbbf1b57f44d9e75be7d0135704ad86eab7e518a12::house::take_fund_balance<T0>(arg1, *0x1::vector::borrow<u64>(&v1.reward_amounts, 0x1::vector::length<u64>(&v1.reward_amounts) - 1));
        0x611e724cbd74e740ab0ae4fbbf1b57f44d9e75be7d0135704ad86eab7e518a12::house::distribute_referral_rewards<T0>(arg1, v4, 0x2::tx_context::sender(arg5));
        ...
        0x611e724cbd74e740ab0ae4fbbf1b57f44d9e75be7d0135704ad86eab7e518a12::events::emit_lootbox_revealed_event(0x2::object::uid_to_inner(&v5), v4, 0x1::uq32_32::from_quotient(v8, v4), arg2, v2, v8);
