module 0x611e724cbd74e740ab0ae4fbbf1b57f44d9e75be7d0135704ad86eab7e518a12::house {
    ...
    public fun withdraw_all<T0>(arg0: &AdminCap, arg1: &mut House<T0>) : 0x2::balance::Balance<T0> {
    ...
    public fun claim_referee_rewards<T0>(arg0: &mut House<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x611e724cbd74e740ab0ae4fbbf1b57f44d9e75be7d0135704ad86eab7e518a12::events::emit_referee_rewards_claimed_event(0x2::balance::value<T0>(&v2));
    ...
    public fun claim_referrer_rewards<T0>(arg0: &mut House<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x611e724cbd74e740ab0ae4fbbf1b57f44d9e75be7d0135704ad86eab7e518a12::events::emit_referrer_rewards_claimed_event(0x2::balance::value<T0>(&v2));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v2, arg1), v0);
    }
