module 0x32fe1a93a598eef2af12732c7fec0d3bb19be96d95c170ed4b1c18a42e496777::distribution_config {
    ...
    public fun checked_package_version(arg0: &DistributionConfig) {
        assert!(arg0.version == 3, 458466182903521300);
    }
    ...
    public fun set_package_version(arg0: &mut DistributionConfig, arg1: &0x2::package::Publisher, arg2: u64) {
        ...
        assert!(arg2 <= 3, 326963916733903800);
        arg0.version = arg2;
    }
