module 0xc2150addc946212b904648baa4fb1c1521f9483940e878ea011814a3a5480d9d::cnsnft7970 {
    struct CNSNFT7970 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7970, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7970>(arg0, arg1);
