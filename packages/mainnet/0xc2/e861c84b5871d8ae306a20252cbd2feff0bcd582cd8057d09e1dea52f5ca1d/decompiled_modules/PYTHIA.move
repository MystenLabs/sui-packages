module 0xc2e861c84b5871d8ae306a20252cbd2feff0bcd582cd8057d09e1dea52f5ca1d::PYTHIA {
    struct PYTHIA has drop {
        dummy_field: bool,
    }

    fun init(arg0: PYTHIA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<PYTHIA>(arg0, 2, b"PYTHIA", b"PYTHIA", b"PYTHIA", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/pmDDW041rtVD1DOgpvVwTPbTttj-6qU2YqoYO10dQFE?ext=png")), arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<PYTHIA>>(v2);
        0x2::transfer::public_transfer<0x2::coin::DenyCap<PYTHIA>>(v1, @0x7c3c58155b85c3ecf4864777fce255a7e405ffa3b6e443e736976588910f0e8d);
        let v3 = v0;
