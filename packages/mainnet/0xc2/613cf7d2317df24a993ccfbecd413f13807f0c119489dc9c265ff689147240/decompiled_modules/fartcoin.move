module 0xc2613cf7d2317df24a993ccfbecd413f13807f0c119489dc9c265ff689147240::fartcoin {
    ...
    fun init(arg0: FARTCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<FARTCOIN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Fartcoin")))), trim_right(b"Fartcoin                        "), trim_right(b"The meme token choosen by the Truth Terminal @truth_terminal                                                                                                                                                                                                                                                                    "), v2, arg1);
