module 0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::oracle {
    ...
    struct PriceInfo has store, key {
        id: 0x2::object::UID,
        coin_type: 0x1::type_name::TypeName,
        price: 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::Number,
        ema_price: 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::Number,
        last_updated: u64,
    }

    public(friend) fun get_ema_price(arg0: &Oracle, arg1: &PriceIdentifier) : 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::Number {
        0x2::dynamic_field::borrow<0x1::type_name::TypeName, PriceInfo>(&arg0.id, arg1.coin_type).ema_price
    }

    public(friend) fun get_price(arg0: &Oracle, arg1: &PriceIdentifier) : (0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::Number, 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::Number) {
    ...
    public(friend) fun add_coin_to_oracle(arg0: &mut Oracle, arg1: 0x1::type_name::TypeName, arg2: &mut 0x2::tx_context::TxContext) : PriceIdentifier {
        ...
        let v0 = PriceInfo{
            ...
            coin_type    : arg1,
            price        : 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(0),
            ema_price    : 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(0),
            last_updated : 0,
        };
    ...
    public fun update_price(arg0: &mut Oracle, arg1: &0xb152f5a190ced415b19899ab39cbd2434763a6a7db6b2f051462823166d11afb::oracle::PriceInfo) {
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, PriceInfo>(&mut arg0.id, 0xb152f5a190ced415b19899ab39cbd2434763a6a7db6b2f051462823166d11afb::oracle::coin_type(arg1));
        v0.price = 0xb152f5a190ced415b19899ab39cbd2434763a6a7db6b2f051462823166d11afb::oracle::get_price(arg1);
        v0.ema_price = 0xb152f5a190ced415b19899ab39cbd2434763a6a7db6b2f051462823166d11afb::oracle::get_ema_price(arg1);
        v0.last_updated = 0xb152f5a190ced415b19899ab39cbd2434763a6a7db6b2f051462823166d11afb::oracle::get_updated_time(arg1);
    }
