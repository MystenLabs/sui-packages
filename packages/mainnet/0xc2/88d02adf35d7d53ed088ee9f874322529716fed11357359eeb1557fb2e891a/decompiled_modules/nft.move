module 0xc288d02adf35d7d53ed088ee9f874322529716fed11357359eeb1557fb2e891a::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<SNFT>(v6, @0x76c31a4dfc9df24696fc98db58df2e81105ed2995378d717d115774f565de985);
    }
