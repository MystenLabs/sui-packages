module 0x326537301c41889c15e3265c1674f86a0dcf9a6f51f8308ee420136a560276b3::royalty_rule {
    ...
    public fun pay<T0: store + key>(arg0: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg1: &mut 0x2::transfer_policy::TransferRequest<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg2, @0x2ce57b8afe89e4c38909068984d9a6f559f4eab759d88c022bf0b6aaa8b33684);
        let v0 = Rule{dummy_field: false};
