module 0xc214db7837d4ac8033361d4e8c5ab5b44d122fc5c39424a4332805aa85de1277::venue_orders {
    ...
    public fun approve_venue<T0: drop>(arg0: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::AdminCap, arg1: &mut VenueRegistry) {
    ...
    public fun begin_fill<T0, T1: drop>(arg0: VenueOrder<T0>, arg1: &VenueRegistry, arg2: T1, arg3: 0x2::object::ID, arg4: u128, arg5: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::Config, arg6: &mut 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::fees::FeeVault, arg7: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::referral::ReferralRegistry, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<T0>, FillTicket<T0>) {
        ...
        let v19 = if (0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::referral::has_referrer(arg7, v3)) {
            0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::referral::referrer_of(arg7, v3)
        } else {
            v13
        };
        if (v7) {
    ...
    public fun place_buy_currency<T0, T1: drop>(arg0: T1, arg1: &VenueRegistry, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: &0x2::coin_registry::Currency<T0>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u128, arg7: bool, arg8: u64, arg9: 0x1::option::Option<address>, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<VenueOrder<T0>>(new_order<T0, T1>(arg1, arg2, arg3, true, 0x2::coin::into_balance<0x2::sui::SUI>(arg5), 0x2::balance::zero<T0>(), arg6, arg7, arg8, arg9, arg10, 0x2::coin_registry::decimals<T0>(arg4), arg11, arg12));
    }
    ...
    public fun place_sell_currency<T0, T1: drop>(arg0: T1, arg1: &VenueRegistry, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: &0x2::coin_registry::Currency<T0>, arg5: 0x2::coin::Coin<T0>, arg6: u128, arg7: bool, arg8: u64, arg9: 0x1::option::Option<address>, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<VenueOrder<T0>>(new_order<T0, T1>(arg1, arg2, arg3, false, 0x2::balance::zero<0x2::sui::SUI>(), 0x2::coin::into_balance<T0>(arg5), arg6, arg7, arg8, arg9, arg10, 0x2::coin_registry::decimals<T0>(arg4), arg11, arg12));
    }
    ...
    public fun revoke_venue<T0: drop>(arg0: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::AdminCap, arg1: &mut VenueRegistry) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg1.approved, &v0), 10);
    ...
    public fun venue_price(arg0: u64, arg1: u64, arg2: u8) : u128 {
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::math::spot_price_scaled(arg0, arg1, arg2)
    }
