module 0x484932c474bf09f002b82e4a57206a6658a0ca6dbdb15896808dcd1929c77820::royalty_rule {
    ...
    public fun add<T0>(arg0: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg1: &0x2::transfer_policy::TransferPolicyCap<T0>, arg2: u16, arg3: u64) {
        assert!(arg2 <= 0x484932c474bf09f002b82e4a57206a6658a0ca6dbdb15896808dcd1929c77820::constants::max_bps(), 0x484932c474bf09f002b82e4a57206a6658a0ca6dbdb15896808dcd1929c77820::errors::incorrect_amount());
    ...
    public fun fee_amount<T0>(arg0: &0x2::transfer_policy::TransferPolicy<T0>, arg1: u64) : u64 {
        ...
        let v2 = (((arg1 as u128) * (v1.amount_bp as u128) / (0x484932c474bf09f002b82e4a57206a6658a0ca6dbdb15896808dcd1929c77820::constants::max_bps() as u128)) as u64);
        let v3 = v2;
        if (v2 < v1.min_amount) {
            v3 = v1.min_amount;
        };
    ...
    public fun pay<T0>(arg0: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg1: &mut 0x2::transfer_policy::TransferRequest<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) == fee_amount<T0>(arg0, 0x2::transfer_policy::paid<T0>(arg1)), 0x484932c474bf09f002b82e4a57206a6658a0ca6dbdb15896808dcd1929c77820::errors::insufficient_amount());
        let v0 = Rule{dummy_field: false};
