module 0xc2e3911d5a8d57d515c4c476d74746f510bdf499104208e050d4ed7ac2ee688a::event {
    ...
    struct EventCapacity has store {
        tickets_sold: u32,
        seats: 0xc2e3911d5a8d57d515c4c476d74746f510bdf499104208e050d4ed7ac2ee688a::bitmap::Bitmap,
    }
    ...
    fun create_event_capacity(arg0: &mut 0x2::tx_context::TxContext) : EventCapacity {
        EventCapacity{
            tickets_sold : 0,
            seats        : 0xc2e3911d5a8d57d515c4c476d74746f510bdf499104208e050d4ed7ac2ee688a::bitmap::empty(arg0),
        }
    }
    ...
    public fun get_seats(arg0: &Event) : &0xc2e3911d5a8d57d515c4c476d74746f510bdf499104208e050d4ed7ac2ee688a::bitmap::Bitmap {
    ...
    public(friend) fun update_seats(arg0: &mut Event, arg1: u64) {
        0xc2e3911d5a8d57d515c4c476d74746f510bdf499104208e050d4ed7ac2ee688a::bitmap::flip_bit(&mut arg0.event_capacity.seats, arg1);
    }
