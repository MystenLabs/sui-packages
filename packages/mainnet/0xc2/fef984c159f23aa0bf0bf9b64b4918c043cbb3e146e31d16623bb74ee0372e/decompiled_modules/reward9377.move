module 0xc2fef984c159f23aa0bf0bf9b64b4918c043cbb3e146e31d16623bb74ee0372e::reward9377 {
    struct REWARD9377 has drop {
        dummy_field: bool,
    }

    struct TICKET_9377 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9377(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9377>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9377>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9377, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9377>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9377>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9377>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9377>>(v5, 0x2::tx_context::sender(arg1));
    }
