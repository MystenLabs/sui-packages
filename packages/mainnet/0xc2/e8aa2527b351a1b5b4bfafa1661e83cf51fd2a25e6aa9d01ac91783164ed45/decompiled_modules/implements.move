module 0xc2e8aa2527b351a1b5b4bfafa1661e83cf51fd2a25e6aa9d01ac91783164ed45::implements {
    ...
    fun burn_token_lp<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<LP<T0, T1>>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v2 = 0xc2e8aa2527b351a1b5b4bfafa1661e83cf51fd2a25e6aa9d01ac91783164ed45::amm_math::mul_div(v0, arg2, v1);
        let v3 = 0xc2e8aa2527b351a1b5b4bfafa1661e83cf51fd2a25e6aa9d01ac91783164ed45::amm_math::mul_div(v0, arg3, v1);
    ...
    public fun calc_optimal_coin_values(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : (u64, u64) {
        ...
        let v0 = 0xc2e8aa2527b351a1b5b4bfafa1661e83cf51fd2a25e6aa9d01ac91783164ed45::amm_math::mul_div(arg0, arg5, arg4);
        if (v0 <= arg1) {
            assert!(v0 >= arg3, 504);
            return (arg0, v0)
        };
        let v1 = 0xc2e8aa2527b351a1b5b4bfafa1661e83cf51fd2a25e6aa9d01ac91783164ed45::amm_math::mul_div(arg1, arg4, arg5);
        assert!(v1 <= arg0, 505);
        assert!(v1 >= arg2, 503);
        (v1, arg1)
    }
    ...
    public fun get_amount_out(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        0xc2e8aa2527b351a1b5b4bfafa1661e83cf51fd2a25e6aa9d01ac91783164ed45::amm_math::mul_div_u128(v0, (arg2 as u128), (arg1 as u128) * (10000 as u128) + v0)
    }

    public fun get_fee_to_fundation(arg0: u64) : u64 {
        0xc2e8aa2527b351a1b5b4bfafa1661e83cf51fd2a25e6aa9d01ac91783164ed45::amm_math::mul_div(arg0, 30 / 5, 10000)
    }
    ...
    public fun is_order<T0, T1>() : bool {
        ...
        let v2 = 0xc2e8aa2527b351a1b5b4bfafa1661e83cf51fd2a25e6aa9d01ac91783164ed45::comparator::compare<0x1::type_name::TypeName>(&v0, &v1);
        assert!(!0xc2e8aa2527b351a1b5b4bfafa1661e83cf51fd2a25e6aa9d01ac91783164ed45::comparator::is_equal(&v2), 507);
        0xc2e8aa2527b351a1b5b4bfafa1661e83cf51fd2a25e6aa9d01ac91783164ed45::comparator::is_smaller_than(&v2)
    }
    ...
    fun mint_token_lp<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LP<T0, T1>> {
        let v0 = if (0 == arg5) {
            ...
            0x2::math::min(0xc2e8aa2527b351a1b5b4bfafa1661e83cf51fd2a25e6aa9d01ac91783164ed45::amm_math::mul_div_u128((0x2::balance::value<T0>(&arg1) as u128), (arg5 as u128), (arg3 as u128)), 0xc2e8aa2527b351a1b5b4bfafa1661e83cf51fd2a25e6aa9d01ac91783164ed45::amm_math::mul_div_u128((0x2::balance::value<T1>(&arg2) as u128), (arg5 as u128), (arg4 as u128)))
        };
        assert!(v0 > 0, 511);
