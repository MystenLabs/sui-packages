module 0xc28d2fad29a8a933409969f6a960ae88e6309584a197508dcdbe110a43f659ca::moonmen_on_sui {
    struct MOONMEN_ON_SUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOONMEN_ON_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MOONMEN_ON_SUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"MoonMen on Sui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The MoonMen have traversed the metasphere in search of their true home. "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://yZsBOF8UUGbugawlhtbPW-0cMBokomKoxdbDwswN-Mk"));
