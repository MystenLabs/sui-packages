module 0xc2716fa80a264770ddb836991626b876f3a76acb9f6abce98948dede79037a63::deep {
    struct DEEP has drop {
        dummy_field: bool,
    }

    fun init(arg0: DEEP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DEEP>(arg0, 6, b"DEEP", b"Deep SUI", b" ", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
