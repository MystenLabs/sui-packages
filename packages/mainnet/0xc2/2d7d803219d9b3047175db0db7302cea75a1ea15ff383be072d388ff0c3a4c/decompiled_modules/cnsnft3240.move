module 0xc22d7d803219d9b3047175db0db7302cea75a1ea15ff383be072d388ff0c3a4c::cnsnft3240 {
    struct CNSNFT3240 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3240, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3240>(arg0, arg1);
