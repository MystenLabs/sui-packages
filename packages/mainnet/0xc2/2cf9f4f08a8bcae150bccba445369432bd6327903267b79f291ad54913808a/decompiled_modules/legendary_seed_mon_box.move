module 0xc22cf9f4f08a8bcae150bccba445369432bd6327903267b79f291ad54913808a::legendary_seed_mon_box {
    struct LEGENDARY_SEED_MON_BOX has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LEGENDARY_SEED_MON_BOX, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<LEGENDARY_SEED_MON_BOX>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Legendary SEED Mon Box"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Users will receive SEED Mon Box at random rates, each Box holds a mystery Mon inside. You can mint your own Mon Box in app. When opening box, you'll receive a new SEED Mon, with its quality determined by the Mon Box tier."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreic5kp3borux3nkz7le272azv2ih4hr4iha2qb72qzw6jbbf4i56mi"));
