module 0xc20ffceae22ca30809d38e1cbe5db332890a1d1cccffee7d595bcdf45eb83a9b::FOMO {
    struct FOMO has drop {
        dummy_field: bool,
    }

    fun init(arg0: FOMO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<FOMO>(arg0, 2, b"FOMO", b"FOMO", b"FOMO", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/OBviWaf8_1Rv-Q8gLVqnIYxVGV0Z6PvKFJgOuq6Mop0?ext=png")), arg1);
