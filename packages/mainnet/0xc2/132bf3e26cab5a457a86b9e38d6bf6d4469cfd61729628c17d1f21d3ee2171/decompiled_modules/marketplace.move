module 0xc2132bf3e26cab5a457a86b9e38d6bf6d4469cfd61729628c17d1f21d3ee2171::marketplace {
    ...
    public entry fun buy(arg0: Listing, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v1 * 500 / 10000;
        if (v2 > v1) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v2 - v1, arg3), v0);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v3, arg3), arg2);
