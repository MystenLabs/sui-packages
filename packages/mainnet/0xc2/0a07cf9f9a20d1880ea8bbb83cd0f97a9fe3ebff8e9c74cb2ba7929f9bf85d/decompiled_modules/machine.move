module 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::machine {
    ...
    public fun forward(arg0: 0x1::string::String, arg1: 0x1::option::Option<u16>, arg2: u16, arg3: &0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::guard::Guard, arg4: vector<u8>) : Forward {
        ...
        let v0 = b"order";
        assert!(0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::guard::isWineessModule(arg3, &arg4, &v0), 1408);
        let v1 = ForwardGuard{
            guard     : 0x2::object::id_address<0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::guard::Guard>(arg3),
            order_ids : arg4,
        };
        Forward{
            namedOperator    : arg0,
    ...
    public fun node_new(arg0: 0x1::string::String) : Node {
        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::ASSERT_NAMELEN_ANDNOT_EMPTY(&arg0);
        Node{
            name : arg0,
