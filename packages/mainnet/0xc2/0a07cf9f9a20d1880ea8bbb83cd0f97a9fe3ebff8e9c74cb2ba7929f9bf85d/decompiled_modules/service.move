module 0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::service {
    ...
    public fun REQ(arg0: &0x1::string::String, arg1: &vector<0x1::string::String>) {
        ...
        while (v1 < v0) {
            0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::ASSERT_NAMELEN(0x1::vector::borrow<0x1::string::String>(arg1, v1));
            v1 = v1 + 1;
        };
    }
    ...
    public fun Sale_stock_add(arg0: &mut Sale, arg1: u64) {
        0xc20a07cf9f9a20d1880ea8bbb83cd0f97a9fe3ebff8e9c74cb2ba7929f9bf85d::common::ASSERT_U64_ADD_UPFLOW(arg0.stock, arg1);
