module 0xc236dbb0ba110f0053a39be9635e0bbd5805a8d601f32e8ff9bbc6680f60bd3d::reward4233 {
    struct REWARD4233 has drop {
        dummy_field: bool,
    }

    struct TICKET_4233 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4233(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_4233>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4233, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4233>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4233>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4233>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4233>>(v5, 0x2::tx_context::sender(arg1));
    }
