module 0xc27d4999b06ee8e95ddd43ffbbaf200ea4ac9252950cc769da98d9905b586d37::canvas {
    ...
    entry fun mint(arg0: &mut GlobalState, arg1: &0x2::random::Random, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = encode_base64(*0x1::string::as_bytes(&v7));
        let v9 = 0x1::string::utf8(b"data:image/svg+xml;base64,");
        0x1::string::append(&mut v9, v8);
        let v10 = 0x1::string::utf8(b"Imagine Canvas #");
        0x1::string::append(&mut v10, u64_to_str(arg0.total_supply));
        let v11 = Attribute{
        ...
        let v13 = 0x1::vector::empty<Attribute>();
        let v14 = &mut v13;
        0x1::vector::push_back<Attribute>(v14, v11);
        0x1::vector::push_back<Attribute>(v14, v12);
        let v15 = NFTAttributes{contents: v13};
        let v16 = CanvasNFT{
        ...
        0x2::transfer::public_transfer<CanvasNFT>(v16, 0x2::tx_context::sender(arg3));
    }
    ...
    entry fun paint_overwrite(arg0: &mut CanvasNFT, arg1: vector<u8>, arg2: &0x2::tx_context::TxContext) {
        ...
        0x1::string::append(&mut v4, arg0.svg_data);
        arg0.image_url = v4;
    }
