module 0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::q64x64 {
    ...
    public fun liquidity(arg0: u64, arg1: u64, arg2: u128) : u128 {
        0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::u256_to_u128(((arg0 as u256) * (arg2 as u256) >> 64) + (arg1 as u256))
    }
    ...
    public fun log2(arg0: u128) : u128 {
        ...
        let v2 = if (v0 >= 9223372036854775808) {
            ...
            v1 = 0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::div_u128(85070591730234615865843651857942052864, v0);
            340282366920938463463374607431768211455
        };
        let v3 = 0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::bit_math::most_significant_bit(v1 >> 63);
    ...
    public fun mul_div_round_down_u128(arg0: u128, arg1: u128, arg2: u128) : u128 {
        ...
        0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::u256_to_u128((arg0 as u256) * (arg1 as u256) / (arg2 as u256))
    }
    ...
    public fun mul_div_round_up_u128(arg0: u128, arg1: u128, arg2: u128) : u128 {
        ...
        0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::u256_to_u128(((arg0 as u256) * (arg1 as u256) - 1) / (arg2 as u256) + 1)
    }
    ...
    public fun mul_shift_round_down(arg0: u64, arg1: u128, arg2: u8) : u64 {
        ...
        0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::u256_to_u64((arg0 as u256) * (arg1 as u256) / (1 << arg2))
    }
    ...
    public fun mul_shift_round_up(arg0: u64, arg1: u128, arg2: u8) : u64 {
        ...
        0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::u256_to_u64(((arg0 as u256) * (arg1 as u256) - 1) / (1 << arg2) + 1)
    }
    ...
    public fun shift_div_round_down(arg0: u64, arg1: u8, arg2: u128) : u64 {
        ...
        0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::u128_to_u64(((arg0 as u128) << arg1) / arg2)
    }
    ...
    public fun shift_div_round_up(arg0: u64, arg1: u8, arg2: u128) : u64 {
        ...
        0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::u128_to_u64((((arg0 as u128) << arg1) - 1) / arg2 + 1)
    }
    ...
    public fun sqrt(arg0: u128) : u128 {
        ...
        let v0 = shl(1, shr((0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::bit_math::most_significant_bit(arg0) as u128), 1));
        let v1 = shr(add(v0, 0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::div_u128(arg0, v0)), 1);
        let v2 = shr(add(v1, 0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::div_u128(arg0, v1)), 1);
        let v3 = shr(add(v2, 0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::div_u128(arg0, v2)), 1);
        let v4 = shr(add(v3, 0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::div_u128(arg0, v3)), 1);
        let v5 = shr(add(v4, 0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::div_u128(arg0, v4)), 1);
        let v6 = shr(add(v5, 0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::div_u128(arg0, v5)), 1);
        let v7 = shr(add(v6, 0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::div_u128(arg0, v6)), 1);
        let v8 = 0xc227ae8ddffdcad6b905488f56f230c79b708fcec286a17dd9999b4675893a50::safe_math::div_u128(arg0, v7);
        if (v7 < v8) {
            v7
        } else {
            v8
