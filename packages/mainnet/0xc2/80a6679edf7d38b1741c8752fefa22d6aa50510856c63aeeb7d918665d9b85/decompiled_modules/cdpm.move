module 0xc280a6679edf7d38b1741c8752fefa22d6aa50510856c63aeeb7d918665d9b85::cdpm {
    ...
    public fun admin_collect_fee<T0>(arg0: &AdminCap, arg1: &mut FeeHouse, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>());
        let v1 = 0x2::bag::remove<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg1.fee, v0);
    ...
    public fun admin_collect_fee_return_coin<T0>(arg0: &AdminCap, arg1: &mut FeeHouse, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>());
        let v1 = 0x2::bag::remove<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg1.fee, v0);
        let v2 = AdminFeeCollected{
            fee_house_id : 0x2::object::id<FeeHouse>(arg1),
    ...
    public fun admin_insert_access_list(arg0: &AdminCap, arg1: &mut AccessList, arg2: address, arg3: &0x2::clock::Clock) {
    ...
    public fun admin_new_fee_house(arg0: &AdminCap, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = FeeHouse{
            id       : 0x2::object::new(arg2),
            fee_rate : arg1,
            fee      : 0x2::bag::new(arg2),
        };
        0x2::transfer::share_object<FeeHouse>(v0);
    }

    public fun admin_remove_access_list(arg0: &AdminCap, arg1: &mut AccessList, arg2: address, arg3: &0x2::clock::Clock) {
    ...
    public fun admin_set_fee(arg0: &AdminCap, arg1: &mut FeeHouse, arg2: u64, arg3: &0x2::clock::Clock) {
        arg1.fee_rate = arg2;
    ...
    public fun admin_transfer(arg0: AdminCap, arg1: address, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun agent_add_liquidity<T0, T1>(arg0: &mut PositionManager, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: u64, arg3: u64, arg4: vector<u32>, arg5: vector<u64>, arg6: vector<u64>, arg7: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg8: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v1;
        let v4 = &mut v2;
        add_liquidity_private<T0, T1>(arg0, arg1, v3, v4, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
        add_to_balance<T0>(arg0, v1);
        add_to_balance<T1>(arg0, v2);
        let v5 = AgentLiquidityAdded{
        ...
        0x2::event::emit<AgentLiquidityAdded>(v5);
    }
    ...
    public fun agent_collect_fee<T0, T1>(arg0: &mut PositionManager, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg3: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::contains<address>(&arg0.agents, &v0), 1002);
        let (v1, v2) = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::collect_position_fee<T0, T1>(arg1, 0x1::option::borrow_mut<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&mut arg0.position), arg2, arg3, arg5);
        let v3 = v2;
        let v4 = v1;
        add_to_fee<T0>(arg0, 0x2::coin::from_balance<T0>(v4, arg5));
        add_to_fee<T1>(arg0, 0x2::coin::from_balance<T1>(v3, arg5));
    ...
    public fun agent_collect_reward<T0, T1, T2>(arg0: &mut PositionManager, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg3: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(0x2::vec_set::contains<address>(&arg0.agents, &v0), 1002);
        let v1 = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::collect_position_reward<T0, T1, T2>(arg1, 0x1::option::borrow_mut<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&mut arg0.position), arg2, arg3, arg5);
        add_to_fee<T2>(arg0, 0x2::coin::from_balance<T2>(v1, arg5));
    ...
    public fun agent_remove_liquidity<T0, T1>(arg0: &mut PositionManager, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: vector<u32>, arg3: vector<u128>, arg4: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg5: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        add_to_balance<T0>(arg0, 0x2::coin::from_balance<T0>(v1, arg7));
        add_to_balance<T1>(arg0, 0x2::coin::from_balance<T1>(v2, arg7));
        let v3 = AgentLiquidityRemoved{
            pm_id            : 0x2::object::id<PositionManager>(arg0),
            pool_id          : 0x2::object::id<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>>(arg1),
            bins             : arg2,
        ...
        0x2::event::emit<AgentLiquidityRemoved>(v3);
    }

    public fun agent_transfer_fee_to_balance<T0>(arg0: &mut PositionManager, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::vec_set::contains<address>(&arg0.agents, &v0), 1002);
        let v1 = withdraw_from_fee<T0>(arg0, arg1, arg3);
        add_to_balance<T0>(arg0, v1);
    ...
    public fun protocol_add_liquidity<T0, T1>(arg0: &AccessList, arg1: &mut PositionManager, arg2: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg3: u64, arg4: u64, arg5: vector<u32>, arg6: vector<u64>, arg7: vector<u64>, arg8: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg9: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v1;
        let v4 = &mut v2;
        add_liquidity_private<T0, T1>(arg1, arg2, v3, v4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
        add_to_balance<T0>(arg1, v1);
        add_to_balance<T1>(arg1, v2);
        let v5 = ProtocolLiquidityAdded{
        ...
        0x2::event::emit<ProtocolLiquidityAdded>(v5);
    }
    ...
    public fun protocol_collect_fee<T0, T1>(arg0: &AccessList, arg1: &mut FeeHouse, arg2: &mut PositionManager, arg3: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg4: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg5: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::collect_position_fee<T0, T1>(arg3, 0x1::option::borrow_mut<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&mut arg2.position), arg4, arg5, arg7);
        let v3 = v2;
        let v4 = v1;
        let v5 = &mut v4;
        take_fee<T0>(v5, arg1);
        ...
        add_to_fee<T0>(arg2, 0x2::coin::from_balance<T0>(v4, arg7));
        add_to_fee<T1>(arg2, 0x2::coin::from_balance<T1>(v3, arg7));
    ...
    public fun protocol_collect_reward<T0, T1, T2>(arg0: &AccessList, arg1: &mut FeeHouse, arg2: &mut PositionManager, arg3: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg4: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg5: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::contains<address>(&arg0.allow, &v0), 1002);
        assert!(0x2::vec_set::is_empty<address>(&arg2.agents), 1002);
        let v1 = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::collect_position_reward<T0, T1, T2>(arg3, 0x1::option::borrow_mut<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&mut arg2.position), arg4, arg5, arg7);
        let v2 = &mut v1;
        take_fee<T2>(v2, arg1);
        let v3 = 0x2::balance::value<T2>(&v1);
        add_to_fee<T2>(arg2, 0x2::coin::from_balance<T2>(v1, arg7));
    ...
    public fun protocol_remove_liquidity<T0, T1>(arg0: &AccessList, arg1: &mut PositionManager, arg2: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg3: vector<u32>, arg4: vector<u128>, arg5: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg6: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        add_to_balance<T0>(arg1, 0x2::coin::from_balance<T0>(v1, arg8));
        add_to_balance<T1>(arg1, 0x2::coin::from_balance<T1>(v2, arg8));
        let v3 = ProtocolLiquidityRemoved{
            pm_id            : 0x2::object::id<PositionManager>(arg1),
            pool_id          : 0x2::object::id<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>>(arg2),
            bins             : arg3,
        ...
        0x2::event::emit<ProtocolLiquidityRemoved>(v3);
    }

    public fun protocol_transfer_fee_to_balance<T0>(arg0: &AccessList, arg1: &mut PositionManager, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x2::vec_set::contains<address>(&arg0.allow, &v0), 1002);
        assert!(0x2::vec_set::is_empty<address>(&arg1.agents), 1002);
        let v1 = withdraw_from_fee<T0>(arg1, arg2, arg4);
        add_to_balance<T0>(arg1, v1);
        let v2 = FeeTransferredToBalance{
            pm_id     : 0x2::object::id<PositionManager>(arg1),
            coin_type : 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()),
    ...
    public fun register_and_return_record(arg0: &mut GlobalRecord, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : Record {
        let v0 = Record{
            id     : 0x2::object::new(arg2),
            record : 0x2::table::new<0x2::object::ID, bool>(arg2),
        };
        let v1 = 0x2::object::id<Record>(&v0);
        0x2::table::add<address, 0x2::object::ID>(&mut arg0.record, 0x2::tx_context::sender(arg2), v1);
    ...
    public fun unregister_record(arg0: &mut GlobalRecord, arg1: Record, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        let Record {
            id     : v0,
            record : v1,
        } = arg1;
        ...
        let v2 = RecordDeleted{
            record_id : 0x2::table::remove<address, 0x2::object::ID>(&mut arg0.record, 0x2::tx_context::sender(arg3)),
    ...
    public fun user_add_liquidity_to_position<T0, T1>(arg0: &mut PositionManager, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut 0x2::coin::Coin<T1>, arg4: vector<u32>, arg5: vector<u64>, arg6: vector<u64>, arg7: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg8: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        add_liquidity_private<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
    ...
    public fun user_collect_fee<T0, T1>(arg0: &mut PositionManager, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg3: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg5), 1001);
        let (v0, v1) = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::collect_position_fee<T0, T1>(arg1, 0x1::option::borrow_mut<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&mut arg0.position), arg2, arg3, arg5);
        let v2 = v1;
        let v3 = v0;
        let v4 = FeeCollected{
            pm_id       : 0x2::object::id<PositionManager>(arg0),
    ...
    public fun user_collect_reward<T0, T1, T2>(arg0: &mut PositionManager, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg3: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        assert!(arg0.owner == 0x2::tx_context::sender(arg5), 1001);
        let v0 = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::collect_position_reward<T0, T1, T2>(arg1, 0x1::option::borrow_mut<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(&mut arg0.position), arg2, arg3, arg5);
    ...
    public fun user_deposit_position(arg0: &mut Record, arg1: 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun user_get_and_return_position(arg0: &mut PositionManager, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) : 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position {
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 1001);
    ...
    public fun user_get_position(arg0: &mut PositionManager, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position>(user_get_and_return_position(arg0, arg1, arg2), 0x2::tx_context::sender(arg2));
    }

    public fun user_insert_agent(arg0: &mut PositionManager, arg1: address, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg3), 1001);
    ...
    public fun user_remove_agent(arg0: &mut PositionManager, arg1: address, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg3), 1001);
    ...
    public fun user_remove_liquidity_from_position<T0, T1>(arg0: &mut PositionManager, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: vector<u32>, arg3: vector<u128>, arg4: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg5: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        0x2::event::emit<LiquidityRemoved>(v2);
        (0x2::coin::from_balance<T0>(v0, arg7), 0x2::coin::from_balance<T1>(v1, arg7))
    }
