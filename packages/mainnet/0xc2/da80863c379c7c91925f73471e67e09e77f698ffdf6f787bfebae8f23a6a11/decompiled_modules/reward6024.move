module 0xc2da80863c379c7c91925f73471e67e09e77f698ffdf6f787bfebae8f23a6a11::reward6024 {
    struct REWARD6024 has drop {
        dummy_field: bool,
    }

    struct TICKET_6024 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6024(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6024>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6024>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6024, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6024>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6024>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6024>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6024>>(v5, 0x2::tx_context::sender(arg1));
    }
