module 0xc2d2b5d7105f7dde07905f92e273c97a58541fa954315872f81103ce309b93f4::reward4318 {
    struct REWARD4318 has drop {
        dummy_field: bool,
    }

    struct TICKET_4318 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4318(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4318>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4318>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4318, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4318>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4318>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4318>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4318>>(v5, 0x2::tx_context::sender(arg1));
    }
