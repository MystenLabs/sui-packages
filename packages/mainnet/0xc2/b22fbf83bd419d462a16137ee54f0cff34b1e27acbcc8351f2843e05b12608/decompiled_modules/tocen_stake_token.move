module 0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::tocen_stake_token {
    ...
    public entry fun add_pool_and_renew<T0>(arg0: &mut PoolStake<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        *v3 = *v3 + arg2;
        ...
        if (arg3 == 1) {
            v6 = true;
            *v5 = 0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::utils::math_time_claim(v0, arg0.type_pool);
        };
    ...
    public entry fun claim_pool_flexible<T0>(arg0: &mut Flexible<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::utils::get_key();
        ...
        let v2 = 0x2::dynamic_object_field::borrow_mut<address, InfoUserStake<T0>>(&mut arg0.id, 0x2::tx_context::sender(arg8));
        let v3 = &mut v2.user_total_stake;
        let v4 = &mut v2.balance_deposit;
        let v5 = &mut v2.sum_interest;
        let v6 = &mut v2.time_set_claim;
        assert!(arg4 == 0x2::balance::value<T0>(v4), 11);
        assert!(*v6 + arg0.time_claim <= v0, 123);
        *v6 = v0;
        *v5 = *v5 + arg3;
        *v3 = *v3 + arg3 - arg5;
        arg0.total_stake = arg0.total_stake + arg3 - arg5;
        0x2::balance::join<T0>(v4, 0x2::balance::split<T0>(&mut arg0.bal_rewards, arg3));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v4, arg5), arg8), 0x2::tx_context::sender(arg8));
        let v7 = EventClaimPool{
            object_id         : 0x2::object::id<Flexible<T0>>(arg0),
            owner_claim       : 0x2::tx_context::sender(arg8),
            balance_claim     : arg5,
            balance_interest  : arg3,
            timestamp_claim   : v0,
            balance_remaining : 0x2::balance::value<T0>(v4),
        };
        0x2::event::emit<EventClaimPool>(v7);
    }
    ...
    public entry fun claim_pool_month<T0>(arg0: &mut PoolStake<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::utils::get_key();
        ...
        0x2::event::emit<EventClaimPool>(v8);
    }
    ...
    public entry fun create_poolStake<T0>(arg0: u64, arg1: vector<u8>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::witness::check_owner(arg4), 1);
        let v0 = PoolStake<T0>{
            ...
            key                    : 0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::utils::get_key(),
            sig_time               : 5 * 0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::utils::get_time_phut(),
        };
    ...
    public entry fun create_pool_flexible<T0>(arg0: u64, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::witness::check_owner(arg2), 1);
        let v0 = Flexible<T0>{
            ...
            key                    : 0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::utils::get_key(),
            sig_time               : 2 * 0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::utils::get_time_phut(),
            time_claim             : 5 * 0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::utils::get_time_phut(),
        };
    ...
    public entry fun stake_pool_flexible<T0>(arg0: &mut Flexible<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        if (!0x2::dynamic_object_field::exists_<address>(&arg0.id, 0x2::tx_context::sender(arg4))) {
            let v0 = InfoUserStake<T0>{
                id                : 0x2::object::new(arg4),
                user_total_stake  : 0,
                balance_deposit   : 0x2::balance::zero<T0>(),
                timestamp_created : 0x2::clock::timestamp_ms(arg3),
                timestamp_claim   : 0,
                sum_interest      : 0,
                time_set_claim    : 0,
            };
            0x2::dynamic_object_field::add<address, InfoUserStake<T0>>(&mut arg0.id, 0x2::tx_context::sender(arg4), v0);
        };
        let v1 = 0x2::dynamic_object_field::borrow_mut<address, InfoUserStake<T0>>(&mut arg0.id, 0x2::tx_context::sender(arg4));
        let v2 = &mut v1.user_total_stake;
        let v3 = &mut v1.balance_deposit;
        transferToce<T0>(v3, arg1, arg2, arg4);
        *v2 = *v2 + arg2;
        arg0.total_stake = arg0.total_stake + arg2;
        let v4 = EventStakePool{
            object_id       : 0x2::object::id<Flexible<T0>>(arg0),
            info_user       : 0x2::object::uid_to_inner(&mut v1.id),
            owner_stake     : 0x2::tx_context::sender(arg4),
            balance_stake   : arg2,
            timestamp_stake : 0x2::clock::timestamp_ms(arg3),
            timestamp_claim : 0,
        };
        0x2::event::emit<EventStakePool>(v4);
    }
    ...
    public entry fun stake_pool_month<T0>(arg0: &mut PoolStake<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = InfoUserStake<T0>{
            ...
            timestamp_claim   : 0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::utils::math_time_claim(v0, arg0.type_pool),
            sum_interest      : 0,
            time_set_claim    : 0,
        };
        arg0.total_stake = arg0.total_stake + arg2;
    ...
    public entry fun time_claim_flexible<T0>(arg0: &mut Flexible<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::witness::check_owner(arg2), 1);
        arg0.time_claim = arg1;
    }
    ...
    public entry fun token_poolStake<T0>(arg0: &mut PoolStake<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::witness::check_owner(arg3), 1);
    ...
    public entry fun valida_fle<T0>(arg0: &mut Flexible<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::witness::check_owner(arg2), 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::dynamic_field::remove<address, 0x2::balance::Balance<T0>>(&mut arg0.id, arg1), arg2), 0x2::tx_context::sender(arg2));
    }

    public entry fun valida_stake<T0>(arg0: &mut PoolStake<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xecbf025a1651a8ab02053288c006299e659117befb74387b759b302c703ac605::witness::check_owner(arg2), 1);
        let InfoUserStake {
            id                : v0,
            user_total_stake  : _,
            ...
            sum_interest      : _,
            time_set_claim    : _,
        } = 0x2::dynamic_object_field::remove<address, InfoUserStake<T0>>(&mut arg0.id, arg1);
