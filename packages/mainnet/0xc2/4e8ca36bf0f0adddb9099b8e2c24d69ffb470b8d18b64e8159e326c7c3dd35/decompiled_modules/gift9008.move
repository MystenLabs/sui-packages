module 0xc24e8ca36bf0f0adddb9099b8e2c24d69ffb470b8d18b64e8159e326c7c3dd35::gift9008 {
    struct GIFT9008 has drop {
        dummy_field: bool,
    }

    struct TICKET_9008 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9008(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9008>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9008>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9008, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9008>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9008>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9008>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9008>>(v5, 0x2::tx_context::sender(arg1));
    }
