module 0xe652617a2d6e3d3bb1e24e24d471e755153339c84107dfdcffe77efe04209007::treasury {
    ...
    public fun claim<T0>(arg0: &mut Vault<T0>, arg1: 0x682d456a9b6c051c9b70e2f67bcee9602b1244278b898e70348b8c6214c214ab::journey::Receipt, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui, 11000000), arg2), v1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.wal, 3000000000), arg2), v1);
        let v5 = ProvisionDraw{
            recipient  : v1,
            session_id : v0,
            journey_id : v0,
            sui_out    : 11000000,
        ...
        0x2::event::emit<ProvisionDraw>(v5);
    }
