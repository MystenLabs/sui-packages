module 0x5415a2dee038c47122709496180580195f49c05ef73027cda07cd4a1b8594b44::escrow {
    ...
    struct PaymentCancellationRequest has key {
        id: 0x2::object::UID,
        escrow_id: 0x2::object::ID,
        booking_ref: 0x1::string::String,
        guest: address,
    ...
    struct ResaleBindingKey has copy, drop, store {
        dummy_field: bool,
    }

    struct ResaleBinding has copy, drop, store {
        deposit_escrow_id: 0x2::object::ID,
        payment_escrow_id: 0x2::object::ID,
    }
    ...
    public fun buy_resale_verified<T0>(arg0: &mut BookingEscrow<T0>, arg1: &mut BookingPaymentEscrow<T0>, arg2: &mut ResalePolicy, arg3: &IdentityAttestation, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = ResaleBindingKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists<ResaleBindingKey>(&arg2.id, v1), 36);
        let v2 = ResaleBindingKey{dummy_field: false};
        let v3 = 0x2::dynamic_field::remove<ResaleBindingKey, ResaleBinding>(&mut arg2.id, v2);
        assert!(0x2::object::id<BookingEscrow<T0>>(arg0) == v3.deposit_escrow_id, 35);
        assert!(0x2::object::id<BookingPaymentEscrow<T0>>(arg1) == v3.payment_escrow_id, 35);
        let v4 = 0x2::coin::value<T0>(&arg4);
        assert!(v4 == arg2.ask_price, 21);
        let v5 = arg0.amount + arg1.host_amount + arg1.aria_amount + arg1.tax_amount;
        assert!(v4 >= v5, 18);
        let v6 = v4 - v5;
        let v7 = (((v6 as u128) * (1000 as u128) / (10000 as u128)) as u64);
        let v8 = (((v6 as u128) * (4500 as u128) / (10000 as u128)) as u64);
        let v9 = arg0.guest;
        arg0.guest = v0;
        arg1.guest = v0;
        ...
        arg2.seller = @0x0;
        if (v7 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg4, v7, arg6), arg1.aria_addr);
        };
        if (v8 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg4, v8, arg6), arg1.host);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg4, v9);
        mint_booking_pass_internal(arg2.booking_ref, v0, arg2.host, arg2.property_id, arg2.check_in_ms, arg2.check_out_ms, arg6);
        let v10 = BookingResold{
        ...
        0x2::event::emit<BookingResold>(v10);
    }

    public fun cancel_payment_cancellation_request(arg0: PaymentCancellationRequest, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.guest, 0);
        let PaymentCancellationRequest {
            id              : v0,
            escrow_id       : _,
            booking_ref     : _,
            guest           : _,
    ...
    public fun cancel_resale_listing(arg0: &mut ResalePolicy, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.seller = @0x0;
        let v1 = ResaleBindingKey{dummy_field: false};
        if (0x2::dynamic_field::exists<ResaleBindingKey>(&arg0.id, v1)) {
            let v2 = ResaleBindingKey{dummy_field: false};
            0x2::dynamic_field::remove<ResaleBindingKey, ResaleBinding>(&mut arg0.id, v2);
        };
        mint_booking_pass_internal(arg0.booking_ref, v0, arg0.host, arg0.property_id, arg0.check_in_ms, arg0.check_out_ms, arg1);
        let v3 = ResaleCancelled{
            booking_ref : arg0.booking_ref,
            seller      : v0,
        };
        0x2::event::emit<ResaleCancelled>(v3);
    }
    ...
    public fun claim_operator_cap(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == @0x4d949fa987a29ace653fbd7c43d34293af2fda0ad3e38bd03dd2403e8e5847ad, 31);
    ...
    public fun create_resale_policy_v2<T0>(arg0: &OperatorCap, arg1: &BookingPaymentEscrow<T0>, arg2: bool, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = ResalePolicy{
            ...
            resale_count     : 0,
            release_time_ms  : arg1.release_time_ms,
            resale_window_ms : arg4,
            property_id      : arg5,
            check_in_ms      : arg6,
            check_out_ms     : arg7,
            listed           : false,
    ...
    public fun list_for_resale<T0>(arg0: &mut BookingEscrow<T0>, arg1: &mut BookingPaymentEscrow<T0>, arg2: &mut ResalePolicy, arg3: BookingPass, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        arg2.ask_price = arg4;
        arg2.seller = v0;
        let v9 = ResaleBindingKey{dummy_field: false};
        if (0x2::dynamic_field::exists<ResaleBindingKey>(&arg2.id, v9)) {
            let v10 = ResaleBindingKey{dummy_field: false};
            0x2::dynamic_field::remove<ResaleBindingKey, ResaleBinding>(&mut arg2.id, v10);
        };
        let v11 = ResaleBindingKey{dummy_field: false};
        let v12 = ResaleBinding{
            deposit_escrow_id : 0x2::object::id<BookingEscrow<T0>>(arg0),
            payment_escrow_id : 0x2::object::id<BookingPaymentEscrow<T0>>(arg1),
        };
        0x2::dynamic_field::add<ResaleBindingKey, ResaleBinding>(&mut arg2.id, v11, v12);
        let v13 = ResaleListed{
            booking_ref : arg2.booking_ref,
            seller      : v0,
            ask_price   : arg4,
            face        : v1,
        };
        0x2::event::emit<ResaleListed>(v13);
    }
    ...
    fun mint_booking_pass_internal(arg0: 0x1::string::String, arg1: address, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = BookingPass{
    ...
    public fun mint_booking_pass_v2<T0>(arg0: &OperatorCap, arg1: &BookingPaymentEscrow<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        mint_booking_pass_internal(arg1.booking_ref, arg1.guest, arg1.host, arg2, arg3, arg4, arg5);
    }
    ...
    public fun refund_payment_stale<T0>(arg0: BookingPaymentEscrow<T0>, arg1: PaymentCancellationRequest, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 0, 6);
        assert!(0x2::object::id<BookingPaymentEscrow<T0>>(&arg0) == arg1.escrow_id, 32);
        assert!(arg1.guest == arg0.guest, 34);
        assert!(0x2::clock::timestamp_ms(arg2) < arg0.release_time_ms, 12);
        assert!(0x2::clock::timestamp_ms(arg2) >= arg1.requested_at_ms + 2592000000, 33);
        let v0 = arg0.guest;
        let BookingPaymentEscrow {
            id              : v1,
            booking_ref     : _,
        ...
        let v21 = PaymentRefunded{
            escrow_id   : 0x2::object::uid_to_inner(&v15),
            booking_ref : arg0.booking_ref,
            guest       : v0,
            amount      : 0x2::coin::value<T0>(&v14),
        };
        0x2::event::emit<PaymentRefunded>(v21);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v14, v0);
    }
    ...
    public fun request_payment_cancellation<T0>(arg0: &BookingPaymentEscrow<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 0, 6);
        assert!(0x2::tx_context::sender(arg2) == arg0.guest, 0);
        assert!(0x2::clock::timestamp_ms(arg1) < arg0.release_time_ms, 12);
        let v0 = PaymentCancellationRequest{
            id              : 0x2::object::new(arg2),
            escrow_id       : 0x2::object::id<BookingPaymentEscrow<T0>>(arg0),
            booking_ref     : arg0.booking_ref,
            guest           : arg0.guest,
            requested_at_ms : 0x2::clock::timestamp_ms(arg1),
        };
        0x2::transfer::share_object<PaymentCancellationRequest>(v0);
    }
