module 0xc25b9da5f11f2a6fb5e6563dbfe857f7f78b074e123da6ac266a25ef9ad66467::acl {
    struct Pbpwcxwcuoyrkfy has key {
        id: 0x2::object::UID,
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    public entry fun bgirbpfyuzohlun<T0>(arg0: &mut Pbpwcxwcuoyrkfy, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun kaevwahmlfbwues<T0: store + key>(arg0: &mut Pbpwcxwcuoyrkfy, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
    ...
    public entry fun rbhikrrgsdhdehq(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = Pbpwcxwcuoyrkfy{
        ...
        0x2::transfer::share_object<Pbpwcxwcuoyrkfy>(v0);
    }
    ...
    public entry fun vciraqzqrrftqde(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<Pbpwcxwcuoyrkfy>(v4);
    }

    public entry fun vvzajqebpbvukoj(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Pbpwcxwcuoyrkfy, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
    ...
    public entry fun zbcqrgeuuffwwyn(arg0: &mut Pbpwcxwcuoyrkfy, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun zjhjrabdyjxzdmz(arg0: &mut Pbpwcxwcuoyrkfy, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
