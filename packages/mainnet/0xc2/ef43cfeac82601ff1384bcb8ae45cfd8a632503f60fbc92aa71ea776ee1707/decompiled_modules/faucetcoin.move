module 0xc2ef43cfeac82601ff1384bcb8ae45cfd8a632503f60fbc92aa71ea776ee1707::faucetcoin {
    ...
    fun init(arg0: FAUCETCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCETCOIN>(arg0, 6, b"FGMCC", b"Faucet Coin Neo", b"Don't ask why", 0x1::option::none<0x2::url::Url>(), arg1);
