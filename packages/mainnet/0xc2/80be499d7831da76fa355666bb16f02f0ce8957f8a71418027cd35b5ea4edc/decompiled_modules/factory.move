module 0xc280be499d7831da76fa355666bb16f02f0ce8957f8a71418027cd35b5ea4edc::factory {
    ...
    public fun new<T0: drop>(arg0: T0, arg1: u64, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: 0x1::option::Option<0x2::url::Url>, arg6: bool, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public fun buyCoins<T0: drop>(arg0: &mut CoinReserve<T0>, arg1: u64, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: address, arg4: &mut 0xd2a5dabef718a5908aa92dd10bf1fb2fe0a5305f18c7dc53c1753501ea96f6e2::collector::Collector, arg5: u64, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = arg1 - v0;
        let v3 = v2;
        let v4 = 0xd2a5dabef718a5908aa92dd10bf1fb2fe0a5305f18c7dc53c1753501ea96f6e2::collector::getBondingCurveThreshold(arg4);
        if (v2 + 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance) > v4) {
            let v5 = v4 - 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance);
            v3 = v5;
            v1 = v5 / 100;
        };
        assert!(v3 > 0, 1);
        let v6 = getTokensForSui<T0>(arg0, v3);
        let v7 = &mut arg0.coin_balance;
        assert!(0x2::coin::value<0x2::sui::SUI>(arg2) >= arg1, 14);
        assert!(0x2::balance::value<T0>(v7) >= v6, 17);
        assert!(v6 >= arg5, 10);
        0x2::coin::put<0x2::sui::SUI>(&mut arg0.sui_balance, 0x2::coin::split<0x2::sui::SUI>(arg2, v3, arg7));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(v7, v6, arg7), arg3);
        0xd2a5dabef718a5908aa92dd10bf1fb2fe0a5305f18c7dc53c1753501ea96f6e2::collector::sendFee(arg4, 0x2::coin::split<0x2::sui::SUI>(arg2, v1, arg7), arg7);
        let v8 = getBuyPriceForTokens<T0>(arg0, 1, arg7);
        let v9 = TradeOperation<T0>{
        ...
        0x2::event::emit<TradeOperation<T0>>(v9);
        if (0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance) >= v4) {
            arg0.is_bonding_curve_goal_reached = true;
            let v10 = BondingCurveGoalEvent<T0>{
                coin_balance       : 0x2::balance::value<T0>(&arg0.coin_balance),
                sui_balance        : 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance),
                initial_market_cap : arg0.initial_market_cap,
                latest_price       : v8,
            ...
            0x2::event::emit<BondingCurveGoalEvent<T0>>(v10);
        };
    }
