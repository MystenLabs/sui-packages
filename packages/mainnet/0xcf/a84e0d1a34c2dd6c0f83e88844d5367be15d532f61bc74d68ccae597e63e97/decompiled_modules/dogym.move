module 0x35642bf3b8b1690ab090e2efaf660e2825f99998330dc016d701d4670facc97d::dogym {
    ...
    public entry fun change_coin_admin<T0>(arg0: &mut DogymAridrop<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(arg0.admin == v0, 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg0.total_dogym_coin, arg1, arg2), v0);
        arg0.total_coin_balance = arg0.total_coin_balance - arg1;
    }
