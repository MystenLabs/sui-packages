module 0xcf3f071e1f9e31803d3ff8ce884607a3deb1b9d5c3026f1576ad3bd5e45f6b21::fun_7k_router {
    ...
    public entry fun buy_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0x3068e532f3d924839df360444fa096cada1d5ad66a9d15df610e88166bbdaa60::fun_7k::Configuration, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg7: 0x1::string::String, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0xcf3f071e1f9e31803d3ff8ce884607a3deb1b9d5c3026f1576ad3bd5e45f6b21::utils::send_coin<T0>(v5, 0x2::tx_context::sender(arg8));
        0xcf3f071e1f9e31803d3ff8ce884607a3deb1b9d5c3026f1576ad3bd5e45f6b21::utils::send_coin<0x2::sui::SUI>(arg2, 0x2::tx_context::sender(arg8));
        0xcf3f071e1f9e31803d3ff8ce884607a3deb1b9d5c3026f1576ad3bd5e45f6b21::utils::send_coin<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg8));
        0xcf3f071e1f9e31803d3ff8ce884607a3deb1b9d5c3026f1576ad3bd5e45f6b21::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, v0, arg8), arg0.admin);
        let v7 = BuyEvent<T0>{
    ...
    public entry fun sell_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0x3068e532f3d924839df360444fa096cada1d5ad66a9d15df610e88166bbdaa60::fun_7k::Configuration, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x3068e532f3d924839df360444fa096cada1d5ad66a9d15df610e88166bbdaa60::fun_7k::sell_<T0>(arg1, &mut v0, false, arg4, arg6);
        let v2 = 0x2::coin::value<0x2::sui::SUI>(&v1);
        let v3 = v2 * arg0.sell_fee / 10000;
        assert!(v2 - v3 >= arg4, 1);
        0xcf3f071e1f9e31803d3ff8ce884607a3deb1b9d5c3026f1576ad3bd5e45f6b21::utils::send_coin<T0>(arg2, 0x2::tx_context::sender(arg6));
        0xcf3f071e1f9e31803d3ff8ce884607a3deb1b9d5c3026f1576ad3bd5e45f6b21::utils::send_coin<T0>(v0, 0x2::tx_context::sender(arg6));
        0xcf3f071e1f9e31803d3ff8ce884607a3deb1b9d5c3026f1576ad3bd5e45f6b21::utils::send_coin<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg6));
        0xcf3f071e1f9e31803d3ff8ce884607a3deb1b9d5c3026f1576ad3bd5e45f6b21::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v1, v3, arg6), arg0.admin);
        let v4 = SellEvent<T0>{
