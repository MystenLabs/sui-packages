module 0x26bf21a298d81e2018089f1e5812d7b6d944401f1f04a2da1728a972679a1678::lp_registry {
    ...
    public fun fetch_positions_by_ids<T0: store + key>(arg0: &LPRegistry<T0>, arg1: vector<0x2::object::ID>) : vector<vector<u8>> {
        ...
        while (v2 < 0x1::vector::length<0x2::object::ID>(v0)) {
            ...
            let v4 = if (0x2::table::contains<0x2::object::ID, 0x26bf21a298d81e2018089f1e5812d7b6d944401f1f04a2da1728a972679a1678::auto_position::AutoPosition<T0>>(&arg0.positions, *v3)) {
                0x2::bcs::to_bytes<0x26bf21a298d81e2018089f1e5812d7b6d944401f1f04a2da1728a972679a1678::auto_position::AutoPosition<T0>>(0x2::table::borrow<0x2::object::ID, 0x26bf21a298d81e2018089f1e5812d7b6d944401f1f04a2da1728a972679a1678::auto_position::AutoPosition<T0>>(&arg0.positions, *v3))
            } else {
                0x1::vector::empty<u8>()
            };
