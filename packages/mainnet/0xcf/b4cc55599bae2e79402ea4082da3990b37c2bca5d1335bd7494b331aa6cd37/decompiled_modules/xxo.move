module 0xcfb4cc55599bae2e79402ea4082da3990b37c2bca5d1335bd7494b331aa6cd37::xxo {
    struct XXO has drop {
        dummy_field: bool,
    }

    fun init(arg0: XXO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/1hNAAHBRneBOMqKxuMTtJuLwq_0KzYfkXIn1OmCZBvA";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/1hNAAHBRneBOMqKxuMTtJuLwq_0KzYfkXIn1OmCZBvA"))
        };
