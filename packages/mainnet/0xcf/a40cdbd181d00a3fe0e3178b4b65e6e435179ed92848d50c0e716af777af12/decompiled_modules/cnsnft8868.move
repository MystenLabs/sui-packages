module 0xcfa40cdbd181d00a3fe0e3178b4b65e6e435179ed92848d50c0e716af777af12::cnsnft8868 {
    struct CNSNFT8868 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8868, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://verceltest-fawn-nu.vercel.app/api/{id}"));
        let v4 = 0x2::package::claim<CNSNFT8868>(arg0, arg1);
