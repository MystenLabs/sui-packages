module 0xcfe48ea8672b01465667cd8f360bbf4820b0d809523d7ef306f67a7af1976e59::cetus_adapter {
    ...
    public fun buy<T0>(arg0: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::Config, arg1: &mut 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::fees::FeeVault, arg2: &mut 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::referral::ReferralRegistry, arg3: &GraduatedPool<T0>, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: u64, arg8: 0x1::option::Option<address>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        emit_routed_trade<T0>(arg3, arg4, true, v0, 0x2::coin::value<T0>(&v5), 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::router::charge_buy(arg0, arg1, arg2, arg3.curve_id, &mut arg6, arg8, arg9, arg10), arg8, arg9, arg10);
        v5
    }

    public fun collect_fees<T0>(arg0: &mut GraduatedPool<T0>, arg1: &mut 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::fees::FeeVault, arg2: &0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::router::deposit_pool_fees<T0>(arg1, arg0.curve_id, arg0.coin_type, arg0.creator, 0x2::coin::into_balance<0x2::sui::SUI>(v2), v3, arg5);
    }
    ...
    public fun migrate<T0>(arg0: &mut 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::MigrationVault<T0>, arg1: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::MigrationCap, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg5: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg6: &0x2::coin::CoinMetadata<T0>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::curve_id<T0>(arg0);
        let (v1, v2) = 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::redeem<T0>(arg0, arg1);
        let v3 = v2;
        let v4 = v1;
        let v5 = 0x2::balance::value<0x2::sui::SUI>(&v4);
        let v6 = 0x2::balance::value<T0>(&v3);
        assert!(v5 > 0 && v6 > 0, 0);
        let v7 = 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::sqrt_price_x64(v6, v5);
        ...
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::return_dust<T0>(arg0, 0x2::coin::into_balance<0x2::sui::SUI>(v12), 0x2::coin::into_balance<T0>(v11));
        let v17 = GraduatedPool<T0>{
            id              : 0x2::object::new(arg8),
            curve_id        : v0,
            coin_type       : 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::coin_type<T0>(arg0),
            creator         : 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::creator<T0>(arg0),
            pool_id         : v14,
            proof           : v15,
            sui_collected   : 0,
            token_collected : 0,
        };
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::confirm<T0>(arg0, arg1, v14, 0x1::option::some<0x2::object::ID>(v16), arg7);
    ...
    public fun migrate_burn_position<T0>(arg0: &mut 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::MigrationVault<T0>, arg1: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::MigrationCap, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg5: &0x2::coin::CoinMetadata<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::redeem<T0>(arg0, arg1);
        let v2 = v1;
        let v3 = v0;
        let v4 = 0x2::balance::value<0x2::sui::SUI>(&v3);
        let v5 = 0x2::balance::value<T0>(&v2);
        assert!(v4 > 0 && v5 > 0, 0);
        let v6 = 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::sqrt_price_x64(v5, v4);
        ...
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::return_dust<T0>(arg0, 0x2::coin::into_balance<0x2::sui::SUI>(v11), 0x2::coin::into_balance<T0>(v10));
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::confirm<T0>(arg0, arg1, v13, 0x1::option::none<0x2::object::ID>(), arg6);
        let v14 = MigratedToCetus{
            curve_id          : 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::curve_id<T0>(arg0),
            pool_id           : v13,
    ...
    public fun sell<T0>(arg0: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::Config, arg1: &mut 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::fees::FeeVault, arg2: &mut 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::referral::ReferralRegistry, arg3: &GraduatedPool<T0>, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: 0x2::coin::Coin<T0>, arg7: u64, arg8: 0x1::option::Option<address>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        emit_routed_trade<T0>(arg3, arg4, false, 0x2::coin::value<0x2::sui::SUI>(&v5), v0, 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::router::charge_sell(arg0, arg1, arg2, arg3.curve_id, &mut v5, arg8, arg9, arg10), arg8, arg9, arg10);
        v5
    }
