module 0xcfac56bf2f08d727242f4319243106c6802055d3501f4afe5ec0a304f36e38dd::gift4477 {
    struct GIFT4477 has drop {
        dummy_field: bool,
    }

    struct TICKET_4477 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4477(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4477>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4477>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4477, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4477>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4477>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4477>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4477>>(v5, 0x2::tx_context::sender(arg1));
    }
