module 0xcf9f2fe56d2fac9072dfebb2f96f3d1e8d71ae98f52fae0eb3f2a94dec1e12a8::flipcoin {
    ...
    struct TicketGuessNumber has store, key {
        id: 0x2::object::UID,
        guess: u64,
        result: u64,
        status: 0x1::string::String,
    ...
    public entry fun play_guess_number(arg0: &mut FlipCoin, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xcf9f2fe56d2fac9072dfebb2f96f3d1e8d71ae98f52fae0eb3f2a94dec1e12a8::random::get_last_number(0x2::clock::timestamp_ms(arg3));
        0x1::string::utf8(b"");
        let v1 = if (v0 == arg1) {
            let v2 = 0x2::dynamic_object_field::remove<bool, 0x2::coin::Coin<0x2::sui::SUI>>(&mut arg0.id, true);
        ...
        0x2::transfer::share_object<TicketGuessNumber>(v3);
    }
