module 0xcf2f6e31b1ca5bf52bb94c3bfbc125bce355c3e1322dd71c35e61d799f763eea::cnsnft7605 {
    struct CNSNFT7605 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7605, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7605>(arg0, arg1);
