module 0xcf0b0803ba11a0c59d241e14e0dd682af207f853b50f5303c2ea081bb4d28251::db {
    ...
    public fun create_manager_badge(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) : AtomaManagerBadge {
        assert!(0x2::package::from_module<0xcf0b0803ba11a0c59d241e14e0dd682af207f853b50f5303c2ea081bb4d28251::atoma::ATOMA>(arg0), 312012002);
    ...
    public(friend) fun slash_node_on_timeout(arg0: &mut AtomaDb, arg1: SmallId) : 0x2::balance::Balance<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA> {
        ...
        if (v1 == 0) {
            ...
            0x2::balance::split<0x85b33c1dee78a671da8c7f3b666e8699a8e122865aae37a94b5e3de9499662d7::toma::TOMA>(&mut v0.collateral, 0x2::math::divide_and_round_up(v1 * arg0.permille_to_slash_node_on_timeout, 1000))
        }
    }
