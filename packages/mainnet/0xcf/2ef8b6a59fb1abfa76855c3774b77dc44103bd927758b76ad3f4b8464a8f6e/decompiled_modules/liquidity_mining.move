            ...
            if (0x1::option::is_none<UserReward>(v3)) {
                if (arg1.last_update_time_ms <= v2.end_time_ms) {
                    let v4 = if (arg1.last_update_time_ms <= v2.start_time_ms) {
                        0xba79417dd36e8fa1510f53b0491b7a8b2802217a81b1401b1efbb65e4994e016::decimal::mul(v2.cumulative_rewards_per_share, 0xba79417dd36e8fa1510f53b0491b7a8b2802217a81b1401b1efbb65e4994e016::decimal::from(arg1.share))
                    } else {
