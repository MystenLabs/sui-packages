module 0xcf59cf23208778797dc222f816aa44434d1ec004ce268cef27f38018720bc033::cnsnft1411 {
    struct CNSNFT1411 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1411, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1411>(arg0, arg1);
