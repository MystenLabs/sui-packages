module 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::blank_coins {
    ...
    public fun deposit_coin_set<T0>(arg0: &mut BlankCoinsRegistry, arg1: &0x2::coin_registry::Currency<T0>, arg2: 0x2::coin::TreasuryCap<T0>, arg3: 0x2::coin_registry::MetadataCap<T0>, arg4: u8, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        assert!(arg0.total_sets < 100000, 7);
        assert!(arg4 <= 18, 13);
        assert!(arg5 <= 10000000000, 8);
    ...
    public entry fun deposit_coin_set_entry<T0>(arg0: &mut BlankCoinsRegistry, arg1: &0x2::coin_registry::Currency<T0>, arg2: 0x2::coin::TreasuryCap<T0>, arg3: 0x2::coin_registry::MetadataCap<T0>, arg4: u8, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        deposit_coin_set<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    }
    ...
    public fun get_fee<T0>(arg0: &BlankCoinsRegistry, arg1: u8, arg2: 0x2::object::ID) : u64 {
        let v0 = CoinSetKey{
            decimals : arg1,
            cap_id   : arg2,
        };
        0x2::dynamic_field::borrow<CoinSetKey, CoinSet<T0>>(&arg0.id, v0).fee
    }
    ...
    public fun take_coin_set<T0>(arg0: &mut BlankCoinsRegistry, arg1: u8, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) >= v1.fee, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, v1.fee, arg5), v1.owner);
        arg0.total_sets = arg0.total_sets - 1;
    ...
    fun validate_coin_set_for_registry<T0>(arg0: &0x2::coin_registry::Currency<T0>, arg1: &0x2::coin::TreasuryCap<T0>) {
        ...
        let v0 = 0x2::coin_registry::name<T0>(arg0);
        assert!(0x1::string::is_empty(&v0), 10);
        let v1 = 0x2::coin_registry::description<T0>(arg0);
        assert!(0x1::string::is_empty(&v1), 10);
        let v2 = 0x2::coin_registry::icon_url<T0>(arg0);
        assert!(0x1::string::is_empty(&v2), 10);
        let v3 = 0x1::type_name::get<T0>();
        let v4 = 0x1::ascii::into_bytes(0x1::type_name::get_module(&v3));
        let v5 = b"conditional_";
        let v6 = 0x1::vector::length<u8>(&v5);
        assert!(0x1::vector::length<u8>(&v4) > v6, 10);
        let v7 = 0;
        while (v7 < v6) {
            assert!(*0x1::vector::borrow<u8>(&v4, v7) == *0x1::vector::borrow<u8>(&v5, v7), 10);
            v7 = v7 + 1;
        };
        while (v7 < 0x1::vector::length<u8>(&v4)) {
            let v8 = *0x1::vector::borrow<u8>(&v4, v7);
            assert!(v8 >= 48 && v8 <= 57, 10);
            v7 = v7 + 1;
        };
    }

    public fun validate_coin_set_in_registry(arg0: &BlankCoinsRegistry, arg1: u8, arg2: 0x2::object::ID) : bool {
        let v0 = CoinSetKey{
            decimals : arg1,
            cap_id   : arg2,
        };
