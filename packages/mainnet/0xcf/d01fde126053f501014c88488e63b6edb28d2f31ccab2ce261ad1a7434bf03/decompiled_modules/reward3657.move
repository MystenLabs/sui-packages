module 0xcfd01fde126053f501014c88488e63b6edb28d2f31ccab2ce261ad1a7434bf03::reward3657 {
    struct REWARD3657 has drop {
        dummy_field: bool,
    }

    struct TICKET_3657 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3657(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3657>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3657>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3657, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3657>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3657>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3657>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3657>>(v5, 0x2::tx_context::sender(arg1));
    }
