module 0xcf63f1a3f66e298c28725a5a40b66342bb2b5317576cdd09c82350f62dfe32e0::reward5118 {
    struct REWARD5118 has drop {
        dummy_field: bool,
    }

    struct TICKET_5118 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5118(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5118>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5118>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5118, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5118>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5118>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5118>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5118>>(v5, 0x2::tx_context::sender(arg1));
    }
