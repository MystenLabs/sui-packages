module 0xcffca7f1f69df9e817cb2acc4e3b05514b9be9be378f9ed3f22e298d4b6b373c::swap {
    ...
    public entry fun swap_for_base_asset_with_fix_quote_asset<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = merge_coins<T0>(0x1::vector::empty<0x2::coin::Coin<T0>>(), arg6);
        let (v1, v2) = swap<T0, T1>(arg0, arg1, v0, arg2, false, true, arg3, 79226673515401279992447579055, arg4, arg6);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v1, arg5);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v2, arg5);
    }

    public entry fun swap_for_quote_asset_with_fix_base_asset<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = merge_coins<T1>(0x1::vector::empty<0x2::coin::Coin<T1>>(), arg6);
        let (v1, v2) = swap<T0, T1>(arg0, arg1, arg2, v0, true, true, arg3, 4295048016, arg4, arg6);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v1, arg5);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v2, arg5);
    }
