module 0xcf3958026a662b0ff047858be9db761d98ac711d42680d692aca3b25dc081c00::trade {
    ...
    public fun calculate_swaps_withrate<T0, T1>(arg0: &0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::LBPair<T0, T1>, arg1: u64, arg2: u128) : (u64, u64, vector<u32>) {
        let v0 = 0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::get_active_id<T0, T1>(arg0);
        let (v1, v2) = 0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::get_bin<T0, T1>(arg0, v0);
        let v3 = if (v1 == 0) {
            true
        ...
        0x1::vector::push_back<u32>(&mut v7, v0);
        (v6, v5, v7)
    }
