module 0xcf6f4dc3c5eb3a51b86e48b0eb44433ce3248d4508ee838a3f2e09bd31798266::lofi6 {
    struct LOFI6 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LOFI6, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<LOFI6>(arg0, 9, b"LOFI6", b"LOFI6", b"Embrace Your Inner Yeti", v2, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LOFI6>>(v4);
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<LOFI6>>(v3);
    ...
    public entry fun transfer_with_tax(arg0: &TaxStorage, arg1: &AdminCap, arg2: &mut 0x2::coin::Coin<LOFI6>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        ...
        let v3 = 0x2::balance::split<LOFI6>(0x2::coin::balance_mut<LOFI6>(arg2), arg3);
        if (v0 > 0) {
            let v4 = arg3 * v0 / 10000;
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI6>>(0x2::coin::from_balance<LOFI6>(0x2::balance::split<LOFI6>(&mut v3, v4), arg5), arg1.admin_address);
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI6>>(0x2::coin::from_balance<LOFI6>(0x2::balance::split<LOFI6>(&mut v3, arg3 - v4), arg5), arg4);
            0x2::balance::destroy_zero<LOFI6>(v3);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI6>>(0x2::coin::from_balance<LOFI6>(v3, arg5), arg4);
        };
    }
