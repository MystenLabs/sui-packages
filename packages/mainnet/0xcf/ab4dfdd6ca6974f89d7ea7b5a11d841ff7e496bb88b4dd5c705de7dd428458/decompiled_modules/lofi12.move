module 0xcfab4dfdd6ca6974f89d7ea7b5a11d841ff7e496bb88b4dd5c705de7dd428458::lofi12 {
    struct LOFI12 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LOFI12, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<LOFI12>(arg0, 9, b"LOFI12", b"LOFI12", b"LOFI12", v2, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LOFI12>>(v4);
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<LOFI12>>(v3);
    ...
    public entry fun transfer_with_tax(arg0: &TaxStorage, arg1: &AdminCap, arg2: &mut 0x2::coin::Coin<LOFI12>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        ...
        let v3 = 0x2::balance::split<LOFI12>(0x2::coin::balance_mut<LOFI12>(arg2), arg3);
        if (v0 > 0) {
            let v4 = arg3 * v0 / 10000;
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI12>>(0x2::coin::from_balance<LOFI12>(0x2::balance::split<LOFI12>(&mut v3, v4), arg5), arg1.admin_address);
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI12>>(0x2::coin::from_balance<LOFI12>(0x2::balance::split<LOFI12>(&mut v3, arg3 - v4), arg5), arg4);
            0x2::balance::destroy_zero<LOFI12>(v3);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI12>>(0x2::coin::from_balance<LOFI12>(v3, arg5), arg4);
        };
    }
