module 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::offer_item {
    ...
    public entry fun accept_offer_nft<T0: store + key>(arg0: &mut 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::marketplace::MarketplaceConfig, arg1: &mut 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::creator_bluemove_fee::RoyaltyCollection, arg2: &mut 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::marketplace::CreatorConfig, arg3: &mut OfferData, arg4: u64, arg5: T0, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v7 == 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::utils::get_token_name<T0>(), 1);
        let v9 = if (0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::creator_bluemove_fee::check_exists_royalty_collection<T0>(arg1, arg6)) {
            let (v10, v11, v12, v13) = 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::creator_bluemove_fee::caculate_royalty_collection<T0>(arg1, v5, &mut v8, arg6);
            assert!(v7 == v13, 1);
            0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::marketplace::add_creator_fee(arg2, v11, v10, arg6);
            v12
        } else {
            0
        };
        let v14 = v5 * 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::marketplace::get_market_fee(arg0, arg6) / 10000;
        0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::marketplace::add_market_fee(arg0, 0x2::coin::split<0x2::sui::SUI>(&mut v8, v14, arg6), arg6);
    ...
    public entry fun accept_offer_nft_standard<T0: store + key>(arg0: &mut 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::marketplace::MarketplaceConfig, arg1: &mut 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::marketplace::CreatorConfig, arg2: &mut OfferData, arg3: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::BpsRoyaltyStrategy<T0>, arg4: u64, arg5: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<T0>, arg6: T0, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::utils::get_token_name<T0>() == v7, 3);
        ...
        let v10 = v5 * 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::marketplace::get_market_fee(arg0, arg7) / 10000;
        ...
        0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::marketplace::add_market_fee(arg0, 0x2::coin::split<0x2::sui::SUI>(&mut v8, v10, arg7), arg7);
        if (0x1::vector::length<address>(&v9) > 0 && 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::has_domain<T0, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::creators::Creators>(arg5) && v11 > 0) {
            ...
            while (v14 < v13) {
                0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::marketplace::add_creator_fee(arg1, 0x2::coin::split<0x2::sui::SUI>(&mut v15, v11 / v13, arg7), 0x1::vector::pop_back<address>(&mut v9), arg7);
                v14 = v14 + 1;
            };
