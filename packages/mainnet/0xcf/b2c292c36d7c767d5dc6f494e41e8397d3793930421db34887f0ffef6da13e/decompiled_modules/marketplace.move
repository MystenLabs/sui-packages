module 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::marketplace {
    ...
    public fun buy<T0: store + key, T1>(arg0: &mut MarketplaceConfig, arg1: &mut 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::creator_bluemove_fee::RoyaltyCollection, arg2: &mut CreatorConfig, arg3: 0x2::object::ID, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : T0 {
        let Listing {
            id       : v0,
            amount   : v1,
            owner    : v2,
        ...
        assert!(arg5 == v1, 0);
        let v6 = if (0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::creator_bluemove_fee::check_exists_royalty_collection<T1>(arg1, arg6)) {
            let (v7, v8, v9, v10) = 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::creator_bluemove_fee::caculate_royalty_collection<T0>(arg1, v1, &mut v5, arg6);
            assert!(v10 == v3, 4);
    ...
    public entry fun buy_and_take<T0: store + key, T1>(arg0: &mut MarketplaceConfig, arg1: &mut 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::creator_bluemove_fee::RoyaltyCollection, arg2: &mut CreatorConfig, arg3: 0x2::object::ID, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun list<T0: store + key, T1>(arg0: &mut MarketplaceConfig, arg1: T0, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Listing{
            ...
            nft_type : 0xcfb2c292c36d7c767d5dc6f494e41e8397d3793930421db34887f0ffef6da13e::utils::get_token_name<T1>(),
        };
