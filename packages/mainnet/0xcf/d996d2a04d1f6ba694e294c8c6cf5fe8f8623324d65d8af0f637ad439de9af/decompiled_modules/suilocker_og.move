module 0xcfd996d2a04d1f6ba694e294c8c6cf5fe8f8623324d65d8af0f637ad439de9af::suilocker_og {
    struct SUILOCKER_OG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUILOCKER_OG, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUILOCKER_OG>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SuiLocker OG"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"From the unfathomable depths of the Sui blockchain, a brood of Krakens was born. For eons, they have lived with a single, relentless imperative echoing in their consciousness: Find me more treasure. This changed when the Prime Kraken, SX, heard sailors whispering the legend of Davey Jones's Locker. In that moment, a grand scheme was forged. Now, a new whisper travels the chain, a directive that rings in the mind of every sailor on Sui: Send it to the SuiLocker."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeigpqvim3rj5ixywfuyycygkjsbaq33hbt4rztq7d6dumhn7l3tgme"));
