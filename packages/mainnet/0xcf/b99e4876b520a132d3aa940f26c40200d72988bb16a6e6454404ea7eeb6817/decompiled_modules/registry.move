module 0x46ba3f0a9faffeb5e8badb6f6e6c2a42ead0194428034659241c634e977cc5d0::registry {
    ...
    public fun admin_migrate<T0>(arg0: &mut MarketRegistry<T0>, arg1: &0x46ba3f0a9faffeb5e8badb6f6e6c2a42ead0194428034659241c634e977cc5d0::admin::AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = arg0.version;
        assert!(v0 < 4, 27);
        arg0.min_liquidity = 10000000;
        arg0.version = 4;
        0x46ba3f0a9faffeb5e8badb6f6e6c2a42ead0194428034659241c634e977cc5d0::events::emit_migrated(v0, 4);
    }
    ...
    public fun admin_update_min_liquidity<T0>(arg0: &mut MarketRegistry<T0>, arg1: &0x46ba3f0a9faffeb5e8badb6f6e6c2a42ead0194428034659241c634e977cc5d0::admin::AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 4, 24);
        assert!(arg2 > 0, 17);
        arg0.min_liquidity = arg2;
    }
    ...
    public fun min_liquidity<T0>(arg0: &MarketRegistry<T0>) : u64 {
        arg0.min_liquidity
    }
