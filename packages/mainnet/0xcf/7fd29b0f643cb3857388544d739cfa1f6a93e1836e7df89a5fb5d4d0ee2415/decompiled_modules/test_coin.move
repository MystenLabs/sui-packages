module 0xcf7fd29b0f643cb3857388544d739cfa1f6a93e1836e7df89a5fb5d4d0ee2415::test_coin {
    ...
    fun init(arg0: TEST_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST_COIN>(arg0, 6, b"dying2", b"didthis", b"Template Coin Description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"http://cc.com"))), arg1);
