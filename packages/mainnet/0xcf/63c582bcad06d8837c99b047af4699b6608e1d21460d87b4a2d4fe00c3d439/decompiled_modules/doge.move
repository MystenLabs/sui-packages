module 0xcf63c582bcad06d8837c99b047af4699b6608e1d21460d87b4a2d4fe00c3d439::doge {
    struct DOGE has drop {
        dummy_field: bool,
    }

    fun init(arg0: DOGE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/RmaeJuANnZ6H04Tx6OaPLwIAxEdUHulH5UVd4__jyCc";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/RmaeJuANnZ6H04Tx6OaPLwIAxEdUHulH5UVd4__jyCc"))
        };
