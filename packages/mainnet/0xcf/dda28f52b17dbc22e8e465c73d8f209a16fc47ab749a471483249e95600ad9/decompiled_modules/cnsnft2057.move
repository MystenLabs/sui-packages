module 0xcfdda28f52b17dbc22e8e465c73d8f209a16fc47ab749a471483249e95600ad9::cnsnft2057 {
    struct CNSNFT2057 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2057, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2057>(arg0, arg1);
