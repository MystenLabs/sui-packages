module 0xcf30f9b3847808e51f0f1140be8ebd33de9e4b5df3e2669e79f9c9b2270e5a59::kiosk_swap {
    ...
    public fun cancel_shared_kiosk_swap(arg0: &mut SwapProposal, arg1: &mut SharedKioskSwapEscrow, arg2: &mut ProtocolConfig, arg3: &mut ProtocolTreasury, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = if (0x2::clock::timestamp_ms(arg4) >= arg0.expires_at) {
            true
        } else {
        ...
        if (v4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.proposer_sui_balance, v4, arg5), arg0.proposer);
        };
        if (v5 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.counterparty_sui_balance, v5, arg5), *0x1::option::borrow<address>(&arg0.counterparty));
        };
        let v6 = arg0.protocol_fee_paid;
        if (v6 > 0) {
            let v7 = 0x2::balance::value<0x2::sui::SUI>(&arg3.balance);
            if (v7 >= v6) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg3.balance, v6, arg5), arg0.proposer);
                arg2.total_fees_collected = arg2.total_fees_collected - v6;
            } else if (v7 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg3.balance, v7, arg5), arg0.proposer);
                arg2.total_fees_collected = arg2.total_fees_collected - v7;
            };
        };
        arg0.state = 4;
        let v8 = SwapCancelled{
            proposal_id  : 0x2::object::id<SwapProposal>(arg0),
            cancelled_by : v0,
        };
        0x2::event::emit<SwapCancelled>(v8);
    }

    public fun cancel_swap(arg0: &mut SwapProposal, arg1: &mut SwapEscrow, arg2: &mut ProtocolConfig, arg3: &mut ProtocolTreasury, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = if (0x2::clock::timestamp_ms(arg4) >= arg0.expires_at) {
            true
        } else {
        ...
        if (0x1::option::is_some<0x2::kiosk::Kiosk>(&arg1.proposer_kiosk)) {
            ...
            let v6 = 0x2::kiosk::withdraw(&mut v4, &v5, 0x1::option::none<u64>(), arg5);
        ...
        if (0x1::option::is_some<0x2::kiosk::Kiosk>(&arg1.counterparty_kiosk)) {
            ...
            let v10 = 0x2::kiosk::withdraw(&mut v7, &v8, 0x1::option::none<u64>(), arg5);
        ...
        if (v11 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.proposer_sui_balance, v11, arg5), arg0.proposer);
        };
        if (v12 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.counterparty_sui_balance, v12, arg5), *0x1::option::borrow<address>(&arg0.counterparty));
        };
        let v13 = arg0.protocol_fee_paid;
        if (v13 > 0) {
            let v14 = 0x2::balance::value<0x2::sui::SUI>(&arg3.balance);
            if (v14 >= v13) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg3.balance, v13, arg5), arg0.proposer);
                arg2.total_fees_collected = arg2.total_fees_collected - v13;
            } else if (v14 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg3.balance, v14, arg5), arg0.proposer);
                arg2.total_fees_collected = arg2.total_fees_collected - v14;
            };
        };
        arg0.state = 4;
        let v15 = SwapCancelled{
            proposal_id  : 0x2::object::id<SwapProposal>(arg0),
            cancelled_by : v0,
        };
        0x2::event::emit<SwapCancelled>(v15);
    }
