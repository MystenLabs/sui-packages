module 0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol {
    ...
    public entry fun claim(arg0: &mut AifrensLolPool, arg1: &0x2::clock::Clock, arg2: vector<vector<u8>>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::merkle_tree::verify_calldata(arg2, arg0.root_proof, 0x1::bcs::to_bytes<address>(&v1)), 3);
        mint_token(arg1, 0x2::table::length<address, bool>(&arg0.claimed), arg0.name, arg3);
    }

    public entry fun beta_claim(arg0: &mut BetaLolPool, arg1: &0x2::clock::Clock, arg2: &0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::AifrensGenesis, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg1);
        assert!(!arg0.has_paused, 4);
        assert!(v0 > arg0.launched_at_ms, 5);
        assert!(v0 < arg0.expired_at_ms, 6);
        let v1 = 0x2::object::id<0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::AifrensGenesis>(arg2);
    ...
    fun init(arg0: AIFRENS_LOL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = AifrensLolPool{
            ...
            has_paused     : false,
            launched_at_ms : 1684155600000,
            expired_at_ms  : 1684155600000 + 4 * 3600000,
