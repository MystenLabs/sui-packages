module 0xcfd5acc45bcca35a8d2c9c393af9cc89f466d9e01361b900f8dd2674a8a311e2::cnsnft5694 {
    struct CNSNFT5694 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5694, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5694>(arg0, arg1);
