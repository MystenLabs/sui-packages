module 0xcff88a8ba8f17aa0f39f55a7bcf6dff06d42af84d42c4c7a8a29c22f9e160f4c::swapper {
    ...
    public entry fun swap_coin_to_sui<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &mut 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x2::coin::zero<0x2::sui::SUI>(arg5);
        let v1 = &mut v0;
        let v2 = swap<T0, 0x2::sui::SUI>(arg0, arg1, arg2, v1, true, true, arg3, arg4, arg5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v0, 0x2::tx_context::sender(arg5));
        v2
    }

    public entry fun swap_sui_to_coin<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x2::coin::zero<T0>(arg5);
        let v1 = &mut v0;
        let v2 = swap<T0, 0x2::sui::SUI>(arg0, arg1, v1, arg2, false, true, arg3, arg4, arg5);
