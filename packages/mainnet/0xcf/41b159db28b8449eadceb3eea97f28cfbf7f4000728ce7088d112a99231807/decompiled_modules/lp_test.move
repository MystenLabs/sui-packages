module 0xcf41b159db28b8449eadceb3eea97f28cfbf7f4000728ce7088d112a99231807::lp_test {
    struct LP_TEST has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LP_TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<LP_TEST>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Lp test"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"LP test, don't trade it"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiflln7kerfrqpd6vczaf32txvn3vb5tjzpomwk7medapcbbypqxwi"));
