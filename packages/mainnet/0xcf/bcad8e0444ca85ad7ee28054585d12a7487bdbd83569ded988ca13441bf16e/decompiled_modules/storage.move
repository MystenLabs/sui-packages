module 0xcfbcad8e0444ca85ad7ee28054585d12a7487bdbd83569ded988ca13441bf16e::storage {
    ...
    fun get_or_add_validator_index_by_staking_pool_id_mut(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0;
        while (v0 < 0x1::vector::length<ValidatorInfo>(&arg0.validator_infos)) {
            if (0x1::vector::borrow<ValidatorInfo>(&arg0.validator_infos, v0).staking_pool_id == arg2) {
                return v0
            };
            v0 = v0 + 1;
        };
        let v1 = 0x3::sui_system::validator_address_by_pool_id(arg1, &arg2);
        let v2 = 0x3::sui_system::active_validator_addresses(arg1);
        assert!(0x1::vector::contains<address>(&v2, &v1), 1);
        let v3 = ValidatorInfo{
        ...
        0x1::vector::push_back<ValidatorInfo>(&mut arg0.validator_infos, v3);
        assert!(0x1::vector::length<ValidatorInfo>(&arg0.validator_infos) <= 50, 0);
        v0
    }
    ...
    public(friend) fun refresh(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) : bool {
        ...
        while (v1 > 0) {
            ...
            0x1::vector::borrow_mut<ValidatorInfo>(&mut arg0.validator_infos, v1).exchange_rate = *0x2::table::borrow<u64, 0x3::staking_pool::PoolTokenExchangeRate>(0x3::sui_system::pool_exchange_rates(arg1, &0x1::vector::borrow<ValidatorInfo>(&arg0.validator_infos, v1).staking_pool_id), 0x2::tx_context::epoch(arg2));
            ...
            if (0x1::option::is_some<0x3::staking_pool::StakedSui>(&0x1::vector::borrow<ValidatorInfo>(&arg0.validator_infos, v1).inactive_stake)) {
                let v9 = take_from_inactive_stake(arg0, v1);
                join_fungible_staked_sui_to_validator(arg0, v1, 0x3::sui_system::convert_to_fungible_staked_sui(arg1, v9, arg2));
            };
        };
