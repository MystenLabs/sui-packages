module 0xcf0681021151eb56c22497cadc3313fe69f963898f798694b590fd9e6a7a421e::suitempleton {
    ...
    fun init(arg0: SUITEMPLETON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::mint_and_transfer<SUITEMPLETON>(&mut v0, 1000000000000000, 0x2::tx_context::sender(arg1), arg1);
