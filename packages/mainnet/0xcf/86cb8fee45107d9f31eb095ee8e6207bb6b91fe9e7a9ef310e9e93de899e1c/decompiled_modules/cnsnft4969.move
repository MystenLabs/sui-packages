module 0xcf86cb8fee45107d9f31eb095ee8e6207bb6b91fe9e7a9ef310e9e93de899e1c::cnsnft4969 {
    struct CNSNFT4969 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4969, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4969>(arg0, arg1);
