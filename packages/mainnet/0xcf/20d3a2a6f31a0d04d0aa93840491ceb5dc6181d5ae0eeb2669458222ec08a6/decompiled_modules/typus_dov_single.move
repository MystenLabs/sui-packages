module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single {
    ...
    public(friend) fun activate_<T0, T1, T2>(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        assert!(0x2::clock::timestamp_ms(arg4) >= v1.info.activation_ts_ms, 13906845891019997274);
        assert!(v1.info.status % 5 == 0, 13906845895310901276);
        ...
        let (v5, v6) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::get_price(arg2, arg4);
        let (_, v8, _, _) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::get_token(arg2);
        ...
        let v11 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::activate<T0>(v3, v1.config.has_next, arg5);
        ...
        while (v14 > 0) {
            ...
            let v16 = calculate_strike(v5, v15.strike_bp, v12);
        ...
        let v19 = v18;
        if (0x2::object::id<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg2) != 0x2::object::id<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3)) {
            let (v20, v21) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::get_price(arg3, arg4);
            let (_, _, v24, _) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::get_token(arg3);
            assert!(v1.info.deposit_token == v24, 13906846079995543596);
            v19 = (((v18 as u128) * (v20 as u128) / (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(v21) as u128)) as u64);
        };
        let v26 = calculate_max_auction_size(v1.info.o_token_decimal, v1.config.leverage, v19, calculate_max_loss_per_unit(v1.info.option_type, v5, v6, v1.info.d_token_decimal, v1.info.o_token_decimal, v1.config.active_vault_config.payoff_configs, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(2)), v1.config.bid_lot_size);
        let v27 = OracleInfo{
            price   : v5,
            decimal : v6,
        };
        v1.info.oracle_info = v27;
        let v28 = DeliveryInfos{
            round                     : v1.info.round,
            max_size                  : v26,
        ...
        v1.info.delivery_infos = v28;
        let v29 = v1.info.settlement_base_name;
        let (v30, v31, v32) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_date_from_ts(v1.info.expiration_ts_ms / 1000);
        ...
        if (v1.info.period == 3 || v1.info.period == 4) {
            0x1::string::append_utf8(&mut v29, b"-");
            0x1::string::append_utf8(&mut v29, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_pad_2_number_string(v1.info.expiration_ts_ms % 86400000 / 3600000));
            0x1::string::append_utf8(&mut v29, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_pad_2_number_string(v1.info.expiration_ts_ms % 3600000 / 60000));
        } else {
            0x1::vector::reverse<u64>(&mut v13);
            while (!0x1::vector::is_empty<u64>(&v13)) {
                0x1::string::append_utf8(&mut v29, b"-");
                0x1::string::append_utf8(&mut v29, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::u64_to_bytes(0x1::vector::pop_back<u64>(&mut v13), v6));
            };
        };
        if (v1.info.option_type == 0) {
            ...
            if (0x1::ascii::into_bytes(v8) == b"USDT") {
                0x1::string::append_utf8(&mut v29, b"-UsdtCappedCall");
            } else if (0x1::ascii::into_bytes(v8) == b"USDC") {
                0x1::string::append_utf8(&mut v29, b"-UsdcCappedCall");
            } else {
                0x1::string::append_utf8(&mut v29, b"-UsdCappedCall");
            };
        };
        let v33 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::new_bid_vault<T0, T1>(v1.info.index, v29, arg5);
        let v34 = 0;
        let v35 = 0;
        if (v26 == 0 || 0x2::clock::timestamp_ms(arg4) >= v1.info.expiration_ts_ms) {
            v1.info.status = 4;
            ...
            let v36 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::active_share_supply(v3) + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::deactivating_share_supply(v3);
            if (v36 > 0) {
                let v37 = &mut arg0.id;
                let v38 = &mut v33;
                let (v39, v40) = vault_delivery_<T0, T1, T2>(v37, v1, v3, v38, 0x2::balance::zero<T1>(), arg5);
                v35 = v39;
                v34 = v40;
                let (_, _) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::recoup<T0>(v3, v36, arg5);
            };
        ...
        0x2::dynamic_object_field::add<u64, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::BidVault>(&mut arg0.bid_vault_registry, arg1, v33);
        (v11, v26, v35, v34, v18)
    }
    ...
    public(friend) fun airdrop_otc_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: 0x2::balance::Balance<T1>, arg4: 0x2::balance::Balance<T1>, arg5: vector<address>, arg6: vector<u64>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(!auction_exists(&arg0.auction_registry, arg1), 13906848974802059286);
        assert!(v1.info.status == 1 || v1.info.status == 3, 13906848979097419804);
        assert!(0x1::vector::length<address>(&arg5) == 0x1::vector::length<u64>(&arg6), 13906848983393828914);
        let v6 = 0;
        ...
        assert!(v1.info.delivery_infos.total_delivery_size <= v1.info.delivery_infos.max_size, 13906849150899650642);
    ...
    public(friend) fun borrow_navi_<T0>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::config::OracleConfig, arg4: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg5: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg6: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg7: address, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg9: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg10: u8, arg11: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg12: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg13: &mut 0x3::sui_system::SuiSystemState, arg14: u64, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) : vector<u64> {
        let v0 = &mut arg0.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg1);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v1.info.u64_padding, 0) == 4, 13906840006914670680);
    ...
    public(friend) fun calculate_in_usd<T0>(arg0: &PortfolioVault, arg1: u64, arg2: bool) : u64 {
        let v0 = if (0x1::type_name::with_defining_ids<T0>() == arg0.info.deposit_token) {
            ...
            assert!(0x1::type_name::with_defining_ids<T0>() == arg0.info.bid_token, 13906853209642827844);
    ...
    public(friend) fun calculate_in_usd_with_decimal<T0>(arg0: &PortfolioVault, arg1: u64) : u64 {
        let v0 = if (0x1::type_name::with_defining_ids<T0>() == arg0.info.deposit_token) {
            ...
            assert!(0x1::type_name::with_defining_ids<T0>() == arg0.info.bid_token, 13906853377146552388);
            arg0.info.b_token_decimal
        };
        if (0x1::type_name::with_defining_ids<T0>() != arg0.info.settlement_base && 0x1::type_name::with_defining_ids<T0>() != 0x1::type_name::with_defining_ids<0x2::sui::SUI>()) {
    ...
    public(friend) fun calculate_max_loss_per_unit(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: vector<PayoffConfig>, arg6: u64) : u64 {
        ...
        while (v3 < 0x1::vector::length<PayoffConfig>(&arg5)) {
            ...
            assert!(0x1::option::is_some<u64>(&v4.strike), 13906852573989634146);
        ...
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::i64::is_neg(&v6), 13906852689950736436);
        ...
        assert!(v9 > 0, 13906852698540671028);
        v9
    }
    ...
    public(friend) fun calculate_option_payoff(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        if (arg0 % 2 == 0 && arg0 != 6) {
            ...
            assert!(arg0 == 6, 13906853136627728442);
            if (arg1 >= arg3) {
                arg1 - arg3
            } else {
                0
    ...
    fun calculate_payoff_for_active_bid_receipt_v2(arg0: &Registry, arg1: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt, arg4: &0x2::clock::Clock) : u64 {
        let (v0, v1, v2) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_receipt_info(arg3);
        let v3 = v2;
        ...
        let (v6, v7) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::get_price(arg1, arg4);
        ...
        if (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::i64::is_neg(&v8)) {
            ...
            if (0x2::object::id<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg1) == 0x2::object::id<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg2)) {
                0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::i64::as_u64(&v10)
            } else {
                let (_, _, v13, _) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::get_token(arg2);
                assert!(v5.info.deposit_token == v13, 13906854446591836204);
                let (v15, v16) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::get_price(arg2, arg4);
                (((0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::i64::as_u64(&v10) as u128) * (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(v16) as u128) / (v15 as u128)) as u64)
            }
        } else {
            0
        }
    ...
    public(friend) fun calculate_portfolio_payoff_by_price(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: vector<PayoffConfig>, arg5: u64, arg6: u64, arg7: u64) : 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::i64::I64 {
        ...
        while (!0x1::vector::is_empty<PayoffConfig>(&arg4)) {
            ...
            assert!(0x1::option::is_some<u64>(&v1.strike), 13906852784443031650);
    ...
    public(friend) fun create_payoff_configs(arg0: vector<u64>, arg1: vector<u64>, arg2: vector<bool>) : vector<PayoffConfig> {
        assert!(0x1::vector::length<u64>(&arg0) > 0, 13906853484520341566);
        assert!(0x1::vector::length<u64>(&arg0) == 0x1::vector::length<u64>(&arg1), 13906853488815308862);
        assert!(0x1::vector::length<u64>(&arg1) == 0x1::vector::length<bool>(&arg2), 13906853493110276158);
    ...
    public(friend) fun delivery_<T0, T1, T2>(arg0: &mut Registry, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(v1.info.status == 2, 13906846938987954204);
    ...
    public(friend) fun deposit_collateral_navi_<T0>(arg0: &mut Registry, arg1: u64, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: u8, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: 0x2::balance::Balance<T0>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(v0.info.status != 5, 13906839504399564828);
    ...
    public(friend) fun deposit_from_lending_<T0>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T0>) : vector<u64> {
        ...
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v2.info.u64_padding, 0) == arg2, 13906842274657402968);
    ...
    public(friend) fun deposit_hybrid_navi_<T0>(arg0: &mut Registry, arg1: u64, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: u8, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(v0.info.status != 5, 13906837855132123164);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v0.info.u64_padding, 0) == 7, 13906837859431022680);
        let v2 = &mut arg0.deposit_vault_registry;
    ...
    public(friend) fun deposit_navi_<T0>(arg0: &mut Registry, arg1: u64, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: u8, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(v0.info.status != 5, 13906837472880033820);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v0.info.u64_padding, 0) == 4, 13906837477178933336);
        let v2 = &mut arg0.deposit_vault_registry;
        let v3 = get_mut_deposit_vault(v2, arg1);
    ...
    public(friend) fun deposit_scallop_basic_lending_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(v0.info.status != 5, 13906836996138663964);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v0.info.u64_padding, 0) == 2, 13906837000438087776);
        let v2 = &mut arg0.deposit_vault_registry;
        let v3 = get_mut_deposit_vault(v2, arg1);
        let v4 = &mut arg0.additional_config_registry;
    ...
    public(friend) fun deposit_shared_navi_<T0>(arg0: &mut Registry, arg1: u64, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: u8, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(v0.info.status != 5, 13906837666153562140);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v0.info.u64_padding, 0) == 6, 13906837670452461656);
        let v2 = &mut arg0.deposit_vault_registry;
        let v3 = get_mut_deposit_vault(v2, arg1);
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"navi_account_cap")) {
            0x2::dynamic_field::add<vector<u8>, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap>(&mut arg0.id, b"navi_account_cap", 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::create_account(arg8));
    ...
    public(friend) fun get_auction(arg0: &0x2::object::UID, arg1: u64) : &0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::Auction {
        assert!(auction_exists(arg0, arg1), 13906852084358512664);
    ...
    public fun get_bid_receipt_intrinsic_value_v2<T0>(arg0: &Registry, arg1: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt, arg4: &0x2::clock::Clock) : u64 {
        if (!check_bid_receipt_expired(arg0, arg3)) {
            calculate_payoff_for_active_bid_receipt_v2(arg0, arg1, arg2, arg3, arg4)
        } else {
            let (v1, _, _) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_receipt_info(arg3);
            let v4 = v1;
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::calculate_exercise_value<T0>(get_bid_vault_by_id(&arg0.bid_vault_registry, &v4), arg3)
        }
    }
    ...
    public(friend) fun get_mut_auction(arg0: &mut 0x2::object::UID, arg1: u64) : &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::Auction {
        assert!(auction_exists(arg0, arg1), 13906852123013218328);
    ...
    public(friend) fun lending_cap_key(arg0: u64) : vector<u8> {
        if (arg0 == 5) {
            ...
            assert!(arg0 == 1, 13906841875224395848);
    ...
    public(friend) fun new_auction_<T0>(arg0: &mut Registry, arg1: u64, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        assert!(!auction_exists(&arg0.auction_registry, arg1), 13906846681289523222);
        assert!(v1.info.status == 1 || v1.info.status == 3, 13906846685584883740);
        let v2 = v1.info.activation_ts_ms + 0x1::option::get_with_default<u64>(&arg2, v1.config.auction_delay_ts_ms);
        assert!(v2 < v1.info.expiration_ts_ms, 13906846702765015072);
    ...
    public(friend) fun new_portfolio_vault_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: bool, arg26: vector<PayoffConfig>, arg27: u64, arg28: u64, arg29: u64, arg30: u64, arg31: vector<address>, arg32: &0x2::clock::Clock, arg33: &mut 0x2::tx_context::TxContext) : (u64, Info, Config) {
        ...
        assert!(arg6 >= v1, 13906843584618627102);
        assert!(arg7 > arg6, 13906843588914642990);
        validate_dutch_auction_settings(arg29, arg30, arg20);
        if (arg2 == 0) {
            assert!(arg7 - arg6 == 86400000, 13906843618979414062);
        } else if (arg2 == 1) {
            assert!(arg7 - arg6 == 604800000, 13906843627569348654);
        } else if (arg2 == 2) {
            assert!(arg7 - arg6 == 2419200000 || arg7 - arg6 == 3024000000, 13906843640454250542);
        } else if (arg2 == 3) {
            assert!(arg7 - arg6 == 3600000, 13906843649044185134);
        } else {
            assert!(arg2 == 4, 13906843666225233984);
            assert!(arg7 - arg6 == 600000, 13906843657634119726);
        };
        assert!(arg9 > 0, 13906843674813726762);
        assert!(arg11 >= arg9, 13906843679109611576);
        assert!(arg10 > 0, 13906843683403399206);
        assert!(arg12 >= arg10, 13906843687699415094);
        ...
        if (!0x2::dynamic_object_field::exists_with_type<0x1::type_name::TypeName, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::RefundVault>(&arg0.refund_vault_registry, 0x1::type_name::with_defining_ids<T1>())) {
            0x2::dynamic_object_field::add<0x1::type_name::TypeName, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::RefundVault>(&mut arg0.refund_vault_registry, 0x1::type_name::with_defining_ids<T1>(), 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::new_refund_vault<T1>(arg33));
        };
    ...
    public(friend) fun operation_check(arg0: &Registry) {
        assert!(!arg0.transaction_suspended, 13906855120905633896);
    }
    ...
    public(friend) fun oracle_check(arg0: &Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle) {
        assert!(get_portfolio_vault(&arg0.portfolio_vault_registry, arg1).config.oracle_id == 0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg2), 13906855163852423228);
    }
    ...
    public(friend) fun otc_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: 0x1::option::Option<u64>, arg3: u64, arg4: u64, arg5: 0x2::balance::Balance<T1>, arg6: 0x2::balance::Balance<T1>, arg7: 0x2::balance::Balance<T1>, arg8: 0x2::balance::Balance<T1>, arg9: 0x2::balance::Balance<T1>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = &mut arg0.bid_vault_registry;
        let v5 = get_mut_bid_vault(v4, arg1);
        assert!(!auction_exists(&arg0.auction_registry, arg1), 13906848206002913302);
        assert!(v1.info.status == 1 || v1.info.status == 3, 13906848210298273820);
        assert!(0x1::option::is_none<u64>(&arg2) || 0x1::option::some<u64>(v1.info.round) == arg2, 13906848214595731522);
        assert!((((arg3 as u128) * (arg4 as u128) / (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(v1.info.o_token_decimal) as u128)) as u64) <= 0x2::balance::value<T1>(&arg5) + 0x2::balance::value<T1>(&arg7), 13906848227478011930);
        assert!(v1.info.delivery_infos.total_delivery_size + arg4 <= v1.info.delivery_infos.max_size, 13906848236071616594);
    ...
    public(friend) fun portfolio_vault_token_check<T0, T1>(arg0: &Registry, arg1: u64) {
        let v0 = get_portfolio_vault(&arg0.portfolio_vault_registry, arg1);
        assert!(0x1::type_name::with_defining_ids<T0>() == v0.info.deposit_token, 13906855202506080300);
        assert!(0x1::type_name::with_defining_ids<T1>() == v0.info.bid_token, 13906855206800785448);
    }
    ...
    public(friend) fun post_repay_navi_interest_<T0>(arg0: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::config::OracleConfig, arg4: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg5: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg6: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg7: address, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg9: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg10: u8, arg11: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg12: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg13: 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::witness_lock::HotPotato<0x2::balance::Balance<T0>>, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v1.info.u64_padding, 0) == 4, 13906841510153224280);
    ...
    public(friend) fun pre_repay_navi_interest_<T0, T1, T2>(arg0: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::witness_lock::HotPotato<0x2::balance::Balance<T2>>, vector<u64>) {
        let v0 = &mut arg1.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg2);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v1.info.u64_padding, 0) == 4, 13906841196620611672);
        let v2 = &mut arg1.additional_config_registry;
    ...
    public(friend) fun public_safu_otc_v2_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: 0x2::balance::Balance<T1>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>, vector<u64>) {
        ...
        let v4 = &mut arg0.bid_vault_registry;
        let v5 = get_mut_bid_vault(v4, arg1);
        assert!(!auction_exists(&arg0.auction_registry, arg1), 13906848583960035350);
        ...
        assert!(v6, 13906848588255395868);
        if (v1.info.status == 4) {
    ...
    public(friend) fun recoup_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) : (u64, u64) {
        ...
        assert!(0x2::clock::timestamp_ms(arg2) >= v1.info.activation_ts_ms + v1.config.recoup_delay_ts_ms, 13906849614756905054);
        assert!(v1.info.status == 3, 13906849619047546908);
        v1.info.status = 4;
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v1.info.u64_padding, 0) == 0, 13906849627640496202);
    ...
    public(friend) fun repay_navi_interest_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::config::OracleConfig, arg4: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg5: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg6: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg7: address, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg9: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg10: u8, arg11: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg12: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg13: u64, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) : vector<u64> {
        let v0 = &mut arg0.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg1);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v1.info.u64_padding, 0) == 4, 13906840702699372632);
        let v2 = &mut arg0.additional_config_registry;
        let v3 = get_mut_additional_config(v2, arg1);
        0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle_pro::update_single_price(arg14, arg3, arg4, arg5, arg6, arg7);
        let v4 = &mut arg0.deposit_vault_registry;
    ...
    public(friend) fun resume_transaction_(arg0: &mut Registry) {
        assert!(arg0.transaction_suspended, 13906836192984498276);
    ...
    public(friend) fun return_lending_account_cap_<T0: store + key>(arg0: &mut Registry, arg1: T0, arg2: LendingCapHotPotato) {
        ...
        assert!(v2 == 0x2::object::id_address<T0>(&arg1), 13906842132917780479);
    ...
    public(friend) fun settle_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, vector<u64>) {
        let v0 = &mut arg0.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg1);
        let v2 = &mut arg0.deposit_vault_registry;
        let v3 = get_mut_deposit_vault(v2, arg1);
        ...
        let (v7, v8) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::get_price(arg2, arg4);
        let v9 = calculate_portfolio_payoff_by_price(v1.info.option_type, v7, v8, v1.info.d_token_decimal, v1.config.active_vault_config.payoff_configs, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(2), v1.info.delivery_infos.total_delivery_size, v1.info.o_token_decimal);
        if (0x2::object::id<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg2) != 0x2::object::id<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg3)) {
            let (_, _, v12, _) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::get_token(arg3);
            assert!(v1.info.deposit_token == v12, 13906849881041600556);
            let (v14, v15) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::get_price(arg3, arg4);
            let v16 = v9;
            v9 = i64_mul_div(v16, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(v15), v14);
        };
        let v17 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::active_balance<T0>(v3) + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::deactivating_balance<T0>(v3);
        let v18 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::i64::from(v17);
        let v19 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::i64::add(&v18, &v9);
        let v20 = if (v17 != 0) {
            (((0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(8) as u128) * (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::i64::as_u64(&v19) as u128) / (v17 as u128)) as u64)
        } else {
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(8)
        };
        let v21 = 8;
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::settle<T0, T1>(v3, v5, v20, v21, arg5);
        let v22 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::active_balance<T0>(v3) + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::inactive_balance<T0>(v3) - 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::inactive_balance<T0>(v3);
        let v23 = SettlementInfo{
            round                : v1.info.round,
            oracle_price         : v7,
            ...
            settled_balance      : v22,
            share_price          : v20,
            share_price_decimal  : v21,
            ts_ms                : v6,
            u64_padding          : 0x1::vector::empty<u64>(),
        };
        v1.info.settlement_info = 0x1::option::some<SettlementInfo>(v23);
        update_portfolio_vault_activation_expiration_time(v1);
        let v24 = vector[];
        while (v6 >= v1.info.expiration_ts_ms) {
            v1.info.round = v1.info.round + 1;
            0x1::vector::push_back<u64>(&mut v24, v1.info.round);
            update_portfolio_vault_activation_expiration_time(v1);
        };
        let v25 = 0x2::dynamic_object_field::remove<u64, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::BidVault>(&mut arg0.bid_vault_registry, arg1);
        if (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::length<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::BidShare>(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_shares(&v25)) == 0) {
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::drop_bid_vault<T0>(v25);
        } else {
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::set_bid_vault_u64_padding_value(&mut v25, 0, v7);
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::set_bid_vault_u64_padding_value(&mut v25, 1, 0x1::vector::borrow<DeliveryInfo>(&v1.info.delivery_infos.delivery_info, 0).delivery_price);
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::set_bid_vault_u64_padding_value(&mut v25, 2, v1.config.bid_incentive_bp);
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::set_bid_vault_u64_padding_value(&mut v25, 3, v1.info.round);
            0x2::dynamic_object_field::add<address, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::BidVault>(&mut arg0.bid_vault_registry, 0x2::object::id_address<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::BidVault>(&v25), v25);
        };
        (v7, v8, v17, v22, v20, v24)
    }
    ...
    public(friend) fun skip_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, vector<u64>) {
        ...
        assert!(v6 >= v1.info.expiration_ts_ms, 13906850370671018076);
        assert!(v1.info.status == 3 || v1.info.status == 4, 13906850374961791004);
        v1.info.status = 5;
        let v7 = 0;
        let v8 = 0;
    ...
    public(friend) fun suspend_transaction_(arg0: &mut Registry) {
        assert!(!arg0.transaction_suspended, 13906836154329923686);
    ...
    public(friend) fun take_auction(arg0: &mut 0x2::object::UID, arg1: u64) : 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::Auction {
        assert!(auction_exists(arg0, arg1), 13906852161667923992);
    ...
    public(friend) fun unsubscribe_navi_<T0, T1, T2>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : vector<u64> {
        let v0 = &mut arg0.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg1);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v1.info.u64_padding, 0) == 4, 13906840509425844312);
        let v2 = &mut arg0.additional_config_registry;
        let v3 = get_mut_additional_config(v2, arg1);
        let v4 = &mut arg0.deposit_vault_registry;
        let v5 = 0x1::vector::empty<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusDepositReceipt>();
    ...
    public(friend) fun update_oracle_(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle) {
        let v0 = &mut arg0.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg1);
        v1.config.oracle_id = 0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg2);
        let (_, v3, v4, v5) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::get_token(arg2);
        assert!(v4 == v1.info.settlement_base, 0);
        v1.info.settlement_quote = v5;
        v1.info.settlement_quote_name = 0x1::string::from_ascii(v3);
    }
    ...
    public(friend) fun validate_amount(arg0: u64) {
        assert!(arg0 > 0, 13906855382898770026);
    }
    ...
    public(friend) fun validate_bid(arg0: &PortfolioVault, arg1: &0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::Auction, arg2: u64) {
        ...
        assert!(arg0.config.max_bid_entry == 0 || 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::bid_index(arg1) < arg0.config.max_bid_entry, 13906855331357327438);
    }

    public(friend) fun validate_bid_amount(arg0: &PortfolioVault, arg1: u64) {
        assert!(arg1 >= arg0.config.bid_lot_size && arg1 % arg0.config.bid_lot_size == 0, 13906855357127000140);
        assert!(arg1 >= arg0.config.min_bid_size, 13906855361422622806);
    }

    public(friend) fun validate_capacity(arg0: &Registry, arg1: u64) {
        let v0 = get_portfolio_vault(&arg0.portfolio_vault_registry, arg1);
        let v1 = get_deposit_vault(&arg0.deposit_vault_registry, arg1);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::active_share_supply(v1) + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::warmup_share_supply(v1) <= v0.config.capacity, 13906855485976543316);
        let v2 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_deposit_shares(v1);
        assert!(v0.config.max_deposit_entry == 0 || 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::length<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::DepositShare>(v2) <= v0.config.max_deposit_entry, 13906855511746084944);
    }

    public(friend) fun validate_dutch_auction_settings(arg0: u64, arg1: u64, arg2: u64) {
        assert!(arg0 >= arg1 && arg1 > 0, 13906855421548888100);
        assert!(arg2 >= 60000, 13906855425843724322);
    }

    public(friend) fun validate_min_deposit_size(arg0: &PortfolioVault, arg1: u64) {
        assert!(arg1 >= arg0.config.min_deposit_size, 13906855301293080662);
    }
    ...
    public(friend) fun validate_registry_upgradability(arg0: &Registry, arg1: &0x2::tx_context::TxContext) {
        assert!(31 > arg0.version, 13906855228277588038);
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::authority::verify(&arg0.authority, arg1);
    }
    ...
    public fun verify_bid_receipt_collateral_trading_order_v2<T0, T1>(arg0: &Registry, arg1: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt, arg4: bool, arg5: &0x2::clock::Clock) : vector<u8> {
        let (v0, v1, _) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::get_bid_receipt_info(arg3);
        if (v0 != 0x2::object::id<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::BidVault>(get_bid_vault(&arg0.bid_vault_registry, v1))) {
        ...
        if (calculate_payoff_for_active_bid_receipt_v2(arg0, arg1, arg2, arg3, arg5) == 0) {
            return b"E_BID_RECEIPT_NOT_ITM"
        };
        if (0x1::type_name::with_defining_ids<T1>() != v3.info.settlement_base) {
        ...
        let v6 = v5 && !arg4 || (v4 == 1 || v4 == 5) && arg4;
        if (!v6) {
            return b"E_INVALID_ORDER_SIDE"
        };
        if (0x1::type_name::with_defining_ids<T0>() != v3.info.deposit_token) {
    ...
    public(friend) fun version_check(arg0: &Registry) {
        assert!(31 >= arg0.version, 13906855099428569158);
    }
    ...
    public(friend) fun withdraw_for_lending_<T0>(arg0: &mut Registry, arg1: u64, arg2: u64) : (0x2::balance::Balance<T0>, vector<u64>) {
        let v0 = get_portfolio_vault(&arg0.portfolio_vault_registry, arg1);
        assert!(v0.info.status == 2 || v0.info.status == 3, 13906842188754124828);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v0.info.u64_padding, 0) == arg2, 13906842193053024344);
        let v1 = &mut arg0.deposit_vault_registry;
    ...
    public(friend) fun withdraw_hybrid_navi_<T0>(arg0: &mut Registry, arg1: u64, arg2: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::config::OracleConfig, arg3: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg4: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: address, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg9: u8, arg10: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg11: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg12: &mut 0x3::sui_system::SuiSystemState, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v3.info.u64_padding, 0) == 7, 13906838782848991320);
    ...
    public(friend) fun withdraw_navi_<T0>(arg0: &mut Registry, arg1: u64, arg2: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::config::OracleConfig, arg3: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg4: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: address, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg9: u8, arg10: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg11: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg12: &mut 0x3::sui_system::SuiSystemState, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        let v1 = &mut arg0.portfolio_vault_registry;
        let v2 = get_mut_portfolio_vault(v1, arg1);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v2.info.u64_padding, 0) == 4, 13906838177258602584);
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::set_u64_padding_value(&mut v2.info.u64_padding, 0, 0);
        let v3 = &mut arg0.deposit_vault_registry;
    ...
    public(friend) fun withdraw_scallop_basic_lending_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        let v1 = &mut arg0.portfolio_vault_registry;
        let v2 = get_mut_portfolio_vault(v1, arg1);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v2.info.u64_padding, 0) == 2, 13906837193711616096);
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::set_u64_padding_value(&mut v2.info.u64_padding, 0, 0);
        let v3 = &mut arg0.deposit_vault_registry;
        let v4 = get_mut_deposit_vault(v3, arg1);
        let v5 = &mut arg0.additional_config_registry;
    ...
    public(friend) fun withdraw_shared_navi_<T0>(arg0: &mut Registry, arg1: u64, arg2: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::config::OracleConfig, arg3: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg4: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: address, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg9: u8, arg10: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg11: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg12: &mut 0x3::sui_system::SuiSystemState, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        let v2 = &mut arg0.portfolio_vault_registry;
        let v3 = get_mut_portfolio_vault(v2, arg1);
        assert!(0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v3.info.u64_padding, 0) == 6, 13906838482201280600);
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::set_u64_padding_value(&mut v3.info.u64_padding, 0, 0);
        let v4 = &mut arg0.deposit_vault_registry;
        0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle_pro::update_single_price(arg13, arg2, arg3, arg4, arg5, arg6);
