module 0x6ab4e51c445d96bb32288f3e43116485b45b8a789f25a5ff410d558ea7091ce9::vault {
    ...
    public fun deposit_coin<T0>(arg0: &mut Vault, arg1: 0x2::coin::Coin<T0>) {
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::bag::contains<0x1::type_name::TypeName>(&arg0.coins, v0)) {
            0x2::bag::add<0x1::type_name::TypeName, 0x2::coin::Coin<T0>>(&mut arg0.coins, 0x1::type_name::get<T0>(), arg1);
        } else {
            0x2::coin::join<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::coin::Coin<T0>>(&mut arg0.coins, v0), arg1);
        };
    }

    public fun deposit_coin_with_amount_limit<T0>(arg0: &mut Vault, arg1: 0x2::coin::Coin<T0>, arg2: u64) {
        assert!(0x2::coin::value<T0>(&arg1) > arg2, 0);
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::bag::contains<0x1::type_name::TypeName>(&arg0.coins, v0)) {
            0x2::bag::add<0x1::type_name::TypeName, 0x2::coin::Coin<T0>>(&mut arg0.coins, 0x1::type_name::get<T0>(), arg1);
    ...
    public(friend) fun withdraw<T0>(arg0: &0x6ab4e51c445d96bb32288f3e43116485b45b8a789f25a5ff410d558ea7091ce9::dolphin_cap::DolphinCap, arg1: &mut Vault, arg2: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::get<T0>();
