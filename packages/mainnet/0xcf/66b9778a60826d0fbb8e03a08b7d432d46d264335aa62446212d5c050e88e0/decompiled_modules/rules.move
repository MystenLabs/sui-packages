module 0xcf66b9778a60826d0fbb8e03a08b7d432d46d264335aa62446212d5c050e88e0::rules {
    ...
    public fun prove_kiosk_lock_rule<T0: store + key>(arg0: &0x2::kiosk::Kiosk, arg1: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg2: &mut 0x2::transfer_policy::TransferRequest<T0>) {
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T0>(arg2, arg0);
    }

    public fun prove_personal_kiosk_rule<T0: store + key>(arg0: &0x2::kiosk::Kiosk, arg1: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg2: &mut 0x2::transfer_policy::TransferRequest<T0>) {
