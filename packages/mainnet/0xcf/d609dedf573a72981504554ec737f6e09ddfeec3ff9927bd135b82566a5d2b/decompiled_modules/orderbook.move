module 0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook {
    ...
    struct Orderbook<phantom T0: store + key> has store, key {
        id: 0x2::object::UID,
        inner: 0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook_raw::OrderbookRaw<T0>,
        version: u64,
    }
    ...
    public fun new<T0: store + key>(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) : Orderbook<T0> {
        ...
        let v0 = Orderbook<T0>{
            ...
            inner   : 0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook_raw::new<T0>(arg1),
            version : 0,
        };
        let v1 = EventCreated{
    ...
    public fun buy<T0: store + key>(arg0: &mut Orderbook<T0>, arg1: 0x2::object::ID, arg2: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        let (v0, v1, v2, v3) = 0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook_raw::buy<T0>(&mut arg0.inner, arg1, arg2);
    ...
    public fun claim_commission<T0: store + key>(arg0: &mut Orderbook<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook_raw::claim_commission<T0>(&mut arg0.inner, arg1)
    }
    ...
    public fun delist<T0: store + key>(arg0: &mut Orderbook<T0>, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook_raw::delist<T0>(&mut arg0.inner, arg1, arg2)
    }
    ...
    public entry fun list<T0: store + key>(arg0: &mut Orderbook<T0>, arg1: T0, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        list_inner<T0>(arg0, arg1, arg2, 0x1::option::none<0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook_raw::Commission>(), arg3);
    }

    fun list_inner<T0: store + key>(arg0: &mut Orderbook<T0>, arg1: T0, arg2: u64, arg3: 0x1::option::Option<0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook_raw::Commission>, arg4: &0x2::tx_context::TxContext) {
        assert_version_and_upgrade<T0>(arg0);
        let v0 = 0x2::object::id<T0>(&arg1);
        0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook_raw::list<T0>(&mut arg0.inner, v0, arg1, arg2, arg3, arg4);
        let v1 = EventListed{
            object_id    : v0,
            orderbook_id : 0x2::object::id<Orderbook<T0>>(arg0),
            type_name    : 0x1::type_name::get<T0>(),
    ...
    public entry fun list_with_commission<T0: store + key>(arg0: &mut Orderbook<T0>, arg1: T0, arg2: u64, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        list_inner<T0>(arg0, arg1, arg2, 0x1::option::some<0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook_raw::Commission>(0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook_raw::new_commission(arg3, arg4)), arg5);
    }
    ...
    fun modify_inner<T0: store + key>(arg0: &mut Orderbook<T0>, arg1: 0x2::object::ID, arg2: u64, arg3: 0x1::option::Option<0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook_raw::Commission>, arg4: &0x2::tx_context::TxContext) {
        assert_version_and_upgrade<T0>(arg0);
        0xcfd609dedf573a72981504554ec737f6e09ddfeec3ff9927bd135b82566a5d2b::orderbook_raw::modify<T0>(&mut arg0.inner, arg1, arg2, arg3, arg4);
