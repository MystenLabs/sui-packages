module 0xcfbc3f74ca7db03fff10220e9ed372ce9bafd5318187358d6740a8dc5cc629a9::cnsnft9499 {
    ...
    fun init(arg0: CNSNFT9499, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://nsclaim1123img-0368.vercel.app/api/{id}"));
