module 0xcf359e386b3ffce7cc12da7d06b6d93f0c961c16e5877909f7f335f0f61722b4::reward5493 {
    struct REWARD5493 has drop {
        dummy_field: bool,
    }

    struct TICKET_5493 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5493(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5493>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5493>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5493, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5493>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5493>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5493>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5493>>(v5, 0x2::tx_context::sender(arg1));
    }
