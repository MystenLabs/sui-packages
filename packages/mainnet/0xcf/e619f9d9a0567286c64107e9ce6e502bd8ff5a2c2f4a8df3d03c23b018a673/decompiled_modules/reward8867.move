module 0xcfe619f9d9a0567286c64107e9ce6e502bd8ff5a2c2f4a8df3d03c23b018a673::reward8867 {
    struct REWARD8867 has drop {
        dummy_field: bool,
    }

    struct TICKET_8867 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8867(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8867>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8867>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8867, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8867>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8867>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8867>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8867>>(v5, 0x2::tx_context::sender(arg1));
    }
