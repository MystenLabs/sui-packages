module 0xcf7ef7152ecc3878594800650c0bbd5f8025833b877b779baf57d0e0eba01f5f::vault {
    ...
    public fun deposit(arg0: &mut Vault, arg1: address, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<VAULT>, 0x1::string::String) {
        let v0 = if (arg2 == 1) {
            true
        } else if (arg2 == 2) {
            true
        ...
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.main_balance, 0x2::coin::into_balance<0x2::sui::SUI>(arg4));
        ...
        (0x2::coin::mint<VAULT>(&mut arg0.treasury_cap, v1, arg5), v2)
    }
    ...
    public entry fun deposit_entry(arg0: &mut Vault, arg1: address, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        let (v0, _) = deposit(arg0, arg1, arg2, arg3, arg4, arg5);
        0x2::transfer::public_transfer<0x2::coin::Coin<VAULT>>(v0, 0x2::tx_context::sender(arg5));
    }
    ...
    fun init(arg0: VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<VAULT>(arg0, 9, b"samSUI", b"samSUI", b"samSUI represents SUI deposited into the Smart Asset Management protocol, which dynamically reallocates liquidity across multiple yield sources to maximize returns.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://patara.app/coins/samSUI.png")), arg1);
    ...
    public fun manager_has_deposited(arg0: &Vault, arg1: 0x1::string::String) : bool {
        assert!(0x2::table::contains<0x1::string::String, DepositInfo>(&arg0.deposits, arg1), 3);
        let v0 = 0x2::table::borrow<0x1::string::String, DepositInfo>(&arg0.deposits, arg1);
        v0.amount > v0.manager_withdrawn
    }

    public fun manager_has_deposited_rewards(arg0: &Vault, arg1: 0x1::string::String) : bool {
        assert!(0x2::table::contains<0x1::string::String, DepositInfo>(&arg0.deposits, arg1), 3);
        0x2::table::borrow<0x1::string::String, DepositInfo>(&arg0.deposits, arg1).rewards_earned > 0
    }
