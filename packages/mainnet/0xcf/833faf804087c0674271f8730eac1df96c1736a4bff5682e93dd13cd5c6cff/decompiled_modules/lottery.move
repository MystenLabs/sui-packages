module 0x8c3ff5236a06b915562dc855e8169b8ffd073d21fc53355c8780abbe30fd20da::lottery {
    ...
    public fun withdraw<T0>(arg0: &LotteryStoreAdminCap, arg1: &mut Lottery<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x2::balance::zero<T0>();
        0x2::balance::join<T0>(&mut v0, 0x2::balance::split<T0>(&mut arg1.lottery_prize_pool, 0x2::balance::value<T0>(&arg1.lottery_prize_pool)));
        0x2::balance::join<T0>(&mut v0, 0x2::balance::split<T0>(&mut arg1.lottery_fees, 0x2::balance::value<T0>(&arg1.lottery_fees)));
    ...
    public fun withdraw_fees_v2<T0>(arg0: &LotteryStoreAdminCap, arg1: &mut LotteryStore, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = borrow_mut_lottery<T0>(arg1, arg2);
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut borrow_mut_lottery<T0>(arg1, arg2).lottery_fees, lottery_fees_value<T0>(v0)), arg3)
    }

    public fun withdraw_v2<T0>(arg0: &LotteryStoreAdminCap, arg1: &mut LotteryStore, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = borrow_mut_lottery<T0>(arg1, arg2);
