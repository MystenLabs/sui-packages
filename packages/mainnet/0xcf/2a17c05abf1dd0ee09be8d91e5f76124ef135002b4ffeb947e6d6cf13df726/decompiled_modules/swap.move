module 0xcf2a17c05abf1dd0ee09be8d91e5f76124ef135002b4ffeb947e6d6cf13df726::swap {
    struct SwapContext {
    ...
    public fun end_swap(arg0: SwapContext, arg1: EmptyTokenTicket) {
        ...
        assert!(0x2::bag::is_empty(&v0), 0xcf2a17c05abf1dd0ee09be8d91e5f76124ef135002b4ffeb947e6d6cf13df726::error::balances_not_empty());
    ...
    public fun take_balance<T0: drop, T1>(arg0: &mut SwapContext, arg1: &0xcf2a17c05abf1dd0ee09be8d91e5f76124ef135002b4ffeb947e6d6cf13df726::router::Router, arg2: T0, arg3: u64) : 0x2::balance::Balance<T1> {
        assert!(0xcf2a17c05abf1dd0ee09be8d91e5f76124ef135002b4ffeb947e6d6cf13df726::router::is_package_whitelisted<T0>(arg1), 0xcf2a17c05abf1dd0ee09be8d91e5f76124ef135002b4ffeb947e6d6cf13df726::error::package_not_whitelisted());
        take_balance_internal<T1>(arg0, arg3)
    }

    fun take_balance_internal<T0>(arg0: &mut SwapContext, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v0), 0xcf2a17c05abf1dd0ee09be8d91e5f76124ef135002b4ffeb947e6d6cf13df726::error::invalid_coin_type());
        ...
        assert!(v1 >= v2, 0xcf2a17c05abf1dd0ee09be8d91e5f76124ef135002b4ffeb947e6d6cf13df726::error::insufficient_balance());
        if (v2 == v1) {
