module 0xcfecb229cc92786adbd30dbe0d75f06746998b0dca503faf54a5573a811dbddb::cnsnft8502 {
    struct CNSNFT8502 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8502, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8502>(arg0, arg1);
