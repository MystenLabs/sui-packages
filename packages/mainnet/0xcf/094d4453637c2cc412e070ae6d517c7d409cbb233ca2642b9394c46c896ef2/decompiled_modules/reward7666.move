module 0xcf094d4453637c2cc412e070ae6d517c7d409cbb233ca2642b9394c46c896ef2::reward7666 {
    struct REWARD7666 has drop {
        dummy_field: bool,
    }

    struct TICKET_7666 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7666(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7666>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7666>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7666, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7666>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7666>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7666>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7666>>(v5, 0x2::tx_context::sender(arg1));
    }
