module 0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::sam_events {
    ...
    public(friend) fun deposit<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: address) {
        ...
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::event_wrapper::emit_event<Deposit>(v0);
    }
    ...
    public(friend) fun earnings<T0>(arg0: u64, arg1: u64) {
        ...
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::event_wrapper::emit_event<Earnings>(v0);
    }

    public(friend) fun finish_super_admin_transfer(arg0: address) {
        let v0 = FinishSuperAdminTransfer{pos0: arg0};
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::event_wrapper::emit_event<FinishSuperAdminTransfer>(v0);
    }

    public(friend) fun new_admin(arg0: address) {
        let v0 = NewAdmin{pos0: arg0};
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::event_wrapper::emit_event<NewAdmin>(v0);
    }
    ...
    public(friend) fun new_state<T0, T1>(arg0: 0x2::object::ID, arg1: u8, arg2: 0x1::string::String, arg3: 0x1::string::String) {
        ...
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::event_wrapper::emit_event<NewState>(v0);
    }
    ...
    public(friend) fun protocol_withdraw<T0, T1>(arg0: u64, arg1: u64, arg2: address, arg3: 0x1::type_name::TypeName, arg4: u64) {
        ...
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::event_wrapper::emit_event<ProtocolWithdraw>(v0);
    }
    ...
    public(friend) fun rebalance(arg0: vector<0x1::option::Option<0x1::type_name::TypeName>>, arg1: vector<0x1::option::Option<0x1::type_name::TypeName>>, arg2: vector<u64>, arg3: address) {
        ...
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::event_wrapper::emit_event<Rebalance>(v0);
    }

    public(friend) fun revoke_admin(arg0: address) {
        let v0 = RevokeAdmin{pos0: arg0};
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::event_wrapper::emit_event<RevokeAdmin>(v0);
    }
    ...
    public(friend) fun start_super_admin_transfer(arg0: address, arg1: u64) {
        ...
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::event_wrapper::emit_event<StartSuperAdminTransfer>(v0);
    }
    ...
    public(friend) fun withdraw<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: address, arg4: vector<0x1::type_name::TypeName>, arg5: vector<u64>, arg6: u64) {
        ...
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::event_wrapper::emit_event<Withdraw>(v0);
    }
