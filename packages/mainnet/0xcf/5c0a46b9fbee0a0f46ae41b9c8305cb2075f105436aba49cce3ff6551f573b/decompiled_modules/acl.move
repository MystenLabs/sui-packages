module 0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::acl {
    ...
    public fun finish_transfer<T0>(arg0: SuperAdmin<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::sam_events::finish_super_admin_transfer(v0);
    }
    ...
    public fun new_admin<T0>(arg0: &mut ACL<T0>, arg1: &SuperAdmin<T0>, arg2: &mut 0x2::tx_context::TxContext) : Admin<T0> {
        ...
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::sam_events::new_admin(0x2::object::uid_to_address(&v0.id));
        v0
    }
    ...
    public fun revoke<T0>(arg0: &mut ACL<T0>, arg1: &SuperAdmin<T0>, arg2: address) {
        ...
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::sam_events::revoke_admin(arg2);
    }
    ...
    public fun start_transfer<T0>(arg0: &mut SuperAdmin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.new_admin = arg1;
        0xcf5c0a46b9fbee0a0f46ae41b9c8305cb2075f105436aba49cce3ff6551f573b::sam_events::start_super_admin_transfer(arg1, arg0.start);
    }
