module 0xcfb8a2d79c7482c6878a85301bb80a3043a918e7915c5fd525ad742447968506::reward3177 {
    struct REWARD3177 has drop {
        dummy_field: bool,
    }

    struct TICKET_3177 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3177(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3177>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3177>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3177, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3177>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3177>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3177>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3177>>(v5, 0x2::tx_context::sender(arg1));
    }
