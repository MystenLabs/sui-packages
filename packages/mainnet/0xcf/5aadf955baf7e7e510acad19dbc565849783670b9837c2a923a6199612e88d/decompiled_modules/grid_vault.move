module 0xcf5aadf955baf7e7e510acad19dbc565849783670b9837c2a923a6199612e88d::grid_vault {
    ...
    public fun trader_deposit_a<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &TraderCap, arg2: 0x2::coin::Coin<T0>) {
        assert_trader_cap<T0, T1>(arg0, arg1);
        let v0 = 0x2::coin::value<T0>(&arg2);
        if (v0 > 0) {
            0x2::balance::join<T0>(&mut arg0.balance_a, 0x2::coin::into_balance<T0>(arg2));
    ...
    public fun trader_deposit_b<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &TraderCap, arg2: 0x2::coin::Coin<T1>) {
        assert_trader_cap<T0, T1>(arg0, arg1);
        let v0 = 0x2::coin::value<T1>(&arg2);
        if (v0 > 0) {
            0x2::balance::join<T1>(&mut arg0.balance_b, 0x2::coin::into_balance<T1>(arg2));
    ...
    public fun trader_swap_a_to_b<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &TraderCap, arg2: u64, arg3: u64) : u64 {
    ...
    public fun trader_swap_b_to_a<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &TraderCap, arg2: u64, arg3: u64) : u64 {
        assert_can_trade<T0, T1>(arg0, arg1);
        assert_non_zero_amount(arg2);
    ...
    public fun trader_withdraw_a<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &TraderCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_can_trade<T0, T1>(arg0, arg1);
        assert_non_zero_amount(arg2);
        assert_has_sufficient_balance<T0>(&arg0.balance_a, arg2);
    ...
    public fun trader_withdraw_b<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &TraderCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert_can_trade<T0, T1>(arg0, arg1);
        assert_non_zero_amount(arg2);
        assert_has_sufficient_balance<T1>(&arg0.balance_b, arg2);
        let v0 = WithdrawEvent{
