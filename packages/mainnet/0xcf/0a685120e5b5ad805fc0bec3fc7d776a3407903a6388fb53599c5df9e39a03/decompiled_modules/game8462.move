module 0xcf0a685120e5b5ad805fc0bec3fc7d776a3407903a6388fb53599c5df9e39a03::game8462 {
    struct GAME8462 has drop {
        dummy_field: bool,
    }

    struct TICKET_8462 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8462(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8462>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8462>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME8462, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME8462>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8462>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8462>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8462>>(v5, 0x2::tx_context::sender(arg1));
    }
