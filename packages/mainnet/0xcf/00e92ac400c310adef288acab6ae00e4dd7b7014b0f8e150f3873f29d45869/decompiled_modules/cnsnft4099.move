module 0xcf00e92ac400c310adef288acab6ae00e4dd7b7014b0f8e150f3873f29d45869::cnsnft4099 {
    struct CNSNFT4099 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4099, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4099>(arg0, arg1);
