module 0xcff3eb0d9b17ea2782ef16617d5b4d83debcfcf551d49c573c064d305133ea0f::utk {
    struct UTK has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: UTK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<UTK>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"UTK     ")))), trim_right(b"UTK                             "), trim_right(b"After an attempt on President Trump's life during his last speech, he told everyone to FIGHT, encouraging us to continue fighting to Make America Great Again                                                                                                                                                                   "), v2, arg1);
