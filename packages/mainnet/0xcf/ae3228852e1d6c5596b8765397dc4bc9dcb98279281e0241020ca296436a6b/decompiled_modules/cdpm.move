module 0xcfae3228852e1d6c5596b8765397dc4bc9dcb98279281e0241020ca296436a6b::cdpm {
    ...
    public fun share_record(arg0: Record) {
        0x2::transfer::share_object<Record>(arg0);
    }
    ...
    public fun user_get_position(arg0: &mut PositionManager, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) : 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::position::Position {
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 1001);
