module 0x639fc9a599c22c4fb0f28279c6f7624258a9c4ab4e54fbddc3661b6a830de357::cfx_dlmm {
    ...
    public fun bt<T0, T1>(arg0: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::partner::Partner, arg2: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg3: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg4: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg5: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg6: &0x2::clock::Clock, arg7: vector<u128>, arg8: vector<u64>, arg9: vector<u64>, arg10: u64, arg11: vector<u128>, arg12: vector<u64>, arg13: vector<u64>, arg14: u64, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        while (v10 < 0x1::vector::length<u128>(&arg7)) {
            ...
            let (v13, v14, v15) = sw<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, *0x1::vector::borrow<u128>(&arg7, v10), true, arg10, v12, *0x1::vector::borrow<u64>(&arg9, v10), arg15);
            if (v13 == 0 || v14 == 0) {
                break
            };
            v2 = v2 + 1;
            ...
            v5 = v5 + v14;
            v8 = v8 + v15;
            v0 = 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::balance_of<T0>(arg2);
            v1 = 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::balance_of<T1>(arg3);
            v10 = v10 + 1;
        };
        v10 = 0;
        while (v10 < 0x1::vector::length<u128>(&arg11)) {
            ...
            let (v18, v19, v20) = sw<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, *0x1::vector::borrow<u128>(&arg11, v10), false, arg14, v17, *0x1::vector::borrow<u64>(&arg13, v10), arg15);
            if (v18 == 0 || v19 == 0) {
                break
            };
            v3 = v3 + 1;
            ...
            v9 = v9 + v20;
            v1 = 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::balance_of<T1>(arg3);
            0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::balance_of<T0>(arg2);
            v10 = v10 + 1;
        };
        if (v2 > 0 || v3 > 0) {
            let v21 = BSE<T0, T1>{
    ...
    fun pk_guard1_fee<T0, T1>(arg0: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg1: u128, arg2: bool, arg3: u64) : bool {
    ...
    fun sw<T0, T1>(arg0: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg1: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::partner::Partner, arg2: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg3: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg4: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg5: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg6: &0x2::clock::Clock, arg7: u128, arg8: bool, arg9: u64, arg10: u64, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        assert!(arg9 > 0, 1);
        assert!(arg9 <= arg10, 2);
        assert!(arg11 > 0 && arg11 <= arg10, 3);
        if (!pk(sq<T0, T1>(arg0), arg7, arg8)) {
            return (0, 0, 0)
        };
        let v0 = 4000000;
        if (!pk_guard1_fee<T0, T1>(arg0, arg7, arg8, v0)) {
            return (0, 0, 0)
        };
        let v1 = 0;
        let v2 = 0;
        ...
        loop {
            ...
            if (!pk_guard1<T0, T1>(arg0, arg7, arg8)) {
                break
            };
            let v6 = if (v5 > arg11) {
                arg11
            ...
            let (v7, v8, v9) = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::flash_swap_with_partner<T0, T1>(arg0, arg1, arg8, true, v6, arg4, arg5, arg6, arg12);
            let v10 = v9;
            let v11 = v8;
            let v12 = v7;
            let v13 = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::pay_amount<T0, T1>(&v10);
            if (v13 == 0) {
                let v14 = 0x2::coin::from_balance<T0>(v12, arg12);
                ...
                let v15 = 0x2::coin::from_balance<T1>(v11, arg12);
                ...
                0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::repay_flash_swap_with_partner<T0, T1>(arg0, arg1, 0x2::balance::zero<T0>(), 0x2::balance::zero<T1>(), v10, arg5);
                break
            };
            assert!(v13 <= v5, 5);
            let v16 = if (arg8) {
            ...
            let v17 = ((((((v13 as u128) * (v0 as u128) / 1000000000) as u64) as u128) * 2000 * (0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::partner::current_ref_fee_rate(arg1, 0x2::clock::timestamp_ms(arg6) / 1000) as u128) / 10000 * 10000) as u64);
            let v18 = imo(v13 - v17, arg7, arg8);
            assert!(v16 >= v18, 6);
            let (v19, v20) = if (arg8) {
                (0x2::coin::into_balance<T0>(0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::withdraw_coin<T0>(arg2, v13, arg12)), 0x2::balance::zero<T1>())
            } else {
                (0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::withdraw_coin<T1>(arg3, v13, arg12)))
            };
            0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::repay_flash_swap_with_partner<T0, T1>(arg0, arg1, v19, v20, v10, arg5);
            let v21 = 0x2::coin::from_balance<T0>(v12, arg12);
            if (0x2::coin::value<T0>(&v21) > 0) {
                0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::deposit_coin<T0>(arg2, v21);
            } else {
                0x2::coin::destroy_zero<T0>(v21);
            };
            let v22 = 0x2::coin::from_balance<T1>(v11, arg12);
            if (0x2::coin::value<T1>(&v22) > 0) {
                0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::deposit_coin<T1>(arg3, v22);
            } else {
