module 0x3c6090fd487ca850fc0e5788eb2ee7e8f247b34a6e2cc3a10e9d40a04b34bb9d::reward2066 {
    struct REWARD2066 has drop {
        dummy_field: bool,
    }

    struct TICKET_2066 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2066(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2066>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2066>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2066, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2066>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2066>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2066>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2066>>(v5, 0x2::tx_context::sender(arg1));
    }
