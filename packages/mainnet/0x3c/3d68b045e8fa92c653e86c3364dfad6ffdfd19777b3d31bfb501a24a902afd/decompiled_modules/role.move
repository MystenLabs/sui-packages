module 0x3c3d68b045e8fa92c653e86c3364dfad6ffdfd19777b3d31bfb501a24a902afd::role {
    ...
    public fun issue_operator_cap(arg0: &AdminCap, arg1: &mut OperatorCapsBag, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun revoke_operator_cap(arg0: &AdminCap, arg1: &mut OperatorCapsBag, arg2: &0x2::clock::Clock, arg3: 0x2::object::ID) {
        assert!(0x2::table::contains<0x2::object::ID, bool>(&arg1.caps, arg3), 1);
        0x2::table::remove<0x2::object::ID, bool>(&mut arg1.caps, arg3);
