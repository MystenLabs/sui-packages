module 0x3cd11ca26110ce422bd65fe247c41f6ec7ad0c9fa7ece6dc107b271b13cd671c::hachi {
    ...
    fun init(arg0: HACHI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<HACHI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"HACHI   ")))), trim_right(b"Hachiko                         "), trim_right(b"Hachiko is one of the most famous & legendary dog in the world from Japan. Hachiko Memecoin aims to build a lasting legacy in crypto                                                                                                                                                                                            "), v2, arg1);
