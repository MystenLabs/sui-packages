module 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle {
    ...
    public fun get_token_price(arg0: &0x2::clock::Clock, arg1: &PriceOracle, arg2: u8) : (bool, u256, u8) {
        ...
        assert!(0x2::table::contains<u8, Price>(v0, arg2), 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_error::non_existent_oracle());
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = PriceOracle{
            ...
            update_interval : 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_constants::default_update_interval(),
    ...
    public(friend) fun oracle_version_migrate(arg0: &OracleAdminCap, arg1: &mut PriceOracle) {
        assert!(arg1.version < 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_version::this_version(), 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_error::not_available_version());
        arg1.version = 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_version::this_version();
    }

    public fun price_object(arg0: &PriceOracle, arg1: u8) : &Price {
        assert!(0x2::table::contains<u8, Price>(&arg0.price_oracles, arg1), 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_error::price_oracle_not_found());
    ...
    public entry fun register_token_price(arg0: &OracleAdminCap, arg1: &0x2::clock::Clock, arg2: &mut PriceOracle, arg3: u8, arg4: u256, arg5: u8) {
        ...
        assert!(arg5 <= 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_constants::default_decimal_limit() && arg5 > 0, 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_error::invalid_value());
        let v0 = &mut arg2.price_oracles;
        assert!(!0x2::table::contains<u8, Price>(v0, arg3), 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_error::oracle_already_exist());
        let v1 = Price{
            value     : arg4,
            decimal   : arg5,
    ...
    public entry fun set_update_interval(arg0: &OracleAdminCap, arg1: &mut PriceOracle, arg2: u64) {
        version_verification(arg1);
        assert!(arg2 > 0, 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_error::invalid_value());
    ...
    public(friend) fun update_price_batch(arg0: &0x2::clock::Clock, arg1: &mut PriceOracle, arg2: vector<u8>, arg3: vector<u256>) {
        assert!(0x1::vector::length<u8>(&arg2) == 0x1::vector::length<u256>(&arg3), 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_error::price_length_not_match());
        let v0 = 0;
    ...
    public entry fun update_token_price(arg0: &OracleFeederCap, arg1: &0x2::clock::Clock, arg2: &mut PriceOracle, arg3: u8, arg4: u256) {
        version_verification(arg2);
        let v0 = &mut arg2.price_oracles;
        assert!(0x2::table::contains<u8, Price>(v0, arg3), 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_error::non_existent_oracle());
    ...
    public entry fun update_token_price_batch(arg0: &OracleFeederCap, arg1: &0x2::clock::Clock, arg2: &mut PriceOracle, arg3: vector<u8>, arg4: vector<u256>) {
        ...
        assert!(v0 == 0x1::vector::length<u256>(&arg4), 0x3c6ac23d80ac2b4654c686dd55f5dc4e07f4099489a3fee84e26e871ceef56af::oracle_error::price_length_not_match());
        let v1 = 0;
        while (v1 < v0) {
