module 0xf9f52fdb675f5817f8448b4ca18c9079312303e494d53f288c7d6522220a778f::vault {
    ...
    public fun buy_share<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0xf9f52fdb675f5817f8448b4ca18c9079312303e494d53f288c7d6522220a778f::stingray::Stingray, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v2 = if (v1 != 0) {
            ...
            let v4 = calculate_management_fee<T0, T1>(arg0, v1, arg3);
            ...
            0xf9f52fdb675f5817f8448b4ca18c9079312303e494d53f288c7d6522220a778f::collector::fill_balance<T0>(v5, &mut v0);
            0xce36dcf1d175659e78e42e3478e6fea3110fc3914bb70210df51dec9ef3d6c37::float::from_fraction(0x2::balance::supply_value<T1>(&arg0.supply), v1 - v3 + v4)
        } else {
            0xce36dcf1d175659e78e42e3478e6fea3110fc3914bb70210df51dec9ef3d6c37::float::from(1)
        };
        add_to_reserve<T0, T1, T0>(arg0, v0);
        abort 1111
    }
