module 0x3ca222683e9524600034d1baa4ac013daba53ffe61d87dd9ef9220f3479ed3b1::reward1905 {
    struct REWARD1905 has drop {
        dummy_field: bool,
    }

    struct TICKET_1905 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1905(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1905>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1905>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1905, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1905>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1905>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1905>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1905>>(v5, 0x2::tx_context::sender(arg1));
    }
