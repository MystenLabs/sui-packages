module 0x3cf5d85a1181edfcf009034ccbc4ade7322d01a3ca459ab922fca6f45b33f6bb::bluepika {
    ...
    fun init(arg0: BLUEPIKA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<BLUEPIKA>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<BLUEPIKA>>(v4);
    }
