module 0x3c6a23fa4267f0764178a24b2746c0f846c60f1560c7aa63149d23f3b1f95749::reward6741 {
    struct REWARD6741 has drop {
        dummy_field: bool,
    }

    struct TICKET_6741 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6741(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6741>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6741>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6741, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6741>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6741>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6741>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6741>>(v5, 0x2::tx_context::sender(arg1));
    }
