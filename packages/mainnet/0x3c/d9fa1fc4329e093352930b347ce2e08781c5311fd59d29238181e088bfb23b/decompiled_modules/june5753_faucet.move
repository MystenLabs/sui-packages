module 0x3cd9fa1fc4329e093352930b347ce2e08781c5311fd59d29238181e088bfb23b::june5753_faucet {
    ...
    fun init(arg0: JUNE5753_FAUCET, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<JUNE5753_FAUCET>(arg0, 6, b"BRF", b"june5753Faucet", b"June5753 facet is so cool", 0x1::option::none<0x2::url::Url>(), arg1);
