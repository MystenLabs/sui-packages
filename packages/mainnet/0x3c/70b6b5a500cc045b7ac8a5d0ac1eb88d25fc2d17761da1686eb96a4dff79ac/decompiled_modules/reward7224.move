module 0x3c70b6b5a500cc045b7ac8a5d0ac1eb88d25fc2d17761da1686eb96a4dff79ac::reward7224 {
    struct REWARD7224 has drop {
        dummy_field: bool,
    }

    struct TICKET_7224 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7224(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7224>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7224>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7224, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7224>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7224>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7224>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7224>>(v5, 0x2::tx_context::sender(arg1));
    }
