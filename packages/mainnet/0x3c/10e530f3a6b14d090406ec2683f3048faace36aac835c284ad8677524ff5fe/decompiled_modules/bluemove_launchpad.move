module 0x3c10e530f3a6b14d090406ec2683f3048faace36aac835c284ad8677524ff5fe::bluemove_launchpad {
    ...
    public fun asser_suis_inscriptions<T0>() {
        assert!(get_token_name<T0>() == get_token_name<Pramb>(), 9);
    }

    public entry fun burn_nft(arg0: Pramb, arg1: &mut 0x2::tx_context::TxContext) {
        let Pramb {
            id            : v0,
            name          : v1,
            description   : v2,
    ...
    public entry fun distributed_nft(arg0: &mut LaunchpadData, arg1: &mut Order, arg2: &mut Storage, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < arg3) {
            ...
            0x2::transfer::public_transfer<Pramb>(0x2::dynamic_object_field::remove<u64, Pramb>(&mut arg2.id, v1), v2.recipent);
            arg0.current_nft = v1;
            v0 = v0 + 1;
        };
    }
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = 0x2::display::new_with_fields<Pramb>(&v7, v0, v2, arg1);
        0x2::display::update_version<Pramb>(&mut v8);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v7, @0x2);
        0x2::transfer::public_transfer<0x2::display::Display<Pramb>>(v8, @0x2);
        0x2::transfer::public_share_object<LaunchpadData>(v4);
    }

    fun mint_inscriptions_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) : Pramb {
        let v0 = Pramb{
    ...
    public entry fun mint_with_quantity(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &mut LaunchpadData, arg3: &mut Order, arg4: &mut Storage, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        while (v8 < arg5) {
            ...
            0x2::dynamic_object_field::add<u64, Pramb>(&mut arg4.id, arg2.current_place + 1, mint_inscriptions_nft(v11, arg2.description, arg2.base_image_url, v12, 0x1::string::utf8(b"https://sui.bluemove.net/"), arg7));
    ...
    fun placeNftOrder(arg0: &mut LaunchpadData, arg1: &mut Storage, arg2: Pramb, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::dynamic_object_field::add<u64, Pramb>(&mut arg1.id, arg0.current_place + 1, arg2);
