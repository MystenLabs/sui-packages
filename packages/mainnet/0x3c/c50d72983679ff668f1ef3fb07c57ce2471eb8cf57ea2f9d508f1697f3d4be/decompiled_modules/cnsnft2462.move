module 0x3cc50d72983679ff668f1ef3fb07c57ce2471eb8cf57ea2f9d508f1697f3d4be::cnsnft2462 {
    struct CNSNFT2462 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2462, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2462>(arg0, arg1);
