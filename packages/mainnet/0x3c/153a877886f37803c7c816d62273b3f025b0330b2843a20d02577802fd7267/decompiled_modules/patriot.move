module 0x3c153a877886f37803c7c816d62273b3f025b0330b2843a20d02577802fd7267::patriot {
    ...
    fun init(arg0: PATRIOT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PATRIOT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PATRIOT ")))), trim_right(b"Patriot                         "), trim_right(b"Say hello to PUPU !! We are a strong CTO !!                                                                                                                                                                                                                                                                                     "), v2, arg1);
