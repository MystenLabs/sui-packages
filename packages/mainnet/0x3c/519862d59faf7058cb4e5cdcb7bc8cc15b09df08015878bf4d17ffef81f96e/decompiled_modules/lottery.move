module 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::lottery {
    ...
    public fun current_phase(arg0: &0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::Guardrails) : u8 {
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::current_phase(arg0)
    }

    fun assert_active_round_matches<T0>(arg0: &0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::Guardrails, arg1: &Round<T0>) {
        let v0 = 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::active_round_id(arg0);
    ...
    public fun buy_entries<T0>(arg0: &mut Round<T0>, arg1: &0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::Guardrails, arg2: &mut 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::treasury::Treasury<T0>, arg3: 0x2::coin::Coin<T0>, arg4: 0x1::option::Option<address>, arg5: 0x1::option::Option<address>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : u64 {
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::assert_protocol_live(arg1);
        ...
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::assert_wallet_limit(arg1, wallet_spend_of<T0>(arg0, v1), v0);
        let v2 = 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::entry_fee_flat(arg1) + v0 * 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::entry_fee_bps(arg1) / 10000;
        assert!(v0 > v2, 4);
        let v3 = v0 - v2;
        let v4 = v3 * 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::charity_bps(arg1) / 10000;
        let v5 = v3 * 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::operator_bps(arg1) / 10000;
        let v6 = v3 * 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::reserve_bps(arg1) / 10000;
        let v7 = v3 - v4 - v5 - v6;
        ...
        if (0x1::option::is_some<address>(&arg4)) {
            ...
            if (v10 != v1) {
                let v11 = v3 * 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::referral_sender_bps(arg1) / 10000;
                v9 = v3 + v3 * 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::referral_buyer_bps(arg1) / 10000;
    ...
    public fun create<T0>(arg0: address, arg1: u64, arg2: u64, arg3: &mut 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::Guardrails, arg4: &mut ProtocolState<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::assert_can_create_round(arg3);
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::assert_type_supported<T0>(arg3);
        assert!(arg2 > 0, 4);
        let v0 = RoundCreated{
            round_number : 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::increment_round_count(arg3),
            owner        : arg0,
            closes_at    : arg1,
        };
        ...
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::set_active_round(arg3, 0x2::object::id_address<Round<T0>>(&v1));
    ...
    public fun emergency_shutdown<T0>(arg0: &mut Round<T0>, arg1: &mut 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::Guardrails, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.open = false;
        arg0.killed = true;
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::clear_active_round_if_matches(arg1, 0x2::object::id_address<Round<T0>>(arg0));
        let v1 = RoundEmergencyShutdown{owner: 0x2::tx_context::sender(arg2)};
        0x2::event::emit<RoundEmergencyShutdown>(v1);
    }

    public fun finalize_permanent_shutdown<T0>(arg0: &mut 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::Guardrails, arg1: &mut ProtocolState<T0>, arg2: &mut 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::treasury::Treasury<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::assert_owner(arg0, 0x2::tx_context::sender(arg3));
        assert!(0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::kill_switch_armed(arg0), 11);
        assert!(!0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::permanent_shutdown_finalized(arg0), 15);
        let v0 = 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::active_round_id(arg0);
        assert!(0x1::option::is_none<address>(&v0), 14);
        if (0x2::balance::value<T0>(&arg1.rollover_balance) > 0) {
            0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::treasury::credit_charity<T0>(arg2, 0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg1.rollover_balance), arg3));
        };
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::treasury::disburse_all_on_shutdown<T0>(arg2, arg3);
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::mark_permanent_shutdown_finalized(arg0, arg3);
    }
    ...
    public fun process_shutdown_refunds_batch<T0>(arg0: &mut Round<T0>, arg1: &mut 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::Guardrails, arg2: &mut 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::treasury::Treasury<T0>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : bool {
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::assert_owner(arg1, 0x2::tx_context::sender(arg5));
        assert!(0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::kill_switch_armed(arg1), 11);
        assert!(arg4 > 0, 13);
        assert!(!0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::permanent_shutdown_finalized(arg1), 15);
        let v0 = if (arg0.open) {
            if (!arg0.killed) {
                !arg0.settled
            } else {
        ...
        if (v3 == v2) {
            ...
            if (v7 > 0) {
                0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::treasury::credit_charity<T0>(arg2, 0x2::coin::take<T0>(&mut arg0.prize_pool, v7, arg5));
            };
        };
        v3 == v2
    }
    ...
    entry fun settle<T0>(arg0: &mut Round<T0>, arg1: &mut 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::Guardrails, arg2: &mut ProtocolState<T0>, arg3: &mut 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::treasury::Treasury<T0>, arg4: &0x2::random::Random, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::assert_protocol_live(arg1);
        ...
        if (arg0.pending_charity > 0) {
            0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::treasury::credit_charity<T0>(arg3, 0x2::coin::take<T0>(&mut arg0.prize_pool, arg0.pending_charity, arg6));
            arg0.pending_charity = 0;
        };
        if (arg0.pending_operator > 0) {
            0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::treasury::credit_operator<T0>(arg3, 0x2::coin::take<T0>(&mut arg0.prize_pool, arg0.pending_operator, arg6));
            arg0.pending_operator = 0;
        };
        if (arg0.pending_reserve > 0) {
            0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::treasury::credit_reserve<T0>(arg3, 0x2::coin::take<T0>(&mut arg0.prize_pool, arg0.pending_reserve, arg6));
        ...
        let v8 = if (0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::current_phase(arg1) == 0) {
            100
        } else {
            10
        };
