module 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::treasury {
    ...
    public fun claim_reserve<T0>(arg0: &mut Treasury<T0>, arg1: &0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::Guardrails, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 0);
        assert!(0x2::balance::value<T0>(&arg0.protocol_reserve) >= 0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::reserve_claim_threshold(arg1), 0);
        0x2::coin::take<T0>(&mut arg0.protocol_reserve, 0x2::balance::value<T0>(&arg0.protocol_reserve), arg2)
    }

    public fun create<T0>(arg0: address, arg1: address, arg2: &0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::Guardrails, arg3: &mut 0x2::tx_context::TxContext) {
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::assert_charity_allowed(arg2, arg1);
        let v0 = Treasury<T0>{
    ...
    public fun set_charity<T0>(arg0: &mut Treasury<T0>, arg1: &0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::Guardrails, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.owner, 0);
        0x3c519862d59faf7058cb4e5cdcb7bc8cc15b09df08015878bf4d17ffef81f96e::guardrails::assert_charity_allowed(arg1, arg2);
        arg0.charity = arg2;
        let v0 = CharitySet{
