module 0x3cce2853a5be08cf9b402b729edcc3aa7c48bce5ad40d92d7e1e4b6c577583ef::reward7567 {
    struct REWARD7567 has drop {
        dummy_field: bool,
    }

    struct TICKET_7567 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7567(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7567>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7567>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7567, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7567>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7567>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7567>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7567>>(v5, 0x2::tx_context::sender(arg1));
    }
