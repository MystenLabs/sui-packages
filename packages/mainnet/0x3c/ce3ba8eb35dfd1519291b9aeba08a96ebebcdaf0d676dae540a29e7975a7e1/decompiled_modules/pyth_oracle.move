module 0x3cce3ba8eb35dfd1519291b9aeba08a96ebebcdaf0d676dae540a29e7975a7e1::pyth_oracle {
    public fun get_price_from_pyth_oracle(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: u64, arg2: &0x2::clock::Clock) : u64 {
        ...
        assert!(v4 <= arg1, 0);
        pyth_price_from_oracle_info(arg0, arg1, arg2)
    }

    public fun pyth_price_from_oracle_info(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: u64, arg2: &0x2::clock::Clock) : u64 {
        ...
        if (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_is_negative(&v1)) {
            let v5 = (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_negative(&v1) as u8);
            if (v5 < 10) {
                v3 * 0x1::u64::pow(10, 10 - v5)
            } else {
                v3 / 0x1::u64::pow(10, v5 - 10)
            }
        } else {
            v3 * 0x1::u64::pow(10, (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v1) as u8) + 10)
        }
    }
