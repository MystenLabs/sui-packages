module 0x3c8d6408f812d3f28bda88707c5fc3baa8acc249487f2404f017f3fa61dc8324::marketplace {
    ...
    public fun buy<T0: store + key, T1>(arg0: &mut MarketplaceConfig, arg1: &mut 0x3c8d6408f812d3f28bda88707c5fc3baa8acc249487f2404f017f3fa61dc8324::creator_bluemove_fee::RoyaltyCollection, arg2: &mut CreatorConfig, arg3: 0x2::object::ID, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : T0 {
        let Listing {
            id       : v0,
            amount   : v1,
            owner    : v2,
        ...
        assert!(arg5 == v1, 0);
        let v6 = if (0x3c8d6408f812d3f28bda88707c5fc3baa8acc249487f2404f017f3fa61dc8324::creator_bluemove_fee::check_exists_royalty_collection<T1>(arg1, arg6)) {
            let (v7, v8, v9, v10) = 0x3c8d6408f812d3f28bda88707c5fc3baa8acc249487f2404f017f3fa61dc8324::creator_bluemove_fee::caculate_royalty_collection<T0>(arg1, v1, &mut v5, arg6);
            assert!(v10 == v3, 4);
        ...
        0x2::coin::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::split<0x2::sui::SUI>(&mut v5, v11, arg6));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v5, v1 - v11 - v6, arg6), v2);
    ...
    public entry fun list<T0: store + key, T1>(arg0: &mut MarketplaceConfig, arg1: T0, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Listing{
            ...
            nft_type : 0x3c8d6408f812d3f28bda88707c5fc3baa8acc249487f2404f017f3fa61dc8324::utils::get_token_name<T1>(),
        };
