module 0x3c89732b646675c6ec2f339e22efbcb8d509ac610b095055439281cc4d790b9f::cnsnft3562 {
    struct CNSNFT3562 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3562, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3562>(arg0, arg1);
