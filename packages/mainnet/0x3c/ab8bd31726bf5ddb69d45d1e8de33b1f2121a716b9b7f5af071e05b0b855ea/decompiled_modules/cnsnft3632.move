module 0x3cab8bd31726bf5ddb69d45d1e8de33b1f2121a716b9b7f5af071e05b0b855ea::cnsnft3632 {
    struct CNSNFT3632 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3632, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3710"));
        let v4 = 0x2::package::claim<CNSNFT3632>(arg0, arg1);
