module 0x3cb5f0f588c048c11180f6040b49c2b52ec5ddfbc0b1205f6826ba2753474bda::quants {
    ...
    fun init(arg0: QUANTS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<QUANTS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Quants"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"3,000 Quants building on Sui."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://LL7Lcsag4PLtxdYbry7vEkcFPdPLtu-Z1XMyPc2Ey9g"));
