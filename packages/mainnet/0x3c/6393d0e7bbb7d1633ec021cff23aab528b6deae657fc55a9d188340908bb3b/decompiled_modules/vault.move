module 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::vault {
    ...
    struct Vault<phantom T0, phantom T1, phantom T2, T3: copy + drop + store> has key {
        ...
        decimals_a: u8,
        decimals_b: u8,
        config: 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Config<T3>,
    }
    ...
    struct VaultCreatedEvent<T0: copy + drop + store> has copy, drop {
        ...
        fee_val: u64,
        withdraw_fee: u64,
        config: 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Config<T0>,
    }
    ...
    public fun set_target_adapter<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Drift>, arg1: &VaultCap, arg2: 0x1::ascii::String) {
        abort 0
    }

    public fun set_uc_is_target_reverse<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Uncorrelated>, arg1: &VaultCap, arg2: bool) {
        abort 0
    }

    public fun set_uc_target_adapter<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Uncorrelated>, arg1: &VaultCap, arg2: 0x1::ascii::String) {
        abort 0
    }
    ...
    public(friend) fun add_swap_route<T0, T1, T2, T3: copy + drop + store, T4>(arg0: &mut Vault<T0, T1, T2, T3>, arg1: vector<0x7d798502daf9e53a65b7a725c855de31c7887913227b6d155bc49508d757510f::bag_value::Value>, arg2: bool) {
        ...
        assert!(v0 != 0x1::type_name::into_string(0x1::type_name::get<T0>()), 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_route_key());
        assert!(v0 != 0x1::type_name::into_string(0x1::type_name::get<T1>()), 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_route_key());
        assert!(!0x2::bag::contains<0x1::ascii::String>(&arg0.swap_routes, v0), 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_route_key());
        let v1 = SwapRoute{
            route     : arg1,
            returns_x : arg2,
        };
    ...
    public fun assert_rebalance_cap<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>, arg1: &RebalanceCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<Vault<T0, T1, T2, T3>>(arg0) == arg1.vault_id, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_rebalance_cap());
        assert!(arg1.whitelisted_address == 0x2::tx_context::sender(arg2), 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_rebalance_owner());
    }

    public fun borrow_config<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>) : &0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Config<T3> {
        &arg0.config
    }

    public(friend) fun borrow_mut_config<T0, T1, T2, T3: copy + drop + store>(arg0: &mut Vault<T0, T1, T2, T3>) : &mut 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Config<T3> {
        &mut arg0.config
    }
    ...
    public fun check_pool_compatibility<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>, arg1: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>) {
        assert!(arg0.clmm_pool_id == 0x2::object::id<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>>(arg1), 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_pool());
    }

    public fun check_vault_cap_compatibility<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>, arg1: &VaultCap) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1, T2, T3>>(arg0), 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_vault_cap());
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"vault_cap")) {
            let v0 = 0x2::object::id<VaultCap>(arg1);
            assert!(0x2::dynamic_field::borrow<vector<u8>, 0x2::object::ID>(&arg0.id, b"vault_cap") == &v0, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_vault_cap());
        };
    }

    public fun check_vault_cap_uninitialised(arg0: &VaultCap) {
        assert!(arg0.is_initialised == false, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_vault_cap());
    }
    ...
    fun emit_event<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>, arg1: 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Config<T3>) {
    ...
    public fun is_deposit_enabled<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>) : bool {
        *0x2::dynamic_field::borrow<vector<u8>, bool>(&arg0.id, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::constants::deposit_enabled_df_key())
    }
    ...
    public fun issue_rebalance_cap(arg0: &VaultCap, arg1: address, arg2: &0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun mint_vault_coin<T0, T1, T2, T3: copy + drop + store>(arg0: &mut Vault<T0, T1, T2, T3>, arg1: u128, arg2: u128, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        assert!(v0 > 0, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::seed_mint_zero());
    ...
    public fun new_drift_vault<T0, T1, T2>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: 0x2::coin::TreasuryCap<T2>, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u128, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u8, arg14: u8, arg15: u64, arg16: 0x1::ascii::String, arg17: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::total_supply<T2>(&arg1) == 0, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::treasury_cap_supply_non_zero());
        assert!(arg2 > arg3, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_price_scalling());
        let v0 = 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::new_drift_config(arg16, arg4);
        let v1 = Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Drift>{
        ...
        0x2::dynamic_field::add<vector<u8>, bool>(&mut v1.id, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::constants::deposit_enabled_df_key(), true);
        let v2 = VaultCap{
            id             : 0x2::object::new(arg17),
            vault_id       : 0x2::object::id<Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Drift>>(&v1),
            is_initialised : false,
        };
        emit_event<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Drift>(&v1, v0);
        0x2::transfer::share_object<Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Drift>>(v1);
    ...
    public fun new_stable_vault<T0, T1, T2>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: 0x2::coin::TreasuryCap<T2>, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u8, arg11: u8, arg12: u64, arg13: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::total_supply<T2>(&arg1) == 0, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::treasury_cap_supply_non_zero());
        assert!(arg2 > arg3, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_price_scalling());
        let v0 = 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::new_stable_config();
        let v1 = Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Stable>{
        ...
        let v2 = VaultCap{
            id             : 0x2::object::new(arg13),
            vault_id       : 0x2::object::id<Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Stable>>(&v1),
            is_initialised : false,
        };
        emit_event<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Stable>(&v1, v0);
        0x2::transfer::share_object<Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Stable>>(v1);
    ...
    public fun new_uncorrelated_vault<T0, T1, T2>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: 0x2::coin::TreasuryCap<T2>, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u128, arg7: u128, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u8, arg15: u8, arg16: u64, arg17: 0x1::ascii::String, arg18: bool, arg19: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::total_supply<T2>(&arg1) == 0, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::treasury_cap_supply_non_zero());
        assert!(arg4 > arg5, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::upper_lower_trigger_price_incompatible());
        assert!(arg2 > arg3, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_price_scalling());
        let v0 = 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::new_uncorrelated_config(arg17, arg18, 0, 0, arg4, arg5);
        let v1 = Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Uncorrelated>{
        ...
        let v2 = VaultCap{
            id             : 0x2::object::new(arg19),
            vault_id       : 0x2::object::id<Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Uncorrelated>>(&v1),
            is_initialised : false,
        };
        emit_event<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Uncorrelated>(&v1, v0);
        0x2::transfer::share_object<Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Uncorrelated>>(v1);
    ...
    public(friend) fun seed<T0, T1, T2, T3: copy + drop + store>(arg0: &mut Vault<T0, T1, T2, T3>, arg1: 0x2::balance::Balance<T2>) {
        assert!(0x2::balance::value<T2>(&arg0.seed_balance) == 0, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::seed_balance_zero());
    ...
    public(friend) fun set_deposit_enable<T0, T1, T2, T3: copy + drop + store>(arg0: &mut Vault<T0, T1, T2, T3>, arg1: bool) {
        *0x2::dynamic_field::borrow_mut<vector<u8>, bool>(&mut arg0.id, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::constants::deposit_enabled_df_key()) = arg1;
    }
    ...
    public(friend) fun set_fee_val_internal<T0, T1, T2, T3: copy + drop + store>(arg0: &mut Vault<T0, T1, T2, T3>, arg1: u64) {
        assert!(arg1 <= 1000000, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_fee_val());
        arg0.fee_val = arg1;
    }
    ...
    public(friend) fun set_target_adapter_internal<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Drift>, arg1: 0x1::ascii::String) {
        0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::set_target_adapter(borrow_mut_config<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Drift>(arg0), arg1);
    }

    public(friend) fun set_uc_is_target_reverse_internal<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Uncorrelated>, arg1: bool) {
        0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::set_uc_is_target_reverse(borrow_mut_config<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Uncorrelated>(arg0), arg1);
    }

    public(friend) fun set_uc_target_adapter_internal<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Uncorrelated>, arg1: 0x1::ascii::String) {
        0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::set_uc_target_adapter(borrow_mut_config<T0, T1, T2, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::config::Uncorrelated>(arg0), arg1);
    }
    ...
    public fun update_rebalance_cap_ownership(arg0: &VaultCap, arg1: &mut RebalanceCap, arg2: address, arg3: &0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::version::Version) {
        0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::version::assert_supported_version(arg3);
        assert!(arg0.vault_id == arg1.vault_id, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::invalid_rebalance_cap());
    ...
    public fun when_not_paused<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>) {
        assert!(!arg0.paused, 0x3c6393d0e7bbb7d1633ec021cff23aab528b6deae657fc55a9d188340908bb3b::error::vault_paused());
    }
