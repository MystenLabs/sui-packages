module 0x3c9cf57b0ac0963aa6a00860fda32a2c8b9be8ea9a7dbf8df456c799f0f52b7a::bluemove_launchpad {
    ...
    public entry fun burn_nft(arg0: Submarine, arg1: &mut 0x2::tx_context::TxContext) {
        let Submarine {
            id          : v0,
            name        : v1,
            description : _,
        ...
        let v5 = BurnEvent{
            object_id : 0x2::object::id<Submarine>(&arg0),
    ...
    public entry fun claim_nfts(arg0: &mut LaunchpadData, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v11 > 0) {
            ...
            let v18 = MintNFTEvent{
                object_id : 0x2::object::id<Submarine>(&v17),
                creator   : v0,
                name      : v14,
            };
            0x2::event::emit<MintNFTEvent>(v18);
            0x2::transfer::public_transfer<Submarine>(v17, v0);
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = LaunchpadData{
            id             : 0x2::object::new(arg1),
            minted         : 0,
            current_nft    : 0,
            base_name      : 0x1::string::utf8(b"Alpha Goat #"),
            ...
            fund_address   : @0x49cc391ab4d3503e03dbb24c4f9e28f3cdd2ddf8a459e0d43012c3868ffefa1,
            balance        : 0x2::balance::zero<0x2::sui::SUI>(),
            total_nft      : 100,
            pre_mint       : 100,
        };
        let v1 = 0x2::package::claim<BLUEMOVE_LAUNCHPAD>(arg0, arg1);
        let v2 = 0x2::display::new<Submarine>(&v1, arg1);
        0x2::display::add<Submarine>(&mut v2, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<Submarine>(&mut v2, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<Submarine>(&mut v2, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{image_url}"));
        0x2::display::update_version<Submarine>(&mut v2);
        0x2::transfer::public_transfer<0x2::display::Display<Submarine>>(v2, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v1, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<LaunchpadData>(v0);
    }
    ...
    public entry fun pre_nfts(arg0: &mut LaunchpadData, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg1 > 0) {
            ...
            0x2::transfer::public_transfer<Submarine>(v5, arg2);
            arg0.current_nft = v1;
            arg1 = arg1 - 1;
        };
    }
