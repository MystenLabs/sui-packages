module 0x3c4f15d8a2edb8b8490be62168879719facfe8c50296fbde9b6621170b9abe7f::dialog_management {
    ...
    public entry fun send_message(arg0: &mut UserDialogs, arg1: &mut UserDialogHashes, arg2: &mut ChatCounts, arg3: address, arg4: vector<u8>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<address, vector<u8>>(&arg1.dialog_hashes, arg3)) {
            0x2::table::add<address, vector<u8>>(&mut arg1.dialog_hashes, arg3, arg4);
        };
