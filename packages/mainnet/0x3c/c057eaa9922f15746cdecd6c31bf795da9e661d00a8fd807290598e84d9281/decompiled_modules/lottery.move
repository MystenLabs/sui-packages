module 0x3cc057eaa9922f15746cdecd6c31bf795da9e661d00a8fd807290598e84d9281::lottery {
    ...
    public fun buy_ticket<T0>(arg0: u8, arg1: vector<u8>, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut Jackpot<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun claim_prize<T0>(arg0: Ticket<T0>, arg1: &mut DrawResult<T0>, arg2: &mut Jackpot<T0>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_jackpot<T0>(arg0: &AdminCap, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Jackpot<T0>{
    ...
    public fun execute_draw<T0>(arg0: &AdminCap, arg1: &mut Jackpot<T0>, arg2: &0x2::random::Random, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun reclaim_unclaimed_prize<T0>(arg0: &AdminCap, arg1: &mut DrawResult<T0>, arg2: &mut Jackpot<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(v0 < 10000000000000, 12);
        assert!(arg2.game_type == arg1.game_type, 5);
        assert!(!arg1.claimed, 10);
