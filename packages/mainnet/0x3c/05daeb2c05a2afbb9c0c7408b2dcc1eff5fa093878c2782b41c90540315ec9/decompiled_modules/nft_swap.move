module 0x3c05daeb2c05a2afbb9c0c7408b2dcc1eff5fa093878c2782b41c90540315ec9::nft_swap {
    ...
    public fun accept_trade_improved<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        while (v27 < 0x1::vector::length<0x2::object::ID>(&v13)) {
            ...
            let v32 = 0x2::transfer_policy::paid<T0>(&v31);
            if (v32 > 0) {
                let v33 = 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<T0>(arg6, v32);
                if (v33 > 0) {
                    0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg6, &mut v31, 0x2::coin::split<0x2::sui::SUI>(arg5, v33, arg7));
                };
            };
            let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg6, v31);
            v27 = v27 + 1;
        };
        let v37 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Trade>(&mut arg0.id, arg4);
        let v38 = 0;
        while (v38 < 0x1::vector::length<0x2::object::ID>(&v11)) {
            let v39 = *0x1::vector::borrow<0x2::object::ID>(&v11, v38);
            let v40 = 0x2::bcs::to_bytes<0x2::object::ID>(&v39);
            if (0x2::dynamic_object_field::exists_<vector<u8>>(&v37.id, v40)) {
                let (v41, v42) = 0x2::kiosk::purchase_with_cap<T0>(arg1, 0x2::dynamic_object_field::remove<vector<u8>, 0x2::kiosk::PurchaseCap<T0>>(&mut v37.id, v40), 0x2::coin::zero<0x2::sui::SUI>(arg7));
                let v43 = v42;
                0x2::kiosk::lock<T0>(arg2, arg3, arg6, v41);
                0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T0>(&mut v43, arg2);
                let v44 = 0x2::transfer_policy::paid<T0>(&v43);
                if (v44 > 0) {
                    let v45 = 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<T0>(arg6, v44);
                    if (v45 > 0) {
                        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg6, &mut v43, 0x2::coin::split<0x2::sui::SUI>(arg5, v45, arg7));
                    };
                };
                let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg6, v43);
            };
            v38 = v38 + 1;
        };
        if (v10 > 0) {
        ...
        0x2::event::emit<TradeAcceptedEvent>(v49);
        let Trade {
            id                 : v50,
            creator            : _,
            creator_items      : _,
