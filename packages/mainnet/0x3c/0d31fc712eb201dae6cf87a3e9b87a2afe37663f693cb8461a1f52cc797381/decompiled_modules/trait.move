module 0x3c0d31fc712eb201dae6cf87a3e9b87a2afe37663f693cb8461a1f52cc797381::trait {
    ...
    public fun from_trait_types_values<T0: copy, T1>(arg0: vector<T0>, arg1: vector<T1>) : VecMap<T0, T1> {
    ...
    public fun get_idx_opt<T0: copy, T1>(arg0: &VecMap<T0, T1>, arg1: &T0) : 0x1::option::Option<u64> {
        ...
        while (v0 < size<T0, T1>(arg0)) {
            if (&0x1::vector::borrow<Entry<T0, T1>>(&arg0.contents, v0).trait_type == arg1) {
    ...
    public fun into_trait_types_values<T0: copy, T1>(arg0: VecMap<T0, T1>) : (vector<T0>, vector<T1>) {
        let VecMap { contents: v0 } = arg0;
    ...
    public fun trait_types<T0: copy, T1>(arg0: &VecMap<T0, T1>) : vector<T0> {
        let v0 = 0;
        let v1 = 0x1::vector::empty<T0>();
        while (v0 < 0x1::vector::length<Entry<T0, T1>>(&arg0.contents)) {
            0x1::vector::push_back<T0>(&mut v1, 0x1::vector::borrow<Entry<T0, T1>>(&arg0.contents, v0).trait_type);
            v0 = v0 + 1;
        };
        v1
    }
