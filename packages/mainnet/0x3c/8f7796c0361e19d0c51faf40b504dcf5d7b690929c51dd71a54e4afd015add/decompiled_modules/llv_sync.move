module 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_sync {
    ...
    public(friend) fun sync_protocol_balance_guarded<T0, T1>(arg0: &mut 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::LLVPool<T0, T1>, arg1: u8, arg2: u128, arg3: &0x2::clock::Clock) {
        let v0 = 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::get_protocol_balance<T0, T1>(arg0, arg1);
        if (v0 == 0) {
            assert!(arg2 == 0 || 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::get_protocol_deposited_amount<T0, T1>(arg0, arg1) == 0 && arg2 <= 0x1::u128::pow(10, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::asset_decimals<T0, T1>(arg0) - 3), 1);
        } else if (arg2 != v0) {
            let v1 = if (arg2 > v0) {
                arg2 - v0
            } else {
            ...
            let v3 = 0x1::u128::pow(10, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::asset_decimals<T0, T1>(arg0) - 3);
            let v4 = if (v2 > v3) {
                v2
            } else {
                v3
