module 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy {
    struct Request {
    ...
    public(friend) fun add_receipt<T0>(arg0: &mut Request) {
        0x2::vec_set::insert<0x1::string::String>(&mut arg0.receipts, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::get_key_by_struct<T0>());
    }

    public(friend) fun add_rule<T0, T1: drop + store>(arg0: &mut Policy, arg1: T1) {
        let v0 = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::get_key_by_struct<T0>();
    ...
    public(friend) fun get_rule<T0, T1: drop + store>(arg0: &Policy) : &T1 {
        0x2::dynamic_field::borrow<0x1::string::String, T1>(&arg0.id, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::get_key_by_struct<T0>())
    }

    public(friend) fun get_rule_mut<T0, T1: drop + store>(arg0: &mut Policy) : &mut T1 {
        0x2::dynamic_field::borrow_mut<0x1::string::String, T1>(&mut arg0.id, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::get_key_by_struct<T0>())
    }
