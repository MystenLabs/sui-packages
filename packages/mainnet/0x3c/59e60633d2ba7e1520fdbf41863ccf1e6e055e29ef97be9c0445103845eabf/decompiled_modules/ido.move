module 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::ido {
    struct Round has store, key {
        id: 0x2::object::UID,
        name: 0x1::string::String,
        project: 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::project::ProjectInfo,
    ...
    public(friend) fun add_payment<T0>(arg0: &mut Round, arg1: u64, arg2: u8, arg3: u8) {
        assert!(arg3 <= 18, 304);
        let v0 = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::get_full_type<T0>();
        ...
        let v3 = Payment{
            ...
            ratio_decimal   : arg2,
            method_type     : 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::get_full_type<T0>(),
    ...
    public(friend) fun airdrop_vesting(arg0: &0x2::clock::Clock, arg1: &mut Round, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service::Service>(&mut arg1.other, 0x1::string::utf8(b"SERVICE"));
        let v2 = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_vesting::get_id(v1);
        let v3 = AdminVesting{
        ...
        while (!0x1::vector::is_empty<address>(&arg2) && !0x1::vector::is_empty<u64>(&arg3)) {
            0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_vesting::execute_add_vesting(v1, 0x1::vector::pop_back<u64>(&mut arg3), 0x1::vector::pop_back<address>(&mut arg2));
        };
    ...
    fun cal_payment_amount(arg0: &0x2::vec_map::VecMap<0x1::string::String, Payment>, arg1: 0x1::string::String, arg2: u64, arg3: u8) : u64 {
        ...
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::mul_u64_div_decimal(0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::mul_u64_div_decimal(v0.ratio_per_token, arg2, v0.ratio_decimal), (0x2::math::pow(10, v0.payment_decimal) as u64), arg3)
    }

    public fun claim_refund_preregister<T0>(arg0: &0x2::clock::Clock, arg1: &mut Round, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::get_full_type<T0>();
        ...
        let v2 = 0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service::Service>(&mut arg1.other, 0x1::string::utf8(b"SERVICE"));
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_preregister::validate_claim_refund(v2);
        ...
        if (arg1.total_sold > arg1.total_supply) {
            let v4 = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::mul_u64_div_u64(0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::mul_u64_div_u64(v3.total_accumulate_token, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::max_percent(), arg1.total_sold), arg1.total_supply, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::max_percent());
            let v5 = v3.total_accumulate_token - v4;
            0x1::option::fill<u64>(&mut v3.final_accumulate_token, v4);
            0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_vesting::execute_sub_vesting(v2, v5, v0);
            0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::vault::withdraw<T0>(0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::vault::Vaults>(&mut arg1.other, 0x1::string::utf8(b"VAULT")), cal_payment_amount(&arg1.payments, v1, v5, arg1.token_decimal), v0, arg2);
        } else {
    ...
    public fun claim_vesting<T0>(arg0: &0x2::clock::Clock, arg1: &mut Round, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service::Service>(&mut arg1.other, 0x1::string::utf8(b"SERVICE"));
        let v2 = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_vesting::update_withdraw(arg0, v1, arg2, v0);
        let v3 = 0;
        if (!0x2::vec_set::contains<u8>(&arg1.purchase_type, &v3)) {
            let v4 = 0x2::dynamic_field::borrow<address, Invest>(&arg1.id, v0);
            if (0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_preregister::is_use_preregister(v1)) {
                assert!(!0x1::option::is_none<u64>(&v4.final_accumulate_token), 313);
            };
        };
        assert!(v2 > 0, 300);
        assert!(0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_vesting::check_is_open_claim_vesting(v1), 301);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::vault::withdraw<T0>(0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::vault::Vaults>(&mut arg1.other, 0x1::string::utf8(b"VAULT")), v2, v0, arg3);
        let v5 = ClaimVesting{
            round_id       : 0x2::object::uid_to_inner(&arg1.id),
            period_id_list : arg2,
            total_claim    : v2,
    ...
    public(friend) fun get_mut_policy(arg0: &mut Round) : &mut 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy::Policy {
        0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy::Policy>(&mut arg0.other, 0x1::string::utf8(b"POLICY"))
    }

    public(friend) fun get_mut_service(arg0: &mut Round) : &mut 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service::Service {
        0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service::Service>(&mut arg0.other, 0x1::string::utf8(b"SERVICE"))
    }

    public(friend) fun get_mut_vault(arg0: &mut Round) : &mut 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::vault::Vaults {
        0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::vault::Vaults>(&mut arg0.other, 0x1::string::utf8(b"VAULT"))
    }

    public fun get_project(arg0: &Round) : 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::project::ProjectInfo {
        arg0.project
    }
    ...
    fun handle_cert(arg0: &mut Round, arg1: u64, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::vec_set::contains<address>(&arg0.participants, &v0)) {
            ...
            0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::certificate::issue_investment_certificate(arg1, arg0.project, arg0.name, arg0.token_type, arg2, arg3);
        };
    }
    ...
    fun handle_cert_with_user(arg0: &mut Round, arg1: u64, arg2: 0x2::object::ID, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        if (!0x2::vec_set::contains<address>(&arg0.participants, &arg3)) {
            ...
            0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::certificate::issue_investment_certificate_with_user(arg1, arg0.project, arg0.name, arg0.token_type, arg2, arg3, arg4);
        };
    }
    ...
    fun new_policy(arg0: &mut 0x2::vec_map::VecMap<0x1::string::String, 0x2::object::ID>, arg1: &mut 0x2::object_bag::ObjectBag, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy::new(arg2);
        0x2::vec_map::insert<0x1::string::String, 0x2::object::ID>(arg0, v0, v2);
        0x2::object_bag::add<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy::Policy>(arg1, v0, v1);
    }

    public(friend) fun new_round<T0>(arg0: 0x1::string::String, arg1: 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::project::ProjectInfo, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) : Round {
        ...
        let v10 = NewRound{
            ...
            round_name    : arg0,
            project_name  : 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::project::get_project_name(&arg1),
            token_type    : v1,
            token_decimal : arg2,
            total_supply  : arg5,
    ...
    fun new_service(arg0: &mut 0x2::vec_map::VecMap<0x1::string::String, 0x2::object::ID>, arg1: &mut 0x2::object_bag::ObjectBag, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service::new(arg2);
        0x2::vec_map::insert<0x1::string::String, 0x2::object::ID>(arg0, v0, v2);
        0x2::object_bag::add<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service::Service>(arg1, v0, v1);
    }
    ...
    fun new_vault(arg0: &mut 0x2::vec_map::VecMap<0x1::string::String, 0x2::object::ID>, arg1: &mut 0x2::object_bag::ObjectBag, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::vault::new(arg2);
        0x2::vec_map::insert<0x1::string::String, 0x2::object::ID>(arg0, v0, v2);
        0x2::object_bag::add<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::vault::Vaults>(arg1, v0, v1);
    }
    ...
    public fun purchase_nor<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut Round, arg2: u64, arg3: vector<0x2::coin::Coin<T1>>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::get_full_type<T1>();
        ...
        let v9 = 0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy::Policy>(&mut arg1.other, 0x1::string::utf8(b"POLICY"));
        let v10 = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy::new_request(0x2::object::uid_to_inner(&arg1.id));
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy_purchase::check(v9, &mut v10, arg2);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy_whitelist::check(v9, &mut v10, arg4);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy_yousui_nft::pass(v9, &mut v10);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy::confirm_request(v9, v10);
        update_state_purchase<T1>(arg1, arg2, v3, arg3, arg4);
        let v11 = 0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service::Service>(&mut arg1.other, 0x1::string::utf8(b"SERVICE"));
        let v12 = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_vesting::get_id(v11);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_preregister::validate_purchase(v11, arg1.total_sold, arg1.total_supply);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_vesting::execute_add_vesting(v11, arg2, v1);
        let v13 = Purchase{
            round_id            : 0x2::object::uid_to_inner(&arg1.id),
            token_amount        : arg2,
            payment_amount      : v3,
    ...
    public fun purchase_ref<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut Round, arg2: u64, arg3: vector<0x2::coin::Coin<T1>>, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = 0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service::Service>(&mut arg1.other, 0x1::string::utf8(b"SERVICE"));
        let v12 = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_vesting::get_id(v11);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_affiliate::add_profit_by_affiliate<T1>(v11, arg4, v3);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_preregister::validate_purchase(v11, arg1.total_sold, arg1.total_supply);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_vesting::execute_add_vesting(v11, arg2, v1);
        let v13 = Purchase{
            round_id            : 0x2::object::uid_to_inner(&arg1.id),
    ...
    public fun purchase_yousui_og_holder<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut Round, arg2: u64, arg3: vector<0x2::coin::Coin<T1>>, arg4: &0x6a29b3b80de2bd69ee94b2a2f11e5bf2e3614d1cc08f1cb16eefa290bc859cb0::nft::YOUSUINFT, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy::new_request(0x2::object::uid_to_inner(&arg1.id));
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy_purchase::check(v9, &mut v10, arg2);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy_yousui_nft::check(v9, &mut v10, arg4);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy_whitelist::pass(v9, &mut v10);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::policy::confirm_request(v9, v10);
        update_state_purchase<T1>(arg1, arg2, v3, arg3, arg5);
        let v11 = 0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service::Service>(&mut arg1.other, 0x1::string::utf8(b"SERVICE"));
        let v12 = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::service_vesting::get_id(v11);
    ...
    fun update_state_purchase<T0>(arg0: &mut Round, arg1: u64, arg2: u64, arg3: vector<0x2::coin::Coin<T0>>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let (v0, v1) = 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::utils::merge_and_split<T0>(arg3, arg2, arg4);
        0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::vault::deposit<T0>(0x2::object_bag::borrow_mut<0x1::string::String, 0x9ec7fc7165fe5558574ae87120f8a469686dc56877fa2e4ad4ee6b8c3907a965::vault::Vaults>(&mut arg0.other, 0x1::string::utf8(b"VAULT")), v0, arg4);
