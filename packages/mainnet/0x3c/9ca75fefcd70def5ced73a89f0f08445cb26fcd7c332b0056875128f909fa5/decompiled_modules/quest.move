module 0x3c9ca75fefcd70def5ced73a89f0f08445cb26fcd7c332b0056875128f909fa5::quest {
    ...
    public fun create_journey(arg0: &mut SpaceHub, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &SpaceAdminCap, arg3: &mut Space, arg4: u64, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x3c9ca75fefcd70def5ced73a89f0f08445cb26fcd7c332b0056875128f909fa5::utils::handle_payment<0x2::sui::SUI>(&mut arg0.balance, arg1, arg0.fee_for_creating_journey, arg11);
        let v0 = Journey{
    ...
    public fun start_quest(arg0: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut Space, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        check_space_version(arg1);
        0x2::pay::split_and_transfer<0x2::sui::SUI>(arg0, 10000000, @0xfa40dda8beaf0bee40130a32df04bc74bb8a4bc85b2d27c54289fe8676d5f977, arg5);
        let v0 = 0x2::object_table::borrow_mut<0x2::object::ID, Journey>(&mut arg1.journeys, arg2);
        assert!(0x2::clock::timestamp_ms(arg4) >= v0.start_time && 0x2::clock::timestamp_ms(arg4) <= v0.end_time, 4);
        let v1 = 0x2::object_table::borrow_mut<0x2::object::ID, Quest>(&mut v0.quests, arg3);
        assert!(!0x2::table::contains<address, bool>(&v1.completed_users, 0x2::tx_context::sender(arg5)), 7);
        0x2::table::add<address, bool>(&mut v1.completed_users, 0x2::tx_context::sender(arg5), false);
    }
    ...
    entry fun withdraw(arg0: &AdminCap, arg1: &mut SpaceHub, arg2: &mut 0x2::tx_context::TxContext) {
        check_hub_version(arg1);
        0x3c9ca75fefcd70def5ced73a89f0f08445cb26fcd7c332b0056875128f909fa5::utils::withdraw_balance<0x2::sui::SUI>(&mut arg1.balance, arg2);
    }
