module 0x3c79a7a02fdbc00440ca84e82881fbe5789b6cb346b7ef63e3634fd1bbba34ed::reward9518 {
    struct REWARD9518 has drop {
        dummy_field: bool,
    }

    struct TICKET_9518 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9518(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9518>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9518>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9518, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9518>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9518>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9518>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9518>>(v5, 0x2::tx_context::sender(arg1));
    }
