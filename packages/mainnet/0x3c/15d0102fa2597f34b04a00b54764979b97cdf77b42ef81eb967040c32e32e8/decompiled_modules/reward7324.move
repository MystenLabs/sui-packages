module 0x3c15d0102fa2597f34b04a00b54764979b97cdf77b42ef81eb967040c32e32e8::reward7324 {
    struct REWARD7324 has drop {
        dummy_field: bool,
    }

    struct TICKET_7324 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7324(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7324>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7324>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7324, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7324>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7324>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7324>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7324>>(v5, 0x2::tx_context::sender(arg1));
    }
