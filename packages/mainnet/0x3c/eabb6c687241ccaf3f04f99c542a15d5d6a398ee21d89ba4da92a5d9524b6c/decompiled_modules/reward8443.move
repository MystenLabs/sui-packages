module 0x3ceabb6c687241ccaf3f04f99c542a15d5d6a398ee21d89ba4da92a5d9524b6c::reward8443 {
    struct REWARD8443 has drop {
        dummy_field: bool,
    }

    struct TICKET_8443 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8443(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8443>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8443>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8443, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8443>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8443>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8443>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8443>>(v5, 0x2::tx_context::sender(arg1));
    }
