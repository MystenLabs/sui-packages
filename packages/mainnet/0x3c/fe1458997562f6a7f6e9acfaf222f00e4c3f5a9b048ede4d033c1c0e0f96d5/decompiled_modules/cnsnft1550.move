module 0x3cfe1458997562f6a7f6e9acfaf222f00e4c3f5a9b048ede4d033c1c0e0f96d5::cnsnft1550 {
    struct CNSNFT1550 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1550, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6292"));
        let v4 = 0x2::package::claim<CNSNFT1550>(arg0, arg1);
