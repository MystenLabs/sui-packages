module 0x3cc7586327a4449d7949cf2de24db19ca4a7cc02df571f63abdb676dabeb5f4d::usdd {
    ...
    fun init(arg0: USDD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://gateway.irys.xyz/9uCd4bidEBCgEHyjrDH5fqbnAjoLKhc4KGnmhkzADDhJ                                                                                                                                                                                                                                                           ");
