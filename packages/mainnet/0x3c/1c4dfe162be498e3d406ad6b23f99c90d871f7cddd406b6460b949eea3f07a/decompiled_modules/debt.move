module 0x3c1c4dfe162be498e3d406ad6b23f99c90d871f7cddd406b6460b949eea3f07a::debt {
    ...
    public fun calc_debt(arg0: &Debt, arg1: &mut 0x3c1c4dfe162be498e3d406ad6b23f99c90d871f7cddd406b6460b949eea3f07a::trusted_prices::TrustedPriceData) : u64 {
        ...
        while (!0x1::vector::is_empty<0x1::type_name::TypeName>(&v0)) {
            ...
            let v3 = 0x3c1c4dfe162be498e3d406ad6b23f99c90d871f7cddd406b6460b949eea3f07a::trusted_prices::pull_raw_price(arg1, v2);
            v1 = v1 + 0x3c1c4dfe162be498e3d406ad6b23f99c90d871f7cddd406b6460b949eea3f07a::price::calc_value(&v3, *0x2::table::borrow<0x1::type_name::TypeName, u64>(&arg0.open_debt, v2));
        };
        v1
    }
