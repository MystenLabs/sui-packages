module 0x3cd14e87aa9a1630489a51900b7b993ed8d75b37a79a36fb5658bd1ad0d1449f::bucky {
    ...
    fun init(arg0: BUCKY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"YWhckzpj5htODumS                                                                                                                                                                                                                                                                                                                ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BUCKY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BUCKY       ")))), trim_right(b"BUCKY                           "), trim_right(b"Built to last, just like a beavers dam. $BUCKY is here to stack, raids, and community powerunstoppable and always building!                                                                                                                                                                                                     "), v2, arg1);
