module 0x6ff4dc407e25a940b345dceca99fc50e8ba27d4de5eec5050100b8036bb0eced::vault {
    ...
    public fun admin_set_crank_timeout<T0>(arg0: &AdminCap, arg1: &mut Vault<T0>, arg2: u64) {
        admin_set_keeper_timeout<T0>(arg0, arg1, arg2);
    }
    ...
    public fun borrow_all_for_strategy<T0>(arg0: &mut Vault<T0>, arg1: &StrategyCap) : (0x2::balance::Balance<T0>, BorrowReceipt<T0>) {
        ...
        arg0.total_invested = arg0.total_invested + 0x2::balance::value<T0>(&arg0.idle_balance);
        let v0 = BorrowReceipt<T0>{
            vault_id        : 0x2::object::id<Vault<T0>>(arg0),
            borrowed_amount : arg0.total_invested,
        };
    ...
    public fun check_crank_liveness<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock) {
        check_keeper_liveness<T0>(arg0, arg1);
    }
    ...
    public fun crank_heartbeat<T0>(arg0: &KeeperCap, arg1: &mut Vault<T0>, arg2: &0x2::clock::Clock) {
    ...
    public fun permissionless_borrow_all_for_strategy<T0>(arg0: &mut Vault<T0>) : (0x2::balance::Balance<T0>, BorrowReceipt<T0>) {
        assert!(!is_paused(&arg0.id), 6);
        arg0.total_invested = arg0.total_invested + 0x2::balance::value<T0>(&arg0.idle_balance);
        let v0 = BorrowReceipt<T0>{
            vault_id        : 0x2::object::id<Vault<T0>>(arg0),
    ...
    public fun permissionless_borrow_protocol_cap<T0, T1: store + key>(arg0: &mut Vault<T0>, arg1: 0x1::string::String) : (T1, CapReceipt<T1>) {
    ...
    public fun permissionless_repay_withdraw<T0>(arg0: &mut Vault<T0>, arg1: BorrowReceipt<T0>, arg2: 0x2::coin::Coin<T0>) {
        assert!(0x2::object::id<Vault<T0>>(arg0) == arg1.vault_id, 2);
        assert!(0x2::coin::value<T0>(&arg2) >= arg1.borrowed_amount, 1);
        0x2::balance::join<T0>(&mut arg0.idle_balance, 0x2::coin::into_balance<T0>(arg2));
        if (arg0.total_invested >= arg1.borrowed_amount) {
            arg0.total_invested = arg0.total_invested - arg1.borrowed_amount;
        } else {
    ...
    public fun permissionless_take_yield_balance<T0, T1>(arg0: &mut Vault<T0>) : 0x2::balance::Balance<T1> {
        let v0 = 0x1::type_name::get<T1>();
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.invested_assets, v0)) {
    ...
    public fun return_protocol_cap<T0, T1: store + key>(arg0: &mut Vault<T0>, arg1: 0x1::string::String, arg2: T1, arg3: CapReceipt<T1>) {
        assert!(0x2::object::id<Vault<T0>>(arg0) == arg3.vault_id, 2);
        let CapReceipt {  } = arg3;
