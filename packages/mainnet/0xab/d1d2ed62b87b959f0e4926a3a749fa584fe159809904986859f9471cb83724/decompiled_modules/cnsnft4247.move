module 0xabd1d2ed62b87b959f0e4926a3a749fa584fe159809904986859f9471cb83724::cnsnft4247 {
    struct CNSNFT4247 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4247, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4247>(arg0, arg1);
