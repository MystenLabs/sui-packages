module 0xabafca3c9f6ec389cf9d2ea1b0f0da3e4d98a2b21ad0214a66391122ca71af87::cnsnft7726 {
    struct CNSNFT7726 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7726, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7726>(arg0, arg1);
