module 0xabaa4ae14d6ebb9217b93740a67bb524693f0977f0eb5af40cca0ee5342d63bb::reward9326 {
    struct REWARD9326 has drop {
        dummy_field: bool,
    }

    struct TICKET_9326 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9326(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9326>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9326>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9326, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9326>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9326>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9326>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9326>>(v5, 0x2::tx_context::sender(arg1));
    }
