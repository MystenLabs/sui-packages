module 0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::acl::ACL,
    ...
    public fun add_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        ...
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::acl::Member> {
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        checked_package_version(arg1);
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public fun checked_keeper(arg0: &GlobalConfig, arg1: address) {
        assert!(0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::acl::has_role(&arg0.acl, arg1, 1), 2);
    }
    ...
    public fun checked_token_white_list_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::acl::has_role(&arg0.acl, arg1, 0), 1);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                            : 0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::acl::new(arg0),
