module 0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::limit_order {
    ...
    struct RateOrdersIndexer<phantom T0, phantom T1> has store, key {
        id: 0x2::object::UID,
        indexer: 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::skip_list_u128::SkipList<0x2::table::Table<0x2::object::ID, bool>>,
        size: u64,
    }
    ...
    fun add_order_indexes<T0, T1>(arg0: &LimitOrder<T0, T1>, arg1: &mut RateOrdersIndexer<T0, T1>, arg2: &mut UserOrdersIndexer, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::skip_list_u128::contains<0x2::table::Table<0x2::object::ID, bool>>(&arg1.indexer, arg0.rate)) {
            0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::skip_list_u128::insert<0x2::table::Table<0x2::object::ID, bool>>(&mut arg1.indexer, arg0.rate, 0x2::table::new<0x2::object::ID, bool>(arg3));
        };
        let v1 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::skip_list_u128::borrow_mut<0x2::table::Table<0x2::object::ID, bool>>(&mut arg1.indexer, arg0.rate);
    ...
    public fun cancel_order_by_keeper<T0, T1>(arg0: &0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::GlobalConfig, arg1: &mut RateOrdersIndexer<T0, T1>, arg2: &mut LimitOrder<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_package_version(arg0);
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_keeper(arg0, 0x2::tx_context::sender(arg4));
        let v0 = 0;
    ...
    public fun cancel_order_by_owner<T0, T1>(arg0: &0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::GlobalConfig, arg1: &mut RateOrdersIndexer<T0, T1>, arg2: &mut LimitOrder<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_package_version(arg0);
        assert!(arg2.owner == 0x2::tx_context::sender(arg4), 13);
        cancel_order<T0, T1>(arg1, arg2, 2, arg3, arg4);
    }

    public fun claim_target_coin<T0, T1>(arg0: &0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::GlobalConfig, arg1: &mut LimitOrder<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_package_version(arg0);
    ...
    public entry fun create_indexer_and_place_limit_order<T0, T1>(arg0: &0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::GlobalConfig, arg1: &mut RateOrdersIndexers, arg2: &mut UserOrdersIndexer, arg3: 0x2::coin::Coin<T0>, arg4: u128, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_package_version(arg0);
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_pool_token_types<T0, T1>(arg0);
        assert!(arg4 > 0, 15);
        let v0 = 0x2::clock::timestamp_ms(arg6);
        assert!(arg5 > v0, 18);
        let v1 = create_rate_orders_indexer_internal<T0, T1>(arg0, arg1, v0, arg7);
        assert!(0x2::coin::value<T0>(&arg3) > 0, 19);
        let v2 = 0x2::coin::into_balance<T0>(arg3);
        let v3 = 0x2::object::id<RateOrdersIndexer<T0, T1>>(&v1);
        if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_ceil((0x2::balance::value<T0>(&v2) as u128), 1000000000000000000, arg4) > 18446744073709551615) {
            abort 16
        };
        let v4 = new_limit_order<T0, T1>(v2, v3, arg4, v0, arg5, arg7);
        ...
        let v6 = &mut v1;
        add_order_indexes<T0, T1>(&v4, v6, arg2, arg7);
        0x2::transfer::public_share_object<RateOrdersIndexer<T0, T1>>(v1);
        0x2::transfer::public_share_object<LimitOrder<T0, T1>>(v4);
    }

    public entry fun create_rate_orders_indexer<T0, T1>(arg0: &0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::GlobalConfig, arg1: &mut RateOrdersIndexers, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_package_version(arg0);
    ...
    fun create_rate_orders_indexer_internal<T0, T1>(arg0: &0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::GlobalConfig, arg1: &mut RateOrdersIndexers, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : RateOrdersIndexer<T0, T1> {
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_pool_token_types<T0, T1>(arg0);
    ...
    fun delete_limit_order<T0, T1>(arg0: &0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::GlobalConfig, arg1: LimitOrder<T0, T1>, arg2: &mut UserOrdersIndexer, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg1.canceled_ts != 18446744073709551615, 8);
        assert!(0x2::clock::timestamp_ms(arg3) > arg1.canceled_ts + 0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::get_config_deletion_grace_period(arg0), 12);
        delete_user_order_indexs<T0, T1>(&arg1, arg2, arg4);
        destory_limit_order<T0, T1>(arg1);
    }

    public fun delete_order<T0, T1>(arg0: &0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::GlobalConfig, arg1: LimitOrder<T0, T1>, arg2: &mut UserOrdersIndexer, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_package_version(arg0);
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_keeper(arg0, 0x2::tx_context::sender(arg4));
    ...
    fun delete_rate_order_indexs<T0, T1>(arg0: &LimitOrder<T0, T1>, arg1: &mut RateOrdersIndexer<T0, T1>) {
        ...
        0x2::table::remove<0x2::object::ID, bool>(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::skip_list_u128::borrow_mut<0x2::table::Table<0x2::object::ID, bool>>(&mut arg1.indexer, arg0.rate), 0x2::object::uid_to_inner(&arg0.id));
        arg1.size = arg1.size - 1;
    }
    ...
    public fun flash_loan<T0, T1>(arg0: &0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::GlobalConfig, arg1: &mut LimitOrder<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanReceipt<T1>) {
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_package_version(arg0);
        let v0 = 0x2::tx_context::sender(arg4);
        if (0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::get_config_require_flash_loan_auth(arg0)) {
            0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_keeper(arg0, v0);
        };
        assert!(arg2 > 0, 5);
        assert!(0x2::clock::timestamp_ms(arg3) < arg1.expire_ts, 6);
        assert!(0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::check_token_and_min_trade_amount<T0>(arg0, arg2), 14);
    ...
    public entry fun get_orders_indexer_by_rate<T0, T1>(arg0: u128, arg1: &RateOrdersIndexer<T0, T1>) {
        let v0 = QueryRateIndexerEvent{
            rate            : arg0,
            orders_table_id : 0x2::object::id<0x2::table::Table<0x2::object::ID, bool>>(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::skip_list_u128::borrow<0x2::table::Table<0x2::object::ID, bool>>(&arg1.indexer, arg0)),
        };
    ...
    fun new_rate_orders_indexer<T0, T1>(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : RateOrdersIndexer<T0, T1> {
        RateOrdersIndexer<T0, T1>{
            id      : 0x2::object::new(arg1),
            indexer : 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::skip_list_u128::new<0x2::table::Table<0x2::object::ID, bool>>(20, 2, arg0, arg1),
            size    : 0,
        }
    }

    public entry fun place_limit_order<T0, T1>(arg0: &0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::GlobalConfig, arg1: &mut RateOrdersIndexer<T0, T1>, arg2: &mut UserOrdersIndexer, arg3: 0x2::coin::Coin<T0>, arg4: u128, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_package_version(arg0);
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_pool_token_types<T0, T1>(arg0);
        assert!(arg4 > 0, 15);
        assert!(0x2::coin::value<T0>(&arg3) > 0, 19);
    ...
    public fun repay_flash_loan<T0, T1>(arg0: &0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::GlobalConfig, arg1: &mut 0x2::coin::Coin<T1>, arg2: &mut LimitOrder<T0, T1>, arg3: FlashLoanReceipt<T1>, arg4: &mut 0x2::tx_context::TxContext) {
        0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_package_version(arg0);
        let v0 = 0x2::tx_context::sender(arg4);
        if (0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::get_config_require_flash_loan_auth(arg0)) {
            0xabfcbd0aa1716eacf9db38c9c826d13d58bea18902101caf89224f36d8d37182::config::checked_keeper(arg0, v0);
