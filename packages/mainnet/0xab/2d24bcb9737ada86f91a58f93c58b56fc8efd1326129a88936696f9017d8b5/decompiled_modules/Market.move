module 0x3164fcf73eb6b41ff3d2129346141bd68469964c2d95a5b1533e8d16e6ea6e13::Market {
    ...
    public fun buy_generic_with_price<T0: store + key, T1>(arg0: &0x56714d6578dafaaec566c1483ac0fc5fb206b506455a8d59b043d67d243243eb::version::Version, arg1: &mut Listing<T1>, arg2: u64, arg3: &mut 0x3164fcf73eb6b41ff3d2129346141bd68469964c2d95a5b1533e8d16e6ea6e13::marketplace::MarketPlace<T1>, arg4: 0x2::coin::Coin<T1>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(arg2 == arg1.price, 1);
        let v0 = 0x2::coin::balance_mut<T1>(&mut arg4);
        let v1 = 0x3164fcf73eb6b41ff3d2129346141bd68469964c2d95a5b1533e8d16e6ea6e13::marketplace::calc_market_fee<T1>(arg3, arg1.price);
        0x3164fcf73eb6b41ff3d2129346141bd68469964c2d95a5b1533e8d16e6ea6e13::marketplace::deposit_profit<T1>(arg3, 0x2::balance::split<T1>(v0, v1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(v0, arg1.price - v1, arg5), arg1.seller);
        let v2 = arg1.seller;
    ...
    public fun buy_with_sui_with_price<T0: store + key>(arg0: &0x56714d6578dafaaec566c1483ac0fc5fb206b506455a8d59b043d67d243243eb::version::Version, arg1: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg2: &mut Listing<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x3164fcf73eb6b41ff3d2129346141bd68469964c2d95a5b1533e8d16e6ea6e13::marketplace::MarketPlace<0x2::sui::SUI>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v1 = 0x3164fcf73eb6b41ff3d2129346141bd68469964c2d95a5b1533e8d16e6ea6e13::marketplace::calc_market_fee<0x2::sui::SUI>(arg4, arg2.price);
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg1, &mut v3, 0x2::coin::take<0x2::sui::SUI>(v0, v2, arg6));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg1, v3);
        0x3164fcf73eb6b41ff3d2129346141bd68469964c2d95a5b1533e8d16e6ea6e13::marketplace::deposit_profit<0x2::sui::SUI>(arg4, 0x2::balance::split<0x2::sui::SUI>(v0, v1));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(v0, arg2.price - v1 - v2, arg6), arg2.seller);
        let v7 = arg2.seller;
