module 0xabe56a177cd656030e4e4156f8bb45d75c7d22e4ec54804b6f80a986741b4579::reflection {
    ...
    public entry fun transfer(arg0: &mut 0x2::coin::Coin<REFLECTION>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        public_transfer(arg0, arg1, arg2, arg3);
    }

    public fun public_transfer(arg0: &mut 0x2::coin::Coin<REFLECTION>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = arg1 * 5 / 100;
