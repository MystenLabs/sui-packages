module 0xaba43cee4bebe39c2b9adc549c563f76f6e7d351ace5593241944db0891e1d0b::gift5532 {
    struct GIFT5532 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift5532(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT5532, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5532>(arg0, arg1);
