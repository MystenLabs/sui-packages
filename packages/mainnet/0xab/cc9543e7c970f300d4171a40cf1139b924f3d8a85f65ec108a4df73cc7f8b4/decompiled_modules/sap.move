module 0x60b2d436499019ffa0a9e029d488851bcc82dd745f9ff85c502f8be75145934b::sap {
    ...
    struct TreeDownline<phantom T0> has key {
        id: 0x2::object::UID,
        admin: address,
        active: bool,
        min_lock_ms: u64,
        level_2_threshold: u64,
        level_3_threshold: u64,
        level_4_threshold: u64,
        level_5_threshold: u64,
        locked_tree: 0x2::balance::Balance<T0>,
        locked_by_owner: 0x2::table::Table<address, u64>,
        unlock_by_owner: 0x2::table::Table<address, u64>,
        total_locked: u64,
        total_withdrawn: u64,
    }
    ...
    struct TreeDownlineCreated<phantom T0> has copy, drop {
        downline_id: 0x2::object::ID,
        admin: address,
        min_lock_ms: u64,
        level_2_threshold: u64,
        level_3_threshold: u64,
    ...
    struct TreeDownlineSettingsUpdated<phantom T0> has copy, drop {
        admin: address,
        active: bool,
        min_lock_ms: u64,
        level_2_threshold: u64,
    ...
    struct TreeDownlineLocked<phantom T0> has copy, drop {
        owner: address,
        amount: u64,
        owner_locked: u64,
        unlock_ms: u64,
    ...
    struct TreeDownlineWithdrawn<phantom T0> has copy, drop {
        owner: address,
        amount: u64,
        remaining_locked: u64,
    }

    struct DownlineReferralPaid has copy, drop {
        buyer: address,
        referrer: address,
        level: u64,
        bps: u64,
    ...
    struct DevOpsPaid has copy, drop {
        buyer: address,
        recipient: address,
        bps: u64,
        amount: u64,
    ...
    struct DevOpsBpsUpdated has copy, drop {
        admin: address,
        old_bps: u64,
        new_bps: u64,
    }
    ...
    public fun active_dev_ops_bps(arg0: &Protocol) : u64 {
        if (0x2::dynamic_field::exists_with_type<vector<u8>, u64>(&arg0.id, b"dev_ops_bps")) {
            *0x2::dynamic_field::borrow<vector<u8>, u64>(&arg0.id, b"dev_ops_bps")
        } else {
            200
        }
    }
    ...
    fun assert_downline_settings(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) {
        assert!(arg0 > 0, 19);
        assert!(arg1 > 0, 19);
        assert!(arg1 <= arg2, 19);
        assert!(arg2 <= arg3, 19);
    ...
    fun assert_valid_dev_ops_bps(arg0: u64, arg1: u64, arg2: u64) {
        assert!(arg2 <= 500, 4);
        assert!(arg0 + arg1 + arg2 <= 10000, 4);
        assert!(arg0 + 500 + 500 <= 10000, 4);
    }
    ...
    entry fun create_tree_downline<T0>(arg0: &AdminCap, arg1: &Protocol, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg1, arg7);
        assert_downline_settings(arg2, arg3, arg4, arg5, arg6);
        let v0 = 0x2::tx_context::sender(arg7);
        let v1 = TreeDownline<T0>{
            id                : 0x2::object::new(arg7),
            admin             : v0,
            active            : true,
            min_lock_ms       : arg2,
            level_2_threshold : arg3,
            level_3_threshold : arg4,
            level_4_threshold : arg5,
            level_5_threshold : arg6,
            locked_tree       : 0x2::balance::zero<T0>(),
            locked_by_owner   : 0x2::table::new<address, u64>(arg7),
            unlock_by_owner   : 0x2::table::new<address, u64>(arg7),
            total_locked      : 0,
            total_withdrawn   : 0,
        };
        let v2 = TreeDownlineCreated<T0>{
            downline_id       : 0x2::object::id<TreeDownline<T0>>(&v1),
            admin             : v0,
            min_lock_ms       : arg2,
            level_2_threshold : arg3,
            level_3_threshold : arg4,
        ...
        0x2::event::emit<TreeDownlineCreated<T0>>(v2);
        0x2::transfer::share_object<TreeDownline<T0>>(v1);
    }
    ...
    fun depth_from_locked_amount(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        if (arg0 >= arg4) {
            5
        } else if (arg0 >= arg3) {
            4
    ...
    public fun dev_ops_bps() : u64 {
        200
    }

    fun distinct_2(arg0: address, arg1: address) : bool {
        arg0 != @0x0 && arg0 != arg1
    }

    fun distinct_3(arg0: address, arg1: address, arg2: address) : bool {
        if (arg0 != @0x0) {
            if (arg0 != arg1) {
                arg0 != arg2
            } else {
    ...
    fun distinct_4(arg0: address, arg1: address, arg2: address, arg3: address) : bool {
        if (arg0 != @0x0) {
            if (arg0 != arg1) {
                if (arg0 != arg2) {
                    arg0 != arg3
    ...
    fun distinct_5(arg0: address, arg1: address, arg2: address, arg3: address, arg4: address) : bool {
        if (arg0 != @0x0) {
            if (arg0 != arg1) {
                if (arg0 != arg2) {
                    if (arg0 != arg3) {
    ...
    fun downline_level_bps(arg0: u64) : u64 {
        if (arg0 == 1) {
            300
        } else if (arg0 == 2) {
            80
    ...
    entry fun lock_tree_for_downline<T0>(arg0: &mut TreeDownline<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg0.active, 20);
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::coin::value<T0>(&arg1);
        assert!(v1 > 0, 21);
        assert!(arg2 >= 0x2::clock::timestamp_ms(arg3) + arg0.min_lock_ms, 21);
        let v2 = if (0x2::table::contains<address, u64>(&arg0.locked_by_owner, v0)) {
            assert!(arg2 >= *0x2::table::borrow<address, u64>(&arg0.unlock_by_owner, v0), 21);
            let v3 = 0x2::table::borrow_mut<address, u64>(&mut arg0.locked_by_owner, v0);
            *v3 = *v3 + v1;
            *v3
        } else {
            0x2::table::add<address, u64>(&mut arg0.locked_by_owner, v0, v1);
            0x2::table::add<address, u64>(&mut arg0.unlock_by_owner, v0, arg2);
            v1
        };
        if (0x2::table::contains<address, u64>(&arg0.unlock_by_owner, v0)) {
            *0x2::table::borrow_mut<address, u64>(&mut arg0.unlock_by_owner, v0) = arg2;
        };
        0x2::balance::join<T0>(&mut arg0.locked_tree, 0x2::coin::into_balance<T0>(arg1));
        arg0.total_locked = arg0.total_locked + v1;
        let v4 = TreeDownlineLocked<T0>{
            owner        : v0,
            amount       : v1,
            owner_locked : v2,
            unlock_ms    : arg2,
            max_depth    : depth_from_locked_amount(v2, arg0.level_2_threshold, arg0.level_3_threshold, arg0.level_4_threshold, arg0.level_5_threshold),
        };
        0x2::event::emit<TreeDownlineLocked<T0>>(v4);
    }

    public fun max_dev_ops_bps() : u64 {
        500
    }
    ...
    entry fun mint_and_stake_with_sui(arg0: &mut Protocol, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = &mut v4;
        pay_dev_ops(arg0, v0, v1, v7, arg4);
        let v8 = bps_amount(v1, arg0.liquidity_bps);
        if (v8 > 0) {
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.liquidity_reserve, 0x2::balance::split<0x2::sui::SUI>(&mut v4, v8));
        };
        ...
        let v12 = Staked{
            position_id     : 0x2::object::id<StakePosition>(&v10),
            owner           : v0,
            amount          : v3,
            locked_until_ms : v9 + arg2,
        };
        0x2::event::emit<Staked>(v12);
        0x2::transfer::transfer<StakePosition>(v10, v0);
    }

    entry fun mint_and_stake_with_sui_downline<T0>(arg0: &mut Protocol, arg1: &TreeDownline<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_live(arg0);
        assert!(arg1.active, 20);
        assert!(arg3 >= arg0.min_lock_ms, 7);
        ...
        let v5 = &mut v4;
        let v6 = pay_downline_referrals_if_qualified<T0>(arg0, arg1, v0, v1, v5, arg4, arg5);
        let v7 = &mut v4;
        pay_dev_ops(arg0, v0, v1, v7, arg5);
        let v8 = bps_amount(v1, arg0.liquidity_bps);
        if (v8 > 0) {
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.liquidity_reserve, 0x2::balance::split<0x2::sui::SUI>(&mut v4, v8));
        };
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.treasury_reserve, v4);
        0x2::balance::join<SAP>(&mut arg0.staked_balance, 0x2::coin::into_balance<SAP>(0x2::coin::mint<SAP>(&mut arg0.treasury_cap, v3, arg5)));
        arg0.total_effective_stake = arg0.total_effective_stake + v3;
    ...
    entry fun mint_with_sui(arg0: &mut Protocol, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::coin::into_balance<0x2::sui::SUI>(arg1);
        let v5 = &mut v4;
        pay_dev_ops(arg0, v0, v1, v5, arg2);
        let v6 = bps_amount(v1, arg0.liquidity_bps);
        if (v6 > 0) {
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.liquidity_reserve, 0x2::balance::split<0x2::sui::SUI>(&mut v4, v6));
        };
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.treasury_reserve, v4);
        let v7 = Minted{
            buyer         : v0,
    ...
    fun pay_dev_ops(arg0: &Protocol, arg1: address, arg2: u64, arg3: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = active_dev_ops_bps(arg0);
        assert_valid_dev_ops_bps(arg0.liquidity_bps, arg0.referral_bps, v0);
        let v1 = bps_amount(arg2, v0);
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(arg3, v1), arg4), arg0.admin);
            let v2 = DevOpsPaid{
                buyer     : arg1,
            ...
            0x2::event::emit<DevOpsPaid>(v2);
        };
    }

    fun pay_downline_level(arg0: address, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = bps_amount(arg4, arg3);
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(arg5, v0), arg6), arg1);
        };
        let v1 = DownlineReferralPaid{
            buyer    : arg0,
            referrer : arg1,
            level    : arg2,
            bps      : arg3,
        ...
        0x2::event::emit<DownlineReferralPaid>(v1);
        v0
    }

    fun pay_downline_referrals_if_qualified<T0>(arg0: &Protocol, arg1: &TreeDownline<T0>, arg2: address, arg3: u64, arg4: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : u64 {
        if (!0x2::table::contains<address, address>(&arg0.referrers, arg2)) {
            return 0
        };
        let v0 = *0x2::table::borrow<address, address>(&arg0.referrers, arg2);
        ...
        let v4 = @0x0;
        let v5 = @0x0;
        if (0x2::table::contains<address, address>(&arg0.referrers, v0)) {
            let v6 = *0x2::table::borrow<address, address>(&arg0.referrers, v0);
            v2 = v6;
            if (distinct_2(v6, v0) && qualifies_for_downline_level<T0>(arg0, arg1, v6, 2, arg5)) {
                v1 = 2;
                if (0x2::table::contains<address, address>(&arg0.referrers, v6)) {
                    let v7 = *0x2::table::borrow<address, address>(&arg0.referrers, v6);
                    v3 = v7;
                    if (distinct_3(v7, v0, v6) && qualifies_for_downline_level<T0>(arg0, arg1, v7, 3, arg5)) {
                        v1 = 3;
                        if (0x2::table::contains<address, address>(&arg0.referrers, v7)) {
                            let v8 = *0x2::table::borrow<address, address>(&arg0.referrers, v7);
                            v4 = v8;
                            if (distinct_4(v8, v0, v6, v7) && qualifies_for_downline_level<T0>(arg0, arg1, v8, 4, arg5)) {
                                v1 = 4;
                                if (0x2::table::contains<address, address>(&arg0.referrers, v8)) {
                                    let v9 = *0x2::table::borrow<address, address>(&arg0.referrers, v8);
                                    v5 = v9;
                                    if (distinct_5(v9, v0, v6, v7, v8) && qualifies_for_downline_level<T0>(arg0, arg1, v9, 5, arg5)) {
                                        v1 = 5;
                                    };
                                };
                            };
        ...
        let v10 = pay_downline_level(arg2, v0, 1, downline_level_bps(1), arg3, arg4, arg6);
        let v11 = 0 + v10;
        let v12 = v11;
        if (v1 >= 2) {
            let v13 = pay_downline_level(arg2, v2, 2, downline_level_bps(2), arg3, arg4, arg6);
            v12 = v11 + v13;
        };
        if (v1 >= 3) {
            let v14 = pay_downline_level(arg2, v3, 3, downline_level_bps(3), arg3, arg4, arg6);
            v12 = v12 + v14;
        };
        if (v1 >= 4) {
            let v15 = pay_downline_level(arg2, v4, 4, downline_level_bps(4), arg3, arg4, arg6);
            v12 = v12 + v15;
        };
        if (v1 >= 5) {
            v12 = v12 + pay_downline_level(arg2, v5, 5, downline_level_bps(5), arg3, arg4, arg6);
        };
        v12
    }
    ...
    fun qualifies_for_downline_level<T0>(arg0: &Protocol, arg1: &TreeDownline<T0>, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) : bool {
        0x2::table::contains<address, bool>(&arg0.qualified_referrers, arg2) && tree_downline_depth<T0>(arg1, arg2, arg4) >= arg3
    }
    ...
    public fun tree_downline_depth<T0>(arg0: &TreeDownline<T0>, arg1: address, arg2: &0x2::clock::Clock) : u64 {
        if (!0x2::table::contains<address, u64>(&arg0.locked_by_owner, arg1)) {
            return 1
        };
        if (0x2::clock::timestamp_ms(arg2) >= *0x2::table::borrow<address, u64>(&arg0.unlock_by_owner, arg1)) {
            return 1
        };
        depth_from_locked_amount(*0x2::table::borrow<address, u64>(&arg0.locked_by_owner, arg1), arg0.level_2_threshold, arg0.level_3_threshold, arg0.level_4_threshold, arg0.level_5_threshold)
    }

    public fun tree_downline_locked_amount<T0>(arg0: &TreeDownline<T0>, arg1: address) : u64 {
        if (!0x2::table::contains<address, u64>(&arg0.locked_by_owner, arg1)) {
            return 0
        };
        *0x2::table::borrow<address, u64>(&arg0.locked_by_owner, arg1)
    }

    public fun tree_downline_total_locked<T0>(arg0: &TreeDownline<T0>) : u64 {
        arg0.total_locked
    }

    public fun tree_downline_total_withdrawn<T0>(arg0: &TreeDownline<T0>) : u64 {
        arg0.total_withdrawn
    }

    public fun tree_downline_unlock_ms<T0>(arg0: &TreeDownline<T0>, arg1: address) : u64 {
        if (!0x2::table::contains<address, u64>(&arg0.unlock_by_owner, arg1)) {
            return 0
        };
        *0x2::table::borrow<address, u64>(&arg0.unlock_by_owner, arg1)
    }

    entry fun update_dev_ops_bps(arg0: &AdminCap, arg1: &mut Protocol, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg1, arg3);
        assert_valid_dev_ops_bps(arg1.liquidity_bps, arg1.referral_bps, arg2);
        if (0x2::dynamic_field::exists_with_type<vector<u8>, u64>(&arg1.id, b"dev_ops_bps")) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, u64>(&mut arg1.id, b"dev_ops_bps") = arg2;
        } else {
            0x2::dynamic_field::add<vector<u8>, u64>(&mut arg1.id, b"dev_ops_bps", arg2);
        };
        let v0 = DevOpsBpsUpdated{
            admin   : 0x2::tx_context::sender(arg3),
            old_bps : active_dev_ops_bps(arg1),
            new_bps : arg2,
        };
        0x2::event::emit<DevOpsBpsUpdated>(v0);
    }
    ...
    entry fun update_mint_settings(arg0: &AdminCap, arg1: &mut Protocol, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::tx_context::TxContext) {
        ...
        assert!(arg5 <= 7500, 4);
        assert!(arg6 <= 500, 4);
        assert_valid_dev_ops_bps(arg5, arg6, active_dev_ops_bps(arg1));
    ...
    entry fun update_tree_downline_settings<T0>(arg0: &AdminCap, arg1: &Protocol, arg2: &mut TreeDownline<T0>, arg3: bool, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: &0x2::tx_context::TxContext) {
        assert_admin(arg1, arg9);
        assert!(0x2::tx_context::sender(arg9) == arg2.admin, 2);
        assert_downline_settings(arg4, arg5, arg6, arg7, arg8);
        arg2.active = arg3;
        arg2.min_lock_ms = arg4;
        arg2.level_2_threshold = arg5;
        arg2.level_3_threshold = arg6;
        arg2.level_4_threshold = arg7;
        arg2.level_5_threshold = arg8;
        let v0 = TreeDownlineSettingsUpdated<T0>{
            admin             : 0x2::tx_context::sender(arg9),
            active            : arg3,
            min_lock_ms       : arg4,
            level_2_threshold : arg5,
            level_3_threshold : arg6,
            level_4_threshold : arg7,
            level_5_threshold : arg8,
        };
        0x2::event::emit<TreeDownlineSettingsUpdated<T0>>(v0);
    }
    ...
    entry fun withdraw_unlocked_tree_from_downline<T0>(arg0: &mut TreeDownline<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(arg1 > 0, 21);
        assert!(0x2::table::contains<address, u64>(&arg0.locked_by_owner, v0), 21);
        assert!(0x2::clock::timestamp_ms(arg2) >= *0x2::table::borrow<address, u64>(&arg0.unlock_by_owner, v0), 22);
        let v1 = *0x2::table::borrow<address, u64>(&arg0.locked_by_owner, v0);
        assert!(arg1 <= v1, 21);
        let v2 = v1 - arg1;
        if (v2 == 0) {
            0x2::table::remove<address, u64>(&mut arg0.locked_by_owner, v0);
            0x2::table::remove<address, u64>(&mut arg0.unlock_by_owner, v0);
        } else {
            *0x2::table::borrow_mut<address, u64>(&mut arg0.locked_by_owner, v0) = v2;
        };
        arg0.total_withdrawn = arg0.total_withdrawn + arg1;
        let v3 = TreeDownlineWithdrawn<T0>{
            owner            : v0,
            amount           : arg1,
            remaining_locked : v2,
        };
        0x2::event::emit<TreeDownlineWithdrawn<T0>>(v3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.locked_tree, arg1), arg3), v0);
    }
