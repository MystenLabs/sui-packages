module 0xab4b7134a29798ed367b0af3c291bc1d70140dc26fbd5a65ec7af2b3dd2a01bd::capo_collection {
    ...
    public entry fun mint_to_collection(arg0: &CapoCollection, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = CapoNFT{
            id          : 0x2::object::new(arg4),
            name        : 0x1::string::utf8(arg1),
            description : 0x1::string::utf8(arg2),
            url         : 0x2::url::new_unsafe_from_bytes(arg3),
            collection  : 0x2::object::id_address<CapoCollection>(arg0),
        };
