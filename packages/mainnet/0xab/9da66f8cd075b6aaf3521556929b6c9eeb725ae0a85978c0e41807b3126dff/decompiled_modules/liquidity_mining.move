module 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::liquidity_mining {
    ...
    struct PoolReward has store, key {
        ...
        end_time_ms: u64,
        total_rewards: u64,
        allocated_rewards: 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::Decimal,
        cumulative_rewards_per_share: 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::Decimal,
    ...
    struct UserReward has store {
        ...
        earned_rewards: 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::Decimal,
        cumulative_rewards_per_share: 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::Decimal,
    }
    ...
    public(friend) fun add_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = PoolReward{
            ...
            allocated_rewards            : 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::from(0),
            cumulative_rewards_per_share : 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::from(0),
    ...
    public(friend) fun cancel_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: u64, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        0x2::balance::split<T0>(0x2::bag::borrow_mut<RewardBalance<T0>, 0x2::balance::Balance<T0>>(&mut v0.additional_fields, v1), 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::floor(0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::sub(0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::from(v0.total_rewards), v0.allocated_rewards)))
    }
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut PoolRewardManager, arg1: &mut UserRewardManager, arg2: &0x2::clock::Clock, arg3: u64) : 0x2::balance::Balance<T0> {
        ...
        let v3 = 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::floor(v2.earned_rewards);
        v2.earned_rewards = 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::sub(v2.earned_rewards, 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::from(v3));
    ...
    fun update_pool_reward_manager(arg0: &mut PoolRewardManager, arg1: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<0x1::option::Option<PoolReward>>(&arg0.pool_rewards)) {
            ...
            let v4 = 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::div(0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::mul(0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::from(v3.total_rewards), 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::from(0x1::u64::min(v0, v3.end_time_ms) - 0x1::u64::max(v3.start_time_ms, arg0.last_update_time_ms))), 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::from(v3.end_time_ms - v3.start_time_ms));
            v3.allocated_rewards = 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::add(v3.allocated_rewards, v4);
            v3.cumulative_rewards_per_share = 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::add(v3.cumulative_rewards_per_share, 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::div(v4, 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::from(arg0.total_shares)));
            v1 = v1 + 1;
        };
        arg0.last_update_time_ms = v0;
    }
            ...
            if (0x1::option::is_none<UserReward>(v4)) {
                if (arg1.last_update_time_ms <= v3.end_time_ms) {
                    let v5 = if (arg1.last_update_time_ms <= v3.start_time_ms) {
                        0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::mul(v3.cumulative_rewards_per_share, 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::from(arg1.share))
                    } else {
                        0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::from(0)
                    };
                    let v6 = UserReward{
                ...
                v7.earned_rewards = 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::add(v7.earned_rewards, 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::mul(0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::sub(v3.cumulative_rewards_per_share, v7.cumulative_rewards_per_share), 0xab9da66f8cd075b6aaf3521556929b6c9eeb725ae0a85978c0e41807b3126dff::decimal::from(arg1.share)));
