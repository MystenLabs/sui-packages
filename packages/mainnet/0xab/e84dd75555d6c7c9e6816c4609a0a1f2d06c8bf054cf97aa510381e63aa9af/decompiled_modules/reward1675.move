module 0xabe84dd75555d6c7c9e6816c4609a0a1f2d06c8bf054cf97aa510381e63aa9af::reward1675 {
    struct REWARD1675 has drop {
        dummy_field: bool,
    }

    struct TICKET_1675 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1675(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1675>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1675>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1675, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1675>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1675>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1675>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1675>>(v5, 0x2::tx_context::sender(arg1));
    }
