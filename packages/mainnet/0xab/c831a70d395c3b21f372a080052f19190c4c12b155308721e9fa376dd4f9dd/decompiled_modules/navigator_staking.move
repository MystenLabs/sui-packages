module 0xabc831a70d395c3b21f372a080052f19190c4c12b155308721e9fa376dd4f9dd::navigator_staking {
    ...
    struct NavigatorStake has key {
        id: 0x2::object::UID,
        navigator: address,
        stake: 0x2::balance::Balance<0xabc831a70d395c3b21f372a080052f19190c4c12b155308721e9fa376dd4f9dd::shock::SHOCK>,
        staked_at: u64,
    ...
    public entry fun complete_unstake(arg0: &mut NavigatorRegistry, arg1: NavigatorStake, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xabc831a70d395c3b21f372a080052f19190c4c12b155308721e9fa376dd4f9dd::shock::SHOCK>>(0x2::coin::from_balance<0xabc831a70d395c3b21f372a080052f19190c4c12b155308721e9fa376dd4f9dd::shock::SHOCK>(v2, arg3), v1);
    ...
    public entry fun stake_navigator(arg0: &mut NavigatorRegistry, arg1: 0x2::coin::Coin<0xabc831a70d395c3b21f372a080052f19190c4c12b155308721e9fa376dd4f9dd::shock::SHOCK>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0xabc831a70d395c3b21f372a080052f19190c4c12b155308721e9fa376dd4f9dd::shock::SHOCK>(&arg1) >= 1000000000000, 0);
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = NavigatorStake{
            id                   : 0x2::object::new(arg3),
            navigator            : v0,
            stake                : 0x2::coin::into_balance<0xabc831a70d395c3b21f372a080052f19190c4c12b155308721e9fa376dd4f9dd::shock::SHOCK>(arg1),
