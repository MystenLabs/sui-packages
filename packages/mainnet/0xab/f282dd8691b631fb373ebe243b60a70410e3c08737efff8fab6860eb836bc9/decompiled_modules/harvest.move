module 0xabf282dd8691b631fb373ebe243b60a70410e3c08737efff8fab6860eb836bc9::harvest {
    ...
    public fun complete_harvest<T0>(arg0: &mut 0x5b7846fe40f366aad538e44e77ab6c1a50e1289befbd3ff03b0d579d04490a60::vault::Vault<T0>, arg1: &mut HarvestConfig, arg2: &0xabf282dd8691b631fb373ebe243b60a70410e3c08737efff8fab6860eb836bc9::strategy::StrategyRegistry, arg3: HarvestPromise<T0>, arg4: 0x2::coin::Coin<T0>, arg5: &0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::price_info::PriceInfoObject, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let HarvestPromise {
            vault_id        : v0,
            strategy_id     : v1,
            expected_amount : v2,
        ...
        assert!(0x2::object::id<0x5b7846fe40f366aad538e44e77ab6c1a50e1289befbd3ff03b0d579d04490a60::vault::Vault<T0>>(arg0) == v0, 702);
        ...
        while (v7 < 0x1::vector::length<HarvestInfo>(&arg1.protocols)) {
            ...
            if (v8.strategy_id == v1) {
                assert!(0x2::object::id<0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::price_info::PriceInfoObject>(arg5) == v8.pyth_price_id, 705);
        ...
        assert!(v5, 701);
        let v9 = 0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::price_info::get_price_info_from_price_info_object(arg5);
        let v10 = 0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::price_info::get_price_identifier(&v9);
        let v11 = 0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::price_identifier::get_bytes(&v10);
        ...
        assert!(v12, 707);
        let v13 = 0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::pyth::get_price_no_older_than(arg5, arg6, 60);
        let v14 = 0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::price::get_price(&v13);
        let v15 = 0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::price::get_expo(&v13);
        let v16 = 0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::i64::get_magnitude_if_positive(&v14);
        assert!((0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::price::get_conf(&v13) as u128) * 100 <= (v16 as u128) * 2, 706);
        let v17 = 1;
        let v18 = 0;
        while (v18 < (v6 as u64)) {
            v17 = v17 * 10;
        ...
        v18 = 0;
        while (v18 < 0xb53b0f4174108627fbee72e2498b58d6a2714cded53fac537034c220d26302::i64::get_magnitude_if_negative(&v15)) {
            v17 = v17 * 10;
            v18 = v18 + 1;
        };
        0x5b7846fe40f366aad538e44e77ab6c1a50e1289befbd3ff03b0d579d04490a60::floors::assert_slippage(arg1.harvest_slippage_bps, false);
        assert!(v4 >= (((v2 as u128) * (v16 as u128) * 1000000 / v17) as u64) * (10000 - (arg1.harvest_slippage_bps as u64)) / 10000, 704);
        let v19 = 0x5b7846fe40f366aad538e44e77ab6c1a50e1289befbd3ff03b0d579d04490a60::vault::performance_fee_bps<T0>(arg0);
        let v20 = 0;
        if (v19 > 0) {
            let v21 = v4 * v19 / 10000;
            v20 = v21;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg4, v21, arg7), 0x5b7846fe40f366aad538e44e77ab6c1a50e1289befbd3ff03b0d579d04490a60::vault::fee_recipient<T0>(arg0));
        };
        0x5b7846fe40f366aad538e44e77ab6c1a50e1289befbd3ff03b0d579d04490a60::vault::deposit_balance_to_idle<T0>(arg0, 0xabf282dd8691b631fb373ebe243b60a70410e3c08737efff8fab6860eb836bc9::strategy::borrow_protocol_access_cap(arg2), 0x2::coin::into_balance<T0>(arg4));
    ...
    public fun issue_harvest_promise<T0, T1>(arg0: &0x5b7846fe40f366aad538e44e77ab6c1a50e1289befbd3ff03b0d579d04490a60::vault::Vault<T0>, arg1: &HarvestConfig, arg2: &0x5b7846fe40f366aad538e44e77ab6c1a50e1289befbd3ff03b0d579d04490a60::vault::ProtocolAccessCap, arg3: u8, arg4: u64, arg5: &0x2::clock::Clock) : HarvestPromise<T0> {
        let (v0, _) = should_harvest(arg1, arg3, arg5);
        assert!(v0, 700);
        HarvestPromise<T0>{
            vault_id        : 0x2::object::id<0x5b7846fe40f366aad538e44e77ab6c1a50e1289befbd3ff03b0d579d04490a60::vault::Vault<T0>>(arg0),
            strategy_id     : arg3,
    ...
    public(friend) fun set_harvest_slippage_bps(arg0: &mut HarvestConfig, arg1: u64) {
        0x5b7846fe40f366aad538e44e77ab6c1a50e1289befbd3ff03b0d579d04490a60::floors::assert_slippage(arg1, false);
