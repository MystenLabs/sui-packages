module 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::pool {
    ...
    struct PrivacyPool<phantom T0> has store, key {
        ...
        merkle_tree: 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::MerkleTree,
        nullifiers: 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::NullifierRegistry,
        vk_bytes: vector<u8>,
    ...
    public fun swap<T0, T1>(arg0: &mut PrivacyPool<T0>, arg1: &mut PrivacyPool<T1>, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<vector<u8>>, arg6: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg7: &0x2::clock::Clock, arg8: vector<u8>, arg9: vector<u8>, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = v5;
        let v11 = v2;
        let v12 = *0x1::vector::borrow<vector<u8>>(&arg5, 0);
        let v13 = *0x1::vector::borrow<vector<u8>>(&arg5, 1);
        let v14 = 0x1::vector::empty<u256>();
        let v15 = &mut v14;
        0x1::vector::push_back<u256>(v15, field_element_to_u256(&v12));
        0x1::vector::push_back<u256>(v15, field_element_to_u256(&v13));
        assert!(u256_to_field_element(0x2::poseidon::poseidon_bn254(&v14)) == v0, 5);
        assert!(is_valid_root<T0>(arg0, &v8), 3);
        assert!(!0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::is_spent(&arg0.nullifiers, v12), 1);
        assert!(!0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::is_spent(&arg0.nullifiers, v13), 1);
        let v16 = 0x2::groth16::bn254();
        let v17 = 0x2::groth16::prepare_verifying_key(&v16, &arg0.swap_vk_bytes);
        let v18 = 0x2::groth16::public_proof_inputs_from_bytes(arg4);
        let v19 = 0x2::groth16::proof_points_from_bytes(arg3);
        let v20 = 0x2::groth16::bn254();
        assert!(0x2::groth16::verify_groth16_proof(&v20, &v17, &v18, &v19), 2);
        let v21 = field_element_to_u64(&v10);
        assert!(0x2::balance::value<T0>(&arg0.balance) >= v21, 4);
        let (v22, v23, v24) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::swap_exact_base_for_quote<T0, T1>(arg2, 0x2::coin::take<T0>(&mut arg0.balance, v21, arg10), arg6, field_element_to_u64(&v9), arg7, arg10);
        let v25 = v23;
        0x2::balance::join<T0>(&mut arg0.balance, 0x2::coin::into_balance<T0>(v22));
        0x2::balance::join<T1>(&mut arg1.balance, 0x2::coin::into_balance<T1>(v25));
        0x2::transfer::public_transfer<0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>>(v24, 0x2::tx_context::sender(arg10));
        let v26 = 0x1::vector::empty<vector<u8>>();
        0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::mark_spent(&mut arg0.nullifiers, v12);
        0x1::vector::push_back<vector<u8>>(&mut v26, v12);
        if (!is_zero_commitment(&v13)) {
            0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::mark_spent(&mut arg0.nullifiers, v13);
            0x1::vector::push_back<vector<u8>>(&mut v26, v13);
        };
        save_historical_root<T1>(arg1);
        0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::insert(&mut arg1.merkle_tree, v1);
        if (!is_zero_commitment(&v11)) {
            save_historical_root<T0>(arg0);
            0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::insert(&mut arg0.merkle_tree, v11);
            let v27 = ShieldEvent{
                pool_id        : 0x2::object::id<PrivacyPool<T0>>(arg0),
                position       : 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::get_next_index(&arg0.merkle_tree),
                commitment     : v11,
                encrypted_note : arg9,
            };
            0x2::event::emit<ShieldEvent>(v27);
        };
        let v28 = SwapEvent{
            pool_in_id            : 0x2::object::id<PrivacyPool<T0>>(arg0),
            pool_out_id           : 0x2::object::id<PrivacyPool<T1>>(arg1),
            amount_in             : v21,
            amount_out            : 0x2::coin::value<T1>(&v25),
            input_nullifiers      : v26,
            swap_position         : 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::get_next_index(&arg1.merkle_tree),
            swap_commitment       : v1,
    ...
    public fun transfer<T0>(arg0: &mut PrivacyPool<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<vector<u8>>, arg4: vector<vector<u8>>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::is_spent(&arg0.nullifiers, v7), 1);
        assert!(!0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::is_spent(&arg0.nullifiers, v8), 1);
        ...
        0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::mark_spent(&mut arg0.nullifiers, v7);
        0x1::vector::push_back<vector<u8>>(&mut v16, v7);
        if (!is_zero_commitment(&v8)) {
            0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::mark_spent(&mut arg0.nullifiers, v8);
        ...
        0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::insert(&mut arg0.merkle_tree, v1);
        0x1::vector::push_back<vector<u8>>(&mut v17, *0x1::vector::borrow<vector<u8>>(&arg4, 0));
        0x1::vector::push_back<u64>(&mut v18, 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::get_next_index(&arg0.merkle_tree));
        0x1::vector::push_back<vector<u8>>(&mut v19, v1);
        if (!is_zero_commitment(&v6)) {
            0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::insert(&mut arg0.merkle_tree, v6);
    ...
    fun create_pool<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : PrivacyPool<T0> {
        PrivacyPool<T0>{
            ...
            merkle_tree       : 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::new(arg3),
            nullifiers        : 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::new(arg3),
            vk_bytes          : arg0,
    ...
    public fun get_merkle_root<T0>(arg0: &PrivacyPool<T0>) : vector<u8> {
        0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::get_root(&arg0.merkle_tree)
    }

    public fun get_note_count<T0>(arg0: &PrivacyPool<T0>) : u64 {
        0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::get_next_index(&arg0.merkle_tree)
    }

    public fun is_nullifier_spent<T0>(arg0: &PrivacyPool<T0>, arg1: vector<u8>) : bool {
        0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::is_spent(&arg0.nullifiers, arg1)
    }

    fun is_valid_root<T0>(arg0: &PrivacyPool<T0>, arg1: &vector<u8>) : bool {
        if (*arg1 == 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::get_root(&arg0.merkle_tree)) {
            return true
        };
        let v0 = 0;
    ...
    fun save_historical_root<T0>(arg0: &mut PrivacyPool<T0>) {
        if (0x1::vector::length<vector<u8>>(&arg0.historical_roots) < 100) {
            0x1::vector::push_back<vector<u8>>(&mut arg0.historical_roots, 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::get_root(&arg0.merkle_tree));
        } else {
            *0x1::vector::borrow_mut<vector<u8>>(&mut arg0.historical_roots, arg0.root_head) = 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::get_root(&arg0.merkle_tree);
    ...
    public fun shield<T0>(arg0: &mut PrivacyPool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::insert(&mut arg0.merkle_tree, arg2);
        let v0 = ShieldEvent{
            pool_id        : 0x2::object::id<PrivacyPool<T0>>(arg0),
            position       : 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::get_next_index(&arg0.merkle_tree),
            commitment     : arg2,
    ...
    public fun unshield<T0>(arg0: &mut PrivacyPool<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<vector<u8>>, arg4: address, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(is_valid_root<T0>(arg0, &v5), 3);
        assert!(!0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::is_spent(&arg0.nullifiers, v8), 1);
        assert!(!0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::is_spent(&arg0.nullifiers, v9), 1);
        ...
        if (!is_zero_commitment(&v9)) {
            0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::nullifier::mark_spent(&mut arg0.nullifiers, v9);
        };
        ...
        if (!is_zero_commitment(&v7)) {
            save_historical_root<T0>(arg0);
            0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::insert(&mut arg0.merkle_tree, v7);
            let v18 = ShieldEvent{
                pool_id        : 0x2::object::id<PrivacyPool<T0>>(arg0),
                position       : 0xab4a6267321fce11e7a2314f11f8eef0ac76a9ab8b5bdb66bdfc85feab0e68f6::merkle_tree::get_next_index(&arg0.merkle_tree),
                commitment     : v7,
