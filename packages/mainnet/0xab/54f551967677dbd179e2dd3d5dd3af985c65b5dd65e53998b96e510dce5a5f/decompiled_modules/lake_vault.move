module 0xab54f551967677dbd179e2dd3d5dd3af985c65b5dd65e53998b96e510dce5a5f::lake_vault {
    ...
    fun realtime_rewarder_release_and_unit<T0, T1>(arg0: &LakeVault<T0, T1>, arg1: &0x2::clock::Clock) : (u64, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::Double, bool) {
        let v0 = total_stake_amount<T0, T1>(arg0);
        if (v0 > 0) {
            let v4 = 0x1::u64::min(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::floor(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::mul_u64(arg0.flow_rate, 0x2::clock::timestamp_ms(arg1) - arg0.timestamp)), 0x2::balance::value<T1>(&arg0.source));
            (v4, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::add(arg0.unit, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::from_fraction(v4, v0)), true)
        } else {
            (0, arg0.unit, false)
        }
    }
    ...
    fun source_to_pool<T0, T1>(arg0: &mut LakeVault<T0, T1>, arg1: &0x2::clock::Clock) {
        let (v0, v1, v2) = realtime_rewarder_release_and_unit<T0, T1>(arg0, arg1);
        if (v2) {
    ...
    fun unsettled_reward_amount<T0, T1>(arg0: &LakeVault<T0, T1>, arg1: address, arg2: &0x2::clock::Clock) : u64 {
        if (stake_exists<T0, T1>(arg0, arg1)) {
            let (v1, v2, _) = realtime_rewarder_release_and_unit<T0, T1>(arg0, arg2);
            let (v4, v5) = if (stake_exists<T0, T1>(arg0, arg1)) {
                let v6 = stake_data<T0, T1>(arg0, arg1);
                (v6.unit, v6.stake_amount)
            } else {
                (0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::from(0), 0)
            };
            0x1::u64::min(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::floor(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::mul_u64(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::sub(v2, v4), v5)), v1 + 0x2::balance::value<T1>(&arg0.pool))
        } else {
            0
        }
    }
