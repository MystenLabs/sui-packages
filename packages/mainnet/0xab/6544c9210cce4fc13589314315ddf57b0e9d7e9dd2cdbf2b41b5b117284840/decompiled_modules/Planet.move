module 0xab6544c9210cce4fc13589314315ddf57b0e9d7e9dd2cdbf2b41b5b117284840::Planet {
    ...
    public fun EstablishPatarian(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Patarian{
            id    : arg0,
            addr  : 0x2::tx_context::sender(arg2),
            proof : arg1,
        };
    ...
    public fun EstablishPhantom(arg0: u64, arg1: u64, arg2: address, arg3: u64, arg4: u64) {
        let v0 = Phantom{
            patarian_id : arg0,
            id          : arg1,
            addr        : arg2,
