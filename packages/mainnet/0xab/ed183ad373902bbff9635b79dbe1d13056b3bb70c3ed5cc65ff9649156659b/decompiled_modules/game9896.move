module 0xabed183ad373902bbff9635b79dbe1d13056b3bb70c3ed5cc65ff9649156659b::game9896 {
    struct GAME9896 has drop {
        dummy_field: bool,
    }

    struct TICKET_9896 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9896(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9896>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9896>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME9896, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME9896>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9896>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9896>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9896>>(v5, 0x2::tx_context::sender(arg1));
    }
