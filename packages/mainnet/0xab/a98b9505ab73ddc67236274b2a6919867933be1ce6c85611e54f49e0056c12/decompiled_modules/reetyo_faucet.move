module 0xaba98b9505ab73ddc67236274b2a6919867933be1ce6c85611e54f49e0056c12::reetyo_faucet {
    ...
    fun init(arg0: REETYO_FAUCET, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<REETYO_FAUCET>>(v0, 0x2::tx_context::sender(arg1));
        let v2 = PublicWallet{
