module 0xabe189eb6eedaa27644841a0cb138b2cb057a94d1a2d718f2e9732708379777a::reward9184 {
    struct REWARD9184 has drop {
        dummy_field: bool,
    }

    struct TICKET_9184 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9184(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9184>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9184>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9184, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9184>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9184>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9184>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9184>>(v5, 0x2::tx_context::sender(arg1));
    }
