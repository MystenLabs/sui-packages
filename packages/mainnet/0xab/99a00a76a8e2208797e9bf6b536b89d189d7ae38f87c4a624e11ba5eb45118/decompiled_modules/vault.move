module 0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::vault {
    ...
    entry fun burn_sgc<T0>(arg0: &mut 0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::sgc::Minter, arg1: &mut AdminAddr_fee, arg2: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 1, 11);
        let v0 = withdraw_burning_sgc<T0>(arg1, arg3);
        assert!(0x2::coin::value<T0>(&v0) > 0, 5);
        0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::sgc::burn(arg0, 0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::mini_swap::swap<0x2::sui::SUI, 0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::sgc::SGC>(arg2, 0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::mini_swap::swap<T0, 0x2::sui::SUI>(arg2, v0, arg3), arg3));
    }

    entry fun burn_sgc_sui(arg0: &mut 0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::sgc::Minter, arg1: &mut AdminAddr_fee, arg2: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 1, 11);
        let v0 = withdraw_burning_sgc<0x2::sui::SUI>(arg1, arg3);
        assert!(0x2::coin::value<0x2::sui::SUI>(&v0) > 0, 5);
        0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::sgc::burn(arg0, 0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::mini_swap::swap<0x2::sui::SUI, 0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::sgc::SGC>(arg2, v0, arg3));
    }
    ...
    public entry fun entry_get_sgc_coin<T0>(arg0: &mut 0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::sgc::Minter, arg1: &mut 0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::sgc::Halving_cycle, arg2: &SavingsData<T0>, arg3: &mut Get_sgc<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.version == 1, 11);
        let v0 = 0x2::clock::timestamp_ms(arg4) / 1000;
        0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::sgc::mint(arg0, arg1, *0x2::table::borrow<address, u64>(&arg2.savings, 0x2::tx_context::sender(arg5)) * (v0 - *0x2::table::borrow<address, u64>(&arg3.change_time, 0x2::tx_context::sender(arg5))) / arg3.sgc_weight, arg5);
    ...
    fun get_sgc_coin<T0>(arg0: &mut 0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::sgc::Minter, arg1: &mut 0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::sgc::Halving_cycle, arg2: &SavingsData<T0>, arg3: &mut Get_sgc<T0>, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg5) / 1000;
        if (arg4) {
            0xab99a00a76a8e2208797e9bf6b536b89d189d7ae38f87c4a624e11ba5eb45118::sgc::mint(arg0, arg1, *0x2::table::borrow<address, u64>(&arg2.savings, 0x2::tx_context::sender(arg6)) * (v0 - *0x2::table::borrow<address, u64>(&arg3.change_time, 0x2::tx_context::sender(arg6))) / arg3.sgc_weight, arg6);
