module 0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::rfq_account {
    ...
    struct Account has key {
        ...
        nonces: 0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::table_set::TableSet<u128>,
    }
    ...
    public fun create(arg0: vector<u8>, arg1: &mut 0x2::tx_context::TxContext) : AccountCap {
        let v0 = Account{
            ...
            public_key : arg0,
            nonces     : 0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::table_set::new<u128>(arg1),
        };
        let v1 = AccountCap{
            id         : 0x2::object::new(arg1),
    ...
    public fun destroy(arg0: Account, arg1: AccountCap) {
        ...
        0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::table_set::drop<u128>(v4);
    }
    ...
    public(friend) fun verify_signature<T0, T1>(arg0: &mut Account, arg1: u128, arg2: 0x2::object::ID, arg3: u128, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: vector<u8>, arg9: &0x2::clock::Clock) {
        assert!(!0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::table_set::contains<u128>(&arg0.nonces, arg3), 3);
        0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::table_set::add<u128>(&mut arg0.nonces, arg3);
        let v0 = Rfq<T0, T1>{
            trade_id                    : arg1,
