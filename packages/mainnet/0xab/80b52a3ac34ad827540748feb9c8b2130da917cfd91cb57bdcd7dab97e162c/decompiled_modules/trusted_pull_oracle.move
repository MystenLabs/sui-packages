module 0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::trusted_pull_oracle {
    ...
    struct TrustedPullOracle has key {
        id: 0x2::object::UID,
        trusted_price_data_cap: 0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::trusted_prices::TrustedPriceDataCap,
    ...
    public fun new(arg0: 0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::trusted_prices::TrustedPriceDataCap, arg1: vector<u8>, arg2: &mut 0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::global::GlobalInfo, arg3: &mut 0x2::tx_context::TxContext) : TrustedPullOracleCap {
        ...
        0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::global::update_shared_object_id<TrustedPullOracleCap>(arg2, b"trusted_oracle", &v1);
        v1
    }
    ...
    public fun destroy(arg0: TrustedPullOracle, arg1: TrustedPullOracleCap) : 0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::trusted_prices::TrustedPriceDataCap {
    ...
    public fun make_trusted_prices_data(arg0: &TrustedPullOracle, arg1: vector<SignedPrice>, arg2: u64, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::trusted_prices::TrustedPriceData {
        ...
        let v2 = 0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::trusted_prices::create_empty_trusted_price_data(&arg0.trusted_price_data_cap, arg5);
        ...
        while (v3 < 0x1::vector::length<SignedPrice>(&arg1)) {
            ...
            0xab80b52a3ac34ad827540748feb9c8b2130da917cfd91cb57bdcd7dab97e162c::trusted_prices::set_price_raw(&mut v2, v4.asset, v4.price, &arg0.trusted_price_data_cap);
            v3 = v3 + 1;
        };
