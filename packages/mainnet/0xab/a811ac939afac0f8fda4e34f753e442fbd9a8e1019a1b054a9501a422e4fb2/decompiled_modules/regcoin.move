module 0xaba811ac939afac0f8fda4e34f753e442fbd9a8e1019a1b054a9501a422e4fb2::regcoin {
    ...
    fun init(arg0: REGCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<REGCOIN>(arg0, 6, b"Lulu", b"Lulu coin", b"elooo", 0x1::option::none<0x2::url::Url>(), false, arg1);
