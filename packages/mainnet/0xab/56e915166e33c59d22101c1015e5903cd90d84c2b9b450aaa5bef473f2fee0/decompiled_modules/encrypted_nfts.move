module 0xab56e915166e33c59d22101c1015e5903cd90d84c2b9b450aaa5bef473f2fee0::encrypted_nfts {
    ...
    public fun decrypt(arg0: TimeCapsule, arg1: &0x2::clock::Clock, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : LuckyCard {
        ...
        0xab56e915166e33c59d22101c1015e5903cd90d84c2b9b450aaa5bef473f2fee0::drand_lib::verify_drand_signature(arg2, v2);
        let v4 = 0x2::bls12381::g1_from_bytes(&arg2);
        let v5 = 0xab56e915166e33c59d22101c1015e5903cd90d84c2b9b450aaa5bef473f2fee0::ec_ops::ibe_decrypt(0xab56e915166e33c59d22101c1015e5903cd90d84c2b9b450aaa5bef473f2fee0::ec_ops::ibe_encryption_from_bytes(&v3), &v4);
    ...
    public fun mint_encrypted(arg0: &0xab56e915166e33c59d22101c1015e5903cd90d84c2b9b450aaa5bef473f2fee0::access::AdminCap, arg1: vector<u8>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : TimeCapsule {
        TimeCapsule{
            id             : 0x2::object::new(arg3),
            encrypted_data : arg1,
            round          : arg2,
