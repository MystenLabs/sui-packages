module 0xab002ec86bdbd4c84306ad42a636ceeac60cacfd8c52449e3fd864492bff1956::bclmm {
    struct EE has copy, drop {
        e: u64,
        l: u64,
    }

    public fun elf<T0, T1>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: &mut 0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2::clock::Clock, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: u64, arg6: u64, arg7: u64, arg8: vector<bool>, arg9: vector<bool>, arg10: vector<u64>, arg11: vector<u64>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        while (v8 < 0x1::vector::length<bool>(&arg8)) {
            ...
            let v12 = if (v10) {
                0xab002ec86bdbd4c84306ad42a636ceeac60cacfd8c52449e3fd864492bff1956::ct::cmnsp() + 1
            } else {
                0xab002ec86bdbd4c84306ad42a636ceeac60cacfd8c52449e3fd864492bff1956::ct::cmxsp() - 1
            };
            let (v13, v14) = vbac<T0, T1>(arg0, v5, v7, v9, v10, *0x1::vector::borrow<u64>(&arg10, v8), v11, v12);
            if (v13 != 0xab002ec86bdbd4c84306ad42a636ceeac60cacfd8c52449e3fd864492bff1956::ct::e_no_error()) {
                let v15 = EE{
                    e : v13,
                    l : 268,
                };
    ...
    fun seo<T0, T1>(arg0: &mut 0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::CBM, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: bool, arg5: u64, arg6: u64, arg7: u128, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        let (v0, v1, v2) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::flash_swap<T0, T1>(arg8, arg2, arg3, arg4, false, arg5, arg7);
        let v3 = v2;
        let v4 = v1;
        let v5 = v0;
        ...
        0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::repay_flash_swap<T0, T1>(arg2, arg3, v13, v14, v3);
    ...
    fun vbac<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: bool, arg4: bool, arg5: u64, arg6: u64, arg7: u128) : (u64, u64) {
        ...
        (0xab002ec86bdbd4c84306ad42a636ceeac60cacfd8c52449e3fd864492bff1956::ct::e_no_error(), v1)
    }
