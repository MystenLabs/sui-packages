module 0xab4ff0293de07e838ffde761db6a4fd520a4893516cc48b81cf8fc82e060413b::pools {
    struct InvestmentCap has key {
        id: 0x2::object::UID,
    }
    ...
    public fun buy(arg0: &mut InvestmentPool, arg1: &mut 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 1);
    ...
    fun init(arg0: POOLS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<InvestmentCap>(v0, 0x2::tx_context::sender(arg1));
