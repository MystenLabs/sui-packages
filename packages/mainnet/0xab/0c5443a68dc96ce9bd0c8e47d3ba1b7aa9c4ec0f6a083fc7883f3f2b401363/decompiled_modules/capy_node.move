module 0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::capy_node {
    ...
    struct MinerPool has key {
        ...
        admin: 0x2::object::ID,
        start_time: u64,
        reward_balance: 0x2::balance::Balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>,
    ...
    struct CommitRegistry has key {
        id: 0x2::object::UID,
        version: u64,
        admin: 0x2::object::ID,
        last_commit_times: 0x2::table::Table<0x2::object::ID, u64>,
    }
    ...
    entry fun commit_mine(arg0: &NFTNode, arg1: &mut CommitRegistry, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(arg0.owner == v0, 1);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        let v2 = 0x2::object::id<NFTNode>(arg0);
        let v3 = if (arg0.last_claim_time == 0) {
            arg0.registered_at
        } else {
            arg0.last_claim_time
        };
        assert!(v1 - v3 >= 86400000, 10);
        if (0x2::table::contains<0x2::object::ID, u64>(&arg1.last_commit_times, v2)) {
            assert!(v1 - *0x2::table::borrow_mut<0x2::object::ID, u64>(&mut arg1.last_commit_times, v2) >= 86400000, 30);
        };
        0x1::vector::append<u8>(&mut arg2, 0x2::address::to_bytes(v0));
        0x1::vector::append<u8>(&mut arg2, 0x2::object::id_bytes<NFTNode>(arg0));
        0x1::vector::append<u8>(&mut arg2, 0x2::bcs::to_bytes<u64>(&v1));
        let v4 = MiningCommit{
            id          : 0x2::object::new(arg4),
            miner       : v0,
            nft_node_id : v2,
            commit_hash : 0x2::hash::blake2b256(&arg2),
            commit_time : v1,
            revealed    : false,
        };
        if (0x2::table::contains<0x2::object::ID, u64>(&arg1.last_commit_times, v2)) {
            *0x2::table::borrow_mut<0x2::object::ID, u64>(&mut arg1.last_commit_times, v2) = v1;
        } else {
            0x2::table::add<0x2::object::ID, u64>(&mut arg1.last_commit_times, v2, v1);
        };
        0x2::transfer::transfer<MiningCommit>(v4, v0);
    }

    entry fun create_config(arg0: &AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun create_pool(arg0: 0x2::object::ID, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = MinerPool{
            id             : 0x2::object::new(arg2),
            version        : 2,
            admin          : 0x2::object::id<AdminCap>(arg1),
            start_time     : 0,
            reward_balance : 0x2::balance::zero<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(),
            app_uid        : arg0,
        };
        0x2::transfer::share_object<MinerPool>(v0);
    }

    entry fun create_registry(arg0: &AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Registry{
            id                        : 0x2::object::new(arg1),
            version                   : 2,
            admin                     : 0x2::object::id<AdminCap>(arg0),
    ...
    entry fun create_shard_pool(arg0: &mut Registry, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = ShardPool{
            id                   : 0x2::object::new(arg2),
            version              : 2,
            admin                : 0x2::object::id<AdminCap>(arg1),
    ...
    entry fun create_super_node<T0: store + key>(arg0: &mut Registry, arg1: &mut Config, arg2: &mut MinerPool, arg3: &NFTNode, arg4: &T0, arg5: u8, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: 0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 2, 27);
        ...
        if (v6 < 5) {
            ...
            assert!(0x2::coin::value<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&arg7) >= 100000000000000, 15);
            0x2::balance::join<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut arg2.reward_balance, 0x2::coin::into_balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(0x2::coin::split<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut arg7, 100000000000000, arg8)));
        };
        ...
        if (0x2::coin::value<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&arg7) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>>(arg7, v0);
        } else {
            0x2::coin::destroy_zero<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(arg7);
        };
        let v7 = v5 + 1;
        if (v5 == 0) {
    ...
    entry fun create_super_node_from_kiosk<T0: store + key>(arg0: &mut Registry, arg1: &mut Config, arg2: &mut MinerPool, arg3: &NFTNode, arg4: &0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: 0x2::object::ID, arg7: u8, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: 0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 2, 27);
        assert!(arg1.version == 2, 27);
        assert!(arg2.version == 2, 27);
        ...
        let v6 = arg0.total_super_nodes_created;
        if (v6 < 5) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg8) >= 10000000000, 15);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg8, 10000000000, arg10), @0xd0d72246bfb13549f654628d34bee78aaca712003a6e61fb6b406f5470967a);
        } else {
            assert!(0x2::coin::value<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&arg9) >= 100000000000000, 15);
            0x2::balance::join<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut arg2.reward_balance, 0x2::coin::into_balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(0x2::coin::split<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut arg9, 100000000000000, arg10)));
        };
        ...
        if (0x2::coin::value<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&arg9) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>>(arg9, v0);
        } else {
            0x2::coin::destroy_zero<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(arg9);
        };
        let v7 = v5 + 1;
        if (v5 == 0) {
            0x2::table::add<0x1::ascii::String, u64>(&mut arg1.super_count, v3, v7);
    ...
    entry fun create_super_node_from_personal_kiosk<T0: store + key>(arg0: &mut Registry, arg1: &mut Config, arg2: &mut MinerPool, arg3: &NFTNode, arg4: &0x2::kiosk::Kiosk, arg5: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg6: 0x2::object::ID, arg7: u8, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: 0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 2, 27);
        assert!(arg1.version == 2, 27);
        assert!(arg2.version == 2, 27);
        let v0 = 0x2::tx_context::sender(arg10);
        ...
        assert!(arg3.owner == v0, 1);
        assert!(arg3.type_str == 0x1::type_name::into_string(0x1::type_name::with_defining_ids<0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::suifrens::SuiFren<0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::capy::Capy>>()), 18);
        0x2::kiosk::borrow<T0>(arg4, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg5), arg6);
        let v2 = 0x1::type_name::with_defining_ids<T0>();
        let v3 = 0x1::type_name::into_string(v2);
        if (!0x2::table::contains<0x1::ascii::String, bool>(&arg1.allowed_types, v3)) {
            0x2::table::add<0x1::ascii::String, bool>(&mut arg1.allowed_types, v3, true);
    ...
    public fun fund_pool(arg0: &mut MinerPool, arg1: 0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>) {
        assert!(arg0.version == 2, 27);
        assert!(0x2::coin::value<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&arg1) >= 1000000000000, 29);
        0x2::balance::join<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut arg0.reward_balance, 0x2::coin::into_balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(arg1));
    }

    fun get_current_phase_and_reward(arg0: u64, arg1: u64) : (u64, u64) {
        if (arg1 < arg0) {
            return (0, 0)
        };
    ...
    entry fun migrate_commit_registry(arg0: &mut CommitRegistry, arg1: &AdminCap) {
    ...
    entry fun register_capy_from_personal_kiosk(arg0: &mut Registry, arg1: &mut ShardPool, arg2: &Config, arg3: &0x2::kiosk::Kiosk, arg4: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg5: 0x2::object::ID, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg4);
        assert!(arg0.version == 2, 27);
        assert!(arg1.version == 2, 27);
        let v1 = 0x2::tx_context::sender(arg7);
        assert!(!0x2::table::contains<address, bool>(&arg0.registered_wallets, v1), 5);
        assert!(0x2::object::id<ShardPool>(arg1) == *0x1::vector::borrow<0x2::object::ID>(&arg0.shard_pool_ids, find_lowest_shard_index(&arg0.shard_pool_ids, &arg0.shard_participant_counts)), 23);
        let v2 = calculate_power();
        let v3 = 0x2::clock::timestamp_ms(arg6);
        let v4 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::suifrens::SuiFren<0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::capy::Capy>>());
        assert!(0x2::table::contains<0x1::ascii::String, bool>(&arg2.allowed_types, v4), 12);
        ...
        *0x2::table::borrow_mut<0x2::object::ID, u64>(&mut arg0.shard_participant_counts, 0x2::object::id<ShardPool>(arg1)) = arg1.participant_count;
        let v5 = NFTNode{
            id              : 0x2::object::new(arg7),
            nft_id          : 0x2::object::id<0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::suifrens::SuiFren<0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::capy::Capy>>(0x2::kiosk::borrow<0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::suifrens::SuiFren<0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::capy::Capy>>(arg3, v0, arg5)),
            power           : v2,
            last_claim_time : 0,
            registered_at   : v3,
            owner           : v1,
        ...
        0x2::table::add<address, bool>(&mut arg0.registered_wallets, v1, true);
        0x2::transfer::transfer<NFTNode>(v5, v1);
    }
    ...
    entry fun register_with_super_from_personal_kiosk<T0: store + key>(arg0: &mut Registry, arg1: &mut ShardPool, arg2: &Config, arg3: &mut SuperNode, arg4: &0x2::kiosk::Kiosk, arg5: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg6: 0x2::object::ID, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg5);
        assert!(arg0.version == 2, 27);
        assert!(arg1.version == 2, 27);
        assert!(arg3.version == 2, 27);
        ...
        assert!(0x2::table::contains<0x1::ascii::String, bool>(&arg2.allowed_types, v2), 12);
        assert!(arg3.enabled_type == 0x1::type_name::with_defining_ids<T0>(), 14);
        assert!(arg3.current_onboarded < arg3.max_onboarded, 13);
        0x2::kiosk::borrow<T0>(arg4, v0, arg6);
        let v3 = calculate_power();
        let v4 = 0x2::clock::timestamp_ms(arg7);
        arg1.total_power = arg1.total_power + (v3 as u128);
        arg1.participant_count = arg1.participant_count + 1;
        adjust_difficulty_shard(arg1);
        update_snapshot_if_needed_shard(arg1, v4);
        *0x2::table::borrow_mut<0x2::object::ID, u64>(&mut arg0.shard_participant_counts, 0x2::object::id<ShardPool>(arg1)) = arg1.participant_count;
        arg3.current_onboarded = arg3.current_onboarded + 1;
        let v5 = NFTNode{
            id              : 0x2::object::new(arg8),
    ...
    entry fun reveal_mine<T0: store + key>(arg0: &mut ShardPool, arg1: &mut MinerPool, arg2: &mut NFTNode, arg3: &T0, arg4: MiningCommit, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &0x2::random::Random, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (((v9 % 1000000) as u128) < (arg2.power as u128) * 1000 / (arg0.difficulty_factor as u128) * 1000000 / v4 && v3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>>(0x2::coin::from_balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(0x2::balance::split<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut arg1.reward_balance, v3), arg8), v0);
    ...
    entry fun reveal_mine_from_kiosk<T0: store + key>(arg0: &mut ShardPool, arg1: &mut MinerPool, arg2: &mut NFTNode, arg3: &0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: MiningCommit, arg7: vector<u8>, arg8: &0x2::clock::Clock, arg9: &0x2::random::Random, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::object::delete(v13);
        if (((v9 % 1000000) as u128) < (arg2.power as u128) * 1000 / (arg0.difficulty_factor as u128) * 1000000 / v4 && v3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>>(0x2::coin::from_balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(0x2::balance::split<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut arg1.reward_balance, v3), arg10), v0);
            let v19 = MineSucceeded{
                miner         : v0,
                nft_id        : arg2.nft_id,
                reward_amount : v3,
    ...
    entry fun reveal_mine_from_personal_kiosk<T0: store + key>(arg0: &mut ShardPool, arg1: &mut MinerPool, arg2: &mut NFTNode, arg3: &0x2::kiosk::Kiosk, arg4: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg5: 0x2::object::ID, arg6: MiningCommit, arg7: vector<u8>, arg8: &0x2::clock::Clock, arg9: &0x2::random::Random, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg4);
        assert!(arg0.version == 2, 27);
        assert!(arg1.version == 2, 27);
        let v1 = 0x2::tx_context::sender(arg10);
        assert!(arg6.miner == v1, 1);
        assert!(arg6.nft_node_id == 0x2::object::id<NFTNode>(arg2), 4);
        assert!(arg2.owner == v1, 1);
        assert!(!arg6.revealed, 7);
        assert!(0x2::object::id<T0>(0x2::kiosk::borrow<T0>(arg3, v0, arg5)) == arg2.nft_id, 4);
        assert!(0x1::option::is_none<0x2::object::ID>(&arg2.super_id), 19);
        let v2 = 0x2::clock::timestamp_ms(arg8);
        assert!(v2 - arg6.commit_time <= 600000, 8);
        assert!(v2 - arg1.start_time <= 3155760000000, 2);
        0x1::vector::append<u8>(&mut arg7, 0x2::address::to_bytes(v1));
        0x1::vector::append<u8>(&mut arg7, 0x2::object::id_bytes<NFTNode>(arg2));
        0x1::vector::append<u8>(&mut arg7, 0x2::bcs::to_bytes<u64>(&arg6.commit_time));
        assert!(0x2::hash::blake2b256(&arg7) == arg6.commit_hash, 9);
        update_snapshot_if_needed_shard(arg0, v2);
        let (v3, v4) = get_current_phase_and_reward(arg1.start_time, v2);
        let v5 = if (arg0.total_power_snapshot == 0) {
            arg0.total_power
        } else {
            arg0.total_power_snapshot
        };
        assert!(v5 > 0, 21);
        assert!(arg0.difficulty_factor > 0, 24);
        let v6 = 0x2::random::new_generator(arg9, arg10);
        let v7 = 0x2::random::generate_u128(&mut v6);
        0x1::vector::append<u8>(&mut arg7, 0x2::bcs::to_bytes<u128>(&v7));
        let v8 = 0x2::hash::blake2b256(&arg7);
        ...
        let v12 = 0;
        while (v12 < 8 && v11 + v12 < v9) {
            let v13 = v10 << 8;
            v10 = v13 | (*0x1::vector::borrow<u8>(&v8, v11 + v12) as u64);
            v12 = v12 + 1;
        };
        arg2.last_claim_time = v2;
        let MiningCommit {
            id          : v14,
            miner       : _,
            nft_node_id : _,
        ...
        if (((v10 % 1000000) as u128) < (arg2.power as u128) * 1000 / (arg0.difficulty_factor as u128) * 1000000 / v5 && v4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>>(0x2::coin::from_balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(0x2::balance::split<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut arg1.reward_balance, v4), arg10), v1);
            let v20 = MineSucceeded{
                miner         : v1,
                nft_id        : arg2.nft_id,
                reward_amount : v4,
                phase         : v3,
            };
            0x2::event::emit<MineSucceeded>(v20);
        } else {
            let v21 = MineFailed{
                miner  : v1,
                nft_id : arg2.nft_id,
            };
            0x2::event::emit<MineFailed>(v21);
        };
    }
    ...
    entry fun reveal_with_super<T0: store + key>(arg0: &mut ShardPool, arg1: &mut MinerPool, arg2: &mut NFTNode, arg3: &T0, arg4: &SuperNode, arg5: MiningCommit, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &0x2::random::Random, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::object::delete(v13);
        if (((v9 % 1000000) as u128) < (arg2.power as u128) * 1000 / (arg0.difficulty_factor as u128) * 1000000 / v4 && v3 > 0) {
            let v19 = 0x2::balance::split<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut arg1.reward_balance, v3);
            let v20 = v3 * (arg4.fee_percent as u64) / 100;
            if (v20 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>>(0x2::coin::from_balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(0x2::balance::split<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut v19, v20), arg9), arg4.creator);
                let v21 = RoyaltyPaid{
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>>(0x2::coin::from_balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(v19, arg9), v0);
    ...
    entry fun reveal_with_super_from_kiosk<T0: store + key>(arg0: &mut ShardPool, arg1: &mut MinerPool, arg2: &mut NFTNode, arg3: &0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: &SuperNode, arg7: MiningCommit, arg8: vector<u8>, arg9: &0x2::clock::Clock, arg10: &0x2::random::Random, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (((v9 % 1000000) as u128) < (arg2.power as u128) * 1000 / (arg0.difficulty_factor as u128) * 1000000 / v4 && v3 > 0) {
            ...
            if (v20 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>>(0x2::coin::from_balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(0x2::balance::split<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut v19, v20), arg11), arg6.creator);
                let v21 = RoyaltyPaid{
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>>(0x2::coin::from_balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(v19, arg11), v0);
            let v22 = MineSucceeded{
                miner         : v0,
                nft_id        : arg2.nft_id,
                reward_amount : v3,
    ...
    entry fun reveal_with_super_from_personal_kiosk<T0: store + key>(arg0: &mut ShardPool, arg1: &mut MinerPool, arg2: &mut NFTNode, arg3: &0x2::kiosk::Kiosk, arg4: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg5: 0x2::object::ID, arg6: &SuperNode, arg7: MiningCommit, arg8: vector<u8>, arg9: &0x2::clock::Clock, arg10: &0x2::random::Random, arg11: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg4);
        assert!(arg0.version == 2, 27);
        assert!(arg1.version == 2, 27);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg2.super_id), 20);
        ...
        assert!(arg7.miner == v1, 1);
        assert!(arg7.nft_node_id == 0x2::object::id<NFTNode>(arg2), 4);
        assert!(arg2.owner == v1, 1);
        assert!(!arg7.revealed, 7);
        assert!(0x2::object::id<T0>(0x2::kiosk::borrow<T0>(arg3, v0, arg5)) == arg2.nft_id, 4);
        let v2 = 0x2::clock::timestamp_ms(arg9);
        assert!(v2 - arg7.commit_time <= 600000, 8);
        assert!(v2 - arg1.start_time <= 3155760000000, 2);
        0x1::vector::append<u8>(&mut arg8, 0x2::address::to_bytes(v1));
        0x1::vector::append<u8>(&mut arg8, 0x2::object::id_bytes<NFTNode>(arg2));
        0x1::vector::append<u8>(&mut arg8, 0x2::bcs::to_bytes<u64>(&arg7.commit_time));
        assert!(0x2::hash::blake2b256(&arg8) == arg7.commit_hash, 9);
        update_snapshot_if_needed_shard(arg0, v2);
        ...
        assert!(v5 > 0, 21);
        assert!(arg0.difficulty_factor > 0, 24);
        let v6 = 0x2::random::new_generator(arg10, arg11);
        let v7 = 0x2::random::generate_u128(&mut v6);
        0x1::vector::append<u8>(&mut arg8, 0x2::bcs::to_bytes<u128>(&v7));
        let v8 = 0x2::hash::blake2b256(&arg8);
        let v9 = 0x1::vector::length<u8>(&v8);
        let v10 = 0;
        let v11 = if (v9 > 8) {
            v9 - 8
        ...
        0x2::object::delete(v14);
        if (((v10 % 1000000) as u128) < (arg2.power as u128) * 1000 / (arg0.difficulty_factor as u128) * 1000000 / v5 && v4 > 0) {
            let v20 = 0x2::balance::split<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut arg1.reward_balance, v4);
            let v21 = v4 * (arg6.fee_percent as u64) / 100;
            if (v21 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>>(0x2::coin::from_balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(0x2::balance::split<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(&mut v20, v21), arg11), arg6.creator);
                let v22 = RoyaltyPaid{
                    super_node_id : 0x2::object::id<SuperNode>(arg6),
                    miner         : v1,
                    creator       : arg6.creator,
                ...
                0x2::event::emit<RoyaltyPaid>(v22);
            };
            0x2::transfer::public_transfer<0x2::coin::Coin<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>>(0x2::coin::from_balance<0x41fd6554825168cca007121ef56b9fd2bfda049723c5be61cc96bf2a26d24f9b::cbtc::CBTC>(v20, arg11), v1);
            let v23 = MineSucceeded{
                miner         : v1,
                nft_id        : arg2.nft_id,
                reward_amount : v4,
                phase         : v3,
            };
            0x2::event::emit<MineSucceeded>(v23);
        } else {
            let v24 = MineFailed{
                miner  : v1,
                nft_id : arg2.nft_id,
            };
            0x2::event::emit<MineFailed>(v24);
        };
    }

    entry fun set_start_time(arg0: &mut MinerPool, arg1: &AdminCap, arg2: &0x2::clock::Clock) {
        assert!(arg0.version == 2, 27);
        assert!(arg0.start_time == 0, 3);
        arg0.start_time = 0x2::clock::timestamp_ms(arg2);
    }

    entry fun setup_commitregistry(arg0: &AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = CommitRegistry{
            id                : 0x2::object::new(arg1),
            version           : 2,
            admin             : 0x2::object::id<AdminCap>(arg0),
            last_commit_times : 0x2::table::new<0x2::object::ID, u64>(arg1),
        };
        0x2::transfer::share_object<CommitRegistry>(v0);
    }
