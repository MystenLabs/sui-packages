module 0xabb1ed9f9bc24dab85bafac21ee00d09763e24450a50f054bbd04486ff2c37db::cnsnft5011 {
    struct CNSNFT5011 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5011, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5011>(arg0, arg1);
