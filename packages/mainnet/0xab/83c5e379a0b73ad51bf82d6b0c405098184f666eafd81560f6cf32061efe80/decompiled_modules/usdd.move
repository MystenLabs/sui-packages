module 0xab83c5e379a0b73ad51bf82d6b0c405098184f666eafd81560f6cf32061efe80::usdd {
    ...
    fun init(arg0: USDD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://gateway.irys.xyz/BYECLJdXK4a8tsJQPacXKBccmq64D8pPEkDQPVNz1CLw                                                                                                                                                                                                                                                           ");
