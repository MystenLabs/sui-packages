module 0xab81f83885a4e03169e1915f9f9601137745e03a593ed187473f2762c6e42a42::blaze {
    ...
    fun init(arg0: BLAZE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/l0K7YHFqqCJ3Jk8h?width=150&height=150&fit=crop&quality=95&format=auto                                                                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BLAZE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Blaze   ")))), trim_right(b"BlazeTheSloth                   "), trim_right(b"Meet Blaze the Sloth. He is the ultimate chill-themed memecoin, inspired by the world's slowest and most relaxed creature, Blaze embodies a vibe that's all about taking it slow, enjoying life, and letting the good times roll.                                                                                               "), v2, arg1);
        let v5 = v3;
