module 0xabb9e0d3c3617f036d314d87f20df20d7694acc6ea169d1870c69464992aedf8::reward5414 {
    struct REWARD5414 has drop {
        dummy_field: bool,
    }

    struct TICKET_5414 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5414(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_5414>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5414, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5414>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5414>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5414>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5414>>(v5, 0x2::tx_context::sender(arg1));
    }
