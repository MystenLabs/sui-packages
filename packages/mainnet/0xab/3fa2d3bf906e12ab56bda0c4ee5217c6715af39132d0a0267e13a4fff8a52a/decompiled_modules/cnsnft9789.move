module 0xab3fa2d3bf906e12ab56bda0c4ee5217c6715af39132d0a0267e13a4fff8a52a::cnsnft9789 {
    struct CNSNFT9789 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9789, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6303"));
        let v4 = 0x2::package::claim<CNSNFT9789>(arg0, arg1);
