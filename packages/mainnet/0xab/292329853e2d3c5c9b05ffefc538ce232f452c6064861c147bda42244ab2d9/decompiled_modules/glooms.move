module 0xab292329853e2d3c5c9b05ffefc538ce232f452c6064861c147bda42244ab2d9::glooms {
    ...
    fun init(arg0: GLOOMS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<GLOOMS>(arg0, 6, b"GLOOMS52", b"GLOOMS52", b"Gloom Gloom Gloom 52", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://red-rainy-catfish-636.mypinata.cloud/ipfs/QmY8oLfuXAzE9c1LKgaFAEsVNaektL4W82pLRDX4ChY1KZ")), arg1);
        let v2 = v0;
