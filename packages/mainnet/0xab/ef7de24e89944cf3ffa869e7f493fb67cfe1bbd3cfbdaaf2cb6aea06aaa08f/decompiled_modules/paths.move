module 0xabef7de24e89944cf3ffa869e7f493fb67cfe1bbd3cfbdaaf2cb6aea06aaa08f::paths {
        ...
        while (v1 < 0x1::vector::length<PriceNode>(arg1)) {
            ...
            if (v4 > 0) {
                ...
                while (v5 < v4) {
                    ...
                    let v8 = 0xabef7de24e89944cf3ffa869e7f493fb67cfe1bbd3cfbdaaf2cb6aea06aaa08f::arithmetic::mul_128(0x1::vector::borrow<Route>(&v3, v5).sqrtPrice, v2.sqrtPrice);
                    if (v8 > v7 || v6 < arg2) {
