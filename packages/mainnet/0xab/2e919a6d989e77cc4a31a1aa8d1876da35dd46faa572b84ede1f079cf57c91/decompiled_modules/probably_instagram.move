module 0xab2e919a6d989e77cc4a31a1aa8d1876da35dd46faa572b84ede1f079cf57c91::probably_instagram {
    struct PROBABLY_INSTAGRAM has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PROBABLY_INSTAGRAM, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PROBABLY_INSTAGRAM>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Probably Instagram"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibuzgh5abpmcas5scqpafubzyro43dp3p47iicpbsdl7mkjmkynca"));
