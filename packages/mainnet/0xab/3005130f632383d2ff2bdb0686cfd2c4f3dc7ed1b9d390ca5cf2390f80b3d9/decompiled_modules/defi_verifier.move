module 0xab3005130f632383d2ff2bdb0686cfd2c4f3dc7ed1b9d390ca5cf2390f80b3d9::defi_verifier {
    ...
    public fun verify_defi_coin<T0>(arg0: &0x2::coin::Coin<T0>) : u8 {
        ...
        max(0, 0xab3005130f632383d2ff2bdb0686cfd2c4f3dc7ed1b9d390ca5cf2390f80b3d9::scallop_checker::check(&v0, 0x2::coin::value<T0>(arg0)))
    }
    ...
    public fun verify_navi_any(arg0: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg1: &0x2::tx_context::TxContext) : u8 {
        0xab3005130f632383d2ff2bdb0686cfd2c4f3dc7ed1b9d390ca5cf2390f80b3d9::navi_checker::check_any_asset(arg0, 0x2::tx_context::sender(arg1))
    }
    ...
    public fun verify_navi_usdc(arg0: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg1: &0x2::tx_context::TxContext) : u8 {
        0xab3005130f632383d2ff2bdb0686cfd2c4f3dc7ed1b9d390ca5cf2390f80b3d9::navi_checker::check_usdc(arg0, 0x2::tx_context::sender(arg1))
    }
