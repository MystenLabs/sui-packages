module 0xab6f7007ecdb9e2be772f2a4e8c9eed125a4f687250fab09b89825af5c8d7e64::uspd {
    ...
    fun init(arg0: USPD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (10000000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<USPD>>(0x2::coin::mint<USPD>(&mut v5, 10000000000000000, arg1), v6);
        };
