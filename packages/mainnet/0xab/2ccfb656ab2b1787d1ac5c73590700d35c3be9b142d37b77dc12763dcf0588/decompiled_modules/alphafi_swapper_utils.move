module 0xab2ccfb656ab2b1787d1ac5c73590700d35c3be9b142d37b77dc12763dcf0588::alphafi_swapper_utils {
    fun calculate_sqrt_price_limit_with_slippage(arg0: u128, arg1: u128, arg2: bool) : u128 {
        let v0 = arg0 * arg1 / 1000000000;
        let v1 = v0;
        if (arg2) {
            assert!(v0 >= arg0, 1007);
            let v2 = arg0 * 9746794344 / 1000000000;
            if (v0 < v2) {
                v1 = v2;
            };
        } else {
            assert!(v0 <= arg0, 1008);
            let v3 = arg0 * 10246950766 / 1000000000;
            if (v0 > v3) {
                v1 = v3;
            };
        };
    ...
    public fun flash_swap_bluefin<T0, T1>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: bool, arg3: bool, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64, u64, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::FlashSwapReceipt<T0, T1>, u64) {
        assert!(arg4 > 0, 1011);
        let (v0, v1, v2) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::flash_swap<T0, T1>(arg6, arg1, arg0, arg2, arg3, arg4, calculate_sqrt_price_limit_with_slippage(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg0), arg5, arg2));
        let v3 = v2;
        let v4 = 0x2::coin::from_balance<T0>(v0, arg7);
        let v5 = 0x2::coin::from_balance<T1>(v1, arg7);
        (v4, v5, 0x2::coin::value<T0>(&v4), 0x2::coin::value<T1>(&v5), v3, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap_pay_amount<T0, T1>(&v3))
    }

    public fun flash_swap_cetus<T0, T1>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: bool, arg3: bool, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64, u64, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::FlashSwapReceipt<T0, T1>, u64) {
        assert!(arg4 > 0, 1011);
        let (v0, v1, v2) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg1, arg0, arg2, arg3, arg4, calculate_sqrt_price_limit_with_slippage(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg0), arg5, arg2), arg6);
        let v3 = v2;
        let v4 = 0x2::coin::from_balance<T0>(v0, arg7);
        let v5 = 0x2::coin::from_balance<T1>(v1, arg7);
        (v4, v5, 0x2::coin::value<T0>(&v4), 0x2::coin::value<T1>(&v5), v3, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T1>(&v3))
    }

    public fun flash_swap_momentum<T0, T1>(arg0: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: bool, arg2: bool, arg3: u64, arg4: u128, arg5: &0x2::clock::Clock, arg6: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64, u64, 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::FlashSwapReceipt, u64) {
        assert!(arg3 > 0, 1011);
        let (v0, v1, v2) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::flash_swap<T0, T1>(arg0, arg1, arg2, arg3, calculate_sqrt_price_limit_with_slippage(0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::sqrt_price<T0, T1>(arg0), arg4, arg1), arg5, arg6, arg7);
        let v3 = v2;
        let v4 = 0x2::coin::from_balance<T0>(v0, arg7);
        let v5 = 0x2::coin::from_balance<T1>(v1, arg7);
        ...
        (v4, v5, 0x2::coin::value<T0>(&v4), 0x2::coin::value<T1>(&v5), v3, v8)
    }
