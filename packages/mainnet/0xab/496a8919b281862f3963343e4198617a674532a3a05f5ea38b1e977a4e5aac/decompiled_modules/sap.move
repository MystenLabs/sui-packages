module 0x60b2d436499019ffa0a9e029d488851bcc82dd745f9ff85c502f8be75145934b::sap {
    ...
    fun pay_dev_ops(arg0: &Protocol, arg1: address, arg2: u64, arg3: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(200 <= 500, 4);
        let v0 = bps_amount(arg2, 200);
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(arg3, v0), arg4), arg0.admin);
            let v1 = DevOpsPaid{
                buyer     : arg1,
    ...
    entry fun update_mint_settings(arg0: &AdminCap, arg1: &mut Protocol, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::tx_context::TxContext) {
        ...
        assert!(arg6 <= 500, 4);
        assert!(200 <= 500, 4);
        assert!(arg5 + arg6 + 200 <= 10000, 4);
        assert!(arg5 + 500 + 500 <= 10000, 4);
