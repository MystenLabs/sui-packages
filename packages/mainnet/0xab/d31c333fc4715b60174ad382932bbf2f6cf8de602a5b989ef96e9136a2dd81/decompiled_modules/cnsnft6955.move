module 0xabd31c333fc4715b60174ad382932bbf2f6cf8de602a5b989ef96e9136a2dd81::cnsnft6955 {
    struct CNSNFT6955 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6955, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6955>(arg0, arg1);
