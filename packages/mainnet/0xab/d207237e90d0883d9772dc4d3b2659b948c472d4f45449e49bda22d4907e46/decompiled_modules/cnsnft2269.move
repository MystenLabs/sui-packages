module 0xabd207237e90d0883d9772dc4d3b2659b948c472d4f45449e49bda22d4907e46::cnsnft2269 {
    struct CNSNFT2269 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2269, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2269>(arg0, arg1);
