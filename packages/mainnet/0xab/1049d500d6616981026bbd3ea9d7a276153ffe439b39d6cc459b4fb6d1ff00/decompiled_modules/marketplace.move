module 0xab1049d500d6616981026bbd3ea9d7a276153ffe439b39d6cc459b4fb6d1ff00::marketplace {
    ...
    public entry fun place_nft<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0x2::kiosk::Kiosk>(arg0);
        0x2::transfer::public_transfer<T0>(arg1, 0x2::object::id_to_address(&v0));
        let v1 = NFTPlaced{
            nft_id   : 0x2::object::id<T0>(&arg1),
            kiosk_id : v0,
            seller   : 0x2::tx_context::sender(arg2),
        };
        0x2::event::emit<NFTPlaced>(v1);
    }
