module 0xc85a8f48af9a778b5ea56689506e2533bca32784c700811b3f8749ea079a8cc9::github_nft {
    ...
    fun init(arg0: GITHUB_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"desc"));
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"image_url"));
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"creator"));
        let v2 = 0x1::vector::empty<0x1::string::String>();
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{name} #{nft_id}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"lu github nft"));
        ...
        0x2::transfer::public_share_object<MintRecord>(v4);
    }
