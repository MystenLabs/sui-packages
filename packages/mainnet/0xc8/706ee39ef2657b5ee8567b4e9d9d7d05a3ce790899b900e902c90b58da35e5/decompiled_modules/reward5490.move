module 0xc8706ee39ef2657b5ee8567b4e9d9d7d05a3ce790899b900e902c90b58da35e5::reward5490 {
    struct REWARD5490 has drop {
        dummy_field: bool,
    }

    struct TICKET_5490 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5490(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_5490>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5490, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5490>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5490>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5490>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5490>>(v5, 0x2::tx_context::sender(arg1));
    }
