module 0xc887176663fa1b6a84457a83eec4e08352743afbbe13c60df79a8173e923c2ed::cnsnft3208 {
    struct CNSNFT3208 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3208, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3208>(arg0, arg1);
