module 0xc87453ed98366ad5ac663df89410ddd1596b2b6d8153da942eb2a61c8080755a::game {
    ...
    entry fun claim(arg0: &mut GameInfo, arg1: bool, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::table_vec::borrow<BoatLevel>(&arg0.boat_level, (v1.boat as u64));
        let v3 = 0x2::table_vec::borrow<MeshLevel>(&arg0.mesh_level, (v1.mesh as u64));
        let v4 = 0x2::table_vec::borrow<SeafoodLevel>(&arg0.seafood_level, (v1.seafood as u64));
        let v5 = 0x2::clock::timestamp_ms(arg2);
        assert!(v5 - v1.last_claim >= (v2.fishing_time as u64) * 60 * 60 * 1000 / 10000, 6);
        v1.last_claim = v5;
        let v6 = 1000000000 * (v2.fishing_time as u64) / 10000 * (v3.speed as u64) / 10000 * (v4.rate as u64) / 10000;
        let v7 = v6;
        if (0x1::option::is_some<u16>(&v1.special_boost)) {
            let v8 = 0x2::table_vec::borrow<SpecialBoost>(&arg0.special_boost, (0x1::option::extract<u16>(&mut v1.special_boost) as u64));
            if (v8.type == 0 && v5 >= v8.start_time && v5 <= v8.start_time + v8.duration) {
                v7 = v6 * (v8.rate as u64) / 10000;
            };
            if (v8.type == 1 && v5 >= v1.special_boost_start_time && v5 <= v1.special_boost_start_time + v8.duration) {
                let v9 = v7 * (v8.rate as u64);
                v7 = v9 / 10000;
            };
        };
        let v10 = v7;
        if (arg1) {
            v10 = v7 * (10000 - (arg0.gas_fee as u64)) / 10000;
        };
        let v11 = v1.referral;
        send_token(arg0, v0, v10, arg3);
        if (v11 != v0 && 0x2::dynamic_object_field::exists_<address>(&arg0.id, v11)) {
            let v12 = v7 * (arg0.ref1 as u64) / 10000;
            send_token(arg0, v11, v12, arg3);
            let v13 = 0x2::dynamic_object_field::borrow<address, User>(&arg0.id, v11).referral;
            if (v13 != v11 && 0x2::dynamic_object_field::exists_<address>(&arg0.id, v13)) {
                let v14 = v7 * (arg0.ref2 as u64) / 10000;
                send_token(arg0, v13, v14, arg3);
            };
        };
    }
