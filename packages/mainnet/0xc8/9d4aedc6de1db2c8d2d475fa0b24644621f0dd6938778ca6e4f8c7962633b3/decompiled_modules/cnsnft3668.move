module 0xc89d4aedc6de1db2c8d2d475fa0b24644621f0dd6938778ca6e4f8c7962633b3::cnsnft3668 {
    struct CNSNFT3668 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3668, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3668>(arg0, arg1);
