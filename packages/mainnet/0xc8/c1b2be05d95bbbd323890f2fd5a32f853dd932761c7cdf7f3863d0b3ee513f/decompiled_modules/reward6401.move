module 0xc8c1b2be05d95bbbd323890f2fd5a32f853dd932761c7cdf7f3863d0b3ee513f::reward6401 {
    struct REWARD6401 has drop {
        dummy_field: bool,
    }

    struct TICKET_6401 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6401(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6401>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6401>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6401, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6401>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6401>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6401>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6401>>(v5, 0x2::tx_context::sender(arg1));
    }
