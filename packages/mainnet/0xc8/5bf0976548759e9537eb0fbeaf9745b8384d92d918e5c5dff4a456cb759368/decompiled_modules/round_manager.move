module 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::round_manager {
    ...
    fun assert_version_v2(arg0: &GlobalV2) {
        assert!(arg0.version == 6, 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_INVALID_VERSION());
    }

    public(friend) fun burn_faith(arg0: &mut GlobalV2, arg1: 0x2::coin::Coin<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>) : u64 {
    ...
    public entry fun missed_round_refund_entry_v2(arg0: &mut GlobalV2, arg1: u64, arg2: vector<address>, arg3: vector<u64>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<u64>(&arg3) == 0x1::vector::length<address>(&arg2), 13906837610317217791);
        0x1::vector::reverse<u64>(&mut arg3);
        let v4 = 0;
    ...
    public entry fun roll_season_entry_v3(arg0: &mut GlobalV2, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg2);
        assert_version_v2(arg0);
        assert!(arg0.season_start_ms != 0, 13906836966072123391);
    ...
    public entry fun season_award_sui_from_pilgrimage_entry_v3(arg0: &mut GlobalV2, arg1: &0x2::clock::Clock, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert_version_v2(arg0);
        assert!(arg3 > 0, 13906837266719834111);
    ...
    fun settle(arg0: &mut GlobalV2, arg1: &0x2::random::Random, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
            ...
            if (v11 > 0) {
                ...
                while (v12 < v10 && v8 > 0) {
                    ...
                    if (v15 > 0) {
                        ...
                        let v21 = (((v14 as u128) * (3000 as u128) / 10000) as u64);
                        if (v21 > 0) {
        ...
        if (v32) {
            ...
            while (v34 < v10) {
                ...
                let v36 = ((((v35.amount as u128) * (soul_age_multiplier_bps_for_user(arg0, v35.owner) as u128) / 10000) as u64) as u128);
            ...
            if (v33 > 0) {
                ...
                while (v39 < v10 && v38 > 0) {
                    ...
                    let v41 = ((((v40.amount as u128) * (soul_age_multiplier_bps_for_user(arg0, v40.owner) as u128) / 10000) as u64) as u128);
                    let v42 = 0;
                    if (v39 == v10 - 1) {
                        v42 = v38;
                    } else if (v41 > 0) {
            ...
            if (v8 > 0) {
                ...
                while (v9 < v7 && v5 > 0) {
                    ...
                    let v12 = if (v9 == v7 - 1) {
                        ...
                        let v13 = (((((v5 as u128) as u128) * ((v10.amount as u128) as u128) / ((v8 as u128) as u128)) as u128) as u64);
                        v11 = v13;
                        if (v13 == 0 && v5 > 0) {
                            v11 = 1;
                        };
                    ...
                    if (v12 > 0) {
                        ...
                        let v16 = (((v11 as u128) * (3000 as u128) / 10000) as u64);
                        if (v16 > 0) {
    ...
    public entry fun stop_seasons_entry_v2(arg0: &mut GlobalV2, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert_version_v2(arg0);
        assert!(arg0.paused, 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::errors::E_NOT_PAUSED());
        assert!(arg0.season_start_ms != 0, 13906836811453300735);
        let v0 = SeasonClosed{
            index         : arg0.season_index,
            started_at_ms : arg0.season_start_ms,
