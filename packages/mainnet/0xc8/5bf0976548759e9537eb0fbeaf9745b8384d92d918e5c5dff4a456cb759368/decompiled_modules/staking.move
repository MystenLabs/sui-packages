module 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::staking {
    ...
    fun add_rewards(arg0: &mut StakingPool, arg1: 0x2::coin::Coin<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>, arg2: &0x2::tx_context::TxContext) {
        ...
        while (v5 < 0x1::vector::length<Position>(v4)) {
            ...
            v3 = v3 + ((((v6.shares as u128) * (blessings_multiplier_bps(v6.entered_epoch, v1) as u128) / 10000) as u64) as u128);
            v5 = v5 + 1;
        };
        if (v3 == 0) {
            return
        ...
        while (v7 < v2) {
            ...
            let v10 = ((((v9.shares as u128) * (blessings_multiplier_bps(v9.entered_epoch, v1) as u128) / 10000) as u64) as u128);
            let v11 = 0;
            if (v7 == v2 - 1) {
                v11 = v0;
            } else if (v0 > 0 && v10 > 0) {
                let v12 = (((((v0 as u128) * (v10 as u128) / (v3 as u128)) as u64) as u128) as u64);
                let v13 = v12;
                if (v12 == 0 && v0 > 0) {
                    v13 = 1;
                };
