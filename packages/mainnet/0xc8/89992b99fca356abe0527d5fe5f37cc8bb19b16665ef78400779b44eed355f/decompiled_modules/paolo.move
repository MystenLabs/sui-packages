module 0xc889992b99fca356abe0527d5fe5f37cc8bb19b16665ef78400779b44eed355f::paolo {
    struct PAOLO has drop {
        dummy_field: bool,
    }

    fun init(arg0: PAOLO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PAOLO>(arg0, 6, b"paolo", b"paolo please launch", b"please paolo my family is dying", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://lavender-gentle-primate-223.mypinata.cloud/ipfs/QmTmA3vQT5M7YEiXbfpaaAE2gBUqavjDJ5qHWkhoRqc2iw?pinataGatewayToken=M45Jh03NicrVqTZJJhQIwDtl7G6fGS90bjJiIQrmyaQXC_xXj4BgRqjjBNyGV7q2")), arg1);
        let v2 = v0;
