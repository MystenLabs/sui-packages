module 0xc83f2ed7dfa820b621c5cf6a8de508c8213f5db54e2c438066ea364bbbc8a69b::reward4142 {
    struct REWARD4142 has drop {
        dummy_field: bool,
    }

    struct TICKET_4142 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4142(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4142>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4142>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4142, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4142>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4142>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4142>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4142>>(v5, 0x2::tx_context::sender(arg1));
    }
