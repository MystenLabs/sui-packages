module 0xc8ca97991f0db3ce76acc6a7e89bec2aa7bfc3d910573e51fe275db5bf82a2c2::reward3990 {
    struct REWARD3990 has drop {
        dummy_field: bool,
    }

    struct TICKET_3990 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3990(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3990>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3990>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3990, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3990>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3990>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3990>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3990>>(v5, 0x2::tx_context::sender(arg1));
    }
