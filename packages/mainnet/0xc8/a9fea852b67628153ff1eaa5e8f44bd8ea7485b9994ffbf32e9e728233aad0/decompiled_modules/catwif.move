module 0xc8a9fea852b67628153ff1eaa5e8f44bd8ea7485b9994ffbf32e9e728233aad0::catwif {
    ...
    fun init(arg0: CATWIF, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CATWIF>(arg0, 9, b"CatWif", b"CatWif", b"CatWifHat", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://dd.dexscreener.com/ds-data/tokens/solana/Avb1PBRudW7uUV9MqTUqfZ3EZTDvNkKS63W3wyPseudf.png")), arg1);
        let v2 = v0;
        let v3 = &mut v2;
