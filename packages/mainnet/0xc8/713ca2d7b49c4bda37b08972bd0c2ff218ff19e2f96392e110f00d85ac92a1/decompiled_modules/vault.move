module 0xc8713ca2d7b49c4bda37b08972bd0c2ff218ff19e2f96392e110f00d85ac92a1::vault {
    ...
    struct StrategyVault has key {
        ...
        cap: 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::lb_pair::StrategyVaultCap,
        balance: 0x2::bag::Bag,
        yield: 0x2::bag::Bag,
        reward: 0x2::bag::Bag,
    ...
    public(friend) fun add_reward<T0>(arg0: &mut StrategyVault, arg1: 0x2::balance::Balance<T0>) {
        if (!0x2::bag::contains<0x1::type_name::TypeName>(&arg0.reward, 0x1::type_name::with_defining_ids<T0>())) {
            0x2::bag::add<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.reward, 0x1::type_name::with_defining_ids<T0>(), 0x2::balance::zero<T0>());
        };
        0x2::balance::join<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.reward, 0x1::type_name::with_defining_ids<T0>()), arg1);
    }
    ...
    public(friend) fun borrow_reward_mut<T0>(arg0: &mut StrategyVault) : &mut 0x2::balance::Balance<T0> {
        0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.reward, 0x1::type_name::with_defining_ids<T0>())
    }
    ...
    public fun create_vault<T0, T1>(arg0: &0xc8713ca2d7b49c4bda37b08972bd0c2ff218ff19e2f96392e110f00d85ac92a1::config::AdminCap, arg1: &0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::config::GlobalConfig, arg2: &mut 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::lb_pair::LBPair<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::new(arg3);
        let v1 = 0x2::object::uid_to_inner(&v0);
        let v2 = 0x2::object::id<0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::lb_pair::LBPair<T0, T1>>(arg2);
        let v3 = StrategyVault{
            id        : v0,
            pair_id   : v2,
            cap       : 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::lb_pair::set_strategy_vault<T0, T1>(arg1, arg2, v1, arg3),
            balance   : 0x2::bag::new(arg3),
            yield     : 0x2::bag::new(arg3),
            reward    : 0x2::bag::new(arg3),
    ...
    public fun deposit_to_pair<T0, T1>(arg0: &0xc8713ca2d7b49c4bda37b08972bd0c2ff218ff19e2f96392e110f00d85ac92a1::config::RebalancerCap, arg1: &0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::config::GlobalConfig, arg2: &mut 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::lb_pair::LBPair<T0, T1>, arg3: &mut StrategyVault, arg4: u64, arg5: u64) {
        ...
        0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::lb_pair::deposit_from_vault<T0, T1>(arg1, arg2, &arg3.cap, &mut v0, &mut v1, arg4, arg5);
    ...
    public fun vault_reward<T0>(arg0: &StrategyVault) : u64 {
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.reward, 0x1::type_name::with_defining_ids<T0>())) {
            0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg0.reward, 0x1::type_name::with_defining_ids<T0>()))
        } else {
            0
        }
    }
    ...
    public fun withdraw_from_pair<T0, T1>(arg0: &0xc8713ca2d7b49c4bda37b08972bd0c2ff218ff19e2f96392e110f00d85ac92a1::config::RebalancerCap, arg1: &0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::config::GlobalConfig, arg2: &mut 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::lb_pair::LBPair<T0, T1>, arg3: &mut StrategyVault, arg4: u64, arg5: u64) {
        ...
        let v0 = 0x2::bag::remove<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg3.balance, 0x1::type_name::with_defining_ids<T0>());
        let v1 = 0x2::bag::remove<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg3.balance, 0x1::type_name::with_defining_ids<T1>());
        0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::lb_pair::withdraw_to_vault<T0, T1>(arg1, arg2, &arg3.cap, &mut v0, &mut v1, arg4, arg5);
        0x2::bag::add<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg3.balance, 0x1::type_name::with_defining_ids<T0>(), v0);
        0x2::bag::add<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg3.balance, 0x1::type_name::with_defining_ids<T1>(), v1);
