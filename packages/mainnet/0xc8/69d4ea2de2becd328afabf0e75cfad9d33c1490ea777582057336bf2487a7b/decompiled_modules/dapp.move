module 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::dapp {
    ...
    struct Contract<phantom T0> has key {
        ...
        withdraw_charges: u8,
        withdraw_ratio: u8,
        global_network_data: 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::GlobalNetworkData,
        vault: Vault,
        admin: address,
        rebot: address,
    }
    ...
    fun add_user_balance(arg0: address, arg1: u64, arg2: &mut 0x2::table::Table<address, User>, arg3: &mut 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::GlobalNetworkData) {
        ...
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_user_balance(arg3, arg1);
    ...
    public fun adminWithdrawAmount<T0, T1>(arg0: &mut Contract<T1>, arg1: u64, arg2: address, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_admin_sui_amount(&mut arg0.global_network_data, arg1);
    }
    ...
    public entry fun adminWithdraw_pre<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_admin_pre_amount(&mut arg0.global_network_data, arg2);
    }

    fun apply_reward(arg0: &mut User, arg1: &mut 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::GlobalNetworkData, arg2: u64, arg3: bool) {
        ...
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_user_balance(arg1, v1);
        arg0.total_earning = arg0.total_earning + v1;
        arg0.today_earning = arg0.today_earning + v1;
        if (arg3) {
            0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_static_power_distributed(arg1, v1);
        } else {
            0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_dynamic_power_distributed_amount(arg1, v1);
        };
    }
    ...
    public fun appointUserLevel<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::updateLevel(&mut arg0.global_network_data, get_user_level(v0), arg2);
    ...
    public entry fun bindInviter<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_user(&mut arg0.global_network_data, 1);
    }

    public fun buyToken<T0, T1>(arg0: &mut Contract<T1>, arg1: &mut 0xf64c53c15b63226cff5e81f5dfcaa7d7f2743e93dfeded0a83b5f5db4f19ccff::implements::Global, arg2: &0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::PriceOracle, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg3);
        assert!(v0 > 0, 13906838812908060671);
        let v1 = 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::get_usdt_from_sui(arg2, v0);
        ...
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_use_pre_buy_quota(&mut arg0.global_network_data, v1, 0x2::coin::value<T1>(&v4));
    }
    ...
    fun calc_level_diff(arg0: &mut 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64) {
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 100) {
            ...
            if (v5 > 0) {
                ...
                if (v4.invest_amount > 0) {
                    ...
                    0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::addTeamReward(arg0, v8);
                    0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_user_balance(arg0, v8);
                };
            };
            v0 = v4.inviter;
            v1 = v1 + 1;
    ...
    public entry fun claimBalance<T0, T1>(arg0: &mut Contract<T1>, arg1: &0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg10: &mut 0xf64c53c15b63226cff5e81f5dfcaa7d7f2743e93dfeded0a83b5f5db4f19ccff::implements::Global, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::sub_total_user_balance(v0, arg2);
        let v3 = arg2 / 10;
        let v4 = v3 / 2;
        let v5 = 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::get_sui_amount(arg1, arg2 - v3 + v4);
        let v6 = withdrawSui<T0>(&arg0.vault, v5, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg11);
        let v7 = 0xf64c53c15b63226cff5e81f5dfcaa7d7f2743e93dfeded0a83b5f5db4f19ccff::interface::swapCoin<T0, T1>(arg10, 0x2::coin::split<T0>(&mut v6, 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::get_sui_amount(arg1, v4), arg11), 0, arg11);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v7, @0x0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v6, v1);
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_claimed_amount(v0, arg2, v5, v3);
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_pre_burn_usdt_amount(v0, v4);
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_pre_burn_pre_amount(v0, 0x2::coin::value<T1>(&v7));
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_share_rank_dividend_amount(v0, v4);
    }

    public entry fun claimInterest<T0>(arg0: &mut Contract<T0>, arg1: u64, arg2: &0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::PriceOracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::get_pre_amount(arg2, v7);
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_caimed_stake_interest(v3, v8, v7);
    ...
    fun distribute_pre_level_reward<T0>(arg0: address, arg1: u64, arg2: &0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::PriceOracle, arg3: &mut Contract<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::option::is_some<address>(&v2) && v3 <= 100) {
            ...
            if (v7 > 0) {
                ...
                let v9 = 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::get_pre_amount(arg2, v8);
                let v10 = PreReward{
                    user   : v5,
                    amount : v9,
                };
                0x1::vector::push_back<PreReward>(&mut v4, v10);
                0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_team_stake_team_reward(v0, v9, v8);
            };
            v2 = v6.inviter;
            v3 = v3 + 1;
        };
    ...
    public fun distribute_rank_share<T0>(arg0: &mut Contract<T0>, arg1: &mut 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::rank_list::TodayRank, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.rebot == 0x2::tx_context::sender(arg3), 1);
        let v0 = 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::rank_list::distribute_reward(arg1, 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::get_current_rank_reward(&mut arg0.global_network_data), arg2);
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::clean_rank_reward(&mut arg0.global_network_data);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::rank_list::RankItem>(&v0)) {
            let v2 = 0x1::vector::borrow<0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::rank_list::RankItem>(&v0, v1);
            let v3 = &mut arg0.users;
            let v4 = &mut arg0.global_network_data;
            add_user_balance(0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::rank_list::get_user(v2), 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::rank_list::get_amount(v2), v3, v4);
            v1 = v1 + 1;
        };
    }
    ...
    public fun freezeUser<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2 == 1) {
            0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_freeze_user(&mut arg0.global_network_data, 1);
        } else {
            0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::sub_total_freeze_user(&mut arg0.global_network_data, 1);
        };
    }
    ...
    fun handler_out(arg0: &mut 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::GlobalNetworkData, arg1: address, arg2: &mut 0x2::table::Table<address, User>) {
        let v0 = 0;
        ...
        if (v0 > 0) {
            ...
            0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::sub_total_asset_invested(arg0, v0);
        };
    }
    ...
    public fun init_contract<T0>(arg0: &AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = Contract<T0>{
            ...
            withdraw_charges    : 10,
            withdraw_ratio      : 100,
            global_network_data : 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::new(),
            vault               : v4,
    ...
    public entry fun investment<T0, T1, T2>(arg0: &mut Contract<T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::PriceOracle, arg4: u64, arg5: u8, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg9: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg10: &mut 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::rank_list::TodayRank, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg5 > 0) {
            ...
            0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_sui_invested(v3, v6, arg4 * (arg5 as u64) / 100);
        } else {
        ...
        if (v7 > 0) {
            ...
            v8 = v10;
            assert!(v10 >= 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::get_pre_amount(arg3, v9), 2);
            0x2::balance::join<T1>(&mut arg0.pre_balance, 0x2::coin::into_balance<T1>(arg2));
            0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_pre_invested(v3, v10, v9);
        } else {
        ...
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_asset_invested(v3, arg4);
        if (v11) {
            0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_effective_user(v3, 1);
        };
        let v13 = Order{
        ...
        if (v11 && arg0.up_time < 0x2::clock::timestamp_ms(arg11)) {
            ...
            v4.level = v14;
            0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::updateLevel(v3, 0, v14);
    ...
    fun release_dynamic_power(arg0: &mut User, arg1: &mut 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::GlobalNetworkData) {
        ...
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::sub_total_dynamic_power(arg1, v0);
        apply_reward(arg0, arg1, v0, false);
    }

    fun release_static_power(arg0: &mut User, arg1: &mut 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::GlobalNetworkData) {
    ...
    public entry fun stake<T0>(arg0: &mut Contract<T0>, arg1: &0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::PriceOracle, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::table::borrow_mut<address, User>(&mut arg0.users, 0x2::tx_context::sender(arg5));
        assert!(v2.state == 0, 303);
        let v3 = 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::price_oracle::get_usdt_from_pre(arg1, v0);
        0x2::balance::join<T0>(&mut arg0.pre_balance, 0x2::coin::into_balance<T0>(arg2));
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_cumulative_stake(&mut arg0.global_network_data, v0, v3);
        let v4 = StakeOrder{
    ...
    public entry fun unStake<T0>(arg0: &mut Contract<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_redemption_pre(&mut arg0.global_network_data, v4);
    ...
    fun update_dynamic_power(arg0: &mut 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64, arg4: bool) {
        let v0 = 0x2::table::borrow_mut<address, User>(arg1, arg2).inviter;
        let v1 = 1;
        let v2 = 0x1::vector::empty<address>();
        while (0x1::option::is_some<address>(&v0) && v1 <= 20) {
            ...
            if (v9.invest_amount > 0 && v8 > 0) {
                ...
                if (v1 == 1 && arg4) {
                    ...
                    0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_dynamic_power_distributed(arg0, v10 - v13);
                    0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_share_reward(arg0, v13);
                    0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_user_balance(arg0, v13);
                } else {
                    v9.dynamic_power = v9.dynamic_power + v10;
                    0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_dynamic_power_distributed(arg0, v10);
                };
                if (v1 == 1) {
                    v9.quota = v9.quota + v10;
                    0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::admin::add_total_pre_buy_quota(arg0, v10);
                };
            };
            v0 = v9.inviter;
            v1 = v1 + 1;
    ...
    fun update_share_performance(arg0: &mut 0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::rank_list::TodayRank, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        let v0 = 0x2::table::borrow_mut<address, User>(arg1, arg2).inviter;
        if (0x1::option::is_some<address>(&v0)) {
            ...
            if (v2.invest_amount > 0) {
                ...
                0xc07f687bf0613508340126a13f9a25ca2675949c26d4e2df40924cf4d7a6670a::rank_list::add_performance(arg0, v1, arg3, arg4);
            };
        };
    }
