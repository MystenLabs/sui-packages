module 0xc873bf893b4c857ab0a403a0b63a54f77e179fd0489cdf3a56a2d2193dc168ec::gift2542 {
    struct GIFT2542 has drop {
        dummy_field: bool,
    }

    struct TICKET_2542 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2542(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2542>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2542>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2542, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2542>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2542>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2542>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2542>>(v5, 0x2::tx_context::sender(arg1));
    }
