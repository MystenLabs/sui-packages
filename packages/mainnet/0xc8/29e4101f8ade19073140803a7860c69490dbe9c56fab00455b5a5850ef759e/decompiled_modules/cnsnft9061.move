module 0xc829e4101f8ade19073140803a7860c69490dbe9c56fab00455b5a5850ef759e::cnsnft9061 {
    struct CNSNFT9061 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9061, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9061>(arg0, arg1);
