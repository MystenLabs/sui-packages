module 0xc8d6f2dce929c4f0b609cdf718ea12823cb86c64e7c05933fd9da993769ae603::cnsnft6731 {
    struct CNSNFT6731 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6731, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6731>(arg0, arg1);
