module 0xc81c6393e6af12da05711680fb57c83633d38f859fdbcecf841bcc1c7640cd1c::cnsnft7424 {
    struct CNSNFT7424 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7424, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7424>(arg0, arg1);
