module 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::combo_dice {
    ...
    public(friend) entry fun deposit_stakes<T0>(arg0: &mut Registry, arg1: u64, arg2: vector<0x2::coin::Coin<T0>>, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<T0>(v2, 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::extract_balance<T0>(arg2, arg3, arg4));
    ...
    public entry fun draw<T0>(arg0: &mut Registry, arg1: u64, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>(&v7) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>>(v7, v4);
        } else {
            0x2::coin::destroy_zero<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>(v7);
        };
    }
    ...
    fun draw_with_bls_sig<T0>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>) {
        let v0 = &mut arg0.id;
        let v1 = get_mut_playground(v0, arg1);
        ...
        let v21 = 0x2::dynamic_object_field::remove<vector<u8>, 0x2::coin::Coin<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>>(&mut v19, b"tails_exp_coin");
        ...
        let v26 = 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::multiplier(9);
        ...
        let v34 = 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::get_u64_padding_value(&v1.game_config.u64_padding, 0);
        let v35 = if (v33 > v34) {
            v34
        } else {
            v33
        ...
        let v39 = Draw{
            ...
            stake_amount  : v7,
            reward        : v35,
            exp_amount    : 0x2::coin::value<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>(&v21),
            u64_padding   : 0x1::vector::empty<u64>(),
        };
    ...
    fun draw_with_random<T0>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>) {
        let v0 = &mut arg0.id;
        let v1 = get_mut_playground(v0, arg1);
        ...
        let v22 = 0x2::dynamic_object_field::remove<vector<u8>, 0x2::coin::Coin<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>>(&mut v20, b"tails_exp_coin");
        ...
        let v27 = 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::multiplier(9);
        let v28 = generate_answer(10000, &v3);
        ...
        let v35 = 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::get_u64_padding_value(&v1.game_config.u64_padding, 0);
        let v36 = if (v34 > v35) {
            v35
        } else {
            v34
        ...
        let v40 = Draw{
            ...
            stake_amount  : v8,
            reward        : v36,
            exp_amount    : 0x2::coin::value<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>(&v22),
            u64_padding   : 0x1::vector::empty<u64>(),
        };
    ...
    public(friend) fun get_draw_result(arg0: &Registry, arg1: u64, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: &0x2::tx_context::TxContext) : vector<u64> {
        ...
        0x1::vector::push_back<u64>(&mut v3, 0x2::coin::value<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>(0x2::dynamic_object_field::borrow<vector<u8>, 0x2::coin::Coin<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>>(&v2.id, b"tails_exp_coin")));
        v3
    }
    ...
    public entry fun new_game<T0>(arg0: &mut Registry, arg1: &mut 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::Registry, arg2: u64, arg3: vector<0x2::coin::Coin<T0>>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        version_check(arg0);
        validate_amount(arg0, arg2, arg4);
        let v0 = 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::extract_balance<T0>(arg3, arg4, arg5);
        let v1 = &mut arg0.id;
        ...
        0x2::dynamic_object_field::add<vector<u8>, 0x2::coin::Coin<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>>(&mut v4.id, b"tails_exp_coin", 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::friend_mint_exp_token(arg1, arg4 / v2.exp_config.base_exp_divisor, arg5));
    ...
    public fun odds(arg0: u64, arg1: bool, arg2: u64, arg3: u64) : u64 {
        ...
        assert!(v0 > 0, 13);
        assert!(v0 < 9999, 13);
        let v1 = (((arg2 as u128) * (0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::multiplier(9) as u128) / 10000) as u64);
        let v2 = (0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::multiplier(9) as u128);
    ...
    public(friend) entry fun play_guess_with_random<T0>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: bool, arg4: u64, arg5: bool, arg6: &0x2::random::Random, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>(&v15) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>>(v15, v0);
        } else {
            0x2::coin::destroy_zero<0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp::TAILS_EXP>(v15);
        };
    }
    ...
    public(friend) entry fun set_max_single_game_loss(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        let v0 = &mut arg0.id;
        let v1 = get_mut_playground(v0, arg1);
        0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::set_u64_padding_value(&mut v1.game_config.u64_padding, 0, arg2);
        let v2 = SetMaxSingleGameLoss{
            signer      : 0x2::tx_context::sender(arg3),
            index       : arg1,
            prev_amount : 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::get_u64_padding_value(&v1.game_config.u64_padding, 0),
            amount      : arg2,
        };
    ...
    public(friend) fun simulate_game(arg0: &Registry, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u64, arg6: bool, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: vector<u8>, arg11: &0x2::tx_context::TxContext) : vector<u64> {
        ...
        let v11 = 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::get_u64_padding_value(&v0.game_config.u64_padding, 0);
        let v12 = if (v10 > v11) {
            v11
        } else {
            v10
