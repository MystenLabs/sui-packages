module 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::tails_exp {
    ...
    public fun burn_exp_token(arg0: &mut Registry, arg1: 0x2::coin::Coin<TAILS_EXP>) : u64 {
        0x2::coin::burn<TAILS_EXP>(0x2::dynamic_object_field::borrow_mut<vector<u8>, 0x2::coin::TreasuryCap<TAILS_EXP>>(&mut arg0.id, b"exp_treasury_cap"), arg1)
    }
    ...
    public fun consume_exp_coin_staked(arg0: &mut Registry, arg1: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::tails_staking::TailsStakingRegistry, arg3: address, arg4: 0x2::coin::Coin<TAILS_EXP>) {
    ...
    public(friend) entry fun deposit_stakes_emergency<T0>(arg0: &mut Registry, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<T0>(v2, 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::extract_balance<T0>(arg1, arg2, arg4));
    ...
    public(friend) entry fun draw(arg0: &mut Registry, arg1: u64, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = draw_with_bls_sig(arg0, arg1, v2, arg3, arg4, arg5);
    ...
    fun draw_with_bls_sig(arg0: &mut Registry, arg1: u64, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<TAILS_EXP> {
        let v0 = &mut arg0.id;
        let v1 = get_mut_playground(v0, arg1);
        let (_, v3) = 0x2::vec_map::remove<address, Game>(&mut v1.opened_games, &arg2);
        ...
        let v23 = 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::multiplier(9);
    ...
    fun draw_with_random(arg0: &mut Registry, arg1: u64, arg2: address, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<TAILS_EXP> {
        let v0 = &mut arg0.id;
        let v1 = get_mut_playground(v0, arg1);
        let (_, v3) = 0x2::vec_map::remove<address, Game>(&mut v1.opened_games, &arg2);
        let v4 = 0x2::random::new_generator(arg3, arg4);
        let v5 = 0x2::random::generate_bytes(&mut v4, 32);
        let v6 = 0x2::random::generate_bytes(&mut v4, 32);
        let Game {
            game_id       : v7,
            player        : v8,
            stake_amount  : v9,
        ...
        let v18 = v11;
        let v19 = v10;
        let v20 = *0x1::option::borrow<u64>(&v19);
        let v21 = *0x1::option::borrow<bool>(&v18);
        let v22 = *0x1::option::borrow<u64>(&v17);
        let v23 = *0x1::option::borrow<bool>(&v16);
        let v24 = 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::multiplier(9);
        let v25 = generate_answer(10000, &v5);
        let v26 = generate_answer(10000, &v6);
        let v27 = if (v21) {
            if (v25 > v20) {
                0
            } else if (v25 < v20) {
        ...
        let v29 = if (v27 == 0) {
            odds(v20, v21, v1.game_config.losses_multiplier_bp, v1.game_config.critical_hits_multiplier_bp, 0)
        } else if (v27 == 1) {
            (((v1.game_config.losses_multiplier_bp as u128) * (v24 as u128) / 10000) as u64)
        } else {
            (((v1.game_config.critical_hits_multiplier_bp as u128) * (v24 as u128) / 10000) as u64)
        };
        let v30 = if (v28 == 0) {
            odds(v22, v23, v1.game_config.losses_multiplier_bp, v1.game_config.critical_hits_multiplier_bp, 0)
        } else if (v28 == 1) {
            (((v1.game_config.losses_multiplier_bp as u128) * (v24 as u128) / 10000) as u64)
        } else {
            (((v1.game_config.critical_hits_multiplier_bp as u128) * (v24 as u128) / 10000) as u64)
        };
        let v31 = ((((v9 / v1.game_config.base_exp_divisor) as u128) * (v29 as u128) / (v24 as u128) * (v30 as u128) / (v24 as u128)) as u64);
        let v32 = Draw{
            signer        : 0x2::tx_context::sender(arg4),
            index         : arg1,
            game_id       : v7,
        ...
        0x2::event::emit<Draw>(v32);
        let v33 = 0x2::dynamic_object_field::borrow_mut<vector<u8>, 0x2::coin::TreasuryCap<TAILS_EXP>>(&mut arg0.id, b"exp_treasury_cap");
        mint_exp_token(v33, v31, arg4)
    }
    ...
    entry fun issue_typus_manager_cap(arg0: &mut Registry, arg1: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg2: &0x2::tx_context::TxContext) {
        0x2::dynamic_field::add<vector<u8>, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::ManagerCap>(&mut arg0.id, b"typus_manager_cap", 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::issue_manager_cap(arg1, arg2));
    }
    ...
    public(friend) entry fun merge_exp_tokens(arg0: vector<0x2::coin::Coin<TAILS_EXP>>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<TAILS_EXP>>(0x2::coin::from_balance<TAILS_EXP>(0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::extract_balance<TAILS_EXP>(arg0, v0, arg1), arg1), 0x2::tx_context::sender(arg1));
    }
    ...
    public(friend) entry fun new_game<T0>(arg0: &mut Registry, arg1: u64, arg2: vector<0x2::coin::Coin<T0>>, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        version_check(arg0);
        ...
        if (0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&v1.id, 0x1::type_name::get<T0>())) {
            0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, 0x1::type_name::get<T0>()), 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::extract_balance<T0>(arg2, arg3, arg4));
        } else {
            0x2::dynamic_field::add<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, 0x1::type_name::get<T0>(), 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::extract_balance<T0>(arg2, arg3, arg4));
        };
    ...
    entry fun new_registry(arg0: 0x2::coin::TreasuryCap<TAILS_EXP>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Registry{
    ...
    public(friend) fun odds(arg0: u64, arg1: bool, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ...
        assert!(v0 > 0, 12);
        assert!(v0 < 9999, 12);
        let v2 = (((arg3 as u128) * (0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::multiplier(9) as u128) / 10000) as u64);
        let v3 = (((0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::multiplier(9) as u128) * ((10000 - arg4) as u128) / 10000 * ((10000 - arg2) as u128) / 10000 * ((2 * v0 + v1) as u128) / (v0 as u128)) as u64);
        if (v3 > v2) {
            v2
        } else {
            v3
    ...
    entry fun play_guess_with_random(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: bool, arg4: u64, arg5: bool, arg6: &0x2::random::Random, arg7: &mut 0x2::tx_context::TxContext) {
        version_check(arg0);
        let v0 = &mut arg0.id;
        let v1 = get_mut_playground(v0, arg1);
        assert!(v1.is_active, 19);
        let v2 = &mut v1.id;
        let v3 = get_mut_counter(v2, b"counter_1");
        v3.count = v3.count + 1;
        let v4 = &mut v1.id;
        let v5 = get_mut_counter(v4, b"counter_2");
        v5.count = v5.count + 1;
        let v6 = 0x2::tx_context::sender(arg7);
        assert!(0x2::vec_map::contains<address, Game>(&v1.opened_games, &v6), 6);
        let v7 = 0x2::vec_map::get_mut<address, Game>(&mut v1.opened_games, &v6);
        assert!(0x2::tx_context::sender(arg7) == v7.player, 9);
        odds(arg2, arg3, v1.game_config.losses_multiplier_bp, v1.game_config.critical_hits_multiplier_bp, 0);
        odds(arg4, arg5, v1.game_config.losses_multiplier_bp, v1.game_config.critical_hits_multiplier_bp, 0);
        assert!(0x1::option::is_none<u64>(&v7.guess_1), 10);
        assert!(0x1::option::is_none<bool>(&v7.larger_than_1), 10);
        assert!(0x1::option::is_none<u64>(&v7.guess_2), 10);
        assert!(0x1::option::is_none<bool>(&v7.larger_than_2), 10);
        0x1::option::fill<u64>(&mut v7.guess_1, arg2);
        0x1::option::fill<bool>(&mut v7.larger_than_1, arg3);
        0x1::option::fill<u64>(&mut v7.guess_2, arg4);
        0x1::option::fill<bool>(&mut v7.larger_than_2, arg5);
        let v8 = PlayGuess{
        ...
        0x2::event::emit<PlayGuess>(v8);
        let v9 = draw_with_random(arg0, arg1, v6, arg6, arg7);
        if (0x2::coin::value<TAILS_EXP>(&v9) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<TAILS_EXP>>(v9, v6);
        } else {
            0x2::coin::destroy_zero<TAILS_EXP>(v9);
        };
    }
    ...
    public(friend) fun simulate_game(arg0: &Registry, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u64, arg6: bool, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: vector<u8>, arg11: &0x2::tx_context::TxContext) : vector<u64> {
        ...
        let v3 = 0xc85c99279d648d14160a67fe8c4d1a54750529c17470b764389cae68a6d456c1::utils::multiplier(9);
