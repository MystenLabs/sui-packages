module 0x607c04cb1dbc5a9375ae6021947cfe62cea54df2d6395999809b1a64219f9285::yolo_pump {
    ...
    public entry fun buy_v2<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v3 - v5;
        assert!(v6 > 0, 2);
        let v7 = 0x1::u64::min(0x607c04cb1dbc5a9375ae6021947cfe62cea54df2d6395999809b1a64219f9285::curves::calculate_token_amount_received(v2.virtual_sui_reserves, v2.virtual_token_reserves, v6), v4);
        assert!(v2.virtual_token_reserves >= v7, 8);
        let v8 = 0x607c04cb1dbc5a9375ae6021947cfe62cea54df2d6395999809b1a64219f9285::curves::calculate_add_liquidity_cost(v2.virtual_sui_reserves, v2.virtual_token_reserves, v7);
        assert!(v3 >= v8 + v5, 6);
