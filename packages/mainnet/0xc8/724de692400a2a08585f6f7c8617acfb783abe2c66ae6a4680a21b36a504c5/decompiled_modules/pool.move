module 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool {
    ...
    fun calc_dynamic_fee<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &QuoteAssetReserve<T1>, arg2: u64, arg3: bool, arg4: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg5: &0x2::clock::Clock) : (u64, u128) {
        let (v0, _) = get_pool_liquidity<T0>(arg0);
        let (v2, v3) = get_price<T1, T0>(arg4, arg5);
        let v4 = if (v3) {
            0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v0 as u128), 1000000000000000000, v2)
        } else {
            0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v0 as u128), v2, 1000000000000000000)
        };
        let v5 = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(v4, (arg1.ideal_reserve_pct as u128), 10000);
        ...
        let v8 = (v7 as u128);
        let v9 = if (v8 <= v5) {
            (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg1.fee_base as u128), v8, v5) as u64)
        } else {
            arg1.fee_base + (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg1.fee_max as u128), v8, (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(v4, (arg1.max_reserve_pct as u128), 10000) as u128)) as u64)
        };
        (v9, v5)
    }
    ...
    fun quote_limit<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &QuoteAssetReserve<T1>, arg2: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg3: &0x2::clock::Clock) : u64 {
        let (v0, _) = get_pool_liquidity<T0>(arg0);
        ...
        0x1::u64::min((0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v4 as u128), (0x1::option::get_with_default<u64>(&arg1.limit_ratio, arg0.limit_ratio) as u128), 100) as u64), 0x1::option::get_with_default<u64>(&arg1.limit_fixed, 18446744073709551615))
    }
    ...
    public fun simulate_buy_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        ...
        let v4 = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg3 as u128), v2, 1000000000000000000);
        assert!(v4 != 0, 4016);
        ...
        if (v7 > 0) {
            ...
            let v11 = 0x1::u128::min(0x1::u128::max(0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(v4, (v7 as u128), 10000), (v10 as u128)), v4);
            v8 = v11;
            if (arg0.lp_fee_pct > 0) {
                v9 = 0x1::u128::max(0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(v11, (arg0.lp_fee_pct as u128), 10000), 1);
            };
        };
        let v12 = v4 - v8;
        SwapSimulationResult{
            base_out        : (v12 as u64),
            quote_out       : (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(v12, 1000000000000000000, v2) as u64),
            swap_fee_pct    : arg0.swap_fee_pct,
            dynamic_fee_pct : v5,
            ideal_quote_amt : v6,
            swap_fee        : (v8 as u64),
    ...
    public fun simulate_sell_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        ...
        let (v3, v4) = calc_dynamic_fee<T0, T1>(arg0, 0x2::dynamic_field::borrow<0x1::ascii::String, QuoteAssetReserve<T1>>(&arg0.id, v0), (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg3 as u128), 1000000000000000000, v1) as u64), true, arg1, arg2);
        ...
        if (v5 > 0) {
            ...
            let v9 = 0x1::u128::min(0x1::u128::max(0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg3 as u128), (v5 as u128), 10000), (v8 as u128)), (arg3 as u128));
            v6 = v9;
            if (arg0.lp_fee_pct > 0) {
                v7 = 0x1::u128::max(0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(v9, (arg0.lp_fee_pct as u128), 10000), 1);
            };
        };
        let v10 = (arg3 as u128) - v6;
        SwapSimulationResult{
            base_out        : (v10 as u64),
            quote_out       : (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(v10, 1000000000000000000, v1) as u64),
            swap_fee_pct    : arg0.swap_fee_pct,
            dynamic_fee_pct : v3,
            ideal_quote_amt : v4,
            swap_fee        : (v6 as u64),
