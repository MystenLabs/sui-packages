module 0xc8678883440c07f28110261e77ad57a08f3e9dd0c0cf571ed08d270aa5e9e883::capybara_game_card {
    ...
    public entry fun checkin(arg0: &mut NFTData, arg1: &mut Treasury, arg2: &mut Registry, arg3: &0x2::clock::Clock, arg4: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: 0x1::option::Option<u64>, arg7: 0x1::option::Option<u64>, arg8: vector<u8>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = UserEvt{
            user      : 0x2::address::to_string(v0),
            signature : serialize_checkin_args(arg5, arg6, arg7, v0),
        };
        0x2::event::emit<UserEvt>(v1);
        enforce_signature(arg2, arg3, arg5, arg6, arg7, v0, arg8);
        ...
        if (0x1::option::is_some<u64>(&arg7)) {
            ...
            assert!(0x1::vector::contains<u64>(&arg2.leagues, &v2), 6);
            arg0.league = v2;
        };
        let v3 = DailyCheckin{
