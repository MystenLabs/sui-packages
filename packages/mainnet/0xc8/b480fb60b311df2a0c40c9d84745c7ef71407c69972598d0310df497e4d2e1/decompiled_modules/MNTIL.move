module 0xc8b480fb60b311df2a0c40c9d84745c7ef71407c69972598d0310df497e4d2e1::MNTIL {
    struct MNTIL has drop {
        dummy_field: bool,
    }

    fun init(arg0: MNTIL, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin_registry::new_currency_with_otw<MNTIL>(arg0, 9, 0x1::string::utf8(b"MNTIL"), 0x1::string::utf8(b"mynntil"), 0x1::string::utf8(b"A custom utility token for decentralized applications"), 0x1::string::utf8(b""), arg1);
