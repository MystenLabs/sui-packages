module 0xc80161302b99dd80a63b0bbb0b4c7ed5dccdf70f10d9eea2b2136c576921a8dc::cnsnft1617 {
    struct CNSNFT1617 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1617, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1617>(arg0, arg1);
