module 0xc891cb355872a7902d70620924da5a7f2fcea82c524d99cf4f16dac917e478ff::gift1704 {
    struct GIFT1704 has drop {
        dummy_field: bool,
    }

    struct TICKET_1704 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1704(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1704>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1704>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1704, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1704>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1704>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1704>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1704>>(v5, 0x2::tx_context::sender(arg1));
    }
