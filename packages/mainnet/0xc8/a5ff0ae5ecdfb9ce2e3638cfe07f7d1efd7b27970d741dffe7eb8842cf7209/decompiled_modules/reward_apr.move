module 0xc8a5ff0ae5ecdfb9ce2e3638cfe07f7d1efd7b27970d741dffe7eb8842cf7209::reward_apr {
    ...
    public fun accrue(arg0: &mut RewardAprState, arg1: u64, arg2: u64) {
        ...
        let v2 = 0xc8a5ff0ae5ecdfb9ce2e3638cfe07f7d1efd7b27970d741dffe7eb8842cf7209::apr::annualize(arg0.flow, arg1, v1);
        if (v2 == 0) {
            return
        };
