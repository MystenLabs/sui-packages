module 0xc879ccaabbc302b765c4f7a0c706ee6b91385a0da66730fa005b34bc6bd4f267::test_nft {
    ...
    fun init(arg0: TEST_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v4;
        let v6 = v3;
        0xc879ccaabbc302b765c4f7a0c706ee6b91385a0da66730fa005b34bc6bd4f267::royalty_rule::add<TestNFT>(&mut v6, &v5, 500, 100);
