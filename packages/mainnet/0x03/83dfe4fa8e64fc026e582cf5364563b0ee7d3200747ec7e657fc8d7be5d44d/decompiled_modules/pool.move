module 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::pool {
    ...
    struct PrivacyPool<phantom T0> has store, key {
        ...
        merkle_tree: 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::MerkleTree,
        nullifiers: 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::NullifierRegistry,
        vk_bytes: vector<u8>,
    ...
    public fun swap<T0, T1>(arg0: &mut PrivacyPool<T0>, arg1: &mut PrivacyPool<T1>, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<vector<u8>>, arg6: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg7: &0x2::clock::Clock, arg8: vector<u8>, arg9: vector<u8>, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::is_spent(&arg0.nullifiers, v13), 1);
        assert!(!0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::is_spent(&arg0.nullifiers, v14), 1);
        ...
        0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::mark_spent(&mut arg0.nullifiers, v13);
        0x1::vector::push_back<vector<u8>>(&mut v28, v13);
        if (!is_zero_commitment(&v14)) {
            0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::mark_spent(&mut arg0.nullifiers, v14);
            0x1::vector::push_back<vector<u8>>(&mut v28, v14);
        };
        save_historical_root<T1>(arg1);
        0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::insert(&mut arg1.merkle_tree, v1);
        if (!is_zero_commitment(&v11)) {
            save_historical_root<T0>(arg0);
            0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::insert(&mut arg0.merkle_tree, v11);
            let v29 = ShieldEvent{
                pool_id        : 0x2::object::id<PrivacyPool<T0>>(arg0),
                position       : 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::get_next_index(&arg0.merkle_tree),
                commitment     : v11,
                encrypted_note : arg9,
            };
        ...
        let v30 = SwapEvent{
            ...
            swap_position         : 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::get_next_index(&arg1.merkle_tree),
            swap_commitment       : v1,
    ...
    public fun transfer<T0>(arg0: &mut PrivacyPool<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<vector<u8>>, arg4: vector<vector<u8>>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::is_spent(&arg0.nullifiers, v7), 1);
        assert!(!0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::is_spent(&arg0.nullifiers, v8), 1);
        ...
        0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::mark_spent(&mut arg0.nullifiers, v7);
        0x1::vector::push_back<vector<u8>>(&mut v16, v7);
        if (!is_zero_commitment(&v8)) {
            0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::mark_spent(&mut arg0.nullifiers, v8);
        ...
        0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::insert(&mut arg0.merkle_tree, v1);
        0x1::vector::push_back<vector<u8>>(&mut v17, *0x1::vector::borrow<vector<u8>>(&arg4, 0));
        0x1::vector::push_back<u64>(&mut v18, 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::get_next_index(&arg0.merkle_tree));
        0x1::vector::push_back<vector<u8>>(&mut v19, v1);
        if (!is_zero_commitment(&v6)) {
            0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::insert(&mut arg0.merkle_tree, v6);
    ...
    fun compute_recipient_hash(arg0: address) : vector<u8> {
        ...
        while (0x1::vector::length<u8>(&v1) < 32) {
        ...
        while (0x1::vector::length<u8>(&v4) < 32) {
            0x1::vector::push_back<u8>(&mut v4, 0);
        };
        let v6 = 0x2::bcs::new(v4);
        let v7 = 0x1::vector::empty<u256>();
        let v8 = &mut v7;
        0x1::vector::push_back<u256>(v8, 0x2::bcs::peel_u256(&mut v3));
        0x1::vector::push_back<u256>(v8, 0x2::bcs::peel_u256(&mut v6));
        u256_to_field_element(0x2::poseidon::poseidon_bn254(&v7))
    }
    ...
    fun create_pool<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : PrivacyPool<T0> {
        PrivacyPool<T0>{
            ...
            merkle_tree       : 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::new(arg3),
            nullifiers        : 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::new(arg3),
            vk_bytes          : arg0,
    ...
    public fun get_merkle_root<T0>(arg0: &PrivacyPool<T0>) : vector<u8> {
        0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::get_root(&arg0.merkle_tree)
    }

    public fun get_note_count<T0>(arg0: &PrivacyPool<T0>) : u64 {
        0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::get_next_index(&arg0.merkle_tree)
    }

    public fun is_nullifier_spent<T0>(arg0: &PrivacyPool<T0>, arg1: vector<u8>) : bool {
        0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::is_spent(&arg0.nullifiers, arg1)
    }

    fun is_valid_root<T0>(arg0: &PrivacyPool<T0>, arg1: &vector<u8>) : bool {
        if (*arg1 == 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::get_root(&arg0.merkle_tree)) {
            return true
        };
        let v0 = 0;
    ...
    fun parse_unshield_public_inputs(arg0: &vector<u8>) : (vector<u8>, vector<u8>, vector<u8>, vector<u8>, vector<u8>, vector<u8>) {
        (extract_field(arg0, 0), extract_field(arg0, 32), extract_field(arg0, 64), extract_field(arg0, 96), extract_field(arg0, 128), extract_field(arg0, 160))
    }

    fun save_historical_root<T0>(arg0: &mut PrivacyPool<T0>) {
        if (0x1::vector::length<vector<u8>>(&arg0.historical_roots) < 100) {
            0x1::vector::push_back<vector<u8>>(&mut arg0.historical_roots, 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::get_root(&arg0.merkle_tree));
        } else {
            *0x1::vector::borrow_mut<vector<u8>>(&mut arg0.historical_roots, arg0.root_head) = 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::get_root(&arg0.merkle_tree);
    ...
    public fun shield<T0>(arg0: &mut PrivacyPool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::insert(&mut arg0.merkle_tree, arg2);
        let v0 = ShieldEvent{
            pool_id        : 0x2::object::id<PrivacyPool<T0>>(arg0),
            position       : 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::get_next_index(&arg0.merkle_tree),
            commitment     : arg2,
    ...
    public fun unshield<T0>(arg0: &mut PrivacyPool<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<vector<u8>>, arg4: address, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<vector<u8>>(&arg3) == 2, 5);
        let (v0, v1, v2, v3, _, v5) = parse_unshield_public_inputs(&arg2);
        let v6 = v5;
        let v7 = v3;
        let v8 = v1;
        assert!(compute_recipient_hash(arg4) == v2, 5);
        assert!(is_valid_root<T0>(arg0, &v6), 3);
        let v9 = *0x1::vector::borrow<vector<u8>>(&arg3, 0);
        let v10 = *0x1::vector::borrow<vector<u8>>(&arg3, 1);
        let v11 = 0x1::vector::empty<u256>();
        let v12 = &mut v11;
        0x1::vector::push_back<u256>(v12, field_element_to_u256(&v9));
        0x1::vector::push_back<u256>(v12, field_element_to_u256(&v10));
        assert!(u256_to_field_element(0x2::poseidon::poseidon_bn254(&v11)) == v0, 5);
        let v13 = field_element_to_u64(&v7);
        assert!(!0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::is_spent(&arg0.nullifiers, v9), 1);
        assert!(!0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::is_spent(&arg0.nullifiers, v10), 1);
        let v14 = 0x2::groth16::bn254();
        let v15 = 0x2::groth16::prepare_verifying_key(&v14, &arg0.vk_bytes);
        let v16 = 0x2::groth16::public_proof_inputs_from_bytes(arg2);
        let v17 = 0x2::groth16::proof_points_from_bytes(arg1);
        let v18 = 0x2::groth16::bn254();
        assert!(0x2::groth16::verify_groth16_proof(&v18, &v15, &v16, &v17), 2);
        0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::mark_spent(&mut arg0.nullifiers, v9);
        if (!is_zero_commitment(&v10)) {
            0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::nullifier::mark_spent(&mut arg0.nullifiers, v10);
        };
        assert!(0x2::balance::value<T0>(&arg0.balance) >= v13, 4);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.balance, v13, arg6), arg4);
        if (!is_zero_commitment(&v8)) {
            save_historical_root<T0>(arg0);
            0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::insert(&mut arg0.merkle_tree, v8);
            let v19 = ShieldEvent{
                pool_id        : 0x2::object::id<PrivacyPool<T0>>(arg0),
                position       : 0x383dfe4fa8e64fc026e582cf5364563b0ee7d3200747ec7e657fc8d7be5d44d::merkle_tree::get_next_index(&arg0.merkle_tree),
                commitment     : v8,
            ...
            0x2::event::emit<ShieldEvent>(v19);
        };
        let v20 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v20, v9);
        if (!is_zero_commitment(&v10)) {
            0x1::vector::push_back<vector<u8>>(&mut v20, v10);
        };
        let v21 = UnshieldEvent{
            pool_id          : 0x2::object::id<PrivacyPool<T0>>(arg0),
            input_nullifiers : v20,
            recipient        : arg4,
            amount           : v13,
        };
        0x2::event::emit<UnshieldEvent>(v21);
    }
