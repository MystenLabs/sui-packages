module 0x36ce4fd1392d796eceb88af228444d9d34724a98a0400dcdd3954731e6b81d5::doggenius {
    ...
    fun init(arg0: DOGGENIUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::transfer::public_transfer<0x2::coin::Coin<DOGGENIUS>>(0x2::coin::mint<DOGGENIUS>(&mut v2, 10000000000000000, arg1), 0x2::tx_context::sender(arg1));
