module 0x3561502654df1c7f9825ae86a30d70d0bdc31a6795b3f1be3e53b2deec0bb81::bull_parade__first_drop {
    struct BULL_PARADE__FIRST_DROP has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BULL_PARADE__FIRST_DROP, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BULL_PARADE__FIRST_DROP>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Bull Parade: First Drop"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
