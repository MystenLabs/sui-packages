module 0x33b82ef5af41d16402753a488a0d98eaaef3392fb3e0b9ef4361fcf116398f6::swap_fees {
    ...
    public fun take_fee_on_sui_out(arg0: &mut Fees, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(arg1);
        0x2::pay::split_and_transfer<0x2::sui::SUI>(arg1, v0 - v0 * 100 / 10000, 0x2::tx_context::sender(arg2), arg2);
