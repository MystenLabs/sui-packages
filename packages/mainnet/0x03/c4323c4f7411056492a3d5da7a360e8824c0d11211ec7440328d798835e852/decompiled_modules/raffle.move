module 0x3c4323c4f7411056492a3d5da7a360e8824c0d11211ec7440328d798835e852::raffle {
    ...
    public fun join_raffle_kiosk<T0>(arg0: &mut MarketplaceRaffle<T0>, arg1: 0x2::object::ID, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, RaffleKiosk<T0>>(&mut arg0.id, arg1);
        assert!(0x2::tx_context::sender(arg5) != v0.owner, 2);
        assert!(v0.expires >= 0x2::clock::timestamp_ms(arg4), 3);
        assert!(arg2 > 0, 17);
        assert!(v0.max_ticket - v0.ticket_sold >= arg2, 7);
        ...
        if (0x1::option::is_none<RaffleFund<T0>>(&v0.balance)) {
            let v9 = RaffleFund<T0>{funds: v2};
            0x1::option::fill<RaffleFund<T0>>(&mut v0.balance, v9);
        } else {
            0x2::coin::put<T0>(&mut 0x1::option::borrow_mut<RaffleFund<T0>>(&mut v0.balance).funds, 0x2::coin::from_balance<T0>(v2, arg5));
        };
        if (v7 == 0) {
            0x1::vector::push_back<Player>(&mut v0.list_player, v4);
        };
    ...
    public fun withdraw_and_transfer<T0: store + key, T1>(arg0: &mut MarketplaceRaffle<T1>, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::balance::value<T1>(&v1) * (arg0.fee as u64) / 10000;
        0x1::debug::print<u64>(&v3);
        0x2::coin::put<T1>(&mut arg0.fee_balance, 0x2::coin::split<T1>(&mut v2, v3, arg3));
    ...
    public fun withdraw_and_transfer_holder<T0: store + key, T1>(arg0: &mut MarketplaceRaffle<T1>, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Raffle<T0, T1>>(&mut arg0.id, arg1);
        assert!(0x2::tx_context::sender(arg3) == arg0.owner, 1);
        assert!(v0.expires <= 0x2::clock::timestamp_ms(arg2), 5);
        assert!(v0.owner != v0.winner, 14);
        let RaffleFund { funds: v1 } = 0x1::option::extract<RaffleFund<T1>>(&mut v0.balance);
        let v2 = 0x2::coin::from_balance<T1>(v1, arg3);
        let v3 = 0x2::balance::value<T1>(&v1) * (arg0.fee as u64) / 10000 * 2000 / 10000;
        0x1::debug::print<u64>(&v3);
        0x2::coin::put<T1>(&mut arg0.fee_balance, 0x2::coin::split<T1>(&mut v2, v3, arg3));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v2, v0.owner);
        0x2::transfer::public_transfer<T0>(0x1::option::extract<T0>(&mut v0.item), v0.winner);
    ...
    public fun withdraw_and_transfer_holder_kiosk<T0: store + key, T1>(arg0: &mut MarketplaceRaffle<T1>, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::TransferRequest<T0> {
        ...
        assert!(v0.expires <= 0x2::clock::timestamp_ms(arg4), 5);
        assert!(0x2::object::id<0x2::kiosk::Kiosk>(arg2) == v0.owner_kiosk, 15);
        assert!(0x2::kiosk::owner(arg3) == v0.winner, 16);
        assert!(v0.owner != v0.winner, 14);
        let RaffleFund { funds: v1 } = 0x1::option::extract<RaffleFund<T1>>(&mut v0.balance);
        let v2 = 0x2::coin::from_balance<T1>(v1, arg5);
        0x2::coin::put<T1>(&mut arg0.fee_balance, 0x2::coin::split<T1>(&mut v2, 0x2::balance::value<T1>(&v1) * (arg0.fee as u64) / 10000 * 2000 / 10000, arg5));
        let v3 = 0x2::coin::into_balance<T1>(v2);
        let v4 = 0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::transfer_delegated<T0>(arg2, arg3, v0.item, &v0.id, 0x2::balance::value<T1>(&v3), arg5);
    ...
    public fun withdraw_and_transfer_kiosk<T0: store + key, T1>(arg0: &mut MarketplaceRaffle<T1>, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::TransferRequest<T0> {
        ...
        let RaffleFund { funds: v1 } = 0x1::option::extract<RaffleFund<T1>>(&mut v0.balance);
        let v2 = 0x2::coin::from_balance<T1>(v1, arg5);
        0x2::coin::put<T1>(&mut arg0.fee_balance, 0x2::coin::split<T1>(&mut v2, 0x2::balance::value<T1>(&v1) * (arg0.fee as u64) / 10000, arg5));
        let v3 = 0x2::coin::into_balance<T1>(v2);
        let v4 = 0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::transfer_delegated<T0>(arg2, arg3, v0.item, &v0.id, 0x2::balance::value<T1>(&v3), arg5);
        0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::set_paid<T0, T1>(&mut v4, v3, v0.owner);
        let v5 = Witness{dummy_field: false};
