module 0x3016f221e334463affc9797e35a2af19045aac2b462168008bc16d46016f88a::cnsnft1214 {
    struct CNSNFT1214 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1214, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1214>(arg0, arg1);
