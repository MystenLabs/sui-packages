module 0x3de5911958782460ef07eaf0bd9c9f3a64d0911d1c885ebdf2fd93090308512::event {
    ...
    public(friend) fun emit_emode_param_set(arg0: u64, arg1: u8, arg2: u256, arg3: u8, arg4: u64) {
    ...
    public(friend) fun emit_pool_create(arg0: address, arg1: u64) {
        let v0 = PoolCreate{
            creator   : arg0,
            market_id : arg1,
        };
