module 0x13bfc09cfc1bd922d3aa53fcf7b2cd510727ee65068ce136e2ebd5f3b213fdd2::pool_script {
    ...
    fun cleanup_swap<T0, T1, T2, T3, T4, T5: store, T6: drop>(arg0: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::pool::Pool<T3, T4, T5, T6>, arg1: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::Bank<T0, T1, T3>, arg2: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::Bank<T0, T2, T4>, arg3: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: &mut 0x2::coin::Coin<T1>, arg5: &mut 0x2::coin::Coin<T2>, arg6: 0x2::coin::Coin<T3>, arg7: 0x2::coin::Coin<T4>, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 > 0) {
            let v2 = 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::burn_btokens<T0, T1, T3>(arg1, arg3, &mut arg6, v0, arg9, arg10);
            assert!(0x2::coin::value<T1>(&v2) >= arg8, 0);
            0x2::coin::join<T1>(arg4, v2);
        };
        if (v1 > 0) {
            let v3 = 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank::burn_btokens<T0, T2, T4>(arg2, arg3, &mut arg7, v1, arg9, arg10);
            assert!(0x2::coin::value<T2>(&v3) >= arg8, 0);
            0x2::coin::join<T2>(arg5, v3);
        };
        destroy_or_transfer<T3>(arg6, arg10);
        destroy_or_transfer<T4>(arg7, arg10);
