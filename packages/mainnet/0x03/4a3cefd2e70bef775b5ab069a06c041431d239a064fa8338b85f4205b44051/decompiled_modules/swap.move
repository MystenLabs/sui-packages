module 0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::swap {
    struct SwapContext {
    ...
    public fun end_swap(arg0: SwapContext, arg1: EmptyTokenTicket) {
        ...
        assert!(0x2::bag::is_empty(&v0), 0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::error::balances_not_empty());
    ...
    public fun take_balance<T0: drop, T1>(arg0: &mut SwapContext, arg1: &0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::router::Router, arg2: T0, arg3: u64) : 0x2::balance::Balance<T1> {
        assert!(0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::router::is_package_whitelisted<T0>(arg1), 0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::error::package_not_whitelisted());
        take_balance_internal<T1>(arg0, arg3)
    }

    fun take_balance_internal<T0>(arg0: &mut SwapContext, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v0), 0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::error::invalid_coin_type());
        let v1 = 0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg0.balances, v0));
        assert!(v1 >= arg1, 0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::error::insufficient_balance());
        if (arg1 == v1) {
