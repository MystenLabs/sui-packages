module 0x399abdf475acdfbc50ebd6b609ed7fc22dfac34bf7b8633738c53b62ddb3c57::market {
    ...
    public(friend) fun execute_deposit<T0>(arg0: &mut Market<T0>, arg1: 0x2::balance::Balance<T0>, arg2: u8, arg3: address) {
        let v0 = 0x2::balance::value<T0>(&arg1);
        if (arg2 == 0) {
            0x2::balance::join<T0>(&mut arg0.yes_pool, arg1);
            arg0.yes_deposits = arg0.yes_deposits + v0;
        } else {
            0x2::balance::join<T0>(&mut arg0.no_pool, arg1);
            arg0.no_deposits = arg0.no_deposits + v0;
        };
        ensure_position<T0>(arg0, arg3);
        if (arg2 == 0) {
            0x399abdf475acdfbc50ebd6b609ed7fc22dfac34bf7b8633738c53b62ddb3c57::position::add_yes(0x2::table::borrow_mut<address, 0x399abdf475acdfbc50ebd6b609ed7fc22dfac34bf7b8633738c53b62ddb3c57::position::Position>(&mut arg0.positions, arg3), v0);
        } else {
            0x399abdf475acdfbc50ebd6b609ed7fc22dfac34bf7b8633738c53b62ddb3c57::position::add_no(0x2::table::borrow_mut<address, 0x399abdf475acdfbc50ebd6b609ed7fc22dfac34bf7b8633738c53b62ddb3c57::position::Position>(&mut arg0.positions, arg3), v0);
        };
