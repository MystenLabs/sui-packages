module 0x3be32ed3b889f6eece39b229336b688c0f16dbfb905e78939e46e4abc7a91e1::mm_vault {
    ...
    public(friend) fun swap<T0, T1>(arg0: &mut MMVault, arg1: 0x1::string::String, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: &0x3be32ed3b889f6eece39b229336b688c0f16dbfb905e78939e46e4abc7a91e1::versioned::Versioned, arg8: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        0x3be32ed3b889f6eece39b229336b688c0f16dbfb905e78939e46e4abc7a91e1::versioned::check_version(arg7);
        ...
        assert!(v3, 13906835218020564995);
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v6), 13906835265265598473);
        let v7 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.balances, v6);
        assert!(0x2::balance::value<T1>(v7) >= arg3, 13906835273855533065);
    ...
    public fun check_cap(arg0: &MMVault, arg1: &MMVaultCap) {
        assert!(arg0.cap_id == 0x2::object::id<MMVaultCap>(arg1), 13906835488603635717);
    }

    public fun check_signer(arg0: &MMVault, arg1: address) {
        assert!(arg0.signer == arg1, 13906835505784029197);
    }

    public fun create_vault(arg0: &mut MMRegistry, arg1: 0x1::string::String, arg2: address, arg3: &0x3be32ed3b889f6eece39b229336b688c0f16dbfb905e78939e46e4abc7a91e1::admin_cap::AdminCap, arg4: &0x3be32ed3b889f6eece39b229336b688c0f16dbfb905e78939e46e4abc7a91e1::versioned::Versioned, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        0x3be32ed3b889f6eece39b229336b688c0f16dbfb905e78939e46e4abc7a91e1::versioned::check_version(arg4);
    ...
    public fun deposit<T0>(arg0: &mut MMVault, arg1: 0x2::coin::Coin<T0>, arg2: &0x3be32ed3b889f6eece39b229336b688c0f16dbfb905e78939e46e4abc7a91e1::versioned::Versioned) {
    ...
    public fun parse_signature(arg0: vector<u8>) : (address, vector<u8>, vector<u8>) {
        assert!(*0x1::vector::borrow<u8>(&arg0, 0) == 0, 13906835406999650315);
        let v0 = x"00";
        let v1 = b"";
    ...
    public fun update_signer(arg0: &mut MMVault, arg1: address, arg2: &MMVaultCap, arg3: &0x3be32ed3b889f6eece39b229336b688c0f16dbfb905e78939e46e4abc7a91e1::versioned::Versioned) {
    ...
    public fun withdraw<T0>(arg0: &mut MMVault, arg1: u64, arg2: &MMVaultCap, arg3: &0x3be32ed3b889f6eece39b229336b688c0f16dbfb905e78939e46e4abc7a91e1::versioned::Versioned, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x3be32ed3b889f6eece39b229336b688c0f16dbfb905e78939e46e4abc7a91e1::versioned::check_version(arg3);
        check_cap(arg0, arg2);
        assert!(arg1 > 0, 13906834891602919425);
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v0), 13906834904488214535);
    ...
    public fun withdraw_and_transfer<T0>(arg0: &mut MMVault, arg1: u64, arg2: &MMVaultCap, arg3: &0x3be32ed3b889f6eece39b229336b688c0f16dbfb905e78939e46e4abc7a91e1::versioned::Versioned, arg4: &mut 0x2::tx_context::TxContext) {
