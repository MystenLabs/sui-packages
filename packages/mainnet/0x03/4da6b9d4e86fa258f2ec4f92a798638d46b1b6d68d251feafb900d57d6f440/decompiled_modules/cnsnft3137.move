module 0x34da6b9d4e86fa258f2ec4f92a798638d46b1b6d68d251feafb900d57d6f440::cnsnft3137 {
    struct CNSNFT3137 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3137, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3137>(arg0, arg1);
