module 0x3f1309991a547431369aa3b341aaba3aa9eae437a0624895c98757f0ee9af6c::reward4263 {
    struct REWARD4263 has drop {
        dummy_field: bool,
    }

    struct TICKET_4263 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4263(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4263>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4263>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4263, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4263>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4263>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4263>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4263>>(v5, 0x2::tx_context::sender(arg1));
    }
