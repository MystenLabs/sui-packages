module 0x345b1558e043d6431d36ac2f40c65d797094952100b1f489d90664ec6afb7f4::vault {
    struct MarketVault<phantom T0> has key {
        id: 0x2::object::UID,
        collateral: 0x2::balance::Balance<T0>,
        yes_cap: 0x2::coin::TreasuryCap<0x345b1558e043d6431d36ac2f40c65d797094952100b1f489d90664ec6afb7f4::yes::YES>,
        no_cap: 0x2::coin::TreasuryCap<0x345b1558e043d6431d36ac2f40c65d797094952100b1f489d90664ec6afb7f4::no::NO>,
    ...
    public fun atomic_mint<T0>(arg0: &mut MarketVault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u128, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x345b1558e043d6431d36ac2f40c65d797094952100b1f489d90664ec6afb7f4::yes::YES>, 0x2::coin::Coin<0x345b1558e043d6431d36ac2f40c65d797094952100b1f489d90664ec6afb7f4::no::NO>) {
        ...
        (0x2::coin::mint<0x345b1558e043d6431d36ac2f40c65d797094952100b1f489d90664ec6afb7f4::yes::YES>(&mut arg0.yes_cap, v1, arg3), 0x2::coin::mint<0x345b1558e043d6431d36ac2f40c65d797094952100b1f489d90664ec6afb7f4::no::NO>(&mut arg0.no_cap, v1, arg3))
    }
    ...
    public entry fun atomic_mint_and_keep<T0>(arg0: &mut MarketVault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u128, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x345b1558e043d6431d36ac2f40c65d797094952100b1f489d90664ec6afb7f4::yes::YES>>(v0, v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x345b1558e043d6431d36ac2f40c65d797094952100b1f489d90664ec6afb7f4::no::NO>>(v1, v2);
    }
    ...
    public entry fun create_vault<T0>(arg0: 0x2::coin::TreasuryCap<0x345b1558e043d6431d36ac2f40c65d797094952100b1f489d90664ec6afb7f4::yes::YES>, arg1: 0x2::coin::TreasuryCap<0x345b1558e043d6431d36ac2f40c65d797094952100b1f489d90664ec6afb7f4::no::NO>, arg2: &mut 0x2::tx_context::TxContext) {
