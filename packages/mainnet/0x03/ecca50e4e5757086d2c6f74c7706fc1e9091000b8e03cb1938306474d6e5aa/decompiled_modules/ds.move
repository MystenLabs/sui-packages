module 0x3ecca50e4e5757086d2c6f74c7706fc1e9091000b8e03cb1938306474d6e5aa::ds {
    struct DS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DS>(arg0, 9, trim_right(b"d"), trim_right(b"ds"), trim_right(b"Hello"), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(trim_right(b"https://ipfs.io/ipfs/bafkreigmkwve7xofnanu5kbubk5kiqzdruad7wovx2zmvjxesduxcsjohi"))), arg1);
        let v2 = v0;
