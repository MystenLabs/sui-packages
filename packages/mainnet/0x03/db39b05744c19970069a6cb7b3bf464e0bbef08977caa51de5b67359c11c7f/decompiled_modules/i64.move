module 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::i64 {
    ...
    public fun div(arg0: &I64, arg1: &I64) : I64 {
        ...
        if (arg0.bits >> 63 == 0) {
            if (arg1.bits >> 63 == 0) {
                ...
                I64{bits: 9223372036854775808 | arg0.bits / (arg1.bits - 9223372036854775808)}
            }
        } else if (arg1.bits >> 63 == 0) {
            I64{bits: 9223372036854775808 | (arg0.bits - 9223372036854775808) / arg1.bits}
        } else {
    ...
    public fun mul(arg0: &I64, arg1: &I64) : I64 {
        if (arg0.bits == 0 || arg1.bits == 0) {
            return zero()
        };
        if (arg0.bits >> 63 == 0) {
            if (arg1.bits >> 63 == 0) {
                let v1 = arg0.bits * arg1.bits;
                assert!(v1 >> 63 == 0, 2);
                I64{bits: v1}
            } else {
                I64{bits: 9223372036854775808 + arg0.bits * (arg1.bits - 9223372036854775808)}
            ...
            I64{bits: 9223372036854775808 + arg1.bits * (arg0.bits - 9223372036854775808)}
        } else {
            let v2 = (arg0.bits - 9223372036854775808) * (arg1.bits - 9223372036854775808);
            assert!(v2 >> 63 == 0, 2);
            I64{bits: v2}
        }
    }
