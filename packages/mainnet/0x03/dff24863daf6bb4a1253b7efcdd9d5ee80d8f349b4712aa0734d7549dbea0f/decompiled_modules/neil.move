module 0x3dff24863daf6bb4a1253b7efcdd9d5ee80d8f349b4712aa0734d7549dbea0f::neil {
    struct NEIL has drop {
        dummy_field: bool,
    }

    fun init(arg0: NEIL, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<NEIL>(arg0, 6, b"Neil", b"Neil The Suiel", b"The Most Famous Seal From Tik Tok Is Now On Sui, 50 percent of the team wallet will be used to donate to Neil", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/photo_2024_10_06_20_26_58_e7045bc592.jpg")), arg1);
