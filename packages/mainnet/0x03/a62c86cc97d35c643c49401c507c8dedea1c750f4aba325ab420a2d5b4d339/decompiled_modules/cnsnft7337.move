module 0x3a62c86cc97d35c643c49401c507c8dedea1c750f4aba325ab420a2d5b4d339::cnsnft7337 {
    struct CNSNFT7337 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7337, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7843"));
        let v4 = 0x2::package::claim<CNSNFT7337>(arg0, arg1);
