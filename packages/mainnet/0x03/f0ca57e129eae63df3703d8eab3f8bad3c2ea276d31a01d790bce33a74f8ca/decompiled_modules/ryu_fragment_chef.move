module 0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::ryu_fragment_chef {
    ...
    struct PoolInfo<phantom T0> has store, key {
        ...
        coin_reward: 0x2::coin::Coin<0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FRAGMENT>,
    ...
    struct MasterChefData has key {
        id: 0x2::object::UID,
        ryu_mint_cap: 0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::MintCap,
    ...
    public entry fun add_pool<T0>(arg0: &0x2::clock::Clock, arg1: &mut MasterChefData, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = PoolInfo<T0>{
            ...
            coin_reward               : 0x2::coin::zero<0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FRAGMENT>(arg3),
    ...
    public entry fun deposit<T0>(arg0: vector<0x2::coin::Coin<T0>>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FragmentInfo, arg4: &mut MasterChefData, arg5: &mut UserInfo<T0>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg5.amount > 0) {
            ...
            v3 = v4;
            0x2::transfer::public_transfer<0x2::coin::Coin<0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FRAGMENT>>(0x2::coin::split<0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FRAGMENT>(&mut v0.coin_reward, (v4 as u64), arg6), v2);
        };
    ...
    public entry fun first_deposit<T0>(arg0: vector<0x2::coin::Coin<T0>>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FragmentInfo, arg4: &mut MasterChefData, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun harvest<T0>(arg0: &0x2::clock::Clock, arg1: &mut 0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FragmentInfo, arg2: &mut MasterChefData, arg3: &mut UserInfo<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        deposit<T0>(0x1::vector::empty<0x2::coin::Coin<T0>>(), 0, arg0, arg1, arg2, arg3, arg4);
    }

    public entry fun initialize(arg0: &mut 0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = MasterChefData{
            id                     : v0,
            ryu_mint_cap           : 0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::set_new_role(arg0, &mut v0, 100000000000000),
            total_alloc_point      : 0,
    ...
    public fun pending_BOXFRAGMENT<T0>(arg0: &UserInfo<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FragmentInfo, arg3: &mut MasterChefData, arg4: &mut PoolInfo<T0>, arg5: &mut 0x2::tx_context::TxContext) : u64 {
    ...
    public entry fun update_pool<T0>(arg0: &0x2::clock::Clock, arg1: &mut 0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FragmentInfo, arg2: &mut MasterChefData, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::join<0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FRAGMENT>(&mut v0.coin_reward, 0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::mint_coin(&mut arg2.ryu_mint_cap, arg1, (v3 as u64), arg3));
        v0.acc_BOXFRAGMENT_per_share = v0.acc_BOXFRAGMENT_per_share + v3 * 1000000000000 / (v2 as u128);
        v0.last_reward_timestamp = v1;
    }

    public entry fun withdraw<T0>(arg0: u64, arg1: &0x2::clock::Clock, arg2: &mut 0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FragmentInfo, arg3: &mut MasterChefData, arg4: &mut UserInfo<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        update_pool<T0>(arg1, arg2, arg3, arg5);
        ...
        if (arg4.amount > 0) {
            ...
            v2 = v3;
            0x2::transfer::public_transfer<0x2::coin::Coin<0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FRAGMENT>>(0x2::coin::split<0x3f0ca57e129eae63df3703d8eab3f8bad3c2ea276d31a01d790bce33a74f8ca::fragment::FRAGMENT>(&mut v0.coin_reward, (v3 as u64), arg5), v1);
        };
