module 0x34a3c3f654d431e1c10f4e7cdec98ece3b539c0203e2bf50cbe278f14e2ac55::reward9302 {
    struct REWARD9302 has drop {
        dummy_field: bool,
    }

    struct TICKET_9302 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9302(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9302>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9302>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9302, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9302>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9302>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9302>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9302>>(v5, 0x2::tx_context::sender(arg1));
    }
