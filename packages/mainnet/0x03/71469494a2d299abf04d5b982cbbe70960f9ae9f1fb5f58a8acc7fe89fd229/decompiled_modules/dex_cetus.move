module 0x371469494a2d299abf04d5b982cbbe70960f9ae9f1fb5f58a8acc7fe89fd229::dex_cetus {
    ...
    public fun get_dex_info() : 0x371469494a2d299abf04d5b982cbbe70960f9ae9f1fb5f58a8acc7fe89fd229::dex_trait::DexInfo {
        0x371469494a2d299abf04d5b982cbbe70960f9ae9f1fb5f58a8acc7fe89fd229::dex_trait::create_dex_info(b"Cetus", 30, @0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb)
    }
    ...
    public fun swap_cross<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = SwapExecuted{
            ...
            trader       : arg1,
            pool_address : 0x371469494a2d299abf04d5b982cbbe70960f9ae9f1fb5f58a8acc7fe89fd229::constants::get_cetus_sui_usdc_pool(),
        };
