module 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic {
    ...
    public(friend) fun fix_chestpiece(arg0: &mut Cosmetic) {
        if (arg0.name == 0x1::string::utf8(b"Fang MK IV") && arg0.colour_way == 0x1::string::utf8(b"Digital Winter") && arg0.image_url == 0x1::string::utf8(b"QmYRL4Ws5DjjFywLzibgqLa3NSNDZinKNxn3xQZUywVrv3") && arg0.type == 0x1::string::utf8(b"Chestpiece")) {
            arg0.colour_way = 0x1::string::utf8(b"Hikari");
            arg0.rarity = 0x1::string::utf8(b"Mythic");
            let (v0, v1, v2) = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::uris::get_chestpiece(b"Fang MK IV", b"Hikari");
            ...
            0x1::vector::append<u8>(&mut v3, b"Chestpiece");
    ...
    public(friend) fun fix_helm(arg0: &mut Cosmetic) {
        if (arg0.name == 0x1::string::utf8(b"Fang MK IV") && arg0.colour_way == 0x1::string::utf8(b"Digital Winter") && arg0.image_url == 0x1::string::utf8(b"QmYRL4Ws5DjjFywLzibgqLa3NSNDZinKNxn3xQZUywVrv3") && arg0.type == 0x1::string::utf8(b"Helm")) {
            arg0.colour_way = 0x1::string::utf8(b"Hikari");
            arg0.rarity = 0x1::string::utf8(b"Mythic");
            let (v0, v1, v2) = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::uris::get_helm(b"Fang MK IV", b"Hikari");
            arg0.image_url = 0x1::string::utf8(v0);
            arg0.model_url = 0x1::string::utf8(v1);
            arg0.texture_url = 0x1::string::utf8(v2);
            let v3 = b"";
            0x1::vector::append<u8>(&mut v3, b"Fang MK IV");
            0x1::vector::append<u8>(&mut v3, b"Helm");
            0x1::vector::append<u8>(&mut v3, b"Hikari");
            arg0.hash = 0x2::hash::blake2b256(&v3);
        };
    }
    ...
    public(friend) fun fix_left_bracer(arg0: &mut Cosmetic) {
        if (arg0.name == 0x1::string::utf8(b"Fang MK IV") && arg0.colour_way == 0x1::string::utf8(b"Digital Winter") && arg0.image_url == 0x1::string::utf8(b"QmYRL4Ws5DjjFywLzibgqLa3NSNDZinKNxn3xQZUywVrv3") && arg0.type == 0x1::string::utf8(b"Left Bracer")) {
            arg0.colour_way = 0x1::string::utf8(b"Hikari");
            arg0.rarity = 0x1::string::utf8(b"Mythic");
            let (v0, v1, v2) = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::uris::get_left_bracer(b"Fang MK IV", b"Hikari");
            arg0.image_url = 0x1::string::utf8(v0);
            arg0.model_url = 0x1::string::utf8(v1);
            arg0.texture_url = 0x1::string::utf8(v2);
            let v3 = b"";
            0x1::vector::append<u8>(&mut v3, b"Fang MK IV");
            0x1::vector::append<u8>(&mut v3, b"Left Bracer");
            0x1::vector::append<u8>(&mut v3, b"Hikari");
            arg0.hash = 0x2::hash::blake2b256(&v3);
        };
    }
    ...
    public(friend) fun fix_left_pauldron(arg0: &mut Cosmetic) {
        if (arg0.name == 0x1::string::utf8(b"Fang MK IV") && arg0.colour_way == 0x1::string::utf8(b"Digital Winter") && arg0.image_url == 0x1::string::utf8(b"QmYRL4Ws5DjjFywLzibgqLa3NSNDZinKNxn3xQZUywVrv3") && arg0.type == 0x1::string::utf8(b"Left Pauldron")) {
            arg0.colour_way = 0x1::string::utf8(b"Hikari");
            arg0.rarity = 0x1::string::utf8(b"Mythic");
            let (v0, v1, v2) = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::uris::get_left_pauldron(b"Fang MK IV", b"Hikari");
            arg0.image_url = 0x1::string::utf8(v0);
            arg0.model_url = 0x1::string::utf8(v1);
            arg0.texture_url = 0x1::string::utf8(v2);
            let v3 = b"";
            0x1::vector::append<u8>(&mut v3, b"Fang MK IV");
            0x1::vector::append<u8>(&mut v3, b"Left Pauldron");
            0x1::vector::append<u8>(&mut v3, b"Hikari");
            arg0.hash = 0x2::hash::blake2b256(&v3);
        };
    }
    ...
    public(friend) fun fix_legs(arg0: &mut Cosmetic) {
        ...
        if (arg0.name == 0x1::string::utf8(b"Fang MK IV") && arg0.colour_way == 0x1::string::utf8(b"Hikari") && arg0.type == 0x1::string::utf8(b"Legs")) {
            ...
            let (v1, v2, v3) = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::uris::get_other(b"Fang MK IV", b"Legs", b"Digital Winter");
            ...
            0x1::vector::append<u8>(&mut v4, b"Legs");
            0x1::vector::append<u8>(&mut v4, b"Digital Winter");
            arg0.hash = 0x2::hash::blake2b256(&v4);
        } else if (arg0.name == 0x1::string::utf8(b"Fang MK IV") && arg0.colour_way == 0x1::string::utf8(b"Digital Winter") && arg0.type == 0x1::string::utf8(b"Legs") && arg0.hash == 0x2::hash::blake2b256(&v0)) {
            let v5 = b"";
    ...
    public(friend) fun fix_right_bracer(arg0: &mut Cosmetic) {
        if (arg0.name == 0x1::string::utf8(b"Fang MK IV") && arg0.colour_way == 0x1::string::utf8(b"Digital Winter") && arg0.image_url == 0x1::string::utf8(b"QmYRL4Ws5DjjFywLzibgqLa3NSNDZinKNxn3xQZUywVrv3") && arg0.type == 0x1::string::utf8(b"Right Bracer")) {
            arg0.colour_way = 0x1::string::utf8(b"Hikari");
            arg0.rarity = 0x1::string::utf8(b"Mythic");
            let (v0, v1, v2) = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::uris::get_right_bracer(b"Fang MK IV", b"Hikari");
            arg0.image_url = 0x1::string::utf8(v0);
            arg0.model_url = 0x1::string::utf8(v1);
            arg0.texture_url = 0x1::string::utf8(v2);
            let v3 = b"";
            0x1::vector::append<u8>(&mut v3, b"Fang MK IV");
            0x1::vector::append<u8>(&mut v3, b"Right Bracer");
            0x1::vector::append<u8>(&mut v3, b"Hikari");
            arg0.hash = 0x2::hash::blake2b256(&v3);
        };
    }
    ...
    public(friend) fun fix_right_pauldron(arg0: &mut Cosmetic) {
        if (arg0.name == 0x1::string::utf8(b"Fang MK IV") && arg0.colour_way == 0x1::string::utf8(b"Digital Winter") && arg0.image_url == 0x1::string::utf8(b"QmYRL4Ws5DjjFywLzibgqLa3NSNDZinKNxn3xQZUywVrv3") && arg0.type == 0x1::string::utf8(b"Right Pauldron")) {
            arg0.colour_way = 0x1::string::utf8(b"Hikari");
            arg0.rarity = 0x1::string::utf8(b"Mythic");
            let (v0, v1, v2) = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::uris::get_right_pauldron(b"Fang MK IV", b"Hikari");
            arg0.image_url = 0x1::string::utf8(v0);
            arg0.model_url = 0x1::string::utf8(v1);
            arg0.texture_url = 0x1::string::utf8(v2);
            let v3 = b"";
            0x1::vector::append<u8>(&mut v3, b"Fang MK IV");
            0x1::vector::append<u8>(&mut v3, b"Right Pauldron");
            0x1::vector::append<u8>(&mut v3, b"Hikari");
            arg0.hash = 0x2::hash::blake2b256(&v3);
        };
    }
