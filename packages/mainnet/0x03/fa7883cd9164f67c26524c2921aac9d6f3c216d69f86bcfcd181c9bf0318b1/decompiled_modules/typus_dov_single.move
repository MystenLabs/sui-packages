module 0x4e845c2c18602edd9f7f0251b467a301ad653e38d9fdbfc06cbc670a4d79166e::typus_dov_single {
    ...
    struct Registry has key {
        id: 0x2::object::UID,
        num_of_vault: u64,
        authority: 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::authority::Authority,
        fee_pool: 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::BalancePool,
    ...
    public(friend) fun activate_<T0, T1, T2>(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64) {
        ...
        let v10 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::activate<T0>(v3, v1.config.has_next, arg4);
        ...
        let v17 = calculate_max_auction_size(v1.info.o_token_decimal, v1.config.leverage, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::active_share_supply(v3) + 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::deactivating_share_supply(v3), calculate_max_loss_per_unit(v1.info.option_type, v4, v5, v1.info.d_token_decimal, v1.info.o_token_decimal, v1.config.active_vault_config.payoff_configs, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(2)), v1.config.bid_lot_size);
        let v18 = OracleInfo{
            price   : v4,
            decimal : v5,
        };
        v1.info.oracle_info = v18;
        let v19 = DeliveryInfos{
            round                     : v1.info.round,
            max_size                  : v17,
        ...
        v1.info.delivery_infos = v19;
        let v20 = v1.info.settlement_base_name;
        let (v21, v22, v23) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_date_from_ts(v1.info.expiration_ts_ms / 1000);
        0x1::string::append_utf8(&mut v20, b"-");
        0x1::string::append_utf8(&mut v20, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_pad_2_number_string(v23));
        0x1::string::append_utf8(&mut v20, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_month_short_string(v22));
        0x1::string::append_utf8(&mut v20, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_pad_2_number_string(v21));
        if (v1.info.period == 3 || v1.info.period == 4) {
            0x1::string::append_utf8(&mut v20, b"-");
            0x1::string::append_utf8(&mut v20, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_pad_2_number_string(v1.info.expiration_ts_ms % 86400000 / 3600000));
            0x1::string::append_utf8(&mut v20, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_pad_2_number_string(v1.info.expiration_ts_ms % 3600000 / 60000));
        } else {
            0x1::vector::reverse<u64>(&mut v12);
            while (!0x1::vector::is_empty<u64>(&v12)) {
                0x1::string::append_utf8(&mut v20, b"-");
                0x1::string::append_utf8(&mut v20, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::u64_to_bytes(0x1::vector::pop_back<u64>(&mut v12), v5));
            };
        };
        if (v1.info.option_type == 0) {
            0x1::string::append_utf8(&mut v20, b"-Call");
        } else if (v1.info.option_type == 1) {
            0x1::string::append_utf8(&mut v20, b"-Put");
        } else if (v1.info.option_type == 2) {
            0x1::string::append_utf8(&mut v20, b"-CallSpread");
        } else if (v1.info.option_type == 3) {
            0x1::string::append_utf8(&mut v20, b"-PutSpread");
        } else if (v1.info.option_type == 4) {
            0x1::string::append_utf8(&mut v20, b"-CappedCall");
        } else if (v1.info.option_type == 5) {
            0x1::string::append_utf8(&mut v20, b"-CappedPut");
        } else if (v1.info.option_type == 6) {
            if (0x1::ascii::into_bytes(v7) == b"USDT") {
                0x1::string::append_utf8(&mut v20, b"-UsdtCappedCall");
            } else if (0x1::ascii::into_bytes(v7) == b"USDC") {
                0x1::string::append_utf8(&mut v20, b"-UsdcCappedCall");
            } else {
                0x1::string::append_utf8(&mut v20, b"-UsdCappedCall");
            };
        };
        let v24 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::new_bid_vault<T0, T1>(v1.info.index, v20, arg4);
        let v25 = 0;
        let v26 = 0;
        if (v17 == 0 || 0x2::clock::timestamp_ms(arg3) >= v1.info.expiration_ts_ms) {
            v1.info.status = 4;
            let v27 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::active_share_supply(v3) + 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::deactivating_share_supply(v3);
            if (v27 > 0) {
                let v28 = &mut arg0.id;
                let v29 = &mut v24;
                let (v30, v31) = vault_delivery_<T0, T1, T2>(v28, v1, v3, v29, 0x2::balance::zero<T1>(), arg4);
                v26 = v30;
                v25 = v31;
                let (_, _) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::recoup<T0>(v3, v27, arg4);
            };
        } else {
            v1.info.status = 1;
        };
        0x2::dynamic_object_field::add<u64, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(&mut arg0.bid_vault_registry, arg1, v24);
        (v10, v17, v26, v25)
    }
    ...
    entry fun adjust_incentive_share_ratio<T0>(arg0: &mut Registry, arg1: u64) {
        ...
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::adjust_user_share_ratio<T0>(get_mut_deposit_vault(v0, arg1), 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::incentive_share_tag());
    }

    entry fun adjust_premium_share_ratio<T0>(arg0: &mut Registry, arg1: u64) {
        let v0 = &mut arg0.deposit_vault_registry;
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::adjust_user_share_ratio<T0>(get_mut_deposit_vault(v0, arg1), 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::premium_share_tag());
    }
    ...
    public(friend) fun airdrop_otc_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: 0x2::balance::Balance<T1>, arg4: 0x2::balance::Balance<T1>, arg5: vector<address>, arg6: vector<u64>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        while (!0x1::vector::is_empty<address>(&arg5)) {
            ...
            0x2::transfer::public_transfer<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt>(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::public_new_bid(v5, v7, arg8), 0x1::vector::pop_back<address>(&mut arg5));
            v6 = v6 + v7;
        };
        let v8 = 0x2::balance::value<T1>(&arg4);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::put<T1>(&mut arg0.fee_pool, arg4);
        ...
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::delivery<T0, T1>(v3, v5, arg3);
    ...
    public(friend) fun auction_exists(arg0: &0x2::object::UID, arg1: u64) : bool {
        0x2::dynamic_object_field::exists_with_type<u64, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::Auction>(arg0, arg1)
    }
    ...
    fun calcualte_incentive_(arg0: &PortfolioVault, arg1: u64) : u64 {
        ...
        if (arg0.info.deposit_token == v1) {
            ...
            (((arg1 as u128) * (arg0.info.oracle_info.price as u128) / (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg0.info.oracle_info.decimal) as u128) * (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg0.info.b_token_decimal) as u128) / (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg0.info.d_token_decimal) as u128)) as u64)
        } else {
            (((arg1 as u128) * (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg0.info.oracle_info.decimal) as u128) / (arg0.info.oracle_info.price as u128) * (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg0.info.b_token_decimal) as u128) / (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg0.info.d_token_decimal) as u128)) as u64)
        }
    }
    ...
    public(friend) fun calculate_in_usd<T0>(arg0: &PortfolioVault, arg1: u64, arg2: bool) : u64 {
        ...
        if (0x1::type_name::get<T0>() != arg0.info.settlement_base && 0x1::type_name::get<T0>() != 0x1::type_name::get<0x2::sui::SUI>()) {
            let v2 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(v0);
            if (arg2) {
                (arg1 - arg1 % v2) / v2 + 1
            } else {
                arg1 / v2
            ...
            let v3 = (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(v0) as u128) * (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg0.info.oracle_info.decimal) as u128);
    ...
    public(friend) fun calculate_in_usd_with_decimal<T0>(arg0: &PortfolioVault, arg1: u64) : u64 {
        ...
        if (0x1::type_name::get<T0>() != arg0.info.settlement_base && 0x1::type_name::get<T0>() != 0x1::type_name::get<0x2::sui::SUI>()) {
            (((arg1 as u128) * (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(6) as u128) / (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(v0) as u128)) as u64)
        } else {
            (((arg1 as u128) * (arg0.info.oracle_info.price as u128) / (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(v0) as u128) * (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(6) as u128) / (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg0.info.oracle_info.decimal) as u128)) as u64)
        }
    }

    public(friend) fun calculate_max_auction_size(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ((((0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg0) * arg1) as u128) * (arg2 as u128) / (arg3 as u128) / (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(2) as u128)) as u64) / arg4 * arg4
    }
    ...
    public(friend) fun calculate_max_loss_per_unit(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: vector<PayoffConfig>, arg6: u64) : u64 {
        ...
        let v6 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::zero();
        while (!0x1::vector::is_empty<u64>(&v0)) {
            let v7 = calculate_portfolio_payoff_by_price(arg0, 0x1::vector::pop_back<u64>(&mut v0), arg2, arg3, arg5, arg6, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg4), arg4);
            if (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::compare(&v6, &v7) == 2) {
                v6 = v7;
            };
        };
        assert!(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::is_neg(&v6), 15);
        let v8 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::neg(&v6);
        let v9 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::as_u64(&v8);
        assert!(v9 > 0, 15);
        v9
    }
    ...
    public(friend) fun calculate_option_payoff(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        if (arg0 % 2 == 0 && arg0 != 6) {
            if (arg1 >= arg3) {
                (((0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg2) as u128) * ((arg1 - arg3) as u128) / (arg1 as u128)) as u64)
            } else {
                0
            }
        } else if (arg0 % 2 == 1) {
    ...
    public fun calculate_payoff_for_active_bid_receipt(arg0: &Registry, arg1: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg2: &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt, arg3: &0x2::clock::Clock) : u64 {
        let (v0, v1, v2) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::get_bid_receipt_info(arg2);
        let v3 = v2;
        let v4 = 0x1::vector::borrow<u64>(&v3, 0);
        let v5 = get_portfolio_vault(&arg0.portfolio_vault_registry, v1);
        if (v0 != 0x2::object::id<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(get_bid_vault(&arg0.bid_vault_registry, v1))) {
            return 0
        };
        ...
        if (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::is_neg(&v8)) {
            let v10 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::abs(&v8);
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::as_u64(&v10)
        } else {
            0
        }
    }

    public fun calculate_payoff_for_expired_bid_receipts<T0>(arg0: &Registry, arg1: &vector<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt>) : u64 {
        let (_, v1, _) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::get_bid_receipt_info(0x1::vector::borrow<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt>(arg1, 0));
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::calculate_exercise_value_for_receipts<T0>(get_bid_vault(&arg0.bid_vault_registry, v1), arg1)
    }

    public(friend) fun calculate_portfolio_payoff_by_price(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: vector<PayoffConfig>, arg5: u64, arg6: u64, arg7: u64) : 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::I64 {
        let v0 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::zero();
        while (!0x1::vector::is_empty<PayoffConfig>(&arg4)) {
            ...
            let v2 = if (v1.is_buyer) {
                0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::from(1)
            } else {
                0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::neg_from(1)
            };
            let v3 = v2;
            let v4 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::from((((calculate_option_payoff(arg0, arg1, arg2, *0x1::option::borrow<u64>(&v1.strike)) as u128) * (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg3) as u128) / (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg2) as u128)) as u64));
            let v5 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::mul(&v4, &v3);
            let v6 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::from(v1.weight);
            let v7 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::mul(&v5, &v6);
            let v8 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::from(arg5);
            let v9 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::mul(&v7, &v8);
            let v10 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::from(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(2));
            let v11 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::div(&v9, &v10);
            let v12 = &v0;
            v0 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::add(v12, &v11);
        };
        let v13 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::abs(&v0);
        if (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::is_neg(&v0)) {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::neg_from((((0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::as_u64(&v13) as u128) * (arg6 as u128) / (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg7) as u128)) as u64))
        } else {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::from((((0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::as_u64(&v13) as u128) * (arg6 as u128) / (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg7) as u128)) as u64))
        }
    }
    ...
    public fun check_bid_receipt_expired(arg0: &Registry, arg1: &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt) : bool {
        let (v0, v1, _) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::get_bid_receipt_info(arg1);
        v0 != 0x2::object::id<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(get_bid_vault(&arg0.bid_vault_registry, v1))
    }

    public fun check_itm<T0>(arg0: &Registry, arg1: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg2: &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt, arg3: &0x2::clock::Clock) : bool {
    ...
    public(friend) fun close_(arg0: &mut Registry, arg1: u64) {
        ...
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::close(get_mut_deposit_vault(v1, arg1));
    }
    ...
    public(friend) fun create_scallop_spool_account_<T0>(arg0: &mut Registry, arg1: u64, arg2: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (address, address) {
        ...
        let v1 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::scallop::new_spool_account<T0>(arg2, arg3, arg4);
    ...
    public(friend) fun create_suilend_obligation_owner_cap_(arg0: &mut Registry, arg1: u64, arg2: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>, arg3: &mut 0x2::tx_context::TxContext) : (address, address) {
        let v0 = &mut arg0.additional_config_registry;
        let v1 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::suilend::new_suilend_obligation_owner_cap(arg2, arg3);
    ...
    public(friend) fun delivery_<T0, T1, T2>(arg0: &mut Registry, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        let (v10, v11, v12, v13, v14, v15, v16, v17) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::delivery<T1>(v8, v7, take_auction(v9, arg1), arg2, arg3, arg4);
        let v18 = v11;
        ...
        if (0x2::balance::value<T1>(&v18) > 0) {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut v1.config.u64_padding, 0, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v1.config.u64_padding, 0) + 0x2::balance::value<T1>(&v18));
        ...
        0x1::vector::push_back<u64>(v24, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v1.config.u64_padding, 3));
    ...
    public(friend) fun deposit_scallop_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        assert!(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v0.config.u64_padding, 1) == 1, 34);
        let v1 = &mut arg0.deposit_vault_registry;
        ...
        let v5 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::scallop::deposit<T0>(v2, arg2, arg3, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool_account::SpoolAccount<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&mut v4.id, b"scallop_spool_account"), arg5, arg6);
    ...
    public(friend) fun deposit_scallop_basic_lending_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : vector<u64> {
        let v0 = get_portfolio_vault(&arg0.portfolio_vault_registry, arg1);
        assert!(v0.info.status != 4 && v0.info.status != 5, 3);
        assert!(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v0.config.u64_padding, 4) == 1, 33);
        let v1 = &mut arg0.deposit_vault_registry;
        let v2 = get_mut_deposit_vault(v1, arg1);
        let v3 = &mut arg0.additional_config_registry;
        let (v4, v5) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::scallop::deposit_basic_lending<T0>(v2, arg2, arg3, arg4, arg5);
        let v6 = v5;
    ...
    public(friend) fun deposit_suilend_<T0>(arg0: &mut Registry, arg1: u64, arg2: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : vector<u64> {
        let v0 = get_portfolio_vault(&arg0.portfolio_vault_registry, arg1);
        assert!(v0.info.status != 4 && v0.info.status != 5, 3);
        assert!(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v0.config.u64_padding, 6) == 1, 38);
        let v1 = &mut arg0.deposit_vault_registry;
        let v2 = get_mut_deposit_vault(v1, arg1);
        let v3 = &mut arg0.additional_config_registry;
        let v4 = get_mut_additional_config(v3, arg1);
        assert!(0x2::dynamic_field::exists_with_type<vector<u8>, 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool_account::SpoolAccount<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&v4.id, b"suilend_obligation_owner_cap"), 39);
        let v5 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::suilend::deposit<T0>(v2, arg2, arg3, 0x2::dynamic_field::borrow_mut<vector<u8>, 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>>(&mut v4.id, b"suilend_obligation_owner_cap"), arg4, arg5);
        0x1::vector::push_back<u64>(&mut v5, v0.info.round);
        v5
    }
    ...
    public(friend) fun drop_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        ...
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::authority::add_authorized_user(&mut v4, 0x2::tx_context::sender(arg2));
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::authority::destroy(v4, arg2);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::drop_deposit_vault<T0, T1>(0x2::dynamic_object_field::remove<u64, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::DepositVault>(&mut arg0.deposit_vault_registry, arg1));
    }

    public(friend) fun emit_activate_event(arg0: &Registry, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::tx_context::TxContext) {
        let v0 = get_portfolio_vault(&arg0.portfolio_vault_registry, arg1);
    ...
    public(friend) fun fixed_incentivise_<T0>(arg0: &mut Registry, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64) : u64 {
        ...
        let v1 = get_mut_portfolio_vault(v0, arg1);
        let v2 = &mut arg0.deposit_vault_registry;
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::update_deposit_vault_incentive_token<T0>(get_mut_deposit_vault(v2, arg1));
        ...
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut v1.config.u64_padding, 2, v4);
    ...
    public(friend) fun get_auction(arg0: &0x2::object::UID, arg1: u64) : &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::Auction {
        assert!(auction_exists(arg0, arg1), 1);
        0x2::dynamic_object_field::borrow<u64, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::Auction>(arg0, arg1)
    }
    ...
    public fun get_bid_receipt_intrinsic_value<T0>(arg0: &Registry, arg1: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg2: &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt, arg3: &0x2::clock::Clock) : u64 {
        if (!check_bid_receipt_expired(arg0, arg2)) {
            calculate_payoff_for_active_bid_receipt(arg0, arg1, arg2, arg3)
        } else {
            let (v1, _, _) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::get_bid_receipt_info(arg2);
            let v4 = v1;
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::calculate_exercise_value<T0>(get_bid_vault_by_id(&arg0.bid_vault_registry, &v4), arg2)
        }
    }
    ...
    public(friend) fun get_bid_vault(arg0: &0x2::object::UID, arg1: u64) : &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault {
        0x2::dynamic_object_field::borrow<u64, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(arg0, arg1)
    }

    public(friend) fun get_bid_vault_by_id(arg0: &0x2::object::UID, arg1: &0x2::object::ID) : &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault {
        0x2::dynamic_object_field::borrow<address, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(arg0, 0x2::object::id_to_address(arg1))
    }

    public(friend) fun get_bid_vault_by_id_or_index(arg0: &0x2::object::UID, arg1: &0x2::object::ID, arg2: u64) : &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault {
        if (0x2::dynamic_object_field::exists_with_type<address, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(arg0, 0x2::object::id_to_address(arg1))) {
            0x2::dynamic_object_field::borrow<address, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(arg0, 0x2::object::id_to_address(arg1))
        } else {
    ...
    public(friend) fun get_deposit_vault(arg0: &0x2::object::UID, arg1: u64) : &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::DepositVault {
        0x2::dynamic_object_field::borrow<u64, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::DepositVault>(arg0, arg1)
    }
    ...
    public(friend) fun get_mut_auction(arg0: &mut 0x2::object::UID, arg1: u64) : &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::Auction {
        assert!(auction_exists(arg0, arg1), 1);
        0x2::dynamic_object_field::borrow_mut<u64, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::Auction>(arg0, arg1)
    }

    public(friend) fun get_mut_bid_vault(arg0: &mut 0x2::object::UID, arg1: u64) : &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault {
        0x2::dynamic_object_field::borrow_mut<u64, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(arg0, arg1)
    }

    public(friend) fun get_mut_bid_vault_by_id(arg0: &mut 0x2::object::UID, arg1: &0x2::object::ID) : &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault {
        0x2::dynamic_object_field::borrow_mut<address, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(arg0, 0x2::object::id_to_address(arg1))
    }

    public(friend) fun get_mut_bid_vault_by_id_or_index(arg0: &mut 0x2::object::UID, arg1: &0x2::object::ID, arg2: u64) : &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault {
        if (0x2::dynamic_object_field::exists_with_type<address, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(arg0, 0x2::object::id_to_address(arg1))) {
            0x2::dynamic_object_field::borrow_mut<address, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(arg0, 0x2::object::id_to_address(arg1))
        } else {
    ...
    public(friend) fun get_mut_deposit_vault(arg0: &mut 0x2::object::UID, arg1: u64) : &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::DepositVault {
        0x2::dynamic_object_field::borrow_mut<u64, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::DepositVault>(arg0, arg1)
    }
    ...
    public(friend) fun get_mut_portfolio_vault_authority(arg0: &mut PortfolioVault) : &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::authority::Authority {
        &mut arg0.authority
    }

    public(friend) fun get_mut_refund_vault<T0>(arg0: &mut 0x2::object::UID) : &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::RefundVault {
        0x2::dynamic_object_field::borrow_mut<0x1::type_name::TypeName, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::RefundVault>(arg0, 0x1::type_name::get<T0>())
    }

    public(friend) fun get_mut_registry_inner(arg0: &mut Registry) : (&mut 0x2::object::UID, &mut u64, &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::authority::Authority, &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::BalancePool, &mut 0x2::object::UID, &mut 0x2::object::UID, &mut 0x2::object::UID, &mut 0x2::object::UID, &mut 0x2::object::UID, &mut 0x2::object::UID, &mut u64, &mut bool) {
    ...
    public(friend) fun get_new_bid_incentive_balance<T0>(arg0: &mut 0x2::object::UID, arg1: &mut PortfolioVault, arg2: u64) : 0x2::balance::Balance<T0> {
        ...
        if (0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(arg0, 0x1::type_name::get<T0>())) {
            ...
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut arg1.config.u64_padding, 0, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&arg1.config.u64_padding, 0) - arg2);
        };
        v0
    }

    public(friend) fun get_new_bid_incentive_balance_value<T0>(arg0: &0x2::object::UID, arg1: &PortfolioVault, arg2: &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::Auction, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock) : (u64, u64) {
        let (_, _, v2, v3) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::get_bid_info(arg2, arg3, arg4, 0x2::clock::timestamp_ms(arg5));
        if (arg1.config.bid_incentive_bp > 0) {
            ...
            let v6 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&arg1.config.u64_padding, 0);
    ...
    public(friend) fun get_otc_incentive_balance<T0>(arg0: &mut 0x2::object::UID, arg1: &mut PortfolioVault, arg2: u64, arg3: u64, arg4: u64) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>) {
        ...
        if (0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(arg0, 0x1::type_name::get<T0>())) {
            ...
            let v4 = &mut v0;
            let v5 = request_incentive<T0>(v3, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&arg1.config.u64_padding, 0), arg2, v4);
            let v6 = &mut v1;
            let v7 = request_incentive<T0>(v3, v5, arg3, v6);
            let v8 = &mut v2;
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut arg1.config.u64_padding, 0, request_incentive<T0>(v3, v7, arg4, v8));
        };
        (v0, v1, v2)
    }
    ...
    public(friend) fun get_portfolio_vault_authority(arg0: &PortfolioVault) : &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::authority::Authority {
        &arg0.authority
    }

    public(friend) fun get_refund_vault<T0>(arg0: &0x2::object::UID) : &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::RefundVault {
        0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::RefundVault>(arg0, 0x1::type_name::get<T0>())
    }

    public(friend) fun get_registry_inner(arg0: &Registry) : (&0x2::object::UID, &u64, &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::authority::Authority, &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::BalancePool, &0x2::object::UID, &0x2::object::UID, &0x2::object::UID, &0x2::object::UID, &0x2::object::UID, &0x2::object::UID, &u64, &bool) {
    ...
    entry fun issue_typus_ecosystem_manager_cap(arg0: &mut Registry, arg1: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg2: &0x2::tx_context::TxContext) {
        0x2::dynamic_field::add<vector<u8>, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::ManagerCap>(&mut arg0.id, b"typus_ecosystem", 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::issue_manager_cap(arg1, arg2));
    }
    ...
    public(friend) fun new_portfolio_vault_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: bool, arg26: vector<PayoffConfig>, arg27: u64, arg28: u64, arg29: u64, arg30: u64, arg31: vector<address>, arg32: &0x2::clock::Clock, arg33: &mut 0x2::tx_context::TxContext) : (u64, Info, Config) {
        ...
        let v13 = PortfolioVault{
            ...
            info      : v11,
            config    : v12,
            authority : 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::authority::new(arg31, arg33),
        };
        ...
        0x2::dynamic_object_field::add<u64, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::DepositVault>(&mut arg0.deposit_vault_registry, v7, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::new_deposit_vault<T0, T1>(v7, arg15, v14, arg33));
        ...
        if (!0x2::dynamic_object_field::exists_with_type<0x1::type_name::TypeName, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::RefundVault>(&arg0.refund_vault_registry, 0x1::type_name::get<T1>())) {
            0x2::dynamic_object_field::add<0x1::type_name::TypeName, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::RefundVault>(&mut arg0.refund_vault_registry, 0x1::type_name::get<T1>(), 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::new_refund_vault<T1>(arg33));
        };
    ...
    public(friend) fun new_registry_(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Registry{
            ...
            num_of_vault               : 0,
            authority                  : 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::authority::new(0x1::vector::singleton<address>(0x2::tx_context::sender(arg0)), arg0),
            fee_pool                   : 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::new(0x1::vector::singleton<address>(0x2::tx_context::sender(arg0)), arg0),
    ...
    public(friend) fun otc_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: u64, arg4: 0x2::balance::Balance<T1>, arg5: 0x2::balance::Balance<T1>, arg6: 0x2::balance::Balance<T1>, arg7: 0x2::balance::Balance<T1>, arg8: 0x2::balance::Balance<T1>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!auction_exists(&arg0.auction_registry, arg1), 0);
        assert!(v1.info.status == 1 || v1.info.status == 3, 3);
        assert!((((arg2 as u128) * (arg3 as u128) / (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(v1.info.o_token_decimal) as u128)) as u64) <= 0x2::balance::value<T1>(&arg4) + 0x2::balance::value<T1>(&arg6), 2);
        let v6 = 0x2::balance::value<T1>(&arg5);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::put<T1>(&mut arg0.fee_pool, arg5);
        let v7 = 0x2::balance::value<T1>(&arg7);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::put<T1>(&mut arg0.fee_pool, arg7);
        let v8 = 0x2::balance::value<T1>(&arg4);
        ...
        0x1::vector::push_back<DeliveryInfo>(&mut v1.info.delivery_infos.delivery_info, v10);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::new_bid(v5, arg3, arg10);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::delivery_b<T0, T1>(v3, v5, arg4, arg8, arg10);
        if (v1.info.delivery_infos.total_delivery_size == v1.info.delivery_infos.max_size) {
            v1.info.status = 4;
        };
    }
    ...
    public(friend) fun public_safu_otc_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: 0x2::balance::Balance<T1>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt>, 0x2::balance::Balance<T1>, vector<u64>) {
        let v0 = &mut arg0.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg1);
        let v2 = &mut arg0.deposit_vault_registry;
        let v3 = get_mut_deposit_vault(v2, arg1);
        ...
        let v5 = get_mut_bid_vault(v4, arg1);
        assert!(!auction_exists(&arg0.auction_registry, arg1), 0);
        assert!(v1.info.status == 1 || v1.info.status == 3 || v1.info.status == 4, 3);
        if (v1.info.status == 4) {
            return (0x1::option::none<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt>(), arg3, vector[0, 0, 0, 0])
        };
        let v6 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::calculate_bid_size(v1.config.bid_fee_bp, v1.info.o_token_decimal, arg2, 0x2::balance::value<T1>(&arg3), 0);
        let v7 = if (v1.info.delivery_infos.total_delivery_size + v6 > v1.info.delivery_infos.max_size) {
        ...
        let (v8, v9) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::calculate_bid_value(v1.config.bid_fee_bp, v1.info.b_token_decimal, v1.info.o_token_decimal, arg2, v7, 0);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::put<T1>(&mut arg0.fee_pool, 0x2::balance::split<T1>(&mut arg3, v9));
        v1.info.delivery_infos.total_delivery_size = v1.info.delivery_infos.total_delivery_size + v7;
        v1.info.delivery_infos.total_bidder_bid_value = v1.info.delivery_infos.total_bidder_bid_value + v8;
        v1.info.delivery_infos.total_bidder_fee = v1.info.delivery_infos.total_bidder_fee + v9;
        let v10 = DeliveryInfo{
            auction_type        : 1,
            delivery_price      : arg2,
            delivery_size       : v7,
        ...
        0x1::vector::push_back<DeliveryInfo>(&mut v1.info.delivery_infos.delivery_info, v10);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::delivery<T0, T1>(v3, v5, 0x2::balance::split<T1>(&mut arg3, v8));
        if (v1.info.delivery_infos.total_delivery_size == v1.info.delivery_infos.max_size) {
            v1.info.status = 4;
        };
        let v11 = 0x1::vector::empty<u64>();
        ...
        0x1::vector::push_back<u64>(v12, v8);
        0x1::vector::push_back<u64>(v12, v9);
        (0x1::option::some<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt>(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::public_new_bid(v5, v7, arg5)), arg3, v11)
    }

    public(friend) fun public_safu_otc_v2_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: 0x2::balance::Balance<T1>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt>, vector<u64>) {
        let v0 = &mut arg0.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg1);
        let v2 = &mut arg0.deposit_vault_registry;
        let v3 = get_mut_deposit_vault(v2, arg1);
        ...
        if (v1.info.status == 4) {
            ...
            return (0x1::option::none<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt>(), vector[0, 0, 0, 0])
        };
        let v6 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::calculate_bid_size(v1.config.bid_fee_bp, v1.info.o_token_decimal, arg2, 0x2::balance::value<T1>(&arg3), 0);
        let v7 = if (v1.info.delivery_infos.total_delivery_size + v6 > v1.info.delivery_infos.max_size) {
            v1.info.delivery_infos.max_size - v1.info.delivery_infos.total_delivery_size
        ...
        let (_, v9) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::calculate_bid_value(v1.config.bid_fee_bp, v1.info.b_token_decimal, v1.info.o_token_decimal, arg2, v7, 0);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::put<T1>(&mut arg0.fee_pool, 0x2::balance::split<T1>(&mut arg3, v9));
        let v10 = 0x2::balance::value<T1>(&arg3);
        v1.info.delivery_infos.total_delivery_size = v1.info.delivery_infos.total_delivery_size + v7;
        v1.info.delivery_infos.total_bidder_bid_value = v1.info.delivery_infos.total_bidder_bid_value + v10;
        v1.info.delivery_infos.total_bidder_fee = v1.info.delivery_infos.total_bidder_fee + v9;
        let v11 = DeliveryInfo{
            auction_type        : 1,
            delivery_price      : arg2,
            delivery_size       : v7,
            bidder_bid_value    : v10,
            bidder_fee          : v9,
            incentive_bid_value : 0,
            incentive_fee       : 0,
            ts_ms               : 0x2::clock::timestamp_ms(arg4),
        ...
        (0x1::option::some<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt>(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::public_new_bid(v5, v7, arg5)), v12)
    }
    ...
    public(friend) fun recoup_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) : (u64, u64) {
        ...
        v1.info.status = 4;
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::recoup<T0>(v3, ((((0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::active_share_supply(v3) + 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::deactivating_share_supply(v3)) as u128) * ((v1.info.delivery_infos.max_size - v1.info.delivery_infos.total_delivery_size) as u128) / (v1.info.delivery_infos.max_size as u128)) as u64), arg3)
    }

    public(friend) fun refund_vault_exists<T0>(arg0: &0x2::object::UID) : bool {
        0x2::dynamic_object_field::exists_with_type<0x1::type_name::TypeName, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::RefundVault>(arg0, 0x1::type_name::get<T0>())
    }
    ...
    public(friend) fun reward_suilend_<T0>(arg0: &mut Registry, arg1: u64, arg2: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        let v2 = get_mut_deposit_vault(v1, arg1);
        let v3 = &mut arg0.additional_config_registry;
        let v4 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::suilend::reward<T0>(&mut arg0.fee_pool, v2, arg2, arg3, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>>(&mut get_mut_additional_config(v3, arg1).id, b"suilend_obligation_owner_cap"), 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v0.config.u64_padding, 5) != 1, arg5, arg6);
    ...
    public(friend) fun set_available_incentive_amount_(arg0: &mut Registry, arg1: u64, arg2: u64) : u64 {
        let v0 = &mut arg0.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg1);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut v1.config.u64_padding, 0, arg2);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v1.config.u64_padding, 0)
    }

    public(friend) fun set_enable_additional_lending_flag_(arg0: &mut Registry, arg1: u64, arg2: bool) {
        let v0 = &mut arg0.portfolio_vault_registry;
        if (arg2) {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut get_mut_portfolio_vault(v0, arg1).config.u64_padding, 5, 1);
        } else {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut get_mut_portfolio_vault(v0, arg1).config.u64_padding, 5, 0);
        };
    }
    ...
    public(friend) fun set_enable_scallop_basic_lending_flag_(arg0: &mut Registry, arg1: u64, arg2: bool) {
        let v0 = &mut arg0.portfolio_vault_registry;
        if (arg2) {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut get_mut_portfolio_vault(v0, arg1).config.u64_padding, 4, 1);
        } else {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut get_mut_portfolio_vault(v0, arg1).config.u64_padding, 4, 0);
        };
    }
    ...
    public(friend) fun set_enable_scallop_flag_(arg0: &mut Registry, arg1: u64, arg2: bool) {
        let v0 = &mut arg0.portfolio_vault_registry;
        if (arg2) {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut get_mut_portfolio_vault(v0, arg1).config.u64_padding, 1, 1);
        } else {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut get_mut_portfolio_vault(v0, arg1).config.u64_padding, 1, 0);
        };
    }
    ...
    public(friend) fun set_enable_suilend_flag_(arg0: &mut Registry, arg1: u64, arg2: bool) {
        let v0 = &mut arg0.portfolio_vault_registry;
        if (arg2) {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut get_mut_portfolio_vault(v0, arg1).config.u64_padding, 6, 1);
        } else {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut get_mut_portfolio_vault(v0, arg1).config.u64_padding, 6, 0);
        };
    }
    ...
    public(friend) fun settle_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        let v8 = calculate_portfolio_payoff_by_price(v1.info.option_type, v6, v7, v1.info.d_token_decimal, v1.config.active_vault_config.payoff_configs, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(2), v1.info.delivery_infos.total_delivery_size, v1.info.o_token_decimal);
        let v9 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::active_balance<T0>(v3) + 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::deactivating_balance<T0>(v3);
        let v10 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::from(v9);
        let v11 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::add(&v10, &v8);
        let v12 = if (v9 != 0) {
            (((0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(8) as u128) * (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::i64::as_u64(&v11) as u128) / (v9 as u128)) as u64)
        } else {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(8)
        };
        let v13 = 8;
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::settle<T0, T1>(v3, v5, v12, v13, arg4);
        let v14 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::active_balance<T0>(v3) + 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::inactive_balance<T0>(v3) - 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::inactive_balance<T0>(v3);
        ...
        if (v1.info.period == 0) {
            ...
            let (_, v17, _) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_date_from_ts(v1.info.expiration_ts_ms / 1000 + 2419200);
            let (_, v20, _) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_date_from_ts(v1.info.expiration_ts_ms / 1000 + 3024000);
            if (v17 != v20) {
        ...
        let v22 = 0x2::dynamic_object_field::remove<u64, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(&mut arg0.bid_vault_registry, arg1);
        if (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::length<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidShare>(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::get_bid_shares(&v22)) == 0) {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::drop_bid_vault<T0>(v22);
        } else {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::set_bid_vault_u64_padding_value(&mut v22, 0, v6);
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::set_bid_vault_u64_padding_value(&mut v22, 1, 0x1::vector::borrow<DeliveryInfo>(&v1.info.delivery_infos.delivery_info, 0).delivery_price);
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::set_bid_vault_u64_padding_value(&mut v22, 2, v1.config.bid_incentive_bp);
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::set_bid_vault_u64_padding_value(&mut v22, 3, v1.info.round);
            0x2::dynamic_object_field::add<address, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(&mut arg0.bid_vault_registry, 0x2::object::id_address<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(&v22), v22);
        };
        (v6, v7, v9, v14, v12)
    }
    ...
    public(friend) fun take_auction(arg0: &mut 0x2::object::UID, arg1: u64) : 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::Auction {
        assert!(auction_exists(arg0, arg1), 1);
        0x2::dynamic_object_field::remove<u64, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::Auction>(arg0, arg1)
    }
    ...
    public(friend) fun terminate_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        ...
        v1.info.status = 5;
        let v2 = &mut arg0.deposit_vault_registry;
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::terminate<T0>(get_mut_deposit_vault(v2, arg1), arg2);
    }
    ...
    public(friend) fun update_auction_config_(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: bool, arg12: &0x2::clock::Clock, arg13: &0x2::tx_context::TxContext) {
        ...
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::update_auction_config(get_mut_auction(v0, arg1), arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13);
    }
    ...
    public(friend) fun update_config_(arg0: &mut Registry, arg1: u64, arg2: 0x1::option::Option<address>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: 0x1::option::Option<u64>, arg8: 0x1::option::Option<u64>, arg9: 0x1::option::Option<u64>, arg10: 0x1::option::Option<u64>, arg11: 0x1::option::Option<0x1::option::Option<vector<u8>>>, arg12: 0x1::option::Option<u64>, arg13: 0x1::option::Option<u64>, arg14: 0x1::option::Option<u64>, arg15: 0x1::option::Option<u64>, arg16: 0x1::option::Option<u64>, arg17: 0x1::option::Option<u64>, arg18: 0x1::option::Option<u64>, arg19: 0x1::option::Option<u64>, arg20: 0x1::option::Option<u64>, arg21: 0x1::option::Option<u64>, arg22: &0x2::tx_context::TxContext) : (Config, Config) {
        ...
        if (0x1::option::is_some<u64>(&arg9)) {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::update_fee(v3, 0x1::option::destroy_some<u64>(arg9), arg22);
        };
        ...
        if (0x1::option::is_some<u64>(&arg21)) {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut v1.config.u64_padding, 3, 0x1::option::destroy_some<u64>(arg21));
        };
        (v1.config, v1.config)
    }
    ...
    public(friend) fun update_deposit_snapshot(arg0: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::TypusUserRegistry, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::TypusLeaderboardRegistry, arg3: &mut Registry, arg4: u64, arg5: address, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        v1.total_deposit = v1.total_deposit - 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v1.snapshots, arg4) + arg6;
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut v1.snapshots, arg4, arg6);
    }
    ...
    public(friend) fun update_strike_(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock) : (u64, u64, VaultConfig) {
        ...
        if (v7.info.period == 3 || v7.info.period == 4) {
            ...
            let (v30, v31, v32) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_date_from_ts(v7.info.expiration_ts_ms / 1000);
            0x1::string::append_utf8(&mut v29, b"-");
            0x1::string::append_utf8(&mut v29, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_pad_2_number_string(v32));
            0x1::string::append_utf8(&mut v29, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_month_short_string(v31));
            0x1::string::append_utf8(&mut v29, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_pad_2_number_string(v30));
            0x1::string::append_utf8(&mut v29, b"-");
            0x1::string::append_utf8(&mut v29, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_pad_2_number_string(v7.info.expiration_ts_ms % 86400000 / 3600000));
            0x1::string::append_utf8(&mut v29, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_pad_2_number_string(v7.info.expiration_ts_ms % 3600000 / 60000));
            0x1::vector::reverse<u64>(&mut v8);
            while (!0x1::vector::is_empty<u64>(&v8)) {
                0x1::string::append_utf8(&mut v29, b"-");
                0x1::string::append_utf8(&mut v29, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::u64_to_bytes(0x1::vector::pop_back<u64>(&mut v8), v1));
            };
            ...
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::update_bid_receipt_display(get_mut_bid_vault(v28, arg1), v29);
        };
        let v33 = v7.config.active_vault_config;
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut v33.u64_padding, 0, v7.info.round);
        (v0, v1, v33)
    }
    ...
    public(friend) fun validate_bid(arg0: &PortfolioVault, arg1: &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::Auction, arg2: u64) {
        validate_bid_amount(arg0, arg2);
        assert!(arg0.config.max_bid_entry == 0 || 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch::bid_index(arg1) < arg0.config.max_bid_entry, 25);
    }
    ...
    public(friend) fun validate_capacity(arg0: &Registry, arg1: u64) {
        ...
        assert!(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::active_share_supply(v1) + 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::warmup_share_supply(v1) <= v0.config.capacity, 28);
        let v2 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::get_deposit_shares(v1);
        assert!(v0.config.max_deposit_entry == 0 || 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::length<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::DepositShare>(v2) <= v0.config.max_deposit_entry, 26);
    }
    ...
    public(friend) fun validate_portfolio_authority(arg0: &Registry, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::authority::double_verify(&arg0.authority, &get_portfolio_vault(&arg0.portfolio_vault_registry, arg1).authority, arg2);
    }

    public(friend) fun validate_registry_authority(arg0: &Registry, arg1: &0x2::tx_context::TxContext) {
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::authority::verify(&arg0.authority, arg1);
    }

    public(friend) fun validate_registry_upgradability(arg0: &Registry, arg1: &0x2::tx_context::TxContext) {
        assert!(25 > arg0.version, 23);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::authority::verify(&arg0.authority, arg1);
    }

    fun vault_delivery_<T0, T1, T2>(arg0: &mut 0x2::object::UID, arg1: &mut PortfolioVault, arg2: &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::DepositVault, arg3: &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault, arg4: 0x2::balance::Balance<T1>, arg5: &0x2::tx_context::TxContext) : (u64, u64) {
        let v0 = if (arg1.config.deposit_incentive_bp > 0 && 0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(arg0, 0x1::type_name::get<T1>())) {
            ...
            let v3 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&arg1.config.u64_padding, 0);
            let v4 = calcualte_incentive_(arg1, ((((0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::active_share_supply(arg2) + 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::deactivating_share_supply(arg2)) as u128) * (arg1.config.deposit_incentive_bp as u128) / 10000 / (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&arg1.config.u64_padding, 3)) as u128)) as u64));
            let v5 = if (v4 > v2) {
                if (v2 > v3) {
                    v3
                } else {
            ...
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut arg1.config.u64_padding, 0, v3 - v5);
            v5
        } else {
            0
        };
        let v6 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&arg1.config.u64_padding, 2);
        if (v0 == 0 && v6 == 0) {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::delivery<T0, T1>(arg2, arg3, arg4);
        } else if (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::match_types<T1, T2>()) {
            ...
            if (v6 > 0) {
                ...
                0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut arg1.config.u64_padding, 2, v9);
            };
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::delivery_b<T0, T1>(arg2, arg3, arg4, v7, arg5);
        } else {
            if (v0 > 0) {
            ...
            let v10 = if (v6 > 0) {
                ...
                0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::set_u64_padding_value(&mut arg1.config.u64_padding, 2, v12);
                0x2::balance::split<T2>(v11, v6)
            } else {
                0x2::balance::zero<T2>()
            };
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::delivery_i<T0, T1, T2>(arg2, arg3, arg4, v10, arg5);
        };
        (v0, v6)
    }

    public fun verify_bid_receipt_collateral_trading_order<T0, T1>(arg0: &Registry, arg1: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg2: &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::TypusBidReceipt, arg3: bool, arg4: &0x2::clock::Clock) : vector<u8> {
        let (v0, v1, _) = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::get_bid_receipt_info(arg2);
        if (v0 != 0x2::object::id<0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::BidVault>(get_bid_vault(&arg0.bid_vault_registry, v1))) {
    ...
    public(friend) fun withdraw_scallop_basic_lending_<T0>(arg0: &mut Registry, arg1: u64, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        if (0x2::dynamic_field::exists_<vector<u8>>(&v5.id, b"scallop_market_coin")) {
            let v6 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::scallop::withdraw_basic_lending_v2<T0>(&mut arg0.fee_pool, v3, v0, arg2, arg3, 0x2::dynamic_field::remove<vector<u8>, 0x2::coin::Coin<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(&mut v5.id, b"scallop_market_coin"), 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v1.config.u64_padding, 5) != 1, arg4, arg5);
    ...
    public(friend) fun withdraw_suilend_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>, arg3: u64, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        let v3 = if (0x1::option::is_some<u64>(&arg4)) {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::suilend::withdraw<T0, T1>(&mut arg0.fee_pool, get_mut_deposit_vault(v1, arg1), 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x1::type_name::get<T0>()), arg2, arg3, arg3, 0x1::option::destroy_some<u64>(arg4), 0x2::dynamic_field::borrow_mut<vector<u8>, 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>>(&mut get_mut_additional_config(v2, arg1).id, b"suilend_obligation_owner_cap"), 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v0.config.u64_padding, 5) != 1, arg5, arg6)
        } else {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::suilend::withdraw_without_reward<T0>(&mut arg0.fee_pool, get_mut_deposit_vault(v1, arg1), 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x1::type_name::get<T0>()), arg2, arg3, 0x2::dynamic_field::borrow_mut<vector<u8>, 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>>(&mut get_mut_additional_config(v2, arg1).id, b"suilend_obligation_owner_cap"), 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::get_u64_padding_value(&v0.config.u64_padding, 5) != 1, arg5, arg6)
        };
        let v4 = v3;
        0x1::vector::push_back<u64>(&mut v4, v0.info.round);
        v4
