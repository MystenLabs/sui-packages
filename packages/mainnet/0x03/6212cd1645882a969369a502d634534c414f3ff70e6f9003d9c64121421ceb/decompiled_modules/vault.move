module 0x36212cd1645882a969369a502d634534c414f3ff70e6f9003d9c64121421ceb::vault {
    ...
    public(friend) fun assert_deposits_enabled<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: u64) {
        assert!(arg0.deposits_enabled && 0x2::balance::value<T2>(&arg0.seed_vt) > 0 && arg1 < arg0.deposit_limit, 0x36212cd1645882a969369a502d634534c414f3ff70e6f9003d9c64121421ceb::error::deposits_disabled());
    }

    public(friend) fun assert_vault_cap<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &VaultCap) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1, T2>>(arg0), 0x36212cd1645882a969369a502d634534c414f3ff70e6f9003d9c64121421ceb::error::invalid_vault_cap());
    }
