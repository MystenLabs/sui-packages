module 0x35cf7b699be1d67785cc54dabc83e497fae23516c0329bea39faabf3384f702::badge_rewards {
    ...
    public(friend) fun maybe_award_badges(arg0: &mut 0x35cf7b699be1d67785cc54dabc83e497fae23516c0329bea39faabf3384f702::profiles::Profile, arg1: &BadgeConfig, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : vector<u8> {
        assert!(arg4 >= arg2, 5);
        assert!(arg5 >= arg3, 5);
        ...
        let v3 = 0x35cf7b699be1d67785cc54dabc83e497fae23516c0329bea39faabf3384f702::profiles::owner(arg0);
        let v4 = 0x2::clock::timestamp_ms(arg6);
        let v5 = 0x1::vector::empty<u8>();
        let v6 = 0;
        while (v6 < 5) {
            let v7 = (v6 as u8) + 1;
            if (!0x35cf7b699be1d67785cc54dabc83e497fae23516c0329bea39faabf3384f702::profiles::has_badge_level(arg0, v7)) {
                ...
                if (v10 && !v11) {
                    ...
                    let v12 = BadgeMinted{
                        owner        : v3,
                        level        : v7,
                        profile_id   : 0x2::object::id<0x35cf7b699be1d67785cc54dabc83e497fae23516c0329bea39faabf3384f702::profiles::Profile>(arg0),
                        timestamp_ms : v4,
                    };
                    0x2::event::emit<BadgeMinted>(v12);
                    0x35cf7b699be1d67785cc54dabc83e497fae23516c0329bea39faabf3384f702::profiles::grant_badge_level(arg0, v7);
