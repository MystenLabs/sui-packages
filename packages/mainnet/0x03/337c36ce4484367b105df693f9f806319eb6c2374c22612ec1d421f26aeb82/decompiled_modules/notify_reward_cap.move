module 0x3337c36ce4484367b105df693f9f806319eb6c2374c22612ec1d421f26aeb82::notify_reward_cap {
    ...
    public fun create(arg0: &0x2::package::Publisher, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : NotifyRewardCap {
        assert!(0x2::package::from_package<NotifyRewardCap>(arg0), 13906834311782334463);
        NotifyRewardCap{
    ...
    public fun grant(arg0: &0x2::package::Publisher, arg1: 0x2::object::ID, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<NotifyRewardCap>(arg0), 13906834333257170943);
        assert!(arg2 != @0x0, 13906834337552138239);
    ...
    public fun validate_notify_reward_voter_id(arg0: &NotifyRewardCap, arg1: 0x2::object::ID) {
        assert!(arg0.voter_id == arg1, 13906834273127628801);
    }
