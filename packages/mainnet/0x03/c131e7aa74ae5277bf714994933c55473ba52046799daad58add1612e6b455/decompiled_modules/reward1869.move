module 0x3c131e7aa74ae5277bf714994933c55473ba52046799daad58add1612e6b455::reward1869 {
    struct REWARD1869 has drop {
        dummy_field: bool,
    }

    struct TICKET_1869 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1869(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1869>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1869>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1869, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1869>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1869>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1869>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1869>>(v5, 0x2::tx_context::sender(arg1));
    }
