module 0x3b434956531b40e345a8aabe6b00768e1a70024f95ab484c99a8d0ff0bb2c97::canvas {
    ...
    fun init(arg0: CANVAS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v2, 0x1::string::utf8(b"rarity_tier"));
        let v3 = 0x1::vector::empty<0x1::string::String>();
        let v4 = &mut v3;
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Imagine Canvas #{total_supply}"));
