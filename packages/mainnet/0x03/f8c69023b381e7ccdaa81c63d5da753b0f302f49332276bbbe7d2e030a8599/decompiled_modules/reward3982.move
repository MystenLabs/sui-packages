module 0x3f8c69023b381e7ccdaa81c63d5da753b0f302f49332276bbbe7d2e030a8599::reward3982 {
    struct REWARD3982 has drop {
        dummy_field: bool,
    }

    struct TICKET_3982 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3982(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3982>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3982>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3982, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3982>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3982>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3982>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3982>>(v5, 0x2::tx_context::sender(arg1));
    }
