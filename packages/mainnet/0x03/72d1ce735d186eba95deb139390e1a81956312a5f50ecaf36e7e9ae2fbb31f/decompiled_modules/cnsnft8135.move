module 0x372d1ce735d186eba95deb139390e1a81956312a5f50ecaf36e7e9ae2fbb31f::cnsnft8135 {
    struct CNSNFT8135 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8135, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8135>(arg0, arg1);
