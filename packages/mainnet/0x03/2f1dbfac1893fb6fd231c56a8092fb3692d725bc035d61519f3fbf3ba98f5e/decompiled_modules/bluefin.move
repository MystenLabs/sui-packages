module 0x32f1dbfac1893fb6fd231c56a8092fb3692d725bc035d61519f3fbf3ba98f5e::bluefin {
    struct SwapErrorEvent has copy, drop {
        error_code: u64,
        phase: u64,
    }

    public fun elf<T0, T1>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg2: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg3: &0x2::clock::Clock, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: u64, arg6: vector<bool>, arg7: vector<u64>, arg8: vector<u64>, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x32f1dbfac1893fb6fd231c56a8092fb3692d725bc035d61519f3fbf3ba98f5e::utils::check_deadline(arg3, arg5, true);
        if (v0 != 0) {
        ...
        let v4 = 0;
        while (v4 < 0x1::vector::length<bool>(&arg6)) {
            let v5 = *0x1::vector::borrow<bool>(&arg6, v4);
            let v6 = *0x1::vector::borrow<u64>(&arg8, v4);
            let v7 = if (v5) {
                0x32f1dbfac1893fb6fd231c56a8092fb3692d725bc035d61519f3fbf3ba98f5e::consts::min_sqrt_price() + 1
            } else {
                0x32f1dbfac1893fb6fd231c56a8092fb3692d725bc035d61519f3fbf3ba98f5e::consts::max_sqrt_price() - 1
            };
            let (v8, v9) = vbac_exact_in<T0, T1>(arg0, v2, v3, v5, *0x1::vector::borrow<u64>(&arg7, v4), v6, v7);
            if (v8 != 0x32f1dbfac1893fb6fd231c56a8092fb3692d725bc035d61519f3fbf3ba98f5e::consts::e_no_error()) {
                let v10 = SwapErrorEvent{
                    error_code : v8,
                    phase      : 2,
                };
                0x2::event::emit<SwapErrorEvent>(v10);
                v4 = v4 + 1;
                continue
            };
            let (v11, v12, v13, v14, v15) = swap_exact_in<T0, T1>(arg1, arg2, arg4, arg0, v5, v9, v6, v7, arg3, arg9);
            if (v11 != 0x32f1dbfac1893fb6fd231c56a8092fb3692d725bc035d61519f3fbf3ba98f5e::consts::e_no_error()) {
                let v16 = SwapErrorEvent{
                    error_code : v11,
                    phase      : 3,
                };
                0x2::event::emit<SwapErrorEvent>(v16);
                v4 = v4 + 1;
                continue
            };
            let v17 = v2 + v14;
    ...
    fun swap_exact_in<T0, T1>(arg0: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg1: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: bool, arg5: u64, arg6: u64, arg7: u128, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        assert!(v8 >= arg6, 0x32f1dbfac1893fb6fd231c56a8092fb3692d725bc035d61519f3fbf3ba98f5e::consts::e_amount_out_too_low());
        ...
        (0x32f1dbfac1893fb6fd231c56a8092fb3692d725bc035d61519f3fbf3ba98f5e::consts::e_no_error(), v10, v11, v6, v7)
    }
    ...
    fun vbac_exact_in<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: bool, arg4: u64, arg5: u64, arg6: u128) : (u64, u64) {
        ...
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_swap_result_amount_calculated(&v0) < arg5) {
            return (0x32f1dbfac1893fb6fd231c56a8092fb3692d725bc035d61519f3fbf3ba98f5e::consts::e_amount_out_too_low(), 0)
        };
        if (arg3) {
            if (v1 > arg1) {
                return (0x32f1dbfac1893fb6fd231c56a8092fb3692d725bc035d61519f3fbf3ba98f5e::consts::e_insufficient_input_balance(), 0)
            };
        } else if (v1 > arg2) {
            return (0x32f1dbfac1893fb6fd231c56a8092fb3692d725bc035d61519f3fbf3ba98f5e::consts::e_insufficient_input_balance(), 0)
        };
        (0x32f1dbfac1893fb6fd231c56a8092fb3692d725bc035d61519f3fbf3ba98f5e::consts::e_no_error(), v1)
    }
