module 0x3f72e3f78f2df641411a694b92eef146837d2763668fa7d6935a08168ea49e4::cnsnft2419 {
    struct CNSNFT2419 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2419, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2419>(arg0, arg1);
