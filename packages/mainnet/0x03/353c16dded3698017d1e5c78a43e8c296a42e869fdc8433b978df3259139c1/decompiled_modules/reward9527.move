module 0x3353c16dded3698017d1e5c78a43e8c296a42e869fdc8433b978df3259139c1::reward9527 {
    struct REWARD9527 has drop {
        dummy_field: bool,
    }

    struct TICKET_9527 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9527(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9527>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9527>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9527, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9527>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9527>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9527>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9527>>(v5, 0x2::tx_context::sender(arg1));
    }
