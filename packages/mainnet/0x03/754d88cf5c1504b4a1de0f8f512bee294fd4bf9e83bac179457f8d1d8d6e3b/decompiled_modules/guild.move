module 0xcdd2b74ffd1271fd32ce2d6dd5954434eb9b962e44b82647f6af4ec98bd8a54a::guild {
    ...
    public fun set_max_check_in_days(arg0: &AdminCap, arg1: u64, arg2: &mut UserArchive) {
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg2.id, b"MAX_CHECKIN_DAYS_KEY")) {
            0x2::dynamic_field::add<vector<u8>, u64>(&mut arg2.id, b"MAX_CHECKIN_DAYS_KEY", arg1);
        } else {
            *0x2::dynamic_field::borrow_mut<vector<u8>, u64>(&mut arg2.id, b"MAX_CHECKIN_DAYS_KEY") = arg1;
        };
    }
