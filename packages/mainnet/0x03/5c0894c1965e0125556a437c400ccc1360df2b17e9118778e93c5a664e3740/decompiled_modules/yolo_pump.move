module 0x35c0894c1965e0125556a437c400ccc1360df2b17e9118778e93c5a664e3740::yolo_pump {
    ...
    public fun buy_returns_v2<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let v5 = 0x35c0894c1965e0125556a437c400ccc1360df2b17e9118778e93c5a664e3740::curves::calculate_add_liquidity_cost(v1.virtual_sui_reserves, v1.virtual_token_reserves, v3) + 1;
    ...
    public entry fun buy_v2<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = calculate_platform_fee(v3, arg0.platform_fee);
        let v6 = v3 - v5;
        assert!(v6 > 0, 2);
        let v7 = 0x1::u64::min(0x35c0894c1965e0125556a437c400ccc1360df2b17e9118778e93c5a664e3740::curves::calculate_token_amount_received(v2.virtual_sui_reserves, v2.virtual_token_reserves, v6), v4);
        assert!(v2.virtual_token_reserves >= v7, 8);
        let v8 = 0x35c0894c1965e0125556a437c400ccc1360df2b17e9118778e93c5a664e3740::curves::calculate_add_liquidity_cost(v2.virtual_sui_reserves, v2.virtual_token_reserves, v7);
        assert!(v3 >= v8 + v5, 6);
        let v9 = 0x2::coin::zero<T0>(arg3);
        let (v10, v11) = swap<T0>(v2, v9, arg1, v7, v3 - v8, arg3);
        let v12 = v11;
        let v13 = v10;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v12, v5, arg3), arg0.admin);
        if (v4 == v7 || 0x2::coin::value<0x2::sui::SUI>(&v2.real_sui_reserves) >= arg0.threshold) {
    ...
    fun calculate_platform_fee(arg0: u64, arg1: u64) : u64 {
        0x35c0894c1965e0125556a437c400ccc1360df2b17e9118778e93c5a664e3740::curves::mul_div(arg0, arg1, 10000)
    }
    ...
    public entry fun create_and_first_buy<T0>(arg0: &mut Configuration, arg1: 0x2::coin::TreasuryCap<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: 0x1::ascii::String, arg5: 0x1::ascii::String, arg6: 0x1::ascii::String, arg7: 0x1::ascii::String, arg8: 0x1::ascii::String, arg9: 0x1::ascii::String, arg10: 0x1::ascii::String, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<0x2::sui::SUI>(&arg2) > 0) {
            ...
            let v2 = calculate_platform_fee(v1, arg0.platform_fee);
            let v3 = v1 - v2;
            assert!(v3 > 0, 2);
            let v4 = 0x1::u64::min(0x35c0894c1965e0125556a437c400ccc1360df2b17e9118778e93c5a664e3740::curves::calculate_token_amount_received(v0.virtual_sui_reserves, v0.virtual_token_reserves, v3), arg0.initial_virtual_token_reserves - arg0.remain_token_reserves);
            assert!(v0.virtual_token_reserves >= v4, 8);
            let v5 = 0x35c0894c1965e0125556a437c400ccc1360df2b17e9118778e93c5a664e3740::curves::calculate_add_liquidity_cost(v0.virtual_sui_reserves, v0.virtual_token_reserves, v4);
            assert!(v1 >= v5 + v2, 6);
            let v6 = &mut v0;
            let v7 = 0x2::coin::zero<T0>(arg11);
            let (v8, v9) = swap<T0>(v6, v7, arg2, v4, v1 - v5, arg11);
            let v10 = v9;
            let v11 = v8;
            v0.virtual_token_reserves = v0.virtual_token_reserves - 0x2::coin::value<T0>(&v11);
            let v12 = 0x2::tx_context::sender(arg11);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v10, v12);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v11, v12);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v10, v2, arg11), arg0.admin);
            if (v4 == arg0.initial_virtual_token_reserves - arg0.remain_token_reserves || 0x2::coin::value<0x2::sui::SUI>(&v0.real_sui_reserves) >= arg0.threshold) {
                let v13 = &mut v0;
                transfer_pool<T0>(v13, arg3, arg11);
            };
        } else {
        ...
        let v15 = 0x1::type_name::get<Pool<T0>>();
        0x2::dynamic_object_field::add<0x1::ascii::String, Pool<T0>>(&mut arg0.id, 0x1::type_name::get_address(&v14), v0);
        let v16 = CreatedEvent{
            name                   : arg4,
            symbol                 : arg5,
            uri                    : arg6,
            description            : arg7,
            ...
            telegram               : arg9,
            website                : arg10,
            token_address          : 0x1::type_name::into_string(v14),
            bonding_curve          : 0x1::type_name::get_module(&v15),
            pool_id                : 0x2::object::id<Pool<T0>>(&v0),
        ...
        0x2::event::emit<CreatedEvent>(v16);
    }
    ...
    public fun estimate_amount_out<T0>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, Pool<T0>>(&mut arg0.id, 0x1::type_name::get_address(&v0));
        if (arg1 > 0 && arg2 == 0) {
            (0, 0x35c0894c1965e0125556a437c400ccc1360df2b17e9118778e93c5a664e3740::curves::calculate_token_amount_received(v1.virtual_sui_reserves, v1.virtual_token_reserves, arg1 - calculate_platform_fee(arg1, arg0.platform_fee)))
        } else if (arg1 == 0 && arg2 > 0) {
            let v4 = 0x35c0894c1965e0125556a437c400ccc1360df2b17e9118778e93c5a664e3740::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_sui_reserves, arg2);
    ...
    public entry fun sell<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3 > 0, 2);
        let v4 = 0x35c0894c1965e0125556a437c400ccc1360df2b17e9118778e93c5a664e3740::curves::calculate_remove_liquidity_return(v2.virtual_token_reserves, v2.virtual_sui_reserves, v3);
