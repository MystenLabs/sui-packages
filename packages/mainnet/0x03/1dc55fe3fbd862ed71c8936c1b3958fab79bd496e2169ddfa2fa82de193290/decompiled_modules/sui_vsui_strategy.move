        ...
        if (v0 >= v3) {
            ...
            while (0x2::balance::value<0x2::sui::SUI>(&arg11) < v1) {
                ...
                if (0x2::balance::value<0x2::sui::SUI>(&arg11) >= v6) {
                    ...
                    let (_, v10) = navi_repay_and_withdraw_collateral(arg0, arg4, arg5, arg6, arg7, arg8, arg9, arg10, v8, v2, arg13);
                    let v11 = v10;
                    abort 0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::native_pool::from_shares(arg1, arg2, 0x2::balance::value<0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::cert::CERT>(&v11))
                };
