module 0x35688b3c1afe312b6000fd99d352cd4c6c91d01043cdb39cf1c40dfa86435eb::cnsnft5605 {
    struct CNSNFT5605 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5605, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5605>(arg0, arg1);
