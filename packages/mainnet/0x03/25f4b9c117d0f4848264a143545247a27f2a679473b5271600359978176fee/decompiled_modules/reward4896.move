module 0x325f4b9c117d0f4848264a143545247a27f2a679473b5271600359978176fee::reward4896 {
    struct REWARD4896 has drop {
        dummy_field: bool,
    }

    struct TICKET_4896 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4896(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4896>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4896>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4896, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4896>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4896>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4896>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4896>>(v5, 0x2::tx_context::sender(arg1));
    }
