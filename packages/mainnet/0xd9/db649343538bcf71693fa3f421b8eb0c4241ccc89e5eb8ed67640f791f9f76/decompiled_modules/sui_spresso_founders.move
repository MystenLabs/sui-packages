module 0xd9db649343538bcf71693fa3f421b8eb0c4241ccc89e5eb8ed67640f791f9f76::sui_spresso_founders {
    struct SUI_SPRESSO_FOUNDERS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_SPRESSO_FOUNDERS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_SPRESSO_FOUNDERS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUI SPRESSO Founders"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A limited set of 50 NFTs honoring SPRESSO"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifw3qx43233keqfhrmytdtfq63lobgr4l6mh5pnlx4vubin4ufsvm"));
