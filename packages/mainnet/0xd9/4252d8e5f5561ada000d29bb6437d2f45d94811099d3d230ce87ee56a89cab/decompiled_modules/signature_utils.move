module 0xd94252d8e5f5561ada000d29bb6437d2f45d94811099d3d230ce87ee56a89cab::signature_utils {
    ...
    public fun encode_coin_type_name(arg0: 0x1::ascii::String) : vector<u8> {
        ...
        while (v2 < 0x1::vector::length<u8>(v0)) {
            0x1::vector::push_back<u8>(&mut v3, *0x1::vector::borrow<u8>(v0, v2));
            v2 = v2 + 1;
        };
        v3
    }

    public fun recover_signer(arg0: address, arg1: u64, arg2: u64, arg3: 0x1::ascii::String, arg4: u64, arg5: u64, arg6: vector<u8>) : vector<u8> {
