module 0xd9c6d780dde64ddbbeef54054c59c913e6ab53220e186373ca37f0c7a9e33a15::stonker {
    ...
    fun check_sender(arg0: &Stonker, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 13906834530825666559);
    }
    ...
    fun default_stonker_parameters() : StonkerParameters {
        StonkerParameters{
            ...
            order_size_step_base     : 500000000000,
            allowed_to_buy           : true,
    ...
    public fun input_signal(arg0: &mut Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: &0x2::clock::Clock, arg5: u64, arg6: bool, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg6 && v7 + v8 < arg5) {
            ...
            ensure_deep_balance(arg1, &v22, arg3, v23 * 2, arg4, arg8);
        ...
        if (!arg6 && arg5 + v8 < v6) {
            ...
            let v29 = (arg5 + v8 + v26 - 1) / v26 * v26;
            let v30 = arg0.parameters.minimum_order_size_base + 1000000 * (v6 - v8 - arg5) / v7 * arg0.parameters.order_size_step_base / 100;
            let v31 = v30;
            let v32 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0x2::sui::SUI>(arg1);
            if (v30 > v32) {
                v31 = v32;
            };
            let v33 = v31 / v27 * v27;
            if (v33 < arg0.parameters.minimum_order_size_base) {
                emit_could_not_trade_event(b"at_limit");
                return
            };
            if (v29 < arg0.parameters.minimum_sell_price_quote) {
                emit_could_not_trade_event(b"price_limit");
                return
            };
            if (0x2::clock::timestamp_ms(arg4) < arg0.last_trade_time_ms + arg0.parameters.cooldown_ms) {
            ...
            let v34 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg8);
            let (v35, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::get_order_deep_required<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, v33, v29);
            ensure_deep_balance(arg1, &v34, arg3, v35, arg4, arg8);
            let v37 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v34, 0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::immediate_or_cancel(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::self_matching_allowed(), v29, v33, false, true, 0x2::clock::timestamp_ms(arg4) + 1000, arg4, arg8);
            if (should_repeat_order(&v37)) {
                0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v34, 0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::immediate_or_cancel(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::self_matching_allowed(), v29, v33, false, true, 0x2::clock::timestamp_ms(arg4) + 1000, arg4, arg8);
            };
            arg0.last_trade_time_ms = 0x2::clock::timestamp_ms(arg4);
            return
