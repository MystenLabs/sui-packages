module 0x385f7a0aef8e472e657f2795a70ca9ae5752085c03c67b7807c6cc2b1cce448f::gachapon {
    ...
    struct SpecialTracker has copy, drop, store {
        epoch: u64,
    }

    struct BagTracker has store, key {
        id: 0x2::object::UID,
        bag: 0x2::bag::Bag,
    ...
    fun add_bag_tracker<T0>(arg0: &mut Gachapon<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = SpecialTracker{epoch: 0x2::tx_context::epoch(arg1)};
        if (0x2::dynamic_field::exists_<SpecialTracker>(&arg0.id, v0)) {
            return
        };
        let v1 = BagTracker{
        ...
        let v2 = SpecialTracker{epoch: 0x2::tx_context::epoch(arg1)};
        0x2::dynamic_field::add<SpecialTracker, BagTracker>(&mut arg0.id, v2, v1);
    }

    fun add_id_to_bag_tracker<T0>(arg0: &mut Gachapon<T0>, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        add_bag_tracker<T0>(arg0, arg2);
        let v0 = SpecialTracker{epoch: 0x2::tx_context::epoch(arg2)};
        let v1 = 0x2::dynamic_field::borrow_mut<SpecialTracker, BagTracker>(&mut arg0.id, v0);
        0x2::bag::add<0x2::object::ID, bool>(&mut v1.bag, arg1, true);
        0x1::vector::push_back<0x2::object::ID>(&mut v1.ids, arg1);
    }

    fun add_ids_to_bag_tracker<T0>(arg0: &mut Gachapon<T0>, arg1: &vector<0x2::object::ID>, arg2: &mut 0x2::tx_context::TxContext) {
        add_bag_tracker<T0>(arg0, arg2);
        let v0 = SpecialTracker{epoch: 0x2::tx_context::epoch(arg2)};
        let v1 = 0x2::dynamic_field::borrow_mut<SpecialTracker, BagTracker>(&mut arg0.id, v0);
        let v2 = 0;
        while (v2 < 0x1::vector::length<0x2::object::ID>(arg1)) {
            ...
            0x2::bag::add<0x2::object::ID, bool>(&mut v1.bag, *v3, true);
            0x1::vector::push_back<0x2::object::ID>(&mut v1.ids, *v3);
            v2 = v2 + 1;
        };
    }
    ...
    entry fun draw_free_spin<T0, T1: store + key>(arg0: &mut Gachapon<T0>, arg1: &T1, arg2: &0x2::random::Random, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = borrow_spinner_mut<T0>(arg0);
        if (!0x2::vec_set::contains<0x1::type_name::TypeName>(&v1.allowed_nfts, &v0)) {
            err_object_type_not_supported();
        };
        add_id_to_bag_tracker<T0>(arg0, 0x2::object::id<T1>(arg1), arg4);
        if (egg_supply<T0>(arg0) < 1) {
            err_egg_supply_not_enough();
        };
        let v2 = 0x2::random::new_generator(arg2, arg4);
        let v3 = ((0x2::random::generate_u256(&mut v2) % (egg_supply<T0>(arg0) as u256)) as u64);
        let v4 = 0x385f7a0aef8e472e657f2795a70ca9ae5752085c03c67b7807c6cc2b1cce448f::big_vector::swap_remove<Egg>(&mut arg0.lootbox, v3);
        let v5 = EggOutV2{
            gachapon_id       : 0x2::object::id<Gachapon<T0>>(arg0),
            egg_id            : 0x2::object::id<Egg>(&v4),
        ...
        0x2::event::emit<EggOutV2>(v5);
        0x2::transfer::transfer<Egg>(v4, arg3);
    }
    ...
    entry fun draw_free_spin_with_kiosk<T0, T1: store + key>(arg0: &mut Gachapon<T0>, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: vector<0x2::object::ID>, arg4: &0x2::random::Random, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        add_ids_to_bag_tracker<T0>(arg0, &arg3, arg6);
        while (0x1::vector::length<0x2::object::ID>(&arg3) > 0) {
            ...
            let v5 = ((0x2::random::generate_u256(&mut v4) % (egg_supply<T0>(arg0) as u256)) as u64);
            let v6 = 0x385f7a0aef8e472e657f2795a70ca9ae5752085c03c67b7807c6cc2b1cce448f::big_vector::swap_remove<Egg>(&mut arg0.lootbox, v5);
            let v7 = EggOutV2{
                gachapon_id       : 0x2::object::id<Gachapon<T0>>(arg0),
                egg_id            : 0x2::object::id<Egg>(&v6),
                egg_idx           : 0x1::option::some<u64>(v5),
                payment_coin_type : 0x1::type_name::get<0x2::sui::SUI>(),
                cost              : 0,
            };
            0x2::event::emit<EggOutV2>(v7);
            0x2::transfer::transfer<Egg>(v6, arg5);
        };
    }
    ...
    entry fun draw_free_spin_with_personal_kiosk<T0, T1: store + key>(arg0: &mut Gachapon<T0>, arg1: &0x2::kiosk::Kiosk, arg2: vector<0x2::object::ID>, arg3: &0x2::random::Random, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<0x2::object::ID>(&arg2) > 0) {
            ...
            0x2::event::emit<EggOutV2>(v7);
            0x2::transfer::transfer<Egg>(v6, arg4);
        };
    }
    ...
    public fun get_ids_of_current_epoch<T0>(arg0: &Gachapon<T0>, arg1: &0x2::tx_context::TxContext) : vector<0x2::object::ID> {
        let v0 = SpecialTracker{epoch: 0x2::tx_context::epoch(arg1)};
        0x2::dynamic_field::borrow<SpecialTracker, BagTracker>(&arg0.id, v0).ids
    }
