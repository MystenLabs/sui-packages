module 0xd9873fb9579c18bdf6dffb7de4c838989575df733e22fe25c3f85f61d46e6a88::wait_a_minute {
    struct WAIT_A_MINUTE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WAIT_A_MINUTE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WAIT_A_MINUTE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Wait a minute"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Wait a minute "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreif2wg23ezddlb7wbrwmyvvo6ac2zk56mwbedzhfi4lqki2clbb4he"));
