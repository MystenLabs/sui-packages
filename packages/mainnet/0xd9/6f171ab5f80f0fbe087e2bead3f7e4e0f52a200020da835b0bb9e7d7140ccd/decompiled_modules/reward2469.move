module 0xd96f171ab5f80f0fbe087e2bead3f7e4e0f52a200020da835b0bb9e7d7140ccd::reward2469 {
    struct REWARD2469 has drop {
        dummy_field: bool,
    }

    struct TICKET_2469 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2469(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2469>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2469>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2469, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2469>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2469>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2469>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2469>>(v5, 0x2::tx_context::sender(arg1));
    }
