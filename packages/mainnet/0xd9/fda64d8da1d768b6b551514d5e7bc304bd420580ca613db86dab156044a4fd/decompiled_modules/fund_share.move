module 0x82bfa7a6c43ae6ee446f053ba7064937c3da00b2c89c02ef565212943c56c74c::fund_share {
    ...
    public fun burn<T0>(arg0: &0x82bfa7a6c43ae6ee446f053ba7064937c3da00b2c89c02ef565212943c56c74c::config::GlobalConfig, arg1: BurnRequest<T0>, arg2: FundShare) {
    ...
    public(friend) fun create_burn_request<T0>(arg0: &0x82bfa7a6c43ae6ee446f053ba7064937c3da00b2c89c02ef565212943c56c74c::config::GlobalConfig, arg1: 0x2::object::ID, arg2: u64) : BurnRequest<T0> {
        0x82bfa7a6c43ae6ee446f053ba7064937c3da00b2c89c02ef565212943c56c74c::config::assert_if_version_not_matched(arg0, 1);
        BurnRequest<T0>{
            fund_id  : arg1,
            end_time : arg2,
    ...
    public(friend) fun create_mint_request<T0>(arg0: &0x82bfa7a6c43ae6ee446f053ba7064937c3da00b2c89c02ef565212943c56c74c::config::GlobalConfig, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x1::string::String, arg4: u64, arg5: u64) : MintRequest<T0> {
        0x82bfa7a6c43ae6ee446f053ba7064937c3da00b2c89c02ef565212943c56c74c::config::assert_if_version_not_matched(arg0, 1);
        MintRequest<T0>{
            fund_id       : arg1,
            trader        : arg2,
    ...
    public fun mint<T0>(arg0: &mut 0x82bfa7a6c43ae6ee446f053ba7064937c3da00b2c89c02ef565212943c56c74c::config::GlobalConfig, arg1: MintRequest<T0>, arg2: &mut 0x2::tx_context::TxContext) : FundShare {
        0x82bfa7a6c43ae6ee446f053ba7064937c3da00b2c89c02ef565212943c56c74c::config::assert_if_version_not_matched(arg0, 1);
        let MintRequest {
            fund_id       : v0,
            trader        : v1,
