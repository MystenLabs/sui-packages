module 0xd9563790b0d1f5c1452e9338aa2a5c07e852e1e7d4034f21b4c39380a5520213::reward9955 {
    struct REWARD9955 has drop {
        dummy_field: bool,
    }

    struct TICKET_9955 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9955(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9955>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9955>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9955, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9955>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9955>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9955>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9955>>(v5, 0x2::tx_context::sender(arg1));
    }
