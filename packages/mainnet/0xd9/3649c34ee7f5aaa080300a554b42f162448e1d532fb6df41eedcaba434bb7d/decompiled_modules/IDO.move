module 0xd93649c34ee7f5aaa080300a554b42f162448e1d532fb6df41eedcaba434bb7d::IDO {
    ...
    public entry fun claim_subscription<T0>(arg0: &mut IDO<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.whitelist_funded_amount + arg0.subscription_funded_amount <= arg0.hard_cap) {
            let v1 = *v0 * 150000 * 1000000 / 1000 * 1000000000;
            ...
            let v3 = *v0 * 150000 * (30000000000 as u128) * 1000000 / (arg0.subscription_funded_amount as u128) * 1000 * 1000000000;
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_balance, ((*v0 - *v0 * (30000000000 as u128) / (arg0.subscription_funded_amount as u128)) as u64)), arg2), 0x2::tx_context::sender(arg2));
