module 0xd9fda71a5e57c343816ab4165879852bec7c6bb70fa9a0473eded29794617290::reward7516 {
    struct REWARD7516 has drop {
        dummy_field: bool,
    }

    struct TICKET_7516 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7516(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7516>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7516>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7516, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7516>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7516>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7516>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7516>>(v5, 0x2::tx_context::sender(arg1));
    }
