module 0xd9c5740eb3089874cf7272837972aa1c2b6c5d86fd80ef4e9b3084194dc4b3a5::reward1668 {
    struct REWARD1668 has drop {
        dummy_field: bool,
    }

    struct TICKET_1668 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1668(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1668>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1668>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1668, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1668>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1668>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1668>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1668>>(v5, 0x2::tx_context::sender(arg1));
    }
