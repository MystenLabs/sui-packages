module 0xd988547fe9946e4b77565ac26a647cb9ff627696c733a1074023d29e516c6817::mycoin {
    struct MYCOIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: MYCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MYCOIN>(arg0, 6, b"MYCOIN", b"mc", b"", 0x1::option::none<0x2::url::Url>(), arg1);
