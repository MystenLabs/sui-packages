module 0xd9cb403ff866b11909cc447e1feb1f0e728203797567dcdf1505fda9b4d11e0c::cnsnft3149 {
    struct CNSNFT3149 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3149, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3149>(arg0, arg1);
