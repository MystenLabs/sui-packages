module 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_utils {
    ...
    public fun calc_gem_upgrade_rating(arg0: u64, arg1: u64) : u64 {
        calc_power(arg0, 2 * (arg1 + 1), 1000000)
    }

    fun calc_power(arg0: u64, arg1: u64, arg2: u64) : u64 {
        if (arg1 == 0) {
            return arg2
        };
        if (arg0 == 0) {
        ...
        while (arg1 > 0) {
            if (arg1 % 2 == 1) {
                assert!(v0 <= 18446744073709551615 / arg0, 0);
                let v1 = v0 * arg0;
                v0 = v1 / arg2;
            };
            let v2 = arg0 * arg0;
