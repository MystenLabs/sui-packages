module 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_boss_cave {
    ...
    entry fun batch_claim_boss_cave_reward<T0: store>(arg0: &mut BossCaves, arg1: vector<0x2::object::ID>, arg2: &0x2::clock::Clock, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<0x2::object::ID>(&arg1)) {
            claim_reward_internal<T0>(arg0, 0x1::vector::pop_back<0x2::object::ID>(&mut arg1), arg3, arg4);
            v0 = v0 + 1;
        };
    ...
    entry fun claim_boss_cave_reward<T0: store>(arg0: &mut BossCaves, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.boss_status == 1, 101);
        assert!(0x2::clock::timestamp_ms(arg2) > arg0.defeat_time, 101);
        claim_reward_internal<T0>(arg0, arg1, arg3, arg4);
    }

    fun claim_reward_internal<T0: store>(arg0: &mut BossCaves, arg1: 0x2::object::ID, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
