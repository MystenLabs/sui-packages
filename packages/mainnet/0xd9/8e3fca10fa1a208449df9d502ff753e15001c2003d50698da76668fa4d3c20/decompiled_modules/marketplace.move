module 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::marketplace {
    ...
    struct Marketplace has key {
        id: 0x2::object::UID,
        balance: 0x2::balance::Balance<0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dgg_token::DGG_TOKEN>,
    ...
    public fun admin_init_market(arg0: &0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_resident::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Marketplace{
            ...
            balance            : 0x2::balance::zero<0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dgg_token::DGG_TOKEN>(),
    ...
    public fun buy<T0: store + key>(arg0: &mut Marketplace, arg1: &mut 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dgg_token::DungeonVault, arg2: &mut 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_resident::DungeonState, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0x2::coin::Coin<0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dgg_token::DGG_TOKEN>, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 0);
        let v0 = &mut arg0.listing;
        let v1 = remove_listing(v0, arg4, arg3);
        ...
        assert!(0x2::coin::value<0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dgg_token::DGG_TOKEN>(arg5) == v5, 2);
        assert!(v6 == arg3, 3);
        let v7 = 0x2::dynamic_field::borrow_mut<u8, TradeInfo>(&mut arg0.id, 0);
        v7.total_volume = v7.total_volume + v5;
        let v8 = v5 * arg0.fee / 1000;
        v7.total_burned = v7.total_burned + v8;
        0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_resident::internal_burn_counter(arg2, v8);
        0x2::pay::split_and_transfer<0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dgg_token::DGG_TOKEN>(arg5, v5 - v8, v4, arg6);
        0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dgg_token::internal_burn(arg1, 0x2::coin::split<0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dgg_token::DGG_TOKEN>(arg5, v8, arg6));
        ...
        0x2::transfer::public_transfer<T0>(0x2::dynamic_object_field::remove<0x2::object::ID, T0>(&mut arg0.id, v6), 0x2::tx_context::sender(arg6));
        let v12 = BuyEvent{
            listing_id      : v2,
            dungeon_item_id : v6,
            seller          : v4,
