module 0xd9946d8e6efd4724e1e57a0c568a36e7592002394d74e9f9b2bd73162337dbec::xpnp {
    struct XPNP has drop {
        dummy_field: bool,
    }

    public entry fun burn(arg0: &mut 0x2::coin::TreasuryCap<XPNP>, arg1: 0x2::coin::Coin<XPNP>) {
        0x2::coin::burn<XPNP>(arg0, arg1);
    }
    ...
    public entry fun mint_to_recipient(arg0: &mut 0x2::coin::TreasuryCap<XPNP>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<XPNP>>(0x2::coin::mint<XPNP>(arg0, arg1, arg3), arg2);
    }
