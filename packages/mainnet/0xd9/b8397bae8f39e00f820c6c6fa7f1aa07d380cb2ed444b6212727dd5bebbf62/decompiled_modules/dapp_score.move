module 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::dapp_score {
    ...
    public fun add_dapp_admin(arg0: &mut DappScoreManager, arg1: &mut DappConfig, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x1::vector::contains<address>(&arg1.admins, &arg2), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::duplicated_error());
    ...
    public fun add_super_admin(arg0: &mut DappScoreManager, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x1::vector::contains<address>(&arg0.admins, &arg1), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::duplicated_error());
    ...
    public fun assert_is_dapp_admin(arg0: &DappConfig, arg1: address) {
        assert!(is_dapp_admin(arg0, arg1), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
    }

    public fun assert_is_super_admin(arg0: &DappScoreManager, arg1: address) {
        assert!(is_super_admin(arg0, &arg1), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
    }

    public fun assert_target_exist(arg0: &DappConfig, arg1: 0x1::string::String) {
        assert!(target_exist(arg0, arg1), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::target_not_exist_error());
    }

    public fun assert_target_name_is_not_reserved(arg0: &0x1::string::String) {
        assert!(0x1::string::length(arg0) < 9 || 0x1::string::sub_string(arg0, 0, 10) != 0x1::string::utf8(b"referral__"), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
    }

    public fun assert_target_not_exist(arg0: &DappConfig, arg1: 0x1::string::String) {
        assert!(!target_exist(arg0, arg1), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::duplicated_error());
    }

    public fun assert_user_dapp_score_object_exist(arg0: &DappScoreManager, arg1: address, arg2: 0x1::string::String) {
        assert!(is_user_dapp_score_object_exist(arg0, arg1, arg2), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_exist_error());
    }

    public fun assert_user_dapp_score_object_not_exist(arg0: &DappScoreManager, arg1: address, arg2: 0x1::string::String) {
        assert!(!is_user_dapp_score_object_exist(arg0, arg1, arg2), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::has_exist_error());
    }

    public fun assert_valid_updater(arg0: &UpdaterConfig, arg1: address) {
        assert!(arg0.valid, 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::updater_expired_error());
        assert!(is_updater(arg0, arg1), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
    }

    fun assert_weight_is_not_immutable(arg0: &DappConfig, arg1: 0x1::string::String) {
        assert!(!weight_is_immutable(arg0, arg1), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
    }
    ...
    fun check_dapp_score_manager_version(arg0: &DappScoreManager) {
        assert!(arg0.version == 1, 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::wrong_version_error());
    }
    ...
    public fun create_referrer_dapp_score_object_by_updater(arg0: &UpdaterConfig, arg1: &mut DappScoreManager, arg2: &DappScoreUpadteRequest, arg3: &mut 0x2::tx_context::TxContext) : UserDappScore {
        ...
        assert!(arg2.referrer != 0x1::option::none<address>(), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
    ...
    public fun create_user_dapp_score_object_with_referrer_by_updater(arg0: &UpdaterConfig, arg1: &mut DappScoreManager, arg2: &DappScoreUpadteRequest, arg3: &mut UserDappScore, arg4: &mut 0x2::tx_context::TxContext) : UserDappScore {
        ...
        assert!(arg2.referrer == 0x1::option::some<address>(arg3.user), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
    ...
    public fun increase_user_dapp_score_by_updater(arg0: &UpdaterConfig, arg1: &mut UserDappScore, arg2: &DappScoreUpadteRequest, arg3: 0x1::string::String, arg4: u256, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1.user == arg2.user, 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
    ...
    public fun increase_user_dapp_score_with_referrer_by_updater(arg0: &UpdaterConfig, arg1: &mut UserDappScore, arg2: &mut UserDappScore, arg3: &DappScoreUpadteRequest, arg4: 0x1::string::String, arg5: u256, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg3.referrer == 0x1::option::some<address>(arg2.user), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
        assert!(arg1.user == arg3.user, 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
    ...
    fun internal_add_admin_dapp_map(arg0: &mut DappScoreManager, arg1: address, arg2: 0x1::string::String) {
        if (0x2::table::contains<address, AdminDappMapWrapper>(&arg0.admin_dapp_map, arg1)) {
            ...
            assert!(!0x1::vector::contains<0x1::string::String>(&v0.dapps, &arg2), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::duplicated_error());
    ...
    fun internal_create_dapp_config(arg0: &mut DappScoreManager, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) : DappConfig {
        ...
        assert!(!0x2::table::contains<0x1::string::String, 0x2::object::ID>(&arg0.dapp_config_map, arg1), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::duplicated_error());
    ...
    fun internal_create_user_dapp_score_object(arg0: &mut DappScoreManager, arg1: address, arg2: 0x1::string::String, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) : UserDappScore {
        check_dapp_score_manager_version(arg0);
        assert!(!is_user_dapp_score_object_exist(arg0, arg1, arg2), 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::duplicated_user_dapp_score_object_error());
    ...
    fun internal_remove_admin_dapp_map(arg0: &mut DappScoreManager, arg1: address, arg2: 0x1::string::String) {
        ...
        assert!(v1, 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_exist_error());
    ...
    fun internal_update_user_dapp_score_object(arg0: &mut UserDappScore, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u256, arg4: bool, arg5: bool, arg6: bool) {
        assert!(arg0.dapp == arg1, 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
        let v0 = if (!0x2::table::contains<0x1::string::String, ScoreTableItem>(&arg0.score_table, arg2)) {
            assert!(!arg4, 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::target_not_exist_error());
            ...
            let v0 = if (arg4) {
                assert!(v2.score >= arg3, 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::score_under_zero_error());
                v2.score - arg3
            } else {
                v2.score + arg3
            };
    ...
    public fun remove_dapp_admin(arg0: &mut DappScoreManager, arg1: &mut DappConfig, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert_is_dapp_admin(arg1, 0x2::tx_context::sender(arg3));
        assert!(0x1::vector::length<address>(&arg1.admins) > 1 && v0, 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
    ...
    public fun remove_super_admin(arg0: &mut DappScoreManager, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 && 0x1::vector::length<address>(&arg0.admins) > 1, 0xd9b8397bae8f39e00f820c6c6fa7f1aa07d380cb2ed444b6212727dd5bebbf62::error::not_authorized_error());
