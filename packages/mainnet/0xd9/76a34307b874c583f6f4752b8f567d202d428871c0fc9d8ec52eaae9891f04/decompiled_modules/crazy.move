module 0xd976a34307b874c583f6f4752b8f567d202d428871c0fc9d8ec52eaae9891f04::crazy {
    ...
    fun init(arg0: CRAZY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<CRAZY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"CRAZY     ")))), trim_right(b"CRAZY                           "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
