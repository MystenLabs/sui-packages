module 0xd94b5cca3b5d36d6d4cfa1bb4963c7f3380151d4b1e67a29da7dac9612725c54::reward9424 {
    struct REWARD9424 has drop {
        dummy_field: bool,
    }

    struct TICKET_9424 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9424(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9424>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9424>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9424, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9424>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9424>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9424>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9424>>(v5, 0x2::tx_context::sender(arg1));
    }
