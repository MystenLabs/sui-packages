module 0xd938eca5b9dc7f453111303e1a1db4928fd73ba858e41c4376d5d5d70eb33a8a::project_manager {
    ...
    public entry fun initialize_project_manager<T0>(arg0: &0xd938eca5b9dc7f453111303e1a1db4928fd73ba858e41c4376d5d5d70eb33a8a::launchpad_manager_config::LaunchAdmin, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: &ProjectManagerConfig, arg6: &mut 0x2::tx_context::TxContext) {
        assert_version(arg5);
    ...
    public fun make_project_failed<T0>(arg0: &mut ProjectManager<T0>, arg1: &0xd938eca5b9dc7f453111303e1a1db4928fd73ba858e41c4376d5d5d70eb33a8a::launchpad_manager_config::LaunchAdmin) {
        arg0.status = 2;
    }
    ...
    public fun project_falied<T0>(arg0: &mut ProjectManager<T0>, arg1: &0xd938eca5b9dc7f453111303e1a1db4928fd73ba858e41c4376d5d5d70eb33a8a::launchpad_manager_config::LaunchAdmin) {
