module 0xd9df037aae6a34ead103f6fabb214b814d2c2865e6fc416f5253a26f09ac1775::sudoz {
    ...
    fun init(arg0: SUDOZ, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUDOZ>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUDOZ"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"An evolved form of the  artifact with unique traits"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://hnwEweDmv9Xeg4pdKBA258NKfTYdro18oCa7BmOjrtM"));
