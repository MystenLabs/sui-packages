module 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags {
    ...
    struct FeesBackingRouted has copy, drop, store {
        token_address: 0x1::ascii::String,
        backing_wallet: address,
        sui_to_backing: u64,
        token_burned: u64,
        ts: u64,
    }
    ...
    fun apply_backing_split<T0>(arg0: &0x2::object::UID, arg1: 0x1::ascii::String, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        if (!0x2::dynamic_field::exists_<vector<u8>>(arg0, b"backing_wallet")) {
            return
        };
        let v0 = *0x2::dynamic_field::borrow<vector<u8>, address>(arg0, b"backing_wallet");
        let v1 = 0x2::coin::value<0x2::sui::SUI>(arg3) * 7000 / 10000;
        let v2 = 0x2::coin::value<T0>(arg2) * 7000 / 10000;
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg3, v1, arg5), v0);
        };
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg2, v2, arg5), @0x0);
        };
        let v3 = FeesBackingRouted{
            token_address  : arg1,
            backing_wallet : v0,
            sui_to_backing : v1,
            token_burned   : v2,
        ...
        0x2::event::emit<FeesBackingRouted>(v3);
    }
    ...
    fun buy_direct<T0>(arg0: address, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut Pool<T0>, arg3: u64, arg4: u64, arg5: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg8: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg9: &0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_token_lock::Configuration, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::curves::calculate_add_liquidity_cost(arg2.virtual_sui_reserves, arg2.virtual_token_reserves, v2) + 1;
        let v4 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v3), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg4)), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(10000)));
        assert!(v0 >= v3 + v4, 5);
        ...
        if (arg10 == 0) {
            ...
            0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_token_lock::create_lock<T0>(arg9, v8, 0x2::tx_context::sender(arg12), 0x2::coin::value<T0>(&v8), 0x2::clock::timestamp_ms(arg11) + arg10, arg11, arg12);
        };
        if (v1 == v2) {
    ...
    public fun buy_exact_in_returns_with_lock<T0>(arg0: &mut Configuration, arg1: &0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_token_lock::Configuration, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg8: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let v3 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::curves::calculate_remove_liquidity_return(v2.virtual_sui_reserves, v2.virtual_token_reserves, arg3);
        let v4 = v2.virtual_token_reserves - get_virtual_remain_token_reserves<T0>(v2);
        let (v5, v6) = if (v3 > v4) {
            let v6 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::curves::calculate_add_liquidity_cost(v2.virtual_sui_reserves, v2.virtual_token_reserves, v4) + 1;
            (v4, v6)
        } else {
            (v3, arg3)
        };
        assert!(v5 >= arg4, 1);
        let v7 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v6), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.platform_fee)), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(10000)));
        ...
        if (0x2::dynamic_field::exists_<vector<u8>>(&v2.id, b"pool_creation_timestamp")) {
            ...
            if (v13 - *0x2::dynamic_field::borrow<vector<u8>, u64>(&v2.id, b"pool_creation_timestamp") < *0x2::dynamic_field::borrow<vector<u8>, u64>(&arg0.id, b"buy_block_duration")) {
                let v14 = v11;
                0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_token_lock::create_lock<T0>(arg1, v14, 0x2::tx_context::sender(arg10), 0x2::coin::value<T0>(&v14), v13 + *0x2::dynamic_field::borrow<vector<u8>, u64>(&arg0.id, b"lock_buy_duration"), arg9, arg10);
    ...
    fun calculate_init_sui_reserves(arg0: &Configuration, arg1: u64) : u64 {
        ...
        assert!(v1 > v0, 1);
        0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg1), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v0)), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v1 - v0)))
    }
    ...
    public entry fun create_and_lock_first_buy_with_fee<T0>(arg0: &mut Configuration, arg1: &mut 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::Configuration, arg2: &0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_token_lock::Configuration, arg3: 0x2::coin::TreasuryCap<T0>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u8, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: u64, arg8: 0x1::option::Option<u64>, arg9: u64, arg10: &0x2::clock::Clock, arg11: 0x1::ascii::String, arg12: 0x1::ascii::String, arg13: 0x1::ascii::String, arg14: 0x1::ascii::String, arg15: 0x1::ascii::String, arg16: 0x1::ascii::String, arg17: 0x1::ascii::String, arg18: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg19: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg20: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg21: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg22: 0x2::coin::CoinMetadata<T0>, arg23: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg4) >= arg0.pool_creation_fee, 1);
        assert_version(arg0.version);
        assert!(0x2::coin::total_supply<T0>(&arg3) == 0, 6);
        let v0 = 0x1::option::get_with_default<u64>(&arg8, 2000000000000);
        assert!(v0 >= 100000000000, 1);
        if (arg9 > 0) {
        ...
        let v1 = Pool<T0>{
            ...
            virtual_token_reserves      : 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.initial_virtual_token_reserves), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.initial_virtual_token_reserves)), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.initial_virtual_token_reserves - arg0.remain_token_reserves))),
        ...
        0x2::dynamic_field::add<vector<u8>, u64>(&mut v1.id, b"virtual_token_reserves", 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.remain_token_reserves), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.initial_virtual_token_reserves)), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.initial_virtual_token_reserves - arg0.remain_token_reserves))));
        ...
        0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::initialize_staking_pool<T0>(arg1, arg10, arg23);
        0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::initialize_creator_pool<T0>(arg1, 0x2::tx_context::sender(arg23), arg10, arg23);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg4, arg0.pool_creation_fee, arg23), arg0.fee_platform_recipient);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg4, 0x2::tx_context::sender(arg23));
    }

    public entry fun create_and_lock_first_buy_with_fee_margin_backed<T0>(arg0: &mut Configuration, arg1: &mut 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::Configuration, arg2: &0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_token_lock::Configuration, arg3: 0x2::coin::TreasuryCap<T0>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u8, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: u64, arg8: 0x1::option::Option<u64>, arg9: u64, arg10: &0x2::clock::Clock, arg11: 0x1::ascii::String, arg12: 0x1::ascii::String, arg13: 0x1::ascii::String, arg14: 0x1::ascii::String, arg15: 0x1::ascii::String, arg16: 0x1::ascii::String, arg17: 0x1::ascii::String, arg18: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg19: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg20: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg21: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg22: 0x2::coin::CoinMetadata<T0>, arg23: address, arg24: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::ascii::length(&arg13) <= 300, 1);
        assert!(0x1::ascii::length(&arg14) <= 1000, 1);
        assert!(0x1::ascii::length(&arg15) <= 500, 1);
        assert!(0x1::ascii::length(&arg16) <= 500, 1);
        ...
        let v1 = Pool<T0>{
            ...
            real_sui_reserves           : 0x2::coin::zero<0x2::sui::SUI>(arg24),
            real_token_reserves         : 0x2::coin::mint<T0>(&mut arg3, arg0.initial_virtual_token_reserves, arg24),
            virtual_token_reserves      : 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.initial_virtual_token_reserves), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.initial_virtual_token_reserves)), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.initial_virtual_token_reserves - arg0.remain_token_reserves))),
            virtual_sui_reserves        : calculate_init_sui_reserves(arg0, v0),
            remain_token_reserves       : 0x2::coin::mint<T0>(&mut arg3, arg0.remain_token_reserves, arg24),
            fee_recipient               : 0x2::coin::zero<0x2::sui::SUI>(arg24),
            is_completed                : false,
            platform_fee_withdraw       : arg0.init_platform_fee_withdraw,
            creator_fee_withdraw        : arg0.init_creator_fee_withdraw,
            stake_fee_withdraw          : arg0.init_stake_fee_withdraw,
        ...
        0x2::dynamic_field::add<vector<u8>, u64>(&mut v1.id, b"fee_lock_time", 0x2::clock::timestamp_ms(arg10) + 300000);
        0x2::dynamic_field::add<vector<u8>, u64>(&mut v1.id, b"pool_creation_timestamp", 0x2::clock::timestamp_ms(arg10));
        0x2::dynamic_field::add<vector<u8>, address>(&mut v1.id, b"backing_wallet", arg23);
        let v3 = 0x1::type_name::get<T0>();
        let v4 = 0x1::type_name::get<Pool<T0>>();
        let v5 = CreatedEventV2{
            name                        : arg11,
            ...
            bonding_curve               : 0x1::type_name::get_module(&v4),
            pool_id                     : 0x2::object::id<Pool<T0>>(&v1),
            created_by                  : 0x2::tx_context::sender(arg24),
            virtual_sui_reserves        : v1.virtual_sui_reserves,
            virtual_token_reserves      : v1.virtual_token_reserves,
            real_sui_reserves           : 0x2::coin::value<0x2::sui::SUI>(&v1.real_sui_reserves),
            real_token_reserves         : 0x2::coin::value<T0>(&v1.real_token_reserves),
        ...
        if (0x2::coin::value<0x2::sui::SUI>(&arg6) > 0) {
            let v6 = &mut v1;
            buy_direct<T0>(arg0.admin, arg6, v6, arg7, arg0.platform_fee, arg18, arg19, arg20, arg21, arg2, arg9, arg10, arg24);
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(arg6);
        };
        0x2::dynamic_object_field::add<0x1::ascii::String, Pool<T0>>(&mut arg0.id, 0x1::type_name::get_address(&v3), v1);
        0x2::event::emit<CreatedEventV2>(v5);
        0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::initialize_staking_pool<T0>(arg1, arg10, arg24);
        0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::initialize_creator_pool<T0>(arg1, arg23, arg10, arg24);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg4, arg0.pool_creation_fee, arg24), arg0.fee_platform_recipient);
    ...
    public entry fun create_with_fee<T0>(arg0: &mut Configuration, arg1: &mut 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::Configuration, arg2: 0x2::coin::TreasuryCap<T0>, arg3: 0x2::coin::CoinMetadata<T0>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u8, arg6: 0x1::option::Option<u64>, arg7: &0x2::clock::Clock, arg8: 0x1::ascii::String, arg9: 0x1::ascii::String, arg10: 0x1::ascii::String, arg11: 0x1::ascii::String, arg12: 0x1::ascii::String, arg13: 0x1::ascii::String, arg14: 0x1::ascii::String, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x1::option::get_with_default<u64>(&arg6, 2000000000000);
        assert!(v0 >= 100000000000, 1);
        let v1 = Pool<T0>{
        ...
        0x2::dynamic_object_field::add<0x1::ascii::String, Pool<T0>>(&mut arg0.id, 0x1::type_name::get_address(&v3), v1);
        0x2::event::emit<CreatedEventV2>(v5);
        0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::initialize_staking_pool<T0>(arg1, arg7, arg15);
        0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::initialize_creator_pool<T0>(arg1, 0x2::tx_context::sender(arg15), arg7, arg15);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg4, arg0.pool_creation_fee, arg15), arg0.fee_platform_recipient);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg4, 0x2::tx_context::sender(arg15));
    }

    fun distribute_fees<T0, T1>(arg0: &mut Pool<T0>, arg1: address, arg2: u16, arg3: u16, arg4: u16, arg5: u16, arg6: &mut 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::Configuration, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v0), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64((arg2 as u64))), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(10000)));
        let v2 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v0), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64((arg3 as u64))), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(10000)));
        let v3 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v0), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64((arg4 as u64))), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(10000)));
        let v4 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v0), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64((arg5 as u64))), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(10000)));
        assert!(v1 + v2 + v3 + v4 <= v0, 10);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v1, arg8), arg1);
        0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::deposit_creator_pool<T0>(arg6, 0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v2, arg8), arg7, arg8);
        0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::update_reward_index<T0>(arg6, 0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v3, arg8), arg7, arg8);
        0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::update_reward_index<T1>(arg6, 0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v4, arg8), arg7, arg8);
        let v5 = 0x2::coin::value<0x2::sui::SUI>(&arg0.fee_recipient);
        if (v5 > 1000) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v5, arg8), @0xdb7989b98d681455f424035e3f01c02e27f738fdd6634ef34dedf576a9d8cea);
        };
    }

    fun distribute_fees_margin_backed<T0, T1>(arg0: &mut Pool<T0>, arg1: address, arg2: address, arg3: u16, arg4: u16, arg5: u16, arg6: u16, arg7: &mut 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::Configuration, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"fee_lock_time")) {
            assert!(0x2::clock::timestamp_ms(arg8) >= *0x2::dynamic_field::borrow<vector<u8>, u64>(&arg0.id, b"fee_lock_time"), 11);
        };
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0.fee_recipient);
        if (v0 <= 10000) {
            return
        ...
        let v2 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v0), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64((arg4 as u64))), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(10000)));
        let v3 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v0), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64((arg5 as u64))), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(10000)));
        let v4 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v0), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64((arg6 as u64))), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(10000)));
        assert!(v1 + v2 + v3 + v4 <= v0, 10);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v1, arg9), arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v2, arg9), arg2);
        0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::update_reward_index<T0>(arg7, 0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v3, arg9), arg8, arg9);
        0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::update_reward_index<T1>(arg7, 0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v4, arg9), arg8, arg9);
        let v5 = 0x2::coin::value<0x2::sui::SUI>(&arg0.fee_recipient);
        if (v5 > 1000) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg0.fee_recipient, v5, arg9), @0xdb7989b98d681455f424035e3f01c02e27f738fdd6634ef34dedf576a9d8cea);
        };
    }
    ...
    public fun early_complete_pool<T0>(arg0: &AdminCap, arg1: &mut Configuration, arg2: &mut ThresholdConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 >= arg2.threshold) {
            ...
            if (v2 >= arg2.threshold + v6) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v3, v6, arg4), arg1.treasury);
            };
    ...
    public fun estimate_amount_out<T0>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, Pool<T0>>(&mut arg0.id, 0x1::type_name::get_address(&v0));
        if (arg1 > 0 && arg2 == 0) {
            (0, 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::curves::calculate_token_amount_received(v1.virtual_sui_reserves, v1.virtual_token_reserves, arg1 - 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg1), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.platform_fee)), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(10000)))))
        } else if (arg1 == 0 && arg2 > 0) {
            let v4 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_sui_reserves, arg2);
            (v4 - 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v4), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.platform_fee)), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(10000))), 0)
        } else {
            (0, 0)
        }
    }
    ...
    public entry fun sell<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 > 0, 1);
        let v3 = 0x1::u64::min(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_sui_reserves, v2), 0x2::coin::value<0x2::sui::SUI>(&v1.real_sui_reserves));
        let v4 = 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::as_u64(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::div(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::mul(0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(v3), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(arg0.platform_fee)), 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::utils::from_u64(10000)));
        assert!(v3 - v4 >= arg2, 1);
    ...
    public fun withdraw_fee_bonding_curve<T0, T1>(arg0: &mut Configuration, arg1: &mut 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::Configuration, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
    ...
    public fun withdraw_fee_bonding_curve_margin_backed<T0, T1>(arg0: &mut Configuration, arg1: &mut 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::Configuration, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
        assert!(0x1::type_name::into_string(0x1::type_name::get<T1>()) == arg0.token_platform_type_name, 5);
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, Pool<T0>>(&mut arg0.id, 0x1::type_name::get_address(&v0));
        assert!(0x2::dynamic_field::exists_<vector<u8>>(&v1.id, b"backing_wallet"), 9);
        let v2 = *0x2::dynamic_field::borrow<vector<u8>, address>(&v1.id, b"backing_wallet");
        distribute_fees_margin_backed<T0, T1>(v1, arg0.fee_platform_recipient, v2, 2000, 5000, 1000, 2000, arg1, arg2, arg3);
    }

    public fun withdraw_fee_cetus<T0, T1>(arg0: &mut Configuration, arg1: &mut 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::Configuration, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
        assert!(0x1::type_name::into_string(0x1::type_name::get<T1>()) == arg0.token_platform_type_name, 5);
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x1::type_name::get_address(&v0);
        let v2 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, Pool<T0>>(&mut arg0.id, v1);
        assert!(v2.is_completed, 9);
        assert!(0x2::dynamic_object_field::exists_<vector<u8>>(&v2.id, b"burn_proof"), 9);
        let (v3, v4) = 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::collect_fee<T0, 0x2::sui::SUI>(arg2, arg3, arg4, 0x2::dynamic_object_field::borrow_mut<vector<u8>, 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::CetusLPBurnProof>(&mut v2.id, b"burn_proof"), arg6);
        let v5 = v4;
        let v6 = v3;
        let v7 = &mut v6;
        let v8 = &mut v5;
        apply_backing_split<T0>(&v2.id, v1, v7, v8, arg5, arg6);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v6, arg0.treasury);
        0x2::coin::join<0x2::sui::SUI>(&mut v2.fee_recipient, v5);
        distribute_fees<T0, T1>(v2, arg0.fee_platform_recipient, arg0.init_platform_fee_withdraw, arg0.init_creator_fee_withdraw, arg0.init_stake_fee_withdraw, arg0.init_platform_stake_fee_withdraw, arg1, arg5, arg6);
    }

    public fun withdraw_fee_turbos_sui_after<T0, T1, T2>(arg0: &mut Configuration, arg1: &mut 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::Configuration, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, 0x2::sui::SUI, T2>, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg9: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
        assert!(0x1::type_name::into_string(0x1::type_name::get<T1>()) == arg0.token_platform_type_name, 5);
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x1::type_name::get_address(&v0);
        let v2 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, Pool<T0>>(&mut arg0.id, v1);
        assert!(v2.is_completed, 9);
        assert!(0x2::dynamic_object_field::exists_<vector<u8>>(&v2.id, b"turbos_burn_proof"), 9);
        let (v3, v4) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::burn_nft_collect_fee_with_return_<T0, 0x2::sui::SUI, T2>(arg2, arg3, 0x2::dynamic_object_field::borrow_mut<vector<u8>, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::TurbosPositionBurnNFT>(&mut v2.id, b"turbos_burn_proof"), arg4, arg5, arg6, arg7, arg8, arg9);
        let v5 = v4;
        let v6 = v3;
        let v7 = &mut v6;
        let v8 = &mut v5;
        apply_backing_split<T0>(&v2.id, v1, v7, v8, arg7, arg9);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v6, arg0.treasury);
        0x2::coin::join<0x2::sui::SUI>(&mut v2.fee_recipient, v5);
        distribute_fees<T0, T1>(v2, arg0.fee_platform_recipient, arg0.init_platform_fee_withdraw, arg0.init_creator_fee_withdraw, arg0.init_stake_fee_withdraw, arg0.init_platform_stake_fee_withdraw, arg1, arg7, arg9);
    }

    public fun withdraw_fee_turbos_sui_first<T0, T1, T2>(arg0: &mut Configuration, arg1: &mut 0xc5e89db7227f4b18cb40bbfd6dcde3aea8f47d8aa09a009b4f6d3d6ccaa6ff72::moonbags_stake::Configuration, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<0x2::sui::SUI, T0, T2>, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg9: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
        assert!(0x1::type_name::into_string(0x1::type_name::get<T1>()) == arg0.token_platform_type_name, 5);
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x1::type_name::get_address(&v0);
        ...
        assert!(v2.is_completed, 9);
        assert!(0x2::dynamic_object_field::exists_<vector<u8>>(&v2.id, b"turbos_burn_proof"), 9);
        let (v3, v4) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::burn_nft_collect_fee_with_return_<0x2::sui::SUI, T0, T2>(arg2, arg3, 0x2::dynamic_object_field::borrow_mut<vector<u8>, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::TurbosPositionBurnNFT>(&mut v2.id, b"turbos_burn_proof"), arg4, arg5, arg6, arg7, arg8, arg9);
        let v5 = v4;
        let v6 = v3;
        let v7 = &mut v5;
        let v8 = &mut v6;
        apply_backing_split<T0>(&v2.id, v1, v7, v8, arg7, arg9);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v5, arg0.treasury);
        0x2::coin::join<0x2::sui::SUI>(&mut v2.fee_recipient, v6);
        distribute_fees<T0, T1>(v2, arg0.fee_platform_recipient, arg0.init_platform_fee_withdraw, arg0.init_creator_fee_withdraw, arg0.init_stake_fee_withdraw, arg0.init_platform_stake_fee_withdraw, arg1, arg7, arg9);
    }
