module 0xd9c45eae1837a832ec9d8d8b0a65450a18de103fcf488bd5dfce528d7593eb85::suipaynft {
    ...
    fun genNextFree(arg0: u64, arg1: &mut ContractInfo) : u64 {
        let v0;
        loop {
            v0 = 0x1::vector::borrow_mut<bool>(&mut arg1.minted, arg0);
            if (*v0 == false) {
                break
            };
            let v1 = arg0 + 1;
    ...
    fun init(arg0: SUIPAYNFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Test Sui Pay NFT4"));
        ...
        0x2::transfer::share_object<ContractInfo>(v9);
    }
    ...
    fun mintInternal(arg0: vector<0x1::string::String>, arg1: &mut ContractInfo, arg2: u64, arg3: 0x1::string::String, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = NFT{
            ...
            traits : arg0,
            name   : arg3,
            nr     : convert((genNextFree(0xd9c45eae1837a832ec9d8d8b0a65450a18de103fcf488bd5dfce528d7593eb85::random::rand_u64(arg6) % (1234 as u64), arg1) as u16)),
        };
        let v1 = NFTMinted{
