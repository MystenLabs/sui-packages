module 0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::auctions {
    ...
    public fun bid(arg0: &mut Auction, arg1: &mut 0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::user_stats::UserStatsRegistry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.highest_bidder != arg0.creator && 0x2::balance::value<0x2::sui::SUI>(&arg0.highest_bidder_deposit) > 0) {
            0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::user_stats::record_outbid(arg1, arg0.highest_bidder, v2, arg0.highest_bid, v1, arg4);
        ...
        0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::user_stats::record_bid(arg1, v0, v2, v1, arg4);
    ...
    public fun close_auction<T0: store + key>(arg0: &AdminCap, arg1: &mut Auction, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &mut 0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::dashboard::Dashboard, arg5: &mut 0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::user_stats::UserStatsRegistry, arg6: &mut 0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::leaderboard::Leaderboard, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1.has_nft) {
            if (arg1.highest_bid > 0) {
                ...
                0x2::kiosk::place<T0>(arg2, arg3, 0x2::dynamic_object_field::remove<vector<u8>, T0>(&mut arg1.id, b"nft"));
                ...
                0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::user_stats::record_auction_won(arg5, arg1.highest_bidder, v0, v1, arg8);
                0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::leaderboard::update_leaderboard(arg6, arg5, arg1.highest_bidder, arg8);
            } else {
        ...
        while (v3 < 0x1::vector::length<address>(&arg1.participants)) {
            ...
            if (v4 != v2) {
                0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::user_stats::remove_active_bid(arg5, v4, v0);
            };
            v3 = v3 + 1;
        };
        arg1.active = false;
        0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::dashboard::remove_auction(arg4, v0, v1, v2, arg8);
    }

    public fun create<T0: store + key>(arg0: &mut 0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::dashboard::Dashboard, arg1: &mut 0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::user_stats::UserStatsRegistry, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x2::dynamic_object_field::add<vector<u8>, T0>(&mut v2.id, b"nft", 0x2::kiosk::take<T0>(arg2, arg3, arg4));
        let v3 = 0x2::object::id<Auction>(&v2);
        0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::dashboard::add_auction(arg0, v3, arg7);
        0xd9b54599ea82608de2f6db3e21dee6630c2c6ce320b9847241db97bfb0834aa3::user_stats::record_auction_created(arg1, v0, v3, arg7);
