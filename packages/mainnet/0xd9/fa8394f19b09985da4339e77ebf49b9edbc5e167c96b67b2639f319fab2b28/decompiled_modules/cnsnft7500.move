module 0xd9fa8394f19b09985da4339e77ebf49b9edbc5e167c96b67b2639f319fab2b28::cnsnft7500 {
    struct CNSNFT7500 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7500, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7500>(arg0, arg1);
