module 0xd96d5bb2e56f734b95a8cfe7bf406806abca7e52fd9f14835495556240bebe8c::capybara_lootbox {
    ...
    public fun mint_fruit_by_admin(arg0: &0xd96d5bb2e56f734b95a8cfe7bf406806abca7e52fd9f14835495556240bebe8c::capybara_game_card::AdminCap, arg1: &mut DataStorage, arg2: vector<0x1::string::String>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
    ...
    public fun update_storage(arg0: &0xd96d5bb2e56f734b95a8cfe7bf406806abca7e52fd9f14835495556240bebe8c::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
