module 0xd923ed056237a8c8b42f972080d28d27d7a899c675773c345f5a24bc73032bf8::prediction {
    ...
    public entry fun claim(arg0: &mut Rounds, arg1: u64, arg2: &mut Epoch, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0.upordown) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, *0x2::table::borrow<address, u64>(&v0.upaddress, 0x2::tx_context::sender(arg3)) / v0.upamount * 0x2::balance::value<0x2::sui::SUI>(&mut v0.totalAmount), arg3), 0x2::tx_context::sender(arg3));
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, *0x2::table::borrow<address, u64>(&v0.downaddress, 0x2::tx_context::sender(arg3)) / v0.downamount * 0x2::balance::value<0x2::sui::SUI>(&mut v0.totalAmount), arg3), 0x2::tx_context::sender(arg3));
