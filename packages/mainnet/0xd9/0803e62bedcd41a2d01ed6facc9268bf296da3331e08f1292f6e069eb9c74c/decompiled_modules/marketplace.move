module 0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::marketplace {
    ...
    public fun accept_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::Marketplace>, TradeInfo<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::kiosk_extension::is_installed<0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::Extension>(arg0), 9223374167158685699);
        assert!(0x2::kiosk_extension::is_installed<0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::Extension>(arg1), 9223374171453652995);
        let v0 = ListItem{id: arg2};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::bag_mut(arg0), v0), 9223374175748751365);
        let v1 = BidItem{id: arg2};
        assert!(0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::bag_mut(arg1), v1), 9223374180044111883);
    ...
    public fun accept_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut Collection, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::Marketplace>, TradeInfo<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::kiosk_extension::is_installed<0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::Extension>(arg0), 9223374373317115907);
        assert!(0x2::kiosk_extension::is_installed<0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::Extension>(arg1), 9223374377612083203);
        let v0 = ListItem{id: arg2};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::bag_mut(arg0), v0), 9223374381907181573);
        let v1 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg3.id)};
        assert!(0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::bag_mut(arg1), v1), 9223374386202542091);
        let v2 = ListItem{id: arg2};
        let Listing {
            seller       : v3,
            price        : _,
    ...
    public fun cancel_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: vector<u8>, arg4: &mut MarketplaceConfig, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::Extension>(arg0), 9223373887985811459);
        let v0 = BidItem{id: arg2};
        assert!(0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::bag_mut(arg0), v0), 9223373892281303051);
    ...
    public fun cancel_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut Collection, arg3: vector<u8>, arg4: &mut MarketplaceConfig, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::Extension>(arg0), 9223374025424764931);
        let v0 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg2.id)};
        assert!(0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::bag_mut(arg0), v0), 9223374029720256523);
        let v1 = 0x2::object::uid_to_inner(0x2::kiosk::uid(arg0));
        let v2 = 0x1::bcs::to_bytes<0x2::object::ID>(&v1);
        let v3 = 0x2::kiosk::owner(arg0);
        0x1::vector::append<u8>(&mut v2, 0x1::bcs::to_bytes<address>(&v3));
    ...
    public fun list<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut MarketplaceConfig, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xe4a8ea93bf6e8af3d6e8b69593bc9905907d8168efa22d71ecfc3e786a421f90::build_slot_test::is_active(0x2::kiosk::borrow<0xe4a8ea93bf6e8af3d6e8b69593bc9905907d8168efa22d71ecfc3e786a421f90::build_slot_test::BuildSlot>(arg0, arg1, arg2)), 9223373059057778701);
    ...
    public fun place_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: u64, arg7: &0x2::clock::Clock, arg8: vector<u8>, arg9: &mut MarketplaceConfig, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0x2::bag::borrow<ListItem, Listing<T0, T1>>(0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::bag_mut(arg2), v6);
        let v8 = &v7.seller;
        ...
        0x2::bag::add<BidItem, Bidding<T0, T1>>(0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::bag_mut(arg0), v9, v10);
    ...
    public fun place_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut Collection, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: vector<u8>, arg6: &mut MarketplaceConfig, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::Extension>(arg0), 9223373737661956099);
        let v0 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg2.id)};
        assert!(!0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::bag_mut(arg0), v0), 9223373741957316617);
        ...
        0x2::bag::add<CollectionBidItem, CollectionBid<T0, T1>>(0xe9bac3a247d9e23bb072875a67df75e68ad23b28d0e4ddbfbbb96e0405638b42::extension::bag_mut(arg0), v6, v7);
