module 0xd9c6c3ede591a9d6f7181962d55d205828ff3163aec69a77d8543b4f4a2611eb::reward1618 {
    struct REWARD1618 has drop {
        dummy_field: bool,
    }

    struct TICKET_1618 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1618(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1618>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1618>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1618, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1618>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1618>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1618>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1618>>(v5, 0x2::tx_context::sender(arg1));
    }
