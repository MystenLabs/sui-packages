module 0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::tree_math {
    ...
    public fun find_first_left(arg0: &TreeUint24, arg1: u32) : u32 {
        ...
        if (v1 < 255) {
            let v2 = 0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::bit_math_256::closest_bit_left_u256(safe_borrow_table(&arg0.level2, v0), v1 + 1);
        ...
        if (v4 < 255) {
            let v5 = 0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::bit_math_256::closest_bit_left_u256(safe_borrow_table(&arg0.level1, v3), v4 + 1);
            if (v5 != 115792089237316195423570985008687907853269984665640564039457584007913129639935) {
                let v6 = (v3 as u256) << 8 | v5;
                return ((v6 << 8 | (0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::bit_math_256::least_significant_bit_u256(safe_borrow_table(&arg0.level2, (v6 as u64))) as u256)) as u32)
            };
        };
        let v7 = ((v3 & (255 as u64)) as u8);
        if (v7 < 255) {
            let v8 = 0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::bit_math_256::closest_bit_left_u256(arg0.level0, v7 + 1);
            if (v8 != 115792089237316195423570985008687907853269984665640564039457584007913129639935) {
                let v9 = v8 << 8 | (0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::bit_math_256::least_significant_bit_u256(safe_borrow_table(&arg0.level1, (v8 as u64))) as u256);
                return ((v9 << 8 | (0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::bit_math_256::least_significant_bit_u256(safe_borrow_table(&arg0.level2, (v9 as u64))) as u256)) as u32)
            };
        };
        0
    }
    ...
    public fun find_first_right(arg0: &TreeUint24, arg1: u32) : u32 {
        ...
        let v1 = ((arg1 & (255 as u32)) as u8);
        if (v1 > 0) {
            let v2 = 0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::bit_math_256::closest_bit_right_u256(safe_borrow_table(&arg0.level2, v0), v1 - 1);
            if (v2 != 115792089237316195423570985008687907853269984665640564039457584007913129639935) {
                return (((v0 as u256) << 8 | v2) as u32)
            };
        };
        ...
        let v4 = ((v0 & (255 as u64)) as u8);
        if (v4 > 0) {
            let v5 = 0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::bit_math_256::closest_bit_right_u256(safe_borrow_table(&arg0.level1, v3), v4 - 1);
            if (v5 != 115792089237316195423570985008687907853269984665640564039457584007913129639935) {
                let v6 = (v3 as u256) << 8 | v5;
                return ((v6 << 8 | (0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::bit_math_256::most_significant_bit_u256(safe_borrow_table(&arg0.level2, (v6 as u64))) as u256)) as u32)
            };
        };
        let v7 = ((v3 & (255 as u64)) as u8);
        if (v7 > 0) {
            let v8 = 0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::bit_math_256::closest_bit_right_u256(arg0.level0, v7 - 1);
            if (v8 != 115792089237316195423570985008687907853269984665640564039457584007913129639935) {
                let v9 = v8 << 8 | (0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::bit_math_256::most_significant_bit_u256(safe_borrow_table(&arg0.level1, (v8 as u64))) as u256);
                return ((v9 << 8 | (0xd95657b08292b2abce8574333786c26f60a2b0597d6d2151de84c62cd51545a6::bit_math_256::most_significant_bit_u256(safe_borrow_table(&arg0.level2, (v9 as u64))) as u256)) as u32)
            };
        };
        16777215
    }
