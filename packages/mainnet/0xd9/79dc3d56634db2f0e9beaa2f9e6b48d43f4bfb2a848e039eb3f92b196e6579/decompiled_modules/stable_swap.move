module 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::stable_swap {
    ...
    fun assert_lp_value_is_increased(arg0: u64, arg1: u64, arg2: u128, arg3: u128, arg4: u128, arg5: u128) {
        assert!(0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::stable_curve::lp_value(arg4, arg0, arg5, arg1) > 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::stable_curve::lp_value(arg2, arg0, arg3, arg1), 105);
    }
    ...
    fun create_stable_pool_internal<T0, T1>(arg0: u8, arg1: u8, arg2: u64, arg3: u64, arg4: &mut Dex_Stable_Info, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = Stable_Pool<T0, T1>{
            ...
            x_scale                 : 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::pow_10(arg0),
            y_scale                 : 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::pow_10(arg1),
            is_freeze               : false,
            fee                     : arg2,
            dao_fee                 : arg3,
    ...
    fun get_coin_in_with_fees<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64) : u64 {
        ...
        0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_div((0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::stable_curve::coin_in((arg0 as u128), arg3, arg4, (arg1 as u128), (arg2 as u128)) as u64) + 1, arg6, arg6 - arg5) + 1
    }

    fun get_coin_out_with_fees<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64) : u64 {
        let v0 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_to_u128(arg0, arg6 - arg5);
        let v1 = if (v0 % (arg6 as u128) != 0) {
            v0 / (arg6 as u128) + 1
        } else {
            v0 / (arg6 as u128)
        };
        (0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::stable_curve::coin_out(v1, arg3, arg4, (arg1 as u128), (arg2 as u128)) as u64)
    }
    ...
    public fun get_stable_pool<T0, T1>(arg0: &mut Dex_Stable_Info) : &mut Stable_Pool<T0, T1> {
        ...
        0x2::dynamic_object_field::borrow_mut<0x1::string::String, Stable_Pool<T0, T1>>(&mut arg0.id, 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_lp_name<T0, T1>())
    }
    ...
    fun new_reserves_after_fees_scaled(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : (u128, u128) {
        (((arg0 - 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_div(arg2, arg4, 10000)) as u128), ((arg1 - 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_div(arg3, arg4, 10000)) as u128))
    }
    ...
    fun split_fee_to_dao<T0, T1>(arg0: &mut Stable_Pool<T0, T1>, arg1: u64, arg2: u64) {
        ...
        0x2::balance::join<T0>(&mut arg0.fee_x, 0x2::balance::split<T0>(&mut arg0.token_x, 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_div(arg1, v2, 10000)));
        0x2::balance::join<T1>(&mut arg0.fee_y, 0x2::balance::split<T1>(&mut arg0.token_y, 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_div(arg2, v2, 10000)));
    }
    ...
    fun stable_burn<T0, T1>(arg0: &mut Stable_Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<LSP<T0, T1>>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v2 = 0x2::balance::value<T0>(&arg0.token_x);
        let v3 = 0x2::balance::value<T1>(&arg0.token_y);
        let v4 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_div_u128((v0 as u128), (v2 as u128), v1);
        let v5 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_div_u128((v0 as u128), (v3 as u128), v1);
    ...
    fun stable_mint<T0, T1>(arg0: &mut Stable_Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LSP<T0, T1>> {
        ...
        let v3 = if (v0 == 0) {
            let v4 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::sqrt_u64(0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_to_u128(0x2::coin::value<T0>(&arg2), 0x2::coin::value<T1>(&arg3)));
            assert!(v4 > 1000, 102);
            v4 - 1000
        } else {
            let v5 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_div_u128((0x2::coin::value<T0>(&arg2) as u128), v0, (v1 as u128));
            let v6 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_div_u128((0x2::coin::value<T1>(&arg3) as u128), v0, (v2 as u128));
            if (v5 < v6) {
                v5
            } else {
                v6
    ...
    public(friend) fun swap_x_to_exact_y<T0, T1>(arg0: &mut Stable_Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, u64) {
        ...
        0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::destroy_zero_coin<T0>(arg2, v0);
    ...
    public(friend) fun swap_y_to_exact_x<T0, T1>(arg0: &mut Stable_Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u64) {
        ...
        0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::destroy_zero_coin<T1>(arg2, v0);
    ...
    fun update_oracle<T0, T1>(arg0: &mut Stable_Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64) {
        ...
        if (v2) {
            arg0.last_price_x_cumulative = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::overflow_add(arg0.last_price_x_cumulative, 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::uq64x64::to_u128(0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::uq64x64::fraction(arg3, arg2)) * v1);
            arg0.last_price_y_cumulative = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::overflow_add(arg0.last_price_y_cumulative, 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::uq64x64::to_u128(0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::uq64x64::fraction(arg2, arg3)) * v1);
        };
