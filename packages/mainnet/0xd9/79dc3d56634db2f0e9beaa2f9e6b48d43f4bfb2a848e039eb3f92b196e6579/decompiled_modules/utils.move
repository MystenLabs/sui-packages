module 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils {
    ...
    public fun get_amount_in(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        (((arg1 as u128) * (arg0 as u128) * 10000 / ((arg2 as u128) - (arg0 as u128)) * 9900) as u64) + 1
    }

    public fun get_amount_out(arg0: u64, arg1: u64, arg2: u64) : u64 {
        assert!(arg0 > 0, 0);
        assert!(arg1 > 0 && arg2 > 0, 1);
        let v0 = (arg0 as u128) * 9900;
        ((v0 * (arg2 as u128) / ((arg1 as u128) * 10000 + v0)) as u64)
    }

    public fun get_amount_out_fee(arg0: u64, arg1: u64, arg2: u64) : u64 {
        assert!(arg0 > 0, 0);
        assert!(arg1 > 0 && arg2 > 0, 1);
