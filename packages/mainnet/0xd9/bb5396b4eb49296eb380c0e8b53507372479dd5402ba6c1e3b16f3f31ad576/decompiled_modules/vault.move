module 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault {
    ...
    public fun public_rebate<T0>(arg0: &mut RefundVault, arg1: address) : (0x1::option::Option<0x2::balance::Balance<T0>>, vector<u64>) {
        ...
        let RefundShare {
            ...
            share       : v6,
            u64_padding : _,
        } = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::swap_remove<RefundShare>(v0, v4);
        arg0.share_supply = arg0.share_supply - v6;
        let v8 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v8, v6);
        (0x1::option::some<0x2::balance::Balance<T0>>(0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg0.id, b"refund_balance"), v6)), v8)
    }
