module 0xd9ba10e5ce9858b7a29a43aec375c298242167c8c84eb715aeeb84615b2398a1::reward7018 {
    struct REWARD7018 has drop {
        dummy_field: bool,
    }

    struct TICKET_7018 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7018(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7018>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7018>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7018, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7018>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7018>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7018>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7018>>(v5, 0x2::tx_context::sender(arg1));
    }
