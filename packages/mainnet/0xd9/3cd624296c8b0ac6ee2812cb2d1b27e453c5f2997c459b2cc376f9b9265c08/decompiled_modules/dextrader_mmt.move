module 0xd93cd624296c8b0ac6ee2812cb2d1b27e453c5f2997c459b2cc376f9b9265c08::dextrader_mmt {
    ...
    entry fun add_liquidity<T0, T1>(arg0: &mut State, arg1: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg2: 0x2::transfer::Receiving<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        ...
        verify_position_ownership(arg0, check_pool_id<T0, T1>(arg0, arg1), 0x2::object::id<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(&v0));
        let v1 = &mut arg0.balances;
        let v2 = 0x2::coin::take<T0>(get_balance_mut<T0>(v1), arg3, arg9);
        let v3 = &mut arg0.balances;
        let (v4, v5) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::liquidity::add_liquidity<T0, T1>(arg1, &mut v0, v2, 0x2::coin::take<T1>(get_balance_mut<T1>(v3), arg4, arg9), arg5, arg6, arg8, arg7, arg9);
        let v6 = &mut arg0.balances;
        0x2::coin::put<T0>(get_balance_mut<T0>(v6), v4);
        let v7 = &mut arg0.balances;
        0x2::coin::put<T1>(get_balance_mut<T1>(v7), v5);
        let v8 = 0x2::object::id<State>(arg0);
        0x2::transfer::public_transfer<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(v0, 0x2::object::id_to_address(&v8));
    }
    ...
    entry fun close_position<T0, T1>(arg0: &mut State, arg1: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg2: 0x2::transfer::Receiving<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>, arg3: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg4: &0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::transfer::public_receive<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(&mut arg0.id, arg2);
        let v2 = 0x2::object::id<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(&v1);
        verify_position_ownership(arg0, v0, v2);
        assert!(0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::liquidity(&v1) == 0, 105);
        let v3 = 0x2::table::borrow_mut<0x2::object::ID, vector<0x2::object::ID>>(&mut arg0.position_mappings, v0);
        let (v4, v5) = 0x1::vector::index_of<0x2::object::ID>(v3, &v2);
        if (v4) {
            0x1::vector::remove<0x2::object::ID>(v3, v5);
        };
        let v6 = ClosePosition{
            position_id : v2,
            pool        : v0,
            state_id    : 0x2::object::id<State>(arg0),
        };
        0x2::event::emit<ClosePosition>(v6);
        0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::liquidity::close_position(v1, arg3, arg4);
    }

    entry fun remove_liquidity<T0, T1>(arg0: &mut State, arg1: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg2: 0x2::transfer::Receiving<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>, arg3: u128, arg4: u64, arg5: u64, arg6: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        check_operator(arg0, arg8);
        let v0 = 0x2::transfer::public_receive<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(&mut arg0.id, arg2);
        verify_position_ownership(arg0, check_pool_id<T0, T1>(arg0, arg1), 0x2::object::id<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(&v0));
        let (v1, v2) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::liquidity::remove_liquidity<T0, T1>(arg1, &mut v0, arg3, arg4, arg5, arg7, arg6, arg8);
        let v3 = v2;
        let v4 = v1;
        ...
        let v9 = 0x2::object::id<State>(arg0);
        0x2::transfer::public_transfer<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(v0, 0x2::object::id_to_address(&v9));
    }
    ...
    entry fun collect_fee<T0, T1>(arg0: &mut State, arg1: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg2: 0x2::transfer::Receiving<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>, arg3: &0x2::clock::Clock, arg4: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut arg0.balances;
        0x2::coin::put<T0>(get_balance_mut<T0>(v3), v1);
        let v4 = &mut arg0.balances;
        0x2::coin::put<T1>(get_balance_mut<T1>(v4), v2);
        let v5 = 0x2::object::id<State>(arg0);
        0x2::transfer::public_transfer<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(v0, 0x2::object::id_to_address(&v5));
    }
    ...
    entry fun collect_reward<T0, T1, T2>(arg0: &mut State, arg1: &0x2::clock::Clock, arg2: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg3: 0x2::transfer::Receiving<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>, arg4: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        verify_position_ownership(arg0, check_pool_id<T0, T1>(arg0, arg2), 0x2::object::id<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(&v0));
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::collect::reward<T0, T1, T2>(arg2, &mut v0, arg1, arg4, arg5), arg0.token_holder);
        let v1 = 0x2::object::id<State>(arg0);
        0x2::transfer::public_transfer<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(v0, 0x2::object::id_to_address(&v1));
    }
