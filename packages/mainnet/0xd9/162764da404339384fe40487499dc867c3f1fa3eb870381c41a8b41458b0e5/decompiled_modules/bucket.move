module 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket {
    ...
    public(friend) fun accrue_interests_by_debtor<T0>(arg0: &mut Bucket<T0>, arg1: address, arg2: &0x2::clock::Clock) : u64 {
        ...
        let v4 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::get_bottle_interest_index(0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::borrow_interest_index(0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::borrow_bottle(&arg0.bottle_table, arg1)));
        let v5 = borrow_interest_table_mut<T0>(arg0);
        let (v6, v7) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::accrue_active_interests(v5, v0 - v1, arg2);
        if (v4 < v6) {
            let v8 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::math::mul_factor_u256((v3 as u256), v6, v4);
            assert!(v8 <= (0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::max_u64() as u256), 8);
            0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::update_bottle_debt_and_interest_index(0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::borrow_bottle_mut(&mut arg0.bottle_table, arg1), (v8 as u64), 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::get_active_interest_index(v5));
        };
        assert!(v7 <= (0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::max_u64() as u256), 8);
        arg0.minted_buck_amount = arg0.minted_buck_amount + (v7 as u64);
        (v7 as u64)
    }
