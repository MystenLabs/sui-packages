module 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle {
    ...
    fun get_debt_amount_with_interest(arg0: &Bottle, arg1: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::InterestTable, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        let v0 = (arg2 as u256);
        let v1 = v0;
        let v2 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::get_bottle_interest_index(borrow_interest_index(arg0));
        if (v2 > 0) {
            let (v3, _) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::calculate_interest_index(arg1, arg3);
            v1 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::math::mul_factor_u256((v0 as u256), v3, v2);
        };
        assert!(v1 <= (0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::max_u64() as u256), 7);
        (v1 as u64)
    }
