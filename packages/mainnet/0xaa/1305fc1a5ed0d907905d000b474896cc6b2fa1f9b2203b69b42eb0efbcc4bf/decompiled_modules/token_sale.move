module 0x466124de2ca25615384ab47729ce539bbab3b4ff995c4ac4ab2f60adcb822ad1::token_sale {
    ...
    struct TokenSale has key {
        id: 0x2::object::UID,
        tokens_for_sale: 0x2::balance::Balance<0x466124de2ca25615384ab47729ce539bbab3b4ff995c4ac4ab2f60adcb822ad1::shttoken::SHTTOKEN>,
    ...
    public fun can_purchase_public(arg0: &SalePhaseConfig, arg1: address) : bool {
        ...
        arg0.public_tokens_remaining >= 1000000000000
    }
    ...
    public fun can_purchase_whitelist(arg0: &SaleWhitelist, arg1: &SalePhaseConfig, arg2: address) : bool {
        ...
        arg1.whitelist_tokens_remaining >= 1000000000000
    }
    ...
    public entry fun claim_tokens(arg0: &mut TokenSale, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        v1.claimed = true;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x466124de2ca25615384ab47729ce539bbab3b4ff995c4ac4ab2f60adcb822ad1::shttoken::SHTTOKEN>>(0x2::coin::from_balance<0x466124de2ca25615384ab47729ce539bbab3b4ff995c4ac4ab2f60adcb822ad1::shttoken::SHTTOKEN>(0x2::balance::split<0x466124de2ca25615384ab47729ce539bbab3b4ff995c4ac4ab2f60adcb822ad1::shttoken::SHTTOKEN>(&mut arg0.tokens_for_sale, v2), arg2), v0);
    ...
    public entry fun deposit_tokens(arg0: &SaleAdminCap, arg1: &mut TokenSale, arg2: 0x2::coin::Coin<0x466124de2ca25615384ab47729ce539bbab3b4ff995c4ac4ab2f60adcb822ad1::shttoken::SHTTOKEN>) {
        0x2::balance::join<0x466124de2ca25615384ab47729ce539bbab3b4ff995c4ac4ab2f60adcb822ad1::shttoken::SHTTOKEN>(&mut arg1.tokens_for_sale, 0x2::coin::into_balance<0x466124de2ca25615384ab47729ce539bbab3b4ff995c4ac4ab2f60adcb822ad1::shttoken::SHTTOKEN>(arg2));
        arg1.tokens_remaining = 0x2::balance::value<0x466124de2ca25615384ab47729ce539bbab3b4ff995c4ac4ab2f60adcb822ad1::shttoken::SHTTOKEN>(&arg1.tokens_for_sale);
        let v0 = TokensDeposited{
            amount          : 0x2::coin::value<0x466124de2ca25615384ab47729ce539bbab3b4ff995c4ac4ab2f60adcb822ad1::shttoken::SHTTOKEN>(&arg2),
    ...
    public fun get_phase_constants() : (u64, u64, u64) {
        (8000000000000, 2000000000000, 300000)
    }
    ...
    public fun get_sale_constants() : (u64, u64, u64, u64, u64) {
        (1000000000000, 100000000, 1, 10000000000000, 10)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = TokenSale{
            ...
            tokens_for_sale          : 0x2::balance::zero<0x466124de2ca25615384ab47729ce539bbab3b4ff995c4ac4ab2f60adcb822ad1::shttoken::SHTTOKEN>(),
            tokens_remaining         : 0,
    ...
    public entry fun initialize_phase_config(arg0: &SaleAdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = SalePhaseConfig{
            ...
            whitelist_tokens_remaining : 8000000000000,
            public_tokens_remaining    : 2000000000000,
        ...
        let v1 = PhaseConfigInitialized{
            whitelist_tokens : 8000000000000,
            public_tokens    : 2000000000000,
        };
    ...
    public entry fun mark_liquidity_added(arg0: &SaleAdminCap, arg1: &mut TokenSale, arg2: &0x2::clock::Clock) {
        ...
        arg1.distribution_unlock_time = 0x2::clock::timestamp_ms(arg2) + 300000;
    ...
    public entry fun purchase_v2(arg0: &mut TokenSale, arg1: &mut SaleWhitelist, arg2: &mut SalePhaseConfig, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 >= 100000000, 3);
        if (v1 > 100000000) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, v1 - 100000000, arg5), v0);
        };
        if (arg2.whitelist_phase_active) {
        ...
        v4.tokens_purchased = v4.tokens_purchased + 1000000000000;
        arg0.tokens_remaining = arg0.tokens_remaining - 1000000000000;
        arg0.total_sui_raised = arg0.total_sui_raised + 100000000;
        ...
        let v5 = TokensPurchased{
            buyer            : v0,
            sui_amount       : 100000000,
            tokens_amount    : 1000000000000,
    ...
    public entry fun start_sale(arg0: &SaleAdminCap, arg1: &mut TokenSale, arg2: &0x2::clock::Clock) {
        ...
        assert!(arg1.tokens_remaining >= 10000000000000, 11);
    ...
    fun transition_to_public_phase(arg0: &mut SalePhaseConfig, arg1: &0x2::clock::Clock) {
        ...
        let v1 = WhitelistPhaseEnded{
            ...
            tokens_sold                  : 8000000000000 - arg0.whitelist_tokens_remaining,
