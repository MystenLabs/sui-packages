module 0xaa9bb05a0cbd467946b5ad48c85d09b107ee2fccefc204b517a7a5fc93f27256::battle_blades_base_ {
    struct BATTLE_BLADES_BASE_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BATTLE_BLADES_BASE_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BATTLE_BLADES_BASE_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Battle Blades Base "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The foundation that provides stability and defense. A good base ensures your Battle Blade can withstand powerful attacks and maintain performance."));
