module 0xaa81e27e40e56bdf270946978faa2a0116e9d4ab3c50bca6af81a0b1cfb1addd::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public fun mint_level_nft(arg0: 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::level::LevelNFTTemplate<LevelNFT>, arg1: &mut 0x2::tx_context::TxContext) : LevelNFT {
        assert!(0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::level::recipient<LevelNFT>(&arg0) == 0x2::tx_context::sender(arg1), 2);
        let v0 = LevelNFT{
            id          : 0x2::object::new(arg1),
            level       : 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::level::level<LevelNFT>(&arg0),
            name        : 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::level::name<LevelNFT>(&arg0),
            description : 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::level::description<LevelNFT>(&arg0),
            image_url   : 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::level::uri<LevelNFT>(&arg0),
            attributes  : 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::level::attributes<LevelNFT>(&arg0),
        };
        0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::level::drop_after_minting<LevelNFT>(arg0, &v0);
        v0
    }
