module 0xaae12e65215e4f72e01b5e16629f2a2092cba75d3128e317f6c594bc907305e0::reward5768 {
    struct REWARD5768 has drop {
        dummy_field: bool,
    }

    struct TICKET_5768 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5768(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5768>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5768>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5768, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5768>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5768>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5768>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5768>>(v5, 0x2::tx_context::sender(arg1));
    }
