module 0xaa500c363242db962fefc639d1ec08d1a439eac9e2ba9ed7fd9c6e298b4ab7e7::veithly_faucet {
    ...
    fun init(arg0: VEITHLY_FAUCET, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<VEITHLY_FAUCET>>(v0, 0x2::tx_context::sender(arg1));
    }
