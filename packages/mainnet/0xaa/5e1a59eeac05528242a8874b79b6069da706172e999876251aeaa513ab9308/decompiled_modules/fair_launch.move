module 0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::fair_launch {
    ...
    fun collect_finalize_market_fee<T0, T1>(arg0: &0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::main::MainConfig, arg1: &mut FairLaunch<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.balance_y, arg1.contributed * 0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::main::finalize_market_fee_bps(arg0) / 10000), arg2), 0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::main::fee_recipient(arg0));
    }

    fun collect_open_market_fee<T0>(arg0: &0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::main::MainConfig, arg1: 0x2::coin::Coin<T0>) {
        assert!(0x2::coin::value<T0>(&arg1) == 0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::main::open_market_fee(arg0), 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, 0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::main::fee_recipient(arg0));
    }
    ...
    public fun finalize_fair_launch<T0, T1>(arg0: &0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::main::MainConfig, arg1: &mut FairLaunch<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::vault::LpVault<T0, T1> {
        let v0 = 0x2::clock::timestamp_ms(arg6);
        let v1 = 0x2::balance::value<T1>(&arg1.balance_y);
        assert!(v1 >= arg1.soft_cap && v0 > arg1.end_time, 8);
        if (v0 < arg1.timestamp_last_ms + 0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::main::curator_finalizing_cooldown(arg0) || v0 < arg1.end_time + 0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::main::curator_finalizing_cooldown(arg0)) {
        ...
        let v2 = @0x0;
        let v3 = 0;
        let v4 = 0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::vault::new_lp_vault<T0, T1>(0x2::bag::new(arg7), arg1.curator, arg1.admin_public_key, arg7);
        if (arg1.is_auto_add_liquidity) {
            ...
            if (v12) {
                ...
                0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::vault::add_position<T0, T1>(&mut v4, v19);
                0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::events::emit_lp_vault_created<T0, T1>(0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::events::get_id(&arg1.id), 0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::vault::id<T0, T1>(&v4), arg1.curator, v21, v15, v5, v6);
            } else {
                ...
                0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::vault::add_position<T0, T1>(&mut v4, v26);
                0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::events::emit_lp_vault_created<T0, T1>(0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::events::get_id(&arg1.id), 0xaa5e1a59eeac05528242a8874b79b6069da706172e999876251aeaa513ab9308::vault::id<T0, T1>(&v4), arg1.curator, v28, v22, v5, v6);
            };
        };
