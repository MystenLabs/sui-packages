module 0xaaded240b2a9db047502f179717a8dcb99bbf2462df7d66689f9446a4a9ebe29::cnsnft9697 {
    struct CNSNFT9697 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9697, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9697>(arg0, arg1);
