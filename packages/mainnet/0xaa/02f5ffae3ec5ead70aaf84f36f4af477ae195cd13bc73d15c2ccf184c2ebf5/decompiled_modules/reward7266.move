module 0xaa02f5ffae3ec5ead70aaf84f36f4af477ae195cd13bc73d15c2ccf184c2ebf5::reward7266 {
    struct REWARD7266 has drop {
        dummy_field: bool,
    }

    struct TICKET_7266 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7266(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7266>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7266>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7266, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7266>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7266>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7266>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7266>>(v5, 0x2::tx_context::sender(arg1));
    }
