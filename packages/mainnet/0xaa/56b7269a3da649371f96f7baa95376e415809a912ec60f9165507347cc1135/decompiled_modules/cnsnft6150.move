module 0xaa56b7269a3da649371f96f7baa95376e415809a912ec60f9165507347cc1135::cnsnft6150 {
    struct CNSNFT6150 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6150, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4083"));
        let v4 = 0x2::package::claim<CNSNFT6150>(arg0, arg1);
