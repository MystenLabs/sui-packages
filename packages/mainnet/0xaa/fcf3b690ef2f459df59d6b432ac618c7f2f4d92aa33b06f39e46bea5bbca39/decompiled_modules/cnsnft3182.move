module 0xaafcf3b690ef2f459df59d6b432ac618c7f2f4d92aa33b06f39e46bea5bbca39::cnsnft3182 {
    struct CNSNFT3182 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3182, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9140"));
        let v4 = 0x2::package::claim<CNSNFT3182>(arg0, arg1);
