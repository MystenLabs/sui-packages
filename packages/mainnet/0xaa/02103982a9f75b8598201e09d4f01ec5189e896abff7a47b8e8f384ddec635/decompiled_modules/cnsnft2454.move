module 0xaa02103982a9f75b8598201e09d4f01ec5189e896abff7a47b8e8f384ddec635::cnsnft2454 {
    struct CNSNFT2454 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2454, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2454>(arg0, arg1);
