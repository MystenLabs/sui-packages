module 0xaa5403aa11fbfe34c0a2997bb4cc35c4378fbaf184cc6ac3b65cd1127ba75a5b::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"WIFI", b"WiFi Coin", b"Wifi project", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://iili.io/3Hapn7n.jpg")), arg1);
