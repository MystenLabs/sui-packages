module 0xaa0d6ddbcdc09d7117de443230c543208e2484f456e6db0e6e1e2c926a518e5d::state {
    ...
    entry fun set_config<T0: copy + drop + store, T1: copy + drop + store>(arg0: &mut State, arg1: T0, arg2: T1, arg3: &0xaa0d6ddbcdc09d7117de443230c543208e2484f456e6db0e6e1e2c926a518e5d::capability::AdminCap) {
        0x2::dynamic_field::remove_if_exists<T0, T1>(&mut arg0.id, arg1);
        0x2::dynamic_field::add<T0, T1>(&mut arg0.id, arg1, arg2);
    }

    entry fun update(arg0: &mut State, arg1: bool, arg2: u16, arg3: u256, arg4: &0xaa0d6ddbcdc09d7117de443230c543208e2484f456e6db0e6e1e2c926a518e5d::capability::AdminCap) {
