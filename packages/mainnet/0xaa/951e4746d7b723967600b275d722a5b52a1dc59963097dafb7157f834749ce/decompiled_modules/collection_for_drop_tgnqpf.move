module 0xaa951e4746d7b723967600b275d722a5b52a1dc59963097dafb7157f834749ce::collection_for_drop_tgnqpf {
    struct COLLECTION_FOR_DROP_TGNQPF has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: COLLECTION_FOR_DROP_TGNQPF, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<COLLECTION_FOR_DROP_TGNQPF>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Collection for Drop tgnqpf"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Collection for Drop - test description"));
