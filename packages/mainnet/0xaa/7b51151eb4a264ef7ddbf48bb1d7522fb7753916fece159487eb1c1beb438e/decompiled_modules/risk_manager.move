module 0xaa7b51151eb4a264ef7ddbf48bb1d7522fb7753916fece159487eb1c1beb438e::risk_manager {
    ...
    public(friend) fun add_risk(arg0: &mut RiskManager, arg1: 0x1::type_name::TypeName, arg2: vector<0xaa7b51151eb4a264ef7ddbf48bb1d7522fb7753916fece159487eb1c1beb438e::bet_manager::Placement>, arg3: u64) {
        ...
        let v3 = 0;
        while (v3 < 0x1::vector::length<0xaa7b51151eb4a264ef7ddbf48bb1d7522fb7753916fece159487eb1c1beb438e::bet_manager::Placement>(&arg2)) {
            let (v4, v5) = 0xaa7b51151eb4a264ef7ddbf48bb1d7522fb7753916fece159487eb1c1beb438e::bet_manager::get_placement_data(0x1::vector::borrow<0xaa7b51151eb4a264ef7ddbf48bb1d7522fb7753916fece159487eb1c1beb438e::bet_manager::Placement>(&arg2, v3));
