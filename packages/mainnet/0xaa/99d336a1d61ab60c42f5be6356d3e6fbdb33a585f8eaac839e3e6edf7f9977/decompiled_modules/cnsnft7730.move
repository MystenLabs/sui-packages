module 0xaa99d336a1d61ab60c42f5be6356d3e6fbdb33a585f8eaac839e3e6edf7f9977::cnsnft7730 {
    struct CNSNFT7730 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7730, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7730>(arg0, arg1);
