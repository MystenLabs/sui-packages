module 0xaaa24fefba9db850a93d60d7dc0d045960e4d87ec78a4bf5a195eb9ce8f3d228::cetus_agg {
    ...
    public fun swap<T0, T1, T2>(arg0: &0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::liquidator::Liquidator, arg1: &mut 0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::CustomLiquidateReceipt<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg4: bool, arg5: u64, arg6: &0x2::clock::Clock) {
        let (v0, v1) = if (arg4) {
            ...
            swap_a2b<T1, T2>(arg2, arg3, 0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::take_balance<CetusAgg, T0, T1>(arg1, arg0, v2, arg5), arg6)
        } else {
            let v3 = CetusAgg{dummy_field: false};
            swap_b2a<T1, T2>(arg2, arg3, 0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::take_balance<CetusAgg, T0, T2>(arg1, arg0, v3, arg5), arg6)
        };
        let v4 = v1;
        let v5 = v0;
        if (0x2::balance::value<T1>(&v5) > 0) {
            let v6 = CetusAgg{dummy_field: false};
            0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::put_balance<CetusAgg, T0, T1>(arg1, arg0, v6, v5);
        } else {
            0x2::balance::destroy_zero<T1>(v5);
        };
        if (0x2::balance::value<T2>(&v4) > 0) {
            let v7 = CetusAgg{dummy_field: false};
            0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::put_balance<CetusAgg, T0, T2>(arg1, arg0, v7, v4);
        } else {
    ...
    public fun flash_swap_fixed_output<T0, T1, T2>(arg0: &0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::liquidator::Liquidator, arg1: &mut 0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::CustomLiquidateReceipt<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg4: u64, arg5: bool, arg6: &0x2::clock::Clock) : (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::FlashSwapReceipt<T1, T2>, u64) {
        ...
        if (0x2::balance::value<T1>(&v6) > 0) {
            ...
            0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::put_balance<CetusAgg, T0, T1>(arg1, arg0, v8, v6);
        } else {
            0x2::balance::destroy_zero<T1>(v6);
        };
        if (0x2::balance::value<T2>(&v5) > 0) {
            let v9 = CetusAgg{dummy_field: false};
            0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::put_balance<CetusAgg, T0, T2>(arg1, arg0, v9, v5);
        } else {
    ...
    public fun repay_flash_swap_fixed_output<T0, T1, T2>(arg0: &0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::liquidator::Liquidator, arg1: &mut 0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::CustomLiquidateReceipt<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg4: bool, arg5: 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::FlashSwapReceipt<T1, T2>) {
        let (v0, v1) = if (arg4) {
            let v2 = CetusAgg{dummy_field: false};
            (0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::take_balance<CetusAgg, T0, T1>(arg1, arg0, v2, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T1, T2>(&arg5)), 0x2::balance::zero<T2>())
        } else {
            let v3 = CetusAgg{dummy_field: false};
            (0x2::balance::zero<T1>(), 0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::take_balance<CetusAgg, T0, T2>(arg1, arg0, v3, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T1, T2>(&arg5)))
        };
        ...
        if (0x2::balance::value<T1>(&v7) > 0) {
            let v8 = CetusAgg{dummy_field: false};
            0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::put_balance<CetusAgg, T0, T1>(arg1, arg0, v8, v7);
        } else {
            0x2::balance::destroy_zero<T1>(v7);
        };
        if (0x2::balance::value<T2>(&v6) > 0) {
            let v9 = CetusAgg{dummy_field: false};
            0xf53e23638a3c1e975f51eacf7ff8dda78a66f94b30b45fac8716d8ffe18bd422::custom_liquidate::put_balance<CetusAgg, T0, T2>(arg1, arg0, v9, v6);
        } else {
