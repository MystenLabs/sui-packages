module 0x42a1a418bf977d5306aa783288eebbc2e3ca9200b533fba7feda521e60d199e::leverage_market {
    ...
    public(friend) fun ensure_leverage_on_going(arg0: &LeverageMarket) {
        assert!(arg0.leverage_on_going, 0x42a1a418bf977d5306aa783288eebbc2e3ca9200b533fba7feda521e60d199e::leverage_error::leverage_not_on_going());
    }

    public(friend) fun ensure_no_leverage_on_going(arg0: &LeverageMarket) {
        assert!(!arg0.leverage_on_going, 0x42a1a418bf977d5306aa783288eebbc2e3ca9200b533fba7feda521e60d199e::leverage_error::leverage_on_going());
    }
    ...
    public(friend) fun ensure_supporting_market<T0>(arg0: &LeverageMarket, arg1: &0xfe1d8929d13b00aaecd7642dec1c6d41cab82882a1b139efa46bf61dfd6380bf::market::Market<T0>) {
        assert!(arg0.supported_market_id == 0x2::object::id<0xfe1d8929d13b00aaecd7642dec1c6d41cab82882a1b139efa46bf61dfd6380bf::market::Market<T0>>(arg1), 0x42a1a418bf977d5306aa783288eebbc2e3ca9200b533fba7feda521e60d199e::leverage_error::market_not_supported());
    }
