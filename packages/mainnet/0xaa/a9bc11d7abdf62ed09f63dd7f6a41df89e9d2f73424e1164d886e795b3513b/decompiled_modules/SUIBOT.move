module 0xaaa9bc11d7abdf62ed09f63dd7f6a41df89e9d2f73424e1164d886e795b3513b::SUIBOT {
    struct SUIBOT has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUIBOT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<SUIBOT>(arg0, 2, b"SUIBOT", b"SuiSniperBot", b"SuiSniperBot", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/BqObosAFnktR3nvABUXZF4NMDFbWRs63Y5yAn_ZzcgE?ext=png")), arg1);
