module 0xaac8651572bc69b945cc457c84a2efb65c45a2f1e6a7e0b3192bbe0fbb7c86fa::gift5566 {
    struct GIFT5566 has drop {
        dummy_field: bool,
    }

    struct TICKET_5566 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5566(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5566>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5566>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5566, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5566>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5566>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5566>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5566>>(v5, 0x2::tx_context::sender(arg1));
    }
