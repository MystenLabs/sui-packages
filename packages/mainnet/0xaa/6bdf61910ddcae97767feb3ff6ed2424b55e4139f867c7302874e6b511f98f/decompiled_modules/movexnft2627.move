module 0xaa6bdf61910ddcae97767feb3ff6ed2424b55e4139f867c7302874e6b511f98f::movexnft2627 {
    struct MOVEXNFT2627 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT2627, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT2627>(arg0, arg1);
