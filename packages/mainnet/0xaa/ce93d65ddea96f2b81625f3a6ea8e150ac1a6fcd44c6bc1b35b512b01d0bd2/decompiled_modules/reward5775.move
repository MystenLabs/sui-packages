module 0xaace93d65ddea96f2b81625f3a6ea8e150ac1a6fcd44c6bc1b35b512b01d0bd2::reward5775 {
    struct REWARD5775 has drop {
        dummy_field: bool,
    }

    struct TICKET_5775 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5775(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5775>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5775>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5775, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5775>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5775>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5775>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5775>>(v5, 0x2::tx_context::sender(arg1));
    }
