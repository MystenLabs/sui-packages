module 0xaad663b32a8bf55073d768a718dd9dc48e2ec52efe9026dd91edb134d2d3cb1b::navi_reward_w14 {
    struct NAVI_REWARD_W14 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = NAVI_REWARD{
                ...
                image_url   : 0x1::string::utf8(b"ipfs://QmT5WgBpSdCmCY9HkVTywjH5cdYEWWPqEKRMRzn9wdh9RY"),
    ...
    fun init(arg0: NAVI_REWARD_W14, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmT5WgBpSdCmCY9HkVTywjH5cdYEWWPqEKRMRzn9wdh9RY"));
        ...
        let v4 = 0x2::package::claim<NAVI_REWARD_W14>(arg0, arg1);
