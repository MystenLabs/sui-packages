module 0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::cclmm {
    ...
    public fun elf<T0, T1>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0xe04b8f264c8a29e103e71980987d76a475c8565094b6646e368659a30a9c70ed::bm::CBM, arg2: &0x2::clock::Clock, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x67a4708740dcc8cfd86aea52b11d1972fe1fd9e9f3070b49763d55fe609611a1::sq::SQR, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: vector<bool>, arg10: vector<bool>, arg11: vector<u64>, arg12: vector<u64>, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        while (v8 < 0x1::vector::length<bool>(&arg9)) {
            ...
            if (v12 != 0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::e_no_error()) {
                let v14 = EE{
                    e : v12,
                    l : 324,
                };
            ...
            let v15 = if (v10) {
                0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::cmnsp()
            } else {
                0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::cmxsp()
            };
            ...
            if (v16 != 0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::e_no_error()) {
                let v21 = EE{
                    e : v16,
                    l : 324,
                };
    ...
    fun sei<T0, T1>(arg0: &mut 0xe04b8f264c8a29e103e71980987d76a475c8565094b6646e368659a30a9c70ed::bm::CBM, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: bool, arg4: u64, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        assert!(v8 >= arg5, 0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::e_amount_out_too_low());
        ...
        (0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::e_no_error(), v10, v11, v6, v7)
    }
    ...
    fun seo<T0, T1>(arg0: &mut 0xe04b8f264c8a29e103e71980987d76a475c8565094b6646e368659a30a9c70ed::bm::CBM, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: bool, arg4: u64, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        assert!(v6 <= arg5, 0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::e_amount_in_too_high());
        let (v7, v8) = if (arg3) {
            (v6, 0)
        } else {
            (0, v6)
        ...
        (0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::e_no_error(), v7, v8, 0x2::balance::value<T0>(&v5), 0x2::balance::value<T1>(&v4))
    }
    ...
    fun vbac<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: bool, arg4: bool, arg5: u64, arg6: u64) : (u64, u64) {
        ...
        if (arg3) {
            if (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::calculated_swap_result_amount_out(&v0) < arg6) {
                return (0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::e_amount_out_too_low(), 0)
            };
        } else if (v1 > arg6) {
            return (0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::e_amount_in_too_high(), 0)
        };
        if (arg4) {
            if (v1 > arg1) {
                return (0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::e_insufficient_input_balance(), 0)
            };
        } else if (v1 > arg2) {
            return (0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::e_insufficient_input_balance(), 0)
        };
        (0xaade4ed2ee6d45a958ff1af8c8f8a5b71308785a4bb0bb31839b2299466e17cc::ct::e_no_error(), arg5)
    }
