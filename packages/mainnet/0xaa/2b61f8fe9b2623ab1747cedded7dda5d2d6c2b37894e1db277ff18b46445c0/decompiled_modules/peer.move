module 0xaa2b61f8fe9b2623ab1747cedded7dda5d2d6c2b37894e1db277ff18b46445c0::peer {
    struct Peer has store {
        ...
        token_decimals: u8,
        inbound_rate_limit: 0xaa2b61f8fe9b2623ab1747cedded7dda5d2d6c2b37894e1db277ff18b46445c0::rate_limit::RateLimitState,
    }
    ...
    public fun borrow_inbound_rate_limit_mut(arg0: &mut Peer) : &mut 0xaa2b61f8fe9b2623ab1747cedded7dda5d2d6c2b37894e1db277ff18b46445c0::rate_limit::RateLimitState {
    ...
    public fun new(arg0: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg1: u8, arg2: u64) : Peer {
        Peer{
            address            : arg0,
            token_decimals     : arg1,
            inbound_rate_limit : 0xaa2b61f8fe9b2623ab1747cedded7dda5d2d6c2b37894e1db277ff18b46445c0::rate_limit::new(arg2),
        }
    }
