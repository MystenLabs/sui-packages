module 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::pari_resolution {
    ...
    fun finalize_internal<T0>(arg0: &mut PariResolution<T0>, arg1: &mut 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel::ParimutuelMarket<T0>, arg2: u8, arg3: u8) {
        arg0.finalized = true;
        arg0.final_outcome = arg2;
        if (arg2 == 255) {
            0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel::set_invalid_internal<T0>(arg1);
        } else {
            0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel::set_resolved_internal<T0>(arg1, arg2);
        };
        let v0 = Finalized{
            market_id : arg0.market_id,
            outcome   : arg2,
    ...
    public fun finalize_optimistic<T0>(arg0: &mut PariResolution<T0>, arg1: &mut 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel::ParimutuelMarket<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.finalized, 0);
        assert!(arg0.proposed, 5);
        assert!(!arg0.disputed, 10);
        assert!(0x2::object::id<0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel::ParimutuelMarket<T0>>(arg1) == arg0.market_id, 8);
    ...
    public fun propose<T0>(arg0: &mut PariResolution<T0>, arg1: &0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::fee::FeeConfig, arg2: u8, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.finalized, 0);
        assert!(!arg0.proposed, 6);
        assert!(valid_vote<T0>(arg0, arg2), 9);
        assert!(0x2::coin::value<T0>(&arg3) >= 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::fee::creation_bond(arg1), 7);
        arg0.proposed = true;
    ...
    fun settle_bonds<T0>(arg0: &mut PariResolution<T0>, arg1: u8, arg2: &mut 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::treasury::Treasury<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg0.proposed) {
            if (arg0.disputed) {
    ...
    public fun start<T0>(arg0: &0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::resolution::Council, arg1: &0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel::ParimutuelMarket<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel::state<T0>(arg1) == 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel::state_closed(), 11);
        let v0 = 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::resolution::council_members(arg0);
        let v1 = 0x2::tx_context::sender(arg2);
        assert!(0x1::vector::contains<address>(&v0, &v1), 1);
        let v2 = PariResolution<T0>{
            id                  : 0x2::object::new(arg2),
            market_id           : 0x2::object::id<0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel::ParimutuelMarket<T0>>(arg1),
            num_outcomes        : 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel::num_outcomes<T0>(arg1),
            proposed            : false,
            proposer            : @0x0,
    ...
    public fun vote<T0>(arg0: &0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::resolution::Council, arg1: &mut PariResolution<T0>, arg2: &mut 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel::ParimutuelMarket<T0>, arg3: &mut 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::treasury::Treasury<T0>, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.finalized, 0);
        assert!(0x2::object::id<0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel::ParimutuelMarket<T0>>(arg2) == arg1.market_id, 8);
        assert!(valid_vote<T0>(arg1, arg4), 9);
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::resolution::council_members(arg0);
        ...
        let v4 = 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::resolution::council_threshold(arg0);
