module 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::parimutuel {
    ...
    struct ParimutuelMarket<phantom T0> has key {
        ...
        version: u64,
        frozen: bool,
        resolution_source: 0x1::string::String,
        api_fixture_id: u64,
        creation_bond: 0x2::balance::Balance<T0>,
        bond_returned: bool,
        bond_slashed: bool,
    }
    ...
    struct CreationBondReturned has copy, drop {
        market_id: 0x2::object::ID,
        creator: address,
        amount: u64,
    }

    struct CreationBondSlashed has copy, drop {
        market_id: 0x2::object::ID,
        creator: address,
        amount: u64,
        house: address,
    ...
    public fun api_fixture_id<T0>(arg0: &ParimutuelMarket<T0>) : u64 {
        arg0.api_fixture_id
    }
    ...
    public fun bet<T0>(arg0: &mut ParimutuelMarket<T0>, arg1: u8, arg2: 0x2::coin::Coin<T0>, arg3: &0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::fee::FeeConfig, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : BetReceipt {
        0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::fee::assert_not_paused(arg3);
        ...
        assert!(v0 > 0, 4);
        0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::fee::assert_min_trade(arg3, v0);
    ...
    public fun bond_returned<T0>(arg0: &ParimutuelMarket<T0>) : bool {
        arg0.bond_returned
    }

    public fun bond_slashed<T0>(arg0: &ParimutuelMarket<T0>) : bool {
        arg0.bond_slashed
    }
    ...
    public fun create<T0>(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: u8, arg3: u64, arg4: 0x1::string::String, arg5: u64, arg6: 0x2::coin::Coin<T0>, arg7: &0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::fee::FeeConfig, arg8: &mut 0x2::tx_context::TxContext) : ParimutuelMarket<T0> {
        assert!(arg2 >= 2, 0);
        assert!(arg2 <= 64, 11);
        let v0 = 0x2::coin::value<T0>(&arg6);
        assert!(v0 >= 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::fee::creation_bond(arg7), 13);
        let v1 = 0x2::object::new(arg8);
        let v2 = 0x2::tx_context::sender(arg8);
        let v3 = 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::fee::trading_fee_bps(arg7);
        let v4 = vector[];
        let v5 = 0;
        while (v5 < arg2) {
        ...
        let v6 = MarketCreated{
            market_id      : 0x2::object::uid_to_inner(&v1),
            num_outcomes   : arg2,
            close_ts_ms    : arg3,
            rake_bps       : v3,
            creator        : v2,
        ...
        ParimutuelMarket<T0>{
            ...
            creator           : v2,
            house             : 0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::fee::fee_recipient(arg7),
            version           : 2,
            frozen            : false,
            resolution_source : arg4,
            api_fixture_id    : arg5,
            creation_bond     : 0x2::coin::into_balance<T0>(arg6),
            bond_returned     : false,
            bond_slashed      : false,
        }
    }

    public fun create_and_share<T0>(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: u8, arg3: u64, arg4: 0x1::string::String, arg5: u64, arg6: 0x2::coin::Coin<T0>, arg7: &0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::fee::FeeConfig, arg8: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<ParimutuelMarket<T0>>(create<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8));
    }

    public fun creation_bond_value<T0>(arg0: &ParimutuelMarket<T0>) : u64 {
        0x2::balance::value<T0>(&arg0.creation_bond)
    }
    ...
    public fun place_bet<T0>(arg0: &mut ParimutuelMarket<T0>, arg1: u8, arg2: 0x2::coin::Coin<T0>, arg3: &0xaaad0b32f3a9d8a202f2a68f64d290024413aabfa9ef4c67c27948c81c81c3aa::fee::FeeConfig, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun reclaim_creation_bond<T0>(arg0: &mut ParimutuelMarket<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.state == 2 || arg0.state == 3, 6);
        assert!(!arg0.bond_returned && !arg0.bond_slashed, 14);
        arg0.bond_returned = true;
        let v0 = 0x2::balance::value<T0>(&arg0.creation_bond);
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.creation_bond, v0), arg1), arg0.creator);
            let v1 = CreationBondReturned{
                market_id : 0x2::object::id<ParimutuelMarket<T0>>(arg0),
                creator   : arg0.creator,
                amount    : v0,
            };
            0x2::event::emit<CreationBondReturned>(v1);
        };
    }

    public fun resolution_source<T0>(arg0: &ParimutuelMarket<T0>) : 0x1::string::String {
        arg0.resolution_source
    }
    ...
    public fun void_and_slash<T0>(arg0: &mut ParimutuelMarket<T0>, arg1: &ResolverCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 2, 10);
        set_invalid_internal<T0>(arg0);
        if (!arg0.bond_slashed && !arg0.bond_returned) {
            arg0.bond_slashed = true;
            let v0 = 0x2::balance::value<T0>(&arg0.creation_bond);
            if (v0 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.creation_bond, v0), arg2), arg0.house);
                let v1 = CreationBondSlashed{
                    market_id : 0x2::object::id<ParimutuelMarket<T0>>(arg0),
                    creator   : arg0.creator,
                    amount    : v0,
                    house     : arg0.house,
                };
                0x2::event::emit<CreationBondSlashed>(v1);
            };
        };
    }
