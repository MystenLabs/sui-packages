module 0xaa8ad4d21aae78218897670ff6474a48063096c3b2f74c21949af7031e1bed18::reward7650 {
    struct REWARD7650 has drop {
        dummy_field: bool,
    }

    struct TICKET_7650 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7650(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7650>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7650>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7650, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7650>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7650>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7650>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7650>>(v5, 0x2::tx_context::sender(arg1));
    }
