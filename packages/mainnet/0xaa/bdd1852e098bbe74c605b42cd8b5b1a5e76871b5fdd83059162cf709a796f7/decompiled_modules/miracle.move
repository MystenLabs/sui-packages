module 0xaabdd1852e098bbe74c605b42cd8b5b1a5e76871b5fdd83059162cf709a796f7::miracle {
    ...
    public fun create(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Miracle {
        assert!(arg0 > 0, 0xaabdd1852e098bbe74c605b42cd8b5b1a5e76871b5fdd83059162cf709a796f7::errors::E_BAD_SPLIT());
        Miracle{
    ...
    public fun maybe_trigger(arg0: &mut Miracle, arg1: u64) : (bool, u64) {
        ...
        assert!(v0 > 0, 0xaabdd1852e098bbe74c605b42cd8b5b1a5e76871b5fdd83059162cf709a796f7::errors::E_BAD_SPLIT());
        if (arg1 % v0 == 0) {
    ...
    public fun set_params(arg0: &mut Miracle, arg1: u64, arg2: u64) {
        assert!(arg1 > 0, 0xaabdd1852e098bbe74c605b42cd8b5b1a5e76871b5fdd83059162cf709a796f7::errors::E_BAD_SPLIT());
        arg0.base_odds = arg1;
