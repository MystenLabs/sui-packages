module 0xaa2de6c7d1650d333977dc1a1e87a389d245e7385079454a40f4ce0bae14409f::nft_claim {
    ...
    public entry fun mint_batch(arg0: &mut ClaimCap, arg1: vector<address>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg1)) {
            ...
            if (!0x2::vec_set::contains<address>(&arg0.claimed, &v1)) {
                ...
                0x2::vec_set::insert<address>(&mut arg0.claimed, v1);
            };
            v0 = v0 + 1;
        };
    }

    public entry fun mint_single(arg0: &ClaimCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = DEEPClaimNFT{
