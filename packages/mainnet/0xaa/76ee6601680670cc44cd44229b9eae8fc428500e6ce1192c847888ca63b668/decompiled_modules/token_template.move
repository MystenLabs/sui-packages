module 0xaa76ee6601680670cc44cd44229b9eae8fc428500e6ce1192c847888ca63b668::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT1121542", b"BatchToken1 121542", b"First parallel deployment", 0x1::option::none<0x2::url::Url>(), arg1);
