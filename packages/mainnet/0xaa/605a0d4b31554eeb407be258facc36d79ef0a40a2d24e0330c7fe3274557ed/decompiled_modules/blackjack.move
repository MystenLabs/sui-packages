module 0x5e2f4359b5c0311954f502c4e1e12a845e85152b67e033ca6f8590b5781606ff::blackjack {
    ...
    fun dealer_move<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut BlackjackTable<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v16 == 200) {
            ...
            let v39 = 0;
            while (v39 < 0x1::vector::length<u64>(&v33)) {
            ...
            let v41 = 0;
            while (v41 < 0x1::vector::length<u64>(&v36)) {
                v40 = v40 + 0x1::vector::pop_back<u64>(&mut v36);
                v41 = v41 + 1;
            };
            0x1::vector::destroy_empty<u64>(v36);
            payout<T0>(arg0, arg1, v38, v40, arg2);
            0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::emit_blackjack_game_result<T0, Blackjack>(arg0, v4, v5, v38, v40, v30, v23, v6, v27);
        };
    }
