module 0xaa8fb7b602f0441c63ab2804a016cf1955502f416014c74d434267bf85291093::tte {
    ...
    fun opt<T0>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, T0>, arg1: bool, arg2: u128, arg3: u128, arg4: u64, arg5: u64, arg6: u8, arg7: u8, arg8: u64) : u64 {
        assert!(arg4 > 0, 13906835222315597828);
        assert!(arg4 <= arg5, 13906835226610696198);
        assert!(arg8 < arg4, 13906835230905794568);
        let v0 = 0;
        let v1 = 0;
        let v2 = arg4;
        let v3 = 0;
    ...
    public fun ttb<T0>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, T0>, arg1: &mut 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg4: &0x2::clock::Clock, arg5: vector<AOP>, arg6: vector<AOP>, arg7: u64, arg8: u64, arg9: u8, arg10: u8, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < 0x1::vector::length<AOP>(&arg5)) {
            ...
            let (v7, v8) = tt<T0>(arg0, arg1, arg2, arg3, arg4, v3, true, arg7, v6, arg9, arg10, v5, arg11);
            if (v7 == 0 || v8 == 0) {
                break
            };
            v0 = v0 - v7;
        ...
        while (v2 < 0x1::vector::length<AOP>(&arg6)) {
            ...
            let (v14, v15) = tt<T0>(arg0, arg1, arg2, arg3, arg4, v9, false, arg8, v13, arg9, arg10, v11, arg11);
            if (v14 == 0 || v15 == 0) {
                break
            };
            v1 = v1 - v14;
