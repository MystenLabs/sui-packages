module 0xaa61bcf05de53f7f97a3a830a263d76930f2f5e6997cc0eac032515a93c8d314::t0 {
    struct T0 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 6, b"T0", b"Test0", b"yolo", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = v0;
