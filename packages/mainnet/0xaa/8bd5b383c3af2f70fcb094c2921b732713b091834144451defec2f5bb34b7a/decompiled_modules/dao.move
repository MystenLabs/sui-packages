module 0xaa8bd5b383c3af2f70fcb094c2921b732713b091834144451defec2f5bb34b7a::dao {
    struct DAO has drop {
        dummy_field: bool,
    }
    ...
    entry fun create_dao<T0: store + key>(arg0: &T0, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Dao<T0>{
