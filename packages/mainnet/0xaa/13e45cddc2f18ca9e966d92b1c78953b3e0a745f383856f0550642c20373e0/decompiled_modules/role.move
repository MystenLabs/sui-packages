module 0xaa13e45cddc2f18ca9e966d92b1c78953b3e0a745f383856f0550642c20373e0::role {
    ...
    public entry fun create_random_role_for_cards(arg0: &Global, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) : Role {
        let v0 = 0x2::random::new_generator(arg1, arg2);
        get_random_role_by_level(arg0, 1, 0x2::random::generate_u64_in_range(&mut v0, 0, 1000), arg2)
    }
    ...
    public entry fun get_random_role_by_power(arg0: &Global, arg1: &0x2::random::Random, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Role {
        let v0 = 0x2::random::new_generator(arg1, arg4);
        let v1 = 0x2::random::generate_u64_in_range(&mut v0, 0, 1000);
        if (v1 < arg3) {
            get_random_role_by_level(arg0, 9, v1, arg4)
        } else if (v1 < arg2) {
            get_random_role_by_level(arg0, 3, v1, arg4)
        } else {
            get_random_role_by_level(arg0, 1, v1, arg4)
        }
    }
    ...
    public fun permenant_increase_role_hp(arg0: &mut vector<Role>, arg1: &0x2::vec_map::VecMap<0x1::string::String, 0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::Int_wrapper>) {
        let v0 = 0x2::vec_map::keys<0x1::string::String, 0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::Int_wrapper>(arg1);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::string::String>(&v0)) {
            ...
            while (v3 < 0x1::vector::length<Role>(arg0)) {
                if (&0x1::vector::borrow_mut<Role>(arg0, v3).class == v2) {
                    ...
                    increase_hp(v4, 0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::get_int(0x2::vec_map::get<0x1::string::String, 0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::Int_wrapper>(arg1, v2)));
                    break
                };
                v3 = v3 + 1;
            };
    ...
    public fun print_role(arg0: &Role) {
        ...
        0x1::string::append(&mut v0, 0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::u8_to_string(arg0.level));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", attack: "));
        0x1::string::append(&mut v0, 0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::u64_to_string(arg0.attack));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", hp: "));
        0x1::string::append(&mut v0, 0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::u64_to_string(arg0.hp));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", speed: "));
        0x1::string::append(&mut v0, 0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::u64_to_string(arg0.speed));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", sp: "));
        0x1::string::append(&mut v0, 0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::u8_to_string(arg0.sp));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", sp_cap: "));
        0x1::string::append(&mut v0, 0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::u8_to_string(arg0.sp_cap));
        ...
        0x1::string::append(&mut v0, 0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::u8_to_string(arg0.gold_cost));
    ...
    public fun upgrade(arg0: &Global, arg1: &Role, arg2: &mut Role) : bool {
        ...
        if (v0 < 9 && v1 < 9) {
            ...
            let v9 = 0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::get_class_by_level(0xfcb7d5a9a0977ec7baa77058e7984c98eaa1f703ddd0912946b6f7ef01a53ac0::utils::removeSuffix(arg2.class), v3);
