module 0xaa061b0f28ec7ed017244c1e91d9c8447830e157c9fdb002849a91ffe8e71d7c::reward2235 {
    struct REWARD2235 has drop {
        dummy_field: bool,
    }

    struct TICKET_2235 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2235(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2235>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2235>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2235, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2235>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2235>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2235>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2235>>(v5, 0x2::tx_context::sender(arg1));
    }
