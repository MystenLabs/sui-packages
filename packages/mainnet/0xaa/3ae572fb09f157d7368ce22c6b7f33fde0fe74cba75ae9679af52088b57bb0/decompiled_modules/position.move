module 0xaa3ae572fb09f157d7368ce22c6b7f33fde0fe74cba75ae9679af52088b57bb0::position {
    ...
    fun init(arg0: POSITION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = update_display(&v0, 0x1::string::utf8(b"{name}"), 0x1::string::utf8(b"{coin_type_a}"), 0x1::string::utf8(b"{coin_type_b}"), 0x1::string::utf8(b"https://app.fullsail.finance/liquidity/{pool}/positions/{id}"), 0x1::string::utf8(b"https://app.fullsail.finance/static_files/position.png"), 0x1::string::utf8(b"{description}"), 0x1::string::utf8(b"https://fullsail.finance"), 0x1::string::utf8(b"FULLSAIL"), arg1);
    ...
    public fun is_position_staked(arg0: &PositionManager, arg1: 0x2::object::ID) : bool {
        borrow_position_info(arg0, arg1).fullsail_distribution_staked
    }
    ...
    public fun set_display(arg0: &0xaa3ae572fb09f157d7368ce22c6b7f33fde0fe74cba75ae9679af52088b57bb0::config::GlobalConfig, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_module<Position>(arg1), 985489328434574338);
        0xaa3ae572fb09f157d7368ce22c6b7f33fde0fe74cba75ae9679af52088b57bb0::config::checked_package_version(arg0);
    ...
    public fun set_display_v2(arg0: &0xaa3ae572fb09f157d7368ce22c6b7f33fde0fe74cba75ae9679af52088b57bb0::config::GlobalConfig, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_module<Position>(arg1), 985489328434574338);
        0xaa3ae572fb09f157d7368ce22c6b7f33fde0fe74cba75ae9679af52088b57bb0::config::checked_package_version(arg0);
