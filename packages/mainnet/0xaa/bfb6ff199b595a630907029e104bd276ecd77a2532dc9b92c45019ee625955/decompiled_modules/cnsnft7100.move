module 0xaabfb6ff199b595a630907029e104bd276ecd77a2532dc9b92c45019ee625955::cnsnft7100 {
    struct CNSNFT7100 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7100, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8434"));
        let v4 = 0x2::package::claim<CNSNFT7100>(arg0, arg1);
