module 0xaa0e19b7a0c81672e261ded83befe000f4562afd273c20be419243f809e202dd::peer {
    struct Peer has store {
        ...
        token_decimals: u8,
        inbound_rate_limit: 0xaa0e19b7a0c81672e261ded83befe000f4562afd273c20be419243f809e202dd::rate_limit::RateLimitState,
    }
    ...
    public fun borrow_inbound_rate_limit_mut(arg0: &mut Peer) : &mut 0xaa0e19b7a0c81672e261ded83befe000f4562afd273c20be419243f809e202dd::rate_limit::RateLimitState {
    ...
    public fun new(arg0: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg1: u8, arg2: u64) : Peer {
        Peer{
            address            : arg0,
            token_decimals     : arg1,
            inbound_rate_limit : 0xaa0e19b7a0c81672e261ded83befe000f4562afd273c20be419243f809e202dd::rate_limit::new(arg2),
        }
    }
