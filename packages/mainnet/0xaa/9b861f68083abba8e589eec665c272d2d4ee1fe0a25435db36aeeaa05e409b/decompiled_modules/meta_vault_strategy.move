module 0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_strategy {
    ...
    public(friend) fun apply_supply_cap(arg0: &mut Strategy, arg1: u128, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::emit_apply_supply_cap(arg2, arg1, arg3);
    }
    ...
    public(friend) fun remove_market(arg0: &mut Strategy, arg1: u64, arg2: address, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        ...
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::emit_remove_market(arg2, arg1, arg3, arg4);
    }

    public(friend) fun set_allocation(arg0: &mut Strategy, arg1: &0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::Governance, arg2: u64, arg3: u128, arg4: u64, arg5: address, arg6: &0x2::tx_context::TxContext) {
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::ensure_curator(arg1, 0x2::tx_context::sender(arg6));
        ...
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::emit_set_allocation(arg5, arg2, arg3, arg4, arg6);
    }

    public(friend) fun set_max_deposit(arg0: &mut Strategy, arg1: &0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::Governance, arg2: u128, arg3: address, arg4: &0x2::tx_context::TxContext) {
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::ensure_curator(arg1, 0x2::tx_context::sender(arg4));
        arg0.max_deposit = arg2;
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::emit_set_max_deposit(arg3, arg2, arg4);
    }

    public(friend) fun set_min_deposit(arg0: &mut Strategy, arg1: &0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::Governance, arg2: u128, arg3: address, arg4: &0x2::tx_context::TxContext) {
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::ensure_curator(arg1, 0x2::tx_context::sender(arg4));
        arg0.min_deposit = arg2;
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::emit_set_min_deposit(arg3, arg2, arg4);
    }

    public(friend) fun set_supply_queue(arg0: &mut Strategy, arg1: &0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::Governance, arg2: vector<u64>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::ensure_curator(arg1, 0x2::tx_context::sender(arg4));
        validate_supply_queue(arg0, &arg2, arg4);
        arg0.supply_queue = arg2;
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::emit_set_supply_queue(arg3, copy_queue(&arg2), arg4);
    }

    public(friend) fun set_withdraw_cooldown(arg0: &mut Strategy, arg1: &0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::Governance, arg2: u64, arg3: address, arg4: &0x2::tx_context::TxContext) {
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::ensure_curator(arg1, 0x2::tx_context::sender(arg4));
        arg0.withdraw_cooldown_ms = arg2;
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::emit_set_withdraw_cooldown(arg3, arg2, arg4);
    }

    public(friend) fun set_withdraw_queue(arg0: &mut Strategy, arg1: &0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::Governance, arg2: vector<u64>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::ensure_curator(arg1, 0x2::tx_context::sender(arg4));
        validate_withdraw_queue(arg0, &arg2, arg4);
        arg0.withdraw_queue = arg2;
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::emit_set_withdraw_queue(arg3, copy_queue(&arg2), arg4);
    }

    public(friend) fun submit_remove_market(arg0: &Strategy, arg1: &mut 0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::Governance, arg2: &0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::market::Hearn, arg3: address, arg4: u64, arg5: u64, arg6: &0x2::tx_context::TxContext) {
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::ensure_curator(arg1, 0x2::tx_context::sender(arg6));
        assert!(0x2::table::contains<u64, MarketAllocation>(&arg0.allocations, arg4), 15);
        assert!(0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::market::user_position_supply_assets(arg2, arg4, arg3) == 0, 14);
        let v0 = arg5 + 0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::get_timelock_ms(arg1);
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::submit_pending_market_removal(arg1, arg4, v0);
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::emit_submit_market_removal(arg3, arg4, v0, 0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::event_type_submit(), arg6);
    }

    public(friend) fun submit_supply_cap(arg0: &mut Strategy, arg1: &mut 0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::Governance, arg2: u128, arg3: u64, arg4: address, arg5: &0x2::tx_context::TxContext) {
        0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::ensure_curator(arg1, 0x2::tx_context::sender(arg5));
        assert!(arg2 != arg0.supply_cap, 24);
        if (arg2 < arg0.supply_cap) {
            arg0.supply_cap = arg2;
            0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::emit_apply_supply_cap(arg4, arg2, arg5);
        } else {
            let v0 = arg3 + 0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::get_timelock_ms(arg1);
            0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_governance::submit_pending_supply_cap(arg1, arg2, v0);
            0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::emit_submit_supply_cap(arg4, arg2, v0, 0xaa9b861f68083abba8e589eec665c272d2d4ee1fe0a25435db36aeeaa05e409b::meta_vault_events::event_type_submit(), arg5);
        };
    }
