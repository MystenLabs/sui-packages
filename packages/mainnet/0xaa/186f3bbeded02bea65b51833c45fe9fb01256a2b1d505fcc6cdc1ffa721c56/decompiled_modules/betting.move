module 0x9ca7d3b57c018fb171724dc808a542d2ec27354f6526b75e968d308d29bb6626::betting {
    ...
    public fun get_bet_info(arg0: &Bet) : (address, u64, u64, u8, u8) {
        (arg0.bettor, arg0.stake, arg0.odds, arg0.status, arg0.coin_type)
    }

    public fun get_platform_stats(arg0: &BettingPlatform) : (u64, u64, u64, u64, u64, bool) {
        (arg0.total_bets, arg0.total_volume_sui, arg0.total_volume_sbets, 0x2::balance::value<0x2::sui::SUI>(&arg0.treasury_sui), 0x2::balance::value<0x6a4d9c0eab7ac40371a7453d1aa6c89b130950e8af6868ba975fdd81371a7285::sbets::SBETS>(&arg0.treasury_sbets), arg0.paused)
    }
    ...
    public entry fun place_bet(arg0: &mut BettingPlatform, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 6);
        assert!(v0 >= arg0.min_bet, 9);
        assert!(v0 <= arg0.max_bet, 8);
        assert!(arg5 >= 100, 3);
        let v1 = v0 * arg5 / 100;
        ...
        0x2::transfer::transfer<Bet>(v4, v2);
    }
    ...
    public entry fun revoke_oracle_cap(arg0: &AdminCap, arg1: OracleCap, arg2: &0x2::clock::Clock) {
        ...
        let v1 = OracleCapRevoked{
            oracle_cap_id : 0x2::object::uid_to_inner(&v0),
            timestamp     : 0x2::clock::timestamp_ms(arg2),
        };
    ...
    public entry fun settle_bet(arg0: &OracleCap, arg1: &mut BettingPlatform, arg2: &mut Bet, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg3) {
            ...
            assert!(0x2::balance::value<0x2::sui::SUI>(&arg1.treasury_sui) >= v2, 0);
    ...
    public entry fun settle_bet_sbets(arg0: &OracleCap, arg1: &mut BettingPlatform, arg2: &mut Bet, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg3) {
            ...
            arg2.platform_fee = v1;
            assert!(0x2::balance::value<0x6a4d9c0eab7ac40371a7453d1aa6c89b130950e8af6868ba975fdd81371a7285::sbets::SBETS>(&arg1.treasury_sbets) >= v2, 0);
    ...
    public entry fun update_limits(arg0: &AdminCap, arg1: &mut BettingPlatform, arg2: u64, arg3: u64) {
        arg1.min_bet = arg2;
        arg1.max_bet = arg3;
    }
    ...
    public entry fun withdraw_all_to(arg0: &AdminCap, arg1: &mut BettingPlatform, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg3);
        let v1 = 0x2::object::id<BettingPlatform>(arg1);
        let v2 = 0x2::balance::value<0x2::sui::SUI>(&arg1.treasury_sui);
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.treasury_sui, v2), arg4), arg2);
            arg1.accrued_fees_sui = 0;
        ...
        let v4 = 0x2::balance::value<0x6a4d9c0eab7ac40371a7453d1aa6c89b130950e8af6868ba975fdd81371a7285::sbets::SBETS>(&arg1.treasury_sbets);
        if (v4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x6a4d9c0eab7ac40371a7453d1aa6c89b130950e8af6868ba975fdd81371a7285::sbets::SBETS>>(0x2::coin::from_balance<0x6a4d9c0eab7ac40371a7453d1aa6c89b130950e8af6868ba975fdd81371a7285::sbets::SBETS>(0x2::balance::split<0x6a4d9c0eab7ac40371a7453d1aa6c89b130950e8af6868ba975fdd81371a7285::sbets::SBETS>(&mut arg1.treasury_sbets, v4), arg4), arg2);
            arg1.accrued_fees_sbets = 0;
