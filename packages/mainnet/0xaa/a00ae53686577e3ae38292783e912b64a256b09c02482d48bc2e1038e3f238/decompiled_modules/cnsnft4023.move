module 0xaaa00ae53686577e3ae38292783e912b64a256b09c02482d48bc2e1038e3f238::cnsnft4023 {
    struct CNSNFT4023 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4023, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4023>(arg0, arg1);
