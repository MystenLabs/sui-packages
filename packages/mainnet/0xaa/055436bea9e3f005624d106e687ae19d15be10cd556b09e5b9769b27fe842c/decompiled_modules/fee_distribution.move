module 0xaa055436bea9e3f005624d106e687ae19d15be10cd556b09e5b9769b27fe842c::fee_distribution {
    ...
    public(friend) fun withdraw_fees<T0, T1>(arg0: &mut FeeState<T0, T1>, arg1: u64, arg2: &0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>) {
        ...
        let v2 = get_max_withdraw(*v1, 0x2::balance::value<T1>(&arg0.fees_meme), arg1, arg0.stakes_total);
        *v1 = ((*v1 + v2) as u64);
        ...
        let v4 = get_max_withdraw(*v3, 0x2::balance::value<T0>(&arg0.fees_s), arg1, arg0.stakes_total);
        *v3 = ((*v3 + v4) as u64);
        arg0.fees_meme_total = arg0.fees_meme_total - v2;
        arg0.fees_s_total = arg0.fees_s_total - v4;
