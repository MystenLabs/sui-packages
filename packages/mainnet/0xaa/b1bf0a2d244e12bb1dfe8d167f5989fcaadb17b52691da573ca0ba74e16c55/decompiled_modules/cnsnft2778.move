module 0xaab1bf0a2d244e12bb1dfe8d167f5989fcaadb17b52691da573ca0ba74e16c55::cnsnft2778 {
    struct CNSNFT2778 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2778, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1395"));
        let v4 = 0x2::package::claim<CNSNFT2778>(arg0, arg1);
