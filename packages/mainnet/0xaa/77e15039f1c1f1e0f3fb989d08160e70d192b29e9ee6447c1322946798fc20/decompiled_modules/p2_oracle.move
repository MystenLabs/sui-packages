module 0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::p2_oracle {
    ...
    public fun get_current_price_no_check(arg0: &Oracle, arg1: 0x1::string::String) : u256 {
        borrow_asset_price(arg0, arg1).price
    }
    ...
    public fun update_price_from_pyth(arg0: &mut Oracle, arg1: 0x1::string::String, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) {
        ...
        let (v2, v3) = 0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::pyth_oracle::get_verified_price_1e18_with_publish_time(arg2, v1, arg3, millis_to_seconds_ceil(v0.max_staleness_ms));
        assert!(v2 > 0, 10002);
