module 0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco_ico {
    struct IcoPool has key {
        ...
        taco_pool: 0x2::balance::Balance<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO>,
    ...
    public fun claim_taco(arg0: &mut IcoPool, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO>>(claim_taco_ptb(arg0, arg1, arg2), v0);
    }

    fun claim_taco_internal(arg0: &mut IcoPool, arg1: &0x2::clock::Clock, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO> {
        ...
        if (v4 == 0) {
            return 0x2::coin::from_balance<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO>(0x2::balance::zero<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO>(), arg3)
        };
        let v5 = TacoClaimed{
            user          : arg2,
            amount        : v4,
        ...
        0x2::coin::from_balance<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO>(0x2::balance::split<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO>(&mut arg0.taco_pool, v4), arg3)
    }

    public fun claim_taco_ptb(arg0: &mut IcoPool, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO> {
        let v0 = 0x2::tx_context::sender(arg2);
    ...
    fun create_ico_internal(arg0: u64, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (IcoPool, IcoAdminCap) {
        ...
        let v0 = IcoPool{
            ...
            taco_pool                  : 0x2::balance::zero<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO>(),
    ...
    public fun deposit_taco(arg0: &mut IcoPool, arg1: &IcoAdminCap, arg2: 0x2::coin::Coin<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO>) {
        assert_cap(arg0, arg1);
        let v0 = 0x2::coin::value<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO>(&arg2);
        arg0.total_taco_committed = arg0.total_taco_committed + v0;
        0x2::balance::join<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO>(&mut arg0.taco_pool, 0x2::coin::into_balance<0x3163b57b1dc2349877f79a58132b628110b7dd6cd1e9d3d2672c9620b4fe9fbf::taco::TACO>(arg2));
