module 0xaa571d2c35a8ae2af934167aba85c19ef09799c7f5eb8232dc0fff362f869246::genesis_void {
    struct GENESIS_VOID has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: GENESIS_VOID, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<GENESIS_VOID>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Genesis Void"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A divine NFT collection from a futuristic realm, where blood, lightning, and neon smoke merge to give birth to the last godlike entity. 111 unique beings from the Void"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeihabrpwsm42bp25dpqko2tafi3vh3z6y4k5gmltjuwefpvwjrc3zq"));
