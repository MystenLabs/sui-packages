module 0x5a713350dcbb5bf4222b1620dc531a92b1d7531c9149955f5df60abc93d81526::bridge_locked_fee {
    ...
    public fun bridge_locked_fee<T0: drop>(arg0: &mut 0x5a713350dcbb5bf4222b1620dc531a92b1d7531c9149955f5df60abc93d81526::state::State, arg1: &mut 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::state::State, arg2: &0x2::coin::CoinMetadata<T0>, arg3: BridgeLockedFeeTicket<T0>, arg4: &mut 0x2::tx_context::TxContext) : (CctpBurnRequestBridgeLockedFee<T0>, 0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::deposit_for_burn::DepositForBurnWithCallerTicket<T0, CircleAuth>) {
        ...
        assert!(v2 != 0x5a713350dcbb5bf4222b1620dc531a92b1d7531c9149955f5df60abc93d81526::state::solana_cctp_domain(), 4);
        let v7 = 0x5a713350dcbb5bf4222b1620dc531a92b1d7531c9149955f5df60abc93d81526::state::get_cctp_mayan_caller(arg0, v2);
    ...
    public fun store_bridge_locked_fee<T0>(arg0: &mut 0x5a713350dcbb5bf4222b1620dc531a92b1d7531c9149955f5df60abc93d81526::state::State, arg1: &0x2::coin::CoinMetadata<T0>, arg2: CctpBurnRequestBridgeLockedFee<T0>, arg3: &0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::Message, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!0x5a713350dcbb5bf4222b1620dc531a92b1d7531c9149955f5df60abc93d81526::state::is_paused(arg0), 0);
        0x5a713350dcbb5bf4222b1620dc531a92b1d7531c9149955f5df60abc93d81526::state::assert_valid_version(arg0);
        ...
        let v10 = 0x5a713350dcbb5bf4222b1620dc531a92b1d7531c9149955f5df60abc93d81526::burn_message::from_bytes(&v9);
        assert!(v0 == 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::destination_domain(arg3), 5);
        assert!(v1 == 0x5a713350dcbb5bf4222b1620dc531a92b1d7531c9149955f5df60abc93d81526::burn_message::mint_recipient(&v10), 5);
        assert!(v2 == 0x5a713350dcbb5bf4222b1620dc531a92b1d7531c9149955f5df60abc93d81526::burn_message::burn_token(&v10), 5);
        assert!(v3 == (0x5a713350dcbb5bf4222b1620dc531a92b1d7531c9149955f5df60abc93d81526::burn_message::amount(&v10) as u64), 5);
        ...
        let v12 = BridgeLockedFeeSubmitted{
            ...
            locked_fee_id    : 0x5a713350dcbb5bf4222b1620dc531a92b1d7531c9149955f5df60abc93d81526::state::lock_fee_redeem<T0>(arg0, 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::nonce(arg3), v1, v6, 0x2::coin::into_balance<T0>(v8), arg4),
            addr_dest        : v1,
        };
