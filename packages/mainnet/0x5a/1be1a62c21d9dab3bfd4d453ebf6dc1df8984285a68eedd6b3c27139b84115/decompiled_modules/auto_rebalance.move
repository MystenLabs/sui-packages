module 0x5a1be1a62c21d9dab3bfd4d453ebf6dc1df8984285a68eedd6b3c27139b84115::auto_rebalance {
    ...
    public fun new_strategy_for_testing<T0>(arg0: u64, arg1: u64, arg2: bool, arg3: bool, arg4: u64, arg5: u64, arg6: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg7: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg8: u64, arg9: bool, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg15: &mut 0x2::tx_context::TxContext, arg16: T0) : AutoRebalanceStrategy<T0> {
        AutoRebalanceStrategy<T0>{
            id                                          : 0x2::object::new(arg15),
            owner                                       : 0x2::tx_context::sender(arg15),
            description                                 : 0x1::string::utf8(b"test"),
            lower_sqrt_price_change_threshold_bps       : arg0,
            upper_sqrt_price_change_threshold_bps       : arg1,
            lower_sqrt_price_change_threshold_direction : arg2,
            upper_sqrt_price_change_threshold_direction : arg3,
            rebalance_cooldown_secs                     : arg4,
            range_multiplier                            : arg5,
            rebalance_max_tick                          : arg6,
            rebalance_min_tick                          : arg7,
            profit_take_threshold                       : arg8,
            rebalance_paused                            : arg9,
            tx_gas_limit                                : arg10,
            price_feed_source                           : arg11,
            lp_slippage_tolerance_bps                   : arg12,
            last_rebalance_timestamp                    : arg13,
            current_tick                                : arg14,
            position                                    : 0x1::option::some<T0>(arg16),
        }
    }
    ...
    public fun prepare_rebalance<T0: key>(arg0: &mut AutoRebalanceStrategy<T0>, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg2: &0x2::clock::Clock) : (u64, u64, bool, bool, u64, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, T0, AutoRebalanceReceipt<T0>) {
        if (arg0.last_rebalance_timestamp > 0x2::clock::timestamp_ms(arg2)) {
            abort 0x5a1be1a62c21d9dab3bfd4d453ebf6dc1df8984285a68eedd6b3c27139b84115::errors::error_last_rebalance_timestamp_after_current_timestamp()
        };
        if (arg0.last_rebalance_timestamp + arg0.rebalance_cooldown_secs > 0x2::clock::timestamp_ms(arg2)) {
            abort 0x5a1be1a62c21d9dab3bfd4d453ebf6dc1df8984285a68eedd6b3c27139b84115::errors::error_invalid_rebalance_cooldown()
        };
        if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::cmp(arg1, arg0.rebalance_min_tick) == 0 || 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::cmp(arg1, arg0.rebalance_max_tick) == 2) {
            abort 0x5a1be1a62c21d9dab3bfd4d453ebf6dc1df8984285a68eedd6b3c27139b84115::errors::error_current_tick_out_of_range()
        };
        if (arg0.rebalance_paused) {
            abort 0x5a1be1a62c21d9dab3bfd4d453ebf6dc1df8984285a68eedd6b3c27139b84115::errors::error_invalid_rebalance_paused()
        };
