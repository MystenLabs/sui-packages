module 0xc71ee2be7595aa66cf19ae0040701a9c08442c252bb7467f2b80483ecc9267b9::hanhan {
    ...
    public entry fun batch_mint(arg0: &mut 0x2::coin::TreasuryCap<HANHAN>, arg1: vector<u64>, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<address>(&arg2);
        assert!(v0 == 0x1::vector::length<u64>(&arg1), 0);
        assert!(v0 > 0, 0);
        let v1 = 0;
        while (v1 < v0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<HANHAN>>(0x2::coin::mint<HANHAN>(arg0, *0x1::vector::borrow<u64>(&arg1, v1), arg3), *0x1::vector::borrow<address>(&arg2, v1));
            v1 = v1 + 1;
        };
    }
