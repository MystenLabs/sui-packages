module 0x5a906c0c895ba8d6c8ee57a07f79beffb813523a84c2dd8c715b57ba0b4f9865::launchpad {
    ...
    struct Listing has store, key {
        id: 0x2::object::UID,
        mint_cap: 0x5a906c0c895ba8d6c8ee57a07f79beffb813523a84c2dd8c715b57ba0b4f9865::fossil::MintCap,
        phases: vector<Phase>,
        max_buy_per_tx: u64,
    }
    ...
    public entry fun buy<T0>(arg0: &mut Listing, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x5a906c0c895ba8d6c8ee57a07f79beffb813523a84c2dd8c715b57ba0b4f9865::supply::Supply, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Listing{
            ...
            mint_cap       : 0x5a906c0c895ba8d6c8ee57a07f79beffb813523a84c2dd8c715b57ba0b4f9865::fossil::new_mint_cap(arg0),
    ...
    fun mint_nft(arg0: &mut 0x5a906c0c895ba8d6c8ee57a07f79beffb813523a84c2dd8c715b57ba0b4f9865::fossil::MintCap, arg1: &mut 0x5a906c0c895ba8d6c8ee57a07f79beffb813523a84c2dd8c715b57ba0b4f9865::supply::Supply, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        while (v0 < arg2) {
            0x5a906c0c895ba8d6c8ee57a07f79beffb813523a84c2dd8c715b57ba0b4f9865::fossil::mint_and_transfer(arg0, arg1, arg3);
            v0 = v0 + 1;
        };
    }
