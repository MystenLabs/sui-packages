module 0x5ad6eddace00754969af16ad89cfe4601af9c94735599b7ab79d6e70df91ae07::_analogue_style_ {
    struct _ANALOGUE_STYLE_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _ANALOGUE_STYLE_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_ANALOGUE_STYLE_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(x"e38090416e616c6f677565207374796c65e38091"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"I make NFTs from hand-drawn drawings.I hope you enjoy the distortion and human-link quality that you can't get with digital art."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiherc76myljgtffv7qqbp4yspzlwirngolpoafpb7jwq3vrw3bcmy"));
