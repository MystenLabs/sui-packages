module 0xcd72e9b1dfdd998047c07db08b48ff5458558a6deff4575ee07f1264b12e6ea2::stake {
    ...
    struct MigrateNewVersion has copy, drop, store {
        pool_id: address,
        user_address: address,
        timestamp: u64,
        amount_staked: u128,
    ...
    public entry fun migrateNewVersion<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: vector<u8>, arg2: vector<u8>, arg3: &Admincap, arg4: &mut 0xcd72e9b1dfdd998047c07db08b48ff5458558a6deff4575ee07f1264b12e6ea2::version::Version, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, UserStake>(&mut arg0.stakes, v1)) {
            ...
            v2.spt_staked = 0;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg0.stake_coins, (v3 as u64), arg6), 0x2::object::id_address<Admincap>(arg3));
            ...
            0x2::event::emit<MigrateNewVersion>(v5);
        };
    }
