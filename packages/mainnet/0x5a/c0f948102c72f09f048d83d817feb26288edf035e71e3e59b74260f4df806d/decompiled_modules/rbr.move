module 0x5ac0f948102c72f09f048d83d817feb26288edf035e71e3e59b74260f4df806d::rbr {
    ...
    public(friend) fun fill<T0, T1: drop>(arg0: &mut RebalanceRequest<T0>, arg1: 0x2::balance::Balance<T0>, arg2: T1) {
        ...
        assert!(arg0.from_witness == 0x1::option::some<0x1::type_name::TypeName>(0x1::type_name::with_defining_ids<T1>()), 7);
