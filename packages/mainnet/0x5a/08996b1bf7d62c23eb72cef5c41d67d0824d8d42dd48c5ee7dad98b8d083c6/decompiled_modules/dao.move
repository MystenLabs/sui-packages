module 0x5a08996b1bf7d62c23eb72cef5c41d67d0824d8d42dd48c5ee7dad98b8d083c6::dao {
    ...
    public entry fun cancel_purchase<T0>(arg0: &mut DAOFund<T0>, arg1: &mut 0x5a08996b1bf7d62c23eb72cef5c41d67d0824d8d42dd48c5ee7dad98b8d083c6::dao_config::GlobalDaoFee, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (_, _, v11) = 0x5a08996b1bf7d62c23eb72cef5c41d67d0824d8d42dd48c5ee7dad98b8d083c6::dao_config::get_dao_fee_config(arg1);
    ...
    public entry fun finalize_dao<T0>(arg0: &AdminCap, arg1: &mut DAOFund<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1.dao_end_at > 0) {
            0x5a08996b1bf7d62c23eb72cef5c41d67d0824d8d42dd48c5ee7dad98b8d083c6::lock::lock_nft_to<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(v14, arg1.creator, 31536000000, arg6, arg7);
        } else {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x5a08996b1bf7d62c23eb72cef5c41d67d0824d8d42dd48c5ee7dad98b8d083c6::dao_config::new_global_dao_fee_and_shared(arg0);
        let v1 = DAOSeller{
    ...
    public entry fun set_platform_fee(arg0: &OperatorCap, arg1: &mut 0x5a08996b1bf7d62c23eb72cef5c41d67d0824d8d42dd48c5ee7dad98b8d083c6::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: address, arg5: &0x2::tx_context::TxContext) {
        0x5a08996b1bf7d62c23eb72cef5c41d67d0824d8d42dd48c5ee7dad98b8d083c6::dao_config::set_platform_fee(arg1, arg2, arg3, arg4, arg5);
    }
