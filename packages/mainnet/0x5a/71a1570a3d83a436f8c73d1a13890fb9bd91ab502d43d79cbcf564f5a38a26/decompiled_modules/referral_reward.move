module 0x5a71a1570a3d83a436f8c73d1a13890fb9bd91ab502d43d79cbcf564f5a38a26::referral_reward {
    ...
    entry fun claim(arg0: &mut Referral, arg1: &mut Reward, arg2: address, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = get_claimed_amount(arg2, arg0);
        assert!(arg5 > v0, 1002);
        let v1 = arg5 - v0;
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg1.balance) >= v1, 1001);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.balance, v1), arg8), arg2);
        if (!is_existed_receiver(arg0, arg2)) {
            let v2 = Record{
                claimed_address : arg2,
                claimed_amount  : v1,
            };
            0x2::table::add<address, Record>(&mut arg0.records, arg2, v2);
        } else {
            let v3 = 0x2::table::borrow_mut<address, Record>(&mut arg0.records, arg2);
            v3.claimed_amount = v3.claimed_amount + v1;
        };
    ...
    fun get_claimed_amount(arg0: address, arg1: &Referral) : u64 {
        let v0 = 0;
        if (is_existed_receiver(arg1, arg0)) {
            v0 = 0x2::table::borrow<address, Record>(&arg1.records, arg0).claimed_amount;
        };
        v0
    }
