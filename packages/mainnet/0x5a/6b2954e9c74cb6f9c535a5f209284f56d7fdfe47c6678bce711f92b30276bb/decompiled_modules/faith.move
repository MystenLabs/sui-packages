module 0x5a6b2954e9c74cb6f9c535a5f209284f56d7fdfe47c6678bce711f92b30276bb::faith {
    ...
    public fun accrue_to(arg0: address, arg1: u64, arg2: &mut SupplyCap, arg3: &RefiningIndex, arg4: &mut Buckets, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.minted + arg1 <= arg2.cap, 0x5a6b2954e9c74cb6f9c535a5f209284f56d7fdfe47c6678bce711f92b30276bb::errors::E_SUPPLY_CAP());
    ...
    public fun claim_if_any(arg0: address, arg1: u64, arg2: &mut SupplyCap, arg3: &mut RefiningIndex, arg4: &mut Buckets) : u64 {
        let (v0, v1) = find_bucket_index(&arg4.owners, arg0);
        if (!v0) {
            return 0
        };
    ...
    public fun preview_refinement(arg0: address, arg1: &RefiningIndex, arg2: &Buckets, arg3: u64) : (u64, u64, u64) {
