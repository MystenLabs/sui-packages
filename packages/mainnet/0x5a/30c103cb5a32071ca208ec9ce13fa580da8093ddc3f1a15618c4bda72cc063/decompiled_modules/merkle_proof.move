module 0x5a30c103cb5a32071ca208ec9ce13fa580da8093ddc3f1a15618c4bda72cc063::merkle_proof {
    ...
    fun hash_pair(arg0: vector<u8>, arg1: vector<u8>) : vector<u8> {
        if (0x5a30c103cb5a32071ca208ec9ce13fa580da8093ddc3f1a15618c4bda72cc063::vectors::lt(arg0, arg1)) {
    ...
    public fun verify_with_index(arg0: &vector<vector<u8>>, arg1: vector<u8>, arg2: vector<u8>) : (bool, u256) {
        ...
        while (v1 < 0x1::vector::length<vector<u8>>(arg0)) {
            ...
            let v5 = if (0x5a30c103cb5a32071ca208ec9ce13fa580da8093ddc3f1a15618c4bda72cc063::vectors::lt(v0, v4)) {
