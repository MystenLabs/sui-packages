module 0x70361cdc41d44c2e1f9c30c81837f7cf08c9bf0eaf30d178000070fda9c58b83::distribution {
    ...
    public(friend) fun items<T0: store + key>(arg0: &mut Distribution<T0>) : &mut 0x2::table_vec::TableVec<T0> {
        &mut arg0.items
    }
