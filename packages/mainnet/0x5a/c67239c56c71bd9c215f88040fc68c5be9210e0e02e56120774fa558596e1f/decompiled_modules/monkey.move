module 0x5ac67239c56c71bd9c215f88040fc68c5be9210e0e02e56120774fa558596e1f::monkey {
    ...
    fun init(arg0: MONKEY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v0, v1) = 0x2::coin::create_currency<MONKEY>(arg0, 9, b"MONK", b"MONKEY", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b""))), arg1);
        let v2 = v0;
