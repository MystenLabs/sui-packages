module 0x5a03422332611111f43b2e6e9e4d8f02a7f37194004303076256554863054d14::cnsnft6572 {
    struct CNSNFT6572 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6572, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6572>(arg0, arg1);
