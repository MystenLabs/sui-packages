module 0x5a600a44094bd18c4fe661b0a7aadba8dce9aab9072a82fffc4a3fb6c0f215cd::movexnft1513 {
    struct MOVEXNFT1513 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT1513, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT1513>(arg0, arg1);
