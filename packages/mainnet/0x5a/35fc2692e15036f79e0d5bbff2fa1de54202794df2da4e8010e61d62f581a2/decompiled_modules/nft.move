module 0x5a35fc2692e15036f79e0d5bbff2fa1de54202794df2da4e8010e61d62f581a2::nft {
    ...
    public entry fun add_object(arg0: &mut VisitorList, arg1: &mut CoCoNFT, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        *v0 = *v0 + 1;
        ...
        0x2::dynamic_object_field::add<0x1::string::String, 0x5a35fc2692e15036f79e0d5bbff2fa1de54202794df2da4e8010e61d62f581a2::item::CoCoItem>(&mut arg1.id, item_key(), 0x5a35fc2692e15036f79e0d5bbff2fa1de54202794df2da4e8010e61d62f581a2::item::new_item(arg3, arg4, arg5, arg2, arg6));
    }
