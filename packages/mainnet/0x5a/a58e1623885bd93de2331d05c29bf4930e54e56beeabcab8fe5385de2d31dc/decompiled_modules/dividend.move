module 0x785248249ac457dfd378bdc6d2fbbfec9d1daf65e9d728b820eb4888c8da2c10::dividend {
    ...
    public fun checked_package_version(arg0: &DividendManager) {
        assert!(arg0.package_version <= 4, 7);
    }
    ...
    public fun settle_v2(arg0: &SettleCap, arg1: &mut VeNFTDividends, arg2: &mut DividendManager, arg3: &0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::XcetusManager, arg4: u64, arg5: vector<0x2::object::ID>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0x2::object::ID> {
        ...
        let v11 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_mut<u64, DividendInfo>(&mut arg2.dividends, arg4);
        v11.settled_num = v11.settled_num + v4;
        if (v11.settled_num >= 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::total_holder(arg3)) {
            v11.is_settled = true;
        };
        let v12 = SettleEvent{
            phase   : arg4,
