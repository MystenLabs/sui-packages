module 0x5a129ebe52f374fd06c74c791075c539989e378aaa4433cff84887f968327fb8::luce {
    ...
    fun init(arg0: LUCE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<LUCE>(&mut v3, 690000000000000000, 0x2::tx_context::sender(arg1), arg1);
