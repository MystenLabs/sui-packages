module 0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::ops_buy_desk {
    ...
    public entry fun buy_with_sui_ops_fee(arg0: &mut OpsBuyDesk, arg1: &0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::OpsInteractionFeeConfig, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::BTEN, 0x2::sui::SUI>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::collect_ops_interaction_fee(arg1, arg2, arg6);
        assert!(!arg0.paused, 2);
        let v0 = 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::BTEN, 0x2::sui::SUI>>(arg3);
        assert!(0x2::object::id_to_address(&v0) == arg0.pool_id, 8);
        let v1 = 0x2::coin::value<0x2::sui::SUI>(&arg4);
        assert!(v1 > 0, 3);
        let v2 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::BTEN, 0x2::sui::SUI>(arg3);
        settle_buy(arg0, arg4, v1, bten_out_at_sqrt_mid(v1, v2), arg5, price_mist_sui_per_bten_from_sqrt(v2), 0, arg6);
    }
    ...
    public entry fun buy_with_sui_posted_price_ops_fee(arg0: &mut OpsBuyDesk, arg1: &0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::OpsInteractionFeeConfig, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        0x31c6c71184b08a574bd62fa8edd9a75aab9a986427484cf765a1890ce00aece0::bten::collect_ops_interaction_fee(arg1, arg2, arg5);
        assert!(!arg0.paused, 2);
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg3);
        assert!(v0 > 0, 3);
        let v1 = arg0.price_mist_sui_per_bten;
        settle_buy(arg0, arg3, v0, bten_out_at_posted_price(v0, v1), arg4, v1, 1, arg5);
    }
