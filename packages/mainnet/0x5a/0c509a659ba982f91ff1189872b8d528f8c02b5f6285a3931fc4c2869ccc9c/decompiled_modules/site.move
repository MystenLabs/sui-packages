module 0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::site {
    ...
    public fun redirects(arg0: &Site) : &0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::Redirects {
        0x2::dynamic_field::borrow<vector<u8>, 0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::Redirects>(&arg0.id, b"redirects")
    }
    ...
    public fun burn(arg0: Site) {
        ...
        let v7 = v0;
        assert!(!0x2::dynamic_field::exists_<vector<u8>>(&v7, b"routes"), 4);
        assert!(!0x2::dynamic_field::exists_<vector<u8>>(&v7, b"redirects"), 3);
        0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::events::emit_site_burned(0x2::object::uid_to_inner(&v7));
        0x2::object::delete(v7);
    }

    public fun create_redirects(arg0: &mut Site) {
        0x2::dynamic_field::add<vector<u8>, 0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::Redirects>(&mut arg0.id, b"redirects", 0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::empty());
    }
    ...
    public fun fill_redirects(arg0: &mut Site, arg1: vector<0x1::string::String>, arg2: vector<0x1::string::String>, arg3: vector<u16>) {
        0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::fill(0x2::dynamic_field::borrow_mut<vector<u8>, 0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::Redirects>(&mut arg0.id, b"redirects"), arg1, arg2, arg3);
    }

    public fun fill_routes(arg0: &mut Site, arg1: vector<0x1::string::String>, arg2: vector<0x1::string::String>) {
        let v0 = &mut 0x2::dynamic_field::borrow_mut<vector<u8>, Routes>(&mut arg0.id, b"routes").route_list;
        assert!(0x1::vector::length<0x1::string::String>(&arg1) == 0x1::vector::length<0x1::string::String>(&arg2), 13906835222315401215);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::string::String>(&arg1)) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(v0, 0x1::vector::pop_back<0x1::string::String>(&mut arg1), 0x1::vector::pop_back<0x1::string::String>(&mut arg2));
            v1 = v1 + 1;
        };
    ...
    public fun insert_redirect(arg0: &mut Site, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u16) {
        0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::insert(0x2::dynamic_field::borrow_mut<vector<u8>, 0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::Redirects>(&mut arg0.id, b"redirects"), arg1, arg2, arg3);
    }
    ...
    public fun remove_redirect(arg0: &mut Site, arg1: &0x1::string::String) : (0x1::string::String, 0x1::string::String, u16) {
        0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::remove(0x2::dynamic_field::borrow_mut<vector<u8>, 0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::Redirects>(&mut arg0.id, b"redirects"), arg1)
    }
    ...
    public fun set_redirects(arg0: &mut Site, arg1: 0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::Redirects) {
        0x2::dynamic_field::add<vector<u8>, 0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::Redirects>(&mut arg0.id, b"redirects", arg1);
    }

    public fun set_suins_reverse_lookup(arg0: &mut Site, arg1: &mut 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins::SuiNS, arg2: 0x1::string::String) {
        0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::controller::set_object_reverse_lookup(arg1, uid_mut(arg0), arg2);
    }

    public fun take_redirects(arg0: &mut Site) : 0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::Redirects {
        0x2::dynamic_field::remove<vector<u8>, 0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::Redirects>(&mut arg0.id, b"redirects")
    }

    public fun take_redirects_if_exist(arg0: &mut Site) : 0x1::option::Option<0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::Redirects> {
        0x2::dynamic_field::remove_if_exists<vector<u8>, 0x26eb7ee8688da02c5f671679524e379f0b837a12f1d1d799f255b7eea260ad27::redirects::Redirects>(&mut arg0.id, b"redirects")
    }

    public(friend) fun uid_mut(arg0: &mut Site) : &mut 0x2::object::UID {
        &mut arg0.id
    }
