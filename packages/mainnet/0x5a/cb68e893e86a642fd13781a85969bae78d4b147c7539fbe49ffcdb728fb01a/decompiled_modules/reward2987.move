module 0x5acb68e893e86a642fd13781a85969bae78d4b147c7539fbe49ffcdb728fb01a::reward2987 {
    struct REWARD2987 has drop {
        dummy_field: bool,
    }

    struct TICKET_2987 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2987(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2987>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2987>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2987, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2987>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2987>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2987>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2987>>(v5, 0x2::tx_context::sender(arg1));
    }
