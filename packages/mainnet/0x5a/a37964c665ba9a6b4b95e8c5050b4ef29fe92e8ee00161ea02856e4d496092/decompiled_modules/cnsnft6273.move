module 0x5aa37964c665ba9a6b4b95e8c5050b4ef29fe92e8ee00161ea02856e4d496092::cnsnft6273 {
    struct CNSNFT6273 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6273, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6273>(arg0, arg1);
