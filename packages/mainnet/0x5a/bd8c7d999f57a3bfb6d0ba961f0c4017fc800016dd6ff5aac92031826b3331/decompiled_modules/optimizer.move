module 0x5abd8c7d999f57a3bfb6d0ba961f0c4017fc800016dd6ff5aac92031826b3331::optimizer {
    ...
    fun evaluate_bounded_probe(arg0: &vector<Hop>, arg1: &vector<V3PrefixCache>, arg2: u128, arg3: &mut vector<u128>, arg4: &mut u64, arg5: &mut OptimizeResult) {
        ...
        let (v1, v2, v3, v4) = quote_bounded_route(arg0, arg1, arg2, arg4);
    ...
    fun largest_gap_midpoint(arg0: &vector<u128>, arg1: u128, arg2: u128, arg3: u128) : u128 {
        ...
        while (v3 <= v2) {
            let v4 = if (v3 == v2) {
                ...
                *0x1::vector::borrow<u128>(arg0, v3)
            };
            if (v4 > arg1) {
                if (v4 - arg1 > v1) {
                    v1 = v4 - arg1;
    ...
    public fun optimize_cached(arg0: vector<Hop>, arg1: u128, arg2: u64, arg3: u64, arg4: u64) : OptimizeResult {
        ...
        while (v1.evaluations < arg3 && v6 > 0) {
            ...
            if (v8 - v7 <= v18) {
                ...
                let v19 = &mut v6;
                let v20 = &mut v1;
                trim_cached_v2_plateau(&arg0, &v5, v19, arg3, arg1, v11, v20);
                return v1
            };
            arg1 = v7 + (v8 - v7) / 2;
        };
    ...
    fun refinement_point(arg0: &OptimizeResult, arg1: &vector<u128>, arg2: u128, arg3: u128, arg4: u128, arg5: u64) : u128 {
        ...
        let v5 = if (v4 == v3) {
            ...
            *0x1::vector::borrow<u128>(arg1, v4)
        };
        if (!arg0.found || arg5 % 4 == 3) {
            return largest_gap_midpoint(arg1, arg2, arg3, arg4)
        };
        let v6 = if (v0 - v2 >= v5 - v0) {
            midpoint(v2, v0)
        } else {
            midpoint(v0, v5)
        };
        let v7 = aligned_in_range(v6, arg2, arg3, arg4);
        if (!contains_amount(arg1, v7)) {
            v7
        } else {
    ...
    fun trim_cached_v2_plateau(arg0: &vector<Hop>, arg1: &vector<V3PrefixCache>, arg2: &mut u64, arg3: u64, arg4: u128, arg5: u128, arg6: &mut OptimizeResult) {
