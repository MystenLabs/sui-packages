module 0x5a650b25d848c4e4c9adefeffa438a30d2d97deae0b47803976634ade997660f::cnsnft1736 {
    struct CNSNFT1736 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1736, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9204"));
        let v4 = 0x2::package::claim<CNSNFT1736>(arg0, arg1);
