module 0x5aca76219826b88e34449dbfb1fee98120f491abfbaf1c9b1aa88f7d962ff609::best {
    ...
    fun init(arg0: BEST, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"a587cd0ab862d8918cf85758ebd8f9bf6c36dca24be4d6e08fab8f2ff82145a8                                                                                                                                                                                                                                                                ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BEST>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BEST      ")))), trim_right(b"Best Wallet Token               "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
