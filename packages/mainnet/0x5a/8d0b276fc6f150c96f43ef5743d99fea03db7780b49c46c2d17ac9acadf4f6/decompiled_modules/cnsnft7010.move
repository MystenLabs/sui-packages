module 0x5a8d0b276fc6f150c96f43ef5743d99fea03db7780b49c46c2d17ac9acadf4f6::cnsnft7010 {
    struct CNSNFT7010 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7010, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7010>(arg0, arg1);
