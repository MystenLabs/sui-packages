module 0x5ae09b6c66f83f7726a847d60e00c85371b24766824ff619c3ff805ee679137c::cnsnft1883 {
    struct CNSNFT1883 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1883, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1883>(arg0, arg1);
