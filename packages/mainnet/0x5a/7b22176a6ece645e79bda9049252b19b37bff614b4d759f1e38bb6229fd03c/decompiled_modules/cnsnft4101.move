module 0x5a7b22176a6ece645e79bda9049252b19b37bff614b4d759f1e38bb6229fd03c::cnsnft4101 {
    struct CNSNFT4101 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4101, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4101>(arg0, arg1);
