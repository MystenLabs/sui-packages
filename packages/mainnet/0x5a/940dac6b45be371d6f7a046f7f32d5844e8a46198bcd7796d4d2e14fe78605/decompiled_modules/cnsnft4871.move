module 0x5a940dac6b45be371d6f7a046f7f32d5844e8a46198bcd7796d4d2e14fe78605::cnsnft4871 {
    struct CNSNFT4871 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4871, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4871>(arg0, arg1);
