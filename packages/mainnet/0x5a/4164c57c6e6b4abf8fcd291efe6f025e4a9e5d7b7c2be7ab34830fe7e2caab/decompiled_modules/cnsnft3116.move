module 0x5a4164c57c6e6b4abf8fcd291efe6f025e4a9e5d7b7c2be7ab34830fe7e2caab::cnsnft3116 {
    struct CNSNFT3116 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3116, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3116>(arg0, arg1);
