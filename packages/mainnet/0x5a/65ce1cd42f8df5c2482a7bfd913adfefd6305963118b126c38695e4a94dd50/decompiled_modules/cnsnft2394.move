module 0x5a65ce1cd42f8df5c2482a7bfd913adfefd6305963118b126c38695e4a94dd50::cnsnft2394 {
    struct CNSNFT2394 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2394, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2394>(arg0, arg1);
