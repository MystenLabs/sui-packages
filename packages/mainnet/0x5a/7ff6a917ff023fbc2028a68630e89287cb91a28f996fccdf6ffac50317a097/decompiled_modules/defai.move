module 0x5a7ff6a917ff023fbc2028a68630e89287cb91a28f996fccdf6ffac50317a097::defai {
    ...
    fun init(arg0: DEFAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/5LGyBHMMPwzMunxhcBMn6ZWAuqoHUQmcFiboTJidFURP.png?size=lg&key=9ad9d4                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DEFAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DeFAI     ")))), trim_right(b"DeFAI                           "), trim_right(b"Eliza.Finance revolutionizes DeFi with Agentic AI, offering adaptive, secure, and user-centric financial services. Autonomous AI agents analyze trends, predict risks, and make informed decisions in real-time, democratizing access to sophisticated financial instruments.                                                   "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
