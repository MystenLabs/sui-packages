module 0x5abe63e7f55ded636e03860017392c86e72741f4d56f00edb7466764ae28861d::sui_fam__suilobster_x_suikingfizh_x_zimaonsui_ {
    struct SUI_FAM__SUILOBSTER_X_SUIKINGFIZH_X_ZIMAONSUI_ has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"82f0f5d1-325c-4302-b748-9acb0d34909f"),
        };
    ...
    fun init(arg0: SUI_FAM__SUILOBSTER_X_SUIKINGFIZH_X_ZIMAONSUI_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_FAM__SUILOBSTER_X_SUIKINGFIZH_X_ZIMAONSUI_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUI FAM (SuiLobster X Suikingfizh X zimaonsui)"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Artwork made by SuiKingFizh in support of these projects. You can get some $FZH when it is launched"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmTnUBTzVHcJzFSFajUFLATYyqdgK5eWa9EQm3KR2sY8zm"));
    ...
    public entry fun mint_nft(arg0: &0x2::clock::Clock, arg1: &mut Manager, arg2: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg3: 0x1::string::String, arg4: u64, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: u64, arg9: u64, arg10: u64, arg11: vector<u8>, arg12: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg13: &mut 0x2::kiosk::Kiosk, arg14: &0x2::kiosk::KioskOwnerCap, arg15: &0x2::transfer_policy::TransferPolicy<Nft>, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = MintNftEvent{
            ...
            price                     : arg9 + arg10,
            collection_id             : 0x1::string::utf8(b"82f0f5d1-325c-4302-b748-9acb0d34909f"),
            collection_creator_wallet : @0xe7ab459c8f8d13131d7cbcca8a9c65f384269ad025634ea029364a404a46ac96,
