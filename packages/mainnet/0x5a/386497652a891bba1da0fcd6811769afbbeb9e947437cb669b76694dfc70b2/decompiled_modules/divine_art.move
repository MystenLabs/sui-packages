module 0x5a386497652a891bba1da0fcd6811769afbbeb9e947437cb669b76694dfc70b2::divine_art {
    ...
    fun init(arg0: DIVINE_ART, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"Divine Art test"));
        0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"https://clutchy.app"));
