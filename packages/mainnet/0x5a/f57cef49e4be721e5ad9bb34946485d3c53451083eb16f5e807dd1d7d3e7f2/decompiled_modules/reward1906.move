module 0x5af57cef49e4be721e5ad9bb34946485d3c53451083eb16f5e807dd1d7d3e7f2::reward1906 {
    struct REWARD1906 has drop {
        dummy_field: bool,
    }

    struct TICKET_1906 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1906(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1906>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1906>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1906, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1906>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1906>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1906>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1906>>(v5, 0x2::tx_context::sender(arg1));
    }
