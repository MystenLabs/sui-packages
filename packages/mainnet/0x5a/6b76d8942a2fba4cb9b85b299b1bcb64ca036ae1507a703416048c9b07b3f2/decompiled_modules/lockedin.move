module 0x5a6b76d8942a2fba4cb9b85b299b1bcb64ca036ae1507a703416048c9b07b3f2::lockedin {
    ...
    fun init(arg0: LOCKEDIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/GVZr8f8ySrfYPMjBwSvgY72EjfHPe39Pd6MiPcFVkj8Q.png?claimId=vNXzZhF1s5lXIFBI                                                                                                                                                                                                      ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<LOCKEDIN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"LOCKEDIN  ")))), trim_right(b"LOCKED IN                       "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
