module 0x74bce93b827addba14d1c50a0bea79d6e77b6ee7d95edd9c2dd07fe86541e40b::flowx_wrapper {
    struct FlowxSwapped has copy, drop, store {
        amount_in: u64,
        amount_out: u64,
        a2b: bool,
        by_amount_in: bool,
    ...
    public fun swap_a2b<T0, T1>(arg0: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x2::event::emit<FlowxSwapped>(v1);
        v0
    }
