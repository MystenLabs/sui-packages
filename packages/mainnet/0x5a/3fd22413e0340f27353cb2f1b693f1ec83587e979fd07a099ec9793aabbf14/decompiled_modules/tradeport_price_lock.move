module 0x5a3fd22413e0340f27353cb2f1b693f1ec83587e979fd07a099ec9793aabbf14::tradeport_price_lock {
    ...
    public fun confirm_long_lock<T0: store + key>(arg0: &mut Store, arg1: &0x2::clock::Clock, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &0x2::transfer_policy::TransferPolicy<T0>, arg7: u64, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        0x2::event::emit<LockConfirmedEvent<T0>>(v4);
        v2
    }

    public fun create_long_lock<T0: store + key>(arg0: &mut Store, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
    ...
    public fun create_short_lock<T0: store + key>(arg0: &mut Store, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
    ...
    public fun end_confirm_short_lock<T0: store + key>(arg0: &mut Store, arg1: &mut 0x47c8d4e4f92f877521a1b9dd553554dfec0f449277a9611aed4349c1c40a96ba::kiosk_transfers::Store, arg2: CoinRequest<T0>, arg3: 0x2::object::ID, arg4: &mut 0x2::kiosk::Kiosk, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &0x2::transfer_policy::TransferPolicy<T0>, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        let CoinRequest { lock_id: v0 } = arg2;
        ...
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Lock<T0>>(&mut arg0.id, v0);
    ...
    public fun start_confirm_short_lock<T0: store + key>(arg0: &mut Store, arg1: &0x2::clock::Clock, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : CoinRequest<T0> {
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, Lock<T0>>(&arg0.id, arg2), 4);
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Lock<T0>>(&mut arg0.id, arg2);
