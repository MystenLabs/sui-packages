module 0x5a924093e5577ffdaa6e5ca37423995a62bad04deb8ef7d748d90450a1c95ab3::potus47 {
    ...
    fun init(arg0: POTUS47, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dexscreener.com/solana/3t6cbhuqn445zzsfamjdmrdawdpp8wgutxa5qfgtpump                                                                                                                                                                                                                                                     ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<POTUS47>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"POTUS47   ")))), trim_right(b"president of the united states  "), trim_right(b"Donald J. Trump: The                                                                                                                                                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
