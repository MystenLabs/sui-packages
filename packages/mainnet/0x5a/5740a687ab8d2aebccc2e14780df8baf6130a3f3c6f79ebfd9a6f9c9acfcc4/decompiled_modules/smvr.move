module 0x6bb9cd9cec3bc9a20fd3431a77e75194257f047d4bd8b7f62e3edde753dd64d7::smvr {
    ...
    entry fun mint_and_transfer(arg0: &mut Registry, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<SMVR>>(0x2::coin::mint<SMVR>(&mut arg0.treasury_cap, 666666666666666666, arg2), arg1);
    }
