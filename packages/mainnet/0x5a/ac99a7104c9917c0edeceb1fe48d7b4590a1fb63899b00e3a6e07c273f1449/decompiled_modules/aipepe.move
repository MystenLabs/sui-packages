module 0x5aac99a7104c9917c0edeceb1fe48d7b4590a1fb63899b00e3a6e07c273f1449::aipepe {
    ...
    fun init(arg0: AIPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AIPEPE>(arg0, 2, b"AIPEPE", b"AIPEPE", b"", 0x1::option::none<0x2::url::Url>(), arg1);
