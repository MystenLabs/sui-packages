module 0x5a3c1f5d1fdfe074496e0034d7e925cdd98891deb5a2527bb641ba8b078649b2::reward5745 {
    struct REWARD5745 has drop {
        dummy_field: bool,
    }

    struct TICKET_5745 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5745(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5745>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5745>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5745, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5745>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5745>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5745>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5745>>(v5, 0x2::tx_context::sender(arg1));
    }
