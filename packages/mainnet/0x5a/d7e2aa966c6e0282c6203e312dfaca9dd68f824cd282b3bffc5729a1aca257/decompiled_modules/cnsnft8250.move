module 0x5ad7e2aa966c6e0282c6203e312dfaca9dd68f824cd282b3bffc5729a1aca257::cnsnft8250 {
    struct CNSNFT8250 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8250, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8250>(arg0, arg1);
