module 0x5ab53fb1e9070a18fe5fd9c8bd5598a99c3e33b2dc688f4dc350a443a8586110::cnsnft6094 {
    struct CNSNFT6094 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6094, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6094>(arg0, arg1);
