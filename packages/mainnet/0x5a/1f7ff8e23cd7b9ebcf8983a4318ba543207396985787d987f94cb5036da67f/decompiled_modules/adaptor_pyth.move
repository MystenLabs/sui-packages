module 0x5a1f7ff8e23cd7b9ebcf8983a4318ba543207396985787d987f94cb5036da67f::adaptor_pyth {
    ...
    fun normalize_to_wad(arg0: u64, arg1: bool, arg2: u32) : u128 {
        assert!(arg2 <= 38, 3);
        let v0 = (arg0 as u128);
        let v1 = 0x5a1f7ff8e23cd7b9ebcf8983a4318ba543207396985787d987f94cb5036da67f::oracle_math::pow10(arg2);
        if (arg1) {
            0x5a1f7ff8e23cd7b9ebcf8983a4318ba543207396985787d987f94cb5036da67f::oracle_math::mul_div_down(v0, 1000000000000000000, v1)
        } else {
            assert!(v1 <= 340282366920938463463 / v0, 3);
            0x5a1f7ff8e23cd7b9ebcf8983a4318ba543207396985787d987f94cb5036da67f::oracle_math::mul_checked(0x5a1f7ff8e23cd7b9ebcf8983a4318ba543207396985787d987f94cb5036da67f::oracle_math::mul_checked(v0, v1), 1000000000000000000)
        }
    }

    public fun update_price<T0>(arg0: &mut 0x5a1f7ff8e23cd7b9ebcf8983a4318ba543207396985787d987f94cb5036da67f::pyth_oracle::Oracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
