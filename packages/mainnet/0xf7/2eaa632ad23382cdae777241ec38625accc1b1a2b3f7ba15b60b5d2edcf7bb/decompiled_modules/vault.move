module 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault {
    ...
    public fun compound<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (v4 > 0) {
            ...
            let (_, _, v13) = charge_premium_fee<T0>(arg0, arg1, 0x2::balance::split<T0>(v10, v4));
            let v14 = v13;
            let v15 = 0x2::balance::value<T0>(&v14);
            v9 = v15;
            let v16 = get_mut_deposit_vault_balance<T0>(arg1, 3);
            0x2::balance::join<T0>(v16, v14);
            v8 = v3 + v15;
    ...
    public fun compound_v2<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, 0x1::option::Option<vector<u8>>) {
        ...
        if (v4 > 0) {
            ...
            v7 = v4 - v4;
            arg1.premium_share_supply = arg1.premium_share_supply - v4;
            let (v13, v14, v15) = charge_premium_fee<T0>(arg0, arg1, 0x2::balance::split<T0>(v12, v4));
            let v16 = v15;
            v10 = v13;
            v11 = v14;
    ...
    public fun harvest<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        if (v4 > 0) {
            ...
            v7 = v4 - v4;
            arg1.premium_share_supply = arg1.premium_share_supply - v4;
            let (v11, v12, v13) = charge_premium_fee<T0>(arg0, arg1, 0x2::balance::split<T0>(v10, v4));
            v9 = v11 + v12;
            v8 = v4 - v11 - v12;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v13, arg3), 0x2::tx_context::sender(arg3));
        };
    ...
    public fun harvest_v2<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, 0x1::option::Option<vector<u8>>) {
        ...
        if (v4 > 0) {
            ...
            v7 = v4 - v4;
            arg1.premium_share_supply = arg1.premium_share_supply - v4;
            let (v12, v13, v14) = charge_premium_fee<T0>(arg0, arg1, 0x2::balance::split<T0>(v11, v4));
            v9 = v12;
            v10 = v13;
            v8 = v4 - v12 - v13;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v14, arg3), 0x2::tx_context::sender(arg3));
        };
        add_deposit_share(arg1, v0, v1, v2, v3, v7, v5, v6, arg3);
