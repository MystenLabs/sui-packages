module 0xf7246f49e59a7df31e4db03a46db6da059d2e5ef68cd2bb4a818781a06473822::minter_manager {
    ...
    fun init(arg0: MINTER_MANAGER, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MINTER_MANAGER>(arg0, 8, b"BBUSD", b"BBUSD", b"", 0x1::option::none<0x2::url::Url>(), arg1);
