module 0xf7048255637630136351f3becd6c7aa8a2041f856e4ea03e07addc06e6ae4d40::pengufi_pass {
    struct PENGUFI_PASS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PENGUFI_PASS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PENGUFI_PASS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"PenguFi Pass"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Only 699 will ever exist. Holders gain whitelist access, early staking power, and frosty rewards. Step into the iceberg before it melts!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://kwmWfhForbtMI9YZJXTtwDNY1CRN45UDxnZirp8JMqM"));
