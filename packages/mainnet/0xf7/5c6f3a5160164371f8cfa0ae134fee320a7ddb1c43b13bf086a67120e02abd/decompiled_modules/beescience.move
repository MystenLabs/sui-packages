module 0xf75c6f3a5160164371f8cfa0ae134fee320a7ddb1c43b13bf086a67120e02abd::beescience {
    ...
    public fun evolve_bee(arg0: u256, arg1: vector<u256>) : u256 {
        let v0 = (0x86760b69c6582ca23ccbffc3c8315f41919fe2fbfc26cc33e1f13c30e8cbb376::math::min_u64((((slice_number(arg0, 3, 4) as u8) + 1) as u64), ((8 - 1) as u64)) as u8);
    ...
    public fun mix_appearance_traits(arg0: u256, arg1: u256, arg2: u256) : u256 {
        ...
        while (v2 < 28) {
            ...
            let v4 = v1 + 2;
            let v5 = 0x1::string::utf8(b"mix_appearance_traits :: breeding_method");
