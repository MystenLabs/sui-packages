module 0x1abe7dac235220b3754ba1f69c304924ab88bdf2070f326597ff470feb750bcb::nft {
    ...
    struct Bet has store, key {
        id: 0x2::object::UID,
        user_addr: address,
        guild_nums: 0x2::table::Table<u64, 0x2::table::Table<0x2::object::ID, bool>>,
        bet_time: u64,
    }
    ...
    struct BetRound has store, key {
        ...
        user_addrs: 0x2::table::Table<address, u64>,
    ...
    public entry fun addPhaserWhitelistMerkleRoot<T0>(arg0: &0x2::package::Publisher, arg1: &mut Phaser<T0>, arg2: vector<vector<u8>>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<CubicNft>(arg0), 26);
    ...
    public entry fun batch_burn(arg0: vector<CubicNft>) {
        ...
        while (v0 < 0x1::vector::length<CubicNft>(&arg0)) {
            let CubicNft {
                ...
                link        : _,
                attributes  : v11,
            } = 0x1::vector::pop_back<CubicNft>(&mut arg0);
            let v12 = v11;
            let v13 = 0;
            while (v13 < 0x1::vector::length<Attribute>(&v12)) {
                let Attribute {
                    name  : _,
                    value : _,
                } = 0x1::vector::pop_back<Attribute>(&mut v12);
                v13 = v13 + 1;
            };
            0x1::vector::destroy_empty<Attribute>(v12);
    ...
    public entry fun bet(arg0: &0x2::clock::Clock, arg1: &mut Registry, arg2: vector<CubicNft>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v7 < 0x1::vector::length<CubicNft>(&arg2)) {
            ...
            let v9 = Attribute{
                ...
                value : 0x1::string::utf8(b"27X Token Reward"),
            };
            ...
            add_attribute(v11, b"Witness", b"27X Token Reward");
            v8.opened = true;
            0x2::transfer::public_transfer<CubicNft>(v8, v4);
            v7 = v7 + 1;
        };
        0x1::vector::destroy_empty<CubicNft>(arg2);
        if (0x2::table::contains<address, u64>(&mut v2.user_addrs, v4)) {
            let v12 = 0x2::table::borrow_mut<u64, Bet>(&mut v2.bets, *0x2::table::borrow<address, u64>(&mut v2.user_addrs, v4));
            if (0x2::table::contains<u64, 0x2::table::Table<0x2::object::ID, bool>>(&v12.guild_nums, arg3)) {
                let v13 = 0x2::table::borrow_mut<u64, 0x2::table::Table<0x2::object::ID, bool>>(&mut v12.guild_nums, arg3);
                let v14 = 0;
                while (v14 < 0x1::vector::length<0x2::object::ID>(&v6)) {
                    let v15 = 0x1::vector::borrow<0x2::object::ID>(&v6, v14);
                    0x2::table::remove<0x2::object::ID, bool>(&mut v5, *v15);
                    0x2::table::add<0x2::object::ID, bool>(v13, *v15, true);
                    v14 = v14 + 1;
                };
                0x2::table::destroy_empty<0x2::object::ID, bool>(v5);
            } else {
                0x2::table::add<u64, 0x2::table::Table<0x2::object::ID, bool>>(&mut v12.guild_nums, arg3, v5);
            };
        } else {
            let v16 = 0x2::table::length<address, u64>(&mut v2.user_addrs);
            let v17 = 0x2::table::new<u64, 0x2::table::Table<0x2::object::ID, bool>>(arg4);
            0x2::table::add<u64, 0x2::table::Table<0x2::object::ID, bool>>(&mut v17, arg3, v5);
            let v18 = Bet{
            ...
            0x2::table::add<u64, Bet>(&mut v2.bets, v16, v18);
            0x2::table::add<address, u64>(&mut v2.user_addrs, v4, v16);
        };
        let v19 = BetEvent{
            user_addr : v4,
            nft_ids   : v6,
    ...
    public entry fun create_bet_round(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = BetRound{
            ...
            end_time         : arg2,
            winner_guild_num : 0,
            user_addrs       : 0x2::table::new<address, u64>(arg3),
    ...
    fun isWhitelist<T0>(arg0: &mut Phaser<T0>, arg1: u64, arg2: vector<vector<u8>>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        0x1abe7dac235220b3754ba1f69c304924ab88bdf2070f326597ff470feb750bcb::merkle_proof::verify(&arg2, arg3, 0x1::hash::sha2_256(0x2::bcs::to_bytes<Ticket>(&v0)))
    }
    ...
    fun mint<T0>(arg0: &0x2::clock::Clock, arg1: &mut Collection, arg2: &mut Phaser<T0>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v8 < arg3) {
            ...
            let v13 = CubicNft{
                ...
                token_id    : v10,
                name        : arg1.name,
                image_url   : 0x2::url::new_unsafe(to_url(arg1.image_url, v10)),
    ...
    public fun to_url(arg0: 0x1::ascii::String, arg1: u64) : 0x1::ascii::String {
        ...
        if (v6 < v3) {
            ...
            0x1::string::append(v2, u128_to_string((arg1 as u128)));
