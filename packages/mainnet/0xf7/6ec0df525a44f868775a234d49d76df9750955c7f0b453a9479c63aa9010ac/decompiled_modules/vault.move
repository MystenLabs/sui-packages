module 0xf76ec0df525a44f868775a234d49d76df9750955c7f0b453a9479c63aa9010ac::vault {
    ...
    public fun deposit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        let v1 = if (v0 == 0) {
            0xf76ec0df525a44f868775a234d49d76df9750955c7f0b453a9479c63aa9010ac::utils::mul_div(0x2::balance::value<T0>(&arg1), arg0.deposit_cost_bps, 10000)
        } else {
            0xf76ec0df525a44f868775a234d49d76df9750955c7f0b453a9479c63aa9010ac::utils::mul_div(0x2::coin::total_supply<T1>(&arg0.lp_treasury), 0xf76ec0df525a44f868775a234d49d76df9750955c7f0b453a9479c63aa9010ac::utils::mul_div(0x2::balance::value<T0>(&arg1), arg0.deposit_cost_bps, 10000), v0)
        };
