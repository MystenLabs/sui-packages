module 0xf723725dcae17dd1f55123a4860fd61ef1814e775ec4b319a177493919d781fe::cnsnft6568 {
    struct CNSNFT6568 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6568, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6568>(arg0, arg1);
