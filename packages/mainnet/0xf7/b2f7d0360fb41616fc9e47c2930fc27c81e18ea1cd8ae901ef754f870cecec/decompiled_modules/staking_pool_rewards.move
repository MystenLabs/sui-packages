module 0xf7b2f7d0360fb41616fc9e47c2930fc27c81e18ea1cd8ae901ef754f870cecec::staking_pool_rewards {
    ...
    public fun add_reward_token<T0>(arg0: &0xf7b2f7d0360fb41616fc9e47c2930fc27c81e18ea1cd8ae901ef754f870cecec::admin::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun emergency_withdraw<T0>(arg0: &0xf7b2f7d0360fb41616fc9e47c2930fc27c81e18ea1cd8ae901ef754f870cecec::admin::AdminCap, arg1: &mut RewardPool<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun set_rewards_by_admin<T0>(arg0: &0xf7b2f7d0360fb41616fc9e47c2930fc27c81e18ea1cd8ae901ef754f870cecec::admin::AdminCap, arg1: &mut RewardPool<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        set_rewards_internal<T0>(arg1, arg2, arg3, arg4);
    }

    public entry fun set_rewards_by_keeper<T0>(arg0: &0xf7b2f7d0360fb41616fc9e47c2930fc27c81e18ea1cd8ae901ef754f870cecec::admin::KeeperRegistry, arg1: &mut RewardPool<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        0xf7b2f7d0360fb41616fc9e47c2930fc27c81e18ea1cd8ae901ef754f870cecec::admin::assert_keeper(arg0, arg4);
        set_rewards_internal<T0>(arg1, arg2, arg3, arg4);
    }
