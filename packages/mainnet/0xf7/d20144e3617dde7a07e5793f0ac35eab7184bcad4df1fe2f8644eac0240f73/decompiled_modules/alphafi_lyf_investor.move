module 0xc07a62c770bd1694dab2c5b9553304187a5b59867bca52045d40d1e6c8eda259::alphafi_lyf_investor {
    ...
    public fun rebalance_debts<T0, T1>(arg0: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::AdminCap, arg1: &0xc07a62c770bd1694dab2c5b9553304187a5b59867bca52045d40d1e6c8eda259::version::Version, arg2: &mut Investor<T0, T1>, arg3: u64, arg4: bool, arg5: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg6: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg7: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg8: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg9: &mut 0x3::sui_system::SuiSystemState, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        0xc07a62c770bd1694dab2c5b9553304187a5b59867bca52045d40d1e6c8eda259::version::assert_current_version(arg1);
        assert!(arg3 >= arg2.minimum_swap_amount, 13906839444268253183);
        ...
        if (arg4) {
            ...
            let v12 = v10;
            assert!(0x2::balance::value<T0>(&v12) == 0, 13906839508692762623);
            ...
            let v24 = v23;
            assert!(0x2::balance::value<T1>(&v24) == 0, 13906839581707206655);
    ...
    public(friend) fun withdraw<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: u128, arg2: u128, arg3: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let (v7, v8) = calculate_token_amounts_from_dollars<T0, T1>(arg0, v6, arg3, arg5, &v2, arg6, arg7);
        let v9 = v8;
        let v10 = v7;
        if (v5 == v6) {
            v10 = v7 + 1;
        ...
        let (v11, _, _) = get_liquidity_from_amount<T0, T1>(arg0, v3 - v10, v4 - v9, arg5);
        let (_, _, v16, v17) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg4, arg5, &mut v2, v11, arg6);
        let v18 = &mut v2;
        withdraw_and_repay<T0, T1>(arg0, v10, v9, arg3, arg4, arg5, v18, arg6, arg7);
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::return_bluefin_lp_collateral<T0, T1>(arg3, &arg0.position_cap, arg5, v2, v1, arg6, arg7);
    ...
    public(friend) fun withdraw_and_repay<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: u64, arg2: u64, arg3: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (v11 > 0) {
            ...
            if (v11 > arg0.minimum_swap_amount) {
                ...
                let v15 = v13;
                assert!(0x2::balance::value<T0>(&v15) == 0, 13906839109260804095);
                ...
                assert!(0x2::coin::value<T1>(&v16) == 0, 13906839122145705983);
            ...
            if (v12 > arg0.minimum_swap_amount) {
                ...
                let v19 = v18;
                assert!(0x2::balance::value<T1>(&v19) == 0, 13906839169390346239);
                ...
                assert!(0x2::coin::value<T0>(&v20) == 0, 13906839182275248127);
