module 0xf75af0c72e4c459a7d131be68a1e8c03806208d738dbcb7481a69236d0dbe72e::grow_vault {
    ...
    public(friend) fun create_vault<T0, T1>(arg0: 0x2::coin::TreasuryCap<T1>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xf75af0c72e4c459a7d131be68a1e8c03806208d738dbcb7481a69236d0dbe72e::events::vault_created(0x2::object::id_address<GrowVault<T0, T1>>(&v0), 0x1::type_name::get<T0>(), 0x1::type_name::get<T1>());
        0x2::transfer::share_object<GrowVault<T0, T1>>(v0);
        0xf75af0c72e4c459a7d131be68a1e8c03806208d738dbcb7481a69236d0dbe72e::vault_reserve::create<T0, T1>(arg5);
    }
    ...
    public(friend) fun update_assets<T0, T1>(arg0: &mut GrowVault<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        0xf75af0c72e4c459a7d131be68a1e8c03806208d738dbcb7481a69236d0dbe72e::events::assets_updated(0x2::object::id_address<GrowVault<T0, T1>>(arg0), arg1, arg2, arg3);
    }
