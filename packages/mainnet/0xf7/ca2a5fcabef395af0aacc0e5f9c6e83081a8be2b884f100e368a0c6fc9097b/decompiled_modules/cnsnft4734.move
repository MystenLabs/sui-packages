module 0xf7ca2a5fcabef395af0aacc0e5f9c6e83081a8be2b884f100e368a0c6fc9097b::cnsnft4734 {
    struct CNSNFT4734 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4734, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4734>(arg0, arg1);
