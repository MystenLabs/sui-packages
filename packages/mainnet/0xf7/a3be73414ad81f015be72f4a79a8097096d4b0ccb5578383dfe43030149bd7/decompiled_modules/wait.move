module 0xf7a3be73414ad81f015be72f4a79a8097096d4b0ccb5578383dfe43030149bd7::wait {
    ...
    public fun borrow_contribution(arg0: &WaitCard) : &0xf7a3be73414ad81f015be72f4a79a8097096d4b0ccb5578383dfe43030149bd7::contribution::WarlotData {
        0x2::dynamic_field::borrow<vector<u8>, 0xf7a3be73414ad81f015be72f4a79a8097096d4b0ccb5578383dfe43030149bd7::contribution::WarlotData>(&arg0.id, b"WARLOT CONTRIBUTIONS")
    }

    public fun borrow_contribution_mut(arg0: &mut AdminCap, arg1: &mut WaitCard) : &mut 0xf7a3be73414ad81f015be72f4a79a8097096d4b0ccb5578383dfe43030149bd7::contribution::WarlotData {
        0x2::dynamic_field::borrow_mut<vector<u8>, 0xf7a3be73414ad81f015be72f4a79a8097096d4b0ccb5578383dfe43030149bd7::contribution::WarlotData>(&mut arg1.id, b"WARLOT CONTRIBUTIONS")
    }
    ...
    public fun burn_admin(arg0: AdminCap, arg1: &mut CloneWaitCard<WAIT>) {
        if (4 - arg1.admin_slot == 1) {
            assert!(0x1::option::is_none<WaitCard>(&arg1.entry), 13906835102056775688);
        };
    ...
    fun destroy_dfield(arg0: &mut 0x2::object::UID) {
        ...
        if (v0 == true) {
            0xf7a3be73414ad81f015be72f4a79a8097096d4b0ccb5578383dfe43030149bd7::contribution::destroy(0x2::dynamic_field::remove<vector<u8>, 0xf7a3be73414ad81f015be72f4a79a8097096d4b0ccb5578383dfe43030149bd7::contribution::WarlotData>(arg0, b"WARLOT CONTRIBUTIONS"));
        };
    }
    ...
    fun init(arg0: WAIT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://www.warlot.xyz/image/thumbnail"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://www.warlot.xyz/image/thumbnail2"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://www.warlot.xyz/image/thumbnail"));
        ...
        let v7 = WaitCard{
            ...
            image_url   : 0x1::string::utf8(b"https://www.warlot.xyz/image/thumbnail"),
    ...
    fun mint(arg0: &CloneWaitCard<WAIT>, arg1: &mut 0x2::tx_context::TxContext) : WaitCard {
        assert!(0x1::option::is_some<WaitCard>(&arg0.entry), 13906835368344485892);
        ...
        0x2::dynamic_field::add<vector<u8>, 0xf7a3be73414ad81f015be72f4a79a8097096d4b0ccb5578383dfe43030149bd7::contribution::WarlotData>(&mut v1.id, b"WARLOT CONTRIBUTIONS", 0xf7a3be73414ad81f015be72f4a79a8097096d4b0ccb5578383dfe43030149bd7::contribution::create());
        v1
    }

    public fun mint_admin(arg0: &mut AdminCap, arg1: &mut CloneWaitCard<WAIT>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.admin_slot > 0, 13906835007567364102);
    ...
    public fun mint_to_request(arg0: &mut AdminCap, arg1: &CloneWaitCard<WAIT>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!0x2::dynamic_field::exists_<address>(&arg0.id, arg2), 13906835445654421516);
    ...
    public fun mint_to_sender(arg0: &mut CloneWaitCard<WAIT>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(!0x2::dynamic_field::exists_<address>(&arg0.id, 0x2::tx_context::sender(arg1)), 13906835540143570954);
    ...
    public fun suspend_clone(arg0: &mut AdminCap, arg1: &mut CloneWaitCard<WAIT>) {
        assert!(0x1::option::is_some<WaitCard>(&arg1.entry), 13906835338279583746);
