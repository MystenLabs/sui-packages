module 0xf7b83d64e2b0e7c122768a2df68d1b16a1f7f6bf92313330a9d7190bbbfb3153::cnsnft8116 {
    struct CNSNFT8116 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8116, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3210"));
        let v4 = 0x2::package::claim<CNSNFT8116>(arg0, arg1);
