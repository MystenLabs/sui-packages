module 0xf7af2a349167c9b7a2f47d9171b656d2ff9b58c6ca6460fc6e3a96be2fce4e35::cnsnft4075 {
    struct CNSNFT4075 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4075, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4075>(arg0, arg1);
