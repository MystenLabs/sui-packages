module 0xf75c0d4caa5de153c142904d0cd21b4efd7da8d6f9ecf214aad1f69ed5542ac7::cnsnft7803 {
    struct CNSNFT7803 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7803, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7803>(arg0, arg1);
