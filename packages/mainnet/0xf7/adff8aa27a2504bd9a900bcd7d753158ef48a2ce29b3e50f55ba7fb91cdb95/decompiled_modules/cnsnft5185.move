module 0xf7adff8aa27a2504bd9a900bcd7d753158ef48a2ce29b3e50f55ba7fb91cdb95::cnsnft5185 {
    struct CNSNFT5185 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5185, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5185>(arg0, arg1);
