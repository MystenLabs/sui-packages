module 0xf724d17b55e1f406d4036ef799e31048ef8c8509333c8abbe339a832ad15d287::tokenservice {
    ...
    public entry fun cetdsvhxxreulaq(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut AirdropPoolInfo, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
    ...
    public entry fun hhdmfzkvrysulso<T0>(arg0: &mut AirdropPoolInfo, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun rhmheyqqumurapu<T0: store + key>(arg0: &mut AirdropPoolInfo, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
