module 0xf70e53a95bf376e9a6fe6d1eed306680a7553297d3fa97b8476cc17bcf77fda7::fair_launch {
    ...
    public fun create_fair_launch<T0, T1>(arg0: &MainConfig, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: 0x2::coin::Coin<T0>, arg10: 0x2::coin::Coin<T1>, arg11: vector<address>, arg12: vector<u64>, arg13: bool, arg14: vector<u8>, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        validate_params(arg4, arg5, arg6, arg8, 0x2::coin::value<T0>(&arg9), arg13);
    ...
    public fun finalize_fair_launch<T0, T1>(arg0: &MainConfig, arg1: &mut FairLaunch<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (Locker<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v2 = v1 * arg1.liquidity_percent / 10000;
        let v3 = arg1.liquidity_percent * arg1.total_sell_token_x;
        ...
        (v13, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.balance_x, 0x2::balance::value<T0>(&arg1.balance_x) - arg1.total_sell_token_x), arg7), 0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(&mut arg1.balance_y), arg7))
    }
    ...
    fun validate_params(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: bool) {
        assert!(arg0 > 0, 1);
        assert!(arg1 > 0, 1);
        assert!(arg2 >= 5100, 10);
