module 0xf77334905ee26c307b0b57fb75fac72a2bcbbfa757d7c1d5831526d96c326ca6::reward4498 {
    struct REWARD4498 has drop {
        dummy_field: bool,
    }

    struct TICKET_4498 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4498(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4498>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4498>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4498, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4498>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4498>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4498>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4498>>(v5, 0x2::tx_context::sender(arg1));
    }
