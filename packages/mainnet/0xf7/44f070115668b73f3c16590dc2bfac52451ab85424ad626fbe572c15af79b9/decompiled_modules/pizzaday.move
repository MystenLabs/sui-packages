module 0xf744f070115668b73f3c16590dc2bfac52451ab85424ad626fbe572c15af79b9::pizzaday {
    ...
    fun init(arg0: PIZZADAY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PIZZADAY>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"PizzaDay"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://FZp-V3enpR1lfnX62cmsWbUAVE9uWNeQVCNIyGtHnIE"));
