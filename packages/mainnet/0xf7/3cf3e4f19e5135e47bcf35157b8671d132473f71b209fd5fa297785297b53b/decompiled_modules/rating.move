module 0xf73cf3e4f19e5135e47bcf35157b8671d132473f71b209fd5fa297785297b53b::rating {
    ...
    public entry fun rating_and_comment(arg0: &mut 0xf73cf3e4f19e5135e47bcf35157b8671d132473f71b209fd5fa297785297b53b::community::Community, arg1: u64, arg2: 0x1::string::String, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xf73cf3e4f19e5135e47bcf35157b8671d132473f71b209fd5fa297785297b53b::community::update_total_comments(arg0, arg4);
        0xf73cf3e4f19e5135e47bcf35157b8671d132473f71b209fd5fa297785297b53b::community::update_total_reviewers(arg0, arg1, arg4);
        0x2::transfer::share_object<RateAndComment>(v0);
    }

    public entry fun reply_comment(arg0: &mut 0xf73cf3e4f19e5135e47bcf35157b8671d132473f71b209fd5fa297785297b53b::community::Community, arg1: &mut RateAndComment, arg2: 0x1::string::String, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = CommentChild{
            id          : 0x2::object::new(arg4),
            comment     : arg2,
            is_hidden   : 0,
