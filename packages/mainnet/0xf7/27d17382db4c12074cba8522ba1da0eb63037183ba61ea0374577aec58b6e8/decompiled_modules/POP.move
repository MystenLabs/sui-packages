module 0xf727d17382db4c12074cba8522ba1da0eb63037183ba61ea0374577aec58b6e8::POP {
    struct POP has drop {
        dummy_field: bool,
    }

    fun init(arg0: POP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<POP>(arg0, 9, b"POP", b"Pop Meme", b"Pop Meme boost", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
