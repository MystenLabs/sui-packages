module 0xf7cdd4120ad7c9157ad844d54d06966b843a98bba30c5fbdd17311661f39c11f::game {
    ...
    struct Session has key {
        ...
        minted: bool,
        expires_at: u64,
        seal_approved: 0x1::option::Option<address>,
    }
    ...
    public fun create_game_witness() : 0xf7cdd4120ad7c9157ad844d54d06966b843a98bba30c5fbdd17311661f39c11f::leaderboard::GameWitness {
        0xf7cdd4120ad7c9157ad844d54d06966b843a98bba30c5fbdd17311661f39c11f::leaderboard::new_game_witness()
    }
    ...
    public entry fun create_session(arg0: &AdminCap, arg1: &mut GameConfig, arg2: vector<u8>, arg3: u8, arg4: vector<u8>, arg5: vector<u8>, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Session{
            ...
            minted        : false,
            expires_at    : arg7,
            seal_approved : 0x1::option::none<address>(),
        };
    ...
    public entry fun mint_nft(arg0: &mut Session, arg1: AllowlistCap, arg2: &GameConfig, arg3: vector<u8>, arg4: &mut 0xf7cdd4120ad7c9157ad844d54d06966b843a98bba30c5fbdd17311661f39c11f::leaderboard::Leaderboard, arg5: 0xf7cdd4120ad7c9157ad844d54d06966b843a98bba30c5fbdd17311661f39c11f::leaderboard::GameWitness, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.minted = true;
        arg0.seal_approved = 0x1::option::none<address>();
        ...
        0xf7cdd4120ad7c9157ad844d54d06966b843a98bba30c5fbdd17311661f39c11f::leaderboard::add_score(arg4, arg5, v1, v2, arg6, arg7);
        let AllowlistCap {
            id          : v7,
            session_id  : _,
            session_obj : _,
    ...
    public fun seal_approve(arg0: vector<u8>, arg1: &Session, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(0x1::option::contains<address>(&arg1.seal_approved, &v2), 10);
    }
    ...
    public fun session_seal_approved(arg0: &Session) : 0x1::option::Option<address> {
        arg0.seal_approved
    }
    ...
    public entry fun submit_answer(arg0: &mut Session, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.seal_approved = 0x1::option::some<address>(v0);
        let v1 = AllowlistCap{
