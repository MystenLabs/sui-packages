module 0xf76191f294f81910593a2eb480eeb4052837db63f3967e855eeff696b70e2c2f::reward4181 {
    struct REWARD4181 has drop {
        dummy_field: bool,
    }

    struct TICKET_4181 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4181(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4181>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4181>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4181, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4181>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4181>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4181>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4181>>(v5, 0x2::tx_context::sender(arg1));
    }
