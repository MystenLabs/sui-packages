module 0xf77ee221a361a336030e283dfa8a0003b9666467809bcc540a186d5202e47ec7::shrooms_token {
    ...
    fun calculate_yield(arg0: u64, arg1: u64, arg2: u64) : u64 {
        arg0 * arg1 * 1000000 / 3600000 * arg2
    }
    ...
    public entry fun harvest(arg0: &mut GameState, arg1: &mut 0xf77ee221a361a336030e283dfa8a0003b9666467809bcc540a186d5202e47ec7::referral_system::ReferralSystem, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        let v2 = 0x1::vector::borrow_mut<Farm>(&mut arg0.farms, arg2);
        assert!(v2.owner == v0, 1);
        let v3 = v1 - v2.last_harvest_timestamp;
        assert!(v3 >= 300000, 3);
        let v4 = calculate_yield(v2.mushrooms, v3, v2.level);
        let (v5, v6) = 0xf77ee221a361a336030e283dfa8a0003b9666467809bcc540a186d5202e47ec7::referral_system::calculate_referral_reward(arg1, v0, v4);
        let v7 = v5;
        0x2::transfer::public_transfer<0x2::coin::Coin<SHROOMS_TOKEN>>(0x2::coin::mint<SHROOMS_TOKEN>(&mut arg0.treasury_cap, v4 - v6, arg4), v0);
        if (0x1::option::is_some<address>(&v7)) {
            0x2::transfer::public_transfer<0x2::coin::Coin<SHROOMS_TOKEN>>(0x2::coin::mint<SHROOMS_TOKEN>(&mut arg0.treasury_cap, v6, arg4), 0x1::option::extract<address>(&mut v7));
            0xf77ee221a361a336030e283dfa8a0003b9666467809bcc540a186d5202e47ec7::referral_system::record_reward_distribution(arg1, v6);
        };
