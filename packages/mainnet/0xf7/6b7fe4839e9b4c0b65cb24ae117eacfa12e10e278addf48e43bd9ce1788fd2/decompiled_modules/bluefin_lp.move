module 0xf76b7fe4839e9b4c0b65cb24ae117eacfa12e10e278addf48e43bd9ce1788fd2::bluefin_lp {
    ...
    public fun destroy_vault<T0, T1>(arg0: &AdminCap, arg1: &BluefinLPTreasury, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &mut BluefinLPVault, arg5: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert_valid_package_version(arg1);
        let v0 = &mut arg4.id;
        let v1 = &mut arg4.position;
        let v2 = 0;
        assert!(&mut arg4.bluefin_lp_supply == &v2, 3);
        let (v3, v4, v5, v6) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg2, arg3, v1, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(v1), arg5);
        let v7 = DestroyVault<T0, T1>{
            vault_id  : 0x2::object::uid_to_inner(v0),
            pool_id   : 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg3),
            removal_a : v3,
            removal_b : v4,
        };
        0x2::event::emit<DestroyVault<T0, T1>>(v7);
        (v5, v6)
    }
