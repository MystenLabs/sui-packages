module 0xf7788596b13de9799b6b0afa385b2c30338bc0b8799363113cb06e25d8cc229a::gut {
    ...
    fun init(arg0: GUT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<GUT>>(0x2::coin::from_balance<GUT>(0x2::balance::increase_supply<GUT>(&mut v2.total_supply, 100000000000000000), arg1), 0x2::tx_context::sender(arg1));
        0x2::transfer::share_object<Metadata<GUT>>(v2);
    }

    entry fun migrate(arg0: &mut Metadata<GUT>, arg1: &0xf7788596b13de9799b6b0afa385b2c30338bc0b8799363113cb06e25d8cc229a::ownership::OwnerCap) {
        assert!(arg0.version < 1, 1);
